...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 0000000000000000000000000001617;
    const String videoIdtwo = 'https://youtu.be/dq8scgJCg7w?t=';
    const double startSecondstwo = 000000000000000000000000000641;
    const String videoIdthree = 'https://youtu.be/WBxqiUhadyY?t=';
    const double startSecondsthree = 0000000000000000000000000001358;
    const String videoIdfour = 'https://youtu.be/tFdnCzfJPJ0?t=';
    const double startSecondsfour = 000000000000000000000000000428;
    const String videoIdfive = 'https://youtu.be/J5z4opzud_U?t=';
