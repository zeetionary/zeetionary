...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'oloBebBQE38';
    const double startSecondsend = 43;
    const String videoIdone = 'jrMiqEkSk48';
    const double startSecondsone = 461;
    const String videoIdtwo = 'n068fel-W9I';
    const double startSecondstwo = 2548;
    const String videoIdthree = 'lyJqgL3Zp4E';
    const double startSecondsthree = 988;
    const String videoIdfour = 'v8Nv4rTKlMM';
    const double startSecondsfour = 803;
    const String videoIdfive = 'nl9NQSHcKQI';
