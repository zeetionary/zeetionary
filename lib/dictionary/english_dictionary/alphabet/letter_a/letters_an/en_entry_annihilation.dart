                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "annihilation"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˌnaɪəˈleɪʃn/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˌnaɪəˈleɪʃn/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'z4SCAlIOxrM';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'rGccuYGiK_Q';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'YJSrp_P6Bjo';
  final double _startSeconds = 17;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 1417;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'PCuyCJocJWg';
