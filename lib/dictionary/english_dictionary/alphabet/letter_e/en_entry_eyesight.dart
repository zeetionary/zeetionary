...
class EnglishEntryeyesight extends StatefulWidget {
  const EnglishEntryeyesight({super.key});

  @override
  State<EnglishEntryeyesight> createState() => _EnglishEntryeyesightState();
}

class _EnglishEntryeyesightState extends State<EnglishEntryeyesight> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""eyesight""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """eyesight""",
                      // alsoEnglishWord: "also: eyesight",
                      britshText: """IpaUK: /ˈaɪsaɪt/""",
                      americanText: """IpaUS: /ˈaɪsaɪt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Owls have good eyesight.""");
  }
...
"""),
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She has started to lose her eyesight.""",
            kurdishText: """دەستی کردبوو بە لەدەستدانی بینایی.""",
...
const double _startSecondsend = 000000000000000000000000000516;
const String _videoIdone = 'https://youtu.be/LXhLlWQtdt0?t=';
const double _startSecondsone = 000000000000000000000000000334;
const String _videoIdtwo = 'https://youtu.be/0pAz6LTdTrw?t=';
const double _startSecondstwo = 000000000000000000000000000545;
const String _videoIdthree = 'https://youtu.be/K3YnaQ64ELY?t=';
const double _startSecondsthree = 00000000000000000000000000036;
const String _videoIdfour = 'https://youtu.be/8jNs5G88TiI?t=';
const double _startSecondsfour = 000000000000000000000000000347;
const String _videoIdfive = 'https://youtu.be/_tHpanD6Nik?t=';
const double _startSecondsfive = 000000000000000000000000000219;
