...
class EnglishEntryfirmness extends StatefulWidget {
  const EnglishEntryfirmness({super.key});

  @override
  State<EnglishEntryfirmness> createState() => _EnglishEntryfirmnessState();
}

class _EnglishEntryfirmnessState extends State<EnglishEntryfirmness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: firmness
1. The muscle tone of healthy tissue (= soundness)
"his muscular firmness";
 
2. The trait of being resolute (= resoluteness, firmness of purpose, resolve, resolution)
"his firmness carried him through the battle";
 
3. The property of being unyielding to the touch
 
4. The quality of being steady or securely and immovably fixed in place (= steadiness)
""",
  );

  final String keyword = "firmness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""firmness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The firmness of the fruit indicated its ripeness.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The firmness of conviction was evident in her speech.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """firmness""",
                      // alsoEnglishWord: "also: firmness",
                      britshText: """IpaUK: /ˈfɜːmnəs/""",
                      americanText: """IpaUS: /ˈfɜːrmnəs/""",
...
// With short examples define "firmness", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The firmness of the fruit indicated its ripeness.""",
                      kurdishText: """پتەوی میوەکە نیشانەی گەییوییەکەی بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پتەوی بیروباوەڕەکەی لە وتارەکەیدا ڕوون بوو.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ناو) ئەوەی بە بەهێزی شوێنی خۆی گرتبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The engineer ensured the firmness of the foundations before construction began.""",
                      kurdishText:
                          """ئەدازیارەکە دڵنیایی کردەوە لە جێگیری پایەکان پێش ئەوەی بنیاتنان دەست پێبکات.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (ناو) ئەوەی بەهێز و توند بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                    ...
                    const DefinitionKurdish(
                        text:
                            """٥. (ناو) ئەوەی بەهێز بێت و لە کۆنترۆڵدا بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
...
const String _videoIdone = 'https://youtu.be/PYzhuFS8YkE?t=';
const double _startSecondsone = 00000000000000000000000000069;
const String _videoIdtwo = 'https://youtu.be/FGAfZ-PTaNU?t=';
const double _startSecondstwo = 000000000000000000000000000301;
const String _videoIdthree = 'https://youtu.be/LQ8JOsc3-wU?t=';
const double _startSecondsthree = 000000000000000000000000000322;
const String _videoIdfour = 'https://youtu.be/3u97efIBPmc?t=';
const double _startSecondsfour = 000000000000000000000000000108;
const String _videoIdfive = 'https://youtu.be/-Y30MRr7O_0?t=';
