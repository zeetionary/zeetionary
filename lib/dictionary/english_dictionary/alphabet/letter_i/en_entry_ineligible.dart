...
class EnglishEntryineligible extends StatefulWidget {
  const EnglishEntryineligible({super.key});

  @override
  State<EnglishEntryineligible> createState() => _EnglishEntryineligibleState();
}

class _EnglishEntryineligibleState extends State<EnglishEntryineligible> {
  @override
  void initState() {
    super.initState();
...
1. (sport) prohibited by official rules
...
""",
  ...
  final String keyword = "ineligible";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ineligible""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/FkKPsLxgpuY?t=';
    const double startSecondsone = 000000000000000000000000000866;
    const String videoIdtwo = 'https://youtu.be/NG4Ws74RV04?t=';
    const double startSecondstwo = 000000000000000000000000000269;
    const String videoIdthree = 'https://youtu.be/tYrdMjVXyNg?t=';
    const double startSecondsthree = 0000000000000000000000000006191;
    const String videoIdfour = 'https://youtu.be/76eGLHYOKBQ?t=';
    const double startSecondsfour = 00000000000000000000000000036;
    const String videoIdfive = 'https://youtu.be/LxTWonQvXkw?t=';
    const double startSecondsfive = 000000000000000000000000000523;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ineligible""",
                      // alsoEnglishWord: "also: ineligible",
                      britshText: """IpaUK: /ɪnˈelɪdʒəbl/""",
                      americanText: """IpaUS: /ɪnˈelɪdʒəbl/""",
...
کوردی: لێنەوەشاو، نەشیاو، بەکارنەهاتوو، لێنەهاتوو، پێنەکراو، پەسندنەکراو
"""),
// With short examples define "ineligible", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە هەموو لێهاتوویەکانی تێدا نییە بۆ شتێک"""),
                    SentencesRow(
                      englishText:
                          """The new rules have made thousands more people ineligible for legal aid.""",
                      kurdishText:
                          """یاسا تازەکان هەزاران کەسی دیکەیان کردووە بە لێنەهاتوو بۆ یارمەتیی یاسایی.""",
