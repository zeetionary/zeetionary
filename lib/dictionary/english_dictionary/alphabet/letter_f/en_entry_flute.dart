...
class EnglishEntryflute extends StatefulWidget {
  const EnglishEntryflute({super.key});

  @override
  State<EnglishEntryflute> createState() => _EnglishEntryfluteState();
}

class _EnglishEntryfluteState extends State<EnglishEntryflute> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flute (Derived forms: flutes)
1. A high-pitched woodwind instrument; a slender tube closed at one end with finger holes on one end and an opening near the closed end across which the breath is blown (= transverse flute)
 
2. A tall narrow wineglass (= flute glass, champagne flute)
 
3. A groove or furrow in cloth etc (particularly a shallow concave groove on the shaft of a column) (= fluting)

- Verb: flute (Derived forms: flutes, fluted, fluting)
1. Form flutes in
""",
  );

  final String keyword = "flute";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She learned to play the flute in school.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She polished her silver flute before the concert.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flute""",
                      // alsoEnglishWord: "also: flute",
                      britshText: """IpaUK: /fluːt/""",
                      americanText: """IpaUS: /fluːt/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئامێرێکی میوزیکی شێوە باریک و درێژە و ژەنیارەکە بە لایەکی ڕووخساریدا هەڵی دەگرێت و فوو دەکات بە سەرێکیدا"""),
                    SentencesRow(
                      englishText:
                          """She learned to play the flute in school.""",
                      kurdishText: """لە قوتابخانە فێربوو فلووت لێ‌بدات.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She polished her silver flute before the concert.""",
                      kurdishText:
                          """پێش کۆنسێرتەکە فلوتە زیوییەکەی پاککردەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ouJDvdg7EZI?t=';
const double _startSecondsend = 0000000000000000000000000009;
const String _videoIdone = 'https://youtu.be/A9uBPwP7DQc?t=';
const double _startSecondsone = 0000000000000000000000000007;
const String _videoIdtwo = 'https://youtu.be/A9uBPwP7DQc?t=';
const double _startSecondstwo = 00000000000000000000000000081;
const String _videoIdthree = 'https://youtu.be/D3gPY9XjHpM';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/misjPOhd-9o?t=';
const double _startSecondsfour = 00000000000000000000000000013;
const String _videoIdfive = 'https://youtu.be/_c_ufaxeSTs';
