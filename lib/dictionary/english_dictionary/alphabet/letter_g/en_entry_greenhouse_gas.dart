...
class EnglishEntrygreenhousegas extends StatefulWidget {
  const EnglishEntrygreenhousegas({super.key});

  @override
  State<EnglishEntrygreenhousegas> createState() =>
      _EnglishEntrygreenhousegasState();
}

class _EnglishEntrygreenhousegasState extends State<EnglishEntrygreenhousegas> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: greenhouse gas (Derived forms: greenhouse gases)
1. A gas that contributes to the greenhouse effect by absorbing infrared radiation (- greenhouse emission, GHG)
""",
  );

  final String keyword = "greenhouse gas";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""greenhouse gas""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """greenhouse gas""",
                      // alsoEnglishWord: "also: greenhouse gas",
                      britshText: """IpaUK: /ˌɡriːnhaʊs ˈɡæs/""",
                      americanText: """IpaUS: /ˌɡriːnhaʊs ˈɡæs/""",
...
// With short examples define "greenhouse gas", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هەر یەک لەو گازانەی کە وەها دادەنرێن ببنە هۆکاری گەرمبوونی بەرگەهەوای زەوی، بە تایبەتی دووەم ئۆکسیدی کاربۆن"""),
                    SentencesRow(
                      englishText:
                          """We need a global system for limiting greenhouse gas emissions.""",
                      kurdishText:
                          """پێویستیمان بە سیستەمێکی جیهانییە بۆ سنووردارکردنی دەردانی گازی خانووی شووشەیی.""",
...
const double _startSecondsend = 0000000000000000000000000001926;
const String _videoIdone = 'https://youtu.be/CaLOiGEDPJQ?t=';
const double _startSecondsone = 000000000000000000000000000416;
const String _videoIdtwo = 'https://youtu.be/sL-PL1hpnM0?t=';
const double _startSecondstwo = 0000000000000000000000000001744;
const String _videoIdthree = 'https://youtu.be/F6R_WTDdx7I?t=';
const double _startSecondsthree = 000000000000000000000000000563;
const String _videoIdfour = 'https://youtu.be/SfsCniN7Nsc?t=';
const double _startSecondsfour = 000000000000000000000000000623;
const String _videoIdfive = 'https://youtu.be/XRUxTFWWWdY?t=';
const double _startSecondsfive = 000000000000000000000000000230;
