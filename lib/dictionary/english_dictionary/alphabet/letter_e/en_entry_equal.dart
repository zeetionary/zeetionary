...
class EnglishEntryequal extends StatefulWidget {
  const EnglishEntryequal({super.key});

  @override
  State<EnglishEntryequal> createState() => _EnglishEntryequalState();
}

class _EnglishEntryequalState extends State<EnglishEntryequal> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equal""",
                      // alsoEnglishWord: "also: equal",
                      britshText: """IpaUK: /ˈiːkwəl/""",
                      americanText: """IpaUS: /ˈiːkwəl/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Cut it into four equal parts.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The two countries are roughly equal in size.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""One pound is roughly equal to two dollars.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I believe everyone is born equal.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I hope that he proves equal to the challenge.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""2x plus y equals 7 (= 2x+y=7)""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""A metre equals 39.38 inches.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Three and three equals six.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""This achievement is unlikely ever to be equalled.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""With his last jump he equalled the world record.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Cooperation equals success.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""More knowledge equals less prejudice.""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She treats the people who work for her as her equals.""");
  }
...
کوردی: بەقەدیەک، بەرامبەر، یەکسان، چوون، هاوجووت، هاوئاست، هاوئەندازە، یەک‌ئەندازە، سەک‌سەنگ، هاوسەنگ، هاوشان، هاوپلە،	هاوتا،	ژمارەی بەرامبەر، بڕی بەرامبەر
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) وەک یەکێکی دیکە لە بەها، قەبارە، بڕ، هتد"""),
          SentencesRow(
            englishText: """Cut it into four equal parts.""",
            kurdishText: """بیبڕە بۆ چوار بەشی یەکسان.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The two countries are roughly equal in size.""",
            kurdishText: """دوو وڵاتەکە بە نزیکەیی هەمان قەبارەن.""",
                ...
                children: [
                  SentencesRow(
                    englishText:
                        """An area of forest equal to the size of Wales has been destroyed.""",
                    kurdishText:
                        """ناوچەیەک لە دارستان بە ئەندازەی وێڵز لەناوبراوە.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """یەک پاوەند بەنزیکەیی یەکسانە بە دوو دۆلار.""",
                  ...
                  SentencesRow(
                    englishText:
                        """The EU nations together have an economy about equal in size to that of the US.""",
                    kurdishText:
                        """وڵاتەکانی یەکێتیی ئەورووپا پێکەوە ئابوورییەکیان هەیە بەنزیکەیی هاوتا لەگەڵ هی ئەمریکایە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """پێـ‌وایە هەموان بە یەکسانی لەدایک دەبن.""",
          ...
          SentencesRow(
            englishText:
                """The US constitution guarantees equal protection under the law.""",
            kurdishText:
                """دەستووری ئەمریکا پاراستنی یەکسان دەدات بەپێی یاسا.""",
          ...
          const DefinitionKurdish(
              text:
                  """٤. (ھاوەڵناو) هەبوونی بوێری، هێز، یان توانا بۆ مامەڵە لەگەڵ شتێک"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """I hope that he proves equal to the challenge.""",
            kurdishText: """هیوادارم شایستە بێت بە ئەرکەکە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """A metre equals 39.38 inches.""",
            kurdishText: """یەک مەتر دەکاتە ٣٩,٣٨ ئینج.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Three and three equals six.""",
            kurdishText: """سێ و سێ دەکەنە شەش.""",
          ...
          const DefinitionKurdish(
              text:
                  """٦. (کردار) باش بوون هێندەی شتێکی دیکە، یان کردنی شتێک بەباشی وەک کەسێکی دیکە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """This achievement is unlikely ever to be equalled.""",
            kurdishText: """سەرکەوتەکە ئەگەری کەمە هەرگیز هاوتا بکرێتەوە.""",
            onPressedBritish: () => speaksentence12("en-GB"),
            kurdishNote: "واتە ئەوەی کە دەسکەوتێکی وەک ئەوە دووبارە بکرێتەوە",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """With his last jump he equalled the world record.""",
            kurdishText: """بە بازی کۆتایی یەکسان بوو لەگەڵ ڕیکۆردی جیهانی.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هاوئاهەنگی دەبێت بە سەرکەوتن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """More knowledge equals less prejudice.""",
            kurdishText: """زانیاری زیاتر واتە ڕقی کەمتر.""",
          ...
          const DefinitionKurdish(
              text:
                  """٨. (کردار) کەسێک یان شتێک کە هاوتایە لەگەڵ شتێکی دیکە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """She treats the people who work for her as her equals.""",
            kurdishText:
                """وەک هاوتا مامەڵە لەگەڵ ئەو کەسانە دەکات کە کاری بۆ دەکەن.""",
          ...
          SentencesRow(
            englishText:
                """Our cars are the equal of those produced anywhere in the world.""",
            kurdishText:
                """ئۆتۆمبێلەکانمان هاوتان لەگەڵ ئەوانەی لە شوێنەکانی دیکەی جیهان بەرهەم دێن.""",
...
2. Having the requisite qualities or resources to meet a task (= adequate)
"he was equal to the task";

Verb: equal (Derived forms: equalled, equaling, equaled, equalling, equals)
1. Be identical or equivalent to (= be)
"One dollar equals 1,000 rubles these days!";
 
2. Be equal to in quality or ability (= touch, rival, match)
"Your performance doesn't even equal that of your colleagues";
 
3. Make equal, uniform, corresponding, or matching (= match, equalize, equalise [Brit], equate)

- Noun: equal (Derived forms: equals)
1. A person who is of equal standing with another in a group (= peer, match, compeer)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/_GFkHA5EZdE?t=';
const double _startSecondsend = 000000000000000000000000000000; // 180;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/zqllxbPWKNI?t=';
const double _startSecondsone = 00000000000000000000000000000; // 256;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/55XJ1ObZKaM?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1030;
const String _videoIdthree = 'VIDEOhttps://youtu.be/II-OP6vdMs8?t=';
const double _startSecondsthree = 000000000000000000000000000; // 195;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/yGt2IPmGgmI?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 37;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/851v18xoDWA?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 2027;
