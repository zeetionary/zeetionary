...
class EnglishEntrylightweight extends StatefulWidget {
  const EnglishEntrylightweight({super.key});

  @override
  State<EnglishEntrylightweight> createState() => _EnglishEntrylightweightState();
}

class _EnglishEntrylightweightState extends State<EnglishEntrylightweight> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lightweight""");
  }
