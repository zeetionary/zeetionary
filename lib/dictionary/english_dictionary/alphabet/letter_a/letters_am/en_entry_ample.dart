...
// replace these: replace EnglishEntryample - replace speakAmple - replace ample - /ˈæmpl/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryample extends StatelessWidget {
  EnglishEntryample({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAmple(String languageCode) async {
    // DOPSUM: CHANGE speakAmple
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("ample"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAmple001(String languageCode) async {
    ...
    await flutterTts.speak(
        "There was ample time to get to the airport."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAmple4408(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "These clothes belonged to a man of more ample girth."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "ample"), // DOPSUM: CHANGE WORD ENTRY - Find /ˈæmpl/
                            // divvviiider
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /ˈæmpl/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                            CustomIconButtonBritish(
                              onPressed: () =>
                                  speakAmple(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /ˈæmpl/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                            CustomIconButtonAmerican(
                              onPressed: () => speakAmple(
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'F0jr-HQeT74';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'VfShZEWRbXw';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'tfn-LC254Hk';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'qW_ThmMnZI0';
