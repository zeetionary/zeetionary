...
class EnglishEntryleisure extends StatefulWidget {
  const EnglishEntryleisure({super.key});

  @override
  State<EnglishEntryleisure> createState() => _EnglishEntryleisureState();
}

class _EnglishEntryleisureState extends State<EnglishEntryleisure> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: leisure (Derived forms: leisures)
1. Time available for ease and relaxation (- leisure time)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""leisure""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Make the most of your leisure time!""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""These days we have more money and more leisure to enjoy it.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""These days we have increased opportunities for leisure.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/ht7MNqZT_hU?t=210';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/QytntXWJIe8?t=320';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/a6qna-ZCbxA?t=565';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/Ep6-bNu16_I?t=477';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/yyv2gOHMGEc?t=611';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/uT_GcOGEFsk?t=743';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """leisure""",
                      // alsoEnglishWord: "also: leisure",
                      britshText: """IpaUK: /ˈleʒə(r)/""",
                      americanText: """IpaUS: /ˈliːʒər/""",
...
کوردی: دەسپەرژ، دەس‌گەیشتن، دەسپەرژان، دەس‌بەتاڵی، کاتی پشوو، بێکاری، لێبوونەوە، دەرفەت،	ڕابوێر، خۆش‌گوزەران، ئاسوودە، حەساوە، تەناهـ
"""),
// With short examples define "leisure", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) کاتی بەتاڵ؛ ئەو کاتەی کار ناکەیت یان ناخوێنیته"""),
                    SentencesRow(
                      englishText: """Make the most of your leisure time!""",
                      kurdishText: """زۆرترین چێژ ببینە لە کاتی بەتاڵت!""",
                    ...
                    SentencesRow(
                      englishText: """These days we have more money and more leisure to enjoy it.""",
                      kurdishText: """ئەم ڕۆژانە پارە و کاتی بەتاڵمان زیاترە بۆ چێژبینین لێیان.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ئەو چالاکییانەی کە لە کاتی بەتاڵدا حەز دەکەیت بیان کەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """These days we have increased opportunities for leisure.""",
                      kurdishText: """ئەم ڕۆژانە هەلی ڕابواردنمان زیاد کردووە.""",
