...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Passers-by grappled with the man after the attack.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I was grappling to find an answer to his question.""");
  }
...
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) گرتنی کەسێک/شتێک بە توندی و ڕووبەڕووبوونەوە یان وەستانەوە دژی"""),
                    SentencesRow(
                      englishText:
                          """Passers-by grappled with the man after the attack.""",
                      kurdishText:
                          """ڕێبواران ڕووبەڕووی پیاوەکە بوونەوە لە دوای ھێرشەکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) ھەوڵدان بە سەختی بۆ دۆزینەوەی چارەسەری کێشەیەک"""),
                    SentencesRow(
                      englishText:
                          """The new government has yet to grapple with the problem of air pollution.""",
                      kurdishText:
                          """حکومەتە تازەکە ھێشتا تەقەڵایەتی لەگەڵ کێشەی پیسبوونی ھەوا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەقەڵام بوو بۆ دۆزینەوەی وەڵامی پرسیارەکەی.""",
...
const double _startSecondsend = 507;
const String _videoIdone = 'axcPoS2sF0E';
const double _startSecondsone = 41;
const String _videoIdtwo = 'Zad6v8ZHzdg';
const double _startSecondstwo = 1115;
const String _videoIdthree = 'WRU5m3Q3gkw';
const double _startSecondsthree = 15;
const String _videoIdfour = '3KC32Vymo0Q';
const double _startSecondsfour = 1606;
const String _videoIdfive = 'RAlI0pbMQiM';
const double _startSecondsfive = 621;
