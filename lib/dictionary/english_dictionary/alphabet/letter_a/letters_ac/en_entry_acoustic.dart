...
// replace these: replace EnglishEntryacoustic - replace speakAcoustic - replace acoustic - /əˈkuːstɪk/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryacoustic extends StatelessWidget {
  EnglishEntryacoustic({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAcoustic(String languageCode) async {
    // DOPSUM: CHANGE speakAcoustic
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("acoustic"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAco1537(String languageCode) async {
    // DOPSUM: CHANGE speakAcoustic
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "The microphone converts acoustic waves to electrical signals for transmission."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'acoustic', // DOPSUM: CHANGE WORD ENTRY - Find /əˈkuːstɪk/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈkuːstɪk/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /əˈkuːstɪk/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 't5k7feqZUD0';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'dq8scgJCg7w';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'JUidQ1y_mmQ';
