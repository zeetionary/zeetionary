...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'Aoof8rEPQb0';
    const double startSecondsend = 110;
    const String videoIdone = 'YBx7ZT6FIrU';
    const double startSecondsone = 195;
    const String videoIdtwo = 'Solb9uA-tgQ';
    const double startSecondstwo = 23792;
    const String videoIdthree = 'vFANgWN2Ul0';
    const double startSecondsthree = 577;
    const String videoIdfour = 'wEPBoWJGfbU';
    const double startSecondsfour = 277;
    const String videoIdfive = 'PM7ap2CA_6U';
    const double startSecondsfive = 592;
