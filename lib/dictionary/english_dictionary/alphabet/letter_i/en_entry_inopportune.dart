...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'q1oO5H8Gfr8';
    const double startSecondsend = 498;
    const String videoIdone = 'prVHU1fLR20';
    const double startSecondsone = 529;
    const String videoIdtwo = 'F5ozykwPYHI';
    const double startSecondstwo = 524;
    const String videoIdthree = 'EQoCDlnLN10';
    const double startSecondsthree = 197;
    const String videoIdfour = 'bhTRxyXtfUU';
    const double startSecondsfour = 129;
    const String videoIdfive = 'Mvm8RTdJgq0';
    const double startSecondsfive = 464;
