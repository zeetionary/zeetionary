...
class EnglishEntryaccustomed extends StatefulWidget {
  const EnglishEntryaccustomed({super.key});

  @override
  State<EnglishEntryaccustomed> createState() => _EnglishEntryaccustomedState();
}

class _EnglishEntryaccustomedState extends State<EnglishEntryaccustomed> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "accustomed";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""accustomed""");
  }
  ...
  Future<void> speakac52687(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("My eyes slowly grew accustomed to the dark.");
  }
  ...
  Future<void> speakac5278(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("This was not the kind of behaviour I was accustomed to.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accustomed""",
                      // alsoEnglishWord: "also: accustomed",
                      britshText: """IpaUK: /əˈkʌstəmd/""",
                      americanText: """IpaUS: /əˈkʌstəmd/""",
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final double _startSeconds = 3096;
