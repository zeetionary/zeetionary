...
کوردی: گڕ، بڵێسە، سۆڵە، پڕیشکە، گڵپە، گرپە (وەک هی چۆڵەچرا)،	ڕووناکی، شەوق، گەشانەوە، بریسکانەوە، ڕۆشنایی،	چرا یان نیشانەی دەریایی،	شەوق‌هاوێژ،	پانەوەبوون، فش‌بوونەوە، چەترهەڵپێچان (داوێن)،	تووڕەی لەناکاو،	(سەربازی) فشفشە، ڕۆشنە، شەڵواری دەلینگ‌هەراو
"""),
// With short examples define "flare", please follow LX instructions
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) لەناکاو دەست پێکردن یان بەهێزتر بوون"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Violence flared when the police moved in.""",
                      kurdishText: """توندوتیژی دەستی پێکرد کە پۆلیس هات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بڵێسەیەکی لەناکاو هەبوو کە تەنکەرێکی سووتەمەنی تەقییەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بۆمبهاوێژەکە ڕووناکییەکی بەردایەوە بۆ ڕۆشنکردنەوەی ئامانجەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """قژی درێژکرد و دەستی کرد بە لەپێ کردنی شەڵواری دەلینگ‌هەراو.""",
...
const double _startSecondsend = 0000000000000000000000000001309;
const String _videoIdone = 'https://youtu.be/pTysrwci0pU?t=';
const double _startSecondsone = 000000000000000000000000000866;
...
const String _videoIdfive = 'https://youtu.be/YrMGIqecu0Y?t=';
