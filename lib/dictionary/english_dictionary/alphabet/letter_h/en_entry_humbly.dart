...
class EnglishEntryhumbly extends StatefulWidget {
  const EnglishEntryhumbly({super.key});

  @override
  State<EnglishEntryhumbly> createState() => _EnglishEntryhumblyState();
}

class _EnglishEntryhumblyState extends State<EnglishEntryhumbly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: humbly
1. In a humble manner (- meekly)
"he humbly lowered his head";
 
2. In a miserly manner (- meanly)
"they lived humbly and without ostentation";
""",
  );

  final String keyword = "humbly";
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/EtgxTKuN018?t=';
    const double startSecondsend = 00000000000000000000000000018;
    const String videoIdone = 'https://youtu.be/5R65skWdg7Y?t=';
    const double startSecondsone = 0000000000000000000000000002676;
    const String videoIdtwo = 'https://youtu.be/Ya3YkK0tkUU?t=';
    const double startSecondstwo = 0000000000000000000000000001779;
    const String videoIdthree = 'https://youtu.be/Mtl-Lc1y4YU?t=';
    const double startSecondsthree = 000000000000000000000000000193;
    const String videoIdfour = 'https://youtu.be/cb0pb-OHaM4?t=';
    const double startSecondsfour = 000000000000000000000000000585;
    const String videoIdfive = 'https://youtu.be/sY8aFSY2zv4?t=';
    const double startSecondsfive = 0000000000000000000000000003904;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """humbly""",
                      // alsoEnglishWord: "also: humbly",
                      britshText: """IpaUK: /ˈhʌmbli/""",
                      americanText: """IpaUS: /ˈhʌmbli/""",
...
// With short examples define "humbly", please follow LX instructions
                    ...
                    const AlsoEnglishckb(word: "ھەروەھا: modestly"),
                    SentencesRow(
                      englishText:
                          """I would humbly suggest that there is something wrong here.""",
                      kurdishText:
                          """بە سادەیی ئاماژە بەوە دەکەم شتێک هەڵەیە لێرەدا.""",
