...
class EnglishEntryausterity extends StatelessWidget {
  ...
  Future<void> speakausterity(String languageCode) async {
    ...
    await flutterTts.speak("austerity");
  }
  ...
  Future<void> speakausterity518(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("War was followed by many years of austerity.");
  }
  ...
  Future<void> speakausterity524(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("He was noted for his austerity and authoritarianism.");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'S5vOKKMipSA';
  final double _startSeconds = 2079;
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'omcUaD8pxaY';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'UZhW1k_m7OY';
  final double _startSeconds = 3026;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '8EOxtY3M6Co';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '7oY5WNAgb90';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'EJEi-pP9Rjs';
  final double _startSeconds = 2550;
