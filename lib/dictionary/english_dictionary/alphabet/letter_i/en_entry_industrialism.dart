...
class EnglishEntryindustrialism extends StatefulWidget {
  const EnglishEntryindustrialism({super.key});

  @override
  State<EnglishEntryindustrialism> createState() =>
      _EnglishEntryindustrialismState();
}

class _EnglishEntryindustrialismState extends State<EnglishEntryindustrialism> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: industrialism (Derived forms: industrialisms)
...
""",
  ...
  final String keyword = "industrialism";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""industrialism""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The rise of industrialism changed many cities.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/65tc_KzZQ98?t=';
    const double startSecondsend = 000000000000000000000000000470;
    const String videoIdone = 'https://youtu.be/N5631zptrU4?t=';
    const double startSecondsone = 000000000000000000000000000111;
    const String videoIdtwo = 'https://youtu.be/S45TLjZDzPk?t=';
    const double startSecondstwo = 000000000000000000000000000140;
    const String videoIdthree = 'https://youtu.be/aCpxP51SOmE?t=';
    const double startSecondsthree = 000000000000000000000000000456;
    const String videoIdfour = 'https://youtu.be/X41IMGIHgIo?t=';
    const double startSecondsfour = 0000000000000000000000000001186;
    const String videoIdfive = 'https://youtu.be/iMiE90AnvFk?t=';
    const double startSecondsfive = 000000000000000000000000000578;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """industrialism""",
                      // alsoEnglishWord: "also: industrialism",
                      britshText: """IpaUK: /ɪnˈdʌstriəlɪzəm/""",
                      americanText: """IpaUS: /ɪnˈdʌstriəlɪzəm/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) سیستەمێکی ئابووری یان کۆمەڵایەتی کە پشطی بە پیشەسازی بەستووە"""),
                    SentencesRow(
                      englishText:
                          """The rise of industrialism changed many cities.""",
                      kurdishText:
                          """دەرکەوتنی کۆمەڵگای پیشەسازییەت زۆر شاری گۆڕی.""",
