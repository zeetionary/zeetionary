...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The sun was shining hazily through the palm leaves.""");
  }
...
// With short examples define "hazily", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) کە ڕوون نییە بەهۆی تەمەوە"""),
                    SentencesRow(
                      englishText:
                          """The sun was shining hazily through the palm leaves.""",
                      kurdishText:
                          """خۆرەکە تەماوییانە بە گەڵای دار خورماکاندا دەدرەوشایەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بە شێوەیەک کە ڕوون نییە بەهۆی کەمی یادەوەری، زانیاری، یان وردەکاری"""),
                    SentencesRow(
                      englishText: """This all seems hazily familiar.""",
                      kurdishText:
                          """ئەمە هەمووی تەم‌ومژاوییانە ئاشنا دیارە.""",
