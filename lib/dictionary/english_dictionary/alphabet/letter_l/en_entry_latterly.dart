...
class EnglishEntrylatterly extends StatefulWidget {
  const EnglishEntrylatterly({super.key});

  @override
  State<EnglishEntrylatterly> createState() => _EnglishEntrylatterlyState();
}

class _EnglishEntrylatterlyState extends State<EnglishEntrylatterly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: latterly
1. In the recent past (- recently, late, lately, of late, as of late)
"the spelling was first affected, but latterly the meaning also";
""",
  );

  final String keyword = "latterly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""latterly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Latterly his painting has shown a new freedom of expression.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her health declined rapidly and latterly she never left the house.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/Blhu8kZ20Pw?t=18';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/gS2GG1rDoZw?t=279';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/6CZ0Q6jw4Z4?t=17937';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/PthWFfPz6fQ?t=28';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/3h014oOO9RM?t=40';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/MHchPPoOZrY?t=2871';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """latterly""",
                      // alsoEnglishWord: "also: latterly",
                      britshText: """IpaUK: /ˈlætəli/""",
                      americanText: """IpaUS: /ˈlætərli/""",
...
کوردی: بەم داوایی‌یانە، بەم‌زووانە، بە تازەیی، تازەگی، لەم ئاخروئۆخرەدا
"""),
// With short examples define "latterly", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵکار) تازەترین"""),
                    SentencesRow(
                      englishText: """Latterly his painting has shown a new freedom of expression.""",
                      kurdishText: """تازەگی تابلۆکانی ئازادییەکی تازە لە دەربڕین پیشان دەدەن.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵکار) بەرەو کۆتایی کاتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her health declined rapidly and latterly she never left the house.""",
                      kurdishText: """تەندرووستی بە خێرایی دابەزی و لە کۆتاییدا هەرگیز ماڵەوەی جێنەهێشت.""",
