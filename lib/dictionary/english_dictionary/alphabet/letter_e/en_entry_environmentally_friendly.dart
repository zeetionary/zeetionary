...
class EnglishEntryenvironmentallyfriendly extends StatefulWidget {
  const EnglishEntryenvironmentallyfriendly({super.key});

  @override
  State<EnglishEntryenvironmentallyfriendly> createState() =>
      _EnglishEntryenvironmentallyfriendlyState();
}

class _EnglishEntryenvironmentallyfriendlyState
    extends State<EnglishEntryenvironmentallyfriendly> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""environmentally-friendly""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: environmentally-friendly",
                      britshText: """IpaUK: /ɪnˌvaɪrənmentəli ˈfrendli/""",
                      americanText: """IpaUS: /ɪnˌvaɪrənmentəli ˈfrendli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "environmentally-friendly";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We will use environmentally friendly energy sources.""");
  }
...
// With short examples define "environmentally-friendly", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) کە زیان بە ژینگە ناگەیەنێت"""),
          SentencesRow(
            englishText:
                """We will use environmentally friendly energy sources.""",
            kurdishText: """سەرچاوەی وزەی ژینگەدۆست بەکاردەهێنین.""",
...
1. Not damaging to the environment, or directed at preventing environmental damage (= green, eco-friendly)
"Retailers can influence consumers by promoting environmentally-friendly products and ideas in their shops";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/VS6tnF31zr4?t=';
const double _startSecondsend = 000000000000000000000000000000; // 760;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/T48_SrFCdaQ?t=';
const double _startSecondsone = 00000000000000000000000000000; // 412;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/HPv1GQ6ojcE?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 279;
const String _videoIdthree = 'VIDEOhttps://youtu.be/RfmFNM9PHa0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 210;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/o2dvXWX3Sdw?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 276;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/Y4wrxLVs3eU?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 152;
