...
class EnglishEntryentertainment extends StatefulWidget {
  const EnglishEntryentertainment({super.key});

  @override
  State<EnglishEntryentertainment> createState() =>
      _EnglishEntryentertainmentState();
}

class _EnglishEntryentertainmentState extends State<EnglishEntryentertainment> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""entertainment""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """entertainment""",
                      // alsoEnglishWord: "also: entertainment",
                      britshText: """IpaUK: /ˌentəˈteɪnmənt/""",
                      americanText: """IpaUS: /ˌentərˈteɪnmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "entertainment";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There will be live entertainment at the party.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They set a budget for the entertainment of clients.""");
  }
...
// With short examples define "entertainment", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) فیلم، میوزیک، هتد کە بەکاردێت بۆ دڵخۆشکردنی خەڵکی"""),
          SentencesRow(
            englishText: """There will be live entertainment at the party.""",
            kurdishText: """سەرگەرمیی ڕاستەوخۆ لە ئاهەنگەکە دەبێت.""",
          ...
          SentencesRow(
            englishText:
                """It's pure entertainment and there's nothing wrong with that.""",
            kurdishText: """بەزمەساتێکی تەواو بوو و هیچی هەڵەی تێدا نەبوو.""",
          ...
          SentencesRow(
            englishText:
                """Ladies and gentlemen, for your entertainment, we present Magic Man.""",
            kurdishText:
                """بەڕێزان و خانمان، بۆ دڵخۆشی ئێوە، ماجیک مان دەناسێنین.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """بودجەیەکیان تەرخان کرد بۆ میوانداریی موشتەرییەکان.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: entertainment (Derived forms: entertainments)
1. An activity that is diverting and that holds the attention (= amusement)
""",
  );
...
const String _videoIdone = 'https://youtu.be/F5pgG1M_h_U?t=';
const double _startSecondsone = 347;
const String _videoIdtwo = 'https://youtu.be/CQQit01HHLY?t=';
const double _startSecondstwo = 424;
const String _videoIdthree = 'https://youtu.be/tMNxgi_0eKA?t=';
const double _startSecondsthree = 395;
const String _videoIdfour = 'https://youtu.be/HxRUuGqqMG4?t=';
const double _startSecondsfour = 1502;
const String _videoIdfive = 'https://youtu.be/eo62AEDwTKY?t=';
const double _startSecondsfive = 305;
const String _videoIdsix = 'https://youtu.be/8o12WrHBhU0?t=';
const double _startSecondssix = 437;
