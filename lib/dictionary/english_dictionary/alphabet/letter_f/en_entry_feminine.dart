...
class EnglishEntryfeminine extends StatefulWidget {
  const EnglishEntryfeminine({super.key});

  @override
  State<EnglishEntryfeminine> createState() => _EnglishEntryfeminineState();
}

class _EnglishEntryfeminineState extends State<EnglishEntryfeminine> {
  @override
  void initState() {
    super.initState();
...
2. Female (of grammatical gender)
 
3. Befitting or characteristic of a woman especially a mature woman (= womanly)
"feminine virtues of gentleness and compassion";
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""feminine""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He had delicate, almost feminine, features.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She looked very feminine with her hair like that.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The French word for ‘table’ is feminine.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """feminine""",
                      // alsoEnglishWord: "also: feminine",
                      britshText: """IpaUK: /ˈfemənɪn/""",
                      americanText: """IpaUS: /ˈfemənɪn/""",
...
کوردی: ژنانە، سەربە ژنان، ژن‌ئاسا،	(ڕێزمان) مێ
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆر مێینە دەردەکەوێت بە قژی لەو شێوەیەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """وشەی فەرەنسی بۆ 'مێز' مێینەیە.""",
...
const String _videoIdend = 'https://youtu.be/65CFesU4KVQ?t=';
const double _startSecondsend = 000000000000000000000000000535;
...
const String _videoIdthree = 'https://youtu.be/EpGCCKB3Oag?t=';
const double _startSecondsthree = 000000000000000000000000000525;
const String _videoIdfour = 'https://youtu.be/fn--IVarumw?t=';
const double _startSecondsfour = 000000000000000000000000000182;
const String _videoIdfive = 'https://youtu.be/ShMRAN78598?t=';
const double _startSecondsfive = 000000000000000000000000000134;
