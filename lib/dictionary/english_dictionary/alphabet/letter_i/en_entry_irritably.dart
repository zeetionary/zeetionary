...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'Hj_rA0dhr2I';
    const double startSecondsend = 3156;
    const String videoIdone = '9rL5VsooQyI';
    const double startSecondsone = 1530;
    const String videoIdtwo = 'LIImP_edkK0';
    const double startSecondstwo = 502;
    const String videoIdthree = 'TVUQa2zeS18';
    const double startSecondsthree = 41;
    const String videoIdfour = 'tz_Z_Dpn3-A';
    const double startSecondsfour = 1031;
    const String videoIdfive = 'bdmZq4ooHpI';
