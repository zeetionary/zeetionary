...
class EnglishEntryhideout extends StatefulWidget {
  const EnglishEntryhideout({super.key});

  @override
  State<EnglishEntryhideout> createState() => _EnglishEntryhideoutState();
}

class _EnglishEntryhideoutState extends State<EnglishEntryhideout> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hideout (Derived forms: hideouts)
1. A hiding place; usually a remote place used by outlaws (- hideaway, den)
"a snug hideout";
""",
  );

  final String keyword = "hideout";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hideout""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The guerrillas had a hideout in the mountains.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hideout""",
                      // alsoEnglishWord: "also: hideout",
                      britshText: """IpaUK: /ˈhaɪdaʊt/""",
                      americanText: """IpaUS: /ˈhaɪdaʊt/""",
...
کوردی: 
"""),
// With short examples define "hideout", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) شوێنێک کە کەسێک بۆی دەچێت کە نایەوێت کەس بیدۆزێتەوە"""),
                    SentencesRow(
                      englishText:
                          """The guerrillas had a hideout in the mountains.""",
                      kurdishText:
                          """گەریلاکان حەشارگەیەکیان لە چیاکە هەبوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/YGcWcsajSDQ?t=';
const double _startSecondsend = 000000000000000000000000000310;
const String _videoIdone = 'https://youtu.be/awcQ9-QvZLs?t=';
...
const String _videoIdthree = 'https://youtu.be/wkkx4PCcZjU?t=';
const double _startSecondsthree = 000000000000000000000000000543;
const String _videoIdfour = 'https://youtu.be/v394vC23HW0?t=';
const double _startSecondsfour = 000000000000000000000000000441;
const String _videoIdfive = 'https://youtu.be/NHo6oTKcu7o?t=';
