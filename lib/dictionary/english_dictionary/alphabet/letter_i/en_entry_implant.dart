...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Pon4Zux5MaQ?t=';
    const double startSecondsend = 000000000000000000000000000369;
    const String videoIdone = 'https://youtu.be/lsbcN9-jU1Y?t=';
    const double startSecondsone = 000000000000000000000000000392;
    const String videoIdtwo = 'https://youtu.be/Mf4wwXM2o_M?t=';
    const double startSecondstwo = 000000000000000000000000000265;
    const String videoIdthree = 'https://youtu.be/bii-ci1Zc_c?t=';
    const double startSecondsthree = 000000000000000000000000000301;
    const String videoIdfour = 'https://youtu.be/iDNZGw6uWZg?t=';
    const double startSecondsfour = 000000000000000000000000000178;
    const String videoIdfive = 'https://youtu.be/Cg10exNmf7I?t=';
    const double startSecondsfive = 000000000000000000000000000100;
