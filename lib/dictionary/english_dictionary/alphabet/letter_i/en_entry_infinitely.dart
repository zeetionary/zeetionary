...
class EnglishEntryinfinitely extends StatefulWidget {
  const EnglishEntryinfinitely({super.key});

  @override
  State<EnglishEntryinfinitely> createState() => _EnglishEntryinfinitelyState();
}

class _EnglishEntryinfinitelyState extends State<EnglishEntryinfinitely> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infinitely""");
  }
