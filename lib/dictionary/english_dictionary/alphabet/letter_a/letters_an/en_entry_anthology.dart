...
class EnglishEntryanthology extends StatefulWidget {
  const EnglishEntryanthology({super.key});

  @override
  State<EnglishEntryanthology> createState() => _EnglishEntryanthologyState();
}

class _EnglishEntryanthologyState extends State<EnglishEntryanthology> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "anthology";
  ...
  Widget build(BuildContext context) {
    const String videoIdend = 'dQssQwPE1vA';
    const double startSecondsend = 29;
    const String videoIdone = '2BZw_k7K0YE';
    const double startSecondsone = 6;
    const String videoIdtwo = 'obbyWj92PkA';
    const double startSecondstwo = 15;
    const String videoIdthree = 'Ky1c6d7v0pQ';
    const double startSecondsthree = 152;
    const String videoIdfour = 'VUKtjst3gsg';
    const double startSecondsfour = 906;
    const String videoIdfive = '0acJuZsr_nQ';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """anthology""",
                      // alsoEnglishWord: "also: anthology",
                      britshText: """IpaUK: /ænˈθɒlədʒi/""",
                      americanText: """IpaUS: /ænˈθɑːlədʒi/""",
