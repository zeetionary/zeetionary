...
class EnglishEntrygrandiose extends StatefulWidget {
  const EnglishEntrygrandiose({super.key});

  @override
  State<EnglishEntrygrandiose> createState() => _EnglishEntrygrandioseState();
}

class _EnglishEntrygrandioseState extends State<EnglishEntrygrandiose> {
  @override
  void initState() {
    super.initState();
...
2. Affectedly genteel; to carry an air of affected importance; to be snobbish and haughty (- hifalutin [informal], highfalutin [informal], highfaluting [informal], hoity-toity [informal], la-di-da [informal], lah-di-dah [informal], la-de-da [informal])
"It might be a bit of an arty lifestyle, but it's not a grandiose, fashionable life";
""",
  );

  final String keyword = "grandiose";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grandiose""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grandiose""",
                      // alsoEnglishWord: "also: grandiose",
                      britshText: """IpaUK: /ˈɡrændiəʊs/""",
                      americanText: """IpaUS: /ˈɡrændiəʊs/""",
...
// With short examples define "grandiose", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە زۆر سەرنجڕاکێشە بەڵام زۆر گەورە، ئاڵۆز، گرانبەها، هتد ـــە تاوەکو بکرێت بە کردار"""),
                    SentencesRow(
                      englishText:
                          """The grandiose scheme for a journey across the desert came to nothing.""",
                      kurdishText:
                          """پلانێکی گەورە بۆ گەشتێک بە بیابانەکە لە هیچ دەرچوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He could no longer live the grandiose lifestyle to which he had become accustomed.""",
                      kurdishText:
                          """چیتر نەیدەتوانی لەو شێوازە ژیانەدا بژی کە پێی ڕاهاتبوو.""",
...
const double _startSecondsend = 0000000000000000000000000001141;
const String _videoIdone = 'https://youtu.be/KZbzIf_C6Y4?t=';
const double _startSecondsone = 000000000000000000000000000871;
const String _videoIdtwo = 'https://youtu.be/6dv8zJiggBs?t=';
const double _startSecondstwo = 00000000000000000000000000037;
const String _videoIdthree = 'https://youtu.be/C4sAUc_ZGMY?t=';
const double _startSecondsthree = 00000000000000000000000000018;
const String _videoIdfour = 'https://youtu.be/YTbeRTH7jkg?t=';
const double _startSecondsfour = 000000000000000000000000000164;
const String _videoIdfive = 'https://youtu.be/KJU6ZK4EWVw?t=';
