...
// Define the word "aura" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace aura - replace EnglishEntryaura

// replace speakAura - /ˈɔːrə/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryaura extends StatelessWidget {
  // blank divider
  EnglishEntryaura({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAura(String languageCode) async {
    // DOPSUM: CHANGE speakAura
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("aura"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAura414(String languageCode) async {
    // DOPSUM: CHANGE speakAura
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("She always has an aura of confidence."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "aura"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /ˈɔːrə/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                            CustomIconButtonBritish(
                              onPressed: () => speakAura("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /ˈɔːrə/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find WORD_WEB
                            CustomIconButtonAmerican(
                              onPressed: () => speakAura("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "TDT3GnkF_U4";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "sQ0WsP7osAU";
...
// end aura // TODO Implement this library.