...
class EnglishEntryachieve extends StatelessWidget {
  EnglishEntryachieve({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 11, // 2 + VIDEOS FIND: DOPSUM_WRITE_A_SENTENCE
      child: Scaffold(
        appBar: AppBar(
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'achieve', // DOPSUM: CHANGE WORD ENTRY - Find /əˈtʃiːv/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈtʃiːv/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAchieve(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'IOYfmDbiKBQ';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'EnWiGYT1g4';
