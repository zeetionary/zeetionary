...
class EnglishEntryfluently extends StatefulWidget {
  const EnglishEntryfluently({super.key});

  @override
  State<EnglishEntryfluently> createState() => _EnglishEntryfluentlyState();
}

class _EnglishEntryfluentlyState extends State<EnglishEntryfluently> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fluently""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She speaks German fluently.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'd like to speak English fluently.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fluently""",
                      // alsoEnglishWord: "also: fluently",
                      britshText: """IpaUK: /ˈfluːəntli/""",
                      americanText: """IpaUS: /ˈfluːəntli/""",
...
// With short examples define "fluently", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """She speaks German fluently.""",
                      kurdishText: """بە پاراوی بە ئەڵمانی قسە دەکات.""",
                    ...
                    SentencesRow(
                      englishText: """I'd like to speak English fluently.""",
                      kurdishText:
                          """حەز دەکەم بە ڕەوانی قسە بە ئینگلیزی بکەم.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/95RLviccrQc?t=';
...
const String _videoIdtwo = 'https://youtu.be/eWHN7pBRzIo?t=';
const double _startSecondstwo = 000000000000000000000000000242;
const String _videoIdthree = 'https://youtu.be/vsMydMDi3rI?t=';
const double _startSecondsthree = 0000000000000000000000000001143;
const String _videoIdfour = 'https://youtu.be/3i1lNJPY-4Q?t=';
const double _startSecondsfour = 0000000000000000000000000001161;
const String _videoIdfive = 'https://youtu.be/A1D520DnCZE?t=';
