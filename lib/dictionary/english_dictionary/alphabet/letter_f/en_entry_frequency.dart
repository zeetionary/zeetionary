...
class EnglishEntryfrequency extends StatefulWidget {
  const EnglishEntryfrequency({super.key});

  @override
  State<EnglishEntryfrequency> createState() => _EnglishEntryfrequencyState();
}

class _EnglishEntryfrequencyState extends State<EnglishEntryfrequency> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frequency (Derived forms: frequencies)
1. The number of occurrences within a given time period (= frequence, oftenness)
"the frequency of modulation was 40 cycles per second";
 
2. The ratio of the number of observations in a statistical category to the total number of observations (= relative frequency)
 
3. The number of observations in a given statistical category (= absolute frequency)
""",
  );

  final String keyword = "frequency";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frequency""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The program can show us word frequency.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Bullets bounced off the rock with alarming frequency.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frequency""",
                      // alsoEnglishWord: "also: frequency",
                      britshText: """IpaUK: /ˈfriːkwənsi/""",
                      americanText: """IpaUS: /ˈfriːkwənsi/""",
...
کوردی: فراوانی، زۆری، فرەهی،	دووبارەبوونەوە، زۆرڕوودان، زۆرقەومان، چەندبارەبوونەوە، چەندپاتەیی،	(فیزیک) لەرە، لەرینەوە،	(ڕادیۆ) شەپۆل
"""),
// With short examples define "frequency", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Dawn was then visiting New York with increasing frequency.""",
                      kurdishText:
                          """دۆن ئەو کاتانە بە ماوەماوەی زیاترەوە سەردانی نیویۆرکی دەکرد.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Fatal road accidents have decreased in frequency over recent years.""",
                      kurdishText:
                          """لە ساڵانی نزیکدا ئاستی ڕووداوە کوشندەکانی هاتووچۆ زیادی کردووە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Users will be able to rearrange their icons by frequency of use.""",
                      kurdishText:
                          """بەکارهێنەران دەتوانن ئایکۆنەکانیان بەپێی ڕێژەی بەکارهێنان ڕیزبەند بکەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پڕۆگرامەکە دەتوانێت ڕێژەی بەکارهێنانی وشەیەکمان پێ بڵێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The relative frequency of this illness in the area is of concern to all doctors.""",
                      kurdishText:
                          """ڕێژەی تا ڕادەیەک زۆر ڕوودانی ئەم نەخۆشییە لە ناوچەکە مایەی نیگەرانیی هەموو پزیشکانە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """فیشەکە لە بەردەکە هەڵدەبەزینەوە بە ڕێژەی زۆری جێگەی نیگەرانی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Electromagnetic waves of radio frequency can make molecules vibrate and heat up.""",
                      kurdishText:
                          """شەپۆلە کارۆموگناتیسییەکانی لەرەی ڕادیۆ دەکرێت تەنۆلکەکان بلەرێنێتەوە و گەرمیان بکات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ناو) ژمارەی ئەو شەپۆلە ڕادیۆییانەی کە هەیە بۆ هەر چرکەیەکی پەیامی ڕادیۆیی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """There are only a limited number of broadcasting frequencies.""",
                      kurdishText:
                          """تەنها ژمارەیەکی سنووردار لە شەپۆلەکانی پەخشکردن هەن.""",
...
const String _videoIdtwo = 'https://youtu.be/dNKQYjsxgPU?t=';
const double _startSecondstwo = 00000000000000000000000000027;
const String _videoIdthree = 'https://youtu.be/D8tPkb98Fkk?t=';
const double _startSecondsthree = 000000000000000000000000000186;
const String _videoIdfour = 'https://youtu.be/EIEwy8rPik4?t=';
const double _startSecondsfour = 000000000000000000000000000251;
const String _videoIdfive = 'https://youtu.be/IgF3OX8nT0w?t=';
