...
class EnglishEntryfalse extends StatefulWidget {
  const EnglishEntryfalse({super.key});

  @override
  State<EnglishEntryfalse> createState() => _EnglishEntryfalseState();
}

class _EnglishEntryfalseState extends State<EnglishEntryfalse> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """false""",
                      // alsoEnglishWord: "also: false",
                      britshText: """IpaUK: /fɔːls/""",
                      americanText: """IpaUS: /fɔːls/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A whale is a fish. True or false?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He used a false name to get the job.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His career was ruined by false accusations.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The allegations are completely false.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This claim is simply false.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts
        .speak("""The law can punish knowingly false statements.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She wore false eyelashes for the party.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He had been travelling with a false passport.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Helen's voice sounded slightly false.""");
  }
...
// """),
            ...
            children: [
              MyExpansionTile(
                children: [
                  ...
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """The allegations are completely false.""",
                    kurdishText: """تۆمەتەکان بە تەواوی ناڕاستن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She flashed him a false smile of congratulation.""",
            kurdishText: """پێکەنینێکی ساختەی پیرۆزبایی کردنی بۆی کرد.""",
...
6. Not genuine or real; being an imitation of the genuine article (= fake, faux, imitation, simulated)
"false teeth";
 
7. Designed to deceive
"a suitcase with a false bottom"
 
8. Inaccurate in pitch (= off-key, sour)
"a false note";
 
9. Adopted in order to deceive (= assumed, fictitious, fictive, pretended, put on, sham)
...
const String _videoIdend = 'PhNUjg9X4g8';
const double _startSecondsend = 0;
const String _videoIdone = '544DTGHIBM0';
const double _startSecondsone = 976;
const String _videoIdtwo = 'xvmTr6S00Aw';
const double _startSecondstwo = 708;
const String _videoIdthree = 'bHIhgxav9LY';
const double _startSecondsthree = 189;
const String _videoIdfour = 'Mx8JkGHaGUI';
const double _startSecondsfour = 2306;
const String _videoIdfive = 'Bl5630CeYFs';
