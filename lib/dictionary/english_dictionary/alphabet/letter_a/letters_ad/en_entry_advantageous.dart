...
// replace these: replace EnglishEntryadvantageous - replace speakAdvantageous - replace advantageous - /ˌædvənˈteɪdʒəs/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadvantageous extends StatelessWidget {
  EnglishEntryadvantageous({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "advantageous", // DOPSUM: CHANGE WORD ENTRY - Find /ˌædvənˈteɪdʒəs/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌædvənˈteɪdʒəs/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'ZTY-bdIxA1w';
