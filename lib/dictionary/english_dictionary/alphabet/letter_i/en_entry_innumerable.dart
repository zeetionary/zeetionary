...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'B9_RUwR3RFU';
    const double startSecondsend = 475;
    const String videoIdone = 'qX6NztnPU-4';
    const double startSecondsone = 898;
    const String videoIdtwo = 'Solb9uA-tgQ';
    const double startSecondstwo = 2342;
    const String videoIdthree = 'fTtEYzQYilU';
    const double startSecondsthree = 432;
    const String videoIdfour = 'sD0B-X9LJjs';
    const double startSecondsfour = 199;
    const String videoIdfive = 'fgcfgTTuku0';
