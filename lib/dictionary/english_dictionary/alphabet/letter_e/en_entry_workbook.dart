...
class EnglishEntryworkbook extends StatefulWidget {
  const EnglishEntryworkbook({super.key});

  @override
  State<EnglishEntryworkbook> createState() => _EnglishEntryworkbookState();
}

class _EnglishEntryworkbookState extends State<EnglishEntryworkbook> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""workbook""");
  }
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The workbook helps students practice grammar.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کتێبێک کە ڕاهێنانی تێدایە، و زۆرجار بۆشایی تێدایە بۆ ئەوەی خوێندکاران وەڵامەکانی تێدا بنووسن، بۆ ئەوەی یارمەتیان بدات لە پراکتیزەکردنی ئەو شتانەی فێری بوونە"""),
          const AlsoEnglishckb(word: "ھەروەھا: exercise book"),
          SentencesRow(
            englishText: """The workbook helps students practice grammar.""",
            kurdishText:
                """کتێبە ڕاهێنانەکە یارمەتی خوێندکاران دەدات ڕێزمان پراکتیزە بکەن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: workbook (Derived forms: workbooks)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/3MBPPg1xAsA?t=';
const double _startSecondsend = 000000000000000000000000000000; // 594;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/N9IToJ-HPA4?t=';
const double _startSecondsone = 00000000000000000000000000000; // 734;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/GUP0EVu083g?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 504;
const String _videoIdthree = 'VIDEOhttps://youtu.be/B9HerfKf2AE?t=';
const double _startSecondsthree = 000000000000000000000000000; // 473;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/lCqvJW1kIv8?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 27;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/E4NBGXtky0E?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 540;
