...
class EnglishEntryfissure extends StatefulWidget {
  const EnglishEntryfissure({super.key});

  @override
  State<EnglishEntryfissure> createState() => _EnglishEntryfissureState();
}

class _EnglishEntryfissureState extends State<EnglishEntryfissure> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fissure (Derived forms: fissures)
1. A long narrow depression in a surface (= crevice, cranny, crack, chap)
 
2. A narrow planar hole in a rock or material, usually with a flattish sides (= crack, cleft, crevice, scissure)
 
3. (anatomy) a long narrow slit or groove that divides an organ into lobes

- Verb: fissure (Derived forms: fissured, fissures, fissuring)
1. Break into fissures or fine cracks
""",
  );

  final String keyword = "fissure";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fissure""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Scientists discovered fissures in the ocean floor near the tectonic plates.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fissure""",
                      // alsoEnglishWord: "also: fissure",
                      britshText: """IpaUK: /ˈfɪʃə(r)/""",
                      americanText: """IpaUS: /ˈfɪʃər/""",
...
// With short examples define "fissure", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Scientists discovered fissures in the ocean floor near the tectonic plates.""",
                      kurdishText:
                          """زاناکان قڵیشیان لە بنکی زەریاکان لە نزیک پلێتە تەکتۆنییەکان دۆزییەوە.""",
...
const String _videoIdone = 'https://youtu.be/M6XiFKB7j0w?t=';
const double _startSecondsone = 000000000000000000000000000550;
const String _videoIdtwo = 'https://youtu.be/Jl0IDXkYKbk?t=';
const double _startSecondstwo = 000000000000000000000000000124;
const String _videoIdthree = 'https://youtu.be/OnGrHD1hRkk?t=';
const double _startSecondsthree = 000000000000000000000000000144;
const String _videoIdfour = 'https://youtu.be/UZ0ausMICgM';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/KTlf9OASKjk?t=';
