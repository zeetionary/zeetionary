...
class EnglishEntryhazy extends StatefulWidget {
  const EnglishEntryhazy({super.key});

  @override
  State<EnglishEntryhazy> createState() => _EnglishEntryhazyState();
}

class _EnglishEntryhazyState extends State<EnglishEntryhazy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hazy
1. Filled or abounding with fog or mist (- brumous, foggy, misty)
"a hazy October morning";
 
2. Indistinct or hazy in outline (- bleary, blurred, blurry, foggy, fuzzy, muzzy)
"a landscape of hazy outlines";
""",
  );

  final String keyword = "hazy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The mountains were hazy in the distance.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The room was hazy with smoke.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What happened next is all very hazy.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The dividing line is somewhat hazy.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'm a little hazy about what to do next.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hazy""",
                      // alsoEnglishWord: "also: hazy",
                      britshText: """IpaUK: /ˈheɪzi/""",
                      americanText: """IpaUS: /ˈheɪzi/""",
...
کوردی: مژاوی، تەماوی، لێڵ، تەژمە، نادیار، ناڕوون،	نیوەمەست، سەرخۆش، گێژ
"""),
// With short examples define "hazy", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە ڕوون نییە بەهۆی تەمەوە"""),
                    SentencesRow(
                      englishText:
                          """The mountains were hazy in the distance.""",
                      kurdishText: """چیاکان لە دوورەوە تەماوی دیاربوون.""",
                    ...
                    SentencesRow(
                      englishText: """The room was hazy with smoke.""",
                      kurdishText: """ژووڕەکە تەماوی بوو لە دووکەڵدا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە ڕوون نییە بەهۆی کەمی یادەوەری، زانیاری، یان وردەکاری"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """What happened next is all very hazy.""",
                      kurdishText:
                          """ئەوەی چی ڕوویدا دواتر هەموو تەم‌ومژاوییە.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """ژممر. (ھاوەڵناو) پننسە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: vague"),
                    SentencesRow(
                      englishText: """The dividing line is somewhat hazy.""",
                      kurdishText: """هێڵە جیاکەرەوەکە کەمێک ناڕوونە.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ھاوەڵناو) بەگومان و شڵەژاو لەسەر شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I'm a little hazy about what to do next.""",
                      kurdishText:
                          """کەمێک شڵەژاوم لەسەر ئەوەی دواتر چی بکەم.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ill2cgCyTUc?t=';
const double _startSecondsend = 000000000000000000000000000212;
const String _videoIdone = 'https://youtu.be/ZMu7_Xpp1SM?t=';
const double _startSecondsone = 000000000000000000000000000121;
const String _videoIdtwo = 'https://youtu.be/fOY2vdNbjiI?t=';
const double _startSecondstwo = 00000000000000000000000000091;
const String _videoIdthree = 'https://youtu.be/PZIPsDF0kbE?t=';
const double _startSecondsthree = 000000000000000000000000000137;
const String _videoIdfour = 'https://youtu.be/ZvPzY6MsmCs?t=';
const double _startSecondsfour = 000000000000000000000000000349;
const String _videoIdfive = 'https://youtu.be/HBhXvLlB-kY?t=';
const double _startSecondsfive = 0000000000000000000000000007427;
