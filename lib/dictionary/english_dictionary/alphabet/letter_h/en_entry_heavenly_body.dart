...
class EnglishEntryheavenlybody extends StatefulWidget {
  const EnglishEntryheavenlybody({super.key});

  @override
  State<EnglishEntryheavenlybody> createState() =>
      _EnglishEntryheavenlybodyState();
}

class _EnglishEntryheavenlybodyState extends State<EnglishEntryheavenlybody> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heavenly body (Derived forms: heavenly bodies)
1. Natural objects visible in the sky (- celestial body)
""",
  );

  final String keyword = "heavenly body";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heavenly body""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Ancient cultures often worshipped various heavenly bodies.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heavenly body""",
                      // alsoEnglishWord: "also: heavenly body",
                      britshText: """IpaUK: /ˌhev.ən.li ˈbɒd.i""",
                      americanText: """IpaUS: /ˌhev.ən.li ˈbɑː.di/""",
...
// With short examples define "heavenly body", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) تەنێک کە لە بۆشایی ئاسماندایە، بە تایبەتی خۆر، مانگ، یان هەسارەیەک"""),
                    SentencesRow(
                      englishText:
                          """Ancient cultures often worshipped various heavenly bodies.""",
                      kurdishText:
                          """کەلتوورە کۆنەکان زۆرجار ژمارەیەک تەنی ئاسمانییان دەپەرست.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/dCeEProiqgE?t=';
const double _startSecondsend = 000000000000000000000000000539;
const String _videoIdone = 'https://youtu.be/PnK5B49KKvo?t=';
const double _startSecondsone = 000000000000000000000000000467;
const String _videoIdtwo = 'https://youtu.be/wqhSzceQGYk?t=';
const double _startSecondstwo = 0000000000000000000000000001346;
const String _videoIdthree = 'https://youtu.be/-LWl6Jut6Ko?t=';
const double _startSecondsthree = 000000000000000000000000000451;
const String _videoIdfour = 'https://youtu.be/l4XS-T-r4S8?t=';
const double _startSecondsfour = 000000000000000000000000000747;
const String _videoIdfive = 'https://youtu.be/PngGVt0ZKoc?t=';
