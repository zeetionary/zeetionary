...
class EnglishEntryindirectly extends StatefulWidget {
  const EnglishEntryindirectly({super.key});

  @override
  State<EnglishEntryindirectly> createState() => _EnglishEntryindirectlyState();
}

class _EnglishEntryindirectlyState extends State<EnglishEntryindirectly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: indirectly
1. Not in a forthright manner (- circuitously)
"he answered very indirectly";
""",
  );

  final String keyword = "indirectly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indirectly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The new law will affect us all, directly or indirectly.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We heard about the meeting indirectly.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They communicated indirectly through a mutual friend.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.speak(
        """She was included indirectly as her husband's name came up.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/s3YTfhJmh1I?t=';
    const double startSecondsend = 000000000000000000000000000394;
    const String videoIdone = 'https://youtu.be/e-or_D-qNqM?t=';
    const double startSecondsone = 000000000000000000000000000178;
    const String videoIdtwo = 'https://youtu.be/_BbaiH17hOU?t=';
    const double startSecondstwo = 0000000000000000000000000002936;
    const String videoIdthree = 'https://youtu.be/ZU_MF0NMKhU?t=';
    const double startSecondsthree = 000000000000000000000000000175;
    const String videoIdfour = 'https://youtu.be/VVh6EkYwIGU?t=';
    const double startSecondsfour = 00000000000000000000000000035;
    const String videoIdfive = 'https://youtu.be/kVOTPAxrrP4?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indirectly""",
                      // alsoEnglishWord: "also: indirectly",
                      britshText: """IpaUK: /ˌɪndəˈrektli/, /ˌɪndaɪˈrektli/""",
                      americanText:
                          """IpaUS: /ˌɪndəˈrektli/, /ˌɪndaɪˈrektli/""",
...
کوردی: ناڕاستەوخۆیانە، لە لاوە
"""),
// With short examples define "indirectly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە وەک ئامانج، ئەنجام، یان هۆکاری ناڕاستەوخۆی شتێک ڕوودەدات"""),
                    SentencesRow(
                      englishText:
                          """The new law will affect us all, directly or indirectly.""",
                      kurdishText:
                          """یاسا تازەکە کاریگەریی لەسەر هەموومان دەبێت، بە ڕاستەوخۆ یان ناڕاستەوخۆ.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We heard about the meeting indirectly.""",
                      kurdishText:
                          """بە ناڕاستەوخۆ لەسەر کۆبوونەوەکەمان بیست.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە ناڕاستەوخۆ لە ڕێگای هاوڕێیەکی هاوبەشەوە قسەیان کرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بە شێوەیەک کە ڕوون و ئاشکرا نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She was included indirectly as her husband's name came up.""",
                      kurdishText:
                          """بە ناڕاستەوخۆیی باس کرا کە ناوی هاوسەرەکەی باس کرا.""",
