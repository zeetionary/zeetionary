...
// replace these: replace EnglishEntryanesthetic - replace speakanesthetic - replace anesthetic - /ˌænəsˈθetɪk/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryanesthetic extends StatelessWidget {
  EnglishEntryanesthetic({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakanesthetic(String languageCode) async {
    // DOPSUM: CHANGE speakanesthetic
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("anesthetic"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakanesthetic8505(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("How long will I be under anesthetic?"); // DOPSUM: CHANGE TEXT
  }
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakanesthetic(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () =>
                                    speakanesthetic8505(// REPLACE: anesthetic /ˌænəsˈθetɪk/
                                        "en-US"),
                              ),
                            ],
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'z8pn3FvRYCw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'qnTZbZw1JPQ';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'dBgiOHqhp-o';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'UVoSGyx_YYs';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '-xgoldjr-BI';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'VOob_9fJ5lw';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'qzrw53stoxk';
