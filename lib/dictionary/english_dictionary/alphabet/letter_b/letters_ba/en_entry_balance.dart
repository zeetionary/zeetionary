                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈbæləns/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈbæləns/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbalances1("en-US"),
                          ),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbalances2("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
...
٢. (ناو) توانای وەستان لەکاتێکدا کێشی جیاواز لەسەر لایەکانی جەستەیە"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbalances3("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٣. (ناو) بڕی ماوە لە دوای بەکارھێنانی پارە"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbalances4("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٤. (ناو) بڕی قەرزی ماوە"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbalances5("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٥. (ناو) گەورەترین بەشی گرووپێک یان بڕێک"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbalances6("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٦. (ناو) تەرازوویەک کە لە دوو دەفر پێکھاتووە کە دەبێت وەکو یەکدی بن لە بەرزیدا بۆ ئەوەی ھەردوو دەفرەکە ھەمان کێشیان ھەبێت"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbalances7("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٧. (کردار) ھاوسەنگی ڕاگرتنی شتێک"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbalances8("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٨. (کردار) گرنگیدانی یەکسان بە دوو شتی جیاواز"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbalances9("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٩. (کردار) یەکسان بوون لە بڕ یان نرخدا لەگەڵ شتێکی تری پێچەوانە"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbalances10("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
١٠. (کردار) بەراوردکردنی گرنگی ڕێژەیی دوو شتی جیاواز"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbalances11("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
١١. (کردار) سەرپەرشتی خەرجکردنی پارە بۆ ئەوەی بڕی پارەی خەرجکراو و وەرگیردراو یەکسان بن"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbalances12("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
١٢. (کردار) ھەبوونی ھەمان ڕێژە لە پارەی خەرجکراو و وەرگیردراو"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbalances13("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
