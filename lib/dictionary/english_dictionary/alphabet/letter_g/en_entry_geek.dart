...
class EnglishEntrygeek extends StatefulWidget {
  const EnglishEntrygeek({super.key});

  @override
  State<EnglishEntrygeek> createState() => _EnglishEntrygeekState();
}

class _EnglishEntrygeekState extends State<EnglishEntrygeek> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He's such a geek.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He is a computer geek who loves coding and programming.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """geek""",
                      // alsoEnglishWord: "also: geek",
                      britshText: """IpaUK: /ɡiːk/""",
                      americanText: """IpaUS: /ɡiːk/""",
...
// With short examples define "geek", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """زیرەکێکی بێزارکەری تەواوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) کەسێک کە زۆری حەز بە بابەتێکی دیاریکراوە و زۆری لێ دەزانێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: nerd"),
                    SentencesRow(
                      englishText:
...
const String _videoIdtwo = 'https://youtu.be/kUE2fPLOUxo?t=';
const double _startSecondstwo = 000000000000000000000000000780;
const String _videoIdthree = 'https://youtu.be/MK2USJnG9og?t=';
const double _startSecondsthree = 000000000000000000000000000657;
const String _videoIdfour = 'https://youtu.be/tlezBUdD53w?t=';
const double _startSecondsfour = 000000000000000000000000000205;
const String _videoIdfive = 'https://youtu.be/04RHKZUprwc?t=';
const double _startSecondsfive = 000000000000000000000000000155;
