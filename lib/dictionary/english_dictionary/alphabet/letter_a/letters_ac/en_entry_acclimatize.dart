...
// replace these: EnglishEntryacclimatize - speakAcclimatize - acclimatize - /əˈklaɪmətaɪz/

enum TtsState { playing }

class EnglishEntryacclimatize extends StatelessWidget {
  EnglishEntryacclimatize({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAcclimatize(String languageCode) async {
    // DOPSUM: CHANGE speakAcclimatize
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈklaɪmətaɪz/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'MJxbiHBpSc4';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'SZEJrYH-NcE';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '7MZoIN9I8oU';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'F0xZgbmV_kk';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'elOn5ZYg5fc';
