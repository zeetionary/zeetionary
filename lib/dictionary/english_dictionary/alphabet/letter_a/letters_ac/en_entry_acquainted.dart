...
class EnglishEntryacquainted extends StatefulWidget {
  const EnglishEntryacquainted({super.key});

  @override
  State<EnglishEntryacquainted> createState() => _EnglishEntryacquaintedState();
}

class _EnglishEntryacquaintedState extends State<EnglishEntryacquainted> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "acquainted";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""acquainted""");
  }

  Future<void> speakacqua24(String languageCode) async {
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acquainted""",
                      // alsoEnglishWord: "also: acquainted",
                      britshText: """IpaUK: /əˈkweɪntɪd/""",
                      americanText: """IpaUS: /əˈkweɪntɪd/""",
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final double _startSeconds = 1965;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'zMHJ8Hsbg5I';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'O1PuQ3BdC4w';
