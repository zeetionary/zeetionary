...
class EnglishEntrylint extends StatefulWidget {
  const EnglishEntrylint({super.key});

  @override
  State<EnglishEntrylint> createState() => _EnglishEntrylintState();
}

class _EnglishEntrylintState extends State<EnglishEntrylint> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lint (Derived forms: lints)
1. Fine ravellings of cotton or linen fibers
 
2. Cotton or linen fabric with the nap raised on one side; used to dress wounds
 
3. (computer programming) a tool that analyses source code to flag logic errors, inconsistencies, stylistic errors, suspicious and deprecated constructs, etc. (- linter)

- Verb: lint (Derived forms: linted, lints, linting)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The nurse used lint to cover the wound.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/0zYREwD9e6U?t=25';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/A0N9YF2jfiw?t=191';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/U_ZdvKQHamI?t=299';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/mgIr5vC_-h8?t=355';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/GR66FBUvZ88?t=358';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/9X5Vuh4U5Wo?t=394';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lint""",
                      // alsoEnglishWord: "also: lint",
                      britshText: """IpaUK: /lɪnt/""",
                      americanText: """IpaUS: /lɪnt/""",
...
کوردی: 
"""),
                    const DefinitionKurdish(text: """١. (ناو) جۆرە قوماشێکی نەرم بۆ بەستنی برین"""),
                    SentencesRow(
                      englishText: """The nurse used lint to cover the wound.""",
                      kurdishText: """پەرستارەکە لەفافی بەکارهێنا بۆ بەستنی برینەکە.""",
