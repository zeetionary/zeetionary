...
class EnglishEntryfriday extends StatefulWidget {
  const EnglishEntryfriday({super.key});

  @override
  State<EnglishEntryfriday> createState() => _EnglishEntryfridayState();
}

class _EnglishEntryfridayState extends State<EnglishEntryfriday> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: Friday (Derived forms: Fridays)
1. The sixth day of the week; the fifth working day (= Fri)
""",
  );

  final String keyword = "Friday";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It's Friday today, isn't it?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She went to dance class last Friday.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Are you busy next Friday?""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We'll discuss this at Friday's meeting.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I work Friday to Tuesday.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We met on Friday.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We'll meet Friday.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The museum is closed Fridays.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was born on a Friday.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I always do yoga on a Friday.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """Friday""",
                      // alsoEnglishWord: "also: Friday",
                      britshText: """IpaUK: /ˈfraɪdeɪ/,  /ˈfraɪdi/""",
                      americanText: """IpaUS: /ˈfraɪdeɪ/,  /ˈfraɪdi/""",
...
کوردی: هەینی، ڕۆژی هەینی، جومعە
"""),
// With short examples define "Friday", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕۆژی هەفتە کە دەکەوێتە نێوان پێنجشەممە و شەممە"""),
                    SentencesRow(
                      englishText: """It's Friday today, isn't it?""",
                      kurdishText: """ئەمڕۆ هەینییە، وانییە؟""",
                    ...
                    SentencesRow(
                      englishText: """She went to dance class last Friday.""",
                      kurdishText: """هەینیی ڕابردوو چوو بۆ وانەی یۆگا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Are you busy next Friday?""",
                      kurdishText: """هەینی داهاتوو کارت هەیە؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەمە لە کۆبوونەوەکەی هەینی باس دەکەین.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I work Friday to Tuesday.""",
                      kurdishText: """هەینی بۆ سێشەممە کار دەکەم.""",
                      englishNote: """Also: I work Fridays to Tuesdays.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We met on Friday (= last Friday).""",
                      kurdishText: """هەینی یەکمان دی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We'll meet Friday.""",
                      kurdishText: """هەینی یەکدی دەبینین.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The museum is closed Fridays.""",
                      kurdishText: """مۆزەخانەکە ڕۆژانی هەینی داخراوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He was born on a Friday.""",
                      kurdishText: """ڕۆژێکی هەینی لە دایک بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەمیشە یۆگا لە ڕۆژێکی هەینی دەکەم.""",
...
const double _startSecondsone = 000000000000000000000000000131;
const String _videoIdtwo = 'https://youtu.be/FPAk81X3tTY?t=';
const double _startSecondstwo = 000000000000000000000000000297;
const String _videoIdthree = 'https://youtu.be/9TugA_z5vQE?t=';
const double _startSecondsthree = 0000000000000000000000000001644;
const String _videoIdfour = 'https://youtu.be/zX5TrXxnx7k?t=';
const double _startSecondsfour = 000000000000000000000000000171;
const String _videoIdfive = 'https://youtu.be/2m3AG4x2bL8?t=';
