...
class EnglishEntryhygiene extends StatefulWidget {
  const EnglishEntryhygiene({super.key});

  @override
  State<EnglishEntryhygiene> createState() => _EnglishEntryhygieneState();
}

class _EnglishEntryhygieneState extends State<EnglishEntryhygiene> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hygiene""");
  }
