...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The team worked on an impossibly difficult problem for weeks.""");
  }
...
// With short examples define "impossibly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە ئەستەم یان زۆر سەختە بۆ مامەڵە لەگەڵ کردن"""),
                    SentencesRow(
                      englishText:
                          """The team worked on an impossibly difficult problem for weeks.""",
                      kurdishText:
                          """بۆ چەندین هەفتە تیمەکە کاریان لەسەر کێشەیەکی ئەستەمانە سەخت کرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) هەبوونی خاسیەتێک تا ئاستێک کە وادیارە ئەستەم بێت"""),
