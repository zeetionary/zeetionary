...
class EnglishEntrygabble extends StatefulWidget {
  const EnglishEntrygabble({super.key});

  @override
  State<EnglishEntrygabble> createState() => _EnglishEntrygabbleState();
}

class _EnglishEntrygabbleState extends State<EnglishEntrygabble> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was nervous and started to gabble.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They were gabbling on about the past.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She ignored the constant gabble from the back.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gabble""",
                      // alsoEnglishWord: "also: gabble",
                      britshText: """IpaUK: /ˈɡæbl/""",
                      americanText: """IpaUS: /ˈɡæbl/""",
...
کوردی: منگەمنگ، بڵمەبڵم، چەقەسرۆیی
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) قسەکردن بە خێرایی بە شێوەیەک کە خەڵکی بە باشی لێت تێ نەگەن"""),
                    SentencesRow(
                      englishText: """She was nervous and started to gabble.""",
                      kurdishText: """شڵەژاو بوو و دەستی کرد بە منگەمنگ.""",
                    ...
                    SentencesRow(
                      englishText: """They were gabbling on about the past.""",
                      kurdishText: """دەربارەی ڕابردوو چەنەیان دەدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چەنەبازییەکەی بەردەوامەکەی پشتەوەیی پشتگوێ خست.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ecrXAAlVnCk?t=';
const double _startSecondsend = 00000000000000000000000000055;
const String _videoIdone = 'https://youtu.be/ioejvSKJhsk?t=';
const double _startSecondsone = 000000000000000000000000000814;
const String _videoIdtwo = 'https://youtu.be/y3cVjnWhY5o?t=';
const double _startSecondstwo = 000000000000000000000000000414;
const String _videoIdthree = 'https://youtu.be/KRTWlf1Bxac?t=';
const double _startSecondsthree = 0000000000000000000000000001460;
const String _videoIdfour = 'https://youtu.be/AYZ2N2qQE0A?t=';
const double _startSecondsfour = 000000000000000000000000000516;
const String _videoIdfive = 'https://youtu.be/BZfxNd8LG8c?t=';
const double _startSecondsfive = 0000000000000000000000000001158;
