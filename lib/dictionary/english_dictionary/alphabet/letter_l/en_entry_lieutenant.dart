...
class EnglishEntrylieutenant extends StatefulWidget {
  const EnglishEntrylieutenant({super.key});

  @override
  State<EnglishEntrylieutenant> createState() => _EnglishEntrylieutenantState();
}

class _EnglishEntrylieutenantState extends State<EnglishEntrylieutenant> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lieutenant""");
  }
