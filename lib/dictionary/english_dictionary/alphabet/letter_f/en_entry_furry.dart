...
class EnglishEntryfurry extends StatefulWidget {
  const EnglishEntryfurry({super.key});

  @override
  State<EnglishEntryfurry> createState() => _EnglishEntryfurryState();
}

class _EnglishEntryfurryState extends State<EnglishEntryfurry> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: furry (Derived forms: furriest, furrier)
1. Covered with a dense coat of fine silky hairs (= - furred)
"a furry teddy bear";
""",
  );

  final String keyword = "furry";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Rabbits are small furry animals found in the wild.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Rosie has a massive collection of furry toys.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furry""",
                      // alsoEnglishWord: "also: furry",
                      britshText: """IpaUK: /ˈfɜːri/""",
                      americanText: """IpaUS: /ˈfɜːri/""",
...
کوردی: کوڵکن، تووکاوی، موواوی، فەروەئاسا، کەوڵ‌ئاسا، لەکەوڵ‌چوو،	بارگرتوو، بارهێناو، باراوی
"""),
// With short examples define "furry", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Rabbits are small furry animals found in the wild.""",
                      kurdishText:
                          """کەروێشک ئاژەڵی بچووکی فەروودارە کە لە دەشتدا دەبینرێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕۆزی کۆکراوەیەکی گەورە لە یاریی منداڵانی فەرووداری هەیە.""",
...
const double _startSecondsend = 000000000000000000000000000730;
const String _videoIdone = 'https://youtu.be/erDE9B-X7mk?t=';
const double _startSecondsone = 000000000000000000000000000899;
const String _videoIdtwo = 'https://youtu.be/qg2nGY1aqlg?t=';
const double _startSecondstwo = 0000000000000000000000000001603;
const String _videoIdthree = 'https://youtu.be/VpnandCVKXU?t=';
const double _startSecondsthree = 000000000000000000000000000206;
const String _videoIdfour = 'https://youtu.be/EobMnSpjfTU?t=';
const double _startSecondsfour = 000000000000000000000000000505;
const String _videoIdfive = 'https://youtu.be/CtUuab1Aqg0?t=';
const double _startSecondsfive = 00000000000000000000000000040;
