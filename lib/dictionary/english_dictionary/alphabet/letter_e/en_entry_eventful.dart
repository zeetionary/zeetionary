...
class EnglishEntryeventful extends StatefulWidget {
  const EnglishEntryeventful({super.key});

  @override
  State<EnglishEntryeventful> createState() => _EnglishEntryeventfulState();
}

class _EnglishEntryeventfulState extends State<EnglishEntryeventful> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""eventful""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """eventful""",
                      // alsoEnglishWord: "also: eventful",
                      britshText: """IpaUK: /ɪˈventfl/""",
                      americanText: """IpaUS: /ɪˈventfl/""",
...
کوردی: پڕرووداو، پڕ(لە)سەربردە، زۆرڕووداو، گرنگ
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کە ڕووداوی زۆر لەخۆدەگرێت، بەتایبەتی بەجۆش، گرنگ، یان مەترسیدار"""),
          SentencesRow(
            englishText: """It had been a long and eventful journey.""",
            kurdishText: """گەشتێکی درێژ و پڕ ڕووداو بووە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: eventful
1. Having important issues or results (= consequential)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/2svi_xw_Q7I?t=';
const double _startSecondsend = 000000000000000000000000000000; // 477;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/bLVuiKdhodc?t=';
const double _startSecondsone = 00000000000000000000000000000; // 52;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/oYBq6tgx_5M?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1665;
const String _videoIdthree = 'VIDEOhttps://youtu.be/3mugPH2_qRo?t=';
const double _startSecondsthree = 000000000000000000000000000; // 698;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/vysgvUzKBFw?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 552;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/2SNSX3B_6Uc?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 435;
