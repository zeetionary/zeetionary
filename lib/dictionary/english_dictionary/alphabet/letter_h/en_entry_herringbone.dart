...
class EnglishEntryherringbone extends StatefulWidget {
  const EnglishEntryherringbone({super.key});

  @override
  State<EnglishEntryherringbone> createState() =>
      _EnglishEntryherringboneState();
}

class _EnglishEntryherringboneState extends State<EnglishEntryherringbone> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: herringbone (Derived forms: herringbones)
1. A pattern of columns of short parallel lines with all the lines in one column sloping one way and lines in adjacent columns sloping the other way; it is used in weaving, masonry, parquetry, embroidery (- herringbone pattern)
 
2. A twilled fabric with a herringbone pattern
""",
  );

  final String keyword = "herringbone";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""herringbone""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He wore a herringbone jacket to the meeting.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """herringbone""",
                      // alsoEnglishWord: "also: herringbone",
                      britshText: """IpaUK: /ˈherɪŋbəʊn/""",
                      americanText: """IpaUS: /ˈherɪŋbəʊn/""",
...
کوردی: 
"""),
// With short examples define "herringbone", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) شێوەیەک کە لە ژمارەیەک پیتی V ــی تەریب بە یەکدی پێکهاتووە و زۆرجار لە جلوبەرگدا هەیە"""),
                    SentencesRow(
                      englishText:
                          """He wore a herringbone jacket to the meeting.""",
                      kurdishText:
                          """چاکەتێکی نەخشداری حەوتی لەبەر کرد بۆ چاوپێکەوتنەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/PXvCVlrsGvc?t=';
const double _startSecondsend = 000000000000000000000000000121;
const String _videoIdone = 'https://youtu.be/qjubq284yVk?t=';
const double _startSecondsone = 0000000000000000000000000001076;
const String _videoIdtwo = 'https://youtu.be/ZJmsVPTd0C0?t=';
const double _startSecondstwo = 0000000000000000000000000001072;
const String _videoIdthree = 'https://youtu.be/5m6w1Pq0Pyw?t=';
const double _startSecondsthree = 00000000000000000000000000043;
const String _videoIdfour = 'https://youtu.be/N0XK8661aUA?t=';
const double _startSecondsfour = 000000000000000000000000000217;
const String _videoIdfive = 'https://youtu.be/Zy4kYFWZ1_g?t=';
