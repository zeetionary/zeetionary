...
class EnglishEntryimpound extends StatefulWidget {
  const EnglishEntryimpound({super.key});

  @override
  State<EnglishEntryimpound> createState() => _EnglishEntryimpoundState();
}

class _EnglishEntryimpoundState extends State<EnglishEntryimpound> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impound""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 908;
    const String videoIdone = 'jw7LD2-gg14';
    const double startSecondsone = 237;
    const String videoIdtwo = 'daMJS6dk80o';
    const double startSecondstwo = 789;
    const String videoIdthree = 'SqH0nJngy-c';
    const double startSecondsthree = 1558;
    const String videoIdfour = 'KD1C5NNkB8Y';
    const double startSecondsfour = 327;
    const String videoIdfive = 'QQyup6ZFsvA';
    const double startSecondsfive = 990;
