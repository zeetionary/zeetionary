...
class EnglishEntrygreenbean extends StatefulWidget {
  const EnglishEntrygreenbean({super.key});

  @override
  State<EnglishEntrygreenbean> createState() => _EnglishEntrygreenbeanState();
}

class _EnglishEntrygreenbeanState extends State<EnglishEntrygreenbean> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: green bean (Derived forms: green beans)
1. Immature bean pod eaten as a vegetable
 
2. A common bean plant cultivated for its slender green edible pods
 
3. Seed of the mung bean plant used for food (- mung bean, mung, green gram, golden gram, moong, mash bean, munggo, green soy, moong bean)
""",
  );

  final String keyword = "green bean";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""green bean""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He planted green beans in the garden.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """green bean""",
                      // alsoEnglishWord: "also: green bean",
                      britshText: """IpaUK: /ˌɡriːn ˈbiːn/""",
                      americanText: """IpaUS: /ˌɡriːn ˈbiːn/""",
...
کوردی: 
"""),
                    const DefinitionKurdish(text: """١. (ناو) لۆبیای سەوز"""),
                    SentencesRow(
                      englishText: """He planted green beans in the garden.""",
                      kurdishText: """زۆرجار لۆبیا لە باخچەکە دەچاند.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/qypTsTciYFc?t=';
const double _startSecondsend = 000000000000000000000000000713;
const String _videoIdone = 'https://youtu.be/9ZsORyZa8tI?t=';
const double _startSecondsone = 0000000000000000000000000001468;
const String _videoIdtwo = 'https://youtu.be/LiY89gBd2GQ?t=';
const double _startSecondstwo = 000000000000000000000000000222;
const String _videoIdthree = 'https://youtu.be/_GdkGRel48Q?t=';
const double _startSecondsthree = 000000000000000000000000000299;
const String _videoIdfour = 'https://youtu.be/bWX0-NEjyNQ?t=';
const double _startSecondsfour = 00000000000000000000000000061;
const String _videoIdfive = 'https://youtu.be/wAPH8D2AL8c?t=';
