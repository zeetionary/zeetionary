...
class EnglishEntryamputate extends StatelessWidget {
  ...
  Future<void> speakamputate(String languageCode) async {
    ...
    await flutterTts.speak("amputate");
  }
  ...
  Future<void> speakamputate5528(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("Her right arm became infected and had to be amputated.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "amputate"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæmpjuteɪt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæmpjuteɪt/"),
...
١. (کردار) بڕینەوەی باڵ، لاق، یان پەنجەی کەسێک بە نەشتەرگەری"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakamputate5528("en-US"),
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'cfDt2PPO8Vw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'oaaWacfvB9c';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'QiLhLHSbNx4';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'GUseaF1yySY';
