...
class EnglishEntryhospice extends StatefulWidget {
  const EnglishEntryhospice({super.key});

  @override
  State<EnglishEntryhospice> createState() => _EnglishEntryhospiceState();
}

class _EnglishEntryhospiceState extends State<EnglishEntryhospice> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hospice (Derived forms: hospices)
1. A lodging for travellers (especially one kept by a monastic order)
 
2. A program of medical and emotional care for the terminally ill
""",
  );

  final String keyword = "hospice";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hospice""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/90MNvA5ozcI?t=';
    const double startSecondsend = 000000000000000000000000000717;
    const String videoIdone = 'https://youtu.be/zlg03lfBrEA?t=';
    const double startSecondsone = 000000000000000000000000000805;
    const String videoIdtwo = 'https://youtu.be/m9RY3SHyTjE?t=';
    const double startSecondstwo = 00000000000000000000000000020;
    const String videoIdthree = 'https://youtu.be/-wpHszfnJns?t=';
    const double startSecondsthree = 0000000000000000000000000001388;
    const String videoIdfour = 'https://youtu.be/WwhyZUlmaWA?t=';
    const double startSecondsfour = 0000000000000000000000000003964;
    const String videoIdfive = 'https://youtu.be/jaB9M8B_Tuw?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hospice""",
                      // alsoEnglishWord: "also: hospice",
                      britshText: """IpaUK: /ˈhɒspɪs/""",
                      americanText: """IpaUS: /ˈhɑːspɪs/""",
...
// With short examples define "hospice", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """She founded an AIDS hospice with the help of a local doctor.""",
                      kurdishText:
                          """نەخۆشخانەیەکی ئایدزی درووستکرد بە یارمەتی دکتۆرێکی لۆکاڵی.""",
