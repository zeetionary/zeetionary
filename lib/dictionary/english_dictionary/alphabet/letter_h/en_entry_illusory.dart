...
class EnglishEntryillusory extends StatefulWidget {
  const EnglishEntryillusory({super.key});

  @override
  State<EnglishEntryillusory> createState() => _EnglishEntryillusoryState();
}

class _EnglishEntryillusoryState extends State<EnglishEntryillusory> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: illusory
1. Based on or having the nature of an illusion (- illusive)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""illusory""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Any power he may seem to have is purely illusory.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    // 188888880002200
    const String videoIdend = 'https://youtu.be/RjKNbfA64EE?t=';
    const double startSecondsend = 000000000000000000000000000122;
    const String videoIdone = 'https://youtu.be/SDkAGkd4NLc?t=';
    const double startSecondsone = 0000000000000000000000000001284;
    const String videoIdtwo = 'https://youtu.be/3WRgikuVZpQ?t=';
    const double startSecondstwo = 000000000000000000000000000927;
    const String videoIdthree = 'https://youtu.be/A485tKwmYqE?t=';
    const double startSecondsthree = 00000000000000000000000000041;
    const String videoIdfour = 'https://youtu.be/jlIBGl5-j_4?t=';
    const double startSecondsfour = 000000000000000000000000000451;
    const String videoIdfive = 'https://youtu.be/X2LwIiKhczo?t=';
    const double startSecondsfive = 000000000000000000000000000389;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """illusory""",
                      // alsoEnglishWord: "also: illusory",
                      britshText: """IpaUK: /ɪˈluːsəri/""",
                      americanText: """IpaUS: /ɪˈluːsəri/""",
...
کوردی: پڕوپووچ، ناڕاست، خەیاڵی، ناڕاستەقینە، درۆ،	فریودەر، بەهەڵەدابەر، هەڵفریوێنەر، لەخشتەبەر
"""),
// With short examples define "illusory", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) کە ڕاست نییە ئەگەرچی ڕاست دیارە"""),
                    SentencesRow(
                      englishText: """Any power he may seem to have is purely illusory.""",
                      kurdishText: """هەر دەسەڵاتێک کە وەها دەربکەوێت هەیەتی تەنها خەیاڵە.""",
