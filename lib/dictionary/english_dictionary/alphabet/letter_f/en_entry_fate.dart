...
class EnglishEntryfate extends StatefulWidget {
  const EnglishEntryfate({super.key});

  @override
  State<EnglishEntryfate> createState() => _EnglishEntryfateState();
}

class _EnglishEntryfateState extends State<EnglishEntryfate> {
  @override
  void initState() {
    super.initState();
  }
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fate of the three men is unknown.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She sat outside, waiting to find out her fate.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The court will decide our fate/fates.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Each of the managers suffered the same fate.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He had signed his confession and sealed his own fate.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He will learn his fate in court tomorrow.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His fate rests in the hands of the judges.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Fate was kind to me that day.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Fate decreed that she would never reach America.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Fate was not smiling upon her today.""");
  }
...
کوردی: چارەنووس، قسمەت، قەزاوقەدەر،	داهاتووی کەسێ، ئاقیبەت، ئاخر،	ئەجەل، ئاکام،	مەرگ، مردن، تیاچوون
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ئەو شتانەی کە بەسەر کەسێکدا دێت، بەتایبەتی شتی خراپ"""),
          SentencesRow(
            englishText: """The fate of the three men is unknown.""",
            kurdishText: """چارەنووسی سێ پیاوەکە نەزانراوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She sat outside, waiting to find out her fate.""",
            kurdishText:
                """لە دەرەوە دانیشت بوو و چاوەڕێ بوو چارەنووسی بزانێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The court will decide our fate/fates.""",
            kurdishText: """دادگاکە بڕیار لە چارەنووسمان دەدات.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Each of the managers suffered the same fate.""",
            kurdishText:
                """هەر یەکێک لە بەڕێوەبەرەکان هەمان چارەنووسیان هەبوو.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """دانپێدانانەکەیی واژۆکردبوو و چارەنووسی خۆی کۆتایی پێهێنابوو.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He will learn his fate in court tomorrow.""",
            kurdishText: """سبەی لە دادگا چارەنووسی خۆی دەزانێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """His fate rests in the hands of the judges.""",
            kurdishText: """چارەنووسی کەوتووەتە دەستی دادوەرەکان.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) ئەو هێزەی کە باوەڕ وایە هەموو شتێک کۆنترۆڵ دەکات و ناگۆڕێت"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Fate was kind to me that day.""",
            kurdishText: """ئەو ڕۆژە چارەنووس لەگەڵم میهرەبان بوو.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Fate decreed that she would never reach America.""",
            kurdishText:
                """چارەنووس ئەوەی دیاری کرد کە هەرگیز نەگاتە ئەمریکا.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Fate was not smiling upon her today.""",
            kurdishText: """چارەنووس ئەمڕۆ بەدەمییەوە نەچوو.""",
          ...
          SentencesRow(
            englishText:
                """For some reason fate conspired against them and everything they did was problematic.""",
            kurdishText:
                """بۆ چەند هۆکارێک چارەنووس دژیان بوو و هەر شتێکیان دەکرد کێشەی هەبوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fate (Derived forms: fates)
1. An event (or a course of events) that will inevitably happen in the future (= destiny, kismet)
 
2. The ultimate agency regarded as predetermining the course of events (= destiny)
"we are helpless in the face of fate";
 
3. Your overall circumstances or condition in life (including everything that happens to you) (= fortune, destiny, luck, lot, circumstances, portion, circs [Brit, informal])
"deserved a better fate";

- Verb: fate (Derived forms: fates, fating, fated)
1. Decree or designate beforehand (= destine, doom, designate)
...
const double _startSecondsend = 000000000000000000000000000405;
const String _videoIdone = 'https://youtu.be/khOUvmOQExc?t=';
const double _startSecondsone = 000000000000000000000000000638;
const String _videoIdtwo = 'https://youtu.be/ewLpXw6uN28?t=';
const double _startSecondstwo = 0000000000000000000000000001392;
const String _videoIdthree = 'https://youtu.be/544DTGHIBM0?t=';
const double _startSecondsthree = 000000000000000000000000000737;
const String _videoIdfour = 'https://youtu.be/E47mx4rsVCI?t=';
const double _startSecondsfour = 000000000000000000000000000191;
const String _videoIdfive = 'https://youtu.be/tU8aYj9d6TI?t=';
