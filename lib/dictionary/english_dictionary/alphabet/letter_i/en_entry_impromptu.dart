...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001422;
    const String videoIdone = 'https://youtu.be/_0RTH57v66I?t=';
    const double startSecondsone = 000000000000000000000000000683;
    const String videoIdtwo = 'https://youtu.be/0ST4_hmop9Y?t=';
    const double startSecondstwo = 0000000000000000000000000001688;
    const String videoIdthree = 'https://youtu.be/GkgXRyScubI?t=';
    const double startSecondsthree = 000000000000000000000000000800;
    const String videoIdfour = 'https://youtu.be/h_OeMVcol1g?t=';
    const double startSecondsfour = 000000000000000000000000000622;
    const String videoIdfive = 'https://youtu.be/tkXtBNb5VzE?t=';
