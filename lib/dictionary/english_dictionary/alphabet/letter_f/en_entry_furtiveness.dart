...
class EnglishEntryfurtiveness extends StatefulWidget {
  const EnglishEntryfurtiveness({super.key});

  @override
  State<EnglishEntryfurtiveness> createState() =>
      _EnglishEntryfurtivenessState();
}

class _EnglishEntryfurtivenessState extends State<EnglishEntryfurtiveness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: furtiveness
1. A disposition to be sly and stealthy and to do things surreptitiously (- sneakiness, stealthiness, surreptitiousness)
""",
  );

  final String keyword = "furtiveness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""furtiveness""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furtiveness""",
                      // alsoEnglishWord: "also: furtiveness",
                      britshText: """IpaUK: /ˈfɜːtɪvnəs/""",
                      americanText: """IpaUS: /ˈfɜːrtɪvnəs/""",
...
// With short examples define "furtiveness", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕەفتارکردن کە ئەوە پیشان دەدات کە دەتەوێت شتێک بە نهێنی بهێڵیتەوە و ماتەوێت ببیندرێیت"""),
                    SentencesRow(
                      englishText:
                          """There was a furtiveness in the way she moved, as if she did not want to be observed.""",
                      kurdishText:
                          """شاراوەیی‌بوونێک لە شێوازی جووڵەیدا هەبوو وەک ئەوەی نەیدەویست پێی بزاندرێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Rxh_SVtyZqo?t=';
const double _startSecondsend = 0000000000000000000000000003962;
const String _videoIdone = 'https://youtu.be/H6TDcpTjnxQ?t=';
const double _startSecondsone = 0000000000000000000000000001047;
const String _videoIdtwo = 'https://youtu.be/vJK5w4ZpQKc?t=';
const double _startSecondstwo = 000000000000000000000000000791;
const String _videoIdthree = 'https://youtu.be/fOWm1Fcdde0?t=';
const double _startSecondsthree = 00000000000000000000000000070;
const String _videoIdfour = 'https://youtu.be/QmuYUOomDSw?t=';
const double _startSecondsfour = 000000000000000000000000000525;
const String _videoIdfive = 'https://youtu.be/aMZsKq99hdk?t=';
const double _startSecondsfive = 0000000000000000000000000009257;
