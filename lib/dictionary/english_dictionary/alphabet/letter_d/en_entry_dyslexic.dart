...
; کوردی: 
; """),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) پەیوەندیدار بە هەبوونی کێشەی خوێندنەوە و نووسین"""),
          Row(
            children: [
              const Expanded(
                child: Column(
                  children: [
                    ...
                    ExampleSentenceKurdish(text: """قوتابخانەکە یارمەتی پێشکەش بە خوێندکارانی دیسلێکسیک دەکات."""),
                  ],
                ),
              ),
