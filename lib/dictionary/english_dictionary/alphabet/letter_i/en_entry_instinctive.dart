...
class EnglishEntryinstinctive extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""instinctive""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'E5J_ARKyftA';
    const double startSecondsone = 81;
    const String videoIdtwo = 'zFleLL5zlaI';
    const double startSecondstwo = 1012;
    const String videoIdthree = 'v9tM_YHvhuA';
    const double startSecondsthree = 259;
    const String videoIdfour = 'd-yWx772qFU';
    const double startSecondsfour = 333;
    const String videoIdfive = 'TfzEPtLPnP4';
