...
class EnglishEntryhumorous extends StatefulWidget {
  const EnglishEntryhumorous({super.key});

  @override
  State<EnglishEntryhumorous> createState() => _EnglishEntryhumorousState();
}

class _EnglishEntryhumorousState extends State<EnglishEntryhumorous> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""humorous""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = '6noCpwaFbVw';
    const double startSecondsone = 628;
    const String videoIdtwo = 's_2QTY0V3Yc';
    const double startSecondstwo = 170;
    const String videoIdthree = '7Vm282YvOGw';
    const double startSecondsthree = 174;
    const String videoIdfour = '0vZvPtI5Uk8';
    const double startSecondsfour = 42;
    const String videoIdfive = 'iKhQYYSqhgc';
