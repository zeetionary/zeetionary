...
class EnglishEntrygift extends StatefulWidget {
  const EnglishEntrygift({super.key});

  @override
  State<EnglishEntrygift> createState() => _EnglishEntrygiftState();
}

class _EnglishEntrygiftState extends State<EnglishEntrygift> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The watch was a gift from my mother.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This dinner is my gift to you.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She gave me the book as a gift.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Please accept this small gift.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He knew from an early age he had a special gift.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He has a gift for making friends easily.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Their second goal was an absolute gift.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""At £500 it's a gift.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They gifted their opponents a goal.""");
  }
  ...
  Future<void> speaksentence100(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""At £500 it's a gift.0""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gift""",
                      // alsoEnglishWord: "also: gift",
                      britshText: """IpaUK: /ɡɪft/""",
                      americanText: """IpaUS: /ɡɪft/""",
...
کوردی: دیاری، پێشکەشی، خەڵات،	بەخشین، پێدان، (ماف) بەخشین،	توانایی، بەهرە، مرخ،	مفت، خۆڕایی، ئاسان، وەک ئاوخواردنەوە
"""),
// With short examples define "gift", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The watch was a gift from my mother.""",
                      kurdishText: """کاتژمێرەکە دیارییەک بوو لە دایکمەوە.""",
                    ...
                    SentencesRow(
                      englishText: """This dinner is my gift to you.""",
                      kurdishText: """ئەم نانی ئێوارەیە دیاریی منە بۆ تۆ.""",
                    ...
                    SentencesRow(
                      englishText:
                          """By becoming a blood donor you will be making a vital gift of life to someone else.""",
                      kurdishText:
                          """بەوەی ببیت بە بەخشەری خوێن ئەوا دیارییەکی گران‌بەهای ژیان بە کەسێکی دیکە دەدەیت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She gave me the book as a gift.""",
                      kurdishText: """کتێبەکەی وەک دیاری پێمدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Please accept this small gift.""",
                      kurdishText: """تکایە ئەم دیارییە بچووکە پەسەند بکە.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) توانای سرووشتی"""),
                    const AlsoEnglishckb(word: "ھەروەھا: talent"),
                    SentencesRow(
                      englishText:
                          """She can pick up a tune instantly on the piano. It's a gift.""",
                      kurdishText:
                          """ڕاستەوخۆ دەتوانێت ئاوازێکی پیانۆ بناسێتەوە. ئەوە بەهرەیەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە تەمەنێکی سەرەتاوە دەیزانی کە بەهرەیەکی تایبەتی هەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بەهرەی ئەوەی هەبوو کە بە ئاسانی هاوڕێیەتی درووست بکات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) شتێک کە ئاسانە بۆ کردن یان هەرزانە بۆ کڕین"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Their second goal was an absolute gift.""",
                      kurdishText: """گۆڵی دووەم تەواو دیارییەک بوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """At £500 it's a gift.""",
                      kurdishText: """بە ٥٠٠ پاوەند وەک دیارییەک وایە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (کردار) پێدانی شتێک بە کەسێک بەبێ ئەوەی هیچ هەوڵی بۆی دابێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They gifted their opponents a goal.""",
                      kurdishText: """گۆڵێکیان بەخشی بە ڕکابەرەکەیان.""",
                      englishNote:
                          "Also: They gifted a goal to their opponents.",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """At £500 it's a gift.0""",
                      kurdishText: """رستە_رستە_رستە_رستە.""",
...
const double _startSecondsend = 000000000000000000000000000177;
const String _videoIdone = 'https://youtu.be/_GFkHA5EZdE?t=';
const double _startSecondsone = 000000000000000000000000000250;
const String _videoIdtwo = 'https://youtu.be/LIn8jwTAJpg?t=';
const double _startSecondstwo = 000000000000000000000000000326;
const String _videoIdthree = 'https://youtu.be/gFuEoxh5hd4?t=';
const double _startSecondsthree = 000000000000000000000000000660;
const String _videoIdfour = 'https://youtu.be/221F55VPp2M?t=';
const double _startSecondsfour = 00000000000000000000000000054;
const String _videoIdfive = 'https://youtu.be/d-S3oubvCu0?t=';
