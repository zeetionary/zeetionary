...
class EnglishEntryhenparty extends StatefulWidget {
  const EnglishEntryhenparty({super.key});

  @override
  State<EnglishEntryhenparty> createState() => _EnglishEntryhenpartyState();
}

class _EnglishEntryhenpartyState extends State<EnglishEntryhenparty> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hen party (Derived forms: hen parties)
1. A party for women only
 
2. [Brit] A women's night out with the bride to celebrate before a wedding (- hen night [Brit], bachelorette party [N. Amer])
""",
  );

  final String keyword = "hen party";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hen party""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Are you going to Michelle's hen party?""");
  }
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/aLC9ksgdDqg';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/g5qTSoMjYhE?t=';
const double _startSecondsone = 0000000000000000000000000001061;
const String _videoIdtwo = 'https://youtu.be/sl0uZTzBTP8?t=';
const double _startSecondstwo = 00000000000000000000000000071;
const String _videoIdthree = 'https://youtu.be/1dP1EFqH-nI?t=';
const double _startSecondsthree = 000000000000000000000000000300;
const String _videoIdfour = 'https://youtu.be/QXfxOxmGmfw';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/xCkAPFceGp4?t=';
const double _startSecondsfive = 000000000000000000000000000247;
