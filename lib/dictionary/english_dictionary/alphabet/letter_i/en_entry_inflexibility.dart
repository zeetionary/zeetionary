...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/y84kY4T_nSs?t=';
    const double startSecondsend = 000000000000000000000000000582;
    const String videoIdone = 'https://youtu.be/BVoGf1JTVeI?t=';
    const double startSecondsone = 000000000000000000000000000437;
    const String videoIdtwo = 'https://youtu.be/5Aq9b2XfrWY?t=';
    const double startSecondstwo = 000000000000000000000000000885;
    const String videoIdthree = 'https://youtu.be/spRc-tWuokI?t=';
    const double startSecondsthree = 0000000000000000000000000001033;
    const String videoIdfour = 'https://youtu.be/G5gwb0CM6Ek?t=';
    const double startSecondsfour = 000000000000000000000000000393;
    const String videoIdfive = 'https://youtu.be/OadokY8fcAA?t=';
    const double startSecondsfive = 0000000000000000000000000005323;
