...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 890;
    const String videoIdone = 'YLmDE_JYUNU';
    const double startSecondsone = 1040;
    const String videoIdtwo = 'jTRC_FMzLoo';
    const double startSecondstwo = 495;
    const String videoIdthree = 'MITeeIbCatY';
    const double startSecondsthree = 1041;
    const String videoIdfour = '0UABTaB-_i8';
    const double startSecondsfour = 577;
    const String videoIdfive = 'vchJnrZgz-4';
    const double startSecondsfive = 936;
