...
class EnglishEntryglee extends StatefulWidget {
  const EnglishEntryglee({super.key});

  @override
  State<EnglishEntryglee> createState() => _EnglishEntrygleeState();
}

class _EnglishEntrygleeState extends State<EnglishEntryglee> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She couldn't disguise her glee at their embarrassment.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glee""",
                      // alsoEnglishWord: "also: glee",
                      britshText: """IpaUK: /ɡliː/""",
                      americanText: """IpaUS: /ɡliː/""",
...
کوردی: دڵخۆشی، شادی، بەکەیفی، سەرخۆشی، خۆشحاڵی
"""),
// With short examples define "glee", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هەستی دڵخۆشی، بە تایبەتی بەهۆی ئەوەی شتێکی باشت کردووە یان شتێکی خراپ بەسەر کەسێک هاتووە"""),
                    SentencesRow(
                      englishText:
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/XeJ2vOHaATg?t=';
const double _startSecondsend = 0000000000000000000000000002732;
const String _videoIdone = 'https://youtu.be/hTqtGJwsJVE?t=';
const double _startSecondsone = 0000000000000000000000000002165;
const String _videoIdtwo = 'https://youtu.be/j0iOuOMh_JE?t=';
const double _startSecondstwo = 00000000000000000000000000076;
const String _videoIdthree = 'https://youtu.be/XG4rnKlgCN8?t=';
const double _startSecondsthree = 000000000000000000000000000349;
const String _videoIdfour = 'https://youtu.be/wGeL0C5LGDA?t=';
const double _startSecondsfour = 000000000000000000000000000208;
const String _videoIdfive = 'https://youtu.be/PuW8rq3zFtY?t=';
