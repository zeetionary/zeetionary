...
// With short examples define "flow", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەوڵی دا ڕێگری لە چۆڕەی خوێن لە برینەکەوە بکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕاهێنان ڕۆشتنی خوێن بۆ مێشک زیاد دەکات.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Cut back surrounding vegetation to increase light and air flow.""",
                      kurdishText:
                          """ڕووەکەکانی دەوروبەر کەم بکەرەوە بۆ ئەوەی ڕووناکی و سووڕی هەوا زیاد بکات.""",
                      englishNote:
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) بەرهەمهێنان یان دابینکردنی بەردەوامی شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """We are looking to improve data flow by up to 50%.""",
                      kurdishText:
                          """هەوڵ دەدەین ناردنی داتا بە ڕێژەی ٥٠٪ زیاد بکەین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """وەک هەمیشە تۆم لە چەنەدان نەدەکەوت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەمە دەکرێت ڕێگا بگرێت لەوەی هەوا بە ئازادی بچێت بۆ سییەکان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕووباری وی بۆ ڕۆژهەڵات دەچێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """داواکردنی تازە لە کۆتاییدا دەست دەکەن بە هاتن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """جووڵەی بەردەوا،ی هاتووچۆ بە تەنیشتدا تێپەڕی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەنجامەکانی هەڵبژاردن بۆ تەواوی شەوەکە دەهاتنەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هاوکاری خواردنی هاوردەکراو بەردەوام بوو لە گەشتن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٦. (کردار) گەشەکردن یان بەرهەمهێنان بەشیوەیەکی سرووشتی و ئاسان"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                    ...
                    SentencesRow(
                      englishText:
                          """We hope that the debate on this issue will continue to flow.""",
                      kurdishText:
                          """هیوادارین دیبەیت لەسەر ئەم بابەتە بەردەوام بێت لە بەرەوپێشچوون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئاهەنگەکە بەجۆشتر بوو کە خواردنەوە بەردەست بوو.""",
                      onPressedBritish: () => speaksentence26("en-GB"),
                      onPressedAmerican: () => speaksentence26("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٨. (کردار) کە بە ئاسانی هەستی پێ بکرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/GcdB5bFwio4?t=';
...
const String _videoIdtwo = 'https://youtu.be/WDetHC86Dgo?t=';
const double _startSecondstwo = 000000000000000000000000000151;
const String _videoIdthree = 'https://youtu.be/AF8d72mA41M?t=';
const double _startSecondsthree = 000000000000000000000000000237;
const String _videoIdfour = 'https://youtu.be/9TugA_z5vQE?t=';
const double _startSecondsfour = 000000000000000000000000000398;
const String _videoIdfive = 'https://youtu.be/PhNUjg9X4g8?t=';
