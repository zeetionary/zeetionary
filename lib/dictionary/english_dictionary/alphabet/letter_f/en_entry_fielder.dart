...
class EnglishEntryfielder extends StatefulWidget {
  const EnglishEntryfielder({super.key});

  @override
  State<EnglishEntryfielder> createState() => _EnglishEntryfielderState();
}

class _EnglishEntryfielderState extends State<EnglishEntryfielder> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fielder""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fielder took an amazing catch.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fielder""",
                      // alsoEnglishWord: "also: fielder",
                      britshText: """IpaUK: /ˈfiːldə(r)/""",
                      americanText: """IpaUS: /ˈfiːldər/""",
...
// With short examples define "fielder", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The fielder took an amazing catch.""",
                      kurdishText:
                          """تۆپگرەوەکە گرتنەوەیەکی مەزنی ئەنجام دا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/AbnMSk_G9BM';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/bMsdlCDqhtI?t=';
const double _startSecondsone = 000000000000000000000000000349;
const String _videoIdtwo = 'https://youtu.be/h6xyvTIHdXs?t=';
const double _startSecondstwo = 000000000000000000000000000758;
const String _videoIdthree = 'https://youtu.be/n-5rTHtcv7Y?t=';
const double _startSecondsthree = 000000000000000000000000000388;
const String _videoIdfour = 'https://youtu.be/L1DQTdrYTwI?t=';
const double _startSecondsfour = 000000000000000000000000000774;
const String _videoIdfive = 'https://youtu.be/dFIBwOSnih0?t=';
const double _startSecondsfive = 0000000000000000000000000001969;
