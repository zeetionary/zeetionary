...
class EnglishEntrygynaecologist extends StatefulWidget {
  const EnglishEntrygynaecologist({super.key});

  @override
  State<EnglishEntrygynaecologist> createState() =>
      _EnglishEntrygynaecologistState();
}

class _EnglishEntrygynaecologistState extends State<EnglishEntrygynaecologist> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gynaecologist (Derived forms: gynaecologists)
Usage: Brit, Cdn (US: gynecologist)
1. A specialist in gynaecology (- gynecologist [N. Amer], woman's doctor)
""",
  );

  final String keyword = "gynaecologist";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gynaecologist""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I think you should see a gynaecologist.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gynaecologist""",
                      // alsoEnglishWord: "also: gynaecologist",
                      britshText: """IpaUK: /ˌɡaɪnəˈkɒlədʒɪst/""",
                      americanText: """IpaUS: /ˌɡaɪnəˈkɑːlədʒɪst/""",
...
// With short examples define "gynaecologist", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """I think you should see a gynaecologist.""",
                      kurdishText: """پێموایە دەبێت پزیشکێکی ژنان ببینیت.""",
