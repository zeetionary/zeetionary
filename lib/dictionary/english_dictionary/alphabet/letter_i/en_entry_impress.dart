...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000517;
    const String videoIdone = 'https://youtu.be/qWAagS_MANg?t=';
    const double startSecondsone = 000000000000000000000000000619;
    const String videoIdtwo = 'https://youtu.be/3cxHwQl9pNM?t=';
    const double startSecondstwo = 000000000000000000000000000541;
    const String videoIdthree = 'https://youtu.be/QLq6GEiHqR8?t=';
    const double startSecondsthree = 0000000000000000000000000001757;
    const String videoIdfour = 'https://youtu.be/9TugA_z5vQE?t=';
    const double startSecondsfour = 000000000000000000000000000628;
    const String videoIdfive = 'https://youtu.be/X3n5Pk8fkLg?t=';
    const double startSecondsfive = 000000000000000000000000000280;
