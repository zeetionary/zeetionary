...
class EnglishEntryheroin extends StatefulWidget {
  const EnglishEntryheroin({super.key});

  @override
  State<EnglishEntryheroin> createState() => _EnglishEntryheroinState();
}

class _EnglishEntryheroinState extends State<EnglishEntryheroin> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heroin (Derived forms: heroins)
1. A narcotic that is considered a hard drug; a highly addictive morphine derivative; intravenous injection provides the fastest and most intense rush (- diacetylmorphine, junk [informal], diamorphine)
""",
  );

  final String keyword = "heroin";
...
کوردی: 
"""),
// With short examples define "heroin", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مادەیەکی هۆشبەری بەهێز کە لە مۆرفین درووست دەکرێت و دەکرێت بەکارهێنەرانی پێی ئاڵوودە بن"""),
                    SentencesRow(
                      englishText:
                          """Customs officers have seized nearly a ton of heroin destined for New York.""",
                      kurdishText:
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/R0fT6nkvoP4?t=';
const double _startSecondsend = 00000000000000000000000000015;
const String _videoIdone = 'https://youtu.be/RGvllptSxDQ?t=';
const double _startSecondsone = 0000000000000000000000000005;
const String _videoIdtwo = 'https://youtu.be/cKDP1MbUWow?t=';
const double _startSecondstwo = 00000000000000000000000000055;
const String _videoIdthree = 'https://youtu.be/B5Dr667ZUnM?t=';
const double _startSecondsthree = 00000000000000000000000000056;
const String _videoIdfour = 'https://youtu.be/UeNQ9ZGJi7I?t=';
const double _startSecondsfour = 0000000000000000000000000002583;
const String _videoIdfive = 'https://youtu.be/O1-jhDENkpo?t=';
