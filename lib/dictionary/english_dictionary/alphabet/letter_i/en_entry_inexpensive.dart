...
class EnglishEntryinexpensive extends StatefulWidget {
  const EnglishEntryinexpensive({super.key});

  @override
  State<EnglishEntryinexpensive> createState() =>
      _EnglishEntryinexpensiveState();
}

class _EnglishEntryinexpensiveState extends State<EnglishEntryinexpensive> {
  @override
  void initState() {
    super.initState();
...
1. Relatively low in price or charging low prices (- cheap, budget)
"inexpensive family restaurants";
""",
  );

  final String keyword = "inexpensive";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inexpensive""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Paper is relatively inexpensive here.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Can you recommend an inexpensive hotel?""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/mcZdTvOqmvI?t=';
    const double startSecondsend = 00000000000000000000000000038;
    const String videoIdone = 'https://youtu.be/KQWGHE7NTUA?t=';
    const double startSecondsone = 000000000000000000000000000103;
    const String videoIdtwo = 'https://youtu.be/V3NGBo2M1Ps?t=';
    const double startSecondstwo = 00000000000000000000000000062;
    const String videoIdthree = 'https://youtu.be/ua4oFVz39vM?t=';
    const double startSecondsthree = 000000000000000000000000000504;
    const String videoIdfour = 'https://youtu.be/Bbi0kEaTgio?t=';
    const double startSecondsfour = 00000000000000000000000000022;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inexpensive""",
                      // alsoEnglishWord: "also: inexpensive",
                      britshText: """IpaUK: /ˌɪnɪkˈspensɪv/""",
                      americanText: """IpaUS: /ˌɪnɪkˈspensɪv/""",
...
// کوردی: باش، خراپ نییە، هەرزان، زۆرنەبڕ، کەم‌خەرج
// """),
// With short examples define "inexpensive", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە پارەی زۆری تێناچێت"""),
                    SentencesRow(
                      englishText: """Paper is relatively inexpensive here.""",
                      kurdishText: """کاغەز تاڕادەیەک هەرزانە لێرە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەتوانیت هوتێلێکی هەرزان پێشنیار بکەیت؟""",
