...
// replace these: replace EnglishEntryanode - replace speakAnode - replace anode - /ˈænəʊd/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryanode extends StatelessWidget {
  // blank divider
  ...
  Future<void> speakanode936(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("A red wire is often attached to the anode.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "anode"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈænəʊd/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈænəʊd/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '0_c7D1ozjxM';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'FvMg_d4P5Nw';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '902K5fWggjQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'LAACx-BqmgI';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '4dR6l_2JTcM';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'coTG5mofPX0';
