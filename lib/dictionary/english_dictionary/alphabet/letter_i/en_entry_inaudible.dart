...
class EnglishEntryinaudible extends StatefulWidget {
  const EnglishEntryinaudible({super.key});

  @override
  State<EnglishEntryinaudible> createState() => _EnglishEntryinaudibleState();
}

class _EnglishEntryinaudibleState extends State<EnglishEntryinaudible> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inaudible""");
  }
