...
class EnglishEntryexclaim extends StatefulWidget {
  const EnglishEntryexclaim({super.key});

  @override
  State<EnglishEntryexclaim> createState() => _EnglishEntryexclaimState();
}

class _EnglishEntryexclaimState extends State<EnglishEntryexclaim> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exclaim""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exclaim""",
                      // alsoEnglishWord: "also: exclaim",
                      britshText: """IpaUK: /ɪkˈskleɪm/""",
                      americanText: """IpaUS: /ɪkˈskleɪm/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She exclaimed that it was useless.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) هاوارکردن؛ گوتنی شتێک لەناکاو و بە دەنگی بەرز"""),
          SentencesRow(
            englishText:
                """She opened her eyes and exclaimed in delight at the scene.""",
            kurdishText: """چاوەکانی کردەوە و لە خۆشیدا هاواری کرد.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She exclaimed that it was useless.""",
            kurdishText: """هاواری کرد ئەوە بێ‌سوودە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """They all exclaimed over her beautiful clothes.""",
            kurdishText: """هەموان هاواریان کرد بۆ جلە جوانەکانی.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: exclaim (Derived forms: exclaimed, exclaiming, exclaims)
1. Utter aloud; often with surprise, horror, or joy (= cry, cry out, outcry, call out, shout)
"'I won!' he exclaimed";
 
2. State or announce (= proclaim, promulgate)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/2fA5CBU61ZI?t=';
const double _startSecondsend = 000000000000000000000000000000; // 219;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/nsrI2hT9MsE?t=';
const double _startSecondsone = 00000000000000000000000000000; // 373;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/4f1ByM0gn9c?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 12558;
const String _videoIdthree = 'VIDEOhttps://youtu.be/HdTmUsap-RY?t=';
const double _startSecondsthree = 000000000000000000000000000; // 511;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/lrFTX-0vrDU?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 524;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/Gc-B-a5FrvU?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 523;
