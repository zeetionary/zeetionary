...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/KIxg2zxg1CQ?t=';
    const double startSecondsend = 000000000000000000000000000192;
    const String videoIdone = 'https://youtu.be/uR3GCIjqIFs?t=';
    const double startSecondsone = 000000000000000000000000000715;
    const String videoIdtwo = 'https://youtu.be/yRA0KMCEP2o?t=';
    const double startSecondstwo = 000000000000000000000000000900;
    const String videoIdthree = 'https://youtu.be/LHqbfJ3tq4Y?t=';
    const double startSecondsthree = 000000000000000000000000000504;
    const String videoIdfour = 'https://youtu.be/itwotkBzZGQ?t=';
    const double startSecondsfour = 0000000000000000000000000001358;
    const String videoIdfive = 'https://youtu.be/B82029-9A1M?t=';
    const double startSecondsfive = 000000000000000000000000000129;
