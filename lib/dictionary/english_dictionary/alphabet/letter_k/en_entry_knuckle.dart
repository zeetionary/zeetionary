...
class EnglishEntryknuckle extends StatefulWidget {
  const EnglishEntryknuckle({super.key});

  @override
  State<EnglishEntryknuckle> createState() => _EnglishEntryknuckleState();
}

class _EnglishEntryknuckleState extends State<EnglishEntryknuckle> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryknuckle knuckle
WORD_WEB knuckle knuckle knuckle
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "knuckle";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""knuckle""");
  }
...
کوردی: 
"""),
// With short examples define "knuckle", please follow LX instructions
