...
class EnglishEntryfulfilment extends StatefulWidget {
  const EnglishEntryfulfilment({super.key});

  @override
  State<EnglishEntryfulfilment> createState() => _EnglishEntryfulfilmentState();
}

class _EnglishEntryfulfilmentState extends State<EnglishEntryfulfilment> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fulfillment (Derived forms: fulfillments)
Usage: N. Amer (elsewhere: fulfilment)
1. A feeling of satisfaction at having achieved your desires (- fulfilment [Brit, Cdn])
 
2. The act of consummating something (a desire or promise etc) (- fulfilment [Brit, Cdn])
""",
  );

  final String keyword = "fulfilment";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Winning the award was the fulfilment of a dream.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The company's success was the fulfilment of a promise.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Her job gives her a great sense of fulfilment.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fulfilment""",
                      // alsoEnglishWord: "also: fulfilment",
                      britshText: """IpaUK: /fʊlˈfɪlmənt/""",
                      americanText: """IpaUS: /fʊlˈfɪlmənt/""",
...
کوردی: کردن، جێبەجێ‌کردن، بەدێهاتن، ڕاپەڕاندن، پیادەکردن، بەجێ‌هێنان،	قایل‌بوون، پێخۆش‌بوون، خۆشحاڵی، ڕازی‌بوون
"""),
// With short examples define "fulfilment", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) کردنی ئەوەی کە بەهیوا بوویت بۆی"""),
                    SentencesRow(
                      englishText:
                          """Winning the award was the fulfilment of a dream.""",
                      kurdishText:
                          """بردنەوەی خەڵاتەکە بەدیهێنانی خەونێک بوو.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) کردن یان هەبوونی ئەوەی کە پێویستە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The company's success was the fulfilment of a promise.""",
                      kurdishText:
                          """سەرکەوتنی کۆمپانیاکە بەدیهێنانی بەڵێنێک بوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) هەستی دڵخۆشی یان ئاسوودەیی بەوەی دەیکەیت یان کردووتە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Her job gives her a great sense of fulfilment.""",
                      kurdishText: """کارەکەی هەستی زۆری خۆشبەختی پێدەدات.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The fulfilment of online orders remains a challenge for many retailers.""",
                      kurdishText:
                          """جێبەجێکردنی داواکارییە ئۆنلاینەکان هێشتا ئاستەنگێکە بۆ زۆرێک لە فرۆشیارەکان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/KmaS21OmhKI?t=';
const double _startSecondsend = 0000000000000000000000000001117;
const String _videoIdone = 'https://youtu.be/jZB08H8ND8o?t=';
const double _startSecondsone = 00000000000000000000000000069;
const String _videoIdtwo = 'https://youtu.be/3NVpz6FgwOU?t=';
const double _startSecondstwo = 00000000000000000000000000057;
const String _videoIdthree = 'https://youtu.be/NG4Ws74RV04?t=';
const double _startSecondsthree = 000000000000000000000000000789;
const String _videoIdfour = 'https://youtu.be/_0TsRzZg3cQ?t=';
const double _startSecondsfour = 0000000000000000000000000002132;
const String _videoIdfive = 'https://youtu.be/2PZ9TyA0EXI?t=';
const double _startSecondsfive = 000000000000000000000000000112;
