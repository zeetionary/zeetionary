...
class EnglishEntryattacker extends StatelessWidget {
  ...
  Future<void> speakattacker(String languageCode) async {
    ...
    await flutterTts.speak("attacker");
  }
  ...
  Future<void> speakattacker637(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She didn't really see her attacker.");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "attacker"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈtækə(r)/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakattacker("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈtækər/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakattacker("en-US"),
                            ),
                          ],
                        ),
                      ],
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakattacker637("en-US"),
                          ),
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = '5jOlTfE5EwE';
