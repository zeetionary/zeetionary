...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/7j5ul4XBjAI?t=';
    const double startSecondsend = 000000000000000000000000000499;
    const String videoIdone = 'https://youtu.be/Zad6v8ZHzdg?t=';
    const double startSecondsone = 000000000000000000000000000252;
    const String videoIdtwo = 'https://youtu.be/60FM9WjkXtA?t=';
    const double startSecondstwo = 0000000000000000000000000001014;
    const String videoIdthree = 'https://youtu.be/QcUey-DVYjk?t=';
    const double startSecondsthree = 0000000000000000000000000001103;
    const String videoIdfour = 'https://youtu.be/ShMRAN78598?t=';
    const double startSecondsfour = 00000000000000000000000000060;
    const String videoIdfive = 'https://youtu.be/dHPTR96Sc1g?t=';
    const double startSecondsfive = 000000000000000000000000000785;
