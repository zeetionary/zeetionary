...
class EnglishEntrydecking extends StatefulWidget {
  const EnglishEntrydecking({super.key});

  @override
  State<EnglishEntrydecking> createState() => _EnglishEntrydeckingState();
}

class _EnglishEntrydeckingState extends State<EnglishEntrydecking> {
  @override
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "decking");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: decking");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /ˈdekɪŋ/");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakdecking(String languageCode) async {
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /ˈdekɪŋ/");
  }
}
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakdeckings1(String languageCode) async {
    // DOPSUM: CHANGE speakdecking
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
...
// کوردی: کەل‌وپەلی سازکردنی (سەر)پشتی کەشتی
// """),
          const DefinitionKurdish(
              text: "١. (ناو) تەختە کە بۆ درووستکردنی سەکۆیەکی دارین بەکاردێت"),
          Row(
            children: [
              const Expanded(
                child: Column(
              ...
              const CustomSizedBoxForTTS(), // With short examples define "decking", please follow LX instructions
              Column(
                children: [
                  CustomIconButtonBritish(
                    onPressed: () => speakdeckings1("en-GB"),
                  ),
                  CustomIconButtonAmerican(
                    onPressed: () => speakdeckings1("en-US"),
                  ),
                ],
              ),
            ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdeckings200"),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdeckings2("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdeckings2("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
...
// Create an instance of EnglishMeaningConst with the desired text
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: decking (derived forms: deckings)
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  late YoutubePlayerController _controller;
  final String _videoId = 'pCFsroLfTaI';
...
class _YoutubeEmbeddedtwoState extends State<YoutubeEmbeddedtwo> {
  late YoutubePlayerController _controller;
  final String _videoId = 'jMPF1amMB2M';
...
class _YoutubeEmbeddedthreeState extends State<YoutubeEmbeddedthree> {
  late YoutubePlayerController _controller;
  final String _videoId = 'tO5qTxM_P48';
...
class _YoutubeEmbeddedfiveState extends State<YoutubeEmbeddedfive> {
  late YoutubePlayerController _controller;
  final String _videoId = 'S7Omqkos9ag';
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  late YoutubePlayerController _controller;
  final String _videoId = 'dnMeKO78PjU';
