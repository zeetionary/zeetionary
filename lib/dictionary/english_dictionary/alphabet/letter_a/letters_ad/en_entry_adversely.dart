...
// replace these: replace EnglishEntryadversely - replace speakAdversely - replace adversely - /ˈædvɜːsli/,  /ədˈvɜːsli/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadversely extends StatelessWidget {
  EnglishEntryadversely({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdversely(String languageCode) async {
    // DOPSUM: CHANGE speakAdversely
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("adversely"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAdve592(String languageCode) async {
    ...
    await flutterTts.speak(
        "Her health was adversely affected by the climate."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈædvɜːsli/,  /ədˈvɜːsli/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '335DsLpMy-k';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'dFEcoO0V6rA';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'XG8ulkbNT2Y';
