...
// replace august - replace EnglishEntryaugusttwo

// replace speakAugusttwo - /ɔːˈɡʌst/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryaugusttwo extends StatelessWidget {
  // blank divider
  EnglishEntryaugusttwo({super.key});
  // blank divider
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakaugusttwo338("en-US"),
                          ),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'Fx8iSPoI9O8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 10375;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'zYgkr0KfWM0';
