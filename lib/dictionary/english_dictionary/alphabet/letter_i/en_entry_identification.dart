...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000402;
    const String videoIdone = 'https://youtu.be/pFmtmO2cnlg?t=';
    const double startSecondsone = 000000000000000000000000000431;
    const String videoIdtwo = 'https://youtu.be/b_rjBWmc1iQ?t=';
    const double startSecondstwo = 000000000000000000000000000455;
    const String videoIdthree = 'https://youtu.be/qg2nGY1aqlg?t=';
    const double startSecondsthree = 0000000000000000000000000001240;
    const String videoIdfour = 'https://youtu.be/Ir3eJ1t13fk?t=';
    const double startSecondsfour = 0000000000000000000000000002485;
    const String videoIdfive = 'https://youtu.be/VNZ0so0LCoM?t=';
