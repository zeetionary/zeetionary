...
// replace EnglishEntryAdopsum - replace speakAppointment

// replace appointment - /əˈpɔɪntmənt/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryappointment extends StatelessWidget {
  // blank divider
  EnglishEntryappointment({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "appointment"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈpɔɪntmənt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈpɔɪntmənt/"),
