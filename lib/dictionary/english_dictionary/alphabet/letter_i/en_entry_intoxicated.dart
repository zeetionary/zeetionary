...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 562;
    const String videoIdtwo = 'S4qvPouh1gE';
    const double startSecondstwo = 1345;
    const String videoIdthree = 'F0jr-HQeT74';
    const double startSecondsthree = 93;
    const String videoIdfour = 'pXWyeg2GFBc';
    const double startSecondsfour = 337;
    const String videoIdfive = 'bPwnDyW26gk';
