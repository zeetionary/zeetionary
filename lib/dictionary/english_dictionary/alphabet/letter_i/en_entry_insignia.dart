...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'H7Quhnm-Z8A';
    const double startSecondsend = 549;
    const String videoIdone = 'vsMydMDi3rI';
    const double startSecondsone = 749;
    const String videoIdtwo = 'BBnlC9lrKVM';
    const double startSecondstwo = 737;
    const String videoIdthree = 'PhQksV8fbKw';
    const double startSecondsthree = 1059;
    const String videoIdfour = '2IOyQlZRKhQ';
    const double startSecondsfour = 73;
    const String videoIdfive = 'GYNsox4n9l0';
