...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'ZoLU3-dhoY0';
    const double startSecondsend = 83;
    const String videoIdone = 'fGMCjELDyUY';
    const double startSecondsone = 1932;
    const String videoIdtwo = 'wVyu7NB7W6Y';
    const double startSecondstwo = 1537;
    const String videoIdthree = 'THIGSnMP3io';
    const double startSecondsthree = 926;
    const String videoIdfour = 'MITeeIbCatY';
    const double startSecondsfour = 1505;
    const String videoIdfive = 'VFR37y1-81M';
    const double startSecondsfive = 1548;
...
// With short examples define "interrogation", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) ئەوەی پرسیاری زۆر لە کەسێک بکەیت بۆ ماوەیەکی زۆر، زۆرجار بە توندی"""),
                    SentencesRow(
                      englishText:
