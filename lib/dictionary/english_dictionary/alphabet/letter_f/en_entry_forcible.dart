...
class EnglishEntryforcible extends StatefulWidget {
  const EnglishEntryforcible({super.key});

  @override
  State<EnglishEntryforcible> createState() => _EnglishEntryforcibleState();
}

class _EnglishEntryforcibleState extends State<EnglishEntryforcible> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: forcible
1. Impelled by physical force especially against resistance (= physical, strong-arm)
"forcible entry";
""",
  );

  final String keyword = "forcible";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forcible""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forcible""",
                      // alsoEnglishWord: "also: forcible",
                      britshText: """IpaUK: /ˈfɔːsəbl/""",
                      americanText: """IpaUS: /ˈfɔːrsəbl/""",
...
// With short examples define "forcible", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە بەکارهێنانی هێز لەخۆدەگرێت"""),
                    SentencesRow(
                      englishText:
                          """The police checked all windows and doors for signs of forcible entry.""",
                      kurdishText:
                          """پۆلیس هەموو پەنجەرە و دەرگاکانی پشکنی بۆ ئاماژەی چوونەژوورەوەی زۆرەملێ.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/kVQKGrf_bzs?t=';
const double _startSecondsend = 000000000000000000000000000464;
const String _videoIdone = 'https://youtu.be/bnhF_Qw0dtk?t=';
const double _startSecondsone = 000000000000000000000000000563;
const String _videoIdtwo = 'https://youtu.be/dOK8OdoS11k?t=';
const double _startSecondstwo = 000000000000000000000000000331;
const String _videoIdthree = 'https://youtu.be/sD0B-X9LJjs?t=';
const double _startSecondsthree = 000000000000000000000000000842;
const String _videoIdfour = 'https://youtu.be/_E2f0zq5elI?t=';
const double _startSecondsfour = 0000000000000000000000000004750;
const String _videoIdfive = 'https://youtu.be/GyNVIUpGTWM?t=';
const double _startSecondsfive = 0000000000000000000000000001762;
