...
class EnglishEntryhedgehog extends StatefulWidget {
  const EnglishEntryhedgehog({super.key});

  @override
  State<EnglishEntryhedgehog> createState() => _EnglishEntryhedgehogState();
}

class _EnglishEntryhedgehogState extends State<EnglishEntryhedgehog> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hedgehog (Derived forms: hedgehogs)
1. Relatively large rodents with sharp erectile bristles mingled with the fur (- porcupine, porky [N. Amer, informal])
 
2. Small nocturnal Old World mammal covered with both hair and protective spines (- Erinaceus europaeus, Erinaceus europeaeus)
""",
  );

  final String keyword = "hedgehog";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hedgehog""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hedgehog curled up when it saw the cat.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hedgehog""",
                      // alsoEnglishWord: "also: hedgehog",
                      britshText: """IpaUK: /ˈhedʒhɒɡ/""",
                      americanText: """IpaUS: /ˈhedʒhɔːɡ/""",
...
کوردی: ژیشک، ژۆژی، کەلۆ
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئاژەڵێکی بچووکی قاوەیی کە تاڵی تیژی وەک دەرزی لەسەر پشتییەتی، و زۆرجار بە شەو چالاکن و خۆیان تۆپەڵ دەکەن کە هێرشیان دەکرێتە سەر"""),
                    SentencesRow(
                      englishText:
                          """The hedgehog curled up when it saw the cat.""",
                      kurdishText:
                          """ژیشکەکە خۆت تۆپەڵ کرد کە پشیلەکەی بینی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Agl5vJJtQNE?t=';
const double _startSecondsend = 000000000000000000000000000545;
const String _videoIdone = 'https://youtu.be/Kqxw23fU8hc';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/gl_hGgXeRLs?t=';
const double _startSecondstwo = 00000000000000000000000000013;
const String _videoIdthree = 'https://youtu.be/X637mXR_xyI';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/xyePTW5Fe28?t=';
const double _startSecondsfour = 00000000000000000000000000035;
const String _videoIdfive = 'https://youtu.be/9HjATD1imGc';
