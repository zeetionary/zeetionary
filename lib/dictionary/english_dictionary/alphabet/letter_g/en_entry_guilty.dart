...
class EnglishEntryguilty extends StatefulWidget {
  const EnglishEntryguilty({super.key});

  @override
  State<EnglishEntryguilty> createState() => _EnglishEntryguiltyState();
}

class _EnglishEntryguiltyState extends State<EnglishEntryguilty> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: guilty (Derived forms: guiltiest, guiltier)
1. Responsible for or chargeable with a reprehensible act
"guilty of murder"; "the guilty person"; "secret guilty deeds"
 
2. Showing a sense of guilt (- hangdog, shamefaced, shamed)
"a guilty look";
""",
  );

  final String keyword = "guilty";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Matt and Chrissy both looked equally guilty.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""John had a guilty look on his face.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I had a guilty conscience and could not sleep.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He pleaded guilty to murder.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She may be guilty of murder.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """guilty""",
                      // alsoEnglishWord: "also: guilty",
                      britshText: """IpaUK: /ˈɡɪlti/""",
                      americanText: """IpaUS: /ˈɡɪlti/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ویژدانم تاوانکارانە بوو و نەمدەتوانی بخەوم.""",
                      englishNote:
                          """This sentence implies that the speaker felt responsible for something wrong or immoral they did, which caused them to feel guilty and unable to sleep.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She may be guilty of murder.""",
                      kurdishText: """لەوانەیە تاوانباری کوشتن بێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He was not guilty of the crime he had been put in prison for.""",
                      kurdishText:
                          """خەتاکاری ئەو تاوان نەبوو کە بۆی خرابوویە زیندان.""",
