...
class EnglishEntryhotdog extends StatefulWidget {
  const EnglishEntryhotdog({super.key});

  @override
  State<EnglishEntryhotdog> createState() => _EnglishEntryhotdogState();
}

class _EnglishEntryhotdogState extends State<EnglishEntryhotdog> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hot dog (Derived forms: hot dogs)
1. A frankfurter served hot on a bun (- hot dog, red hot [US, dialect])
 
2. A smooth-textured sausage of minced beef or pork usually smoked; often served on a bread roll (- frank [US, informal], frankfurter, hot dog, dog [informal], wiener [N. Amer, S.Africa], wienerwurst [N. Amer], weenie [N. Amer, informal], wienie [N. Amer, informal])
 
3. [N. Amer, informal] Someone who performs dangerous stunts to attract attention to himself (- hot dog [N. Amer, informal])

- Verb: hot-dog (Derived forms: hot-dogs, hot-dogging, hot-dogged)
Usage: N. Amer, informal
1. Perform intricate manoeuvres while skiing
""",
  );

  final String keyword = "hot dog";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hot dog""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She puts sliced hot dogs into the soup.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    // 188888880002200
    const String videoIdend = 'https://youtu.be/XqrqhcWW2CQ';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/oXW3wIfxKHo?t=';
    const double startSecondsone = 00000000000000000000000000080;
    const String videoIdtwo = 'https://youtu.be/7MSq6Ymi7OI';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/Qs6tLC1ODm8?t=';
    const double startSecondsthree = 0000000000000000000000000007;
    const String videoIdfour = 'https://youtu.be/3aaNfUW-4Zs?t=';
    const double startSecondsfour = 00000000000000000000000000073;
    const String videoIdfive = 'https://youtu.be/nITZooG6ij8?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hot dog""",
                      // alsoEnglishWord: "also: hot dog",
                      britshText: """IpaUK: /ˈhɒt dɒɡ/""",
                      americanText: """IpaUS: /ˈhɑːt dɔːɡ/""",
...
// With short examples define "hot dog", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) سۆسجێکی گەرم لە نانێکی لوولەدا"""),
                    SentencesRow(
                      englishText: """She puts sliced hot dogs into the soup.""",
                      kurdishText: """هۆت دۆگی وردکراو دەکاتە ناو شۆرباکەیەوە.""",
