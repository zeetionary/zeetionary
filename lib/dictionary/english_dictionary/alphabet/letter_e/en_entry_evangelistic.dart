...
class EnglishEntryevangelistic extends StatefulWidget {
  const EnglishEntryevangelistic({super.key});

  @override
  State<EnglishEntryevangelistic> createState() =>
      _EnglishEntryevangelisticState();
}

class _EnglishEntryevangelisticState extends State<EnglishEntryevangelistic> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evangelistic""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evangelistic""",
                      // alsoEnglishWord: "also: evangelistic",
                      britshText: """IpaUK: /ɪˌvændʒəˈlɪstɪk/""",
                      americanText: """IpaUS: /ɪˌvændʒəˈlɪstɪk/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "evangelistic";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The church emphasizes evangelistic work.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە هەوڵ دەدات خەڵکی بانگهێشتی مەسیحییەت بکات"""),
          SentencesRow(
            englishText: """The church emphasizes evangelistic work.""",
            kurdishText: """کڵێساکە جەخت دەکاتەوە لە کاری مژدەبەری دەکاتەوە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ھاوەڵناو) کە بە تامەزرۆیی هەوڵ دەدەیت خەڵکی بە شتێک ڕازی بکەیت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """She has brought opera to the masses with evangelistic zeal.""",
            kurdishText:
                """ئۆپێرای بە خەڵکێکی زۆر گەیاندووە بە ویستی نەبڕاوەوە و تامەزرۆیی.""",
...
1. Marked by ardent or zealous enthusiasm for a cause (= evangelical)
 
2. Relating to or promoting the preaching and dissemination of the Christian gospel
"evangelistic fervour"; "the evangelistic concerns of the early church"
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/Qm4cAaAFhEs?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1109;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/WwhyZUlmaWA?t=';
const double _startSecondsone = 00000000000000000000000000000; // 3381;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/c3Sih7aSf84?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 498;
const String _videoIdthree = 'VIDEOhttps://youtu.be/Iz4vlm3lHY8?t=';
const double _startSecondsthree = 000000000000000000000000000; // 481;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/z2-tSJAVOGo?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 75;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/iXmKQ52ByUM?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1144;
