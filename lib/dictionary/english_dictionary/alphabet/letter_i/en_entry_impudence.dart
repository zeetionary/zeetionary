...
class EnglishEntryimpudence extends StatefulWidget {
  const EnglishEntryimpudence({super.key});

  @override
  State<EnglishEntryimpudence> createState() => _EnglishEntryimpudenceState();
}

class _EnglishEntryimpudenceState extends State<EnglishEntryimpudence> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: impudence (Derived forms: impudences)
1. An impudent statement (- cheek, impertinence, sauce [Brit, informal])
 
2. The trait of being rude and impertinent; inclined to take liberties (- crust, gall, impertinence, insolence, cheekiness, freshness)
""",
  );

  final String keyword = "impudence";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impudence""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I’ve had enough of your impudence, young lady.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001177;
    const String videoIdone = 'https://youtu.be/s-tJ5WIQM1M?t=';
    const double startSecondsone = 0000000000000000000000000005;
    const String videoIdtwo = 'https://youtu.be/NBe5qbnkqoM?t=';
    const double startSecondstwo = 000000000000000000000000000224;
    const String videoIdthree = 'https://youtu.be/FCM-3jZ8dXY?t=';
    const double startSecondsthree = 000000000000000000000000000416;
    const String videoIdfour = 'https://youtu.be/-m9p2Z5DqWY?t=';
    const double startSecondsfour = 000000000000000000000000000920;
    const String videoIdfive = 'https://youtu.be/auQxY4ZEqP0?t=';
    const double startSecondsfive = 000000000000000000000000000413;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """impudence""",
                      // alsoEnglishWord: "also: impudence",
                      britshText: """IpaUK: /ˈɪmpjədəns/""",
                      americanText: """IpaUS: /ˈɪmpjədəns/""",
...
کوردی: بێ‌شەرمی، ڕووداری، بێ‌حەیایی، ئاوەسوویی، هەرزەیی، ڕووهەڵماڵراوی
"""),
// With short examples define "impudence", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) هەڵسووکەوتی بێ‌شەرمانە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: impertinence"),
                    SentencesRow(
                      englishText:
                          """I’ve had enough of your impudence, young lady.""",
                      kurdishText:
                          """بەشی پێویست لە بێ‌شەرمیتم دیوە، کچی گەنج.""",
