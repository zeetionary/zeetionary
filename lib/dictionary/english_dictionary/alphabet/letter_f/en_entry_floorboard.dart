...
class EnglishEntryfloorboard extends StatefulWidget {
  const EnglishEntryfloorboard({super.key});

  @override
  State<EnglishEntryfloorboard> createState() => _EnglishEntryfloorboardState();
}

class _EnglishEntryfloorboardState extends State<EnglishEntryfloorboard> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: floorboard (Derived forms: floor boards, floorboards)
1. A board in the floor (= floor board)
 
2. The floor of an automobile
""",
  );

  final String keyword = "floorboard";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""floorboard""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The money was hidden under the floorboards.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """floorboard""",
                      // alsoEnglishWord: "also: floorboard",
                      britshText: """IpaUK: /ˈflɔːbɔːd/""",
                      americanText: """IpaUS: /ˈflɔːrbɔːrd/""",
...
// With short examples define "floorboard", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) پارچە تەختەیەکی درێژ لە زەوییەتی دارین"""),
                    SentencesRow(
                      englishText:
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/qg2nGY1aqlg?t=';
const double _startSecondsend = 0000000000000000000000000001969;
const String _videoIdone = 'https://youtu.be/bIvqhdoZzo8?t=';
...
const String _videoIdthree = 'https://youtu.be/qSmyimnMOBo?t=';
const double _startSecondsthree = 000000000000000000000000000261;
const String _videoIdfour = 'https://youtu.be/iBzmicgDGCY?t=';
const double _startSecondsfour = 00000000000000000000000000077;
const String _videoIdfive = 'https://youtu.be/jhnLtcX3bKk?t=';
