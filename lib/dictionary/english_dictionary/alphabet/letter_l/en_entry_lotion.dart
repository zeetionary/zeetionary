...
class EnglishEntrylotion extends StatefulWidget {
  const EnglishEntrylotion({super.key});

  @override
  State<EnglishEntrylotion> createState() => _EnglishEntrylotionState();
}

class _EnglishEntrylotionState extends State<EnglishEntrylotion> {
  @override
  void initState() {
    super.initState();
