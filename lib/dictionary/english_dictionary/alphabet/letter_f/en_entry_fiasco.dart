...
class EnglishEntryfiasco extends StatefulWidget {
  const EnglishEntryfiasco({super.key});

  @override
  State<EnglishEntryfiasco> createState() => _EnglishEntryfiascoState();
}

class _EnglishEntryfiascoState extends State<EnglishEntryfiasco> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""What a fiasco!""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiasco""",
                      // alsoEnglishWord: "also: fiasco",
                      britshText: """IpaUK: /fiˈæskəʊ/""",
                      americanText: """IpaUS: /fiˈæskəʊ/""",
...
// With short examples define "fiasco", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """What a fiasco!""",
                      kurdishText: """چی ئابڕووچوونێک!""",
...
const String _videoIdtwo = 'https://youtu.be/WK_AtW66XI0?t=';
const double _startSecondstwo = 00000000000000000000000000094;
const String _videoIdthree = 'https://youtu.be/MnmrEMbDdyA?t=';
const double _startSecondsthree = 0000000000000000000000000001320;
const String _videoIdfour = 'https://youtu.be/VV83UpkOyR8?t=';
const double _startSecondsfour = 00000000000000000000000000049;
const String _videoIdfive = 'https://youtu.be/EiuMpLG_l6Q?t=';
const double _startSecondsfive = 000000000000000000000000000225;
