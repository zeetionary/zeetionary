...
class EnglishEntrycolour extends StatelessWidget {
  ...
  Future<void> speakcolours1(String languageCode) async {
    ...
    await flutterTts.speak(
        "// speakcolours111111111111111111111111111111111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcolours2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcolours200"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcolours3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcolours300"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcolours4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcolours400"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcolours5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcolours500"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcolours6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcolours600"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcolours7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcolours700"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcolours8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcolours800"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcolours9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcolours900"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcolours10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcolours1000"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcolours11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcolours1100"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcolours12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcolours1200"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcolours13(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcolours1300"); // DOPSUM: CHANGE TEXT
  }
                                ...
                                child: Column(
                                  children: [
                                    ExampleSentenceEnglish(
                                        text:
                                            "// speakcolours111111111111111111111111111111111"),
...
speakcolour EnglishEntrycolour
WORD_WEB colour haʊʊʊʊʊʊʊ4
""",
  );
