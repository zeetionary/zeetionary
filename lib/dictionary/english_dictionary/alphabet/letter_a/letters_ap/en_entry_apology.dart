...
// replace EnglishEntryAdopsum - replace speakApology

// replace apology - /əˈpɒlədʒi/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryapology extends StatelessWidget {
  // blank divider
  EnglishEntryapology({super.key});
  // blank divider
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "mrilDQugeME";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "dsWl42Uplt8";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "QntBkDFkiuY";
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  static String myVideoId = "yrOlx4e6ADg";
