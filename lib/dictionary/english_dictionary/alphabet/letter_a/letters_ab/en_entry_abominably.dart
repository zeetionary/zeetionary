...
// replace these: EnglishEntryabominably - speakAbominably - abominably - /əˈbɒmɪnəbli/

enum TtsState { playing }

class EnglishEntryabominably extends StatelessWidget {
  EnglishEntryabominably({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAbominably(String languageCode) async {
    // DOPSUM: CHANGE speakAbominably
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈbɒmɪnəbli/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '3kfGIz3u0RA';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'kEMJRjEdNzM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'WNHr7VHlzT4';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'jKevzVKCFCg';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'BNYh4p6tNr8';
