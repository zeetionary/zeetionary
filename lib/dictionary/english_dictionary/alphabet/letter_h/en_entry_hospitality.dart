...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/qjqh9UVfNNk?t=';
    const double startSecondsend = 0000000000000000000000000001278;
    const String videoIdone = 'https://youtu.be/CupbRr2m_sM?t=';
    const double startSecondsone = 0000000000000000000000000001542;
    const String videoIdtwo = 'https://youtu.be/JAOYywV_gvc?t=';
    const double startSecondstwo = 000000000000000000000000000196;
    const String videoIdthree = 'https://youtu.be/GF_bsZMe7zg?t=';
    const double startSecondsthree = 00000000000000000000000000016;
    const String videoIdfour = 'https://youtu.be/yYncTW_fhao?t=';
    const double startSecondsfour = 00000000000000000000000000059;
    const String videoIdfive = 'https://youtu.be/oAADFdfa-G4?t=';
    const double startSecondsfive = 0000000000000000000000000001325;
