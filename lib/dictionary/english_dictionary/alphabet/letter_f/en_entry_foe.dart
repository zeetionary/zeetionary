...
class EnglishEntryfoe extends StatefulWidget {
  const EnglishEntryfoe({super.key});

  @override
  State<EnglishEntryfoe> createState() => _EnglishEntryfoeState();
}

class _EnglishEntryfoeState extends State<EnglishEntryfoe> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foe (Derived forms: foes)
1. (military) an armed adversary (especially a member of an opposing military force) (= enemy, foeman [archaic], opposition)
"a soldier must be prepared to kill his foes";
 
2. A personal enemy (= enemy)
"they had been political foes for years";
""",
  );

  final String keyword = "foe";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She was unsure as yet whether he was friend or foe.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His newspaper articles criticized friend and foe alike.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foe""",
                      // alsoEnglishWord: "also: foe",
                      britshText: """IpaUK: /fəʊ/""",
                      americanText: """IpaUS: /fəʊ/""",
...
// With short examples define "foe", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دڵنیا نەبوو لەوەی کە دۆست یان دوژمنە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕۆژنامەکانی وەک یەک ڕەخنەیان لە دۆست و دوژمن دەگرت.""",
...
const double _startSecondsend = 0000000000000000000000000001149;
const String _videoIdone = 'https://youtu.be/-r_l-cTcWsE?t=';
...
const double _startSecondsthree = 0000000000000000000000000001983;
const String _videoIdfour = 'https://youtu.be/Eu46puWv7ts?t=';
const double _startSecondsfour = 000000000000000000000000000865;
const String _videoIdfive = 'https://youtu.be/tTJeePNgOF8?t=';
const double _startSecondsfive = 000000000000000000000000000361;
