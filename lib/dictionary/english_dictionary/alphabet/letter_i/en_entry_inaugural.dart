...
class EnglishEntryinaugural extends StatefulWidget {
  const EnglishEntryinaugural({super.key});

  @override
  State<EnglishEntryinaugural> createState() => _EnglishEntryinauguralState();
}

class _EnglishEntryinauguralState extends State<EnglishEntryinaugural> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inaugural""");
  }
