...
class EnglishEntryfabricate extends StatefulWidget {
  const EnglishEntryfabricate({super.key});

  @override
  State<EnglishEntryfabricate> createState() => _EnglishEntryfabricateState();
}

class _EnglishEntryfabricateState extends State<EnglishEntryfabricate> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fabricate""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fabricate""",
                      // alsoEnglishWord: "also: fabricate",
                      britshText: """IpaUK: /ˈfæbrɪkeɪt/""",
                      americanText: """IpaUS: /ˈfæbrɪkeɪt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "fabricate";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The evidence was totally fabricated.""");
  }
...
"""),
          ...
          SentencesRow(
            ...
            kurdishText: """بەڵگەکە تەواو درووستکراو بوو.""",
          ...
          SentencesRow(
            englishText:
                """The prisoner claimed the police had fabricated his confession.""",
            kurdishText:
                """زیندانییەکە بانگەشەی ئەوەی کرد کە پۆلیس دانپێدانانەکەی ساختە کرد.""",
...
2. Concoct something artificial or untrue (= manufacture, cook up [informal], make up, invent)
""",
  );
...
const String _videoIdtwo = 'https://youtu.be/Bj6ulLJGPB8?t=';
const double _startSecondstwo = 000000000000000000000000000360;
const String _videoIdthree = 'https://youtu.be/j0_7JTKlVvo?t=';
const double _startSecondsthree = 000000000000000000000000000121;
const String _videoIdfour = 'https://youtu.be/Kh2NRdVx_ns?t=';
const double _startSecondsfour = 000000000000000000000000000239;
const String _videoIdfive = 'https://youtu.be/6xdKdKlErZU?t=';
