...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'oBcxuzdP3rs';
    const double startSecondsend = 158;
    const String videoIdone = 'fGMCjELDyUY';
    const double startSecondsone = 1693;
    const String videoIdtwo = 'CjiKlLE3NuI';
    const double startSecondstwo = 861;
    const String videoIdthree = 'PhQksV8fbKw';
    const double startSecondsthree = 1943;
    const String videoIdfour = 'KDthN45L57Q';
    const double startSecondsfour = 548;
    const String videoIdfive = 'lQHXTJtzVk0';
