...
class EnglishEntryfrustrated extends StatefulWidget {
  const EnglishEntryfrustrated({super.key});

  @override
  State<EnglishEntryfrustrated> createState() => _EnglishEntryfrustratedState();
}

class _EnglishEntryfrustratedState extends State<EnglishEntryfrustrated> {
  @override
  void initState() {
    super.initState();
...
1. Disappointingly unsuccessful (= defeated, disappointed, discomfited, foiled, thwarted, gutted [Brit, informal], crushed)
"many frustrated poets end as pipe-smoking teachers";
""",
  );

  final String keyword = "frustrated";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frustrated""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It's very easy to get frustrated in this job.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His apathy just made her even more frustrated.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They felt frustrated at the lack of progress.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He stamped his foot in frustrated rage.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Frustrated writers often end up in publishing.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His frustrated wife expressed her concerns to him again.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frustrated""",
                      // alsoEnglishWord: "also: frustrated",
                      britshText: """IpaUK: /frʌˈstreɪtɪd/""",
                      americanText: """IpaUS: /ˈfrʌstreɪtɪd/""",
...
کوردی: تێشکاو، سەرنەکەوتوو، خەفەکراو، کپ‌کراو، کپێنراو، دامرکاو، دامراو، سەرنەگرتوو، نامراد، داماو، بێ‌ئەنجام(ماو)، سەرکوێر، ناهومێد، دڵسارد، باڵشکاو، دەس‌شکاو
"""),
// With short examples define "frustrated", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) هەستی بە بێزاری یان بێ‌ئۆقرەیی چونکە ناتوانێت ئەوە بکەیت کە دەتەوێت"""),
                    SentencesRow(
                      englishText:
                          """It's very easy to get frustrated in this job.""",
                      kurdishText: """زۆر ئاسانە لەم کارەدا بێ‌ئۆقرە بیت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بێ‌هەستییەکەی زیاتر بێزاریی دەکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەستیان بە بێزاری دەکرد بەهۆی کەمی بەرەوپێشچوون.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) کە هیچ کاریگەریی نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He stamped his foot in frustrated rage.""",
                      kurdishText:
                          """لە تووڕەیی بێهوودەدا پێی کوتا بە زەویدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """نووسەرە شکستخواردووەکان زۆرجار دەچنە کاری بڵاوکدرنەوەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ژنە ناقایلەکەی دووبارە نیگەرانییەکانی پێی ڕاگەیاند.""",
...
const double _startSecondsone = 000000000000000000000000000987;
const String _videoIdtwo = 'https://youtu.be/PkUg89kLLBE?t=';
const double _startSecondstwo = 0000000000000000000000000001843;
const String _videoIdthree = 'https://youtu.be/raSeaAeryWE?t=';
const double _startSecondsthree = 0000000000000000000000000001195;
const String _videoIdfour = 'https://youtu.be/nYRefC7E9gU?t=';
const double _startSecondsfour = 00000000000000000000000000049;
const String _videoIdfive = 'https://youtu.be/gjySnrspD7E?t=';
const double _startSecondsfive = 0000000000000000000000000001310;
