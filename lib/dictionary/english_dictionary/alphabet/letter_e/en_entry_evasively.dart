...
class EnglishEntryevasively extends StatefulWidget {
  const EnglishEntryevasively({super.key});

  @override
  State<EnglishEntryevasively> createState() => _EnglishEntryevasivelyState();
}

class _EnglishEntryevasivelyState extends State<EnglishEntryevasively> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evasively""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evasively""",
                      // alsoEnglishWord: "also: evasively",
                      britshText: """IpaUK: /ɪˈveɪsɪvli/""",
                      americanText: """IpaUS: /ɪˈveɪsɪvli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "evasively";
...
کوردی: بە خۆگێل‌کردنەوە، بە خۆدزینەوە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵکار) بەشێوەیەک کە وەڵامی ڕوونی پرسیارێک نادەیتەوە"""),
          SentencesRow(
            englishText: """‘I'm not sure,’ she replied evasively.""",
            kurdishText: """بە ناڕوونی وەڵامی دایەوە 'دڵنیا نیم'.""",
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/BLKD2Wf8_wk?t=';
const double _startSecondsend = 000000000000000000000000000000; // 15419;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/pJIjAwk8Jg8?t=';
const double _startSecondsone = 00000000000000000000000000000; // 871;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/bpdhhMSNX9s?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1612;
const String _videoIdthree = 'VIDEOhttps://youtu.be/SZCVF_4Oll8?t=';
const double _startSecondsthree = 000000000000000000000000000; // 513;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/xRGCAt6BgiQ?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 404;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/4Zfyecw5dd4?t=';
