...
class EnglishEntrylifeline extends StatefulWidget {
  const EnglishEntrylifeline({super.key});

  @override
  State<EnglishEntrylifeline> createState() => _EnglishEntrylifelineState();
}

class _EnglishEntrylifelineState extends State<EnglishEntrylifeline> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lifeline (Derived forms: life lines, lifelines)
1. A crease on the palm; its length is said by palmists to indicate how long you will live (- line of life, life line)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lifeline""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He clung to the lifeline and the woman pulled him towards the bank.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was stranded on the seabed for 40 mins when his lifeline snapped.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The extra payments are a lifeline for most single mothers.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The airport is the island's lifeline.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/EDx5OFOiQ-I?t=256';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/JGNiafLl0iA?t=58';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/y6GNrpcXtqM?t=77';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/EDMinX6t1Zk?t=259';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/yptTYheIKP8?t=47';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/hAEF50YEjxE?t=233';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lifeline""",
                      // alsoEnglishWord: "also: lifeline",
                      britshText: """IpaUK: /ˈlaɪflaɪn/""",
                      americanText: """IpaUS: /ˈlaɪflaɪn/""",
...
کوردی: 
"""),
// With short examples define "lifeline", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) حەبلێک کە فڕێ دەدرێت بۆ کەسێک کە لە مەترسیدایە لە ئاودا"""),
                    SentencesRow(
                      englishText: """He clung to the lifeline and the woman pulled him towards the bank.""",
                      kurdishText: """دەستی گرت بە پەتەکەوە و ژنەکە ڕایکێشا بۆ قەراغەکە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) حەبلێک کە دەبسترێت بە مەلەوانێکەوە و لە ڕێگەیەوە پەیوەندیی لەگەڵ سەرەوە دەبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He was stranded on the seabed for 40 mins when his lifeline snapped.""",
                      kurdishText: """لە بنکی دەریاکە بۆ ٤٠ خولەک بێ سەروشوێن بوو کە پەتەکەی پچڕا.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) شتێک کە زۆر گرنگە و پشتی پێ دەبەسترێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The extra payments are a lifeline for most single mothers.""",
                      kurdishText: """پارە زیادەکان یەکجارگرنگن بۆ ئەو دایکانەی تەنهان.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The airport is the island's lifeline.""",
                      kurdishText: """فڕۆکەخانەکە شادەماری دوورگەکەیە.""",
