...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/KvZNXaw-haI?t=';
    const double startSecondsend = 00000000000000000000000000034;
    const String videoIdone = 'https://youtu.be/Jtwv74zF-10?t=';
    const double startSecondsone = 00000000000000000000000000017;
    const String videoIdtwo = 'https://youtu.be/iYwqH4b59Q0?t=';
    const double startSecondstwo = 00000000000000000000000000065;
    const String videoIdthree = 'https://youtu.be/vIkmO9-bICM?t=';
    const double startSecondsthree = 00000000000000000000000000020;
    const String videoIdfour = 'https://youtu.be/B5DAXWGS2Ys?t=';
    const double startSecondsfour = 0000000000000000000000000008;
    const String videoIdfive = 'https://youtu.be/K2A_nmNklZc?t=';
