...
class EnglishEntryfantasize extends StatefulWidget {
  const EnglishEntryfantasize({super.key});

  @override
  State<EnglishEntryfantasize> createState() => _EnglishEntryfantasizeState();
}

class _EnglishEntryfantasizeState extends State<EnglishEntryfantasize> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fantasize""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fantasize""",
                      // alsoEnglishWord: "also: fantasize",
                      britshText: """IpaUK: /ˈfæntəsaɪz/""",
                      americanText: """IpaUS: /ˈfæntəsaɪz/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "fantasize";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He sometimes fantasized about winning the gold medal.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He spent his time fantasizing revenge.""");
  }
...
// With short examples define "fantasize", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He spent his time fantasizing revenge.""",
            kurdishText: """کاتەکەی بەسەر برد بە خەیاڵکردنی تۆڵەکردنەوە.""",
...
2. Portray in the mind (= fantasise [Brit])
...
const String _videoIdone = 'https://youtu.be/HSG3uEzld_A?t=';
const double _startSecondsone = 000000000000000000000000000192;
const String _videoIdtwo = 'https://youtu.be/J_Z3JJBkpeQ?t=';
const double _startSecondstwo = 000000000000000000000000000308;
const String _videoIdthree = 'https://youtu.be/27rLZ16BTFY?t=';
const double _startSecondsthree = 00000000000000000000000000090;
const String _videoIdfour = 'https://youtu.be/b6he-99lyKg?t=';
const double _startSecondsfour = 000000000000000000000000000695;
const String _videoIdfive = 'https://youtu.be/d1mbbYKPpHY?t=';
