...
class EnglishEntryfingertip extends StatefulWidget {
  const EnglishEntryfingertip({super.key});

  @override
  State<EnglishEntryfingertip> createState() => _EnglishEntryfingertipState();
}

class _EnglishEntryfingertipState extends State<EnglishEntryfingertip> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fingertip (Derived forms: fingertips)
1. The end (tip) of a finger
""",
  );

  final String keyword = "fingertip";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fingertip""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Apply the cream gently using your fingertips.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fingertip""",
                      // alsoEnglishWord: "also: fingertip",
                      britshText: """IpaUK: /ˈfɪŋɡətɪp/""",
                      americanText: """IpaUS: /ˈfɪŋɡərtɪp/""",
...
// With short examples define "fingertip", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کرێمەکە بەهێواشی دابنە بە سەری پەنجەکانت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/CXvG2CBJ3SE?t=';
const double _startSecondsend = 000000000000000000000000000573;
const String _videoIdone = 'https://youtu.be/dtp6b76pMak?t=';
const double _startSecondsone = 0000000000000000000000000001288;
const String _videoIdtwo = 'https://youtu.be/Rzd0mLf366I?t=';
...
const String _videoIdfour = 'https://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondsfour = 0000000000000000000000000001792;
const String _videoIdfive = 'https://youtu.be/y1r9toPQNkM?t=';
