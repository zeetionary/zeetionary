...
class EnglishEntryglossy extends StatefulWidget {
  const EnglishEntryglossy({super.key});

  @override
  State<EnglishEntryglossy> createState() => _EnglishEntryglossyState();
}

class _EnglishEntryglossyState extends State<EnglishEntryglossy> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her hair looked soft and glossy.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This magazine is full of glossy advertisements.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glossy""",
                      // alsoEnglishWord: "also: glossy",
                      britshText: """IpaUK: /ˈɡlɒsi/""",
                      americanText: """IpaUS: /ˈɡlɑːsi/""",
...
// With short examples define "glossy", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Her hair looked soft and glossy.""",
                      kurdishText: """قژی نەرم و بریقەدار دەردەکەوت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Eating carrots should make your pet’s fur thicker and glossier.""",
                      kurdishText:
                          """خواردنی گێزەر دەبێت فەرووی ئاژەڵە ماڵییەکەت ئەستوورتر و بریقەدارتر بکات.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵناو) کە گرنگ و گران‌بەها شت دەردەخات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """This magazine is full of glossy advertisements.""",
                      kurdishText: """ئەم گۆڤارە پڕە لە ڕیکلامی باق و بریق.""",
...
const double _startSecondsend = 000000000000000000000000000105;
const String _videoIdone = 'https://youtu.be/57htei0Xw1E?t=';
const double _startSecondsone = 000000000000000000000000000160;
const String _videoIdtwo = 'https://youtu.be/UoSSCUMk-7I?t=';
const double _startSecondstwo = 0000000000000000000000000001047;
const String _videoIdthree = 'https://youtu.be/kDdUdvNQndo?t=';
const double _startSecondsthree = 000000000000000000000000000370;
const String _videoIdfour = 'https://youtu.be/3n99jqOdeSw?t=';
const double _startSecondsfour = 000000000000000000000000000765;
const String _videoIdfive = 'https://youtu.be/9hvjBi4PKWA?t=';
const double _startSecondsfive = 0000000000000000000000000001219;
