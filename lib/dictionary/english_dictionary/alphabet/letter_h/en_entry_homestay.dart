...
class EnglishEntryhomestay extends StatefulWidget {
  const EnglishEntryhomestay({super.key});

  @override
  State<EnglishEntryhomestay> createState() => _EnglishEntryhomestayState();
}

class _EnglishEntryhomestayState extends State<EnglishEntryhomestay> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: homestay (Derived forms: homestays)
1. A time spent staying as a guest in a stranger's home (e.g. on holiday)
""",
  );

  final String keyword = "homestay";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""homestay""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The trip includes a homestay in a traditional village.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We arrange homestays for students and school groups.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/eEA0Y54-Ds8?t=';
    const double startSecondsend = 00000000000000000000000000058;
    const String videoIdone = 'https://youtu.be/ybvTU4uldOM?t=';
    const double startSecondsone = 000000000000000000000000000491;
    const String videoIdtwo = 'https://youtu.be/VPTCVwnfRZY?t=';
    const double startSecondstwo = 000000000000000000000000000551;
    const String videoIdthree = 'https://youtu.be/3ptcqDHvdXI?t=';
    const double startSecondsthree = 000000000000000000000000000227;
    const String videoIdfour = 'https://youtu.be/_xJfgMRPdp8?t=';
    const double startSecondsfour = 0000000000000000000000000001022;
    const String videoIdfive = 'https://youtu.be/OKva7dVgzGg?t=';
    const double startSecondsfive = 0000000000000000000000000002250;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homestay""",
                      // alsoEnglishWord: "also: homestay",
                      britshText: """IpaUK: /ˈhəʊmsteɪ/""",
                      americanText: """IpaUS: /ˈhəʊmsteɪ/""",
...
کوردی: 
"""),
// With short examples define "homestay", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مانەوەی خێزان یان گەشتیار لە ماڵی خێزانێک بە کرێ؛ ماڵێک کە بەم شێوەیە"""),
                    SentencesRow(
                      englishText:
                          """The trip includes a homestay in a traditional village.""",
                      kurdishText:
                          """گەشتەکە مانەوە لەخۆ دەگرێت لە گوندێکی کۆن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """مانەوەی خێزانی بۆ خوێندکاران و گرووپی قوتابخانە ڕێکدەخەین.""",
