...
class EnglishEntryartistically extends StatelessWidget {
  ...
  Future<void> speakartistically(String languageCode) async {
    ...
    await flutterTts.speak("artistically");
  }
  ...
  Future<void> speakartistically930(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("The film was both commercially and artistically successful.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "artistically"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ɑːˈtɪstɪkli/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakartistically("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ɑːrˈtɪstɪkli/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakartistically("en-US"),
                            ),
                          ],
                        ),
                      ],
...
کوردی: لەباری ھونەری‌یەوە، ھونەرمەندانە، دەس‌ڕەنگینانە
"""),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final double _startSeconds = 1859;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '2gQ1v1AxHKc';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'J45QdpSqsco';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '9h2QqLE7xmU';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'F0_W6gomFA8';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'fNDS1_iZz_s';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'ldLKs8VOi3E';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'bTUUNZFOflw';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'CfHysNgRy7c';
