...
class EnglishEntryfeatureless extends StatefulWidget {
  const EnglishEntryfeatureless({super.key});

  @override
  State<EnglishEntryfeatureless> createState() =>
      _EnglishEntryfeaturelessState();
}

class _EnglishEntryfeaturelessState extends State<EnglishEntryfeatureless> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""featureless""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """featureless""",
                      // alsoEnglishWord: "also: featureless",
                      britshText: """IpaUK: /ˈfiːtʃələs/""",
                      americanText: """IpaUS: /ˈfiːtʃərləs/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "featureless";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The countryside is flat and featureless.""");
  }
...
کوردی: بێ‌تایبەتمەندی، ئاسایی، ناخۆش، ناسەرنج‌ڕاکێش
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) بەبی تایبەتمەندیی جیاکەرەوە کە تێبینی بکرێت"""),
          SentencesRow(
            englishText: """The countryside is flat and featureless.""",
            kurdishText: """دەشتەکە تەخت و ئاساییە.""",
          ...
          SentencesRow(
            englishText:
                """The taxi drove her from the airport along featureless expressways.""",
            kurdishText:
                """تەکسییەکە لە فڕۆکەخانەکە گواستییەوە بە پانەڕێی ئاساییدا.""",
...
const String _videoIdend = 'https://youtu.be/DxL2HoqLbyA?t=';
const double _startSecondsend = 0000000000000000000000000001518;
const String _videoIdone = 'https://youtu.be/pzvbUpKU4eE?t=';
const double _startSecondsone = 00000000000000000000000000030;
const String _videoIdtwo = 'https://youtu.be/em-pVICrnqM?t=';
const double _startSecondstwo = 000000000000000000000000000421;
const String _videoIdthree = 'https://youtu.be/hG0ROjzgEA0?t=';
const double _startSecondsthree = 000000000000000000000000000115;
const String _videoIdfour = 'https://youtu.be/w6EblErBJqw?t=';
const double _startSecondsfour = 000000000000000000000000000603;
const String _videoIdfive = 'https://youtu.be/bHHz5NohafE?t=';
