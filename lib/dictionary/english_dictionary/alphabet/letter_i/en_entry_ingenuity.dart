...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'jMhXEnQLni0';
    const double startSecondsend = 134;
    const String videoIdone = '4itx6mXEJ6c';
    const double startSecondsone = 237;
    const String videoIdtwo = 'iZbala54uzk';
    const double startSecondstwo = 231;
    const String videoIdthree = '5hos7hv1Cn8';
    const double startSecondsthree = 1190;
    const String videoIdfour = 'ARgT2XmHN2E';
    const double startSecondsfour = 250;
    const String videoIdfive = 'Ky1c6d7v0pQ';
    const double startSecondsfive = 686;
