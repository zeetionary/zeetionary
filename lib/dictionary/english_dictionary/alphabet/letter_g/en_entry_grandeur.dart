...
class EnglishEntrygrandeur extends StatefulWidget {
  const EnglishEntrygrandeur({super.key});

  @override
  State<EnglishEntrygrandeur> createState() => _EnglishEntrygrandeurState();
}

class _EnglishEntrygrandeurState extends State<EnglishEntrygrandeur> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grandeur (Derived forms: grandeurs)
1. The quality of being magnificent, splendid or grand (- magnificence, brilliance, splendor [US], splendour [Brit, Cdn], grandness)
"an imaginative mix of old-fashioned grandeur and colourful art";
 
2. The quality of elevation of mind and exaltation of character, ideals or conduct (- nobility, nobleness, magnanimousness)
""",
  );

  final String keyword = "grandeur";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grandeur""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He has a sense of grandeur about him.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grandeur""",
                      // alsoEnglishWord: "also: grandeur",
                      britshText: """IpaUK: /ˈɡrændʒə(r)/,  /ˈɡrændjə(r)/""",
                      americanText: """IpaUS: /ˈɡrændʒər/,  /ˈɡrændjər/""",
...
کوردی: گەورەیی، مەزنی، مەزناهی، شکۆ، فەڕ، ئەندێش، هەیبەت، سام،	باوەڕ، بایەخ،	دەس‌ڕۆیشتوویی، گرنگی
"""),
// With short examples define "grandeur", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە سەرنجڕاکێش و مەزن بێت لە شێوەدا"""),
                    const AlsoEnglishckb(word: "ھەروەھا: splendour"),
                    SentencesRow(
                      englishText:
                          """We admired the grandeur and simplicity of the Roman architecture.""",
                      kurdishText:
                          """سەرسام بووین بە مەزنی و سادەیی تەلارسازی ڕۆمانی.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) گرنگی یان پێگەی کۆمەڵایەتی کە کەسێک هەیەتی یان پێی وایە هەیەتی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He has a sense of grandeur about him.""",
                      kurdishText: """هەستێکی نەجیبزادەیی هەبوو لەسەری.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/JHjXwicEwQo?t=';
const double _startSecondsend = 000000000000000000000000000256;
const String _videoIdone = 'https://youtu.be/JN3KPFbWCy8?t=';
const double _startSecondsone = 0000000000000000000000000002150;
const String _videoIdtwo = 'https://youtu.be/PVs_xZ46Cxw?t=';
const double _startSecondstwo = 0000000000000000000000000001054;
const String _videoIdthree = 'https://youtu.be/Ky1c6d7v0pQ?t=';
const double _startSecondsthree = 000000000000000000000000000256;
const String _videoIdfour = 'https://youtu.be/SUsqnD9-42g?t=';
const double _startSecondsfour = 000000000000000000000000000431;
const String _videoIdfive = 'https://youtu.be/sKEadUHagWc?t=';
const double _startSecondsfive = 000000000000000000000000000344;
