...
class EnglishEntryidealization extends StatefulWidget {
  const EnglishEntryidealization({super.key});

  @override
  State<EnglishEntryidealization> createState() =>
      _EnglishEntryidealizationState();
}

class _EnglishEntryidealizationState extends State<EnglishEntryidealization> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: idealization (Derived forms: idealizations)
1. A portrayal of something as ideal (- idealisation [Brit], glorification)
"the idealization of rural life was very misleading";
 
2. (psychiatry) a defence mechanism that splits something you are ambivalent about into two representations--one good and one bad (- idealisation [Brit])
 
3. Something that exists only as an idea (- idealisation [Brit])
""",
  );

  final String keyword = "idealization";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""idealization""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """An idealization of nature characterized the artist’s work.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Gj5uEr0Lh-k?t=';
    const double startSecondsend = 0000000000000000000000000004015;
    const String videoIdone = 'https://youtu.be/Gy5FA57W70A?t=';
    const double startSecondsone = 000000000000000000000000000149;
    const String videoIdtwo = 'https://youtu.be/KcaVhMt71qE?t=';
    const double startSecondstwo = 0000000000000000000000000002267;
    const String videoIdthree = 'https://youtu.be/0fvZhF2zdr4?t=';
    const double startSecondsthree = 00000000000000000000000000029;
    const String videoIdfour = 'https://youtu.be/V1Ahnobmygg?t=';
    const double startSecondsfour = 000000000000000000000000000490;
    const String videoIdfive = 'https://youtu.be/Q2cSDt5ptrg?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """idealization""",
                      // alsoEnglishWord: "also: idealization",
                      britshText: """IpaUK: /aɪˌdiːəlaɪˈzeɪʃn/""",
                      americanText: """IpaUS: /aɪˌdiːələˈzeɪʃn/""",
...
کوردی: 
"""),
// With short examples define "idealization", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە کەسێک/شتێک باشتر لەوەی هەیە ببینیت یان پیشان بدەیت"""),
                    SentencesRow(
                      englishText:
                          """An idealization of nature characterized the artist’s work.""",
                      kurdishText:
                          """جوانترپیشاندانی سرووشت خاسیەتی کاری هونەرمەندەکە بوو.""",
                      englishNote:
                          """This means the artist’s work was marked by an unrealistic or romanticized portrayal of nature, emphasizing perfect or ideal aspects rather than realistic details.""",
