...
class EnglishEntryhayfever extends StatefulWidget {
  const EnglishEntryhayfever({super.key});

  @override
  State<EnglishEntryhayfever> createState() => _EnglishEntryhayfeverState();
}

class _EnglishEntryhayfeverState extends State<EnglishEntryhayfever> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hay fever
1. A seasonal rhinitis resulting from an allergic reaction to pollen (- pollinosis)
""",
  );

  final String keyword = "hay fever";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hay fever""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She suffers from hay fever every spring.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hay fever""",
                      // alsoEnglishWord: "also: hay fever",
                      britshText: """IpaUK: /ˈheɪ fiːvə(r)/""",
                      americanText: """IpaUS: /ˈheɪ fiːvər/""",
...
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) نەخۆشییەک کە تووشی لووت، قوڕگ، و چاو دەبێت و بەهۆی ئەو هەڵاڵانەوە درووست دەبێت کە هەڵدەمژرێن لە هەوادا"""),
                    SentencesRow(
                      englishText:
                          """She suffers from hay fever every spring.""",
                      kurdishText: """هەموو بەهارێک تووشی پووشەتێ دەبێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/5slOG0bYZck?t=';
const double _startSecondsend = 000000000000000000000000000454;
const String _videoIdone = 'https://youtu.be/afTXaxQv7Yg?t=';
const double _startSecondsone = 0000000000000000000000000003682;
const String _videoIdtwo = 'https://youtu.be/SXIah083UBE?t=';
const double _startSecondstwo = 000000000000000000000000000738;
const String _videoIdthree = 'https://youtu.be/Jf7gag2M2Ro?t=';
const double _startSecondsthree = 000000000000000000000000000950;
const String _videoIdfour = 'https://youtu.be/DZRIzGMr4jE?t=';
const double _startSecondsfour = 000000000000000000000000000753;
const String _videoIdfive = 'https://youtu.be/3wNin31IdmU?t=';
