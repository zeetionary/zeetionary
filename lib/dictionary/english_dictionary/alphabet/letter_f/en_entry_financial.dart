...
class EnglishEntryfinancial extends StatefulWidget {
  const EnglishEntryfinancial({super.key});

  @override
  State<EnglishEntryfinancial> createState() => _EnglishEntryfinancialState();
}

class _EnglishEntryfinancialState extends State<EnglishEntryfinancial> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: financial
1. Relating to finance (= fiscal)
"financial responsibility";
""",
  );

  final String keyword = "financial";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""financial""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Tokyo and New York are major financial centres.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The company offers sophisticated financial services.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The current financial crisis is global.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His motives were purely financial.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """financial""",
                      // alsoEnglishWord: "also: financial",
                      britshText: """IpaUK: /faɪˈnænʃl/,  /fəˈnænʃl/""",
                      americanText: """IpaUS: /faɪˈnænʃl/,  /fəˈnænʃl/""",
...
// With short examples define "financial", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تۆکیۆ و نیویۆرک سەنتەری دارایی گەورەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کۆمپانیاکە خزمەتگوزاریی باڵای دارایی پێشکەش دەکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """قەیرانە داراییەکەی ئێستا جیهانییە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """His motives were purely financial.""",
                      kurdishText: """پاڵنەرەکانی تەنها دارایی بوون.""",
...
const double _startSecondsone = 000000000000000000000000000391;
const String _videoIdtwo = 'https://youtu.be/SrDEtSlqJC4?t=';
const double _startSecondstwo = 000000000000000000000000000937;
const String _videoIdthree = 'https://youtu.be/gwZuUxeBYV8?t=';
const double _startSecondsthree = 000000000000000000000000000293;
const String _videoIdfour = 'https://youtu.be/qg2nGY1aqlg?t=';
const double _startSecondsfour = 0000000000000000000000000001762;
const String _videoIdfive = 'https://youtu.be/qr_dTySMl7s?t=';
