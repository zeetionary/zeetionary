...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/D7Cv7x6jjYQ?t=';
    const double startSecondsone = 00000000000000000000000000056;
    const String videoIdtwo = 'https://youtu.be/SDpCzJw2xm4?t=';
    const double startSecondstwo = 000000000000000000000000000195;
    const String videoIdthree = 'https://youtu.be/Vnf6hbRfIv0?t=';
    const double startSecondsthree = 000000000000000000000000000448;
    const String videoIdfour = 'https://youtu.be/lhc_bXGvmp0?t=';
    const double startSecondsfour = 00000000000000000000000000062;
    const String videoIdfive = 'https://youtu.be/_y4DbZivHCY';
