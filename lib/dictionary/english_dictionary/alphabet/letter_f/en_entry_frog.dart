...
class EnglishEntryfrog extends StatefulWidget {
  const EnglishEntryfrog({super.key});

  @override
  State<EnglishEntryfrog> createState() => _EnglishEntryfrogState();
}

class _EnglishEntryfrogState extends State<EnglishEntryfrog> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frog (Derived forms: frogs)
1. Any of various tailless stout-bodied amphibians with long hind limbs for leaping; semiaquatic and terrestrial species (- toad, toad frog, anuran, batrachian, salientian)
 
2. [informal] A person of French descent (- Gaul, Frog [informal])
...
- Verb: frog (Derived forms: frogs, frogging, frogged)
1. Hunt frogs for food
""",
  );

  final String keyword = "frog";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The frog jumped into the pond.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Frogs make a low noise called a croak.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frog""",
                      // alsoEnglishWord: "also: frog",
                      britshText: """IpaUK: /frɒɡ/""",
                      americanText: """IpaUS: /frɑːɡ/""",
...
// With short examples define "frog", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The frog jumped into the pond.""",
                      kurdishText: """بۆقەکە بازی دایە ناو زۆنگاوەکە.""",
                    ...
                    SentencesRow(
                      englishText: """Frogs make a low noise called a croak.""",
                      kurdishText:
                          """بۆق دەنگێکی نزم دەر دەکات کە پێی دەگوترێت قیڕە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/USxQgEp1GN8?t=';
const double _startSecondsend = 00000000000000000000000000037;
const String _videoIdone = 'https://youtu.be/8V3B85bfVFI?t=';
const double _startSecondsone = 00000000000000000000000000032;
const String _videoIdtwo = 'https://youtu.be/lr1VSvztlCM?t=';
const double _startSecondstwo = 00000000000000000000000000087;
const String _videoIdthree = 'https://youtu.be/bZhUwQqmvnk?t=';
const double _startSecondsthree = 00000000000000000000000000011;
const String _videoIdfour = 'https://youtu.be/GRmaeVL7VDo?t=';
const double _startSecondsfour = 00000000000000000000000000074;
const String _videoIdfive = 'https://youtu.be/4cdU17WVqN4?t=';
