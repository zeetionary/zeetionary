...
class EnglishEntryfeast extends StatefulWidget {
  const EnglishEntryfeast({super.key});

  @override
  State<EnglishEntryfeast> createState() => _EnglishEntryfeastState();
}

class _EnglishEntryfeastState extends State<EnglishEntryfeast> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """feast""",
                      // alsoEnglishWord: "also: feast",
                      britshText: """IpaUK: /fiːst/""",
                      americanText: """IpaUS: /fiːst/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The women were busy preparing the wedding feast.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Villagers used to hold a great feast at harvest time.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They celebrated a Muslim feast day with family.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The evening was a real feast for music lovers.""");
  }
...
کوردی: سوور، شا(د)ڕۆژ، جەژن، جێژن (دین)،	میوانی،	خۆشی، وەشی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ژەمە خواردنێکی گەورە، بەتایبەتی بۆ ژمارەیەکی زۆر کەس و ئاهەنگگێڕان"""),
          SentencesRow(
            englishText: """The women were busy preparing the wedding feast.""",
            kurdishText:
                """ژنەکان سەرقاڵ بوون بە ئامادەکردنی خواردنی هاوسەرگیرییەکەوە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """گوندنشینان ژەمێکی گەورە ڕێکدەخەن لە کاتی دروێنە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """ئێوارەکە بۆنەیەکی ڕاستەقینە بوو بۆ ئاشقانی میوزیک.""",
          ...
          SentencesRow(
            englishText:
                """We sat in the yard feasting on barbecued chicken and beer.""",
            kurdishText:
                """لە حەوشەکە دانیشتین مریشکین لە مەقاڵە دراو و بیرەمان خواردەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Flies were feasting on the rotting flesh.""",
            kurdishText: """مەگەزەکان لەسەر جەستە بۆگەنەکەیان دەخوارد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: feast (Derived forms: feasts)
...
4. An elaborate party (often outdoors) (= fete, fiesta, fête)

- Verb: feast (Derived forms: feasting, feasts, feasted)
1. Partake in a feast or banquet (= banquet, junket)
 
2. Provide a feast or banquet for (= banquet, junket)
 
3. Gratify (= feed)
"feast one's eyes on a gorgeous view";
""",
  );
...
const double _startSecondsend = 000000000000000000000000000128;
const String _videoIdone = 'https://youtu.be/GjMmsEwIcl0?t=';
const double _startSecondsone = 000000000000000000000000000534;
const String _videoIdtwo = 'https://youtu.be/7TavVZMewpY?t=';
...
const String _videoIdfour = 'https://youtu.be/yRmOWcWdQAo?t=';
const double _startSecondsfour = 00000000000000000000000000097;
const String _videoIdfive = 'https://youtu.be/jPCRXMkDTcA?t=';
