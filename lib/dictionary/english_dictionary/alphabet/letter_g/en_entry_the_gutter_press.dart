...
class EnglishEntrythegutterpress extends StatefulWidget {
  const EnglishEntrythegutterpress({super.key});

  @override
  State<EnglishEntrythegutterpress> createState() =>
      _EnglishEntrythegutterpressState();
}

class _EnglishEntrythegutterpressState
    extends State<EnglishEntrythegutterpress> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""the gutter press""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """the gutter press""",
                      // alsoEnglishWord: "also: the gutter press",
                      britshText: """IpaUK: /ðə ˌɡʌtə ˈpres/""",
                      americanText: """IpaUS: /ðə ˌɡʌtər ˈpres/""",
...
// \b(the gutter press)(s|ed|es|ing)?\b(?=[.!?]?)
                    ...
                    SentencesRow(
                      englishText:
                          """The gutter press thrives on celebrity gossip and fabricated scandals.""",
                      kurdishText:
                          """میدیا بازاڕییەکان زیاتر لەسەر قسەوقسەڵۆکی کەسانی بەناوبانگ و ئابڕووچوونی درووستکراو بەڕێوە دەچن.""",
