...
// With short examples define "foster", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """I'm trying to foster an interest in classical music in my children.""",
                      kurdishText:
                          """ھەوڵ دەدەم حەزی میوزیکی کلاسیک لای منداڵەکانم گەشە پێ بدەم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """نەمان توانی منداڵ ھەڵبگرینەوە، بۆیان بڕیارمان دا چاودێری کردن بکەین.""",
...
// 188888880002200
const String _videoIdend = 'TKoCWh2yneM';
const double _startSecondsend = 336;
const String _videoIdone = 'vn1_vUghWzA';
const double _startSecondsone = 95;
const String _videoIdtwo = 'yH2FPSupO6c';
const double _startSecondstwo = 86;
const String _videoIdthree = 'i4FkQMDTqYc';
const double _startSecondsthree = 505;
const String _videoIdfour = 'FUHkTs-Ipfg';
const double _startSecondsfour = 1045;
const String _videoIdfive = 'Sbp_EeBk-As';
