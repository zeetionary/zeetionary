...
class EnglishEntrykg extends StatefulWidget {
  const EnglishEntrykg({super.key});

  @override
  State<EnglishEntrykg> createState() => _EnglishEntrykgState();
}

class _EnglishEntrykgState extends State<EnglishEntrykg> {
  @override
  void initState() {
    super.initState();
...
کوردی: 
"""),
// With short examples define "kg", please follow LX instructions
