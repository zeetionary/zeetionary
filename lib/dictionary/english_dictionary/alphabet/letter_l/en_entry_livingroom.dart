...
class EnglishEntrylivingroom extends StatefulWidget {
  const EnglishEntrylivingroom({super.key});

  @override
  State<EnglishEntrylivingroom> createState() => _EnglishEntrylivingroomState();
}

class _EnglishEntrylivingroomState extends State<EnglishEntrylivingroom> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""living room""");
  }
