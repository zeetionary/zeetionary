...
class EnglishEntryfatherchristmas extends StatefulWidget {
  const EnglishEntryfatherchristmas({super.key});

  @override
  State<EnglishEntryfatherchristmas> createState() =>
      _EnglishEntryfatherchristmasState();
}

class _EnglishEntryfatherchristmasState
    extends State<EnglishEntryfatherchristmas> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""Father Christmas""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: Father Christmas",
                      britshText: """IpaUK: /ˌfɑːðə ˈkrɪsməs/""",
                      americanText: """IpaUS: /ˌfɑːðər ˈkrɪsməs/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "Father Christmas";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Children wrote letters to Father Christmas.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) پیاوێکی خەیاڵی بە جلی سوور و ڕیشی سپی درێژ. دایبابان بە منداڵانی بچووک دەڵێن کە لە کریسمسدا دیارییان بۆ دەهێنێت"""),
          SentencesRow(
            englishText: """Children wrote letters to Father Christmas.""",
            kurdishText: """منداڵان نامەیان بۆ بابا نوئێل نووسی.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: Father Christmas (Derived forms: Father Christmases)
Usage: Brit (N. Amer: Santa Claus)
1. The legendary patron saint of children; an imaginary being who is thought to bring presents to children at Christmas (= Santa Claus, Santa, Kriss Kringle [US], Saint Nicholas, Saint Nick, St. Nick)
""",
  );
...
const String _videoIdend = 'https://youtu.be/2svi_xw_Q7I?t=';
const double _startSecondsend = 000000000000000000000000000801;
const String _videoIdone = 'https://youtu.be/X2bJeRcyhlo?t=';
const double _startSecondsone = 00000000000000000000000000097;
const String _videoIdtwo = 'https://youtu.be/Fiw9CskKnTA?t=';
const double _startSecondstwo = 000000000000000000000000000842;
const String _videoIdthree = 'https://youtu.be/SJXFcEYjZEw?t=';
const double _startSecondsthree = 000000000000000000000000000604;
const String _videoIdfour = 'https://youtu.be/E-Hu3jsFw_I?t=';
const double _startSecondsfour = 00000000000000000000000000081;
const String _videoIdfive = 'https://youtu.be/j210gCAUdXQ?t=';
const double _startSecondsfive = 000000000000000000000000000237;
