...
// blank divider
  ...
  Future<void> speakbleats1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The lamb gave a faint bleat.");
  }
  ...
  Future<void> speakbleats3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("A goat was bleating afar.");
  }
  ...
  Future<void> speakbleats4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbleats44");
  }
  ...
  Future<void> speakbleats5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbleats55");
  }
  ...
  Future<void> speakbleats6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbleats66");
  }
  ...
  Future<void> speakbleats7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbleats77");
  }
...
"""),
                          ...
                          SentencesRow(
                            englishText: "The lamb gave a faint bleat.",
                            kurdishText: "بەرخەکە بەنزمی باعاندی.",
                            onPressedBritish: () => speakbleats1("en-GB"),
                            onPressedAmerican: () => speakbleats1("en-US"),
                          ),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: "٢. (کردار) باعاندن"),
                          SentencesRow(
                            englishText: "A goat was bleating afar.",
                            kurdishText: "بزنێک لە دوورەوە دەیباعاند.",
                            onPressedBritish: () => speakbleats3("en-GB"),
                            onPressedAmerican: () => speakbleats3("en-US"),
                          ),
                          const DividerDefinition(),
                          const DefinitionKurdish(
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbleats2("en-GB"),
                            onPressedAmerican: () => speakbleats2("en-US"),
                          ),
                          // const DividerDefinition(),
                        ],
                      ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'v5uon3iMlsk';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'rXo8mmVTXGQ';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'z5VOzFbD_6Q';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'ek-NqxUW0V8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'XDYf4-fp5lQ';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'HFT7f7Uh0fI';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'EWJjiEACHWA';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'hcBkY74BCfc';
