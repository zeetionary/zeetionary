...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'nMIifkRSs0I';
    const double startSecondsend = 33;
    const String videoIdone = '2O7RV-4zYRs';
    const double startSecondsone = 10;
    const String videoIdtwo = 'Cnn9CfsYJqc';
    const double startSecondstwo = 12;
    const String videoIdthree = 'jrfn75QuOFg';
    const double startSecondsthree = 0;
    const String videoIdfour = 'SeeNyOAcviI';
    const double startSecondsfour = 0;
    const String videoIdfive = 'MXWhlkreKq8';
