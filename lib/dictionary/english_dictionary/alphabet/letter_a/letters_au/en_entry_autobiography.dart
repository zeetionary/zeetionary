...
// Define the word "autobiography" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace autobiography - replace EnglishEntryautobiography

// replace speakAutobiography - /ˌɔːtəbaɪˈɒɡrəfi/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryautobiography extends StatelessWidget {
  // blank divider
  EnglishEntryautobiography({super.key});
  // blank divider
  ...
  Future<void> speakautobiography(String languageCode) async {
    ...
    await flutterTts.speak("autobiography");
  }
  ...
  Future<void> speakautobiography901(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("In his autobiography, he recalls the poverty he grew up in.");
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "autobiography"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final double _startSeconds = 2545;
