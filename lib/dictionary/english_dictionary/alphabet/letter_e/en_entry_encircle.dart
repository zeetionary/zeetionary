...
class EnglishEntryencircle extends StatefulWidget {
  const EnglishEntryencircle({super.key});

  @override
  State<EnglishEntryencircle> createState() => _EnglishEntryencircleState();
}

class _EnglishEntryencircleState extends State<EnglishEntryencircle> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("encircle");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "encircle",
                      // alsoEnglishWord: "also: encircle",
                      britshText: "IpaUK: /ɪnˈsɜːkl/",
                      americanText: "IpaUS: /ɪnˈsɜːrkl/",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Jack's arms encircled her waist.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The house is encircled by a high fence.");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("Villaverde is one of the districts that encircle Madrid.");
  }
...
کوردی: دەورەدان، دەورە گرتن، گەمارۆ دان
"""),
          const DefinitionKurdish(text: """١. (کردار) دەوردان"""),
          SentencesRow(
            englishText: """Jack's arms encircled her waist.""",
            kurdishText: """باڵی جاک دەوری کەمەری دابوو.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerSentences(),
          SentencesRow(
            englishText: """The house is encircled by a high fence.""",
            kurdishText: """خانووەکە بە پەرژینێکی بەرز دەوردراوە.""",
          ...
          SentencesRow(
            englishText:
                """Villaverde is one of the districts that encircle Madrid.""",
            kurdishText:
                """ڤیلاردێ یەکێکە لەو گەڕەکانەی کە دەوری مەدریدی داوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: encircle (Derived forms: encircled, encircles, encircling)
1. Form or draw a circle around (= circle)
"encircle the errors";
 
2. Bind with something round or circular (= gird, girt)
""",
  );
