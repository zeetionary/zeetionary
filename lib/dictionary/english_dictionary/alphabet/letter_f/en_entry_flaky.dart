...
class EnglishEntryflaky extends StatefulWidget {
  const EnglishEntryflaky({super.key});

  @override
  State<EnglishEntryflaky> createState() => _EnglishEntryflakyState();
}

class _EnglishEntryflakyState extends State<EnglishEntryflaky> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flaky (Derived forms: flakier, flakiest)
1. Made of or easily forming flakes (= flakey)
 
2. Made of or resembling flakes (= flakey)
"flaky soap";
 
3. [informal] Not worthy of reliance or trust (= unreliable, undependable, flakey [informal])
 
4. [informal] Conspicuously or grossly unconventional or unusual (= bizarre, eccentric, freakish, freaky [informal], flakey [informal], gonzo [N. Amer, informal], off-the-wall [informal], outlandish, outré)
""",
  );

  final String keyword = "flaky";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Winter weather often causes dry flaky skin.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He plays a flaky tourist visiting Europe.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I found the software a bit flaky.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flaky""",
                      // alsoEnglishWord: "also: flaky",
                      britshText: """IpaUK: /ˈfleɪki/""",
                      americanText: """IpaUS: /ˈfleɪki/""",
...
// With short examples define "flaky", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) کە بۆ بەشی بچووک دەشکێت یان لێ دەبێتەوە"""),
                    SentencesRow(
                      englishText:
                          """Winter weather often causes dry flaky skin.""",
                      kurdishText: """کەشی زستان زۆرجار دەکرێت ببێتە هۆکاری پێستی توێژاڵاوی وشک.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵناو) کە بە شێوەیەکی نامۆ و سەیر ڕەفتار دەکات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He plays a flaky tourist visiting Europe.""",
                      kurdishText: """ڕۆڵی گەشتیارێکی گەلحۆ دەبینێت کە سەردانی ئەورووپا دەکات.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ھاوەڵناو) کە باش کار ناکات یان زۆرجار لە کار دەوەستێت"""),
                    const DividerSentences(),
                    SentencesRow(
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/h4CyhQqAPpk?t=';
const double _startSecondsend = 000000000000000000000000000785;
const String _videoIdone = 'https://youtu.be/n4bucphC9r4?t=';
const double _startSecondsone = 000000000000000000000000000448;
const String _videoIdtwo = 'https://youtu.be/1p8r-2ffK_c?t=';
const double _startSecondstwo = 000000000000000000000000000134;
const String _videoIdthree = 'https://youtu.be/0ST4_hmop9Y?t=';
const double _startSecondsthree = 000000000000000000000000000542;
const String _videoIdfour = 'https://youtu.be/ImoP-Apzrsg?t=';
const double _startSecondsfour = 000000000000000000000000000277;
const String _videoIdfive = 'https://youtu.be/PcUnoFCxmsw?t=';
const double _startSecondsfive = 000000000000000000000000000370;
