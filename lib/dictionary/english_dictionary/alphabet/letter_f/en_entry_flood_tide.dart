...
class EnglishEntryfloodtide extends StatefulWidget {
  const EnglishEntryfloodtide({super.key});

  @override
  State<EnglishEntryfloodtide> createState() => _EnglishEntryfloodtideState();
}

class _EnglishEntryfloodtideState extends State<EnglishEntryfloodtide> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flood tide (Derived forms: flood tides)
1. The highest point of anything conceived of as growing, developing or unfolding (= climax)
"in the flood tide of his success";
 
2. The occurrence of incoming water (between a low tide and the following high tide) (= flood, rising tide)
"a tide in the affairs of men which, taken at the flood tide, leads on to fortune";
""",
  );

  final String keyword = "flood tide";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flood tide""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The boats returned to the harbor during the flood tide.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flood tide""",
                      // alsoEnglishWord: "also: flood tide",
                      britshText: """IpaUK: /ˈflʌd taɪd/""",
                      americanText: """IpaUS: /ˈflʌd taɪd/""",
...
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) بەرزبوونەوەی ئاستی ئاوی دەریا"""),
                    SentencesRow(
                      englishText:
                          """The boats returned to the harbor during the flood tide.""",
                      kurdishText:
                          """بەلەمەکان دەگەڕانەوە بەدەرەکە کە هەڵکشانی ئاو ڕووی دەدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/gW-Up4Envow?t=';
const double _startSecondsend = 000000000000000000000000000765;
const String _videoIdone = 'https://youtu.be/jYjhaHf7pBo?t=';
const double _startSecondsone = 0000000000000000000000000001753;
const String _videoIdtwo = 'https://youtu.be/NGXBJIMqU7g?t=';
const double _startSecondstwo = 0000000000000000000000000003235;
const String _videoIdthree = 'https://youtu.be/Pvi8hKVHp2w?t=';
const double _startSecondsthree = 000000000000000000000000000441;
const String _videoIdfour = 'https://youtu.be/KLksNpfgAhY?t=';
const double _startSecondsfour = 0000000000000000000000000002278;
const String _videoIdfive = 'https://youtu.be/H_-UHVqd6yk?t=';
