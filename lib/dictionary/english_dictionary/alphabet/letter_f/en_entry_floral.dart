...
class EnglishEntryfloral extends StatefulWidget {
  const EnglishEntryfloral({super.key});

  @override
  State<EnglishEntryfloral> createState() => _EnglishEntryfloralState();
}

class _EnglishEntryfloralState extends State<EnglishEntryfloral> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: floral
1. Resembling or made of or suggestive of flowers (= flowered)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She prefers clothing with small floral patterns.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Floral tributes were sent to the church.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """floral""",
                      // alsoEnglishWord: "also: floral",
                      britshText: """IpaUK: /ˈflɔːrəl/""",
                      americanText: """IpaUS: /ˈflɔːrəl/""",
...
// With short examples define "floral", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """She prefers clothing with small floral patterns.""",
                      kurdishText:
                          """ئەو جلوبەرگی بە نەخشی گوڵداری بچووک پێ باشترە..""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تاجەگوڵینە بۆ کڵێسا نێردران..""",
...
const double _startSecondsend = 0000000000000000000000000001315;
const String _videoIdone = 'https://youtu.be/s3B-qp3U5G0?t=';
const double _startSecondsone = 000000000000000000000000000529;
const String _videoIdtwo = 'https://youtu.be/eNChF-u-BQg?t=';
const double _startSecondstwo = 000000000000000000000000000689;
const String _videoIdthree = 'https://youtu.be/ZFRnQ-Ti6Is?t=';
const double _startSecondsthree = 000000000000000000000000000177;
const String _videoIdfour = 'https://youtu.be/sYoDERqkPo8?t=';
const double _startSecondsfour = 000000000000000000000000000560;
const String _videoIdfive = 'https://youtu.be/Ky1c6d7v0pQ?t=';
const double _startSecondsfive = 000000000000000000000000000635;
