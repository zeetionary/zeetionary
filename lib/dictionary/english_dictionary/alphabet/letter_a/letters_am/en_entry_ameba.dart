...
class EnglishEntryameba extends StatelessWidget {
  ...
  Future<void> speakameba4688(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He is studying the ecology of ameba.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "ameba"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈmiːbə/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'pXiYhj-zMOw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'l5t-uDLTr_Y';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '39ocsrVHvoQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'wD68-d34bb4';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'ztnpOHJjWig';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'wE0gybNVwzc';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'Z6zRRuBpPnw';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'CX2OsTryGFI';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'vycyO4Gvyg0';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'NTz_cdrG4Dk';
