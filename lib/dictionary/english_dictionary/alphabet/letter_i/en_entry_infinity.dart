...
class EnglishEntryinfinity extends StatefulWidget {
  const EnglishEntryinfinity({super.key});

  @override
  State<EnglishEntryinfinity> createState() => _EnglishEntryinfinityState();
}

class _EnglishEntryinfinityState extends State<EnglishEntryinfinity> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: infinity (Derived forms: infinities)
1. Time without end (- eternity)
""",
  );

  final String keyword = "infinity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infinity""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Scientists study the infinity of the universe to understand its origins.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Theoretically, a line can extend into infinity.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The landscape seemed to stretch into infinity.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The number tends towards infinity.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/eNChF-u-BQg?t=';
    const double startSecondsone = 000000000000000000000000000300;
    const String videoIdtwo = 'https://youtu.be/hBmj4rs1KrI?t=';
    ...
    const String videoIdfour = 'https://youtu.be/WUjVPIEtJd0?t=';
    const double startSecondsfour = 000000000000000000000000000789;
    const String videoIdfive = 'https://youtu.be/FHJ3CMWnVxY?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """infinity""",
                      // alsoEnglishWord: "also: infinity",
                      britshText: """IpaUK: /ɪnˈfɪnəti/""",
                      americanText: """IpaUS: /ɪnˈfɪnəti/""",
...
کوردی: دیاری‌نەکراوی، بێ‌کۆتایێتی، بێ‌ڕادەیی، بێ‌سنوورێتی، بێ‌بنی، لە ڕادەبەدەری، بێ‌ئەندازەیی، بێ‌ئەژماری
"""),
// With short examples define "infinity", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە هیچ کۆتایی یان سنوورێک نەبێت"""),
                    SentencesRow(
                      englishText:
                          """Scientists study the infinity of the universe to understand its origins.""",
                      kurdishText:
                          """زاناکان دەکۆڵنەوە لە بێ‌سنووری گەردوون بۆ تێگەشتن لە بنچینەکانی.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) خاڵێکی زۆر دوور کە هەرگیز ناتوانیت پێی بگەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Theoretically, a line can extend into infinity.""",
                      kurdishText:
                          """لە ڕووی تیۆرییەوە، هێڵێک دەکرێتە بە بێ‌سنوور درێژ ببێتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دیمەنەکە وەها دیاربوو بە بێ‌ئەندازەیی درێژ ببێتەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) ژمارەیەک کە گەورەترە لە هەموو ژمارەیەکی دیکە و بە سمبوولی ∞ دەنووسرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The number tends towards infinity.""",
                      kurdishText: """ژمارەکە بەرەو بێ‌سنوور دەچێت.""",
