...
class EnglishEntryentirety extends StatefulWidget {
  const EnglishEntryentirety({super.key});

  @override
  State<EnglishEntryentirety> createState() => _EnglishEntryentiretyState();
}

class _EnglishEntryentiretyState extends State<EnglishEntryentirety> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""entirety""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """entirety""",
                      // alsoEnglishWord: "also: entirety",
                      britshText: """IpaUK: /ɪnˈtaɪərəti/""",
                      americanText: """IpaUS: /ɪnˈtaɪərəti/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The entirety of the budget was used.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The poem is too long to quote in its entirety.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I've never actually read the book in its entirety.""");
  }
...
کوردی: تەواوەتی، گشت، سەرجەم، تێکڕای
"""),
          const DefinitionKurdish(text: """١. (ناو) پێنناسە"""),
          SentencesRow(
            englishText: """The entirety of the budget was used.""",
            kurdishText: """تەواوی بودجەکە بەکارهات.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هۆنراوەکە زۆر درێژە کە هەمووی بنووسرێت.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هەرگیز تەواوی کتێبەکەم نەخوێندووتەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: entirety (Derived forms: entireties)
1. The state of being total and complete (= entireness, integrality, totality)
...
const String _videoIdtwo = 'https://youtu.be/kElsSj8hky4?t=';
const double _startSecondstwo = 383;
const String _videoIdthree = 'https://youtu.be/Xzv84ZdtlE0?t=';
const double _startSecondsthree = 1347;
const String _videoIdfour = 'https://youtu.be/bii-ci1Zc_c?t=';
const double _startSecondsfour = 78;
const String _videoIdfive = 'https://youtu.be/QcUey-DVYjk?t=';
const double _startSecondsfive = 20;
const String _videoIdsix = 'https://youtu.be/HQ7VKfg1654?t=';
const double _startSecondssix = 7;
