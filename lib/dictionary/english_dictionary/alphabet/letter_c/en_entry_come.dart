...
class EnglishEntrycome extends StatelessWidget {
  ...
  Future<void> speakcomes1(String languageCode) async {
    ...
    await flutterTts.speak(
        "// speakcomes111111111111111111111111111111111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcomes2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcomes200"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcomes3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcomes300"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcomes4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcomes400"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcomes5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcomes500"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcomes6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcomes600"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcomes7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcomes700"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcomes8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcomes800"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcomes9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcomes900"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcomes10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcomes1000"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcomes11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcomes1100"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcomes12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcomes1200"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcomes13(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcomes1300"); // DOPSUM: CHANGE TEXT
  }
                                ...
                                child: Column(
                                  children: [
                                    ExampleSentenceEnglish(
                                        text:
                                            "// speakcomes111111111111111111111111111111111"),
...
speakcome EnglishEntrycome
WORD_WEB come haʊʊʊʊʊʊʊ4
""",
  );
