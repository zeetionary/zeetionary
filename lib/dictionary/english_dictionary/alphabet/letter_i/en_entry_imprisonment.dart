...
class EnglishEntryimprisonment extends StatefulWidget {
  const EnglishEntryimprisonment({super.key});

  @override
  State<EnglishEntryimprisonment> createState() =>
      _EnglishEntryimprisonmentState();
}

class _EnglishEntryimprisonmentState extends State<EnglishEntryimprisonment> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: imprisonment (Derived forms: imprisonments)
1. (law) putting someone in prison or in jail as lawful punishment
 
2. The state of being imprisoned (- captivity, incarceration, immurement)
"the imprisonment of captured soldiers";
 
3. The act of confining someone in a prison (or as if in a prison) (- internment)
""",
  );

  final String keyword = "imprisonment";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""imprisonment""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000002547;
    const String videoIdone = 'https://youtu.be/tKZ2ILu_EMc?t=';
    const double startSecondsone = 0000000000000000000000000002044;
    const String videoIdtwo = 'https://youtu.be/ySOKrCusEjw?t=';
    const double startSecondstwo = 0000000000000000000000000001915;
    const String videoIdthree = 'https://youtu.be/wJa5Ch0O4BI?t=';
    const double startSecondsthree = 0000000000000000000000000004319;
    const String videoIdfour = 'https://youtu.be/9uH8-Gj8XrM?t=';
    const double startSecondsfour = 0000000000000000000000000001302;
    const String videoIdfive = 'https://youtu.be/3u2FauOIPh8?t=';
    const double startSecondsfive = 0000000000000000000000000001394;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """imprisonment""",
                      // alsoEnglishWord: "also: imprisonment",
                      britshText: """IpaUK: /ɪmˈprɪznmənt/""",
                      americanText: """IpaUS: /ɪmˈprɪznmənt/""",
...
کوردی: 
"""),
// With short examples define "imprisonment", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کەسێک بخرێتە بەندیخانە؛ ئەوەی کەسێک لە بەندیخانە بێت"""),
                    SentencesRow(
                      englishText:
                          """The death sentence was commuted to life imprisonment.""",
                      kurdishText: "سزا مەرگەکەی گۆڕدرا بۆ زیندانی ھەتاھەتایی.",
