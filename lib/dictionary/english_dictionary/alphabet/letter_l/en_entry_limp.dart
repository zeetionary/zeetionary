...
class EnglishEntrylimp extends StatefulWidget {
  const EnglishEntrylimp({super.key});

  @override
  State<EnglishEntrylimp> createState() => _EnglishEntrylimpState();
}

class _EnglishEntrylimpState extends State<EnglishEntrylimp> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: limp (Derived forms: limping, limped, limps)
1. Walk impeded by some physical limitation or injury (- gimp [N. Amer, informal], hobble, hitch [N. Amer, informal])
"The old woman limps down to the store every day";
 
2. Proceed slowly or with difficulty
"the boat limped into the harbour"

- Adjective: limp (Derived forms: limper, limpest)
1. Without energy or will (- wilted)
...
- Noun: limp (Derived forms: limps)
1. The uneven manner of walking that results from an injured leg (- hitch, hobble)
""",
  );

  final String keyword = "limp";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His hand went limp and the knife clattered to the ground.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She felt limp and exhausted.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hat had become limp and shapeless.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She had twisted her ankle and was limping.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""By the time we got back home she was limping badly.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The plane limped back to the airport.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The accident had left him with a slight limp.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/f7QWMUCMYOE?t=837';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/VpnandCVKXU?t=54';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/1Gxrwh4zGPg?t=1194';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/5wcPcb_R0Ek?t=26';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/_-cGBYAt2Fw?t=6';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/Ir3eJ1t13fk?t=1932';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """limp""",
                      // alsoEnglishWord: "also: limp",
                      britshText: """IpaUK: /lɪmp/""",
                      americanText: """IpaUS: /lɪmp/""",
...
کوردی: بێ‌هێز، لاواز، بێ‌تین، تەپ، تەپلۆس، سست،	(گیا) ژاکاو، چرچ، سیس،	شۆڕەوەبوو، شل(و شەوێق)، شلەوەبوو، نەرم، چەمیو، داکەوتوو
"""),
// With short examples define "limp", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) بێ‌هێز و لاواز"""),
                    SentencesRow(
                      englishText: """His hand went limp and the knife clattered to the ground.""",
                      kurdishText: """دەستی لاواز بوو و چەقۆیەکە کەوتە سەر زەوی.""",
                    ...
                    SentencesRow(
                      englishText: """She felt limp and exhausted.""",
                      kurdishText: """هەستی بە لاوازی و شەکەتی دەکرد.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) کە جیڕ یان بەهێز نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The hat had become limp and shapeless.""",
                      kurdishText: """کڵاوەکە نەرم و شێواو بووبوو.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) ڕێکردن بە هێواشی و سەختی بەهۆی ئەوەی لاقێکت بریندارە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She had twisted her ankle and was limping.""",
                      kurdishText: """پاژنەپێی شکابوو و دەشەلی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """By the time we got back home she was limping badly.""",
                      kurdishText: """تاوەکو گەشتینەوە ماڵەوە بەخراپی دەشەلی.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) جووڵان بە هێواشی و سەختی بەهۆی زیانەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The plane limped back to the airport.""",
                      kurdishText: """فڕۆکەکە بە نالەباری گەڕایەوە فڕۆکەخانەکە.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (ناو) شەلین"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The accident had left him with a slight limp.""",
                      kurdishText: """ڕووداوەکە کەمێک شەلی کردبوو.""",
