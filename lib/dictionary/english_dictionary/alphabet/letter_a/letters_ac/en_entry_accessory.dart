...
// replace these: EnglishEntryaccessory - speakAccessory - accessory - /əkˈsesəri/

enum TtsState { playing }

class EnglishEntryaccessory extends StatelessWidget {
  EnglishEntryaccessory({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAccessory(String languageCode) async {
    // DOPSUM: CHANGE speakAccessory
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "accessory"), // DOPSUM: CHANGE WORD ENTRY
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əkˈsesəri/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakAccessory("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /əkˈsesəri/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                            CustomIconButtonAmerican(
                              onPressed: () => speakAccessory("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'sW_1fB9AwE0';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '5hpuoMilm_4';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'SVgXEUQE1A4';
