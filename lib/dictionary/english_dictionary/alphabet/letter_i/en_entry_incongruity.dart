...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'Udk8YHOy0EU';
    const double startSecondsend = 46;
    const String videoIdone = 'BOdca_kJimE';
    const double startSecondsone = 272;
    const String videoIdtwo = '-9kAlQKUGvA';
    const double startSecondstwo = 213;
    const String videoIdthree = 'SXIah083UBE';
    const double startSecondsthree = 1920;
    const String videoIdfour = '0z5SsDEWWIU';
    const double startSecondsfour = 420;
    const String videoIdfive = 'dipZeq_P6Ew';
