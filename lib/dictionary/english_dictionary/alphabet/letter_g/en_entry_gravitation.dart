...
class EnglishEntrygravitation extends StatefulWidget {
  const EnglishEntrygravitation({super.key});

  @override
  State<EnglishEntrygravitation> createState() =>
      _EnglishEntrygravitationState();
}

class _EnglishEntrygravitationState extends State<EnglishEntrygravitation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gravitation (Derived forms: gravitations)
1. (physics) the force of attraction between all masses in the universe; especially the attraction of the earth's mass for bodies near its surface (- gravity, gravitational attraction, gravitational force)
"the gravitation between two bodies is proportional to the product of their masses and inversely proportional to the square of the distance between them"; "gravitation cannot be held responsible for people falling in love";
...
""",
  ...
  final String keyword = "gravitation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gravitation""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Particles are attracted to each other by gravitation.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gravitation""",
                      // alsoEnglishWord: "also: gravitation",
                      britshText: """IpaUK: /ˌɡrævɪˈteɪʃn/""",
                      americanText: """IpaUS: /ˌɡrævɪˈteɪʃn/""",
...
// With short examples define "gravitation", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هێزێک کە وا دەکات تەنەکان بۆ یەکتر بچن"""),
                    SentencesRow(
                      englishText:
                          """Particles are attracted to each other by gravitation.""",
                      kurdishText:
                          """گەردیلەکان بە هۆی هێزی ڕاکێشانەوە بەرەو یەکتر کێش دەکرێن..""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/QcUey-DVYjk?t=';
const double _startSecondsend = 0000000000000000000000000001311;
const String _videoIdone = 'https://youtu.be/wJa5Ch0O4BI?t=';
const double _startSecondsone = 0000000000000000000000000003939;
const String _videoIdtwo = 'https://youtu.be/p9e8qNNe3L0?t=';
const double _startSecondstwo = 000000000000000000000000000580;
const String _videoIdthree = 'https://youtu.be/wsJh_dXpiyk?t=';
const double _startSecondsthree = 000000000000000000000000000959;
const String _videoIdfour = 'https://youtu.be/0sTBZ2G4vow?t=';
const double _startSecondsfour = 000000000000000000000000000116;
const String _videoIdfive = 'https://youtu.be/z4odQd8q3xY?t=';
