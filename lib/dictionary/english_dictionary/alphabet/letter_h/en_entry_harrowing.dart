...
class EnglishEntryharrowing extends StatefulWidget {
  const EnglishEntryharrowing({super.key});

  @override
  State<EnglishEntryharrowing> createState() => _EnglishEntryharrowingState();
}

class _EnglishEntryharrowingState extends State<EnglishEntryharrowing> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: harrowing
1. Extremely painful (- agonizing, agonising [Brit], excruciating, torturing, torturous, torturesome)
"Stephanie reveals the near-tragic personal story that compelled her into this harrowing career";
""",
  );

  final String keyword = "harrowing";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""harrowing""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The book makes harrowing reading.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The whole thing was very harrowing for her.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harrowing""",
                      // alsoEnglishWord: "also: harrowing",
                      britshText: """IpaUK: /ˈhærəʊɪŋ/""",
                      americanText: """IpaUS: /ˈhærəʊɪŋ/""",
...
const String _videoIdone = 'https://youtu.be/uN84HhcdIws?t=';
const double _startSecondsone = 0000000000000000000000000001224;
const String _videoIdtwo = 'https://youtu.be/IgF3OX8nT0w?t=';
const double _startSecondstwo = 000000000000000000000000000761;
const String _videoIdthree = 'https://youtu.be/8KmmZBBJGkE?t=';
const double _startSecondsthree = 000000000000000000000000000842;
const String _videoIdfour = 'https://youtu.be/YwOMc-4OEWg?t=';
const double _startSecondsfour = 000000000000000000000000000570;
const String _videoIdfive = 'https://youtu.be/cTozcxvFDtM?t=';
const double _startSecondsfive = 000000000000000000000000000397;
