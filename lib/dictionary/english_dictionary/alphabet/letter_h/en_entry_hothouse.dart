...
class EnglishEntryhothouse extends StatefulWidget {
  const EnglishEntryhothouse({super.key});

  @override
  State<EnglishEntryhothouse> createState() => _EnglishEntryhothouseState();
}

class _EnglishEntryhothouseState extends State<EnglishEntryhothouse> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hothouse (Derived forms: hothouses)
1. A greenhouse in which plants are arranged in a pleasing manner (- conservatory, indoor garden)
 
2. Somewhere that provides an environment for rapid development
"a hothouse for innovative ideas"; "the continent has become a hothouse for the emergence of extremist groups"

- Verb: hothouse (Derived forms: hothouses, hothoused, hothousing)
1. Provide (a child) with high-level teaching at an early age
"I was hothoused as a child and reading very well by the age of 3"
""",
  );

  final String keyword = "hothouse";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hothouse""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/HbveGiotp_M?t=';
    const double startSecondsone = 00000000000000000000000000019;
    const String videoIdtwo = 'https://youtu.be/TEaT0z5kUo4?t=';
    const double startSecondstwo = 000000000000000000000000000449;
    const String videoIdthree = 'https://youtu.be/bfFSBLhrHe0?t=';
    const double startSecondsthree = 000000000000000000000000000101;
    const String videoIdfour = 'https://youtu.be/EnNRI_3c_YE?t=';
    const double startSecondsfour = 000000000000000000000000000523;
    const String videoIdfive = 'https://youtu.be/QbEd_XL2uvc?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hothouse""",
                      // alsoEnglishWord: "also: hothouse",
                      britshText: """IpaUK: /ˈhɒthaʊs/""",
                      americanText: """IpaUS: /ˈhɑːthaʊs/""",
