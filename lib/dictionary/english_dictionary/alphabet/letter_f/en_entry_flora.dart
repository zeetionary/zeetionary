...
class EnglishEntryflora extends StatefulWidget {
  const EnglishEntryflora({super.key});

  @override
  State<EnglishEntryflora> createState() => _EnglishEntryfloraState();
}

class _EnglishEntryfloraState extends State<EnglishEntryflora> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flora (Derived forms: floras, florae)
1. All the plant life in a particular region or period (= vegetation, botany)
"the flora of southern California";
 
2. (botany) a living organism lacking the power of locomotion (= plant, plant life)
""",
  );

  final String keyword = "flora";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flora""",
                      // alsoEnglishWord: "also: flora",
                      britshText: """IpaUK: /ˈflɔːrə/""",
                      americanText: """IpaUS: /ˈflɔːrə/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕووەکی ناوچەیەکی دیاریکراو، جۆرە ژینگەیەک، یان کاتێکی دیاریکراو"""),
                    SentencesRow(
                      englishText:
                          """The flora of the rainforest is incredibly diverse.""",
                      kurdishText:
                          """ڕووەکی دارستانە باراناوییەکە تەواو هەمەچەشنە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/CsTmgX32Uk8?t=';
const double _startSecondsend = 000000000000000000000000000240;
const String _videoIdone = 'https://youtu.be/42G_XzaPcPo?t=';
const double _startSecondsone = 000000000000000000000000000362;
const String _videoIdtwo = 'https://youtu.be/KIxg2zxg1CQ?t=';
const double _startSecondstwo = 00000000000000000000000000058;
const String _videoIdthree = 'https://youtu.be/HdwzJLTLFqc?t=';
const double _startSecondsthree = 00000000000000000000000000098;
const String _videoIdfour = 'https://youtu.be/KHF8mB_8LUM?t=';
const double _startSecondsfour = 00000000000000000000000000060;
const String _videoIdfive = 'https://youtu.be/N5r9CJ_MJBc?t=';
