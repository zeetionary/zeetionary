...
class EnglishEntryhalfway extends StatefulWidget {
  const EnglishEntryhalfway({super.key});

  @override
  State<EnglishEntryhalfway> createState() => _EnglishEntryhalfwayState();
}

class _EnglishEntryhalfwayState extends State<EnglishEntryhalfway> {
  @override
  void initState() {
    super.initState();
...
- Adjective: halfway
1. Equally distant from the extremes (- center [US], middle, midway, centre [Brit, Cdn])
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""halfway""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I got the ball on the halfway line.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It's about halfway between London and Bristol.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He left halfway through the ceremony.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Any halfway decent map will give you that information.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """halfway""",
                      // alsoEnglishWord: "also: halfway",
                      britshText: """IpaUK: /ˌhɑːfˈweɪ/""",
                      americanText: """IpaUS: /ˌhæfˈweɪ/""",
...
// With short examples define "halfway", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """New York City is halfway between Boston and Washington, DC.""",
                      kurdishText:
                          """نیویۆرک لە نیوەی ڕێگای نێوان بۆستن و واشنتۆنە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە خاڵی نێوان لیڤەرپوول و بریستۆڵە.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He left halfway through the ceremony.""",
                      kurdishText: """لە نیوەی بۆنەکەدا چوو.""",
