...
class EnglishEntrygerm extends StatefulWidget {
  const EnglishEntrygerm({super.key});

  @override
  State<EnglishEntrygerm> createState() => _EnglishEntrygermState();
}

class _EnglishEntrygermState extends State<EnglishEntrygerm> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Disinfectant kills germs.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Dirty hands can be a breeding ground for germs.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Here was the germ of a brilliant idea.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The germ of the town was a single house near the river.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The germ is the embryo of the new plant.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """germ""",
                      // alsoEnglishWord: "also: germ",
                      britshText: """IpaUK: /dʒɜːm/""",
                      americanText: """IpaUS: /dʒɜːrm/""",
...
// With short examples define "germ", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەستی پیس دەکرێت ژینگەی لەبار بن بۆ میکرۆب.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سەرەتای شارۆچکەکە یەک خانوو بوو نزیک لە ڕووبارەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تۆوەکە چەکەرەی ڕووەکێکی تازەیە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/X3TAROotFfM?t=';
const double _startSecondsend = 000000000000000000000000000804;
const String _videoIdone = 'https://youtu.be/Ku-ForS6G3I?t=';
const double _startSecondsone = 00000000000000000000000000080;
const String _videoIdtwo = 'https://youtu.be/YkmlPaGui5k?t=';
const double _startSecondstwo = 000000000000000000000000000193;
const String _videoIdthree = 'https://youtu.be/W-ZuKp8P7gA?t=';
const double _startSecondsthree = 0000000000000000000000000003049;
const String _videoIdfour = 'https://youtu.be/AiFQRCx1uBI?t=';
const double _startSecondsfour = 000000000000000000000000000297;
const String _videoIdfive = 'https://youtu.be/UjQ6HSq3UIk?t=';
