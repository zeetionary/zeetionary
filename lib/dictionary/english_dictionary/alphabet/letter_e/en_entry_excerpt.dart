...
class EnglishEntryexcerpt extends StatefulWidget {
  const EnglishEntryexcerpt({super.key});

  @override
  State<EnglishEntryexcerpt> createState() => _EnglishEntryexcerptState();
}

class _EnglishEntryexcerptState extends State<EnglishEntryexcerpt> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""excerpt""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """excerpt""",
                      // alsoEnglishWord: "also: excerpt",
                      britshText: """IpaUK: /ekˈsɜːpt/""",
                      americanText: """IpaUS: /ekˈsɜːrpt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They only played a short excerpt.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Read the following excerpt from one of Milton’s poems.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The article included excerpts from various interviews.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The document was excerpted from an unidentified FBI file.""");
  }
...
// With short examples define "excerpt", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: بڕگە، پارچە، تیکە، کۆپلە، پارچەی هەڵبژاردە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کورتە نووسینێک، میوزیکێک، فیلمێک، هتد کە لە بەشە تەواوەکە وەرگیراوە"""),
          SentencesRow(
            englishText: """They only played a short excerpt.""",
            kurdishText: """تەنها پارچەیەکی کورتیان پیشان دا.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """ئەم پارچەی دواتر بخوێنەوە لە یەکێک لە هۆنراوەکانی میڵتۆن.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """وتارەکە پارچە نووسینی لە ژمارەیەک چاوپێکەوتنەوە تێدا بوو.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) وەرگرتنی کورتە نووسینێک، میوزیکێک، فیلمێک، هتد لە بەشە تەواوەکە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The document was excerpted from an unidentified FBI file.""",
            kurdishText:
                """بەڵگەنامەکە لە فایلێکی نەناسراوی ئێف‌بی‌ئای وەرگیرا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: excerpt (Derived forms: excerpts)
1. A passage selected from a larger work (= excerption, extract, selection)
"he presented excerpts from William James' philosophical writings";

- Verb: excerpt (Derived forms: excerpted, excerpting, excerpts)
1. Take out of a literary work in order to cite or copy (= extract, take out)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/3C9wZf88y4Q?t=';
const double _startSecondsend = 000000000000000000000000000000; // 549;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/UzIxYdWVbm0?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1052;
...
const double _startSecondsthree = 000000000000000000000000000; // 435;
...
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/4IaOeVgZ-wc?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 6204;
