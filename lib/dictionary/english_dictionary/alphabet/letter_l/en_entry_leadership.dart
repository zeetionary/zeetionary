...
class EnglishEntryleadership extends StatefulWidget {
  const EnglishEntryleadership({super.key});

  @override
  State<EnglishEntryleadership> createState() => _EnglishEntryleadershipState();
}

class _EnglishEntryleadershipState extends State<EnglishEntryleadership> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: leadership (Derived forms: leaderships)
1. The activity of leading (- leading)
"his leadership inspired the team";
 
2. The body of people who lead a group (- leaders)
...
""",
  ...
  final String keyword = "leadership";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""leadership""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Who will take over the leadership of the club?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The party thrived under his leadership.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Strong leadership is needed to captain the team.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Many in the party have criticized his lack of leadership.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They called on the United States to show greater leadership in the fight against international terrorism.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The party leadership is/are divided.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There have been disagreements within the leadership of the union.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/Ir3eJ1t13fk?t=1634';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/Xzv84ZdtlE0?t=4';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/VRJzvJ5XPQI?t=157';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/CD7UmmLhFR8?t=289';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/p3O6bKdPLbw?t=3288';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/QLq6GEiHqR8?t=2262';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """leadership""",
                      // alsoEnglishWord: "also: leadership",
                      britshText: """IpaUK: /ˈliːdəʃɪp/""",
                      americanText: """IpaUS: /ˈliːdərʃɪp/""",
...
کوردی: ڕێبەرایەتی، سەرۆکایەتی، پێشەوایی، پێشەوایەتی
"""),
// With short examples define "leadership", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ئەوەی کە سەرکردە بیت"""),
                    SentencesRow(
                      englishText: """Who will take over the leadership of the club?""",
                      kurdishText: """کێ سەرکردایەتی یانەکە دەگرێتە دەست؟""",
                    ...
                    SentencesRow(
                      englishText: """The party thrived under his leadership.""",
                      kurdishText: """پارتەکە لەژێر سەرکردایەتییدا بوژایەوە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ئەوەی کە ببیت بە سەرکردە یان ئەو خاسیەتانەی سەرکردی باش هەیەتی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Strong leadership is needed to captain the team.""",
                      kurdishText: """سەرکردایەتیی بەهێز پێویستە بۆ بوون بە کاپتنی تیمەکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Many in the party have criticized his lack of leadership.""",
                      kurdishText: """زۆر کەس لە پارتەکە ڕەخنەیان گرتووە لە کەمیی توانای ڕێبەرایەتیکردنی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They called on the United States to show greater leadership in the fight against international terrorism.""",
                      kurdishText: """داوایان لە ئەمریکا کرد کە پێشەنگی زیاتر پیشان بدات لە جەنگ دژ بە تیرۆریزمی نێودەوڵەتی.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) ژمارەیەک سەرکردەی دامەزراوەیەک، هتد ــی دیاریکراو"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The party leadership is/are divided.""",
                      kurdishText: """سەرکردایەتیی پارتەکە دابەش بووە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There have been disagreements within the leadership of the union.""",
                      kurdishText: """ڕێک‌نەکەوتوویی هەبووە لە سەرکردایەتیی سەندیکاکە.""",
