...
class EnglishEntryfoglamp extends StatefulWidget {
  const EnglishEntryfoglamp({super.key});

  @override
  State<EnglishEntryfoglamp> createState() => _EnglishEntryfoglampState();
}

class _EnglishEntryfoglampState extends State<EnglishEntryfoglamp> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foglamp (Derived forms: foglamps)
1. Headlight that provides strong beam for use in foggy weather
""",
  );

  final String keyword = "fog lamp";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fog lamp""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He was dazzled by fog lights on an oncoming vehicle.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I had my fog lamps on.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fog lamp""",
                      // alsoEnglishWord: "also: fog lamp",
                      britshText: """IpaUK: /ˈfɒɡ læmp/""",
                      americanText: """IpaUS: /ˈfɑːɡ læmp/""",
...
// With short examples define "fog lamp", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """He was dazzled by fog lights on an oncoming vehicle.""",
                      kurdishText:
                          """شەوارەی کردبوو بە مژبڕی پێڕۆیەکانی بەرامبەر.""",
                    ...
                    SentencesRow(
                      englishText: """I had my fog lamps on.""",
                      kurdishText: """مژبڕەکانم لە کاردا بوون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/c2J91UG6Fn8?t=';
const double _startSecondsend = 000000000000000000000000000282;
const String _videoIdone = 'https://youtu.be/4-ap2ntgXKE?t=';
const double _startSecondsone = 000000000000000000000000000260;
const String _videoIdtwo = 'https://youtu.be/p_P9J97ELlg?t=';
const double _startSecondstwo = 000000000000000000000000000123;
const String _videoIdthree = 'https://youtu.be/LcJLE1MEGac?t=';
const double _startSecondsthree = 000000000000000000000000000977;
const String _videoIdfour = 'https://youtu.be/8uKtpITZHKI?t=';
const double _startSecondsfour = 000000000000000000000000000384;
const String _videoIdfive = 'https://youtu.be/D1KKIUkOLSY?t=';
