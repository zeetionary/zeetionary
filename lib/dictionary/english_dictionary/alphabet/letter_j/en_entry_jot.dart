...
class EnglishEntryjot extends StatefulWidget {
  const EnglishEntryjot({super.key});

  @override
  State<EnglishEntryjot> createState() => _EnglishEntryjotState();
}

class _EnglishEntryjotState extends State<EnglishEntryjot> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryjot jot
WORD_WEB jot jot jot
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "jot";
...
کوردی: 
"""),
// With short examples define "jot", please follow LX instructions
