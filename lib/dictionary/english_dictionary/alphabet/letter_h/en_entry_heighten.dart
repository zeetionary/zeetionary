...
class EnglishEntryheighten extends StatefulWidget {
  const EnglishEntryheighten({super.key});

  @override
  State<EnglishEntryheighten> createState() => _EnglishEntryheightenState();
}

class _EnglishEntryheightenState extends State<EnglishEntryheighten> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: heighten (Derived forms: heightened, heightening, heightens)
1. Become more extreme (- rise)
"The tension heightened";
 
2. Make more extreme; raise in quantity, degree, or intensity
"heightened interest"
 
3. Add something extra to make more intense or better (- enhance, raise, increase)
"heighten the tension";
 
4. Increase the height of
"The athletes kept jumping over the steadily heightened bars"
 
5. Make (one's senses) more acute (- sharpen)
"This drug will heighten your vision";
 
6. Make more intense, stronger, or more marked (- intensify, compound, deepen)
"Pot smokers claim it heightens their awareness";
""",
  );

  final String keyword = "heighten";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heighten""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Tension has heightened after the recent bomb attack.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heighten""",
                      // alsoEnglishWord: "also: heighten",
                      britshText: """IpaUK: /ˈhaɪtn/""",
                      americanText: """IpaUS: /ˈhaɪtn/""",
...
کوردی: 
"""),
// With short examples define "heighten", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) بەرزبوون لە ڕێژەدا"""),
                    const AlsoEnglishckb(word: "ھەروەھا: intensify"),
                    SentencesRow(
                      englishText:
                          """Tension has heightened after the recent bomb attack.""",
                      kurdishText:
                          """ئاڵۆزی زیادی کردووە لە دوای هێرشە تازە بۆمبییەکە.""",
...
const double _startSecondsend = 0000000000000000000000000001395;
const String _videoIdone = 'https://youtu.be/576HwhU6PMM?t=';
const double _startSecondsone = 000000000000000000000000000348;
const String _videoIdtwo = 'https://youtu.be/O-6f5wQXSu8?t=';
const double _startSecondstwo = 000000000000000000000000000187;
const String _videoIdthree = 'https://youtu.be/hkO8qXCFYWA?t=';
const double _startSecondsthree = 0000000000000000000000000001162;
const String _videoIdfour = 'https://youtu.be/8PJGIEz5YJ4?t=';
const double _startSecondsfour = 0000000000000000000000000001821;
const String _videoIdfive = 'https://youtu.be/jTRC_FMzLoo?t=';
