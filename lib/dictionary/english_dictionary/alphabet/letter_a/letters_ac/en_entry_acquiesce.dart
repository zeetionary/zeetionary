...
class EnglishEntryacquiesce extends StatefulWidget {
  const EnglishEntryacquiesce({super.key});

  @override
  State<EnglishEntryacquiesce> createState() => _EnglishEntryacquiesceState();
}

class _EnglishEntryacquiesceState extends State<EnglishEntryacquiesce> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "acquiesce";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""acquiesce""");
  }
  ...
  Future<void> speakacq154(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("She explained her plan and reluctantly he acquiesced.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acquiesce""",
                      // alsoEnglishWord: "also: acquiesce",
                      britshText: """IpaUK: /ˌækwiˈes/""",
                      americanText: """IpaUS: /ˌækwiˈes/""",
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'cKdRis64tsQ';
