...
class EnglishEntryindignity extends StatefulWidget {
  const EnglishEntryindignity({super.key});

  @override
  State<EnglishEntryindignity> createState() => _EnglishEntryindignityState();
}

class _EnglishEntryindignityState extends State<EnglishEntryindignity> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: indignity (Derived forms: indignities)
1. An affront to one's dignity or self-esteem
""",
  );

  final String keyword = "indignity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indignity""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/3PX2d3Zwutg?t=';
    const double startSecondsend = 000000000000000000000000000533;
    const String videoIdone = 'https://youtu.be/VPURs2iP9YY?t=';
    const double startSecondsone = 000000000000000000000000000463;
    const String videoIdtwo = 'https://youtu.be/cJiq-6abMEs?t=';
    const double startSecondstwo = 000000000000000000000000000294;
    const String videoIdthree = 'https://youtu.be/DWbxIFC0Q2o?t=';
    const double startSecondsthree = 00000000000000000000000000061;
    const String videoIdfour = 'https://youtu.be/6521a_4tUYA?t=';
    const double startSecondsfour = 0000000000000000000000000001183;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indignity""",
                      // alsoEnglishWord: "also: indignity",
                      britshText: """IpaUK: /ɪnˈdɪɡnəti/""",
                      americanText: """IpaUS: /ɪnˈdɪɡnəti/""",
...
"""),
// With short examples define "indignity", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دۆخێک کە وات لێدەکات هەست بە شەرمەزاری بکەیت چونکە بە ڕێزەوە مامەڵەت لەگەڵ نەکراوە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: humiliation"),
                    SentencesRow(
                      englishText:
                          """The chairman suffered the indignity of being refused admission to the meeting.""",
                      kurdishText:
                          """سەرۆکەکە تووشی شەرمەزاری ئەوە بوو کە ڕێگای لێ بگیردرێت بچێتە کۆبوونەوەکەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Clint suffered the indignity of being called "Puppy" in front of his girlfriend.""",
                      kurdishText:
                          """کلینت تووشی ئەو شەرمەزارییە بوو کە پێی بگوترێت 'پەپی' لە پێش دۆستە کچەکەی.""",
