...
class EnglishEntrylinear extends StatefulWidget {
  const EnglishEntrylinear({super.key});

  @override
  State<EnglishEntrylinear> createState() => _EnglishEntrylinearState();
}

class _EnglishEntrylinearState extends State<EnglishEntrylinear> {
  @override
  void initState() {
    super.initState();
