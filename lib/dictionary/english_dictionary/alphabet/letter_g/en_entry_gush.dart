...
class EnglishEntrygush extends StatefulWidget {
  const EnglishEntrygush({super.key});

  @override
  State<EnglishEntrygush> createState() => _EnglishEntrygushState();
}

class _EnglishEntrygushState extends State<EnglishEntrygush> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: gush (Derived forms: gushed, gushes, gushing)
1. Issue in a jet; come out in a jet; stream or spring forth (- jet)
"Water gushed forth";
 
2. Gush forth in a sudden stream or jet (- spurt, spirt, spout)
"water gushed forth";
 
3. Praise enthusiastically (- rave, enthuse, kvell [N. Amer, informal])
"She gushed about that new restaurant";

- Noun: gush (Derived forms: gushes)
1. A sudden rapid flow (as of water) (- flush, outpouring)
"there was a little gush of blood";
 
2. An unrestrained expression of emotion (- effusion, outburst, blowup [informal], ebullition, blow-up [informal])
""",
  );

  final String keyword = "gush";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Water gushed out of the pipe.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The tanker was gushing oil.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She absolutely gushed enthusiasm.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Showers with pumps are more expensive, but they deliver a really powerful gush of water.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gush""",
                      // alsoEnglishWord: "also: gush",
                      britshText: """IpaUK: /ɡʌʃ/""",
                      americanText: """IpaUS: /ɡʌʃ/""",
...
کوردی: فیشقە(کردن)، کفە(کردن) کوفارە، بازرەقە، هەڵقوڵین، پژان، گوڕبوون، دەرپەڕین، هەڵچوون، ڕژان،	پەڕگری، زێدەڕەوی، پەڕگیری
"""),
// With short examples define "gush", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) ئەوی شتێک لەناکاو دەست بە بەربوون بکات لە کونێکەوە"""),
                    SentencesRow(
                      englishText: """Water gushed out of the pipe.""",
                      kurdishText: """ئاو لە بۆرییەکەوە فیشقەی کرد.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) کە لەناکاو ڕێژەیەکی زۆر شلە فیشقە بکات"""),
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She absolutely gushed enthusiasm.""",
                      kurdishText: """(خوازراوی) جۆش‌وخرۆشی لێدەباری.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) ڕێژەیەکی زۆر شلە کە لە شوێنێکەوە دەچێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Showers with pumps are more expensive, but they deliver a really powerful gush of water.""",
                      kurdishText: """شاوەری پەمپدار گران‌بەهاترن، بەڵام فیشقەی ئاوی تەواو بەهێزیان هەیە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/HmtdGWoDMHE?t=';
...
const String _videoIdtwo = 'https://youtu.be/LQpLMvC7Et0?t=';
const double _startSecondstwo = 000000000000000000000000000281;
const String _videoIdthree = 'https://youtu.be/QlIcb_PKoTQ?t=';
const double _startSecondsthree = 000000000000000000000000000531;
const String _videoIdfour = 'https://youtu.be/26ixBG5LCXk?t=';
const double _startSecondsfour = 000000000000000000000000000325;
const String _videoIdfive = 'https://youtu.be/G3DsWnEDqbc?t=';
