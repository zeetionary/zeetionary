...
// replace these: replace EnglishEntryamorously - replace speakAmorously - replace amorously - /ˈæmərəsli/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryamorously extends StatelessWidget {
  ...
  Future<void> speakamorously(String languageCode) async {
    ...
    await flutterTts.speak("amorously");
  }
  ...
  Future<void> speakamorously5555(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He looked at her amorously.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "amorously"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæmərəsli/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæmərəsli/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '9sQ-TgigqU4';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '0Xb_8lN8vj0';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'EC_2FL0wCqs';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'fL8w4JATRpY';
