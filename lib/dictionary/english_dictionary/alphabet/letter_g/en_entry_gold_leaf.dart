...
class EnglishEntrygoldleaf extends StatefulWidget {
  const EnglishEntrygoldleaf({super.key});

  @override
  State<EnglishEntrygoldleaf> createState() => _EnglishEntrygoldleafState();
}

class _EnglishEntrygoldleafState extends State<EnglishEntrygoldleaf> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gold leaf (Derived forms: gold leaves)
1. A very thin form of gold foil
""",
  );

  final String keyword = "gold leaf";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gold leaf""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Gold leaf was used to gild the statue.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gold leaf""",
                      // alsoEnglishWord: "also: gold leaf",
                      britshText: """IpaUK: /ˌɡəʊld ˈliːf/""",
                      americanText: """IpaUS: /ˌɡəʊld ˈliːf/""",
...
کوردی: جغجغە، زێڕپەڕ، پەڕزێڕ، گەڵای زێڕین، زێڕوەرەق
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) زێڕ کە کراوە بە پارچەیەکی زۆر تەنکەوە و بۆ جوانکاری بەکاردێت"""),
                    SentencesRow(
                      englishText: """Gold leaf was used to gild the statue.""",
                      kurdishText:
                          """زێڕپەڕ بەکارهات بۆ ڕووپۆشکردنی پەیکەرەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/8hK4UzAH0rk?t=';
const double _startSecondsend = 000000000000000000000000000286;
const String _videoIdone = 'https://youtu.be/0n89GZvmeXI?t=';
const double _startSecondsone = 000000000000000000000000000479;
const String _videoIdtwo = 'https://youtu.be/BPGgyputhpA?t=';
const double _startSecondstwo = 0000000000000000000000000002237;
const String _videoIdthree = 'https://youtu.be/uud3c3vvGGQ?t=';
const double _startSecondsthree = 000000000000000000000000000757;
const String _videoIdfour = 'https://youtu.be/y-MUpSN4Lbw?t=';
const double _startSecondsfour = 000000000000000000000000000669;
const String _videoIdfive = 'https://youtu.be/5Blt_CJ29WQ?t=';
