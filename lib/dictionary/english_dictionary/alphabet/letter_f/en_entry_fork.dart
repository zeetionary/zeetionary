...
کوردی: چنگاڵ، چەتاڵ، ملێبۆک،	شەن، شەنە، هەسک، درگان، گۆ، کارێج، تەبور، ملێب، قەلەپیسک، هیرگووش، سێ‌دەندەک، پەنجە، پەنجەقازی (ئامێری کشت‌وکاڵ)،	دوڕیانە، دووڕێیانە،	(لق)لێبوونەوە، پەل‌لێبوونەوە،	دوولقانە، دووفلیقانە، دووحاچە، دوولکانە (دووچەرخە)،	بنی ڕان، گەڵ، ناوگەڵ، خەرک
"""),
// With short examples define "fork", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """She brought an extra plate, and knife and fork to the table.""",
                      kurdishText:
                          """دەورییەک، چەقۆیەک، و چنگاڵێکی زیادەی هێنایە سەر مێزەکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) کەرەستەیەک کە دەسکێکی چەند ددانێکی تیژی هەیە و لە کاری باخچە و کشتوکاڵ بەکاردێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Using a garden fork, she dug a hole two foot deep.""",
                      kurdishText:
                          """بە بەکارهێنانی شەنی باخچە، چاڵێکی هەڵکەند کە دوو پێ قووڵ بوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) شوێنێک کە ڕووبارێک، ڕێگایەک، هتد لێیەوە دەبێتە دوو بەشەوە؛ هەر یەکێک لەو دوو بەشە"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DefinitionKurdish(
                        text:
                            """٦. (کردار) جووڵاندن، کەندن، یان هەڵگرتن بە چنگاڵ یان شەن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/njn6krU3tQ8';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/hTqtGJwsJVE?t=';
const double _startSecondsone = 0000000000000000000000000002310;
const String _videoIdtwo = 'https://youtu.be/qWAagS_MANg?t=';
const double _startSecondstwo = 000000000000000000000000000384;
const String _videoIdthree = 'https://youtu.be/S-4rhjO6xYg?t=';
const double _startSecondsthree = 000000000000000000000000000557;
const String _videoIdfour = 'https://youtu.be/XG8b7WhANNA?t=';
const double _startSecondsfour = 000000000000000000000000000383;
