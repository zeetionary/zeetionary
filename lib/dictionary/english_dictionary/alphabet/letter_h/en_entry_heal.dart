...
class EnglishEntryheal extends StatefulWidget {
  const EnglishEntryheal({super.key});

  @override
  State<EnglishEntryheal> createState() => _EnglishEntryhealState();
}

class _EnglishEntryhealState extends State<EnglishEntryheal> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: heal (Derived forms: healed, healing, heals)
1. Get healthy again (- mend)
"The wound is healing slowly";
 
2. (medicine) provide a cure for, make healthy again (- bring around, cure)
"The quack pretended to heal patients but never managed to";
 
3. Reconcile or restore (a difference or breach in good relations)
""",
  );

  final String keyword = "heal";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It took a long time for the wounds to heal.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The cut healed up without leaving a scar.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""My leg has healed beautifully.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The breach between them never really healed.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was never able to heal the rift between herself and her father.""");
  }
...
کوردی: 
"""),
// With short examples define "heal", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) چاکبوونەوە یان چاککردنەوەی کەسێکی نەخۆش"""),
                    SentencesRow(
                      englishText:
                          """It took a long time for the wounds to heal.""",
                      kurdishText:
                          """کاتێکی زۆری پێچوو بۆ برینەکان کە ساڕێژ بن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """برینەکە ساڕێژبوو بەبێ جێهێشتنی زام.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) کۆتایی هێنان بە شتێک یان ئەوەی شتێک ئاسانتر بێت بۆ بەرگەگرتن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The breach between them never really healed.""",
                      kurdishText: """کەلێنەکەی نێوانیان هەرگیز بە تەواوی چاک نەبووەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She was never able to heal the rift between herself and her father.""",
                      kurdishText: """هەرگیز نەیتوانی ناکۆکی نێوان خۆی و باوکی چاک بکاتەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/UuGpm01SPcA?t=';
const double _startSecondsend = 000000000000000000000000000479;
const String _videoIdone = 'https://youtu.be/XnbCSboujF4?t=';
const double _startSecondsone = 000000000000000000000000000195;
const String _videoIdtwo = 'https://youtu.be/Cqbleas1mmo?t=';
const double _startSecondstwo = 0000000000000000000000000001141;
const String _videoIdthree = 'https://youtu.be/y1sF6ZeASU0?t=';
const double _startSecondsthree = 0000000000000000000000000001121;
const String _videoIdfour = 'https://youtu.be/pNCOA8AUxdw?t=';
const double _startSecondsfour = 000000000000000000000000000323;
const String _videoIdfive = 'https://youtu.be/qjqh9UVfNNk?t=';
const double _startSecondsfive = 000000000000000000000000000384;
