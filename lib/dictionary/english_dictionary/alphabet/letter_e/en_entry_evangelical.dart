...
class EnglishEntryevangelical extends StatefulWidget {
  const EnglishEntryevangelical({super.key});

  @override
  State<EnglishEntryevangelical> createState() =>
      _EnglishEntryevangelicalState();
}

class _EnglishEntryevangelicalState extends State<EnglishEntryevangelical> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evangelical""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evangelical""",
                      // alsoEnglishWord: "also: evangelical",
                      britshText: """IpaUK: /ˌiːvænˈdʒelɪkl/""",
                      americanText: """IpaUS: /ˌiːvænˈdʒelɪkl/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "evangelical";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They're evangelical Christians.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) سەر بەو گرووپە مەسیحییەی کە گرنگی بە ئینجیل دەدەن و پێیان وایە باوەڕ ڕزگارکەری مرۆڤە"""),
          SentencesRow(
            englishText: """They're evangelical Christians.""",
            kurdishText: """مەسیحیی ئینجیلین.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ھاوەڵناو) کە زۆر دەیەوێت خەڵکی ڕازی بکات بە دید و باوەڕەکانی"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """He delivered his speech with evangelical fervour.""",
            kurdishText: """وتارەکەی پێشکەش کرد بە تامەزرۆیی بەهێزەوە.""",
...
1. Marked by ardent or zealous enthusiasm for a cause (= evangelistic)
 
2. Relating to or being a Christian church believing in personal conversion and the inerrancy of the Bible especially the 4 Gospels (= evangelic [rare])
"evangelical Christianity"; "an ultraconservative evangelical message";
 
3. Of, pertaining to, or in keeping with the Christian Gospel, especially as in the first 4 books of the New Testament (= evangelic [rare])

- Noun: evangelical (Derived forms: evangelicals)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/kAgTZSJ4jo8';
const double _startSecondsend = 000000000000000000000000000000; // 0;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/4TogbPPyQQM?t=';
const double _startSecondsone = 00000000000000000000000000000; // 126;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/JJl4yF_y_eU?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 275;
const String _videoIdthree = 'VIDEOhttps://youtu.be/IOgq4Nk2H8w?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1582;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/6tYxnt3gCyI?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 408;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/ciOLx8t9UPo?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 425;
