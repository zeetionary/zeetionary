...
class EnglishEntrylongdistance extends StatefulWidget {
  const EnglishEntrylongdistance({super.key});

  @override
  State<EnglishEntrylongdistance> createState() => _EnglishEntrylongdistanceState();
}

class _EnglishEntrylongdistanceState extends State<EnglishEntrylongdistance> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""long-distance""");
  }
