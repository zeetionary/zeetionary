...
// Define the word "backlog" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace backlog - replace EnglishEntrybacklog

// replace speakBacklog - /ˈbæklɒɡ/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntrybacklog extends StatelessWidget {
  // blank divider
  EnglishEntrybacklog({super.key});
  // blank divider
  ...
  Future<void> speakA3(String languageCode) async {
    ...
    await flutterTts.speak("backlog"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakA3s1(String languageCode) async {
    ...
    await flutterTts.speak(
        "When she eventually returned to work, there was a tremendous backlog of paperwork to catch up on."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "backlog", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: const Text(
                                "IpaUK: /ˈbæklɒɡ/", // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
                        ...
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˈbæklɔːɡ/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () => speakA3s1(// REPLACE: backlog
                                    "en-US"),
                              ),
                            ],
                          ),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "sTTvilkyTLY";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "VeKq-l2Uzv8";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 15409, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
      autoPlay: true,
      enableCaption: true,
      loop: true,
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "ub1umsYqPw0";
...
// end backlog // TODO Implement this library.
