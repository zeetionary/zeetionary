...
class EnglishEntryholding extends StatefulWidget {
  const EnglishEntryholding({super.key});

  @override
  State<EnglishEntryholding> createState() => _EnglishEntryholdingState();
}

class _EnglishEntryholdingState extends State<EnglishEntryholding> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: holding (Derived forms: holdings)
1. The act of retaining something (- retention, keeping)
 
2. Something owned; any tangible or intangible possession that is owned by someone (- property, belongings)
""",
  );

  final String keyword = "holding";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""holding""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She has a 40% holding in the company.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The holding has been housed in the museum since 2002.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 000000000000000000000000000609;
    const String videoIdtwo = 'https://youtu.be/zwZY-PknSQw?t=';
    const double startSecondstwo = 0000000000000000000000000001761;
    const String videoIdthree = 'https://youtu.be/96BhTy93MN0?t=';
    const double startSecondsthree = 0000000000000000000000000001337;
    const String videoIdfour = 'https://youtu.be/XB2W_kw62u8?t=';
    const double startSecondsfour = 000000000000000000000000000594;
    const String videoIdfive = 'https://youtu.be/rWVAzS5duAs?t=';
    const double startSecondsfive = 000000000000000000000000000736;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """holding""",
                      // alsoEnglishWord: "also: holding",
                      britshText: """IpaUK: /ˈhəʊldɪŋ/""",
                      americanText: """IpaUS: /ˈhəʊldɪŋ/""",
...
کوردی: 
"""),
// With short examples define "holding", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ژمارەی ئەو پشکانەی کەسێک لە کۆمپانیایەک هەیەتی"""),
                    SentencesRow(
                      englishText: """She has a 40% holding in the company.""",
                      kurdishText: """٤٠٪ ـی پشکی هەیە لە کۆمپانیاکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کاڵاکە لە مۆزەخانەکە بووە لە ٢٠٠٢ ــەوە.""",
                      englishNote:
                          """This means the collection or item has been stored and displayed in the museum starting from 2002.""",
