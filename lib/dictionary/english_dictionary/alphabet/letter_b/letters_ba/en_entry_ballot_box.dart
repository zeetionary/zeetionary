...
Future<void> speakBallotboxs1(String languageCode) async {
  ...
  await flutterTts.setPitch(1.0);
  await flutterTts.setSpeechRate(0.5);
  await flutterTts.speak("The voters cast their ballots into the ballot box one by one."); // DOPSUM: CHANGE TEXT
}
...
Future<void> speakBallotboxs2(String languageCode) async {
  ...
  await flutterTts.setPitch(1.0);
  await flutterTts.setSpeechRate(0.5);
  await flutterTts.speak("The people make their wishes known through the ballot box."); // DOPSUM: CHANGE TEXT
}
                      ...
                      Row(
                        children: [
                          ...
                          IconButton(
                            ...
                            onPressed: () =>
                                speakBallotbox(// DOPSUM: CHANGE THE WORD ABOVE
                                    "en-GB"),
                          ),
                        ],
                      ),
                      Row(
                        children: [
                          Container(
                            constraints: const BoxConstraints(maxWidth: 300),
                            child: const Text(
                              "IpaUS: /ˈbælət bɑːks/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                          ),
                          IconButton(
...
١. (ناو) سندووقی دەنگدان""",
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () => speakBallotboxs1(// REPLACE: ballot box
                                  "en-US"),
                            ),
                          ],
                        ),
                        ...
                        const Text(
                          // DOPSUM: WRITE DEFINITION IN KURDISH. COPY FOR ANOTHER DEFINITION
                          """
٢. (ناو) سیستەمی دەنگدان لە هەڵبژاردنێکدا""",
                          style: TextStyle(fontSize: 18),
                          textAlign: TextAlign.right,
                          textDirection: TextDirection.rtl,
                        ),
                          ...
                          children: [
                            ...
                            const Expanded(
                              child: Align(
                                alignment: Alignment.topLeft,
                                child: Text(
                                  "خەڵکی خواستەکانیان دەردەبڕن لە سیستەمی هەڵبژاردنەکەدا.",
                                  textAlign: TextAlign
                                      .right, // Right-to-left direction 
                                  textDirection: TextDirection.rtl,
                                ),
                            ...
                            IconButton(
                              ...
                              onPressed: () => speakBallotboxs2(// REPLACE: ballot box
                                  "en-US"),
                            ),
                          ],
                        ),
...
static String myVideoId = "https://youtu.be/0sazcZ8wwZc?t=";
...
static String myVideoId = "https://youtu.be/UJZY8e1rKGQ?t=";
...
static String myVideoId = "https://youtu.be/oUeXaPaKF50?t=";
...
static String myVideoId = "https://youtu.be/ha7iWECm_8E?t=";
...
static String myVideoId = "https://youtu.be/jdLf3SbBH9Q?t=";
...
static String myVideoId = "https://youtu.be/YdVhOBv5pcc?t=";
...
static String myVideoId = "https://youtu.be/bGURPuoXgW4?t=";
...
static String myVideoId = "https://youtu.be/Z8f1jz55tZo?t=";
