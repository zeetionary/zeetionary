...
class EnglishEntryimpolite extends StatefulWidget {
  const EnglishEntryimpolite({super.key});

  @override
  State<EnglishEntryimpolite> createState() => _EnglishEntryimpoliteState();
}

class _EnglishEntryimpoliteState extends State<EnglishEntryimpolite> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impolite""");
  }
