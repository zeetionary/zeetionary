...
class EnglishEntryinject extends StatefulWidget {
  const EnglishEntryinject({super.key});

  @override
  State<EnglishEntryinject> createState() => _EnglishEntryinjectState();
}

class _EnglishEntryinjectState extends State<EnglishEntryinject> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: inject (Derived forms: injected, injecting, injects)
1. Give an injection to (- shoot)
"We injected the glucose into the patient's vein";
 
2. Force or drive (a fluid or gas) into by piercing (- shoot)
"inject hydrogen into the balloon";
 
3. Take by injection
"inject heroin"
 
4. To insert between other elements (- interject, come in, interpose, put in, throw in)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Adrenaline was injected into the muscle.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The fruit is injected with chemicals to reduce decay.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Chemicals are injected into the fruit to reduce decay.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000626;
    const String videoIdone = 'https://youtu.be/a9m3GD0DbPY?t=';
    const double startSecondsone = 0000000000000000000000000001237;
    const String videoIdtwo = 'https://youtu.be/ngTcyNtDjE8?t=';
    ...
    const double startSecondsfour = 000000000000000000000000000284;
    const String videoIdfive = 'https://youtu.be/sKnjw8Fl5Yg?t=';
    const double startSecondsfive = 000000000000000000000000000541;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inject""",
                      // alsoEnglishWord: "also: inject",
                      britshText: """IpaUK: /ɪnˈdʒekt/""",
                      americanText: """IpaUS: /ɪnˈdʒekt/""",
...
کوردی: 
"""),
// With short examples define "inject", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) دەرزی‌لێدان لە کەسێک یان ئاژەڵێک بۆ پێدانی دەرمانێک"""),
                    SentencesRow(
                      englishText:
                          """Adrenaline was injected into the muscle.""",
                      kurdishText: """ئەدریناڵین بە دەرزی درا لە ماسوولکەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She has been injecting herself with insulin since the age of 16.""",
                      kurdishText:
                          """لە تەمەنی ١٦ ساڵییەوە ئەنسوولینی بە دەرزی لە خۆی داوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) دەرزی‌لێدان لە شتێک بۆ تێخستنی مادەیەک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The fruit is injected with chemicals to reduce decay.""",
                      kurdishText:
                          """میوەکە مادەی کیمیایی لێدەدرێت بۆ کەمکردنەوەی گەنین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کیمیایی دەدرێت لە میوەکان بۆ کەمکردنەوەی گەنین.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) زیادکردنی خاسیەتێکی دیاریکراو بۆ شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """They are hoping a change of leader will inject new energy into the movement.""",
                      kurdishText:
                          """بەهیوان گۆڕانی سەرکردە وزەی تازە بدات بە بزووتنەوەکە.""",
