...
class EnglishEntryenthusiast extends StatefulWidget {
  const EnglishEntryenthusiast({super.key});

  @override
  State<EnglishEntryenthusiast> createState() => _EnglishEntryenthusiastState();
}

class _EnglishEntryenthusiastState extends State<EnglishEntryenthusiast> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enthusiast""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enthusiast""",
                      // alsoEnglishWord: "also: enthusiast",
                      britshText: """IpaUK: /ɪnˈθjuːziæst/""",
                      americanText: """IpaUS: /ɪnˈθuːziæst/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enthusiast";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was an enthusiast for early Italian art.""");
  }
...
کوردی: مرۆی بەپەرۆش، تامەزرۆ، دڵبەستە، بەتاو، بەشەوق، لەگوڕ
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کەسێک کە زۆر حەزی بە شتێکە و کاتێکی زۆر بەسەر دەبات بە کردنی"""),
          SentencesRow(
            englishText: """She was an enthusiast for early Italian art.""",
            kurdishText: """تامەزرۆیەکی هونەری سەرەتایی ئیتالیا بوو.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هەواداری گەورەی ئاکاری کارن لە ئەمریکا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: enthusiast (Derived forms: enthusiasts)
1. An ardent and enthusiastic supporter of some person or activity (= partisan, partizan)
 
2. A person having a strong liking for something (= fancier)
""",
  );
...
const String _videoIdone = 'https://youtu.be/qQ01eLt_bxo?t=';
const double _startSecondsone = 590;
const String _videoIdtwo = 'https://youtu.be/LbPw9AlVKVM?t=';
const double _startSecondstwo = 34;
const String _videoIdthree = 'https://youtu.be/tJuYL3nPINM?t=';
const double _startSecondsthree = 367;
const String _videoIdfour = 'https://youtu.be/b4wRdoWpw0w?t=';
const double _startSecondsfour = 603;
const String _videoIdfive = 'https://youtu.be/9hvjBi4PKWA?t=';
const double _startSecondsfive = 1272;
const String _videoIdsix = 'https://youtu.be/TnkdoEZhTbc?t=';
const double _startSecondssix = 127;
