...
class EnglishEntryacronym extends StatefulWidget {
  const EnglishEntryacronym({super.key});

  @override
  State<EnglishEntryacronym> createState() => _EnglishEntryacronymState();
}

class _EnglishEntryacronymState extends State<EnglishEntryacronym> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""acronym""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acronym""",
                      // alsoEnglishWord: "also: acronym",
                      britshText: """IpaUK: /ˈækrənɪm/""",
                      americanText: """IpaUS: /ˈækrənɪm/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '41DK2Oi1M2s';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 't4MtseJfQqk';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '9wqXhTOe8ak';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'hXCzhyYqLso';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'moIucWGgvMc';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'R-elGPRABFw';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'qr5m0sXIep8';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'F-qeFLMkEng';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final double _startSeconds = 5118;
