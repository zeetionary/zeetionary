...
class EnglishEntryindustrial extends StatefulWidget {
  const EnglishEntryindustrial({super.key});

  @override
  State<EnglishEntryindustrial> createState() => _EnglishEntryindustrialState();
}

class _EnglishEntryindustrialState extends State<EnglishEntryindustrial> {
  @override
  void initState() {
    super.initState();
...
3. Suitable to stand up to hard wear
"industrial carpeting"
 
4. Having highly developed industries
"the industrial revolution"; "an industrial nation"
""",
  );

  final String keyword = "industrial";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""industrial""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Industrial production fell in December by 1.4 per cent.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""India has a large industrial sector.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Factories use industrial chemicals to produce goods.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They had made industrial quantities of food.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They were guilty of fraud on an industrial scale.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001252;
    const String videoIdone = 'https://youtu.be/SrDEtSlqJC4?t=';
    const double startSecondsone = 0000000000000000000000000001323;
    const String videoIdtwo = 'https://youtu.be/b1reY72ktEc?t=';
    const double startSecondstwo = 0000000000000000000000000001133;
    const String videoIdthree = 'https://youtu.be/a9m3GD0DbPY?t=';
    const double startSecondsthree = 000000000000000000000000000238;
    const String videoIdfour = 'https://youtu.be/8FpPSMIB4uA?t=';
    const double startSecondsfour = 000000000000000000000000000603;
    const String videoIdfive = 'https://youtu.be/DxL2HoqLbyA?t=';
    const double startSecondsfive = 000000000000000000000000000197;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """industrial""",
                      // alsoEnglishWord: "also: industrial",
                      britshText: """IpaUK: /ɪnˈdʌstriəl/""",
                      americanText: """IpaUS: /ɪnˈdʌstriəl/""",
...
کوردی: 
"""),
// With short examples define "industrial", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) پەیوەندیدار بە پیشەسازی"""),
                    SentencesRow(
                      englishText:
                          """Industrial production fell in December by 1.4 per cent.""",
                      kurdishText:
                          """بەرهەمی پیشەسازی لە کانوونی یەکەم بە ڕێژەی ١,٤ لە سەد دابەزی.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """India has a large industrial sector.""",
                      kurdishText:
                          """هندستان سێکتەرێکی گەورەی پیشەسازی هەیە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە لەلایەن کۆمپانیا پیشەسازییەکان بەکاردێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Factories use industrial chemicals to produce goods.""",
                      kurdishText:
                          """کارگەکان مادەی کیمیایی پیشەسازی بەکاردێنن بۆ بەرهەمهێنانی کەلووپەل.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ھاوەڵناو) کە زۆر پیشەسازی هەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Houses near industrial sites often do not sell so quickly because they are regarded as undesirable.""",
                      kurdishText:
                          """خانووی تەنیشت شوێنە پیشەسازییەکان زۆرجار بە ئاسانی نافرۆشرێن بەهۆی ئەوەی کە بە نەویستراو دادەنرێن.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (ھاوەڵناو) زۆر گەورە لە بڕ یان ئاست"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """They had made industrial quantities of food.""",
                      kurdishText: """ڕێژەیەکی زۆر لە خواردنیان درووستکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تاوانبار بوون بە ساختەکاری لە ئاستێکی زۆر گەورە.""",
