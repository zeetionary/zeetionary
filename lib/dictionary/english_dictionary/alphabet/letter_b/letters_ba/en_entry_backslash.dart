...
class EnglishEntrybackslash extends StatelessWidget {
  ...
  Future<void> speakb3(String languageCode) async {
    ...
    await flutterTts.speak("backslash");
  }
  ...
  Future<void> speakb3s1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakB3s11");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'GhQdlIFylQ8';
  final double _startSeconds = 2297;
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'fis26HvvDII';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'ATqEsETjubs';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 3590;
