...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '-cPdImejxEQ';
    const double startSecondsend = 257;
    const String videoIdone = 'inpok4MKVLM';
    const double startSecondsone = 49;
    const String videoIdtwo = 'SwQhKFMxmDY';
    const double startSecondstwo = 4707;
    const String videoIdthree = 'O-6f5wQXSu8';
    const double startSecondsthree = 66;
    const String videoIdfour = 'Oij-BdIkPgQ';
    const double startSecondsfour = 353;
    const String videoIdfive = 'CupbRr2m_sM';
    const double startSecondsfive = 843;
