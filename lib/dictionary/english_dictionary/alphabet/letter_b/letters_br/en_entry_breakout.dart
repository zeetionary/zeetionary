...
// blank divider
  ...
  Future<void> speakbreakouts2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("She was the breakout star of this year's Women's World Cup.");
  }
  ...
  Future<void> speakbreakouts3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("Here are some notes from the breakout session I attended.");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'x3Bbt7xmoEU';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'HMX-wa3mVkc';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'yZqdUBpHmhM';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = '310WCL-esLM';
  final double _startSeconds = 6799;
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'YHCArqqE9rE';
