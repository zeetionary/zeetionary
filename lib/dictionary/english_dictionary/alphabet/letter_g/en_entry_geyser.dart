...
class EnglishEntrygeyser extends StatefulWidget {
  const EnglishEntrygeyser({super.key});

  @override
  State<EnglishEntrygeyser> createState() => _EnglishEntrygeyserState();
}

class _EnglishEntrygeyserState extends State<EnglishEntrygeyser> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""A geyser's eruption can be a spectacular sight.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They installed a new geyser to heat water.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """geyser""",
                      // alsoEnglishWord: "also: geyser",
                      britshText: """IpaUK: /ˈɡiːzə(r)/""",
                      americanText: """IpaUS: /ˈɡaɪzər/""",
...
کوردی: ئاوپژێن، فیشقاو، تەوژماو، گراو، کانی گەرماو، گەرماڤ
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەقینی گیزەرێک دەکرێت دیمەنێکی ناوازە بێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """گیزەرێکی تازەیان دانا بۆ گەرمکردنی ئاو.""",
...
const double _startSecondsend = 000000000000000000000000000406;
const String _videoIdone = 'https://youtu.be/C0mDENSW3VQ?t=';
const double _startSecondsone = 000000000000000000000000000497;
const String _videoIdtwo = 'https://youtu.be/rArpyMXT2ew?t=';
const double _startSecondstwo = 000000000000000000000000000892;
const String _videoIdthree = 'https://youtu.be/V2c81NNNx5s?t=';
const double _startSecondsthree = 0000000000000000000000000001024;
const String _videoIdfour = 'https://youtu.be/fiVYYbZSnFw?t=';
const double _startSecondsfour = 000000000000000000000000000454;
const String _videoIdfive = 'https://youtu.be/A_uyT6UEBFs?t=';
const double _startSecondsfive = 000000000000000000000000000839;
