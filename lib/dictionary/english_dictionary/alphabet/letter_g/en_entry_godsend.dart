...
class EnglishEntrygodsend extends StatefulWidget {
  const EnglishEntrygodsend({super.key});

  @override
  State<EnglishEntrygodsend> createState() => _EnglishEntrygodsendState();
}

class _EnglishEntrygodsendState extends State<EnglishEntrygodsend> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""godsend""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """godsend""",
                      // alsoEnglishWord: "also: godsend",
                      britshText: """IpaUK: /ˈɡɒdsend/""",
                      americanText: """IpaUS: /ˈɡɑːdsend/""",
...
// With short examples define "godsend", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) شتێکی باشی چاوەڕواننەکراو کە ڕوودەدات و یارمەتی کەسێک/شتێک دەدات لە کاتێکدا کە پێویستیی بە یارمەتی هەیە"""),
                    SentencesRow(
                      englishText:
                          """The grant was a real godsend, especially considering the theatre was going to be shut down next month.""",
                      kurdishText:
                          """کۆمەکە دیارییەکی ئاسمانی تەواو بوو، بەتایبەتی کە هۆڵە شانۆکە بڕیار بوو مانگی داهاتوو دابخرێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """This new benefit has come as a godsend for low-income families.""",
                      kurdishText:
                          """ئەم سووە تازەیە وەک دیارییەکی ئاسمانی وایە بۆ ئەو خێزانانەی داهاتیان کەمە..""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/CURLWPCxe-c?t=';
const double _startSecondsend = 000000000000000000000000000298;
const String _videoIdone = 'https://youtu.be/PYsE5K9Vgns?t=';
const double _startSecondsone = 000000000000000000000000000261;
const String _videoIdtwo = 'https://youtu.be/R7JZVn1iFy4?t=';
const double _startSecondstwo = 000000000000000000000000000482;
const String _videoIdthree = 'https://youtu.be/l1p--Mr63Gg?t=';
const double _startSecondsthree = 000000000000000000000000000166;
const String _videoIdfour = 'https://youtu.be/WhEkTCpI__4?t=';
const double _startSecondsfour = 000000000000000000000000000447;
const String _videoIdfive = 'https://youtu.be/oloBebBQE38?t=';
