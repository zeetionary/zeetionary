...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1217;
    const String videoIdone = 'dtp6b76pMak';
    const double startSecondsone = 1544;
    const String videoIdtwo = 'b5fNif_WGdc';
    const double startSecondstwo = 998;
    const String videoIdthree = 'd0LRV27wGDE';
    const double startSecondsthree = 215;
    const String videoIdfour = '3i1lNJPY-4Q';
    const double startSecondsfour = 1323;
    const String videoIdfive = '6T_-DiAzYBc';
    const double startSecondsfive = 164;
