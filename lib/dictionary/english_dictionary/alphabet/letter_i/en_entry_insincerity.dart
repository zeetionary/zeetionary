...
class EnglishEntryinsincerity extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insincerity""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'H7haxkYwAaU';
    const double startSecondsend = 1004;
    const String videoIdone = '0MMTa_tk5NM';
    const double startSecondsone = 64;
    const String videoIdtwo = 'uqWgRoV_QnY';
    const double startSecondstwo = 490;
    const String videoIdthree = 'lWeaWLxwQLo';
    const double startSecondsthree = 1576;
    const String videoIdfour = 'wudoSFuc4Dc';
    const double startSecondsfour = 99;
    const String videoIdfive = 'idZUsjVioDQ';
    const double startSecondsfive = 649;
