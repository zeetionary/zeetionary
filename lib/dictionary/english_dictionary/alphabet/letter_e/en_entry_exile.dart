...
class EnglishEntryexile extends StatefulWidget {
  const EnglishEntryexile({super.key});

  @override
  State<EnglishEntryexile> createState() => _EnglishEntryexileState();
}

class _EnglishEntryexileState extends State<EnglishEntryexile> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exile""",
                      // alsoEnglishWord: "also: exile",
                      britshText: """IpaUK: /ˈeksaɪl/,  /ˈeɡzaɪl/""",
                      americanText: """IpaUS: /ˈeksaɪl/,  /ˈeɡzaɪl/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He returned after 40 years of exile.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He has lived in exile since 1989.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The whole family went into exile.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Dante died in exile from Florence.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Many political exiles fled the country.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was exiled to Siberia.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was exiled after a failed bid for power.""");
  }
...
کوردی: دوورخستنەوە، شاربەدەرکردن،	کەسی دوورەوەخراو، شاربەدەر
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) دوورخستنەوە لە وڵات یان زێدی خۆت بۆ هۆکاری سیاسی یان وەک سزا"""),
          SentencesRow(
            englishText: """He returned after 40 years of exile.""",
            kurdishText: """لە دوای چل ساڵ لە دوورخستنەوە گەڕایەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He has lived in exile since 1989.""",
            kurdishText: """لە ساڵی ١٩٨٩ ـوە لە شاربەدەری ژیاوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The whole family went into exile.""",
            kurdishText: """تەواوی خێزانەکە دوورخرانەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Dante died in exile from Florence.""",
            kurdishText: """دانتێ لە فلۆرنس لە دەربەدەریدا مرد.""",
            onPressedBritish: () => speaksentence4("en-GB"),
            onPressedAmerican: () => speaksentence4("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """٢. (ناو) کەسێک کە دوورخراوەتەوە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Many political exiles fled the country.""",
            kurdishText: """زۆر دوورخراوەی سیاسی لە وڵاتەکە هەڵهاتن.""",
          ...
          const DefinitionKurdish(
              text:
                  """٣. (کردار) دەرکردنی کەسێک لە وڵات یان زێدی خۆی بۆ هۆکاری سیاسی یان وەک سزا"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """He was exiled to Siberia.""",
            kurdishText: """دوورخرایەوە بۆ سیبیریا.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He was exiled after a failed bid for power.""",
            kurdishText:
                """دوورخرایەوە لە دوای هەوڵێکی شکستخواردوو بۆ دەسەڵات.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The family was exiled from France.""",
            kurdishText: """خێزانەکە لە فەرەنسا دوورخرانەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: exile (Derived forms: exiles)
1. A person who is voluntarily absent from home or country (= expatriate, expat)
"American exiles";
 
2. A person who is expelled from home or country by authority (= deportee)
 
3. The act of expelling a person from their native land (= deportation, expatriation, transportation)
"men in exile dream of hope";

- Verb: exile (Derived forms: exiling, exiles, exiled)
1. Expel from a country (= expatriate, deport)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/mY3SEMTROas?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1230;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/Cqbleas1mmo?t=';
const double _startSecondsone = 00000000000000000000000000000; // 454;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/hkO8qXCFYWA?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 562;
const String _videoIdthree = 'VIDEOhttps://youtu.be/GHUHgk8xCs0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1858;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/S7Lu2YIpYs4?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 21;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/CaOwcYLGTMo?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 183;
