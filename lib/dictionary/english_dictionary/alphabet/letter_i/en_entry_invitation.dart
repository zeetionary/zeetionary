...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/4K-_KbbRiEE?t=';
    const double startSecondsend = 000000000000000000000000000374;
    const String videoIdone = 'https://youtu.be/4K32WYshK6E?t=';
    const double startSecondsone = 000000000000000000000000000895;
    const String videoIdtwo = 'https://youtu.be/epAuo2_6gR8?t=';
    const double startSecondstwo = 00000000000000000000000000063;
    const String videoIdthree = 'https://youtu.be/g4U4BQW9OEk?t=';
    const double startSecondsthree = 00000000000000000000000000054;
    const String videoIdfour = 'https://youtu.be/_1btDc5xJe0?t=';
    const double startSecondsfour = 00000000000000000000000000034;
    const String videoIdfive = 'https://youtu.be/auPYOsBejK4?t=';
