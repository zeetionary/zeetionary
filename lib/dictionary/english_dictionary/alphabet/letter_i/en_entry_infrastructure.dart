...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 953;
    const String videoIdtwo = '-UrdExQW0cs';
    const double startSecondstwo = 1342;
    const String videoIdthree = 'rWVAzS5duAs';
    const double startSecondsthree = 1234;
    const String videoIdfour = 'dxqYDrELD_E';
    const double startSecondsfour = 108;
    const String videoIdfive = 'vsMydMDi3rI';
