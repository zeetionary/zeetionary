...
class EnglishEntryinsolence extends StatefulWidget {
  const EnglishEntryinsolence({super.key});

  @override
  State<EnglishEntryinsolence> createState() => _EnglishEntryinsolenceState();
}

class _EnglishEntryinsolenceState extends State<EnglishEntryinsolence> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insolence""");
  }
