...
class EnglishEntrygravelly extends StatefulWidget {
  const EnglishEntrygravelly({super.key});

  @override
  State<EnglishEntrygravelly> createState() => _EnglishEntrygravellyState();
}

class _EnglishEntrygravellyState extends State<EnglishEntrygravelly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: gravelly
1. Abounding in small stones (- pebbly, shingly)
"landed at a gravelly little beach";
 
2. Unpleasantly harsh or grating in sound (- grating, rasping, raspy, rough, scratchy)
"a gravelly voice";
""",
  );

  final String keyword = "gravelly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gravelly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Silt and gravelly deposits had been left by the tide.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His gravelly voice is perfect for radio.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gravelly""",
                      // alsoEnglishWord: "also: gravelly",
                      britshText: """IpaUK: /ˈɡrævəli/""",
                      americanText: """IpaUS: /ˈɡrævəli/""",
...
// With short examples define "gravelly", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شەپۆلەکە لم و نیشتەنی زیخاوی لە دوای خۆی بەجێ هێشتبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەنگە گڕەکەی تەواوە بۆ ڕادیۆ.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/zg3bdspvIiQ?t=';
const double _startSecondsend = 00000000000000000000000000042;
const String _videoIdone = 'https://youtu.be/ZoZT8-HqI64?t=';
const double _startSecondsone = 000000000000000000000000000257;
const String _videoIdtwo = 'https://youtu.be/JsxYsqZKYSw?t=';
const double _startSecondstwo = 000000000000000000000000000682;
const String _videoIdthree = 'https://youtu.be/xZk-xsMjyJg?t=';
const double _startSecondsthree = 000000000000000000000000000114;
const String _videoIdfour = 'https://youtu.be/H2-OMgQmRow?t=';
const double _startSecondsfour = 0000000000000000000000000001453;
const String _videoIdfive = 'https://youtu.be/SLB0li7D0wA?t=';
const double _startSecondsfive = 0000000000000000000000000001254;
