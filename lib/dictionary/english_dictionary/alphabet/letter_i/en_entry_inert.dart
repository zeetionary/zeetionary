...
class EnglishEntryinert extends StatefulWidget {
  const EnglishEntryinert({super.key});

  @override
  State<EnglishEntryinert> createState() => _EnglishEntryinertState();
}

class _EnglishEntryinertState extends State<EnglishEntryinert> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: inert (Derived forms: inertest, inerter)
1. Unable to move or resist motion
 
2. (chemistry) having only a limited ability to react chemically; chemically inactive (- indifferent, neutral)
"inert matter";
 
3. Slow and apathetic (- sluggish, torpid, dozy [Brit, informal])
"she was fat and inert";
""",
  );

  final String keyword = "inert";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He lay inert with half-closed eyes.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000481;
    const String videoIdone = 'https://youtu.be/OCFmQd15SRo?t=';
    const double startSecondsone = 000000000000000000000000000320;
    const String videoIdtwo = 'https://youtu.be/lfkjm2YRG-Q?t=';
    const double startSecondstwo = 000000000000000000000000000496;
    const String videoIdthree = 'https://youtu.be/dCXkaQa53QQ?t=';
    const double startSecondsthree = 000000000000000000000000000737;
    const String videoIdfour = 'https://youtu.be/QWY6osJ4eJI?t=';
    const double startSecondsfour = 000000000000000000000000000692;
    const String videoIdfive = 'https://youtu.be/4arNJoJ98Og?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inert""",
                      // alsoEnglishWord: "also: inert",
                      britshText: """IpaUK: /ɪˈnɜːt/""",
                      americanText: """IpaUS: /ɪˈnɜːrt/""",
...
کوردی: بێ‌جووڵە، نەبزواو، نەبزۆک، تەکان‌نەخواردوو، چرکەنەکردوو، نەجووڵ،	(گاز) ناچالاک، بێ‌کاردانەوە، ناکاریگەر، سست،	سست، تەمەڵ، داوەشاو
"""),
// With short examples define "inert", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) بەبێ دەسەڵاتی هەنگاونان یان جوڵان"""),
                    SentencesRow(
                      englishText: """He lay inert with half-closed eyes.""",
                      kurdishText: """بە چاوی نیوە داخراو بێ‌جووڵە کەوتبوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The president has to operate within an inert political system.""",
                      kurdishText:
                          """سەرۆک دەبێت کار بکات لە نێو سیستەمێکی سیاسیی بێ‌دەسەڵات.""",
