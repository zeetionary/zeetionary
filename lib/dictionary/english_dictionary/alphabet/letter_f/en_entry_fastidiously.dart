...
class EnglishEntryfastidiously extends StatefulWidget {
  const EnglishEntryfastidiously({super.key});

  @override
  State<EnglishEntryfastidiously> createState() =>
      _EnglishEntryfastidiouslyState();
}

class _EnglishEntryfastidiouslyState extends State<EnglishEntryfastidiously> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fastidiously""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fastidiously""",
                      // alsoEnglishWord: "also: fastidiously",
                      britshText: """IpaUK: /fæˈstɪdiəsli/""",
                      americanText: """IpaUS: /fæˈstɪdiəsli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "fastidiously";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her pictures are fastidiously crafted.""");
  }
...
کوردی: عەیب‌گرانە، سەختگرانە، دێرپەسندانە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵکار) بەشێوەیەک کە گرنگی بدەیت بەوەی کە هەموو وردەکارییەکی شتێک درووستە"""),
          SentencesRow(
            englishText: """Her pictures are fastidiously crafted.""",
            kurdishText: """وێنەکانی وریایانە دەکێشران.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هێنری زۆر پاک بوو بەپێی ستانداردەکانی تەمەنەکەی.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: fastidiously
1. In a fastidious and painstaking manner (= painstakingly)
"fastidiously learn the routines of selling";
...
const String _videoIdend = 'https://youtu.be/cGQ7LSAQwo4?t=';
const double _startSecondsend = 000000000000000000000000000597;
const String _videoIdone = 'https://youtu.be/TDKfqpnFoeQ?t=';
const double _startSecondsone = 000000000000000000000000000186;
const String _videoIdtwo = 'https://youtu.be/b47CJlE-ut0?t=';
const double _startSecondstwo = 000000000000000000000000000435;
const String _videoIdthree = 'https://youtu.be/QU3JYx1tDxw?t=';
const double _startSecondsthree = 000000000000000000000000000340;
const String _videoIdfour = 'https://youtu.be/bax5I-NR8c8?t=';
const double _startSecondsfour = 000000000000000000000000000312;
const String _videoIdfive = 'https://youtu.be/HzlBB1dGkGM?t=';
const double _startSecondsfive = 000000000000000000000000000405;
