...
class EnglishEntrygunsmith extends StatefulWidget {
  const EnglishEntrygunsmith({super.key});

  @override
  State<EnglishEntrygunsmith> createState() => _EnglishEntrygunsmithState();
}

class _EnglishEntrygunsmithState extends State<EnglishEntrygunsmith> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gunsmith (Derived forms: gunsmiths)
1. Someone who makes or repairs guns
""",
  );

  final String keyword = "gunsmith";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gunsmith""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gunsmith""",
                      // alsoEnglishWord: "also: gunsmith",
                      britshText: """IpaUK: /ˈɡʌnsmɪθ/""",
                      americanText: """IpaUS: /ˈɡʌnsmɪθ/""",
...
کوردی: چەخماخ‌چی، تفەنگ‌ساز، چەک‌ساز
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە چەک درووست دەکات و چاکیان دەکاتەوە"""),
                    SentencesRow(
                      englishText:
                          """She apprenticed with a master gunsmith to learn the trade.""",
                      kurdishText:
