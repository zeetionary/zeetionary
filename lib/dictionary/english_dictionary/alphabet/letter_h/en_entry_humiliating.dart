...
class EnglishEntryhumiliating extends StatefulWidget {
  const EnglishEntryhumiliating({super.key});

  @override
  State<EnglishEntryhumiliating> createState() => _EnglishEntryhumiliatingState();
}

class _EnglishEntryhumiliatingState extends State<EnglishEntryhumiliating> {
  @override
  void initState() {
    super.initState();
...
1. Causing awareness of your shortcomings (- demeaning, humbling, mortifying)
"golf is a humiliating game";
""",
  );

  final String keyword = "humiliating";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""humiliating""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It was the most humiliating night of his life.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""To withdraw the remaining troops would have been a humiliating capitulation.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    // 188888880002200
    const String videoIdend = 'https://youtu.be/lsbcN9-jU1Y?t=';
    const double startSecondsend = 000000000000000000000000000192;
    ...
    const double startSecondstwo = 0000000000000000000000000001250;
    const String videoIdthree = 'https://youtu.be/Q-nWA0WeF98?t=';
    const double startSecondsthree = 000000000000000000000000000189;
    const String videoIdfour = 'https://youtu.be/EmT0i0xG6zg?t=';
    const double startSecondsfour = 0000000000000000000000000004088;
    const String videoIdfive = 'https://youtu.be/hhvjKAQv2cs?t=';
    const double startSecondsfive = 000000000000000000000000000232;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """humiliating""",
                      // alsoEnglishWord: "also: humiliating",
                      britshText: """IpaUK: /hjuːˈmɪlieɪtɪŋ/""",
                      americanText: """IpaUS: /hjuːˈmɪlieɪtɪŋ/""",
...
// With short examples define "humiliating", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) کە وا لە کەسێک دەکات هەست بە شەرم بکات"""),
                    SentencesRow(
                      englishText: """It was the most humiliating night of his life.""",
                      kurdishText: """شەرمهێنەرترین شەوی ژیانی بوو.""",
                    ...
                    SentencesRow(
                      englishText: """To withdraw the remaining troops would have been a humiliating capitulation.""",
                      kurdishText:
