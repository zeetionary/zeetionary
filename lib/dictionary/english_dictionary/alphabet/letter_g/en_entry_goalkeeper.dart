...
class EnglishEntrygoalkeeper extends StatefulWidget {
  const EnglishEntrygoalkeeper({super.key});

  @override
  State<EnglishEntrygoalkeeper> createState() => _EnglishEntrygoalkeeperState();
}

class _EnglishEntrygoalkeeperState extends State<EnglishEntrygoalkeeper> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "goalkeeper";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""goalkeeper""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He now plays as goalkeeper for Liverpool.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The England goalkeeper played brilliantly.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """goalkeeper""",
                      // alsoEnglishWord: "also: goalkeeper",
                      britshText: """IpaUK: /ˈɡəʊlkiːpə(r)/""",
                      americanText: """IpaUS: /ˈɡəʊlkiːpər/""",
...
// With short examples define "goalkeeper", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئێستا وەک گۆڵپارێز بۆ لیڤەرپوول یاری دەکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """گۆڵپارێزی ئینگلاند ناوازە یاریی کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/_V8_f2jUfac?t=';
const double _startSecondsend = 00000000000000000000000000071;
const String _videoIdone = 'https://youtu.be/k7YVxLLIuGM?t=';
const double _startSecondsone = 000000000000000000000000000150;
const String _videoIdtwo = 'https://youtu.be/yQnZVtdXkYQ?t=';
const double _startSecondstwo = 000000000000000000000000000277;
const String _videoIdthree = 'https://youtu.be/tLUt_iZsFDY?t=';
const double _startSecondsthree = 0000000000000000000000000002025;
const String _videoIdfour = 'https://youtu.be/aMXl4Y8FBvU?t=';
const double _startSecondsfour = 000000000000000000000000000127;
const String _videoIdfive = 'https://youtu.be/mTlIcUun06w?t=';
