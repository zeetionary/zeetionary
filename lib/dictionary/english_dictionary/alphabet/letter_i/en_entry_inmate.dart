...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'Gi3HnqetpLw';
    const double startSecondsend = 578;
    const String videoIdone = 'bcdEFos9YQQ';
    const double startSecondsone = 145;
    const String videoIdtwo = 'qr4MSVxfYBE';
    const double startSecondstwo = 0;
    const String videoIdthree = 'Hw1X5oFPgro';
    const double startSecondsthree = 2019;
    const String videoIdfour = 'OIo2Ie1HwHY';
    const double startSecondsfour = 2289;
    const String videoIdfive = 'l554kV12Wuo';
