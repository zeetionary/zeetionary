...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/EjidrUoHvPs?t=';
    const double startSecondsend = 000000000000000000000000000600;
    const String videoIdone = 'https://youtu.be/tKZ2ILu_EMc?t=';
    const double startSecondsone = 000000000000000000000000000966;
    const String videoIdtwo = 'https://youtu.be/F8Thuw3qPGw?t=';
    const double startSecondstwo = 000000000000000000000000000301;
    const String videoIdthree = 'https://youtu.be/bTYV7aFC6KE?t=';
    const double startSecondsthree = 000000000000000000000000000537;
    const String videoIdfour = 'https://youtu.be/kp6F7jW5cmI?t=';
    const double startSecondsfour = 000000000000000000000000000100;
    const String videoIdfive = 'https://youtu.be/1uu9VWBgcBU?t=';
