...
class EnglishEntryfiftieth extends StatefulWidget {
  const EnglishEntryfiftieth({super.key});

  @override
  State<EnglishEntryfiftieth> createState() => _EnglishEntryfiftiethState();
}

class _EnglishEntryfiftiethState extends State<EnglishEntryfiftieth> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fiftieth""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She celebrated her fiftieth birthday.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He received a prize for his fiftieth sale.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiftieth""",
                      // alsoEnglishWord: "also: fiftieth",
                      britshText: """IpaUK: /ˈfɪftiəθ/""",
                      americanText: """IpaUS: /ˈfɪftiəθ/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """He received a prize for his fiftieth sale.""",
                      kurdishText: """خەڵاتێکی بۆ پەنجایەمین فرۆشتنی وەرگرت.""",
...
const String _videoIdend = 'https://youtu.be/1AxLzMJIgxM?t=';
const double _startSecondsend = 00000000000000000000000000081;
const String _videoIdone = 'https://youtu.be/2_W9GfQrQ2A?t=';
const double _startSecondsone = 000000000000000000000000000318;
const String _videoIdtwo = 'https://youtu.be/E3jfvncofiA?t=';
const double _startSecondstwo = 00000000000000000000000000036;
const String _videoIdthree = 'https://youtu.be/rQLBitV69Cc?t=';
const double _startSecondsthree = 000000000000000000000000000238;
const String _videoIdfour = 'https://youtu.be/3GLBEBCwqp4?t=';
const double _startSecondsfour = 00000000000000000000000000084;
const String _videoIdfive = 'https://youtu.be/hpJUeokrb_A?t=';
const double _startSecondsfive = 0000000000000000000000000002726;
