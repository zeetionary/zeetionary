...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000576;
    const String videoIdone = 'https://youtu.be/EHJNGdFll4o?t=';
    const double startSecondsone = 000000000000000000000000000691;
    const String videoIdtwo = 'https://youtu.be/gjySnrspD7E?t=';
    const double startSecondstwo = 0000000000000000000000000002496;
    const String videoIdthree = 'https://youtu.be/oI_X2cMHNe0?t=';
    const double startSecondsthree = 000000000000000000000000000964;
    const String videoIdfour = 'https://youtu.be/dl5FHmL_6rE?t=';
    const double startSecondsfour = 000000000000000000000000000151;
    const String videoIdfive = 'https://youtu.be/b4wRdoWpw0w?t=';
