...
class EnglishEntryhotblooded extends StatefulWidget {
  const EnglishEntryhotblooded({super.key});

  @override
  State<EnglishEntryhotblooded> createState() => _EnglishEntryhotbloodedState();
}

class _EnglishEntryhotbloodedState extends State<EnglishEntryhotblooded> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "hot-blooded";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hot-blooded""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hot-blooded teen acted before thinking.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/3Ohp9y-M6bg?t=';
    const double startSecondsone = 000000000000000000000000000370;
    const String videoIdtwo = 'https://youtu.be/8CviaikflJw?t=';
    const double startSecondstwo = 00000000000000000000000000012;
    const String videoIdthree = 'https://youtu.be/_JA4r-mGkzQ?t=';
    const double startSecondsthree = 0000000000000000000000000003;
    const String videoIdfour = 'https://youtu.be/e-kQIxfD8Lg?t=';
    const double startSecondsfour = 000000000000000000000000000882;
    const String videoIdfive = 'https://youtu.be/jvqcsQv_b_k?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hot-blooded""",
                      // alsoEnglishWord: "also: hot-blooded",
                      britshText: """IpaUK: /ˌhɒt ˈblʌdɪd/""",
                      americanText: """IpaUS: /ˌhɑːt ˈblʌdɪd/""",
