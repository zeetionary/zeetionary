                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "amaze"), // Find /əˈmeɪz/
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈmeɪz/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakamaze("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈmeɪz/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakamaze("en-US"),
                            ),
                          ],
                        ),
                      ],
