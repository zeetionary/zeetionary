                      ...
                      child: Column(
                        ...
                        children: [
                          const Text(
                            ...
                            """
کوردی: باش، گونجاو، لێهاتوو، لێوەشاو، بەجێ، لەبار، ئامادە، ساز، بەتوانا، زیرەک، زرینگ، مدریک، زووتێگەیشتوو، ڕێ‌تێچوو، بۆی هەیە، لەوانەیە
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "ناوێکی لێوەشاوەی هەبوو بەپێی شارەزاییەکانی.",
                                    textAlign: TextAlign
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "نووسەری بەهرەمەند باسکردنی بەجێ بەکاردێنی بۆ بەرهەمهێنانی گێڕانەوەی دەوڵەمەند کە خوێنەر تێیدا ڕۆبچێت.",
                                    textAlign: TextAlign
                                        .right, // Right-to-left direction
                                    textDirection: TextDirection.rtl,
                                  ),
...
٢. (ھاوەڵناو) ویستی سرووشتی بۆ کردنی شتێک""",
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "منداڵی بچووک خووی ئەوەیان هەیە شت بخەنە دەمیان.",
                                    textAlign: TextAlign
                                        .right, // Right-to-left direction
                                    textDirection: TextDirection.rtl,
                                  ),
                          ...
                          const Text(
                            // DOPSUM: WRITE DEFINITION IN KURDISH. COPY FOR ANOTHER DEFINITION
                            """
٣. (ھاوەڵناو) کەسێک کە توانای سرووشتی بۆ فێربوون و تێگەشتن هەیە""",
                            style: TextStyle(fontSize: 18),
                            textAlign: TextAlign.right,
                            textDirection: TextDirection.rtl,
                          ),
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "ئەمساڵ چەند خوێندکارێکی بەتایبەت زرنگمان هەیە لە پۆلدا.",
                                    textAlign: TextAlign
                                        .right, // Right-to-left direction
                                    textDirection: TextDirection.rtl,
                                  ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "https://youtu.be/LYUdnsIn5OU?t=";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "https://youtu.be/98Njh9UmkxU?t=";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "https://youtu.be/fdCDQIyXGnw?t=";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "https://youtu.be/4cQPpf1dLk8?t=";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "https://youtu.be/CWi9abJ89cE?t=";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "https://youtu.be/Rz1X0RP3Mfw?t=";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "https://youtu.be/NgcYUYCFzis?t=";
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  static String myVideoId = "https://youtu.be/8GOoBPLeS60?t=";
