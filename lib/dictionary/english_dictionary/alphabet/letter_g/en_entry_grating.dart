...
class EnglishEntrygrating extends StatefulWidget {
  const EnglishEntrygrating({super.key});

  @override
  State<EnglishEntrygrating> createState() => _EnglishEntrygratingState();
}

class _EnglishEntrygratingState extends State<EnglishEntrygrating> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grating (Derived forms: gratings)
1. A barrier that has parallel or crossed bars blocking a passage but admitting air (- grate)
 
2. A frame of iron bars to hold a fire(- grate)
 
3. Optical device consisting of a surface with many parallel grooves in it; disperses a beam of light (or other electromagnetic radiation) into its wavelengths to produce its spectrum (- diffraction grating)

- Adjective: grating
1. Unpleasantly harsh or grating in sound (- gravelly, rasping, raspy, rough, scratchy)
"a grating voice";
""",
  );

  final String keyword = "grating";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grating""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grating""",
                      // alsoEnglishWord: "also: grating",
                      britshText: """IpaUK: /ˈɡreɪtɪŋ/""",
                      americanText: """IpaUS: /ˈɡreɪtɪŋ/""",
...
کوردی: ناخۆش، قیژە و هەرای ناخۆش، کەڕکەر
"""),
// With short examples define "grating", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پارچە ئاسنێکی گەورە کە بەکاردێت بۆ بەستنی پەنجەرەیەک، دەرگایەک، چاڵێکی گەورەی مەنهۆڵ، هتد"""),
                    SentencesRow(
                      englishText:
                          """The entrance to the drain is covered by a heavy iron grating.""",
                      kurdishText:
                          """دەرچەی ئاوەڕۆکە بە پارچەیەکی قورسی ئاسنین داپۆشراوە..""",
                    ...
                    SentencesRow(
                      englishText:
                          """The complaining of his grating voice all day was driving me crazy.""",
                      kurdishText:
                          """بۆڵەبۆڵی دەنگە بێزارکەرەکەی بۆ تەواوی ڕۆژەکە شێتی دەکردم.""",
...
const double _startSecondsend = 000000000000000000000000000510;
const String _videoIdone = 'https://youtu.be/j3o6RLBehlc?t=';
const double _startSecondsone = 000000000000000000000000000452;
const String _videoIdtwo = 'https://youtu.be/Lkl9_3-jX6c?t=';
const double _startSecondstwo = 000000000000000000000000000504;
const String _videoIdthree = 'https://youtu.be/a7wC2M0b5u0?t=';
const double _startSecondsthree = 000000000000000000000000000594;
const String _videoIdfour = 'https://youtu.be/6ta_sftSfIw?t=';
const double _startSecondsfour = 000000000000000000000000000333;
