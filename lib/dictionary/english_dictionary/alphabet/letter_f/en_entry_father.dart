...
"""),
              ...
              MyExpansionTile(
                children: [
                  ...
                  SentencesRow(
                    ...
                    kurdishText: """هەرگیز باوکی خوێنیمم نەدی.""",
                  ...
                  SentencesRow(
                    englishText:
                        """Elena's brother was a surrogate father to her kids after her husband died.""",
                    kurdishText:
                        """براکەی ئێلێنا وەک باوکێکی بەخێوکار بوو بۆ منداڵەکانی (ئێلێنا) لە دوای هاوسەرەکەی (ئێلێنا) مرد.""",
                  ...
                  SentencesRow(
                    englishText:
                        """He has an ailing father and two younger brothers to support.""",
                    kurdishText:
                        """باوکێکی نەخۆش و دوو برای بچووکی هەبوو بۆ بەخێوکردن.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText: """هاوسەرێکی خراپ و باوکێکی خراپیش بوو.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """هەمیشە وەک باوکی دووەم بیرم لێ دەکردیتەوە.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """جێسی ئێستا هاوسەرگیری کردووە باوکی کوڕێکی بچووکە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """نەریتەکانی خاکی باپیرانمان هێشتا زیندوون.""",
          ...
          SentencesRow(
            englishText:
                """Henry Moore is considered to be the father of modern British sculpture.""",
            kurdishText:
                """هێنری موور بە باوکی پەیکەرتاشی سەردەمی بەریتانی دادەنرێت.""",
            onPressedBritish: () => speaksentence15("en-GB"),
            onPressedAmerican: () => speaksentence15("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٤. (ناو) مەسیحییەکان بۆ بانگکردنی خودا بەکاری دەهێنن"""),
          const DividerSentences(),
          SentencesRow(
          ...
          SentencesRow(
            ...
            kurdishText: """بانگەشەی ئەوە دەکات کە ٢٠ منداڵی هەبووبێت.""",
...
const double _startSecondstwo = 0000000000000000000000000001234;
const String _videoIdthree = 'https://youtu.be/t_0aE0VBJzQ?t=';
...
const String _videoIdfive = 'https://youtu.be/od6Zq5T57R0?t=';
