...
class EnglishEntrylipreading extends StatefulWidget {
  const EnglishEntrylipreading({super.key});

  @override
  State<EnglishEntrylipreading> createState() => _EnglishEntrylipreadingState();
}

class _EnglishEntrylipreadingState extends State<EnglishEntrylipreading> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lip-reading""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Lip-reading skills were of little use because her vocabulary was so small.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/P8A4ivmCCk4?t=211';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/mfudK2pEbIs?t=743';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/f9SA25OukyM?t=602';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/U24fKGJ2JPo?t=5748';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/C-ePy-2WLfY?t=407';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/nzMZNZCmCUg?t=13';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lip-reading""",
                      // alsoEnglishWord: "also: lip-reading",
                      britshText: """IpaUK: /ˈlɪp riːdɪŋ/""",
                      americanText: """IpaUS: /ˈlɪp riːdɪŋ/""",
...
کوردی: 
"""),
// With short examples define "lip-reading", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) تێگەشتن لەوەی کەسێک چی دەڵێت بە سەیرکردنی شێوازی جوڵانی لێوەکانی"""),
                    SentencesRow(
                      englishText: """Lip-reading skills were of little use because her vocabulary was so small.""",
                      kurdishText: """تواناکانی لێو خوێندنەوە سوودی کەمی هەبوو بەهۆی کەمی وشە زانینی.""",
