...
// Define the word "assault course" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryassaultcourse - replace speakAssaultcourse

// replace assault course - /əˈsɔːlt kɔːs/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryassaultcourse extends StatelessWidget {
  // blank divider
  EnglishEntryassaultcourse({super.key});
  // blank divider
  ...
  Future<void> speakassaultcourse(String languageCode) async {
    ...
    await flutterTts.speak("assault course");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "assault course"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈsɔːlt kɔːs/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈsɔːlt kɔːrs/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'ZCQu8nbRy7o';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'obhkcrwvkd8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'PXuRqvO-zHg';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'dArMZwqHU98';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'icPBH64oOuA';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '_LpHCElQdz0';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '5E-A28V4F80';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'qNs3K3ZEAqs';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'uo7ucNeP5mo';
