...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'KNJSkg6KqrI';
    const double startSecondsend = 48;
    const String videoIdone = 'sB5sEsFEIb8';
    const double startSecondsone = 20;
    const String videoIdtwo = 'IdTCLumZusY';
    const double startSecondstwo = 567;
    const String videoIdthree = 'amuNqpiGhYY';
    const double startSecondsthree = 324;
    const String videoIdfour = '-f8GcFCxeP8';
    const double startSecondsfour = 381;
    const String videoIdfive = '4Omkh8QFAdg';
