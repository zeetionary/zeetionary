...
class EnglishEntryfruitful extends StatefulWidget {
  const EnglishEntryfruitful({super.key});

  @override
  State<EnglishEntryfruitful> createState() => _EnglishEntryfruitfulState();
}

class _EnglishEntryfruitfulState extends State<EnglishEntryfruitful> {
  @override
  void initState() {
    super.initState();
...
2. Yielding positive results (- productive)
""",
  );

  final String keyword = "fruitful";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fruitful""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The research has proved extremely fruitful.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was a very fruitful discussion.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fruitful""",
                      // alsoEnglishWord: "also: fruitful",
                      britshText: """IpaUK: /ˈfruːtfl/""",
                      americanText: """IpaUS: /ˈfruːtfl/""",
...
// With short examples define "fruitful", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """توێژینەوەکە تەواو بەسوود بووە.""",
                    ...
                    SentencesRow(
                      englishText: """It was a very fruitful discussion.""",
                      kurdishText: """باسێکی زۆر بەسوود بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/R21IXVYnvHk?t=';
const double _startSecondsend = 000000000000000000000000000575;
const String _videoIdone = 'https://youtu.be/SDpCzJw2xm4?t=';
const double _startSecondsone = 00000000000000000000000000058;
const String _videoIdtwo = 'https://youtu.be/jwZBl6KQojM?t=';
const double _startSecondstwo = 0000000000000000000000000001584;
const String _videoIdthree = 'https://youtu.be/wGSOMKSRjkc?t=';
const double _startSecondsthree = 0000000000000000000000000001579;
const String _videoIdfour = 'https://youtu.be/pO-L9mo06CQ?t=';
const double _startSecondsfour = 000000000000000000000000000152;
const String _videoIdfive = 'https://youtu.be/U8XeKPr2Y9s?t=';
