                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈer mɑːrʃl/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '_3Z3lmErOTo';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'vOH8eWO4H1Q';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'ZBYC7QnHrQA';
  final double _startSeconds = 6080;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'hn1B7EDsVkU';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'IlaW6MQIbpY';
