...
class EnglishEntryfume extends StatefulWidget {
  const EnglishEntryfume({super.key});

  @override
  State<EnglishEntryfume> createState() => _EnglishEntryfumeState();
}

class _EnglishEntryfumeState extends State<EnglishEntryfume> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: fume (Derived forms: fumed, fuming, fumes)
1. Be mad, angry, or furious
 
2. Emit a cloud of fine particles (- smoke)
"The chimney was fuming";
 
3. Treat with fumes, expose to fumes, especially with the aim of disinfecting or eradicating pests (- fumigate, smoke)
 
4. Be wet with sweat or blood, as of one's face (- reek)

- Noun: fume (Derived forms: fumes)
1. A cloud of fine particles suspended in a gas (- smoke)

""",
  );

  final String keyword = "fume";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She sat in the car, silently fuming at the traffic jam.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Hurry up or else he'll be fuming mad.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He sat fuming over what he had just learnt.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The body of a man was found in a fume-filled car yesterday.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Sometimes exhaust fumes escape into the vehicle.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fume""",
                      // alsoEnglishWord: "also: fume",
                      britshText: """IpaUK: /fjuːm/""",
                      americanText: """IpaUS: /fjuːm/""",
...
کوردی: دووکەڵ، هەڵم، هەڵم کردن، دووکەڵ کردن
"""),
// With short examples define "fume", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە ئۆتۆمبێلەکەدا دانیشت بوو، بە بێ‌دەنگی ئاگری لێ دەباری بەدەست قەرەباڵغی هاتووچۆوە.""",
                    ...
                    SentencesRow(
                      englishText: """Hurry up or else he'll be fuming mad.""",
                      kurdishText: """زووکە ئەگەرنا لە تووڕەییدا شێت دەبێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He sat fuming over what he had just learnt.""",
                      kurdishText: """دانیشت و تووڕە بوو لەوەی کە تازە زانیبووی.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) دووکەڵ، گاز، یان شتێکی هاوشێوە کە بۆنی توندی هەیە و مەترسیدارە هەڵی بمژی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The body of a man was found in a fume-filled car yesterday.""",
                      kurdishText: """لاشەی پیاوەکە دوێنێ لە ئۆتۆمبێلێکی پڕ لە دووکەڵدا دۆزرایەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Sometimes exhaust fumes escape into the vehicle.""",
                      kurdishText: """هەندێک لە دووکەڵی ئەگسۆز دەچنە ناو پێڕۆکەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/1Gxrwh4zGPg?t=';
const double _startSecondsend = 000000000000000000000000000375;
const String _videoIdone = 'https://youtu.be/raSeaAeryWE?t=';
const double _startSecondsone = 000000000000000000000000000849;
const String _videoIdtwo = 'https://youtu.be/FSHITL5oedk?t=';
const double _startSecondstwo = 0000000000000000000000000001082;
const String _videoIdthree = 'https://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondsthree = 0000000000000000000000000001104;
const String _videoIdfour = 'https://youtu.be/E0WT1HtB-Sc?t=';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/VTzKIs19eZE?t=';
const double _startSecondsfive = 000000000000000000000000000373;
