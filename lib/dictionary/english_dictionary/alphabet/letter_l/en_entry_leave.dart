...
class EnglishEntryleave extends StatefulWidget {
  const EnglishEntryleave({super.key});

  @override
  State<EnglishEntryleave> createState() => _EnglishEntryleaveState();
}

class _EnglishEntryleaveState extends State<EnglishEntryleave> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: leave (Derived forms: leaving, left, leaves)
1. Go away from a place (- go forth, go away, off [informal])
...
4. Refrain from changing, disturbing or taking (- leave alone, leave behind, let alone, never mind)
"leave it as is"; "leave the young fawn alone";
 
5. Move out of or depart from (- exit, go out, get out)
"leave the room"; "the fugitive has left the country";
 
6. Make a possibility or provide opportunity for; permit to be attainable or cause to remain (- allow for, allow, provide)
"This leaves no room for improvement"; "leave lots of time for the trip";
 
7. Produce as a result or residue (- result, lead)
"The water left a mark on the silk dress"; "Her blood left a stain on the napkin";
 
8. Remove oneself from an association with or participation in (- depart, pull up stakes)
"She wants to leave"; "The teenager left home"; "She left her position with the Red Cross"; "He left the Senate after two terms";
 
9. Put into the care or protection of someone (- entrust)
"He left the decision to his deputy"; "leave your child in the nurse's care";
 
10. Leave or give by will after one's death (- bequeath, will)
"My grandfather left me his entire estate";
 
11. Have left or have as a remainder
"That left the four of us"; "19 minus 8 leaves 11"
 
12. Be survived by after one's death (- leave behind)
"He left six children"; "At her death, she left behind her husband and 11 cats";
 
13. Transmit (knowledge or skills) (- impart, give, pass on)
"leave your name and address here";
 
14. Leave behind unintentionally (- forget)
"I left my keys inside the car and locked the doors";

- Noun: leave (Derived forms: leaves)
1. The period of time during which you are absent from work or duty (- leave of absence)
"a ten day's leave to visit his mother";
 
2. Permission to do something
"she was granted leave to speak"
 
3. The act of departing politely (- farewell, leave-taking, parting)
"he took his leave"; "he disliked long leave-takings";
""",
  );

  final String keyword = "leave";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She left without saying goodbye.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Come on, it's time we left.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The plane leaves for Dallas at 12.35.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What time do you have to leave for work?""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I hate leaving home.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The plane leaves Heathrow at 12.35.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She left the house around 8 this morning.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You want Chris? Sorry, he's just left.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I wanted to leave but they wouldn't let me.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""My assistant is threatening to leave.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He didn't leave home until he was 30.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She left school at 16.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The Mayor left office in 2018.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Why did you leave your last job?""");
  }
  ...
  Future<void> speaksentence18(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'll never leave you.""");
  }
  ...
  Future<void> speaksentence19(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She left him for a colleague.""");
  }
  ...
  Future<void> speaksentence20(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He's been depressed since his wife left.""");
  }
  ...
  Future<void> speaksentence21(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'll have to go back—I've left my jacket.""");
  }
  ...
  Future<void> speaksentence22(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I've left my bag on the bus.""");
  }
  ...
  Future<void> speaksentence23(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You can leave your things here.""");
  }
  ...
  Future<void> speaksentence24(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Don't leave any of your belongings behind.""");
  }
  ...
  Future<void> speaksentence25(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The bomb blast left 25 people dead.""");
  }
  ...
  Future<void> speaksentence27(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We were left feeling rather disappointed.""");
  }
  ...
  Future<void> speaksentence28(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Leave the rice to cook for 20 minutes.""");
  }
  ...
  Future<void> speaksentence29(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He had left his food untouched.""");
  }
  ...
  Future<void> speaksentence30(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Is there any coffee left?""");
  }
  ...
  Future<void> speaksentence32(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You still have a few minutes left.""");
  }
  ...
  Future<void> speaksentence33(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How many tickets do you have left?""");
  }
  ...
  Future<void> speaksentence34(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Not much is left of the old town.""");
  }
  ...
  Future<void> speaksentence35(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The Romans left their mark on Britain.""");
  }
  ...
  Future<void> speaksentence37(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'm afraid you leave me no choice.""");
  }
  ...
  Future<void> speaksentence38(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He disappeared without leaving a trace.""");
  }
  ...
  Future<void> speaksentence41(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Someone left this note for you.""");
  }
  ...
  Future<void> speaksentence42(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Leave the dishes—I'll do them later.""");
  }
  ...
  Future<void> speaksentence44(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Let's leave that topic for another day.""");
  }
  ...
  Future<void> speaksentence47(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I left the best till last.""");
  }
  ...
  Future<void> speaksentence48(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You can leave the cooking to me.""");
  }
  ...
  Future<void> speaksentence50(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They didn't leave anything to chance.""");
  }
  ...
  Future<void> speaksentence51(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She left her assistant in charge.""");
  }
  ...
  Future<void> speaksentence52(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Leave it with me—I'm sure I can sort it out.""");
  }
  ...
  Future<void> speaksentence53(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She left £1 million to her daughter.""");
  }
  ...
  Future<void> speaksentence55(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She left everything to charity.""");
  }
  ...
  Future<void> speaksentence56(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She died and left me nothing.""");
  }
  ...
  Future<void> speaksentence57(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He leaves a wife and two children.""");
  }
  ...
  Future<void> speaksentence58(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Seven from ten leaves three.""");
  }
  ...
  Future<void> speaksentence59(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How much annual leave do you get?""");
  }
  ...
  Future<void> speaksentence60(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I still have some leave left this year.""");
  }
  ...
  Future<void> speaksentence61(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I still have some leave to use up.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/2vYqjQnm3WY?t=775';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/jtoq3S48Pgk?t=704';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/4InwO1SSp5o?t=73';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/p7wabPRxvII?t=58';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/6fJNyx7kI6w?t=43';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/JylK4HuKMvQ?t=118';
...
کوردی: ڕێدان، هێڵان، هێشتن، دەستووردان، ماوەپێدان، مۆڵەت(پێدان)، وچان، بەجێ‌هێشتن، مەرەخەسی
"""),
// With short examples define "leave", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) ڕۆشتن"""),
                    SentencesRow(
                      englishText: """She left without saying goodbye.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """یاریدەدەرەکەم هەڕەشەی ئەوە دەکات بچێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He didn't leave home until he was 30.""",
                      kurdishText: """ماڵەوەی جێنەهێشت تاوەکو ٣٠ ساڵ بوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She left school at 16.""",
                      kurdishText: """لە ١٦ ساڵی وازی لە قوتابخانە هێنا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Why did you leave your last job?""",
                      kurdishText: """بۆچی وازت هێنا لە کۆتا کارت؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I'll never leave you.""",
                      kurdishText: """هەرگیز جێتناهێڵم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She left him for a colleague.""",
                      kurdishText: """بۆ خاتری هاوکارێکی جێیهێشت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I've left my bag on the bus.""",
                      kurdishText: """جانتاکەمم لەسەر پاسەکە جێهێشت .""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """You can leave your things here.""",
                      kurdishText: """دەتوانیت شتەکانت لێرە جێبهێڵیت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The bomb blast left 25 people dead.""",
                      kurdishText: """تەقینەوەی بۆمبەکە ٢٥ کەسی کوشت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Leave the rice to cook for 20 minutes.""",
                      kurdishText: """بهێڵە برنجەکە بۆ ٢٠ خولەک پێبگات.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He had left his food untouched.""",
                      kurdishText: """خواردنەکەی وەک خۆی جێهێشت بوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """You still have a few minutes left.""",
                      kurdishText: """هێشتا چەند خولەکێکت ماوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """How many tickets do you have left?""",
                      kurdishText: """چەند بلیتت ماوە؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Not much is left of the old town.""",
                      kurdishText: """زۆر لە شارۆچکە کۆنەکە نەماوەتەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Someone left this note for you.""",
                      kurdishText: """کەسێک ئەم تێبینییەی بۆت جێهێشت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I left the best till last.""",
                      kurdishText: """باشترینەکانم بۆ کۆتا جێهێشت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """جێشتلێنانەکە بۆ من دابنێ.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She left her assistant in charge.""",
                      kurdishText: """یاریدەدەرەکەیی وەک بەرپرس جێهێشت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She died and left me nothing.""",
                      kurdishText: """مرد و هیچی بۆم جێنەهێشت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ژنێک و دوو منداڵی جێهێشتووە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """حەوت لە دە بچێت سێ دەمێنێتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """چەندە پشووی ساڵانە وەردەگریت؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I still have some leave to use up.""",
                      kurdishText: """هێشتا هەندێک پشووم ماوە بەکاری بێنم.""",
