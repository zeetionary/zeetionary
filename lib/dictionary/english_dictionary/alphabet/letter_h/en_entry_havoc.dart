...
class EnglishEntryhavoc extends StatefulWidget {
  const EnglishEntryhavoc({super.key});

  @override
  State<EnglishEntryhavoc> createState() => _EnglishEntryhavocState();
}

class _EnglishEntryhavocState extends State<EnglishEntryhavoc> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: havoc (Derived forms: havocs)
1. Violent and needless disturbance (- mayhem)
"wreak havoc";
""",
  );

  final String keyword = "havoc";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The floods caused havoc throughout the area.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""These insects can wreak havoc on crops.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """havoc""",
                      // alsoEnglishWord: "also: havoc",
                      britshText: """IpaUK: /ˈhævək/""",
                      americanText: """IpaUS: /ˈhævək/""",
...
کوردی: کاولی، خاپووری، وێرانی،	زیان‌لێ‌کەوتوویی، زەرەرمەندی، خەسارلێ‌کەوتن،	شێواوی، پاشاگەردانی، ناڕێکی، ئاڵۆزایی
"""),
// With short examples define "havoc", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دۆخێک کە تێیدا شتەکان تەواو زیانیان پێگەشتووە، لەناوبراون، یان شپرزەن"""),
                    SentencesRow(
                      englishText:
                          """The floods caused havoc throughout the area.""",
                      kurdishText:
                          """لافاوەکان بوون بە هۆکاری کارەسات لە هەموو ناوچەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەم مێرووانە دەکرێت کارەسات بهێنن بەسەر بەرووبوومدا.""",
...
const double _startSecondsend = 0000000000000000000000000002114;
const String _videoIdone = 'https://youtu.be/tsxmyL7TUJg?t=';
const double _startSecondsone = 0000000000000000000000000001449;
const String _videoIdtwo = 'https://youtu.be/D0x2dgpBDzc?t=';
const double _startSecondstwo = 0000000000000000000000000001007;
const String _videoIdthree = 'https://youtu.be/UoSSCUMk-7I?t=';
const double _startSecondsthree = 0000000000000000000000000001145;
const String _videoIdfour = 'https://youtu.be/sAiTuitN5b8?t=';
const double _startSecondsfour = 000000000000000000000000000185;
const String _videoIdfive = 'https://youtu.be/d_fHun8jj2g?t=';
const double _startSecondsfive = 000000000000000000000000000999;
