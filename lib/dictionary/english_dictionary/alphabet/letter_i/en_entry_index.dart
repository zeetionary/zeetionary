...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He still has all his friends' names and addresses on a card index.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The Dow Jones index fell 15 points this morning.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The number of new houses being built is a good index of a country's prosperity.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001273;
    const String videoIdone = 'https://youtu.be/6ta_sftSfIw?t=';
    const double startSecondsone = 0000000000000000000000000001463;
    const String videoIdtwo = 'https://youtu.be/KT18KJouHWg?t=';
    const double startSecondstwo = 000000000000000000000000000240;
    const String videoIdthree = 'https://youtu.be/V2ec7EE0pB8?t=';
    const double startSecondsthree = 0000000000000000000000000001589;
    const String videoIdfour = 'https://youtu.be/QxZ_iPldGtI?t=';
    const double startSecondsfour = 000000000000000000000000000269;
    const String videoIdfive = 'https://youtu.be/AxSQGOjh110?t=';
    const double startSecondsfive = 000000000000000000000000000489;
...
// With short examples define "index", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) لیستێکی ئەلفوبێی، بۆ نموونە لە کتێبێک، کە ئەوە پیشان دەدات کە لە چی لاپەڕەیەک باسی بابەتێک، کەسێک، هتد دەکرێت"""),
                    SentencesRow(
                      englishText: """Try looking up "heart disease" in the index.""",
                      kurdishText: """هەوڵ بدە بۆ نەخۆشی دڵ بگەڕێ لە پێڕستەکە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ژمارەیەک زانیاری کە لەسەر کۆمپیوتەر یان ژمارەیەک کارد هەڵگیراون بە ڕیزبەندی ئەلفوبێ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He still has all his friends' names and addresses on a card index.""",
                      kurdishText: """هێشتا ناو و ناونیشانی هەموو هاوڕێکانی لەسەر کارد ئیندێکسێک هەیە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) سیستەمێک کە ئاستی نرخ، مووچە، هتد ـی تێدایە بۆ ئەوەی بەراورد بکرێن بە کاتێکی پێشووتر"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The Dow Jones index fell 15 points this morning.""",
                      kurdishText: """ئیندێکسی داو جەونز ئەم بەیانییە ١٥ خاڵ دابەزی.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ناو) ژمارەیەک کە پێوانی شتێک دەدات بە بەراورد بە ستانداردێکی دیاریکراو"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """White bread has a high glycaemic index.""",
                      kurdishText: """نانی سپی ئیندێکسی گلایسیمیکی بەرزی هەیە.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (ناو) نیشانەیەک یان پێوەرێک کە شتێکی دیکە دەکرێت بەروارد بکرێت پێی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The number of new houses being built is a good index of a country's prosperity.""",
                      kurdishText: """ژمارەی ئەو خانووە تازانەی کە درووست دەکرێن پێوەرێکی باشە بۆ بووژانەوەی وڵاتێک.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٦. (ناو) لیستی تۆمارەکانی فایلی کۆمپیوتەر لەگەڵ زانیاریی ئەوەی لە کوێدا هەڵگیراون"""),
                    const DividerSentences(),
                    SentencesRow(
