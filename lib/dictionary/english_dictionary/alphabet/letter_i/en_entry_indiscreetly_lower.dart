...
class EnglishEntryindiscreetly extends StatefulWidget {
  const EnglishEntryindiscreetly({super.key});

  @override
  State<EnglishEntryindiscreetly> createState() =>
      _EnglishEntryindiscreetlyState();
}

class _EnglishEntryindiscreetlyState extends State<EnglishEntryindiscreetly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: indiscreetly
1. Without discretion, wisdom or self-restraint
"she inquired indiscreetly after the state of his health"
""",
  );

  final String keyword = "indiscreetly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indiscreetly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """He indiscreetly revealed his guilt and his brother’s involvement.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/iDVxOg_R0rc?t=';
    const double startSecondsend = 00000000000000000000000000014515;
    const String videoIdone = 'https://youtu.be/ogivHp-iBSk?t=';
    const double startSecondsone = 0000000000000000000000000003859;
    const String videoIdtwo = 'https://youtu.be/JvuCH4YxHQY?t=';
    const double startSecondstwo = 000000000000000000000000000154;
    const String videoIdthree = 'https://youtu.be/FNHwxyS_oEk?t=';
    const double startSecondsthree = 000000000000000000000000000260;
    const String videoIdfour = 'https://youtu.be/NX791fqpv5Q?t=';
    const double startSecondsfour = 000000000000000000000000000533;
    const String videoIdfive = 'https://youtu.be/URbFDtxUj7M?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indiscreetly""",
                      // alsoEnglishWord: "also: indiscreetly",
                      britshText: """IpaUK: /ˌɪndɪˈskriːtli/""",
                      americanText: """IpaUS: /ˌɪndɪˈskriːtli/""",
...
// کوردی: دەم‌بڵاوانە، سەرچڵانە
// """),
// With short examples define "indiscreetly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە نهێنییەک ئاشکرا دەکات کە دەکرێت شەرمهێنەر بێت"""),
                    SentencesRow(
                      englishText:
                          """He indiscreetly revealed his guilt and his brother’s involvement.""",
                      kurdishText:
                          """نائاگایانە تاوانەکەی خۆی و تێوەگلانی براکەی ئاشکرا کرد.""",
