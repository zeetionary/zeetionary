...
class EnglishEntryfidget extends StatefulWidget {
  const EnglishEntryfidget({super.key});

  @override
  State<EnglishEntryfidget> createState() => _EnglishEntryfidgetState();
}

class _EnglishEntryfidgetState extends State<EnglishEntryfidget> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Sit still and stop fidgeting!""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She fidgeted with her keys as she talked.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""You’re such a fidget!""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fidget""",
                      // alsoEnglishWord: "also: fidget",
                      britshText: """IpaUK: /ˈfɪdʒɪt/""",
                      americanText: """IpaUS: /ˈfɪdʒɪt/""",
...
// With short examples define "fidget", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پەلەفرتێی بوو بە کلیلەکانی کە قسەی دەکرد.""",
...
const double _startSecondsend = 000000000000000000000000000825;
const String _videoIdone = 'https://youtu.be/Zad6v8ZHzdg?t=';
const double _startSecondsone = 000000000000000000000000000562;
const String _videoIdtwo = 'https://youtu.be/ciV5CpsnDb4?t=';
const double _startSecondstwo = 0000000000000000000000000001233;
const String _videoIdthree = 'https://youtu.be/XXhc5UTxv5I?t=';
const double _startSecondsthree = 0000000000000000000000000001650;
const String _videoIdfour = 'https://youtu.be/Qo3YV1ZKDHs?t=';
const double _startSecondsfour = 000000000000000000000000000198;
const String _videoIdfive = 'https://youtu.be/JoNj0KDuDR8?t=';
