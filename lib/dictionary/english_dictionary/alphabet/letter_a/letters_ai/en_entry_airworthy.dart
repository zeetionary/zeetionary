...
class EnglishEntryairworthy extends StatelessWidget {
  EnglishEntryairworthy({super.key});
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈeəwɜːði/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakairworthy("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈerwɜːrði/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakairworthy("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'p2ou0oq9Bz4';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'h6vERdmuV5U';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'NAxb5O5a2nQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'CfDJpFJ9Cw8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'UnseG8_o_uU';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'wEPeoVS7J7k';
