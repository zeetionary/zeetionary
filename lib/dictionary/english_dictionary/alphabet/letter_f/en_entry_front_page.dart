...
class EnglishEntryfrontpage extends StatefulWidget {
  const EnglishEntryfrontpage({super.key});

  @override
  State<EnglishEntryfrontpage> createState() => _EnglishEntryfrontpageState();
}

class _EnglishEntryfrontpageState extends State<EnglishEntryfrontpage> {
  @override
  void initState() {
    super.initState();
...
1. ​appearing on the front page of a newspaper, where the most important news is printed
""",
  );

  final String keyword = "front-page";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""front-page""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The divorce made front-page news.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """front-page""",
                      // alsoEnglishWord: "also: front-page",
                      britshText: """IpaUK: /ˈfrʌnt peɪdʒ/""",
                      americanText: """IpaUS: /ˈfrʌnt peɪdʒ/""",
...
کوردی: 
"""),
// With short examples define "front-page", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە لەسەر بەرگی ڕۆژنامەیەک دەردەکەوێت"""),
                    SentencesRow(
                      englishText: """The divorce made front-page news.""",
                      kurdishText:
                          """جیابوونەوەکە بوو بە هەواڵی سەرپەڕەی ڕۆژنامەکان.""",
...
const String _videoIdtwo = 'https://youtu.be/eOpyJciiCAY?t=';
const double _startSecondstwo = 000000000000000000000000000303;
const String _videoIdthree = 'https://youtu.be/vbhFubiFiqg?t=';
const double _startSecondsthree = 0000000000000000000000000002193;
const String _videoIdfour = 'https://youtu.be/gFXrnkcFbds?t=';
const double _startSecondsfour = 000000000000000000000000000252;
const String _videoIdfive = 'https://youtu.be/gX1nM_p0m0I?t=';
