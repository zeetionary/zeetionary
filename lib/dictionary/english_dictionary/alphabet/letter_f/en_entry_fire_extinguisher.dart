...
class EnglishEntryfireextinguisher extends StatefulWidget {
  const EnglishEntryfireextinguisher({super.key});

  @override
  State<EnglishEntryfireextinguisher> createState() =>
      _EnglishEntryfireextinguisherState();
}

class _EnglishEntryfireextinguisherState
    extends State<EnglishEntryfireextinguisher> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fire extinguisher (Derived forms: fire extinguishers)
1. A manually operated device for extinguishing small fires (= extinguisher, asphyxiator)
""",
  );

  final String keyword = "fire extinguisher";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fire extinguisher""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """She grabbed the fire extinguisher to put out the kitchen fire.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: fire extinguisher",
                      britshText: """IpaUK: /ˈfaɪər ɪkstɪŋɡwɪʃə(r)/""",
                      americanText: """IpaUS: /ˈfaɪər ɪkstɪŋɡwɪʃər/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئاگرکوژێنە؛ قەواغێک کە ئاو یان مادەی کیمیایی تێدایە و بەکاردێت بۆ کوژاندنەوەی ئاگری بچووک"""),
                    SentencesRow(
                      englishText:
                          """She grabbed the fire extinguisher to put out the kitchen fire.""",
                      kurdishText:
                          """ئاگرکوژێنەکەی هەڵگرت بۆ کوژاندنەوەی ئاگری چێشتخانەکە.""",
...
const double _startSecondsend = 0000000000000000000000000001895;
const String _videoIdone = 'https://youtu.be/f7QWMUCMYOE?t=';
const double _startSecondsone = 000000000000000000000000000317;
const String _videoIdtwo = 'https://youtu.be/LfR4QfmwTAc?t=';
const double _startSecondstwo = 000000000000000000000000000169;
const String _videoIdthree = 'https://youtu.be/Bbi0kEaTgio?t=';
const double _startSecondsthree = 0000000000000000000000000001050;
const String _videoIdfour = 'https://youtu.be/l2FuvKTyRMQ?t=';
const double _startSecondsfour = 000000000000000000000000000163;
const String _videoIdfive = 'https://youtu.be/UkZH3a79tOM?t=';
const double _startSecondsfive = 0000000000000000000000000001227;
