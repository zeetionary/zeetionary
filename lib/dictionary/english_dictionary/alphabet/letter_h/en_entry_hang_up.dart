...
class EnglishEntryhangup extends StatefulWidget {
  const EnglishEntryhangup({super.key});

  @override
  State<EnglishEntryhangup> createState() => _EnglishEntryhangupState();
}

class _EnglishEntryhangupState extends State<EnglishEntryhangup> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hang-up (Derived forms: hangs up, hang-ups)
1. An emotional preoccupation
 
2. An unforeseen obstacle (- hitch, rub, snag)
""",
  );

  final String keyword = "hang-up";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hang-up""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He's got a real hang-up about his height.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Everyone has their own hangups.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It is best to fix hangups as soon as they occur.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hang-up""",
                      // alsoEnglishWord: "also: hang-up",
                      britshText: """IpaUK: /ˈhæŋ ʌp/""",
                      americanText: """IpaUS: /ˈhæŋ ʌp/""",
...
// With short examples define "hang-up", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کێشەیەکی دەرەوونی کە شەرمەزارت دەکات لەسەر شتێک"""),
                    SentencesRow(
                      englishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """واباشە گرفتەکان چارەسەر بکرێن کە ڕوودەدەن.""",
