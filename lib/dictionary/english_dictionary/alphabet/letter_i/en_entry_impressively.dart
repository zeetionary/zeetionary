...
class EnglishEntryimpressively extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impressively""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'aTDG16Mh2_w';
    const double startSecondsone = 396;
    const String videoIdtwo = 'hQT7PN4Tzsg';
    const double startSecondstwo = 6;
    const String videoIdthree = '6ta_sftSfIw';
    const double startSecondsthree = 136;
    const String videoIdfour = 'WoNAt9bQZtY';
    const double startSecondsfour = 117;
    const String videoIdfive = 'GJ9_7L873m8';
