...
class EnglishEntryfoothold extends StatefulWidget {
  const EnglishEntryfoothold({super.key});

  @override
  State<EnglishEntryfoothold> createState() => _EnglishEntryfootholdState();
}

class _EnglishEntryfootholdState extends State<EnglishEntryfoothold> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foothold (Derived forms: footholds)
1. An area in hostile territory that has been captured and is held awaiting further troops and supplies (= bridgehead)
"the only foothold left for British troops in Europe was Gibraltar";
 
2. A place providing support for the foot in standing or climbing (= footing)
 
3. An initial accomplishment that opens the way for further developments (= beachhead)
"they are presently attempting to gain a foothold in the Russian market";
""",
  );

  final String keyword = "foothold";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foothold""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She scrabbled for a foothold on the steep grassy bank.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The company is eager to gain a foothold in Europe.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foothold""",
                      // alsoEnglishWord: "also: foothold",
                      britshText: """IpaUK: /ˈfʊthəʊld/""",
                      americanText: """IpaUS: /ˈfʊthəʊld/""",
...
کوردی: جێ‌پێ، هەنگاوگە، جێگای پێ لەسەرنان،	(خوازە) جێگای لێ‌ڕابینراو، هەل‌ومەرجی باش
"""),
// With short examples define "foothold", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لەسەر لێژاییە گژوگیادارەکە بۆ دۆزینەوەی جێ‌پێیەک گەڕا..""",
                      englishNote:
                          "She scrabbled for a foothold on the steep grassy bank.",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) خاڵێک یان پێگەیەکی بەهێز لە کار، بازرگانی، هتد کە لێیەوە دەکرێت بەرەوپێشچوون ئەنجام بدرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The company is eager to gain a foothold in Europe.""",
                      kurdishText:
                          """کۆمپانیاکە بەپەرۆشە بۆ ئەوەی کە بناغەیەک لە ئەوڕووپا دابنێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Jt5WpKRPIlE?t=';
const double _startSecondsend = 0000000000000000000000000001725;
const String _videoIdone = 'https://youtu.be/HH3C1pYXCl0?t=';
const double _startSecondsone = 000000000000000000000000000730;
const String _videoIdtwo = 'https://youtu.be/YU2v38hRRbg?t=';
const double _startSecondstwo = 000000000000000000000000000487;
const String _videoIdthree = 'https://youtu.be/qiuFj-R7Et0?t=';
const double _startSecondsthree = 000000000000000000000000000367;
const String _videoIdfour = 'https://youtu.be/hG0ROjzgEA0?t=';
const double _startSecondsfour = 0000000000000000000000000001062;
const String _videoIdfive = 'https://youtu.be/nWv2OY01fOI?t=';
const double _startSecondsfive = 00000000000000000000000000095;
