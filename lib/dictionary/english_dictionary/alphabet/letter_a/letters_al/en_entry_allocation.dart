...
class EnglishEntryallocation extends StatelessWidget {
  ...
  Future<void> speakAllocation359(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "The allocation of space in this office is unusual."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "allocation", // DOPSUM: CHANGE WORD ENTRY - Find /ˌæləˈkeɪʃn/
                              style: TextStyle(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'eVNnaNmEsVI';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'nmMUUuXhk2A';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'mo4QBrV8pRM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'z4loh3LGObU';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'ul1cGarS23M';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'd5e_YJGXXFU';
