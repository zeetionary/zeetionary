...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'Z83I2tz5UzM';
    const double startSecondstwo = 175;
    const String videoIdthree = 'xLP8nXAcRwA';
    const double startSecondsthree = 25;
    const String videoIdfour = 'Z4wxVH3ICg0';
    const double startSecondsfour = 2043;
    const String videoIdfive = 'B5HORANmzHw';
