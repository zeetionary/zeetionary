...
class EnglishEntryevocative extends StatefulWidget {
  const EnglishEntryevocative({super.key});

  @override
  State<EnglishEntryevocative> createState() => _EnglishEntryevocativeState();
}

class _EnglishEntryevocativeState extends State<EnglishEntryevocative> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evocative""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evocative""",
                      // alsoEnglishWord: "also: evocative",
                      britshText: """IpaUK: /ɪˈvɒkətɪv/""",
                      americanText: """IpaUS: /ɪˈvɑːkətɪv/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "evocative";
...
کوردی: بیرخەرەوە، بەبیرهێنەرەوە، زیندووکەرەوە،	بانگ‌کار،	ورووژێنەر، بزوێنەر
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە وات لێ دەکات بیر بکەیتەوە لە وێنە یان هەستێکی بەهێز بەشێوەیەکی جوان، یان شتێکی وەهات بیر دەخاتەوە"""),
          SentencesRow(
            englishText:
                """Her new book is wonderfully evocative of village life.""",
            kurdishText: """کتێبە تازەکەی بە جوانی دەربڕی ژیانی گوندە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: evocative
1. Serving to bring to mind (= redolent, remindful, reminiscent, resonant)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/CjiKlLE3NuI?t=';
const double _startSecondsend = 000000000000000000000000000000; // 306;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/-I6YmMAThZ8?t=';
const double _startSecondsone = 00000000000000000000000000000; // 776;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/xPGdOXstSyk?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1217;
const String _videoIdthree = 'VIDEOhttps://youtu.be/6yVpvRLvXm0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 470;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/tILIeNjbH1E?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 95;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/x-QcbOphxYs?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 310;
