...
class EnglishEntryfloorshow extends StatefulWidget {
  const EnglishEntryfloorshow({super.key});

  @override
  State<EnglishEntryfloorshow> createState() => _EnglishEntryfloorshowState();
}

class _EnglishEntryfloorshowState extends State<EnglishEntryfloorshow> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: floor show (Derived forms: floorshows, floor shows)
1. A series of acts at a night club (= cabaret, floorshow)
""",
  );

  final String keyword = "floor show";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""floor show""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """floor show""",
                      // alsoEnglishWord: "also: floor show",
                      britshText: """IpaUK: /ˈflɔː ʃəʊ/""",
                      americanText: """IpaUS: /ˈflɔːr ʃəʊ/""",
...
// With short examples define "floor show", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ژمارەیەک نمایشی گۆرانیبێژان، سەماکاران، هتد لە چێشتخانەیەک، یانەیەک، لەسەر زەوی، نەک لەسەر ستەیج"""),
//                     SentencesRow(
//                       englishText:
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/5kuPCeheMSM?t=';
const double _startSecondsend = 00000000000000000000000000016;
const String _videoIdone = 'https://youtu.be/CnW_iU33cz8?t=';
const double _startSecondsone = 000000000000000000000000000220;
const String _videoIdtwo = 'https://youtu.be/hRm1-jBoCcM?t=';
const double _startSecondstwo = 000000000000000000000000000625;
const String _videoIdthree = 'https://youtu.be/X_Z9JsFP22k?t=';
const double _startSecondsthree = 000000000000000000000000000755;
const String _videoIdfour = 'https://youtu.be/JOcmMn87Njs?t=';
const double _startSecondsfour = 000000000000000000000000000188;
const String _videoIdfive = 'https://youtu.be/cRfY5vFaZTk?t=';
