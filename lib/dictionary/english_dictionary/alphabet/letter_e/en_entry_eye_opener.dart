...
class EnglishEntryeyeopener extends StatefulWidget {
  const EnglishEntryeyeopener({super.key});

  @override
  State<EnglishEntryeyeopener> createState() => _EnglishEntryeyeopenerState();
}

class _EnglishEntryeyeopenerState extends State<EnglishEntryeyeopener> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""eye-opener""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """eye-opener""",
                      // alsoEnglishWord: "also: eye-opener",
                      britshText: """IpaUK: /ˈaɪ əʊpənə(r)/""",
                      americanText: """IpaUS: /ˈaɪ əʊəpənər/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "eye-opener";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Travelling around India was a real eye-opener for me.""");
  }
...
// With short examples define "eye-opener", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
const double _startSecondsend = 000000000000000000000000000552;
const String _videoIdone = 'https://youtu.be/gKinPCgOMxE?t=';
const double _startSecondsone = 00000000000000000000000000043;
const String _videoIdtwo = 'https://youtu.be/OapuLyWTvjQ?t=';
const double _startSecondstwo = 000000000000000000000000000179;
const String _videoIdthree = 'https://youtu.be/330Ufcaj1zA?t=';
const double _startSecondsthree = 000000000000000000000000000805;
const String _videoIdfour = 'https://youtu.be/aInpfPQRnyc?t=';
const double _startSecondsfour = 000000000000000000000000000255;
const String _videoIdfive = 'https://youtu.be/As7ADZTOaCM?t=';
