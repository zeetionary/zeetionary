...
class EnglishEntrylook extends StatefulWidget {
  const EnglishEntrylook({super.key});

  @override
  State<EnglishEntrylook> createState() => _EnglishEntrylookState();
}

class _EnglishEntrylookState extends State<EnglishEntrylook> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylook look
WORD_WEB look look look
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "look";
...
کوردی: 
"""),
// With short examples define "look", please follow LX instructions
