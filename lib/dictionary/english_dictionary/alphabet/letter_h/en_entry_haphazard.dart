...
class EnglishEntryhaphazard extends StatefulWidget {
  const EnglishEntryhaphazard({super.key});

  @override
  State<EnglishEntryhaphazard> createState() => _EnglishEntryhaphazardState();
}

class _EnglishEntryhaphazardState extends State<EnglishEntryhaphazard> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: haphazard
1. Dependent upon or characterized by chance (- hit-or-miss)
"a haphazard plan of action";
 
2. Marked by great carelessness (- slapdash, slipshod, sloppy)
"a most haphazard system of record keeping";

- Adverb: haphazard
1. Without care; in a slapdash manner (- haphazardly)
...
""",
  ...
  final String keyword = "haphazard";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""haphazard""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The books had been piled on the shelves in a haphazard fashion.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The government's approach to the problem was haphazard.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """haphazard""",
                      // alsoEnglishWord: "also: haphazard",
                      britshText: """IpaUK: /hæpˈhæzəd/""",
                      americanText: """IpaUS: /hæpˈhæzərd/""",
...
// With short examples define "haphazard", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The books had been piled on the shelves in a haphazard fashion.""",
                      kurdishText: """کتێبەکان لەسەر ڕەفەکان بە شێوەیەکی شپرزانە دانرابوون.""",
                    ...
                    SentencesRow(
                      englishText: """The government's approach to the problem was haphazard.""",
                      kurdishText: """مامەڵەی حکومەت لەگەڵ کێشەکە شپرزانە بوو.""",
