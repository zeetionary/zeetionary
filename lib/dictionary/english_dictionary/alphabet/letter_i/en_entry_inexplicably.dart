...
class EnglishEntryinexplicably extends StatefulWidget {
  const EnglishEntryinexplicably({super.key});

  @override
  State<EnglishEntryinexplicably> createState() =>
      _EnglishEntryinexplicablyState();
}

class _EnglishEntryinexplicablyState extends State<EnglishEntryinexplicably> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: inexplicably
1. In a manner differing from the usual or expected (- curiously, oddly, peculiarly, strangely)
"The rain has increased in volume, and inexplicably, so has traffic";
 
2. In an unexplained or unexplainable manner
""",
  );

  final String keyword = "inexplicably";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inexplicably""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She inexplicably withdrew the offer.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/S3ksC_8jGuc?t=';
    const double startSecondsend = 000000000000000000000000000562;
    const String videoIdone = 'https://youtu.be/Mx8JkGHaGUI?t=';
    const double startSecondsone = 0000000000000000000000000002036;
    const String videoIdtwo = 'https://youtu.be/tExo3ovEBWQ?t=';
    const double startSecondstwo = 000000000000000000000000000365;
    const String videoIdthree = 'https://youtu.be/UvIkojfQDxA?t=';
    const double startSecondsthree = 000000000000000000000000000373;
    const String videoIdfour = 'https://youtu.be/SjeS6gtPq8E?t=';
    const double startSecondsfour = 000000000000000000000000000309;
    const String videoIdfive = 'https://youtu.be/fU-8Rg4CgeI?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inexplicably""",
                      // alsoEnglishWord: "also: inexplicably",
                      britshText: """IpaUK: /ˌɪnɪkˈsplɪkəbli/""",
                      americanText: """IpaUS: /ˌɪnɪkˈsplɪkəbli/""",
...
کوردی: 
"""),
// With short examples define "inexplicably", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە جێگای تێگەشتن یان ڕوونکردنەوە نییە"""),
                    SentencesRow(
                      englishText: """She inexplicably withdrew the offer.""",
                      kurdishText:
                          """بە شێوەیەکی سەیر پەشیمان بوویەوە لە پێشنیارەکەی .""",
