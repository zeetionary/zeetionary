...
class EnglishEntryenthuse extends StatefulWidget {
  const EnglishEntryenthuse({super.key});

  @override
  State<EnglishEntryenthuse> createState() => _EnglishEntryenthuseState();
}

class _EnglishEntryenthuseState extends State<EnglishEntryenthuse> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enthuse""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enthuse""",
                      // alsoEnglishWord: "also: enthuse",
                      britshText: """IpaUK: /ɪnˈθjuːz/""",
                      americanText: """IpaUS: /ɪnˈθuːz/""",
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) قسەکردن بە جۆش‌وخرۆشی و ورووژاوی سەبارەت بە شتێک"""),
          SentencesRow(
            englishText:
                """The article enthused about the benefits that the new system would bring.""",
            kurdishText:
                """وتارەکە پیاهەڵدانی بوو بەو سوودانەی کە سیستەمە تازەکە دەیهێنا .""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """هەموو ئەوانەی ئامادە بوون سەرسام بوون بە بیرۆکەکە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: enthuse (Derived forms: enthuses, enthused, enthusing)
1. Cause to feel enthusiasm
 
2. Utter with enthusiasm
 
3. Praise enthusiastically (= rave, gush, kvell [N. Amer, informal])
""",
  );
...
const String _videoIdend = 'https://youtu.be/XkQtWI3SO_o?t=';
const double _startSecondsend = 454;
const String _videoIdone = 'https://youtu.be/dJhgDZn84Ag?t=';
const double _startSecondsone = 76;
const String _videoIdtwo = 'https://youtu.be/GITeFJSKSPI?t=';
const double _startSecondstwo = 280;
const String _videoIdthree = 'https://youtu.be/Q0UGYWsL59U?t=';
const double _startSecondsthree = 118;
const String _videoIdfour = 'https://youtu.be/eG_aRPy1KVE?t=';
const double _startSecondsfour = 579;
const String _videoIdfive = 'https://youtu.be/NEHE8eiC0Zk?t=';
const double _startSecondsfive = 566;
const String _videoIdsix = 'https://youtu.be/7BMqCvbCKFE?t=';
