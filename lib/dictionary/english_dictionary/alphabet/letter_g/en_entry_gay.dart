...
class EnglishEntrygay extends StatefulWidget {
  const EnglishEntrygay({super.key});

  @override
  State<EnglishEntrygay> createState() => _EnglishEntrygayState();
}

class _EnglishEntrygayState extends State<EnglishEntrygay> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I didn't know he was gay.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He is openly gay.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They danced all night at the gay club.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She felt lighthearted and gay.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The streets were gay and full of people.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gay""",
                      // alsoEnglishWord: "also: gay",
                      britshText: """IpaUK: /ɡeɪ/""",
                      americanText: """IpaUS: /ɡeɪ/""",
...
// With short examples define "gay", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەواوی شەوەکە لە یانەکەی کەسانی گەی سەمایان کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """شەقامەکان درەوشاوە و پڕ لە خەڵکی بوون.""",
...
const double _startSecondsend = 00000000000000000000000000078;
const String _videoIdone = 'https://youtu.be/D9od6OlaPgc?t=';
const double _startSecondsone = 000000000000000000000000000206;
const String _videoIdtwo = 'https://youtu.be/xdgOrKkxKXc?t=';
const double _startSecondstwo = 00000000000000000000000000020;
const String _videoIdthree = 'https://youtu.be/Jk7NYEhai0g?t=';
const double _startSecondsthree = 000000000000000000000000000473;
const String _videoIdfour = 'https://youtu.be/2-bQnjgUiUs?t=';
const double _startSecondsfour = 000000000000000000000000000264;
const String _videoIdfive = 'https://youtu.be/75UUiYUx1Fo?t=';
