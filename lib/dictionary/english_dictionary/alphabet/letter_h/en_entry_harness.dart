...
class EnglishEntryharness extends StatefulWidget {
  const EnglishEntryharness({super.key});

  @override
  State<EnglishEntryharness> createState() => _EnglishEntryharnessState();
}

class _EnglishEntryharnessState extends State<EnglishEntryharness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: harness (Derived forms: harnesses)
...
- Verb: harness (Derived forms: harnessing, harnesses, harnessed)
1. (animal husbandry) put a harness (- tackle)
"harness the horse";
 
2. Exploit the power of
"harness natural forces and resources"
 
3. Control and direct with or as if by reins (- rein in, draw rein, rein)
"harness a horse";
 
4. Keep in check (- rule, rein)
"harness one's temper";
""",
  );

  final String keyword = "harness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""harness""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We harnessed two ponies to the cart.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""In some areas, the poor feel harnessed to their jobs.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They are attempting to harness the power of the sun.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harness""",
                      // alsoEnglishWord: "also: harness",
                      britshText: """IpaUK: /ˈhɑːnɪs/""",
                      americanText: """IpaUS: /ˈhɑːrnɪs/""",
...
// کوردی:
// """),
// With short examples define "harness", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پارچە جلێک کە لە سەر و ناوقەدی ئاژەڵێک، بە تایبەتی ئەسپ دەبەسترێت، بۆ ئەوەی کۆنترۆڵ بکرێت و عەرابەی لێ ببەسترێت"""),
                    SentencesRow(
                      englishText:
                          """The sight of horses in harness hauling timber was common a hundred years ago.""",
                      kurdishText:
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ژمارەیەک قایش کە لە کەسێک دەبەسترێت بۆ ئەوەی شتێکی پێوە ببەسترێت"""),
                    SentencesRow(
                      englishText:
                          """She fastened the safety harness tightly around her waist before starting the descent.""",
                      kurdishText:
                          """کەمەربەندە سەلامەتییەکەی توند لە خۆی بەست پێش ئەوەی دەست بە چوونە خوارەوە بکات.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (کردار) بەستنی کەمەربەند لە ئاژەڵ"""),
                    SentencesRow(
                      englishText: """We harnessed two ponies to the cart.""",
                      kurdishText: """دوو بەچکە ئەسپمان بەست بە عەرابەکەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """(خوازراوی) لە هەندێک ناوچە خەڵکی هەست دەکەن گرێدراون بە کارەکانیانەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (کردار) کۆنترۆڵ و بەکارهێنانی هێزی شتێک بۆ درووستکردنی وزە یان بەدەستهێنانی شتێک"""),
                    SentencesRow(
                      englishText:
                          """We must harness the skill and creativity of our workforce.""",
                      kurdishText:
                          """دەبێت شارەزایی و داهێنەرێتی دەستی کارمان بەکاربهێنین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەوڵ دەدەن وزەی خۆر بەکاربهێنن.""",
...
const String _videoIdfour = 'https://youtu.be/pFmtmO2cnlg?t=';
