...
class EnglishEntrycram extends StatelessWidget {
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakcrams1(String languageCode) async {
    ...
    await flutterTts.speak(
        "// speakcrams111111111111111111111111111111111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcrams2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcrams200"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcrams3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcrams300"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcrams4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcrams400"); // DOPSUM: CHANGE TEXT
  }
