...
class EnglishEntrylaunder extends StatefulWidget {
  const EnglishEntrylaunder({super.key});

  @override
  State<EnglishEntrylaunder> createState() => _EnglishEntrylaunderState();
}

class _EnglishEntrylaunderState extends State<EnglishEntrylaunder> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: launder (Derived forms: laundered, laundering, launders)
1. Cleanse with a cleaning agent, such as soap, and water (- wash)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""launder""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Freshly laundered sheets feel soft and cozy at night.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Most of the stolen money was laundered through Swiss bank accounts.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/mS9CFBlLOcg?t=821';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/fhn8JrO8xyA?t=850';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/WV0OBRJKeYA?t=349';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/Gi3HnqetpLw?t=323';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/HZryl5nJr00?t=1448';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/ove6sd_mao8?t=467';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """launder""",
                      // alsoEnglishWord: "also: launder",
                      britshText: """IpaUK: /ˈlɔːndə(r)/""",
                      americanText: """IpaUS: /ˈlɔːndər/""",
...
کوردی: 
"""),
// With short examples define "launder", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) ششت، وشککردنەوە، و ئوتووکردنی جل، هتد"""),
                    SentencesRow(
                      englishText: """Freshly laundered sheets feel soft and cozy at night.""",
                      kurdishText: """پێخەفی تازە شۆراو نەرم و خۆش دەردەکەوێت لە شەودا.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) پارەیەک کە بە نایاسایی خراوەتەوە ناو هەژماری بانکی بیانی یان بازرگانی یاسایی بۆ ئەوەی وەها بکرێت سەخت بێت خەڵکی سەرچاوەکەی بزانن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Most of the stolen money was laundered through Swiss bank accounts.""",
                      kurdishText: """زۆرینەی پارە دزراوەکە سپی کرانەوە لە هەژماری بانکە سویسراییەکان.""",
