...
class EnglishEntryadaptable extends StatelessWidget {
  EnglishEntryadaptable({super.key});
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "adaptable"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈdæptəbl/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakadaptable("en-GB"),
                            ),
                          ],
                        ),
                        Row(
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'T2k80X9kbsM';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '9KppNMmA2V4';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '01iofNdVGa4';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'zf8pHwce9s8';
  final double _startSeconds = 3310;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'X_wodL64e2M';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'iMvtHqLmEkI';
  final double _startSeconds = 4750;
