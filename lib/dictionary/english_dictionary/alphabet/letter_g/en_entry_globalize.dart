...
class EnglishEntryglobalize extends StatefulWidget {
  const EnglishEntryglobalize({super.key});

  @override
  State<EnglishEntryglobalize> createState() => _EnglishEntryglobalizeState();
}

class _EnglishEntryglobalizeState extends State<EnglishEntryglobalize> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "globalize";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""globalize""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Satellite broadcasting is helping to globalize television.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """globalize""",
                      // alsoEnglishWord: "also: globalize",
                      britshText: """IpaUK: /ˈɡləʊbəlaɪz/""",
                      americanText: """IpaUS: /ˈɡləʊbəlaɪz/""",
...
// With short examples define "globalize", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) بڵاوبوونەوە بە جیهان"""),
                    SentencesRow(
                      englishText: """Satellite broadcasting is helping to globalize television.""",
                      kurdishText: """پەخشی سەتەلایت یارمەتیدەرە بۆ بەجیهانیبوونی تەلەفیزیۆن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/99i8Sb1krDQ?t=';
const double _startSecondsend = 00000000000000000000000000074;
const String _videoIdone = 'https://youtu.be/TIO_S4BBfM4?t=';
const double _startSecondsone = 000000000000000000000000000739;
const String _videoIdtwo = 'https://youtu.be/GqMSWuSeDPA?t=';
const double _startSecondstwo = 000000000000000000000000000854;
const String _videoIdthree = 'https://youtu.be/xl32J4TCS0E?t=';
const double _startSecondsthree = 000000000000000000000000000272;
const String _videoIdfour = 'https://youtu.be/UNbyT7wPwk4?t=';
const double _startSecondsfour = 000000000000000000000000000906;
const String _videoIdfive = 'https://youtu.be/zoA2ZaYLs_g?t=';
