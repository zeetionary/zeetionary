...
class EnglishEntryimpoverish extends StatefulWidget {
  const EnglishEntryimpoverish({super.key});

  @override
  State<EnglishEntryimpoverish> createState() => _EnglishEntryimpoverishState();
}

class _EnglishEntryimpoverishState extends State<EnglishEntryimpoverish> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: impoverish (Derived forms: impoverished, impoverishes, impoverishing)
1. Make poor
 
2. Become poor (- immiserise [Brit], immiserize, immiserate)
""",
  );

  final String keyword = "impoverish";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impoverish""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Intensive cultivation has impoverished the soil.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/KL8CIZej19o?t=';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/j4kI2h3iotA?t=';
    const double startSecondstwo = 0000000000000000000000000001008;
    const String videoIdthree = 'https://youtu.be/1ZKBaRsP1gY?t=';
    const double startSecondsthree = 000000000000000000000000000561;
    const String videoIdfour = 'https://youtu.be/H5W1tpG9cL0?t=';
    const double startSecondsfour = 000000000000000000000000000188;
    const String videoIdfive = 'https://youtu.be/eXaIpTj3vOs?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """impoverish""",
                      // alsoEnglishWord: "also: impoverish",
                      britshText: """IpaUK: /ɪmˈpɒvərɪʃ/""",
                      americanText: """IpaUS: /ɪmˈpɑːvərɪʃ/""",
...
کوردی: فەقیر کردن، بێ پارە کردن، هەژار کردن، بێ هێز کردن
"""),
// With short examples define "impoverish", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) هەژارکردن"""),
                    SentencesRow(
                      englishText:
                          """These changes are likely to impoverish single-parent families even further.""",
                      kurdishText:
                          """ئەم گۆڕانکارییانە ئەگەریان هەیە زیاتر خێزانە یەک دایبابەکان هەژار بکەن.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (کردار) خراپکردنی کوالێتی شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Intensive cultivation has impoverished the soil.""",
                      kurdishText:
                          """کێڵانی لەڕادەبەدەر زەوییەکەی لاواز کردووە.""",
