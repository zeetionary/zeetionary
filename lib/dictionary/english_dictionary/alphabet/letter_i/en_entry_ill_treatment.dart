...
class EnglishEntryilltreatment extends StatefulWidget {
  const EnglishEntryilltreatment({super.key});

  @override
  State<EnglishEntryilltreatment> createState() =>
      _EnglishEntryilltreatmentState();
}

class _EnglishEntryilltreatmentState extends State<EnglishEntryilltreatment> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: ill-treatment
1. Cruel or inhumane treatment (- maltreatment, ill-usage, abuse)
"the child showed signs of physical ill-treatment";
""",
  );

  final String keyword = "ill-treatment";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ill-treatment""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Workers had no formal means to complain about ill-treatment.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/m2Vz98-JAaE?t=';
    const double startSecondsend = 000000000000000000000000000125;
    const String videoIdone = 'https://youtu.be/R7hK5_Rj--8?t=';
    const double startSecondsone = 0000000000000000000000000004086;
    const String videoIdtwo = 'https://youtu.be/HhFOqNJWp4Q?t=';
    const double startSecondstwo = 0000000000000000000000000006091;
    const String videoIdthree = 'https://youtu.be/RIY4f369VLA?t=';
    const double startSecondsthree = 000000000000000000000000000495;
    const String videoIdfour = 'https://youtu.be/su6zJeRQLUQ?t=';
    const double startSecondsfour = 0000000000000000000000000001218;
    const String videoIdfive = 'https://youtu.be/_wGBEaAZEBc?t=';
    const double startSecondsfive = 0000000000000000000000000001072;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ill-treatment""",
                      // alsoEnglishWord: "also: ill-treatment",
                      britshText: """IpaUK: /ˌɪl ˈtriːtmənt/""",
                      americanText: """IpaUS: /ˌɪl ˈtriːtmənt/""",
...
کوردی: 
"""),
// With short examples define "ill-treatment", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مامەڵەی خراپ و دڕندانە بەرامبەر کەسێک"""),
                    SentencesRow(
                      englishText:
                          """Workers had no formal means to complain about ill-treatment.""",
                      kurdishText:
                          """کرێکاران هیچ ڕێگایەکی فەرمییان نەبوو بۆ گازەندە سەبارەت بە مامەڵەی خراپ.""",
