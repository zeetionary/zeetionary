...
class EnglishEntryextravagant extends StatefulWidget {
  const EnglishEntryextravagant({super.key});

  @override
  State<EnglishEntryextravagant> createState() => _EnglishEntryextravagantState();
}

class _EnglishEntryextravagantState extends State<EnglishEntryextravagant> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extravagant""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extravagant""",
                      // alsoEnglishWord: "also: extravagant",
                      britshText: """IpaUK: /ɪkˈstrævəɡənt/""",
                      americanText: """IpaUS: /ɪkˈstrævəɡənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extravagant";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I felt very extravagant spending £200 on a dress.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's got very extravagant tastes.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I go to that restaurant for lunch if I'm feeling extravagant.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""You mustn't be so extravagant with other people's money.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He bought us all these extravagant presents he couldn't really afford.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I was embarrassed by all the extravagant praise I was getting.""");
  }
...
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) بەکارهێنانی زۆر زیاتر لەوەی پێویستە؛ خەرجکردنی پارەی زیاتر لە پێویست"""),
          SentencesRow(
            englishText:
                """I felt very extravagant spending £200 on a dress.""",
            kurdishText: """هەستم بە زیادەڕۆیی کرد بە خەرجکردنی ٢٠٠ پاوەند بۆ جلێک.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I go to that restaurant for lunch if I'm feeling extravagant.""",
            kurdishText: """ئەگەر هەست دەس‌بڵاوی بکەم دەچم بۆ ئەو چێشتخانەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """You mustn't be so extravagant with other people's money.""",
            kurdishText: """نابێت هێدە دەس‌بڵاو بیت بە پارەی خەڵکی دیکە.""",
            onPressedBritish: () => speaksentence4("en-GB"),
            onPressedAmerican: () => speaksentence4("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """٢. (ھاوەڵناو) کە پارەی زۆر زیاتری دەچێت لەوەی شایەنیەتی یان هەتە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """He bought us all these extravagant presents he couldn't really afford.""",
            kurdishText: """بۆ هەموومان ئەم دیارییە گران‌باییانەی کڕی کە پارەی بۆی نەبوو.""",
            onPressedBritish: () => speaksentence5("en-GB"),
            onPressedAmerican: () => speaksentence5("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """٣. (ھاوەڵناو) کە بە ئاستێکی زۆر و سەرنجڕاکێشە بەڵام پێویست نییە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """I was embarrassed by all the extravagant praise I was getting.""",
            kurdishText: """شەرمەزار بووم بەو هەموو پیاهەڵوتنەی کە پێم دەدرا.""",
...
1. Unrestrained, especially with regard to feelings (= excessive, exuberant, overweening)
"extravagant praise";
 
2. Recklessly wasteful (= prodigal, profligate, spendthrift)
"extravagant in their expenditures";
""",
  );
...
const double _startSecondsend = 0000000000000000000000000001727;
const String _videoIdone = 'https://youtu.be/Bl5630CeYFs?t=';
const double _startSecondsone = 000000000000000000000000000250;
const String _videoIdtwo = 'https://youtu.be/f5NJQiY9AuY?t=';
const double _startSecondstwo = 000000000000000000000000000164;
const String _videoIdthree = 'https://youtu.be/4K-_KbbRiEE?t=';
const double _startSecondsthree = 000000000000000000000000000652;
const String _videoIdfour = 'https://youtu.be/FD3CHzV5rUE?t=';
const double _startSecondsfour = 000000000000000000000000000460;
const String _videoIdfive = 'https://youtu.be/XYgA2f-Ltjo?t=';
const double _startSecondsfive = 0000000000000000000000000008;
