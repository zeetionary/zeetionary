...
class EnglishEntryfission extends StatefulWidget {
  const EnglishEntryfission({super.key});

  @override
  State<EnglishEntryfission> createState() => _EnglishEntryfissionState();
}

class _EnglishEntryfissionState extends State<EnglishEntryfission> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fission (Derived forms: fissions)
1. Reproduction of some unicellular organisms by division of the cell into two more or less equal parts
 
2. A nuclear reaction in which a massive nucleus splits into smaller nuclei with the simultaneous release of energy (= nuclear fission)

- Verb: fission (Derived forms: fissioned, fissioning, fissions)
1. Undergo fission; cause to fission
""",
  );

  final String keyword = "fission";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fission""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fission""",
                      // alsoEnglishWord: "also: fission",
                      britshText: """IpaUK: /ˈfɪʃn/""",
                      americanText: """IpaUS: /ˈfɪʃn/""",
...
// With short examples define "fission", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) جیاکردنەوەی ناوکی ئەتۆم کە وادەکات هێزێکی زۆر دەربکرێت"""),
                    SentencesRow(
                      englishText:
                          """In nuclear fission, a uranium atom is divided into 2 small atoms.""",
                      kurdishText:
                          """لە کەرتبوونی ناوەکیدا، ئەتۆمی یۆرانیۆم دابەش دەکرێت بۆ ٢ ئەتۆمی بچووک.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The fission of the cell could be inhibited with certain chemicals.""",
                      kurdishText:
                          """دابەشبوونی خانە دەکرێت بوەستێنرێت بە مادەی دیایکراوی کیمیایی.""",
...
const String _videoIdone = 'https://youtu.be/112H-vY4Wdo?t=';
const double _startSecondsone = 000000000000000000000000000517;
const String _videoIdtwo = 'https://youtu.be/Unl1jXFnzgo?t=';
const double _startSecondstwo = 000000000000000000000000000569;
const String _videoIdthree = 'https://youtu.be/bpWJNSBQo0k?t=';
const double _startSecondsthree = 000000000000000000000000000223;
const String _videoIdfour = 'https://youtu.be/AecFpnj383A?t=';
const double _startSecondsfour = 0000000000000000000000000001542;
const String _videoIdfive = 'https://youtu.be/HEpNiOM6lto?t=';
