...
class EnglishEntryhilltop extends StatefulWidget {
  const EnglishEntryhilltop({super.key});

  @override
  State<EnglishEntryhilltop> createState() => _EnglishEntryhilltopState();
}

class _EnglishEntryhilltopState extends State<EnglishEntryhilltop> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hilltop (Derived forms: hilltops)
1. The peak of a hill (- brow)
""",
  );

  final String keyword = "hilltop";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hilltop""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They built their house on a hilltop.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001199;
    const String videoIdone = 'https://youtu.be/Ix6vtM4gP8g?t=';
    const double startSecondsone = 00000000000000000000000000062;
    const String videoIdtwo = 'https://youtu.be/hGkVxIyKnEA';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/wI38Yiu4KrM?t=';
    const double startSecondsthree = 000000000000000000000000000422;
    const String videoIdfour = 'https://youtu.be/1zINzDBXxjw?t=';
    const double startSecondsfour = 000000000000000000000000000103;
    const String videoIdfive = 'https://youtu.be/fZ82h9tV5KQ?t=';
    const double startSecondsfive = 00000000000000000000000000062;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hilltop""",
                      // alsoEnglishWord: "also: hilltop",
                      britshText: """IpaUK: /ˈhɪltɒp/""",
                      americanText: """IpaUS: /ˈhɪltɑːp/""",
...
کوردی: سەرگرد، نووکی تەپە، نووچکەی زورک
"""),
                    const DefinitionKurdish(text: """١. (ناو) لوتکەی گردێت"""),
                    SentencesRow(
                      englishText: """They built their house on a hilltop.""",
                      kurdishText: """خانووەکەیان لە لووتکەی گردەکە بنیاتنا.""",
