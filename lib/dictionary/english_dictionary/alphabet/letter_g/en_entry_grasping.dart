...
class EnglishEntrygrasping extends StatefulWidget {
  const EnglishEntrygrasping({super.key});

  @override
  State<EnglishEntrygrasping> createState() => _EnglishEntrygraspingState();
}

class _EnglishEntrygraspingState extends State<EnglishEntrygrasping> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: grasping
1. Immoderately desirous of acquiring e.g. wealth (- avaricious, covetous, grabby [N. Amer, informal], greedy, prehensile)
"a grasping old miser"; "grasping commercialism";

- Noun: grasping (Derived forms: graspings)
1. Understanding with difficulty
"the lecture was beyond his most strenuous graspings"
 
2. The act of gripping something firmly with the hands (or the tentacles) (- taking hold, seizing, prehension)

""",
  );

  final String keyword = "grasping";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grasping""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She refused to work with a grasping man.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grasping""",
                      // alsoEnglishWord: "also: grasping",
                      britshText: """IpaUK: /ˈɡrɑːspɪŋ/""",
                      americanText: """IpaUS: /ˈɡræspɪŋ/""",
...
// With short examples define "grasping", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە هەمیشە هەوڵ بدەیت پارە، دەسەڵات، هتد بۆ خۆت کۆبکەیتەوە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: greedy"),
                    SentencesRow(
                      englishText:
                          """She refused to work with a grasping man.""",
                      kurdishText:
                          """ڕەتی کردەوە لەگەڵ پیاوێکی پارەپەرست کار بکات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/cpriXP451ys?t=';
const double _startSecondsend = 000000000000000000000000000281;
const String _videoIdone = 'https://youtu.be/Jo8jlfVZ194?t=';
const double _startSecondsone = 000000000000000000000000000178;
const String _videoIdtwo = 'https://youtu.be/UXM75CN8SAA?t=';
const double _startSecondstwo = 000000000000000000000000000202;
const String _videoIdthree = 'https://youtu.be/QU45vh8K6_c?t=';
const double _startSecondsthree = 000000000000000000000000000810;
const String _videoIdfour = 'https://youtu.be/D97Fr6yvYsc?t=';
const double _startSecondsfour = 0000000000000000000000000001841;
const String _videoIdfive = 'https://youtu.be/0JD12JOfOWk?t=';
