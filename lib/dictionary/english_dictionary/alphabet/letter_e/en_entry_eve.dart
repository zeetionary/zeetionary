...
class EnglishEntryeve extends StatefulWidget {
  const EnglishEntryeve({super.key});

  @override
  State<EnglishEntryeve> createState() => _EnglishEntryeveState();
}

class _EnglishEntryeveState extends State<EnglishEntryeve> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """eve""",
                      // alsoEnglishWord: "also: eve",
                      britshText: """IpaUK: /iːv/""",
                      americanText: """IpaUS: /iːv/""",
...
کوردی: شەو(ی...)، درەنگان، شێوان، ئێوارە
"""),
          const DefinitionKurdish(
              text: """١. (ناو) ڕۆژ یان ئێوارەی پێش شتێک"""),
          SentencesRow(
            englishText:
                """Mrs Clayton was speaking to Arab journalists in Paris on the eve of her visit to Egypt.""",
            kurdishText:
                """خاتوو کلایتن لەگەڵ ڕۆژنامەنووسە عەرەبەکان قسەی دەکرد لە ئێوارەی سەردانەکەی بۆ میسر.""",
          ...
          SentencesRow(
            englishText:
                """Where did you spend Christmas Eve (= 24 December)?""",
            kurdishText: """ئێوارەی کریسمست لە کوێ بەسەر برد؟""",
...
3. The latter part of the day (the period of decreasing daylight from late afternoon until nightfall) (= evening, even, eventide)
"he enjoyed the eve light across the lake";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/QaZ93sibpk0?t=';
const double _startSecondsend = 000000000000000000000000000000; // 380;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/raSeaAeryWE?t=';
const double _startSecondsone = 00000000000000000000000000000; // 548;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/oD9BaNAH-eE?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1324;
const String _videoIdthree = 'VIDEOhttps://youtu.be/3RkhZgRNC1k?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1875;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/QWz07MktCKg?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 444;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/YpqaWQiyQRA?t=';
