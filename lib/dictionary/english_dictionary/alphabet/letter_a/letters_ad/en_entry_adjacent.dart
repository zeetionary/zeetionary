...
class EnglishEntryadjacent extends StatefulWidget {
  const EnglishEntryadjacent({super.key});

  @override
  State<EnglishEntryadjacent> createState() => _EnglishEntryadjacentState();
}

class _EnglishEntryadjacentState extends State<EnglishEntryadjacent> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""adjacent""");
  }

  Future<void> speakadj255(String languageCode) async {
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Our farm land was adjacent to the river.");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdthree = '0jltioeaEyY';
    const double startSecondsthree = 765;
    const String videoIdfour = 'FSHITL5oedk';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """adjacent""",
                      // alsoEnglishWord: "also: adjacent",
                      britshText: """IpaUK: /əˈdʒeɪsnt/""",
                      americanText: """IpaUS: /əˈdʒeɪsnt/""",
