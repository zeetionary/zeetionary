...
class EnglishEntrylead extends StatefulWidget {
  const EnglishEntrylead({super.key});

  @override
  State<EnglishEntrylead> createState() => _EnglishEntryleadState();
}

class _EnglishEntryleadState extends State<EnglishEntrylead> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: lead (Derived forms: leading, led, leads)
1. Accompany somebody somewhere to show them the way (- take, direct, conduct, guide)
"we led him to our chief";
 
2. Produce as a result or residue (- leave, result)
 
3. Tend to or result in
"This remark led to further arguments among the guests"
 
4. Travel in front of; go in advance of others (- head)
"The procession was led by John";
 
5. Cause to undertake a certain action
"Her greed led her to forge the checks"
 
6. Stretch out over a distance, space, time, or scope; run or extend between two points or beyond a certain point (- run, go, pass, extend)
"Service leads all the way to Cranbury";
 
7. Be in charge of (- head)
"Who is leading this project?";
 
8. Be ahead of others; be the first (- top)
"she led her class every year";
 
9. Have the effect of making happen, or become more likely (- contribute, conduce)
"The use of computers in the classroom led to better writing";
 
10. (music) Have the leading position, as in the performance of a composition (- conduct, direct)
"lead an orchestra";
 
11. Provide access; extend (in the direction of something) (- go)
"This door leads to the basement";
 
12. Move ahead (of others) in time or space (- precede)
 
13. Cause something to lie along a particular path (- run)
"lead the wire behind the cabinet";
 
14. Preside over (- moderate, chair, mod [informal])
"John led the discussion";

- Noun: lead (Derived forms: leads)
1. An advantage held by a competitor in a race
"he took the lead at the last turn"
 
2. Evidence pointing to a possible solution (- track, trail)
...
5. The introductory section of a story (- lead-in, lede)
"it was an amusing lead-in to a very serious matter";
 
6. (sport) the score by which a team or individual is winning
 
7. An actor who plays a principal role (- star, principal)
 
8. (baseball) the position taken by a base runner preparing to advance to the next base
"he took a long lead off first"
 
9. An indication of potential opportunity (- tip, steer, confidential information, wind, hint)
"a good lead for a job";
 
10. A news story of major importance (- lead story)
 
11. The timing of ignition relative to the position of the piston in an internal-combustion engine (- spark advance)
 
12. Restraint consisting of a rope (or light chain) used to restrain an animal (- leash, tether)
 
13. A jumper that consists of a short piece of wire (- jumper cable [N. Amer], jumper lead [N. Amer], booster cable [N. Amer], jump lead [Brit])
...
- Noun: lead
1. A soft heavy toxic malleable metallic element; bluish white when freshly cut but tarnishes readily to dull grey (- Pb, atomic number 82)
"the children were playing with lead soldiers";
 
2. Mixture of graphite with clay in different degrees of hardness; the marking substance in a pencil (- pencil lead)
 
3. Thin strip of metal used to separate lines of type in printing (- leading[2])
""",
  );

  final String keyword = "lead";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""If you lead, I'll follow.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She led the horse back into the stable.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Firefighters led the survivors to safety.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You lead the way and we'll follow.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Let me lead the way.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The wire led to a speaker.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A path led down the hill.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Which door leads to the yard?""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The track led us through a wood.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The gardens lead directly onto a beach.""");
  }
  ...
  Future<void> speaksentence20(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What led you to this conclusion?""");
  }
  ...
  Future<void> speaksentence21(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He's too easily led.""");
  }
  ...
  Future<void> speaksentence25(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Who will lead the party in the next election?""");
  }
  ...
  Future<void> speaksentence26(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A good manager leads by example.""");
  }
  ...
  Future<void> speaksentence28(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The champion is leading by 18 seconds.""");
  }
  ...
  Future<void> speaksentence29(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I tried to lead as normal a life as possible.""");
  }
  ...
  Future<void> speaksentence31(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She took the lead in the second lap.""");
  }
  ...
  Future<void> speaksentence32(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The Democrats now appear to be in the lead.""");
  }
  ...
  Future<void> speaksentence33(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He has gone into the lead.""");
  }
  ...
  Future<void> speaksentence34(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We were struggling to stay in the lead.""");
  }
  ...
  Future<void> speaksentence37(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They took an early lead.""");
  }
  ...
  Future<void> speaksentence41(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The police will follow up all possible leads.""");
  }
  ...
  Future<void> speaksentence42(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The police are following every possible lead.""");
  }
  ...
  Future<void> speaksentence43(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It turned out to be a false lead.""");
  }
  ...
  Future<void> speaksentence45(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Who is playing the lead?""");
  }
  ...
  Future<void> speaksentence46(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Both Christine and Fiona want the lead role.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/qL6Qgxz_oog?t=224';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/OJrGd-0oOo0?t=288';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/dThvyim4tbU';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/IEVmaLZ1w2M?t=16';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/7wZdMPB-O6Y?t=141';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/rGZlNoIMq-k?t=349';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lead""",
                      // alsoEnglishWord: "also: lead",
                      britshText: """IpaUK: /liːd/""",
                      americanText: """IpaUS: /liːd/""",
...
// With short examples define "lead", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەگەر تۆ ڕێبەری بکەیت، من بەدوادا دێم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """You lead the way and we'll follow.""",
                      kurdishText: """تۆ بە پێشدا بچۆ و من دوات دەکەوم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Let me lead the way.""",
                      kurdishText: """بهێڵە ڕێنیشاندەرت بم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The wire led to a speaker.""",
                      kurdishText: """وایەرەکە بە بڵندگۆیەک بەسترابوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕێگایەک بە خوار گردەکەدا دەچوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Which door leads to the yard?""",
                      kurdishText: """چی دەرگایەک بۆ حەوشەکە دەچێت؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The track led us through a wood.""",
                      kurdishText: """ڕێگاکە بە دارستانێکدا بردمانی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """چی گەیاندتی بەم دەرەنجامە؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە فڕەی دووەم پێشەنگی وەرگرت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He has gone into the lead.""",
                      kurdishText: """چووەتە پێشەنگی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They took an early lead.""",
                      kurdishText: """پێشەنگی زوویان بردەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """It turned out to be a false lead.""",
                      kurdishText: """دەرکەوت کە سەرەداوێکی هەڵە بێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کێ ڕۆڵی سەرەکی دەبینێت.""",
