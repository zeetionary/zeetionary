...
class EnglishEntryflagrant extends StatefulWidget {
  const EnglishEntryflagrant({super.key});

  @override
  State<EnglishEntryflagrant> createState() => _EnglishEntryflagrantState();
}

class _EnglishEntryflagrantState extends State<EnglishEntryflagrant> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flagrant
1. Conspicuously and outrageously bad or reprehensible (= crying, egregious, glaring, gross, rank)
"flagrant violation of human rights";
""",
  );

  final String keyword = "flagrant";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flagrant""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He showed a flagrant disregard for anyone else's feelings.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flagrant""",
                      // alsoEnglishWord: "also: flagrant",
                      britshText: """IpaUK: /ˈfleɪɡrənt/""",
                      americanText: """IpaUS: /ˈfleɪɡrənt/""",
...
کوردی: بێ‌شەرم، بێ‌حەیا، ڕووڕەش، ناحەز، ناشیرین، ئابڕووبەرە، ناوزڕێن، قەبە، هەرزە، بێ‌شەرمانە
"""),
// With short examples define "flagrant", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) کە شۆکت دەکات چونکە زۆر بە ئاشکرایی دەکرێت هیچ ڕێز بۆ خەڵک، یاسا، هتد دانانێت"""),
                    SentencesRow(
                      englishText:
                          """He showed a flagrant disregard for anyone else's feelings.""",
                      kurdishText: """گوێ‌پێ‌نەدانی بێ‌شەرمانەی دەدا بە هەستەکانی هەموو کەس.""",
...
const double _startSecondsend = 0000000000000000000000000003838;
const String _videoIdone = 'https://youtu.be/j4kI2h3iotA?t=';
const double _startSecondsone = 0000000000000000000000000003018;
const String _videoIdtwo = 'https://youtu.be/VNJbONExjeQ?t=';
const double _startSecondstwo = 0000000000000000000000000001153;
const String _videoIdthree = 'https://youtu.be/9drJy2Eohh0?t=';
const double _startSecondsthree = 000000000000000000000000000151;
const String _videoIdfour = 'https://youtu.be/TBJGgCHgf5w?t=';
const double _startSecondsfour = 0000000000000000000000000002188;
const String _videoIdfive = 'https://youtu.be/mSm7sRx-0hA?t=';
