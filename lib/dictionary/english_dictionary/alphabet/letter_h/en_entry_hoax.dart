...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000236;
    const String videoIdone = 'https://youtu.be/CupbRr2m_sM?t=';
    const double startSecondsone = 0000000000000000000000000001514;
    const String videoIdtwo = 'https://youtu.be/j2KKUcxAdjc?t=';
    const double startSecondstwo = 000000000000000000000000000421;
    const String videoIdthree = 'https://youtu.be/tExo3ovEBWQ?t=';
    const double startSecondsthree = 000000000000000000000000000860;
    const String videoIdfour = 'https://youtu.be/qCbfTN-caFI?t=';
    const double startSecondsfour = 0000000000000000000000000002564;
    const String videoIdfive = 'https://youtu.be/63tQ7yGmsmI?t=';
    const double startSecondsfive = 0000000000000000000000000001433;
