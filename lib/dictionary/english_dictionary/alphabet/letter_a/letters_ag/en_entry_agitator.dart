                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈædʒɪteɪtər/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'iYcmcX2sstg';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'zoP27ooRVYc';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'pmwC4YI0D2A';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'YEhUUQQekkQ';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'SJx1SPClg6A';
  final double _startSeconds = 1644;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'DJft9OHHCRs';
