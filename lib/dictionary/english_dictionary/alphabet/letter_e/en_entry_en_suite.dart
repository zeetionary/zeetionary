...
class EnglishEntryensuite extends StatefulWidget {
  const EnglishEntryensuite({super.key});

  @override
  State<EnglishEntryensuite> createState() => _EnglishEntryensuiteState();
}

class _EnglishEntryensuiteState extends State<EnglishEntryensuite> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""en suite""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """en suite""",
                      // alsoEnglishWord: "also: en suite",
                      britshText: """IpaUK: /ˌɒ̃ ˈswiːt/""",
                      americanText: """IpaUS: /ˌɑ̃ː ˈswiːt/""",
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو، ھاوەڵکار) گەرماوێک کە گرێدراوە بە ژوورێکی خەو و تەنها لەلایەن کەسانی ئەو ژوورەوە بەکاردێت"""),
          SentencesRow(
            englishText:
                """Each bedroom in the hotel has a bathroom en suite/an en-suite bathroom.""",
            kurdishText:
                """هەر ژوورێکی خەوی هوتێلەکە گەرماوێکی تایبەتی هەیە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: en suite
1. (of a bedroom) having a private bathroom attached
"The apartment's master bath had an en suite bathroom"
""",
  );
...
const String _videoIdend = 'https://youtu.be/ajbooXnvsE8?t=';
const double _startSecondsend = 265;
const String _videoIdone = 'https://youtu.be/ua4oFVz39vM?t=';
const double _startSecondsone = 312;
const String _videoIdtwo = 'https://youtu.be/Fz8G63_QTXc?t=';
const double _startSecondstwo = 163;
const String _videoIdthree = 'https://youtu.be/c2rBN12V9aU?t=';
const double _startSecondsthree = 299;
const String _videoIdfour = 'https://youtu.be/YAWtKCIAUSE?t=';
const double _startSecondsfour = 418;
const String _videoIdfive = 'https://youtu.be/2wh8dC_U8sk?t=';
const double _startSecondsfive = 1473;
const String _videoIdsix = 'https://youtu.be/PE--m5NMFpA?t=';
const double _startSecondssix = 143;
