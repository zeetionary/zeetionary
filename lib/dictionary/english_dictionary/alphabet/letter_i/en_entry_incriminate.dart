...
class EnglishEntryincriminate extends StatefulWidget {
  const EnglishEntryincriminate({super.key});

  @override
  State<EnglishEntryincriminate> createState() =>
      _EnglishEntryincriminateState();
}

class _EnglishEntryincriminateState extends State<EnglishEntryincriminate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: incriminate (Derived forms: incriminated, incriminating, incriminates)
1. Suggest that someone is guilty (- imply, inculpate [archaic])
 
2. Bring an accusation against; level a charge against (- accuse, impeach, criminate)
"The neighbours incriminated the man of spousal abuse";
""",
  );

  final String keyword = "incriminate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incriminate""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/CupbRr2m_sM?t=';
    const double startSecondsend = 000000000000000000000000000981;
    const String videoIdone = 'https://youtu.be/qjqh9UVfNNk?t=';
    const double startSecondsone = 0000000000000000000000000001308;
    const String videoIdtwo = 'https://youtu.be/9Lc3QKplEiI?t=';
    const double startSecondstwo = 0000000000000000000000000001406;
    const String videoIdthree = 'https://youtu.be/5cGxmooRfCI?t=';
    const double startSecondsthree = 0000000000000000000000000002761;
    const String videoIdfour = 'https://youtu.be/GyD8aTwrGo8?t=';
    const double startSecondsfour = 0000000000000000000000000001146;
    const String videoIdfive = 'https://youtu.be/hS4XXstzocY?t=';
    const double startSecondsfive = 0000000000000000000000000003050;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """incriminate""",
                      // alsoEnglishWord: "also: incriminate",
                      britshText: """IpaUK: /ɪnˈkrɪmɪneɪt/""",
                      americanText: """IpaUS: /ɪnˈkrɪmɪneɪt/""",
...
کوردی: 
"""),
// With short examples define "incriminate", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) وادەرخستنی ئەوەی کەسێک شتێکی هەڵە یان نایاسایی کردووە"""),
                    SentencesRow(
                      englishText:
                          """They were afraid of answering the questions and incriminating themselves.""",
                      kurdishText:
                          """دەترسان لە وەڵامدانەوەی پرسیارەکان و تێوەگلاندنی خۆیان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He was careful not to say anything that might incriminate the others.""",
                      kurdishText:
                          """وریابوو لەوەی هیچ نەڵێت کە کەسانی دیکە تێوەبگلێنێت.""",
