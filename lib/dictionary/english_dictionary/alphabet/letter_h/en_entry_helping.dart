...
class EnglishEntryhelping extends StatefulWidget {
  const EnglishEntryhelping({super.key});

  @override
  State<EnglishEntryhelping> createState() => _EnglishEntryhelpingState();
}

class _EnglishEntryhelpingState extends State<EnglishEntryhelping> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: helping (Derived forms: helpings)
1. An individual quantity of food or drink taken as part of a meal (- portion, serving)
"the helpings were all small";
""",
  );

  final String keyword = "helping";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""helping""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We all had a second helping of chicken.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He asked for an extra helping.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The comedian is back with another helping of zany humour.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """helping""",
                      // alsoEnglishWord: "also: helping",
                      britshText: """IpaUK: /ˈhelpɪŋ/""",
                      americanText: """IpaUS: /ˈhelpɪŋ/""",
...
کوردی: 
"""),
// With short examples define "helping", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بڕە خواردنێک کە لە ژەمێک بە کەسێک دەدرێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: serving"),
                    SentencesRow(
                      englishText:
                          """We all had a second helping of chicken.""",
                      kurdishText: """دووەم بەش مریشکمان خوارد.""",
                    ...
                    SentencesRow(
                      englishText: """He asked for an extra helping.""",
                      kurdishText: """داوای بەشێکی زیادەی کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کۆمیدیانەکە گەڕاوەتەوە بە بەشێکی تر لە گاڵتەی سەیر و سەمەرە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/bhdZmR0CJJo?t=';
const double _startSecondsend = 00000000000000000000000000063;
const String _videoIdone = 'https://youtu.be/_fnhy5xO9vQ?t=';
const double _startSecondsone = 000000000000000000000000000287;
const String _videoIdtwo = 'https://youtu.be/96K9MBvGDeA?t=';
const double _startSecondstwo = 00000000000000000000000000092;
const String _videoIdthree = 'https://youtu.be/eKU-E-99Bj4?t=';
const double _startSecondsthree = 000000000000000000000000000575;
const String _videoIdfour = 'https://youtu.be/p71KQM1hc30?t=';
const double _startSecondsfour = 000000000000000000000000000411;
const String _videoIdfive = 'https://youtu.be/KV-SUOpW408?t=';
