...
class EnglishEntryfont extends StatefulWidget {
  const EnglishEntryfont({super.key});

  @override
  State<EnglishEntryfont> createState() => _EnglishEntryfontState();
}

class _EnglishEntryfontState extends State<EnglishEntryfont> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: font (Derived forms: fonts)
1. A specific size and style of type within a type family (= fount [Brit], typeface, face, case)
 
2. Bowl for baptismal water (= baptismal font, baptistry, baptistery)
""",
  );

  final String keyword = "font";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The font was filled with holy water for the ceremony.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The report was typed in a professional font.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """font""",
                      // alsoEnglishWord: "also: font",
                      britshText: """IpaUK: /fɒnt/""",
                      americanText: """IpaUS: /fɑːnt/""",
...
کوردی: حەوزی باپتیزم، بەرداوی تەوفن، تەشتی تەوفن، جێی ئاوی پیرۆز
"""),
                    CustomRichText(
                      textBeforeLink:
                          "١. حەوزێکی گەورە بەردین لە کڵێسا کە ئاوی تێدایە بۆ مەراسیمی",
                      linkText: "تەوفن",
                      textAfterLink: "",
                      onTap: () {
                        Routemaster.of(context).push("/english-font/baptism");
                      },
                    ),
                    SentencesRow(
                      englishText:
                          """The font was filled with holy water for the ceremony.""",
                      kurdishText:
                          """حەوزەکە پڕکرابوو لە ئاوی پیرۆز بۆ بۆنەکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) شێوە و ئەندازەی پیت کە بەکاردێت بۆ چاپکردن، نووسینی کۆمپیوتەر، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The report was typed in a professional font.""",
                      kurdishText:
                          """ڕاپۆرتەکە بە فۆنتێکی پڕۆفیشناڵانە نووسرا.""",
...
const double _startSecondsend = 000000000000000000000000000263;
const String _videoIdone = 'https://youtu.be/xXvgT-AgLAo?t=';
const double _startSecondsone = 00000000000000000000000000079;
const String _videoIdtwo = 'https://youtu.be/LfeEu4_vtfQ?t=';
const double _startSecondstwo = 000000000000000000000000000729;
const String _videoIdthree = 'https://youtu.be/e31fNccOQSE?t=';
const double _startSecondsthree = 00000000000000000000000000022;
const String _videoIdfour = 'https://youtu.be/kr4lKkfv3lM?t=';
const double _startSecondsfour = 00000000000000000000000000076;
const String _videoIdfive = 'https://youtu.be/5l4sCaw71NE?t=';
