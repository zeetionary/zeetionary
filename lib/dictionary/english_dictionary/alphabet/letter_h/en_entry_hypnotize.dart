...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/4HNBi6zb6Xs?t=';
    const double startSecondsend = 0000000000000000000000000005;
    const String videoIdone = 'https://youtu.be/zJ5rFV5b9Xs?t=';
    const double startSecondsone = 000000000000000000000000000498;
    const String videoIdtwo = 'https://youtu.be/MMd5ABmMN74?t=';
    const double startSecondstwo = 000000000000000000000000000469;
    const String videoIdthree = 'https://youtu.be/9wGXDNLG_oA?t=';
    const double startSecondsthree = 000000000000000000000000000158;
    const String videoIdfour = 'https://youtu.be/eGIkGo-lGm0?t=';
    const double startSecondsfour = 0000000000000000000000000002269;
    const String videoIdfive = 'https://youtu.be/Ob0n6CiIJ70?t=';
    const double startSecondsfive = 000000000000000000000000000593;
