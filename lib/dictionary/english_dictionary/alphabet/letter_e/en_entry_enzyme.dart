...
class EnglishEntryenzyme extends StatefulWidget {
  const EnglishEntryenzyme({super.key});

  @override
  State<EnglishEntryenzyme> createState() => _EnglishEntryenzymeState();
}

class _EnglishEntryenzymeState extends State<EnglishEntryenzyme> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enzyme""",
                      // alsoEnglishWord: "also: enzyme",
                      britshText: """IpaUK: /ˈenzaɪm/""",
                      americanText: """IpaUS: /ˈenzaɪm/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Enzymes are essential to the body’s functioning.""");
  }
...
کوردی: ئینزایم، ئانزیم، هەوێنە، ترشێنە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ماددەیەک کە لەلایەن هەموو زیندەوەرانەوە بەرهەم دەهێنرێت و یارمەتی گۆڕانکارییەکی کیمیایی دەدات کە ڕووبدات یان خێراتر ڕووبدات، بەبێ ئەوەی خۆی بگۆڕێت"""),
          SentencesRow(
            englishText: """Enzymes are essential to the body’s functioning.""",
            kurdishText: """ئەنزیمەکان گرنگن بۆ کارکردنی جەستە.""",
          ...
          SentencesRow(
            englishText:
                """An enzyme in the saliva of the mouth starts the process of breaking down the food.""",
            kurdishText:
                """ئەنزیمێک لە تفی ناو دەمدا پرۆسەی شیکردنەوەی خۆراک دەست پێدەکات..""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: enzyme (Derived forms: enzymes)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/X3TAROotFfM?t=';
const double _startSecondsend = 000000000000000000000000000000; // 40;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/mRj1RKh4xyY?t=';
const double _startSecondsone = 00000000000000000000000000000; // 240;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/6_Vrg3zAKl4?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 386;
const String _videoIdthree = 'VIDEOhttps://youtu.be/ZzdV_HM95RQ?t=';
const double _startSecondsthree = 000000000000000000000000000; // 730;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/MLd4K5hKosw?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 457;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/Zj-dUiYYH64?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 327;
