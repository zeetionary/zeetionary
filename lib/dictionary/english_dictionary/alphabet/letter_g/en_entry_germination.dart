...
class EnglishEntrygermination extends StatefulWidget {
  const EnglishEntrygermination({super.key});

  @override
  State<EnglishEntrygermination> createState() =>
      _EnglishEntrygerminationState();
}

class _EnglishEntrygerminationState extends State<EnglishEntrygermination> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "germination";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""germination""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """germination""",
                      // alsoEnglishWord: "also: germination",
                      britshText: """IpaUK: /ˌdʒɜːmɪˈneɪʃn/""",
                      americanText: """IpaUS: /ˌdʒɜːrmɪˈneɪʃn/""",
...
کوردی: چەکەرەکردن، چەقەرەکردن، چرۆکردن، شین‌بوون، ڕسکان، سەوزبوون، گووران، ڕوان
"""),
// With short examples define "germination", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) پڕۆسەی گەشەی تۆو"""),
                    SentencesRow(
                      englishText:
                          """Keep the seeds in warm, damp conditions to encourage germination.""",
                      kurdishText:
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/StgMJMn80t8?t=';
const double _startSecondsend = 000000000000000000000000000336;
const String _videoIdone = 'https://youtu.be/4arNJoJ98Og?t=';
const double _startSecondsone = 000000000000000000000000000512;
const String _videoIdtwo = 'https://youtu.be/dtvuMNVLISo?t=';
const double _startSecondstwo = 000000000000000000000000000229;
const String _videoIdthree = 'https://youtu.be/E7oEq6CE78g?t=';
const double _startSecondsthree = 000000000000000000000000000174;
const String _videoIdfour = 'https://youtu.be/sdIFhbzCeDk?t=';
const double _startSecondsfour = 000000000000000000000000000179;
const String _videoIdfive = 'https://youtu.be/K9UtK-bVpsg?t=';
