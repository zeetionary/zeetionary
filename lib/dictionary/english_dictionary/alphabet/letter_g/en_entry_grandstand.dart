...
class EnglishEntrygrandstand extends StatefulWidget {
  const EnglishEntrygrandstand({super.key});

  @override
  State<EnglishEntrygrandstand> createState() => _EnglishEntrygrandstandState();
}

class _EnglishEntrygrandstandState extends State<EnglishEntrygrandstand> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grandstand (Derived forms: grandstands)
1. The audience at a stadium or racetrack
 
2. A stand at a racecourse or stadium consisting of tiers with rows of individual seats that are under a protective roof (- covered stand)

- Verb: grandstand (Derived forms: grandstands, grandstanded, grandstanding)
1. (performing arts) perform ostentatiously in order to impress the audience and with an eye to the applause
"She never misses a chance to grandstand"
""",
  );

  final String keyword = "grandstand";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grandstand""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The game was played to a packed grandstand.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grandstand""",
                      // alsoEnglishWord: "also: grandstand",
                      britshText: """IpaUK: /ˈɡrænstænd/""",
                      americanText: """IpaUS: /ˈɡrænstænd/""",
...
// With short examples define "grandstand", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) جێگای سەرەکی تەماشاکارانی بۆنەیەکی وەرزشی کە باشترین دیمەنی هەیە"""),
                    SentencesRow(
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/tYrdMjVXyNg?t=';
const double _startSecondsend = 0000000000000000000000000001377;
const String _videoIdone = 'https://youtu.be/cztw76aM-18?t=';
const double _startSecondsone = 000000000000000000000000000293;
const String _videoIdtwo = 'https://youtu.be/MV1qaFv4VUg?t=';
const double _startSecondstwo = 000000000000000000000000000710;
const String _videoIdthree = 'https://youtu.be/GtZZVEy2OUc?t=';
const double _startSecondsthree = 000000000000000000000000000450;
const String _videoIdfour = 'https://youtu.be/GHa3rxmSi1c?t=';
const double _startSecondsfour = 000000000000000000000000000600;
const String _videoIdfive = 'https://youtu.be/6BsaRYD922c?t=';
const double _startSecondsfive = 0000000000000000000000000001154;
