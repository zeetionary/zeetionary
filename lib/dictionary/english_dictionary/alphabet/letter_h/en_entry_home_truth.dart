...
class EnglishEntryhometruth extends StatefulWidget {
  const EnglishEntryhometruth({super.key});

  @override
  State<EnglishEntryhometruth> createState() => _EnglishEntryhometruthState();
}

class _EnglishEntryhometruthState extends State<EnglishEntryhometruth> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: home truth (Derived forms: home truths)
1. An important truth that is unpleasant to acknowledge (as about yourself)
""",
  );

  final String keyword = "home truth";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""home truth""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It's time you told him a few home truths.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/YpAYPNBlEAE?t=';
    const double startSecondsend = 00000000000000000000000000055;
    const String videoIdone = 'https://youtu.be/NML1WGvXOeU?t=';
    const double startSecondsone = 0000000000000000000000000001113;
    const String videoIdtwo = 'https://youtu.be/8O3U0reMHXw?t=';
    const double startSecondstwo = 00000000000000000000000000010;
    const String videoIdthree = 'https://youtu.be/PV6pnTYF3rg?t=';
    const double startSecondsthree = 00000000000000000000000000041;
    const String videoIdfour = 'https://youtu.be/ayrGnzQTRmI?t=';
    const double startSecondsfour = 0000000000000000000000000001525;
    const String videoIdfive = 'https://youtu.be/UHDgFrx10Js?t=';
    const double startSecondsfive = 0000000000000000000000000001582;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """home truth""",
                      // alsoEnglishWord: "also: home truth",
                      britshText: """IpaUK: /ˌhəʊm ˈtruːθ/""",
                      americanText: """IpaUS: /ˌhəʊm ˈtruːθ/""",
...
// With short examples define "home truth", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کاتی ئەوەبوو هەندێک ڕاستیی تاڵت پێ گوتبا.""",
