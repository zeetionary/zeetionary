...
class EnglishEntryherewith extends StatefulWidget {
  const EnglishEntryherewith({super.key});

  @override
  State<EnglishEntryherewith> createState() => _EnglishEntryherewithState();
}

class _EnglishEntryherewithState extends State<EnglishEntryherewith> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: herewith
1. (formal) by means of this (- hereby)
"I herewith declare you man and wife";
""",
  );

  final String keyword = "herewith";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""herewith""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I enclose herewith a copy of the policy.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I enclose three documents herewith.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """herewith""",
                      // alsoEnglishWord: "also: herewith",
                      britshText: """IpaUK: /ˌhɪəˈwɪð/,  /ˌhɪəˈwɪθ/""",
                      americanText: """IpaUS: /ˌhɪrˈwɪð/,  /ˌhɪrˈwɪθ/""",
...
کوردی: 
"""),
// With short examples define "herewith", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) لەگەڵ ئەم کتێبە، نامەیە، یان بەڵگەنامەیە"""),
                    SentencesRow(
                      englishText:
                          """I enclose herewith a copy of the policy.""",
                      kurdishText:
                          """لەگەڵیندا کۆپییەکەی سیاسەتەکەم ناردووە.""",
...
const double _startSecondsend = 0000000000000000000000000006420;
const String _videoIdone = 'https://youtu.be/tPRG-l-YR94?t=';
const double _startSecondsone = 000000000000000000000000000345;
const String _videoIdtwo = 'https://youtu.be/PqYNDnw5gxY?t=';
const double _startSecondstwo = 000000000000000000000000000556;
const String _videoIdthree = 'https://youtu.be/it4BGLrnl-g?t=';
const double _startSecondsthree = 00000000000000000000000000012090;
const String _videoIdfour = 'https://youtu.be/NSEsLtwKzvw?t=';
const double _startSecondsfour = 000000000000000000000000000587;
const String _videoIdfive = 'https://youtu.be/UtSB5IXAx8M?t=';
const double _startSecondsfive = 000000000000000000000000000929;
