...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 788;
    const String videoIdone = 'khOUvmOQExc';
    const double startSecondsone = 678;
    const String videoIdtwo = 'c0oKgSb5BbQ';
    const double startSecondstwo = 54;
    const String videoIdthree = 'y4TAuIuC2Gg';
    const double startSecondsthree = 48;
    const String videoIdfour = '_mqP7kd1H_Y';
    const double startSecondsfour = 501;
    const String videoIdfive = '1UTjWy-vnOo';
