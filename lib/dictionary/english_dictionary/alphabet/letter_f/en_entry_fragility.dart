...
class EnglishEntryfragility extends StatefulWidget {
  const EnglishEntryfragility({super.key});

  @override
  State<EnglishEntryfragility> createState() => _EnglishEntryfragilityState();
}

class _EnglishEntryfragilityState extends State<EnglishEntryfragility> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fragility (Derived forms: fragilities)
1. Quality of being easily damaged or destroyed (= breakability, frangibleness, frangibility)
 
2. Lack of physical strength (= delicacy)
""",
  );

  final String keyword = "fragility";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fragility""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There was an air of fragility about him.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fragility""",
                      // alsoEnglishWord: "also: fragility",
                      britshText: """IpaUK: /frəˈdʒɪləti/""",
                      americanText: """IpaUS: /frəˈdʒɪləti/""",
...
کوردی: ناسکی، زووشکاوی، قرچی، قرپی، هەڵپەڕیوی، ڕێزەڵۆکی، لەشکان‌هاتوویی،	هەستیاری، ناسکی،	سستی، لاوازی، بێ‌هێزی، بێ‌گیانی
"""),
// With short examples define "fragility", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەستێکی ناسکی سەبارەت بەو هەبوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """A deficiency of copper can cause increased bone fragility.""",
                      kurdishText:
                          """کەمی مس دەکرێت ببێتە هۆکاری زیادبووی ناسکی ئێسک.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/tZBk_Hb-X0w?t=';
const double _startSecondsend = 000000000000000000000000000244;
const String _videoIdone = 'https://youtu.be/wf6x4FHTMKo?t=';
const double _startSecondsone = 0000000000000000000000000002079;
const String _videoIdtwo = 'https://youtu.be/Jjh1W_TbUNY?t=';
const double _startSecondstwo = 000000000000000000000000000162;
const String _videoIdthree = 'https://youtu.be/L_Guz73e6fw?t=';
const double _startSecondsthree = 0000000000000000000000000007665;
const String _videoIdfour = 'https://youtu.be/tQmFVcD-Mbo?t=';
const double _startSecondsfour = 000000000000000000000000000831;
const String _videoIdfive = 'https://youtu.be/YqxrcEiFJtI?t=';
