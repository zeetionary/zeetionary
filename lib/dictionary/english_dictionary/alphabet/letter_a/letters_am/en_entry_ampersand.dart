                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "ampersand"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæmpəsænd/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakampersand("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæmpərsænd/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakampersand("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'oOLDS5vo79I';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'nB_s79lHSVs';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'zYierUhIFNQ';
  final double _startSeconds = 5863;
