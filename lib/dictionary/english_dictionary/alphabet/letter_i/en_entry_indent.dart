...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/-7bIDbaU_zQ?t=';
    const double startSecondsend = 000000000000000000000000000977;
    const String videoIdone = 'https://youtu.be/JX82wa5HkJg?t=';
    const double startSecondsone = 000000000000000000000000000731;
    const String videoIdtwo = 'https://youtu.be/PGqZkOveLb8?t=';
    const double startSecondstwo = 000000000000000000000000000321;
    const String videoIdthree = 'https://youtu.be/-obKX-mqjXQ?t=';
    const double startSecondsthree = 000000000000000000000000000338;
    const String videoIdfour = 'https://youtu.be/XxOh12Uhg08?t=';
    const double startSecondsfour = 000000000000000000000000000794;
    const String videoIdfive = 'https://youtu.be/W9ojqSfsWKI?t=';
    const double startSecondsfive = 0000000000000000000000000002491;
