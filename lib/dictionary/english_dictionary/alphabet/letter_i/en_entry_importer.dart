...
class EnglishEntryimporter extends StatefulWidget {
  const EnglishEntryimporter({super.key});

  @override
  State<EnglishEntryimporter> createState() => _EnglishEntryimporterState();
}

class _EnglishEntryimporterState extends State<EnglishEntryimporter> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""importer""");
  }
