...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'xPG3_8m1NQA';
    const double startSecondsend = 172;
    const String videoIdone = 'BQOJ-aqclFs';
    const double startSecondsone = 431;
    const String videoIdtwo = '3xpZzOIDd9I';
    const double startSecondstwo = 713;
    const String videoIdthree = 'YJp3e3pRvYI';
    const double startSecondsthree = 214;
    const String videoIdfour = '2hrtI_msLZY';
    const double startSecondsfour = 267;
    const String videoIdfive = 'lvGUKfqGXdQ';
