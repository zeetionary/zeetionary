...
// replace these: EnglishEntryabysmal - speakAbysmal - abysmal - /əˈbɪzməl/

enum TtsState { playing }

class EnglishEntryabysmal extends StatelessWidget {
  EnglishEntryabysmal({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAbysmal(String languageCode) async {
    // DOPSUM: CHANGE speakAbysmal
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("abysmal"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakA1547(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("His manners are abysmal."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'abysmal', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈbɪzməl/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /əˈbɪzməl/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '1MagImMpI7M';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '4Rz8BPRFeiA';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'nnzYZdGFzzM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'QeviyBHqR7k';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '9O0RNSlB5-g';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'KFevuP5ua_8';
