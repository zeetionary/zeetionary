...
class EnglishEntryendorsement extends StatefulWidget {
  const EnglishEntryendorsement({super.key});

  @override
  State<EnglishEntryendorsement> createState() =>
      _EnglishEntryendorsementState();
}

class _EnglishEntryendorsementState extends State<EnglishEntryendorsement> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""endorsement""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """endorsement""",
                      // alsoEnglishWord: "also: endorsement",
                      britshText: """IpaUK: /ɪnˈdɔːsmənt/""",
                      americanText: """IpaUS: /ɪnˈdɔːrsmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "endorsement";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We are happy to give the product our full endorsement.""");
  }
...
// """),
          const DefinitionKurdish(
              text:
                  """١. (ناو) لێدوانێکی فەرمی بۆ ڕاگەیاندنی پشتگیری بۆ کەسێک"""),
          SentencesRow(
            englishText:
                """The election victory is a clear endorsement of their policies.""",
            kurdishText:
                """سەرکەوتنەکەی هەڵبژاردن پشتگیری ڕوونی سیاسەتەکانیانە.""",
          ...
          SentencesRow(
            englishText:
                """His presidential campaign won endorsement from several celebrities.""",
            kurdishText:
                """کەمپینی سەرۆکایەتییەکەی پشتگیری چەندین کەسی بەناوبانگی بردەوە.""",
          ...
          SentencesRow(
            englishText:
                """These measures have the strong endorsement of the Labour party.""",
            kurdishText:
                """ئەم ڕێکارانە پشتگیری بەهێزی پارتی کرێکارانیان هەیە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) لێدوانێک لە ڕیکلامێکدا کە تێیدا کەسێک پشتگیری بەرهەمێک دەکات"""),
          // const DividerSentences(),
          SentencesRow(
            englishText:
                """We are happy to give the product our full endorsement.""",
            kurdishText: """دڵخۆشین کە پشتگیری تەواومان بدەین بە بەرهەمەکە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: endorsement (Derived forms: endorsements)
1. A promotional statement (as found on the dust jackets of books) (= indorsement, blurb)
"the author got all his friends to write endorsements for his book";
 
2. A speech seconding a motion (= second, secondment, indorsement)
 
3. Formal and explicit approval (= sanction, countenance, indorsement, warrant, imprimatur)
"a Democrat usually gets the union's endorsement";
 
4. A signature that validates something (= indorsement)
"the cashier would not cash the check without an endorsement";
 
5. The act of endorsing (= indorsement)
...
const String _videoIdend = 'https://youtu.be/io6wi8DVZ3o?t=';
const double _startSecondsend = 259;
const String _videoIdone = 'https://youtu.be/SrDEtSlqJC4?t=';
const double _startSecondsone = 1518;
const String _videoIdtwo = 'https://youtu.be/8KmmZBBJGkE?t=';
const double _startSecondstwo = 975;
const String _videoIdthree = 'https://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondsthree = 4240;
const String _videoIdfour = 'https://youtu.be/okeeKqcmQkw?t=';
const double _startSecondsfour = 271;
const String _videoIdfive = 'https://youtu.be/mXpwgg5TxOU?t=';
const double _startSecondsfive = 399;
const String _videoIdsix = 'https://youtu.be/jMq65CslbZA?t=';
const double _startSecondssix = 337;
