...
class EnglishEntryleukaemia extends StatefulWidget {
  const EnglishEntryleukaemia({super.key});

  @override
  State<EnglishEntryleukaemia> createState() => _EnglishEntryleukaemiaState();
}

class _EnglishEntryleukaemiaState extends State<EnglishEntryleukaemia> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""leukaemia""");
  }
