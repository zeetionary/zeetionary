...
class EnglishEntrylemon extends StatefulWidget {
  const EnglishEntrylemon({super.key});

  @override
  State<EnglishEntrylemon> createState() => _EnglishEntrylemonState();
}

class _EnglishEntrylemonState extends State<EnglishEntrylemon> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lemon (Derived forms: lemons)
1. Yellow oval fruit with juicy acidic flesh
 
2. A strong yellow colour (- gamboge, lemon yellow, maize)
 
3. A small evergreen tree that originated in Asia but is widely cultivated for its fruit (- lemon tree, Citrus limon)
 
4. A distinctive tart flavour characteristic of lemons
 
5. [informal] An artifact (especially an automobile) that is defective or unsatisfactory (- stinker [informal])
""",
  );

  final String keyword = "lemon";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Squeeze the juice of half a lemon over the fish.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""For this recipe you need the juice of two lemons.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She wore a lemon dress to the party.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Only one of his inventions turned out to be a lemon.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I felt such a lemon when I discovered the answer.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/y0YDu-vMT1A';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/4oI-jCDkm-A?t=4';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/hktIRdd90g4?t=126';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/1wc_mZ86ypg?t=4';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/XFKhIBH23-Q?t=97';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/cM4q33O2Qys?t=167';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lemon""",
                      // alsoEnglishWord: "also: lemon",
                      britshText: """IpaUK: /ˈlemən/""",
                      americanText: """IpaUS: /ˈlemən/""",
...
کوردی: 
"""),
// With short examples define "lemon", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) لیمۆ؛ ئاوی لیمۆ یان خواردنەوەیەک کە لە ئاوی لیمۆ درووست کراوە"""),
                    SentencesRow(
                      englishText: """Squeeze the juice of half a lemon over the fish.""",
                      kurdishText: """ئاوی نیو لیمۆ بڕژینە سەر ماسییەکە.""",
                    ...
                    SentencesRow(
                      englishText: """For this recipe you need the juice of two lemons.""",
                      kurdishText: """بۆ ئەم ڕەچەتەیە پێویستیت بە ئاوی دوو لیمۆ هەیە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ڕەنگێکی زەردی کاڵ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She wore a lemon dress to the party.""",
                      kurdishText: """جلێکی لیمۆیی بۆ ئاهەنگەکە لەبەرکرد.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) شتێک کە بەکارنایەت بەهۆی ئەوەی کارناکات"""),
                    const AlsoEnglishckb(word: "ھەروەھا: dud"),
                    SentencesRow(
                      englishText: """Only one of his inventions turned out to be a lemon.""",
                      kurdishText: """تەنها یەکێک لە داهێنانەکانی دەرکەوت کە هیچەکەیەکە.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ناو) کەسێکی گەمژە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: idiot"),
                    SentencesRow(
                      englishText: """I felt such a lemon when I discovered the answer.""",
                      kurdishText: """هەستم بە گەمژەییەتییەکی تەواو کرد کە وەڵامەکەم زانی.""",
