...
// blank divider
  ...
  Future<void> speakBetrayals7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBetrayals77"); // DOPSUM: CHANGE TEXT
  }
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  static String myVideoId = "JKFvCjItGDg";
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  static String myVideoId = "J8I-UUHgV_I";
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  static String myVideoId = "GMc8icI6mmg";
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  static String myVideoId = "TMrtLsQbaok";
