...
class EnglishEntryhaveto extends StatefulWidget {
  const EnglishEntryhaveto({super.key});

  @override
  State<EnglishEntryhaveto> createState() => _EnglishEntryhavetoState();
}

class _EnglishEntryhavetoState extends State<EnglishEntryhaveto> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""have to""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Sorry, I've got to go.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Did she have to pay a fine?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You don't have to knock—just walk in.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I haven't got to leave till seven.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Do you have to go?""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You simply have to get a new job.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You've got to try this recipe—it's delicious.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""There has to be a reason for his strange behaviour.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This war has got to end soon.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """have to""",
                      // alsoEnglishWord: "also: have to",
                      britshText: """IpaUK: /ˈhæv tə/, /ˈhæf tə/""",
                      americanText: """IpaUS: /ˈhæv tə/, /ˈhæf tə/""",
...
// With short examples define "have to", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Sorry, I've got to go.""",
                      kurdishText: """ببوورە، دەبێت بچم.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """ژممر. (کاری مۆداڵ) پننسە"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پێویست ناکات لە دەرگا بدەیت ـ هەر بچۆ ژوورەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کاری مۆداڵ) بۆ پێدانی ئامۆژگاری یان پێشنیار"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """You simply have to get a new job.""",
                      kurdishText:
                          """بە سادەیی (ئەوەیە کە) دەبێت کارێک بدۆزیتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەبێت ئەم ڕەچەتەیە تاقی بکەیتەوە ـ بەلەزەتە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کاری مۆداڵ) بۆ گوتنی ئەوەی شتێک دەبێت ڕاست بێت یان ڕووبدات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """There has to be a reason for his strange behaviour.""",
                      kurdishText:
                          """دەبێت هۆکارێک هەبێت بۆ ئەم ڕەفتارە نامۆیە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (کاری مۆداڵ) بۆ گوتنی ئەوەی شتێک ڕوودەدات یان کەسێک شتێک دەکات بۆ بێزارکردنی تۆ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Of course, it had to start raining as soon as we got to the beach.""",
                      kurdishText:
                          """بەدڵنیاییەوە، هەر دەبوو باران ببارێت هەرکە گەشتینە کەنارەکە.""",
...
const double _startSecondsend = 000000000000000000000000000159;
const String _videoIdone = 'https://youtu.be/rPe4yziWiOg?t=';
const double _startSecondsone = 000000000000000000000000000569;
const String _videoIdtwo = 'https://youtu.be/hTqtGJwsJVE?t=';
const double _startSecondstwo = 0000000000000000000000000001892;
const String _videoIdthree = 'https://youtu.be/XZVHmRvfDHM?t=';
const double _startSecondsthree = 000000000000000000000000000142;
const String _videoIdfour = 'https://youtu.be/wLHNI96oF2A?t=';
const double _startSecondsfour = 000000000000000000000000000276;
