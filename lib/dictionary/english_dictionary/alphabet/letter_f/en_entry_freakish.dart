...
class EnglishEntryfreakish extends StatefulWidget {
  const EnglishEntryfreakish({super.key});

  @override
  State<EnglishEntryfreakish> createState() => _EnglishEntryfreakishState();
}

class _EnglishEntryfreakishState extends State<EnglishEntryfreakish> {
  @override
  void initState() {
    super.initState();
...
3. Conspicuously or grossly unconventional or unusual (= bizarre, eccentric, freaky [informal], flaky [informal], flakey [informal], gonzo [N. Amer, informal], off-the-wall [informal], outlandish, outré)
"a freakish combination of styles";
""",
  );

  final String keyword = "freakish";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""freakish""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """freakish""",
                      // alsoEnglishWord: "also: freakish",
                      britshText: """IpaUK: /ˈfriːkɪʃ/""",
                      americanText: """IpaUS: /ˈfriːkɪʃ/""",
...
// With short examples define "freakish", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Freakish weather conditions have caused massive traffic jams in the area.""",
                      kurdishText:
                          """دۆخی نائاسایی کەشووهەوا بوو بە هۆکاری قەرەباڵغیی هاتووچۆ لە ناوچەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """When you're a child you always imagine that your own bodily imperfections are somehow freakish.""",
                      kurdishText:
                          """کە منداڵیت هەمیشە وەها دادەنێیت خەوشییەکانی جەستەت نامۆن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/62EGPCEmeh4?t=';
const double _startSecondsend = 00000000000000000000000000071;
const String _videoIdone = 'https://youtu.be/tNdVTnrA-2k?t=';
const double _startSecondsone = 000000000000000000000000000781;
const String _videoIdtwo = 'https://youtu.be/AU4fXUVd3o0?t=';
const double _startSecondstwo = 000000000000000000000000000441;
const String _videoIdthree = 'https://youtu.be/UShsgCOzER4?t=';
const double _startSecondsthree = 000000000000000000000000000339;
const String _videoIdfour = 'https://youtu.be/KqcOX0oviGc?t=';
const double _startSecondsfour = 000000000000000000000000000758;
const String _videoIdfive = 'https://youtu.be/SOE7EWEnU2o?t=';
