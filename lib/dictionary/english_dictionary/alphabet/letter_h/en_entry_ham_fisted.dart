...
class EnglishEntryhamfisted extends StatefulWidget {
  const EnglishEntryhamfisted({super.key});

  @override
  State<EnglishEntryhamfisted> createState() => _EnglishEntryhamfistedState();
}

class _EnglishEntryhamfistedState extends State<EnglishEntryhamfisted> {
  @override
  void initState() {
    super.initState();
...
1. Lacking physical movement skills, especially with the hands (- bumbling, bungling, butterfingered, ham-handed, handless, heavy-handed, left-handed)
"a ham-fisted mechanic";
""",
  );

  final String keyword = "ham-fisted";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ham-fisted""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ham-fisted""",
                      alsoEnglishWord: "also: ham-handed",
                      britshText: """IpaUK: /ˌhæm ˈfɪstɪd/""",
                      americanText: """IpaUS: /ˌhæm ˈfɪstɪd/""",
...
کوردی: دەس‌خاو، دەس‌گران، تەپ، تەپلۆس، داوەشاو، دەس‌سست، سست‌وپەلەشت، سستەپەلە، خاو، خرس، کنگ‌گران، خاووخلیچک
"""),
// With short examples define "ham-fisted", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The report criticizes the ham-fisted way in which complaints were dealt with.""",
                      kurdishText:
                          """ڕاپۆرتەکە ڕەخنە لەو شێوازە سستییە دەگرێت کە ناڕەزاییەکان مامەڵەیان لەگەڵ کرا.""",
