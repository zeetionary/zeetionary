...
class EnglishEntrylegitimate extends StatefulWidget {
  const EnglishEntrylegitimate({super.key});

  @override
  State<EnglishEntrylegitimate> createState() => _EnglishEntrylegitimateState();
}

class _EnglishEntrylegitimateState extends State<EnglishEntrylegitimate> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""legitimate""");
  }
