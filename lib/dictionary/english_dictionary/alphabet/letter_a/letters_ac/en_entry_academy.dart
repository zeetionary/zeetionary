...
class EnglishEntryacademy extends StatefulWidget {
  const EnglishEntryacademy({super.key});

  @override
  State<EnglishEntryacademy> createState() => _EnglishEntryacademyState();
}

class _EnglishEntryacademyState extends State<EnglishEntryacademy> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""academy""");
  }
  ...
  Future<void> speak25963(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("a police/military academy");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """academy""",
                      // alsoEnglishWord: "also: academy",
                      britshText: """IpaUK: /əˈkædəmi/""",
                      americanText: """IpaUS: /əˈkædəmi/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final double _startSeconds = 2977;
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = '6pWkdVipGi4';
