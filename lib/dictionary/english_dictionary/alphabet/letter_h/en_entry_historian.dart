...
class EnglishEntryhistorian extends StatefulWidget {
  const EnglishEntryhistorian({super.key});

  @override
  State<EnglishEntryhistorian> createState() => _EnglishEntryhistorianState();
}

class _EnglishEntryhistorianState extends State<EnglishEntryhistorian> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: historian (Derived forms: historians)
1. (history) a person who is an authority on history and who studies it and writes about it (- historiographer)
"a notable historian";
""",
  );

  final String keyword = "historian";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""historian""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her father was an eminent historian.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He had dared to challenge the views of an august body of imperial historians.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The historian's painstaking research resulted in an authentic understanding of the events leading up to the revolution.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He enjoyed a long and distinguished career as a historian.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Only recently have historians begun to examine the impact and influence of these changes.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Although not formally trained as an art historian, he is widely respected for his knowledge of the period.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The archive is a gold mine for historians.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001351;
    const String videoIdone = 'https://youtu.be/fn--IVarumw?t=';
    const double startSecondsone = 000000000000000000000000000815;
    const String videoIdtwo = 'https://youtu.be/CURLWPCxe-c?t=';
    const double startSecondstwo = 000000000000000000000000000151;
    const String videoIdthree = 'https://youtu.be/YwOMc-4OEWg?t=';
    const double startSecondsthree = 000000000000000000000000000349;
    const String videoIdfour = 'https://youtu.be/0IoJBV29zMg?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """historian""",
                      // alsoEnglishWord: "also: historian",
                      britshText: """IpaUK: /hɪˈstɔːriən/""",
                      americanText: """IpaUS: /hɪˈstɔːriən/""",
...
// With short examples define "historian", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) کەسێک کە لەسەر مێژوو دەنووسێت یان لێکۆڵینەوەی لێ دەکات"""),
                    SentencesRow(
                      englishText: """Her father was an eminent historian.""",
                      kurdishText: """باوکی مێژوونووسێکی ناسراو بوو.""",
                    ...
                    SentencesRow(
                      englishText: """He had dared to challenge the views of an august body of imperial historians.""",
                      kurdishText:
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The historian's painstaking research resulted in an authentic understanding of the events leading up to the revolution.""",
                      kurdishText:
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He enjoyed a long and distinguished career as a historian.""",
                      kurdishText:
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Only recently have historians begun to examine the impact and influence of these changes.""",
                      kurdishText:
            ...
            onPressedBritish: () => speaksentence6("en-GB"),
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Although not formally trained as an art historian, he is widely respected for his knowledge of the period.""",
                      kurdishText:
                          """ئەگەرچی بە فەرمی وەک مێژوونووسی ھونەری ڕاھێننای وەرنەگرتووە، تەواو ڕێزی لێ دەنرێت بۆ زانیاریی لەسەر سەردەمەکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The archive is a gold mine for historians.""",
                      kurdishText: """ئەرشیفەکە گەنجینەیەکە بۆ مێژوونووسان.""",
