...
class EnglishEntryloyal extends StatefulWidget {
  const EnglishEntryloyal({super.key});

  @override
  State<EnglishEntryloyal> createState() => _EnglishEntryloyalState();
}

class _EnglishEntryloyalState extends State<EnglishEntryloyal> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryloyal loyal
WORD_WEB loyal loyal loyal
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "loyal";
...
کوردی: 
"""),
// With short examples define "loyal", please follow LX instructions
