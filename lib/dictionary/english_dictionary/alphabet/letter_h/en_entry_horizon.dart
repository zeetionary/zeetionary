...
class EnglishEntryhorizon extends StatefulWidget {
  const EnglishEntryhorizon({super.key});

  @override
  State<EnglishEntryhorizon> createState() => _EnglishEntryhorizonState();
}

class _EnglishEntryhorizonState extends State<EnglishEntryhorizon> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: horizon (Derived forms: horizons)
1. The line at which the sky and Earth appear to meet (- apparent horizon, visible horizon, sensible horizon, skyline)
 
2. The range of interest or activity that can be anticipated (- view, purview)
"It is beyond the horizon of present knowledge";
 
3. A specific layer or stratum of soil or subsoil in a vertical cross section of land
 
4. The great circle on the celestial sphere whose plane passes through the sensible horizon and the centre of the Earth (- celestial horizon)
""",
  );

  final String keyword = "horizon";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""horizon""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The sun sank below the horizon.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She wanted to travel to broaden her horizons.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000954;
    const String videoIdone = 'https://youtu.be/0E0rarldXK0?t=';
    const double startSecondsone = 000000000000000000000000000227;
    const String videoIdtwo = 'https://youtu.be/bG-xu5H6plk?t=';
    const double startSecondstwo = 00000000000000000000000000052;
    const String videoIdthree = 'https://youtu.be/Q9WqQXqNtrc?t=';
    const double startSecondsthree = 000000000000000000000000000424;
    const String videoIdfour = 'https://youtu.be/VIW0N6AZ4wg?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """horizon""",
                      // alsoEnglishWord: "also: horizon",
                      britshText: """IpaUK: /həˈraɪzn/""",
                      americanText: """IpaUS: /həˈraɪzn/""",
...
// With short examples define "horizon", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The sun sank below the horizon.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The shadows deepened as the sun dropped below the horizon.""",
                      kurdishText:
                          "سێبەرەکان تاریک بوون کە خۆر کەوتە خوار ئاسۆ.",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەیویست گەشت بکات بۆ فراوانکردنی دیدی.""",
