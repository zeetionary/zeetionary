...
class EnglishEntryfrostbite extends StatefulWidget {
  const EnglishEntryfrostbite({super.key});

  @override
  State<EnglishEntryfrostbite> createState() => _EnglishEntryfrostbiteState();
}

class _EnglishEntryfrostbiteState extends State<EnglishEntryfrostbite> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frostbite (Derived forms: frostbites)
1. Destruction of tissue by freezing and characterized by tingling, blistering and possibly gangrene (- cryopathy)
""",
  );

  final String keyword = "frostbite";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frostbite""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The climbers were all suffering from frostbite.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frostbite""",
                      // alsoEnglishWord: "also: frostbite",
                      britshText: """IpaUK: /ˈfrɒstbaɪt/""",
                      americanText: """IpaUS: /ˈfrɔːstbaɪt/""",
...
// With short examples define "frostbite", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ شاخەوانەکان هەموویان تووشی سەرمابردوویی بووبوون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/FWYsvw_U3Zw?t=';
const double _startSecondsend = 000000000000000000000000000322;
const String _videoIdone = 'https://youtu.be/CaLOiGEDPJQ?t=';
const double _startSecondsone = 000000000000000000000000000128;
const String _videoIdtwo = 'https://youtu.be/ExoOL2lwlWE?t=';
const double _startSecondstwo = 000000000000000000000000000236;
const String _videoIdthree = 'https://youtu.be/dcnPK1HYSqQ?t=';
const double _startSecondsthree = 000000000000000000000000000836;
const String _videoIdfour = 'https://youtu.be/w0QRliFvOC0?t=';
const double _startSecondsfour = 000000000000000000000000000351;
const String _videoIdfive = 'https://youtu.be/XuEfAi0gThY?t=';
const double _startSecondsfive = 000000000000000000000000000566;
