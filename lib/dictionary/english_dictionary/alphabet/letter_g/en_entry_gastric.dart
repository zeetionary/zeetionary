...
class EnglishEntrygastric extends StatefulWidget {
  const EnglishEntrygastric({super.key});

  @override
  State<EnglishEntrygastric> createState() => _EnglishEntrygastricState();
}

class _EnglishEntrygastricState extends State<EnglishEntrygastric> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gastric""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She took medicine for her gastric pain.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gastric""",
                      // alsoEnglishWord: "also: gastric",
                      britshText: """IpaUK: /ˈɡæstrɪk/""",
                      americanText: """IpaUS: /ˈɡæstrɪk/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """She took medicine for her gastric pain.""",
                      kurdishText: """چارەسەری وەرگرت بۆ ئازاری گەدە.""",
...
const String _videoIdtwo = 'https://youtu.be/oeyt2zVqCG8?t=';
const double _startSecondstwo = 00000000000000000000000000067;
const String _videoIdthree = 'https://youtu.be/2tnwYYYAK4o?t=';
const double _startSecondsthree = 000000000000000000000000000230;
const String _videoIdfour = 'https://youtu.be/76eGLHYOKBQ?t=';
