...
class EnglishEntryfuck extends StatefulWidget {
  const EnglishEntryfuck({super.key});

  @override
  State<EnglishEntryfuck> createState() => _EnglishEntryfuckState();
}

class _EnglishEntryfuckState extends State<EnglishEntryfuck> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fuck (Derived forms: fucks)
Usage: vulgar
1. Slang for sexual intercourse (- rumpy-pumpy [informal])
 
2. Strongly and emphatically all of something

- Verb: fuck (Derived forms: fucks, fucking, fucked)
Usage: vulgar
...
"they fucked in the back of the car";
...
"I fucked up the dinner and we had to eat out";

- Interjection: fuck
Usage: vulgar
1. Exclamation of annoyance (- blast, bother [Brit], botheration, bummer [informal], curses, dang [N. Amer, informal], damn, damnation, dammit [informal], damn it [informal], darn [informal], dash [Brit, informal], durn [US, dialect], drat [informal], hang [informal], tarnation [N. Amer, informal], shoot [N. Amer, informal])
""",
  );

  final String keyword = "fuck";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They planned to fuck after the party ended.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They decided to fuck in the hotel room.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Oh, fuck! I've lost my keys.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Fuck you—I'm leaving.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Fuck it! We've missed the train.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She had a quick fuck before leaving.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""What the fuck are you doing?""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Let's get the fuck out of here!""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fuck""",
                      // alsoEnglishWord: "also: fuck",
                      britshText: """IpaUK: /fʌk/""",
                      americanText: """IpaUS: /fʌk/""",
...
// کوردی: گایین، نیاندن، قوز، خەمشە، کوز
// """),
                    const DefinitionKurdish(
                        text: """١. (کردار) هەبوونی سێکس لەگەڵ کەسێک"""),
                    SentencesRow(
                      englishText:
                          """They planned to fuck after the party ended.""",
                      kurdishText:
                          """پلانیان هەبوو لە دوای ئاهەنگەکە سێکس بکەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بڕیاریاندا لە ژووری هوتێلەکە سێکس بکەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئاه، نەفرەتی! کلیلەکانم ونکردووە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Fuck you—I'm leaving.""",
                      kurdishText: """بە جەهەنەم ـ من ئەچم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Fuck it! We've missed the train.""",
                      kurdishText:
                          """بەزیادم نەکرد! شەمەندەفەرەکەمان لە دەست دەرچوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Let's get the fuck out of here!""",
                      kurdishText: """با ملمان لێرە بشکێنینە دەرەوە!""",
...
const double _startSecondsend = 000000000000000000000000000291;
const String _videoIdone = 'https://youtu.be/_spuxXnul0U?t=';
const double _startSecondsone = 000000000000000000000000000812;
const String _videoIdtwo = 'https://youtu.be/KJy7T24rhg0?t=';
const double _startSecondstwo = 00000000000000000000000000047;
const String _videoIdthree = 'https://youtu.be/8T7lEvtwETA?t=';
const double _startSecondsthree = 00000000000000000000000000062;
const String _videoIdfour = 'https://youtu.be/4J0xFUyz1nw?t=';
const double _startSecondsfour = 000000000000000000000000000404;
const String _videoIdfive = 'https://youtu.be/XG8b7WhANNA?t=';
