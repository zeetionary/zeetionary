...
class EnglishEntryineffective extends StatefulWidget {
  const EnglishEntryineffective({super.key});

  @override
  State<EnglishEntryineffective> createState() =>
      _EnglishEntryineffectiveState();
}

class _EnglishEntryineffectiveState extends State<EnglishEntryineffective> {
  @override
  void initState() {
    super.initState();
...
1. Not producing an intended effect (- uneffective, ineffectual)
"an ineffective teacher"; "ineffective legislation";
 
2. Lacking in power or forcefulness (- ineffectual, unable, wet [Brit, informal], useless [informal], pathetic, effete)
"an ineffective ruler";
 
3. Lacking the ability or skill to perform effectively; inadequate (- inefficient)
"an ineffective administration";
""",
  );

  final String keyword = "ineffective";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ineffective""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The new drug was ineffective.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The law proved ineffective in dealing with the problem.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'https://youtu.be/aTDG16Mh2_w?t=';
    const double startSecondstwo = 00000000000000000000000000022;
    const String videoIdthree = 'https://youtu.be/60FM9WjkXtA?t=';
    const double startSecondsthree = 000000000000000000000000000791;
    const String videoIdfour = 'https://youtu.be/IGyP2uMM3i0?t=';
    const double startSecondsfour = 000000000000000000000000000556;
    const String videoIdfive = 'https://youtu.be/Bj6ulLJGPB8?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ineffective""",
                      // alsoEnglishWord: "also: ineffective",
                      britshText: """IpaUK: /ˌɪnɪˈfektɪv/""",
                      americanText: """IpaUS: /ˌɪnɪˈfektɪv/""",
...
کوردی: بێ‌ئەنجام، نەزۆک، سەرنەکەوتوو، سەرنەگرتوو، ناکاریگەر،	لێنەهاتوو، لێنەوەشاو، بێکارە، بەکارنەهاتوو، توانایی‌نەماو، هیچ‌لەدەس‌نەهاتوو، بەیدەس
"""),
// With short examples define "ineffective", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە ئەوە بەدەست نەهێنێت کە دەتەوێت"""),
                    SentencesRow(
                      englishText: """The new drug was ineffective.""",
                      kurdishText: """دەرمانە تازەکە ناکاریگەر بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """یاساکە ناکاریگەر لە مامەڵەکردن لەگەڵ کێشەکە.""",
