...
class EnglishEntryintelligibility extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intelligibility""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'VYJtb2YXae8';
    const double startSecondsend = 208;
    const String videoIdone = 'qBy63yKkoqQ';
    const double startSecondsone = 18;
    const String videoIdtwo = 'a3u_HgOAse8';
    const double startSecondstwo = 13;
    const String videoIdthree = 'DySrreILcrc';
    const double startSecondsthree = 297;
    const String videoIdfour = 'WbaggvooEZU';
    const double startSecondsfour = 0;
    const String videoIdfive = 'B6s7J-lu0WI';
