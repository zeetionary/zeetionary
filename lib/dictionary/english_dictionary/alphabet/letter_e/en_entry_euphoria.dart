...
class EnglishEntryeuphoria extends StatefulWidget {
  const EnglishEntryeuphoria({super.key});

  @override
  State<EnglishEntryeuphoria> createState() => _EnglishEntryeuphoriaState();
}

class _EnglishEntryeuphoriaState extends State<EnglishEntryeuphoria> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""euphoria""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """euphoria""",
                      // alsoEnglishWord: "also: euphoria",
                      britshText: """IpaUK: /juːˈfɔːriə/""",
                      americanText: """IpaUS: /juːˈfɔːriə/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I was in a state of euphoria all day.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Euphoria soon gave way to despair.""");
  }
...
کوردی: سەرخۆشی، سەرمەستی، شاگەشکەیی، شادی، دڵخۆشی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) هەستێکی بەهێزی خۆشی کە ماوەیەکی کەم دەخایەنێت"""),
          SentencesRow(
            englishText: """I was in a state of euphoria all day.""",
            kurdishText: """تەواوی ڕۆژەکە لە دۆخی شاگەشکەیی بووم.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Euphoria soon gave way to despair.""",
            kurdishText: """دڵخۆشی زوو بوو بە بێزاری.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """هەواڵەکە شەپۆلێک لە خۆشحاڵی لە وڵاتەکەدا دەست پێکرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: euphoria (Derived forms: euphorias)
1. A feeling of great (usually exaggerated) elation (= euphory)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/QKIobyk6Isc?t=';
const double _startSecondsend = 000000000000000000000000000000; // 329;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/ih8X45dZ5NI?t=';
const double _startSecondsone = 00000000000000000000000000000; // 13;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/RGvllptSxDQ?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 154;
const String _videoIdthree = 'VIDEOhttps://youtu.be/brZPDoEyEhA?t=';
const double _startSecondsthree = 000000000000000000000000000; // 469;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/keEDcUBL2CY?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 54;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/9u2ov8xV-sA?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1115;
