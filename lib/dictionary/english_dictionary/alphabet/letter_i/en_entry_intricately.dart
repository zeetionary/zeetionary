...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'ihwAF-zahsA';
    const double startSecondsend = 1271;
    const String videoIdone = 'x6a4hMyiwBo';
    const double startSecondsone = 335;
    const String videoIdtwo = 'HtLddZHaXOk';
    const double startSecondstwo = 80;
    const String videoIdthree = 'tyixMpuGEL8';
    const double startSecondsthree = 1825;
    const String videoIdfour = 'sw4T62rNmoA';
    const double startSecondsfour = 102;
    const String videoIdfive = '6OuJzGA0Umg';
