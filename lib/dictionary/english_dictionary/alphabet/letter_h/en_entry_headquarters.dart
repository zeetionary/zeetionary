...
class EnglishEntryheadquarters extends StatefulWidget {
  const EnglishEntryheadquarters({super.key});

  @override
  State<EnglishEntryheadquarters> createState() =>
      _EnglishEntryheadquartersState();
}

class _EnglishEntryheadquartersState extends State<EnglishEntryheadquarters> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: headquarters
1. (usually plural) the office that serves as the administrative centre of an enterprise (- central office, main office, home office, home base, base)
"many companies have their headquarters in New York";
 
2. (military) the military installation from which a commander performs the functions of command (- HQ, military headquarters)
...
""",
  ...
  final String keyword = "headquarters";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""headquarters""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The firm’s headquarters is/are in London.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'm now based at headquarters.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Headquarters in Dublin has/have agreed.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """headquarters""",
                      // alsoEnglishWord: "also: headquarters",
                      britshText: """IpaUK: /ˌhedˈkwɔːtəz/""",
                      americanText: """IpaUS: /ˈhedkwɔːrtərz/""",
...
کوردی: بەڕێوەبەڕی ناوەندی، بارەگا، بڕیارگە، ناوەندی فەرمانداری، ناوەندی سەرکردایەتی
"""),
// With short examples define "headquarters", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) شوێنێک کە دەزگایەکی لێیە یان لێیەوە ئۆپەراسیۆنێکی سەربازی کۆنترۆڵ دەکرێت"""),
                    SentencesRow(
                      englishText:
                          """The firm’s headquarters is/are in London.""",
                      kurdishText: """بارەگای کۆمپانیاکە لە لەندەنە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I'm now based at headquarters.""",
                      kurdishText: """ئێستا لە بارەگام.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بارەگای بەرلین ڕازی بوونە.""",
