...
class EnglishEntryenlist extends StatefulWidget {
  const EnglishEntryenlist({super.key});

  @override
  State<EnglishEntryenlist> createState() => _EnglishEntryenlistState();
}

class _EnglishEntryenlistState extends State<EnglishEntryenlist> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enlist""",
                      // alsoEnglishWord: "also: enlist",
                      britshText: """IpaUK: enlist""",
                      americanText: """IpaUS: enlist""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We were enlisted as helpers.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They both enlisted in 1915.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was enlisted into the US Navy.""");
  }
...
// With short examples define "enlist", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: ناونووسی کردن، داوای یارمەتیکردن، پێڕست نووسین، ڕەشبگیری کردن
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) ڕازیکردنی کەسێک کە پەیوەندیت پێوە بکات یان یارمەتیت بدات لە کردنی شتێکدا"""),
          SentencesRow(
            englishText:
                """They hoped to enlist the help of the public in solving the crime.""",
            kurdishText:
                """بەهیوابوون کە یارمەتیی خەڵکی لە چارەسەری کێشەکە وەربگرن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """We were enlisted as helpers.""",
            englishNote: "Similar: We were enlisted to help.",
            kurdishText: """وەک یارمەتیدەر گیردراین.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هەردووکیان لە ١٩١٥ چوونە سوپا.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He was enlisted into the US Navy.""",
            kurdishText: """ناونووس کرا لە هێزی دەریایی ئەمریکا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: enlist (Derived forms: enlisting, enlisted, enlists)
1. Join the military
 
2. Hire for work or assistance (= engage)
"enlist aid, help, services, or support";
 
3. Engage somebody to enter the army (= draft, muster in)
""",
  );
...
const String _videoIdone = 'https://youtu.be/NZ74oFctP_g?t=';
const double _startSecondsone = 24;
const String _videoIdtwo = 'https://youtu.be/raSeaAeryWE?t=';
const double _startSecondstwo = 576;
const String _videoIdthree = 'https://youtu.be/_0RTH57v66I?t=';
const double _startSecondsthree = 191;
const String _videoIdfour = 'https://youtu.be/qg2nGY1aqlg?t=';
const double _startSecondsfour = 1133;
const String _videoIdfive = 'https://youtu.be/gjySnrspD7E?t=';
const double _startSecondsfive = 1065;
const String _videoIdsix = 'https://youtu.be/60FM9WjkXtA?t=';
const double _startSecondssix = 148;
