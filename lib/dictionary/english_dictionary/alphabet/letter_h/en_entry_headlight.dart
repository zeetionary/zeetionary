...
class EnglishEntryheadlight extends StatefulWidget {
  const EnglishEntryheadlight({super.key});

  @override
  State<EnglishEntryheadlight> createState() => _EnglishEntryheadlightState();
}

class _EnglishEntryheadlightState extends State<EnglishEntryheadlight> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: headlight (Derived forms: headlights)
1. A powerful light with reflector; attached to the front of an automobile or locomotive (- headlamp)
""",
  );

  final String keyword = "headlight";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""headlight""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He dipped his headlights for the oncoming traffic.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """headlight""",
                      // alsoEnglishWord: "also: headlight",
                      britshText: """IpaUK: /ˈhedlaɪt/""",
                      americanText: """IpaUS: /ˈhedlaɪt/""",
...
// کوردی: چرای پێشەوە، چرای سەر(ەکی)، چراگەورە
// """),
// With short examples define "headlight", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) لایتی پێشەوەی ئۆتۆمبێل؛ ڕووناکی ئەم لایتە"""),
                    SentencesRow(
                      englishText:
                          """He dipped his headlights (= directed the light downwards) for the oncoming traffic.""",
                      kurdishText:
                          """لایتە سەرەکییەکانیی بۆ هاتووچۆی بەرانبەر نزم کردەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/KQWGHE7NTUA?t=';
const double _startSecondsend = 000000000000000000000000000130;
const String _videoIdone = 'https://youtu.be/3RkhZgRNC1k?t=';
const double _startSecondsone = 0000000000000000000000000002020;
const String _videoIdtwo = 'https://youtu.be/UzIxYdWVbm0?t=';
const double _startSecondstwo = 0000000000000000000000000001245;
const String _videoIdthree = 'https://youtu.be/hCsPV0eiqxg?t=';
const double _startSecondsthree = 00000000000000000000000000064;
const String _videoIdfour = 'https://youtu.be/vchJnrZgz-4?t=';
const double _startSecondsfour = 000000000000000000000000000856;
const String _videoIdfive = 'https://youtu.be/XxOh12Uhg08?t=';
