...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/hllf45NK-KA?t=';
    const double startSecondsend = 000000000000000000000000000869;
    const String videoIdone = 'https://youtu.be/Wiy8icSKKQs?t=';
    const double startSecondsone = 000000000000000000000000000136;
    const String videoIdtwo = 'https://youtu.be/APIvXUbye2c?t=';
    const double startSecondstwo = 000000000000000000000000000287;
    const String videoIdthree = 'https://youtu.be/72i3XhRcn0s?t=';
    const double startSecondsthree = 000000000000000000000000000301;
    const String videoIdfour = 'https://youtu.be/wPQzenQMxKs?t=';
    const double startSecondsfour = 00000000000000000000000000026;
    const String videoIdfive = 'https://youtu.be/sfkIvdwXtEY';
