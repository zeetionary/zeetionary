...
class EnglishEntryhaughty extends StatefulWidget {
  const EnglishEntryhaughty({super.key});

  @override
  State<EnglishEntryhaughty> createState() => _EnglishEntryhaughtyState();
}

class _EnglishEntryhaughtyState extends State<EnglishEntryhaughty> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: haughty (Derived forms: haughtier, haughtiest)
1. Having or showing arrogant superiority to and disdain of those one views as unworthy (- disdainful, imperious, lordly, overbearing, prideful, sniffy [informal], supercilious, swaggering, toplofty [US, informal], orgulous [archaic])
"haughty aristocrats";
""",
  );

  final String keyword = "haughty";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""haughty""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He replied with haughty disdain.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She has a rather haughty manner.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """haughty""",
                      // alsoEnglishWord: "also: haughty",
                      britshText: """IpaUK: /ˈhɔːti/""",
                      americanText: """IpaUS: /ˈhɔːti/""",
...
کوردی: بەدەمار، فیزن، لووت‌بەرز، تڕزل، خۆپێ‌زل، ئاخوڕبەرز
"""),
// With short examples define "haughty", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) ڕەفتارکردن بە ناشرینی لەگەڵ کەسانی دیکە چونکە پێتوایە لەوان باشتریت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: arrogant"),
                    SentencesRow(
                      englishText: """He replied with haughty disdain.""",
                      kurdishText:
                          """بە بێ‌ڕێزی‌پێ‌کردنی فیزاوییەوە وەڵامی دایەوە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She has a rather haughty manner.""",
                      kurdishText: """هەڵسوکەوتی کەمێک فیزاوی هەیە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/u8yL3I_6Oco?t=';
const double _startSecondsend = 000000000000000000000000000896;
const String _videoIdone = 'https://youtu.be/Solb9uA-tgQ?t=';
const double _startSecondsone = 00000000000000000000000000019501;
const String _videoIdtwo = 'https://youtu.be/fiVYYbZSnFw?t=';
const double _startSecondstwo = 00000000000000000000000000070;
const String _videoIdthree = 'https://youtu.be/n2Tg-OmOztM?t=';
const double _startSecondsthree = 000000000000000000000000000390;
const String _videoIdfour = 'https://youtu.be/WQUuMqB2XZg?t=';
const double _startSecondsfour = 000000000000000000000000000889;
const String _videoIdfive = 'https://youtu.be/fxUnwsttr_8?t=';
const double _startSecondsfive = 0000000000000000000000000001288;
