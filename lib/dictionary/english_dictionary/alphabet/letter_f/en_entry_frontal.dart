...
class EnglishEntryfrontal extends StatefulWidget {
  const EnglishEntryfrontal({super.key});

  @override
  State<EnglishEntryfrontal> createState() => _EnglishEntryfrontalState();
}

class _EnglishEntryfrontalState extends State<EnglishEntryfrontal> {
  @override
  void initState() {
    super.initState();
...
2. Meeting front to front (- head-on)
"a frontal attack";
 
3. Of or adjacent to the forehead or frontal bone
"the frontal lobes"
 
4. (meteorology) of or relating to the front of an advancing mass of air
"frontal rainfall"

- Noun: frontal (Derived forms: frontals)
1. An adornment worn on the forehead (- frontlet)
 
2. A drapery that covers the front of an altar
 
2. The face or front of a building (- facade, frontage)
""",
  );

  final String keyword = "frontal";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frontal""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They launched a frontal attack on company directors.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frontal""",
                      // alsoEnglishWord: "also: frontal",
                      britshText: """IpaUK: /ˈfrʌntl/""",
                      americanText: """IpaUS: /ˈfrʌntl/""",
...
کوردی: پێشینە، لە پێشەوە، لە بەرەوە، پێشوەیی،	بەرەیی، سەربە بەرە (هەوا)،	سەربە ناوچاوان، تەوێڵی
"""),
// With short examples define "frontal", please follow LX instructions
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) هێرشی توند و ڕاستەخۆ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """They launched a frontal attack on company directors.""",
                      kurdishText:
                          """هێرشی توندیان کردە سەر بەڕێوەبەرانی کۆمپانیاکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The frontal regions of the brain are involved in planning.""",
                      kurdishText:
                          """ناوچەکانی پێشەوەی مێشک بەژداری پلاندانانن.""",
...
const double _startSecondsone = 000000000000000000000000000670;
const String _videoIdtwo = 'https://youtu.be/gjySnrspD7E?t=';
const double _startSecondstwo = 0000000000000000000000000002705;
const String _videoIdthree = 'https://youtu.be/9UHIWVtAdhY?t=';
const double _startSecondsthree = 000000000000000000000000000290;
const String _videoIdfour = 'https://youtu.be/1RvBvYrklXM?t=';
const double _startSecondsfour = 000000000000000000000000000168;
const String _videoIdfive = 'https://youtu.be/JW_tADt9KDM?t=';
