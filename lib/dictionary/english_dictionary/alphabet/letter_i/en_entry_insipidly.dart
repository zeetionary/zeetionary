...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'oeMHMTAR_tY';
    const double startSecondsend = 21;
    const String videoIdone = 'gohKOJ7dieA';
    const double startSecondsone = 972;
    const String videoIdtwo = '3kSXE9aENVE';
    const double startSecondstwo = 140;
    const String videoIdthree = '1fl6jZRkkPI';
    const double startSecondsthree = 444;
    const String videoIdfour = 'QnQRFg4Vzus';
    const double startSecondsfour = 10069;
    const String videoIdfive = 'v3ymRPGMYes';
