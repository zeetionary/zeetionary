...
class EnglishEntryfunnily extends StatefulWidget {
  const EnglishEntryfunnily({super.key});

  @override
  State<EnglishEntryfunnily> createState() => _EnglishEntryfunnilyState();
}

class _EnglishEntryfunnilyState extends State<EnglishEntryfunnily> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: funnily
1. In a strange manner (- queerly, strangely, oddly)
"a funnily inscribed sheet of paper";
""",
  );

  final String keyword = "funnily";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""funnily""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """funnily""",
                      // alsoEnglishWord: "also: funnily",
                      britshText: """IpaUK: /ˈfʌnəli/""",
                      americanText: """IpaUS: /ˈfʌnəli/""",
...
// With short examples define "funnily", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """His face seems foreign and funnily familiar at the same time.""",
                      kurdishText:
                          """ڕووخساری وەک بیانی دەردەکەوێت و بە شێوەیەکی سەیریش ئاشنا دەردەکەوێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/XXhc5UTxv5I?t=';
const double _startSecondsend = 0000000000000000000000000001331;
const String _videoIdone = 'https://youtu.be/Unzc731iCUY?t=';
const double _startSecondsone = 0000000000000000000000000003134;
const String _videoIdtwo = 'https://youtu.be/6i9UUvxhAlY?t=';
const double _startSecondstwo = 000000000000000000000000000457;
const String _videoIdthree = 'https://youtu.be/xG1xQfvIvqQ?t=';
const double _startSecondsthree = 000000000000000000000000000213;
const String _videoIdfour = 'https://youtu.be/Ll6-eGDpimU?t=';
const double _startSecondsfour = 0000000000000000000000000001482;
const String _videoIdfive = 'https://youtu.be/v2hjeC_PoYw?t=';
