...
class EnglishEntryfluff extends StatefulWidget {
  const EnglishEntryfluff({super.key});

  @override
  State<EnglishEntryfluff> createState() => _EnglishEntryfluffState();
}

class _EnglishEntryfluffState extends State<EnglishEntryfluff> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fluff (Derived forms: fluffs)
1. Any light downy material
 
2. Something of little value or significance (= bagatelle, frippery, frivolity)
"mere rhetorical fluff";
 
3. [informal] A blunder (especially an actor's forgetting the lines)

- Verb: fluff (Derived forms: fluffed, fluffing, fluffs)
1. [informal] Make a mess of, destroy or ruin (= botch, bodge [Brit, informal], bumble, fumble, botch up, muff [informal], blow, flub [N. Amer, informal], screw up [informal], spoil, muck up [informal], bungle, bobble [N. Amer], mishandle, louse up [informal], foul up, mess up, butcher, goof up [informal], cock up [Brit, informal], balls up [informal], make a hash of [informal])
"I fluffed the dinner and we had to eat out";
 
2. Erect or fluff up (= ruffle)
"the bird fluffed its feathers";
 
3. Ruffle (one's hair) by combing the ends towards the scalp, for a full effect (= tease)
""",
  );

  final String keyword = "fluff";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This coat is covered in fluff.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The baby birds were still covered in fluff.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He completely fluffed an easy shot.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Most actors fluff their lines occasionally.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Let me fluff up your pillows for you.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The female sat on the eggs, fluffing out her feathers.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fluff""",
                      // alsoEnglishWord: "also: fluff",
                      britshText: """IpaUK: /flʌf/""",
                      americanText: """IpaUS: /flʌf/""",
...
کوردی: کوڵکە، پرزە، پڕوشە، موو، تووک، پەڕی نەرم، نەرمەپەڕ، نەرمەتووک،	شتی ئایەخ و ناگرنگ، شتی هیچەکە یان سەرسەرەکی،	هەڵە، لێ‌هەڵقڵیشان
"""),
// With short examples define "fluff", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پارچەی بچووک لە خوری، لۆکە، هتد کە لەسەر جل و ڕووی دیکە کۆدەبنەوە"""),
                    SentencesRow(
                      englishText: """This coat is covered in fluff.""",
                      kurdishText: """ئەم پاڵتاوە بە تووک داپۆشراوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """باڵندە بچووکەکان هێشتا بە کوڵکە داپۆشراو بوون.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) کردنی شتێک بە خراپی یان شکستهێنان لە شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He completely fluffed an easy shot (= in sport).""",
                      kurdishText:
                          """بە تەواوی لێدانێکی ئاسانی بەدەستەوە دا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """زۆر ئەکتەر دێڕەکانیانیان لێ تێکدەچێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """مێینەکە لەسەر هێلکەکان دانیشتبوو و پەڕەکانی ڕادەوەشاند.""",
...
const double _startSecondsend = 000000000000000000000000000180;
const String _videoIdone = 'https://youtu.be/qjqh9UVfNNk?t=';
const double _startSecondsone = 000000000000000000000000000342;
const String _videoIdtwo = 'https://youtu.be/rtAAjKBH9GU?t=';
const double _startSecondstwo = 000000000000000000000000000664;
const String _videoIdthree = 'https://youtu.be/BRi-SL5VpyE?t=';
const double _startSecondsthree = 000000000000000000000000000258;
const String _videoIdfour = 'https://youtu.be/fjCinn-sjzk?t=';
const double _startSecondsfour = 000000000000000000000000000510;
const String _videoIdfive = 'https://youtu.be/Ax5eAzV5U5s?t=';
