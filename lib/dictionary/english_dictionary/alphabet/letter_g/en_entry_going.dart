...
class EnglishEntrygoing extends StatefulWidget {
  const EnglishEntrygoing({super.key});

  @override
  State<EnglishEntrygoing> createState() => _EnglishEntrygoingState();
}

class _EnglishEntrygoingState extends State<EnglishEntrygoing> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We were all sad at her going.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""What was the reason for his going?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Walking four miles in an hour is pretty good going for me.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She had her own company by 25—not bad going!""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The path was rough going, even in daylight.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He grew up in a church-going family.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """going""",
                      // alsoEnglishWord: "also: going",
                      britshText: """IpaUK: /ˈɡəʊɪŋ/""",
                      americanText: """IpaUS: /ˈɡəʊɪŋ/""",
...
کوردی: ڕۆیشتن، چوون، ڕەو، هەرین، مەش،	(خوازە) مردن، ڕۆیشتن،	ڕەفتار، هەڵس‌وکەوت،	ڕەوش، بارودۆخ، بارودۆخی ڕێگا، باری عەرز،	خێرایی، پێشکەوتن، چوونەپێش، پێشڤەچوون،	لەبەردەس، هەیی، بەردەس،	(نرخ و هتد) ئێستا، هەنووکە،	بەبڕەو، گەشەسەندوو، بەڕمێن
"""),
// With short examples define "going", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """We were all sad at her going.""",
                      kurdishText: """هەموومان دڵتەنگ بووین بە ڕۆشتنی.""",
                    ...
                    SentencesRow(
                      englishText: """What was the reason for his going?""",
                      kurdishText: """هۆکار چی بوو بۆ چوونی؟""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) خێرایی کردنی شتێک لەلایەن کەسێکەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Walking four miles in an hour is pretty good going for me.""",
                      kurdishText: """بڕینی چوار میل لە کاتژمێرێکدا خێرایی باشە بۆ من.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She had her own company by 25—not bad going!""",
                      kurdishText: """تاوەکو ٢٥ ساڵی کۆمپانیای خۆی هەبوو ـ چوونەپێشی خراپ نییە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The path was rough going, even in daylight.""",
                      kurdishText: """ڕێگاکە لە دۆخی توندا بوو، تەنانەت لە ڕۆژیشدا.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ھاوەڵناو) بەردەوام چوونە ئەو شوێنەی کە باسکراوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He grew up in a church-going family.""",
                      kurdishText: """لە خێزانێکدا پەروەردە بوو کە هەمیشە بە دەم ڕێگای کڵێساوە بوون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/p70E1GxMP3o?t=';
const double _startSecondsend = 000000000000000000000000000535;
const String _videoIdone = 'https://youtu.be/CFRGARTeLng?t=';
const double _startSecondsone = 0000000000000000000000000003;
const String _videoIdtwo = 'https://youtu.be/oD9BaNAH-eE?t=';
const double _startSecondstwo = 00000000000000000000000000052;
const String _videoIdthree = 'https://youtu.be/-ObtCDwm2Ao?t=';
const double _startSecondsthree = 000000000000000000000000000128;
const String _videoIdfour = 'https://youtu.be/K3YnaQ64ELY?t=';
const double _startSecondsfour = 000000000000000000000000000144;
const String _videoIdfive = 'https://youtu.be/RCRHdaM3Sz0?t=';
