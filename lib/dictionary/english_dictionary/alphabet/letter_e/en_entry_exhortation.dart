...
class EnglishEntryexhortation extends StatefulWidget {
  const EnglishEntryexhortation({super.key});

  @override
  State<EnglishEntryexhortation> createState() =>
      _EnglishEntryexhortationState();
}

class _EnglishEntryexhortationState extends State<EnglishEntryexhortation> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exhortation""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exhortation""",
                      // alsoEnglishWord: "also: exhortation",
                      britshText: """IpaUK: /ˌeɡzɔːˈteɪʃn/""",
                      americanText: """IpaUS: /ˌeɡzɔːrˈteɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exhortation";
...
کوردی: داوا، داخوازی، پاڕانەوە، تکا،	هان‌دان، تین‌دان،	ڕاسپاردن، ئامۆژگاری‌کردن، نەسێحەت، شیرەت‌کردن،	ناچارکردن، پێکردن (بە ئامۆژگاری)، پێداگرتن، سووربوون
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) هەوڵدانی زۆر بۆ ڕازیکردنی کەسێک تاوەکو شتێک بکات"""),
          SentencesRow(
            englishText:
                """The play becomes a strong exhortation to enjoy life while you still can.""",
            kurdishText:
                """شانۆکە هاندانێکی بەهێزە بۆ چێژبینین لە ژیان تاوەکو دەتوانیت.""",
            englishNote:
                "This means that the play powerfully encourages or urges people to make the most of life and find joy in it while they have the opportunity.",
          ...
          SentencesRow(
            englishText:
                """Experience shows that encouragement and exhortation have not produced change.""",
            kurdishText:
                """ئەزموون دەری دەخات هاندان و تکا کردن گۆڕانیان درووست نەکردووە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: exhortation (Derived forms: exhortations)
1. A communication intended to urge or persuade the recipients to take some action
 
2. The act of exhorting; an earnest attempt at persuasion (= incitement)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/XK08CKO-yAQ?t=';
const double _startSecondsend = 000000000000000000000000000000; // 788;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/X0QUMfxAv_c?t=';
const double _startSecondsone = 00000000000000000000000000000; // 181;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/CSbx8KnNl9c?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 955;
const String _videoIdthree = 'VIDEOhttps://youtu.be/PwQYefFrki0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 696;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/MJDmjFPFFJc?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 434;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/WY4jWGbekwE?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 270;
