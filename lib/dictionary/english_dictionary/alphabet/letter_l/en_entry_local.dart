...
class EnglishEntrylocal extends StatefulWidget {
  const EnglishEntrylocal({super.key});

  @override
  State<EnglishEntrylocal> createState() => _EnglishEntrylocalState();
}

class _EnglishEntrylocalState extends State<EnglishEntrylocal> {
  @override
  void initState() {
    super.initState();
...
2. Of or belonging to or characteristic of a particular locality or neighbourhood
"local customs"; "local schools"; "the local citizens"; "a local point of view"; "local outbreaks of flu"; "a local bus line"
 
3. (medicine) affecting only a restricted part or area of the body
"local anaesthesia"

- Noun: local (Derived forms: locals)
...
2. Anaesthetic that numbs a particular area of the body (- local anesthetic [N. Amer], local anaesthetic [Brit, Cdn], topical anesthetic, topical anaesthetic)
 
3. A person who lives nearby
 
4. [UK, informal] A local pub
""",
  );

  final String keyword = "local";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A local man was accused of the murder.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Our children go to the local school.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her tooth was extracted under local anaesthetic.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She’s beginning to sound like one of the locals.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The locals are very friendly.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It's a local with good beer.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/1XKSo2mFC6c?t=283';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/j1BfO7VlIw4?t=529';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/VrKW58MS12g?t=1192';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/gWOXSh4-Iuc?t=240';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/QiKZYt9070U?t=135';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/QLq6GEiHqR8?t=1078';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """local""",
                      // alsoEnglishWord: "also: local",
                      britshText: """IpaUK: /ˈləʊkl/""",
                      americanText: """IpaUS: /ˈləʊkl/""",
...
کوردی: خۆجێیی، لاخۆیی، خۆلایی، ناوچەیی، خۆماڵی
"""),
// With short examples define "local", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) پەیوەندیدار بەو شوێنەی کە باسی دەکەیت یان تێیدا دەژیت"""),
                    SentencesRow(
                      englishText: """A local man was accused of the murder.""",
                      kurdishText: """پیاوێکی خۆجێی بە کوشتنەکە تۆمەتبار کرا.""",
                    ...
                    SentencesRow(
                      englishText: """Our children go to the local school.""",
                      kurdishText: """منداڵەکانمان دەچنە قوتابخانە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵناو) کە تەنها کاریگەریی لەسەر یەک بەشی جەستە دەبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her tooth was extracted under local anaesthetic.""",
                      kurdishText: """ددانەکەی دەرهێندرا لە ژێر بەنجی ناوچەیی.""",
                      englishNote: """This means her tooth was removed while she was given a medication that numbed only a specific area of her body, without causing unconsciousness.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) کەسێک کە لە ناوچەیەکی دیاریکراودا دەژی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She’s beginning to sound like one of the locals.""",
                      kurdishText: """دەستیکردووە بەوەی وەک یەکێک لە کەسە خۆجێییەکان دەربکەوێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The locals are very friendly.""",
                      kurdishText: """دانیشتووانە خۆجێییەکە زۆر ڕووخۆشن.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ناو) مەیخانەیەک نزیک لەو شوێنەی کە دەژیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """It's a local with good beer.""",
                      kurdishText: """مەیخانەیەکی کە بیرەی چاکی هەیە.""",
