...
class EnglishEntryjiggle extends StatefulWidget {
  const EnglishEntryjiggle({super.key});

  @override
  State<EnglishEntryjiggle> createState() => _EnglishEntryjiggleState();
}

class _EnglishEntryjiggleState extends State<EnglishEntryjiggle> {
  @override
  void initState() {
    super.initState();
