...
class EnglishEntryfathomless extends StatefulWidget {
  const EnglishEntryfathomless({super.key});

  @override
  State<EnglishEntryfathomless> createState() => _EnglishEntryfathomlessState();
}

class _EnglishEntryfathomlessState extends State<EnglishEntryfathomless> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fathomless""",
                      // alsoEnglishWord: "also: fathomless",
                      britshText: """IpaUK: /ˈfæðəmləs/""",
                      americanText: """IpaUS: /ˈfæðəmləs/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "fathomless";
...
کوردی: قووڵ، بێ‌بن، بێ‌بنک،	لە ئەندازبەدەر، بێ‌کۆتایی، لەدوایی‌نەهاتوو،	ئاڵۆز، لێڵ، ڕێ‌پێنەبراو، سەرەندەرنەکراو، سەرلێدەرنەهێنراو
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) هێندە قووڵ کە پێوانە ناکرێت"""),
          SentencesRow(
            englishText:
                """She gazed into the fathomless depths of his brown eyes.""",
            kurdishText:
                """(خوازراوی) ڕووانی لە قوڵایی بێ‌کۆتای چاوە قاوەییەکانی.""",
...
1. Incapable of being fathomed; immeasurable; bottomless
...
const String _videoIdend = 'https://youtu.be/0gLeTpus6Wo?t=';
const double _startSecondsend = 00000000000000000000000000024;
const String _videoIdone = 'https://youtu.be/Solb9uA-tgQ?t=';
const double _startSecondsone = 0000000000000000000000000001450;
const String _videoIdtwo = 'https://youtu.be/j4IHEWOWwcs?t=';
const double _startSecondstwo = 000000000000000000000000000556;
const String _videoIdthree = 'https://youtu.be/41elK59iygE?t=';
const double _startSecondsthree = 0000000000000000000000000003430;
const String _videoIdfour = 'https://youtu.be/7PKoPAMozZo?t=';
const double _startSecondsfour = 000000000000000000000000000427;
const String _videoIdfive = 'https://youtu.be/iYVqOBZDJVU?t=';
