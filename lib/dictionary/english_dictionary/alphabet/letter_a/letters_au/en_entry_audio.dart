...
class EnglishEntryaudio extends StatelessWidget {
  ...
  Future<void> speakaudio136(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("The audio quality was poor.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɔːdiəʊ/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɔːdiəʊ/"),
...
١. (ھاوەڵناو) پەیوەندیدار بە دەنگ"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakaudio136("en-US"),
                          ),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final double _startSeconds = 2278;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 3139;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'LLYB5lGR6H0';
