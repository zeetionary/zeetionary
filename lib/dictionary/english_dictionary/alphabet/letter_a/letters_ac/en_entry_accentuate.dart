...
class EnglishEntryaccentuate extends StatelessWidget {
  EnglishEntryaccentuate({super.key});
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "accentuate"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əkˈsentʃueɪt/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakaccentuate("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əkˈsentʃueɪt/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakaccentuate("en-US"),
                            ),
                          ],
                        ),
                      ],
