...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'yAHypkGO1C0';
    const double startSecondsend = 158;
    const String videoIdone = 'OwbD5Bn96TI';
    const double startSecondsone = 438;
    const String videoIdtwo = 'SHgQeBk7zIs';
    const double startSecondstwo = 155;
    const String videoIdthree = 'O_w_mKbK0kU';
    const double startSecondsthree = 516;
    const String videoIdfour = 'zeEUgZlogkM';
    const double startSecondsfour = 53;
    const String videoIdfive = 'BU_AcWnhxSc';
