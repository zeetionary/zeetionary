...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '8Poi5x0E2CM';
    const double startSecondsend = 2202;
    const String videoIdone = 'jHJSG9YtEZk';
    const double startSecondsone = 377;
    const String videoIdtwo = 'LwfqyIDvQWM';
    const double startSecondstwo = 356;
    const String videoIdthree = 'R2e2RbN7kVI';
    const double startSecondsthree = 1005;
    const String videoIdfour = '8K6l7pFCBQw';
    const double startSecondsfour = 4;
    const String videoIdfive = '712VvC9Vwg4';
