...
class EnglishEntryglacial extends StatefulWidget {
  const EnglishEntryglacial({super.key});

  @override
  State<EnglishEntryglacial> createState() => _EnglishEntryglacialState();
}

class _EnglishEntryglacialState extends State<EnglishEntryglacial> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""glacial""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Many animals went extinct after the glacial period.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The dining room was glacial.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her expression was glacial.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glacial""",
                      // alsoEnglishWord: "also: glacial",
                      britshText: """IpaUK: /ˈɡleɪʃl/,  /ˈɡleɪsiəl/""",
                      americanText: """IpaUS: /ˈɡleɪʃl/""",
...
// With short examples define "glacial", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) پەیوەندیدار بە سەردەمی سەهۆڵبەندان"""),
                    SentencesRow(
                      englishText:
                          """Many animals went extinct after the glacial period.""",
                      kurdishText:
                          """زۆر ئاژەڵ لەناوچوون لە دوای سەردەمی سەهۆڵبەندان.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە بەهۆی شەختە بەفری گەورەوە درووست بووە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The valley is filled with glacial deposits from ancient ice.""",
                      kurdishText:
                          """دۆڵەکە پڕە لە چینی سەهۆڵین بەهۆی شەختەی کۆنەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/LXkO4HdQXdo?t=';
const double _startSecondsend = 000000000000000000000000000158;
const String _videoIdone = 'https://youtu.be/5d6SEQQbwtU?t=';
const double _startSecondsone = 000000000000000000000000000720;
const String _videoIdtwo = 'https://youtu.be/Z0SzIkheaFg?t=';
const double _startSecondstwo = 000000000000000000000000000218;
const String _videoIdthree = 'https://youtu.be/L2ivI-WIunc?t=';
const double _startSecondsthree = 000000000000000000000000000265;
const String _videoIdfour = 'https://youtu.be/rvRCKgw2B8k?t=';
const double _startSecondsfour = 00000000000000000000000000024;
const String _videoIdfive = 'https://youtu.be/p01hH7_5U4g?t=';
const double _startSecondsfive = 000000000000000000000000000147;
