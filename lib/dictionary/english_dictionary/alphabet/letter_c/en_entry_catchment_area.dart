...
١. (ناو) ناوچەیەک کە خوێندنگە بەرپرسە لە وەرگرتنی خوێندکار لێوەی، یان نەخۆشخانە دەبێت نەخۆشی لێوە وەربگرێت """),
                              ...
                              const Expanded(
                                child: Column(
                                  children: [
                                    ...
                                    ExampleSentenceKurdish(
                                        text:
                                            "ئەگەر سەنتەرێکی چارەسەر هەیە کە دەتەوێت بۆی بچیت، سارد مەبەوە ئەگەر پێت بڵێن سەر بەو مەڵبەندی خزمەتگوزارییە نیت."),
                                  ],
                                ),
                              ),
                          ...
                          const DefinitionKurdish(
                              text:
                                  "٢. (ناو) ناوچەیەک کە لێیەوە ئاو تێکەڵ دەبێت بە ڕووبارێک، دەریاچەیەک، زۆنگاوێک، هتد"),
                          Row(
                            children: [
                              const Expanded(
                                child: Column(
                                  children: [
                                    ...
                                    ExampleSentenceKurdish(
                                        text:
                                            "تازەگی بارانێکی زۆر هەبووە لە ڕێژگەی ڕووبارەکە."),
                                  ],
                                ),
                              ),
                              const CustomSizedBoxForTTS(),
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/pOq9N5YzqV0?t=',
    startSeconds: 465,
    autoPlay: true,
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/DpTTGFbn5Xc?t=',
    startSeconds: 667,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/bFx9YlnAP2M?t=',
    startSeconds: 1915,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/QqWWEFc-Z1M?t=',
    startSeconds: 135,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/uyU1QfJAufk?t=',
    startSeconds: 652,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/HZmzdymreq0?t=',
    startSeconds: 30,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/56OShfOwkm0?t=',
    startSeconds: 88,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/72O6mQnZim0?t=',
    startSeconds: 131,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
