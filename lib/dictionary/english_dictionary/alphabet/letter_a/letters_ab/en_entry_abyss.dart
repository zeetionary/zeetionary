...
class EnglishEntryabyss extends StatefulWidget {
  const EnglishEntryabyss({super.key});

  @override
  State<EnglishEntryabyss> createState() => _EnglishEntryabyssState();
}

class _EnglishEntryabyssState extends State<EnglishEntryabyss> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: abyss (derived forms: abysses)
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """abyss""",
                      // alsoEnglishWord: "also: abyss",
                      britshText: """IpaUK: /əˈbɪs/""",
                      americanText: """IpaUS: /əˈbɪs/""",
