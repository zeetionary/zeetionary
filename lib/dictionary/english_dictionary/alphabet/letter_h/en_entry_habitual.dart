...
کوردی: ئاسایی، ھەمیشەیی، عەدەتی،	گیرۆدە، ڕاھاتوو، عادەت‌کردوو، خدەگرتوو، فێر،	لە ڕووی عادەتەوە، واخووگرتوو، واڕاھاتوو
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بۆ وەڵامدانەوە ھەمیشەییەکەی وەستان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کەوتەوە سەر ڕووگرژییە ھەمیشەییەکەی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Is habitual drunkenness considered to be grounds for divorce?""",
                      kurdishText:
                          """ئایا سەرخۆشیی عادەتییانە بە ھۆکارێکی باش دادەنرێت بۆ جیابوونەوە؟""",
...
const String _videoIdend = 'L1HCG3BGK8I';
const double _startSecondsend = 217;
const String _videoIdone = '87y1_IbJRZE';
const double _startSecondsone = 1220;
const String _videoIdtwo = 'sY8aFSY2zv4';
const double _startSecondstwo = 7962;
const String _videoIdthree = 'HGezagpjZiA';
const double _startSecondsthree = 2027;
const String _videoIdfour = 'QKIobyk6Isc';
const double _startSecondsfour = 418;
const String _videoIdfive = 'jcL4JEqFlg0';
