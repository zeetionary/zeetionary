...
class EnglishEntryastride extends StatelessWidget {
  ...
  Future<void> speakastride(String languageCode) async {
    ...
    await flutterTts.speak("astride");
  }
  ...
  Future<void> speakastride351(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She sat proudly astride her new motorbike.");
  }
  ...
  Future<void> speakastride352(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The town lies astride (= on either side of) the River Havel.");
  }
  ...
  Future<void> speakastride354(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He stood there, legs astride.");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "astride"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈstraɪd/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈstraɪd/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakastride351("en-US"),
                          ),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakastride352("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
...
٢. (ھاوەڵکار) بە ھەر قاچێک لە لایەکەوە، یان بە لاق‌بڵاوی"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakastride354("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: astride
1. With one leg on each side (= astraddle)
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '6MaUi4OWQ9s';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '1Fg2ZE1-jo4';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '6lf9q6OQse0';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'QChjRtTd1L8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '4pITlnrvhrY';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '2i_yAoWqPJA';
  final double _startSeconds = 3446;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'Z6dvGXiT5H8';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'dFIBwOSnih0';
  final double _startSeconds = 4078;
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'hMNzZiN0-P0';
  final double _startSeconds = 4078;
