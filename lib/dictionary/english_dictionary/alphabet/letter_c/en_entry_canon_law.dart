...
class EnglishEntrycanonlaw extends StatelessWidget {
// blank divider
  EnglishEntrycanonlaw({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcanonlaw(String languageCode) async {
    // DOPSUM: CHANGE speakcanonlaw
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "canon law"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌkænən ˈlɔː/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcanonlaw("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌkænən ˈlɔː/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcanonlaw("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final double _startSeconds = 3385;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'n8et6TBkAwU';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '06IdN8chAVw';
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  ...
  final String _videoId = 'c0e-D-Fo_J4';
  final double _startSeconds = 2930;
...
class _YoutubeEmbeddedsevenState extends State<YoutubeEmbeddedseven> {
  ...
  final double _startSeconds = 7950;
...
class _YoutubeEmbeddedeightState extends State<YoutubeEmbeddedeight> {
  late YoutubePlayerController _controller;
  final String _videoId = 'XjnXgb6CzFg';
