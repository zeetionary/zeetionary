...
class EnglishEntryhonesty extends StatefulWidget {
  const EnglishEntryhonesty({super.key});

  @override
  State<EnglishEntryhonesty> createState() => _EnglishEntryhonestyState();
}

class _EnglishEntryhonestyState extends State<EnglishEntryhonesty> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: honesty (Derived forms: honesties)
1. The quality of being honest (- honestness)
 
3. Southeastern European plant cultivated for its fragrant purplish flowers and round flat papery silver-white seedpods that are used for indoor decoration (- silver dollar, money plant, satin flower, satinpod, Lunaria annua)
""",
  );

  final String keyword = "honesty";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""honesty""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondstwo = 0000000000000000000000000001331;
    const String videoIdthree = 'https://youtu.be/CQQit01HHLY?t=';
    const double startSecondsthree = 0000000000000000000000000001565;
    const String videoIdfour = 'https://youtu.be/anbBwpoI9TI?t=';
    const double startSecondsfour = 000000000000000000000000000622;
    const String videoIdfive = 'https://youtu.be/EobMnSpjfTU?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """honesty""",
                      // alsoEnglishWord: "also: honesty",
                      britshText: """IpaUK: /ˈɒnəsti/""",
                      americanText: """IpaUS: /ˈɑːnəsti/""",
