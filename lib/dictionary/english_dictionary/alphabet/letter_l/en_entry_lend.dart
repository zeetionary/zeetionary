...
class EnglishEntrylend extends StatefulWidget {
  const EnglishEntrylend({super.key});

  @override
  State<EnglishEntrylend> createState() => _EnglishEntrylendState();
}

class _EnglishEntrylendState extends State<EnglishEntrylend> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: lend (Derived forms: lent, lends, lending)
1. Provide a particular quality or character (- impart, bestow, contribute, add, bring)
"Her presence lends a certain cachet to the company";
 
2. Give temporarily; let have for a limited time (- loan)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They will lend equipment free of charge.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I've lent the car to a friend.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The gallery has been willing to lend out works of art in the past.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Can you lend me £10?""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Has he returned that book you lent him?""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She very kindly lent me her bicycle.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The bank lends money at very cheap rates.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They refused to lend us the money.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her presence lent the occasion a certain dignity.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I was more than happy to lend my support to such a good cause.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He came along to lend me moral support.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/jtoq3S48Pgk?t=601';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/GfHOoFVUk9Y?t=116';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/mFH_r2w28rM?t=49';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/BWDYUMTmHjU?t=16';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/4pSAjI9lOGY';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/u-M9uIqPLXc?t=59';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lend""",
                      // alsoEnglishWord: "also: lend",
                      britshText: """IpaUK: /lend/""",
                      americanText: """IpaUS: /lend/""",
...
کوردی: 
"""),
// With short examples define "lend", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) پێدانی شتێک بە کەسێک کە دەبێت دواتر بیگەڕێننەوە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: loan"),
                    SentencesRow(
                      englishText: """They will lend equipment free of charge.""",
                      kurdishText: """کەرەستە بەبێ هیچ نرخێک بە قەرز دەدەن.""",
                    ...
                    SentencesRow(
                      englishText: """I've lent the car to a friend.""",
                      kurdishText: """ئۆتۆمبێلەکەم داوە بە هاوڕێیەک.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The gallery has been willing to lend out works of art in the past.""",
                      kurdishText: """پێشانگاکە ئامادە بووە لە ڕابردوودا کە کاری هونەری بە قەرز بدات.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Can you lend me £10?""",
                      kurdishText: """دەتوانیت ١٠ پاوەندم بە قەرز پێ بدەیت؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Has he returned that book you lent him?""",
                      kurdishText: """ئەو پەرتووکەی گەڕاندووەتەوە کە بە قەرز پێتداوە؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She very kindly lent me her bicycle.""",
                      kurdishText: """زۆر میهرەبانابە پاسکیلەکەیی بە قەرز پێمدا.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) پێدانی پارە بە قەزر بە کەسێک بەو مەرجەی بە سووەوە بیداتەوە"""),const AlsoEnglishckb(word: "ھەروەھا: loan"),
                    SentencesRow(
                      englishText: """The bank lends money at very cheap rates.""",
                      kurdishText: """بانکەکە بە سووی زۆر کەم پارە بە قەرز دەدات.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They refused to lend us the money.""",
                      kurdishText: """ڕەتیان کردەوە پارەکەمان بە قەرز پێبدەن.""",
                      onPressedBritish: () => speaksentence8("en-GB"),
                      onPressedAmerican: () => speaksentence8("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) پێدانی خاسیەتێکی دیاریکراو بە کەس یان شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her presence lent the occasion a certain dignity.""",
                      kurdishText: """ئامادەیی ئەو شانازییەکی تایبەتی دا بە بۆنەکە.""",
                      onPressedBritish: () => speaksentence9("en-GB"),
                      onPressedAmerican: () => speaksentence9("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) یارمەتیدانی خەڵکی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I was more than happy to lend my support to such a good cause.""",
                      kurdishText: """زۆر دڵخۆش بووم کە پشتیوانی خۆم بدەم بە دۆزێکی وەها باش.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He came along to lend me moral support.""",
                      kurdishText: """ئامادەیی پیشان دا کە پشتیوانیی مەعنەویم بکات.""",
