...
class EnglishEntrylayabout extends StatefulWidget {
  const EnglishEntrylayabout({super.key});

  @override
  State<EnglishEntrylayabout> createState() => _EnglishEntrylayaboutState();
}

class _EnglishEntrylayaboutState extends State<EnglishEntrylayabout> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""layabout""");
  }
