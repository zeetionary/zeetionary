...
class EnglishEntryinnovator extends StatefulWidget {
  const EnglishEntryinnovator({super.key});

  @override
  State<EnglishEntryinnovator> createState() => _EnglishEntryinnovatorState();
}

class _EnglishEntryinnovatorState extends State<EnglishEntryinnovator> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""innovator""");
  }
