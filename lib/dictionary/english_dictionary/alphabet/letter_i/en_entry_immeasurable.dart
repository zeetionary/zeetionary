...
class EnglishEntryimmeasurable extends StatefulWidget {
  ...
  @override
  State<EnglishEntryimmeasurable> createState() =>
      _EnglishEntryimmeasurableState();
}
...
1. Beyond calculation or measure (- incomputable, inestimable)
"immeasurable wealth";
 
2. Impossible to measure (- unmeasurable, immensurable, immensurate)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Her contribution was of immeasurable importance.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/7Vm282YvOGw?t=';
    const double startSecondsend = 0000000000000000000000000001281;
    const String videoIdone = 'https://youtu.be/ZU_MF0NMKhU?t=';
    const double startSecondsone = 00000000000000000000000000058;
    const String videoIdtwo = 'https://youtu.be/2N0jtSW9kwg?t=';
    const double startSecondstwo = 000000000000000000000000000174;
    const String videoIdthree = 'https://youtu.be/wiCRhrWpDbI?t=';
    const double startSecondsthree = 00000000000000000000000000094;
    const String videoIdfour = 'https://youtu.be/IvNc9yDox8U?t=';
    const double startSecondsfour = 000000000000000000000000000886;
    const String videoIdfive = 'https://youtu.be/6g57DJntRXk?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      britshText: """IpaUK: /ɪˈmeʒərəbl/""",
                      americanText: """IpaUS: /ɪˈmeʒərəbl/""",
...
کوردی: بەرین، بەربڵاو، بەرفرەهـ، بێ‌ئەندازە، لەڕادەبەدەر، نەپێوراو، بێ‌پێوانە
"""),
// With short examples define "immeasurable", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) زۆر گەورە، فراوان، قووڵ، هتد کە بپێورێت"""),
                    SentencesRow(
                      englishText:
                          """Her contribution was of immeasurable importance.""",
                      kurdishText:
                          """بەژدارییەکانی جێگای گرنگی بێ‌ئەندازە بوون.""",
