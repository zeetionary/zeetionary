...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'DWmGArQBtFI';
    const double startSecondsend = 177;
    const String videoIdone = 'CsTmgX32Uk8';
    const double startSecondsone = 239;
    const String videoIdtwo = 'JObYtU7Y7ag';
    const double startSecondstwo = 21;
    const String videoIdthree = 'FTKP0Y9MVus';
    const double startSecondsthree = 124;
    const String videoIdfour = 'fvu5FxKuqdQ';
    const double startSecondsfour = 626;
    const String videoIdfive = 'vS0TuIPoeBs';
    const double startSecondsfive = 217;
