...
class EnglishEntryjungle extends StatefulWidget {
  const EnglishEntryjungle({super.key});

  @override
  State<EnglishEntryjungle> createState() => _EnglishEntryjungleState();
}

class _EnglishEntryjungleState extends State<EnglishEntryjungle> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The area was covered in dense jungle.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Our garden is a complete jungle.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/y1V1Am0koSA?t=582';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/tXjHb5QmDV0?t=287';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/gO_gm74yiUY?t=684';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/_Z0ZQT0FttM';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/V2ec7EE0pB8?t=1947';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/YkmlPaGui5k?t=1680';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """jungle""",
                      // alsoEnglishWord: "also: jungle",
                      britshText: """IpaUK: /ˈdʒʌŋɡl/""",
                      americanText: """IpaUS: /ˈdʒʌŋɡl/""",
...
کوردی: دارستان، نزار، دەحل، بێشەڵان، جەنگەڵ، جەنگەڵستان
"""),
// With short examples define "jungle", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ناوچەیەک لە دارستانی خولگەیی کە تێیدا دار و ڕووەک بە چڕی گەشە دەکەن"""),
                    SentencesRow(
                      englishText: """The area was covered in dense jungle.""",
                      kurdishText: """ناوچەکە بە جەنگەڵی چڕ داپۆشرا بوو.""",
                    ...
                    SentencesRow(
                      englishText: """Our garden is a complete jungle.""",
                      kurdishText:
                          """(خوازراوی) باخچەکەمان جەنگەڵێکی تەواوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) شوێن یان دۆخێکی مەترسیدار، بە تایبەتی یەکێک کە زۆر سەختە تێیدا متمانە بە کەس بکەیت یان سەرکەوتوو بیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """It's a jungle out there—you've got to be strong to succeed.""",
                      kurdishText:
                          """دوونیایەکی سەختە ئەوێ ـ دەبێت بەهێز بیت بۆ سەرکەوتن.""",
