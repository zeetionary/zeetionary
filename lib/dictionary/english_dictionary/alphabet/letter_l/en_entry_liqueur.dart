...
class EnglishEntryliqueur extends StatefulWidget {
  const EnglishEntryliqueur({super.key});

  @override
  State<EnglishEntryliqueur> createState() => _EnglishEntryliqueurState();
}

class _EnglishEntryliqueurState extends State<EnglishEntryliqueur> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: liqueur (Derived forms: liqueurs)
1. Strong highly flavoured sweet liquor usually drunk after a meal (- cordial)
""",
  );

  final String keyword = "liqueur";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""liqueur""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She sipped a cherry liqueur after dinner.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/Jl0IDXkYKbk?t=321';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/3cxHwQl9pNM?t=471';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/s3B-qp3U5G0?t=1236';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/KB0kltHtnBA?t=417';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/vA7w-s4khrY?t=349';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/cFdCzN7RYbw?t=117';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """liqueur""",
                      // alsoEnglishWord: "also: liqueur",
                      britshText: """IpaUK: /lɪˈkjʊə(r)/""",
                      americanText: """IpaUS: /lɪˈkɜːr/""",
...
کوردی: 
"""),
                    const DefinitionKurdish(text: """١. (ناو) خواردنەوەیەکی کحوولی شیرینی توند کە تامی میوە دەدات و زۆرجار لە گڵاسی بچووکدا دەخورێت لە دوای ژەمە خواردنێک"""),
                    SentencesRow(
                      englishText: """She sipped a cherry liqueur after dinner.""",
                      kurdishText: """دوای نانخواردن شەربەتی شاتووی خواردەوە.""",
