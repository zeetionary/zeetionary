...
class EnglishEntrygeneralpractitioner extends StatefulWidget {
  const EnglishEntrygeneralpractitioner({super.key});

  @override
  State<EnglishEntrygeneralpractitioner> createState() =>
      _EnglishEntrygeneralpractitionerState();
}

class _EnglishEntrygeneralpractitionerState
    extends State<EnglishEntrygeneralpractitioner> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "general practitioner";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""general practitioner""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""You should go to see your general practitioner.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      alsoEnglishWord:
                          "also: family doctor, family practitioner, primary care physician, PCP",
                      britshText: """IpaUK: /ˌdʒenrəl prækˈtɪʃənə(r)/""",
                      americanText: """IpaUS: /ˌdʒenrəl prækˈtɪʃənər/""",
...
// With short examples define "general practitioner", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەبێت بچیت پزیشکە گشتییەکەت ببینیت.""",
...
const String _videoIdend = 'https://youtu.be/HczFMLiFlGw?t=';
const double _startSecondsend = 000000000000000000000000000178;
const String _videoIdone = 'https://youtu.be/OveCbIhWg9Y?t=';
const double _startSecondsone = 00000000000000000000000000013;
const String _videoIdtwo = 'https://youtu.be/E7_HyULzL8o?t=';
const double _startSecondstwo = 000000000000000000000000000138;
const String _videoIdthree = 'https://youtu.be/of2zkCF1yEU?t=';
const double _startSecondsthree = 000000000000000000000000000258;
const String _videoIdfour = 'https://youtu.be/alPt0oJabFU?t=';
const double _startSecondsfour = 0000000000000000000000000001166;
const String _videoIdfive = 'https://youtu.be/fjD4e5wo2mE?t=';
const double _startSecondsfive = 0000000000000000000000000001268;
