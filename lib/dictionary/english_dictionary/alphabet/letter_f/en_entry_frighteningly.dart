...
class EnglishEntryfrighteningly extends StatefulWidget {
  const EnglishEntryfrighteningly({super.key});

  @override
  State<EnglishEntryfrighteningly> createState() =>
      _EnglishEntryfrighteninglyState();
}

class _EnglishEntryfrighteninglyState extends State<EnglishEntryfrighteningly> {
  @override
  void initState() {
    super.initState();
...
1. In a terrifying manner (= scarily, chillingly, terrifyingly, spine-chillingly)
"the disturbing thing about the Minister's behaviour is that far from being artificial, it too often rings frighteningly true";
""",
  );

  final String keyword = "frighteningly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frighteningly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The battle scenes were frighteningly realistic.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frighteningly""",
                      // alsoEnglishWord: "also: frighteningly",
                      britshText: """IpaUK: /ˈfraɪtnɪŋli/""",
                      americanText: """IpaUS: /ˈfraɪtnɪŋli/""",
...
// With short examples define "frighteningly", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دیمەنی جەنگەکان ترسێنەرانە ڕاستەقینە بوون.""",
...
const double _startSecondsone = 000000000000000000000000000917;
const String _videoIdtwo = 'https://youtu.be/r_iNRGac_uM?t=';
const double _startSecondstwo = 000000000000000000000000000212;
const String _videoIdthree = 'https://youtu.be/YDNNIttJXUE?t=';
const double _startSecondsthree = 000000000000000000000000000733;
const String _videoIdfour = 'https://youtu.be/CwlTFQqdI3I?t=';
const double _startSecondsfour = 000000000000000000000000000398;
const String _videoIdfive = 'https://youtu.be/oJLA8iNUV-0?t=';
const double _startSecondsfive = 000000000000000000000000000865;
