...
class EnglishEntryimposing extends StatefulWidget {
  const EnglishEntryimposing({super.key});

  @override
  State<EnglishEntryimposing> createState() => _EnglishEntryimposingState();
}

class _EnglishEntryimposingState extends State<EnglishEntryimposing> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""imposing""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'LXhLlWQtdt0';
    ...
    const String videoIdthree = 'ErPsyBUCijM';
    const double startSecondsthree = 489;
    const String videoIdfour = 'Rn1WnrH-pdw';
    const double startSecondsfour = 196;
    const String videoIdfive = 'awoQuVq2yYc';
