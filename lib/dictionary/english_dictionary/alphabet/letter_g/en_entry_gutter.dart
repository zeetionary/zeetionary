...
class EnglishEntrygutter extends StatefulWidget {
  const EnglishEntrygutter({super.key});

  @override
  State<EnglishEntrygutter> createState() => _EnglishEntrygutterState();
}

class _EnglishEntrygutterState extends State<EnglishEntrygutter> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gutter (Derived forms: gutters)
1. A channel along the eaves or on the roof; collects and carries away rainwater (- trough, eavestrough [Cdn])
 
2. Misfortune resulting in lost effort or money (- sewer, toilet)
...
- Verb: gutter (Derived forms: guttered, guttering, gutters)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The blocked gutter was filled with leaves and debris.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The city crews cleared the gutters after the heavy storm to prevent flooding.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She rose from the gutter to become a great star.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gutter""",
                      // alsoEnglishWord: "also: gutter",
                      britshText: """IpaUK: /ˈɡʌtə(r)/""",
                      americanText: """IpaUS: /ˈɡʌtər/""",
...
// With short examples define "gutter", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ئاوەڕۆی خوار قەراغی سەربانی بینایەک"""),
                    SentencesRow(
                      englishText: """The blocked gutter was filled with leaves and debris.""",
                      kurdishText: """ئاوەڕۆ گیراوەکە پڕبوو لە گەڵا و پاشماوە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ئاوەڕۆی قەراغ ڕێگا کە لێیەوە ئاو دەچێتە ناو زێرابەکان"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The city crews cleared the gutters after the heavy storm to prevent flooding.""",
                      kurdishText: """کرێکارانی شارەکە ئاوەڕۆکانیان پاککردەوە لە دوای زریانە بەهێزەکە بۆ ڕێگری لە لافاو.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) دۆخی کۆمەڵایەتی خراپ یان ستانداردی نزمی ئەخلاقی کە هەندێک جار دەبەسترێتەوە بە نزمترین ئاستی کۆمەڵگا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She rose from the gutter to become a great star.""",
                      kurdishText: """لە هەژارییەوە گەورە بوو بۆ بوون بە ئەستێرەیەکی گەورە.""",
