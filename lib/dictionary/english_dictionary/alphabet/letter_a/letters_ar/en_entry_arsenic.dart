...
class EnglishEntryarsenic extends StatelessWidget {
  ...
  Future<void> speakarsenic(String languageCode) async {
    ...
    await flutterTts.speak("arsenic");
  }
  ...
  Future<void> speakarsenic900(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The doctor found traces of arsenic in his body.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arsenic"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɑːsnɪk/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrsnɪk/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'nI1wNoXZIkc';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'EIM_zjCmQ5Y';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '4dDQsRy0ulE';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'r1mDcTvvhn0';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'ifavkrnVYsE';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'biZLNkEW5tg';
