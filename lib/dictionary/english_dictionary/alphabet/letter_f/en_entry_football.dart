...
class EnglishEntryfootball extends StatefulWidget {
  const EnglishEntryfootball({super.key});

  @override
  State<EnglishEntryfootball> createState() => _EnglishEntryfootballState();
}

class _EnglishEntryfootballState extends State<EnglishEntryfootball> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: football (Derived forms: footballs)
...
3. [Brit] A football game in which two teams of 11 players try to kick or head a ball into the opponents' goal (= soccer, association football, beautiful game [Brit, informal])
 
4. [Brit] An inflated ball used in playing soccer (= soccer ball)
""",
  );

  final String keyword = "football";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""football""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The kids were outside playing football.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We settled down to watch the football on TV.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""On Saturday we went to a football match.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""As a child he was always kicking a football.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Healthcare should not become a political football.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """football""",
                      // alsoEnglishWord: "also: football",
                      britshText: """IpaUK: /ˈfʊtbɔːl/""",
                      americanText: """IpaUS: /ˈfʊtbɔːl/""",
...
// With short examples define "football", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) تۆپی پێ؛ یارییەک کە لە دوو تیمی ١١ یاریزانی پێکدێت و هەر تیمێک هەوڵ دەدات تۆپەکە بخاتە گۆڵی تیمەکەی دیکە"""),
                    SentencesRow(
                      englishText:
                          """The kids were outside playing football.""",
                      kurdishText:
                          """منداڵەکان لە دەرەوە بوون تۆپێنیان دەکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لەسەر ئەوە ڕێککەوتین سەیری تۆپێنەکە لە تەلەفیزیۆن بکەین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕۆژی شەممە چووین بۆ یارییەکی تۆپی پێ.""",
                    ...
                    SentencesRow(
                      englishText:
                          """This was the best game of football I have seen all season.""",
                      kurdishText:
                          """ئەمە باشترین یاریی تۆپی پێ بوو کە تەواوی وەرزەکە دیبێتم.""",
                    ...
                    CustomRichText(
                      ...
                      onTap: () {
                        Routemaster.of(context)
                            .push("/english-football/americanfootball");
                      },
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ناو) تۆپێکی خڕ یان هێلکەیی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """As a child he was always kicking a football.""",
                      kurdishText: """کە منداڵ بوو هەمیشە شەقی لە تۆپ دەدا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ناو) شتێک کە بەردەوام دەبێتە هۆکاری ناکۆکی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Healthcare should not become a political football.""",
                      kurdishText:
                          """چاودێری تەندرووستی نابێت بەردەوام ببێت بە گرفتی سیاسی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/f8VTSGLCa1M';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/6DK0yrF_ffU';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/XyvUgodDjik?t=';
const double _startSecondstwo = 000000000000000000000000000881;
const String _videoIdthree = 'https://youtu.be/kSYEWXwzyzM';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/mHtNCSdGe2M?t=';
const double _startSecondsfour = 00000000000000000000000000096;
const String _videoIdfive = 'https://youtu.be/fHdg3WJ9rg4?t=';
const double _startSecondsfive = 0000000000000000000000000003;
