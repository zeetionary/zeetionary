...
class EnglishEntryferociously extends StatefulWidget {
  const EnglishEntryferociously({super.key});

  @override
  State<EnglishEntryferociously> createState() =>
      _EnglishEntryferociouslyState();
}

class _EnglishEntryferociouslyState extends State<EnglishEntryferociously> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: ferociously
1. In a physically fierce manner (= fiercely)
"silence broken by dogs barking ferociously";
""",
  );

  final String keyword = "ferociously";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""ferociously""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was ferociously attacked.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""A lioness defends her young ferociously.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The group ferociously denounced the ban.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ferociously""",
                      // alsoEnglishWord: "also: ferociously",
                      britshText: """IpaUK: /fəˈrəʊʃəsli/""",
                      americanText: """IpaUS: /fəˈrəʊʃəsli/""",
...
// With short examples define "ferociously", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دایکە شێرێک بە دڕی بەچکەکانی دەپارێزێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """گرووپەکە بە توندی قەدەغەکەیان سەرکۆنە کرد.""",
...
const double _startSecondsend = 0000000000000000000000000001004;
const String _videoIdone = 'https://youtu.be/5R65skWdg7Y?t=';
const double _startSecondsone = 000000000000000000000000000373;
const String _videoIdtwo = 'https://youtu.be/fVSyQIiEcXY?t=';
const double _startSecondstwo = 000000000000000000000000000437;
const String _videoIdthree = 'https://youtu.be/sElsPrcgCao?t=';
const double _startSecondsthree = 000000000000000000000000000195;
const String _videoIdfour = 'https://youtu.be/Solb9uA-tgQ?t=';
const double _startSecondsfour = 00000000000000000000000000019532;
