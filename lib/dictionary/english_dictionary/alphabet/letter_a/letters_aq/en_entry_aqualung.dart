...
class EnglishEntryaqualung extends StatelessWidget {
  ...
  Future<void> speakaqualung(String languageCode) async {
    ...
    await flutterTts.speak("aqualung");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "aqualung"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈækwəlʌŋ/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːkwəlʌŋ/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'TJ9AVsdOphQ';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '-27B8gngS4g';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'b0AYnZU0GbU';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'ivLQmXS7AuM';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'j_GgeX4V2Xc';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'K4ltBn8BBwY';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'KRj_xdd7DsQ';
