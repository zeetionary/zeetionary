...
// replace these: replace EnglishEntryadvertiser - replace speakAdvertiser - replace advertiser - /ˈædvətaɪzər/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadvertiser extends StatelessWidget {
  EnglishEntryadvertiser({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdvertiser(String languageCode) async {
    // DOPSUM: CHANGE speakAdvertiser
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("advertiser"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAdve3589(String languageCode) async {
    ...
    await flutterTts.speak(
        "Magazines need to attract advertisers to survive."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "advertiser", // DOPSUM: CHANGE WORD ENTRY - Find /ˈædvətaɪzə(r)/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈædvətaɪzə(r)/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˈædvətaɪzər/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 't6cjpCND-Qk';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'fcHEc0pE924';
