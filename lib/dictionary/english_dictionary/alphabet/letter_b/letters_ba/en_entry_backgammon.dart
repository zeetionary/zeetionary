...
class EnglishEntrybackgammon extends StatelessWidget {
  ...
  Future<void> speakBackgammons7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBackgammons77"); // DOPSUM: CHANGE TEXT
  }
                        ...
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˈbækɡæmən/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "7WOTO9y_zQc";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "lKQBq73_BWw";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "J8r-izgWLr4";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "7q0u38sZpYE";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "fsYZye1Ykao";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "4yWv5PyF2qs";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "0CnLXbyIKkU";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "twPSB-XtBic";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "j9WZyLZCBzs";
