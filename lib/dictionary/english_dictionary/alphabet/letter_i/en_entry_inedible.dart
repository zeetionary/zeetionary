...
class EnglishEntryinedible extends StatefulWidget {
  const EnglishEntryinedible({super.key});

  @override
  State<EnglishEntryinedible> createState() => _EnglishEntryinedibleState();
}

class _EnglishEntryinedibleState extends State<EnglishEntryinedible> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: inedible
1. Not suitable for food (- uneatable)
"Consumption of inedible tallow and greases in fat splitting increased slightly";
""",
  );

  final String keyword = "inedible";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inedible""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""These chemicals make the fruit inedible.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/FoOiWhTgI3o?t=';
    const double startSecondsend = 000000000000000000000000000325;
    const String videoIdone = 'https://youtu.be/sfq2BYB8K54?t=';
    const double startSecondsone = 000000000000000000000000000673;
    const String videoIdtwo = 'https://youtu.be/c324y0OVqVI?t=';
    const double startSecondstwo = 000000000000000000000000000796;
    const String videoIdthree = 'https://youtu.be/lAguD4gBmSI?t=';
    const double startSecondsthree = 0000000000000000000000000001242;
    const String videoIdfour = 'https://youtu.be/KE8-VK7Net0?t=';
    const double startSecondsfour = 0000000000000000000000000001677;
    const String videoIdfive = 'https://youtu.be/y3PoXXoGVj0?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inedible""",
                      // alsoEnglishWord: "also: inedible",
                      britshText: """IpaUK: /ɪnˈedəbl/""",
                      americanText: """IpaUS: /ɪnˈedəbl/""",
...
کوردی: نەخوراو، ناخۆراکی، ناخواردەنی، لەخواردن‌نەهاتوو، ناخورێ، بەکارخواردن نایە، بۆ خواردن ناشێ
"""),
// With short examples define "inedible", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە ناتوانیت بیخۆیت بەهۆی ئەوەی ناخۆشە یان ژەهراوییە"""),
                    SentencesRow(
                      englishText:
                          """These chemicals make the fruit inedible.""",
                      kurdishText:
                          """ئەم مادە کیمیاییانە خواردن دەکەن بە لەخواردن‌نەهاتوو.""",
