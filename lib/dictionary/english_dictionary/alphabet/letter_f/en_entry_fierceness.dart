...
class EnglishEntryfierceness extends StatefulWidget {
  const EnglishEntryfierceness({super.key});

  @override
  State<EnglishEntryfierceness> createState() => _EnglishEntryfiercenessState();
}

class _EnglishEntryfiercenessState extends State<EnglishEntryfierceness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fierceness
1. The property of being wild or turbulent (= ferocity, furiousness, fury, vehemence, violence, wildness, vehemency)
"the storm's fierceness";
""",
  );

  final String keyword = "fierceness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fierceness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He pulled my face to his with a sudden fierceness.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The fierceness of a bear was evident in its growl.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I was impressed by the fierceness of his desire to win.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fierceness of the storm was unexpected.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fierceness""",
                      // alsoEnglishWord: "also: fierceness",
                      britshText: """IpaUK: /ˈfɪəsnəs/""",
                      americanText: """IpaUS: /ˈfɪrsnəs/""",
...
// With short examples define "fierceness", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕووخسارمی ڕاکێشا بۆ خۆی بە دڕییەکی لەناکو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The fierceness of a bear was evident in its growl.""",
                      kurdishText: """دڕی ورچ دیارە لە نەڕەکەیدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """سەرسام بووم بە توندی حەزی بۆ بردنەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """توندی زریانەکە پێشبینی نەکراو بوو.""",
...
const double _startSecondsend = 0000000000000000000000000004501;
const String _videoIdone = 'https://youtu.be/EnWIxeD18bw?t=';
const double _startSecondsone = 000000000000000000000000000641;
const String _videoIdtwo = 'https://youtu.be/Y0Oa4Lp5fLE?t=';
const double _startSecondstwo = 0000000000000000000000000002988;
const String _videoIdthree = 'https://youtu.be/PAH_8kOhAdY?t=';
const double _startSecondsthree = 000000000000000000000000000486;
const String _videoIdfour = 'https://youtu.be/cvrYEJ4gG8U?t=';
const double _startSecondsfour = 000000000000000000000000000381;
const String _videoIdfive = 'https://youtu.be/zGUd6DDlurA?t=';
const double _startSecondsfive = 000000000000000000000000000156;
