...
class EnglishEntryexterminate extends StatefulWidget {
  const EnglishEntryexterminate({super.key});

  @override
  State<EnglishEntryexterminate> createState() =>
      _EnglishEntryexterminateState();
}

class _EnglishEntryexterminateState extends State<EnglishEntryexterminate> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exterminate""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exterminate""",
                      // alsoEnglishWord: "also: exterminate",
                      britshText: """IpaUK: /ɪkˈstɜːmɪneɪt/""",
                      americanText: """IpaUS: /ɪkˈstɜːrmɪneɪt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exterminate";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Fur seals were nearly exterminated a few years ago.""");
  }
...
کوردی: تێکدان، وێران کردن، لەناو بردن
"""),
          const DefinitionKurdish(
              text: """١. (کردار) لەناوبردنی ڕێژەیەکی زۆر لە خەڵک یان ئاژەڵ"""),
          SentencesRow(
            englishText:
                """Fur seals were nearly exterminated a few years ago.""",
            kurdishText:
                """سەگڵاوی فەروودار چەند ساڵێک پێش ئێستا بەنزیکەیی قڕ کران.""",
          ...
          SentencesRow(
            englishText:
                """Once cockroaches get into a building, it's very difficult to exterminate them.""",
            kurdishText: """کە سیسرکە دەگەنە بینایەک سەختە لەناویان بەریت.""",
...
2. Remove, destroy or wipe out completely (= uproot, eradicate, extirpate [formal], root out)
""",
  );
...
const String _videoIdone = 'https://youtu.be/YZoZr_m9WLU?t=';
...
const String _videoIdthree = 'https://youtu.be/NNnIGh9g6fA?t=';
const double _startSecondsthree = 0000000000000000000000000001837;
const String _videoIdfour = 'https://youtu.be/3OMmxKiG4LE?t=';
const double _startSecondsfour = 000000000000000000000000000528;
const String _videoIdfive = 'https://youtu.be/9nlhmJF5FNI?t=';
