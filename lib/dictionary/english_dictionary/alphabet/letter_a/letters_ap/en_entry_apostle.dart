                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "apostle"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈpɒsl/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakapostle("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈpɑːsl/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakapostle("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'EBXJYvOFfPY';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'BnswoosvUPU';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'tFPS4pUhOsA';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '8_oyV-Jlw70';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'wu-WAuPxXBs';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'iagCO64DCUg';
