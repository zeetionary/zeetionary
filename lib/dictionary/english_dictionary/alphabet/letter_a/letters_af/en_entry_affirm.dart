...
class EnglishEntryaffirm extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 3, // 2 + VIDEOS FIND: direction1
      child: Scaffold(
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈfɜːrm/"),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'MRWYzNIk5vU';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 2325;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Yi0Mdvcg1Dg';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'c7MoqwTIw3M';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'Bkdvw4sPz8A';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'JNZc9H54eBI';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'CqnWMPuyT0g';
