...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '9UHIWVtAdhY';
    const double startSecondsend = 24;
    const String videoIdone = '851aS_abQG4';
    const double startSecondsone = 382;
    const String videoIdtwo = '-6HOdHEeosc';
    const double startSecondstwo = 1723;
    const String videoIdthree = 'foYyeGLf9yU';
    const double startSecondsthree = 2992;
    const String videoIdfour = 'shTEMKZQ3rY';
    const double startSecondsfour = 181;
    const String videoIdfive = 'SgCJeoDNmYU';
    const double startSecondsfive = 2284;
