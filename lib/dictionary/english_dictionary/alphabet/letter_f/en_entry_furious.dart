...
class EnglishEntryfurious extends StatefulWidget {
  const EnglishEntryfurious({super.key});

  @override
  State<EnglishEntryfurious> createState() => _EnglishEntryfuriousState();
}

class _EnglishEntryfuriousState extends State<EnglishEntryfurious> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: furious
1. Marked by extreme and violent energy (- ferocious, fierce, savage)
"a furious battle";
 
2. Marked by extreme anger (- angered, enraged, infuriated, maddened, ropable [Austral, NZ], ropeable [Austral, NZ])
"furious about the accident"; "a furious scowl";
 
3. (of the elements) as if showing violent anger (- angry, raging, tempestuous, wild)
"furious winds";
 
4. Feeling or showing extreme anger (- irate, ireful, steaming [informal], fuming, seething, hopping mad [informal], apoplectic [informal], livid)
"wilful stupidity makes him absolutely furious";
""",
  );

  final String keyword = "furious";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""furious""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She was absolutely furious at having been deceived.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'm furious that I wasn't told about it.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I was furious at the way we'd been treated.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She drove off at a furious pace.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furious""",
                      // alsoEnglishWord: "also: furious",
                      britshText: """IpaUK: /ˈfjʊəriəs/""",
                      americanText: """IpaUS: /ˈfjʊriəs/""",
...
کوردی: ڕق‌هەستاو، لەدین‌دەرچوو، بەردبەباکەر، زۆرتووڕە، سوورەوەبوو،	توند، توندوتیژ، سەخت، بێ‌ئەمان، دژوار،	(خێرایی) شێتانە، زۆر توند
"""),
// With short examples define "furious", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لێنەهاتووییان تووڕەی کردم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تەواو توورە بوو لەوەی فریو درابوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He was furious with himself for letting things get so out of control.""",
                      kurdishText:
                          """لە خۆی تووڕە بوو بۆ ئەوەی هێشتبووی شتەکان هێندە لە کۆنترۆڵ دەربچن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """توورەم کە لەسەر ئەوە پێم نەگوترا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """توورە بووم لەو شێوەیەی مامەڵەمان لەگەڵ کرابوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Play was fast and furious in the opening minutes of the game.""",
                      kurdishText:
                          """یاریکردن خێرا و بەجۆش بوو لە خولەکەکانی سەرەتای یارییەکە.""",
...
const String _videoIdtwo = 'https://youtu.be/SFphlZ_BryA?t=';
...
const String _videoIdfour = 'https://youtu.be/gk4JFz6nnLo?t=';
const double _startSecondsfour = 00000000000000000000000000019;
const String _videoIdfive = 'https://youtu.be/AOfIm5YZzVo?t=';
