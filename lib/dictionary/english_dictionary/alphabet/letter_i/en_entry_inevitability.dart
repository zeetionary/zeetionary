...
class EnglishEntryinevitability extends StatefulWidget {
  const EnglishEntryinevitability({super.key});

  @override
  State<EnglishEntryinevitability> createState() =>
      _EnglishEntryinevitabilityState();
}

class _EnglishEntryinevitabilityState extends State<EnglishEntryinevitability> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: inevitability (Derived forms: inevitabilities)
1. The quality of being unavoidable (- inevitableness)
"there was a sense of inevitability about it";
""",
  );

  final String keyword = "inevitability";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inevitability""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""There was an inevitability about their defeat.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/b1JlYZQG3lI?t=';
    const double startSecondsend = 000000000000000000000000000956;
    const String videoIdone = 'https://youtu.be/NNnIGh9g6fA?t=';
    const double startSecondsone = 0000000000000000000000000002287;
    const String videoIdtwo = 'https://youtu.be/wf6x4FHTMKo?t=';
    const double startSecondstwo = 0000000000000000000000000002048;
    const String videoIdthree = 'https://youtu.be/58MRRR6TJgY?t=';
    const double startSecondsthree = 000000000000000000000000000275;
    const String videoIdfour = 'https://youtu.be/4jwBxxgYcaw?t=';
    const double startSecondsfour = 000000000000000000000000000540;
    const String videoIdfive = 'https://youtu.be/gTegijTH7rg?t=';
    const double startSecondsfive = 000000000000000000000000000870;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inevitability""",
                      // alsoEnglishWord: "also: inevitability",
                      britshText: """IpaUK: /ɪnˌevɪtəˈbɪləti/""",
                      americanText: """IpaUS: /ɪnˌevɪtəˈbɪləti/""",
...
کوردی: لێ‌دەربازنەبوویی، دیاری‌کراوی، پێش‌گیری‌لێ‌نەکراوی، دووری‌لێ‌نەکراوی، خۆلێ‌لانەدراوی
"""),
// With short examples define "inevitability", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە شتێک نەکرێت ڕێگری لێ بکرێت"""),
                    SentencesRow(
                      englishText:
                          """There was an inevitability about their defeat.""",
                      kurdishText:
                          """لێ‌دەربازنەبووییەک هەبوو سەبارەت بە شکستیان.""",
