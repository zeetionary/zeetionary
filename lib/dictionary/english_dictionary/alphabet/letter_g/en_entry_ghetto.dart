...
class EnglishEntryghetto extends StatefulWidget {
  const EnglishEntryghetto({super.key});

  @override
  State<EnglishEntryghetto> createState() => _EnglishEntryghettoState();
}

class _EnglishEntryghettoState extends State<EnglishEntryghetto> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I'm from the ghetto and I didn't have it easy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ghetto""",
                      // alsoEnglishWord: "also: ghetto",
                      britshText: """IpaUK: /ˈɡetəʊ/""",
                      americanText: """IpaUS: /ˈɡetəʊ/""",
...
// With short examples define "ghetto", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە گێتۆیەک گەورەبووم و ئاسان نەبوو بۆم.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The south coast of Spain has become something of a tourist ghetto.""",
                      kurdishText:
                          """کەناراوی باشووری ئیسپانیا بووە بە ناوچەیەکی گەشتیاری.""",
...
const String _videoIdone = 'https://youtu.be/jJJ7YTt_C4M?t=';
const double _startSecondsone = 00000000000000000000000000086;
const String _videoIdtwo = 'https://youtu.be/_0TsRzZg3cQ?t=';
const double _startSecondstwo = 0000000000000000000000000002861;
const String _videoIdthree = 'https://youtu.be/dDrZmTGOIoc?t=';
const double _startSecondsthree = 000000000000000000000000000285;
const String _videoIdfour = 'https://youtu.be/NEoGhsTvzNk?t=';
const double _startSecondsfour = 00000000000000000000000000022;
const String _videoIdfive = 'https://youtu.be/fYctVzy-zqc?t=';
