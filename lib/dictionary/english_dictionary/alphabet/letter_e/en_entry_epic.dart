...
class EnglishEntryepic extends StatefulWidget {
  const EnglishEntryepic({super.key});

  @override
  State<EnglishEntryepic> createState() => _EnglishEntryepicState();
}

class _EnglishEntryepicState extends State<EnglishEntryepic> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """epic""",
                      // alsoEnglishWord: "also: epic",
                      britshText: """IpaUK: /ˈepɪk/""",
                      americanText: """IpaUS: /ˈepɪk/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Homer is a genius of Greek epic literature.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Their four-hour match was an epic.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They produced an epic film about the Roman Empire.""");
  }
...
کوردی: پاڵەوانی، قارەمانی،	فیلمی قارەمانی یان پاڵەوانی،	چیرۆکی پاڵەوانی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) هۆنراوەیەکی درێژ سەبارەت نە پیاوان و ژنانی بەناوبانگ یان مێژووی وڵاتێک"""),
          SentencesRow(
            englishText: """Homer is a genius of Greek epic literature.""",
            kurdishText: """هۆمەر بلیمەتێکی ئەدەبی هۆنراوەی پاڵەوانی یۆنانە.""",
          ...
          SentencesRow(
            englishText:
                """It's one of those old Hollywood epics with a cast of thousands.""",
            kurdishText:
                """یەکێک لە فیلمە پاڵەوانێتییەکانی هۆڵیهوود بە هەزاران ئەکتەرەوە.""",
          ...
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٤. (هاوەڵناو) هۆنراوەیەکی پاڵەوانێتی"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """They produced an epic film about the Roman Empire.""",
            kurdishText:
                """فیلمێکی ناوازەیان لەسەر ئیمپراتۆریەتی ڕۆمانی بەرهەمهێنا.""",
          ...
          const DefinitionKurdish(
              text:
                  """٥. (هاوەڵناو) کە لە ماوەیەکی درێژدا ڕوودەدات و زۆر سەختی لەخۆدەگرێت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """James has walked 1,000 miles in an epic journey across Africa.""",
            kurdishText:
                """جەیمس ١٠٠٠ میل ڕێی کرد لە گەشتێکی درێژدا بە ئەفریقادا.""",
            onPressedBritish: () => speaksentence5("en-GB"),
            onPressedAmerican: () => speaksentence5("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٦. (هاوەڵناو) زۆر باش، گەورە، یان ناوازە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """The party was epic!""",
            kurdishText: """ئاهەنگەکە بێ‌وێنە بوو!""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: epic (Derived forms: epics)
1. A long narrative poem telling of a hero's deeds (= epic poem, heroic poem, epos)
 
2. A long story or event
"a war epic"

- Adjective: epic
1. Very imposing or impressive; surpassing the ordinary (especially in size or scale) (= heroic, larger-than-life)
"an epic voyage";
 
2. Constituting or having to do with or suggestive of a literary epic (= epical)
"epic tradition";
 
3. [slang] Extraordinarily good or great; used especially as an intensifier (= fantastic, grand, howling [informal], marvelous [US], marvellous [Brit, Cdn], rattling [informal], terrific, tremendous, wonderful, wondrous, phenomenal, magnificent, heavenly [informal])
 
4. [slang] Excellent and enjoyable or memorable (= mega [slang])
"we had an epic time";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/Jk7NYEhai0g?t=';
const double _startSecondsend = 000000000000000000000000000000; // 36;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/pk99d2015so?t=';
const double _startSecondsone = 00000000000000000000000000000; // 362;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/P4tDxQby99A?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 194;
const String _videoIdthree = 'VIDEOhttps://youtu.be/LIsUmtxgGF0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 88;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/rN9NzgryhMY?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 328;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/J75uWWaMZHw?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 114;
