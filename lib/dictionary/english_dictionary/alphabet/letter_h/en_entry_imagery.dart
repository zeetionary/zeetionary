...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: imagery (Derived forms: imageries)
1. The ability to form mental images of things or events (- imagination, imaging, mental imagery)
"he could still hear her in his mental imagery";
 
2. Figurative writing or speaking; vivid descriptions presenting or suggesting images
""",
  );
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The poem is full of religious imagery.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The team used aerial imagery to recreate the scene.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000909;
    const String videoIdone = 'https://youtu.be/cqidD7kVnxY?t=';
    const double startSecondsone = 0000000000000000000000000001029;
    const String videoIdtwo = 'https://youtu.be/3RkhZgRNC1k?t=';
    const double startSecondstwo = 0000000000000000000000000001790;
    const String videoIdthree = 'https://youtu.be/4I-p8vjQ95s?t=';
    const double startSecondsthree = 00000000000000000000000000020;
    const String videoIdfour = 'https://youtu.be/Unzc731iCUY?t=';
    const double startSecondsfour = 0000000000000000000000000001923;
    const String videoIdfive = 'https://youtu.be/-I6YmMAThZ8?t=';
    const double startSecondsfive = 000000000000000000000000000774;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      britshText: """IpaUK: /ˈɪmɪdʒəri/""",
                      americanText: """IpaUS: /ˈɪmɪdʒəri/""",
...
// With short examples define "imagery", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) جۆرە زمانێک کە وێنە لە مێشکی خوێنەر/گوێگر درووست دەکات"""),
                    SentencesRow(
                      englishText: """The poem is full of religious imagery.""",
                      kurdishText: """هۆنراوەکە پڕە لە وێنەگەری ئایینی.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) وێنە، """),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The team used aerial imagery to recreate the scene.""",
                      kurdishText:
                          """تیمەکە وێنەی ئاسمانییان بەکارهێنا بۆ درووستکردنەوەی دیمەنەکە.""",
