...
class EnglishEntrylearning extends StatefulWidget {
  const EnglishEntrylearning({super.key});

  @override
  State<EnglishEntrylearning> createState() => _EnglishEntrylearningState();
}

class _EnglishEntrylearningState extends State<EnglishEntrylearning> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: learning (Derived forms: learnings)
1. The cognitive process of acquiring skill or knowledge (- acquisition)
"the child's learning of language";
 
2. Profound scholarly knowledge (- eruditeness, erudition, learnedness, scholarship, encyclopedism, encyclopaedism [Brit])
"his vast and versatile learning";
""",
  );

  final String keyword = "learning";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""learning""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The school aims to provide a learning environment.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Last season was a learning experience for the team.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The learning process is slightly different in each individual.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A large part of children's learning takes place in the home.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A little learning is a dangerous thing.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Academic learning may not be seen as particularly useful in some situations.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We will be sharing key learnings from our project.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/rPe4yziWiOg?t=891';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/dgxPlUgIqSA?t=56';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/hS2x1zl4rn0?t=406';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/_a8u4949t_k?t=268';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/toVfvRhWbj8?t=1320';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/ea4Tq7HB7kU?t=194';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """learning""",
                      // alsoEnglishWord: "also: learning",
                      britshText: """IpaUK: /ˈlɜːnɪŋ/""",
                      americanText: """IpaUS: /ˈlɜːrnɪŋ/""",
...
کوردی: 
"""),
// With short examples define "learning", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) پڕۆسەی فێربوون"""),
                    SentencesRow(
                      englishText: """The school aims to provide a learning environment.""",
                      kurdishText: """قوتابخانەکە ئامانجیەتی ژینگەیەکی فێربوون درووست بکات.""",
                    ...
                    SentencesRow(
                      englishText: """Last season was a learning experience for the team.""",
                      kurdishText: """وەرزی پێشوو ئەزموونێکی فێربوون بوو بۆ تیمەکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The learning process is slightly different in each individual.""",
                      kurdishText: """پڕۆسەی فێربوون کەمێکی جیاوازە بۆ هەر کەسێک.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """A large part of children's learning takes place in the home.""",
                      kurdishText: """بەشێکی زۆری فێربوونی منداڵ لە ماڵەوە ڕوودەدات.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ئەو زانیارییەی کە لە خوێندنەوە وەریدەگریت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """A little learning is a dangerous thing.""",
                      kurdishText: """کەمێک زانیاری شتێکی مەترسیدارە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Academic learning may not be seen as particularly useful in some situations.""",
                      kurdishText: """زانیاریی ئەکادیمی ڕەنگە بە شتێکی تەواو بەسوود دانەنرێت لە هەندێک دۆخدا.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) شتێک کە فێری دەبیت، بە تایبەتی لە ئەزموونتەوە لەسەر کارکردن لە شتێکدا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We will be sharing key learnings from our project.""",
                      kurdishText: """فێربوونە سەرەکییەکانمان لە پڕۆژەکەوە بە یەکدی دەڵێین.""",
