...
class EnglishEntryadministrative extends StatefulWidget {
...
// 188888880002200
  ...
  final String keyword = "administrative";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""administrative""");
  }
  ...
  Future<void> speakadmin25687(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("Your responsibilities will be mainly administrative.");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'e1kL-Drm-To';
    const double startSecondstwo = 1;
    const String videoIdthree = 'jpvPQ5oFmHE';
    const double startSecondsthree = 9;
    const String videoIdfour = 'E2rtQFAibEA';
    const double startSecondsfour = 1121;
    const String videoIdfive = 'a6zvvlrd-jw';
    const double startSecondsfive = 437;
    // const String videoId = '5-QejUTDCWw';
    // const double startSeconds = 1350;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """administrative""",
                      // alsoEnglishWord: "also: administrative",
                      britshText: """IpaUK: /ədˈmɪnɪstrətɪv/""",
                      americanText: """IpaUS: /ədˈmɪnɪstreɪtɪv/""",
