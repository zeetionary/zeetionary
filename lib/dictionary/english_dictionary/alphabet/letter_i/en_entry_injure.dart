...
class EnglishEntryinjure extends StatefulWidget {
  const EnglishEntryinjure({super.key});

  @override
  State<EnglishEntryinjure> createState() => _EnglishEntryinjureState();
}

class _EnglishEntryinjureState extends State<EnglishEntryinjure> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: injure (Derived forms: injured, injuring, injures)
1. Cause injuries or bodily harm to (- wound)
 
2. Cause (somebody) emotional pain or offence (- hurt, wound, bruise, offend, spite)
 
3. Cause damage or affect negatively (- hurt)
""",
  );

  final String keyword = "injure";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Three people were killed and five injured in the crash.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She injured herself during training.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Doing all that while injured isn't exactly easy.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""This could seriously injure the company's reputation.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/qUNYPkroz18?t=';
    const double startSecondsend = 000000000000000000000000000478;
    const String videoIdone = 'https://youtu.be/f7QWMUCMYOE?t=';
    const double startSecondsone = 000000000000000000000000000622;
    const String videoIdtwo = 'https://youtu.be/ZzdV_HM95RQ?t=';
    const double startSecondstwo = 0000000000000000000000000001062;
    const String videoIdthree = 'https://youtu.be/WXNmSruTWIA?t=';
    const double startSecondsthree = 00000000000000000000000000085;
    const String videoIdfour = 'https://youtu.be/I720xCnnPUY?t=';
    const double startSecondsfour = 000000000000000000000000000235;
    const String videoIdfive = 'https://youtu.be/EeT-dNlvsdc?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """injure""",
                      // alsoEnglishWord: "also: injure",
                      britshText: """IpaUK: /ˈɪndʒə(r)/""",
                      americanText: """IpaUS: /ˈɪndʒər/""",
...
کوردی: 
"""),
// With short examples define "injure", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) گەیاندنی زیانی جەستەیی بە خۆت یان بە کەسێک، بە تایبەتی لە ڕووداوێکدا"""),
                    SentencesRow(
                      englishText:
                          """Three people were killed and five injured in the crash.""",
                      kurdishText:
                          """سێ کەس مردن و پێنج گیانیان لەدەستدا لە تێکشکانەکە/پێکدادانەکە.""",
                    ...
                    SentencesRow(
                      englishText: """She injured herself during training.""",
                      kurdishText: """لە کاتی ڕاهێنان خۆی بریندار کرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) گەیاندنی زیان بە ناوبانگ، بەرژەوەندی، هەست، هتد ـی کەسێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """This could seriously injure the company's reputation.""",
                      kurdishText:
                          """ئەمە دەکرێت بە خراپی زیان بە ناوبانگی کۆمپانیاکە بگەیەنێت.""",
