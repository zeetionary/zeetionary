...
class EnglishEntryicehockey extends StatefulWidget {
  const EnglishEntryicehockey({super.key});

  @override
  State<EnglishEntryicehockey> createState() => _EnglishEntryicehockeyState();
}

class _EnglishEntryicehockeyState extends State<EnglishEntryicehockey> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: ice hockey
1. A game played on an ice rink by two opposing teams of six skaters each who try to knock a flat round puck into the opponents' goal with angled hockey sticks (- hockey, hockey game)
""",
  );

  final String keyword = "ice hockey";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ice hockey""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They watched an intense ice hockey game last night.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Bl5630CeYFs?t=';
    const double startSecondsend = 000000000000000000000000000208;
    const String videoIdone = 'https://youtu.be/ms2-KQd58gY?t=';
    const double startSecondsone = 00000000000000000000000000039;
    const String videoIdtwo = 'https://youtu.be/JpGq1MEZ2DM?t=';
    const double startSecondstwo = 000000000000000000000000000247;
    const String videoIdthree = 'https://youtu.be/8PZQ0mm4EJk?t=';
    const double startSecondsthree = 000000000000000000000000000630;
    const String videoIdfour = 'https://youtu.be/tIfXsxtnGr4?t=';
    const double startSecondsfour = 00000000000000000000000000025;
    const String videoIdfive = 'https://youtu.be/NKGIbfhWX9E?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ice hockey""",
                      // alsoEnglishWord: "also: ice hockey",
                      britshText: """IpaUK: /ˈaɪs hɒki/""",
                      americanText: """IpaUS: /ˈaɪs hɑːki/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دوێنێ شەو سەیری یارییەکی بەهێزی هۆکی سەرسەهۆڵیان کرد.""",
