...
class EnglishEntryfundamentalism extends StatefulWidget {
  const EnglishEntryfundamentalism({super.key});

  @override
  State<EnglishEntryfundamentalism> createState() =>
      _EnglishEntryfundamentalismState();
}

class _EnglishEntryfundamentalismState
    extends State<EnglishEntryfundamentalism> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fundamentalism (Derived forms: fundamentalisms)
...
""",
  ...
  final String keyword = "fundamentalism";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fundamentalism""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fundamentalism""",
                      // alsoEnglishWord: "also: fundamentalism",
                      britshText: """IpaUK: /ˌfʌndəˈmentəlɪzəm/""",
                      americanText: """IpaUS: /ˌfʌndəˈmentəlɪzəm/""",
...
// With short examples define "fundamentalism", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) جۆرێک لە ئایین، بە تایبەتی لە ئیسلام یان پڕۆتێستانی مەسیحی، کە باوەڕی وایە هەموو شتێک کە لە نووسراوە پیرۆزەکان نووسراون تەواو ڕاستن"""),
                    SentencesRow(
                      englishText:
                          """Recent years have witnessed a growth in religious fundamentalism.""",
                      kurdishText:
                          """ئەم ساڵانەی دوایی زیادبوونی لە بنچینەخوازیی ئایینی  بەخۆوە دیوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/r0vC-dUhwqw?t=';
const double _startSecondsend = 000000000000000000000000000260;
const String _videoIdone = 'https://youtu.be/UPgTP3VzBL0?t=';
const double _startSecondsone = 00000000000000000000000000035;
const String _videoIdtwo = 'https://youtu.be/BdcrP-5bDIk?t=';
const double _startSecondstwo = 000000000000000000000000000312;
const String _videoIdthree = 'https://youtu.be/p0sNQdOW1CI?t=';
const double _startSecondsthree = 000000000000000000000000000524;
const String _videoIdfour = 'https://youtu.be/Ga1_2Zy5__s?t=';
const double _startSecondsfour = 000000000000000000000000000331;
const String _videoIdfive = 'https://youtu.be/9jv0-dUu4_k?t=';
