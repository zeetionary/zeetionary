...
class EnglishEntryinanimate extends StatefulWidget {
  const EnglishEntryinanimate({super.key});

  @override
  State<EnglishEntryinanimate> createState() => _EnglishEntryinanimateState();
}

class _EnglishEntryinanimateState extends State<EnglishEntryinanimate> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inanimate""");
  }
