...
class EnglishEntrygloat extends StatefulWidget {
  const EnglishEntrygloat({super.key});

  @override
  State<EnglishEntrygloat> createState() => _EnglishEntrygloatState();
}

class _EnglishEntrygloatState extends State<EnglishEntrygloat> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I hope you haven’t just come here to gloat.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gloat""",
                      // alsoEnglishWord: "also: gloat",
                      britshText: """IpaUK: /ɡləʊt/""",
                      americanText: """IpaUS: /ɡləʊt/""",
...
کوردی: دڵشادی، هەستی سەرکەوتووانە،	چاوتێ‌بڕین
"""),
// With short examples define "gloat", please follow LX instructions
                    ...
                    const AlsoEnglishckb(word: "ھەروەھا: crow"),
                    SentencesRow(
                      englishText:
                          """Having lost a large percentage of the vote, they were in no position to gloat.""",
                      kurdishText:
                          """بەوەی کە ڕێژەیەکی زۆری دەنگیان لەدەست دابوو، لە هیچ پێگەیەک نەبوون دەنگ بدەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هیوادارم تەنها بۆ ئەوە نەهاتبیت بۆ ئێرە کە دڵخۆشیت دەرببڕیت.""",
...
const double _startSecondsend = 000000000000000000000000000950;
const String _videoIdone = 'https://youtu.be/qg2nGY1aqlg?t=';
const double _startSecondsone = 0000000000000000000000000001202;
const String _videoIdtwo = 'https://youtu.be/RZt7kE7PZMQ?t=';
const double _startSecondstwo = 000000000000000000000000000829;
const String _videoIdthree = 'https://youtu.be/iogjPsCceqc?t=';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/AnRYS02tvRA?t=';
const double _startSecondsfour = 000000000000000000000000000112;
const String _videoIdfive = 'https://youtu.be/77cprR9Qvzk?t=';
