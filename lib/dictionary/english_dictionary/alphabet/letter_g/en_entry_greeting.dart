...
class EnglishEntrygreeting extends StatefulWidget {
  const EnglishEntrygreeting({super.key});

  @override
  State<EnglishEntrygreeting> createState() => _EnglishEntrygreetingState();
}

class _EnglishEntrygreetingState extends State<EnglishEntrygreeting> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: greeting (Derived forms: greetings)
1. (usually plural) an acknowledgment or expression of good will (especially on meeting) (- salutation)
""",
  );

  final String keyword = "greeting";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She waved a friendly greeting.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They exchanged greetings and sat down to lunch.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""My mother sends her greetings to you all.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """greeting""",
                      // alsoEnglishWord: "also: greeting",
                      britshText: """IpaUK: /ˈɡriːtɪŋ/""",
                      americanText: """IpaUS: /ˈɡriːtɪŋ/""",
...
// With short examples define "greeting", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """She waved a friendly greeting.""",
                      kurdishText: """سڵاوێکی دۆستانەی کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چاوک‌چۆنییان گۆڕییەوە بۆ نانی نیوەڕۆ دانیشتن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) پەیامی پیرۆزبایی هیواخواستن بۆ تەندرووستی، خۆشی، هتد ــی کەسێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """My mother sends her greetings to you all.""",
                      kurdishText: """دایکم سڵاوی بۆ هەمووتان هەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """We extend our greetings to you and thank you for listening to us.""",
                      kurdishText:
                          """سڵاومان بۆتان هەیە و سوپاستان دەکەین بۆ گوێگرتن لێمان.""",
...
const String _videoIdone = 'https://youtu.be/3GNjbAACqIY?t=';
const double _startSecondsone = 000000000000000000000000000339;
const String _videoIdtwo = 'https://youtu.be/v1desDduz5M?t=';
const double _startSecondstwo = 0000000000000000000000000003;
const String _videoIdthree = 'https://youtu.be/rtAAjKBH9GU?t=';
const double _startSecondsthree = 00000000000000000000000000022;
const String _videoIdfour = 'https://youtu.be/FaCeZsOOKEY';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/6MoBvV12C58?t=';
