...
class EnglishEntryfen extends StatefulWidget {
  const EnglishEntryfen({super.key});

  @override
  State<EnglishEntryfen> createState() => _EnglishEntryfenState();
}

class _EnglishEntryfenState extends State<EnglishEntryfen> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There was an early morning mist rising from the fens.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The Fens were drained in the seventeenth century.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fen""",
                      // alsoEnglishWord: "also: fen",
                      britshText: """IpaUK: /fen/""",
                      americanText: """IpaUS: /fen/""",
...
کوردی: زۆنگاو، زەلکاو، چامۆر، زەل، زنە
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) زەوییەکی نزمی تەختی تەڕ"""),
                    SentencesRow(
                      englishText:
                          """There was an early morning mist rising from the fens.""",
                      kurdishText:
                          """تەمێکی بەیانی زوو لە زۆنگاوەکانەوە دەستی پێدەکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """زۆنگاوەکان لە سەدەی حەڤدە وشککران.""",
...
const String _videoIdend = 'https://youtu.be/1HI_1bj4J1U?t=';
const double _startSecondsend = 000000000000000000000000000188;
const String _videoIdone = 'https://youtu.be/aPRL0HhWfP0?t=';
const double _startSecondsone = 000000000000000000000000000230;
const String _videoIdtwo = 'https://youtu.be/OBeGRq7ACKA?t=';
const double _startSecondstwo = 00000000000000000000000000015;
const String _videoIdthree = 'https://youtu.be/_B8-1sVcfzE?t=';
const double _startSecondsthree = 000000000000000000000000000159;
const String _videoIdfour = 'https://youtu.be/6v5yvFXb6xw?t=';
const double _startSecondsfour = 00000000000000000000000000024;
const String _videoIdfive = 'https://youtu.be/ilBVx4LmYps?t=';
