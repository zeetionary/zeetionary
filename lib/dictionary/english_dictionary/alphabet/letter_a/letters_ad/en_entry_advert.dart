...
// replace these: replace EnglishEntryadvert - replace speakAdvert - replace advert - /ˈædvɜːrt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadvert extends StatelessWidget {
  EnglishEntryadvert({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdvert(String languageCode) async {
    // DOPSUM: CHANGE speakAdvert
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("advert"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAdv36914(String languageCode) async {
    ...
    await flutterTts.speak(
        "A lot of claims are made in the advert."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "advert", // DOPSUM: CHANGE WORD ENTRY - Find /ˈædvɜːt/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈædvɜːt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAdvert(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˈædvɜːrt/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'K-gvd_0-6mc';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'MBPdKxlazD0';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '4jeq8la3kQg';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'RhI8NrHparM';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '01oB5fkT_-Y';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'xeGPIBCX9BA';
