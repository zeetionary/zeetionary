...
// blank divider
  ...
  Future<void> speakbashs2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("Bashing politicians is normal practice in the press.");
  }
  ...
  Future<void> speakbashs3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He gave Mike a bash on the nose.");
  }
  ...
  Future<void> speakbashs5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBashs55");
  }
  ...
  Future<void> speakbashs6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBashs66");
  }
  ...
  Future<void> speakbashs7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBashs77");
  }
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbashs1("en-GB"),
                            onPressedAmerican: () => speakbashs1("en-US"),
                          ),
...
٢. (کردار) ڕەخنەگرتنی توند"""),
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbashs2("en-GB"),
                            onPressedAmerican: () => speakbashs2("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٣. (ناو) لێدانێکی توند"""),
                          SentencesRow(
                            englishText: "He gave Mike a bash on the nose.",
                            kurdishText: "مشتێکی کێشا بە لووتی مایکدا.",
                            onPressedBritish: () => speakbashs3("en-GB"),
                            onPressedAmerican: () => speakbashs3("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٤. (ناو) ئاھەنگێکی گەورە"""),
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbashs4("en-GB"),
                            onPressedAmerican: () => speakbashs4("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final double _startSeconds = 2645;
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'gO2xAHIaUUA';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'vKxJnJ0OipU';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'pgzfdXFfzXQ';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'Tmg5WOvPKpU';
