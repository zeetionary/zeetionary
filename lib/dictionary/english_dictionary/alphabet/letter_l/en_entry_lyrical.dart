...
class EnglishEntrylyrical extends StatefulWidget {
  const EnglishEntrylyrical({super.key});

  @override
  State<EnglishEntrylyrical> createState() => _EnglishEntrylyricalState();
}

class _EnglishEntrylyricalState extends State<EnglishEntrylyrical> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylyrical lyrical
WORD_WEB lyrical lyrical lyrical
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lyrical";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lyrical""");
  }
...
کوردی: 
"""),
// With short examples define "lyrical", please follow LX instructions
