...
class EnglishEntryassortment extends StatelessWidget {
  ...
  Future<void> speakassortment(String languageCode) async {
    ...
    await flutterTts.speak("assortment");
  }
  ...
  Future<void> speakassortment832(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("He was dressed in an odd assortment of clothes.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "assortment"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈsɔːtmənt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈsɔːrtmənt/"),
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'epYDHqAwsnY';
