...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'tkXtBNb5VzE';
    const double startSecondsend = 305;
    const String videoIdone = 'apmF_FXcZKc';
    const double startSecondsone = 724;
    const String videoIdtwo = 'lUslI5w9deU';
    const double startSecondstwo = 517;
    const String videoIdthree = 'kvHHa_6zVxU';
    const double startSecondsthree = 0;
    const String videoIdfour = 'mVhObSZUQM0';
    const double startSecondsfour = 223;
    const String videoIdfive = '3mugPH2_qRo';
    const double startSecondsfive = 999;
