...
class EnglishEntrygilt extends StatefulWidget {
  const EnglishEntrygilt({super.key});

  @override
  State<EnglishEntrygilt> createState() => _EnglishEntrygiltState();
}

class _EnglishEntrygiltState extends State<EnglishEntrygilt> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It's not solid gold - it's just gilt.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gilt""",
                      // alsoEnglishWord: "also: gilt",
                      britshText: """IpaUK: gilt""",
                      americanText: """IpaUS: gilt""",
...
// With short examples define "gilt", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) چینێکی تەنک لە ئاڵتوون یان شتێکی وەک ئاڵتوون کە بۆ ڕازاندنەوە بەکاردێت لەسەر ڕوویەک"""),
                    SentencesRow(
                      englishText: """It's not solid gold - it's just gilt.""",
                      kurdishText: """ئاڵتوونی تەواو نییە ـ تەنها زێڕپۆشە.""",
                      kurdishNote: """واتا ڕووەکەی ئاڵتوونە بەڵام لەژێرەوە ئاڵتوون نییە""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/F7AL8LR9BxY?t=';
const double _startSecondsend = 000000000000000000000000000823;
const String _videoIdone = 'https://youtu.be/0RA_B5p2JYg?t=';
const double _startSecondsone = 000000000000000000000000000716;
const String _videoIdtwo = 'https://youtu.be/X-6jMi4e-0Q?t=';
const double _startSecondstwo = 000000000000000000000000000392;
const String _videoIdthree = 'https://youtu.be/NekZK0vXyqc?t=';
const double _startSecondsthree = 000000000000000000000000000114;
const String _videoIdfour = 'https://youtu.be/6Dv1uAKCEKE?t=';
const double _startSecondsfour = 000000000000000000000000000543;
const String _videoIdfive = 'https://youtu.be/SYRXX0ykJMs?t=';
