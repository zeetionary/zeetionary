...
class EnglishEntryfloppy extends StatefulWidget {
  const EnglishEntryfloppy({super.key});

  @override
  State<EnglishEntryfloppy> createState() => _EnglishEntryfloppyState();
}

class _EnglishEntryfloppyState extends State<EnglishEntryfloppy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: floppy (Derived forms: floppier, floppiest)
1. Hanging limply
"a spaniel with floppy ears"

- Noun: floppy (Derived forms: floppies)
1. A small plastic magnetic disk enclosed in a stiff envelope with a radial slit; used to store data or programs for a microcomputer (= diskette, floppy disk)
"floppy disks are noted for their relatively slow speed and small capacity and low price";
""",
  );

  final String keyword = "floppy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He's got floppy blond hair that's always falling in his eyes.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """floppy""",
                      // alsoEnglishWord: "also: floppy",
                      britshText: """IpaUK: /ˈflɒpi/""",
                      americanText: """IpaUS: /ˈflɑːpi/""",
...
// With short examples define "floppy", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) کە بە فشی شۆڕبووە"""),
                    SentencesRow(
                      englishText:
                          """He's got floppy blond hair that's always falling in his eyes.""",
                      kurdishText: """قژی زەردی فشی هەیە کە هەمیشە دەکەوێت بەسەر چاوانیدا.""",
...
const double _startSecondsend = 000000000000000000000000000115;
const String _videoIdone = 'https://youtu.be/syH0oN_B4g0?t=';
const double _startSecondsone = 000000000000000000000000000422;
const String _videoIdtwo = 'https://youtu.be/MqyJZsGFZ3M?t=';
const double _startSecondstwo = 0000000000000000000000000001262;
const String _videoIdthree = 'https://youtu.be/VK2405H3Hjk?t=';
const double _startSecondsthree = 000000000000000000000000000105;
const String _videoIdfour = 'https://youtu.be/JHjXwicEwQo?t=';
const double _startSecondsfour = 000000000000000000000000000905;
const String _videoIdfive = 'https://youtu.be/NWGVFi-213w?t=';
