...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'C6cX0wQP5NA';
    ...
    const double startSecondstwo = 2579;
    const String videoIdthree = 'ejFccNmL15g';
    const double startSecondsthree = 1547;
    const String videoIdfour = 'ZU_MF0NMKhU';
    const double startSecondsfour = 37;
    const String videoIdfive = 'tIsXEkR5OVs';
