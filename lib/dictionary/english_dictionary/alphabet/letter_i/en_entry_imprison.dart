...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000291;
    const String videoIdone = 'https://youtu.be/oiLdWXLXDeA?t=';
    const double startSecondsone = 000000000000000000000000000931;
    const String videoIdtwo = 'https://youtu.be/bcdEFos9YQQ?t=';
    const double startSecondstwo = 000000000000000000000000000103;
    const String videoIdthree = 'https://youtu.be/wJa5Ch0O4BI?t=';
    const double startSecondsthree = 0000000000000000000000000004129;
    const String videoIdfour = 'https://youtu.be/cij0pxAK9w0?t=';
    const double startSecondsfour = 00000000000000000000000000010;
    const String videoIdfive = 'https://youtu.be/VFR37y1-81M?t=';
    const double startSecondsfive = 0000000000000000000000000001019;
