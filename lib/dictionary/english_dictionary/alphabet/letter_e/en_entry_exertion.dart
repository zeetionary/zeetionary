...
class EnglishEntryexertion extends StatefulWidget {
  const EnglishEntryexertion({super.key});

  @override
  State<EnglishEntryexertion> createState() => _EnglishEntryexertionState();
}

class _EnglishEntryexertionState extends State<EnglishEntryexertion> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exertion""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exertion""",
                      // alsoEnglishWord: "also: exertion",
                      britshText: """IpaUK: /ɪɡˈzɜːʃn/""",
                      americanText: """IpaUS: /ɪɡˈzɜːrʃn/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Try to avoid physical exertion.""");
  }
...
کوردی: هەوڵ، تێکۆشان، کردوکۆش، تەقەلا، ڕەتان، زەحمەت، ڕەنج، نقەلەخۆدان، لێنەوین، هێزلێنان، هێزلێدان، چالاکی جەستەیی یان هۆشی،	بەکارهێنان، خستنەکار
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) هەوڵی دەروونی یان جەستەیی؛ هەوڵدان بۆ کردنی شتی شتێک"""),
          SentencesRow(
            englishText:
                """She was hot and breathless from the exertion of cycling uphill.""",
            kurdishText:
                """گەرما و هەناسەبڕکێی لە هەوڵدان بە پاکیلسواری بەسەر گردەکەدا.""",
          ...
          SentencesRow(
            englishText:
                """He needed to relax after the exertions of a busy day at work.""",
            kurdishText:
                """پێویست بوو بحەسێتەوە لە دوای ئیشی ڕۆژێکی سەخت لەسەر کار.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Try to avoid physical exertion.""",
            kurdishText: """هەوڵ بدە لە ماندوویەتی جەستەیی بەدوور بە.""",
            onPressedBritish: () => speaksentence3("en-GB"),
            onPressedAmerican: () => speaksentence3("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) بەکارهێنانی هێز بۆ کردنی شتێک"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """It requires no great exertion of the imagination to recognize the truth of this.""",
            kurdishText:
                """پێویستیی بە هێزی زۆری خەیاڵ نییە بۆ بینینی ڕاستی ئەمە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: exertion (Derived forms: exertions)
1. Use of physical or mental energy; hard work (= effort, elbow grease, travail [literary], sweat [informal])
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/JX82wa5HkJg?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1039;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/hCsPV0eiqxg?t=';
const double _startSecondsone = 00000000000000000000000000000; // 45;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/YLR2Vm346Lc?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 514;
const String _videoIdthree = 'VIDEOhttps://youtu.be/9ttxmg2nBOQ?t=';
const double _startSecondsthree = 000000000000000000000000000; // 703;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/ZThc79RtIeI?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 2498;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/GR4jd2-kH_E?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 458;
