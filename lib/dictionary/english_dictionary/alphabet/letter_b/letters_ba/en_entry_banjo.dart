...
// blank divider
  ...
  Future<void> speakBanjos7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBanjos77"); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "banjo", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakBanjo(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˈbændʒəʊ/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "oki150lYgWU";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "1DRjBGKbIMs";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "Xizp9MqZY10";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "N7SWUCpHme8";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "DkPhdIT0-vU";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "pb7jOme3LCk";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "E7u8-rS4Asg";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "h_cK-mtyKSg";
