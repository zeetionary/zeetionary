...
class EnglishEntryhellish extends StatefulWidget {
  const EnglishEntryhellish({super.key});

  @override
  State<EnglishEntryhellish> createState() => _EnglishEntryhellishState();
}

class _EnglishEntryhellishState extends State<EnglishEntryhellish> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hellish
1. [informal] Very unpleasant (- beastly [informal], god-awful [informal], horrible [informal], hellacious [N. Amer, informal])
"hellish weather";
 
2. Extremely evil or cruel; expressive of cruelty or befitting hell (- demonic, diabolic, diabolical, fiendish, infernal, satanic, unholy)
"hellish torture";
""",
  );

  final String keyword = "hellish";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hellish""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His school days were hellish.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We’ve had a hellish time lately.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hellish""",
                      // alsoEnglishWord: "also: hellish",
                      britshText: """IpaUK: /ˈhelɪʃ/""",
                      americanText: """IpaUS: /ˈhelɪʃ/""",
...
// With short examples define "hellish", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەم ماوەیە کاتێکی زۆر ناخۆشمان هەبووە.""",
...
const double _startSecondsend = 0000000000000000000000000001303;
const String _videoIdone = 'https://youtu.be/sJVxU2zpeLk?t=';
const double _startSecondsone = 000000000000000000000000000189;
const String _videoIdtwo = 'https://youtu.be/UShsgCOzER4?t=';
const double _startSecondstwo = 0000000000000000000000000001586;
const String _videoIdthree = 'https://youtu.be/0UABTaB-_i8?t=';
const double _startSecondsthree = 000000000000000000000000000357;
const String _videoIdfour = 'https://youtu.be/udDv4IHOhDo?t=';
const double _startSecondsfour = 00000000000000000000000000023;
const String _videoIdfive = 'https://youtu.be/VZMHSq_VQ0g?t=';
const double _startSecondsfive = 0000000000000000000000000001466;
