...
class EnglishEntryencouraging extends StatefulWidget {
  const EnglishEntryencouraging({super.key});

  @override
  State<EnglishEntryencouraging> createState() =>
      _EnglishEntryencouragingState();
}

class _EnglishEntryencouragingState extends State<EnglishEntryencouraging> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("encouraging");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "encouraging",
                      // alsoEnglishWord: "also: encouraging",
                      britshText: "IpaUK: /ɪnˈkʌrɪdʒɪŋ/",
                      americanText: "IpaUS: /ɪnˈkɜːrɪdʒɪŋ/",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "encouraging";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""You could try being a little more encouraging!""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("Despite the encouraging findings, we remain cautious.");
  }
...
کوردی: دڵ‌گەرم‌کەر، هیواپێدەر، ورەپێدەر، دڵ‌خۆش‌کەر، هاندەر
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) کە بوێری، پشتیوانی، یان هیوات پێ دەدات"""),
          SentencesRow(
            englishText: """You could try being a little more encouraging!""",
            kurdishText: """دەتتوانی کەمێک پشتیوان بیت!""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """سەرەڕای دۆزینەوە هیوابەخشەکان، بە هۆشیاری دەمێنینەوە.""",
...
2. Furnishing support and encouragement (= supporting)
...
const String _videoIdtwo = 'https://youtu.be/YFoDphBJ2Zg?t=';
const double _startSecondstwo = 886;
const String _videoIdthree = 'https://youtu.be/f5jwTft6654?t=';
const double _startSecondsthree = 524;
const String _videoIdfour = 'https://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondsfour = 4118;
const String _videoIdfive = 'https://youtu.be/5YPi2QS0oz8?t=';
const double _startSecondsfive = 685;
const String _videoIdsix = 'https://youtu.be/jwZBl6KQojM?t=';
const double _startSecondssix = 3055;
