...
class EnglishEntrybackhanded extends StatelessWidget {
  ...
  Future<void> speakBackhandeds7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBackhandeds77"); // DOPSUM: CHANGE TEXT
  }
                        ...
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˌbækˈhændɪd/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "6d0caGV1eTg";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "MDzgQOmHFXA";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "7nL-kgbbcBA";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "KC7QU1yw0og";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "YvZPU-KBCiQ";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "S7O14idhvFk";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "mXC4PPw9n2E";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "r_zJSv2JbIc";
