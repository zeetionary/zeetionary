                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "antibiotic"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌæntibaɪˈɒtɪk/"),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'p8RkiEX9j4Y';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'pkTalaQsRlw';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'SDkKCw3xeYo';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '2HUgPQftzRY';
  final double _startSeconds = 8;
