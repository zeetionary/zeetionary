...
class EnglishEntryloo extends StatefulWidget {
  const EnglishEntryloo({super.key});

  @override
  State<EnglishEntryloo> createState() => _EnglishEntrylooState();
}

class _EnglishEntrylooState extends State<EnglishEntryloo> {
  @override
  void initState() {
    super.initState();
