...
class EnglishEntryhurtful extends StatefulWidget {
  const EnglishEntryhurtful({super.key});

  @override
  State<EnglishEntryhurtful> createState() => _EnglishEntryhurtfulState();
}

class _EnglishEntryhurtfulState extends State<EnglishEntryhurtful> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hurtful""");
  }
