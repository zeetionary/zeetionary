...
class EnglishEntrylawlessness extends StatefulWidget {
  const EnglishEntrylawlessness({super.key});

  @override
  State<EnglishEntrylawlessness> createState() =>
      _EnglishEntrylawlessnessState();
}

class _EnglishEntrylawlessnessState extends State<EnglishEntrylawlessness> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lawlessness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The climate here is one of violence and lawlessness.""");
  }
...
// With short examples define "lawlessness", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە یاسا بوونی نەبێت یان پەیڕەو نەکرێت"""),
                    SentencesRow(
                      englishText:
                          """The climate here is one of violence and lawlessness.""",
                      kurdishText:
                          """کەشی ئێرە نموونەیەکی توندوتیژی و بێ‌سەرەوبەرەییە.""",
