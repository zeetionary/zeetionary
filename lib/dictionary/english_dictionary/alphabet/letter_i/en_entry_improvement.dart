...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001298;
    const String videoIdone = 'https://youtu.be/CaaJyRvvaq8?t=';
    const double startSecondsone = 000000000000000000000000000152;
    const String videoIdtwo = 'https://youtu.be/58XEfDtU0Z4?t=';
    const double startSecondstwo = 0000000000000000000000000001378;
    const String videoIdthree = 'https://youtu.be/FSHITL5oedk?t=';
    const double startSecondsthree = 000000000000000000000000000165;
    const String videoIdfour = 'https://youtu.be/ofTb57aZHZs?t=';
    const double startSecondsfour = 000000000000000000000000000421;
    const String videoIdfive = 'https://youtu.be/RlQzUX-UOW4?t=';
    const double startSecondsfive = 000000000000000000000000000115;
