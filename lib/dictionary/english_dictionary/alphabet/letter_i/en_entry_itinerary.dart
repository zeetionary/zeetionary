...
class EnglishEntryitinerary extends StatefulWidget {
  const EnglishEntryitinerary({super.key});

  @override
  State<EnglishEntryitinerary> createState() => _EnglishEntryitineraryState();
}

class _EnglishEntryitineraryState extends State<EnglishEntryitinerary> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryitinerary itinerary
WORD_WEB itinerary itinerary itinerary
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "itinerary";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""itinerary""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """itinerary""",
                      // alsoEnglishWord: "also: itinerary",
...
// کوردی:
// """),
// With short examples define "itinerary", please follow LX instructions
