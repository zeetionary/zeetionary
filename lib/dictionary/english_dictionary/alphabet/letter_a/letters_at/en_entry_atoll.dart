...
// Define the word "atoll" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryatoll - replace speakAtoll

// replace atoll - /ˈætɒl/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryatoll extends StatelessWidget {
  // blank divider
  EnglishEntryatoll({super.key});
  // blank divider
  ...
  Future<void> speakatoll1156(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The Maldives is a group of atolls in the Indian Ocean.");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "atoll"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈætɒl/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈætɔːl/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakatoll1156("en-US"),
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'WzAe7t_o0Mw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '0Q6jFb7f4Ao';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'H-qb0dxj3NA';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'LoSLZP0e-M4';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'OTQwTrYjJWM';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'iO9rAbb4Ajg';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'vKMNZyJRhBg';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'Bntj6OCe2_g';
