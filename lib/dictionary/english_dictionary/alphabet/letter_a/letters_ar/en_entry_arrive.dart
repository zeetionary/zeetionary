...
// replace EnglishEntryarrive - replace speakArrive

// replace arrive - /əˈraɪv/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarrive extends StatelessWidget {
  // blank divider
  EnglishEntryarrive({super.key});
  // blank divider
  ...
  Future<void> speakarrive524(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I'll wait until they arrive.");
  }
  ...
  Future<void> speakarrive525(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She'll arrive in New York at noon.");
  }
  ...
  Future<void> speakarrive527(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("A letter arrived for you this morning.");
  }
  ...
  Future<void> speakarrive528(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The wedding day finally arrived.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arrive"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈraɪv/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈraɪv/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '3PyXQ0UXk9w';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'WnSov1HCILo';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '4Ozte2GDeMM';
