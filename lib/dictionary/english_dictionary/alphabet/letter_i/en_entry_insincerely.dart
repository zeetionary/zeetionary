...
class EnglishEntryinsincerely extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insincerely""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '1X_KdkoGxSs';
    const double startSecondsend = 3197;
    const String videoIdone = 'ko938Us5gqQ';
    const double startSecondsone = 1181;
    const String videoIdtwo = 'OKEtoTKULyk';
    const double startSecondstwo = 10;
    const String videoIdthree = '20FLVfybuRc';
    const double startSecondsthree = 1633;
    const String videoIdfour = 'aE5S-xl6lUc';
    const double startSecondsfour = 396;
    const String videoIdfive = 'U65142yh3PI';
    const double startSecondsfive = 1167;
