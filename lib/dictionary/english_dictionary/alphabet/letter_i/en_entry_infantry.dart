...
class EnglishEntryinfantry extends StatefulWidget {
  const EnglishEntryinfantry({super.key});

  @override
  State<EnglishEntryinfantry> createState() => _EnglishEntryinfantryState();
}

class _EnglishEntryinfantryState extends State<EnglishEntryinfantry> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
 -Noun: infantry (Derived forms: infantries)
1. (military) an army unit consisting of soldiers who fight on foot (- foot)
"there came ten thousand horsemen and as many fully-armed infantry";
""",
  );

  final String keyword = "infantry";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infantry""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The infantry was/were guarding the bridge.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/s36hrId0rOo?t=';
    const double startSecondsend = 000000000000000000000000000484;
    const String videoIdone = 'https://youtu.be/-PHcdn8R4d4?t=';
    const double startSecondsone = 00000000000000000000000000073;
    const String videoIdtwo = 'https://youtu.be/HYbbmatf6w4?t=';
    const double startSecondstwo = 00000000000000000000000000075;
    const String videoIdthree = 'https://youtu.be/4kEil-H7490?t=';
    ...
    const double startSecondsfive = 000000000000000000000000000135;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """infantry""",
                      // alsoEnglishWord: "also: infantry",
                      britshText: """IpaUK: /ˈɪnfəntri/""",
                      americanText: """IpaUS: /ˈɪnfəntri/""",
...
کوردی: 
"""),
// With short examples define "infantry", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) هێزی پیادە"""),
                    SentencesRow(
                      englishText:
                          """The infantry was/were guarding the bridge.""",
                      kurdishText: """هێزی پیادە پردەکەی دەپاراست.""",
