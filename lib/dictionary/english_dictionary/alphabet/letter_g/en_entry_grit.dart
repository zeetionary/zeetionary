...
class EnglishEntrygrit extends StatefulWidget {
  const EnglishEntrygrit({super.key});

  @override
  State<EnglishEntrygrit> createState() => _EnglishEntrygritState();
}

class _EnglishEntrygritState extends State<EnglishEntrygrit> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grit (Derived forms: grits)
1. Grains of rock or sand
 
2. A hard coarse-grained siliceous sandstone (- gritrock, gritstone)
 
3. Fortitude and determination (- backbone, guts, moxie [N. Amer, informal], sand [N. Amer, informal], gumption [informal], cojones [N. Amer])
"he didn't have the grit to try it";

- Verb: grit (Derived forms: gritted, grits, gritting)
1. Cover with a grit
"grit roads"
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I had a piece of grit in my eye.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A bit of grit had got into my eye.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grit""",
                      // alsoEnglishWord: "also: grit",
                      britshText: """IpaUK: /ɡrɪt/""",
                      americanText: """IpaUS: /ɡrɪt/""",
...
"""),
// With short examples define "grit", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """A bit of grit had got into my eye.""",
                      kurdishText: """تۆزقاڵە بەردێک چووبووە چاوم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەندێک کات بێ‌هیوا بوو، بەڵام کۆڵنەدان و سووربوونی بە بەردەوامی هێشتییەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/U61yzVVlUoE?t=';
const double _startSecondsend = 000000000000000000000000000311;
const String _videoIdone = 'https://youtu.be/Bbi0kEaTgio?t=';
const double _startSecondsone = 000000000000000000000000000857;
const String _videoIdtwo = 'https://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondstwo = 0000000000000000000000000003895;
const String _videoIdthree = 'https://youtu.be/JFqiSr9A-Go?t=';
...
const String _videoIdfive = 'https://youtu.be/pavLytzPMgM?t=';
const double _startSecondsfive = 0000000000000000000000000001249;
