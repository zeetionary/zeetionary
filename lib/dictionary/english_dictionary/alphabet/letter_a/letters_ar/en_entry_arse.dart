...
class EnglishEntryarse extends StatelessWidget {
  ...
  Future<void> speakarse803(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Get off your arse!");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arse"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ɑːs/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ɑːrs/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'pEerrMQe7tk';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'JV14tr3qHgk';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'BtiQvhQF8IA';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'sOrXp9jDJAA';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '7z3nMSOI3BY';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 's_wuzlzhXKs';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = '8-1MAqbxTbo';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'yXohcxCKqvo';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'XfmPu8l24wY';
