...
class EnglishEntryanswer extends StatefulWidget {
  const EnglishEntryanswer({super.key});

  @override
  State<EnglishEntryanswer> createState() => _EnglishEntryanswerState();
}

class _EnglishEntryanswerState extends State<EnglishEntryanswer> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """answer""",
                      // alsoEnglishWord: "also: answer",
                      britshText: """IpaUK: /ˈɑːnsə(r)/""",
                      americanText: """IpaUS: /ˈænsər/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText: "I rang the bell, but there was no answer.",
                    ...
                    SentencesRow(
                      englishText: "Can't you give me a definitive answer?",
                    ...
                    // const DividerDefinition(),
                    SentencesRow(
                      englishText: "She had no answer to the accusations.",
...
٢. (ناو) شتێک کە دەینووسیت یان دەیڵێیت وەک وەڵام بۆ پرسیارێک لە تاقیکردنەوەیەک"""),
                    SentencesRow(
                      englishText: "Write your answers on the sheet provided.",
                      kurdishText:
...
٣. (ناو) چارەسەری کێشەیەک"""),
                    SentencesRow(
                      englishText: "This may not be the answer for everyone.",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "چارەسەری ڕوون ھەڵوەشاندنەوەی ئاھەنگەکەیە.",
...
٤. (کردار) کردن، نووسین، یان وتنی شتێک وەک وەڵام بۆ پرسیارێک یان بارودۆخێک"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "ڕەتی‌کردەوە وەڵامی تۆمەتەکانی دژی بداتەوە.",
