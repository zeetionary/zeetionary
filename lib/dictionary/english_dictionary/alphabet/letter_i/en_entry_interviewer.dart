...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'Ys1EjAGzuDk';
    ...
    const double startSecondstwo = 1054;
    const String videoIdthree = '_9rucsh5brg';
    const double startSecondsthree = 424;
    const String videoIdfour = '89cXbrLB52c';
    const double startSecondsfour = 561;
