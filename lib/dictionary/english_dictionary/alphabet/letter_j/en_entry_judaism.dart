...
class EnglishEntryjudaism extends StatefulWidget {
  const EnglishEntryjudaism({super.key});

  @override
  State<EnglishEntryjudaism> createState() => _EnglishEntryjudaismState();
}

class _EnglishEntryjudaismState extends State<EnglishEntryjudaism> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Judaism""");
  }
