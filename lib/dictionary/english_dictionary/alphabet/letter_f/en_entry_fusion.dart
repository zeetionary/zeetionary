...
class EnglishEntryfusion extends StatefulWidget {
  const EnglishEntryfusion({super.key});

  @override
  State<EnglishEntryfusion> createState() => _EnglishEntryfusionState();
}

class _EnglishEntryfusionState extends State<EnglishEntryfusion> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fusion (Derived forms: fusions)
1. An occurrence that involves the production of a union (- merger, unification)
 
2. The state of being combined into one body (- coalition)
 
3. The merging of adjacent sounds, syllables or words
 
4. A nuclear reaction in which nuclei combine to form more massive nuclei with the simultaneous release of energy (- nuclear fusion, nuclear fusion reaction)
 
5. The combining of images from the two eyes to form a single visual percept (- optical fusion)
 
6. Correction of an unstable part of the spine by joining two or more vertebrae; usually done surgically but sometimes done by traction or immobilization (- spinal fusion)
 
7. The act of fusing (or melting) together
""",
  );

  final String keyword = "fusion";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The movie displayed a perfect fusion of image and sound.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Scientists study nuclear fusion for energy production.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fusion""",
                      // alsoEnglishWord: "also: fusion",
                      britshText: """IpaUK: /ˈfjuːʒn/""",
                      americanText: """IpaUS: /ˈfjuːʒn/""",
...
کوردی: پێکالکان، پێکانووسان، یەک‌بوون، پێکاچەسپین، پێکاچوون، پێکداچوون، یەک‌گرتن، بوونەیەک، یەک‌کەوتن، پێکەوەبەستراوی، پێکەوەلکاوی،	پێکالکان یان پێکەوەنووسانی ناوکی،	توانەوە، شل‌بوونەوە،	ئاوێتە، تێکەڵە،	تێکەڵی، لێکدان، تێکەڵ‌کردن، تێک‌هەڵکێشان، یەکخستن، کردنەیەک
"""),
// With short examples define "fusion", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) تێکەڵبوونی دوو شت بۆ پێکهێننای یەکێک"""),
                    SentencesRow(
                      englishText:
                          """The movie displayed a perfect fusion of image and sound.""",
                      kurdishText:
                          """فیلمەکە تێکەڵبوونی بێ‌خەوشی وێنە و دەنگی پیشان دا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ئەوەی ناوکی ئەتۆم تێکەڵ بکەیت و بۆ پێکهێنانی یەک ناوکی گەورەتر و لە پڕۆسەکەدا وزە دەربدەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Scientists study nuclear fusion for energy production.""",
                      kurdishText:
                          """زاناکان لێکۆڵینەوە دەکەن لەسەر یەکگرتنی ناوەکی بۆ بەرهەمهێنانی وزە.""",
...
const double _startSecondsone = 0000000000000000000000000001318;
const String _videoIdtwo = 'https://youtu.be/QcUey-DVYjk?t=';
const double _startSecondstwo = 0000000000000000000000000001431;
const String _videoIdthree = 'https://youtu.be/FaCeZsOOKEY?t=';
const double _startSecondsthree = 000000000000000000000000000496;
const String _videoIdfour = 'https://youtu.be/6NOtF4l9i9g?t=';
const double _startSecondsfour = 00000000000000000000000000023;
const String _videoIdfive = 'https://youtu.be/Kp_kqamkYpw?t=';
const double _startSecondsfive = 000000000000000000000000000116;
