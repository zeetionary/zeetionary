...
class EnglishEntryextrapolate extends StatefulWidget {
  const EnglishEntryextrapolate({super.key});

  @override
  State<EnglishEntryextrapolate> createState() =>
      _EnglishEntryextrapolateState();
}

class _EnglishEntryextrapolateState extends State<EnglishEntryextrapolate> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extrapolate""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extrapolate""",
                      // alsoEnglishWord: "also: extrapolate",
                      britshText: """IpaUK: extrapolate""",
                      americanText: """IpaUS: extrapolate""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extrapolate";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Try not to extrapolate too much from your own experience.""");
  }
...
"""),
          ...
          SentencesRow(
            englishText:
                """The figures were obtained by extrapolating from past trends.""",
            kurdishText:
                """ئامارەکان بەدەستخران بە مەزەندەکردنی ترێندەکانی ڕابردوو.""",
          ...
          SentencesRow(
            englishText:
                """The results cannot be extrapolated to other patient groups.""",
            kurdishText:
                """ئەنجامەکان ناکرێت بۆ گرووپی نەخۆشەکانی دیکەش مەزەندە بکرێت.""",
...
const String _videoIdtwo = 'https://youtu.be/8bshv_9HWw4?t=';
const double _startSecondstwo = 000000000000000000000000000160;
const String _videoIdthree = 'https://youtu.be/J-K2yeQylCk?t=';
...
const String _videoIdfive = 'https://youtu.be/vXIAB_1FEC0?t=';
