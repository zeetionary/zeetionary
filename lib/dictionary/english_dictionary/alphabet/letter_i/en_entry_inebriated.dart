...
class EnglishEntryinebriated extends StatefulWidget {
  const EnglishEntryinebriated({super.key});

  @override
  State<EnglishEntryinebriated> createState() => _EnglishEntryinebriatedState();
}

class _EnglishEntryinebriatedState extends State<EnglishEntryinebriated> {
  @override
  void initState() {
    super.initState();
...
1. Stupefied or excited by a chemical substance (especially alcohol) (- intoxicated, drunk, ripped [informal], gone, inebriate, skunked [informal])
"helplessly inebriated";
""",
  );

  final String keyword = "inebriated";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inebriated""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The programme offers not just a free ride home for inebriated drivers and their passengers, but the opportunity to get their car home safely as well.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000748;
    const String videoIdone = 'https://youtu.be/xoYS_j7uEAk?t=';
    const double startSecondsone = 0000000000000000000000000001002;
    const String videoIdtwo = 'https://youtu.be/pTk9HnIwEYU?t=';
    const double startSecondstwo = 000000000000000000000000000306;
    const String videoIdthree = 'https://youtu.be/H5_HVUS1l0Y?t=';
    const double startSecondsthree = 000000000000000000000000000669;
    const String videoIdfour = 'https://youtu.be/2IxD3WFHXxs?t=';
    const double startSecondsfour = 000000000000000000000000000316;
    const String videoIdfive = 'https://youtu.be/ENhfIeZF_AY?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inebriated""",
                      // alsoEnglishWord: "also: inebriated",
                      britshText: """IpaUK: /ɪˈniːbrieɪtɪd/""",
                      americanText: """IpaUS: /ɪˈniːbrieɪtɪd/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """The programme offers not just a free ride home for inebriated drivers and their passengers, but the opportunity to get their car home safely as well.""",
                      kurdishText:
                          """پڕۆگرامەکە نەک تەنها گەیاندنەوە ماڵەوەی بێ‌بەرامبەر دەدات بە شۆفێرە سەرخۆشەکان و سەرنشینەکانیان، بەڵکو ئەوەی کە ئۆتۆمبێلەکەش بە سەلامەتی بگەیەنێتەوە ماڵەوە.""",
