...
class EnglishEntrygunshot extends StatefulWidget {
  const EnglishEntrygunshot({super.key});

  @override
  State<EnglishEntrygunshot> createState() => _EnglishEntrygunshotState();
}

class _EnglishEntrygunshotState extends State<EnglishEntrygunshot> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gunshot (Derived forms: gunshots)
1. The act of shooting a gun (- gunfire)
"the gunshot endangered innocent bystanders";
""",
  );

  final String keyword = "gunshot";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gunshot""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He died of a single gunshot wound to the chest.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I heard the sound of gunshots out in the street.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gunshot""",
                      // alsoEnglishWord: "also: gunshot",
                      britshText: """IpaUK: /ˈɡʌnʃɒt/""",
                      americanText: """IpaUS: /ˈɡʌnʃɑːt/""",
...
// With short examples define "gunshot", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بە برینی یەک فیشەک لە سنگیدا مرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """گوێم لە دەنگی فیشەک‌تەقاندن بوو لە دەرەوە.""",
