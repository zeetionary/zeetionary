...
class EnglishEntryinkling extends StatefulWidget {
  const EnglishEntryinkling({super.key});

  @override
  State<EnglishEntryinkling> createState() => _EnglishEntryinklingState();
}

class _EnglishEntryinklingState extends State<EnglishEntryinkling> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inkling""");
  }
