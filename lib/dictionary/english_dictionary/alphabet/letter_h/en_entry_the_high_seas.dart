...
class EnglishEntrythehighseas extends StatefulWidget {
  const EnglishEntrythehighseas({super.key});

  @override
  State<EnglishEntrythehighseas> createState() =>
      _EnglishEntrythehighseasState();
}

class _EnglishEntrythehighseasState extends State<EnglishEntrythehighseas> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "the high seas";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""the high seas""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Countries must follow international laws when fishing on the high seas.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """the high seas""",
                      // alsoEnglishWord: "also: the high seas",
                      britshText: """IpaUK: /ðə ˌhaɪ ˈsiːz/""",
                      americanText: """IpaUS: /ðə ˌhaɪ ˈsiːz/""",
...
// With short examples define "the high seas", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەو بەشانەی زەریاکان کە هیچ وڵاتێک مافی یاسایی بەسەریانەوە نییە"""),
                    SentencesRow(
                      englishText:
                          """Countries must follow international laws when fishing on the high seas.""",
                      kurdishText:
                          """وڵاتان دەبێت پابەند بن بە یاسا نێودەوڵەتییەکان کە لە ئاوە سەربەخۆکان ڕاو دەکەن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/RJQPthD9rx8?t=';
const double _startSecondsend = 000000000000000000000000000778;
const String _videoIdone = 'https://youtu.be/3ulWkFs-OGM?t=';
const double _startSecondsone = 0000000000000000000000000001017;
const String _videoIdtwo = 'https://youtu.be/-UYS__NBS-E';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/GHRZ8JHTEf0?t=';
const double _startSecondsthree = 00000000000000000000000000073;
const String _videoIdfour = 'https://youtu.be/xmVmg0uzk74?t=';
const double _startSecondsfour = 000000000000000000000000000340;
const String _videoIdfive = 'https://youtu.be/P8aGMa3fpOY?t=';
