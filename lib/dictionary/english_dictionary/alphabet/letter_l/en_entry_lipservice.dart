...
class EnglishEntrylipservice extends StatefulWidget {
  const EnglishEntrylipservice({super.key});

  @override
  State<EnglishEntrylipservice> createState() => _EnglishEntrylipserviceState();
}

class _EnglishEntrylipserviceState extends State<EnglishEntrylipservice> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "lip service";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lip service""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""All the parties pay lip service to environmental issues.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/DHOSiFzcHJ8?t=1021';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/mUH4Co2wE-I?t=2192';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/DuFyGHgGIKg?t=406';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/DcWqzZ3I2cY?t=3542';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/YZAibo7eiik?t=1045';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/VZ9u8S26tGk?t=13296';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lip service""",
                      // alsoEnglishWord: "also: lip service",
                      britshText: """IpaUK: /ˈlɪp sɜːvɪs/""",
                      americanText: """IpaUS: /ˈlɪp sɜːrvɪs/""",
...
کوردی: 
"""),
// With short examples define "lip service", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) کە کەسێک پشتگیری ڕابگەیەنێت بۆ شتێک بەڵام هیچ نەکات بۆ پشتگیری کردنی"""),
                    SentencesRow(
                      englishText: """All the parties pay lip service to environmental issues.""",
                      kurdishText: """هەموو پارتەکان بە زارەکی پشتگیری کێشە ژینگەییەکان دەکەن.""",
