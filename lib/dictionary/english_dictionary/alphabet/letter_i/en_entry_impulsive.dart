...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/n7WH7A2v7OU?t=';
    const double startSecondsend = 000000000000000000000000000560;
    const String videoIdone = 'https://youtu.be/Hw1X5oFPgro?t=';
    const double startSecondsone = 0000000000000000000000000001788;
    const String videoIdtwo = 'https://youtu.be/qS_VWG3JEZg?t=';
    const double startSecondstwo = 000000000000000000000000000518;
    const String videoIdthree = 'https://youtu.be/tZktTdGHaJY?t=';
    const double startSecondsthree = 0000000000000000000000000001188;
    const String videoIdfour = 'https://youtu.be/N4wW85WZMJQ?t=';
    const double startSecondsfour = 000000000000000000000000000432;
    const String videoIdfive = 'https://youtu.be/ItgkkdIgPe0?t=';
