...
class EnglishEntrygynaecology extends StatefulWidget {
  const EnglishEntrygynaecology({super.key});

  @override
  State<EnglishEntrygynaecology> createState() =>
      _EnglishEntrygynaecologyState();
}

class _EnglishEntrygynaecologyState extends State<EnglishEntrygynaecology> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gynaecology (Derived forms: gynaecologies)
Usage: Brit, Cdn (US: gynecology)
1. The branch of medicine that deals with the diseases and hygiene of women (- gynecology [N. Amer])
""",
  );

  final String keyword = "gynaecology";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gynaecology""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gynaecology""",
                      // alsoEnglishWord: "also: gynaecology",
                      britshText: """IpaUK: /ˌɡaɪnəˈkɒlədʒi/""",
                      americanText: """IpaUS: /ˌɡaɪnəˈkɑːlədʒi/""",
