...
class EnglishEntryactivity extends StatefulWidget {
  const EnglishEntryactivity({super.key});

  @override
  State<EnglishEntryactivity> createState() => _EnglishEntryactivityState();
}

class _EnglishEntryactivityState extends State<EnglishEntryactivity> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """activity""",
                      // alsoEnglishWord: "also: activity",
                      britshText: """IpaUK: /ækˈtɪvəti/""",
                      americanText: """IpaUS: /ækˈtɪvəti/""",
