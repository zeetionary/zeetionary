...
class EnglishEntryentrust extends StatefulWidget {
  const EnglishEntryentrust({super.key});

  @override
  State<EnglishEntryentrust> createState() => _EnglishEntryentrustState();
}

class _EnglishEntryentrustState extends State<EnglishEntryentrust> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""entrust""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """entrust""",
                      // alsoEnglishWord: "also: entrust",
                      britshText: """IpaUK: /ɪnˈtrʌst/""",
                      americanText: """IpaUS: /ɪnˈtrʌst/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He entrusted the task to his nephew.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) پێدانی بەرپرسیاریەتی بە کەسێک بۆ کردن یان چاودێری کردنی شتێک"""),
          SentencesRow(
            englishText: """He entrusted the task to his nephew.""",
            englishNote: "Similar: He entrusted his nephew with the task.",
            kurdishText: """ئەرکەی سپارد بە خوشکەزا/برازایەکەی.""",
          ...
          SentencesRow(
            englishText:
                """He didn't look like the sort of man you should entrust a task like this to.""",
            kurdishText:
                """لەو کەسانە نەدەچوو کە شتێکی باش بێت ئەرکی وەها بسپێریت پێی.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: entrust (Derived forms: entrusts, entrusted, entrusting)
1. Confer a trust upon (= intrust [archaic], trust, confide, commit)
"The messenger was entrusted with the general's secret";
 
2. Put into the care or protection of someone (= leave)
"He entrusted the decision to his deputy";
""",
  );
...
const String _videoIdone = '15AGWA9bTjo';
const double _startSecondsone = 1082;
const String _videoIdtwo = '_2LApgOJe5k';
const double _startSecondstwo = 80;
const String _videoIdthree = 'zvBiIvKUiOQ';
const double _startSecondsthree = 124;
const String _videoIdfour = 'j4kI2h3iotA';
const double _startSecondsfour = 2439;
const String _videoIdfive = 'V3PK_fBIzBM';
const double _startSecondsfive = 1119;
const String _videoIdsix = '1ZKBaRsP1gY';
const double _startSecondssix = 277;
