...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'HvNdJ2RCReg';
    const double startSecondsend = 38;
    const String videoIdone = 'hFZFjoX2cGg';
    const double startSecondsone = 96;
    const String videoIdtwo = 'ozsgl_sLnHQ';
    const double startSecondstwo = 1992;
    const String videoIdthree = 'EdQxtsTwHHs';
    const double startSecondsthree = 0;
    const String videoIdfour = 'Pto9L7kjuSM';
