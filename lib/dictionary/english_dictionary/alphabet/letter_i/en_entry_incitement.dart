...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'GHUHgk8xCs0';
    const double startSecondsend = 1835;
    const String videoIdone = 'LJ0Hfc8hvpE';
    const double startSecondsone = 108;
    const String videoIdtwo = '0DSO5Khbi1s';
    const double startSecondstwo = 276;
    const String videoIdthree = 'tYrdMjVXyNg';
    const double startSecondsthree = 5124;
    const String videoIdfour = 'XwqAInN9HWI';
    const double startSecondsfour = 35;
    const String videoIdfive = 'OaLxTz1Yw7M';
