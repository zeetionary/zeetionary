...
class EnglishEntryhothead extends StatefulWidget {
  const EnglishEntryhothead({super.key});

  @override
  State<EnglishEntryhothead> createState() => _EnglishEntryhotheadState();
}

class _EnglishEntryhotheadState extends State<EnglishEntryhothead> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hothead (Derived forms: hotheads)
1. A belligerent grouch (- fire-eater)
 
2. A reckless impetuous irresponsible person (- daredevil, madcap, swashbuckler, lunatic, harum-scarum)
""",
  );

  final String keyword = "hothead";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hothead""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He's a real hothead when things don't go his way.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/rR4t9LRy-6o?t=';
    const double startSecondsone = 000000000000000000000000000430;
    const String videoIdtwo = 'https://youtu.be/6H8h5HSI84c?t=';
    const double startSecondstwo = 000000000000000000000000000947;
    const String videoIdthree = 'https://youtu.be/LbalOCu5Xqc?t=';
    const double startSecondsthree = 000000000000000000000000000106;
    const String videoIdfour = 'https://youtu.be/lcWDirWLyRo?t=';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/RRmhBbECoG4';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hothead""",
                      // alsoEnglishWord: "also: hothead",
                      britshText: """IpaUK: /ˈhɒthed/""",
                      americanText: """IpaUS: /ˈhɑːthed/""",
...
// کوردی: بنیادەمی بەپەلە، بنیادەمی کەم‌تاقەت، مرۆی بە پڕتاو، مرۆی سەرتوند
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە زۆرجار زۆر بە خێرایی ڕەفتار دەکات بەبێ ئەوەی بیر لە دەرەنجامەکانی بکاتەوە"""),
                    SentencesRow(
                      englishText:
                          """He's a real hothead when things don't go his way.""",
                      kurdishText:
                          """کەسێکی تەواو هەڵچووە کە شتەکان بەو شێوەیە ناچن کە دەیەوێت.""",
