...
class EnglishEntryhelplessness extends StatefulWidget {
  const EnglishEntryhelplessness({super.key});

  @override
  State<EnglishEntryhelplessness> createState() =>
      _EnglishEntryhelplessnessState();
}

class _EnglishEntryhelplessnessState extends State<EnglishEntryhelplessness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: helplessness
1. Powerlessness revealed by an inability to act (- weakness, impuissance)
"in spite of their helplessness the group remains active";
...
""",
  ...
  final String keyword = "helplessness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""helplessness""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """helplessness""",
                      // alsoEnglishWord: "also: helplessness",
                      britshText: """IpaUK: /ˈhelpləsnəs/""",
                      americanText: """IpaUS: /ˈhelpləsnəs/""",
...
کوردی: بێچارەیی، داماوی، بێ‌یاری
"""),
// With short examples define "helplessness", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هەستی ئەوەی کە نەتوانیت ئاگاداری خۆت بیت یان شتێک بکەیت بەبێ یارمەتی کەسانی دیکە"""),
                    SentencesRow(
                      englishText:
                          """Doing something for others can stem feelings of helplessness.""",
                      kurdishText:
                          """کردنی شتێک بۆ کەسانی دیکە دەکرێت هەستی داماوی درووست بکات.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Her story was all about one woman's feelings of frustration and helplessness.""",
                      kurdishText:
                          """چیرۆکەکە هەمووی دەربارەی هەستی بێ‌هیوایی و بێ‌چارەیی ژنێک بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/q8HRGiUeZwc?t=';
const double _startSecondsend = 000000000000000000000000000319;
const String _videoIdone = 'https://youtu.be/n_aq5TVb0HA?t=';
const double _startSecondsone = 000000000000000000000000000484;
const String _videoIdtwo = 'https://youtu.be/DCHbhDxBLko?t=';
...
const String _videoIdfour = 'https://youtu.be/mrilDQugeME?t=';
const double _startSecondsfour = 000000000000000000000000000540;
const String _videoIdfive = 'https://youtu.be/PuYJQsIJzhg?t=';
