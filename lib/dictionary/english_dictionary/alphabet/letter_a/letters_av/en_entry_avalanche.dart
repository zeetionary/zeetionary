...
class EnglishEntryavalanche extends StatelessWidget {
  ...
  Future<void> speakAvalanches7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvalanches7c"); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "avalanche", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˈævəlæntʃ/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "7j3ivJx1faE";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "RnCCqHOiX5Q";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "_v1rrMuKtcI";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "-a0TKbf_zOo";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "hn_cOO80sHM";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "Gic31-wDkZw";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "rBEPUD91iD4";
