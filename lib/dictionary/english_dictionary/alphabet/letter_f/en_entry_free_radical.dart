...
class EnglishEntryfreeradical extends StatefulWidget {
  const EnglishEntryfreeradical({super.key});

  @override
  State<EnglishEntryfreeradical> createState() =>
      _EnglishEntryfreeradicalState();
}

class _EnglishEntryfreeradicalState extends State<EnglishEntryfreeradical> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: free radical (Derived forms: free radicals)
1. An atom or group of atoms with at least one unpaired electron; in the body it is usually an oxygen molecule that has lost an electron and will stabilize itself by stealing an electron from a nearby molecule (= radical)
"in the body free radicals are high-energy particles that ricochet wildly and damage cells";
""",
  );

  final String keyword = "free radical";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""free radical""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """free radical""",
                      // alsoEnglishWord: "also: free radical",
                      britshText: """IpaUK: /ˌfriː ˈrædɪkl/""",
                      americanText: """IpaUS: /ˌfriː ˈrædɪkl/""",
...
// With short examples define "free radical", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Free radicals have been implicated in cancer and many other serious diseases.""",
                      kurdishText:
                          """ئەتۆمە ئازادەکان بەژداری  شێرپەنجە و زۆر نەخۆشی توندی دیکەن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/jJx-f_VZK2c?t=';
const double _startSecondsend = 00000000000000000000000000014;
const String _videoIdone = 'https://youtu.be/66VdylXI0nQ?t=';
const double _startSecondsone = 000000000000000000000000000515;
const String _videoIdtwo = 'https://youtu.be/eqQnJIx17io?t=';
const double _startSecondstwo = 000000000000000000000000000141;
const String _videoIdthree = 'https://youtu.be/nsUIG5PSENQ?t=';
const double _startSecondsthree = 000000000000000000000000000192;
const String _videoIdfour = 'https://youtu.be/8OB2bnN1Vus?t=';
const double _startSecondsfour = 000000000000000000000000000458;
const String _videoIdfive = 'https://youtu.be/oJLA8iNUV-0?t=';
const double _startSecondsfive = 0000000000000000000000000001286;
