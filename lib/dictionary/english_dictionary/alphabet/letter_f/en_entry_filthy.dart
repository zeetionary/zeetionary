...
class EnglishEntryfilthy extends StatefulWidget {
  const EnglishEntryfilthy({super.key});

  @override
  State<EnglishEntryfilthy> createState() => _EnglishEntryfilthyState();
}

class _EnglishEntryfilthyState extends State<EnglishEntryfilthy> {
  @override
  void initState() {
    super.initState();
...
2. Vile; despicable (= dirty, lousy [informal], cruddy [informal])
"a filthy trick";
 
3. Characterized by obscenity (= foul, nasty, smutty)
"had a filthy mouth";
""",
  );

  final String keyword = "filthy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It's filthy in here!""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Why are the streets so filthy in this part of the city?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He's got a filthy mind.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""That's enough of your filthy language!""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was in a filthy mood.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Ann gave him a filthy look.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Isn't it a filthy day?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """filthy""",
                      // alsoEnglishWord: "also: filthy",
                      britshText: """IpaUK: /ˈfɪlθi/""",
                      americanText: """IpaUS: /ˈfɪlθi/""",
...
// With short examples define "filthy", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """It's filthy in here!""",
                      kurdishText: """زۆر پیسە ئێرە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """That's enough of your filthy language!""",
                      kurdishText: """بەسە ئەو زمانە پیسەت!""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Ann gave him a filthy look.""",
                      kurdishText: """ئان نیگایەکی تووڕەیی لێکرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/KJy7T24rhg0?t=';
const double _startSecondsend = 000000000000000000000000000378;
const String _videoIdone = 'https://youtu.be/Cqbleas1mmo?t=';
const double _startSecondsone = 000000000000000000000000000678;
const String _videoIdtwo = 'https://youtu.be/TRGHIN2PGIA?t=';
const double _startSecondstwo = 000000000000000000000000000678;
const String _videoIdthree = 'https://youtu.be/-w7bTb4qVPU?t=';
const double _startSecondsthree = 000000000000000000000000000237;
const String _videoIdfour = 'https://youtu.be/jrHz8Bti6FY?t=';
const double _startSecondsfour = 000000000000000000000000000173;
const String _videoIdfive = 'https://youtu.be/UoSSCUMk-7I?t=';
const double _startSecondsfive = 000000000000000000000000000705;
