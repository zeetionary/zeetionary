...
class EnglishEntryaddicted extends StatefulWidget {
  const EnglishEntryaddicted({super.key});

  @override
  State<EnglishEntryaddicted> createState() => _EnglishEntryaddictedState();
}

class _EnglishEntryaddictedState extends State<EnglishEntryaddicted> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""addicted""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'H4vA9RotpK4';
    const double startSecondsend = 11;
    const String videoIdone = 'giiqCn5p5j4';
    const double startSecondsone = 1;
    const String videoIdtwo = 'Gupq0-5DYUQ?';
    const double startSecondstwo = 1;
    const String videoIdthree = 'rEIb5eQ5MsY';
    const double startSecondsthree = 3;
    const String videoIdfour = 'd77b9oefbSs';
    const double startSecondsfour = 19;
    const String videoIdfive = 'htkEmbDaoMA';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """addicted""",
                      // alsoEnglishWord: "also: addicted",
                      britshText: """IpaUK: /əˈdɪktɪd/""",
                      americanText: """IpaUS: /əˈdɪktɪd/""",
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakaddict7451("en-US"),
                          ),
                  ],
                ),
              ),
