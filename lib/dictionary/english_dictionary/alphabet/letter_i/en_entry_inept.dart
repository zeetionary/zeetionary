...
class EnglishEntryinept extends StatefulWidget {
  const EnglishEntryinept({super.key});

  @override
  State<EnglishEntryinept> createState() => _EnglishEntryineptState();
}

class _EnglishEntryineptState extends State<EnglishEntryinept> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: inept
1. Not elegant or graceful in expression (- awkward, clumsy, cumbersome, inapt, ill-chosen, clunky [informal])
"if the rumour is true, can anything be more inept than to repeat it now?";
 
2. Generally incompetent and ineffectual (- feckless)
"inept handling of the account";
 
3. Revealing lack of perceptiveness, judgment or finesse (- tactless)
"an inept remark";
""",
  );

  final String keyword = "inept";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He's intelligent but socially inept.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He made some particularly inept remarks.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/iKhQYYSqhgc?t=';
    const double startSecondsend = 00000000000000000000000000020;
    const String videoIdone = 'https://youtu.be/a7DYaTxrDg8?t=';
    const double startSecondsone = 000000000000000000000000000342;
    const String videoIdtwo = 'https://youtu.be/QLv7SkInz70?t=';
    const double startSecondstwo = 000000000000000000000000000740;
    const String videoIdthree = 'https://youtu.be/I8VNA55S-7I?t=';
    const double startSecondsthree = 000000000000000000000000000233;
    const String videoIdfour = 'https://youtu.be/VIz05lZMKyM?t=';
    const double startSecondsfour = 000000000000000000000000000294;
    const String videoIdfive = 'https://youtu.be/m6TW35oIefE?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inept""",
                      // alsoEnglishWord: "also: inept",
                      britshText: """IpaUK: /ɪˈnept/""",
                      americanText: """IpaUS: /ɪˈnept/""",
...
کوردی: نابەجێ، بێجێ، نەگونجاو، نالەبار، هیچ نییە، نەشیاو، لێنەهاتوو، لێنەوەشاو
"""),
// With short examples define "inept", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە شتێک بەبێ شارەزایی دەکەیت؛ کە شتێک بەبێ شارەزایی کراوە"""),
                    SentencesRow(
                      englishText:
                          """He's intelligent but socially inept (= not good at relating to people socially).""",
                      kurdishText:
                          """زیرەکە بەڵام لە ڕووی کۆمەڵایەتییەوە نەشارەزاییە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ژمارەیەک لێدوانی نەشارەزاییانەی دا.""",
