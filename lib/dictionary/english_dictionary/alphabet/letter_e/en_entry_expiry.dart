...
class EnglishEntryexpiry extends StatefulWidget {
  const EnglishEntryexpiry({super.key});

  @override
  State<EnglishEntryexpiry> createState() => _EnglishEntryexpiryState();
}

class _EnglishEntryexpiryState extends State<EnglishEntryexpiry> {
  @override
  void initState() {
    super.initState();
  }
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The licence can be renewed on expiry.""");
  }
...
کوردی: بەسەرچوون، ڕاب(و)ردن، تەواوبوون، کۆتایی‌پێ‌هاتن، خلاس‌بوون
"""),
          const DefinitionKurdish(
              text: """١. (ناو) ڕێکەوتی کۆتایی هاتنی شتێک"""),
          SentencesRow(
            englishText: """The licence can be renewed on expiry.""",
            kurdishText: """مۆڵەتەکە دەکرێت لەگەڵ بەسەرچوون تازەبکرێتەوە.""",
          ...
          SentencesRow(
            englishText:
                """Your passport should be renewed before its expiry.""",
            kurdishText: """پاسپۆرتەکەت دەبێت پێش بەسەرچوون تازەبکرێتەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: expiry (Derived forms: expiries)
1. A coming to an end of a contract period (= termination, expiration)
"the expiry of his driver's licence";
 
2. The event of dying or departure from life (= death, decease)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/A5w-dEgIU1M?t=';
const double _startSecondsend = 000000000000000000000000000000; // 274;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/MFO6OtnmEDo?t=';
const double _startSecondsone = 00000000000000000000000000000; // 720;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/uTrFAY3LUNw?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 164;
const String _videoIdthree = 'VIDEOhttps://youtu.be/g0USYkuJZ8o?t=';
const double _startSecondsthree = 000000000000000000000000000; // 48;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/I1u9RNmfTuE?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 546;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/z6hTodqWPc8?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 681;
