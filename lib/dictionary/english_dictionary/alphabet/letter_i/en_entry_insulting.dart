...
class EnglishEntryinsulting extends StatefulWidget {
  const EnglishEntryinsulting({super.key});

  @override
  State<EnglishEntryinsulting> createState() => _EnglishEntryinsultingState();
}

class _EnglishEntryinsultingState extends State<EnglishEntryinsulting> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insulting""");
  }
