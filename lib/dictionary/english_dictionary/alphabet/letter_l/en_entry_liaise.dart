...
class EnglishEntryliaise extends StatefulWidget {
  const EnglishEntryliaise({super.key});

  @override
  State<EnglishEntryliaise> createState() => _EnglishEntryliaiseState();
}

class _EnglishEntryliaiseState extends State<EnglishEntryliaise> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: liaise (Derived forms: liaising, liaises, liaised)
1. Act between parties with a view to reconciling differences (- intercede, mediate, intermediate, arbitrate)
""",
  );

  final String keyword = "liaise";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He had to liaise directly with the police while writing the report.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her job is to liaise between students and teachers.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/rZuvXWxOJTE?t=673';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/BD3my03ioio?t=634';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/gHjbay54F4U?t=1211';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/WcoQQmujddU?t=115';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/88SGfykwt8g?t=405';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/GlLUr07oAZ8?t=2840';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """liaise""",
                      // alsoEnglishWord: "also: liaise",
                      britshText: """IpaUK: /liˈeɪz/""",
                      americanText: """IpaUS: /liˈeɪz/""",
...
کوردی: 
"""),
// With short examples define "liaise", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) کارکردن لە نزیکەوە لەگەڵ کەسێک و گۆڕینەوەی زانیاری لەگەڵیدا"""),
                    SentencesRow(
                      englishText: """He had to liaise directly with the police while writing the report.""",
                      kurdishText: """پێویست بوو ڕاستەوخۆ هەماهەنگی لەگەڵ پۆلیس بکات لە کاتی نووسینی ڕاپۆرتەکە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) هەبوونی ئەرکی نێوەندگیر لەنێوان دوو کەس یان گرووپ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her job is to liaise between students and teachers.""",
                      kurdishText: """کاری ئەوەیە هەماهەنگی لەنێوان خوێندکاران و مامۆستایان بکات.""",
