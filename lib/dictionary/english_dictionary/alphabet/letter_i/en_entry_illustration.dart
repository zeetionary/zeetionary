...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Ihoys69G56U?t=';
    const double startSecondsend = 000000000000000000000000000396;
    const String videoIdone = 'https://youtu.be/nn8zfDv3EbA?t=';
    const double startSecondsone = 000000000000000000000000000339;
    const String videoIdtwo = 'https://youtu.be/L1kYZHnHS0E?t=';
    const double startSecondstwo = 000000000000000000000000000393;
    const String videoIdthree = 'https://youtu.be/wJa5Ch0O4BI?t=';
    const double startSecondsthree = 0000000000000000000000000001050;
    const String videoIdfour = 'https://youtu.be/Wao0_uB4Zw4?t=';
    const double startSecondsfour = 0000000000000000000000000001568;
    const String videoIdfive = 'https://youtu.be/IwJzsE8CvzQ?t=';
