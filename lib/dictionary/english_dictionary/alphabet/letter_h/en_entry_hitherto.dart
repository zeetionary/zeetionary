...
class EnglishEntryhitherto extends StatefulWidget {
  const EnglishEntryhitherto({super.key});

  @override
  State<EnglishEntryhitherto> createState() => _EnglishEntryhithertoState();
}

class _EnglishEntryhithertoState extends State<EnglishEntryhitherto> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: hitherto
1. Used in negative statement to describe a situation that has existed up to this point or up to the present time (- so far, thus far, up to now, heretofore, as yet, yet, til now, until now)
"hitherto imperturbable, he now showed signs of alarm";
""",
  );

  final String keyword = "hitherto";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hitherto""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Her life hitherto had been devoid of adventure.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000942;
    const String videoIdone = 'https://youtu.be/KZbzIf_C6Y4?t=';
    const double startSecondsone = 0000000000000000000000000001808;
    const String videoIdtwo = 'https://youtu.be/8X1xYpPmKvA?t=';
    const double startSecondstwo = 0000000000000000000000000004033;
    const String videoIdthree = 'https://youtu.be/_ZQ03ki7-UU?t=';
    const double startSecondsthree = 0000000000000000000000000001060;
    const String videoIdfour = 'https://youtu.be/ZkIRVNIqBKQ?t=';
    const double startSecondsfour = 000000000000000000000000000741;
    const String videoIdfive = 'https://youtu.be/tnLXW-p5Wig?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hitherto""",
                      // alsoEnglishWord: "also: hitherto",
                      britshText: """IpaUK: /ˌhɪðəˈtuː/""",
                      americanText: """IpaUS: /ˌhɪðərˈtuː/""",
...
// With short examples define "hitherto", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ژیانی تا ئەوکاتە بەدەر لە سەرکێشی بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Mira revealed hitherto unsuspected talents on the dance floor.""",
                      englishNote:
                          """This means Mira showed talents on the dance floor that had not been noticed or known until that moment.""",
                      kurdishText:
                          """میرا بەهرەی گومان بۆنەبراوی تا ئەوکات پیشان دا لەسەر تەختەی سەما.""",
