...
class EnglishEntryfurnish extends StatefulWidget {
  const EnglishEntryfurnish({super.key});

  @override
  State<EnglishEntryfurnish> createState() => _EnglishEntryfurnishState();
}

class _EnglishEntryfurnishState extends State<EnglishEntryfurnish> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: furnish (Derived forms: furnished, furnishes, furnishing)
1. Give something useful or necessary to (- supply, provide, render, offer)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""furnish""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The room was furnished with antiques.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They've furnished the room very simply.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She furnished him with the facts surrounding the case.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furnish""",
                      // alsoEnglishWord: "also: furnish",
                      britshText: """IpaUK: /ˈfɜːnɪʃ/""",
                      americanText: """IpaUS: /ˈfɜːrnɪʃ/""",
...
// With short examples define "furnish", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) دانانی کەلوپەلی ناوماڵ لە ژوورێک، خانوویەک، هتد"""),
                    SentencesRow(
                      englishText: """The room was furnished with antiques.""",
                      kurdishText: """ژوورەکە کەلوپەلی کۆنی تێخرابوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆر بە سادەیی کەلوپەلیان داناوە لە ژوورەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """زانیارییەکانی سەبارەت بە کەیسەکە پێدا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Foreign investors furnished most of the capital for the project.""",
                      kurdishText:
                          """وەبەرهێنەرانی بیانی زۆرینەی پارەی پڕۆژەکەیان دا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/FSHITL5oedk?t=';
const double _startSecondsend = 000000000000000000000000000427;
const String _videoIdone = 'https://youtu.be/gjySnrspD7E?t=';
const double _startSecondsone = 0000000000000000000000000002196;
const String _videoIdtwo = 'https://youtu.be/zgacuXdzCmw?t=';
const double _startSecondstwo = 000000000000000000000000000132;
const String _videoIdthree = 'https://youtu.be/FZrrfGfI3uM?t=';
const double _startSecondsthree = 000000000000000000000000000687;
const String _videoIdfour = 'https://youtu.be/vtMWkWnaoq4?t=';
const double _startSecondsfour = 00000000000000000000000000032;
const String _videoIdfive = 'https://youtu.be/0e8woEkKmG8?t=';
const double _startSecondsfive = 0000000000000000000000000003055;
