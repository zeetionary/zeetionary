...
class EnglishEntryfigureofspeech extends StatefulWidget {
  const EnglishEntryfigureofspeech({super.key});

  @override
  State<EnglishEntryfigureofspeech> createState() =>
      _EnglishEntryfigureofspeechState();
}

class _EnglishEntryfigureofspeechState
    extends State<EnglishEntryfigureofspeech> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "figure of speech";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""figure of speech""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak(""""Break a leg" is a figure of speech, meaning "good luck".""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: figure of speech",
                      britshText: """IpaUK: /ˌfɪɡər əv ˈspiːtʃ/""",
                      americanText: """IpaUS: /ˌfɪɡjər əv ˈspiːtʃ/""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/zouGFPlbtkk?t=';
const double _startSecondsend = 00000000000000000000000000072;
const String _videoIdone = 'https://youtu.be/wn29IiFIgDA?t=';
const double _startSecondsone = 00000000000000000000000000044;
const String _videoIdtwo = 'https://youtu.be/O0dHmsbqh8k?t=';
const double _startSecondstwo = 000000000000000000000000000482;
const String _videoIdthree = 'https://youtu.be/1H2EGYcKF-c?t=';
const double _startSecondsthree = 00000000000000000000000000013;
const String _videoIdfour = 'https://youtu.be/2oxueftPzhY?t=';
const double _startSecondsfour = 00000000000000000000000000029;
const String _videoIdfive = 'https://youtu.be/HsMzE2MwN8o?t=';
