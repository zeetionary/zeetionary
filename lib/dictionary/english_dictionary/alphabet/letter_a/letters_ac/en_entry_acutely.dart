...
class EnglishEntryacutely extends StatefulWidget {
  const EnglishEntryacutely({super.key});

  @override
  State<EnglishEntryacutely> createState() => _EnglishEntryacutelyState();
}

class _EnglishEntryacutelyState extends State<EnglishEntryacutely> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acutely""",
                      // alsoEnglishWord: "also: acutely",
                      britshText: """IpaUK: /əˈkjuːtli/""",
                      americanText: """IpaUS: /əˈkjuːtli/""",
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakacute7481("en-US"),
                          ),
                          const DividerDefinition(),
...
٢. (ھاوەڵکار) دەرکەوتنی ھەستێکی خراپ زۆر بە زەقی"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakacute666632("en-US"),
                          ),
                        ],
                      ),
                    ),
