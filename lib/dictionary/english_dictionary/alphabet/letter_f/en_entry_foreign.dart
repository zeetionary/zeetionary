...
کوردی: دەرەکی، دەروەیی، دەرەوە،	لە دەرەوەی وڵات، هەٌڵکەوتوو لە دەرەوەی وڵات (خۆ)،	بێگانە، بیانی، لایدە، نەناس، لاوەکی، غەوارە، غەیرە، نائاشنا، ناشناس، نائاسایی،	بێگانە، بیانی، لە لایەن دەزگای پاراستنەوە وەک بەشێکی خۆ ناناسرێتەوە
"""),
// With short examples define "foreign", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چووم بۆ بانک بۆ بەدەستخستنی هەندێک دروای بیانی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وڵاتەکە هەوڵ دەدات وەبەرهێنانی بیانی بەدەست بهێنێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەو جۆرە هەڵسووکەوتە تەواو نامۆیە پێی.""",
...
const String _videoIdtwo = 'https://youtu.be/-L7o6HtX8Vg?t=';
const double _startSecondstwo = 000000000000000000000000000970;
const String _videoIdthree = 'https://youtu.be/mY3SEMTROas?t=';
const double _startSecondsthree = 000000000000000000000000000328;
const String _videoIdfour = 'https://youtu.be/b1reY72ktEc?t=';
const double _startSecondsfour = 00000000000000000000000000025;
const String _videoIdfive = 'https://youtu.be/HxRUuGqqMG4?t=';
const double _startSecondsfive = 0000000000000000000000000001413;
