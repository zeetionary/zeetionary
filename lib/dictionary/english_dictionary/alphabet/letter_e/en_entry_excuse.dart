...
کوردی: بیانوو، بۆنە، بەهانە، بیانک، پەڵپ، هەواڵە بە گەواڵە، دەساوێز، بیانووی ژیرانە،	لێبوردن‌خوازی
"""),
          ...
          SentencesRow(
            ...
            kurdishText: """بێهوودە بۆ بیانوویەک دەگەڕام.""",
          ...
          SentencesRow(
            ...
            kurdishText: """دەتوانم دواوادەکەم پەڕداوە، بەڵام بیانووم هەیە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هیچ بیانوویەک بۆ ڕەفتاری وەها نییە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """نامەوێت هیچ بیانووی دیکە بدۆزمەوە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) هۆکارێکی گونجاو بۆ کردنی شتێک کە دەتەوێت بیکەیت بۆ مەبەستی دیکە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """It's just an excuse for a party.""",
            kurdishText: """ئەوە تەنها بیانووە بۆ ئاهەنگێک.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """شکستخواردووانە هەوڵی دا بۆ دۆزینەوەی بیانوویەک بۆ ڕۆشتن.""",
          ...
          SentencesRow(
            englishText:
                """The demonstration was used as an excuse to impose martial law.""",
            kurdishText:
                """خۆپیشاندانەکە وەک بیانوو بەکارهات بۆ سەپاندنی باری نائاسایی.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """پێویست بوو بیانوویەکی گونجاو بدۆزێتەوە بۆ جێهێشتنی ژوورەکە.""",
              ...
              MyExpansionTile(
                children: [
                  SentencesRow(
                    ...
                    kurdishText:
                        """دەبێت لە باوکم خۆشبیت ـ هەمیشە وەها بێ‌ڕێز نییە.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """هیوادارم لێم ببووری کە هێندە درەنگ کەوتووم.""",
                  ...
                  SentencesRow(
                    englishText:
                        """If you'll excuse me pointing this out, I think you've made a mistake here.""",
                    kurdishText:
                        """ئەگەر بمبووریت ئەمە بخەمە بەر باس، پێموایە لێرە هەڵەیەکت کردووە.""",
          ...
          const DividerDefinition(),
          const DefinitionKurdish(text: """٥. (کردار) بیانوو هێنانەوە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Nothing can excuse such rudeness.""",
            kurdishText: """هیچ ناتوانێت بێ‌ڕێزی وەها پۆزش بکات.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """دەمتوانی پۆزش بۆ خۆم بهێنمەوە، بەڵام بۆچی هەوڵ بدەم؟""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """هیچ هەوڵێک نادات بۆ هێنانەوەی بیانوو بۆ کارەکانی.""",
          ...
          SentencesRow(
            ...
            kurdishText: """داوای ڕۆشتنی خواست و زوو چاوپێکەوتنەکەی جێهێشت.""",
          ...
          SentencesRow(
            ...
            kurdishText: """بەخشرا لە پێدانی بەڵگە بەهۆی تەمەنەکەیەوە.""",
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/_spuxXnul0U?t=';
const double _startSecondsend = 000000000000000000000000000000; // 887;
...
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/D0x2dgpBDzc?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 130;
const String _videoIdthree = 'VIDEOhttps://youtu.be/r5cqa9V0mUo?t=';
const double _startSecondsthree = 000000000000000000000000000; // 874;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/iAnlaR398hs?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 120;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/VwPGtn9qJZ4?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 691;
