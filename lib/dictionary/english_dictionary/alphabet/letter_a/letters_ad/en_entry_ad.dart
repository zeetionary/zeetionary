...
class EnglishEntryad extends StatefulWidget {
  const EnglishEntryad({super.key});

  @override
  State<EnglishEntryad> createState() => _EnglishEntryadState();
}

class _EnglishEntryadState extends State<EnglishEntryad> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ad""",
                      // alsoEnglishWord: "also: ad",
                      britshText: """IpaUK: /æd/, /ˌeɪˈdiː/""",
                      americanText: """IpaUS: /æd/, /ˌeɪˈdiː/""",
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakad142568("en-US"),
                          ),
...
٢. (ھاوەڵکار) لە دوای لەدایکبوونی پێغەمبەر عیسا."""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakad4247("en-US"),
                          ),
                        ],
                      ),
                    ),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'Bhro-CO1QA4';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'Q6Y7eNvD-Ng';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '_qWF9ycAb90';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'ltpY063yUmY';
