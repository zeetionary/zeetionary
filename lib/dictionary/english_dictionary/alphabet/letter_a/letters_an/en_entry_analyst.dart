                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "analyst"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈænəlɪst/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakanalyst("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈænəlɪst/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakanalyst("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'VG5bRHbzWdg';
