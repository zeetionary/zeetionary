...
// replace these: replace EnglishEntryageold - replace speakAgeold - replace age-old - /ˌeɪdʒ ˈəʊld/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryageold extends StatelessWidget {
  EnglishEntryageold({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "age-old", // DOPSUM: CHANGE WORD ENTRY - Find /ˌeɪdʒ ˈəʊld/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌeɪdʒ ˈəʊld/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAgeold(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                      ...
                      child: Column(
                        ...
                        children: [
                          const Text(
                            ...
                            '''
کوردی: لەمێژینە، دێرین، بە تەمەنێک پێشینە، کۆن
    ...
    return const SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          Text('''
- Adjective: age-old 
1. Belonging to or lasting from times long ago (= antique)
"age-old customs";
'''),
        ],
      ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'd2-BHPI8ggM';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'Hybm--GAgmo';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'GF_bsZMe7zg';
