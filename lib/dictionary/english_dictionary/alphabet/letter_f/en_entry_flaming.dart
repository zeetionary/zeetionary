...
class EnglishEntryflaming extends StatefulWidget {
  const EnglishEntryflaming({super.key});

  @override
  State<EnglishEntryflaming> createState() => _EnglishEntryflamingState();
}

class _EnglishEntryflamingState extends State<EnglishEntryflaming> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flaming
1. Informal intensifier (= bally [Brit, informal], blinking [Brit, informal], bloody [Brit, informal], blooming [Brit, informal], crashing, freaking [informal], effing [Brit, informal])
"what a flaming nuisance"; "you flaming idiot";
 
2. Passionate or quick-tempered (= fiery)
"flaming passions";

- Noun: flaming (Derived forms: flamings)
1. The process of combustion of flammable materials; produces heat, light, and (often) smoke (= fire, flame)
""",
  );

  final String keyword = "flaming";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flaming""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We had a flaming row over it last night.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Flaming fragments were still falling from the sky.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Who let that flaming cat in?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flaming""",
                      // alsoEnglishWord: "also: flaming",
                      britshText: """IpaUK: /ˈfleɪmɪŋ/""",
                      americanText: """IpaUS: /ˈfleɪmɪŋ/""",
...
// With short examples define "flaming", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شەوی ڕابردوو مشتومڕێکی توندمان هەبوو سەبارەت بەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پارچەی گڕگرتوو هێشتا لە ئاسمانەوە دەبارین.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Who let that flaming cat in?""",
                      kurdishText:
                          """کێ ڕێگای بەو پشیلە نەفرەتییە دا بێتە ژوورەوە؟""",
...
const String _videoIdone = 'https://youtu.be/FWYsvw_U3Zw?t=';
const double _startSecondsone = 000000000000000000000000000192;
const String _videoIdtwo = 'https://youtu.be/fNJI2A0v8yI?t=';
const double _startSecondstwo = 000000000000000000000000000201;
const String _videoIdthree = 'https://youtu.be/6i9UUvxhAlY?t=';
const double _startSecondsthree = 000000000000000000000000000699;
const String _videoIdfour = 'https://youtu.be/VMrHnpTMYfk?t=';
const double _startSecondsfour = 000000000000000000000000000184;
const String _videoIdfive = 'https://youtu.be/PYzhuFS8YkE?t=';
const double _startSecondsfive = 000000000000000000000000000262;
