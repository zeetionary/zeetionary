...
class EnglishEntrygulf extends StatefulWidget {
  const EnglishEntrygulf({super.key});

  @override
  State<EnglishEntrygulf> createState() => _EnglishEntrygulfState();
}

class _EnglishEntrygulfState extends State<EnglishEntrygulf> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gulf (Derived forms: gulfs)
1. An arm of a sea or ocean partly enclosed by land; larger than a bay
 
2. An unbridgeable disparity (as from a failure of understanding) (- disconnect, disconnection, disconnexion [Brit])
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Many hurricanes form in the Gulf of Mexico.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Tensions in the Gulf can affect global oil prices.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The gulf between rich and poor is enormous.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gulf""",
                      // alsoEnglishWord: "also: gulf",
                      britshText: """IpaUK: gulf""",
                      americanText: """IpaUS: gulf""",
...
// With short examples define "gulf", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Many hurricanes form in the Gulf of Mexico.""",
                      kurdishText:
                          """زۆر گێژەلووکە لە کەنداوی مەکسیک درووست دەبێت.""",
