...
class EnglishEntrykeynote extends StatefulWidget {
  const EnglishEntrykeynote({super.key});

  @override
  State<EnglishEntrykeynote> createState() => _EnglishEntrykeynoteState();
}

class _EnglishEntrykeynoteState extends State<EnglishEntrykeynote> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: keynote (Derived forms: keynotes)
1. The principal theme in a speech or literary work
 
2. A fundamental or central idea
 
3. (music) the first note of a diatonic scale (- tonic)

- Verb: keynote (Derived forms: keynoted, keynotes, keynoting)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""keynote""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Choice is the keynote of the new education policy.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/4U2ZxO7b8iM?t=442';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/dtp6b76pMak?t=1083';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/Unzc731iCUY?t=3532';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/ZWgr7qP6yhY?t=297';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/w_lDeCxjLQc?t=130';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/OoJsPvmFixU?t=206';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """keynote""",
                      // alsoEnglishWord: "also: keynote",
                      britshText: """IpaUK: /ˈkiːnəʊt/""",
                      americanText: """IpaUS: /ˈkiːnəʊt/""",
...
کوردی: 
"""),
// With short examples define "keynote", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بیرۆکەی سەرەکیی کتێبێک، وتارێک، هتد"""),
                    SentencesRow(
                      englishText:
                          """Choice is the keynote of the new education policy.""",
                      kurdishText:
                          """هەڵبژاردە مژاری سەرەکی سیاسەتی پەروەردەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """This issue has become the keynote of the election campaign.""",
                      kurdishText:
                          """بابەتەکە بووە بە مژاری سەرەکی کەمپینی هەڵبژاردن.""",
