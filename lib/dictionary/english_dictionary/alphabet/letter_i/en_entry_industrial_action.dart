...
class EnglishEntryindustrialaction extends StatefulWidget {
  const EnglishEntryindustrialaction({super.key});

  @override
  State<EnglishEntryindustrialaction> createState() =>
      _EnglishEntryindustrialactionState();
}

class _EnglishEntryindustrialactionState
    extends State<EnglishEntryindustrialaction> {
  @override
  void initState() {
    super.initState();
...
Usage: Brit (N. Amer: job action)
1. A temporary action by workers to protest management decision or to make demands (- job action [N. Amer])
""",
  );

  final String keyword = "industrial action";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""industrial action""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/N9L7mrUj3mE?t=';
    const double startSecondsend = 000000000000000000000000000638;
    const String videoIdone = 'https://youtu.be/yXxxZ3b-3X4?t=';
    const double startSecondsone = 000000000000000000000000000811;
    const String videoIdtwo = 'https://youtu.be/TQr3X1jV8Hc?t=';
    const double startSecondstwo = 000000000000000000000000000766;
    const String videoIdthree = 'https://youtu.be/041iK0Xm2_U?t=';
    const double startSecondsthree = 0000000000000000000000000001051;
    const String videoIdfour = 'https://youtu.be/LbpMqFM4E6k?t=';
    const double startSecondsfour = 0000000000000000000000000001053;
    const String videoIdfive = 'https://youtu.be/jFAvkg_LF74?t=';
    const double startSecondsfive = 0000000000000000000000000001796;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: industrial action",
                      britshText: """IpaUK: /ɪnˌdʌstriəl ˈækʃn/""",
                      americanText: """IpaUS: /ɪnˌdʌstriəl ˈækʃn/""",
...
// With short examples define "industrial action", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The union is considering stepping up its industrial action.""",
                      kurdishText:
                          """سەندیکاکە بیر لە زیادکردنی ناڕەزایی کرێکارانی دەکاتەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The union is threatening industrial action against the company.""",
                      kurdishText:
                          """سەندیکاکە هەڕەشەی ناڕەزایی کرێکاران دەکات دژ بە کۆمپانیاکە.""",
