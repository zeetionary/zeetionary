...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'rdICAzaaTtc';
    const double startSecondsend = 466;
    const String videoIdone = 'A2EyZ8EViHQ';
    const double startSecondsone = 644;
    const String videoIdtwo = 'Lg-nUy2DalM';
    const double startSecondstwo = 1535;
    const String videoIdthree = 'A5tGUi1Twuc';
    const double startSecondsthree = 209;
    const String videoIdfour = 'qrbFXkI4RzU';
    const double startSecondsfour = 357;
    const String videoIdfive = 'xa8BYZrSTxY';
