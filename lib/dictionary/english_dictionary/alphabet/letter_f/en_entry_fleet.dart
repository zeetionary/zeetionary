...
class EnglishEntryfleet extends StatefulWidget {
  const EnglishEntryfleet({super.key});

  @override
  State<EnglishEntryfleet> createState() => _EnglishEntryfleetState();
}

class _EnglishEntryfleetState extends State<EnglishEntryfleet> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fleet (Derived forms: fleets)
...
- Adjective: fleet (Derived forms: fleetest, fleeter)
1. Moving very fast (= swift)
"fleet of foot"; "the fleet scurrying of squirrels";

- Verb: fleet (Derived forms: fleeted, fleeting, fleets)
1. Move along rapidly and lightly; skim or dart (= flit, flutter, dart)
"The hummingbird fleeted among the branches";
 
2. Disappear gradually (= evanesce, fade, blow over, pass off, pass)
""",
  );

  final String keyword = "fleet";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The entire fleet was sunk.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The whaling fleet set sail at dawn.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The fleet was mobilized and the country prepared for war.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The airline is doubling the size of its fleet.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fleet""",
                      // alsoEnglishWord: "also: fleet",
                      britshText: """IpaUK: /fliːt/""",
                      americanText: """IpaUS: /fliːt/""",
...
// With short examples define "fleet", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Nelson destroyed the Franco-Spanish fleet at the Battle of Trafalgar.""",
                      kurdishText:
                          """نێڵسن کەشتیگەکی فەرەنسی-ئیسپانی لە شەڕی ترافڵگار تێکشکاند.""",
                    ...
                    SentencesRow(
                      englishText: """The entire fleet was sunk.""",
                      kurdishText: """تەواوی کەشتیگەلەکە نوقمکرا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەستەکەشتییە نەهەنگ ڕاوکەرەکە لە بەرەبەیاندا دەستیان بە گەشت دەکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هێزی دەریایی خرایە حاڵەتی ئامادەباشی و وڵاتەکە ئامادەکاری بۆ جەنگ کرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ناو) ژمارەیەک فڕۆکە، پاس، تەکسی، هتد ەکە پێکەوە گەشت دەکەن و یان هی هەمان دامەزراوەن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The airline is doubling the size of its fleet.""",
                      kurdishText:
                          """هێڵە ئاسمانییەکە ڕێژەی فڕۆکەکانی دوو هێندە دەکات.""",
...
const double _startSecondsend = 000000000000000000000000000755;
const String _videoIdone = 'https://youtu.be/zqllxbPWKNI?t=';
const double _startSecondsone = 0000000000000000000000000001576;
const String _videoIdtwo = 'https://youtu.be/aCPNlZ7bvRc?t=';
const double _startSecondstwo = 00000000000000000000000000050;
const String _videoIdthree = 'https://youtu.be/ARPQAT73BYQ';
const double _startSecondsthree = 193;
const String _videoIdfour = 'https://youtu.be/HoH5KvDFz-s?t=';
const double _startSecondsfour = 0000000000000000000000000007;
const String _videoIdfive = 'https://youtu.be/BwoTXpao7no?t=';
const double _startSecondsfive = 00000000000000000000000000015;
