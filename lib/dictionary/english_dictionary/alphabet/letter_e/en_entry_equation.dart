...
class EnglishEntryequation extends StatefulWidget {
  const EnglishEntryequation({super.key});

  @override
  State<EnglishEntryequation> createState() => _EnglishEntryequationState();
}

class _EnglishEntryequationState extends State<EnglishEntryequation> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equation""",
                      // alsoEnglishWord: "also: equation",
                      britshText: """IpaUK: /ɪˈkweɪʒn/""",
                      americanText: """IpaUS: /ɪˈkweɪʒn/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This can be shown by a simple equation.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""In the equation 3x - 3 = 15, x = 6.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.speak(
        """The students were learning to solve simple equations, such as 6 + x = 18.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The equation of wealth with happiness can be dangerous.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Money also comes into the equation.""");
  }
...
// With short examples define "equation", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: (بیرکاری) هاوکێشە،	هاوسەنگی، هاوکێشی، بەرامبەبوون،	کاری وەک‌یەک‌دانان، کاری بە بەرامبەر زانین، بەرامبەرکردن
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) هاوکێشەیەک کە ئەوە پیشان دەدات کە دوو بڕ یەکسانن"""),
          SentencesRow(
            englishText: """This can be shown by a simple equation.""",
            kurdishText: """ئەمە دەکرێت بە هاوکێشەیەکی سادە پیشان بدرێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """In the equation 3x - 3 = 15, x = 6.""",
            kurdishText: """لە هاوکێشەی ٣x - ٣ = ١٥، x = ٦.""",
          ...
          SentencesRow(
            englishText:
                """The students were learning to solve simple equations, such as 6 + x = 18.""",
            kurdishText:
                """خوێندکارەکان خەریک بوون فێری شیکارکردنی هاوکێشەی سادە دەبوون، وەک ٦ + x = ١٨.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) هاوتاکردنی شتێک یان ئەوەی شتێک بە هاوتا سەیر بکەیت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The equation of wealth with happiness can be dangerous.""",
            kurdishText: """یەکسانکردنی سامان بە خۆشی دەکرێت مەترسیدار بێت.""",
          ...
          SentencesRow(
            englishText:
                """When children enter the equation, further tensions may arise within a marriage.""",
            kurdishText:
                """کە منداڵ دێتە هاوکێشەکەوە، کێشەی زیاتر ڕەنگە درووست ببێت لە هاوسەرگیری.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Money also comes into the equation.""",
            kurdishText: """هەروەها پارە دێتە هاوکێشەکەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: equation (Derived forms: equations)
1. (mathematics) a mathematical statement that two expressions are equal
 
2. A state of being essentially equal or equivalent; equally balanced (= equality, equivalence, par)
 
3. The act of regarding as equal (= equating)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/tMKXbLBgkEc?t=';
const double _startSecondsend = 000000000000000000000000000000; // 657;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/NFtQOxjWfaA?t=';
const double _startSecondsone = 00000000000000000000000000000; // 98;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/bHIhgxav9LY?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 220;
const String _videoIdthree = 'VIDEOhttps://youtu.be/bGqvimnOTeg?t=';
const double _startSecondsthree = 000000000000000000000000000; // 160;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/cqidD7kVnxY?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 53;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/7c1FO8FT__U?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 285;
