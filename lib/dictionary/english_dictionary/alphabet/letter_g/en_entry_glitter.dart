...
class EnglishEntryglitter extends StatefulWidget {
  const EnglishEntryglitter({super.key});

  @override
  State<EnglishEntryglitter> createState() => _EnglishEntryglitterState();
}

class _EnglishEntryglitterState extends State<EnglishEntryglitter> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""glitter""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The water glittered in the sunlight.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The ceiling of the cathedral glittered with gold.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His eyes glittered with greed.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There was a glitter of frost on the grass.""");
  }
...
کوردی: درەوشانەوە، ورشانەوە، بریقانەوە، تروسکە، بریسکە، ئارنگ، درەوشەدرەوش، ورشەورش، تروسکەتروسک، بریسک‌وهۆڕ
"""),
// With short examples define "glitter", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The water glittered in the sunlight.""",
                      kurdishText: """ئاوەکە لەبەر تیشکە خۆرەکەدا دەبریسکایەوە.""",
                    ...
                    SentencesRow(
                      englishText: """The ceiling of the cathedral glittered with gold.""",
                      kurdishText: """بنبانی کڵێسا گەورەکە بە زێڕەوە دەبریسکایەوە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) ئەوەی چاو پڕ لە هەستێک بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) بریسکانەوەی شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There was a glitter of frost on the grass.""",
                      kurdishText: """بریسکانەوەی زوقم لەسەر چیمەنەکە بوو.""",
                    ...
                    textAfterLink: "",
                    onTap: () {
                    Routemaster.of(context).push("/english-glitter/glint");
                    },
                    ),
                    const DividerDefinition(),
                    CustomRichText(
                    ...
                    textAfterLink: "",
                    onTap: () {
                    Routemaster.of(context).push("/english-glitter/glamour");
                    },
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """ژممر. (کردار) پننسە"""),
...
const double _startSecondsthree = 0000000000000000000000000001118;
const String _videoIdfour = 'https://youtu.be/CQQit01HHLY?t=';
const double _startSecondsfour = 000000000000000000000000000175;
const String _videoIdfive = 'https://youtu.be/MzSktgpfD84?t=';
