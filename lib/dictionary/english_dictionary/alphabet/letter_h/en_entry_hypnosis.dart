...
class EnglishEntryhypnosis extends StatefulWidget {
  const EnglishEntryhypnosis({super.key});

  @override
  State<EnglishEntryhypnosis> createState() => _EnglishEntryhypnosisState();
}

class _EnglishEntryhypnosisState extends State<EnglishEntryhypnosis> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hypnosis""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 2081;
    const String videoIdone = 'nARcrP7GNso';
    const double startSecondsone = 1068;
    const String videoIdtwo = 'drhDGeNauuo';
    const double startSecondstwo = 1371;
    const String videoIdthree = 'nnzYZdGFzzM';
    const double startSecondsthree = 151;
    const String videoIdfour = 'l6PlMpncVuc';
    const double startSecondsfour = 198;
    const String videoIdfive = 'H-u6a66rTpQ';
