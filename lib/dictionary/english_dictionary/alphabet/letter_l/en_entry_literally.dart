...
class EnglishEntryliterally extends StatefulWidget {
  const EnglishEntryliterally({super.key});

  @override
  State<EnglishEntryliterally> createState() => _EnglishEntryliterallyState();
}

class _EnglishEntryliterallyState extends State<EnglishEntryliterally> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "literally";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""literally""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The word ‘planet’ literally means ‘wandering body’.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""When I told you to ‘get lost’ I didn't expect to be taken literally.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There are literally hundreds of prizes to win.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He literally flew across the room.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/JUFf5yrZDbA?t=18';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/hFZFjoX2cGg?t=1018';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/21Z4RIOFhMA?t=334';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/khOUvmOQExc?t=31';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/hS2x1zl4rn0?t=561';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/a_TSR_v07m0?t=67';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """literally""",
                      // alsoEnglishWord: "also: literally",
                      britshText: """IpaUK: /ˈlɪtərəli/""",
                      americanText: """IpaUS: /ˈlɪtərəli/""",
...
کوردی: 
"""),
// With short examples define "literally", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵکار) بە شێوەیەک کە سەرەتاییترین واتای وشەیەک بێت نەک واتای وێژەیی یان خوازراوی"""),
                    SentencesRow(
                      englishText: """The word ‘planet’ literally means ‘wandering body’.""",
                      kurdishText: """وشەی 'planet' لە بنچینەدا واتا 'تەنی گەرۆک'.""",
                    ...
                    SentencesRow(
                      englishText: """When I told you to ‘get lost’ I didn't expect to be taken literally.""",
                      kurdishText: """کە گوتم 'ونبە لەبەرچاوم' نەمزانی وەک خۆی وەردەگیردرێت.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵکار) بۆ جەختکردنەوە لە ڕاستی شتێک کە ڕەنگە سەرنجڕاکێش بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There are literally hundreds of prizes to win.""",
                      kurdishText: """هەر بە ڕاستی سەدان خەڵات هەن بۆ بردنەوە.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ھاوەڵکار) بۆ جەختکردنەوە لە وشە یان دەستەواژەیەک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He literally flew across the room.""",
                      kurdishText: """هەر ڕێک بە ژوورەکەدا فڕی.""",
