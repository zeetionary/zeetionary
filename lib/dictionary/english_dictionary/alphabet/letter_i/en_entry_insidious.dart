...
// With short examples define "insidious", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە بە هێواشی ڕوودەدات بەبێ ئەوەی هەستی پێ بکرێت، بەڵام زیانی خراپ دەگەیەنێت"""),
                    SentencesRow(
                      englishText:
                          """High blood pressure is an insidious condition which has few symptoms.""",
                      kurdishText:
                          """فشاری خوێنی دۆخێکی خراپە کە کەم نیشانەی هەیە.""",
