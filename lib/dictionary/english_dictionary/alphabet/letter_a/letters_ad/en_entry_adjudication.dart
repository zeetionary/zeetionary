...
class EnglishEntryadjudication extends StatelessWidget {
  ...
  Future<void> speakadjudication(String languageCode) async {
    ...
    await flutterTts.speak("adjudication");
  }
  ...
  Future<void> speakadjudi5684(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The case was referred to a higher court for adjudication.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˌdʒuːdɪˈkeɪʃn/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final double _startSeconds = 3510;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'C5K8pM9WP9E';
