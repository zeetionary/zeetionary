...
class EnglishEntryaromatic extends StatelessWidget {
  ...
  Future<void> speakaromatic(String languageCode) async {
    ...
    await flutterTts.speak("aromatic");
  }
  ...
  Future<void> speakaromatic857(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The plant is strongly aromatic.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "aromatic"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌærəˈmætɪk/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌærəˈmætɪk/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '5VhwkoP3fsE';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '10Wj_Enb1AA';
