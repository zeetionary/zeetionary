...
class EnglishEntryfilling extends StatefulWidget {
  const EnglishEntryfilling({super.key});

  @override
  State<EnglishEntryfilling> createState() => _EnglishEntryfillingState();
}

class _EnglishEntryfillingState extends State<EnglishEntryfilling> {
  @override
  void initState() {
    super.initState();
...
4. The yarn woven across the warp yarn in weaving (= woof, weft, pick)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""filling""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I had to have two fillings at the dentist's today.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""One of my fillings came out this morning.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She baked a sponge cake with cream filling for the party.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """filling""",
                      // alsoEnglishWord: "also: filling",
                      britshText: """IpaUK: /ˈfɪlɪŋ/""",
                      americanText: """IpaUS: /ˈfɪlɪŋ/""",
...
// With short examples define "filling", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەمڕۆ پێویست بوو دوو پڕکردنەوە لای پزیشکە ددانەکە بکەم.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/idWpZ63isMo?t=';
const double _startSecondsend = 000000000000000000000000000121;
const String _videoIdone = 'https://youtu.be/Ihoys69G56U?t=';
const double _startSecondsone = 000000000000000000000000000691;
const String _videoIdtwo = 'https://youtu.be/4VTOplLl2BM?t=';
const double _startSecondstwo = 000000000000000000000000000572;
const String _videoIdthree = 'https://youtu.be/qWAagS_MANg?t=';
const double _startSecondsthree = 000000000000000000000000000806;
const String _videoIdfour = 'https://youtu.be/219YybX66MY?t=';
const double _startSecondsfour = 000000000000000000000000000474;
const String _videoIdfive = 'https://youtu.be/Ow50TBiytiE?t=';
const double _startSecondsfive = 000000000000000000000000000407;
