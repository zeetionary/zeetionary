...
class EnglishEntryflounce extends StatefulWidget {
  const EnglishEntryflounce({super.key});

  @override
  State<EnglishEntryflounce> createState() => _EnglishEntryflounceState();
}

class _EnglishEntryflounceState extends State<EnglishEntryflounce> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flounce (Derived forms: flounces)
1. A strip of pleated material used as a decoration or a trim (= frill, ruffle, furbelow)
 
2. The act of walking with exaggerated jerky motions

- Verb: flounce (Derived forms: flounces, flouncing, flounced)
1. Walk emphatically
""",
  );

  final String keyword = "flounce";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flounce""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She flounced out of the room.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She left the room with a flounce.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flounce""",
                      // alsoEnglishWord: "also: flounce",
                      britshText: """IpaUK: /flaʊns/""",
                      americanText: """IpaUS: /flaʊns/""",
...
کوردی: تەکان، ڕاتڵەکان، جووڵەی کت‌وپڕ، پەلەپڕژێ، پەلەقاژە، هەلوەلا، جووڵەی بەدەس‌خۆنەبوو، هەڵبەزینەوە، جیفڕک، چین، زێوار، پەراوێز
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) چوونە شوێنێک بەوەی سەرنج بۆ خۆت ڕادەکێشیت"""),
                    SentencesRow(
                      englishText: """She flounced out of the room.""",
                      kurdishText: """لە ژوورەکە دەرپەڕییە دەرەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) پارچە قوماشێک کە دووراوە بە پەردە، تەنوورە، جل، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The blouse had a ruffled flounce around the neckline for a feminine touch.""",
                      kurdishText:
                          """بلووزەەک لە دەوری ملیوانەکەیدا چینێکی چرچ و لۆچی هەبوو بۆ ئەوەی دیمەنێکی ژنانەی پێ ببەخشێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بە دەرپەڕین ژوورەکەی جێهێشت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/XKDhq2UcjIM?t=';
const double _startSecondsend = 000000000000000000000000000720;
const String _videoIdone = 'https://youtu.be/GKLSWP1MHEo?t=';
const double _startSecondsone = 000000000000000000000000000285;
const String _videoIdtwo = 'https://youtu.be/sgYkyubLlzw?t=';
const double _startSecondstwo = 0000000000000000000000000001956;
const String _videoIdthree = 'https://youtu.be/Llyf83OLcAk?t=';
const double _startSecondsthree = 000000000000000000000000000162;
const String _videoIdfour = 'https://youtu.be/ejXRxee7xkQ?t=';
const double _startSecondsfour = 0000000000000000000000000001161;
const String _videoIdfive = 'https://youtu.be/PDrYLMxJEh8?t=';
