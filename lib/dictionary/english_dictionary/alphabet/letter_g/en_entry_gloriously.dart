...
""",
  ...
  Future<void> speaksentence100(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""speaksentence_10000""");
  }
...
// With short examples define "gloriously", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵکار) بە شێوەیەک کە شایەنی سەرکەوتنی زۆرە، یان سەرکەوتنی زۆر دەهێنێت و کەسێک بەناوبانگ دەکات"""),
                    SentencesRow(
                      englishText: """Nelson died gloriously at Trafalgar.""",
                      kurdishText: """نێڵسن سەربەرزانە لە ترافڵگار مرد.""",
                      kurdishNote: """کاپتن نێڵسن کەسایەتییەکی گرنگی مێژووی دەریاوانی بەریتانیا بوو. ناوی تەواوی هۆراشیۆ نێڵسن بوو. ئەفسەرێکی بەناوبانگی دەریایی شاهانەی بەریتانیا بوو لە سەدەی ١٨ و سەرەتای سەدەی ١٩. بە یەکێک لە سەرکەوتووترین فەرماندەکانی مێژووی دەریایی دادەنرێت. بەشداری چەندین جەنگی دەریایی گرنگی کرد دژی فەڕەنسا لە ماوەی جەنگەکانی ناپۆلیۆن. گەورەترین سەرکەوتنی لە شەڕی ترافڵگار بوو لە ساڵی ١٨٠٥، کە تیایدا کوژرا بەڵام جەنگەکەیان بردەوە دژ بە سوپای هاوبەشی فەرەنسا و ئیسپانیا کە ئامانجیان داگیرکردنی بەریتانیا بوو. بە قارەمانێکی نەتەوەیی بەریتانیا دادەنرێت.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵکار) زۆر بە جوانی و سەرنجڕاکێشی"""),
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ھاوەڵکار) پننسە"""),
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """speaksentence_10000""",
                      kurdishText: """رستە_رستە_رستە_رستە.""",
