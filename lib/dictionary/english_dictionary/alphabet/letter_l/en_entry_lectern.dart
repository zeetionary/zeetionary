...
class EnglishEntrylectern extends StatefulWidget {
  const EnglishEntrylectern({super.key});

  @override
  State<EnglishEntrylectern> createState() => _EnglishEntrylecternState();
}

class _EnglishEntrylecternState extends State<EnglishEntrylectern> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lectern""");
  }
