...
class EnglishEntryindividuality extends StatefulWidget {
  const EnglishEntryindividuality({super.key});

  @override
  State<EnglishEntryindividuality> createState() =>
      _EnglishEntryindividualityState();
}

class _EnglishEntryindividualityState extends State<EnglishEntryindividuality> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: individuality (Derived forms: individualities)
1. The quality of being individual (- individualism, individuation)
"so absorbed by the movement that she lost all sense of individuality";
 
2. The distinct personality of an individual regarded as a persisting entity (- identity, personal identity)
"you can lose your individuality when you join the army";
""",
  );

  final String keyword = "individuality";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""individuality""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She expresses her individuality through her clothes.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Each song has its own individuality.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The pictures give individuality to the room.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001581;
    const String videoIdone = 'https://youtu.be/7eM7pb5M5DU?t=';
    const double startSecondsone = 000000000000000000000000000692;
    const String videoIdtwo = 'https://youtu.be/B1r4Z3nXPVA?t=';
    const double startSecondstwo = 000000000000000000000000000387;
    const String videoIdthree = 'https://youtu.be/FghSUttp6Lc?t=';
    const double startSecondsthree = 000000000000000000000000000198;
    const String videoIdfour = 'https://youtu.be/GtRyI6sxJgk?t=';
    const double startSecondsfour = 00000000000000000000000000050;
    const String videoIdfive = 'https://youtu.be/_vwSrfw85S4?t=';
    const double startSecondsfive = 000000000000000000000000000833;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """individuality""",
                      // alsoEnglishWord: "also: individuality",
                      britshText: """IpaUK: /ˌɪndɪˌvɪdʒuˈæləti/""",
                      americanText: """IpaUS: /ˌɪndɪˌvɪdʒuˈæləti/""",
...
کوردی: تاکێتی، کێیەتی، تاک، کەسێتی
"""),
// With short examples define "individuality", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کەسایەتی خۆی لە ڕێگای جلەکانی جیا دەکاتەوە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Each song has its own individuality.""",
                      kurdishText: """هەموو گۆرانییەک تامی خۆی هەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وێنەکان خاسیەتی تایبەت بە ژوورەکە دەدەن.""",
