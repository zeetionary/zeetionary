...
class EnglishEntryanonymous extends StatefulWidget {
  const EnglishEntryanonymous({super.key});

  @override
  State<EnglishEntryanonymous> createState() => _EnglishEntryanonymousState();
}

class _EnglishEntryanonymousState extends State<EnglishEntryanonymous> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "anonymous";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """anonymous""",
                      // alsoEnglishWord: "also: anonymous",
                      britshText: """IpaUK: /əˈnɒnɪməs/""",
                      americanText: """IpaUS: /əˈnɑːnɪməs/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      onPressedAmerican: () => speakanonymous1022("en-US"),
                    ),
...
٢. (ھاوەڵناو) شتێک لەلایەن کەسێکەوە کە نەناسراوە یان نایەنەوێت ئاشکرا بێ"""),
                    SentencesRow(
                      ...
                      onPressedAmerican: () => speakanonymous1026("en-US"),
                    ),
                    // const DividerSentences(),
                    // const DividerDefinition(),
                  ],
