...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/87y1_IbJRZE?t=';
    const double startSecondsend = 000000000000000000000000000385;
    const String videoIdone = 'https://youtu.be/d1eaQrxA6ZE?t=';
    const double startSecondsone = 000000000000000000000000000349;
    const String videoIdtwo = 'https://youtu.be/gTCYcpdq6Eg?t=';
    const double startSecondstwo = 000000000000000000000000000207;
    const String videoIdthree = 'https://youtu.be/mviTS_cIWXg?t=';
    const double startSecondsthree = 000000000000000000000000000287;
    const String videoIdfour = 'https://youtu.be/HBhXvLlB-kY?t=';
    const double startSecondsfour = 0000000000000000000000000005079;
    const String videoIdfive = 'https://youtu.be/7QCYDzsQ_yM?t=';
