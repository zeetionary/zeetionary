...
class EnglishEntrylampshade extends StatefulWidget {
  const EnglishEntrylampshade({super.key});

  @override
  State<EnglishEntrylampshade> createState() => _EnglishEntrylampshadeState();
}

class _EnglishEntrylampshadeState extends State<EnglishEntrylampshade> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lampshade""");
  }
