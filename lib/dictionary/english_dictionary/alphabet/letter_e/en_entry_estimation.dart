...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Who is the best candidate in your estimation?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak(
        """She went up in my estimation when I discovered how much charity work she does.""");
  }
...
کوردی: بۆچوون، ڕا، دیتن،	نرخاندن، ھەڵسەنگاندن، لێکدانەوە، مەزندە(کردن)، قەبڵاندن، قرساندن،	ڕێز، ڕوومەت، باوەڕی، وەج، ڕوومەت، قەدر، قەدرگرتن، ڕێزگرتن
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) بڕیاردان یان دەربڕینی بۆچوون سەبارەت بە کوالێتی شتێک"""),
          SentencesRow(
            englishText: """Who is the best candidate in your estimation?""",
          ...
          SentencesRow(
            ...
            kurdishText: """لەوەتەی ژنەکەی جێھێشتووە لام بەھای نەماوە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """لام ڕێزی زیاتر بووە کە زانیومە چەندە کاری خێرخوازی دەکات.""",
          ...
          SentencesRow(
            englishText:
                """Estimations of our total world sales are around 50 million.""",
            kurdishText:
                """خەمڵاندنی فرۆشی تەواوی جیھانیمان نزیکەی ٥٠ ملیۆنە.""",
...
const double _startSecondsend = 1837;
const String _videoIdone = '-BeTq99LqUo';
const double _startSecondsone = 592;
const String _videoIdtwo = 'GVsUOuSjvcg';
const double _startSecondstwo = 93;
const String _videoIdthree = 'JHjXwicEwQo';
const double _startSecondsthree = 364;
const String _videoIdfour = 'cykdSb7xqI4';
const double _startSecondsfour = 147;
const String _videoIdfive = 'DNhnboOpX8k';
