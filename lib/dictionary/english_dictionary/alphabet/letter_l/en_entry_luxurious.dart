...
class EnglishEntryluxurious extends StatefulWidget {
  const EnglishEntryluxurious({super.key});

  @override
  State<EnglishEntryluxurious> createState() => _EnglishEntryluxuriousState();
}

class _EnglishEntryluxuriousState extends State<EnglishEntryluxurious> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryluxurious luxurious
WORD_WEB luxurious luxurious luxurious
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "luxurious";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""luxurious""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """luxurious""",
                      // alsoEnglishWord: "also: luxurious",
...
کوردی: 
"""),
// With short examples define "luxurious", please follow LX instructions
