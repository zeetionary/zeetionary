...
class EnglishEntrygloomy extends StatefulWidget {
  const EnglishEntrygloomy({super.key});

  @override
  State<EnglishEntrygloomy> createState() => _EnglishEntrygloomyState();
}

class _EnglishEntrygloomyState extends State<EnglishEntrygloomy> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was a wet and gloomy day.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The gloomy weather showed little sign of lifting.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We sat in gloomy silence.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gloomy""",
                      // alsoEnglishWord: "also: gloomy",
                      britshText: """IpaUK: /ˈɡluːmi/""",
                      americanText: """IpaUS: /ˈɡluːmi/""",
...
کوردی: تاریک، لێڵ، مات کەم‌شەوق،	ناڕەحەت، مەیوس، دڵتەنگ، خەمبار، ناهومێد، دڵسارد،	دڵتەنگ(کەر)، ناڕەحەت‌کەر
"""),
// With short examples define "gloomy", please follow LX instructions
                    ...
                    const AlsoEnglishckb(word: "ھەروەھا: depressing"),
                    SentencesRow(
                      englishText: """It was a wet and gloomy day.""",
                      kurdishText: """ڕۆژێکی باراناوی و لێڵ بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کەشووهەوا تاریکەکە کەم ئاماژەی تەواوبوونی هەبوو.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) دڵتەنگ و بێ‌هیوا"""),
                    const AlsoEnglishckb(word: "ھەروەھا: glum"),
                    SentencesRow(
                      englishText: """We sat in gloomy silence.""",
                      kurdishText: """لە بێدەنگییە خەمناکەکەدا دانیشتین.""",
...
const String _videoIdone = 'https://youtu.be/nMwQWrzAYSU?t=';
const double _startSecondsone = 000000000000000000000000000308;
const String _videoIdtwo = 'https://youtu.be/tMNxgi_0eKA?t=';
const double _startSecondstwo = 000000000000000000000000000313;
const String _videoIdthree = 'https://youtu.be/Unzc731iCUY?t=';
const double _startSecondsthree = 0000000000000000000000000002089;
const String _videoIdfour = 'https://youtu.be/y4DTW4B3Sjs?t=';
const double _startSecondsfour = 00000000000000000000000000015;
const String _videoIdfive = 'https://youtu.be/FkKPsLxgpuY?t=';
