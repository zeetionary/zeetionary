...
class EnglishEntryinhumanity extends StatefulWidget {
  const EnglishEntryinhumanity({super.key});

  @override
  State<EnglishEntryinhumanity> createState() => _EnglishEntryinhumanityState();
}

class _EnglishEntryinhumanityState extends State<EnglishEntryinhumanity> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inhumanity""");
  }
