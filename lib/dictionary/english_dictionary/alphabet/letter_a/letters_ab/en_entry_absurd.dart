...
class EnglishEntryabsurd extends StatelessWidget {
  EnglishEntryabsurd({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'absurd', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əbˈsɜːd/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'pqgVQYmrObc';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '9-GRzu6zbS0';
