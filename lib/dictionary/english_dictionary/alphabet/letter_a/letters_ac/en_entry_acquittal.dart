...
class EnglishEntryacquittal extends StatefulWidget {
  const EnglishEntryacquittal({super.key});

  @override
  State<EnglishEntryacquittal> createState() => _EnglishEntryacquittalState();
}

class _EnglishEntryacquittalState extends State<EnglishEntryacquittal> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "acquittal";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acquittal""",
                      // alsoEnglishWord: "also: acquittal",
                      britshText: """IpaUK: /əˈkwɪtl/""",
                      americanText: """IpaUS: /əˈkwɪtl/""",
