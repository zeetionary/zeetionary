...
class EnglishEntrygig extends StatefulWidget {
  const EnglishEntrygig({super.key});

  @override
  State<EnglishEntrygig> createState() => _EnglishEntrygigState();
}

class _EnglishEntrygigState extends State<EnglishEntrygig> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They're doing a gig in Boston tonight.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She landed her first gig on a kids' TV show.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We were gigging two or three nights a week.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gig""",
                      // alsoEnglishWord: "also: gig",
                      britshText: """IpaUK: /ɡɪɡ/""",
                      americanText: """IpaUS: /ɡɪɡ/""",
...
// With short examples define "gig", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """They're doing a gig in Boston tonight.""",
                      kurdishText: """ئەمشەو لە بۆستن نمایشێک دەکەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """یەکەم کاریی بەدەستخست لە پڕۆگرامێکی تەلەفیزیۆنیی منداڵان.""",
                    ...
                    CustomRichText(
                      ...
                      textAfterLink: "",
                      onTap: () {
                        Routemaster.of(context).push("/english-gig/gigabyte");
                      },
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) پێشکەشکردنی نمایشی میوزیکی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We were gigging two or three nights a week.""",
                      kurdishText: """دوو یان سێ شەو لە هەفتەیەکدا نمایشی میوزیکیمان دەبێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/rRymSi8SmqA?t=';
const double _startSecondsend = 000000000000000000000000000614;
const String _videoIdone = 'https://youtu.be/544DTGHIBM0?t=';
const double _startSecondsone = 0000000000000000000000000001037;
const String _videoIdtwo = 'https://youtu.be/8FpPSMIB4uA?t=';
const double _startSecondstwo = 000000000000000000000000000208;
const String _videoIdthree = 'https://youtu.be/HAnw168huqA?t=';
const double _startSecondsthree = 000000000000000000000000000755;
const String _videoIdfour = 'https://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondsfour = 0000000000000000000000000004294;
const String _videoIdfive = 'https://youtu.be/cCP9vjp4kSg?t=';
const double _startSecondsfive = 0000000000000000000000000001260;
