...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fishy (Derived forms: fishier, fishiest)
1. [informal] Of questionable motive; of doubtful legality, value, truth, honesty, etc. (= funny, shady [informal], suspect, suspicious, dodgy [Brit, informal])
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There's something fishy going on here.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""What's that fishy smell?""");
  }
...
کوردی: ماسی‌ئاسا، پێوەندی بە ماسی‌یەوە هەیە (بۆن و بەرام)، پڕماسی،	گوماناوی، گومان‌لەسەر، جێی‌شک
"""),
// With short examples define "dopsum1", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە وەها دەردەکەوێت هەڵە، نایاسایی، یان فێڵبازانە بێت"""),
                    SentencesRow(
                      englishText: """There's something fishy going on here.""",
                      kurdishText: """شتێکی نامۆ لێرە هەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I don’t know what they’re up to. It sounds a distinctly fishy business.""",
                      kurdishText:
                          """نازانم خەریکی چین. کارێکی تەواو گوماناوی دیارە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە بۆن یان تامی وەک ماسی هەیە"""),
                    const DividerSentences(),
                    SentencesRow(
...
const double _startSecondsend = 0000000000000000000000000001210;
const String _videoIdone = 'https://youtu.be/hTqtGJwsJVE?t=';
const double _startSecondsone = 0000000000000000000000000003508;
...
const double _startSecondsthree = 0000000000000000000000000004167;
const String _videoIdfour = 'https://youtu.be/MqyJZsGFZ3M?t=';
const double _startSecondsfour = 000000000000000000000000000583;
const String _videoIdfive = 'https://youtu.be/pLwHTqU2r_Y?t=';
const double _startSecondsfive = 0000000000000000000000000001025;
