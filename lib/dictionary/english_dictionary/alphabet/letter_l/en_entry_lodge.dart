...
class EnglishEntrylodge extends StatefulWidget {
  const EnglishEntrylodge({super.key});

  @override
  State<EnglishEntrylodge> createState() => _EnglishEntrylodgeState();
}

class _EnglishEntrylodgeState extends State<EnglishEntrylodge> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: lodge (Derived forms: lodged, lodges, lodging)
1. Be a lodger; stay temporarily
"Where are you lodging in Paris?"
 
2. Provide housing for (- accommodate)
"We are lodging three foreign students this semester";
 
3. Put, fix, force, or implant (- wedge, stick, deposit)
"lodge a bullet in the table";
 
4. Place a formal charge against (- charge, file)
...
"The heavy rain caused the wheat to lodge"
 ...
 -Noun: lodge (Derived forms: lodges)
1. [Brit] Small house at the entrance to the grounds of a country mansion; usually occupied by a gatekeeper or gardener
 
2. A small (rustic) house used as a temporary shelter (- hunting lodge)
 
3. Any of various Native American dwellings (- indian lodge)
 
4. A hotel providing overnight lodging for travellers (- hostel, hostelry, inn, auberge)
 
5. A formal association of people with similar interests (- club, social club, society, guild, gild, order)
"he joined a golf lodge";
 
6. A beaver's den constructed on a pond or lake

- Noun: Lodge
1. English physicist who studied electromagnetic radiation and was a pioneer of radiotelegraphy (1851-1940) (- Sir Oliver Lodge, Sir Oliver Joseph Lodge)
""",
  );

  final String keyword = "lodge";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They stayed at a hunting lodge in the forest.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He turned in between the lodge gates and guided the Porsche down the winding drive.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""All visitors should report to the porter's lodge.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Portugal has lodged a complaint with the International Court of Justice.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They formally lodged an appeal against the decision.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He lodged with Mrs Brown when he arrived in the city.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The refugees are being lodged at an old army base.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""One of the bullets lodged in his chest.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/lf-KVEXIoqM?t=557';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/69UIlCLyvNE?t=878';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/cyzXgTaU3bo?t=383';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/hIyqLdKBAlc?t=874';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/HI1V5WJDey0?t=1176';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/Uhh_An7FGek?t=328';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lodge""",
                      // alsoEnglishWord: "also: lodge",
                      britshText: """IpaUK: /lɒdʒ/""",
                      americanText: """IpaUS: /lɑːdʒ/""",
...
کوردی: دیوی درگاوان یان داڵان‌دار،	قولیت، خانوچکە، چاوە، جێگا، ماڵ، مەزڵ، ماڵۆچکە،	لق، لک
"""),
// With short examples define "lodge", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) خانوویەک لە دەرودەشت کە خەڵکی تێیدا دەمێننەوە"""),
                    SentencesRow(
                      englishText: """They stayed at a hunting lodge in the forest.""",
                      kurdishText: """لە خانوویەکی ڕاوکردن لە دارستانەکە مانەوە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) خانوویەکی بچووک لە دەروازەی پارکێک یان زەویی خانوویەکی گەورە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He turned in between the lodge gates and guided the Porsche down the winding drive.""",
                      kurdishText: """ لە نێوان دەروازەکانی لۆجەکەدا سووڕایەوە و پۆڕشەکەی ڕێنمایی کرد بۆ خوارەوەی ڕێگا پێچاوپێچەکە.""",
                      englishNote: """This means he entered the gates of a large property or estate (often marked by a small building or lodge) and drove along a curved driveway leading to the main house or area.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) ژوورێک لە دەروازەی بینایەک بۆ ئەو کەسەی کە چاودێری ئەو کەسانە دەکات کە دێن و دەچن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """All visitors should report to the porter's lodge.""",
                      kurdishText: """سەردانکەران دەبێت ڕاوێژ بە ژوورۆچکەی بەندەرەکە بکەن.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) بڵاوکردنەوەی بەیاننامەیەکی فەرمی لەسەر شتێک"""),
                    const AlsoEnglishckb(word: "ھەروەھا: register، submit"),
                    SentencesRow(
                      englishText: """Portugal has lodged a complaint with the International Court of Justice.""",
                      kurdishText: """پرتوگال ناڕەزایی لای دادگای دادی نێودەوڵەتی دەربڕیوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They formally lodged an appeal against the decision.""",
                      kurdishText: """بە فەرمی تانەیان لە بڕیارەکە دا.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (کردار) پارەدان بە کەسێک بۆ ئەوەی لە ماڵەکەیدا بژیت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: board"),
                    SentencesRow(
                      englishText: """He lodged with Mrs Brown when he arrived in the city.""",
                      kurdishText: """کرێچیی بەڕێز براون بوو کە گەشتە شار.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٦. (کردار) دابینکردنی شوێنێک بۆ کەسێک بۆ ئەوەی تێیدا بخەوێت یان بژی"""),
                    const AlsoEnglishckb(word: "ھەروەھا: accommodate"),
                    SentencesRow(
                      englishText: """The refugees are being lodged at an old army base.""",
                      kurdishText: """پەنابەرەکان لە بنکەیەکی سەربازیی کۆن دەهێڵدرێنەوە.""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٧. (کردار) مانەوە لە شوێنێک یان گیرخواردن لێی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """One of the bullets lodged in his chest.""",
                      kurdishText: """یەکێک لە فیشەکان لە سنگیدا گیری خوارد.""",
