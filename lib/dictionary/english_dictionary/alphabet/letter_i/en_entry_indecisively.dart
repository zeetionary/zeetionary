...
class EnglishEntryindecisively extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indecisively""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He lingered indecisively outside the train station.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The struggle ended indecisively.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/fT8oSrv6ANM?t=';
    const double startSecondsend = 000000000000000000000000000319;
    const String videoIdone = 'https://youtu.be/D0oeH5LVnb4?t=';
    const double startSecondsone = 0000000000000000000000000001398;
    const String videoIdtwo = 'https://youtu.be/j5n9HXNmTro?t=';
    const double startSecondstwo = 000000000000000000000000000430;
    const String videoIdthree = 'https://youtu.be/xRGCAt6BgiQ?t=';
    const double startSecondsthree = 0000000000000000000000000004011;
    const String videoIdfour = 'https://youtu.be/lNRp8ck_SOo?t=';
    const double startSecondsfour = 000000000000000000000000000398;
    const String videoIdfive = 'https://youtu.be/xtQm470SW-w?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indecisively""",
                      // alsoEnglishWord: "also: indecisively",
                      britshText: """IpaUK: /ˌɪndɪˈsaɪsɪvli/""",
                      americanText: """IpaUS: /ˌɪndɪˈsaɪsɪvli/""",
...
// کوردی: یەکلایی‌نەکراوانە، بە شێوەیەکی یەکلایی‌نەکراوە
// """),
// With short examples define "indecisively", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە ئەوە پیشان دەدات ناتوانیت بڕیار لەسەر شتێک بدەیت"""),
                    SentencesRow(
                      englishText:
                          """He lingered indecisively outside the train station.""",
                      kurdishText:
                          """بە داڵغەوە لە دەرەوەی وێستگەی شەمەندەفەرەکە چاوەڕێ بوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بە شێوەیەک کە وەڵام یان ئەنجامێکی ڕوون نادات بەدەستەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The struggle ended indecisively.""",
                      kurdishText:
                          """هەوڵەکە بە شێوەیەکی یەکلایی‌نەکراوە کۆتایی هات.""",
