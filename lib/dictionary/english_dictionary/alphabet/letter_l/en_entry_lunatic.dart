...
class EnglishEntrylunatic extends StatefulWidget {
  const EnglishEntrylunatic({super.key});

  @override
  State<EnglishEntrylunatic> createState() => _EnglishEntrylunaticState();
}

class _EnglishEntrylunaticState extends State<EnglishEntrylunatic> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylunatic lunatic
WORD_WEB lunatic lunatic lunatic
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lunatic";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lunatic""");
  }
...
کوردی: 
"""),
// With short examples define "lunatic", please follow LX instructions
