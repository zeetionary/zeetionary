...
class EnglishEntryincorrectly extends StatefulWidget {
  const EnglishEntryincorrectly({super.key});

  @override
  State<EnglishEntryincorrectly> createState() => _EnglishEntryincorrectlyState();
}

class _EnglishEntryincorrectlyState extends State<EnglishEntryincorrectly> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incorrectly""");
  }
