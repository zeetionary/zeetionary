...
class EnglishEntryfurthermore extends StatefulWidget {
  const EnglishEntryfurthermore({super.key});

  @override
  State<EnglishEntryfurthermore> createState() =>
      _EnglishEntryfurthermoreState();
}

class _EnglishEntryfurthermoreState extends State<EnglishEntryfurthermore> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: furthermore
1. Denoting additional information (- moreover, what is more, in addition)
"computer chess games are getting cheaper all the time; furthermore, their quality is improving";
""",
  );

  final String keyword = "furthermore";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""furthermore""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furthermore""",
                      // alsoEnglishWord: "also: furthermore",
                      britshText: """IpaUK: /ˌfɜːðəˈmɔː(r)/""",
                      americanText: """IpaUS: /ˌfɜːrðərˈmɔːr/""",
...
کوردی: سەرەڕای ئەوەش، سەرباری ئەوەش، بێجگەلە ئەوەش، لەگەڵ ئەوەش‌دا، زێدەباری، هەروەها، لە لایەکی ترەوە
"""),
// With short examples define "furthermore", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """He said he had not discussed the matter with her. Furthermore, he had not even contacted her.""",
                      kurdishText:
                          """گوتی کە بابەتەکەی هێشتا لەگەڵی باس نەکردبوو. بێجگە لەوەش، هێشتا هەر پەیوەندیی پێوە نەکردبوو.""",
...
const double _startSecondsend = 000000000000000000000000000455;
const String _videoIdone = 'https://youtu.be/XEZfGlyLQnA?t=';
const double _startSecondsone = 000000000000000000000000000286;
const String _videoIdtwo = 'https://youtu.be/Xzv84ZdtlE0?t=';
const double _startSecondstwo = 000000000000000000000000000725;
const String _videoIdthree = 'https://youtu.be/IgF3OX8nT0w?t=';
const double _startSecondsthree = 0000000000000000000000000001040;
const String _videoIdfour = 'https://youtu.be/qg2nGY1aqlg?t=';
const double _startSecondsfour = 0000000000000000000000000001284;
const String _videoIdfive = 'https://youtu.be/KZbzIf_C6Y4?t=';
