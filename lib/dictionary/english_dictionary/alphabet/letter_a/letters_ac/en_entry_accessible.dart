...
class EnglishEntryaccessible extends StatefulWidget {
  const EnglishEntryaccessible({super.key});

  @override
  State<EnglishEntryaccessible> createState() => _EnglishEntryaccessibleState();
}

class _EnglishEntryaccessibleState extends State<EnglishEntryaccessible> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "accessible";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accessible""",
                      // alsoEnglishWord: "also: accessible",
                      britshText: """IpaUK: /əkˈsesəbl/""",
                      americanText: """IpaUS: /əkˈsesəbl/""",
