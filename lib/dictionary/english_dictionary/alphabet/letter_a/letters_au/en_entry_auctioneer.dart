...
class EnglishEntryauctioneer extends StatelessWidget {
  ...
  Future<void> speakauctioneer(String languageCode) async {
    ...
    await flutterTts.speak("auctioneer");
  }
  ...
  Future<void> speakauctioneer1221(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("‘Yours for £200,’ said the auctioneer.");
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUK: /ˌɔːkʃəˈnɪə(r)/, /ˌɒkʃəˈnɪə(r)/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌɔːkʃəˈnɪr/"),
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'oUHQhXWuZFc';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '8yStwJOpvd8';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'sHvyrEAsmFA';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'tB0yu5yoXXU';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'QGErBZoPeZA';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'MMJ-wD0xvHE';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'MhLxe80bOEI';
  final double _startSeconds = 17580;
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = '0DM5XJxyrkA';
