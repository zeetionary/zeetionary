...
class EnglishEntryfrailty extends StatefulWidget {
  const EnglishEntryfrailty({super.key});

  @override
  State<EnglishEntryfrailty> createState() => _EnglishEntryfrailtyState();
}

class _EnglishEntryfrailtyState extends State<EnglishEntryfrailty> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frailty (Derived forms: frailties)
1. The state of being weak in health or body (especially from old age) (= infirmity, debility, feebleness, frailness, valetudinarianism)
 
2. Moral weakness (= vice)
""",
  );

  final String keyword = "frailty";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frailty""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We are all subject to the frailties of human nature.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frailty""",
                      // alsoEnglishWord: "also: frailty",
                      britshText: """IpaUK: /ˈfreɪlti/""",
                      americanText: """IpaUS: /ˈfreɪlti/""",
...
کوردی: سستی، لاوازی، بێ‌هێزی، بێ‌گیانی، بێ‌بنگەیی،	لاوازی یان سستی ئاکاری،	زووشکاوی، ناسکی، هەڵپەڕیوی، تورتی، قرپی،	ناتەواوی، کەمی
"""),
// With short examples define "frailty", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Increasing frailty meant that she was more and more confined to bed.""",
                      kurdishText:
                          """لاوازیی زیادبوو وایکرد زیاتر و زیاتر بکەوێتە سەر جێگا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەموومان کاریگەر دەبین بە لاوازیی سرووشتی مرۆڤ.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/bl9DuMLr9k8?t=';
const double _startSecondsend = 000000000000000000000000000197;
const String _videoIdone = 'https://youtu.be/z3uvnwBMTdY?t=';
const double _startSecondsone = 0000000000000000000000000008899;
const String _videoIdtwo = 'https://youtu.be/7D-gxaie6UI?t=';
const double _startSecondstwo = 000000000000000000000000000740;
const String _videoIdthree = 'https://youtu.be/9nXop2lLDa4?t=';
const double _startSecondsthree = 000000000000000000000000000250;
const String _videoIdfour = 'https://youtu.be/LZ3fEUrqCxQ?t=';
const double _startSecondsfour = 000000000000000000000000000759;
const String _videoIdfive = 'https://youtu.be/6JU5d6Rd-Kw?t=';
