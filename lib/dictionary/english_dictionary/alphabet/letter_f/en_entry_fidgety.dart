...
class EnglishEntryfidgety extends StatefulWidget {
  const EnglishEntryfidgety({super.key});

  @override
  State<EnglishEntryfidgety> createState() => _EnglishEntryfidgetyState();
}

class _EnglishEntryfidgetyState extends State<EnglishEntryfidgety> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fidgety
1. Nervous and unable to relax (= antsy [N. Amer, informal], fretful, itchy, restless, on edge, keyed-up, twitchy [informal])
"a constant fidgety stamping of hooves";
 
2. Restless and inclined to fidget
""",
  );

  final String keyword = "fidgety";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fidgety""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The children get fidgety if they have nothing to do.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fidgety""",
                      // alsoEnglishWord: "also: fidgety",
                      britshText: """IpaUK: /ˈfɪdʒɪti/""",
                      americanText: """IpaUS: /ˈfɪdʒɪti/""",
...
// With short examples define "fidgety", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """As the questioning continued, he became fidgety and uneasy.""",
                      kurdishText:
                          """کە پرسیارەکان بەردەوام بوون، بێ‌سرەوت و نیگەران بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/80ULDtPkUQg?t=';
const double _startSecondsend = 00000000000000000000000000042;
const String _videoIdone = 'https://youtu.be/LmkmQyybH60?t=';
const double _startSecondsone = 000000000000000000000000000314;
const String _videoIdtwo = 'https://youtu.be/YKDf29wM_mA?t=';
const double _startSecondstwo = 000000000000000000000000000217;
const String _videoIdthree = 'https://youtu.be/dP57iVGvnro?t=';
const double _startSecondsthree = 000000000000000000000000000217;
const String _videoIdfour = 'https://youtu.be/FARXrLsBNJY?t=';
const double _startSecondsfour = 000000000000000000000000000301;
const String _videoIdfive = 'https://youtu.be/XaqOejIaFgM?t=';
