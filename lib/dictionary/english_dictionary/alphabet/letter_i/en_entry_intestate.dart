...
class EnglishEntryintestate extends StatefulWidget {
  const EnglishEntryintestate({super.key});

  @override
  State<EnglishEntryintestate> createState() => _EnglishEntryintestateState();
}

class _EnglishEntryintestateState extends State<EnglishEntryintestate> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intestate""");
  }
