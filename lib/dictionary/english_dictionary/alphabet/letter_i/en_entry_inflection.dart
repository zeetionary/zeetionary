...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 138;
    const String videoIdtwo = '6_Vrg3zAKl4';
    const double startSecondstwo = 255;
    const String videoIdthree = 'QINII0eeJxc';
    const double startSecondsthree = 252;
    const String videoIdfour = 'm0aG6urHpSI';
    const double startSecondsfour = 420;
    const String videoIdfive = 'rjDX5ItsOnQ';
    const double startSecondsfive = 679;
