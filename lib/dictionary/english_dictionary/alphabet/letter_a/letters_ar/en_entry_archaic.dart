                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "archaic"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ɑːˈkeɪɪk/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ɑːrˈkeɪɪk/"),
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: archaic 
1. So extremely old as seeming to belong to an earlier period (= antediluvian, antiquated)
"archaic laws";
 
2. Little evolved from or characteristic of an earlier ancestral type (= primitive)
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'tfJlIL9Zpgg';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'mHUR0ySyQPA';
