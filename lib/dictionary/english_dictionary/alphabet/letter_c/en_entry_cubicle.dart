...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakcubicles1(String languageCode) async {
    ...
    await flutterTts.speak(
        "// speakcubicles111111111111111111111111111111111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcubicles2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcubicles200"); // DOPSUM: CHANGE TEXT
  }
                ...
                child: Column(
                  children: [
                    ExampleSentenceEnglish(
                        text:
                            "// speakcubicles111111111111111111111111111111111"),
