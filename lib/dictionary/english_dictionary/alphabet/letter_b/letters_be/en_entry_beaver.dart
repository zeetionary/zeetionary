...
// Define the word "beaver" and provide five simple example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings or more.

// replace beaver - replace EnglishEntrybeaver

// replace speakBeaver - /ˈbiːvə(r)/

enum TtsState { playing }

class EnglishEntrybeaver extends StatelessWidget {
// blank divider
  EnglishEntrybeaver({super.key});
// blank divider
  ...
  Future<void> speakbeavers3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He was staring at her beaver the whole time.");
  }
...
4. A man's hat with a tall crown; usually covered with silk or with beaver fur (= dress hat, high hat, opera hat, silk hat, stovepipe, top hat, topper, stovepipe hat)
 
5. A movable piece of armour on a medieval helmet used to protect the lower face
 
6. A hat made with the fur of a beaver (or similar material) (= castor)
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'cIZgFqkuGFI';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'lPLvkrtqkJ8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'ONb2FVNe-7o';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'GHjpvpZyuow';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = '3P_KII-M2Kg';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'aL8zc9LMbg4';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'ePvAlpAyZI8';
  final double _startSeconds = 0;
