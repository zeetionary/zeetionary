                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "anaerobic"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌænəˈrəʊbɪk/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌænəˈrəʊbɪk/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'bdzkbzscQm8';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'ra_bwOckp1M';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'nnKqRdtqcOM';
