...
class EnglishEntryhatchback extends StatefulWidget {
  const EnglishEntryhatchback({super.key});

  @override
  State<EnglishEntryhatchback> createState() => _EnglishEntryhatchbackState();
}

class _EnglishEntryhatchbackState extends State<EnglishEntryhatchback> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hatchback (Derived forms: hatchbacks)
1. A car having a hatchback door
 
2. A sloping rear car door that is lifted to open (- hatchback door, liftgate [US], hatch)
""",
  );

  final String keyword = "hatchback";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hatchback""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They parked their hatchback near the store.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hatchback""",
                      // alsoEnglishWord: "also: hatchback",
                      britshText: """IpaUK: /ˈhætʃbæk/""",
                      americanText: """IpaUS: /ˈhætʃbæk/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئۆتۆمبێلێک کە دەرگای پشتەوەی هەیە و بەرز دەکرێتەوە"""),
                    SentencesRow(
                      englishText:
                          """They parked their hatchback near the store.""",
                      kurdishText:
                          """هاچباکەکەیان لە تەنیشت فرۆشگاکە وەستاند.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/1eYZnCx-02g?t=';
const double _startSecondsend = 000000000000000000000000000792;
const String _videoIdone = 'https://youtu.be/AEhRu5y2IV0?t=';
const double _startSecondsone = 000000000000000000000000000737;
const String _videoIdtwo = 'https://youtu.be/4yjRIcRc9qY?t=';
const double _startSecondstwo = 000000000000000000000000000161;
const String _videoIdthree = 'https://youtu.be/_ihseKhJEXo?t=';
const double _startSecondsthree = 000000000000000000000000000568;
const String _videoIdfour = 'https://youtu.be/Nvedr1AeQt8?t=';
const double _startSecondsfour = 000000000000000000000000000209;
const String _videoIdfive = 'https://youtu.be/RsZM1u5IH3Y?t=';
