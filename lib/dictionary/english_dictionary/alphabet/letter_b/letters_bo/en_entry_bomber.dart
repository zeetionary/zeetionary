...
// blank divider
  ...
  Future<void> speakbombers1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The invasion on land was supported by bombers in the air.");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'Tokg7iIvfQk';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'PbpWGRtHfYw';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'NcumiS0uk5o';
  final double _startSeconds = 0;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '2795bNju200';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'BhCM-sehmMI';
  final double _startSeconds = 0;
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final double _startSeconds = 2077;
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'PCeMCwxayp0';
