...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '-obKX-mqjXQ';
    const double startSecondsend = 417;
    const String videoIdone = 'phuS5VLQy8c';
    const double startSecondsone = 1009;
    const String videoIdtwo = '_uS4WCsGi0k';
    const double startSecondstwo = 906;
    const String videoIdthree = 'M5Vrar4w_CU';
    const double startSecondsthree = 563;
    const String videoIdfour = 'Ei8JnepMRoM';
    const double startSecondsfour = 308;
    const String videoIdfive = 'ssI9_Teij8c';
