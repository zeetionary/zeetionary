...
// replace EnglishEntryAdopsummm - replace speakArdent

// replace ardent - /ˈɑːdnt/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryardent extends StatelessWidget {
  // blank divider
  EnglishEntryardent({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "ardent"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɑːdnt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrdnt/"),
...
2. Characterized by strong enthusiasm (= warm)
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '3yi0FNwOYiI';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '1O55kFMD_dc';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'JTfzEM7THiY';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'TAC_7k9QoE8';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'IJCy64adY3Y';
