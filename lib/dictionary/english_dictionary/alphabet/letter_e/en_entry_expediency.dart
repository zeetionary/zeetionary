...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ئەوەی کە شتێک بەسوودە یان پێویستە بۆ مەبەستێکی دیاریکراو، بەڵام ھەمیشە گونجاو یان ڕاست نییە"""),
          SentencesRow(
            englishText: """He acted out of expediency, not principle.""",
            kurdishText:
                """بۆ بەرژەوەندی خۆی ھەنگاوی نا نەک بە پشت بەستن بە بنچینەکانی.""",
            englishNote:
          ...
          SentencesRow(
            englishText:
                """Some of their critics claim that recent decisions about tax are are nothing more than political expediency.""",
            kurdishText:
                """ھەندێک لە ڕەخنەگرانیان بانگەشەی ئەوە دەکەن کە بڕیارە تازەکان سەبارەت بە باج ھیچ نییە جگە لە بەرژەوەندی‌خوازی سیاسی.""",
...
const String _videoIdend = 'SjeS6gtPq8E?t=';
const double _startSecondsend = 304;
const String _videoIdone = 'z3uvnwBMTdY?t=';
const double _startSecondsone = 1726;
const String _videoIdtwo = '-_PU0cRZ9wg?t=';
const double _startSecondstwo = 1082;
const String _videoIdthree = '1q4dUt1yK0g?t=';
const double _startSecondsthree = 113;
const String _videoIdfour = 'SlfIOOTc6Og?t=';
const double _startSecondsfour = 240;
const String _videoIdfive = '7uS7A4x31PY?t=';
const double _startSecondsfive = 773;
