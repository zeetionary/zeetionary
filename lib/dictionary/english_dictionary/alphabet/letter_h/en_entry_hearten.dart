...
class EnglishEntryhearten extends StatefulWidget {
  const EnglishEntryhearten({super.key});

  @override
  State<EnglishEntryhearten> createState() => _EnglishEntryheartenState();
}

class _EnglishEntryheartenState extends State<EnglishEntryhearten> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: hearten (Derived forms: heartens, heartened, heartening)
1. Give encouragement to (- cheer, recreate, embolden)
"If we do indulge in peace discussion, they tell us, we shall merely hearten the enemy";
""",
  );

  final String keyword = "hearten";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hearten""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I was heartened by all the support I received.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hearten""",
                      // alsoEnglishWord: "also: hearten",
                      britshText: """IpaUK: /ˈhɑːtn/""",
                      americanText: """IpaUS: /ˈhɑːrtn/""",
...
کوردی: 
"""),
// With short examples define "hearten", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) پێدانی هیوا"""),
                    SentencesRow(
                      englishText:
                          """I was heartened by all the support I received.""",
                      kurdishText:
                          """دڵم خۆش بوو بەو هەموو پشتگیرییەی کە پێمدرا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/KGAwqY-h9uk?t=';
const double _startSecondsend = 000000000000000000000000000163;
const String _videoIdone = 'https://youtu.be/CoTA2aqckNM?t=';
const double _startSecondsone = 000000000000000000000000000222;
const String _videoIdtwo = 'https://youtu.be/vJ4LwWdhymE?t=';
const double _startSecondstwo = 000000000000000000000000000751;
const String _videoIdthree = 'https://youtu.be/it4BGLrnl-g?t=';
const double _startSecondsthree = 00000000000000000000000000020500;
const String _videoIdfour = 'https://youtu.be/66G-iwqyPUU?t=';
const double _startSecondsfour = 000000000000000000000000000330;
const String _videoIdfive = 'https://youtu.be/x0mlkOZQ_fE?t=';
const double _startSecondsfive = 000000000000000000000000000948;
