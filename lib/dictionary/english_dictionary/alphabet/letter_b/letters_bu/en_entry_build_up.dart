...
class EnglishEntrybuildup extends StatelessWidget {
// blank divider
  EnglishEntrybuildup({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakbuildup(String languageCode) async {
    // DOPSUM: CHANGE speakbuildup
  ...
  Future<void> speakbuildups1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The leak led to a slow build-up of carbon dioxide.");
  }
  ...
  Future<void> speakbuildups4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The media have given the movie a huge build-up.");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'GeOUZ_pIwB4';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '0liyz4vpksU';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'x8qXVIc04eg';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'K3kAA4FBIH4';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'LfXLlrseAxg';
