...
// replace EnglishEntryaromatherapist - replace speakAromatherapist

// replace aromatherapist - /əˌrəʊməˈθerəpɪst/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryaromatherapist extends StatelessWidget {
  // blank divider
  EnglishEntryaromatherapist({super.key});
  // blank divider
  ...
  Future<void> speakaromatherapist(String languageCode) async {
    ...
    await flutterTts.speak("aromatherapist");
  }
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  ...
  final String _videoId = 'aUk02H_rACc';
...
class _YoutubeEmbeddedtwoState extends State<YoutubeEmbeddedtwo> {
  late YoutubePlayerController _controller;
  final String _videoId = 'A0kqiKAs0JI';
...
class _YoutubeEmbeddedthreeState extends State<YoutubeEmbeddedthree> {
  late YoutubePlayerController _controller;
  final String _videoId = 'yL_Tr8-Bl5o';
...
class _YoutubeEmbeddedfourState extends State<YoutubeEmbeddedfour> {
  late YoutubePlayerController _controller;
  final String _videoId = 'nSYN4KsyA6U';
...
class _YoutubeEmbeddedfiveState extends State<YoutubeEmbeddedfive> {
  late YoutubePlayerController _controller;
  final String _videoId = 'xKNCjxmwde4';
  final double _startSeconds = 1;
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  late YoutubePlayerController _controller;
  final String _videoId = 'GOBo2JrHt6g';
...
class _YoutubeEmbeddedsevenState extends State<YoutubeEmbeddedseven> {
  late YoutubePlayerController _controller;
  final String _videoId = 'sHkJhfXK7oE';
