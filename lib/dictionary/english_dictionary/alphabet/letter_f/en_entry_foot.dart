...
class EnglishEntryfoot extends StatefulWidget {
  const EnglishEntryfoot({super.key});

  @override
  State<EnglishEntryfoot> createState() => _EnglishEntryfootState();
}

class _EnglishEntryfootState extends State<EnglishEntryfoot> {
  @override
  void initState() {
    super.initState();
...
5. Lowest support of a structure (= foundation, base, fundament, groundwork, substructure, understructure)
"he stood at the foot of the tower";
 
6. Any of various organs of locomotion or attachment in invertebrates (= invertebrate foot)
...
9. (military) an army unit consisting of soldiers who fight on foot (= infantry)
"there came ten thousand horsemen and as many fully-armed foot";
 
10. (prosody) a group of 2 or 3 syllables forming the basic unit of poetic rhythm (= metrical foot, metrical unit)
 
11. A support resembling a pedal extremity
"one foot of the chair was on the carpet"

- Verb: foot (Derived forms: footed, footing, feet, foots)
1. Pay for something (= pick)
"foot the bill";
 
2. [informal] Walk (= leg it [informal], hoof [informal], hoof it [informal], ankle [N. Amer, informal])
"let's foot it to the disco";
 
3. (arithmetic) add a column of numbers (= foot up)
""",
  );

  final String keyword = "foot";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""My feet are aching.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She kicked the ball with her right foot.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He's broken several bones in his left foot.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The whole audience rose to its feet and cheered.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We came on foot.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I've been on my feet all day.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Come on lads—on your feet and do some work!""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We were stamping our feet to keep warm.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He is currently resting a foot injury.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He swung a foot at the ball but missed completely.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The children ran bare-footed on the beach.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The foot of his socks wore out quickly.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We're flying at 35 000 feet.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The town was under several feet of water.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We had over a foot of snow in a few hours.""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The team remains stuck at the foot of the table.""");
  }
  ...
  Future<void> speaksentence18(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He sat at the foot of the table.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foot""",
                      // alsoEnglishWord: "also: foot",
                      britshText: """IpaUK: /fʊt/""",
                      americanText: """IpaUS: /fʊt/""",
...
کوردی: پێ، پا (لە خوارووی قولاپەوە)،	ژێر، خوارەوە، خوارترین بەش، داوێن، پێ، بنار، بن، بنک،	خوارووی گۆرەوی، بنەوەی گۆرەوەی،	بنەما، پایە (لە هەڵبەستی ئینگلیسی‌دا)،	هەنگاو، گاڤ، شەقاو،	پیادە، سپای پیادە،	فووت، پێ
"""),
// With short examples define "foot", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بە پێی ڕاستی لە تۆپەکەی دا.""",
                        ...
                        MyExpansionTile(
                          children: [
                            SentencesRow(
                              ...
                              kurdishText: """ژمارەیەک ئێسکی پێی چەپی شکاون.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """تەواوی ئامادەبووان هەستانە سەر پێ و هاواریان کرد.""",
                            ...
                            const DividerSentences(),
                            SentencesRow(
                              englishText: """We came on foot (= we walked).""",
                              kurdishText: """بە پێ هاتین.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText: """تەواوی ڕۆژەکە لەسەر پێم بوومە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """یەڵڵا کوڕینە ـ هەستنە سەر پێ و هەندێک کار بکەن.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """پێمان بە زەویدا دەکوتا بۆ مانەوە بە گەرمی.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """لە ئێستادا پشوو وەردەگرێت بۆ برینێکی پێی.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """پێی هێنایەوە بۆ تۆپەکە بەڵام بە تەواوی لەدەستی چوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) هەبوونی ئەو جۆر یان ژمارە پێیەی کە باسکراوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The children ran bare-footed on the beach.""",
                      kurdishText:
                          """منداڵەکان بە پێی پەتی لەسەر کەنارەکە ڕایان دەکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پێی گۆرەوییەکانی زوو داڕزان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """شارۆچکەکە لەژێر چەند پێیەک لە ئاو بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە یەک کاتژمێردا سەروو پێیەک بەفرمان بەخۆوە دی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The city now reaches to the foot of the surrounding mountains.""",
                      kurdishText:
                          """شارەکە ئێستا دەگات بە بناری شاخەکانی دەورووبەری.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تیمەکە لە خوارەوەی ڕیزبەندییەکە ماوەتەوە.""",
...
const double _startSecondsend = 000000000000000000000000000863;
const String _videoIdone = 'https://youtu.be/gngPQ771Ahk?t=';
const double _startSecondsone = 0000000000000000000000000001853;
const String _videoIdtwo = 'https://youtu.be/DWmGArQBtFI?t=';
const double _startSecondstwo = 000000000000000000000000000174;
const String _videoIdthree = 'https://youtu.be/9TugA_z5vQE?t=';
const double _startSecondsthree = 00000000000000000000000000040;
const String _videoIdfour = 'https://youtu.be/VrKW58MS12g?t=';
const double _startSecondsfour = 000000000000000000000000000347;
const String _videoIdfive = 'https://youtu.be/LLmsekLy_yI?t=';
