...
class EnglishEntryhomely extends StatefulWidget {
  const EnglishEntryhomely({super.key});

  @override
  State<EnglishEntryhomely> createState() => _EnglishEntryhomelyState();
}

class _EnglishEntryhomelyState extends State<EnglishEntryhomely> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: homely (Derived forms: homeliest, homelier)
1. Having a feeling of home; cosy and comfortable (- homelike, homey, homy, mumsy [Brit, informal], gemütlich)
...
4. [N. Amer] Lacking in physical beauty or proportion (- plain, unhandsome)
"a homely child"; "several of the buildings were downright homely";
""",
  );

  final String keyword = "homely";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hotel has a lovely homely feel to it.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Her homely cooking reminds me of my childhood.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The homely child was shy but friendly.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000226;
    const String videoIdone = 'https://youtu.be/kVrNmOmGB6c?t=';
    const double startSecondsone = 0000000000000000000000000001062;
    const String videoIdtwo = 'https://youtu.be/KIhDByfsW3Y?t=';
    const double startSecondstwo = 00000000000000000000000000020;
    const String videoIdthree = 'https://youtu.be/oHn2qCa1Ml4?t=';
    const double startSecondsthree = 000000000000000000000000000135;
    const String videoIdfour = 'https://youtu.be/rHM1cjGNK7E?t=';
    const double startSecondsfour = 000000000000000000000000000652;
    const String videoIdfive = 'https://youtu.be/ayOS3iRgoUk?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homely""",
                      // alsoEnglishWord: "also: homely",
                      britshText: """IpaUK: /ˈhəʊmli/""",
                      americanText: """IpaUS: /ˈhəʊmli/""",
...
// With short examples define "homely", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هوتێلەکە هەستێکی خۆشی ماڵەوەی هەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The restaurant was quite homely, with just a dozen tables.""",
                      kurdishText:
                          """چێشتخانەکە ئاسوودەبەخش بوو بە تەنها چەند مێزێکەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چێشتلێنانە سادەکەی منداڵیمم بیردێنێتەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵناو) ڕووخساری کەسێک کە سادەیە و جوان نییە، ناشرینە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: plain"),
                    SentencesRow(
                      englishText: """The homely child was shy but friendly.""",
                      kurdishText:
                          """منداڵە ناشرینەکە شەرمن بەڵام خۆشەویست بوو.""",
