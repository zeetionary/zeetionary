...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 0000000000000000000000000001571;
    const String videoIdtwo = 'https://youtu.be/MVu8QbxafJE?t=';
    const double startSecondstwo = 000000000000000000000000000325;
    const String videoIdthree = 'https://youtu.be/Uhh_An7FGek?t=';
    const double startSecondsthree = 0000000000000000000000000001417;
    const String videoIdfour = 'https://youtu.be/yWI61kpFEAA?t=';
    const double startSecondsfour = 000000000000000000000000000754;
    const String videoIdfive = 'https://youtu.be/J_n1FZaKzF8?t=';
    const double startSecondsfive = 0000000000000000000000000001356;
