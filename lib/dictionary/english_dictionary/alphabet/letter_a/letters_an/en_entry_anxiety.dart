                      ...
                      child: Column(
                        ...
                        children: [
                          const Text(
                            ...
                            '''
کوردی: دڵەتەپە، دڵەخورپێ، دڵەڕاوکێ، خەتەرە، نگەرانی، ناڕەحەتی، خەم، پەرێشانی، ئارام‌لێ‌هەڵگیراوی، تامەزرۆیی، گوڕوتین، پەرۆش، مەراق

١. (ناو) دۆخی هەستکردن بە شڵەژاوی و نیگەرانی سەبارەت بەوەی شتێکی خراپ ڕوودەدات''',
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "هەندێک لە نەخۆشانی نەخۆشخانە بە دڵەڕاوکێی زۆردا تێپەڕدەبن.",
                                    textAlign: TextAlign
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "دڵەڕاوکێی زۆر هەیە سەبارەت بۆ کۆپی‌کردنی مرۆڤ.",
                                    textAlign: TextAlign
                                        .right, // Right-to-left direction
                                    textDirection: TextDirection.rtl,
                                  ),
                          ...
                          const Text(
                            // DOPSUM: WRITE DEFINITION IN KURDISH. COPY FOR ANOTHER DEFINITION
                            '''
٢. (ناو) نەخۆشییەکی دەروونی کە دەبێتەهۆی ئەوەی کەسێک هێندە زۆر نیگەران بێت کە کاریگەری نەرێنی زۆری لەسەریان هەبێت''',
                            style: TextStyle(fontSize: 18),
                            textAlign: TextAlign.right,
                            textDirection: TextDirection.rtl,
                          ),
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "هەندێک کەس هەست بە پەستان و ئازاری دڵەخورپە و بێزاری دەکەن.",
                                    textAlign: TextAlign
                                        .right, // Right-to-left direction
                                    textDirection: TextDirection.rtl,
                                  ),
...
٣. (ناو) نیگەرانی و ترس دەربارەی شتێک''',
                          ...
                          const Text(
                            // DOPSUM: WRITE DEFINITION IN KURDISH. COPY FOR ANOTHER DEFINITION
                            '''
٤. (ناو) هەستێکی بەهێز بۆ ویستنی کردنی شتێک یان ویستنی ڕوودانی شتێک''',
                            style: TextStyle(fontSize: 18),
                            textAlign: TextAlign.right,
                            textDirection: TextDirection.rtl,
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "https://youtu.be/L1HCG3BGK8I?t=";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "https://youtu.be/O-6f5wQXSu8";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "https://youtu.be/XIrQKo-d7h4?t=";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "https://youtu.be/Eupw-yTBkQI?t=";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "https://youtu.be/Zrg7lJyIYzQ?t=";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "https://youtu.be/LnV3Q2xIb1U";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "https://youtu.be/QjLOWQqy2MU?t=";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "https://youtu.be/QwtPA-07NnU?t=";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "https://youtu.be/4pLUleLdwY4";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "https://youtu.be/UfGDb41oDjo?t=";
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  static String myVideoId = "https://youtu.be/2EPnNOlxF8M?t=";
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  static String myVideoId = "https://youtu.be/b5i0aY_rUZU?t=";
