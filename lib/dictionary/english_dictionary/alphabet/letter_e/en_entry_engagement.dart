...
class EnglishEntryengagement extends StatefulWidget {
  const EnglishEntryengagement({super.key});

  @override
  State<EnglishEntryengagement> createState() => _EnglishEntryengagementState();
}

class _EnglishEntryengagementState extends State<EnglishEntryengagement> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""engagement""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """engagement""",
                      // alsoEnglishWord: "also: engagement",
                      britshText: """IpaUK: /ɪnˈɡeɪdʒmənt/""",
                      americanText: """IpaUS: /ɪnˈɡeɪdʒmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "engagement";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Their engagement was announced in the local paper.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She has broken off her engagement to Charles.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He has a number of social engagements next week.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was her first official engagement.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Higher education can contribute to civic engagement.""");
  }
...
کوردی: دەزگیرانی،	کار، سەرقاڵی،	بەڵێنی، بڕیار، گفت، خۆبەستەیی، پەیمان‌بەستەیی، پەیگرتن، گرتنەمل، دەربەستی، پێبەندی،	بڕیار،	ڕاگرتن، دامەزران(دن)،	تێک‌هەڵچوون، شەڕ، پێکادان،	گیر، لێک‌گیری، تێک‌گیران، لێک‌گیربوون، تێک‌گیری، جووت (پێچکە یان گێڕەکان)
"""),
          const DefinitionKurdish(
              text: """١. (ناو) ڕازیبوون بە هاوسەرگیری لەگەڵ کەسێک"""),
          SentencesRow(
            englishText:
                """Their engagement was announced in the local paper.""",
            kurdishText: """مارەبڕینەکەیان لە ڕۆژنامە خۆجێییەکە ڕاگەیەندرا.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She has broken off her engagement to Charles.""",
            kurdishText: """دەزگیرانداریی لەگەڵ چارڵس هەڵوەشاندەوە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """ژمارەیەک کۆبوونەوەی کۆمەڵایەتی بۆ هەفتەی داهاتوو هەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """It was her first official engagement.""",
            kurdishText: """ئەوە یەکەمین ئەرکی فەرمیی بوو.""",
          ...
          SentencesRow(
            englishText:
                """The president fell ill and was forced to cancel all public engagements.""",
            kurdishText:
                """سەرۆک نەخۆش کەوت و ناچاربوو هەموو ئەرکێکی گشتی هەڵبوەشێنێتەوە.""",
          ...
          SentencesRow(
            englishText:
                """Her views are based on years of engagement with the problems of the inner city.""",
            kurdishText:
                """دیدەکانی پشتبەستوون بە چەندین ساڵ لە تێگەشتن لە کێشەکانی ناوخۆی شارەکە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """خوێندنی باڵا دەکرێت ببێتە بەشێک لە تێگەشتنی مەدەنییانە.""",
            onPressedBritish: () => speaksentence7("en-GB"),
            onPressedAmerican: () => speaksentence7("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٤. (ناو) شەڕی نێوان دوو سوپا، هتد"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The general tried to avoid an engagement with the enemy.""",
            kurdishText:
                """ژەنەڕاڵەکە هەوڵیدا لە شەڕ لەگەڵ دوژمن دوور بکەوێتەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: engagement (Derived forms: engagements)
1. A hostile meeting of opposing military forces in the course of a war (= battle, conflict, fight)
"he lost his romantic ideas about war when he got into a real engagement";
 
2. A meeting arranged in advance (= date, appointment)
 
3. A mutual promise to marry (= betrothal, troth [archaic], betrothment)
 
4. The act of giving someone a job (= employment)
 
5. Employment for performers or performing groups that lasts for a limited period of time (= booking)
"the play had engagements throughout the summer";
 
6. Contact by fitting together (= mesh, meshing, interlocking)
"the engagement of the clutch";
 
7. The act of sharing in the activities of a group (= participation, involvement, involution)
...
const double _startSecondsend = 1056;
const String _videoIdone = 'https://youtu.be/8AGNsvNFUGw?t=';
const double _startSecondsone = 45;
const String _videoIdtwo = 'https://youtu.be/mY3SEMTROas?t=';
const double _startSecondstwo = 1533;
const String _videoIdthree = 'https://youtu.be/io6wi8DVZ3o?t=';
const double _startSecondsthree = 493;
const String _videoIdfour = 'https://youtu.be/Zad6v8ZHzdg?t=';
const double _startSecondsfour = 587;
const String _videoIdfive = 'https://youtu.be/HAnw168huqA?t=';
const double _startSecondsfive = 3075;
const String _videoIdsix = 'https://youtu.be/k7YVxLLIuGM?t=';
const double _startSecondssix = 269;
