...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'CYvjC94jDu4';
    const double startSecondsend = 60;
    const String videoIdone = 'irWodlcSBbQ';
    const double startSecondsone = 407;
    const String videoIdtwo = 'oRg7kCVZ3cc';
    const double startSecondstwo = 66;
    const String videoIdthree = 'MPS2fwRMFgM';
    const double startSecondsthree = 103;
    const String videoIdfour = '3DxCHzPFbaU';
    const double startSecondsfour = 136;
    const String videoIdfive = 'hMgMASVsA9Y';
    const double startSecondsfive = 3422;
