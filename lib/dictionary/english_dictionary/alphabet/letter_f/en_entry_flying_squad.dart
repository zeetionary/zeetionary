...
class EnglishEntryflyingsquad extends StatefulWidget {
  const EnglishEntryflyingsquad({super.key});

  @override
  State<EnglishEntryflyingsquad> createState() =>
      _EnglishEntryflyingsquadState();
}

class _EnglishEntryflyingsquadState extends State<EnglishEntryflyingsquad> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flying squad (Derived forms: flying squads)
1. A mobile group of trained people (police, executives or officials) able to move quickly in the case of emergencies
""",
  );

  final String keyword = "flying squad";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flying squad""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The police flying squad arrived at the scene within minutes.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flying squad""",
                      // alsoEnglishWord: "also: flying squad",
                      britshText: """IpaUK: /ˈflaɪɪŋ skwɒd/""",
                      americanText: """IpaUS: /ˈflaɪɪŋ skwɑːd/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ژمارەیەک پۆلیس لە بەریتانیا کە زوو دەگەنە شوێنی تاوان"""),
                    SentencesRow(
                      englishText:
                          """The police flying squad arrived at the scene within minutes.""",
                      kurdishText:
                          """یەکەی خێرای پۆلیس لە ماوەی چەند خولەکێکدا گەیشتە شوێنی ڕووداوەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/dpuHrZRS4rY?t=';
const double _startSecondsend = 000000000000000000000000000655;
const String _videoIdone = 'https://youtu.be/NcLBJsBY1Nw?t=';
const double _startSecondsone = 000000000000000000000000000143;
const String _videoIdtwo = 'https://youtu.be/cEQBz1pmOko?t=';
const double _startSecondstwo = 000000000000000000000000000566;
const String _videoIdthree = 'https://youtu.be/kL5BDP7FqWw?t=';
const double _startSecondsthree = 00000000000000000000000000064;
const String _videoIdfour = 'https://youtu.be/SbiI8age-y4?t=';
const double _startSecondsfour = 0000000000000000000000000001703;
const String _videoIdfive = 'https://youtu.be/5ai1F4Puspg?t=';
