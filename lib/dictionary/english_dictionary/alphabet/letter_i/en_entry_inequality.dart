...
class EnglishEntryinequality extends StatefulWidget {
  const EnglishEntryinequality({super.key});

  @override
  State<EnglishEntryinequality> createState() => _EnglishEntryinequalityState();
}

class _EnglishEntryinequalityState extends State<EnglishEntryinequality> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: inequality (Derived forms: inequalities)
1. Lack of equality
"the growing inequality between rich and poor"
""",
  );

  final String keyword = "inequality";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inequality""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak(
        """Gender inequality are still widespread throughout society.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/JY5t6iUzajk?t=';
    const double startSecondsone = 000000000000000000000000000514;
    const String videoIdtwo = 'https://youtu.be/kBdfcR-8hEY?t=';
    const double startSecondstwo = 000000000000000000000000000990;
    const String videoIdthree = 'https://youtu.be/Ot4qdCs54ZE?t=';
    const double startSecondsthree = 00000000000000000000000000040;
    const String videoIdfour = 'https://youtu.be/E37swnRU2fs?t=';
    const double startSecondsfour = 000000000000000000000000000179;
    const String videoIdfive = 'https://youtu.be/Ix6vtM4gP8g?t=';
    const double startSecondsfive = 000000000000000000000000000226;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inequality""",
                      // alsoEnglishWord: "also: inequality",
                      britshText: """IpaUK: /ˌɪnɪˈkwɒləti/""",
                      americanText: """IpaUS: /ˌɪnɪˈkwɑːləti/""",
...
کوردی: نابەرامبەری، نایەکسانی، جیاوازی،	نادادگەری، ناڕەوایی، نادادپەروەری،	ناڕێکی، ناتەختی
"""),
// With short examples define "inequality", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) نایەکسانی لە نێوان گرووپەکانی کۆمەڵگادا، بۆ نموونە کە کۆمەڵێک سامان، پێگە، و هەلی زیاتریان هەبێت لەوانی دیکە"""),
                    SentencesRow(
                      englishText:
                          """We need to tackle inequality of opportunity wherever we find it.""",
                      kurdishText:
                          """دەبێت بوەستین دژی لەگەڵ نایەکسانی پێدانی هەل بوەستین لە هەر کوێ بیبینین.""",
                      englishNote:
                          """This means we should address and solve the unfairness in chances people have, no matter where it exists.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Gender inequality are still widespread throughout society.""",
                      kurdishText:
                          """نایەکسانی ڕەگەزی هێشتا بەربڵاوە لە تەواوی کۆمەڵگاکەدا.""",
