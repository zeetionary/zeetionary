...
class EnglishEntryflamboyant extends StatefulWidget {
  const EnglishEntryflamboyant({super.key});

  @override
  State<EnglishEntryflamboyant> createState() => _EnglishEntryflamboyantState();
}

class _EnglishEntryflamboyantState extends State<EnglishEntryflamboyant> {
  @override
  void initState() {
    super.initState();
...
1. Marked by ostentation but often tasteless (= showy, splashy)
"a cheap flamboyant rhinestone bracelet";
 
2. Elaborately or excessively ornamented (= aureate, florid)
...
- Noun: flamboyant (Derived forms: flamboyants)
1. Showy tropical tree or shrub native to Madagascar; widely planted in tropical regions for its immense racemes of scarlet and orange flowers; sometimes placed in genus Poinciana (= royal poinciana, flame tree, peacock flower, Delonix regia, Poinciana regia)
""",
  );

  final String keyword = "flamboyant";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flamboyant""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The writer's flamboyant lifestyle was well known.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flamboyant""",
                      // alsoEnglishWord: "also: flamboyant",
                      britshText: """IpaUK: /flæmˈbɔɪənt/""",
                      americanText: """IpaUS: /flæmˈbɔɪənt/""",
...
// With short examples define "flamboyant", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کەسێک یان ڕەفتارکردنی کە جیاواز و بەجۆشهێنەرە و زۆرجار سەرنج ڕادەکێشێت"""),
                    SentencesRow(
                      englishText:
                          """The writer's flamboyant lifestyle was well known.""",
                      kurdishText:
                          """شێوازی ژیانی سەیروسەمەرەی نووسەرەکە باش زانراو بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """His clothes were rather flamboyant for such a serious occasion.""",
                      kurdishText:
                          """جلەکانی تا ڕادەیەک باق و بریق بوون بۆ بۆنەیەکی جدی.""",
...
const double _startSecondsend = 0000000000000000000000000001729;
const String _videoIdone = 'https://youtu.be/60FM9WjkXtA?t=';
const double _startSecondsone = 000000000000000000000000000140;
const String _videoIdtwo = 'https://youtu.be/48pP0WFjuOE?t=';
const double _startSecondstwo = 00000000000000000000000000014;
const String _videoIdthree = 'https://youtu.be/uK98jrF_0Og?t=';
const double _startSecondsthree = 00000000000000000000000000030;
const String _videoIdfour = 'https://youtu.be/Un1gfVckcVw?t=';
const double _startSecondsfour = 0000000000000000000000000001734;
const String _videoIdfive = 'https://youtu.be/L3SIdXPtB0M?t=';
const double _startSecondsfive = 000000000000000000000000000202;
