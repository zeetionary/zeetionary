...
// replace these: replace EnglishEntryacrobat - replace speakAacrobat - replace acrobat - /ˈækrəbæt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryacrobat extends StatelessWidget {
  EnglishEntryacrobat({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAacrobat(String languageCode) async {
    // DOPSUM: CHANGE speakAacrobat
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("acrobat"); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈækrəbæt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'IdTqwK9q2cE';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'oJ6MYYTccKE';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'oyXl3IhonRM';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'UU2AZyf6EGQ';
