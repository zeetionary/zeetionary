...
class EnglishEntrygrandchild extends StatefulWidget {
  const EnglishEntrygrandchild({super.key});

  @override
  State<EnglishEntrygrandchild> createState() => _EnglishEntrygrandchildState();
}

class _EnglishEntrygrandchildState extends State<EnglishEntrygrandchild> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grandchild (Derived forms: grandchildren)
1. A child of your son or daughter (- grandkid [N. Amer, informal], oe [UK, dialect])
""",
  );

  final String keyword = "grandchild";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grandchild""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She loves spending time with her grandchild.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He visited his grandchild every weekend.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grandchild""",
                      // alsoEnglishWord: "also: grandchild",
                      britshText: """IpaUK: /ˈɡræntʃaɪld/""",
                      americanText: """IpaUS: /ˈɡræntʃaɪld/""",
...
کوردی: نەوە، کوڕەزا، کچەزا
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) منداڵی کوڕ یان کچەکەت"""),
                    SentencesRow(
                      englishText:
                          """She loves spending time with her grandchild.""",
                      kurdishText: """حەزی لە بەسەربردنی کاتە لەگەڵ نەوەکەی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He visited his grandchild every weekend.""",
                      kurdishText:
                          """هەموو کۆتایی هەفتەیەک سەردانی نەوەکەی دەکرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/yWI61kpFEAA?t=';
const double _startSecondsend = 000000000000000000000000000116;
const String _videoIdone = 'https://youtu.be/OaXvEd5uu2w?t=';
const double _startSecondsone = 0000000000000000000000000001278;
const String _videoIdtwo = 'https://youtu.be/3AqCyShVGOQ?t=';
const double _startSecondstwo = 000000000000000000000000000481;
const String _videoIdthree = 'https://youtu.be/F8Thuw3qPGw?t=';
const double _startSecondsthree = 00000000000000000000000000024;
const String _videoIdfour = 'https://youtu.be/AxSQGOjh110?t=';
const double _startSecondsfour = 0000000000000000000000000001701;
const String _videoIdfive = 'https://youtu.be/C5L687zX-IM?t=';
