...
class EnglishEntryherdsman extends StatefulWidget {
  const EnglishEntryherdsman({super.key});

  @override
  State<EnglishEntryherdsman> createState() => _EnglishEntryherdsmanState();
}

class _EnglishEntryherdsmanState extends State<EnglishEntryherdsman> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: herdsman (Derived forms: herdsmen)
1. Someone who drives a herd (- herder, drover)
""",
  );

  final String keyword = "herdsman";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""herdsman""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """A skilled herdsman knows how to handle different types of livestock.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """herdsman""",
                      // alsoEnglishWord: "also: herdsman",
                      britshText: """IpaUK: /ˈhɜːdzmən/""",
                      americanText: """IpaUS: /ˈhɜːrdzmən/""",
...
کوردی: مێگەلەوان، ڕانەوان، مێگەل‌دار، مێگەل‌ڕاگر، شوان
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە چاودێری ژمارەیەک ئاژەڵ دەکات لە دەشتێکدا"""),
                    SentencesRow(
                      englishText:
                          """A skilled herdsman knows how to handle different types of livestock.""",
                      kurdishText:
                          """شوانێکی شارەزا دەزانێت چۆن مامەڵە بکات لەگەڵ جۆرە جیاوازەکانی مەڕ و ماڵات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/CwzaVzIhgmk?t=';
const double _startSecondsend = 0000000000000000000000000001421;
const String _videoIdone = 'https://youtu.be/MPHkGmPf9j0?t=';
const double _startSecondsone = 000000000000000000000000000923;
const String _videoIdtwo = 'https://youtu.be/llZpc8MlK8k?t=';
const double _startSecondstwo = 00000000000000000000000000049;
const String _videoIdthree = 'https://youtu.be/Bh5kHTBr0gU?t=';
const double _startSecondsthree = 00000000000000000000000000037;
const String _videoIdfour = 'https://youtu.be/R0qkSTvRQa8?t=';
const double _startSecondsfour = 000000000000000000000000000518;
const String _videoIdfive = 'https://youtu.be/Kv8jmSVUFWk?t=';
const double _startSecondsfive = 000000000000000000000000000606;
