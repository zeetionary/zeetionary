...
// replace these: EnglishEntryabundance - speakAbundance - abundance - /əˈbʌndəns/

enum TtsState { playing }

class EnglishEntryabundance extends StatelessWidget {
  EnglishEntryabundance({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAbundance(String languageCode) async {
    // DOPSUM: CHANGE speakAbundance
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'abundance', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈbʌndəns/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'ciV5CpsnDb4';
