...
class EnglishEntryflair extends StatefulWidget {
  const EnglishEntryflair({super.key});

  @override
  State<EnglishEntryflair> createState() => _EnglishEntryflairState();
}

class _EnglishEntryflairState extends State<EnglishEntryflair> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flair (Derived forms: flairs)
1. A natural talent (= genius)
"he has a flair for mathematics";
 
2. Distinctive and stylish elegance (= dash, elan, panache, style, élan)
"he wooed her with the confident flair of a cavalry officer";
 
3. [non-standard] A shape that spreads outward (= flare)
"the skirt had a wide flair";
""",
  );

  final String keyword = "flair";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He has a flair for languages.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She dresses with real flair.""");
  }
...
کوردی: توانایی، توانست، توانایی سروشتی، بەهرە، لێهاتوویی، توانایی لێک‌کردنەوە، زیرەکی،	ئارەزوو، حەز، مەیل، ویست
"""),
// With short examples define "flair", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) توانای سرووشتی کردنی شتێک بە باشی"""),
                    SentencesRow(
                      englishText: """He has a flair for languages.""",
                      kurdishText: """کێهاتووی بۆ (فێربوونی) زمان هەبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بە بەهرەی ڕاستەقینەوە جل لەبەر دەکات.""",
...
const double _startSecondsend = 000000000000000000000000000915;
const String _videoIdone = 'https://youtu.be/KJy7T24rhg0?t=';
const double _startSecondsone = 000000000000000000000000000309;
const String _videoIdtwo = 'https://youtu.be/0zXfDafyyao?t=';
const double _startSecondstwo = 000000000000000000000000000548;
...
const double _startSecondsfour = 000000000000000000000000000275;
const String _videoIdfive = 'https://youtu.be/qQ01eLt_bxo?t=';
const double _startSecondsfive = 0000000000000000000000000001210;
