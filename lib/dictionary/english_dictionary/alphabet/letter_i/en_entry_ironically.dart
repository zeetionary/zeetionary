...
class EnglishEntryironically extends StatefulWidget {
  const EnglishEntryironically({super.key});

  @override
  State<EnglishEntryironically> createState() => _EnglishEntryironicallyState();
}

class _EnglishEntryironicallyState extends State<EnglishEntryironically> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "ironically";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ironically""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He smiled ironically.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/Cxqca4RQd_M?t=';
    const double startSecondsend = 000000000000000000000000000364;
    const String videoIdone = 'https://youtu.be/BuEgzFAM6Es?t=';
    const double startSecondsone = 000000000000000000000000000353;
    const String videoIdtwo = 'https://youtu.be/TRGHIN2PGIA?t=';
    const double startSecondstwo = 000000000000000000000000000169;
    const String videoIdthree = 'https://youtu.be/anbBwpoI9TI?t=';
    const double startSecondsthree = 000000000000000000000000000188;
    const String videoIdfour = 'https://youtu.be/oiLdWXLXDeA?t=';
    const double startSecondsfour = 000000000000000000000000000580;
    const String videoIdfive = 'https://youtu.be/OOg-4mtA3Zo?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ironically""",
                      // alsoEnglishWord: "also: ironically",
                      britshText: """IpaUK: /aɪˈrɒnɪkli/""",
                      americanText: """IpaUS: /aɪˈrɑːnɪkli/""",
...
// کوردی:
// """),
// With short examples define "ironically", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە ئەوە پیشان دەدات کە مەبەستت پێچەوانەی ئەوەیە کە دەیڵێیت"""),
                    SentencesRow(
                      englishText: """He smiled ironically.""",
                      kurdishText: """بە توانجەوە پێکەنی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Ironically, the book she felt was her worst sold more copies than any of her others.""",
                      kurdishText:
                          """بە تەنزەوە، ئەو کتێبەی کە وای بیرکردەوە خراپترینییەتی زیاتر لە هەموو ئەوانەی دیکەیی فرۆشت.""",
