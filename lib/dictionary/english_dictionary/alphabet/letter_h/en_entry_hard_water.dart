...
class EnglishEntryhardwater extends StatefulWidget {
  const EnglishEntryhardwater({super.key});

  @override
  State<EnglishEntryhardwater> createState() => _EnglishEntryhardwaterState();
}

class _EnglishEntryhardwaterState extends State<EnglishEntryhardwater> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "hard water";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hard water""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She noticed hard water buildup on the faucet.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hard water""",
                      // alsoEnglishWord: "also: hard water",
                      britshText: """IpaUK: /ˈhevi wɔːtə(r)/""",
                      americanText: """IpaUS: /ˈhevi wɔːtər/""",
...
کوردی: 
"""),
                    const DefinitionKurdish(text: """١. (ناو) ئاوێک کە تێیدا هایدرۆجین گۆڕدراوەتەوە بە دیوتێریەم، و وادەکات دیوتێریەم بئۆکسێت. ئەم ئاوە لە وێستگەی ئەتۆمیدا بەکاردێت"""),
                    SentencesRow(
                      englishText: """She noticed hard water buildup on the faucet.""",
                      kurdishText: """تێبینی کەڵەکەبوونی ئاوی قورسی لە بەلووعەدا کرد.""",
