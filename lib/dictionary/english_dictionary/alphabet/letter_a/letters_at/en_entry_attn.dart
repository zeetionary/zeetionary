...
class EnglishEntryattn extends StatelessWidget {
  ...
  Future<void> speakAttn(String languageCode) async {
    ...
    await flutterTts.speak("attn"); // DOPSUM: CHANGE TEXT
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "X298UT0Zrpo";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "a4QOPlOxJnM";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "5e-AZWwWvts";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "m-MzRKsvCGE";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "p0nFothF9JQ";
