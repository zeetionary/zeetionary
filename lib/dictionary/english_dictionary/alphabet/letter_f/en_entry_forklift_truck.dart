...
class EnglishEntryforklifttruck extends StatefulWidget {
  const EnglishEntryforklifttruck({super.key});

  @override
  State<EnglishEntryforklifttruck> createState() =>
      _EnglishEntryforklifttruckState();
}

class _EnglishEntryforklifttruckState extends State<EnglishEntryforklifttruck> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forklift truck (Derived forms: forklift trucks)
1. A small industrial vehicle with a power operated forked platform in front that can be inserted under loads to lift and move them (= forklift)
""",
  );

  final String keyword = "forklift truck";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forklift truck""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They used a forklift truck to unload the truck.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forklift truck""",
                      // alsoEnglishWord: "also: forklift truck",
                      britshText: """IpaUK: /ˌfɔːklɪft ˈtrʌk/""",
                      americanText: """IpaUS: /ˌfɔːrklɪft ˈtrʌk/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پێڕۆیەکی بچووک کە دوو پارچە ئاسنی بەهێز لە پێشیەوەیەتی بۆ هەڵگرتنی شت، بۆ نموونە لە کارگەیەکدا"""),
                    SentencesRow(
                      englishText:
                          """They used a forklift truck to unload the truck.""",
                      kurdishText:
                          """رافیعەیەکیان بەکارهێنا بۆ بەتاڵکردنی بارهەڵگرەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/p5QUHh__lvk?t=';
const double _startSecondsend = 000000000000000000000000000157;
const String _videoIdone = 'https://youtu.be/IGaq9aFSjuU?t=';
const double _startSecondsone = 0000000000000000000000000003655;
const String _videoIdtwo = 'https://youtu.be/yLUzEABILpw?t=';
const double _startSecondstwo = 000000000000000000000000000374;
const String _videoIdthree = 'https://youtu.be/GbcXfbRvvrA?t=';
const double _startSecondsthree = 000000000000000000000000000186;
const String _videoIdfour = 'https://youtu.be/XobwaWEAfpg?t=';
const double _startSecondsfour = 000000000000000000000000000373;
const String _videoIdfive = 'https://youtu.be/HIllH4sS9Js?t=';
const double _startSecondsfive = 0000000000000000000000000001975;
