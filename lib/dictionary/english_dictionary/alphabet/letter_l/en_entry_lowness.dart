...
class EnglishEntrylowness extends StatefulWidget {
  const EnglishEntrylowness({super.key});

  @override
  State<EnglishEntrylowness> createState() => _EnglishEntrylownessState();
}

class _EnglishEntrylownessState extends State<EnglishEntrylowness> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylowness lowness
WORD_WEB lowness lowness lowness
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lowness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lowness""");
  }
...
کوردی: 
"""),
// With short examples define "lowness", please follow LX instructions
