...
class EnglishEntryextermination extends StatefulWidget {
  const EnglishEntryextermination({super.key});

  @override
  State<EnglishEntryextermination> createState() =>
      _EnglishEntryexterminationState();
}

class _EnglishEntryexterminationState extends State<EnglishEntryextermination> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extermination""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extermination""",
                      // alsoEnglishWord: "also: extermination",
                      britshText: """IpaUK: /ɪkˌstɜːmɪˈneɪʃn/""",
                      americanText: """IpaUS: /ɪkˌstɜːrmɪˈneɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extermination";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The sheer scale of these mass exterminations is horrifying.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کوشتنی تەواوی ئەندامانی گرووپێک یان کۆمەڵە ئاژەڵێک"""),
          SentencesRow(
            englishText:
                """The sheer scale of these mass exterminations is horrifying.""",
            kurdishText: """ئاستی زۆری ئەم قڕکردنە بەکۆمەڵانە تۆقێنەرە.""",
...
2. The act of exterminating (= liquidation)
""",
  );
...
const double _startSecondsend = 0000000000000000000000000004890;
const String _videoIdone = 'https://youtu.be/NNnIGh9g6fA?t=';
const double _startSecondsone = 0000000000000000000000000001806;
const String _videoIdtwo = 'https://youtu.be/PhQksV8fbKw?t=';
const double _startSecondstwo = 000000000000000000000000000798;
const String _videoIdthree = 'https://youtu.be/J3euEMWC8tg?t=';
const double _startSecondsthree = 000000000000000000000000000527;
const String _videoIdfour = 'https://youtu.be/3-zXS_1B5oo?t=';
const double _startSecondsfour = 00000000000000000000000000034;
const String _videoIdfive = 'https://youtu.be/pv-c70rrKZI?t=';
