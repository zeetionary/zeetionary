...
class EnglishEntryhinder extends StatefulWidget {
  const EnglishEntryhinder({super.key});

  @override
  State<EnglishEntryhinder> createState() => _EnglishEntryhinderState();
}

class _EnglishEntryhinderState extends State<EnglishEntryhinder> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: hinder (Derived forms: hindering, hinders, hindered)
1. Be a hindrance or obstacle to (- impede, fetter [literary], entrammel [literary], trammel [literary])
"She is hindering the progress of our project";
 
2. Hinder or prevent the progress or accomplishment of (- obstruct, blockade, block, stymie, stymy [rare], embarrass)
"His brother hindered him at every turn";
 
3. Put at a disadvantage (- handicap, hamper)
"The brace I have to wear is hindering my movements";

- Adjective: hinder 
1. Located at or near the back of an animal (- back, hind)
"hinder legs"; "the hinder part of a carcass";
""",
  );

  final String keyword = "hinder";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Some teachers felt hindered by a lack of resources.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""An injury was hindering him from playing his best.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001052;
    const String videoIdone = 'https://youtu.be/zhdBNVY55oM?t=';
    const double startSecondsone = 000000000000000000000000000316;
    const String videoIdtwo = 'https://youtu.be/kVOTPAxrrP4?t=';
    const double startSecondstwo = 000000000000000000000000000942;
    const String videoIdthree = 'https://youtu.be/vjDYfvPW4mA?t=';
    const double startSecondsthree = 000000000000000000000000000869;
    const String videoIdfour = 'https://youtu.be/_rBO8neWw04?t=';
    const double startSecondsfour = 0000000000000000000000000001504;
    const String videoIdfive = 'https://youtu.be/7bo3RaOEL8g?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hinder""",
                      // alsoEnglishWord: "also: hinder",
                      britshText: """IpaUK: /ˈhɪndə(r)/""",
                      americanText: """IpaUS: /ˈhɪndər/""",
...
کوردی: 
"""),
// With short examples define "hinder", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) ڕێگرتن لە کەسێک لەوەی بە ئاسانی شتێک بکات یان شتێک ڕووبدات"""),
                    const AlsoEnglishckb(word: "ھەروەھا: hamper"),
                    SentencesRow(
                      englishText:
                          """Some teachers felt hindered by a lack of resources.""",
                      kurdishText:
                          """هەندێک مامۆستا هەستیان بە کۆسپ دەکرد بەهۆی کەمی سەرچاوەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پێکانێک ڕێگریی لێی دەکرد لەوەی بە باشترین شێوە یاری بکات.""",
