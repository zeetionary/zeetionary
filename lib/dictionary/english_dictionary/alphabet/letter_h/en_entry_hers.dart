...
class EnglishEntryhers extends StatefulWidget {
  const EnglishEntryhers({super.key});

  @override
  State<EnglishEntryhers> createState() => _EnglishEntryhersState();
}

class _EnglishEntryhersState extends State<EnglishEntryhers> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Pronoun: hers
1. Belonging to or associated with her
""",
  );

  final String keyword = "hers";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The choice was hers.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hers""",
                      // alsoEnglishWord: "also: hers",
                      britshText: """IpaUK: /hɜːz/, /ɜːz/""",
                      americanText: """IpaUS: /hɜːrz/, /ɜːrz/""",
