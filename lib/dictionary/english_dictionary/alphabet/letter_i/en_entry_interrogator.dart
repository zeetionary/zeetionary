...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '4kEil-H7490';
    const double startSecondsend = 387;
    const String videoIdone = 'wf6x4FHTMKo';
    const double startSecondsone = 1928;
    const String videoIdtwo = 'zwZY-PknSQw';
    const double startSecondstwo = 613;
    const String videoIdthree = 'sY8aFSY2zv4';
    const double startSecondsthree = 10947;
    const String videoIdfour = 'qWNHsaszXpc';
    const double startSecondsfour = 734;
    const String videoIdfive = 'PuYJQsIJzhg';
