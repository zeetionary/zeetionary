...
// replace these: replace EnglishEntryairway - replace speakAirway - replace airway - /ˈeəweɪ/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryairway extends StatelessWidget {
  EnglishEntryairway({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAirway(String languageCode) async {
    // DOPSUM: CHANGE speakAirway
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("airway"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAirway4555(String languageCode) async {
    ...
    await flutterTts.speak(
        "Prevent the tongue falling back and obstructing the airway."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "airway"), // DOPSUM: CHANGE WORD ENTRY - Find /ˈeəweɪ/
                            // nothing heereee
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /ˈeəweɪ/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                            CustomIconButtonBritish(
                              onPressed: () =>
                                  speakAirway(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /ˈerweɪ/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                            CustomIconButtonAmerican(
                              onPressed: () => speakAirway(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'N6K35fvBjn4';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '7Ga0nnK5sss';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'V-FEi9NEYtQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'Cxv0z1CjIW4';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '-RhxtkanZQk';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'wgGPan7MbyU';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'iek2kalqcsk';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'E9peKIdne44';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = 'yACYTPsAQNU';
