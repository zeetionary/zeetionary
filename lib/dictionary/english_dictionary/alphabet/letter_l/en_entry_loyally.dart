...
class EnglishEntryloyally extends StatefulWidget {
  const EnglishEntryloyally({super.key});

  @override
  State<EnglishEntryloyally> createState() => _EnglishEntryloyallyState();
}

class _EnglishEntryloyallyState extends State<EnglishEntryloyally> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryloyally loyally
WORD_WEB loyally loyally loyally
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "loyally";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""loyally""");
  }
...
کوردی: 
"""),
// With short examples define "loyally", please follow LX instructions
