...
class EnglishEntryhighprofile extends StatefulWidget {
  const EnglishEntryhighprofile({super.key});

  @override
  State<EnglishEntryhighprofile> createState() => _EnglishEntryhighprofileState();
}

class _EnglishEntryhighprofileState extends State<EnglishEntryhighprofile> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: high profile (Derived forms: high profiles)
1. A position attracting much attention and publicity
""",
  );

  final String keyword = "high-profile";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""high-profile""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He resigned from a high-profile job as economic adviser to the president.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """high-profile""",
                      // alsoEnglishWord: "also: high-profile",
                      britshText: """IpaUK: /ˌhaɪ ˈprəʊfaɪl/""",
                      americanText: """IpaUS: /ˌhaɪ ˈprəʊfaɪl/""",
...
کوردی: 
"""),
// With short examples define "high-profile", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) کە زۆر لە میدیادا باس دەکرێت"""),
                    SentencesRow(
                      englishText: """He resigned from a high-profile job as economic adviser to the president.""",
                      kurdishText: """دەستی کێشایەوە لە کارێکی بەناوبانگ وەک ڕاوێژکاری ئابووری بۆ سەرۆک.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/7eM7pb5M5DU?t=';
const double _startSecondsend = 0000000000000000000000000002633;
const String _videoIdone = 'https://youtu.be/63tQ7yGmsmI?t=';
const double _startSecondsone = 000000000000000000000000000231;
const String _videoIdtwo = 'https://youtu.be/5U-yqm9H_Sg?t=';
const double _startSecondstwo = 000000000000000000000000000276;
const String _videoIdthree = 'https://youtu.be/BPGgyputhpA?t=';
const double _startSecondsthree = 00000000000000000000000000057;
const String _videoIdfour = 'https://youtu.be/runjda4La_4?t=';
const double _startSecondsfour = 0000000000000000000000000001735;
const String _videoIdfive = 'https://youtu.be/cpXrH9sfslo?t=';
const double _startSecondsfive = 000000000000000000000000000814;
