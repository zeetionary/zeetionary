...
class EnglishEntryadlib extends StatefulWidget {
  const EnglishEntryadlib({super.key});

  @override
  State<EnglishEntryadlib> createState() => _EnglishEntryadlibState();
}

class _EnglishEntryadlibState extends State<EnglishEntryadlib> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakadlib4587(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("She delivered her speech ad lib.");
  }
  ...
  Future<void> speakadlib42587(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("I lost my notes and had to ad-lib the whole speech.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ad lib""",
                      // alsoEnglishWord: "also: ad lib",
                      britshText: """IpaUK: /ˌæd ˈlɪb/""",
                      americanText: """IpaUS: /ˌæd ˈlɪb/""",
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'rhL81MGXBRU';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '2pCRplUQVMI';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Bv18cPFpb6w';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '0w0AYg0c0xQ';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'QYigQmDriWw';
