...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""A group of hippies gathered for the peace rally.""");
  }
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک، بە تایبەتی گەنجێک لە کۆتاییەکانی شەستەکان و سەرەتای حەفتاکان، کە باوەڕی بە ئاشتی هەبوو، دژی زۆرێک لەو باوەڕە پەسەندکراوەکانی کۆمەڵگا بوو لەسەر شێوازی ژیان، قژی درێژی هەبوو، و زۆرجار بە گروپ دەژیان و مادەی هۆشبەریان دەکێشا"""),
                    SentencesRow(
                      englishText:
                          """A group of hippies gathered for the peace rally.""",
                      kurdishText:
                          """گرووپێک لە هیپییەکان کۆبوونەوە بۆ ڕێپێوانە ئاشتییەکە.""",
