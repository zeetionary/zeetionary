...
class EnglishEntryincisor extends StatefulWidget {
  const EnglishEntryincisor({super.key});

  @override
  State<EnglishEntryincisor> createState() => _EnglishEntryincisorState();
}

class _EnglishEntryincisorState extends State<EnglishEntryincisor> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incisor""");
  }
