...
class EnglishEntrylinchpin extends StatefulWidget {
  const EnglishEntrylinchpin({super.key});

  @override
  State<EnglishEntrylinchpin> createState() => _EnglishEntrylinchpinState();
}

class _EnglishEntrylinchpinState extends State<EnglishEntrylinchpin> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""linchpin""");
  }
