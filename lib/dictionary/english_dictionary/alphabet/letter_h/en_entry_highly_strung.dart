...
class EnglishEntryhighlystrung extends StatefulWidget {
  const EnglishEntryhighlystrung({super.key});

  @override
  State<EnglishEntryhighlystrung> createState() => _EnglishEntryhighlystrungState();
}

class _EnglishEntryhighlystrungState extends State<EnglishEntryhighlystrung> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: highly strung
1. Being in a tense state (- edgy, high-strung, jittery, jumpy, nervy, overstrung, restive, uptight [informal], squirrelly [N. Amer, informal])
"highly strung parents are sensitive themselves";
""",
  );

  final String keyword = "highly strung";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""highly strung""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    // 188888880002200
    const String videoIdend = 'https://youtu.be/JgCDO3F0G54?t=';
    const double startSecondsend = 00000000000000000000000000082;
    const String videoIdone = 'https://youtu.be/3WRD8BdxUTc?t=';
    const double startSecondsone = 000000000000000000000000000211;
    const String videoIdtwo = 'https://youtu.be/SZ_Iv9zk6M4?t=';
    const double startSecondstwo = 000000000000000000000000000638;
    const String videoIdthree = 'https://youtu.be/j9NXUqsfdEY?t=';
    const double startSecondsthree = 0000000000000000000000000001088;
    const String videoIdfour = 'https://youtu.be/u2UxisJLN5c?t=';
    const double startSecondsfour = 00000000000000000000000000084;
    const String videoIdfive = 'https://youtu.be/uPpy81ijQJk?t=';
    const double startSecondsfive = 0000000000000000000000000001012;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """highly strung""",
                      alsoEnglishWord: "also in US: high strung",
                      britshText: """IpaUK: /ˌhaɪli ˈstrʌŋ/""",
                      americanText: """IpaUS: /ˌhaɪli ˈstrʌŋ/""",
...
کوردی: 
"""),
// With short examples define "highly strung", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) کە شڵەژاوە و بە ئاسانی بێزار دەبێت"""),
                    SentencesRow(
                      englishText: """Their new horse is very highly strung.""",
