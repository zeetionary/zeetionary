...
class EnglishEntryloudspeaker extends StatefulWidget {
  const EnglishEntryloudspeaker({super.key});

  @override
  State<EnglishEntryloudspeaker> createState() => _EnglishEntryloudspeakerState();
}

class _EnglishEntryloudspeakerState extends State<EnglishEntryloudspeaker> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: loudspeaker (Derived forms: loudspeakers)
1. Electro-acoustic transducer that converts electrical signals into sounds loud enough to be heard at a distance (- speaker, speaker unit, loudspeaker system, speaker system)
""",
  );

  final String keyword = "loudspeaker";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""loudspeaker""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Their names were called over the loudspeaker.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Loudspeakers broadcast the football results.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She used her phone's loudspeaker to let everyone listen.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/V2ec7EE0pB8?t=2286';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/LP6ppSM3xq4?t=127';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/_0RTH57v66I?t=755';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/5d6SEQQbwtU?t=1730';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/kVOTPAxrrP4?t=439';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/dVZKn6NSmNg?t=559';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """loudspeaker""",
                      // alsoEnglishWord: "also: loudspeaker",
                      britshText: """IpaUK: /ˌlaʊdˈspiːkə(r)/""",
                      americanText: """IpaUS: /ˌlaʊdˈspiːkər/""",
...
کوردی: 
"""),
// With short examples define "loudspeaker", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ئامرازێک کە شەپۆلی کارەبایی دەکات بە دەنگی بەرز"""),
                    SentencesRow(
                      englishText: """Their names were called over the loudspeaker.""",
                      kurdishText: """دەنگیان بە بڵندگۆیەکە خوێندرایەوە.""",
                    ...
                    SentencesRow(
                      englishText: """Loudspeakers broadcast the football results.""",
                      kurdishText: """بڵندگۆیەکان ئەنجامی یارییەکە پەخش دەکەن.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ڕێگایەک بۆ گوێگرتن لە دەنگی موبایل بەبێ ئەوەی بینێیت بە گوێتەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She used her phone's loudspeaker to let everyone listen.""",
                      kurdishText: """بڵندگۆی موبایلەکەی بەکارهێنا بۆ ئەوەی هەموان گوێ بگرن.""",
