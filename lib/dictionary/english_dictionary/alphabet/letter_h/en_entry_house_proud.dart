...
class EnglishEntryhouseproud extends StatefulWidget {
  const EnglishEntryhouseproud({super.key});

  @override
  State<EnglishEntryhouseproud> createState() => _EnglishEntryhouseproudState();
}

class _EnglishEntryhouseproudState extends State<EnglishEntryhouseproud> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: house-proud
1. Proud of your house or its furnishings or upkeep
""",
  );

  final String keyword = "house-proud";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""house-proud""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She is very house-proud and cleans every day.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/urlnWsUczd4?t=';
    const double startSecondsend = 000000000000000000000000000887;
    const String videoIdone = 'https://youtu.be/4r9rkBS4gEk?t=';
    const double startSecondsone = 0000000000000000000000000001319;
    const String videoIdtwo = 'https://youtu.be/EnHbk2drLkU?t=';
    const double startSecondstwo = 000000000000000000000000000236;
    const String videoIdthree = 'https://youtu.be/fdjY7VgrGQg?t=';
    const double startSecondsthree = 000000000000000000000000000141;
    const String videoIdfour = 'https://youtu.be/pPy7eY_lCWE?t=';
    const double startSecondsfour = 00000000000000000000000000013688;
    const String videoIdfive = 'https://youtu.be/BQEEXozJH2Y?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """house-proud""",
                      // alsoEnglishWord: "also: house-proud",
                      britshText: """IpaUK: /ˈhaʊs praʊd/""",
                      americanText: """IpaUS: /ˈhaʊs praʊd/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) ئەوەی کە ماوەیەکی زۆر بەسەر ببەیت بە پاککردنەوە و جوانکردنی ماڵەکەت، و وەها بیربکەیتەوە کە ئەمە گرنگە"""),
                    SentencesRow(
                      englishText:
                          """She is very house-proud and cleans every day.""",
                      kurdishText:
                          """زۆر ژنێکی ماڵدارە و هەموو ڕۆژێک پاککردنەوە دەکات.""",
