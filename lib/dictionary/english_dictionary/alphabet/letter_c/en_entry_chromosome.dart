...
class EnglishEntrychromosome extends StatelessWidget {
  // blank divider
  EnglishEntrychromosome({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakchromosome(String languageCode) async {
    // DOPSUM: CHANGE speakchromosome
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "chromosome"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈkrəʊməsəʊm/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakchromosome("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈkrəʊməsəʊm/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakchromosome("en-US"),
                            ),
                          ],
                        ),
                      ],
...
کوردی: کرۆمۆسۆم، ڕەنگ‌تەن، ڕەنگین‌تەن، تەنەڕەنگینە
"""),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'BbA-pHyirzo';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'y3ST0whbA4k';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'OPMDO_IYY4Y';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '6wbgzVwiAKM';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'JA5j8QzAz0w';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'IoIfDUbaoBc';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'xtqUu8DGQko';
  final double _startSeconds = 18;
