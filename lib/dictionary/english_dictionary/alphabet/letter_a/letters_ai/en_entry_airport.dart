...
// replace these: replace EnglishEntryairport - replace speakAirport - replace airport - /ˈeəpɔːt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryairport extends StatelessWidget {
  EnglishEntryairport({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAirport(String languageCode) async {
    // DOPSUM: CHANGE speakAirport
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("airport"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAirport45288(String languageCode) async {
    ...
    await flutterTts.speak(
        "She arrived at Sao Paulo international airport on Friday to begin her journey."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "airport", // DOPSUM: CHANGE WORD ENTRY - Find /ˈeəpɔːt/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              "IpaUK: /ˈeəpɔːt/", // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAirport(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              "IpaUS: /ˈerpɔːrt/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'YA1J-raGinQ';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '6qXyJT7EVag';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = '1-byu4WBJGg';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'Kil-slXgVys';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'qJlrK9ao8zE';
