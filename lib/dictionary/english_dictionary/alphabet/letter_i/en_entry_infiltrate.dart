...
class EnglishEntryinfiltrate extends StatefulWidget {
  const EnglishEntryinfiltrate({super.key});

  @override
  State<EnglishEntryinfiltrate> createState() => _EnglishEntryinfiltrateState();
}

class _EnglishEntryinfiltrateState extends State<EnglishEntryinfiltrate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: infiltrate (Derived forms: infiltrated, infiltrates, infiltrating)
1. Cause (a liquid) to enter by penetrating the interstices
 
2. Enter a group or organization in order to spy on the members (- penetrate)
"The student organization was infiltrated by a traitor";
 
3. Pass into or through by filtering or permeating
"the substance infiltrated the material"
 
4. Pass through an enemy line; in a military conflict (- pass through)
""",
  );

  final String keyword = "infiltrate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infiltrate""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The headquarters had been infiltrated by enemy spies.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Rebel forces were infiltrated into the country.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/kRr9LQ7mZ_A?t=';
    const double startSecondsend = 000000000000000000000000000548;
    const String videoIdone = 'https://youtu.be/jeyVV9Ckpt4?t=';
    const double startSecondsone = 000000000000000000000000000217;
    const String videoIdtwo = 'https://youtu.be/AdZ9kGwqkTM?t=';
    const double startSecondstwo = 000000000000000000000000000195;
    const String videoIdthree = 'https://youtu.be/PhQksV8fbKw?t=';
    const double startSecondsthree = 0000000000000000000000000001130;
    const String videoIdfour = 'https://youtu.be/2dTmANFn0a4';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/U8dhOqrd8cY?t=';
    const double startSecondsfive = 000000000000000000000000000295;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """infiltrate""",
                      // alsoEnglishWord: "also: infiltrate",
                      britshText: """IpaUK: /ˈɪnfɪltreɪt/""",
                      americanText: """IpaUS: /ˈɪnfɪltreɪt/""",
...
کوردی: 
"""),
// With short examples define "infiltrate", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) چوونە شوێن یان ناو دامەزراوەیەک بە نهێنی؛ واکردنی ئەوەی کەسێک وابکات"""),
                    SentencesRow(
                      englishText:
                          """The headquarters had been infiltrated by enemy spies.""",
                      kurdishText:
                          """بارەگاکان لەلایەن سیخووڕی دوژمنەوە دزەیان تێکرابوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هێزە یاخیبووەکان دزەیان پێکرایە ناو وڵاتەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The CIA agents successfully infiltrated into the terrorist organizations.""",
                      kurdishText:
                          """سیخووڕەکانی سی‌ئای‌ئەی بە سەرکەوتووی دزەیان کردە ناو ڕێکخراوە تیرۆریستییەکانەوە.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (کردار) بە هێواشی تێپەڕینە ناو شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Only a small amount of the rainwater actually infiltrates into the soil.""",
                      kurdishText:
                          """تەنها دڵۆپەیەکی کەم لە ئاوی باران دزە دەکاتە ناو خاک.""",
