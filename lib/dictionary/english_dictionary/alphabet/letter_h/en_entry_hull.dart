...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/W8uXhQnWgj4?t=';
    const double startSecondsend = 000000000000000000000000000203;
    const String videoIdone = 'https://youtu.be/hkO8qXCFYWA?t=';
    const double startSecondsone = 0000000000000000000000000001072;
    const String videoIdtwo = 'https://youtu.be/RXXMJAU6vY8?t=';
    const double startSecondstwo = 000000000000000000000000000391;
    const String videoIdthree = 'https://youtu.be/-obKX-mqjXQ?t=';
    const double startSecondsthree = 0000000000000000000000000001383;
    const String videoIdfour = 'https://youtu.be/cykdSb7xqI4?t=';
    const double startSecondsfour = 000000000000000000000000000115;
    const String videoIdfive = 'https://youtu.be/kw9Bd96c1ug?t=';
    const double startSecondsfive = 0000000000000000000000000001255;
