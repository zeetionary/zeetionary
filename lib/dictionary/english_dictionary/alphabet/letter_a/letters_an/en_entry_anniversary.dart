                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "anniversary"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌænɪˈvɜːsəri/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌænɪˈvɜːrsəri/"),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '1CsN6ZYgp2Y';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'Eb4RooyW11M';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '_Bxnov4Iz0s';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'vKkpvQlHEG8';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'pcEWkf08CAA';
  final double _startSeconds = 52;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'O658Kh4lc8g';
