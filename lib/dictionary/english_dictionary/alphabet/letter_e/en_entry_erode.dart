...
class EnglishEntryerode extends StatefulWidget {
  const EnglishEntryerode({super.key});

  @override
  State<EnglishEntryerode> createState() => _EnglishEntryerodeState();
}

class _EnglishEntryerodeState extends State<EnglishEntryerode> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """erode""",
                      // alsoEnglishWord: "also: erode",
                      britshText: """IpaUK: /ɪˈrəʊd/""",
                      americanText: """IpaUS: /ɪˈrəʊd/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The cliff face has been steadily eroded by the sea.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The rocks have eroded away over time.""");
  }
...
کوردی: سووان، داخوران، پووکانەوە
"""),
          const DefinitionKurdish(
              text: """١. (کردار) کەم‌کەم داڕزان بەهۆی با، باران، هتد"""),
          SentencesRow(
            englishText:
                """The cliff face has been steadily eroded by the sea.""",
            kurdishText: """ووی قەپاڵەکە کەم‌کەم لەناوچووە بە دەریاکە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The rocks have eroded away over time.""",
            kurdishText: """بەردەکان لەگەڵ کاتدا داخورابوون.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) کەم‌کەم لەناوبردنی شتێک یان لاوازکردنی لەگەڵ کاتدا"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Her confidence has been slowly eroded by repeated failures.""",
            kurdishText:
                """ورەی بەهێواشی لەنابرابوو بە شکستی یەک لەدوای یەک.""",
          ...
          SentencesRow(
            englishText:
                """The experience had seriously eroded his confidence in himself.""",
            kurdishText: """ئەزموونە بە سەختی ورەی بە خۆی لەناوبردبوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: erode (Derived forms: eroded, erodes, eroding)
1. Become ground down or deteriorate (= gnaw, gnaw at, eat at, wear away)
"Her confidence eroded";
 
2. Remove soil or rock (= eat away, fret)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/hK9HXNib24g?t=';
const double _startSecondsend = 000000000000000000000000000000; // 72;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/pzvbUpKU4eE?t=';
const double _startSecondsone = 00000000000000000000000000000; // 546;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/q_T7L8rt1Ec?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 304;
const String _videoIdthree = 'VIDEOhttps://youtu.be/u0GMaP0M6w0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 181;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/bG19b06NG_w?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 705;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/of7vrIIcTa0?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 611;
