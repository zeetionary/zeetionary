...
class EnglishEntryhogmanay extends StatefulWidget {
  const EnglishEntryhogmanay({super.key});

  @override
  State<EnglishEntryhogmanay> createState() => _EnglishEntryhogmanayState();
}

class _EnglishEntryhogmanayState extends State<EnglishEntryhogmanay> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: Hogmanay (Derived forms: Hogmanays)
1. New Year's Eve in Scotland
""",
  );

  final String keyword = "Hogmanay";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Hogmanay""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We always celebrate Hogmanay with family and friends.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Wgh8Gfs2S7M?t=';
    const double startSecondsend = 000000000000000000000000000484;
    const String videoIdone = 'https://youtu.be/RUM0wmtjr_M?t=';
    const double startSecondsone = 0000000000000000000000000003;
    const String videoIdtwo = 'https://youtu.be/t7PVRDbqS8I?t=';
    const double startSecondstwo = 000000000000000000000000000107;
    const String videoIdthree = 'https://youtu.be/x7yN-GEVp20?t=';
    const double startSecondsthree = 000000000000000000000000000257;
    const String videoIdfour = 'https://youtu.be/5csK_dzniHE?t=';
    const double startSecondsfour = 000000000000000000000000000319;
    const String videoIdfive = 'https://youtu.be/qItknlzMmEY?t=';
    const double startSecondsfive = 000000000000000000000000000236;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """Hogmanay""",
                      // alsoEnglishWord: "also: Hogmanay",
                      britshText: """IpaUK: /ˈhɒɡməneɪ/,  /ˌhɒɡməˈneɪ/""",
                      americanText: """IpaUS: /ˈhɑːɡməneɪ/""",
...
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) شەوی سەری ساڵ لە سکۆتلەندا"""),
                    SentencesRow(
                      englishText:
                          """We always celebrate Hogmanay with family and friends.""",
                      kurdishText:
                          """هەمیشە شەوی سەری ساڵ لەگەڵ خێزان و هاوڕێکانمان بەسەر دەبەین.""",
