...
class EnglishEntryletterbox extends StatefulWidget {
  const EnglishEntryletterbox({super.key});

  @override
  State<EnglishEntryletterbox> createState() => _EnglishEntryletterboxState();
}

class _EnglishEntryletterboxState extends State<EnglishEntryletterbox> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""letter box""");
  }
