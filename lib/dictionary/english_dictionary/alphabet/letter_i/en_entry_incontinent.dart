...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'cvtOFHbENf0';
    const double startSecondsend = 0;
    const String videoIdone = 'vKQ15yYIf_c';
    const double startSecondsone = 43;
    const String videoIdtwo = '9Lv3l9zU6dU';
    const double startSecondstwo = 342;
    const String videoIdthree = 'XfmPu8l24wY';
    const double startSecondsthree = 261;
    const String videoIdfour = '7d0vFrsQJ24';
    const double startSecondsfour = 165;
    const String videoIdfive = 'joaPFbos42E';
    const double startSecondsfive = 1352;
