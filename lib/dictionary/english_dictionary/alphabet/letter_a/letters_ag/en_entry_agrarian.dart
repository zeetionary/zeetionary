...
// replace these: replace EnglishEntryagrarian - replace speakAgrarian - replace agrarian - /əˈɡreəriən/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryagrarian extends StatelessWidget {
  EnglishEntryagrarian({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAgrarian(String languageCode) async {
    // DOPSUM: CHANGE speakAgrarian
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("agrarian"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAgrarian4377(String languageCode) async {
    ...
    await flutterTts.speak(
        "The central government was urged to adopt a massive public investment programme in the agrarian sector to enhance grain production."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈɡreəriən/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'wdcXmerZWDc';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'g_2FZ-V_4zs';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'saSSlSQwlwg';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'PdYLRTGmQ3c';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = '2Hfj_6EFYKQ';
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = 'kCHdp7RpiwA';
