...
class EnglishEntryflowerpot extends StatefulWidget {
  const EnglishEntryflowerpot({super.key});

  @override
  State<EnglishEntryflowerpot> createState() => _EnglishEntryflowerpotState();
}

class _EnglishEntryflowerpotState extends State<EnglishEntryflowerpot> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flowerpot (Derived forms: flowerpots)
1. A container in which plants are cultivated (= pot)
""",
  );

  final String keyword = "flowerpot";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flowerpot""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Flowerpots need proper drainage to prevent waterlogging.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flowerpot""",
                      // alsoEnglishWord: "also: flowerpot",
                      britshText: """IpaUK: /ˈflaʊəpɒt/""",
                      americanText: """IpaUS: /ˈflaʊərpɑːt/""",
...
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) گوڵدانی پلاستیکی یان قوڕ"""),
                    SentencesRow(
                      englishText:
                          """Flowerpots need proper drainage to prevent waterlogging.""",
                      kurdishText:
                          """گوڵدان پێویستی بە بەتاڵکردنەوەی گونجاو هەیە بۆ ڕێگری لە پەنگخواردنی ئاو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/LC3OCQly1Jg?t=';
const double _startSecondsend = 000000000000000000000000000249;
const String _videoIdone = 'https://youtu.be/X6L57v59QZc?t=';
const double _startSecondsone = 000000000000000000000000000687;
const String _videoIdtwo = 'https://youtu.be/QIHuvbMg1qI?t=';
const double _startSecondstwo = 0000000000000000000000000001216;
const String _videoIdthree = 'https://youtu.be/VKl0AdbfqNM?t=';
const double _startSecondsthree = 000000000000000000000000000726;
const String _videoIdfour = 'https://youtu.be/Hq7kjC3jzyE?t=';
const double _startSecondsfour = 000000000000000000000000000115;
const String _videoIdfive = 'https://youtu.be/kB0U8vrkc-s?t=';
const double _startSecondsfive = 000000000000000000000000000208;
