...
class EnglishEntryflashy extends StatefulWidget {
  const EnglishEntryflashy({super.key});

  @override
  State<EnglishEntryflashy> createState() => _EnglishEntryflashyState();
}

class _EnglishEntryflashyState extends State<EnglishEntryflashy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flashy (Derived forms: flashiest, flashier)
1. Tastelessly showy (= brassy [informal], cheap, flash [informal], garish, gaudy, gimcrack, loud, meretricious, tacky [informal], tatty [informal], tawdry, trashy)
"a flashy ring";
 
2. (used especially of clothes) marked by conspicuous display (= gaudy, jazzy, showy, sporty)
""",
  );

  final String keyword = "flashy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I just want a good reliable car, nothing flashy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flashy""",
                      // alsoEnglishWord: "also: flashy",
                      britshText: """IpaUK: /ˈflæʃi/""",
                      americanText: """IpaUS: /ˈflæʃi/""",
...
// With short examples define "flashy", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە سەرنج ڕادەکێشێت بەوەی گەورە، درەوشاوە، گران‌بەها، هتد ـە"""),
                    SentencesRow(
                      englishText:
                          """I just want a good reliable car, nothing flashy.""",
                      kurdishText:
                          """تەنها ئۆتۆمبێلێکی باشی پشتپێبەستراوم دەوێت، هیچی گران‌بەها نا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کەسێک کە سەرنج ڕادەکێشێت بە لەبەرکردنی جلی گران‌بەها، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He was one of those flashy guys with too much money to throw around.""",
                      kurdishText:
                          """یەکێک بوو لەو پیاوانەی کە زۆر خۆنیشاندەر بوون و پارەی زیادیان هەبوو بۆ بەفیڕۆدان..""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/SEZu7K5tGxw?t=';
const double _startSecondsend = 000000000000000000000000000443;
const String _videoIdone = 'https://youtu.be/I8dQfQekmcs?t=';
const double _startSecondsone = 00000000000000000000000000065;
const String _videoIdtwo = 'https://youtu.be/apmF_FXcZKc?t=';
const double _startSecondstwo = 000000000000000000000000000114;
const String _videoIdthree = 'https://youtu.be/kUE2fPLOUxo?t=';
const double _startSecondsthree = 000000000000000000000000000475;
const String _videoIdfour = 'https://youtu.be/oHNRRGx-yOE?t=';
const double _startSecondsfour = 000000000000000000000000000366;
const String _videoIdfive = 'https://youtu.be/jGEYGevx13s?t=';
