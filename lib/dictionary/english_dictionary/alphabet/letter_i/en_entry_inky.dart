...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'bTYV7aFC6KE';
    const double startSecondsend = 137;
    const String videoIdone = 'NQZ5BfdjDv0';
    const double startSecondsone = 817;
    const String videoIdtwo = 'E2rtQFAibEA';
    const double startSecondstwo = 10306;
    const String videoIdthree = 'pVXXtZtZ6Gs';
    const double startSecondsthree = 17;
    const String videoIdfour = 'M5Vrar4w_CU';
    const double startSecondsfour = 115;
    const String videoIdfive = 'KbkNGjfgqJU';
    const double startSecondsfive = 467;
