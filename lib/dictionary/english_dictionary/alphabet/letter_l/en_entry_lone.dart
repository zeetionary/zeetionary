...
class EnglishEntrylone extends StatefulWidget {
  const EnglishEntrylone({super.key});

  @override
  State<EnglishEntrylone> createState() => _EnglishEntryloneState();
}

class _EnglishEntryloneState extends State<EnglishEntrylone> {
  @override
  void initState() {
    super.initState();
