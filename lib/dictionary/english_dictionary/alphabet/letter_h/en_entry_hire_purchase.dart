...
class EnglishEntryhirepurchase extends StatefulWidget {
  const EnglishEntryhirepurchase({super.key});

  @override
  State<EnglishEntryhirepurchase> createState() => _EnglishEntryhirepurchaseState();
}

class _EnglishEntryhirepurchaseState extends State<EnglishEntryhirepurchase> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hire purchase (Derived forms: hire purchases)
Usage: Brit
1. Instalment plan (- never-never [Brit, informal])
""",
  );

  final String keyword = "hire purchase";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hire purchase""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I bought my first car on hire purchase.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    // 188888880002200
    const String videoIdend = 'https://youtu.be/IOJHZN9vXeQ?t=';
    const double startSecondsend = 000000000000000000000000000545;
    const String videoIdone = 'https://youtu.be/KAUkJloVDXQ?t=';
    const double startSecondsone = 000000000000000000000000000220;
    const String videoIdtwo = 'https://youtu.be/07o0R-Pw-sA?t=';
    const double startSecondstwo = 000000000000000000000000000132;
    const String videoIdthree = 'https://youtu.be/QkjxkKYrEyE?t=';
    const double startSecondsthree = 000000000000000000000000000317;
    const String videoIdfour = 'https://youtu.be/4CF7I_aROT4?t=';
    const double startSecondsfour = 000000000000000000000000000847;
    const String videoIdfive = 'https://youtu.be/ia6x8ctyDjc?t=';
    const double startSecondsfive = 0000000000000000000000000002494;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hire purchase""",
                      // alsoEnglishWord: "also: hire purchase",
                      britshText: """IpaUK: /ˌhaɪə ˈpɜːtʃəs/""",
                      americanText: """IpaUS: /ˌhaɪər ˈpɜːrtʃəs/""",
...
// With short examples define "hire purchase", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) شێوازی کڕینی شتێک کە سەرەتا پێشەکییەک دەدەیت و دواتر بە بەش بەش ئەوی دیکەی دەدەیت"""),
                    SentencesRow(
                      englishText: """I bought my first car on hire purchase.""",
                      kurdishText: """یەکەم ئۆتۆمبێلمم بە قیست کڕی.""",
