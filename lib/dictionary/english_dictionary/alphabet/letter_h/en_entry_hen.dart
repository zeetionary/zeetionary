...
class EnglishEntryhen extends StatefulWidget {
  const EnglishEntryhen({super.key});

  @override
  State<EnglishEntryhen> createState() => _EnglishEntryhenState();
}

class _EnglishEntryhenState extends State<EnglishEntryhen> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hen (Derived forms: hens)
1. Adult female chicken (- biddy)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I could hear the hens clucking in the farmyard.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""My hens have stopped laying.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hen laid three beautiful eggs.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hens pecked hopefully at the dusty floor.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The duck hen guided her ducklings to the pond.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hen""",
                      // alsoEnglishWord: "also: hen",
                      britshText: """IpaUK: /hen/""",
                      americanText: """IpaUS: /hen/""",
...
کوردی: مریشک، کاڕگە، کەڕک، کەڕگی، مر، مامر
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """گوێم لە مریشکەکان بوو گارەگاریان دەهات لە حەوشەی کێڵگەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """مریشکەکانم لە هێلکەکردن وەستاون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """مریشکەکە سێ هێلکەی جوانی کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """مریشکەکان بە هیواوە دەنووکیان لە زەوییە تۆزاوییەکە دەدا.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) باڵندەیەکی مێینە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The duck hen guided her ducklings to the pond.""",
                      kurdishText:
                          """قازە مێینەکە ڕێنوێنی بەچکەکانی کرد بۆ زۆنگاوەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/JTCsL26vob4';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/dGplrNa-NZk';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/alUbqnWGd_4?t=';
const double _startSecondstwo = 00000000000000000000000000032;
const String _videoIdthree = 'https://youtu.be/dWVM_ITtmXo?t=';
const double _startSecondsthree = 00000000000000000000000000097;
const String _videoIdfour = 'https://youtu.be/f66r1yTK-KE?t=';
const double _startSecondsfour = 00000000000000000000000000024;
const String _videoIdfive = 'https://youtu.be/WE6pvUbeaxg';
