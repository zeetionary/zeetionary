...
// replace these: replace EnglishEntryanew - replace speakAnew - replace anew - /əˈnjuː/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryanew extends StatelessWidget {
  EnglishEntryanew({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAnew(String languageCode) async {
    // DOPSUM: CHANGE speakAnew
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("anew"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAnew407(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("They started life anew in Canada."); // DOPSUM: CHANGE TEXT
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "anew"), // Find /əˈnjuː/
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /əˈnjuː/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                            CustomIconButtonBritish(
                              onPressed: () => speakAnew("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /əˈnuː/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                            CustomIconButtonAmerican(
                              onPressed: () => speakAnew("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "78YTubJnttg";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "5krBzh1hJWg";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "bSWvQw8MX0o";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "KVKEifWrwn4";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "j734gLbQFbU";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "pQPL3H5rrsw";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "cC6zxh4MFBI";
