...
class EnglishEntryfestivity extends StatefulWidget {
  const EnglishEntryfestivity({super.key});

  @override
  State<EnglishEntryfestivity> createState() => _EnglishEntryfestivityState();
}

class _EnglishEntryfestivityState extends State<EnglishEntryfestivity> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "festivity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""festivity""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The wedding was an occasion of great festivity.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """festivity""",
                      // alsoEnglishWord: "also: festivity",
                      britshText: """IpaUK: /feˈstɪvəti/""",
                      americanText: """IpaUS: /feˈstɪvəti/""",
...
const String _videoIdend = 'https://youtu.be/o_L_NlRExOw?t=';
const double _startSecondsend = 000000000000000000000000000637;
const String _videoIdone = 'https://youtu.be/sTG1MQdlNRY?t=';
const double _startSecondsone = 000000000000000000000000000102;
const String _videoIdtwo = 'https://youtu.be/5odneOsxNTw?t=';
const double _startSecondstwo = 0000000000000000000000000001436;
const String _videoIdthree = 'https://youtu.be/yEs933aETJU?t=';
const double _startSecondsthree = 000000000000000000000000000491;
const String _videoIdfour = 'https://youtu.be/jGmiw0e9IeE?t=';
const double _startSecondsfour = 0000000000000000000000000001143;
const String _videoIdfive = 'https://youtu.be/3-yfZn5iYJE?t=';
const double _startSecondsfive = 0000000000000000000000000001046;
