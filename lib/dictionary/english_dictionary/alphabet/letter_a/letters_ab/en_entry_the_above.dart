...
// replace these: EnglishEntrytheabove - speakTheabove - the above - /ði əˈbʌv/

enum TtsState { playing }

class EnglishEntrytheabove extends StatelessWidget {
  EnglishEntrytheabove({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakTheabove(String languageCode) async {
    // DOPSUM: CHANGE speakTheabove
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'the above', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ði əˈbʌv/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakTheabove(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
