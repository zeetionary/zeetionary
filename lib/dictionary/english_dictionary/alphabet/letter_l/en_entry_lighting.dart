...
class EnglishEntrylighting extends StatefulWidget {
  const EnglishEntrylighting({super.key});

  @override
  State<EnglishEntrylighting> createState() => _EnglishEntrylightingState();
}

class _EnglishEntrylightingState extends State<EnglishEntrylighting> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lighting (Derived forms: lightings)
1. The quality or amount of light; the effect and arrangement of lights (- light, illumination)
...
4. The act of setting something on fire (- ignition, firing, kindling, inflammation)
""",
  );

  final String keyword = "lighting";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lighting""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The building needs improved security and lighting.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The generator supplies emergency lighting.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/55XJ1ObZKaM?t=376';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/a3WnvDtDD2M?t=8';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/HDntl7yzzVI?t=1157';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/dtp6b76pMak?t=703';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/AF8d72mA41M?t=40';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/737Xp2J2KSs?t=767';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lighting""",
                      // alsoEnglishWord: "also: lighting",
                      britshText: """IpaUK: /ˈlaɪtɪŋ/""",
                      americanText: """IpaUS: /ˈlaɪtɪŋ/""",
...
کوردی: داگیرساندن، هەڵکردن، دایساندن،	ڕووناک‌کردن، ڕۆشن‌کردن، ڕووناکی، ڕووناهی،	برووسکە، چەخماخە، چرف، تەشبریق
"""),
// With short examples define "lighting", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) شێوەی ڕێکخستنی ڕووناکی لە شوێنێکدا"""),
                    SentencesRow(
                      englishText: """The building needs improved security and lighting.""",
                      kurdishText: """بیناکە پێویستی بە ئاسایشی باشتر و ڕووناکی هەیە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) بەکارهێنانی ڕۆشنایی کارەبایی لە شوێنێکدا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The generator supplies emergency lighting.""",
                      kurdishText: """مۆلیدەکە ڕۆشنایی باری لەناکاو دابین دەکات.""",
