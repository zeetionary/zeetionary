...
class EnglishEntryincite extends StatefulWidget {
  const EnglishEntryincite({super.key});

  @override
  State<EnglishEntryincite> createState() => _EnglishEntryinciteState();
}

class _EnglishEntryinciteState extends State<EnglishEntryincite> {
  @override
  void initState() {
    super.initState();
