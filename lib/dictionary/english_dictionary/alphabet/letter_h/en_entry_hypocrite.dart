...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'rRymSi8SmqA';
    const double startSecondsend = 1388;
    const String videoIdone = 'Cccx1KKdIJ4';
    const double startSecondsone = 190;
    const String videoIdtwo = 'JR3z8lq2cNM';
    const double startSecondstwo = 78;
    const String videoIdthree = 'lknCE7fn7k8';
    const double startSecondsthree = 1463;
    const String videoIdfour = 'WwhyZUlmaWA';
    const double startSecondsfour = 3607;
    const String videoIdfive = 'Gfj5f0GVLZ0';
    const double startSecondsfive = 436;
