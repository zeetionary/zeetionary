...
class EnglishEntryknack extends StatefulWidget {
  const EnglishEntryknack({super.key});

  @override
  State<EnglishEntryknack> createState() => _EnglishEntryknackState();
}

class _EnglishEntryknackState extends State<EnglishEntryknack> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: knack (Derived forms: knacks)
1. A special way of doing something (- bent, hang)
"he had a special knack for getting into trouble";
""",
  );

  final String keyword = "knack";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It's easy, once you've got the knack.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He's got a real knack for making money.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She has the knack of always saying the wrong thing.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/-7bIDbaU_zQ?t=1410';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/qg2nGY1aqlg?t=455';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/b_rjBWmc1iQ?t=4623';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/mqxHzWJlqps?t=376';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/4wli0ULFIbk?t=366';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/1lTYPvArbGo?t=115';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """knack""",
                      // alsoEnglishWord: "also: knack",
                      britshText: """IpaUK: /næk/""",
                      americanText: """IpaUS: /næk/""",
...
کوردی: بار، ڕێگا، فێڵ، سوێ،	شارەزایی، لێهاتوویی، توانایی، بەهرە، زیرەکی، هونەر، سەلیقە
"""),
// With short examples define "knack", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) شارەزاییەک یان تواناییەکی تایبەت کە بە سرووشتی هەتە یان فێری دەبیت"""),
                    SentencesRow(
                      englishText: """It's easy, once you've got the knack.""",
                      kurdishText: """ئاسانە کە بەهرەکەیت هەبێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لێهاتوویی تەواوی هەیە بۆ پارە پەیداکردن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I don't cook much these days and I think I may have lost the knack.""",
                      kurdishText:
                          """ئەم ڕۆژانە خواردنی زۆر لێنانێم و پێموایە ڕەنگە شارەزاییەکەم لەدەست دابێت.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) خووی کردنی شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She has the knack of always saying the wrong thing.""",
                      kurdishText:
                          """ئەو خووەی هەبوو کە هەمیشە شتی هەڵە بڵێت.""",
