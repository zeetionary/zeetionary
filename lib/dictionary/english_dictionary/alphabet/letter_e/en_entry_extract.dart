...
class EnglishEntryextract extends StatefulWidget {
  const EnglishEntryextract({super.key});

  @override
  State<EnglishEntryextract> createState() => _EnglishEntryextractState();
}

class _EnglishEntryextractState extends State<EnglishEntryextract> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extract""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extract""",
                      // alsoEnglishWord: "also: extract",
                      britshText: """IpaUK: /ˈekstrækt/""",
                      americanText: """IpaUS: /ˈekstrækt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The following extract is taken from her new novel.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He read out a brief extract from his book.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Extract of olives is used for cooking.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Animals take in food and extract nutrients from it.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Journalists managed to extract all kinds of information about her private life.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This article is extracted from his new book.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The tooth was eventually extracted.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The dentist may decide that the wisdom teeth need to be extracted.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I tried extracting the rusty nails with a hammer.""");
  }
...
"""),
          const DefinitionKurdish(text: """١. (ناو) بەشێکی بچووکی کتێبێک، میوزیکێک، هتد کە تێگەشتنێکت پێ دەدات کە هەمووی چۆنە"""),
          SentencesRow(
            englishText:
                """The following extract is taken from her new novel.""",
            kurdishText: """ئەم پارچەی دواتر لە ڕۆمانە تازەکەی وەرگیردراوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He read out a brief extract from his book.""",
            kurdishText: """پارچەیەکی کورتی لە کتێبەکەی بە دەنگی بەرز خوێندەوە""",
            onPressedBritish: () => speaksentence2("en-GB"),
            onPressedAmerican: () => speaksentence2("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """٢. (ناو) مادەیەک کە لە شتێکی دیکە بە پڕۆسەی تایبەت وەرگیراوە"""),
          const DividerSentences(),
          SentencesRow(
          ...
          const DividerDefinition(),
          const DefinitionKurdish(text: """٣. (کردار) دەرکردنی شتێک لە شتێکی دیکە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Animals take in food and extract nutrients from it.""",
            kurdishText: """ئاژەڵەکان خواردن دەخۆن و مادە خۆراکییەکانی دەردەکەن.""",
            onPressedBritish: () => speaksentence4("en-GB"),
            onPressedAmerican: () => speaksentence4("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """٤. (کردار) بەدەستهێنانی زانیاری، پارە، هتد، زۆرجار بە وەرگرتنی لە کەسێک کە ئامادە نییە بیدات"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Journalists managed to extract all kinds of information about her private life.""",
            kurdishText: """ڕۆژنامەنووسان توانیان هەموو جۆرە زانیارییەکیان لەسەر ژیانی تایبەتیی دەست بکەوێت.""",
            onPressedBritish: () => speaksentence5("en-GB"),
            onPressedAmerican: () => speaksentence5("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """٥. (کردار) هەڵبژاردنی زانیاری، هتد لە کتێب، کۆمپیوتەر، هتد بۆ ئەوەی بۆ مەبەستێکی دیاریکراو بەکاربێت"""),
          const DividerSentences(),
          SentencesRow(
          ...
          const DividerDefinition(),
          const DefinitionKurdish(text: """٦. (کردار) دەرکردن یان ڕاکێشانی شتێک بۆ دەرەوە، بەتایبەتی کە پێویستی بە هێزە"""),
          const DividerSentences(),
          SentencesRow(
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The dentist may decide that the wisdom teeth need to be extracted.""",
            kurdishText: """پزیشکانی ددان ڕەنگە بڕیار بدەن کە ددانی ژیری پێویستە هەڵبکێشرێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I tried extracting the rusty nails with a hammer.""",
            kurdishText: """هەوڵم دا بزمارە ژەنگگرتووەکان بە چەکوشێک دەربکەم.""",
...
3. Deduce (a principle) or construe (a meaning) (= educe [formal], evoke, elicit, draw out)
"We extracted some interesting linguistic data from the native informant";
 
4. (chemistry) purify or isolate using distillation (= distill [N. Amer], distil [Brit])
"extract the essence of this compound";
 
5. (mining) separate (a metal) from an ore
 
6. Obtain from a substance, as by mechanical action (= press out, express)
"Italians extract coffee rather than filter it";
 
7. Take out of a literary work in order to cite or copy (= excerpt, take out)
...
const double _startSecondstwo = 0000000000000000000000000001375;
...
const double _startSecondsfour = 000000000000000000000000000648;
const String _videoIdfive = 'https://youtu.be/XMCZEJVlyRY?t=';
