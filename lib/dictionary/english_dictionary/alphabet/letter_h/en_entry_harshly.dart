...
class EnglishEntryharshly extends StatefulWidget {
  const EnglishEntryharshly({super.key});

  @override
  State<EnglishEntryharshly> createState() => _EnglishEntryharshlyState();
}

class _EnglishEntryharshlyState extends State<EnglishEntryharshly> {
  @override
  void initState() {
    super.initState();
...
2. In a harsh and grating manner (- gratingly, raspingly)
"her voice fell harshly on our ears";
""",
  );

  final String keyword = "harshly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""harshly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was treated very harshly.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The room was harshly lit.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The bell sounded, ringing harshly in the quiet classroom.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The shovel scraped harshly over the floor.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harshly""",
                      // alsoEnglishWord: "also: harshly",
                      britshText: """IpaUK: /ˈhɑːʃli/""",
                      americanText: """IpaUS: /ˈhɑːrʃli/""",
...
کوردی: بە سەختی، بە قورسی
"""),
// With short examples define "harshly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بەشێوەیەک کە توند و نامیهرەبانانەیە"""),
                    SentencesRow(
                      englishText: """She was treated very harshly.""",
                      kurdishText: """زۆر بە توندی مامەڵەی لەگەڵ کرا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """His findings have been harshly criticized by fellow scientists.""",
                      kurdishText:
                          """دۆزینەوەکانی بە توندی ڕەخنەیان لێگیراوە لەلایەن زانا هاوکارەکانی.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بەشێوەیەک کە زۆر بەهێز و ڕۆشنە"""),
                    SentencesRow(
                      englishText: """The room was harshly lit.""",
                      kurdishText: """ژوورەکە بە توندی ڕۆشن کرابوویەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵکار) بە شێوەیەک کە ناخۆشە بۆ گوێگرتن لێی"""),
                    SentencesRow(
                      englishText:
                          """The bell sounded, ringing harshly in the quiet classroom.""",
                      kurdishText:
                          """زەنگەکە لێی دا، بە توندی دەنگی دەهات لە پۆلە بێ‌دەنگەکەدا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ھاوەڵکار) بە شێوەیەک کە زۆر بەهێزە کە دەکرێت زیانبەخش بێت"""),
                    SentencesRow(
                      englishText:
                          """The shovel scraped harshly over the floor.""",
                      kurdishText: """بێڵەکە بە توندی بە زەوییەکەدا دەکیڕا.""",
...
const String _videoIdone = 'https://youtu.be/TJvHHgGerJg?t=';
const double _startSecondsone = 000000000000000000000000000675;
const String _videoIdtwo = 'https://youtu.be/hS2emKDlGmE?t=';
const double _startSecondstwo = 0000000000000000000000000002114;
const String _videoIdthree = 'https://youtu.be/kWfy87P__v0?t=';
const double _startSecondsthree = 0000000000000000000000000002537;
const String _videoIdfour = 'https://youtu.be/WZ256UU8xJ0?t=';
const double _startSecondsfour = 000000000000000000000000000250;
const String _videoIdfive = 'https://youtu.be/k-dqIhxKYhU?t=';
