...
class EnglishEntryfearful extends StatefulWidget {
  const EnglishEntryfearful({super.key});

  @override
  State<EnglishEntryfearful> createState() => _EnglishEntryfearfulState();
}

class _EnglishEntryfearfulState extends State<EnglishEntryfearful> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fearful""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fearful""",
                      // alsoEnglishWord: "also: fearful",
                      britshText: """IpaUK: /ˈfɪəfl/""",
                      americanText: """IpaUS: /ˈfɪrfl/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Parents are ever fearful for their children.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was fearful that she would fail.""");
  }
...
کوردی: ترسناک، ترسێنەر، پڕترس، تۆقێنەر، ترسەنۆک، ترس‌لێ‌نیشتوو، نگەران، نیگەران
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) شڵەژاو و ترساو"""),
          SentencesRow(
            englishText:
                """Parents are ever fearful for their children.""",
            kurdishText: """دایبابان هەمیشە ترس‌لێ‌نیشتوون بۆ منداڵەکانیان.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She was fearful that she would fail.""",
            kurdishText: """دەترسا لەوەی بکەوێت.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ئەو شەوە مشتومڕێکی زۆر خراپیان هەبوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fearful
1. Lacking courage; ignobly timid and faint-hearted (= cowardly)
"fearful dogs, ye will not aid me then";
 
2. Experiencing or showing fear
"a fearful glance"; "fearful of criticism"
 
3. Causing fear, dread or terror (= awful, dire, direful, dread, dreaded, dreadful, fearsome, frightening, horrendous, horrific, terrible)
"a fearful howling";
 
4. Extremely distressing (= frightful)
"fearful slum conditions";
 
5. Timid by nature or revealing timidity (= timorous, trepid)
...
const double _startSecondsend = 000000000000000000000000000350;
const String _videoIdone = 'https://youtu.be/9K_CZizKdVs?t=';
const double _startSecondsone = 000000000000000000000000000475;
const String _videoIdtwo = 'https://youtu.be/OZ_xhkg32nk?t=';
const double _startSecondstwo = 000000000000000000000000000261;
const String _videoIdthree = 'https://youtu.be/1JlqrXqKKRs?t=';
const double _startSecondsthree = 00000000000000000000000000043;
const String _videoIdfour = 'https://youtu.be/wJa5Ch0O4BI?t=';
const double _startSecondsfour = 000000000000000000000000000671;
const String _videoIdfive = 'https://youtu.be/mW-C7WE1xOs?t=';
const double _startSecondsfive = 000000000000000000000000000252;
