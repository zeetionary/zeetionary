...
class EnglishEntrylogically extends StatefulWidget {
  const EnglishEntrylogically({super.key});

  @override
  State<EnglishEntrylogically> createState() => _EnglishEntrylogicallyState();
}

class _EnglishEntrylogicallyState extends State<EnglishEntrylogically> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""logically""");
  }
