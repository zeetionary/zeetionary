...
class EnglishEntryilliteracy extends StatefulWidget {
  const EnglishEntryilliteracy({super.key});

  @override
  State<EnglishEntryilliteracy> createState() => _EnglishEntryilliteracyState();
}

class _EnglishEntryilliteracyState extends State<EnglishEntryilliteracy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: illiteracy (Derived forms: illiteracies)
1. Ignorance resulting from not reading
 
2. An inability to read (- analphabetism)
""",
  );

  final String keyword = "illiteracy";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""illiteracy""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The government has declared war on illiteracy.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""My scientific illiteracy was about to be exposed.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000348;
    const String videoIdone = 'https://youtu.be/AMg4ooa0U-U?t=';
    const double startSecondsone = 000000000000000000000000000500;
    const String videoIdtwo = 'https://youtu.be/7LFkN7QGp2c?t=';
    const double startSecondstwo = 000000000000000000000000000388;
    const String videoIdthree = 'https://youtu.be/uuXlIbd50DQ?t=';
    const double startSecondsthree = 0000000000000000000000000001469;
    const String videoIdfour = 'https://youtu.be/iaKkZJAoqCA?t=';
    const double startSecondsfour = 000000000000000000000000000355;
    const String videoIdfive = 'https://youtu.be/AHeq99pojLo?t=';
    const double startSecondsfive = 000000000000000000000000000713;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """illiteracy""",
                      // alsoEnglishWord: "also: illiteracy",
                      britshText: """IpaUK: /ɪˈlɪtərəsi/""",
                      americanText: """IpaUS: /ɪˈlɪtərəsi/""",
...
کوردی: 
"""),
// With short examples define "illiteracy", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە توانای خوێندنەوە یان نووسینت نەبێت"""),
                    SentencesRow(
                      englishText:
                          """The illiteracy rate on the island is still unacceptably high.""",
                      kurdishText:
                          """ڕێژەی نەخوێندەواری لەسەر ئەم دوورگەیە تا ئێستا بە پەسەندنەکراوانە بەرزە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          "حکومەت جەنگی دژ بە نەخوێندەواری ڕاگەیاندووە.",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) هەبوونی زانیاریی کەم لەسەر بابەتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """My scientific illiteracy was about to be exposed.""",
                      kurdishText: """نەزانیی زانستیم خەریک بوو دەربکەوێت.""",
