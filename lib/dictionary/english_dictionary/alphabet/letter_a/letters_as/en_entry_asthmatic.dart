...
// Define the word "asthmatic" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryasthmatic - replace speakAsthmatic

// replace asthmatic - /æsˈmætɪk/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryasthmatic extends StatelessWidget {
  // blank divider
  EnglishEntryasthmatic({super.key});
  // blank divider
  ...
  Future<void> speakasthmatic(String languageCode) async {
    ...
    await flutterTts.speak("asthmatic");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "asthmatic"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'JYJq02OTdSs';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'Uhgn8sYw8gg';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'BlgTQN-esjM';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'Irgq_VgMqao';
