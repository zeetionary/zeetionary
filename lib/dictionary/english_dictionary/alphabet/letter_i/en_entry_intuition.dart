...
class EnglishEntryintuition extends StatefulWidget {
  const EnglishEntryintuition({super.key});

  @override
  State<EnglishEntryintuition> createState() => _EnglishEntryintuitionState();
}

class _EnglishEntryintuitionState extends State<EnglishEntryintuition> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intuition""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1967;
    const String videoIdone = 'UuGpm01SPcA';
    const double startSecondsone = 82;
    const String videoIdtwo = '-7bIDbaU_zQ';
    const double startSecondstwo = 908;
    const String videoIdthree = 'DxL2HoqLbyA';
    const double startSecondsthree = 1602;
    const String videoIdfour = 'GVsUOuSjvcg';
    const double startSecondsfour = 1256;
