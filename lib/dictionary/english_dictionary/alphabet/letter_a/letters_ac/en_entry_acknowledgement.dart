...
class EnglishEntryacknowledgment extends StatefulWidget {
...
// 188888880002200
  ...
  final String keyword = "acknowledgment";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acknowledgment""",
                      // alsoEnglishWord: "also: acknowledgment",
                      britshText: """IpaUK: /əkˈnɒlɪdʒmənt/""",
                      americanText: """IpaUS: /əkˈnɑːlɪdʒmənt/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final double _startSeconds = 5212;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final double _startSeconds = 9647;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'f_U-hMer1cE';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'STAafnlUtDc';
