...
class EnglishEntrygrass extends StatefulWidget {
  const EnglishEntrygrass({super.key});

  @override
  State<EnglishEntrygrass> createState() => _EnglishEntrygrassState();
}

class _EnglishEntrygrassState extends State<EnglishEntrygrass> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grass (Derived forms: grasses)
1. Narrow-leaved green herbage: grown as lawns; used as pasture for grazing animals; cut and dried as hay
 
2. Bulky food like grass or hay for browsing or grazing horses or cattle (- eatage [dialect], forage, pasture, pasturage, grazing)
 
3. [slang] A street name for marijuana (- pot [slang], green goddess [slang], dope [slang], weed [slang], gage [slang], sess [slang], sens [slang], smoke [slang], skunk [slang], locoweed [N. Amer, slang], Mary Jane [slang])
 
4. [Brit, informal] Someone acting as an informer or decoy for the police (- fink [N. Amer, informal], snitch [informal], snitcher [informal], stoolpigeon [informal], stool pigeon [informal], stoolie [N. Amer, informal], sneak [informal], canary [N. Amer], snout [Brit, informal])
 
5. [Brit, informal] Someone who reports another person's wrongdoings to someone in authority (- telltale [Brit, informal], snitch [informal], tattletale [US, informal], talebearer [archaic], rat [informal], squealer [informal])
"I told the teacher that I'm not a grass and didn't want to get involved";
 
6. [Brit] A police informer who implicates many people (- supergrass [Brit, informal])

- Verb: grass (Derived forms: grassing, grasses, grassed)
1. Shoot down, of birds
 
2. Completely cover with grass (- grass over)
...
5. Give away information about somebody (- denounce, tell on, betray, give away, rat [informal], shop [informal], snitch [informal], stag, squeak [informal])

- Noun: Grass
1. German writer of novels and poetry and plays (born 1927) (- Gunter Grass, Gunter Wilhelm Grass)
""",
  );

  final String keyword = "grass";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The dry grass caught fire.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I sowed a little bag of grass seed.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The dog came running through the long grass.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Don't walk on the grass.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Keep off the grass.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We all sat down on the grass.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Who grassed on us?""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You can count on Sam not to grass.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grass""",
                      // alsoEnglishWord: "also: grass",
                      britshText: """IpaUK: /ɡrɑːs/""",
                      americanText: """IpaUS: /ɡræs/""",
...
// With short examples define "grass", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕووەکێکی باوی دەشتەکی کە گەڵای باریکی هەیە و قەدەکەی مانگا، ئەسپ، مەڕ، هتد دەخورێت؛ هەر جۆرە گیایەکی وەها"""),
                    SentencesRow(
                      englishText: """The dry grass caught fire.""",
                      kurdishText: """گژووگیا وشکەکە ئاگری گرت.""",
                    ...
                    SentencesRow(
                      englishText: """I sowed a little bag of grass seed.""",
                      kurdishText: """جانتایەکی بچووک لە تۆوی گژووگیام چاند.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سەگەکە بە ڕاکردن بە سەوزەگیا درێژەکەدا هات.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Keep off the grass. (= on a sign)""",
                      kurdishText: """مەیە سەر چیمەنەکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We all sat down on the grass.""",
                      kurdishText: """هەموان لەسەر چیمەنەکە دانیشتین.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) هەوڵدان بە پۆلیس سەبارەت بە تاوانی کەسێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Who grassed on us?""",
                      kurdishText: """کێ هەواڵی لێ داین؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """You can count on Sam not to grass.""",
                      kurdishText:
                          """ناتوانیت پشت بە سام ببەستیت کە هەواڵت لێ نەدات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/HUsIcK1a4B0?t=';
const double _startSecondsend = 000000000000000000000000000271;
const String _videoIdone = 'https://youtu.be/-GlJFVTzEsI?t=';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/CTbswd1Q3-o?t=';
const double _startSecondstwo = 0000000000000000000000000003;
const String _videoIdthree = 'https://youtu.be/SEh2Ob5djLQ?t=';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/oqWXAcdWGS0?t=';
const double _startSecondsfour = 00000000000000000000000000014;
const String _videoIdfive = 'https://youtu.be/cibOtoYn6d0?t=';
