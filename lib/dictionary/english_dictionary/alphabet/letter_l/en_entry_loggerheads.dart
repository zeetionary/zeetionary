...
class EnglishEntryloggerheads extends StatefulWidget {
  const EnglishEntryloggerheads({super.key});

  @override
  State<EnglishEntryloggerheads> createState() => _EnglishEntryloggerheadsState();
}

class _EnglishEntryloggerheadsState extends State<EnglishEntryloggerheads> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryloggerheads loggerheads
WORD_WEB loggerheads loggerheads loggerheads
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "loggerheads";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""loggerheads""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """loggerheads""",
                      // alsoEnglishWord: "also: loggerheads",
...
کوردی: 
"""),
// With short examples define "loggerheads", please follow LX instructions
