...
class EnglishEntryintelligibly extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intelligibly""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'NEMpcTxcMPE';
    const double startSecondsend = 298;
    const String videoIdone = '_FRXE1L_PbI';
    const double startSecondsone = 711;
    const String videoIdtwo = 'DNYAZe_u6v4';
    const double startSecondstwo = 175;
    const String videoIdthree = 'LadYxRUJvY4';
    const double startSecondsthree = 677;
    const String videoIdfour = 'q-ZaD2JBcAE';
    const double startSecondsfour = 580;
    const String videoIdfive = 'xsG8Xpr3cZI';
    const double startSecondsfive = 795;
