...
class EnglishEntryavow extends StatelessWidget {
  ...
  Future<void> speakavows2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvows22");
  }
  ...
  Future<void> speakavows3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvows33");
  }
  ...
  Future<void> speakavows4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvows44");
  }
  ...
  Future<void> speakavows5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvows55");
  }
  ...
  Future<void> speakavows6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvows66");
  }
  ...
  Future<void> speakavows7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvows77");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "avow"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈvaʊ/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakavow("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈvaʊ/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakavow("en-US"),
                            ),
                          ],
                        ),
                      ],
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakavows1("en-US"),
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'znehkLEafTU';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'BKiGrPsbtA8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '_hxjlRpkM1M';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '76ma3D0iNJ8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'x0r5uYT10bg';
  final double _startSeconds = 2059;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'ITk_DwjtIpY';
  final double _startSeconds = 1310;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'QnsmuPW9qTY';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = '4oY5GfhZkfA';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = '3WOSFPCQlaI';
  final double _startSeconds = 1866;
