...
// replace EnglishEntryAdopsum - replace speakAperitif

// replace aperitif - /əˌperəˈtiːf/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryaperitif extends StatelessWidget {
  // blank divider
  EnglishEntryaperitif({super.key});
  // blank divider
  ...
  Future<void> speakaperitif(String languageCode) async {
    ...
    await flutterTts.speak("aperitif");
  }
  ...
  Future<void> speakaperitif144(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("This vermouth is a delicious aperitif.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "aperitif"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˌperəˈtiːf/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˌperəˈtiːf/"),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'PbQyevYlLAY';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'kfe9hmwjOVQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'eWg3D1SW3SI';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'evGHr3mMlmo';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'YRA_sJru4p0';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '7Z_mZ6wq1Rw';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'rnrDI5d4Cxg';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'ntd_Y2eywc4';
