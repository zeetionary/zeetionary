...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000521;
    const String videoIdone = 'https://youtu.be/dtp6b76pMak?t=';
    const double startSecondsone = 0000000000000000000000000001554;
    const String videoIdtwo = 'https://youtu.be/LoqwZBkYWqE?t=';
    const double startSecondstwo = 00000000000000000000000000096;
    const String videoIdthree = 'https://youtu.be/TRGHIN2PGIA?t=';
    const double startSecondsthree = 000000000000000000000000000900;
    const String videoIdfour = 'https://youtu.be/9yjZpBq1XBE?t=';
    const double startSecondsfour = 0000000000000000000000000006023;
