...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/nGrB-5ieeMU?t=';
    const double startSecondsend = 000000000000000000000000000333;
    const String videoIdone = 'https://youtu.be/Mp11EzxCOG4?t=';
    const double startSecondsone = 000000000000000000000000000188;
    const String videoIdtwo = 'https://youtu.be/G0SpzIIHEaE?t=';
    const double startSecondstwo = 00000000000000000000000000083;
    const String videoIdthree = 'https://youtu.be/Lp5uh6ztGJo?t=';
    const double startSecondsthree = 000000000000000000000000000501;
    const String videoIdfour = 'https://youtu.be/H1KP4ztKK0A?t=';
    const double startSecondsfour = 000000000000000000000000000195;
    const String videoIdfive = 'https://youtu.be/3SJr44m-w1Y?t=';
