...
class EnglishEntryfigurehead extends StatefulWidget {
  const EnglishEntryfigurehead({super.key});

  @override
  State<EnglishEntryfigurehead> createState() => _EnglishEntryfigureheadState();
}

class _EnglishEntryfigureheadState extends State<EnglishEntryfigurehead> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""figurehead""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The president of the club is not just a figurehead.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """figurehead""",
                      // alsoEnglishWord: "also: figurehead",
                      britshText: """IpaUK: /ˈfɪɡəhed/""",
                      americanText: """IpaUS: /ˈfɪɡjərhed/""",
...
const double _startSecondsone = 000000000000000000000000000769;
const String _videoIdtwo = 'https://youtu.be/7WXQbKjr3gY?t=';
const double _startSecondstwo = 000000000000000000000000000164;
const String _videoIdthree = 'https://youtu.be/u7Wja0rdc-U?t=';
const double _startSecondsthree = 000000000000000000000000000575;
const String _videoIdfour = 'https://youtu.be/cxoAt2iB-js?t=';
const double _startSecondsfour = 000000000000000000000000000191;
const String _videoIdfive = 'https://youtu.be/x8Owr_sGIOs?t=';
const double _startSecondsfive = 0000000000000000000000000001004;
