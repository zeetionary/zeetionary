...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'Rux4d-32fUQ';
    const double startSecondsend = 3;
    const String videoIdone = '6ta_sftSfIw';
    const double startSecondsone = 43;
    const String videoIdtwo = 'GdPsgt_ySU4';
    const double startSecondstwo = 595;
    const String videoIdthree = 'FiRDpXMIkzU';
    const double startSecondsthree = 1073;
    const String videoIdfour = 'lVNV1qXnGb0';
    const double startSecondsfour = 204;
    const String videoIdfive = 'VdLQC2b5Wkg';
    const double startSecondsfive = 381;
