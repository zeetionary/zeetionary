...
class EnglishEntryfortnight extends StatefulWidget {
  const EnglishEntryfortnight({super.key});

  @override
  State<EnglishEntryfortnight> createState() => _EnglishEntryfortnightState();
}

class _EnglishEntryfortnightState extends State<EnglishEntryfortnight> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fortnight (Derived forms: fortnights)
Usage: Brit (N. Amer: two weeks)
1. A period of fourteen consecutive days (= two weeks)
"most major tennis tournaments last a fortnight";
""",
  );

  final String keyword = "fortnight";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fortnight""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""How much would it cost to hire a car for a fortnight?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We spent a fortnight in Rome looking at all the sights.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He's had three accidents in the past fortnight.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fortnight""",
                      // alsoEnglishWord: "also: fortnight",
                      britshText: """IpaUK: /ˈfɔːtnaɪt/""",
                      americanText: """IpaUS: /ˈfɔːrtnaɪt/""",
...
// With short examples define "fortnight", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) دوو هەفتە"""),
                    SentencesRow(
                      englishText:
                          """How much would it cost to hire a car for a fortnight?""",
                      kurdishText:
                          """چەند تێچووی دەبێت کە ئۆتۆمبێلێک بۆ دوو هەفتە بە کرێ بگریت؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دوو هەفتەمان لە ڕۆما بەسەر برد بە سەیرکردنی ئەو هەموو دیمەنە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سێ ڕووداوی هەبووبوو لە دو هەفتەی ڕابردوودا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/sLA3egyypiI?t=';
const double _startSecondsend = 000000000000000000000000000587;
const String _videoIdone = 'https://youtu.be/DGXf9LcPKWM?t=';
const double _startSecondsone = 0000000000000000000000000001929;
const String _videoIdtwo = 'https://youtu.be/eQcoXQaEXZ4?t=';
const double _startSecondstwo = 000000000000000000000000000502;
const String _videoIdthree = 'https://youtu.be/q_cT2zJehMk?t=';
const double _startSecondsthree = 000000000000000000000000000768;
const String _videoIdfour = 'https://youtu.be/iy-2t8mKzIY?t=';
const double _startSecondsfour = 000000000000000000000000000937;
const String _videoIdfive = 'https://youtu.be/QvyYd8jNZHY?t=';
