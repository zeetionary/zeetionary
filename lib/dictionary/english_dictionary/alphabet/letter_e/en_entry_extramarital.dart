...
class EnglishEntryextramarital extends StatefulWidget {
  const EnglishEntryextramarital({super.key});

  @override
  State<EnglishEntryextramarital> createState() =>
      _EnglishEntryextramaritalState();
}

class _EnglishEntryextramaritalState extends State<EnglishEntryextramarital> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extramarital""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extramarital""",
                      // alsoEnglishWord: "also: extramarital",
                      britshText: """IpaUK: /ˌekstrəˈmærɪtl/""",
                      americanText: """IpaUS: /ˌekstrəˈmærɪtl/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extramarital";
...
1. Characterized by adultery (= adulterous, extracurricular)
...
const String _videoIdend = 'https://youtu.be/Iv7PW4ZEFD4?t=';
const double _startSecondsend = 000000000000000000000000000822;
const String _videoIdone = 'https://youtu.be/35kg7Do_5R0?t=';
const double _startSecondsone = 000000000000000000000000000278;
const String _videoIdtwo = 'https://youtu.be/0gliG6L4_x0?t=';
const double _startSecondstwo = 000000000000000000000000000199;
const String _videoIdthree = 'https://youtu.be/Yl0m3pm5SCo?t=';
const double _startSecondsthree = 000000000000000000000000000421;
const String _videoIdfour = 'https://youtu.be/rt-wLbJuPo4?t=';
const double _startSecondsfour = 0000000000000000000000000001670;
const String _videoIdfive = 'https://youtu.be/_axaqyGbSmk?t=';
