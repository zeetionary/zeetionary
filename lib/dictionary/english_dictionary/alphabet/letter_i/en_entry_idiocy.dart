...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1799;
    const String videoIdone = 'apDoJkfR85A';
    const double startSecondsone = 240;
    const String videoIdtwo = '4_FHvf9typs';
    const double startSecondstwo = 380;
    const String videoIdthree = 'J-4FaTv1mcM';
    const double startSecondsthree = 471;
    const String videoIdfour = 'U_kx78rAlAk';
    const double startSecondsfour = 555;
    const String videoIdfive = '1X_KdkoGxSs';
    const double startSecondsfive = 9938;
