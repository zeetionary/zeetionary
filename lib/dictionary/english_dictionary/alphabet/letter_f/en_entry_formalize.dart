...
class EnglishEntryformalize extends StatefulWidget {
  const EnglishEntryformalize({super.key});

  @override
  State<EnglishEntryformalize> createState() => _EnglishEntryformalizeState();
}

class _EnglishEntryformalizeState extends State<EnglishEntryformalize> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: formalize (Derived forms: formalizes, formalized, formalizing)
1. Make formal or official (= formalise [Brit])
"We formalized the appointment and gave him a title";
 
2. Declare or make legally valid (= validate, formalise [Brit])
""",
  );

  final String keyword = "formalize";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""formalize""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The college has a highly formalized system of assessment.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """formalize""",
                      // alsoEnglishWord: "also: formalize",
                      britshText: """IpaUK: /ˈfɔːməlaɪz/""",
                      americanText: """IpaUS: /ˈfɔːrməlaɪz/""",
...
// With short examples define "formalize", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """They decided to formalize their relationship by getting married.""",
                      kurdishText:
                          """بڕیاریان دا کە پەیوەندییەکەیان بکەن بە فەرمی بەوەی هاوسەرگیری بکەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کۆلێژەکە سیستەمێکی تەواو ڕێکخراوی هەڵسەنگاندنی هەیە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/g7aa6KRD8Ug?t=';
const double _startSecondsend = 000000000000000000000000000115;
const String _videoIdone = 'https://youtu.be/-RdOwhmqP5s?t=';
const double _startSecondsone = 0000000000000000000000000001105;
const String _videoIdtwo = 'https://youtu.be/9goS1nHM_-E?t=';
const double _startSecondstwo = 0000000000000000000000000001250;
const String _videoIdthree = 'https://youtu.be/EiX3hTPGoCg?t=';
const double _startSecondsthree = 000000000000000000000000000609;
const String _videoIdfour = 'https://youtu.be/hYc97J2MZIo?t=';
const double _startSecondsfour = 000000000000000000000000000667;
const String _videoIdfive = 'https://youtu.be/cDofhN-RJqg?t=';
