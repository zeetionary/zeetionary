...
class EnglishEntryingratitude extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ingratitude""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'khR5UIEK_mE';
    const double startSecondsend = 5417;
    const String videoIdone = 'KG6tlxmL0gk';
    const double startSecondsone = 139;
    const String videoIdtwo = 'JHUKkGfY7IY';
    const double startSecondstwo = 2604;
    const String videoIdthree = 'AcdOWKiKgWU';
    const double startSecondsthree = 533;
    const String videoIdfour = 'NaJNFnXMC1A';
    const double startSecondsfour = 359;
    const String videoIdfive = 'ok0G-tBTJvs';
    const double startSecondsfive = 975;
