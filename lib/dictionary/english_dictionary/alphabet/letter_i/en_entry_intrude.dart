...
class EnglishEntryintrude extends StatefulWidget {
  const EnglishEntryintrude({super.key});

  @override
  State<EnglishEntryintrude> createState() => _EnglishEntryintrudeState();
}

class _EnglishEntryintrudeState extends State<EnglishEntryintrude> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: intrude (Derived forms: intruded, intruding, intrudes)
1. Enter uninvited (- irrupt)
"They intruded on our dinner party";
 
2. Enter unlawfully on someone's property (- trespass)
"Don't intrude on my land!";
 
3. Search or inquire in a meddlesome way (- horn in, pry, nose, poke)
"This guy is always intruding around the office";
 
4. Thrust oneself in as if by force (- obtrude)
"The colours don't intrude on the viewer";
""",
  );

  final String keyword = "intrude";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intrude""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I'm sorry to intrude, but I need to talk to someone.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We should not intrude upon their private grief.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The sound of the telephone intruded into his dreams.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/VxLrmkWHtu4?t=';
    const double startSecondsend = 000000000000000000000000000402;
    const String videoIdone = 'https://youtu.be/bUia-EbqS7A?t=';
    const double startSecondsone = 0000000000000000000000000001039;
    const String videoIdtwo = 'https://youtu.be/o3gfdG2gMGk?t=';
    const double startSecondstwo = 00000000000000000000000000097;
    const String videoIdthree = 'https://youtu.be/Solb9uA-tgQ?t=';
    const double startSecondsthree = 0000000000000000000000000001613;
    const String videoIdfour = 'https://youtu.be/nQ-Ua6NYago?t=';
    const double startSecondsfour = 000000000000000000000000000947;
    const String videoIdfive = 'https://youtu.be/PAptGxzuCZ8?t=';
    const double startSecondsfive = 000000000000000000000000000362;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """intrude""",
                      // alsoEnglishWord: "also: intrude",
                      britshText: """IpaUK: /ɪnˈtruːd/""",
                      americanText: """IpaUS: /ɪnˈtruːd/""",
...
کوردی: 
"""),
// With short examples define "intrude", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) چوونە شوێنێک یان بوون لە شوێنێک کە نابێت تێیدا بیت"""),
                    SentencesRow(
                      englishText:
                          """I'm sorry to intrude, but I need to talk to someone.""",
                      kurdishText:
                          """ببوورە کە لەپڕدا هاتم، بەڵام پێویستم بە قسەکردنە لەگەڵ کەسێک.""",
                      englishNote:
                          """This means you feel sorry for interrupting or bothering someone, but you really need to speak with them due to an important or urgent matter.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """نابێت تێکەڵ بە شیوەنی کەسییان ببین.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) چوونە ناو شتێک کە نابێت بچیت یان کە کاریگەرییەکی خراپی هەیە لەسەری"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The sound of the telephone intruded into his dreams.""",
                      kurdishText:
                          """دەنگی تەلەفۆنەکە تێکەڵ بە خەونەکانی دەبوو.""",
