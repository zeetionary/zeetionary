...
class EnglishEntryfirewood extends StatefulWidget {
  const EnglishEntryfirewood({super.key});

  @override
  State<EnglishEntryfirewood> createState() => _EnglishEntryfirewoodState();
}

class _EnglishEntryfirewoodState extends State<EnglishEntryfirewood> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: firewood (Derived forms: firewoods)
1. Wood used for fuel 
"they collected and cut their own firewood"
""",
  );

  final String keyword = "firewood";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""firewood""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We can use those old shelves as firewood.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """firewood""",
                      // alsoEnglishWord: "also: firewood",
                      britshText: """IpaUK: /ˈfaɪəwʊd/""",
                      americanText: """IpaUS: /ˈfaɪərwʊd/""",
...
کوردی: ئاوردوو، ئێزنگ، هێزم، قەڵاشکەری، ئەنجینە، هەژگەڵ، هەژگ‌وبژاڵ
"""),
// With short examples define "firewood", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) دار کە پارچەپارچە دەکرێت بۆ سوتاندن بەکاردێت"""),
                    SentencesRow(
                      englishText:
                          """We can use those old shelves as firewood.""",
                      kurdishText: """دەتوانین ئەو ڕەفە کۆنانە وەک ئێزنگ بەکاربهێنین.""",
...
const double _startSecondsend = 000000000000000000000000000112;
const String _videoIdone = 'https://youtu.be/ySOKrCusEjw?t=';
const double _startSecondsone = 0000000000000000000000000001657;
const String _videoIdtwo = 'https://youtu.be/CkM0QI3c3Yk?t=';
const double _startSecondstwo = 000000000000000000000000000114;
const String _videoIdthree = 'https://youtu.be/vtMWkWnaoq4?t=';
const double _startSecondsthree = 00000000000000000000000000068;
const String _videoIdfour = 'https://youtu.be/6a6RkJbWCos?t=';
const double _startSecondsfour = 000000000000000000000000000216;
const String _videoIdfive = 'https://youtu.be/gYz0Xel-upA?t=';
const double _startSecondsfive = 000000000000000000000000000245;
