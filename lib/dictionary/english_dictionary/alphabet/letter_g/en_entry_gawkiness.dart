...
class EnglishEntrygawkiness extends StatefulWidget {
  const EnglishEntrygawkiness({super.key});

  @override
  State<EnglishEntrygawkiness> createState() => _EnglishEntrygawkinessState();
}

class _EnglishEntrygawkinessState extends State<EnglishEntrygawkiness> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gawkiness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gawkiness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The gawkiness of his walk made others smile.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gawkiness""",
                      // alsoEnglishWord: "also: gawkiness",
                      britshText: """IpaUK: /ˈɡɔːkinəs/""",
                      americanText: """IpaUS: /ˈɡɔːkinəs/""",
...
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کەسێک بە ئاسانی و ئاسوودەیی نەتوانێت شێوازی بجوڵێت یان ڕەفتار بکات"""),
                    SentencesRow(
                      englishText:
                          """The gawkiness of his walk made others smile.""",
                      kurdishText:
                          """ناشارەزایی ڕۆیشتنەکەی وای کرد کەسانی تر بکەونە بزە.""",
...
const String _videoIdend = 'https://youtu.be/ucgT-6d3qvw?t=';
const double _startSecondsend = 000000000000000000000000000183;
const String _videoIdone = 'https://youtu.be/Qj5w7BimQJo?t=';
const double _startSecondsone = 0000000000000000000000000001077;
const String _videoIdtwo = 'https://youtu.be/BEPJXH-9L0A?t=';
const double _startSecondstwo = 000000000000000000000000000731;
const String _videoIdthree = 'https://youtu.be/8AmqZqeMs44?t=';
const double _startSecondsthree = 000000000000000000000000000315;
const String _videoIdfour = 'https://youtu.be/M5VF1P2-iZ0?t=';
const double _startSecondsfour = 0000000000000000000000000001606;
const String _videoIdfive = 'https://youtu.be/M5VF1P2-iZ0?t=';
const double _startSecondsfive = 0000000000000000000000000001606;
