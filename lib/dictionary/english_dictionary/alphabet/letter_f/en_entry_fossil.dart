...
class EnglishEntryfossil extends StatefulWidget {
  const EnglishEntryfossil({super.key});

  @override
  State<EnglishEntryfossil> createState() => _EnglishEntryfossilState();
}

class _EnglishEntryfossilState extends State<EnglishEntryfossil> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fossil (Derived forms: fossils)
...
2. Someone whose style is out of fashion (= dodo, fogy, fogey)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They discovered a dinosaur fossil in the excavation site.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The museum displayed fossils of ancient marine creatures.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fossil""",
                      // alsoEnglishWord: "also: fossil",
                      britshText: """IpaUK: /ˈfɒsl/""",
                      americanText: """IpaUS: /ˈfɑːsl/""",
...
کوردی: بەردبوو، بووبەرد، بەردەک، فوسیل،	(بە شۆخی) مرۆی بیرتەسک، مرۆی کۆنەپەرست، فوسیلی، بەردبوویی، بەردەکی
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بەشەکانی ئاژەڵێک یان ڕووەکێکی مردوو کە بووە بە بەرد"""),
                    SentencesRow(
                      englishText:
                          """They discovered a dinosaur fossil in the excavation site.""",
                      kurdishText:
                          """بەردبووی داینەسوورێکیان دۆزییەوە لە شوێنی هەڵکۆڵینەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The museum displayed fossils of ancient marine creatures.""",
                      kurdishText:
                          """مۆزەخانەکە بەردبووی گیانلەبەری ئاوی کۆنی نمایش کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/F6N5LqrWR_s?t=';
const double _startSecondsend = 00000000000000000000000000040;
const String _videoIdone = 'https://youtu.be/B4_aVspq1hY?t=';
const double _startSecondsone = 000000000000000000000000000176;
const String _videoIdtwo = 'https://youtu.be/y2jfh2RNK_s?t=';
const double _startSecondstwo = 00000000000000000000000000016;
const String _videoIdthree = 'https://youtu.be/H7WcRTPMcKo?t=';
const double _startSecondsthree = 00000000000000000000000000010;
const String _videoIdfour = 'https://youtu.be/bziQ6_THggE?t=';
const double _startSecondsfour = 0000000000000000000000000009;
const String _videoIdfive = 'https://youtu.be/XAbSPJDLnSE?t=';
