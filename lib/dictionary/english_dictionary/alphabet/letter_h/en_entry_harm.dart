...
class EnglishEntryharm extends StatefulWidget {
  const EnglishEntryharm({super.key});

  @override
  State<EnglishEntryharm> createState() => _EnglishEntryharmState();
}

class _EnglishEntryharmState extends State<EnglishEntryharm> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: harm (Derived forms: harms)
1. Any physical damage to the body caused by violence, accident or fracture etc.; the condition of an injury (- injury, hurt, trauma)
 
2. The occurrence of a change for the worse (- damage, impairment)
 
3. The act of damaging something or someone (- damage, hurt, scathe [archaic])

- Verb: harm (Derived forms: harmed, harms, harming)
1. Cause or do harm to
"These pills won't harm your system"
""",
  );

  final String keyword = "harm";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He would never frighten anyone or cause them any harm.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He may look fierce, but he means no harm.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""No definite harm to human health has been determined.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The court case will do serious harm to my business.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He would never harm anyone.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Pollution can harm marine life.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Rising oil prices could harm the global economy.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Misusing drugs in pregnancy can seriously harm your baby.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak(
        """Could the anti-nausea tablets she had been prescribed harm the foetus?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harm""",
                      // alsoEnglishWord: "also: harm",
                      britshText: """IpaUK: /hɑːm/""",
                      americanText: """IpaUS: /hɑːrm/""",
...
// With short examples define "harm", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کەیسەکەی دادگا زیانی توند دەگەیەنێت بە بازرگانییەکەم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Pollution can harm marine life.""",
                      kurdishText:
                          """پیسی دەکرێت زیان بە ژیانی دەریایی بگەیەنێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Could the anti-nausea tablets she had been prescribed harm the foetus?""",
                      kurdishText:
                          """دەکرێت ئەو دژە دڵ‌تێکھەڵاتنەی کە پێیدرا زیانی بە کۆرپەلەکە گەیاندبێت؟""",
