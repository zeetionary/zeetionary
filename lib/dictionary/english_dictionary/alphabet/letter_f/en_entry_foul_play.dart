...
class EnglishEntryfoulplay extends StatefulWidget {
  const EnglishEntryfoulplay({super.key});

  @override
  State<EnglishEntryfoulplay> createState() => _EnglishEntryfoulplayState();
}

class _EnglishEntryfoulplayState extends State<EnglishEntryfoulplay> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foul play
1. Unfair or dishonest behaviour (especially involving violence)
""",
  );

  final String keyword = "foul play";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foul play""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The police found no evidence of foul play.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was sent off for foul play.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foul play""",
                      // alsoEnglishWord: "also: foul play",
                      britshText: """IpaUK: /ˌfaʊl ˈpleɪ/""",
                      americanText: """IpaUS: /ˌfaʊl ˈpleɪ/""",
...
کوردی: (وەرزش) خەتا، هەڵە،	تاوان، تاوان‌کاری، توندوتیژی، کوشتن‌کاری، پیاوکوژی
"""),
// With short examples define "foul play", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کاری تاوانکاری یان توندووتیژی کە دەبێتە هۆکاری مەرگی کەسێک"""),
                    SentencesRow(
                      englishText:
                          """Police immediately began an investigation, but did not suspect foul play (= did not suspect that the person had been murdered).""",
                      kurdishText:
                          """پۆلیس دەستبەجێ دەستی کرد بە لێکۆڵینەوە، بەڵام گومانیان لە تیرۆرکردن نەکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پۆلیس هیچ بەڵگەیەکی تاوانکاریی نەدۆزییەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The police have ruled out foul play in the case of his death.""",
                      kurdishText:
                          """لە کەیسی مردنەکەیدا پۆلیس کاری تاوانکاری ڕەتکردبووەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بۆ یاریکردنی هەڵە کرایە دەرەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/48jBi86ih5Q?t=';
...
const String _videoIdtwo = 'https://youtu.be/H5_HVUS1l0Y?t=';
const double _startSecondstwo = 000000000000000000000000000898;
const String _videoIdthree = 'https://youtu.be/4Q1FzhMY8FQ?t=';
const double _startSecondsthree = 000000000000000000000000000874;
const String _videoIdfour = 'https://youtu.be/1GgD0CpMkyA?t=';
const double _startSecondsfour = 000000000000000000000000000766;
const String _videoIdfive = 'https://youtu.be/nyVOi3X53bk?t=';
const double _startSecondsfive = 000000000000000000000000000398;
