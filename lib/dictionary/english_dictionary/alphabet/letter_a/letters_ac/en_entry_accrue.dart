...
// replace these: EnglishEntryaccrue - speakAccrue - accrue - /əˈkruː/

enum TtsState { playing }

class EnglishEntryaccrue extends StatelessWidget {
  EnglishEntryaccrue({Key? key}) : super(key: key);
  ...
  Future<void> speakAccrue(String languageCode) async {
    ...
    await flutterTts.speak("accrue"); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'accrue', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈkruː/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
2. Come into the possession of (= fall)
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '-T64FLsJnAU';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '15RhQpLA6HU';
