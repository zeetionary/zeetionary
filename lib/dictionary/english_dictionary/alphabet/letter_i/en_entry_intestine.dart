...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'owKtZffVzPw';
    const double startSecondsend = 0;
    const String videoIdone = 'Fdgc2eaSzuM';
    const double startSecondsone = 0;
    const String videoIdtwo = 'l1SgmMXszEM';
    const double startSecondstwo = 0;
    const String videoIdthree = 'TGrJ0WB_1qQ';
    const double startSecondsthree = 238;
    const String videoIdfour = '1v8BH5Hj3dU';
    const double startSecondsfour = 41;
    const String videoIdfive = 'EMY_1D0yndI';
