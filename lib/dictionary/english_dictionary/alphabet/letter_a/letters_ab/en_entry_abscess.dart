...
// replace these: EnglishEntryabscess - speakAbscess - abscess - /ˈæbses/

enum TtsState { playing }

class EnglishEntryabscess extends StatelessWidget {
  EnglishEntryabscess({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'abscess', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈæbses/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˈæbses/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '5fZRRfai1bs';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'avkqIy7uIWQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'tIY7jxd7GAY';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'aa24Y0nLODA';
