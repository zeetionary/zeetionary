...
class EnglishEntrygardening extends StatefulWidget {
  const EnglishEntrygardening({super.key});

  @override
  State<EnglishEntrygardening> createState() => _EnglishEntrygardeningState();
}

class _EnglishEntrygardeningState extends State<EnglishEntrygardening> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gardening";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gardening""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""My mother has always enjoyed gardening.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gardening""",
                      // alsoEnglishWord: "also: gardening",
                      britshText: """IpaUK: /ˈɡɑːdnɪŋ/""",
                      americanText: """IpaUS: /ˈɡɑːrdnɪŋ/""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/JR3z8lq2cNM?t=';
const double _startSecondsend = 000000000000000000000000000974;
const String _videoIdone = 'https://youtu.be/L87HuKmGwVQ?t=';
...
const String _videoIdthree = 'https://youtu.be/1uNpjqH-mQQ?t=';
const double _startSecondsthree = 000000000000000000000000000308;
const String _videoIdfour = 'https://youtu.be/pLQuIuokP6Q?t=';
const double _startSecondsfour = 00000000000000000000000000014;
const String _videoIdfive = 'https://youtu.be/UxUPPN9wSfg?t=';
