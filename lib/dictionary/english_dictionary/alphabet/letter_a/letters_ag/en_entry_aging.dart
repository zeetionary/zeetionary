...
// replace these: replace EnglishEntryaging - replace speakAging - replace aging (or aging) - /ˈeɪdʒɪŋ/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaging extends StatelessWidget {
  EnglishEntryaging({super.key});
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "aging (or ageing)"),
                          ],
                        ),
                        Row(
                          children: [
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakaging35699("en-US"),
                          ),
                          const DividerDefinition(),
...
٢. (ھاوەڵناو) پیربوون و لەدەستدانت توانا و تەندرووستی"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakaging148825("en-US"),
                          ),
                        ],
                      ),
                    ),
