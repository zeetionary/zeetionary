...
class EnglishEntrygodlike extends StatefulWidget {
  const EnglishEntrygodlike({super.key});

  @override
  State<EnglishEntrygodlike> createState() => _EnglishEntrygodlikeState();
}

class _EnglishEntrygodlikeState extends State<EnglishEntrygodlike> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""godlike""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """godlike""",
                      // alsoEnglishWord: "also: godlike",
                      britshText: """IpaUK: /ˈɡɒdlaɪk/""",
                      americanText: """IpaUS: /ˈɡɑːdlaɪk/""",
...
// With short examples define "godlike", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) وەک خودا یان هەبوونی خاسیەتی خودا"""),
                    SentencesRow(
                      englishText:
                          """The hero in the story had godlike powers to control the weather.""",
                      kurdishText:
                          """پاڵەوانی چیرۆکەکە دەسەڵاتی خودایی هەیە بۆ کۆنترۆڵکردنی کەشووهەوا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/H6NUzanLUd4?t=';
const double _startSecondsend = 000000000000000000000000000503;
const String _videoIdone = 'https://youtu.be/Hzv8E3z1nx8?t=';
const double _startSecondsone = 0000000000000000000000000001053;
const String _videoIdtwo = 'https://youtu.be/v91FZUfEXGo?t=';
const double _startSecondstwo = 000000000000000000000000000496;
const String _videoIdthree = 'https://youtu.be/SDkAGkd4NLc?t=';
const double _startSecondsthree = 0000000000000000000000000001313;
const String _videoIdfour = 'https://youtu.be/N5FQRGfPy8I?t=';
const double _startSecondsfour = 00000000000000000000000000020;
const String _videoIdfive = 'https://youtu.be/CAmQ5ODJJfA?t=';
const double _startSecondsfive = 0000000000000000000000000001409;
