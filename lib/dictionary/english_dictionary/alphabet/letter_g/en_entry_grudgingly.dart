...
class EnglishEntrygrudgingly extends StatefulWidget {
  const EnglishEntrygrudgingly({super.key});

  @override
  State<EnglishEntrygrudgingly> createState() => _EnglishEntrygrudginglyState();
}

class _EnglishEntrygrudginglyState extends State<EnglishEntrygrudgingly> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "grudgingly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grudgingly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She grudgingly admitted that I was right.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grudgingly""",
                      // alsoEnglishWord: "also: grudgingly",
                      britshText: """IpaUK: /ˈɡrʌdʒɪŋli/""",
                      americanText: """IpaUS: /ˈɡrʌdʒɪŋli/""",
...
// With short examples define "grudgingly", please follow LX instructions
                    ...
                    const AlsoEnglishckb(word: "ھەروەھا: reluctantly"),
                    SentencesRow(
                      englishText:
                          """She grudgingly admitted that I was right.""",
                      kurdishText: """بە نابەدڵییەوە دانی پێدانا کە ڕاستم.""",
