...
class EnglishEntryhalfboard extends StatefulWidget {
  const EnglishEntryhalfboard({super.key});

  @override
  State<EnglishEntryhalfboard> createState() => _EnglishEntryhalfboardState();
}

class _EnglishEntryhalfboardState extends State<EnglishEntryhalfboard> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: half board (Derived forms: half boards)
Usage: Brit, Cdn (US: modified American plan)
1. A hotel plan that includes breakfast and dinner (but not lunch) (- modified American plan [N. Amer])
""",
  );

  final String keyword = "half board";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""half board""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """half board""",
                      // alsoEnglishWord: "also: half board",
                      britshText: """IpaUK: /ˌhɑːf ˈbɔːd/""",
                      americanText: """IpaUS: /ˌhæf ˈbɔːrd/""",
