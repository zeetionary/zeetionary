...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 289;
    const String videoIdone = 'tXjHb5QmDV0';
    const double startSecondsone = 1143;
    const String videoIdtwo = 'o9zCgPtsups';
    const double startSecondstwo = 670;
    const String videoIdthree = 'tsxmyL7TUJg';
    const double startSecondsthree = 1637;
    const String videoIdfour = 'AF8d72mA41M';
    const double startSecondsfour = 46;
    const String videoIdfive = 'P8m-KThvtxA';
