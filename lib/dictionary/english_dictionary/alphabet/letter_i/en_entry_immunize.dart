...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'MXQ43yyJvgs';
    const double startSecondsend = 1383;
    const String videoIdone = 'czjisEGe5Cw';
    const double startSecondsone = 877;
    const String videoIdtwo = 'F6NKbQzo4aE';
    const double startSecondstwo = 372;
    const String videoIdthree = 'hzNo5lZCq5M';
    const double startSecondsthree = 126;
    const String videoIdfour = 'm5Lwwbe7HiI';
    const double startSecondsfour = 193;
    const String videoIdfive = '9yQs3oQ1dC8';
    const double startSecondsfive = 1135;
