...
class EnglishEntryfritter extends StatefulWidget {
  const EnglishEntryfritter({super.key});

  @override
  State<EnglishEntryfritter> createState() => _EnglishEntryfritterState();
}

class _EnglishEntryfritterState extends State<EnglishEntryfritter> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fritter (Derived forms: fritters, frittering, frittered)
1. Small quantity of fried batter containing fruit, meat or vegetables

- Verb: fritter 
1. Spend frivolously and unwisely (- frivol away, dissipate, shoot, fritter away, fool, fool away)
"Fritter away one's inheritance";
""",
  );

  final String keyword = "fritter";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fritter""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She made apple fritters for breakfast.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fritter""",
                      // alsoEnglishWord: "also: fritter",
                      britshText: """IpaUK: /ˈfrɪtə(r)/""",
                      americanText: """IpaUS: /ˈfrɪtər/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پارچەیەک میوە، گۆشت، یان سەوزە کە بە جۆرە هەویرێک داپۆشراوە و دەبرژێندرێت"""),
                    SentencesRow(
                      englishText: """She made apple fritters for breakfast.""",
                      kurdishText:
                          """بۆ نانی بەیانی فریتەری سێوی ئامادە کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/4l8M3dQlUwg?t=';
const double _startSecondsend = 0000000000000000000000000001146;
const String _videoIdone = 'https://youtu.be/YCKO1qgotHY?t=';
const double _startSecondsone = 0000000000000000000000000004191;
const String _videoIdtwo = 'https://youtu.be/YYSP1D6GJ30';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/RwTvjfma_Sg?t=';
const double _startSecondsthree = 0000000000000000000000000001194;
const String _videoIdfour = 'https://youtu.be/GsK5NaSCkho?t=';
const double _startSecondsfour = 000000000000000000000000000343;
const String _videoIdfive = 'https://youtu.be/hNQMVweQjlw?t=';
const double _startSecondsfive = 000000000000000000000000000223;
