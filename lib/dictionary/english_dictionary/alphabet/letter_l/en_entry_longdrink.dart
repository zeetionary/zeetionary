...
class EnglishEntrylongdrink extends StatefulWidget {
  const EnglishEntrylongdrink({super.key});

  @override
  State<EnglishEntrylongdrink> createState() => _EnglishEntrylongdrinkState();
}

class _EnglishEntrylongdrinkState extends State<EnglishEntrylongdrink> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylongdrink long drink
WORD_WEB long drink long drink long drink
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "long drink";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""long drink""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """long drink""",
                      // alsoEnglishWord: "also: long drink",
...
کوردی: 
"""),
// With short examples define "long drink", please follow LX instructions
