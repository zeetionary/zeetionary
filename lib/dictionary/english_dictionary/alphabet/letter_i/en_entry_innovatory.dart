...
class EnglishEntryinnovatory extends StatefulWidget {
  const EnglishEntryinnovatory({super.key});

  @override
  State<EnglishEntryinnovatory> createState() => _EnglishEntryinnovatoryState();
}

class _EnglishEntryinnovatoryState extends State<EnglishEntryinnovatory> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryinnovatory innovatory
WORD_WEB innovatory innovatory innovatory
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "innovatory";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""innovatory""");
  }
...
کوردی: 
"""),
// With short examples define "innovatory", please follow LX instructions
