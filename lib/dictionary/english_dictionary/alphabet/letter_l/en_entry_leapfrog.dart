...
class EnglishEntryleapfrog extends StatefulWidget {
  const EnglishEntryleapfrog({super.key});

  @override
  State<EnglishEntryleapfrog> createState() => _EnglishEntryleapfrogState();
}

class _EnglishEntryleapfrogState extends State<EnglishEntryleapfrog> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""leapfrog""");
  }
