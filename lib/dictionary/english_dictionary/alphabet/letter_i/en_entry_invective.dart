...
class EnglishEntryinvective extends StatefulWidget {
  const EnglishEntryinvective({super.key});

  @override
  State<EnglishEntryinvective> createState() => _EnglishEntryinvectiveState();
}

class _EnglishEntryinvectiveState extends State<EnglishEntryinvective> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""invective""");
  }
