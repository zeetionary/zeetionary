...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: intimidate (Derived forms: intimidated, intimidates, intimidating)
1. Make timid or fearful
"Her boss intimidates her"
 
2. To compel or deter by (or as if) by threats or a show of force (- put the frigheners on [Brit, informal], put the screws on [informal])
""",
  );
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She refused to be intimidated by their threats.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/fjCinn-sjzk?t=';
    const double startSecondsend = 000000000000000000000000000694;
    const String videoIdone = 'https://youtu.be/waY6FwOd9eM?t=';
    const double startSecondsone = 000000000000000000000000000196;
    const String videoIdtwo = 'https://youtu.be/VNZ0so0LCoM?t=';
    const double startSecondstwo = 000000000000000000000000000111;
    const String videoIdthree = 'https://youtu.be/lf-KVEXIoqM?t=';
    const double startSecondsthree = 000000000000000000000000000902;
    const String videoIdfour = 'https://youtu.be/CupbRr2m_sM?t=';
    const double startSecondsfour = 0000000000000000000000000001071;
    const String videoIdfive = 'https://youtu.be/TfH85qWVilQ?t=';
    const double startSecondsfive = 0000000000000000000000000001629;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      britshText: """IpaUK: /ɪnˈtɪmɪdeɪt/""",
                      americanText: """IpaUS: /ɪnˈtɪmɪdeɪt/""",
...
// With short examples define "intimidate", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) ترساندن یان هەڕەشەکردن لە کەسێک بۆ ئەوەی ئەوە بکەن کە دەتەوێت"""),
                    SentencesRow(
                      englishText:
                          """They were accused of intimidating people into voting for them.""",
                      kurdishText:
                          """تۆمەتبار کران بە ترساندنی خەڵکی بۆ دەنگدان پێیان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕەتیکردەوە بترسێت بە هەڕەشەکانیان.""",
