...
class EnglishEntryevaluation extends StatefulWidget {
  const EnglishEntryevaluation({super.key});

  @override
  State<EnglishEntryevaluation> createState() => _EnglishEntryevaluationState();
}

class _EnglishEntryevaluationState extends State<EnglishEntryevaluation> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evaluation""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evaluation""",
                      // alsoEnglishWord: "also: evaluation",
                      britshText: """IpaUK: /ɪˌvæljuˈeɪʃn/""",
                      americanText: """IpaUS: /ɪˌvæljuˈeɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "evaluation";
...
کوردی: نرخاندن، هەڵسەنگاندن، لێکدانەوە، قەبڵاندن، مەزندەکردن،	نرخ‌دانان، بایەخ‌دانان
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) هەڵسەنگاندنی شتێک لە دوای بیرکردنەوە لێی بەوریایی"""),
          SentencesRow(
            englishText:
                """The technique is not widely practised and requires further evaluation.""",
            kurdishText:
                """تەکنیکەکە بە بەرفراوانی جێبەجێ ناکرێت و پێویستیی بە هەڵسەنگاندنی زیاترە.""",
          ...
          SentencesRow(
            englishText:
                """Evaluation of this new treatment cannot take place until all the data has been collected.""",
            kurdishText:
                """هەڵسەنگاندنی ئەم دەرمانە تازەیە ناکرێت بکردرێت تاوەکو هەموو داتاکە کۆکراوەتەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: evaluation (Derived forms: evaluations)
1. Act of ascertaining or fixing the value or worth of (= rating)
 
2. An appraisal of the value of something (= valuation, rating)
"he set a high evaluation on friendship";
 
3. (mathematics) calculation of the numerical value of an expression
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/ofTb57aZHZs?t=';
const double _startSecondsend = 000000000000000000000000000000; // 245;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/Nfr2BERLZBY?t=';
const double _startSecondsone = 00000000000000000000000000000; // 241;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/0PufM6dW_to?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 95;
const String _videoIdthree = 'VIDEOhttps://youtu.be/B7gKA1o31rM?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1767;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/s36hrId0rOo?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 151;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/CZbEQsKLRZQ?t=';
