...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Tropical areas are near zero degrees latitude.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""At these latitudes the sun does not rise at all on winter days.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Nowadays, newspapers are allowed considerable latitude in criticizing the government.""");
  }
...
// With short examples define "latitude", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) دووری شوێنێک لە باکوور یان باشووری هێڵی کەمەرەیی کە بە پلە دەپێورێت"""),
                    SentencesRow(
                      englishText: """Tropical areas are near zero degrees latitude.""",
                      kurdishText: """ناوچە کەمەرەییەکان بە نزیکەی لە پلەی سفری بازنەی پانین.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ناوچەیەکی جیهان کە بە پلەیەکی دیاریکراو دوورە لە هێڵی کەمەرەیی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """At these latitudes the sun does not rise at all on winter days.""",
                      kurdishText: """لەم بازنانەی پانی خۆر بە هیچ شێوەیەک هەڵنایەت لە ڕۆژانی زستاندا.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) ئازادیی ئەوەی چی دەکەیت یان چۆن دەیکەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Nowadays, newspapers are allowed considerable latitude in criticizing the government.""",
                      kurdishText: """لەم سەردەمەدا، ڕۆژنامەکان ئازادیی زۆریان پێدەدرێت لە ڕەخنەگرتن لە حکومەت.""",
