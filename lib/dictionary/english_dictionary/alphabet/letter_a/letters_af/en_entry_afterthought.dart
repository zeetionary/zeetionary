...
class EnglishEntryafterthought extends StatefulWidget {
  const EnglishEntryafterthought({super.key});

  @override
  State<EnglishEntryafterthought> createState() =>
      _EnglishEntryafterthoughtState();
}

class _EnglishEntryafterthoughtState extends State<EnglishEntryafterthought> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "afterthought";
  ...
  Widget build(BuildContext context) {
    const String videoIdend = 'Ww8gHl1tOCI';
    const double startSecondsend = 1;
    const String videoIdone = 'u8P9YW5YkL0';
    const double startSecondsone = 6;
    const String videoIdtwo = 'qSmyimnMOBo';
    const double startSecondstwo = 85;
    const String videoIdthree = 'DuMVJj6jBpA';
    const double startSecondsthree = 1346;
    const String videoIdfour = '0e8woEkKmG8';
    const double startSecondsfour = 3426;
    const String videoIdfive = '07MdzMu2nS8';
    const double startSecondsfive = 1574;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """afterthought""",
                      // alsoEnglishWord: "also: afterthought",
                      britshText: """IpaUK: /ˈɑːftəθɔːt/""",
                      americanText: """IpaUS: /ˈɑːftərθɔːt/""",
