...
class EnglishEntryheretic extends StatefulWidget {
  const EnglishEntryheretic({super.key});

  @override
  State<EnglishEntryheretic> createState() => _EnglishEntryhereticState();
}

class _EnglishEntryhereticState extends State<EnglishEntryheretic> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heretic (Derived forms: heretics)
1. A person who holds religious beliefs in conflict with the dogma of the Roman Catholic Church (- misbeliever, religious outcast)
 
2. A person who holds unorthodox opinions in any field (not merely religion)
""",
  );

  final String keyword = "heretic";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heretic""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heretic""",
                      // alsoEnglishWord: "also: heretic",
                      britshText: """IpaUK: /ˈherətɪk/""",
                      americanText: """IpaUS: /ˈherətɪk/""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/-aSdFrPnlRg?t=';
const double _startSecondsend = 0000000000000000000000000002593;
const String _videoIdone = 'https://youtu.be/ToBdcRGsqr8';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/qWNHsaszXpc?t=';
...
const String _videoIdfour = 'https://youtu.be/lhuUEYVYXfM?t=';
const double _startSecondsfour = 000000000000000000000000000239;
const String _videoIdfive = 'https://youtu.be/YytF2v7Vvw0?t=';
