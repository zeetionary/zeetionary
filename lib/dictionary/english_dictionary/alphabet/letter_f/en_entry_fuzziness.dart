...
// With short examples define "fuzziness", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """زۆر شڵەژاوی ھەیە سەبارەت بەم بابەتە.""",
...
const double _startSecondstwo = 3246;
const String _videoIdthree = 'l1SQvO8twcM';
const double _startSecondsthree = 198;
const String _videoIdfour = 'FnZSyDaTwZs';
const double _startSecondsfour = 288;
const String _videoIdfive = '9h_QtLol75I';
const double _startSecondsfive = 211;
