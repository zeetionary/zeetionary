...
""",
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""When they asked me if I wanted the job, I said yes.""");
  }
...
// With short examples define "i", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (جێناو) جێناوی کەسی یەکەمی تاک؛ من"""),
                    SentencesRow(
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کە لێمیان پرسی کە کارەکەم دەوێت، گوتم بەڵێ.""",
