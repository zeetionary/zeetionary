...
class EnglishEntryinhumane extends StatefulWidget {
  const EnglishEntryinhumane({super.key});

  @override
  State<EnglishEntryinhumane> createState() => _EnglishEntryinhumaneState();
}

class _EnglishEntryinhumaneState extends State<EnglishEntryinhumane> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inhumane""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1814;
    const String videoIdone = 'UOc7xdRhAAY';
    const double startSecondsone = 8;
    const String videoIdtwo = 'auPYOsBejK4';
    const double startSecondstwo = 279;
    const String videoIdthree = 'P6bVl47kdNk';
    const double startSecondsthree = 1129;
    const String videoIdfour = '5DvmM7nPqVA';
    const double startSecondsfour = 132;
    const String videoIdfive = 'SG1vNoErfQw';
