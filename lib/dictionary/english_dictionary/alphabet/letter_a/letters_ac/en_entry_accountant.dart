...
// replace these: EnglishEntryaccountant - speakAccountant - accountant - /əˈkaʊntənt/

enum TtsState { playing }

class EnglishEntryaccountant extends StatelessWidget {
  EnglishEntryaccountant({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAccountant(String languageCode) async {
    // DOPSUM: CHANGE speakAccountant
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("accountant"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakA4582(String languageCode) async {
    // DOPSUM: CHANGE speakAccountant
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "We talked to the company’s chief accountant."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'accountant', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈkaʊntənt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /əˈkaʊntənt/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'i4mQNsvnJ5s';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'zzRd9eiWthk';
