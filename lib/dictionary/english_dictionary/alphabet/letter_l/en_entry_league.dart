...
class EnglishEntryleague extends StatefulWidget {
  const EnglishEntryleague({super.key});

  @override
  State<EnglishEntryleague> createState() => _EnglishEntryleagueState();
}

class _EnglishEntryleagueState extends State<EnglishEntryleague> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: league (Derived forms: leagues)
1. An association of sports teams that organizes matches for its members (- conference)
 
2. An association of states, organizations or individuals for common action
 
3. An obsolete unit of distance of variable length (usually 3 miles)

- Verb: league (Derived forms: leagues, leaguing, leagued)
1. Unite to form a league
""",
  );

  final String keyword = "league";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Castleford have led the league for most of the season.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We must do better if we are to win the league again this season.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They're in a different league from us.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""As a painter, he is in a league of his own.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""When it comes to cooking, I'm not in her league.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A house like that is out of our league.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Egypt was a founding member of the Arab League.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/PmlRbfSavbI?t=769';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/Bl5630CeYFs?t=204';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/zqllxbPWKNI?t=885';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/-RjJtO51ykY?t=767';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/fGMCjELDyUY?t=411';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/nGrB-5ieeMU?t=248';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """league""",
                      // alsoEnglishWord: "also: league",
                      britshText: """IpaUK: /liːɡ/""",
                      americanText: """IpaUS: /liːɡ/""",
...
کوردی: 
"""),
// With short examples define "league", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ژمارەیەک یانەی وەرزشی کە پێکەوە یاری دەکەن بۆ بەدەستهێنانی خاڵ"""),
                    SentencesRow(
                      englishText: """Castleford have led the league for most of the season.""",
                      kurdishText: """کاسڵفۆرد بۆ زۆرینەی وەرزەکە لە پێشەوەی خولەکە بووە.""",
                    ...
                    SentencesRow(
                      englishText: """We must do better if we are to win the league again this season.""",
                      kurdishText: """دەبێت باشتر بین ئەگەر ئەم وەرزە دووبارە دەبێت خولەکە ببەینەوە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ڕێژەیەک لە خاسیەتێک، توانایەک، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They're in a different league from us.""",
                      kurdishText: """لە ئاستێکی جیاوازترن وەک لە ئێمە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """As a painter, he is in a league of his own (= much better than others).""",
                      kurdishText: """وەک نیگارکێشێک، لە ئاستێکی تایبەت بە خۆیەتی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """When it comes to cooking, I'm not in her league (= she is much better than me).""",
                      kurdishText: """کە دێتە سەر چێشتلێنان، لە ئاستی ئەو نیم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """A house like that is out of our league (= too expensive for us).""",
                      kurdishText: """خانوویەکی ئاوەها لە قەرەی ئێمەدا نییە.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) گرووپێک لە خەڵکی یان وڵاتان کە بۆ مەبەستێکی دیاریکراو یەکیان گرتووە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: alliance"),
                    SentencesRow(
                      englishText: """Egypt was a founding member of the Arab League.""",
                      kurdishText: """میسر ئەندامی دامەزرێنەری کۆمکاری عەرەبی بوو.""",
