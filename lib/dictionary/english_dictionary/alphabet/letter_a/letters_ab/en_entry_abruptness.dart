...
// replace these: EnglishEntryabruptness - speakAbruptness - abruptness - /əˈbrʌptnəs/

enum TtsState { playing }

class EnglishEntryabruptness extends StatelessWidget {
  EnglishEntryabruptness({super.key});
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "abruptness"), // DOPSUM: CHANGE WORD ENTRY
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈbrʌptnəs/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /əˈbrʌptnəs/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'LAkFtka3UFw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'aXJH4tZM5gM';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'Yy9yCkHJYkc';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'p9jQoXlrupA';
