...
class EnglishEntryexercisebook extends StatefulWidget {
...
class _EnglishEntryexercisebookState extends State<EnglishEntryexercisebook> {
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exercise book""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      britshText: """IpaUK: /ˈeksəsaɪz bʊk/""",
                      americanText: """IpaUS: /ˈeksərsaɪz bʊk/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exercise book";
...
"""),
          ...
          CustomRichText(
            ...
            textAfterLink: "",
            onTap: () {
              Routemaster.of(context).push("/english-exercisebook/notebook");
            },
          ),
          const DividerDefinition(),
          CustomRichText(
            ...
            textAfterLink: "",
            onTap: () {
              Routemaster.of(context).push("/english-exercisebook/workbook");
            },
          ),
          const DividerSentences(),
          SentencesRow(
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: exercise book (Derived forms: exercise books)
1. A booklet for students, containing either problems and exercises or blank pages for writing answers
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/keZnAtBxO-c?t=';
const double _startSecondsend = 000000000000000000000000000000; // 63;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/Lr-zoNnDid0?t=';
const double _startSecondsone = 00000000000000000000000000000; // 978;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/oU2qLnqCXik?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 77;
const String _videoIdthree = 'VIDEOhttps://youtu.be/u5X979R-JTE?t=';
const double _startSecondsthree = 000000000000000000000000000; // 333;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/3aQJ_OtIEFc?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 339;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/qcLRCmNRsx4?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 85;
