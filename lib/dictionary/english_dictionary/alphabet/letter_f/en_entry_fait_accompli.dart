...
class EnglishEntryfaitaccompli extends StatefulWidget {
  const EnglishEntryfaitaccompli({super.key});

  @override
  State<EnglishEntryfaitaccompli> createState() => _EnglishEntryfaitaccompliState();
}

class _EnglishEntryfaitaccompliState extends State<EnglishEntryfaitaccompli> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fait accompli""",
                      // alsoEnglishWord: "also: fait accompli",
                      britshText: """IpaUK: /ˌfeɪt əˈkɒmpliː/""",
                      americanText: """IpaUS: /ˌfeɪt əˈkɑːmpliː/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "fait accompli";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We got married secretly and then presented our parents with a fait accompli.""");
  }
...
کوردی: کاری کراو، شتێکی کراو
"""),
          const DefinitionKurdish(text: """١. (ناو) شتێکی کە پێشوەختە دەستی بە ڕوودان کردووە و ناتوانیت پێشی بگریت"""),
          SentencesRow(
            englishText:
                """We got married secretly and then presented our parents with a fait accompli.""",
            kurdishText: """بە نهێنی هاوسەرگیریمان کرد و دایک و باوکمان خستە پێش شتێکی کراو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fait accompli
1. An irreversible accomplishment (= accomplished fact)
""",
  );
...
const String _videoIdend = 'https://youtu.be/S5LrQv496Iw?t=';
const double _startSecondsend = 000000000000000000000000000429;
const String _videoIdone = 'https://youtu.be/h6PK6BJ8II8?t=';
const double _startSecondsone = 000000000000000000000000000970;
const String _videoIdtwo = 'https://youtu.be/h-gxgeFdCTk?t=';
const double _startSecondstwo = 000000000000000000000000000223;
const String _videoIdthree = 'https://youtu.be/dVWrx24jGQw?t=';
const double _startSecondsthree = 000000000000000000000000000770;
const String _videoIdfour = 'https://youtu.be/F5wW7pZDXxA?t=';
const double _startSecondsfour = 000000000000000000000000000390;
const String _videoIdfive = 'https://youtu.be/z7CToebgF7A?t=';
