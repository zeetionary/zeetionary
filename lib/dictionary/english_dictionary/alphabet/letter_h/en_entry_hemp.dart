...
class EnglishEntryhemp extends StatefulWidget {
  const EnglishEntryhemp({super.key});

  @override
  State<EnglishEntryhemp> createState() => _EnglishEntryhempState();
}

class _EnglishEntryhempState extends State<EnglishEntryhemp> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hemp (Derived forms: hemps)
1. A plant fibre
 
2. Any plant of the genus Cannabis; a coarse bushy annual with palmate leaves and clusters of small green flowers; yields tough fibers and recreational drugs (- cannabis, dagga [S.Africa])
 
3. [rare] A rope that is used by a hangman to execute persons who have been condemned to death by hanging (- hangman's rope, hangman's halter, halter, hempen necktie, noose)
""",
  );

  final String keyword = "hemp";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The rope was made from durable hemp fibers.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hemp""",
                      // alsoEnglishWord: "also: hemp",
                      britshText: """IpaUK: /hemp/""",
                      americanText: """IpaUS: /hemp/""",
...
"""),
                    CustomRichText(
                      textBeforeLink:
                          "١. (ناو) گیایەک کە دەڕێسرێت و جل و حەبلی پێ درووست دەکرێت، و هەروەها  ",
                      linkText: "cannabis",
                      textAfterLink: " درووست دەکات",
                      onTap: () {
                        Routemaster.of(context).push("/english-hemp/cannabis");
                      },
                    ),
                    SentencesRow(
                      englishText:
                          """The rope was made from durable hemp fibers.""",
                      kurdishText:
                          """حەبلەکە لە ڕیشاڵی بەرگەگرتووی گوش درووستکرا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Lkl9_3-jX6c?t=';
const double _startSecondsend = 000000000000000000000000000183;
const String _videoIdone = 'https://youtu.be/f3cQEMLnd_k?t=';
const double _startSecondsone = 000000000000000000000000000528;
const String _videoIdtwo = 'https://youtu.be/cApVVuuqLFY?t=';
const double _startSecondstwo = 000000000000000000000000000211;
const String _videoIdthree = 'https://youtu.be/Y-SnB10ihD4?t=';
const double _startSecondsthree = 000000000000000000000000000332;
const String _videoIdfour = 'https://youtu.be/dvWVaN3a6ao?t=';
const double _startSecondsfour = 000000000000000000000000000269;
const String _videoIdfive = 'https://youtu.be/fcHEc0pE924?t=';
const double _startSecondsfive = 000000000000000000000000000380;
