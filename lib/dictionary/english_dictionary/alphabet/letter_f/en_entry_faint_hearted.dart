...
class EnglishEntryfainthearted extends StatefulWidget {
  const EnglishEntryfainthearted({super.key});

  @override
  State<EnglishEntryfainthearted> createState() =>
      _EnglishEntryfaintheartedState();
}

class _EnglishEntryfaintheartedState extends State<EnglishEntryfainthearted> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""faint-hearted""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """faint-hearted""",
                      // alsoEnglishWord: "also: faint-hearted",
                      britshText: """IpaUK: /ˌfeɪnt ˈhɑːtɪd/""",
                      americanText: """IpaUS: /ˌfeɪnt ˈhɑːrtɪd/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "faint-hearted";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He tried not to appear faint-hearted.""");
  }
...
// With short examples define "faint-hearted", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: بێ‌جەرگ، ترسەنۆک، حیز، نەوێر
"""),
...
1. Lacking conviction, boldness or courage (= faint, timid, faint-hearted)
"fainthearted heart ne'er won fair lady";
""",
  );
...
const String _videoIdend = 'https://youtu.be/tkLZYEIslWM?t=';
const double _startSecondsend = 000000000000000000000000000586;
const String _videoIdone = 'https://youtu.be/OU-DF-JcXkw?t=';
const double _startSecondsone = 000000000000000000000000000550;
const String _videoIdtwo = 'https://youtu.be/61LwFaWJ5jI?t=';
const double _startSecondstwo = 000000000000000000000000000505;
const String _videoIdthree = 'https://youtu.be/uJI1mQ69az4?t=';
const double _startSecondsthree = 000000000000000000000000000415;
const String _videoIdfour = 'https://youtu.be/fEGdonFCL7A?t=';
const double _startSecondsfour = 000000000000000000000000000497;
const String _videoIdfive = 'https://youtu.be/c4RuWmmt8To?t=';
