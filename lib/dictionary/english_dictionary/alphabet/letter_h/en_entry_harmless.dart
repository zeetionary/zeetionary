...
class EnglishEntryharmless extends StatefulWidget {
  const EnglishEntryharmless({super.key});

  @override
  State<EnglishEntryharmless> createState() => _EnglishEntryharmlessState();
}

class _EnglishEntryharmlessState extends State<EnglishEntryharmless> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""harmless""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The bacteria is harmless to humans.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """Some apparently harmless drugs can be lethal when used in combination.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Most people considered him a harmless eccentric.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It was just a harmless frolic.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It was a harmless flirtation and nothing more.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harmless""",
                      // alsoEnglishWord: "also: harmless",
                      britshText: """IpaUK: /ˈhɑːmləs/""",
                      americanText: """IpaUS: /ˈhɑːrmləs/""",
...
کوردی: بێ‌زیان، بێ‌مەترسی، بێ‌زەرەر، بێ‌ئازار، بێ‌وەی، بێ‌وەزەن،	بێ‌گوناهـ، بێ‌گوناهانە
"""),
// With short examples define "harmless", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە زیان نابەخشێت"""),
                    SentencesRow(
                      englishText: """The bacteria is harmless to humans.""",
                      kurdishText: """بەکتریاکە بێ‌زیانە بۆ مرۆڤ.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Some apparently harmless drugs can be lethal when used in combination.""",
                      kurdishText:
                          """ژمارەیەک دەرمانی بێ‌زیان دەکرێت کوشندە بن کە پێکەوە بەکاربێن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆر کەس بە شێتۆکەیەکی بێ‌زیان دایان دەنا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە ئەگەری کەمە کەسێک بێزار بکات"""),
                    const AlsoEnglishckb(word: "ھەروەھا: innocuous"),
                    SentencesRow(
                      englishText:
                          """It was a harmless flirtation and nothing more.""",
                      kurdishText:
                          """تەنھا داڵدارییەکی بێ‌زیان بوو و ھیچی تر.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/O_vfyEpyB4A?t=';
const double _startSecondsend = 0000000000000000000000000006;
const String _videoIdone = 'https://youtu.be/IHAVC3ASxi4?t=';
const double _startSecondsone = 000000000000000000000000000165;
const String _videoIdtwo = 'https://youtu.be/VPBTD8BImHE?t=';
const double _startSecondstwo = 000000000000000000000000000220;
const String _videoIdthree = 'https://youtu.be/1I4nHRYgfGE?t=';
const double _startSecondsthree = 000000000000000000000000000115;
const String _videoIdfour = 'https://youtu.be/rSvBFm_MuXw?t=';
const double _startSecondsfour = 00000000000000000000000000059;
const String _videoIdfive = 'https://youtu.be/f7QWMUCMYOE?t=';
