                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "adviser"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ədˈvaɪzə(r)/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakadviser("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ədˈvaɪzər/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakadviser("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'VP2wn4EytSY';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'OVIT27oX9eo';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 's_zB_D9DBhE';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '3-0-81q-fGo';
