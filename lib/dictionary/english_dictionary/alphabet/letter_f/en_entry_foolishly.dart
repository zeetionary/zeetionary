...
class EnglishEntryfoolishly extends StatefulWidget {
  const EnglishEntryfoolishly({super.key});

  @override
  State<EnglishEntryfoolishly> createState() => _EnglishEntryfoolishlyState();
}

class _EnglishEntryfoolishlyState extends State<EnglishEntryfoolishly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: foolishly
1. Without good sense or judgment (= unwisely, ill-advisedly, misguidedly)
"He acted foolishly when he agreed to come";
""",
  );

  final String keyword = "foolishly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foolishly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We foolishly thought that everyone would speak English.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foolishly""",
                      // alsoEnglishWord: "also: foolishly",
                      britshText: """IpaUK: /ˈfuːlɪʃli/""",
                      americanText: """IpaUS: /ˈfuːlɪʃli/""",
...
// With short examples define "foolishly", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """گەمژانە وامان دانا هەموان بە ئینگلیزی قسە دەکەن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/oHLMla-75QA?t=';
const double _startSecondsend = 000000000000000000000000000262;
const String _videoIdone = 'https://youtu.be/Mx8JkGHaGUI?t=';
const double _startSecondsone = 0000000000000000000000000001659;
const String _videoIdtwo = 'https://youtu.be/v9tM_YHvhuA?t=';
const double _startSecondstwo = 000000000000000000000000000408;
const String _videoIdthree = 'https://youtu.be/BWFLztKBrLY?t=';
const double _startSecondsthree = 00000000000000000000000000029;
const String _videoIdfour = 'https://youtu.be/FoqHB7BMduw?t=';
const double _startSecondsfour = 000000000000000000000000000823;
const String _videoIdfive = 'https://youtu.be/1Z7Yxwg4TfE?t=';
