...
class EnglishEntryhardlabour extends StatefulWidget {
  const EnglishEntryhardlabour({super.key});

  @override
  State<EnglishEntryhardlabour> createState() => _EnglishEntryhardlabourState();
}

class _EnglishEntryhardlabourState extends State<EnglishEntryhardlabour> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "hard labour";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hard labour""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was sentenced to ten years’ hard labour.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hard labour""",
                      // alsoEnglishWord: "also: hard labour",
                      britshText: """IpaUK: /ˌhɑːd ˈleɪbə(r)/""",
                      americanText: """IpaUS: /ˌhɑːrd ˈleɪbər/""",
...
// With short examples define "hard labour", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) سزای لە زینداندا کە کاری زۆر سەخت لەخۆدەگرێت"""),
                    SentencesRow(
                      englishText: """He was sentenced to ten years’ hard labour.""",
                      kurdishText: """سزادرا بە دە ساڵ لە کاری زۆرەملێ سزادرا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/xi4wZJ-7ZCg?t=';
const double _startSecondsend = 0000000000000000000000000001231;
const String _videoIdone = 'https://youtu.be/Ic_IapE_D-Q?t=';
const double _startSecondsone = 0000000000000000000000000001758;
const String _videoIdtwo = 'https://youtu.be/j4kI2h3iotA?t=';
const double _startSecondstwo = 0000000000000000000000000002360;
const String _videoIdthree = 'https://youtu.be/1ZKBaRsP1gY?t=';
const double _startSecondsthree = 00000000000000000000000000070;
const String _videoIdfour = 'https://youtu.be/x3GvCQJVQfs?t=';
const double _startSecondsfour = 000000000000000000000000000561;
const String _videoIdfive = 'https://youtu.be/NZOHQwzA0bM?t=';
