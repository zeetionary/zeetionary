...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'wkORnroOOWg';
    const double startSecondsend = 768;
    const String videoIdone = '5sHuFK7yOdo';
    const double startSecondsone = 411;
    const String videoIdtwo = '6iKeOP72hTo';
    const double startSecondstwo = 70;
    const String videoIdthree = 'w0QRliFvOC0';
    const double startSecondsthree = 897;
    const String videoIdfour = 'MYnjzsjeMK8';
    const double startSecondsfour = 567;
    const String videoIdfive = 'YeAxxMZf1O4';
    const double startSecondsfive = 748;
