...
class EnglishEntryfraudulent extends StatefulWidget {
  const EnglishEntryfraudulent({super.key});

  @override
  State<EnglishEntryfraudulent> createState() => _EnglishEntryfraudulentState();
}

class _EnglishEntryfraudulentState extends State<EnglishEntryfraudulent> {
  @override
  void initState() {
    super.initState();
...
1. Involving deception (= deceitful, fallacious)
"a fraudulent scheme to escape paying taxes";
""",
  );

  final String keyword = "fraudulent";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fraudulent""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fraudulent""",
                      // alsoEnglishWord: "also: fraudulent",
                      britshText: """IpaUK: /ˈfrɔːdʒələnt/""",
                      americanText: """IpaUS: /ˈfrɔːdʒələnt/""",
...
// With short examples define "fraudulent", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """They claim that the fall in unemployment is based on a fraudulent manipulation of statistics.""",
                      kurdishText:
                          """بانگەشەی ئەوە دەکەن کە دابەزینی بێ‌کاری پشتی بەستووە بە دەستکاری ساختەکارانەی ئامارەکان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/dqcSk-EDrRo?t=';
const double _startSecondsend = 000000000000000000000000000312;
const String _videoIdone = 'https://youtu.be/NpBPm0b9deQ?t=';
const double _startSecondsone = 0000000000000000000000000001049;
const String _videoIdtwo = 'https://youtu.be/ugYPoWShl6k?t=';
const double _startSecondstwo = 0000000000000000000000000001600;
const String _videoIdthree = 'https://youtu.be/4IaOeVgZ-wc?t=';
const double _startSecondsthree = 0000000000000000000000000003707;
const String _videoIdfour = 'https://youtu.be/h31p4OLbqSc?t=';
const double _startSecondsfour = 000000000000000000000000000550;
const String _videoIdfive = 'https://youtu.be/DbhuZFVqAqc?t=';
