...
class EnglishEntryenglish extends StatefulWidget {
  const EnglishEntryenglish({super.key});

  @override
  State<EnglishEntryenglish> createState() => _EnglishEntryenglishState();
}

class _EnglishEntryenglishState extends State<EnglishEntryenglish> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """English""",
                      // alsoEnglishWord: "also: English",
                      britshText: """IpaUK: /ˈɪŋɡlɪʃ/""",
                      americanText: """IpaUS: /ˈɪŋɡlɪʃ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She speaks good English.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I need to improve my English.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Do you speak English?""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""English is my best subject.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The English have a rich cultural heritage.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Is she English?""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They publish English dictionaries.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The English countryside is beautiful.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) زمانی ئینگلیزی؛ زمانی خەڵکی ئینگلتەرە کە ئێستا لە زۆر وڵاتی جیهاندا قسەی پێدەکرێت و وەک زمانی گفتوگۆی نێودەڵەتی لە جیهاندا بەکاردێت"""),
          SentencesRow(
            englishText: """She speaks good English.""",
            kurdishText: """بە ئینگلیزییەکی باش قسە دەکات.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I need to improve my English.""",
            kurdishText: """دەبێت ئینگلیزییەکەم باشتر بکەم.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """خەڵکی ئینگلتەرە کەلەپوورێکی کەلتووری دەوڵەمەندیان هەیە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٤. (هاوەڵناو) پەیوەندیدار بە ئینگلتەرە خەڵکەکەی، یان زمانەکەی"""),
          const DividerSentences(),
          SentencesRow(
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """They publish English dictionaries.""",
            kurdishText: """فەرهەنگی ئینگلیزی بڵاودەکەنەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The English countryside is beautiful.""",
            kurdishText: """دەشت‌ودەری ئینگلیز جوانە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: English (Derived forms: Englishes)
1. An Indo-European language belonging to the West Germanic branch; the official language of Britain and the United States and most of the commonwealth countries (= English language)
 
2. The people of England (= English people)
 
3. The discipline that studies the English language and literature
 
4. [N. Amer] (sport) the spin given to a ball by striking it on one side or releasing it with a sharp twist (= side)
...
const String _videoIdone = 'https://youtu.be/ky3KiiUK_D0';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/AtiMqeDmo1M?t=';
const double _startSecondstwo = 19;
const String _videoIdthree = 'https://youtu.be/HUXzbefQzWY?t=';
const double _startSecondsthree = 144;
const String _videoIdfour = 'https://youtu.be/iKv4oc2zbeA?t=';
const double _startSecondsfour = 9;
const String _videoIdfive = 'https://youtu.be/EoXOHyYEguk?t=';
const double _startSecondsfive = 5;
const String _videoIdsix = 'https://youtu.be/9sRQQRiltrE?t=';
const double _startSecondssix = 50;
