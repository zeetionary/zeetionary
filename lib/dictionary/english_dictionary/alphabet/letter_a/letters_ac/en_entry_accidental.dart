...
class EnglishEntryaccidental extends StatefulWidget {
  const EnglishEntryaccidental({super.key});

  @override
  State<EnglishEntryaccidental> createState() => _EnglishEntryaccidentalState();
}

class _EnglishEntryaccidentalState extends State<EnglishEntryaccidental> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "accidental";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accidental""",
                      // alsoEnglishWord: "also: accidental",
                      britshText: """IpaUK: /ˌæksɪˈdentl/""",
                      americanText: """IpaUS: /ˌæksɪˈdentl/""",
