...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'g0amdIcZt5I';
    const double startSecondsend = 1134;
    const String videoIdone = 'Q1bSDnuIPbo';
    const double startSecondsone = 706;
    const String videoIdtwo = '2IxD3WFHXxs';
    const double startSecondstwo = 182;
    const String videoIdthree = 'apmSXL43Xao';
    const double startSecondsthree = 192;
    const String videoIdfour = 'x9flq3vb9JU';
    const double startSecondsfour = 36;
    const String videoIdfive = 'QCQ_d0NOF4g';
