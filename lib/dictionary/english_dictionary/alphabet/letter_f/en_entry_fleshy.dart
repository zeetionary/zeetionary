...
class EnglishEntryfleshy extends StatefulWidget {
  const EnglishEntryfleshy({super.key});

  @override
  State<EnglishEntryfleshy> createState() => _EnglishEntryfleshyState();
}

class _EnglishEntryfleshyState extends State<EnglishEntryfleshy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fleshy (Derived forms: fleshier, fleshiest)
1. Usually describes a large person who is fat but has a large frame to carry it (= heavy, thickset, heavyset)
 
2. Of or relating to or resembling flesh (= sarcoid)
""",
  );

  final String keyword = "fleshy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The bullet hit the fleshy part of his upper arm.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fleshy""",
                      // alsoEnglishWord: "also: fleshy",
                      britshText: """IpaUK: fleshy""",
                      americanText: """IpaUS: fleshy""",
...
// With short examples define "fleshy", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """فیشەکەکە بەشی گۆشتنی باڵی سەرەوەیی پێکا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Fa13JKGG0ds?t=';
const double _startSecondsend = 000000000000000000000000000403;
const String _videoIdone = 'https://youtu.be/D7Cv7x6jjYQ?t=';
const double _startSecondsone = 000000000000000000000000000327;
const String _videoIdtwo = 'https://youtu.be/QICB_puGtYo?t=';
const double _startSecondstwo = 0000000000000000000000000001837;
const String _videoIdthree = 'https://youtu.be/dzRNswfny3A?t=';
const double _startSecondsthree = 000000000000000000000000000751;
const String _videoIdfour = 'https://youtu.be/ZMlt-6XUW-U?t=';
const double _startSecondsfour = 000000000000000000000000000323;
const String _videoIdfive = 'https://youtu.be/iojNr30s0TY?t=';
const double _startSecondsfive = 00000000000000000000000000029;
