...
// replace EnglishEntryAdopsum - replace speakArabic

// replace arabic - /ˈærəbɪk/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarabic extends StatelessWidget {
  // blank divider
  EnglishEntryarabic({super.key});
  // blank divider
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "Arabic"), // DOPSUM: CHANGE WORD ENTRY - Find /ˈærəbɪk/
                            // divvviiider
                        ...
                        Row(
                          children: [
                            ...
                            CustomIconButtonBritish(
                              onPressed: () =>
                                  speakArabic(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
- Noun: Arabic 
1. The Semitic language of the Arabs; spoken in a variety of dialects (= Arabic language)
""",
          )
        ],
      ),
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "rdeQT7KkqM8";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "8OqdiU5u4vs";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "Dt-PEVm8754";
