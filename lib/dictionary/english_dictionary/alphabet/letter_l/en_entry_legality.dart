...
class EnglishEntrylegality extends StatefulWidget {
  const EnglishEntrylegality({super.key});

  @override
  State<EnglishEntrylegality> createState() => _EnglishEntrylegalityState();
}

class _EnglishEntrylegalityState extends State<EnglishEntrylegality> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""legality""");
  }
