...
class EnglishEntryintensify extends StatefulWidget {
  const EnglishEntryintensify({super.key});

  @override
  State<EnglishEntryintensify> createState() => _EnglishEntryintensifyState();
}

class _EnglishEntryintensifyState extends State<EnglishEntryintensify> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intensify""");
  }
