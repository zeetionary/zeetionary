...
class EnglishEntryestatecar extends StatefulWidget {
  const EnglishEntryestatecar({super.key});

  @override
  State<EnglishEntryestatecar> createState() => _EnglishEntryestatecarState();
}

class _EnglishEntryestatecarState extends State<EnglishEntryestatecar> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""estate car""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """estate car""",
                      // alsoEnglishWord: "also: estate car",
                      britshText: """IpaUK: /ɪˈsteɪt kɑː(r)/""",
                      americanText: """IpaUS: /ɪˈsteɪt kɑːr/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "estate car";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They bought an estate car for family trips.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ئۆتۆمبێلێک کە لە دوای کوشنەکانییەوە جێگای فراوانی هەیە و لە پشتەوە دەرگایەکی هەیە"""),
          // SentencesRow(
          //   englishText:
          //       """They bought an estate car for family trips.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: estate car (Derived forms: estate cars)
Usage: Brit, Cdn (US: station wagon)
1. A car that has a long body and rear door with space behind rear seat (= beach wagon [N. Amer, Austral, NZ], station wagon [N. Amer, Austral, NZ], wagon [N. Amer, Austral, NZ], beach waggon [Cdn, Austral, NZ], station waggon [N. Amer, Austral, NZ], waggon [Cdn, Austral, NZ], estate [Brit, informal])
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/ymjWeQhic0s?t=';
const double _startSecondsend = 000000000000000000000000000000; // 479;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/cl3ySfKfv1s?t=';
const double _startSecondsone = 00000000000000000000000000000; // 398;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/zxKCli-h4Bs?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 29;
const String _videoIdthree = 'VIDEOhttps://youtu.be/4HYdVXmYA-w?t=';
const double _startSecondsthree = 000000000000000000000000000; // 9;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/LcJLE1MEGac?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1277;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/cxSu8arwgqg?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 381;
