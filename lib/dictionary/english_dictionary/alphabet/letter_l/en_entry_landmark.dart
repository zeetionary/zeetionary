...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The Empire State Building is a familiar landmark on the New York skyline.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The ceasefire was seen as a major landmark in the fight against terrorism.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The magazine's 150th anniversary was an important publishing landmark.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The film is an important landmark in the history of the cinema.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The building has been designated a historical landmark.""");
  }
...
// With short examples define "landmark", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) شتێک، بۆ نموونە بینایەکی گەورە، کە لە دوورەوە بە ڕوونی دەیبینی و لە ڕێگەیەوە دەزانیت لە کوێیت"""),
                    SentencesRow(
                      englishText: """The tower was once a landmark for ships.""",
                      kurdishText: """تاوەرەکە جاران سنوورنیشانێک بوو بۆ کەشتی.""",
                    ...
                    SentencesRow(
                      englishText: """The Empire State Building is a familiar landmark on the New York skyline.""",
                      kurdishText: """بینای ئیمپایەر ستەیت ڕێ‌پیشاندەرێکی ناسراوی ئاسمانی نیویۆرکە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) بۆنە، دۆزینەوە، داهێنانێک، هتد کە قۆناغێکی گرنگە لە شتێکدا"""),
                    const AlsoEnglishckb(word: "ھەروەھا: milestone"),
                    SentencesRow(
                      englishText: """The ceasefire was seen as a major landmark in the fight against terrorism.""",
                      kurdishText: """ئاگربەستەکە وەک قۆناغێکی گرنگی جەنگ دژ بە تیرۆریزم بینرا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The magazine's 150th anniversary was an important publishing landmark.""",
                      kurdishText: """ساڵیادی ١٥٠ ساڵەی گۆڤارەکە قۆناغێکی گرنگی بڵاوکردنەوە بوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The film is an important landmark in the history of the cinema.""",
                      kurdishText: """فیلمەکە قۆناغێکی گرنگی مێژووی سینەمایە.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) بینایەک کە زۆر گرنگە بەهۆی مێژووەکەی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The building has been designated a historical landmark.""",
