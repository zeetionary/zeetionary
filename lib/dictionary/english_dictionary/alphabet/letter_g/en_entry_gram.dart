...
class EnglishEntrygram extends StatefulWidget {
  const EnglishEntrygram({super.key});

  @override
  State<EnglishEntrygram> createState() => _EnglishEntrygramState();
}

class _EnglishEntrygramState extends State<EnglishEntrygram> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Add 125 grams of sugar.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gram""",
                      // alsoEnglishWord: "also: gram",
                      britshText: """IpaUK: /ɡræm/""",
                      americanText: """IpaUS: /ɡræm/""",
...
// With short examples define "gram", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) یەکەی پێوانی کێش. ١٠٠٠ گرام هەیە لە یەک کیلۆگرامدا"""),
                    SentencesRow(
                      englishText: """Add 125 grams of sugar.""",
                      kurdishText: """١٢٥ گرام شەکر زیاد بکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """To make this cake, you'll need 175 grams each of sugar and flour, and two eggs.""",
                      kurdishText:
                          """بۆ درووستکردنی ئەم کێکە پێویستیت بە ١٧٥ گرام لە هەر یەکە لە شەکر و ئارد دەبێت، دوو هێلکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/zyyibay7Jzg?t=';
const double _startSecondsend = 00000000000000000000000000015;
const String _videoIdone = 'https://youtu.be/wjYLKhaeKL0?t=';
const double _startSecondsone = 000000000000000000000000000155;
const String _videoIdtwo = 'https://youtu.be/PCuyCJocJWg?t=';
...
const String _videoIdfour = 'https://youtu.be/qWAagS_MANg?t=';
const double _startSecondsfour = 000000000000000000000000000910;
const String _videoIdfive = 'https://youtu.be/dtp6b76pMak?t=';
