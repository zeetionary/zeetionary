...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/axhYc_4jL3Y?t=';
    const double startSecondsone = 0000000000000000000000000003685;
    const String videoIdtwo = 'https://youtu.be/tXjHb5QmDV0?t=';
    const double startSecondstwo = 000000000000000000000000000331;
    const String videoIdthree = 'https://youtu.be/r8E1Hq5tktg?t=';
    const double startSecondsthree = 00000000000000000000000000018;
    const String videoIdfour = 'https://youtu.be/oFKbvpXJ83w?t=';
    const double startSecondsfour = 00000000000000000000000000054;
    const String videoIdfive = 'https://youtu.be/EyuWCLOE-BU?t=';
