...
// Define the word "backlash" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace backlash - replace EnglishEntrybacklash

// replace speakBacklash - /ˈbæklæʃ/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntrybacklash extends StatelessWidget {
  // blank divider
  EnglishEntrybacklash({super.key});
  // blank divider
  ...
  Future<void> speakB3(String languageCode) async {
    ...
    await flutterTts.speak("backlash"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakB3s1(String languageCode) async {
    ...
    await flutterTts.speak(
        "The government is facing an angry backlash from voters over the new tax."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "backlash"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /ˈbæklæʃ/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /ˈbæklæʃ/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find WORD_WEB
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "V3-0OVl_19c";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "OFh5Z-DL8_8";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "mW-C7WE1xOs";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "N4wW85WZMJQ";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "L_ku9YRV2Pg";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "rvfulw6l9Ao";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "ZH-t_XM_wv8";
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  static String myVideoId = "II-OP6vdMs8";
...
// end backlash // TODO Implement this library.
