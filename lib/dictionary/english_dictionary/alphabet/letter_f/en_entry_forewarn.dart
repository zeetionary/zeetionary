...
class EnglishEntryforewarn extends StatefulWidget {
  const EnglishEntryforewarn({super.key});

  @override
  State<EnglishEntryforewarn> createState() => _EnglishEntryforewarnState();
}

class _EnglishEntryforewarnState extends State<EnglishEntryforewarn> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: forewarn (Derived forms: forewarned, forewarning, forewarns)
1. Warn in advance or beforehand; give an early warning (= previse)
"I forewarned him of the trouble that would arise if he showed up at his ex-wife's house";
""",
  );

  final String keyword = "forewarn";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forewarn""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The commander had been forewarned of the attack.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They were forewarned that a storm was approaching.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forewarn""",
                      // alsoEnglishWord: "also: forewarn",
                      britshText: """IpaUK: /fɔːˈwɔːn/""",
                      americanText: """IpaUS: /fɔːrˈwɔːrn/""",
...
// With short examples define "forewarn", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەفسەرەکە پێشوەختە ئاگادارکرابوو لە هێرشەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """They were forewarned that a storm was approaching.""",
                      kurdishText:
                          """ئاگاداری پێشوەختیان پێدرابوو کە زریانێک بەڕێوەیە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/dNKQYjsxgPU?t=';
const double _startSecondsend = 000000000000000000000000000237;
const String _videoIdone = 'https://youtu.be/kBdfcR-8hEY?t=';
const double _startSecondsone = 0000000000000000000000000002715;
const String _videoIdtwo = 'https://youtu.be/deEAegbA8s4?t=';
const double _startSecondstwo = 000000000000000000000000000178;
const String _videoIdthree = 'https://youtu.be/FUrrk4QSnXM?t=';
const double _startSecondsthree = 000000000000000000000000000409;
const String _videoIdfour = 'https://youtu.be/FUrrk4QSnXM?t=';
const double _startSecondsfour = 000000000000000000000000000409;
const String _videoIdfive = 'https://youtu.be/Solb9uA-tgQ?t=';
const double _startSecondsfive = 00000000000000000000000000016853;
