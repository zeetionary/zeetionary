...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001813;
    const String videoIdone = 'https://youtu.be/OPVZcsdy9RY?t=';
    const double startSecondsone = 000000000000000000000000000739;
    const String videoIdtwo = 'https://youtu.be/QUvLJ4larbQ?t=';
    const double startSecondstwo = 000000000000000000000000000119;
    const String videoIdthree = 'https://youtu.be/UJhqHjwBfAg?t=';
    const double startSecondsthree = 000000000000000000000000000174;
    const String videoIdfour = 'https://youtu.be/E0WT1HtB-Sc?t=';
    const double startSecondsfour = 000000000000000000000000000376;
    const String videoIdfive = 'https://youtu.be/ajbooXnvsE8?t=';
