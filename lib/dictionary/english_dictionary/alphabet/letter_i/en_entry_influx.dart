...
class EnglishEntryinflux extends StatefulWidget {
  const EnglishEntryinflux({super.key});

  @override
  State<EnglishEntryinflux> createState() => _EnglishEntryinfluxState();
}

class _EnglishEntryinfluxState extends State<EnglishEntryinflux> {
  @override
  void initState() {
    super.initState();
