...
class EnglishEntryirritate extends StatefulWidget {
  const EnglishEntryirritate({super.key});

  @override
  State<EnglishEntryirritate> createState() => _EnglishEntryirritateState();
}

class _EnglishEntryirritateState extends State<EnglishEntryirritate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: irritate (Derived forms: irritated, irritates, irritating)
1. Cause annoyance in; disturb, especially by minor irritations (- annoy, rag, get to, bother, get at [informal], rile, nark [Brit, slang], nettle, gravel [US], vex, chafe, devil, tick off [informal], roil [N. Amer])
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""irritate""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The way she puts on that accent really irritates me.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""That man really irritates me!""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""At first my contact lenses irritated my eyes.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/GYxpm4Taj7o?t=291';
    const double startSecondsend = 000000000000000000000000000;
    const String videoIdone = 'https://youtu.be/MLd4K5hKosw?t=447';
    const double startSecondsone = 000000000000000000000000000;
    const String videoIdtwo = 'https://youtu.be/lVoGZiL-kns?t=123';
    const double startSecondstwo = 000000000000000000000000000;
    const String videoIdthree = 'https://youtu.be/xzZH151_wXo?t=991';
    const double startSecondsthree = 000000000000000000000000000;
    const String videoIdfour = 'https://youtu.be/41agvCBlicE?t=181';
    const double startSecondsfour = 000000000000000000000000000;
    const String videoIdfive = 'https://youtu.be/fbJgzZnIHUo?t=369';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """irritate""",
                      // alsoEnglishWord: "also: irritate",
                      britshText: """IpaUK: /ˈɪrɪteɪt/""",
                      americanText: """IpaUS: /ˈɪrɪteɪt/""",
...
// کوردی:
// """),
// With short examples define "irritate", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) بێزارکردنی کەسێک، زیاتر بەوەی کە شتێک بەردەوام بکەیت یان شتێک بەردەوام ڕووبدات"""),
                    SentencesRow(
                      englishText:
                          """The way she puts on that accent really irritates me.""",
                      kurdishText:
                          """شێوازی بەکارهێنانی ئەو ئەکسێنتەی بەڕاستی بێزارم دەکات.""",
                    ...
                    SentencesRow(
                      englishText: """That man really irritates me!""",
                      kurdishText: """ئەو پیاوە بەڕاستی بێزارم دەکات!""",
                    ...
                    SentencesRow(
                      englishText:
                          """She was irritated by his continued refusal to believe her.""",
                      kurdishText:
                          """بێزار بوو بە ڕەتکردنەوەی بەردەوامی کە باوەڕی پێ بکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سەرەتا عەدەسەکانم ئازاری چاوەکانمیان دەدا.""",
