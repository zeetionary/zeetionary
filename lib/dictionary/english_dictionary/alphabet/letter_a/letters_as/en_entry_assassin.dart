...
class EnglishEntryassassin extends StatelessWidget {
  ...
  Future<void> speakassassin(String languageCode) async {
    ...
    await flutterTts.speak("assassin");
  }
  ...
  Future<void> speakassassin958(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("He was killed by a hired assassin.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "assassin"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈsæsɪn/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈsæsn/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'jLP6QUOoNcw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'bdzK-pTadQs';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'bCzlRdnn6r8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'T-Etuazfk_0';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'CZ6oNlZJXL0';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'Aq1871YNaWA';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'nWP0yyaGt7c';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = '3LWCYJHrKOs';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'PfGoqqKT020';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'uuS2fElxXn0';
