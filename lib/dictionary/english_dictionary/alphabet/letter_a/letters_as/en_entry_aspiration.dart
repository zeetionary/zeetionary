...
class EnglishEntryaspiration extends StatelessWidget {
  ...
  Future<void> speakaspiration(String languageCode) async {
    ...
    await flutterTts.speak("aspiration");
  }
  ...
  Future<void> speakaspiration709(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I didn't realize you had political aspirations.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "aspiration"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌæspəˈreɪʃn/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌæspəˈreɪʃn/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'FK8JfsXwZpo';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'WBHkRTyscOw';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'z2HneqfZGsM';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'nPr-SIL6BiQ';
