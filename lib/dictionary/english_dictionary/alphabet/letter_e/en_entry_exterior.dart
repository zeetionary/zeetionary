...
class EnglishEntryexterior extends StatefulWidget {
  const EnglishEntryexterior({super.key});

  @override
  State<EnglishEntryexterior> createState() => _EnglishEntryexteriorState();
}

class _EnglishEntryexteriorState extends State<EnglishEntryexterior> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exterior""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exterior""",
                      // alsoEnglishWord: "also: exterior",
                      britshText: """IpaUK: /ɪkˈstɪəriə(r)/""",
                      americanText: """IpaUS: /ɪkˈstɪriər/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The exterior of the house needs painting.""");
  }
...
کوردی: دەروەیی، دەرەکی،	دەرەوە، ڕووکاری دەرەوە، دیمەنی دەرەوە، ڕووی دەرەوە، ڕواڵەت، ڕووکەش
"""),
          ...
          SentencesRow(
            englishText:
                """Beneath his confident exterior, he was desperately nervous.""",
            kurdishText: """لە ژێر ڕووی متمانەبەخۆبووی، تەواو شڵەژاو بوو.""",
          ...
          SentencesRow(
            englishText:
                """The exterior lights of the house came on as I approached the door.""",
            kurdishText:
                """ڕۆشناییەکانی دەرەوەی خانووەکە دەرکەوتن کە نزیک لە دەرگاکە بوومەوە.""",
...
const double _startSecondsend = 000000000000000000000000000598;
const String _videoIdone = 'https://youtu.be/a9m3GD0DbPY?t=';
const double _startSecondsone = 0000000000000000000000000001388;
const String _videoIdtwo = 'https://youtu.be/KQWGHE7NTUA?t=';
const double _startSecondstwo = 000000000000000000000000000563;
const String _videoIdthree = 'https://youtu.be/m6kcANnAJSo?t=';
const double _startSecondsthree = 000000000000000000000000000137;
const String _videoIdfour = 'https://youtu.be/iqhK6QGehtQ?t=';
const double _startSecondsfour = 000000000000000000000000000774;
const String _videoIdfive = 'https://youtu.be/DxL2HoqLbyA?t=';
const double _startSecondsfive = 000000000000000000000000000896;
