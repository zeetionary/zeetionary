...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She stroked the baby's fuzzy head.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts
        .speak("""Oh no, it's raining - my hair will get all fuzzy.""");
  }
...
"""),
                    ...
                    SentencesRow(
                      englishText: """She stroked the baby's fuzzy head.""",
                      kurdishText:
                          """دەستی دەھێنا بە سەرە کوڵکنەکەی منداڵەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئاھ نا، بارانە ـ قژەکەم تەواو لوول دەبێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەنگەکە لە ھەندێک شوێن ناڕوونە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """میشکم کەمێک جەنجاڵە لە دوای ئەو ھەموو شەرابەی شەوی ڕابردوو.""",
...
const String _videoIdone = '4RlBVzUCYek';
const double _startSecondsone = 1005;
const String _videoIdtwo = '1j_k5WCFShQ';
const double _startSecondstwo = 595;
const String _videoIdthree = 'PqpCeiYycVM';
const double _startSecondsthree = 748;
const String _videoIdfour = 'yH2FPSupO6c';
const double _startSecondsfour = 53;
const String _videoIdfive = 'Wao0_uB4Zw4';
