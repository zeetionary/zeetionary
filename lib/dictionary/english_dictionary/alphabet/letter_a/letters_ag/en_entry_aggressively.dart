...
// replace these: replace EnglishEntryaggressively - replace speakAggressively - replace aggressively - /əˈɡresɪvli/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaggressively extends StatelessWidget {
  EnglishEntryaggressively({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "aggressively", // DOPSUM: CHANGE WORD ENTRY - Find /əˈɡresɪvli/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈɡresɪvli/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'K83zdXu2xrw';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'cmw3SO42VVo';
