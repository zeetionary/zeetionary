...
class EnglishEntryenforceable extends StatefulWidget {
  const EnglishEntryenforceable({super.key});

  @override
  State<EnglishEntryenforceable> createState() =>
      _EnglishEntryenforceableState();
}

class _EnglishEntryenforceableState extends State<EnglishEntryenforceable> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enforceable""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enforceable""",
                      // alsoEnglishWord: "also: enforceable",
                      britshText: """IpaUK: /ɪnˈfɔːsəbl/""",
                      americanText: """IpaUS: /ɪnˈfɔːrsəbl/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enforceable";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""A gambling debt is not legally enforceable.""");
  }
...
کوردی: شیاوی جێبەجێ‌کردن، شیاوی بەجێ‌هێنان، لەجێبەجێ‌کردن‌هاتوو
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە کەسێک لە دەسەڵات دەکرێت بیخاتە بواری جێبەجێکردنەوە"""),
          SentencesRow(
            englishText: """A gambling debt is not legally enforceable.""",
            kurdishText:
                """قەرزی قومار لە ڕووی یاساییەوە لەجێبەجێ‌کردن‌هاتوو نییە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The guidelines are legally enforceable.""",
            kurdishText:
                """ڕێنماییەکان لە ڕووی ئاساییەوە لەجێبەجێ‌کردن‌هاتوون.""",
...
"A contract is essentially a legally enforceable promise"
""",
  );
...
const String _videoIdend = 'https://youtu.be/j4kI2h3iotA?t=';
const double _startSecondsend = 1697;
const String _videoIdone = 'https://youtu.be/NG4Ws74RV04?t=';
const double _startSecondsone = 435;
const String _videoIdtwo = 'https://youtu.be/RJQPthD9rx8?t=';
const double _startSecondstwo = 491;
const String _videoIdthree = 'https://youtu.be/-2gV8LaH9SQ?t=';
const double _startSecondsthree = 1639;
const String _videoIdfour = 'https://youtu.be/eXcwJ3EDahw?t=';
const double _startSecondsfour = 575;
const String _videoIdfive = 'https://youtu.be/8NDLpSUcV5E?t=';
const double _startSecondsfive = 158;
const String _videoIdsix = 'https://youtu.be/wcMLFMsIVis?t=';
const double _startSecondssix = 900;
