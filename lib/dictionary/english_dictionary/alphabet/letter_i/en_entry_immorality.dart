...
class EnglishEntryimmorality extends StatefulWidget {
  const EnglishEntryimmorality({super.key});

  @override
  State<EnglishEntryimmorality> createState() => _EnglishEntryimmoralityState();
}

class _EnglishEntryimmoralityState extends State<EnglishEntryimmorality> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: immorality (Derived forms: immoralities)
1. The quality of not being in accord with standards of right or good conduct
"the immorality of basing the defence of the West on the threat of mutual assured destruction"
 
2. Morally objectionable behaviour (- evil, wickedness, iniquity)
""",
  );

  final String keyword = "immorality";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""immorality""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We attempted to show the immorality of the war.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """They are worried about rampant drug abuse and sexual immorality.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/R3FUb7oXk50?t=';
    const double startSecondsend = 000000000000000000000000000228;
    const String videoIdone = 'https://youtu.be/pSFc9hCNq9E?t=';
    const double startSecondsone = 000000000000000000000000000397;
    const String videoIdtwo = 'https://youtu.be/mXpwgg5TxOU?t=';
    const double startSecondstwo = 00000000000000000000000000055;
    const String videoIdthree = 'https://youtu.be/6tYxnt3gCyI?t=';
    const double startSecondsthree = 000000000000000000000000000460;
    const String videoIdfour = 'https://youtu.be/yGbv-watbbw?t=';
    const double startSecondsfour = 000000000000000000000000000927;
    const String videoIdfive = 'https://youtu.be/HF9zRqlN4T0?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """immorality""",
                      // alsoEnglishWord: "also: immorality",
                      britshText: """IpaUK: /ˌɪməˈræləti/""",
                      americanText: """IpaUS: /ˌɪməˈræləti/""",
...
کوردی: بێ‌ڕەوشتی، بێ‌ئەخلاقی، بەدئاکاری، هەرزەیی، بێ‌سەروبەرەیی، فەساد
"""),
// With short examples define "immorality", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕەفتارێک کە لەلایەن زۆر کەسەوە بە باش دانانرێت"""),
                    SentencesRow(
                      englishText:
                          """We attempted to show the immorality of the war.""",
                      kurdishText:
                          """هەوڵمان دا بێ‌ئەخلاقی جەنگ پیشان بدەین.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ڕەفتارێک کە پابەند نییە بە ستانداردە پەسەندکراوەکانی هەڵسووکەوتی سێکسی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """They are worried about rampant drug abuse and sexual immorality.""",
                      kurdishText:
                          """نیگەرانن سەبارەت بە بەکارهێنانی مادەی هۆشبەر و بێ‌ڕەوشتی سێکسی.""",
