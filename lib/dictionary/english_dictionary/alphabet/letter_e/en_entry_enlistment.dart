...
class EnglishEntryenlistment extends StatefulWidget {
  const EnglishEntryenlistment({super.key});

  @override
  State<EnglishEntryenlistment> createState() => _EnglishEntryenlistmentState();
}

class _EnglishEntryenlistmentState extends State<EnglishEntryenlistment> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enlistment""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enlistment""",
                      // alsoEnglishWord: "also: enlistment",
                      britshText: """IpaUK: /ɪnˈlɪstmənt/""",
                      americanText: """IpaUS: /ɪnˈlɪstmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enlistment";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The enlistment of chefs was part of her campaign against childhood obesity.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ڕازیکردنی کەسێک لەوەی یارمەتیت بدات یان پەیوەندیت پێوە بکات لە کردنی شتێکدا"""),
          SentencesRow(
            englishText:
                """The enlistment of chefs was part of her campaign against childhood obesity.""",
            kurdishText:
                """گرتنی چێشتلێنەر بەشێک بوو لە هەوڵەکانی بۆ وەستانەوە دژ بە قەڵەوی منداڵان.""",
          ...
          SentencesRow(
            englishText:
                """One possibility would be to increase the maximum age for enlistment to 40.""",
            kurdishText:
                """ئەگەرێک ئەوەی بەرزترین تەمەنی چوونە سوپا بۆ ٤٠ ساڵان زیاد بکرێت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: enlistment (Derived forms: enlistments)
1. A period of time spent in military, diplomatic or other service (= hitch, term of enlistment, tour of duty, duty tour, tour)
...
const String _videoIdend = 'https://youtu.be/nPr-SIL6BiQ?t=';
const double _startSecondsend = 158;
const String _videoIdone = 'https://youtu.be/7wCmtr4GFFc?t=';
const double _startSecondsone = 651;
const String _videoIdtwo = 'https://youtu.be/5r90DYjZ76g?t=';
const double _startSecondstwo = 494;
const String _videoIdthree = 'https://youtu.be/CTsLdVvMev8?t=';
...
const String _videoIdfive = 'https://youtu.be/YOHpNTjE1bo?t=';
const double _startSecondsfive = 197;
const String _videoIdsix = 'https://youtu.be/Lg-nUy2DalM?t=';
const double _startSecondssix = 914;
