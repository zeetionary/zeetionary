...
class EnglishEntryartificially extends StatelessWidget {
  ...
  Future<void> speakartificially(String languageCode) async {
    ...
    await flutterTts.speak("artificially");
  }
  ...
  Future<void> speakartificially956(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("They are keeping their prices artificially low.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "artificially"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌɑːtɪˈfɪʃəli/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌɑːrtɪˈfɪʃəli/"),
...
کوردی: بەشێوەیەکی دەستکرد یان نائاسایی، دەستکردانە
"""),
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'PlDbfq2HKuA';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'CMtF7nxMv5A';
