...
class EnglishEntryluncheon extends StatefulWidget {
  const EnglishEntryluncheon({super.key});

  @override
  State<EnglishEntryluncheon> createState() => _EnglishEntryluncheonState();
}

class _EnglishEntryluncheonState extends State<EnglishEntryluncheon> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryluncheon luncheon
WORD_WEB luncheon luncheon luncheon
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "luncheon";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""luncheon""");
  }
...
کوردی: 
"""),
// With short examples define "luncheon", please follow LX instructions
