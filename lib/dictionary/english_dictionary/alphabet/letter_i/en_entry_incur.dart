...
class EnglishEntryincur extends StatefulWidget {
  const EnglishEntryincur({super.key});

  @override
  State<EnglishEntryincur> createState() => _EnglishEntryincurState();
}

class _EnglishEntryincurState extends State<EnglishEntryincur> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: incur (Derived forms: incurs, incurred, incurring)
1. Make oneself subject to; bring upon oneself; become liable to
"People who smoke incur a great danger to their health"
 
2. Be subject to a specified treatment or analysis (- receive, get, find, obtain)
"These aspects of civilization do not find expression or incur an interpretation";
""",
  );

  final String keyword = "incur";
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001224;
    const String videoIdone = 'https://youtu.be/YrMGIqecu0Y?t=';
    const double startSecondsone = 000000000000000000000000000507;
    const String videoIdtwo = 'https://youtu.be/SHfqtaa0VI8?t=';
    const double startSecondstwo = 000000000000000000000000000490;
    const String videoIdthree = 'https://youtu.be/eweyhaE6mpI?t=';
    const double startSecondsthree = 000000000000000000000000000261;
    const String videoIdfour = 'https://youtu.be/2ONXCig9pf4?t=';
    const double startSecondsfour = 000000000000000000000000000460;
    const String videoIdfive = 'https://youtu.be/RJQPthD9rx8?t=';
    const double startSecondsfive = 000000000000000000000000000136;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """incur""",
                      // alsoEnglishWord: "also: incur",
                      britshText: """IpaUK: /ɪnˈkɜː(r)/""",
                      americanText: """IpaUS: /ɪnˈkɜːr/""",
...
کوردی: 
"""),
// With short examples define "incur", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) کە دەکەویتە دۆخێکی ناخۆش و دەبێت مامەڵەی لەگەڵ بکەیت"""),
                    SentencesRow(
                      englishText:
                          """She had incurred the wrath of her father by marrying without his consent.""",
                      kurdishText:
                          """تووشی غەزەبی باوکی بووبوو بە هاوسەرگیریکردن بەبێ ڕەزامەندیی.""",
