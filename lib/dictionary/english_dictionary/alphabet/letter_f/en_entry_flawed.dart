...
class EnglishEntryflawed extends StatefulWidget {
  const EnglishEntryflawed({super.key});

  @override
  State<EnglishEntryflawed> createState() => _EnglishEntryflawedState();
}

class _EnglishEntryflawedState extends State<EnglishEntryflawed> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flawed
1. Having a blemish or flaw (= blemished)
"a flawed diamond";
""",
  );

  final String keyword = "flawed";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Diamonds are still valuable, even when they are flawed.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His argument is deeply flawed.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flawed""",
                      // alsoEnglishWord: "also: flawed",
                      britshText: """IpaUK: /flɔːd/""",
                      americanText: """IpaUS: /flɔːd/""",
...
کوردی: ناتەواو، نیوەچڵ، عەیب‌دار، خەوش‌دار، بەگەرد،	هەڵە، شاشی
"""),
// With short examples define "flawed", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە تەواو نییە؛ کە هەڵە یان خەوشییەکی تیایە"""),
                    SentencesRow(
                      englishText:
                          """Diamonds are still valuable, even when they are flawed.""",
                      kurdishText:
                          """ئەڵماس هێشتا بەبەهایە، تەنانەت ئەگەر خەوشی تێدا بێت.""",
                    ...
                    SentencesRow(
                      englishText: """His argument is deeply flawed.""",
                      kurdishText: """مشتومڕەکەی تەواو هەڵەیە.""",
...
const double _startSecondsone = 000000000000000000000000000406;
const String _videoIdtwo = 'https://youtu.be/oI_X2cMHNe0?t=';
const double _startSecondstwo = 000000000000000000000000000944;
const String _videoIdthree = 'https://youtu.be/92Yb6vY8vUY?t=';
const double _startSecondsthree = 000000000000000000000000000516;
const String _videoIdfour = 'https://youtu.be/Y8hi6A5MPVY?t=';
const double _startSecondsfour = 000000000000000000000000000254;
const String _videoIdfive = 'https://youtu.be/zvBiIvKUiOQ?t=';
