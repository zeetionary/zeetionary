...
class EnglishEntrygulp extends StatefulWidget {
  const EnglishEntrygulp({super.key});

  @override
  State<EnglishEntrygulp> createState() => _EnglishEntrygulpState();
}

class _EnglishEntrygulpState extends State<EnglishEntrygulp> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: gulp (Derived forms: gulping, gulped, gulps)
1. To swallow hurriedly, greedily or in one draught (- quaff, swig, neck [Brit, informal], slug [informal])
"The men gulped down their beers";
 
2. Utter or make a noise, as when swallowing too quickly
"He gulped for help after choking on a big piece of meat"

- Noun: gulp (Derived forms: gulps)
1. A large and hurried swallow (- draft [N. Amer], draught [Brit, Cdn], swig)
"he finished it at a single gulp";
 
2. A spasmodic reflex of the throat made as if in swallowing (- gulping)
 
3. A large mouthful of drink (- slug, draught [Brit], draft [US])
""",
  );

  final String keyword = "gulp";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He gulped down the rest of his tea and went out.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She gulped nervously before trying to answer.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Keith swam to the surface and gulped for air.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He took a gulp of coffee.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She took a large gulp of water from the bottle.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He drank the glass of juice in one gulp.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gulp""",
                      // alsoEnglishWord: "also: gulp",
                      britshText: """IpaUK: /ɡʌlp/""",
                      americanText: """IpaUS: /ɡʌlp/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) قوتدانی ڕێژەیەکی زۆر لە ئاو و خۆراک بە خێرایی"""),
                    SentencesRow(
                      englishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """قومێکی گەورەی لە ئاوی بوتڵەکە دا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """گڵاسە شەربەتەکەی بە یەک قوم خواردەوە.""",
