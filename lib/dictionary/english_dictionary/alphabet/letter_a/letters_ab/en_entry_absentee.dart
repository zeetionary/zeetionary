...
class EnglishEntryabsentee extends StatefulWidget {
  const EnglishEntryabsentee({super.key});

  @override
  State<EnglishEntryabsentee> createState() => _EnglishEntryabsenteeState();
}

class _EnglishEntryabsenteeState extends State<EnglishEntryabsentee> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""absentee""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """absentee""",
                      // alsoEnglishWord: "also: absentee",
                      britshText: """IpaUK: /ˌæbsənˈtiː/""",
                      americanText: """IpaUS: /ˌæbsənˈtiː/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '9xYQO1Ja0Yc';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'BJPKUw8QIlk';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'YikMbBSPY1w';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'YyV_9nsEGgM';
