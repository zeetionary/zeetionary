...
class EnglishEntryfortnightly extends StatefulWidget {
  const EnglishEntryfortnightly({super.key});

  @override
  State<EnglishEntryfortnightly> createState() =>
      _EnglishEntryfortnightlyState();
}

class _EnglishEntryfortnightlyState extends State<EnglishEntryfortnightly> {
  @override
  void initState() {
    super.initState();
...
Usage: Brit
1. Occurring every two weeks (= biweekly)

- Adverb: fortnightly
Usage: Brit
1. Every two weeks (= biweekly)
"he visited his cousins fortnightly";

- Noun: fortnightly (Derived forms: fortnightlies)
1. A publication put out every two weeks
""",
  );

  final String keyword = "fortnightly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fortnightly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Meetings take place at fortnightly intervals.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The committee meets fortnightly.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fortnightly""",
                      // alsoEnglishWord: "also: fortnightly",
                      britshText: """IpaUK: /ˈfɔːtnaɪtli/""",
                      americanText: """IpaUS: /ˈfɔːrtnaɪtli/""",
...
کوردی: دووهەفتەیی، لامانگە، (هەر) دوو هەفتە جارێ، دووهەفتەنامە
"""),
// With short examples define "fortnightly", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) دوو هەفتە جارێک"""),
                    SentencesRow(
                      englishText:
                          """Meetings take place at fortnightly intervals.""",
                      kurdishText: """کۆبوونەوە دوو هەفتە جارێک ڕوودەدەن.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵکار) بەشێوەی دوو هەفتە جارێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The committee meets fortnightly.""",
                      kurdishText: """لیژنەکە دوو هەفتە جارێک کۆدەبێتەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/T1qjjr2V-7g?t=';
const double _startSecondsend = 000000000000000000000000000476;
const String _videoIdone = 'https://youtu.be/n9IxomBusuw?t=';
const double _startSecondsone = 0000000000000000000000000005034;
const String _videoIdtwo = 'https://youtu.be/3e-U5piiEow?t=';
const double _startSecondstwo = 000000000000000000000000000597;
const String _videoIdthree = 'https://youtu.be/n9IxomBusuw?t=';
const double _startSecondsthree = 0000000000000000000000000005034;
const String _videoIdfour = 'https://youtu.be/RYDiDpW2VkM?t=';
const double _startSecondsfour = 00000000000000000000000000027226;
const String _videoIdfive = 'https://youtu.be/enzzn9wnoFc?t=';
