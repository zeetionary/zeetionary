                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "alliance"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈlaɪəns/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈlaɪəns/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '5p_a9QiL-hA';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'NrxlBuuSydA';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'UOdYqkKiIF0';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'S3PcdReHat8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'XxeMHZkaYY0';
