...
class EnglishEntryforeground extends StatefulWidget {
  const EnglishEntryforeground({super.key});

  @override
  State<EnglishEntryforeground> createState() => _EnglishEntryforegroundState();
}

class _EnglishEntryforegroundState extends State<EnglishEntryforeground> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foreground (Derived forms: foregrounds)
1. The part of a scene that is near the viewer
 
2. (computing) a window for an active application

- Verb: foreground (Derived forms: foregrounded, foregrounds, foregrounding)
1. Emphasise or focus on to make more important or prominent (= highlight, spotlight, play up)
"The introduction foregrounded the speaker's distinguished career in linguistics";
""",
  );

  final String keyword = "foreground";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foreground""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The figure in the foreground is the artist's mother.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This issue is very much in the foreground.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foreground""",
                      // alsoEnglishWord: "also: foreground",
                      britshText: """IpaUK: /ˈfɔːɡraʊnd/""",
                      americanText: """IpaUS: /ˈfɔːrɡraʊnd/""",
...
کوردی: پێش‌خان، پێشەوە، بەشی پێشەوەی دیمەن، وێنەیێ و هتد، نزیک‌ترین بەش لە بینەرەوە،	(خوازە) جێگای سەرنج،	دیارترین شوێن
"""),
// With short examples define "foreground", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بەشی پێشەوەی دیمەنێک، وێنەیەک، هتد کە سەیری دەکەیت"""),
                    SentencesRow(
                      englishText:
                          """The figure in the foreground is the artist's mother.""",
                      kurdishText: """ئەو کەسەی پێشەوە دایکی هونەرمەندەکەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بابەتەکە تەواو لە بەرباسە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The play foregrounds the relationship between father and daughter.""",
                      kurdishText:
                          """شانۆکە گرنگی تایبەتیی بە پەیوەندیی باوک و کچ دەدات.""",
...
const double _startSecondsone = 0000000000000000000000000001004;
const String _videoIdtwo = 'https://youtu.be/KOnk7Nbqkhs?t=';
const double _startSecondstwo = 00000000000000000000000000017;
const String _videoIdthree = 'https://youtu.be/WfVF-Ec4naQ?t=';
const double _startSecondsthree = 000000000000000000000000000485;
const String _videoIdfour = 'https://youtu.be/4U2ZxO7b8iM?t=';
const double _startSecondsfour = 000000000000000000000000000971;
const String _videoIdfive = 'https://youtu.be/iErqWGwso7o?t=';
