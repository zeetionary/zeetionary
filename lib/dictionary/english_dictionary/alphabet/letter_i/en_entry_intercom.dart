...
class EnglishEntryintercom extends StatefulWidget {
  const EnglishEntryintercom({super.key});

  @override
  State<EnglishEntryintercom> createState() => _EnglishEntryintercomState();
}

class _EnglishEntryintercomState extends State<EnglishEntryintercom> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intercom""");
  }
