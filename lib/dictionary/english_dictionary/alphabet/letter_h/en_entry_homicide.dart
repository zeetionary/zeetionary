...
class EnglishEntryhomicide extends StatefulWidget {
  const EnglishEntryhomicide({super.key});

  @override
  State<EnglishEntryhomicide> createState() => _EnglishEntryhomicideState();
}

class _EnglishEntryhomicideState extends State<EnglishEntryhomicide> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: homicide (Derived forms: homicides)
1. The killing of a human being by another human being
"Chicago set the homicide record"
""",
  );

  final String keyword = "homicide";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""homicide""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He has been arrested on homicide charges.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was convicted of homicide.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 000000000000000000000000000508;
    const String videoIdtwo = 'https://youtu.be/BztMgcNgobk?t=';
    const double startSecondstwo = 000000000000000000000000000987;
    const String videoIdthree = 'https://youtu.be/kn-h78tuNiU?t=';
    const double startSecondsthree = 000000000000000000000000000368;
    const String videoIdfour = 'https://youtu.be/KT18KJouHWg?t=';
    const double startSecondsfour = 0000000000000000000000000001229;
    const String videoIdfive = 'https://youtu.be/9-8pkESUztc?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homicide""",
                      // alsoEnglishWord: "also: homicide",
                      britshText: """IpaUK: /ˈhɒmɪsaɪd/""",
                      americanText: """IpaUS: /ˈhɑːmɪsaɪd/""",
...
// With short examples define "homicide", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """He was convicted of homicide.""",
                      kurdishText: """بە پیاوکوژی ناسێندرا.""",
