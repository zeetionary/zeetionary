...
class EnglishEntryineffectiveness extends StatefulWidget {
  const EnglishEntryineffectiveness({super.key});

  @override
  State<EnglishEntryineffectiveness> createState() =>
      _EnglishEntryineffectivenessState();
}

class _EnglishEntryineffectivenessState
    extends State<EnglishEntryineffectiveness> {
  @override
  void initState() {
    super.initState();
...
1. Lacking the power to be effective (- ineffectualness, ineffectuality, effeteness, wetness [Brit, informal])
""",
  );

  final String keyword = "ineffectiveness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ineffectiveness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The medicine’s ineffectiveness was obvious after no change.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/lVQFRJFge3E?t=';
    const double startSecondsend = 000000000000000000000000000310;
    const String videoIdone = 'https://youtu.be/Tv3DFbFAM8A?t=';
    const double startSecondsone = 000000000000000000000000000424;
    const String videoIdtwo = 'https://youtu.be/gd6rIngnSCA?t=';
    const double startSecondstwo = 000000000000000000000000000765;
    const String videoIdthree = 'https://youtu.be/PHm2I9V4q2A?t=';
    const double startSecondsthree = 0000000000000000000000000001278;
    const String videoIdfour = 'https://youtu.be/t6kmm70ji5c?t=';
    const double startSecondsfour = 0000000000000000000000000003771;
    const String videoIdfive = 'https://youtu.be/nUM5WgmNTPE?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: ineffectiveness",
                      britshText: """IpaUK: /ˌɪnɪˈfektɪvnəs/""",
                      americanText: """IpaUS: /ˌɪnɪˈfektɪvnəs/""",
...
کوردی: ناکاریگەربوون،	لێنەوەشاوەیی، لێنەهاتوویی، بەکارنەهاتوویی، توانایی‌نەماوی، هیچ‌لەدەس‌نەهاتوویی
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە شتێک ئەنجامی مەبەست یان سەرکەوتوو بەدەست نەهێنێت"""),
                    SentencesRow(
                      englishText:
                          """The medicine’s ineffectiveness was obvious after no change.""",
                      kurdishText:
                          """ناکاریگەری دەرمانەکە ڕوون بوو لە دوای هیچ گۆڕانکارییەک.""",
