...
class EnglishEntryhereabouts extends StatefulWidget {
  const EnglishEntryhereabouts({super.key});

  @override
  State<EnglishEntryhereabouts> createState() => _EnglishEntryhereaboutsState();
}

class _EnglishEntryhereaboutsState extends State<EnglishEntryhereabouts> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: hereabouts
1. In this general vicinity (- hereabout)
"the people are friendly hereabouts";
""",
  );

  final String keyword = "hereabouts";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hereabouts""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There aren't many houses hereabouts.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hereabouts""",
                      // alsoEnglishWord: "also: hereabouts",
                      britshText: """IpaUK: /ˌhɪərəˈbaʊts/""",
                      americanText: """IpaUS: /ˌhɪrəˈbaʊts/""",
...
کوردی: لەم دەوروبەرە، لەم نزیکی‌یانە، لە دەوروبەری ئێرە، لە ئەمێ‌یانە
"""),
// With short examples define "hereabouts", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) نزیک ئەم شوێنە"""),
                    SentencesRow(
                      englishText: """There aren't many houses hereabouts.""",
                      kurdishText: """زۆر خانوو نییە لەم نزیکانە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/nC5ghtpeL6I?t=';
const double _startSecondsend = 000000000000000000000000000762;
const String _videoIdone = 'https://youtu.be/jo40xoJP1hQ?t=';
const double _startSecondsone = 0000000000000000000000000002452;
const String _videoIdtwo = 'https://youtu.be/li-1i222Icg?t=';
const double _startSecondstwo = 000000000000000000000000000399;
const String _videoIdthree = 'https://youtu.be/iDVxOg_R0rc?t=';
const double _startSecondsthree = 0000000000000000000000000004152;
const String _videoIdfour = 'https://youtu.be/JyZ5Zb7SLn8?t=';
const double _startSecondsfour = 0000000000000000000000000001462;
const String _videoIdfive = 'https://youtu.be/gE7BAKUkQD4?t=';
const double _startSecondsfive = 000000000000000000000000000858;
