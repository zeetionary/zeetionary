...
// Define the word "ATM" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryatm - replace speakAtm

// replace ATM - /ˌeɪ tiː ˈem/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryatm extends StatelessWidget {
  // blank divider
  EnglishEntryatm({super.key});
  // blank divider
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAtm(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˌeɪ tiː ˈem/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
- Noun: ATM (derived forms: ATMs)
1. A means of digital communications that is capable of very high speeds; suitable for transmission of images, voice or video as well as data (= asynchronous transfer mode)
"ATM is used for both LAN and WAN";
 
2. An unattended machine (outside some banks) that dispenses money when a personal coded card is used (= cash machine [Brit, Cdn], cash dispenser [Brit], automated teller machine, automatic teller machine, automated teller, automatic teller, hole-in-the-wall [UK, informal], cashpoint [UK])
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "sxt4YCIsn2I";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "MlldVbmz4oQ";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "5Wq0yv73NpY";
