...
class EnglishEntryhypocritical extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hypocritical""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '9X5Vuh4U5Wo';
    const double startSecondsend = 55;
    const String videoIdone = 'sULBN9ptwsg';
    const double startSecondsone = 1306;
    const String videoIdtwo = 'lipa6JGLLQU';
    const double startSecondstwo = 84;
    const String videoIdthree = 'Gfj5f0GVLZ0';
    const double startSecondsthree = 647;
    const String videoIdfour = 'kvHHa_6zVxU';
    const double startSecondsfour = 149;
    const String videoIdfive = 'oXPhvh4eGcM';
    const double startSecondsfive = 663;
