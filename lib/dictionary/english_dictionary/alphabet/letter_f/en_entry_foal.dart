...
class EnglishEntryfoal extends StatefulWidget {
  const EnglishEntryfoal({super.key});

  @override
  State<EnglishEntryfoal> createState() => _EnglishEntryfoalState();
}

class _EnglishEntryfoalState extends State<EnglishEntryfoal> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foal (Derived forms: foals)
1. A young horse

- Verb: foal (Derived forms: foaled, foaling, foals)
1. Give birth to a foal
"the mare foaled"
""",
  );

  final String keyword = "foal";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The mare gave birth to a healthy foal last night.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foal""",
                      // alsoEnglishWord: "also: foal",
                      britshText: """IpaUK: /fəʊl/""",
                      americanText: """IpaUS: /fəʊl/""",
...
کوردی: جوانوو، بێچووە ئەسپ، جاشک، کەرکوڵ
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) بێچووە ئەسپ یان گوێدرێژ"""),
                    SentencesRow(
                      englishText:
                          """The mare gave birth to a healthy foal last night.""",
                      kurdishText:
                          """مایینەکە دوێنێ شەو بێچوویەکی تەندرووستی بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/1eJBwHVw--E';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/EeXDKMAhZbs?t=';
const double _startSecondsone = 00000000000000000000000000069;
const String _videoIdtwo = 'https://youtu.be/AZ9TMQSYI7I?t=';
const double _startSecondstwo = 00000000000000000000000000092;
const String _videoIdthree = 'https://youtu.be/3oxGoLVLpSg?t=';
const double _startSecondsthree = 00000000000000000000000000079;
const String _videoIdfour = 'https://youtu.be/DM48e9UClv8?t=';
const double _startSecondsfour = 00000000000000000000000000059;
const String _videoIdfive = 'https://youtu.be/1OCVeqZuk3I?t=';
