...
class EnglishEntryliner extends StatefulWidget {
  const EnglishEntryliner({super.key});

  @override
  State<EnglishEntryliner> createState() => _EnglishEntrylinerState();
}

class _EnglishEntrylinerState extends State<EnglishEntryliner> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: liner (Derived forms: liners)
1. A large commercial ship (especially one that carries passengers on a regular schedule) (- ocean liner)
 
2. A protective covering that protects an inside surface (- lining)
 
3. A piece of cloth that is used as the inside surface of a garment (- lining)
 
4. (baseball) a hit that flies straight out from the batter (- line drive)
"the batter hit a liner to the shortstop";
""",
  );

  final String keyword = "liner";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He got a job on a cruise liner.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Heat the oven to 170°C and fill your baking tin with paper cupcake liners.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Using a black liquid liner, trace a line above your upper eyelashes.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/PYS3UZFPJWI?t=954';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/raSeaAeryWE?t=1078';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/5UxfEHeLzqE?t=12';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/qMeFQvpAE1w?t=7';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/qz0V4t0f68w?t=348';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/CJUKVmkRx_E?t=507';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """liner""",
                      // alsoEnglishWord: "also: liner",
                      britshText: """IpaUK: /ˈlaɪnə(r)/""",
                      americanText: """IpaUS: /ˈlaɪnər/""",
...
کوردی: 
"""),
// With short examples define "liner", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) کەشتییەکی گەورە کە گەشتیار هەڵدەگرێت"""),
                    SentencesRow(
                      englishText: """He got a job on a cruise liner.""",
                      kurdishText: """کارێکی دۆزییەوە لە کەشتییەکی گەشتیاری.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) شتێک کە بەکاردێت بۆ داپۆشینی ناوەوەی شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Heat the oven to 170°C and fill your baking tin with paper cupcake liners.""",
                      kurdishText: """فڕنەکە گەرم بکە بۆ پلەی ١٧٠ پلەی سیلیزی و قاڵبی شیرینییەکەت پڕ بکە لە داپۆشەری کاغەزیی کێک.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) مەیکەپ کە لە قەراغی چاو یان شوێنێکی دیکە دەدرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Using a black liquid liner, trace a line above your upper eyelashes.""",
                      kurdishText: """بە بەکارهێنانی خەتکێشێکی ڕەشی شل، هێڵێک بکێشە لە سەرووی برژانگەکانی سەرەوەت.""",
