...
class EnglishEntryincentive extends StatefulWidget {
  const EnglishEntryincentive({super.key});

  @override
  State<EnglishEntryincentive> createState() => _EnglishEntryincentiveState();
}

class _EnglishEntryincentiveState extends State<EnglishEntryincentive> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incentive""");
  }
