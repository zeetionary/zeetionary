...
// replace these: replace EnglishEntryageist - replace speakAgeist - replace ageist - /ˈeɪdʒɪst/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryageist extends StatelessWidget {
  EnglishEntryageist({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAgeist(String languageCode) async {
    // DOPSUM: CHANGE speakAgeist
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("ageist"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAgeist5272316(String languageCode) async {
    ...
    await flutterTts.speak(
        "The fact is, we live in an ageist society."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "ageist", // DOPSUM: CHANGE WORD ENTRY - Find /ˈeɪdʒɪst/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈeɪdʒɪst/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAgeist(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˈeɪdʒɪst/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '6EjeFnw0cZY';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'Hk7lfkQLXLI';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'q1WLtIvYk34';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'GzFJLpEsxVw';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'zBf7DOtWRP8';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = '7-y3-0Bhjik';
