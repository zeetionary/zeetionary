...
class EnglishEntryfern extends StatefulWidget {
  const EnglishEntryfern({super.key});

  @override
  State<EnglishEntryfern> createState() => _EnglishEntryfernState();
}

class _EnglishEntryfernState extends State<EnglishEntryfern> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fern's leaves were delicate and green.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fern""",
                      // alsoEnglishWord: "also: fern",
                      britshText: """IpaUK: /fɜːn/""",
                      americanText: """IpaUS: /fɜːrn/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """گەڵاکانی گوێ‌فیلەکە ناسک و سەوز بوون.""",
...
const String _videoIdend = 'https://youtu.be/oS830cxjVFk?t=';
const double _startSecondsend = 000000000000000000000000000390;
const String _videoIdone = 'https://youtu.be/gQmiqmxJMtA?t=';
const double _startSecondsone = 0000000000000000000000000009458;
const String _videoIdtwo = 'https://youtu.be/9ttxmg2nBOQ?t=';
const double _startSecondstwo = 000000000000000000000000000760;
const String _videoIdthree = 'https://youtu.be/gQRXHP_geAA?t=';
const double _startSecondsthree = 000000000000000000000000000507;
const String _videoIdfour = 'https://youtu.be/bM6gEUNyEqA?t=';
const double _startSecondsfour = 000000000000000000000000000229;
const String _videoIdfive = 'https://youtu.be/sflgUE9h2JY?t=';
