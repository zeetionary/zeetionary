...
class EnglishEntryequate extends StatefulWidget {
  const EnglishEntryequate({super.key});

  @override
  State<EnglishEntryequate> createState() => _EnglishEntryequateState();
}

class _EnglishEntryequateState extends State<EnglishEntryequate> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equate""",
                      // alsoEnglishWord: "also: equate",
                      britshText: """IpaUK: /ɪˈkweɪt/""",
                      americanText: """IpaUS: /ɪˈkweɪt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Some parents equate education with exam success.""");
  }
...
کوردی: یەکسان کردن، هاوسەنگ کردن، بەرابەر گرتن
"""),
          const DefinitionKurdish(
              text: """١. (کردار) هاوتاکردنی شتێک لەگەڵ شتێکی دیکە"""),
          SentencesRow(
            englishText: """Some parents equate education with exam success.""",
            kurdishText:
                """هەندێک دایباب خوێندن هاوتا دەکەن لەگەڵ سەرکەوتن لە تاقیکردنەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I don't see how you can equate the two things.""",
            kurdishText: """تێناگەم چۆن دەتوانیت دوو شتە هاوتا بکەیت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: equate (Derived forms: equating, equates, equated)
1. Consider or describe as similar, equal, or analogous (= compare, liken)
"You cannot equate success in financial matters with greed";
 
2. Be equivalent or parallel, in mathematics (= correspond)
 
3. Make equal, uniform, corresponding, or matching (= equal, match, equalize, equalise [Brit])
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/6Xf858oNEak?t=';
const double _startSecondsend = 000000000000000000000000000000; // 311;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/sAiTuitN5b8?t=';
const double _startSecondsone = 00000000000000000000000000000; // 14;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/IM31fgkxn2I?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 574;
const String _videoIdthree = 'VIDEOhttps://youtu.be/76X4JvjpXug?t=';
const double _startSecondsthree = 000000000000000000000000000; // 28;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/aGPEsFY1vx4?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 321;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/yRFPjBuRRCg?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1129;
