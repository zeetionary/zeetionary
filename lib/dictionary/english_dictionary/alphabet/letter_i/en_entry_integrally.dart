...
class EnglishEntryintegrally extends StatefulWidget {
  const EnglishEntryintegrally({super.key});

  @override
  State<EnglishEntryintegrally> createState() => _EnglishEntryintegrallyState();
}

class _EnglishEntryintegrallyState extends State<EnglishEntryintegrally> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""integrally""");
  }
