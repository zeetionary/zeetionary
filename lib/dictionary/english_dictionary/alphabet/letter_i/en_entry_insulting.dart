...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '8o12WrHBhU0';
    const double startSecondsend = 835;
    const String videoIdone = 'Nqf15ViHSmQ';
    const double startSecondsone = 363;
    const String videoIdtwo = 'jMsqfidTpXQ';
    const double startSecondstwo = 57;
    const String videoIdthree = 'Unzc731iCUY';
    const double startSecondsthree = 902;
    const String videoIdfour = 'S4qvPouh1gE';
    const double startSecondsfour = 833;
    const String videoIdfive = 'HMX-wa3mVkc';
