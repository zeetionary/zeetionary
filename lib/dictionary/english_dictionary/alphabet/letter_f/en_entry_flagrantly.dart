...
class EnglishEntryflagrantly extends StatefulWidget {
  const EnglishEntryflagrantly({super.key});

  @override
  State<EnglishEntryflagrantly> createState() => _EnglishEntryflagrantlyState();
}

class _EnglishEntryflagrantlyState extends State<EnglishEntryflagrantly> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "flagrantly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flagrantly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The plane flagrantly violated a UN no-fly zone.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flagrantly""",
                      // alsoEnglishWord: "also: flagrantly",
                      britshText: """IpaUK: /ˈfleɪɡrəntli/""",
                      americanText: """IpaUS: /ˈfleɪɡrəntli/""",
...
کوردی: بێ‌شەرمانە، هەرزانە، بە ئاشکرایی، بێ‌پەردە
"""),
// With short examples define "flagrantly", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """فڕۆکەکە بەئاشکرایی سەرپێچی ناوچەی دژە فڕینی نەتەوە یەکگرتووەکانی کرد.""",
...
const double _startSecondsend = 0000000000000000000000000005323;
const String _videoIdone = 'https://youtu.be/2POq39ce_5I?t=';
const double _startSecondsone = 000000000000000000000000000173;
const String _videoIdtwo = 'https://youtu.be/Ll6-eGDpimU?t=';
const double _startSecondstwo = 0000000000000000000000000001258;
const String _videoIdthree = 'https://youtu.be/kvHHa_6zVxU?t=';
const double _startSecondsthree = 0000000000000000000000000001;
const String _videoIdfour = 'https://youtu.be/hmdqdO8wZdI?t=';
const double _startSecondsfour = 000000000000000000000000000231;
const String _videoIdfive = 'https://youtu.be/37Hmd-VkMIM?t=';
const double _startSecondsfive = 000000000000000000000000000785;
