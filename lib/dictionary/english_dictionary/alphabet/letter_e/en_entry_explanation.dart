...
class EnglishEntryexplanation extends StatefulWidget {
  const EnglishEntryexplanation({super.key});

  @override
  State<EnglishEntryexplanation> createState() =>
      _EnglishEntryexplanationState();
}

class _EnglishEntryexplanationState extends State<EnglishEntryexplanation> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """explanation""",
                      // alsoEnglishWord: "also: explanation",
                      britshText: """IpaUK: /ˌekspləˈneɪʃn/""",
                      americanText: """IpaUS: /ˌekspləˈneɪʃn/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It's the only explanation that makes any sense.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I'm sure there's a perfectly simple explanation for this.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She didn't give an adequate explanation for being late.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She left the room abruptly without explanation.""");
  }
...
کوردی: ڕوون‌کردنەوە، ڕۆشنایی‌خستنەسەر، تیشک‌خستنەسەر، ڕۆشن‌کردنەوە، تێگەیاندن، لێکدانەوە، شی‌کردنەوە، واڵاکاری، ڕاڤە، شرۆڤە
"""),
          const DefinitionKurdish(
              text: """١. (ناو) ڕوونکردنەوەی شتێک؛ هۆکاری شتێک"""),
          SentencesRow(
            englishText:
                """The most likely explanation is that his plane was delayed.""",
            kurdishText: """نزیکترین ئەگەر ئەوەیە کە فڕۆکەکە دواکەوت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """It's the only explanation that makes any sense.""",
            kurdishText: """تەنها ڕوونکردنەوەیە کە دەچێتە ئەقڵەوە.""",
                ...
                children: [
                  SentencesRow(
                    englishText:
                        """I can't think of any possible explanation for his absence.""",
                    kurdishText:
                        """ناتوانم بیر لە هیچ ڕوونکردنەوەیەک بکەمەوە بۆ ئامادەنەبوونی.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText: """دڵنیام هۆکارێکی سادە هەیە بۆ ئەمە.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """ڕوونکردنەوە.هۆکارێکی باشی نەدا بەدەستەوە بۆ درەنگ‌کەوتنی.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """لەناکاو ژوورەکەی جێهێشت بەبێ ڕوونکردنەوە.""",
          ...
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) ڕێنمایی یان ڕوونکردنەوەیەکی نووسراوی شتێک"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Other parts of the book contain unnecessarily lengthy explanations.""",
            kurdishText:
                """بەشەکانی دیکەی کتێبەکە ڕوونکردنەوەی درێژی ناپێویست لەخۆدەگرن.""",
          ...
          SentencesRow(
            englishText:
                """For a full explanation of how the machine works, turn to page 5.""",
            kurdishText:
                """بۆ ڕێنمایی تەواوی ئەوەی چۆن ئامێرەکە کار دەکات بچۆ بۆ لاپەڕە ٥.""",
          ...
          SentencesRow(
            englishText:
                """The teacher gave the children a detailed explanation of the story.""",
            kurdishText:
                """مامۆستاکە ڕوونکردنەوەی وردی چیرۆکەکەی دا بە منداڵەکان.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: explanation (Derived forms: explanations)
1. A statement that makes something comprehensible by describing the relevant structure, operation or circumstances etc. (= account)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/SrDEtSlqJC4?t=';
const double _startSecondsend = 000000000000000000000000000000; // 654;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/Mx8JkGHaGUI?t=';
const double _startSecondsone = 00000000000000000000000000000; // 2643;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/PmlRbfSavbI?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 250;
const String _videoIdthree = 'VIDEOhttps://youtu.be/anbBwpoI9TI?t=';
const double _startSecondsthree = 000000000000000000000000000; // 421;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/0jltioeaEyY?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 264;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/g9QneAV4fVo?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 996;
