...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000274;
    const String videoIdone = 'https://youtu.be/tXjHb5QmDV0?t=';
    const double startSecondsone = 00000000000000000000000000062;
    const String videoIdtwo = 'https://youtu.be/1oa6VziZH78?t=';
    const double startSecondstwo = 000000000000000000000000000315;
    const String videoIdthree = 'https://youtu.be/y-2jd0Ds8Iw?t=';
    const double startSecondsthree = 00000000000000000000000000058;
    const String videoIdfour = 'https://youtu.be/h42QVfrUVFw?t=';
    const double startSecondsfour = 000000000000000000000000000601;
    const String videoIdfive = 'https://youtu.be/XKDhq2UcjIM?t=';
