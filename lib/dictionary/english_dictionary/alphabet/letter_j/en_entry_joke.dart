...
""",
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They often make jokes at each other's expense.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The kids in that class are always looking to play a joke on the teacher.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Our new teacher's a joke - he can't even control the class.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The new software is a complete joke - it keeps crashing.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was laughing and joking with the children.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'm the sort of person who likes to joke a lot.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They often joked about all the things that could go wrong.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She joked that she only loved him for his money.""");
  }
...
// With short examples define "joke", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) شتێک کە دەیڵێیت یان دەیکەیت بۆ ئەوەی کەسانی دیکە پێبکەنن"""),
                    SentencesRow(
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They often make jokes at each other's expense.""",
                      kurdishText: """زۆرجار نوکتە لەسەر حسابی یەکدی دەڵێن (گاڵتە بە یەکدی دەکەن).""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The kids in that class are always looking to play a joke on the teacher.""",
                      kurdishText: """منداڵەکانی ئەو پۆلە هەمیشە نوکتە لەسەر مامۆستاکە دەڵێن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I didn't get the joke (= understand it).""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I only did it as a joke (= it was not meant seriously).""",
                      kurdishText: """تەنها وەک نوکتەیەک گوتم.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) کەسێک، شتێک، یان دۆخێک کە ناکرێت بە جدی سەیر بکرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """This latest pay offer is a joke.""",
                      kurdishText: """تازەترین پێشنیاری مووچەیان گاڵتەجاڕییە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Our new teacher's a joke - he can't even control the class.""",
                      kurdishText: """مامۆستا تازەکەمان گاڵتەجاڕییە ـ تەنانەت ناتوانێت پۆلەکە کۆنترۆڵ بکات.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The new software is a complete joke - it keeps crashing.""",
                      kurdishText: """نەرمامێرەکە گاڵتەجاڕییەکی تەواو ـ بەردەوام لەکار دەکەوێت.""",
                      onPressedBritish: () => speaksentence9("en-GB"),
                      onPressedAmerican: () => speaksentence9("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) گوتنی شتێک بۆ ئەوەی خەڵکی پێبکەنن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She was laughing and joking with the children.""",
                      kurdishText: """پێدەکەنی و گاڵتەی دەکرد لەگەڵ منداڵەکان.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I'm the sort of person who likes to joke a lot.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They often joked about all the things that could go wrong.""",
                      kurdishText: """زۆرجار گاڵتەیان دەکرد سەبارەت بەو شتانەی کە دەکرێت بە هەڵە ڕووبدەن.""",
                      onPressedBritish: () => speaksentence12("en-GB"),
                      onPressedAmerican: () => speaksentence12("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) گوتنی شتێک کە ڕاست نییە بەهۆی ئەوەی وەها بیردەکەیتەوە کە جێگای پێکەنینە"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She joked that she only loved him for his money.""",
                      kurdishText: """بە گاڵتەوە ئەوەی گوت کە تەنها بۆ پارەکەی خۆشی دەوێت.""",
