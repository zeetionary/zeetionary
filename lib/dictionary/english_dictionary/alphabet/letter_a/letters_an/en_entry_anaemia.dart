...
// replace these: replace EnglishEntryanaemia - replace speakAnaemia - replace anaemia - /əˈniːmiə/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryanaemia extends StatelessWidget {
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "anaemia"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈniːmiə/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈniːmiə/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakanaemia558(
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'TPzFAUKkReM';
  final double _startSeconds = 4934;
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'KVOUTEz7rcA';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '-Pcc1SHhhGs';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '5ozf3drS1QA';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'MpI6In4fmeo';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '3fTClCxvid4';
