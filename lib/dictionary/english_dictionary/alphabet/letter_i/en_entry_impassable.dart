...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = '08mwXICY4JM';
    const double startSecondsone = 503;
    const String videoIdtwo = 'Mn4VDwaV-oo';
    const double startSecondstwo = 168;
    const String videoIdthree = 'GOfKwjC_AH4';
    const double startSecondsthree = 369;
    const String videoIdfour = 'O177L4pu2jg';
    const double startSecondsfour = 538;
    const String videoIdfive = 'YbmiKG56zuw';
