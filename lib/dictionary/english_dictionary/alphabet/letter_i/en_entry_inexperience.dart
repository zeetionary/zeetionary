...
class EnglishEntryinexperience extends StatefulWidget {
  const EnglishEntryinexperience({super.key});

  @override
  State<EnglishEntryinexperience> createState() =>
      _EnglishEntryinexperienceState();
}

class _EnglishEntryinexperienceState extends State<EnglishEntryinexperience> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: inexperience (Derived forms: inexperiences)
1. Lack of experience and the knowledge and understanding derived from experience (- rawness)
"procedural inexperience created difficulties";
""",
  );

  final String keyword = "inexperience";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inexperience""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""His mistake was due to youth and inexperience.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/yRmOWcWdQAo?t=';
    const double startSecondsend = 0000000000000000000000000001088;
    const String videoIdone = 'https://youtu.be/1UTjWy-vnOo?t=';
    const double startSecondsone = 000000000000000000000000000486;
    const String videoIdtwo = 'https://youtu.be/5sHuFK7yOdo?t=';
    const double startSecondstwo = 0000000000000000000000000001024;
    const String videoIdthree = 'https://youtu.be/3E17wr77ffM?t=';
    const double startSecondsthree = 000000000000000000000000000778;
    const String videoIdfour = 'https://youtu.be/dWJ_WwWSabw?t=';
    const double startSecondsfour = 0000000000000000000000000003206;
    const String videoIdfive = 'https://youtu.be/A0Lkh02_Ik4?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inexperience""",
                      // alsoEnglishWord: "also: inexperience",
                      britshText: """IpaUK: /ˌɪnɪkˈspɪəriəns/""",
                      americanText: """IpaUS: /ˌɪnɪkˈspɪriəns/""",
...
کوردی: بێ‌ئەزموونی، ناپوختی، خاوی، قاڵەوەنەبوویی
"""),
// With short examples define "inexperience", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) کەمی زانیاری و ئەزموون"""),
                    SentencesRow(
                      englishText:
                          """His mistake was due to youth and inexperience.""",
                      kurdishText: """هەڵەکەی بەهۆی گەنجی و بێ‌ئەزموونی بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She realized that her youth and inexperience were being exploited.""",
                      kurdishText:
                          """زانی کە گەنجی و کەم ئەزموونیی دەقۆزرایەوە.""",
