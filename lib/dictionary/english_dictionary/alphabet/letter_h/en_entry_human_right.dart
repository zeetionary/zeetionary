...
class EnglishEntryhumanright extends StatefulWidget {
  const EnglishEntryhumanright({super.key});

  @override
  State<EnglishEntryhumanright> createState() => _EnglishEntryhumanrightState();
}

class _EnglishEntryhumanrightState extends State<EnglishEntryhumanright> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: human right (Derived forms: human rights)
...
""",
  ...
  final String keyword = "human right";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""human right""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The country has a poor record on human rights.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondstwo = 00000000000000000000000000059;
    const String videoIdthree = 'https://youtu.be/ZOvyn72x6kQ?t=';
    const double startSecondsthree = 000000000000000000000000000464;
    const String videoIdfour = 'https://youtu.be/EmT0i0xG6zg?t=';
    const double startSecondsfour = 000000000000000000000000000214;
    const String videoIdfive = 'https://youtu.be/syQhuq7BnT4?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """human right""",
                      // alsoEnglishWord: "also: human right",
                      britshText: """IpaUK: /ˌhjuːmən ˈraɪt/""",
                      americanText: """IpaUS: /ˌhjuːmən ˈraɪt/""",
...
// With short examples define "human right", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وڵاتەکە تۆمارێکی خراپ لە مافەکانی مرۆڤی هەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """European law ensures human rights are protected.""",
                      kurdishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئازادیی ڕادەربڕین مافێکی سەرەتایی مرۆڤە.""",
