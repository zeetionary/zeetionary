...
class EnglishEntryentertain extends StatefulWidget {
  const EnglishEntryentertain({super.key});

  @override
  State<EnglishEntryentertain> createState() => _EnglishEntryentertainState();
}

class _EnglishEntryentertainState extends State<EnglishEntryentertain> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""entertain""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """entertain""",
                      // alsoEnglishWord: "also: entertain",
                      britshText: """IpaUK: /ˌentəˈteɪn/""",
                      americanText: """IpaUS: /ˌentərˈteɪn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "entertain";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The aim of the series is both to entertain and inform.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He entertained us for hours with his stories and jokes.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Films can entertain and educate, make you laugh or cry.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Do you entertain a lot?""");
  }
...
کوردی: 
"""),
          const DefinitionKurdish(text: """١. (کردار) دڵخۆشکردنی کەسێک"""),
          SentencesRow(
            englishText:
                """The aim of the series is both to entertain and inform.""",
            kurdishText: """ئامانجی زنجیرەکە دڵخۆشکردن و زانیاری بەخشینە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """بۆ چەندین کاتژمێر بە چیرۆک و نوکتەکانی دڵخۆشی کردین.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """فیلم دەتوانێت دڵخۆشت بکات یان فێرت بکات، بتخاتە پێکەنین یان گریان.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """They entertained us to lunch in their new house.""",
            kurdishText:
                """لە ماڵە تازەکەیان بۆ نانی نیوەڕۆ میوانداریمان دەکەن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: entertain (Derived forms: entertains, entertained, entertaining)
1. Provide entertainment for
 
2. Take into consideration; have in view (= think of, toy with, flirt with, think about)
"He entertained the notion of moving to South America";
 
3. Maintain (a theory, thoughts, or feelings) (= harbor [N. Amer], harbour [Brit, Cdn], hold, nurse, bear)
...
const String _videoIdend = 'https://youtu.be/anbBwpoI9TI?t=';
const double _startSecondsend = 511;
const String _videoIdone = 'https://youtu.be/HAnw168huqA?t=';
const double _startSecondsone = 2919;
const String _videoIdtwo = 'https://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondstwo = 5970;
const String _videoIdthree = 'https://youtu.be/fGMCjELDyUY?t=';
const double _startSecondsthree = 60;
const String _videoIdfour = 'https://youtu.be/W8l9TpruFik?t=';
const double _startSecondsfour = 673;
const String _videoIdfive = 'https://youtu.be/-r_l-cTcWsE?t=';
const double _startSecondsfive = 386;
const String _videoIdsix = 'https://youtu.be/qSmyimnMOBo?t=';
const double _startSecondssix = 284;
