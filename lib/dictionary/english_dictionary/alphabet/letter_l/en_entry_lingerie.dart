...
class EnglishEntrylingerie extends StatefulWidget {
  const EnglishEntrylingerie({super.key});

  @override
  State<EnglishEntrylingerie> createState() => _EnglishEntrylingerieState();
}

class _EnglishEntrylingerieState extends State<EnglishEntrylingerie> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lingerie (Derived forms: lingeries)
1. Women's underwear and nightclothes (- intimate apparel)
""",
  );

  final String keyword = "lingerie";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lingerie""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Comfortable lingerie is essential for daily wear.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/iabqAFwFYtg?t=32';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/z_eg2OjO6uM?t=9';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/8-IKq4lOhj4?t=350';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/_wNsZEqpKUA?t=225';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/ekc69jEQcX0?t=17';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/2Xiykd0zDI0?t=4';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lingerie""",
                      // alsoEnglishWord: "also: lingerie",
                      britshText: """IpaUK: /ˈlɒ̃ʒəri/""",
                      americanText: """IpaUS: /ˌlɑːndʒəˈreɪ/""",
...
کوردی: 
"""),
                    const DefinitionKurdish(text: """١. (ناو) جلی ژێرەوەی ژنان"""),
                    SentencesRow(
                      englishText: """Comfortable lingerie is essential for daily wear.""",
                      kurdishText: """جلی ئاسوودەی ژێرەوە پێویستە بۆ بەکارهێنانی ڕۆژانە.""",
