...
class EnglishEntryexternally extends StatefulWidget {
  const EnglishEntryexternally({super.key});

  @override
  State<EnglishEntryexternally> createState() => _EnglishEntryexternallyState();
}

class _EnglishEntryexternallyState extends State<EnglishEntryexternally> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""externally""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """externally""",
                      // alsoEnglishWord: "also: externally",
                      britshText: """IpaUK: /ɪkˈstɜːnəli/""",
                      americanText: """IpaUS: /ɪkˈstɜːrnəli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "externally";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The building has been restored externally and internally.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The medication is to be applied externally.""");
  }
...
کوردی: لە دەرەوە، بە ڕواڵەت، لە ڕواڵەت‌دا، بە شێوەیەکی دەروەیی، دەرەکی‌یانە
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵکار) لە دەرەوەی کەسێک/شتێک"""),
          SentencesRow(
            englishText:
                """The building has been restored externally and internally.""",
            kurdishText: """بیناکە لە دەرەوە و ناوەوە نۆژەنکراوەتەوە.""",
...
2. With respect to the outside (= outwardly)
"externally, the figure is smooth";
""",
  );
...
const String _videoIdend = 'https://youtu.be/wMmy2MlH55U?t=';
const double _startSecondsend = 000000000000000000000000000549;
const String _videoIdone = 'https://youtu.be/tZktTdGHaJY?t=';
const double _startSecondsone = 0000000000000000000000000001411;
const String _videoIdtwo = 'https://youtu.be/XU52BmNR8q4?t=';
const double _startSecondstwo = 000000000000000000000000000194;
const String _videoIdthree = 'https://youtu.be/NZLbTuBDhJg?t=';
const double _startSecondsthree = 000000000000000000000000000303;
const String _videoIdfour = 'https://youtu.be/ndQZBQJf034?t=';
const double _startSecondsfour = 000000000000000000000000000166;
const String _videoIdfive = 'https://youtu.be/1ZKBaRsP1gY?t=';
const double _startSecondsfive = 0000000000000000000000000001176;
