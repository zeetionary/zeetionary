...
class EnglishEntrygranite extends StatefulWidget {
  const EnglishEntrygranite({super.key});

  @override
  State<EnglishEntrygranite> createState() => _EnglishEntrygraniteState();
}

class _EnglishEntrygraniteState extends State<EnglishEntrygranite> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: granite (Derived forms: granites)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""granite""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They built the monument from granite.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The old building has granite walls.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """granite""",
                      // alsoEnglishWord: "also: granite",
                      britshText: """IpaUK: /ˈɡrænɪt/""",
                      americanText: """IpaUS: /ˈɡrænɪt/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بەردێکی خۆڵەمێشی سەخت کە بۆ بیناسازی بەکاردێت"""),
                    SentencesRow(
                      englishText: """They built the monument from granite.""",
                      kurdishText: """مۆنیومێنتەکەیان لە گرانیت درووستکرد.""",
                    ...
                    SentencesRow(
                      englishText: """The old building has granite walls.""",
                      kurdishText: """بینا کۆنەکە دیواری گرانیتی هەیە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/d9C19v8RSZg?t=';
const double _startSecondsend = 00000000000000000000000000097;
const String _videoIdone = 'https://youtu.be/eXyHRnDNH64?t=';
const double _startSecondsone = 00000000000000000000000000012;
const String _videoIdtwo = 'https://youtu.be/qQTaFH6vnXU?t=';
const double _startSecondstwo = 00000000000000000000000000025;
const String _videoIdthree = 'https://youtu.be/yAIOykJ9pbg';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/hu8QBjmQOBo?t=';
const double _startSecondsfour = 0000000000000000000000000008;
const String _videoIdfive = 'https://youtu.be/bWnK6ZqpujE';
