...
class EnglishEntryliteracy extends StatefulWidget {
  const EnglishEntryliteracy({super.key});

  @override
  State<EnglishEntryliteracy> createState() => _EnglishEntryliteracyState();
}

class _EnglishEntryliteracyState extends State<EnglishEntryliteracy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: literacy (Derived forms: literacies)
1. The ability to read and write
""",
  );

  final String keyword = "literacy";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""literacy""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Most of the students here need help with literacy and numeracy.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""All the children are tested in basic literacy.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We’re looking to hire an assistant with a high level of digital literacy.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/DBG1Wgg32Ok?t=563';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/zB_OApdxcno?t=486';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/qg2nGY1aqlg?t=117';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/OBG50aoUwlI?t=133';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/1dhvry6E0jA?t=347';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/PTpEZYJV12c?t=283';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """literacy""",
                      // alsoEnglishWord: "also: literacy",
                      britshText: """IpaUK: /ˈlɪtərəsi/""",
                      americanText: """IpaUS: /ˈlɪtərəsi/""",
...
کوردی: 
"""),
// With short examples define "literacy", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) توانای خوێندنەوە و نووسین"""),
                    SentencesRow(
                      englishText: """Most of the students here need help with literacy and numeracy.""",
                      kurdishText: """زۆرینەی خوێندکارانی ئێرە پێویستییان بە یارمەتییە لەگەڵ خوێندنەوە و ژماردن.""",
                    ...
                    SentencesRow(
                      englishText: """All the children are tested in basic literacy.""",
                      kurdishText: """هەموو منداڵەکان توانای خوێندەواریی سەرەتاییان تاقی دەکرێتەوە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) زانیاری و شارەزایی لە بوارێکی دیاریکراو"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We’re looking to hire an assistant with a high level of digital literacy.""",
                      kurdishText: """دەگەڕێین بۆ گرتنی یاریدەدەرێک بە شارەزایەکی باشی کۆمپیوتەر.""",
