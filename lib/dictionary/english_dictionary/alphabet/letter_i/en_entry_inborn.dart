...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'W6aDNutZoB0';
    const double startSecondsend = 1583;
    const String videoIdone = 'SwQhKFMxmDY';
    const double startSecondsone = 6092;
    const String videoIdtwo = 'kMYZ3fUlZFA';
    const double startSecondstwo = 226;
    const String videoIdthree = 'WJBA1bidwis';
    const double startSecondsthree = 379;
    const String videoIdfour = 'wAafVviGxhk';
    const double startSecondsfour = 158;
    const String videoIdfive = 'VSZ8ywgGNGM';
