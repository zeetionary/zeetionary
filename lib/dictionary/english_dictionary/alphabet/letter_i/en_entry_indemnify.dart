...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/YI5orKCzz58?t=';
    const double startSecondsend = 000000000000000000000000000883;
    const String videoIdone = 'https://youtu.be/dpITyDIIz_k?t=';
    const double startSecondsone = 000000000000000000000000000534;
    const String videoIdtwo = 'https://youtu.be/DFZPaMgjChE?t=';
    const double startSecondstwo = 000000000000000000000000000227;
    const String videoIdthree = 'https://youtu.be/IRT1_lRcMJA?t=';
    const double startSecondsthree = 000000000000000000000000000965;
    const String videoIdfour = 'https://youtu.be/bke10pPJ3i0?t=';
    const double startSecondsfour = 000000000000000000000000000110;
    const String videoIdfive = 'https://youtu.be/xYs3j0VpFtU?t=';
    const double startSecondsfive = 000000000000000000000000000125;
