...
// blank divider
  ...
  Future<void> speakconversions2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Consult the conversion table to figure out the weight in kilos."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakconversions3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("There are no charges for currency conversion."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakconversions4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Late in life she experienced a religious conversion."); // DOPSUM: CHANGE TEXT
  }
...
"""),
                          const DefinitionKurdish(
                              text: "١. (ناو) کردار یان پڕۆسەی گۆڕانی شتێک لە جۆرێک، بەکارهێنانێک، یان سیستەمێکەوە بۆ یەکێکی دیکە"),
                          Row(
                            children: [
                              const Expanded(
                                child: Column(
                                  children: [
                                    ...
                                    ExampleSentenceKurdish(
                                        text: "گۆڕین بۆ گەرمکەری ناوەکی گاز پارەی زۆرت بۆ دەگێڕێتەوە."),
                                  ],
                                ),
                              ),
                          ...
                          ExampleSentenceKurdish(
                          text: "لە خشتەی گۆڕینەکە بڕوانە بۆ زانینی کێشەکە بە کیلۆ."),
                          ],
                          ),
                          ),
                          ...
                          ExampleSentenceKurdish(
                          text: "هیچ بڕێک وەرناگیرێت بۆ گۆڕینەوەی پارە."),
                          ],
                          ),
                          ),
                          const CustomSizedBoxForTTS(),
                          ...
                          const DividerDefinition(),
                          const DefinitionKurdish(text: "٢. (ناو) پڕۆسە یان ئەزموونی گۆڕینی باوەڕ یان ئایینی کەسێک"),
                          Row(
                          children: [
                          const Expanded(
                          child: Column(
                          ...
                          ExampleSentenceKurdish(
                          text: "لە کۆتایی ژیانیدا بە گۆڕینی ئاییندا تێپەڕبوو."),
                          ],
                          ),
                          ),
                          const CustomSizedBoxForTTS(),
