...
class EnglishEntryfrugal extends StatefulWidget {
  const EnglishEntryfrugal({super.key});

  @override
  State<EnglishEntryfrugal> createState() => _EnglishEntryfrugalState();
}

class _EnglishEntryfrugalState extends State<EnglishEntryfrugal> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: frugal
1. Avoiding waste (= economical, sparing, stinting)
"a frugal farmer";
""",
  );

  final String keyword = "frugal";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He has always been hard-working and frugal.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He prefers a frugal lunch of bread and cheese.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frugal""",
                      // alsoEnglishWord: "also: frugal",
                      britshText: """IpaUK: /ˈfruːɡl/""",
                      americanText: """IpaUS: /ˈfruːɡl/""",
...
// With short examples define "frugal", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) بەکارهێنانی پارە بەو ڕێژەیەی کە پێویستە"""),
                    SentencesRow(
                      englishText:
                          """He has always been hard-working and frugal.""",
                      kurdishText: """هەمیشە زەحمەت‌کێش و دەس‌پێوەگر بووە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) ژەمە خواردنێکی سادە و هەرزان"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He prefers a frugal lunch of bread and cheese.""",
                      kurdishText:
                          """حەزی بە نانێکی نیوەڕۆی سادە لە نان و پەنیرە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/V2ec7EE0pB8?t=';
const double _startSecondsend = 0000000000000000000000000001811;
const String _videoIdone = 'https://youtu.be/_2ThNd8DBEI?t=';
const double _startSecondsone = 000000000000000000000000000624;
const String _videoIdtwo = 'https://youtu.be/B7m-byNkoHc?t=';
const double _startSecondstwo = 000000000000000000000000000246;
const String _videoIdthree = 'https://youtu.be/jGrp_qIoGFM?t=';
const double _startSecondsthree = 000000000000000000000000000209;
const String _videoIdfour = 'https://youtu.be/6s8ofnwQCbY?t=';
const double _startSecondsfour = 000000000000000000000000000252;
const String _videoIdfive = 'https://youtu.be/TZO-jqy1IBg?t=';
