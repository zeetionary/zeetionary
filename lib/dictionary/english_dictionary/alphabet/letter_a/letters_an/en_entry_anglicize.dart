                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "anglicize"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæŋɡlɪsaɪz/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæŋɡlɪsaɪz/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'Kb2F0tfY1A0';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'MICQb4QW448';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'ffTk-zW9sqg';
  final double _startSeconds = 3836;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'f7VGA_Xhj34';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'OCUEolJRrxc';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'XcpU-TrWMvQ';
