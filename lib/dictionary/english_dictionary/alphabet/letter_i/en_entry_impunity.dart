...
class EnglishEntryimpunity extends StatefulWidget {
  const EnglishEntryimpunity({super.key});

  @override
  State<EnglishEntryimpunity> createState() => _EnglishEntryimpunityState();
}

class _EnglishEntryimpunityState extends State<EnglishEntryimpunity> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: impunity (Derived forms: impunities)
1. Exemption from punishment or loss
""",
  );

  final String keyword = "impunity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impunity""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They continue to break the law with impunity.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000151;
    const String videoIdone = 'https://youtu.be/Z0qwi6UkKtQ?t=';
    const double startSecondsone = 000000000000000000000000000740;
    const String videoIdtwo = 'https://youtu.be/tkLZYEIslWM?t=';
    const double startSecondstwo = 000000000000000000000000000678;
    const String videoIdthree = 'https://youtu.be/AGqUCKin4X0?t=';
    const double startSecondsthree = 000000000000000000000000000294;
    const String videoIdfour = 'https://youtu.be/FUrrk4QSnXM?t=';
    const double startSecondsfour = 000000000000000000000000000471;
    const String videoIdfive = 'https://youtu.be/fmwXRE5fkjM?t=';
    const double startSecondsfive = 000000000000000000000000000203;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """impunity""",
                      // alsoEnglishWord: "also: impunity",
                      britshText: """IpaUK: /ɪmˈpjuːnəti/""",
                      americanText: """IpaUS: /ɪmˈpjuːnəti/""",
...
کوردی: بەخشران، جەبە(کران)، سزانەدران
"""),
// With short examples define "impunity", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) ئەوەی کە سزا نەدرێیت بۆ شتێک"""),
                    SentencesRow(
                      englishText:
                          """They continue to break the law with impunity.""",
                      kurdishText:
                          """بەردەوامن لە شکاندنی یاسا بە پارێزبەندییەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Those involved in such attacks often enjoy complete impunity.""",
                      kurdishText:
                          """ئەو کەسانەی بەژدارن لە هێرشی وەها زۆرجار حەسانەی تەواویان هەیە.""",
