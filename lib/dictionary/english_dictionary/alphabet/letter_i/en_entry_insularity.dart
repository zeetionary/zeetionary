...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'ascPhiXcpss';
    const double startSecondsend = 989;
    const String videoIdone = 'dgj16KSgtIE';
    const double startSecondsone = 751;
    const String videoIdtwo = 'lW3Dl2nA4M4';
    const double startSecondstwo = 82;
    const String videoIdthree = 'v_wVO_icQbw';
    const double startSecondsthree = 467;
    const String videoIdfour = 'DOr21EFOyGI';
    const double startSecondsfour = 881;
    const String videoIdfive = 'tBw3IsQsf4c';
    const double startSecondsfive = 1252;
