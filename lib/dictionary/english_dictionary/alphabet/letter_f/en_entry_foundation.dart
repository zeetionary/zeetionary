...
class EnglishEntryfoundation extends StatefulWidget {
  const EnglishEntryfoundation({super.key});

  @override
  State<EnglishEntryfoundation> createState() => _EnglishEntryfoundationState();
}

class _EnglishEntryfoundationState extends State<EnglishEntryfoundation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foundation (Derived forms: foundations)
1. The basis on which something is grounded
"there is little foundation for his objections"
 
2. An institution supported by an endowment
 
3. Lowest support of a structure (= base, fundament, foot, groundwork, substructure, understructure)
"it was built on a foundation of solid rock";
 
4. Education or instruction in the fundamentals of a field of knowledge (= grounding)
"he lacks the foundation necessary for advanced study";
 
5. The fundamental assumptions from which something is begun, developed, calculated or explained (= basis, base, fundament, groundwork, cornerstone)
"the whole argument rested on a foundation of conjecture";
 
6. A woman's undergarment worn to give shape to the contours of the body (= foundation garment, shapewear)
 
7. The act of starting something for the first time; introducing something new (= initiation, founding, institution, origination, creation, innovation, introduction, instauration, debut, first appearance, launching, unveiling, entry)
"the foundation of a new scientific society";
""",
  );

  final String keyword = "foundation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foundation""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He laid the foundation of Japan's modern economy.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""These stories have no foundation.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The rumour is totally without foundation.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We now have a firm foundation to build on.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The money will go to the San Francisco AIDS Foundation.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The explosion shook the foundations of the houses nearby.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foundation""",
                      // alsoEnglishWord: "also: foundation",
                      britshText: """IpaUK: /faʊnˈdeɪʃn/""",
                      americanText: """IpaUS: /faʊnˈdeɪʃn/""",
...
کوردی: بنیات‌نان، دامەزراندن، پێکهێنان، دانان، چێ‌کردن، دروس‌کردن،	دامەزرە، ئەنیستیتۆ، دامەزراوە،	بناخە، هیم، بنەڕەت، بنچینە، بنە، بنەچەق، بناوان، بنەوان، بنەما، خیم، بنگەهـ،	کرێمی دەم‌وچاو،	پاساودان، بیانووهێنانەوە، بیانوو، پەڵپ، بناخە، هیم، بنەڕەت، بنچینە، بنەما، خیم، بنگەهـ، بنەچەق، بناوان
"""),
// With short examples define "foundation", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بنچینەیەک، بیرۆکەیەک، یان ڕاستییەک کە شتێک پشتی پێ دەبەستێت و لێیەوە گەشە دەکات"""),
                    SentencesRow(
                      englishText:
                          """Respect and friendship provide a solid foundation for marriage.""",
                      kurdishText:
                          """ڕێز و خۆشەویستی بناغەیەکی جێگیر دەبێت بۆ هاوسەرگیری.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بناغەی ئابووریی سەردەمیی ژاپۆنی دانا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەم چیرۆکانە هیچ بناغەیەکیان نییە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەنگۆکە تەواو بێ بناغەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئێستا بناغەیەکی پتەومان هەیە لێیەوە دەست پێبکەین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پارەکە دەچێت بۆ دامەزراوەی ئایدزی سان فرانسیسکۆ.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The research centre was set up by a charitable foundation.""",
                      kurdishText:
                          """سەنتەری توێژینەوەکە لەلایەن دامەزراوەیەکی خێرخوازییەوە دامەزرا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The organization has grown enormously since its foundation in 1955.""",
                      kurdishText:
                          """دامەزراوەکە زۆر گەشەی کردووە لەوەتەی دامەزراندنی لە ١٩٥٥.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ناو) چینێک لە بەرد، کۆنکریت، هتد کە بناغەی پتەوی بینایەک پێکدێنێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The explosion shook the foundations of the houses nearby.""",
                      kurdishText:
                          """تەقینەوەکە بناغەی خانووەکانی دەورووبەری هەژاند.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The builders are now beginning to lay the foundations of the new school.""",
                      kurdishText:
                          """بنیاتنەران ئێستا خەریکی دانانی بناغەی قوتابخانە تازەکەن.""",
...
const double _startSecondsone = 000000000000000000000000000293;
const String _videoIdtwo = 'https://youtu.be/DwsZggwPRKc?t=';
const double _startSecondstwo = 00000000000000000000000000081;
const String _videoIdthree = 'https://youtu.be/D0x2dgpBDzc?t=';
const double _startSecondsthree = 00000000000000000000000000079;
const String _videoIdfour = 'https://youtu.be/ewLpXw6uN28?t=';
const double _startSecondsfour = 000000000000000000000000000959;
const String _videoIdfive = 'https://youtu.be/pTysrwci0pU?t=';
const double _startSecondsfive = 0000000000000000000000000001190;
