...
class EnglishEntryhidingplace extends StatefulWidget {
  const EnglishEntryhidingplace({super.key});

  @override
  State<EnglishEntryhidingplace> createState() =>
      _EnglishEntryhidingplaceState();
}

class _EnglishEntryhidingplaceState extends State<EnglishEntryhidingplace> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hiding place (Derived forms: hiding places)
1. A place suitable for hiding something (such as yourself) (- hidey-hole [informal], hidy-hole [informal])
""",
  );

  final String keyword = "hiding place";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hiding place""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""As darkness fell, she emerged from her hiding place.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They used the cave as a hiding place for their weapons.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hiding place""",
                      // alsoEnglishWord: "also: hiding place",
                      britshText: """IpaUK: /ˈhaɪdɪŋ pleɪs/""",
                      americanText: """IpaUS: /ˈhaɪdɪŋ pleɪs/""",
...
// With short examples define "hiding place", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """As darkness fell, she emerged from her hiding place.""",
                      kurdishText:
                          """کە تاریکی دەستی پێکرد، لە حەشارگەکەی هاتە دەرەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """They used the cave as a hiding place for their weapons.""",
                      kurdishText:
                          """ئەشکەوتەکەیان وەک حەشارگەی چەکەکانیان بەکارهێنا.""",
...
const double _startSecondsend = 0000000000000000000000000001071;
const String _videoIdone = 'https://youtu.be/ZVJ5oLS74mc?t=';
const double _startSecondsone = 000000000000000000000000000885;
const String _videoIdtwo = 'https://youtu.be/gbPqmGVm8uU?t=';
const double _startSecondstwo = 000000000000000000000000000419;
const String _videoIdthree = 'https://youtu.be/djzzvbK_IUM?t=';
const double _startSecondsthree = 000000000000000000000000000591;
const String _videoIdfour = 'https://youtu.be/JYI95jCLBPk?t=';
const double _startSecondsfour = 0000000000000000000000000001057;
const String _videoIdfive = 'https://youtu.be/oGDGvCgiTZY?t=';
const double _startSecondsfive = 000000000000000000000000000286;
