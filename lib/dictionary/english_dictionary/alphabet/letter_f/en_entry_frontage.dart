...
class EnglishEntryfrontage extends StatefulWidget {
  const EnglishEntryfrontage({super.key});

  @override
  State<EnglishEntryfrontage> createState() => _EnglishEntryfrontageState();
}

class _EnglishEntryfrontageState extends State<EnglishEntryfrontage> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frontage (Derived forms: frontages)
1. The extent of land abutting on a street or water
 
2. The direction in which something (such as a building) faces
 
3. The face or front of a building (= facade, frontal)
""",
  );

  final String keyword = "frontage";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frontage""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The building’s street frontages are mostly of glass.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frontage""",
                      // alsoEnglishWord: "also: frontage",
                      britshText: """IpaUK: /ˈfrʌntɪdʒ/""",
                      americanText: """IpaUS: /ˈfrʌntɪdʒ/""",
...
// With short examples define "frontage", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕووی بیناکە لە شەقامەکە بەزۆری شووشەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """They bought two miles of river frontage along the Colorado.""",
                      kurdishText:
                          """دوو میل لە ناوچەی ڕووبارییان کڕی بەدرێژایی ڕووباری کۆلۆرادۆ.""",
                      englishNote:
                          """This means they purchased a length of land that extends for two miles along the edge of the Colorado River. They now own property that borders the river for this distance.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/nQEOK8I-Czc?t=';
const double _startSecondsend = 00000000000000000000000000084;
const String _videoIdone = 'https://youtu.be/OQ6NfFIr2jw?t=';
const double _startSecondsone = 000000000000000000000000000471;
const String _videoIdtwo = 'https://youtu.be/eR-J_JSBNTI?t=';
const double _startSecondstwo = 00000000000000000000000000012;
const String _videoIdthree = 'https://youtu.be/yqmso0c9CBs?t=';
const double _startSecondsthree = 000000000000000000000000000100;
const String _videoIdfour = 'https://youtu.be/w--9IPKtqOs?t=';
const double _startSecondsfour = 00000000000000000000000000067;
const String _videoIdfive = 'https://youtu.be/c2YInNlzMDQ?t=';
