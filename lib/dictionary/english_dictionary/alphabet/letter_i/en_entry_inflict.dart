...
class EnglishEntryinflict extends StatefulWidget {
  const EnglishEntryinflict({super.key});

  @override
  State<EnglishEntryinflict> createState() => _EnglishEntryinflictState();
}

class _EnglishEntryinflictState extends State<EnglishEntryinflict> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inflict""");
  }
