...
class EnglishEntryflamboyantly extends StatefulWidget {
  const EnglishEntryflamboyantly({super.key});

  @override
  State<EnglishEntryflamboyantly> createState() =>
      _EnglishEntryflamboyantlyState();
}

class _EnglishEntryflamboyantlyState extends State<EnglishEntryflamboyantly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: flamboyantly
1. In a fancy colourful manner (= showily, flashily)
"he dresses rather flamboyantly";
""",
  );

  final String keyword = "flamboyantly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flamboyantly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He dresses very flamboyantly.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flamboyantly""",
                      // alsoEnglishWord: "also: flamboyantly",
                      britshText: """IpaUK: /flæmˈbɔɪəntli/""",
                      americanText: """IpaUS: /flæmˈbɔɪəntli/""",
...
// With short examples define "flamboyantly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بەشێوەیەک کە جیاواز و بەجۆشهێنەرە و سەرنج ڕادەکێشێت"""),
                    SentencesRow(
                      englishText: """He dresses very flamboyantly.""",
                      kurdishText: """زۆر سەیروسەمەرانە جل لەبەردەکات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/tdVv_Kws_0I?t=';
const double _startSecondsend = 000000000000000000000000000481;
const String _videoIdone = 'https://youtu.be/gkmmzjl7vSI?t=';
const double _startSecondsone = 00000000000000000000000000025;
const String _videoIdtwo = 'https://youtu.be/szybEhqUmVI?t=';
const double _startSecondstwo = 0000000000000000000000000001147;
const String _videoIdthree = 'https://youtu.be/G4pd8C78VKg?t=';
const double _startSecondsthree = 000000000000000000000000000377;
const String _videoIdfour = 'https://youtu.be/iwg--TQQDe8?t=';
const double _startSecondsfour = 000000000000000000000000000751;
const String _videoIdfive = 'https://youtu.be/qPImjIBpb08?t=';
const double _startSecondsfive = 000000000000000000000000000899;
