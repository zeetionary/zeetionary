...
class EnglishEntryliveable extends StatefulWidget {
  const EnglishEntryliveable({super.key});

  @override
  State<EnglishEntryliveable> createState() => _EnglishEntryliveableState();
}

class _EnglishEntryliveableState extends State<EnglishEntryliveable> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""liveable""");
  }
