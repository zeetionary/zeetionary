...
class EnglishEntryheterogeneous extends StatefulWidget {
  const EnglishEntryheterogeneous({super.key});

  @override
  State<EnglishEntryheterogeneous> createState() =>
      _EnglishEntryheterogeneousState();
}

class _EnglishEntryheterogeneousState extends State<EnglishEntryheterogeneous> {
  @override
  void initState() {
    super.initState();
...
1. Consisting of elements that are not of the same kind or nature (- heterogenous [non-standard])
"the population of the United States is vast and heterogeneous";
 
2. Originating outside the body (- heterogenous)
""",
  );

  final String keyword = "heterogeneous";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heterogeneous""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heterogeneous""",
                      // alsoEnglishWord: "also: heterogeneous",
                      britshText: """IpaUK: /ˌhetərəˈdʒiːniəs/""",
                      americanText: """IpaUS: /ˌhetərəˈdʒiːniəs/""",
...
کوردی: ناچونیەک، نایەک‌ڕەنگ، نایەک‌شێوە، تێکڵاو،	جۆراوجۆر، جۆربەجۆر، فرەجۆر، جیاواز
"""),
// With short examples define "heterogeneous", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) پێکهاتوو لە زۆر کەس و شتی جیاواز"""),
                    SentencesRow(
                      englishText:
                          """Switzerland is a heterogeneous confederation of 26 self-governing cantons.""",
                      kurdishText:
                          """سویسرا کۆنفیدراسیۆنێکی جۆراوجۆری ٢٦ کانتۆنی خۆبەڕێوەبەرییە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/DxREm3s1scA?t=';
const double _startSecondsend = 0000000000000000000000000003113;
const String _videoIdone = 'https://youtu.be/kP1BHrvYopI?t=';
const double _startSecondsone = 000000000000000000000000000492;
const String _videoIdtwo = 'https://youtu.be/JWI5-vWqcGc?t=';
const double _startSecondstwo = 000000000000000000000000000315;
const String _videoIdthree = 'https://youtu.be/aWeqyAxlM2M?t=';
const double _startSecondsthree = 0000000000000000000000000001198;
const String _videoIdfour = 'https://youtu.be/1QKVKb0xnAw?t=';
const double _startSecondsfour = 000000000000000000000000000149;
const String _videoIdfive = 'https://youtu.be/fZBC3nmvJb8?t=';
const double _startSecondsfive = 000000000000000000000000000979;
