...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'Ir3eJ1t13fk';
    const double startSecondsend = 2619;
    const String videoIdone = 'ilj8fZroRw0';
    const double startSecondsone = 5050;
    const String videoIdtwo = 'zUbod5t_2oM';
    const double startSecondstwo = 231;
    const String videoIdthree = 'DZTTdYCBqqg';
    const double startSecondsthree = 996;
    const String videoIdfour = 'K7ssW8_QHj0';
    const double startSecondsfour = 1228;
    const String videoIdfive = 'myM5SY1mHoA';
    const double startSecondsfive = 985;
