...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 954;
    const String videoIdone = '0E0rarldXK0';
    const double startSecondsone = 227;
    const String videoIdtwo = 'bG-xu5H6plk';
    const double startSecondstwo = 52;
    const String videoIdthree = 'Q9WqQXqNtrc';
    const double startSecondsthree = 424;
    const String videoIdfour = 'VIW0N6AZ4wg';
