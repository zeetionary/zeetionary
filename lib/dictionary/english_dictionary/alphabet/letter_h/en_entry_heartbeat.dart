...
class EnglishEntryheartbeat extends StatefulWidget {
  const EnglishEntryheartbeat({super.key});

  @override
  State<EnglishEntryheartbeat> createState() => _EnglishEntryheartbeatState();
}

class _EnglishEntryheartbeatState extends State<EnglishEntryheartbeat> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heartbeat (Derived forms: heartbeats)
1. The rhythmic contraction and expansion of the arteries with each beat of the heart (- pulse, pulsation, beat)
 
2. A very short time (- blink of an eye [informal], flash, instant, jiffy [informal], split second, trice, twinkling [informal], wink [informal], New York minute [US, informal], jiff [informal], glimmering)
"if I had the chance I'd do it in a heartbeat";
...
""",
  ...
  final String keyword = "heartbeat";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heartbeat""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was suddenly aware of her racing heartbeat.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her heartbeats steadied.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The candidate said that he understood the heartbeat of the Hispanic community in California.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heartbeat""",
                      // alsoEnglishWord: "also: heartbeat",
                      britshText: """IpaUK: /ˈhɑːtbiːt/""",
                      americanText: """IpaUS: /ˈhɑːrtbiːt/""",
...
کوردی: ترپەی دڵ، لێدانی دڵ
"""),
// With short examples define "heartbeat", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) جووڵە یان دەنگی دڵ کە لێدەدات بۆ ناردنی خوێن"""),
                    SentencesRow(
                      englishText: """She was suddenly aware of her racing heartbeat.""",
                      kurdishText: """لەناکاو بەئاگا بوو لە لێدانی خێرای دڵی.""",
                    ...
                    SentencesRow(
                      englishText: """Her heartbeats steadied.""",
                      kurdishText: """لێدانی دڵی هێوربوویەوە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) تایبەتمەندییەکی گرنگی شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The candidate said that he understood the heartbeat of the Hispanic community in California.""",
                      kurdishText: """بەربژێرەکە گوتی کە تێدەگات لە گرنگی کۆمەڵگەی ئیسپانی لە کالیفۆرنیا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/h0IPcqF2q9U?t=';
const double _startSecondsend = 0000000000000000000000000001254;
const String _videoIdone = 'https://youtu.be/EtgxTKuN018?t=';
const double _startSecondsone = 000000000000000000000000000118;
const String _videoIdtwo = 'https://youtu.be/XeHl5Y7m1xM?t=';
const double _startSecondstwo = 000000000000000000000000000429;
const String _videoIdthree = 'https://youtu.be/qS_VWG3JEZg?t=';
const double _startSecondsthree = 000000000000000000000000000247;
const String _videoIdfour = 'https://youtu.be/bIvqhdoZzo8?t=';
const double _startSecondsfour = 000000000000000000000000000354;
const String _videoIdfive = 'https://youtu.be/_tHpanD6Nik?t=';
const double _startSecondsfive = 0000000000000000000000000001554;
