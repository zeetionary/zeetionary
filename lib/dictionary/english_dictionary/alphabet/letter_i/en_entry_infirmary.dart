...
class EnglishEntryinfirmary extends StatefulWidget {
  const EnglishEntryinfirmary({super.key});

  @override
  State<EnglishEntryinfirmary> createState() => _EnglishEntryinfirmaryState();
}

class _EnglishEntryinfirmaryState extends State<EnglishEntryinfirmary> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infirmary""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'M5Vrar4w_CU';
    const double startSecondsend = 267;
    const String videoIdone = 'GLXj3Mm-C-k';
    const double startSecondsone = 139;
    const String videoIdtwo = 'ronquUhy0xE';
    const double startSecondstwo = 597;
    const String videoIdthree = 'gTCYcpdq6Eg';
    const double startSecondsthree = 30;
    const String videoIdfour = 'Lnd6gd_9NMw';
    const double startSecondsfour = 247;
    const String videoIdfive = 'ejFccNmL15g';
