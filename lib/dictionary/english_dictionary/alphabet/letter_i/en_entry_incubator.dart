...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'D6V85qfsu3g';
    const double startSecondsend = 553;
    const String videoIdone = 'bG5fFI3eorg';
    const double startSecondsone = 11;
    const String videoIdtwo = 'AF2cxmRzJMM';
    const double startSecondstwo = 114;
    const String videoIdthree = '1BPxcoZsZLo';
    const double startSecondsthree = 210;
    const String videoIdfour = 'fv_kmflg6q0';
    const double startSecondsfour = 1223;
    const String videoIdfive = 'wgo4VQlh0kM';
