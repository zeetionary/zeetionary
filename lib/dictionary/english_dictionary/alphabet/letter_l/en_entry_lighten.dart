...
class EnglishEntrylighten extends StatefulWidget {
  const EnglishEntrylighten({super.key});

  @override
  State<EnglishEntrylighten> createState() => _EnglishEntrylightenState();
}

class _EnglishEntrylightenState extends State<EnglishEntrylighten> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: lighten (Derived forms: lightening, lightens, lightened)
1. Make more cheerful (- lighten up, buoy up)
"the conversation lightened me up a bit";
 
2. Reduce the weight on; make lighter
"she lightened the load on the tired donkey"
 
3. Become more cheerful (- lighten up, buoy up)
"after a glass of wine, he lightened up a bit";
 
4. Make more cheerful through the use of colour (- brighten, lighten up)
"The paint will lighten the room";
 
5. Become lighter (- lighten up)
"The room lightened up";
 
6. Alleviate or remove (pressure or stress) or make less oppressive (- relieve)
"lighten the burden of caring for her elderly parents";
""",
  );

  final String keyword = "lighten";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lighten""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The measures will lighten the tax burden on small businesses.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The sky began to lighten in the east.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""My mood gradually lightened.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She told a joke to lighten the atmosphere.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/W8uXhQnWgj4?t=680';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/j1BfO7VlIw4?t=563';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/qWAagS_MANg?t=1099';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/UoSSCUMk-7I?t=860';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/Mf4wwXM2o_M?t=210';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/8CUUFpRYtN4?t=384';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lighten""",
                      // alsoEnglishWord: "also: lighten",
                      britshText: """IpaUK: /ˈlaɪtn/""",
                      americanText: """IpaUS: /ˈlaɪtn/""",
...
کوردی: 
"""),
// With short examples define "lighten", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) کەمکردنەوەی ڕێژەی کارکردن، قەرز، نیگەرانی، هتد کە کەسێک هەیەتی"""),
                    const AlsoEnglishckb(word: "ھەروەھا: lessen"),
                    SentencesRow(
                      englishText: """The measures will lighten the tax burden on small businesses.""",
                      kurdishText: """ڕێکارەکان سەختی باج لەسەر بازرگانییە بچووکەکان کەمدەکاتەوە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) ڕۆشنکردن یان ڕۆشنبوون"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The sky began to lighten in the east.""",
                      kurdishText: """ئاسمان دەستیکرد بە ڕۆشنبوونەوە لە ڕۆژهەڵاتەوە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) واکردنی ئەوەی کەسێک کەمتر نیگەران یان دڵتەنگ بێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: cheer"),
                    SentencesRow(
                      englishText: """My mood gradually lightened.""",
                      kurdishText: """حەوسەلەم کەم کەم باشتربوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She told a joke to lighten the atmosphere.""",
                      kurdishText: """نوکتەیەکی گێڕایەوە بۆ خۆشکردنی کەشەکە.""",
