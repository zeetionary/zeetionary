...
class EnglishEntryconcurrence extends StatelessWidget {
// blank divider
  EnglishEntryconcurrence({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakconcurrence(String languageCode) async {
    // DOPSUM: CHANGE speakconcurrence
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "concurrence"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /kənˈkʌrəns/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakconcurrence("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /kənˈkɜːrəns/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakconcurrence("en-US"),
                            ),
                          ],
                        ),
                      ],
...
کوردی: ڕێک‌کەوتن، سازبوون، پێک‌هاتن،	هاوکاتی،	(بیرکاری) پێک‌گەیشتن، گەیینەوە،	خاڵی پێک‌گەیشتن، جەمسەر
"""),
...
// Create an instance of EnglishMeaningConst with the desired text
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: concurrence (Derived forms: concurrences)
1. Agreement of results or opinions (= concurrency)
 
2. Acting together, as agents, circumstances or events (= concurrency)
 
3. A state of cooperation (= meeting of minds)
 
4. The temporal property of two things happening at the same time (= coincidence, conjunction, co-occurrence)
"the interval determining the concurrence gate is adjustable";
""",
  );
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/me51ngAYAI0?t=',
    startSeconds: 928,
    autoPlay: true,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/gZvr92YcmGI?t=',
    startSeconds: 453,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/fEbed_DvQZI?t=',
    startSeconds: 187,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/RGS4-7WMWhI?t=',
    startSeconds: 238,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/D2h2D1FU-MQ?t=',
    startSeconds: 104,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
