...
class EnglishEntrylung extends StatefulWidget {
  const EnglishEntrylung({super.key});

  @override
  State<EnglishEntrylung> createState() => _EnglishEntrylungState();
}

class _EnglishEntrylungState extends State<EnglishEntrylung> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylung lung
WORD_WEB lung lung lung
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lung";
...
کوردی: 
"""),
// With short examples define "lung", please follow LX instructions
