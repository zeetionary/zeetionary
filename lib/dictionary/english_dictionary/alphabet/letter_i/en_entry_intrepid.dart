...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'vOxFgZaD0tQ';
    const double startSecondsend = 40;
    const String videoIdone = 'VPURs2iP9YY';
    const double startSecondsone = 1077;
    const String videoIdtwo = '0EPY1CKFecs';
    const double startSecondstwo = 121;
    const String videoIdthree = 'edbWdVkJUuE';
    const double startSecondsthree = 653;
    const String videoIdfour = 'SHx4xVhfS3w';
    const double startSecondsfour = 52;
    const String videoIdfive = 'nlzQU2X9EqA';
