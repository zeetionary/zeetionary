...
class EnglishEntryfuckall extends StatefulWidget {
  const EnglishEntryfuckall({super.key});

  @override
  State<EnglishEntryfuckall> createState() => _EnglishEntryfuckallState();
}

class _EnglishEntryfuckallState extends State<EnglishEntryfuckall> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fuck all (Derived forms: fuck alls)
Usage: Brit, vulgar
1. Little or nothing at all (- Fanny Adams [Brit, informal], sweet Fanny Adams [Brit, informal])

""",
  );

  final String keyword = "fuck all";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fuck all""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""You've done fuck all today.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""These instructions make fuck all sense to me.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fuck all""",
                      // alsoEnglishWord: "also: fuck all",
                      britshText: """IpaUK: /ˌfʌk ˈɔːl/""",
                      americanText: """IpaUS: /ˌfʌk ˈɔːl/""",
...
کوردی: هیچ، هیچ پۆخێ، هیچ گوویێ
"""),
// With short examples define "fuck all", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) هیچ شتێک؛ """),
                    SentencesRow(
                      englishText: """You've done fuck all today.""",
                      kurdishText: """ئەمڕۆ هیچ گوویەکت نەکردووە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕێنماییەکان هیچ تێگەشتنم پێ نادەن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/uPeOgQSsjDM?t=';
const double _startSecondsend = 00000000000000000000000000034;
const String _videoIdone = 'https://youtu.be/i7QJkWoaBkg?t=';
const double _startSecondsone = 000000000000000000000000000928;
const String _videoIdtwo = 'https://youtu.be/FaWPa6MtiPI?t=';
const double _startSecondstwo = 0000000000000000000000000001343;
const String _videoIdthree = 'https://youtu.be/N3KdxN0hzfI?t=';
const double _startSecondsthree = 000000000000000000000000000543;
const String _videoIdfour = 'https://youtu.be/6dx_fWtnepQ?t=';
const double _startSecondsfour = 000000000000000000000000000472;
const String _videoIdfive = 'https://youtu.be/NMBE_eYejq4?t=';
