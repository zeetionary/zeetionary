...
class EnglishEntrylofty extends StatefulWidget {
  const EnglishEntrylofty({super.key});

  @override
  State<EnglishEntrylofty> createState() => _EnglishEntryloftyState();
}

class _EnglishEntryloftyState extends State<EnglishEntrylofty> {
  @override
  void initState() {
    super.initState();
