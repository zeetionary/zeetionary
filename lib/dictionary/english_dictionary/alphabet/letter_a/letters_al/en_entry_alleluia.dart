...
// replace these: replace EnglishEntryalleluia - replace speakAlleluia - replace alleluia - /ˌælɪˈluːjə/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryalleluia extends StatelessWidget {
  ...
  Future<void> speakAlleluia35288(String languageCode) async {
    ...
    await flutterTts.speak(
        "When the news of their victory came, there was an 'alleluia' of happiness and relief among the team."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "alleluia", // DOPSUM: CHANGE WORD ENTRY - Find /ˌælɪˈluːjə/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAlleluia(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '43YMCoZHpPE';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'evWIerF3eeU';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '4AQ1mHMfIVI';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'HNrYlaBCQrQ';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'TTQXavt214c';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'Co4jgavsv1Q';
