...
class EnglishEntryexuberantly extends StatefulWidget {
  const EnglishEntryexuberantly({super.key});

  @override
  State<EnglishEntryexuberantly> createState() =>
      _EnglishEntryexuberantlyState();
}

class _EnglishEntryexuberantlyState extends State<EnglishEntryexuberantly> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exuberantly""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exuberantly""",
                      // alsoEnglishWord: "also: exuberantly",
                      britshText: """IpaUK: /ɪɡˈzjuːbərəntli/""",
                      americanText: """IpaUS: /ɪɡˈzuːbərəntli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exuberantly";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They danced exuberantly.""");
  }
...
// With short examples define "exuberantly", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵکار) کە پڕ لە جۆش و خرۆشی و دڵخۆشییە"""),
          SentencesRow(
            englishText: """They danced exuberantly.""",
            kurdishText: """بە کەیفەوە سەمایان دەکرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: exuberantly
1. In an exuberant manner (= riotously)
"the exuberantly baroque decoration of the church";
 
2. In an ebullient manner (= ebulliently, expansively)
"Khrushchev exuberantly promised to supply rockets for the protection of Cuba against American aggression";
""",
  );
...
const String _videoIdend = 'https://youtu.be/-zAFmH4qsGc?t=';
const double _startSecondsend = 000000000000000000000000000878;
const String _videoIdone = 'https://youtu.be/mj4ck6isFmI?t=';
const double _startSecondsone = 00000000000000000000000000035;
const String _videoIdtwo = 'https://youtu.be/4NjRmn1Ag_o?t=';
const double _startSecondstwo = 0000000000000000000000000002575;
const String _videoIdthree = 'https://youtu.be/lEV2OGm4vFA?t=';
const double _startSecondsthree = 000000000000000000000000000660;
const String _videoIdfour = 'https://youtu.be/wxnZUrd-Uh0?t=';
const double _startSecondsfour = 0000000000000000000000000001010;
const String _videoIdfive = 'https://youtu.be/eu5jp9TxlBI?t=';
