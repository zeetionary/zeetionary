...
class EnglishEntryinsolvency extends StatefulWidget {
  const EnglishEntryinsolvency({super.key});

  @override
  State<EnglishEntryinsolvency> createState() => _EnglishEntryinsolvencyState();
}

class _EnglishEntryinsolvencyState extends State<EnglishEntryinsolvency> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insolvency""");
  }
