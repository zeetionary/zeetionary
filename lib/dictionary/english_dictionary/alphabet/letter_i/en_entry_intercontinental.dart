...
class EnglishEntryintercontinental extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intercontinental""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'xX0ozxrZlEQ';
    const double startSecondsend = 359;
    const String videoIdone = '3E17wr77ffM';
    const double startSecondsone = 26;
    const String videoIdtwo = 'EH6vE97qIP4';
    const double startSecondstwo = 2361;
    const String videoIdthree = '4MqK90Aq8bE';
    const double startSecondsthree = 201;
    const String videoIdfour = '3AvoV8GodbU';
    const double startSecondsfour = 319;
    const String videoIdfive = '5r90DYjZ76g';
    const double startSecondsfive = 374;
