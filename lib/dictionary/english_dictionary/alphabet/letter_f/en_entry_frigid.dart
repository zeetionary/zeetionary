...
class EnglishEntryfrigid extends StatefulWidget {
  const EnglishEntryfrigid({super.key});

  @override
  State<EnglishEntryfrigid> createState() => _EnglishEntryfrigidState();
}

class _EnglishEntryfrigidState extends State<EnglishEntryfrigid> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: frigid
1. Sexually unresponsive (= cold)
"a frigid woman";
 
2. Extremely cold (= arctic, gelid, glacial, icy, polar)
"a frigid day";
 
3. Devoid of warmth and cordiality; expressive of unfriendliness or disdain (= frosty, frozen, glacial, icy, wintry)
"a frigid greeting";
""",
  );

  final String keyword = "frigid";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They travelled over frigid lands.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There was a frigid atmosphere in the room.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frigid""",
                      // alsoEnglishWord: "also: frigid",
                      britshText: """IpaUK: /ˈfrɪdʒɪd/""",
                      americanText: """IpaUS: /ˈfrɪdʒɪd/""",
...
کوردی: سارد، بەستەڵەک، شەختەبەند، تۆف‌وبەند، بەستوو،	بێ‌هەست، وشک، ساردوسڕ، نادۆستانە،	ژنی سارد
"""),
// With short examples define "frigid", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بە زەویی زۆر سارددا گەشتیان کرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە هیچ هەستێکی خۆش یان هاوڕێیانە پیشان نادات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """There was a frigid atmosphere in the room.""",
                      kurdishText: """کەشێکی ناخۆش لە ژوورەکە هەبوو.""",
...
const double _startSecondsend = 000000000000000000000000000739;
const String _videoIdone = 'https://youtu.be/C_7tn_oGHI0?t=';
const double _startSecondsone = 0000000000000000000000000002643;
const String _videoIdtwo = 'https://youtu.be/UZ0ausMICgM?t=';
const double _startSecondstwo = 000000000000000000000000000497;
const String _videoIdthree = 'https://youtu.be/b8WnPAxVxRY?t=';
const double _startSecondsthree = 000000000000000000000000000848;
const String _videoIdfour = 'https://youtu.be/Yv0Xk5KZcZE?t=';
const double _startSecondsfour = 000000000000000000000000000448;
const String _videoIdfive = 'https://youtu.be/k17NmE6LLG8?t=';
const double _startSecondsfive = 000000000000000000000000000199;
