...
class EnglishEntryenrichment extends StatefulWidget {
  const EnglishEntryenrichment({super.key});

  @override
  State<EnglishEntryenrichment> createState() => _EnglishEntryenrichmentState();
}

class _EnglishEntryenrichmentState extends State<EnglishEntryenrichment> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enrichment""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enrichment""",
                      // alsoEnglishWord: "also: enrichment",
                      britshText: """IpaUK: /ɪnˈrɪtʃmənt/""",
                      americanText: """IpaUS: /ɪnˈrɪtʃmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enrichment";
...
کوردی: بەپیتی، مایەداری، پیتاندن، زاخاندن، دەوڵەمەندکردن، مایەدارکردن، مایاندن، زاخاودان، زاخ‌کردن
"""),
          const DefinitionKurdish(
              text: """١. (ناو) باشترکردنی کوالێتیی شتێک"""),
          SentencesRow(
            englishText:
                """Qualifying students are invited to attend a six-week summer enrichment programme.""",
            kurdishText:
                """خوێندکارە شایستەکان بانگهێشتکران بۆ بەژداری لە پڕۆگرامێکی هاوینەی بەهێزکردنی تواناکان.""",
          ...
          SentencesRow(
            englishText:
                """Their goal is not the good of the people, but their own enrichment.""",
            kurdishText:
                """ئامانجیان چاکەی خەڵکەکە نییە بەڵکو دەوڵەمەندبوونی خۆیانە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: enrichment (Derived forms: enrichments)
...
const String _videoIdend = 'https://youtu.be/nnzYZdGFzzM?t=';
const double _startSecondsend = 301;
const String _videoIdone = 'https://youtu.be/x3zQELlrY6A?t=';
const double _startSecondsone = 87;
const String _videoIdtwo = 'https://youtu.be/wqMMEGW_Uqs?t=';
const double _startSecondstwo = 223;
const String _videoIdthree = 'https://youtu.be/4knJCinUgXU?t=';
const double _startSecondsthree = 486;
const String _videoIdfour = 'https://youtu.be/3a9MmVMyoTo?t=';
const double _startSecondsfour = 264;
const String _videoIdfive = 'https://youtu.be/kRO5jOa06Qw?t=';
const double _startSecondsfive = 2010;
const String _videoIdsix = 'https://youtu.be/U_7CGl6VWaQ?t=';
const double _startSecondssix = 559;
