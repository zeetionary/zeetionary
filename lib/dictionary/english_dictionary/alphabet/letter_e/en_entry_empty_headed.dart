...
// """),
          ...
          SentencesRow(
            englishText:
                """The plan failed because it was made by an empty-headed leader.""",
            kurdishText:
                """پلانەکە شکستی ھێنا چونکە لەلایەن سەرکردەیەکی کەللەپووکەوە داندرا.""",
          ...
          //   onPressedAmerican: () => speaksentence2sentence300""",
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = '_vcpgDBzWyc';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'NXvertLlhW8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '5siSa4A9M_Q';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'KYacEAxLsME';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'zlQh7JmpaYY';
