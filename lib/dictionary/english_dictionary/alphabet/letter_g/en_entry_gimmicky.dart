...
class EnglishEntrygimmicky extends StatefulWidget {
  const EnglishEntrygimmicky({super.key});

  @override
  State<EnglishEntrygimmicky> createState() => _EnglishEntrygimmickyState();
}

class _EnglishEntrygimmickyState extends State<EnglishEntrygimmicky> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: gimmicky
1. Featuring or full of gimmicks
"Gimmicky openings don't work because they produce a gimmicky response"
""",
  );

  final String keyword = "gimmicky";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gimmicky""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The product's gimmicky design didn't improve its function.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gimmicky""",
                      // alsoEnglishWord: "also: gimmicky",
                      britshText: """IpaUK: /ˈɡɪmɪki/""",
                      americanText: """IpaUS: /ˈɡɪmɪki/""",
...
کوردی: فریودەر، لەخشتەبەر، بەهەڵەدابەر، هەڵفریوێنەر
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) بەکارهێنانی شتێک کە گرنگ نییە و بەکاردێت بۆ ڕاکێشانی سەرنجی خەڵکی، بە تایبەتی بۆ ئەوەی شتێک بکڕن"""),
                    SentencesRow(
                      englishText:
                          """The product's gimmicky design didn't improve its function.""",
                      kurdishText:
                          """دیزاینە فریودەرەکەی بەرهەمەکە هیچ کارکردنی باشتر نەکرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/GsK5NaSCkho?t=';
const double _startSecondsend = 000000000000000000000000000403;
const String _videoIdone = 'https://youtu.be/Ix6vtM4gP8g?t=';
const double _startSecondsone = 000000000000000000000000000360;
const String _videoIdtwo = 'https://youtu.be/tFdnCzfJPJ0?t=';
const double _startSecondstwo = 0000000000000000000000000001056;
const String _videoIdthree = 'https://youtu.be/3j_FyDbw-bo?t=';
const double _startSecondsthree = 000000000000000000000000000186;
const String _videoIdfour = 'https://youtu.be/0WIwQgH4lKg?t=';
const double _startSecondsfour = 00000000000000000000000000021;
const String _videoIdfive = 'https://youtu.be/auL6gvGSI_Q?t=';
const double _startSecondsfive = 000000000000000000000000000426;
