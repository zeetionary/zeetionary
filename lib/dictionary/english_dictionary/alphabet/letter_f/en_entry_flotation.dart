...
class EnglishEntryflotation extends StatefulWidget {
  const EnglishEntryflotation({super.key});

  @override
  State<EnglishEntryflotation> createState() => _EnglishEntryflotationState();
}

class _EnglishEntryflotationState extends State<EnglishEntryflotation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flotation (Derived forms: flotations)
1. The phenomenon of floating (remaining on the surface of a liquid without sinking) (= floatation)
 
2. Financing a commercial enterprise by bond or stock shares (= floatation)
""",
  );

  final String keyword = "flotation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flotation""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""All who remain missing are believed to be wearing flotation devices.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flotation""",
                      // alsoEnglishWord: "also: flotation",
                      britshText: """IpaUK: /fləʊˈteɪʃn/""",
                      americanText: """IpaUS: /fləʊˈteɪʃn/""",
...
// With short examples define "flotation", please follow LX instructions
                    CustomRichText(
                      ...
                      textAfterLink: "",
                      onTap: () {
                        Routemaster.of(context).push("/english-flotation/float");
                      },
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) سەرئاوکەوتن"""),
                    SentencesRow(
                      englishText:
                          """All who remain missing are believed to be wearing flotation devices.""",
                      kurdishText: """هەموو ئەوانەی کە بە ونبوو ماونەتەوە باوەڕ وایە کە ئامرازی سەرئاوکەوتنیان بەستووە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/L87HuKmGwVQ?t=';
const double _startSecondsend = 000000000000000000000000000823;
const String _videoIdone = 'https://youtu.be/OnjI-FBdRTQ?t=';
const double _startSecondsone = 00000000000000000000000000017160;
const String _videoIdtwo = 'https://youtu.be/4mjvZrLnlCg?t=';
const double _startSecondstwo = 000000000000000000000000000826;
const String _videoIdthree = 'https://youtu.be/Vzi1qNykIu0?t=';
const double _startSecondsthree = 00000000000000000000000000087;
const String _videoIdfour = 'https://youtu.be/Gvt3TFaDLj0?t=';
const double _startSecondsfour = 000000000000000000000000000588;
const String _videoIdfive = 'https://youtu.be/QlTf5X0MKbg?t=';
const double _startSecondsfive = 0000000000000000000000000001069;
