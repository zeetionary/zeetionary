                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "articulation"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ɑːˌtɪkjuˈleɪʃn/"),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '7D0F1lSvGi0';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'XNN1Hbg9oNU';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'NTpd-KE2aw0';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = '2xF_teT2_V0';
