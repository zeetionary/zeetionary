...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 0000000000000000000000000001226;
    const String videoIdtwo = 'https://youtu.be/Zb5IH57SorQ?t=';
    const double startSecondstwo = 00000000000000000000000000018;
    const String videoIdthree = 'https://youtu.be/ktlTxC4QG8g?t=';
    const double startSecondsthree = 00000000000000000000000000025;
    const String videoIdfour = 'https://youtu.be/Ot4qdCs54ZE?t=';
    const double startSecondsfour = 000000000000000000000000000774;
    const String videoIdfive = 'https://youtu.be/qCbfTN-caFI?t=';
    const double startSecondsfive = 000000000000000000000000000671;
