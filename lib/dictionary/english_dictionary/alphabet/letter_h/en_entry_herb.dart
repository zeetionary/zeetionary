...
class EnglishEntryherb extends StatefulWidget {
  const EnglishEntryherb({super.key});

  @override
  State<EnglishEntryherb> createState() => _EnglishEntryherbState();
}

class _EnglishEntryherbState extends State<EnglishEntryherb> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: herb (Derived forms: herbs)
1. Aromatic potherb used in cookery for its savoury qualities
 
2. A plant lacking a permanent woody stem; many are flowering garden plants or potherbs; some having medicinal properties; some are pests (- herbaceous plant)
""",
  );

  final String keyword = "herb";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Add a teaspoonful of mixed herbs.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """herb""",
                      // alsoEnglishWord: "also: herb",
                      britshText: """IpaUK: /hɜːb/""",
                      americanText: """IpaUS: /ɜːrb/, /hɜːrb/""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/QdWDfgL3XkA';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/VJmoqrufDM4?t=';
const double _startSecondsone = 00000000000000000000000000081;
const String _videoIdtwo = 'https://youtu.be/PKOpu2TBKMo';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/9u8BUl1nr4Y?t=';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/Rr7Xkn6J90k?t=';
const double _startSecondsfour = 00000000000000000000000000012;
const String _videoIdfive = 'https://youtu.be/lInxbk4j5Ag?t=';
