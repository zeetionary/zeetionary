...
class EnglishEntryinfamous extends StatefulWidget {
  const EnglishEntryinfamous({super.key});

  @override
  State<EnglishEntryinfamous> createState() => _EnglishEntryinfamousState();
}

class _EnglishEntryinfamousState extends State<EnglishEntryinfamous> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: infamous
1. Known widely and usually unfavourably (- ill-famed, notorious)
"the infamous Benedict Arnold";
""",
  );

  final String keyword = "infamous";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infamous""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000121;
    const String videoIdone = 'https://youtu.be/Cln0J87vulU?t=';
    const double startSecondsone = 000000000000000000000000000105;
    const String videoIdtwo = 'https://youtu.be/8FpPSMIB4uA?t=';
    const double startSecondstwo = 0000000000000000000000000001124;
    const String videoIdthree = 'https://youtu.be/hRSGxw2AQnk?t=';
    const double startSecondsthree = 000000000000000000000000000679;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """infamous""",
                      // alsoEnglishWord: "also: infamous",
                      britshText: """IpaUK: /ˈɪnfəməs/""",
                      americanText: """IpaUS: /ˈɪnfəməs/""",
...
کوردی: شەرماوی، ناحەز، شوورەیی، ناشیرین، ئابڕووبەرە، نەنگ، عەیب،	ڕووڕەش، نێوزڕاو، ئابڕووتکاو، ڕووسیابار، بێ‌ئابڕوو، نێودەرکردوو
"""),
// With short examples define "infamous", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە بەناوبانگە بە خراپی"""),
                    const AlsoEnglishckb(word: "ھەروەھا: notorious"),
                    SentencesRow(
                      englishText:
                          """He is infamous for saying that cheating is the way the game is played.""",
                      kurdishText:
                          """خراپ نێودەرکردووە بۆ گوتنی ئەوەی فێڵکردن شێوازی ئەنجامدانی یارییەکەیە.""",
