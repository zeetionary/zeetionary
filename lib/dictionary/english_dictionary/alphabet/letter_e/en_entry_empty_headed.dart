...
class EnglishEntryemptyheaded extends StatefulWidget {
  const EnglishEntryemptyheaded({super.key});

  @override
  State<EnglishEntryemptyheaded> createState() =>
      _EnglishEntryemptyheadedState();
}

class _EnglishEntryemptyheadedState extends State<EnglishEntryemptyheaded> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("empty-headed");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "empty-headed",
                      // alsoEnglishWord: "also: empty-headed",
                      britshText: "IpaUK: /ˌempti ˈhedɪd/",
                      americanText: "IpaUS: /ˌempti ˈhedɪd/",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "empty-headed";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        "The plan failed because it was made by an empty-headed leader.");
  }
...
// """),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) کەسێک کە ناتوانێت ئاقڵانە بیربکاتەوە"""),
          SentencesRow(
            englishText:
                """The plan failed because it was made by an empty-headed leader.""",
            kurdishText:
                """پلانەکە شکستی هێنا چونکە لەلایەن سەرکردەیەکی کەللەپووکەوە داندرا.""",
...
1. Lacking seriousness; given to frivolity (= airheaded, dizzy, featherbrained, giddy, light-headed, lightheaded, silly)
""",
  );
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/_vcpgDBzWyc?t=';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/oXPhvh4eGcM?t=';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/NXvertLlhW8?t=';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/5siSa4A9M_Q?t=';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/KYacEAxLsME?t=';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/zlQh7JmpaYY?t=';
