...
class EnglishEntryeviction extends StatefulWidget {
  const EnglishEntryeviction({super.key});

  @override
  State<EnglishEntryeviction> createState() => _EnglishEntryevictionState();
}

class _EnglishEntryevictionState extends State<EnglishEntryeviction> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""eviction""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """eviction""",
                      // alsoEnglishWord: "also: eviction",
                      britshText: """IpaUK: /ɪˈvɪkʃn/""",
                      americanText: """IpaUS: /ɪˈvɪkʃn/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The tenants were threatened with eviction.""");
  }
...
کوردی: دەرکردن، دەرپەڕاندن، پێ‌چۆڵ‌کردن، وەدەرنان، خستنەدەرەوە، چۆڵ‌کردن، بەجێ‌هێشتن
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) دەرکردنی کەسێک لە ژوور یان زەوییەک، بەتایبەتی کە مافی یاساییت هەیە"""),
          SentencesRow(
            englishText: """The tenants were threatened with eviction.""",
            kurdishText: """کرێچییەکان هەڕەشەی دەرکردنیان لێکرا.""",
          ...
          SentencesRow(
            englishText:
                """They received an eviction notice telling them they had to leave in seven days.""",
            kurdishText:
                """ئاگاداریی دەرکردنیان پێدرا کە دەبێت لە حەوت ڕۆژدا بچن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: eviction (Derived forms: evictions)
1. (law) action by a landlord that compels a tenant to leave the premises (as by rendering the premises unfit for occupancy); no physical expulsion or legal process is involved (= constructive eviction)
 
2. (law) the expulsion of someone (such as a tenant) from the possession of land by process of law (= dispossession, legal ouster)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/xgQT4A6dS_o?t=';
const double _startSecondsend = 000000000000000000000000000000; // 413;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/I63BBggZK9Q?t=';
const double _startSecondsone = 00000000000000000000000000000; // 184;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/XZComkkxeEI?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 368;
const String _videoIdthree = 'VIDEOhttps://youtu.be/oqySpTv0E5g?t=';
const double _startSecondsthree = 000000000000000000000000000; // 514;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/MPFPBzr7FgY?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 380;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/ZkiiyJYaXkQ?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1003;
