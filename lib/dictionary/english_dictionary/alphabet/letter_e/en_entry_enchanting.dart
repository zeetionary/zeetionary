...
class EnglishEntryenchanting extends StatefulWidget {
  const EnglishEntryenchanting({super.key});

  @override
  State<EnglishEntryenchanting> createState() => _EnglishEntryenchantingState();
}

class _EnglishEntryenchantingState extends State<EnglishEntryenchanting> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("enchanting");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "enchanting",
                      // alsoEnglishWord: "also: enchanting",
                      britshText: "IpaUK: /ɪnˈtʃɑːntɪŋ/",
                      americanText: "IpaUS: /ɪnˈtʃæntɪŋ/",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enchanting";
...
کوردی: تەلەسماوی، ئەفسووناوی، سەرنج‌ڕاکێش، دڵڕفێن، فریودەر
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) جوان و خۆش"""),
          SentencesRow(
            englishText:
                """It's described in the guide book as "an enchanting medieval city".""",
            kurdishText:
                """لە کتێبە ڕێبەرییەکە وەک "شارێکی ئەفسووناوی سەردەمانی ناوەڕاست" باسکراوە.""",
...
1. Capturing interest as if by a spell (= bewitching, captivating, enthralling, entrancing, fascinating)
"enchanting music";
""",
  );
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/Vac36s2rdFY?t=';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/gpv7ayf_tyE?t=';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/kMYZ3fUlZFA?t=';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/a6urwsKddKk?t=';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/zssa-tdKfBk?t=';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/7j5ul4XBjAI?t=';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/v5KEURgn-yg?t=';
