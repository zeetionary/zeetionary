...
class EnglishEntrygreatbritain extends StatefulWidget {
  const EnglishEntrygreatbritain({super.key});

  @override
  State<EnglishEntrygreatbritain> createState() =>
      _EnglishEntrygreatbritainState();
}

class _EnglishEntrygreatbritainState extends State<EnglishEntrygreatbritain> {
  @override
  void initState() {
    super.initState();
...
2. A monarchy in northwestern Europe occupying most of the British Isles; divided into England and Scotland and Wales and Northern Ireland; 'Great Britain' is often used loosely to refer to the United Kingdom (- United Kingdom, UK, U.K., Britain, United Kingdom of Great Britain and Northern Ireland, Pommyland [Austral, NZ, informal])
""",
  );

  final String keyword = "Great Britain";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Great Britain""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Great Britain has a rich history.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""London is the capital of Great Britain.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """Great Britain""",
                      // alsoEnglishWord: "also: Great Britain",
                      britshText: """IpaUK: /ˌɡreɪt ˈbrɪtn/""",
                      americanText: """IpaUS: /ˌɡreɪt ˈbrɪtn/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText: """Great Britain has a rich history.""",
                      kurdishText:
                          """بەریتانیای مەزن مێژوویەکی دەوڵەمەندی هەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لەندەن پایتەختی بەریتانیای مەزنە.""",
...
const double _startSecondsend = 00000000000000000000000000052;
const String _videoIdone = 'https://youtu.be/vsMydMDi3rI?t=';
const double _startSecondsone = 0000000000000000000000000002675;
const String _videoIdtwo = 'https://youtu.be/AMN9Ek4qec0?t=';
const double _startSecondstwo = 000000000000000000000000000249;
const String _videoIdthree = 'https://youtu.be/2XIsHyfTmfc?t=';
const double _startSecondsthree = 000000000000000000000000000205;
const String _videoIdfour = 'https://youtu.be/Ix3JApnAF4w?t=';
const double _startSecondsfour = 000000000000000000000000000450;
const String _videoIdfive = 'https://youtu.be/eJP93u7n5Ok?t=';
const double _startSecondsfive = 000000000000000000000000000945;
