...
class EnglishEntrygrounding extends StatefulWidget {
  const EnglishEntrygrounding({super.key});

  @override
  State<EnglishEntrygrounding> createState() => _EnglishEntrygroundingState();
}

class _EnglishEntrygroundingState extends State<EnglishEntrygrounding> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grounding (Derived forms: groundings)
1. Education or instruction in the fundamentals of a field of knowledge (- foundation)
"a good grounding in mathematics";
 
2. Fastening electrical equipment to earth (- earthing)
""",
  );

  final String keyword = "grounding";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grounding""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He has a good grounding in grammar.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grounding""",
                      // alsoEnglishWord: "also: grounding",
                      britshText: """IpaUK: /ˈɡraʊndɪŋ/""",
                      americanText: """IpaUS: /ˈɡraʊndɪŋ/""",
...
کوردی: 
"""),
// With short examples define "grounding", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) فێرکردنی بنچینەکانی بابەتێک"""),
                    SentencesRow(
                      englishText: """He has a good grounding in grammar.""",
                      kurdishText: """تێگەشتنی بنچینەیی باشی ڕێزمانی هەبوو.""",
...
const String _videoIdone = 'https://youtu.be/kMLDScu1zD8?t=';
...
const String _videoIdfour = 'https://youtu.be/UEEsdXn8oG8?t=';
const double _startSecondsfour = 000000000000000000000000000412;
const String _videoIdfive = 'https://youtu.be/dzfAwSp5EMY?t=';
const double _startSecondsfive = 000000000000000000000000000687;
