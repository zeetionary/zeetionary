...
class EnglishEntrygroup extends StatefulWidget {
  const EnglishEntrygroup({super.key});

  @override
  State<EnglishEntrygroup> createState() => _EnglishEntrygroupState();
}

class _EnglishEntrygroupState extends State<EnglishEntrygroup> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: group (Derived forms: groups)
...
- Verb: group (Derived forms: grouped, grouping, groups)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""A group of us are going to the theatre this evening.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""English is a member of the Germanic group of languages.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""People were standing around in small groups.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The gorillas go foraging for food as a group.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She has a very wide group of friends.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The animals live in family groups of 10–20 individuals.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Other members of the group agree.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There are fifteen of us in the group.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The students were divided into groups of four.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Only group members are allowed to vote.""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The group formed back in 1992.""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The children grouped themselves around their teacher.""");
  }
  ...
  Future<void> speaksentence18(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Most of the houses were grouped around the church.""");
  }
  ...
  Future<void> speaksentence19(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We all grouped around the tree for a photograph.""");
  }
  ...
  Future<void> speaksentence20(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The books are grouped together by subject.""");
  }
  ...
  Future<void> speaksentence21(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Contestants were grouped according to age and ability.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """group""",
                      // alsoEnglishWord: "also: group",
                      britshText: """IpaUK: /ɡruːp/""",
                      americanText: """IpaUS: /ɡruːp/""",
...
کوردی: کۆمەڵ، دەستە، پۆل، کۆڕ، جەڵەب، تاقم، پەرەم، جەماعەت، (زمانەوانی) گروپ، کۆمەڵ، خێزان، ماڵبات
"""),
// With short examples define "group", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) گرووپێک کەس یان شت"""),
                    SentencesRow(
                      englishText:
                        ...
                        MyExpansionTile(
                          children: [
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """ئینگلیزی ئەندامێکی گرووپی زمانە ئەڵمانییەکانە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """خەڵکی لەو دەورە بە گرووپی بچووک وەستابوون.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """گۆرێلاکان دەچن بۆ خواردن دەگەڕێن بە گرووپ.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """گرووپێکی فراوان لە هاوڕێی هەیە.""",
                            ...
                            SentencesRow(
                              englishText:
                                  """Minority groups are entitled to equal protection under the law.""",
                              kurdishText:
                                  """گرووپە کەمینەکان مافی پاراستنی یەکسانیان هەیە بە پێی یاسا.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """ئاژەڵەکان لە گرووپی خێزانی ١٠-٢٠ کەسیدا دەژین""",
                            ...
                            SentencesRow(
                              englishText:
                                  """The president met with a select group of senior ministers.""",
                              kurdishText:
                                  """سەرۆک لەگەڵ گرووپێکی دیاریکراو لە وەزیرانی باڵا کۆبوویەوە.""",
                            ...
                            SentencesRow(
                              englishText:
                                  """A large group of people had collected outside the building.""",
                              kurdishText:
                                  """گرووپێکی گەورە لە خەڵکی لە دەرەوەی بیناکە کۆببوونەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ژمارەیەک کەس کە پێکەوە کار دەکەن یان هەمان بیرکردنەوەیان هەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    SentencesRow(
                      englishText:
                          """She leads a group of scientists at the Medical Research Centre.""",
                      kurdishText:
                          """پێشڕەوی ژمارەیەک زانا دەکات لە سەنتەری لێکۆڵینەوە توێژینەوەییەکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There are fifteen of us in the group.""",
                      kurdishText: """پازدە کەسین لە گرووپەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خوێندکارەکان بۆ گرووپی چوار کەسی دابەشکران.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەنها ئەندامانی گرووپەکە ڕێگا پێدراون دەنگ بدەن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) ژمارەیەک کۆمپانیا کە هی یەک کەس یان دامەزراوەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """This acquisition will make them the largest newspaper group in the world.""",
                      kurdishText:
                          """کڕینەکە دەیانکات بە گەورەترین گرووپی ڕۆژنامەوانی لە جیهاندا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """منداڵەکان لە دەوری مامۆستاکەیان کۆبوونەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆرینەی خانووەکان لە دەوری کڵێساکە کۆکرابوونەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەموو لە دەوری دارەکە کۆبووینەوە بۆ وێنەیەک.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٦. (کردار) دابەشکردنی خەڵکی و شت بۆ ژمارەیەک گرووپی لێکچوو و هاوبەش"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The books are grouped together by subject.""",
                      kurdishText: """کتێبەکان بەپێی بابەت گرووپ کراون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕکابەرەکان بەپیی تەمەن و توانا گرووپ کرابوون.""",
...
const double _startSecondsend = 0000000000000000000000000001177;
const String _videoIdone = 'https://youtu.be/47MNn4bsmSw?t=';
const double _startSecondsone = 0000000000000000000000000001848;
const String _videoIdtwo = 'https://youtu.be/W2c86R-BOw0?t=';
const double _startSecondstwo = 000000000000000000000000000114;
const String _videoIdthree = 'https://youtu.be/B0lwiInZG1E?t=';
const double _startSecondsthree = 000000000000000000000000000164;
const String _videoIdfour = 'https://youtu.be/HDntl7yzzVI?t=';
const double _startSecondsfour = 0000000000000000000000000001709;
const String _videoIdfive = 'https://youtu.be/zqllxbPWKNI?t=';
const double _startSecondsfive = 0000000000000000000000000001050;
