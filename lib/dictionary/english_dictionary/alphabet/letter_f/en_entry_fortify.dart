...
class EnglishEntryfortify extends StatefulWidget {
  const EnglishEntryfortify({super.key});

  @override
  State<EnglishEntryfortify> createState() => _EnglishEntryfortifyState();
}

class _EnglishEntryfortifyState extends State<EnglishEntryfortify> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: fortify (Derived forms: fortified, fortifies, fortifying)
1. Make strong or stronger (= strengthen, beef up)
"This exercise will fortify your upper body";
 
2. Enclose by or as if by a fortification (= fort)
 
3. Prepare oneself for a military confrontation (= arm, build up, gird)
"troops are fortifying on the Iraqi border";
 
4. (cooking) add nutrients to
"fortified milk"
 
5. (cooking) add alcohol to (beverages) (= spike, lace)
"the punch is fortified!";
""",
  );

  final String keyword = "fortify";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fortify""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They fortified the area against attack.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He fortified himself against the cold with a hot drink.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The news merely fortified their determination.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fortify""",
                      // alsoEnglishWord: "also: fortify",
                      britshText: """IpaUK: /ˈfɔːtɪfaɪ/""",
                      americanText: """IpaUS: /ˈfɔːrtɪfaɪ/""",
...
کوردی: قەوی کردن، قایم کردن، بەهێز کردن، پتەو کردن
"""),
// With short examples define "fortify", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) واکردنی ئەوەی شوێنێک بەرگەی هێرش بگرێت، بە تایبەتی بە بنیاتنانی شوورا"""),
                    SentencesRow(
                      englishText:
                          """They fortified the area against attack.""",
                      kurdishText: """ناوچەیەک دژ بە هێرش پتەو کرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) واکردنی ئەوەی خۆت یان کەسێک هەست بە بەهێزی، بوێری، هتد بکات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He fortified himself against the cold with a hot drink.""",
                      kurdishText:
                          """بە خواردنەوەیەکی گەرم خۆی بەهێز کرد بەرامبەر سەرماکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) واکردنی ئەوەی هەستێک یان هەڵوێستێک بەهێز بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The news merely fortified their determination.""",
                      kurdishText: """هەواڵەکە تەنها شیلگیریی بەهێز کرد.""",
...
const double _startSecondsend = 0000000000000000000000000001697;
const String _videoIdone = 'https://youtu.be/bcdEFos9YQQ?t=';
const double _startSecondsone = 000000000000000000000000000397;
const String _videoIdtwo = 'https://youtu.be/Eu46puWv7ts?t=';
const double _startSecondstwo = 000000000000000000000000000865;
const String _videoIdthree = 'https://youtu.be/bUia-EbqS7A?t=';
const double _startSecondsthree = 000000000000000000000000000564;
const String _videoIdfour = 'https://youtu.be/iQ5GfDbjos8?t=';
const double _startSecondsfour = 000000000000000000000000000547;
const String _videoIdfive = 'https://youtu.be/xPGdOXstSyk?t=';
const double _startSecondsfive = 000000000000000000000000000601;
