...
// replace these: replace EnglishEntryanticyclone - replace speakAnticyclone - replace anticyclone - /ˌæntiˈsaɪkləʊn/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryanticyclone extends StatelessWidget {
  // blank divider
  EnglishEntryanticyclone({super.key});
  // blank divider
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "dIMrWQCJ_mA";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "14kMipQMJGE";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "w1iz2PUAXTA";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "ao_-OjDQwfk";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "J96x0oRPjeQ";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "SsohCDqvmLE";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "1hFNv74jk2U";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "nNA_fXNUmeQ";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "prNQMOzqJn8";
