...
class EnglishEntryhamster extends StatefulWidget {
  const EnglishEntryhamster({super.key});

  @override
  State<EnglishEntryhamster> createState() => _EnglishEntryhamsterState();
}

class _EnglishEntryhamsterState extends State<EnglishEntryhamster> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hamster""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Hamsters are omnivores and eat a variety of foods.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The Syrian hamster is the most common pet hamster.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hamster""",
                      // alsoEnglishWord: "also: hamster",
                      britshText: """IpaUK: /ˈhæmstə(r)/""",
                      americanText: """IpaUS: /ˈhæmstər/""",
