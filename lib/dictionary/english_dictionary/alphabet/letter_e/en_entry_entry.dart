...
کوردی: ژوورەوەچوون، چوونەنێو، مافی چوونەنێو، دەستووری چوونەنێو،	درگا، دەرک، ڕێڕەو، ژوورگە، پێشخان، ڕێژوور، ڕێڕەو، داڵان، دەروازە،	(فەرهەنگ) مادە، سەروشە، ماک،	بڕگە، بابەت،	بەشداری‌کەر، هاتەنێو،	نەیار، هەڤرک،	ژمارەی بەشداری‌کەران، ژمارەی هاتەنێوان،	نووسین، تۆمار(کردن)،	(ماف) گرتن، دەس‌بەسەرداگرتن، داگیرکردن
"""),
          const DefinitionKurdish(text: """١. (ناو) چوونە ناو شوێنێک"""),
          SentencesRow(
            englishText:
                """The children were surprised by the sudden entry of their teacher.""",
            kurdishText: """منداڵەکان تاسان بە هاتنی لەناکاوی مامۆستاکە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """بازگەی پشکنین هەیە لە خاڵی چوونەژوورەوە.""",
            onPressedBritish: () => speaksentence4("en-GB"),
            onPressedAmerican: () => speaksentence4("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) ماف یان هەلی چوونە شوێنێک"""),
          const DividerSentences(),
          SentencesRow(
          ...
          SentencesRow(
            ...
            kurdishText:
                """میوانەکانی هوتێلەکە چوونەژوورەوەی بێ‌بەرامبەریان هەیە بۆ ناو سەنتەرە وەرزشییەکە.""",
          ...
          SentencesRow(
            englishText:
                """The winning entry will be published in next month's issue.""",
            kurdishText:
                """بەژداربووی براوە لە چاپی مانگی داهاتوو بڵاودەکرێتەوە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """زۆر بەژداربوومان هەیە بۆ ئەم بۆنەیە.""",
            onPressedBritish: () => speaksentence10("en-GB"),
            onPressedAmerican: () => speaksentence10("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٤. (ناو) بەژداریکردن لە پێشبڕکێیەک، هتد"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Entry is open to anyone over the age of 18.""",
            kurdishText:
                """بەژداریکردن کراوەیە بۆ هەر کەسێک لە سەروو ١٨ ساڵە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٥. (ناو) هەموو ئەو کەسانەی بەژداری لە پێشبڕکێیەک، هتد دەکەن"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """There's a record entry for this year's marathon.""",
            kurdishText: """بەژداریی مێژووی هەیە بۆ ماراسۆنی ئەمساڵ.""",
          ...
          const DefinitionKurdish(
              text:
                  """٦. (ناو) شتێک، بۆ نموونە زانیارییەک، کە لەسەر فەرهەنگێک، کتێبێک، هتد نووسراوە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
          ...
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٧. (ناو) تۆمارکردنی زانیاری لە کۆمپیوتەر، کتێب، هتد"""),
          const DividerSentences(),
          SentencesRow(
          ...
          const DefinitionKurdish(
              text:
                  """٨. (ناو) ماف یان هەلی بەژداری کردن لە شتێک یان بوون بە ئەندامی گرووپێک"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """It is extremely difficult for new companies to gain entry into the market.""",
          ...
          SentencesRow(
            ...
            kurdishText: """داوای چوونە زانکۆی نۆتینگهامی کرد.""",
          ...
          SentencesRow(
            englishText:
                """Things changed forever with the entry of women into the workforce.""",
            kurdishText:
                """شتەکان بۆ هەمیشە گۆڕان بە چوونی ژنان بۆ ناو دەستی کار.""",
