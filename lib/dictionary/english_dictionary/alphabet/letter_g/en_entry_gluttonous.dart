...
class EnglishEntrygluttonous extends StatefulWidget {
  const EnglishEntrygluttonous({super.key});

  @override
  State<EnglishEntrygluttonous> createState() => _EnglishEntrygluttonousState();
}

class _EnglishEntrygluttonousState extends State<EnglishEntrygluttonous> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gluttonous""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He has a gluttonous appetite for sweets.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gluttonous""",
                      // alsoEnglishWord: "also: gluttonous",
                      britshText: """IpaUK: /ˈɡlʌtənəs/""",
                      americanText: """IpaUS: /ˈɡlʌtənəs/""",
...
کوردی: زۆرخۆر، چڵێس، زگەڕۆ، نەوسن، زکوون
"""),
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) زۆرخۆر"""),
                    SentencesRow(
                      englishText:
                          """He has a gluttonous appetite for sweets.""",
                      kurdishText: """حەزێکی چڵێسانەی هەیە بۆ شیرینی.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) بەکارهێنانی زیاتر لەوەی پێویستتە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She said that industrialized countries should reduce their gluttonous (= greater than is needed) consumption of oil.""",
                      kurdishText:
                          """گوتی کە وڵاتە پیشەسازییەکان دەبێت بەکارهێنانی چڵێسانەیان بۆ ڕؤن کەم بکەنەوە.""",
...
const String _videoIdtwo = 'https://youtu.be/uFmQmqNAmfo?t=';
const double _startSecondstwo = 000000000000000000000000000182;
const String _videoIdthree = 'https://youtu.be/x_VFWscxj34?t=';
const double _startSecondsthree = 000000000000000000000000000275;
const String _videoIdfour = 'https://youtu.be/DnTBnaBPc18?t=';
const double _startSecondsfour = 000000000000000000000000000393;
const String _videoIdfive = 'https://youtu.be/Jelo4bliA1Y?t=';
const double _startSecondsfive = 000000000000000000000000000675;
