...
class EnglishEntryambush extends StatelessWidget {
  EnglishEntryambush({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAmbush(String languageCode) async {
    // DOPSUM: CHANGE speakAmbush
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("ambush"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAmbush4355(String languageCode) async {
    ...
    await flutterTts.speak(
        "Two soldiers were killed in a terrorist ambush."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAmbush4699(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "The guerrillas ambushed them near the bridge."); // DOPSUM: CHANGE TEXT
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '_7Y61bM7K8M';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'la20lUzZ6b0';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'hwQD6CSLwgo';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'Nbw49Llcstg';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'Qi8trre9FX4';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'RgfXw6FbmrA';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'zWy7XLZEzdw';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'EvNLPc25SiQ';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = 'k0KLCdQCy-w';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  static String myVideoId = '_rjmTjXYheE';
