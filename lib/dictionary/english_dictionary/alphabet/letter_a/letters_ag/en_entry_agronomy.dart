...
class EnglishEntryagronomy extends StatelessWidget {
  EnglishEntryagronomy({super.key});
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈɡrɑːnəmi/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'Ab2NyGSwsJ8';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '1N3uRGGXYhQ';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'NkFCU8oVhFA';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'UrXUcsUFnRs';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'HXlAz7HVLxg';
