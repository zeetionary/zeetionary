...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001080;
    const String videoIdone = 'https://youtu.be/AF8d72mA41M?t=';
    const double startSecondsone = 0000000000000000000000000001494;
    const String videoIdtwo = 'https://youtu.be/mY3SEMTROas?t=';
    const double startSecondstwo = 0000000000000000000000000001503;
    const String videoIdthree = 'https://youtu.be/8eq2vGEEbB4?t=';
    const double startSecondsthree = 000000000000000000000000000219;
    const String videoIdfour = 'https://youtu.be/L9Mu93VJLcc?t=';
    const double startSecondsfour = 000000000000000000000000000202;
    const String videoIdfive = 'https://youtu.be/pFmtmO2cnlg?t=';
    const double startSecondsfive = 000000000000000000000000000547;
