...
class EnglishEntryheartfelt extends StatefulWidget {
  const EnglishEntryheartfelt({super.key});

  @override
  State<EnglishEntryheartfelt> createState() => _EnglishEntryheartfeltState();
}

class _EnglishEntryheartfeltState extends State<EnglishEntryheartfelt> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: heartfelt
1. Sincerely intended and with strong feeling (- dear, devout, earnest)
"heartfelt condolences";
""",
  );

  final String keyword = "heartfelt";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heartfelt""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Christina breathed a heartfelt sigh of relief.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Please accept our heartfelt sympathy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heartfelt""",
                      // alsoEnglishWord: "also: heartfelt",
                      britshText: """IpaUK: /ˈhɑːtfelt/""",
                      americanText: """IpaUS: /ˈhɑːrtfelt/""",
...
کوردی: لە ناخی دڵەوە، پڕ بەدڵ، بە داوودڵ(ەوە)، لە دڵەوە، گەرم‌وگوڕانە
"""),
// With short examples define "heartfelt", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کە هەستی قووڵ پیشان دەدات لە دڵەوە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: sincere"),
                    SentencesRow(
                      englishText:
                          """Christina breathed a heartfelt sigh of relief.""",
                      kurdishText:
                          """کریستینا ئاهێکی قووڵی حەسانەوەی هەڵکێشا.""",
                    ...
                    SentencesRow(
                      englishText: """Please accept our heartfelt sympathy.""",
                      kurdishText:
                          """تکایە هاوخەمی پڕ بەدڵمان قبووڵ بفەرموون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/tkOKfFcOnvQ?t=';
const double _startSecondsend = 000000000000000000000000000283;
const String _videoIdone = 'https://youtu.be/d7ShPtShl0M?t=';
const double _startSecondsone = 0000000000000000000000000001484;
const String _videoIdtwo = 'https://youtu.be/wMXN6-hZZzA?t=';
const double _startSecondstwo = 00000000000000000000000000047;
const String _videoIdthree = 'https://youtu.be/CaGF6sWi6ZM?t=';
const double _startSecondsthree = 000000000000000000000000000392;
const String _videoIdfour = 'https://youtu.be/s04fn1wtKg0?t=';
const double _startSecondsfour = 0000000000000000000000000001201;
const String _videoIdfive = 'https://youtu.be/s04fn1wtKg0?t=';
const double _startSecondsfive = 0000000000000000000000000001196;
