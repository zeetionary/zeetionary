...
class EnglishEntryhitandrun extends StatefulWidget {
  const EnglishEntryhitandrun({super.key});

  @override
  State<EnglishEntryhitandrun> createState() => _EnglishEntryhitandrunState();
}

class _EnglishEntryhitandrunState extends State<EnglishEntryhitandrun> {
  @override
  void initState() {
    super.initState();
...
1. Designed for or consisting of a brief attack followed by a quick escape (- tip-and-run)
"hit-and-run units";
...
""",
  ...
  final String keyword = "hit-and-run";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hit-and-run""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was killed in a hit-and-run.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Insurgents continued hit-and-run attacks.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/x629nYBuLpY?t=';
    const double startSecondsend = 000000000000000000000000000577;
    const String videoIdone = 'https://youtu.be/goxvS5pxLDo?t=';
    const double startSecondsone = 000000000000000000000000000687;
    const String videoIdtwo = 'https://youtu.be/7b_0CfmQ1NU?t=';
    const double startSecondstwo = 000000000000000000000000000112;
    const String videoIdthree = 'https://youtu.be/OTDY--Qb72E?t=';
    const double startSecondsthree = 000000000000000000000000000632;
    const String videoIdfour = 'https://youtu.be/2YhD3mpDIZQ?t=';
    const double startSecondsfour = 000000000000000000000000000786;
    const String videoIdfive = 'https://youtu.be/UlRPE1OPAWw?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hit-and-run""",
                      // alsoEnglishWord: "also: hit-and-run",
                      britshText: """IpaUK: /ˌhɪt ən ˈrʌn/""",
                      americanText: """IpaUS: /ˌhɪt ən ˈrʌn/""",
...
کوردی: 
"""),
// With short examples define "hit-and-run", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕووداوێکی هاتووچۆ لەلایەن شۆفێرێکەوە کە ناوەستێت بۆ یارمەتی"""),
                    SentencesRow(
                      englishText: """He was killed in a hit-and-run.""",
                      kurdishText: """لە ڕووداوێکی لێدان و هەڵاتندا کوژرا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He struck and killed a pedestrian in a hit-and-run accident.""",
                      kurdishText:
                          """دای لە پیادەیەک و کوشتی لە ڕووداوێکی لێدان و هەڵاتندا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چەکدارەکان بەردەوام بوون لە هێرشە پارتیزانییەکانیان..""",
