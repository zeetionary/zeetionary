...
class EnglishEntryabundance extends StatefulWidget {
  const EnglishEntryabundance({super.key});

  @override
  State<EnglishEntryabundance> createState() => _EnglishEntryabundanceState();
}

class _EnglishEntryabundanceState extends State<EnglishEntryabundance> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "abundance";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """abundance""",
                      // alsoEnglishWord: "also: abundance",
                      britshText: """IpaUK: abundance""",
                      americanText: """IpaUS: abundance""",
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'ciV5CpsnDb4';
