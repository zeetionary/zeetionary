...
class EnglishEntryfoggy extends StatefulWidget {
  const EnglishEntryfoggy({super.key});

  @override
  State<EnglishEntryfoggy> createState() => _EnglishEntryfoggyState();
}

class _EnglishEntryfoggyState extends State<EnglishEntryfoggy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: foggy (Derived forms: foggiest, foggier)
1. Filled or abounding with fog or mist (= brumous, hazy, misty)
"a foggy October morning";
 
2. Indistinct or hazy in outline (= bleary, blurred, blurry, fuzzy, hazy, muzzy)
"a landscape of foggy outlines";
 
3. Obscured by fog (= fogged)
"he could barely see through the foggy window";
 
4. Stunned or confused and slow to react (as from blows or drunkenness or exhaustion) (= dazed, groggy, logy [N. Amer], stuporous)
"I woke up, tired and foggy";
""",
  );

  final String keyword = "foggy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He was driving much too fast for the foggy conditions.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foggy""",
                      // alsoEnglishWord: "also: foggy",
                      britshText: """IpaUK: /ˈfɒɡi/""",
                      americanText: """IpaUS: /ˈfɑːɡi/""",
...
// With short examples define "foggy", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) کە بەهۆی تەمەوە ڕوون نییە"""),
                    SentencesRow(
                      englishText:
                          """He was driving much too fast for the foggy conditions.""",
                      kurdishText:
                          """زۆر خێرا شۆفێری دەکرد بۆ دۆخە تەماوییەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Side effects include headaches, nausea, weakness, and foggy thinking.""",
                      kurdishText:
                          """کاریگەرییە لاوەکییەکان سەرێشە، دڵ‌تێکهەڵاتن، لاوازی، و بیرکردنەوەی ناڕوون لەخۆ دەگرێت.""",
...
const double _startSecondsend = 000000000000000000000000000787;
const String _videoIdone = 'https://youtu.be/Pon4Zux5MaQ?t=';
const double _startSecondsone = 000000000000000000000000000907;
const String _videoIdtwo = 'https://youtu.be/gGILiLTenR8?t=';
const double _startSecondstwo = 000000000000000000000000000347;
const String _videoIdthree = 'https://youtu.be/xEDuF4yFXtE?t=';
const double _startSecondsthree = 000000000000000000000000000432;
const String _videoIdfour = 'https://youtu.be/tExo3ovEBWQ?t=';
const double _startSecondsfour = 000000000000000000000000000269;
const String _videoIdfive = 'https://youtu.be/-lsFs2615gw?t=';
const double _startSecondsfive = 000000000000000000000000000357;
