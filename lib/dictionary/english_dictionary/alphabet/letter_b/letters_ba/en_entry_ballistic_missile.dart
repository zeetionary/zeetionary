...
// Define the word "ballistic missile" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace ballistic missile - replace EnglishEntryballisticmissile

// replace speakBallisticmissile - /bəˌlɪstɪk ˈmɪsaɪl/

enum TtsState { playing }

class EnglishEntryballisticmissile extends StatelessWidget {
  EnglishEntryballisticmissile({super.key});
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "ballistic missile"),
                            // divvviiider
                          ],
                        ),
                        Row(
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = '5r90DYjZ76g';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'ILgSesWMUEI';
