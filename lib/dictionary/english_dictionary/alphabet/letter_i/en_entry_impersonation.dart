...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '2Fq5NM2A-EQ';
    const double startSecondsend = 479;
    const String videoIdone = 'B1r4Z3nXPVA';
    const double startSecondsone = 245;
    const String videoIdtwo = '1Cw-vODp-8Y';
    const double startSecondstwo = 566;
    const String videoIdthree = '9mgwZASlFvw';
    const double startSecondsthree = 304;
    const String videoIdfour = 'vytJbTcHzKs';
    const double startSecondsfour = 691;
    const String videoIdfive = 'eaa5onIXG_0';
    const double startSecondsfive = 819;
