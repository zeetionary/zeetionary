...
class EnglishEntryhiker extends StatefulWidget {
  const EnglishEntryhiker({super.key});

  @override
  State<EnglishEntryhiker> createState() => _EnglishEntryhikerState();
}

class _EnglishEntryhikerState extends State<EnglishEntryhiker> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hiker (Derived forms: hikers)
1. A foot traveller; someone who goes on an extended walk (for pleasure) (- tramp, tramper)
""",
  );

  final String keyword = "hiker";
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/doiFDlS6zHI?t=';
    const double startSecondsend = 00000000000000000000000000021;
    const String videoIdone = 'https://youtu.be/HjEqOWjTkHE?t=';
    const double startSecondsone = 000000000000000000000000000544;
    const String videoIdtwo = 'https://youtu.be/Ix6vtM4gP8g?t=';
    const double startSecondstwo = 00000000000000000000000000060;
    const String videoIdthree = 'https://youtu.be/vW678sFdwLw?t=';
    ...
    const String videoIdfive = 'https://youtu.be/FPoSemTTNvg?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hiker""",
                      // alsoEnglishWord: "also: hiker",
                      britshText: """IpaUK: /ˈhaɪkə(r)/""",
                      americanText: """IpaUS: /ˈhaɪkər/""",
...
کوردی: ڕێگاڕەو، پیاسەکار
"""),
// With short examples define "hiker", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە بۆ خۆشی دەچێتە دەشت‌ودەر بۆ پیاسە"""),
                    SentencesRow(
                      englishText:
                          """With no shelter in sight, the hikers faced a bleak night in the mountains as temperatures dropped.""",
                      kurdishText:
