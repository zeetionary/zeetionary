...
class EnglishEntryflatfooted extends StatefulWidget {
  const EnglishEntryflatfooted({super.key});

  @override
  State<EnglishEntryflatfooted> createState() => _EnglishEntryflatfootedState();
}

class _EnglishEntryflatfootedState extends State<EnglishEntryflatfooted> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flatfooted
1. With feet flat on the ground; not tiptoe (= flat-footed)
 
2. Having broad flat feet that usually turn outward (= flat-footed)
 
3. Unprepared and unable to react quickly (= flat-footed)
 
4. Forthright and explicit (= flat-footed)
""",
  );

  final String keyword = "flat-footed";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flat-footed""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The doctor diagnosed him as flat-footed.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They were caught flat-footed by the attack.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flat-footed""",
                      // alsoEnglishWord: "also: flat-footed",
                      britshText: """IpaUK: /ˌflæt ˈfʊtɪd/""",
                      americanText: """IpaUS: /ˌflæt ˈfʊtɪd/""",
...
کوردی: تەخت، ڕێک،	دەستەوسان، بێ‌دەس، بەیدەس، ناشی
"""),
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) پێ‌تەخت؛ بەبێ چەماوەی پێ"""),
                    SentencesRow(
                      englishText:
                          """The doctor diagnosed him as flat-footed.""",
                      kurdishText: """پزیشکەکە بە پێ‌تەخت ناساندی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەستەوەسان بوون بۆ هێرشەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/7-Y5RlSM2PI?t=';
const double _startSecondsend = 000000000000000000000000000177;
const String _videoIdone = 'https://youtu.be/TRGHIN2PGIA?t=';
const double _startSecondsone = 000000000000000000000000000898;
const String _videoIdtwo = 'https://youtu.be/IKJWKJQXTuY?t=';
const double _startSecondstwo = 000000000000000000000000000500;
const String _videoIdthree = 'https://youtu.be/_rujVtjlp1Y?t=';
const double _startSecondsthree = 000000000000000000000000000294;
const String _videoIdfour = 'https://youtu.be/CK33lDfJjKI?t=';
const double _startSecondsfour = 000000000000000000000000000681;
const String _videoIdfive = 'https://youtu.be/Sj9cN9yy00U?t=';
const double _startSecondsfive = 0000000000000000000000000001342;
