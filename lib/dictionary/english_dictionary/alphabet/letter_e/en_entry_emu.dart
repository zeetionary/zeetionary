...
class EnglishEntryemu extends StatefulWidget {
  const EnglishEntryemu({super.key});

  @override
  State<EnglishEntryemu> createState() => _EnglishEntryemuState();
}

class _EnglishEntryemuState extends State<EnglishEntryemu> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "emu",
                      // alsoEnglishWord: "also: emu",
                      britshText: "IpaUK: /ˈiːmjuː/",
                      americanText: "IpaUS: /ˈiːmjuː/",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts
        .speak("Emus grow to almost two metres and can run at nearly 50 kph.");
  }
...
کوردی: وشترمەلی ئەوسترالیایی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) باڵندەیەکی گەورەی ئوسترالی کە خێرا ڕادەکات و نافڕێت"""),
          SentencesRow(
            englishText:
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: emu (derived forms: emus)
1. Any of various systems of units for measuring electricity and magnetism (= electromagnetic unit)
 
2. Large Australian flightless bird similar to the ostrich but smaller (= Dromaius novaehollandiae, Emu novaehollandiae)
""",
  );
