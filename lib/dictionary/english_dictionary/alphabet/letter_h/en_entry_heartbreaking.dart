...
class EnglishEntryheartbreaking extends StatefulWidget {
  const EnglishEntryheartbreaking({super.key});

  @override
  State<EnglishEntryheartbreaking> createState() =>
      _EnglishEntryheartbreakingState();
}

class _EnglishEntryheartbreakingState extends State<EnglishEntryheartbreaking> {
  @override
  void initState() {
    super.initState();
...
1. Causing or marked by grief or anguish (- grievous, heartrending)
"her sigh was heartbreaking";
""",
  );

  final String keyword = "heartbreaking";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heartbreaking""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It's heartbreaking to see him wasting his life like this.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heartbreaking""",
                      // alsoEnglishWord: "also: heartbreaking",
                      britshText: """IpaUK: /ˈhɑːtbreɪkɪŋ/""",
                      americanText: """IpaUS: /ˈhɑːrtbreɪkɪŋ/""",
...
کوردی: خەماوی، دڵ‌شکێن، جەرگبڕ
"""),
// With short examples define "heartbreaking", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە زۆر جێگای دڵتەنگییە"""),
                    SentencesRow(
                      englishText:
                          """It's heartbreaking to see him wasting his life like this.""",
                      kurdishText:
                          """دڵ‌شکێنەرە کە ببینیت ژیانی بەم شێوەیە بەفیڕۆ بدات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/vn1_vUghWzA?t=';
const double _startSecondsend = 000000000000000000000000000122;
const String _videoIdone = 'https://youtu.be/raSeaAeryWE?t=';
const double _startSecondsone = 2174;
const String _videoIdtwo = 'https://youtu.be/xrkPe-9rM1Q?t=';
const double _startSecondstwo = 000000000000000000000000000180;
const String _videoIdthree = 'https://youtu.be/xuSBPqkSpc0?t=';
const double _startSecondsthree = 000000000000000000000000000170;
const String _videoIdfour = 'https://youtu.be/PGK2JAAMTy8?t=';
const double _startSecondsfour = 00000000000000000000000000098;
const String _videoIdfive = 'https://youtu.be/SzjYGRpBVto?t=';
