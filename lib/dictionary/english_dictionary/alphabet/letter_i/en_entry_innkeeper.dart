...
class EnglishEntryinnkeeper extends StatefulWidget {
  const EnglishEntryinnkeeper({super.key});

  @override
  State<EnglishEntryinnkeeper> createState() => _EnglishEntryinnkeeperState();
}

class _EnglishEntryinnkeeperState extends State<EnglishEntryinnkeeper> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""innkeeper""");
  }
