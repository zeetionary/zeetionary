...
class EnglishEntryineffectual extends StatefulWidget {
  const EnglishEntryineffectual({super.key});

  @override
  State<EnglishEntryineffectual> createState() =>
      _EnglishEntryineffectualState();
}

class _EnglishEntryineffectualState extends State<EnglishEntryineffectual> {
  @override
  void initState() {
    super.initState();
...
1. Not producing an intended effect (- ineffective, uneffective)
 
2. Producing no result or effect (- futile, otiose, unavailing, meaningless)
"the therapy was ineffectual";
 
3. Lacking in power or forcefulness (- ineffective, unable, wet [Brit, informal], useless [informal], pathetic, effete)
"an ineffectual ruler";
""",
  );

  final String keyword = "ineffectual";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ineffectual""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He plays the role of a ineffectual teacher.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The president is seen as weak and ineffectual.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001570;
    const String videoIdone = 'https://youtu.be/FCZ06Sfr9Cg?t=';
    const double startSecondsone = 000000000000000000000000000459;
    const String videoIdtwo = 'https://youtu.be/8GOoBPLeS60?t=';
    const double startSecondstwo = 0000000000000000000000000001121;
    const String videoIdthree = 'https://youtu.be/kJRbWlAHA1E?t=';
    const double startSecondsthree = 000000000000000000000000000904;
    const String videoIdfour = 'https://youtu.be/VeBX4WjhhXs?t=';
    const double startSecondsfour = 0000000000000000000000000001927;
    const String videoIdfive = 'https://youtu.be/Zs1ahNtj498?t=';
    const double startSecondsfive = 000000000000000000000000000771;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ineffectual""",
                      // alsoEnglishWord: "also: ineffectual",
                      britshText: """IpaUK: /ˌɪnɪˈfektʃuəl/""",
                      americanText: """IpaUS: /ˌɪnɪˈfektʃuəl/""",
...
کوردی: بێ‌ئەنجام، نەزۆک، سەرنەکەوتوو، سەرنەگرتوو، بێهوودە، ناکاریگەر،	لێنەهاتوو، لێنەوەشاو، بەکارنەهاتوو، بێکارە، توانایی‌نەماو، هیچ‌لەدەس‌نەهاتوو
"""),
// With short examples define "ineffectual", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) لاواز؛ کە توانای بەدەستهێنانی زۆری نییە"""),
                    SentencesRow(
                      englishText:
                          """He plays the role of a ineffectual teacher.""",
                      kurdishText: """ڕۆڵی مامۆستایەکی بێ‌دەسەڵات دەبینێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """سەرۆک بە لاواز و بێ‌دەسەڵات دەبیندرێت.""",
