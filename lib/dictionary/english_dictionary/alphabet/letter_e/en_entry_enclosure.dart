...
class EnglishEntryenclosure extends StatefulWidget {
  const EnglishEntryenclosure({super.key});

  @override
  State<EnglishEntryenclosure> createState() => _EnglishEntryenclosureState();
}

class _EnglishEntryenclosureState extends State<EnglishEntryenclosure> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("enclosure");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "enclosure",
                      // alsoEnglishWord: "also: enclosure",
                      britshText: "IpaUK: /ɪnˈkləʊʒə(r)/",
                      americanText: "IpaUS: /ɪnˈkləʊʒər/",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enclosure";
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) زەوییەک کە دەوری گیردراوە و بۆ مەبەستێکی تایبەت بەکاردێت"""),
          SentencesRow(
...
// With short examples define "enclosure", please follow LX instructions
          ...
          SentencesRow(
            englishText:
                """The result of the enclosures was that many countrymen lost their only livelihood.""",
            kurdishText:
                """ئەنجامی پەرژینکردنەکە ئەوەبوو کە زۆر کەس تاکە سەرچاوەی بژێوییان لەدەست دا.""",
            kurdishNote:
                "مەبەست لێی سەردەمانی ڕابردووی ئینگلتەرەیە کە تێیدا خاکی گشتی قۆرخ دەکران لەلایەن دەوڵەمەندانەوە",
          ...
          SentencesRow(
            englishText:
                """Always state the number of enclosures at the bottom of your letter.""",
            kurdishText:
                """هەمیشە لە خوارەوەی نامەکەت ژمارەی هاوپێچەکان بنووسە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: enclosure (Derived forms: enclosures)
1. A structure consisting of an area that has been enclosed for some purpose
 
2. The act of enclosing something inside something else (= enclosing, envelopment, inclosure)
 
3. A naturally enclosed space (= natural enclosure)
 
4. Something (usually a supporting document) that is enclosed in an envelope with a covering letter (= inclosure)
""",
  );
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/EOY1LVjohrw?t=';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/KrChYx_sFK0?t=';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/UZZ7yD3wJ6E?t=';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/T15gXm6ha_I?t=';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/axcPoS2sF0E?t=';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/MnExgQ81fhU?t=';
