...
class EnglishEntryfoolishness extends StatefulWidget {
  const EnglishEntryfoolishness({super.key});

  @override
  State<EnglishEntryfoolishness> createState() =>
      _EnglishEntryfoolishnessState();
}

class _EnglishEntryfoolishnessState extends State<EnglishEntryfoolishness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foolishness
1. The trait of acting stupidly or rashly (= folly, unwiseness)
 
2. The quality of being rash and foolish (= folly, craziness, madness, nuttiness [informal], insanity)
"adjusting to an insane society is total foolishness";
 
3. A stupid mistake (= stupidity, bêtise, folly, imbecility)
""",
  );

  final String keyword = "foolishness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foolishness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Jenny had to laugh at her own foolishness.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foolishness""",
                      // alsoEnglishWord: "also: foolishness",
                      britshText: """IpaUK: /ˈfuːlɪʃnəs/""",
                      americanText: """IpaUS: /ˈfuːlɪʃnəs/""",
...
// With short examples define "foolishness", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """جێنی بە گەمژەیی خۆی پێکەنی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/LAbFGixLhz8?t=';
const double _startSecondsend = 00000000000000000000000000095;
const String _videoIdone = 'https://youtu.be/y3eR8QLPjlc?t=';
const double _startSecondsone = 000000000000000000000000000628;
const String _videoIdtwo = 'https://youtu.be/XWcZeYvJ0D0?t=';
const double _startSecondstwo = 0000000000000000000000000001417;
const String _videoIdthree = 'https://youtu.be/lctv_pyT62o?t=';
const double _startSecondsthree = 0000000000000000000000000001589;
const String _videoIdfour = 'https://youtu.be/Ck27gUFCBh8?t=';
const double _startSecondsfour = 000000000000000000000000000320;
const String _videoIdfive = 'https://youtu.be/ZYQnDEWojik?t=';
