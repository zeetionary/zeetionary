...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'HGsjNOOaRXg';
    const double startSecondsone = 174;
    const String videoIdtwo = 'wJa5Ch0O4BI';
    const double startSecondstwo = 6073;
    const String videoIdthree = '1n2nPRxAOss';
    const double startSecondsthree = 1244;
    const String videoIdfour = 'LEip8nKp5SI';
    const double startSecondsfour = 194;
    const String videoIdfive = 'fRcPn3mJSyY';
    const double startSecondsfive = 1321;
