...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/p2bsnqtc7xE?t=';
    const double startSecondsend = 000000000000000000000000000949;
    const String videoIdone = 'https://youtu.be/Ojo3Q2h2Q3g?t=';
    const double startSecondsone = 000000000000000000000000000413;
    const String videoIdtwo = 'https://youtu.be/iDVxOg_R0rc?t=';
    const double startSecondstwo = 00000000000000000000000000012615;
    const String videoIdthree = 'https://youtu.be/C38FH9FeRgY?t=';
    const double startSecondsthree = 000000000000000000000000000525;
    const String videoIdfour = 'https://youtu.be/vgcA8fz10Uo?t=';
    const double startSecondsfour = 000000000000000000000000000371;
    const String videoIdfive = 'https://youtu.be/_u3EwK4sy-E?t=';
