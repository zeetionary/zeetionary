...
class EnglishEntryaccredited extends StatefulWidget {
  const EnglishEntryaccredited({super.key});

  @override
  State<EnglishEntryaccredited> createState() => _EnglishEntryaccreditedState();
}

class _EnglishEntryaccreditedState extends State<EnglishEntryaccredited> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "accredited";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accredited""",
                      // alsoEnglishWord: "also: accredited",
                      britshText: """IpaUK: /əˈkredɪtɪd/""",
                      americanText: """IpaUS: /əˈkredɪtɪd/""",
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final double _startSeconds = 66324;
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'xu51GFQcgak';
