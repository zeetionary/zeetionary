...
class EnglishEntryfeedingbottle extends StatefulWidget {
  const EnglishEntryfeedingbottle({super.key});

  @override
  State<EnglishEntryfeedingbottle> createState() =>
      _EnglishEntryfeedingbottleState();
}

class _EnglishEntryfeedingbottleState extends State<EnglishEntryfeedingbottle> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""feeding bottle""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """feeding bottle""",
                      // alsoEnglishWord: "also: feeding bottle",
                      britshText: """IpaUK: /ˈfiːdɪŋ bɒtl/""",
                      americanText: """IpaUS: /ˈfiːdɪŋ bɑːtl/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "feeding bottle";
...
کوردی: 
"""),
          const DefinitionKurdish(text: """١. (ناو) دەبەی شیرخواردنی منداڵ"""),
          SentencesRow(
            englishText:
                """The survey reveals that 80% of dads help with the bottle-feeding.""",
            kurdishText:
                """ڕاپرسییەکە ئاشکرای کرد کە ٨٠٪ ـی باوکان پاڵپشت (ـی ژنان) دەبن لەگەڵ شیرپێدان بە مەمە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: feeding bottle (Derived forms: feeding bottles)
1. A vessel fitted with a flexible teat and filled with milk or formula; used as a substitute for breast feeding infants and very young children (= bottle, nursing bottle)
""",
  );
...
const String _videoIdend = 'https://youtu.be/WpHodA9wick?t=';
const double _startSecondsend = 000000000000000000000000000743;
const String _videoIdone = 'https://youtu.be/kOVmyCmxC2k?t=';
const double _startSecondsone = 000000000000000000000000000880;
const String _videoIdtwo = 'https://youtu.be/Weaf2ttJ3Tg?t=';
const double _startSecondstwo = 0000000000000000000000000001817;
const String _videoIdthree = 'https://youtu.be/hcMPLDN16ko?t=';
const double _startSecondsthree = 000000000000000000000000000596;
const String _videoIdfour = 'https://youtu.be/LTa6t1h0N7k?t=';
const double _startSecondsfour = 00000000000000000000000000049;
const String _videoIdfive = 'https://youtu.be/Yhj8fYBdoaE?t=';
const double _startSecondsfive = 000000000000000000000000000644;
