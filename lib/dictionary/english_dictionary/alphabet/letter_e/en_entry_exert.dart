...
class EnglishEntryexert extends StatefulWidget {
  const EnglishEntryexert({super.key});

  @override
  State<EnglishEntryexert> createState() => _EnglishEntryexertState();
}

class _EnglishEntryexertState extends State<EnglishEntryexert> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exert""",
                      // alsoEnglishWord: "also: exert",
                      britshText: """IpaUK: /ɪɡˈzɜːt/""",
                      americanText: """IpaUS: /ɪɡˈzɜːrt/""",
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) بەکارهێنانی هێز و دەسەڵات بۆ کاریگەری کردن لە شتێک"""),
          SentencesRow(
            englishText:
                """He exerted all his authority to make them accept the plan.""",
            kurdishText:
                """تەواوی دەسەڵاتی بەکارهێنا بۆ ئەوەی وایان لێ بکات پلانەکە پەسەند بکەن.""",
          ...
          SentencesRow(
            englishText:
                """The moon exerts a force on the earth that causes the tides.""",
            kurdishText:
                """مانگ هێزێک دەخاتە سەر زەوی کە شەپۆلەکان درووست دەکات.""",
            onPressedBritish: () => speaksentence2("en-GB"),
            onPressedAmerican: () => speaksentence2("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) هەوڵدانێکی زۆری جەستەیی یان دەروونی"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """In order to be successful he would have to exert himself.""",
            kurdishText: """بۆ ئەوەی سەرکەوتوو بێت دەبوو خۆی بسەلمێنێت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: exert (Derived forms: exerted, exerting, exerts)
1. Put to use (= exercise)
"exert one's power or influence";
 
2. Have and exercise (= wield, maintain)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/3RkhZgRNC1k?t=';
const double _startSecondsend = 000000000000000000000000000000; // 985;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/nedusgCUZC4?t=';
const double _startSecondsone = 00000000000000000000000000000; // 76;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/DxL2HoqLbyA?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 420;
const String _videoIdthree = 'VIDEOhttps://youtu.be/UvjSXBqQe4A?t=';
const double _startSecondsthree = 000000000000000000000000000; // 215;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 3314;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/vKDYfRtfqng?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 423;
