...
class EnglishEntrytheinjured extends StatefulWidget {
  const EnglishEntrytheinjured({super.key});

  @override
  State<EnglishEntrytheinjured> createState() => _EnglishEntrytheinjuredState();
}

class _EnglishEntrytheinjuredState extends State<EnglishEntrytheinjured> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrytheinjured the injured
WORD_WEB the injured the injured the injured
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "the injured";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""the injured""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """the injured""",
                      // alsoEnglishWord: "also: the injured",
