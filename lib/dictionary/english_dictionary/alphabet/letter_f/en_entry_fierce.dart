...
class EnglishEntryfierce extends StatefulWidget {
  const EnglishEntryfierce({super.key});

  @override
  State<EnglishEntryfierce> createState() => _EnglishEntryfierceState();
}

class _EnglishEntryfierceState extends State<EnglishEntryfierce> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fierce 
1. Marked by extreme and violent energy (= ferocious, furious, savage)
"fierce fighting";
 
2. Marked by extreme intensity of emotions or convictions; inclined to react violently; fervid (= tearing, vehement, violent, trigger-happy)
"fierce loyalty";
 
3. Ruthless in competition (= cutthroat, bowelless)
"fierce competition";
 
4. Violently agitated and turbulent (= boisterous, rough)
"the fierce thunders roar me their music";
""",
  );

  final String keyword = "fierce";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Two fierce eyes glared at them.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He suddenly looked fierce.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The more she struggled, the fiercer he became.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He launched a fierce attack on the Democrats.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Competition from abroad became fiercer in the 1990s.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His wife is his fiercest critic.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The bill was passed despite fierce opposition.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Fierce winds prevented the race from taking place.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Firefighters had to retreat from the fierce heat.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fierce""",
                      // alsoEnglishWord: "also: fierce",
                      britshText: """IpaUK: /fɪəs/""",
                      americanText: """IpaUS: /fɪrs/""",
...
// With short examples define "fierce", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Two fierce eyes glared at them.""",
                      kurdishText: """دوو چاوی توندوتیژ لێیان دەڕوانین.""",
                    ...
                    SentencesRow(
                      englishText: """He suddenly looked fierce.""",
                      kurdishText: """لەناکاو دڕ دیار بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕکابەری بیانی لە ساڵانی ١٩٩٠ ـەکان توندتر بوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """His wife is his fiercest critic.""",
                      kurdishText: """ژنەکەی ڕەخنەگری سەرەکییەتی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پڕۆژە یاساکە تێپەڕێندرا سەرەڕای دژبەری توند.""",
...
const double _startSecondsone = 000000000000000000000000000709;
const String _videoIdtwo = 'https://youtu.be/Cln0J87vulU?t=';
const double _startSecondstwo = 000000000000000000000000000971;
const String _videoIdthree = 'https://youtu.be/AF8d72mA41M?t=';
const double _startSecondsthree = 000000000000000000000000000834;
const String _videoIdfour = 'https://youtu.be/XMCZEJVlyRY?t=';
const double _startSecondsfour = 000000000000000000000000000526;
const String _videoIdfive = 'https://youtu.be/unk6n3_QdlM?t=';
