...
class EnglishEntryenchantment extends StatefulWidget {
  const EnglishEntryenchantment({super.key});

  @override
  State<EnglishEntryenchantment> createState() =>
      _EnglishEntryenchantmentState();
}

class _EnglishEntryenchantmentState extends State<EnglishEntryenchantment> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("enchantment");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "enchantment",
                      // alsoEnglishWord: "also: enchantment",
                      britshText: "IpaUK: /ɪnˈtʃɑːntmənt/",
                      americanText: "IpaUS: /ɪnˈtʃæntmənt/",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enchantment";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This is a place of enchantment and beauty.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The audience looked on in utter fascination and enchantment.");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("It was a place of deep mystery and enchantment.");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("They had been turned to stone by an enchantment.");
  }
...
کوردی: ئەفسوون، تەلەسم، جادوو،	جوانی، دڵڕفێنی، خۆشی، سەرخۆشی، بەکەیفی، ڕاکێشان
"""),
          const DefinitionKurdish(text: """١. (ناو) هەستکردن بە خۆشی زۆر"""),
          SentencesRow(
            englishText: """This is a place of enchantment and beauty.""",
            kurdishText: """ئەمە جێگای دڵڕفێنی و جوانییە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """گوێگران بە سەرسامی و بەکەیفی تەواوەوە سیریان کرد.""",
          ...
          SentencesRow(
            ...
            kurdishText: """شوێنێکی پڕ لە نهێنی و جادوولێکراو بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: enchantment (Derived forms: enchantments)
1. A feeling of great liking for something wonderful and unusual (= captivation, enthrallment [N. Amer], fascination, enthralment [Brit, Cdn])
 
2. A psychological state induced by (or as if induced by) a magical incantation (= spell, trance)
 
3. A magical spell (= bewitchment)
""",
  );
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/mw9uKzy4GRs?t=';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/Q76VdtOEBYI?t=';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/DZziNktXZcU?t=';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/1n2nPRxAOss?t=';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/SwGBYolLXbU?t=';
