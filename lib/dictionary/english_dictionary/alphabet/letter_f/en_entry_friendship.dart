...
class EnglishEntryfriendship extends StatefulWidget {
  const EnglishEntryfriendship({super.key});

  @override
  State<EnglishEntryfriendship> createState() => _EnglishEntryfriendshipState();
}

class _EnglishEntryfriendshipState extends State<EnglishEntryfriendship> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: friendship (Derived forms: friendships)
1. The state of being friends (or friendly) (= friendly relationship, mateship [Austral, NZ])
""",
  );

  final String keyword = "friendship";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""friendship""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They formed a close friendship at college.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He seemed to have already struck up a friendship with Jo.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Friendships need time to develop.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Your friendship is very important to me.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Please accept this gift as a token of our friendship.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """friendship""",
                      // alsoEnglishWord: "also: friendship",
                      britshText: """IpaUK: /ˈfrendʃɪp/""",
                      americanText: """IpaUS: /ˈfrendʃɪp/""",
...
کوردی: دۆستایەتی، هەڤاڵەتی، دۆستانی، سەروسەخت، ڕفێقایەتی،	پێوەندی یان تێکەڵی دۆستانە
"""),
// With short examples define "friendship", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) پەیوەندیی هاوڕێیەتی"""),
                    SentencesRow(
                      englishText:
                          """They formed a close friendship at college.""",
                      kurdishText:
                          """هاوڕێیەتییەکی نزیکیان لە کۆلێژ درووست کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وەها دیار بوو پێشوەختە هاوڕێیەتییەکی لەگەڵ جۆ دەست پێکردبێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It's the story of an extraordinary friendship between a boy and a seal.""",
                      kurdishText:
                          """هاوڕێیەتیی ناوازەی نێوان کوڕێک و سەگڵاوییەکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Friendships need time to develop.""",
                      kurdishText:
                          """هاوڕێیەتی پێویستی بە کاتە تاوەکو گەشە بکات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ئەو هەست یان یان پەیوەندییەی کەسانی هاوڕێ هەیانە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Your friendship is very important to me.""",
                      kurdishText: """پەیوەندیی هاوڕێیەتیت زۆر گرنگە بۆم.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He extended the hand of friendship towards his former enemy.""",
                      kurdishText:
                          """دەستی هاوڕێیەتیی بۆ دوژمنە کۆنەکەی درێژ کرد.""",
                    ...
                    SentencesRow(
                      englishText:
                          """In a gesture of friendship she invited them to her wedding.""",
                      kurdishText:
                          """وەک پیشاندانی هاوڕێیەتی بۆ ئاهەنگی هاوسەرگیرییەکەی بانگهێشتی کردن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تکایە ئەم خەڵاتە وەک نیشانەی هاوڕێیەتیمان پەسەند بکەن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/yKXs6mJBUbA?t=';
const double _startSecondsend = 000000000000000000000000000539;
const String _videoIdone = 'https://youtu.be/khOUvmOQExc?t=';
const double _startSecondsone = 000000000000000000000000000213;
const String _videoIdtwo = 'https://youtu.be/DgAoy7XaFgk?t=';
const double _startSecondstwo = 00000000000000000000000000030;
const String _videoIdthree = 'https://youtu.be/abPjtpNzO5U?t=';
const double _startSecondsthree = 00000000000000000000000000032;
const String _videoIdfour = 'https://youtu.be/goy57Qoiab4?t=';
const double _startSecondsfour = 00000000000000000000000000081;
const String _videoIdfive = 'https://youtu.be/YQHqL2itOXU?t=';
