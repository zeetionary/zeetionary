...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 668;
    const String videoIdone = 'J8ZOttyAs9Y';
    const double startSecondsone = 511;
    const String videoIdtwo = 'jTRC_FMzLoo';
    const double startSecondstwo = 435;
    const String videoIdthree = 'XxOh12Uhg08';
    const double startSecondsthree = 2099;
    const String videoIdfour = 'iQ5GfDbjos8';
    const double startSecondsfour = 78;
    const String videoIdfive = 'H1S6UCX4RAA';
