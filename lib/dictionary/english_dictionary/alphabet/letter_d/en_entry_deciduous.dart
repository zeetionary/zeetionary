...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakdeciduous(String languageCode) async {
    ...
    await flutterTts.speak("deciduous");
  }
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakdeciduouss1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The forest was a mix of evergreen and deciduous trees.");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'rT9IJXuHbKs';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'i10v-5a9X0M';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'R0NdFvRqZ10';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'rWH4XGO1KSU';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'QUGJPZ1a308';
