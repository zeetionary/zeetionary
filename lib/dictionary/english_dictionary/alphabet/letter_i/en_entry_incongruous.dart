...
class EnglishEntryincongruous extends StatefulWidget {
  const EnglishEntryincongruous({super.key});

  @override
  State<EnglishEntryincongruous> createState() =>
      _EnglishEntryincongruousState();
}

class _EnglishEntryincongruousState extends State<EnglishEntryincongruous> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incongruous""");
  }
...
// With short examples define "incongruous", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The new computer looked incongruous in the dark book-filled library.""",
                      kurdishText:
                          """کۆمپیوتەرە تازەکە نەگونجاو دەردەکەوت لە کتێبخانە پڕ لە کتێبە تاریکەکەس.""",
