...
class EnglishEntryexhibit extends StatefulWidget {
  const EnglishEntryexhibit({super.key});

  @override
  State<EnglishEntryexhibit> createState() => _EnglishEntryexhibitState();
}

class _EnglishEntryexhibitState extends State<EnglishEntryexhibit> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exhibit""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exhibit""",
                      // alsoEnglishWord: "also: exhibit",
                      britshText: """IpaUK: /ɪɡˈzɪbɪt/""",
                      americanText: """IpaUS: /ɪɡˈzɪbɪt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Only one painting was exhibited in the artist's lifetime.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He longed for the chance to exhibit his work publicly.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He exhibits regularly in local art galleries.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The patient exhibited signs of fatigue and memory loss.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The new exhibit will tour a dozen US cities next year.""");
  }
...
کوردی: شتی بەرچاوخراو، شتێ بۆ ڕانان، کەل‌وپەلی پیشان‌دراو، پیشانە،	(ماف) بەڵگە،	دەرخستن، پیشان‌دان، خستنەڕوو، هەڵخستن
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) نمایشکردنی شتێک لە شوێنی گشتی بۆ چێژبەخشێن یان زانیاریدان"""),
          SentencesRow(
            englishText:
                """Only one painting was exhibited in the artist's lifetime.""",
            kurdishText:
                """تەنها یەک تابلۆ نمایشکرا لە ماوەی ژیانی هونەرمەندەکە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """بە ئاواتی شانسی نمایشکردنی کارەکەی بەشێوەی گشتی بوو.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He exhibits regularly in local art galleries.""",
            kurdishText:
                """بە بەردەوامی لە پێشانگا هونەرییە خۆجێییەکان نمایش دەکات.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) پیشاندانی ئەوەی کە هەست بە توانایەک، هەستێک، سۆزێک، هتد دەکەیت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The patient exhibited signs of fatigue and memory loss.""",
            kurdishText:
                """نەخۆشەکە هەستی بە نیشانەی ماندوویەتی و بیرچوونەوە کرد.""",
          ...
          SentencesRow(
            englishText:
                """The museum contains some interesting exhibits on Spanish rural life.""",
            kurdishText:
                """مۆزەخاکە هەندێک خستنەڕووی لەسەر ژیانی گوندی لە ئیسپانیا هەیە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٤. (ناو) کۆمەڵە شتێک، بۆ نموونە کاری هونەری، کە بە خەڵکی پیشان دەدرێن"""),
          ...
          SentencesRow(
            ...
            kurdishText:
                """پێشانگا تازەکە بە ژمارەیەک شاری ئەمریکا دەگەڕێت لە ساڵی ڕابردوودا.""",
          ...
          SentencesRow(
            englishText:
                """The first exhibit was a knife which the prosecution claimed was the murder weapon.""",
            kurdishText:
                """یەکەم بەڵگە چەقۆیەک بوو کە دەستەی لێکۆڵینەوە گوتی چەکی کوشتنەکە بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: exhibit (Derived forms: exhibited, exhibiting, exhibits)
1. Show an attribute, property, knowledge, or skill
"he exhibits a great talent"
 
2. To show, make visible or apparent (= expose, display)
"The Metropolitan Museum is exhibiting Goya's works this month";
 
3. Give an exhibition of to an interested audience (= show, demo, present, demonstrate, showcase)
"She exhibits her dogs frequently";
 
4. Walk ostentatiously (= parade, march)
"She exhibits her new husband around town";

- Noun: exhibit (Derived forms: exhibits)
1. An object or statement produced before a court of law and referred to while giving evidence
 
2. Something shown to the public (= display, showing)
...
const double _startSecondsend = 000000000000000000000000000000; // 212;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/XlHzvTEstz8?t=';
const double _startSecondsone = 00000000000000000000000000000; // 334;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/Y4E8qEDi_xg?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 10;
const String _videoIdthree = 'VIDEOhttps://youtu.be/Unzc731iCUY?t=';
const double _startSecondsthree = 000000000000000000000000000; // 2259;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/f7QWMUCMYOE?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 458;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/cCP9vjp4kSg?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1588;
