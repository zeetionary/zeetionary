...
class EnglishEntryherald extends StatefulWidget {
  const EnglishEntryherald({super.key});

  @override
  State<EnglishEntryherald> createState() => _EnglishEntryheraldState();
}

class _EnglishEntryheraldState extends State<EnglishEntryherald> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: herald (Derived forms: heralds)
1. (formal) a person who announces important news (- trumpeter)
"the chieftain had a herald who announced his arrival with a trumpet";
 
2. Something that precedes and indicates the approach of something or someone (- harbinger, forerunner, predecessor, precursor)

- Verb: herald (Derived forms: heralds, heralded, heralding)
1. Foreshadow or presage (- announce, annunciate, harbinger, foretell)
 
2. Praise vociferously (- acclaim, hail)
"The critics heralded the young pianist as a new Rubinstein";
 
3. Greet enthusiastically or joyfully (- hail)
""",
  );

  final String keyword = "herald";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""These talks could herald a new era of peace.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Voices and footsteps outside heralded their return.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """herald""",
                      // alsoEnglishWord: "also: herald",
                      britshText: """IpaUK: /ˈherəld/""",
                      americanText: """IpaUS: /ˈherəld/""",
...
کوردی: ڕاسپاردە، نێراو، پەیام‌بەر، جاڕدەر، جاڕکێش، ڕاگەیێنەر، پێشەنگ، سەرکێش، بەرایی، سەرجەلە، جڵەودار، پێش‌دار، پێشڕەو
"""),
// With short examples define "herald", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) بوون بە ئاماژەی ئەوەی کە شتێک ڕوودەدات"""),
                    SentencesRow(
                      englishText:
                          """These talks could herald a new era of peace.""",
                      kurdishText:
                          """ئەم گفتووگۆیانە دەکرێت ئاماژەی سەردەمێکی تازە لە ئاشتی بن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەنگەدەنگ و تەپەی پێ لە دەرەوە ئاماژەی گەڕانەوەیان بوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) گوتن لە پێش خەڵکی کە کەسێک/شتێک گرنگە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The report is being heralded as a blueprint for the future of transport.""",
                      kurdishText:
                          """ڕاپۆرتەکە وەک نەخشەڕێگایەک بۆ داهاتووی گواستنەوە ستایش دەکرێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) شتێک کە ئاماژەی ڕوودانی شتێکی دیکەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The government claims that the fall in unemployment is the herald of economic recovery.""",
                      kurdishText:
                          """حکومەت بانگەشەی ئەوە دەکات کە دابەزینی ڕێژەی بێكاری نیشانەی باشبوونەوەی ئابوورییە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/qVfJheBp7Ys?t=';
const double _startSecondsend = 000000000000000000000000000103;
const String _videoIdone = 'https://youtu.be/93A1ryc-WW0?t=';
const double _startSecondsone = 000000000000000000000000000484;
const String _videoIdtwo = 'https://youtu.be/HhSNbKezP64?t=';
const double _startSecondstwo = 00000000000000000000000000087;
const String _videoIdthree = 'https://youtu.be/hP8dOUm2qgc?t=';
const double _startSecondsthree = 000000000000000000000000000386;
const String _videoIdfour = 'https://youtu.be/b88v-WvqzeQ?t=';
const double _startSecondsfour = 000000000000000000000000000532;
const String _videoIdfive = 'https://youtu.be/36oRiPAn4Tw?t=';
