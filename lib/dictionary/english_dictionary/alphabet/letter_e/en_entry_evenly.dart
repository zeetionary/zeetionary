...
class EnglishEntryevenly extends StatefulWidget {
  const EnglishEntryevenly({super.key});

  @override
  State<EnglishEntryevenly> createState() => _EnglishEntryevenlyState();
}

class _EnglishEntryevenlyState extends State<EnglishEntryevenly> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evenly""",
                      // alsoEnglishWord: "also: evenly",
                      britshText: """IpaUK: /ˈiːvnli/""",
                      americanText: """IpaUS: /ˈiːvnli/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Make sure the paint covers the surface evenly.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was fast asleep, breathing evenly.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The two teams are very evenly matched.""");
  }
...
کوردی: بە شێوەیەکی بەرامبەر، بەرامبەرانە،	دەس‌ڕێکانە، دادپەروەرانە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵکار) بەشێوەیەکی یەکسان، ڕێک، یان نەرم‌ونیانی"""),
          SentencesRow(
            englishText: """Make sure the paint covers the surface evenly.""",
            kurdishText: """دڵنیابەرەوە بۆیەکە ڕووەکە بە یەکسانی دادەپۆشێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She was fast asleep, breathing evenly.""",
            kurdishText:
                """بە خێرایی خەوی لێکەوت و بە نەرم‌ونیانی هەناسەی دەدا.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ھاوەڵکار) بە بڕی یەکسان بۆ هەر کەسێک یان لە هەر شوێنێک"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Incidence of the disease is fairly evenly spread across Europe.""",
          ...
          SentencesRow(
            ...
            kurdishText: """دوو تیمەکە تا ئاستێکی زۆر لە هەمان ئاستن.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """بە لەسەرخۆیی گوتی 'ئاگادارم کردیتەوە پەیوەندیم پێوە نەکەیتەوە'.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: evenly
1. In equal amounts or shares; in a balanced or impartial way (= equally)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/rEdl2Uetpvo?t=';
...
const double _startSecondsone = 00000000000000000000000000000; // 267;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/qWAagS_MANg?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 771;
const String _videoIdthree = 'VIDEOhttps://youtu.be/z4L2E6_Gmkk?t=';
const double _startSecondsthree = 000000000000000000000000000; // 264;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/dqcSk-EDrRo?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1181;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/X5oD_thIk3c?t=';
