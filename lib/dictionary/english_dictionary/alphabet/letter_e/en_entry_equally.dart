...
class EnglishEntryequally extends StatefulWidget {
  const EnglishEntryequally({super.key});

  @override
  State<EnglishEntryequally> createState() => _EnglishEntryequallyState();
}

class _EnglishEntryequallyState extends State<EnglishEntryequally> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""equally""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equally""",
                      // alsoEnglishWord: "also: equally",
                      britshText: """IpaUK: /ˈiːkwəli/""",
                      americanText: """IpaUS: /ˈiːkwəli/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Everyone should be treated equally.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""This job could be done equally well by a computer.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The money was divided equally among her four children.""");
  }
...
کوردی: بە شێوەیەکی یەکسان، بەرامبەرانە
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵکار) بە هەمان ئاست"""),
          SentencesRow(
            englishText: """Diet and exercise are equally important.""",
            kurdishText: """شێوەی خواردن و ڕاهێنان وەک یەکدی گرنگن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Everyone should be treated equally.""",
            kurdishText: """هەموان دەبێت بە یەکسانی مامەڵەیان لەگەڵ بکرێت.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """کارەکە دەکرێت بە هەمان ئاست بە باشی لەلایەن کۆمپیوتەرەوە بکردرێت.""",
            onPressedBritish: () => speaksentence3("en-GB"),
            onPressedAmerican: () => speaksentence3("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ھاوەڵکار) بە بڕ، بەش، هتد ـی پێویست"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """They share the housework equally.""",
            kurdishText: """کاری ماڵەەو بە هاوبەشی دەکەن.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """پارەکە بە یەکسانی لە نێوان چوار منداڵەکەی دابەش کرا.""",
          ...
          const DefinitionKurdish(
              text:
                  """٣. (ھاوەڵکار) بۆ زیادکردنی شتێک کە وەک ئەوە گرنگە کە پێشووتر گوتووتە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """I'm trying to do what is best, but equally I've got to consider the cost.""",
            kurdishText:
                """هەوڵ دەدەم ئەوە بکەم کە باشترینە، بەڵام بە هەمان شێوە دەبێت تێچووەکە لەبەرچاو بگرم.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: equally
1. To the same degree (= as, every bit)
"they were equally beautiful";
 
2. In equal amounts or shares; in a balanced or impartial way (= evenly)
"they split their winnings equally"; "deal equally with rich and poor";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/MGO4_8YRKro?t=';
...
const double _startSecondsone = 00000000000000000000000000000; // 1090;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/ea4Tq7HB7kU?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 163;
const String _videoIdthree = 'VIDEOhttps://youtu.be/DfSnHyIryeY?t=';
const double _startSecondsthree = 000000000000000000000000000; // 146;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/hOUGNGWmN0k?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 184;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/F8_ME4VwTiw?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 89;
