...
class EnglishEntryforte extends StatefulWidget {
  const EnglishEntryforte({super.key});

  @override
  State<EnglishEntryforte> createState() => _EnglishEntryforteState();
}

class _EnglishEntryforteState extends State<EnglishEntryforte> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: forte
1. (used chiefly as a direction or description in music) indicating that said piece or segment should be played loudly (= loud)
"the forte passages in the composition";

- Noun: forte (Derived forms: fortes)
1. An asset of special worth or utility (= strong suit, long suit, métier, specialty [N. Amer], speciality [Brit, Cdn], strong point, strength)
...
- Adverb: forte
1. Used as a direction in music; to be played relatively loudly (= loudly)
""",
  );

  final String keyword = "forte";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Languages were never my forte.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forte""",
                      // alsoEnglishWord: "also: forte",
                      britshText: """IpaUK: /ˈfɔːteɪ/""",
                      americanText: """IpaUS: /fɔːrt/""",
...
کوردی: خالێ بەهێزی،	هونەر، شاکار
"""),
// With short examples define "forte", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) شتێک کە کەسێک باش دەیکات"""),
                    SentencesRow(
                      englishText: """Languages were never my forte.""",
                      kurdishText: """زمان هەرگیز خاڵی بەهێزم نەبووە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/xvmTr6S00Aw?t=';
const double _startSecondsend = 000000000000000000000000000215;
const String _videoIdone = 'https://youtu.be/hTqtGJwsJVE?t=';
const double _startSecondsone = 0000000000000000000000000003262;
const String _videoIdtwo = 'https://youtu.be/KZbzIf_C6Y4?t=';
const double _startSecondstwo = 000000000000000000000000000271;
const String _videoIdthree = 'https://youtu.be/VPWO3bvLtEU?t=';
const double _startSecondsthree = 000000000000000000000000000203;
const String _videoIdfour = 'https://youtu.be/BhqcprmntPY?t=';
const double _startSecondsfour = 000000000000000000000000000427;
const String _videoIdfive = 'https://youtu.be/fcmpqSLlgzk?t=';
const double _startSecondsfive = 000000000000000000000000000767;
