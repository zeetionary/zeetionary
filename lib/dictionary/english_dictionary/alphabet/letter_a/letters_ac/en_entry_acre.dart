...
class EnglishEntryacre extends StatefulWidget {
  const EnglishEntryacre({super.key});

  @override
  State<EnglishEntryacre> createState() => _EnglishEntryacreState();
}

class _EnglishEntryacreState extends State<EnglishEntryacre> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakacr1527(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Each house has acres of space around it.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acre""",
                      // alsoEnglishWord: "also: acre",
                      britshText: """IpaUK: /ˈeɪkə(r)/""",
                      americanText: """IpaUS: /ˈeɪkər/""",
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'G-fYO5e7FN8';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'qjIeocu0SyU';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = '-NIGa3nxkxg';
