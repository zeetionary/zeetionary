...
class EnglishEntryinvariable extends StatefulWidget {
  const EnglishEntryinvariable({super.key});

  @override
  State<EnglishEntryinvariable> createState() => _EnglishEntryinvariableState();
}

class _EnglishEntryinvariableState extends State<EnglishEntryinvariable> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""invariable""");
  }
