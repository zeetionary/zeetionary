...
class EnglishEntryfete extends StatefulWidget {
  const EnglishEntryfete({super.key});

  @override
  State<EnglishEntryfete> createState() => _EnglishEntryfeteState();
}

class _EnglishEntryfeteState extends State<EnglishEntryfete> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They're holding the village fete on the green.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fete""",
                      // alsoEnglishWord: "also: fete",
                      britshText: """IpaUK: /feɪt/""",
                      americanText: """IpaUS: /feɪt/""",
...
// With short examples define "fete", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """She was feted by audiences both in her own country and abroad.""",
                      kurdishText:
                          """لەلایەن گوێگرانەوە لە وڵاتەکەی خۆی و لە دەرەوەش پێشوازی لێدەکرا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/d7gsPmWOU-g?t=';
const double _startSecondsend = 00000000000000000000000000022;
const String _videoIdone = 'https://youtu.be/ykTqPOaYbDE?t=';
const double _startSecondsone = 000000000000000000000000000406;
const String _videoIdtwo = 'https://youtu.be/yThjSE7wLmA?t=';
const double _startSecondstwo = 000000000000000000000000000148;
const String _videoIdthree = 'https://youtu.be/tYvMpH_IDIk?t=';
const double _startSecondsthree = 0000000000000000000000000001095;
const String _videoIdfour = 'https://youtu.be/0NhS5D_uXxI?t=';
const double _startSecondsfour = 00000000000000000000000000040;
const String _videoIdfive = 'https://youtu.be/qaR8rFsWoEo?t=';
