...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '1Z1KLpf_7tU';
    const double startSecondsend = 934;
    const String videoIdone = '0IJSSBMLz6g';
    const double startSecondsone = 111;
    const String videoIdtwo = 'VYDaqto22NY';
    const double startSecondstwo = 806;
    const String videoIdthree = '60jGRGXOXbU';
    const double startSecondsthree = 193;
    const String videoIdfour = '3nso_KfY6AQ';
    const double startSecondsfour = 708;
    const String videoIdfive = '5yanE03KV00';
