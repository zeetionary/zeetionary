...
class EnglishEntryforever extends StatefulWidget {
  const EnglishEntryforever({super.key});

  @override
  State<EnglishEntryforever> createState() => _EnglishEntryforeverState();
}

class _EnglishEntryforeverState extends State<EnglishEntryforever> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: forever
1. For a limitless time (= everlastingly, eternally, evermore)
"no one can live forever";
 
2. For a very long or seemingly endless time (= forever and a day)
"she took forever to write the paper"; "we had to wait forever and a day";
 
3. Invariably (= constantly, always, perpetually, incessantly, unremittingly)
"the world is forever changing";
""",
  );

  final String keyword = "forever";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forever""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'll love you forever!""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""After her death, their lives changed forever.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Just keep telling yourself that it won't last forever.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The local dairy industry will soon be lost forever.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The final death toll may forever remain a mystery.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It takes her forever to get dressed.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Where have you been? I've been waiting forever!""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She's forever going on about how poor they are.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forever""",
                      // alsoEnglishWord: "also: forever",
                      britshText: """IpaUK: /fərˈevə(r)/""",
                      americanText: """IpaUS: /fərˈevər/""",
...
کوردی: هەمیشە، بۆ هەمیشە، هەتاهەتا، تاسەر، بۆ هەتاهەتا، هەتاهەتایە، بۆ یەکجاری، لەسەریەک، پەیتاپەیتا، یەکبینە، شەوڕۆژ، ماوەیەکی یەکجار زۆر
"""),
// With short examples define "forever", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بۆ گوتنی ئەوەی دۆخێکی دیاریکراو بۆ هەمیشەیی بووبی دەبێت"""),
                    SentencesRow(
                      englishText: """I'll love you forever!""",
                      kurdishText: """بۆ هەمیشە خۆشم دەوێیت!""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە دوای مەرگی، ژیانیان بۆ هەمیشە گۆڕا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەنها بەردەوام بە لەوەی بەخۆت بڵێیت کە بۆ هەمیشە بەردەوام نابێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پیشەسازییە شیرەمەنییە خۆجێییەکە زوو بۆ هەمیشە ون دەبیت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کۆتا ئاماری مردن ڕەنگە بۆ هەمیشە بە نهێنی بمێنێتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە کوێ بوویت؟ ئێجگار زۆرە چاوەڕێم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بەردەوام قسە دەکات لەسەر ئەوەی چەندە هەژارن.""",
...
const double _startSecondsend = 000000000000000000000000000295;
