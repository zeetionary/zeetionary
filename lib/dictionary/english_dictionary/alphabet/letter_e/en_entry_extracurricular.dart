...
class EnglishEntryextracurricular extends StatefulWidget {
  const EnglishEntryextracurricular({super.key});

  @override
  State<EnglishEntryextracurricular> createState() =>
      _EnglishEntryextracurricularState();
}

class _EnglishEntryextracurricularState
    extends State<EnglishEntryextracurricular> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extracurricular""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: extracurricular",
                      britshText: """IpaUK: /ˌekstrəkəˈrɪkjələ(r)/""",
                      americanText: """IpaUS: /ˌekstrəkəˈrɪkjələr/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extracurricular";
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە سەر بە پڕۆگرامی خوێندنی قوتابخانە یان کۆلێژێک نییە"""),
          SentencesRow(
            englishText:
                """She's involved in many extracurricular activities.""",
            kurdishText: """لە زۆر چالاکی دەرەوەی پڕۆگرامی خوێندن بەژدارە.""",
...
3. Characterized by adultery (= adulterous, extramarital)
...
const String _videoIdtwo = 'https://youtu.be/dPicox3QWC0?t=';
const double _startSecondstwo = 000000000000000000000000000747;
const String _videoIdthree = 'https://youtu.be/hCsPV0eiqxg?t=';
const double _startSecondsthree = 000000000000000000000000000227;
const String _videoIdfour = 'https://youtu.be/YGs9-_Fe74g?t=';
const double _startSecondsfour = 00000000000000000000000000060;
const String _videoIdfive = 'https://youtu.be/OqcP_wkcl2I?t=';
