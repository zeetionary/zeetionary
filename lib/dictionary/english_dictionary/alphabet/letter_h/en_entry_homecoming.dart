...
class EnglishEntryhomecoming extends StatefulWidget {
  const EnglishEntryhomecoming({super.key});

  @override
  State<EnglishEntryhomecoming> createState() => _EnglishEntryhomecomingState();
}

class _EnglishEntryhomecomingState extends State<EnglishEntryhomecoming> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: homecoming (Derived forms: homecomings)
1. An annual school or university reunion for graduates
 
2. A coming to or returning home (- return)
"on his homecoming from Australia we gave him a welcoming party";
""",
  );

  final String keyword = "homecoming";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""homecoming""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She felt no sense of homecoming.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She spent the day preparing for his homecoming.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/YIafrsAWS1Y?t=';
    const double startSecondsone = 00000000000000000000000000048;
    const String videoIdtwo = 'https://youtu.be/YpqaWQiyQRA?t=';
    const double startSecondstwo = 000000000000000000000000000230;
    const String videoIdthree = 'https://youtu.be/q1V1Zu7XYaI?t=';
    const double startSecondsthree = 0000000000000000000000000001688;
    const String videoIdfour = 'https://youtu.be/EFQFKVFLuOA?t=';
    const double startSecondsfour = 000000000000000000000000000277;
    const String videoIdfive = 'https://youtu.be/jLIUkk6Esr0?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homecoming""",
                      // alsoEnglishWord: "also: homecoming",
                      britshText: """IpaUK: /ˈhəʊmkʌmɪŋ/""",
                      americanText: """IpaUS: /ˈhəʊmkʌmɪŋ/""",
...
// With short examples define "homecoming", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """She felt no sense of homecoming.""",
                      kurdishText: """هیچ هەستی بە گەرانەوە ماڵ نەدەکرد.""",
                      englishNote:
                          """This means she did not experience the expected feeling of comfort, familiarity, or belonging when returning to a place or situation that should feel like home.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕۆژەکەی بەسەر برد بە گەڕانەوە ماڵ.""",
