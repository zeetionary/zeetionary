...
class EnglishEntryincessant extends StatefulWidget {
  const EnglishEntryincessant({super.key});

  @override
  State<EnglishEntryincessant> createState() => _EnglishEntryincessantState();
}

class _EnglishEntryincessantState extends State<EnglishEntryincessant> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incessant""");
  }
