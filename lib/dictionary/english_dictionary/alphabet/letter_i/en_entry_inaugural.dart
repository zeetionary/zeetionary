...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'sZnDoZsWntM';
    const double startSecondsend = 414;
    const String videoIdone = 'VhI2EpAIcm4';
    const double startSecondsone = 415;
    const String videoIdtwo = 'TByLlkbUa8A';
    const double startSecondstwo = 37;
    const String videoIdthree = 'A7beCOs4yAw';
    const double startSecondsthree = 40;
    const String videoIdfour = 'jEL5i38GFd8';
    const double startSecondsfour = 2;
    const String videoIdfive = '_S_dc2cmoZY';
    const double startSecondsfive = 1200;
