...
class EnglishEntryfootprint extends StatefulWidget {
  const EnglishEntryfootprint({super.key});

  @override
  State<EnglishEntryfootprint> createState() => _EnglishEntryfootprintState();
}

class _EnglishEntryfootprintState extends State<EnglishEntryfootprint> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: footprint (Derived forms: footprints)
1. A mark of a foot or shoe on a surface (= footmark, step, footstep)
"the police made casts of the footprints in the soft earth outside the window";
 
2. A trace suggesting that something was once present, felt or otherwise important
...
""",
  ...
  final String keyword = "footprint";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""footprint""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The wet footprints led back to the pool.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The new computer has a smaller footprint.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """footprint""",
                      // alsoEnglishWord: "also: footprint",
                      britshText: """IpaUK: /ˈfʊtprɪnt/""",
                      americanText: """IpaUS: /ˈfʊtprɪnt/""",
...
// With short examples define "footprint", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەیتوانی هەر ئاژەڵێک بە جێ پێیەکەی بناسێتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """جێ پێ تەڕەکە بەرەو مەلەوانگەکە دەچووەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) پێوانی ئەو سەرچاوانەی زەوی کە لە لایەن کەسێک یان دانیشتوانێکەوە بەکارهاتووە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: ecological footprint"),
                    SentencesRow(
                      englishText:
                          """These countries are so populous that they can have a very big footprint.""",
                      kurdishText:
                          """ئەم وڵاتانە هێندە پڕدانیشتوون کە دەکرێت پێ‌شوێنی ژینگەیی گەورەیان هەبێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کۆمپیوتەرە تازەکە شوێنگرتنی کەمتری هەیە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/_0RTH57v66I?t=';
const double _startSecondsend = 00000000000000000000000000070;
const String _videoIdone = 'https://youtu.be/Xzv84ZdtlE0?t=';
const double _startSecondsone = 0000000000000000000000000001889;
const String _videoIdtwo = 'https://youtu.be/4U2ZxO7b8iM?t=';
const double _startSecondstwo = 000000000000000000000000000665;
const String _videoIdthree = 'https://youtu.be/qr4MSVxfYBE?t=';
const double _startSecondsthree = 000000000000000000000000000699;
const String _videoIdfour = 'https://youtu.be/YLmDE_JYUNU?t=';
const double _startSecondsfour = 000000000000000000000000000302;
const String _videoIdfive = 'https://youtu.be/rsNskDfd5CM?t=';
