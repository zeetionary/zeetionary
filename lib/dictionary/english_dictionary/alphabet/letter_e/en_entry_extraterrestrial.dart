...
class EnglishEntryextraterrestrial extends StatefulWidget {
  const EnglishEntryextraterrestrial({super.key});

  @override
  State<EnglishEntryextraterrestrial> createState() =>
      _EnglishEntryextraterrestrialState();
}

class _EnglishEntryextraterrestrialState
    extends State<EnglishEntryextraterrestrial> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extraterrestrial""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: extraterrestrial",
                      britshText: """IpaUK: /ˌekstrətəˈrestriəl/""",
                      americanText: """IpaUS: /ˌekstrətəˈrestriəl/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extraterrestrial";
...
const String _videoIdend = 'https://youtu.be/kHTcoPoAnys?t=';
const double _startSecondsend = 000000000000000000000000000472;
const String _videoIdone = 'https://youtu.be/DuFyGHgGIKg?t=';
const double _startSecondsone = 000000000000000000000000000862;
...
const String _videoIdfour = 'https://youtu.be/j3DuONZb3Ik?t=';
const double _startSecondsfour = 000000000000000000000000000518;
const String _videoIdfive = 'https://youtu.be/wQSxY7TR6mI?t=';
const double _startSecondsfive = 000000000000000000000000000547;
