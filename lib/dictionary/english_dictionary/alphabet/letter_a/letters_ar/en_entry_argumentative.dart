...
class EnglishEntryargumentative extends StatelessWidget {
  ...
  Future<void> speakargumentative(String languageCode) async {
    ...
    await flutterTts.speak("argumentative");
  }
  ...
  Future<void> speakargumentative1050(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Everyone in the family was argumentative.");
  }
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'iC97eT8W3Xg';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'adx4of7Pnvo';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final double _startSeconds = 9146;
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'vN1Y-PBGqCE';
