...
class EnglishEntryirrigate extends StatefulWidget {
  const EnglishEntryirrigate({super.key});

  @override
  State<EnglishEntryirrigate> createState() => _EnglishEntryirrigateState();
}

class _EnglishEntryirrigateState extends State<EnglishEntryirrigate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: irrigate (Derived forms: irrigates, irrigated, irrigating)
1. Supply with water, as with channels, ditches or streams (- water)
"irrigate the fields";
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""irrigate""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The waters in these three rivers irrigate the plains of Punjab.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/VaTkzYv8sMo?t=641';
    const double startSecondsend = 000000000000000000000000000;
    const String videoIdone = 'https://youtu.be/Gqgp5zqmk14?t=649';
    const double startSecondsone = 000000000000000000000000000;
    const String videoIdtwo = 'https://youtu.be/uCM0Tvp6Dko?t=182';
    const double startSecondstwo = 000000000000000000000000000;
    const String videoIdthree = 'https://youtu.be/3Sqm_v49zno?t=590';
    const double startSecondsthree = 000000000000000000000000000;
    const String videoIdfour = 'https://youtu.be/iSWNXxLSOmQ?t=226';
    const double startSecondsfour = 000000000000000000000000000;
    const String videoIdfive = 'https://youtu.be/_BCY0SPOFpE?t=818';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """irrigate""",
                      // alsoEnglishWord: "also: irrigate",
                      britshText: """IpaUK: /ˈɪrɪɡeɪt/""",
                      americanText: """IpaUS: /ˈɪrɪɡeɪt/""",
...
// کوردی:
// """),
// With short examples define "irrigate", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) دابینکردنی ئاو بۆ پارچە زەوییەک بۆ ئەوەی دانەوێڵە گەشەی تێدا بکات"""),
                    SentencesRow(
                      englishText: """The waters in these three rivers irrigate the plains of Punjab.""",
                      kurdishText: """ئاوی سێ ڕووبار ئاودێری دەشتەکانی پونجاب دەکەن.""",
