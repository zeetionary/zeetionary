...
class EnglishEntryheavyweight extends StatefulWidget {
  const EnglishEntryheavyweight({super.key});

  @override
  State<EnglishEntryheavyweight> createState() =>
      _EnglishEntryheavyweightState();
}

class _EnglishEntryheavyweightState extends State<EnglishEntryheavyweight> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heavyweight (Derived forms: heavyweights)
...
4. A very large person; impressive in size or qualities (- giant, hulk, whale)
 
5. A person of exceptional importance and reputation (- colossus, behemoth, giant, titan)
 
6. A weight class division in combat sports, often the heaviest. (- super heavyweight)
""",
  );

  final String keyword = "heavyweight";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heavyweight""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The boxer won the heavyweight championship.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Mike Tyson was heavyweight champion of the world.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.speak(
        """He’s a heavyweight among his friends, much taller and stronger.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heavyweight""",
                      // alsoEnglishWord: "also: heavyweight",
                      britshText: """IpaUK: /ˈheviweɪt/""",
                      americanText: """IpaUS: /ˈheviweɪt/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کێشێک کە لە یاری بۆکسێن و وەرزشی دیکە کە زیاترینە، و لە یاری بۆکسێن زۆرجار وەرزشوانانی ٨١ کیلۆگرام یان زیاتر دەگرێتەوە؛ یاریزانێک لەم پۆلێنەدا"""),
                    SentencesRow(
                      englishText:
                          """The boxer won the heavyweight championship.""",
                      kurdishText:
                          """مستەوانەکە پاڵەوانێتیی کێشی قورسی بردەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """مایک تایسن پاڵەوانی جیهانی کێشی قورس بوو.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """ژممر. (ناو) کەسێک یان شتێک کە کێشی زۆرە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He’s a heavyweight among his friends, much taller and stronger.""",
                      kurdishText: """کێش‌قورسێکە لەناو هاوڕێکانیدا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) کەسێک، دامەزراوەیەک، یان شتێکی زۆر گرنگ کە کاریگەری هەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Her extraordinary intelligence and speaking ability made her a political heavyweight.""",
                      kurdishText:
                          """زیرەکیی لەڕادەبەدەری و توانای قسەکردنی کردی بە کەسایەتییەکی گرنگی سیاسی.""",
