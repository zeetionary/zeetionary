...
class EnglishEntryirritability extends StatefulWidget {
  const EnglishEntryirritability({super.key});

  @override
  State<EnglishEntryirritability> createState() =>
      _EnglishEntryirritabilityState();
}

class _EnglishEntryirritabilityState extends State<EnglishEntryirritability> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""irritability""");
  }
