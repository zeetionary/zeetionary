...
class EnglishEntryextinction extends StatefulWidget {
  const EnglishEntryextinction({super.key});

  @override
  State<EnglishEntryextinction> createState() => _EnglishEntryextinctionState();
}

class _EnglishEntryextinctionState extends State<EnglishEntryextinction> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extinction""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extinction""",
                      // alsoEnglishWord: "also: extinction",
                      britshText: """IpaUK: /ɪkˈstɪŋkʃn/""",
                      americanText: """IpaUS: /ɪkˈstɪŋkʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extinction";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The island's way of life is doomed to extinction.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The mountain gorilla is on the verge of extinction.""");
  }
...
"""),
          ...
          SentencesRow(
            ...
            kurdishText: """شێوازی ژیانی دوورگەکە مەحکومە بە لەناوچوونە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """گۆریلای شاخاوی لەسەر لێواری لەناوچوونە.""",
          ...
          SentencesRow(
            englishText:
                """We know of several mass extinctions in the earth's history.""",
            kurdishText:
                """سەبارەت بە ژمارەیەک لەناوچوونی بەکۆمەڵ لە مێژووی زەویدا دەزانین.""",
...
3. (physics) reduction of the intensity of radiation as a consequence of absorption or scattering
...
6. The act of extinguishing; causing to stop burning (= quenching)
...
const double _startSecondsone = 00000000000000000000000000050;
const String _videoIdtwo = 'https://youtu.be/oiLdWXLXDeA?t=';
const double _startSecondstwo = 0000000000000000000000000001056;
const String _videoIdthree = 'https://youtu.be/UvjSXBqQe4A?t=';
const double _startSecondsthree = 000000000000000000000000000492;
const String _videoIdfour = 'https://youtu.be/8jNs5G88TiI?t=';
const double _startSecondsfour = 000000000000000000000000000215;
const String _videoIdfive = 'https://youtu.be/OIo2Ie1HwHY?t=';
