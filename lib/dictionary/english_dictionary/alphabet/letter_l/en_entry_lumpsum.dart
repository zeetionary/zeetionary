...
class EnglishEntrylumpsum extends StatefulWidget {
  const EnglishEntrylumpsum({super.key});

  @override
  State<EnglishEntrylumpsum> createState() => _EnglishEntrylumpsumState();
}

class _EnglishEntrylumpsumState extends State<EnglishEntrylumpsum> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylumpsum lump sum
WORD_WEB lump sum lump sum lump sum
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lump sum";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lump sum""");
  }
...
کوردی: 
"""),
// With short examples define "lump sum", please follow LX instructions
