...
class EnglishEntryfrisk extends StatefulWidget {
  const EnglishEntryfrisk({super.key});

  @override
  State<EnglishEntryfrisk> createState() => _EnglishEntryfriskState();
}

class _EnglishEntryfriskState extends State<EnglishEntryfrisk> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: frisk (Derived forms: frisked, frisking, frisks)
...
2. Play boisterously (- frolic, lark [informal], rollick, skylark [informal], disport, sport, cavort, gambol, romp, run around, lark about [informal])
"The children frisked in the garden";

- Noun: frisk (Derived forms: frisks)
1. The act of searching someone for concealed weapons or illegal drugs (- frisking)
"he gave the suspect a quick frisk";
""",
  );

  final String keyword = "frisk";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We were all frisked at the airport.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Lambs frisked in the fields.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frisk""",
                      // alsoEnglishWord: "also: frisk",
                      britshText: """IpaUK: /frɪsk/""",
                      americanText: """IpaUS: /frɪsk/""",
...
کوردی: پشکنین، گیان‌گەڕان،	هەڵبەزودابەز، هەڵپەڕوداپەڕ، فڕک‌وهۆڕ، قوەتەقشقەنە
"""),
// With short examples define "frisk", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) گەڕان بۆ چەک، مادەی هۆشبەر، هتد بەوەی دەست بهێنیت بە لاشەی کەسێکدا"""),
                    SentencesRow(
                      englishText:
                          """We were all frisked at the airport.""",
                      kurdishText: """هەموومان لە فڕۆکەخانەکە پشکنراین.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) ڕاکردن و بازدان بە دڵخۆشییەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Lambs frisked in the fields.""",
                      kurdishText: """بەرخەکان هەڵبەزودابەزیان بوو لە کێڵگەکان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Xg0LamQIxUA?t=';
const double _startSecondsend = 000000000000000000000000000500;
const String _videoIdone = 'https://youtu.be/Slz8dnwYvEA?t=';
const double _startSecondsone = 000000000000000000000000000299;
const String _videoIdtwo = 'https://youtu.be/yYqlI__PniY?t=';
const double _startSecondstwo = 000000000000000000000000000593;
const String _videoIdthree = 'https://youtu.be/8TPaCsQVwA8?t=';
const double _startSecondsthree = 000000000000000000000000000489;
const String _videoIdfour = 'https://youtu.be/zKJAoXqix8A?t=';
const double _startSecondsfour = 000000000000000000000000000333;
const String _videoIdfive = 'https://youtu.be/aUbzT25kZ6s?t=';
