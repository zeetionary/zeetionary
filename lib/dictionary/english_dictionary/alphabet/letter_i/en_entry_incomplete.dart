...
class EnglishEntryincomplete extends StatefulWidget {
  const EnglishEntryincomplete({super.key});

  @override
  State<EnglishEntryincomplete> createState() => _EnglishEntryincompleteState();
}

class _EnglishEntryincompleteState extends State<EnglishEntryincomplete> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incomplete""");
  }
