...
class EnglishEntryfreetrade extends StatefulWidget {
  const EnglishEntryfreetrade({super.key});

  @override
  State<EnglishEntryfreetrade> createState() => _EnglishEntryfreetradeState();
}

class _EnglishEntryfreetradeState extends State<EnglishEntryfreetrade> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: free trade (Derived forms: free trades)
1. International trade free of government interference
""",
  );

  final String keyword = "free trade";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""free trade""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""A free-trade agreement can lower the cost of imports.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """free trade""",
                      // alsoEnglishWord: "also: free trade",
                      britshText: """IpaUK: /ˌfriː ˈtreɪd/""",
                      americanText: """IpaUS: /ˌfriː ˈtreɪd/""",
...
// With short examples define "free trade", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) سیستەمێکی بازرگانیی نێودەوڵەتی کە تێیدا هیچ باج نییە لەسەر هەناردە و هاوردە"""),
                    SentencesRow(
                      englishText:
                          """A free-trade agreement can lower the cost of imports.""",
                      kurdishText:
                          """ڕێکەوتنی بازرگانیی ئازاد دەکرێت تێچووی هاوردە کەم بکاتەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/kmo6lZcdkO0?t=';
const double _startSecondsend = 000000000000000000000000000661;
const String _videoIdone = 'https://youtu.be/JY5t6iUzajk?t=';
const double _startSecondsone = 000000000000000000000000000188;
const String _videoIdtwo = 'https://youtu.be/tYrdMjVXyNg?t=';
const double _startSecondstwo = 0000000000000000000000000004603;
const String _videoIdthree = 'https://youtu.be/72m0cK423-Q?t=';
const double _startSecondsthree = 00000000000000000000000000066;
const String _videoIdfour = 'https://youtu.be/P0G3lYTOI0Q?t=';
const double _startSecondsfour = 000000000000000000000000000125;
const String _videoIdfive = 'https://youtu.be/LoUdNi-WuGE?t=';
const double _startSecondsfive = 000000000000000000000000000519;
