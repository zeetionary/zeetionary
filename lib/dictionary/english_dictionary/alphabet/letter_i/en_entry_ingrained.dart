...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '-3-bVRYRnSM';
    const double startSecondsend = 301;
    const String videoIdone = 'mv-3D3noaxk';
    const double startSecondsone = 100;
    const String videoIdtwo = 'IfYRzxeMdGs';
    const double startSecondstwo = 295;
    const String videoIdthree = '3vH_9pgWExY';
    const double startSecondsthree = 47;
    const String videoIdfour = 'n3HN4NQdcqU';
    const double startSecondsfour = 36;
    const String videoIdfive = 'BE3ZGaeUEP8';
