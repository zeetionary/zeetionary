...
class EnglishEntryinsist extends StatefulWidget {
  const EnglishEntryinsist({super.key});

  @override
  State<EnglishEntryinsist> createState() => _EnglishEntryinsistState();
}

class _EnglishEntryinsistState extends State<EnglishEntryinsist> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: insist (Derived forms: insisted, insisting, insists)
1. Be emphatic or resolute and refuse to budge (- take a firm stand)
"I must insist!";
 
2. Beg persistently and urgently (- importune)
 
3. Postulate positively and assertively (- assert)
"The letter insists a free society";
""",
  );

  final String keyword = "insist";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I didn't really want to go but he insisted.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The Church insisted on abstention from all luxuries.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""His family insisted he should be given a proper burial.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He insisted on formal dress for dinner.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He insisted on his innocence.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/_gk72KC4jWc';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/Fi6gbNfd3SA?t=';
    ...
    const String videoIdthree = 'https://youtu.be/A8psc_yiKDM?t=';
    const double startSecondsthree = 000000000000000000000000000187;
    const String videoIdfour = 'https://youtu.be/1G-6jhYa7mw?t=';
    const double startSecondsfour = 000000000000000000000000000127;
    const String videoIdfive = 'https://youtu.be/DpntvSNMURY?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """insist""",
                      // alsoEnglishWord: "also: insist",
                      britshText: """IpaUK: /ɪnˈsɪst/""",
                      americanText: """IpaUS: /ɪnˈsɪst/""",
...
کوردی: 
"""),
// With short examples define "insist", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) داواکردنی ئەوەی شتێک ڕووبدات یان کەسێک بە شتێک ڕازی ببێت"""),
                    SentencesRow(
                      englishText:
                          """I didn't really want to go but he insisted.""",
                      kurdishText:
                          """لە ڕاستیدا نەمویست بچم بەڵام پێداگری کرد.""",
                    ...
                    SentencesRow(
                      englishText:
                          """They insisted that the property had not been acquired corruptly.""",
                      kurdishText:
                          "پێداگریان دەکرد کە زەوییەکە بە خراپی بەدەستنەھاتووە.",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) بە ڕوونی گوتنی ئەوەی کە شتێک ڕاستە، بە تایبەتی کە کەسانی دیکە باوەڕ ناکەن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He insisted on his innocence.""",
                      kurdishText: """پێداگیری لە بێ‌تاوانیی کرد.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The government has always insisted that this was not the case.""",
                      kurdishText:
                          """حکومەت هەمیشە پێداگری کردووە لەوەی ئەمە بابەتەکە نییە.""",
