...
class EnglishEntryfatigue extends StatefulWidget {
  const EnglishEntryfatigue({super.key});

  @override
  State<EnglishEntryfatigue> createState() => _EnglishEntryfatigueState();
}

class _EnglishEntryfatigueState extends State<EnglishEntryfatigue> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fatigue""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fatigue""",
                      // alsoEnglishWord: "also: fatigue",
                      britshText: """IpaUK: /fəˈtiːɡ/""",
                      americanText: """IpaUS: /fəˈtiːɡ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Driver fatigue was to blame for the accident.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was crying from cold and fatigue.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The right vitamins help you combat fatigue.""");
  }
...
کوردی: ماندوویی زۆر، ماندوویەتی، شەل‌وکوت‌بوون، لەپێکەوتن (لەبەر کاری سەخت یان مەشق،	(کانزاناسی) لاوازی، شەکەتی،	کاری سەخت، کوڵەمەرگی،	(سەربازی) بێگاری، کاری زۆرەملی، بەرگی شەڕ، یۆنیفۆڕمی شەڕ
"""),
          const DefinitionKurdish(
              text: """١. (ناو) ئەوەی کە تەواو ماندوو بیت"""),
          SentencesRow(
            englishText: """Driver fatigue was to blame for the accident.""",
            kurdishText: """شەکەتی شۆفێرەکە هۆکار بوو بۆ ڕووداوەکە.""",
          ...
          SentencesRow(
            englishText:
                """I was dropping with fatigue and could not keep my eyes open.""",
            kurdishText:
                """لە شەکەتیدا دەکەوتم و نەمدەتوانی چاوەکانم بە کراوەیی بهێڵمەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He was crying from cold and fatigue.""",
            kurdishText: """لە سەرماو شەکەتیدا دەگریا.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The right vitamins help you combat fatigue.""",
            kurdishText:
                """ڤیتامینی درووست یارمەتیت دەدات دژ بە شەکەتی بوەستیت.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) ئەوەی کە چی دیکە نەتەوێت شتێک بکەیت بەهۆی ئەوەی زۆرت لێ کردووە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Launching too many charity appeals risks bringing on compassion fatigue.""",
            kurdishText:
                """ئەنجامدانی تکای خێرخوازی زۆر مەترسی درووستکردنی نەمانی دڵ‌پێ‌سووتانی لێدەکەوێتەوە.""",
            englishNote:
                "Compassion fatigue is a loss of the ability to feel pity for other people’s suffering.)",
          ...
          const DefinitionKurdish(
              text:
                  """٣. (ناو) لاوازبوونی دار یان کانزا بەهۆی بەردەوام ڕاکێشان یان چەماندنەوە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The wing of the plane showed signs of metal fatigue.""",
            kurdishText: """باڵی فڕۆکەکە ئاماژەی لاوازبوونی کانزای تێدا بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fatigue (Derived forms: fatigues)
1. Temporary loss of strength and energy resulting from hard physical or mental work (= weariness, tiredness)
...
4. (military) labour of a nonmilitary kind done by soldiers (cleaning, digging, draining or so on) (= fatigue duty)
"they were assigned to kitchen fatigues"; "the soldiers were put on fatigue to teach them a lesson";

- Verb: fatigue (Derived forms: fatiguing, fatigues, fatigued)
1. Lose interest or become bored with something or somebody (= tire, pall, weary, jade)
"I'm so fatigued of your mother and her complaints about my food";
 
2. Exhaust or get tired through overuse or great strain or stress (= tire, wear upon, tire out, wear, weary, jade, wear out, outwear, wear down, fag out [Brit, informal], fag [informal], knacker [Brit, informal])
""",
  );
...
const String _videoIdend = 'https://youtu.be/LruThmuaxms?t=';
const double _startSecondsend = 00000000000000000000000000053;
const String _videoIdone = 'https://youtu.be/3Mn9QMTmRDM?t=';
const double _startSecondsone = 0000000000000000000000000001694;
const String _videoIdtwo = 'https://youtu.be/j3AQzO_JupE?t=';
const double _startSecondstwo = 000000000000000000000000000165;
const String _videoIdthree = 'https://youtu.be/6QgR6Tjle7g?t=';
const double _startSecondsthree = 000000000000000000000000000353;
const String _videoIdfour = 'https://youtu.be/mRj1RKh4xyY?t=';
const double _startSecondsfour = 00000000000000000000000000086;
const String _videoIdfive = 'https://youtu.be/S3ksC_8jGuc?t=';
const double _startSecondsfive = 000000000000000000000000000368;
