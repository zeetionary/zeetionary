...
// replace these: EnglishEntryaccommodating - speakAccommodating - accommodating - /əˈkɒmədeɪtɪŋ/

enum TtsState { playing }

class EnglishEntryaccommodating extends StatelessWidget {
  EnglishEntryaccommodating({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAccommodating(String languageCode) async {
    // DOPSUM: CHANGE speakAccommodating
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("accommodating"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAc24687(String languageCode) async {
    // DOPSUM: CHANGE speakAccommodating
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "They are very accommodating to people with special needs."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "accommodating"), // DOPSUM: CHANGE WORD ENTRY
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            CustomIconButtonBritish(
                              onPressed: () => speakAccommodating("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /əˈkɑːmədeɪtɪŋ/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                            CustomIconButtonAmerican(
                              onPressed: () => speakAccommodating("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'iK5ZcCse2G0';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'Oww65QJ7ix8';
