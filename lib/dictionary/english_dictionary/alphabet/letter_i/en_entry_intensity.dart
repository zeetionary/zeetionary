...
class EnglishEntryintensity extends StatefulWidget {
  const EnglishEntryintensity({super.key});

  @override
  State<EnglishEntryintensity> createState() => _EnglishEntryintensityState();
}

class _EnglishEntryintensityState extends State<EnglishEntryintensity> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: intensity (Derived forms: intensities)
1. The amount of energy transmitted (as by acoustic or electromagnetic radiation) (- strength, intensity level)
"he adjusted the intensity of the sound";
 
2. High level or degree; the property of being intense (- intensiveness)
 
3. The magnitude of sound (usually in a specified direction) (- volume, loudness)
"the kids played their music at full intensity";
 
4. Chromatic purity: freedom from dilution with white and hence vivid in hue (- saturation, chroma, vividness)
""",
  );

  final String keyword = "intensity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intensity""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He was watching her with an intensity that was unnerving.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The storm resumed with even greater intensity.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Her headaches started to increase in intensity.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.speak(
        """Scientists use the instrument to measure the intensity of the light.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/MnExgQ81fhU?t=';
    const double startSecondsend = 000000000000000000000000000863;
    const String videoIdone = 'https://youtu.be/s3B-qp3U5G0?t=';
    const double startSecondsone = 000000000000000000000000000594;
    const String videoIdtwo = 'https://youtu.be/n7WH7A2v7OU?t=';
    const double startSecondstwo = 000000000000000000000000000488;
    const String videoIdthree = 'https://youtu.be/-L7o6HtX8Vg?t=';
    const double startSecondsthree = 00000000000000000000000000045;
    const String videoIdfour = 'https://youtu.be/0Kr4JO9591c?t=';
    const double startSecondsfour = 000000000000000000000000000271;
    const String videoIdfive = 'https://youtu.be/n5CPMf5eC_s?t=';
    const double startSecondsfive = 0000000000000000000000000003166;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """intensity""",
                      // alsoEnglishWord: "also: intensity",
                      britshText: """IpaUK: /ɪnˈtensəti/""",
                      americanText: """IpaUS: /ɪnˈtensəti/""",
...
کوردی: زۆری، توندی، سەختی، تیژی، حوجەت، بەهێزی، بەقەوەتی، قووڵی، گرانی، خەستی، بەڕشتی، سووربوون، سۆز، ورووژان، کڵ‌وکۆ
"""),
// With short examples define "intensity", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) ئەوەی کە توند بێت"""),
                    SentencesRow(
                      englishText:
                          """He was watching her with an intensity that was unnerving.""",
                      kurdishText:
                          """بە توندییەکەوە سەیری دەکرد ترسێنەر بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زریانەکە بە توندییەکی تەنانەت زیاترەوە بەردەوام بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """سەرێشەکانی لە توندیدا زیادیان دەکرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) توندی شتێک، بۆ نموونە ڕۆشنایی، کە دەکرێت بپێورێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Scientists use the instrument to measure the intensity of the light.""",
                      kurdishText:
                          """زاناکان ئامێرەکە بەکاردێنن بۆ پێوانی توندی ڕۆشنایی.""",
