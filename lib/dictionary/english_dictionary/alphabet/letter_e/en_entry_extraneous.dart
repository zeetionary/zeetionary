...
class EnglishEntryextraneous extends StatefulWidget {
  const EnglishEntryextraneous({super.key});

  @override
  State<EnglishEntryextraneous> createState() => _EnglishEntryextraneousState();
}

class _EnglishEntryextraneousState extends State<EnglishEntryextraneous> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extraneous""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extraneous""",
                      // alsoEnglishWord: "also: extraneous",
                      britshText: """IpaUK: /ɪkˈstreɪniəs/""",
                      americanText: """IpaUS: /ɪkˈstreɪniəs/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extraneous";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We do not want any extraneous information on the page.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Coughs and extraneous noises can be edited out.""");
  }
...
کوردی: بیانی، بێگانە،	زیادی، زیایی، ناپێوەندیدار، تاک‌وتروک، پرش‌وبڵاو، ناتێکەڵ، بەری‌پێوەنەداو
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە ڕاستەوخۆ پەیوەندیدار نییە بەو دۆخەی تێیدایت یان ئەو بابەتەی قسەی لەسەر دەکەیت"""),
          SentencesRow(
            englishText:
                """We do not want any extraneous information on the page.""",
            kurdishText: """لەسەر پەڕەکە زانیاریی لاوەکیمان ناوێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Coughs and extraneous noises can be edited out.""",
            kurdishText: """کۆکە و ژاوەژاوی دیادی دەکرێت لاببرێت.""",
...
1. Not pertinent to the matter under consideration (= immaterial, impertinent, orthogonal)
"an issue extraneous to the debate";
 
2. Not essential
"the ballet struck me as extraneous and somewhat out of keeping with the rest of the play"
 
3. Not belonging to that in which it is contained; introduced from an outside source (= foreign)
"water free of extraneous matter";
 
4. Coming from the outside (= external, outside)
"extraneous light in the camera spoiled the photograph"; "relying upon an extraneous income";
""",
  );
...
const String _videoIdend = 'https://youtu.be/viOpP6P_PrQ?t=';
const double _startSecondsend = 000000000000000000000000000472;
const String _videoIdone = 'https://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondsone = 0000000000000000000000000002629;
const String _videoIdtwo = 'https://youtu.be/Gso2WrBcV2Q?t=';
const double _startSecondstwo = 000000000000000000000000000279;
const String _videoIdthree = 'https://youtu.be/xVnAWL2K3Xg?t=';
const double _startSecondsthree = 00000000000000000000000000049;
const String _videoIdfour = 'https://youtu.be/7UHQzuwqZM0?t=';
const double _startSecondsfour = 0000000000000000000000000002275;
const String _videoIdfive = 'https://youtu.be/dM0qCW8gBe4?t=';
const double _startSecondsfive = 000000000000000000000000000629;
