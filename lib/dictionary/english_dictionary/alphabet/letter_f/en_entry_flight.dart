...
""",
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""If we leave now, I can catch the earlier flight.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""After a few phone calls he boarded a flight to Bangkok.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Don't get into the line of flight of the bees—you'd be sure to get stung.""");
  }
...
// With short examples define "flight", please follow LX instructions
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) فڕۆکەیەک کە گەشتێکی دیاریکراو دەکات"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """If we leave now, I can catch the earlier flight.""",
                      kurdishText: """ئەگەر ئێستا دەربچین دەتوانم فڕۆکەکەی پێشتر بگرم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """After a few phone calls he boarded a flight to Bangkok.""",
                      kurdishText: """لە دوای ژمارەیەک پەیوەندیی تەلەفۆنی چووە سەر فڕۆکەیەک بۆ بانکۆک.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Flight BA 4793 is now boarding at Gate 17.""",
                      kurdishText: """گەشتی BA 4793 ئێستا لە دروازی ١٧ سەرخستن دەکات.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Barn owls are capable of flight at 56 days.""",
                      kurdishText: """کوندە پەپووی تەویلە دەتوانێت لە ٥٦ ڕۆژیدا بفڕێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They watched the young eagles take flight.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Don't get into the line of flight of the bees—you'd be sure to get stung.""",
                      kurdishText: """مەچۆ سەر ڕێگای فڕینی مێشهەنگەکان ـ دڵنیابە دەگەزرێیت.""",
