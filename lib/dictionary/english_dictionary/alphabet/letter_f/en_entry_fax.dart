...
class EnglishEntryfax extends StatefulWidget {
  const EnglishEntryfax({super.key});

  @override
  State<EnglishEntryfax> createState() => _EnglishEntryfaxState();
}

class _EnglishEntryfaxState extends State<EnglishEntryfax> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fax""",
                      // alsoEnglishWord: "also: fax",
                      britshText: """IpaUK: /fæks/""",
                      americanText: """IpaUS: /fæks/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""In those days we often sent documents by fax.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""You can still send faxes via email.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Could you fax me the latest version?""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ئامێرێک کە بەڵگەنامە بەشێوەی ئەلیکترۆنی دەنێرێت"""),
          SentencesRow(
            englishText:
                """The office equipment included a photocopier and a fax, but no computer.""",
            kurdishText:
                """کەرەستەکانی ئۆفیسەکە دەزگای فۆتۆکۆپی و بەڵگەبەرە هەبوو، بەڵام کۆمپیوتەر نا.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) سیستەمی ناردنی بەڵگەنامە بە هێڵەکانی موبایل یان ئینتەرنێت"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """In those days we often sent documents by fax.""",
            kurdishText:
                """لەو سەردەمانەدا زۆرجار بەڵگەنامەمان بە سیستەمی بەڵگەبەرە دەنارد.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هێستا دەتوانیت نامەی بەڵگەبەرە بە ئیمەیڵ بنێریت.""",
          ...
          const DefinitionKurdish(
              text:
                  """٤. (کردار) ناردنی نامەیەک، بەلگەنامەیەک، هتد بەم سیستەمە"""),
          const DividerSentences(),
          SentencesRow(
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Could you fax it to me?""",
            kurdishText: """دەتوانیت بۆم بنێریت؟""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fax (Derived forms: faxes)
1. Duplicator that transmits the copy by wire or radio (= facsimile, facsimile machine, fax machine)

- Verb: fax (Derived forms: faxed, faxes, faxing)
1. Send something via a facsimile machine (= telefax, facsimile)
...
const String _videoIdend = 'https://youtu.be/9P7hGBoi4Vo?t=';
const double _startSecondsend = 00000000000000000000000000011;
const String _videoIdone = 'https://youtu.be/xS7zGMrn8ck?t=';
const double _startSecondsone = 00000000000000000000000000017;
const String _videoIdtwo = 'https://youtu.be/G6IhvPoIRz0';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/ZROMk_I-PdI';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/38BEDMtu1BA';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/D4qS8hiGUg0?t=';
