...
class EnglishEntryaccordingly extends StatelessWidget {
  EnglishEntryaccordingly({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakaccordingly(String languageCode) async {
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈkɔːrdɪŋli/"),
