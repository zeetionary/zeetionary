...
کوردی: دەنگی تەقە، دەنگی تڵپە، دەنگی شڵپە،	تێشکان، سەرنەکەوتن، فشەڵ‌هێنان (کتێب، شانۆ و هتد)،	گۆڕانی کت‌وپڕ
"""),
// With short examples define "flop", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) پاڵکەوتن یان دانیشتن بە توندی بەهۆی ئەوەی زۆر ماندوویت"""),
                    SentencesRow(
                      englishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پیاوە گەنجەکە کەوت بە پشتدا بە بێ‌هۆشی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئینگلتەرە لە پاڵەوانێتیی ئەورووپا شکستی هێنا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Her first book flopped, but her second became a bestseller.""",
                      kurdishText:
                          """یەکەم کتێبی شکستی هێنا، بەڵام دووەمی بوو بە پڕفرۆشترین.""",
...
const double _startSecondsone = 000000000000000000000000000280;
const String _videoIdtwo = 'https://youtu.be/58XEfDtU0Z4?t=';
const double _startSecondstwo = 000000000000000000000000000815;
const String _videoIdthree = 'https://youtu.be/yLUvvfw_06s?t=';
const double _startSecondsthree = 000000000000000000000000000539;
const String _videoIdfour = 'https://youtu.be/y9nBhv0lq1s?t=';
const double _startSecondsfour = 0000000000000000000000000001864;
