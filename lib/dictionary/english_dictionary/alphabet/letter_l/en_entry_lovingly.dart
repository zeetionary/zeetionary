...
class EnglishEntrylovingly extends StatefulWidget {
  const EnglishEntrylovingly({super.key});

  @override
  State<EnglishEntrylovingly> createState() => _EnglishEntrylovinglyState();
}

class _EnglishEntrylovinglyState extends State<EnglishEntrylovingly> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylovingly lovingly
WORD_WEB lovingly lovingly lovingly
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lovingly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lovingly""");
  }
...
کوردی: 
"""),
// With short examples define "lovingly", please follow LX instructions
