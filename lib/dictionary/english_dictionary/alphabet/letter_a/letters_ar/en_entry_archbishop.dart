...
// replace EnglishEntryAdopsum - replace speakArchbishop

// replace archbishop - /ˌɑːtʃˈbɪʃəp/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarchbishop extends StatelessWidget {
  // blank divider
  EnglishEntryarchbishop({super.key});
  // blank divider
  ...
  Future<void> speakarchbishop(String languageCode) async {
    ...
    await flutterTts.speak("archbishop");
  }
  ...
  Future<void> speakarchbishop315(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("He was made Archbishop of Milan.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "archbishop"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌɑːtʃˈbɪʃəp/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌɑːrtʃˈbɪʃəp/"),
...
کوردی: سەرئۆسقۆف، گەورەئۆسقۆف، ئۆسقۆفی گەورە
"""),
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'yljjCPOQf44';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'E9fnMXK_AAQ';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'mIGzHXmcyg0';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'crcFImOwiJg';
