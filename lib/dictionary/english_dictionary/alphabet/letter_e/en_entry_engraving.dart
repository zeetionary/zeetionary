...
class EnglishEntryengraving extends StatefulWidget {
  const EnglishEntryengraving({super.key});

  @override
  State<EnglishEntryengraving> createState() => _EnglishEntryengravingState();
}

class _EnglishEntryengravingState extends State<EnglishEntryengraving> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""engraving""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """engraving""",
                      // alsoEnglishWord: "also: engraving",
                      britshText: """IpaUK: /ɪnˈɡreɪvɪŋ/""",
                      americanText: """IpaUS: /ɪnˈɡreɪvɪŋ/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "engraving";
...
کوردی: هەڵکۆڵی، کۆڵیاری، هەڵکۆڵین، هەڵکەندن، کاردۆژە،	وێنەی هەڵکۆڵراو 
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) وێنەیەک کە درووستکراوە بە هەڵکۆڵینی دیزاینێک لەسەر پارچەیەک کانزا و دواتر دیزاینەکە لەسەر کاغەز چاپکراوە"""),
          SentencesRow(
            englishText: """The engraving on the ring was intricate.""",
          ...
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) هونەری هەڵکۆڵین لەسەر دار، بەرد، کانزا، هتد"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """She learned the art of engraving from her father.""",
            kurdishText: """هونەری هەڵکۆڵین لە باوکییەوە فێربوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: engraving (Derived forms: engravings)
1. Making engraved or etched plates and printing designs from them (= etching)
 
2. A print made from an engraving
 
3. A block, plate or other hard surface that has been engraved
""",
  );
