...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'F2xv4fba65U';
    const double startSecondsend = 49;
    const String videoIdone = 'jJJ7YTt_C4M';
    const double startSecondsone = 255;
    const String videoIdtwo = 'nbBHdhFs1q0';
    const double startSecondstwo = 238;
    const String videoIdthree = 'axQGMmRew4k';
    const double startSecondsthree = 119;
    const String videoIdfour = '9uH8-Gj8XrM';
    const double startSecondsfour = 922;
    const String videoIdfive = 'tkD6QfeRil8';
    const double startSecondsfive = 405;
