...
class EnglishEntrylowkey extends StatefulWidget {
  const EnglishEntrylowkey({super.key});

  @override
  State<EnglishEntrylowkey> createState() => _EnglishEntrylowkeyState();
}

class _EnglishEntrylowkeyState extends State<EnglishEntrylowkey> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylowkey low-key
WORD_WEB low-key low-key low-key
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "low-key";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""low-key""");
  }
...
کوردی: 
"""),
// With short examples define "low-key", please follow LX instructions
