...
class EnglishEntryforgive extends StatefulWidget {
  const EnglishEntryforgive({super.key});

  @override
  State<EnglishEntryforgive> createState() => _EnglishEntryforgiveState();
}

class _EnglishEntryforgiveState extends State<EnglishEntryforgive> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: forgive (Derived forms: forgiven, forgave, forgives, forgiving)
1. Stop blaming or grant forgiveness (= pardon)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forgive""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Can you ever forgive me?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'll never forgive her for what she did.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She never forgave him for losing her ring.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I can't forgive that type of behaviour.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We all have to learn to forgive.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She'd forgive him anything.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I couldn't forgive him.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""An insult like that isn't easy to forgive.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Forgive me, but I don't see that any of this concerns me.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        """Forgive me for interrupting you, but I really don't agree with that.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forgive""",
                      // alsoEnglishWord: "also: forgive",
                      britshText: """IpaUK: /fəˈɡɪv/""",
                      americanText: """IpaUS: /fərˈɡɪv/""",
...
// With short examples define "forgive", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Can you ever forgive me?""",
                      kurdishText: """هەرگیز دەتوانیت بمبەخشیت؟""",
                          ...
                          children: [
                            SentencesRow(
                              englishText:
                                  """I'd never forgive myself if she heard the truth from someone else.""",
                              kurdishText:
                                  """هەرگیز خۆمم نەدەبەخشی ئەگەر ڕاستییەکەی لە کەسێکی دیکەوە ببیستایە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """هەرگیز نایبەخشم بۆ ئەوەی کە کردی.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """هەرگیز نەیبەخشی بۆ ونکردنی ئەڵقەکەی.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """ناتوانم لەو جۆرە ڕەفتارە ببوورم.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """هەموومان دەبێت فێری بەخشین ببین.""",
                            ...
                            const DividerSentences(),
                            SentencesRow(
                              englishText: """She'd forgive him anything.""",
                              kurdishText: """لە هەر شتێکیی دەبووری.""",
                            ...
                            const DividerSentences(),
                            SentencesRow(
                              englishText: """I couldn't forgive him.""",
                              kurdishText: """نەمدەتوانی لێی خۆش بم.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """سووکایەتییەکی وەک ئەوە ئاسان نییە بۆ بەخشین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بمبوورە، بەڵام هیچ لەوانە بەوە نابینم کە پەیوەندییان پێمەوە هەبێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Forgive me for interrupting you, but I really don't agree with that.""",
                      kurdishText:
                          """بمبوورە بۆ پچڕاندنت، بەڵام بەڕاستی قایل نیم بەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The government has agreed to forgive a large part of the debt.""",
                      kurdishText:
                          """حکومەت ڕازی بووە بە لێخۆشبوون لە بەشێکی گەورەی قەرزەکە.""",
...
const String _videoIdtwo = 'https://youtu.be/y1sF6ZeASU0?t=';
const double _startSecondstwo = 0000000000000000000000000001018;
const String _videoIdthree = 'https://youtu.be/raSeaAeryWE?t=';
const double _startSecondsthree = 0000000000000000000000000002231;
const String _videoIdfour = 'https://youtu.be/4K32WYshK6E?t=';
const double _startSecondsfour = 0000000000000000000000000001388;
const String _videoIdfive = 'https://youtu.be/dfuPBC-v5NE?t=';
const double _startSecondsfive = 000000000000000000000000000873;
