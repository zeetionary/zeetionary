...
class EnglishEntrylowland extends StatefulWidget {
  const EnglishEntrylowland({super.key});

  @override
  State<EnglishEntrylowland> createState() => _EnglishEntrylowlandState();
}

class _EnglishEntrylowlandState extends State<EnglishEntrylowland> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylowland lowland
WORD_WEB lowland lowland lowland
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lowland";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lowland""");
  }
...
کوردی: 
"""),
// With short examples define "lowland", please follow LX instructions
