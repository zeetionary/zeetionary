...
class EnglishEntryfineart extends StatefulWidget {
  const EnglishEntryfineart({super.key});

  @override
  State<EnglishEntryfineart> createState() => _EnglishEntryfineartState();
}

class _EnglishEntryfineartState extends State<EnglishEntryfineart> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fine art""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She studied fine art at the university.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fine art""",
                      // alsoEnglishWord: "also: fine art",
                      britshText: """IpaUK: /ˌfaɪn ˈɑːt/""",
                      americanText: """IpaUS: /ˌfaɪn ˈɑːrt/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) جۆرەکانی هونەر کە درووستکراون بۆ جوانی نەک سوود"""),
                    SentencesRow(
                      englishText:
                          """She studied fine art at the university.""",
                      kurdishText: """هونەری جوانی خوێند لە زانکۆ.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/eweyhaE6mpI?t=';
...
const String _videoIdtwo = 'https://youtu.be/bQbKLy3AAXY?t=';
const double _startSecondstwo = 000000000000000000000000000461;
const String _videoIdthree = 'https://youtu.be/0tl4S1KvH6o?t=';
const double _startSecondsthree = 000000000000000000000000000380;
const String _videoIdfour = 'https://youtu.be/EN6jtHIqeTg?t=';
const double _startSecondsfour = 0000000000000000000000000004;
const String _videoIdfive = 'https://youtu.be/HQlB4jSy-3Q?t=';
