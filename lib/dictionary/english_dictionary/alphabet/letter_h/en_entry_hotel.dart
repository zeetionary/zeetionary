...
class EnglishEntryhotel extends StatefulWidget {
  const EnglishEntryhotel({super.key});

  @override
  State<EnglishEntryhotel> createState() => _EnglishEntryhotelState();
}

class _EnglishEntryhotelState extends State<EnglishEntryhotel> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hotel (Derived forms: hotels)
1. A building where travellers can pay for lodging and meals and other services
""",
  );

  final String keyword = "hotel";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We met at the hotel.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""You are assured of a warm welcome at this hotel.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We had drinks on the hotel balcony.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hotel staff are friendly and attentive.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/HDntl7yzzVI?t=';
    const double startSecondsone = 00000000000000000000000000091;
    const String videoIdtwo = 'https://youtu.be/XZVHmRvfDHM?t=';
    const double startSecondstwo = 00000000000000000000000000043;
    const String videoIdthree = 'https://youtu.be/NCLZi2Rn_ug?t=';
    const double startSecondsthree = 00000000000000000000000000014;
    const String videoIdfour = 'https://youtu.be/613Oc0Q87Lk?t=';
    const double startSecondsfour = 00000000000000000000000000059;
    const String videoIdfive = 'https://youtu.be/mUv1NV_reWc?t=';
    const double startSecondsfive = 000000000000000000000000000161;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hotel""",
                      // alsoEnglishWord: "also: hotel",
                      britshText: """IpaUK: /həʊˈtel/""",
                      americanText: """IpaUS: /həʊˈtel/""",
...
// With short examples define "hotel", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """We met at the hotel.""",
                      kurdishText: """لە هوتێلەکە یەکمان دی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "ھوتێلەکە ئەتوانێت ٥٠٠ میوان لەخۆبگرێت.",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "ستافی ھوتێلەکە زۆر ڕووخۆش و یارمەتیدەرن.",
