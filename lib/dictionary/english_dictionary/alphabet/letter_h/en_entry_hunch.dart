...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'erDE9B-X7mk';
    const double startSecondsend = 1101;
    const String videoIdone = 'qg2nGY1aqlg';
    const double startSecondsone = 1021;
    const String videoIdtwo = 'BuX6-lvUwd0';
    const double startSecondstwo = 730;
    const String videoIdthree = 'wJa5Ch0O4BI';
    const double startSecondsthree = 488;
    const String videoIdfour = 'thR7IhHV554';
    const double startSecondsfour = 538;
    const String videoIdfive = 'THIGSnMP3io';
    const double startSecondsfive = 1793;
