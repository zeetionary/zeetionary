...
// replace EnglishEntryAdopsummm - replace speakArmistice

// replace armistice - /ˈɑːmɪstɪs/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarmistice extends StatelessWidget {
  // blank divider
  EnglishEntryarmistice({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakArmistice(String languageCode) async {
    // DOPSUM: CHANGE speakArmistice
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("armistice"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakArmistice508(String languageCode) async {
    // DOPSUM: CHANGE speakArmistice
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "The armistice was signed on 4 December."); // DOPSUM: CHANGE TEXT
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "vr4JU7C8yDE";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "QBXkGg-738M";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "XfiSZQsMXNE";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "EkwdBXovh4s";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "TViVAmSlLG4";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "Fu81WlXh6P4";

  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 863, // DOPSUM: CHANGE IT
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "y-E_n0q0ttI";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "uSuO2oOwZq4";

  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 1064, // DOPSUM: CHANGE IT
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "e0xqJfC25D4";
