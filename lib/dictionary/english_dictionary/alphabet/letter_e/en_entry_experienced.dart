...
class EnglishEntryexperienced extends StatefulWidget {
  const EnglishEntryexperienced({super.key});

  @override
  State<EnglishEntryexperienced> createState() =>
      _EnglishEntryexperiencedState();
}

class _EnglishEntryexperiencedState extends State<EnglishEntryexperienced> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""experienced""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """experienced""",
                      // alsoEnglishWord: "also: experienced",
                      britshText: """IpaUK: /ɪkˈspɪəriənst/""",
                      americanText: """IpaUS: /ɪkˈspɪriənst/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "experienced";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She's highly experienced in software development.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He's very experienced in looking after animals.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's very young and not very experienced.""");
  }
...
کوردی: بەئەزموون، کارامە، پوختە، خاراو، لەکاردەرهاتوو، کردە، دنیادیدە، لەکڵ‌دەرهاتوو
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) هەبوونی زانیاری یان شارەزایی لە کارێکی دیاریکراو"""),
          SentencesRow(
            englishText:
                """She's highly experienced in software development.""",
            kurdishText: """تەواو بەئەزموونە لە گەشەپێدانی نەرمامێر.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He's very experienced in looking after animals.""",
            kurdishText: """زۆر بەئەزموونە لە چاودێری ئاژەڵان.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ھاوەڵناو) هەبوونی زانیاری لە ئەنجامی کردنی کارێکی بۆ ماوەیەکی زۆر یان هەبوونی ئەزموونی زۆر"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """She's very young and not very experienced.""",
            kurdishText: """زۆر گەنجە و زۆر بەئەزموون نییە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She was more mature, more experienced.""",
            kurdishText: """بەتەمەن و زیاتر بەئەزموون بوو.""",
...
1. Having experience; having knowledge or skill from observation or participation (= experient)
""",
  );
...
const double _startSecondsend = 000000000000000000000000000000; // 1368;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/mY3SEMTROas?t=';
const double _startSecondsone = 00000000000000000000000000000; // 904;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/Gv4Af83KFrE?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1136;
const String _videoIdthree = 'VIDEOhttps://youtu.be/3RkhZgRNC1k?t=';
const double _startSecondsthree = 000000000000000000000000000; // 153;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/J-K5OjAkiEA?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 155;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/jfhEbHJoZZ8?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 447;
