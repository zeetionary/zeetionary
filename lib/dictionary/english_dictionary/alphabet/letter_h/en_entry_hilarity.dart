...
class EnglishEntryhilarity extends StatefulWidget {
  const EnglishEntryhilarity({super.key});

  @override
  State<EnglishEntryhilarity> createState() => _EnglishEntryhilarityState();
}

class _EnglishEntryhilarityState extends State<EnglishEntryhilarity> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hilarity (Derived forms: hilarities)
1. Great merriment (- mirth, mirthfulness, glee, gleefulness)
""",
  );

  final String keyword = "hilarity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hilarity""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The announcement was greeted with great hilarity.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """There was much hilarity when Geoffrey steamed in ten minutes late.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/jTRC_FMzLoo?t=';
    const double startSecondsend = 000000000000000000000000000107;
    const String videoIdone = 'https://youtu.be/OuOkS2tm89k?t=';
    const double startSecondsone = 000000000000000000000000000352;
    const String videoIdtwo = 'https://youtu.be/VWlAIbxoLmc?t=';
    const double startSecondstwo = 00000000000000000000000000083;
    const String videoIdthree = 'https://youtu.be/L_Guz73e6fw?t=';
    const double startSecondsthree = 0000000000000000000000000007024;
    const String videoIdfour = 'https://youtu.be/LxTWonQvXkw?t=';
    const double startSecondsfour = 000000000000000000000000000642;
    const String videoIdfive = 'https://youtu.be/WefqSN8dqOU?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hilarity""",
                      // alsoEnglishWord: "also: hilarity",
                      britshText: """IpaUK: /hɪˈlærəti/""",
                      americanText: """IpaUS: /hɪˈlærəti/""",
...
کوردی: خۆشی، شادی، قاقای خۆشی
"""),
// With short examples define "hilarity", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی شتێک بە جێگای پێکەنینی زۆر ببینیت"""),
                    SentencesRow(
                      englishText:
                          """The announcement was greeted with great hilarity.""",
                      kurdishText:
                          """ڕاگەیاندنەکە بە گاڵتەجاریی زۆرەوە سەیر کرا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """There was much hilarity when Geoffrey steamed in ten minutes late.""",
                      kurdishText:
                          """خۆشی زۆر هەبوو کە جێفری ١٠ خولەک درەنگتر خۆی کرد بە ژووردا.""",
