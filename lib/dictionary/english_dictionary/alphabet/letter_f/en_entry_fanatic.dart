...
class EnglishEntryfanatic extends StatefulWidget {
  const EnglishEntryfanatic({super.key});

  @override
  State<EnglishEntryfanatic> createState() => _EnglishEntryfanaticState();
}

class _EnglishEntryfanaticState extends State<EnglishEntryfanatic> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fanatic""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fanatic""",
                      // alsoEnglishWord: "also: fanatic",
                      britshText: """IpaUK: /fəˈnætɪk/""",
                      americanText: """IpaUS: /fəˈnætɪk/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He's fanatic about his religious beliefs.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The group was led by religious fanatics.""");
  }
...
"""),
          ...
          SentencesRow(
            ...
            kurdishText:
                """گرووپەکە لەلایەن توندڕەوانی ئایینییەوە پێشەوایی دەکرا.""",
...
const double _startSecondsend = 945;
const String _videoIdone = '05gCLHlpzTU';
const double _startSecondsone = 337;
const String _videoIdtwo = 'nMPCXuvL8EM';
const double _startSecondstwo = 89;
const String _videoIdthree = 'xRyPWG9PTm4';
const double _startSecondsthree = 705;
const String _videoIdfour = 'EmT0i0xG6zg';
const double _startSecondsfour = 1623;
const String _videoIdfive = 'wQSxY7TR6mI';
