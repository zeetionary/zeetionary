                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "amulet"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæmjʊlət/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæmjʊlət/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'UVl_fiD3jlM';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'En9gBAnfZZk';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '4YINmpUxiBw';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'IjycsgMc1Ok';
  final double _startSeconds = 1;
