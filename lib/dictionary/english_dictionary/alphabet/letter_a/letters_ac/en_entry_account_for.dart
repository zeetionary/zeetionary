...
// replace these: EnglishEntryaccountfor - speakAccountfor - account for - /əˈkaʊnt fə(r)/

enum TtsState { playing }

class EnglishEntryaccountfor extends StatelessWidget {
  EnglishEntryaccountfor({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakaccountfor(String languageCode) async {
    // DOPSUM: CHANGE speakAccountfor
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "account for"), // DOPSUM: CHANGE WORD ENTRY
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈkaʊnt fə(r)/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakaccountfor("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /əˈkaʊnt fər/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                            CustomIconButtonAmerican(
                              onPressed: () => speakaccountfor("en-US"),
                            ),
                          ],
                        ),
                      ],
...
١. (کاری لێکدراو) شتێک کە ھۆکاری شتێک ڕووندەکاتەوە"""),
                          SentencesRow(
                            ...
                            onPressedBritish: () => speaka79658("en-GB"),
                            onPressedAmerican: () => speaka79658("en-US"),
                          ),
                        ],
                      ),
                    ),
