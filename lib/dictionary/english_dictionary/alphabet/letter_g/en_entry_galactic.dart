...
class EnglishEntrygalactic extends StatefulWidget {
  const EnglishEntrygalactic({super.key});

  @override
  State<EnglishEntrygalactic> createState() => _EnglishEntrygalacticState();
}

class _EnglishEntrygalacticState extends State<EnglishEntrygalactic> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""galactic""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """galactic""",
                      // alsoEnglishWord: "also: galactic",
                      britshText: """IpaUK: /ɡəˈlæktɪk/""",
                      americanText: """IpaUS: /ɡəˈlæktɪk/""",
...
کوردی: کاکێشکەیی، کاگێشکەیی، گەلەستێرەیی، سەربە کۆئەستێرە (بەتایبەت کاکێشانی ڕێگای شیری)،	یەکجار زۆر، لەژمارنەهاتوو، بێ‌ئەنداز، زەبەلاح، یەکجار گەورە، فیلەتەن
"""),
// With short examples define "galactic", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """A galactic year is the time the galaxy takes to rotate once completely.""",
                      kurdishText:
                          """ساڵی گەلە ئەستێرە ئەو کاتەیە کە گەلە ئەستێرەکە پێویستییەتی جارێک بە تەواوی بسووڕێتەوە.""",
...
const String _videoIdend = 'https://youtu.be/jrHz8Bti6FY?t=';
const double _startSecondsend = 0000000000000000000000000001072;
const String _videoIdone = 'https://youtu.be/Esef5__HDXY?t=';
const double _startSecondsone = 000000000000000000000000000889;
const String _videoIdtwo = 'https://youtu.be/ZU_MF0NMKhU?t=';
const double _startSecondstwo = 000000000000000000000000000116;
const String _videoIdthree = 'https://youtu.be/mr7FXvTSYpA?t=';
const double _startSecondsthree = 000000000000000000000000000347;
const String _videoIdfour = 'https://youtu.be/s4Y3dlTDAxw?t=';
const double _startSecondsfour = 000000000000000000000000000468;
const String _videoIdfive = 'https://youtu.be/JN3KPFbWCy8?t=';
const double _startSecondsfive = 000000000000000000000000000596;
