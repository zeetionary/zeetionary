...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/_Z0ZQT0FttM?t=';
    const double startSecondsend = 000000000000000000000000000340;
    const String videoIdone = 'https://youtu.be/UfHNbCtx4cE?t=';
    const double startSecondsone = 000000000000000000000000000195;
    const String videoIdtwo = 'https://youtu.be/bp6kmcno9SI?t=';
    const double startSecondstwo = 000000000000000000000000000502;
    const String videoIdthree = 'https://youtu.be/gjySnrspD7E?t=';
    const double startSecondsthree = 000000000000000000000000000231;
    const String videoIdfour = 'https://youtu.be/lXuvGtB_LOU?t=';
    const double startSecondsfour = 000000000000000000000000000471;
    const String videoIdfive = 'https://youtu.be/89cXbrLB52c?t=';
    const double startSecondsfive = 000000000000000000000000000162;
