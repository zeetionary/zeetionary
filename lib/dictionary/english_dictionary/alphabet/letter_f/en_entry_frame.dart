...
// With short examples define "frame", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چوارچێوەی وێنە زۆرجار قەراغی پەخ‌داری هەیە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) چوارچێوەی کەلوپەلێک، بینایەک، پێڕۆیەک، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەیکەلێکی بچووکی هەیە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ناو) ئەو تێگەشتنە گشتییانەی کە شتێک پێکدەهێنن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """In this course we hope to look at literature in the frame of its social and historical context.""",
                      kurdishText:
                          """لەم کۆرسەدا هیوادارین سەیری ئەدەبیات بکەین لە چوارچێوەی پێگە کۆمەڵایەتی و مێژووییەکەیدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەڵێت کە تاوانی بۆ هەڵبەستراوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Measures to secure oil production must be framed in the context of rising energy demands.""",
                      kurdishText:
                          """هەنگاوەکانی بەرهەمهێنانی نەوت دەبێت دابڕێژرێن بە لەبەرچاوگرتنی خواستی بەرزبوو بۆ وزە.""",
...
const double _startSecondsone = 0000000000000000000000000001132;
const String _videoIdtwo = 'https://youtu.be/e09xig209cQ?t=';
const double _startSecondstwo = 000000000000000000000000000226;
const String _videoIdthree = 'https://youtu.be/tXjHb5QmDV0?t=';
const double _startSecondsthree = 000000000000000000000000000769;
const String _videoIdfour = 'https://youtu.be/O4iGNXsqghs?t=';
const double _startSecondsfour = 00000000000000000000000000084;
const String _videoIdfive = 'https://youtu.be/O4iGNXsqghs?t=';
