...
class EnglishEntryincomprehensible extends StatefulWidget {
  const EnglishEntryincomprehensible({super.key});

  @override
  State<EnglishEntryincomprehensible> createState() =>
      _EnglishEntryincomprehensibleState();
}

class _EnglishEntryincomprehensibleState
    extends State<EnglishEntryincomprehensible> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incomprehensible""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'VFR37y1-81M';
    const double startSecondsend = 889;
    const String videoIdone = 'HgvqxRqZybw';
    const double startSecondsone = 674;
    const String videoIdtwo = 'jRMTCQgEVuM';
    const double startSecondstwo = 733;
    const String videoIdthree = 'P8A4ivmCCk4';
    const double startSecondsthree = 751;
    const String videoIdfour = 'B9RbCdSNoQg';
    const double startSecondsfour = 1327;
    const String videoIdfive = 'DPMiWwqX4wI';
    const double startSecondsfive = 997;
