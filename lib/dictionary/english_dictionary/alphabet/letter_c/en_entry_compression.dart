...
class EnglishEntrycompression extends StatelessWidget {
// blank divider
  EnglishEntrycompression({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcompression(String languageCode) async {
    // DOPSUM: CHANGE speakcompression
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "compression"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /kəmˈpreʃn/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcompression("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /kəmˈpreʃn/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcompression("en-US"),
                            ),
                          ],
                        ),
                      ],
...
کوردی: پەستان، داگرتن، پەستاوتن، پەسواندن، داتەپاندن، گوشاردان، گڤاشتن، گوشین، پاڵیەک‌نان، داشێلان، پەسێوراوی، داتەپیوی، داشێلاوی،	گوشار، پەستان،	کورتی، پوختی
"""),
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  late YoutubePlayerController _controller;
  final String _videoId = 'iiBLQPiRjRc';
...
class _YoutubeEmbeddedtwoState extends State<YoutubeEmbeddedtwo> {
  late YoutubePlayerController _controller;
  final String _videoId = '7JGM_4lumXM';
...
class _YoutubeEmbeddedthreeState extends State<YoutubeEmbeddedthree> {
  late YoutubePlayerController _controller;
  final String _videoId = 'VXIu3oo8z4c';
