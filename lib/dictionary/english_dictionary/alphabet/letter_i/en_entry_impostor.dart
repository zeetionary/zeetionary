...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '_ZmHwaqCxRY';
    const double startSecondsend = 315;
    const String videoIdone = '2iHm4PNR1DI';
    const double startSecondsone = 498;
    const String videoIdtwo = 'axI5aUwPA6k';
    const double startSecondstwo = 338;
    const String videoIdthree = 'o3gfdG2gMGk';
    const double startSecondsthree = 261;
    const String videoIdfour = 'ynQOgG7B8Ck';
    const double startSecondsfour = 429;
    const String videoIdfive = 'bvSkHbM2GVk';
