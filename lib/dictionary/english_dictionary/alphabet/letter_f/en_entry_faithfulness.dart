...
class EnglishEntryfaithfulness extends StatefulWidget {
  const EnglishEntryfaithfulness({super.key});

  @override
  State<EnglishEntryfaithfulness> createState() =>
      _EnglishEntryfaithfulnessState();
}

class _EnglishEntryfaithfulnessState extends State<EnglishEntryfaithfulness> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""faithfulness""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """faithfulness""",
                      // alsoEnglishWord: "also: faithfulness",
                      britshText: """IpaUK: /ˈfeɪθflnəs/""",
                      americanText: """IpaUS: /ˈfeɪθflnəs/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "faithfulness";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His faithfulness to tradition was evident in his wedding.""");
  }
...
کوردی: بەوەفایی، بەئەمەکی، پێزانی، ئەمەگ‌داری، دڵسۆزی، یەکلایی،	بڕوا، ئیمان
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) مانەوەی زۆر لەگەڵ یان وەک پشتیوانی کەسێک، دامەزراوەیەک، یان باوەڕێکی دیاریکراو"""),
          SentencesRow(
            englishText:
...
const double _startSecondsend = 000000000000000000000000000694;
const String _videoIdone = 'https://youtu.be/eQ9eY0_DoEk?t=';
const double _startSecondsone = 000000000000000000000000000207;
const String _videoIdtwo = 'https://youtu.be/cIjeUVkrpRo?t=';
const double _startSecondstwo = 000000000000000000000000000439;
const String _videoIdthree = 'https://youtu.be/34axirGsSSs?t=';
const double _startSecondsthree = 0000000000000000000000000001080;
const String _videoIdfour = 'https://youtu.be/ydZAcANvrkY?t=';
const double _startSecondsfour = 0000000000000000000000000002813;
const String _videoIdfive = 'https://youtu.be/TeQ1nq_YJD0?t=';
