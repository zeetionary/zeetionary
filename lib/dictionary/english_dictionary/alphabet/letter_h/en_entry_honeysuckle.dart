...
class EnglishEntryhoneysuckle extends StatefulWidget {
  const EnglishEntryhoneysuckle({super.key});

  @override
  State<EnglishEntryhoneysuckle> createState() =>
      _EnglishEntryhoneysuckleState();
}

class _EnglishEntryhoneysuckleState extends State<EnglishEntryhoneysuckle> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: honeysuckle (Derived forms: honeysuckles)
1. Shrub or vine of the genus Lonicera
 
2. Shrubby tree with silky foliage and spikes of cylindrical yellow nectarous flowers (- Australian honeysuckle, coast banksia, Banksia integrifolia)
 
3. Columbine of eastern North America having long-spurred red flowers (- meeting house, Aquilegia canadensis)
""",
  );

  final String keyword = "honeysuckle";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""honeysuckle""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The honeysuckle blooms attract many bees and butterflies.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/a7wC2M0b5u0?t=';
    const double startSecondsend = 0000000000000000000000000001581;
    const String videoIdone = 'https://youtu.be/f-M3JN_7LGU?t=';
    const double startSecondsone = 000000000000000000000000000336;
    const String videoIdtwo = 'https://youtu.be/bOieHHnaDVI?t=';
    const double startSecondstwo = 000000000000000000000000000366;
    const String videoIdthree = 'https://youtu.be/u05gxIWYv8k?t=';
    const double startSecondsthree = 000000000000000000000000000186;
    const String videoIdfour = 'https://youtu.be/ikHBtzay1lY?t=';
    const double startSecondsfour = 000000000000000000000000000850;
    const String videoIdfive = 'https://youtu.be/Z3aNyMLKMG8?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """honeysuckle""",
                      // alsoEnglishWord: "also: honeysuckle",
                      britshText: """IpaUK: /ˈhʌnisʌkl/""",
                      americanText: """IpaUS: /ˈhʌnisʌkl/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕووەکێکی پیاهەڵگژ کە گوڵی سپی، زەرد، و پەمەیی پێکهاتووە، بۆنێکی خۆشی هەیە"""),
                    SentencesRow(
                      englishText:
                          """The honeysuckle blooms attract many bees and butterflies.""",
                      kurdishText:
                          """خونچەی دارخەڵات زۆر مێشهەنگ و پەپوولە ڕادەکێشێت.""",
