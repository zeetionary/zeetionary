...
class EnglishEntryfussy extends StatefulWidget {
  const EnglishEntryfussy({super.key});

  @override
  State<EnglishEntryfussy> createState() => _EnglishEntryfussyState();
}

class _EnglishEntryfussyState extends State<EnglishEntryfussy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fussy (Derived forms: fussier, fussiest)
1. Annoyed and irritable (- crabbed, crabby, cross, grouchy [informal], grumpy, bad-tempered, ill-tempered, arsey [Brit, informal])
 
2. Overcrowded or cluttered with detail (- busy)
"a fussy design";
 
3. Exacting especially about details (- finical, finicky, particular, picky, finicking)
"fussy about clothes";
""",
  );

  final String keyword = "fussy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's such a fussy eater.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Our teacher is very fussy about punctuation.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He noticed the quick, fussy movements of her small hands.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The costume designs are too fussy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fussy""",
                      // alsoEnglishWord: "also: fussy",
                      britshText: """IpaUK: /ˈfʌsi/""",
                      americanText: """IpaUS: /ˈfʌsi/""",
...
کوردی: نگەران، بەدڵەڕاوکێ، قیژەون لەسەر شتی هیچەکە، هەژیو، زووتووڕە، جینگزی،	(دیزاین، بەرگ و هتد) بەزریقەوبڕیقە، ئاڵاوواڵا، ڕازاوە، بریقەدار،	پڕدێدی‌وبۆدی، پڕتڕوتەوێڵ
"""),
// With short examples define "fussy", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """She's such a fussy eater.""",
                      kurdishText: """بخۆرێکی زۆر بەپیتکەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """‘Where do you want to go for lunch?’ ‘I'm not fussy (= I don't mind).’""",
                      kurdishText:
                          """'بۆ نانی نیوەڕۆ دەتەوێت بۆ کوێ بچیت؟' 'گرنگی پێ نادەم.'""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """مامۆستاکەمان نیگەرانە سەبارەت بە خاڵبەندی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تێبینی جووڵەی خێرا و بەدڵەڕاوکێی دەستە بچووکەکانیی کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/6gq5t1SBnPs?t=';
...
const double _startSecondstwo = 000000000000000000000000000769;
const String _videoIdthree = 'https://youtu.be/rWXAiWYywLk?t=';
const double _startSecondsthree = 000000000000000000000000000213;
const String _videoIdfour = 'https://youtu.be/jzFY1KDoaeU?t=';
const double _startSecondsfour = 000000000000000000000000000445;
const String _videoIdfive = 'https://youtu.be/IGS0JouUgjM?t=';
