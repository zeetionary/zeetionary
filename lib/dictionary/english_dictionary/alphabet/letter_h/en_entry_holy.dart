...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1142;
    const String videoIdone = 'G-Wn48geCJ8';
    const double startSecondsone = 42;
    const String videoIdtwo = 'omcNGrnt7Sg';
    const double startSecondstwo = 3858;
    const String videoIdthree = 'CvjoXdC-WkM';
    const double startSecondsthree = 438;
    const String videoIdfour = 'eMgFyMUFELA';
    const double startSecondsfour = 133;
