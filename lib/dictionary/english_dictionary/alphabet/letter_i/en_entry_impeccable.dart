...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 591;
    const String videoIdone = 'ShMRAN78598';
    const double startSecondsone = 989;
    const String videoIdtwo = 'YAr7O8-iRgQ';
    const double startSecondstwo = 1623;
    const String videoIdthree = 'l6PlMpncVuc';
    const double startSecondsthree = 300;
    const String videoIdfour = 'Y5-6f1T9qsc';
    const double startSecondsfour = 51;
    const String videoIdfive = 'kAgTZSJ4jo8';
