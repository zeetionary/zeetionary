...
class EnglishEntryloyalty extends StatefulWidget {
  const EnglishEntryloyalty({super.key});

  @override
  State<EnglishEntryloyalty> createState() => _EnglishEntryloyaltyState();
}

class _EnglishEntryloyaltyState extends State<EnglishEntryloyalty> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryloyalty loyalty
WORD_WEB loyalty loyalty loyalty
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "loyalty";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""loyalty""");
  }
...
کوردی: 
"""),
// With short examples define "loyalty", please follow LX instructions
