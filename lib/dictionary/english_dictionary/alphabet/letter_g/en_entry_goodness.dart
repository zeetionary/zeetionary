...
class EnglishEntrygoodness extends StatefulWidget {
  const EnglishEntrygoodness({super.key});

  @override
  State<EnglishEntrygoodness> createState() => _EnglishEntrygoodnessState();
}

class _EnglishEntrygoodnessState extends State<EnglishEntrygoodness> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""goodness""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We like to think that goodness exists in everyone.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """goodness""",
                      // alsoEnglishWord: "also: goodness",
                      britshText: """IpaUK: /ˈɡʊdnəs/""",
                      americanText: """IpaUS: /ˈɡʊdnəs/""",
...
// With short examples define "goodness", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هیچ نەبێت ئەخلاقی ئەوەت هەبێت هەبێت سەیرم بکەیت کە قسەت لەگەڵ دەکەم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پێمان خۆشە وەها بفکرین کە چاکە لە هەموو کەسێکدا بوونی هەیە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ئەو لایەنەی شتێک کە کاریگەری باشی هەیە لەسەر کەسێک/شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """These vegetables have had all the goodness boiled out of them.""",
                      kurdishText:
                          """ئەم سەوزانە هەموو سوودەکەیان بە کوڵان لێدەرکراوە.""",
...
const double _startSecondsend = 000000000000000000000000000628;
const String _videoIdone = 'https://youtu.be/_Z0ZQT0FttM?t=';
const double _startSecondsone = 0000000000000000000000000002875;
...
const String _videoIdfour = 'https://youtu.be/t_0aE0VBJzQ?t=';
const double _startSecondsfour = 00000000000000000000000000067;
const String _videoIdfive = 'https://youtu.be/s5eILKG5oSE?t=';
