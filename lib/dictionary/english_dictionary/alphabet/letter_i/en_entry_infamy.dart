...
class EnglishEntryinfamy extends StatefulWidget {
  const EnglishEntryinfamy({super.key});

  @override
  State<EnglishEntryinfamy> createState() => _EnglishEntryinfamyState();
}

class _EnglishEntryinfamyState extends State<EnglishEntryinfamy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: infamy (Derived forms: infamies)
1. A state of extreme dishonour (- opprobrium)
...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/FIH5WjT3b2U?t=';
    const double startSecondsend = 00000000000000000000000000011;
    const String videoIdone = 'https://youtu.be/7eM7pb5M5DU?t=';
    const double startSecondsone = 0000000000000000000000000002200;
    const String videoIdtwo = 'https://youtu.be/7fcqhU-23TA?t=';
    const double startSecondstwo = 0000000000000000000000000001034;
    const String videoIdthree = 'https://youtu.be/CiRBQ3frG6U?t=';
    const double startSecondsthree = 000000000000000000000000000294;
    const String videoIdfour = 'https://youtu.be/IBI67y7GWUc?t=';
    const double startSecondsfour = 000000000000000000000000000265;
    const String videoIdfive = 'https://youtu.be/7fE5ljMUsAw?t=';
    const double startSecondsfive = 000000000000000000000000000210;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """infamy""",
                      // alsoEnglishWord: "also: infamy",
                      britshText: """IpaUK: /ˈɪnfəmi/""",
                      americanText: """IpaUS: /ˈɪnfəmi/""",
...
کوردی: نێوزڕاوی، ئابڕووتکاوی، بێ‌ئابڕوویی، ڕووڕەشی، ڕووسیاباری، خوێڕیەتی، سووکی
"""),
// With short examples define "infamy", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) ئەوەی کە ناسراو بیت بۆ شتێکی خراپ"""),
                    SentencesRow(
                      englishText:
                          """The president described the attack as "a day that will live in infamy".""",
                      kurdishText:
                          """سەرۆک هێرشەکەی ناوزەد کرد بە ڕۆژێک کە لە مێژووی بەدناوی دەمێنێتەوە.""",
                      englishNote:
                          """This means the president called the attack a significant and shameful event that will always be remembered negatively in history. This refers to American President Franklin D. Roosevelt's speech on December 8, 1941, following the Japanese attack on Pearl Harbor the previous day.""",
