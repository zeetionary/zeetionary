...
class EnglishEntryfun extends StatefulWidget {
  const EnglishEntryfun({super.key});

  @override
  State<EnglishEntryfun> createState() => _EnglishEntryfunState();
}

class _EnglishEntryfunState extends State<EnglishEntryfun> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fun (Derived forms: funs)
1. Activities that are enjoyable or amusing (- merriment, playfulness)
"he is fun to have around"; "I do it for the fun of it";
 
2. Verbal wit or mockery (often at another's expense but not to be taken seriously) (- play, sport)
"he became a figure of fun";
 
3. Violent and excited activity
"she asked for money and then the fun began"
 
4. A disposition to find (or make) causes for amusement (- playfulness)
"he was fun to be with";

- Adjective: fun
1. Affording satisfaction or pleasure (- enjoyable, gratifying, pleasurable)
 
2. Providing enjoyment; pleasantly entertaining (- amusing, amusive, diverting)

""",
  );

  final String keyword = "fun";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We had a lot of fun at Sarah's party.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Have fun!""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""That was the most fun I have had in years.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was great fun! You should have come too.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We won't let a bit of rain spoil our fun.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I decided to learn Spanish, just for fun.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I didn't do all that work just for the fun of it.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It's not much fun going to a party on your own.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We didn't mean to hurt him. It was just a bit of fun.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It wasn't serious—it was all done in fun.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's really fun to be with.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This game looks fun!""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Let's have a fun night out.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fun""",
                      // alsoEnglishWord: "also: fun",
                      britshText: """IpaUK: /fʌn/""",
                      americanText: """IpaUS: /fʌn/""",
...
کوردی: ڕابواردن، سەرقاڵی،	خۆشی، وەشی، کەیف،	گاڵتەجاڕی، تیتاڵ‌بازی، قۆشمەیی، کایە، هاروهاجی، شلوقی، شەیتانی،	مایەی ڕابواردن یان سەرقاڵی، مایەی پێکەنین، پێکەنینی، گاڵتەجاڕ
"""),
// With short examples define "fun", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) ئەوەی کە چێژ و خۆشی لە خۆت ببینیت"""),
                    SentencesRow(
                      englishText: """We had a lot of fun at Sarah's party.""",
                      kurdishText:
                          """خۆشییەکی زۆرمان هەبوو لە ئاهەنگەکەی سارا.""",
                    ...
                    Column(
                      children: [
                        MyExpansionTile(
                          children: [
                            SentencesRow(
                              englishText: """Have fun! (= Enjoy yourself)""",
                              kurdishText: """کاتێکی خۆش!""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """ئەوە خۆشترین کات بوو کە بۆ چەندین ساڵ بێت هەمبووبێت.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """خۆشییەکی زۆر بوو! تۆش دەبوو هاتبایت.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """ناهێڵین کەمێک باران خۆشییەکەمان تێک بدات.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """بڕیارمدا فێری ئیسپانی ببم، تەنها بۆ خۆشی.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """هەموو ئەو کارەم نەکرد تەنها بۆ خۆشییەکەی.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """زۆر خۆش نییە خۆت بە تەنها بچیتە ئاهەنگێک.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) هەڵسوکەوت و چالاکی کە بە جدی نین بەڵکو بۆ خۆشین"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We didn't mean to hurt him. It was just a bit of fun.""",
                      kurdishText: """نەمانویست ئازاری بدەین. تەنها کەمێک گاڵتە بوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """It wasn't serious—it was all done in fun.""",
                      kurdishText: """بە جدی نەبوو ـ هەمووی بە گاڵتە بوو.""",
                      onPressedBritish: () => speaksentence10("en-GB"),
                      onPressedAmerican: () => speaksentence10("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) کە چێژی لێ دەبینیت"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """This game looks fun!""",
                      kurdishText: """یارییەکە خۆش دیارە!""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Let's have a fun night out.""",
                      kurdishText: """با شەوێکی بەچێژ لە دەرەوە بەسەر بەرین.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/kNw8V_Fkw28?t=';
const double _startSecondsend = 000000000000000000000000000278;
const String _videoIdone = 'https://youtu.be/_Z0ZQT0FttM?t=';
const double _startSecondsone = 00000000000000000000000000052;
const String _videoIdtwo = 'https://youtu.be/sDmeXdC3myg?t=';
...
const String _videoIdfive = 'https://youtu.be/_spuxXnul0U?t=';
