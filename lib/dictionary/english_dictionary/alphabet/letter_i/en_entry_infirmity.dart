...
class EnglishEntryinfirmity extends StatefulWidget {
  const EnglishEntryinfirmity({super.key});

  @override
  State<EnglishEntryinfirmity> createState() => _EnglishEntryinfirmityState();
}

class _EnglishEntryinfirmityState extends State<EnglishEntryinfirmity> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infirmity""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 3102;
    const String videoIdone = 'CzP23Zti-YI';
    const double startSecondsone = 1328;
    const String videoIdtwo = 'TDMd40a-A4c';
    const double startSecondstwo = 378;
    const String videoIdthree = 'NeaE_sSVxxQ';
    const double startSecondsthree = 712;
    const String videoIdfour = 'E6HR2vfnn9M';
    const double startSecondsfour = 905;
    const String videoIdfive = 'ih2Z3HEMvVM';
    const double startSecondsfive = 396;
