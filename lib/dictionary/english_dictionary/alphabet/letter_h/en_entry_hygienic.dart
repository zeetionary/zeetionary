...
class EnglishEntryhygienic extends StatefulWidget {
  const EnglishEntryhygienic({super.key});

  @override
  State<EnglishEntryhygienic> createState() => _EnglishEntryhygienicState();
}

class _EnglishEntryhygienicState extends State<EnglishEntryhygienic> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hygienic""");
  }
