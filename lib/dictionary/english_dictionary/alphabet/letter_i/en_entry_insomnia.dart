...
class EnglishEntryinsomnia extends StatefulWidget {
  const EnglishEntryinsomnia({super.key});

  @override
  State<EnglishEntryinsomnia> createState() => _EnglishEntryinsomniaState();
}

class _EnglishEntryinsomniaState extends State<EnglishEntryinsomnia> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insomnia""");
  }
