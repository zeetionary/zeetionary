...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""There have been strange happenings here lately.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Ask Caroline - she knows all the happening clubs in town.""");
  }
...
// With short examples define "happening", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Recent happenings on the stock market can be interpreted in various ways.""",
                      kurdishText:
                          """ڕووداوە تازەکان لە بازاڕی بۆرسە دەکرێت بە چەند شێوەیەک لێکدانەوەیان بۆ بکرێت.""",
