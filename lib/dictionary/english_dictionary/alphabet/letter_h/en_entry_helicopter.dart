...
class EnglishEntryhelicopter extends StatefulWidget {
  const EnglishEntryhelicopter({super.key});

  @override
  State<EnglishEntryhelicopter> createState() => _EnglishEntryhelicopterState();
}

class _EnglishEntryhelicopterState extends State<EnglishEntryhelicopter> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: helicopter (Derived forms: helicopters)
1. An aircraft without wings that obtains its lift from the rotation of overhead blades (- chopper [informal], whirlybird [N. Amer, informal], eggbeater [N. Amer, informal], copter [informal])

- Verb: helicopter (Derived forms: helicoptering, helicopters, helicoptered)
1. Travel or transport by helicopter
""",
  );

  final String keyword = "helicopter";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""helicopter""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was rushed to the hospital by helicopter.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He flew helicopters during the Gulf War.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Helicopters buzzed overhead.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """helicopter""",
                      // alsoEnglishWord: "also: helicopter",
                      britshText: """IpaUK: /ˈhelɪkɒptə(r)/""",
                      americanText: """IpaUS: /ˈhelɪkɑːptər/""",
...
کوردی: 
"""),
// With short examples define "helicopter", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) باڵەفڕێک کە باڵی هەیە لە سەرەوەی کە دەسووڕێتەوە"""),
                    SentencesRow(
                      englishText:
                          """He was rushed to the hospital by helicopter.""",
                      kurdishText: """بە هەلیکۆپتەر فڕێندرا بۆ نەخۆشخانە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەلیکۆپتەری فڕاند لە ماوەی جەنگی کەنداودا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەلیکۆپتەر لە سەرەوە فڕەیان دەهات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/kHrjgWoy8qY?t=';
const double _startSecondsend = 000000000000000000000000000185;
const String _videoIdone = 'https://youtu.be/DGMGCgA5fvM?t=';
const double _startSecondsone = 000000000000000000000000000173;
const String _videoIdtwo = 'https://youtu.be/uAG4zCsiA_w?t=';
const double _startSecondstwo = 0000000000000000000000000003;
const String _videoIdthree = 'https://youtu.be/u1lU64CG8p8?t=';
const double _startSecondsthree = 0000000000000000000000000008;
const String _videoIdfour = 'https://youtu.be/O4RpSc1d4UE?t=';
const double _startSecondsfour = 000000000000000000000000000102;
const String _videoIdfive = 'https://youtu.be/Z2QjDBtaEKg?t=';
