...
class EnglishEntryhandiwork extends StatefulWidget {
  const EnglishEntryhandiwork({super.key});

  @override
  State<EnglishEntryhandiwork> createState() => _EnglishEntryhandiworkState();
}

class _EnglishEntryhandiworkState extends State<EnglishEntryhandiwork> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: handiwork (Derived forms: handiworks)
1. A work produced by hand labour (- handicraft, handcraft, handwork)
"he gazed reverently at the handiwork";
""",
  );

  final String keyword = "handiwork";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""handiwork""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We admired her exquisite handiwork.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This looks like the handiwork of an arsonist.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """handiwork""",
                      // alsoEnglishWord: "also: handiwork",
                      britshText: """IpaUK: /ˈhændiwɜːk/""",
                      americanText: """IpaUS: /ˈhændiwɜːrk/""",
...
// """),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەمە لە کاری ئاورتێبەردەرێک دەچێت.""",
