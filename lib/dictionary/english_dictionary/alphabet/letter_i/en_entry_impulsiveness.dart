...
class EnglishEntryimpulsiveness extends StatefulWidget {
  const EnglishEntryimpulsiveness({super.key});

  @override
  State<EnglishEntryimpulsiveness> createState() =>
      _EnglishEntryimpulsivenessState();
}

class _EnglishEntryimpulsivenessState extends State<EnglishEntryimpulsiveness> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "impulsiveness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impulsiveness""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She had to learn how to curb her impulsiveness.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/HrpiX8D_1Qo?t=';
    const double startSecondsend = 0000000000000000000000000001432;
    const String videoIdone = 'https://youtu.be/fIspXVHv3QY?t=';
    const double startSecondsone = 00000000000000000000000000037;
    const String videoIdtwo = 'https://youtu.be/LbalOCu5Xqc?t=';
    const double startSecondstwo = 000000000000000000000000000905;
    const String videoIdthree = 'https://youtu.be/qtOKrG_wK5A?t=';
    const double startSecondsthree = 0000000000000000000000000004193;
    const String videoIdfour = 'https://youtu.be/irp5ghCVNAM?t=';
    const double startSecondsfour = 00000000000000000000000000018;
    const String videoIdfive = 'https://youtu.be/8CviaikflJw?t=';
    const double startSecondsfive = 000000000000000000000000000490;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """impulsiveness""",
                      // alsoEnglishWord: "also: impulsiveness",
                      britshText: """IpaUK: /ɪmˈpʌlsɪvnəs/""",
                      americanText: """IpaUS: /ɪmˈpʌlsɪvnəs/""",
...
کوردی: 
"""),
// With short examples define "impulsiveness", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە زوو هەنگاو بنێیت بۆ کردنی شتێک بەبێ ئەوەی بیربکەیتەوە چی ڕوودەدات لە ئەنجامدا"""),
                    SentencesRow(
                      englishText:
                          """He had rushed into the relationship too quickly, and regretted his impulsiveness.""",
                      kurdishText:
                          """زۆر زوو چووبووە ناو پەیوەندییەکە و پەشیمان بوو لە سەرەڕۆیی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پێویست بوو فێربێت چۆن دژی هەڵەشەییەکەی بوەستێت.""",
