...
class EnglishEntrylowprofile extends StatefulWidget {
  const EnglishEntrylowprofile({super.key});

  @override
  State<EnglishEntrylowprofile> createState() => _EnglishEntrylowprofileState();
}

class _EnglishEntrylowprofileState extends State<EnglishEntrylowprofile> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylowprofile low-profile
WORD_WEB low-profile low-profile low-profile
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "low-profile";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""low-profile""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """low-profile""",
                      // alsoEnglishWord: "also: low-profile",
...
کوردی: 
"""),
// With short examples define "low-profile", please follow LX instructions
