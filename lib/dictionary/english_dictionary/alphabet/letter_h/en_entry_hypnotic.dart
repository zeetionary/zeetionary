...
class EnglishEntryhypnotic extends StatefulWidget {
  const EnglishEntryhypnotic({super.key});

  @override
  State<EnglishEntryhypnotic> createState() => _EnglishEntryhypnoticState();
}

class _EnglishEntryhypnoticState extends State<EnglishEntryhypnotic> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hypnotic""");
  }
