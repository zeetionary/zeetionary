...
// replace EnglishEntryAdopsum - replace speakApricot

// replace apricot - /ˈeɪprɪkɒt/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryapricot extends StatelessWidget {
  // blank divider
  EnglishEntryapricot({super.key});
  // blank divider
  ...
  Future<void> speakapricot(String languageCode) async {
    ...
    await flutterTts.speak("apricot");
  }
  ...
  Future<void> speakapricot1040(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I don't like apricot.");
  }
  ...
  Future<void> speakapricot1043(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The room was painted apricot and white.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "apricot"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈeɪprɪkɒt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUS: /ˈæprɪkɑːt/, /ˈeɪprɪkɑːt/"),
...
3. A shade of pink tinged with yellow (= yellowish pink, peach, salmon pink)
""",
  );
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '1sCr-ehnSl0';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'SdRIU5e9Cu4';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'WE83Fn5IJKo';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'vJsE5nzZ3Lg';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'DIp9IS0PJrk';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'UYsiMxPFuFY';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'vwY2OFy6Ph0';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'bg_0Sqt4-Q8';
  final double _startSeconds = 1;
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'hUgNhfTy1Oc';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'x4Ugd9dGDbQ';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'kAlT0dt6wUA';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'vRjbFdzk4yY';
