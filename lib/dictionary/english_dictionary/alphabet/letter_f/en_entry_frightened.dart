...
class EnglishEntryfrightened extends StatefulWidget {
  const EnglishEntryfrightened({super.key});

  @override
  State<EnglishEntryfrightened> createState() => _EnglishEntryfrightenedState();
}

class _EnglishEntryfrightenedState extends State<EnglishEntryfrightened> {
  @override
  void initState() {
    super.initState();
...
1. Made afraid (= scared)
"the frightened child cowered in the corner";
 
2. Thrown into a state of intense fear or desperation (= panicky, panicked, panic-stricken, panic-struck, terrified)
"became frightened as the snow deepened";
""",
  );

  final String keyword = "frightened";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frightened""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Don't be frightened.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He sounded frightened.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""What are you frightened of?""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I'm frightened of walking home alone in the dark.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frightened""",
                      // alsoEnglishWord: "also: frightened",
                      britshText: """IpaUK: /ˈfraɪtnd/""",
                      americanText: """IpaUS: /ˈfraɪtnd/""",
...
// With short examples define "frightened", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """He sounded frightened.""",
                      kurdishText: """ترساو دیار بوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """What are you frightened of?""",
                      kurdishText: """لە چی دەترسیت؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەترسم لەوەی بە تەنها بچمەوە ماڵەوە.""",
...
const String _videoIdone = 'https://youtu.be/mriYyuDmB58?t=';
const double _startSecondsone = 00000000000000000000000000017;
const String _videoIdtwo = 'https://youtu.be/jfhEbHJoZZ8?t=';
const double _startSecondstwo = 000000000000000000000000000350;
const String _videoIdthree = 'https://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondsthree = 000000000000000000000000000546;
const String _videoIdfour = 'https://youtu.be/t8r3UwCUCfw?t=';
const double _startSecondsfour = 000000000000000000000000000129;
const String _videoIdfive = 'https://youtu.be/HYbbmatf6w4?t=';
