...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 853;
    const String videoIdone = 'mY3SEMTROas';
    const double startSecondsone = 705;
    const String videoIdtwo = 'Fr-qagv7ig0';
    const double startSecondstwo = 1148;
    const String videoIdthree = 'aTDG16Mh2_w';
    const double startSecondsthree = 73;
    const String videoIdfour = 'FQ4hvLqNfqo';
    const double startSecondsfour = 1325;
    const String videoIdfive = 'iib_imkZ5fk';
