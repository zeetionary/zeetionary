...
class EnglishEntryallah extends StatelessWidget {
  ...
  Future<void> speakallah359999(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("It is the will of Allah.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈælə/, /əˈlɑː/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'CHLcfTXd0FE';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '-tkGEFhHM5I';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'IOjwyHYEdN4';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'JjUFV2idv4Y';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'FFIAFPmBvRw';
  final double _startSeconds = 2078;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'ibNTMEsABbo';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '46AbkP5Gxaw';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'DR1j5aeiGZk';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = '4bE9_XQg3z8';
