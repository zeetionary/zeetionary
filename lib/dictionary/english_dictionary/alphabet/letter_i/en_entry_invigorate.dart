...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/SEW0iqZn5jo?t=';
    const double startSecondsend = 0000000000000000000000000001461;
    const String videoIdone = 'https://youtu.be/l4Iu3YB0pTs?t=';
    const double startSecondsone = 0000000000000000000000000003722;
    const String videoIdtwo = 'https://youtu.be/q9T3Dx7NE-k?t=';
    const double startSecondstwo = 00000000000000000000000000033;
    const String videoIdthree = 'https://youtu.be/RlvYLgdL61A?t=';
    const double startSecondsthree = 000000000000000000000000000269;
    const String videoIdfour = 'https://youtu.be/Ga1_2Zy5__s?t=';
    const double startSecondsfour = 000000000000000000000000000209;
    const String videoIdfive = 'https://youtu.be/y2d1XYcMTDY?t=';
