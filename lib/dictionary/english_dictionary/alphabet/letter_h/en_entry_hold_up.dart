...
class EnglishEntryholdup extends StatefulWidget {
  const EnglishEntryholdup({super.key});

  @override
  State<EnglishEntryholdup> createState() => _EnglishEntryholdupState();
}

class _EnglishEntryholdupState extends State<EnglishEntryholdup> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hold-up (Derived forms: holdups)
1. Robbery at gunpoint (- armed robbery, heist [informal], stickup)
 
2. The act of delaying; inactivity resulting in something being put off until a later time (- delay)
""",
  );

  final String keyword = "hold-up";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hold-up""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What's the hold-up?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We should finish by tonight, barring hold-ups.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Cd1EmYRZynw?t=';
    const double startSecondsend = 000000000000000000000000000331;
    const String videoIdone = 'https://youtu.be/uSDG4K1ycvc?t=';
    const double startSecondsone = 000000000000000000000000000140;
    const String videoIdtwo = 'https://youtu.be/3BMnmGUXQhI?t=';
    const double startSecondstwo = 000000000000000000000000000434;
    const String videoIdthree = 'https://youtu.be/LnU15fBwm4I?t=';
    const double startSecondsthree = 000000000000000000000000000253;
    const String videoIdfour = 'https://youtu.be/j4QAA8Fwy1c?t=';
    const double startSecondsfour = 000000000000000000000000000625;
    const String videoIdfive = 'https://youtu.be/20n5F_DmNDY?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hold-up""",
                      // alsoEnglishWord: "also: hold-up",
                      britshText: """IpaUK: /ˈhəʊld ʌp/""",
                      americanText: """IpaUS: /ˈhəʊld ʌp/""",
...
کوردی: 
"""),
// With short examples define "hold-up", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دۆخێک کە دەبێت ڕێگر لە پێش ڕوودانی شتێک بۆ ماوەیەکی کاتی"""),
                    const AlsoEnglishckb(word: "ھەروەھا: delay"),
                    SentencesRow(
                      englishText: """What's the hold-up?""",
                      kurdishText: """چییە دواکەوتنەکە؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەبێت تا ئەمشەو تەواو بین، بەدەر لە هەر دواکەوتنێک.""",
                      kurdishNote:
                          """واتا تا ئەمشەو پێشبینی دەکرێت تەواو ببین ئەگەر هیچ دواکەوتنێک ڕوونەدات""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) دزیکردنی لە بانکێک، هتد بە چەک"""),
                    const AlsoEnglishckb(word: "ھەروەھا: stick-up"),
                    SentencesRow(
                      englishText:
                          """In the hold-up, a masked youth threatened the bank staff with a gun.""",
                      kurdishText:
                          """لە تاڵانییەکەدا، گەنجێکی دەمامکدار هەڕەشەی لە ستافی بانکەکە کرد بە چەکێکەوە.""",
