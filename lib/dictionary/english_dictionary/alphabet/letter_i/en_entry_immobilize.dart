...
class EnglishEntryimmobilize extends StatefulWidget {
  const EnglishEntryimmobilize({super.key});

  @override
  State<EnglishEntryimmobilize> createState() => _EnglishEntryimmobilizeState();
}

class _EnglishEntryimmobilizeState extends State<EnglishEntryimmobilize> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: immobilize (Derived forms: immobilized, immobilizes, immobilizing)
1. Hold as reserve or withdraw from circulation; of capital (- immobilise [Brit])
 
2. To hold fast or prevent from moving (- trap, pin, immobilise [Brit])
"The child was immobilized under the fallen tree";
 
3. Make defenseless (- immobilise [Brit])
 
4. Convert (assets) into fixed capital (- immobilise [Brit])
 
5. Prohibit the conversion or use of (assets) (- freeze, block, immobilise [Brit])
"immobilize the assets of this hostile government";
 
6. Cause to be unable to move (- immobilise [Brit])
"The sudden storm immobilized the traffic";
""",
  );

  final String keyword = "immobilize";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""immobilize""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Always immobilize a broken leg immediately.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The firm has been immobilized by a series of strikes.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/drhDGeNauuo?t=';
    const double startSecondsend = 000000000000000000000000000944;
    const String videoIdone = 'https://youtu.be/9qw3lkpa5lY?t=';
    const double startSecondsone = 000000000000000000000000000114;
    const String videoIdtwo = 'https://youtu.be/UIyfNM6y3vU?t=';
    const double startSecondstwo = 000000000000000000000000000184;
    const String videoIdthree = 'https://youtu.be/yRowC6t8tjA?t=';
    const double startSecondsthree = 00000000000000000000000000051;
    const String videoIdfour = 'https://youtu.be/4mjvZrLnlCg?t=';
    const double startSecondsfour = 000000000000000000000000000182;
    const String videoIdfive = 'https://youtu.be/DHLVQXXFIsc?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """immobilize""",
                      // alsoEnglishWord: "also: immobilize",
                      britshText: """IpaUK: /ɪˈməʊbəlaɪz/""",
                      americanText: """IpaUS: /ɪˈməʊbəlaɪz/""",
...
// With short examples define "immobilize", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەمیشە دەستبەجێ لاقی شکاو لەجووڵە بوەستێنە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کۆمپانیاکە لە دەست‌وپێ کەتووە بەهۆی زنجیرەیەک لە مانگرتنەوە.""",
