...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondstwo = 1634;
    const String videoIdthree = 'Oz9zw7-_vhM';
    const double startSecondsthree = 279;
    const String videoIdfour = '7jD5Gkh4K34';
    const double startSecondsfour = 478;
    const String videoIdfive = 'RQYuyHNLPTQ';
    const double startSecondsfive = 907;
