...
// Define the word "bowel" and for each meaning provide five real life example sentences that consist of less than 12 words. Use  Oxford Advanced Learner's Dictionary style. Provide at least 5 meanings or more for each types of speech that the word has.
...
class EnglishEntrybowel extends StatelessWidget {
// blank divider
  EnglishEntrybowel({super.key});
// blank divider
  ...
  Future<void> speakbowel(String languageCode) async {
    ...
    await flutterTts.speak("bowel"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakbowels1(String languageCode) async {
    ...
    await flutterTts.speak(
        "Patients are asked to report any change in bowel habit."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakbowels2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("He has trouble with his bowels."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakbowels3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "A rumble came from the bowels of the earth."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakbowels4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbowels44"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakbowels5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbowels55"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakbowels6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbowels66"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakbowels7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbowels77"); // DOPSUM: CHANGE TEXT
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "bowel"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈbaʊəl/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakbowel("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈbaʊəl/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakbowel("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  ...
  final String _videoId = 'NTNSCmw4A4c';
...
class _YoutubeEmbeddedthreeState extends State<YoutubeEmbeddedthree> {
  late YoutubePlayerController _controller;
  final String _videoId = 'Ob8sR4A-UIA';
...
class _YoutubeEmbeddedfourState extends State<YoutubeEmbeddedfour> {
  late YoutubePlayerController _controller;
  final String _videoId = 'E86eXpVBTcI';
...
class _YoutubeEmbeddedfiveState extends State<YoutubeEmbeddedfive> {
  late YoutubePlayerController _controller;
  final String _videoId = '586F2O94uu4';
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  late YoutubePlayerController _controller;
  final String _videoId = 'FdQexSS0lOg';
...
class _YoutubeEmbeddedsevenState extends State<YoutubeEmbeddedseven> {
  late YoutubePlayerController _controller;
  final String _videoId = 'O9-_55YRcj4';
...
class _YoutubeEmbeddedeightState extends State<YoutubeEmbeddedeight> {
  late YoutubePlayerController _controller;
  final String _videoId = '6_dgTAazOpQ';
...
class _YoutubeEmbeddednineState extends State<YoutubeEmbeddednine> {
  late YoutubePlayerController _controller;
  final String _videoId = 'NZPLzhWB_5E';
...
class _YoutubeEmbeddedtenState extends State<YoutubeEmbeddedten> {
  late YoutubePlayerController _controller;
  final String _videoId = 'jCo3VAnODEk';
  final double _startSeconds = 6;
