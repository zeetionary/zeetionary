...
// replace these: replace EnglishEntryadoration - replace speakAdoration - replace adoration - /ˌædəˈreɪʃn/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadoration extends StatelessWidget {
  EnglishEntryadoration({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdoration(String languageCode) async {
    // DOPSUM: CHANGE speakAdoration
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("adoration"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAdor25674(String languageCode) async {
    // DOPSUM: CHANGE speakAdoration
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("He gazed at her with pure adoration."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "adoration", // DOPSUM: CHANGE WORD ENTRY - Find /ˌædəˈreɪʃn/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌædəˈreɪʃn/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˌædəˈreɪʃn/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'IWj00KJ6Jow';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'VS93y0-YEhc';
