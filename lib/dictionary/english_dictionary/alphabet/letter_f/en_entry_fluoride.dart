...
class EnglishEntryfluoride extends StatefulWidget {
  const EnglishEntryfluoride({super.key});

  @override
  State<EnglishEntryfluoride> createState() => _EnglishEntryfluorideState();
}

class _EnglishEntryfluorideState extends State<EnglishEntryfluoride> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fluoride (Derived forms: fluorides)
1. A salt of hydrofluoric acid
""",
  );

  final String keyword = "fluoride";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fluoride""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Fluoride can strengthen tooth enamel.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fluoride""",
                      // alsoEnglishWord: "also: fluoride",
                      britshText: """IpaUK: /ˈflɔːraɪd/,  /ˈflʊəraɪd/""",
                      americanText: """IpaUS: /ˈflɔːraɪd/,  /ˈflʊraɪd/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مادەیەکی کیمیایی کە ددان لە پووکانەوە دەپارێزێت و زۆرجار بۆ هەویری ددان زیاد دەکرێت و هەندێک جار بۆ ئاوی خواردنەوەش"""),
                    SentencesRow(
                      englishText: """Fluoride can strengthen tooth enamel.""",
                      kurdishText: """فلۆراید دەکرێت مینای ددان بپارێزێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/vFKQ7GflRkk?t=';
const double _startSecondsend = 000000000000000000000000000183;
const String _videoIdone = 'https://youtu.be/f0gMdGrVteI?t=';
const double _startSecondsone = 000000000000000000000000000210;
const String _videoIdtwo = 'https://youtu.be/MO-OMsxToWA?t=';
const double _startSecondstwo = 00000000000000000000000000063;
const String _videoIdthree = 'https://youtu.be/UWBNcMyfiGQ?t=';
const double _startSecondsthree = 0000000000000000000000000001515;
const String _videoIdfour = 'https://youtu.be/RvFsAZpUiM0?t=';
const double _startSecondsfour = 000000000000000000000000000103;
const String _videoIdfive = 'https://youtu.be/Amy6GOcbDKA?t=';
