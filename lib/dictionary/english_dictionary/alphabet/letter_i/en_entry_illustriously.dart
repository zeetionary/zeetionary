...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '_d-G7ePTJCU';
    const double startSecondsend = 2315;
    const String videoIdone = 'LV7ZBCgAMM0';
    const double startSecondsone = 2;
    const String videoIdtwo = '2qFwvuhzse0';
    const double startSecondstwo = 1050;
    const String videoIdthree = 'up7YZPWCalo';
    const double startSecondsthree = 621;
    const String videoIdfour = 'NOoc_D2GMAc';
    const double startSecondsfour = 1485;
    const String videoIdfive = 'TClcYnrfWss';
    const double startSecondsfive = 75;
