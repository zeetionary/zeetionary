...
class EnglishEntryaccost extends StatefulWidget {
  const EnglishEntryaccost({super.key});

  @override
  State<EnglishEntryaccost> createState() => _EnglishEntryaccostState();
}

class _EnglishEntryaccostState extends State<EnglishEntryaccost> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accost""",
                      // alsoEnglishWord: "also: accost",
                      britshText: """IpaUK: /əˈkɒst/""",
                      americanText: """IpaUS: /əˈkɔːst/""",
...
١. چوون بۆ لای کەسێک و قسەکردن لەگەڵی بەشێوەیەکی بێڕێزانە"""),
                          SentencesRow(
                            ...
                            onPressedBritish: () => speaka532476("en-GB"),
                            onPressedAmerican: () => speaka532476("en-US"),
                          ),
                        ],
                      ),
                    ),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'NHo6oTKcu7o';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'WPZfIKy7LWo';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final double _startSeconds = 4177;
