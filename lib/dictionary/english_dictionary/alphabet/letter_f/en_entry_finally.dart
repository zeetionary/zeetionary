...
class EnglishEntryfinally extends StatefulWidget {
  const EnglishEntryfinally({super.key});

  @override
  State<EnglishEntryfinally> createState() => _EnglishEntryfinallyState();
}

class _EnglishEntryfinallyState extends State<EnglishEntryfinally> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: finally
1. After an unspecified period of time or an especially long delay (= eventually)
"finally the family left the house";
 
2. As the end result of a succession or process (= ultimately, in the end, at last, at long last)
"finally he had to give in";
 
3. Introducing the last item or a series (= last, lastly, in conclusion)
"finally, I'll discuss family values";
""",
  );

  final String keyword = "finally";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""finally""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The performance finally started half an hour late.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The law was finally passed in May 2019.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I finally managed to get her attention.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Are you finally going to tell me why I’m here?""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Finally, stir in the fruit and walnuts.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The plan hasn't been finally approved.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """finally""",
                      // alsoEnglishWord: "also: finally",
                      britshText: """IpaUK: /ˈfaɪnəli/""",
                      americanText: """IpaUS: /ˈfaɪnəli/""",
...
// With short examples define "finally", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """نمایشەکە لەکۆتاییدا دوای نیو کاتژمێر لە درەنگی دەستی پێکرد.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """ژممارە. (ھاوەڵکار) پێنناسە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The law was finally passed in May 2019.""",
                      kurdishText:
                          """یاساکە لە کۆتاییدا لە ئایاری ٢٠١٩ تێپەڕێندرا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە کۆتاییدا توانیم سەرنجی ڕابکێشم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئایا لە کۆتاییدا پێم دەڵێیت بۆچی لێرەم؟""",
...
const double _startSecondstwo = 0000000000000000000000000001217;
...
const double _startSecondsfour = 000000000000000000000000000961;
