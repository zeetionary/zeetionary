...
class EnglishEntrylifeless extends StatefulWidget {
  const EnglishEntrylifeless({super.key});

  @override
  State<EnglishEntrylifeless> createState() => _EnglishEntrylifelessState();
}

class _EnglishEntrylifelessState extends State<EnglishEntrylifeless> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lifeless""");
  }
