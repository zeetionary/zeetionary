...
class EnglishEntrylefthanded extends StatefulWidget {
  const EnglishEntrylefthanded({super.key});

  @override
  State<EnglishEntrylefthanded> createState() => _EnglishEntrylefthandedState();
}

class _EnglishEntrylefthandedState extends State<EnglishEntrylefthanded> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""left-handed""");
  }
