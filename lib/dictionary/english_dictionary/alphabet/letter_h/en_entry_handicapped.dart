...
class EnglishEntryhandicapped extends StatefulWidget {
  const EnglishEntryhandicapped({super.key});

  @override
  State<EnglishEntryhandicapped> createState() => _EnglishEntryhandicappedState();
}

class _EnglishEntryhandicappedState extends State<EnglishEntryhandicapped> {
  @override
  void initState() {
    super.initState();
...
1. Having restricted mental or physical functioning as a consequence of injury or illness (- disabled)
 
2. Limited by an impediment of some kind

- Noun: handicapped
1. People collectively who are crippled or otherwise physically handicapped (- disabled)
"technology to help the elderly and the handicapped";
""",
  );

  final String keyword = "handicapped";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""handicapped""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The accident left him physically handicapped.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Steven was born severely handicapped.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """handicapped""",
                      // alsoEnglishWord: "also: handicapped",
                      britshText: """IpaUK: /ˈhændikæpt/""",
                      americanText: """IpaUS: /ˈhændikæpt/""",
...
کوردی: پەککەوتە، نوقسان، سەقەت، عەیب‌دار،	دواکەوتوو، کەم‌هۆش
"""),
// With short examples define "handicapped", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) هەبوونی دۆخێکی هەمیشەیی جەستەیی یان دەروونی کە وا دەکات سەخت بێت بۆ کەسێک کە ئەو شتانە بکات کەوا کەسانی دیکە دەتوانن بیکەن"""),
                    SentencesRow(
                      englishText: """The accident left him physically handicapped.""",
                      kurdishText: """ڕووداوەکە لە ڕووی جەستەییەوە ئیفلیجی کرد.""",
                    ...
                    SentencesRow(
                      englishText: """Steven was born severely handicapped.""",
                      kurdishText: """ستیڤ بە ئیفلیجی توندەوە لەدایکبوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/OwAL5TetOdI?t=';
const double _startSecondsend = 000000000000000000000000000222;
const String _videoIdone = 'https://youtu.be/YpbZxsMDmrQ?t=';
const double _startSecondsone = 0000000000000000000000000001045;
const String _videoIdtwo = 'https://youtu.be/CiRBQ3frG6U?t=';
const double _startSecondstwo = 000000000000000000000000000557;
const String _videoIdthree = 'https://youtu.be/DZTTdYCBqqg?t=';
const double _startSecondsthree = 000000000000000000000000000504;
const String _videoIdfour = 'https://youtu.be/IRFKFexoBdc';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/lESBZWZ4lpI?t=';
