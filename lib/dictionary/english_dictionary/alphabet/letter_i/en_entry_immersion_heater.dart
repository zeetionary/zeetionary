...
class EnglishEntryimmersionheater extends StatefulWidget {
  const EnglishEntryimmersionheater({super.key});

  @override
  State<EnglishEntryimmersionheater> createState() =>
      _EnglishEntryimmersionheaterState();
}

class _EnglishEntryimmersionheaterState
    extends State<EnglishEntryimmersionheater> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""immersion heater""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He replaced the old immersion heater with a new one.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/t2c6lduDuIA?t=';
    const double startSecondsend = 00000000000000000000000000069;
    const String videoIdone = 'https://youtu.be/nPutQsxBoAo?t=';
    const double startSecondsone = 000000000000000000000000000604;
    const String videoIdtwo = 'https://youtu.be/mZ2BUefly-k?t=';
    const double startSecondstwo = 00000000000000000000000000073;
    const String videoIdthree = 'https://youtu.be/mZ2MT0SKVZY?t=';
    const double startSecondsthree = 0000000000000000000000000005;
    const String videoIdfour = 'https://youtu.be/SIuCB7HDi2w?t=';
    const double startSecondsfour = 0000000000000000000000000002406;
    const String videoIdfive = 'https://youtu.be/5WdLV3YRMvw?t=';
    const double startSecondsfive = 000000000000000000000000000513;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: immersion heater",
                      britshText: """IpaUK: /ɪˈmɜːʃn hiːtə(r)/""",
                      americanText: """IpaUS: /ɪˈmɜːrʒn hiːtər/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئامێرێک کە ئاوی گەرم بۆ ماڵێک دابین دەکات بەوەی لە تانکییەکدا گەرمی دەکات"""),
                    SentencesRow(
                      englishText:
                          """He replaced the old immersion heater with a new one.""",
                      kurdishText: """گیزەرەکەی بە دانەیەکی تازە گۆڕی.""",
