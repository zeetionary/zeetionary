...
class EnglishEntrygenital extends StatefulWidget {
  const EnglishEntrygenital({super.key});

  @override
  State<EnglishEntrygenital> createState() => _EnglishEntrygenitalState();
}

class _EnglishEntrygenitalState extends State<EnglishEntrygenital> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""genital""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The pain is centered mainly in the genital region.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """genital""",
                      // alsoEnglishWord: "also: genital",
                      britshText: """IpaUK: /ˈdʒenɪtl/""",
                      americanText: """IpaUS: /ˈdʒenɪtl/""",
...
// With short examples define "genital", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The pain is centered mainly in the genital region.""",
                      kurdishText:
                          """ئازارەکە بە زۆری کەوتووەتە ناوچەی ئەندامی زاوزێ.""",
...
const String _videoIdone = 'https://youtu.be/092PIJKKgFo?t=';
const double _startSecondsone = 000000000000000000000000000125;
const String _videoIdtwo = 'https://youtu.be/VlbYUIMjSOk?t=';
const double _startSecondstwo = 000000000000000000000000000323;
const String _videoIdthree = 'https://youtu.be/jJA3dYwIB3s?t=';
const double _startSecondsthree = 00000000000000000000000000029;
const String _videoIdfour = 'https://youtu.be/YzohP2AhiNw?t=';
const double _startSecondsfour = 000000000000000000000000000219;
const String _videoIdfive = 'https://youtu.be/X25WPtneYwA?t=';
