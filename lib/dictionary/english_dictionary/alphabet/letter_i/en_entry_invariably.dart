...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'j4kI2h3iotA';
    const double startSecondsend = 2488;
    const String videoIdone = 'wJa5Ch0O4BI';
    const double startSecondsone = 1546;
    const String videoIdtwo = 'TpY7B00Pqf8';
    const double startSecondstwo = 560;
    const String videoIdthree = 'Solb9uA-tgQ';
    const double startSecondsthree = 11037;
    const String videoIdfour = 'y7voToyTmOE';
    const double startSecondsfour = 745;
    const String videoIdfive = '2OQu9q70YkE';
    const double startSecondsfive = 61;
