...
class EnglishEntrydeathpenalty extends StatefulWidget {
  const EnglishEntrydeathpenalty({super.key});

  @override
  State<EnglishEntrydeathpenalty> createState() =>
      _EnglishEntrydeathpenaltyState();
}

class _EnglishEntrydeathpenaltyState extends State<EnglishEntrydeathpenalty> {
  @override
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "the death penalty");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: the death penalty");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /ðə ˈdeθ penəlti/");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakthedeathpenalty(String languageCode) async {
  ...
  Widget build(BuildContext context) {
    return CustomIconButtonBritish(
      onPressed: () => speakthedeathpenalty("en-GB"),
    );
  }
}
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /ðə ˈdeθ penəlti/");
  }
}
...
class TTSUS extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomIconButtonAmerican(
      onPressed: () => speakthedeathpenalty("en-US"),
    );
  }
}
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakthedeathpenaltys1(String languageCode) async {
    // DOPSUM: CHANGE speakthedeathpenalty
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
...
کوردی: سزای لەداردان یا مەرگ یا مردن، لەسێدارەدان
"""),
          const DefinitionKurdish(
              text:
                  "١. (ناو) سزای مەرگ کە لە هەندێک وڵاتدا سزایە بۆ تاوانە قورسەکان"),
          Row(
            children: [
              const Expanded(
                child: Column(
...
// Create an instance of EnglishMeaningConst with the desired text
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: the death penalty (Derived forms: death penalties)
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/fC0eoM5Jwg4?t=',
    startSeconds: 130,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
