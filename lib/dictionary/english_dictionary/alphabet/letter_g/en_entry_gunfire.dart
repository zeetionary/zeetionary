...
class EnglishEntrygunfire extends StatefulWidget {
  const EnglishEntrygunfire({super.key});

  @override
  State<EnglishEntrygunfire> createState() => _EnglishEntrygunfireState();
}

class _EnglishEntrygunfireState extends State<EnglishEntrygunfire> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gunfire (Derived forms: gunfires)
1. The act of shooting a gun (- gunshot)
"the gunfire endangered innocent bystanders";
""",
  );

  final String keyword = "gunfire";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gunfire""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I could hear gunfire.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gunfire""",
                      // alsoEnglishWord: "also: gunfire",
                      britshText: """IpaUK: /ˈɡʌnfaɪə(r)/""",
                      americanText: """IpaUS: /ˈɡʌnfaɪər/""",
...
// With short examples define "gunfire", please follow LX instructions
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I could hear gunfire.""",
                      kurdishText: """گوێم لە تەقەی بەردەوام بوو.""",
