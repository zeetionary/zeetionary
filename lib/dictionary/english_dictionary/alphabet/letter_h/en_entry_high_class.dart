...
class EnglishEntryhighclass extends StatefulWidget {
  const EnglishEntryhighclass({super.key});

  @override
  State<EnglishEntryhighclass> createState() => _EnglishEntryhighclassState();
}

class _EnglishEntryhighclassState extends State<EnglishEntryhighclass> {
  @override
  void initState() {
    super.initState();
...
1. Pretentiously elegant (- high-toned [N. Amer])
"a high-class restaurant";
""",
  );

  final String keyword = "high-class";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""high-class""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The musicians gave a high-class performance.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """He never mentioned that he came from a high-class background.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """high-class""",
                      // alsoEnglishWord: "also: high-class",
                      britshText: """IpaUK: /ˌhaɪ ˈklɑːs/""",
                      americanText: """IpaUS: /ˌhaɪ ˈklæs/""",
...
کوردی: 
"""),
// With short examples define "high-class", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) نایاب"""),
                    SentencesRow(
                      englishText:
                          """The musicians gave a high-class performance.""",
                      kurdishText:
                          """میوزیکژەنەکە نمایشێکی نایابی ئەنجام دا.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) پەیوەندیدار بە چینی باڵا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He never mentioned that he came from a high-class background.""",
                      kurdishText:
                          """هەرگیز باسی ئەوەی نەکرد کە سەر بە خێزانێکی چینی باڵایە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/4K-_KbbRiEE?t=';
const double _startSecondsend = 000000000000000000000000000382;
const String _videoIdone = 'https://youtu.be/ZSiKL_zDsgA?t=';
const double _startSecondsone = 000000000000000000000000000431;
const String _videoIdtwo = 'https://youtu.be/TdEyQiDDcH4?t=';
const double _startSecondstwo = 000000000000000000000000000107;
const String _videoIdthree = 'https://youtu.be/sgjhpCj_yRI?t=';
const double _startSecondsthree = 000000000000000000000000000220;
const String _videoIdfour = 'https://youtu.be/bzVEnC5LZpc?t=';
const double _startSecondsfour = 000000000000000000000000000597;
const String _videoIdfive = 'https://youtu.be/E_-1OPcQZ0E?t=';
const double _startSecondsfive = 000000000000000000000000000604;
