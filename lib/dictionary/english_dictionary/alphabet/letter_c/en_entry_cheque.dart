...
class EnglishEntrycheque extends StatelessWidget {
  ...
  Future<void> speakcheques1(String languageCode) async {
    ...
    await flutterTts.speak(
        "speakcheques111111111111111111111111111111111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcheques3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcheques300"); // DOPSUM: CHANGE TEXT
  }
                                ...
                                child: Column(
                                  children: [
                                    ExampleSentenceEnglish(
                                        text:
                                            "speakcheques111111111111111111111111111111111"),
