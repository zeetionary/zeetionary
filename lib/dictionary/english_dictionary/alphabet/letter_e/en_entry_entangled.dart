...
class EnglishEntryentangled extends StatefulWidget {
  const EnglishEntryentangled({super.key});

  @override
  State<EnglishEntryentangled> createState() => _EnglishEntryentangledState();
}

class _EnglishEntryentangledState extends State<EnglishEntryentangled> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""entangled""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """entangled""",
                      // alsoEnglishWord: "also: entangled",
                      britshText: """IpaUK: /ɪnˈtæŋɡlɪd//""",
                      americanText: """IpaUS: /ɪnˈtæŋɡlɪd//""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "entangled";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The bird was entangled in the netting.""");
  }
...
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) گیراو یان ئازڵکاو لە شتێک"""),
          SentencesRow(
            englishText: """The bird was entangled in the netting.""",
            kurdishText: """باڵندەکە لە تۆڕەکە ئازڵکاو بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: entangled
1. Deeply involved especially in something complicated (= embroiled)
...
const String _videoIdend = 'https://youtu.be/wdP_UDSsuro?t=';
const double _startSecondsend = 1089;
const String _videoIdone = 'https://youtu.be/US7fEkBsy4A?t=';
const double _startSecondsone = 155;
const String _videoIdtwo = 'https://youtu.be/BFrBr8oUVXU?t=';
const double _startSecondstwo = 3417;
const String _videoIdthree = 'https://youtu.be/vgYQglmYU-8?t=';
const double _startSecondsthree = 655;
const String _videoIdfour = 'https://youtu.be/BLqk7uaENAY?t=';
const double _startSecondsfour = 730;
const String _videoIdfive = 'https://youtu.be/0ui9ovrQuKE?t=';
const double _startSecondsfive = 294;
const String _videoIdsix = 'https://youtu.be/0ui9ovrQuKE?t=';
const double _startSecondssix = 294;
