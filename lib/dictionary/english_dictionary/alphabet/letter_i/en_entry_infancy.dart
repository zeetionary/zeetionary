...
class EnglishEntryinfancy extends StatefulWidget {
  const EnglishEntryinfancy({super.key});

  @override
  State<EnglishEntryinfancy> createState() => _EnglishEntryinfancyState();
}

class _EnglishEntryinfancyState extends State<EnglishEntryinfancy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: infancy (Derived forms: infancies)
1. The early stage of growth or development (- babyhood, early childhood)
 
2. The earliest state of immaturity (- babyhood)
""",
  );

  final String keyword = "infancy";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infancy""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was ill many times throughout his infancy.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The vaccination is given in early infancy.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The new company is still in its infancy.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/ysTPxUZnZaU?t=';
    const double startSecondsend = 000000000000000000000000000443;
    const String videoIdone = 'https://youtu.be/JTB5T5aldNo?t=';
    const double startSecondsone = 000000000000000000000000000651;
    const String videoIdtwo = 'https://youtu.be/3Pdamwkm7tE?t=';
    const double startSecondstwo = 00000000000000000000000000071;
    const String videoIdthree = 'https://youtu.be/fABaF50GA1Q';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/Gjo1hlIey9g?t=';
    const double startSecondsfour = 000000000000000000000000000597;
    const String videoIdfive = 'https://youtu.be/u6kc7rEQXpI?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """infancy""",
                      // alsoEnglishWord: "also: infancy",
                      britshText: """IpaUK: /ˈɪnfənsi/""",
                      americanText: """IpaUS: /ˈɪnfənsi/""",
...
کوردی: مناڵی، ساوایی، زارۆکی، کۆرپە،	سەردەمی مناڵی،	قۆناخی هەڵدان یان پەرەسەندن، سەروبەند یان سەردەمی دەس‌پێکردن، قۆناخی سەرەتا،	(ماف) سەغیری، کەم‌تەمەنی
"""),
// With short examples define "infancy", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەو کاتەی کە منداڵێک ساوایە و زۆر بچووکە"""),
                    SentencesRow(
                      englishText:
                          """Deaths during infancy have fallen dramatically in the last hundred years.""",
                      kurdishText:
                          """مردن لە ماوەی کۆرپەیی بە ئاستێکی زۆر دابەزیوە لە ماوەی سەد ساڵی ڕابردوودا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆر جاران نەخۆش بوو لە ماوەی کۆرپەلەییدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کوتانی ڤاکسینەکە لە سەرەتای ساوایی دەدرێت.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) گەشەی سەرەتای شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """This was at a time when the cinema was still in its infancy.""",
                      kurdishText:
                          """ئەمە لە کاتێک بوو کە سینەما هێشتا لە سەرەتای بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کۆمپانیا تازەکە هێشتا لە ساواییدایە.""",
