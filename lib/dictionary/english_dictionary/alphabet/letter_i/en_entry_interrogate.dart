...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '9afhwb6rIZw';
    const double startSecondsend = 0;
    const String videoIdone = 'THIGSnMP3io';
    const double startSecondsone = 542;
    const String videoIdtwo = 'vg7qbp_KIcA';
    const double startSecondstwo = 12;
    const String videoIdthree = 'fBTjbGfHx0s';
    const double startSecondsthree = 441;
    const String videoIdfour = 'AqqaYs7LjlM';
    const double startSecondsfour = 745;
    const String videoIdfive = 'Jt5WpKRPIlE';
