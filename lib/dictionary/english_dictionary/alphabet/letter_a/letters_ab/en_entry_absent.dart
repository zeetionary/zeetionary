...
class EnglishEntryabsent extends StatefulWidget {
  const EnglishEntryabsent({super.key});

  @override
  State<EnglishEntryabsent> createState() => _EnglishEntryabsentState();
}

class _EnglishEntryabsentState extends State<EnglishEntryabsent> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """absent""",
                      // alsoEnglishWord: "also: absent",
                      britshText: """IpaUK: /ˈæbsənt/""",
                      americanText: """IpaUS: /ˈæbsənt/""",
