...
class EnglishEntryhusk extends StatefulWidget {
  const EnglishEntryhusk({super.key});

  @override
  State<EnglishEntryhusk> createState() => _EnglishEntryhuskState();
}

class _EnglishEntryhuskState extends State<EnglishEntryhusk> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '8xe8Um-p4xA';
    const double startSecondsend = 221;
    const String videoIdone = 'KhBxCx11eck';
    const double startSecondsone = 1563;
    const String videoIdtwo = '0UABTaB-_i8';
    const double startSecondstwo = 318;
    const String videoIdthree = 'Jl0IDXkYKbk';
    const double startSecondsthree = 171;
    const String videoIdfour = 'meBd1GHC2yg';
    const double startSecondsfour = 112;
    const String videoIdfive = 'PhQksV8fbKw';
    const double startSecondsfive = 2147;
