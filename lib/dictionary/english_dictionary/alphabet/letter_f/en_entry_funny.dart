...
class EnglishEntryfunny extends StatefulWidget {
  const EnglishEntryfunny({super.key});

  @override
  State<EnglishEntryfunny> createState() => _EnglishEntryfunnyState();
}

class _EnglishEntryfunnyState extends State<EnglishEntryfunny> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: funny (Derived forms: funnier, funniest)
1. Arousing or provoking laughter (- amusing, comic, comical, laughable, mirthful, risible, rib-tickling [informal])
"funny stories that made everybody laugh"; "a very funny writer";
 
2. Beyond or deviating from the usual or expected (- curious, odd, peculiar, queer, rum [Brit, informal], rummy [Brit, archaic, informal], singular)
"her speech has a funny twang"; "they have some funny ideas about war";
 
3. Of questionable motive; of doubtful legality, value, truth, honesty, etc. (- fishy [informal], shady [informal], suspect, suspicious, dodgy [Brit, informal])
"up to some funny business";
 
4. Experiencing odd bodily sensations
"told the doctor about the funny sensations in her chest"

Noun: funny (Derived forms: funnies)
1. An account of an amusing incident (usually with a punch line) (- funny story, good story, funny remark)
"she told a funny story"; "she made a funny"; "she told a funny remark";
""",
  );

  final String keyword = "funny";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He was a very funny guy as well as a kind person.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The movie is full of funny moments.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""That's the funniest thing I've ever heard.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I found the play funny and moving.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""A funny thing happened to me today.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""That's funny—he was here a moment ago and now he's gone.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The engine's making a very funny noise.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I suspect there may be something funny going on.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Don't you get funny with me!""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I feel a bit funny today—I don't think I'll go to work.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""That Dave's a funny chap, isn't he?""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""My computer keeps going funny.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """funny""",
                      // alsoEnglishWord: "also: funny",
                      britshText: """IpaUK: /ˈfʌni/""",
                      americanText: """IpaUS: /ˈfʌni/""",
...
// With short examples define "funny", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پیاوێکی زۆر خۆش و هەروەها کەسێکی میهرەبان بوو.""",
                    ...
                    SentencesRow(
                      englishText: """The movie is full of funny moments.""",
                      kurdishText: """فیلمەکە پڕ لە ساتی پێکەنیناوییە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەوە پێکەنیناویترین شتە کە هەرگیز بیستبێتم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I found the play funny and moving.""",
                      kurdishText: """شانۆکەم بە پێکەنیناوی و کاریگەر بینی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I was really embarrassed, but then I saw the funny side of it.""",
                      kurdishText:
                          """بە ڕاستی شەرمەزار بووم، بەڵام دواتر لایەنە پێکەنیناوییەکەیم بینی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەمڕۆ شتێکی نامۆم بەسەر هات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەوە نامۆیە ـ ساتێک پێش ئێستا لەوێ بوو و ئێستا ڕۆشتووە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بزوێنەرەکە دەنگێکی زۆر نامۆ دەردەکات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵناو) ئەگەری هەیە یان وادیارە کە نایاسایی، هەڵە، یان فێڵبازانە بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I suspect there may be something funny going on.""",
                      kurdishText: """گومان دەکەم شتێکی هەڵە لە ئارادا بێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """If there has been any funny business, we'll soon find out.""",
                      kurdishText:
                          """ئەگەر هەر کارێکی نایاسایی لە ئارادا بێت، زوو دەیزانین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەمڕۆ کەمێک هەست بە نەخۆشی دەکەم ـ پێم وانییە بچمە سەر کار.""",
...
const String _videoIdone = 'https://youtu.be/_spuxXnul0U?t=';
const double _startSecondsone = 000000000000000000000000000246;
const String _videoIdtwo = 'https://youtu.be/_Z0ZQT0FttM?t=';
const double _startSecondstwo = 0000000000000000000000000004828;
const String _videoIdthree = 'https://youtu.be/4itx6mXEJ6c?t=';
const double _startSecondsthree = 000000000000000000000000000694;
const String _videoIdfour = 'https://youtu.be/MPS2fwRMFgM?t=';
const double _startSecondsfour = 00000000000000000000000000087;
const String _videoIdfive = 'https://youtu.be/_wNsZEqpKUA?t=';
