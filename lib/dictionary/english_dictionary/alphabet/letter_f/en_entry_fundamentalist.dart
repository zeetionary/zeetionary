...
class EnglishEntryfundamentalist extends StatefulWidget {
  const EnglishEntryfundamentalist({super.key});

  @override
  State<EnglishEntryfundamentalist> createState() =>
      _EnglishEntryfundamentalistState();
}

class _EnglishEntryfundamentalistState
    extends State<EnglishEntryfundamentalist> {
  @override
  void initState() {
    super.initState();
...
1. (theology) of or relating to or characteristic of Protestant fundamentalism or its adherents (- fundamentalistic)
 
2. Of or relating to or tending toward ideological fundamentalism (- fundamentalistic)

- Noun: fundamentalist (Derived forms: fundamentalists)
1. An adherent of fundamentalist principles (- fundie)
 
2. A supporter of fundamentalism (- fundie)
""",
  );

  final String keyword = "fundamentalist";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fundamentalist""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fundamentalist""",
                      // alsoEnglishWord: "also: fundamentalist",
                      britshText: """IpaUK: /ˌfʌndəˈmentəlɪst/""",
                      americanText: """IpaUS: /ˌfʌndəˈmentəlɪst/""",
...
// With short examples define "fundamentalist", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The organization had been taken over by religious fundamentalists.""",
                      kurdishText:
                          """دامەزراوەکە کەوتووەتە دەستی بنچینەخوازە ئایینییەکان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She said that fundamentalists constitute about 10 percent of her country.""",
                      kurdishText:
                          """گوتی بنچینەخوازان نزیکەی ١٠ لە سەدی وڵاتەکەی پێکدەهێنن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/EmT0i0xG6zg?t=';
const double _startSecondsend = 0000000000000000000000000003418;
const String _videoIdone = 'https://youtu.be/jLIUkk6Esr0?t=';
const double _startSecondsone = 00000000000000000000000000033;
const String _videoIdtwo = 'https://youtu.be/TWVbZ0WQ3s8?t=';
const double _startSecondstwo = 000000000000000000000000000255;
const String _videoIdthree = 'https://youtu.be/_wIOqHSsV9c?t=';
const double _startSecondsthree = 0000000000000000000000000001414;
const String _videoIdfour = 'https://youtu.be/9zNTpey21Y0?t=';
const double _startSecondsfour = 00000000000000000000000000052;
const String _videoIdfive = 'https://youtu.be/vVPk5lRHQGc?t=';
