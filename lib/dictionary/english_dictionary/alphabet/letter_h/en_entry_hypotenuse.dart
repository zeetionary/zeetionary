...
class EnglishEntryhypotenuse extends StatefulWidget {
  const EnglishEntryhypotenuse({super.key});

  @override
  State<EnglishEntryhypotenuse> createState() => _EnglishEntryhypotenuseState();
}

class _EnglishEntryhypotenuseState extends State<EnglishEntryhypotenuse> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hypotenuse""");
  }
