...
class EnglishEntryactor extends StatefulWidget {
  const EnglishEntryactor({super.key});

  @override
  State<EnglishEntryactor> createState() => _EnglishEntryactorState();
}

class _EnglishEntryactorState extends State<EnglishEntryactor> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakacto459(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She is one of the country’s leading actors.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """actor""",
                      // alsoEnglishWord: "also: actor",
                      britshText: """IpaUK: /ˈæktə(r)/""",
                      americanText: """IpaUS: /ˈæktər/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '2VggEmXPnGw';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'zg3bdspvIiQ';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'h4uA605ryD0';
  final double _startSeconds = 10;
