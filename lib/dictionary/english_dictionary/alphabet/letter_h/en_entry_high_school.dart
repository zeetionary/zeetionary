...
class EnglishEntryhighschool extends StatefulWidget {
  const EnglishEntryhighschool({super.key});

  @override
  State<EnglishEntryhighschool> createState() => _EnglishEntryhighschoolState();
}

class _EnglishEntryhighschoolState extends State<EnglishEntryhighschool> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: highschool (Derived forms: high schools, highschools)
1. A public secondary school usually including grades 9 through 12 (- senior high school [N. Amer], senior high [N. Amer], high [N. Amer, informal], high school)
"he goes to the neighbourhood highschool";
""",
  );

  final String keyword = "high school";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""high school""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I went to high school in Ohio.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He dropped out of high school when he was seventeen.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Janine dated many boys during high school.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We knew each other back in high school.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """high school""",
                      // alsoEnglishWord: "also: high school",
                      britshText: """IpaUK: /ˈhaɪ skuːl/""",
                      americanText: """IpaUS: /ˈhaɪ skuːl/""",
...
// With short examples define "high school", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """I went to high school in Ohio.""",
                      kurdishText: """چوومە خوێندنگای ئامادەیی لە ئۆهایۆ.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە قوتابخانەی ئامادەیی دەرچوو کە ١٧ ساڵان بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """جنین پەیوەندی لەگەڵ زۆر کوڕ بوو لە خوێندنگای ئامادەیی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە ئامادەیی یەکدیمان دەناسی.""",
...
const String _videoIdone = 'https://youtu.be/VyEf4EBXe8o?t=';
const double _startSecondsone = 000000000000000000000000000273;
const String _videoIdtwo = 'https://youtu.be/-CJ4eUhE3Lw?t=';
const double _startSecondstwo = 000000000000000000000000000195;
const String _videoIdthree = 'https://youtu.be/3U9P4-ac0Lc?t=';
const double _startSecondsthree = 000000000000000000000000000255;
const String _videoIdfour = 'https://youtu.be/VUo6NKm7peE?t=';
const double _startSecondsfour = 000000000000000000000000000601;
const String _videoIdfive = 'https://youtu.be/92Yb6vY8vUY?t=';
