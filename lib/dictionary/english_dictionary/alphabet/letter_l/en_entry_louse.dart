...
class EnglishEntrylouse extends StatefulWidget {
  const EnglishEntrylouse({super.key});

  @override
  State<EnglishEntrylouse> createState() => _EnglishEntrylouseState();
}

class _EnglishEntrylouseState extends State<EnglishEntrylouse> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylouse louse
WORD_WEB louse louse louse
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "louse";
...
کوردی: 
"""),
// With short examples define "louse", please follow LX instructions
