...
class EnglishEntrylyric extends StatefulWidget {
  const EnglishEntrylyric({super.key});

  @override
  State<EnglishEntrylyric> createState() => _EnglishEntrylyricState();
}

class _EnglishEntrylyricState extends State<EnglishEntrylyric> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylyric lyric
WORD_WEB lyric lyric lyric
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lyric";
...
کوردی: 
"""),
// With short examples define "lyric", please follow LX instructions
