...
class EnglishEntryfaraway extends StatefulWidget {
  const EnglishEntryfaraway({super.key});

  @override
  State<EnglishEntryfaraway> createState() => _EnglishEntryfarawayState();
}

class _EnglishEntryfarawayState extends State<EnglishEntryfaraway> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""faraway""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """faraway""",
                      // alsoEnglishWord: "also: faraway",
                      britshText: """IpaUK: /ˈfɑːrəweɪ/""",
                      americanText: """IpaUS: /ˈfɑːrəweɪ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They travelled to faraway places.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """Few Americans care about an event that took place in a faraway land over fifty years ago""");
  }
...
کوردی: دوور، دوورەدەس، چەپەک
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) کۆ زۆر دوورە"""),
          SentencesRow(
            englishText: """They travelled to faraway places.""",
            kurdishText: """گەشتیان دەکرد بۆ شوێنی دوورەدەست.""",
          ...
          SentencesRow(
            englishText:
                """Few Americans care about an event that took place in a faraway land over fifty years ago""",
            kurdishText:
                """کەم ئەمریکی گرنگی دەدەن بە ڕووداوێک کە لە شوێنێکی دوور سەروو پەنجا ساڵ پێش ڕوویدا.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ھاوەڵناو) دەربڕینیک کە ئەوە پیشان دەدات کە بیرکردنەوەت ڕۆشتووە و لەم ساتەی ئێستادا ناژیت"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """There was a faraway look in her eyes.""",
            kurdishText: """نیگایەکی دوور لە چاوانیدا بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: faraway
1. Very far away in space or time (= far-off)
"faraway mountains"; "the faraway future";
...
const String _videoIdend = 'https://youtu.be/XB2W_kw62u8?t=';
const double _startSecondsend = 000000000000000000000000000896;
const String _videoIdone = 'https://youtu.be/WesrJBgEmyw?t=';
const double _startSecondsone = 000000000000000000000000000637;
const String _videoIdtwo = 'https://youtu.be/hfMsvYROjpM?t=';
const double _startSecondstwo = 0000000000000000000000000001000;
const String _videoIdthree = 'https://youtu.be/1RHY9-35KwA?t=';
const double _startSecondsthree = 000000000000000000000000000533;
const String _videoIdfour = 'https://youtu.be/ixYVFZnNl6s?t=';
const double _startSecondsfour = 000000000000000000000000000247;
const String _videoIdfive = 'https://youtu.be/RmBSPetp4mk?t=';
const double _startSecondsfive = 000000000000000000000000000396;
