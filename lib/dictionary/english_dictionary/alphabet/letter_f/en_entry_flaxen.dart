...
class EnglishEntryflaxen extends StatefulWidget {
  const EnglishEntryflaxen({super.key});

  @override
  State<EnglishEntryflaxen> createState() => _EnglishEntryflaxenState();
}

class _EnglishEntryflaxenState extends State<EnglishEntryflaxen> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flaxen
1. Of hair colour; pale yellowish to yellowish brown (= sandy)
"flaxen locks";
""",
  );

  final String keyword = "flaxen";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her flaxen braids were long and thick.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flaxen""",
                      // alsoEnglishWord: "also: flaxen",
                      britshText: """IpaUK: /ˈflæksn/""",
                      americanText: """IpaUS: /ˈflæksn/""",
...
// کوردی: زەردی کاڵ، قژکاڵ
// """),
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) زەردی کاڵ، قژکاڵ"""),
                    SentencesRow(
                      englishText: """Her flaxen braids were long and thick.""",
                      kurdishText:
                          """پەلکە زەردە کاڵەکانی درێژ و ئەستوور بوون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/1PCHy2TJBbc?t=';
const double _startSecondsend = 000000000000000000000000000176;
const String _videoIdone = 'https://youtu.be/l-y98OYaXu8?t=';
const double _startSecondsone = 0000000000000000000000000001332;
const String _videoIdtwo = 'https://youtu.be/AHEAGY1F0sw?t=';
const double _startSecondstwo = 000000000000000000000000000606;
const String _videoIdthree = 'https://youtu.be/vi_-GCcEFRg?t=';
const double _startSecondsthree = 000000000000000000000000000407;
const String _videoIdfour = 'https://youtu.be/fH_NXsmGUdU?t=';
const double _startSecondsfour = 0000000000000000000000000001176;
const String _videoIdfive = 'https://youtu.be/xOM_ohW6FQc?t=';
const double _startSecondsfive = 0000000000000000000000000001698;
