...
class EnglishEntryenroute extends StatefulWidget {
  const EnglishEntryenroute({super.key});

  @override
  State<EnglishEntryenroute> createState() => _EnglishEntryenrouteState();
}

class _EnglishEntryenrouteState extends State<EnglishEntryenroute> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""en route""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """en route""",
                      // alsoEnglishWord: "also: en route",
                      britshText: """IpaUK: /ˌɒ̃ ˈruːt/,  /ˌɒn ˈruːt/""",
                      americanText: """IpaUS: /ˌɑ̃ː ˈruːt/,  /ˌɑːn ˈruːt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We stopped for a picnic en route.""");
  }
...
کوردی: سەرەڕێ، لەسەرڕێ، لە ڕێگا
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵکار) لەسەر ڕێگا بۆ سوێنێک"""),
          SentencesRow(
            englishText: """We stopped for a picnic en route.""",
            kurdishText: """لەسەر ڕێگا بۆ سەفرەیەک وەستاین.""",
          ...
          SentencesRow(
            ...
            kurdishText: """پاسەکە لەسەر ڕێگای بۆستن بۆ نیویۆرک تێکچوو.""",
...
const String _videoIdend = 'https://youtu.be/bPwnDyW26gk?t=';
const double _startSecondsend = 197;
const String _videoIdone = 'https://youtu.be/XAtzfJcuHjY?t=';
const double _startSecondsone = 309;
const String _videoIdtwo = 'https://youtu.be/ugYPoWShl6k?t=';
const double _startSecondstwo = 683;
const String _videoIdthree = 'https://youtu.be/CaOwcYLGTMo?t=';
const double _startSecondsthree = 443;
const String _videoIdfour = 'https://youtu.be/x94BqWK1Ks4?t=';
const double _startSecondsfour = 800;
const String _videoIdfive = 'https://youtu.be/3E17wr77ffM?t=';
const double _startSecondsfive = 896;
const String _videoIdsix = 'https://youtu.be/cXOATB1v3jM?t=';
const double _startSecondssix = 225;
