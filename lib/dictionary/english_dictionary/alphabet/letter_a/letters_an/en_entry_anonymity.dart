...
// replace these: replace EnglishEntryanonymity - replace speakAnonymity - replace anonymity - /ˌænəˈnɪməti/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryanonymity extends StatelessWidget {
  // blank divider
  EnglishEntryanonymity({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAnonymity(String languageCode) async {
    // DOPSUM: CHANGE speakAnonymity
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "anonymity"), // Find /ˌænəˈnɪməti/
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /ˌænəˈnɪməti/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                            CustomIconButtonBritish(
                              onPressed: () => speakAnonymity("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /ˌænəˈnɪməti/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                            CustomIconButtonAmerican(
                              onPressed: () => speakAnonymity("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "YvBwYHwrgdQ";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "Z0XRDb1Vj2I";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "Uud2J8nAG-Y";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "acc7i38wa1s";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "rratBYNYpqA";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "g2AymqfV3nE";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "w4xIyGs-3wc";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "Jhk-NSf7_qw";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "zQZAIhP0H2A";
