...
class EnglishEntryabsolutemajority extends StatefulWidget {
  const EnglishEntryabsolutemajority({super.key});

  @override
  State<EnglishEntryabsolutemajority> createState() =>
      _EnglishEntryabsolutemajorityState();
}

class _EnglishEntryabsolutemajorityState
    extends State<EnglishEntryabsolutemajority> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "absolute majority";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""absolute majority""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: absolute majority",
                      britshText: """IpaUK: /ˌæbsəluːt məˈdʒɒrəti/""",
                      americanText: """IpaUS: /ˌæbsəluːt məˈdʒɔːrəti/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'OTDY--Qb72E';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'KYVw9lPiCHQ';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'ozj-ZZMXP0c';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'WH6S0EukOG4';
