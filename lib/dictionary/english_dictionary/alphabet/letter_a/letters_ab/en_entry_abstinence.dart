...
// replace these: EnglishEntryabstinence - speakAbstinence - abstinence - /ˈæbstɪnəns/

enum TtsState { playing }

class EnglishEntryabstinence extends StatelessWidget {
  EnglishEntryabstinence({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAbstinence(String languageCode) async {
    // DOPSUM: CHANGE speakAbstinence
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈæbstɪnəns/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'HWB3VhIPWrU';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'yRA0KMCEP2o';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'F1w80BW8sjc';
