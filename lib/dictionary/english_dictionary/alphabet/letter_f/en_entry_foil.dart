...
// With short examples define "foil", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ماسییەکە بە هێواشی بە پەڕەکانزا داپۆشە و با بۆ ٣٠ خولەک ببرژێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Customs officials foiled an attempt to smuggle the paintings out of the country.""",
                      kurdishText:
                          """بەرپرسانی گومرک هەوڵێلیان شکست پێهێنا لەوەی تابلۆکان ببرێنە دەرەوەی وڵاتەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """They were foiled in their attempt to smuggle the paintings.""",
                      kurdishText:
                          """ڕێگریان لێکرا لە هەوڵدانیان بۆ بردنە دەرەوەی تابلۆکان.""",
...
const double _startSecondsend = 000000000000000000000000000682;
const String _videoIdone = 'https://youtu.be/qWAagS_MANg?t=';
const double _startSecondsone = 0000000000000000000000000001454;
const String _videoIdtwo = 'https://youtu.be/roCX0AfBseQ?t=';
const double _startSecondstwo = 00000000000000000000000000074;
const String _videoIdthree = 'https://youtu.be/Mx8JkGHaGUI?t=';
...
const double _startSecondsfive = 0000000000000000000000000001142;
