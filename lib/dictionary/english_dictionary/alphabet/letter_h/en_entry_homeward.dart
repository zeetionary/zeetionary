...
class EnglishEntryhomeward extends StatefulWidget {
  const EnglishEntryhomeward({super.key});

  @override
  State<EnglishEntryhomeward> createState() => _EnglishEntryhomewardState();
}

class _EnglishEntryhomewardState extends State<EnglishEntryhomeward> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""homeward""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We were homeward bound at last.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We drove homewards in silence.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/llxPiLsRoGE?t=';
    const double startSecondsend = 000000000000000000000000000210;
    const String videoIdone = 'https://youtu.be/ncMoQs_HNmY?t=';
    const double startSecondsone = 000000000000000000000000000157;
    const String videoIdtwo = 'https://youtu.be/bC7ckGiCd3I?t=';
    const double startSecondstwo = 000000000000000000000000000989;
    const String videoIdthree = 'https://youtu.be/ypBlLvbNero?t=';
    const double startSecondsthree = 000000000000000000000000000466;
    const String videoIdfour = 'https://youtu.be/qMNx9-AjrXM?t=';
    const double startSecondsfour = 000000000000000000000000000664;
    const String videoIdfive = 'https://youtu.be/g8Bc1TA6pbM?t=';
    const double startSecondsfive = 0000000000000000000000000001423;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homeward""",
                      // alsoEnglishWord: "also: homeward",
                      britshText: """IpaUK: /ˈhəʊmwəd/""",
                      americanText: """IpaUS: /ˈhəʊmwərd/""",
...
// With short examples define "homeward", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """We were homeward bound at last.""",
                      kurdishText: """لە کۆتاییدا ڕووەو ماڵەوە بووین.""",
                    ...
                    SentencesRow(
                      englishText: """We drove homewards in silence.""",
                      kurdishText: """بە بێ‌دەنگی بەرەو ماڵ لێمان خوڕی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It happened when she was on the homeward flight back to the UK.""",
                      kurdishText:
                          """ڕوویدا کە لە گەشتێکی بەرەو ماڵەوە بوو بۆ بەریتانیا.""",
