...
class EnglishEntryintegrity extends StatefulWidget {
  const EnglishEntryintegrity({super.key});

  @override
  State<EnglishEntryintegrity> createState() => _EnglishEntryintegrityState();
}

class _EnglishEntryintegrityState extends State<EnglishEntryintegrity> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""integrity""");
  }
