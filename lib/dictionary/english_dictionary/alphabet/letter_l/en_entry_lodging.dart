...
class EnglishEntrylodging extends StatefulWidget {
  const EnglishEntrylodging({super.key});

  @override
  State<EnglishEntrylodging> createState() => _EnglishEntrylodgingState();
}

class _EnglishEntrylodgingState extends State<EnglishEntrylodging> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lodging""");
  }
