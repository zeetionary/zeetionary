...
class EnglishEntrylegibly extends StatefulWidget {
  const EnglishEntrylegibly({super.key});

  @override
  State<EnglishEntrylegibly> createState() => _EnglishEntrylegiblyState();
}

class _EnglishEntrylegiblyState extends State<EnglishEntrylegibly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: legibly
1. In a legible manner (- decipherably, readably)
"you must write legibly";
""",
  );

  final String keyword = "legibly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""legibly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Please write legibly.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/tb5nqZDe5W4?t=187';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/C-ePy-2WLfY?t=779';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/7mCJBotRYeg?t=919';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/YNAMmdHp210?t=710';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/HjPEAmSFNP8?t=546';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/8uD2BJGryDY?t=202';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """legibly""",
                      // alsoEnglishWord: "also: legibly",
                      britshText: """IpaUK: /ˈledʒəbli/""",
                      americanText: """IpaUS: /ˈledʒəbli/""",
...
// کوردی: بە شێوەیەکی خوانا یان خوێنراوە، خوانایانە، بە شێوەیێکی وانا
// """),
// With short examples define "legibly", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵکار) بە شێوەیەک کە هێندە ڕوون بێت بخوێندرێتەوە"""),
                    SentencesRow(
                      englishText: """Please write legibly.""",
                      kurdishText: """تکایە بە شێوەیەکی لەخوێندنەوەهاتوو بنووسە.""",
