...
class EnglishEntrygym extends StatefulWidget {
  const EnglishEntrygym({super.key});

  @override
  State<EnglishEntrygym> createState() => _EnglishEntrygymState();
}

class _EnglishEntrygymState extends State<EnglishEntrygym> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gym (Derived forms: gyms)
1. Athletic facility equipped for sports or physical training (- gymnasium)
 
2. Training in the development of and care for the human body; stresses athletics; includes hygiene (- physical education, PE)
""",
  );

  final String keyword = "gym";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The school has recently built a new gym.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I work out at the gym most days.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I hit the gym at 6.00 again this morning.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I don't enjoy gym.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gym""",
                      alsoEnglishWord: "also: gymnasium",
                      britshText: """IpaUK: /dʒɪm/""",
                      americanText: """IpaUS: /dʒɪm/""",
