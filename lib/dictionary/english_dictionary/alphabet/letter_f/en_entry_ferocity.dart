...
class EnglishEntryferocity extends StatefulWidget {
  const EnglishEntryferocity({super.key});

  @override
  State<EnglishEntryferocity> createState() => _EnglishEntryferocityState();
}

class _EnglishEntryferocityState extends State<EnglishEntryferocity> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""ferocity""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The police were shocked by the ferocity of the attack.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The hurricane hit with terrible ferocity.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ferocity""",
                      // alsoEnglishWord: "also: ferocity",
                      britshText: """IpaUK: /fəˈrɒsəti/""",
                      americanText: """IpaUS: /fəˈrɑːsəti/""",
...
const String _videoIdend = 'https://youtu.be/dGpJRvawgNI?t=';
const double _startSecondsend = 0000000000000000000000000001317;
const String _videoIdone = 'https://youtu.be/ViBaYl9GCcE?t=';
const double _startSecondsone = 000000000000000000000000000616;
const String _videoIdtwo = 'https://youtu.be/SxvUs6WFWn0?t=';
const double _startSecondstwo = 00000000000000000000000000041;
const String _videoIdthree = 'https://youtu.be/-F5BrN8LE6Q?t=';
const double _startSecondsthree = 00000000000000000000000000098;
const String _videoIdfour = 'https://youtu.be/vNEd9FyG5P4?t=';
const double _startSecondsfour = 000000000000000000000000000402;
const String _videoIdfive = 'https://youtu.be/woD6RYptp58?t=';
