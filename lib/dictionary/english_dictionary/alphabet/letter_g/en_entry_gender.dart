...
class EnglishEntrygender extends StatefulWidget {
  const EnglishEntrygender({super.key});

  @override
  State<EnglishEntrygender> createState() => _EnglishEntrygenderState();
}

class _EnglishEntrygenderState extends State<EnglishEntrygender> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gender""",
                      // alsoEnglishWord: "also: gender",
                      britshText: """IpaUK: /ˈdʒendə(r)/""",
                      americanText: """IpaUS: /ˈdʒendər/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """Levels of physical activity did not differ between genders.""",
                      kurdishText:
                          """ئاستی چالاکیی جەستەیی جیاواز نەبوو لە نێوان ڕەگەزەکان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The government is working on tackling gender inequalities in employment.""",
                      kurdishText:
                          """حکومەت کار دەکات لەسەر مامەڵەکردن لەگەڵ نایەکسانی ڕەگەزی لە وەرگرتن بۆ کار.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Germany's top court has ruled that parliament must legally recognize a third gender.""",
                      kurdishText:
                          """دادگای باڵای ئەڵمانیا بڕیاری داوە کە پەرلەمان دەبێت بە یاسایی ڕەگەزی سێیەم بناسێنێت.""",
...
const String _videoIdtwo = 'https://youtu.be/hOUGNGWmN0k?t=';
const double _startSecondstwo = 000000000000000000000000000181;
const String _videoIdthree = 'https://youtu.be/_0RTH57v66I?t=';
const double _startSecondsthree = 000000000000000000000000000579;
const String _videoIdfour = 'https://youtu.be/S3ksC_8jGuc?t=';
const double _startSecondsfour = 000000000000000000000000000373;
const String _videoIdfive = 'https://youtu.be/bXqZllqGWGQ?t=';
