...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/t6jQ0X55zt4';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/xzRRJ1nguvM?t=';
    const double startSecondsone = 000000000000000000000000000995;
    const String videoIdtwo = 'https://youtu.be/wx3Dao9erK8?t=';
    const double startSecondstwo = 0000000000000000000000000002342;
    const String videoIdthree = 'https://youtu.be/W-iyNPQ5yr0';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/A4rMlM3s7H4?t=';
    const double startSecondsfour = 000000000000000000000000000134;
    const String videoIdfive = 'https://youtu.be/1n7zuAHyXX0?t=';
