...
class EnglishEntryalso extends StatelessWidget {
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "also", // DOPSUM: CHANGE WORD ENTRY - Find /ˈɔːlsəʊ/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAlso(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () => speakActive6255("en-GB"),
                              ),
                              IconButton(
                                iconSize: 18,
                                icon: const Icon(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '4_jkeWgtZ18';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'FQ9LwuOG4W4';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '2z5A-COlDPk';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '-2gV8LaH9SQ';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'ZRDIHcFRPFs';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'V5c2pyVmKYQ';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = '2CrsNJ2s2Po';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'YeRu4xYH_W0';
