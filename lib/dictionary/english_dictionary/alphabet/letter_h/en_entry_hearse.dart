...
class EnglishEntryhearse extends StatefulWidget {
  const EnglishEntryhearse({super.key});

  @override
  State<EnglishEntryhearse> createState() => _EnglishEntryhearseState();
}

class _EnglishEntryhearseState extends State<EnglishEntryhearse> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hearse (Derived forms: hearses)
1. A vehicle for carrying a coffin to a church or a cemetery; formerly drawn by horses but now usually a motor vehicle (- herse [archaic])
""",
  );

  final String keyword = "hearse";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hearse""",
                      // alsoEnglishWord: "also: hearse",
                      britshText: """IpaUK: /hɜːs/""",
                      americanText: """IpaUS: /hɜːrs/""",
...
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پێڕۆیەکی درێژ کە بەکاردێت بۆ هەڵگرتنی تەرم لە مەراسیمی ناشتندا"""),
                    SentencesRow(
                      englishText:
                          """A horse-drawn hearse took the coffin from the house to the church.""",
                      kurdishText:
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/wRNYoWFjmEc?t=';
const double _startSecondsend = 000000000000000000000000000652;
const String _videoIdone = 'https://youtu.be/ySOKrCusEjw?t=';
const double _startSecondsone = 0000000000000000000000000002021;
const String _videoIdtwo = 'https://youtu.be/B5ytcg5pYEA?t=';
const double _startSecondstwo = 000000000000000000000000000206;
const String _videoIdthree = 'https://youtu.be/cJiq-6abMEs?t=';
const double _startSecondsthree = 000000000000000000000000000144;
const String _videoIdfour = 'https://youtu.be/s403m3x8zuM?t=';
const double _startSecondsfour = 000000000000000000000000000806;
const String _videoIdfive = 'https://youtu.be/j_700Q1vL0c?t=';
