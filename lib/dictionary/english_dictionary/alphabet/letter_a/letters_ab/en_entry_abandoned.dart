...
class EnglishEntryabandoned extends StatefulWidget {
  ...
  @override
  State<EnglishEntryabandoned> createState() => _EnglishEntryabandonedState();
}

class _EnglishEntryabandonedState extends State<EnglishEntryabandoned> {
  @override
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: abandoned");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /əˈbændənd/");
  }
}
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /əˈbændənd/");
  }
}
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'ffoQRLTPbgE';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'AsJ0YBCWGZ8';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = '2G--Kox8eMA';
