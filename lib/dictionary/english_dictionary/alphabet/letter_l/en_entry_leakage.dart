...
class EnglishEntryleakage extends StatefulWidget {
  const EnglishEntryleakage({super.key});

  @override
  State<EnglishEntryleakage> createState() => _EnglishEntryleakageState();
}

class _EnglishEntryleakageState extends State<EnglishEntryleakage> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""leakage""");
  }
