...
class EnglishEntryincubator extends StatefulWidget {
  const EnglishEntryincubator({super.key});

  @override
  State<EnglishEntryincubator> createState() => _EnglishEntryincubatorState();
}

class _EnglishEntryincubatorState extends State<EnglishEntryincubator> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incubator""");
  }
