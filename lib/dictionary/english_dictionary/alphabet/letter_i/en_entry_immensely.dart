...
class EnglishEntryimmensely extends StatefulWidget {
  const EnglishEntryimmensely({super.key});

  @override
  State<EnglishEntryimmensely> createState() => _EnglishEntryimmenselyState();
}

class _EnglishEntryimmenselyState extends State<EnglishEntryimmensely> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: immensely
1. To an exceedingly great extent or degree (- vastly, gigantically, colossally)
"was immensely more important to the project as a scientist than as an administrator";
 
2. To a great extent; over a large range or scale (- enormously, terrifically [informal], tremendously, hugely, vastly, massively [informal], greatly)
"salaries vary immensely";
""",
  );

  final String keyword = "immensely";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""immensely""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We enjoyed ourselves immensely.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001419;
    const String videoIdone = 'https://youtu.be/VNZ0so0LCoM?t=';
    const double startSecondsone = 000000000000000000000000000296;
    const String videoIdtwo = 'https://youtu.be/7eM7pb5M5DU?t=';
    const double startSecondstwo = 0000000000000000000000000001445;
    const String videoIdthree = 'https://youtu.be/JcpboMScfIY?t=';
    const double startSecondsthree = 0000000000000000000000000005694;
    const String videoIdfour = 'https://youtu.be/nARcrP7GNso?t=';
    const double startSecondsfour = 0000000000000000000000000001725;
    const String videoIdfive = 'https://youtu.be/rMNAdHqGMhs?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """immensely""",
                      // alsoEnglishWord: "also: immensely",
                      britshText: """IpaUK: /ɪˈmensli/""",
                      americanText: """IpaUS: /ɪˈmensli/""",
...
کوردی: 
"""),
// With short examples define "immensely", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) بە ئاستێکی زۆر زۆر"""),
                    const AlsoEnglishckb(word: "ھەروەھا: enormously"),
                    SentencesRow(
                      englishText: """We enjoyed ourselves immensely.""",
                      kurdishText: """ئێجگار زۆر چێژمان بینی.""",
