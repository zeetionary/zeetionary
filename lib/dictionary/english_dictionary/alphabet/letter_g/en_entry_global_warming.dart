...
class EnglishEntryglobalwarming extends StatefulWidget {
  const EnglishEntryglobalwarming({super.key});

  @override
  State<EnglishEntryglobalwarming> createState() =>
      _EnglishEntryglobalwarmingState();
}

class _EnglishEntryglobalwarmingState extends State<EnglishEntryglobalwarming> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "global warming";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""global warming""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """global warming""",
                      // alsoEnglishWord: "also: global warming",
                      britshText: """IpaUK: /ˌɡləʊbl ˈwɔːmɪŋ/""",
                      americanText: """IpaUS: /ˌɡləʊbl ˈwɔːrmɪŋ/""",
...
// With short examples define "global warming", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) زیادبوونی گەرمبوونی بەرگەهەوای زەوی بەهۆی زۆربوونی ژمارەیەک گازەوە، بە تایبەتی دووەم ئۆکسیدی"""),
                    SentencesRow(
                      englishText:
                          """The destruction of the rainforests is contributing to global warming.""",
                      kurdishText:
                          """لەناوبردنی دارستانە باراناوییەکان هۆکارێکە بۆ گەرمبوونی جیهانی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Several hypotheses for global warming have been suggested.""",
                      kurdishText:
                          """ژمارەیەک گریمانە بۆ گەرمبوونی جیهانی باسکراوە.""",
...
const double _startSecondsone = 0000000000000000000000000001936;
const String _videoIdtwo = 'https://youtu.be/rsNskDfd5CM?t=';
const double _startSecondstwo = 00000000000000000000000000058;
const String _videoIdthree = 'https://youtu.be/Ix6vtM4gP8g?t=';
const double _startSecondsthree = 000000000000000000000000000714;
const String _videoIdfour = 'https://youtu.be/atNiYtCTcPc?t=';
const double _startSecondsfour = 00000000000000000000000000079;
const String _videoIdfive = 'https://youtu.be/QGlACrp1rG0?t=';
