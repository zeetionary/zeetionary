...
class EnglishEntryhandy extends StatefulWidget {
  const EnglishEntryhandy({super.key});

  @override
  State<EnglishEntryhandy> createState() => _EnglishEntryhandyState();
}

class _EnglishEntryhandyState extends State<EnglishEntryhandy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: handy (Derived forms: handiest, handier)
1. Easy to reach (- ready to hand)
"found a handy spot for the can opener";
 
2. Useful and convenient
"a handy gadget"
 
3. Skilful with the hands
"handy with an axe"
""",
  );

  final String keyword = "handy";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The arrangement was handy for both of us.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Always keep a first-aid kit handy.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Have you got a pen handy?""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Lucy is quite handy with a drill!""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """handy""",
                      // alsoEnglishWord: "also: handy",
                      britshText: """IpaUK: /ˈhændi/""",
                      americanText: """IpaUS: /ˈhændi/""",
...
// With short examples define "handy", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The wire brush is very handy for cleaning up old iron and steel.""",
                      kurdishText:
                          """لفکە تەلەکە ئاسان بوو بۆ پاککردنەوەی ئاسن و پۆڵای کۆن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Have you got a pen handy?""",
                      kurdishText: """پێنووسێکت لەبەردەستە؟""",
