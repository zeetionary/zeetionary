...
// replace these: replace EnglishEntryaffected - replace speakAffected - replace affected - /əˈfektɪd/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaffected extends StatelessWidget {
  EnglishEntryaffected({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAffected(String languageCode) async {
    // DOPSUM: CHANGE speakAffected
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("affected"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAffec357(String languageCode) async {
    ...
    await flutterTts.speak(
        "Don't worry about the rule changes—you're not affected."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAffec3618(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "Don’t use such strange words—it makes you sound affected."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "affected", // DOPSUM: CHANGE WORD ENTRY - Find /əˈfektɪd/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈfektɪd/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAffected(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /əˈfektɪd/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 't6ugaHl_vps';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'dmZw0-sPSc4';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'hWmOA8XIrQE';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'hvZ8BcJnzj4';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'kP6pW24T7Go';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'fQ2jIBMSSWI';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'FelLnPywn-E';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'n53UaiSZuDg';
