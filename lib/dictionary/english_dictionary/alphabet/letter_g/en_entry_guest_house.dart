...
class EnglishEntryguesthouse extends StatefulWidget {
  const EnglishEntryguesthouse({super.key});

  @override
  State<EnglishEntryguesthouse> createState() => _EnglishEntryguesthouseState();
}

class _EnglishEntryguesthouseState extends State<EnglishEntryguesthouse> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: guest house (Derived forms: guest houses)
1. A house separate from the main house; for housing guests
""",
  );

  final String keyword = "guest house";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""guest house""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """guest house""",
                      // alsoEnglishWord: "also: guest house",
                      britshText: """IpaUK: /ˈɡest haʊs/""",
                      americanText: """IpaUS: /ˈɡest haʊs/""",
...
// With short examples define "guest house", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """It is a comfortable family-run guest house near the beach.""",
                      kurdishText:
                          """میوانخانەیەکی خێزانی ئاسوودەبەخشە لە نزیک کەناراوەکە.""",
