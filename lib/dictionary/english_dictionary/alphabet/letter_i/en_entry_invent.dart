...
class EnglishEntryinvent extends StatefulWidget {
  const EnglishEntryinvent({super.key});

  @override
  State<EnglishEntryinvent> createState() => _EnglishEntryinventState();
}

class _EnglishEntryinventState extends State<EnglishEntryinvent> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: invent (Derived forms: invented, invents, inventing)
1. Come up with (an idea, plan, explanation, theory, or principle) after a mental effort (- contrive, devise, excogitate, formulate, forge)
"invent a way to measure the speed of light";
 
2. Concoct something artificial or untrue (- fabricate, manufacture, cook up [informal], make up)
""",
  );

  final String keyword = "invent";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Who invented the steam engine?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I wish mobile phones had never been invented!""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The term ‘sociology’ was invented by Auguste Comte.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Louis Braille invented an alphabet to help blind people.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What excuse did he invent this time?""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Many children invent an imaginary friend.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/DEFD9TSHg_A?t=';
    const double startSecondsend = 00000000000000000000000000070;
    ...
    const double startSecondstwo = 000000000000000000000000000717;
    const String videoIdthree = 'https://youtu.be/3cxHwQl9pNM?t=';
    const double startSecondsthree = 000000000000000000000000000122;
    const String videoIdfour = 'https://youtu.be/SrDEtSlqJC4?t=';
    const double startSecondsfour = 0000000000000000000000000001378;
    const String videoIdfive = 'https://youtu.be/Cqbleas1mmo?t=';
    const double startSecondsfive = 00000000000000000000000000029;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """invent""",
                      // alsoEnglishWord: "also: invent",
                      britshText: """IpaUK: /ɪnˈvent/""",
                      americanText: """IpaUS: /ɪnˈvent/""",
...
کوردی: 
"""),
// With short examples define "invent", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) داهێنانی شتێک"""),
                    SentencesRow(
                      englishText: """Who invented the steam engine?""",
                      kurdishText: """کێ بزوێنەری هەڵمی داهێنا؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بەهیوام موبایل هەرگیز درووست نەکرابا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەستەواژەی 'سۆسیۆلۆژی' لەلایەن ئۆگەست کۆمت دامەزرا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لویس برایل ئەلفوبێی درووستکرد بۆ یارمەتیدانی کەسانی نابینا.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (کردار) گوتنی شتێک کە ڕاست نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """What excuse did he invent this time?""",
                      kurdishText: """ئەم جارە چی بەهانەیەکی درووستکرد؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆر منداڵ هاوڕێیەکی خەیاڵی درووست دەکەن.""",
