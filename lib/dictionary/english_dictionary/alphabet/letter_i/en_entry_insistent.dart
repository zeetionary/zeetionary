...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'lADBzq_CFwY';
    const double startSecondsend = 741;
    ...
    const String videoIdthree = 'LYUdnsIn5OU';
    const double startSecondsthree = 517;
    const String videoIdfour = 'djU7rduvo6s';
    const double startSecondsfour = 309;
    const String videoIdfive = 'runjda4La_4';
    const double startSecondsfive = 1342;
