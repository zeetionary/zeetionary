...
class EnglishEntryheady extends StatefulWidget {
  const EnglishEntryheady({super.key});

  @override
  State<EnglishEntryheady> createState() => _EnglishEntryheadyState();
}

class _EnglishEntryheadyState extends State<EnglishEntryheady> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: heady (Derived forms: headier, headiest)
1. Marked by the exercise of good judgment or common sense in practical matters (- judicious, wise)
"heady use of one's money";
 
2. Extremely exciting as if by alcohol or a narcotic (- intoxicating)
 
3. Marked by defiant disregard for danger or consequences (- foolhardy, rash, reckless)
"heady enough to try to seize the gun from the hijacker";
""",
  );

  final String keyword = "heady";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Profits grew last year by a heady 5.7%.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She felt heady with success.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heady""",
                      // alsoEnglishWord: "also: heady",
                      britshText: """IpaUK: /ˈhedi/""",
                      americanText: """IpaUS: /ˈhedi/""",
...
"""),
// With short examples define "heady", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە کاریگەری بەهێزی هەیە لەسەر هەستەکانت؛ کە ورە و جۆش‌وخرۆشیت پێدەدات"""),
                    const AlsoEnglishckb(word: "ھەروەھا: intoxicating"),
                    SentencesRow(
                      englishText:
                          """Profits grew last year by a heady 5.7%.""",
                      kurdishText:
                          """قازانج بە ڕێژەی ٥,٧ زیادی کرد لە ساڵی ڕابردوودا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە کەسێک بەجۆشە و شتانێک دەکات کە گرنگی بە ئەنجامەکەی نادات"""),
                    SentencesRow(
                      englishText: """She felt heady with success.""",
                      kurdishText: """لە سەرکەوتندا هەستی بە هەڵەشەیی دەکرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/jMhXEnQLni0?t=';
const double _startSecondsend = 000000000000000000000000000200;
const String _videoIdone = 'https://youtu.be/Yj07347rEqo?t=';
const double _startSecondsone = 00000000000000000000000000053;
const String _videoIdtwo = 'https://youtu.be/pWlk1gLkF2Y?t=';
const double _startSecondstwo = 000000000000000000000000000827;
const String _videoIdthree = 'https://youtu.be/LjyN5qmi8ZY?t=';
const double _startSecondsthree = 00000000000000000000000000021;
const String _videoIdfour = 'https://youtu.be/5Akc-1UJqdI?t=';
const double _startSecondsfour = 000000000000000000000000000907;
const String _videoIdfive = 'https://youtu.be/XVjeYW6S8Mo?t=';
