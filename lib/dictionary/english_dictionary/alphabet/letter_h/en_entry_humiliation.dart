...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001320;
    const String videoIdone = 'https://youtu.be/7eM7pb5M5DU?t=';
    const double startSecondsone = 0000000000000000000000000001162;
    const String videoIdtwo = 'https://youtu.be/AwodL8z2EtE?t=';
    const double startSecondstwo = 0000000000000000000000000002504;
    const String videoIdthree = 'https://youtu.be/xfLN3618gE8?t=';
    ...
    const double startSecondsfive = 0000000000000000000000000001160;
