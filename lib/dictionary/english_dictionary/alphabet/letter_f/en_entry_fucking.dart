...
class EnglishEntryfucking extends StatefulWidget {
  const EnglishEntryfucking({super.key});

  @override
  State<EnglishEntryfucking> createState() => _EnglishEntryfuckingState();
}

class _EnglishEntryfuckingState extends State<EnglishEntryfucking> {
  @override
  void initState() {
    super.initState();
...
- Adjective: fucking
Usage: vulgar
1. Informal intensifier (- bally [Brit, informal], blinking [Brit, informal], bloody [Brit, informal], blooming [Brit, informal], crashing, flaming, freaking [informal], effing [Brit, informal])
"what a fucking nuisance";

- Noun: fucking (Derived forms: fuckings)
Usage: vulgar
1. Slang for sexual intercourse (- rumpy-pumpy [informal])

- Adverb: fucking
Usage: vulgar
1. Intensifier, very colloquial
"what took you so fucking long?"
""",
  );

  final String keyword = "fucking";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fucking""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'm fucking sick of this fucking rain!""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He's a fucking good player.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fucking""",
                      // alsoEnglishWord: "also: fucking",
                      britshText: """IpaUK: /ˈfʌkɪŋ/""",
                      americanText: """IpaUS: /ˈfʌkɪŋ/""",
...
// With short examples define "fucking", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """I'm fucking sick of this fucking rain!""",
                      kurdishText: """تەواو بێزارم لەم بارانە نەفرەتییە!""",
                    ...
                    SentencesRow(
                      englishText: """He's a fucking good player.""",
                      kurdishText: """یاریزانێکی حەرامزادەی زۆر باشە.""",
...
const double _startSecondsone = 00000000000000000000000000087;
const String _videoIdtwo = 'https://youtu.be/4J0xFUyz1nw?t=';
const double _startSecondstwo = 000000000000000000000000000576;
...
const String _videoIdfive = 'https://youtu.be/HUsIcK1a4B0?t=';
