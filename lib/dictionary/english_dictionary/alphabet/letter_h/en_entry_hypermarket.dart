...
class EnglishEntryhypermarket extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hypermarket""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'kg38QEJWgYQ';
    const double startSecondsend = 428;
    const String videoIdone = 'Ji5SMsS1tZI';
    const double startSecondsone = 516;
    const String videoIdtwo = 'C1EvIQi873g';
    const double startSecondstwo = 378;
    const String videoIdthree = 'y07ySAIYDSQ';
    const double startSecondsthree = 54;
    const String videoIdfour = 'q0HKHUd7SKo';
    const double startSecondsfour = 39;
    const String videoIdfive = 'o3b1cA_uEoE';
    const double startSecondsfive = 667;
