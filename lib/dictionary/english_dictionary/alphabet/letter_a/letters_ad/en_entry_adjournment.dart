...
class EnglishEntryadjournment extends StatefulWidget {
...
// 188888880002200
  ...
  final String keyword = "adjournment";
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'AxX8RbY1RXc';
    const double startSecondstwo = 61;
    const String videoIdthree = 'B-DhLetLxyM';
    const double startSecondsthree = 291;
    const String videoIdfour = '5y7a1Eb6QR4';
    const double startSecondsfour = 12;
    const String videoIdfive = 'O6HfUi8n7-4';
    const double startSecondsfive = 371;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """adjournment""",
                      // alsoEnglishWord: "also: adjournment",
                      britshText: """IpaUK: /əˈdʒɜːnmənt/""",
                      americanText: """IpaUS: /əˈdʒɜːrnmənt/""",
