...
class EnglishEntryfoodstuff extends StatefulWidget {
  const EnglishEntryfoodstuff({super.key});

  @override
  State<EnglishEntryfoodstuff> createState() => _EnglishEntryfoodstuffState();
}

class _EnglishEntryfoodstuffState extends State<EnglishEntryfoodstuff> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foodstuff (Derived forms: foodstuffs)
1. (usually plural) consumer goods sold by a grocer (= grocery)
 
2. A substance that can be used or prepared for use as food (= food product)
""",
  );

  final String keyword = "foodstuff";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foodstuff""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foodstuff""",
                      // alsoEnglishWord: "also: foodstuff",
                      britshText: """IpaUK: /ˈfuːdstʌf/""",
                      americanText: """IpaUS: /ˈfuːdstʌf/""",
...
// With short examples define "foodstuff", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) هەر شتێک کە بخورێت"""),
                    SentencesRow(
                      englishText:
                          """Cross-border trade in foodstuffs and consumer goods is increasing.""",
                      kurdishText:
                          """بازرگانی سنووری مادەی خۆراکی و کەلوپەلی بەکارهێنان زیاد دەکات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/4QDDxmtbUsw?t=';
const double _startSecondsend = 00000000000000000000000000036;
const String _videoIdone = 'https://youtu.be/UiS27feX8o0?t=';
const double _startSecondsone = 00000000000000000000000000063;
const String _videoIdtwo = 'https://youtu.be/ha2mLz-Xdpg?t=';
const double _startSecondstwo = 0000000000000000000000000002995;
const String _videoIdthree = 'https://youtu.be/o62UrPGwFNs?t=';
const double _startSecondsthree = 0000000000000000000000000001482;
const String _videoIdfour = 'https://youtu.be/3kr7C2L6AUA?t=';
const double _startSecondsfour = 00000000000000000000000000024;
const String _videoIdfive = 'https://youtu.be/u7WGKy5Wz5A?t=';
