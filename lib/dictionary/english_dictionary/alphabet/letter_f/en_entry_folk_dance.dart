...
class EnglishEntryfolkdance extends StatefulWidget {
  const EnglishEntryfolkdance({super.key});

  @override
  State<EnglishEntryfolkdance> createState() => _EnglishEntryfolkdanceState();
}

class _EnglishEntryfolkdanceState extends State<EnglishEntryfolkdance> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: folk dance (Derived forms: folk dances)
1. A style of dancing that originated among ordinary people (not in the royal courts) (= folk dancing)

- Verb: folk dance (Derived forms: folk dances, folk dancing, folk danced)
1. Perform a folk-dance
""",
  );

  final String keyword = "folk dance";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""folk dance""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She learned a folk dance from her grandparents.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """folk dance""",
                      // alsoEnglishWord: "also: folk dance",
                      britshText: """IpaUK: /ˈfəʊk dɑːns/""",
                      americanText: """IpaUS: /ˈfəʊk dæns/""",
...
کوردی: هەڵپەڕکێ یان سەمای نەریتی، هەڵپەڕکێی خۆجێیی یان ناوچەیی
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) سەما و هەڵپەڕکێی نەریتی"""),
                    SentencesRow(
                      englishText:
                          """She learned a folk dance from her grandparents.""",
                      kurdishText:
                          """سەمایەکی نەریتی لە داپیرە و باپیرەی فێربوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/lObbGydVSg4?t=';
const double _startSecondsend = 00000000000000000000000000023;
const String _videoIdone = 'https://youtu.be/7uK--nAp1a0?t=';
const double _startSecondsone = 000000000000000000000000000121;
const String _videoIdtwo = 'https://youtu.be/p2WGRRiXVNs?t=';
const double _startSecondstwo = 000000000000000000000000000395;
const String _videoIdthree = 'https://youtu.be/J_bluwl_MT0?t=';
const double _startSecondsthree = 000000000000000000000000000277;
const String _videoIdfour = 'https://youtu.be/thXe-rtpl6U?t=';
const double _startSecondsfour = 0000000000000000000000000002298;
const String _videoIdfive = 'https://youtu.be/z3TbbpPkGmQ?t=';
const double _startSecondsfive = 000000000000000000000000000313;
