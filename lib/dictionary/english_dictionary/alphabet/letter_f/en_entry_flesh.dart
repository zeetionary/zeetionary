...
class EnglishEntryflesh extends StatefulWidget {
  const EnglishEntryflesh({super.key});

  @override
  State<EnglishEntryflesh> createState() => _EnglishEntryfleshState();
}

class _EnglishEntryfleshState extends State<EnglishEntryflesh> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flesh (Derived forms: fleshes)
1. The soft tissue of the body of a vertebrate: mainly muscle tissue and fat
 
2. The physical body of a human being (= human body, physical body, material body, soma, build, figure, physique, anatomy, shape, bod [informal], chassis [informal], frame, form)
"the spirit is willing but the flesh is weak";
 
3. A soft moist part of a fruit (= pulp)

- Verb: flesh (Derived forms: fleshing, fleshed, fleshes)
1. Remove adhering flesh from (hides) when preparing leather manufacture
""",
  );

  final String keyword = "flesh";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The trap had cut deeply into the rabbit's flesh.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Falcons usually strip the flesh off their prey.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His fingers closed around the soft flesh of her arm.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""My flesh tingled as I got out of the ice cold pool.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Cut the melon in half and scoop out the flesh.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flesh""",
                      // alsoEnglishWord: "also: flesh",
                      britshText: """IpaUK: /fleʃ/""",
                      americanText: """IpaUS: /fleʃ/""",
...
// With short examples define "flesh", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تەڵەکە قووڵ چوو بە گۆشتی کەروێشکەکەدا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """African hunting dogs will tear at the flesh of their victim until it is weak.""",
                      kurdishText:
                          """سەگی ڕاوکەری ئەفریقی گاز لە گۆشتی قوربانییەکە دەگرن تاوەکو لاوازی دەکەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """باز زۆرجار گۆشتی نێیرەکەی جیادەکاتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پەنجەکانی بە دەوری پێستی نەرمی قۆڵیدا داخران..""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کاتێک لە حەوزە زۆر ساردەکە هاتمە دەرەوە، لەشم مووچڕکەی پێدا هات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کاڵەکەکە لە ناوەڕاستدا کەرت بکە و نەرمییەکەی دەربکە.""",
...
const String _videoIdtwo = 'https://youtu.be/D_Y18GEjfNY?t=';
const double _startSecondstwo = 000000000000000000000000000310;
const String _videoIdthree = 'https://youtu.be/AdYaTa_lOf4?t=';
const double _startSecondsthree = 00000000000000000000000000016;
const String _videoIdfour = 'https://youtu.be/dJzTse9Dsaw?t=';
const double _startSecondsfour = 000000000000000000000000000272;
const String _videoIdfive = 'https://youtu.be/8eq2vGEEbB4?t=';
