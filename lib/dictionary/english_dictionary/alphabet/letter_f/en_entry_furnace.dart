...
class EnglishEntryfurnace extends StatefulWidget {
  const EnglishEntryfurnace({super.key});

  @override
  State<EnglishEntryfurnace> createState() => _EnglishEntryfurnaceState();
}

class _EnglishEntryfurnaceState extends State<EnglishEntryfurnace> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: furnace (Derived forms: furnaces)
1. An enclosed chamber in which heat is produced to heat buildings, destroy refuse, smelt or refine ores, etc. (- oven)
"Oil fires the furnace";
 
2. Any area that is excessively hot
""",
  );

  final String keyword = "furnace";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""furnace""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It's like a furnace in here!""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The furnaces burned fiercely.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furnace""",
                      // alsoEnglishWord: "also: furnace",
                      britshText: """IpaUK: /ˈfɜːnɪs/""",
                      americanText: """IpaUS: /ˈfɜːrnɪs/""",
...
کوردی: کوورە، توون، کوانوو، گوڵخەن، کوڵخان،	جەهەنم، توون، شوێنێکی یەکجار گەرم، کوورەی تاقی‌کردنەوە
"""),
// With short examples define "furnace", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئێرە ئەڵێی کوورەیە!""",
                    ...
                    SentencesRow(
                      englishText: """The furnaces burned fiercely.""",
                      kurdishText: """کوورەکان بە توندی ئاگریان سەندبوو.""",
                    ...
                    CustomRichText(
                      ...
                      textAfterLink: "",
                      onTap: () {
                        Routemaster.of(context).push("/english-furnace/boiler");
                      },
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """ژممر. (ھاوەڵناو) پننسە"""),
...
const double _startSecondsone = 0000000000000000000000000001259;
const String _videoIdtwo = 'https://youtu.be/s_2QTY0V3Yc?t=';
const double _startSecondstwo = 0000000000000000000000000001151;
const String _videoIdthree = 'https://youtu.be/VTzKIs19eZE?t=';
const double _startSecondsthree = 00000000000000000000000000072;
const String _videoIdfour = 'https://youtu.be/lSoWxG30rb0?t=';
const double _startSecondsfour = 000000000000000000000000000144;
const String _videoIdfive = 'https://youtu.be/Tt6WQYtefXA?t=';
const double _startSecondsfive = 000000000000000000000000000572;
