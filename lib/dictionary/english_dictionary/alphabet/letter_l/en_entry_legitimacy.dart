...
class EnglishEntrylegitimacy extends StatefulWidget {
  const EnglishEntrylegitimacy({super.key});

  @override
  State<EnglishEntrylegitimacy> createState() => _EnglishEntrylegitimacyState();
}

class _EnglishEntrylegitimacyState extends State<EnglishEntrylegitimacy> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""legitimacy""");
  }
