...
class EnglishEntryhousekeeper extends StatefulWidget {
  const EnglishEntryhousekeeper({super.key});

  @override
  State<EnglishEntryhousekeeper> createState() =>
      _EnglishEntryhousekeeperState();
}

class _EnglishEntryhousekeeperState extends State<EnglishEntryhousekeeper> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: housekeeper (Derived forms: housekeepers)
1. Someone employed to manage the domestic tasks of a household
""",
  );

  final String keyword = "housekeeper";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""housekeeper""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Do come in. My housekeeper will make you a cup of tea.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/GYk4ymtQ1WM?t=';
    const double startSecondsend = 0000000000000000000000000001931;
    const String videoIdone = 'https://youtu.be/cVhxyYklsI8?t=';
    const double startSecondsone = 000000000000000000000000000660;
    const String videoIdtwo = 'https://youtu.be/ZSiKL_zDsgA?t=';
    const double startSecondstwo = 0000000000000000000000000001116;
    const String videoIdthree = 'https://youtu.be/B7m-byNkoHc?t=';
    const double startSecondsthree = 000000000000000000000000000569;
    const String videoIdfour = 'https://youtu.be/U6OhuqD4w1k?t=';
    const double startSecondsfour = 0000000000000000000000000001062;
    const String videoIdfive = 'https://youtu.be/X1ncuW-bLsw?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """housekeeper""",
                      // alsoEnglishWord: "also: housekeeper",
                      britshText: """IpaUK: /ˈhaʊskiːpə(r)/""",
                      americanText: """IpaUS: /ˈhaʊskiːpər/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وەرە ژوورەوە. بەردەسەکەم کوپێک چات بۆ لێ دەنێت .""",
                    ...
                    SentencesRow(
                      englishText:
                          """Miss Mack had been housekeeper at the Hall for many years.""",
                      kurdishText:
                          """خاتوو ماک فەڕاش بووە لە هۆڵەکە بۆ چەندین ساڵ.""",
