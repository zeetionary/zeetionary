...
class EnglishEntryfatherly extends StatefulWidget {
  const EnglishEntryfatherly({super.key});

  @override
  State<EnglishEntryfatherly> createState() => _EnglishEntryfatherlyState();
}

class _EnglishEntryfatherlyState extends State<EnglishEntryfatherly> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fatherly""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fatherly""",
                      // alsoEnglishWord: "also: fatherly",
                      britshText: """IpaUK: /ˈfɑːðəli/""",
                      americanText: """IpaUS: /ˈfɑːðərli/""",
...
کوردی: باوکانە، وەکوو باوک
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) کە لە باوکێک چاوەڕێ دەکرێت"""),
          SentencesRow(
            englishText: """He keeps a fatherly eye on his players.""",
            kurdishText: """چاوێکی باوکانە بەسەر یاریزانەکانی دەهێڵێت.""",
...
"loving, fatherly, advice and encouragement";
""",
  );
...
const String _videoIdend = 'https://youtu.be/YbNeOLbFZVg?t=';
const double _startSecondsend = 0000000000000000000000000001183;
const String _videoIdone = 'https://youtu.be/lXuvGtB_LOU?t=';
const double _startSecondsone = 000000000000000000000000000551;
const String _videoIdtwo = 'https://youtu.be/2WV_0hiuVOg?t=';
const double _startSecondstwo = 0000000000000000000000000001019;
const String _videoIdthree = 'https://youtu.be/mSzk5iz726E?t=';
const double _startSecondsthree = 00000000000000000000000000018;
const String _videoIdfour = 'https://youtu.be/v91FZUfEXGo?t=';
const double _startSecondsfour = 000000000000000000000000000103;
const String _videoIdfive = 'https://youtu.be/GdPsgt_ySU4?t=';
