...
class EnglishEntryfrustrate extends StatefulWidget {
  const EnglishEntryfrustrate({super.key});

  @override
  State<EnglishEntryfrustrate> createState() => _EnglishEntryfrustrateState();
}

class _EnglishEntryfrustrateState extends State<EnglishEntryfrustrate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: frustrate (Derived forms: frustrated, frustrates, frustrating)
1. Hinder or prevent (the efforts, plans, or desires) of (= thwart, queer [informal], spoil, scotch, foil, cross, baffle, bilk [informal], scupper [informal])
"What ultimately frustrated every challenger was Ruth's amazing September surge";
 
2. Harass persistently in cruel or annoying way (- torment, rag, bedevil, crucify, dun)
"The children frustrated the stuttering teacher";
 
3. Deprive of courage or hope; take away hope from; cause to feel discouraged (- discourage)
""",
  );

  final String keyword = "frustrate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frustrate""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The rescue attempt was frustrated by bad weather.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frustrate""",
                      // alsoEnglishWord: "also: frustrate",
                      britshText: """IpaUK: frustrate""",
                      americanText: """IpaUS: /ˈfrʌstreɪt/""",
...
کوردی: خەساندن، پووچەڵ کردن، بێ هیوا کردن
"""),
// With short examples define "frustrate", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) واکردنی ئەوەی کەسێک هەست بە بێزاری یان بێ‌ئۆقرەیی بکات چونکە ناتوانێت ئەوە بکات کە دەیەوێت"""),
                    SentencesRow(
                      englishText:
                          """What frustrates him is that there's too little money to spend on the project.""",
                      kurdishText:
                          """ئەوەی بێزاری دەکات ئەوەیە کە پارەی کەم هەیە لە پڕۆژەکەدا خەرج بکرێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەوڵی ڕزگارکردنەکە بەهۆی کەشووهەوای خراپەوە لەباربرا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/tKZ2ILu_EMc?t=';
const double _startSecondsend = 0000000000000000000000000002146;
const String _videoIdone = 'https://youtu.be/ysTPxUZnZaU?t=';
const double _startSecondsone = 000000000000000000000000000389;
const String _videoIdtwo = 'https://youtu.be/BfzMPuSKfLc?t=';
const double _startSecondstwo = 0000000000000000000000000001036;
const String _videoIdthree = 'https://youtu.be/vS0TuIPoeBs?t=';
const double _startSecondsthree = 000000000000000000000000000470;
const String _videoIdfour = 'https://youtu.be/dUjlMY_Y1Mg?t=';
const double _startSecondsfour = 000000000000000000000000000336;
const String _videoIdfive = 'https://youtu.be/kZdhnDmr0w4?t=';
const double _startSecondsfive = 000000000000000000000000000771;
