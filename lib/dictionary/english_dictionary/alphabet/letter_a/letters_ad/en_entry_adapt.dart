...
// replace these: replace EnglishEntryadamsadapt - replace speakAdapt - replace adapt - /əˈdæpt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadamsadapt extends StatelessWidget {
  EnglishEntryadamsadapt({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "adapt", // DOPSUM: CHANGE WORD ENTRY - Find /əˈdæpt/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈdæpt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAdapt(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'Q6AYg0oLfC8';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'wtWcojcuJ4Q';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'ZK-zhYptqaU';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'DSAW49Kqsm0';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'BmTdxilNkGM';
