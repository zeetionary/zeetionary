...
class EnglishEntryinoculation extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inoculation""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 263;
    const String videoIdone = 'cfOSmkPjuMo';
    const double startSecondsone = 492;
    const String videoIdtwo = '2lRE1Hqy-Xk';
    const double startSecondstwo = 508;
    const String videoIdthree = 'c3dDagZMALQ';
    const double startSecondsthree = 966;
    const String videoIdfour = '5rRXj3rTHhY';
    const double startSecondsfour = 589;
    const String videoIdfive = '3CuPqeIJr3U';
