...
class EnglishEntryassist extends StatelessWidget {
  ...
  Future<void> speakassist849(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("His task is to advise and assist his colleagues.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "assist"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈsɪst/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈsɪst/"),
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'xoYS_j7uEAk';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'sth0GSJdzFY';
