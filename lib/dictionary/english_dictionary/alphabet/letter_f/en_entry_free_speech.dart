...
class EnglishEntryfreespeech extends StatefulWidget {
  const EnglishEntryfreespeech({super.key});

  @override
  State<EnglishEntryfreespeech> createState() => _EnglishEntryfreespeechState();
}

class _EnglishEntryfreespeechState extends State<EnglishEntryfreespeech> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: free speech
1. The right to express an opinion in public without being restrained or censored (= freedom of speech)
""",
  );

  final String keyword = "free speech";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""free speech""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """free speech""",
                      // alsoEnglishWord: "also: free speech",
                      britshText: """IpaUK: /ˌfriː ˈspiːtʃ/""",
                      americanText: """IpaUS: /ˌfriː ˈspiːtʃ/""",
...
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) ئازادی ڕادەربڕین، ئازادی ئاخافتن"""),
                    SentencesRow(
                      englishText:
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/K3v5wFMQRqs?t=';
const double _startSecondsend = 000000000000000000000000000328;
const String _videoIdone = 'https://youtu.be/P6bVl47kdNk?t=';
const double _startSecondsone = 0000000000000000000000000001729;
const String _videoIdtwo = 'https://youtu.be/kBdfcR-8hEY?t=';
const double _startSecondstwo = 000000000000000000000000000995;
...
const double _startSecondsfour = 0000000000000000000000000004126;
const String _videoIdfive = 'https://youtu.be/hDNiNdsPHNA?t=';
const double _startSecondsfive = 000000000000000000000000000229;
