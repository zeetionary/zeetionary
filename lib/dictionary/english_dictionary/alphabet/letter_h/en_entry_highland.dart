...
class EnglishEntryhighland extends StatefulWidget {
  const EnglishEntryhighland({super.key});

  @override
  State<EnglishEntryhighland> createState() => _EnglishEntryhighlandState();
}

class _EnglishEntryhighlandState extends State<EnglishEntryhighland> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: highland
1. Used of high or hilly country (- upland)

- Noun: highland (Derived forms: highlands)
1. Elevated (e.g., mountainous) land (- upland)
""",
  );

  final String keyword = "highland";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""highland""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Much of central and eastern Brazil is highland plateau.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """highland""",
                      // alsoEnglishWord: "also: highland",
                      britshText: """IpaUK: /ˈhaɪlənd/""",
                      americanText: """IpaUS: /ˈhaɪlənd/""",
...
کوردی: شاخ‌وداخ، کێوان، سەرچیا
"""),
// With short examples define "highland", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پەیوەندیدار بە ناوچەیەک کە گرد و شاخی لێیە"""),
                    SentencesRow(
                      englishText:
                          """Much of central and eastern Brazil is highland plateau.""",
                      kurdishText:
                          """زۆرێک لە ناوەڕاست و ڕۆژهەڵاتی بەرازیل و تەختایی شاخ‌وداخن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/yKrFM2tQ_VI?t=';
const double _startSecondsend = 000000000000000000000000000343;
const String _videoIdone = 'https://youtu.be/YlIgwcWlrkA?t=';
const double _startSecondsone = 00000000000000000000000000064;
const String _videoIdtwo = 'https://youtu.be/-EV3pzjwJpE?t=';
const double _startSecondstwo = 000000000000000000000000000180;
const String _videoIdthree = 'https://youtu.be/txNV1kw5bc8?t=';
const double _startSecondsthree = 000000000000000000000000000981;
const String _videoIdfour = 'https://youtu.be/4LQX8Q04g6k?t=';
const double _startSecondsfour = 000000000000000000000000000101;
const String _videoIdfive = 'https://youtu.be/dVykWl3wDjI?t=';
