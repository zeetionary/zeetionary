...
کوردی: بێ‌سەرەتا و کۆتایی، ئەزەلی و ئەبەدی، ھەمیشەیی، (ھە)تاھەتایی، ھەتایی، تاسەر، نەمر، جاوید، ھەرمان، ناکۆتایی، ژیانی پاش مەرگ (ی لەش)، نەفەوتاو، نەگۆڕ، جێگیر،	یەکبینە، لەسەریەک، یەکڕیز، بێ‌پسانەوە
"""),
          ...
          SentencesRow(
            ...
            kurdishText: """قەدری ھەمیشەییت لام ھەیە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """نرخی ئازادیی چاوکراوەیی ھەمیشەییە.""",
          ...
          SentencesRow(
            englishText:
                """The universe was about to be plunged again into eternal darkness.""",
            kurdishText:
                """گەردوون خەریک بوو دووبارە بکەوێتە ناو تاریکی ھەمیشەیی.""",
...
const String _videoIdone = 'uqJKryP1-8M';
