...
class EnglishEntryicily extends StatefulWidget {
  const EnglishEntryicily({super.key});

  @override
  State<EnglishEntryicily> createState() => _EnglishEntryicilyState();
}

class _EnglishEntryicilyState extends State<EnglishEntryicily> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She stared icily at us.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/r4RTdLwZ7xM?t=';
    const double startSecondsend = 000000000000000000000000000425;
    const String videoIdone = 'https://youtu.be/1_oEh11L4jg?t=';
    const double startSecondsone = 000000000000000000000000000370;
    const String videoIdtwo = 'https://youtu.be/LOeeM1WmyOA?t=';
    const double startSecondstwo = 0000000000000000000000000001100;
    const String videoIdthree = 'https://youtu.be/sIXHdzbq1e4?t=';
    const double startSecondsthree = 000000000000000000000000000262;
    const String videoIdfour = 'https://youtu.be/Qug7m6VU68I?t=';
    const double startSecondsfour = 000000000000000000000000000245;
    const String videoIdfive = 'https://youtu.be/KcG1F39GBA8?t=';
    const double startSecondsfive = 00000000000000000000000000014182;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """icily""",
                      // alsoEnglishWord: "also: icily",
                      britshText: """IpaUK: /ˈaɪsɪli/""",
                      americanText: """IpaUS: /ˈaɪsɪli/""",
...
کوردی: وەکوو سەهۆڵ، سەهۆڵانە،	ساردوسڕانە، بە ساردی‌یەوە
"""),
// With short examples define "icily", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) بە شێوەیەکی ساردوسڕانە"""),
                    SentencesRow(
                      englishText: """She stared icily at us.""",
                      kurdishText: """ساردوسڕانە لێمانی ڕوانی.""",
