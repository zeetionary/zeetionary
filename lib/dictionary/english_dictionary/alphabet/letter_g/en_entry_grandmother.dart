...
class EnglishEntrygrandmother extends StatefulWidget {
  const EnglishEntrygrandmother({super.key});

  @override
  State<EnglishEntrygrandmother> createState() =>
      _EnglishEntrygrandmotherState();
}

class _EnglishEntrygrandmotherState extends State<EnglishEntrygrandmother> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grandmother (Derived forms: grandmothers)
1. The mother of your father or mother (- grandma, granny [Brit], grannie [Brit], gran, nan [Brit, informal], nanna [Brit, informal], grandmama [archaic], nana [informal], grandmamma [archaic], nanny [Brit, informal])
""",
  );

  final String keyword = "grandmother";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grandmother""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I always loved going to visit my grandmother.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Both my grandmothers were from Scotland.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grandmother""",
                      alsoEnglishWord: "also: grandma",
                      britshText: """IpaUK: /ˈɡrænmʌðə(r)/""",
                      americanText: """IpaUS: /ˈɡrænmʌðər/""",
...
کوردی: دایەگەورە، نەنک، دێ‌باڤ (هی باوک)، پیرک، ماما
"""),
// With short examples define "grandmother", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) دایکی دایکت یان باوکت"""),
                    SentencesRow(
                      englishText:
                          """I always loved going to visit my grandmother.""",
                      kurdishText:
                          """هەمیشە حەزم بە سەردانکردنی داپیرەم بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەردوو داپیرەم خەڵکی سکۆتلەندا بوون.""",
...
const double _startSecondsend = 000000000000000000000000000599;
const String _videoIdone = 'https://youtu.be/1p8r-2ffK_c?t=';
...
const String _videoIdfive = 'https://youtu.be/6C4ZV4TW86g?t=';
