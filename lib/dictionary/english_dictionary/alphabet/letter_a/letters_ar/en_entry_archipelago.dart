...
class EnglishEntryarchipelago extends StatelessWidget {
  ...
  Future<void> speakarchipelago(String languageCode) async {
    ...
    await flutterTts.speak("archipelago");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "archipelago"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌɑːkɪˈpeləɡəʊ/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌɑːrkɪˈpeləɡəʊ/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '9htGonmCjwg';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'LjieOlWXwTw';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'wEhOZJ55Ve8';
  final double _startSeconds = 5;
