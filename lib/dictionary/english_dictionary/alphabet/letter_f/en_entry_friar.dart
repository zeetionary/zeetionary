...
class EnglishEntryfriar extends StatefulWidget {
  const EnglishEntryfriar({super.key});

  @override
  State<EnglishEntryfriar> createState() => _EnglishEntryfriarState();
}

class _EnglishEntryfriarState extends State<EnglishEntryfriar> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: friar (Derived forms: friars)
1. A male member of a religious order that originally relied solely on alms (= mendicant)
""",
  );

  final String keyword = "friar";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The friar took vows of poverty and chastity.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """friar""",
                      // alsoEnglishWord: "also: friar",
                      britshText: """IpaUK: /ˈfraɪə(r)/""",
                      americanText: """IpaUS: /ˈfraɪər/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕەبەن، ڕاگەیێنەر؛ ئەندامێکی ژمارەیەک گرووپی کاسۆلیکی ڕۆمانی کە ئەندامەکانی بەڵێن دەدەن بە هەژاری بمێننەوە"""),
                    SentencesRow(
                      englishText:
                          """The friar took vows of poverty and chastity.""",
                      kurdishText: """ڕەبەنەکە بەڵێنی هەژاری و پاکیزەیی دا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/q5jnslfwazg?t=';
const double _startSecondsend = 0000000000000000000000000001842;
const String _videoIdone = 'https://youtu.be/_ilrMO0kjzg?t=';
const double _startSecondsone = 000000000000000000000000000289;
const String _videoIdtwo = 'https://youtu.be/m_zFyXWxxMA?t=';
const double _startSecondstwo = 000000000000000000000000000500;
const String _videoIdthree = 'https://youtu.be/1kno8nTCmWw?t=';
const double _startSecondsthree = 000000000000000000000000000108;
const String _videoIdfour = 'https://youtu.be/XK08CKO-yAQ?t=';
const double _startSecondsfour = 000000000000000000000000000258;
const String _videoIdfive = 'https://youtu.be/fNqOGhDMm8k?t=';
const double _startSecondsfive = 000000000000000000000000000113;
