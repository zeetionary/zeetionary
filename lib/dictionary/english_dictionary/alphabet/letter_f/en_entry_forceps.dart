...
class EnglishEntryforceps extends StatefulWidget {
  const EnglishEntryforceps({super.key});

  @override
  State<EnglishEntryforceps> createState() => _EnglishEntryforcepsState();
}

class _EnglishEntryforcepsState extends State<EnglishEntryforceps> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forceps""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Dentists often use forceps to extract teeth.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forceps""",
                      // alsoEnglishWord: "also: forceps",
                      britshText: """IpaUK: /ˈfɔːseps/""",
                      americanText: """IpaUS: /ˈfɔːrseps/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئامرازێک کە لەلایەن پزیشکان و زاناکن بەکاردێت بۆ هەڵگرتنی شت، زۆرجار شێوەی وەک مەقەستە"""),
                    SentencesRow(
                      englishText:
                          """Dentists often use forceps to extract teeth.""",
                      kurdishText:
                          """پزیشکانی ددان فۆرسێپ بەکاردێنن بۆ هەڵکێشانی ددان.""",
...
const double _startSecondsend = 000000000000000000000000000686;
const String _videoIdone = 'https://youtu.be/7EWs5QBv6_w?t=';
...
const String _videoIdthree = 'https://youtu.be/IOgq4Nk2H8w?t=';
const double _startSecondsthree = 0000000000000000000000000001319;
const String _videoIdfour = 'https://youtu.be/GTacoF6WQuI';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/iQTZxUgt4Z8?t=';
const double _startSecondsfive = 000000000000000000000000000780;
