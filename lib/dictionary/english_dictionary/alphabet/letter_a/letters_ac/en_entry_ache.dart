...
class EnglishEntryache extends StatefulWidget {
  const EnglishEntryache({super.key});

  @override
  State<EnglishEntryache> createState() => _EnglishEntryacheState();
}

class _EnglishEntryacheState extends State<EnglishEntryache> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ache""",
                      // alsoEnglishWord: "also: ache",
                      britshText: """IpaUK: /eɪk/""",
                      americanText: """IpaUS: /eɪk/""",
