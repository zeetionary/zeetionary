...
کوردی: پاژنەی پێ، پانیە، لەپان،	پاژنەی پێڵاو یان کەوش، گوھن،	پاژنەی گۆرەوی،	مرۆی شەڕانی و سەربەگۆنگەڵ،	پشت(ی) سم، پش‌سم،	لاق یا پێی دواوە (ھی گیانەوەر)، پاژنە
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پاژنەی پێڵاوەکەی گیر بوو و لەسەر پلەکانەکە پیی ھەڵکەوت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) ھەبوونی ئەو جۆرە پاژنەیەی کە باسکراوە"""),
                    SentencesRow(
                      englishText:
                          """She wore high-heeled shoes to the party.""",
                      kurdishText: """پێڵاوی بنبەرزی لە پێ کرد بۆ ئاھەنگەکە.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٥. (کردار) چاککردنەوەی پاژنەی پێڵاوێک، ھتد"""),
                    SentencesRow(
                      englishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بەلەمەکە کەوت بە لادا لەبەر بایە بەھێزەکە.""",
...
const String _videoIdend = 'sWn_Gqzz4gE';
const double _startSecondsend = 8;
const String _videoIdone = 'mSoHZtyA-9g';
const double _startSecondsone = 0;
const String _videoIdtwo = 'U1VFnNMKPtg';
const double _startSecondstwo = 33;
const String _videoIdthree = 'tLD-OUkYtk4';
const double _startSecondsthree = 1036;
const String _videoIdfour = 'MGO4_8YRKro';
