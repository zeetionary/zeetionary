...
class EnglishEntrykangaroo extends StatefulWidget {
  const EnglishEntrykangaroo({super.key});

  @override
  State<EnglishEntrykangaroo> createState() => _EnglishEntrykangarooState();
}

class _EnglishEntrykangarooState extends State<EnglishEntrykangaroo> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""kangaroo""");
  }
