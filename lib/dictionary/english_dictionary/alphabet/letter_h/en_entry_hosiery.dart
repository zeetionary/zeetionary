...
class EnglishEntryhosiery extends StatefulWidget {
  const EnglishEntryhosiery({super.key});

  @override
  State<EnglishEntryhosiery> createState() => _EnglishEntryhosieryState();
}

class _EnglishEntryhosieryState extends State<EnglishEntryhosiery> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hosiery (Derived forms: hosieries)
Usage: Brit, Cdn
1. Socks and stockings and tights collectively (the British include underwear) (- hose [Brit])
""",
  );

  final String keyword = "hosiery";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hosiery""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Hosiery is on the second floor, Madam.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/EAAbIA5gPh0?t=';
    const double startSecondsone = 000000000000000000000000000162;
    const String videoIdtwo = 'https://youtu.be/wjFDUKrkOu8?t=';
    const double startSecondstwo = 000000000000000000000000000337;
    const String videoIdthree = 'https://youtu.be/ejXRxee7xkQ?t=';
    const double startSecondsthree = 000000000000000000000000000819;
    const String videoIdfour = 'https://youtu.be/COkjLgzpVmk?t=';
    const double startSecondsfour = 000000000000000000000000000297;
    const String videoIdfive = 'https://youtu.be/GKNy42Kek7c?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hosiery""",
                      // alsoEnglishWord: "also: hosiery",
                      britshText: """IpaUK: /ˈhəʊziəri/""",
                      americanText: """IpaUS: /ˈhəʊʒəri/""",
