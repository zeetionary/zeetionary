                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "applause"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈplɔːz/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakapplause("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈplɔːz/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakapplause("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '-PZQqZ6n25k';
