...
class EnglishEntryexceed extends StatefulWidget {
  const EnglishEntryexceed({super.key});

  @override
  State<EnglishEntryexceed> createState() => _EnglishEntryexceedState();
}

class _EnglishEntryexceedState extends State<EnglishEntryexceed> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exceed""",
                      // alsoEnglishWord: "also: exceed",
                      britshText: """IpaUK: /ɪkˈsiːd/""",
                      americanText: """IpaUS: /ɪkˈsiːd/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The price will not exceed £100.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Summer temperatures rarely exceed 27°C.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Their numbers barely exceed 100 in the wild.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was exceeding the speed limit.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The officers had exceeded their authority.""");
  }
...
"""),
          const DefinitionKurdish(
              text: """١. (کردار) زیاتربوون لە بڕ یان ژمارەیەکی دیاریکراو"""),
          SentencesRow(
            englishText: """The price will not exceed £100.""",
            kurdishText: """نرخەکە ١٠٠ پاوەند تێناپەڕێنێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Summer temperatures rarely exceed 27°C.""",
            kurdishText:
                """پلەی گەرمی هاوین بە کەمی دەچێتە سەروو ٢٧ ـی سیلیزی.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Their numbers barely exceed 100 in the wild.""",
            kurdishText:
                """ژمارەیان لە دەشت‌ودەر بە ئاستەنگ ١٠٠ دانە تێدەپەڕێنێت.""",
          ...
          SentencesRow(
            ...
            kurdishText: """خێرایی ڕێگاپێدراوی تێپەڕاندبوو.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The officers had exceeded their authority.""",
            kurdishText: """ئەفسەرەکان دەسەڵاتی خۆیان تێپەڕاندبوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: exceed (Derived forms: exceeds, exceeding, exceeded)
1. Be greater in scope or size than some standard (= transcend, surpass)
"Their loyalty exceeds their national bonds";
 
2. Be superior or better than some standard (= transcend, overstep, pass, go past, top)
"She exceeded our expectations";
 
3. Be or do something to a greater degree (= surpass, outstrip, outmatch, outgo [archaic], outdo, surmount, outperform)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/nsnyl8llfH4?t=';
const double _startSecondsend = 000000000000000000000000000000; // 209;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1263;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/LxdoC2sG1i4?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 491;
const String _videoIdthree = 'VIDEOhttps://youtu.be/UvjSXBqQe4A?t=';
const double _startSecondsthree = 000000000000000000000000000; // 429;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/XXhc5UTxv5I?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1563;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/ao2Jfm35XeE?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 946;
