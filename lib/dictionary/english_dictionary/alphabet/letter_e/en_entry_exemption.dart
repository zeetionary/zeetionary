...
class EnglishEntryexemption extends StatefulWidget {
  const EnglishEntryexemption({super.key});

  @override
  State<EnglishEntryexemption> createState() => _EnglishEntryexemptionState();
}

class _EnglishEntryexemptionState extends State<EnglishEntryexemption> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exemption""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exemption""",
                      // alsoEnglishWord: "also: exemption",
                      britshText: """IpaUK: /ɪɡˈzempʃn/""",
                      americanText: """IpaUS: /ɪɡˈzempʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exemption";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She was given exemption from the final examination.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The exemption applies to home buyers.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Charities are granted exemption from income tax.""");
  }
...
کوردی: بەخشراوی، هەڵاوێردراوی، جەبە،	تەرخان‌بوون، تەرخانێتی، بەخشران لە باج
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) مۆڵەتدانی فەرمی بە کەسێک کە شتێک نەکات یان پارەی شتێک نەدات کە بە شێوەی ئاسایی دەبێت بیدات"""),
          SentencesRow(
            englishText:
                """She was given exemption from the final examination.""",
            kurdishText: """بەخشینی لە تاقیکردنەوەی کۆتایی پێدرا.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The exemption applies to home buyers.""",
            kurdishText: """بەخشینەکە بۆ کڕیارانی خانووبەرەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Charities are granted exemption from income tax.""",
            kurdishText:
                """ڕێکخراوە خێرخوازییەکان بەخشینیان پێدەدرێت لە باجی سەر داهات.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He applied for exemption from military service.""",
            kurdishText: """داوای بەخشینی لە خزمەتی سەربازی کرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: exemption (Derived forms: exemptions)
1. Immunity from an obligation or duty (= freedom)
...
3. An act exempting someone (= immunity, granting immunity)
"he was granted exemption from prosecution";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/EPYy_g8NzmI?t=';
const double _startSecondsend = 000000000000000000000000000000; // 431;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/nARcrP7GNso?t=';
const double _startSecondsone = 00000000000000000000000000000; // 53;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/j4kI2h3iotA?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 3846;
const String _videoIdthree = 'VIDEOhttps://youtu.be/NG4Ws74RV04?t=';
const double _startSecondsthree = 000000000000000000000000000; // 453;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/QHscMam4W7s?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 427;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/uMlcnmS46SA?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 968;
