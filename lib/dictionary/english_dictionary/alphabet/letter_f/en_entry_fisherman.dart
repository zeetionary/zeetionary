...
class EnglishEntryfisherman extends StatefulWidget {
  const EnglishEntryfisherman({super.key});

  @override
  State<EnglishEntryfisherman> createState() => _EnglishEntryfishermanState();
}

class _EnglishEntryfishermanState extends State<EnglishEntryfisherman> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fisherman (Derived forms: fishermen)
1. Someone whose occupation is catching fish (= fisher, fisherwoman)
"the fisherman caught a 10-pounder";
""",
  );

  final String keyword = "fisherman";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fisherman""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""A keen fisherman caught a record-sized salmon.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fisherman""",
                      // alsoEnglishWord: "also: fisherman",
                      britshText: """IpaUK: /ˈfɪʃəmən/""",
                      americanText: """IpaUS: /ˈfɪʃərmən/""",
...
// With short examples define "fisherman", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """A keen fisherman caught a record-sized salmon.""",
                      kurdishText:
                          """ماسیگرێکی بەپەرۆش سەلەمۆن قەبارە مێژووی گرت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Local fishermen are protesting about the latest government regulations.""",
                      kurdishText:
                          """ماسیگرە خۆجێیەکان ناڕەزایی دەردەبڕن بەرامبەر تازەترین ڕێساکانی حکومەت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/cAfYtXB-qN4?t=';
const double _startSecondsend = 000000000000000000000000000585;
const String _videoIdone = 'https://youtu.be/qpi9epVHYlc?t=';
const double _startSecondsone = 000000000000000000000000000610;
const String _videoIdtwo = 'https://youtu.be/cMBrvHsFD_8?t=';
const double _startSecondstwo = 0000000000000000000000000001425;
const String _videoIdthree = 'https://youtu.be/SsuWS6yE478?t=';
const double _startSecondsthree = 000000000000000000000000000891;
const String _videoIdfour = 'https://youtu.be/TS4AM9mPX-8?t=';
const double _startSecondsfour = 00000000000000000000000000068;
const String _videoIdfive = 'https://youtu.be/oipLbJoV9pM?t=';
const double _startSecondsfive = 00000000000000000000000000071;
