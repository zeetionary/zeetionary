...
// replace these: replace EnglishEntryaffliction - replace speakAffliction - replace affliction - /əˈflɪkʃn/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaffliction extends StatelessWidget {
  EnglishEntryaffliction({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAffliction(String languageCode) async {
    // DOPSUM: CHANGE speakAffliction
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("affliction"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAfflict9644(String languageCode) async {
    ...
    await flutterTts.speak(
        "These poor people are in great affliction."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈflɪkʃn/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '8X1xYpPmKvA';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '4hKpOi09qqE';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'sJEDfAbuutA';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'b0KbZl4upQQ';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'R630_eaXQIc';
