...
class EnglishEntryexhalation extends StatefulWidget {
  const EnglishEntryexhalation({super.key});

  @override
  State<EnglishEntryexhalation> createState() => _EnglishEntryexhalationState();
}

class _EnglishEntryexhalationState extends State<EnglishEntryexhalation> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exhalation""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exhalation""",
                      // alsoEnglishWord: "also: exhalation",
                      britshText: """IpaUK: /ˌekshəˈleɪʃn/""",
                      americanText: """IpaUS: /ˌekshəˈleɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exhalation";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Each exhalation was visible in the cold air.""");
  }
...
کوردی: 
"""),
          const DefinitionKurdish(text: """١. (ناو) هەناسەدانەوە"""),
          SentencesRow(
            englishText: """Each exhalation was visible in the cold air.""",
            kurdishText: """هەر هەناسەدانەوەیەک لە کەشە ساردەکەدا دەبینرا.""",
          ...
          SentencesRow(
            englishText:
                """Carbon dioxide is eliminated from the body during exhalation.""",
            kurdishText:
                """دووەم ئۆکسیدی کاربۆن دەردەکرێت لە جەستە لە ماوەی هەناسەدانەوەدا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: exhalation (Derived forms: exhalations)
1. Exhaled breath (= halitus)
 
2. The act of expelling air from the lungs (= expiration, breathing out)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/LqXZ628YNj4?t=';
const double _startSecondsend = 000000000000000000000000000000; // 196;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/--jhKVdZOJM?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1172;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/k0PSUDvLi8E?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 207;
const String _videoIdthree = 'VIDEOhttps://youtu.be/Solb9uA-tgQ?t=';
const double _startSecondsthree = 000000000000000000000000000; // 4738;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/cGawSOuubA0?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 663;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/J-05m7bboK0?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 906;
