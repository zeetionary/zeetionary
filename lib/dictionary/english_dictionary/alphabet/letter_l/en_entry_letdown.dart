...
class EnglishEntryletdown extends StatefulWidget {
  const EnglishEntryletdown({super.key});

  @override
  State<EnglishEntryletdown> createState() => _EnglishEntryletdownState();
}

class _EnglishEntryletdownState extends State<EnglishEntryletdown> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
Noun: let-down
1. ​something that is disappointing because it is not as good as you expected it to be
""",
  );

  final String keyword = "let-down";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""let-down""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The London exhibition was a bit of a let-down.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/E4-Pz3hSwwQ?t=687';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/W_E9wivFlpE?t=77';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/h_OeMVcol1g?t=854';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/m8dR9apR--4?t=891';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/k1hFnjUFSsY?t=285';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/ekrpXYXTKCw?t=590';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """let-down""",
                      // alsoEnglishWord: "also: let-down",
                      britshText: """IpaUK: /ˈlet daʊn/""",
                      americanText: """IpaUS: /ˈlet daʊn/""",
...
کوردی: 
"""),
// With short examples define "let-down", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) شتێک کە بەو شێوەیە ڕووینەدا کە دەتویست و بەداخەوەیت بۆی"""),
                    const AlsoEnglishckb(word: "ھەروەھا: disappointment، anticlimax"),
                    SentencesRow(
                      englishText: """The London exhibition was a bit of a let-down.""",
                      kurdishText: """پێشانگاکەی لەندەن کەمێک مایەی ناهومێدی بوو.""",
