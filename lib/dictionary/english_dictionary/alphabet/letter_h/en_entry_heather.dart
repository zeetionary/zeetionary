...
class EnglishEntryheather extends StatefulWidget {
  const EnglishEntryheather({super.key});

  @override
  State<EnglishEntryheather> createState() => _EnglishEntryheatherState();
}

class _EnglishEntryheatherState extends State<EnglishEntryheather> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heather (Derived forms: heathers)
1. Common Old World heath represented by many varieties; low evergreen grown widely in the Northern Hemisphere (- ling, Scots heather, broom, Calluna vulgaris)
 
2. Interwoven yarns of mixed colours producing muted greyish shades with flecks of colour (- heather mixture)
""",
  );

  final String keyword = "heather";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heather""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hills were covered in blooming heather.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heather""",
                      // alsoEnglishWord: "also: heather",
                      britshText: """IpaUK: /ˈheðə(r)/""",
                      americanText: """IpaUS: /ˈheðər/""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/XRwrpXf5V6c?t=';
const double _startSecondsend = 000000000000000000000000000370;
const String _videoIdone = 'https://youtu.be/HpFflEJA1ps?t=';
const double _startSecondsone = 000000000000000000000000000737;
const String _videoIdtwo = 'https://youtu.be/VU8vqnITmtY?t=';
const double _startSecondstwo = 0000000000000000000000000001327;
const String _videoIdthree = 'https://youtu.be/7MZoIN9I8oU?t=';
const double _startSecondsthree = 000000000000000000000000000127;
const String _videoIdfour = 'https://youtu.be/WS8lQDEgVcY?t=';
const double _startSecondsfour = 0000000000000000000000000002528;
const String _videoIdfive = 'https://youtu.be/AiKM7VyEXsI?t=';
const double _startSecondsfive = 0000000000000000000000000001792;
