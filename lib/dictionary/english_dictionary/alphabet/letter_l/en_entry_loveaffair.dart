...
class EnglishEntryloveaffair extends StatefulWidget {
  const EnglishEntryloveaffair({super.key});

  @override
  State<EnglishEntryloveaffair> createState() => _EnglishEntryloveaffairState();
}

class _EnglishEntryloveaffairState extends State<EnglishEntryloveaffair> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryloveaffair love affair
WORD_WEB love affair love affair love affair
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "love affair";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""love affair""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """love affair""",
                      // alsoEnglishWord: "also: love affair",
...
کوردی: 
"""),
// With short examples define "love affair", please follow LX instructions
