...
class EnglishEntryerect extends StatefulWidget {
  const EnglishEntryerect({super.key});

  @override
  State<EnglishEntryerect> createState() => _EnglishEntryerectState();
}

class _EnglishEntryerectState extends State<EnglishEntryerect> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """erect""",
                      // alsoEnglishWord: "also: erect",
                      britshText: """IpaUK: /ɪˈrekt/""",
                      americanText: """IpaUS: /ɪˈrekt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The church was erected in 1582.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Police had to erect barriers to keep crowds back.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""An electric fence was erected around the campus.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Stand with your arms by your side and your head erect.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Janice was standing perfectly erect.""");
  }
...
کوردی: ڕاوێستاو، وێستاوی، ڕاست، قیت، قنج، بەل، ڕەق، زیت، ڕەپ، بژەوەبوو، ئەستوونی،	هەستاو، ئێرەق، قیتەوەبوو، هەڵداو، ڕەپ‌بوو، بزواو
"""),
          const DefinitionKurdish(text: """١. (کردار) بنیاتنانی شتێک"""),
          SentencesRow(
            englishText: """The church was erected in 1582.""",
            kurdishText: """کڵێساکە لە ساڵی ١٥٨٢ بنیاتنرا.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """پۆلیس پێویست بوو بەربەست دابنێت بۆ ئەوەی ڕێگری لە جەماوەرەکە بکات.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """An electric fence was erected around the campus.""",
            kurdishText: """پەرژینێکی کارەبایی دانرا لە دەورووبەری کەمپەکە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """بوەستە بەوەی باڵەکانت لە تەنیشتت بێت و سەرت ڕاوەستاو بێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Janice was standing perfectly erect.""",
            kurdishText: """جانیس بە تەواوی بە ڕاوەستاوی وەستابوو.""",
          ...
          const DefinitionKurdish(
              text:
                  """٤. (ھاوەڵناو) چووک یان گۆی مەمک کە توند و ڕەق بووە بەهۆی ورووژانی سێکسی"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """An erect penis is a sign of sexual readiness.""",
            kurdishText: """چووکێکی هەستاو نیشانەی ئامادەیی سێکسییە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: erect (Derived forms: erected, erects, erecting)
1. (construction) Construct, build (= raise, rear, set up, put up)
"erect a barn";
 
2. Cause to rise up (= rear)

- Adjective: erect
1. Not sloping in position or posture; positioned vertically (= vertical, upright)
"an erect stature"; "erect flower stalks"; "for a dog, an erect tail indicates aggression";
 
2. (physiology) of sexual organs; stiff and rigid (= tumid)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/0jltioeaEyY?t=';
const double _startSecondsend = 000000000000000000000000000000; // 396;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/xVQxvthAcLU?t=';
const double _startSecondsone = 00000000000000000000000000000; // 145;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/cY4e0uvp7uI?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 540;
const String _videoIdthree = 'VIDEOhttps://youtu.be/pTk9HnIwEYU?t=';
const double _startSecondsthree = 000000000000000000000000000; // 270;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/y4DTW4B3Sjs?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1048;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/lEgPVrSZa6w?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1391;
