...
class EnglishEntryinimitable extends StatefulWidget {
  const EnglishEntryinimitable({super.key});

  @override
  State<EnglishEntryinimitable> createState() => _EnglishEntryinimitableState();
}

class _EnglishEntryinimitableState extends State<EnglishEntryinimitable> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inimitable""");
  }
