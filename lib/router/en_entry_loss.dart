...
class EnglishEntryloss extends StatefulWidget {
  const EnglishEntryloss({super.key});

  @override
  State<EnglishEntryloss> createState() => _EnglishEntrylossState();
}

class _EnglishEntrylossState extends State<EnglishEntryloss> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryloss loss
WORD_WEB loss loss loss
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "loss";
...
کوردی: 
"""),
// With short examples define "loss", please follow LX instructions
