...
class EnglishEntryinnocuous extends StatefulWidget {
  const EnglishEntryinnocuous({super.key});

  @override
  State<EnglishEntryinnocuous> createState() => _EnglishEntryinnocuousState();
}

class _EnglishEntryinnocuousState extends State<EnglishEntryinnocuous> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""innocuous""");
  }
