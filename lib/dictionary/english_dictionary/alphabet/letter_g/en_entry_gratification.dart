...
class EnglishEntrygratification extends StatefulWidget {
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gratification (Derived forms: gratifications)
1. State of being gratified or satisfied (- satisfaction)
"to my immense gratification he arrived on time"; "dull repetitious work gives no gratification";
 
2. The act or an instance of satisfying
""",
  );

  final String keyword = "gratification";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gratification""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gratification""",
                      // alsoEnglishWord: "also: gratification",
                      britshText: """IpaUK: /ˌɡrætɪfɪˈkeɪʃn/""",
                      americanText: """IpaUS: /ˌɡrætɪfɪˈkeɪʃn/""",
...
"""),
// With short examples define "gratification", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ئەوەی کە دڵخۆش بیت بەهۆی ئەوەی شتەکان بەو شێوەیە ڕوودەدەن کە دەتەوێت یان ئارەزووەکانت بەدی دێن """),
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/djU7rduvo6s?t=';
const double _startSecondsend = 000000000000000000000000000752;
const String _videoIdone = 'https://youtu.be/5CRD9pmqa7s?t=';
const double _startSecondsone = 000000000000000000000000000616;
const String _videoIdtwo = 'https://youtu.be/1h12uwyMZY0?t=';
const double _startSecondstwo = 000000000000000000000000000325;
const String _videoIdthree = 'https://youtu.be/QTJnRbFJvvE?t=';
const double _startSecondsthree = 000000000000000000000000000101;
const String _videoIdfour = 'https://youtu.be/HNSaXAe8tyg?t=';
const double _startSecondsfour = 000000000000000000000000000388;
const String _videoIdfive = 'https://youtu.be/LQtKYbKcPXg?t=';
const double _startSecondsfive = 000000000000000000000000000120;
