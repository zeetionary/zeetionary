...
class EnglishEntrylipstick extends StatefulWidget {
  const EnglishEntrylipstick({super.key});

  @override
  State<EnglishEntrylipstick> createState() => _EnglishEntrylipstickState();
}

class _EnglishEntrylipstickState extends State<EnglishEntrylipstick> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lipstick (Derived forms: lipsticks)
1. Makeup that is used to colour the lips (- lip rouge, lippy [informal])

- Verb: lipstick (Derived forms: lipsticked, lipsticking, lipsticks)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lipstick""");
  }
...
""");
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/HDntl7yzzVI?t=222';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/xTnKpPcbG6s?t=6';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/khOUvmOQExc?t=682';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/IXZ6tqzqVjs?t=4';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/sEnUXSPjPZc';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/Ei1dC03uv9A?t=13';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lipstick""",
                      // alsoEnglishWord: "also: lipstick",
                      britshText: """IpaUK: /ˈlɪpstɪk/""",
                      americanText: """IpaUS: /ˈlɪpstɪk/""",
...
کوردی: 
"""),
// With short examples define "lipstick", please follow LX instructions
