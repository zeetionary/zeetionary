...
class EnglishEntrylegless extends StatefulWidget {
  const EnglishEntrylegless({super.key});

  @override
  State<EnglishEntrylegless> createState() => _EnglishEntryleglessState();
}

class _EnglishEntryleglessState extends State<EnglishEntrylegless> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""legless""");
  }
