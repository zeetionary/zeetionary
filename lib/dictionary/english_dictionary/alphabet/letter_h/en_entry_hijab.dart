...
class EnglishEntryhijab extends StatefulWidget {
  const EnglishEntryhijab({super.key});

  @override
  State<EnglishEntryhijab> createState() => _EnglishEntryhijabState();
}

class _EnglishEntryhijabState extends State<EnglishEntryhijab> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hijab (Derived forms: hijabs)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hijab covers her hair and neck.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She chose a colorful hijab for the special occasion.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Many people follow the hijab to express their faith.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/ScVu6xUPScg?t=';
    const double startSecondsend = 00000000000000000000000000010;
    const String videoIdone = 'https://youtu.be/i2aOr1cNk-0';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/dUjlMY_Y1Mg?t=';
    const double startSecondstwo = 00000000000000000000000000050;
    const String videoIdthree = 'https://youtu.be/EAr9ZiNfNCw?t=';
    const double startSecondsthree = 00000000000000000000000000049;
    const String videoIdfour = 'https://youtu.be/mr5j-Lkk7rw?t=';
    const double startSecondsfour = 0000000000000000000000000004;
    const String videoIdfive = 'https://youtu.be/jUzd_AjILg4?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hijab""",
                      // alsoEnglishWord: "also: hijab",
                      britshText: """IpaUK: /hɪˈdʒɑːb/""",
                      americanText: """IpaUS: /hɪˈdʒɑːb/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) لەچکێک کە زیاتر لەلایەن ژنانی موسڵمانەوە دەبەسترێت"""),
                    SentencesRow(
                      englishText: """The hijab covers her hair and neck.""",
                      kurdishText: """حیجابەکە قژ و ملی دادەپۆشێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She chose a colorful hijab for the special occasion.""",
                      kurdishText:
                          """بۆ بۆنە تایبەتەکە حیجابێکی ڕەنگینی هەڵبژارد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ئەو سیستەمە ئایینییەی کە کۆنترۆڵی پۆشینی حیجاب دەکات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Many people follow the hijab to express their faith.""",
                      kurdishText:
                          """زۆر کەس پابەندی پۆشینی حیجاب دەبن بۆ دەربڕینی باوەڕیان.""",
