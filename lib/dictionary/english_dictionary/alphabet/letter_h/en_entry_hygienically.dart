...
class EnglishEntryhygienically extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hygienically""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'Rf4QoPZQmPM';
    const double startSecondsend = 350;
    const String videoIdone = 'Rf4QoPZQmPM';
    const double startSecondsone = 350;
    const String videoIdtwo = 'iAB4V6s1n3A';
    const double startSecondstwo = 347;
    const String videoIdthree = 'WEjE20-OXLg';
    const double startSecondsthree = 507;
    const String videoIdfour = 'MSRaPMaup0g';
    const double startSecondsfour = 1847;
    const String videoIdfive = 'kqn1ybabfYo';
