...
class EnglishEntryfiendish extends StatefulWidget {
  const EnglishEntryfiendish({super.key});

  @override
  State<EnglishEntryfiendish> createState() => _EnglishEntryfiendishState();
}

class _EnglishEntryfiendishState extends State<EnglishEntryfiendish> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fiendish
1. Extremely evil or cruel; expressive of cruelty or befitting hell (= demonic, diabolic, diabolical, hellish, infernal, satanic, unholy)
"a fiendish despot";
 
2. Very difficult
"the puzzles are fiendish"
""",
  );

  final String keyword = "fiendish";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fiendish""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The detective investigated a fiendish act.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They uncovered a fiendish plan to steal the jewels.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiendish""",
                      // alsoEnglishWord: "also: fiendish",
                      britshText: """IpaUK: /ˈfiːndɪʃ/""",
                      americanText: """IpaUS: /ˈfiːndɪʃ/""",
...
// With short examples define "fiendish", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The detective investigated a fiendish act.""",
                      kurdishText:
                          """پشکنەرەکە لێکۆڵینەوەی لە کارێکی دڕندانە کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پلانێکی شەیتانییان ئاشكرا کرد بۆ دزینی خشڵەکان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She faced a fiendish problem at work that took days to resolve.""",
                      kurdishText:
                          """لە کار ڕووبەڕووی کێشەیەکی سەخت بوونەوە کە چەندین ڕۆژی برد بۆ چارەسەر.""",
...
const double _startSecondsend = 000000000000000000000000000985;
const String _videoIdone = 'https://youtu.be/P1yGmJsipqg?t=';
const double _startSecondsone = 000000000000000000000000000178;
const String _videoIdtwo = 'https://youtu.be/zIADYkHIFDI?t=';
const double _startSecondstwo = 000000000000000000000000000636;
const String _videoIdthree = 'https://youtu.be/9XECUXXbjhU?t=';
const double _startSecondsthree = 000000000000000000000000000346;
const String _videoIdfour = 'https://youtu.be/sWY_hTzfz_M?t=';
const double _startSecondsfour = 0000000000000000000000000006;
const String _videoIdfive = 'https://youtu.be/Lg-nUy2DalM?t=';
const double _startSecondsfive = 0000000000000000000000000001696;
