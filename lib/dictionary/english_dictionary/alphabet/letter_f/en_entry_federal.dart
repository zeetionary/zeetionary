...
// """),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) ھەبوونی سیتەمێک کە بەشەکانی وڵاتێک دەسەڵاتیان بەسەر خۆیاندا ھەیە بەڵام لەلایەن حکومەتێکی ناوەندییەوە کۆنترۆڵ دەکرێن بۆ باسی نیشتیمانی"""),
          SentencesRow(
          ...
          SentencesRow(
            ...
            kurdishText: """بەردەوامی بە بودجەی فیدراڵی بۆ ھونەر دەدەین.""",
...
const double _startSecondsend = 124;
const String _videoIdone = '3C9wZf88y4Q';
const double _startSecondsone = 325;
const String _videoIdtwo = 'DfSnHyIryeY';
const double _startSecondstwo = 159;
const String _videoIdthree = 'b_rjBWmc1iQ';
const double _startSecondsthree = 1369;
const String _videoIdfour = 'vJC4yz7e7HE';
const double _startSecondsfour = 198;
const String _videoIdfive = 'CtWqv0Z3ErM';
