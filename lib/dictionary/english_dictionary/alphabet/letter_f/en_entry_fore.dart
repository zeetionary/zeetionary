...
class EnglishEntryfore extends StatefulWidget {
  const EnglishEntryfore({super.key});

  @override
  State<EnglishEntryfore> createState() => _EnglishEntryforeState();
}

class _EnglishEntryforeState extends State<EnglishEntryfore> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fore
1. (seafaring) situated at or toward the bow of a vessel

- Noun: fore (Derived forms: fores)
1. Front part of a vessel or aircraft (= bow[3], prow, stem)
"he pointed the fore of the boat toward the finish line";

- Adverb: fore
1. Near or toward the bow of a ship or cockpit of a plane (= forward)
"the captain went fore to check the instruments";
""",
  );

  final String keyword = "fore";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The fore section of the boat was damaged in the storm.""");
  }
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە لە بەشی پێشەوەی کەشتی، فڕۆکە، یان ئاژەڵە"""),
                    SentencesRow(
                      englishText:
                          """The fore section of the boat was damaged in the storm.""",
                      kurdishText:
                          """بەشی پێشەوەی بەلەمەکە لە زریانەکەدا زیانی پێگەشت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/iMKwDHPkRLw?t=';
const double _startSecondsend = 000000000000000000000000000205;
const String _videoIdone = 'https://youtu.be/Mb3D2y0QWrc?t=';
const double _startSecondsone = 000000000000000000000000000270;
const String _videoIdtwo = 'https://youtu.be/-IMDJg1nOD8?t=';
const double _startSecondstwo = 0000000000000000000000000001310;
const String _videoIdthree = 'https://youtu.be/F4D5rvGt1FQ?t=';
const double _startSecondsthree = 000000000000000000000000000474;
const String _videoIdfour = 'https://youtu.be/30pvfyBNFMM?t=';
const double _startSecondsfour = 0000000000000000000000000001053;
const String _videoIdfive = 'https://youtu.be/1DAw4sJT-r4?t=';
const double _startSecondsfive = 0000000000000000000000000001846;
