...
class EnglishEntrylowerclass extends StatefulWidget {
  const EnglishEntrylowerclass({super.key});

  @override
  State<EnglishEntrylowerclass> createState() => _EnglishEntrylowerclassState();
}

class _EnglishEntrylowerclassState extends State<EnglishEntrylowerclass> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylowerclass lower class
WORD_WEB lower class lower class lower class
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lower class";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lower class""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lower class""",
                      // alsoEnglishWord: "also: lower class",
...
کوردی: 
"""),
// With short examples define "lower class", please follow LX instructions
