...
class EnglishEntryfrill extends StatefulWidget {
  const EnglishEntryfrill({super.key});

  @override
  State<EnglishEntryfrill> createState() => _EnglishEntryfrillState();
}

class _EnglishEntryfrillState extends State<EnglishEntryfrill> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frill (Derived forms: frills)
1. (palaeontology) a bony plate that curves upward behind the skull of many ceratopsian dinosaurs
 
2. An external body part consisting of feathers or hair about the neck of a bird or other animal (= ruff)
 
3. A strip of pleated material used as a decoration or a trim (= flounce, ruffle, furbelow)
 
4. Ornamental objects of no great value (- falderal, falderol, gimcrackery, gimcrack, nonsense, trumpery [archaic], folderol [archaic])
""",
  );

  final String keyword = "frill";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This model has fewer frills so it costs less.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frill""",
                      // alsoEnglishWord: "also: frill",
                      britshText: """IpaUK: /frɪl/""",
                      americanText: """IpaUS: /frɪl/""",
...
// With short examples define "frill", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) قوماشێکی تەسک کە قەدی زۆری تێدایە و بەستراوە بە قەراغی جلێک، پەردەیەک، هتد بۆ جوانی"""),
                    SentencesRow(
                      englishText:
                          """You could always sew a frill or two around the bottom of the skirt if you think it's too plain.""",
                      kurdishText:
                          """ئەگەر پێت وایە تەنوورەکە زۆر سادەیە، هەمیشە دەتوانیت یەک یان دوو چین لە خوارەوەی بدووریت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەم نموونەیە ڕازاندنەوەی کەمتری هەیە بۆیە کەمتری تێدەچێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/B5ytcg5pYEA?t=';
const double _startSecondsend = 000000000000000000000000000500;
const String _videoIdone = 'https://youtu.be/P10p7ALXkcU?t=';
const double _startSecondsone = 000000000000000000000000000164;
const String _videoIdtwo = 'https://youtu.be/fhn8JrO8xyA?t=';
const double _startSecondstwo = 00000000000000000000000000086;
const String _videoIdthree = 'https://youtu.be/GKLSWP1MHEo?t=';
const double _startSecondsthree = 000000000000000000000000000245;
const String _videoIdfour = 'https://youtu.be/hcUAJNqxrUY?t=';
const double _startSecondsfour = 000000000000000000000000000102;
const String _videoIdfive = 'https://youtu.be/Gq9AfWfByjo?t=';
