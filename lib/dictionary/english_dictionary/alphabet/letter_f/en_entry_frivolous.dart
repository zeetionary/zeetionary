...
class EnglishEntryfrivolous extends StatefulWidget {
  const EnglishEntryfrivolous({super.key});

  @override
  State<EnglishEntryfrivolous> createState() => _EnglishEntryfrivolousState();
}

class _EnglishEntryfrivolousState extends State<EnglishEntryfrivolous> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: frivolous
1. Not serious in content, attitude or behaviour
"a frivolous novel"; "a frivolous remark"; "a frivolous young woman"
""",
  );

  final String keyword = "frivolous";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frivolous""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her words seemed utterly frivolous.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Sorry, I was being frivolous.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I feel like doing something completely frivolous today.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frivolous""",
                      // alsoEnglishWord: "also: frivolous",
                      britshText: """IpaUK: /ˈfrɪvələs/""",
                      americanText: """IpaUS: /ˈfrɪvələs/""",
...
کوردی: بێ‌ئەقڵ، کەم‌ئەقڵ، سووک، سەرچڵ، هەڵەشە، گەوجانە، بێهوودە، سەرسەرەکی، فشە، لەخۆڕایی، بێ‌نرخ، بێ‌بایەخ، هیچەکە
"""),
// With short examples define "frivolous", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Her words seemed utterly frivolous.""",
                      kurdishText: """قسەکانی تەواو پڕوپووچ بوون.""",
                    ...
                    SentencesRow(
                      englishText: """Sorry, I was being frivolous.""",
                      kurdishText: """ببوورە، گەوجانە بووم.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە هیچ سوود یان مەبەستێکی نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I feel like doing something completely frivolous today.""",
                      kurdishText:
                          """حەز دەکەم ئەمڕۆ شتێکی تەواو گەمژانە بکەم.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/bXqZllqGWGQ?t=';
const double _startSecondsend = 000000000000000000000000000887;
const String _videoIdone = 'https://youtu.be/z3QdKnln3yw?t=';
const double _startSecondsone = 000000000000000000000000000127;
const String _videoIdtwo = 'https://youtu.be/QQyup6ZFsvA?t=';
const double _startSecondstwo = 000000000000000000000000000977;
const String _videoIdthree = 'https://youtu.be/s_jaU5V9FUg?t=';
const double _startSecondsthree = 0000000000000000000000000001;
const String _videoIdfour = 'https://youtu.be/kt75MJHCFk4?t=';
const double _startSecondsfour = 000000000000000000000000000545;
const String _videoIdfive = 'https://youtu.be/i_mLxyIXpSY?t=';
