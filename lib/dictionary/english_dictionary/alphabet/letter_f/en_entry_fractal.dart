...
const String _videoIdend = 'BaVpeJlcQzg';
const double _startSecondsend = 867;
const String _videoIdone = 'sY8aFSY2zv4';
const double _startSecondsone = 248;
const String _videoIdtwo = '-RdOwhmqP5s';
const double _startSecondstwo = 0;
const String _videoIdthree = 'uMMQbcisins';
const double _startSecondsthree = 907;
const String _videoIdfour = 'FOkgpfcnG8o';
const double _startSecondsfour = 260;
const String _videoIdfive = '68LWjy7f-tA';
