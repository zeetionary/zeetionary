...
class EnglishEntryfloating extends StatefulWidget {
  const EnglishEntryfloating({super.key});

  @override
  State<EnglishEntryfloating> createState() => _EnglishEntryfloatingState();
}

class _EnglishEntryfloatingState extends State<EnglishEntryfloating> {
  @override
  void initState() {
    super.initState();
...
2. Continually changing especially as from one abode or occupation to another (= aimless, drifting, vagabond, vagrant)
...
- Noun: floating (Derived forms: floatings)
1. The act of someone who floats on the water
""",
  );

  final String keyword = "floating";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""floating""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The city has a large floating population.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """floating""",
                      // alsoEnglishWord: "also: floating",
                      britshText: """IpaUK: /ˈfləʊtɪŋ/""",
                      americanText: """IpaUS: /ˈfləʊtɪŋ/""",
...
// With short examples define "floating", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """شارەکە دانیشتووانێکی زۆری گەڕۆکی هەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The bank has offered us a loan with a floating interest rate.""",
                      kurdishText:
                          """بانکەکە قەرزێکی بە ڕێژەی سووی ناجێگیر پێداین.""",
...
const String _videoIdtwo = 'https://youtu.be/3n99jqOdeSw?t=';
const double _startSecondstwo = 000000000000000000000000000606;
const String _videoIdthree = 'https://youtu.be/CqkhjL3WvWQ?t=';
const double _startSecondsthree = 000000000000000000000000000636;
const String _videoIdfour = 'https://youtu.be/0GUT3Egdd5k?t=';
const double _startSecondsfour = 000000000000000000000000000361;
const String _videoIdfive = 'https://youtu.be/aoXJfuPaFF8?t=';
const double _startSecondsfive = 000000000000000000000000000748;
