...
class EnglishEntryadhoc extends StatefulWidget {
  const EnglishEntryadhoc({super.key});

  @override
  State<EnglishEntryadhoc> createState() => _EnglishEntryadhocState();
}

class _EnglishEntryadhocState extends State<EnglishEntryadhoc> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakadhoc2414(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("The meetings will be held on an ad hoc basis.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ad hoc """,
                      // alsoEnglishWord: "also: ad hoc ",
                      britshText: """IpaUK: /ˌæd ˈhɒk/""",
                      americanText: """IpaUS: /ˌæd ˈhɑːk/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '06EG6jpCBBk';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'iyFT8qXcOrM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'eHSvv8eSsvc';
