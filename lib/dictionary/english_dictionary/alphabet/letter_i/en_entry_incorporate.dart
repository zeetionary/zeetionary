...
class EnglishEntryincorporate extends StatefulWidget {
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: incorporate (Derived forms: incorporated, incorporates, incorporating)
1. Make into a whole or make part of a whole (- integrate)
"She incorporated his suggestions into her proposal";
 
2. Include; have as a component (- contain, comprise)
"The record incorporates many old songs from the 1930's";
...
1. Formed or united into a whole (- incorporated, integrated, merged, unified)
""",
  );

  final String keyword = "incorporate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incorporate""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The data is now incorporated in the total figures.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The company was incorporated in 2008.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """incorporate""",
                      // alsoEnglishWord: "also: incorporate",
                      britshText: """IpaUK: /ɪnˈkɔːpəreɪt/""",
                      americanText: """IpaUS: /ɪnˈkɔːrpəreɪt/""",
...
کوردی: 
"""),
// With short examples define "incorporate", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) لەخۆگرتنی شتێک بە شێوەیەک کە بەشێکی شتێک پێکبهێنێت"""),
                    SentencesRow(
                      englishText:
                          """The new car design incorporates all the latest safety features.""",
                      kurdishText:
                          """دیزاینی ئۆتۆمبێلە تازەکە هەموو تایبەتمەندییەکانی سەلامەتی لەخۆگرتووە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """We have incorporated all the latest safety features into the design.""",
                      kurdishText:
                          """هەموو تایبەتمەندییە تازەکانی سەلامەتیمان لەخۆگرتووە لە دیزاینەکەدا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Many of your suggestions have been incorporated in the plan.""",
                      kurdishText:
                          """زۆرینەی پێشنیارەکانت خراونەتە پلانەکەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """داتاکە دەخرێتە ناو ئامارە گشتییەکان.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) دامەزراندنی کۆمپانیایەکی بە فەرمی ناسێندراو"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The company was incorporated in 2008.""",
                      kurdishText: """کۆمپانیاکە لە ساڵی ٢٠٠٨ دامەزرا.""",
