...
// blank divider
  ...
  Future<void> speakcops1(String languageCode) async {
    ...
    await flutterTts.speak(
        "// speakcops111111111111111111111111111111111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcops2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcops200"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcops3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcops300"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcops4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcops400"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcops5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcops500"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcops6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcops600"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcops7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcops700"); // DOPSUM: CHANGE TEXT
  }
                                ...
                                child: Column(
                                  children: [
                                    ExampleSentenceEnglish(
                                        text:
                                            "// speakcops111111111111111111111111111111111"),
