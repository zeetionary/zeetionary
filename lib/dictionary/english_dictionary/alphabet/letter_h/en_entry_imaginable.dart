...
class EnglishEntryimaginable extends StatefulWidget {
  const EnglishEntryimaginable({super.key});

  @override
  State<EnglishEntryimaginable> createState() => _EnglishEntryimaginableState();
}

class _EnglishEntryimaginableState extends State<EnglishEntryimaginable> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "imaginable";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""imaginable""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The house has the most spectacular views imaginable.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They stock every imaginable type of pasta.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It was the most boring movie imaginable!""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000451;
    const String videoIdone = 'https://youtu.be/a9m3GD0DbPY?t=';
    const double startSecondsone = 000000000000000000000000000268;
    const String videoIdtwo = 'https://youtu.be/KZbzIf_C6Y4?t=';
    const double startSecondstwo = 000000000000000000000000000629;
    const String videoIdthree = 'https://youtu.be/GLXoSXOTVJg?t=';
    const double startSecondsthree = 000000000000000000000000000243;
    const String videoIdfour = 'https://youtu.be/nDs56sVlk2A?t=';
    const double startSecondsfour = 000000000000000000000000000640;
    const String videoIdfive = 'https://youtu.be/Y9Cald-OCPA?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """imaginable""",
                      // alsoEnglishWord: "also: imaginable",
                      britshText: """IpaUK: /ɪˈmædʒɪnəbl/""",
                      americanText: """IpaUS: /ɪˈmædʒɪnəbl/""",
...
کوردی: دەخرێتە بەرچاو، دێنرێتە پێش‌چاو، شیاوی هێنانەبەرچاو
"""),
// With short examples define "imaginable", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) لەگەڵ هاوەڵناوی پلەی باڵا، all، و every بەکاردێت بۆ گوتنی ئەوەی باشترینە، خراپترینە، هتد کە خەیاڵی بکەیت، یان ئەوەی هەموو ئەگەرێک دەگرێتەوە"""),
                    SentencesRow(
                      englishText:
                          """The house has the most spectacular views imaginable.""",
                      kurdishText:
                          """خانووەکە باشترین ئەو دیمەنانەی هەیە کە خەیاڵ بکرێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەموو جۆرێکی خەیاڵکراوی پاستایان هەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بێزارکەرترین فیلم بوو کە خەیاڵ بکرێت.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) کە دەکرێت خەیاڵ بکرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """These technological developments were hardly imaginable 30 years ago.""",
                      kurdishText:
                          """ئەم بەرەوپێشچوونە تەکنەلۆژیایانە بە ئەستەم خەیاڵ دەکران پێش ٣٠ ساڵ.""",
