...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/y1sF6ZeASU0?t=';
    const double startSecondsend = 000000000000000000000000000879;
    const String videoIdone = 'https://youtu.be/QLq6GEiHqR8?t=';
    const double startSecondsone = 000000000000000000000000000488;
    const String videoIdtwo = 'https://youtu.be/MqyJZsGFZ3M?t=';
    const double startSecondstwo = 000000000000000000000000000857;
    const String videoIdthree = 'https://youtu.be/S4qvPouh1gE?t=';
    const double startSecondsthree = 0000000000000000000000000002339;
    const String videoIdfour = 'https://youtu.be/CtWqv0Z3ErM?t=';
    const double startSecondsfour = 000000000000000000000000000263;
    const String videoIdfive = 'https://youtu.be/LJNtfyq3TDE?t=';
