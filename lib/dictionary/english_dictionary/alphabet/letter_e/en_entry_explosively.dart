...
class EnglishEntryexplosively extends StatefulWidget {
  const EnglishEntryexplosively({super.key});

  @override
  State<EnglishEntryexplosively> createState() =>
      _EnglishEntryexplosivelyState();
}

class _EnglishEntryexplosivelyState extends State<EnglishEntryexplosively> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""explosively""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """explosively""",
                      // alsoEnglishWord: "also: explosively",
                      britshText:
                          """IpaUK: /ɪkˈspləʊsɪvli/,  /ɪkˈspləʊzɪvli/""",
                      americanText:
                          """IpaUS: /ɪkˈspləʊsɪvli/,  /ɪkˈspləʊzɪvli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "explosively";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The substance is toxic and explosively flammable.""");
  }
...
"""),
          ...
          SentencesRow(
            englishText:
                """The company has grown explosively over the last two years.""",
            kurdishText:
                """کۆمپانیاکە بە کت‌وپڕانە گەشەی کردووە لە دوو ساڵی ڕابردوودا.""",
...
const String _videoIdone = 'https://youtu.be/jv31A4Ab4nA?t=';
const double _startSecondsone = 000000000000000000000000000499;
const String _videoIdtwo = 'https://youtu.be/fsNhU6H-16I?t=';
const double _startSecondstwo = 000000000000000000000000000560;
const String _videoIdthree = 'https://youtu.be/quxl5xJHxJs?t=';
const double _startSecondsthree = 000000000000000000000000000661;
const String _videoIdfour = 'https://youtu.be/p1ElntiJmME?t=';
const double _startSecondsfour = 000000000000000000000000000408;
const String _videoIdfive = 'https://youtu.be/469chceiiUQ?t=';
const double _startSecondsfive = 000000000000000000000000000145;
