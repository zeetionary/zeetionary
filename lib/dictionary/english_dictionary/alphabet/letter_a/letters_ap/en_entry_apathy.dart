...
// replace EnglishEntryAdopsum - replace speakApathy

// replace apathy - /ˈæpəθi/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryapathy extends StatelessWidget {
  // blank divider
  EnglishEntryapathy({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakapathy(String languageCode) async {
    // DOPSUM: CHANGE speakApathy
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "apathy"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæpəθi/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæpəθi/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'uUR-Zk9S5bE';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '4FE2f2I7hVg';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'RKVSDQaxHjE';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'Skqs0-cmlbo';
