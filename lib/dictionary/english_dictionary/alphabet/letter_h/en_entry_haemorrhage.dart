...
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دۆخێکی تەندرووستی کە دەبێتە ھۆکاری خوێنبەربوونی زۆر بەھۆی زیانگەشتن بە موولوولەیەکی خوێن لە لەشی مرۆڤدا"""),
                    SentencesRow(
                      englishText:
                          """He was checked for any signs of haemorrhage.""",
                      kurdishText:
                          """پشکنینی بۆ کرا بۆ ھەر ئاماژەیەکی خوێنبەربوون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """نەخۆشەکە بە ھۆی خوێنبەربوونی لەناکاوی مێشک مرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) لەدەستدانی زۆری پارە، خەڵک. ھتد لە وڵاتێک، گرووپێک، یان دامەزراوەیەک"""),
                    SentencesRow(
                      englishText:
                          """The newspaper sold its websites in a bid to stem the haemorrhage of cash from the business.""",
                      kurdishText:
                          """ڕۆژنامەکە ماڵپەڕەکانی خۆی فرۆشت لە ھەوڵێکدا بۆ ڕێگری لە لەدەستدانی خێرای پارەی بیزنسەکە.""",
...
const String _videoIdend = '-K2WUezOTDg';
const double _startSecondsend = 434;
const String _videoIdone = 'YCnFYvL17v4';
const double _startSecondsone = 282;
const String _videoIdtwo = 'pdipblQmgnw';
const double _startSecondstwo = 366;
const String _videoIdthree = 'wlbO-DyxwYA';
const double _startSecondsthree = 1133;
const String _videoIdfour = 'VeKq-l2Uzv8';
const double _startSecondsfour = 203;
const String _videoIdfive = 'TankFrHtQiM';
