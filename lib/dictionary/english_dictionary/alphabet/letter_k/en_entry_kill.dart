...
""",
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Dozens of civilians were killed or injured in the attack.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Both members of the crew were killed instantly when the missile hit their aircraft.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Three soldiers were killed in action yesterday.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The terrorists threatened to kill the hostages.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She claims that social media kills relationships.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The defeat last night killed the team's chances of qualifying.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The only way to kill the process is to reboot the computer.""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A cat often plays with a mouse before the kill.""");
  }
...
// With short examples define "kill", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Cancer kills thousands of people every year.""",
                      kurdishText: """شێرپەنجە هەموو ساڵێک هەزاران کەس دەکوژێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ماندوویەتی لەکاتی شۆفێری دەکرێت بگات بە کوشتن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Dozens of civilians were killed or injured in the attack.""",
                      kurdishText: """هەزاران هاوڵاتی مەدەنی کوژران یان بریندار بوون لە هێرشەکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Both members of the crew were killed instantly when the missile hit their aircraft.""",
                      kurdishText: """هەردوو ئەندامی تاقمەکە دەستبەجێ کوژران کە مووشەکەکە دای لە فڕۆکەکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Three soldiers were killed in action (= while fighting) yesterday.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The terrorists threatened to kill the hostages.""",
                      kurdishText: """تیرۆریستەکان هەڕەشەی ئەوەیان بارمتەکان بکوژن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """My mother will kill me (= be very angry with me) when she finds out.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He tried to kill himself with sleeping pills.""",
                      kurdishText: """هەوڵی دا بە حەبی خەو خۆی بکوژێت.""",
                      onPressedBritish: () => speaksentence10("en-GB"),
                      onPressedAmerican: () => speaksentence10("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) وەستاندن یان لەناوبردنی شتێک، یان وای لێ بکەیت کەمتر باش بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She claims that social media kills relationships.""",
                      kurdishText: """بانگەشەی ئەوە دەکات تۆڕە کۆمەڵایەتییەکان پەیوەندییەکان دەکوژێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The defeat last night killed the team's chances of qualifying.""",
                      kurdishText: """شکستەکەی شەوی ڕابردوو شانسی تیمەکەی بۆ شایستەبوون کۆتایی پێهێنا.""",
                      onPressedBritish: () => speaksentence12("en-GB"),
                      onPressedAmerican: () => speaksentence12("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) کوژاندنەوەی لایت یان بزوێنەرێک"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The only way to kill the process is to reboot the computer.""",
                      kurdishText: """تەنها ڕێگا بۆ کۆتایی هێنان بە پڕۆسەکە دووبارە هەڵکردنەوەی کۆمپیوتەرەکەیە.""",
                      onPressedBritish: () => speaksentence14("en-GB"),
                      onPressedAmerican: () => speaksentence14("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) بوون بە هۆکاری ئازار بۆ کەسێک"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (کردار) واکردنی ئەوەی کەسێک زۆر پێبکەنێت"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٦. (ناو) کوشتن، بە تایبەتی کە ئاژەڵێک دەکوژرێت یان ڕاو دەکرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """A cat often plays with a mouse before the kill.""",
                      kurdishText: """پشیلە زۆرجار یاری لەگەڵ مشک دەکات پێش کوشتنی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The plane prepared to move in for the kill.""",
                      kurdishText: """فڕۆکەکە ئامادەکاری بۆ چوون کرد بۆ کوشتنەکە.""",
