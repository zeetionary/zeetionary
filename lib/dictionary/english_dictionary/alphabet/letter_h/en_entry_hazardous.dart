...
class EnglishEntryhazardous extends StatefulWidget {
  const EnglishEntryhazardous({super.key});

  @override
  State<EnglishEntryhazardous> createState() => _EnglishEntryhazardousState();
}

class _EnglishEntryhazardousState extends State<EnglishEntryhazardous> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hazardous
1. Involving risk or danger (- risky, wild)
"skydiving is a hazardous sport";
""",
  );

  final String keyword = "hazardous";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hazardous""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They endured a hazardous journey through thickening fog.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hazardous""",
                      // alsoEnglishWord: "also: hazardous",
                      britshText: """IpaUK: /ˈhæzədəs/""",
                      americanText: """IpaUS: /ˈhæzərdəs/""",
...
کوردی: مەترسی‌دار، پڕمەترسی
"""),
// With short examples define "hazardous", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) مەترسیدار"""),
                    SentencesRow(
                      englishText:
                          """They endured a hazardous journey through thickening fog.""",
                      kurdishText:
                          """بە گەشتێکی مەترسیداردا تێپەڕین بە تەمە بەهێزەکەدا.""",
...
const String _videoIdone = 'https://youtu.be/T48_SrFCdaQ?t=';
const double _startSecondsone = 000000000000000000000000000165;
const String _videoIdtwo = 'https://youtu.be/UvjSXBqQe4A?t=';
const double _startSecondstwo = 000000000000000000000000000686;
...
const double _startSecondsfour = 0000000000000000000000000003431;
const String _videoIdfive = 'https://youtu.be/CupbRr2m_sM?t=';
const double _startSecondsfive = 000000000000000000000000000584;
