...
class EnglishEntryformer extends StatefulWidget {
  const EnglishEntryformer({super.key});

  @override
  State<EnglishEntryformer> createState() => _EnglishEntryformerState();
}

class _EnglishEntryformerState extends State<EnglishEntryformer> {
  @override
  void initState() {
    super.initState();
...
2. Belonging to some prior time (= erstwhile, old, onetime, one-time, quondam, sometime)
"our former glory";
 
3. (used especially of persons) of the immediate past (= late, previous)
"the former president";
 
4. Belonging to the distant past (= early, other)
"former generations";

- Noun: former (Derived forms: formers)
1. The first of two or the first mentioned of two
"Tom and Dick were both heroes but only the former is remembered today"
""",
  );

  final String keyword = "former";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""This ruin was, in former times, a royal castle.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""A former staff member visited the office today.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He met his former teacher at the reunion.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Former Portuguese colonies include Brazil and Mozambique.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The former option would be much more sensible.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """former""",
                      // alsoEnglishWord: "also: former",
                      britshText: """IpaUK: /ˈfɔːmə(r)/""",
                      americanText: """IpaUS: /ˈfɔːrmər/""",
...
کوردی: ڕابردوو، بووری، پێشوو، لەوەپێش، جاران، زوو، بەرین، ساڵان، بەری،	یەکەمین، هەوەڵین، یەکەم، یەکەمین، سەرەتا، پێشین، پێکهێنەر، دامەزرێنەر
"""),
// With short examples define "former", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە پێشووتر بوونی هەبووە"""),
                    SentencesRow(
                      englishText:
                          """This ruin was, in former times, a royal castle.""",
                      kurdishText:
                          """کەلاوەکە لە سەردەمانی کۆندا قەڵایەکی شاهانەیی بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """This beautiful old building has been restored to its former glory.""",
                      kurdishText:
                          """ئەم بینا کۆنە جوانە بۆ شکۆداریی پێشووی نۆژەنکراوەتەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە پێگەیەکی دیاریکراوی هەبووە لە پێشوودا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Former South African president Nelson Mandela was a key figure in ending apartheid.""",
                      kurdishText:
                          """سەرۆکی پێشووتری ئەفریقای باشوور نێڵسن ماندێلا ڕۆڵی گرنگی هەبوو لە کۆتایی هێنان بە ئەپارتاید.""",
                      englishNote:
                          """Apartheid was the former political system in South Africa in which only white people had full political rights and other people, especially black people, were forced to live away from white people, go to separate schools, etc.""",
                    ...
                    SentencesRow(
                      englishText:
                          """A former staff member visited the office today.""",
                      kurdishText:
                          """ئەندانێکی پێشووتری ستافەکە دوێنێ سەردانی ئۆفیسەکەی کرد.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He met his former teacher at the reunion.""",
                      kurdishText:
                          """لە بەیەکدی شادبوونەوە مامۆستا کۆنەکەیی بینی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Former Portuguese colonies include Brazil and Mozambique.""",
                      kurdishText:
                          """کۆڵۆنییە کۆنەکانی پورتوگال بەرازیل و مۆزەمبیق لەخۆدەگرن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵناو) بۆ ناوهێنانی یەکەم شت، کەس، یان خەڵک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The former option would be much more sensible.""",
                      kurdishText:
                          """هەڵبژاردەکەی سەرەتا زۆر گونجاوتر دەبێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He had to choose between giving up his job and giving up his principles. He chose the former.""",
                      kurdishText:
                          """ناچاربوو واز لە کارەکەی یان بەهاکانی بهێنێت. ئەوەی یەکەمی هەڵبژارد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/wE1azf6azWw?t=';
const double _startSecondsend = 000000000000000000000000000495;
...
const double _startSecondstwo = 000000000000000000000000000874;
const String _videoIdthree = 'https://youtu.be/rRymSi8SmqA?t=';
const double _startSecondsthree = 000000000000000000000000000428;
const String _videoIdfour = 'https://youtu.be/bHIhgxav9LY?t=';
const double _startSecondsfour = 000000000000000000000000000230;
const String _videoIdfive = 'https://youtu.be/Mx8JkGHaGUI?t=';
const double _startSecondsfive = 0000000000000000000000000001987;
