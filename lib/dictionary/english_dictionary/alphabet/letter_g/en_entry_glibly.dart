...
class EnglishEntryglibly extends StatefulWidget {
  const EnglishEntryglibly({super.key});

  @override
  State<EnglishEntryglibly> createState() => _EnglishEntrygliblyState();
}

class _EnglishEntrygliblyState extends State<EnglishEntryglibly> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""You can't just glibly dismiss centuries of tradition.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glibly""",
                      // alsoEnglishWord: "also: glibly",
                      britshText: """IpaUK: /ˈɡlɪbli/""",
                      americanText: """IpaUS: /ˈɡlɪbli/""",
...
// With short examples define "glibly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە بە بەکارهێنانی وشەی زیرەکانەیە، بەڵام کە زۆر بیری لێ‌نەکراوەتەوە و لە دڵەوە نییە؛ ئەوەی بە باوەڕبەخۆبوونەوە بێت، بەڵام بە سادەیی و بە بێ بیرکردنەوەی قووڵ"""),
                    SentencesRow(
                      englishText:
                          """You can't just glibly dismiss centuries of tradition.""",
                      kurdishText:
                          """ناتوانیت هەروا چەندین سەدە لە نەریت بە هیچ دابنێیت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/CHjVz6nHh7Y?t=';
const double _startSecondsend = 0000000000000000000000000004305;
const String _videoIdone = 'https://youtu.be/2MuJdA5q6bc?t=';
const double _startSecondsone = 000000000000000000000000000591;
const String _videoIdtwo = 'https://youtu.be/AYxKRoONrfY?t=';
const double _startSecondstwo = 0000000000000000000000000002699;
const String _videoIdthree = 'https://youtu.be/45ey4jgoxeU?t=';
const double _startSecondsthree = 0000000000000000000000000004597;
const String _videoIdfour = 'https://youtu.be/m5Lwwbe7HiI?t=';
const double _startSecondsfour = 0000000000000000000000000001430;
const String _videoIdfive = 'https://youtu.be/gokZgvLPe1g?t=';
const double _startSecondsfive = 0000000000000000000000000001485;
