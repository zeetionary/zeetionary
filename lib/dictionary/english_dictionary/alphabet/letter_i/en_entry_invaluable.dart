...
class EnglishEntryinvaluable extends StatefulWidget {
  const EnglishEntryinvaluable({super.key});

  @override
  State<EnglishEntryinvaluable> createState() => _EnglishEntryinvaluableState();
}

class _EnglishEntryinvaluableState extends State<EnglishEntryinvaluable> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""invaluable""");
  }
