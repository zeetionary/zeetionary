...
class EnglishEntryflashback extends StatefulWidget {
  const EnglishEntryflashback({super.key});

  @override
  State<EnglishEntryflashback> createState() => _EnglishEntryflashbackState();
}

class _EnglishEntryflashbackState extends State<EnglishEntryflashback> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flashback (Derived forms: flashbacks)
1. (literature) a transition (in literary or theatrical works or films) to an earlier event or scene that interrupts the normal chronological development of the story
...
""",
  ...
  final String keyword = "flashback";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flashback""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The reader is told the story in flashback.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I kept having flashbacks of her lying there bleeding.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flashback""",
                      // alsoEnglishWord: "also: flashback",
                      britshText: """IpaUK: /ˈflæʃbæk/""",
                      americanText: """IpaUS: /ˈflæʃbæk/""",
...
// With short examples define "flashback", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بەشێکی فیلمێک، شانۆیەک، هتد کە دیمەنێک پیشان دەدات کە پێش کاتی چیرۆکە سەرەکییەکە ڕوویداوە"""),
                    SentencesRow(
                      englishText:
                          """The reader is told the story in flashback.""",
                      kurdishText:
                          """خوێنەر چیرۆکەکەی بە پاش‌گەڕانەوە پێدەگوترێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The events that led up to the murder were shown in a series of flashbacks.""",
                      kurdishText:
                          """ئەو ڕووداوانەی کە بوونە هۆکاری کووشتنەکە لە زنجیرەیەک فلاشباکدا پیشان دەدرێن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بەردەوام یادەوەریی ئەوەم دەبوو کە لەوێ پاڵ کەوتبوو خوێنی لێدەچوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/8o12WrHBhU0?t=';
const double _startSecondsend = 000000000000000000000000000458;
const String _videoIdone = 'https://youtu.be/Fon7og7w4Yw?t=';
const double _startSecondsone = 000000000000000000000000000572;
const String _videoIdtwo = 'https://youtu.be/fgfqV6SJyHo?t=';
const double _startSecondstwo = 000000000000000000000000000116;
const String _videoIdthree = 'https://youtu.be/YbNeOLbFZVg?t=';
const double _startSecondsthree = 000000000000000000000000000184;
const String _videoIdfour = 'https://youtu.be/-id0F6jnIqo?t=';
const double _startSecondsfour = 000000000000000000000000000102;
const String _videoIdfive = 'https://youtu.be/ndHOav52t7k?t=';
const double _startSecondsfive = 000000000000000000000000000328;
