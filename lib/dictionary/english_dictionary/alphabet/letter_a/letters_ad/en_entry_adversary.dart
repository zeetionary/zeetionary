...
// replace these: replace EnglishEntryadversary - replace speakAdversary - replace adversary - /ˈædvərsəri/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadversary extends StatelessWidget {
  EnglishEntryadversary({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdversary(String languageCode) async {
    // DOPSUM: CHANGE speakAdversary
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("adversary"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAdver66982(String languageCode) async {
    ...
    await flutterTts.speak(
        "He saw her as his main adversary within the company."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "adversary", // DOPSUM: CHANGE WORD ENTRY - Find /ˈædvəsəri/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈædvəsəri/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˈædvərsəri/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
