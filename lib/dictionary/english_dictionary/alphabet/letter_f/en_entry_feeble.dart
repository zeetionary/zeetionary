...
کوردی: کز، لاواز، جووقن، جیقن، بێ‌ھێز، پەککەوتە، لاکەوتە، داکەوتوو، سست، بێ‌دەس، بەسزمان، دەستەوسان،	لێ‌نەوەشاو، لێ‌نەھاتوو،	ناکاریگەر
"""),
          ...
          SentencesRow(
            ...
            kurdishText: """ھێندە لاواز مەبە! پێی بڵێ ناتەوێت بچیت.""",
...
const String _videoIdend = 'JTslqcXsFd4';
const double _startSecondsend = 65;
const String _videoIdone = 'BuX6-lvUwd0';
const double _startSecondsone = 119;
const String _videoIdtwo = 's3YTfhJmh1I';
const double _startSecondstwo = 94;
const String _videoIdthree = 'udDv4IHOhDo';
const double _startSecondsthree = 75;
const String _videoIdfour = 'Q-nWA0WeF98';
const double _startSecondsfour = 345;
const String _videoIdfive = 'vc90NQpY_4s';
