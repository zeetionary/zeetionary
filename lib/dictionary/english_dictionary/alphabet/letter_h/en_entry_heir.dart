...
class EnglishEntryheir extends StatefulWidget {
  const EnglishEntryheir({super.key});

  @override
  State<EnglishEntryheir> createState() => _EnglishEntryheirState();
}

class _EnglishEntryheirState extends State<EnglishEntryheir> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heir (Derived forms: heirs)
1. A person who is entitled by law or by the terms of a will to inherit the estate of another (- inheritor, heritor, distributee [US])
 
2. A person who inherits some title or office (- successor)
""",
  );

  final String keyword = "heir";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""At the age of twenty he fell heir to a large estate.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He has no heir to leave his fortune to.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He left most of his property to his eldest son.""");
  }
...
کوردی: بەشبەر، میراتگر، میراتبەر
"""),
// With short examples define "heir", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە مافی یاسایی هەیە زەوی و پارەی کەسێک وەربگرێت لە دوای مردنی"""),
                    SentencesRow(
                      englishText:
                          """At the age of twenty he fell heir to a large estate.""",
                      kurdishText:
                          """لە تەمەنی بیست ساڵیدا بوو بە میراتگری زەوی‌وزارێکی گەورە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هیچ میراتگری نییە کە سامانەکەی بۆ بەجێبهێڵێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He left most of his property to his eldest son.""",
                      kurdishText:
                          """زۆرینەی سامانەکەی بۆ میراتگرەکەی جێهێشت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) کەسێک کە باوەڕ وایە بەردەوامی بە نەریتێک دەدات کە کەسێکی دیکە دەستی پێکردووە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The socialists saw themselves as true heirs of the Enlightenment.""",
                      kurdishText:
                          """سۆشیالیستەکان خۆیان بە جێگرەوەی ڕاستی سەردەمی ڕۆشنگەری بینی.""",
...
const double _startSecondsend = 0000000000000000000000000001231;
const String _videoIdone = 'https://youtu.be/mY3SEMTROas?t=';
const double _startSecondsone = 000000000000000000000000000458;
const String _videoIdtwo = 'https://youtu.be/pLwHTqU2r_Y?t=';
const double _startSecondstwo = 000000000000000000000000000338;
const String _videoIdthree = 'https://youtu.be/Ot4qdCs54ZE?t=';
const double _startSecondsthree = 000000000000000000000000000704;
const String _videoIdfour = 'https://youtu.be/9hdT8PgT19w?t=';
const double _startSecondsfour = 000000000000000000000000000338;
const String _videoIdfive = 'https://youtu.be/HnzNZ0Mdx4I?t=';
