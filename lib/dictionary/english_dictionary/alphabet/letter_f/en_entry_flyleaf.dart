...
class EnglishEntryflyleaf extends StatefulWidget {
  const EnglishEntryflyleaf({super.key});

  @override
  State<EnglishEntryflyleaf> createState() => _EnglishEntryflyleafState();
}

class _EnglishEntryflyleafState extends State<EnglishEntryflyleaf> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flyleaf (Derived forms: flyleaves)
1. A blank leaf in the front or back of a book
""",
  );

  final String keyword = "flyleaf";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flyleaf""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The author signed the book on the flyleaf.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flyleaf""",
                      // alsoEnglishWord: "also: flyleaf",
                      britshText: """IpaUK: /ˈflaɪliːf/""",
                      americanText: """IpaUS: /ˈflaɪliːf/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پەڕەیەکی بەتاڵ لە سەرەتا یان کۆتایی کتێب"""),
                    SentencesRow(
                      englishText:
                          """The author signed the book on the flyleaf.""",
                      kurdishText:
                          """نووسەرەکە لەسەر پەڕە بەتاڵەکە کتێبەکەی واژۆ دەکرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/TYka4NBMiWg?t=';
const double _startSecondsend = 000000000000000000000000000631;
const String _videoIdone = 'https://youtu.be/Q9xWifX87eI?t=';
const double _startSecondsone = 000000000000000000000000000356;
const String _videoIdtwo = 'https://youtu.be/_LfkVMFKgbY?t=';
const double _startSecondstwo = 000000000000000000000000000300;
const String _videoIdthree = 'https://youtu.be/v8iMneNOdx4?t=';
const double _startSecondsthree = 0000000000000000000000000001405;
const String _videoIdfour = 'https://youtu.be/QW9okbgXcZw?t=';
const double _startSecondsfour = 00000000000000000000000000060;
const String _videoIdfive = 'https://youtu.be/hwPVwsBqoFo?t=';
const double _startSecondsfive = 000000000000000000000000000582;
