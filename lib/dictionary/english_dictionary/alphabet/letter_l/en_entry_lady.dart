...
class EnglishEntrylady extends StatefulWidget {
  const EnglishEntrylady({super.key});

  @override
  State<EnglishEntrylady> createState() => _EnglishEntryladyState();
}

class _EnglishEntryladyState extends State<EnglishEntrylady> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lady (Derived forms: ladies)
1. A polite name for any woman
"a nice lady at the library helped me"
 
2. A woman of refinement (- dame, madam, ma'am, gentlewoman [archaic])
"a chauffeur opened the door of the limousine for the grand lady";

- Noun: Lady
Usage: Brit
1. A woman of the peerage in Britain (- noblewoman [Brit], peeress [Brit])
""",
  );

  final String keyword = "lady";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There's a lady waiting to see you.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was with an attractive young lady.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""And who is this lovely lady?""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She's a tough lady.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His wife was a real lady.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You could at least try to behave like a lady.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Can I take your coats, ladies?""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Could I have your attention, ladies and gentlemen?""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Listen, lady, don't shout at me.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Could you tell me where the ladies is?""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/YCBxFfnWKRg?t=165';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/3vBHcq4JEEk?t=190';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/dJxP85txY9I?t=629';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/Vx0MQxIFBW8?t=10';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/N0N_p05lo1c?t=93';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/qmgTn199WOE?t=98';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lady""",
                      // alsoEnglishWord: "also: lady",
                      britshText: """IpaUK: /ˈleɪdi/""",
                      americanText: """IpaUS: /ˈleɪdi/""",
...
کوردی: خانم، یایە، خاتوون، خاتوو، بانوو، ژن
"""),
// With short examples define "lady", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ژن"""),
                    SentencesRow(
                      englishText: """There's a lady waiting to see you.""",
                      kurdishText: """خانمێک چاوەڕێتە.""",
                    ...
                    SentencesRow(
                      englishText: """He was with an attractive young lady.""",
                      kurdishText: """لەگەڵ ژنێکی گەنجی جوان بوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """And who is this lovely lady?""",
                      kurdishText: """و ئەم خانمە جوانە کێیە؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She's a tough lady.""",
                      kurdishText: """خانمێکی سەرسەختە.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) ژنێکی بەڕێز و باش پەروەردەکراو"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """His wife was a real lady.""",
                      kurdishText: """ژنەکەی خانمێکی تەواو بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هیچ نەبێت دەکرێت وەک خانمێک ڕەفتار بکەیت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) کە قسە لەسەر یان لەگەڵ کچێک یان ژنێک دەکەیت کە نایناسیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Can I take your coats, ladies?""",
                      kurdishText: """دەکرێت قەمسەڵەکانتان بگرم خانمان؟.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەکرێت گوێم بۆ بگرن، بەڕێزان و خانمان؟""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ناو) ڕێگایەکی نافەرمی بۆ قسەکردن لەگەڵ ژنێک و پیشان نەدانی ڕێز"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Listen, lady, don't shout at me.""",
                      kurdishText: """گوێ بگرە ژنێ، هاوار مەکە بەسەرم دا.""",
                      onPressedBritish: () => speaksentence9("en-GB"),
                      onPressedAmerican: () => speaksentence9("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٥. (ناو) سەرئاوی ژنان لە بینایەکی گشتی"""),
                    const AlsoEnglishckb(
                        word: "ھەروەھا: ladies’ room، women's room"),
                    SentencesRow(
                      englishText: """Could you tell me where the ladies is?""",
                      kurdishText:
                          """دەکرێت پیم بڵێیت سەرئاوی ژنان لە کوێیە؟""",
