...
class EnglishEntryevaluate extends StatefulWidget {
  const EnglishEntryevaluate({super.key});

  @override
  State<EnglishEntryevaluate> createState() => _EnglishEntryevaluateState();
}

class _EnglishEntryevaluateState extends State<EnglishEntryevaluate> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evaluate""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evaluate""",
                      // alsoEnglishWord: "also: evaluate",
                      britshText: """IpaUK: /ɪˈvæljueɪt/""",
                      americanText: """IpaUS: /ɪˈvæljueɪt/""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: evaluate (Derived forms: evaluates, evaluating, evaluated)
1. Estimate or determine the nature, value, quality, ability, extent, or significance of (= measure, valuate, assess, appraise, value, scope)
"I will have the family jewels evaluated by a professional";
 
2. Form a critical opinion of (= pass judgment, judge)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/WUjVPIEtJd0?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1025;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/yWhU40m-6uU?t=';
const double _startSecondsone = 00000000000000000000000000000; // 236;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/LoqwZBkYWqE?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 190;
const String _videoIdthree = 'VIDEOhttps://youtu.be/HAnw168huqA?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1443;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/MqyJZsGFZ3M?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1294;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/Fop2oskTug8?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 200;
