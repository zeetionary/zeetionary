...
class EnglishEntrygraffiti extends StatefulWidget {
  const EnglishEntrygraffiti({super.key});

  @override
  State<EnglishEntrygraffiti> createState() => _EnglishEntrygraffitiState();
}

class _EnglishEntrygraffitiState extends State<EnglishEntrygraffiti> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""graffiti""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Someone had scrawled graffiti all over the school walls.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Racist graffiti was sprayed on the walls.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """graffiti""",
                      // alsoEnglishWord: "also: graffiti",
                      britshText: """IpaUK: /ɡrəˈfiːti/""",
                      americanText: """IpaUS: /ɡrəˈfiːti/""",
...
// With short examples define "graffiti", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کەسێک گرافیتی لەسەر ھەموو دیواری قوتابخانەکە نووسیبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """گرافیتی ڕەگەزپەرستانە لسەر دیوارەکان نووسرا بوو.""",
...
const String _videoIdtwo = '_F750c50014';
...
const String _videoIdfive = '2-MLV_RJ6KQ';
