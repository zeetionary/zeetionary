...
class EnglishEntryextradite extends StatefulWidget {
  const EnglishEntryextradite({super.key});

  @override
  State<EnglishEntryextradite> createState() => _EnglishEntryextraditeState();
}

class _EnglishEntryextraditeState extends State<EnglishEntryextradite> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extradite""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extradite""",
                      // alsoEnglishWord: "also: extradite",
                      britshText: """IpaUK: /ˈekstrədaɪt/""",
                      americanText: """IpaUS: /ˈekstrədaɪt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extradite";
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) ناردنەوەی تاوانبارێک بۆ وڵاتێک کە تێیدا تاوانەکە ئەنجام دراوە"""),
          SentencesRow(
            englishText:
                """The British government attempted to extradite the suspects from Belgium.""",
            kurdishText:
          ...
          SentencesRow(
            englishText:
                """The courts have refused to extradite the suspects from Spain.""",
            kurdishText:
                """دادگاکان ڕەتیان کردووەتەوە گومان لێکراوەکان لە ئیسپانیاوە ڕادەست بکەن.""",
...
const String _videoIdend = 'https://youtu.be/jFYi2QRVFOc?t=';
const double _startSecondsend = 000000000000000000000000000313;
const String _videoIdone = 'https://youtu.be/4l8M3dQlUwg?t=';
const double _startSecondsone = 0000000000000000000000000002161;
const String _videoIdtwo = 'https://youtu.be/MLIehuS4xyw?t=';
const double _startSecondstwo = 0000000000000000000000000001197;
const String _videoIdthree = 'https://youtu.be/XvVCc1Ts0MA?t=';
const double _startSecondsthree = 000000000000000000000000000253;
const String _videoIdfour = 'https://youtu.be/tmUximhgYnI?t=';
const double _startSecondsfour = 000000000000000000000000000142;
const String _videoIdfive = 'https://youtu.be/B7V9KZjm_rs?t=';
const double _startSecondsfive = 0000000000000000000000000001595;
