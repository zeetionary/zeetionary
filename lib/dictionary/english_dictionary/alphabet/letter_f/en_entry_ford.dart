...
class EnglishEntryford extends StatefulWidget {
  const EnglishEntryford({super.key});

  @override
  State<EnglishEntryford> createState() => _EnglishEntryfordState();
}

class _EnglishEntryfordState extends State<EnglishEntryford> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: ford (Derived forms: fords)
1. The shallow area of a river or stream where it can be crossed without a bridge (= crossing)
 
2. The act of crossing a stream or river by wading, in a car or on a horse (= fording)

- Verb: ford (Derived forms: forded, fords, fording)
1. Cross a river where it's shallow

- Noun: Ford (Derived forms: Fords)
1. United States manufacturer of automobiles who pioneered mass production (1863-1947) (= Henry Ford)
 
2. English writer and editor (1873-1939) (= Ford Madox Ford, Ford Hermann Hueffer)
 
3. Son of Henry Ford (1893-1943) (= Edsel Ford, Edsel Bryant Ford)
 
4. 38th President of the United States; appointed vice president and succeeded Nixon when Nixon resigned (1913-2006) (= Gerald Ford, Gerald R. Ford, Gerald Rudolph Ford, President Ford)
 
5. United States film maker (1896-1973) (= John Ford)
 
6. Grandson of Henry Ford (1917-1987) (= Henry Ford II)
""",
  );

  final String keyword = "ford";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The ford was deeper after the heavy rain.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They forded the stream to continue their journey.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ford""",
                      // alsoEnglishWord: "also: ford",
                      britshText: """IpaUK: /fɔːd/""",
                      americanText: """IpaUS: /fɔːrd/""",
...
کوردی: بوار، بڕ، دەراڤ، تەنکاو، جێ‌پەڕینەوە
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بەشێکی ڕووبارێک کە دەکرێت پێیدا بچیت بە پێ یان ئۆتۆمبێل"""),
                    SentencesRow(
                      englishText:
                          """The ford was deeper after the heavy rain.""",
                      kurdishText:
                          """جێ‌پەڕینەوەکە قووڵتر بوو لە دوای بارانە بەهێزەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە زێیەکە پەڕینەوە بۆ بەردەوامی دان بە گەشتەکەیان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/PXsZntwnArQ?t=';
const double _startSecondsend = 000000000000000000000000000163;
const String _videoIdone = 'https://youtu.be/KGqexebCcUo?t=';
const double _startSecondsone = 000000000000000000000000000671;
const String _videoIdtwo = 'https://youtu.be/YxkPuEmIX4U?t=';
const double _startSecondstwo = 000000000000000000000000000358;
const String _videoIdthree = 'https://youtu.be/VU8vqnITmtY?t=';
const double _startSecondsthree = 0000000000000000000000000001367;
const String _videoIdfour = 'https://youtu.be/PUETWFRhowE?t=';
const double _startSecondsfour = 0000000000000000000000000004948;
const String _videoIdfive = 'https://youtu.be/erka8USiBgM?t=';
const double _startSecondsfive = 0000000000000000000000000005420;
