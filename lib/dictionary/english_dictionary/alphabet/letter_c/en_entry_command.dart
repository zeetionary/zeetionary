...
کوردی: دەستوور، فەرمان، فەروار،	(کامپیوتێر) دەستوور، فەرمان،	فەرمانداری، فەرماندەری، سەرکردایەتی،	کەرت، یەکینە، یەکە،	کاربەدەستان، فەرماندەران، سەرکردەکان،	دەسەڵات، سەردەستی، باڵادەستی، زاڵی، سواری، کۆنتڕۆڵ، چاودێری، هێزپێ‌شکان
"""),
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/7yW6Ybj6tOk?t=',
    startSeconds: 59,
    autoPlay: true,
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/Ml1cfQnxSd0?t=',
    startSeconds: 5,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/BnJ013X02b8?t=',
    startSeconds: 50,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/XbXawCXKBhY?t=',
    startSeconds: 157,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/xg_1UjZqMdQ?t=',
    startSeconds: 618,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/IvgeLaM1wl4?t=',
    startSeconds: 6,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
