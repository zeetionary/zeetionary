...
// blank divider
  ...
  Future<void> speakcooks4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcooks400"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcooks5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcooks500"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcooks6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcooks600"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcooks7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcooks700"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcooks8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcooks800"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcooks9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcooks900"); // DOPSUM: CHANGE TEXT
  }
