...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/a9m3GD0DbPY?t=';
    const double startSecondsend = 0000000000000000000000000002286;
    const String videoIdone = 'https://youtu.be/a7wC2M0b5u0?t=';
    const double startSecondsone = 0000000000000000000000000001299;
    const String videoIdtwo = 'https://youtu.be/kUE2fPLOUxo?t=';
    const double startSecondstwo = 000000000000000000000000000614;
    const String videoIdthree = 'https://youtu.be/yRFPjBuRRCg?t=';
    const double startSecondsthree = 000000000000000000000000000483;
    const String videoIdfour = 'https://youtu.be/UrkPC81_QfU?t=';
    const double startSecondsfour = 000000000000000000000000000507;
    const String videoIdfive = 'https://youtu.be/ySOKrCusEjw?t=';
    const double startSecondsfive = 0000000000000000000000000001067;
