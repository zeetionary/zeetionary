...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001226;
    const String videoIdone = 'https://youtu.be/HH3C1pYXCl0?t=';
    const double startSecondsone = 000000000000000000000000000702;
    const String videoIdtwo = 'https://youtu.be/BugC71BYEmg?t=';
    const double startSecondstwo = 00000000000000000000000000070;
    const String videoIdthree = 'https://youtu.be/HdwzJLTLFqc?t=';
    const double startSecondsthree = 000000000000000000000000000768;
    const String videoIdfour = 'https://youtu.be/00yC_W0fUPE?t=';
    const double startSecondsfour = 00000000000000000000000000068;
    const String videoIdfive = 'https://youtu.be/DoxI_3RhVUg?t=';
    const double startSecondsfive = 000000000000000000000000000988;
