...
class EnglishEntryfoghorn extends StatefulWidget {
  const EnglishEntryfoghorn({super.key});

  @override
  State<EnglishEntryfoghorn> createState() => _EnglishEntryfoghornState();
}

class _EnglishEntryfoghornState extends State<EnglishEntryfoghorn> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foghorn (Derived forms: foghorns)
1. A loud low warning signal that can be heard by fogbound ships (= fogsignal)
 
2. A warning device consisting of a horn that generates a loud low tone
""",
  );

  final String keyword = "foghorn";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foghorn""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He's got a voice like a foghorn.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foghorn""",
                      // alsoEnglishWord: "also: foghorn",
                      britshText: """IpaUK: /ˈfɒɡhɔːn/""",
                      americanText: """IpaUS: /ˈfɑːɡhɔːrn/""",
...
// With short examples define "foghorn", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """He's got a voice like a foghorn (= a loud unpleasant voice).""",
                      kurdishText: """دەنگی وەک هۆرنی تەمە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/23NbEOXRkCg?t=';
const double _startSecondsend = 000000000000000000000000000351;
const String _videoIdone = 'https://youtu.be/HYfQYJlgmUc?t=';
const double _startSecondsone = 0000000000000000000000000002664;
const String _videoIdtwo = 'https://youtu.be/nbax8SYZ0Ro?t=';
const double _startSecondstwo = 000000000000000000000000000767;
const String _videoIdthree = 'https://youtu.be/9JjSr4di8ug?t=';
const double _startSecondsthree = 000000000000000000000000000324;
const String _videoIdfour = 'https://youtu.be/Dss094oxbQo?t=';
const double _startSecondsfour = 000000000000000000000000000574;
const String _videoIdfive = 'https://youtu.be/SiPq0AViBsI?t=';
const double _startSecondsfive = 000000000000000000000000000336;
