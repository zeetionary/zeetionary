...
class EnglishEntryhelper extends StatefulWidget {
  const EnglishEntryhelper({super.key});

  @override
  State<EnglishEntryhelper> createState() => _EnglishEntryhelperState();
}

class _EnglishEntryhelperState extends State<EnglishEntryhelper> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: helper (Derived forms: helpers)
1. A person who contributes to the fulfilment of a need or furtherance of an effort or purpose (- assistant, help, supporter, aid)
"my invaluable helper";
 
2. A person who helps people or institutions (especially with financial help) (- benefactor)
""",
  );

  final String keyword = "helper";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He recruited a band of willing helpers.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We rely on volunteer helpers.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """helper""",
                      // alsoEnglishWord: "also: helper",
                      britshText: """IpaUK: /ˈhelpə(r)/""",
                      americanText: """IpaUS: /ˈhelpər/""",
...
کوردی: یاریدەدەر، یارمەتیدەر، یاریەدەر، یار، بازگورد، دەسگر، ئاریکار، ئالیکار، هاریکار، کۆمەک، دەستە، دڵسۆز،	بەردەس، کڵفەت، کارکەر
"""),
// With short examples define "helper", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە یارمەتیی کەسێک دەدات لە کردنی شتێک"""),
                    SentencesRow(
                      englishText:
                          """He recruited a band of willing helpers.""",
                      kurdishText:
                          """باندێکی یارمەتیدەرانی ئامادەی بە کرێ گرت.""",
...
const double _startSecondsend = 000000000000000000000000000879;
const String _videoIdone = 'https://youtu.be/HYzv2I2R5o8?t=';
const double _startSecondsone = 000000000000000000000000000656;
const String _videoIdtwo = 'https://youtu.be/0Cl7TY92rd4?t=';
const double _startSecondstwo = 000000000000000000000000000110;
const String _videoIdthree = 'https://youtu.be/gngPQ771Ahk?t=';
const double _startSecondsthree = 0000000000000000000000000002306;
const String _videoIdfour = 'https://youtu.be/V2ec7EE0pB8?t=';
const double _startSecondsfour = 000000000000000000000000000447;
const String _videoIdfive = 'https://youtu.be/u8yL3I_6Oco?t=';
const double _startSecondsfive = 000000000000000000000000000986;
