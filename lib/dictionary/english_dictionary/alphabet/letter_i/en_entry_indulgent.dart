...
class EnglishEntryindulgent extends StatefulWidget {
  const EnglishEntryindulgent({super.key});

  @override
  State<EnglishEntryindulgent> createState() => _EnglishEntryindulgentState();
}

class _EnglishEntryindulgentState extends State<EnglishEntryindulgent> {
  @override
  void initState() {
    super.initState();
...
2. Tolerant or lenient (- lenient, soft)
"indulgent parents risk spoiling their children";
 
3. Being favourably inclined
"an indulgent attitude"
""",
  );

  final String keyword = "indulgent";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indulgent""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was less indulgent towards her daughter.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was usually very indulgent with her.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/AJAkMojjOWg';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/WTr1lObW5Z8?t=';
    const double startSecondstwo = 0000000000000000000000000001508;
    const String videoIdthree = 'https://youtu.be/K0j2dlBMzUs?t=';
    const double startSecondsthree = 0000000000000000000000000001617;
    const String videoIdfour = 'https://youtu.be/RQ1nY51txoA';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/wHy-bc39dHQ?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indulgent""",
                      // alsoEnglishWord: "also: indulgent",
                      britshText: """IpaUK: /ɪnˈdʌldʒənt/""",
                      americanText: """IpaUS: /ɪnˈdʌldʒənt/""",
...
کوردی: ئاسانگر، شل‌گرتوو، بەدەمەوەدەر، ئازادکردوو، نەرم، لێبوردە
"""),
// With short examples define "indulgent", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) هەبوونی مەیلی ئەوەی ڕێگا بە کەسێک بدەیت کە ئەوە بکات کە دەیەوێت"""),
                    SentencesRow(
                      englishText:
                          """She was less indulgent towards her daughter.""",
                      kurdishText: """ژەم شل‌گرتوو بوو بەرامبەر کچەکەی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """زۆرجار زۆر بەدەمەوەی بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He had been a strict father but was indulgent to/towards his grandchildren.""",
                      kurdishText:
                          """باوکێکی توند بووبوو بەڵام نەرم بوو بەرامبەر نەوەکانی.""",
