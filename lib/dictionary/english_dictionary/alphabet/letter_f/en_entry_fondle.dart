...
class EnglishEntryfondle extends StatefulWidget {
  const EnglishEntryfondle({super.key});

  @override
  State<EnglishEntryfondle> createState() => _EnglishEntryfondleState();
}

class _EnglishEntryfondleState extends State<EnglishEntryfondle> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: fondle (Derived forms: fondled, fondling, fondles)
1. Touch or stroke lightly in a loving or endearing manner (= caress)
"They fondled in the back seat of the taxi";
""",
  );

  final String keyword = "fondle";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He kissed and fondled her face and neck.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She fondled the dog’s ears affectionately.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fondle""",
                      // alsoEnglishWord: "also: fondle",
                      britshText: """IpaUK: /ˈfɒndl/""",
                      americanText: """IpaUS: /ˈfɑːndl/""",
...
// With short examples define "fondle", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) دەستهێنان بە شتێک، بە تایبەتی بە لایەنی سێکسی"""),
                    AlsoEnglishckblink(
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕووخسار و ملی ماچ کرد و دەستی پێداهێنان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە خۆشەویستییەوە دەستی هێنا بە گوێی سەگەکەدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/A8f_aHL1ALI?t=';
const double _startSecondsend = 000000000000000000000000000641;
const String _videoIdone = 'https://youtu.be/jMw1NAwYDbQ?t=';
const double _startSecondsone = 000000000000000000000000000635;
const String _videoIdtwo = 'https://youtu.be/6YHBCeTyxEc';
...
const String _videoIdfour = 'https://youtu.be/O1U770Bp-Uc?t=';
const double _startSecondsfour = 000000000000000000000000000706;
const String _videoIdfive = 'https://youtu.be/gCY2EPJdxTo?t=';
const double _startSecondsfive = 0000000000000000000000000001389;
