...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = '0zXfDafyyao';
    const double startSecondsone = 109;
    const String videoIdtwo = 'g01YnqH-2ek';
    const double startSecondstwo = 34;
    const String videoIdthree = '4Ep9N4tJjOc';
    const double startSecondsthree = 940;
    const String videoIdfour = 'ycFziHLcxdY';
    const double startSecondsfour = 845;
    const String videoIdfive = 'V2ec7EE0pB8';
    const double startSecondsfive = 1584;
