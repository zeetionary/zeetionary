...
class EnglishEntryimmaculately extends StatefulWidget {
  const EnglishEntryimmaculately({super.key});

  @override
  State<EnglishEntryimmaculately> createState() =>
      _EnglishEntryimmaculatelyState();
}

class _EnglishEntryimmaculatelyState extends State<EnglishEntryimmaculately> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "immaculately";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""immaculately""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The cemetery is immaculately kept.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His book is immaculately researched.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/1zINzDBXxjw?t=';
    const double startSecondsend = 000000000000000000000000000827;
    const String videoIdone = 'https://youtu.be/9_HJFOxde0s?t=';
    const double startSecondsone = 000000000000000000000000000241;
    const String videoIdtwo = 'https://youtu.be/ligo_LBPfiE?t=';
    const double startSecondstwo = 000000000000000000000000000378;
    const String videoIdthree = 'https://youtu.be/2WftyuqGuv4?t=';
    const double startSecondsthree = 000000000000000000000000000551;
    const String videoIdfour = 'https://youtu.be/3k6cA27iWy8?t=';
    const double startSecondsfour = 000000000000000000000000000450;
    const String videoIdfive = 'https://youtu.be/G2yFknYhDVQ?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """immaculately""",
                      // alsoEnglishWord: "also: immaculately",
                      britshText: """IpaUK: /ɪˈmækjələtli/""",
                      americanText: """IpaUS: /ɪˈmækjələtli/""",
...
کوردی: خاوێن، پاک، جوان، بێ‌عەیب،	لە ڕووی پاکی‌یەوە
"""),
// With short examples define "immaculately", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەکی تەواو پاک و ڕێک بەبێ هیچ خاڵ و پیسییەک"""),
                    SentencesRow(
                      englishText: """The cemetery is immaculately kept.""",
                      kurdishText: """گۆڕستانەکە بە پاکی ڕادەگیردرێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بە شێوەیەک کە هیچ هەڵەو ناتەواوی تێدا نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """His book is immaculately researched.""",
                      kurdishText:
                          """کتێبەکەی بە بێ‌هەڵە لێکۆڵینەوەی بۆ کراوە.""",
