...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'SY3y6zNTiLs';
    const double startSecondsend = 150;
    const String videoIdone = 'io6wi8DVZ3o';
    const double startSecondsone = 512;
    const String videoIdtwo = 'JKFvCjItGDg';
    const double startSecondstwo = 915;
    const String videoIdthree = 'sqlJcJfKZJw';
    const double startSecondsthree = 69;
    const String videoIdfour = 'tkLZYEIslWM';
    const double startSecondsfour = 189;
    const String videoIdfive = 'RsZM1u5IH3Y';
