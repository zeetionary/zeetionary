...
class EnglishEntryfreeenterprise extends StatefulWidget {
  const EnglishEntryfreeenterprise({super.key});

  @override
  State<EnglishEntryfreeenterprise> createState() =>
      _EnglishEntryfreeenterpriseState();
}

class _EnglishEntryfreeenterpriseState
    extends State<EnglishEntryfreeenterprise> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "free enterprise";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""free enterprise""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""In a free enterprise system, anyone can start a business.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: free enterprise",
                      britshText: """IpaUK: /ˌfriː ˈentəpraɪz/""",
                      americanText: """IpaUS: /ˌfriː ˈentərpraɪz/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئابووریی ئازاد یان سەربەست؛ سیستەمێکی ئابووری کە تێیدا بازرگانییەکان ڕکابەری دەکەن بەبێ دەستێوەردانی حکومەت"""),
                    SentencesRow(
                      englishText:
                          """In a free enterprise system, anyone can start a business.""",
                      kurdishText:
                          """لە سیستەمێکی ئابووریی ئازاددا هەموو کەس دەتوانێت بازرگانییەک دەست پێبکات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/qw-FLc7Z01Q?t=';
const double _startSecondsend = 000000000000000000000000000100;
const String _videoIdone = 'https://youtu.be/OCrxD19DHA8?t=';
const double _startSecondsone = 00000000000000000000000000056;
const String _videoIdtwo = 'https://youtu.be/aQirG0u2NLg?t=';
const double _startSecondstwo = 00000000000000000000000000013;
const String _videoIdthree = 'https://youtu.be/JfqDvi8b4gg?t=';
const double _startSecondsthree = 000000000000000000000000000742;
const String _videoIdfour = 'https://youtu.be/znsx7RFXDt8?t=';
const double _startSecondsfour = 000000000000000000000000000198;
const String _videoIdfive = 'https://youtu.be/rQLBitV69Cc?t=';
