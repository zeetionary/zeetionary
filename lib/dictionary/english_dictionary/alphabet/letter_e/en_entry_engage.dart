...
class EnglishEntryengage extends StatefulWidget {
  const EnglishEntryengage({super.key});

  @override
  State<EnglishEntryengage> createState() => _EnglishEntryengageState();
}

class _EnglishEntryengageState extends State<EnglishEntryengage> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """engage""",
                      // alsoEnglishWord: "also: engage",
                      britshText: """IpaUK: engage""",
                      americanText: """IpaUS: engage""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It is a movie that engages both the mind and the eye.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Their pleas failed to engage any sympathy.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It was difficult to engage the students at first.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She has already engaged a lawyer.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was immediately engaged as a consultant.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She has the ability to engage with young minds.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He ordered his men to engage the enemy.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The fleet sailed out of Cadiz to engage with the enemy.""");
  }
...
کوردی: بەکار گرتن، دامەزراندن، نیشان کردن، ناودێڕ کردن، سەرقاڵکردن
"""),
          const DefinitionKurdish(text: """١. (کردار) ڕاگرتنی سەرنجی کەسێک"""),
          SentencesRow(
            englishText:
                """It is a movie that engages both the mind and the eye.""",
            kurdishText: """فیلمێکە کە هەردوو هزر و چاو ڕادەکێشێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Their pleas failed to engage any sympathy.""",
            kurdishText: """پاڕانەوەکانیان نەیتوانی هیچ سۆزێک بەدەست بهێنێت.""",
          ...
          SentencesRow(
            ...
            kurdishText: """سەرەتا سەخت بوو قوتابییەکان دڵخۆش بکرێن.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) بەکرێگرتنی کەسێک، کۆمپانیایەک، هتد بۆ کردنی کارێک"""),
          const DividerSentences(),
          SentencesRow(
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He was immediately engaged as a consultant.""",
            kurdishText: """دەستبەجێ وەک ڕاوێژکارێک گیردرا.""",
            onPressedBritish: () => speaksentence5("en-GB"),
            onPressedAmerican: () => speaksentence5("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٣. (کردار) بەژداربوون و هەوڵدان بۆ کردنی شتێک"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """She has the ability to engage with young minds.""",
            kurdishText: """توانای هەیە لە کەسانی گەنج تێبگات.""",
          ...
          SentencesRow(
            englishText:
                """We acknowledge the need to engage directly with these problems.""",
            kurdishText:
                """دان بەو پێویستییە دەنێین کە دەبێت ڕاستەوخۆ لەم کێشانە تێبگەین.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """کەشتی‌گەلەکە لە کادیزەوە دەرچوو بۆ ڕووبەڕووبوونەوەی دوژمن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: engage (Derived forms: engaged, engaging, engages)
...
3. Start in a job or pay to do a particular piece of work (= hire, employ)
"They engaged two new secretaries in the department";
 
4. Ask to represent; of legal counsel
 
5. Give to in marriage (= betroth [archaic], affiance [literary], plight [archaic])
...
9. Engage for service under a term of contract (= lease, rent, hire, charter, take)
"Let's engage a car";
 
10. Keep engaged (= mesh, lock, operate)
"engaged the gears";
...
const double _startSecondsend = 710;
const String _videoIdone = 'https://youtu.be/Gv4Af83KFrE?t=';
const double _startSecondsone = 73;
const String _videoIdtwo = 'https://youtu.be/_0RTH57v66I?t=';
...
const String _videoIdfour = 'https://youtu.be/f5NJQiY9AuY?t=';
const double _startSecondsfour = 325;
const String _videoIdfive = 'https://youtu.be/0pAz6LTdTrw?t=';
const double _startSecondsfive = 223;
const String _videoIdsix = 'https://youtu.be/FUHkTs-Ipfg?t=';
const double _startSecondssix = 1026;
