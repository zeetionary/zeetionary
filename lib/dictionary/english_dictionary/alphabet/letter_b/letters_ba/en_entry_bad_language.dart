...
class EnglishEntrybadlanguage extends StatelessWidget {
  ...
  Future<void> speakBadlanguages7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBadlanguages77"); // DOPSUM: CHANGE TEXT
  }
                        ...
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˌbæd ˈlæŋɡwɪdʒ/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "8zFEppGYEKA";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "JqGCFfOhd-M";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "kz_HcIb6EfY";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "UEy_HQu2hqg";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "4ElutMJx_28";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "szybEhqUmVI";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "ewMDtyYPCK0";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "gd6rIngnSCA";
