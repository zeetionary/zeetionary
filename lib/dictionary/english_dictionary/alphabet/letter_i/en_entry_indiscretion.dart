...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/4l8M3dQlUwg?t=';
    const double startSecondsend = 0000000000000000000000000002206;
    const String videoIdone = 'https://youtu.be/0UABTaB-_i8?t=';
    const double startSecondsone = 000000000000000000000000000288;
    const String videoIdtwo = 'https://youtu.be/spr5smxuO5E?t=';
    const double startSecondstwo = 000000000000000000000000000523;
    const String videoIdthree = 'https://youtu.be/PFo9-7VX2K8?t=';
    const double startSecondsthree = 000000000000000000000000000369;
    const String videoIdfour = 'https://youtu.be/iwSTob1q0TA?t=';
    const double startSecondsfour = 00000000000000000000000000055;
    const String videoIdfive = 'https://youtu.be/IyxM9CvV3q8?t=';
