...
class EnglishEntrylure extends StatefulWidget {
  const EnglishEntrylure({super.key});

  @override
  State<EnglishEntrylure> createState() => _EnglishEntrylureState();
}

class _EnglishEntrylureState extends State<EnglishEntrylure> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylure lure
WORD_WEB lure lure lure
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lure";
...
کوردی: 
"""),
// With short examples define "lure", please follow LX instructions
