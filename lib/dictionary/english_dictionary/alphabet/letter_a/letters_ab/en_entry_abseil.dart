...
// replace these: EnglishEntryabseil - speakAbseil - abseil - /ˈæbseɪl/

enum TtsState { playing }

class EnglishEntryabseil extends StatelessWidget {
  EnglishEntryabseil({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAbseil(String languageCode) async {
    // DOPSUM: CHANGE speakAbseil
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("abseil"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakA6271(String languageCode) async {
    ...
    await flutterTts.speak(
        "I was a little scared when I first abseiled."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'abseil', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈæbseɪl/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˈæbseɪl/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'KAzSEZqrbO0';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'tydks9RpJ2k';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'jS9GK9KGFxA';
