...
class EnglishEntryexciting extends StatefulWidget {
  const EnglishEntryexciting({super.key});

  @override
  State<EnglishEntryexciting> createState() => _EnglishEntryexcitingState();
}

class _EnglishEntryexcitingState extends State<EnglishEntryexciting> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exciting""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exciting""",
                      // alsoEnglishWord: "also: exciting",
                      britshText: """IpaUK: /ɪkˈsaɪtɪŋ/""",
                      americanText: """IpaUS: /ɪkˈsaɪtɪŋ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This is an exciting opportunity for me.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It's an exciting time for the entire industry.""");
  }
...
کوردی: ورووژێنەر، هەژێنەر، هاندەر، بزوێنەر
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) کە خۆشی و شادی زۆر درووست دەکات"""),
          SentencesRow(
            englishText: """This is an exciting opportunity for me.""",
            kurdishText: """ئەمە هەلێکی خۆشە بۆ من.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """It's an exciting time for the entire industry.""",
            kurdishText: """کاتێکی هەژێنەرە بۆ تەواوی پیشەسازییەکە.""",
          ...
          SentencesRow(
            englishText:
                """It's the most exciting thing that's happened to these people in a long time.""",
            kurdishText:
                """بزوێنەرترین شتە کە بەسەر ئەم خەڵکە هاتبێت لە ماوەیەکی زۆرەوە.""",
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/_wNsZEqpKUA?t=';
const double _startSecondsend = 000000000000000000000000000000; // 320;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/FHJ3CMWnVxY';
...
const double _startSecondstwo = 00000000000000000000000000000; // 141;
const String _videoIdthree = 'VIDEOhttps://youtu.be/qWAagS_MANg?t=';
const double _startSecondsthree = 000000000000000000000000000; // 665;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/QLq6GEiHqR8?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1583;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/55XJ1ObZKaM?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 141;
