...
class EnglishEntryfortune extends StatefulWidget {
  const EnglishEntryfortune({super.key});

  @override
  State<EnglishEntryfortune> createState() => _EnglishEntryfortuneState();
}

class _EnglishEntryfortuneState extends State<EnglishEntryfortune> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fortune (Derived forms: fortunes)
1. An unknown and unpredictable phenomenon that causes an event to result one way rather than another (= luck, chance, hazard)
"bad fortune caused his downfall";
 
2. A large amount of wealth or prosperity
 
3. An unknown and unpredictable phenomenon that leads to a favourable outcome (= luck)
"it was as if fortune guided his hand";
 
4. Your overall circumstances or condition in life (including everything that happens to you) (= destiny, fate, luck, lot, circumstances, portion, circs [Brit, informal])
"whatever my fortune may be";
""",
  );

  final String keyword = "fortune";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fortune""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He made a fortune in real estate.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Her father made his fortune selling electronics.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""A car like that costs a small fortune.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He amassed a fortune of nearly £2 billion.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Fortune smiled on me.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fortune""",
                      // alsoEnglishWord: "also: fortune",
                      britshText: """IpaUK: /ˈfɔːtʃuːn/""",
                      americanText: """IpaUS: /ˈfɔːrtʃən/""",
...
کوردی: بەخت، شانس، چارەنووس، فاڵ، قسمەت،	خۆش‌بەختی، بەختیاری، بەختەوەری،	سەرکەوتن، ڕووداو، ڕێکەوت، پێش‌هات، 	سامان، دەوڵەت، ماڵ، دارایی، پارەیەکی زۆر، لۆدە پارەیێ
"""),
// With short examples define "fortune", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سامانێکی پەیدا کرد لە بازاڕی خانووبەرە.""",
                      englishNote:
                          """This means that he earned a lot of money through his work in buying, selling, or managing properties.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سامانەکەیی پەیدا کرد بە فرۆشتنی ئامێری کارەبایی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئۆتۆمبێلێکی وەک ئەوە سووکە سامانێکی تێدەچێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سامانی نزیکەی ٢ ملیار پاوەندی کۆکردەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I have had the good fortune to work with some brilliant directors.""",
                      kurdishText:
                          """شانسی ئەوەم هەبوو کار لەگەڵ ژمارەیەک دەرهێنەری ناوازە بکەم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بەختی باش ڕووێ تێکردم.""",
                    ...
                    SentencesRow(
                      englishText:
                          """As good fortune would have it, a bus came along just when I needed it.""",
                      kurdishText:
                          """وەک ئەوەی بەختی باش هێنابووبێتی، پاسێک هات ڕێک کە من پێویستم بوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) ئەو شتە باش و خراپانەی کە بەسەر کەسێک، خێزانێک، وڵاتێک، هتد دێن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The team had a dramatic reversal of fortunes in the second half.""",
                      kurdishText:
                          """تیمەکە لە نیوەی دووەمدا گۆڕانکارییەکی دراماتیکی لە چارەنووسیدا ڕوویدا.""",
                      onPressedBritish: () => speaksentence9("en-GB"),
                      onPressedAmerican: () => speaksentence9("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (ناو) چارەنووس یان داهاتووی کەسێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She can tell your fortune by looking at the lines on your hand.""",
                      kurdishText:
                          """دەتوانێت چارەنووست بخوێنێتەوە بە سەیرکردنی هێڵەکانی دەستت.""",
