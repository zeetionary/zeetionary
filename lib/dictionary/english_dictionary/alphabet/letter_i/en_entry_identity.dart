...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 000000000000000000000000000579;
    const String videoIdtwo = 'https://youtu.be/zZM57oTu9Ng?t=';
    const double startSecondstwo = 000000000000000000000000000199;
    const String videoIdthree = 'https://youtu.be/Js2UoMSumx4?t=';
    const double startSecondsthree = 000000000000000000000000000886;
    const String videoIdfour = 'https://youtu.be/x6btmJSRueE?t=';
    const double startSecondsfour = 000000000000000000000000000144;
    const String videoIdfive = 'https://youtu.be/YrMGIqecu0Y?t=';
    const double startSecondsfive = 0000000000000000000000000001228;
