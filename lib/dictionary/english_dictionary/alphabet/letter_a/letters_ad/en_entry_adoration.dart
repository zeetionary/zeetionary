...
class EnglishEntryadoration extends StatefulWidget {
  const EnglishEntryadoration({super.key});

  @override
  State<EnglishEntryadoration> createState() => _EnglishEntryadorationState();
}

class _EnglishEntryadorationState extends State<EnglishEntryadoration> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "adoration";
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = '-_nka_Nkli8';
    const double startSecondstwo = 354;
    const String videoIdthree = '6klHvO4EPG8';
    const double startSecondsthree = 579;
    const String videoIdfour = 'EeGz7KGno1A';
    const double startSecondsfour = 63;
    const String videoIdfive = 'VS93y0-YEhc';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """adoration""",
                      // alsoEnglishWord: "also: adoration",
                      britshText: """IpaUK: /ˌædəˈreɪʃn/""",
                      americanText: """IpaUS: /ˌædəˈreɪʃn/""",
