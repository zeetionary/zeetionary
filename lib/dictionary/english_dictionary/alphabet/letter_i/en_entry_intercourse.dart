...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '-C3CjOkF-jY';
    const double startSecondsend = 198;
    const String videoIdone = 'WDetHC86Dgo';
    const double startSecondsone = 262;
    const String videoIdtwo = 'xbIdoL_Zm0c';
    const double startSecondstwo = 633;
    const String videoIdthree = 'cMBrvHsFD_8';
    const double startSecondsthree = 626;
    const String videoIdfour = '0foq0Krn9yI';
    const double startSecondsfour = 0;
    const String videoIdfive = '41agvCBlicE';
