...
class EnglishEntryliquid extends StatefulWidget {
  const EnglishEntryliquid({super.key});

  @override
  State<EnglishEntryliquid> createState() => _EnglishEntryliquidState();
}

class _EnglishEntryliquidState extends State<EnglishEntryliquid> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: liquid (Derived forms: liquids)
1. The state in which a substance exhibits a characteristic readiness to flow with little or no tendency to disperse and relatively high incompressibility (- liquidness, liquidity, liquid state)
...
2. Changed from a solid to a liquid state (- melted, liquified)
"rivers filled to overflowing by liquid snow";
 
3. Filled or brimming with tears (- swimming)
"sorrow made the eyes of many grow liquid";
 
4. Clear and bright (- limpid)
...
6. Unconstrained and flowing smoothly in movement (- fluent, fluid, smooth)
"the liquid grace of a ballerina";
 
7. In cash or easily convertible to cash (- fluid)
"liquid assets";
""",
  );

  final String keyword = "liquid";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She poured the dark brown liquid down the sink.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Empty the liquid into a large bowl.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Reduce the liquid by boiling for two minutes.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Water is liquid at room temperature.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He is a handsome man with dark, liquid eyes.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She has very few liquid assets as most of her wealth is tied up in property.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The girls had gathered into a liquid, dancing group.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/qWAagS_MANg?t=106';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/AAGIi62-sAU?t=881';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/rEdl2Uetpvo?t=196';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/W8uXhQnWgj4?t=78';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/dqcSk-EDrRo?t=254';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/kGg44zdgHYM?t=210';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """liquid""",
                      // alsoEnglishWord: "also: liquid",
                      britshText: """IpaUK: /ˈlɪkwɪd/""",
                      americanText: """IpaUS: /ˈlɪkwɪd/""",
...
کوردی: ئاوەکی، وەکوو ئاو، ڕوون، ڕۆشن، درەوشاوە، ورشاوە، بریقاوە،	(دەنگ) زوڵاڵ، ڕەوان، پاراو،	(زوو) وردەوەبوو، (ئاسان) نەغدەوەبوو،	شلە
"""),
// With short examples define "liquid", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) شلە"""),
                    SentencesRow(
                      englishText: """She poured the dark brown liquid down the sink.""",
                      kurdishText: """شلە قاوەییە تۆخەکەی ڕژاندە ناو ئاوەڕۆکە.""",
                    ...
                    SentencesRow(
                      englishText: """Empty the liquid into a large bowl.""",
                      kurdishText: """شلەکە بەتاڵ بکە ناو دەفرێکی گەورە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Reduce the liquid by boiling for two minutes.""",
                      kurdishText: """شلەکە کەم بکەرەوە بە کوڵاندنی بۆ دوو خولەک.""",
                      englishNote: """This means to make the liquid less in quantity by heating it so some of it evaporates during the two minutes of boiling.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵناو) کە لە شێوەی شلیدا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Water is liquid at room temperature.""",
                      kurdishText: """ئاو شلەیە لە پلەی گەرمیی ژووردا.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ھاوەڵناو) کە شێوەیەکی ڕوونی هەیە وەک ئاو"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He is a handsome man with dark, liquid eyes.""",
                      kurdishText: """پیاوێکی قۆزە و چاوی تاریکی ئاوی هەیە.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ھاوەڵناو) کە پارەی کاشە یان بە ئاسانی دەکرێت بە پارەی کاش، نەک وەبەرهێنان یان زەوی‌وزار بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She has very few liquid assets as most of her wealth is tied up in property.""",
                      kurdishText: """ڕێژەیەکی کەم لە سامانی وشکی هەیە بەو پێیەی زۆرینەی سەروەتەکەی لە زەوی‌وزاردایە.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    // const DividerDefinition(),
                    // const DefinitionKurdish(text: """٥. (ھاوەڵناو) کە ئەوە لەخۆ دەگرێت کە جەستە بە هێواشی و بەردەوام بجووڵێت"""),
                    // const DividerSentences(),
                    // SentencesRow(
                    //   englishText: """The girls had gathered into a liquid, dancing group.""",
                    //   kurdishText: """کچەکان کۆببوونەوە بۆ گرووپێکی سەماکاری .""",
