...
class EnglishEntryfortuitous extends StatefulWidget {
  const EnglishEntryfortuitous({super.key});

  @override
  State<EnglishEntryfortuitous> createState() => _EnglishEntryfortuitousState();
}

class _EnglishEntryfortuitousState extends State<EnglishEntryfortuitous> {
  @override
  void initState() {
    super.initState();
...
1. Having no cause or apparent cause (= causeless, uncaused)
...
""",
  ...
  final String keyword = "fortuitous";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fortuitous""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fortuitous""",
                      // alsoEnglishWord: "also: fortuitous",
                      britshText: """IpaUK: /fɔːˈtjuːɪtəs/""",
                      americanText: """IpaUS: /fɔːrˈtuːɪtəs/""",
...
// کوردی: بەهەڵکەوت، بەڕێکەوت، خۆوشانسی، شانسی، پێشبینی‌نەکراو، ڕێگاڕەوی، ڕاگوزەری،	پیرۆز، باش
// """),
// With short examples define "fortuitous", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """His success depended on a fortuitous combination of circumstances.""",
                      kurdishText:
                          """سەرکەوتنەکەی پشتی بەست بە ژمارەیەک هەلومەرجی بەشانسی پێکەوە گرێدراو.""",
                      englishNote:
                          "This means that his success happened because a fortunate and unexpected series of events came together in a way that helped him succeed.",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/WTSy_JjCTGg?t=';
const double _startSecondsend = 000000000000000000000000000457;
const String _videoIdone = 'https://youtu.be/bHVOqTIeT1k?t=';
const double _startSecondsone = 000000000000000000000000000325;
const String _videoIdtwo = 'https://youtu.be/Bi_Tp1H9CDs?t=';
const double _startSecondstwo = 000000000000000000000000000819;
const String _videoIdthree = 'https://youtu.be/6klHvO4EPG8?t=';
const double _startSecondsthree = 000000000000000000000000000195;
const String _videoIdfour = 'https://youtu.be/PVF1NDrHPeo?t=';
const double _startSecondsfour = 000000000000000000000000000513;
const String _videoIdfive = 'https://youtu.be/leD3jExiP2Y?t=';
