...
// replace these: replace EnglishEntrytheaccustomed - replace speakAccustomed - replace accustomed - /əˈkʌstəmd/ - find Dopsum2

enum TtsState { playing }

class EnglishEntrytheaccustomed extends StatelessWidget {
  EnglishEntrytheaccustomed({Key? key}) : super(key: key);
