...
class EnglishEntryflavourless extends StatefulWidget {
  const EnglishEntryflavourless({super.key});

  @override
  State<EnglishEntryflavourless> createState() =>
      _EnglishEntryflavourlessState();
}

class _EnglishEntryflavourlessState extends State<EnglishEntryflavourless> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flavourless
Usage: Brit, Cdn (US: flavorless)
1. Lacking taste, flavour or tang (= bland, flat, flavorless [US], insipid, savorless [US], savourless [Brit, Cdn], vapid)
"flavourless supermarket tomatoes"; "a flavourless diet";
""",
  );

  final String keyword = "flavourless";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flavourless""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""These grapes are completely flavourless.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flavourless""",
                      // alsoEnglishWord: "also: flavourless",
                      britshText: """IpaUK: /ˈfleɪvələs/""",
                      americanText: """IpaUS: /ˈfleɪvərləs/""",
...
// With short examples define "flavourless", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەم ترێیانە تەواو بێ‌تامن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/DvwtPD6o_z4?t=';
const double _startSecondsend = 0000000000000000000000000001170;
const String _videoIdone = 'https://youtu.be/nbCgfiqq-5c?t=';
const double _startSecondsone = 000000000000000000000000000159;
const String _videoIdtwo = 'https://youtu.be/EOWeN9hCXd4?t=';
const double _startSecondstwo = 000000000000000000000000000193;
const String _videoIdthree = 'https://youtu.be/WrXLOVYXSGU?t=';
const double _startSecondsthree = 000000000000000000000000000126;
const String _videoIdfour = 'https://youtu.be/HqzMzND33XA?t=';
const double _startSecondsfour = 000000000000000000000000000478;
const String _videoIdfive = 'https://youtu.be/OnhxY27jlSU?t=';
