...
class EnglishEntryfluorescent extends StatefulWidget {
  const EnglishEntryfluorescent({super.key});

  @override
  State<EnglishEntryfluorescent> createState() =>
      _EnglishEntryfluorescentState();
}

class _EnglishEntryfluorescentState extends State<EnglishEntryfluorescent> {
  @override
  void initState() {
    super.initState();
...
2. Brilliantly coloured and apparently giving off light
"fluorescent colours"

- Noun: fluorescent (Derived forms: fluorescents) 
1. A lighting fixture that uses a fluorescent lamp (= fluorescent fixture)
""",
  );

  final String keyword = "fluorescent";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fluorescent""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Fluorescent bulbs use less electricity than incandescent bulbs.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        """Workers in fluorescent orange vests were working on the bridge.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fluorescent""",
                      // alsoEnglishWord: "also: fluorescent",
                      britshText: """IpaUK: /fləˈresnt/""",
                      americanText: """IpaUS: /fləˈresnt/""",
...
// With short examples define "fluorescent", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Fluorescent bulbs use less electricity than incandescent bulbs.""",
                      kurdishText:
                          """گڵۆپی فلۆرسنت کەمتر کارەبا بەکاردەهێنێت وەک گڵۆپی گەرمیدەر.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە کاتێک ڕۆشنایی بەردەکەوێت زۆر ڕۆشن دەردەکەوێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Workers in fluorescent orange vests were working on the bridge.""",
                      kurdishText:
                          """کرێکارەکان بە جاکێتی پرتەقاڵیی بریقەدار لەسەر پردەکە کاریان دەکرد.""",
...
const double _startSecondsend = 0000000000000000000000000001684;
const String _videoIdone = 'https://youtu.be/LwZIxGAG8xA?t=';
const double _startSecondsone = 00000000000000000000000000092;
const String _videoIdtwo = 'https://youtu.be/Oij-BdIkPgQ?t=';
const double _startSecondstwo = 000000000000000000000000000872;
const String _videoIdthree = 'https://youtu.be/5zI9sG3pjVU?t=';
const double _startSecondsthree = 000000000000000000000000000818;
const String _videoIdfour = 'https://youtu.be/l554kV12Wuo?t=';
const double _startSecondsfour = 000000000000000000000000000177;
const String _videoIdfive = 'https://youtu.be/zIADYkHIFDI?t=';
const double _startSecondsfive = 0000000000000000000000000001032;
