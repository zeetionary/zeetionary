...
class EnglishEntryinefficiency extends StatefulWidget {
  const EnglishEntryinefficiency({super.key});

  @override
  State<EnglishEntryinefficiency> createState() =>
      _EnglishEntryinefficiencyState();
}

class _EnglishEntryinefficiencyState extends State<EnglishEntryinefficiency> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: inefficiency (Derived forms: inefficiencies)
1. Unskillfulness resulting from a lack of efficiency
""",
  );

  final String keyword = "inefficiency";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inefficiency""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It is a troubled organization, plagued by inefficiencies.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/a9_JPgwW9nw?t=';
    const double startSecondsend = 000000000000000000000000000191;
    const String videoIdone = 'https://youtu.be/NG4Ws74RV04?t=';
    const double startSecondsone = 0000000000000000000000000001876;
    const String videoIdtwo = 'https://youtu.be/L6WDq0V5oBg?t=';
    const double startSecondstwo = 000000000000000000000000000332;
    const String videoIdthree = 'https://youtu.be/QEZ3x9ouNZk?t=';
    const double startSecondsthree = 0000000000000000000000000001202;
    const String videoIdfour = 'https://youtu.be/U9jirFqex6g?t=';
    const double startSecondsfour = 0000000000000000000000000001033;
    const String videoIdfive = 'https://youtu.be/aaiIl8J26fo?t=';
    const double startSecondsfive = 000000000000000000000000000151;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inefficiency""",
                      // alsoEnglishWord: "also: inefficiency",
                      britshText: """IpaUK: /ˌɪnɪˈfɪʃnsi/""",
                      americanText: """IpaUS: /ˌɪnɪˈfɪʃnsi/""",
...
کوردی: کەم‌بەرهەمی،	بەکارنەهاتوویی، لێنەهاتوویی، لێنەوەشاوەیی
"""),
// With short examples define "inefficiency", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کارێک کە بە باشترین شێوە کات، پارە، وزە، هتد بەکار ناهێنێت"""),
                    SentencesRow(
                      englishText:
                          """They were accused of gross inefficiency in their handling of the case.""",
                      kurdishText:
                          """تۆمەتبار کران بە ناکارامەیی زۆر لە مامەڵەیان لەگەڵ کەیسەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It is a troubled organization, plagued by inefficiencies.""",
                      kurdishText:
                          """دامەزراوەیەکی پڕ لە کێشەیە کە بەدەست ناکارامەیی دەناڵێنێت.""",
