...
class EnglishEntryarmchair extends StatelessWidget {
  ...
  Future<void> speakarmchair(String languageCode) async {
    ...
    await flutterTts.speak("armchair");
  }
  ...
  Future<void> speakarmchair356(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He eased himself into the big armchair.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "armchair"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɑːmtʃeə(r)/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrmtʃer/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'vR_rjW7Ro3c';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'UTJRgoG6en8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'IkYboMnY_ck';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'gmbEmWUXsxw';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final double _startSeconds = 3001;
