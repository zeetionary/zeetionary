...
class EnglishEntryexporter extends StatefulWidget {
  const EnglishEntryexporter({super.key});

  @override
  State<EnglishEntryexporter> createState() => _EnglishEntryexporterState();
}

class _EnglishEntryexporterState extends State<EnglishEntryexporter> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exporter""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exporter""",
                      // alsoEnglishWord: "also: exporter",
                      britshText: """IpaUK: /ekˈspɔːtə(r)/""",
                      americanText: """IpaUS: /ekˈspɔːrtər/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The country is now a exporter of fuel.""");
  }
...
const String _videoIdend = 'https://youtu.be/TS4AM9mPX-8?t=';
const double _startSecondsend = 000000000000000000000000000388;
const String _videoIdone = 'https://youtu.be/sY8aFSY2zv4?t=';
const double _startSecondsone = 0000000000000000000000000002907;
const String _videoIdtwo = 'https://youtu.be/K0OtGIPRcAs?t=';
const double _startSecondstwo = 000000000000000000000000000960;
const String _videoIdthree = 'https://youtu.be/qo-2gDg-37w?t=';
const double _startSecondsthree = 000000000000000000000000000355;
const String _videoIdfour = 'https://youtu.be/Xm6Y3Rl9u1Q?t=';
const double _startSecondsfour = 000000000000000000000000000923;
const String _videoIdfive = 'https://youtu.be/ba63OVl1MHw?t=';
