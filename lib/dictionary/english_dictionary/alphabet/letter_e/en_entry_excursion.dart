...
class EnglishEntryexcursion extends StatefulWidget {
  const EnglishEntryexcursion({super.key});

  @override
  State<EnglishEntryexcursion> createState() => _EnglishEntryexcursionState();
}

class _EnglishEntryexcursionState extends State<EnglishEntryexcursion> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""excursion""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """excursion""",
                      // alsoEnglishWord: "also: excursion",
                      britshText: """IpaUK: /ɪkˈskɜːʃn/""",
                      americanText: """IpaUS: /ɪkˈskɜːrʒn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "excursion";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They've gone on an excursion to York.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Our ship offers 13 different excursions.""");
  }
...
کوردی: گەڕان (بە دەستە)، گەڕوانی، گەشت، سەیران، سەیاحەت، تۆڕ،	لادان، لەڕێ‌دەرچوون
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کورتە گەشتێک کە بۆ خۆشییە، بەتایبەتی ئەوانەی کە بۆ گرووپیک ڕێکخراون"""),
          SentencesRow(
            englishText: """They've gone on an excursion to York.""",
            kurdishText: """بە گەشتێک چوونە بۆ یۆرک.""",
          ...
          SentencesRow(
            englishText:
                """There are regular weekend excursions throughout the summer.""",
            kurdishText:
                """بە درێژایی هاوین لە کۆتایی هەفتەدا گەشتی بەردەوام هەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Our ship offers 13 different excursions.""",
            kurdishText: """کەشتییەکەمان ١٣ گەشتی جیاواز ڕێکدەخات.""",
          ...
          SentencesRow(
            englishText:
                """After a brief excursion into drama, he concentrated on his main interest, which was poetry.""",
            kurdishText:
                """لە دوای ماوەیەکی کورت لە خەریک بوون بە دراما، سەرنجی خستە سەر حەزی سەرەکیی.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: excursion (Derived forms: excursions)
1. A journey taken for pleasure (= jaunt, outing, junket, pleasure trip, expedition, sashay [N. Amer])
"many summer excursions to the shore";
 
2. Wandering from the main path of a journey (= digression)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/ZzdV_HM95RQ?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1105;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/esJkln9wAEg?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1113;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/L3SIdXPtB0M?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 521;
const String _videoIdthree = 'VIDEOhttps://youtu.be/Q1UXZs-yWDc?t=';
const double _startSecondsthree = 000000000000000000000000000; // 89;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/7u1uRCU5ZeE?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1050;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/5sHsJJM4nZU?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 167;
