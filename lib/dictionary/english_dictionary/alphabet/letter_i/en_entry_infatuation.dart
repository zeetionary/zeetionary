...
class EnglishEntryinfatuation extends StatefulWidget {
  const EnglishEntryinfatuation({super.key});

  @override
  State<EnglishEntryinfatuation> createState() =>
      _EnglishEntryinfatuationState();
}

class _EnglishEntryinfatuationState extends State<EnglishEntryinfatuation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: infatuation (Derived forms: infatuations)
1. A foolish and usually extravagant passion, love or admiration
 
2. Temporary love of an adolescent (- puppy love, calf love, crush [informal])
 
3/ An object of extravagant short-lived passion
""",
  );

  final String keyword = "infatuation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infatuation""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It isn't love—it's just a passing infatuation.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""My infatuation with her continued to grow.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/iDNZGw6uWZg?t=';
    const double startSecondsone = 000000000000000000000000000272;
    const String videoIdtwo = 'https://youtu.be/YpkP6BZIFDE?t=';
    const double startSecondstwo = 000000000000000000000000000113;
    const String videoIdthree = 'https://youtu.be/-T64FLsJnAU?t=';
    const double startSecondsthree = 000000000000000000000000000298;
    const String videoIdfour = 'https://youtu.be/SV-8eshpvvU?t=';
    const double startSecondsfour = 00000000000000000000000000015;
    const String videoIdfive = 'https://youtu.be/9dnN82DsQ2k?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """infatuation""",
                      // alsoEnglishWord: "also: infatuation",
                      britshText: """IpaUK: /ɪnˌfætʃuˈeɪʃn/""",
                      americanText: """IpaUS: /ɪnˌfætʃuˈeɪʃn/""",
...
کوردی: سەوداسەری، شێت‌وشەیدابوون، دڵڕفاوی، دڵبەستەیی، ئەوینداری، دڵ‌تێچوون
"""),
// With short examples define "infatuation", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خۆشەویستی نییە ـ تەنها شەیدابوونێکی تێپەڕیوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شەیدابوونم پێی بەردەوام بوو لە زۆربوون.""",
