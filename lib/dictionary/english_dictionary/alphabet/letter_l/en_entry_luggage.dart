...
class EnglishEntryluggage extends StatefulWidget {
  const EnglishEntryluggage({super.key});

  @override
  State<EnglishEntryluggage> createState() => _EnglishEntryluggageState();
}

class _EnglishEntryluggageState extends State<EnglishEntryluggage> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryluggage luggage
WORD_WEB luggage luggage luggage
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "luggage";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""luggage""");
  }
...
کوردی: 
"""),
// With short examples define "luggage", please follow LX instructions
