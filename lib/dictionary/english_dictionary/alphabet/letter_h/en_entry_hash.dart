...
class EnglishEntryhash extends StatefulWidget {
  const EnglishEntryhash({super.key});

  @override
  State<EnglishEntryhash> createState() => _EnglishEntryhashState();
}

class _EnglishEntryhashState extends State<EnglishEntryhash> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hash (Derived forms: hashes)
1. Chopped meat mixed with potatoes and browned
 
2. Purified resinous extract of the hemp plant; used as a hallucinogen (- hashish, hasheesh, haschisch)
 
3. [Brit] The symbol # (- octothorpe [N. Amer], octothorp [N. Amer], pound sign [US], pound [US], number sign, hash mark, hash symbol)
 
4. [informal] A confusing mixture of things

- Verb: hash (Derived forms: hashes, hashed, hashing)
1. Chop up
"hash the potatoes"
""",
  );

  final String keyword = "hash";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She loves making eggs and hash on weekends.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hash""",
                      // alsoEnglishWord: "also: hash",
                      britshText: """IpaUK: /hæʃ/""",
                      americanText: """IpaUS: /hæʃ/""",
...
const String _videoIdone = 'https://youtu.be/ZvGFV1WoVeo?t=';
const double _startSecondsone = 000000000000000000000000000404;
const String _videoIdtwo = 'https://youtu.be/oiLdWXLXDeA?t=';
const double _startSecondstwo = 0000000000000000000000000001482;
const String _videoIdthree = 'https://youtu.be/VVsdb90aOmA?t=';
...
const String _videoIdfive = 'https://youtu.be/P-SEulc_5vE?t=';
