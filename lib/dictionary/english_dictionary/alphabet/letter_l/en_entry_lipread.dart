...
class EnglishEntrylipread extends StatefulWidget {
  const EnglishEntrylipread({super.key});

  @override
  State<EnglishEntrylipread> createState() => _EnglishEntrylipreadState();
}

class _EnglishEntrylipreadState extends State<EnglishEntrylipread> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: lip-read (Derived forms: lip-reads, lip-read, lip-reading, lipread, lipreads, lipreading)
1. Interpret by lipreading; of deaf people (- lipread, speech-read)
"Those words which were easy to lipread should be identified better as rhyming than those which were difficult to lip-read";
""",
  );

  final String keyword = "lip-read";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lip-read""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She learned to lip-read after losing her hearing.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/thdC-HlRHWg?t=1632';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/7prNvGodzSc?t=1511';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/I3tx2h9A5n8?t=2045';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/nxDA_PL-XzA?t=1903';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/rwoDKcgaa8E?t=1239';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/HOFEP3bA8-8?t=117';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lip-read""",
                      // alsoEnglishWord: "also: lip-read",
                      britshText: """IpaUK: /ˈlɪp riːd/""",
                      americanText: """IpaUS: /ˈlɪp riːd/""",
...
کوردی: 
"""),
                    const DefinitionKurdish(text: """١. (کردار) تێگەشتن لەوەی کەسێک چی دەڵێت بە سەیرکردنی شێوازی جوڵانی لێوەکانی"""),
                    SentencesRow(
                      englishText: """She learned to lip-read after losing her hearing.""",
                      kurdishText: """لە دوای لەدەستدانی توانای بیستنی فێری لێو خوێندنەوە بوو.""",
