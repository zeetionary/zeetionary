...
// replace these: replace EnglishEntryaffectation - replace speakAffectation - replace affectation - /ˌæfekˈteɪʃn/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaffectation extends StatelessWidget {
  EnglishEntryaffectation({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌæfekˈteɪʃn/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "ژمارەیەکی زۆر بە درۆ نواندنی بچووکی ھەیە",
                                    textAlign: TextAlign
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'RN5X1yia2R4';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 's0lAOpNKFrg';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'UtcoJ8xX8Ps';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'vjIZARv_6nc';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = '0WKyuVMDT5U';
