                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "apprehension"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌæprɪˈhenʃn/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌæprɪˈhenʃn/"),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final double _startSeconds = 1829;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 3344;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'SFr0fCgrTNQ';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'iUPnr-lijlU';
