...
کوردی: 
"""),
// With short examples define "heater", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئامێرێک کە هەوا یان ئاو گەرم دەکات"""),
                    SentencesRow(
                      englishText:
                          """Even with the heater full on, the room felt cold.""",
                      kurdishText:
                          """تەنانەت بەوەی هیتەرەکە تەواو کراوە بوو، ژوورەکە هێشتا سارد بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/V-jmSjy2ArM?t=';
const double _startSecondsend = 00000000000000000000000000017;
const String _videoIdone = 'https://youtu.be/d3Pgd1Uz3Dg?t=';
const double _startSecondsone = 0000000000000000000000000009;
const String _videoIdtwo = 'https://youtu.be/Bm7L-2J52GU?t=';
const double _startSecondstwo = 00000000000000000000000000013;
const String _videoIdthree = 'https://youtu.be/8vrSO8WLs_M?t=';
const double _startSecondsthree = 000000000000000000000000000152;
const String _videoIdfour = 'https://youtu.be/gDCpZa5dJk4?t=';
const double _startSecondsfour = 00000000000000000000000000010;
const String _videoIdfive = 'https://youtu.be/32dvdtzVxRY';
