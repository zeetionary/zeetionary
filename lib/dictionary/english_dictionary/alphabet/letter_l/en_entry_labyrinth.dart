...
class EnglishEntrylabyrinth extends StatefulWidget {
  const EnglishEntrylabyrinth({super.key});

  @override
  State<EnglishEntrylabyrinth> createState() => _EnglishEntrylabyrinthState();
}

class _EnglishEntrylabyrinthState extends State<EnglishEntrylabyrinth> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: labyrinth (- maze) (Derived forms: labyrinths)
1. Complex system of paths or tunnels in which it is easy to get lost
 
2. A complex system of interconnecting cavities; concerned with hearing and equilibrium (- inner ear, internal ear)
""",
  );

  final String keyword = "labyrinth";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""labyrinth""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We lost our way in the labyrinth of streets.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/RTOuKWojGss?t=240';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/9bPIaHg11mI?t=93';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/1rJHcHTXj8M?t=144';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/d86ws7mQYIg?t=140';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/UrkPC81_QfU?t=397';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/A5a2Guy8-_8?t=123';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """labyrinth""",
                      // alsoEnglishWord: "also: labyrinth",
                      britshText: """IpaUK: /ˈlæbərɪnθ/""",
                      americanText: """IpaUS: /ˈlæbərɪnθ/""",
...
کوردی: پێچەڵاوپێچ، پێچەلپێچ، هەزاربەهەزار، بەپێچ‌وپەنا، کوناوکون
"""),
// With short examples define "labyrinth", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) زنجیرەیەک لە ڕێگای ئاڵۆز کە سەختە بە ناویدا بچیت"""),
                    SentencesRow(
                      englishText:
                          """We lost our way in the labyrinth of streets.""",
                      kurdishText:
                          """ڕێگاکەمانمان ونکرد لە پێچەڵاوپێچی شەقامەکان.""",
