...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'vk7Iplg9dGk';
    const double startSecondsend = 351;
    const String videoIdone = 'SkGIr2qUz-4';
    const double startSecondsone = 158;
    const String videoIdtwo = 'gO-V8E9MIBg';
    const double startSecondstwo = 1440;
    const String videoIdthree = 'Gmjd6Zad1Ag';
    const double startSecondsthree = 47;
    const String videoIdfour = 'FaNLkd0rzXk';
    const double startSecondsfour = 713;
    const String videoIdfive = 'm_uDrH9a1ng';
