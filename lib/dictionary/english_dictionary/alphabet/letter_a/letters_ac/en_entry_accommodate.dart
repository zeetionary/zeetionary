...
class EnglishEntryaccommodate extends StatefulWidget {
  const EnglishEntryaccommodate({super.key});

  @override
  State<EnglishEntryaccommodate> createState() => _EnglishEntryaccommodateState();
}

class _EnglishEntryaccommodateState extends State<EnglishEntryaccommodate> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "accommodate";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accommodate""",
                      // alsoEnglishWord: "also: accommodate",
                      britshText: """IpaUK: /əˈkɒmədeɪt/""",
                      americanText: """IpaUS: /əˈkɑːmədeɪt/""",
