...
class EnglishEntryfoolproof extends StatefulWidget {
  const EnglishEntryfoolproof({super.key});

  @override
  State<EnglishEntryfoolproof> createState() => _EnglishEntryfoolproofState();
}

class _EnglishEntryfoolproofState extends State<EnglishEntryfoolproof> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: foolproof
1. Not liable to failure (= unfailing, idiot-proof [informal])
"a foolproof identification system";

- Verb: foolproof (Derived forms: foolproofed, foolproofing, foolproofs)
1. Proof against human misuse or error (= goofproof, goof-proof, idiot-proof [informal])
"foolproof this appliance";
""",
  );

  final String keyword = "foolproof";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foolproof""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This recipe is foolproof—it works every time.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""No system can ever be completely foolproof.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foolproof""",
                      // alsoEnglishWord: "also: foolproof",
                      britshText: """IpaUK: /ˈfuːlpruːf/""",
                      americanText: """IpaUS: /ˈfuːlpruːf/""",
...
کوردی: جێی‌باوەڕ، هەڵەهەڵنەگر، بێ‌هەڵە، لێ‌ڕابینراو،	سادە، ئاسان
"""),
// With short examples define "foolproof", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە زۆر بە باشی و ئاسانی دیزاین کراوە بەشێوەیەک کە ئەگەری ئەوە نەبێت هەڵە بکەیت لە بەکارهێنانی یان شکست بهێنیت"""),
                    SentencesRow(
                      englishText:
                          """This recipe is foolproof—it works every time.""",
                      kurdishText:
                          """ئەم ڕەچەتەیە جێی‌باوەڕە ـ هەموو کات کار دەکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هیچ سیستەمێک هەرگیز بە تەواوی جێی‌باوەڕ نییە.""",
...
const double _startSecondsend = 0000000000000000000000000001269;
const String _videoIdone = 'https://youtu.be/QLq6GEiHqR8?t=';
const double _startSecondsone = 0000000000000000000000000001345;
const String _videoIdtwo = 'https://youtu.be/raSeaAeryWE?t=';
const double _startSecondstwo = 0000000000000000000000000002573;
const String _videoIdthree = 'https://youtu.be/aWWc2VcsTjo?t=';
const double _startSecondsthree = 00000000000000000000000000094;
const String _videoIdfour = 'https://youtu.be/JY5t6iUzajk?t=';
const double _startSecondsfour = 00000000000000000000000000023;
const String _videoIdfive = 'https://youtu.be/6HEheIozS5c?t=';
const double _startSecondsfive = 0000000000000000000000000001118;
