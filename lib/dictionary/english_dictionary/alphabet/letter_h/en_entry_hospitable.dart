...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/p3O6bKdPLbw?t=';
    const double startSecondsend = 0000000000000000000000000001382;
    const String videoIdone = 'https://youtu.be/XkYvo6S82LE?t=';
    const double startSecondsone = 00000000000000000000000000032;
    const String videoIdtwo = 'https://youtu.be/dRLCZqEfJFA?t=';
    const double startSecondstwo = 000000000000000000000000000192;
    const String videoIdthree = 'https://youtu.be/88bD9f2MivI?t=';
    const double startSecondsthree = 000000000000000000000000000429;
    const String videoIdfour = 'https://youtu.be/DxREm3s1scA?t=';
    const double startSecondsfour = 0000000000000000000000000002165;
    const String videoIdfive = 'https://youtu.be/sY8aFSY2zv4?t=';
    const double startSecondsfive = 0000000000000000000000000005212;
