...
class EnglishEntryfingerprint extends StatefulWidget {
  const EnglishEntryfingerprint({super.key});

  @override
  State<EnglishEntryfingerprint> createState() =>
      _EnglishEntryfingerprintState();
}

class _EnglishEntryfingerprintState extends State<EnglishEntryfingerprint> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fingerprint (Derived forms: fingerprints)
...
3. A smudge made by a (dirty) finger (= fingermark)

- Verb: fingerprint (Derived forms: fingerprints, fingerprinting, fingerprinted)
1. Take an impression of a person's fingerprints
""",
  );

  final String keyword = "fingerprint";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fingerprint""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His fingerprints were all over the gun.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The car was examined for fingerprints.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fingerprint""",
                      // alsoEnglishWord: "also: fingerprint",
                      britshText: """IpaUK: /ˈfɪŋɡəprɪnt/""",
                      americanText: """IpaUS: /ˈfɪŋɡərprɪnt/""",
...
// With short examples define "fingerprint", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """جێ‌پەنجەی لەسەر گشت چەکەکە بوو.""",
                    ...
                    SentencesRow(
                      englishText: """The car was examined for fingerprints.""",
                      kurdishText: """ئۆتۆمبێلەکە بۆ جێ‌پەنجە پشکنرا.""",
...
const double _startSecondsend = 000000000000000000000000000717;
const String _videoIdone = 'https://youtu.be/dtp6b76pMak?t=';
const double _startSecondsone = 000000000000000000000000000159;
const String _videoIdtwo = 'https://youtu.be/eTvrSLFWmLo?t=';
const double _startSecondstwo = 000000000000000000000000000588;
const String _videoIdthree = 'https://youtu.be/0jltioeaEyY?t=';
const double _startSecondsthree = 000000000000000000000000000315;
const String _videoIdfour = 'https://youtu.be/58XEfDtU0Z4?t=';
const double _startSecondsfour = 0000000000000000000000000001400;
const String _videoIdfive = 'https://youtu.be/8FpPSMIB4uA?t=';
const double _startSecondsfive = 000000000000000000000000000706;
