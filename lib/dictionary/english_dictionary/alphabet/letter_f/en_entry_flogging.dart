...
class EnglishEntryflogging extends StatefulWidget {
  const EnglishEntryflogging({super.key});

  @override
  State<EnglishEntryflogging> createState() => _EnglishEntryfloggingState();
}

class _EnglishEntryfloggingState extends State<EnglishEntryflogging> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flogging (Derived forms: floggings)
1. Beating with a whip, strap or rope as a form of punishment (= whipping, tanning, lashing, flagellation)
""",
  );

  final String keyword = "flogging";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flogging""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Some politicians have made calls to bring back flogging as a deterrent for certain crimes.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flogging""",
                      // alsoEnglishWord: "also: flogging",
                      britshText: """IpaUK: /ˈflɒɡɪŋ/""",
                      americanText: """IpaUS: /ˈflɑːɡɪŋ/""",
...
// With short examples define "flogging", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Some politicians have made calls to bring back flogging as a deterrent for certain crimes.""",
                      kurdishText:
                          """هەندێک سیاسی داوایان کردووە بۆ هێناننەوەی جەڵد وەک پێشگیرییەک بۆ ژمارەیەک تاوان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/4Nr1AgIfajI?t=';
const double _startSecondsend = 000000000000000000000000000804;
const String _videoIdone = 'https://youtu.be/z3P0kTcM8iw?t=';
const double _startSecondsone = 000000000000000000000000000313;
const String _videoIdtwo = 'https://youtu.be/C7897QIXYOU?t=';
const double _startSecondstwo = 000000000000000000000000000731;
const String _videoIdthree = 'https://youtu.be/6pWkdVipGi4?t=';
const double _startSecondsthree = 000000000000000000000000000371;
const String _videoIdfour = 'https://youtu.be/1Kx_2Sh7iz0?t=';
const double _startSecondsfour = 000000000000000000000000000171;
const String _videoIdfive = 'https://youtu.be/apapojA4Si8?t=';
