...
class EnglishEntryfailing extends StatefulWidget {
  const EnglishEntryfailing({super.key});

  @override
  State<EnglishEntryfailing> createState() => _EnglishEntryfailingState();
}

class _EnglishEntryfailingState extends State<EnglishEntryfailing> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""failing""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """failing""",
                      // alsoEnglishWord: "also: failing",
                      britshText: """IpaUK: /ˈfeɪlɪŋ/""",
                      americanText: """IpaUS: /ˈfeɪlɪŋ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She is aware of her own failings.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Jealousy is a very human failing.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We all have our failings.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""More support is needed to improve failing schools.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His last months in office were marred by failing health.""");
  }
...
"""),
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Jealousy is a very human failing.""",
            kurdishText: """بەخیلی لاوازییەکی مرۆڤە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """پشتگیری زیاتر پێویستە بۆ باشترکردنی خوێندنگە شکستخواردووەکان.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """کۆتا مانگەکانی لە پۆستەکەیدا گیرۆدە بوون بە تەندرووستی لاواز.""",
...
- Noun: failing
1. A flaw or weak point (= weakness, minus, disadvantage)
"he was quick to point out his wife's failings";
 
2. Failure to reach a minimum required performance (= flunk [informal])
...
const String _videoIdend = 'https://youtu.be/YZAibo7eiik?t=';
const double _startSecondsend = 000000000000000000000000000969;
const String _videoIdone = 'https://youtu.be/citaRMTIHNg?t=';
const double _startSecondsone = 000000000000000000000000000641;
const String _videoIdtwo = 'https://youtu.be/tKCyg2ln_1E?t=';
const double _startSecondstwo = 00000000000000000000000000011;
const String _videoIdthree = 'https://youtu.be/OqF-O5iq-lk?t=';
const double _startSecondsthree = 0000000000000000000000000001151;
const String _videoIdfour = 'https://youtu.be/0qjRv6nY4QU?t=';
const double _startSecondsfour = 000000000000000000000000000572;
const String _videoIdfive = 'https://youtu.be/ZqSONHVilTM?t=';
const double _startSecondsfive = 0000000000000000000000000001160;
