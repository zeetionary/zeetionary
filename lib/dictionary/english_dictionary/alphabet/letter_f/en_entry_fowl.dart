...
class EnglishEntryfowl extends StatefulWidget {
  const EnglishEntryfowl({super.key});

  @override
  State<EnglishEntryfowl> createState() => _EnglishEntryfowlState();
}

class _EnglishEntryfowlState extends State<EnglishEntryfowl> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fowl (Derived forms: fowls)
1. A domesticated gallinaceous bird thought to be descended from the red jungle fowl (= domestic fowl, poultry)
 
2. The flesh of a bird or fowl (wild or domestic) used as food (= bird)

- Verb: fowl (Derived forms: fowl, fowling, fowls, fowled)
1. Hunt fowl
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I now eat more fish and fowl and less red meat.""");
  }
...
کوردی: 
"""),
// With short examples define "fowl", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) باڵندەیەک کە بۆ گۆشت و هێلکەکەی بەخێو دەکرێت، بۆ نموونە مریشک"""),
                    SentencesRow(
                      englishText:
                          """I now eat more fish and fowl and less red meat.""",
                      kurdishText:
                          """ئێستا زیاتر ماسی و پەلەوەر دەخۆم وەک لە گۆشتی سوور.""",
