...
"""),
// With short examples define "heat", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەستی بە گەرمی خۆرەکە دەکرد لەسەر پشتی.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) گەرمی وەک سەرچاوەی وزە کە لە تەنێکەوە بۆ تەنێکی دیکە دەچێت بەهۆی جیاوازیی پلەی گەرمی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ناو) کەشووهەوای گەرم؛ دۆخی گەرم لە بینایەک، پێڕۆیەک، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەواوی دوا نیوەڕۆکە لە گەرما بەهێزەکە کاریان کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چکلێت نابێت هەرگیز بتاوێندرێتەوە لەسەر گەرمیی ڕاستەوخۆ.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """خانووەکە سیستەمی گەرمی کارەبایی هەیە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٨. (ناو) هەستی بەهێز، بە تایبەتی هی تووڕەیی و جۆش‌وخرۆشی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                    ...
                    const DefinitionKurdish(
                        text:
                            """٩. (ناو) فشار لەسەر کەسێک بۆ کردن یان بەدەستهێنانی شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The heat is on now that the election is only a week away.""",
                      kurdishText:
                          """فشار ئێستا زۆرە کە هەڵبژاردن تەنها یەک هەفتەی ماوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The system produced enough energy to heat several thousand homes.""",
                      kurdishText:
                          """سیستەمەکە بەشی پێویست گەرمی درووست دەکرد بۆ گەرمکردنی چەند هەزار خانوویەک.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بۆ چەند خولەکێک بە هێواشی سۆسەکە گەرم بکە.""",
...
const double _startSecondsthree = 0000000000000000000000000001174;
const String _videoIdfour = 'https://youtu.be/vxGP-dJd-1o?t=';
const double _startSecondsfour = 000000000000000000000000000101;
const String _videoIdfive = 'https://youtu.be/OgMFtn_iFZc?t=';
