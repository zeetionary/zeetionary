...
class EnglishEntrynotebook extends StatefulWidget {
  const EnglishEntrynotebook({super.key});

  @override
  State<EnglishEntrynotebook> createState() => _EnglishEntrynotebookState();
}

class _EnglishEntrynotebookState extends State<EnglishEntrynotebook> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""notebook""");
  }
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She kept a notebook during the trip.""");
  }
...
کوردی: یاددنامە، سەرنج‌نامە، تێبینی‌نامە، بیرنامچە، دەفتەر، تێنووس، دەفتەری تێبینی
"""),
          ...
          SentencesRow(
            englishText:
                """The police officer wrote the details down in his notebook.""",
            kurdishText:
                """ئەفسەرە پۆلیسەکە وردەکارییەکانی لە دەفتەرەکەیدا نووسی.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """لە ماوەی گەشتەکەدا دەفتەرێکی هەڵگرت (بۆ نووسین و تۆماکردن).""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Sophie's notebook is covered with stickers.""",
            kurdishText: """دەفتەرەکەی سۆفی پڕە لە ستیکەر.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: notebook (Derived forms: notebooks)
1. A book with blank pages for recording notes or memoranda
 
2. A small compact portable computer (= notebook computer, laptop, laptop computer)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/6S8lZxz_sy4?t=';
const double _startSecondsend = 000000000000000000000000000000; // 194;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/idWpZ63isMo';
const double _startSecondsone = 00000000000000000000000000000; // 0;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/2KP13L-jE30?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 28;
const String _videoIdthree = 'VIDEOhttps://youtu.be/TSQ0UNNqaRg?t=';
const double _startSecondsthree = 000000000000000000000000000; // 15;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/uz0sOL5spW4?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 4;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/bxgLUwRPhp0?t=';
