...
class EnglishEntrygoldfish extends StatefulWidget {
  const EnglishEntrygoldfish({super.key});

  @override
  State<EnglishEntrygoldfish> createState() => _EnglishEntrygoldfishState();
}

class _EnglishEntrygoldfishState extends State<EnglishEntrygoldfish> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""goldfish""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She has a goldfish named Goldie in a bowl.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """goldfish""",
                      // alsoEnglishWord: "also: goldfish",
                      britshText: """IpaUK: /ˈɡəʊldfɪʃ/""",
                      americanText: """IpaUS: /ˈɡəʊldfɪʃ/""",
...
کوردی: زەردەماسی، ماسی‌یە زەردە، سوورەماسی
"""),
                    const DefinitionKurdish(text: """١. (ناو) ماسییەکی پرتەقاڵی یان سوور کە زۆرجار لە ماڵدا دەخرێتە حەوز"""),
                    SentencesRow(
                      englishText: """She has a goldfish named Goldie in a bowl.""",
                      kurdishText: """سوورەماسییەکی هەبوو بە ناوی گۆڵدی لە حەوزێکدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/KOnk7Nbqkhs?t=';
const double _startSecondsend = 000000000000000000000000000132;
const String _videoIdone = 'https://youtu.be/KH9fyRUz0ks?t=';
const double _startSecondsone = 00000000000000000000000000017;
const String _videoIdtwo = 'https://youtu.be/23WEnemwgbs?t=';
const double _startSecondstwo = 00000000000000000000000000064;
const String _videoIdthree = 'https://youtu.be/ifhY_AHbSRA';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/O-D-W1U3lW4?t=';
const double _startSecondsfour = 00000000000000000000000000084;
const String _videoIdfive = 'https://youtu.be/QBC-IlTmA00?t=';
