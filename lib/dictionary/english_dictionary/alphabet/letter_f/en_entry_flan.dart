...
class EnglishEntryflan extends StatefulWidget {
  const EnglishEntryflan({super.key});

  @override
  State<EnglishEntryflan> createState() => _EnglishEntryflanState();
}

class _EnglishEntryflanState extends State<EnglishEntryflan> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flan (Derived forms: flans)
1. Open pastry filled with fruit or custard
""",
  );

  final String keyword = "flan";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Have some more flan.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flan""",
                      // alsoEnglishWord: "also: flan",
                      britshText: """IpaUK: /flæn/""",
                      americanText: """IpaUS: /flæn/,  /flɑːn/""",
...
// With short examples define "flan", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کێکێک کە پڕە لە هێلکە، پەنیر، میوە، هتد"""),
                    SentencesRow(
                      englishText: """Have some more flan.""",
                      kurdishText: """هەندێک فلانی دیکە بخۆ.""",
...
const String _videoIdone = 'https://youtu.be/W2hRTTTpmr8?t=';
const double _startSecondsone = 0000000000000000000000000001117;
const String _videoIdtwo = 'https://youtu.be/qUm8TSGtenI?t=';
const double _startSecondstwo = 0000000000000000000000000001015;
const String _videoIdthree = 'https://youtu.be/G3HfLZiuBnk?t=';
const double _startSecondsthree = 000000000000000000000000000827;
const String _videoIdfour = 'https://youtu.be/TiyxdTPnL9o?t=';
const double _startSecondsfour = 0000000000000000000000000003;
const String _videoIdfive = 'https://youtu.be/UjtwYNnVOQU?t=';
