...
class EnglishEntryheartache extends StatefulWidget {
  const EnglishEntryheartache({super.key});

  @override
  State<EnglishEntryheartache> createState() => _EnglishEntryheartacheState();
}

class _EnglishEntryheartacheState extends State<EnglishEntryheartache> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heartache (Derived forms: heartaches)
1. Intense sorrow caused by loss of a loved one (especially by death) (- grief, heartbreak, brokenheartedness)
""",
  );

  final String keyword = "heartache";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heartache""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The relationship caused her a great deal of heartache.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heartache""",
                      // alsoEnglishWord: "also: heartache",
                      britshText: """IpaUK: /ˈhɑːteɪk/""",
                      americanText: """IpaUS: /ˈhɑːrteɪk/""",
...
کوردی: خەم، خەفەت، خوسپە، پەژارە، سوێ، کەسەر، کۆڤان، کزەی جەرگ
"""),
// With short examples define "heartache", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) هەستی نیگەرانی و بێزاری"""),
                    SentencesRow(
                      englishText:
                          """The relationship caused her a great deal of heartache.""",
                      kurdishText:
                          """پەیوەندییەکە بوو بە هۆکاری زۆری دڵشکاوی بۆی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/FYVvE4tr2BI?t=';
const double _startSecondsend = 000000000000000000000000000500;
const String _videoIdone = 'https://youtu.be/Xp4Y2nCNNS8?t=';
const double _startSecondsone = 000000000000000000000000000874;
const String _videoIdtwo = 'https://youtu.be/jwZBl6KQojM?t=';
const double _startSecondstwo = 0000000000000000000000000001481;
const String _videoIdthree = 'https://youtu.be/fBTjbGfHx0s?t=';
const double _startSecondsthree = 0000000000000000000000000002163;
const String _videoIdfour = 'https://youtu.be/FCZ06Sfr9Cg?t=';
const double _startSecondsfour = 000000000000000000000000000642;
const String _videoIdfive = 'https://youtu.be/tILIeNjbH1E?t=';
const double _startSecondsfive = 000000000000000000000000000735;
