...
class EnglishEntrycontroversial extends StatelessWidget {
// blank divider
  EnglishEntrycontroversial({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcontroversial(String languageCode) async {
    // DOPSUM: CHANGE speakcontroversial
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "controversial"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌkɒntrəˈvɜːʃl/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcontroversial("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUS: /ˌkɑːntrəˈvɜːrʃl/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcontroversial("en-US"),
                            ),
                          ],
                        ),
                      ],
...
کوردی: مشت‌ومڕلەسەر، کێشەلەسەر، کێشەبار، کێشاوی، کێشەبەدوا، کێشەون
"""),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '0E0rarldXK0';
