...
class EnglishEntrylisten extends StatefulWidget {
  const EnglishEntrylisten({super.key});

  @override
  State<EnglishEntrylisten> createState() => _EnglishEntrylistenState();
}

class _EnglishEntrylistenState extends State<EnglishEntrylisten> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: listen (Derived forms: listened, listening, listens)
1. Pay attention to a sound
"Listen to the sound of this cello"
 
2. Take careful note; follow advice (- hear, take heed)
"Listen to your father";
 
3. Pay close attention to; give heed to (- heed, mind)
""",
  );

  final String keyword = "listen";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Listen! What's that noise? Can you hear it?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Sorry, I wasn't really listening.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He had been listening at the door.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I listened carefully to her story.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was listening intently to what she was saying.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Listen, there's something I have to tell you.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I tried to warn her, but she wouldn't listen.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""None of this would have happened if you'd listened to me.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The government is willing to listen to any concerns that people have.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Have a listen to this.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/oEn7XBxOXSw?t=111';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/DEX-5gM0P8I';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/ObDiLkXAQNQ?t=76';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/BahSmJ6Xqjg?t=1486';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/fvol_PhlegU?t=913';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/A8Tw5xASluI?t=123';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """listen""",
                      // alsoEnglishWord: "also: listen",
                      britshText: """IpaUK: /ˈlɪsn/""",
                      americanText: """IpaUS: /ˈlɪsn/""",
...
کوردی: گوێ‌پێدان، گوێ‌لێڕاگرتن، گوێ‌دان، گوێ بۆ ڕاداشتن
"""),
// With short examples define "listen", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) گوێگرتن"""),
                    SentencesRow(
                      englishText: """Listen! What's that noise? Can you hear it?""",
                      kurdishText: """گوێگرە! ئەو ژاوەژاوە چییە؟ گوێت لێیە؟""",
                    ...
                    SentencesRow(
                      englishText: """Sorry, I wasn't really listening.""",
                      kurdishText: """ببوورە، لە ڕاستیدا گوێم نەدەگرت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He had been listening at the door.""",
                      kurdishText: """لە دەرگاکەوە گوێی دەگرت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I listened carefully to her story.""",
                      kurdishText: """بە وریاییەوە گوێم لە چیرۆکەکەی گرت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He was listening intently to what she was saying.""",
                      kurdishText: """بە پەرۆشەوە گوێی دەگرت بۆ ئەوەی چی دەگوت.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) گوتن بە کەسێک کە گوێت بۆ بگرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Listen, there's something I have to tell you.""",
                      kurdishText: """گوێ بگرە، شتێک هەیە دەبێت پێت بڵێم.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) گوێگرتن لەوەی کەسێک چی دەڵێت و باوەڕی پێ بکەیت یان ڕاوێژەکەی پەسەند بکەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I tried to warn her, but she wouldn't listen.""",
                      kurdishText: """هەوڵم دا ئاگاداری بکەمەوە، بەڵام گوێی نەگرت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """None of this would have happened if you'd listened to me.""",
                      kurdishText: """هیچ کام لەمە ڕوویان نەدەدا ئەگەر گوێت گرتبا بۆم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The government is willing to listen to any concerns that people have.""",
                      kurdishText: """حکومەت ئامادەیە گوێ بگرێت بۆ هەر داوایەک کە خەڵکی هەیان بێت.""",
                      onPressedBritish: () => speaksentence9("en-GB"),
                      onPressedAmerican: () => speaksentence9("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ناو) گوێگرتن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Have a listen to this.""",
                      kurdishText: """گوێیەک بگرە بۆ ئەمە.""",
