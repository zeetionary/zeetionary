...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'HHZLjffZXUo';
    const double startSecondsend = 327;
    const String videoIdone = 'hkSOOB3MYMY';
    const double startSecondsone = 324;
    const String videoIdtwo = '9s9UXXAmlTg';
    const double startSecondstwo = 418;
    const String videoIdthree = 'HAMQfXMkoKw';
    const double startSecondsthree = 243;
    const String videoIdfour = 'z56d4f1uT3k';
    const double startSecondsfour = 305;
    const String videoIdfive = 'exZoJM3rIIg';
