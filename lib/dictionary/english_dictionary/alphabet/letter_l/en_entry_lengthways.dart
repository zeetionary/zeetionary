...
class EnglishEntrylengthways extends StatefulWidget {
  const EnglishEntrylengthways({super.key});

  @override
  State<EnglishEntrylengthways> createState() => _EnglishEntrylengthwaysState();
}

class _EnglishEntrylengthwaysState extends State<EnglishEntrylengthways> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lengthways""");
  }
