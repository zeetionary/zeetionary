...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'PYS3UZFPJWI';
    const double startSecondsend = 875;
    const String videoIdone = 'kTaYet07Ioo';
    const double startSecondsone = 1010;
    const String videoIdtwo = 'OgFcz6klaeg';
    const double startSecondstwo = 788;
    const String videoIdthree = 'FaCeZsOOKEY';
    const double startSecondsthree = 601;
    const String videoIdfour = '6ta_sftSfIw';
    const double startSecondsfour = 1533;
    const String videoIdfive = '4Q1FzhMY8FQ';
    const double startSecondsfive = 383;
