...
class EnglishEntrylow extends StatefulWidget {
  const EnglishEntrylow({super.key});

  @override
  State<EnglishEntrylow> createState() => _EnglishEntrylowState();
}

class _EnglishEntrylowState extends State<EnglishEntrylow> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylow low
WORD_WEB low low low
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "low";
...
کوردی: 
"""),
// With short examples define "low", please follow LX instructions
