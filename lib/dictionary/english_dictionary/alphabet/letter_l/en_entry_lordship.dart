...
class EnglishEntrylordship extends StatefulWidget {
  const EnglishEntrylordship({super.key});

  @override
  State<EnglishEntrylordship> createState() => _EnglishEntrylordshipState();
}

class _EnglishEntrylordshipState extends State<EnglishEntrylordship> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lordship""");
  }
