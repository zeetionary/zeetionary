...
class EnglishEntryfridge extends StatefulWidget {
  const EnglishEntryfridge({super.key});

  @override
  State<EnglishEntryfridge> createState() => _EnglishEntryfridgeState();
}

class _EnglishEntryfridgeState extends State<EnglishEntryfridge> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fridge (Derived forms: fridges)
1. A refrigerator in which the coolant is pumped around by an electric motor (= electric refrigerator)
 
2. [informal] A household appliance in which food can be stored at low temperatures (= refrigerator, icebox [US])
""",
  );

  final String keyword = "fridge";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There's no food in the fridge!""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Place the dough in the fridge overnight.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""This dessert can be served straight from the fridge.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fridge""",
                      // alsoEnglishWord: "also: fridge",
                      britshText: """IpaUK: /frɪdʒ/""",
                      americanText: """IpaUS: /frɪdʒ/""",
...
// With short examples define "fridge", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """There's no food in the fridge!""",
                      kurdishText: """هیچ خواردن لە یەخچاڵەکە نییە!""",
                    ...
                    SentencesRow(
                      englishText:
                          """The kids tend to raid the fridge when they get home from school.""",
                      kurdishText:
                          """منداڵەکان حەزی ئەوەیان هەیە بەربنە یەخچاڵەکە کە دەگەنەوە ماڵ لە قوتابخانە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە شەودا هەویرەکە بخە یەخچاڵەکەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شیرینییەکە دەکرێت پێشکەش بکردرێت کە ڕێک لە یەخچاڵەکە دەردەهێندرێت.""",
...
const double _startSecondsend = 000000000000000000000000000228;
const String _videoIdone = 'https://youtu.be/IHJI6_VpH00?t=';
const double _startSecondsone = 000000000000000000000000000145;
...
const String _videoIdfour = 'https://youtu.be/X5oD_thIk3c';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/a9m3GD0DbPY?t=';
const double _startSecondsfive = 000000000000000000000000000371;
