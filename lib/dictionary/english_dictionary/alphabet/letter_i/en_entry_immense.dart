...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: immense
1. Unusually great in size or amount or degree or especially extent or scope (- huge, vast, Brobdingnagian)
"the Los Angeles aqueduct winds like an immense snake along the base of the mountains"; "immense numbers of birds"; "at vast (or immense) expense";
""",
  );
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The benefits are immense.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""There is still an immense amount of work to be done.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001367;
    const String videoIdone = 'https://youtu.be/xXvgT-AgLAo?t=';
    const double startSecondsone = 000000000000000000000000000129;
    const String videoIdtwo = 'https://youtu.be/xBNfOg0FxDM?t=';
    const double startSecondstwo = 000000000000000000000000000195;
    const String videoIdthree = 'https://youtu.be/7eM7pb5M5DU?t=';
    const double startSecondsthree = 0000000000000000000000000001013;
    const String videoIdfour = 'https://youtu.be/ErPsyBUCijM?t=';
    const double startSecondsfour = 0000000000000000000000000001259;
    const String videoIdfive = 'https://youtu.be/IDcyXtweHCw?t=';
    const double startSecondsfive = 000000000000000000000000000900;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      britshText: """IpaUK: /ɪˈmens/""",
                      americanText: """IpaUS: /ɪˈmens/""",
...
کوردی: یەکجار گەورە، لە ڕادەبەدەر، یەکجارزۆر، کەتە، زەبەند، کەڵە، زۆر قورس، بەرین، بەربڵاو 
"""),
// With short examples define "immense", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) تەواو گەورە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: enormous"),
                    SentencesRow(
                      englishText: """The benefits are immense.""",
                      kurdishText: """سوودەکان ڕادەبەدەرن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هێشتا ڕێژەیەکی زۆر کار هەیە بکرێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The political fallout of the revelations has been immense.""",
                      kurdishText:
                          """کاریگەرییە خراپە سیاسییەکانی ئاشکراکردنەکان گەورە بوونە.""",
