...
class EnglishEntryfixation extends StatefulWidget {
  const EnglishEntryfixation({super.key});

  @override
  State<EnglishEntryfixation> createState() => _EnglishEntryfixationState();
}

class _EnglishEntryfixationState extends State<EnglishEntryfixation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fixation (Derived forms: fixations)
1. An abnormal state in which development has stopped prematurely (= arrested development, infantile fixation, regression)
 
2. An unhealthy and compulsive preoccupation with something or someone (= obsession)
 
3. The activity of fastening something firmly in position
 
4. (histology) the preservation and hardening of a tissue sample to retain as nearly as possible the same relations they had in the living body (= fixing)
""",
  );

  final String keyword = "fixation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fixation""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Winning the title again has become a fixation for him.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He's got this fixation with cleanliness.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fixation""",
                      // alsoEnglishWord: "also: fixation",
                      britshText: """IpaUK: /fɪkˈseɪʃn/""",
                      americanText: """IpaUS: /fɪkˈseɪʃn/""",
...
// With short examples define "fixation", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) حەزێکی زۆر بۆ شتێک کە نامۆیە یان بێ‌هۆکارە"""),
                    SentencesRow(
                      englishText:
                          """Winning the title again has become a fixation for him.""",
                      kurdishText:
                          """بردنەوەی نازناوەکە دووبارە بووە بە خولیایەک بۆی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دڵبەستەیی بە پاک و خاوێنی هەیە.""",
...
const String _videoIdone = 'https://youtu.be/UopANFTGexA?t=';
const double _startSecondsone = 000000000000000000000000000177;
const String _videoIdtwo = 'https://youtu.be/wLHNI96oF2A?t=';
const double _startSecondstwo = 000000000000000000000000000257;
const String _videoIdthree = 'https://youtu.be/K7ssW8_QHj0?t=';
const double _startSecondsthree = 000000000000000000000000000217;
const String _videoIdfour = 'https://youtu.be/QWY6osJ4eJI?t=';
const double _startSecondsfour = 000000000000000000000000000267;
const String _videoIdfive = 'https://youtu.be/GIAiag16KVY?t=';
