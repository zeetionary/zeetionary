...
class EnglishEntryhatchet extends StatefulWidget {
  const EnglishEntryhatchet({super.key});

  @override
  State<EnglishEntryhatchet> createState() => _EnglishEntryhatchetState();
}

class _EnglishEntryhatchetState extends State<EnglishEntryhatchet> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hatchet (Derived forms: hatchets)
1. Weapon consisting of a fighting axe; used by North American Indians (- tomahawk)
 
2. A small axe with a short handle used with one hand (usually to chop wood)
""",
  );

  final String keyword = "hatchet";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hatchet""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He used a hatchet to chop the tree.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hatchet""",
                      // alsoEnglishWord: "also: hatchet",
                      britshText: """IpaUK: /ˈhætʃɪt/""",
                      americanText: """IpaUS: /ˈhætʃɪt/""",
...
کوردی: تەور، تەورۆکە، سیکارد، بیور، بڤر، تەوری چکۆلە (دەسک‌کورت)، نەژاخ
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) تەورێکی بچووک کە دەسکی کورتی هەیە"""),
                    SentencesRow(
                      englishText: """He used a hatchet to chop the tree.""",
                      kurdishText: """تەورۆکەیەکی بەکارهێنا بۆ بڕینی دارەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/JcpACQCgESk?t=';
const double _startSecondsend = 00000000000000000000000000018;
const String _videoIdone = 'https://youtu.be/eX_3Qq61ZXM?t=';
const double _startSecondsone = 00000000000000000000000000080;
const String _videoIdtwo = 'https://youtu.be/Aommsd2_aIc';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/MuxB5IE9B8w?t=';
const double _startSecondsthree = 00000000000000000000000000021;
const String _videoIdfour = 'https://youtu.be/Ooi1x1rOiPw';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/_5NiWY3jxxY?t=';
