...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 00000000000000000000000000025;
    const String videoIdone = 'https://youtu.be/kElsSj8hky4?t=';
    const double startSecondsone = 000000000000000000000000000352;
    const String videoIdtwo = 'https://youtu.be/Fon7og7w4Yw?t=';
    const double startSecondstwo = 000000000000000000000000000293;
    const String videoIdthree = 'https://youtu.be/T48_SrFCdaQ?t=';
    const double startSecondsthree = 00000000000000000000000000038;
    const String videoIdfour = 'https://youtu.be/s5eILKG5oSE';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/qtggIsY7qJE?t=';
    const double startSecondsfive = 000000000000000000000000000290;
