...
class EnglishEntryexpansion extends StatefulWidget {
  const EnglishEntryexpansion({super.key});

  @override
  State<EnglishEntryexpansion> createState() => _EnglishEntryexpansionState();
}

class _EnglishEntryexpansionState extends State<EnglishEntryexpansion> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""expansion""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """expansion""",
                      // alsoEnglishWord: "also: expansion",
                      britshText: """IpaUK: /ɪkˈspænʃn/""",
                      americanText: """IpaUS: /ɪkˈspænʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "expansion";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The expansion of higher education will continue.""");
  }
...
// With short examples define "expansion", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: کشان،	گەورەبوونەوە، فراوان‌بوونەوە، کرانەوە، بەرین‌بوونەوە، فش‌بوونەوە، پان‌بوونەوە، فرەهـبوون، پەرەسەندن، گەشەسەندن، زۆربوون
"""),
          const DefinitionKurdish(
              text: """١. (ناو) گەورەترکردن لە ئەندازە، ژمارە، یان گرنگی"""),
          SentencesRow(
            englishText:
                """Despite the recession the company is confident of further expansion.""",
            kurdishText:
                """سەرەڕای قەیرانەکە کۆمپانیاکە باوەڕی بە فراوانبوونی زیاتر هەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The expansion of higher education will continue.""",
            kurdishText: """فراوانبوونی خوێندنی باڵا بەردەوام دەبێت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: expansion (Derived forms: expansions)
1. The act of increasing (something) in size, volume, quantity or scope (= enlargement)
 
2. (mathematics) a function expressed as a sum or product of terms
"the expansion of (a+b)expansion2 is aexpansion2 + 2ab + bexpansion2"
 
3. A discussion that provides additional information (= enlargement, elaboration)
 
4. Adding information or detail (= expanding upon)
""",
  );
...
const double _startSecondsend = 000000000000000000000000000000; // 498;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/QLq6GEiHqR8?t=';
const double _startSecondsone = 00000000000000000000000000000; // 252;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/tsxmyL7TUJg?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 586;
const String _videoIdthree = 'VIDEOhttps://youtu.be/yRmOWcWdQAo?t=';
const double _startSecondsthree = 000000000000000000000000000; // 336;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/FQ4hvLqNfqo?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1348;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/oI_X2cMHNe0?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 398;
