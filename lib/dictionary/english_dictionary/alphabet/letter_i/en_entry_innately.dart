...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'd6iQrh2TK98';
    const double startSecondsend = 1235;
    const String videoIdone = 'Sbp_EeBk-As';
    const double startSecondsone = 944;
    const String videoIdtwo = 'ErPsyBUCijM';
    const double startSecondstwo = 966;
    const String videoIdthree = 'f9SA25OukyM';
    const double startSecondsthree = 1125;
    const String videoIdfour = 'rJalBwzWbdU';
    const double startSecondsfour = 126;
    const String videoIdfive = 'o0FiG7c6m48';
