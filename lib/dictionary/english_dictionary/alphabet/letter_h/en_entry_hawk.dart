...
class EnglishEntryhawk extends StatefulWidget {
  const EnglishEntryhawk({super.key});

  @override
  State<EnglishEntryhawk> createState() => _EnglishEntryhawkState();
}

class _EnglishEntryhawkState extends State<EnglishEntryhawk> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hawk (Derived forms: hawking, hawks, hawked)
1. Diurnal bird of prey typically having short rounded wings and a long tail
 
2. An advocate of an aggressive policy on foreign relations (- war hawk)
 
3. A square board with a handle underneath; used by masons to hold or carry mortar (- mortarboard)

- Verb: hawk
1. Sell or offer for sale from place to place (- peddle, monger, huckster [N. Amer], vend, pitch)
"He had been told to hawk his papers elsewhere";
 
2. Hunt with hawks
"the tribes like to hawk in the desert"
 
3. Clear mucus or food from one's throat (- clear the throat, harrumph)
""",
  );

  final String keyword = "hawk";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He waited, watching her like a hawk.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hawk swooped low over the field.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The senator is known as a hawk in foreign policy.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He made a living hawking cleaning products from door to door.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hawk""",
                      // alsoEnglishWord: "also: hawk",
                      britshText: """IpaUK: /hɔːk/""",
                      americanText: """IpaUS: /hɔːk/""",
...
کوردی: باز، هەڵۆ، واشۆ، واشە، شاهین، لاچین، شەڕخواز
"""),
                    const DefinitionKurdish(text: """١. (ناو) باڵندەیەکی ڕاوکەری بەهێز و خێرا"""),
                    SentencesRow(
                      englishText: """He waited, watching her like a hawk (= watching her very closely).""",
                      kurdishText: """چاوەڕێی کرد و وەک باز چاودێری دەکرد.""",
                    ...
                    SentencesRow(
                      englishText: """The hawk swooped low over the field.""",
                      kurdishText: """بازەکە نزم دابەزی بەسەر کێڵگەدا.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) کەسێک، بە تایبەتی سیاسەتمەدارێک، کە لەگەڵ شەڕ دایە بۆ چارەسەری کێشە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The senator is known as a hawk in foreign policy.""",
                      kurdishText: """سیناتۆرەکە لە سیاسەتی دەرەوەدا بە شەڕخواز ناسراوە.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) هەوڵدان بۆ فرۆشتنی شت بەوەی لە شوێنێک بۆ شوێنێکی دیکە بچیت بۆ ئەوەی خەڵکی لێت بکڕێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He made a living hawking cleaning products from door to door.""",
                      kurdishText: """بژێوی پەیدا دەکرد بەوەی دەرگا بە دەرگا دەچوو بۆ فرۆشتنی بەرهەمی پاککەرەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/XpIWBjUoG30?t=';
const double _startSecondsend = 000000000000000000000000000231;
const String _videoIdone = 'https://youtu.be/kHrjgWoy8qY?t=';
const double _startSecondsone = 000000000000000000000000000102;
const String _videoIdtwo = 'https://youtu.be/lm0CtcEZV4E?t=';
const double _startSecondstwo = 00000000000000000000000000094;
const String _videoIdthree = 'https://youtu.be/V3oIsGkS-iI?t=';
const double _startSecondsthree = 00000000000000000000000000016;
const String _videoIdfour = 'https://youtu.be/Xnpunaq7cvw';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/9gr7GMfjnX8?t=';
