...
class EnglishEntryfrightfully extends StatefulWidget {
  const EnglishEntryfrightfully({super.key});

  @override
  State<EnglishEntryfrightfully> createState() =>
      _EnglishEntryfrightfullyState();
}

class _EnglishEntryfrightfullyState extends State<EnglishEntryfrightfully> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: frightfully
1. Used as an intensifier (= terribly, awfully, awful [N. Amer], execrably, appallingly)
"frightfully interesting";
""",
  );

  final String keyword = "frightfully";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frightfully""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'm frightfully sorry.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I'm frightfully sorry about the noise last night.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She’s frightfully smart.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frightfully""",
                      // alsoEnglishWord: "also: frightfully",
                      britshText: """IpaUK: /ˈfraɪtfəli/""",
                      americanText: """IpaUS: /ˈfraɪtfəli/""",
...
// With short examples define "frightfully", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """I'm frightfully sorry.""",
                      kurdishText: """زۆر بمبوورە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆر بەداخەوەم بۆ دەنگەدەنگەکەی دوێنێ شەو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She’s frightfully smart.""",
                      kurdishText: """ئێجگار زیرەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/_yMMTVVJI4c?t=';
const double _startSecondsend = 000000000000000000000000000305;
const String _videoIdone = 'https://youtu.be/YAEZiwpCK3s?t=';
const double _startSecondsone = 000000000000000000000000000293;
const String _videoIdtwo = 'https://youtu.be/8g7YWsjzr2U?t=';
const double _startSecondstwo = 00000000000000000000000000073;
const String _videoIdthree = 'https://youtu.be/uOSnQM1Zu4w?t=';
const double _startSecondsthree = 000000000000000000000000000176;
const String _videoIdfour = 'https://youtu.be/ZZC0SP02PqY?t=';
const double _startSecondsfour = 000000000000000000000000000154;
const String _videoIdfive = 'https://youtu.be/z2G3R-nT6Vw?t=';
