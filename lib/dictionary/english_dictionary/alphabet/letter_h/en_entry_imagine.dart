...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001035;
    const String videoIdone = 'https://youtu.be/nRafaCcfrcI?t=';
    const double startSecondsone = 000000000000000000000000000378;
    const String videoIdtwo = 'https://youtu.be/dJzTse9Dsaw?t=';
    const double startSecondstwo = 000000000000000000000000000237;
    const String videoIdthree = 'https://youtu.be/dtp6b76pMak?t=';
    const double startSecondsthree = 000000000000000000000000000665;
    const String videoIdfour = 'https://youtu.be/bHIhgxav9LY';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/BZbChKzedEk?t=';
    const double startSecondsfive = 000000000000000000000000000301;
