...
class EnglishEntryheated extends StatefulWidget {
  const EnglishEntryheated({super.key});

  @override
  State<EnglishEntryheated> createState() => _EnglishEntryheatedState();
}

class _EnglishEntryheatedState extends State<EnglishEntryheated> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: heated
1. Made warm or hot (- heated up, het [UK, dialect], het up [UK, dialect])
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She became very heated.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heated""",
                      // alsoEnglishWord: "also: heated",
                      britshText: """IpaUK: /ˈhiːtɪd/""",
                      americanText: """IpaUS: /ˈhiːtɪd/""",
...
const double _startSecondsend = 000000000000000000000000000596;
const String _videoIdone = 'https://youtu.be/Cqbleas1mmo?t=';
const double _startSecondsone = 000000000000000000000000000508;
const String _videoIdtwo = 'https://youtu.be/7j5ul4XBjAI?t=';
const double _startSecondstwo = 000000000000000000000000000110;
const String _videoIdthree = 'https://youtu.be/AwhBTrzzqeg?t=';
const double _startSecondsthree = 000000000000000000000000000491;
const String _videoIdfour = 'https://youtu.be/raSeaAeryWE?t=';
const double _startSecondsfour = 000000000000000000000000000710;
const String _videoIdfive = 'https://youtu.be/kTaYet07Ioo?t=';
