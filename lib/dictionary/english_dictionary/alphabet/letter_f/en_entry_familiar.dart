...
class EnglishEntryfamiliar extends StatefulWidget {
  const EnglishEntryfamiliar({super.key});

  @override
  State<EnglishEntryfamiliar> createState() => _EnglishEntryfamiliarState();
}

class _EnglishEntryfamiliarState extends State<EnglishEntryfamiliar> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""familiar""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """familiar""",
                      // alsoEnglishWord: "also: familiar",
                      britshText: """IpaUK: /fəˈmɪliə(r)/""",
                      americanText: """IpaUS: /fəˈmɪliər/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I couldn’t see any familiar faces in the room.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He's a familiar figure in the neighbourhood.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Then she heard a familiar voice.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The cast contains a number of familiar names.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The song was vaguely familiar.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His face looked awfully familiar.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Are you familiar with the computer software they use?""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""You seem to be on very familiar terms with your tutor.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was being overly familiar with Gloria.""");
  }

// With short examples define "familiar", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
              ...
              MyExpansionTile(
                children: [
                  SentencesRow(
                    ...
                    kurdishText: """کەسێکی ناسیاوە لە گەڕەکەکە.""",
                    onPressedBritish: () => speaksentence2("en-GB"),
                    onPressedAmerican: () => speaksentence2("en-US"),
                  ),
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """Then she heard a familiar voice.""",
                    kurdishText: """دواتر دەنگێکی ئاشنای بیست.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """دەستەی ئەکتەران ژمارەیەک ناوی ناسیاو لەخۆدەگرێت.""",
                    onPressedBritish: () => speaksentence4("en-GB"),
                    onPressedAmerican: () => speaksentence4("en-US"),
                  ),
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """The song was vaguely familiar.""",
                    kurdishText: """گۆرانییەکە کەمێک ئاشنا بوو.""",
                  ...
                  SentencesRow(
                    englishText:
                        """The smell is very familiar to everyone who lives near a bakery.""",
                    kurdishText:
                        """بۆنەکە زۆر ئاشنا بوو بۆ کەسانێک کە لە نزیک نانەواخانە دەژین.""",
                    onPressedBritish: () => speaksentence6("en-GB"),
                    onPressedAmerican: () => speaksentence6("en-US"),
                  ),
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """His face looked awfully familiar.""",
                    kurdishText: """ڕووخساری تەواو ناسیاو بوو.""",
          ...
          SentencesRow(
            englishText:
                """You will soon become familiar with the different activities.""",
            kurdishText: """زوو ناسیاو دەبیت لەگەڵ چالاکییە جیاوازەکان.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He was being overly familiar with Gloria.""",
            kurdishText: """ئێجگار زۆر گەرم‌وگوڕ بوو لەگەڵ گلۆریا.""",
...
3. Having mutual interests or affections; of established friendship (= intimate)
"on familiar terms";
...
const String _videoIdfour = 'fXLrw7XozC8';
const double _startSecondsfour = 302;
const String _videoIdfive = 'MGacKah0ASs';
