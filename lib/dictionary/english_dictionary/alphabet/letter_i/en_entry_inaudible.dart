...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'QvK7mlJdS_w';
    const double startSecondsend = 494;
    const String videoIdone = 'WziLgtdPSSk';
    const double startSecondsone = 667;
    const String videoIdtwo = 'z247GzZ_D1w';
    const double startSecondstwo = 243;
    const String videoIdthree = 'sMLhsrSfpwA';
    const double startSecondsthree = 515;
    const String videoIdfour = 'D0p3WqTzd2o';
    const double startSecondsfour = 993;
    const String videoIdfive = 'sYeM4H2-94A';
    const double startSecondsfive = 1077;
