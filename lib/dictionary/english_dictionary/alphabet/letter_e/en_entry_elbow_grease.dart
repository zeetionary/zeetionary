...
class EnglishEntryelbowgrease extends StatefulWidget {
  const EnglishEntryelbowgrease({super.key});

  @override
  State<EnglishEntryelbowgrease> createState() =>
      _EnglishEntryelbowgreaseState();
}

class _EnglishEntryelbowgreaseState extends State<EnglishEntryelbowgrease> {
  @override
  void initState() {
    super.initState();
  }
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "elbow grease";
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "elbow grease");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: elbow grease");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /ˈelbəʊ ɡriːs/");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakelbowgrease(String languageCode) async {
  ...
  Widget build(BuildContext context) {
    return CustomIconButtonBritish(
      onPressed: () => speakelbowgrease("en-GB" ""),
    );
  }
}
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /ˈelbəʊ ɡriːs/");
  }
}
...
class TTSUS extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomIconButtonAmerican(
      onPressed: () => speakelbowgrease("en-US" ""),
    );
  }
}
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakelbowgreases1(String languageCode) async {
    // DOPSUM: CHANGE speakelbowgrease
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
...
// Create an instance of EnglishMeaningConst with the desired text
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: elbow grease
1. Use of physical or mental energy; hard work (= effort, exertion, travail [literary], sweat [informal])
"he got an A for elbow grease";
""",
  );
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  late YoutubePlayerController _controller;
  final String _videoId = 'https://youtu.be/6ta_sftSfIw?t=';
...
class _YoutubeEmbeddedtwoState extends State<YoutubeEmbeddedtwo> {
  late YoutubePlayerController _controller;
  final String _videoId = 'https://youtu.be/vojsscI61Sk?t=';
...
class _YoutubeEmbeddedthreeState extends State<YoutubeEmbeddedthree> {
  late YoutubePlayerController _controller;
  final String _videoId = 'https://youtu.be/8JFmGxmqkkU?t=';
...
class _YoutubeEmbeddedfourState extends State<YoutubeEmbeddedfour> {
  late YoutubePlayerController _controller;
  final String _videoId = 'https://youtu.be/72eq0zeUH3A?t=';
...
class _YoutubeEmbeddedfiveState extends State<YoutubeEmbeddedfive> {
  late YoutubePlayerController _controller;
  final String _videoId = 'https://youtu.be/_ihseKhJEXo?t=';
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  late YoutubePlayerController _controller;
  final String _videoId = 'https://youtu.be/dFh7tZoGYA4?t=';
