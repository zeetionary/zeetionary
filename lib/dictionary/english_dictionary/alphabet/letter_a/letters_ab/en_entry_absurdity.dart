...
class EnglishEntryabsurdity extends StatefulWidget {
  const EnglishEntryabsurdity({super.key});

  @override
  State<EnglishEntryabsurdity> createState() => _EnglishEntryabsurdityState();
}

class _EnglishEntryabsurdityState extends State<EnglishEntryabsurdity> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "absurdity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""absurdity""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """absurdity""",
                      // alsoEnglishWord: "also: absurdity",
                      britshText: """IpaUK: /əbˈsɜːdəti/""",
                      americanText: """IpaUS: /əbˈsɜːrdəti/""",
