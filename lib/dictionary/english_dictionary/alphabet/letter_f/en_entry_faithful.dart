...
class EnglishEntryfaithful extends StatefulWidget {
  const EnglishEntryfaithful({super.key});

  @override
  State<EnglishEntryfaithful> createState() => _EnglishEntryfaithfulState();
}

class _EnglishEntryfaithfulState extends State<EnglishEntryfaithful> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""faithful""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """faithful""",
                      // alsoEnglishWord: "also: faithful",
                      britshText: """IpaUK: /ˈfeɪθfl/""",
                      americanText: """IpaUS: /ˈfeɪθfl/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He has been a very faithful friend to me.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He had remained entirely faithful to his wife.""");
  }
...
کوردی: بەوەفا، بەئەمەک، ئەمەگ‌دار، پێزان، سەرڕاست، دڵسۆز، یەکلا،	سەرڕاستانە،	جێی ڕابینین، جێی‌باوەڕ،	بەدین، دیندار، بەبڕوا، بەباوەڕ،	لایەنگر، پشتیوان،	لێ‌ڕابینراو، دروست، ڕاست، ڕاستەقینە، پشت‌پێبەستراو، باوەڕپێکراو،	باوەڕداران، خاوەن‌باوەڕان، ئیمانداران، بەدینان،	بڕواداران، لایەنگران، ئالیگران، پشتیوانان
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) مانەوە لەگەڵ کەسێک، دامەزراوەیەک، یان باوەڕێکی دیاریکراو، یان پشتگیری کردنی"""),
          SentencesRow(
            englishText:
                """She was rewarded for her 40 years' faithful service with the company.""",
            kurdishText:
                """خەڵات کرا بۆ خزمەتی ٤٩ ساڵەی وەفادارانەی بە کۆمپانیاکە.""",
          ...
          SentencesRow(
            englishText:
                """I have been a faithful reader of your newspaper for many years.""",
            kurdishText:
                """بۆ چەندین ساڵە خوێنەرێکی دڵسۆزی ڕۆژنامەکەتان بوومە.""",
          ...
          SentencesRow(
            englishText:
                """The president will keep the support of the party faithful.""",
            kurdishText: """سەرۆک پشتگیریی دڵسۆزانی پارتەکە دەپارێزێت.""",
          ...
          SentencesRow(
            ...
            kurdishText: """فیلمەکە ڕێک وەک ڕۆمانە ڕەسەنەکەیە.""",
...
const String _videoIdend = 'https://youtu.be/L1kYZHnHS0E?t=';
const double _startSecondsend = 0000000000000000000000000002544;
const String _videoIdone = 'https://youtu.be/A5a2Guy8-_8?t=';
const double _startSecondsone = 00000000000000000000000000070;
const String _videoIdtwo = 'https://youtu.be/l-RzJVQYPi0?t=';
const double _startSecondstwo = 0000000000000000000000000001609;
const String _videoIdthree = 'https://youtu.be/l-RzJVQYPi0?t=';
const double _startSecondsthree = 0000000000000000000000000001606;
const String _videoIdfour = 'https://youtu.be/DroTM9SqcWI?t=';
const double _startSecondsfour = 000000000000000000000000000176;
const String _videoIdfive = 'https://youtu.be/Ir3eJ1t13fk?t=';
const double _startSecondsfive = 0000000000000000000000000001679;
