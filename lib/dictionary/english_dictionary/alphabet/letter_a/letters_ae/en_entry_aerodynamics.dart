...
// replace these: replace EnglishEntryaerodynamics - replace speakAerodynamics - replace aerodynamics - /ˌerəʊdaɪˈnæmɪks/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaerodynamics extends StatelessWidget {
  EnglishEntryaerodynamics({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAerodynamics(String languageCode) async {
    // DOPSUM: CHANGE speakAerodynamics
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("aerodynamics"); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "aerodynamics", // DOPSUM: CHANGE WORD ENTRY - Find /ˌeərəʊdaɪˈnæmɪks/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌeərəʊdaɪˈnæmɪks/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'OnUFE0Uqd80';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'wlJlayVteog';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'FG2lWRAW-aU';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'iLOBnaIOnQw';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'gm987m20edg';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'XZxn2IhTRmw';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'ma4OelXpuHM';
