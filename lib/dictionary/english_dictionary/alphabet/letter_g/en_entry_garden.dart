...
class EnglishEntrygarden extends StatefulWidget {
  const EnglishEntrygarden({super.key});

  @override
  State<EnglishEntrygarden> createState() => _EnglishEntrygardenState();
}

class _EnglishEntrygardenState extends State<EnglishEntrygarden> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She has created a garden out of a wilderness.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The garden is laid out in 18th-century style.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We got someone to design the garden for us.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Weekends were spent doing the garden.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""More people are choosing to garden.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """garden""",
                      // alsoEnglishWord: "also: garden",
                      britshText: """IpaUK: /ˈɡɑːdn/""",
                      americanText: """IpaUS: /ˈɡɑːrdn/""",
...
const String _videoIdtwo = 'https://youtu.be/QuEo67fEbIg?t=';
const double _startSecondstwo = 00000000000000000000000000023;
const String _videoIdthree = 'https://youtu.be/9Z3hgEWNq8s?t=';
const double _startSecondsthree = 0000000000000000000000000006;
const String _videoIdfour = 'https://youtu.be/hTqtGJwsJVE?t=';
const double _startSecondsfour = 000000000000000000000000000874;
const String _videoIdfive = 'https://youtu.be/544DTGHIBM0?t=';
const double _startSecondsfive = 000000000000000000000000000498;
