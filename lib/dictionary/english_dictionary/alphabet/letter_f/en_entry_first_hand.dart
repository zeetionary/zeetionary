...
class EnglishEntryfirsthand extends StatefulWidget {
  const EnglishEntryfirsthand({super.key});

  @override
  State<EnglishEntryfirsthand> createState() => _EnglishEntryfirsthandState();
}

class _EnglishEntryfirsthandState extends State<EnglishEntryfirsthand> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: first-hand
1. Received directly from a source
"first-hand information"

- Adverb: first-hand
1. From the original source; directly (= at first hand)
"I heard this story firsthand";
""",
  );

  final String keyword = "first-hand";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""first-hand""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Most of us have firsthand experience of teaching.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """first-hand""",
                      // alsoEnglishWord: "also: first-hand",
                      britshText: """IpaUK: /ˌfɜːst ˈhænd/""",
                      americanText: """IpaUS: /ˌfɜːrst ˈhænd/""",
...
کوردی: ڕاستەوخۆ، سەرەکی، دەستی ئەوەڵ
"""),
// With short examples define "first-hand", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە خۆت بەدەستت هێناوە یان ئەزموونت کردووە"""),
                    SentencesRow(
                      englishText:
                          """Most of us have firsthand experience of teaching.""",
                      kurdishText:
                          """زۆرێکمان ئەزموونی ڕاستەوخۆی وانەگوتنەوەمان هەیە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) کە هی خۆتە نەک کەسێکی دیکە پێی دابیت یان گوتبێتی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Most of the older reporters have experienced war firsthand.""",
                      kurdishText:
                          """زۆرێک لە پەیامنێرە کۆنەکان بۆ خۆیان ئەزموونی جەنگیان کردووە.""",
...
const double _startSecondsend = 0000000000000000000000000001734;
const String _videoIdone = 'https://youtu.be/j1BfO7VlIw4?t=';
const double _startSecondsone = 0000000000000000000000000001188;
const String _videoIdtwo = 'https://youtu.be/3RkhZgRNC1k?t=';
const double _startSecondstwo = 0000000000000000000000000002042;
const String _videoIdthree = 'https://youtu.be/x6a4hMyiwBo?t=';
const double _startSecondsthree = 000000000000000000000000000330;
const String _videoIdfour = 'https://youtu.be/USL6P8haroY?t=';
const double _startSecondsfour = 0000000000000000000000000001026;
const String _videoIdfive = 'https://youtu.be/IDJ8tkf_omU?t=';
