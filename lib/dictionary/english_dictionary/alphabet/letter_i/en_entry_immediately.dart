...
class EnglishEntryimmediately extends StatefulWidget {
  const EnglishEntryimmediately({super.key});

  @override
  State<EnglishEntryimmediately> createState() =>
      _EnglishEntryimmediatelyState();
}

class _EnglishEntryimmediatelyState extends State<EnglishEntryimmediately> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: immediately
1. Without delay or hesitation; with no time intervening (- instantly, straightaway, straight off, directly, now, right away, at once, forthwith, like a shot [informal], right off the bat [N. Amer, informal], instantaneously, outright, in a flash, tout de suite)
...
""",
  ...
  final String keyword = "immediately";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""immediately""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She answered almost immediately.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They immediately began arguing.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They voted to cease strike action immediately.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Turn right immediately after the church.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Who is immediately above a colonel in rank?""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 000000000000000000000000000524;
    const String videoIdtwo = 'https://youtu.be/ARERGvMzhmc?t=';
    const double startSecondstwo = 000000000000000000000000000293;
    const String videoIdthree = 'https://youtu.be/6z6g8mKEs9k?t=';
    const double startSecondsthree = 0000000000000000000000000005;
    const String videoIdfour = 'https://youtu.be/r-Or05EFLUM?t=';
    const double startSecondsfour = 00000000000000000000000000045;
    const String videoIdfive = 'https://youtu.be/jBbiUirrCFM?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """immediately""",
                      // alsoEnglishWord: "also: immediately",
                      britshText: """IpaUK: /ɪˈmiːdiətli/""",
                      americanText: """IpaUS: /ɪˈmiːdiətli/""",
...
کوردی: دەسبەجێ، دەست‌وبرد، لەڕێوە، ڕاستەوخۆ، یەکسەرە، بێ‌مەحتەلی، هەرکە
"""),
// With short examples define "immediately", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) بەبێ دواکەوتن"""),
                    const AlsoEnglishckb(word: "ھەروەھا: at once"),
                    SentencesRow(
                      englishText: """She answered almost immediately.""",
                      kurdishText: """تا ڕادەیەک دەسبەجێ وەڵامی دایەوە.""",
                        ...
                        MyExpansionTile(
                          children: [
                            SentencesRow(
                              ...
                              kurdishText:
                                  """دەسبەجێ دەستیان بە مشتوومڕ کرد.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵکار) زۆر نزیک لە کات یان شوێنێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Turn right immediately after the church.""",
                      kurdishText: """ڕێک لە دوای کڵێساکە بۆ ڕاست پێچبکەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کێ ڕاستەوخۆ لە سەروو کۆلۆنێڵەوەیە لە پلەدا؟""",
                      onPressedBritish: () => speaksentence12("en-GB"),
                      onPressedAmerican: () => speaksentence12("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ھاوەڵکار) لە نزیکەوە و ڕاستەوخۆ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Counselling is being given to those most immediately affected by the tragedy.""",
                      kurdishText:
                          """ڕاوێژکاری دەدرێت بەو کەسانەی کە ڕاستەوخۆ کاریگەر بوون بە تراژیدیاکە.""",
