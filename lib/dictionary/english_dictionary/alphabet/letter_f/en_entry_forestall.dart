...
class EnglishEntryforestall extends StatefulWidget {
  const EnglishEntryforestall({super.key});

  @override
  State<EnglishEntryforestall> createState() => _EnglishEntryforestallState();
}

class _EnglishEntryforestallState extends State<EnglishEntryforestall> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: forestall (Derived forms: forestalls, forestalling, forestalled)
1. Keep from happening or arising; make impossible (= prevent, foreclose, preclude, forbid)
"Your role in the projects forestalls your involvement in the competitive project";
 
2. Act in advance of; deal with ahead of time (= anticipate, foresee, counter)
""",
  );

  final String keyword = "forestall";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forestall""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forestall""",
                      // alsoEnglishWord: "also: forestall",
                      britshText: """IpaUK: /fɔːˈstɔːl/""",
                      americanText: """IpaUS: /fɔːrˈstɔːl/""",
...
// With short examples define "forestall", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Try to anticipate what your child will do and forestall problems.""",
                      kurdishText:
                          """هەوڵ بدە پێشبینی ئەوە بکە کە منداڵەکەت دەیکات و ڕێگری لە کێشە بکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Any plans for a peaceful settlement were forestalled by the intervention of the army.""",
                      kurdishText:
                          """هەر پلانێک بۆ چارەسەری ئاشتی بە دەستێوەردانی سوپا ڕێگری لێدەکرا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/fHAA9tV8M28?t=';
const double _startSecondsend = 000000000000000000000000000760;
const String _videoIdone = 'https://youtu.be/Ht8D7Q31P3c?t=';
const double _startSecondsone = 000000000000000000000000000424;
const String _videoIdtwo = 'https://youtu.be/NK8Mj4eBjcI?t=';
const double _startSecondstwo = 0000000000000000000000000001364;
const String _videoIdthree = 'https://youtu.be/Xm9yOvNAmRk?t=';
const double _startSecondsthree = 0000000000000000000000000001698;
const String _videoIdfour = 'https://youtu.be/Q8d5VWH2oGc?t=';
const double _startSecondsfour = 000000000000000000000000000344;
const String _videoIdfive = 'https://youtu.be/8EQ_axr1y7Y?t=';
const double _startSecondsfive = 0000000000000000000000000002434;
