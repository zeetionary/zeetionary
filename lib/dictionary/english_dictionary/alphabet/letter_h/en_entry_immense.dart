...
class EnglishEntryimmense extends StatefulWidget {
  const EnglishEntryimmense({super.key});

  @override
  State<EnglishEntryimmense> createState() => _EnglishEntryimmenseState();
}

class _EnglishEntryimmenseState extends State<EnglishEntryimmense> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryimmense immense
WORD_WEB immense immense immense
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200

  final String keyword = "immense";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""immense""");
  }
...
کوردی: 
"""),
// With short examples define "immense", please follow LX instructions
