...
// replace EnglishEntryAdopsum - replace speakArbitration

// replace arbitration - /ˌɑːbɪˈtreɪʃn/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarbitration extends StatelessWidget {
  // blank divider
  EnglishEntryarbitration({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arbitration"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌɑːbɪˈtreɪʃn/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌɑːrbɪˈtreɪʃn/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'WpQQOQ__1ok';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 1990;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'aS6z0bEpVpM';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'rMimQEhClJc';
