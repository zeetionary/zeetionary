...
class EnglishEntryeternally extends StatefulWidget {
  const EnglishEntryeternally({super.key});

  @override
  State<EnglishEntryeternally> createState() => _EnglishEntryeternallyState();
}

class _EnglishEntryeternallyState extends State<EnglishEntryeternally> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""eternally""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """eternally""",
                      // alsoEnglishWord: "also: eternally",
                      britshText: """IpaUK: /ɪˈtɜːnəli/""",
                      americanText: """IpaUS: /ɪˈtɜːrnəli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "eternally";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'll be eternally grateful to you for this.""");
  }
...
کوردی: (بۆ) هەمیشە، بێ‌وچان، لەسەریەک، یەکبینە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵکار) بەشێوەیەک کە بۆ هەمیشەیی بوونی هەیە و بەردەوام دەبێت"""),
          SentencesRow(
            englishText: """I'll be eternally grateful to you for this.""",
            kurdishText: """بۆ ئەمە بۆ هەمیشەیی قەرزارتم.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ھاوەڵکار) بەشێوەیەک کە بە ردەوامە لە ڕوودان و وەها دەرناکەوێت کە بوەستێت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """I am eternally amazed at what some people will do for money.""",
            kurdishText: """هەمیشە سەرسامم بەوەی هەندێک کەس بۆ پارە دەیکەن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: eternally
1. For a limitless time (= everlastingly, forever, evermore)
...
const double _startSecondsend = 000000000000000000000000000000; // 4868;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/K4xWCljHJLE?t=';
const double _startSecondsone = 00000000000000000000000000000; // 504;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/G1FLUuDKRYI?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 481;
const String _videoIdthree = 'VIDEOhttps://youtu.be/DbhuZFVqAqc?t=';
const double _startSecondsthree = 000000000000000000000000000; // 2081;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/jzdHQUKYS3Q?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1186;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/ZbVcG8_0bzY?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 589;
