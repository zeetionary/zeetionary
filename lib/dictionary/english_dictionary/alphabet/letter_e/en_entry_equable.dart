...
class EnglishEntryequable extends StatefulWidget {
  const EnglishEntryequable({super.key});

  @override
  State<EnglishEntryequable> createState() => _EnglishEntryequableState();
}

class _EnglishEntryequableState extends State<EnglishEntryequable> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""equable""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equable""",
                      // alsoEnglishWord: "also: equable",
                      britshText: """IpaUK: /ˈekwəbl/""",
                      americanText: """IpaUS: /ˈekwəbl/""",
...
کوردی: مام‌ناوەند، فێنک، ئەندازە، سازگار، خۆش،	لەسەرەخۆ، ئارام
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) لەسەرخۆ بەجۆرێک کە بە ئاسانی تووڕە نابێت"""),
          SentencesRow(
            englishText:
                """He was in a remarkably equable mood when he spoke to reporters last night.""",
            kurdishText:
                """لە کەشێکی تەواو لەسەرەخۆ بوو کە دوێنێ شەو قسەی لەگەڵ پەیامنێران کرد.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ھاوەڵناو) کەشووهەوایەک کە جێگیرە و گۆڕانی لەناکاوی تێدا نییە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The south of the country enjoys an equable climate.""",
            kurdishText: """باشووری وڵاتەکە ئاووهەوایەکی جێگیری هەیە.""",
...
2. Not easily irritated (= even-tempered, good-tempered, placid)
"an equable temper";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/Yc28bsBxJnA?t=';
const double _startSecondsend = 000000000000000000000000000000; // 429;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/VeBX4WjhhXs?t=';
const double _startSecondsone = 00000000000000000000000000000; // 2844;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/huPKeL5aBQ4?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1415;
const String _videoIdthree = 'VIDEOhttps://youtu.be/vOfMlY-5mTY?t=';
const double _startSecondsthree = 000000000000000000000000000; // 756;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/Mdj-FhISI8I?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1087;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/LmNwa4tD9KU?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 5943;
