...
class EnglishEntryfable extends StatefulWidget {
  const EnglishEntryfable({super.key});

  @override
  State<EnglishEntryfable> createState() => _EnglishEntryfableState();
}

class _EnglishEntryfableState extends State<EnglishEntryfable> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fable""",
                      // alsoEnglishWord: "also: fable",
                      britshText: """IpaUK: /ˈfeɪbl/""",
                      americanText: """IpaUS: /ˈfeɪbl/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The children enjoyed the fable of the tortoise and the hare.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        """The fable of the tortoise and the hare teaches us patience.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His story about meeting a dragon is just a fable.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) چیرۆکێک کە وانەیەکی ئەخلاقی فێر دەکات، بەتایبەتی کە ئاژەڵ تێیدا قسە دەکات؛ ئەم جۆرە چیرۆکانە"""),
          SentencesRow(
            englishText:
                """The children enjoyed the fable of the tortoise and the hare.""",
            kurdishText:
                """منداڵەکان چێژیان بینی لە چیرۆکی کیسەڵ و کەروێشکەکە.""",
          ...
          SentencesRow(
            englishText:
                """The fable of the tortoise and the hare teaches us patience.""",
            kurdishText: """چیرۆکی کیسەڵ و کەروێشکەکە سەبرمان فێر دەکات.""",
...
const String _videoIdend = 'https://youtu.be/TfaMLqEh1qM?t=';
const double _startSecondsend = 000000000000000000000000000923;
const String _videoIdone = 'https://youtu.be/GxdaYxunZXg?t=';
const double _startSecondsone = 00000000000000000000000000079;
const String _videoIdtwo = 'https://youtu.be/DH6Utz9KYOQ?t=';
const double _startSecondstwo = 000000000000000000000000000773;
const String _videoIdthree = 'https://youtu.be/GOayco-JCb0?t=';
const double _startSecondsthree = 000000000000000000000000000163;
const String _videoIdfour = 'https://youtu.be/AqkMykYQ7eU?t=';
const double _startSecondsfour = 000000000000000000000000000400;
const String _videoIdfive = 'https://youtu.be/cLEOqhwc3dA?t=';
