...
// With short examples define "global", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """This year the global economy will grow by about 4 per cent.""",
                      kurdishText:
                          """ئەمسال ئابووریی جیھان بە نزیکەیی ٤ لە سەد گەشە دەکات.""",
                    ...
                    SentencesRow(
                      englishText:
                          """A global study has just been started to chart the effects of climate change.""",
                      kurdishText:
                          """توێژینەوەیەکی جیھانی دەستپێکراوە بۆ کێشانی ھێڵکاریی کاریگەرییەکانی گۆڕانی کەشووھەوا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئیمەیڵێکی گشتگیریان نارد بۆ ھەموو ستافەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەبێت چارەسەرێکی زیاتر ھەمەلایەنە بگرینە بەر بۆ کێشەکە.""",
...
// 188888880002200
const String _videoIdend = 'F5pgG1M_h_U?t=';
...
const double _startSecondsthree = 1830;
const String _videoIdfour = 'f5NJQiY9AuY?t=';
const double _startSecondsfour = 244;
const String _videoIdfive = 'ekq24bjTSY4?t=';
