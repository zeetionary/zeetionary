...
class EnglishEntryindifferently extends StatefulWidget {
  const EnglishEntryindifferently({super.key});

  @override
  State<EnglishEntryindifferently> createState() =>
      _EnglishEntryindifferentlyState();
}

class _EnglishEntryindifferentlyState extends State<EnglishEntryindifferently> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "indifferently";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indifferently""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He shrugged indifferently.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/gRuarpWsKHY?t=';
    const double startSecondsend = 00000000000000000000000000091;
    const String videoIdone = 'https://youtu.be/DTQA2ONgOlE?t=';
    const double startSecondsone = 0000000000000000000000000001874;
    const String videoIdtwo = 'https://youtu.be/0DsfDUyn1kQ?t=';
    const double startSecondstwo = 000000000000000000000000000593;
    const String videoIdthree = 'https://youtu.be/aO_XltYHGWc?t=';
    const double startSecondsthree = 0000000000000000000000000002368;
    const String videoIdfour = 'https://youtu.be/0DsfDUyn1kQ?t=';
    const double startSecondsfour = 000000000000000000000000000594;
    const String videoIdfive = 'https://youtu.be/o1LFuEqDKAA?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indifferently""",
                      // alsoEnglishWord: "also: indifferently",
                      britshText: """IpaUK: /ɪnˈdɪfrəntli/""",
                      americanText: """IpaUS: /ɪnˈdɪfrəntli/""",
...
// With short examples define "indifferently", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      englishNote:
                          """This means that he shrugged without showing any particular interest, concern, or emotion. The word "indifferently" suggests that his action was casual or unconcerned, as if the situation did not matter to him.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) کە زۆر باش نییە؛ کە شارەزایی کەمە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The pictures were indifferently painted and poorly exhibited.""",
                      kurdishText:
                          """وێنەکان بە مام‌ناوەندی بۆیەکرابوون و بە خراپی نمایش کرابوون.""",
