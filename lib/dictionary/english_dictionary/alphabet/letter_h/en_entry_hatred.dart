...
class EnglishEntryhatred extends StatefulWidget {
  const EnglishEntryhatred({super.key});

  @override
  State<EnglishEntryhatred> createState() => _EnglishEntryhatredState();
}

class _EnglishEntryhatredState extends State<EnglishEntryhatred> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hatred (Derived forms: hatreds)
1. The emotion of intense dislike; a feeling of dislike so strong that it demands action (- hate)
""",
  );

  final String keyword = "hatred";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hatred""",
                      // alsoEnglishWord: "also: hatred",
                      britshText: """IpaUK: /ˈheɪtrɪd/""",
                      americanText: """IpaUS: /ˈheɪtrɪd/""",
...
کوردی: بێزاری، ڕق‌لێبوون، خۆش‌نەویستن، ناخۆش‌ویستن
"""),
// With short examples define "hatred", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) ڕقێکی زۆر بۆ کەسێک/شتێک"""),
                    SentencesRow(
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "ھەستەکانی بۆی لە ڕقەوە نزیک بوو.",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We must fight hatred with love.""",
                      kurdishText: """دەبێت بە خۆشەویستی دژی ڕق بوەستین.""",
...
const double _startSecondsone = 0000000000000000000000000001083;
const String _videoIdtwo = 'https://youtu.be/lsbcN9-jU1Y?t=';
const double _startSecondstwo = 000000000000000000000000000392;
const String _videoIdthree = 'https://youtu.be/FYVvE4tr2BI?t=';
const double _startSecondsthree = 00000000000000000000000000016;
const String _videoIdfour = 'https://youtu.be/wJa5Ch0O4BI?t=';
const double _startSecondsfour = 0000000000000000000000000002028;
const String _videoIdfive = 'https://youtu.be/-oHGafLPvEE?t=';
const double _startSecondsfive = 0000000000000000000000000002574;
