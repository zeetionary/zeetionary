...
// """),
                        ...
                        MyExpansionTile(
                          children: [
                            SentencesRow(
                              ...
                              kurdishText: """ھەندێکجار بە ڕاستی ڕقم لێیەتی.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """ڕقم لەوەیە ھەمیشە ڕەخنەم لێ دەگرێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I hate to say it, but I don't think their marriage will last.""",
                      kurdishText:
                          """بەداخەوەم کە بیڵێم، بەڵام پێم وانییە ھاوسەرگیرییەکەیان بەردەوام ببێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I hate to say it, but I don't think their marriage will last.""",
                      kurdishText:
                          """بەداخەوەم کە لە کاتت بگرم، بەڵام دەتوانم موبایلەکەت بەکاربھێنم؟""",
                    ...
                    SentencesRow(
                      englishText:
                          """Plastic flowers have always been a particular hate of mine.""",
                      kurdishText:
                          """گوڵی پلاستیکی ھەمیشە جێگای ڕقی من بوونە.""",
...
const double _startSecondstwo = 402;
const String _videoIdthree = 'f8VTSGLCa1M';
const double _startSecondsthree = 324;
const String _videoIdfour = 'BNRItz1Ngt0';
