...
class EnglishEntryflurry extends StatefulWidget {
  const EnglishEntryflurry({super.key});

  @override
  State<EnglishEntryflurry> createState() => _EnglishEntryflurryState();
}

class _EnglishEntryflurryState extends State<EnglishEntryflurry> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flurry (Derived forms: flurries)
1. A rapid active commotion (= bustle, hustle, ado, fuss, stir)
 
2. A light brief snowfall and gust of wind (or something resembling that) (= snow flurry)
"he had to close the window against the flurries"; "there was a flurry of chicken feathers";

- Verb: flurry (Derived forms: flurrying, flurries, flurried)
1. Move in an agitated or confused manner
 
2. Cause to feel embarrassment (= confuse, disconcert, put off)
"The constant attention of the young man flurried her";
""",
  );

  final String keyword = "flurry";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They arrived in a flurry of excitement.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""A flurry of shots rang out in the darkness.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Snow flurries began in the early morning.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flurry""",
                      // alsoEnglishWord: "also: flurry",
                      britshText: """IpaUK: /ˈflʌri/""",
                      americanText: """IpaUS: /ˈflɜːri/""",
...
کوردی: هاتنی با، هەڵکردنی با (ناکاو)،	بادەوە،	بارین، بارشت،	پەشۆکاوی، سەرسامی، تاسان، شڵەژان، فڕک‌وهۆڕ، فڕکەفڕک، جرپ‌وهۆڕ
"""),
// With short examples define "flurry", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ماوەیەک کە چالاکی، حەز. جۆش‌وخرۆشی، هتد ـی زۆر هەیە لە کاتێکی کەمدا"""),
                    SentencesRow(
                      englishText:
                          """They arrived in a flurry of excitement.""",
                      kurdishText: """بە خرۆشانێکی زۆرەوە هاتن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ژمارەیەکی زۆر تەقە کران لە تاریکییەکەدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بەفر بارین لە بەیانی زوودا دەستی پێکرد.""",
...
const String _videoIdone = 'https://youtu.be/pD4BUcD4e9w?t=';
const double _startSecondsone = 000000000000000000000000000176;
const String _videoIdtwo = 'https://youtu.be/YpkP6BZIFDE?t=';
const double _startSecondstwo = 000000000000000000000000000140;
const String _videoIdthree = 'https://youtu.be/v9tM_YHvhuA?t=';
const double _startSecondsthree = 000000000000000000000000000145;
const String _videoIdfour = 'https://youtu.be/fE4Z5hFLrqI?t=';
const double _startSecondsfour = 000000000000000000000000000145;
const String _videoIdfive = 'https://youtu.be/drd7jCqfQsY?t=';
