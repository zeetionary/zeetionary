...
کوردی: گواستنەوە، ڕاگوێستن، گوێزانەوە، ڕاکێشان، کێشان، بردن، ناردن، شاندن، هەڵگرتن، گەیاندن،	ڕاگوێزە، ئۆتۆمبێل،	(ماف) بەنێوکردن، ڕاگوێستن،	قەباڵەی بەناوکردن یان ڕاگوێستن، تاپۆ، ڕاگوێستن‌نامە
"""),
