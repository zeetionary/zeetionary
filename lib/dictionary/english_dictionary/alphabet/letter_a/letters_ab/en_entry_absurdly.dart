...
class EnglishEntryabsurdly extends StatefulWidget {
  const EnglishEntryabsurdly({super.key});

  @override
  State<EnglishEntryabsurdly> createState() => _EnglishEntryabsurdlyState();
}

class _EnglishEntryabsurdlyState extends State<EnglishEntryabsurdly> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """absurdly""",
                      // alsoEnglishWord: "also: absurdly",
                      britshText: """IpaUK: /əbˈsɜːdli/""",
                      americanText: """IpaUS: /əbˈsɜːrdli/""",
