...
class EnglishEntrykph extends StatefulWidget {
  const EnglishEntrykph({super.key});

  @override
  State<EnglishEntrykph> createState() => _EnglishEntrykphState();
}

class _EnglishEntrykphState extends State<EnglishEntrykph> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrykph kph
WORD_WEB kph kph kph
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "kph";
...
کوردی: 
"""),
// With short examples define "kph", please follow LX instructions
