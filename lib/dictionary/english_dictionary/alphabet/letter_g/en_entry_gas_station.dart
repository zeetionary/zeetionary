...
class EnglishEntrygasstation extends StatefulWidget {
  const EnglishEntrygasstation({super.key});

  @override
  State<EnglishEntrygasstation> createState() => _EnglishEntrygasstationState();
}

class _EnglishEntrygasstationState extends State<EnglishEntrygasstation> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gas station";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gas station""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Her father was partner in a gas station chain.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gas station""",
                      // alsoEnglishWord: "also: gas station",
                      britshText: """IpaUK: /ˈɡæs steɪʃn/""",
                      americanText: """IpaUS: /ˈɡæs steɪʃn/""",
...
// With short examples define "gas station", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بەنزینخانە؛ شوێنێک لە تەنیشتی شەقام کە دەویستیت بۆ بەنزین، ڕۆن، گاز، هتد"""),
                    SentencesRow(
                      englishText:
                          """Her father was partner in a gas station chain.""",
                      kurdishText:
                          """باوکی هاوبەش بوو لە زنجیرە بەنزینخانەیەک.""",
...
const double _startSecondsone = 000000000000000000000000000581;
const String _videoIdtwo = 'https://youtu.be/wknSc6HRUMI?t=';
const double _startSecondstwo = 000000000000000000000000000295;
...
const String _videoIdfive = 'https://youtu.be/4Q1FzhMY8FQ?t=';
const double _startSecondsfive = 000000000000000000000000000801;
