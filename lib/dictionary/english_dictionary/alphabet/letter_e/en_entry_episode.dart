...
class EnglishEntryepisode extends StatefulWidget {
  const EnglishEntryepisode({super.key});

  @override
  State<EnglishEntryepisode> createState() => _EnglishEntryepisodeState();
}

class _EnglishEntryepisodeState extends State<EnglishEntryepisode> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""episode""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """episode""",
                      // alsoEnglishWord: "also: episode",
                      britshText: """IpaUK: /ˈepɪsəʊd/""",
                      americanText: """IpaUS: /ˈepɪsəʊd/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The next episode has not yet been filmed.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I watched a few episodes of seasons one and two.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I only saw the first episode in the series""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'd like to try and forget the whole episode.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It was an episode in his life that he was not proud of.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I still remember that episode from my childhood.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""All the patients had episodes of unexplained fever.""");
  }
...
کوردی: ڕووداو، بوویەر، قەومین، دیمەن،	بەش، پشک
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) یەک بەشی چیرۆکێک کە لەسەر تەلەفیزیۆن یان ڕادیۆ بە ژمارەیەک بەش پێشکەش دەکرێت"""),
          SentencesRow(
            englishText: """The next episode has not yet been filmed.""",
            kurdishText: """ئەڵقەی دواتر هێشتا تۆمار نەکراوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I watched a few episodes of seasons one and two.""",
            kurdishText: """سەیری ژمارەیەک ئەڵقەی وەرزی یەک و دووم کرد.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I only saw the first episode in the series""",
            kurdishText: """تەنها یەکەم قەڵقەی زنجیرەکەم بینی.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) بۆنەیەک، دۆخێک، یان ماوەیەک لە ژیانی کەسێک، ڕۆمانێک، هتد کە گرنگە یان سەرنجڕاکێشە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """I'd like to try and forget the whole episode.""",
            kurdishText: """حەز دەکەم هەوڵ بدەم و تەواوی ماوەکە لەبیر بکەم.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ئەوە بەشێک بوو لە ژیانی کە پێی سەرفراز نەبوو.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I still remember that episode from my childhood.""",
            kurdishText: """هێشتا ئەو قۆناغەی منداڵیمم بیردێت.""",
          ...
          const DefinitionKurdish(
              text:
                  """٣. (ناو) ماوەیەک کە کەسێک تووشی نەخۆشییەک یان قۆناغێکی نەخۆشییەکی درێژخایەن دەبێت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """All the patients had episodes of unexplained fever.""",
            kurdishText:
                """تەواوی نەخۆشەکان ماوەی تووشبوونی نەزانراویان بە تا هەبوو.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ژنی پێشووتری تووشی نەخۆشی خەمۆکی دەبوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: episode (Derived forms: episodes)
...
3. A part of a broadcast serial (= installment [N. Amer], instalment)
 
4. Film consisting of a succession of related shots that develop a given subject in a movie (= sequence)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/3C0BdIn6Hdo?t=';
const double _startSecondsend = 000000000000000000000000000000; // 33;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/MnExgQ81fhU?t=';
const double _startSecondsone = 00000000000000000000000000000; // 281;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/MGO4_8YRKro?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 671;
const String _videoIdthree = 'VIDEOhttps://youtu.be/r5cqa9V0mUo?t=';
const double _startSecondsthree = 000000000000000000000000000; // 261;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/DA2ukcfd9Vo?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 128;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/vw2SaHkGfss?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 109;
