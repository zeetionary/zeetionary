...
class EnglishEntryheadroom extends StatefulWidget {
  const EnglishEntryheadroom({super.key});

  @override
  State<EnglishEntryheadroom> createState() => _EnglishEntryheadroomState();
}

class _EnglishEntryheadroomState extends State<EnglishEntryheadroom> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: headroom (Derived forms: headrooms)
1. Vertical space available to allow easy passage under something (- headway, clearance)
 
2. The capacity of a system to reproduce loud sounds without distortion (- dynamic headroom)
""",
  );

  final String keyword = "headroom";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""headroom""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""There's a lot of headroom for such a small car.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """headroom""",
                      // alsoEnglishWord: "also: headroom",
                      britshText: """IpaUK: /ˈhedruːm/, /ˈhedrʊm/""",
                      americanText: """IpaUS: /ˈhedruːm/, /ˈhedrʊm/""",
...
کوردی: 
"""),
// With short examples define "headroom", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بۆشایی نێوان بەشی سەرەوەی پێڕۆیەک و شتێک کە پێڕۆکە بە ژێریدا تێدەپەڕێت"""),
                    SentencesRow(
                      englishText:
                          """The sign on the bridge said ‘Maximum Headroom 2.5 metres’.""",
                      kurdishText:
                          """ئاماژەی سەر پردەکە دەیگوت 'ئەوپەڕی بۆشایی ٢,٥ مەتر'.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) بۆشایی نێوان سەرت و بەشی سەرەوەی ئۆتۆمبێل کە لە ناویدایت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """There's a lot of headroom for such a small car.""",
                      kurdishText:
                          """مەودای سەری زۆر هەیە بۆ ئۆتۆمبیلێکی وەها بچووک.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/DcX_lXP977g?t=';
const double _startSecondsend = 000000000000000000000000000473;
const String _videoIdone = 'https://youtu.be/SjeS6gtPq8E?t=';
const double _startSecondsone = 000000000000000000000000000108;
const String _videoIdtwo = 'https://youtu.be/ZQ4E0JJcxz0?t=';
const double _startSecondstwo = 000000000000000000000000000286;
const String _videoIdthree = 'https://youtu.be/cBpGq-vDr2Y?t=';
const double _startSecondsthree = 000000000000000000000000000554;
const String _videoIdfour = 'https://youtu.be/d7y9z7pjCRM?t=';
const double _startSecondsfour = 000000000000000000000000000305;
const String _videoIdfive = 'https://youtu.be/ZMLa7pdd1T4?t=';
