...
// replace these: replace EnglishEntryagegroup - replace speakAgegroup - replace age group - /ˈeɪdʒ ɡruːp/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryagegroup extends StatelessWidget {
  EnglishEntryagegroup({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAgegroup(String languageCode) async {
    // DOPSUM: CHANGE speakAgegroup
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("age group"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAgegrou199852(String languageCode) async {
    // DOPSUM: CHANGE speakAgegroup
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "People in the younger age groups tended to vote less."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "age group", // DOPSUM: CHANGE WORD ENTRY - Find /ˈeɪdʒ ɡruːp/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈeɪdʒ ɡruːp/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAgegroup(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˈeɪdʒ ɡruːp/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'HE_nD5sGVYY';
