...
class EnglishEntryabusive extends StatefulWidget {
  const EnglishEntryabusive({super.key});

  @override
  State<EnglishEntryabusive> createState() => _EnglishEntryabusiveState();
}

class _EnglishEntryabusiveState extends State<EnglishEntryabusive> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""abusive""");
  }
  ...
  Future<void> speakab582(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("He became abusive when he was drunk.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """abusive""",
                      // alsoEnglishWord: "also: abusive",
                      britshText: """IpaUK: /əˈbjuːsɪv/""",
                      americanText: """IpaUS: /əˈbjuːsɪv/""",
