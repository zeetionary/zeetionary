...
class EnglishEntryforbearance extends StatefulWidget {
  const EnglishEntryforbearance({super.key});

  @override
  State<EnglishEntryforbearance> createState() =>
      _EnglishEntryforbearanceState();
}

class _EnglishEntryforbearanceState extends State<EnglishEntryforbearance> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forbearance (Derived forms: forbearances)
1. Good-natured tolerance of delay or incompetence (= patience, longanimity)
...
""",
  ...
  final String keyword = "forbearance";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forbearance""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forbearance""",
                      // alsoEnglishWord: "also: forbearance",
                      britshText: """IpaUK: /fɔːˈbeərəns/""",
                      americanText: """IpaUS: /fɔːrˈberəns/""",
...
کوردی: پشوودرێژی، سنگ‌فراوانی، لەسەرەخۆیی، سەبر، خودداری، خۆڕاگرتن، دەربردن، تاقەت‌هێنان، هەڵکردن، بەرگەگرتن، خۆگرتن، خۆگیری،	چاوپۆشی، لێبوردەیی
"""),
// With short examples define "forbearance", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) میهرەبانی و پشوودرێژی بەرامبەر کەسانی دیکە"""),
                    SentencesRow(
                      englishText:
                          """We are very grateful for the cooperation and forbearance of all the staff.""",
                      kurdishText:
                          """ئێمە زۆر سوپاسگوزارین بۆ هاوکاری و ئارامگرتنی هەموو کارمەندان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He thanked his employees for the forbearance (that) they had shown during the company's difficult times.""",
                      kurdishText:
                          """سوپاسی کارمەندەکانی کرد بۆ ئەو ئارامگرتنەی کە لە ماوەی کاتە سەختەکانی کۆمپانیاکەدا پیشانیان دابوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/t0CyBv18A5k?t=';
const double _startSecondsend = 000000000000000000000000000657;
const String _videoIdone = 'https://youtu.be/lXoHd8hmWaQ?t=';
const double _startSecondsone = 00000000000000000000000000097;
const String _videoIdtwo = 'https://youtu.be/h56S5BA7AyI?t=';
const double _startSecondstwo = 00000000000000000000000000081;
const String _videoIdthree = 'https://youtu.be/-FZO1P1R-eY?t=';
const double _startSecondsthree = 0000000000000000000000000002367;
const String _videoIdfour = 'https://youtu.be/4GehjvyAsZs?t=';
const double _startSecondsfour = 0000000000000000000000000002658;
const String _videoIdfive = 'https://youtu.be/n59SdRCyLG4?t=';
const double _startSecondsfive = 0000000000000000000000000001504;
