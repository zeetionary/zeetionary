...
class EnglishEntryaloof extends StatelessWidget {
  ...
  Future<void> speakaloof457(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("He was a cold man, aloof and distant.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈluːf/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈluːf/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 're_VkwJW3Hk';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'oU0uNGUxdyo';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'pvQP-85ADRE';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'fRcPn3mJSyY';
