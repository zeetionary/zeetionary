...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 1346;
    const String videoIdtwo = 'VMmdeMzXKMI';
    const double startSecondstwo = 49;
    const String videoIdthree = 'tyixMpuGEL8';
    const double startSecondsthree = 1156;
    const String videoIdfour = 'eFReTj2KsM0';
    const double startSecondsfour = 1227;
    const String videoIdfive = 'xHvVhhFvLtY';
