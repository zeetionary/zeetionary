...
class EnglishEntryinvestigative extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""investigative""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1574;
    const String videoIdone = 'Y5F_ha7d-PI';
    const double startSecondsone = 495;
    const String videoIdtwo = '2Hq4CtLfnZs';
    const double startSecondstwo = 1018;
    const String videoIdthree = 'LQpLMvC7Et0';
    const double startSecondsthree = 124;
    const String videoIdfour = '4_jkeWgtZ18';
    const double startSecondsfour = 219;
    const String videoIdfive = '8mCcM-PUmLM';
