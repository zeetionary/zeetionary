...
class EnglishEntryfiery extends StatefulWidget {
  const EnglishEntryfiery({super.key});

  @override
  State<EnglishEntryfiery> createState() => _EnglishEntryfieryState();
}

class _EnglishEntryfieryState extends State<EnglishEntryfiery> {
  @override
  void initState() {
    super.initState();
...
2. Like or suggestive of fire (= igneous)
"a fiery desert wind";
 
3. Passionate or quick-tempered (= flaming)
"a fiery temper";
""",
  );

  final String keyword = "fiery";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She has a fiery temper.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He delivered the sermon with fiery passion.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The fiery liquor burnt its way down her throat.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiery""",
                      // alsoEnglishWord: "also: fiery",
                      britshText: """IpaUK: /ˈfaɪəri/""",
                      americanText: """IpaUS: /ˈfaɪəri/""",
...
کوردی: گڕگرتوو، داگیرساو، کڵپەکردوو، ئاورین، ئاگرین، ئاگرئاسا، شێوەئاور،	گڕکێش، زووئاورگرتوو، زوو(ئاگر)گرتوو،	سوور، سوورباو، زووتووڕە، جینگزی، فیشەکی، سەرتوند، سوورەوەبوو،	تیژ، دۆخ، توند (چێشت)،	لەشەوق، بەگوڕ، لەگوڕ، لەجۆش، بەتین، بەکەیف، شاد، سەرخۆش
"""),
// With short examples define "fiery", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The sun was now sinking, a fiery ball of light in the west.""",
                      kurdishText:
                          """خۆر لە ئێستادا ئاوا دەبوو، تۆپێکی ئاگرین لە ڕۆژئاواوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """وتارەکەی بە حەزی ئاگرینەوە پێکەش کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خواردنەوە توونەکە بە قوڕگیدا چووە خوارەوە.""",
...
const String _videoIdone = 'https://youtu.be/lV0pznr8GD4?t=';
const double _startSecondsone = 000000000000000000000000000118;
const String _videoIdtwo = 'https://youtu.be/UvjSXBqQe4A?t=';
...
const String _videoIdfive = 'https://youtu.be/fU-8Rg4CgeI?t=';
