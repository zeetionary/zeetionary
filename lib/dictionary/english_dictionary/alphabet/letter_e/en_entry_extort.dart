...
class EnglishEntryextort extends StatefulWidget {
  const EnglishEntryextort({super.key});

  @override
  State<EnglishEntryextort> createState() => _EnglishEntryextortState();
}

class _EnglishEntryextortState extends State<EnglishEntryextort> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extort""",
                      // alsoEnglishWord: "also: extort",
                      britshText: """IpaUK: /ɪkˈstɔːt/""",
                      americanText: """IpaUS: /ɪkˈstɔːrt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The gang extorted money from over 30 local businesses.""");
  }
...
"""),
          ...
          SentencesRow(
            ...
            kurdishText:
                """گرووپە تاوانکارەکە پارەیان لە زیاتر لە ٣٠ بازرگانیی ناوخۆیی سەند.""",
...
3. Get or cause to become in a difficult or laborious manner (= wring from)
""",
  );
...
const String _videoIdend = 'https://youtu.be/3yi0FNwOYiI?t=';
const double _startSecondsend = 00000000000000000000000000093;
const String _videoIdone = 'https://youtu.be/Cqbleas1mmo?t=';
const double _startSecondsone = 0000000000000000000000000001089;
...
const double _startSecondsthree = 000000000000000000000000000580;
const String _videoIdfour = 'https://youtu.be/N-FqJzC3tA8?t=';
const double _startSecondsfour = 000000000000000000000000000577;
const String _videoIdfive = 'https://youtu.be/Iv7PW4ZEFD4?t=';
