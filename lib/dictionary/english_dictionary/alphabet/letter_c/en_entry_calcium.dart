...
class EnglishEntrycalcium extends StatelessWidget {
// blank divider
  EnglishEntrycalcium({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcalcium(String languageCode) async {
    // DOPSUM: CHANGE speakcalcium
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "calcium"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈkælsiəm/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcalcium("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈkælsiəm/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcalcium("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  static String myVideoId = "ZMaW6TamNAc";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  static String myVideoId = "OD7T5GF6b28";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  static String myVideoId = "J-oDjYNmKgo";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  static String myVideoId = "nf3NSK-X5tY";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  static String myVideoId = "kqe9tEcZkno";
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  static String myVideoId = "5inBtFdZa7A";
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  static String myVideoId = "jfElZfrmlRs";
