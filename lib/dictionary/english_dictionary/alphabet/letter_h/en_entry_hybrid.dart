...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/wE1azf6azWw?t=';
    ...
    const String videoIdtwo = 'https://youtu.be/YZoZr_m9WLU?t=';
    const double startSecondstwo = 00000000000000000000000000067;
    const String videoIdthree = 'https://youtu.be/LvShfo-1mE0?t=';
    const double startSecondsthree = 000000000000000000000000000148;
    const String videoIdfour = 'https://youtu.be/HAnw168huqA?t=';
    const double startSecondsfour = 000000000000000000000000000207;
    const String videoIdfive = 'https://youtu.be/qQ01eLt_bxo?t=';
    const double startSecondsfive = 000000000000000000000000000659;
