...
class EnglishEntryenemy extends StatefulWidget {
  const EnglishEntryenemy({super.key});

  @override
  State<EnglishEntryenemy> createState() => _EnglishEntryenemyState();
}

class _EnglishEntryenemyState extends State<EnglishEntryenemy> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enemy""",
                      // alsoEnglishWord: "also: enemy",
                      britshText: """IpaUK: /ˈenəmi/""",
                      americanText: """IpaUS: /ˈenəmi/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She didn't have an enemy in the world.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He has a lot of enemies in the company.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They united in the face of a common enemy.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The enemy was/were forced to retreat.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The men came under enemy fire.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They were dropped by parachute behind enemy lines.""");
  }
...
کوردی: دوژمن، ناحەز، گاڤبەر، نەیار،	دوژمنی چەک‌دار، هێزی سەربازی ڕکەبەر یان دژ،	کەشتی، فڕۆکە و هتد هی دوژمن،	نەتەوە یان وڵاتێکی دوژمن،	هاووڵاتی‌یێکی وڵاتێکی دوژمن،	شتێکی بەزیان یان خراپ
"""),
          const DefinitionKurdish(text: """١. (ناو) دوژمن"""),
          SentencesRow(
            englishText: """She didn't have an enemy in the world.""",
            kurdishText: """یەک دوژمنی لە جیهاندا نەبوو.""",
          ...
          Column(
            children: [
              MyExpansionTile(
                children: [
                  SentencesRow(
                    englishText: """He has a lot of enemies in the company.""",
                    kurdishText: """زۆر نەیاری لە کۆمپانیاکە هەیە.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText: """یەکیان گرت دژ بە دوژمنێکی هاوبەش.""",
                  ...
                  SentencesRow(
                    englishText:
                        """It is rare to find a prominent politician with few political enemies.""",
                    kurdishText:
                        """دەگمەنە سیاسییەکی ناسراو ببینیت بە ژمارەیەکی کەم لە نەیاری سیاسی.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The men came under enemy fire.""",
            kurdishText: """هێزەکان کەوتنە ژێر هێرشی دوژمن.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """بە پەڕەشووت لە پشتەوەی هێڵەکانی دوژمن بەردرانەوە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٣. (ناو) هەر شتێک کە زیان بە شتێک دەگەیەنێت یان ڕێگا لە سەرکەوتنی دەگرێت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Poverty and ignorance are the enemies of progress.""",
            kurdishText: """هەژاری و نەزانی دوژمنی پێشکەوتنن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: enemy (Derived forms: enemies)
1. An opposing military force
"the enemy attacked at dawn"
 
2. (military) an armed adversary (especially a member of an opposing military force) (= foe, foeman [archaic], opposition)
"a soldier must be prepared to kill his enemies";
 
3. Any hostile group of people
"he viewed lawyers as the real enemy"
 
4. A personal enemy (= foe)
...
const double _startSecondsend = 1247;
const String _videoIdone = 'https://youtu.be/zqllxbPWKNI?t=';
const double _startSecondsone = 1687;
const String _videoIdtwo = 'https://youtu.be/rRymSi8SmqA?t=';
const double _startSecondstwo = 431;
const String _videoIdthree = 'https://youtu.be/-L7o6HtX8Vg?t=';
...
const String _videoIdfive = 'https://youtu.be/Fa13JKGG0ds?t=';
const double _startSecondsfive = 113;
const String _videoIdsix = 'https://youtu.be/gwZuUxeBYV8?t=';
const double _startSecondssix = 840;
