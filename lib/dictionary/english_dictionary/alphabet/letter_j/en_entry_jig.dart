...
class EnglishEntryjig extends StatefulWidget {
  const EnglishEntryjig({super.key});

  @override
  State<EnglishEntryjig> createState() => _EnglishEntryjigState();
}

class _EnglishEntryjigState extends State<EnglishEntryjig> {
  @override
  void initState() {
    super.initState();
