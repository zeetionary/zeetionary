...
class EnglishEntrygroundsheet extends StatefulWidget {
  const EnglishEntrygroundsheet({super.key});

  @override
  State<EnglishEntrygroundsheet> createState() =>
      _EnglishEntrygroundsheetState();
}

class _EnglishEntrygroundsheetState extends State<EnglishEntrygroundsheet> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: groundsheet (Derived forms: groundsheets)
1. A waterproofed piece of cloth spread on the ground (as under a tent) to protect from moisture (- ground cloth [N. Amer])
""",
  );

  final String keyword = "groundsheet";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""groundsheet""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Each individual not provided with a bed received a groundsheet.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """groundsheet""",
                      // alsoEnglishWord: "also: groundsheet",
                      britshText: """IpaUK: /ˈɡraʊndʃiːt/""",
                      americanText: """IpaUS: /ˈɡraʊndʃiːt/""",
...
// With short examples define "groundsheet", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Each individual not provided with a bed received a groundsheet.""",
                      kurdishText:
                          """هەر کەسێک کە جێخەوێکی پێنەدرا ڕایەخێکی وەرگرت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/t1BHeMz6_2E?t=';
const double _startSecondsend = 000000000000000000000000000523;
const String _videoIdone = 'https://youtu.be/zVpciPkBSgM?t=';
const double _startSecondsone = 00000000000000000000000000072;
const String _videoIdtwo = 'https://youtu.be/ak79mOHpkoQ?t=';
const double _startSecondstwo = 000000000000000000000000000347;
const String _videoIdthree = 'https://youtu.be/qQSphNzchx8?t=';
const double _startSecondsthree = 000000000000000000000000000295;
const String _videoIdfour = 'https://youtu.be/6NBpb0oLrrs?t=';
const double _startSecondsfour = 000000000000000000000000000243;
const String _videoIdfive = 'https://youtu.be/FjnoLonGejY?t=';
