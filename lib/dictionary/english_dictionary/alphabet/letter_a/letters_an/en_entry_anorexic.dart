                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "anorexic"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌænəˈreksɪk/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌænəˈreksɪk/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '6yo61uGNI9c';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '9-NfU3sFHXg';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'BivQrVvWNaw';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'K1FG0Wjf_Cc';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'jDrkdxpaGMs';
  final double _startSeconds = 1;
