...
// replace these: replace EnglishEntryachillesheel - replace speakAchillesheel - replace Achilles' heel - /əˌkɪliːz ˈhiːl/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryachillesheel extends StatelessWidget {
  EnglishEntryachillesheel({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˌkɪliːz ˈhiːl/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'NU4MgeOb-cc';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'lkM8nxcJanM';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'ccHhj_E245s';
