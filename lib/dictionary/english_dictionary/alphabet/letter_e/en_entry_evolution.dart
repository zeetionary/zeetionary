...
کوردی: گەشە(سەندن)، پەرەسەندنی بەرەبەرەیی، گووران،	گۆڕان‌کاری، گۆڕان، گۆڕانی شێوە، ھەڵدان، ڕسکان، پێشڤەچوون، ، پێشوەچوون، پێشکەوتن،	(بیرکاری) دەرھێنانی ڕەگ، ڕەگ‌دەرکێشی، ڕەگ‌دۆزی،	(سەما یان مانۆڤر) بادان، سووڕان، سوور، خول، کار، جووڵان، کردار
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) گەشەی ھێواشی مرۆڤ، ڕووەک، ئاژەڵ، ھتد لە ماوەی مێژووی زەویدا، کە خۆدەگونجێنن لەگەڵ ژینگەدا"""),
          SentencesRow(
            englishText:
                """Finally it was legal to teach evolution everywhere in America.""",
            kurdishText:
          ...
          SentencesRow(
            ...
            kurdishText:
                """پەرەسەندن پێویستیی بە شێوەی ناوەند ھەیە بۆ چەشنەکان.""",
            kurdishNote:
                "واتا بۆ ئەوەی پەرەسەندن ڕووبدات، دەبێت ژمارەیەک قۆناغی ناوەندی ھەبن کە وابکەن گۆڕانکارییەکان ھێواش لە چەشنێکەوە بۆ چەشنێکی دیکە بە تێپەڕبوونی کات، بۆ نموونە لە نێوان ئەو ئاژەڵەی باوانی مرۆڤ بووە و خودی مرۆڤ جۆری دیکە ھەیە کە وەک چەشنی ھاوبەش کار دەکەن، واتا لە ھەندێک لایەنەوە لە مرۆڤ دەکەن و لە ھەندێک لایەنەوە لەو ئاژەڵەی باوانی مرۆڤ بووە.",
          ...
          SentencesRow(
            englishText:
                """This product was an extremely significant step in the evolution of computer games.""",
            kurdishText:
                """ئەم بەرھەمە تەواو گرنگ بوو لە پەرەسەندنی یاریی کۆمپیوتەری.""",
...
const double _startSecondsend = 38;
const String _videoIdone = 'pFmtmO2cnlg';
const double _startSecondsone = 388;
const String _videoIdtwo = 'DxL2HoqLbyA';
const double _startSecondstwo = 10;
const String _videoIdthree = 'mN41M732I_I';
const double _startSecondsthree = 64;
const String _videoIdfour = 'DrgR_tSVdLU';
const double _startSecondsfour = 0;
const String _videoIdfive = 'xEJrlQYkuVo';
const double _startSecondsfive = 46;
