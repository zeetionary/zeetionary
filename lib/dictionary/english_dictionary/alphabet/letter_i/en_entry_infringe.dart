...
class EnglishEntryinfringe extends StatefulWidget {
  const EnglishEntryinfringe({super.key});

  @override
  State<EnglishEntryinfringe> createState() => _EnglishEntryinfringeState();
}

class _EnglishEntryinfringeState extends State<EnglishEntryinfringe> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: infringe (Derived forms: infringing, infringes, infringed)
1. Go against, as of rules and laws (- conflict, run afoul, contravene)
 
2. Advance beyond the usual limit (- encroach, impinge)
""",
  );

  final String keyword = "infringe";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infringe""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The material can be copied without infringing copyright.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/4IaOeVgZ-wc?t=';
    const double startSecondsend = 0000000000000000000000000002463;
    const String videoIdone = 'https://youtu.be/E37swnRU2fs?t=';
    const double startSecondsone = 000000000000000000000000000559;
    const String videoIdtwo = 'https://youtu.be/mlKAOjChW28?t=';
    const double startSecondstwo = 000000000000000000000000000693;
    const String videoIdthree = 'https://youtu.be/oVW0-efpR-A?t=';
    const double startSecondsthree = 000000000000000000000000000219;
    const String videoIdfour = 'https://youtu.be/yat1PBrsbQo?t=';
    const double startSecondsfour = 000000000000000000000000000575;
    const String videoIdfive = 'https://youtu.be/z9YN83kUAHk?t=';
    const double startSecondsfive = 0000000000000000000000000001472;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """infringe""",
                      // alsoEnglishWord: "also: infringe",
                      britshText: """IpaUK: /ɪnˈfrɪndʒ/""",
                      americanText: """IpaUS: /ɪnˈfrɪndʒ/""",
...
کوردی: 
"""),
// With short examples define "infringe", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) شکاندنی یاسایەک"""),
                    SentencesRow(
                      englishText:
                          """The material can be copied without infringing copyright.""",
                      kurdishText:
                          """بابەتەکە دەکرێت لەبەر بگیرێتەوە بەبێ پێشێلی کۆپیڕایت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Two of the projects are deemed to infringe EU legislation.""",
                      kurdishText:
                          """دوو لە پڕۆژەکان وا دادەنرێن کە پێشێلی ڕێسای یەکێتیی ئەورووپا بکات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) سنووردارکردنی مافی یاسایی یان ئازادیی کەسێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She refused to answer questions that infringed on her private affairs.""",
                      kurdishText:
                          """ڕەتیکردەوە وەڵامی ئەو پرسیارانە بداتەوە کە پێشێلی بابەتە کەسییەکانییان دەکرد.""",
