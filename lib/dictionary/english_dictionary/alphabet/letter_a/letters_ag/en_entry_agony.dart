...
// replace these: replace EnglishEntryagony - replace speakAgony - replace agony - /ˈæɡəni/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryagony extends StatelessWidget {
  EnglishEntryagony({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈæɡəni/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'DP7SGcPto_k';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'IGb_6Vf9mZE';
