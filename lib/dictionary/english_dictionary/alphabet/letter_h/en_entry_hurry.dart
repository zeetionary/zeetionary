...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 0000000000000000000000000003414;
    const String videoIdtwo = 'https://youtu.be/sV6uuMAnJUE?t=';
    const double startSecondstwo = 0000000000000000000000000001120;
    const String videoIdthree = 'https://youtu.be/4J0xFUyz1nw?t=';
    const double startSecondsthree = 000000000000000000000000000563;
    const String videoIdfour = 'https://youtu.be/E47mx4rsVCI?t=';
    const double startSecondsfour = 00000000000000000000000000017;
    const String videoIdfive = 'https://youtu.be/r-Or05EFLUM?t=';
