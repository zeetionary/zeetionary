...
class EnglishEntryhandout extends StatefulWidget {
  const EnglishEntryhandout({super.key});

  @override
  State<EnglishEntryhandout> createState() => _EnglishEntryhandoutState();
}

class _EnglishEntryhandoutState extends State<EnglishEntryhandout> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: handout (Derived forms: handouts)
1. An announcement distributed to members of the press in order to supplement or replace an oral presentation (- press release, release)
 
2. A gift or portion (money, food, clothing, etc.) handed out, esp. to a needy person
 
3. A worksheet, printout, leaflet, pamphlet etc. that is given out (usually by hand), e.g. for advertising or to accompany a lecture
""",
  );

  final String keyword = "handout";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""handout""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I don't want to be dependent on handouts.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""All those eligible will receive a cash handout.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The company is currently thriving thanks to a £70 000 government handout.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""More information can be found in the handout.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """handout""",
                      // alsoEnglishWord: "also: handout",
                      britshText: """IpaUK: /ˈhændaʊt/""",
                      americanText: """IpaUS: /ˈhændaʊt/""",
...
// With short examples define "handout", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) خواردن، پارە، یان جل کە دەدرێت بە کەسێک کە هەژارە"""),
                    SentencesRow(
                      englishText: """I don't want to be dependent on handouts.""",
                      kurdishText: """نامەوێت پشت بە کۆمەک ببەستم.""",
                    ...
                    SentencesRow(
                      englishText: """All those eligible will receive a cash handout.""",
                      kurdishText: """هەموو ئەو کەسانەی شایستەن کۆمەکی دارایی وەردەگرن.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) بڕە پارەیەک کە دەدرێت بە کۆمپانیا یان دامەزراوەیەک لەلایەن حکومەتەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The company is currently thriving thanks to a £70 000 government handout.""",
                      kurdishText: """کۆمپانیاکە لە ئێستادا دەبووژێتەوە بەهۆی کۆمەکێکی ٧٠٠٠٠ پاوەندی حکومەت.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) بەڵگەنامەیەک کە بێ‌بەرامبەر دەدرێت بە خەڵکی و تێیدا بانگەشە بۆ بۆنەیەک، باوەڕێکی سیاسی، هتد دەکرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """More information can be found in the handout.""",
                      kurdishText: """زانیاریی زیاتر لە بڵاونامەکەیە.""",
