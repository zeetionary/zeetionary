...
class EnglishEntryfirework extends StatefulWidget {
  const EnglishEntryfirework({super.key});

  @override
  State<EnglishEntryfirework> createState() => _EnglishEntryfireworkState();
}

class _EnglishEntryfireworkState extends State<EnglishEntryfirework> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: firework (Derived forms: fireworks)
1. (usually plural) a device with an explosive that burns at a low rate and with coloured flames; can be used to illuminate areas or send signals etc. (= pyrotechnic)
""",
  );

  final String keyword = "firework";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""firework""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The firework spluttered and went out.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They set off fireworks in their back garden.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """firework""",
                      // alsoEnglishWord: "also: firework",
                      britshText: """IpaUK: /ˈfaɪəwɜːk/""",
                      americanText: """IpaUS: /ˈfaɪərwɜːrk/""",
...
// With short examples define "firework", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The firework spluttered and went out.""",
                      kurdishText: """یارییە ئاگرینەکە تاقی و درەوشایەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """یاریی ئاگرینیان لە باخچەی پشتەوەیان هەڵدا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Thousands of people jammed into square to watch the fireworks.""",
                      kurdishText:
                          """هەزاران کەس لە گۆڕەپانەکە خڕبوونەوە بۆ سەیرکردنی یاریی ئاگرین.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/7nGz7xgGJzc?t=';
const double _startSecondsend = 000000000000000000000000000155;
const String _videoIdone = 'https://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondsone = 0000000000000000000000000002114;
const String _videoIdtwo = 'https://youtu.be/Mhlpk5ZrYLM?t=';
const double _startSecondstwo = 000000000000000000000000000423;
const String _videoIdthree = 'https://youtu.be/rJUpsiNcki4?t=';
...
const String _videoIdfive = 'https://youtu.be/YIXy2Kit4z4?t=';
