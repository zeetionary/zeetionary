...
class EnglishEntryemulate extends StatefulWidget {
  const EnglishEntryemulate({super.key});

  @override
  State<EnglishEntryemulate> createState() => _EnglishEntryemulateState();
}

class _EnglishEntryemulateState extends State<EnglishEntryemulate> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("emulate");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "emulate",
                      // alsoEnglishWord: "also: emulate",
                      britshText: "IpaUK: /ˈemjuleɪt/",
                      americanText: "IpaUS: /ˈemjuleɪt/",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("She hopes to emulate her sister's sporting achievements.");
  }
...
کوردی: لاسا کردنەوە، ڕکەبەری کردن
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) هەوڵدان بۆ کردنی شتێک وەک کەسێکی دیکە بەهۆی ئەوەی سەرسامی پێی"""),
          SentencesRow(
            englishText:
                """She hopes to emulate her sister's sporting achievements.""",
            kurdishText:
                """بە هیوایە بەدەستهێنانە وەرزشییەکانی خووشکەکەی دووبارە بکاتەوە.""",
          ...
          SentencesRow(
            englishText:
                """Officials are looking to emulate successful ideas from other cities.""",
            kurdishText:
                """بەرپرسان هەوڵ دەدەن بیرۆکە سەرکەوتووەکانی شارەکانی دیکە دووبارە بکەنەوە .""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: emulate (Derived forms: emulates, emulated, emulating)
1. Strive to equal or match, especially by imitating
"He is emulating the skating skills of his older sister"
 
2. (computing) imitate the function of (another system), as by modifying the hardware or the software
 
3. Compete with successfully; approach or reach equality with
"This artist's drawings cannot emulate his water colours"
""",
  );
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/3AiDa3ZD20Y?t=';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/_0RTH57v66I?t=';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/uOJQbqwsfLg?t=';
