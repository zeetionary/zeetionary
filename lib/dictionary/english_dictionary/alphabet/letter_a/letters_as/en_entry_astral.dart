...
// Define the word "astral" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryastral - replace speakAstral

// replace astral - /ˈæstrəl/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryastral extends StatelessWidget {
  // blank divider
  EnglishEntryastral({super.key});
  // blank divider
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "astral", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
      ...
      child: Column(
        ...
        children: [
          EnglishMeaningConst(
            text: """
- Adjective: astral 
1. Being or relating to or resembling or emanating from stars (= stellar [informal], most important)
"an astral body";
""",
          )
        ],
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "4Uoiqlm_C2Q";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "eSXZLGDdhcQ";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "Q6D706RXZdk";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "2HIP2IiPb8w";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "Jdq-Grx4muk";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "61souSkwDk4";

  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 1754, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
      autoPlay: true,
      enableCaption: true,
      loop: true,
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "t035xfmGVkQ";
