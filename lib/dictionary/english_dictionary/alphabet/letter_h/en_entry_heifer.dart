...
class EnglishEntryheifer extends StatefulWidget {
  const EnglishEntryheifer({super.key});

  @override
  State<EnglishEntryheifer> createState() => _EnglishEntryheiferState();
}

class _EnglishEntryheiferState extends State<EnglishEntryheifer> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heifer (Derived forms: heifers)
1. Young cow
""",
  );

  final String keyword = "heifer";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The farmer bought a new heifer for his dairy farm.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heifer""",
                      // alsoEnglishWord: "also: heifer",
                      britshText: """IpaUK: /ˈhefə(r)/""",
                      americanText: """IpaUS: /ˈhefər/""",
...
// کوردی: گوێرەکە، گۆلک، نێوون، نوێگن، داملەچەقان، دامنەچەقان
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مانگایەکی گەنجی مێینە کە هێشتا بێووی نەبووە یان تەنها یەک بێچووی هەبووە"""),
                    SentencesRow(
                      englishText:
                          """The farmer bought a new heifer for his dairy farm.""",
                      kurdishText:
                          """جووتیارەکە دامنەچەقانێکی هێنا بۆ کێڵگە شیرەمەنییەکەی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/oou7yliYf_Q?t=';
const double _startSecondsend = 000000000000000000000000000352;
const String _videoIdone = 'https://youtu.be/YW249cc4NhQ?t=';
const double _startSecondsone = 000000000000000000000000000147;
const String _videoIdtwo = 'https://youtu.be/3_hCLjUrK1E?t=';
const double _startSecondstwo = 000000000000000000000000000191;
const String _videoIdthree = 'https://youtu.be/z9OcG5A788Q?t=';
const double _startSecondsthree = 000000000000000000000000000192;
const String _videoIdfour = 'https://youtu.be/jo40xoJP1hQ?t=';
const double _startSecondsfour = 000000000000000000000000000203;
const String _videoIdfive = 'https://youtu.be/iAn_2CtLhQc?t=';
const double _startSecondsfive = 000000000000000000000000000484;
