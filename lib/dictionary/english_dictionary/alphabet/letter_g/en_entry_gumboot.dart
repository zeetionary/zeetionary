...
class EnglishEntrygumboot extends StatefulWidget {
  const EnglishEntrygumboot({super.key});

  @override
  State<EnglishEntrygumboot> createState() => _EnglishEntrygumbootState();
}

class _EnglishEntrygumbootState extends State<EnglishEntrygumboot> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gumboot (Derived forms: gumboots, gum boots)
1. A high boot made of rubber (- rubber boot, gum boot, welly [Brit, informal], wellington [Brit, informal], Wellington boot [Brit], wellie [Brit, informal])

""",
  );

  final String keyword = "gumboot";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gumboot""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The kids love their colorful gumboots.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gumboot""",
                      // alsoEnglishWord: "also: gumboot",
                      britshText: """IpaUK: /ˈɡʌmbuːt/""",
                      americanText: """IpaUS: /ˈɡʌmbuːt/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) جزمە؛ پێڵاوێک کە لە لاستیک درووستکراوە و زۆرجار تاوەکو ئەژنۆ بەرز دەبێتەوە بۆ ڕێگری لە تەڕبوون  """),
                    const AlsoEnglishckb(word: "ھەروەھا: wellington"),
                    SentencesRow(
                      englishText: """The kids love their colorful gumboots.""",
                      kurdishText:
                          """منداڵەکان حەزیان بە جزمە ڕەنگینەکانیان بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ZzdV_HM95RQ?t=';
const double _startSecondsend = 000000000000000000000000000521;
const String _videoIdone = 'https://youtu.be/8FMN7zHB5BA?t=';
const double _startSecondsone = 000000000000000000000000000952;
const String _videoIdtwo = 'https://youtu.be/gQ1YdszFH7Q?t=';
const double _startSecondstwo = 00000000000000000000000000090;
const String _videoIdthree = 'https://youtu.be/jGCuhl5wkkE?t=';
const double _startSecondsthree = 000000000000000000000000000897;
const String _videoIdfour = 'https://youtu.be/tnDzlBK6FiU?t=';
const double _startSecondsfour = 0000000000000000000000000001001;
const String _videoIdfive = 'https://youtu.be/nQec4_wjvcA?t=';
const double _startSecondsfive = 00000000000000000000000000053;
