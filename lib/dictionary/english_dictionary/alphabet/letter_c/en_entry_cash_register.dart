...
class EnglishEntrycashregister extends StatelessWidget {
  // blank divider
  EnglishEntrycashregister({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcashregister(String languageCode) async {
    // DOPSUM: CHANGE speakcashregister
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "cash register"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUK: /ˈkæʃ redʒɪstə(r)/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcashregister("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈkæʃ redʒɪstər/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcashregister("en-US"),
                            ),
                          ],
                        ),
                      ],
...
١. (ناو) دەزگایەک لە کە لە فرۆشگایەک، چێشتخانەیەک، هتد دادەنرێت و پارەی تێدەخرێت و نرخی ئەو شتانە پیشان دەدات کە فرۆشراون و تۆماریان دەکات"""),
                          Row(
                            children: [
                              const Expanded(
                                child: Column(
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: cash register (Derived forms: cash registers)
1. A cashbox with an adding machine to register transactions; used in shops to add up the bill (= register, till)
""",
  );
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/0BjOYbib2_4?t=',
    startSeconds: 153,
    autoPlay: true,
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/1gbRTkTkS8M?t=',
    startSeconds: 57,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/L0a8ZtGr7iA?t=',
    startSeconds: 6,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/6ingSiAKd9A?t=',
    startSeconds: 207,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/MzYMmVCNQHA?t=',
    startSeconds: 10,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/f76wmDQWZKo',
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/4ORZ7WfUrL8?t=',
    startSeconds: 112,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
