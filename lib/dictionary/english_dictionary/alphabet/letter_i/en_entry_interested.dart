...
class EnglishEntryinterested extends StatefulWidget {
  const EnglishEntryinterested({super.key});

  @override
  State<EnglishEntryinterested> createState() => _EnglishEntryinterestedState();
}

class _EnglishEntryinterestedState extends State<EnglishEntryinterested> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""interested""");
  }
