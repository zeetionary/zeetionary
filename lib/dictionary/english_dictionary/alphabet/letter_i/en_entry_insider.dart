...
class EnglishEntryinsider extends StatefulWidget {
  const EnglishEntryinsider({super.key});

  @override
  State<EnglishEntryinsider> createState() => _EnglishEntryinsiderState();
}

class _EnglishEntryinsiderState extends State<EnglishEntryinsider> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insider""");
  }
