...
class EnglishEntryaccuse extends StatefulWidget {
  const EnglishEntryaccuse({super.key});

  @override
  State<EnglishEntryaccuse> createState() => _EnglishEntryaccuseState();
}

class _EnglishEntryaccuseState extends State<EnglishEntryaccuse> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speaka14587(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("She accused him of lying.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accuse""",
                      // alsoEnglishWord: "also: accuse",
                      britshText: """IpaUK: /əˈkjuːz/""",
                      americanText: """IpaUS: /əˈkjuːz/""",
...
"""),
                          const DefinitionKurdish(
                              text:
                                  ...
                                  ""),
                          SentencesRow(
                            englishText: "She accused him of lying.",
                            kurdishText: "بە درۆکردن تۆمەتباری کرد.",
                            onPressedBritish: () => speaka14587("en-GB"),
                            onPressedAmerican: () => speaka14587("en-US"),
                          ),
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speaka45691("en-GB"),
                            onPressedAmerican: () => speaka45691("en-US"),
                          ),
                        ],
                      ),
                    ),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'vfv5hGqj_MI';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final double _startSeconds = 2256;
