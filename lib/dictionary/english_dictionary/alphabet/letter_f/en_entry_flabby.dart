...
class EnglishEntryflabby extends StatefulWidget {
  const EnglishEntryflabby({super.key});

  @override
  State<EnglishEntryflabby> createState() => _EnglishEntryflabbyState();
}

class _EnglishEntryflabbyState extends State<EnglishEntryflabby> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flabby (Derived forms: flabbier, flabbiest)
1. Out of condition; not strong or robust; incapable of exertion or endurance (= soft, flaccid)
"flabby around the middle";
""",
  );

  final String keyword = "flabby";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He’s got soft and flabby since he gave up running.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His essay was full of flabby arguments.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flabby""",
                      // alsoEnglishWord: "also: flabby",
                      britshText: """IpaUK: /ˈflæbi/""",
                      americanText: """IpaUS: /ˈflæbi/""",
...
// With short examples define "flabby", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لەوەتەی وازی لە ڕاکردنی هێناوە نەرم و شل‌وشۆڕ بووە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) لاواز و بێ‌هێز"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """His essay was full of flabby arguments.""",
                      kurdishText: """وتارەکەی پڕ لە مشتومڕی لاواز بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/dRLCZqEfJFA?t=';
const double _startSecondsend = 000000000000000000000000000147;
const String _videoIdone = 'https://youtu.be/UZk17HJGu8I?t=';
const double _startSecondsone = 000000000000000000000000000483;
const String _videoIdtwo = 'https://youtu.be/xU0TmQ56v0U?t=';
const double _startSecondstwo = 000000000000000000000000000953;
const String _videoIdthree = 'https://youtu.be/Jpd_CUX2o98?t=';
const double _startSecondsthree = 000000000000000000000000000595;
const String _videoIdfour = 'https://youtu.be/n9o3gdoHoeo?t=';
const double _startSecondsfour = 000000000000000000000000000104;
const String _videoIdfive = 'https://youtu.be/jhe4GjxrM_Q?t=';
