...
class EnglishEntryfolksong extends StatefulWidget {
  const EnglishEntryfolksong({super.key});

  @override
  State<EnglishEntryfolksong> createState() => _EnglishEntryfolksongState();
}

class _EnglishEntryfolksongState extends State<EnglishEntryfolksong> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: folk song (Derived forms: folk songs, folksongs)
...
""",
  ...
  final String keyword = "folk song";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""folk song""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""This type of rhyme has survived only in folk song.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """folk song""",
                      // alsoEnglishWord: "also: folk song",
                      britshText: """IpaUK: /ˈfəʊk sɒŋ/""",
                      americanText: """IpaUS: /ˈfəʊk sɔːŋ/""",
...
// With short examples define "folk song", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەم جۆرە دەروایە تەنها لە گۆرانیی نەریتیدا ماوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/LJNtfyq3TDE?t=';
const double _startSecondsend = 000000000000000000000000000483;
const String _videoIdone = 'https://youtu.be/8fBimVfIwGQ?t=';
const double _startSecondsone = 00000000000000000000000000049;
const String _videoIdtwo = 'https://youtu.be/TccwMWVtmj0?t=';
const double _startSecondstwo = 00000000000000000000000000037;
const String _videoIdthree = 'https://youtu.be/ht7wb-W7XTg?t=';
const double _startSecondsthree = 000000000000000000000000000520;
const String _videoIdfour = 'https://youtu.be/RV2ftqfYk_s?t=';
const double _startSecondsfour = 000000000000000000000000000627;
const String _videoIdfive = 'https://youtu.be/2oysDxhHEEk?t=';
const double _startSecondsfive = 0000000000000000000000000001010;
