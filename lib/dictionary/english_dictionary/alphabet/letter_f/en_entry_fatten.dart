...
class EnglishEntryfatten extends StatefulWidget {
  const EnglishEntryfatten({super.key});

  @override
  State<EnglishEntryfatten> createState() => _EnglishEntryfattenState();
}

class _EnglishEntryfattenState extends State<EnglishEntryfatten> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fatten""",
                      // alsoEnglishWord: "also: fatten",
                      britshText: """IpaUK: /ˈfætn/""",
                      americanText: """IpaUS: /ˈfætn/""",
...
کوردی: قەڵەو کردن، دابەستە کردن
"""),
          const DefinitionKurdish(text: """١. (کردار) قەڵەوکردنی کەسێک/شتێک"""),
          SentencesRow(
            englishText:
                """The piglets are taken from the sow to be fattened for market.""",
            kurdishText:
                """بەچکە بەرازەکان لە دایکە بەرازەکە دەبردڕین بۆ ئەوەی بۆ بازاڕ قەڵەو بکرێن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: fatten (Derived forms: fattened, fattens, fattening)
1. Make fat or plump (= fat [archaic], flesh out, fill out, plump, plump out, fatten out, fatten up)
"We will fatten out that poor starving child";
""",
  );
...
const String _videoIdend = 'https://youtu.be/mqxgP8WlxJQ?t=';
const double _startSecondsend = 0000000000000000000000000001270;
const String _videoIdone = 'https://youtu.be/-YhjDv1ipMY?t=';
const double _startSecondsone = 000000000000000000000000000442;
const String _videoIdtwo = 'https://youtu.be/HZq_HjKCRB4?t=';
const double _startSecondstwo = 000000000000000000000000000515;
const String _videoIdthree = 'https://youtu.be/FoqHB7BMduw?t=';
const double _startSecondsthree = 000000000000000000000000000647;
const String _videoIdfour = 'https://youtu.be/sbhB1PqpX28?t=';
const double _startSecondsfour = 00000000000000000000000000067;
const String _videoIdfive = 'https://youtu.be/ewAHYVzMobw?t=';
const double _startSecondsfive = 0000000000000000000000000001130;
