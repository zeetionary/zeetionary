...
// Define the word "atheist" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryatheist - replace speakAtheist

// replace atheist - /ˈeɪθiɪst/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryatheist extends StatelessWidget {
  // blank divider
  EnglishEntryatheist({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakatheist(String languageCode) async {
    // DOPSUM: CHANGE speakAtheist
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("atheist"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakatheist743(String languageCode) async {
    // DOPSUM: CHANGE speakAtheist
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "As an atheist, I do not accept this religious argument."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "atheist"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /ˈeɪθiɪst/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                            CustomIconButtonBritish(
                              onPressed: () => speakatheist("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /ˈeɪθiɪst/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find WORD_WEB
                            CustomIconButtonAmerican(
                              onPressed: () => speakatheist("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  ...
  final double _startSeconds = 1357;
...
class _YoutubeEmbeddedthreeState extends State<YoutubeEmbeddedthree> {
  late YoutubePlayerController _controller;
  final String _videoId = 'nllZrOoxpzc';
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  ...
  final double _startSeconds = 4255;
...
class _YoutubeEmbeddedsevenState extends State<YoutubeEmbeddedseven> {
  late YoutubePlayerController _controller;
  final String _videoId = 'VZV11sRa5mw';
...
class _YoutubeEmbeddedtenState extends State<YoutubeEmbeddedten> {
  late YoutubePlayerController _controller;
  final String _videoId = 'kJGxVeQw3SE';
...
class _YoutubeEmbeddedelevenState extends State<YoutubeEmbeddedeleven> {
  late YoutubePlayerController _controller;
  final String _videoId = 'TvBct2uWT1U';
...
class _YoutubeEmbeddedtwelveState extends State<YoutubeEmbeddedtwelve> {
  late YoutubePlayerController _controller;
  final String _videoId = '_zpp94Mh_hI';
