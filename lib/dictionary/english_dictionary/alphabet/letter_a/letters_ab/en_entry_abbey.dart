...
// replace these: EnglishEntryabbey - speakAbbey - /ˈæbi/ - abbey

enum TtsState { playing }

class EnglishEntryabbey extends StatelessWidget {
  EnglishEntryabbey({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'abbey', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈæbi/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˈæbi/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
١. کڵێسایەکی گەورە لەگەڵ بینای دیکە لە دەوریدا کە تێیدا ڕەبەنەکان تێیدا دەژین''',
...
class YoutubeEmbeddedOne extends StatelessWidget {
  static String myVideoId = 'CmH8uZ7YoOU';
...
class YoutubeEmbeddedTwo extends StatelessWidget {
  static String myVideoId = '67FXsWynln8';
...
class YoutubeEmbeddedThree extends StatelessWidget {
  static String myVideoId = 'P9-mBcAy02A';
