...
class EnglishEntryascendant extends StatelessWidget {
  ...
  Future<void> speakascendant(String languageCode) async {
    ...
    await flutterTts.speak("ascendant");
  }
  ...
  Future<void> speakascendant1217(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I’m a Capricorn but my ascendant is Leo.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "ascendant"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈsendənt/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakascendant("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈsendənt/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakascendant("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'U0J2gst0irg';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'JYurz771kLA';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'DcbafWJt53U';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'vy3IsfyS2Ng';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '7tSQNejnX1M';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'DFhjKA5ExA4';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'U0QqMQ2Makg';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'AqFBsJd5yYA';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = '5jozMjlsxmI';
