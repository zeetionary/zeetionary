...
class EnglishEntryhappen extends StatefulWidget {
  const EnglishEntryhappen({super.key});

  @override
  State<EnglishEntryhappen> createState() => _EnglishEntryhappenState();
}

class _EnglishEntryhappenState extends State<EnglishEntryhappen> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: happen (Derived forms: happens, happened, happening)
1. (of an event) come to pass (in time, so that it is real and actual at some time) (- hap [archaic], go on, pass off, occur, pass, fall out, come about, take place)
"What is happening?";
 
2. Occur or be the case in the course of events or by chance (- befall, bechance [archaic])
"It happens that today is my birthday";
 
3. Chance to be or do something, without intention or causation
"I happen to have just what you need!"
 
4. Come into being; become reality (- materialize, materialise [Brit])
"Her dream really happened";
 
5. Come upon, as if by accident; meet with (- find, chance, bump, encounter)
"I happened upon the most wonderful bakery not very far from here";
""",
  );

  final String keyword = "happen";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You'll never guess what's happened!""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Accidents like this happen all the time.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The most recent incident happened only a week ago.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Change doesn't happen overnight.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You have to make things happen.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Let's see what happens next week.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'll be there whatever happens.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""No matter what happens, he's going to pay for what he's done.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Is this really happening or is it a dream?""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This would never happen in real life.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She pressed the button but nothing happened.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What happens if nobody comes to the party?""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Just plug it in and see what happens.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She happened to be out when we called.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You don't happen to know his name, do you?""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This happens to be my favourite restaurant.""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The door happened to be unlocked.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """happen""",
                      // alsoEnglishWord: "also: happen",
                      britshText: """IpaUK: /ˈhæpən/""",
                      americanText: """IpaUS: /ˈhæpən/""",
...
// With short examples define "happen", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) ڕوودان، بە تایبەتی بەبێ پلان"""),
                    SentencesRow(
                    ...
                    children: [
                    SentencesRow(
                      englishText: """Accidents like this happen all the time.""",
                      kurdishText: """ڕووداوی وەها هەموو کات ڕوودەدەن.""",
                    ...
                    SentencesRow(
                      englishText: """The most recent incident happened only a week ago.""",
                      kurdishText: """تازەترین هەوڵ تەنها هەفتەیەک پێش ئێستا ڕوویدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Change doesn't happen overnight.""",
                      kurdishText: """گۆڕان لە شەوێکدا ڕوونادات.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """You have to make things happen.""",
                      kurdishText: """دەبێت وابکەیت شتەکان ڕووبدەن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Let's see what happens next week.""",
                      kurdishText: """با ببینین هەفتەی داهاتوو چی ڕوودەدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I'll be there whatever happens.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """No matter what happens, he's going to pay for what he's done.""",
                      kurdishText: """گرنگ نییە چی ڕوودەدات، باجی ئەوە دەدات کە کردوویەتی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Is this really happening or is it a dream?""",
                      kurdishText: """هەر بە ڕاستی ڕوودەدات یان خەوێکە؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """This would never happen in real life.""",
                      kurdishText: """ئەوە لە ژیانی ڕاستەقینەد ا هەرگیز ڕوونادات.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) ڕوودان لە ئەنجامی شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She pressed the button but nothing happened.""",
                      kurdishText: """پەنجەی نا بە دووگمەکەدا بەڵام هیچ ڕووینەدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """What happens if nobody comes to the party?""",
                      kurdishText: """چی ڕوودەدات ئەگەر کەس نەیەتە ئاهەنگەکە؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تەنها پلاکەکەی پێوە بکە و ببینە چی ڕوودەدات.""",
                      onPressedBritish: () => speaksentence13("en-GB"),
                      onPressedAmerican: () => speaksentence13("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) کردن یان بوون بە شتێک بە ڕێکەوت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She happened to be out when we called.""",
                      kurdishText: """وا ڕێکەوت لە دەرەوە بێت کە بانگمان کرد.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """You don't happen to know his name, do you?""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """This happens to be my favourite restaurant.""",
                      kurdishText: """ئەمە چێشتخانەی دڵخوازمە.""",
