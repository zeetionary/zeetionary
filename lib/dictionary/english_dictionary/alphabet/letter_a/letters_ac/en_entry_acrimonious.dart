...
class EnglishEntryacrimonious extends StatelessWidget {
  EnglishEntryacrimonious({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'acrimonious', // DOPSUM: CHANGE WORD ENTRY - Find /ˌækrɪˈməʊniəs/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌækrɪˈməʊniəs/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '_7M1YcwrKGo';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'suVD6h7WkcQ';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'adaKJcf9yLE';
