...
class EnglishEntryinvader extends StatefulWidget {
  const EnglishEntryinvader({super.key});

  @override
  State<EnglishEntryinvader> createState() => _EnglishEntryinvaderState();
}

class _EnglishEntryinvaderState extends State<EnglishEntryinvader> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""invader""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'wPQzenQMxKs';
    const double startSecondsend = 277;
    const String videoIdone = 'Fa13JKGG0ds';
    const double startSecondsone = 242;
    const String videoIdtwo = 'e-V_MDVgISo';
    const double startSecondstwo = 79;
    const String videoIdthree = 'Ex6Xw83rszo';
    const double startSecondsthree = 101;
    const String videoIdfour = 'BlacyJsokzo';
    const double startSecondsfour = 36;
    const String videoIdfive = 'zS4VSQNGr_A';
    const double startSecondsfive = 109;
