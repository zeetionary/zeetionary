...
class EnglishEntryhaberdashery extends StatefulWidget {
  const EnglishEntryhaberdashery({super.key});

  @override
  State<EnglishEntryhaberdashery> createState() =>
      _EnglishEntryhaberdasheryState();
}

class _EnglishEntryhaberdasheryState extends State<EnglishEntryhaberdashery> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: haberdashery (Derived forms: haberdasheries)
1. [N. Amer] A store where men's clothes are sold (- clothing store [N. Amer], haberdashery store [N. Amer], mens store [N. Amer], clothes shop [Brit])
 
2. The dry goods sold by a haberdasher (- men's furnishings [N. Amer], menswear)
 
3. [Brit] A shop that sells sewing and dressmaking materials
""",
  );

  final String keyword = "haberdashery";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""haberdashery""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The haberdashery section of the store had a wide range of buttons.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """haberdashery""",
                      // alsoEnglishWord: "also: haberdashery",
                      britshText: """IpaUK: /ˌhæbəˈdæʃəri/""",
                      americanText: """IpaUS: /ˈhæbərdæʃəri/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """The haberdashery section of the store had a wide range of buttons.""",
                      kurdishText:
                          """بەشی دروومانەفرۆشی فرۆشگاکە ژمارەیەکی زۆر لە دوگمەی هەبوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The haberdashery industry has evolved with fashion trends.""",
                      kurdishText:
                          """پیشەسازی جلی پیاوان لەگەڵ ترێندەکاندا بەرەوپێشچووە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/zpwRA9KQnWU?t=';
const double _startSecondsend = 000000000000000000000000000436;
const String _videoIdone = 'https://youtu.be/ygHpwa85GYQ?t=';
const double _startSecondsone = 0000000000000000000000000001214;
const String _videoIdtwo = 'https://youtu.be/UaxJvFF84PI?t=';
const double _startSecondstwo = 000000000000000000000000000381;
const String _videoIdthree = 'https://youtu.be/uLNIX_iki0A?t=';
const double _startSecondsthree = 0000000000000000000000000001362;
const String _videoIdfour = 'https://youtu.be/LGSxK1qw8Zw?t=';
const double _startSecondsfour = 000000000000000000000000000130;
const String _videoIdfive = 'https://youtu.be/EkEK3xj2BPU?t=';
const double _startSecondsfive = 0000000000000000000000000002204;
