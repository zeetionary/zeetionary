...
class EnglishEntryherbalist extends StatefulWidget {
  const EnglishEntryherbalist({super.key});

  @override
  State<EnglishEntryherbalist> createState() => _EnglishEntryherbalistState();
}

class _EnglishEntryherbalistState extends State<EnglishEntryherbalist> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: herbalist (Derived forms: herbalists)
1. A therapist who heals by the use of herbs (- herb doctor)
""",
  );

  final String keyword = "herbalist";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""herbalist""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The herbalist explained how to use herbs for digestive health.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """herbalist""",
                      // alsoEnglishWord: "also: herbalist",
                      britshText: """IpaUK: /ˈhɜːbəlɪst/""",
                      americanText: """IpaUS: /ˈɜːrbəlɪst/, /ˈhɜːrbəlɪst/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە گیای دەرمانی دەچێنێت، دەفرۆشێت، یان بەکاری دەهێنێت"""),
                    SentencesRow(
                      englishText:
                          """The herbalist explained how to use herbs for digestive health.""",
                      kurdishText:
                          """گیاناسەکە ڕوونی کردەوە چۆن گیا بەکاربهێنرێت بۆ تەندروستی هەرس.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/tp5cGuMD_u4?t=';
const double _startSecondsend = 000000000000000000000000000341;
const String _videoIdone = 'https://youtu.be/i2hT21D-JzU?t=';
const double _startSecondsone = 000000000000000000000000000233;
const String _videoIdtwo = 'https://youtu.be/ATi3GdospAo?t=';
const double _startSecondstwo = 1595;
const String _videoIdthree = 'https://youtu.be/aP0mGQUMnVc?t=';
const double _startSecondsthree = 000000000000000000000000000451;
const String _videoIdfour = 'https://youtu.be/qHYQsnyeXVE?t=';
const double _startSecondsfour = 000000000000000000000000000132;
const String _videoIdfive = 'https://youtu.be/JVw2KnPmXk4?t=';
const double _startSecondsfive = 0000000000000000000000000001591;
