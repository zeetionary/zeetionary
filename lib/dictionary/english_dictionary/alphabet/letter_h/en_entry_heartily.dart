...
class EnglishEntryheartily extends StatefulWidget {
  const EnglishEntryheartily({super.key});

  @override
  State<EnglishEntryheartily> createState() => _EnglishEntryheartilyState();
}

class _EnglishEntryheartilyState extends State<EnglishEntryheartily> {
  @override
  void initState() {
    super.initState();
...
2. In a hearty manner (- cordially, warmly)
"'Yes,' the children chorused heartily";
""",
  );

  final String keyword = "heartily";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heartily""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She laughed heartily at the joke.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The school heartily approves of parental involvement.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I am heartily sick of the whole situation.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heartily""",
                      // alsoEnglishWord: "also: heartily",
                      britshText: """IpaUK: /ˈhɑːtɪli/""",
                      americanText: """IpaUS: /ˈhɑːrtɪli/""",
...
کوردی: لەدڵەوە، پڕ بەدڵ، لە ناخی دڵەوە، سێ‌مڕەکی، بەتەواوەتی، یەکجار، بەڕاستی
"""),
// With short examples define "heartily", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) بە خۆشی و شادی ئاشکراوە"""),
                    SentencesRow(
                      englishText: """She laughed heartily at the joke.""",
                      kurdishText: """لەدڵەوە پێکەنی بە نوکتەکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بە شێوەیەک کە ئەوە پیشان دەدات هەستی توندت هەیە بۆ شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The school heartily approves of parental involvement.""",
                      kurdishText:
                          """قوتابخانەکە لەدڵەوە تێکەڵبوونی دایبابان پەسەند دەکات.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ھاوەڵکار) بە ئاستێکی زۆر"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I am heartily sick of the whole situation.""",
                      kurdishText: """تەواو بێزارم لە تەواوی دۆخەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/98MCz9gQaiE?t=';
const double _startSecondsend = 0000000000000000000000000001438;
const String _videoIdone = 'https://youtu.be/r5cqa9V0mUo?t=';
const double _startSecondsone = 0000000000000000000000000001570;
const String _videoIdtwo = 'https://youtu.be/HyDMhrmXIew?t=';
const double _startSecondstwo = 000000000000000000000000000974;
const String _videoIdthree = 'https://youtu.be/_dXakYvOPdM?t=';
const double _startSecondsthree = 0000000000000000000000000003724;
const String _videoIdfour = 'https://youtu.be/Qbel5MhtDq4?t=';
const double _startSecondsfour = 000000000000000000000000000707;
const String _videoIdfive = 'https://youtu.be/DsHH2iv53kw?t=';
