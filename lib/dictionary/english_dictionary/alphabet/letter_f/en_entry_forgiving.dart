...
class EnglishEntryforgiving extends StatefulWidget {
  const EnglishEntryforgiving({super.key});

  @override
  State<EnglishEntryforgiving> createState() => _EnglishEntryforgivingState();
}

class _EnglishEntryforgivingState extends State<EnglishEntryforgiving> {
  @override
  void initState() {
    super.initState();
...
2. Providing absolution (= absolvitory, exonerative)
""",
  );

  final String keyword = "forgiving";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forgiving""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Snow is a forgiving surface on which to fall.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forgiving""",
                      // alsoEnglishWord: "also: forgiving",
                      britshText: """IpaUK: /fəˈɡɪvɪŋ/""",
                      americanText: """IpaUS: /fərˈɡɪvɪŋ/""",
...
// With short examples define "forgiving", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The public was more forgiving of the president's difficulties than the press and fellow politicians.""",
                      kurdishText:
                          """خەڵکی زیاتر بەخشندە بوون بەرامبەر ئاڵەنگارییەکانی سەرۆک وەک لە میدیا و سیاسەتمەدارە هاوڕێکانی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بەفر ڕوویەکی بێ‌زیانە بۆ کەوتن لەسەری.""",
                      englishNote:
                          """This means that snow is a gentle and soft surface to fall on, making it less likely to cause injury.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/4brrubUsqB0?t=';
const double _startSecondsend = 000000000000000000000000000215;
const String _videoIdone = 'https://youtu.be/iq6_iUhLHo4?t=';
const double _startSecondsone = 000000000000000000000000000360;
const String _videoIdtwo = 'https://youtu.be/pdipblQmgnw?t=';
const double _startSecondstwo = 00000000000000000000000000022;
const String _videoIdthree = 'https://youtu.be/mScpHTIi-kM?t=';
const double _startSecondsthree = 000000000000000000000000000822;
const String _videoIdfour = 'https://youtu.be/69Dh6zVZe80?t=';
const double _startSecondsfour = 000000000000000000000000000771;
const String _videoIdfive = 'https://youtu.be/3mugPH2_qRo?t=';
const double _startSecondsfive = 0000000000000000000000000002957;
