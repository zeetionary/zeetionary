...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000800;
    const String videoIdone = 'https://youtu.be/OgFcz6klaeg?t=';
    const double startSecondsone = 000000000000000000000000000689;
    const String videoIdtwo = 'https://youtu.be/HfV_GyC3oM4?t=';
    const double startSecondstwo = 00000000000000000000000000065;
    const String videoIdthree = 'https://youtu.be/4cwXifDaCjE?t=';
    const double startSecondsthree = 0000000000000000000000000002759;
    const String videoIdfour = 'https://youtu.be/O85OWBJ2ayo?t=';
    const double startSecondsfour = 0000000000000000000000000005;
    const String videoIdfive = 'https://youtu.be/6ES9xdZsWHQ?t=';
