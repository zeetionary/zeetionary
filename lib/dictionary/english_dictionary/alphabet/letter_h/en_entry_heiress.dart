...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ژنە میراتگرێک کە مافی یاسایی هەیە زەوی و پارەی کەسێک وەربگرێت لە دوای مردنی"""),
                    SentencesRow(
                      englishText:
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/1jm3K9cm3vI?t=';
const double _startSecondsend = 0000000000000000000000000001584;
const String _videoIdone = 'https://youtu.be/s_2QTY0V3Yc?t=';
const double _startSecondsone = 0000000000000000000000000002;
const String _videoIdtwo = 'https://youtu.be/0DSO5Khbi1s?t=';
const double _startSecondstwo = 000000000000000000000000000124;
const String _videoIdthree = 'https://youtu.be/U8XeKPr2Y9s?t=';
const double _startSecondsthree = 000000000000000000000000000149;
const String _videoIdfour = 'https://youtu.be/jxahNT2pHkg?t=';
const double _startSecondsfour = 000000000000000000000000000199;
const String _videoIdfive = 'https://youtu.be/wwzFB_UjtVQ?t=';
const double _startSecondsfive = 0000000000000000000000000003789;
