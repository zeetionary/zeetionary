...
class EnglishEntryleg extends StatefulWidget {
  const EnglishEntryleg({super.key});

  @override
  State<EnglishEntryleg> createState() => _EnglishEntrylegState();
}

class _EnglishEntrylegState extends State<EnglishEntryleg> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: leg (Derived forms: legs)
1. A human limb; commonly used to refer to a whole limb but technically only the part of the limb between the knee and ankle(- pin [informal], peg [informal], stick [informal])
...
6. A prosthesis that replaces a missing leg (- peg [informal], wooden leg, pegleg [informal], peg leg [informal])
...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I broke my leg playing football.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She has a broken leg.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He lost a leg in a motorcycle accident.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She had to have her leg amputated.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How many legs does a centipede have?""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She rose to her feet on shaky legs.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Have you ever tried frogs' legs?""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He rolled up the legs of his jeans.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""These jeans are too long in the leg.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He tripped over the leg of the chair.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He saw a long-legged insect hopping in the garden.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The final leg of the trip was by donkey.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We were on the last leg of our journey.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/3o-_seszOCA?t=41';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/CCe_7wdiIl8';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/K-2kCA3BRB8?t=12';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/stM2eCH-IXk?t=1014';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/qslVHurpXzU?t=1363';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/7tKP0pXXbs0?t=4305';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """leg""",
                      // alsoEnglishWord: "also: leg",
                      britshText: """IpaUK: /leɡ/""",
                      americanText: """IpaUS: /leɡ/""",
...
کوردی: پێ، لاق، پا، قاچ، لنگ، پاچکە،	گۆشتی ڕان، گۆشتی پێ،	(کورسی و هتد) پاچکە، پایە، قاچ،	(شەڵوار) لنگ،	(گەڕان و سەفەر) قۆناخ، بەش، وچان،	(گۆرەوی) مل،	(ئەندازە) ستوون
"""),
// With short examples define "leg", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) لاق"""),
                    SentencesRow(
                      englishText:
                          """Sit on the floor, stretching your legs out in front of you.""",
                      kurdishText:
                          """لەسەر زەوییەکە دابنیشە و لاقەکانت لە پێشت ڕابکێشە.""",
                        ...
                        MyExpansionTile(
                          children: [
                            SentencesRow(
                              ...
                              kurdishText: """لاقم شکا لە کاتی یاری تۆپی پێ.""",
                            ...
                            SentencesRow(
                              englishText: """She has a broken leg.""",
                              kurdishText: """لاقی شکاوە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """لاقێکی لە ڕووداوێکی ماتۆڕسکیلدا لەدەستدا.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText: """پێویست بوو لاقی ببڕنەوە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """لەسەر لاقی لەرزۆک هەستایە سەر پێ.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) لاقی ئاژەڵێک کە دەخورێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Have you ever tried frogs' legs?""",
                      kurdishText: """هەرگیز لاقی بۆقت خواردووە؟""",
                      onPressedBritish: () => speaksentence8("en-GB"),
                      onPressedAmerican: () => speaksentence8("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) ئەو بەشەی شەرواڵ کە لاقەکان دادەپۆشێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He rolled up the legs of his jeans.""",
                      kurdishText: """لاقەکانی شەرواڵەکەیی هەڵکرد.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """These jeans are too long in the leg.""",
                      kurdishText: """لاقەکانی ئەم شەرواڵە زۆر درێژن.""",
                      onPressedBritish: () => speaksentence10("en-GB"),
                      onPressedAmerican: () => speaksentence10("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ناو) لاقەکانی مێزێک، کورسییەک، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He tripped over the leg of the chair.""",
                      kurdishText: """پێی هەڵکەوت لە لاقی کورسییەکە.""",
                      onPressedBritish: () => speaksentence11("en-GB"),
                      onPressedAmerican: () => speaksentence11("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (ناو) هەبوونی ئەو ڕێژە یان ژمارە لە لاق کە باسکراوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He saw a long-legged insect hopping in the garden.""",
                      kurdishText: """مێروویەکی لاق درێژی بینی لە باخچەکە بازی دەدا.""",
                      onPressedBritish: () => speaksentence12("en-GB"),
                      onPressedAmerican: () => speaksentence12("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٦. (ناو) بەشێکی گەشتێک یان پێشبڕکێیەک"""),
                    const AlsoEnglishckb(word: "ھەروەھا: section، stage"),
                    SentencesRow(
                      englishText: """The final leg of the trip was by donkey.""",
                      kurdishText: """کۆتا بەشی گەشتەکە بە گوێدرێژ بوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We were on the last leg of our journey.""",
                      kurdishText: """لە کۆتا بەشی گەشتەکەمان بووین.""",
