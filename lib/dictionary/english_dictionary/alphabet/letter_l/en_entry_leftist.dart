...
class EnglishEntryleftist extends StatefulWidget {
  const EnglishEntryleftist({super.key});

  @override
  State<EnglishEntryleftist> createState() => _EnglishEntryleftistState();
}

class _EnglishEntryleftistState extends State<EnglishEntryleftist> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""leftist""");
  }
