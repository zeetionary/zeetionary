...
class EnglishEntryasbestos extends StatelessWidget {
  ...
  Future<void> speakasbestos(String languageCode) async {
    ...
    await flutterTts.speak("asbestos");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "asbestos"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /æsˈbestɒs/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /æzˈbestəs/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'te1YVChqcnw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'X7nY4pbVMsA';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'yOFioumFt3Y';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'WRSZAd-9mx4';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'TgB5kiRa2Y0';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'GURHbtSD7jA';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'aHS8w-pu1bg';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'CEaXtBAKP7M';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'HwAFHwNAOz0';
