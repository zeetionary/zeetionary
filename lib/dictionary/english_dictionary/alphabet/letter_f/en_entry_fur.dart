...
class EnglishEntryfur extends StatefulWidget {
  const EnglishEntryfur({super.key});

  @override
  State<EnglishEntryfur> createState() => _EnglishEntryfurState();
}

class _EnglishEntryfurState extends State<EnglishEntryfur> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fur (Derived forms: furs)
1. The dressed hairy coat of a mammal (- pelt)
 
2. Dense coat of fine silky hairs on mammals (e.g., cat, seal or weasel)
 
3، A garment made of animal pelts or synthetic fur

- Verb: fur (Derived forms: furring, furred, furs)
1. [Brit] Become covered or clogged with a deposit (e.g. limescale in a hard water area) (- fur up [Brit])
"the boiler has become furred up"; "Facts about smoking and furred-up arteries";

2. Cover or trim with fur
""",
  );

  final String keyword = "fur";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The cat carefully licked its fur.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She stroked the soft fur on the dog's back.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The animal is hunted for its fur.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was wearing her fur.""");
  }
...
کوردی: خوری، تووک، موو، تیسک، کوڵکە،	پێستە، کەوڵ، کورک، فەروە، پارچەی لە کوڵک یان تووک،	(کتری، لوولە و هتد) بەڵخ، سۆنە، بار،	(زمان) پەلاسی دەم، بار
"""),
// With short examples define "fur", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The cat carefully licked its fur.""",
                      kurdishText:
                          """پشیلەکە بە وریاییەوە فەرووەکەیی دەلێسایەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەستی دەهێنا بە فەرووە نەرمەکەی سەر پشتی سەگەکەدا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Native Americans traded furs with early European settlers.""",
                      kurdishText:
                          """ئەمریکییە ڕەسەنەکان فەروویان دەگۆڕییەوە لەگەڵ نیشتەجێ ئەورووپییەکان.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) پێستی ئاژەڵێک کە هێشتا فەرووەکەی پێوەیە و بەکاردێت بۆ جلوبەرگ؛ مادەیەکی دەستکرد کە وەک فەرووە"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    SentencesRow(
                      englishText:
                          """Personally , I don't think animals should be killed for their fur.""",
                      kurdishText:
                          """وەک خۆم، پێم وانییە گونجاو بێت ئاژەڵان بکوژرێن بۆ فەرووەکەیان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/gRHVPfhJOr4?t=';
const double _startSecondsend = 00000000000000000000000000063;
const String _videoIdone = 'https://youtu.be/JX4Xv6Ty3vk?t=';
const double _startSecondsone = 00000000000000000000000000052;
const String _videoIdtwo = 'https://youtu.be/WlSAu5dNdp8?t=';
const double _startSecondstwo = 00000000000000000000000000096;
const String _videoIdthree = 'https://youtu.be/9vlerM2a4Bk?t=';
const double _startSecondsthree = 00000000000000000000000000059;
const String _videoIdfour = 'https://youtu.be/KWBIcY2KKBs?t=';
const double _startSecondsfour = 00000000000000000000000000063;
const String _videoIdfive = 'https://youtu.be/Zxqg_um1TXI?t=';
