...
class EnglishEntryunderage extends StatelessWidget {
  EnglishEntryunderage({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈʌndə(r) eɪdʒ/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'dQuRfXhjld4';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'ncP-T9NB-8A';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '2gU8lXbqN68';
