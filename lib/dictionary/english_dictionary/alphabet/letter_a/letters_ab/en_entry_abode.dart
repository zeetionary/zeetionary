...
// replace these: EnglishEntryabode - speakAbode - abode - /əˈbəʊd/

enum TtsState { playing }

class EnglishEntryabode extends StatelessWidget {
  EnglishEntryabode({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'abode', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈbəʊd/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /əˈbəʊd/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'JQfniiD4qGw';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'ZmNkcH2o9Go';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'B50sVK_VT4A';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'oN4wJp9M7-E';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'NQuP82c6jW0';
