...
class EnglishEntryfermentation extends StatefulWidget {
...
2. A process in which an agent causes an organic substance to break down into simpler substances; especially, the anaerobic breakdown of sugar into alcohol (= zymosis, zymolysis, fermenting)
""",
  );
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fermentation""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fermentation""",
                      // alsoEnglishWord: "also: fermentation",
                      britshText: """IpaUK: /ˌfɜːmenˈteɪʃn/""",
                      americanText: """IpaUS: /ˌfɜːrmenˈteɪʃn/""",
...
const double _startSecondsone = 000000000000000000000000000259;
const String _videoIdtwo = 'https://youtu.be/PwbgLteVwvs?t=';
const double _startSecondstwo = 000000000000000000000000000261;
const String _videoIdthree = 'https://youtu.be/vA_j6rjsBec?t=';
const double _startSecondsthree = 00000000000000000000000000052;
const String _videoIdfour = 'https://youtu.be/x3zQELlrY6A?t=';
const double _startSecondsfour = 000000000000000000000000000352;
const String _videoIdfive = 'https://youtu.be/FovIyqov1uA?t=';
const double _startSecondsfive = 000000000000000000000000000833;
