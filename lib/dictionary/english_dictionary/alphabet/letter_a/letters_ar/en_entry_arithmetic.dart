...
class EnglishEntryarithmetic extends StatelessWidget {
  ...
  Future<void> speakarithmetic(String languageCode) async {
    ...
    await flutterTts.speak("arithmetic");
  }
  ...
  Future<void> speakarithmetic1223(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He's not very good at arithmetic.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arithmetic"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈrɪθmətɪk/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈrɪθmətɪk/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'wsOoClvZmic';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'sYRXC0sHahE';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'y_f7c3ztFrI';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'rtTRJC9iNFA';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'kUs9PzFr6yg';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'EXUuKYHyXPY';
