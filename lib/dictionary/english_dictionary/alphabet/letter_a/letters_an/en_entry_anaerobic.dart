...
// replace these: replace EnglishEntryanaerobic - replace speakAnaerobic - replace anaerobic - /ˌænəˈrəʊbɪk/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryanaerobic extends StatelessWidget {
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "anaerobic", // DOPSUM: CHANGE WORD ENTRY - Find /ˌænəˈrəʊbɪk/
                                style: TextStyle(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'bdzkbzscQm8';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'ra_bwOckp1M';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'nnKqRdtqcOM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'J44svaQc5WY';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'fRKW7wt4pNg';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'GTrrpF1prOY';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = 'V17T_5jRE2M';
