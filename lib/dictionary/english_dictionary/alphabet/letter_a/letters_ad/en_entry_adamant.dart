...
class EnglishEntryadamant extends StatefulWidget {
  const EnglishEntryadamant({super.key});

  @override
  State<EnglishEntryadamant> createState() => _EnglishEntryadamantState();
}

class _EnglishEntryadamantState extends State<EnglishEntryadamant> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""adamant""");
  }
  ...
  Future<void> speakadam35871(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Eva was adamant that she would not come.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """adamant""",
                      // alsoEnglishWord: "also: adamant",
                      britshText: """IpaUK: /ˈædəmənt/""",
                      americanText: """IpaUS: /ˈædəmənt/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'JuqcsWoXSWQ';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'gXCh24ZSueY';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'N8r56f19ziU';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '01WOcylvNlU';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final double _startSeconds = 5380;
