...
class EnglishEntrygarland extends StatefulWidget {
  const EnglishEntrygarland({super.key});

  @override
  State<EnglishEntrygarland> createState() => _EnglishEntrygarlandState();
}

class _EnglishEntrygarlandState extends State<EnglishEntrygarland> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""garland""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The office was decked with garlands for the party.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They garlanded the visitors with scented flowers.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """garland""",
                      // alsoEnglishWord: "also: garland",
                      britshText: """IpaUK: /ˈɡɑːlənd/""",
                      americanText: """IpaUS: /ˈɡɑːrlənd/""",
...
// With short examples define "garland", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئۆفیسەکە بە تاجەگوڵینە ڕازێندرابوویەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تاجەگوڵینەی گوڵی بۆنخۆشیان لە ملی میوانەکان کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/sormK0WQ1Ac?t=';
const double _startSecondsend = 000000000000000000000000000474;
const String _videoIdone = 'https://youtu.be/4Nr1AgIfajI?t=';
const double _startSecondsone = 000000000000000000000000000662;
const String _videoIdtwo = 'https://youtu.be/j6tbG6b6xRg?t=';
const double _startSecondstwo = 000000000000000000000000000163;
const String _videoIdthree = 'https://youtu.be/cGuoio-kc_8?t=';
const double _startSecondsthree = 000000000000000000000000000294;
const String _videoIdfour = 'https://youtu.be/FCX0bx070OM?t=';
const double _startSecondsfour = 000000000000000000000000000207;
const String _videoIdfive = 'https://youtu.be/Gi2939KtVNM?t=';
const double _startSecondsfive = 000000000000000000000000000702;
