...
class EnglishEntryextraordinary extends StatefulWidget {
  const EnglishEntryextraordinary({super.key});

  @override
  State<EnglishEntryextraordinary> createState() =>
      _EnglishEntryextraordinaryState();
}

class _EnglishEntryextraordinaryState extends State<EnglishEntryextraordinary> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extraordinary""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extraordinary""",
                      // alsoEnglishWord: "also: extraordinary",
                      britshText: """IpaUK: /ɪkˈstrɔːdnri/""",
                      americanText: """IpaUS: /ɪkˈstrɔːrdəneri/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extraordinary";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""What an extraordinary thing to say!""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was a truly extraordinary woman.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""An extraordinary meeting was held to discuss the problem.""");
  }
...
"""),
          ...
          SentencesRow(
            englishText: """What an extraordinary thing to say!""",
            kurdishText: """چی شتێکی نامۆیە بۆ گوتن.""",
          ...
          SentencesRow(
            englishText:
                """It is extraordinary how little evidence supports this view.""",
            kurdishText:
                """ئەوە نامۆیە کە چەندە بەڵگەی کەم پشتگیری ئەم دیدە دەکات.""",
          ...
          SentencesRow(
            englishText:
                """The response from the public has been quite extraordinary.""",
            kurdishText: """وەڵامی خەڵکی تەواو نائاسایی بووە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """گفتوگۆیەکی نائاسایی ڕێکخرا بۆ باسکردنی کێشەکە.""",
          ...
          SentencesRow(
            englishText:
                """The ruling Socialist Party held an extraordinary congress in July, two months before the annual congress.""",
            kurdishText:
                """پارتی سۆشیالیستی دەسەڵاتدار کۆبوونەوەیەکی نائاسایی ڕێکخست لە تەمووزدا، دوو مانگ پێش کۆبوونەوەی ساڵانەی.""",
...
2. Far more than usual or expected (= over-the-top, sinful)
...
const double _startSecondsend = 000000000000000000000000000888;
const String _videoIdone = 'https://youtu.be/GcdB5bFwio4?t=';
const double _startSecondsone = 00000000000000000000000000045;
const String _videoIdtwo = 'https://youtu.be/10FiSsim_a4?t=';
const double _startSecondstwo = 000000000000000000000000000424;
const String _videoIdthree = 'https://youtu.be/uKgaVlMN7IY?t=';
const double _startSecondsthree = 000000000000000000000000000133;
const String _videoIdfour = 'https://youtu.be/TRGHIN2PGIA?t=';
const double _startSecondsfour = 000000000000000000000000000458;
