...
class EnglishEntryenjoy extends StatefulWidget {
  const EnglishEntryenjoy({super.key});

  @override
  State<EnglishEntryenjoy> createState() => _EnglishEntryenjoyState();
}

class _EnglishEntryenjoyState extends State<EnglishEntryenjoy> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enjoy""",
                      // alsoEnglishWord: "also: enjoy",
                      britshText: """IpaUK: /ɪnˈdʒɔɪ/""",
                      americanText: """IpaUS: /ɪnˈdʒɔɪ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Thanks for a great evening. I really enjoyed it.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She seems to be enjoying life in Paris.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I really enjoyed watching the film again.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She greatly enjoys her work.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They all enjoyed themselves at the party.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The kids all seemed to enjoy themselves.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He's always enjoyed good health.""");
  }
...
"""),
          ...
          SentencesRow(
            ...
            kurdishText: """سوپاس بۆ ئەم ئێوارە خۆشە. بەڕاستی چێژم لێ بینی.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She seems to be enjoying life in Paris.""",
            kurdishText: """وەها دەردەکەوێت حەز بە ژیانی پاریس بکات.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I really enjoyed watching the film again.""",
            kurdishText:
                """بەڕاستی چێژم بینی لە دووبارە سەیرکردنەوەی فیلمەکە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She greatly enjoys her work.""",
            kurdishText: """زۆر چیژ دەبینێت لە کارەکەی.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هەموویان چێژیان لە خۆیان بینی لە ئاهەنگەکە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The kids all seemed to enjoy themselves.""",
            kurdishText: """منداڵەکان هەموویان وەها دەردەکەوتن کە دڵخۆش بن.""",
            onPressedBritish: () => speaksentence6("en-GB"),
            onPressedAmerican: () => speaksentence6("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٣. (کردار) هەبوونی شتێکی باش کە سوودی بۆت هەیە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """He's always enjoyed good health.""",
            kurdishText: """هەمیشە تەندرووستی باشی هەبووە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """خەڵکی ئەم وڵاتە ستانداردی بەرزی ژیانیان هەیە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: enjoy (Derived forms: enjoyed, enjoys, enjoying)
1. Derive or receive pleasure from; get enjoyment from; take pleasure in (= bask, relish, savor [US], savour [Brit, Cdn], love)
 
2. Have benefit from
"enjoy privileges"
 
3. Have for one's benefit
"The industry enjoyed a boom"
 
4. Take delight in and make the most of (= delight, revel)
""",
  );
...
const double _startSecondsend = 1092;
const String _videoIdone = 'https://youtu.be/hS2x1zl4rn0?t=';
const double _startSecondsone = 1290;
const String _videoIdtwo = 'https://youtu.be/oEn7XBxOXSw?t=';
const double _startSecondstwo = 452;
const String _videoIdthree = 'https://youtu.be/GlPaFt6C56Y?t=';
const double _startSecondsthree = 176;
const String _videoIdfour = 'https://youtu.be/ky3KiiUK_D0?t=';
...
const String _videoIdsix = 'https://youtu.be/h4CyhQqAPpk?t=';
const double _startSecondssix = 12;
