...
// With short examples define "heal", please follow LX instructions
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) کۆتایی هێنان بە شتێک یان ئەوەی شتێک ئاسانتر بێت بۆ بەرگەگرتن"""),
                    SentencesRow(
                      englishText:
                          """The breach between them never really healed.""",
                      kurdishText:
                          """کەلێنەکەی نێوانیان هەرگیز بە تەواوی چاک نەبووەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She was never able to heal the rift between herself and her father.""",
                      kurdishText:
                          """هەرگیز نەیتوانی ناکۆکی نێوان خۆی و باوکی چاک بکاتەوە.""",
