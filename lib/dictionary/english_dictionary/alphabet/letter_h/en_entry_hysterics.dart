...
class EnglishEntryhysterics extends StatefulWidget {
  const EnglishEntryhysterics({super.key});

  @override
  State<EnglishEntryhysterics> createState() => _EnglishEntryhystericsState();
}

class _EnglishEntryhystericsState extends State<EnglishEntryhysterics> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hysterics""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 506;
    const String videoIdone = 'xgs5gOCpsAE';
    const double startSecondsone = 81;
    const String videoIdtwo = '0num7Zb4iu4';
    const double startSecondstwo = 653;
    const String videoIdthree = '8y58X14nYcM';
    const double startSecondsthree = 565;
    const String videoIdfour = 'ODf7VDAL1QU';
    const double startSecondsfour = 239;
    const String videoIdfive = 'On-bOrfQEgk';
