...
class EnglishEntryattach extends StatelessWidget {
  ...
  Future<void> speakattach319(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("attI attached a photo to my application form.");
  }
  ...
  Future<void> speakattach321(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("They have attached a number of conditions to the agreement.");
  }
  ...
  Future<void> speakattach322(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("I am attaching the image as a PDF file.");
  }
  ...
  Future<void> speakattach329(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("This does not attach any blame to you.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "attach"),
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈtætʃ/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈtætʃ/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakattach319("en-GB"),
                            onPressedAmerican: () => speakattach319("en-US"),
                          ),
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakattach321("en-GB"),
                            onPressedAmerican: () => speakattach321("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
...
٢. (کردار) ناردنی دۆکیومێنتێک بە ئیمەیڵ"""),
                          SentencesRow(
                            ...
                            kurdishText: "وێنەکە بە فایلێکی پی‌دی‌ئێف دەنێرم.",
                            onPressedBritish: () => speakattach322("en-GB"),
                            onPressedAmerican: () => speakattach322("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٣. (کردار) وادانانی ئەوەی شتێک گرنگە یان شایەنی ئەوەیە بیری لێ‌بکەیەوە"""),
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakattach325("en-GB"),
                            onPressedAmerican: () => speakattach325("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٤. (کردار) لەگەڵ کەسێک بوون، بەتایبەتی لەگەڵ کەسێک کە نایەوێیت"""),
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakattach327("en-GB"),
                            onPressedAmerican: () => speakattach327("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٥. (کردار) بوونی پەیوەندی لە نێوان کەسێک و شتێکدا"""),
                          SentencesRow(
                            ...
                            kurdishText: "ئەمە ھیچ لۆمەیەک ناخاتە سەر تۆ.",
                            onPressedBritish: () => speakattach329("en-GB"),
                            onPressedAmerican: () => speakattach329("en-US"),
                          ),
                          const DividerSentences(),
                          // const DividerDefinition(),
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakattach331("en-GB"),
                            onPressedAmerican: () => speakattach331("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'XASsnCAUIRY';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'GhY5jdXD-bw';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'yP6NCLhjywQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '4jTbQsSt_vI';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'I5CQsBWKtOg';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'EEuzEn0qmI8';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'wqRKFYDtphU';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = '3RkfODVAE74';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'TTYeXoXDvBE';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'ZAdiMbaH8F8';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'GnR9RimdNMI';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'PBKmc24qETo';
