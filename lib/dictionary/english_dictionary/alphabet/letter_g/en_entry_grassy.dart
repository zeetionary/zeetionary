...
class EnglishEntrygrassy extends StatefulWidget {
  const EnglishEntrygrassy({super.key});

  @override
  State<EnglishEntrygrassy> createState() => _EnglishEntrygrassyState();
}

class _EnglishEntrygrassyState extends State<EnglishEntrygrassy> {
  @override
  void initState() {
    super.initState();
...
2. Resembling or relating to grass
""",
  );

  final String keyword = "grassy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A grassy slope led down to the river.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grassy""",
                      // alsoEnglishWord: "also: grassy",
                      britshText: """IpaUK: /ˈɡrɑːsi/""",
                      americanText: """IpaUS: /ˈɡræsi/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText: """A grassy slope led down to the river.""",
                      kurdishText:
                          """لێژاییەکی پڕگیا بەرەو ڕووبارەکە لێژدەبوویەوە.""",
