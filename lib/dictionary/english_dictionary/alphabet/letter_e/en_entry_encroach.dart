...
class EnglishEntryencroach extends StatefulWidget {
  const EnglishEntryencroach({super.key});

  @override
  State<EnglishEntryencroach> createState() => _EnglishEntryencroachState();
}

class _EnglishEntryencroachState extends State<EnglishEntryencroach> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("encroach");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "encroach",
                      // alsoEnglishWord: "also: encroach",
                      britshText: "IpaUK: /ɪnˈkrəʊtʃ/",
                      americanText: "IpaUS: /ɪnˈkrəʊtʃ/",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I won't encroach on your time any longer.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("He never allows work to encroach upon his family life.");
  }
...
// کوردی: دەستدرێژی کردن، سەرپێچی کردن
// """),
          const DefinitionKurdish(
              text:
                  """١. (کردار) دەستکردن بە بەکارهێنانی بەشێکی زۆر لە کات، ماف، ژیانی کەسی، هتد ــی کەسێک"""),
          SentencesRow(
            englishText: """I won't encroach on your time any longer.""",
            kurdishText: """چی دیکە لە کاتت ناگرم.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هەرگیز ناهێڵێت کارکردن لە ژیانی خێزانی ببات.""",
          ...
          SentencesRow(
            englishText:
                """The growing town soon encroached on the surrounding countryside.""",
            kurdishText:
                """شارۆچکەکە ڕوولەگەشەکە فراوانبوو بەسەر دەشتەکەی دەوریدا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: encroach (Derived forms: encroaching, encroached, encroaches)
1. Advance beyond the usual limit (= infringe, impinge)
 
2. Have a negative effect on, esp. by somehow restricting; infringe upon (= impinge, entrench, trench [archaic])
...
const String _videoIdend = 'https://youtu.be/YMfYfoBxOVM?t=';
const double _startSecondsend = 181;
const String _videoIdone = 'https://youtu.be/rwVSF1L53Gs?t=';
const double _startSecondsone = 276;
const String _videoIdtwo = 'https://youtu.be/woD6RYptp58?t=';
const double _startSecondstwo = 1102;
const String _videoIdthree = 'https://youtu.be/E7LuMCamy7k?t=';
const double _startSecondsthree = 107;
const String _videoIdfour = 'https://youtu.be/ojubI-sYwho?t=';
const double _startSecondsfour = 74;
const String _videoIdfive = 'https://youtu.be/ill2cgCyTUc?t=';
const double _startSecondsfive = 739;
const String _videoIdsix = 'https://youtu.be/QLq6GEiHqR8?t=';
const double _startSecondssix = 674;
