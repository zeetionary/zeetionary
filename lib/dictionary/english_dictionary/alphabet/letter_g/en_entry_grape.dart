...
class EnglishEntrygrape extends StatefulWidget {
  const EnglishEntrygrape({super.key});

  @override
  State<EnglishEntrygrape> createState() => _EnglishEntrygrapeState();
}

class _EnglishEntrygrapeState extends State<EnglishEntrygrape> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grape (Derived forms: grapes)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We picked grapes in the south of France last summer.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grape""",
                      // alsoEnglishWord: "also: grape",
                      britshText: """IpaUK: /ɡreɪp/""",
                      americanText: """IpaUS: /ɡreɪp/""",
...
کوردی: ترێ، هەنگوور، دەنکەترێ، گلارە
"""),
// With short examples define "grape", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ترێ"""),
                    SentencesRow(
                      englishText:
                          """We picked grapes in the south of France last summer.""",
                      kurdishText:
                          """هاوینی ڕابردوو ترێمان لێکردەوە لە باشووری فەرەنسا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He pulled another grape off the bunch and popped it into his mouth.""",
                      kurdishText:
                          """دەنکە ترێیەکی دیکەی لە هێشووەکە لێکردەوە و خستییە دەمی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The Mediterranean climate is good for growing citrus fruits and grapes.""",
                      kurdishText:
                          """کەش و هەوای دەریای ناوەڕاست بۆ چاندنی میوە ترشەکان و ترێ باشە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/EkkaxjqWaEI?t=';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/sTBOjPxix5c?t=';
const double _startSecondsone = 00000000000000000000000000019;
const String _videoIdtwo = 'https://youtu.be/SowdlPyFQfk?t=';
const double _startSecondstwo = 0000000000000000000000000006;
const String _videoIdthree = 'https://youtu.be/zEUIGiRzpVQ';
const double _startSecondsthree = 0;
const String _videoIdfour = ' https://youtu.be/E72wnbus4aE?t=';
const double _startSecondsfour = 00000000000000000000000000075;
const String _videoIdfive = 'https://youtu.be/eKmm4Q-Q_w0?t=';
