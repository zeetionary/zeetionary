...
class EnglishEntryglib extends StatefulWidget {
  const EnglishEntryglib({super.key});

  @override
  State<EnglishEntryglib> createState() => _EnglishEntryglibState();
}

class _EnglishEntryglibState extends State<EnglishEntryglib> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It would be glib to suggest that she did it deliberately.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glib""",
                      // alsoEnglishWord: "also: glib",
                      britshText: """IpaUK: /ɡlɪb/""",
                      americanText: """IpaUS: /ɡlɪb/""",
...
// With short examples define "glib", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) بەکارهێنانی وشەی زیرەکانە، بەڵام کە زۆر بیری لێ‌نەکراوەتەوە و لە دڵەوە نییە؛ ئەوەی بە باوەڕبەخۆبوون بێت، بەڵام بە سادەیی و بە بێ بیرکردنەوەی قووڵ"""),
                    SentencesRow(
                      englishText:
                          """It would be glib to suggest that she did it deliberately.""",
                      kurdishText:
                          """سەرسەرەکی دەبێت کە باس لەوە بکەیت بە ئەنقەست کردی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He had assumed that his glib explanations would convince us.""",
                      kurdishText:
                          """وەهای دانابوو کە ڕوونکردنەوە زمان‌لووسییەکەی ڕازیمان دەکات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Sbp_EeBk-As?t=';
const double _startSecondsend = 000000000000000000000000000871;
const String _videoIdone = 'https://youtu.be/NpBPm0b9deQ?t=';
const double _startSecondsone = 0000000000000000000000000001150;
const String _videoIdtwo = 'https://youtu.be/K3v5wFMQRqs?t=';
const double _startSecondstwo = 0000000000000000000000000002986;
const String _videoIdthree = 'https://youtu.be/yRFPjBuRRCg?t=';
const double _startSecondsthree = 000000000000000000000000000523;
const String _videoIdfour = 'https://youtu.be/wwzFB_UjtVQ?t=';
const double _startSecondsfour = 0000000000000000000000000005936;
const String _videoIdfive = 'https://youtu.be/VDWzxeo6984?t=';
const double _startSecondsfive = 000000000000000000000000000825;
