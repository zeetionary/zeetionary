...
// Define the word "awning" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace awning - replace EnglishEntryawning

// replace speakAwning - /ˈɔːnɪŋ/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryawning extends StatelessWidget {
  // blank divider
  EnglishEntryawning({super.key});
  // blank divider
  ...
  Future<void> speakawnings1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("We sat under the blue and white awning of the cafe.");
  }
  ...
  Future<void> speakawnings2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAwnings22");
  }
  ...
  Future<void> speakawnings3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAwnings33");
  }
  ...
  Future<void> speakawnings4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAwnings44");
  }
  ...
  Future<void> speakawnings5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAwnings55");
  }
  ...
  Future<void> speakawnings6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAwnings66");
  }
  ...
  Future<void> speakawnings7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAwnings77");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɔːnɪŋ/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɔːnɪŋ/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakawnings1("en-US"),
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'FQ3Z-8MCuxs';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'j_Of36XVHng';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'zX1J9-KMVXE';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'hCxFUWlgb_M';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '14tbRXvXpns';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final double _startSeconds = 1717;
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'swtpoH-HZgY';
...
// end awning // TODO Implement this library.
