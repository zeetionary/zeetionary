...
class EnglishEntryheed extends StatefulWidget {
  const EnglishEntryheed({super.key});

  @override
  State<EnglishEntryheed> createState() => _EnglishEntryheedState();
}

class _EnglishEntryheedState extends State<EnglishEntryheed> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: heed (Derived forms: heeds, heeding, heeded)
1. Pay close attention to; give heed to (- mind, listen)
"Heed the advice of the old men";
- Noun: heed (Derived forms: heeds)
1. Paying particular notice (as to children or helpless people) (- attentiveness, regard, paying attention)
"he spends without heed to the consequences";
""",
  );

  final String keyword = "heed";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They failed to heed the lessons of history.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""If only they had heeded his warnings!""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heed""",
                      // alsoEnglishWord: "also: heed",
                      britshText: """IpaUK: /hiːd/""",
                      americanText: """IpaUS: /hiːd/""",
...
const String _videoIdone = 'https://youtu.be/hKlUQeTRUDo?t=';
const double _startSecondsone = 0000000000000000000000000001305;
const String _videoIdtwo = 'https://youtu.be/pjs33FRZfNI?t=';
const double _startSecondstwo = 00000000000000000000000000021;
const String _videoIdthree = 'https://youtu.be/zJt0e8FRBwM?t=';
const double _startSecondsthree = 00000000000000000000000000089;
const String _videoIdfour = 'https://youtu.be/xPG3_8m1NQA?t=';
const double _startSecondsfour = 000000000000000000000000000996;
const String _videoIdfive = 'https://youtu.be/bcaqyX2jD4g?t=';
