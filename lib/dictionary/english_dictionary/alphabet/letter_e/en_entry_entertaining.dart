...
class EnglishEntryentertaining extends StatefulWidget {
  const EnglishEntryentertaining({super.key});

  @override
  State<EnglishEntryentertaining> createState() =>
      _EnglishEntryentertainingState();
}

class _EnglishEntryentertainingState extends State<EnglishEntryentertaining> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""entertaining""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """entertaining""",
                      // alsoEnglishWord: "also: entertaining",
                      britshText: """IpaUK: /ˌentəˈteɪnɪŋ/""",
                      americanText: """IpaUS: /ˌentərˈteɪnɪŋ/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "entertaining";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was always so funny and entertaining.""");
  }
...
کوردی: خۆش، سەرقاڵ‌کەر، خافڵێنەر، دڵڕفێن، وەپێکەنین‌هێن، بۆرابواردن
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) کە چێژی لێ دەبینیت"""),
          SentencesRow(
            englishText: """She was always so funny and entertaining.""",
            kurdishText: """هەمیشە وەپێکەنین‌هێن و شادی‌هێن بوو.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """گفتووگۆکە بە هەردوو زانیاری‌بەخش و چێژبەخش دەبینم.""",
...
const String _videoIdthree = 'https://youtu.be/-6vzjjIrRK8?t=';
const double _startSecondsthree = 1582;
const String _videoIdfour = 'https://youtu.be/Fr-qagv7ig0?t=';
const double _startSecondsfour = 625;
const String _videoIdfive = 'https://youtu.be/yWhU40m-6uU?t=';
const double _startSecondsfive = 280;
const String _videoIdsix = 'https://youtu.be/mncCR3wehF8?t=';
const double _startSecondssix = 737;
