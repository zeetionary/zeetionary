...
// Define the word "asterisk" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryasterisk - replace speakAsterisk

// replace asterisk - /ˈæstərɪsk/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryasterisk extends StatelessWidget {
  // blank divider
  EnglishEntryasterisk({super.key});
  // blank divider
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'vSJUfAOy0aM';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'TnkdoEZhTbc';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '3aZzmJTpGQo';
