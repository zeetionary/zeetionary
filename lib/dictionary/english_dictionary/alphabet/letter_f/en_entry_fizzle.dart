...
class EnglishEntryfizzle extends StatefulWidget {
  const EnglishEntryfizzle({super.key});

  @override
  State<EnglishEntryfizzle> createState() => _EnglishEntryfizzleState();
}

class _EnglishEntryfizzleState extends State<EnglishEntryfizzle> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fizzle (Derived forms: fizzles)
1. A fricative sound (especially as an expression of disapproval) (= hiss, hissing, hushing, sibilation)
"the performers could not be heard over the fizzle of the audience";
 
2. A complete failure (= flop [informal], bust [informal], clinker [N. Amer, informal], epic fail [informal])
"the play was a dismal fizzle";

- Verb: fizzle (Derived forms: fizzled, fizzling, fizzles)
1. End weakly (= taper off, peter out, fizzle out)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Fireworks fizzled and exploded in the night sky.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fire fizzled in the rain.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fizzle""",
                      // alsoEnglishWord: "also: fizzle",
                      britshText: """IpaUK: /ˈfɪzl/""",
                      americanText: """IpaUS: /ˈfɪzl/""",
...
// With short examples define "fizzle", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """یاریی ئاگرین لە ئاسمانی شەودا فسەی دەهات و دەتەقییەوە.""",
                    ...
                    SentencesRow(
                      englishText: """The fire fizzled in the rain.""",
                      kurdishText: """ئاگرەکە لە بارانەکەدا قرچەی دەهات.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (کردار) کەم‌کەم کۆتایی هاتن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Interest in the project fizzled after the funding was withdrawn.""",
                      kurdishText:
                          """حەز بۆ پڕۆژەکە کەم دامرکایەوە دوای ئەوەی بودجەکە نەهێڵدرا.""",
...
const String _videoIdtwo = 'https://youtu.be/lfkjm2YRG-Q?t=';
const double _startSecondstwo = 000000000000000000000000000875;
const String _videoIdthree = 'https://youtu.be/UdAwX8JB66E?t=';
const double _startSecondsthree = 00000000000000000000000000041;
const String _videoIdfour = 'https://youtu.be/SXARDOeSDyg?t=';
const double _startSecondsfour = 000000000000000000000000000349;
const String _videoIdfive = 'https://youtu.be/JPg-L5kJuOc?t=';
const double _startSecondsfive = 000000000000000000000000000465;
