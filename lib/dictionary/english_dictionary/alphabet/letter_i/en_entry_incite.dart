...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1127;
    const String videoIdone = '3yvxFFsjcYs';
    const double startSecondsone = 967;
    const String videoIdtwo = 'B5ytcg5pYEA';
    const double startSecondstwo = 1021;
    const String videoIdthree = 'HhSNbKezP64';
    const double startSecondsthree = 342;
    const String videoIdfour = 'u8yL3I_6Oco';
    const double startSecondsfour = 674;
    const String videoIdfive = 'A7beCOs4yAw';
    const double startSecondsfive = 449;
