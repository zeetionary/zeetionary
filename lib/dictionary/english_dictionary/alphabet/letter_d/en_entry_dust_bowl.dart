...
class EnglishEntrydustbowl extends StatefulWidget {
  const EnglishEntrydustbowl({super.key});

  @override
  State<EnglishEntrydustbowl> createState() => _EnglishEntrydustbowlState();
}

class _EnglishEntrydustbowlState extends State<EnglishEntrydustbowl> {
  @override
  void initState() {
    super.initState();
  }
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "dust bowl";
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "dust bowl");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: dust bowl");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /ˈdʌst bəʊl/");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakdustbowl(String languageCode) async {
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /ˈdʌst bəʊl/");
  }
}
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakdustbowls1(String languageCode) async {
    // DOPSUM: CHANGE speakdustbowl
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
...
کوردی: چۆڵگە، دەشت، دەشتی تۆزگر، دەشتی کاکی‌بەکاکی
"""),
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls200"""),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls2("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls2("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls300"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls3("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls3("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls400"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls4("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls4("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls500"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls5("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls5("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls600"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls6("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls6("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls700"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls7("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls7("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls800"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls8("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls8("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls900"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls9("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls9("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls_1000"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls10("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls10("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls1100"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls11("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls11("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls1200"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls12("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls12("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls1300"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls13("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls13("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls1400"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls14("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls14("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls1500"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls15("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls15("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls1600"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls16("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls16("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls1700"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls17("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls17("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls1800"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls18("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls18("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls1900"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls19("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls19("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls_2000"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls20("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls20("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls2100"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls21("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls21("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakdustbowls2200"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdustbowls22("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdustbowls22("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
...
class _YoutubeEmbeddedendState extends State<YoutubeEmbeddedend> {
  ...
  final String _videoId = 'qR6BO5p7aak';
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  late YoutubePlayerController _controller;
  final String _videoId = 'EikT1yA5b5E';
...
class _YoutubeEmbeddedtwoState extends State<YoutubeEmbeddedtwo> {
  late YoutubePlayerController _controller;
  final String _videoId = '-g8DQSjFasE';
...
class _YoutubeEmbeddedfourState extends State<YoutubeEmbeddedfour> {
  late YoutubePlayerController _controller;
  final String _videoId = 'GV-tVsrqTCM';
...
class _YoutubeEmbeddedfiveState extends State<YoutubeEmbeddedfive> {
  late YoutubePlayerController _controller;
  final String _videoId = 'axRHuOvcXF0';
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  late YoutubePlayerController _controller;
  final String _videoId = 'bMRyfgjpaa0';
