...
// replace these: replace EnglishEntryacorn - replace speakAcorn - replace acorn - /ˈeɪkɔːrn/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryacorn extends StatelessWidget {
  EnglishEntryacorn({Key? key}) : super(key: key);
  ...
  Future<void> speakAcorn(String languageCode) async {
    ...
    await flutterTts.speak("acorn"); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈeɪkɔːn/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '6PTuUMJ2Uh8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '6i4We1K0Ju4';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = '_FRCyW9jcmA';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = '83EGQgx6Njc';
