...
class EnglishEntryexemplification extends StatefulWidget {
  const EnglishEntryexemplification({super.key});

  @override
  State<EnglishEntryexemplification> createState() =>
      _EnglishEntryexemplificationState();
}

class _EnglishEntryexemplificationState
    extends State<EnglishEntryexemplification> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exemplification""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: exemplification",
                      britshText: """IpaUK: /ɪɡˌzemplɪfɪˈkeɪʃn/""",
                      americanText: """IpaUS: /ɪɡˌzemplɪfɪˈkeɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exemplification";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her speech was an exemplification of courage.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """The exemplifications are what make the definitions meaningful.""");
  }
...
کوردی: نموونەهێنانەوە، تێگەیاندن بە نموونە، هەڵدانی نموونە یان وێنە،	لەبەرهەڵگرتنەوە،	نموونە، میناک، وێنە
"""),
          const DefinitionKurdish(
              text: """١. (ناو) شتێک کە نموونەی تەواوی شتێکە"""),
          SentencesRow(
            englishText: """Her speech was an exemplification of courage.""",
            kurdishText: """وتارەکەی پێناسەی بوێری بوو.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) پێدانی نموونە بۆ ڕوونکردنەوەی شتێک"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The exemplifications are what make the definitions meaningful.""",
            kurdishText: """نموونەکان ئەوەن کە واتا دەبەخشن بە پێناسەکان.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: exemplification (Derived forms: exemplifications)
1. Showing by example (= illustration)
 
2. A representational or typifying form or model (= typification)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/2RbiCOFffRs?t=';
const double _startSecondsend = 000000000000000000000000000000; // 563;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/NRaYhaAoC6g?t=';
const double _startSecondsone = 00000000000000000000000000000; // 393;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/PEcd7eOnLIU?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 55;
const String _videoIdthree = 'VIDEOhttps://youtu.be/0F2gq9rWuj0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 205;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/hoFdVuqrMZw?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 393;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/WqsyvK_2eYo?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 437;
