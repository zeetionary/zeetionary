...
class EnglishEntryforcibly extends StatefulWidget {
  const EnglishEntryforcibly({super.key});

  @override
  State<EnglishEntryforcibly> createState() => _EnglishEntryforciblyState();
}

class _EnglishEntryforciblyState extends State<EnglishEntryforcibly> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forcibly""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forcibly""",
                      // alsoEnglishWord: "also: forcibly",
                      britshText: """IpaUK: /ˈfɔːsəbli/""",
                      americanText: """IpaUS: /ˈfɔːrsəbli/""",
...
کوردی: بە زۆری، زۆەملی، بە زۆرەملی،	بە توندی، بە سەختی
"""),
// With short examples define "forcibly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بەشێوەیەک کە لەخۆگرتنی هێزی جەستەیی تێدایە"""),
                    SentencesRow(
                      englishText:
                          """Several rioters were forcibly removed from the town square.""",
                      kurdishText:
                          """ژمارەیەک ئاژاوەگێڕ بە زۆر لە گۆڕەپانەکە دەرکران.""",
...
const double _startSecondsend = 000000000000000000000000000657;
const String _videoIdone = 'https://youtu.be/tURHTuKHBZs?t=';
const double _startSecondsone = 000000000000000000000000000658;
const String _videoIdtwo = 'https://youtu.be/FkKPsLxgpuY?t=';
const double _startSecondstwo = 0000000000000000000000000001150;
const String _videoIdthree = 'https://youtu.be/ZMu7_Xpp1SM?t=';
const double _startSecondsthree = 000000000000000000000000000327;
const String _videoIdfour = 'https://youtu.be/NVH7JewfgJg?t=';
const double _startSecondsfour = 000000000000000000000000000406;
const String _videoIdfive = 'https://youtu.be/2nc9AFcKIuM?t=';
