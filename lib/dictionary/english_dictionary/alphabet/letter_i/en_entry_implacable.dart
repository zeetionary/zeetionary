...
class EnglishEntryimplacable extends StatefulWidget {
  const EnglishEntryimplacable({super.key});

  @override
  State<EnglishEntryimplacable> createState() => _EnglishEntryimplacableState();
}

class _EnglishEntryimplacableState extends State<EnglishEntryimplacable> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""implacable""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'CDKASJDakiA';
    const double startSecondsend = 2316;
    const String videoIdone = 'zZgd75hJTbQ';
    const double startSecondsone = 18;
    const String videoIdtwo = 'boyzWeHdtiI';
    const double startSecondstwo = 165;
    const String videoIdthree = 'sapdYjiFUhY';
    const double startSecondsthree = 3381;
    const String videoIdfour = 'BKiGrPsbtA8';
    const double startSecondsfour = 1740;
    const String videoIdfive = 'V_j7NeYwaoQ';
