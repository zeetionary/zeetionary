...
class EnglishEntrygratefully extends StatefulWidget {
  const EnglishEntrygratefully({super.key});

  @override
  State<EnglishEntrygratefully> createState() => _EnglishEntrygratefullyState();
}

class _EnglishEntrygratefullyState extends State<EnglishEntrygratefully> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: gratefully
1. With appreciation; in a grateful manner (- appreciatively)
"he accepted my offer gratefully";
 
2. In a thankful manner; with thanks (- thankfully)
""",
  );

  final String keyword = "gratefully";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gratefully""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He nodded gratefully.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""All donations will be gratefully received.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gratefully""",
                      // alsoEnglishWord: "also: gratefully",
                      britshText: """IpaUK: /ˈɡreɪtfəli/""",
                      americanText: """IpaUS: /ˈɡreɪtfəli/""",
...
// With short examples define "gratefully", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە سوپاسگوزاری پیشان دەدات بەهۆی ئەوەی کەسێک میهرەبان بووە لەگەڵت یان یارمەتی داویت"""),
                    SentencesRow(
                      englishText: """He nodded gratefully.""",
                      kurdishText: """بە سوپاسگوزارییەوە سەری لەقاند.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەموو بەخشینەکان بە سوپاسگوزارییەوە وەردەگیرێن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ivfspJOAtBI?t=';
const double _startSecondsend = 000000000000000000000000000623;
const String _videoIdone = 'https://youtu.be/bmsmTQNPkSY?t=';
const double _startSecondsone = 000000000000000000000000000245;
const String _videoIdtwo = 'https://youtu.be/ligo_LBPfiE?t=';
const double _startSecondstwo = 000000000000000000000000000334;
const String _videoIdthree = 'https://youtu.be/PQ8m5R76COo?t=';
const double _startSecondsthree = 000000000000000000000000000444;
const String _videoIdfour = 'https://youtu.be/b0BC3F0kqtw?t=';
const double _startSecondsfour = 0000000000000000000000000003889;
const String _videoIdfive = 'https://youtu.be/i0_ginwNbPI?t=';
const double _startSecondsfive = 0000000000000000000000000002070;
