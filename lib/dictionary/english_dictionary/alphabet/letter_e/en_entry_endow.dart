...
class EnglishEntryendow extends StatefulWidget {
  const EnglishEntryendow({super.key});

  @override
  State<EnglishEntryendow> createState() => _EnglishEntryendowState();
}

class _EnglishEntryendowState extends State<EnglishEntryendow> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """endow""",
                      // alsoEnglishWord: "also: endow",
                      britshText: """IpaUK: /ɪnˈdaʊ/""",
                      americanText: """IpaUS: /ɪnˈdaʊ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""In 1937, Mellon endowed the National Gallery of Art.""");
  }
...
// """),
          const DefinitionKurdish(
              text:
                  """١. (کردار) پێدانی داهات یان پارەیەکی زۆر بە قوتابخانە، کۆلێژ، یان پەیمانگایەکی دیکە"""),
          SentencesRow(
            englishText:
                """The state of Michigan has endowed three institutes to do research for industry.""",
            kurdishText:
                """ویلایەتی میشیگان خەرجی بە سێ پەیمانگا داوە بۆ ئەنجامدانی توێژینەوە بۆ پیشەسازی.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """لە ساڵی ١٩٣٧ میڵۆن خەرجی پێشانگای نیشتیمانیی هونەری کرد""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: endow (Derived forms: endowed, endowing, endows)
1. Give qualities or abilities to (= indue, gift, empower, invest, endue)
 
2. Furnish with an endowment (= dower)
"When she got married, she got endowed";
""",
  );
...
const String _videoIdend = 'https://youtu.be/UrkPC81_QfU?t=';
const double _startSecondsend = 1123;
const String _videoIdone = 'https://youtu.be/9hdT8PgT19w?t=';
const double _startSecondsone = 353;
const String _videoIdtwo = 'https://youtu.be/4IaOeVgZ-wc?t=';
const double _startSecondstwo = 5244;
const String _videoIdthree = 'https://youtu.be/65vK_gbsgwI?t=';
const double _startSecondsthree = 9;
const String _videoIdfour = 'https://youtu.be/gsXYJn28Gn4?t=';
const double _startSecondsfour = 163;
const String _videoIdfive = 'https://youtu.be/ry_hKpYz0xc?t=';
const double _startSecondsfive = 426;
const String _videoIdsix = 'https://youtu.be/Solb9uA-tgQ?t=';
const double _startSecondssix = 1251;
