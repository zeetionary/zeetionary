...
class EnglishEntryheartlessly extends StatefulWidget {
  const EnglishEntryheartlessly({super.key});

  @override
  State<EnglishEntryheartlessly> createState() =>
      _EnglishEntryheartlesslyState();
}

class _EnglishEntryheartlesslyState extends State<EnglishEntryheartlessly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: heartlessly
1. In a heartless manner
"she behaves rather heartlessly toward her admirers"
""",
  );

  final String keyword = "heartlessly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heartlessly""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heartlessly""",
                      // alsoEnglishWord: "also: heartlessly",
                      britshText: """IpaUK: /ˈhɑːtləsli/""",
                      americanText: """IpaUS: /ˈhɑːrtləsli/""",
...
کوردی: دڵڕەقانە، بێ‌بەزەیی‌یانە
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە بە بێ بوونی بەزەییە بۆ کەسانی دیکە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: cruelly"),
                    SentencesRow(
                      englishText:
...
const String _videoIdone = 'https://youtu.be/M6q8I5UwcQI?t=';
const double _startSecondsone = 000000000000000000000000000426;
const String _videoIdtwo = 'https://youtu.be/MVDz_YiSf4M?t=';
const double _startSecondstwo = 000000000000000000000000000364;
const String _videoIdthree = 'https://youtu.be/kC0antZogec?t=';
const double _startSecondsthree = 0000000000000000000000000001099;
const String _videoIdfour = 'https://youtu.be/-xgoldjr-BI?t=';
const double _startSecondsfour = 0000000000000000000000000001155;
const String _videoIdfive = 'https://youtu.be/Wl4LVB2gnME?t=';
const double _startSecondsfive = 000000000000000000000000000360;
