...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'CtWqv0Z3ErM';
    const double startSecondsend = 637;
    const String videoIdone = '60FM9WjkXtA';
    const double startSecondsone = 1048;
    const String videoIdtwo = 'qqZ_SH9N3Xo';
    const double startSecondstwo = 1448;
    const String videoIdthree = 'OyuIAUlL5IU';
    const double startSecondsthree = 155;
    const String videoIdfour = 'hDNiNdsPHNA';
    const double startSecondsfour = 93;
    const String videoIdfive = 'QICB_puGtYo';
    const double startSecondsfive = 1886;
