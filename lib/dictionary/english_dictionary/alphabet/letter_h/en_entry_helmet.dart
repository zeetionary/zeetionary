...
class EnglishEntryhelmet extends StatefulWidget {
  const EnglishEntryhelmet({super.key});

  @override
  State<EnglishEntryhelmet> createState() => _EnglishEntryhelmetState();
}

class _EnglishEntryhelmetState extends State<EnglishEntryhelmet> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: helmet (Derived forms: helmets)
1. Armour plate that protects the head
 
2. A protective headgear made of hard material to resist blows
""",
  );

  final String keyword = "helmet";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""A protective helmet should be worn at all times.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """helmet""",
                      // alsoEnglishWord: "also: helmet",
                      britshText: """IpaUK: /ˈhelmɪt/""",
                      americanText: """IpaUS: /ˈhelmɪt/""",
...
کوردی: کڵاوی پارستن، کڵاوزرێ، تاس‌کڵاو، خوود، خوودە، کووم‌زرخ
"""),
// With short examples define "helmet", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) جۆرە کڵاوێکی پتەو کە پۆلیس، سەرباز، پاسکیلسوارن، هتد لە سەری دەکەن بۆ پاراستنی سەریان"""),
                    SentencesRow(
                      englishText:
                          """A protective helmet should be worn at all times.""",
                      kurdishText:
                          """کڵاوێکی پارێزەر دەبێت هەمیشە لەسەر بکرێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Cycle helmets dramatically reduce the risk and severity of head injuries.""",
                      kurdishText:
                          """کڵاوەکانی پاسکیلسواری بە ئاستێکی زۆر مەترسی و توندی برینی سەر کەم دەکەنەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ZKbYaOiz5U4?t=';
const double _startSecondsend = 0000000000000000000000000004;
const String _videoIdone = 'https://youtu.be/3FbUpeH7SOw?t=';
const double _startSecondsone = 00000000000000000000000000074;
const String _videoIdtwo = 'https://youtu.be/HGpihHqBgM8?t=';
const double _startSecondstwo = 0000000000000000000000000005;
const String _videoIdthree = 'https://youtu.be/3qMqgU6hIv0?t=';
const double _startSecondsthree = 00000000000000000000000000061;
const String _videoIdfour = 'https://youtu.be/R6WsHO8CKrQ?t=';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/BgL_6jWNP2c?t=';
