...
// blank divider
  ...
  Future<void> speakconventions1(String languageCode) async {
    ...
    await flutterTts.speak(
        "// speakconventions111111111111111111111111111111111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakconventions2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakconventions200"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakconventions3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakconventions300"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakconventions4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakconventions400"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakconventions5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakconventions500"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakconventions6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakconventions600"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakconventions7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakconventions700"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakconventions8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakconventions800"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakconventions9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakconventions900"); // DOPSUM: CHANGE TEXT
  }
                                ...
                                child: Column(
                                  children: [
                                    ExampleSentenceEnglish(
                                        text:
                                            "// speakconventions111111111111111111111111111111111"),
...
speakconvention EnglishEntryconvention
WORD_WEB convention haʊʊʊʊʊʊʊ4
""",
  );
