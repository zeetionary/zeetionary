...
class EnglishEntryfrenzied extends StatefulWidget {
  const EnglishEntryfrenzied({super.key});

  @override
  State<EnglishEntryfrenzied> createState() => _EnglishEntryfrenziedState();
}

class _EnglishEntryfrenziedState extends State<EnglishEntryfrenzied> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: frenzied
1. Affected with or marked by frenzy or mania uncontrolled by reason (= manic)
"a frenzied attack"; "the prosecutor's frenzied denunciation of the accused";
 
2. Excessively agitated; distraught with fear or other violent emotion (= frantic, frenetic, phrenetic)
"a frenzied look in his eye";
""",
  );

  final String keyword = "frenzied";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frenzied""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was the subject of a frenzied attack.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frenzied""",
                      // alsoEnglishWord: "also: frenzied",
                      britshText: """IpaUK: /ˈfrenzid/""",
                      americanText: """IpaUS: /ˈfrenzid/""",
...
// With short examples define "frenzied", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کەوتە بەر پەلامارێکی سەرشێتانە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """As he arrived at the court, he was surrounded by frenzied fans.""",
                      kurdishText:
                          """کە گەشتە دادگا لەلایەن هەوادارە سەرشێتەکانەوە دەوردرا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/nlodY8nMw-A?t=';
const double _startSecondsend = 0000000000000000000000000005;
const String _videoIdone = 'https://youtu.be/Eupw-yTBkQI?t=';
const double _startSecondsone = 000000000000000000000000000568;
const String _videoIdtwo = 'https://youtu.be/QbhsMLD9Hb0?t=';
const double _startSecondstwo = 000000000000000000000000000639;
const String _videoIdthree = 'https://youtu.be/q43WY5XgSFY?t=';
const double _startSecondsthree = 000000000000000000000000000366;
const String _videoIdfour = 'https://youtu.be/TRGdQfoBWcY?t=';
const double _startSecondsfour = 000000000000000000000000000241;
const String _videoIdfive = 'https://youtu.be/MLv_9XNaM4U?t=';
