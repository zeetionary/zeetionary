...
class EnglishEntryhappening extends StatefulWidget {
  const EnglishEntryhappening({super.key});

  @override
  State<EnglishEntryhappening> createState() => _EnglishEntryhappeningState();
}

class _EnglishEntryhappeningState extends State<EnglishEntryhappening> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: happening (Derived forms: happenings)
1. An event that happens (- occurrence, occurrent, natural event)

- Adjective: happening
Usage: informal
1. Popular and considered appealing or fashionable at the time (- fashionable, in fashion, trendy [informal], sexy [informal])
""",
  );

  final String keyword = "happening";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""happening""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There have been strange happenings here lately.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Recent happenings on the stock market can be interpreted in various ways.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Ask Caroline - she knows all the happening clubs in town.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """happening""",
                      // alsoEnglishWord: "also: happening",
                      britshText: """IpaUK: /ˈhæpənɪŋ/""",
                      americanText: """IpaUS: /ˈhæpənɪŋ/""",
...
// With short examples define "happening", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """There have been strange happenings here lately.""",
                    ...
                    SentencesRow(
                      englishText: """Recent happenings on the stock market can be interpreted in various ways.""",
                      kurdishText: """ڕووداوە تازەکان لە بازاڕی بۆرسە دەکرێت بە چەند شێوەیەک لێکدانەوەیان بۆ بکرێت.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵناو) شوێنێکی خۆش و بەجۆشهێنەر"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Ask Caroline - she knows all the happening clubs in town.""",
                      kurdishText: """لە کارۆلین بپرسە ـ هەموو یانە خۆشەکانی شار دەزانێت.""",
