...
class EnglishEntryhalting extends StatefulWidget {
  const EnglishEntryhalting({super.key});

  @override
  State<EnglishEntryhalting> createState() => _EnglishEntryhaltingState();
}

class _EnglishEntryhaltingState extends State<EnglishEntryhalting> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: halting
1. Disabled in the feet or legs (- crippled, halt [archaic], lame, gimpy [N. Amer, informal], game [informal])
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""halting""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We carried on a halting conversation.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The driver spoke only very halting English.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """halting""",
                      // alsoEnglishWord: "also: halting",
                      britshText: """IpaUK: /ˈhɔːltɪŋ/,  /ˈhɒltɪŋ/""",
                      americanText: """IpaUS: /ˈhɔːltɪŋ/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """گفتوگۆیەکی پچڕپچڕمان کرد.""",
