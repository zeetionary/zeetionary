...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'gjySnrspD7E';
    const double startSecondsend = 1976;
    const String videoIdone = 'oiLdWXLXDeA';
    const double startSecondsone = 942;
    const String videoIdtwo = '7eM7pb5M5DU';
    const double startSecondstwo = 2013;
    const String videoIdthree = '90MNvA5ozcI';
    const double startSecondsthree = 456;
    const String videoIdfour = '4K-_KbbRiEE';
    const double startSecondsfour = 1168;
    const String videoIdfive = 'EmT0i0xG6zg';
    const double startSecondsfive = 3548;
