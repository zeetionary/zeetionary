...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'O8TvYQZEOvo';
    const double startSecondsend = 564;
    const String videoIdone = '2eF6z8_2D6g';
    const double startSecondsone = 467;
    const String videoIdtwo = 'A4wp42_nsEM';
    const double startSecondstwo = 331;
    const String videoIdthree = 'q8Qa6Vj-5ZU';
    const double startSecondsthree = 90;
    const String videoIdfour = 'UDunKQ0nyKU';
    const double startSecondsfour = 773;
    const String videoIdfive = 'F6Ytq2WyS6U';
