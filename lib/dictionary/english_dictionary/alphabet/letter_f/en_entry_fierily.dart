...
class EnglishEntryfierily extends StatefulWidget {
  const EnglishEntryfierily({super.key});

  @override
  State<EnglishEntryfierily> createState() => _EnglishEntryfierilyState();
}

class _EnglishEntryfierilyState extends State<EnglishEntryfierily> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: fierily
1. With passionate fervour (= fervently, fervidly)
"a fierily opinionated book";
""",
  );

  final String keyword = "fierily";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fierily""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The plant has distinctive, fierily red petals.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She glared at me fierily, not saying a word.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fierily""",
                      // alsoEnglishWord: "also: fierily",
                      britshText: """IpaUK: /ˈfaɪərili/""",
                      americanText: """IpaUS: /ˈfaɪərili/""",
...
// With short examples define "fierily", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The sauce is relatively mild at first taste, but then hits you fierily.""",
                      kurdishText:
                          """سۆسەکە سەرەتا کەمێک مام‌ناوەند  لە تامدا، بەڵام دواتر بە توونی کاریگەری دەبێت لێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە توندی لێی دەڕوانیم بەبێ گوتنی وشەیەک.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/cO_QDgq0dTQ?t=';
const double _startSecondsend = 000000000000000000000000000338;
const String _videoIdone = 'https://youtu.be/CUT1rLoM8Ik?t=';
const double _startSecondsone = 00000000000000000000000000014;
const String _videoIdtwo = 'https://youtu.be/KSv2xba96tM?t=';
const double _startSecondstwo = 00000000000000000000000000010135;
const String _videoIdthree = 'https://youtu.be/p9A4qP58et4?t=';
const double _startSecondsthree = 00000000000000000000000000010110;
const String _videoIdfour = 'https://youtu.be/HDfTtfiBAgk?t=';
const double _startSecondsfour = 000000000000000000000000000698;
const String _videoIdfive = 'https://youtu.be/W07PDdSVU2Y?t=';
