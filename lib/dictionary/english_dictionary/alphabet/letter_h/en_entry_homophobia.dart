...
class EnglishEntryhomophobia extends StatefulWidget {
  const EnglishEntryhomophobia({super.key});

  @override
  State<EnglishEntryhomophobia> createState() => _EnglishEntryhomophobiaState();
}

class _EnglishEntryhomophobiaState extends State<EnglishEntryhomophobia> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""homophobia""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Critics of the comedian accused him of homophobia and sexism.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/wv9G8d4tXhw?t=';
    const double startSecondsend = 000000000000000000000000000309;
    const String videoIdone = 'https://youtu.be/EmT0i0xG6zg?t=';
    const double startSecondsone = 0000000000000000000000000002922;
    const String videoIdtwo = 'https://youtu.be/29n2bv7F6uc?t=';
    const double startSecondstwo = 0000000000000000000000000001715;
    const String videoIdthree = 'https://youtu.be/F5EfFkTD0xc?t=';
    const double startSecondsthree = 0000000000000000000000000001813;
    const String videoIdfour = 'https://youtu.be/Kyyp5UmPeJE?t=';
    const double startSecondsfour = 0000000000000000000000000001178;
    const String videoIdfive = 'https://youtu.be/l4XS-T-r4S8?t=';
    const double startSecondsfive = 000000000000000000000000000850;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homophobia""",
                      // alsoEnglishWord: "also: homophobia",
                      britshText: """IpaUK: /ˌhəʊməˈfəʊbiə/, /ˌhɒməˈfəʊbiə/""",
                      americanText: """IpaUS: /ˌhəʊməˈfəʊbiə/""",
...
// With short examples define "homophobia", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Critics of the comedian accused him of homophobia and sexism.""",
                      kurdishText:
                          """ڕەخنەگرانی کۆمیدیانەکە تاوانباریان کرد بە هۆمۆفۆبیا و ڕەگەزپەرستی.""",
