...
class EnglishEntryextinguisher extends StatefulWidget {
  const EnglishEntryextinguisher({super.key});

  @override
  State<EnglishEntryextinguisher> createState() =>
      _EnglishEntryextinguisherState();
}

class _EnglishEntryextinguisherState extends State<EnglishEntryextinguisher> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extinguisher""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extinguisher""",
                      // alsoEnglishWord: "also: extinguisher",
                      britshText: """IpaUK: /ɪkˈstɪŋɡwɪʃə(r)/""",
                      americanText: """IpaUS: /ɪkˈstɪŋɡwɪʃər/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extinguisher";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He grabbed the extinguisher and sprayed it on the flames.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) شتێک کە کیمیایی تێدایە و بۆ کوژاندنەوەی ئاگر بەکاردێت"""),
          SentencesRow(
            englishText:
...
const double _startSecondsone = 0000000000000000000000000001872;
const String _videoIdtwo = 'https://youtu.be/f7QWMUCMYOE?t=';
...
const double _startSecondsfour = 0000000000000000000000000001050;
const String _videoIdfive = 'https://youtu.be/0yv6smozK9M?t=';
