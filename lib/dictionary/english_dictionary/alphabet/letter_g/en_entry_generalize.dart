...
class EnglishEntrygeneralize extends StatefulWidget {
  const EnglishEntrygeneralize({super.key});

  @override
  State<EnglishEntrygeneralize> createState() => _EnglishEntrygeneralizeState();
}

class _EnglishEntrygeneralizeState extends State<EnglishEntrygeneralize> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "generalize";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""generalize""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It would be foolish to generalize from a single example.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We cannot generalize from these few examples.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It is dangerous to generalize about the poor.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """generalize""",
                      // alsoEnglishWord: "also: generalize",
                      britshText: """IpaUK: /ˈdʒenrəlaɪz/""",
                      americanText: """IpaUS: /ˈdʒenrəlaɪz/""",
...
// With short examples define "generalize", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ناتوانین لەم کەمە نموونانەوە تێگەشتن درووست بکەین.""",
                    ...
                    SentencesRow(
                      englishText:
                          """These conclusions cannot be generalized to the whole country.""",
                      kurdishText:
                          """ئەنجامەکان ناکرێن بۆ تەواوی وڵاتەکە بخەمڵێندرێن.""",
...
const double _startSecondsone = 0000000000000000000000000001108;
...
const double _startSecondsthree = 0000000000000000000000000002148;
const String _videoIdfour = 'https://youtu.be/IBRBO7KkFTo?t=';
const double _startSecondsfour = 000000000000000000000000000175;
const String _videoIdfive = 'https://youtu.be/u8yL3I_6Oco?t=';
const double _startSecondsfive = 000000000000000000000000000904;
