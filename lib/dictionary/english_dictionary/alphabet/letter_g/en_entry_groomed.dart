...
class EnglishEntrygroomed extends StatefulWidget {
  const EnglishEntrygroomed({super.key});

  @override
  State<EnglishEntrygroomed> createState() => _EnglishEntrygroomedState();
}

class _EnglishEntrygroomedState extends State<EnglishEntrygroomed> {
  @override
  void initState() {
    super.initState();
...
"the manager was a beautifully groomed young man"; "his horse was always groomed"
""",
  );

  final String keyword = "groomed";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""groomed""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She is always perfectly groomed.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """groomed""",
                      // alsoEnglishWord: "also: groomed",
                      britshText: """IpaUK: /ɡruːmd/""",
                      americanText: """IpaUS: /ɡruːmd/""",
...
کوردی: ڕاهێنراو، پەروەردەکراو، ئامادە
"""),
// With short examples define "groomed", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) بۆ باسکردنی شێوازی چاودێری کەسێک لە جلوبەرگ و قژی"""),
                    SentencesRow(
                      englishText: """She is always perfectly groomed.""",
                      kurdishText: """هەمیشە بە تەواوی ڕێکخراوە.""",
                      englishNote:
                          """This means 'She is always well-maintained in appearance, with her hair, clothing, and overall look carefully cared for and polished.'""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/QlUQ0nRQ8oU?t=';
const double _startSecondsend = 000000000000000000000000000418;
const String _videoIdone = 'https://youtu.be/frPXtNrs_N4?t=';
const double _startSecondsone = 000000000000000000000000000282;
const String _videoIdtwo = 'https://youtu.be/Uly8iW-oowE?t=';
const double _startSecondstwo = 0000000000000000000000000001944;
const String _videoIdthree = 'https://youtu.be/_rpfiAbsv_w?t=';
const double _startSecondsthree = 00000000000000000000000000018;
const String _videoIdfour = 'https://youtu.be/ikGlrGtg22Y?t=';
const double _startSecondsfour = 000000000000000000000000000222;
const String _videoIdfive = 'https://youtu.be/nVY_hvAkmSY?t=';
const double _startSecondsfive = 000000000000000000000000000523;
