...
class EnglishEntryforgiveness extends StatefulWidget {
  const EnglishEntryforgiveness({super.key});

  @override
  State<EnglishEntryforgiveness> createState() =>
      _EnglishEntryforgivenessState();
}

class _EnglishEntryforgivenessState extends State<EnglishEntryforgiveness> {
  @override
  void initState() {
    super.initState();
...
2. The act of excusing a mistake or offence (= pardon)
""",
  );

  final String keyword = "forgiveness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forgiveness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He begged forgiveness for what he had done.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There can be no progress without forgiveness.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forgiveness""",
                      // alsoEnglishWord: "also: forgiveness",
                      britshText: """IpaUK: /fəˈɡɪvnəs/""",
                      americanText: """IpaUS: /fərˈɡɪvnəs/""",
...
// With short examples define "forgiveness", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پاڕایەوە بۆ لیخۆشىوون بۆ ئەوەی کردبووی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """There can be no progress without forgiveness.""",
                      kurdishText:
                          """هیچ بەرەوپێشچوونێک بەبێ لێخۆشبوون نابێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/fGMCjELDyUY?t=';
const double _startSecondsend = 0000000000000000000000000002521;
const String _videoIdone = 'https://youtu.be/YbNeOLbFZVg?t=';
const double _startSecondsone = 000000000000000000000000000972;
const String _videoIdtwo = 'https://youtu.be/VVsdb90aOmA?t=';
const double _startSecondstwo = 0000000000000000000000000002561;
const String _videoIdthree = 'https://youtu.be/wJa5Ch0O4BI?t=';
const double _startSecondsthree = 0000000000000000000000000001620;
const String _videoIdfour = 'https://youtu.be/tCqwT2MqLxI?t=';
const double _startSecondsfour = 0000000000000000000000000001349;
const String _videoIdfive = 'https://youtu.be/h8VHaNeuw3o?t=';
const double _startSecondsfive = 000000000000000000000000000795;
