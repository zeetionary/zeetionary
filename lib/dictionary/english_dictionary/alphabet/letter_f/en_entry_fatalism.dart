...
class EnglishEntryfatalism extends StatefulWidget {
  const EnglishEntryfatalism({super.key});

  @override
  State<EnglishEntryfatalism> createState() => _EnglishEntryfatalismState();
}

class _EnglishEntryfatalismState extends State<EnglishEntryfatalism> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fatalism""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fatalism""",
                      // alsoEnglishWord: "also: fatalism",
                      britshText: """IpaUK: /ˈfeɪtəlɪzəm/""",
                      americanText: """IpaUS: /ˈfeɪtəlɪzəm/""",
...
کوردی: چارەنووس‌گەری، چارەنووس‌باوەڕی، چارەنووس‌خوازی، پێش‌دیارباوەڕی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) باوەڕی ئەوەی شتەکان بە چارەنووس دیاری کراون و لە توانای گۆڕاندا نین"""),
          SentencesRow(
            englishText:
                """There is a mood of profound fatalism amongst party members.""",
            kurdishText:
                """هەستێکی باوەڕ بە چارەنووس هەیە لە نێوان ئەندامانی پارتەکە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fatalism (Derived forms: fatalisms)
...
const String _videoIdend = 'https://youtu.be/2_BTVN68-ZA?t=';
const double _startSecondsend = 000000000000000000000000000426;
const String _videoIdone = 'https://youtu.be/PyIyxeMXKeg?t=';
const double _startSecondsone = 000000000000000000000000000184;
const String _videoIdtwo = 'https://youtu.be/rLt-DvBKEJY?t=';
const double _startSecondstwo = 000000000000000000000000000492;
const String _videoIdthree = 'https://youtu.be/PHm2I9V4q2A?t=';
const double _startSecondsthree = 0000000000000000000000000001282;
const String _videoIdfour = 'https://youtu.be/JJGNA9lZYVU?t=';
const double _startSecondsfour = 000000000000000000000000000984;
const String _videoIdfive = 'https://youtu.be/27rhHfBugnc?t=';
const double _startSecondsfive = 000000000000000000000000000485;
