...
class EnglishEntryartificial extends StatelessWidget {
  ...
  Future<void> speakartificial(String languageCode) async {
    ...
    await flutterTts.speak("artificial");
  }
  ...
  Future<void> speakartificial910(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("A job interview is a very artificial situation.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "artificial"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌɑːtɪˈfɪʃl/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌɑːrtɪˈfɪʃl/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'Pls_q2aQzHg';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'JMLsHI8aV0g';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'b3D7QlMVa5s';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '3uV8XZcIBbk';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'KhZo6uAo_Ms';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'EsnHghKt810';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'i3iIKtpVmJQ';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'ThZ-VlH30Js';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'N4l5Li_xmnk';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'waisRS6MNmA';
  final double _startSeconds = 1;
