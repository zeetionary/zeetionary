...
class EnglishEntryindigestion extends StatefulWidget {
  const EnglishEntryindigestion({super.key});

  @override
  State<EnglishEntryindigestion> createState() =>
      _EnglishEntryindigestionState();
}

class _EnglishEntryindigestionState extends State<EnglishEntryindigestion> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: indigestion (Derived forms: indigestions)
1. A disorder of digestive function characterized by discomfort, heartburn or nausea (- dyspepsia, stomach upset, upset stomach)
""",
  );

  final String keyword = "indigestion";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indigestion""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Rich food always gives me indigestion.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/LbPw9AlVKVM?t=';
    ...
    const String videoIdtwo = 'https://youtu.be/JNpKUp5FTeY?t=';
    const double startSecondstwo = 000000000000000000000000000120;
    const String videoIdthree = 'https://youtu.be/eqQnJIx17io?t=';
    const double startSecondsthree = 00000000000000000000000000068;
    const String videoIdfour = 'https://youtu.be/IKd5LURFD0o?t=';
    const double startSecondsfour = 000000000000000000000000000254;
    const String videoIdfive = 'https://youtu.be/feHnfZ7Tsyc?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indigestion""",
                      // alsoEnglishWord: "also: indigestion",
                      britshText: """IpaUK: /ˌɪndɪˈdʒestʃən/""",
                      americanText: """IpaUS: /ˌɪndɪˈdʒestʃən/""",
...
کوردی: بەدهەرسی، گرفت، پیرومەر
"""),
// With short examples define "indigestion", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئازار کە درووست دەبێت لە کاتی هەرسکردنی خواردن"""),
                    const AlsoEnglishckb(word: "ھەروەھا: dyspepsia"),
                    SentencesRow(
                      englishText: """Rich food always gives me indigestion.""",
                      kurdishText:
                          """خواردنی دەوڵەمەند هەمیشە بەدهەرسیم پێدەدات.""",
