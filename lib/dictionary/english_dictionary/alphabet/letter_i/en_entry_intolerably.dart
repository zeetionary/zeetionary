...
class EnglishEntryintolerably extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intolerably""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'iPJFDhSgzFs';
    const double startSecondsend = 715;
    const String videoIdone = 's_1rIwVXAEI';
    const double startSecondsone = 831;
    const String videoIdtwo = 'N7mWHe-N_sw';
    const double startSecondstwo = 549;
    const String videoIdthree = 'fakLQiiwd54';
    const double startSecondsthree = 675;
    const String videoIdfour = 'OwB6FjpML98';
    const double startSecondsfour = 424;
    const String videoIdfive = 'mW9UH51S1uc';
    const double startSecondsfive = 2816;
