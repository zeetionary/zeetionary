...
class EnglishEntryharden extends StatefulWidget {
  const EnglishEntryharden({super.key});

  @override
  State<EnglishEntryharden> createState() => _EnglishEntryhardenState();
}

class _EnglishEntryhardenState extends State<EnglishEntryharden> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: harden (Derived forms: hardened, hardens, hardening)
1. Become hard or harder (- indurate)
"The wax hardened";
 
2. Make hard or harder (- indurate)
"The cold hardened the butter";
 
3. Harden by reheating and cooling in oil (- temper)
"harden steel";
 
4. Make healthy (- season)
"This trip will harden even the hardiest traveller";
 
5. Cause to accept or become hardened to; habituate (- inure, indurate, enure)
"He was hardened to the cold";
""",
  );

  final String keyword = "harden";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The mixture hardens as it cools.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Her face hardened into an expression of hatred.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He hardened his voice when he saw she wasn't listening.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Public attitudes to the strike have hardened.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Their suspicions hardened into certainty.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Joe sounded different, hardened by the war.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harden""",
                      // alsoEnglishWord: "also: harden",
                      britshText: """IpaUK: /ˈhɑːdn/""",
                      americanText: """IpaUS: /ˈhɑːrdn/""",
...
// With short examples define "harden", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """When the paint has hardened thoroughly, you can apply the next coat.""",
                      kurdishText:
                          """کە بۆیەکە تەواو وشکبووە، دەتوانیت چینێکی دیکەی لێبدەیت.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The mixture hardens as it cools.""",
                      kurdishText: """تێکەڵەکە ڕەق دەبێت کە سارد دەبێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕووخساری جدی بوویەوە بۆ دەربڕینی تووڕەیی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەنگی توند کرد کە بینی گوێ ناگرێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """گومانەکانیان جدی بوو بۆ دڵنیایی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """جۆو جیاواز دیاربوو، بەوەی بە جەنگەکە توندبووبوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """They were hardened criminals (= they showed no regret for their crimes).""",
                      kurdishText: """تاوانباری شێلگیر بوون.""",
