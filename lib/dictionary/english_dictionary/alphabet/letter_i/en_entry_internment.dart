...
class EnglishEntryinternment extends StatefulWidget {
  const EnglishEntryinternment({super.key});

  @override
  State<EnglishEntryinternment> createState() => _EnglishEntryinternmentState();
}

class _EnglishEntryinternmentState extends State<EnglishEntryinternment> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""internment""");
  }
