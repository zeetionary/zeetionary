...
class EnglishEntryheresy extends StatefulWidget {
  const EnglishEntryheresy({super.key});

  @override
  State<EnglishEntryheresy> createState() => _EnglishEntryheresyState();
}

class _EnglishEntryheresyState extends State<EnglishEntryheresy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heresy (Derived forms: heresies)
1. Any opinions or doctrines at variance with the official or orthodox position (- unorthodoxy, heterodoxy)
 
2. A belief that rejects the orthodox tenets of a religion (- unorthodoxy)
""",
  );

  final String keyword = "heresy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was burned at the stake for heresy.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The idea is heresy to most employees of the firm.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heresy""",
                      // alsoEnglishWord: "also: heresy",
                      britshText: """IpaUK: /ˈherəsi/""",
                      americanText: """IpaUS: /ˈherəsi/""",
...
کوردی: بیدعەت، لەدین‌لاداوان، لەئایین‌لادان، جیاباوەڕی، هەڵگەڕانەوە، بادانەوە، جیابیری، جودابیری
"""),
// With short examples define "heresy", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) هەبوونی باوەڕێک کە دژ بە ئایینێکە"""),
                    SentencesRow(
                      englishText: """He was burned at the stake for heresy.""",
                      kurdishText: """بە دار مەرگەکەوە سوتێندرا بۆ کفربازی.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) هەبوونی باوەڕێک کە لەگەڵ زۆرینە ناکۆکە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The idea is heresy to most employees of the firm.""",
                      kurdishText:
                          """ئەم بیرۆکەیە جیاباوەڕییە لای زۆرینەی کارمەندانی کۆمپانیاکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/qWNHsaszXpc?t=';
const double _startSecondsend = 000000000000000000000000000769;
const String _videoIdone = 'https://youtu.be/lhuUEYVYXfM?t=';
const double _startSecondsone = 000000000000000000000000000429;
const String _videoIdtwo = 'https://youtu.be/5ovm0nvdgbw?t=';
const double _startSecondstwo = 00000000000000000000000000079;
const String _videoIdthree = 'https://youtu.be/h_o-WCll7Fs?t=';
const double _startSecondsthree = 000000000000000000000000000751;
const String _videoIdfour = 'https://youtu.be/K4Ze-Sp6aUE?t=';
const double _startSecondsfour = 0000000000000000000000000007490;
const String _videoIdfive = 'https://youtu.be/lctv_pyT62o?t=';
const double _startSecondsfive = 000000000000000000000000000581;
