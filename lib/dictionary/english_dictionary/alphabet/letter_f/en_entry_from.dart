...
کوردی: لە، ژ،	لە ڕووی،	لە لایەن، لە کن، ژ ئالییێ، لەوەتای،	لەو دەمەی، ماوە بە...،	لە مەودای،	لەبەرامبەر، لە هەمبەر،	بەهۆی لەبەر، ژبەر، بەپێی، بە ڕەچاوکردنی، بە سەرنج‌دان بەو (شتە)
"""),
// With short examples define "from", please follow LX instructions
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ئامراز) بۆ ناوهێنانی بنەچەی کەسێک/شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بەڵگەنامەکان هی سەدەی شازدەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بیرۆکەکە هی کتێبێکی کۆنە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """نامەیەکی لە هاوڕێکەیەوە پێگەشت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەموو ڕۆژێک لە ٨ ـی بەیانی تاوەکو ٧ ـی ئێوارە کراوەین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """فرۆشگاکە هەموو شت دەفرۆشێت لە قەیتانەوە بۆ کۆمپیوتەر.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پارتەکە لە دەسەڵات دەرکرا لە دوای هەژدە ساڵ.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """١٣. (ئامراز) بۆ پیشاندانی هۆکاری شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She felt sick from tiredness.""",
                      kurdishText: """لە ماندوێتیدا هەستی بە نەخۆشی کرد.""",
                      onPressedBritish: () => speaksentence26("en-GB"),
                      onPressedAmerican: () => speaksentence26("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """١٤. (ئامراز) بۆ پیشاندانی هۆکاری بڕیارێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
...
const double _startSecondsone = 000000000000000000000000000726;
const String _videoIdtwo = 'https://youtu.be/gFuEoxh5hd4?t=';
