...
class EnglishEntryfrogman extends StatefulWidget {
  const EnglishEntryfrogman({super.key});

  @override
  State<EnglishEntryfrogman> createState() => _EnglishEntryfrogmanState();
}

class _EnglishEntryfrogmanState extends State<EnglishEntryfrogman> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frogman (Derived forms: frogmen)
1. Someone who works underwater (= diver, underwater diver)
""",
  );

  final String keyword = "frogman";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frogman""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Police frogmen searched the lake for the murder weapon.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frogman""",
                      // alsoEnglishWord: "also: frogman",
                      britshText: """IpaUK: /ˈfrɒɡmən/""",
                      americanText: """IpaUS: /ˈfrɑːɡmən/""",
...
// With short examples define "frogman", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە لەژێر ئاودا کار دەکات و جلێکی لاستیکی و بۆقەپێ و کەرەستەی تایبەت بۆ هەناسەدان بەکار دەهێنێت"""),
                    SentencesRow(
                      englishText:
                          """Police frogmen searched the lake for the murder weapon.""",
                      kurdishText:
                          """مەلەوانی پۆلیس بە دەریاچەکەدا گەڕان بۆ چەکی کوشتنەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/WGp-4-owh9A?t=';
const double _startSecondsend = 0000000000000000000000000001544;
const String _videoIdone = 'https://youtu.be/QlTf5X0MKbg?t=';
const double _startSecondsone = 0000000000000000000000000001068;
const String _videoIdtwo = 'https://youtu.be/qrUMEXGavLI?t=';
const double _startSecondstwo = 00000000000000000000000000071;
const String _videoIdthree = 'https://youtu.be/74JqZ2JgEPg?t=';
const double _startSecondsthree = 00000000000000000000000000035;
const String _videoIdfour = 'https://youtu.be/w6y8jptPaR0?t=';
const double _startSecondsfour = 000000000000000000000000000365;
const String _videoIdfive = 'https://youtu.be/aaUfajPVgNk?t=';
const double _startSecondsfive = 000000000000000000000000000306;
