...
class EnglishEntryfin extends StatefulWidget {
  const EnglishEntryfin({super.key});

  @override
  State<EnglishEntryfin> createState() => _EnglishEntryfinState();
}

class _EnglishEntryfinState extends State<EnglishEntryfin> {
  @override
  void initState() {
    super.initState();
...
3. One of a set of parallel slats in a door or window to admit air and reject rain (= louver [US], louvre)
 
4. A shoe for swimming; the paddle-like front is an aid in swimming (especially underwater) (= flipper)
...
3. Show the fins above the water while swimming (= break water)
"The sharks were finning near the surface";
""",
  );

  final String keyword = "fin";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The aircraft has a long tail fin.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fin""",
                      // alsoEnglishWord: "also: fin",
                      britshText: """IpaUK: /fɪn/""",
                      americanText: """IpaUS: /fɪn/""",
...
// With short examples define "fin", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """We could see the fin of a shark as it slowly circled our boat.""",
                      kurdishText:
                          """باڵی قرشێکمان دەبینی کە بە دەوری بەلەمەکەمان دەسووڕایەوە.""",
...
const double _startSecondsend = 000000000000000000000000000204;
const String _videoIdone = 'https://youtu.be/rSvBFm_MuXw?t=';
const double _startSecondsone = 00000000000000000000000000026;
const String _videoIdtwo = 'https://youtu.be/cAfYtXB-qN4?t=';
const double _startSecondstwo = 0000000000000000000000000001548;
const String _videoIdthree = 'https://youtu.be/3aG3WroJHlk?t=';
const double _startSecondsthree = 000000000000000000000000000312;
const String _videoIdfour = 'https://youtu.be/ZzdV_HM95RQ?t=';
const double _startSecondsfour = 000000000000000000000000000392;
const String _videoIdfive = 'https://youtu.be/ZQvfHyfgBtA?t=';
