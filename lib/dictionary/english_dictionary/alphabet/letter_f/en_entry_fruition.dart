...
class EnglishEntryfruition extends StatefulWidget {
  const EnglishEntryfruition({super.key});

  @override
  State<EnglishEntryfruition> createState() => _EnglishEntryfruitionState();
}

class _EnglishEntryfruitionState extends State<EnglishEntryfruition> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fruition (Derived forms: fruitions)
1. The condition of bearing fruit
 
2. Enjoyment derived from use or possession
 
3. Something that is made real or concrete (= realization, realisation [Brit])
""",
  );

  final String keyword = "fruition";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fruition""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Their efforts came to fruition many years later.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fruition""",
                      // alsoEnglishWord: "also: fruition",
                      britshText: """IpaUK: /fruˈɪʃn/""",
                      americanText: """IpaUS: /fruˈɪʃn/""",
...
کوردی: ئەنجام، ئاکام، پێئاژۆ، بەرگرتن، بەرهێنەری، پڕبەری، بەرهێنان،	جێبەجێ‌بوون، بەدی‌هاتن
"""),
// With short examples define "fruition", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """After months of hard work, our plans finally came to fruition.""",
                      kurdishText:
                          """لە دوای چەندین مانگ لە کاری سەخت، پلانەکانمان گەشتن بە ئەنجام.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەوڵەکانیان لە دوای چەندین ساڵ گەشتن بە ئەنجام.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/b4wRdoWpw0w?t=';
const double _startSecondsend = 000000000000000000000000000510;
const String _videoIdone = 'https://youtu.be/cTozcxvFDtM?t=';
const double _startSecondsone = 000000000000000000000000000182;
const String _videoIdtwo = 'https://youtu.be/FCZ06Sfr9Cg?t=';
const double _startSecondstwo = 000000000000000000000000000699;
const String _videoIdthree = 'https://youtu.be/E2rtQFAibEA?t=';
const double _startSecondsthree = 0000000000000000000000000004739;
const String _videoIdfour = 'https://youtu.be/i9InAbpM7mU?t=';
const double _startSecondsfour = 000000000000000000000000000378;
const String _videoIdfive = 'https://youtu.be/QWY6osJ4eJI?t=';
const double _startSecondsfive = 000000000000000000000000000302;
