...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'Qm4cAaAFhEs';
    const double startSecondsend = 512;
    const String videoIdone = 'vpArBufV1xg';
    const double startSecondsone = 703;
    const String videoIdtwo = 'GkXnc1JxrQM';
    const double startSecondstwo = 1093;
    const String videoIdthree = '5bTsUJJJapM';
    const double startSecondsthree = 0;
    const String videoIdfour = 'MK1gCx6J3kg';
    const double startSecondsfour = 21;
    const String videoIdfive = 'In4yord4gGU';
    const double startSecondsfive = 1570;
