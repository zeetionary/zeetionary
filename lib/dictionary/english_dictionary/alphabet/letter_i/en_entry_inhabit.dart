...
class EnglishEntryinhabit extends StatefulWidget {
  const EnglishEntryinhabit({super.key});

  @override
  State<EnglishEntryinhabit> createState() => _EnglishEntryinhabitState();
}

class _EnglishEntryinhabitState extends State<EnglishEntryinhabit> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inhabit""");
  }
