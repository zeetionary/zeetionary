...
class EnglishEntryimplicitly extends StatefulWidget {
  const EnglishEntryimplicitly({super.key});

  @override
  State<EnglishEntryimplicitly> createState() => _EnglishEntryimplicitlyState();
}

class _EnglishEntryimplicitlyState extends State<EnglishEntryimplicitly> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "implicitly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""implicitly""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I trust John implicitly.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/kBdfcR-8hEY?t=';
    const double startSecondsend = 0000000000000000000000000003027;
    const String videoIdone = 'https://youtu.be/OgFcz6klaeg?t=';
    const double startSecondsone = 0000000000000000000000000001036;
    const String videoIdtwo = 'https://youtu.be/Q8-ujJWxP9Y?t=';
    const double startSecondstwo = 000000000000000000000000000873;
    ...
    const String videoIdfive = 'https://youtu.be/mtDOr9UY-yk?t=';
    const double startSecondsfive = 0000000000000000000000000009264;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """implicitly""",
                      // alsoEnglishWord: "also: implicitly",
                      britshText: """IpaUK: /ɪmˈplɪsɪtli/""",
                      americanText: """IpaUS: /ɪmˈplɪsɪtli/""",
...
کوردی: ناڕاستەوخۆیانە،	بێ‌ئەملاوئەولا
"""),
// With short examples define "implicitly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە ئاماژەی پێکراوە بەبێ ئەوەی بە ڕاستەوخۆیی گوترابێت"""),
                    SentencesRow(
                      englishText:
                          """It reinforces, implicitly or explicitly, the idea that money is all-important.""",
                      kurdishText:
                          """ئەوە با ناڕاستەوخۆیانە یان ئاشکرایانە ئەو بیرۆکە بەهێز دەکات کە پارە هەموو شت گرنگترینە.""",
                      englishNote:
                          """This means that it either subtly or openly strengthens the belief that money holds the highest value or is the most crucial thing in life. Whether stated clearly or suggested indirectly, the message being conveyed is that money takes priority over other aspects.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بە شێوەیەک کە بە تەواوی و بەبێ گومانە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: absolutely"),
                    SentencesRow(
                      englishText: """I trust John implicitly.""",
                      kurdishText: """بێ‌ئەملاوئەولا متمانەم بە جۆنە.""",
