...
class EnglishEntryglider extends StatefulWidget {
  const EnglishEntryglider({super.key});

  @override
  State<EnglishEntryglider> createState() => _EnglishEntrygliderState();
}

class _EnglishEntrygliderState extends State<EnglishEntryglider> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""A glider flew above the beach.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glider""",
                      // alsoEnglishWord: "also: glider",
                      britshText: """IpaUK: /ˈɡlaɪdə(r)/""",
                      americanText: """IpaUS: /ˈɡlaɪdər/""",
...
کوردی: فڕۆکەی بێ‌بزوێنە یا بێ‌مۆتۆڕ، فڕۆکەی چارۆکەدار، خزۆکە
"""),
// With short examples define "glider", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) فڕۆکەیەکی سووک کە بە بێ بزوێنەر دەفڕێت"""),
                    SentencesRow(
                      englishText: """A glider flew above the beach.""",
                      kurdishText: """خزۆکەیەک بە سەرەوە تێپەڕی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/t93UCj1hzu8?t=';
const double _startSecondsend = 0000000000000000000000000001190;
const String _videoIdone = 'https://youtu.be/xCX5evgP-5E?t=';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/mUy7TenHKoQ?t=';
const double _startSecondstwo = 000000000000000000000000000164;
const String _videoIdthree = 'https://youtu.be/fJ0CyHNEOrE?t=';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/c_MCDoRKLjg';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/PAX7m6PApH4?t=';
const double _startSecondsfive = 000000000000000000000000000214;
