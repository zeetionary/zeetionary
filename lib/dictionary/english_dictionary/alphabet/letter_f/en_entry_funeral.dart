...
class EnglishEntryfuneral extends StatefulWidget {
  const EnglishEntryfuneral({super.key});

  @override
  State<EnglishEntryfuneral> createState() => _EnglishEntryfuneralState();
}

class _EnglishEntryfuneralState extends State<EnglishEntryfuneral> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: funeral (Derived forms: funerals)
1. A ceremony at which a dead person is buried or cremated (- obsequy)
"hundreds of people attended his funeral";
""",
  );

  final String keyword = "funeral";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""funeral""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He read out a poem at her funeral.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The dead man's son arranged the funeral.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """funeral""",
                      // alsoEnglishWord: "also: funeral",
                      britshText: """IpaUK: /ˈfjuːnərəl/""",
                      americanText: """IpaUS: /ˈfjuːnərəl/""",
...
کوردی: ڕێ‌وڕەسمی ناشتن، ئاهەنگی بەخاک‌سپاردن،	ئاهەنگی سووتاندنی مردوو، تەرم‌سووتان،	تەرم‌نێژان
"""),
// With short examples define "funeral", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """He read out a poem at her funeral.""",
                      kurdishText:
                          """هۆنراوەیەکی لە مەراسیمی ناشتنەکەی خوێندەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کوڕی پیاوە مردووەکە مەراسیمی ناشتنەکەی ڕێکخست.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/sV6uuMAnJUE?t=';
const double _startSecondsend = 0000000000000000000000000001248;
const String _videoIdone = 'https://youtu.be/BxWw8AO4ZmI?t=';
const double _startSecondsone = 000000000000000000000000000420;
const String _videoIdtwo = 'https://youtu.be/b1reY72ktEc?t=';
const double _startSecondstwo = 0000000000000000000000000001374;
const String _videoIdthree = 'https://youtu.be/Pon4Zux5MaQ?t=';
const double _startSecondsthree = 0000000000000000000000000004;
const String _videoIdfour = 'https://youtu.be/Ru7PWYXMQ8E?t=';
const double _startSecondsfour = 0000000000000000000000000001415;
const String _videoIdfive = 'https://youtu.be/27uHlm_0TQs';
