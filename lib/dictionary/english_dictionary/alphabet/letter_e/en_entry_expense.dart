...
class EnglishEntryexpense extends StatefulWidget {
  const EnglishEntryexpense({super.key});

  @override
  State<EnglishEntryexpense> createState() => _EnglishEntryexpenseState();
}

class _EnglishEntryexpenseState extends State<EnglishEntryexpense> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""expense""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """expense""",
                      // alsoEnglishWord: "also: expense",
                      britshText: """IpaUK: /ɪkˈspens/""",
                      americanText: """IpaUS: /ɪkˈspens/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The results are well worth the expense.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Running a car is a big expense.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The real expense of the trip was the flights.""");
  }
...
"""),
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The results are well worth the expense.""",
            kurdishText: """یەنجامەکان تەواو شایەنی تێچووەکەن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The real expense of the trip was the flights.""",
            kurdishText: """خەرجی ڕاستی گەشتەکە فڕینەکان بوون.""",
          ...
          SentencesRow(
            ...
            kurdishText: """خەرجییەکانمان پێدان و هیچی زیاتر.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: expense (Derived forms: expenses)
1. Amounts paid for goods and services that may be currently tax deductible (as opposed to capital expenditures) (= disbursal, disbursement)
...
- Verb: expense (Derived forms: expenses, expensed, expensing)
1. Reduce the estimated value of something (= write off, write down)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/043CQXHfx10?t=';
const double _startSecondsend = 000000000000000000000000000000; // 772;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/iqhK6QGehtQ?t=';
const double _startSecondsone = 00000000000000000000000000000; // 739;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/IgF3OX8nT0w?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 873;
const String _videoIdthree = 'VIDEOhttps://youtu.be/lDeFSOUHdH4?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1064;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/2xfh02FCrd4?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 610;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/bXqZllqGWGQ?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 733;
