...
class EnglishEntryflock extends StatefulWidget {
  const EnglishEntryflock({super.key});

  @override
  State<EnglishEntryflock> createState() => _EnglishEntryflockState();
}

class _EnglishEntryflockState extends State<EnglishEntryflock> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flock (Derived forms: flocks)
1. A church congregation guided by a pastor
 
2. A group of birds
 
3. (often followed by 'of') a large number, amount or extent (= batch, deal, good deal, great deal, hatful, heap, lot, mass, mess, mickle [archaic], mint, mountain, muckle, passel [US], peck, pile [informal], plenty, pot, quite a little, raft, sight, slew, spate, stack, tidy sum, wad, bunch [informal])
"a flock of letters";
 
4. An orderly crowd (= troop)
"a flock of children";
 
5. A group of sheep or goats (= fold)
 
6. Coarse tufts of wool or cotton used in bedding

- Verb: flock (Derived forms: flocked, flocking, flocks)
1. Move as a crowd or in a group
"Tourists flocked to the shrine where the statue was said to have shed tears"
 
2. Come together as in a cluster or flock (= cluster, constellate, clump)
""",
  );

  final String keyword = "flock";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He looks after a flock of 500 sheep.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""These birds fly in huge flocks.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They came in flocks to see the festival.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.speak(
        """The priest invited all the members of his flock to attend the special service.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Thousands of people flocked to the beach this weekend.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""People flocked to hear him speak.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flock""",
                      // alsoEnglishWord: "also: flock",
                      britshText: """IpaUK: /flɒk/""",
                      americanText: """IpaUS: /flɑːk/""",
...
// With short examples define "flock", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) گرووپێک لە مەڕ، بزن، یان باڵندەی هەمان جۆر"""),
                    SentencesRow(
                      englishText: """He looks after a flock of 500 sheep.""",
                      kurdishText: """چاودێری ڕانێکی ٥٠٠ مێیی دەکات.""",
                    ...
                    SentencesRow(
                      englishText: """These birds fly in huge flocks.""",
                      kurdishText: """باڵندەکان بە دەستەی گەورە دەفڕن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بە کۆمەڵ هاتن بۆ بینینی فێستیڤاڵەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """قەشەکە تەواوی پەیڕەوانی خۆی بانگکرد بۆ بەژداری لە بۆنە تایبەتەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەزاران لەس ئەم کۆتایی هەفتە ڕژانە کەناراوەکان.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """People flocked to hear him speak.""",
                      kurdishText: """خەڵک بە کۆمەڵ هاتن بۆ گوێگرتن لێی.""",
...
const double _startSecondsend = 000000000000000000000000000712;
...
const double _startSecondstwo = 000000000000000000000000000564;
const String _videoIdthree = 'https://youtu.be/HiWXeWQAsUE?t=';
const double _startSecondsthree = 000000000000000000000000000382;
const String _videoIdfour = 'https://youtu.be/twAP3buj9Og?t=';
const double _startSecondsfour = 000000000000000000000000000187;
