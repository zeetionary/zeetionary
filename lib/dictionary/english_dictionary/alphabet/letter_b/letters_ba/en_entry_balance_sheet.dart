...
// blank divider
  ...
  Future<void> speakBalancesheets7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBalancesheets77"); // DOPSUM: CHANGE TEXT
  }
                        ...
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˈbæləns ʃiːt/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "L_Guz73e6fw?t=";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "kJVj3vp-lho?t=";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "k84bDit_wts?t=";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "EH6vE97qIP4?t=";

  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 3485, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
      autoPlay: true,
      enableCaption: true,
      loop: true,
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "5jjdErDkDZE?t=";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "ZcfitxiEJU8?t=";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "T1x_knZmZAk?t=";

  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 8563, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
      autoPlay: true,
      enableCaption: true,
      loop: true,
