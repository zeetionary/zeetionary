...
// Define the word "ashore" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryashore - replace speakAshore

// replace ashore - /əˈʃɔː(r)/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryashore extends StatelessWidget {
  // blank divider
  EnglishEntryashore({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "ashore"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈʃɔː(r)/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈʃɔːr/"),
...
2. (nautical) on the land as opposed to onboard
""",
  );
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'ZdZ3pTaSB1I';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'lt15NAl7R2k';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'vc90NQpY_4s';
