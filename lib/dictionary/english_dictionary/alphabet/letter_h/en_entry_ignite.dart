...
class EnglishEntryignite extends StatefulWidget {
  const EnglishEntryignite({super.key});

  @override
  State<EnglishEntryignite> createState() => _EnglishEntryigniteState();
}

class _EnglishEntryigniteState extends State<EnglishEntryignite> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: ignite (Derived forms: igniting, ignited, ignites)
1. Cause to start burning; subject to fire or great heat (- light)
"Great heat can ignite almost any dry matter";
 
2. Start to burn or burst into flames (- erupt, catch fire, take fire, combust, conflagrate)
"Marsh gases ignited suddenly";
 
3. Arouse or excite feelings and passions (- inflame, stir up, wake, heat, fire up)
"The ostentatious way of living of the rich ignites the hatred of the poor";
 
4. Start or maintain a fire in (- fire, light)
""",
  );

  final String keyword = "ignite";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Gas ignites very easily.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000003289;
    const String videoIdone = 'https://youtu.be/-BeTq99LqUo?t=';
    const double startSecondsone = 000000000000000000000000000548;
    const String videoIdtwo = 'https://youtu.be/ZQvfHyfgBtA?t=';
    const double startSecondstwo = 00000000000000000000000000051;
    const String videoIdthree = 'https://youtu.be/JX82wa5HkJg?t=';
    const double startSecondsthree = 000000000000000000000000000265;
    const String videoIdfour = 'https://youtu.be/uQtw2_7oXV0?t=';
    const double startSecondsfour = 000000000000000000000000000797;
    const String videoIdfive = 'https://youtu.be/yUYxk-y-tU8?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ignite""",
                      // alsoEnglishWord: "also: ignite",
                      britshText: """IpaUK: /ɪɡˈnaɪt/""",
                      americanText: """IpaUS: /ɪɡˈnaɪt/""",
...
کوردی: 
"""),
// With short examples define "ignite", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) دەستکردن بە سووتان"""),
                    SentencesRow(
                      englishText: """Gas ignites very easily.""",
                      kurdishText: """گاز بە ئاسانی دەسووتێت.""",
