...
// Define the word "auditorium" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace auditorium - replace EnglishEntryauditorium

// replace speakAuditorium - /ˌɔːdɪˈtɔːriəm/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryauditorium extends StatelessWidget {
  // blank divider
  EnglishEntryauditorium({super.key});
  // blank divider
  ...
  Future<void> speakauditorium(String languageCode) async {
    ...
    await flutterTts.speak("auditorium");
  }
  ...
  Future<void> speakauditorium252(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The auditorium seats over a thousand people.");
  }
  ...
  Future<void> speakauditorium255(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He stood at the back of the packed auditorium.");
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "auditorium"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
...
1. The area of a theatre or concert hall where the audience sits
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'BVQSr8NpjrU';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'xS4FAZ2Oyl0';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'kJ96dvMfkrE';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'M39dAasRNPI';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'jNz4Bl87Xs8';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'GlL1P6gMEz0';
