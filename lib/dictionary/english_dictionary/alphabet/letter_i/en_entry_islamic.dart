...
class EnglishEntryislamic extends StatefulWidget {
  const EnglishEntryislamic({super.key});

  @override
  State<EnglishEntryislamic> createState() => _EnglishEntryislamicState();
}

class _EnglishEntryislamicState extends State<EnglishEntryislamic> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Islamic""");
  }
