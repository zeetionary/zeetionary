...
class EnglishEntryflab extends StatefulWidget {
  const EnglishEntryflab({super.key});

  @override
  State<EnglishEntryflab> createState() => _EnglishEntryflabState();
}

class _EnglishEntryflabState extends State<EnglishEntryflab> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flab (Derived forms: flabs)
1. Loose or flaccid body fat
""",
  );

  final String keyword = "flab";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Fight the flab with exercise!""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flab""",
                      // alsoEnglishWord: "also: flab",
                      britshText: """IpaUK: /flæb/""",
                      americanText: """IpaUS: /flæb/""",
...
کوردی: 
"""),
// With short examples define "flab", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) چەوری نەرم و شل کە جەستەی کەسێک دادەپۆشێت"""),
                    SentencesRow(
                      englishText: """Fight the flab with exercise!""",
                      kurdishText: """بە ڕاهێنان دژی بەز بوەستە!""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/vgK51uFNOZY?t=';
const double _startSecondsend = 00000000000000000000000000044;
const String _videoIdone = 'https://youtu.be/crY-q80MfJU?t=';
const double _startSecondsone = 000000000000000000000000000261;
const String _videoIdtwo = 'https://youtu.be/XrSCqbD-ivE';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/7kLdsHyp6Yo?t=';
const double _startSecondsthree = 00000000000000000000000000010;
const String _videoIdfour = 'https://youtu.be/j2D4BelPffU?t=';
const double _startSecondsfour = 000000000000000000000000000135;
const String _videoIdfive = 'https://youtu.be/AqeGVt4AJo8?t=';
const double _startSecondsfive = 0000000000000000000000000001304;
