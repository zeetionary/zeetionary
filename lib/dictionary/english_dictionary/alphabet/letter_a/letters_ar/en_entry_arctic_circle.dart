...
class EnglishEntryarcticcircle extends StatelessWidget {
  ...
  Future<void> speakarcticcircle(String languageCode) async {
    ...
    await flutterTts.speak("the Arctic Circle");
  }
  ...
  Future<void> speakarcticcircle505(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Soviet Union tests atomic bomb in Arctic Circle.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "the Arctic Circle"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUK: /ði ˌɑːktɪk ˈsɜːkl/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUS: /ði ˌɑːrktɪk ˈsɜːrkl/"),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'jLPBJ5EwV2I';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'I0SAQ-76C3Q';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'JUtAra3pFGs';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 's97V9w-9Jao';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '06V20tiHSAE';
