...
class EnglishEntryforest extends StatefulWidget {
  const EnglishEntryforest({super.key});

  @override
  State<EnglishEntryforest> createState() => _EnglishEntryforestState();
}

class _EnglishEntryforestState extends State<EnglishEntryforest> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forest (Derived forms: forests)
1. The trees and other plants in a large densely wooded area (= wood, woods)
 
2. Land that is covered with trees and shrubs (= woodland, timberland [N. Amer], timber, forestry, forestland [N. Amer])
 
3. Any dense collection or large number of things
"During term time you will amass a small forest of papers and notes"

- Verb: forest (Derived forms: forested, foresting, forests)
1. Establish a forest on previously unforested land (= afforest)
"forest the mountains";
""",
  );

  final String keyword = "forest";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""One careless match can start a forest fire.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Thousands of hectares of forest are destroyed each year.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Forest is being cleared to make way for new farming land.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Much of Europe was once covered in forest.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They got lost in the forest.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He warned her never to enter the forest at night.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forest""",
                      // alsoEnglishWord: "also: forest",
                      britshText: """IpaUK: /ˈfɒrɪst/""",
                      americanText: """IpaUS: /ˈfɔːrɪst/""",
...
// With short examples define "forest", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """یەک شقارتەی هەڵەشە دەکرێت ئاگرێکی دارستان هەڵبگیرسێنێت.""",
                    ...
                    SentencesRow(
                      englishText: """Thousands of hectares of forest are destroyed each year.""",
                      kurdishText: """هەزاران هێکتار لە دارستان هەموو ساڵێک لەناودەبرێن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Forest is being cleared to make way for new farming land.""",
                      kurdishText: """دارستان لەناودەبردرێت بۆ درووستکردنی جێگا بۆ زەوی جوتیاری.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Much of Europe was once covered in forest.""",
                      kurdishText: """زۆرینەی ئەورووپا جاران بە دارستان داپۆشرابوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They got lost in the forest.""",
                      kurdishText: """لە دارستانەکە ونبوون.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He warned her never to enter the forest at night.""",
                      kurdishText: """ئاگاداری کردەوە هەرگیز لە شەودا نەچێتە دارستانەکە.""",
...
const double _startSecondsend = 000000000000000000000000000820;
...
const String _videoIdfour = 'https://youtu.be/4U-u4CsnygA?t=';
const double _startSecondsfour = 00000000000000000000000000043;
const String _videoIdfive = 'https://youtu.be/y1V1Am0koSA?t=';
const double _startSecondsfive = 000000000000000000000000000698;
