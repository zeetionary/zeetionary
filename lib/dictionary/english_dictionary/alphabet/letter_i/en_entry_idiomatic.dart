...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '41phB_nAA_8';
    const double startSecondsend = 585;
    const String videoIdone = 'TE8xg3d8dBg';
    const double startSecondsone = 252;
    const String videoIdtwo = 'iQ-j824f5vc';
    const double startSecondstwo = 32;
    const String videoIdthree = 'huAuiHXJCPY';
    const double startSecondsthree = 618;
    const String videoIdfour = 'ssBX_l5AH8k';
    const double startSecondsfour = 456;
    const String videoIdfive = 'DcR-KahoGag';
