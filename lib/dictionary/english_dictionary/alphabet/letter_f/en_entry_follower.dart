...
class EnglishEntryfollower extends StatefulWidget {
  const EnglishEntryfollower({super.key});

  @override
  State<EnglishEntryfollower> createState() => _EnglishEntryfollowerState();
}

class _EnglishEntryfollowerState extends State<EnglishEntryfollower> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: follower (Derived forms: followers)
1. A person who accepts the leadership of another (= acolyte)
 
2. Someone who travels behind or pursues another
""",
  );

  final String keyword = "follower";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""follower""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She still has many loyal followers.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He is often referred to as a follower of Darwin.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She is a leader, not a follower.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She has over 100,000 followers on Instagram.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """follower""",
                      // alsoEnglishWord: "also: follower",
                      britshText: """IpaUK: /ˈfɒləʊə(r)/""",
                      americanText: """IpaUS: /ˈfɑːləʊər/""",
...
// With short examples define "follower", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """She still has many loyal followers.""",
                      kurdishText: """هێشتا زۆر شوێنکەوتووی وەفاداری هەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆرجار وەک شوێنکەوتووی داروین دادەنرێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) کەسێک کە حەزی بە چالاکییەکی دیاریکراو هەیە و ئاگای لە هەموو هەواڵێک هەیە لەسەری"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """This book is only for the dedicated follower of modernist architecture.""",
                      kurdishText:
                          """ئەم کتێبە تەنها بۆ شوێنکەوتووانی خۆبەستەی تەلارسازیی سەردەمە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سەروو ١٠٠٠٠٠ شوێنکەتووی لە ئینستاگرام هەیە.""",
...
const double _startSecondsend = 000000000000000000000000000299;
const String _videoIdone = 'https://youtu.be/_wNsZEqpKUA?t=';
const double _startSecondsone = 00000000000000000000000000040;
const String _videoIdtwo = 'https://youtu.be/_GFkHA5EZdE?t=';
const double _startSecondstwo = 00000000000000000000000000066;
const String _videoIdthree = 'https://youtu.be/MGO4_8YRKro?t=';
const double _startSecondsthree = 000000000000000000000000000213;
const String _videoIdfour = 'https://youtu.be/lex6USTugUU?t=';
const double _startSecondsfour = 0000000000000000000000000001093;
const String _videoIdfive = 'https://youtu.be/mAxvK2aGtQU';
