...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/NCLZi2Rn_ug?t=';
    const double startSecondsend = 00000000000000000000000000067;
    const String videoIdone = 'https://youtu.be/FgT3GCsJteA?t=';
    const double startSecondsone = 000000000000000000000000000203;
    const String videoIdtwo = 'https://youtu.be/Vap9SMRf8YE?t=';
    const double startSecondstwo = 00000000000000000000000000021;
    const String videoIdthree = 'https://youtu.be/QytntXWJIe8?t=';
    const double startSecondsthree = 000000000000000000000000000242;
    const String videoIdfour = 'https://youtu.be/OIo2Ie1HwHY?t=';
    const double startSecondsfour = 0000000000000000000000000001656;
    const String videoIdfive = 'https://youtu.be/nyVOi3X53bk?t=';
