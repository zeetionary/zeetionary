...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'N9x_Ycv3Nns';
    const double startSecondsend = 152;
    const String videoIdone = '20LdNzARkk4';
    const double startSecondsone = 269;
    const String videoIdtwo = 'ZipvszPdzB0';
    const double startSecondstwo = 82;
    const String videoIdthree = 'MfHXXV45EjE';
    const double startSecondsthree = 403;
    const String videoIdfour = 'pnLwRk3xgrE';
    const double startSecondsfour = 63;
    const String videoIdfive = '2i8jqG6Hx0M';
