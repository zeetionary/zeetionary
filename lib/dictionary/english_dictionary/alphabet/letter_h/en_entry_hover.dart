...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/SOeAThye5rQ?t=';
    const double startSecondsone = 000000000000000000000000000162;
    const String videoIdtwo = 'https://youtu.be/cT993ypa0_A?t=';
    const double startSecondstwo = 000000000000000000000000000141;
    const String videoIdthree = 'https://youtu.be/XtuWiHYmr4U?t=';
    const double startSecondsthree = 000000000000000000000000000295;
    const String videoIdfour = 'https://youtu.be/TNQ9pvxXCkQ?t=';
    const double startSecondsfour = 0000000000000000000000000008;
    const String videoIdfive = 'https://youtu.be/onKCSNe3xlU?t=';
