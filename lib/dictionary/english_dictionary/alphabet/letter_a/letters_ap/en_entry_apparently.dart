...
// replace EnglishEntryAdopsum - replace speakApparently

// replace apparently - /əˈpærəntli/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryapparently extends StatelessWidget {
  // blank divider
  EnglishEntryapparently({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "apparently"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈpærəntli/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈpærəntli/"),
