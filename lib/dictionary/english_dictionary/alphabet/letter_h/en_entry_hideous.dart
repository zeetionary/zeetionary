...
class EnglishEntryhideous extends StatefulWidget {
  const EnglishEntryhideous({super.key});

  @override
  State<EnglishEntryhideous> createState() => _EnglishEntryhideousState();
}

class _EnglishEntryhideousState extends State<EnglishEntryhideous> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hideous
1. Grossly offensive to decency or morality; causing horror (- horrid, horrific, outrageous)
"a hideous pattern of injustice";
 
2. So extremely ugly as to be terrifying (- repulsive)
"a hideous scar";
""",
  );

  final String keyword = "hideous";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hideous""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The whole experience had been like some hideous nightmare.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was wearing a hideous yellow dress.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hideous""",
                      // alsoEnglishWord: "also: hideous",
                      britshText: """IpaUK: /ˈhɪdiəs/""",
                      americanText: """IpaUS: /ˈhɪdiəs/""",
...
کوردی: ناحەز، ناشیرین، بەزەڕە، دزێو، کرێت، قەبە، بێ‌شەرمانە، ناخۆش، تاڵ، ترسناک، بەژان
"""),
// With short examples define "hideous", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) زۆر ناشرین و ناپەسەند"""),
                    const AlsoEnglishckb(word: "ھەروەھا: revolting"),
                    SentencesRow(
                      englishText: """The whole experience had been like some hideous nightmare.""",
                      kurdishText: """تەواوی ئەزموونەکە وەک دێوەزمەیەکی ناخۆش بوو.""",
                    ...
                    SentencesRow(
                      englishText: """She was wearing a hideous yellow dress.""",
                      kurdishText: """جلێکی زەردی قەبیحی لەبەر کردبوو.""",
...
const double _startSecondsend = 0000000000000000000000000001500;
const String _videoIdone = 'https://youtu.be/L1kYZHnHS0E?t=';
const double _startSecondsone = 0000000000000000000000000001220;
const String _videoIdtwo = 'https://youtu.be/VVsdb90aOmA?t=';
const double _startSecondstwo = 0000000000000000000000000001180;
const String _videoIdthree = 'https://youtu.be/kUE2fPLOUxo?t=';
const double _startSecondsthree = 000000000000000000000000000556;
const String _videoIdfour = 'https://youtu.be/hGLY5MAAFO4?t=';
const double _startSecondsfour = 00000000000000000000000000081;
const String _videoIdfive = 'https://youtu.be/MVu8QbxafJE?t=';
