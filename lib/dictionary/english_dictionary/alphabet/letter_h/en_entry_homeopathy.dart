...
class EnglishEntryhomeopathy extends StatefulWidget {
  const EnglishEntryhomeopathy({super.key});

  @override
  State<EnglishEntryhomeopathy> createState() => _EnglishEntryhomeopathyState();
}

class _EnglishEntryhomeopathyState extends State<EnglishEntryhomeopathy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: homeopathy (Derived forms: homeopathies)
Usage: N. Amer (elsewhere: homoeopathy)
1. A method of treating disease with small amounts of remedies that, in large amounts in healthy people, produce symptoms similar to those being treated (- homoeopathy [Brit, Cdn])
""",
  );

  final String keyword = "homeopathy";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""homeopathy""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He believes in homeopathy for treating minor ailments.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/6RhOUup8epA?t=';
    const double startSecondsend = 000000000000000000000000000505;
    const String videoIdone = 'https://youtu.be/vj71yGp-8WM?t=';
    const double startSecondsone = 000000000000000000000000000392;
    const String videoIdtwo = 'https://youtu.be/rqqDok9caYE?t=';
    const double startSecondstwo = 0000000000000000000000000001051;
    const String videoIdthree = 'https://youtu.be/UrzF-rhJtOs?t=';
    const double startSecondsthree = 0000000000000000000000000001022;
    const String videoIdfour = 'https://youtu.be/m5Lwwbe7HiI?t=';
    const double startSecondsfour = 0000000000000000000000000001103;
    const String videoIdfive = 'https://youtu.be/6dXM0itfDO0?t=';
    const double startSecondsfive = 000000000000000000000000000700;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homeopathy""",
                      // alsoEnglishWord: "also: homeopathy",
                      britshText: """IpaUK: /ˌhəʊmiˈɒpəθi/,  /ˌhɒmiˈɒpəθi/""",
                      americanText: """IpaUS: /ˌhəʊmiˈɑːpəθi/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) جۆری چارەسەرکردنی دۆخێکی تەندرووستی یان نەخۆشییەک بە بەکارهێنانی بڕی کەمی ئەو مادەیەی کە بووە بە هۆکاری"""),
                    SentencesRow(
                      englishText:
                          """He believes in homeopathy for treating minor ailments.""",
                      kurdishText:
                          """باوەڕی بە هۆمیۆپاسی هەیە بۆ چارەسەری نەخۆشی بچووک.""",
