...
class EnglishEntryinconveniently extends StatefulWidget {
  const EnglishEntryinconveniently({super.key});

  @override
  State<EnglishEntryinconveniently> createState() =>
      _EnglishEntryinconvenientlyState();
}

class _EnglishEntryinconvenientlyState
    extends State<EnglishEntryinconveniently> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inconveniently""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'sLaXSvpfDZs';
    const double startSecondsend = 1729;
    const String videoIdone = 'CMxHQ5B7dZ8';
    const double startSecondsone = 36;
    const String videoIdtwo = 'd1CVVoAihBc';
    const double startSecondstwo = 266;
    const String videoIdthree = '0c7EN2Dolis';
    const double startSecondsthree = 978;
    const String videoIdfour = '60fWsMyZfX0';
    const double startSecondsfour = 2123;
    const String videoIdfive = 'pLQuIuokP6Q';
