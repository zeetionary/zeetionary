...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His superb play inspired the team to a 5–0 win.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We hope to inspire others to pursue their dreams.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The choice of decor was inspired by a trip to India.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His tragic story later inspired a Hollywood film.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her paintings were clearly inspired by Monet’s work.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Henry did not inspire confidence as a figure of authority.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her work didn't exactly inspire me with confidence.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""As a general, he inspired great loyalty in his troops.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/jgkMFBDyzE8?t=';
    ...
    const String videoIdthree = 'https://youtu.be/cfwuadOlyz0?t=';
    const double startSecondsthree = 000000000000000000000000000701;
    const String videoIdfour = 'https://youtu.be/BD44SVoCIFo?t=';
    const double startSecondsfour = 00000000000000000000000000088;
    const String videoIdfive = 'https://youtu.be/Y_N0AxCzVLg?t=';
    const double startSecondsfive = 0000000000000000000000000001259;
...
// With short examples define "inspire", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) پێدانی حەز، باوەڕ، یان وزە بۆ کردنی شتێک بە باشی"""),
                    SentencesRow(
                      englishText: """The actors' enthusiasm inspired the kids.""",
                      kurdishText: """بەجۆشی ئەکتەرەکە ئیلهامی بەخشی بە منداڵەکان.""",
                      englishNote: """Also: The actors inspired the kids with their enthusiasm.""",
                    ...
                    SentencesRow(
                      englishText: """His superb play inspired the team to a 5–0 win.""",
                      kurdishText: """یارییە ناوازەکەی وزەی دا بە تیمەکە بۆ بردنەوەیەکی ٥ - ٠.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We hope to inspire others to pursue their dreams.""",
                      kurdishText: """هیوادارین ئیلهام بدەین بەوانی دیکە کە شوێنی خەونەکانیان بکەون.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) پێدانی بیرۆکەی شتێک بە کەسێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The choice of decor was inspired by a trip to India.""",
                      kurdishText: """هەڵبژاردنی ڕازانەوەکە لە گەشتێکەوە بۆ هندستان سەرچاوەی گرت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """His tragic story later inspired a Hollywood film.""",
                      kurdishText: """چیرۆکە تراژیدیایەکەی دواتر ئیلهامی بە فیلمێکی هۆڵیوود بەخشی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her paintings were clearly inspired by Monet’s work.""",
                      kurdishText: """تابلۆکانی بە ئاشکرایی لەلایەن کارەکانی مۆنێتەوە ئیلهامیان وەرگرت.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) واکردنی ئەوەی کەسێک هەستێکی دیاریکراوی هەبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Henry did not inspire confidence as a figure of authority.""",
                      kurdishText: """هێنری ورەی نەدەبەخشی وەک کەسێکی دەسەڵاتدار.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her work didn't exactly inspire me with confidence.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """As a general, he inspired great loyalty in his troops.""",
                      kurdishText: """وەک ژەنەراڵێک، وەفاداریی زۆری دەبەخشی بە هێزەکانی.""",
