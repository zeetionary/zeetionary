...
// replace these: replace EnglishEntryanarchist - replace speakAnarchist - replace anarchist - /ˈænəkɪst/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryanarchist extends StatelessWidget {
  EnglishEntryanarchist({super.key});
  ...
  Future<void> speakanarchist(String languageCode) async {
    ...
    await flutterTts.speak("anarchist");
  }

  Future<void> speakanarchist459(String languageCode) async {
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("He was a poet, an anarchist, and a vegan.");
  }

  // Future<void> speakanarchist(String languageCode) async {
  //   // DOPSUM: CHANGE speakAnarchist
  //   await flutterTts.setLanguage(languageCode);
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "anarchist"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈænəkɪst/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈænərkɪst/"),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'cNi_HC839Wo';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'iTkURG6FIZg';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'Jcmeu5porZA';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = '4e9DBXdXxAc';
