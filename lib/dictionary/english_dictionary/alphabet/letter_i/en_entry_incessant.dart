...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'NpBPm0b9deQ';
    const double startSecondsend = 476;
    const String videoIdone = 'HbUGTcdFIio';
    const double startSecondsone = 2632;
    const String videoIdtwo = 'fb_SQOIC_zY';
    const double startSecondstwo = 698;
    const String videoIdthree = 'GKuHdd_-m6M';
    const double startSecondsthree = 525;
    const String videoIdfour = 'Solb9uA-tgQ';
    const double startSecondsfour = 4696;
    const String videoIdfive = 'sGOXHdf-_dM';
