...
class EnglishEntryflagship extends StatefulWidget {
  const EnglishEntryflagship({super.key});

  @override
  State<EnglishEntryflagship> createState() => _EnglishEntryflagshipState();
}

class _EnglishEntryflagshipState extends State<EnglishEntryflagship> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flagship (Derived forms: flagships)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flagship""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The flagship was equipped with the latest technology.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The iPhone is Apple's flagship product.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flagship""",
                      // alsoEnglishWord: "also: flagship",
                      britshText: """IpaUK: /ˈflæɡʃɪp/""",
                      americanText: """IpaUS: /ˈflæɡʃɪp/""",
...
کوردی: سەرکەشتی،	هەڵبژاردە، سەرتۆپ، گرنگ‌ترین بەش، باشترین بەش
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەشتی سەرەکی لە کەشتی‌گەلی هێزی دەریایی"""),
                    SentencesRow(
                      englishText:
                          """The flagship was equipped with the latest technology.""",
                      kurdishText:
                          """سەرکەشتییەکە باشترین تەکنەلۆژیای پێدرابوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) گرنترین بەرهەم، خزمەتگوزاری، بینا، هتد کە دامەزراوەیەک هەیەتی یان بەرهەمی دەهێنێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The iPhone is Apple's flagship product.""",
                      kurdishText: """ئایفۆن بەرهەمی سەرەکیی ئەپڵە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/EgTshfSvM0A?t=';
const double _startSecondsend = 00000000000000000000000000095;
const String _videoIdone = 'https://youtu.be/8FpPSMIB4uA?t=';
const double _startSecondsone = 000000000000000000000000000681;
const String _videoIdtwo = 'https://youtu.be/gqibxjObZ-I?t=';
...
const String _videoIdfour = 'https://youtu.be/UpqaQR4ikig?t=';
