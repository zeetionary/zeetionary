...
class EnglishEntryinitially extends StatefulWidget {
  const EnglishEntryinitially({super.key});

  @override
  State<EnglishEntryinitially> createState() => _EnglishEntryinitiallyState();
}

class _EnglishEntryinitiallyState extends State<EnglishEntryinitially> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""initially""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1206;
    const String videoIdone = 'zqllxbPWKNI';
    const double startSecondsone = 842;
    const String videoIdtwo = 'QLq6GEiHqR8';
    const double startSecondstwo = 2102;
    const String videoIdthree = 'pTysrwci0pU';
    const double startSecondsthree = 1218;
    const String videoIdfour = 'Mx8JkGHaGUI';
    const double startSecondsfour = 1259;
    const String videoIdfive = 'vzKuobmi3iI';
