...
class EnglishEntryhindquarters extends StatefulWidget {
  const EnglishEntryhindquarters({super.key});

  @override
  State<EnglishEntryhindquarters> createState() =>
      _EnglishEntryhindquartersState();
}

class _EnglishEntryhindquartersState extends State<EnglishEntryhindquarters> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hindquarters
1. The fleshy part of the human body that you sit on (- buttocks, nates [technical], butt [N. Amer, informal], backside, bum [Brit, informal], buns [N. Amer, informal], can [N. Amer, informal], fundament, hind end, posterior, rear [informal], rear end [informal], rump, stern [informal], seat, tail [N. Amer, informal], tail end, tooshie [informal], tush [N. Amer, informal], bottom, behind, derriere, bahookie [UK, dialect, informal], botty [informal], heinie [US, informal], duff [N. Amer, informal], booty [N. Amer, informal], patootie [US, informal], tushy [N. Amer, informal], derrière)
"he deserves a good kick in the hindquarters";
 
2. The part of an animal that corresponds to the human buttocks (- croup, croupe, rump)
""",
  );

  final String keyword = "hindquarters";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hindquarters""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A horse’s hindquarters are very powerful.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/SHfqtaa0VI8?t=';
    const double startSecondsend = 000000000000000000000000000358;
    const String videoIdone = 'https://youtu.be/wMxKbkWrvDc?t=';
    const double startSecondsone = 000000000000000000000000000113;
    const String videoIdtwo = 'https://youtu.be/BMoF4iupwfw?t=';
    const double startSecondstwo = 000000000000000000000000000121;
    const String videoIdthree = 'https://youtu.be/5hsiOzwspio?t=';
    const double startSecondsthree = 0000000000000000000000000001829;
    const String videoIdfour = 'https://youtu.be/4bGNm5jqwLg?t=';
    const double startSecondsfour = 00000000000000000000000000055;
    const String videoIdfive = 'https://youtu.be/3Ajb3Uva42w?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hindquarters""",
                      // alsoEnglishWord: "also: hindquarters",
                      britshText: """IpaUK: /ˌhaɪndˈkwɔːtəz/""",
                      americanText: """IpaUS: /ˈhaɪndkwɔːrtərz/""",
...
// کوردی: پاشوو، پاشەڵ، بەشی دواوەی چوارپێکان
// """),
                    const DefinitionKurdish(
                        text: """١. (ناو) بەشی دواوەی ئاژەڵی چوارپێ"""),
                    SentencesRow(
                      englishText:
                          """A horse’s hindquarters are very powerful.""",
                      kurdishText: """پاشووی ئەسپ زۆر بەهێزە.""",
