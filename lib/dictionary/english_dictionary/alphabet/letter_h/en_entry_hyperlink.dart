...
class EnglishEntryhyperlink extends StatefulWidget {
  const EnglishEntryhyperlink({super.key});

  @override
  State<EnglishEntryhyperlink> createState() => _EnglishEntryhyperlinkState();
}

class _EnglishEntryhyperlinkState extends State<EnglishEntryhyperlink> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hyperlink""");
  }
