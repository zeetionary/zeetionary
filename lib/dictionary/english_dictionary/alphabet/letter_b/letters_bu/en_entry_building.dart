...
// blank divider
  ...
  Future<void> speakbuildings2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The old industrial buildings have all been demolished.");
  }
  ...
  Future<void> speakbuildings3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("In 2018 the building was converted into a house.");
  }
  ...
  Future<void> speakbuildings4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Several new buildings are now being put up.");
  }
  ...
  Future<void> speakbuildings5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("There's building work going on next door.");
  }
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbuildings2("en-GB"),
                            onPressedAmerican: () => speakbuildings2("en-US"),
                          ),
                          Column(
                            children: [
                              MyExpansionTile(
                          ...
                          SentencesRow(
                            ...
                            kurdishText: "کاری بیناسازی لە تەنیشتمانەوە ھەیە.",
                            onPressedBritish: () => speakbuildings5("en-GB"),
                            onPressedAmerican: () => speakbuildings5("en-US"),
                          ),
                          const DividerSentences(),
                          SentencesRow(
                            englishText:
                            ...
                            onPressedBritish: () => speakbuildings6("en-GB"),
                            onPressedAmerican: () => speakbuildings6("en-US"),
                          ),
                          const DividerDefinition(),
                          const DefinitionKurdish(
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbuildings7("en-GB"),
                            onPressedAmerican: () => speakbuildings7("en-US"),
                          ),
                        ],
                      ),
                    ),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'COFtvPVoPQ8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'aKlLgwyqsqY';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '87MMbN1bQCs';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'bH-TlC0111Q';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = '9D3TiyEY9-g';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'tHMPR7flpf4';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'P-QZ5Om9_20';
