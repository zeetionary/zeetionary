...
class EnglishEntrygoldmine extends StatefulWidget {
  const EnglishEntrygoldmine({super.key});

  @override
  State<EnglishEntrygoldmine> createState() => _EnglishEntrygoldmineState();
}

class _EnglishEntrygoldmineState extends State<EnglishEntrygoldmine> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gold mine";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gold mine""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Her family had made their fortune from owning gold mines.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gold mine""",
                      // alsoEnglishWord: "also: gold mine",
                      britshText: """IpaUK: /ˈɡəʊld maɪn/""",
                      americanText: """IpaUS: /ˈɡəʊld maɪn/""",
...
کوردی: کانەزێڕ،	(خوازە) گەنج، خەزێنە،	کاروکاسپی پڕداهات، کاری پڕقازانج یان پڕخێر
"""),
// With short examples define "gold mine", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) شوێنێک کە زێڕ لە زەوی دەردەهێنرێت"""),
                    SentencesRow(
                      englishText:
                          """Her family had made their fortune from owning gold mines.""",
                      kurdishText:
                          """خێزانەکەی سامانەکەیان بەدەستهێنا لە خاوەندارێتیکردنی کانەزێڕێک.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) کارێک یان چالاکییەک کە قازانجی زۆری دەبێت؛ شتێک کە بەهای زۆرە"""),
...
const double _startSecondsend = 000000000000000000000000000834;
const String _videoIdone = 'https://youtu.be/RZt7kE7PZMQ?t=';
const double _startSecondsone = 00000000000000000000000000098;
const String _videoIdtwo = 'https://youtu.be/6etTERFUlUI';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/zVqFAMOtwaI?t=';
const double _startSecondsthree = 000000000000000000000000000898;
const String _videoIdfour = 'https://youtu.be/bDcfrpbNorw?t=';
const double _startSecondsfour = 000000000000000000000000000744;
const String _videoIdfive = 'https://youtu.be/iYCAwk5oxFE?t=';
const double _startSecondsfive = 0000000000000000000000000001104;
