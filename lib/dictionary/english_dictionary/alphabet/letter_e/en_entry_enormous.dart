...
class EnglishEntryenormous extends StatefulWidget {
  const EnglishEntryenormous({super.key});

  @override
  State<EnglishEntryenormous> createState() => _EnglishEntryenormousState();
}

class _EnglishEntryenormousState extends State<EnglishEntryenormous> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enormous""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enormous""",
                      // alsoEnglishWord: "also: enormous",
                      britshText: """IpaUK: /ɪˈnɔːməs/""",
                      americanText: """IpaUS: /ɪˈnɔːrməs/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Universities are under enormous pressure financially.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Their house is absolutely enormous!""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The problems facing the President are enormous.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""An enormous number of people were killed that night.""");
  }
...
کوردی: (یەکجار) گەورە، زەبەلاح، قەبە، قەپە، گەپ، کەتە، یەکجار زۆر، زۆروزەبەن، لەرادەبەدەر
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) زۆر گەورە"""),
          SentencesRow(
            englishText:
                """Universities are under enormous pressure financially.""",
            kurdishText: """زانکۆکان لە ڕووی داراییەوە لەژێر فشاری زۆرن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Their house is absolutely enormous!""",
            kurdishText: """ئەم خانووە تەواو زەبەلاحە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The problems facing the President are enormous.""",
            kurdishText: """ئەو کێشانەی ڕووبەڕووی سەرۆک بوونەتەوە زۆرن.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ژمارەیەکی زۆر خەڵک دوێنێ شەو کوژران.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The cost of the work was enormous.""",
            kurdishText: """تێچووی کارەکە قەبە بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: enormous
1. Extraordinarily large in size, extent, amount, power or degree (= tremendous, ginormous [Brit, informal])
...
const double _startSecondsend = 1738;
...
const String _videoIdthree = 'https://youtu.be/LBSFeJ1WLv4';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/DfSnHyIryeY?t=';
...
const String _videoIdsix = 'https://youtu.be/unk6n3_QdlM?t=';
const double _startSecondssix = 160;
