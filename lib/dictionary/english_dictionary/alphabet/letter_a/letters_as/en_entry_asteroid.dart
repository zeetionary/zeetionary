...
// Define the word "asteroid" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryasteroid - replace speakAsteroid

// replace asteroid - /ˈæstərɔɪd/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryasteroid extends StatelessWidget {
  // blank divider
  EnglishEntryasteroid({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "asteroid"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæstərɔɪd/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæstərɔɪd/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakasteroid952("en-US"),
                          ),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'rqV4VztL5xE';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'Ygv6hesk3JQ';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'yljsHQgJx9k';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'sTOvYDQyfrM';
