...
class EnglishEntrygust extends StatefulWidget {
  const EnglishEntrygust({super.key});

  @override
  State<EnglishEntrygust> createState() => _EnglishEntrygustState();
}

class _EnglishEntrygustState extends State<EnglishEntrygust> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gust (Derived forms: gusts)
1. A strong current of air (- blast, blow)
"the tree was bent almost double by the gust";

- Verb: gust (Derived forms: gusts, gusting, gusted)
1. (of wind) blow with bursts of strong wind
""",
  );

  final String keyword = "gust";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A gust of wind blew his hat off.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The wind was blowing in gusts.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Her joke triggered a gust of laughter from the group.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The wind gusted through the branches.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gust""",
                      // alsoEnglishWord: "also: gust",
                      britshText: """IpaUK: /ɡʌst/""",
                      americanText: """IpaUS: /ɡʌst/""",
...
// With short examples define "gust", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """A gust of wind blew his hat off.""",
                      kurdishText: """بایەکی توند کڵاوەکەیی خست.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """نوکتەکەی قاقایەکی بەکۆمەڵی لە نێو ئامادەبووان درووستکرد""",
