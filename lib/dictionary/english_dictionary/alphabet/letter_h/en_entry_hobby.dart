...
class EnglishEntryhobby extends StatefulWidget {
  const EnglishEntryhobby({super.key});

  @override
  State<EnglishEntryhobby> createState() => _EnglishEntryhobbyState();
}

class _EnglishEntryhobbyState extends State<EnglishEntryhobby> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hobby (Derived forms: hobbies)
1. An auxiliary activity (- avocation, by-line, pursuit, sideline, spare-time activity)
 
2. A child's plaything consisting of an imitation horse mounted on rockers; the child straddles it and pretends to ride (- hobbyhorse, rocking horse)
 
3. Small Old World falcon formerly trained and flown at small birds (- Falco subbuteo)
""",
  );

  final String keyword = "hobby";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Alex plays chess as a hobby.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Do you have any hobbies?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her hobbies include swimming and gardening.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Why don't you take up a new hobby?""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/DLzA9kcjuGg?t=';
    const double startSecondsend = 00000000000000000000000000091;
    const String videoIdone = 'https://youtu.be/m7SHm0YlWpk?t=';
    const double startSecondsone = 000000000000000000000000000738;
    const String videoIdtwo = 'https://youtu.be/q9-_MLoLQ4Y?t=';
    const double startSecondstwo = 000000000000000000000000000825;
    const String videoIdthree = 'https://youtu.be/nRafaCcfrcI?t=';
    const double startSecondsthree = 000000000000000000000000000164;
    const String videoIdfour = 'https://youtu.be/nYRefC7E9gU?t=';
    const double startSecondsfour = 000000000000000000000000000364;
    const String videoIdfive = 'https://youtu.be/lRW6CYfhei0?t=';
    const double startSecondsfive = 000000000000000000000000000878;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hobby""",
                      // alsoEnglishWord: "also: hobby",
                      britshText: """IpaUK: /ˈhɒbi/""",
                      americanText: """IpaUS: /ˈhɑːbi/""",
...
// With short examples define "hobby", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Do you have any hobbies?""",
                      kurdishText: """هیچ سەرگەرمییەکت هەیە؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """حەزەکانی مەلەکردن و باخداری لەخۆ دەگرێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Why don't you take up a new hobby?""",
                      kurdishText: """بۆچی خولیایەکی نوێ دەست پێ ناکەیت؟.""",
