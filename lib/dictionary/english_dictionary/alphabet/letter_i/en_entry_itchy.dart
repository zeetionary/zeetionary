...
class EnglishEntryitchy extends StatefulWidget {
  const EnglishEntryitchy({super.key});

  @override
  State<EnglishEntryitchy> createState() => _EnglishEntryitchyState();
}

class _EnglishEntryitchyState extends State<EnglishEntryitchy> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryitchy itchy
WORD_WEB itchy itchy itchy
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "itchy";
...
// کوردی:
// """),
// With short examples define "itchy", please follow LX instructions
