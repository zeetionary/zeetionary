...
class EnglishEntryfunctional extends StatefulWidget {
  const EnglishEntryfunctional({super.key});

  @override
  State<EnglishEntryfunctional> createState() => _EnglishEntryfunctionalState();
}

class _EnglishEntryfunctionalState extends State<EnglishEntryfunctional> {
  @override
  void initState() {
    super.initState();
...
"a style of writing in which every word is functional"; "functional architecture"; "functional education selects knowledge that is concrete and usable rather than abstract and theoretical"; "functional architecture"
 
2. (pathology) involving or affecting function rather than physiology
"functional deafness"
...
4. Fit or ready for use or service (- usable, useable, operable, operational)
"the toaster was still functional even after being dropped";

5. (of e.g. a machine) performing or capable of performing (- running, operative, working)
"in functional order"; "a functional set of brakes";
""",
  );

  final String keyword = "functional";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""functional""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The hospital will soon be fully functional.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """functional""",
                      // alsoEnglishWord: "also: functional",
                      britshText: """IpaUK: /ˈfʌŋkʃənl/""",
                      americanText: """IpaUS: /ˈfʌŋkʃənl/""",
...
کوردی: ئەرکی، فرمانی، پەیوری، کارەکی، کاری، کردەوەیی، کرداری، کارکردی،	بەسوود، بەقازانج، بەکەڵک،	کاریگەر، کارا،	بەکارهاتوو، کارپێکراو، ساغ
"""),
// With short examples define "functional", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە بۆ بەکارهێنان و سوود بینینە؛ کە ڕازاندنەوەی کەمە"""),
                    SentencesRow(
                      englishText:
                          """The office was large and functional rather than welcoming.""",
                      kurdishText:
                          """ئۆفیسەکە گەورە و کارەکی بوو وەک لەوەی دڵگیر بێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Items such as musical instruments may be both functional and aesthetically pleasing.""",
                      kurdishText:
                          """کەرەستەی وەک ئامێرە میوزیکییەکان لەوانەیە هەم بەسوود و هەم لەلایەنی هونەرییەوە دڵخۆشکەر بن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە مەبەستێکی تایبەتی هەیە؛ کە ئەوە دەڕەخسێنێت بۆ کەسێک شتێک بکات یان شتێک ڕووبدات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """These units played a key functional role in the military operation.""",
                      kurdishText:
                          """ئەم یەکانە ئەرکێکی سەرەکیان بینی لە ئۆپەراسیۆنە سەربازییەکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵناو) کە شتێک کار دەکات یان توانای کارکردنی هەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The hospital will soon be fully functional.""",
                      kurdishText:
                          """نەخۆشخانەکە بەزووی بە تەواوی کارا دەبێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/SrDEtSlqJC4?t=';
const double _startSecondsend = 0000000000000000000000000001218;
const String _videoIdone = 'https://youtu.be/AF8d72mA41M?t=';
const double _startSecondsone = 000000000000000000000000000375;
const String _videoIdtwo = 'https://youtu.be/jKv_N0IDS2A?t=';
const double _startSecondstwo = 00000000000000000000000000027;
const String _videoIdthree = 'https://youtu.be/W2hRTTTpmr8?t=';
const double _startSecondsthree = 0000000000000000000000000001919;
const String _videoIdfour = 'https://youtu.be/8eq2vGEEbB4?t=';
const double _startSecondsfour = 000000000000000000000000000384;
const String _videoIdfive = 'https://youtu.be/oHSehKtDyoI?t=';
const double _startSecondsfive = 000000000000000000000000000898;
