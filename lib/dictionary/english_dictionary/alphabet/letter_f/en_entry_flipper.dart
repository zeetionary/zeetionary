...
class EnglishEntryflipper extends StatefulWidget {
  const EnglishEntryflipper({super.key});

  @override
  State<EnglishEntryflipper> createState() => _EnglishEntryflipperState();
}

class _EnglishEntryflipperState extends State<EnglishEntryflipper> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flipper (Derived forms: flippers)
1. A shoe for swimming; the paddle-like front is an aid in swimming (especially underwater) (= fin)
 
2. The flat broad limb of aquatic animals specialized for swimming
""",
  );

  final String keyword = "flipper";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flipper""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Penguins use their flippers to glide through the water.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He practiced swimming with new flippers.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flipper""",
                      // alsoEnglishWord: "also: flipper",
                      britshText: """IpaUK: /ˈflɪpə(r)/""",
                      americanText: """IpaUS: /ˈflɪpər/""",
...
کوردی: باڵ، پەڕەکە، ئەندامی مەلێ، سەوڵە،	کەوشی مەلەوانی، بۆقەپێ
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بەشێکی جەستە کە وەک باڵی پێ پەنجە وایە و هەندێک ئاژەڵی وەک کیسەڵ و سەگڵاوی بەکاری دەهێنن بۆ مەلەکردن"""),
                    SentencesRow(
                      englishText:
                          """Penguins use their flippers to glide through the water.""",
                      kurdishText:
                          """پەنگوین باڵیان بەکاردەهێنن بۆ مەلەکردن بە ئاودا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) پارچە پلاستیک یان لاستیکێکی تەخت کە بەکاری دەهێنیت بۆ ئەوەی خێراتر مەلە بکەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He practiced swimming with new flippers.""",
                      kurdishText: """مەلەی کرد بە بۆقەپێی تازەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/NC_KIE8DbtE?t=';
const double _startSecondsend = 00000000000000000000000000099;
const String _videoIdone = 'https://youtu.be/2fOWFfpLYW0?t=';
const double _startSecondsone = 000000000000000000000000000790;
const String _videoIdtwo = 'https://youtu.be/q8y-RLkpsnk?t=';
const double _startSecondstwo = 000000000000000000000000000604;
const String _videoIdthree = 'https://youtu.be/TTM4y5-Onc4?t=';
const double _startSecondsthree = 00000000000000000000000000056;
const String _videoIdfour = 'https://youtu.be/9ttxmg2nBOQ?t=';
const double _startSecondsfour = 0000000000000000000000000001649;
const String _videoIdfive = 'https://youtu.be/Ze9jxpur47M?t=';
const double _startSecondsfive = 0000000000000000000000000001028;
