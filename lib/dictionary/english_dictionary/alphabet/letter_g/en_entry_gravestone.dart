...
class EnglishEntrygravestone extends StatefulWidget {
  const EnglishEntrygravestone({super.key});

  @override
  State<EnglishEntrygravestone> createState() => _EnglishEntrygravestoneState();
}

class _EnglishEntrygravestoneState extends State<EnglishEntrygravestone> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gravestone (Derived forms: gravestones)
1. A stone that is used to mark a grave (- headstone, tombstone)
""",
  );

  final String keyword = "gravestone";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gravestone""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Flowers were laid next to the gravestone.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gravestone""",
                      // alsoEnglishWord: "also: gravestone",
                      britshText: """IpaUK: /ˈɡreɪvstəʊn/""",
                      americanText: """IpaUS: /ˈɡreɪvstəʊn/""",
...
کوردی: کێل، هەنگێز، بەردی گۆر، میل
"""),
                    const DefinitionKurdish(text: """١. (ناو) کێلی گۆڕ"""),
                    const AlsoEnglishckb(word: "ھەروەھا: headstone"),
                    SentencesRow(
                      englishText:
                          """Flowers were laid next to the gravestone.""",
                      kurdishText: """گوڵەکان لە تەنیشت کێلەکە دانران.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/YCnFYvL17v4?t=';
const double _startSecondsend = 0000000000000000000000000001518;
const String _videoIdone = 'https://youtu.be/HWB3VhIPWrU?t=';
const double _startSecondsone = 000000000000000000000000000143;
const String _videoIdtwo = 'https://youtu.be/qSmyimnMOBo?t=';
const double _startSecondstwo = 0000000000000000000000000004596;
const String _videoIdthree = 'https://youtu.be/YAKcbvioxFk?t=';
const double _startSecondsthree = 000000000000000000000000000702;
const String _videoIdfour = 'https://youtu.be/3HrDf6nra-I';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/zC4saZg6sG0?t=';
const double _startSecondsfive = 000000000000000000000000000715;
