...
class EnglishEntryfrilly extends StatefulWidget {
  const EnglishEntryfrilly({super.key});

  @override
  State<EnglishEntryfrilly> createState() => _EnglishEntryfrillyState();
}

class _EnglishEntryfrillyState extends State<EnglishEntryfrilly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: frilly 
1. Having decorative ruffles or frills (- frilled, ruffled)
"The girl liked the little dresser with its frilly nylon cover";
""",
  );

  final String keyword = "frilly";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She wore a frilly white dress.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frilly""",
                      // alsoEnglishWord: "also: frilly",
                      britshText: """IpaUK: /ˈfrɪli/""",
                      americanText: """IpaUS: /ˈfrɪli/""",
...
// With short examples define "frilly", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """She wore a frilly white dress.""",
                      kurdishText: """جلێکی چین‌چینی سپی لەبەر کرد.""",
...
const double _startSecondsend = 000000000000000000000000000176;
const String _videoIdone = 'https://youtu.be/WUjVPIEtJd0?t=';
const double _startSecondsone = 00000000000000000000000000046;
const String _videoIdtwo = 'https://youtu.be/ZFRnQ-Ti6Is?t=';
const double _startSecondstwo = 000000000000000000000000000184;
const String _videoIdthree = 'https://youtu.be/oYBq6tgx_5M?t=';
const double _startSecondsthree = 0000000000000000000000000001793;
const String _videoIdfour = 'https://youtu.be/W6aDNutZoB0?t=';
const double _startSecondsfour = 000000000000000000000000000774;
const String _videoIdfive = 'https://youtu.be/bVZqpMYDiiw?t=';
const double _startSecondsfive = 000000000000000000000000000144;
