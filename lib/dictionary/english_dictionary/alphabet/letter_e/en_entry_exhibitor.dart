...
class EnglishEntryexhibitor extends StatefulWidget {
  const EnglishEntryexhibitor({super.key});

  @override
  State<EnglishEntryexhibitor> createState() => _EnglishEntryexhibitorState();
}

class _EnglishEntryexhibitorState extends State<EnglishEntryexhibitor> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exhibitor""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exhibitor""",
                      // alsoEnglishWord: "also: exhibitor",
                      britshText: """IpaUK: /ɪɡˈzɪbɪtə(r)/""",
                      americanText: """IpaUS: /ɪɡˈzɪbɪtər/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exhibitor";
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کەسێک یان کۆمپانیایەک کە کارەکانی بۆ خەڵکی نمایش دەکات"""),
          SentencesRow(
            englishText:
                """The work of over 500 exhibitors will be on display at the arts and crafts show.""",
            kurdishText:
                """کاری سەروو لە ٥٠٠ بەشداری‌کەر لە نمایشدا دەبێت لە شانۆی هونەری و کاری دەستکرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: exhibitor (Derived forms: exhibitors)
1. Someone who organizes an exhibit for others to see (= exhibitioner, shower)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/kl4ORsnCn-U?t=';
const double _startSecondsend = 000000000000000000000000000000; // 3407;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/SM9MhGck72A?t=';
const double _startSecondsone = 00000000000000000000000000000; // 120;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/mx8FiGGRPKo?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 475;
const String _videoIdthree = 'VIDEOhttps://youtu.be/l30sADfDiM8?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1037;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/QyPQmwLObyQ?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 893;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/7tuRJIkDcXg?t=';
