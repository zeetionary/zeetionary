...
class EnglishEntrygigabyte extends StatefulWidget {
  const EnglishEntrygigabyte({super.key});

  @override
  State<EnglishEntrygigabyte> createState() => _EnglishEntrygigabyteState();
}

class _EnglishEntrygigabyteState extends State<EnglishEntrygigabyte> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gigabyte""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It has a gigabyte of RAM and a large hard drive.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Gigabyte (GB) can be a synonym of gibibyte.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gigabyte""",
                      // alsoEnglishWord: "also: gigabyte",
                      britshText: """IpaUK: /ˈɡɪɡəbaɪt/""",
                      americanText: """IpaUS: /ˈɡɪɡəbaɪt/""",
...
// With short examples define "gigabyte", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) یەکەیەکی زانیاریی کۆمپیوتەر کە لە ١,٠٠٠,٠٠٠,٠٠٠ بایت پێکهاتووە"""),
                    SentencesRow(
                      englishText:
                          """It has a gigabyte of RAM and a large hard drive.""",
                      kurdishText:
                          """یەک گیگابایت ڕام و هارد درایڤێکی گەورەی هەیە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) یەکەیەکی زانیاریی کۆمپیوتەر کە لە ١,٠٧٣,٧٤١,٨٢٤ بایت پێکهاتووە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Gigabyte (GB) can be a synonym of gibibyte.""",
                      kurdishText:
                          """Gigabyte (GB) دەکرێت هاوواتای gibibyte بێت.""",
...
const String _videoIdone = 'https://youtu.be/4U2ZxO7b8iM?t=';
const double _startSecondsone = 000000000000000000000000000578;
const String _videoIdtwo = 'https://youtu.be/J-K2yeQylCk?t=';
const double _startSecondstwo = 000000000000000000000000000112;
const String _videoIdthree = 'https://youtu.be/d86ws7mQYIg?t=';
const double _startSecondsthree = 000000000000000000000000000826;
const String _videoIdfour = 'https://youtu.be/pwHNannxolo?t=';
const double _startSecondsfour = 000000000000000000000000000198;
const String _videoIdfive = 'https://youtu.be/gO-V8E9MIBg?t=';
