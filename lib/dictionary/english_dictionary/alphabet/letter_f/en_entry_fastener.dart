...
class EnglishEntryfastener extends StatefulWidget {
  const EnglishEntryfastener({super.key});

  @override
  State<EnglishEntryfastener> createState() => _EnglishEntryfastenerState();
}

class _EnglishEntryfastenerState extends State<EnglishEntryfastener> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fastener""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fastener""",
                      // alsoEnglishWord: "also: fastener",
                      britshText: """IpaUK: /ˈfɑːsnə(r)/""",
                      americanText: """IpaUS: /ˈfæsnər/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The jacket has a zipper fastener.""");
  }
...
کوردی: قولاپ، بەند، بەست، دەسک، دەسەگیرە، گیرە، ئەشکنجە،	دوگمە، لێکبەست، لێک‌هەڵپێک، پێکبەست، داخە(ڕ)، ئاغزۆنە، پزیم، قازان‌قوفڵی، قرتێنە، دەرزی (سنجاغ)، دەرزی بەرکوژە،	زنجیر
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ئەو شتانەی کە وەک بەستەر بەکاردێن، بۆ نموونە دوگمە یان زنجیر، کە بۆ بەستن بەکاردێن"""),
          SentencesRow(
            englishText: """The jacket has a zipper fastener.""",
            kurdishText: """چاکەتەکە گیرەیەکی زنجیری هەیە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fastener (Derived forms: fasteners)
1. A person who fastens or makes fast
"he found the door fastened and wondered who the fastener was"
 
2. Restraint that attaches to something or holds something in place (= fastening, holdfast, fixing)
""",
  );
...
const String _videoIdend = 'https://youtu.be/-CJ4eUhE3Lw?t=';
const double _startSecondsend = 000000000000000000000000000881;
const String _videoIdone = 'https://youtu.be/4Nr1AgIfajI?t=';
const double _startSecondsone = 00000000000000000000000000043;
const String _videoIdtwo = 'https://youtu.be/Bbi0kEaTgio?t=';
const double _startSecondstwo = 000000000000000000000000000656;
const String _videoIdthree = 'https://youtu.be/kZdhnDmr0w4?t=';
const double _startSecondsthree = 00000000000000000000000000072;
const String _videoIdfour = 'https://youtu.be/kvo-n2AYZnA?t=';
const double _startSecondsfour = 00000000000000000000000000063;
const String _videoIdfive = 'https://youtu.be/1_hFKRDDP_o?t=';
const double _startSecondsfive = 000000000000000000000000000790;
