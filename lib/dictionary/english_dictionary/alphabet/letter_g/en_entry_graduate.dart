...
// With short examples define "graduate", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) کەسێکی کە بڕوانامەی زانکۆی هەیە"""),
                    SentencesRow(
                      englishText:
                          """The company places great importance on graduate recruitment and training.""",
                      kurdishText:
                          """کۆمپانیاکە گرنگی زۆر دەدات بە دەرچووانی زانکۆ و ڕاهێنان.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) تەواوکردنی زانکۆ یان کۆلێژ و بەدەستهێنانی، بە تایبەتی یەکەم بڕوانامە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She taught in France after she graduated.""",
                      kurdishText:
                          """لە فەرەنسا وانەی گوتەوە دوای ئەوەی بڕوانامەی بەدەستهێنا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەمساڵ خوێندنی لە هارڤارد تەواو کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە بیرکاری کەوت و هەرگیز خوێندنی تەواو نەکرد.""",
