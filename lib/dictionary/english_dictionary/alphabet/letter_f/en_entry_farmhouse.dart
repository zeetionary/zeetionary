...
class EnglishEntryfarmhouse extends StatefulWidget {
  const EnglishEntryfarmhouse({super.key});

  @override
  State<EnglishEntryfarmhouse> createState() => _EnglishEntryfarmhouseState();
}

class _EnglishEntryfarmhouseState extends State<EnglishEntryfarmhouse> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""farmhouse""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """farmhouse""",
                      // alsoEnglishWord: "also: farmhouse",
                      britshText: """IpaUK: /ˈfɑːmhaʊs/""",
                      americanText: """IpaUS: /ˈfɑːrmhaʊs/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "farmhouse";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The farmhouse had a big kitchen.""");
  }
...
کوردی: ماڵی جووتبەندە، خانووی جووتیار
"""),
...
const double _startSecondsend = 0000000000000000000000000001593;
...
const double _startSecondstwo = 0000000000000000000000000007714;
const String _videoIdthree = 'https://youtu.be/bIvqhdoZzo8?t=';
const double _startSecondsthree = 000000000000000000000000000872;
const String _videoIdfour = 'https://youtu.be/1ybLXdwp0Gk';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/gZOBkF7RoEQ?t=';
const double _startSecondsfive = 000000000000000000000000000610;
