...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/_h95pZQiKwI?t=';
    const double startSecondsend = 0000000000000000000000000001033;
    const String videoIdone = 'https://youtu.be/uAPTWTmlc8Q?t=';
    const double startSecondsone = 000000000000000000000000000386;
    const String videoIdtwo = 'https://youtu.be/EmT0i0xG6zg?t=';
    const double startSecondstwo = 0000000000000000000000000006079;
    const String videoIdthree = 'https://youtu.be/S6rDvbQ-mz4?t=';
    const double startSecondsthree = 000000000000000000000000000308;
    const String videoIdfour = 'https://youtu.be/sY8aFSY2zv4?t=';
    const double startSecondsfour = 0000000000000000000000000008536;
    const String videoIdfive = 'https://youtu.be/s_jaU5V9FUg?t=';
