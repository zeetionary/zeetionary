...
// replace these: replace EnglishEntryancestral - replace speakAncestral - replace ancestral - /ænˈsestrəl/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryancestral extends StatelessWidget {
  EnglishEntryancestral({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAncestral(String languageCode) async {
    // DOPSUM: CHANGE speakAncestral
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("ancestral"); // DOPSUM: CHANGE TEXT
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "ancestral"), // Find /ænˈsestrəl/
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /ænˈsestrəl/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                            CustomIconButtonBritish(
                              onPressed: () => speakAncestral("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /ænˈsestrəl/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                            CustomIconButtonAmerican(
                              onPressed: () => speakAncestral("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "jszmqmOcrlM";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "BmDvCLFM9b4";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "ho9-WlRHhV8";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "wPlrajJL0-w";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "uaMqzIo5KWY";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "7DWWkU6Jerw";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "dDYyqGIKOZg";
