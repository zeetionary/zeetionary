...
class EnglishEntryinstead extends StatefulWidget {
  const EnglishEntryinstead({super.key});

  @override
  State<EnglishEntryinstead> createState() => _EnglishEntryinsteadState();
}

class _EnglishEntryinsteadState extends State<EnglishEntryinstead> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""instead""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondstwo = 1687;
    const String videoIdthree = 'lex6USTugUU';
    const double startSecondsthree = 282;
    const String videoIdfour = 'Ht0IbFNbfSY';
    const double startSecondsfour = 110;
    const String videoIdfive = 'iKv4oc2zbeA';
