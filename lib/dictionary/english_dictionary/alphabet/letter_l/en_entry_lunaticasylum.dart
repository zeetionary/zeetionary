...
class EnglishEntrylunaticasylum extends StatefulWidget {
  const EnglishEntrylunaticasylum({super.key});

  @override
  State<EnglishEntrylunaticasylum> createState() => _EnglishEntrylunaticasylumState();
}

class _EnglishEntrylunaticasylumState extends State<EnglishEntrylunaticasylum> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylunaticasylum lunatic asylum
WORD_WEB lunatic asylum lunatic asylum lunatic asylum
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lunatic asylum";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lunatic asylum""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lunatic asylum""",
                      // alsoEnglishWord: "also: lunatic asylum",
...
کوردی: 
"""),
// With short examples define "lunatic asylum", please follow LX instructions
