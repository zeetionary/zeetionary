...
class EnglishEntrygiggle extends StatefulWidget {
  const EnglishEntrygiggle({super.key});

  @override
  State<EnglishEntrygiggle> createState() => _EnglishEntrygiggleState();
}

class _EnglishEntrygiggleState extends State<EnglishEntrygiggle> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The girls giggled at the joke.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She giggled with delight.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She gave a nervous giggle.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Matt collapsed into giggles and hung up the phone.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We only did it for a giggle.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I get the giggles when I'm nervous.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """giggle""",
                      // alsoEnglishWord: "also: giggle",
                      britshText: """IpaUK: /ˈɡɪɡl/""",
                      americanText: """IpaUS: /ˈɡɪɡl/""",
...
// With short examples define "giggle", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) پێکەنین بە بە شێوەیەکی گێلانە بەهۆی ئەوەی شەرمەزار یان شڵەژاویت، یان پێتوایە شتێک پێکەنیناوییە"""),
                    SentencesRow(
                      englishText: """The girls giggled at the joke.""",
                      kurdishText: """کچەکان بە نوکتەکە خشیان بردبووەوە.""",
                    ...
                    SentencesRow(
                      englishText: """She giggled with delight.""",
                      kurdishText: """لە خۆشیدا حیلکەیان دەهات.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) کەمێک پێکەنینی دووبارەی گێلانە"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Matt collapsed into giggles and hung up the phone.""",
                      kurdishText: """مات کەوتە قاقا و تەلەفۆنەکەی داخستەوە.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) شتێک کە پێتوایە پێکەنیناوییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We only did it for a giggle.""",
                      kurdishText: """تەنها بۆ پێکەنین کردمان.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ناو) پێکەنینی بەردەوام کە ناتوانیت بیوەستێنیت"""),
                    const DividerSentences(),
                    SentencesRow(
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/PqpCeiYycVM?t=';
const double _startSecondsend = 000000000000000000000000000939;
const String _videoIdone = 'https://youtu.be/Wiy8icSKKQs?t=';
...
const String _videoIdthree = 'https://youtu.be/jfpZQyinCBo?t=';
const double _startSecondsthree = 000000000000000000000000000102;
const String _videoIdfour = 'https://youtu.be/ZChccKUYVRg?t=';
const double _startSecondsfour = 000000000000000000000000000513;
const String _videoIdfive = 'https://youtu.be/K3v5wFMQRqs?t=';
const double _startSecondsfive = 000000000000000000000000000866;
