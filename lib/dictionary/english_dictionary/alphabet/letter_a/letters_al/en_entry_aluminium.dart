...
class EnglishEntryaluminium extends StatelessWidget {
  EnglishEntryaluminium({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakaluminium(String languageCode) async {
    // DOPSUM: CHANGE speakAluminium
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUK: /ˌæljəˈmɪniəm/, /ˌæləˈmɪniəm/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUS: /ˌæljəˈmɪniəm/, /ˌæləˈmɪniəm/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '4xsj2O_fRnc';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'JZXcjvnLjJg';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'X3ftxamng7M';
