...
class EnglishEntryfaroff extends StatefulWidget {
  const EnglishEntryfaroff({super.key});

  @override
  State<EnglishEntryfaroff> createState() => _EnglishEntryfaroffState();
}

class _EnglishEntryfaroffState extends State<EnglishEntryfaroff> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""far-off""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """far-off""",
                      // alsoEnglishWord: "also: far-off",
                      britshText: """IpaUK: /ˈfɑːr ɒf/""",
                      americanText: """IpaUS: /ˈfɑːr ɔːf/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They dreamed of visiting a far-off land.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Far-off days are hard to remember clearly.""");
  }
...
// With short examples define "far-off", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: زۆر دوور، دوورکەوتە، چەپرەک
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) زۆر دوور"""),
          SentencesRow(
            englishText: """They dreamed of visiting a far-off land.""",
            kurdishText:
                """خەونیان بە سەردانکردنی زەوییەکی دوورکەوتەوە دەبینی.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: far-off
1. Very far away in space or time (= faraway)
"troops landing on far-off shores"; "far-off happier times";
""",
  );
...
const double _startSecondsend = 0000000000000000000000000001307;
const String _videoIdone = 'https://youtu.be/CQQit01HHLY?t=';
const double _startSecondsone = 000000000000000000000000000611;
const String _videoIdtwo = 'https://youtu.be/qr_dTySMl7s?t=';
const double _startSecondstwo = 000000000000000000000000000879;
const String _videoIdthree = 'https://youtu.be/092PIJKKgFo?t=';
const double _startSecondsthree = 000000000000000000000000000304;
const String _videoIdfour = 'https://youtu.be/Tc_HhuikGCc';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/y4DTW4B3Sjs?t=';
