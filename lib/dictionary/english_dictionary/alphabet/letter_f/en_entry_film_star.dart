...
class EnglishEntryfilmstar extends StatefulWidget {
  const EnglishEntryfilmstar({super.key});

  @override
  State<EnglishEntryfilmstar> createState() => _EnglishEntryfilmstarState();
}

class _EnglishEntryfilmstarState extends State<EnglishEntryfilmstar> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "film star";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""film star""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He dreams of becoming a film star one day.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """film star""",
                      // alsoEnglishWord: "also: film star",
                      britshText: """IpaUK: /ˈfɪlm stɑː(r)/""",
                      americanText: """IpaUS: /ˈfɪlm stɑːr/""",
...
کوردی: ئەستێرەی فیلم یان سینەما
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە بەناوبانگە بۆ بوون لە فیلمدا"""),
                    SentencesRow(
                      englishText:
                          """He dreams of becoming a film star one day.""",
                      kurdishText:
                          """خەون بەوەوە دەبینێت ڕۆژێک ببێتە ئەستێرەی فیلم.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/PHLY4a5fTjU?t=';
const double _startSecondsend = 000000000000000000000000000434;
const String _videoIdone = 'https://youtu.be/6VJtBntjgsM?t=';
const double _startSecondsone = 00000000000000000000000000069;
const String _videoIdtwo = 'https://youtu.be/aqKm-tYHlwM?t=';
const double _startSecondstwo = 000000000000000000000000000110;
const String _videoIdthree = 'https://youtu.be/runjda4La_4?t=';
const double _startSecondsthree = 0000000000000000000000000001315;
const String _videoIdfour = 'https://youtu.be/VD8DhU8r-vI?t=';
const double _startSecondsfour = 0000000000000000000000000005;
const String _videoIdfive = 'https://youtu.be/RWYE1Ka11y0?t=';
const double _startSecondsfive = 0000000000000000000000000001089;
