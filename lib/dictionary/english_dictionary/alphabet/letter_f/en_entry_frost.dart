...
class EnglishEntryfrost extends StatefulWidget {
  const EnglishEntryfrost({super.key});

  @override
  State<EnglishEntryfrost> createState() => _EnglishEntryfrostState();
}

class _EnglishEntryfrostState extends State<EnglishEntryfrost> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frost (Derived forms: frosts)
1. Ice crystals forming a white deposit (especially on objects outside) (- hoar, hoarfrost, rime)
 
2. Weather cold enough to cause freezing (- freeze)
 
3. The formation of frost or ice on a surface (- icing)

- Verb: frost (Derived forms: frosts, frosting, frosted)
1. [N. Amer] (cooking) decorate with frosting (- ice)
"frost a cake";
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It will be a clear night with some ground frost.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The winter frosts have arrived.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The car windows were covered with frost.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The windows had frosted over.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Leave the cake to cool before frosting it.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frost""",
                      // alsoEnglishWord: "also: frost",
                      britshText: """IpaUK: /frɒst/""",
                      americanText: """IpaUS: /frɔːst/""",
...
کوردی: سەهۆڵ‌بەندان، بەستەڵەک، شەختەبەندان، قۆناخی سەهۆڵ‌بەندان، سەردەمی بەستەڵەک،	سەهۆڵ،	زوقم، ئەڵماسە، سیخوار، قەل، شەڵتە، خووس، خویز، ئاڵشت، زەمەگولیلک، سووخ،	شەختەبەند، جەبەرە، تۆف‌وبەند، نەختە، سەرمای توند یان سەغڵەت،	بنەوەی سیفر، ژێر سیفر،	(زمانی خەڵک) بەزین، تێ‌شکان
"""),
// With short examples define "frost", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەشووهەوایەک کە تێیدا پلەی گەرمی دادەبەزێتە خوار سفر و چینێکی تەنک لە سەهۆل لەسەر زەوی درووست دەبێت"""),
                    SentencesRow(
                      englishText:
                          """It will be a clear night with some ground frost.""",
                      kurdishText:
                          """شەوێکی ساماڵ دەبێت بە کەمێک سەهۆڵبەندانی سەر زەوییەوە.""",
                    ...
                    SentencesRow(
                      englishText: """The winter frosts have arrived.""",
                      kurdishText: """زوقمی زستانان دەستی پێکردوەە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ئەو سەهۆڵەی کە درووست دەبێت لە کەشووهەوایەکی وەهادا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The car windows were covered with frost.""",
                      kurdishText:
                          """جامەکانی ئۆۆتمبێلەکە بە زوقم داپۆشرابوون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بهێڵە کێکەکە سارد ببێتەوە پێش ڕووپۆشکردنی.""",
...
const String _videoIdone = 'https://youtu.be/olHw-8py9K0?t=';
const double _startSecondsone = 000000000000000000000000000150;
const String _videoIdtwo = 'https://youtu.be/a9m3GD0DbPY?t=';
const double _startSecondstwo = 000000000000000000000000000957;
const String _videoIdthree = 'https://youtu.be/OVnCW3ZLX58?t=';
const double _startSecondsthree = 0000000000000000000000000006;
const String _videoIdfour = 'https://youtu.be/gfCLXaKq5q4?t=';
const double _startSecondsfour = 00000000000000000000000000044;
const String _videoIdfive = 'https://youtu.be/4FMZhW3cVb4';
