...
class EnglishEntryhibernation extends StatefulWidget {
  const EnglishEntryhibernation({super.key});

  @override
  State<EnglishEntryhibernation> createState() =>
      _EnglishEntryhibernationState();
}

class _EnglishEntryhibernationState extends State<EnglishEntryhibernation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hibernation (Derived forms: hibernations)
...
""",
  ...
  final String keyword = "hibernation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hibernation""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Bears go into hibernation in the autumn.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hibernation""",
                      // alsoEnglishWord: "also: hibernation",
                      britshText: """IpaUK: /ˌhaɪbəˈneɪʃn/""",
                      americanText: """IpaUS: /ˌhaɪbərˈneɪʃn/""",
...
کوردی: زستانەخەو، سڕبوون، مات‌بوون، مت‌بوون
"""),
// With short examples define "hibernation", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دۆخێک کە وەک خەوی قووڵ وایە هەندێک ئاژەڵ زستانی تێدا بەسەر دەبەن"""),
                    SentencesRow(
                      englishText:
                          """Bears go into hibernation in the autumn.""",
                      kurdishText: """ورچ دەچێتە دۆخی متبوون لە پاییزدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/vFYIIR55xbU?t=';
const double _startSecondsend = 000000000000000000000000000250;
const String _videoIdone = 'https://youtu.be/IT-HoBPSR78?t=';
const double _startSecondsone = 000000000000000000000000000223;
const String _videoIdtwo = 'https://youtu.be/LDyzABbHcEY?t=';
const double _startSecondstwo = 000000000000000000000000000308;
const String _videoIdthree = 'https://youtu.be/oJLA8iNUV-0?t=';
const double _startSecondsthree = 0000000000000000000000000001213;
const String _videoIdfour = 'https://youtu.be/UMbqE6BTcuY?t=';
const double _startSecondsfour = 000000000000000000000000000488;
const String _videoIdfive = 'https://youtu.be/9vgnXRypc4o?t=';
const double _startSecondsfive = 000000000000000000000000000355;
