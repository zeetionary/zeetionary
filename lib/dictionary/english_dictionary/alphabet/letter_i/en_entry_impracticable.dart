...
class EnglishEntryimpracticable extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impracticable""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'o0Exu8S7gQg';
    const double startSecondsend = 2003;
    const String videoIdone = '9F3WRMlZEy4';
    const double startSecondsone = 553;
    const String videoIdtwo = 'uZ6FH7F2gLs';
    const double startSecondstwo = 800;
    const String videoIdthree = 'WuY0nIkt7lE';
    const double startSecondsthree = 251;
    const String videoIdfour = 'WVCNUOk-O9E';
    const double startSecondsfour = 4343;
    const String videoIdfive = 'rfRL1a14444';
    const double startSecondsfive = 1234;
