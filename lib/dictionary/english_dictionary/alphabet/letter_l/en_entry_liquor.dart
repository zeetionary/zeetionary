...
class EnglishEntryliquor extends StatefulWidget {
  const EnglishEntryliquor({super.key});

  @override
  State<EnglishEntryliquor> createState() => _EnglishEntryliquorState();
}

class _EnglishEntryliquorState extends State<EnglishEntryliquor> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: liquor (Derived forms: liquors)
1. An alcoholic beverage that is distilled rather than fermented (- spirits [Brit], hard drink, hard liquor, John Barleycorn [informal], strong drink, spirit [Brit])
 
2. A liquid substance that is a solution (or emulsion or suspension) used or obtained in an industrial process
"waste liquors"
 
3. The liquid in which vegetables or meat have been cooked (- pot liquor [US], pot likker [US, informal])

- Verb: liquor (Derived forms: liquored, liquors, liquoring)
1. Steep in water, esp. malt for brewing
""",
  );

  final String keyword = "liquor";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He spent most of his money on liquor and drugs.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/gjySnrspD7E?t=657';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/AAGIi62-sAU?t=81';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/qWAagS_MANg?t=94';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/Md-iBTwN4Kc?t=378';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/qzEoBrr9gRA?t=4';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/y4DTW4B3Sjs?t=995';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """liquor""",
                      // alsoEnglishWord: "also: liquor",
                      britshText: """IpaUK: /ˈlɪkə(r)/""",
                      americanText: """IpaUS: /ˈlɪkər/""",
...
کوردی: 
"""),
// With short examples define "liquor", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) خواردنەوەی کحوولیی توند لە ئەمریکا؛ لە بەریتانیا هەر مادەیەکی کحوولییە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: spirit"),
                    SentencesRow(
                      englishText: """He spent most of his money on liquor and drugs.""",
                      kurdishText: """زۆرینەی پارەکەیی بە شەراب و مادەی هۆشبەر خەرج کرد.""",
