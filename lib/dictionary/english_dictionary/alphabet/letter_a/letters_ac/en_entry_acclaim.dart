...
class EnglishEntryacclaim extends StatefulWidget {
  const EnglishEntryacclaim({super.key});

  @override
  State<EnglishEntryacclaim> createState() => _EnglishEntryacclaimState();
}

class _EnglishEntryacclaimState extends State<EnglishEntryacclaim> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acclaim""",
                      // alsoEnglishWord: "also: acclaim",
                      britshText: """IpaUK: /əˈkleɪm/""",
                      americanText: """IpaUS: /əˈkleɪm/""",
