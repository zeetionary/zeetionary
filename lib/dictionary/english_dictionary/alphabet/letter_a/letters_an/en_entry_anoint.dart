...
// replace these: replace EnglishEntryanoint - replace speakAnoint - replace anoint - /əˈnɔɪnt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryanoint extends StatelessWidget {
  // blank divider
  EnglishEntryanoint({super.key});
  ...
  Future<void> speakAnoint(String languageCode) async {
    ...
    await flutterTts.speak("anoint"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAnoint949(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The priest anointed her with oil."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "anoint"), // DOPSUM: CHANGE WORD ENTRY - Find /əˈnɔɪnt/
                            // divvviiider
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /əˈnɔɪnt/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                            CustomIconButtonBritish(
                              onPressed: () =>
                                  speakAnoint(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /əˈnɔɪnt/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                            CustomIconButtonAmerican(
                              onPressed: () => speakAnoint(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "FwrynHAB5KE";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "CrKkjXMYFzs";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "Ubn7cLLxR80";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "P2XlPvijHOA";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "YW0oyHvetqY";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "NfTXLJJg-Mw";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "LA0Y0TydEIg";
