...
// Define the word "authorization" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace authorization - replace EnglishEntryauthorization

// replace speakAuthorization - /ˌɔːθəraɪˈzeɪʃn/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryauthorization extends StatelessWidget {
  // blank divider
  EnglishEntryauthorization({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "authorization"),
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌɔːθəraɪˈzeɪʃn/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌɔːθərəˈzeɪʃn/"),
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'KwUlRtU3leU';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '5c0xkgX4itQ';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'v9GODjGXju0';
...
// end authorization // TODO Implement this library.