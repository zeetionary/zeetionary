...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'h8VHaNeuw3o';
    const double startSecondsend = 716;
    const String videoIdone = 'QKIobyk6Isc';
    const double startSecondsone = 249;
    const String videoIdtwo = 'wG8gYDWj-mg';
    const double startSecondstwo = 240;
    const String videoIdthree = '9euW5iCjKDo';
    const double startSecondsthree = 451;
    const String videoIdfour = 'FKTicVgp8zU';
    const double startSecondsfour = 189;
    const String videoIdfive = 'K4Ze-Sp6aUE';
    const double startSecondsfive = 5390;
