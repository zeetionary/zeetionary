...
class EnglishEntryadequate extends StatelessWidget {
  EnglishEntryadequate({super.key});
                        ...
                        Row(
                          children: [
                            ...
                            CustomIconButtonBritish(
                              onPressed: () => speakadequate("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈædɪkwət/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakadequate("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'u4bBQ2tNLCY';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '-iPq3-b8pwU';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'YeLpUt04Ses';
  final double _startSeconds = 1;
