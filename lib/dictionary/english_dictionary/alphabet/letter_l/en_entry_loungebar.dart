...
class EnglishEntryloungebar extends StatefulWidget {
  const EnglishEntryloungebar({super.key});

  @override
  State<EnglishEntryloungebar> createState() => _EnglishEntryloungebarState();
}

class _EnglishEntryloungebarState extends State<EnglishEntryloungebar> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryloungebar lounge bar
WORD_WEB lounge bar lounge bar lounge bar
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lounge bar";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lounge bar""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lounge bar""",
                      // alsoEnglishWord: "also: lounge bar",
...
کوردی: 
"""),
// With short examples define "lounge bar", please follow LX instructions
