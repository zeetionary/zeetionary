...
class EnglishEntryfatty extends StatefulWidget {
  const EnglishEntryfatty({super.key});

  @override
  State<EnglishEntryfatty> createState() => _EnglishEntryfattyState();
}

class _EnglishEntryfattyState extends State<EnglishEntryfatty> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fatty""",
                      // alsoEnglishWord: "also: fatty",
                      britshText: """IpaUK: /ˈfæti/""",
                      americanText: """IpaUS: /ˈfæti/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Goose is a very fatty meat.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was teased in school for being a fatty.""");
  }
...
کوردی: چەور، بەپیو، بەزاوی، زوم‌دار، پڕچەور
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) کە چەوری زۆر لەخۆ دەگرێت"""),
          SentencesRow(
            englishText: """Goose is a very fatty meat.""",
            kurdishText: """قاز گۆشتی زۆر چەوری هەیە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """لە قوتابخانە گاڵتەی پێدەکرا بۆ ئەوەی کە خرتەڵەیە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fatty (Derived forms: fattier, fattiest)
1. Containing or composed of fat (= fat)
"fatty food";
 
2. (medicine) having accumulated fat

 -Noun: fatty (Derived forms: fatties)
Usage: informal
1. A rotund individual (= fatso [informal], fat person, roly-poly [informal], butterball [N. Amer, informal])
""",
  );
...
const String _videoIdone = 'https://youtu.be/7EnWiGYT1g4?t=';
...
const String _videoIdthree = 'https://youtu.be/nCPIKP_84qs?t=';
const double _startSecondsthree = 00000000000000000000000000069;
const String _videoIdfour = 'https://youtu.be/mRj1RKh4xyY?t=294';
const double _startSecondsfour = 000000000000000000000000000;
const String _videoIdfive = 'https://youtu.be/mRj1RKh4xyY?t=';
const double _startSecondsfive = 000000000000000000000000000294;
