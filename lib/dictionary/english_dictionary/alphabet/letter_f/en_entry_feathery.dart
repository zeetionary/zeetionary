...
"""),
          ...
          SentencesRow(
            ...
            kurdishText:
                """قژێکی زەردی پەڕئاسای ھەیە کە لەبەر خۆرەکە دەدرەوشێتەوە.""",
...
const String _videoIdend = 'DMRMWLwvAGA';
const double _startSecondsend = 557;
const String _videoIdone = 'Fa13JKGG0ds';
const double _startSecondsone = 204;
const String _videoIdtwo = '6i9UUvxhAlY';
const double _startSecondstwo = 233;
const String _videoIdthree = 'JBwIhLFTbiA';
const double _startSecondsthree = 68;
const String _videoIdfour = '8mCcM-PUmLM';
const double _startSecondsfour = 622;
const String _videoIdfive = 'h5b4r6AB9J4';
const double _startSecondsfive = 263;
