...
// Define the word "backbiting" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace backbiting - replace EnglishEntrybackbiting

// replace speakBackbiting - /ˈbækbaɪtɪŋ/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntrybackbiting extends StatelessWidget {
  // blank divider
  EnglishEntrybackbiting({super.key});
  // blank divider
  ...
  Future<void> speakA3(String languageCode) async {
    ...
    await flutterTts.speak("backbiting"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakA3s1(String languageCode) async {
    ...
    await flutterTts.speak(
        "He was tired of all the backbiting and gossip in the office."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "backbiting"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /ˈbækbaɪtɪŋ/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /ˈbækbaɪtɪŋ/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find WORD_WEB
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "wVt7YCjF1AI";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "5g_HHd_kxFg";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "cpZYJF050k8";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "uXUqeZOlOeA";

  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 2936, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
      autoPlay: true,
      enableCaption: true,
      loop: true,
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "S--L6owD0go";
