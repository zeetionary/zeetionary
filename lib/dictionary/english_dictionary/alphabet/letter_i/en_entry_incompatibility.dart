...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001028;
    const String videoIdone = 'https://youtu.be/1MGNw-Y2QPk?t=';
    const double startSecondsone = 00000000000000000000000000095;
    const String videoIdtwo = 'https://youtu.be/qadSvKa2eHY?t=';
    const double startSecondstwo = 00000000000000000000000000068;
    const String videoIdthree = 'https://youtu.be/I-GpS5PCcLc?t=';
    const double startSecondsthree = 00000000000000000000000000051;
    const String videoIdfour = 'https://youtu.be/BOdca_kJimE?t=';
    const double startSecondsfour = 000000000000000000000000000277;
    const String videoIdfive = 'https://youtu.be/dyZQxlBvnE8?t=';
