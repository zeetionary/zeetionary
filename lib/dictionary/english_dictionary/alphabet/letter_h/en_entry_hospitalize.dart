...
class EnglishEntryhospitalize extends StatefulWidget {
  const EnglishEntryhospitalize({super.key});

  @override
  State<EnglishEntryhospitalize> createState() =>
      _EnglishEntryhospitalizeState();
}

class _EnglishEntryhospitalizeState extends State<EnglishEntryhospitalize> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: hospitalize (Derived forms: hospitalized, hospitalizes, hospitalizing)
1. Admit into a hospital (- hospitalise [Brit])
"Mother had to be hospitalized because her blood pressure was too high";
""",
  );

  final String keyword = "hospitalize";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hospitalize""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/o62UrPGwFNs?t=';
    const double startSecondsend = 0000000000000000000000000001951;
    const String videoIdone = 'https://youtu.be/Qm4cAaAFhEs?t=';
    const double startSecondsone = 0000000000000000000000000001096;
    const String videoIdtwo = 'https://youtu.be/mVBCrQ1RQoI?t=';
    const double startSecondstwo = 000000000000000000000000000518;
    const String videoIdthree = 'https://youtu.be/-ajU9Nx8Gh8?t=';
    const double startSecondsthree = 0000000000000000000000000001087;
    const String videoIdfour = 'https://youtu.be/91vMHoXumDI?t=';
    const double startSecondsfour = 000000000000000000000000000254;
    const String videoIdfive = 'https://youtu.be/SzGe0tvFVPQ?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hospitalize""",
                      // alsoEnglishWord: "also: hospitalize",
                      britshText: """IpaUK: /ˈhɒspɪtəlaɪz/""",
                      americanText: """IpaUS: /ˈhɑːspɪtəlaɪz/""",
...
کوردی: 
"""),
// With short examples define "hospitalize", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) بردنی کەسێک بۆ نەخۆشخانە"""),
                    SentencesRow(
                      englishText:
                          """Eight people were hospitalized after receiving bullet wounds.""",
                      kurdishText:
                          """هەشت بردرانە نەخۆشخانە لە دوای هەبوونی برینی فیشەک.""",
