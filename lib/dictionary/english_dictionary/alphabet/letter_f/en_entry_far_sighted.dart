...
class EnglishEntryfarsighted extends StatefulWidget {
  const EnglishEntryfarsighted({super.key});

  @override
  State<EnglishEntryfarsighted> createState() => _EnglishEntryfarsightedState();
}

class _EnglishEntryfarsightedState extends State<EnglishEntryfarsighted> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""far-sighted""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """far-sighted""",
                      // alsoEnglishWord: "also: far-sighted",
                      britshText: """IpaUK: /ˌfɑː ˈsaɪtɪd/""",
                      americanText: """IpaUS: /ˌfɑːr ˈsaɪtɪd/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "far-sighted";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """It is rare to find such a farsighted and courageous politician.""");
  }
...
// With short examples define "far-sighted", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) ئەوەی کە پێشبینی کاریگەری ئەو کارانە بکەیت کە ئێستا دەیانکەیت و پلانیان بۆ دابنێیت"""),
          SentencesRow(
            englishText:
                """It is rare to find such a farsighted and courageous politician.""",
            kurdishText:
                """دەگمەنە سیاسەتمەدارێکی دووربین و بوێری وەها بدۆزیتەوە.""",
          ...
          SentencesRow(
            englishText:
                """I'm so farsighted, I can't read the newspaper without my glasses.""",
            kurdishText:
                """زۆر دووربینم، ناتوانم ڕۆژنامەکە بەبێ چاویلکەکەم بخوێنمەوە.""",
...
1. Planning prudently for the future (= farseeing, foresighted, foresightful, prospicient, long, long-sighted [Brit])
"large goals that required farsighted policies";
 
2. [N. Amer] (ophthalmology) having abnormal vision, unable to focus sharply on things that are nearby (= hyperopic, hypermetropic, long-sighted [Brit])
 
3. Capable of seeing to a great distance (= eagle-eyed, keen-sighted, farseeing, long-sighted [Brit])
""",
  );
...
const String _videoIdend = 'https://youtu.be/rgwIKktAvBw?t=';
const double _startSecondsend = 000000000000000000000000000359;
const String _videoIdone = 'https://youtu.be/MazI9dFA6ME?t=';
const double _startSecondsone = 000000000000000000000000000545;
const String _videoIdtwo = 'https://youtu.be/qn8tLbXWAtc?t=';
const double _startSecondstwo = 0000000000000000000000000006289;
const String _videoIdthree = 'https://youtu.be/nJs1dLGbGZY?t=';
const double _startSecondsthree = 000000000000000000000000000155;
const String _videoIdfour = 'https://youtu.be/nP0aKBhga-o?t=';
const double _startSecondsfour = 000000000000000000000000000934;
const String _videoIdfive = 'https://youtu.be/d2szo16g0fI?t=';
const double _startSecondsfive = 000000000000000000000000000424;
