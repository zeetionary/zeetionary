...
class EnglishEntryfig extends StatefulWidget {
  const EnglishEntryfig({super.key});

  @override
  State<EnglishEntryfig> createState() => _EnglishEntryfigState();
}

class _EnglishEntryfigState extends State<EnglishEntryfig> {
  @override
  void initState() {
    super.initState();
...
2. Mediterranean tree widely cultivated for its edible fruit (= common fig, common fig tree, Ficus carica)
 
3. Fleshy sweet pear-shaped yellowish or purple multiple fruit eaten fresh or preserved or dried
""",
  );

  final String keyword = "fig";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She added figs to the salad.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Figs are rich in fiber and nutrients.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fig""",
                      // alsoEnglishWord: "also: fig",
                      britshText: """IpaUK: /fɪɡ/""",
                      americanText: """IpaUS: /fɪɡ/""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/wwamAM1Io30?t=';
const double _startSecondsend = 00000000000000000000000000011;
const String _videoIdone = 'https://youtu.be/KlU-CCF-j9M';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/GhMbvPXx4aU?t=';
const double _startSecondstwo = 00000000000000000000000000011;
const String _videoIdthree = 'https://youtu.be/Qxrl--Nj0VY?t=';
const double _startSecondsthree = 0000000000000000000000000008;
const String _videoIdfour = 'https://youtu.be/K6R1P8RqDoI?t=';
const double _startSecondsfour = 00000000000000000000000000011;
const String _videoIdfive = 'https://youtu.be/ARc0tsq6e_o';
