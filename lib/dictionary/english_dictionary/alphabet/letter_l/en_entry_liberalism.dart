...
class EnglishEntryliberalism extends StatefulWidget {
  const EnglishEntryliberalism({super.key});

  @override
  State<EnglishEntryliberalism> createState() => _EnglishEntryliberalismState();
}

class _EnglishEntryliberalismState extends State<EnglishEntryliberalism> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""liberalism""");
  }
