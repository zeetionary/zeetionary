...
class EnglishEntryexude extends StatefulWidget {
  const EnglishEntryexude({super.key});

  @override
  State<EnglishEntryexude> createState() => _EnglishEntryexudeState();
}

class _EnglishEntryexudeState extends State<EnglishEntryexude> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exude""",
                      // alsoEnglishWord: "also: exude",
                      britshText: """IpaUK: /ɪɡˈzjuːd/""",
                      americanText: """IpaUS: /ɪɡˈzuːd/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She exuded confidence.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The plant exudes a sticky fluid.""");
  }
...
"""),
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """An awful smell exuded from the creature's body.""",
            kurdishText: """بۆنێکی پیس لە جەستەی گیانلەبەرەکەوە دێتە دەرەوە.""",
...
2. Make apparent by one's mood or behaviour
...
const String _videoIdend = 'https://youtu.be/fHS2cqjijIk?t=';
const double _startSecondsend = 00000000000000000000000000077;
const String _videoIdone = 'https://youtu.be/vx09_4cEzlM?t=';
const double _startSecondsone = 000000000000000000000000000778;
const String _videoIdtwo = 'https://youtu.be/_rjmTjXYheE?t=';
const double _startSecondstwo = 000000000000000000000000000440;
const String _videoIdthree = 'https://youtu.be/HzUIUTatyZI?t=';
const double _startSecondsthree = 000000000000000000000000000133;
const String _videoIdfour = 'https://youtu.be/JAF-VEAuyVQ?t=';
const double _startSecondsfour = 000000000000000000000000000130;
const String _videoIdfive = 'https://youtu.be/nDEyQB0Jjkw?t=';
