...
class EnglishEntrylineup extends StatefulWidget {
  const EnglishEntrylineup({super.key});

  @override
  State<EnglishEntrylineup> createState() => _EnglishEntrylineupState();
}

class _EnglishEntrylineupState extends State<EnglishEntrylineup> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""line-up""");
  }
