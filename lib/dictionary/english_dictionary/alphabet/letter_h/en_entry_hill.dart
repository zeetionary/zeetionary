...
class EnglishEntryhill extends StatefulWidget {
  const EnglishEntryhill({super.key});

  @override
  State<EnglishEntryhill> createState() => _EnglishEntryhillState();
}

class _EnglishEntryhillState extends State<EnglishEntryhill> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hill (Derived forms: hills)
1. A local and well-defined elevation of the land
"they loved to roam the hills of West Virginia"
 
2. Structure consisting of an artificial heap or bank usually of earth or stones (- mound)
"they built small hills to hide behind";
 
3. (baseball) the slight elevation on which the pitcher stands (- mound, pitcher's mound)

- Verb: hill (Derived forms: hilling, hills, hilled)
1. Form into a hill

- Noun: Hill (Derived forms: Hills)
1. Risqué English comedian (1925-1992) (- Benny Hill, Alfred Hawthorne)
 
2. United States railway tycoon (1838-1916) (- James J. Hill, J. J. Hill, James Jerome Hill)
""",
  );

  final String keyword = "hill";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The church is perched on a hill.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They make their way up the hill.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We started to walk back down the hill.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Always take care when driving down steep hills.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The bus sped down the long hill.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001478;
    const String videoIdone = 'https://youtu.be/Z75Hsp-2zaw?t=';
    const double startSecondsone = 00000000000000000000000000062;
    const String videoIdtwo = 'https://youtu.be/TOTd78ZTDGE?t=';
    const double startSecondstwo = 00000000000000000000000000010;
    const String videoIdthree = 'https://youtu.be/AF8d72mA41M?t=';
    const double startSecondsthree = 0000000000000000000000000001403;
    const String videoIdfour = 'https://youtu.be/W8uXhQnWgj4?t=';
    const double startSecondsfour = 000000000000000000000000000153;
    const String videoIdfive = 'https://youtu.be/0SeM5eqlNVg?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hill""",
                      // alsoEnglishWord: "also: hill",
                      britshText: """IpaUK: /hɪl/""",
                      americanText: """IpaUS: /hɪl/""",
...
کوردی: تەپۆڵکە، تەپە، گرد، زورک، کەژ، گوژمە، گر، گدو، زینوو،	لێژایی، سەرەولێژی، تەلان، لاپێ، لێژ،	کۆما، لۆدە
"""),
// With short examples define "hill", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بەرزاییەک کە لە دەشتی دەرووبەری بەرزترە بەڵام بە قەد چیا نا"""),
                    SentencesRow(
                      englishText: """The church is perched on a hill.""",
                      kurdishText: """کڵێساکە لەسەر گردێک هەڵکەوتووە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The house is built on the side of a hill overlooking the river.""",
                      kurdishText:
                          """خانووەکە لەسەر لاپاڵی گردێک درووستکراوە کە بەسەر ڕووبارەکە دەڕوانێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They make their way up the hill.""",
                      kurdishText: """بەسەر گردەکەدا سەردەکەون.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We started to walk back down the hill.""",
                      kurdishText:
                          """دەستمان کرد بە چوونە خوارەوە بە گردەکەدا.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) لێژایی سەر ڕێگایەک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Always take care when driving down steep hills.""",
                      kurdishText:
                          """هەمیشە ئاگادار بە کە بە لێژایی زۆر سەرەوخوار شۆفێری دەکەیت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The bus sped down the long hill.""",
                      kurdishText: """پاسەکە لە لێژاییە درێژەکە خێرا بوو.""",
