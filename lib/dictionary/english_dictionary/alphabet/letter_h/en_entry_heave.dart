...
کوردی: لێنەوین، بەرزکردنەوە، ھەڵکێشان،	خستن، ھاویشتن، تووڕھەڵدان، حەودان،	تەکان، گوڕم،	(دەریا) شەپۆلاوی‌بوون،	جێگۆڕکێی ڕەگ یان چینەکانی زەوی
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) بەرزکردنەوە، ڕاکێشان، یان فڕێدانی کەسێک/شتێکی زۆر قورس بە ھیزی زۆرەوە"""),
                    SentencesRow(
                      englishText: """We all heaved on the rope.""",
                      kurdishText: """ھەموومان حەبلەکەمان ڕاکێشا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) بەرزبوونەوە و دانیشتن بە جووڵەی توند و بەھێزەوە"""),
                    SentencesRow(
                      englishText: """The boat heaved beneath them.""",
                      kurdishText: """بەلەمەکە لە ژێریاندا نقەی دەھات.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    // const DividerDefinition(),
                    // const DefinitionKurdish(text: """ژمممر. (کردار) پنننسە"""),
                    // const DividerSentences(),
                    // SentencesRow(
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) دەرکردنی دەنگێک بە ھێواشی و ھەوڵدانەوە"""),
                    SentencesRow(
                      englishText: """We all heaved a sigh of relief.""",
                      kurdishText: """ھەموومان ئاھێکی ئاسوودەییمان ھەڵکێشا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (کردار) ھەبوونی ئەو ھەستەی کە پێش ڕشانەوە دەتبێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: retch"),
                    SentencesRow(
                      englishText: """The thought of it makes me heave.""",
                      kurdishText: """بیرکردنەوە لێی ھێڵنجم بۆ دێنێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە بەرزکردنەوەیەکی بەھێزەوە کیسەکەی بەرزکردە سەر بارھەڵگرەکە.""",
...
const String _videoIdend = 'tSzlgybdkFA';
const double _startSecondsend = 394;
const String _videoIdone = 'f8euUepDo5w';
const double _startSecondsone = 382;
const String _videoIdtwo = 'R6gZoAzAhCg';
const double _startSecondstwo = 281;
const String _videoIdthree = '0_KhihMIOG8';
const double _startSecondsthree = 113;
const String _videoIdfour = 'TZANFlvsXv4';
const double _startSecondsfour = 294;
const String _videoIdfive = 'x9RiG0jINsw';
