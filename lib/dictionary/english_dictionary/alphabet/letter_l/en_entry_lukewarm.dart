...
class EnglishEntrylukewarm extends StatefulWidget {
  const EnglishEntrylukewarm({super.key});

  @override
  State<EnglishEntrylukewarm> createState() => _EnglishEntrylukewarmState();
}

class _EnglishEntrylukewarmState extends State<EnglishEntrylukewarm> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylukewarm lukewarm
WORD_WEB lukewarm lukewarm lukewarm
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lukewarm";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lukewarm""");
  }
...
کوردی: 
"""),
// With short examples define "lukewarm", please follow LX instructions
