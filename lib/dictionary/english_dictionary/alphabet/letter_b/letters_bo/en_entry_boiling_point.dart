...
// Define the word "boiling point" and for each meaning provide five real life example sentences that consist of less than 12 words. Use  Oxford Advanced Learner's Dictionary style. Provide at least 5 meanings or more for each types of speech that the word has.

// replace boiling point - /ˈbɔɪlɪŋ pɔɪnt/

enum TtsState { playing }

class EnglishEntryboilingpoint extends StatelessWidget {
// blank divider
  EnglishEntryboilingpoint({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakboilingpoint(String languageCode) async {
    // DOPSUM: CHANGE speakboilingpoint
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("boiling point"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakboilingpoints1(String languageCode) async {
    // DOPSUM: CHANGE speakboilingpoint
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The boiling point of water is 100°C."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakboilingpoints2(String languageCode) async {
    // DOPSUM: CHANGE speakboilingpoint
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "Public frustration has reached boiling point."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakboilingpoints3(String languageCode) async {
    // DOPSUM: CHANGE speakboilingpoint
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "Kate’s anger was reaching boiling point."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakboilingpoints4(String languageCode) async {
    // DOPSUM: CHANGE speakboilingpoint
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakboilingpoints44"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakboilingpoints5(String languageCode) async {
    // DOPSUM: CHANGE speakboilingpoint
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakboilingpoints55"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakboilingpoints6(String languageCode) async {
    // DOPSUM: CHANGE speakboilingpoint
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakboilingpoints66"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakboilingpoints7(String languageCode) async {
    // DOPSUM: CHANGE speakboilingpoint
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakboilingpoints77"); // DOPSUM: CHANGE TEXT
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "boiling point"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈbɔɪlɪŋ pɔɪnt/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakboilingpoint("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈbɔɪlɪŋ pɔɪnt/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakboilingpoint("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  ...
  final String _videoId = 'zhK-XjrFwhg';
...
class _YoutubeEmbeddedfourState extends State<YoutubeEmbeddedfour> {
  late YoutubePlayerController _controller;
  final String _videoId = 'BhqcprmntPY';
...
class _YoutubeEmbeddedsevenState extends State<YoutubeEmbeddedseven> {
  late YoutubePlayerController _controller;
  final String _videoId = '16gB2BDXwTo';
...
class _YoutubeEmbeddednineState extends State<YoutubeEmbeddednine> {
  late YoutubePlayerController _controller;
  final String _videoId = 'VzqN4Cn8r3U';
...
class _YoutubeEmbeddedelevenState extends State<YoutubeEmbeddedeleven> {
  late YoutubePlayerController _controller;
  final String _videoId = 'BfDLoIvb0w4';
...
class _YoutubeEmbeddedtwelveState extends State<YoutubeEmbeddedtwelve> {
  late YoutubePlayerController _controller;
  final String _videoId = 'jBXm8fCWdo8';
