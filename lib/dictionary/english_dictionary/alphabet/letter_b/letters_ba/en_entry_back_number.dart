...
// Define the word "back number" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace back number - replace EnglishEntrybacknumber

// replace speakBacknumber - /ˈbæk nʌmbə(r)/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntrybacknumber extends StatelessWidget {
  // blank divider
  EnglishEntrybacknumber({super.key});
  // blank divider
  ...
  Future<void> speaka3(String languageCode) async {
    ...
    await flutterTts.speak("back number");
  }
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /ˈbæk nʌmbə(r)/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /ˈbæk nʌmbər/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find WORD_WEB
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'wgbpcvdISJI';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'yYGKteR6RKY';
  final double _startSeconds = 4997;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'beo-B-Iv4ds';
  final double _startSeconds = 2482;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'fpm3gpD-HXA';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'nWzTq1ZOFSU';
