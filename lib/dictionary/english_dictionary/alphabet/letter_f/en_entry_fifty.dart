...
class EnglishEntryfifty extends StatefulWidget {
  const EnglishEntryfifty({super.key});

  @override
  State<EnglishEntryfifty> createState() => _EnglishEntryfiftyState();
}

class _EnglishEntryfiftyState extends State<EnglishEntryfifty> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They were driving fifty (miles an hour).""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The film was made fifty years ago.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There are about fifty calories in an apple.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was born in the fifties.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fifty""",
                      // alsoEnglishWord: "also: fifty",
                      britshText: """IpaUK: /ˈfɪfti/""",
                      americanText: """IpaUS: /ˈfɪfti/""",
...
// With short examples define "fifty", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """They were driving fifty (miles an hour).""",
                      kurdishText: """پەنجا میل لە کاتژمێرێکدا دەچوون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/nW948Va-l10?t=';
const double _startSecondsend = 000000000000000000000000000111;
const String _videoIdone = 'https://youtu.be/8_AE-QHWj-A?t=';
const double _startSecondsone = 000000000000000000000000000197;
const String _videoIdtwo = 'https://youtu.be/b2lDdwxNWto?t=';
const double _startSecondstwo = 000000000000000000000000000205;
const String _videoIdthree = 'https://youtu.be/PmlRbfSavbI?t=';
const double _startSecondsthree = 000000000000000000000000000467;
const String _videoIdfour = 'https://youtu.be/kTaYet07Ioo?t=';
const double _startSecondsfour = 000000000000000000000000000263;
const String _videoIdfive = 'https://youtu.be/bqMV2whnNjg?t=';
const double _startSecondsfive = 0000000000000000000000000001102;
