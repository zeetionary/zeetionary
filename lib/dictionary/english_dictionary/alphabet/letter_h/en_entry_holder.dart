...
class EnglishEntryholder extends StatefulWidget {
  const EnglishEntryholder({super.key});

  @override
  State<EnglishEntryholder> createState() => _EnglishEntryholderState();
}

class _EnglishEntryholderState extends State<EnglishEntryholder> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: holder (Derived forms: holders)
1. A holding device
"a towel holder"; "a cigarette holder"; "an umbrella holder"
 
2. A person who holds something
"Permit holders are also required to have a valid business licence"
 
3. The person who is in possession of a check or note or bond or document of title that is endorsed to him or to whoever holds it (- bearer)
"the bond was marked 'payable to holder'";
 
4. A person who occupies a place or a position (- occupant)
""",
  );

  final String keyword = "holder";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Only ticket holders will be allowed in.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She wondered why the previous job holder had left.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The pen holder keeps the desk organized.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000592;
    const String videoIdone = 'https://youtu.be/qWAagS_MANg?t=';
    const double startSecondsone = 000000000000000000000000000669;
    const String videoIdtwo = 'https://youtu.be/mcZdTvOqmvI?t=';
    const double startSecondstwo = 000000000000000000000000000638;
    const String videoIdthree = 'https://youtu.be/u9Xt4TRrc3I?t=';
    const double startSecondsthree = 000000000000000000000000000671;
    const String videoIdfour = 'https://youtu.be/LP6ppSM3xq4?t=';
    const double startSecondsfour = 000000000000000000000000000380;
    const String videoIdfive = 'https://youtu.be/9yjZpBq1XBE?t=';
    const double startSecondsfive = 0000000000000000000000000003550;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """holder""",
                      // alsoEnglishWord: "also: holder",
                      britshText: """IpaUK: /ˈhəʊldə(r)/""",
                      americanText: """IpaUS: /ˈhəʊldər/""",
...
// With short examples define "holder", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Account holders with the bank qualify for a discount on loans.""",
                      kurdishText:
                          """خاوەن هەژماران لە بانکەکە دەکرێت داشکاندن وەربگرن لە قەرزەکان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تەنها خاوەن بلیتەکان دەکرێنە ژوورەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بیری دەکردەوە کە بۆچی خاوەن کارەکەی پێشووتر ڕۆشتبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پێنووس‌ڕاگرەکە دێسکەکە بە ڕێکخراوی دەهێڵێتەوە.""",
