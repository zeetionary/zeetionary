...
class EnglishEntryhear extends StatefulWidget {
  const EnglishEntryhear({super.key});

  @override
  State<EnglishEntryhear> createState() => _EnglishEntryhearState();
}

class _EnglishEntryhearState extends State<EnglishEntryhear> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: hear (Derived forms: hears, hearing, heard)
1. Perceive (sound) via the auditory sense
 
2. Get to know or become aware of, usually accidentally (- learn, get word, get wind, pick up, find out, get a line, discover, see)
"I heard that she has two grown-up children";
 
3. Examine or hear (evidence or a case) by judicial process (- try)
"The jury had heard all the evidence";
 
4. Receive a communication from someone
"We heard nothing from our son for five years"
 
5. Take careful note; follow advice (- listen, take heed)
"We must hear the expert before we make a decision";
""",
  );

  final String keyword = "hear";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I can't hear very well.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He heard a noise and went to investigate.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She could hear voices in the kitchen.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She heard footsteps behind her.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He could hear a dog barking.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Didn't you hear what I said?""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He knows that the crowd wants to hear those songs.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Langgard's music is rarely heard outside Denmark.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Have you ever heard him lecture?""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We'd better hear what they have to say.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Things are going well from what I hear.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I was sorry to hear about your accident.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Come on! I want to hear all about it.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Wait till he hears about this.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I've heard about people like you.""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""When I heard the news, I was devastated.""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I was delighted to hear your good news.""");
  }
  ...
  Future<void> speaksentence18(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Today the court began to hear the evidence.""");
  }
...
// کوردی:
// """),
// With short examples define "hear", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) گوێ لێبوون"""),
                    SentencesRow(
                      englishText: """I can't hear very well.""",
                      kurdishText: """ناتوانم زۆر باش گوێم لێ بێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ژاوەژاوێکی گوێ لێ بوو و ڕۆشت بۆ لێکۆڵینەوە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She could hear voices in the kitchen.""",
                      kurdishText: """گوێ لە دەنگ بوو لە چێشتخانەکەوە.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She heard footsteps behind her.""",
                      kurdishText: """گوێی لە تەپەی پێ بوو لە پشتییەوە.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He could hear a dog barking.""",
                      kurdishText: """گوێی لە سەگێک بوو دەیحەپاند.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Didn't you hear what I said?""",
                      kurdishText: """گوێت لێ نەبوو چیم گوت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) گوێگرتن یان سەرنجدان بە کەسێک/شتێک"""),
                    SentencesRow(
                      englishText:
                          """He knows that the crowd wants to hear those songs.""",
                      kurdishText:
                          """دەزانێت کە خەڵکەکە دەیانەوێت گوێیان لەو گۆرانییانە بێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """میوزیکی لانگارد بە ئەستەم دەبیسترێت لە دەرەوەی دانیمارک.""",
                      onPressedBritish: () => speaksentence8("en-GB"),
                      onPressedAmerican: () => speaksentence8("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Have you ever heard him lecture?""",
                      kurdishText: """هەرگیز گوێت لێی بووە وانە بڵێتەوە؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """باشترە گوێمان لێ بێت چی دەڵێن.""",
                      onPressedBritish: () => speaksentence10("en-GB"),
                      onPressedAmerican: () => speaksentence10("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (کردار) ئەوەی لەسەر شتێک پێت بگوترێت"""),
                    SentencesRow(
                      englishText:
                          """Things are going well from what I hear.""",
                      kurdishText:
                          """شتەکان باش بەڕێوە دەچن بەپێی ئەوەی بیستوومە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بەداخەوە بووم کە سەبارەت بە ڕووداوەکەت بیستم.""",
                      onPressedBritish: () => speaksentence12("en-GB"),
                      onPressedAmerican: () => speaksentence12("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Come on! I want to hear all about it.""",
                      kurdishText:
                          """یەڵلا! ئەمەوێت گوێم لە هەمووی بێت دەربارەی.""",
                      onPressedBritish: () => speaksentence13("en-GB"),
                      onPressedAmerican: () => speaksentence13("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Wait till he hears about this.""",
                      kurdishText: """بوەستە تا ئاگای لەمە دەبێت.""",
                      onPressedBritish: () => speaksentence14("en-GB"),
                      onPressedAmerican: () => speaksentence14("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I've heard about people like you.""",
                      kurdishText: """ئاگام لە کەسانی وەک تۆ بووە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کە هەواڵەکەم بیست داڕووخام.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دڵخۆش بووم کە هەواڵە خۆشەکەتم بیست.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (کردار) گوێگرتن لە کەیسێک لە دادگا و بڕیاردان لەسەری"""),
                    SentencesRow(
                      englishText:
                          """Today the court began to hear the evidence.""",
                      kurdishText:
                          """ئەمڕۆ دادگا دەستی کرد بە گوێگرتن لە بەڵگەکان.""",
...
const double _startSecondsone = 0000000000000000000000000003545;
const String _videoIdtwo = 'https://youtu.be/_spuxXnul0U?t=';
const double _startSecondstwo = 000000000000000000000000000473;
const String _videoIdthree = 'https://youtu.be/hS2x1zl4rn0?t=';
const double _startSecondsthree = 000000000000000000000000000620;
const String _videoIdfour = 'https://youtu.be/wizgxRBfVTY?t=';
const double _startSecondsfour = 000000000000000000000000000166;
const String _videoIdfive = 'https://youtu.be/G4BxOhJOmUw?t=';
