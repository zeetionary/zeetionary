...
class EnglishEntrylegible extends StatefulWidget {
  const EnglishEntrylegible({super.key});

  @override
  State<EnglishEntrylegible> createState() => _EnglishEntrylegibleState();
}

class _EnglishEntrylegibleState extends State<EnglishEntrylegible> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""legible""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The signature was still legible.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The price must be legible to a purchaser.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/9vuqI2v2IRs?t=12';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/JcpboMScfIY?t=1401';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/Unzc731iCUY?t=1738';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/8ext9G7xspg?t=10296';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/7UHQzuwqZM0?t=1211';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/DgZo_Ac00jc?t=319';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """legible""",
                      // alsoEnglishWord: "also: legible",
                      britshText: """IpaUK: /ˈledʒəbl/""",
                      americanText: """IpaUS: /ˈledʒəbl/""",
...
کوردی: خوانا، وانا، ڕوون، ڕۆشن، خوێنراوە، جوان‌نووسراو
"""),
// With short examples define "legible", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) کە هێندە ڕوونە بخوێندرێتەوە"""),
                    SentencesRow(
                      englishText: """The signature was still legible.""",
                      kurdishText: """واژۆکە هێشتا دەخوێندرایەوە.""",
                    ...
                    SentencesRow(
                      englishText: """The price must be legible to a purchaser.""",
                      kurdishText: """نرخەکە دەبێت بۆ کڕیار بخوێندرێتەوە.""",
