...
class EnglishEntrydam extends StatefulWidget {
  const EnglishEntrydam({super.key});

  @override
  State<EnglishEntrydam> createState() => _EnglishEntrydamState();
}

class _EnglishEntrydamState extends State<EnglishEntrydam> {
  @override
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "dam");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: dam");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakdam(String languageCode) async {
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakdams1(String languageCode) async {
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
...
"""),
          ...
          SentencesRow(
            ...
            kurdishText: "بەنداوەکە داڕووخا و دۆڵەکە کەوتە ژێر ئاو.",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'JXK9DC3Y2MU';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'V5Fn-OU-A7I';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'w4FB9Omjn94';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '_BCY0SPOFpE';
