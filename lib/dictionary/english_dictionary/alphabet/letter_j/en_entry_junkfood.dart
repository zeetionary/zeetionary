...
class EnglishEntryjunkfood extends StatefulWidget {
  const EnglishEntryjunkfood({super.key});

  @override
  State<EnglishEntryjunkfood> createState() => _EnglishEntryjunkfoodState();
}

class _EnglishEntryjunkfoodState extends State<EnglishEntryjunkfood> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""junk food""");
  }
