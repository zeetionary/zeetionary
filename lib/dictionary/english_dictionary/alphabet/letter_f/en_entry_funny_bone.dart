...
class EnglishEntryfunnybone extends StatefulWidget {
  const EnglishEntryfunnybone({super.key});

  @override
  State<EnglishEntryfunnybone> createState() => _EnglishEntryfunnyboneState();
}

class _EnglishEntryfunnyboneState extends State<EnglishEntryfunnybone> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: funny bone (Derived forms: funny bones)
Usage: Brit, Cdn (US: crazy bone)
1. A point on the elbow where the ulnar nerve passes near the surface; a sharp tingling sensation results when the nerve is knocked against the bone (- crazy bone [N. Amer])
"the funny bone is not humerus";
""",
  );

  final String keyword = "funny bone";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She accidentally struck her funny bone on the door.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """funny bone""",
                      // alsoEnglishWord: "also: funny bone",
                      britshText: """IpaUK: /ˈfʌni bəʊn/""",
                      americanText: """IpaUS: /ˈfʌni bəʊn/""",
...
کوردی: ئێسکی ئانیشک، کنگە ئانیشک
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەو بەشەی ئانیشک کە دەماری زۆر هەستیار لەخۆ دەگرێت و ئازاری زۆری دەبێت ئەگەر بیکێشیت بە شتێکدا"""),
                    SentencesRow(
                      englishText:
                          """She accidentally struck her funny bone on the door.""",
                      kurdishText:
                          """بە ڕێکەوت ئێسکی ئانیشکیی کێشا بە دەرگاکەدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/h5rliCqB-4Y?t=';
const double _startSecondsend = 000000000000000000000000000663;
...
const String _videoIdthree = 'https://youtu.be/8KXZiLPAhMA?t=';
const double _startSecondsthree = 000000000000000000000000000105;
const String _videoIdfour = 'https://youtu.be/aw3N5h7tfsU?t=';
const double _startSecondsfour = 00000000000000000000000000046;
const String _videoIdfive = 'https://youtu.be/0xrQaK7CnRA?t=';
