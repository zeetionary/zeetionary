...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/_plc81p5xNw?t=';
    const double startSecondsend = 0000000000000000000000000001432;
    const String videoIdone = 'https://youtu.be/PWilradvu6s?t=';
    const double startSecondsone = 00000000000000000000000000047;
    const String videoIdtwo = 'https://youtu.be/yCiNxEpZnqs';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/745WT5bcFwA?t=';
    const double startSecondsthree = 000000000000000000000000000677;
    const String videoIdfour = 'https://youtu.be/StcSHmBZj2k?t=';
    const double startSecondsfour = 0000000000000000000000000002564;
    const String videoIdfive = 'https://youtu.be/B48cfVFWxcw?t=';
