...
class EnglishEntryendowment extends StatefulWidget {
  const EnglishEntryendowment({super.key});

  @override
  State<EnglishEntryendowment> createState() => _EnglishEntryendowmentState();
}

class _EnglishEntryendowmentState extends State<EnglishEntryendowment> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""endowment""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """endowment""",
                      // alsoEnglishWord: "also: endowment",
                      britshText: """IpaUK: /ɪnˈdaʊmənt/""",
                      americanText: """IpaUS: /ɪnˈdaʊmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "endowment";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Few people are blessed with her mental endowments.""");
  }
...
کوردی: بەخشین، پێدان،	تەرخان، داهاتی تەرخان‌کراو، تەرخانە،	توانایی، توانایی سروشتی، خواپێداوی، بەهرە، نێعمەت
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) پارەیەک کە وەک یارمەتی دەدریت بە بە قوتابخانە، کۆلێژ، یان پەیمانگایەکی دیکە"""),
          SentencesRow(
            englishText:
                """The school has received an endowment of £50,000 to buy new books for the library.""",
            kurdishText:
                """قوتابخانەکە یارمەتیی ٥٠٠٠٠ پاوەندی وەرگرتووە بۆ کڕینی کتێبی تازە بۆ کتێبخانەکە.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) شتێک کە لە منداڵییەوە هەتە"""),
          // const DividerSentences(),
          SentencesRow(
            englishText:
                """Few people are blessed with her mental endowments.""",
            kurdishText: """کەم کەس خواپێداویی دەروونی ئەویان هەیە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: endowment (Derived forms: endowments)
1. A natural ability or quality (= gift, talent, natural endowment)
 
2. The capital that provides income for an institution (= endowment fund)
...
const double _startSecondsend = 1136;
const String _videoIdone = 'https://youtu.be/aTMsfOcHiJg?t=';
const double _startSecondsone = 529;
const String _videoIdtwo = 'https://youtu.be/Oese1nrwXk0?t=';
const double _startSecondstwo = 104;
const String _videoIdthree = 'https://youtu.be/YytF2v7Vvw0?t=';
const double _startSecondsthree = 821;
const String _videoIdfour = 'https://youtu.be/TVCEvx8JCTQ?t=';
const double _startSecondsfour = 401;
const String _videoIdfive = 'https://youtu.be/9vd3iZDN_OI?t=';
const double _startSecondsfive = 250;
const String _videoIdsix = 'https://youtu.be/mtvmqI0PV2M?t=';
const double _startSecondssix = 126;
