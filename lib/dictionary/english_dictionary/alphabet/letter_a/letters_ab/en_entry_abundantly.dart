...
class EnglishEntryabundantly extends StatefulWidget {
  const EnglishEntryabundantly({super.key});

  @override
  State<EnglishEntryabundantly> createState() => _EnglishEntryabundantlyState();
}

class _EnglishEntryabundantlyState extends State<EnglishEntryabundantly> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "abundantly";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """abundantly""",
                      // alsoEnglishWord: "also: abundantly",
                      britshText: """IpaUK: /əˈbʌndəntli/""",
                      americanText: """IpaUS: /əˈbʌndəntli/""",
