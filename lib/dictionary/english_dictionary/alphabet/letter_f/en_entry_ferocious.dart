...
class EnglishEntryferocious extends StatefulWidget {
  const EnglishEntryferocious({super.key});

  @override
  State<EnglishEntryferocious> createState() => _EnglishEntryferociousState();
}

class _EnglishEntryferociousState extends State<EnglishEntryferocious> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: ferocious
1. Marked by extreme and violent energy (= fierce, furious, savage)
"a ferocious beating";
""",
  );

  final String keyword = "ferocious";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""ferocious""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's got a ferocious temper.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The president came in for some ferocious criticism.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ferocious""",
                      // alsoEnglishWord: "also: ferocious",
                      britshText: """IpaUK: /fəˈrəʊʃəs/""",
                      americanText: """IpaUS: /fəˈrəʊʃəs/""",
...
const String _videoIdone = 'https://youtu.be/wMw83xuK5CQ?t=';
const double _startSecondsone = 00000000000000000000000000076;
const String _videoIdtwo = 'https://youtu.be/S3R4k7YlEXc?t=';
const double _startSecondstwo = 000000000000000000000000000258;
const String _videoIdthree = 'https://youtu.be/ug-pOdhVzLs?t=';
const double _startSecondsthree = 000000000000000000000000000390;
const String _videoIdfour = 'https://youtu.be/Mg3UG9aOo3E?t=';
const double _startSecondsfour = 00000000000000000000000000030;
const String _videoIdfive = 'https://youtu.be/zDVHVueSCP8?t=';
