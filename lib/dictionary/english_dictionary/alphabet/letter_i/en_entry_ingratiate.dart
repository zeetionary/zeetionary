...
class EnglishEntryingratiate extends StatefulWidget {
  const EnglishEntryingratiate({super.key});

  @override
  State<EnglishEntryingratiate> createState() => _EnglishEntryingratiateState();
}

class _EnglishEntryingratiateState extends State<EnglishEntryingratiate> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ingratiate""");
  }
