...
class EnglishEntrylie extends StatefulWidget {
  const EnglishEntrylie({super.key});

  @override
  State<EnglishEntrylie> createState() => _EnglishEntrylieState();
}

class _EnglishEntrylieState extends State<EnglishEntrylie> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: lie (Derived forms: lying, lies, lain, lay)
...
5. Have a place in relation to something else (- rest)
"The fate of Bosnia lies in the hands of the West";
 
6. Assume a reclining position (- lie down)
"lie down on the bed until you feel better";

- Noun: lie (Derived forms: lies)
1. Position or manner in which something is situated (- lay)

- Noun: lie
1. A statement that deviates from or perverts the truth (- prevarication)

- Verb: lie (Derived forms: lied, lying, lies)
1. Tell an untruth; pretend with intent to deceive
"Don't lie[2] to your parents"
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She lay in bed listening to music.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Lie there for a bit until you feel better.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The cat was lying fast asleep by the fire.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was lying next to his wife in bed.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I lay on the grass and fell asleep.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He just lay there smiling.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was lying face down in the mud.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Lie face up on the floor.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Lie still and try to sleep.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Clothes were lying all over the floor.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She picked up a pen that was lying nearby.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The book lay open on the desk.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Broken glass lay scattered all over the floor.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He found a piece of quartz lying on the sand.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The books lay gathering dust on the shelf.""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Houses lie empty while people are homeless.""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""These machines have lain idle since the factory closed.""");
  }
  ...
  Future<void> speaksentence18(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Much of the city now lay in ruins.""");
  }
  ...
  Future<void> speaksentence19(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'd rather use my money than leave it lying in the bank.""");
  }
  ...
  Future<void> speaksentence20(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The problem lies in deciding when to intervene.""");
  }
  ...
  Future<void> speaksentence21(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The fault lies with you.""");
  }
  ...
  Future<void> speaksentence22(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The answer seems to lie elsewhere.""");
  }
  ...
  Future<void> speaksentence23(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""My main interest lies in his early work.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/I4o7caGRmwk?t=2371';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/Lhpu3GdlV3w?t=1993';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/3lkG_MD7T9U?t=19';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/K77az04O5DM?t=34';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/poTqVcSgFRE?t=124';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/-APcPQUDyNk?t=748';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lie""",
                      // alsoEnglishWord: "also: lie",
                      britshText: """IpaUK: /laɪ/""",
                      americanText: """IpaUS: /laɪ/""",
...
کوردی: 
"""),
// With short examples define "lie", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) ڕاکشان"""),
                    SentencesRow(
                      englishText: """She lay in bed listening to music.""",
                      kurdishText:
                          """لە جێخەوەکەیدا ڕاکشابوو گوێی لە میوزیک دەگرت.""",
                        ...
                        MyExpansionTile(
                          children: [
                            SentencesRow(
                              ...
                              kurdishText:
                                  """کەمێک لەوێدا ڕابکشێ تاوەکو هەست بە باشتر دەکەیت.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """پشیلەکە ڕاکشا و زوو خەوی لێکەوت لە نزیک ئاگرەکە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """لە نزیک هاوسەرەکەی لە جێخەودا ڕاکشابوو.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """لەسەر چیمەنەکە ڕاکشام و خەوم لێکەوت.""",
                            ...
                            const DividerSentences(),
                            SentencesRow(
                              englishText: """He just lay there smiling.""",
                              kurdishText:
                                  """تەنها لەوێ ڕاکشابوو بزەی دەکرد.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText: """لەسەر دەم لە قوڕەکە ڕاکشابوو.""",
                            ...
                            const DividerSentences(),
                            SentencesRow(
                              englishText: """Lie face up on the floor.""",
                              kurdishText:
                                  """لەسەر پشت لەسەر زەوییەکە ڕاکشێ.""",
                            ...
                            const DividerSentences(),
                            SentencesRow(
                              englishText: """Lie still and try to sleep.""",
                              kurdishText:
                                  """بێ جووڵە ڕاکشێ و هەوڵ بدە بخەوە.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) ئەوەی لەسەر ڕوویەک کەوتبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Clothes were lying all over the floor.""",
                      kurdishText: """جل لەسەر هەموو زەوییەکە کەوتبوون.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She picked up a pen that was lying nearby.""",
                      kurdishText: """پێنووسێکی هەڵگرت کە لەو ناوە کەوتبوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The book lay open on the desk.""",
                      kurdishText: """پەرتووکەکە بە کراوەیی لەسەر دێسکەکە کەوتبوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Broken glass lay scattered all over the floor.""",
                      kurdishText: """گڵاسی شکاو بە خاشکراوی لەسەر زەوییەکە کەوتبوون.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He found a piece of quartz lying on the sand.""",
                      kurdishText: """پارچە کوارتزێکی دۆزییەوە کە لەسەر خۆڵەکە کەوتبوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The books lay gathering dust on the shelf.""",
                      kurdishText: """پەتووکەکان کەوتوون لەسەر ڕەفەکە و تۆزیان لێنیشتووە.""",
                      onPressedBritish: () => speaksentence15("en-GB"),
                      onPressedAmerican: () => speaksentence15("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) ئەوەی لە دۆخێکی دیاریکراو بمێنیتەوە یان بپارێزرێیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Houses lie empty while people are homeless.""",
                      kurdishText: """خانووەکان بە بەتاڵی ماونەتەوە لە کاتێکدا خەڵکی بێلانەن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """These machines have lain idle since the factory closed.""",
                      kurdishText: """ئەم ئامێرانە بێکار کەوتوون لەوەتەی کارگەکە داخراوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Much of the city now lay in ruins.""",
                      kurdishText: """زۆرێک لە شارەکە ئێستا وێرانەیە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I'd rather use my money than leave it lying in the bank.""",
                      kurdishText: """پێم باشترە پارەکەم بەکاربێنم وەک لەوەی دایبنێم کەوتبێت لە بانکدا.""",
                      onPressedBritish: () => speaksentence19("en-GB"),
                      onPressedAmerican: () => speaksentence19("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) هەبوون یان بۆهاتن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The problem lies in deciding when to intervene.""",
                      kurdishText: """کێشەکە وەستاوەتە سەر بڕیاردانی ئەوەی کەی دەستێوەردان بکرێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The fault lies with you.""",
                      kurdishText: """کێشەکە لای تۆیە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The answer seems to lie elsewhere.""",
                      kurdishText: """وەڵامەکە وەها دەردەکەوێت لە جێگای دیکە بێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """My main interest lies in his early work.""",
                      kurdishText: """حەزی سەرەکیم بۆ کارەکانی سەرەتاییەتی.""",
