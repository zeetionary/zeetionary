...
class EnglishEntryinhibit extends StatefulWidget {
  const EnglishEntryinhibit({super.key});

  @override
  State<EnglishEntryinhibit> createState() => _EnglishEntryinhibitState();
}

class _EnglishEntryinhibitState extends State<EnglishEntryinhibit> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: inhibit (Derived forms: inhibiting, inhibited, inhibits)
...
3. Consciously restrain from showing; of emotions, desires, impulses, or behaviour (- bottle up, suppress)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inhibit""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Alcohol significantly inhibits the action of the drug.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/saLcKOmPVlg?t=';
    const double startSecondsone = 00000000000000000000000000089;
    const String videoIdtwo = 'https://youtu.be/6aOGxhbe-Hc?t=';
    const double startSecondstwo = 000000000000000000000000000319;
    const String videoIdthree = 'https://youtu.be/LQ8JOsc3-wU?t=';
    const double startSecondsthree = 000000000000000000000000000240;
    const String videoIdfour = 'https://youtu.be/xSdWog85Esw?t=';
    const double startSecondsfour = 000000000000000000000000000365;
    const String videoIdfive = 'https://youtu.be/Rz1X0RP3Mfw?t=';
    const double startSecondsfive = 000000000000000000000000000470;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inhibit""",
                      // alsoEnglishWord: "also: inhibit",
                      britshText: """IpaUK: /ɪnˈhɪbɪt/""",
                      americanText: """IpaUS: /ɪnˈhɪbɪt/""",
...
کوردی: 
"""),
// With short examples define "inhibit", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) واکردنی ئەوەی شتێک چی دیکە ڕوونەدات یان هێواشتر یان کەمتر لە جاران ڕووبدات"""),
                    SentencesRow(
                      englishText:
                          """Alcohol significantly inhibits the action of the drug.""",
                      kurdishText:
                          """کحوول بە ئاستێکی زۆر کاریگەریی دەرمانەکە کەمدەکاتەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Financial considerations are inhibiting access to higher education.""",
                      kurdishText:
                          """کێشەی دارایی ڕاگەشتن خوێندنی باڵا کەمدەکەنەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """A lack of oxygen may inhibit brain development in the unborn child.""",
                      kurdishText:
                          """کەمی ئۆکسجین گەشەی منداڵی لەدایک‌نەبوو هێواش دەکات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) شڵەژاندن یان شەرمەزارکردنی کەسێک بە شێوەیەک کە نەتوانن شتێک بکەن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The fear of dismissal inhibited employees from raising problems.""",
                      kurdishText:
                          """ترسی دەرکردن ڕێگری لە کارمەندان دەکرد باسی کێشەکان بکەن.""",
