...
class EnglishEntryflyingsaucer extends StatefulWidget {
  const EnglishEntryflyingsaucer({super.key});

  @override
  State<EnglishEntryflyingsaucer> createState() =>
      _EnglishEntryflyingsaucerState();
}

class _EnglishEntryflyingsaucerState extends State<EnglishEntryflyingsaucer> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flying saucer (Derived forms: flying saucers)
1. An (apparently) flying object whose nature is unknown; especially those considered to have extraterrestrial origins (= unidentified flying object, UFO)
""",
  );

  final String keyword = "flying saucer";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flying saucer""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She claimed to have photographed a flying saucer.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flying saucer""",
                      // alsoEnglishWord: "also: flying saucer",
                      britshText: """IpaUK: /ˌflaɪɪŋ ˈsɔːsə(r)/""",
                      americanText: """IpaUS: /ˌflaɪɪŋ ˈsɔːsər/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەشتییەکی ئاسمانی کە هەندێک کەس بانگەشەی ئەوە دەکەن بینیویان بێت و لە هەسارەیەکی دیکەوە بێت"""),
                    SentencesRow(
                      englishText:
                          """She claimed to have photographed a flying saucer.""",
                      kurdishText:
                          """بانگەشەی ئەوەی دەکرد کە دەفری فڕیوی وێنە گرتبێت.""",
