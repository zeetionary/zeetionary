...
class EnglishEntryeverywhere extends StatefulWidget {
  const EnglishEntryeverywhere({super.key});

  @override
  State<EnglishEntryeverywhere> createState() => _EnglishEntryeverywhereState();
}

class _EnglishEntryeverywhereState extends State<EnglishEntryeverywhere> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""everywhere""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """everywhere""",
                      // alsoEnglishWord: "also: everywhere",
                      britshText: """IpaUK: /ˈevriweə(r)/""",
                      americanText: """IpaUS: /ˈevriwer/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "everywhere";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I've looked everywhere.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He follows me everywhere.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We'll have to eat here—everywhere else is full.""");
  }
...
کوردی: هەموو جێگەیێ، گشت جێیێ، هەرشوێنی، هەر جێیێ
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵکار، جێناو، لێکدەر) هەموو شوێنێک؛ لە هەموو شوێنێک؛ بەرەو هەموو شوێنێک"""),
          SentencesRow(
            englishText: """I've looked everywhere.""",
            kurdishText: """هەموو شوێنێک گەڕاوم.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """ژممارە. (ھاوەڵکار، جێناو، لێکدەر) پێنناسە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """He follows me everywhere.""",
            kurdishText: """بۆ هەموو شوێنێک دوام دەکەوێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """We'll have to eat here—everywhere else is full.""",
            kurdishText: """دەبێت لێرە نان بخۆین ـ هەموو شوێنیک پڕە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Everywhere we went was full of tourists.""",
            kurdishText: """بۆ هەر شوێنێک چووین پڕ لە گەشتیار بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: everywhere
1. To or in any or all places; pronoun, location; quantifier: universal (= everyplace [N. Amer, informal], all over)
"You find fast food stores everywhere"; "people everywhere are becoming aware of the problem"; "he carried a gun everywhere he went";
""",
  );
...
const double _startSecondsend = 000000000000000000000000000000; // 358;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/zmEv7vTOQGE?t=';
const double _startSecondsone = 00000000000000000000000000000; // 2229;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/QY7BWZ_aSc4?t=';
...
const double _startSecondsthree = 000000000000000000000000000; // 173;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/E47mx4rsVCI?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 71;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/2-bQnjgUiUs?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 347;
