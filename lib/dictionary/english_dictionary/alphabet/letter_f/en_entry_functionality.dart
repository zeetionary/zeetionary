...
class EnglishEntryfunctionality extends StatefulWidget {
  const EnglishEntryfunctionality({super.key});

  @override
  State<EnglishEntryfunctionality> createState() =>
      _EnglishEntryfunctionalityState();
}

class _EnglishEntryfunctionalityState extends State<EnglishEntryfunctionality> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: functionality (Derived forms: functionalities)
1. Capable of serving a purpose well
"software with greater functionality"
 
2. The set of functions or operations that a computer or other system is able to perform

""",
  );

  final String keyword = "functionality";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""functionality""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They praised the functionality of the new software.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """functionality""",
                      // alsoEnglishWord: "also: functionality",
                      britshText: """IpaUK: /ˌfʌŋkʃəˈnæləti/""",
                      americanText: """IpaUS: /ˌfʌŋkʃəˈnæləti/""",
...
// With short examples define "functionality", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """They praised the functionality of the new software.""",
                      kurdishText: """پەسنی کارایی نەرمامێرە نوێیەکەیان دا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Manufacturing processes may be affected by the functionality of the product.""",
                      kurdishText:
                          """پڕۆسەی بەرهەمهێنان ڕەنگە کاریگەر بێت بە کارایی بەرهەمەکە.""",
...
const double _startSecondsend = 000000000000000000000000000973;
const String _videoIdone = 'https://youtu.be/xVQxvthAcLU?t=';
const double _startSecondsone = 0000000000000000000000000001607;
const String _videoIdtwo = 'https://youtu.be/U38i32CpYow?t=';
const double _startSecondstwo = 00000000000000000000000000059;
const String _videoIdthree = 'https://youtu.be/ltOkMlHrGPc?t=';
const double _startSecondsthree = 000000000000000000000000000342;
const String _videoIdfour = 'https://youtu.be/mrkAmmMakMg?t=';
const double _startSecondsfour = 000000000000000000000000000140;
const String _videoIdfive = 'https://youtu.be/qkYoBNdcXBU?t=';
