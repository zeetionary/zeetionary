...
class EnglishEntrycategorize extends StatelessWidget {
  // blank divider
  EnglishEntrycategorize({super.key});
  // blank divider
  ...
  Future<void> speakcategorize(String languageCode) async {
    ...
    await flutterTts.speak("categorize"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcategorizes1(String languageCode) async {
    ...
    await flutterTts.speak(
        "Participants were categorized according to age."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcategorizes2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcategorizes22"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcategorizes3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcategorizes33"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcategorizes4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcategorizes44"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcategorizes5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcategorizes55"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcategorizes6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcategorizes66"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcategorizes7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcategorizes77"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcategorizes8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcategorizes88"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcategorizes9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcategorizes99"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcategorizes10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcategorizes1010"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcategorizes11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcategorizes1111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcategorizes12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcategorizes1212"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcategorizes13(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcategorizes1313"); // DOPSUM: CHANGE TEXT
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "categorize"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈkætəɡəraɪz/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcategorize("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈkætəɡəraɪz/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcategorize("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  late YoutubePlayerController _controller;
  final String _videoId = '-JmA5_gHrrM';
