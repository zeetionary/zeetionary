...
class EnglishEntryimproperly extends StatefulWidget {
  const EnglishEntryimproperly({super.key});

  @override
  State<EnglishEntryimproperly> createState() => _EnglishEntryimproperlyState();
}

class _EnglishEntryimproperlyState extends State<EnglishEntryimproperly> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "improperly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""improperly""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was improperly dressed for the occasion.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak(
        """Botulism is a form of food poisoning that occurs after eating improperly canned foods.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/8WQ5MsroXxE?t=';
    const double startSecondsend = 000000000000000000000000000133;
    const String videoIdone = 'https://youtu.be/wPclF09XnDk?t=';
    const double startSecondsone = 00000000000000000000000000057;
    const String videoIdtwo = 'https://youtu.be/zVqFAMOtwaI?t=';
    const double startSecondstwo = 000000000000000000000000000620;
    const String videoIdthree = 'https://youtu.be/iQ5GfDbjos8?t=';
    const double startSecondsthree = 000000000000000000000000000313;
    const String videoIdfour = 'https://youtu.be/3ZRVpYPFOl0?t=';
    const double startSecondsfour = 000000000000000000000000000119;
    const String videoIdfive = 'https://youtu.be/gIhCuqtC0r0?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """improperly""",
                      // alsoEnglishWord: "also: improperly",
                      britshText: """IpaUK: /ɪmˈprɒpəli/""",
                      americanText: """IpaUS: /ɪmˈprɑːpərli/""",
...
کوردی: نەگونجاوانە، بە شێوەیەکی نەشیاو
"""),
// With short examples define "improperly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە لە ڕووی ئەخلاقییەوە هەڵەیە"""),
                    SentencesRow(
                      englishText:
                          """The legislators had acted improperly by making the law retroactive.""",
                      kurdishText: """یاسادانەران بە نەگونجاوی هەنگاویان نا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بە شێوەیەک کە ڕاست یان گونجاوە نییە بۆ دۆخەکە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: inappropriately"),
                    SentencesRow(
                      englishText:
                          """He was improperly dressed for the occasion.""",
                      kurdishText: """بە نەگونجاوی جلی لەبەربوو بۆ بۆنەکە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ھاوەڵکار) بە شێوەیەکی هەڵە و نادرووست"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Botulism is a form of food poisoning that occurs after eating improperly canned foods.""",
                      kurdishText:
                          """بۆتولیزم جۆرێکە لە ژەهراویبوون بە خواردن کە ڕوودەدات لە دوای خواردنی قوتووکراو بە نەگونجاوی.""",
