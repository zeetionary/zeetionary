...
کوردی: مافی دەنگ‌دان،	مافی هەڵبژاردن،	دەستوورنامە،	نوێنەرایەتی (فرۆشتن)، بریکاری،	تایبەت‌ماف، مافی تایبەتی، ئازادی، ئیمتیاز،	(وەرزش) تیمی پیشەیی، هیوای تیم
"""),
// With short examples define "franchise", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مۆڵەتی فەرمیی کۆمپانیایەک بە کەسێک کە دەیەوێت بەرهەمەکانی لە شوێنێکی دیاریکراودا بفرۆشێت"""),
                    SentencesRow(
                      englishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وەک بریکار بەرهەم لە لەندەن و پاریس دەفرۆشن.""",
                      englishNote:
                    ...
                    SentencesRow(
                      englishText:
                          """The franchise was later extended to all adults over eighteen.""",
                      kurdishText:
                          """مافی دەنگدان دواتر زیاد کرا بۆ هەموو ئەو کەسانەی کە لە سەروو هەژدە ساڵەوەن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It was decided that all men in the armed forces should qualify for the franchise.""",
                      kurdishText:
                          """بڕیار درا هەموو ئەندامانی هێزە چەکدارەکان مافی دەنگدانیان هەبێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ناو) ژمارەیەک فیلم کە تێیدا هەمان کۆمەڵە کارەکتەر کە ژمارەیەک فیلم دەردەکەون"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Disney has successfully revived the ‘Star Wars’ franchise, with four films already released and more in the works.""",
                      kurdishText:
                          """دیزنی سەرکەوتووانە ڕەواجی داوە بە زنجیرە فیلمی ستاروۆرز بەوەی چوار فیلم بڵاوکراوە و هی تریش بەڕێوەن.""",
...
const String _videoIdone = 'https://youtu.be/xXvgT-AgLAo?t=';
const double _startSecondsone = 000000000000000000000000000256;
const String _videoIdtwo = 'https://youtu.be/YIafrsAWS1Y?t=';
const double _startSecondstwo = 000000000000000000000000000926;
const String _videoIdthree = 'https://youtu.be/1j_k5WCFShQ?t=';
const double _startSecondsthree = 00000000000000000000000000082;
const String _videoIdfour = 'https://youtu.be/SzwEzpec7CA?t=';
const double _startSecondsfour = 000000000000000000000000000297;
const String _videoIdfive = 'https://youtu.be/4H5--Qy3h9Q';
