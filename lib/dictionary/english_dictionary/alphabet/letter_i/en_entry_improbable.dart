...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000860;
    const String videoIdone = 'https://youtu.be/DxL2HoqLbyA?t=';
    const double startSecondsone = 000000000000000000000000000775;
    const String videoIdtwo = 'https://youtu.be/y__v0aEgzO0?t=';
    const double startSecondstwo = 000000000000000000000000000953;
    const String videoIdthree = 'https://youtu.be/wf6x4FHTMKo?t=';
    const double startSecondsthree = 000000000000000000000000000490;
    const String videoIdfour = 'https://youtu.be/l7xrSigfM7I?t=';
    const double startSecondsfour = 000000000000000000000000000882;
    const String videoIdfive = 'https://youtu.be/PsE10pSYBos?t=';
    const double startSecondsfive = 000000000000000000000000000690;
