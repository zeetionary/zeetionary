...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/mqxgP8WlxJQ?t=';
    const double startSecondsend = 000000000000000000000000000852;
    const String videoIdone = 'https://youtu.be/vjZXcapkFEU?t=';
    const double startSecondsone = 000000000000000000000000000190;
    const String videoIdtwo = 'https://youtu.be/IuGJ8k6lcOY?t=';
    const double startSecondstwo = 000000000000000000000000000712;
    const String videoIdthree = 'https://youtu.be/vTEi5FFxMuE?t=';
    const double startSecondsthree = 000000000000000000000000000235;
    const String videoIdfour = 'https://youtu.be/EMXnJMCoFYI?t=';
    const double startSecondsfour = 0000000000000000000000000001805;
    const String videoIdfive = 'https://youtu.be/COqq7862wcU?t=';
