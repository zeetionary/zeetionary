...
class EnglishEntryimitate extends StatefulWidget {
  const EnglishEntryimitate({super.key});

  @override
  State<EnglishEntryimitate> createState() => _EnglishEntryimitateState();
}

class _EnglishEntryimitateState extends State<EnglishEntryimitate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: imitate (Derived forms: imitated, imitating, imitates)
1. Reproduce someone's behaviour or looks (- copy, simulate)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""imitate""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Teachers provide a model for children to imitate.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He tried to imitate my Scots accent and we both laughed.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/5MwEBEq2Axw?t=';
    const double startSecondsone = 000000000000000000000000000338;
    const String videoIdtwo = 'https://youtu.be/LhR5w1bc6Xg?t=';
    const double startSecondstwo = 000000000000000000000000000659;
    const String videoIdthree = 'https://youtu.be/UG61a5vjxuI?t=';
    const double startSecondsthree = 0000000000000000000000000001147;
    const String videoIdfour = 'https://youtu.be/8X1xYpPmKvA?t=';
    const double startSecondsfour = 000000000000000000000000000603;
    const String videoIdfive = 'https://youtu.be/I720xCnnPUY?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """imitate""",
                      // alsoEnglishWord: "also: imitate",
                      britshText: """IpaUK: /ˈɪmɪteɪt/""",
                      americanText: """IpaUS: /ˈɪmɪteɪt/""",
...
// With short examples define "imitate", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """مامۆستایان دەبن بە نموونەیەک بۆ خوێندکاران کە شوێنیان بکەون.""",
                    ...
                    SentencesRow(
                      englishText:
                          """No computer can imitate the complex functions of the human brain.""",
                      kurdishText:
                          """هیچ کۆمپیوتەرێک ناتوانێت لاسایی ئەرکە ئاڵۆزەکانی مێشکی مرۆڤ باکت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Dolphins learn to imitate sounds very accurately and quickly.""",
                      kurdishText:
                          """دۆڵفین فێر دەبێت زۆر بە درووستی و خێرایی لاسایی دەنگ بکاتەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) لاسایی کردنەوەی شێوازی قسە یان ڕەفتاری کەسێک بۆ ئەوەی خەڵکی پێبکەنن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He tried to imitate my Scots accent and we both laughed.""",
                      kurdishText:
                          """هەوڵی دا لاسایی شێوەزاری سکۆتلەندی بکاتەوە و هەردووکمان پێکەنین.""",
