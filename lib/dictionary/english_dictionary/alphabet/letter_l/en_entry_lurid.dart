...
class EnglishEntrylurid extends StatefulWidget {
  const EnglishEntrylurid({super.key});

  @override
  State<EnglishEntrylurid> createState() => _EnglishEntryluridState();
}

class _EnglishEntryluridState extends State<EnglishEntrylurid> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylurid lurid
WORD_WEB lurid lurid lurid
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lurid";
...
کوردی: 
"""),
// With short examples define "lurid", please follow LX instructions
