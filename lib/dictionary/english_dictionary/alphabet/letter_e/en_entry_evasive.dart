...
// With short examples define "evasive", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/VV83UpkOyR8?t=';
const double _startSecondsend = 000000000000000000000000000000; // 170;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/qg2nGY1aqlg?t=';
const double _startSecondsone = 00000000000000000000000000000; // 671;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/k_LjfwrMr9I?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 558;
const String _videoIdthree = 'VIDEOhttps://youtu.be/Vn09c20wOmI?t=';
const double _startSecondsthree = 000000000000000000000000000; // 299;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/hG0ROjzgEA0?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1222;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/NHTJPd7cnBU?t=';
