...
class EnglishEntryinteract extends StatefulWidget {
  const EnglishEntryinteract({super.key});

  @override
  State<EnglishEntryinteract> createState() => _EnglishEntryinteractState();
}

class _EnglishEntryinteractState extends State<EnglishEntryinteract> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: interact (Derived forms: interacted, interacting, interacts)
1. Act together or towards others or with others
"He should interact more with his colleagues"
""",
  );

  final String keyword = "interact";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""interact""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He interacts very well with other children.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The only thing he interacts with is his computer!""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Perfume interacts with the skin's natural chemicals.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/55XJ1ObZKaM?t=';
    const double startSecondsone = 000000000000000000000000000741;
    const String videoIdtwo = 'https://youtu.be/uKgaVlMN7IY?t=';
    const double startSecondstwo = 00000000000000000000000000049;
    const String videoIdthree = 'https://youtu.be/dtp6b76pMak?t=';
    const double startSecondsthree = 000000000000000000000000000558;
    const String videoIdfour = 'https://youtu.be/J-K5OjAkiEA?t=';
    const double startSecondsfour = 000000000000000000000000000344;
    const String videoIdfive = 'https://youtu.be/PmlRbfSavbI?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """interact""",
                      // alsoEnglishWord: "also: interact",
                      britshText: """IpaUK: /ˌɪntərˈækt/""",
                      americanText: """IpaUS: /ˌɪntərˈækt/""",
...
کوردی: 
"""),
// With short examples define "interact", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) مامەڵە کردن لەگەڵ کەسێک، بە تایبەتی کە کار یان یاری دەکەیت، یان کاتی لەگەڵ بەسەر دەبەیت"""),
                    SentencesRow(
                      englishText:
                          """Teachers have a limited amount of time to interact with each child.""",
                      kurdishText:
                          """مامۆستایان کاتێکی دیاریکراویان هەیە بۆ مامەڵە لەگەڵ هەر منداڵێک.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆر باش مامەڵە لەگەڵ منداڵانی دیکە دەکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەنها شت کە مامەڵەی لەگەڵ دەکات هەر کۆمپیوتەرەکەیەتی!""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) کە شتێک کاریگەریی لەسەر شتێکی دیکە دەبێت یان دوو شت کاریگەرییان لەسەر یەکدی دەبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Perfume interacts with the skin's natural chemicals.""",
                      kurdishText:
                          """بۆن کاریگەریی لەسەر مادە کیمیاییە سرووشتییەکانی جەستە دەبێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """This hormone interacts closely with other hormones in the body.""",
                      kurdishText:
                          """ئەم هۆرمۆنە بە زۆری کاریگەریی دەبێت لەسەر هۆرمۆنەکانی دیکەی جەستە.""",
