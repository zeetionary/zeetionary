...
class EnglishEntryfitted extends StatefulWidget {
  const EnglishEntryfitted({super.key});

  @override
  State<EnglishEntryfitted> createState() => _EnglishEntryfittedState();
}

class _EnglishEntryfittedState extends State<EnglishEntryfitted> {
  @override
  void initState() {
    super.initState();
...
"a fitted overcoat"; "he quickly assembled the fitted pieces"
""",
  );

  final String keyword = "fitted";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The carpenter measured the wall for fitted wardrobes.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We're having a new fitted kitchen put in.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She wore a fitted jacket to the interview.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fitted""",
                      // alsoEnglishWord: "also: fitted",
                      britshText: """IpaUK: /ˈfɪtɪd/""",
                      americanText: """IpaUS: /ˈfɪtɪd/""",
...
// With short examples define "fitted", please follow LX instructions
                    ...
                    AlsoEnglishckblink(
                      ...
                      onTap: () {
                        Routemaster.of(context)
                            .push("/english-fitted/built-in");
                      },
                    ),
                    SentencesRow(
                      englishText:
                          """The carpenter measured the wall for fitted wardrobes.""",
                      kurdishText:
                          """دارتاشەکە دیوارەکەی پێوا بۆ دۆڵابی گونجاو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) ژوورێک کە کەلوپەلی خۆی هەیە و لە شوێنی خۆیان جێگیرکراون"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """We're having a new fitted kitchen put in.""",
                      kurdishText:
                          """چێشتخانەیەکی نوێی گونجێنراومان بۆ دادەنرێت..""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چاکەتێکی تەسکی بۆ چاوپێکەوتنەکە لەبەرکرد.""",
...
const double _startSecondsend = 000000000000000000000000000368;
const String _videoIdone = 'https://youtu.be/vzKuobmi3iI?t=';
const double _startSecondsone = 00000000000000000000000000066;
const String _videoIdtwo = 'https://youtu.be/pTysrwci0pU?t=';
const double _startSecondstwo = 0000000000000000000000000001017;
const String _videoIdthree = 'https://youtu.be/0zXfDafyyao?t=';
const double _startSecondsthree = 000000000000000000000000000335;
const String _videoIdfour = 'https://youtu.be/kcUFSapjVqk?t=';
const double _startSecondsfour = 000000000000000000000000000387;
const String _videoIdfive = 'https://youtu.be/-7bIDbaU_zQ?t=';
