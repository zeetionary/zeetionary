...
class EnglishEntryforger extends StatefulWidget {
  const EnglishEntryforger({super.key});

  @override
  State<EnglishEntryforger> createState() => _EnglishEntryforgerState();
}

class _EnglishEntryforgerState extends State<EnglishEntryforger> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forger (Derived forms: forgers)
1. Someone who operates a forge
 
2. Someone who makes copies illegally (= counterfeiter)
""",
  );

  final String keyword = "forger";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He was the forger of a painting sold as a Rembrandt.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forger""",
                      // alsoEnglishWord: "also: forger",
                      britshText: """IpaUK: /ˈfɔːdʒə(r)/""",
                      americanText: """IpaUS: /ˈfɔːrdʒər/""",
...
// With short examples define "forger", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ساختەکارێکی تابلۆیەک بوو کە وەک کاری ڕێمبراند فرۆشرا.""",
                      englishNote:
                          """This means he was the person who made a fake or imitation painting that was sold as if it were an original work by Rembrandt.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/vsMydMDi3rI?t=';
const double _startSecondsend = 0000000000000000000000000002017;
const String _videoIdone = 'https://youtu.be/gQmiqmxJMtA?t=';
const double _startSecondsone = 00000000000000000000000000017164;
const String _videoIdtwo = 'https://youtu.be/S951cdansBI?t=';
const double _startSecondstwo = 000000000000000000000000000307;
const String _videoIdthree = 'https://youtu.be/g9F9qAT226Y?t=';
const double _startSecondsthree = 00000000000000000000000000021;
const String _videoIdfour = 'https://youtu.be/55sHJVLSLBQ?t=';
const double _startSecondsfour = 000000000000000000000000000236;
const String _videoIdfive = 'https://youtu.be/mezHXskkkPI?t=';
