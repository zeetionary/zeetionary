...
class EnglishEntryhighwayman extends StatefulWidget {
  const EnglishEntryhighwayman({super.key});

  @override
  State<EnglishEntryhighwayman> createState() => _EnglishEntryhighwaymanState();
}

class _EnglishEntryhighwaymanState extends State<EnglishEntryhighwayman> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: highwayman (Derived forms: highwaymen)
1. A holdup man who stops a vehicle and steals from it (- highjacker, hijacker, road agent)
""",
  );

  final String keyword = "highwayman";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""highwayman""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He was held up by highwaymen on the Plymouth road.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Kqu_GOLt20k?t=';
    const double startSecondsend = 000000000000000000000000000421;
    const String videoIdone = 'https://youtu.be/x6xsUxXgv1Q?t=';
    const double startSecondsone = 000000000000000000000000000814;
    const String videoIdtwo = 'https://youtu.be/qqLj6O9kXEQ?t=';
    const double startSecondstwo = 000000000000000000000000000657;
    const String videoIdthree = 'https://youtu.be/WjtE9GaLR8M?t=';
    const double startSecondsthree = 000000000000000000000000000822;
    const String videoIdfour = 'https://youtu.be/fHDwdD-tUkc?t=';
    const double startSecondsfour = 0000000000000000000000000001738;
    const String videoIdfive = 'https://youtu.be/LsZWfZWToro?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """highwayman""",
                      // alsoEnglishWord: "also: highwayman",
                      britshText: """IpaUK: /ˈhaɪweɪmən/""",
                      americanText: """IpaUS: /ˈhaɪweɪmən/""",
...
کوردی: ڕێگر، جەردە، نژدەڤان
"""),
// With short examples define "highwayman", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێکی ئەسپسوار کە لە ڕابردوودا چەکی پێبوو و لەسەر ڕێگا کاری جەردەیی دەکرد"""),
                    SentencesRow(
                      englishText:
                          """He was held up by highwaymen on the Plymouth road.""",
                      kurdishText:
                          """لەلایەن جەردەیەکەوە لەسەر ڕێگای پلایماوس گیردرا.""",
