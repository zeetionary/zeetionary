...
class EnglishEntryfrivolity extends StatefulWidget {
  const EnglishEntryfrivolity({super.key});

  @override
  State<EnglishEntryfrivolity> createState() => _EnglishEntryfrivolityState();
}

class _EnglishEntryfrivolityState extends State<EnglishEntryfrivolity> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frivolity (Derived forms: frivolities)
1. The trait of being frivolous; not serious or sensible (= frivolousness)
 
2. Something of little value or significance (= bagatelle, fluff, frippery)
 
3. Acting like a clown or buffoon (= buffoonery, clowning, japery, harlequinade [archaic], prank)
""",
  );

  final String keyword = "frivolity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frivolity""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was just a piece of harmless frivolity.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I can't waste time on such frivolities.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frivolity""",
                      // alsoEnglishWord: "also: frivolity",
                      britshText: """IpaUK: /frɪˈvɒləti/""",
                      americanText: """IpaUS: /frɪˈvɑːləti/""",
...
کوردی: بێ‌ئەقڵی، سەرچڵی، سووکی، گەوجی، گەمژەیی، بێهوودەیی
"""),
// With short examples define "frivolity", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تەنها کارێکی گەمژانەی بێ‌زیان بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ناتوانم کات بە شتی وەها هیچەکە بکوژم.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/a0cDdo-H5Vo?t=';
const double _startSecondsend = 0000000000000000000000000001098;
const String _videoIdone = 'https://youtu.be/G0Cj6tGnaK8?t=';
const double _startSecondsone = 0000000000000000000000000001671;
const String _videoIdtwo = 'https://youtu.be/Tphz-X3Ks0o?t=';
const double _startSecondstwo = 000000000000000000000000000494;
const String _videoIdthree = 'https://youtu.be/VO9He_KhGy4?t=';
const double _startSecondsthree = 000000000000000000000000000482;
const String _videoIdfour = 'https://youtu.be/MSMb1DcXCQA?t=';
const double _startSecondsfour = 000000000000000000000000000176;
const String _videoIdfive = 'https://youtu.be/7BOh92tYHx8?t=';
