...
class EnglishEntryinertia extends StatefulWidget {
  const EnglishEntryinertia({super.key});

  @override
  State<EnglishEntryinertia> createState() => _EnglishEntryinertiaState();
}

class _EnglishEntryinertiaState extends State<EnglishEntryinertia> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: inertia (Derived forms: inertias)
1. A disposition to remain inactive or inert (- inactiveness, inactivity)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inertia""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I can't seem to throw off this feeling of inertia.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She lapsed into inertia and lay there as if asleep.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/-RjJtO51ykY?t=';
    const double startSecondsone = 000000000000000000000000000360;
    const String videoIdtwo = 'https://youtu.be/6QDvJ7Vtfac?t=';
    const double startSecondstwo = 00000000000000000000000000050;
    const String videoIdthree = 'https://youtu.be/fvu5FxKuqdQ?t=';
    const double startSecondsthree = 000000000000000000000000000302;
    const String videoIdfour = 'https://youtu.be/DxREm3s1scA?t=';
    const double startSecondsfour = 0000000000000000000000000001559;
    const String videoIdfive = 'https://youtu.be/daaDuC1kbds?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inertia""",
                      // alsoEnglishWord: "also: inertia",
                      britshText: """IpaUK: /ɪˈnɜːʃə/""",
                      americanText: """IpaUS: /ɪˈnɜːrʃə/""",
...
کوردی: (فیزیک) سستی، ناکاردانەوەیی، ناکاریگەری، ناچالاکی،	تەمەڵی، سستی، داوەشاوی، خاوی، لەش‌گرانی
"""),
// With short examples define "inertia", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەمی وزە؛ کەمی ویست و توانا بۆ جوڵان یان گۆران"""),
                    SentencesRow(
                      englishText:
                          """I can't seem to throw off this feeling of inertia.""",
                      kurdishText:
                          """وادیار نییە بتوانم خۆم لەم هەستی تەمەڵییە ڕزگار بکەم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کەوتە تەمەڵی و لەوێ کەوت وەک ئەوەی خەوتوو بێت.""",
