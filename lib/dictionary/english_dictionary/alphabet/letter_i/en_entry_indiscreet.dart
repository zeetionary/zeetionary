...
class EnglishEntryindiscreet extends StatefulWidget {
  const EnglishEntryindiscreet({super.key});

  @override
  State<EnglishEntryindiscreet> createState() => _EnglishEntryindiscreetState();
}

class _EnglishEntryindiscreetState extends State<EnglishEntryindiscreet> {
  @override
  void initState() {
    super.initState();
...
"her behaviour was indiscreet at the very best"
""",
  );

  final String keyword = "indiscreet";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indiscreet""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""One indiscreet comment could spoil the whole thing.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It was indiscreet of him to disclose that information.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/E91PnDtuVww?t=';
    const double startSecondsend = 000000000000000000000000000535;
    const String videoIdone = 'https://youtu.be/Pn0Cusu-9Ac?t=';
    const double startSecondsone = 0000000000000000000000000001628;
    const String videoIdtwo = 'https://youtu.be/0O_NGKgvTfA?t=';
    const double startSecondstwo = 000000000000000000000000000973;
    const String videoIdthree = 'https://youtu.be/tzlT6yju94s?t=';
    const double startSecondsthree = 0000000000000000000000000001014;
    const String videoIdfour = 'https://youtu.be/oKOSF29p-x4?t=';
    const double startSecondsfour = 0000000000000000000000000005223;
    const String videoIdfive = 'https://youtu.be/0bDm_Qb0o7M?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indiscreet""",
                      // alsoEnglishWord: "also: indiscreet",
                      britshText: """IpaUK: /ˌɪndɪˈskriːt/""",
                      americanText: """IpaUS: /ˌɪndɪˈskriːt/""",
...
کوردی: هەڵەشە، سەرچڵ، سەرەڕۆ، گەوج، بێ‌ئەقڵ، دەم‌بەهاوار، دەم‌بڵاو، ناژیرانە
"""),
// With short examples define "indiscreet", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە وریا نیت لەسەر ئەوەی کە دەیڵێیت یان دەیکەیت"""),
                    SentencesRow(
                      englishText:
                          """One indiscreet comment could spoil the whole thing.""",
                      kurdishText:
                          """یەک لێدوانی سەرچڵانە دەکرێت تەواوی شتەکە بشێوێنێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەوە لە هەڵەشەیی بوو کە ئەو زانیارییە ئاشکرا بکات.""",
