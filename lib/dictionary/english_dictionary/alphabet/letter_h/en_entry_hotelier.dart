...
class EnglishEntryhotelier extends StatefulWidget {
  const EnglishEntryhotelier({super.key});

  @override
  State<EnglishEntryhotelier> createState() => _EnglishEntryhotelierState();
}

class _EnglishEntryhotelierState extends State<EnglishEntryhotelier> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hotelier (Derived forms: hoteliers)
1. An owner or manager of hotels (- hotelkeeper, hotel manager, hotelman, hosteller [Brit, Cdn], hosteler [US])
""",
  );

  final String keyword = "hotelier";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hotelier""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/CaNmr6XC8NU?t=';
    const double startSecondsone = 000000000000000000000000000378;
    const String videoIdtwo = 'https://youtu.be/RrcRZSh9z60?t=';
    const double startSecondstwo = 0000000000000000000000000001183;
    const String videoIdthree = 'https://youtu.be/Fm2W0MFrgFc?t=';
    const double startSecondsthree = 00000000000000000000000000050;
    const String videoIdfour = 'https://youtu.be/Pn0Cusu-9Ac?t=';
    const double startSecondsfour = 000000000000000000000000000179;
    const String videoIdfive = 'https://youtu.be/pwDwZjxo4eg?t=';
    const double startSecondsfive = 000000000000000000000000000473;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hotelier""",
                      // alsoEnglishWord: "also: hotelier",
                      britshText: """IpaUK: /həʊˈteliə(r)/, /həʊˈtelieɪ/""",
                      americanText: """IpaUS: /ˌəʊtelˈjeɪ/, /həʊˈteljər/""",
