...
class EnglishEntrygratifying extends StatefulWidget {
  const EnglishEntrygratifying({super.key});

  @override
  State<EnglishEntrygratifying> createState() => _EnglishEntrygratifyingState();
}

class _EnglishEntrygratifyingState extends State<EnglishEntrygratifying> {
  @override
  void initState() {
    super.initState();
...
1. Pleasing to the mind or feeling (- sweet)
"gratifying revenge";
 
2. Affording satisfaction or pleasure (- enjoyable, pleasurable, fun)
"found her praise gratifying";
""",
  );

  final String keyword = "gratifying";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gratifying""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It is gratifying to see such good results.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gratifying""",
                      // alsoEnglishWord: "also: gratifying",
                      britshText: """IpaUK: /ˈɡrætɪfaɪɪŋ/""",
                      americanText: """IpaUS: /ˈɡrætɪfaɪɪŋ/""",
...
// With short examples define "gratifying", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دڵخۆشکەرە کە ئەنجامی وەها باش ببینین.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It must be very gratifying to see all your children grown up and happy.""",
                      kurdishText:
                          """دەبێت زۆر دڵخۆشکەر بێت کە هەموو منداڵەکان ببینیت گەورە بن و دڵخۆش بن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/HgbxUMx3JWA?t=';
const double _startSecondsend = 000000000000000000000000000244;
const String _videoIdone = 'https://youtu.be/lGSOWwUvJiU?t=';
const double _startSecondsone = 0000000000000000000000000001857;
const String _videoIdtwo = 'https://youtu.be/OgFcz6klaeg?t=';
const double _startSecondstwo = 000000000000000000000000000831;
const String _videoIdthree = 'https://youtu.be/O-yiVtGrRwY?t=';
const double _startSecondsthree = 000000000000000000000000000291;
const String _videoIdfour = 'https://youtu.be/8kk4dsa6F5A?t=';
const double _startSecondsfour = 00000000000000000000000000044;
const String _videoIdfive = 'https://youtu.be/gSgdaEPrcbA?t=';
