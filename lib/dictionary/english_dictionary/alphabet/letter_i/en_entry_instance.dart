...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The report highlights a number of instances of injustice.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""There have been several instances of that happening.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1065;
    const String videoIdone = 'nyf7wNn5fw8';
    const double startSecondsone = 54;
    const String videoIdtwo = 'HO0KklLjwd4';
    const double startSecondstwo = 47;
    const String videoIdthree = 'u1GZk3TWNQQ';
    const double startSecondsthree = 51;
    const String videoIdfour = 'NFtQOxjWfaA';
    const double startSecondsfour = 44;
    const String videoIdfive = 'VvJm4pQZ04s';
...
// With short examples define "instance", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) نموونە یان کەیسێکی دیاریکراوی شتێک"""),
                    SentencesRow(
                      englishText:
                          """The report highlights a number of instances of injustice.""",
                      kurdishText:
                          """ڕاپۆرتەکە ژمارەیەک نموونەی نادادی دەخاتە بەرچاو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He admitted two instances of taking bribes.""",
                      kurdishText:
                          """دانی بە دوو نموونەی خواردنی بەرتیل ناوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """This is one of the few instances where the director does not succeed.""",
                      kurdishText:
                          """ئەمە یەکێکە لەو نموونە دەگمەنانەی دەرهێنەرەکە تێیدا سەرناکەوێت.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (کردار) پێدانی شتێک وەک نموونەیەک"""),
                    SentencesRow(
                      englishText:
                          """I refer to the situation instanced above.""",
                      kurdishText:
                          """باس لەو دۆخە دەکەمەوە کە لە سەرەوە وەک نموونە دراوە.""",
