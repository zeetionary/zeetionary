...
class EnglishEntryexcavate extends StatefulWidget {
  const EnglishEntryexcavate({super.key});

  @override
  State<EnglishEntryexcavate> createState() => _EnglishEntryexcavateState();
}

class _EnglishEntryexcavateState extends State<EnglishEntryexcavate> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""excavate""");
  }
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The site has been excavated by archaeologists.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The area has not yet been fully excavated.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) هەڵکۆڵینی زەوی بۆ دۆزینەوەی بینا و کەرەستەی کۆن کە بۆ ماوەیەکی زۆرە کەوتوونەتە ژێر زەوی"""),
          SentencesRow(
            englishText: """The site has been excavated by archaeologists.""",
            kurdishText: """شوێنەکە لەلایەن شوێنەوارناسانەوە هەڵکۆڵدراوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The area has not yet been fully excavated.""",
            kurdishText: """ناوچەکە هێشتا بە تەواوی هەڵنەکۆڵدراوە.""",
            onPressedBritish: () => speaksentence2("en-GB"),
            onPressedAmerican: () => speaksentence2("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """٢. (کردار) هەڵکەندنی چاڵێک"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The body was discovered when builders excavated the area.""",
            kurdishText: """لاشەکە دۆزرایەوە کە بنیاتنەران ناوچەکەیان کەند.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: excavate (Derived forms: excavated, excavating, excavates)
1. Recover through digging (= unearth, dig up)
"Schliemann excavated Troy"; "excavate gold";
 
2. Find by digging in the ground (= dig up, turn up)
...
4. Remove the inner part or the core of (= dig, hollow)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/Pck5JcnkYYs?t=';
const double _startSecondsend = 000000000000000000000000000000; // 763;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/cmSphKD18uo?t=';
const double _startSecondsone = 00000000000000000000000000000; // 197;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/DxL2HoqLbyA?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 196;
const String _videoIdthree = 'VIDEOhttps://youtu.be/E7uGvsT_nnM?t=';
const double _startSecondsthree = 000000000000000000000000000; // 238;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/5OmJpOSNniU?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 239;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/h23rF0xrhTE?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 144;
