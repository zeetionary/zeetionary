...
class EnglishEntryhandbook extends StatefulWidget {
  const EnglishEntryhandbook({super.key});

  @override
  State<EnglishEntryhandbook> createState() => _EnglishEntryhandbookState();
}

class _EnglishEntryhandbookState extends State<EnglishEntryhandbook> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: handbook (Derived forms: handbooks)
1. A concise reference book providing specific information about a subject or location (- enchiridion, vade mecum)
"the easy solution is to look it up in the handbook";
""",
  );

  final String keyword = "handbook";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""handbook""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The student handbook gives details of all courses.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """handbook""",
                      // alsoEnglishWord: "also: handbook",
                      britshText: """IpaUK: /ˈhændbʊk/""",
                      americanText: """IpaUS: /ˈhændbʊk/""",
