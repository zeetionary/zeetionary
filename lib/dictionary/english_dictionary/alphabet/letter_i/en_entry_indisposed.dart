...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000144;
    const String videoIdone = 'https://youtu.be/FCZ06Sfr9Cg?t=';
    const double startSecondsone = 00000000000000000000000000063;
    const String videoIdtwo = 'https://youtu.be/Yaj7tBY2UGI?t=';
    const double startSecondstwo = 0000000000000000000000000001629;
    const String videoIdthree = 'https://youtu.be/w_lsIdMfV40?t=';
    const double startSecondsthree = 0000000000000000000000000001792;
    const String videoIdfour = 'https://youtu.be/OrOZRVxyR3I?t=';
    const double startSecondsfour = 00000000000000000000000000011235;
    const String videoIdfive = 'https://youtu.be/uzfZQkBhILE?t=';
