...
class EnglishEntrygathering extends StatefulWidget {
  const EnglishEntrygathering({super.key});

  @override
  State<EnglishEntrygathering> createState() => _EnglishEntrygatheringState();
}

class _EnglishEntrygatheringState extends State<EnglishEntrygathering> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gathering";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gathering""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She spent hours on information gathering at the library.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gathering""",
                      // alsoEnglishWord: "also: gathering",
                      britshText: """IpaUK: /ˈɡæðərɪŋ/""",
                      americanText: """IpaUS: /ˈɡæðərɪŋ/""",
...
// With short examples define "gathering", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """He was asked to speak at a gathering of religious leaders.""",
                      kurdishText:
                          """داوای لێکرا گوتار بدات لە کۆبوونەوەیەکی پیاوانی ئایینی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چەندین کاتژمێری بەسەر برد بە کۆکردنەوەی زانیاری لە کتێبخانەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Bl5630CeYFs?t=';
const double _startSecondsend = 000000000000000000000000000144;
const String _videoIdone = 'https://youtu.be/t_0aE0VBJzQ?t=';
const double _startSecondsone = 00000000000000000000000000021;
const String _videoIdtwo = 'https://youtu.be/b1reY72ktEc?t=';
const double _startSecondstwo = 000000000000000000000000000213;
const String _videoIdthree = 'https://youtu.be/dNKQYjsxgPU?t=';
const double _startSecondsthree = 00000000000000000000000000017;
const String _videoIdfour = 'https://youtu.be/D-qQneOnJl0?t=';
const double _startSecondsfour = 00000000000000000000000000043;
const String _videoIdfive = 'https://youtu.be/JX82wa5HkJg?t=';
const double _startSecondsfive = 000000000000000000000000000317;
