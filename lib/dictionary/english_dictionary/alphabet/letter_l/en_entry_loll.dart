...
class EnglishEntryloll extends StatefulWidget {
  const EnglishEntryloll({super.key});

  @override
  State<EnglishEntryloll> createState() => _EnglishEntrylollState();
}

class _EnglishEntrylollState extends State<EnglishEntryloll> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: loll (Derived forms: lolled, lolls, lolling)
1. Hang loosely or laxly (- droop)
"His tongue lolled";
 
2. Be lazy or idle (- bum [informal], bum around [informal], bum about [informal], arse around [Brit, Cdn, informal], arse about [Brit, Cdn, informal], loaf [informal], waste one's time, lounge around, loll around, lounge about, slob [Brit, informal])
"Her son is just lolling around all day";
""",
  );

  final String keyword = "loll";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He lolled back in his chair by the fire.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I spent most of the weekend lolling about/around on the beach.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""My head lolled against his shoulder.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/k8xxxyppTRQ?t=42';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/qGfnDJ6J8d4?t=239';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/72i3XhRcn0s?t=152';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/wCj4kCq1Z9Y?t=984';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/B5sUXSaTHKc?t=3837';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/LwfqyIDvQWM?t=252';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """loll""",
                      // alsoEnglishWord: "also: loll",
                      britshText: """IpaUK: /lɒl/""",
                      americanText: """IpaUS: /lɑːl/""",
...
کوردی: 
"""),
// With short examples define "loll", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) پاڵکەوتن، دانیشتن، یان وەستان بە تەمبەڵانە"""),
                    SentencesRow(
                      englishText: """He lolled back in his chair by the fire.""",
                      kurdishText: """لە کورسییەکەیدا لای ئاگرەکە پاڵکەوتبوو.""",
                    ...
                    SentencesRow(
                      englishText: """I spent most of the weekend lolling about/around on the beach.""",
                      kurdishText: """زۆرینەی کۆتایی هەفتەم بەسەر بە ڕاکشان لەسەر کەناراوەکە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) ئەوەی بە ئاسوودەیی بجووڵێت یان لەسەر شتێک بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """My head lolled against his shoulder.""",
                      kurdishText: """سەرم کەوتە سەر شانی.""",
                      englishNote: """This means my head drooped or tilted to the side in a loose or relaxed way, resting against his shoulder, possibly due to tiredness, sleepiness, or weakness.""",
