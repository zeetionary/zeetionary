...
class EnglishEntryhardline extends StatefulWidget {
  const EnglishEntryhardline({super.key});

  @override
  State<EnglishEntryhardline> createState() => _EnglishEntryhardlineState();
}

class _EnglishEntryhardlineState extends State<EnglishEntryhardline> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hard-line
1. Firm and uncompromising (- hardline)
"a hardline policy";

- Noun: hard line (Derived forms: hard lines)
1. A firm and uncompromising stance or position
"the governor took a hard line on drugs"
""",
  );

  final String keyword = "hard-line";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hard-line""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The government took a hard line on the strike.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hard-line""",
                      // alsoEnglishWord: "also: hard-line",
                      britshText: """IpaUK: /ˌhɑːd ˈlaɪn/""",
                      americanText: """IpaUS: /ˌhɑːrd ˈlaɪn/""",
...
// With short examples define "hard-line", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) سیاسەت یان هەڵوێستێکی توند"""),
                    SentencesRow(
                      englishText: """The government took a hard line on the strike.""",
                      kurdishText: """حکومەت هەڵوێستی توندی گرتەبەر دژ بە مانگرتنەکە.""",
