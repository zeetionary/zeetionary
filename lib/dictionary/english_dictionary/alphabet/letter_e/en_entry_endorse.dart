...
class EnglishEntryendorse extends StatefulWidget {
  const EnglishEntryendorse({super.key});

  @override
  State<EnglishEntryendorse> createState() => _EnglishEntryendorseState();
}

class _EnglishEntryendorseState extends State<EnglishEntryendorse> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""endorse""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """endorse""",
                      // alsoEnglishWord: "also: endorse",
                      britshText: """IpaUK: /ɪnˈdɔːs/""",
                      americanText: """IpaUS: /ɪnˈdɔːrs/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I wholeheartedly endorse his remarks.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Members of all parties endorsed a ban on land mines.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The government has broadly endorsed the research paper.""");
  }
...
// """),
          const DefinitionKurdish(
              text: """١. (کردار) بە فەرمی ڕاگەیاندنی پشتگیری بۆ کەسێک/شتێک"""),
          SentencesRow(
            englishText: """I wholeheartedly endorse his remarks.""",
            kurdishText: """لە ناخی دڵەوە پشتگیری وتەکانی دەکەم.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """ئەندامانی هەموو پارتەکان پشتگیری قەدەغەیان لەسەر مینی چێندراو دەکرد.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """حکومەت بە بەرفراوانی پشتگیری توێژینەوەکەی کردووە.""",
          ...
          SentencesRow(
            englishText:
                """I wonder how many celebrities actually use the products they endorse.""",
            kurdishText:
                """تامەزرۆی زانینی ئەوەم کە چەندە لە کەسانی بەناوبانگ لە ڕاستیدا ئەو بەرهەمانە بەکاردەهێنن کە پشتگیری دەکەن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: endorse (Derived forms: endorsed, endorses, endorsing)
1. Pick one person to give support and approval to in a particular role (= back, indorse, plump for, plunk for, support)
"I endorsed Kennedy in 1960";
 
2. Give support or one's approval to (= second, back, indorse)
"endorse a new project";
 
3. Guarantee as meeting a certain standard (= certify, indorse)
"endorsed grade AAA meat";
 
4. Sign as evidence of legal transfer (= indorse)
"endorse cheques";
""",
  );
...
const String _videoIdend = 'https://youtu.be/YIafrsAWS1Y?t=';
const double _startSecondsend = 1040;
const String _videoIdone = 'https://youtu.be/io6wi8DVZ3o?t=';
const double _startSecondsone = 447;
const String _videoIdtwo = 'https://youtu.be/MqyJZsGFZ3M?t=';
const double _startSecondstwo = 1683;
const String _videoIdthree = 'https://youtu.be/cY4e0uvp7uI?t=';
const double _startSecondsthree = 698;
const String _videoIdfour = 'https://youtu.be/kBdfcR-8hEY?t=';
const double _startSecondsfour = 1537;
const String _videoIdfive = 'https://youtu.be/GJ9_7L873m8?t=';
const double _startSecondsfive = 239;
const String _videoIdsix = 'https://youtu.be/hDNiNdsPHNA?t=';
const double _startSecondssix = 52;
