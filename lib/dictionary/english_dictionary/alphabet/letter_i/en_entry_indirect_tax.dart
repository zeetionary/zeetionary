...
class EnglishEntryindirecttax extends StatefulWidget {
  const EnglishEntryindirecttax({super.key});

  @override
  State<EnglishEntryindirecttax> createState() =>
      _EnglishEntryindirecttaxState();
}

class _EnglishEntryindirecttaxState extends State<EnglishEntryindirecttax> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: indirect tax (Derived forms: indirect taxes)
1. A tax levied on goods or services rather than on persons or organizations
""",
  );

  final String keyword = "indirect tax";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indirect tax""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The price increase includes an indirect tax on imports.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/3GIR7rHzF6Q?t=';
    const double startSecondsend = 00000000000000000000000000063;
    const String videoIdone = 'https://youtu.be/oPwCvSH30WA?t=';
    const double startSecondsone = 000000000000000000000000000143;
    const String videoIdtwo = 'https://youtu.be/ds_SG__COP4?t=';
    const double startSecondstwo = 0000000000000000000000000001549;
    const String videoIdthree = 'https://youtu.be/OK3XCob8D-s?t=';
    const double startSecondsthree = 000000000000000000000000000232;
    const String videoIdfour = 'https://youtu.be/ni0aX0tUAd0?t=';
    const double startSecondsfour = 000000000000000000000000000397;
    const String videoIdfive = 'https://youtu.be/9S6lS6127yA?t=';
    const double startSecondsfive = 0000000000000000000000000001037;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indirect tax""",
                      // alsoEnglishWord: "also: indirect tax",
                      britshText:
                          """IpaUK: /ˌɪndərekt ˈtæks/, /ˌɪndaɪrekt ˈtæks/""",
                      americanText:
                          """IpaUS: /ˌɪndərekt ˈtæks/, /ˌɪndaɪrekt ˈtæks/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) باجی ناڕاستەوخۆ؛ باجێک کە دەدرێت بەوەی کە زیاد دەکرێتە سەر کەلووپەل و خزمەتگوزاری نەک ڕاستەوخۆ بدرێت بە حکومەت"""),
                    SentencesRow(
                      englishText:
                          """The price increase includes an indirect tax on imports.""",
                      kurdishText:
                          """زیادبوونی نرخەکان باجی ناڕاستەوخۆ لەسەر هاوردەکان دەگرێتەوە.""",
                      englishNote:
                          """This means that the rise in price is partly due to a tax that is applied to imported goods. The term "indirect tax" suggests that the tax is not paid directly by the buyer but is included in the cost of the products, which makes the buyer indirectly pay it when purchasing the goods.""",
