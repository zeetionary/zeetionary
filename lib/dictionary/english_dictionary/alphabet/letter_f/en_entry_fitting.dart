...
class EnglishEntryfitting extends StatefulWidget {
  const EnglishEntryfitting({super.key});

  @override
  State<EnglishEntryfitting> createState() => _EnglishEntryfittingState();
}

class _EnglishEntryfittingState extends State<EnglishEntryfitting> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fitting""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Our bathroom fittings are easy to install.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The room still has the original fixtures and fittings.""");
  }
...
// With short examples define "fitting", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The award was a fitting tribute to her years of devoted work.""",
                      kurdishText:
                          """خەڵاتەکە قەدرلێ‌نانی گونجاو بوو بۆ چەندین ساڵ لە کارکردنی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It seemed entirely fitting that she should be wearing black.""",
                      kurdishText: """تەواو گونجاو بوو کە دەبێت ڕەش بپۆشێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It is fitting that the new centre for European studies should be in a university that teaches every European language.""",
                      kurdishText:
                          """گونجاوە کە سەنتەری تازە بۆ لێکۆڵینەوە لە ئەورووپا پێویستە لە زانکۆیەک بێت کە هەموو زمانێکی ئەورووپا دەڵێتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کەرەستەی گەرماوەکەمان ئاسانن بۆ دانان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ژوورەکە هێشتا کەلوپەلە جێگیر و ناجێگیرەکانی خۆی هەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I'm having the final fitting of my wedding dress on Thursday.""",
                      kurdishText:
                          """ڕۆژی پێنجشەممە کۆتا تاقیکردنەوەی جلی هاوسەرگیرییەکەم دەکەم.""",
...
const double _startSecondsend = 000000000000000000000000000882;
const String _videoIdone = 'https://youtu.be/XnbCSboujF4?t=';
const double _startSecondsone = 0000000000000000000000000002;
const String _videoIdtwo = 'https://youtu.be/yjhibJ-OqxE?t=';
const double _startSecondstwo = 000000000000000000000000000366;
const String _videoIdthree = 'https://youtu.be/raSeaAeryWE?t=';
const double _startSecondsthree = 000000000000000000000000000413;
const String _videoIdfour = 'https://youtu.be/Bk0G1f4DpCM?t=';
const double _startSecondsfour = 00000000000000000000000000021;
const String _videoIdfive = 'https://youtu.be/0zXfDafyyao?t=';
const double _startSecondsfive = 0000000000000000000000000001223;
