...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'oCt7g0fWWyw';
    const double startSecondsend = 100;
    ...
    const String videoIdthree = 'CyWZ7lCifso';
    const double startSecondsthree = 925;
    const String videoIdfour = 'Gfj5f0GVLZ0';
    const double startSecondsfour = 662;
    const String videoIdfive = 'JN3KPFbWCy8';
    const double startSecondsfive = 6112;
