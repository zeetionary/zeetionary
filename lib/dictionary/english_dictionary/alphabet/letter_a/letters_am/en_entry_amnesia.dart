                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "amnesia"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /æmˈniːziə/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /æmˈniːʒə/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'ivuk6Eltl8g';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'DIf-J4tXh2w';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'XvJhyhr3XAc';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '0arlcul978A';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'K--dPi2EurM';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'kUq2-wx4oCA';
  final double _startSeconds = 1;
