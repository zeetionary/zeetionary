...
class EnglishEntryhare extends StatefulWidget {
  const EnglishEntryhare({super.key});

  @override
  State<EnglishEntryhare> createState() => _EnglishEntryhareState();
}

class _EnglishEntryhareState extends State<EnglishEntryhare> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hare (Derived forms: hares)
1. Swift, timid, long-eared mammal larger than a rabbit; having a divided upper lip and long hind legs
 
2. Flesh of any of various rabbits or hares (wild or domesticated) eaten as food (- rabbit)

- Verb: hare (Derived forms: hares, hared, haring)
1. Run quickly, like a hare
"He hared down the hill"
""",
  );

  final String keyword = "hare";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hare darted across the field.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He hared away down the street.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She’s always haring off to France on business.""");
  }
...
کوردی: 
"""),
                    const DefinitionKurdish(text: """١. (ناو) کەروێشکی کێوی؛ ئاژەڵێکە وەک کەروێشکی گەورە کە قاچی دواوەی زۆر بەهێزە و دەتوانێت زۆر خێرا ڕابکات"""),
                    SentencesRow(
                      englishText: """The hare darted across the field.""",
                      kurdishText: """کەروێشکە کێوییەکە بە گۆڕەۆانەکەدا بۆی دەرچوو.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) ڕاکردن یان چوونە شوێنێک زۆر بەخێرایی"""),
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She’s always haring off to France on business.""",
                      kurdishText: """بەردەوام بە کاری بازرگانی دەچێتە فەرەنسا.""",
