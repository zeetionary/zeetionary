...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/cqidD7kVnxY?t=';
    const double startSecondsend = 0000000000000000000000000001068;
    const String videoIdone = 'https://youtu.be/b_rjBWmc1iQ?t=';
    const double startSecondsone = 0000000000000000000000000005375;
    const String videoIdtwo = 'https://youtu.be/LJ0Hfc8hvpE?t=';
    const double startSecondstwo = 000000000000000000000000000351;
    const String videoIdthree = 'https://youtu.be/-Mkp4oavz2M?t=';
    ...
    const String videoIdfive = 'https://youtu.be/ZThc79RtIeI?t=';
    const double startSecondsfive = 0000000000000000000000000003843;
...
// With short examples define "indisputable", please follow LX instructions
                    ...
                    const DefinitionKurdish(text: """٢. (ھاوەڵناو) پننسە"""),
