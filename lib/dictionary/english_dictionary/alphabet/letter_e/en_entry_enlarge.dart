...
class EnglishEntryenlarge extends StatefulWidget {
  const EnglishEntryenlarge({super.key});

  @override
  State<EnglishEntryenlarge> createState() => _EnglishEntryenlargeState();
}

class _EnglishEntryenlargeState extends State<EnglishEntryenlarge> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enlarge""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enlarge""",
                      // alsoEnglishWord: "also: enlarge",
                      britshText: """IpaUK: /ɪnˈlɑːdʒ/""",
                      americanText: """IpaUS: /ɪnˈlɑːrdʒ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Reading will enlarge your vocabulary.""");
  }
...
"""),
          const DefinitionKurdish(
              text: """١. (کردار) گەورە کردن؛ گەورە بوون"""),
          SentencesRow(
            englishText: """Reading will enlarge your vocabulary.""",
            kurdishText: """خوێندنەوە ژمارەی وشەکانت زیاد دەکات.""",
          ...
          SentencesRow(
            englishText:
                """The castle was enlarged considerably in the fifteenth century.""",
            kurdishText:
                """قەڵاکە بە ئاستێکی زۆر لە سەدەی پازدەدا گەورە کرا.""",
            onPressedBritish: () => speaksentence2("en-GB"),
            onPressedAmerican: () => speaksentence2("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (کردار) گەورەکردنی وێنەیەک یان بەڵگەنامەیەک"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """We're going to have this picture enlarged.""",
            kurdishText: """ئەم وێنەیە گەورە دەکەینەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: enlarge (Derived forms: enlarges, enlarged, enlarging)
1. Make larger
"She enlarged the flower beds"
 
2. (photography) make appear larger; make a larger copy (= blow up, magnify)
"enlarge an image";
 
3. Become larger or bigger
 
4. Describe and explain in detail (= elaborate, lucubrate [archaic], expatiate, exposit, flesh out, expand, expound, dilate)
""",
  );
...
const double _startSecondsend = 7486;
const String _videoIdone = 'https://youtu.be/X3TAROotFfM?t=';
const double _startSecondsone = 148;
const String _videoIdtwo = 'https://youtu.be/ni5-3x6ofjc?t=';
const double _startSecondstwo = 410;
const String _videoIdthree = 'https://youtu.be/zGtiylOAtM0?t=';
const double _startSecondsthree = 273;
const String _videoIdfour = 'https://youtu.be/DG2esWiRe0s?t=';
const double _startSecondsfour = 375;
const String _videoIdfive = 'https://youtu.be/ReRnWVPXtpk?t=';
const double _startSecondsfive = 209;
const String _videoIdsix = 'https://youtu.be/rszK4_Pk6G8?t=';
const double _startSecondssix = 486;
