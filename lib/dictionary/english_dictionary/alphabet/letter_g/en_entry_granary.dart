...
class EnglishEntrygranary extends StatefulWidget {
  const EnglishEntrygranary({super.key});

  @override
  State<EnglishEntrygranary> createState() => _EnglishEntrygranaryState();
}

class _EnglishEntrygranaryState extends State<EnglishEntrygranary> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""granary""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The surplus seed will be returned to the granary.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """granary""",
                      // alsoEnglishWord: "also: granary",
                      britshText: """IpaUK: /ˈɡrænəri/""",
                      americanText: """IpaUS: /ˈɡreɪnəri/,  /ˈɡrænəri/""",
...
کوردی: عەماری دەغڵ‌ودان، سایلۆی گەنم، شوێنی گەنم تیاهەڵگرتن
"""),
// With short examples define "granary", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The surplus seed will be returned to the granary.""",
                      kurdishText:
                          """تۆوە زیادەکە دەگەڕێندرێتەوە بۆ سایلۆی گەنمەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/eQzeHYI3Q7Q?t=';
const double _startSecondsend = 000000000000000000000000000385;
const String _videoIdone = 'https://youtu.be/XvPaiDX_3JM?t=';
const double _startSecondsone = 00000000000000000000000000042;
const String _videoIdtwo = 'https://youtu.be/JvkTrNW72rw?t=';
const double _startSecondstwo = 000000000000000000000000000264;
const String _videoIdthree = 'https://youtu.be/zLKktS61JrM?t=';
const double _startSecondsthree = 0000000000000000000000000001524;
const String _videoIdfour = 'https://youtu.be/cM_0mwIoG3w?t=';
const double _startSecondsfour = 000000000000000000000000000314;
const String _videoIdfive = 'https://youtu.be/Ieb22ok2INA?t=';
const double _startSecondsfive = 000000000000000000000000000369;
