...
class EnglishEntryfairytale extends StatefulWidget {
  const EnglishEntryfairytale({super.key});

  @override
  State<EnglishEntryfairytale> createState() => _EnglishEntryfairytaleState();
}

class _EnglishEntryfairytaleState extends State<EnglishEntryfairytale> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fairy tale""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fairy tale""",
                      alsoEnglishWord: "also: fairy story",
                      britshText: """IpaUK: /ˈfeəri teɪl/""",
                      americanText: """IpaUS: /ˈferi teɪl/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "fairy tale";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""A prince in a fairy tale often fights dragons.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Life doesn't always have a fairy-tale ending.""");
  }
...
"""),
          ...
          SentencesRow(
            englishText:
                """Now tell me the truth: I don't want any more of your fairy stories.""",
            kurdishText:
                """ئێستا ڕاستییەکەم پێ بڵێ: چی دیکەم لە درۆ و دەلەسەکانت ناوێت.""",
...
const String _videoIdend = 'https://youtu.be/pNCOA8AUxdw?t=';
const double _startSecondsend = 000000000000000000000000000355;
const String _videoIdone = 'https://youtu.be/ct-CdyT4HkM?t=';
const double _startSecondsone = 0000000000000000000000000006;
const String _videoIdtwo = 'https://youtu.be/xpSaVRJqs1g?t=';
const double _startSecondstwo = 000000000000000000000000000334;
const String _videoIdthree = 'https://youtu.be/sKnjw8Fl5Yg?t=';
...
const String _videoIdfive = 'https://youtu.be/lEgPVrSZa6w?t=';
