...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1532;
    const String videoIdone = 'jLIUkk6Esr0';
    const double startSecondsone = 771;
    const String videoIdtwo = 'w5ebcowAJD8';
    const double startSecondstwo = 521;
    const String videoIdthree = 'Aks0W6OSM2k';
    const double startSecondsthree = 1568;
    const String videoIdfour = 'P4l9Y5OHqpk';
    const double startSecondsfour = 1079;
    const String videoIdfive = 'SqH0nJngy-c';
    const double startSecondsfive = 2571;
