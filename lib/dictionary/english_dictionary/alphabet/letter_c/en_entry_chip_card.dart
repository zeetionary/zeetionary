...
class EnglishEntrychipcard extends StatelessWidget {
  // blank divider
  EnglishEntrychipcard({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakchipcard(String languageCode) async {
    // DOPSUM: CHANGE speakchipcard
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "chip card"),
                          ],
                        ),
                        const Row(
                          children: [
                            AlsoEnglish(word: "also: smart card"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈtʃɪp kɑːd/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakchipcard("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈtʃɪp kɑːrd/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakchipcard("en-US"),
                            ),
                          ],
                        ),
                      ],
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
Noun: chip card (derived forms: chip cards)
1. a plastic card on which information is stored in the form of a microchip
""",
  );
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/b0YS1kgyql4?t=',
    startSeconds: 5,
    autoPlay: true,
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/gEvf-WGnR_I?t=',
    startSeconds: 396,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/_t0m3VJoLHA?t=',
    startSeconds: 32,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/i9_-fr4s_4U?t=',
    startSeconds: 204,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/NE5H5intsck?t=',
    startSeconds: 359,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/Sl09t_Bz9jU?t=',
    startSeconds: 136,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/Xw0oR66MqaU?t=',
    startSeconds: 55,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/S7dWigI7Soc?t=',
    startSeconds: 231,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
