...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '7uHGlfeCBbE';
    const double startSecondsend = 931;
    const String videoIdone = 'PcDznK9vd_w';
    const double startSecondsone = 443;
    const String videoIdtwo = 'Ij3g_HGwb5M';
    const double startSecondstwo = 975;
    const String videoIdthree = 'dyi0ZcEyBNE';
    const double startSecondsthree = 575;
    const String videoIdfour = 'jesx32dzTqY';
    const double startSecondsfour = 93;
    const String videoIdfive = '9p3K1U46VvE';
    const double startSecondsfive = 365;
