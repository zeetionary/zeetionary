...
class EnglishEntryepilogue extends StatefulWidget {
  const EnglishEntryepilogue({super.key});

  @override
  State<EnglishEntryepilogue> createState() => _EnglishEntryepilogueState();
}

class _EnglishEntryepilogueState extends State<EnglishEntryepilogue> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""epilogue""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """epilogue""",
                      // alsoEnglishWord: "also: epilogue",
                      britshText: """IpaUK: /ˈepɪlɒɡ/""",
                      americanText: """IpaUS: /ˈepɪlɔːɡ/""",
...
کوردی: پاشەکی، پاش(ە)نووس، کۆتایی، کۆتایی‌نامە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) وتارێک، هتد لە کۆتایی فیلمێک، شانۆیەک، یان کتێبێک کە وەک دەرئەنجام ڕۆڵ دەبینێت یان باسی دەرئەنجام دەکات"""),
          SentencesRow(
            englishText:
                """Fortinbras speaks the epilogue in Shakespeare’s ‘Hamlet’.""",
            kurdishText: """فۆرتنبراس پاشەکیی هاملێتی شێکسپیر دەگێڕێتەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: epilogue (Derived forms: epilogues)
1. A short speech (often in verse) addressed directly to the audience by an actor at the end of a play (= epilog [US])
 
2. A short passage added at the end of a literary work (= epilog [US])
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/x6Kbphnil7s?t=';
const double _startSecondsend = 000000000000000000000000000000; // 409;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/fBTjbGfHx0s';
const double _startSecondsone = 00000000000000000000000000000; // 0;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/Ypx1FLDMDDU?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 577;
const String _videoIdthree = 'VIDEOhttps://youtu.be/EJZS87Gw89I?t=';
const double _startSecondsthree = 000000000000000000000000000; // 109;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/P-o-VlaOJio?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 744;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/Bkdvw4sPz8A?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 900;
