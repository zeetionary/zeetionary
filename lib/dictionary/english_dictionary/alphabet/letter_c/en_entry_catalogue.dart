...
class EnglishEntrycatalogue extends StatelessWidget {
  ...
  Future<void> speakcatalogues1(String languageCode) async {
    ...
    await flutterTts.speak(
        "speakcatalogues111111111111111111111111111111111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcatalogues2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcatalogues22"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcatalogues3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcatalogues33"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcatalogues4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcatalogues44"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcatalogues5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcatalogues55"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcatalogues6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcatalogues66"); // DOPSUM: CHANGE TEXT
  }
...
١. (ھاوەڵناو) پێنناسە"""),
                                ...
                                child: Column(
                                  children: [
                                    ExampleSentenceEnglish(
                                        text:
                                            "speakcatalogues111111111111111111111111111111111"),
                    ...
                    YouTubeScroller(
                      children: [
                        ...
                        // YoutubeEmbeddedeight(), // speakcatalogues111111111111111111111111111111111
                        // YoutubeEmbeddednine(),
                        // YoutubeEmbeddedten(),
