...
class EnglishEntrylistless extends StatefulWidget {
  const EnglishEntrylistless({super.key});

  @override
  State<EnglishEntrylistless> createState() => _EnglishEntrylistlessState();
}

class _EnglishEntrylistlessState extends State<EnglishEntrylistless> {
  @override
  void initState() {
    super.initState();
...
2. Marked by low spirits; showing no enthusiasm (- dispirited)
"reacted to the crisis with listless resignation";
""",
  );

  final String keyword = "listless";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""listless""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The illness left her feeling listless and depressed.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/54F69B35L34?t=205';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/nMYPc-j5JyQ?t=32';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/BmCTv_ZD-Ow?t=11';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/YV2cfbMefi8?t=1000';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/QKZTvDv_vwI?t=975';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/vVloMqJEsME?t=6404';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """listless""",
                      // alsoEnglishWord: "also: listless",
                      britshText: """IpaUK: /ˈlɪstləs/""",
                      americanText: """IpaUS: /ˈlɪstləs/""",
...
کوردی: وەڕەز، داهێزراو، بێ‌حاڵ، بێ‌تاقەت، دڵ‌مردوو، بێ‌کەیف، بێ‌مەیل، ماندوو، کەشەنگ
"""),
// With short examples define "listless", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) بەبێ هیچ وزە و توانایەک بۆ کردنی شتێک"""),
                    const AlsoEnglishckb(word: "ھەروەھا: lethargic"),
                    SentencesRow(
                      englishText: """The illness left her feeling listless and depressed.""",
                      kurdishText: """نەخۆشییەکە وایکرد هەست بە بێ‌تاقەتی و خەمباری بکات.""",
