...
class EnglishEntryinstil extends StatefulWidget {
  const EnglishEntryinstil({super.key});

  @override
  State<EnglishEntryinstil> createState() => _EnglishEntryinstilState();
}

class _EnglishEntryinstilState extends State<EnglishEntryinstil> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: instil (Derived forms: instils)
Usage: Brit, Cdn (US: instill)
1. Enter drop by drop (- instill)
"instil medication into my eye";
""",
  );

  final String keyword = "instil";
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000525;
    const String videoIdone = 'https://youtu.be/-C3CjOkF-jY?t=';
    const double startSecondsone = 000000000000000000000000000802;
    const String videoIdtwo = 'https://youtu.be/Fgvdl87lqc8?t=';
    const double startSecondstwo = 0000000000000000000000000001147;
    const String videoIdthree = 'https://youtu.be/aTMsfOcHiJg?t=';
    const double startSecondsthree = 000000000000000000000000000785;
    const String videoIdfour = 'https://youtu.be/87y1_IbJRZE?t=';
    const double startSecondsfour = 000000000000000000000000000649;
    const String videoIdfive = 'https://youtu.be/dPicox3QWC0?t=';
    const double startSecondsfive = 000000000000000000000000000642;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """instil""",
                      // alsoEnglishWord: "also: instil",
                      britshText: """IpaUK: /ɪnˈstɪl/""",
                      americanText: """IpaUS: /ɪnˈstɪl/""",
...
// کوردی: تکاندن، ڕژاندن، بە دڵۆپ ڕژتن
// """),
// With short examples define "instil", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) کەم کەم چەسپاندنی بیرۆکەیەک یان هەڵسووکەوت لە مێشکی کەسێکدا"""),
                    SentencesRow(
                      englishText:
                          """His father instilled him with a desire to fight injustice and corruption.""",
                      kurdishText:
                          """باوکی ویستی شەڕی دژ بە نادادی و گەندەڵی تێیدا چەسپاند.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It is part of a teacher's job to instil confidence in/into his or her students.""",
                      kurdishText:
                          """ئەوە بەشێکە لە کاری مامۆستایەک کە متمانە لە خوێندکارەکانی بچەسپێنێت.""",
