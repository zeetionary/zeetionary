...
class EnglishEntryflag extends StatefulWidget {
  const EnglishEntryflag({super.key});

  @override
  State<EnglishEntryflag> createState() => _EnglishEntryflagState();
}

class _EnglishEntryflagState extends State<EnglishEntryflag> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flag (Derived forms: flags)
1. Emblem usually consisting of a rectangular piece of cloth of distinctive design
 
2. A listing printed in all issues of a newspaper or magazine (usually on the editorial page) that gives the name of the publication and the names of the editorial staff, etc. (= masthead)
 
3. Plants with sword-shaped leaves and erect stalks bearing bright-coloured flowers composed of three petals and three drooping sepals (= iris, fleur-de-lis, sword lily)
 
4. A rectangular piece of fabric used as a signalling device (= signal flag)
 
5. Flagpole used to mark the position of the hole on a golf green (= pin)
 
6. Stratified stone that splits into pieces suitable as paving stones (= flagstone)
...
- Verb: flag (Derived forms: flagging, flagged, flags)
1. Communicate or signal with a flag
 
2. Provide with a flag
"Flag this file so that I can recognize it immediately"
 
3. Droop, sink, or settle from or as if from pressure or loss of tautness (= sag, droop, swag)
 
4. Decorate with flags
"the building was flagged for the holiday"
 
5. Become less intense (= ease up, ease off, slacken off)
""",
  );
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The hotel flies the European Union flag.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The American flag was flying.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The black and white flag went down, and the race began.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The assistant referee had raised his flag for offside.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""A large Brazilian flag fluttered above the podium.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His shot went closer to the corner flag than the goal.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The team competed under the Olympic flag.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He was working under the flag of the United Nations.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her confidence had never flagged.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flag""",
                      // alsoEnglishWord: "also: flag",
                      britshText: """IpaUK: /flæɡ/""",
                      americanText: """IpaUS: /flæɡ/""",
...
// With short examples define "flag", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هوتێلەکە ئاڵای یەکێتیی ئەورووپای هەڵداوە.""",
                    ...
                    SentencesRow(
                      englishText: """The American flag was flying.""",
                      kurdishText: """ئاڵای ئەمریکا دەشەکایەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سەدان کەس هاواریان بوو و ئاڵایان دەشەکاندەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئاڵا ڕەش و سپییەکە چووە خوارەوە و پێشبڕکێیەکە دەستی پێکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ناوبژیوانە یاریدەدەرەکە ئاڵاکەیی بەرزکردەوە بۆ ئۆفساید.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئاڵاکەی بەرازیل بەسەر یاریگاکەدا دەشەکایەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لێدانەکەی نزیکتر بۆ ئاڵای سووچەکە چوو وەک لە گۆڵەکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) بۆ ناوهێنانی وڵات یان دامەزراوەیەکی دیاریکراو و بەها و باوەڕەکانی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The team competed under the Olympic flag.""",
                      kurdishText:
                          """تیمەکە لەژێر ئاڵای ئۆڵۆمپیاددا یاریی کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لەژێر ئاڵای نەتەوە یەکگرتووەکان یاریی دەکرد.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I've flagged the paragraphs that we need to look at in more detail.""",
                      kurdishText:
                          """ئەو پەرەگرافانەم دیاریکردووە کە دەبێت بە وردەکاریی زیاترەوە لێیان بڕوانین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ورەی هەرگیز لاواز نەبوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It had been a long day and the children were beginning to flag.""",
                      kurdishText:
                          """ڕۆژێکی درێژ بووبوو و منداڵەکان دەستیان بە شەکەت بوون دەکرد.""",
...
const double _startSecondsend = 000000000000000000000000000688;
const String _videoIdone = 'https://youtu.be/D0x2dgpBDzc?t=';
const double _startSecondsone = 00000000000000000000000000060;
const String _videoIdtwo = 'https://youtu.be/mY3SEMTROas?t=';
const double _startSecondstwo = 0000000000000000000000000001259;
const String _videoIdthree = 'https://youtu.be/0POHnKF2pH4?t=';
const double _startSecondsthree = 000000000000000000000000000149;
const String _videoIdfour = 'https://youtu.be/Z36OznHFIt4?t=';
const double _startSecondsfour = 000000000000000000000000000332;
const String _videoIdfive = 'https://youtu.be/JHjXwicEwQo?t=';
const double _startSecondsfive = 000000000000000000000000000678;
