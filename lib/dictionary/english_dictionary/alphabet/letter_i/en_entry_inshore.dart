...
class EnglishEntryinshore extends StatefulWidget {
  const EnglishEntryinshore({super.key});

  @override
  State<EnglishEntryinshore> createState() => _EnglishEntryinshoreState();
}

class _EnglishEntryinshoreState extends State<EnglishEntryinshore> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inshore""");
  }
