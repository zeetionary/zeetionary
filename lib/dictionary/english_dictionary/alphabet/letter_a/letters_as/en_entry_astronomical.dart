...
// Define the word "astronomical" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryastronomical - replace speakAstronomical

// replace astronomical - /ˌæstrəˈnɒmɪkl/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryastronomical extends StatelessWidget {
  // blank divider
  EnglishEntryastronomical({super.key});
  // blank divider
  ...
  Future<void> speakastronomical(String languageCode) async {
    ...
    await flutterTts.speak("astronomical");
  }
  ...
  Future<void> speakastronomical512(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The astronomical observatory is located on a mountaintop.");
  }
  ...
  Future<void> speakastronomical514(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The costs were astronomical.");
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "astronomical"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
...
1. Inconceivably large (= astronomic, galactic)
 
2. Relating or belonging to the science of astronomy (= astronomic)
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'WgxO7vhlF7A';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'GDc6PxpAMeY';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = '1scFuf0K9U0';
