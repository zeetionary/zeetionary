...
class EnglishEntryfatuously extends StatefulWidget {
  const EnglishEntryfatuously({super.key});

  @override
  State<EnglishEntryfatuously> createState() => _EnglishEntryfatuouslyState();
}

class _EnglishEntryfatuouslyState extends State<EnglishEntryfatuously> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fatuously""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fatuously""",
                      // alsoEnglishWord: "also: fatuously",
                      britshText: """IpaUK: /ˈfætʃuəsli/""",
                      americanText: """IpaUS: /ˈfætʃuəsli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "fatuously";
...
کوردی: گەوجانە، نەفامانە
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵکار) گەمژانە"""),
          SentencesRow(
            englishText: """They chattered fatuously about old movies.""",
            kurdishText: """گەمژانە دەمەتەقێیان بوو لەسەر فیلمە کۆنەکان.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: fatuously
1. Vacuously or complacently and unconsciously foolish (= inanely)
"He values it all sublimely and perhaps a little fatuously";
""",
  );
...
const String _videoIdend = 'https://youtu.be/yQb3oNv1V8c?t=';
const double _startSecondsend = 000000000000000000000000000506;
const String _videoIdone = 'https://youtu.be/xgwWe0Nu_KI?t=';
const double _startSecondsone = 000000000000000000000000000489;
const String _videoIdtwo = 'https://youtu.be/So8i6oJzA5M?t=';
const double _startSecondstwo = 0000000000000000000000000001270;
const String _videoIdthree = 'https://youtu.be/ZPayBG3uc4E?t=';
const double _startSecondsthree = 0000000000000000000000000004071;
const String _videoIdfour = 'https://youtu.be/JVcNn2B2Ldk?t=';
const double _startSecondsfour = 000000000000000000000000000246;
const String _videoIdfive = 'https://youtu.be/cm73iUi-pLo?t=';
