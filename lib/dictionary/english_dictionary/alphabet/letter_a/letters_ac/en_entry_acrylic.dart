...
class EnglishEntryacrylic extends StatefulWidget {
  const EnglishEntryacrylic({super.key});

  @override
  State<EnglishEntryacrylic> createState() => _EnglishEntryacrylicState();
}

class _EnglishEntryacrylicState extends State<EnglishEntryacrylic> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""acrylic""");
  }
  ...
  Future<void> speakacryl1256(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("an acrylic sweater");
  }
  ...
  Future<void> speakacry4289(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("acrylic paint");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acrylic""",
                      // alsoEnglishWord: "also: acrylic",
                      britshText: """IpaUK: /əˈkrɪlɪk/""",
                      americanText: """IpaUS: /əˈkrɪlɪk/""",
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'RLW5fSJd03s';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '7t9Syo1SWs0';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'v15w3t2ws6E';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'tSc7F_fxvMI';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'zn3pCipJdks';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '9a5gfmRm0yU';
  final double _startSeconds = 10;
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = '7R10DA5Cm-c';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'I2EFeaMkqwA';
