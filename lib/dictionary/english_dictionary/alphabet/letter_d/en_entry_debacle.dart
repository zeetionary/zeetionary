...
class EnglishEntrydebacle extends StatefulWidget {
  const EnglishEntrydebacle({super.key});

  @override
  State<EnglishEntrydebacle> createState() => _EnglishEntrydebacleState();
}

class _EnglishEntrydebacleState extends State<EnglishEntrydebacle> {
  @override
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "debacle");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: debacle");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /dɪˈbɑːkl/,  /deɪˈbɑːkl/");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakdebacle(String languageCode) async {
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /dɪˈbɑːkl/");
  }
}
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakdebacles1(String languageCode) async {
    // DOPSUM: CHANGE speakdebacle
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
...
کوردی: تێشکانی تەواو، تێشکانی لە ناکاو و بە تەواوەتی، کارەسات، بەڵا، مەینەتی
"""),
          const DefinitionKurdish(
              text:
                  "١. (ناو) ڕووداوێک کە شکستێکی تەواوە و دەبێتە هۆکاری ئەوەی خەڵکی هەست بە شەرم بکەن"),
          Row(
            children: [
              const Expanded(
                child: Column(
                  children: [
                    ...
                    ExampleSentenceKurdish(
                        text:
                            "دەبێت بەرپرسیاریەتی بۆ مەینەتییەکە هەڵبگرێت و دەست لەکاربکێشێتەوە."),
                  ],
                ),
              ),
...
// Create an instance of EnglishMeaningConst with the desired text
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: debacle (Derived forms: debacles, débâcles)
1. A disastrous or embarrassing failure (= fiasco, débâcle)
 
2. Flooding caused by a tumultuous breakup of ice in a river during the spring or summer (= débâcle)
 
3. A sound defeat (= thrashing, walloping, drubbing, slaughter, trouncing, whipping, hammering [informal], pasting [informal], débâcle, smackdown [N. Amer, informal], beatdown [N. Amer])
""",
  );
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/4Fq32-bNB-A?t=',
    startSeconds: 16,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
