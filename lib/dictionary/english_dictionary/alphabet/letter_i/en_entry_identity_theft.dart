...
class EnglishEntryidentitytheft extends StatefulWidget {
  const EnglishEntryidentitytheft({super.key});

  @override
  State<EnglishEntryidentitytheft> createState() =>
      _EnglishEntryidentitytheftState();
}

class _EnglishEntryidentitytheftState extends State<EnglishEntryidentitytheft> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: identity theft (Derived forms: identity thefts)
...
""",
  ...
  final String keyword = "identity theft";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""identity theft""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/vsMydMDi3rI?t=';
    const double startSecondsend = 00000000000000000000000000032;
    const String videoIdone = 'https://youtu.be/KJ4N8JM_n_U?t=';
    const double startSecondsone = 000000000000000000000000000874;
    const String videoIdtwo = 'https://youtu.be/Kn9tr1nhU7E?t=';
    const double startSecondstwo = 000000000000000000000000000150;
    const String videoIdthree = 'https://youtu.be/aS6z0bEpVpM?t=';
    const double startSecondsthree = 000000000000000000000000000258;
    const String videoIdfour = 'https://youtu.be/7KRceywz-rU?t=';
    const double startSecondsfour = 0000000000000000000000000001472;
    const String videoIdfive = 'https://youtu.be/MavIx74cYBk?t=';
    const double startSecondsfive = 000000000000000000000000000821;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """identity theft""",
                      // alsoEnglishWord: "also: identity theft",
                      britshText: """IpaUK: /aɪˈdentəti θeft/""",
                      americanText: """IpaUS: /aɪˈdentəti θeft/""",
...
// With short examples define "identity theft", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The number of identity thefts in Britain rose to 42 029 last year.""",
                      kurdishText:
                          """ژمارەی تاوانی دزینی ناسنامە لە بەریتانیا ساڵی ڕابردوو بۆ ٤٢٠٢٩ بەرزبوویەوە.""",
