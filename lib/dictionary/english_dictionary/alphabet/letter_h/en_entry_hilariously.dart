...
class EnglishEntryhilariously extends StatefulWidget {
  const EnglishEntryhilariously({super.key});

  @override
  State<EnglishEntryhilariously> createState() =>
      _EnglishEntryhilariouslyState();
}

class _EnglishEntryhilariouslyState extends State<EnglishEntryhilariously> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: hilariously
1. In a hilarious manner (- uproariously)
"hilariously funny";
""",
  );

  final String keyword = "hilariously";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hilariously""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her new book's hilariously funny.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001633;
    const String videoIdone = 'https://youtu.be/90MNvA5ozcI?t=';
    const double startSecondsone = 0000000000000000000000000002148;
    const String videoIdtwo = 'https://youtu.be/HE2Jg3GXH6Q?t=';
    const double startSecondstwo = 00000000000000000000000000045;
    const String videoIdthree = 'https://youtu.be/C6Ni9rH6VmA?t=';
    const double startSecondsthree = 00000000000000000000000000097;
    const String videoIdfour = 'https://youtu.be/oHLMla-75QA?t=';
    const double startSecondsfour = 000000000000000000000000000321;
    const String videoIdfive = 'https://youtu.be/HbUGTcdFIio?t=';
    const double startSecondsfive = 0000000000000000000000000002041;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hilariously""",
                      // alsoEnglishWord: "also: hilariously",
                      britshText: """IpaUK: /hɪˈleəriəsli/""",
                      americanText: """IpaUS: /hɪˈleriəsli/""",
...
کوردی: پێکەنینی‌یانە، قۆشمانە، گاڵتەجاڕانە
"""),
// With short examples define "hilariously", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە تەواو جێگای پێکەنینە"""),
                    SentencesRow(
                      englishText: """Her new book's hilariously funny.""",
                      kurdishText: """پەرتووکە تازەکەی تەواو پێکەنیناوییە.""",
