...
class EnglishEntryhoneycomb extends StatefulWidget {
  const EnglishEntryhoneycomb({super.key});

  @override
  State<EnglishEntryhoneycomb> createState() => _EnglishEntryhoneycombState();
}

class _EnglishEntryhoneycombState extends State<EnglishEntryhoneycomb> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: honeycomb (Derived forms: honeycombs)
...
- Verb: honeycomb (Derived forms: honeycombed, honeycombing, honeycombs)
...
""",
  ...
  final String keyword = "honeycomb";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""honeycomb""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/DfSnHyIryeY?t=';
    const double startSecondsend = 000000000000000000000000000266;
    const String videoIdone = 'https://youtu.be/YZoZr_m9WLU?t=';
    const double startSecondsone = 000000000000000000000000000589;
    const String videoIdtwo = 'https://youtu.be/5evWhHWOX40?t=';
    const double startSecondstwo = 0000000000000000000000000003;
    const String videoIdthree = 'https://youtu.be/EqjgZyAqlUM?t=';
    const double startSecondsthree = 0000000000000000000000000001;
    const String videoIdfour = 'https://youtu.be/YhwPRy334J0?t=';
    const double startSecondsfour = 00000000000000000000000000034;
    const String videoIdfive = 'https://youtu.be/xChcbwJt46Q?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """honeycomb""",
                      // alsoEnglishWord: "also: honeycomb",
                      britshText: """IpaUK: /ˈhʌnikəʊm/""",
                      americanText: """IpaUS: /ˈhʌnikəʊm/""",
...
کوردی: شانەهەنگوین، هەنگەماڵ، شانەهەنگ، تیرەشان
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) شانەی هەنگ؛ کۆمەڵێک خانە کە شەش لایان هەیە و مێشهەنگ هەنگوینی هێلکەکانیانی تێدا هەڵدەگرن"""),
                    SentencesRow(
                      englishText:
