...
class EnglishEntryindicative extends StatefulWidget {
  const EnglishEntryindicative({super.key});

  @override
  State<EnglishEntryindicative> createState() => _EnglishEntryindicativeState();
}

class _EnglishEntryindicativeState extends State<EnglishEntryindicative> {
  @override
  void initState() {
    super.initState();
...
1. (usually followed by 'of') pointing out or revealing clearly (- indicatory, revelatory, significative, suggestive)
"actions indicative of fear";
 
2. (grammar) of, or relating to the indicative mood (- declarative)
"indicative mood";

- Noun: indicative (Derived forms: indicatives)
1. A mood (grammatically unmarked) that represents the act or state as an objective fact (- indicative mood, declarative mood, declarative, common mood, fact mood)
""",
  );

  final String keyword = "indicative";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indicative""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/EHJNGdFll4o?t=';
    const double startSecondsend = 000000000000000000000000000798;
    const String videoIdone = 'https://youtu.be/kcUFSapjVqk?t=';
    const double startSecondsone = 000000000000000000000000000880;
    const String videoIdtwo = 'https://youtu.be/b4wRdoWpw0w?t=';
    const double startSecondstwo = 000000000000000000000000000681;
    const String videoIdthree = 'https://youtu.be/fgfqV6SJyHo?t=';
    ...
    const String videoIdfive = 'https://youtu.be/C1oxhniG_Fc?t=';
    const double startSecondsfive = 0000000000000000000000000001145;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indicative""",
                      // alsoEnglishWord: "also: indicative",
                      britshText: """IpaUK: /ɪnˈdɪkətɪv/""",
                      americanText: """IpaUS: /ɪnˈdɪkətɪv/""",
...
کوردی: 
"""),
// With short examples define "indicative", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە شتێک پیشان دەدات یان ئاماژەی پێدەکات"""),
                    SentencesRow(
                      englishText:
                          """Their failure to act is indicative of their lack of interest.""",
                      kurdishText:
                          """شکستهێنانیان لە هەنگاونان دەرخەری کەمی حەزیانە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The rise in unemployment is seen as indicative of a new economic recession.""",
                      kurdishText:
                          """بەرزبوونەوەی بێکاری وەک دەرخەری قەیرانێکی ئابووری تازە دەبیندرێت.""",
