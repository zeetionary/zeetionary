...
class EnglishEntryflea extends StatefulWidget {
  const EnglishEntryflea({super.key});

  @override
  State<EnglishEntryflea> createState() => _EnglishEntryfleaState();
}

class _EnglishEntryfleaState extends State<EnglishEntryflea> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The dog has fleas.""");
  }
...
// With short examples define "flea", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The dog has fleas.""",
                      kurdishText: """سەگەکە کێچی گرتە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/qUNYPkroz18?t=';
const double _startSecondsend = 00000000000000000000000000064;
const String _videoIdone = 'https://youtu.be/DgqcU5TuEjo?t=';
const double _startSecondsone = 00000000000000000000000000040;
const String _videoIdtwo = 'https://youtu.be/daaDuC1kbds?t=';
...
const String _videoIdfour = 'https://youtu.be/g3cQCjCQWIc?t=';
const double _startSecondsfour = 000000000000000000000000000198;
const String _videoIdfive = 'https://youtu.be/zHfha18xbtg?t=';
