...
class EnglishEntrygasmask extends StatefulWidget {
  const EnglishEntrygasmask({super.key});

  @override
  State<EnglishEntrygasmask> createState() => _EnglishEntrygasmaskState();
}

class _EnglishEntrygasmaskState extends State<EnglishEntrygasmask> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gas mask""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We had to wear a gas mask to handle it.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gas mask""",
                      // alsoEnglishWord: "also: gas mask",
                      britshText: """IpaUK: /ˈɡæs mɑːsk/""",
                      americanText: """IpaUS: /ˈɡæs mæsk/""",
...
// With short examples define "gas mask", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پێویست بوو ماسکێکی گازی ببەستین بۆ ئەوەی مامەڵەی لەگەڵ بکەین.""",
...
const String _videoIdtwo = 'https://youtu.be/AdZ9kGwqkTM?t=';
const double _startSecondstwo = 000000000000000000000000000245;
const String _videoIdthree = 'https://youtu.be/QdwxKdYG1qI?t=';
const double _startSecondsthree = 000000000000000000000000000156;
const String _videoIdfour = 'https://youtu.be/MDdHYjb5sBk?t=';
const double _startSecondsfour = 0000000000000000000000000002228;
const String _videoIdfive = 'https://youtu.be/qe87I2LiLko?t=';
