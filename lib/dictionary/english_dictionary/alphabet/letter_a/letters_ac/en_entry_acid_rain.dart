...
class EnglishEntryacidrain extends StatefulWidget {
  const EnglishEntryacidrain({super.key});

  @override
  State<EnglishEntryacidrain> createState() => _EnglishEntryacidrainState();
}

class _EnglishEntryacidrainState extends State<EnglishEntryacidrain> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "acid rain";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""acid rain""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acid rain""",
                      // alsoEnglishWord: "also: acid rain",
                      britshText: """IpaUK: /ˌæsɪd ˈreɪn/""",
                      americanText: """IpaUS: /ˌæsɪd ˈreɪn/""",
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '0nCT8h8gO1g';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'lhHUMJXWKlc';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = '5gKTNob4WJA';
