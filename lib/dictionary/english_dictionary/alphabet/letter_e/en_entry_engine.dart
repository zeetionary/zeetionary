...
class EnglishEntryengine extends StatefulWidget {
  const EnglishEntryengine({super.key});

  @override
  State<EnglishEntryengine> createState() => _EnglishEntryengineState();
}

class _EnglishEntryengineState extends State<EnglishEntryengine> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """engine""",
                      // alsoEnglishWord: "also: engine",
                      britshText: """IpaUK: /ˈendʒɪn/""",
                      americanText: """IpaUS: /ˈendʒɪn/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I got in the car and started the engine.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""My car had to have a new engine.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The engine runs on diesel.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Its engine is powered by both gasoline and electricity.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Great newspapers serve as an engine for positive change.""");
  }
...
کوردی: بزوێنە، جووڵێنە(ڕ)، مۆتۆڕ، لۆکۆمۆتیڤ،	ماشێنی ئاگرکوژێنەوە،	ئامێری میکانیکی، ئامراز، ئامێر، وەسیلە، دەزگا
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) بزوێنەری ئۆتۆمبێل، هتد کە جووڵە درووست دەکات"""),
          SentencesRow(
            englishText: """I got in the car and started the engine.""",
            kurdishText: """چوومە ئۆتۆمبێلەکە و بزوێنەرەکەم خستە کار.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """My car had to have a new engine.""",
            kurdishText: """ئۆتۆمبێلەکەم پێویستیی بە بزوێنەرێکی تازە بوو.""",
          ...
          Column(
            children: [
              MyExpansionTile(
                children: [
                  SentencesRow(
                    englishText: """The engine runs on diesel.""",
                    kurdishText: """بزوێنەرەکە بە دیزڵ کار دەکات.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """بزوێنەرەکەی بە هەردوو گازوایڵ و کارەبا کار دەکات.""",
          ...
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) شتێک کە ڕۆڵی گرنگی هەیە لە ڕوودانی شتێک"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Agriculture is a key engine of growth in most developing countries.""",
            kurdishText:
                """کشتوکاڵ بزوێنەرێکی سەرەکیی گەشەیە لە زۆر وڵاتی تازە پێشکەوتوودا.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """ڕۆژنامە گەورەکان وەک بزوێنەری گۆڕانی ئەرێنی کار دەکەن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He was the engine behind the victory.""",
            kurdishText: """بزوێنەری پشت سەرکەوتنەکە بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: engine (Derived forms: engines)
1. Motor that converts thermal energy to mechanical work
 
2. Something used to achieve a purpose
"an engine of change"
 
3. A wheeled vehicle consisting of a self-propelled engine that is used to draw trains along railway tracks (= locomotive, locomotive engine, railway locomotive [Brit, Cdn], loco [informal], railroad locomotive [N. Amer])
...
const String _videoIdsix = 'https://youtu.be/Wiy8icSKKQs?t=';
const double _startSecondssix = 1356;
