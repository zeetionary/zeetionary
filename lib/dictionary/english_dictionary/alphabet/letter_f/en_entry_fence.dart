...
class EnglishEntryfence extends StatefulWidget {
  const EnglishEntryfence({super.key});

  @override
  State<EnglishEntryfence> createState() => _EnglishEntryfenceState();
}

class _EnglishEntryfenceState extends State<EnglishEntryfence> {
  @override
  void initState() {
    super.initState();
...
4. Surround with a wall, e.g. for protection, shelter or privacy (= wall, palisade, fence in, surround)
 
5. Have an argument about something (= argue, contend, debate)
""",
  );

  final String keyword = "fence";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The two women chatted over the garden fence.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Security guards with dogs patrolled the perimeter fence.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She walked over to the tall wooden fence.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His property is fenced with barbed wire.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fence""",
                      // alsoEnglishWord: "also: fence",
                      britshText: """IpaUK: /fens/""",
                      americanText: """IpaUS: /fens/""",
...
کوردی: حەوشە، حەسار، دیوار، نەردە، پەرژین، کەناری، سێنچ، تان، ناڤبریک، کونگی، چیل، شوورە، تەیمان، چیلە، ڕیتاڵ، تۆڕ
"""),
// With short examples define "fence", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دوو ژنەکە بەسەر پەرژینی باخچەکەدا دەمەتەقێیان دەکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پاسەوانەکان لەگەڵ سەگدا پاسەوانی پەرژینی بیناکەیان دەکرد.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She walked over to the tall wooden fence.""",
                      kurdishText: """بەسەر پەرژینە دارینە بەرزەکەدا ڕۆشت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زەوییەکەی بە وایەری تەلدار پەرژین کراوە.""",
...
const double _startSecondsend = 000000000000000000000000000154;
const String _videoIdone = 'https://youtu.be/QLq6GEiHqR8?t=';
const double _startSecondsone = 0000000000000000000000000001036;
const String _videoIdtwo = 'https://youtu.be/fez7X_oevNs?t=';
const double _startSecondstwo = 000000000000000000000000000189;
const String _videoIdthree = 'https://youtu.be/qr4MSVxfYBE?t=';
const double _startSecondsthree = 000000000000000000000000000575;
const String _videoIdfour = 'https://youtu.be/BztMgcNgobk?t=';
const double _startSecondsfour = 0000000000000000000000000001548;
const String _videoIdfive = 'https://youtu.be/8hTarWb0C9M?t=';
const double _startSecondsfive = 000000000000000000000000000150;
