...
class EnglishEntryflippancy extends StatefulWidget {
  const EnglishEntryflippancy({super.key});

  @override
  State<EnglishEntryflippancy> createState() => _EnglishEntryflippancyState();
}

class _EnglishEntryflippancyState extends State<EnglishEntryflippancy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flippancy (Derived forms: flippancies)
1. Inappropriate levity (= light-mindedness)
"Annika reacted to Tom's flippancy with a cool stare";
""",
  );

  final String keyword = "flippancy";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flippancy""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This is not the time for flippancy.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He spoke with a flippancy he was far from feeling.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flippancy""",
                      // alsoEnglishWord: "also: flippancy",
                      britshText: """IpaUK: /ˈflɪpənsi/""",
                      americanText: """IpaUS: /ˈflɪpənsi/""",
...
کوردی: 
"""),
// With short examples define "flippancy", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی شتێک بە جدی نابینیت، یان بەو شێوەیەی کە کەسانی دیکە چاوەڕێ دەکەن"""),
                    SentencesRow(
                      englishText: """This is not the time for flippancy.""",
                      kurdishText: """ئەمە کاتی گاڵتەجاڕی نییە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He spoke with a flippancy he was far from feeling.""",
                      kurdishText:
                          """بە گەمە و گاڵتەیەکەوە قسەی دەکرد کە (خۆی) هیچ هەستی پێنەدەکرد.""",
                      kurdishNote:
                          "ئەوەی باسی دەکرد ئەوە نەبوو کە بە ڕاستی هەستی پێدەکرد",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/l_U2YPeGy9U?t=';
const double _startSecondsend = 000000000000000000000000000770;
const String _videoIdone = 'https://youtu.be/qmAJsNoRMaM?t=';
const double _startSecondsone = 000000000000000000000000000854;
const String _videoIdtwo = 'https://youtu.be/oWzQ9zAK4xM?t=';
const double _startSecondstwo = 00000000000000000000000000057;
const String _videoIdthree = 'https://youtu.be/ls3MCdHFJpA?t=';
const double _startSecondsthree = 0000000000000000000000000002086;
const String _videoIdfour = 'https://youtu.be/n09aSDjDaFw?t=';
const double _startSecondsfour = 000000000000000000000000000847;
const String _videoIdfive = 'https://youtu.be/sZqLW4A26c4?t=';
