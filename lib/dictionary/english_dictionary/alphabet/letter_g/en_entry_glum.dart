...
class EnglishEntryglum extends StatefulWidget {
  const EnglishEntryglum({super.key});

  @override
  State<EnglishEntryglum> createState() => _EnglishEntryglumState();
}

class _EnglishEntryglumState extends State<EnglishEntryglum> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The players sat there with glum looks on their faces.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""You look glum. What's up?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glum""",
                      // alsoEnglishWord: "also: glum",
                      britshText: """IpaUK: /ɡlʌm/""",
                      americanText: """IpaUS: /ɡlʌm/""",
...
کوردی: خەمبار، دڵتەنگ، مات، ناڕەحەت، کز، بێ‌کەیف، ناڤچاڤ‌شین، ڕووسارد، ناهومێد
"""),
// With short examples define "glum", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """یاریزانەکان لەوێ دانیشتبوون بە نیگای پەژارەیی لەسەر ڕووخساریان.""",
                    ...
                    SentencesRow(
                      englishText: """You look glum. What's up?""",
                      kurdishText: """پەژارە دیاریت، چی باسە؟""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/3RkhZgRNC1k?t=';
const double _startSecondsend = 0000000000000000000000000001409;
const String _videoIdone = 'https://youtu.be/K6FteqXWtYI?t=';
const double _startSecondsone = 0000000000000000000000000002005;
const String _videoIdtwo = 'https://youtu.be/1_ogluZE5AM?t=';
const double _startSecondstwo = 000000000000000000000000000149;
const String _videoIdthree = 'https://youtu.be/J-4FaTv1mcM?t=';
const double _startSecondsthree = 000000000000000000000000000223;
const String _videoIdfour = 'https://youtu.be/pJPKn9VnfgI?t=';
const double _startSecondsfour = 000000000000000000000000000421;
const String _videoIdfive = 'https://youtu.be/akPZjOZZVNk?t=';
const double _startSecondsfive = 0000000000000000000000000001289;
