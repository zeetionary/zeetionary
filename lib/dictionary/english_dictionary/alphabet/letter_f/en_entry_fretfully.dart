...
class EnglishEntryfretfully extends StatefulWidget {
  const EnglishEntryfretfully({super.key});

  @override
  State<EnglishEntryfretfully> createState() => _EnglishEntryfretfullyState();
}

class _EnglishEntryfretfullyState extends State<EnglishEntryfretfully> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "fretfully";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fretfully""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was moving fretfully around the room.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fretfully""",
                      // alsoEnglishWord: "also: fretfully",
                      britshText: """IpaUK: /ˈfretfəli/""",
                      americanText: """IpaUS: /ˈfretfəli/""",
...
کوردی: 
"""),
// With short examples define "fretfully", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە نیگەران و نائاسوودەیت"""),
                    SentencesRow(
                      englishText:
                          """He was moving fretfully around the room.""",
                      kurdishText:
                          """بە نیگەرانییەوە بە ژوورەکەدا دەسووڕایەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/5leX503ea2k?t=';
const double _startSecondsend = 0000000000000000000000000001836;
const String _videoIdone = 'https://youtu.be/nzxFa8CDKgU?t=';
const double _startSecondsone = 000000000000000000000000000229;
const String _videoIdtwo = 'https://youtu.be/rjETn25MuDc?t=';
const double _startSecondstwo = 000000000000000000000000000432;
const String _videoIdthree = 'https://youtu.be/jiDipjfNEVg?t=';
const double _startSecondsthree = 0000000000000000000000000002136;
const String _videoIdfour = 'https://youtu.be/5Fuplg6MhPQ?t=';
const double _startSecondsfour = 00000000000000000000000000016552;
const String _videoIdfive = 'https://youtu.be/GD5Ln-WVOC0?t=';
const double _startSecondsfive = 00000000000000000000000000014867;
