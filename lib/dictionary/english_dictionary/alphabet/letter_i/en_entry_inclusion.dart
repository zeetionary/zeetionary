...
class EnglishEntryinclusion extends StatefulWidget {
  const EnglishEntryinclusion({super.key});

  @override
  State<EnglishEntryinclusion> createState() => _EnglishEntryinclusionState();
}

class _EnglishEntryinclusionState extends State<EnglishEntryinclusion> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inclusion""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 653;
    const String videoIdone = 'EFQFKVFLuOA';
    const double startSecondsone = 284;
    const String videoIdtwo = 'f5jwTft6654';
    const double startSecondstwo = 497;
    const String videoIdthree = 'qqZ_SH9N3Xo';
    const double startSecondsthree = 1659;
    const String videoIdfour = 'tTJeePNgOF8';
    const double startSecondsfour = 517;
    const String videoIdfive = 'EmT0i0xG6zg';
    const double startSecondsfive = 3534;
