...
class EnglishEntrycastoroil extends StatelessWidget {
  // blank divider
  EnglishEntrycastoroil({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcastoroil(String languageCode) async {
    // DOPSUM: CHANGE speakcastoroil
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "castor oil"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈkɑːstər ɔɪl/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcastoroil("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈkæstər ɔɪl/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcastoroil("en-US"),
                            ),
                          ],
                        ),
                      ],
...
١. (ناو) ڕۆنێکی زەرد کە لە ڕووەکێکی خولگەیی دەردەهێنرێت و لا ڕابردوودا وەک دەرمان بەکاردەهات، بەتایبەتی بۆ بەتاڵکردنی ڕیخۆڵە"""),
                          Row(
                            children: [
                              const Expanded(
                                child: Column(
                                  children: [
                                    ...
                                    ExampleSentenceKurdish(
                                        text:
                                            "بەکارهێنانی ڕۆنە گەرچەک دەکرێت یارمەتی ڕووخساری وشک شێداربکاتەوە."),
                                  ],
                                ),
                              ),
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/zBHcJBYJ6a0?t=',
    startSeconds: 37,
    autoPlay: true,
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/ae8LN5Mvytg?t=',
    startSeconds: 68,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/3N7Mn2HJw3g?t=',
    startSeconds: 7,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/2Y6VJTXuJe0',
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/H3Den05Q_D0?t=',
    startSeconds: 50,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/CzoG2Mld3I0?t=',
    startSeconds: 379,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
