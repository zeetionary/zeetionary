...
class EnglishEntrylongrange extends StatefulWidget {
  const EnglishEntrylongrange({super.key});

  @override
  State<EnglishEntrylongrange> createState() => _EnglishEntrylongrangeState();
}

class _EnglishEntrylongrangeState extends State<EnglishEntrylongrange> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""long-range""");
  }
