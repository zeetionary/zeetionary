...
class EnglishEntryhubcap extends StatefulWidget {
  const EnglishEntryhubcap({super.key});

  @override
  State<EnglishEntryhubcap> createState() => _EnglishEntryhubcapState();
}

class _EnglishEntryhubcapState extends State<EnglishEntryhubcap> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hubcap (Derived forms: hubcaps)
1. Cap that fits over the hub of a wheel
""",
  );

  final String keyword = "hubcap";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She replaced the broken hubcap on her car.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 000000000000000000000000000209;
    const String videoIdtwo = 'https://youtu.be/p70E1GxMP3o?t=';
    const double startSecondstwo = 0000000000000000000000000001165;
    const String videoIdthree = 'https://youtu.be/N2B5cfiKxs4?t=';
    const double startSecondsthree = 000000000000000000000000000576;
    const String videoIdfour = 'https://youtu.be/2fuPkOI2OJE?t=';
    const double startSecondsfour = 000000000000000000000000000195;
    const String videoIdfive = 'https://youtu.be/u7Wja0rdc-U?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hubcap""",
                      // alsoEnglishWord: "also: hubcap",
                      britshText: """IpaUK: /ˈhʌbkæp/""",
                      americanText: """IpaUS: /ˈhʌbkæp/""",
...
کوردی: سەرتۆپ، تۆپەوانە، تۆپوانە، سەرەتۆپ، تۆپ‌پۆش، کڵاوەی تۆپ
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) داپۆشەرێک کە دەدرێت بەسەر چەقی ویلی پێڕۆیەکدا"""),
                    SentencesRow(
                      englishText:
                          """She replaced the broken hubcap on her car.""",
                      kurdishText:
                          """تۆپەوانە شکاوەکەی سەر ئۆتۆمبێلەکەیی گۆڕی.""",
