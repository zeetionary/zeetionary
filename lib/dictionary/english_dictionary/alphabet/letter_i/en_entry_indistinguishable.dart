...
class EnglishEntryindistinguishable extends StatefulWidget {
  ...
  @override
  State<EnglishEntryindistinguishable> createState() => _EnglishEntryindistinguishableState();
}

class _EnglishEntryindistinguishableState extends State<EnglishEntryindistinguishable> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryindistinguishable indistinguishable
WORD_WEB indistinguishable indistinguishable indistinguishable
haʊʊʊʊʊʊʊ4
""",
  );
