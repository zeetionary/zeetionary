...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakcoverages2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The TV company was given a special award for its news coverage."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcoverages3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The minister's resignation was given widespread coverage."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcoverages4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcoverages400"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcoverages5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcoverages500"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcoverages6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcoverages600"); // DOPSUM: CHANGE TEXT
  }
...
"""),
          const DefinitionKurdish(text: "١. (ناو) ڕووماڵی هەواڵ و وەرزش لە میدیادا"),
          Row(
            children: [
              const Expanded(
                child: Column(
                  children: [
                    ...
                    ExampleSentenceKurdish(text: "ڕووماڵی بەرفراوانی جیابوونەوە شاهانەییەکە هەبوو."),
                  ],
                ),
              ),
          ...
          text: "کۆمپانیا تەلەفیزیۆنێکە خەڵاتی تایبەتی پێدرا بۆ ڕووماڵەکەی بۆ هەواڵەکە."),
          ],
          ),
          ),
          ...
          ExampleSentenceKurdish(
          text: "دەستلەکارکێشانەوەی وەزیرەکە ڕووماڵی بەرفراوانی پێدرا."),
          ],
          ),
          ),
          const CustomSizedBoxForTTS(),
