...
class EnglishEntryhiccup extends StatefulWidget {
  const EnglishEntryhiccup({super.key});

  @override
  State<EnglishEntryhiccup> createState() => _EnglishEntryhiccupState();
}

class _EnglishEntryhiccupState extends State<EnglishEntryhiccup> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hiccup (Derived forms: hiccups)
1. (usually plural) the state of having reflex spasms of the diaphragm accompanied by a rapid closure of the glottis producing an audible sound; sometimes a symptom of indigestion (- hiccough, singultus)
"how do you cure the hiccups?";

- Verb: hiccup (Derived forms: hiccuped, hiccuping, hiccupped, hiccups)
1. Breathe spasmodically, and make a sound (- hiccough)
"When you have to hiccup, drink a glass of cold water";
""",
  );

  final String keyword = "hiccup";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She gave a loud hiccup.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I ate too quickly and got hiccups.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He had the hiccups.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There was a slight hiccup in the timetable.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I can't stop hiccuping - does anyone know a good cure?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hiccup""",
                      // alsoEnglishWord: "also: hiccup",
                      britshText: """IpaUK: /ˈhɪkʌp/""",
                      americanText: """IpaUS: /ˈhɪkʌp/""",
...
کوردی: نزگرە، هەرس، هەسر، شهی، هکەهک، ئیسک،	کێشەی نیوەچڵ، هەڵوەستەی کاتی یان کورت، ئاستەنگی چکۆلانە، کێشەی بچووک، مەسەلەیەکی هیچ، گرفتێکی چکۆلانە
"""),
// With short examples define "hiccup", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) نزگەرە"""),
                    SentencesRow(
                      englishText: """She gave a loud hiccup.""",
                      kurdishText: """نزگەرەیەکی بەرزی کرد.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) زنجیرە نزگەرە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I ate too quickly and got hiccups.""",
                      kurdishText:
                          """زۆر بە خێرایی نانم خوارد و نزگەرەم گرت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He had the hiccups.""",
                      kurdishText: """نزگەرەی گرت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) کێشەیەکی بچووک یان دواکەوتنێکی کاتی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """There was a slight hiccup in the timetable.""",
                      kurdishText: """کەمێک کێشە لە خشتەی کاتەکان هەبوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """We’ve planned it down to the last detail—we don’t want any unexpected hiccups.""",
                      kurdishText:
                          """تا بچووکترین وردەکاری پلانمان داناوە ـ نامانەوێت هیچ دواکەوتنێکی پێشبینی‌نەکراو ڕووبدات.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (کردار) هەبوونی نزگەرە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I can't stop hiccuping - does anyone know a good cure?""",
                      kurdishText:
                          """ناتوانم لە نزگەرە بوەستم ـ هیچ کەس چارەسەرێک دەزانێت؟""",
...
const double _startSecondsend = 0000000000000000000000000001416;
const String _videoIdone = 'https://youtu.be/HDntl7yzzVI?t=';
const double _startSecondsone = 0000000000000000000000000001732;
const String _videoIdtwo = 'https://youtu.be/syH0oN_B4g0?t=';
const double _startSecondstwo = 000000000000000000000000000412;
const String _videoIdthree = 'https://youtu.be/zItV3TbP5XA?t=';
const double _startSecondsthree = 000000000000000000000000000230;
const String _videoIdfour = 'https://youtu.be/dRLCZqEfJFA?t=';
const double _startSecondsfour = 000000000000000000000000000348;
const String _videoIdfive = 'https://youtu.be/4K-_KbbRiEE?t=';
const double _startSecondsfive = 000000000000000000000000000779;
