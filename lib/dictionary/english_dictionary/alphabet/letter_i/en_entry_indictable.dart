...
class EnglishEntryindictable extends StatefulWidget {
  const EnglishEntryindictable({super.key});

  @override
  State<EnglishEntryindictable> createState() => _EnglishEntryindictableState();
}

class _EnglishEntryindictableState extends State<EnglishEntryindictable> {
  @override
  void initState() {
    super.initState();
...
1. Liable to be accused, or cause for such liability (- chargeable)
"an indictable offence";
""",
  );

  final String keyword = "indictable";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indictable""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Robbery is an indictable offence.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/kroDJT2Qmrg?t=';
    const double startSecondsend = 00000000000000000000000000082;
    const String videoIdone = 'https://youtu.be/yZ8wzG0J6NY?t=';
    const double startSecondsone = 0000000000000000000000000001357;
    const String videoIdtwo = 'https://youtu.be/0i6x_-h8SR8?t=';
    const double startSecondstwo = 000000000000000000000000000495;
    const String videoIdthree = 'https://youtu.be/f71Rasj_0JY?t=';
    const double startSecondsthree = 000000000000000000000000000190;
    const String videoIdfour = 'https://youtu.be/NzobxHaT-QA?t=';
    const double startSecondsfour = 000000000000000000000000000361;
    const String videoIdfive = 'https://youtu.be/r2GqqyK_2sM?t=';
    const double startSecondsfive = 000000000000000000000000000520;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indictable""",
                      // alsoEnglishWord: "also: indictable",
                      britshText: """IpaUK: /ɪnˈdaɪtəbl/""",
                      americanText: """IpaUS: /ɪnˈdaɪtəbl/""",
...
کوردی: 
"""),
// With short examples define "indictable", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) تاوانێک کە دەکرێت بە توندی سەیر بکرێیت و تاوانبار بکرێیت بۆی"""),
                    SentencesRow(
                      englishText: """Robbery is an indictable offence.""",
                      kurdishText:
                          """تاڵانکردن تاوانێکی شیاو بە تاوانبارکردنە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کەسێک کە دەکرێت بە تاوانێک تاوانبار بکرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Many more indictable offenders are tried in magistrates courts.""",
                      kurdishText:
                          """زۆربەی تاوانبارانی سزادراو لە دادگا ناوخۆییەکان دادگایی دەکرێن.""",
