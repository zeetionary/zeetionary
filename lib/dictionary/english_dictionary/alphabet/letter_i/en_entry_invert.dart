...
class EnglishEntryinvert extends StatefulWidget {
  const EnglishEntryinvert({super.key});

  @override
  State<EnglishEntryinvert> createState() => _EnglishEntryinvertState();
}

class _EnglishEntryinvertState extends State<EnglishEntryinvert> {
  @override
  void initState() {
    super.initState();
