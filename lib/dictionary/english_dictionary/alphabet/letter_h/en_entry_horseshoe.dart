...
class EnglishEntryhorseshoe extends StatefulWidget {
  const EnglishEntryhorseshoe({super.key});

  @override
  State<EnglishEntryhorseshoe> createState() => _EnglishEntryhorseshoeState();
}

class _EnglishEntryhorseshoeState extends State<EnglishEntryhorseshoe> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: horseshoe (Derived forms: horseshoes)
1. Game equipment consisting of an open ring of iron used in playing horseshoes
 
2. U-shaped plate nailed to underside of horse's hoof (- shoe)
 
3. Something with the shape of a horseshoe

- Verb: horseshoe (Derived forms: horseshoed, horseshoes, horseshoeing)
1. Equip (a horse) with a horseshoe or horseshoes
""",
  );

  final String keyword = "horseshoe";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""horseshoe""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""For many people the horseshoe is a symbol of good luck.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/rtAAjKBH9GU?t=';
    const double startSecondsone = 00000000000000000000000000079;
    const String videoIdtwo = 'https://youtu.be/XXhc5UTxv5I?t=';
    const double startSecondstwo = 000000000000000000000000000769;
    const String videoIdthree = 'https://youtu.be/qr4MSVxfYBE?t=';
    const double startSecondsthree = 0000000000000000000000000001050;
    const String videoIdfour = 'https://youtu.be/wJa5Ch0O4BI?t=';
    const double startSecondsfour = 0000000000000000000000000001655;
    const String videoIdfive = 'https://youtu.be/__qtH1ly2Sg?t=';
    const double startSecondsfive = 000000000000000000000000000544;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """horseshoe""",
                      // alsoEnglishWord: "also: horseshoe",
                      britshText: """IpaUK: /ˈhɔːsʃuː/,  /ˈhɔːʃʃuː/""",
                      americanText: """IpaUS: /ˈhɔːrʃʃuː/,  /ˈhɔːrsʃuː/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بۆ زۆر کەس ناڵی ئەسپ سمبولی بەختی باشە.""",
