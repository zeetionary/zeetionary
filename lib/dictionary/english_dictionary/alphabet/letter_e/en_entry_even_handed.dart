...
class EnglishEntryevenhanded extends StatefulWidget {
  const EnglishEntryevenhanded({super.key});

  @override
  State<EnglishEntryevenhanded> createState() => _EnglishEntryevenhandedState();
}

class _EnglishEntryevenhandedState extends State<EnglishEntryevenhanded> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""even-handed""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """even-handed""",
                      // alsoEnglishWord: "also: even-handed",
                      britshText: """IpaUK: /ˌiːvn ˈhændɪd/""",
                      americanText: """IpaUS: /ˌiːvn ˈhændɪd/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "even-handed";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He had an even-handed approach to the negotiations.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Their role was to dispense even-handed justice.""");
  }
...
// With short examples define "even-handed", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: 
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) تەواو دادپەروەر"""),
          SentencesRow(
            englishText:
                """He had an even-handed approach to the negotiations.""",
            kurdishText:
                """تێڕوانینێکی دادپەروەرانەی هەبوو بۆ دانووستانەکان.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Their role was to dispense even-handed justice.""",
            kurdishText: """ئەرکیان پێدانی داپەروەری یەکسان بوو.""",
...
const double _startSecondsend = 000000000000000000000000000000; // 418;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/iaqcwyZPuKg?t=';
const double _startSecondsone = 00000000000000000000000000000; // 416;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/bHbivOu0iGs?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 518;
const String _videoIdthree = 'VIDEOhttps://youtu.be/rLt-DvBKEJY?t=';
const double _startSecondsthree = 000000000000000000000000000; // 778;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/MSgbPZOIBHk?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1399;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/MMibZZqZ16Q?t=';
