...
class EnglishEntrygaily extends StatefulWidget {
  const EnglishEntrygaily({super.key});

  @override
  State<EnglishEntrygaily> createState() => _EnglishEntrygailyState();
}

class _EnglishEntrygailyState extends State<EnglishEntrygaily> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The gates were gaily painted in green, yellow, and red.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She waved gaily to the little crowd.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She gaily announced that she was leaving the next day.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gaily""",
                      // alsoEnglishWord: "also: gaily",
                      britshText: """IpaUK: /ˈɡeɪli/""",
                      americanText: """IpaUS: /ˈɡeɪli/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەروازەکان بە جوان بۆیە کرابوون بە سەوز، زەرد، و سوور.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە دڵخۆشییەوە سڵاویان لە جەماوەرە کەمەکە کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بێ باکانە ڕایگەیاند کە ڕۆژی دواتر دەچێت.""",
...
const String _videoIdtwo = 'https://youtu.be/1b-cD3-UnUA?t=';
const double _startSecondstwo = 000000000000000000000000000218;
const String _videoIdthree = 'https://youtu.be/hFe4GT1LgaY?t=';
const double _startSecondsthree = 000000000000000000000000000135;
const String _videoIdfour = 'https://youtu.be/wOblNE9kWnk?t=';
const double _startSecondsfour = 0000000000000000000000000002061;
const String _videoIdfive = 'https://youtu.be/yWw5LMwM8x8?t=';
const double _startSecondsfive = 0000000000000000000000000001147;
