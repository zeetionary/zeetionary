...
class EnglishEntryfiringsquad extends StatefulWidget {
  const EnglishEntryfiringsquad({super.key});

  @override
  State<EnglishEntryfiringsquad> createState() =>
      _EnglishEntryfiringsquadState();
}

class _EnglishEntryfiringsquadState extends State<EnglishEntryfiringsquad> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: firing squad (Derived forms: firing squads)
1. (military) a squad formed to fire volleys at a military funeral or to carry out a military execution (= firing party)
""",
  );

  final String keyword = "firing squad";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""firing squad""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was executed by (a) firing squad.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """firing squad""",
                      // alsoEnglishWord: "also: firing squad",
                      britshText: """IpaUK: /ˈfaɪərɪŋ skwɒd/""",
                      americanText: """IpaUS: /ˈfaɪərɪŋ skwɑːd/""",
...
// With short examples define "firing squad", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """He was executed by (a) firing squad.""",
                      kurdishText:
                          """لەلایەن دەستەیەکی گوللەبارانکردنەوە  کوژرا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/SG1vNoErfQw?t=';
const double _startSecondsend = 000000000000000000000000000647;
const String _videoIdone = 'https://youtu.be/qEHvgFsdjBc?t=';
const double _startSecondsone = 000000000000000000000000000241;
const String _videoIdtwo = 'https://youtu.be/PhJhJfMp658?t=';
const double _startSecondstwo = 000000000000000000000000000422;
const String _videoIdthree = 'https://youtu.be/9cKDo4cAR9o?t=';
const double _startSecondsthree = 000000000000000000000000000344;
const String _videoIdfour = 'https://youtu.be/_wIOqHSsV9c?t=';
const double _startSecondsfour = 0000000000000000000000000001014;
const String _videoIdfive = 'https://youtu.be/arBqhFisv7w?t=';
