...
// replace these: replace EnglishEntryacidrain - replace speakAcidrain - replace acid rain - /ˌæsɪd ˈreɪn/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryacidrain extends StatelessWidget {
  EnglishEntryacidrain({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'acid rain', // DOPSUM: CHANGE WORD ENTRY - Find /ˌæsɪd ˈreɪn/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌæsɪd ˈreɪn/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAcidrain(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '0nCT8h8gO1g';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'lhHUMJXWKlc';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = '5gKTNob4WJA';
