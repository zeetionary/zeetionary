...
class EnglishEntryfolk extends StatefulWidget {
  const EnglishEntryfolk({super.key});

  @override
  State<EnglishEntryfolk> createState() => _EnglishEntryfolkState();
}

class _EnglishEntryfolkState extends State<EnglishEntryfolk> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: folk (Derived forms: folks)
1. People in general (often used in the plural) (= folks, common people)
"they're just country folk"; "folks around here drink moonshine";
 
2. A social division of (usually preliterate) people (= tribe)
 
3. People descended from a common ancestor; blood relations (= family, family line, kinfolk, kinsfolk, phratry, kith and kin)
"his folk has lived in Massachusetts since the Mayflower";
 
4. The traditional and typically anonymous music that is an expression of the life of people in a community (= folk music, ethnic music)
""",
  );

  final String keyword = "folk";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'd like a job working with old folk or kids.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Folks say that he is a hard man.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There are a lot of old folk living in this town.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Ordinary folk can't afford cars like that.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Well, folks, what are we going to do today?""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""How are your folks?""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I am going to visit my folks at the weekend.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Garlic is widely used in folk medicine.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """folk""",
                      // alsoEnglishWord: "also: folk",
                      britshText: """IpaUK: /fəʊk/""",
                      americanText: """IpaUS: /fəʊk/""",
...
// With short examples define "folk", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """حەزم بە ئیشێکە کار لەگەڵ خەڵکی پیر یان منداڵان بکەن.""",
                    ...
                    SentencesRow(
                      englishText: """Folks say that he is a hard man.""",
                      kurdishText: """خەڵکی دەڵێن کەسێکی سەختە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """There are a lot of old folk living in this town.""",
                      kurdishText: """خەڵکانێکی پیر هەن لەم شارۆچکەیە دەژین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خەڵکی ئاسایی ناتوانن ئۆتۆمبێلێکی وەها بکڕن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) شێوەیەکی هاوڕێیانە بۆ بانگکردنی زیاتر لە یەک کەس"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Well, folks, what are we going to do today?""",
                      kurdishText: """باشە، خەڵکەکە، ئەمڕۆ چی دەکەین؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کۆتایی هەفتە سەردانی کەسوکارم دەکەم.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (هاوەڵناو) کە پەیوەندیدارە بە خەڵکی ئاساییەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She had an interest in the folk customs of ancient societies.""",
                      kurdishText:
                          """حەزی بۆ نەریتە خۆجێییەکانی کۆمەڵگاکانی کۆن هەبوو.""",
                      onPressedBritish: () => speaksentence8("en-GB"),
                      onPressedAmerican: () => speaksentence8("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٥. (هاوەڵناو) بەپێی باوەڕی خەڵکی ئاسایی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Garlic is widely used in folk medicine.""",
                      kurdishText:
                          """سیر بە بەرفراوانی بەکاردێت لە دەرمانی نەریتی.""",
...
const double _startSecondsend = 000000000000000000000000000626;
const String _videoIdone = 'https://youtu.be/LAOoF2gyQaA?t=';
const double _startSecondsone = 000000000000000000000000000381;
const String _videoIdtwo = 'https://youtu.be/ukD8zj6ngVY?t=';
const double _startSecondstwo = 00000000000000000000000000081;
const String _videoIdthree = 'https://youtu.be/qWAagS_MANg?t=';
const double _startSecondsthree = 000000000000000000000000000903;
const String _videoIdfour = 'https://youtu.be/QiKZYt9070U?t=';
const double _startSecondsfour = 000000000000000000000000000586;
const String _videoIdfive = 'https://youtu.be/c65wnT5hM5w?t=';
const double _startSecondsfive = 000000000000000000000000000430;
