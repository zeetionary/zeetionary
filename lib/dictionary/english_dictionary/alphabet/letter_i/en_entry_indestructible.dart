...
class EnglishEntryindestructible extends StatefulWidget {
  const EnglishEntryindestructible({super.key});

  @override
  State<EnglishEntryindestructible> createState() =>
      _EnglishEntryindestructibleState();
}

class _EnglishEntryindestructibleState
    extends State<EnglishEntryindestructible> {
  @override
  void initState() {
    super.initState();
...
1. Very long lasting (- durable, perdurable, undestroyable)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indestructible""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""These plastic cups are virtually indestructible.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000772;
    const String videoIdone = 'https://youtu.be/0Zph6S5iEdc?t=';
    const double startSecondsone = 0000000000000000000000000006;
    const String videoIdtwo = 'https://youtu.be/bXqZllqGWGQ?t=';
    const double startSecondstwo = 000000000000000000000000000954;
    const String videoIdthree = 'https://youtu.be/KLGSLCaksdY';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/AMN9Ek4qec0?t=';
    const double startSecondsfour = 000000000000000000000000000110;
    const String videoIdfive = 'https://youtu.be/R3FUb7oXk50?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indestructible""",
                      // alsoEnglishWord: "also: indestructible",
                      britshText: """IpaUK: /ˌɪndɪˈstrʌktəbl/""",
                      americanText: """IpaUS: /ˌɪndɪˈstrʌktəbl/""",
...
کوردی: تیانەچوو، نەمر، لەنێونەچوو، تیاناچێ، نافەوتێ، تێک‌نەچوو، خراپ‌نەبوو
"""),
// With short examples define "indestructible", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە هێندە بەهێزە بە ئاسانی ناشکێت"""),
                    SentencesRow(
                      englishText:
                          """These plastic cups are virtually indestructible.""",
                      kurdishText:
                          """ئەم کووپە پلاستیکانە تا ئاستێکی زۆر خراپ‌نەبوون.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Whatever the degradation, the human spirit can be indestructible.""",
                      kurdishText:
                          """هەر تێکشکانێک هەبێت، ڕووحییەتی مرۆڤ تێکنەشکاوە.""",
