...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 00000000000000000000000000099;
    const String videoIdtwo = 'https://youtu.be/9yjZpBq1XBE?t=';
    const double startSecondstwo = 0000000000000000000000000004933;
    const String videoIdthree = 'https://youtu.be/nedusgCUZC4?t=';
    const double startSecondsthree = 00000000000000000000000000045;
    const String videoIdfour = 'https://youtu.be/MqyJZsGFZ3M?t=';
    const double startSecondsfour = 000000000000000000000000000453;
    const String videoIdfive = 'https://youtu.be/Fop2oskTug8?t=';
