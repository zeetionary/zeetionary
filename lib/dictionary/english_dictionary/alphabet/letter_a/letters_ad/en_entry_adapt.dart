...
// replace these: replace EnglishEntryadapt - replace speakAdapt - replace adapt - /əˈdæpt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadapt extends StatelessWidget {
  EnglishEntryadapt({Key? key}) : super(key: key);
