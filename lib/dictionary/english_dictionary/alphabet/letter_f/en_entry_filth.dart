...
class EnglishEntryfilth extends StatefulWidget {
  const EnglishEntryfilth({super.key});

  @override
  State<EnglishEntryfilth> createState() => _EnglishEntryfilthState();
}

class _EnglishEntryfilthState extends State<EnglishEntryfilth> {
  @override
  void initState() {
    super.initState();
...
3. A state characterized by foul or disgusting dirt and refuse (= filthiness, foulness, nastiness)
 
4. An offensive or indecent word or phrase (= obscenity, smut, vulgarism, dirty word)
""",
  );

  final String keyword = "filth";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The floor was covered in filth.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""How can you watch such filth?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """filth""",
                      // alsoEnglishWord: "also: filth",
                      britshText: """IpaUK: /fɪlθ/""",
                      americanText: """IpaUS: /fɪlθ/""",
...
const double _startSecondsend = 00000000000000000000000000030;
const String _videoIdone = 'https://youtu.be/rdt5-S5ZaYo?t=';
const double _startSecondsone = 000000000000000000000000000760;
const String _videoIdtwo = 'https://youtu.be/pSFc9hCNq9E?t=';
const double _startSecondstwo = 000000000000000000000000000342;
const String _videoIdthree = 'https://youtu.be/yHC0mmU-RNI?t=';
const double _startSecondsthree = 0000000000000000000000000001079;
const String _videoIdfour = 'https://youtu.be/Sew4rctKghY?t=';
const double _startSecondsfour = 000000000000000000000000000411;
const String _videoIdfive = 'https://youtu.be/QQyup6ZFsvA?t=';
