...
// replace these: replace EnglishEntryanthology - replace speakAnthology - replace anthology - /ænˈθɒlədʒi/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryanthology extends StatelessWidget {
  // blank divider
  EnglishEntryanthology({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "anthology"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ænˈθɒlədʒi/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ænˈθɑːlədʒi/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'dQssQwPE1vA';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '2BZw_k7K0YE';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'VUKtjst3gsg';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '0acJuZsr_nQ';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'JeUuk-g_Qws';
