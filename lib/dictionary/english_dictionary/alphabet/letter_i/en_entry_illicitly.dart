...
class EnglishEntryillicitly extends StatefulWidget {
  const EnglishEntryillicitly({super.key});

  @override
  State<EnglishEntryillicitly> createState() => _EnglishEntryillicitlyState();
}

class _EnglishEntryillicitlyState extends State<EnglishEntryillicitly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: illicitly
1. In a manner disapproved or not allowed by custom (- illegitimately)
 
2. In an illegal manner (- illegally, lawlessly)
"they dumped the waste illicitly";
""",
  );

  final String keyword = "illicitly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""illicitly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The land was illicitly cleared of forest.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They began to meet illicitly.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/UoSSCUMk-7I?t=';
    const double startSecondsend = 000000000000000000000000000577;
    const String videoIdone = 'https://youtu.be/kRO5jOa06Qw?t=';
    const double startSecondsone = 0000000000000000000000000004255;
    const String videoIdtwo = 'https://youtu.be/H6PcxY_JUTU?t=';
    const double startSecondstwo = 000000000000000000000000000215;
    const String videoIdthree = 'https://youtu.be/hSsKgM8-SfE?t=';
    const double startSecondsthree = 00000000000000000000000000014;
    const String videoIdfour = 'https://youtu.be/KkfZ3WXuQks?t=';
    const double startSecondsfour = 00000000000000000000000000072;
    const String videoIdfive = 'https://youtu.be/oFIWIgzwpx8?t=';
    const double startSecondsfive = 000000000000000000000000000511;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """illicitly""",
                      // alsoEnglishWord: "also: illicitly",
                      britshText: """IpaUK: /ɪˈlɪsɪtli/""",
                      americanText: """IpaUS: /ɪˈlɪsɪtli/""",
...
کوردی: 
"""),
// With short examples define "illicitly", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) بە شێوەیەک کە نایاساییە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: illegally"),
                    SentencesRow(
                      englishText:
                          """The land was illicitly cleared of forest.""",
                      kurdishText:
                          """زەوییەکە نایاساییانە لە دارستان پاککرایەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بە شێوەیەک کە پەسەند نەکراوە بەپێی یاساکانی کۆمەڵگا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They began to meet illicitly.""",
                      kurdishText:
                          """دەستیان کرد بەوەی بە نایاسایی کۆببنەوە.""",
                      englishNote:
                          """This means they started meeting in secret, usually because their meetings were not allowed or were against the rules.""",
