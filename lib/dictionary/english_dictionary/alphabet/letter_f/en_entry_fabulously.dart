...
class EnglishEntryfabulously extends StatefulWidget {
  const EnglishEntryfabulously({super.key});

  @override
  State<EnglishEntryfabulously> createState() => _EnglishEntryfabulouslyState();
}

class _EnglishEntryfabulouslyState extends State<EnglishEntryfabulously> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fabulously""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fabulously""",
                      // alsoEnglishWord: "also: fabulously",
                      britshText: """IpaUK: /ˈfæbjələsli/""",
                      americanText: """IpaUS: /ˈfæbjələsli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "fabulously";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It's all going fabulously.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She dressed him fabulously.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They were fabulously successful.""");
  }
...
// With short examples define "fabulously", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She dressed him fabulously.""",
            kurdishText: """بە ناوازەیی جلی لەبەری کرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: fabulously
1. Exceedingly; extremely (= fantastically, incredibly, breathtakingly)
...
const String _videoIdend = 'https://youtu.be/Ya3YkK0tkUU?t=';
const double _startSecondsend = 0000000000000000000000000001785;
const String _videoIdone = 'https://youtu.be/PlBaIvxsqys?t=';
const double _startSecondsone = 000000000000000000000000000343;
const String _videoIdtwo = 'https://youtu.be/YDvXOHjV4UM?t=';
const double _startSecondstwo = 000000000000000000000000000622;
const String _videoIdthree = 'https://youtu.be/HbGPoCrtcFM?t=';
const double _startSecondsthree = 000000000000000000000000000652;
const String _videoIdfour = 'https://youtu.be/PCMaFUXqU7k?t=';
const double _startSecondsfour = 00000000000000000000000000012;
const String _videoIdfive = 'https://youtu.be/-adHRNYHbm0?t=';
