...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001075;
    const String videoIdone = 'https://youtu.be/XEZfGlyLQnA?t=';
    const double startSecondsone = 000000000000000000000000000281;
    const String videoIdtwo = 'https://youtu.be/3C9wZf88y4Q?t=';
    const double startSecondstwo = 0000000000000000000000000005;
    const String videoIdthree = 'https://youtu.be/L1kYZHnHS0E?t=';
    const double startSecondsthree = 0000000000000000000000000001815;
    const String videoIdfour = 'https://youtu.be/Unzc731iCUY?t=';
    const double startSecondsfour = 0000000000000000000000000001970;
