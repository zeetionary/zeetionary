...
class EnglishEntryhomosexuality extends StatefulWidget {
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: homosexuality (Derived forms: homosexualities)
1. A sexual attraction to (or sexual relations with) persons of the same sex (- homosexualism, homoeroticism, queerness, gayness)
""",
  );

  final String keyword = "homosexuality";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""homosexuality""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I've never been ashamed of my homosexuality.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/9Zja_cIAwY8?t=';
    const double startSecondsone = 000000000000000000000000000119;
    ...
    const double startSecondsthree = 0000000000000000000000000002634;
    const String videoIdfour = 'https://youtu.be/FNuvso78g8I?t=';
    const double startSecondsfour = 000000000000000000000000000426;
    const String videoIdfive = 'https://youtu.be/r7ccg1nIE_c?t=';
    const double startSecondsfive = 000000000000000000000000000323;
