...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'FSHITL5oedk';
    const double startSecondsend = 712;
    const String videoIdone = 'mCtSiImXpRo';
    const double startSecondsone = 19;
    const String videoIdtwo = 'UG61a5vjxuI';
    const double startSecondstwo = 1119;
    const String videoIdthree = 'Wk1oClYJE58';
    const double startSecondsthree = 155;
    const String videoIdfour = 'Qx54quy9tDQ';
    const double startSecondsfour = 231;
    const String videoIdfive = 'QztFpzKsdeA';
    const double startSecondsfive = 360;
...
// With short examples define "informative", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە زانیاریی بەسوود دەدات"""),
                    SentencesRow(
                      englishText:
