...
class EnglishEntryinflationary extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inflationary""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 2870;
    const String videoIdone = 'UKxQTvqcpSg';
    const double startSecondsone = 556;
    const String videoIdtwo = 'HdPzOWlLrbE';
    const double startSecondstwo = 126;
    const String videoIdthree = 'pn3euL8Tbfw';
    const double startSecondsthree = 1459;
    const String videoIdfour = 'PbVSZvC7UxY';
    const double startSecondsfour = 667;
    const String videoIdfive = 'yaX4iGw-b_Y';
    const double startSecondsfive = 1344;
