...
class EnglishEntryeventually extends StatefulWidget {
  const EnglishEntryeventually({super.key});

  @override
  State<EnglishEntryeventually> createState() => _EnglishEntryeventuallyState();
}

class _EnglishEntryeventuallyState extends State<EnglishEntryeventually> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""eventually""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """eventually""",
                      // alsoEnglishWord: "also: eventually",
                      britshText: """IpaUK: /ɪˈventʃuəli/""",
                      americanText: """IpaUS: /ɪˈventʃuəli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "eventually";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Our flight eventually left five hours late.""");
  }
...
کوردی: پاشجار، ئاخر(ی)، ئاقیبەت، سەرەنجام، ئاخرسەر، لە کۆتایی‌دا، ئاخری و ئۆخری
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵکار) لە کۆتایی ماوەیەک یان زنجیرە ڕووداوێک"""),
          SentencesRow(
            englishText: """Our flight eventually left five hours late.""",
            kurdishText:
                """گەشتەکەمان لە کۆتاییدا چوار کاتژمێر درەنگ دەرچوو.""",
          ...
          SentencesRow(
            englishText:
                """She hopes eventually to attend medical school and become a doctor.""",
            kurdishText:
                """هیواخوازە لەکۆتاییدا بچێتە بەشی پزیشکی و ببێت بە پزیشک.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: eventually
1. After an unspecified period of time or an especially long delay (= finally)
"eventually the family left the house";
""",
  );
...
const double _startSecondsend = 000000000000000000000000000000; // 727;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/HDntl7yzzVI?t=';
const double _startSecondsone = 00000000000000000000000000000; // 618;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/-HyHZsa79LU?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 43;
const String _videoIdthree = 'VIDEOhttps://youtu.be/zqllxbPWKNI?t=';
const double _startSecondsthree = 000000000000000000000000000; // 300;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/QEbYo07jLoY?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 427;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/l31zZHfSUjA?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 83;
