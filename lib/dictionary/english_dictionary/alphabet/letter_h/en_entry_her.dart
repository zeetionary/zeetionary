...
class EnglishEntryher extends StatefulWidget {
  const EnglishEntryher({super.key});

  @override
  State<EnglishEntryher> createState() => _EnglishEntryherState();
}

class _EnglishEntryherState extends State<EnglishEntryher> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We're going to call her Sophie.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Please give her my regards.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The manager will be free soon—you can wait for her here.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""That must be her now.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Meg loves her job.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She broke her leg skiing.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """her""",
                      // alsoEnglishWord: "also: her",
                      britshText:
                          """IpaUK: /hə(r)/, /ɜː(r)/, /ə(r)/, strong form  /hɜː(r)/""",
                      americanText:
                          """IpaUS: /hər/, /ɜːr/, /ər/, strong form  /hɜːr/""",
...
کوردی: 
"""),
// With short examples define "her", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (جێناو) وەک بەرکاری کاری be تان لە دوای ئامرازێک بەکاردێت بۆ ناوهێنانی ژن یان کچێک کە پێشووتر باسکراوە یان دەزانرێت کێیە"""),
                    SentencesRow(
                      englishText: """We're going to call her Sophie.""",
                      kurdishText: """بە سۆفی ناوی دەهێنین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بەڕێوبەر زوو دەستبەتاڵ دەبێت > دەتوانیت لێرە چاوەڕێی بکەیت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناسێنەر) سەر بە ژنێک یا کچێک کە پێشووتر باسکراوە یان ناسراوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Meg loves her job.""",
                      kurdishText: """مێگ حەزی بە کارەکەیەتی.""",
...
const String _videoIdthree = 'https://youtu.be/4J0xFUyz1nw?t=';
const double _startSecondsthree = 00000000000000000000000000088;
const String _videoIdfour = 'https://youtu.be/hS2x1zl4rn0?t=';
const double _startSecondsfour = 000000000000000000000000000611;
