...
class EnglishEntryepileptic extends StatefulWidget {
  const EnglishEntryepileptic({super.key});

  @override
  State<EnglishEntryepileptic> createState() => _EnglishEntryepilepticState();
}

class _EnglishEntryepilepticState extends State<EnglishEntryepileptic> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""epileptic""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """epileptic""",
                      // alsoEnglishWord: "also: epileptic",
                      britshText: """IpaUK: /ˌepɪˈleptɪk/""",
                      americanText: """IpaUS: /ˌepɪˈleptɪk/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "epileptic";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her aunt is epileptic.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The doctor specialized in treating epileptics.""");
  }
...
کوردی: فێ‌دار، سەربە فێ
"""),
          // const DefinitionKurdish(text: """١. (ھاوەڵناو) پێنناسە"""),
          CustomRichText(
            textBeforeLink: "١. (ھاوەڵناو) پەیوەندیدار بە ",
            linkText: "پەرکەم",
            textAfterLink: "؛ هەبوونی پەرکەم",
            onTap: () {
              Routemaster.of(context).push("/english-epileptic/epilepsy");
            },
          ),
          SentencesRow(
            englishText: """Her aunt is epileptic.""",
            kurdishText: """پووری تووشبووی پەرکەمە.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """٢. (ناو) کەسێک کە پەرکەمی هەیە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """The doctor specialized in treating epileptics.""",
            kurdishText:
                """پزیشکەکە شارەزایی هەیە لە چارەسەری کەسانی پەرکەمدار.""",
...
- Noun: epileptic (Derived forms: epileptics)
...
const double _startSecondsend = 000000000000000000000000000000; // 189;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/Unzc731iCUY?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1832;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/oOAyQUBithQ?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 370;
const String _videoIdthree = 'VIDEOhttps://youtu.be/BuX6-lvUwd0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 120;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/NS4hohGHZbk?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 904;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/C5pblK3inqY?t=';
