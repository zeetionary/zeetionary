...
class EnglishEntryheadphones extends StatefulWidget {
  const EnglishEntryheadphones({super.key});

  @override
  State<EnglishEntryheadphones> createState() => _EnglishEntryheadphonesState();
}

class _EnglishEntryheadphonesState extends State<EnglishEntryheadphones> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: headphones
1. Electro-acoustic transducer for converting electric signals into sounds; it is held over or inserted into the ear (- earphone, earpiece, phone)
"it was not the typing but the headphones that she disliked";
""",
  );
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""headphones""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She was listening to the radio through headphones.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """headphones""",
                      // alsoEnglishWord: "also: headphones",
                      britshText: """IpaUK: /ˈhedfəʊnz/""",
                      americanText: """IpaUS: /ˈhedfəʊnz/""",
...
// کوردی:
// """),
// With short examples define "headphones", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دەزگایەک کە بەکاردێت بۆ گوێگرتن لە دەنگ بەبێ ئەوەی کەسانی دیکە گوێیان لێی بێت"""),
                    SentencesRow(
                      englishText:
                          """She was listening to the radio through headphones.""",
                      kurdishText: """بە هێدفۆن گوێی لە ڕادیۆ دەگرت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/TXk8CoMdxD8';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/aL4JMl9FuMI';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/KNe35B_ny24?t=';
const double _startSecondstwo = 000000000000000000000000000172;
const String _videoIdthree = 'https://youtu.be/v9fsqqummpk?t=';
const double _startSecondsthree = 00000000000000000000000000057;
const String _videoIdfour = 'https://youtu.be/s4YuXNTCU2Y?t=';
const double _startSecondsfour = 00000000000000000000000000079;
const String _videoIdfive = 'https://youtu.be/SNLo2q3Wjic?t=';
