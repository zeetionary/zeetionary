...
class EnglishEntryinalienable extends StatefulWidget {
  const EnglishEntryinalienable({super.key});

  @override
  State<EnglishEntryinalienable> createState() =>
      _EnglishEntryinalienableState();
}

class _EnglishEntryinalienableState extends State<EnglishEntryinalienable> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inalienable""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We have an inalienable right to freedom of speech.""");
  }
...
// With short examples define "inalienable", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە ناکرێت لێت بسەندرێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا کەمتر: unalienable"),
                    SentencesRow(
                      englishText:
                          """We have an inalienable right to freedom of speech.""",
                      kurdishText:
                          """مافێکی بنچینەییمان بۆ ئازادیی ڕادەربڕین هەیە.""",
