...
class EnglishEntryether extends StatefulWidget {
  const EnglishEntryether({super.key});

  @override
  State<EnglishEntryether> createState() => _EnglishEntryetherState();
}

class _EnglishEntryetherState extends State<EnglishEntryether> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ether""",
                      // alsoEnglishWord: "also: ether",
                      britshText: """IpaUK: /ˈiːθə(r)/""",
                      americanText: """IpaUS: /ˈiːθər/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Ether anaesthesia was introduced in 1846.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) شلەیەکی ڕوون کە لە کحوولەوە بەرهەم دەهات و وەک توێنەر لە پیشەسازی و مادەی بێهۆشکەر لە پزیشکیدا بەکار دەهات"""),
          SentencesRow(
            englishText: """Ether anaesthesia was introduced in 1846.""",
            kurdishText: """بەنجی ئیسەر لە ساڵی ١٨٤٦ ناسێندرا.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          // skipped_meaning
          // const DividerDefinition(),
          // const DefinitionKurdish(text: """٢. (ناو) (لە وێژەدا) بەشی سەرەوەی ئاسمان"""),
          // const DividerSentences(),
          // SentencesRow(
          //   englishText: """Her words disappeared into the ether.""",
          //   kurdishText: """وشەکانی .""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: ether (Derived forms: ethers)
1. Any of a class of organic compounds that have two hydrocarbon groups linked by an oxygen atom
 
2. A colourless volatile highly flammable liquid formerly used as an inhalation anaesthetic (= ethoxyethane, divinyl ether, vinyl ether, diethyl ether, ethyl ether)
 
3. A cryptocurrency generated by the Ethereum protocol (= Ether, ETH)
 
4. A medium that was once supposed to fill all space and to support the propagation of electromagnetic waves (= aether)
 
5. [archaic] The fifth and highest element after air and earth and fire and water; was believed to be the substance composing all heavenly bodies (= quintessence [archaic])
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/02tRxM_1VsE?t=';
const double _startSecondsend = 000000000000000000000000000000; // 137;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/YrMGIqecu0Y?t=';
const double _startSecondsone = 00000000000000000000000000000; // 475;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/lwP9H9qTuUY?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 136;
const String _videoIdthree = 'VIDEOhttps://youtu.be/iiYXSS2x4rQ?t=';
const double _startSecondsthree = 000000000000000000000000000; // 899;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/EB6TmNNqmos?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 398;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/Solb9uA-tgQ?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 4118;
