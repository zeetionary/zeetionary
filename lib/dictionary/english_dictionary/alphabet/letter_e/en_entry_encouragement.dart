...
"""),
          const DefinitionKurdish(
              text: """١. (ناو) ھاندانی کەسێک بۆ کردنی شتێک"""),
          SentencesRow(
            englishText:
                """He needs all the support and encouragement he can get.""",
            kurdishText:
                """پێویستیی بە ھەموو پشتیوانی و ھاندانێکە کە بەدەستی بھێنێت.""",
          ...
          SentencesRow(
            englishText:
                """With a little encouragement from his parents he should do well.""",
            kurdishText: """بە کەمێک ھاندانی دایبابی دەبێت باش بێت.""",
          ...
          SentencesRow(
            ...
            kurdishText: """قسەکانی ھاندانی باش بوون بۆیان.""",
