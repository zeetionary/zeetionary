...
class EnglishEntryindescribably extends StatefulWidget {
  const EnglishEntryindescribably({super.key});

  @override
  State<EnglishEntryindescribably> createState() =>
      _EnglishEntryindescribablyState();
}

class _EnglishEntryindescribablyState extends State<EnglishEntryindescribably> {
  @override
  void initState() {
    super.initState();
...
1. To an inexpressible degree (- ineffably, unutterably, unspeakably, inexpressibly)
...
""",
  ...
  final String keyword = "indescribably";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indescribably""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The mountains are indescribably beautiful on a clear day.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/lAguD4gBmSI?t=';
    const double startSecondsend = 0000000000000000000000000002369;
    const String videoIdone = 'https://youtu.be/TJ2yVoK7Kj8?t=';
    const double startSecondsone = 000000000000000000000000000317;
    const String videoIdtwo = 'https://youtu.be/4sTcB6fvUF4?t=';
    const double startSecondstwo = 0000000000000000000000000001103;
    const String videoIdthree = 'https://youtu.be/XVuIMocTciY?t=';
    const double startSecondsthree = 000000000000000000000000000585;
    const String videoIdfour = 'https://youtu.be/i44KnocYsno?t=';
    const double startSecondsfour = 000000000000000000000000000632;
    const String videoIdfive = 'https://youtu.be/o0A9M5wHBA4?t=';
    const double startSecondsfive = 000000000000000000000000000633;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indescribably""",
                      // alsoEnglishWord: "also: indescribably",
                      britshText: """IpaUK: /ˌɪndɪˈskraɪbəbli/""",
                      americanText: """IpaUS: /ˌɪndɪˈskraɪbəbli/""",
...
کوردی: 
"""),
// With short examples define "indescribably", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە بە ئاستێکی هێندە زۆرە کە ناتوانیت باسی بکەیت"""),
                    SentencesRow(
                      englishText:
                          """The mountains are indescribably beautiful on a clear day.""",
                      kurdishText:
                          """لە ڕۆژێکی ساماڵدا چیاکان لەباس‌نەهاتووانە جوانن.""",
