...
class EnglishEntryinseparable extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inseparable""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'B7gKA1o31rM';
    const double startSecondsone = 398;
    const String videoIdtwo = 'kNovwPIWr3Q';
    const double startSecondstwo = 218;
    const String videoIdthree = 'RWrF88o3MC4';
    const double startSecondsthree = 216;
    const String videoIdfour = 'pSFc9hCNq9E';
    const double startSecondsfour = 478;
    const String videoIdfive = 'KUd7nJJtM6M';
