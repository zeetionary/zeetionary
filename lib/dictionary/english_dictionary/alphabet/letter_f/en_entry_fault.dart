...
class EnglishEntryfault extends StatefulWidget {
  const EnglishEntryfault({super.key});

  @override
  State<EnglishEntryfault> createState() => _EnglishEntryfaultState();
}

class _EnglishEntryfaultState extends State<EnglishEntryfault> {
  @override
  void initState() {
    super.initState();
  }
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Why should I say sorry when it's not my fault?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It's nobody's fault.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was his fault that we were late.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It's your own fault for being careless.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I think the owners are at fault for not warning us.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He's proud of his children and blind to their faults.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I think my worst fault is impatience.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We all have our faults.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""My biggest fault was my laziness.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fire was caused by an electrical fault.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We're trying to correct the faults in the program.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The film is not without fault.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There seemed to be some fault with the cooling system.""");
  }
  ...
  Future<void> speaksentence18(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Her colleagues could not fault her dedication to the job.""");
  }
...
کوردی: عەیب، خەوش، گەرد، گرفت، گیر،	گوناح، سووچ، خەتا، هەڵە، چەوتی، شاشی،	خاڵی لاوازی، شکستی، ئیراد، عەیب، هەڵە، خەتا، قڵیش، قەڵەشت
"""),
          const DefinitionKurdish(
              text: """١. (ناو) بەرپرسیاریەتی بۆ شتێکی هەڵە"""),
          SentencesRow(
            englishText: """Why should I say sorry when it's not my fault?""",
            kurdishText: """بۆچی دەبێت بڵێم ببوورە کە ئەوە هەڵەی من نییە.""",
          ...
          Column(
            children: [
              MyExpansionTile(
                children: [
                  SentencesRow(
                    englishText: """It's nobody's fault.""",
                    kurdishText: """هەڵەی کەس نییە.""",
                  ...
                  SentencesRow(
                    englishText:
                        """He believes that the product’s poor image is partly the fault of the press.""",
                    kurdishText:
                        """باوەڕی وایە کە وێنای خراپی بەرهەمەکە تا ڕادەیەک هەڵەی میدیایە.""",
                  ...
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """It was his fault that we were late.""",
                    kurdishText: """هەڵەی ئەو بوو کە درەنگ کەوتین.""",
                  ...
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """It's your own fault for being careless.""",
                    kurdishText: """هەڵەی خۆتە کە خەمسارد بوویتە.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """پێموایە هەڵەی خاوەنەکانە کە ئاگاداریان نەکردووین.""",
                  ...
                  SentencesRow(
                    englishText:
                        """Many people live in poverty through no fault of their own.""",
                    kurdishText:
                        """زۆر کەس لە هەژاریدا دەژین بەبێ هەڵەی هیچ کەسی دیکە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """شانازی بە منداڵەکانی دەکات و چاوی کوێرە لە ئاستی هەڵەکانیان.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """We all have our faults.""",
            kurdishText: """هەموومان عەیبەی خۆمانمان هەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """My biggest fault was my laziness.""",
            kurdishText: """گەورەترین عەیبم تەمەڵییەکەم بوو.""",
          ...
          const DefinitionKurdish(
              text:
                  """٣. (ناو) شتێک کە هەڵەیە یان تەواو نییە؛ کێشەیەک کە لە ئامێرێکدا هەیە و وادەکات بە باشی کار نەکات"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """The fire was caused by an electrical fault.""",
            kurdishText: """ئاگرەکە بەهۆی هەڵەیەکی کارەبایی کەوتەوە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هەوڵ دەدەین کێشەکانی پڕۆگرامەکە چاک بکەینەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The film is not without fault.""",
            kurdishText: """فیلمەکە بێ هەڵە نییە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """وادیاربوو کێشەیەک لە سیستەمی ساردکەرەوەکە هەبێت.""",
          ...
          SentencesRow(
            englishText:
                """The healthcare system, for all its faults, is far better than ever before.""",
            kurdishText:
                """سیستەمی تەندرووستی، لەگەڵ هەموو هەڵەکانی، هێشتا زۆر باشترە زیاتر لە هەرکاتی دیکە.""",
          ...
          SentencesRow(
            englishText:
                """A major design fault was discovered in the latest model of the car.""",
            kurdishText:
                """هەڵەیەکی گەورەی دیزاین لە تازەترین جۆری ئۆتۆمبێلەکە دۆزرایەوە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٤. (کردار) دۆزینەوەی هەڵەیەک یان لاوازییەک لە کەسێک/شتێک"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Her colleagues could not fault her dedication to the job.""",
            kurdishText:
                """هاوکارەکانی نەیاندەتوانی ڕەخنە لە خۆتەرخانکردنی بۆ کارەکە بگرن.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """هەمیشە بەڕێز بووە ـ نەیدەتوانی بۆ ئەوە ڕەخنەی لێ بگرێت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fault (Derived forms: faults)
1. A wrong action attributable to bad judgment, ignorance or inattention (= mistake, error)
"I could understand his English in spite of his grammatical faults";
 
2. An imperfection in an object or machine (= defect, flaw)
"if there are any faults you should send it back to the manufacturer";
 
3. The quality of being inadequate or falling short of perfection (= demerit)
"he knew his own faults much better than she did";
 
4. (geology) a crack in the earth's crust resulting from the displacement of one side with respect to the other (= faulting, geological fault, shift, fracture, break)
...
- Verb: fault (Derived forms: faulting, faulted, faults)
1. Put or pin the blame on (= blame)
...
const double _startSecondsone = 0000000000000000000000000001118;
...
const double _startSecondsthree = 000000000000000000000000000677;
const String _videoIdfour = 'https://youtu.be/NCLZi2Rn_ug?t=';
const double _startSecondsfour = 00000000000000000000000000089;
const String _videoIdfive = 'https://youtu.be/bq4UUfi35qI?t=';
