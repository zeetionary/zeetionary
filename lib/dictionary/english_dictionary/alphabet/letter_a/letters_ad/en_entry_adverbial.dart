...
// replace these: replace EnglishEntryadverbial - replace speakAdverbial - replace adverbial - /ædˈvɜːrbiəl/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadverbial extends StatelessWidget {
  EnglishEntryadverbial({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdverbial(String languageCode) async {
    // DOPSUM: CHANGE speakAdverbial
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("adverbial"); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ædˈvɜːbiəl/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'PYxNxegyNrw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '_OqvF3SOMVY';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'zmxCmcCxCUY';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '4zAkoXyhrdI';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'rN0hR0BdibA';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'u3CJs0etXkw';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'udpnAtyYboU';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = '7XBYuCz52Sc';
