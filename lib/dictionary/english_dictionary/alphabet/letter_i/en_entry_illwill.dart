...
class EnglishEntryillwill extends StatefulWidget {
  const EnglishEntryillwill({super.key});

  @override
  State<EnglishEntryillwill> createState() => _EnglishEntryillwillState();
}

class _EnglishEntryillwillState extends State<EnglishEntryillwill> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: ill will (Derived forms: ill wills)
1. The feeling of a hostile person (- hostility, enmity)
 
2. A hostile (very unfriendly) disposition (- hostility)
"he could not conceal his ill will";
""",
  );

  final String keyword = "ill will";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ill will""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I bear Sue no ill will.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She bears them no ill will.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Q2hxlxWYTN0?t=';
    const double startSecondsend = 00000000000000000000000000075;
    const String videoIdone = 'https://youtu.be/cb0pb-OHaM4?t=';
    const double startSecondsone = 000000000000000000000000000200;
    const String videoIdtwo = 'https://youtu.be/Udk8YHOy0EU?t=';
    const double startSecondstwo = 000000000000000000000000000300;
    const String videoIdthree = 'https://youtu.be/TsNvYjJ_JcE?t=';
    const double startSecondsthree = 000000000000000000000000000371;
    const String videoIdfour = 'https://youtu.be/Solb9uA-tgQ?t=';
    const double startSecondsfour = 00000000000000000000000000010253;
    const String videoIdfive = 'https://youtu.be/iZx04fmxdfA?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ill will""",
                      // alsoEnglishWord: "also: ill will",
                      britshText: """IpaUK: /ˌɪl ˈwɪl/""",
                      americanText: """IpaUS: /ˌɪl ˈwɪl/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText: """I bear Sue no ill will.""",
                      kurdishText: """هیچ نیاز خراپیم بۆ سوو نییە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She bears them no ill will.""",
                      kurdishText: """هیچ دوژمنایەتی نییە بۆیان.""",
