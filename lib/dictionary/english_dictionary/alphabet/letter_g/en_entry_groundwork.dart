...
class EnglishEntrygroundwork extends StatefulWidget {
  const EnglishEntrygroundwork({super.key});

  @override
  State<EnglishEntrygroundwork> createState() => _EnglishEntrygroundworkState();
}

class _EnglishEntrygroundworkState extends State<EnglishEntrygroundwork> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: groundwork (Derived forms: groundworks)
1. The fundamental assumptions from which something is begun, developed, calculated or explained (- basis, base, foundation, fundament, cornerstone)
"the whole argument rested on a groundwork of conjecture";
 
2. Lowest support of a structure (- foundation, base, fundament, foot, substructure, understructure)
"it was built on a groundwork of solid rock";
...
""",
  ...
  final String keyword = "groundwork";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""groundwork""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """groundwork""",
                      // alsoEnglishWord: "also: groundwork",
                      britshText: """IpaUK: /ˈɡraʊndwɜːk/""",
                      americanText: """IpaUS: /ˈɡraʊndwɜːrk/""",
...
کوردی: ئامادەکاری، کارە سەرەتایی‌یەکان، بنەڕەت، بنگەهـ
"""),
// With short examples define "groundwork", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) پننسە"""),
                    SentencesRow(
                      englishText:
                          """Officials are laying the groundwork for a summit conference of world leaders.""",
                      kurdishText:
                          """بەرپرسان ئامادەکاری دەکەن بۆ کۆنفرانسی لوتکەی بەرپرسانی جیهان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """We are already doing the groundwork for the introduction of the plan next year.""",
                      kurdishText:
                          """پێشوەختە دەستمان بە ئامادەکاری بۆ ناساندنی پلانەکە لە ساڵی داهاتوودا کردووە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/3PX2d3Zwutg?t=';
const double _startSecondsend = 000000000000000000000000000953;
const String _videoIdone = 'https://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondsone = 0000000000000000000000000003159;
const String _videoIdtwo = 'https://youtu.be/ZU_MF0NMKhU?t=';
const double _startSecondstwo = 000000000000000000000000000228;
const String _videoIdthree = 'https://youtu.be/zlm1aajH6gY?t=';
const double _startSecondsthree = 00000000000000000000000000089;
const String _videoIdfour = 'https://youtu.be/fBTjbGfHx0s?t=';
const double _startSecondsfour = 00000000000000000000000000067;
const String _videoIdfive = 'https://youtu.be/zXgD-KSb5ZM?t=';
