...
class EnglishEntrygetupandgo extends StatefulWidget {
  const EnglishEntrygetupandgo({super.key});

  @override
  State<EnglishEntrygetupandgo> createState() => _EnglishEntrygetupandgoState();
}

class _EnglishEntrygetupandgoState extends State<EnglishEntrygetupandgo> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "get-up-and-go";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""get-up-and-go""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""This job needs someone with a lot of get-up-and-go.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """get-up-and-go""",
                      // alsoEnglishWord: "also: get-up-and-go",
                      britshText: """IpaUK: /ˌɡet ʌp ən ˈɡəʊ/""",
                      americanText: """IpaUS: /ˌɡet ʌp ən ˈɡəʊ/""",
...
کوردی: 
"""),
// With short examples define "get-up-and-go", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) وزە و حەزێکی زۆر بۆ کردنی شت"""),
                    SentencesRow(
                      englishText:
                          """This job needs someone with a lot of get-up-and-go.""",
                      kurdishText:
                          """ئەم کارە پێویستی بە کەسێکە کە خاوەن وزە و چالاکییەکی زۆر بێت..""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/QRpDIdPFUXg?t=';
const double _startSecondsend = 000000000000000000000000000918;
const String _videoIdone = 'https://youtu.be/FCZ06Sfr9Cg?t=';
const double _startSecondsone = 000000000000000000000000000498;
const String _videoIdtwo = 'https://youtu.be/bAlGzsVsbLE?t=';
const double _startSecondstwo = 00000000000000000000000000094;
const String _videoIdthree = 'https://youtu.be/m7wIAdsG-gQ?t=';
const double _startSecondsthree = 000000000000000000000000000120;
const String _videoIdfour = 'https://youtu.be/BoDS-aZ4JN4?t=';
const double _startSecondsfour = 000000000000000000000000000155;
const String _videoIdfive = 'https://youtu.be/rUQlHbco0Z4?t=';
