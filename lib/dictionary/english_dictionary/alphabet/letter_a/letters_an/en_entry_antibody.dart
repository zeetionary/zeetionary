                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "antibody"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæntibɒdi/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæntibɑːdi/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'zZl0gcHHnhM';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'nKyjSUhhHRs';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'cA_FGtGwiig';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'NOK6drNPNck';
