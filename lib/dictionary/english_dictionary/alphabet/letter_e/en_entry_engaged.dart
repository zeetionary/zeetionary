...
class EnglishEntryengaged extends StatefulWidget {
  const EnglishEntryengaged({super.key});

  @override
  State<EnglishEntryengaged> createState() => _EnglishEntryengagedState();
}

class _EnglishEntryengagedState extends State<EnglishEntryengaged> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""engaged""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """engaged""",
                      // alsoEnglishWord: "also: engaged",
                      britshText: """IpaUK: /ɪnˈɡeɪdʒd/""",
                      americanText: """IpaUS: /ɪnˈɡeɪdʒd/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""When did you get engaged?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's engaged to Peter.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She was engaged to marry the heir to the Spanish throne.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They were engaged in conversation.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They are engaged in talks with the Irish government.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She is actively engaged on several projects.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I couldn't get through—the line's engaged.""");
  }
...
کوردی: سەرقاڵ، پڕکار، خەریک، پێوەبوو، گیرکردوو،	گیراو (تەلەفون)،	دەزگیران
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە ڕازی بوویت بە هاوسەرگیری لەگەڵ کەسێک"""),
          SentencesRow(
            englishText: """When did you get engaged?""",
            kurdishText: """کەی مارە بڕدرایت؟""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She's engaged to Peter.""",
            kurdishText: """لە پیتەر مارە بڕدراوە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """مارەبڕدرابوو لە جێنشینی تەختی شاهانەی ئیسپانیا.""",
          ...
          SentencesRow(
            ...
            kurdishText: """سەرقاڵ بوون بە گفتوگۆ لەگەڵ حکومەتی ئێرلەندا.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She is actively engaged on several projects.""",
            kurdishText: """چالاکانە سەرقاڵی ژمارەیەک پڕۆژەیە.""",
            onPressedBritish: () => speaksentence6("en-GB"),
            onPressedAmerican: () => speaksentence6("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٣. (ھاوەڵناو) هێڵێکی پەیوەندی کە لە کارکردندایە"""),
          const DividerSentences(),
          SentencesRow(
          ...
          SentencesRow(
            ...
            kurdishText: """پێشووتر پەیوەندیم کرد بەڵام پەیوەندیی ترت هەبوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: engaged
1. Having one's attention, mind or energy occupied (= occupied)
"deeply engaged in conversation";
 
2. Pledged to be married (= bespoken, betrothed)
"the engaged couple";
 
3. Involved in military hostilities
"the desperately engaged ships continued the fight"
 
4. Reserved in advance (= booked, set-aside)
"All highways must be five lanes wide and either three or four of these lanes must be engaged for passenger cars only";
 
5. (of facilities such as telephones or lavatories) unavailable for use by anyone else or indicating unavailability (= busy, in use)
"receptionists' telephones are always engaged";
 
6. (used of toothed parts or gears) interlocked and interacting (= meshed, intermeshed)
...
const double _startSecondsthree = 574;
const String _videoIdfour = 'https://youtu.be/a9m3GD0DbPY?t=';
const double _startSecondsfour = 14;
const String _videoIdfive = 'https://youtu.be/8LPVjHxXvJM?t=';
const double _startSecondsfive = 98;
const String _videoIdsix = 'https://youtu.be/jfhEbHJoZZ8?t=';
const double _startSecondssix = 105;
