...
class EnglishEntryhandsome extends StatefulWidget {
  const EnglishEntryhandsome({super.key});

  @override
  State<EnglishEntryhandsome> createState() => _EnglishEntryhandsomeState();
}

class _EnglishEntryhandsomeState extends State<EnglishEntryhandsome> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: handsome (Derived forms: handsomest, handsomer)
1. Pleasing in appearance especially by reason of conformity to ideals of form and proportion (- fine-looking, good-looking, better-looking, well-favored [US], well-favoured [Brit, Cdn], on fleek [N. Amer, informal])
"very pretty but not so extraordinarily handsome";
 
2. Given or giving freely (- big, bighearted, bounteous, bountiful, freehanded, giving, liberal, openhanded
"a handsome allowance";
""",
  );

  final String keyword = "handsome";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""handsome""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He had an interesting and rather handsome face.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He's the most handsome man I've ever met.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He'd be handsome if it wasn't for that huge beak of his.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The tall, handsome woman caught everyone's attention.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The bride and groom made a handsome couple.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They sold the house two years later at a handsome profit.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She paid him a handsome compliment.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It was very handsome of him to pay for the meal.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """handsome""",
                      // alsoEnglishWord: "also: handsome",
                      britshText: """IpaUK: /ˈhænsəm/""",
                      americanText: """IpaUS: /ˈhænsəm/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """قۆزترین پیاوە تا ئێستا بینیبێتم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بووک و زاواکە دوو دڵداری ڕازاوە بوون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دوو ساڵ دواتر خانووەکەیان فرۆشت بە قازانجێکی زۆر.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆر لە دەستکراوەیی خۆی بوو پارەی خواردنەکە بدات.""",
