...
class EnglishEntryhousewife extends StatefulWidget {
  const EnglishEntryhousewife({super.key});

  @override
  State<EnglishEntryhousewife> createState() => _EnglishEntryhousewifeState();
}

class _EnglishEntryhousewifeState extends State<EnglishEntryhousewife> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: housewife (Derived forms: housewives)
1. A wife who manages a household while her husband earns the family income (- homemaker, lady of the house, woman of the house)
""",
  );

  final String keyword = "housewife";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""housewife""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/9hdT8PgT19w?t=';
    const double startSecondsend = 000000000000000000000000000264;
    const String videoIdone = 'https://youtu.be/ToBdcRGsqr8?t=';
    const double startSecondsone = 000000000000000000000000000194;
    const String videoIdtwo = 'https://youtu.be/BPGgyputhpA?t=';
    const double startSecondstwo = 0000000000000000000000000002042;
    const String videoIdthree = 'https://youtu.be/hz5HHB1N4jQ?t=';
    ...
    const String videoIdfive = 'https://youtu.be/wY5-8kvMEh0?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """housewife""",
                      // alsoEnglishWord: "also: housewife",
                      britshText: """IpaUK: /ˈhaʊswaɪf/""",
                      americanText: """IpaUS: /ˈhaʊswaɪf/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """She's not the type of person to stay at home and be a housewife.""",
                      kurdishText:
                          """ئەو جۆرە کەسە نییە لە ماڵەوە بمێنێتەوە و ببێت بە ژنی ماڵەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """A group of housewives stood chatting outside the butcher's shop.""",
                      kurdishText:
                          """ژمارەیەک کەیبانوو وەستابوون دەمەتەقێیان دەکرد لە دەرەوەی قەسابخانەکە.""",
