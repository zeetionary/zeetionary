...
class EnglishEntryintern extends StatefulWidget {
  const EnglishEntryintern({super.key});

  @override
  State<EnglishEntryintern> createState() => _EnglishEntryinternState();
}

class _EnglishEntryinternState extends State<EnglishEntryintern> {
  @override
  void initState() {
    super.initState();
