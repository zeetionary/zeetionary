...
// replace these: replace EnglishEntryaesthetically - replace speakAesthetically - replace aesthetically - /esˈθetɪkli/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaesthetically extends StatelessWidget {
  EnglishEntryaesthetically({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "aesthetically", // DOPSUM: CHANGE WORD ENTRY - Find /iːsˈθetɪkli/,  /esˈθetɪkli/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /iːsˈθetɪkli/,  /esˈθetɪkli/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'OtkGciKsO4c';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'MF8kz-mTIp4';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'OMnfI8xkJ1s';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'eMTbI-OGHUY';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '2q_zrCF5i14';
