...
class EnglishEntryenrolment extends StatefulWidget {
  const EnglishEntryenrolment({super.key});

  @override
  State<EnglishEntryenrolment> createState() => _EnglishEntryenrolmentState();
}

class _EnglishEntryenrolmentState extends State<EnglishEntryenrolment> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enrolment""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enrolment""",
                      // alsoEnglishWord: "also: enrolment",
                      britshText: """IpaUK: /ɪnˈrəʊlmənt/""",
                      americanText: """IpaUS: /ɪnˈrəʊlmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enrolment";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Enrolment is the first week of September.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Fees must be paid in full at the time of enrolment.""");
  }
...
// With short examples define "enrolment", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: ناونووسی، کردنەئەندام، ئەنداماندن، نێونووس‌کراوان
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) پەیوەندی کردن لە کۆرسێک، قوتابخانەیەک، هتد؛ ژمارەی ئەو کەسانەی کە پەیوەندییان کردووە"""),
          SentencesRow(
            englishText: """Enrolment is the first week of September.""",
            kurdishText: """ناونووسین لە یەکەم هەفتەی ئەیلوولە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """نرخەکان دەبێت بە تەواوی بدرێن لە کاتی ناونووسین.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: enrolment (Derived forms: enrolments)
Usage: Brit, Cdn (US: enrollment) 
1. The act of enrolling (= registration, enrollment [N. Amer])
 
2. The body of people (such as students) who register or enrol at the same time (= registration, enrollment [N. Amer])
""",
  );
...
const String _videoIdend = 'https://youtu.be/yObXukkULCY?t=';
const double _startSecondsend = 461;
const String _videoIdone = 'https://youtu.be/U4DKMOhIwio?t=';
const double _startSecondsone = 658;
const String _videoIdtwo = 'https://youtu.be/gJgQR6xiZGs?t=';
const double _startSecondstwo = 328;
const String _videoIdthree = 'https://youtu.be/5E-A28V4F80?t=';
const double _startSecondsthree = 238;
const String _videoIdfour = 'https://youtu.be/1A3cDXo4MkI?t=';
const double _startSecondsfour = 360;
const String _videoIdfive = 'https://youtu.be/jIIazUBydsY?t=';
const double _startSecondsfive = 152;
const String _videoIdsix = 'https://youtu.be/lOjn-jvukb4?t=';
const double _startSecondssix = 213;
