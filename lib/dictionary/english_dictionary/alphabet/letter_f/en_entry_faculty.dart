...
class EnglishEntryfaculty extends StatefulWidget {
  const EnglishEntryfaculty({super.key});

  @override
  State<EnglishEntryfaculty> createState() => _EnglishEntryfacultyState();
}

class _EnglishEntryfacultyState extends State<EnglishEntryfaculty> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""faculty""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """faculty""",
                      // alsoEnglishWord: "also: faculty",
                      britshText: """IpaUK: /ˈfæklti/""",
                      americanText: """IpaUS: /ˈfæklti/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""See the faculty website for more details.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He has been a faculty member for 20 years.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She retained her mental faculties until the day she died.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He is not in full possession of all his mental faculties.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) بەشێک یان ژمارەیەک بەشی پەیوەندیداری کۆلێژێک یان زانکۆیەک"""),
          SentencesRow(
            englishText: """He's applied for a job in the history faculty.""",
            kurdishText: """داخوازی ناردووە بۆ کارێک لە فاکەڵتیی مێژوو.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """See the faculty website for more details.""",
            kurdishText:
                """لە وێبسایتی فاکەڵتییەکە بڕاونە بۆ زانیاریی زیاتر.""",
          ...
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٣. (ناو) تەواوی مامۆستاکانی کۆلێژێک یان زانکۆیەک"""),
          const AlsoEnglishckb(word: "زۆرجار دەگوترێت the faculty"),
          SentencesRow(
            englishText:
                """She is joining the faculty of the University of Washington.""",
            kurdishText: """پەیوەندی بە فاکەڵتی زانکۆی واشنتۆن دەکات.""",
...
const String _videoIdend = 'https://youtu.be/Unzc731iCUY?t=';
const double _startSecondsend = 0000000000000000000000000002215;
const String _videoIdone = 'https://youtu.be/OP7l1n_8Lh4?t=';
const double _startSecondsone = 0000000000000000000000000008;
const String _videoIdtwo = 'https://youtu.be/sY8aFSY2zv4?t=';
const double _startSecondstwo = 0000000000000000000000000004361;
const String _videoIdthree = 'https://youtu.be/LaERkte8ylA?t=';
const double _startSecondsthree = 000000000000000000000000000138;
const String _videoIdfour = 'https://youtu.be/Xj28qAS8MWU?t=';
const double _startSecondsfour = 00000000000000000000000000038;
const String _videoIdfive = 'https://youtu.be/BmYv8XGl-YU?t=';
