...
کوردی: هاندان، دڵگەرم کردن، پاڵپشتیکردن
"""),
          const DefinitionKurdish(
              text: """١. (کردار) پێدانی ورە، بوێری، یان هیوا بە کەسێک"""),
          SentencesRow(
            englishText:
                """We were greatly encouraged by the positive response of the public.""",
...
const String _videoIdfive = 'https://youtu.be/VrKW58MS12g?t=';
const double _startSecondsfive = 1297;
const String _videoIdsix = 'https://youtu.be/3C0BdIn6Hdo?t=';
