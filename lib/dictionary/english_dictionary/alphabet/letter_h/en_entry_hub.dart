...
class EnglishEntryhub extends StatefulWidget {
  const EnglishEntryhub({super.key});

  @override
  State<EnglishEntryhub> createState() => _EnglishEntryhubState();
}

class _EnglishEntryhubState extends State<EnglishEntryhub> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The airport has become an international hub.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The kitchen was the hub of family life.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/jBn-Qd0cgHo?t=';
    const double startSecondsend = 000000000000000000000000000105;
    const String videoIdone = 'https://youtu.be/Riv_68n9F_s?t=';
    const double startSecondsone = 0000000000000000000000000009;
    const String videoIdtwo = 'https://youtu.be/Wpo-WRcQ07o';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/B5PqLSZPIOM?t=';
    const double startSecondsthree = 00000000000000000000000000019;
    const String videoIdfour = 'https://youtu.be/-2H0Ysf8mO8?t=';
    const double startSecondsfour = 000000000000000000000000000168;
    const String videoIdfive = 'https://youtu.be/75lF8JQP92s?t=';
    const double startSecondsfive = 0000000000000000000000000001106;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hub""",
                      // alsoEnglishWord: "also: hub",
                      britshText: """IpaUK: /hʌb/""",
                      americanText: """IpaUS: /hʌb/""",
...
// With short examples define "hub", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """فڕۆکەخانە بووە بە ناوەندێکی جیهانی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It's the city's major transportation hub for bus and rail.""",
                      kurdishText:
                          """ناوەندی گرنگی گواستنەوەی شارەکەیە بۆ پاس و شەمەندەفەر.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """چێشتخانەکە چەقی ژیانی خێزانی بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The City of London is the hub of the UK's financial world.""",
                      kurdishText:
                          """شاری لەندەن چەقی جیهانی دارایی بەریتانیایە.""",
