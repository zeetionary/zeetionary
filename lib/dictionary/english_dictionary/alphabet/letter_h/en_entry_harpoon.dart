...
class EnglishEntryharpoon extends StatefulWidget {
  const EnglishEntryharpoon({super.key});

  @override
  State<EnglishEntryharpoon> createState() => _EnglishEntryharpoonState();
}

class _EnglishEntryharpoonState extends State<EnglishEntryharpoon> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: harpoon (Derived forms: harpoons)
...
- Verb: harpoon (Derived forms: harpoons, harpooning, harpooned)
1. Spear with a harpoon
"harpoon whales"
""",
  );

  final String keyword = "harpoon";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""harpoon""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They hunt whales with harpoons.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Thousands of whales have been harpooned in these waters.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harpoon""",
                      // alsoEnglishWord: "also: harpoon",
                      britshText: """IpaUK: /hɑːˈpuːn/""",
                      americanText: """IpaUS: /hɑːrˈpuːn/""",
...
کوردی: 
"""),
// With short examples define "harpoon", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕمێک کە دەبەسترێت بە حەبلێکی درێژەوە بەکاردێت بۆ گرتنی ماسی گەورە، نەهەنگ، هتد"""),
                    SentencesRow(
                      englishText: """They hunt whales with harpoons.""",
                      kurdishText: """بە ڕم نەهەنگ ڕاو دەکەن.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (کردار) کوشتن یان ڕاوکردن بە ڕم"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Thousands of whales have been harpooned in these waters.""",
                      kurdishText:
                          """سەدان نەهەنگ لەم ئاوانە ڕاوکراون بە ڕم.""",
...
const double _startSecondsend = 000000000000000000000000000371;
const String _videoIdone = 'https://youtu.be/o_CRqBIHkdA?t=';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/O6Duf496Ips?t=';
const double _startSecondstwo = 000000000000000000000000000361;
const String _videoIdthree = 'https://youtu.be/Gs26bZTRkdU?t=';
const double _startSecondsthree = 000000000000000000000000000551;
const String _videoIdfour = 'https://youtu.be/d0rZDL4lL-4?t=';
const double _startSecondsfour = 0000000000000000000000000001075;
const String _videoIdfive = 'https://youtu.be/v-KggdhnyLI?t=';
const double _startSecondsfive = 000000000000000000000000000838;
