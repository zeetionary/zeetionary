...
class EnglishEntryjauntily extends StatefulWidget {
  const EnglishEntryjauntily({super.key});

  @override
  State<EnglishEntryjauntily> createState() => _EnglishEntryjauntilyState();
}

class _EnglishEntryjauntilyState extends State<EnglishEntryjauntily> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""jauntily""");
  }
