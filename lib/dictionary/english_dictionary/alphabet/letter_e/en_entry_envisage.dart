...
class EnglishEntryenvisage extends StatefulWidget {
  const EnglishEntryenvisage({super.key});

  @override
  State<EnglishEntryenvisage> createState() => _EnglishEntryenvisageState();
}

class _EnglishEntryenvisageState extends State<EnglishEntryenvisage> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""envisage""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """envisage""",
                      // alsoEnglishWord: "also: envisage",
                      britshText: """IpaUK: /ɪnˈvɪzɪdʒ/""",
                      americanText: """IpaUS: /ɪnˈvɪzɪdʒ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""What level of profit do you envisage?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I can't envisage her coping with this job.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I don’t envisage working with him again.""");
  }
...
"""),
          const DefinitionKurdish(
              text: """١. (کردار) خەیاڵکردنی ئەوەی لە داهاتوودا چی ڕوودەدات"""),
          SentencesRow(
            englishText: """What level of profit do you envisage?""",
            kurdishText: """پێشبینی چی ئاستێکی قازانج دەکەیت؟""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I can't envisage her coping with this job.""",
            kurdishText:
                """ناتوانم خەیاڵی ئەوە بکەم کە بەرگەی ئەم کارە بگرێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I don’t envisage working with him again.""",
            kurdishText: """خەیاڵی ئەوە ناکەم دووبارە کاری لەگەڵ بکەم.""",
          ...
          SentencesRow(
            englishText:
                """It is envisaged that the talks will take place in the spring.""",
            kurdishText:
                """پێشبینی ئەوە دەکرێت کە گفتوگۆکان لە بەهاردا ڕووبدەن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: envisage (Derived forms: envisaging, envisaged, envisages)
1. Form a mental image of something that is not present or that is not the case (= imagine, conceive of, ideate)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/LFtz5ZTJxxw?t=';
const double _startSecondsend = 000000000000000000000000000000; // 883;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/0dy5uhZSG18?t=';
const double _startSecondsone = 00000000000000000000000000000; // 632;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/n7wLJ7YiR7s?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1577;
const String _videoIdthree = 'VIDEOhttps://youtu.be/NhM-2P93hoI?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1022;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/_q0WuSdVknE?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1153;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/7XhGnwg-fZw?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 39;
