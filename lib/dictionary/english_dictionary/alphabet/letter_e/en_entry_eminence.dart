...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/gbe2Men71fA?t=',
    startSeconds: 99,
    autoPlay: true,
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/Akv0TZI985U?t=',
    startSeconds: 1209,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/hNs8_hNq2UA?t=',
    startSeconds: 468,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/G08hY8dSrUY?t=',
    startSeconds: 934,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/gDckM6ks_z4?t=',
    startSeconds: 286,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
