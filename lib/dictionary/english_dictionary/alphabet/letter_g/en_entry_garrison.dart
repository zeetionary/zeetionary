...
class EnglishEntrygarrison extends StatefulWidget {
  const EnglishEntrygarrison({super.key});

  @override
  State<EnglishEntrygarrison> createState() => _EnglishEntrygarrisonState();
}

class _EnglishEntrygarrisonState extends State<EnglishEntrygarrison> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""garrison""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Two regiments were sent to garrison the town.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""100 soldiers were garrisoned in the town.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """garrison""",
                      // alsoEnglishWord: "also: garrison",
                      britshText: """IpaUK: /ˈɡærɪsn/""",
                      americanText: """IpaUS: /ˈɡærɪsn/""",
...
// With short examples define "garrison", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دوو تیپ نێردران بۆ پارێزگاری لە شارۆچکەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """١٠٠ سەرباز لە شارۆچکەکە دانران.""",
...
const double _startSecondsone = 0000000000000000000000000001577;
const String _videoIdtwo = 'https://youtu.be/ElQdUHSXkME?t=';
const double _startSecondstwo = 000000000000000000000000000429;
const String _videoIdthree = 'https://youtu.be/ojJupoAyT58?t=';
const double _startSecondsthree = 000000000000000000000000000102;
const String _videoIdfour = 'https://youtu.be/lFlu60qs7_4?t=';
const double _startSecondsfour = 000000000000000000000000000648;
const String _videoIdfive = 'https://youtu.be/a2a4oR0ZUYE?t=';
