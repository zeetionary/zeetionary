...
class EnglishEntrylogo extends StatefulWidget {
  const EnglishEntrylogo({super.key});

  @override
  State<EnglishEntrylogo> createState() => _EnglishEntrylogoState();
}

class _EnglishEntrylogoState extends State<EnglishEntrylogo> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: logo (Derived forms: logos)
1. A company emblem or device (- logotype)
""",
  );

  final String keyword = "logo";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The company has a distinctive logo that makes it well known.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Athletes are all wearing the sneaker company’s logo.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/dtp6b76pMak?t=295';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/SEZu7K5tGxw?t=384';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/BYunaBkn9Ng?t=112';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/NUzDLpSkQTg?t=212';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/L1kYZHnHS0E?t=79';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/Unzc731iCUY?t=1618';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """logo""",
                      // alsoEnglishWord: "also: logo",
                      britshText: """IpaUK: /ˈləʊɡəʊ/""",
                      americanText: """IpaUS: /ˈləʊɡəʊ/""",
...
کوردی: 
"""),
// With short examples define "logo", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) دیزاینێک یان سمبولێک کە کۆمپانیا یان دامەزراوەیەک بەکاریدێنێت وەک ئاماژەیەکی تایبەت"""),
                    SentencesRow(
                      englishText: """The company has a distinctive logo that makes it well known.""",
                      kurdishText: """کۆمپانیاکە لۆگۆیەکی جیاکەرەوەی هەیە کە بەناوبانگی کردووە.""",
                    ...
                    SentencesRow(
                      englishText: """Athletes are all wearing the sneaker company’s logo.""",
                      kurdishText: """وەرزشوانەکان لۆگۆی کۆمپانیای پێڵاوەکە لەپێ دەکەن.""",
