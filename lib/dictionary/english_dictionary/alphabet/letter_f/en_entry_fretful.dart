...
class EnglishEntryfretful extends StatefulWidget {
  const EnglishEntryfretful({super.key});

  @override
  State<EnglishEntryfretful> createState() => _EnglishEntryfretfulState();
}

class _EnglishEntryfretfulState extends State<EnglishEntryfretful> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fretful
1. Nervous and unable to relax (= antsy [N. Amer, informal], fidgety, itchy, restless, on edge, keyed-up, twitchy [informal])
"a constant fretful stamping of hooves";
 
2. Habitually complaining (= querulous, whiney, whiny)
"a fretful child";
""",
  );

  final String keyword = "fretful";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fretful""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fretful""",
                      // alsoEnglishWord: "also: fretful",
                      britshText: """IpaUK: /ˈfretfl/""",
                      americanText: """IpaUS: /ˈfretfl/""",
...
کوردی: ناڕەحەت، بەدخوو، ناجسن، کەساس، بێ‌ئارام، ئارام‌لێ‌هەڵگیراو،	دەم‌بەگلەیی، بەگلەیی‌وگناشت
"""),
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/0ens0WjAyOc?t=';
const double _startSecondsend = 0000000000000000000000000002265;
const String _videoIdone = 'https://youtu.be/pkTGNsX1wWE?t=';
const double _startSecondsone = 00000000000000000000000000018;
const String _videoIdtwo = 'https://youtu.be/Ytu5xu2axtE?t=';
const double _startSecondstwo = 0000000000000000000000000001095;
const String _videoIdthree = 'https://youtu.be/RltufVomqFY?t=';
const double _startSecondsthree = 00000000000000000000000000032;
const String _videoIdfour = 'https://youtu.be/Y9rrvZ6o4sg?t=';
const double _startSecondsfour = 00000000000000000000000000013;
const String _videoIdfive = 'https://youtu.be/2B8RfixmLzQ?t=';
const double _startSecondsfive = 000000000000000000000000000802;
