...
class EnglishEntryastound extends StatelessWidget {
  ...
  Future<void> speakastound(String languageCode) async {
    ...
    await flutterTts.speak("astound");
  }
  ...
  Future<void> speakastound1101(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("His arrogance astounded her.");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "astound"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'rFYNhX-dSwE';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'Dq7gM1leBho';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '54heYhzfv-Y';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '5f2xOxRGKqk';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'TKiQB_CfMR4';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'a-8f0sRJ7Bc';
  final double _startSeconds = 2754;
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'B2ph_FeB7d8';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'LvS0gUlzS-4';
