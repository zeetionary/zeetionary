...
class EnglishEntryamendment extends StatelessWidget {
  ...
  Future<void> speakAmendment1244(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Parliament passed the bill without further amendment."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAmendment4557(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The Senate added numerous amendments to the bill."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAmendment74111(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The 19th Amendment gave women the right to vote."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "amendment", // DOPSUM: CHANGE WORD ENTRY - Find /əˈmendmənt/
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAmendment(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () =>
                                    speakAmendment1244(// REPLACE: amendment /əˈmendmənt/
                                        "en-US"),
                              ),
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () =>
                                    speakAmendment4557(// REPLACE: amendment /əˈmendmənt/
                                        "en-US"),
                              ),
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () =>
                                    speakAmendment74111(// REPLACE: amendment /əˈmendmənt/
                                        "en-US"),
                              ),
                            ],
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'wWwQjH7T1bE';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'VS3cAOEVTss';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'CKNYcYYvfv4';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'pE2VIj7ozyA';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'zZ2AUptmvfA';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = '3xxHqPIk0r4';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = '-hwFKze2a_8';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = '5A_2I8Y5tWk';
