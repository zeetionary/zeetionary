...
class EnglishEntryhomicidal extends StatefulWidget {
  const EnglishEntryhomicidal({super.key});

  @override
  State<EnglishEntryhomicidal> createState() => _EnglishEntryhomicidalState();
}

class _EnglishEntryhomicidalState extends State<EnglishEntryhomicidal> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: homicidal
1. Characteristic of or capable of or having a tendency toward killing another human being (- murderous)
"a homicidal rage";
""",
  );

  final String keyword = "homicidal";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""homicidal""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He had clear homicidal tendencies.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001041;
    const String videoIdone = 'https://youtu.be/WdFFY221YOw?t=';
    const double startSecondsone = 000000000000000000000000000107;
    const String videoIdtwo = 'https://youtu.be/sJVxU2zpeLk?t=';
    const double startSecondstwo = 00000000000000000000000000085;
    const String videoIdthree = 'https://youtu.be/DbhuZFVqAqc?t=';
    const double startSecondsthree = 0000000000000000000000000001225;
    const String videoIdfour = 'https://youtu.be/QUuR2wm2hoE?t=';
    const double startSecondsfour = 000000000000000000000000000201;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homicidal""",
                      // alsoEnglishWord: "also: homicidal",
                      britshText: """IpaUK: /ˌhɒmɪˈsaɪdl/""",
                      americanText: """IpaUS: /ˌhɑːmɪˈsaɪdl/""",
...
کوردی: 
"""),
// With short examples define "homicidal", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە ئەگەری هەیە کەسێک بکوژێت یان وا لە کەسێک بکات کەسێک بکوژێت"""),
                    SentencesRow(
                      englishText: """He had clear homicidal tendencies.""",
                      kurdishText: """ئامانجی ئاشکرای پیاوکوژی هەبوو.""",
