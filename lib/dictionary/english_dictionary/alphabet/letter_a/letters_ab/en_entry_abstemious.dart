...
class EnglishEntryabstemious extends StatefulWidget {
  const EnglishEntryabstemious({super.key});

  @override
  State<EnglishEntryabstemious> createState() => _EnglishEntryabstemiousState();
}

class _EnglishEntryabstemiousState extends State<EnglishEntryabstemious> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "abstemious";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""abstemious""");
  }
  ...
  Future<void> speakab75891(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("He was a hard-working man with abstemious habits.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """abstemious""",
                      // alsoEnglishWord: "also: abstemious",
                      britshText: """IpaUK: /əbˈstiːmiəs/""",
                      americanText: """IpaUS: /əbˈstiːmiəs/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '_RFTUteO_2g';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '7L1vZ7SKKf8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'Du-OtLDqqC8';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'LuqlOP__7_g';
