...
class EnglishEntrylibrary extends StatefulWidget {
  const EnglishEntrylibrary({super.key});

  @override
  State<EnglishEntrylibrary> createState() => _EnglishEntrylibraryState();
}

class _EnglishEntrylibraryState extends State<EnglishEntrylibrary> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: library (Derived forms: libraries)
...
4. A depository built to contain books and other materials for reading and study (- depository library)
 
5. (computing) a collection of standard programs and subroutines that are stored and available for immediate use (- program library, subroutine library)
""",
  );

  final String keyword = "library";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""library""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How often do you go to the library?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I got this very interesting book out of the library.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Do you have any books to take back to the library?""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The library has an extensive collection of books on Chinese history.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The Media Centre houses a digital library of radio and television programmes.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She has a small library at home filled with novels.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The family possessed an extensive library.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/q8jLyotMMVE?t=2226';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/JHA_q-o1MEY?t=28';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/ImN2ze6opHE?t=60';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/Dq-cHtWJPpY?t=10';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/hYDYkQaxSFg?t=392';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/lhVwGCx4E2Q?t=26';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """library""",
                      // alsoEnglishWord: "also: library",
                      britshText: """IpaUK: /ˈlaɪbrəri/,  /ˈlaɪbri/""",
                      americanText: """IpaUS: /ˈlaɪbreri/""",
...
کوردی: 
"""),
// With short examples define "library", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) شوێنێک کە تێیدا پەرتووک، ڕۆژنامە، هتد و هەندێک جار فیلم و میوزیک هەیە بۆ خەڵکی بۆ ئەوەی بیان خوێننەوە یان بۆ ماوەیەکی کاتی بیانبەن"""),
                    SentencesRow(
                      englishText: """How often do you go to the library?""",
                      kurdishText: """چەندە زۆر دەچیتە پەرتووکخانە؟""",
                    ...
                    SentencesRow(
                      englishText: """I got this very interesting book out of the library.""",
                      kurdishText: """ئەم کتێبە ناوازەم لە کتێبخانەکە وەرگرت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Do you have any books to take back to the library?""",
                      kurdishText: """هیچ پەرتووکێکت هەیە بیبەیتەوە پەرتووکخانەکە؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The library has an extensive collection of books on Chinese history.""",
                      kurdishText: """پەرتووکخانەکە کۆکراوەیەکی فراوان لە مێژووی چینی هەیە.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) کۆکراوەیەک لە پەرتووک، ڕۆژنامە، فیلم، میوزیک، هتد کە لە پەرتووکخانەیەکن یان بە شێوەی دیجیتاڵ هەڵگیراون"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The Media Centre houses a digital library of radio and television programmes.""",
                      kurdishText: """سەنتەرە میدیاییەکە کۆکراوەیەک لە پڕۆگرامی ڕادیۆ و تەلەفیزیۆنی هەیە.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) ژوورێک لە ماڵێکدا کە کتێبی تێدا هەڵدەگیردرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She has a small library at home filled with novels.""",
                      kurdishText: """پەرتووکخانەیەکی بچووکی لە ماڵەوە هەیە کە پڕە لە ڕۆمان.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ناو) کۆکراوەیەکی کەسیی کتێب، میوزیک، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The family possessed an extensive library.""",
                      kurdishText: """خێزانەکە کۆکراوەیەکی فراوانی هەبوو.""",
