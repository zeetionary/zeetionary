...
class EnglishEntryfungus extends StatefulWidget {
  const EnglishEntryfungus({super.key});

  @override
  State<EnglishEntryfungus> createState() => _EnglishEntryfungusState();
}

class _EnglishEntryfungusState extends State<EnglishEntryfungus> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fungus (Derived forms: funguses, fungi)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Mushrooms and mould are fungi.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The logs were covered with bright fungus.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fungus""",
                      // alsoEnglishWord: "also: fungus",
                      britshText: """IpaUK: /ˈfʌŋɡəs/""",
                      americanText: """IpaUS: /ˈfʌŋɡəs/""",
...
// With short examples define "fungus", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Mushrooms and mould are fungi.""",
                      kurdishText: """قارچک و کەڕوو کوارگن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەختە دارەکان بە کوارگی درەوشاوە داپۆشرا بوون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/DfSnHyIryeY?t=';
const double _startSecondsend = 000000000000000000000000000201;
const String _videoIdone = 'https://youtu.be/CsTmgX32Uk8?t=';
const double _startSecondsone = 000000000000000000000000000231;
const String _videoIdtwo = 'https://youtu.be/7uk3-sjbaMQ';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/pHh5Nxbsa0c?t=';
const double _startSecondsthree = 00000000000000000000000000042;
const String _videoIdfour = 'https://youtu.be/HX483CVCBbw';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/C2Jw5ib-s_I?t=';
