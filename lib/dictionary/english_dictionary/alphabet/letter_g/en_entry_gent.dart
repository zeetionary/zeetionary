...
class EnglishEntrygent extends StatefulWidget {
  const EnglishEntrygent({super.key});

  @override
  State<EnglishEntrygent> createState() => _EnglishEntrygentState();
}

class _EnglishEntrygentState extends State<EnglishEntrygent> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This way please, ladies and gents!""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Is there a gents near here?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gent""",
                      // alsoEnglishWord: "also: gent",
                      britshText: """IpaUK: /dʒent/""",
                      americanText: """IpaUS: /dʒent/""",
...
کوردی: بە تەشەر و شۆخی‌یەوە بە جێنتێلمەن دەوترێ
"""),
// With short examples define "gent", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) پیاوێک"""),
                    SentencesRow(
                      englishText: """This way please, ladies and gents!""",
                      kurdishText: """تکایە لەم ڕێگاوە بەڕێزان و خانمان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/60FM9WjkXtA?t=';
const double _startSecondsend = 00000000000000000000000000047;
const String _videoIdone = 'https://youtu.be/Gpxkme91K4I';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/PoNCG3PZKII?t=';
const double _startSecondstwo = 0000000000000000000000000001356;
const String _videoIdthree = 'https://youtu.be/RZt7kE7PZMQ?t=';
const double _startSecondsthree = 0000000000000000000000000001468;
const String _videoIdfour = 'https://youtu.be/Hybm--GAgmo?t=';
const double _startSecondsfour = 000000000000000000000000000596;
const String _videoIdfive = 'https://youtu.be/e2Dx4-NQNeE?t=';
const double _startSecondsfive = 000000000000000000000000000121;
