...
// replace EnglishEntryantithesis - replace speakAntithesis

// replace antithesis - /ænˈtɪθəsɪs/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryantithesis extends StatelessWidget {
  // blank divider
  EnglishEntryantithesis({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "antithesis"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ænˈtɪθəsɪs/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ænˈtɪθəsɪs/"),
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 6096;
