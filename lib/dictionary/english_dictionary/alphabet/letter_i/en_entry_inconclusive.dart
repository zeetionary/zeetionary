...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'hPvyXkDRdis';
    const double startSecondsend = 926;
    const String videoIdone = 'IM31fgkxn2I';
    const double startSecondsone = 207;
    const String videoIdtwo = 'bnnRIrxGGX8';
    const double startSecondstwo = 2862;
    const String videoIdthree = 'Bh9lIfocRMk';
    const double startSecondsthree = 917;
    const String videoIdfour = 'oU7-KMGZ4bc';
    const double startSecondsfour = 314;
    const String videoIdfive = '_gM6NG2PN4Q';
