...
class EnglishEntryliability extends StatefulWidget {
  const EnglishEntryliability({super.key});

  @override
  State<EnglishEntryliability> createState() => _EnglishEntryliabilityState();
}

class _EnglishEntryliabilityState extends State<EnglishEntryliability> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: liability (Derived forms: liabilities)
1. The state of being legally obliged and responsible
 
2. An obligation to pay money to another party (- indebtedness, financial obligation)
 
3. The quality of being something that holds you back
""",
  );

  final String keyword = "liability";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""liability""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The company cannot accept liability for any damage caused by natural disasters.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The company has liabilities to its employees.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They have denied liability for the accident.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Since his injury, Jones has become more of a liability than an asset to the team.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The debate on immigration is proving to be something of a liability for the Prime Minister.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The company is reported to have liabilities of nearly £90 000.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/xjjKfFqQNjM?t=22';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/AF8d72mA41M?t=1586';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/N4kvtt2T_6Y?t=161';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/Pon4Zux5MaQ?t=564';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/eNMmSkE8ua4?t=972';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/GxnlPU1_QX8?t=146';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """liability""",
                      // alsoEnglishWord: "also: liability",
                      britshText: """IpaUK: /ˌlaɪəˈbɪləti/""",
                      americanText: """IpaUS: /ˌlaɪəˈbɪləti/""",
...
کوردی: 
"""),
// With short examples define "liability", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ئەوەی بەرپرس بیت بۆ شتێک"""),
                    SentencesRow(
                      englishText: """The company cannot accept liability for any damage caused by natural disasters.""",
                      kurdishText: """کۆمپانیاکە ناتوانێت بەرپرسیاریەتی بگرێتە ئەستۆ بۆ هەر زیانێک بە کارەساتی سرووشتی درووست ببێت.""",
                    ...
                    SentencesRow(
                      englishText: """The company has liabilities to its employees.""",
                      kurdishText: """کۆمپانیاکە بەرپرسیاریەتیی هەیە بەرامبەر بە کارمەندەکانی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They have denied liability for the accident.""",
                      kurdishText: """نکۆڵییان لە بەرپرسیاریەتی بە ڕووداوەکە کردووە.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) کەس یان شتێک کە کێشە درووست دەکات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Since his injury, Jones has become more of a liability than an asset to the team.""",
                      kurdishText: """لەوەتەی پێکانەکەی، جۆنز زیاتر بووە بە ئەرکێک وەک لە سوودێک بۆ تیمەکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The debate on immigration is proving to be something of a liability for the Prime Minister.""",
                      kurdishText: """بابەتی پەنابەری دەرکەوتووە جۆرێک لە کێشە بێت بۆ سەرۆک وەزیران.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) ئەو بڕە پارەیەی کەس یان کۆمپانیایەک هەیەتی وەک قەرز"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The company is reported to have liabilities of nearly £90 000.""",
                      kurdishText: """کۆمپانیاکە باس دەکرێت کە قەرزی نزیکەی ٩٠,٠٠٠ پاوەندی هەبێت.""",
