...
class EnglishEntrycollage extends StatelessWidget {
  ...
  Future<void> speakcollage(String languageCode) async {
    ...
    await flutterTts.speak("collage");
  }
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'cvx4ncV-rvA';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'EtMA5oVAWLs';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'jARyL7M6A7A';
  final double _startSeconds = 0;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'RbY0y-4XqOk';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '4oQLVHaEMkI';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '8vqMqwWA8Us';
