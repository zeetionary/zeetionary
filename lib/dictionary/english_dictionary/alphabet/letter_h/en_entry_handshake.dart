...
class EnglishEntryhandshake extends StatefulWidget {
  const EnglishEntryhandshake({super.key});

  @override
  State<EnglishEntryhandshake> createState() => _EnglishEntryhandshakeState();
}

class _EnglishEntryhandshakeState extends State<EnglishEntryhandshake> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: handshake (Derived forms: handshakes)
1. (contract) grasping and shaking a person's hand (as to acknowledge an introduction or to agree on a contract) (- shake, handshaking, handclasp)
"they closed the purchase with a handshake";
""",
  );

  final String keyword = "handshake";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""handshake""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She wasn't impressed by his limp handshake.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He had a firm handshake.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Fawcett gave me a hearty handshake.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She favours hugs over handshakes.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The firmness of his handshake reassured me.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """handshake""",
                      // alsoEnglishWord: "also: handshake",
                      britshText: """IpaUK: /ˈhændʃeɪk/""",
                      americanText: """IpaUS: /ˈhændʃeɪk/""",
...
کوردی: دەس‌لێکدانەوە، تەوقە، دەس‌ومشتاخ، (کاری) دەس‌دانەوە
"""),
// With short examples define "handshake", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕاوەشاندنی دەستی کەسێک بە دەستت، زۆرجار لە کاتی سڵاو یان خوداحافیزی دەکرێت"""),
                    SentencesRow(
                      englishText:
                          """She wasn't impressed by his limp handshake.""",
                      kurdishText: """سەرسام نەبوو بە تەوقە سستەکەی.""",
                    ...
                    SentencesRow(
                      englishText: """He had a firm handshake.""",
                      kurdishText: """تەوقەیەکی توندی هەبوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Fawcett gave me a hearty handshake.""",
                      kurdishText: """فۆسیت تەوقەیەکی گەرم‌وگوڕی لەگەڵ کردم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She favours hugs over handshakes.""",
                      kurdishText: """باوەشی پێ باشە وەک لە تەوقەکردن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The firmness of his handshake reassured me.""",
                      kurdishText: """توندی تەوقەکەی دڵنیای کردمەوە.""",
...
const double _startSecondsend = 000000000000000000000000000735;
const String _videoIdone = 'https://youtu.be/0ST4_hmop9Y?t=';
const double _startSecondsone = 000000000000000000000000000893;
const String _videoIdtwo = 'https://youtu.be/CvjoXdC-WkM?t=';
const double _startSecondstwo = 000000000000000000000000000625;
const String _videoIdthree = 'https://youtu.be/H3fUn4le238?t=';
const double _startSecondsthree = 00000000000000000000000000024;
const String _videoIdfour = 'https://youtu.be/piYf4gDthjY?t=';
const double _startSecondsfour = 000000000000000000000000000306;
const String _videoIdfive = 'https://youtu.be/60I84LHc_ug?t=';
