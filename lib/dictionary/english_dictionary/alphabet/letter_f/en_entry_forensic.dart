...
class EnglishEntryforensic extends StatefulWidget {
  const EnglishEntryforensic({super.key});

  @override
  State<EnglishEntryforensic> createState() => _EnglishEntryforensicState();
}

class _EnglishEntryforensicState extends State<EnglishEntryforensic> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forensic""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forensic""",
                      // alsoEnglishWord: "also: forensic",
                      britshText: """IpaUK: /fəˈrenzɪk/""",
                      americanText: """IpaUS: /fəˈrenzɪk/""",
...
// With short examples define "forensic", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) پەیوەندیدار بە تاقیکردنەوەی زانستی کە پۆلیس لە لێکۆڵینەوەی تاواندا بەکاری دەهێنێت"""),
                    SentencesRow(
                      englishText:
                          """Forensic examination revealed a large quantity of poison in the dead man's stomach.""",
                      kurdishText:
                          """لێکۆڵینەوەی پۆلیسی ئاشکرای کرد کە ڕێژەیەکی زۆر لە ژەهر لە گەدەی پیاوە مردووەکەیە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ii50SWTJSoA?t=';
const double _startSecondsend = 00000000000000000000000000096;
const String _videoIdone = 'https://youtu.be/qg2nGY1aqlg?t=';
const double _startSecondsone = 0000000000000000000000000001172;
const String _videoIdtwo = 'https://youtu.be/0jltioeaEyY?t=';
const double _startSecondstwo = 000000000000000000000000000815;
const String _videoIdthree = 'https://youtu.be/05gCLHlpzTU?t=';
const double _startSecondsthree = 0000000000000000000000000001670;
const String _videoIdfour = 'https://youtu.be/OZ_xhkg32nk?t=';
const double _startSecondsfour = 000000000000000000000000000286;
const String _videoIdfive = 'https://youtu.be/fGMCjELDyUY?t=';
const double _startSecondsfive = 0000000000000000000000000002281;
