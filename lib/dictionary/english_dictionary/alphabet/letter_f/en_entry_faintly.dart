...
class EnglishEntryfaintly extends StatefulWidget {
  const EnglishEntryfaintly({super.key});

  @override
  State<EnglishEntryfaintly> createState() => _EnglishEntryfaintlyState();
}

class _EnglishEntryfaintlyState extends State<EnglishEntryfaintly> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""faintly""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """faintly""",
                      // alsoEnglishWord: "also: faintly",
                      britshText: """IpaUK: /ˈfeɪntli/""",
                      americanText: """IpaUS: /ˈfeɪntli/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She could faintly hear music playing.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It smelled faintly of smoke.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He looked faintly embarrassed.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The whole thing was faintly ridiculous.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She smiled faintly.""");
  }
...
// With short examples define "faintly", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The whole thing was faintly ridiculous.""",
            kurdishText: """تەواوی شتەکە کەمێک پڕووپووچ بوو.""",
...
"between him and the dim light a form was outlined faintly"; "stars shining faintly through the overcast"; "could hear his distant shouts only faintly"; "the rumours weren't even faintly true"
""",
  );
...
const String _videoIdend = 'https://youtu.be/uOJQbqwsfLg?t=';
const double _startSecondsend = 000000000000000000000000000272;
const String _videoIdone = 'https://youtu.be/nARcrP7GNso?t=';
const double _startSecondsone = 000000000000000000000000000985;
const String _videoIdtwo = 'https://youtu.be/qURmdmgCCOI?t=';
const double _startSecondstwo = 000000000000000000000000000278;
const String _videoIdthree = 'https://youtu.be/9ZsORyZa8tI?t=';
const double _startSecondsthree = 000000000000000000000000000140;
const String _videoIdfour = 'https://youtu.be/t70wcV3gJ68?t=';
const double _startSecondsfour = 000000000000000000000000000323;
const String _videoIdfive = 'https://youtu.be/fNLPrNNDz5I?t=';
const double _startSecondsfive = 000000000000000000000000000947;
