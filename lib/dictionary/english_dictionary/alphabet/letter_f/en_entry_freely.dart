...
class EnglishEntryfreely extends StatefulWidget {
  const EnglishEntryfreely({super.key});

  @override
  State<EnglishEntryfreely> createState() => _EnglishEntryfreelyState();
}

class _EnglishEntryfreelyState extends State<EnglishEntryfreely> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""EU citizens can travel freely between member states.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""When the gate is raised, the water can flow freely.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Once into the open street they could breathe more freely.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I freely admit that I made a mistake.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """freely""",
                      // alsoEnglishWord: "also: freely",
                      britshText: """IpaUK: /ˈfriːli/""",
                      americanText: """IpaUS: /ˈfriːli/""",
...
کوردی: ئازادانە، ئازاد، بە سەربەستی،	بەخۆڕایی، بەلاش،	بە دڵاوایی، بەدەهندانەوە
"""),
// With short examples define "freely", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەندامانی یەکێتیی ئەورووپا دەتوانن بە ئازادی لە نێوان ئەندامەکاندا گەشت بکەن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بەبێ ئەوەی هیچ شتێک جووڵەی شتێک بوەستێنێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """When the gate is raised, the water can flow freely.""",
                      kurdishText:
                          """کە دەروازەکە بەرز دەکرێتەوە، ئاوەکە دەتوانێت بە ئازادی تێپەڕێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کە گەشتنە سەر شەقامە ئازادەکە دەیانتوانی ئازادانەتر هەناسە بدەن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """For the first time he was able to speak freely without the fear of reprisals against his family.""",
                      kurdishText:
                          """بۆ یەکەمین جار دەیتوانی بە ئازادی قسە بکات بەبێ ترسی تۆڵەکردنەوەی خێزانەکەی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە ئازادانە دان بەوەدا دەنێم کە هەڵەم کرد.""",
...
const double _startSecondsone = 000000000000000000000000000451;
const String _videoIdtwo = 'https://youtu.be/X3TAROotFfM?t=';
const double _startSecondstwo = 000000000000000000000000000598;
const String _videoIdthree = 'https://youtu.be/oBcxuzdP3rs?t=';
const double _startSecondsthree = 000000000000000000000000000285;
const String _videoIdfour = 'https://youtu.be/G0SpzIIHEaE?t=';
const double _startSecondsfour = 00000000000000000000000000070;
const String _videoIdfive = 'https://youtu.be/QcUey-DVYjk?t=';
