...
class EnglishEntryfabric extends StatefulWidget {
  const EnglishEntryfabric({super.key});

  @override
  State<EnglishEntryfabric> createState() => _EnglishEntryfabricState();
}

class _EnglishEntryfabricState extends State<EnglishEntryfabric> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fabric""",
                      // alsoEnglishWord: "also: fabric",
                      britshText: """IpaUK: /ˈfæbrɪk/""",
                      americanText: """IpaUS: /ˈfæbrɪk/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They sell a wide variety of cotton fabric.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fabric is woven on these machines.""");
  }
...
"""),
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The fabric is woven on these machines.""",
            kurdishText: """قوماشەکە لەسەر ئەم ئامێرانە دەچندرێن.""",
          ...
          SentencesRow(
            englishText:
                """The government's policies have destroyed the social fabric.""",
            kurdishText:
                """سیاسەتەکانی حکومەت پایەکانی کۆمەڵگای داڕووخاندووە.""",
...
2. The underlying structure (= framework)
...
const double _startSecondsend = 000000000000000000000000000469;
