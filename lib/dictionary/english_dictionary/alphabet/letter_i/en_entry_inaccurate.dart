...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'pTk9HnIwEYU';
    const double startSecondsend = 135;
    const String videoIdone = 'd_fHun8jj2g';
    const double startSecondsone = 919;
    const String videoIdtwo = '1I1vxu5qIUM';
    const double startSecondstwo = 959;
    const String videoIdthree = 'XkYvo6S82LE';
    const double startSecondsthree = 1736;
    const String videoIdfour = 'm1GEPsSVpZY';
    const double startSecondsfour = 680;
    const String videoIdfive = 'FrbiPlT-rJU';
