...
class EnglishEntryimpurity extends StatefulWidget {
  const EnglishEntryimpurity({super.key});

  @override
  State<EnglishEntryimpurity> createState() => _EnglishEntryimpurityState();
}

class _EnglishEntryimpurityState extends State<EnglishEntryimpurity> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: impurity (Derived forms: impurities)
1. Worthless or dangerous material that should be removed (- dross)
"there were impurities in the water";
 
2. The condition of being impure (- impureness)
""",
  );

  final String keyword = "impurity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impurity""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""A filter will remove most impurities found in water.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The substance is free of impurities.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/16gB2BDXwTo?t=';
    const double startSecondsend = 000000000000000000000000000944;
    const String videoIdone = 'https://youtu.be/GHkUdA68YNI?t=';
    const double startSecondsone = 000000000000000000000000000707;
    const String videoIdtwo = 'https://youtu.be/B-KroMPyUFU?t=';
    const double startSecondstwo = 0000000000000000000000000001403;
    const String videoIdthree = 'https://youtu.be/-_PU0cRZ9wg?t=';
    const double startSecondsthree = 000000000000000000000000000757;
    const String videoIdfour = 'https://youtu.be/VeBX4WjhhXs?t=';
    const double startSecondsfour = 000000000000000000000000000689;
    const String videoIdfive = 'https://youtu.be/Zx4hRmuW6TM?t=';
    const double startSecondsfive = 000000000000000000000000000416;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """impurity""",
                      // alsoEnglishWord: "also: impurity",
                      britshText: """IpaUK: /ɪmˈpjʊərəti/""",
                      americanText: """IpaUS: /ɪmˈpjʊrəti/""",
...
کوردی: پیسی، ناخاوێنی، چڵکنی،	تێکەڵی، ناپوختی، ناپوختە،	هەرزەیی، ناپاکی، داوێن‌پیسی
"""),
// With short examples define "impurity", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مادەیەک کە بە ڕێژەی بچووک لە مادەیەکی دیکەدا بوونی هەیە و پیسی دەکات"""),
                    SentencesRow(
                      englishText:
                          """A filter will remove most impurities found in water.""",
                      kurdishText:
                          """فیلتەرێک زۆرینەی پیسییەکانی ئاو دەردەکات.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The substance is free of impurities.""",
                      kurdishText: """مادەکە بەدەرە لە پیسی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The water contains impurities which make it unsuitable for drinking.""",
                      kurdishText:
                          """ئاوەکە پیسی تێدایە کە وا دەکات پیس بێت بۆ خواردنەوە.""",
