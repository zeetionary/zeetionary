...
class EnglishEntryfabrication extends StatefulWidget {
  const EnglishEntryfabrication({super.key});

  @override
  State<EnglishEntryfabrication> createState() =>
      _EnglishEntryfabricationState();
}

class _EnglishEntryfabricationState extends State<EnglishEntryfabrication> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fabrication""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fabrication""",
                      // alsoEnglishWord: "also: fabrication",
                      britshText: """IpaUK: /ˌfæbrɪˈkeɪʃn/""",
                      americanText: """IpaUS: /ˌfæbrɪˈkeɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "fabrication";
...
3. The act of making something (a product) from raw materials (= manufacture, manufacturing)
"the synthesis and fabrication of single crystals";
 
4. The act of constructing something (as a piece of machinery) (= assembly)
 
5. The deliberate act of deviating from the truth (= lying, prevarication)
""",
  );
...
const double _startSecondsend = 000000000000000000000000000644;
const String _videoIdone = 'https://youtu.be/cqjn3mup1So?t=';
const double _startSecondsone = 00000000000000000000000000038;
const String _videoIdtwo = 'https://youtu.be/tyixMpuGEL8?t=';
const double _startSecondstwo = 0000000000000000000000000001785;
const String _videoIdthree = 'https://youtu.be/E3EFK020pgw?t=';
const double _startSecondsthree = 000000000000000000000000000575;
const String _videoIdfour = 'https://youtu.be/YCjy9cU-3NA?t=';
const double _startSecondsfour = 000000000000000000000000000104;
const String _videoIdfive = 'https://youtu.be/mlKAOjChW28?t=';
