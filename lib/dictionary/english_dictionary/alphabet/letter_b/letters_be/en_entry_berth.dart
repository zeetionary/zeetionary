...
// Define the word "berth" and provide five simple example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings or more.

// replace berth - replace EnglishEntryberth

// replace speakBerth - /bɜːθ/

enum TtsState { playing }

class EnglishEntryberth extends StatelessWidget {
// blank divider
  EnglishEntryberth({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakBerth(String languageCode) async {
    // DOPSUM: CHANGE speakBerth
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("berth"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakBerths1(String languageCode) async {
    // DOPSUM: CHANGE speakBerth
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "She booked a berth on the ferry from Palermo to Naples."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakBerths2(String languageCode) async {
    // DOPSUM: CHANGE speakBerth
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "The harbor was filled with ships of all sizes, each secured to its own berth."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakBerths3(String languageCode) async {
    // DOPSUM: CHANGE speakBerth
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The ship is berthed at Southampton."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakBerths4(String languageCode) async {
    // DOPSUM: CHANGE speakBerth
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBerths44"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakBerths5(String languageCode) async {
    // DOPSUM: CHANGE speakBerth
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBerths55"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakBerths6(String languageCode) async {
    // DOPSUM: CHANGE speakBerth
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBerths66"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakBerths7(String languageCode) async {
    // DOPSUM: CHANGE speakBerth
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBerths77"); // DOPSUM: CHANGE TEXT
  }
...
1. A job in an organization (= position, post, office, place, situation)
 
2. A place where a craft can be made fast (= mooring, moorage, slip)
 
3. A bed on a ship or train; usually in tiers (= bunk, built in bed)

- Verb: berth (derived forms: berthing, berthed, berths)
1. Provide with a berth
 
2. Secure in or as if in a berth or dock (= moor, tie up)
"berth the boat";
 
3. Come into or dock at a wharf (= moor, wharf)
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  static String myVideoId = "upvvvICISZ8";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  static String myVideoId = "6FD23UrWnUU";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  static String myVideoId = "Vh_d31rWt2o";
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  static String myVideoId = "f33WqXf30Qk";
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  static String myVideoId = "YmX8seNKVQo";
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  static String myVideoId = "ki6MQgeb45A";
...
// end berth// TODO Implement this library.
