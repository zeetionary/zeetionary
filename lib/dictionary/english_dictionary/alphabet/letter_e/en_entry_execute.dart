...
class EnglishEntryexecute extends StatefulWidget {
  const EnglishEntryexecute({super.key});

  @override
  State<EnglishEntryexecute> createState() => _EnglishEntryexecuteState();
}

class _EnglishEntryexecuteState extends State<EnglishEntryexecute> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""execute""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """execute""",
                      // alsoEnglishWord: "also: execute",
                      britshText: """IpaUK: /ˈeksɪkjuːt/""",
                      americanText: """IpaUS: /ˈeksɪkjuːt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was executed for treason.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The prisoners were executed by firing squad.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She was condemned to death and executed two weeks later.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The crime was very cleverly executed.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Check that the computer has executed your commands.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The pilot executed a perfect landing.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The movement was beautifully executed.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The second goal was superbly executed.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The whole play was executed with great precision.""");
  }
...
"""),
          const DefinitionKurdish(
              text: """١. (کردار) کوشتنی کەسێک، بەتایبەتی وەک سزای یاسایی"""),
          SentencesRow(
            englishText: """He was executed for treason.""",
            kurdishText: """بۆ خیانەت کوژرا.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The prisoners were executed by firing squad.""",
            kurdishText: """زیندانییەکان بە گوللەباران کوژران.""",
          ...
          SentencesRow(
            ...
            kurdishText: """بە مەرگ سزا درا و دوای دوو هەفتە کوژرا.""",
          ...
          SentencesRow(
            englishText:
                """A convicted murderer was executed in North Carolina yesterday.""",
            kurdishText: """بکوژێکی سزادراو دوێنێ لە کارۆلینای باکوور کوژرا.""",
          ...
          SentencesRow(
            englishText:
                """Anyone caught trying to escape from the prison camp would be executed on the spot.""",
            kurdishText:
                """هەرکەس کە دەگیردرا لەکاتی ڕاکردن کە کەمپی زیندانیان لە جێگای خۆی دەکوژرا.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) کردنی شتێک، بەجێهێنانی ئەرکێک، جێبەجێکردنی پلانێک، هتد"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """They drew up and executed a plan to reduce fuel consumption.""",
            kurdishText:
                """پلانێکیان داڕێژا و جێبەجێیان کرد بۆ کەمکردنەوەی بەکارهێنانی سووتەمەنی.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The crime was very cleverly executed.""",
            kurdishText: """تاوانەکە زۆر زیرەکانە ئەنجام درا.""",
          ...
          SentencesRow(
            ...
            kurdishText: """دڵنیابەرەوە کۆمپیوتەرەکە ئەرکەکانتی بەجێهێناوە.""",
          ...
          SentencesRow(
            englishText:
                """I swear that I will faithfully execute the office of President of the United States.""",
            kurdishText:
                """بەڵێن دەدەم بە متمانەوە ئەرکی سەرۆکایەتی ویلایەتە یەکگرتووەکان جێبەجێ بکەم.""",
          ...
          const DefinitionKurdish(
              text:
                  """٣. (کردار) بەسەرکەوتووی ئەنجامدانی کردارێک یان جووڵەیەک کە پێویستیی بە شارەزایی هەیە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """The pilot executed a perfect landing.""",
            kurdishText: """فڕۆکەوانەکە نیشتنەوەیەکی بێ‌خەوشی بەجێهێنا.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The movement was beautifully executed.""",
            kurdishText: """جووڵەکە بەجوانی ئەنجام درا.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The second goal was superbly executed.""",
            kurdishText: """گۆڵی دووەم بە ناوازەیی ئەنجام درا.""",
            onPressedBritish: () => speaksentence12("en-GB"),
            onPressedAmerican: () => speaksentence12("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٤. (کردار) ئەنجامدانی کارێکی هونەری"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The whole play was executed with great precision.""",
            kurdishText: """تەواوی شانۆکە بە وردی زۆرەوە ئەنجام درا.""",
          ...
          const DefinitionKurdish(
              text:
                  """٥. (کردار) بەجێهێنانی ڕێنماییەکانی بەڵگەنامەیەکی یاسایی"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """His will was executed by his lawyers in 2008.""",
            kurdishText:
                """وەسیەتەکەی لە ساڵی ٢٠٠٨ لەلایەن پارێزەرەکانی بەجێهێندرا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: execute (Derived forms: executed, executing, executes)
1. Kill as a means of socially sanctioned punishment (= put to death)
"In some states, criminals are executed";
 
2. Murder in a planned fashion
"The Mafioso who collaborated with the police was executed"
 
3. Cause to happen; complete successfully (= carry through, accomplish, carry out, action, fulfill [N. Amer], fulfil [Brit, Cdn])
"execute the decision of the people";
 
4. Carry out the legalities of
"execute a will or a deed"
 
5. Carry out a process or program, as on a computer or a machine (= run)
"the computer executed the instruction";
 
6. Carry out an action (= perform, do)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/8HEfIJlcFbs?t=';
const double _startSecondsend = 000000000000000000000000000000; // 440;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/wMmy2MlH55U?t=';
const double _startSecondsone = 00000000000000000000000000000; // 318;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/b1reY72ktEc?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1154;
const String _videoIdthree = 'VIDEOhttps://youtu.be/k7YVxLLIuGM?t=';
const double _startSecondsthree = 000000000000000000000000000; // 286;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/8KmmZBBJGkE?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 189;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/60FM9WjkXtA?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 675;
