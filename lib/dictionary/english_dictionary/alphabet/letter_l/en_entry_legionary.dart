...
class EnglishEntrylegionary extends StatefulWidget {
  const EnglishEntrylegionary({super.key});

  @override
  State<EnglishEntrylegionary> createState() => _EnglishEntrylegionaryState();
}

class _EnglishEntrylegionaryState extends State<EnglishEntrylegionary> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: legionary (Derived forms: legionaries)
1. A soldier who is a member of a legion (especially the French Foreign Legion) (- legionnaire)
""",
  );

  final String keyword = "legionary";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""legionary""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The legionaries were armed with swords.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/VZ9u8S26tGk?t=13380';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/kfQ6GNKqLOs?t=793';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/eR-J_JSBNTI?t=97';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/Y_6aYGfUkdc?t=264';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/TyVFnkFfwac?t=1161';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/z3uvnwBMTdY?t=8922';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """legionary""",
                      // alsoEnglishWord: "also: legionary",
                      britshText: """IpaUK: /ˈliːdʒənəri/""",
                      americanText: """IpaUS: /ˈliːdʒəneri/""",
...
کوردی: 
"""),
// With short examples define "legionary", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) سەربازێک کە سەربە لیجنێکە"""),
                    SentencesRow(
                      englishText: """The legionaries were armed with swords.""",
                      kurdishText: """لیجنەکان شمشێریان پێبوو.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    // const DividerDefinition(),
                    // const DefinitionKurdish(text: """٢. (ھاوەڵناو) پەیوەندیدار بە لیجن"""),
