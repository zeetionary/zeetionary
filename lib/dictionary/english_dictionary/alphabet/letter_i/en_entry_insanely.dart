...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 732;
    const String videoIdtwo = 'AF8d72mA41M';
    const double startSecondstwo = 1782;
    const String videoIdthree = 'W2c86R-BOw0';
    const double startSecondsthree = 55;
    const String videoIdfour = 'O15kBAODBo4';
    const double startSecondsfour = 211;
    const String videoIdfive = 'svy8zw-2XRM';
