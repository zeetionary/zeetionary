...
class EnglishEntryfrench extends StatefulWidget {
  const EnglishEntryfrench({super.key});

  @override
  State<EnglishEntryfrench> createState() => _EnglishEntryfrenchState();
}

class _EnglishEntryfrenchState extends State<EnglishEntryfrench> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: French
1. Of or pertaining to France or the people of France (= Gallic)
"French cooking";
 
2. Of or relating to the French language
"the French word for cheese"

- Noun: French (Derived forms: Frenches)
1. The people of France (= French people)
 
2. The Romance language spoken in France and in countries colonized by France (= French language)
 
3. United States sculptor who created the seated marble figure of Abraham Lincoln in the Lincoln Memorial in Washington D.C. (1850-1931) (= Daniel Chester French)

- Verb: French (Derived forms: Frenches, Frenching, Frenched)
1. Cut (e.g, beans) lengthwise in preparation for cooking
"French the potatoes"
""",
  );

  final String keyword = "French";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """French""",
                      // alsoEnglishWord: "also: French",
                      britshText: """IpaUK: /frentʃ/""",
                      americanText: """IpaUS: /frentʃ/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """Have you got a dictionary I can use for translating French into English?""",
                      kurdishText:
                          """فەرهەنگێکت هەیە کە بەکاری بهێنم بۆ وەرگێڕان لە فەرەنسی بۆ ئینگلیزی؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """فەرەنسییەکان مێژوویەکی دەوڵەمەندی هونەر و وێژەیان هەیە.""",
