...
class EnglishEntryinteger extends StatefulWidget {
  const EnglishEntryinteger({super.key});

  @override
  State<EnglishEntryinteger> createState() => _EnglishEntryintegerState();
}

class _EnglishEntryintegerState extends State<EnglishEntryinteger> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""integer""");
  }
