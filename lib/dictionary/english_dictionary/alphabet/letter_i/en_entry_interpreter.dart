...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'F_7QXlXpytM';
    const double startSecondsend = 112;
    const String videoIdone = 'knjliFs3gR8';
    const double startSecondsone = 264;
    const String videoIdtwo = 'IxhGjDyBT30';
    const double startSecondstwo = 162;
    const String videoIdthree = 'zOyDwBvxAyA';
    const double startSecondsthree = 959;
    const String videoIdfour = 'z096HXz0gso';
    const double startSecondsfour = 571;
    const String videoIdfive = 'HGOBQPFzWKo';
    const double startSecondsfive = 4692;
