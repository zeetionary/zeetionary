...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'apDoJkfR85A';
    const double startSecondsend = 967;
    const String videoIdone = 'KIzqSTEC5kU';
    const double startSecondsone = 369;
    const String videoIdtwo = 'CMtF7nxMv5A';
    const double startSecondstwo = 452;
    const String videoIdthree = 'u1h-jPizdv4';
    const double startSecondsthree = 15;
    const String videoIdfour = 'WihpfXxGOBo';
    const double startSecondsfour = 589;
    const String videoIdfive = 'AzAN53uhZd0';
