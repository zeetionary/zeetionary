...
class EnglishEntryinexperienced extends StatefulWidget {
  ...
  @override
  State<EnglishEntryinexperienced> createState() =>
      _EnglishEntryinexperiencedState();
}
...
1. Lacking practical experience or training (- inexperient [non-standard], green [informal])
...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 00000000000000000000000000013;
    const String videoIdone = 'https://youtu.be/S2jqBwv4VbA?t=';
    const double startSecondsone = 000000000000000000000000000300;
    const String videoIdtwo = 'https://youtu.be/EDx5OFOiQ-I?t=';
    const double startSecondstwo = 000000000000000000000000000652;
    const String videoIdthree = 'https://youtu.be/Q-nWA0WeF98?t=';
    const double startSecondsthree = 0000000000000000000000000001706;
    const String videoIdfour = 'https://youtu.be/DmqFbgKWoao?t=';
    const double startSecondsfour = 000000000000000000000000000385;
    const String videoIdfive = 'https://youtu.be/GF_bsZMe7zg?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      britshText: """IpaUK: /ˌɪnɪkˈspɪəriənst/""",
                      americanText: """IpaUS: /ˌɪnɪkˈspɪriənst/""",
...
کوردی: بێ‌ئەزموون، خاو، ناپوخت(ە)، بێ‌تەجروبە
"""),
// With short examples define "inexperienced", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە زانیاری و ئەزموونت کەمە"""),
                    SentencesRow(
                      englishText:
                          """A child of his age is too young and inexperienced to recognize danger.""",
                      kurdishText:
                          """منداڵێک لە تەمەنی ئەودا زۆر گەنج و بێ‌ئەزموونە کە مەترسی بناسێتەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Some of the older teachers are inexperienced in modern methods.""",
                      kurdishText:
                          """هەندێک لە مامۆستا کۆنەکان بێ‌ئەزموون لە ڕێگا تازەکان.""",
