...
class EnglishEntryfiercely extends StatefulWidget {
  const EnglishEntryfiercely({super.key});

  @override
  State<EnglishEntryfiercely> createState() => _EnglishEntryfiercelyState();
}

class _EnglishEntryfiercelyState extends State<EnglishEntryfiercely> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: fiercely
1. In a physically fierce manner (= ferociously)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fiercely""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They remain fiercely opposed to outside intervention.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The aircraft was burning fiercely.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiercely""",
                      // alsoEnglishWord: "also: fiercely",
                      britshText: """IpaUK: /ˈfɪəsli/""",
                      americanText: """IpaUS: /ˈfɪrsli/""",
...
// With short examples define "fiercely", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەواو دژ بە دەستوەردانی دەرەکی دەوەستنەوە.""",
...
const String _videoIdend = 'https://youtu.be/rsNskDfd5CM?t=';
const double _startSecondsend = 00000000000000000000000000082;
const String _videoIdone = 'https://youtu.be/wrAGtxMWQE0?t=';
const double _startSecondsone = 000000000000000000000000000251;
const String _videoIdtwo = 'https://youtu.be/1ZKBaRsP1gY?t=';
const double _startSecondstwo = 000000000000000000000000000901;
const String _videoIdthree = 'https://youtu.be/RWrF88o3MC4?t=';
const double _startSecondsthree = 00000000000000000000000000025;
const String _videoIdfour = 'https://youtu.be/V3PK_fBIzBM?t=';
const double _startSecondsfour = 000000000000000000000000000244;
const String _videoIdfive = 'https://youtu.be/eRExYRZ74OQ?t=';
const double _startSecondsfive = 0000000000000000000000000001237;
