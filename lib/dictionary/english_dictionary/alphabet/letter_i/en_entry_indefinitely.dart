...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 2174;
    const String videoIdone = 'OPEh7UWmfDc';
    const double startSecondsone = 1233;
    const String videoIdtwo = 'g3Ud6mHdhlQ';
    const double startSecondstwo = 1462;
    const String videoIdthree = '7Vm282YvOGw';
    const double startSecondsthree = 697;
    const String videoIdfour = 'GaLdHd2J-xM';
