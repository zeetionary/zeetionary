...
class EnglishEntryinstigate extends StatefulWidget {
  const EnglishEntryinstigate({super.key});

  @override
  State<EnglishEntryinstigate> createState() => _EnglishEntryinstigateState();
}

class _EnglishEntryinstigateState extends State<EnglishEntryinstigate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: instigate (Derived forms: instigated, instigates, instigating)
1. Provoke or stir up (- incite, set off, stir up)
"instigate a riot";
 
2. Serve as the inciting cause of (- prompt, inspire)
""",
  );

  final String keyword = "instigate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""instigate""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They were accused of instigating violence.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/dIa-M5qoOHE?t=';
    const double startSecondsend = 000000000000000000000000000210;
    const String videoIdone = 'https://youtu.be/hSNWkRw53Jo?t=';
    const double startSecondsone = 0000000000000000000000000008674;
    const String videoIdtwo = 'https://youtu.be/QLNCl3dBqG8?t=';
    const double startSecondstwo = 000000000000000000000000000971;
    const String videoIdthree = 'https://youtu.be/IOgq4Nk2H8w?t=';
    const double startSecondsthree = 0000000000000000000000000001286;
    const String videoIdfour = 'https://youtu.be/Bfln3YgJh1s?t=';
    const double startSecondsfour = 0000000000000000000000000002518;
    const String videoIdfive = 'https://youtu.be/QPS4X5MhvZc?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """instigate""",
                      // alsoEnglishWord: "also: instigate",
                      britshText: """IpaUK: /ˈɪnstɪɡeɪt/""",
                      americanText: """IpaUS: /ˈɪnstɪɡeɪt/""",
...
کوردی: ورووژاندن، بزاوتن، هاندان
"""),
// With short examples define "instigate", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) دەستپێکردنی شتێک"""),
                    const AlsoEnglishckb(
                        word: "ھەروەھا: lifbring something about"),
                    SentencesRow(
                      englishText:
                          """The government has instigated a programme of economic reform.""",
                      kurdishText:
                    ...
                    SentencesRow(
                      englishText:
                          """The man responsible for instigating change was Robin Darwin.""",
                      kurdishText:
                          """ئەو کەسەی بەرپرسی دەستپێکردنی گۆڕانکاری بوو ڕۆبن داروین بوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) بوون بە هۆکاری ڕوودانی شتێکی خراپ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """They were accused of instigating violence.""",
                      kurdishText: """تاوانبار کران بە نانەوەی توندووتیژی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Those found guilty of instigating the unrest will be punished.""",
                      kurdishText:
                          """ئەوانەی کە بە تۆمەتبار دادەنرێن لە درووستکردنی ئاژاوە سزا دەدرێن.""",
