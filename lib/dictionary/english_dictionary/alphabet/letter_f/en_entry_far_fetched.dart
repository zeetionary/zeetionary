...
class EnglishEntryfarfetched extends StatefulWidget {
  const EnglishEntryfarfetched({super.key});

  @override
  State<EnglishEntryfarfetched> createState() => _EnglishEntryfarfetchedState();
}

class _EnglishEntryfarfetchedState extends State<EnglishEntryfarfetched> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""far-fetched""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """far-fetched""",
                      // alsoEnglishWord: "also: far-fetched",
                      britshText: """IpaUK: /ˌfɑː ˈfetʃt/""",
                      americanText: """IpaUS: /ˌfɑːr ˈfetʃt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "far-fetched";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The whole story sounds very far-fetched.""");
  }
...
// With short examples define "far-fetched", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) کە سەختە باوەڕی پێ بکرێت"""),
          SentencesRow(
            englishText: """The whole story sounds very far-fetched.""",
            kurdishText: """تەواوی چیرۆکەکە زۆر دوور لە باوەڕ دیارە.""",
...
1. (of an idea or story) so exaggerated or ludicrous as to be improbable (= farfetched, imaginative)
 
2. (of a theory or explanation) highly imaginative but unlikely and unconvincing (= farfetched, imaginative)
"a farfetched excuse";
""",
  );
...
const String _videoIdone = 'https://youtu.be/GjbxgP9jL18?t=';
const double _startSecondsone = 00000000000000000000000000030;
const String _videoIdtwo = 'https://youtu.be/iQlAFNrbPcc?t=';
const double _startSecondstwo = 000000000000000000000000000138;
const String _videoIdthree = 'https://youtu.be/hCsPV0eiqxg?t=';
const double _startSecondsthree = 000000000000000000000000000984;
const String _videoIdfour = 'https://youtu.be/ilj8fZroRw0?t=';
const double _startSecondsfour = 0000000000000000000000000003288;
const String _videoIdfive = 'https://youtu.be/wkkx4PCcZjU?t=';
const double _startSecondsfive = 000000000000000000000000000312;
