...
class EnglishEntryforage extends StatefulWidget {
  const EnglishEntryforage({super.key});

  @override
  State<EnglishEntryforage> createState() => _EnglishEntryforageState();
}

class _EnglishEntryforageState extends State<EnglishEntryforage> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forage (Derived forms: forages)
1. Bulky food like grass or hay for browsing or grazing horses or cattle (= eatage [dialect], pasture, pasturage, grass, grazing)
 
2. The act of searching for food and provisions (= foraging)

- Verb: forage (Derived forms: foraged, foraging, forages)
1. Collect or look around for (food) (= scrounge)
...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The pigs foraged in the woods for acorns.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forage""",
                      // alsoEnglishWord: "also: forage",
                      britshText: """IpaUK: /ˈfɒrɪdʒ/""",
                      americanText: """IpaUS: /ˈfɔːrɪdʒ/""",
...
// With short examples define "forage", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The female only leaves the young when she forages for food.""",
                      kurdishText:
                          """مێینەکە بێچووەکانی جێدەهێڵێت تەنها کە بۆ خواردن دەگەڕێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بەرازەکان لە دارستانەکە بۆ بەڕوو گەڕان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Her assistant was foraging in a cupboard for some envelopes.""",
                      kurdishText:
                          """یاریدەدەرەکەی لە دۆڵابێکدا بۆ هەندێک زەرف دەگەڕا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """We'll have to maximize home-grown forages so we can cut back on grain.""",
                      kurdishText:
                          """دەبێت ئالیکی ماڵەوە زیاد بکەین بۆ ئەوەی پشتبەستن بە گەنم کەم بکەینەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/helhqdNlWhg?t=';
const double _startSecondsend = 000000000000000000000000000186;
const String _videoIdone = 'https://youtu.be/yRmOWcWdQAo?t=';
const double _startSecondsone = 000000000000000000000000000765;
const String _videoIdtwo = 'https://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondstwo = 0000000000000000000000000007815;
const String _videoIdthree = 'https://youtu.be/Tt6WQYtefXA?t=';
const double _startSecondsthree = 0000000000000000000000000001185;
const String _videoIdfour = 'https://youtu.be/kVOTPAxrrP4?t=';
