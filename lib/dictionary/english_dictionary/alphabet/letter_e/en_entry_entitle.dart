...
class EnglishEntryentitle extends StatefulWidget {
  const EnglishEntryentitle({super.key});

  @override
  State<EnglishEntryentitle> createState() => _EnglishEntryentitleState();
}

class _EnglishEntryentitleState extends State<EnglishEntryentitle> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""entitle""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """entitle""",
                      // alsoEnglishWord: "also: entitle",
                      britshText: """IpaUK: /ɪnˈtaɪtl/""",
                      americanText: """IpaUS: /ɪnˈtaɪtl/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""You will be entitled to your pension when you reach 65.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Everyone's entitled to their own opinion.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The authorities were entitled to act as they did.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He read a poem entitled ‘Salt’.""");
  }
...
// With short examples define "entitle", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) پێدانی ماف بە کەسێک کە شتێکی هەبێت یان شتێک بکات"""),
          SentencesRow(
            englishText:
                """You will be entitled to your pension when you reach 65.""",
            kurdishText: """مافی مووچەی خانەنشینیت دەبێت کە دەبیت بە ٦٥ ساڵ.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Everyone's entitled to their own opinion.""",
            kurdishText: """هەموو کەس مافی هەبوونی بۆچوونی خۆی هەیە.""",
          ...
          SentencesRow(
            englishText:
                """Of course, he's entitled to his opinion but I think he's wrong.""",
            kurdishText:
                """بێ گومان مافی هەبوونی بۆچوونی خۆی هەیە بەڵام پێم‌وایە هەڵەیە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """بەرپرسان مافی ئەوەیان هەبوو بەو شێوەیە ڕەفتار بکەن کە کردیان.""",
            onPressedBritish: () => speaksentence4("en-GB"),
            onPressedAmerican: () => speaksentence4("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (کردار) پێدانی ناونیشانێک بە کتێبێک، شانۆیەک، هتد"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """He read a poem entitled ‘Salt’.""",
            kurdishText: """هۆنراوەیەکی بە ناونیشانی 'خوێ' خوێندەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: entitle (Derived forms: entitling, entitles, entitled)
1. Give the right to
"The Freedom of Information Act entitles you to request your FBI file"
 
2. Give a title to (= title)
 
3. Give a title to someone; make someone a member of the nobility (= ennoble, gentle [archaic])
""",
  );
...
const String _videoIdend = 'xi4wZJ-7ZCg';
const double _startSecondsend = 1066;
const String _videoIdone = 'dGpJRvawgNI';
const double _startSecondsone = 1045;
const String _videoIdtwo = 'wrQYHeodRio';
const double _startSecondstwo = 820;
const String _videoIdthree = 'RZdfE_7cde0';
const double _startSecondsthree = 272;
const String _videoIdfour = 'kWqLxTatndU';
const double _startSecondsfour = 434;
const String _videoIdfive = 'zKmeSbE9Uf4';
const double _startSecondsfive = 109;
const String _videoIdsix = '2h7fG_AyJRQ';
const double _startSecondssix = 262;
