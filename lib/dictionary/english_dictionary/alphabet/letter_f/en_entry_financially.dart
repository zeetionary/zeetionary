...
class EnglishEntryfinancially extends StatefulWidget {
  const EnglishEntryfinancially({super.key});

  @override
  State<EnglishEntryfinancially> createState() =>
      _EnglishEntryfinanciallyState();
}

class _EnglishEntryfinanciallyState extends State<EnglishEntryfinancially> {
  @override
  void initState() {
    super.initState();
...
2. Of or relating to finance or money
"He helped his daughter out financially"
""",
  );

  final String keyword = "financially";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""financially""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She is still financially dependent on her parents.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Financially, I'm much better off than before.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """financially""",
                      // alsoEnglishWord: "also: financially",
                      britshText: """IpaUK: /faɪˈnænʃəli/,  /fəˈnænʃəli/""",
                      americanText: """IpaUS: /faɪˈnænʃəli/,  /fəˈnænʃəli/""",
...
کوردی: 
"""),
// With short examples define "financially", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) کە پەیوەندیدارە بە پارە و دارایی"""),
                    SentencesRow(
                      englishText:
                          """She is still financially dependent on her parents.""",
                      kurdishText:
                          """لەباری داراییەوە هێشتا پشت بە دایبابی دەبەستێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لەباری داراییەوە، ئێستا زۆر باشترم لە پێشووتر.""",
...
const double _startSecondsend = 000000000000000000000000000286;
const String _videoIdone = 'https://youtu.be/GaDKclacCOY?t=';
const double _startSecondsone = 0000000000000000000000000001299;
const String _videoIdtwo = 'https://youtu.be/AwodL8z2EtE?t=';
const double _startSecondstwo = 000000000000000000000000000217;
const String _videoIdthree = 'https://youtu.be/lXuvGtB_LOU?t=';
const double _startSecondsthree = 000000000000000000000000000603;
const String _videoIdfour = 'https://youtu.be/qqZ_SH9N3Xo?t=';
const double _startSecondsfour = 0000000000000000000000000001149;
const String _videoIdfive = 'https://youtu.be/NEoOJ0uRskY?t=';
