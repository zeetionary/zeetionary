...
class EnglishEntrygraphic extends StatefulWidget {
  const EnglishEntrygraphic({super.key});

  @override
  State<EnglishEntrygraphic> createState() => _EnglishEntrygraphicState();
}

class _EnglishEntrygraphicState extends State<EnglishEntrygraphic> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: graphic
1. Written, drawn or engraved (- graphical, in writing)
"graphic symbols";
 
2. Describing nudity or sexual activity in graphic detail
"graphic sexual scenes"
 
3. Accurately resembling life or closely resembling the thing being represented (- lifelike, pictorial, vivid)
...
5. Relating to or presented by a graph (- graphical)
"a graphic presentation of the data";

- Noun: graphic (Derived forms: graphics)
1. An image that is generated by a computer (- computer graphic)
""",
  );

  final String keyword = "graphic";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""graphic""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He works in graphic design for a tech company.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """graphic""",
                      // alsoEnglishWord: "also: graphic",
                      britshText: """IpaUK: /ˈɡræfɪk/""",
                      americanText: """IpaUS: /ˈɡræfɪk/""",
...
// With short examples define "graphic", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) پەیوەندیدار بە دیزاین و وێنەکێشان، بە تایبەتی لە بەرهەمهێنانی کتێب، گۆڤار، وێبسایت، هتد"""),
                    SentencesRow(
                      englishText:
                          """He works in graphic design for a tech company.""",
                      kurdishText:
                          """کاری گرافیک دیزاین بۆ کۆمپانیایەکی تەکنەلۆژی دەکات.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) زۆر ڕوون و پڕ لە وردەکاری"""),
                    const AlsoEnglishckb(word: "ھەروەھا: vivid"),
                    SentencesRow(
                      englishText:
                          """This is a very graphic account of life in Victorian England.""",
                      kurdishText:
                          """ئەمە گیڕانەوەی زۆر وردی ژیانە لە سەردەمی ئینلتەرای شاژن ڤیکتۆریا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/cQOIDhZfJkA?t=';
const double _startSecondsend = 00000000000000000000000000011;
const String _videoIdone = 'https://youtu.be/dTsWYQawXRw';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/DF64yY3dZy0?t=';
const double _startSecondstwo = 00000000000000000000000000026;
const String _videoIdthree = 'https://youtu.be/Bmz72skfX4s?t=';
const double _startSecondsthree = 0000000000000000000000000003;
const String _videoIdfour = 'https://youtu.be/7Kpj8mJGIls?t=';
const double _startSecondsfour = 0000000000000000000000000006;
const String _videoIdfive = 'https://youtu.be/OA0dB6rmhPc';
