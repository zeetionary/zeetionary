...
class EnglishEntryfreak extends StatefulWidget {
  const EnglishEntryfreak({super.key});

  @override
  State<EnglishEntryfreak> createState() => _EnglishEntryfreakState();
}

class _EnglishEntryfreakState extends State<EnglishEntryfreak> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: freak (Derived forms: freaks)
1. A person or animal that is markedly unusual or deformed (= monster, monstrosity, lusus naturae)
 
2. Someone who is so ardently devoted to something that it resembles an addiction (= addict, nut [informal], junkie [informal], junky [informal])
"a bodybuilding freak";

- Verb: freak (Derived forms: freaks, freaked, freaking)
1. Lose one's nerve (= freak out [informal], gross out [informal])
"When he saw the accident, he freaked out";
""",
  );

  final String keyword = "freak";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I'm such a neat freak that I clean up after other people.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """In his teens he was a computer freak and stayed in his room all day.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I felt such a freak in my strange clothes.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""By some freak of fate they all escaped without injury.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The manager described the 8–0 defeat as a freak result.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Snakes really freak me out.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""My parents really freaked when they saw my hair.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """freak""",
                      // alsoEnglishWord: "also: freak",
                      britshText: """IpaUK: /friːk/""",
                      americanText: """IpaUS: /friːk/""",
...
کوردی: مرۆی سەیر، مرۆی نائاسایی،	گیانەوەر یان ڕووەکی سەیر و نائاسایی،	لایەنگر، کوشتەومردە، سەوداسەر، بۆمردوو،	ڕووداوی نائاسایی، ڕووداوی چاوەڕوان‌نەکراو،	کار یان کردەوەی نائاسایی،	بێزوو، کەڵکەڵە، ئارەزوو، مەراق، هەوەس، نگە،	تاوتاوی، ڕاڕایی، وازی‌وازێتی
"""),
// With short examples define "freak", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) کەسێک کە حەزێکی زۆری بۆ شتێک هەیە"""),
                    SentencesRow(
                      englishText:
                          """I'm such a neat freak that I clean up after other people.""",
                      kurdishText:
                          """زۆر کەسێکی هۆگر بە پاکوخاوێنی کە هەموو شت پاکدەکەمەوە دوای کەسانی دیکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """In his teens he was a computer freak and stayed in his room all day.""",
                      kurdishText:
                          """لە کاتی گەنجێتییدا هۆگری تەواو بە کۆمپیوتەر بوو و هەموو ڕۆژ لە ژوورەکەی دەمایەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) کەسێک کە بە نامۆ دادەنرێت بەهۆی شێوازی دەرکەوتن، بیرکردنەوە، یان ڕەفتاری"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She was treated like a freak because she didn't want children.""",
                      kurdishText:
                          """وەک مرۆڤێکی سەیر دەبینرا بەهۆی ئەوەی منداڵی نەدەویست.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەستم بە کەسێکی سەیر دەکرد بە جلە سەمەرەکانمەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """This butterfly is a freak of nature, black and white instead of blue.""",
                      kurdishText:
                          """ئەم پەپوولەیە دەعبای سرووشتە، ڕەش و سپییە وەک ئەوەی شین بێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە ڕووداوێکی چاوەڕوان‌نەکراو هەموویان بەبێ برین ڕزگاریان بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕاهێنەرەکە دۆڕانی ٨ - ٠ ـی بە ئەنجامێکی  چاوەڕوان‌نەکراو باسکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دایبابم تاسان کە قژمیان بینی.""",
...
const double _startSecondsend = 000000000000000000000000000170;
const String _videoIdone = 'https://youtu.be/_wNsZEqpKUA?t=';
const double _startSecondsone = 000000000000000000000000000114;
const String _videoIdtwo = 'https://youtu.be/Cxqca4RQd_M?t=';
const double _startSecondstwo = 000000000000000000000000000472;
