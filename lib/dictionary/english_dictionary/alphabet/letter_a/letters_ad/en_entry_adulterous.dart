...
class EnglishEntryadulterous extends StatelessWidget {
  EnglishEntryadulterous({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "adulterous", // DOPSUM: CHANGE WORD ENTRY - Find /əˈdʌltərəs/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈdʌltərəs/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
