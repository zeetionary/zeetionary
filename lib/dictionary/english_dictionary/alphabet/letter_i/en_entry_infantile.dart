...
class EnglishEntryinfantile extends StatefulWidget {
  const EnglishEntryinfantile({super.key});

  @override
  State<EnglishEntryinfantile> createState() => _EnglishEntryinfantileState();
}

class _EnglishEntryinfantileState extends State<EnglishEntryinfantile> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: infantile
1. Indicating a lack of maturity (- childish)
"infantile behaviour";
 
2. Being, befitting or characteristic of an infant
"infantile games"
...
""",
  ...
  final String keyword = "infantile";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infantile""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Don't be so infantile.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They laughed at the infantile jokes like little kids.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/qDVZ9Z6BhyY?t=';
    const double startSecondsone = 00000000000000000000000000023;
    const String videoIdtwo = 'https://youtu.be/ptI6BRVC1Kw?t=';
    const double startSecondstwo = 000000000000000000000000000220;
    const String videoIdthree = 'https://youtu.be/buhewZznrzA?t=';
    const double startSecondsthree = 000000000000000000000000000268;
    const String videoIdfour = 'https://youtu.be/E-VoKwMDdLg?t=';
    const double startSecondsfour = 000000000000000000000000000414;
    const String videoIdfive = 'https://youtu.be/qjG5q2VwNh8?t=';
    const double startSecondsfive = 000000000000000000000000000534;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """infantile""",
                      // alsoEnglishWord: "also: infantile",
                      britshText: """IpaUK: /ˈɪnfəntaɪl/""",
                      americanText: """IpaUS: /ˈɪnfəntaɪl/""",
...
کوردی: مناڵانە، سەربە مناڵان یان (سەردەمی) مناڵی،	سەرەتایی
"""),
// With short examples define "infantile", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە لە منداڵێکی بچووک چاوەڕێ دەکرێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: childish"),
                    SentencesRow(
                      englishText: """Don't be so infantile.""",
                    ...
                    SentencesRow(
                      englishText:
                          """They laughed at the infantile jokes like little kids.""",
                      kurdishText:
                          """وەک منداڵ پێکەنین بە نوکتە منداڵانەکان.""",
