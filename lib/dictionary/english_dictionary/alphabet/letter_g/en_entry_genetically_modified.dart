...
class EnglishEntrygeneticallymodified extends StatefulWidget {
  const EnglishEntrygeneticallymodified({super.key});

  @override
  State<EnglishEntrygeneticallymodified> createState() =>
      _EnglishEntrygeneticallymodifiedState();
}

class _EnglishEntrygeneticallymodifiedState
    extends State<EnglishEntrygeneticallymodified> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "genetically modified";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""genetically modified""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They tested genetically modified animals in the lab.""");
  }
...
const double _startSecondsone = 000000000000000000000000000847;
const String _videoIdtwo = 'https://youtu.be/Zh4c5IrllBg?t=';
const double _startSecondstwo = 000000000000000000000000000178;
const String _videoIdthree = 'https://youtu.be/DO5x_tJBn7w?t=';
const double _startSecondsthree = 000000000000000000000000000898;
const String _videoIdfour = 'https://youtu.be/-KJ9XsnU_sk?t=';
const double _startSecondsfour = 000000000000000000000000000417;
const String _videoIdfive = 'https://youtu.be/h-x7M-anEA0?t=';
