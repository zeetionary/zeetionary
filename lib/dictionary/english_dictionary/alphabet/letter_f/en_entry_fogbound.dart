...
class EnglishEntryfogbound extends StatefulWidget {
  const EnglishEntryfogbound({super.key});

  @override
  State<EnglishEntryfogbound> createState() => _EnglishEntryfogboundState();
}

class _EnglishEntryfogboundState extends State<EnglishEntryfogbound> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fogbound""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She spent hours fogbound in Brussels.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fogbound""",
                      // alsoEnglishWord: "also: fogbound",
                      britshText: """IpaUK: /ˈfɒɡbaʊnd/""",
                      americanText: """IpaUS: /ˈfɑːɡbaʊnd/""",
...
// With short examples define "fogbound", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە بەهۆی تەمەوە ناتوانێت کار بکات"""),
                    SentencesRow(
                      englishText: """She spent hours fogbound in Brussels.""",
                      kurdishText:
                          """چەندین کاتژمێری لە برۆکسڵ بەسەربرد لەبەر تەم گیرکردووی .""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ELC_e2QBQMk?t=';
const double _startSecondsend = 0000000000000000000000000001098;
const String _videoIdone = 'https://youtu.be/sqY2XIZ5pi0?t=';
const double _startSecondsone = 0000000000000000000000000001190;
const String _videoIdtwo = 'https://youtu.be/RGkFvs4mHlY?t=';
const double _startSecondstwo = 0000000000000000000000000002096;
const String _videoIdthree = 'https://youtu.be/bcr81g9oHIk?t=';
const double _startSecondsthree = 000000000000000000000000000178;
const String _videoIdfour = 'https://youtu.be/o-epAIeHQH8?t=';
const double _startSecondsfour = 00000000000000000000000000041300;
const String _videoIdfive = 'https://youtu.be/wcXHWbIVQk8?t=';
const double _startSecondsfive = 0000000000000000000000000002501;
