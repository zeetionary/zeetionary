...
کوردی: دیم، دەم‌وچاو، ڕوخسار، بیچم، قیافە، دیمە، شێوە،	تایبەتمەندی، لایەنی دیار، ڕەوشت، درووڤ، خەسڵەت، جیاکەرەوە، چۆنیەتی،	وتاری تایبەتی و گرنگ،	فیلمی درێژ، فیلمی سەرەکی،	بەرنامەی تایبەتی یان گرنگ (تەلەفزیۆن، ڕادیۆ و هتد)،	نیشانەی تایبەت،	بەشی سەرەکی، بابەتی سەرەکی یان تایبەتی،	(وەک ئاوەڵناو) سەرەکی
"""),
          ...
          SentencesRow(
            ...
            kurdishText:
                """کارکردن بە تیم تایبەتمەندیی سەرەکی پڕۆگرامی ڕاهێنانەکەیە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """هەندێک تایبەتمەندیی تازەم بۆ وێبسایتەکەم زیاد کردووە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """بۆ چی تایبەتمەندییەک دەگەڕێیت لەکاتی هەڵبژاردنی ئۆتۆمبێلێک.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """نەرمامێرەکە هیچ تایبەتمەندییەکی جیاکەرەوەی تایبەتی نییە.""",
          ...
          SentencesRow(
            englishText:
                """He took me around our new offices, pointing out all the salient features.""",
            kurdishText:
                """بە ئۆفیسە تازەکانمان گڕی دام و هەموو تایبەتمەندییە سەرەکییەکانی پیشان دام.""",
          ...
          SentencesRow(
            ...
            kurdishText: """بیچمی گونجاوی هەیە بۆ ڕۆڵەکە.""",
          ...
          SentencesRow(
            englishText:
                """In today's programme we have a special feature on education.""",
            kurdishText:
                """لە پڕۆگرامی ئەمڕۆدا فیچەرێکمان هەیە لەسەر پەروەردە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """وتاری تایبەتی ورد هەیە لەسەر هەموو بابەتێک.""",
            onPressedBritish: () => speaksentence10("en-GB"),
            onPressedAmerican: () => speaksentence10("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٤. (کردار) هەبوون وەک تایبەتمەندییەک"""),
          const DividerSentences(),
          SentencesRow(
          ...
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٥. (کردار) هەبوونی بەشێکی گرنگ لە شتێکدا"""),
          const DividerSentences(),
          SentencesRow(
          ...
          SentencesRow(
            ...
            kurdishText:
                """زەیتی زەیتوون و سیر بە بەرفراوانی لە ڕەچەتەکەنیدا هەن.""",
...
const double _startSecondsone = 000000000000000000000000000136;
const String _videoIdtwo = 'https://youtu.be/tsxmyL7TUJg?t=';
const double _startSecondstwo = 0000000000000000000000000001048;
const String _videoIdthree = 'https://youtu.be/CXvG2CBJ3SE?t=';
const double _startSecondsthree = 000000000000000000000000000582;
const String _videoIdfour = 'https://youtu.be/dtp6b76pMak?t=';
const double _startSecondsfour = 0000000000000000000000000001241;
const String _videoIdfive = 'https://youtu.be/pTysrwci0pU?t=';
const double _startSecondsfive = 00000000000000000000000000049;
