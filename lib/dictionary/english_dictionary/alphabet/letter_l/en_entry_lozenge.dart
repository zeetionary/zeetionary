...
class EnglishEntrylozenge extends StatefulWidget {
  const EnglishEntrylozenge({super.key});

  @override
  State<EnglishEntrylozenge> createState() => _EnglishEntrylozengeState();
}

class _EnglishEntrylozengeState extends State<EnglishEntrylozenge> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylozenge lozenge
WORD_WEB lozenge lozenge lozenge
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lozenge";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lozenge""");
  }
...
کوردی: 
"""),
// With short examples define "lozenge", please follow LX instructions
