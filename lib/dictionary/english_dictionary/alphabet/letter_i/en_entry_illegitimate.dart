...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000740;
    const String videoIdone = 'https://youtu.be/LYUdnsIn5OU?t=';
    const double startSecondsone = 000000000000000000000000000572;
    const String videoIdtwo = 'https://youtu.be/zVqFAMOtwaI?t=';
    const double startSecondstwo = 000000000000000000000000000524;
    const String videoIdthree = 'https://youtu.be/3yvxFFsjcYs?t=';
    const double startSecondsthree = 000000000000000000000000000544;
    const String videoIdfour = 'https://youtu.be/96BhTy93MN0?t=';
    const double startSecondsfour = 000000000000000000000000000622;
    const String videoIdfive = 'https://youtu.be/1Y0F7zZ_Ws0?t=';
    const double startSecondsfive = 000000000000000000000000000779;
