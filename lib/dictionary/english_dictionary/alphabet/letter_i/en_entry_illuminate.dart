...
class EnglishEntryilluminate extends StatefulWidget {
  const EnglishEntryilluminate({super.key});

  @override
  State<EnglishEntryilluminate> createState() => _EnglishEntryilluminateState();
}

class _EnglishEntryilluminateState extends State<EnglishEntryilluminate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: illuminate (Derived forms: illuminated, illuminates, illuminating)
1. Introduce light into (- light, illume, illumine, light up)
 
2. Make free from confusion or ambiguity; make clear (- clear, clear up, shed light on, crystallize, crystallise [Brit], crystalize, crystalise [Brit], straighten out, sort out, enlighten, elucidate)
 
3. (art) add embellishments and paintings to (medieval manuscripts)
""",
  );

  final String keyword = "illuminate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""illuminate""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The earth is illuminated by the sun.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The red glow of the sun beautifully illuminated the sky.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""This text illuminates the philosopher's early thinking.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""His explanation obscured more than it illuminated.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000660;
    const String videoIdone = 'https://youtu.be/KT18KJouHWg?t=';
    const double startSecondsone = 000000000000000000000000000978;
    const String videoIdtwo = 'https://youtu.be/ugYPoWShl6k?t=';
    const double startSecondstwo = 000000000000000000000000000430;
    const String videoIdthree = 'https://youtu.be/kBdfcR-8hEY?t=';
    const double startSecondsthree = 0000000000000000000000000001024;
    const String videoIdfour = 'https://youtu.be/BlU49dJhfcw?t=';
    const double startSecondsfour = 000000000000000000000000000240;
    const String videoIdfive = 'https://youtu.be/ih8ex84QoH4?t=';
    const double startSecondsfive = 000000000000000000000000000545;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """illuminate""",
                      // alsoEnglishWord: "also: illuminate",
                      britshText: """IpaUK: /ɪˈluːmɪneɪt/""",
                      americanText: """IpaUS: /ɪˈluːmɪneɪt/""",
...
کوردی: 
"""),
// With short examples define "illuminate", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) ڕووناککردنەوەی شتێک"""),
                    SentencesRow(
                      englishText: """The earth is illuminated by the sun.""",
                      kurdishText: """زەوی لەلایەن خۆرەوە ڕووناک دەکرێتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕۆشناییە سوورەکەی خۆر بە جوانی ئاسمانی ڕووناک کردبوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) ئەوەی شتێک ڕوون بکەیتەوە یان ئاسانتر بێت بۆ تێگەشتن"""),
                    const AlsoEnglishckb(word: "ھەروەھا: clarify"),
                    SentencesRow(
                      englishText:
                          """This text illuminates the philosopher's early thinking.""",
                      kurdishText:
                          """ئەم نووسینە بیرکردنەوەی سەرەتای فەیلەسووفەکە ڕوون دەکاتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕوونکردنەوەکەی زیاتر سەرلێشێوانی درووست کرد وەک لە ڕوونکردنەوە.""",
