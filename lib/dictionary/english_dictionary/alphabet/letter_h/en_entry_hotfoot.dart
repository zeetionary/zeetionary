...
class EnglishEntryhotfoot extends StatefulWidget {
  const EnglishEntryhotfoot({super.key});

  @override
  State<EnglishEntryhotfoot> createState() => _EnglishEntryhotfootState();
}

class _EnglishEntryhotfootState extends State<EnglishEntryhotfoot> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hotfoot (Derived forms: hotfoots)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hotfoot""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He had just arrived hotfoot from London.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/mYyfb1Pfu-8?t=';
    const double startSecondsend = 000000000000000000000000000814;
    const String videoIdone = 'https://youtu.be/tVnLt-wpccQ?t=';
    const double startSecondsone = 000000000000000000000000000431;
    const String videoIdtwo = 'https://youtu.be/t1wqWgXoP60?t=';
    const double startSecondstwo = 000000000000000000000000000192;
    const String videoIdthree = 'https://youtu.be/4UepSzIaFAc?t=';
    const double startSecondsthree = 00000000000000000000000000021;
    const String videoIdfour = 'https://youtu.be/D0zk4tLSWcU?t=';
    const double startSecondsfour = 000000000000000000000000000387;
    const String videoIdfive = 'https://youtu.be/jXily5oSkY4?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hotfoot""",
                      // alsoEnglishWord: "also: hotfoot",
                      britshText: """IpaUK: /ˈhɒtfʊt/""",
                      americanText: """IpaUS: /ˈhɑːtfʊt/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تازە بە پەلە گەشتبووە لەندەن.""",
