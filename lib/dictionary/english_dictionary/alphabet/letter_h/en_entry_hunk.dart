...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'CJUKVmkRx_E';
    const double startSecondsend = 176;
    const String videoIdone = 'W2hRTTTpmr8';
    const double startSecondsone = 615;
    const String videoIdtwo = 'BfgQoeHyfms';
    const double startSecondstwo = 529;
    const String videoIdthree = 'lsbcN9-jU1Y';
    const double startSecondsthree = 283;
    const String videoIdfour = 'IesIsKMjB4Y';
    const double startSecondsfour = 109;
    const String videoIdfive = '0yv6smozK9M';
    const double startSecondsfive = 479;
