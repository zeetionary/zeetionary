...
class EnglishEntryflour extends StatefulWidget {
  const EnglishEntryflour({super.key});

  @override
  State<EnglishEntryflour> createState() => _EnglishEntryflourState();
}

class _EnglishEntryflourState extends State<EnglishEntryflour> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flour (Derived forms: flours)
1. Fine powdery foodstuff obtained by grinding and sifting the meal of a cereal grain
 
2. A powder of any material
"wood flour produced by sanding wood"

- Verb: flour (Derived forms: flours, floured, flouring)
1. (cooking) cover with flour
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Sift the flour and salt into a bowl.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Rub the butter into the flour.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Roll the dough on a lightly floured surface.""");
  }
...
// With short examples define "flour", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئارد و خوێ تێکەڵ بە جامێک بکە.""",
                    ...
                    SentencesRow(
                      englishText: """Rub the butter into the flour.""",
                      kurdishText: """کەرەکە بساوە ناو ئاردەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Blend the flour with a little milk to make a smooth paste.""",
                      kurdishText:
                          """ئاردەکە لەگەڵ کەمێک شیر تێکەڵ بکە بۆ درووستکردنی هەویرێکی نەرم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەویرەکە بڵاوبکەرەوە بەسەر ڕوویەک کە کەمێک ئاردی پێدا کراوە.""",
                      englishNote:
                          """This means to flatten and stretch the dough on a surface that has been lightly dusted with flour.""",
...
const String _videoIdthree = 'https://youtu.be/vzKuobmi3iI?t=';
const double _startSecondsthree = 00000000000000000000000000024;
const String _videoIdfour = 'https://youtu.be/olHw-8py9K0?t=';
const double _startSecondsfour = 00000000000000000000000000012;
const String _videoIdfive = 'https://youtu.be/LoqwZBkYWqE?t=';
const double _startSecondsfive = 00000000000000000000000000051;
