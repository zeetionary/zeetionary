...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '2fOWFfpLYW0';
    const double startSecondsend = 893;
    const String videoIdone = 'Ap50PaMyias';
    const double startSecondsone = 187;
    const String videoIdtwo = '0e8woEkKmG8';
    const double startSecondstwo = 421;
    const String videoIdthree = 'zEXXe9Ef_R8';
    const double startSecondsthree = 647;
    const String videoIdfour = 'XXVXmR6j3Kc';
    const double startSecondsfour = 673;
    const String videoIdfive = 'zrLleFetY_Y';
    const double startSecondsfive = 584;
