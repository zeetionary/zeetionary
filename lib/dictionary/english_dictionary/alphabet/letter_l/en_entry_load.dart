...
class EnglishEntryload extends StatefulWidget {
  const EnglishEntryload({super.key});

  @override
  State<EnglishEntryload> createState() => _EnglishEntryloadState();
}

class _EnglishEntryloadState extends State<EnglishEntryload> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryload load
WORD_WEB load load load
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "load";
...
کوردی: 
"""),
// With short examples define "load", please follow LX instructions
