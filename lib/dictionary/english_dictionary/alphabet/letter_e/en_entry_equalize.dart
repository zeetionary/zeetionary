...
class EnglishEntryequalize extends StatefulWidget {
  const EnglishEntryequalize({super.key});

  @override
  State<EnglishEntryequalize> createState() => _EnglishEntryequalizeState();
}

class _EnglishEntryequalizeState extends State<EnglishEntryequalize> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""equalize""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equalize""",
                      // alsoEnglishWord: "also: equalize",
                      britshText: """IpaUK: /ˈiːkwəlaɪz/""",
                      americanText: """IpaUS: /ˈiːkwəlaɪz/""",
...
کوردی: هاوسەنگ کردن، بەرابەربوون بە
"""),
          const DefinitionKurdish(
              text: """١. (کردار) هاوتاکردنی شت لە قەبارە، پێگە، هتد"""),
          SentencesRow(
            englishText:
                """They are putting pressure on the government to equalize state pension ages between men and women.""",
            kurdishText:
                """فشار دەخەنە سەر حکومەت تاوەکو تەمەنی خانەنشینی ویلایەتەکان لە نێوان ژنان و پیاوان هاوتا بکات.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (کردار) یەکسان کردنی گۆڵ لە یاریدا"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Kane equalized early in the second half.""",
            kurdishText:
                """کەین بەزووی لە گێمی دووەمدا یەکسانکردنەوەی ئەنجام دا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: equalize (Derived forms: equalizes, equalized, equalizing)
1. Compensate; make the score equal (= equalise [Brit], get even)
 
2. Make equal, uniform, corresponding, or matching (= equal, match, equalise [Brit], equate)
...
const double _startSecondsend = 000000000000000000000000000000; // 438;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/hOUGNGWmN0k?t=';
const double _startSecondsone = 00000000000000000000000000000; // 282;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/UYEyhB0AGlw?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 661;
const String _videoIdthree = 'VIDEOhttps://youtu.be/WpN4cgAAhLQ?t=';
const double _startSecondsthree = 000000000000000000000000000; // 166;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/uH9A-7Y3lL0?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 245;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/rgY7j-ulcyo?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 33;
