...
class EnglishEntryincrement extends StatefulWidget {
  const EnglishEntryincrement({super.key});

  @override
  State<EnglishEntryincrement> createState() => _EnglishEntryincrementState();
}

class _EnglishEntryincrementState extends State<EnglishEntryincrement> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""increment""");
  }
