...
class EnglishEntryintercity extends StatefulWidget {
  const EnglishEntryintercity({super.key});

  @override
  State<EnglishEntryintercity> createState() => _EnglishEntryintercityState();
}

class _EnglishEntryintercityState extends State<EnglishEntryintercity> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intercity""");
  }
