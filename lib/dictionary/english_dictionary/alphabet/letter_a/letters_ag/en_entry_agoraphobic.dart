...
// replace these: replace EnglishEntryagoraphobic - replace speakAgoraphobic - replace agoraphobic - /ˌæɡərəˈfəʊbɪk/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryagoraphobic extends StatelessWidget {
  EnglishEntryagoraphobic({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌæɡərəˈfəʊbɪk/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'I_j1wMoSxjg';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'AlCD_EAGEkM';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'v_0GJg_Jnlo';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'AqlkPJH_on4';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'JwB9V34Cg_Y';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'VHcDcjakdJQ';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'v0AqyJWiIrc';
