...
// replace these: EnglishEntryabsorption - speakAbsorption - absorption - /əbˈzɔːpʃn/

enum TtsState { playing }

class EnglishEntryabsorption extends StatelessWidget {
  EnglishEntryabsorption({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'absorption', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əbˈzɔːpʃn/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'H3_mVryqXpU';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = '72p58Iy6u7M';
