...
class EnglishEntryhay extends StatefulWidget {
  const EnglishEntryhay({super.key});

  @override
  State<EnglishEntryhay> createState() => _EnglishEntryhayState();
}

class _EnglishEntryhayState extends State<EnglishEntryhay> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hay (Derived forms: hays)
1. Grass mowed and cured for use as fodder

- Verb: hay (Derived forms: hays, hayed, haying)
1. Convert (plant material) into hay
""",
  );

  final String keyword = "hay";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The children were playing in the hay.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They make hay to feed the cattle in winter.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hay""",
                      // alsoEnglishWord: "also: hay",
                      britshText: """IpaUK: /heɪ/""",
                      americanText: """IpaUS: /heɪ/""",
...
کوردی: گزرە، پووش، کا، پەڵاش، هەڵیس، وشکەگیا، هەلیز
"""),
// With short examples define "hay", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) گیا کە بڕدراوە و وشککراوە، و وەک خواردنی ئاژەڵ بەکاردێت"""),
                    SentencesRow(
                      englishText: """The children were playing in the hay.""",
                      kurdishText: """منداڵەکان لە پەڵاشەکەدا یارییان دەکرد.""",
                    ...
                    SentencesRow(
                      englishText: """They make hay to feed the cattle in winter.""",
                      kurdishText: """کا درووست دەکەن بۆ تێرکردنی ڕەشەوڵاخەکان لە زستاندا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/kb8VTymT4mg';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/Xz0_VNAbXv8?t=';
const double _startSecondsone = 00000000000000000000000000025;
const String _videoIdtwo = 'https://youtu.be/aT9Mikm58gY?t=';
const double _startSecondstwo = 00000000000000000000000000038;
const String _videoIdthree = 'https://youtu.be/A6kUGRhDmNs';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/DNsZvG_nOaQ?t=';
const double _startSecondsfour = 0000000000000000000000000002;
const String _videoIdfive = 'https://youtu.be/-rf-Wjqqvuw?t=';
