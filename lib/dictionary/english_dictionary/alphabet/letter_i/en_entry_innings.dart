...
class EnglishEntryinnings extends StatefulWidget {
  const EnglishEntryinnings({super.key});

  @override
  State<EnglishEntryinnings> createState() => _EnglishEntryinningsState();
}

class _EnglishEntryinningsState extends State<EnglishEntryinnings> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryinnings innings
WORD_WEB innings innings innings
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "innings";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""innings""");
  }
...
کوردی: 
"""),
// With short examples define "innings", please follow LX instructions
