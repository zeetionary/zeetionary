                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːftər ɪfekt/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final double _startSeconds = 3007;
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'TZKhK5uA-v4';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'cpE_s5K4J4g';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'RSfCWAClNmM';
  final double _startSeconds = 1653;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'NJunwbvkzAU';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'bAkuNXtgrLA';
  final double _startSeconds = 2538;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'LCEsoH1F-Us';
