...
class EnglishEntrytheaccused extends StatelessWidget {
  EnglishEntrytheaccused({super.key});
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 3, // 2 + VIDEOS FIND: KURDISHH
      child: Scaffold(
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "the accused"), // Find /ði əˈkjuːzd/
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ði əˈkjuːzd/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakTheaccused("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            CustomIconButtonAmerican(
                              onPressed: () => speakTheaccused("en-US"),
                            ),
                          ],
                        ),
                      ],
