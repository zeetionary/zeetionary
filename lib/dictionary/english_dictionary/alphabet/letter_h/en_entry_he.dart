...
class EnglishEntryhe extends StatefulWidget {
  const EnglishEntryhe({super.key});

  @override
  State<EnglishEntryhe> createState() => _EnglishEntryheState();
}

class _EnglishEntryheState extends State<EnglishEntryhe> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Pronoun: he
1. Objective male pronoun, used to refer to a male human or animal
"he is a painter"
 
2. He or she; generic third person singular pronoun, used to refer to a person or animal of either sex (this sense of 'he' is regarded as politically incorrect in some circles) (- they)
"when you do find someone he will have a tough time catching up";

- Noun: he (Derived forms: hes)
1. The 5th letter of the Hebrew alphabet

- Noun: He
1. A very light colourless element that is one of the six inert gasses; the most difficult gas to liquefy; occurs in economically extractable amounts in certain natural gases (as those found in Texas and Kansas) (- helium, atomic number 2)
""",
  );

  final String keyword = "he";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He went through that door.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The police suspect that he had an accomplice.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""When my name was called, he looked across at me.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Every child needs to know that he is loved.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He who hesitates is lost.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What a nice dog—is it a he or a she?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """he""",
                      // alsoEnglishWord: "also: he",
                      britshText:
                          """IpaUK: /hi/, /iː/, /i/, strong form /hiː/""",
                      americanText:
                          """IpaUS: /hi/, /iː/, /i/, strong form /hiː/""",
...
کوردی: 
"""),
// With short examples define "he", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (جێناو) مرۆڤ یان ئاژەڵێکی نێرینە کە پێشوەختە باسکراوە یان بە ئاسانی دەناسرێتەوە"""),
                    SentencesRow(
                      englishText:
                          """He (= the man we are watching) went through that door.""",
                      kurdishText: """پیاوەکە بەو دەرگایەدا چووە ژوورەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "پۆلیس گومان دەکەن کە ھاودەستێکی ھەبووبێت.",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (جێناو) کەسێک کە ئاماژە بە ڕەگەزی نەکراوە یان نازانرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Every child needs to know that he is loved.""",
                      kurdishText: """هەموو منداڵێک دەبێت بزانرێت کە خۆشویستراوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He who (= anyone who) hesitates is lost.""",
                      kurdishText: """ئەوەی پەلە بکات دۆڕاوە.""",
                      onPressedBritish: () => speaksentence10("en-GB"),
                      onPressedAmerican: () => speaksentence10("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) نێرینەیەک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """What a nice dog—is it a he or a she?""",
                      kurdishText: """چی سەگێکی جوانە ـ نێرە یان مێیە؟""",
...
const double _startSecondsone = 000000000000000000000000000285;
const String _videoIdtwo = 'https://youtu.be/wizgxRBfVTY?t=';
const double _startSecondstwo = 00000000000000000000000000014;
const String _videoIdthree = 'https://youtu.be/r8E1Hq5tktg?t=';
const double _startSecondsthree = 00000000000000000000000000025;
const String _videoIdfour = 'https://youtu.be/Ht0IbFNbfSY?t=';
const double _startSecondsfour = 000000000000000000000000000222;
const String _videoIdfive = 'https://youtu.be/2TUGZ1VQDss?t=';
const double _startSecondsfive = 000000000000000000000000000256;
