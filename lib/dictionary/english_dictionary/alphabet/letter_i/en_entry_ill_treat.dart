...
class EnglishEntryilltreat extends StatefulWidget {
  const EnglishEntryilltreat({super.key});

  @override
  State<EnglishEntryilltreat> createState() => _EnglishEntryilltreatState();
}

class _EnglishEntryilltreatState extends State<EnglishEntryilltreat> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: ill-treat (Derived forms: ill-treated, ill-treating, ill-treats)
1. Treat badly (- mistreat, maltreat, abuse, ill-use, step on [informal])
"This boss ill-treats his workers";
""",
  );

  final String keyword = "ill-treat";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ill-treat""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The child had been severely ill-treated by his parents.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/hC8A5-_RvZI?t=';
    const double startSecondsend = 00000000000000000000000000069;
    const String videoIdone = 'https://youtu.be/95F1k6YIh80?t=';
    const double startSecondsone = 000000000000000000000000000737;
    const String videoIdtwo = 'https://youtu.be/CDxFPGHk9Vw?t=';
    const double startSecondstwo = 0000000000000000000000000001578;
    const String videoIdthree = 'https://youtu.be/1m5_rxrpsL4?t=';
    const double startSecondsthree = 000000000000000000000000000160;
    const String videoIdfour = 'https://youtu.be/CKYw_RG7i7w?t=';
    const double startSecondsfour = 000000000000000000000000000603;
    const String videoIdfive = 'https://youtu.be/WUVdAyZTsGI?t=';
    const double startSecondsfive = 000000000000000000000000000640;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ill-treat""",
                      // alsoEnglishWord: "also: ill-treat",
                      britshText: """IpaUK: /ˌɪl ˈtriːt/""",
                      americanText: """IpaUS: /ˌɪl ˈtriːt/""",
...
کوردی: 
"""),
// With short examples define "ill-treat", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) مامەڵەکردن بە خراپی و دڕندانە بەرامبەر کەسێک"""),
                    SentencesRow(
                      englishText:
                          """The child had been severely ill-treated by his parents.""",
                      kurdishText:
                          """منداڵەکە زۆر خراپ دڕندانە مامەڵەی لەگەڵ کرابوو لەلایەن دایبابی.""",
