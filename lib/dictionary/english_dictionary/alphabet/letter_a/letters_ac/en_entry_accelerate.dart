...
class EnglishEntryaccelerate extends StatefulWidget {
  const EnglishEntryaccelerate({super.key});

  @override
  State<EnglishEntryaccelerate> createState() => _EnglishEntryaccelerateState();
}

class _EnglishEntryaccelerateState extends State<EnglishEntryaccelerate> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "accelerate";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accelerate""",
                      // alsoEnglishWord: "also: accelerate",
                      britshText: """IpaUK: /əkˈseləreɪt/""",
                      americanText: """IpaUS: /əkˈseləreɪt/""",
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'KY6SOHA1tH4';
