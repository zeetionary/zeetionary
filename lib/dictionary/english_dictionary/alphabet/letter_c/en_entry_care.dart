...
class EnglishEntrycare extends StatelessWidget {
  ...
  Future<void> speakcares8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She chose her words with care."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcares9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Transporting an atomic bomb requires great care."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcares10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I felt free from the cares of the day as soon as I left the building."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcares11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Sam looked as if he didn't have a care in the world."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcares12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I don't care if I never see him again!"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcares13(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He threatened to fire me, as if I cared!"); // DOPSUM: CHANGE TEXT
  }
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She cares deeply about environmental issues."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcares15(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I don't really care about how much it costs."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcares16(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He genuinely cares about his employees."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcares17(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("They care an awful lot about each other."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcares18(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I've done this job more times than I care to remember."); // DOPSUM: CHANGE TEXT
  }
...
کوردی: ئاگاداری، وریایی، هۆشیاری، ئاگالێ‌بوون، بەدیارەوەبوون، چاوبەسەرەوەبوون، لەبەرچاوگرتن، بەتەنگەوەبوون، بیر(لابوون)، دڵ(لابوون)، لالێ‌دانەوە، سەرنج، وردبوونەوە، لێ‌خوردبوونەوە، چاودێری، دڵەڕاوکە، دڵەکورکە، نگەرانی، دڵ‌لەدوایی، بەرپرسایەتی
...
١. (ناو) چاودێریکردنی کەسێک یان شتێک و پێدانی ئەوەی پێویستیانە"""),
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    ExampleSentenceKurdish(
                                        text:
                                            "هەندێک کەس بە خراپی برینداربوون و پێویستیان بە چاودێریی تەندرووستی."),
                                  ],
                                ),
                              ),
                                      ...
                                      const Expanded(
                                        child: Column(
                                          children: [
                                            ...
                                            ExampleSentenceKurdish(
                                                text:
                                                    "منداڵەکان لەژێر چاودێریی دراوسێیەک جێهێڵدران."),
                                          ],
                                        ),
                                      ),
                                      const CustomSizedBoxForTTS(),
                          ...
                          const DefinitionKurdish(
                              text:
                                  "٣. (ناو) ئەو سەرنجەی کە بە شتێکی دەدەیت بۆ ئەوەی بە باشی و بێ هەڵە بیکەیت"),
                          Row(
                            children: [
                              const Expanded(
                                child: Column(
                                  children: [
                                    ...
                                    ExampleSentenceKurdish(
                                        text: "وریایی زۆر پێویستە کە ئۆتۆمبێلێکی دەستی دوو دەکڕیت."),
                                  ],
                                ),
                              ),
                              const CustomSizedBoxForTTS(),
                          ...
                          ExampleSentenceKurdish(
                          text: "بە وریاییەوە وشەکانی هەڵبژارد."),
                          ],
                          ),
                          ),
                          const CustomSizedBoxForTTS(),
                          ...
                          ExampleSentenceKurdish(
                          text: "گواستنەوەی چەکێکی ئەتۆمی پێویستی بە چاودێری زۆر هەیە."),
                          ],
                          ),
                          ),
                          const CustomSizedBoxForTTS(),
                          ...
                          const DividerDefinition(),
                          const DefinitionKurdish(text: "٤. (ناو) هەستی نیگەرانی"),
                          Row(
                          children: [
                          const Expanded(
                          child: Column(
                          ...
                          ExampleSentenceKurdish(
                          text: "هەرکە بیانکەم جێهێشت هەموو نیگەرانی ڕۆژەکەم بیرچوو."),
                          ],
                          ),
                          ),
                          const CustomSizedBoxForTTS(),
                          ...
                          ExampleSentenceKurdish(
                          text: "سام وادیاربوو کە هیچ خەمێکی لە دونیادا نەبێت."),
                          ],
                          ),
                          ),
                          const CustomSizedBoxForTTS(),
                          ...
                          const DividerDefinition(),
                          const DefinitionKurdish(text: "٥. (کردار) هەستکردن بەوەی شتێک گرنگە و هی ئەوەیە نیگەران بیت بۆی"),
                          Row(
                          children: [
                          const Expanded(
                          child: Column(
                          ...
                          ExampleSentenceKurdish(
                          text: "گرنگ نییە لام ئەگەر هەرگیز نەیبینمەوە!"),
                          ],
                          ),
                          ),
                          const CustomSizedBoxForTTS(),
                          ...
                          ExampleSentenceKurdish(
                          text: "هەڕەشەی دەرکردنمی کرد وەک ئەوەی گرنگ بێت لام!"),
                          ],
                          ),
                          ),
                          const CustomSizedBoxForTTS(),
                          ...
                          ExampleSentenceKurdish(
                          text: "تەواو گرنگی دەدات بە کێشە ژینگەییەکان."),
                          ],
                          ),
                          ),
                          const CustomSizedBoxForTTS(),
                          ...
                          children: [
                          CustomIconButtonBritish(
                          onPressed: () => speakcares14("en-GB"),
                          ),
                          CustomIconButtonAmerican(
                          onPressed: () => speakcares14("en-US"),
                          ),
                          ],
                          ),
                          ],
                          ...
                          ExampleSentenceKurdish(
                          text: "گرنگ نییە لام چەندە تێچووی هەیە."),
                          ],
                          ),
                          ),
                          const CustomSizedBoxForTTS(),
                          ...
                          children: [
                          CustomIconButtonBritish(
                          onPressed: () => speakcares15("en-GB"),
                          ),
                          CustomIconButtonAmerican(
                          onPressed: () => speakcares15("en-US"),
                          ),
                          ],
                          ),
                          ],
                          ...
                          const DividerDefinition(),
                          const DefinitionKurdish(text: "٦. (کردار) حەزکردن و خۆشویستنی کەسێک و گرنگیدان بەوەی چیان بەسەر دێت"),
                          Row(
                          children: [
                          const Expanded(
                          child: Column(
                          ...
                          ExampleSentenceKurdish(
                          text: "بەڕاستی گرنگی دەدات بە کارمەندەکانی."),
                          ],
                          ),
                          ),
                          const CustomSizedBoxForTTS(),
                          ...
                          ExampleSentenceKurdish(
                          text: "لە ڕادەبەر گرنگی بە یەکدی دەدەن."),
                          ],
                          ),
                          ),
                          const CustomSizedBoxForTTS(),
                          ...
                          const DividerDefinition(),
                          const DefinitionKurdish(text: "٧. (کردار) هەوڵدان بۆ کردنی شتێک"),
                          Row(
                          children: [
                          const Expanded(
                          child: Column(
                          ...
                          ExampleSentenceKurdish(
                          text: "ئەم کارەم زیاد لەوە کردووە کە حەوسەڵەم هەبێت بیر خۆمی بێنمەوە."),
                          ],
                          ),
                          ),
                          const CustomSizedBoxForTTS(),
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/9R_hPxyRQUA?t=',
    startSeconds: 154,
    autoPlay: true,
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/j94QOMf10BI?t=',
    startSeconds: 93,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/y-2mcJeK1kY?t=',
    startSeconds: 61,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/Vtos9gw1HJI?t=',
    startSeconds: 26,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
