...
class EnglishEntryforetell extends StatefulWidget {
  const EnglishEntryforetell({super.key});

  @override
  State<EnglishEntryforetell> createState() => _EnglishEntryforetellState();
}

class _EnglishEntryforetellState extends State<EnglishEntryforetell> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: foretell (Derived forms: foretells, foretelling, foretold)
1. Foreshadow or presage (= announce, annunciate, harbinger, herald)
 
2. Make a prediction about; tell in advance (= predict, prognosticate, call, forebode, anticipate, promise)
"foretell the outcome of an election";
 
3. Be a sign of something to come, esp. something important or bad (= bode, portend, auspicate, prognosticate, omen, presage, betoken [archaic], foreshadow, augur, prefigure, forecast, predict, foretoken)
"These signs foretell bad news";
""",
  );

  final String keyword = "foretell";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foretell""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The witch foretold that she would marry a prince.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""None of us can foretell what lies ahead.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foretell""",
                      // alsoEnglishWord: "also: foretell",
                      britshText: """IpaUK: /fɔːˈtel/""",
                      americanText: """IpaUS: /fɔːrˈtel/""",
...
// With short examples define "foretell", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) زانین یان پێشبینی کردنی ئەوەی چی ڕوودەدات لە داهاتوو، بە تایبەتی بە هەبوونی هێزی ئەفسووناوی"""),
                    SentencesRow(
                      englishText:
                          """The witch foretold that she would marry a prince.""",
                      kurdishText:
                          """ژنە جادووگەرەکە پێشبینی ئەوەی کرد کە شازادەیەک مارە دەکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کەسمان ناتوانین پێشبینی ئەوە بکەین چی لە پێشە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/LXcUDMn64Lw?t=';
const double _startSecondsend = 0000000000000000000000000004441;
const String _videoIdone = 'https://youtu.be/60fWsMyZfX0?t=';
const double _startSecondsone = 0000000000000000000000000003833;
const String _videoIdtwo = 'https://youtu.be/DTQA2ONgOlE?t=';
const double _startSecondstwo = 0000000000000000000000000001981;
const String _videoIdthree = 'https://youtu.be/5_JC_cvzshU?t=';
const double _startSecondsthree = 000000000000000000000000000489;
const String _videoIdfour = 'https://youtu.be/yDX-2rTxE6Y?t=';
const double _startSecondsfour = 000000000000000000000000000989;
const String _videoIdfive = 'https://youtu.be/VPB0RW7zg60?t=';
const double _startSecondsfive = 0000000000000000000000000005;
