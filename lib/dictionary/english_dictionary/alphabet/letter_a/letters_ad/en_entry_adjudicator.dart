...
// replace these: replace EnglishEntryadjudicator - replace speakAdjudicator - replace adjudicator - /əˈdʒuːdɪkeɪtər/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadjudicator extends StatelessWidget {
  EnglishEntryadjudicator({Key? key}) : super(key: key);
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'lhc_bXGvmp0';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'qBEKBgIVGxE';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'Xw4K-fW32zQ';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'CyVw2bz4Roc';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'w5K2ZoPVD5E';
