...
class EnglishEntryarrears extends StatelessWidget {
  ...
  Future<void> speakarrears(String languageCode) async {
    ...
    await flutterTts.speak("arrears");
  }
  ...
  Future<void> speakarrears400(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The family is facing eviction over mortgage arrears.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arrears"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈrɪəz/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈrɪrz/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakarrears400("en-US"),
                          ),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakarrears404("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final double _startSeconds = 3321;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'pH9dnJ8BmY0';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'B48uZJgM1bE';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'BJYCdHioqgg';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'kl5279dWqGs';
  final double _startSeconds = 2967;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'EHhlixGwUi4';
