...
class EnglishEntryhim extends StatefulWidget {
  const EnglishEntryhim({super.key});

  @override
  State<EnglishEntryhim> createState() => _EnglishEntryhimState();
}

class _EnglishEntryhimState extends State<EnglishEntryhim> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Pronoun: him
1. That male; objective male pronoun
""",
  );

  final String keyword = "him";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""When did you see him?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He took the children with him.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'm taller than him.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It's him.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 000000000000000000000000000848;
    ...
    const String videoIdfour = 'https://youtu.be/2xcWYu18a-w?t=';
    const double startSecondsfour = 000000000000000000000000000116;
    const String videoIdfive = 'https://youtu.be/1aHVa2jT3n4?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """him""",
                      // alsoEnglishWord: "also: him",
                      britshText: """IpaUK: /hɪm/, /ɪm/""",
                      americanText: """IpaUS: /hɪm/, /ɪm/""",
...
کوردی: 
"""),
// With short examples define "him", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (جێناو) وەک بەرکاری کاری be تان لە دوای ئامرازێک بەکاردێت بۆ ناوھێنانی پیاو یان کوڕێک کە پێشووتر باسکراوە یان دەزانرێت کێیە"""),
                    SentencesRow(
                      englishText: """When did you see him?""",
                      kurdishText: """کەی بینیت؟""",
                    ...
                    SentencesRow(
                      englishText: """He took the children with him.""",
                      kurdishText: """منداڵەکانی لەگەڵ خۆی برد.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I'm taller than him.""",
                      kurdishText: """درێژترم لێی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """It's him.""",
                      kurdishText: """ئەوە خۆیەتی.""",
