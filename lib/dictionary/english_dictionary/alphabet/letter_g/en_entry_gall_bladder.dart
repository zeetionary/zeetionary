...
class EnglishEntrygallbladder extends StatefulWidget {
  const EnglishEntrygallbladder({super.key});

  @override
  State<EnglishEntrygallbladder> createState() =>
      _EnglishEntrygallbladderState();
}

class _EnglishEntrygallbladderState extends State<EnglishEntrygallbladder> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gall bladder";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gall bladder""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gall bladder""",
                      // alsoEnglishWord: "also: gall bladder",
                      britshText: """IpaUK: /ˈɡɔːl blædə(r)/""",
                      americanText: """IpaUS: /ˈɡɔːl blædər/""",
...
// With short examples define "gall bladder", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """She had an operation to remove a stone from her gall bladder.""",
                      kurdishText:
                          """نەشتەرگەرییەکی کرد بۆ لابردنی بەرد لە توورەگەی زراوی.""",
...
const String _videoIdone = 'https://youtu.be/X3TAROotFfM?t=';
const double _startSecondsone = 00000000000000000000000000015;
const String _videoIdtwo = 'https://youtu.be/PN3Mrwk8AVQ?t=';
const double _startSecondstwo = 000000000000000000000000000483;
const String _videoIdthree = 'https://youtu.be/L0tTTU7lwg4?t=';
const double _startSecondsthree = 000000000000000000000000000186;
const String _videoIdfour = 'https://youtu.be/CgOSR7b1aFY?t=';
const double _startSecondsfour = 00000000000000000000000000080;
const String _videoIdfive = 'https://youtu.be/-Pu-PTbMj5E?t=';
const double _startSecondsfive = 000000000000000000000000000337;
