...
// replace these: replace EnglishEntryanaesthesia - replace speakAnaesthesia - replace anaesthesia - /ˌænəsˈθiːziə/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryanaesthesia extends StatelessWidget {
  EnglishEntryanaesthesia({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakanaesthesia(String languageCode) async {
    // DOPSUM: CHANGE speakAnaesthesia
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "anaesthesia"), // Find /ˌænəsˈθiːziə/
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            CustomIconButtonBritish(
                              onPressed: () => speakanaesthesia("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            CustomIconButtonAmerican(
                              onPressed: () => speakanaesthesia("en-US"),
                            ),
                          ],
                        ),
                      ],
