...
class EnglishEntryfreshen extends StatefulWidget {
  const EnglishEntryfreshen({super.key});

  @override
  State<EnglishEntryfreshen> createState() => _EnglishEntryfreshenState();
}

class _EnglishEntryfreshenState extends State<EnglishEntryfreshen> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: freshen (Derived forms: freshens, freshening, freshened)
1. Make (to feel) fresh (= refresh)
"The cool water freshened us";
 
2. Become or make oneself fresh again (= refresh, refreshen, freshen up)
"She freshened up after the tennis game";
 
3. Make fresh again (= refresh, refreshen)
""",
  );

  final String keyword = "freshen";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""freshen""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The walls need freshening up with white paint.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The rain had freshened the air.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Can I freshen your drink, sir?""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The wind will freshen tonight.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """freshen""",
                      // alsoEnglishWord: "also: freshen",
                      britshText: """IpaUK: /ˈfreʃn/""",
                      americanText: """IpaUS: /ˈfreʃn/""",
...
// With short examples define "freshen", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دیوارەکان پێویستییان بە تازەکردنەوە هەیە بە بۆیەی سپی.""",
                    ...
                    SentencesRow(
                      englishText: """The rain had freshened the air.""",
                      kurdishText: """بارانەکە هەواکەی خاوێن کردبووەوە.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (کردار) بەهێز و سارد بوون"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The wind will freshen tonight.""",
                      kurdishText: """بایەکە ئەمشەو بەهێز دەبێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/_VBNW98c_bU?t=';
const double _startSecondsend = 000000000000000000000000000575;
const String _videoIdone = 'https://youtu.be/Z9YwycIFeww?t=';
...
const String _videoIdthree = 'https://youtu.be/jaE9Nce-57U?t=';
const double _startSecondsthree = 000000000000000000000000000295;
const String _videoIdfour = 'https://youtu.be/PtrF9hx0ygw?t=';
const double _startSecondsfour = 000000000000000000000000000152;
const String _videoIdfive = 'https://youtu.be/Y2VlTpe4srk?t=';
const double _startSecondsfive = 000000000000000000000000000260;
