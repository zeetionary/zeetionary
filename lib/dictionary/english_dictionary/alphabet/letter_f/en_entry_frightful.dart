...
class EnglishEntryfrightful extends StatefulWidget {
  const EnglishEntryfrightful({super.key});

  @override
  State<EnglishEntryfrightful> createState() => _EnglishEntryfrightfulState();
}

class _EnglishEntryfrightfulState extends State<EnglishEntryfrightful> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: frightful
1. Provoking horror (= atrocious, horrifying, horrible, ugly)
"a frightful crime of decapitation";
 
2. Extreme in degree, extent, amount or impact (= terrible, awful, tremendous)
"in a frightful hurry"; "spent a frightful amount of money";
 
3. Extremely distressing (= fearful)
"a frightful mistake";
""",
  );

  final String keyword = "frightful";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frightful""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was absolutely frightful!""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This room's in a frightful mess.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They’re making a frightful noise.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frightful""",
                      // alsoEnglishWord: "also: frightful",
                      britshText: """IpaUK: /ˈfraɪtfl/""",
                      americanText: """IpaUS: /ˈfraɪtfl/""",
...
// With short examples define "frightful", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """It was absolutely frightful!""",
                      kurdishText: """تەواو خراپ بوو!""",
                    ...
                    SentencesRow(
                      englishText: """This room's in a frightful mess.""",
                      kurdishText: """ئەم ژوورە لە شپرزەییەکی زۆر خراپە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They’re making a frightful noise.""",
                      kurdishText: """دەنگەدەنگێکی زۆر خراپ دەکەن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/kY3SuNvqQPw?t=';
const double _startSecondsend = 0000000000000000000000000002;
const String _videoIdone = 'https://youtu.be/m5q-PIN3KSE?t=';
const double _startSecondsone = 00000000000000000000000000044;
const String _videoIdtwo = 'https://youtu.be/U6OhuqD4w1k?t=';
const double _startSecondstwo = 0000000000000000000000000001871;
const String _videoIdthree = 'https://youtu.be/GHkUdA68YNI?t=';
const double _startSecondsthree = 000000000000000000000000000451;
const String _videoIdfour = 'https://youtu.be/VL0cscPoPiw?t=';
const double _startSecondsfour = 0000000000000000000000000001061;
const String _videoIdfive = 'https://youtu.be/DC-SSfQ8XlA?t=';
const double _startSecondsfive = 000000000000000000000000000115;
