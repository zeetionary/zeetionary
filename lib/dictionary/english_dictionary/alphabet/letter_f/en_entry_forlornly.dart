...
class EnglishEntryforlornly extends StatefulWidget {
  const EnglishEntryforlornly({super.key});

  @override
  State<EnglishEntryforlornly> createState() => _EnglishEntryforlornlyState();
}

class _EnglishEntryforlornlyState extends State<EnglishEntryforlornly> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "forlornly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forlornly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She sat forlornly looking out to sea.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Her computer sits forlornly in pieces in her room.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forlornly""",
                      // alsoEnglishWord: "also: forlornly",
                      britshText: """IpaUK: /fəˈlɔːnli/""",
                      americanText: """IpaUS: /fərˈlɔːrnli/""",
...
// With short examples define "forlornly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە تەنها و دڵتەنگ دەردەکەوێت"""),
                    SentencesRow(
                      englishText: """She sat forlornly looking out to sea.""",
                      kurdishText: """بە تەنهایی دانیشت لە دەریای دەڕوانی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کۆمپیوتەرەکە بێ‌خاوەنانە بە پارچەپارچەکراوی لە ژوورەکەی دانراوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/REnc_wXkHnc?t=';
const double _startSecondsend = 0000000000000000000000000001023;
const String _videoIdone = 'https://youtu.be/Q52dHcRhV_U?t=';
const double _startSecondsone = 000000000000000000000000000142;
const String _videoIdtwo = 'https://youtu.be/b7QJgBDHwjI?t=';
const double _startSecondstwo = 00000000000000000000000000042;
const String _videoIdthree = 'https://youtu.be/xg0gGMe1TBM?t=';
const double _startSecondsthree = 000000000000000000000000000593;
const String _videoIdfour = 'https://youtu.be/pqNZkTdbJaY?t=';
const double _startSecondsfour = 0000000000000000000000000001925;
const String _videoIdfive = 'https://youtu.be/PDjsNtaM2jY?t=';
const double _startSecondsfive = 000000000000000000000000000196;
