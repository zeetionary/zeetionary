...
class EnglishEntryflushed extends StatefulWidget {
  const EnglishEntryflushed({super.key});

  @override
  State<EnglishEntryflushed> createState() => _EnglishEntryflushedState();
}

class _EnglishEntryflushedState extends State<EnglishEntryflushed> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flushed
1. Having the pinkish flush of health (= rose-cheeked, rosy, rosy-cheeked)
 
2. (especially of the face) reddened or suffused with or as if with blood from emotion or exertion (= crimson, red, reddened, red-faced)
"flushed (or crimson) with embarrassment";
 
3. Having a red face from embarrassment, shame, agitation or emotional upset (= blushful, blushing, red-faced, ablush, erubescent)
"her flushed beau";
""",
  );

  final String keyword = "flushed";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flushed""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""You look a little flushed - are you hot?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Peter turned away to hide his flushed cheeks.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flushed""",
                      // alsoEnglishWord: "also: flushed",
                      britshText: """IpaUK: /flʌʃt/""",
                      americanText: """IpaUS: /flʌʃt/""",
...
// With short examples define "flushed", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """سوورەوە بوو دیاریت ـ گەرماتە؟""",
                    ...
                    SentencesRow(
                      englishText:
                          """Peter turned away to hide his flushed cheeks.""",
                      kurdishText:
                          """پیتەر ڕووی وەرگێڕا بۆ شاردنەوەی گۆنا سوورەوەبووەکانی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/1uu9VWBgcBU?t=';
const double _startSecondsend = 000000000000000000000000000543;
const String _videoIdone = 'https://youtu.be/ZHIcVi7F6hM?t=';
const double _startSecondsone = 00000000000000000000000000081;
const String _videoIdtwo = 'https://youtu.be/dmxLv0sSzhE?t=';
const double _startSecondstwo = 000000000000000000000000000976;
const String _videoIdthree = 'https://youtu.be/dmxLv0sSzhE?t=';
const double _startSecondsthree = 0000000000000000000000000001710;
const String _videoIdfour = 'https://youtu.be/tPeOW3nLEws?t=';
const double _startSecondsfour = 000000000000000000000000000571;
const String _videoIdfive = 'https://youtu.be/vF8iV_24n2E?t=';
const double _startSecondsfive = 000000000000000000000000000669;
