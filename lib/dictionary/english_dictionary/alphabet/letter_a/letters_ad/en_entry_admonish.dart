...
// replace these: replace EnglishEntryadmonish - replace speakAdmonish - replace admonish - /ədˈmɒnɪʃ/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadmonish extends StatelessWidget {
  EnglishEntryadmonish({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdmonish(String languageCode) async {
    // DOPSUM: CHANGE speakAdmonish
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("admonish"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAdmon2568(String languageCode) async {
    // DOPSUM: CHANGE speakAdmonish
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "She was admonished for chewing gum in class."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ədˈmɒnɪʃ/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'qaHmpwbsYis';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '2N6cmL7Nt38';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'swuoSZXQTac';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '4Y4Vv_EVgIE';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'SWwnrGrHGQE';
