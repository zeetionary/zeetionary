...
class EnglishEntryhernia extends StatefulWidget {
  const EnglishEntryhernia({super.key});

  @override
  State<EnglishEntryhernia> createState() => _EnglishEntryherniaState();
}

class _EnglishEntryherniaState extends State<EnglishEntryhernia> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hernia (Derived forms: herniae, hernias)
1. Rupture in smooth muscle tissue through which a bodily structure protrudes (- herniation)
"he got a hernia when he tried to lift 100 pounds";
""",
  );

  final String keyword = "hernia";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She developed a hernia after years of physical labor.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hernia""",
                      // alsoEnglishWord: "also: hernia",
                      britshText: """IpaUK: /ˈhɜːniə/""",
                      americanText: """IpaUS: /ˈhɜːrniə/""",
...
// کوردی: هێرنیا، قۆڕی، فیتق، گەدوەڵ، پسان
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دۆخێکی تەندرووستی کە ئەندامێکی جەستە دەچێت بە شانە یان ماسوولکەیەکی نەرمی دەورووبەریدا"""),
                    SentencesRow(
                      englishText:
                          """She developed a hernia after years of physical labor.""",
                      kurdishText:
                          """لە دوای چەندین ساڵ لە کارکردنی جەستەیی تووشی هێرنیا بوو.""",
...
const String _videoIdone = 'https://youtu.be/zX5TrXxnx7k?t=';
const double _startSecondsone = 00000000000000000000000000087;
const String _videoIdtwo = 'https://youtu.be/Cg10exNmf7I?t=';
const double _startSecondstwo = 000000000000000000000000000163;
const String _videoIdthree = 'https://youtu.be/VnwszJtvF_8?t=';
const double _startSecondsthree = 0000000000000000000000000009;
const String _videoIdfour = 'https://youtu.be/ZzGH0EXzNeM?t=';
const double _startSecondsfour = 00000000000000000000000000011;
const String _videoIdfive = 'https://youtu.be/2Wgylrijzlg';
