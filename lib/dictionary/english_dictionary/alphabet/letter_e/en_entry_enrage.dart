...
class EnglishEntryenrage extends StatefulWidget {
  const EnglishEntryenrage({super.key});

  @override
  State<EnglishEntryenrage> createState() => _EnglishEntryenrageState();
}

class _EnglishEntryenrageState extends State<EnglishEntryenrage> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enrage""",
                      // alsoEnglishWord: "also: enrage",
                      britshText: """IpaUK: /ɪnˈreɪdʒ/""",
                      americanText: """IpaUS: /ɪnˈreɪdʒ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was enraged at his stupidity.""");
  }
...
کوردی: 
"""),
          const DefinitionKurdish(text: """١. (کردار) تووڕە کردن"""),
          SentencesRow(
            englishText: """She was enraged at his stupidity.""",
            kurdishText: """تووڕە بوو بە گەمژەییەتییەکەی.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The newspaper article enraged him.""",
            kurdishText: """وتاری ڕۆژنامەکە تووڕەی کرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: enrage (Derived forms: enraging, enraged, enrages)
1. Put into a rage; make violently angry
"To scorn Christ's sacrifice is to insult and enrage the Holy Spirit"
""",
  );
...
const String _videoIdend = 'https://youtu.be/G2r_I1G_mfA?t=';
const double _startSecondsend = 295;
const String _videoIdone = 'https://youtu.be/lVQFRJFge3E?t=';
const double _startSecondsone = 512;
const String _videoIdtwo = 'https://youtu.be/DZTTdYCBqqg?t=';
const double _startSecondstwo = 1287;
const String _videoIdthree = 'https://youtu.be/pLJYPNnPBk4?t=';
const double _startSecondsthree = 302;
const String _videoIdfour = 'https://youtu.be/bKyt_7f2-is?t=';
const double _startSecondsfour = 264;
const String _videoIdfive = 'https://youtu.be/zZcgjmLPs80?t=';
const double _startSecondsfive = 463;
const String _videoIdsix = 'https://youtu.be/LpIyaIHsJbc?t=';
const double _startSecondssix = 846;
