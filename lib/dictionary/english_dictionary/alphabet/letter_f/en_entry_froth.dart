...
class EnglishEntryfroth extends StatefulWidget {
  const EnglishEntryfroth({super.key});

  @override
  State<EnglishEntryfroth> createState() => _EnglishEntryfrothState();
}

class _EnglishEntryfrothState extends State<EnglishEntryfroth> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: froth (Derived forms: froths)
1. A mass of small bubbles formed in or on a liquid (- foam)
"the beer had a thick head of froth";

- Verb: froth (Derived forms: frothed, frothing, froths)
1. Become bubbly, frothy or foaming (- foam, fizz, effervesce, sparkle, form bubbles)
"The boiling soup was frothing";

2. Make froth or foam and become bubbly (- spume, suds [N. Amer])
...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I like the froth on the top of the coffee.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His books are just froth, but they're enjoyable enough.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The waves frothed as they crashed onto the beach.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        """When she opened the bottle of soda, it frothed up and spilled all over the table.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The dog was frothing at the mouth.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He frothed at the mouth when I asked for more money.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """froth""",
                      // alsoEnglishWord: "also: froth",
                      britshText: """IpaUK: /frɒθ/""",
                      americanText: """IpaUS: /frɔːθ/""",
...
کوردی: کەف، سەرکەف، سەرکوڵ،	فڵتە، قسەی هیچەکە، یاوە، هەڵیت‌وپڵیت
"""),
// With short examples define "froth", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The barmen around here always top up your beer with too much froth.""",
                      kurdishText:
                          """مەیگێڕەکانی ئێرە هەمیشە سەرەوەی بیرەکەت پڕ دەکەن لە کەف.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """حەزم بە کەفی سەر قاوەکەیە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) شتێکی کە جدی نییە و بێ بەهایە، بەڵام خۆشە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """His books are just froth, but they're enjoyable enough.""",
                      kurdishText:
                          """کتێبەکانی تەنها قسەی هیچن، بەڵام بەشی پێویست خۆشن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شەپەلەکان کەفیان کرد کە کێشایان بە کەنار دەریاکەدا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """When she opened the bottle of soda, it frothed up and spilled all over the table.""",
                      kurdishText:
                          """کە سۆدەکەی هەڵچڕی، کەفی کردە سەرەوە و ڕژا بەسەر تەواوی مێزەکەدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆر توورە بوو کە داوای پارەی زیاترم کرد.""",
...
const String _videoIdone = 'https://youtu.be/XFeItKoT0Fw?t=';
const double _startSecondsone = 000000000000000000000000000908;
const String _videoIdtwo = 'https://youtu.be/H-iM_JhNzIQ?t=';
const double _startSecondstwo = 000000000000000000000000000730;
const String _videoIdthree = 'https://youtu.be/BGLZoBFKvNk?t=';
const double _startSecondsthree = 000000000000000000000000000506;
const String _videoIdfour = 'https://youtu.be/6UnRHtwHGSE?t=';
const double _startSecondsfour = 00000000000000000000000000038;
const String _videoIdfive = 'https://youtu.be/XGcYQIF7sls?t=';
