...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/WdqUZIwHhG4?t=';
    const double startSecondsend = 000000000000000000000000000312;
    const String videoIdone = 'https://youtu.be/C2Jw5ib-s_I?t=';
    const double startSecondsone = 00000000000000000000000000025;
    const String videoIdtwo = 'https://youtu.be/1uRx9NQJi3Y?t=';
    const double startSecondstwo = 000000000000000000000000000365;
    const String videoIdthree = 'https://youtu.be/YB6O7jS_VBM?t=';
    const double startSecondsthree = 00000000000000000000000000053;
    const String videoIdfour = 'https://youtu.be/1_ogluZE5AM?t=';
    const double startSecondsfour = 000000000000000000000000000288;
    const String videoIdfive = 'https://youtu.be/bfScSo3lkwo?t=';
    const double startSecondsfive = 000000000000000000000000000271;
