...
class EnglishEntryforty extends StatefulWidget {
  const EnglishEntryforty({super.key});

  @override
  State<EnglishEntryforty> createState() => _EnglishEntryfortyState();
}

class _EnglishEntryfortyState extends State<EnglishEntryforty> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: forty
1. Being ten more than thirty (= 40, xl, twoscore [archaic])

- Noun: forty (Derived forms: forties)
1. The cardinal number that is the product of ten and four (= 40, XL)
""",
  );

  final String keyword = "forty";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He looks about forty.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I think she gets about forty thousand pounds a year.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She was a successful banker by the time she was forty.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""World War II took place during the forties.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forty""",
                      // alsoEnglishWord: "also: forty",
                      britshText: """IpaUK: /ˈfɔːti/""",
                      americanText: """IpaUS: /ˈfɔːrti/""",
...
// With short examples define "forty", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """نزیکەی چل ساڵ دیارە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پێموایە نزیکەی ٤٠٠٠٠ پاوەند لە ساڵێکدا وەردەگرێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """خاوەن باکێکی سەرکەوتوو کە ٤٠ ساڵ بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """جەنگی دووەمی جیهان لە ساڵانی چلەکان ڕوویدا.""",
...
const String _videoIdone = 'https://youtu.be/65CFesU4KVQ?t=';
const double _startSecondsone = 000000000000000000000000000562;
const String _videoIdtwo = 'https://youtu.be/kTaYet07Ioo?t=';
const double _startSecondstwo = 000000000000000000000000000852;
...
const String _videoIdfive = 'https://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondsfive = 0000000000000000000000000005228;
