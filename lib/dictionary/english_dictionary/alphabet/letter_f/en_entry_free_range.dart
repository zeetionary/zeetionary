...
class EnglishEntryfreerange extends StatefulWidget {
  const EnglishEntryfreerange({super.key});

  @override
  State<EnglishEntryfreerange> createState() => _EnglishEntryfreerangeState();
}

class _EnglishEntryfreerangeState extends State<EnglishEntryfreerange> {
  @override
  void initState() {
    super.initState();
...
"Free-range hens are generally given slightly more space to live in than hens kept in battery cages"
""",
  );

  final String keyword = "free-range";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""free-range""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Free-range eggs are often considered healthier.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I wanted the kids to have a free-range childhood.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """free-range""",
                      // alsoEnglishWord: "also: free-range",
                      britshText: """IpaUK: /ˌfriː ˈreɪndʒ/""",
                      americanText: """IpaUS: /ˌfriː ˈreɪndʒ/""",
...
// With short examples define "free-range", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) پەیوەندیدار بە سیستەمێکی ئاژەڵداری کە ئاژەلان لە کەشی سرووشتی دان و دەتوانن بە ئازادی هاتووچۆ بکەن"""),
                    SentencesRow(
                      englishText:
                          """Free-range eggs are often considered healthier.""",
                      kurdishText:
                          """هێلکەی مریشکی ئازاد زۆرجار بە تەندروستتر دادەنرێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەمویست منداڵەکان منداڵییەکی ئازادانەیان هەبێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/zrfBPDy4KPc?t=';
const double _startSecondsend = 000000000000000000000000000638;
const String _videoIdone = 'https://youtu.be/dCfVThaUrlw?t=';
const double _startSecondsone = 000000000000000000000000000574;
const String _videoIdtwo = 'https://youtu.be/SjeS6gtPq8E?t=';
const double _startSecondstwo = 000000000000000000000000000287;
const String _videoIdthree = 'https://youtu.be/xj-6hC5GFfI?t=';
const double _startSecondsthree = 000000000000000000000000000825;
const String _videoIdfour = 'https://youtu.be/w5K2ZoPVD5E';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/_G2Ifc8SAbU?t=';
