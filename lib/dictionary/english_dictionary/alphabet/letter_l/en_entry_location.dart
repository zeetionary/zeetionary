...
class EnglishEntrylocation extends StatefulWidget {
  const EnglishEntrylocation({super.key});

  @override
  State<EnglishEntrylocation> createState() => _EnglishEntrylocationState();
}

class _EnglishEntrylocationState extends State<EnglishEntrylocation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: location (Derived forms: locations)
1. A point or extent in space; a point or extent in space
 
2. The act of putting something in a certain place (- placement, locating, position, positioning, emplacement)
 
3. A determination of the place where something is (- localization, localisation [Brit], locating, fix)
...
""",
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We still do not know the precise location of the crash.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The movie was shot entirely on location in Italy.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Location of a suitable site may take some time.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/o5cbHaffnbI?t=551';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/eQ6x21nyMFg?t=19';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/xVeeMyv0upE?t=3';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/z1KGMsMai0M?t=589';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/P0JUY_IEZts?t=94';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/-APcPQUDyNk?t=1231';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """location""",
                      // alsoEnglishWord: "also: location",
                      britshText: """IpaUK: /ləʊˈkeɪʃn/""",
                      americanText: """IpaUS: /ləʊˈkeɪʃn/""",
...
کوردی: شوێن، جێگا، هەڵکەوت، هەڵکەوتن
"""),
// With short examples define "location", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) شوێنی شتێک"""),
                    SentencesRow(
                      englishText:
                          """Mobile phones can determine our exact location and relay it to the police in an emergency.""",
                      kurdishText:
                          """موبایل دەکرێت شوێنی درووستمان دیاری بکات و بینێرێت بۆ پۆلیس لە هەر بارێکی لەناکاودا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """We selected these two locations because they offer a range of services.""",
                      kurdishText:
                          """ئەو دوو شوێنەمان دیاری کرد بەهۆی ئەوەی ژمارەیەک خزمەتگوزاری پێشکەش دەکەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """شوێنی تەواوی تێکشکانەکە نازانین.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) شوێنێک لە دەرەوەی ستودیۆی فیلم کە دیمەنی تێدا تۆمار دەکرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The movie was shot entirely on location in Italy.""",
                      kurdishText:
                          """فیلمەکە هەمووی وێنە گیردرا لە دەرەوەی ستویۆ لە ئیتالیا.""",
                      englishNote:
                          """This means the movie was filmed in real outdoor or indoor settings in Italy, not in a studio.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ناو) دۆزینەوەی شوێنی کەسێک/شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Location of a suitable site may take some time.""",
                      kurdishText:
                          """دیاریکردنی شوێنێکی گونجاو ڕەنگە هەندێک کاتی بوێت.""",
