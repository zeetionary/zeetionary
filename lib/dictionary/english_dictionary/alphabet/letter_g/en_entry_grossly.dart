...
class EnglishEntrygrossly extends StatefulWidget {
  const EnglishEntrygrossly({super.key});

  @override
  State<EnglishEntrygrossly> createState() => _EnglishEntrygrosslyState();
}

class _EnglishEntrygrosslyState extends State<EnglishEntrygrossly> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grossly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Press reports have been grossly exaggerated.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grossly""",
                      // alsoEnglishWord: "also: grossly",
                      britshText: """IpaUK: /ˈɡrəʊsli/""",
                      americanText: """IpaUS: /ˈɡrəʊsli/""",
...
کوردی: (خراپ) یەکجار، گەلێ، لەرادەبەدەر، بێ‌ئەندازە
"""),
// With short examples define "grossly", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) بە ئاستێکی ئێجگار زۆر"""),
                    SentencesRow(
                      englishText:
                          """Press reports have been grossly exaggerated.""",
                      kurdishText:
                          """ڕاپۆرتەکانی میدیا ئێجگار زۆر زیادەڕەوییان تێدا کراوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/NNnIGh9g6fA?t=';
const double _startSecondsend = 000000000000000000000000000476;
const String _videoIdone = 'https://youtu.be/ugYPoWShl6k?t=';
const double _startSecondsone = 000000000000000000000000000459;
const String _videoIdtwo = 'https://youtu.be/aIQKq5alziM?t=';
...
const String _videoIdfour = 'https://youtu.be/ViBaYl9GCcE?t=';
const double _startSecondsfour = 000000000000000000000000000296;
const String _videoIdfive = 'https://youtu.be/ElQdUHSXkME?t=';
const double _startSecondsfive = 000000000000000000000000000515;
