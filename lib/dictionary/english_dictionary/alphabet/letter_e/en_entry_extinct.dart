...
class EnglishEntryextinct extends StatefulWidget {
  const EnglishEntryextinct({super.key});

  @override
  State<EnglishEntryextinct> createState() => _EnglishEntryextinctState();
}

class _EnglishEntryextinctState extends State<EnglishEntryextinct> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extinct""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extinct""",
                      // alsoEnglishWord: "also: extinct",
                      britshText: """IpaUK: /ɪkˈstɪŋkt/""",
                      americanText: """IpaUS: /ɪkˈstɪŋkt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The species was presumed extinct.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Servants are now almost extinct in modern society.""");
  }
...
"""),
          ...
          SentencesRow(
            englishText:
                """The red squirrel is in danger of becoming extinct in England.""",
            kurdishText:
                """سمۆرە سوورە لە پێش مەترسی لەناوچوونە لە ئینگلتەرە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The species was presumed extinct.""",
            kurdishText: """ئاژەڵەکە بە لەناوچوو دانرا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: extinct
1. Not lit, or having grown cold (= out)
"threw his extinct cigarette into the stream";
 
2. No longer in existence; lost or especially having died out leaving no living representatives (= nonextant)
"an extinct species of fish"; "extinct laws and customs";
 
3. (of e.g. volcanoes) permanently inactive
"an extinct volcano"
""",
  );
...
const double _startSecondsend = 0000000000000000000000000002383;
const String _videoIdone = 'https://youtu.be/j_y88KAPKW0?t=';
const double _startSecondsone = 000000000000000000000000000129;
const String _videoIdtwo = 'https://youtu.be/RQYuyHNLPTQ?t=';
...
const String _videoIdfour = 'https://youtu.be/Jl0IDXkYKbk?t=';
const double _startSecondsfour = 00000000000000000000000000065;
const String _videoIdfive = 'https://youtu.be/VVh6EkYwIGU?t=';
