...
class EnglishEntryfray extends StatefulWidget {
  const EnglishEntryfray({super.key});

  @override
  State<EnglishEntryfray> createState() => _EnglishEntryfrayState();
}

class _EnglishEntryfrayState extends State<EnglishEntryfray> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fray (Derived forms: frays)
1. A noisy fight (= affray, disturbance, ruffle)

- Verb: fray (Derived forms: frayed, frays, fraying)
1. Wear away by rubbing (= frazzle)
"The friction frayed the sleeve";
 
2. Cause friction (= rub, fret, chafe, scratch)
"my sweater frays";
""",
  );

  final String keyword = "fray";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This material frays easily.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The cuffs of his shirt were fraying.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""As the debate went on, tempers began to fray.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fray""",
                      // alsoEnglishWord: "also: fray",
                      britshText: """IpaUK: /freɪ/""",
                      americanText: """IpaUS: /freɪ/""",
...
کوردی: ئاژاوە، گۆنگەڵ، کێشە، بگرەوبەردە، ململانێ، جوڕڕە، هەرا، قڕە، شەڕەقسە، مشت‌ومڕ
"""),
// With short examples define "fray", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەم مادەیە ئاسان هەڵدەوەشێتەوە.""",
                    ...
                    SentencesRow(
                      englishText: """The cuffs of his shirt were fraying.""",
                      kurdishText:
                          """قۆڵەکانی جلەکەی دەستیان بە شیبوونەوە دەکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دیبەیتەکە بەردەوام بوو و نیگەران بوون دەستی پێکرد.""",
...
const double _startSecondsend = 000000000000000000000000000465;
const String _videoIdone = 'https://youtu.be/HDntl7yzzVI?t=';
const double _startSecondsone = 000000000000000000000000000317;
const String _videoIdtwo = 'https://youtu.be/LqU9CdPs6ek?t=';
const double _startSecondstwo = 000000000000000000000000000691;
const String _videoIdthree = 'https://youtu.be/JR3z8lq2cNM?t=';
const double _startSecondsthree = 000000000000000000000000000791;
const String _videoIdfour = 'https://youtu.be/EFQFKVFLuOA?t=';
const double _startSecondsfour = 000000000000000000000000000498;
const String _videoIdfive = 'https://youtu.be/DvDwlyGthtY?t=';
