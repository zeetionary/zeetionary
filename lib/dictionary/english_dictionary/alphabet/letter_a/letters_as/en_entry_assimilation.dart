...
class EnglishEntryassimilation extends StatelessWidget {
  ...
  Future<void> speakassimilation(String languageCode) async {
    ...
    await flutterTts.speak("assimilation");
  }
  ...
  Future<void> speakassimilation833(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("To thrive in the ever-changing tech landscape");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "assimilation"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˌsɪməˈleɪʃn/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakassimilation("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˌsɪməˈleɪʃn/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakassimilation("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'xBZA5Bpc0WQ';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'mha2OwA2rpk';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'lAaLRpmdeG4';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'yxmG1ntM2uw';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'jO4QjktFaOc';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final double _startSeconds = 4016;
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'ie4m9LAVDGw';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'yw8a8n7ZAZg';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'Vh7c7PSVubE';
