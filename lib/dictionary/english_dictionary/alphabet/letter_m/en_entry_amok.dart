...
// replace these: replace EnglishEntryamok - replace speakAmok - replace amok - /əˈmɒk/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryamok extends StatelessWidget {
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "amok"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈmɒk/"),
...
- Adverb: amok 
1. Wildly; without self-control (= amuck)
"when the restaurant caught fire the patrons ran amok, blocking the exit";
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'HUoU4ESQp88';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'NGbSR29wy30';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '15SILwg5ehc';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'wgOAMKX5MAE';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'v1YRiaj_n38';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'm1d_soYTp_g';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'PY7GIYFFmbA';
