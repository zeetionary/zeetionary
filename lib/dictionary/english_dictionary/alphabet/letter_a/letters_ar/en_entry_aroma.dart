...
class EnglishEntryaroma extends StatelessWidget {
  ...
  Future<void> speakaroma822(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("A delicious aroma was coming from the kitchen.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "aroma"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈrəʊmə/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakaroma("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈrəʊmə/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakaroma("en-US"),
                            ),
                          ],
                        ),
                      ],
