...
class EnglishEntryheckle extends StatefulWidget {
  const EnglishEntryheckle({super.key});

  @override
  State<EnglishEntryheckle> createState() => _EnglishEntryheckleState();
}

class _EnglishEntryheckleState extends State<EnglishEntryheckle> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heckle (Derived forms: heckles)
1. A comb for separating flax fibers (- hatchel)

- Verb: heckle (Derived forms: heckled, heckles, heckling)
1. Comb with a heckle (- hackle, hatchel)
"heckle hemp or flax";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heckle""",
                      // alsoEnglishWord: "also: heckle",
                      britshText: """IpaUK: /ˈhekl/""",
                      americanText: """IpaUS: /ˈhekl/""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/HUs2nK1q1QM?t=';
const double _startSecondsend = 000000000000000000000000000190;
const String _videoIdone = 'https://youtu.be/FrLgREKD4kk?t=';
const double _startSecondsone = 000000000000000000000000000543;
const String _videoIdtwo = 'https://youtu.be/rUAXjGXr75s?t=';
const double _startSecondstwo = 000000000000000000000000000454;
const String _videoIdthree = 'https://youtu.be/aO_QnNRAlzA?t=';
const double _startSecondsthree = 000000000000000000000000000276;
const String _videoIdfour = 'https://youtu.be/qNKPTAEzXTw?t=';
const double _startSecondsfour = 00000000000000000000000000073;
const String _videoIdfive = 'https://youtu.be/cyyEKuFBMUw?t=';
const double _startSecondsfive = 000000000000000000000000000516;
