...
class EnglishEntryfatality extends StatefulWidget {
  const EnglishEntryfatality({super.key});

  @override
  State<EnglishEntryfatality> createState() => _EnglishEntryfatalityState();
}

class _EnglishEntryfatalityState extends State<EnglishEntryfatality> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fatality""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fatality""",
                      // alsoEnglishWord: "also: fatality",
                      britshText: """IpaUK: /fəˈtæləti/""",
                      americanText: """IpaUS: /feɪˈtæləti/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Different forms of cancer have different fatality rates.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fatality rate so far is about 50%.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""A sense of fatality gripped her.""");
  }
...
// With short examples define "fatality", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: مەرگ، نەمان، مردن، تیاچوون، مردنی ناسروشتی، کوشندەیی،	چارەنووس، چارەنڤیس،	بەڵا، ماڵ‌وێرانی، بەدبەختی، نەهامەتی، مەینەتی، کارەسات،	کاریگەری کوشندە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) مردنێک کە درووست دەبێت بەهۆی ڕووداو یان جەنگ، یان بەهۆی توندوتیژی یان نەخۆشی"""),
          SentencesRow(
            englishText:
                """Several people were injured, but there were no fatalities.""",
            kurdishText:
                """ژمارەیەک کەس بریندار بوون، بەڵام هیچ مەرگێک نەبوو.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) ئەوەی کە نەخۆشییەک دەبێتە هۆی مردن"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Different forms of cancer have different fatality rates.""",
            kurdishText:
                """شێوەی جۆراوجۆری شێرپەنجە ئاستی کوشندەیی جیاوازیان هەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The fatality rate so far is about 50%.""",
            kurdishText: """ئاستی کوشندەیی تا ئێستا ٥٠٪ ــە.""",
            onPressedBritish: () => speaksentence3("en-GB"),
            onPressedAmerican: () => speaksentence3("en-US"),
          ),
          // const DividerDefinition(),
          // const DefinitionKurdish(text: """٣. (ناو) باوەڕی ئەوەی هیچ دەسەڵاتمان نییە بەسەر ئەوەی چی ڕوودەدات"""),
          // const DividerSentences(),
          // SentencesRow(
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fatality (Derived forms: fatalities)
1. A death resulting from an accident or a disaster (= human death)
...
const String _videoIdend = 'https://youtu.be/d4wn7ojGyx8?t=';
const double _startSecondsend = 000000000000000000000000000618;
const String _videoIdone = 'https://youtu.be/oiLdWXLXDeA?t=';
const double _startSecondsone = 000000000000000000000000000948;
const String _videoIdtwo = 'https://youtu.be/FkKPsLxgpuY?t=';
const double _startSecondstwo = 000000000000000000000000000855;
const String _videoIdthree = 'https://youtu.be/p7iwXvBnbIE?t=';
...
const String _videoIdfive = 'https://youtu.be/AdZ9kGwqkTM?t=';
const double _startSecondsfive = 000000000000000000000000000364;
