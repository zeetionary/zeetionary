...
class EnglishEntrygammon extends StatefulWidget {
  const EnglishEntrygammon({super.key});

  @override
  State<EnglishEntrygammon> createState() => _EnglishEntrygammonState();
}

class _EnglishEntrygammonState extends State<EnglishEntrygammon> {
  @override
  void initState() {
    super.initState();
...
3. [Brit, informal] (derogatory) a middle-aged white man with reactionary views, esp. when ill-informed but with strong opinions
""",
  );

  final String keyword = "gammon";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This gammon is delicious.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He helped himself to a slice of gammon.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gammon""",
                      // alsoEnglishWord: "also: gammon",
                      britshText: """IpaUK: /ˈɡæmən/""",
                      americanText: """IpaUS: /ˈɡæmən/""",
...
// With short examples define "gammon", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """This gammon is delicious.""",
                      kurdishText: """ئەم گامنە بەلەزەتە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پارچە گامنێکی خوارد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Z6MqOw2y744?t=';
const double _startSecondsend = 000000000000000000000000000767;
const String _videoIdone = 'https://youtu.be/cNhSlyXB7PE?t=';
const double _startSecondsone = 000000000000000000000000000337;
const String _videoIdtwo = 'https://youtu.be/AgTGA9Qnegs?t=';
const double _startSecondstwo = 0000000000000000000000000001327;
const String _videoIdthree = 'https://youtu.be/VNGQRF6nR4U?t=';
const double _startSecondsthree = 000000000000000000000000000509;
const String _videoIdfour = 'https://youtu.be/zrJYW08beVE?t=';
