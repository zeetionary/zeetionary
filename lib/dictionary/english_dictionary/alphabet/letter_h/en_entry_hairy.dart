...
class EnglishEntryhairy extends StatefulWidget {
  const EnglishEntryhairy({super.key});

  @override
  State<EnglishEntryhairy> createState() => _EnglishEntryhairyState();
}

class _EnglishEntryhairyState extends State<EnglishEntryhairy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hairy (Derived forms: hairier, hairiest)
1. Hazardous and frightening
"hairy moments in the mountains"
 
2. Having or covered with hair (- haired, hirsute)
"Jacob was a hairy man"; "a hairy caterpillar";
""",
  );

  final String keyword = "hairy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Many men have a hairy chest.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Driving on icy roads can be pretty hairy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hairy""",
                      // alsoEnglishWord: "also: hairy",
                      britshText: """IpaUK: /ˈheəri/""",
                      americanText: """IpaUS: /ˈheri/""",
