...
class EnglishEntrychocolate extends StatelessWidget {
  ...
  Future<void> speakchocolates4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakchocolates400"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakchocolates5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakchocolates500"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakchocolates6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakchocolates600"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakchocolates7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakchocolates700"); // DOPSUM: CHANGE TEXT
  }
...
کوردی: نوقڵ، چاکڵیت،	شیرکاکائۆ،	ڕەنگی قاوەیی ئاماڵ سوور، قاوەیی تۆخ
"""),
