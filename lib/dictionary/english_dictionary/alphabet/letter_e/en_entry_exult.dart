...
class EnglishEntryexult extends StatefulWidget {
  const EnglishEntryexult({super.key});

  @override
  State<EnglishEntryexult> createState() => _EnglishEntryexultState();
}

class _EnglishEntryexultState extends State<EnglishEntryexult> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exult""",
                      // alsoEnglishWord: "also: exult",
                      britshText: """IpaUK: /ɪɡˈzʌlt/""",
                      americanText: """IpaUS: /ɪɡˈzʌlt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He leaned back, exulting at the success of his plan.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They exulted at their victory.""");
  }
...
// With short examples define "exult", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          ...
          SentencesRow(
            ...
            kurdishText: """پاڵی دایەوە و شادی دەربڕی لە سەرکەوتنی پلانەکەی.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """They exulted at their victory.""",
            kurdishText: """شادیان گێڕا بۆ سەرکەوتنەکەیان.""",
...
const String _videoIdend = 'https://youtu.be/knjliFs3gR8?t=';
const double _startSecondsend = 000000000000000000000000000862;
const String _videoIdone = 'https://youtu.be/Oot0NGxQEm4?t=';
const double _startSecondsone = 00000000000000000000000000057;
const String _videoIdtwo = 'https://youtu.be/rYGISX6-eo0?t=';
const double _startSecondstwo = 000000000000000000000000000585;
const String _videoIdthree = 'https://youtu.be/prmPXZUZfEk?t=';
const double _startSecondsthree = 000000000000000000000000000821;
const String _videoIdfour = 'https://youtu.be/-sbmgOiQWjc?t=';
const double _startSecondsfour = 000000000000000000000000000246;
const String _videoIdfive = 'https://youtu.be/aO_XltYHGWc?t=';
const double _startSecondsfive = 0000000000000000000000000002928;
