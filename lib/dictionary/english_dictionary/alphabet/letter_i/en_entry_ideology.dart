...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: ideology (Derived forms: ideologies)
1. An orientation that characterizes the thinking of a group or nation (- political orientation, political theory, mythos)
...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They are divided by opposing ideologies.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He had never committed himself to any ideology.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001362;
    const String videoIdone = 'https://youtu.be/fez7X_oevNs?t=';
    const double startSecondsone = 000000000000000000000000000191;
    const String videoIdtwo = 'https://youtu.be/FQ4hvLqNfqo?t=';
    const double startSecondstwo = 000000000000000000000000000501;
    const String videoIdthree = 'https://youtu.be/ndHOav52t7k?t=';
    const double startSecondsthree = 000000000000000000000000000373;
    const String videoIdfour = 'https://youtu.be/NNnIGh9g6fA?t=';
    const double startSecondsfour = 0000000000000000000000000001755;
    const String videoIdfive = 'https://youtu.be/LJUl77rsFEw?t=';
    const double startSecondsfive = 000000000000000000000000000336;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      britshText: """IpaUK: /ˌaɪdiˈɒlədʒi/""",
                      americanText: """IpaUS: /ˌaɪdiˈɑːlədʒi/""",
...
// With short examples define "ideology", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ژمارەیەک بیروباوەڕ کە سیستەمێکی سیاسی یان ئابووری پشتی پێبەستووە"""),
                    SentencesRow(
                      englishText:
                          """The party's policies were based on prejudice rather than on any coherent ideology.""",
                      kurdishText:
                          """سیاسەتی پارتەکە پشتی بە ڕق بەستبوو وەک لە ئایدۆلۆژیایەکی یەکگرتوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بە ئایدۆلۆژیای دژ بەیەک دابەش بوونە.""",
