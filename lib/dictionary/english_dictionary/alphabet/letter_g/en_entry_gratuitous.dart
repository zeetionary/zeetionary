...
class EnglishEntrygratuitous extends StatefulWidget {
  const EnglishEntrygratuitous({super.key});

  @override
  State<EnglishEntrygratuitous> createState() => _EnglishEntrygratuitousState();
}

class _EnglishEntrygratuitousState extends State<EnglishEntrygratuitous> {
  @override
  void initState() {
    super.initState();
...
2. Costing nothing (- complimentary, costless, free, gratis, courtesy)
"gratuitous tickets";
 
3. Unnecessary and unwarranted (- needless, uncalled-for)
""",
  );

  final String keyword = "gratuitous";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gratuitous""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gratuitous""",
                      // alsoEnglishWord: "also: gratuitous",
                      britshText: """IpaUK: /ɡrəˈtjuːɪtəs/""",
                      americanText: """IpaUS: /ɡrəˈtuːɪtəs/""",
...
کوردی: لەخۆوە، هەڕەمەکی، لەخۆڕایی، بێ‌هۆ، بێجێ
"""),
// With short examples define "gratuitous", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە بە بێ هۆکار یان مەبەستی دیاریکراو دەکرێت و زۆرجار کاریگەری زیانبەخشی هەیە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: unnecessary"),
                    SentencesRow(
                      englishText:
                          """It was a completely gratuitous insult which the singer’s agent was forced to apologize for.""",
                      kurdishText:
                          """بێ‌ڕێزییەکی تەواو لەخۆرایی بوو کە بریکاری گۆرانی‌بێژەکە ناچار کرا داوای لێبوردن بکات بۆی.""",
...
const String _videoIdone = 'https://youtu.be/Eu46puWv7ts?t=';
const double _startSecondsone = 00000000000000000000000000082;
const String _videoIdtwo = 'https://youtu.be/15AGWA9bTjo?t=';
const double _startSecondstwo = 000000000000000000000000000333;
const String _videoIdthree = 'https://youtu.be/J-piNPoWoYc?t=';
const double _startSecondsthree = 0000000000000000000000000001820;
const String _videoIdfour = 'https://youtu.be/t70wcV3gJ68?t=';
const double _startSecondsfour = 000000000000000000000000000618;
const String _videoIdfive = 'https://youtu.be/L_LwqMOVHlc?t=';
