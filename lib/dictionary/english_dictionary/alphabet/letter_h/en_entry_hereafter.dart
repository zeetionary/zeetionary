...
class EnglishEntryhereafter extends StatefulWidget {
  const EnglishEntryhereafter({super.key});

  @override
  State<EnglishEntryhereafter> createState() => _EnglishEntryhereafterState();
}

class _EnglishEntryhereafterState extends State<EnglishEntryhereafter> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: hereafter
1. In a subsequent part of this document, statement or matter etc. (- hereinafter, hereunder)
...
- Noun: hereafter (Derived forms: hereafters)
1. Life after death (- afterlife)
 
2. The time yet to come (- future, futurity, time to come)
""",
  );

  final String keyword = "hereafter";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hereafter""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Do you believe in a life hereafter?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hereafter""",
                      // alsoEnglishWord: "also: hereafter",
                      britshText: """IpaUK: /ˌhɪərˈɑːftə(r)/""",
                      americanText: """IpaUS: /ˌhɪrˈæftər/""",
...
کوردی: لەمەوبەدوا، لەم کاتەوە،	لە داهاتوو(دا)، ژیانی دوای مەرگ، جیهانی پەسڵان
"""),
// With short examples define "hereafter", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) لە بەشی ماوەی ئەم بەڵگەنامەیە"""),
                    SentencesRow(
                      englishText:
                          """This contract is between Mrs Green (hereafter referred to as the vendor) and Mr Quain (hereafter referred to as the purchaser).""",
                      kurdishText:
                          """ڕێکەوتنەکە لە نێوان بەڕێز گرین (لەمەوبەدوا پێی دەگوترێت فرۆشیار) و بەڕێز کواینە (لەمەوبەدوا پێی دەگوترێت کڕیار).""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵکار) لە ئێستاوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I will let you in this time, but hereafter you have to get permission in advance.""",
                      kurdishText:
                          """ئەم جارە دەهێڵم بێیتە ژوورەوە، بەڵام لەمەوبەدوا دەبێت پێشوەختە مۆڵەت وەربگریت.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ھاوەڵکار) دوای مەرگ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Do you believe in a life hereafter?""",
                      kurdishText: """باوەڕت بە ژیان لە دوای مەرگ هەیە؟""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (ناو) ژیانی دوای مەرگ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She had a firm conviction that they would meet again in the hereafter.""",
                      kurdishText:
                          """بڕوایەکی پتەوی هەبوو کە لە ژیانی دوای مەرگ دووبارە یەکتر دەبیننەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/y9nBhv0lq1s?t=';
const double _startSecondsend = 0000000000000000000000000002133;
const String _videoIdone = 'https://youtu.be/ozj-ZZMXP0c?t=';
const double _startSecondsone = 000000000000000000000000000279;
const String _videoIdtwo = 'https://youtu.be/NyoEDpY_uyM?t=';
const double _startSecondstwo = 000000000000000000000000000319;
const String _videoIdthree = 'https://youtu.be/ipiewC3QP-k?t=';
const double _startSecondsthree = 000000000000000000000000000343;
const String _videoIdfour = 'https://youtu.be/CxL1b7nEFxA?t=';
const double _startSecondsfour = 000000000000000000000000000188;
const String _videoIdfive = 'https://youtu.be/w-mGzVdTVUI?t=';
