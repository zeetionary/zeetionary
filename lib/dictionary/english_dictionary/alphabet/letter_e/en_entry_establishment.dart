...
کوردی: دامەزراندن، دانان، سازدان، بنیات‌نان، سەقامگیرکردن، جێگیرکردن، داکوتاندن، داکوتان، دامەزران، تێ‌نیشتن، بنیات‌نران،	دەزگا، دەزگاوبەرە، دووکان، دامەزرە، دامەزراوە، دام‌ودەزگا،	کۆمەڵە قانوون،	کلێسەی فەرمی،	دەس‌پێکردن، دەس‌بەکاربوون، کەوتنەکار، دەس‌ڕۆیشتووان، دەسەڵات‌داران، ڕایەداران، دەسەڵات‌بەدەستان، ھێزبەدەستان، دەسداران، چینی سەردەست، کۆمەڵی کلیلی، دەزگای دەسەڵات‌دار
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) دامەزراوەیەک، ڕێکخراوەیەکی گەورە، یان ھوتێلێک"""),
          SentencesRow(
            englishText:
                """She's now running a small government research establishment.""",
            kurdishText:
          ...
          SentencesRow(
            englishText:
                """The members were drawn from the ranks of the Establishment.""",
            kurdishText: """ئەندامەکان لە کەسانی دەس‌ڕۆیشتوو ھەڵبژێردران.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """دەسەڵات‌بەدەستانی بەریتانیا ھێواشن لە پەسەندکردنی گۆڕانکاریدا.""",
...
const String _videoIdthree = 'YCnFYvL17v4';
const double _startSecondsthree = 1355;
const String _videoIdfour = '1jm3K9cm3vI';
const double _startSecondsfour = 2327;
