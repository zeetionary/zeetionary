...
کوردی: ئەرک، پەیور، کار، کاری تایبەت، تایبەت‌کار، پیشە، فرمان، کردار، کردەوە، کارکرد(ن)،	مەبەست، ئامانج،	ئەنجام، پێئاژۆ، ئاکام،	چالاکی،	پلەوپایە،	ئاهەنگ، ڕێ‌وڕەسم، سووران،	(بیرکاری) فانکشن،	(کامپیوتێر) کردار
"""),
// With short examples define "function", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """یانەکە ئەرکێکی بەسوودی هەیە وەک جێگایەکی کۆبوونەوە.""",
                          ...
                          children: [
                            ...
                            SentencesRow(
                              englishText:
                                  """Fortunately, his head injuries left his bodily functions unimpaired.""",
                              kurdishText:
                                  """خۆشبەختانە، برینەکانی سەری ئەرکەکانی جەستەکانی بێ زیان هێشتەوە.""",
                            ...
                            SentencesRow(
                              englishText:
                                  """Within two weeks of quitting smoking, your lung function can improve as much as 30%""",
                              kurdishText:
                                  """لە ماوەی دوو هەفتە لە وازهێنان لە جگەرەکێشان، سییەکانت دەکرێت بە ڕێژەی ٣٠٪ باشتر بن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The hall provided a venue for weddings and other functions.""",
                      kurdishText:
                          """هۆڵەکە شوێنێک بوو بۆ ئاهەنگی هاوسەرگیری و بۆنەکانی دیکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پێشوازییەکە ڕێکدەخرێت لە ژووری بۆنەکانی هوتێلەکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) بڕێک کە بەهاکەی پشت بە بەهای شتێکی دیکە دەبەستێت. لە 2x=y, y بەهای گۆڕاوی x دەبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئێستاکە گەرماوێکمان هەیە کە کار دەکات.""",
...
const String _videoIdtwo = 'https://youtu.be/iKv4oc2zbeA?t=';
const double _startSecondstwo = 000000000000000000000000000857;
const String _videoIdthree = 'https://youtu.be/yRmOWcWdQAo?t=';
const double _startSecondsthree = 0000000000000000000000000001015;
