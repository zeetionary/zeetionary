...
class EnglishEntrygeologically extends StatefulWidget {
  const EnglishEntrygeologically({super.key});

  @override
  State<EnglishEntrygeologically> createState() =>
      _EnglishEntrygeologicallyState();
}

class _EnglishEntrygeologicallyState extends State<EnglishEntrygeologically> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "geologically";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""geologically""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Geologically speaking, 500 million years is a very short time.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """geologically""",
                      // alsoEnglishWord: "also: geologically",
                      britshText: """IpaUK: /ˌdʒiːəˈlɒdʒɪkli/""",
                      americanText: """IpaUS: /ˌdʒiːəˈlɑːdʒɪkli/""",
...
// With short examples define "geologically", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بەشێوەیەک کە پەیوەندیدارە بە زانستی لێکۆڵینەوە لە پێکهاتەی زەوی، لە نێوانیاندا بنەچە و مێژووی ئەو بەرد و خۆڵەی کە زەوی پێکدەهێنن؛ بە شێوەیەک کە پەیوەندیدارە بە بنەچە و مێژووی بەرد و خۆڵی ناوچەیەکی دیاریکراو"""),
                    SentencesRow(
                      englishText:
                          """Geologically speaking, 500 million years is a very short time.""",
                      kurdishText:
                          """لە لایەنی زەوی‌ناسییەوە قسە بکەین، ٥٠٠ ملیۆن ساڵ کاتێکی زۆر کەمە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/DqF-gEPcgPo?t=';
const double _startSecondsend = 000000000000000000000000000929;
const String _videoIdone = 'https://youtu.be/-SL9KRvzVmo?t=';
const double _startSecondsone = 000000000000000000000000000154;
const String _videoIdtwo = 'https://youtu.be/k-vm3ZWnMWk?t=';
const double _startSecondstwo = 000000000000000000000000000961;
const String _videoIdthree = 'https://youtu.be/VbF1AJPqP1M?t=';
const double _startSecondsthree = 00000000000000000000000000083;
const String _videoIdfour = 'https://youtu.be/bpSeijzXuC0?t=';
const double _startSecondsfour = 000000000000000000000000000572;
const String _videoIdfive = 'https://youtu.be/rqqVOcg1_AY?t=';
