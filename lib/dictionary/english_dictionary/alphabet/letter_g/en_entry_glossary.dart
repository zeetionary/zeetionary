...
class EnglishEntryglossary extends StatefulWidget {
  const EnglishEntryglossary({super.key});

  @override
  State<EnglishEntryglossary> createState() => _EnglishEntryglossaryState();
}

class _EnglishEntryglossaryState extends State<EnglishEntryglossary> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""glossary""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glossary""",
                      // alsoEnglishWord: "also: glossary",
                      britshText: """IpaUK: /ˈɡlɒsəri/""",
                      americanText: """IpaUS: /ˈɡlɑːsəri/""",
...
// With short examples define "glossary", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """فەرهەنگۆکێکی دەستەواژەکانی ئەسپسواری کۆکردووەتەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ersq3x0xFM4?t=';
const double _startSecondsend = 000000000000000000000000000553;
const String _videoIdone = 'https://youtu.be/uq4Vi8PyBFM?t=';
const double _startSecondsone = 0000000000000000000000000001004;
const String _videoIdtwo = 'https://youtu.be/l1FXQMmXYoA?t=';
const double _startSecondstwo = 000000000000000000000000000237;
const String _videoIdthree = 'https://youtu.be/sZOuz_laH9I?t=';
const double _startSecondsthree = 00000000000000000000000000046;
const String _videoIdfour = 'https://youtu.be/zBWVfz6GEgk?t=';
const double _startSecondsfour = 000000000000000000000000000909;
const String _videoIdfive = 'https://youtu.be/AR0Qo3-lfas?t=';
const double _startSecondsfive = 0000000000000000000000000001053;
