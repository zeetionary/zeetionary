...
کوردی: بەرامبەر، هاوسەنگ، هاوئەندازە، هاوچەند، هاونرخ، هاوواتا، هاوتا، هاوشێوە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) شتێک، بڕێک، وشەیەک، هتد کە لە بەها، واتا یان مەبەستدا یەکسانە لەگەڵ شتێکی تر"""),
          SentencesRow(
            englishText: """Send €20 or the equivalent in your own currency.""",
            kurdishText: """٢٠ یۆرۆ یان هاونرخەکەی بە دراوی خۆت بنێرە.""",
          ...
          SentencesRow(
            englishText:
                """Is there a French word that is the exact equivalent of the English word ‘home’?""",
            kurdishText:
                """وشەیەکی فەرەنسی هەیە کە هاو واتای وشەی ئینگلیزی 'home' بێت؟""",
          ...
          SentencesRow(
            englishText:
                """There is no English equivalent for "bon appetit" so we have adopted the French expression.""",
            kurdishText:
                """هیچ هاوتایەکی ئینگلیزی بۆ 'bon appetit' نییە بۆ دەستەواژە فەرەنسییەکەمان وەرگرتووە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ھاوەڵناو) کە هاوتایە لە بەها، نرخ، بڕ، گرنگی، هتد"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Eight kilometres is roughly equivalent to five miles.""",
            kurdishText: """هەشت کیلۆمەتر بەنزیکەیی هاوتایە لەگەڵ پێنج میل.""",
          ...
          SentencesRow(
            englishText:
                """She's doing the equivalent job in the new company but for more money.""",
            kurdishText:
                """هەمان ئیش لە کۆمپانیایەکی تازە دەکات بەڵام بە پارەی زیاتر.""",
...
const double _startSecondsend = 000000000000000000000000000000; // 1751;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/QiKZYt9070U?t=';
const double _startSecondsone = 00000000000000000000000000000; // 380;
...
const double _startSecondsthree = 000000000000000000000000000; // 1426;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/T48_SrFCdaQ?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 193;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/UvjSXBqQe4A?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 479;
