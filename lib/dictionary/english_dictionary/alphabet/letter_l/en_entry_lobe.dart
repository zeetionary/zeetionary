...
class EnglishEntrylobe extends StatefulWidget {
  const EnglishEntrylobe({super.key});

  @override
  State<EnglishEntrylobe> createState() => _EnglishEntrylobeState();
}

class _EnglishEntrylobeState extends State<EnglishEntrylobe> {
  @override
  void initState() {
    super.initState();
