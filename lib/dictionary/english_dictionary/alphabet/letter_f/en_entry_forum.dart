...
class EnglishEntryforum extends StatefulWidget {
  const EnglishEntryforum({super.key});

  @override
  State<EnglishEntryforum> createState() => _EnglishEntryforumState();
}

class _EnglishEntryforumState extends State<EnglishEntryforum> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forum (Derived forms: forums, fora)
1. A public meeting or assembly for open discussion
 
2. A public facility to meet for open discussion (= assembly, meeting place)
 
3. An internet message board where users can post messages on a topic of shared interest
""",
  );

  final String keyword = "forum";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We will be hosting a two-day forum on childcare.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forum""",
                      // alsoEnglishWord: "also: forum",
                      britshText: """IpaUK: /ˈfɔːrəm/""",
                      americanText: """IpaUS: /ˈfɔːrəm/""",
...
// With short examples define "forum", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Television is now an important forum for political debate.""",
                      kurdishText:
                          """تەلەفیزیۆن ئێستا گۆڕەپانێکی گرنگە بۆ دیبەیتی سیاسی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بیرگەیەکی دوو ڕۆژە لەسەر چاودێریی منداڵان ڕێک دەخەین.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It's a forum where mothers can exchange advice, support and gossip.""",
                      kurdishText:
                          """یانەیەکە کە دایکان دەتوانن تێیدا ڕاوێک، پشتیوانی و قسەڵۆک بگۆڕنەوە.""",
...
const String _videoIdone = 'https://youtu.be/VRJzvJ5XPQI?t=';
const double _startSecondsone = 000000000000000000000000000730;
const String _videoIdtwo = 'https://youtu.be/LwZIxGAG8xA?t=';
const double _startSecondstwo = 000000000000000000000000000481;
const String _videoIdthree = 'https://youtu.be/7eM7pb5M5DU?t=';
const double _startSecondsthree = 0000000000000000000000000002735;
const String _videoIdfour = 'https://youtu.be/Hw1X5oFPgro?t=';
const double _startSecondsfour = 000000000000000000000000000614;
const String _videoIdfive = 'https://youtu.be/8PJGIEz5YJ4?t=';
const double _startSecondsfive = 0000000000000000000000000001604;
