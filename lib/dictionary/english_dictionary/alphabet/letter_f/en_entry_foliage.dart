...
class EnglishEntryfoliage extends StatefulWidget {
  const EnglishEntryfoliage({super.key});

  @override
  State<EnglishEntryfoliage> createState() => _EnglishEntryfoliageState();
}

class _EnglishEntryfoliageState extends State<EnglishEntryfoliage> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foliage (Derived forms: foliages)
1. The main organ of photosynthesis and transpiration in higher plants (= leaf, leafage)
 
2. (architecture) leaf-like architectural ornament (= foliation)
 
3. A cluster of plant leaves
""",
  );

  final String keyword = "foliage";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foliage""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The dense foliage overhead almost blocked out the sun.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foliage""",
                      // alsoEnglishWord: "also: foliage",
                      britshText: """IpaUK: /ˈfəʊliɪdʒ/""",
                      americanText: """IpaUS: /ˈfəʊliɪdʒ/""",
...
// With short examples define "foliage", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لق‌وپۆپەکەی سەرەوە بەنزیکەیی تیشكی خۆری قەتیس کردبوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/FQ3Z-8MCuxs?t=';
const double _startSecondsend = 0000000000000000000000000001006;
const String _videoIdone = 'https://youtu.be/LbPw9AlVKVM?t=';
const double _startSecondsone = 000000000000000000000000000261;
const String _videoIdtwo = 'https://youtu.be/C1oxhniG_Fc?t=';
const double _startSecondstwo = 0000000000000000000000000001190;
const String _videoIdthree = 'https://youtu.be/8mCcM-PUmLM?t=';
const double _startSecondsthree = 000000000000000000000000000257;
const String _videoIdfour = 'https://youtu.be/1_ogluZE5AM?t=';
const double _startSecondsfour = 00000000000000000000000000067;
const String _videoIdfive = 'https://youtu.be/cRLnR4Kot2M?t=';
