...
class EnglishEntrylistlessness extends StatefulWidget {
  const EnglishEntrylistlessness({super.key});

  @override
  State<EnglishEntrylistlessness> createState() => _EnglishEntrylistlessnessState();
}

class _EnglishEntrylistlessnessState extends State<EnglishEntrylistlessness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: listlessness
1. A feeling of lack of interest or energy (- languor, lassitude)
 
2. Inactivity resulting from lethargy and lack of vigour or energy (- torpidity, torpidness, torpor)
""",
  );

  final String keyword = "listlessness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""listlessness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A lack of iron in the body can lead to listlessness and a lack of concentration.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/CXRxrYBgUIo?t=164';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/54F69B35L34?t=216';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/5RnVfYzIvmU?t=687';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/CyYVtojfcWQ?t=412';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/yi87xlmOjP8?t=351';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/S5r5JQCNuGM?t=56';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """listlessness""",
                      // alsoEnglishWord: "also: listlessness",
                      britshText: """IpaUK: /ˈlɪstləsnəs/""",
                      americanText: """IpaUS: /ˈlɪstləsnəs/""",
...
کوردی: وەڕەزی، داهێزراوی، بێ‌حاڵی، دڵ‌مردوویی، بێ‌کەیفی، بێ‌مەیلی، ماندوویی، کەشەنگی، شەکەتی
"""),
// With short examples define "listlessness", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) کە بەبێ هیچ وزە و توانایەک بیت بۆ کردنی شتێک"""),
                    const AlsoEnglishckb(word: "ھەروەھا: lethargy"),
                    SentencesRow(
                      englishText: """A lack of iron in the body can lead to listlessness and a lack of concentration.""",
                      kurdishText: """کەمی ئاسن لە لەشدا دەکرێت ببێتە هۆکاری وەڕەزی و کەمی توانای سەرنجدان.""",
