...
// replace these: replace EnglishEntryagoraphobia - replace speakAgoraphobia - replace agoraphobia - /ˌæɡərəˈfəʊbiə/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryagoraphobia extends StatelessWidget {
  EnglishEntryagoraphobia({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAgoraphobia(String languageCode) async {
    // DOPSUM: CHANGE speakAgoraphobia
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("agoraphobia"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAgoraph6922(String languageCode) async {
    ...
    await flutterTts.speak(
        "She had agoraphobia and never wanted to go out of the house."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "agoraphobia", // DOPSUM: CHANGE WORD ENTRY - Find /ˌæɡərəˈfəʊbiə/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌæɡərəˈfəʊbiə/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˌæɡərəˈfəʊbiə/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "ئەگۆرافۆبیای ھەبوو و ھەرگیز نەیدەویست لە ماڵە دەربچێت",
                                    textAlign: TextAlign
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'Ha23BbieZO8';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '4hvSoj2VIyQ';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '9jsP4ev8O00';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'IB5outFW0fU';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'f-IlwHERGxI';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'ra8gUzMUuXY';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'DODscEECMuc';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = '-HNq1dTDL5Q';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = 'BNoKy8VSVuI';
