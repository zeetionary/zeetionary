...
class EnglishEntryfleeting extends StatefulWidget {
  const EnglishEntryfleeting({super.key});

  @override
  State<EnglishEntryfleeting> createState() => _EnglishEntryfleetingState();
}

class _EnglishEntryfleetingState extends State<EnglishEntryfleeting> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fleeting
1. Lasting for a markedly brief time (= fugitive, momentaneous, momentary)
"a fleeting glance";
""",
  );

  final String keyword = "fleeting";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fleeting""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We paid a fleeting visit to Paris.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fleeting""",
                      // alsoEnglishWord: "also: fleeting",
                      britshText: """IpaUK: /ˈfliːtɪŋ/""",
                      americanText: """IpaUS: /ˈfliːtɪŋ/""",
...
// With short examples define "fleeting", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """We paid a fleeting visit to Paris.""",
                      kurdishText: """گەشتێکی خێرای پاریسمان کرد.""",
...
const String _videoIdtwo = 'https://youtu.be/9WBqHdI5Bdw?t=';
const double _startSecondstwo = 00000000000000000000000000045;
const String _videoIdthree = 'https://youtu.be/wGSOMKSRjkc?t=';
const double _startSecondsthree = 0000000000000000000000000001179;
const String _videoIdfour = 'https://youtu.be/ilj8fZroRw0?t=';
const double _startSecondsfour = 0000000000000000000000000004247;
