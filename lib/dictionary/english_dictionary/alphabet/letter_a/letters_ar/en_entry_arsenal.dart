                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arsenal"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɑːsənl/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakarsenal("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrsənl/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakarsenal("en-US"),
                            ),
                          ],
                        ),
                      ],
...
کوردی: جبەخانە، قۆڕخانە، باڕووت‌خانە، چەک‌وچۆڵ، چەکەمەنی، (کارخانە) چەک‌سازی، تۆکمەسازی، عەمباری چەک‌وچۆڵ و تەقەمەنی، عەمبار، کۆگا، ھەمار، پاشکەوت‌خانە
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakarsenal825("en-US"),
                          ),
...
٢. (ناو) کۆگای چەک و تەقەمەنی"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakarsenal826("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'hEcaWua1lp0';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 1554;
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final double _startSeconds = 3703;
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'kE3La8u5bnw';
