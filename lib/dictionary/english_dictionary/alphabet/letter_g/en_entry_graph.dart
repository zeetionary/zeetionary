...
class EnglishEntrygraph extends StatefulWidget {
  const EnglishEntrygraph({super.key});

  @override
  State<EnglishEntrygraph> createState() => _EnglishEntrygraphState();
}

class _EnglishEntrygraphState extends State<EnglishEntrygraph> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: graph (Derived forms: graphs)
1. A visual representation of the relations between certain quantities, represented as points, plotted with reference to a set of axes (- graphical record, graphical recording)
 
2. A visual display of information (- chart)
 
3. A written symbol that is used to represent speech (- character, grapheme, graphic symbol)

- Verb: graph (Derived forms: graphed, graphing, graphs)
1. Represent by means of a graph (- chart)
"graph the data";
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Plot a graph of height against age.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """graph""",
                      // alsoEnglishWord: "also: graph",
                      britshText: """IpaUK: /ɡrɑːf/""",
                      americanText: """IpaUS: /ɡræf/""",
...
// With short examples define "graph", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) هێلکارییەک کە هێڵێک یان یان زیاتری تێدایە و پیشانی دەدات چۆن ژمارەیەک ژمارە پەیوەندیدارن بە یەکەوە"""),
                    SentencesRow(
                      englishText: """Plot a graph of height against age.""",
                      kurdishText: """هیڵکارییەکی بەرزی دژ بە تەمەن بکێشە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/V_TulH374hw?t=';
const double _startSecondsend = 00000000000000000000000000056;
const String _videoIdone = 'https://youtu.be/GowxEMHTeh0?t=';
const double _startSecondsone = 00000000000000000000000000017;
const String _videoIdtwo = 'https://youtu.be/PQrFjthwOWQ?t=';
const double _startSecondstwo = 000000000000000000000000000142;
const String _videoIdthree = 'https://youtu.be/gVGlA4jdQso';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/LFKZLXVO-Dg?t=';
const double _startSecondsfour = 00000000000000000000000000062;
const String _videoIdfive = 'https://youtu.be/I6GJVvwUEGk?t=';
