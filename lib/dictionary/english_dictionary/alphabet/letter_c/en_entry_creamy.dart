...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakcreamys1(String languageCode) async {
    ...
    await flutterTts.speak(
        "// speakcreamys111111111111111111111111111111111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcreamys2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcreamys200"); // DOPSUM: CHANGE TEXT
  }
                ...
                child: Column(
                  children: [
                    ExampleSentenceEnglish(
                        text:
                            "// speakcreamys111111111111111111111111111111111"),
