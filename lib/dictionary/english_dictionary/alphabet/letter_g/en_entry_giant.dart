...
class EnglishEntrygiant extends StatefulWidget {
  const EnglishEntrygiant({super.key});

  @override
  State<EnglishEntrygiant> createState() => _EnglishEntrygiantState();
}

class _EnglishEntrygiantState extends State<EnglishEntrygiant> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The match was shown on a giant screen outside the building.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He is described as a gentle giant.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He's a giant of a man.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The Amazon is a giant among rivers.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""These are boom times for the software giant.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """giant""",
                      // alsoEnglishWord: "also: giant",
                      britshText: """IpaUK: /ˈdʒaɪənt/""",
                      americanText: """IpaUS: /ˈdʒaɪənt/""",
...
کوردی: دێو، مرۆ، گیا یان گیانەوەری یەکجار گەورە، نەڕەدێو، مرۆی زەبەلاح، فیتەر، تەژە، فیلەتەن، گیانەوەری زۆرزەلام،	زۆرزەلام، زەبەلاح، تەژە، یەکجار گەورە، نەترەبۆق
"""),
// With short examples define "giant", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) ئێجگار گەورە"""),
                    SentencesRow(
                      englishText:
                          """The match was shown on a giant screen outside the building.""",
                      kurdishText:
                          """ئارییەکە لەسەر شاشەیەکی زەبەلاح لە دەرەوەی بیناکە پیشان درا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Dad terrified us with stories of a big, bad giant who ate little children.""",
                      kurdishText:
                          """باوکە ترساندمانی بە چیرۆکی دێوی گەورەی خراپ کە منداڵی بچووکی دەخوارد.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He's a giant of a man.""",
                      kurdishText: """پیاوێکی زەبەلاحە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The Amazon is a giant among rivers.""",
                      kurdishText: """ئەمازۆن لەناو ڕووبارەکاندا زەبەلاحە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەمانە کاتی بوژانەوەن بۆ دامەزراوە زەبەلاحە نەرمامێرەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The company is now one of the giants of the computer industry.""",
                      kurdishText:
                          """کۆمپانیاکە ئێسا یەکێکە لە زەبەلاحەکانی پیشەسازیی کۆمپیوتەر.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Toni Morrison is one of the twentieth century's literary giants.""",
                      kurdishText:
                          """تۆنی مۆریسن یەکێکە لە باشترینە ئەدەبییەکانی سەدەی بیست.""",
...
const double _startSecondsend = 0000000000000000000000000001706;
const String _videoIdone = 'https://youtu.be/e09xig209cQ?t=';
const double _startSecondsone = 000000000000000000000000000121;
const String _videoIdtwo = 'https://youtu.be/SOeAThye5rQ?t=';
const double _startSecondstwo = 000000000000000000000000000147;
const String _videoIdthree = 'https://youtu.be/x8sFfsIiU2s?t=';
const double _startSecondsthree = 0000000000000000000000000009;
const String _videoIdfour = 'https://youtu.be/rci9SXMaiHY';
