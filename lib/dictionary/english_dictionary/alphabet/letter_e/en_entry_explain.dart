...
class EnglishEntryexplain extends StatefulWidget {
  const EnglishEntryexplain({super.key});

  @override
  State<EnglishEntryexplain> createState() => _EnglishEntryexplainState();
}

class _EnglishEntryexplainState extends State<EnglishEntryexplain> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""explain""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """explain""",
                      // alsoEnglishWord: "also: explain",
                      britshText: """IpaUK: /ɪkˈspleɪn/""",
                      americanText: """IpaUS: /ɪkˈspleɪn/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""First, I'll explain the rules of the game.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The theory is not explained in detail.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It was difficult to explain the concept to beginners.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Can you explain how this machine works?""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It was explained that attendance was compulsory.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She tried to explain but he wouldn't listen.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Alex explained that his car had broken down.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Well, that doesn't explain why you didn't phone.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Please explain your reasons.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Oh well then, that explains it.""");
  }
...
کوردی: 
"""),
          const DefinitionKurdish(text: """١. (کردار) ڕوونکردنەوەی شتێک"""),
          SentencesRow(
            englishText: """First, I'll explain the rules of the game.""",
            kurdishText: """سەرەتا، یاساکانی یارییەکە ڕوون دەکەمەوە.""",
          ...
          Column(
            children: [
              MyExpansionTile(
                children: [
                  SentencesRow(
                    englishText: """The theory is not explained in detail.""",
                    kurdishText: """بیردۆزەکە بە وردی ڕوون نەکراوەتەوە.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """قورس بوو چەمکەکە بۆ ئەوانەی ئاستی سەرەتا ڕوون بکرێتەوە.""",
                  ...
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """Can you explain how this machine works?""",
                    kurdishText:
                        """دەتوانیت ڕوونی بکەیتەوە ئەم ئامێرە چۆن کار دەکات؟""",
                  ...
                  SentencesRow(
                    englishText:
                        """She explained to the children exactly what to do in an emergency.""",
                    kurdishText:
                        """بۆ منداڵەکانی ڕوونکردەوە ڕێک چی بکەن لە فریاگوزارییەک.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText: """ئەوە ڕوونکرایەوە بەژداری کردن ناچارییە.""",
          ...
          const DefinitionKurdish(
              text: """٢. (کردار) پێدانی هۆکاریک؛ بوون بە هۆکاریک"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """She tried to explain but he wouldn't listen.""",
            kurdishText: """هەوڵی دا ڕوونی بکاتەوە بەڵام گوێی نەدەگرت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Alex explained that his car had broken down.""",
            kurdishText: """ئەلێکس ڕوونی کردەوە ئۆتۆمبێلەکەی شکابوو.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Well, that doesn't explain why you didn't phone.""",
            kurdishText: """دەی، ئەو ڕوونی ناکاتەوە بۆچی پەیوەندی نەکرد.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Please explain your reasons.""",
            kurdishText: """تکایە هۆکارەکانت بڵێ.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ئاه زۆر باشە، ئەوە ڕوونی دەکاتەوە.""",
          ...
          SentencesRow(
            englishText:
                """The government now has to explain its decision to the public.""",
            kurdishText:
                """حکومەت ئێستا دەبێت بڕیارەکەی بۆ خەڵکی ڕوون بکاتەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: explain (Derived forms: explained, explains, explaining)
1. Make plain and comprehensible (= explicate)
"He explained the laws of physics to his students";
 
2. Give details; define scope and structure
"The committee explained their plan for fund-raising to the Dean"
 
3. Serve as a reason, cause or justification of (= excuse)
...
const double _startSecondsend = 000000000000000000000000000000; // 100;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/DesEUpFgGrQ?t=';
const double _startSecondsone = 00000000000000000000000000000; // 288;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/r8E1Hq5tktg?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 44;
const String _videoIdthree = 'VIDEOhttps://youtu.be/U1KGRnWjllg?t=';
const double _startSecondsthree = 000000000000000000000000000; // 509;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/dfuPBC-v5NE?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1456;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/8pEcvteQo9g?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 19;
