...
// Define the word "ashtray" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryashtray - replace speakAshtray

// replace ashtray - /ˈæʃtreɪ/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryashtray extends StatelessWidget {
  // blank divider
  EnglishEntryashtray({super.key});
  // blank divider
  ...
  Future<void> speakashtray(String languageCode) async {
    ...
    await flutterTts.speak("ashtray");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "ashtray"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæʃtreɪ/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæʃtreɪ/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'cIFdCtdawzo';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'L3XXITD1gCY';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'uQH58QPhMpk';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'eIJLELu2RjY';
  final double _startSeconds = 16419;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'V7_rjQO9ikk';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = '06pTuluOydQ';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = '7PKk-ua_0IU';
