...
class EnglishEntryfraternize extends StatefulWidget {
  const EnglishEntryfraternize({super.key});

  @override
  State<EnglishEntryfraternize> createState() => _EnglishEntryfraternizeState();
}

class _EnglishEntryfraternizeState extends State<EnglishEntryfraternize> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: fraternize (Derived forms: fraternizing, fraternizes, fraternized)
1. Be on friendly terms with someone, as if with a brother, especially with an enemy (= fraternise [Brit])
"War-weary soldiers fraternize with their enemies";
""",
  );

  final String keyword = "fraternize";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fraternize""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She was accused of fraternizing with the enemy.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Do the doctors fraternize much with the nurses here?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fraternize""",
                      // alsoEnglishWord: "also: fraternize",
                      britshText: """IpaUK: /ˈfrætənaɪz/""",
                      americanText: """IpaUS: /ˈfrætərnaɪz/""",
...
کوردی: 
"""),
// With short examples define "fraternize", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) مامەڵە کردن لەگەڵ کەسێک بە دۆستانە، بە تایبەتی کە نابێت بەو شێوەیە بیت"""),
                    SentencesRow(
                      englishText:
                          """She was accused of fraternizing with the enemy.""",
                      kurdishText: """تاوانبار کرا بە دۆستایەتی کردنی دوژمن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لێرە پزیشکان گاڵتەوگەپ لەگەڵ پەرستاران دەکەن؟""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/xOIfhZygk5Y?t=';
const double _startSecondsend = 0000000000000000000000000001965;
const String _videoIdone = 'https://youtu.be/ItfFOpZ8no8?t=';
const double _startSecondsone = 000000000000000000000000000727;
const String _videoIdtwo = 'https://youtu.be/2FUaKz0Ie-M?t=';
const double _startSecondstwo = 000000000000000000000000000991;
const String _videoIdthree = 'https://youtu.be/XV_0gLNgCD8?t=';
const double _startSecondsthree = 0000000000000000000000000002188;
const String _videoIdfour = 'https://youtu.be/xz4GnxHOitM?t=';
const double _startSecondsfour = 00000000000000000000000000088;
const String _videoIdfive = 'https://youtu.be/X8Hw8zeCDTA?t=';
const double _startSecondsfive = 0000000000000000000000000005097;
