...
class EnglishEntryhasty extends StatefulWidget {
  const EnglishEntryhasty({super.key});

  @override
  State<EnglishEntryhasty> createState() => _EnglishEntryhastyState();
}

class _EnglishEntryhastyState extends State<EnglishEntryhasty> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hasty (Derived forms: hastier, hastiest)
1. Excessively quick (- headlong, Gadarene, gadarene)
"made a hasty exit";
 
2. Done with very great haste and without due deliberation (- overhasty, precipitate, precipitant, precipitous)
"hasty marriage seldom proveth well";
""",
  );

  final String keyword = "hasty";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We made a hasty departure.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The army beat a hasty retreat.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hasty""",
                      // alsoEnglishWord: "also: hasty",
                      britshText: """IpaUK: /ˈheɪsti/""",
                      americanText: """IpaUS: /ˈheɪsti/""",
...
// With short examples define "hasty", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The army beat a hasty retreat.""",
                      kurdishText: """سوپا کشانەوەیەکی خێرای ئەنجامدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/nyVOi3X53bk';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/vstnLLViSgM?t=';
const double _startSecondsone = 0000000000000000000000000004283;
const String _videoIdtwo = 'https://youtu.be/nyVOi3X53bk';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/Q-nWA0WeF98?t=';
const double _startSecondsthree = 0000000000000000000000000001799;
const String _videoIdfour = 'https://youtu.be/knjliFs3gR8?t=';
const double _startSecondsfour = 000000000000000000000000000207;
const String _videoIdfive = 'https://youtu.be/y0y7VeF9JI4?t=';
const double _startSecondsfive = 000000000000000000000000000272;
