...
class EnglishEntryactivist extends StatefulWidget {
  const EnglishEntryactivist({super.key});

  @override
  State<EnglishEntryactivist> createState() => _EnglishEntryactivistState();
}

class _EnglishEntryactivistState extends State<EnglishEntryactivist> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""activist""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """activist""",
                      // alsoEnglishWord: "also: activist",
                      britshText: """IpaUK: /ˈæktɪvɪst/""",
                      americanText: """IpaUS: /ˈæktɪvɪst/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'wVXFxARO04A';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'hlTEGQ3D4O0';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'ZaKuW_lhIy8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'hkTPhoGeSJU';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'n2awj5rUWzo';
