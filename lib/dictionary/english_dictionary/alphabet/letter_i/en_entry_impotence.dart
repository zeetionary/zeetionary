...
class EnglishEntryimpotence extends StatefulWidget {
  const EnglishEntryimpotence({super.key});

  @override
  State<EnglishEntryimpotence> createState() => _EnglishEntryimpotenceState();
}

class _EnglishEntryimpotenceState extends State<EnglishEntryimpotence> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impotence""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'dV0H159rXt8';
    const double startSecondsend = 0;
    const String videoIdone = 'K4Ze-Sp6aUE';
    const double startSecondsone = 11219;
    const String videoIdtwo = '6ISOK-XtvYs';
    const double startSecondstwo = 132;
    const String videoIdthree = '4EBMk4ZKszk';
    const double startSecondsthree = 474;
    const String videoIdfour = '-ebMbqkdQdg';
    const double startSecondsfour = 251;
    const String videoIdfive = '8kWjJPQXCyc';
    const double startSecondsfive = 2002;
