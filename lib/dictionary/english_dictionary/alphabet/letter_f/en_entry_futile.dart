...
// With short examples define "futile", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ھەوڵەکانیان بۆ زیندووکردنەوەی ئەو بێھوودە بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کۆتا ھەوڵی بێ‌ھوودەی دا بۆ کردنەوەی دەرگاکە.""",
...
const String _videoIdend = 'S3ksC_8jGuc';
const double _startSecondsend = 83;
const String _videoIdone = 'SwQhKFMxmDY';
const double _startSecondsone = 3201;
const String _videoIdtwo = '7eM7pb5M5DU';
const double _startSecondstwo = 382;
const String _videoIdthree = 'TSmEn1qfhnU';
const double _startSecondsthree = 661;
const String _videoIdfour = '8X1xYpPmKvA';
const double _startSecondsfour = 4106;
const String _videoIdfive = '4IaOeVgZ-wc';
const double _startSecondsfive = 3117;
