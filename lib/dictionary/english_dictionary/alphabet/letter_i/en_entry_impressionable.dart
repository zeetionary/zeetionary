...
class EnglishEntryimpressionable extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impressionable""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 2022;
    const String videoIdtwo = 'gqibxjObZ-I';
    const double startSecondstwo = 1044;
    const String videoIdthree = '_h95pZQiKwI';
    const double startSecondsthree = 608;
    const String videoIdfour = 'lknCE7fn7k8';
    const double startSecondsfour = 584;
    const String videoIdfive = 'EmT0i0xG6zg';
