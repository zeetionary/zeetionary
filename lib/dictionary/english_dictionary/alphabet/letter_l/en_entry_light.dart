...
class EnglishEntrylight extends StatefulWidget {
  const EnglishEntrylight({super.key});

  @override
  State<EnglishEntrylight> createState() => _EnglishEntrylightState();
}

class _EnglishEntrylightState extends State<EnglishEntrylight> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylight light
WORD_WEB light light light
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "light";
...
کوردی: 
"""),
// With short examples define "light", please follow LX instructions
