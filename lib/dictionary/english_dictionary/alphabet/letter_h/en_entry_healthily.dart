...
class EnglishEntryhealthily extends StatefulWidget {
  const EnglishEntryhealthily({super.key});

  @override
  State<EnglishEntryhealthily> createState() => _EnglishEntryhealthilyState();
}

class _EnglishEntryhealthilyState extends State<EnglishEntryhealthily> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: healthily
1. In a manner that is good for the health; in a healthy manner
"How can I eat healthily at home?"; "an effort to take care of your health will help you to live healthily and live longer"
...
""",
  ...
  final String keyword = "healthily";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""healthily""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You should eat healthily.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His skin shone healthily.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The relationship developed and matured healthily.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The economy grew healthily.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """healthily""",
                      // alsoEnglishWord: "also: healthily",
                      britshText: """IpaUK: /ˈhelθɪli/""",
                      americanText: """IpaUS: /ˈhelθɪli/""",
...
کوردی: تەندروستانە، لەش‌ساغانە
"""),
// With short examples define "healthily", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) بە شێوەیەکی تەندرووست"""),
                    SentencesRow(
                      englishText:
                          """A good gardener knows how to keep things growing healthily.""",
                      kurdishText:
                          """باخەوانێکی باش دەزانێت چۆن شتەکان گەشە پێ بدات بە تەندرووستانە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پەیوەندییەکە گەشەی کرد و بە تەندرووستانە پەرەی سەند.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/dR6TnC1RY_8?t=';
const double _startSecondsend = 000000000000000000000000000225;
const String _videoIdone = 'https://youtu.be/ZMaW6TamNAc?t=';
const double _startSecondsone = 000000000000000000000000000254;
const String _videoIdtwo = 'https://youtu.be/sgjhpCj_yRI?t=';
const double _startSecondstwo = 000000000000000000000000000615;
const String _videoIdthree = 'https://youtu.be/MY6nKL59L1o?t=';
const double _startSecondsthree = 000000000000000000000000000379;
const String _videoIdfour = 'https://youtu.be/wHULU5mM-Fc?t=';
const double _startSecondsfour = 000000000000000000000000000795;
const String _videoIdfive = 'https://youtu.be/1BPxcoZsZLo?t=';
const double _startSecondsfive = 0000000000000000000000000001645;
