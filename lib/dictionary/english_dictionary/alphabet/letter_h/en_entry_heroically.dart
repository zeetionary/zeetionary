...
class EnglishEntryheroically extends StatefulWidget {
  const EnglishEntryheroically({super.key});

  @override
  State<EnglishEntryheroically> createState() => _EnglishEntryheroicallyState();
}

class _EnglishEntryheroicallyState extends State<EnglishEntryheroically> {
  @override
  void initState() {
    super.initState();
...
"he became reconciled to not dying heroically in her arms"
""",
  );

  final String keyword = "heroically";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heroically""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She worked heroically to help others escape.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He heroically struggled up the hill.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heroically""",
                      // alsoEnglishWord: "also: heroically",
                      britshText: """IpaUK: /həˈrəʊɪkli/""",
                      americanText: """IpaUS: /həˈrəʊɪkli/""",
...
کوردی: قارەمانانە، پاڵەوانانە، نەبەزانە
"""),
// With short examples define "heroically", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) پننسەی پاڵەوانانە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: courageously"),
                    SentencesRow(
                      englishText:
                          """She worked heroically to help others escape.""",
                      kurdishText:
                          """پاڵەوانانە یارمەتی ئەوانی دیکەی دا هەڵبێن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) پننسە کە هەوڵی شێلگیرانە پیشان دەدات بۆ بەدەستهێنان یان سەرکەوتن لە شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He heroically struggled up the hill.""",
                      kurdishText: """کۆڵنەدەرانە بەسەر گردەکەدا دەچوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/7fcqhU-23TA?t=';
const double _startSecondsend = 00000000000000000000000000083;
const String _videoIdone = 'https://youtu.be/h3JMkm5M3N0?t=';
const double _startSecondsone = 000000000000000000000000000109;
const String _videoIdtwo = 'https://youtu.be/7ClzL-QNk7M?t=';
const double _startSecondstwo = 000000000000000000000000000836;
const String _videoIdthree = 'https://youtu.be/W_dtjcQWL34?t=';
const double _startSecondsthree = 00000000000000000000000000038;
const String _videoIdfour = 'https://youtu.be/Z7RTykOCcuI?t=';
const double _startSecondsfour = 00000000000000000000000000032;
const String _videoIdfive = 'https://youtu.be/-qMu60ecjvE?t=';
