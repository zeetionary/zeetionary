...
class EnglishEntrylogic extends StatefulWidget {
  const EnglishEntrylogic({super.key});

  @override
  State<EnglishEntrylogic> createState() => _EnglishEntrylogicState();
}

class _EnglishEntrylogicState extends State<EnglishEntrylogic> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: logic (Derived forms: logics)
...
5. A system of reasoning (- logical system, system of logic)
""",
  );

  final String keyword = "logic";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The two parts of the plan were governed by the same logic.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I can't follow the logic of what you are saying.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What kind of twisted logic is that?""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There is no logic in any of their claims.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It's a stupid decision that completely defies logic.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There doesn't seem to be any logic in the move.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/iLy0E48RPyE?t=205';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/x3PGvSJY1-s?t=687';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/uGstM8QMCjQ?t=86';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/kmgRv2V_7P4?t=72';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/bHMmniN2ovM?t=206';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/9EOazpvA7-U?t=126';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """logic""",
                      // alsoEnglishWord: "also: logic",
                      britshText: """IpaUK: /ˈlɒdʒɪk/""",
                      americanText: """IpaUS: /ˈlɑːdʒɪk/""",
...
کوردی: 
"""),
// With short examples define "logic", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) شێوازی بیرکردنەوە یان ڕوونکردنەوەی شتێک"""),
                    SentencesRow(
                      englishText: """The two parts of the plan were governed by the same logic.""",
                      kurdishText: """دوو بەشەکەی پلانەکە لە هەمان لۆژیکەوە سەرچاوەیان دەگرت.""",
                    ...
                    SentencesRow(
                      englishText: """I can't follow the logic of what you are saying.""",
                      kurdishText: """تێناگەم لە لۆژیکی ئەوەی کە دەیڵێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """What kind of twisted logic is that?""",
                      kurdishText: """ئەوە چ جۆرە لۆژیکێکی سەیر و سەمەرەیە؟""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) هۆکاری ژیرانەی کردنی شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There is no logic in any of their claims.""",
                      kurdishText: """هیچ لۆژیکێک نییە لە هیچ لە بانگەشەکانیاندا.""",
                      englishNote: """This means their statements lack reasoning or evidence to support them. The claims are baseless and do not follow any logical pattern or rationale.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """It's a stupid decision that completely defies logic.""",
                      kurdishText: """ئەوە بڕیارێکی گەمژانەیە کە تەواو دژ بە لۆژیکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There doesn't seem to be any logic in the move.""",
                      kurdishText: """وەها دیار نییە هیچ لۆژیکێک هەبێت لە جوڵەکەدا.""",
