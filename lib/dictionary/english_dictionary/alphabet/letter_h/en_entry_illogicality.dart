...
class EnglishEntryillogicality extends StatefulWidget {
  const EnglishEntryillogicality({super.key});

  @override
  State<EnglishEntryillogicality> createState() =>
      _EnglishEntryillogicalityState();
}

class _EnglishEntryillogicalityState extends State<EnglishEntryillogicality> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: illogicality (Derived forms: illogicalities)
1. Invalid or incorrect reasoning (- illogicalness, illogic, inconsequence)
""",
  );

  final String keyword = "illogicality";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""illogicality""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """He was apparently unaware of the illogicality of his statement.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/HLlP08Ol1fo?t=';
    const double startSecondsend = 000000000000000000000000000375;
    const String videoIdone = 'https://youtu.be/gEygR0EApuY?t=';
    const double startSecondsone = 000000000000000000000000000575;
    const String videoIdtwo = 'https://youtu.be/8jZqUMS91oc?t=';
    const double startSecondstwo = 0000000000000000000000000003632;
    const String videoIdthree = 'https://youtu.be/Jl1yIMdjpfg?t=';
    const double startSecondsthree = 000000000000000000000000000665;
    const String videoIdfour = 'https://youtu.be/VnsKGpvNMIw?t=';
    const double startSecondsfour = 0000000000000000000000000001660;
    const String videoIdfive = 'https://youtu.be/629cXdzN-bk?t=';
    const double startSecondsfive = 0000000000000000000000000001247;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """illogicality""",
                      // alsoEnglishWord: "also: illogicality",
                      britshText: """IpaUK: /ɪˌlɒdʒɪˈkæləti/""",
                      americanText: """IpaUS: /ɪˌlɑːdʒɪˈkæləti/""",
...
کوردی: نالۆژیکی بوون، نالۆژیکێتی
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) ئەوەی کە شتێک عاقڵانی نەبێت"""),
                    SentencesRow(
                      englishText:
                          """He was apparently unaware of the illogicality of his statement.""",
                      kurdishText:
                          """ڕووکەشانە وادیاربوو بێ‌ئاگا بێت لە نالۆژیکی قسەکەی.""",
                      englishNote:
                          """This means he didn’t seem to realize that his statement didn’t make sense or was inconsistent with logic.""",
