...
class EnglishEntryfluctuate extends StatefulWidget {
  const EnglishEntryfluctuate({super.key});

  @override
  State<EnglishEntryfluctuate> createState() => _EnglishEntryfluctuateState();
}

class _EnglishEntryfluctuateState extends State<EnglishEntryfluctuate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: fluctuate (Derived forms: fluctuates, fluctuating, fluctuated)
1. Move or sway in a rising and falling or wavelike pattern (= vacillate, waver)
"the line on the monitor fluctuated";
 
2. Cause to fluctuate or move in a wavelike pattern
 
3. Vary up and down; be unstable
"The stock market fluctuates"
""",
  );

  final String keyword = "fluctuate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fluctuate""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fluctuate""",
                      // alsoEnglishWord: "also: fluctuate",
                      britshText: """IpaUK: /ˈflʌktʃueɪt/""",
                      americanText: """IpaUS: /ˈflʌktʃueɪt/""",
...
// With short examples define "fluctuate", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) بەردەوام جووڵان لە ئەندازە، بڕ، کوالێتی، هتد"""),
                    SentencesRow(
                      englishText:
                          """The documentary follows the fluctuating fortunes of one marketing company.""",
                      kurdishText:
                          """دۆکیومێنتارییەکە باس لە سامانی زووزووگۆڕانی کۆمپانیایەکی بەبازاڕکردن دەکات.""",
                    ...
                    SentencesRow(
                      englishText:
                          """During the crisis, oil prices fluctuated between £20 and £40 a barrel.""",
                      kurdishText:
                          """لە ماوەی قەیرانەکە نرخی نەوت هەڵبەز و دابەزی بوو لە نێوان ٢٠ و ٤٠ پاوەندا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/WfVF-Ec4naQ?t=';
const double _startSecondsend = 000000000000000000000000000191;
const String _videoIdone = 'https://youtu.be/L6QJS8djygk?t=';
const double _startSecondsone = 000000000000000000000000000205;
const String _videoIdtwo = 'https://youtu.be/LbPw9AlVKVM?t=';
const double _startSecondstwo = 0000000000000000000000000001624;
const String _videoIdthree = 'https://youtu.be/jJx-f_VZK2c?t=';
const double _startSecondsthree = 000000000000000000000000000179;
const String _videoIdfour = 'https://youtu.be/6etTERFUlUI?t=';
const double _startSecondsfour = 000000000000000000000000000169;
const String _videoIdfive = 'https://youtu.be/A0sM6xVAY-A?t=';
const double _startSecondsfive = 000000000000000000000000000111;
