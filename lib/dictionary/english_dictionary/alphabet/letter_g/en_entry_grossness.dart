...
class EnglishEntrygrossness extends StatefulWidget {
  const EnglishEntrygrossness({super.key});

  @override
  State<EnglishEntrygrossness> createState() => _EnglishEntrygrossnessState();
}

class _EnglishEntrygrossnessState extends State<EnglishEntrygrossness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grossness
1. The quality of lacking taste and refinement (- coarseness, commonness, vulgarity, vulgarism, raunch)
"in the twilight zone between humour and grossness";
""",
  );

  final String keyword = "grossness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grossness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I stared at the grossness of the bathroom.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He couldn't forgive the grossness of her betrayal.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She was appalled by the grossness of his language.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grossness""",
                      // alsoEnglishWord: "also: grossness",
                      britshText: """IpaUK: /ˈɡrəʊsnəs/""",
                      americanText: """IpaUS: /ˈɡrəʊsnəs/""",
...
کوردی: بێ‌ڕەوشتی، بێ‌ماریفەتی، بێ‌ئەدەبی،	زلەیی، گمتەیی، ناهەمواری، ناقۆڵایی، نالەباری
"""),
// With short examples define "grossness", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """نەیان دەتوانی لە ئاشکرایی خیانەتەکەی خۆش بن.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ناو) ئەوەی زۆر بێ‌ڕێزانە بیت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: crudeness"),
                    SentencesRow(
                      englishText:
                          """She was appalled by the grossness of his language.""",
                      kurdishText: """تۆقا بە قێزەونی زمانی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/-o9a8YZXPUY?t=';
const double _startSecondsend = 000000000000000000000000000618;
const String _videoIdone = 'https://youtu.be/KV-SUOpW408?t=';
const double _startSecondsone = 000000000000000000000000000573;
const String _videoIdtwo = 'https://youtu.be/_rBO8neWw04?t=';
const double _startSecondstwo = 0000000000000000000000000001109;
const String _videoIdthree = 'https://youtu.be/w5K2ZoPVD5E?t=';
const double _startSecondsthree = 00000000000000000000000000060;
const String _videoIdfour = 'https://youtu.be/TDUcQhOzO1Q?t=';
const double _startSecondsfour = 000000000000000000000000000418;
const String _videoIdfive = 'https://youtu.be/3denP7wX2XU?t=';
const double _startSecondsfive = 000000000000000000000000000236;
