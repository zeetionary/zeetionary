...
class EnglishEntryflirt extends StatefulWidget {
  const EnglishEntryflirt({super.key});

  @override
  State<EnglishEntryflirt> createState() => _EnglishEntryflirtState();
}

class _EnglishEntryflirtState extends State<EnglishEntryflirt> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: flirt (Derived forms: flirted, flirts, flirting)
1. Talk or behave amorously, without serious intentions (= chat up [Brit, informal], dally, coquet [rare], romance, philander, mash [archaic])
"My husband never flirts with other women";
 
2. Behave carelessly or indifferently (= dally, toy, play)
"flirt about with a young girl's affection";

- Noun: flirt (Derived forms: flirts)
1. Someone who habitually flirts with people they are attracted to
 
2. A seductive woman who uses her sex appeal to exploit men (= coquette, vamp [informal], vamper, minx, tease, flirter)
""",
  );

  final String keyword = "flirt";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He flirts outrageously with his female clients.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's a real flirt.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flirt""",
                      // alsoEnglishWord: "also: flirt",
                      britshText: """IpaUK: /flɜːt/""",
                      americanText: """IpaUS: /flɜːrt/""",
...
// With short examples define "flirt", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) ڕەفتارکردن لەگەڵ کەسێک کە لە ڕووی سێکسییەوە بە ورووژێنەر دەیبینیت بەبێ ئەوەی بتەوێت پەیوەندیت هەبێت"""),
                    SentencesRow(
                      englishText:
                          """He flirts outrageously with his female clients.""",
                      kurdishText:
                          """بە شێوەیەکی زۆر ناشیرین لەگەڵ کڕیارە ژنەکانیدا ڕادەبوێرێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Christina was flirting with just about every man in the room.""",
                      kurdishText:
                          """کریستینا بە نزیکەیی لەگەڵ هەموو پیاوێکی ژوورەکە ڕایدەبوارد.""",
...
const double _startSecondsone = 0000000000000000000000000002185;
const String _videoIdtwo = 'https://youtu.be/c3hh1AYMo7o?t=';
const double _startSecondstwo = 00000000000000000000000000017;
const String _videoIdthree = 'https://youtu.be/aKlLgwyqsqY?t=';
const double _startSecondsthree = 00000000000000000000000000027;
const String _videoIdfour = 'https://youtu.be/1I4nHRYgfGE?t=';
const double _startSecondsfour = 000000000000000000000000000112;
const String _videoIdfive = 'https://youtu.be/LJNtfyq3TDE?t=';
const double _startSecondsfive = 000000000000000000000000000684;
