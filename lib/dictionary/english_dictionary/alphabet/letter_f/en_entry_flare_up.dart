...
class EnglishEntryflareup extends StatefulWidget {
  const EnglishEntryflareup({super.key});

  @override
  State<EnglishEntryflareup> createState() => _EnglishEntryflareupState();
}

class _EnglishEntryflareupState extends State<EnglishEntryflareup> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flare-up (Derived forms: flare-ups)
1. A sudden intense happening (= outburst, burst)
""",
  );

  final String keyword = "flare-up";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flare-up""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There was another flare-up of rioting later that day.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flare-up""",
                      // alsoEnglishWord: "also: flare-up",
                      britshText: """IpaUK: /ˈfleər ʌp/""",
                      americanText: """IpaUS: /ˈfler ʌp/""",
...
کوردی: 
"""),
// With short examples define "flare-up", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دەرکەوتنی لەناکاوی هەستی توند، نەخۆشی یان توندوتیژی"""),
                    SentencesRow(
                      englishText:
                          """There was another flare-up of rioting later that day.""",
                      kurdishText:
                          """خرۆشانێکی دیکەی توندوتیژی هەبوو دواتر لەو ڕۆژەدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Zad6v8ZHzdg?t=';
const double _startSecondsend = 000000000000000000000000000791;
const String _videoIdone = 'https://youtu.be/buMCmzXJUx0?t=';
const double _startSecondsone = 000000000000000000000000000652;
const String _videoIdtwo = 'https://youtu.be/UzEyHb4mvkk?t=';
const double _startSecondstwo = 000000000000000000000000000275;
const String _videoIdthree = 'https://youtu.be/B3VHd2D-SLM?t=';
const double _startSecondsthree = 000000000000000000000000000235;
const String _videoIdfour = 'https://youtu.be/IlYAH-vtut0?t=';
const double _startSecondsfour = 000000000000000000000000000947;
const String _videoIdfive = 'https://youtu.be/A5-8y0DgTC0?t=';
