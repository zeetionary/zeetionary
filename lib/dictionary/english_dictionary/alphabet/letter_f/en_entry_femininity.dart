...
class EnglishEntryfemininity extends StatefulWidget {
  const EnglishEntryfemininity({super.key});

  @override
  State<EnglishEntryfemininity> createState() => _EnglishEntryfemininityState();
}

class _EnglishEntryfemininityState extends State<EnglishEntryfemininity> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "femininity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""femininity""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        """She feels that working women should not be reluctant to express their femininity.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """femininity""",
                      // alsoEnglishWord: "also: femininity",
                      britshText: """IpaUK: /ˌfeməˈnɪnəti/""",
                      americanText: """IpaUS: /ˌfeməˈnɪnəti/""",
...
// With short examples define "femininity", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Long hair was traditionally regarded as a sign of femininity.""",
                      kurdishText:
                          """قژی درێژ لۆکەنەوە بە ئاماژەی ژنێتی دادەنرێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She feels that working women should not be reluctant to express their femininity.""",
                      kurdishText:
                          """وابیردەکاتەوە کە ژنانی کارکەر نابێت نابەدڵ بن لە پیشاندانی مێینەیەتییان.""",
...
const double _startSecondsend = 000000000000000000000000000856;
const String _videoIdone = 'https://youtu.be/bXqZllqGWGQ?t=';
const double _startSecondsone = 00000000000000000000000000074;
const String _videoIdtwo = 'https://youtu.be/4bmzIkni3-8?t=';
const double _startSecondstwo = 00000000000000000000000000035;
const String _videoIdthree = 'https://youtu.be/7bkGM_zSGOU?t=';
const double _startSecondsthree = 000000000000000000000000000471;
const String _videoIdfour = 'https://youtu.be/Aoo9l_w2pq4?t=';
const double _startSecondsfour = 000000000000000000000000000631;
const String _videoIdfive = 'https://youtu.be/W6aDNutZoB0?t=';
