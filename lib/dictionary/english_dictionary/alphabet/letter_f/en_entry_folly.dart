...
class EnglishEntryfolly extends StatefulWidget {
  const EnglishEntryfolly({super.key});

  @override
  State<EnglishEntryfolly> createState() => _EnglishEntryfollyState();
}

class _EnglishEntryfollyState extends State<EnglishEntryfolly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: folly (Derived forms: follies)
1. The trait of acting stupidly or rashly (= foolishness, unwiseness)
 
2. A stupid mistake (= stupidity, bêtise, foolishness, imbecility)
 
3. The quality of being rash and foolish (= foolishness, craziness, madness, nuttiness [informal], insanity)
"trying to drive through a blizzard is the height of folly";
 
4. Foolish or senseless behaviour (= foolery, tomfoolery, craziness, lunacy, indulgence)
 
5. A fanciful building built for purely ornamental reasons
""",
  );

  final String keyword = "folly";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Giving up a secure job seems to be the height of folly.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It would be folly to turn the offer down.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """folly""",
                      // alsoEnglishWord: "also: folly",
                      britshText: """IpaUK: /ˈfɒli/""",
                      americanText: """IpaUS: /ˈfɑːli/""",
...
// With short examples define "folly", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) خراپی بڕیاردان؛ کردنی شتێکی گەمژانە"""),
                    SentencesRow(
                      englishText:
                          """Giving up a secure job seems to be the height of folly.""",
                      kurdishText: """وازهێنان لە کارێکی باش ئەوپەڕی گەمژەییە.""",
                    ...
                    SentencesRow(
                      englishText: """It would be folly to turn the offer down.""",
                      kurdishText: """گەمژەیی دەبێت پێشنیارەکە ڕەتبکەیتەوە.""",
...
const double _startSecondsend = 0000000000000000000000000002683;
const String _videoIdone = 'https://youtu.be/ZMu7_Xpp1SM?t=';
const double _startSecondsone = 000000000000000000000000000372;
const String _videoIdtwo = 'https://youtu.be/379oevm2fho?t=';
const double _startSecondstwo = 000000000000000000000000000118;
const String _videoIdthree = 'https://youtu.be/HBhXvLlB-kY?t=';
const double _startSecondsthree = 0000000000000000000000000007679;
const String _videoIdfour = 'https://youtu.be/tkLZYEIslWM?t=';
const double _startSecondsfour = 000000000000000000000000000545;
const String _videoIdfive = 'https://youtu.be/5-QejUTDCWw?t=';
const double _startSecondsfive = 000000000000000000000000000883;
