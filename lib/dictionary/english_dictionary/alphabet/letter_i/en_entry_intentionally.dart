...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 865;
    const String videoIdtwo = 'sAiTuitN5b8';
    const double startSecondstwo = 182;
    const String videoIdthree = 'tFSgH_cUm2E';
    const double startSecondsthree = 353;
    const String videoIdfour = 'mrkAmmMakMg';
    const double startSecondsfour = 352;
    const String videoIdfive = 'UvjSXBqQe4A';
    const double startSecondsfive = 717;
