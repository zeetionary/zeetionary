...
class EnglishEntryentitlement extends StatefulWidget {
  const EnglishEntryentitlement({super.key});

  @override
  State<EnglishEntryentitlement> createState() =>
      _EnglishEntryentitlementState();
}

class _EnglishEntryentitlementState extends State<EnglishEntryentitlement> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""entitlement""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """entitlement""",
                      // alsoEnglishWord: "also: entitlement",
                      britshText: """IpaUK: /ɪnˈtaɪtlmənt/""",
                      americanText: """IpaUS: /ɪnˈtaɪtlmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "entitlement";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""This may affect your entitlement to compensation.""");
  }
...
کوردی: حەق‌پێدان، ماف‌پێدان، حەق‌بەدەست، بەرحەق، حەق‌پێ‌شیاو، پێ‌ڕەوا، شیاو، لێوەشاو،	ماف، حەق،	نێولەسەرنان، سەرناوپێدان، نێودانان
"""),
          const DefinitionKurdish(
              text: """١. (ناو) مافی فەرمی بۆ کردنی شتێک"""),
          SentencesRow(
            englishText:
                """This may affect your entitlement to compensation.""",
            kurdishText:
                """ئەمە ڕەنگە کاریگەری هەبێت لەسەر مافت بەسەر قەرەبووەوە.""",
          ...
          SentencesRow(
            englishText:
                """They will have to prove their entitlement to the property.""",
            kurdishText: """دەبێت مافیان بەسەر سامانەکەوە بسەلمێنن.""",
            onPressedBritish: () => speaksentence2("en-GB"),
            onPressedAmerican: () => speaksentence2("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) شتێک کە مافت بەسەریەوە هەیە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """We are able to advise people what their legal entitlements are.""",
            kurdishText:
                """دەتوانین ڕاوێژ بە خەڵکی بدەین کە مافە یاساییەکانیان چین.""",
          ...
          const DefinitionKurdish(
              text:
                  """٣. (ناو) ئەو هەستەی کە مافت بەسەر شتێکەوە هەیە بەبی ئەوەی مەرج بێت کاری بۆ بکەیت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """I can't stand the sense of entitlement among these kids.""",
            kurdishText:
                """ناتوانم بەرگەی هەستی پێ‌خۆڕەوایی لەم منداڵانەدا بگرم.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: entitlement (Derived forms: entitlements)
1. (law) right granted by law or contract (especially a right to benefits)
...
const String _videoIdend = 'hOUGNGWmN0k';
const double _startSecondsend = 384;
const String _videoIdone = 'dI6GI-IQuhk';
const double _startSecondsone = 466;
const String _videoIdtwo = 'KhBxCx11eck';
const double _startSecondstwo = 118;
const String _videoIdthree = 'GusUQlZXNyI';
const double _startSecondsthree = 2702;
const String _videoIdfour = '4czBKTO5XWY';
const double _startSecondsfour = 489;
const String _videoIdfive = 'ojubI-sYwho';
const double _startSecondsfive = 0;
const String _videoIdsix = 'HopEHvZY-08';
const double _startSecondssix = 463;
