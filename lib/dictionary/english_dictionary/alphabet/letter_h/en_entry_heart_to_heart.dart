...
class EnglishEntryhearttoheart extends StatefulWidget {
  const EnglishEntryhearttoheart({super.key});

  @override
  State<EnglishEntryhearttoheart> createState() =>
      _EnglishEntryhearttoheartState();
}

class _EnglishEntryhearttoheartState extends State<EnglishEntryhearttoheart> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: heart-to-heart
1. Openly straightforward and direct without reserve or secretiveness (- candid, open)
"a heart-to-heart talk";

- Noun: heart-to-heart (Derived forms: heart-to-hearts)
1. An intimate talk in private
"he took me aside for a little heart-to-heart"
""",
  );

  final String keyword = "heart-to-heart";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heart-to-heart""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We had a heart-to-heart over a bottle of wine.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He called his father for a heart-to-heart talk.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heart-to-heart""",
                      // alsoEnglishWord: "also: heart-to-heart",
                      britshText: """IpaUK: /ˌhɑːt tə ˈhɑːt/""",
                      americanText: """IpaUS: /ˌhɑːrt tə ˈhɑːrt/""",
...
کوردی: دۆستانە، خۆمانە
"""),
// With short examples define "heart-to-heart", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) گفتووگۆیەک کە تێیدا دوو کەس دۆستانە قسە لەسەر هەست و کێشەکانیان دەکەن"""),
                    SentencesRow(
                      englishText:
                          """We had a heart-to-heart over a bottle of wine.""",
                      kurdishText:
                          """گفتووگۆیەکی دۆستانەمان هەبوو لەگەڵ بوتڵێک شەراب.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) پەیوەندیدار بە گفتووگۆیەک کە تێیدا دوو کەس دۆستانە قسە لەسەر هەست و کێشەکانیان دەکەن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He called his father for a heart-to-heart talk.""",
                      kurdishText: """باوکی بانگ کرد بۆ گفتووگۆیەکی دۆستانە.""",
...
const String _videoIdone = 'https://youtu.be/tyixMpuGEL8?t=';
const double _startSecondsone = 000000000000000000000000000150;
const String _videoIdtwo = 'https://youtu.be/PnIDso3a0XQ?t=';
const double _startSecondstwo = 000000000000000000000000000202;
const String _videoIdthree = 'https://youtu.be/Jt5WpKRPIlE?t=';
const double _startSecondsthree = 0000000000000000000000000001372;
const String _videoIdfour = 'https://youtu.be/cb0pb-OHaM4?t=';
const double _startSecondsfour = 00000000000000000000000000013;
const String _videoIdfive = 'https://youtu.be/SYn485wNCI0?t=';
const double _startSecondsfive = 000000000000000000000000000714;
