...
class EnglishEntryenormously extends StatefulWidget {
  const EnglishEntryenormously({super.key});

  @override
  State<EnglishEntryenormously> createState() => _EnglishEntryenormouslyState();
}

class _EnglishEntryenormouslyState extends State<EnglishEntryenormously> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enormously""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enormously""",
                      // alsoEnglishWord: "also: enormously",
                      britshText: """IpaUK: /ɪˈnɔːməsli/""",
                      americanText: """IpaUS: /ɪˈnɔːrməsli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enormously";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Property prices vary enormously across the country.""");
  }
...
کوردی: یەکجار زۆر، لەئەندازبەدەر
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵکار) پێنناسە"""),
          SentencesRow(
            englishText:
                """Property prices vary enormously across the country.""",
            kurdishText:
                """نرخی خانووبەرە بە ئاستێکی زۆر جیاوازە لە وڵاتەکەدا.""",
          ...
          SentencesRow(
            ...
            kurdishText: """یەکجار زۆر بە هیوای کۆبوونەوەکە بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: enormously
1. Vastly (= tremendously, hugely, staggeringly)
"he was enormously popular";
 
2. To a great extent; over a large range or scale (= terrifically [informal], tremendously, hugely, immensely, vastly, massively [informal], greatly)
...
const String _videoIdend = 'https://youtu.be/IgF3OX8nT0w?t=';
const double _startSecondsend = 981;
const String _videoIdone = 'https://youtu.be/DG4Ox2sTrKU?t=';
const double _startSecondsone = 475;
const String _videoIdtwo = 'https://youtu.be/2XIsHyfTmfc?t=';
const double _startSecondstwo = 129;
const String _videoIdthree = 'https://youtu.be/cb0pb-OHaM4?t=';
...
const String _videoIdsix = 'https://youtu.be/sJG-rXBbmCc?t=';
const double _startSecondssix = 2244;
