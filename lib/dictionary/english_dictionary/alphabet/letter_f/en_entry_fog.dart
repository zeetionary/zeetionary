...
class EnglishEntryfog extends StatefulWidget {
  const EnglishEntryfog({super.key});

  @override
  State<EnglishEntryfog> createState() => _EnglishEntryfogState();
}

class _EnglishEntryfogState extends State<EnglishEntryfog> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fog (Derived forms: fogs)
1. Droplets of water vapour suspended in the air near the ground
 
2. An atmosphere in which visibility is reduced because of a cloud of some substance (= fogginess, murk, murkiness)
 
3. Confusion characterized by lack of clarity (= daze, haze)
 
4. (photography) cloudiness on a photographic image (= fogging)

- Verb: fog (Derived forms: fogs, fogging, fogged)
1. Make less visible or unclear (= obscure, befog, becloud, obnubilate, haze over, cloud, mist)
"The stars are fogged by the clouds";
""",
  );

  final String keyword = "fog";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Dense/thick fog is affecting roads in the north and visibility is poor.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We get heavy fogs on this coast in winter.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The town was covered in a thick blanket of fog.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fog finally lifted.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We drove slowly through the fog.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He went through the day with his mind in a fog.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I tried to clear the confusion that was fogging my brain.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fog""",
                      // alsoEnglishWord: "also: fog",
                      britshText: """IpaUK: /fɒɡ/""",
                      americanText: """IpaUS: /fɑːɡ/""",
...
کوردی: (تەم‌و)مژ، دوومان، مۆران، تومان، چەمان، تەم،	دووکەڵ، دوومان،	هەور،	(وێنە) سووتان، تاریک‌هاتن،	تاریکی، لێڵی، ناڕۆشنی،	پەشۆکان، سەرلێ‌شێوان، شڵەژان
"""),
// With short examples define "fog", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تەمی بەهێز کاریگەری لە ڕێگاکانی باکوور دەکەن و بینین لاوازە.""",
                    ...
                    SentencesRow(
                      englishText: """We get heavy fogs on this coast in winter.""",
                      kurdishText: """لە زستاندا لەم کەناراوە تەمی بەهێز دەبێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The town was covered in a thick blanket of fog.""",
                      kurdishText: """شارۆچکەکە بە چینێکی ئەستوور لە تەم داپۆشرابوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The fog finally lifted (= disappeared).""",
                      kurdishText: """تەمەکە لەکۆتاییدا نەما.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We drove slowly through the fog.""",
                      kurdishText: """بە هێواشی بە ناو تەمەکەدا لێمانخوڕی.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) دۆخێک تێیدا شتەکان ڕوون نین و سەختن بۆ تێگەشتن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He went through the day with his mind in a fog.""",
                      kurdishText: """بە ڕۆژەکەدا تێپەڕی بەوەی مێشکی ناڕوون بوو.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) ئەوەی شتێک ناڕوون بکەیت یان سەرلێشێوان درووست بکەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I tried to clear the confusion that was fogging my brain.""",
                      kurdishText: """هەوڵم دا ئەو سەرلێشێوانە نەهێڵم کە مێشکمی ئاڵۆز کردبوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/OY_OHFAgUiA?t=';
const double _startSecondsend = 00000000000000000000000000050;
const String _videoIdone = 'https://youtu.be/kSlq08dm89I?t=';
const double _startSecondsone = 00000000000000000000000000026;
const String _videoIdtwo = 'https://youtu.be/Biy21E6sqLk?t=';
const double _startSecondstwo = 0000000000000000000000000007;
const String _videoIdthree = 'https://youtu.be/CkR1UowJF0w?t=';
const double _startSecondsthree = 0000000000000000000000000006;
const String _videoIdfour = 'https://youtu.be/Y0_9L9t8EzA?t=';
const double _startSecondsfour = 00000000000000000000000000024;
const String _videoIdfive = 'https://youtu.be/JfhdEed0q3g?t=';
const double _startSecondsfive = 00000000000000000000000000011;
