...
// Define the word "bedding" and provide five simple example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings or more.

// replace bedding - replace EnglishEntrybedding

// replace speakBedding - /ˈbedɪŋ/

enum TtsState { playing }

class EnglishEntrybedding extends StatelessWidget {
  EnglishEntrybedding({super.key});
  ...
  Future<void> speakbedding(String languageCode) async {
    ...
    await flutterTts.speak("bedding");
  }
  ...
  Future<void> speakbeddings2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("The farmer spread fresh bedding in the stalls for the horses.");
  }
  ...
  Future<void> speakbeddings3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("speakBeddings33");
  }
  ...
  Future<void> speakbeddings4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("speakBeddings44");
  }
  ...
  Future<void> speakbeddings5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("speakBeddings55");
  }
  ...
  Future<void> speakbeddings6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("speakBeddings66");
  }
  ...
  Future<void> speakbeddings7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("speakBeddings77");
  }
...
کوردی: پێخەف، نوێن، جێ‌ونوێن، جێگاوبان، بناخە، ھیم، بنەڕەت، پەیین و پاڵ، کاوکۆت و پەیین کە دەیکەن بە تێولەوە تا ئاژەڵەکان لەسەری بخەون، پێگە، چینی خواروو یان ژێرەوە
"""),
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: bedding (derived forms: beddings)
1. Coverings that are used on a bed (= bedclothes, bed clothing)
"disarrayed bedding";
 
2. Material used to provide a bed for animals (= bedding material, litter)
""",
  );
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'g-j2-9Y3JXo';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Ol4vDMVnv4s';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'JaLjRTcQPdU';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'xiyZvrQ1DAk';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = '4HnPbSSAT_U';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'KSFwvyQLEK0';
...
// end bedding// TODO Implement this library.
