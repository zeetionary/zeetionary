...
class EnglishEntryforethought extends StatefulWidget {
  const EnglishEntryforethought({super.key});

  @override
  State<EnglishEntryforethought> createState() =>
      _EnglishEntryforethoughtState();
}

class _EnglishEntryforethoughtState extends State<EnglishEntryforethought> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forethought (Derived forms: forethoughts)
1. Planning or plotting in advance of acting (= premeditation)
 
2. Judiciousness in avoiding harm or danger (= caution, precaution, care)
"he exercised forethought in opening the door";
""",
  );

  final String keyword = "forethought";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forethought""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He had had the forethought to book in advance.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She was appalled at her own lack of forethought.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forethought""",
                      // alsoEnglishWord: "also: forethought",
                      britshText: """IpaUK: /ˈfɔːθɔːt/""",
                      americanText: """IpaUS: /ˈfɔːrθɔːt/""",
...
کوردی: دووربینی، بەمشووری، داهاتووبینی، داهاتووزانی، پێشبینی، دوابینی
"""),
// With short examples define "forethought", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بیرکردنەوەی وریاییانە بۆ دڵنیایی ئەوەی شتەکان سەرکەتوو دەبن لە داهاتوودا"""),
                    SentencesRow(
                      englishText:
                          """He had had the forethought to book in advance.""",
                      kurdishText:
                          """دووربینیی ئەوەی هەبوو پێشوەختە شوێن بگرێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تاسا بە کەمی دووربینیی خۆی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/_WjUFuW2J0A?t=';
const double _startSecondsend = 000000000000000000000000000341;
const String _videoIdone = 'https://youtu.be/Rz1X0RP3Mfw?t=';
const double _startSecondsone = 000000000000000000000000000415;
const String _videoIdtwo = 'https://youtu.be/uCM0Tvp6Dko?t=';
const double _startSecondstwo = 000000000000000000000000000214;
const String _videoIdthree = 'https://youtu.be/6FD23UrWnUU?t=';
const double _startSecondsthree = 000000000000000000000000000500;
const String _videoIdfour = 'https://youtu.be/cJAXpyt8-oQ?t=';
const double _startSecondsfour = 0000000000000000000000000001083;
const String _videoIdfive = 'https://youtu.be/DkS1pkKpILY?t=';
const double _startSecondsfive = 0000000000000000000000000001401;
