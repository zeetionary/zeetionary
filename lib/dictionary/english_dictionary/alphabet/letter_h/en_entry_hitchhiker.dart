...
class EnglishEntryhitchhiker extends StatefulWidget {
  const EnglishEntryhitchhiker({super.key});

  @override
  State<EnglishEntryhitchhiker> createState() => _EnglishEntryhitchhikerState();
}

class _EnglishEntryhitchhikerState extends State<EnglishEntryhitchhiker> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hitchhiker (Derived forms: hitchhikers)
1. A person who travels by getting free rides from passing vehicles (- hitcher [informal])
"We picked up a hitchhiker on the highway";
""",
  );

  final String keyword = "hitchhiker";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hitchhiker""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He picked up two hitchhikers on the road to Bristol.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/DgAoy7XaFgk?t=';
    const double startSecondsend = 000000000000000000000000000124;
    const String videoIdone = 'https://youtu.be/wgM5V44eQHU?t=';
    const double startSecondsone = 000000000000000000000000000982;
    const String videoIdtwo = 'https://youtu.be/F31WyojtONQ?t=';
    const double startSecondstwo = 000000000000000000000000000793;
    const String videoIdthree = 'https://youtu.be/gjySnrspD7E?t=';
    const double startSecondsthree = 000000000000000000000000000795;
    const String videoIdfour = 'https://youtu.be/OZ_xhkg32nk?t=';
    const double startSecondsfour = 000000000000000000000000000420;
    const String videoIdfive = 'https://youtu.be/G3LZ-Jh2L6E?t=';
    const double startSecondsfive = 0000000000000000000000000001122;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hitchhiker""",
                      // alsoEnglishWord: "also: hitchhiker",
                      britshText: """IpaUK: /ˈhɪtʃhaɪkə(r)/""",
                      americanText: """IpaUS: /ˈhɪtʃhaɪkər/""",
...
// With short examples define "hitchhiker", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دوو ڕێبواری هەڵگرت لەسەر ڕێگای بۆ بریستڵ.""",
