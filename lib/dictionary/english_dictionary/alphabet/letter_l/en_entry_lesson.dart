...
class EnglishEntrylesson extends StatefulWidget {
  const EnglishEntrylesson({super.key});

  @override
  State<EnglishEntrylesson> createState() => _EnglishEntrylessonState();
}

class _EnglishEntrylessonState extends State<EnglishEntrylesson> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lesson (Derived forms: lessons)
1. A unit of instruction
"he took driving lessons"
 
2. Punishment intended as a warning to others (- example, deterrent example, object lesson)
"they decided to make an object lesson of him";
 
3. The significance of a story or event (- moral)
"the lesson of the story is to love thy neighbour";
 
4. A task assigned for individual study
"he did the lesson for today"
 
5. A section of the Bible or other religious text read as part of a service
""",
  );

  final String keyword = "lesson";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She gives piano lessons.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I’m having driving lessons.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He took lessons in Thai cookery.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Beethoven's lessons with Haydn continued until 1794.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Our first lesson on Tuesdays is French.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What did we do last lesson?""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The coursebook is divided into 30 lessons.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Other countries can teach us a lesson or two on industrial policy.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The accident taught me a lesson I'll never forget.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They decided to teach him a lesson for telling lies about them.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There are lessons to be learned from this mistake.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It is dangerous to ignore the lessons of history.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Let that be a lesson to you.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/79DijItQXMM?t=106';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/JUFf5yrZDbA?t=19';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/6PDJXdjnWM4?t=13';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/QaZ93sibpk0?t=361';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/2vYqjQnm3WY?t=1653';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/gmr41ht2Sq4?t=139';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lesson""",
                      // alsoEnglishWord: "also: lesson",
                      britshText: """IpaUK: /ˈlesn/""",
                      americanText: """IpaUS: /ˈlesn/""",
...
کوردی: 
"""),
// With short examples define "lesson", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ماوەیەک کە تێیدا کەسێک فێری شتێک دەکرێت"""),
                    SentencesRow(
                      englishText: """She gives piano lessons.""",
                      kurdishText: """وانەی پیانۆ دەڵێتەوە.""",
                    ...
                    Column(
                      children: [
                        MyExpansionTile(
                          children: [
                            SentencesRow(
                              englishText: """I’m having driving lessons.""",
                              kurdishText: """وانەی شۆفێریم هەیە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """وانەی خواردن‌لێنانی تایلەندیی وەرگرت.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """وانەکانی بیتهۆڤن لەگەڵ هایدن تاوەکو ١٧٩٤ بەردەوام بوون.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """یەکەم وانەمان لە ڕۆژی سێشەممە فەرەنسییە.""",
                            ...
                            const DividerSentences(),
                            SentencesRow(
                              englishText: """What did we do last lesson?""",
                              kurdishText: """وانەی ڕابردوو چیمان کرد.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) شتێک کە بۆ فێربوونە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The coursebook is divided into 30 lessons.""",
                      kurdishText: """پەرتووکی کۆرسەکە بەسەر ٣٠ وانەدا دابەش کراوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Other countries can teach us a lesson or two on industrial policy.""",
                      kurdishText: """وڵاتانی دیکە دەکرێت یان دوو وانەمان فێربکەن لەسەر سیاسەتی پیشەسازی.""",
                      onPressedBritish: () => speaksentence8("en-GB"),
                      onPressedAmerican: () => speaksentence8("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) ئەزموونێک، بە تایبەتی یەکێکی ناخۆش، کە کەسێک دەکرێت لێیەوە دێر ببێت بۆ ئەوەی دووبارە نەبێتەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The accident taught me a lesson I'll never forget.""",
                      kurdishText: """ئەم ڕووداوە وانەیەکی فێرکردم کە هەرگیز بیرم ناچێتەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They decided to teach him a lesson (= punish him) for telling lies about them.""",
                      kurdishText: """بڕیاریان دا کە وانەیەکی دابدەن بۆ گوتنی درۆ لەسەریان.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There are lessons to be learned from this mistake.""",
                      kurdishText: """وانە هەیە بۆ فێربوون لەسەر ئەم هەڵەیە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """It is dangerous to ignore the lessons of history.""",
                      kurdishText: """مەترسیدارە وانەکانی مێژوو لەبیر بکردرێن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Let that be a lesson to you (= so that you do not make the same mistake again).""",
                      kurdishText: """با ئەوە ببێتە پەندێک بۆت.""",
