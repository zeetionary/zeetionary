...
class EnglishEntryimposition extends StatefulWidget {
  const EnglishEntryimposition({super.key});

  @override
  State<EnglishEntryimposition> createState() => _EnglishEntryimpositionState();
}

class _EnglishEntryimpositionState extends State<EnglishEntryimposition> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: imposition (Derived forms: impositions)
1. (tax) the act of imposing something (as a tax or an embargo) (- infliction)
...
""",
  ...
  final String keyword = "imposition";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""imposition""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The government announced the imposition of martial law during the crisis.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I'd like to stay if it's not too much of an imposition.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak(
        """Would it be too much of an imposition to ask you to pick my children up from school?""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/ncMoQs_HNmY?t=';
    const double startSecondsend = 00000000000000000000000000077;
    const String videoIdone = 'https://youtu.be/eJ-WJssJgdg?t=';
    const double startSecondsone = 0000000000000000000000000003446;
    const String videoIdtwo = 'https://youtu.be/_89FaXrN24A?t=';
    const double startSecondstwo = 0000000000000000000000000001218;
    const String videoIdthree = 'https://youtu.be/PnO7pL-QWyc?t=';
    const double startSecondsthree = 000000000000000000000000000539;
    const String videoIdfour = 'https://youtu.be/D8a2SDw5PYo?t=';
    const double startSecondsfour = 000000000000000000000000000185;
    const String videoIdfive = 'https://youtu.be/r1ZPwQEPNpg?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """imposition""",
                      // alsoEnglishWord: "also: imposition",
                      britshText: """IpaUK: /ˌɪmpəˈzɪʃn/""",
                      americanText: """IpaUS: /ˌɪmpəˈzɪʃn/""",
...
// کوردی: (باج) دانان،	لەسەردانان، داسەپاندن، خستنەسەر، شتی داسەپاو، بار،	فێڵ، فریو، کەڵەک
// """),
// With short examples define "imposition", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) سەپاندنی یاسا یان باجێکی تازە"""),
                    SentencesRow(
                      englishText:
                          """The government announced the imposition of martial law during the crisis.""",
                      kurdishText:
                          """حکومەت قەدەغەی هاتووچۆی سەپاند لە ماوەی قەیرانەکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) شتێکی نادادپەروەری، بێ‌هۆکار، یان ناعاقڵانی کە کەسێک داوات لێدەکات بیکەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I'd like to stay if it's not too much of an imposition.""",
                      kurdishText: """دەمەوێت بیڵێم ئەگەر بارێکی قورس نییە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Would it be too much of an imposition to ask you to pick my children up from school?""",
                      kurdishText:
                          """بارێکی قورس دەبێت ئەگەر داوات لێ بکەم منداڵەکانم لە قوتابخانە بهێنیتەوە؟""",
