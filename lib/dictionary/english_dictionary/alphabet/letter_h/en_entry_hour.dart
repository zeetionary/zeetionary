...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 803;
    const String videoIdtwo = 'fXLrw7XozC8';
    const double startSecondstwo = 242;
    const String videoIdthree = 'nITZooG6ij8';
    const double startSecondsthree = 0;
    const String videoIdfour = '2TUGZ1VQDss';
    const double startSecondsfour = 572;
    const String videoIdfive = 'BNRItz1Ngt0';
