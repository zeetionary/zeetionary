...
class EnglishEntryidiotic extends StatefulWidget {
  const EnglishEntryidiotic({super.key});

  @override
  State<EnglishEntryidiotic> createState() => _EnglishEntryidioticState();
}

class _EnglishEntryidioticState extends State<EnglishEntryidiotic> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""idiotic""");
  }
