...
class EnglishEntryexist extends StatefulWidget {
  const EnglishEntryexist({super.key});

  @override
  State<EnglishEntryexist> createState() => _EnglishEntryexistState();
}

class _EnglishEntryexistState extends State<EnglishEntryexist> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exist""",
                      // alsoEnglishWord: "also: exist",
                      britshText: """IpaUK: /ɪɡˈzɪst/""",
                      americanText: """IpaUS: /ɪɡˈzɪst/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Does life exist on other planets?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Few of these monkeys still exist in the wild.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""On his retirement the post will cease to exist.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It is an art gallery that exists only on the internet.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I didn't think people like that existed any more.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The charity exists to support victims of crime.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We existed on a diet of rice.""");
  }
...
"""),
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Few of these monkeys still exist in the wild.""",
            kurdishText:
                """کەم لەم مەیموونانە هێشتا لە دەست‌ودەردا بوونیان هەیە.""",
                ...
                children: [
                  SentencesRow(
                    englishText:
                        """Major differences continue to exist between the two countries.""",
                    kurdishText:
                        """جیاوازیی زۆر بەردەوامە لەوەی بوونیان هەبێت لە نێوان دوو وڵاتەکەدا.""",
                  ...
                  SentencesRow(
                    englishText:
                        """A solution has been found and the problem no longer exists.""",
                    kurdishText:
                        """چارەسەرێک دۆزراوەتەوە و کێشەکە چی دیکە بوونی نییە.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """لەگەڵ خانەنشینبوونی پێگەکە بوونی نامێنێت.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """پێشانگایەکی هونەرییە کە تەنها لەسەر ئینتەرنێت بوونی هەیە.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """وەهام بیر نەدەکردەوە کە خەڵکی لەو جۆرە هێشتا بوونیان هەبێت.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """ڕێکخراوەکە بوونی هەیە بۆ یارمەتیدانی قوربانیانی تاوان.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) ژیان کردن، بەتایبەتی لە دۆخێکی سەخت یان بە پارەی کەم"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """We existed on a diet of rice.""",
            kurdishText: """لەسەر خواردنی برنج دەژیاین.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """They can't exist on the money he's earning.""",
            kurdishText: """ناتوانن بەو پارەیە بژین کە بەدەستی دەهێنێت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: exist (Derived forms: exists, existing, existed)
1. Have reality; have an existence, be extant (= be)
 
2. Support oneself, esp. at a minimal level (= survive, live, subsist)
...
const double _startSecondsend = 000000000000000000000000000000; // 1172;
...
const double _startSecondstwo = 00000000000000000000000000000; // 59;
const String _videoIdthree = 'VIDEOhttps://youtu.be/MnExgQ81fhU?t=';
const double _startSecondsthree = 000000000000000000000000000; // 364;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/MGO4_8YRKro?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 513;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/zqllxbPWKNI?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 485;
