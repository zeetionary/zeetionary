...
class EnglishEntryairfield extends StatelessWidget {
  EnglishEntryairfield({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "airfield", // DOPSUM: CHANGE WORD ENTRY - Find /ˈeəfiːld/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈeəfiːld/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
