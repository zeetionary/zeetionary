...
class EnglishEntryleader extends StatefulWidget {
  const EnglishEntryleader({super.key});

  @override
  State<EnglishEntryleader> createState() => _EnglishEntryleaderState();
}

class _EnglishEntryleaderState extends State<EnglishEntryleader> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: leader (Derived forms: leaders)
...
3. [Brit] An article written by the newspaper editor, usually expressing the editor's opinion (- leading article [Brit])
""",
  );

  final String keyword = "leader";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She became leader of the campaign group.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She's a born leader.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/ghUFMbHmw8s?t=154';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/pmqBmTWq420';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/vFOZP-9kkeI?t=56';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/Cx8r0hDjObA?t=38';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/2EAR4z8oszQ?t=301';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/hFEUq-l3DF8?t=594';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """leader""",
                      // alsoEnglishWord: "also: leader",
                      britshText: """IpaUK: /ˈliːdə(r)/""",
                      americanText: """IpaUS: /ˈliːdər/""",
...
// With short examples define "leader", please follow LX instructions
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She's a born leader.""",
                      kurdishText: """بۆ سەرکردەیی هاتە دوونیاوە.""",
