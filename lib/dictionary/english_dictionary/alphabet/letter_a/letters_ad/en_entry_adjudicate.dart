...
class EnglishEntryadjudicate extends StatefulWidget {
  const EnglishEntryadjudicate({super.key});

  @override
  State<EnglishEntryadjudicate> createState() => _EnglishEntryadjudicateState();
}

class _EnglishEntryadjudicateState extends State<EnglishEntryadjudicate> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "adjudicate";
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = '1ribon_WKOA';
    const double startSecondstwo = 636;
    const String videoIdthree = 'Cj4fEqDZib0';
    const double startSecondsthree = 208;
    const String videoIdfour = 'jpD9J7ye8s8';
    const double startSecondsfour = 961;
    const String videoIdfive = 'zbcAjnUUncw';
    const double startSecondsfive = 325;
    // const String videoIdsix = 'l6MyImeCKlk';
    // const double startSecondssix = 640;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """adjudicate""",
                      // alsoEnglishWord: "also: adjudicate",
                      britshText: """IpaUK: /əˈdʒuːdɪkeɪt/""",
                      americanText: """IpaUS: /əˈdʒuːdɪkeɪt/""",
