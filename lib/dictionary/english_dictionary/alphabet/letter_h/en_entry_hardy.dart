...
class EnglishEntryhardy extends StatefulWidget {
  const EnglishEntryhardy({super.key});

  @override
  State<EnglishEntryhardy> createState() => _EnglishEntryhardyState();
}

class _EnglishEntryhardyState extends State<EnglishEntryhardy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hardy (Derived forms: hardier, hardiest)
1. Having rugged physical strength; inured to fatigue or hardships (- stalwart, stout, sturdy)
...
3. Invulnerable to fear or intimidation (- audacious, brave, dauntless, fearless, intrepid, unfearing)
"hardy explorers";
 
4. Resolute and without fear (- doughty)
"The hardy soldier faced the oncoming enemy";
""",
  );

  final String keyword = "hardy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""These hardy mountain folk seem to thrive on the cold.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A few hardy souls had turned out to watch the hockey game.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Parsley is hardy and can be grown outdoors from the spring.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hardy""",
                      // alsoEnglishWord: "also: hardy",
                      britshText: """IpaUK: /ˈhɑːdi/""",
                      americanText: """IpaUS: /ˈhɑːrdi/""",
...
// With short examples define "hardy", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) کە بەهێزە و دەتوانێت بەسەر دۆخ و کەشووهەوای سەختدا سەربکەوێت"""),
                    SentencesRow(
                      englishText: """These hardy mountain folk seem to thrive on the cold.""",
                      kurdishText: """ئەم خەڵکە شاخاوییە بەهێزە وادیارن لە سەرماکەدا ڕزگاریان ببێت.""",
                      englishNote: """This means these resilient mountain people appear to do well and be comfortable in cold conditions.""",
                    ...
                    SentencesRow(
                      englishText: """A few hardy souls had turned out to watch the hockey game.""",
                      kurdishText: """چەند کەسێکی جەربەزە هاتبوونە دەرەوە بۆ سەیرکردنی یارییە هۆکییەکە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵناو) کە دەتوانێت لە دەرەوە لە زستاندا بژی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Parsley is hardy and can be grown outdoors from the spring.""",
                      kurdishText: """مەعدەنووس خۆگرە و دەکرێت لە بەهارەوە لە دەرەوە بچێندرێت.""",
