...
کوردی: بەربەرەکانی، ڕقەبەرایەتی، پێشبڕکێ،	چاوپێ‌ھەڵنەھاتوویی، بەغیلی،	گوێڕایەلی، ملکەچی،	لاسایی‌کردنەوە، چاولێکەری
"""),
          const DefinitionKurdish(
              text: """١. (ناو) ھەوڵدان بۆ کردنی شتێک وەک کەسێک بەباشی"""),
          SentencesRow(
            englishText:
                """It is not clear that the Western model of development deserves emulation.""",
            kurdishText:
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'lYPe4MsALk4';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '8XVRpotGsO0';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'KgngSfkT0G0';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'OzE72EJqtkU';
