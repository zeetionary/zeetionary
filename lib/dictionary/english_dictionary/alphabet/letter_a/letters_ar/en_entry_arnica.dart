...
// replace EnglishEntryAdopsummm - replace speakArnica

// replace arnica - /ˈɑːnɪkə/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarnica extends StatelessWidget {
  // blank divider
  EnglishEntryarnica({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arnica"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɑːnɪkə/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrnɪkə/"),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'hcKZ2dxumgk';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'aO8K2B6gN7I';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'vKTmrVx2EUA';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'PxpITAD5nWw';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'RmdcNI4a9ZU';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'atzVsQAq2Ag';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'tWQBpHa9TKM';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'QeVTACkubDw';
