...
class EnglishEntryfurniture extends StatefulWidget {
  const EnglishEntryfurniture({super.key});

  @override
  State<EnglishEntryfurniture> createState() => _EnglishEntryfurnitureState();
}

class _EnglishEntryfurnitureState extends State<EnglishEntryfurniture> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: furniture (Derived forms: furnitures)
1. Furnishings that make a room or other area ready for occupancy (- piece of furniture, article of furniture)
"they had too much furniture for the small apartment"; "there was only one piece of furniture in the room";
""",
  );

  final String keyword = "furniture";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""furniture""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We need to buy some new furniture.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The wood is used for making fine furniture.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furniture""",
                      // alsoEnglishWord: "also: furniture",
                      britshText: """IpaUK: /ˈfɜːnɪtʃə(r)/""",
                      americanText: """IpaUS: /ˈfɜːrnɪtʃər/""",
...
کوردی: کەل‌وپەلی نێوماڵ، سامانی ناوماڵ، شمەکی ماڵ، ڕایەخ، هاجەت،	کەل‌وپەل، شمەک، شت‌ومەک
"""),
// With short examples define "furniture", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەو کەلوپەلانەی کە دەکرێت بجوڵێندرێن، وەک کورسی، جێخەو، مێز، هتد، و دەخرێنە ژوور ئان ئۆفیسێک بۆ ئەوەی گونجاو بێت بۆ ژیان یان کارکردن"""),
                    SentencesRow(
                      englishText: """We need to buy some new furniture.""",
                      kurdishText: """دەبێت هەندێک کەلوپەل بکڕین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دارەکە بۆ درووستکردنی کەلوپەلی باش بەکاردێت.""",
...
const String _videoIdfive = 'https://youtu.be/oD9BaNAH-eE?t=';
const double _startSecondsfive = 0000000000000000000000000002402;
