...
class EnglishEntryharebrained extends StatefulWidget {
  const EnglishEntryharebrained({super.key});

  @override
  State<EnglishEntryharebrained> createState() => _EnglishEntryharebrainedState();
}

class _EnglishEntryharebrainedState extends State<EnglishEntryharebrained> {
  @override
  void initState() {
    super.initState();
...
1. Very foolish (- insane, mad)
"harebrained ideas";
""",
  );

  final String keyword = "hare-brained";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hare-brained""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""That sounds like another of his harebrained schemes!""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hare-brained""",
                      // alsoEnglishWord: "also: hare-brained",
                      britshText: """IpaUK: /ˈheə breɪnd/""",
                      americanText: """IpaUS: /ˈher breɪnd/""",
...
کوردی: 
"""),
// With short examples define "hare-brained", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) شێتانە کە ئەگەری کەمە سەر بگرێت"""),
                    SentencesRow(
                      englishText: """That sounds like another of his harebrained schemes!""",
                      kurdishText: """ئەمە لە یەکێکی دیکە لە پلانە شێتانەکانی دەکات!""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/kxNwmClQMKs?t=';
const double _startSecondsend = 000000000000000000000000000883;
const String _videoIdone = 'https://youtu.be/dW_ekZRGalk?t=';
const double _startSecondsone = 000000000000000000000000000398;
const String _videoIdtwo = 'https://youtu.be/2pH0v1zolNg?t=';
const double _startSecondstwo = 000000000000000000000000000590;
const String _videoIdthree = 'https://youtu.be/i2lcDQjoOkg?t=';
const double _startSecondsthree = 00000000000000000000000000082;
const String _videoIdfour = 'https://youtu.be/vUdz8ycrho8?t=';
const double _startSecondsfour = 00000000000000000000000000024;
const String _videoIdfive = 'https://youtu.be/mpaOxBzz5DE?t=';
