...
class EnglishEntryindoor extends StatefulWidget {
  const EnglishEntryindoor({super.key});

  @override
  State<EnglishEntryindoor> createState() => _EnglishEntryindoorState();
}

class _EnglishEntryindoorState extends State<EnglishEntryindoor> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The indoor flower market is booming.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He's gone to play indoor football with his mates.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/DPZzrlFCD_I';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/9TugA_z5vQE?t=';
    const double startSecondsone = 0000000000000000000000000001534;
    const String videoIdtwo = 'https://youtu.be/W8uXhQnWgj4?t=';
    const double startSecondstwo = 000000000000000000000000000451;
    const String videoIdthree = 'https://youtu.be/f5NJQiY9AuY?t=';
    const double startSecondsthree = 000000000000000000000000000200;
    const String videoIdfour = 'https://youtu.be/PqpCeiYycVM?t=';
    const double startSecondsfour = 0000000000000000000000000001000;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indoor""",
                      // alsoEnglishWord: "also: indoor",
                      britshText: """IpaUK: /ˈɪndɔː(r)/""",
                      americanText: """IpaUS: /ˈɪndɔːr/""",
...
کوردی: لە نێوەوە، لە ژوورەوە، نێوخۆیی، نێوەکی
"""),
// With short examples define "indoor", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە کەوتووەتە ناو بینایەک یان لە ناویدا بەکاردێت"""),
                    SentencesRow(
                      englishText: """The indoor flower market is booming.""",
                      kurdishText: """بازاڕی گووڵی ماڵەوە دەبووژێتەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Poor indoor air quality can result in increased risk of asthma and allergies.""",
                      kurdishText:
                          """خراپی کوالێتی هەوای ژوورەوە دەکرێت ببێتە هۆکاری مەترسی زیاتری تەنگەنەفەسی و هەستیاری.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) پەیوەندیدار بە وەرزش کە لەناو بینای داخراودا بکرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He's gone to play indoor football with his mates.""",
                      kurdishText:
                          """چووە بۆ ئەنجامدانی تۆپی پێی ناو هۆڵ لەگەڵ هاوڕێکانی.""",
