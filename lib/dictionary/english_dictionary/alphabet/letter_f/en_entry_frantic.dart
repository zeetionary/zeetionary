...
class EnglishEntryfrantic extends StatefulWidget {
  const EnglishEntryfrantic({super.key});

  @override
  State<EnglishEntryfrantic> createState() => _EnglishEntryfranticState();
}

class _EnglishEntryfranticState extends State<EnglishEntryfrantic> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: frantic
1. Excessively agitated; distraught with fear or other violent emotion (= frenetic, phrenetic, frenzied)
"frantic with anger and frustration";
 
2. Marked by uncontrolled excitement or emotion (= delirious, excited, mad, unrestrained)
"something frantic in their gaiety";
""",
  );

  final String keyword = "frantic";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frantic""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They made frantic attempts to revive him.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Things are frantic in the office right now.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They worked with frantic haste.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We were starting to get frantic with worry.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frantic""",
                      // alsoEnglishWord: "also: frantic",
                      britshText: """IpaUK: /ˈfræntɪk/""",
                      americanText: """IpaUS: /ˈfræntɪk/""",
...
کوردی: 	پەشۆکاو، تاساو، هەژیو، نگەران، شڵەژاو،	شێت‌ئاسا، شێتانە، بەپەلە، بە هەشتاو
"""),
// With short examples define "frantic", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەوڵی پەشۆکاوانەیان دا بۆ بەئاگاهێنانەوەی.""",
                      englishNote:
                          """This means they made very urgent and desperate efforts to bring him back to life or consciousness.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شتەکان لە ئۆفسەکە پەشۆکاون (= لە دۆخی پەشۆکاوین).""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They worked with frantic haste.""",
                      kurdishText: """بە خێرایی پەشؤکاوییەوە کاریان کرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە ناتوانیت هەستەکانت کۆنترۆڵ بکەیت چونکە تەواو ترساو یان نیگەرانیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Let's go back. Your parents must be getting frantic by now.""",
                      kurdishText:
                          """با بگەڕیینەوە. دایبابت دەبێت تا ئێستا شڵەژاو بووبن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """خەریک بوو دەشڵەژاین لە نیگەرانیدا.""",
...
const double _startSecondsone = 0000000000000000000000000001989;
const String _videoIdtwo = 'https://youtu.be/tCqwT2MqLxI?t=';
const double _startSecondstwo = 00000000000000000000000000027;
const String _videoIdthree = 'https://youtu.be/sz3aopl4OhI?t=';
const double _startSecondsthree = 000000000000000000000000000933;
const String _videoIdfour = 'https://youtu.be/Bv7Hw2dDflQ';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/y__v0aEgzO0?t=';
