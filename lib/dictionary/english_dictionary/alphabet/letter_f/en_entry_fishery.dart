...
class EnglishEntryfishery extends StatefulWidget {
  const EnglishEntryfishery({super.key});

  @override
  State<EnglishEntryfishery> createState() => _EnglishEntryfisheryState();
}

class _EnglishEntryfisheryState extends State<EnglishEntryfishery> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fishery (Derived forms: fisheries)
1. A workplace where fish are caught and processed and sold (= piscary)
""",
  );

  final String keyword = "fishery";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fishery""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Freshwater fisheries provide jobs and food for many people.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fishery""",
                      // alsoEnglishWord: "also: fishery",
                      britshText: """IpaUK: /ˈfɪʃəri/""",
                      americanText: """IpaUS: /ˈfɪʃəri/""",
...
// With short examples define "fishery", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Freshwater fisheries provide jobs and food for many people.""",
                      kurdishText:
                          """ڕاوگەماسیی ئاوی سازگار کار و خواردنی زۆرکەس دابین دەکات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/8jNs5G88TiI?t=';
const double _startSecondsend = 00000000000000000000000000073;
const String _videoIdone = 'https://youtu.be/XJ79FPwav4g?t=';
const double _startSecondsone = 000000000000000000000000000356;
const String _videoIdtwo = 'https://youtu.be/6gr_gMSF0c0?t=';
const double _startSecondstwo = 000000000000000000000000000365;
const String _videoIdthree = 'https://youtu.be/laxYhf-uOs4?t=';
const double _startSecondsthree = 000000000000000000000000000494;
const String _videoIdfour = 'https://youtu.be/NROeA1IUdnk?t=';
const double _startSecondsfour = 0000000000000000000000000001268;
const String _videoIdfive = 'https://youtu.be/eIpDILFHTBw?t=';
const double _startSecondsfive = 000000000000000000000000000736;
