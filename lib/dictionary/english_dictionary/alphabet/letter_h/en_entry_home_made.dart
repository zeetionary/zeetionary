...
class EnglishEntryhomemade extends StatefulWidget {
  const EnglishEntryhomemade({super.key});

  @override
  State<EnglishEntryhomemade> createState() => _EnglishEntryhomemadeState();
}

class _EnglishEntryhomemadeState extends State<EnglishEntryhomemade> {
  @override
  void initState() {
    super.initState();
...
2. In a simple style, as if made at home
""",
  );

  final String keyword = "home-made";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""home-made""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I prefer home-made meals over takeout.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/P4l9Y5OHqpk?t=';
    const double startSecondsone = 0000000000000000000000000001227;
    const String videoIdtwo = 'https://youtu.be/g2nXwiNl9tg?t=';
    const double startSecondstwo = 000000000000000000000000000441;
    const String videoIdthree = 'https://youtu.be/16gB2BDXwTo?t=';
    const double startSecondsthree = 000000000000000000000000000361;
    const String videoIdfour = 'https://youtu.be/OINRkRf3aFs?t=';
    const double startSecondsfour = 000000000000000000000000000524;
    const String videoIdfive = 'https://youtu.be/I2MfxX0N7dQ?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """home-made""",
                      // alsoEnglishWord: "also: home-made",
                      britshText: """IpaUK: /ˌhəʊm ˈmeɪd/""",
                      americanText: """IpaUS: /ˌhəʊm ˈmeɪd/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە لە ماڵەوە درووستکراوە نەک لە کارگە یان لە فرۆشگا کڕابێت"""),
                    SentencesRow(
                      englishText: """I prefer home-made meals over takeout.""",
                      kurdishText:
                          """هەندێک خواردنی ماڵەوەم پێ باشترە وەک لە دیلیڤەری.""",
