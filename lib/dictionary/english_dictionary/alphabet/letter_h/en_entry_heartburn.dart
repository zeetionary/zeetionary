...
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەو هەستەی کە وادەزانیت شتێک لە سنگتدا دەسووتێتەوە کە درووست دەبێت بەهۆی گەڕانەوەی ترشی لە گەددەوە"""),
                    SentencesRow(
                      englishText:
                          """He felt heartburn after eating spicy food.""",
                      kurdishText:
                          """هەستی بە دڵە کزە دەکرد لە دوای خواردنی توون.""",
