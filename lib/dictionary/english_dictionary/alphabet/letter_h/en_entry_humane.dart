...
class EnglishEntryhumane extends StatefulWidget {
  const EnglishEntryhumane({super.key});

  @override
  State<EnglishEntryhumane> createState() => _EnglishEntryhumaneState();
}

class _EnglishEntryhumaneState extends State<EnglishEntryhumane> {
  @override
  void initState() {
    super.initState();
...
2. Pertaining to or concerned with the humanities (- humanist, humanistic)
"a humane education";
...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/l554kV12Wuo?t=';
    const double startSecondsend = 000000000000000000000000000149;
    const String videoIdone = 'https://youtu.be/MK2USJnG9og?t=';
    const double startSecondsone = 000000000000000000000000000787;
    const String videoIdtwo = 'https://youtu.be/XHXLbp7x3MM?t=';
    const double startSecondstwo = 00000000000000000000000000071;
    const String videoIdthree = 'https://youtu.be/TS4AM9mPX-8';
    ...
    const double startSecondsfive = 0000000000000000000000000001559;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """humane""",
                      // alsoEnglishWord: "also: humane",
                      britshText: """IpaUK: /hjuːˈmeɪn/""",
                      americanText: """IpaUS: /hjuːˈmeɪn/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """These regulations ensure the humane treatment of all refugees.""",
                      kurdishText:
                          """ئەم ڕێسایانە دڵنیایی دەدەن لە مامەڵەی مرۆڤانە لەگەڵ هەموو پەنابەران.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Campaigners claim that the animals are not being kept in humane conditions.""",
                      kurdishText:
                          """خەباتکاران بانگەشەی ئەوە دەکەن ئاژەڵان لە دۆخی مرۆڤانەدا ڕاناگیرێن.""",
