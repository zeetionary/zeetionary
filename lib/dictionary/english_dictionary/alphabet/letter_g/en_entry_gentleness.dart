...
class EnglishEntrygentleness extends StatefulWidget {
  const EnglishEntrygentleness({super.key});

  @override
  State<EnglishEntrygentleness> createState() => _EnglishEntrygentlenessState();
}

class _EnglishEntrygentlenessState extends State<EnglishEntrygentleness> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gentleness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gentleness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She will be remembered for her kindness and gentleness.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The gentleness of his touch calmed the baby.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gentleness""",
                      // alsoEnglishWord: "also: gentleness",
                      britshText: """IpaUK: /ˈdʒentlnəs/""",
                      americanText: """IpaUS: /ˈdʒentlnəs/""",
...
"""),
// With short examples define "gentleness", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """He was content to be pushed along by the gentleness of the breeze.""",
                      kurdishText:
                          """ئاسوودە بوو بەوەی پاڵبندرێتە پێشەوە بە نەرمی بایەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/EBlJYtgVQMs?t=';
const double _startSecondsend = 00000000000000000000000000093;
const String _videoIdone = 'https://youtu.be/Solb9uA-tgQ?t=';
const double _startSecondsone = 00000000000000000000000000025646;
const String _videoIdtwo = 'https://youtu.be/upzWztulGkM?t=';
const double _startSecondstwo = 0000000000000000000000000005813;
const String _videoIdthree = 'https://youtu.be/qBuzN1dP06M?t=';
const double _startSecondsthree = 0000000000000000000000000003117;
const String _videoIdfour = 'https://youtu.be/VeBX4WjhhXs?t=';
const double _startSecondsfour = 0000000000000000000000000001362;
const String _videoIdfive = 'https://youtu.be/qtOKrG_wK5A?t=';
const double _startSecondsfive = 000000000000000000000000000765;
