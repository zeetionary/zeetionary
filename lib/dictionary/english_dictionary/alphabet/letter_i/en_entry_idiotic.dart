...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'e_OgJzVOsQk';
    const double startSecondsone = 184;
    const String videoIdtwo = 'OnjI-FBdRTQ';
    const double startSecondstwo = 8832;
    const String videoIdthree = 'W4DnmTEHQug';
    const double startSecondsthree = 416;
    const String videoIdfour = 'JYJq02OTdSs';
    const double startSecondsfour = 103;
    const String videoIdfive = '4ExfAzih1Ow';
