...
class EnglishEntryautomate extends StatelessWidget {
  ...
  Future<void> speakautomate(String languageCode) async {
    ...
    await flutterTts.speak("automate");
  }
  ...
  Future<void> speakautomate1012(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("The entire manufacturing process has been automated.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "automate"),
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɔːtəmeɪt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɔːtəmeɪt/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakautomate1012("en-US"),
                          ),
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'RM9GY-n6PEA';
