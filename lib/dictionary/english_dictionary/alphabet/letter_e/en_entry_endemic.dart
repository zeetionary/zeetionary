...
class EnglishEntryendemic extends StatefulWidget {
  const EnglishEntryendemic({super.key});

  @override
  State<EnglishEntryendemic> createState() => _EnglishEntryendemicState();
}

class _EnglishEntryendemicState extends State<EnglishEntryendemic> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""endemic""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """endemic""",
                      // alsoEnglishWord: "also: endemic",
                      britshText: """IpaUK: /enˈdemɪk/""",
                      americanText: """IpaUS: /enˈdemɪk/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Malaria is endemic in many hot countries.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Corruption is endemic in the system.""");
  }
...
کوردی: (نەخۆشی) ناوچەیی، خۆماڵی، وڵات‌تەنەرەوە، باو، برەودار،	(گیانەوەر یا ڕووەکێ) ناوچەیی، ڕەسەن
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە زۆرجار لەناو لە شوێنیکی دیاریکراو یان لەناو کۆمەڵێک خەڵکدا هەیە و سەختە لێی ڕزگار ببیت"""),
          SentencesRow(
            englishText: """Malaria is endemic in many hot countries.""",
            kurdishText: """مەلاریا لە زۆر وڵاتی گەرمدا باوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Corruption is endemic in the system.""",
            kurdishText: """گەندەڵی لە ڕیشەی سیستەمەکەیە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: endemic
1. Of or relating to a disease (or anything resembling a disease) constantly present to greater or lesser extent in a particular locality (= endemical)
...
3. Originating where it is found (= autochthonal, autochthonic, autochthonous, indigenous, desi [Asia])
"endemic folkways";

- Noun: endemic (Derived forms: endemics)
1. A disease that is constantly present to a greater or lesser degree in people of a certain class or in people living in a particular location (= endemic disease)
...
const String _videoIdend = 'https://youtu.be/_wIOqHSsV9c?t=';
const double _startSecondsend = 777;
const String _videoIdone = 'https://youtu.be/ENhfIeZF_AY?t=';
const double _startSecondsone = 735;
const String _videoIdtwo = 'https://youtu.be/Uhgn8sYw8gg?t=';
const double _startSecondstwo = 426;
const String _videoIdthree = 'https://youtu.be/o0FiG7c6m48?t=';
const double _startSecondsthree = 1006;
const String _videoIdfour = 'https://youtu.be/-ZhxFtmAoXg?t=';
const double _startSecondsfour = 1174;
const String _videoIdfive = 'https://youtu.be/34oI0yd5YUc?t=';
const double _startSecondsfive = 414;
const String _videoIdsix = 'https://youtu.be/rdgXEV-ZjUU?t=';
const double _startSecondssix = 138;
