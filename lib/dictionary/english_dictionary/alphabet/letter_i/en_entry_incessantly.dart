...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'YLmDE_JYUNU';
    const double startSecondsend = 78;
    const String videoIdone = 'Mx8JkGHaGUI';
    const double startSecondsone = 1749;
    const String videoIdtwo = 'jJfgHa49GX0';
    const double startSecondstwo = 282;
    const String videoIdthree = 'yE-8iTNMlro';
    const double startSecondsthree = 241;
    const String videoIdfour = 'sGOXHdf-_dM';
    const double startSecondsfour = 481;
    const String videoIdfive = 'fzia-8MX4ig';
    const double startSecondsfive = 174;
