...
کوردی: پتەو، تۆکمە، قایم (نە زۆر و نە کەم)، جێگیر، بەهێز، سەخت، نەلەق، پێ‌بەجێ، سەقامگیر، چەقیو، ڕەق، توند، ڕۆنەچوو، دانەدەر،	بەڕشت، شێلگر، (لەسەر)سوور، بڕا، پتەو، بەبڕیار،	یەکلایی‌کەرەوە، لێبڕاوانە،	بەوەفا، بەئەمەگ، یەکلایی،	پتەو، بەبیروباوەڕ، تۆکمە،	لێ‌ڕابینراو، باوەڕپێکراو، بەڵگەنامەیی، جێ‌متمانە،	تەواو، ڕەبەق،	سەقامگیر، جێگیر (پارە، دراو و هتد)، پتەو، تۆکمە، یەکلایی‌کەرەوانە، لێبڕاوانە
"""),
// With short examples define "firm", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """By the age of only 28 she was a partner in a top law firm.""",
                      kurdishText:
                          """لە تەمەنی ٢٨ ساڵیدا هاوبەشی کۆمپانیایەکی باڵای یاسایی بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """قۆخەکان هێشتا توندن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """وەک هاوڕێی بەوەفا مانەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هیچ ڕێکەوتنێکی نەگۆڕ ئەنجام نەدرا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """No building can stand without firm foundations, and neither can a marriage.""",
                      kurdishText:
                          """هیچ بینایەک ناتوانێت بەبێ بنچینەیەکی جێگیر بوەستێت، و هەروەها هاوسەرگیریش.""",
                      onPressedBritish: () => speaksentence12("en-GB"),
                      onPressedAmerican: () => speaksentence12("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٥. (ھاوەڵناو) بەهێز و نەگۆڕ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                    ...
                    const DefinitionKurdish(
                        text:
                            """٦. (ھاوەڵناو) کە بەهێزە و وای پیشان دەدات لە کۆنترۆڵ دایە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کۆمپانیاکە ئێستا پێگەیەکی بەهێزی هەیە لە مارکێتەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەبێت کۆنترۆڵی توندمان بەسەر دۆخەکەدا هەبێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The euro remained firm against the dollar, but fell against the yen.""",
                      kurdishText:
                          """یۆرۆ بەهێز بەرامبەر دۆلار مایەوە، بەڵام بەرامبەر یەن داشکا.""",
                      onPressedBritish: () => speaksentence18("en-GB"),
                      onPressedAmerican: () => speaksentence18("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٨. (کردار) ئەوەی شتێک بەهێز یان توند بکەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەم بەرهەمە بانگەشەی ئەوە دەکات کە لە شەش هەفتەدا جەستەت توند دەکات.""",
