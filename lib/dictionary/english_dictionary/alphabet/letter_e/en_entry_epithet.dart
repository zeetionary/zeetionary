...
class EnglishEntryepithet extends StatefulWidget {
  const EnglishEntryepithet({super.key});

  @override
  State<EnglishEntryepithet> createState() => _EnglishEntryepithetState();
}

class _EnglishEntryepithetState extends State<EnglishEntryepithet> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""epithet""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """epithet""",
                      // alsoEnglishWord: "also: epithet",
                      britshText: """IpaUK: /ˈepɪθet/""",
                      americanText: """IpaUS: /ˈepɪθet/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His bravery earned him the epithet “the lion.”""");
  }
...
کوردی: ناو، سەرنێو، سەرناو، نازناو، ئاوەڵناو، سەرخستە، ڕەنگدێر، سیفەت
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) هاوەڵناو یان دەستەواژەیەک کە باسی کەسێک/شتێک دەکات، بەتایبەتی بۆ پەسندان یان ڕەخنەگرتن"""),
          SentencesRow(
            englishText: """His bravery earned him the epithet “the lion.”""",
            kurdishText: """بوێرییەکەی نازناوی 'شێر' ـی پێدا.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) وشەیەکی ناشرین کە بە کەسێک یان ژمارەیەک کەس دەگوترێت"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Racial epithets were scrawled on the walls.""",
            kurdishText: """جوێنی ڕەگەزی لەسەر دیوارەکە نووسرابوون.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: epithet (Derived forms: epithets)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/1h12uwyMZY0?t=';
const double _startSecondsend = 000000000000000000000000000000; // 60;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/p3O6bKdPLbw?t=';
const double _startSecondsone = 00000000000000000000000000000; // 3334;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/QmFqTnhmSZ4?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 464;
const String _videoIdthree = 'VIDEOhttps://youtu.be/U_kx78rAlAk?t=';
const double _startSecondsthree = 000000000000000000000000000; // 47;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/CKKSkA2lKF0?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 14;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/eUy4-hrMVXg?t=';
