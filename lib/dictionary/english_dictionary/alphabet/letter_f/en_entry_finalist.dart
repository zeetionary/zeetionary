...
class EnglishEntryfinalist extends StatefulWidget {
  const EnglishEntryfinalist({super.key});

  @override
  State<EnglishEntryfinalist> createState() => _EnglishEntryfinalistState();
}

class _EnglishEntryfinalistState extends State<EnglishEntryfinalist> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""finalist""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The team play last year’s beaten finalists.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """finalist""",
                      // alsoEnglishWord: "also: finalist",
                      britshText: """IpaUK: /ˈfaɪnəlɪst/""",
                      americanText: """IpaUS: /ˈfaɪnəlɪst/""",
...
// With short examples define "finalist", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تیمەکە یاری دەکەن دژ بە دۆڕاوەکانی یاریی کۆتایی ساڵی ڕابردوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/kaf4p10SiWY';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/MzSktgpfD84?t=';
const double _startSecondsone = 0000000000000000000000000001198;
const String _videoIdtwo = 'https://youtu.be/Ihoys69G56U?t=';
const double _startSecondstwo = 000000000000000000000000000189;
const String _videoIdthree = 'https://youtu.be/2G-B5upjLjM?t=';
const double _startSecondsthree = 00000000000000000000000000076;
const String _videoIdfour = 'https://youtu.be/CiHUcQG7bH4?t=';
const double _startSecondsfour = 000000000000000000000000000280;
const String _videoIdfive = 'https://youtu.be/Yo8UzbQQH3k?t=';
