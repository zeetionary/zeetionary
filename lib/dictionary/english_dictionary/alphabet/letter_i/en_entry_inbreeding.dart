...
class EnglishEntryinbreeding extends StatefulWidget {
  const EnglishEntryinbreeding({super.key});

  @override
  State<EnglishEntryinbreeding> createState() => _EnglishEntryinbreedingState();
}

class _EnglishEntryinbreedingState extends State<EnglishEntryinbreeding> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inbreeding""");
  }
