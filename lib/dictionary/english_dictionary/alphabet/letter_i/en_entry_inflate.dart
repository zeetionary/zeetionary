...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/9yjZpBq1XBE?t=';
    const double startSecondsend = 0000000000000000000000000001849;
    const String videoIdone = 'https://youtu.be/VVsdb90aOmA?t=';
    const double startSecondsone = 000000000000000000000000000787;
    const String videoIdtwo = 'https://youtu.be/8GKI2sYe1CI?t=';
    const double startSecondstwo = 000000000000000000000000000547;
    const String videoIdthree = 'https://youtu.be/gNqQL-1gZF8?t=';
    const double startSecondsthree = 00000000000000000000000000088;
    const String videoIdfour = 'https://youtu.be/fOY2vdNbjiI?t=';
    const double startSecondsfour = 00000000000000000000000000073;
    const String videoIdfive = 'https://youtu.be/vjDYfvPW4mA?t=';
    const double startSecondsfive = 000000000000000000000000000398;
