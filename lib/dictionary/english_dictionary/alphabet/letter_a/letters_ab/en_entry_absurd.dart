...
class EnglishEntryabsurd extends StatefulWidget {
  const EnglishEntryabsurd({super.key});

  @override
  State<EnglishEntryabsurd> createState() => _EnglishEntryabsurdState();
}

class _EnglishEntryabsurdState extends State<EnglishEntryabsurd> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """absurd""",
                      // alsoEnglishWord: "also: absurd",
                      britshText: """IpaUK: /əbˈsɜːrd/""",
                      americanText: """IpaUS: /əbˈsɜːd/""",
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final double _startSeconds = 2250;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'pqgVQYmrObc';
  final double _startSeconds = 1857;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '9-GRzu6zbS0';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'BfzXLjK6Pno';
