...
class EnglishEntrygangling extends StatefulWidget {
  const EnglishEntrygangling({super.key});

  @override
  State<EnglishEntrygangling> createState() => _EnglishEntryganglingState();
}

class _EnglishEntryganglingState extends State<EnglishEntrygangling> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gangling""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Susan showed up with a tall, gangly boy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gangling""",
                      // alsoEnglishWord: "also: gangling",
                      britshText: """IpaUK: /ˈɡæŋɡlɪŋ/""",
                      americanText: """IpaUS: /ˈɡæŋɡlɪŋ/""",
...
// With short examples define "gangling", please follow LX instructions
                    ...
                    const AlsoEnglishckb(word: "ھەروەھا: lanky"),
                    SentencesRow(
                      englishText:
                          """Susan showed up with a tall, gangly boy.""",
                      kurdishText:
                          """سوزان لەگەڵ کوڕێکی درێژی لەقلۆقی دەرکەوت.""",
...
const double _startSecondsend = 000000000000000000000000000884;
const String _videoIdone = 'https://youtu.be/CrKkjXMYFzs?t=';
const double _startSecondsone = 000000000000000000000000000507;
const String _videoIdtwo = 'https://youtu.be/5bBc4h91Was?t=';
const double _startSecondstwo = 000000000000000000000000000532;
const String _videoIdthree = 'https://youtu.be/jfBDZjI6SiQ?t=';
const double _startSecondsthree = 000000000000000000000000000271;
const String _videoIdfour = 'https://youtu.be/bqUSMMd_RlY?t=';
const double _startSecondsfour = 00000000000000000000000000027;
const String _videoIdfive = 'https://youtu.be/Uci-m0TwSo8?t=';
