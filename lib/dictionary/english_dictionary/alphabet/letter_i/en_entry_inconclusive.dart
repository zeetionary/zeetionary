...
class EnglishEntryinconclusive extends StatefulWidget {
  const EnglishEntryinconclusive({super.key});

  @override
  State<EnglishEntryinconclusive> createState() => _EnglishEntryinconclusiveState();
}

class _EnglishEntryinconclusiveState extends State<EnglishEntryinconclusive> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inconclusive""");
  }
