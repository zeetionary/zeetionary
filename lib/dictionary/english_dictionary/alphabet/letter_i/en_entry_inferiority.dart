...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'r5cqa9V0mUo';
    const double startSecondsend = 818;
    const String videoIdone = 'Solb9uA-tgQ';
    const double startSecondsone = 22660;
    const String videoIdtwo = 'PlgmD-ZjDRU';
    const double startSecondstwo = 357;
    const String videoIdthree = 'gsXYJn28Gn4';
    const double startSecondsthree = 552;
    const String videoIdfour = 'IfYRzxeMdGs';
    const double startSecondsfour = 155;
    const String videoIdfive = '384qFPXCuO4';
    const double startSecondsfive = 1261;
