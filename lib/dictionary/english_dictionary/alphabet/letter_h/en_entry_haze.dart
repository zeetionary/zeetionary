...
class EnglishEntryhaze extends StatefulWidget {
  const EnglishEntryhaze({super.key});

  @override
  State<EnglishEntryhaze> createState() => _EnglishEntryhazeState();
}

class _EnglishEntryhazeState extends State<EnglishEntryhaze> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: haze (Derived forms: hazes)
1. Atmospheric moisture, dust or smoke that causes reduced visibility
 
2. Confusion characterized by lack of clarity (- daze, fog)

- Verb: haze (Derived forms: hazing, hazes, hazed)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""In the evenings a blue haze hung in the valleys.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """haze""",
                      // alsoEnglishWord: "also: haze",
                      britshText: """IpaUK: /heɪz/""",
                      americanText: """IpaUS: /heɪz/""",
...
کوردی: مژی تەنک، تەم‌ومژی تۆزاوی، تۆزەتەم، تەم‌ومژی تەنک، سووکەتەم
"""),
// With short examples define "haze", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) تەمێک کە بەهۆی کەشووهەوای گەرمەوە درووست دەبێت"""),
                    SentencesRow(
                      englishText:
                          """In the evenings a blue haze hung in the valleys.""",
                      kurdishText:
                          """لە ئێواراندا تەمێکی شین باڵی بەسەر دۆڵەکاندا دەکێشا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) هەوایەک کە شتێکی تێدایە بینین سەخت دەکات"""),
                    SentencesRow(
                      englishText:
                          """Meetings are always conducted in a haze of cigarette smoke.""",
                      kurdishText:
                          """کۆبوونەوەکان هەمیشە لە نێو دووکەڵی جگەرەدا بەڕێوە دەچن..""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) دۆخێکی دەروونی کە تێیدا بیرکردنەوەت ڕوون نییە"""),
                    SentencesRow(
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/-C3CjOkF-jY?t=';
const double _startSecondsend = 000000000000000000000000000996;
const String _videoIdone = 'https://youtu.be/pU4iFVR3RCg?t=';
const double _startSecondsone = 00000000000000000000000000072;
const String _videoIdtwo = 'https://youtu.be/Z0SzIkheaFg?t=';
const double _startSecondstwo = 0000000000000000000000000005;
const String _videoIdthree = 'https://youtu.be/WihpfXxGOBo?t=';
const double _startSecondsthree = 000000000000000000000000000860;
const String _videoIdfour = 'https://youtu.be/OnjI-FBdRTQ?t=';
const double _startSecondsfour = 00000000000000000000000000017565;
const String _videoIdfive = 'https://youtu.be/yUcX_q7m6IQ?t=';
