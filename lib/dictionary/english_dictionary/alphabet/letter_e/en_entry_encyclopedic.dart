...
class EnglishEntryencyclopedic extends StatefulWidget {
  const EnglishEntryencyclopedic({super.key});

  @override
  State<EnglishEntryencyclopedic> createState() =>
      _EnglishEntryencyclopedicState();
}

class _EnglishEntryencyclopedicState extends State<EnglishEntryencyclopedic> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("encyclopedic");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "encyclopedic",
                      // alsoEnglishWord: "also: encyclopedic",
                      britshText: "IpaUK: /ɪnˌsaɪkləˈpiːdɪk/",
                      americanText: "IpaUS: /ɪnˌsaɪkləˈpiːdɪk/",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "encyclopedic";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""An encyclopedic dictionary offers detailed explanations.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("She has an encyclopedic knowledge of natural history.");
  }
...
کوردی: سەربە ئینسایکلۆپیدیا، زانست‌نامەیی
"""),
          ...
          CustomRichText(
            ...
            onTap: () {
              Routemaster.of(context)
                  .push("/english-encyclopedic/encyclopedia");
            },
          ),
          SentencesRow(
            englishText:
                """An encyclopedic dictionary offers detailed explanations.""",
            kurdishText:
                """فەرهەنگێکی زانست‌نامەیی ڕوونکردنەوەی ورد لەخۆ دەگرێت.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ھاوەڵناو) هەبوونی زانیاریی زۆر لەسەر ژمارەیەکی زۆر بابەت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """She has an encyclopedic knowledge of natural history.""",
            kurdishText: """زانیاریی زانست‌نامەیی لەسەر مێژووی سرووشتی هەیە.""",
            englishNote:
                "Natural history is the scientific study of animals or plants, especially as concerned with observation rather than experiment, and presented in popular rather than academic form.",
...
1. Comprehensive in scope or content (as an encyclopaedia) (= encyclopaedic [Brit])
