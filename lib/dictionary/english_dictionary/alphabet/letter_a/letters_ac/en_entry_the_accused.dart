...
class EnglishEntrytheaccused extends StatelessWidget {
  EnglishEntrytheaccused({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakTheaccused(String languageCode) async {
    // DOPSUM: CHANGE speakTheaccused
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("the accused"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakTh1547(String languageCode) async {
    // DOPSUM: CHANGE speakTheaccused
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The accused was found innocent."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakT21536(String languageCode) async {
    // DOPSUM: CHANGE speakTheaccused
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("All the accused have pleaded guilty."); // DOPSUM: CHANGE TEXT
  }
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 8, // 2 + VIDEOS FIND: KURDISHH
      child: Scaffold(
        appBar: AppBar(
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'the accused', // DOPSUM: CHANGE WORD ENTRY - Find /ði əˈkjuːzd/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ði əˈkjuːzd/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ði əˈkjuːzd/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
