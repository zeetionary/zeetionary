...
// blank divider
  ...
  Future<void> speakBearers7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBearers77"); // DOPSUM: CHANGE TEXT
  }
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  static String myVideoId = "YGgnza9hLMM";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  static String myVideoId = "Bd_Zpqa7X08";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  static String myVideoId = "YmtIrYXlGRM";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  static String myVideoId = "DoI-rn_xNAw";
