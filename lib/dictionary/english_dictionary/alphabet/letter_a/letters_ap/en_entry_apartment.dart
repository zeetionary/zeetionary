                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "apartment"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈpɑːtmənt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈpɑːrtmənt/"),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'vnYJxD2jd7k';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'f2fUhZrAq_s';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'kUMQ-bRxOjw';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'byt6WYw6J6g';
  final double _startSeconds = 1;
