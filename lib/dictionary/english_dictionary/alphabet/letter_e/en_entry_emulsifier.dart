...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) مادەیەک کە زیاد دەکرێت بۆ خۆراک یان شتی بۆ ئەوەی وا بکات پێکھاتەکانی تێکەڵ بن"""),
          SentencesRow(
            englishText:
                """The cake recipe calls for an emulsifier to mix ingredients.""",
            kurdishText:
                """ڕەچەتەی کێکەکە پێویستیی بە شیراوکەرە ھەیە بۆ تێکەڵبوونی پێکھاتەکان.""",
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'RgIfypeptJw';
