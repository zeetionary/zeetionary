...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '8XVRpotGsO0';
    const double startSecondsend = 90;
    const String videoIdone = '2pCRplUQVMI';
    const double startSecondsone = 2324;
    const String videoIdtwo = 'Yu8PBEU8ADo';
    const double startSecondstwo = 248;
    const String videoIdthree = 'W2C2LHE0szI';
    const double startSecondsthree = 719;
    const String videoIdfour = 'O7chWBMNKns';
    const double startSecondsfour = 169;
    const String videoIdfive = '69r1SxxPnaI';
    const double startSecondsfive = 66;
