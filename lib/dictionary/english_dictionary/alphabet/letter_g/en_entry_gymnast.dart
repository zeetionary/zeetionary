...
class EnglishEntrygymnast extends StatefulWidget {
  const EnglishEntrygymnast({super.key});

  @override
  State<EnglishEntrygymnast> createState() => _EnglishEntrygymnastState();
}

class _EnglishEntrygymnastState extends State<EnglishEntrygymnast> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gymnast (Derived forms: gymnasts)
1. An athlete who is skilled in gymnastics
"sleek and agile as a gymnast"
""",
  );

  final String keyword = "gymnast";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gymnast""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Young gymnasts have to train for up to five hours a day.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He swung down from the tree like a gymnast.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gymnast""",
                      // alsoEnglishWord: "also: gymnast",
                      britshText: """IpaUK: /ˈdʒɪmnæst/""",
                      americanText: """IpaUS: /ˈdʒɪmnæst/""",
...
// \b(gymnast)(s|ed|es|ing)?\b(?=[.!?]?)
                    ...
                    CustomRichText(
                      ...
                      linkText: "جیمناستیکس ",
                      textAfterLink: "دەکات، بە تایبەتی لە پاڵەوانێتییەکەدا",
                      onTap: () {
                        Routemaster.of(context)
                            .push("/english-gymnast/gymnastics");
                      },
                    ),
                    SentencesRow(
                      englishText:
                      ...
                      kurdishText:
                          """جیمناستە گەنجەکان دەبێت بۆ سەروو پێنج کاتژمێر لە ڕۆژێکدا ڕاهێنان بکەن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He swung down from the tree like a gymnast.""",
                      kurdishText: """وەک جیمناستێک لە دارەکە هاتە خوارەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/wNZ2K3z-uoQ?t=';
const double _startSecondsend = 00000000000000000000000000057;
const String _videoIdone = 'https://youtu.be/9bLNQVcN_IM';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/RnyK-boMINE';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/zHX0H7FAym0?t=';
const double _startSecondsthree = 000000000000000000000000000234;
const String _videoIdfour = 'https://youtu.be/i1Ke14lne9M?t=';
const double _startSecondsfour = 000000000000000000000000000194;
const String _videoIdfive = 'https://youtu.be/prdJbeyyPo0?t=';
