...
class EnglishEntryguidance extends StatefulWidget {
  const EnglishEntryguidance({super.key});

  @override
  State<EnglishEntryguidance> createState() => _EnglishEntryguidanceState();
}

class _EnglishEntryguidanceState extends State<EnglishEntryguidance> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: guidance (Derived forms: guidances)
1. Direction or helpful suggestions regarding a decision or future course of action (- counsel, counseling [US], counselling [Brit, Cdn], direction)
 
2. The act of guiding or showing the way (- steering)
 
3. The act of setting and holding a course (- steering, direction)
"a new council was installed under the guidance of the king"; 
""",
  );

  final String keyword = "guidance";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""guidance""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """guidance""",
                      // alsoEnglishWord: "also: guidance",
                      britshText: """IpaUK: /ˈɡaɪdns/""",
                      americanText: """IpaUS: /ˈɡaɪdns/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """I think you should seek guidance from your lawyer on this matter.""",
                      kurdishText:
                          """پێموایە لەسەر ئەم بابەتە دەبێت ڕێنمایی پارێزەرەکەت وەربگریت.""",
