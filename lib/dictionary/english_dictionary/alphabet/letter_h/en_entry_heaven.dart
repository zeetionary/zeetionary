...
class EnglishEntryheaven extends StatefulWidget {
  const EnglishEntryheaven({super.key});

  @override
  State<EnglishEntryheaven> createState() => _EnglishEntryheavenState();
}

class _EnglishEntryheavenState extends State<EnglishEntryheaven> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heaven (Derived forms: heavens)
1. Any place of complete bliss and delight and peace (- Eden, paradise, nirvana, promised land, Shangri-la)
- Noun: Heaven
1. A place regarded by various beliefs as the abode of their deities; also a place where good people are believed to go after death (Derived forms: Heavens)
""",
  );

  final String keyword = "heaven";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I feel like I've died and gone to heaven.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I told her Daddy was in heaven with God.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Our child seemed a gift from heaven.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This isn't exactly my idea of heaven!""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It was heaven being away from the office for a week.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The island is truly a heaven on earth.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Four tall trees stretched up to the heavens.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heaven""",
                      // alsoEnglishWord: "also: heaven",
                      britshText: """IpaUK: /ˈhevn/""",
                      americanText: """IpaUS: /ˈhevn/""",
...
کوردی: بەهەشت،	عەرش، گەردوون، ئاسمان
"""),
// With short examples define "heaven", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بەهەشت؛ شوێنێک کە هەندێک ئایین باوەڕیان وایە خودای لێیە و کەسانی باش دەچن بۆی دوای مەرگ"""),
                    SentencesRow(
                      englishText:
                          """I feel like I've died and gone to heaven.""",
                      kurdishText: """وا هەست دەکەم مردووم و چوومەتە بەهەشت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پێمگوت باوکی لە بەهەشتە لەگەڵ خودا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """منداڵەکەمان وەک دیارییەک لە بەهەشتەوە وابوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) شوێنێک یان دۆخێک کە تێیدا زۆر دڵخۆشی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """This isn't exactly my idea of heaven!""",
                      kurdishText:
                          """ئەمە بە تەواوی تێگەشتنی من نییە بۆ خۆشی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بەهەشت بوو بۆ هەفتەیەک لە ئۆفیس دوور بووم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دوورگەکە بەڕاستی بەهەشتی سەر زەوییە.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) ئاسمان"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Four tall trees stretched up to the heavens.""",
                      kurdishText:
                          """چوار داری گەورە بەرەو ئاسمان درێژبووبوونەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/4itx6mXEJ6c?t=';
const double _startSecondsend = 000000000000000000000000000808;
const String _videoIdone = 'https://youtu.be/tHTTQIjLRzw?t=';
const double _startSecondsone = 000000000000000000000000000113;
const String _videoIdtwo = 'https://youtu.be/6EAnFFOpSgU?t=';
const double _startSecondstwo = 000000000000000000000000000136;
const String _videoIdthree = 'https://youtu.be/KmL0zZg0Zyo?t=';
const double _startSecondsthree = 000000000000000000000000000212;
const String _videoIdfour = 'https://youtu.be/lq9no5yCNmU?t=';
const double _startSecondsfour = 000000000000000000000000000114;
const String _videoIdfive = 'https://youtu.be/qbk_dTzcfA0?t=';
const double _startSecondsfive = 000000000000000000000000000186;
