...
class EnglishEntryablebodied extends StatefulWidget {
  const EnglishEntryablebodied({super.key});

  @override
  State<EnglishEntryablebodied> createState() => _EnglishEntryablebodiedState();
}

class _EnglishEntryablebodiedState extends State<EnglishEntryablebodied> {
  @override
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "able-bodied");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: able-bodied");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /ˌeɪbl ˈbɒdid/");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakablebodied(String languageCode) async {
    // DOPSUM: CHANGE speakablebodied
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /ˌeɪbl ˈbɑːdid/");
  }
}
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakablebodieds1(String languageCode) async {
    // DOPSUM: CHANGE speakablebodied
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  ...
  final String _videoId = '67S2RDPqoOU';
  final double _startSeconds = 4183;
...
class _YoutubeEmbeddedendState extends State<YoutubeEmbeddedend> {
  late YoutubePlayerController _controller;
  final String _videoId = 'fnJDVV5lfUU';
...
// speakablebodieds111111111111111111111111111111111
