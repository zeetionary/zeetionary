...
// replace these: EnglishEntryaccidental - speakAccidental - accidental - /ˌæksɪˈdentl/

enum TtsState { playing }

class EnglishEntryaccidental extends StatelessWidget {
  EnglishEntryaccidental({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAccidental(String languageCode) async {
    // DOPSUM: CHANGE speakAccidental
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("accidental"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakA1598(String languageCode) async {
    // DOPSUM: CHANGE speakAccidental
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "I didn't think our meeting was accidental—he must have known I would be there."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "accidental"), // DOPSUM: CHANGE WORD ENTRY
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌæksɪˈdentl/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakAccidental("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /ˌæksɪˈdentl/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                            CustomIconButtonAmerican(
                              onPressed: () => speakAccidental("en-US"),
                            ),
                          ],
                        ),
                      ],
...
2. Not of prime or central importance (= incidental, nonessential)
"the character's motives remain accidental to the plot";
 
3. Being minor or subordinate; happening as a chance consequence (= incidental, incident)
"accidental expenses";
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'kUTYSyd3LR0';
