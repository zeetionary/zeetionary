...
class EnglishEntryincompletely extends StatefulWidget {
  const EnglishEntryincompletely({super.key});

  @override
  State<EnglishEntryincompletely> createState() =>
      _EnglishEntryincompletelyState();
}

class _EnglishEntryincompletelyState extends State<EnglishEntryincompletely> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incompletely""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'fZBC3nmvJb8';
    const double startSecondsend = 980;
    const String videoIdone = 'UkeGQotnsDU';
    const double startSecondsone = 328;
    const String videoIdtwo = '-wIt_WsJGfw';
    const double startSecondstwo = 5187;
    const String videoIdthree = 'MfH1GsVf7jI';
    const double startSecondsthree = 359;
    const String videoIdfour = 'uKElvfhNuhQ';
    const double startSecondsfour = 4;
    const String videoIdfive = 'p4T4zuJfOsA';
