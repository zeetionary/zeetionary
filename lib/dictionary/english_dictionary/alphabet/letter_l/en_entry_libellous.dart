...
class EnglishEntrylibellous extends StatefulWidget {
  const EnglishEntrylibellous({super.key});

  @override
  State<EnglishEntrylibellous> createState() => _EnglishEntrylibellousState();
}

class _EnglishEntrylibellousState extends State<EnglishEntrylibellous> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""libellous""");
  }
