...
// Define the word "asphyxiate" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryasphyxiate - replace speakAsphyxiate

// replace asphyxiate - /əsˈfɪksieɪt/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryasphyxiate extends StatelessWidget {
  // blank divider
  EnglishEntryasphyxiate({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakasphyxiate(String languageCode) async {
    // DOPSUM: CHANGE speakAsphyxiate
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("asphyxiate");
  }

  Future<void> speakasphyxiate617(String languageCode) async {
    // DOPSUM: CHANGE speakAsphyxiate
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He was asphyxiated by the smoke.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "asphyxiate"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əsˈfɪksieɪt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əsˈfɪksieɪt/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'GqbgFtKwdHw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'VrOBh6BjS28';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 's5xbcLZuFK4';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'Eh_CGOtmwrY';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'bhYxg0GOtCI';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'CmWLtXQgZOo';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'Cz27UNHsXDc';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'dQEb_L2fms0';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = '6qTNObVSZlg';
