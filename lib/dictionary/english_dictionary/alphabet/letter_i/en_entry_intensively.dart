...
class EnglishEntryintensively extends StatefulWidget {
  const EnglishEntryintensively({super.key});

  @override
  State<EnglishEntryintensively> createState() =>
      _EnglishEntryintensivelyState();
}

class _EnglishEntryintensivelyState extends State<EnglishEntryintensively> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "intensively";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intensively""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This case has been intensively studied.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was studying intensively six days a week.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/6T_-DiAzYBc?t=';
    const double startSecondsend = 000000000000000000000000000974;
    const String videoIdone = 'https://youtu.be/0H_UxhRXgec?t=';
    const double startSecondsone = 000000000000000000000000000438;
    const String videoIdtwo = 'https://youtu.be/KYqsV05gEK8?t=';
    const double startSecondstwo = 0000000000000000000000000001143;
    const String videoIdthree = 'https://youtu.be/URoVKPVDKPU?t=';
    const double startSecondsthree = 000000000000000000000000000964;
    const String videoIdfour = 'https://youtu.be/xp-8HysWkxw?t=';
    const double startSecondsfour = 0000000000000000000000000001104;
    const String videoIdfive = 'https://youtu.be/RsgFW99THb0?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """intensively""",
                      // alsoEnglishWord: "also: intensively",
                      britshText: """IpaUK: /ɪnˈtensɪvli/""",
                      americanText: """IpaUS: /ɪnˈtensɪvli/""",
...
کوردی: 
"""),
// With short examples define "intensively", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بەشێوەیەکی تەواو و وردەکارییەوە"""),
                    SentencesRow(
                      englishText:
                          """This case has been intensively studied.""",
                      kurdishText: """ئەم کەیسە بە وردی لێکۆڵینەوەی لێکراوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بەشێوەیەک کە بڕێکی زۆر کار و چالاکی لەخۆدەگرێت لە ماوەیەکی کەم"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She was studying intensively six days a week.""",
                      kurdishText: """شەش ڕۆژ لە هەفتەیەک بە ڕژدی دەیخوێند.""",
