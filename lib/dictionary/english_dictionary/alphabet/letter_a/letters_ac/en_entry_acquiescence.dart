...
// replace these: replace EnglishEntryacquiescence - replace speakAcquiescence - replace acquiescence - /ˌækwiˈesns/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryacquiescence extends StatelessWidget {
  EnglishEntryacquiescence({super.key});
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌækwiˈesns/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'N-YtnuYKdqc';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '9k3UvaC5m7o';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'wAEex6nW4gI';
