...
class EnglishEntryformless extends StatefulWidget {
  const EnglishEntryformless({super.key});

  @override
  State<EnglishEntryformless> createState() => _EnglishEntryformlessState();
}

class _EnglishEntryformlessState extends State<EnglishEntryformless> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: formless 
1. Having no definite form or distinct shape (= amorphous, shapeless)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""formless""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She saw a formless shadow in the dark room.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """formless""",
                      // alsoEnglishWord: "also: formless",
                      britshText: """IpaUK: /ˈfɔːmləs/""",
                      americanText: """IpaUS: /ˈfɔːrmləs/""",
...
کوردی: بێ‌شێوە، بێ‌بیچم، بەبێ شێوەیەکی دیار، لەهیچ‌نەچوو
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) شتێک کە شێوە و پێکهاتەی ڕوون و ئاشکرای نییە"""),
                    SentencesRow(
                      englishText:
                          """She saw a formless shadow in the dark room.""",
                      kurdishText:
                          """سێبەرێکی بێ‌شێوەی لە ژوورە تاریکەکەدا بینی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/HhSNbKezP64?t=';
const double _startSecondsend = 000000000000000000000000000192;
const String _videoIdone = 'https://youtu.be/8MK4DK1lgdE?t=';
const double _startSecondsone = 000000000000000000000000000413;
const String _videoIdtwo = 'https://youtu.be/LbTSWDexJR4?t=';
const double _startSecondstwo = 00000000000000000000000000087;
const String _videoIdthree = 'https://youtu.be/kDrKsHPQFeQ?t=';
const double _startSecondsthree = 000000000000000000000000000158;
const String _videoIdfour = 'https://youtu.be/c8sbJT4cS2c?t=';
const double _startSecondsfour = 00000000000000000000000000064;
const String _videoIdfive = 'https://youtu.be/SNbhExKfqtA?t=';
