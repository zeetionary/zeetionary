...
class EnglishEntryeverything extends StatefulWidget {
  const EnglishEntryeverything({super.key});

  @override
  State<EnglishEntryeverything> createState() => _EnglishEntryeverythingState();
}

class _EnglishEntryeverythingState extends State<EnglishEntryeverything> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""everything""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """everything""",
                      // alsoEnglishWord: "also: everything",
                      britshText: """IpaUK: /ˈevriθɪŋ/""",
                      americanText: """IpaUS: /ˈevriθɪŋ/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "everything";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Everything had gone.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""When we confronted him, he denied everything.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Take this bag, and leave everything else to me.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She seemed to have everything—looks, money, intelligence.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Everything in the capital is now quiet.""");
  }
...
کوردی: هەموو شتێ، هەر شتێ، گرنگ‌ترین شت
"""),
          const DefinitionKurdish(text: """١. (جێناو) هەموو شتێک"""),
          SentencesRow(
            englishText: """Everything had gone.""",
            kurdishText: """هەموو شتێک چوو بوو.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """ژممارە. (جێناو) پێنناسە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """When we confronted him, he denied everything.""",
            kurdishText: """کە ڕووبەڕووی بووینەوە، نکۆڵیی لە هەموو شتێک کرد.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Take this bag, and leave everything else to me.""",
            kurdishText: """ئەم جانتا ببە و هەموو شتێکی دیکە بۆ من جێبهێڵە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """وا دیاربوو کە هەموو شتێکی هەبێت ـ جوانی، پارە، زیرەکی.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هەموو شتێک لە پایتەخت ئێستا ئارامە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """پارە هەموو شت نییە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """My family means everything to me.""",
            kurdishText: """خێزانەکەم هەموو شتە لام.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Pronoun: everything
1. All things; the whole quantity or number (= all)
...
const double _startSecondsend = 000000000000000000000000000000; // 370;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/VrKW58MS12g?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1343;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/gFuEoxh5hd4?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 257;
const String _videoIdthree = 'VIDEOhttps://youtu.be/_spuxXnul0U?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1216;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/wizgxRBfVTY?t=';
