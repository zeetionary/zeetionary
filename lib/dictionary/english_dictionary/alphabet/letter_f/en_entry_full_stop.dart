...
class EnglishEntryfullstop extends StatefulWidget {
  const EnglishEntryfullstop({super.key});

  @override
  State<EnglishEntryfullstop> createState() => _EnglishEntryfullstopState();
}

class _EnglishEntryfullstopState extends State<EnglishEntryfullstop> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: full stop (Derived forms: full stops)
1. A punctuation mark (.) placed at the end of a declarative sentence to indicate a full stop or after abbreviations (- period, point, stop, full point [Brit, rare])
""",
  );

  final String keyword = "full stop";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""full stop""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I've already told you—we can't afford it, full stop!""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """full stop""",
                      // alsoEnglishWord: "also: full stop",
                      britshText: """IpaUK: /ˌfʊl ˈstɒp/""",
                      americanText: """IpaUS: /ˌfʊl ˈstɑːp/""",
...
// With short examples define "full stop", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) خاڵێکە کە لە کۆتایی ڕستەیەک ڕستە بەکاردێت بۆ گوتنی ئەوەی هیچی دیکە نییە بۆ گوتن"""),
                    SentencesRow(
                      englishText:
                          """I've already told you—we can't afford it, full stop!""",
                      kurdishText:
                          """پێشوەختە پێم گوتوویت کە ناتوانین پارەکەی بدەین، نوقتە!""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/RAlI0pbMQiM?t=';
const double _startSecondsend = 000000000000000000000000000392;
const String _videoIdone = 'https://youtu.be/HY_OIwideLg?t=';
const double _startSecondsone = 000000000000000000000000000425;
const String _videoIdtwo = 'https://youtu.be/b1JlYZQG3lI?t=';
const double _startSecondstwo = 000000000000000000000000000935;
const String _videoIdthree = 'https://youtu.be/ZPM9aAvOIg0?t=';
const double _startSecondsthree = 0000000000000000000000000004;
const String _videoIdfour = 'https://youtu.be/k19WhcFH7WU?t=';
const double _startSecondsfour = 000000000000000000000000000254;
const String _videoIdfive = 'https://youtu.be/3CLlRUqinHc?t=';
