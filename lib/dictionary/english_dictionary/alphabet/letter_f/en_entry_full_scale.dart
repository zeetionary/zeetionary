...
class EnglishEntryfullscale extends StatefulWidget {
  const EnglishEntryfullscale({super.key});

  @override
  State<EnglishEntryfullscale> createState() => _EnglishEntryfullscaleState();
}

class _EnglishEntryfullscaleState extends State<EnglishEntryfullscale> {
  @override
  void initState() {
    super.initState();
...
1. Using all available resources (- all-out, full-frontal)
"a full-scale campaign against nuclear power plants";
""",
  );

  final String keyword = "full-scale";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""full-scale""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The police made a full-scale search of the area.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The museum displayed a full-scale model of the dinosaur.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """full-scale""",
                      // alsoEnglishWord: "also: full-scale",
                      britshText: """IpaUK: /ˌfʊl ˈskeɪl/""",
                      americanText: """IpaUS: /ˌfʊl ˈskeɪl/""",
...
// With short examples define "full-scale", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پۆلیس گەڕانێکی تەواوی ناوچکەی کرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە هەمان قەبارەی ئەو شتەی هەیە کە پیشانی دەدات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The museum displayed a full-scale model of the dinosaur.""",
                      kurdishText:
                          """مۆزەخانەکە نموونەیەکی تەواو قەبارەی دایناسۆرەکەی نمایش کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/PbQyevYlLAY?t=';
const double _startSecondsend = 000000000000000000000000000673;
const String _videoIdone = 'https://youtu.be/MVu8QbxafJE?t=';
const double _startSecondsone = 0000000000000000000000000009;
const String _videoIdtwo = 'https://youtu.be/tyixMpuGEL8?t=';
const double _startSecondstwo = 000000000000000000000000000303;
const String _videoIdthree = 'https://youtu.be/pzvbUpKU4eE?t=';
const double _startSecondsthree = 00000000000000000000000000064;
const String _videoIdfour = 'https://youtu.be/ElQdUHSXkME?t=';
const double _startSecondsfour = 000000000000000000000000000434;
const String _videoIdfive = 'https://youtu.be/Lsv8jps7H9k?t=';
