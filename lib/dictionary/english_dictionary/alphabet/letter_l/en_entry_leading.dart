...
class EnglishEntryleading extends StatefulWidget {
  const EnglishEntryleading({super.key});

  @override
  State<EnglishEntryleading> createState() => _EnglishEntryleadingState();
}

class _EnglishEntryleadingState extends State<EnglishEntryleading> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""leading""");
  }
