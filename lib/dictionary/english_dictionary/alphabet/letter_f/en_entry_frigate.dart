...
class EnglishEntryfrigate extends StatefulWidget {
  const EnglishEntryfrigate({super.key});

  @override
  State<EnglishEntryfrigate> createState() => _EnglishEntryfrigateState();
}

class _EnglishEntryfrigateState extends State<EnglishEntryfrigate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frigate (Derived forms: frigates)
1. A United States warship larger than a destroyer and smaller than a cruiser
 
2. A warship smaller than a destroyer, typically equipped with some form of missile or used for anti-submarine activities
 
3. A medium size square-rigged warship of the 18th and 19th centuries
""",
  );

  final String keyword = "frigate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frigate""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The frigate was equipped with advanced radar.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frigate""",
                      // alsoEnglishWord: "also: frigate",
                      britshText: """IpaUK: /ˈfrɪɡət/""",
                      americanText: """IpaUS: /ˈfrɪɡət/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """The frigate was equipped with advanced radar.""",
                      kurdishText:
                          """کەشتی پارێزەرەکە ڕاداری پێشکەوتووی لەسەر دانرا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/s36hrId0rOo?t=';
const double _startSecondsend = 000000000000000000000000000462;
const String _videoIdone = 'https://youtu.be/8GOoBPLeS60?t=';
const double _startSecondsone = 000000000000000000000000000347;
const String _videoIdtwo = 'https://youtu.be/ko6qiSKXAGA?t=';
const double _startSecondstwo = 000000000000000000000000000315;
const String _videoIdthree = 'https://youtu.be/K12udO9LATI';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/hG0ROjzgEA0?t=';
const double _startSecondsfour = 00000000000000000000000000083;
const String _videoIdfive = 'https://youtu.be/nWY_s14z57w?t=';
const double _startSecondsfive = 000000000000000000000000000182;
