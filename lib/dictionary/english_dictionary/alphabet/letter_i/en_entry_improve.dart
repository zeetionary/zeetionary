...
class EnglishEntryimprove extends StatefulWidget {
  const EnglishEntryimprove({super.key});

  @override
  State<EnglishEntryimprove> createState() => _EnglishEntryimproveState();
}

class _EnglishEntryimproveState extends State<EnglishEntryimprove> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: improve (Derived forms: improves, improving, improved)
1. To make better (- better, amend, ameliorate, meliorate, mend)
"The editor improved the manuscript with his changes";
 
2. Get better (- better, ameliorate, meliorate)
"The weather improved toward evening";
""",
  );

  final String keyword = "improve";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""improve""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Overall the situation has improved dramatically.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Things are improving every day.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001184;
    const String videoIdone = 'https://youtu.be/-cPdImejxEQ?t=';
    const double startSecondsone = 00000000000000000000000000069;
    const String videoIdtwo = 'https://youtu.be/W8uXhQnWgj4?t=';
    const double startSecondstwo = 000000000000000000000000000382;
    const String videoIdthree = 'https://youtu.be/qYXw_qvtNQc?t=';
    const double startSecondsthree = 0000000000000000000000000005;
    const String videoIdfour = 'https://youtu.be/27iM-TNNRCg?t=';
    const double startSecondsfour = 00000000000000000000000000080;
    const String videoIdfive = 'https://youtu.be/OMYEN2dDTyY?t=';
    const double startSecondsfive = 0000000000000000000000000003921;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """improve""",
                      // alsoEnglishWord: "also: improve",
                      britshText: """IpaUK: improve""",
                      americanText: """IpaUS: improve""",
...
کوردی: 
"""),
// With short examples define "improve", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) باشتربوونل باشترکردن"""),
                    SentencesRow(
                      englishText:
                          """Overall the situation has improved dramatically.""",
                      kurdishText:
                          """بە شێوەیەکی گشتی دۆخەکە بە ئاستێکی زۆر بەرەوپێش چووە.""",
                    ...
                    SentencesRow(
                      englishText: """Things are improving every day.""",
                      kurdishText: """شتەکان هەموو ڕۆژێک باشتر دەبن.""",
