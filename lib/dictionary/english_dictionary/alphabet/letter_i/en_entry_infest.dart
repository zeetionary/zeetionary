...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'Q-nWA0WeF98';
    const double startSecondsend = 891;
    const String videoIdone = 's3YTfhJmh1I';
    const double startSecondsone = 472;
    const String videoIdtwo = 'mctn16hLzhg';
    const double startSecondstwo = 173;
    const String videoIdthree = 'r9cLluDKIhk';
    const double startSecondsthree = 9;
    const String videoIdfour = 'QLq6GEiHqR8';
    const double startSecondsfour = 978;
    const String videoIdfive = 'b8WnPAxVxRY';
    const double startSecondsfive = 1245;
