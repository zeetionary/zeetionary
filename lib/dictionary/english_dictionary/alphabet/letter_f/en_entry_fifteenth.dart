...
class EnglishEntryfifteenth extends StatefulWidget {
  const EnglishEntryfifteenth({super.key});

  @override
  State<EnglishEntryfifteenth> createState() => _EnglishEntryfifteenthState();
}

class _EnglishEntryfifteenthState extends State<EnglishEntryfifteenth> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "fifteenth";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fifteenth""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We go on the 9th of July and return on the fifteenth.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Today is the fifteenth of June.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fifteenth""",
                      // alsoEnglishWord: "also: fifteenth",
                      britshText: """IpaUK: /ˌfɪfˈtiːnθ/""",
                      americanText: """IpaUS: /ˌfɪfˈtiːnθ/""",
...
// With short examples define "fifteenth", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """We go on the 9th of July and return on the fifteenth.""",
                      kurdishText:
                          """لە نۆی تەمموز دەچین لە پازدە دەەگڕێینەوە.""",
                    ...
                    SentencesRow(
                      englishText: """Today is the fifteenth of June.""",
                      kurdishText: """ئەمڕۆ پازدەی حوزەیرانە.""",
...
const double _startSecondsend = 000000000000000000000000000711;
const String _videoIdone = 'https://youtu.be/s4Y3dlTDAxw?t=';
const double _startSecondsone = 000000000000000000000000000163;
const String _videoIdtwo = 'https://youtu.be/j4kI2h3iotA?t=';
const double _startSecondstwo = 0000000000000000000000000002060;
const String _videoIdthree = 'https://youtu.be/oCqkVZVPOe8?t=';
const double _startSecondsthree = 000000000000000000000000000282;
const String _videoIdfour = 'https://youtu.be/H6NUzanLUd4?t=';
const double _startSecondsfour = 000000000000000000000000000399;
const String _videoIdfive = 'https://youtu.be/91lt6T7wBjY?t=';
const double _startSecondsfive = 000000000000000000000000000138;
