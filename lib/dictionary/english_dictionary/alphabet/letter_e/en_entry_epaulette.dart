...
class EnglishEntryepaulette extends StatefulWidget {
  const EnglishEntryepaulette({super.key});

  @override
  State<EnglishEntryepaulette> createState() => _EnglishEntryepauletteState();
}

class _EnglishEntryepauletteState extends State<EnglishEntryepaulette> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""epaulette""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """epaulette""",
                      // alsoEnglishWord: "also: epaulette",
                      britshText: """IpaUK: /ˈepəlet/""",
                      americanText: """IpaUS: /ˈepəlet/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "epaulette";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Each soldier's epaulette displayed their rank.""");
  }
...
کوردی: زرێی شان، شانەوانە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) جوانکارییەک لەسەر شانی پاڵتۆیەک، چاکەتێک، هتد"""),
          SentencesRow(
            englishText: """Each soldier's epaulette displayed their rank.""",
            kurdishText: """شانەوانەی هەر سەربازێک پلەکەی پیشان دەدا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: epaulette (Derived forms: epaulettes)
1. Adornment consisting of an ornamental cloth pad worn on the shoulder (= epaulet [US])
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/AUf3C2-q4Y4?t=';
const double _startSecondsend = 000000000000000000000000000000; // 154;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/GwfDE03lnus?t=';
const double _startSecondsone = 00000000000000000000000000000; // 277;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/yYBT6G9fGMg?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 648;
const String _videoIdthree = 'VIDEOhttps://youtu.be/uaJfExPF9EA?t=';
const double _startSecondsthree = 000000000000000000000000000; // 722;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/nbeT2V57ZUA?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 172;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/gx0_7SkCXzQ?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 317;
