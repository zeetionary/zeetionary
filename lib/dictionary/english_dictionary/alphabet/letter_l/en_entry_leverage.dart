...
class EnglishEntryleverage extends StatefulWidget {
  const EnglishEntryleverage({super.key});

  @override
  State<EnglishEntryleverage> createState() => _EnglishEntryleverageState();
}

class _EnglishEntryleverageState extends State<EnglishEntryleverage> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: leverage (Derived forms: leverages)
1. The mechanical advantage gained by being in a position to use a lever (- purchase)
 
2. Strategic advantage; power to act effectively
"relatively small groups can sometimes exert immense political leverage"
 
3. Investing with borrowed money as a way to amplify potential gains (at the risk of greater losses) (- leveraging)

- Verb: leverage (Derived forms: leveraging, leverages, leveraged)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""leverage""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They are determined to gain more political leverage.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They suddenly had more leverage in negotiations.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Their actions were seen as an attempt to use economic leverage to force political change.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A longer piece of wood would give you greater leverage.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Position the piece of wood so that maximum leverage can be applied.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The company needs to leverage its resources.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This system will help you to leverage your time so that you get more done.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/HAnw168huqA?t=2882';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/Rzd0mLf366I?t=77';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/efauuIJt_sY?t=31';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/iCMGPRiDXQg?t=303';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/SwQhKFMxmDY?t=6077';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/lDeFSOUHdH4?t=601';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """leverage""",
                      // alsoEnglishWord: "also: leverage",
                      britshText: """IpaUK: /ˈliːvərɪdʒ/""",
                      americanText: """IpaUS: /ˈlevərɪdʒ/""",
...
کوردی: کار یان هێزی نوێڵ، بەکارهێنانی لۆسە،	سوود و کەڵکی میکانیکی نوێڵ،	(خوازە) هێز، دەسەڵات، دەس‌ڕۆیشتوویی، کاریگەری، باندۆر
"""),
// With short examples define "leverage", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) توانای ئەوەی کاریگەری دابنێیت لەسەر ئەوەی خەڵکی چی دەکەن"""),
                    SentencesRow(
                      englishText: """They are determined to gain more political leverage.""",
                      kurdishText: """سوورن لەسەر ئەوەی کەریگەریی  سیاسیی زیاتریان هەبێت.""",
                    ...
                    SentencesRow(
                      englishText: """They suddenly had more leverage in negotiations.""",
                      kurdishText: """لەناکاو کاریگەریی زیاتریان هەبوو لە دانووستانەکاندا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Their actions were seen as an attempt to use economic leverage to force political change.""",
                      kurdishText: """چالاکییەکانیان بینرا وەک هەوڵێک بۆ بەکارهێنانی کاریگەریی ئابووری بۆ سەپاندنی گۆڕانی سیاسی.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ئەوەی نوێڵێک بەکاربێنیت بۆ کردنەوەی شتێک؛ ئەو هێزەی نوێڵێک درووستی دەکات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """A longer piece of wood would give you greater leverage.""",
                      kurdishText: """پارچە دارێکی درێژتر هێزی زیاترت پێدەدات.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Position the piece of wood so that maximum leverage can be applied.""",
                      kurdishText: """پارچە دارەکە بەشێوەیەک دابنێ کە زۆرترین هێز بسەپێندرێت.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) بەدەستکەوتنی زۆرترین سوود و قازانج لە شتێک کە هەتە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The company needs to leverage its resources.""",
                      kurdishText: """کۆمپانیاکە دەبێت سەرچاوەکانی بدۆشێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """This system will help you to leverage your time so that you get more done.""",
                      kurdishText: """ئەم سیستەمە ڕێگات پێدەدات کە کاتت بەکاربێنیت بەشێوەیەک کە کاری زیاتر بکەیت.""",
