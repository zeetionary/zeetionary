...
class EnglishEntryenvy extends StatefulWidget {
  const EnglishEntryenvy({super.key});

  @override
  State<EnglishEntryenvy> createState() => _EnglishEntryenvyState();
}

class _EnglishEntryenvyState extends State<EnglishEntryenvy> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """envy""",
                      // alsoEnglishWord: "also: envy",
                      britshText: """IpaUK: /ˈenvi/""",
                      americanText: """IpaUS: /ˈenvi/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He couldn't conceal his envy of me.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her colleagues were green with envy.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She has always envied my success.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It's a difficult situation you're in. I don't envy you.""");
  }
...
کوردی: ئیرەیی، بەغیلی، ڕەشک، سوو، چاوپێ‌هەڵنەهاتوویی، لەچەری، مایەی بەغیلی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) هەستی ویستنی ئەوەی لە هەمان پێگەی کەسێکی دیکە بیت یان ئەوەت هەبێت کە هەیەتی"""),
          SentencesRow(
            englishText: """He couldn't conceal his envy of me.""",
            kurdishText: """نەیدەتوانی بەغیلی پێم بشارێتەوە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هاوپۆلەکانی تەواو بەغیل بووبوون.""",
            onPressedBritish: () => speaksentence2("en-GB"),
            onPressedAmerican: () => speaksentence2("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (کردار) بەغیلی بردن بە کەسێکی دیکە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """He envied her—she seemed to have everything she could possibly want.""",
            kurdishText:
                """بەغیلی پێ دەبرد ـ ئەو وادیاربوو کە هەر شتێکی هەبێت کە بیەوێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She has always envied my success.""",
            kurdishText: """هەمیشە بەغیلی بە سەرکەوتنم بردووە.""",
            onPressedBritish: () => speaksentence4("en-GB"),
            onPressedAmerican: () => speaksentence4("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٣. (کردار) دڵخۆش بوون بەوەی لە دۆخی کەسێکی دیکە نییت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """It's a difficult situation you're in. I don't envy you.""",
            kurdishText: """لە دۆخێکی خراپ دایت، بەغیلیت پێ نابەم.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I don't envy her that job.""",
            kurdishText: """ئاواتەخوازی ئەو کارە نیم.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: envy (Derived forms: envies, envied, envying)
1. Feel envious towards; admire enviously
 
2. Be envious of; set one's heart on (= begrudge)

- Noun: envy (Derived forms: envies)
1. A feeling of grudging admiration and desire to have something that is possessed by another (= enviousness)
 
2. Spite and resentment at seeing the success of another (personified as one of the deadly sins) (= invidia)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/FYVvE4tr2BI?t=';
const double _startSecondsend = 000000000000000000000000000000; // 17;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/1n2nPRxAOss?t=';
const double _startSecondsone = 00000000000000000000000000000; // 791;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/wJa5Ch0O4BI?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 4448;
const String _videoIdthree = 'VIDEOhttps://youtu.be/5hos7hv1Cn8?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1295;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/KDthN45L57Q?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 155;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/DEZdsisM8ZI?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 57;
