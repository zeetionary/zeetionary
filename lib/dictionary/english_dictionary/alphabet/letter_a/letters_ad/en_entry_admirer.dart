                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "admirer"), // Find /ədˈmaɪərə(r)/
                          ],
                        ),
                        Row(
                          children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ədˈmaɪərər/"),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'vS_k399L9Eg';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'vpYc7Juxu_s';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Kyyp5UmPeJE';
