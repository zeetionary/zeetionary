...
class EnglishEntrycablecar extends StatelessWidget {
// blank divider
  EnglishEntrycablecar({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcablecar(String languageCode) async {
    // DOPSUM: CHANGE speakcablecar
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "cable car"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈkeɪbl kɑː(r)/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcablecar("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈkeɪbl kɑːr/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcablecar("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'wGIEy-TQKhI';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 's_Jcq7DR4_I';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'IQzfprW0Yl0';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '5dqrOSk-Wyk';
  final double _startSeconds = 2877;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'gkaZ94cKxVc';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'G3eMyjyZ6Aw';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = '8oiGkB2-rMI';
