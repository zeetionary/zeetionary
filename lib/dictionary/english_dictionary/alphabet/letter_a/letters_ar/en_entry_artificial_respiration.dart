...
class EnglishEntryartificialrespiration extends StatelessWidget {
  ...
  Future<void> speakartificialrespiration(String languageCode) async {
    ...
    await flutterTts.speak("artificial respiration");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'Kz5njuWjtPk';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'ws-GcQ0ht1c';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'gZqIKBaBpQI';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'knz-Vyv4_Bw';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'OKEtoTKULyk';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'S27qQcHL62M';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'H6yEjSEgSWM';
