...
class EnglishEntryhelpfully extends StatefulWidget {
  const EnglishEntryhelpfully({super.key});

  @override
  State<EnglishEntryhelpfully> createState() => _EnglishEntryhelpfullyState();
}

class _EnglishEntryhelpfullyState extends State<EnglishEntryhelpfully> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: helpfully
1. In a helpful manner
"the subtitles are helpfully conveyed"
""",
  );

  final String keyword = "helpfully";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""helpfully""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The gadget helpfully points out what you are doing wrong.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She helpfully suggested that I try the local library.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """helpfully""",
                      // alsoEnglishWord: "also: helpfully",
                      britshText: """IpaUK: /ˈhelpfəli/""",
                      americanText: """IpaUS: /ˈhelpfəli/""",
...
کوردی: دڵسۆزانە، بەسوودانە، بەکارهاتووانە
"""),
// With short examples define "helpfully", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵکار) بە شێوەیەک کە کە دۆخێکی دیاریکراو باش دەکات و بەسوودە بۆی"""),
                    const AlsoEnglishckb(word: "ھەروەھا: usefully"),
                    SentencesRow(
                      englishText: """The gadget helpfully points out what you are doing wrong.""",
                      kurdishText: """ئامێرەکە بە شێوەیەکی بەسوود پیشانی دەدات کە چی بە هەڵە دەکەیت.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵکار) بە شێوەیەک کە پیشانی دەدات ئامادەیت بۆ یارمەتی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She helpfully suggested that I try the local library.""",
                      kurdishText: """بە یارمەتیدۆستانە پێشنیاری کرد لە بچمە کتێبخانە لۆکاڵییەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/eJ-WJssJgdg?t=';
const double _startSecondsend = 0000000000000000000000000002629;
const String _videoIdone = 'https://youtu.be/ZiXg6H_FycI?t=';
const double _startSecondsone = 00000000000000000000000000083;
const String _videoIdtwo = 'https://youtu.be/RMxB7zA-e4Y?t=';
const double _startSecondstwo = 000000000000000000000000000610;
const String _videoIdthree = 'https://youtu.be/va1rzP2xIx4?t=';
const double _startSecondsthree = 000000000000000000000000000529;
const String _videoIdfour = 'https://youtu.be/U0YW7x9U5TQ?t=';
const double _startSecondsfour = 000000000000000000000000000204;
const String _videoIdfive = 'https://youtu.be/eb2v8aZvyfQ?t=';
