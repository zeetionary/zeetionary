...
class EnglishEntryinsomniac extends StatefulWidget {
  const EnglishEntryinsomniac({super.key});

  @override
  State<EnglishEntryinsomniac> createState() => _EnglishEntryinsomniacState();
}

class _EnglishEntryinsomniacState extends State<EnglishEntryinsomniac> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insomniac""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'Jcp3BKtZC5w';
    const double startSecondsend = 34;
    const String videoIdone = '5j-R06GLvvU';
    const double startSecondsone = 673;
    const String videoIdtwo = 'TmNARZonhvY';
    const double startSecondstwo = 61;
    const String videoIdthree = '0j1YJ78oSaU';
    const double startSecondsthree = 80;
    const String videoIdfour = 'mFtItoFfUd8';
    const double startSecondsfour = 552;
    const String videoIdfive = 'tQDqlRQ7UJM';
