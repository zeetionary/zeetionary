...
class EnglishEntryharmony extends StatefulWidget {
  const EnglishEntryharmony({super.key});

  @override
  State<EnglishEntryharmony> createState() => _EnglishEntryharmonyState();
}

class _EnglishEntryharmonyState extends State<EnglishEntryharmony> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: harmony (Derived forms: harmonies)
1. Compatibility in opinion and action (- harmoniousness)
 
2. The structure of music with respect to the composition and progression of chords (- musical harmony)
 
3. A harmonious state of things in general and of their properties (as of colours and sounds); congruity of parts with one another and with the whole (- concord, concordance, symphony)
 
4. Agreement of opinions (- concord, concordance)
 
5. An agreeable sound property
""",
  );

  final String keyword = "harmony";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""harmony""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They lived together in perfect harmony.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The Church tries to promote racial harmony.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They began to sing in perfect four-part harmony.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harmony""",
                      // alsoEnglishWord: "also: harmony",
                      britshText: """IpaUK: /ˈhɑːməni/""",
                      americanText: """IpaUS: /ˈhɑːrməni/""",
...
کوردی: ڕێککەوتن، سازان، کۆک‌بوون، گونجان
"""),
// With short examples define "harmony", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی پێکەوەگونجان و پێکەوەهەبوون هەبێت"""),
                    SentencesRow(
                      englishText:
                          """They lived together in perfect harmony.""",
                      kurdishText:
                          """پێکەوە دەژیان لە پێکەوەگونجانی تەواودا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کڵێساکە هەواڵ دەدات پێکەوەگونجانی ڕەگەزی درووست بکات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) شێوازی ژەنینی نۆتە جیاوازەکانی میوزیک پێکەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """They began to sing in perfect four-part harmony.""",
                      kurdishText:
                          """دەستیان کرد بە گۆرانی گوتن بە هارمۆنی چوار بەشی بێ‌خەوش.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) پێکەوەبوونی جوانی شتانی پەیوەندیدار"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The designer’s aim is to produce a harmony of shape and texture.""",
                      kurdishText:
                          """ئامانجی دیزاینەرەکە ئەوەیە پێکەوەگونجانی شێوە و ڕەنگ درووست بکات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/9JVGx-hvY9I?t=';
const double _startSecondsend = 000000000000000000000000000349;
const String _videoIdone = 'https://youtu.be/c1C0hSJVX3Q?t=';
const double _startSecondsone = 0000000000000000000000000009;
const String _videoIdtwo = 'https://youtu.be/mwhROjklvcE?t=';
const double _startSecondstwo = 0000000000000000000000000002316;
const String _videoIdthree = 'https://youtu.be/fn--IVarumw?t=';
const double _startSecondsthree = 000000000000000000000000000496;
const String _videoIdfour = 'https://youtu.be/oiLdWXLXDeA?t=';
const double _startSecondsfour = 0000000000000000000000000001529;
