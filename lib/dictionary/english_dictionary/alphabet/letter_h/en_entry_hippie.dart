...
class EnglishEntryhippie extends StatefulWidget {
  const EnglishEntryhippie({super.key});

  @override
  State<EnglishEntryhippie> createState() => _EnglishEntryhippieState();
}

class _EnglishEntryhippieState extends State<EnglishEntryhippie> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hippie (Derived forms: hippies)
1. Someone who rejects the established culture; advocates extreme liberalism in politics and lifestyle (- hippy, hipster, flower child)
""",
  );

  final String keyword = "hippie";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A group of hippies gathered for the peace rally.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    // 188888880002200
    const String videoIdend = 'https://youtu.be/nc0R3HQ1axs?t=';
    const double startSecondsend = 00000000000000000000000000014;
    const String videoIdone = 'https://youtu.be/7QrRDUasQp8?t=';
    const double startSecondsone = 0000000000000000000000000009;
    const String videoIdtwo = 'https://youtu.be/-Je79iRtTTE?t=';
    const double startSecondstwo = 000000000000000000000000000592;
    const String videoIdthree = 'https://youtu.be/dzRNswfny3A?t=';
    const double startSecondsthree = 000000000000000000000000000389;
    const String videoIdfour = 'https://youtu.be/vImyXlST6g0?t=';
    const double startSecondsfour = 000000000000000000000000000764;
    const String videoIdfive = 'https://youtu.be/9vuqI2v2IRs?t=';
    const double startSecondsfive = 00000000000000000000000000099;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hippie""",
                      alsoEnglishWord: "also: hippy",
                      britshText: """IpaUK: /ˈhɪpi/""",
                      americanText: """IpaUS: /ˈhɪpi/""",
...
کوردی: 
"""),
                    const DefinitionKurdish(text: """١. (ناو) کەسێک، بە تایبەتی گەنجێک لە کۆتاییەکانی شەستەکان و سەرەتای حەفتاکان، کە باوەڕی بە ئاشتی هەبوو، دژی زۆرێک لەو باوەڕە پەسەندکراوەکانی کۆمەڵگا بوو لەسەر شێوازی ژیان، قژی درێژی هەبوو، و زۆرجار بە گروپ دەژیان و مادەی هۆشبەریان دەکێشا"""),
                    SentencesRow(
                      englishText: """A group of hippies gathered for the peace rally.""",
                      kurdishText: """گرووپێک لە هیپییەکان کۆبوونەوە بۆ ڕێپێوانە ئاشتییەکە.""",
