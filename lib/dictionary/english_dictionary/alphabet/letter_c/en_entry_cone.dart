...
// blank divider
  ...
  Future<void> speakcones2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcones200"); // DOPSUM: CHANGE TEXT
  }
...
"""),
                          const DefinitionKurdish(
                              text: "١. (ناو) شێوەیەک کە تەختە، خڕ، یان هێلکەیی هەیە و لایەلانی بەرەوە سەرەوە دەچن تاوەکو لە خاڵێک یەکدەگرن"),
                          Row(
                            children: [
                              const Expanded(
                                child: Column(
                                  children: [
                                    ...
                                    ExampleSentenceKurdish(
                                        text: "تیمی بیناسازییەکە مۆتەی هاتووچۆیان لە ڕێگاکەدا دانا بۆ گۆڕینی ئاراستەی هاتووچۆ."),
                                  ],
                                ),
                              ),
