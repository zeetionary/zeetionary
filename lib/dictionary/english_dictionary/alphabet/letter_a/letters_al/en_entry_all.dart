...
class EnglishEntryall extends StatelessWidget {
  ...
  Future<void> speakAll3582(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("FROM_YOUTUBE_BELOW"); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "all", // DOPSUM: CHANGE WORD ENTRY - Find //ɔːl/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAll(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
