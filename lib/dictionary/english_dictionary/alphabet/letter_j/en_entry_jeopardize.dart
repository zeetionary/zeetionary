...
class EnglishEntryjeopardize extends StatefulWidget {
  const EnglishEntryjeopardize({super.key});

  @override
  State<EnglishEntryjeopardize> createState() => _EnglishEntryjeopardizeState();
}

class _EnglishEntryjeopardizeState extends State<EnglishEntryjeopardize> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: jeopardize (Derived forms: jeopardizing, jeopardized, jeopardizes)
1. Pose a threat to; present a danger to (- endanger, jeopardise [Brit], menace, threaten, imperil, peril)
"The pollution is jeopardizing the crops";
 
2. Put at risk (- venture, hazard, adventure, stake, jeopardise [Brit])
"I will jeopardize my good reputation for this";
""",
  );

  final String keyword = "jeopardize";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""jeopardize""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He would never do anything to jeopardize his career.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/wQ-3fUJlNuc?t=1136';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/saLcKOmPVlg?t=186';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/vsMydMDi3rI?t=1591';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/wizgxRBfVTY?t=126';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/iuQA7P_gtw8?t=315';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/QhlrndJ1Hz8?t=1857';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """jeopardize""",
                      // alsoEnglishWord: "also: jeopardize",
                      britshText: """IpaUK: /ˈdʒepədaɪz/""",
                      americanText: """IpaUS: /ˈdʒepərdaɪz/""",
...
// With short examples define "jeopardize", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەرگیز هیچ ناکات کارەکەی بخاتە مەترسییەوە.""",
