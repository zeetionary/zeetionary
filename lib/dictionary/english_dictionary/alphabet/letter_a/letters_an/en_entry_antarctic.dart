                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "Antarctic"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ænˈtɑːktɪk/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ænˈtɑːrktɪk/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'WHdzMX8smps';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'yTaVvSe03TQ';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'VjTXa7K1N_w';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'SzL8D1AtyQs';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'EvRAuy1ZmTc';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '5UqjS1RGRzo';
