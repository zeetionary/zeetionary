...
class EnglishEntryinadmissible extends StatefulWidget {
  const EnglishEntryinadmissible({super.key});

  @override
  State<EnglishEntryinadmissible> createState() => _EnglishEntryinadmissibleState();
}

class _EnglishEntryinadmissibleState extends State<EnglishEntryinadmissible> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inadmissible""");
  }
