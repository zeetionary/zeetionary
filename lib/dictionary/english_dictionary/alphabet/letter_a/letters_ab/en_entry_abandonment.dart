...
class EnglishEntryabandonment extends StatefulWidget {
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "abandonment");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: abandonment");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /əˈbændənmənt/");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomIconButtonBritish(
      onPressed: () => speakabandonment("en-GB"),
    );
  }
}
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /əˈbændənmənt/");
  }
}
...
class TTSUS extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomIconButtonAmerican(
      onPressed: () => speakabandonment("en-US"),
    );
  }
}
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'k8OtECwWN6c';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '1xHEFn87oOA';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'rT5PN7IhyPc';
