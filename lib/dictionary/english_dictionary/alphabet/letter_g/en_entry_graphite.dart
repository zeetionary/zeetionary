...
class EnglishEntrygraphite extends StatefulWidget {
  const EnglishEntrygraphite({super.key});

  @override
  State<EnglishEntrygraphite> createState() => _EnglishEntrygraphiteState();
}

class _EnglishEntrygraphiteState extends State<EnglishEntrygraphite> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: graphite (Derived forms: graphites)
1. Used as a lubricant and as a moderator in nuclear reactors (- black lead, plumbago)
"graphite and diamond are allotropes of carbon";
""",
  );

  final String keyword = "graphite";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""graphite""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The core of a pencil is made of graphite.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """graphite""",
                      // alsoEnglishWord: "also: graphite",
                      britshText: """IpaUK: /ˈɡræfaɪt/""",
                      americanText: """IpaUS: /ˈɡræfaɪt/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مادەیەکی نائەندامی نەرمی ڕەش کە لە درووستکردنی پێنووس، چەورکردنی ئامێر، و وێستگە ئەتۆمییەکان بەکاردێت"""),
                    SentencesRow(
                      englishText:
                          """The core of a pencil is made of graphite.""",
                      kurdishText: """ناوەخنی پێنووس لە گرافیت درووستکراوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/gdgL4Rp0lz0?t=';
const double _startSecondsend = 000000000000000000000000000582;
const String _videoIdone = 'https://youtu.be/J3mn7nbQYsw?t=';
const double _startSecondsone = 000000000000000000000000000385;
const String _videoIdtwo = 'https://youtu.be/wyY5YEJ_CsE?t=';
const double _startSecondstwo = 000000000000000000000000000112;
const String _videoIdthree = 'https://youtu.be/AL6xp4fLdFw?t=';
const double _startSecondsthree = 00000000000000000000000000070;
const String _videoIdfour = 'https://youtu.be/uAdx3z38_Og';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/TszHd9yl364?t=';
