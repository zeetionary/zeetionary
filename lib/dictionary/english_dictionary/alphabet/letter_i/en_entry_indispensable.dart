...
class EnglishEntryindispensable extends StatefulWidget {
  const EnglishEntryindispensable({super.key});

  @override
  State<EnglishEntryindispensable> createState() =>
      _EnglishEntryindispensableState();
}

class _EnglishEntryindispensableState extends State<EnglishEntryindispensable> {
  @override
  void initState() {
    super.initState();
...
2. Absolutely necessary; vitally necessary (- essential)
...
""",
  ...
  final String keyword = "indispensable";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indispensable""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Cars have become an indispensable part of our lives.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She made herself indispensable to the department.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/ZvPzY6MsmCs?t=';
    const double startSecondsend = 000000000000000000000000000273;
    const String videoIdone = 'https://youtu.be/AdZ9kGwqkTM?t=';
    const double startSecondsone = 000000000000000000000000000406;
    const String videoIdtwo = 'https://youtu.be/m_uDrH9a1ng?t=';
    const double startSecondstwo = 000000000000000000000000000153;
    const String videoIdthree = 'https://youtu.be/EMOttGz1PLc?t=';
    const double startSecondsthree = 000000000000000000000000000161;
    const String videoIdfour = 'https://youtu.be/i3sP2jwG9jc?t=';
    const double startSecondsfour = 000000000000000000000000000422;
    const String videoIdfive = 'https://youtu.be/Uh4QGey2zTk?t=';
    const double startSecondsfive = 000000000000000000000000000546;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indispensable""",
                      // alsoEnglishWord: "also: indispensable",
                      britshText: """IpaUK: /ˌɪndɪˈspensəbl/""",
                      americanText: """IpaUS: /ˌɪndɪˈspensəbl/""",
...
کوردی: پێویست، پێوەژیاو، بێ‌هەڵنەکردوو، زۆرگرنگ
"""),
// With short examples define "indispensable", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە شتێک زۆر گرنگ بێت تا دەستبەرداری بیت"""),
                    SentencesRow(
                      englishText:
                          """Cars have become an indispensable part of our lives.""",
                      kurdishText:
                          """ئۆتۆمبێل بووە بە بەشێکی جیانەکراوەی ژیانمان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """خۆی کرد بە بەشێکی سەرەکی بەشەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """A good dictionary is indispensable for learning a foreign language.""",
                      kurdishText:
                          """فەرهەنگێکی باش زۆر پێویستە بۆ فێربوونی زمانێکی بیانی.""",
