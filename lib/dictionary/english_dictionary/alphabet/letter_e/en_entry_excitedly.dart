...
class EnglishEntryexcitedly extends StatefulWidget {
  const EnglishEntryexcitedly({super.key});

  @override
  State<EnglishEntryexcitedly> createState() => _EnglishEntryexcitedlyState();
}

class _EnglishEntryexcitedlyState extends State<EnglishEntryexcitedly> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""excitedly""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """excitedly""",
                      // alsoEnglishWord: "also: excitedly",
                      britshText: """IpaUK: /ɪkˈsaɪtɪdli/""",
                      americanText: """IpaUS: /ɪkˈsaɪtɪdli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "excitedly";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She waved excitedly as the car approached.""");
  }
...
// With short examples define "excitedly", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: ورووژاوانە، بە خرۆشانەوە
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵکار) بەشێوەیەکی دڵخۆش و تامەزرۆییانە"""),
          SentencesRow(
            englishText: """She waved excitedly as the car approached.""",
            kurdishText:
                """تامەزرۆییانە سڵاوی کرد کە ئۆتۆمبێلەکە نزیکبوویەوە.""",
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/G2wPCbazMjQ?t=';
const double _startSecondsend = 000000000000000000000000000000; // 271;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/KnS0Q06E17w?t=';
const double _startSecondsone = 00000000000000000000000000000; // 446;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/J-piNPoWoYc?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 2061;
const String _videoIdthree = 'VIDEOhttps://youtu.be/brofphmC7GI?t=';
const double _startSecondsthree = 000000000000000000000000000; // 323;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/_RfHNxiXffA?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 693;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/-Mkp4oavz2M?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 321;
