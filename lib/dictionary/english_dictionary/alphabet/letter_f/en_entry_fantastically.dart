...
class EnglishEntryfantastically extends StatefulWidget {
  const EnglishEntryfantastically({super.key});

  @override
  State<EnglishEntryfantastically> createState() =>
      _EnglishEntryfantasticallyState();
}

class _EnglishEntryfantasticallyState extends State<EnglishEntryfantastically> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fantastically""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fantastically""",
                      // alsoEnglishWord: "also: fantastically",
                      britshText: """IpaUK: /fænˈtæstɪkli/""",
                      americanText: """IpaUS: /fænˈtæstɪkli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "fantastically";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""You did fantastically.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They're fantastically rich.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They're doing fantastically well.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was a fantastically shaped piece of stone.""");
  }
...
// With short examples define "fantastically", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          ...
          SentencesRow(
            englishText: """You did fantastically.""",
            kurdishText: """ناوازە کارت کرد.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """They're doing fantastically well.""",
            kurdishText: """ئێجگار باش بەڕێوە دەچن.""",
...
1. Exceedingly; extremely (= fabulously, incredibly, breathtakingly)
"she plays fantastically well";
""",
  );
...
const double _startSecondsend = 0000000000000000000000000002060;
const String _videoIdone = 'https://youtu.be/zFleLL5zlaI?t=';
const double _startSecondsone = 000000000000000000000000000803;
const String _videoIdtwo = 'https://youtu.be/NhCod-SUuAc?t=';
const double _startSecondstwo = 000000000000000000000000000906;
const String _videoIdthree = 'https://youtu.be/3IQbPHtMrKw?t=';
const double _startSecondsthree = 00000000000000000000000000020;
const String _videoIdfour = 'https://youtu.be/zXgD-KSb5ZM?t=';
const double _startSecondsfour = 000000000000000000000000000100;
const String _videoIdfive = 'https://youtu.be/gsMIT25iPXk?t=';
const double _startSecondsfive = 0000000000000000000000000001496;
