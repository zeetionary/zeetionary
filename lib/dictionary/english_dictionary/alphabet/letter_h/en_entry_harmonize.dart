...
class EnglishEntryharmonize extends StatefulWidget {
  const EnglishEntryharmonize({super.key});

  @override
  State<EnglishEntryharmonize> createState() => _EnglishEntryharmonizeState();
}

class _EnglishEntryharmonizeState extends State<EnglishEntryharmonize> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: harmonize (Derived forms: harmonized, harmonizes, harmonizing)
1. Go well together (- harmonise [Brit], consort, accord, concord, fit in, agree)
"The colours don't harmonize";
 
2. (music) write a harmony for (- harmonise [Brit])
 
3. (music) sing or play in harmony (- harmonise [Brit])
 
4. Bring (several things) into consonance or relate harmoniously (- harmonise [Brit])
"harmonize the different interests";
 
5. Bring into consonance or accord (- harmonise [Brit], reconcile)
"harmonize one's goals with one's abilities";
 
6. (music) bring into consonance, harmony, or accord while making music or singing (- harmonise [Brit], chord)
""",
  );

  final String keyword = "harmonize";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""harmonize""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The singers harmonize well.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harmonize""",
                      // alsoEnglishWord: "also: harmonize",
                      britshText: """IpaUK: /ˈhɑːmənaɪz/""",
                      americanText: """IpaUS: /ˈhɑːrmənaɪz/""",
...
// کوردی:
// """),
// With short examples define "harmonize", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) کە دوو شت پێکەوە دەگونجێن و ئەنجامێکی باش درووست دەکەن"""),
                    SentencesRow(
                      englishText:
                          """The new building does not harmonize with its surroundings.""",
                      kurdishText: """بینا تازەکە لەگەڵ دەورووبەری ناگونجێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) ئەوەی سیستەم و یاساکانی وڵات و دامەزراوەی جیاواز وەک یەکدی بن"""),
                    SentencesRow(
                      englishText:
                          """The plan is to harmonize (= make similar) safety standards across all the countries involved.""",
                      kurdishText:
                          """پلانیان هەیە ستانداردەکانی سەلامەتی وەک یەک لێ بکەن لەو وڵاتانەی بەژدارن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) ژەنینی میوزیکێک کە لەگەڵ میوزیکی سەرەکی دەگونجێت"""),
                    SentencesRow(
                      englishText: """The singers harmonize well.""",
                      kurdishText: """گۆرانیبێژەکان باش پێکەوە دەگونجێن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/DSQG0zvR6dk?t=';
const double _startSecondsend = 0000000000000000000000000001137;
const String _videoIdone = 'https://youtu.be/hyXCWYqpId4?t=';
const double _startSecondsone = 00000000000000000000000000070;
const String _videoIdtwo = 'https://youtu.be/fYVouIyOXC0?t=';
const double _startSecondstwo = 000000000000000000000000000413;
const String _videoIdthree = 'https://youtu.be/vT-zZsjwZKk?t=';
...
const double _startSecondsfive = 00000000000000000000000000021187;
