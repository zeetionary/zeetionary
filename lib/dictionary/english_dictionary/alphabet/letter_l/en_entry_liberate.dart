...
class EnglishEntryliberate extends StatefulWidget {
  const EnglishEntryliberate({super.key});

  @override
  State<EnglishEntryliberate> createState() => _EnglishEntryliberateState();
}

class _EnglishEntryliberateState extends State<EnglishEntryliberate> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""liberate""");
  }
