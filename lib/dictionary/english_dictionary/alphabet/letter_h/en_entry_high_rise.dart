...
class EnglishEntryhighrise extends StatefulWidget {
  const EnglishEntryhighrise({super.key});

  @override
  State<EnglishEntryhighrise> createState() => _EnglishEntryhighriseState();
}

class _EnglishEntryhighriseState extends State<EnglishEntryhighrise> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "high-rise";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""high-rise""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She lives in a high-rise overlooking the river.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""These high-rise building were built in the 1960s.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """high-rise""",
                      // alsoEnglishWord: "also: high-rise",
                      britshText: """IpaUK: /ˈhaɪ raɪz/""",
                      americanText: """IpaUS: /ˈhaɪ raɪz/""",
...
کوردی: 
"""),
// With short examples define "high-rise", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بینایەکی زۆر بەرز کە نهۆمی زۆری هەیە"""),
                    SentencesRow(
                      englishText:
                          """She lives in a high-rise overlooking the river.""",
                      kurdishText:
                          """لە بینایەکی بەرز دەژی کە بەسەر ڕووبارەکە دەڕوانێت.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) بینایەک کە بەرزە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """These high-rise building were built in the 1960s.""",
                      kurdishText:
                          """بینا بەرزەکە لە ساڵانی ١٩٦٠ ــەکان درووستکران.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/eNChF-u-BQg?t=';
const double _startSecondsend = 000000000000000000000000000368;
const String _videoIdone = 'https://youtu.be/Zr2bmYV6I-4?t=';
const double _startSecondsone = 000000000000000000000000000608;
const String _videoIdtwo = 'https://youtu.be/aiOHBfr-yjY?t=';
const double _startSecondstwo = 000000000000000000000000000368;
const String _videoIdthree = 'https://youtu.be/JGVBv7svKLo?t=';
const double _startSecondsthree = 00000000000000000000000000082;
const String _videoIdfour = 'https://youtu.be/mzZTLT8WpcQ?t=';
const double _startSecondsfour = 000000000000000000000000000397;
const String _videoIdfive = 'https://youtu.be/4eE8d94qGPo?t=';
