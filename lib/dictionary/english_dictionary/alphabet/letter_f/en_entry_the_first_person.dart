...
class EnglishEntrythefirstperson extends StatefulWidget {
  const EnglishEntrythefirstperson({super.key});

  @override
  State<EnglishEntrythefirstperson> createState() =>
      _EnglishEntrythefirstpersonState();
}

class _EnglishEntrythefirstpersonState
    extends State<EnglishEntrythefirstperson> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""the first person""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""‘I’, ‘me’, ‘we’ and ‘us’ are first-person pronouns.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The novel is written in the first person.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: the first person",
                      britshText: """IpaUK: /ðə ˌfɜːst ˈpɜːsn/""",
                      americanText: """IpaUS: /ðə ˌfɜːrst ˈpɜːrsn/""",
...
// With short examples define "the first person", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """'I', 'me', 'we' و 'us' جێناوی کەسی یەکەمن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """‘I am’ is the first person singular of the present tense of the verb ‘to be’.""",
                      kurdishText:
                          """'I am' کەسی یەکەمی تاکی دەمی ڕانەبردووی کاری 'to be' ـیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕۆمانەکە لە کەسی یەکەمەوە نووسراوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/3AiDa3ZD20Y?t=';
const double _startSecondsend = 000000000000000000000000000243;
const String _videoIdone = 'https://youtu.be/StcSHmBZj2k?t=';
const double _startSecondsone = 0000000000000000000000000002188;
const String _videoIdtwo = 'https://youtu.be/upb7kwWrdt8?t=';
const double _startSecondstwo = 000000000000000000000000000716;
const String _videoIdthree = 'https://youtu.be/Kh22m1QG6i4?t=';
const double _startSecondsthree = 000000000000000000000000000502;
const String _videoIdfour = 'https://youtu.be/5hWO_T_Y6F4?t=';
const double _startSecondsfour = 00000000000000000000000000056;
const String _videoIdfive = 'https://youtu.be/O0MvwWJqDfg?t=';
const double _startSecondsfive = 00000000000000000000000000064;
