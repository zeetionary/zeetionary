...
class EnglishEntryfresco extends StatefulWidget {
  const EnglishEntryfresco({super.key});

  @override
  State<EnglishEntryfresco> createState() => _EnglishEntryfrescoState();
}

class _EnglishEntryfrescoState extends State<EnglishEntryfresco> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fresco (Derived forms: frescoes)
1. A mural done with watercolours on wet plaster
 
2. A durable method of painting on a wall by using watercolours on wet plaster

- Verb: fresco (Derived forms: frescoing, frescos, frescoed, frescoes)
1. (art) paint onto wet plaster on a wall
""",
  );

  final String keyword = "fresco";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Michelangelo's famous frescoes are in the Sistine Chapel.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fresco""",
                      // alsoEnglishWord: "also: fresco",
                      britshText: """IpaUK: /ˈfreskəʊ/""",
                      americanText: """IpaUS: /ˈfreskəʊ/""",
...
// With short examples define "fresco", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) وێنەیەک کە لەسەر دیوارێک دەکێشرێت لە کاتێکدا هێشتا پلاستەری سەر دیوارەکە تەڕە"""),
                    SentencesRow(
                      englishText:
                          """Michelangelo's famous frescoes are in the Sistine Chapel.""",
                      kurdishText:
                          """وێنە بەناوبانگەکانی مایکڵ ئەنجلۆ لە سیستاین چاپێڵن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/fbVRnlR_6BM?t=';
...
const String _videoIdtwo = 'https://youtu.be/PXT_DPZLt5c?t=';
const double _startSecondstwo = 0000000000000000000000000001185;
const String _videoIdthree = 'https://youtu.be/C8U23AS1irY?t=';
const double _startSecondsthree = 000000000000000000000000000167;
const String _videoIdfour = 'https://youtu.be/JCHttVEG_Lk?t=';
const double _startSecondsfour = 000000000000000000000000000422;
const String _videoIdfive = 'https://youtu.be/2ECoTEcPv4U?t=';
