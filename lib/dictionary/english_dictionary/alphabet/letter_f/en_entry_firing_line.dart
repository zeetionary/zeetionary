...
class EnglishEntryfiringline extends StatefulWidget {
  const EnglishEntryfiringline({super.key});

  @override
  State<EnglishEntryfiringline> createState() => _EnglishEntryfiringlineState();
}

class _EnglishEntryfiringlineState extends State<EnglishEntryfiringline> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: firing line (Derived forms: firing lines)
...
""",
  ...
  final String keyword = "firing line";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""firing line""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """There were extensive attempts to prevent civilians from being in the firing line.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """firing line""",
                      // alsoEnglishWord: "also: firing line",
                      britshText: """IpaUK: /ˈfaɪərɪŋ laɪn/""",
                      americanText: """IpaUS: /ˈfaɪərɪŋ laɪn/""",
...
// With short examples define "firing line", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """There were extensive attempts to prevent civilians from being in the firing line.""",
                      kurdishText:
                          """هەوڵی زۆر هەبوو بۆ ڕێگری لەوەی هاوڵاتیی مەدەنی لە بەرەکانی پێشەوە بن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The firm is the first in the firing line over corporate abuses.""",
                      kurdishText:
                          """کۆمپانیاکە یەکەمینە پێشەنگە سەبارەت بە پێشێلکارییەکانی کۆمپانیاکان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/wnai3EoYZJ8?t=';
const double _startSecondsend = 00000000000000000000000000056;
const String _videoIdone = 'https://youtu.be/V0Xx0E8cs7U?t=';
const double _startSecondsone = 000000000000000000000000000824;
const String _videoIdtwo = 'https://youtu.be/Ca6h52PhbY8?t=';
const double _startSecondstwo = 0000000000000000000000000001358;
const String _videoIdthree = 'https://youtu.be/4009RK8Y7Go?t=';
const double _startSecondsthree = 000000000000000000000000000222;
const String _videoIdfour = 'https://youtu.be/tQp3nVTgjXM?t=';
const double _startSecondsfour = 000000000000000000000000000565;
const String _videoIdfive = 'https://youtu.be/eJrWEmijmc4?t=';
const double _startSecondsfive = 0000000000000000000000000001760;
