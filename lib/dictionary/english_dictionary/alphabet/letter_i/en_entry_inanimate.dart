...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'j9h2-ZVDLB8';
    const double startSecondsend = 67;
    const String videoIdone = 'okeeKqcmQkw';
    const double startSecondsone = 642;
    const String videoIdtwo = 'DaY89TPgjak';
    const double startSecondstwo = 135;
    const String videoIdthree = 'cWrsRwNAMpc';
    const double startSecondsthree = 384;
    const String videoIdfour = 'vXIAB_1FEC0';
    const double startSecondsfour = 602;
    const String videoIdfive = 'T-vxRbm-YoI';
    const double startSecondsfive = 235;
