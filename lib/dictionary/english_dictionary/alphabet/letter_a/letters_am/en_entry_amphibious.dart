                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "amphibious"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /æmˈfɪbiəs/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /æmˈfɪbiəs/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '3lM9jJR4dPo';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '8ekMrwNur9Y';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'dWtmCKZAFhQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'jUejvrbRJmk';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'KPICvVm5QOA';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 's6Xy4INpS_w';
  final double _startSeconds = 1;
