                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "aquarium"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈkweəriəm/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈkweriəm/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakaquarium922("en-US"),
                          ),
...
٢. (ناو) شوێنێک کە تێیدا ژمارەیەک پارچە گڵاسی گەورە ھەیە کە ماسی و گیانلەبەری دیکەی ئاوییان تێدان و خەڵکی سەردانی دەکەن"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakaquarium926("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'zMjmWainsA0';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '6EGOQHrZ6Kw';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'O-Aad-n-bIU';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'D235f-7xrCA';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'OO4Qb5PAM4Q';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'R0-5WU3k6jg';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'G7GKeDki7a0';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'DlNQmsiDIWU';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'nXDe9QF-Gu8';
