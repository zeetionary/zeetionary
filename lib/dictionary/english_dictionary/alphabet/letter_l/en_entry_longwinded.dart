...
class EnglishEntrylongwinded extends StatefulWidget {
  const EnglishEntrylongwinded({super.key});

  @override
  State<EnglishEntrylongwinded> createState() => _EnglishEntrylongwindedState();
}

class _EnglishEntrylongwindedState extends State<EnglishEntrylongwinded> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""long-winded""");
  }
