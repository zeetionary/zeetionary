...
class EnglishEntryerotic extends StatefulWidget {
  const EnglishEntryerotic({super.key});

  @override
  State<EnglishEntryerotic> createState() => _EnglishEntryeroticState();
}

class _EnglishEntryeroticState extends State<EnglishEntryerotic> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """erotic""",
                      // alsoEnglishWord: "also: erotic",
                      britshText: """IpaUK: /ɪˈrɒtɪk/""",
                      americanText: """IpaUS: /ɪˈrɑːtɪk/""",
...
کوردی: ئاڵۆش‌هێنەر، بزوێنەر، هەوەساوی، ئاڵۆشاوی، شەهوانی، بزوێنەری ئارەزووی سێکسی، سێکسی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە حەز و خۆشی سێکسی لەخۆدەگرێت یان پیشانی دەدات"""),
          SentencesRow(
            englishText:
                """There were some overtly erotic scenes in the film.""",
            kurdishText: """ژمارەیەک دیمەنی زۆر ورووژێنەر لە فیلمەکە بوون.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: erotic
1. Giving sexual pleasure; sexually arousing (= titillating)

- Noun: erotic (Derived forms: erotics)
1. An erotic person
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/Uhh_An7FGek?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1095;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/8PJGIEz5YJ4?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1807;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/y9nBhv0lq1s?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 970;
const String _videoIdthree = 'VIDEOhttps://youtu.be/tKZ2ILu_EMc?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1113;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/eqX38J9ya1I?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 478;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/MLIehuS4xyw?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 507;
