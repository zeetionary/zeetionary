...
// blank divider
  ...
  Future<void> speakblueprints2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The government does not have a blueprint for reform.");
  }
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakblueprints1("en-GB"),
                            onPressedAmerican: () => speakblueprints1("en-US"),
                          ),
                          const DividerDefinition(),
                          const DefinitionKurdish(
                              text:
                          ...
                          SentencesRow(
                            ...
                            kurdishText: "حکومەت نەخشە ڕێگای بۆ چاکسازی نییە.",
                            onPressedBritish: () => speakblueprints2("en-GB"),
                            onPressedAmerican: () => speakblueprints2("en-US"),
                          ),
                        ],
                      ),
                    ),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final double _startSeconds = 2303;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '_OCFXfFwHX8';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'fq0YkhXKIKw';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'oLnLqiYfi0s';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'UGgFkyZaClQ';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'F07RNxIAm9Q';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'sxl_qOQELFY';
