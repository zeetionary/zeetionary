...
class EnglishEntryequipment extends StatefulWidget {
  const EnglishEntryequipment({super.key});

  @override
  State<EnglishEntryequipment> createState() => _EnglishEntryequipmentState();
}

class _EnglishEntryequipmentState extends State<EnglishEntryequipment> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""equipment""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equipment""",
                      // alsoEnglishWord: "also: equipment",
                      britshText: """IpaUK: /ɪˈkwɪpmənt/""",
                      americanText: """IpaUS: /ɪˈkwɪpmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "equipment";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Take care when using old electrical equipment.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""No special equipment is needed.""");
  }
...
کوردی: کەل‌وپەل، سازوتفاق، شت‌ومەک، سامان، ئەسپاپ، ڕەخت، تێشواک، کەرەسە، دەزگا،	تەیارکردن، سازکردن، ئامادەکردن، ڕەخت‌کردن
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ئەو شتانەی کە پێویستن بۆ مەبەستێک یان چالاکییەکی دیاریکراو"""),
          SentencesRow(
            englishText: """Take care when using old electrical equipment.""",
            kurdishText:
                """ئاگادار بە کە کەلوپەلی کارەبایی کۆن بەکاردەهێنیت.""",
          ...
          SentencesRow(
            englishText:
                """Everyone should bring the necessary equipment for camping in the mountains.""",
            kurdishText:
                """هەموو کەس کەل‌وپەلی پێویست بهێنێت بۆ کەمپ‌هەڵدان لە چیاکان.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """No special equipment is needed.""",
            kurdishText: """هیچ کەل‌وپەلێکی تایبەتی پێویست نییە.""",
          ...
          SentencesRow(
            englishText:
                """That particular piece of equipment was unavailable at the time.""",
            kurdishText:
                """ئەو پارچە کەل‌وپەلە دیاریکراوە بەردەست نەبوو لەو کاتەدا.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) پڕۆسەی دابینکردنی شتی پێویست بۆ کەسێک یان شوێنێک"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The equipment of the photographic studio was expensive.""",
            kurdishText: """دابنکردنی کەل‌وپەلی ستودیۆی وێنەگری گرانە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: equipment (Derived forms: equipments)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/4zAkoXyhrdI?t=';
const double _startSecondsend = 000000000000000000000000000000; // 470;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/gFuEoxh5hd4?t=';
const double _startSecondsone = 00000000000000000000000000000; // 328;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/e0s_0vfDXrI';
const double _startSecondstwo = 00000000000000000000000000000; // 0;
const String _videoIdthree = 'VIDEOhttps://youtu.be/m9nM4Ekdfc8?t=';
const double _startSecondsthree = 000000000000000000000000000; // 68;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/zqllxbPWKNI?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 440;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/oD9BaNAH-eE?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 297;
