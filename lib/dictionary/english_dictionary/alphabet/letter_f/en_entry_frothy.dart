...
class EnglishEntryfrothy extends StatefulWidget {
  const EnglishEntryfrothy({super.key});

  @override
  State<EnglishEntryfrothy> createState() => _EnglishEntryfrothyState();
}

class _EnglishEntryfrothyState extends State<EnglishEntryfrothy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: frothy (Derived forms: frothiest, frothier)
1. Emitting or filled with bubbles as from carbonation or fermentation (- bubbling, bubbly, foaming, foamy, effervescing, spumy)
"foamy (or frothy) beer";
 
2. Marked by high spirits or excitement (- bubbling, effervescent, scintillating, sparkly)
"his fertile frothy mind";
""",
  );

  final String keyword = "frothy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Add the eggs and beat until frothy.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her first novel was a frothy romantic comedy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frothy""",
                      // alsoEnglishWord: "also: frothy",
                      britshText: """IpaUK: /ˈfrɒθi/""",
                      americanText: """IpaUS: /ˈfrɔːθi/""",
...
کوردی: کەفاوی، کەف‌پۆش، کەف‌کردوو، لەکەفەوەدراو،	سووک، هیچ، بێ‌بایەخ، فشە، ئایەخ، بێ‌واتا
"""),
// With short examples define "frothy", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) شلەیەک کە کەفی کردووە"""),
                    SentencesRow(
                      englishText: """Add the eggs and beat until frothy.""",
                      kurdishText:
                          """هێلکەکان زیاد بکە و تێکی بدە تاوەکو کەف دەکات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە بەهای نییە بەڵام چێژبەخش دیارن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Her first novel was a frothy romantic comedy.""",
                      kurdishText:
                          """یەکەم ڕۆمانی کۆمیدییەکی ڕۆمانسی چێژبەخش بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/6NOtF4l9i9g?t=';
const double _startSecondsend = 000000000000000000000000000148;
const String _videoIdone = 'https://youtu.be/qS250xspGmI?t=';
const double _startSecondsone = 000000000000000000000000000516;
const String _videoIdtwo = 'https://youtu.be/LXDAu8DnALw?t=';
const double _startSecondstwo = 000000000000000000000000000349;
const String _videoIdthree = 'https://youtu.be/B5ytcg5pYEA?t=';
const double _startSecondsthree = 000000000000000000000000000849;
const String _videoIdfour = 'https://youtu.be/8q8LsYbDCmM?t=';
const double _startSecondsfour = 000000000000000000000000000114;
const String _videoIdfive = 'https://youtu.be/tfn-LC254Hk?t=';
const double _startSecondsfive = 00000000000000000000000000038;
