...
class EnglishEntryfireguard extends StatefulWidget {
  const EnglishEntryfireguard({super.key});

  @override
  State<EnglishEntryfireguard> createState() => _EnglishEntryfireguardState();
}

class _EnglishEntryfireguardState extends State<EnglishEntryfireguard> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fireguard (Derived forms: fireguards)
1. A narrow field that has been cleared to check the spread of a prairie fire or forest fire (= firebreak)
 
2. A metal screen before an open fire for protection (especially against flying sparks) (= fire screen)
""",
  );

  final String keyword = "fireguard";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fireguard""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She bought a decorative fireguard for her living room.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fireguard""",
                      alsoEnglishWord: "also: fire screen",
                      britshText: """IpaUK: /ˈfaɪəɡɑːd/""",
                      americanText: """IpaUS: /ˈfaɪərɡɑːrd/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """She bought a decorative fireguard for her living room.""",
                      kurdishText:
                          """ئاگرپارێزێکی جوانی کڕی بۆ ژووری میوانەکەی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/JZXcjvnLjJg?t=';
const double _startSecondsend = 000000000000000000000000000595;
const String _videoIdone = 'https://youtu.be/rK1vUChw3Ow?t=';
const double _startSecondsone = 0000000000000000000000000001556;
const String _videoIdtwo = 'https://youtu.be/cwRUcchszNg?t=';
const double _startSecondstwo = 00000000000000000000000000097;
const String _videoIdthree = 'https://youtu.be/yBCIiz0_SGU?t=';
const double _startSecondsthree = 0000000000000000000000000005;
const String _videoIdfour = 'https://youtu.be/--2dzyO5_T0?t=';
const double _startSecondsfour = 0000000000000000000000000001578;
const String _videoIdfive = 'https://youtu.be/7rKoTDvhNX0';
