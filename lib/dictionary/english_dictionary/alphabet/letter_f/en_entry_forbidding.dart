...
class EnglishEntryforbidding extends StatefulWidget {
  const EnglishEntryforbidding({super.key});

  @override
  State<EnglishEntryforbidding> createState() => _EnglishEntryforbiddingState();
}

class _EnglishEntryforbiddingState extends State<EnglishEntryforbidding> {
  @override
  void initState() {
    super.initState();
...
1. Harshly uninviting or formidable in manner or appearance (= dour, grim)
"a forbidding scowl";
 
2. Indicating evil intent or suggesting tragic developments (= baleful, menacing, minacious, minatory, ominous, sinister, threatening)
"forbidding thunderclouds";

- Noun: forbidding (Derived forms: forbiddings)
1. An official prohibition or edict against something (= ban, banning, forbiddance)
""",
  );

  final String keyword = "forbidding";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forbidding""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The house looked dark and forbidding.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forbidding""",
                      // alsoEnglishWord: "also: forbidding",
                      britshText: """IpaUK: /fəˈbɪdɪŋ/""",
                      americanText: """IpaUS: /fərˈbɪdɪŋ/""",
...
کوردی: مۆن، ڕووگرژ، ڕووتاڵ،	نادۆستانە، دوژمنانە، ڕقەبەرانە، ترسناک، ترسێنەر،	بێزەون،	هەڕەشەیی‌یانە، لەگەڵ‌هەڕەشە، مەترسی‌دار
"""),
// With short examples define "forbidding", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) کە نەیار و تۆقێنەر دیارە"""),
                    SentencesRow(
                      englishText: """The house looked dark and forbidding.""",
                      kurdishText: """خانووەکە تاریک و تۆقێنەر دیار بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/sQ0WsP7osAU?t=';
const double _startSecondsend = 000000000000000000000000000231;
const String _videoIdone = 'https://youtu.be/8fCqhpV2SG4?t=';
const double _startSecondsone = 0000000000000000000000000002487;
const String _videoIdtwo = 'https://youtu.be/pY-mZoX0tK0?t=';
const double _startSecondstwo = 000000000000000000000000000221;
const String _videoIdthree = 'https://youtu.be/7Sk6lTLSZcA?t=';
const double _startSecondsthree = 000000000000000000000000000666;
const String _videoIdfour = 'https://youtu.be/JTyPQFHB3KM?t=';
const double _startSecondsfour = 000000000000000000000000000338;
const String _videoIdfive = 'https://youtu.be/LCEsoH1F-Us?t=';
const double _startSecondsfive = 000000000000000000000000000266;
