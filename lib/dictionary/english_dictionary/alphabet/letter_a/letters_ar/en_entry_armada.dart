...
// replace EnglishEntryAdopsummm - replace speakArmada

// replace armada - /ɑːˈmɑːdə/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarmada extends StatelessWidget {
  // blank divider
  EnglishEntryarmada({super.key});
  // blank divider
  ...
  Future<void> speakarmada423(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The Spanish Armada was sent to attack England in 1588.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "armada"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ɑːˈmɑːdə/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ɑːrˈmɑːdə/"),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'RRlh8ivGXmQ';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Y1ial6_iWZ8';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'lYwQDNZrbWQ';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'cl3ySfKfv1s';
