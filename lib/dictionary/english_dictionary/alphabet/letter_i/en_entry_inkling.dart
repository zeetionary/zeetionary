...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'd3qOoYZppaQ';
    const double startSecondsend = 920;
    const String videoIdone = 'HdwzJLTLFqc';
    const double startSecondsone = 190;
    const String videoIdtwo = 'bw-DaU90gQo';
    const double startSecondstwo = 289;
    const String videoIdthree = '3ulWkFs-OGM';
    const double startSecondsthree = 1027;
    const String videoIdfour = 'qadSvKa2eHY';
    const double startSecondsfour = 350;
    const String videoIdfive = 'kwz-Md6OoyA';
    const double startSecondsfive = 888;
