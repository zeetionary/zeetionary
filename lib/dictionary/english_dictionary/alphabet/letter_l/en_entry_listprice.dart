...
class EnglishEntrylistprice extends StatefulWidget {
  const EnglishEntrylistprice({super.key});

  @override
  State<EnglishEntrylistprice> createState() => _EnglishEntrylistpriceState();
}

class _EnglishEntrylistpriceState extends State<EnglishEntrylistprice> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: list price (Derived forms: list prices)
...
""",
  ...
  final String keyword = "list price";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""list price""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It is selling for £18.89 instead of for the list price of £34.95.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/7Ycd8zEdoVk?t=280';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/CLzMq1OjJvw?t=258';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/2zBucwG6Mwo?t=529';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/n6mC5C6PcE4?t=297';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/XacNRsAfKb4?t=113';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/qIMo6OVku9U?t=554';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """list price""",
                      // alsoEnglishWord: "also: list price",
                      britshText: """IpaUK: /ˈlɪst praɪs/""",
                      americanText: """IpaUS: /ˈlɪst praɪs/""",
...
کوردی: 
"""),
// With short examples define "list price", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) نرخی سەرەتای شتێک کە دەفرۆشرێت"""),
                    SentencesRow(
                      englishText: """It is selling for £18.89 instead of for the list price of £34.95.""",
                      kurdishText: """بە ١٨,٨٩ پاوەند دەفرۆشرێت لە جیاتی نرخی سەرەتای ٣٤,٩٥ پاوەند.""",
