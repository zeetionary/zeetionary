...
class EnglishEntryfictitious extends StatefulWidget {
  const EnglishEntryfictitious({super.key});

  @override
  State<EnglishEntryfictitious> createState() => _EnglishEntryfictitiousState();
}

class _EnglishEntryfictitiousState extends State<EnglishEntryfictitious> {
  @override
  void initState() {
    super.initState();
...
1. Formed or conceived by the imagination (= fabricated, fancied, fictional, made-up)
"a fictitious excuse for his absence";
 
2. Adopted in order to deceive (= assumed, false, fictive, pretended, put on, sham)
"a fictitious address";
""",
  );

  final String keyword = "fictitious";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fictitious""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""All the places and characters in my novel are fictitious.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The account he gives of his childhood is fictitious.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fictitious""",
                      // alsoEnglishWord: "also: fictitious",
                      britshText: """IpaUK: /fɪkˈtɪʃəs/""",
                      americanText: """IpaUS: /fɪkˈtɪʃəs/""",
...
const String _videoIdone = 'https://youtu.be/anbBwpoI9TI?t=';
const double _startSecondsone = 000000000000000000000000000313;
const String _videoIdtwo = 'https://youtu.be/YbNeOLbFZVg?t=';
const double _startSecondstwo = 000000000000000000000000000734;
const String _videoIdthree = 'https://youtu.be/vsMydMDi3rI?t=';
const double _startSecondsthree = 0000000000000000000000000002714;
const String _videoIdfour = 'https://youtu.be/Z4H2W-k2j84?t=';
const double _startSecondsfour = 00000000000000000000000000076;
const String _videoIdfive = 'https://youtu.be/j4kI2h3iotA?t=';
const double _startSecondsfive = 0000000000000000000000000003212;
