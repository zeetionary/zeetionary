...
class EnglishEntryiceskate extends StatefulWidget {
  const EnglishEntryiceskate({super.key});

  @override
  State<EnglishEntryiceskate> createState() => _EnglishEntryiceskateState();
}

class _EnglishEntryiceskateState extends State<EnglishEntryiceskate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: ice skate (Derived forms: ice skates)
1. Skate consisting of a boot with a steel blade fitted to the sole

- Verb: ice-skate (Derived forms: ice-skates, ice-skated, ice-skating)
1. (sport) move along on ice skates
""",
  );

  final String keyword = "ice skate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ice skate""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Ice skates make it easy to move quickly on the ice.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He learned to ice skate last winter.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Sv1fDOwyK4s?t=';
    const double startSecondsend = 000000000000000000000000000392;
    const String videoIdone = 'https://youtu.be/BpFoQlzd3Z4?t=';
    const double startSecondsone = 000000000000000000000000000231;
    const String videoIdtwo = 'https://youtu.be/0TRBaanw1gs?t=';
    const double startSecondstwo = 000000000000000000000000000463;
    const String videoIdthree = 'https://youtu.be/FoLIoqxEBcQ?t=';
    const double startSecondsthree = 000000000000000000000000000371;
    const String videoIdfour = 'https://youtu.be/Q2jZv-zaG_I?t=';
    const double startSecondsfour = 000000000000000000000000000377;
    const String videoIdfive = 'https://youtu.be/wtoG5N3v3Ak?t=';
    const double startSecondsfive = 000000000000000000000000000465;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ice skate""",
                      // alsoEnglishWord: "also: ice skate",
                      britshText: """IpaUK: /ˈaɪs skeɪt/""",
                      americanText: """IpaUS: /ˈaɪs skeɪt/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پووتێک کە بەکاردێت بۆ خلیسکێنەی سەر سەهۆڵ"""),
                    SentencesRow(
                      englishText:
                          """Ice skates make it easy to move quickly on the ice.""",
                      kurdishText:
                          """پووتی سەرسەهۆڵ وادەکات ئاسان بێت بە خێرایی لەسەر سەهۆڵ خلیسکێنە بکەیت.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (کردار) خلیسکێنەکردن لەسەر سەهۆڵ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He learned to ice skate last winter.""",
                      kurdishText:
                          """زستانی ڕابردوو فێری خلیسکێنەی سەرسەهۆڵ بوو.""",
