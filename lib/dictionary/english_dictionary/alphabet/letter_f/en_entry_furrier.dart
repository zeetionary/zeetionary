...
class EnglishEntryfurrier extends StatefulWidget {
  const EnglishEntryfurrier({super.key});

  @override
  State<EnglishEntryfurrier> createState() => _EnglishEntryfurrierState();
}

class _EnglishEntryfurrierState extends State<EnglishEntryfurrier> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: furrier (Derived forms: furriers)
1. Someone whose occupation is making or repairing fur garments (- cloakmaker)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""furrier""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The furrier displayed beautiful fur jackets.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furrier""",
                      // alsoEnglishWord: "also: furrier",
                      britshText: """IpaUK: /ˈfʌrɪə(r)/""",
                      americanText: """IpaUS: /ˈfɜːriər/""",
...
کوردی: کەوڵ‌فرۆش، پێستەفرۆش، فەروەفرۆش، خەزفرۆش
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە ئەو جلانە دەفرۆشێت کە لە فەروو درووستکراون"""),
                    SentencesRow(
                      englishText:
                          """The furrier displayed beautiful fur jackets.""",
                      kurdishText:
                          """فەروەفرۆشەکە چاکەتی فەرووی جوانی نمایش کردبوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/tgtTMD1obDs?t=';
const double _startSecondsend = 0000000000000000000000000001386;
const String _videoIdone = 'https://youtu.be/VLablc2ElFQ?t=';
const double _startSecondsone = 000000000000000000000000000123;
const String _videoIdtwo = 'https://youtu.be/g476q-3DL-U?t=';
const double _startSecondstwo = 00000000000000000000000000076;
const String _videoIdthree = 'https://youtu.be/wJugmmW-Jok?t=';
const double _startSecondsthree = 0000000000000000000000000001737;
const String _videoIdfour = 'https://youtu.be/tN7Th52hy5A?t=';
const double _startSecondsfour = 000000000000000000000000000129;
const String _videoIdfive = 'https://youtu.be/3zueoGI18ds?t=';
const double _startSecondsfive = 000000000000000000000000000102;
