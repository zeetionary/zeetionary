...
// replace these: replace EnglishEntryambiguous - replace speakAmbiguous - replace ambiguous - /æmˈbɪɡjuəs/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryambiguous extends StatelessWidget {
  EnglishEntryambiguous({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAmbiguous(String languageCode) async {
    // DOPSUM: CHANGE speakAmbiguous
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("ambiguous"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAmbiguous7666(String languageCode) async {
    ...
    await flutterTts.speak(
        "The paragraph is rendered ambiguous by the writer's careless use of pronouns."); // DOPSUM: CHANGE TEXT
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'W5jAiVVOr0w';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'VXXpRW3bGw8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '57nlvT_o8uw';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '5xioPAlymFM';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'L3XnKr0lvDw';
