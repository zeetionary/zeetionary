...
class EnglishEntryfinance extends StatefulWidget {
  const EnglishEntryfinance({super.key});

  @override
  State<EnglishEntryfinance> createState() => _EnglishEntryfinanceState();
}

class _EnglishEntryfinanceState extends State<EnglishEntryfinance> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""finance""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Finance for education comes from taxpayers.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's got a diploma in banking and finance.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The banking and finance sector was booming.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The bank offers advice and guidance on personal finance.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They were unable to manage their finances.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It's about time you sorted out your finances.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Moving house put a severe strain on our finances.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Our family finances are not very healthy at the moment.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The company's finances are looking a bit shaky.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He took a job to finance his stay in Germany.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The building project will be financed by the government.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The research is financed through government grants.""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The new roads will be financed privately.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """finance""",
                      // alsoEnglishWord: "also: finance",
                      britshText:
                          """IpaUK: /ˈfaɪnæns/,  /faɪˈnæns/,  /fəˈnæns/""",
                      americanText:
                          """IpaUS: /ˈfaɪnæns/,  /faɪˈnæns/,  /fəˈnæns/""",
...
// With short examples define "finance", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The project will only go ahead if they can raise the necessary finance.""",
                      kurdishText:
                          """پڕۆژەکە بەردەوام دەبێت تەنها ئەگەر سەرمایەی پێویست کۆبکەنەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """خەرجی پاروەردە لە باجدەرانەوە دەکرێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She struggled to get the necessary finance for her training.""",
                      kurdishText:
                          """تەقەڵای بوو بۆ بەدەستهێنانی خەرجی ڕاهێنانەکەی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دیبلۆمای هەیە لە بانکداری و دارایی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """سێکتەری بانکی و دارایی دەبووژایەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بانکەکە ڕاوێژ و ڕێنمایی لەسەر کاری دارایی کەسی پێشکەش دەکات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) ئەو پارەیەی کە کەسێک، دامەزراوەیەک، یان حکومەتێک هەیەتی؛ شێوازی بەڕێوەبردنی پارەکە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """They were unable to manage their finances.""",
                      kurdishText:
                          """بێ‌توانا بوون لە بەڕێوەبردنی پارەکانیان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەنها کاتی پێویستە کاری دارایی خۆت بکەیت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """گواستنەوەی ماڵ پەستانی زۆری خستە سەر دەسمایەمان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەسمایەی خێزانەکەمان زۆر باش نییە لە ئێستادا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """سەرمایەی کۆمپانیاکە کەمێک لە هەرەسە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کارێکی دەستخست بۆ دابینکردنی پارەی مانەوەی لە ئەڵمانیا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پڕۆژە خانووبەرەکە لەلایەن حکومەتەوە خەرجی دەکرێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The research is financed through government grants.""",
                      kurdishText:
                          """توێژینەوەکە بە پارەی حکومەت خەرجی دەکرێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕێگا تازەکان لەلایەن کەرتی تایبەت خەرجی دەکرێن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Apparently he committed the offences to finance his drug addiction.""",
                      kurdishText:
                          """بەوەی دەردەکەوێت تاوانەکانی ئەنجام دا بۆ دابینکردنی پارەی ئاڵوودەیی بە مادەی هۆشبەر.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/f5NJQiY9AuY?t=';
const double _startSecondsend = 000000000000000000000000000127;
const String _videoIdone = 'https://youtu.be/Wao0_uB4Zw4?t=';
const double _startSecondsone = 0000000000000000000000000002602;
const String _videoIdtwo = 'https://youtu.be/cY4e0uvp7uI?t=';
const double _startSecondstwo = 0000000000000000000000000001194;
const String _videoIdthree = 'https://youtu.be/ZOvyn72x6kQ?t=';
...
const double _startSecondsfive = 000000000000000000000000000751;
