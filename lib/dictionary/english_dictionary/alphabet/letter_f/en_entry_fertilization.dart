...
class EnglishEntryfertilization extends StatefulWidget {
  const EnglishEntryfertilization({super.key});

  @override
  State<EnglishEntryfertilization> createState() =>
      _EnglishEntryfertilizationState();
}

class _EnglishEntryfertilizationState extends State<EnglishEntryfertilization> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "fertilization";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fertilization""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fertilization""",
                      // alsoEnglishWord: "also: fertilization",
                      britshText: """IpaUK: /ˌfɜːtəlaɪˈzeɪʃn/""",
                      americanText: """IpaUS: /ˌfɜːrtələˈzeɪʃn/""",
...
const double _startSecondsone = 000000000000000000000000000760;
const String _videoIdtwo = 'https://youtu.be/1YbgilES3Pk?t=';
const double _startSecondstwo = 000000000000000000000000000525;
const String _videoIdthree = 'https://youtu.be/NrFlhSNdDDk?t=';
const double _startSecondsthree = 000000000000000000000000000516;
const String _videoIdfour = 'https://youtu.be/gbC4hCh3WMw?t=';
const double _startSecondsfour = 000000000000000000000000000328;
const String _videoIdfive = 'https://youtu.be/dHc7MW6x0JQ?t=';
const double _startSecondsfive = 000000000000000000000000000304;
