...
// replace these: replace EnglishEntryaggrieved - replace speakAggrieved - replace aggrieved - /əˈɡriːvd/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaggrieved extends StatelessWidget {
  EnglishEntryaggrieved({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAggrieved(String languageCode) async {
    // DOPSUM: CHANGE speakAggrieved
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("aggrieved"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAggri6254(String languageCode) async {
    ...
    await flutterTts.speak(
        "He had every right to feel aggrieved at the decision."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "aggrieved", // DOPSUM: CHANGE WORD ENTRY - Find /əˈɡriːvd/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈɡriːvd/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /əˈɡriːvd/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'hTY_FDO2TXw';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'UTskEs2UF6w';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'pm5xxlajTW0';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'GMbPpio9jJo';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'veN5XnTkHI8';
