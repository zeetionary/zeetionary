...
final _controller = YoutubePlayerController.fromVideoId(
  videoId: 'https://youtu.be/4v3G10xh4yQ?t=',
  startSeconds: 2659,
  autoPlay: true,
...
final _controller = YoutubePlayerController.fromVideoId(
  videoId: 'https://youtu.be/06lO-_CieQQ?t=',
  startSeconds: 663,
  autoPlay: true,
  params: const YoutubePlayerParams(
    enableCaption: true,
...
final _controller = YoutubePlayerController.fromVideoId(
  videoId: 'https://youtu.be/a_XE1FsaWBA?t=',
  startSeconds: 697,
  autoPlay: true,
  params: const YoutubePlayerParams(
    enableCaption: true,
...
final _controller = YoutubePlayerController.fromVideoId(
  videoId: 'https://youtu.be/G049wsu-gpI?t=',
  startSeconds: 12018,
  autoPlay: true,
  params: const YoutubePlayerParams(
    enableCaption: true,
...
final _controller = YoutubePlayerController.fromVideoId(
  videoId: 'https://youtu.be/RAv1O0g7lbM?t=',
  startSeconds: 11562,
  autoPlay: true,
  params: const YoutubePlayerParams(
    enableCaption: true,
...
final _controller = YoutubePlayerController.fromVideoId(
  videoId: 'https://youtu.be/mpDtuFyYS8o?t=',
  startSeconds: 562,
  autoPlay: true,
  params: const YoutubePlayerParams(
    enableCaption: true,
