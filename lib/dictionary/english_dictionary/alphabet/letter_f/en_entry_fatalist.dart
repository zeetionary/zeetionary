...
class EnglishEntryfatalist extends StatefulWidget {
  const EnglishEntryfatalist({super.key});

  @override
  State<EnglishEntryfatalist> createState() => _EnglishEntryfatalistState();
}

class _EnglishEntryfatalistState extends State<EnglishEntryfatalist> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fatalist""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fatalist""",
                      // alsoEnglishWord: "also: fatalist",
                      britshText: """IpaUK: /ˈfeɪtəlɪst/""",
                      americanText: """IpaUS: /ˈfeɪtəlɪst/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'm a fatalist.""");
  }
...
// With short examples define "fatalist", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: چارەنووس‌گەر، چارەنووس‌باوەڕ
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کەسێک کە باوەڕی بەوە هەیە شتەکان بە چارەنووس دیاری کراون و لە توانای گۆڕاندا نین"""),
          SentencesRow(
            englishText: """I'm a fatalist.""",
            kurdishText: """من باوەڕدارێکی چارەنووسم.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fatalist
1. Of or relating to fatalism (= fatalistic)
"a fatalist person";

- Noun: fatalist (Derived forms: fatalists)
1. Anyone who submits to the belief that they are powerless to change their destiny (= determinist, predestinarian, predestinationist)
""",
  );
...
const String _videoIdend = 'https://youtu.be/pqZ6fUt9TXk?t=';
const double _startSecondsend = 000000000000000000000000000471;
const String _videoIdone = 'https://youtu.be/RB_h0_dOmJQ?t=';
const double _startSecondsone = 0000000000000000000000000001158;
const String _videoIdtwo = 'https://youtu.be/RB_h0_dOmJQ?t=';
const double _startSecondstwo = 0000000000000000000000000001153;
const String _videoIdthree = 'https://youtu.be/IxTN5PdXJRI?t=';
const double _startSecondsthree = 0000000000000000000000000001341;
const String _videoIdfour = 'https://youtu.be/H4QQf9XgCrc?t=';
const double _startSecondsfour = 0000000000000000000000000001048;
const String _videoIdfive = 'https://youtu.be/cMlKQPc-cKM?t=';
