...
// Define the word "authorship" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace authorship - replace EnglishEntryauthorship

// replace speakAuthorship - /ˈɔːθəʃɪp/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryauthorship extends StatelessWidget {
  // blank divider
  EnglishEntryauthorship({super.key});
  // blank divider
  ...
  Future<void> speakauthorship(String languageCode) async {
    ...
    await flutterTts.speak("authorship");
  }
  ...
  Future<void> speakauthorship731(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The authorship of the poem is unknown.");
  }
  ...
  Future<void> speakauthorship733(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("He published the report in joint authorship with a colleague.");
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "authorship"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: authorship (derived forms: authorships)
1. The act of creating written works (= writing, composition, penning)
"it was a matter of disputed authorship";
 
2. The act of initiating a new idea, theory or writing (= paternity)
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'iZQJQYqhAgY';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'sig8X_kojco';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'nIEbpGdctyg';
  final double _startSeconds = 1429;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'LZB0mPMBvC4';
  final double _startSeconds = 1874;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'nIRbN52PA0o';
...
// end authorship // TODO Implement this library.