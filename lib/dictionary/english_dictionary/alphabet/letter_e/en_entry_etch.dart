...
class EnglishEntryetch extends StatefulWidget {
  const EnglishEntryetch({super.key});

  @override
  State<EnglishEntryetch> createState() => _EnglishEntryetchState();
}

class _EnglishEntryetchState extends State<EnglishEntryetch> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """etch""",
                      // alsoEnglishWord: "also: etch",
                      britshText: """IpaUK: /etʃ/""",
                      americanText: """IpaUS: /etʃ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He etched his name on a piece of glass.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) نەخشاندنی وشە یان وێنە لەسەر شووشە، کانزا، هتد"""),
          SentencesRow(
            englishText:
                """A security number had been etched on the car window as a protection against theft.""",
            kurdishText:
                """ژمارەیەکی پاراستن لەسەر جامی ئۆتۆمبێلەکە نەخشێندرابوو وەک پاراستن دژ بە دزی.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He etched his name on a piece of glass.""",
            kurdishText: """ناویی لەسەر پارچە شووشەیەک نەخشاند.""",
            onPressedBritish: () => speaksentence2("en-GB"),
            onPressedAmerican: () => speaksentence2("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (کردار) دەرکەوتنی هەستێک بە ئاسانی"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Tiredness was etched on his face.""",
            kurdishText: """ماندوویەتی لە ڕووخساری نەخشێندرابوو.""",
            englishNote: "Also: His face was etched with tiredness.",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: etch (Derived forms: etched, etching, etches)
1. Selectively dissolve the surface of something with a solvent (or laser, stream of electrons, etc.) to produce a desired design or effect
 
2. (art) make an etching of
"He etched her image into the surface"
 
3. (art) carve or cut into a block used for printing or print from such a block (= engrave)
"etch a letter";
 
4. Carve or cut a design or letters into (= engrave)
"etch the pen with the owner's name";
 
5. Cause to stand out or be clearly defined or visible
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/U38i32CpYow?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1010;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/y4DTW4B3Sjs?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1070;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/Ir3eJ1t13fk?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 471;
const String _videoIdthree = 'VIDEOhttps://youtu.be/Uhh_An7FGek?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1091;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/bUia-EbqS7A?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 780;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/xjmXzYdxuTQ?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 94;
