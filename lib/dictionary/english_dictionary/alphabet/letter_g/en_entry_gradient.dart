...
class EnglishEntrygradient extends StatefulWidget {
  const EnglishEntrygradient({super.key});

  @override
  State<EnglishEntrygradient> createState() => _EnglishEntrygradientState();
}

class _EnglishEntrygradientState extends State<EnglishEntrygradient> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gradient""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The route includes some steep gradients.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The hill has a gradient of 25%.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      britshText: """IpaUK: /ˈɡreɪdiənt/""",
                      americanText: """IpaUS: /ˈɡreɪdiənt/""",
...
// With short examples define "gradient", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The route includes some steep gradients.""",
                      kurdishText: """ڕێگاکە هەندێک لێژایی سەرەوخوار لەخۆ دەگرێت..""",
                    ...
                    SentencesRow(
                      englishText: """The hill has a gradient of 25%.""",
                      kurdishText: """گردەکە لێژایی ٢٥٪ ــی هەیە.""",
...
const String _videoIdone = 'https://youtu.be/TUfyUUauuoY?t=';
const double _startSecondsone = 000000000000000000000000000689;
const String _videoIdtwo = 'https://youtu.be/oI_X2cMHNe0?t=';
const double _startSecondstwo = 000000000000000000000000000351;
const String _videoIdthree = 'https://youtu.be/RQYuyHNLPTQ?t=';
const double _startSecondsthree = 000000000000000000000000000711;
const String _videoIdfour = 'https://youtu.be/zIADYkHIFDI?t=';
const double _startSecondsfour = 0000000000000000000000000001222;
const String _videoIdfive = 'https://youtu.be/9hvjBi4PKWA?t=';
const double _startSecondsfive = 000000000000000000000000000552;
