...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 2641;
    const String videoIdone = 'f7QWMUCMYOE';
    const double startSecondsone = 908;
    const String videoIdtwo = '3PX2d3Zwutg';
    const double startSecondstwo = 493;
    const String videoIdthree = '9yjZpBq1XBE';
    const double startSecondsthree = 2407;
    const String videoIdfour = 'EN6jtHIqeTg';
    const double startSecondsfour = 731;
    const String videoIdfive = 'DSQG0zvR6dk';
    const double startSecondsfive = 1120;
