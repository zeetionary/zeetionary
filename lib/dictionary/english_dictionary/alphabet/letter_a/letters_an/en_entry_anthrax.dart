                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "anthrax"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈænθræks/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈænθræks/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'jPJje65SnJY';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'QMS6MGUtHH0';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'lr1dzJjJFFs';
  final double _startSeconds = 2453;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'x3FMww5biJ8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'nLAVTQwXc48';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'M65_i2HVbuc';
