...
class EnglishEntryhideously extends StatefulWidget {
  const EnglishEntryhideously({super.key});

  @override
  State<EnglishEntryhideously> createState() => _EnglishEntryhideouslyState();
}

class _EnglishEntryhideouslyState extends State<EnglishEntryhideously> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: hideously
1. In a hideous manner (- horridly, monstrously)
"her face was hideously disfigured after the accident";
""",
  );

  final String keyword = "hideously";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hideously""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His face was hideously deformed.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hideously""",
                      // alsoEnglishWord: "also: hideously",
                      britshText: """IpaUK: /ˈhɪdiəsli/""",
                      americanText: """IpaUS: /ˈhɪdiəsli/""",
...
کوردی: ناحەزانە، ترسناکانە
"""),
// With short examples define "hideously", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بەشێوەیەکی زۆر ناشرین و ناپەسەند """),
                    const AlsoEnglishckb(word: "ھەروەھا: revoltingly"),
                    SentencesRow(
                      englishText: """His face was hideously deformed.""",
                      kurdishText: """ڕووخساری ناشرینانە تێکچوو بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Ag4sUz3crzw?t=';
const double _startSecondsend = 000000000000000000000000000356;
const String _videoIdone = 'https://youtu.be/KMXMGvZ0lJA?t=';
const double _startSecondsone = 000000000000000000000000000567;
const String _videoIdtwo = 'https://youtu.be/s6Mo7YNAmcs?t=';
const double _startSecondstwo = 00000000000000000000000000065;
const String _videoIdthree = 'https://youtu.be/z3uvnwBMTdY?t=';
const double _startSecondsthree = 0000000000000000000000000002450;
const String _videoIdfour = 'https://youtu.be/WINud2yt0NQ?t=';
const double _startSecondsfour = 000000000000000000000000000148;
const String _videoIdfive = 'https://youtu.be/3xzYkcJdmUE?t=';
const double _startSecondsfive = 000000000000000000000000000661;
