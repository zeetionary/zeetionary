...
class EnglishEntryhospital extends StatefulWidget {
  const EnglishEntryhospital({super.key});

  @override
  State<EnglishEntryhospital> createState() => _EnglishEntryhospitalState();
}

class _EnglishEntryhospitalState extends State<EnglishEntryhospital> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hospital (Derived forms: hospitals)
1. A medical institution where sick or injured people are given medical or surgical care (- spital [archaic])
 
2. A health facility where patients receive treatment (- infirmary)
""",
  );

  final String keyword = "hospital";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hospital""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The hospital is affiliated with the university.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The ambulance crew rushed her to the hospital.""");
  }
  ...
  Future<void> speaksentence18(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He was the man behind the plan to build a new hospital.""");
  }
  ...
  Future<void> speaksentence21(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He was certified dead upon arrival at the hospital.""");
  }
  ...
  Future<void> speaksentence23(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The Queen ceremonially opened the new hospital.""");
  }
  ...
  Future<void> speaksentence30(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was committed to a psychiatric hospital.""");
  }
  ...
  Future<void> speaksentence31(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was taken to hospital with concussion.""");
  }
  ...
  Future<void> speaksentence40(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Hospitals use strong disinfectants for cleaning.""");
  }
  ...
  Future<void> speaksentence45(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He was taken to the hospital during the night.""");
  }
  ...
  Future<void> speaksentence58(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The hospital has a dedicated geriatrics department.""");
  }
  ...
  Future<void> speaksentence60(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak(
        """The hospital will be celebrating its golden jubilee on Thursday.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/2fch6wJNuxE?t=';
    const double startSecondsend = 0000000000000000000000000003;
    const String videoIdone = 'https://youtu.be/ztH77Bl4qns?t=';
    const double startSecondsone = 00000000000000000000000000018;
    const String videoIdtwo = 'https://youtu.be/AdqQWg3ImEw?t=';
    const double startSecondstwo = 000000000000000000000000000158;
    const String videoIdthree = 'https://youtu.be/CmhFPjE6U8k?t=';
    const double startSecondsthree = 000000000000000000000000000100;
    const String videoIdfour = 'https://youtu.be/e8Zbzv8Vq2o?t=';
    const double startSecondsfour = 00000000000000000000000000025;
    const String videoIdfive = 'https://youtu.be/4tZt5axOB80?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hospital""",
                      // alsoEnglishWord: "also: hospital",
                      britshText: """IpaUK: /ˈhɒspɪtl/""",
                      americanText: """IpaUS: /ˈhɑːspɪtl/""",
...
// With short examples define "hospital", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "دڵی لە لێدان کەوت لە ڕێگا بۆ نەخۆشخانە.",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "بە مردوو دەنرا ھەرکە گەشتە نەخۆشخانەکە.",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "بەخێرایی مەترسیدار چووین بۆ نەخۆشخانەکە.",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "لە کلینکی چاوی نەخۆشخانەکە چارەسەرکرا.",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "نەخۆشخانەکە داخرا لە کۆتایی ساڵی پار.",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "لەھۆش خۆی چوو و گوازرایەوە بۆ نەخۆشخانە.",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "بردرا بۆ نەخۆشخانە بەھۆی ڕاتڵەکانی مێشک.",
                    ...
                    SentencesRow(
                      englishText:
                          """It seemed to take an eternity for us to get to the hospital.""",
                      kurdishText:
                          """وادیاربوو ماوەیەکی ئەبەدی پێ بچێت تا بگەینە نەخۆشخانەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The hospital will be celebrating its golden jubilee on Thursday.""",
                      kurdishText:
                          """ڕۆژی پێنجشەممە نەخۆشخانەکە ئاھەنگی پەنجایەمین ساڵیادی دەگێڕێت.""",
