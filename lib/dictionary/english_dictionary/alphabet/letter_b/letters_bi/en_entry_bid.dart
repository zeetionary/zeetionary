...
// blank divider
  ...
  Future<void> speakbids1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("At the auction, the highest bid for the picture was £200.");
  }
  ...
  Future<void> speakbids2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Any more bids?");
  }
  ...
  Future<void> speakbids4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("He attacked his guards in a desperate bid for freedom.");
  }
  ...
  Future<void> speakbids5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I bid £2 000 for the painting.");
  }
  ...
  Future<void> speakbids6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("Which other cities are bidding to host the 2028 Olympics?");
  }
  ...
  Future<void> speakbids7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The team is bidding to retain its place in the league.");
  }
  ...
  Future<void> speakbids8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("I bade farewell to all the friends I had made in Paris.");
  }
  ...
  Future<void> speakbids9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He bade her good day and left.");
  }
  ...
  Future<void> speakbids10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBids1010");
  }
  ...
  Future<void> speakbids11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBids1111");
  }
  ...
  Future<void> speakbids12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBids1212");
  }
  ...
  Future<void> speakbids13(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBids1313");
  }
  ...
  Future<void> speakbids14(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBids1414");
  }
  ...
  Future<void> speakbids15(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBids1515");
  }
  ...
  Future<void> speakbids16(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBids1616");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '_LUX70mXcEE';
...
class _YoutubeEmbeddedtenState extends State<YoutubeEmbeddedten> {
  late YoutubePlayerController _controller;
  final String _videoId = 'jBRjumRkWd4';
...
class _YoutubeEmbeddedelevenState extends State<YoutubeEmbeddedeleven> {
  late YoutubePlayerController _controller;
  final String _videoId = 'Leu0HHZuGbw';
...
class _YoutubeEmbeddedtwelveState extends State<YoutubeEmbeddedtwelve> {
  late YoutubePlayerController _controller;
  final String _videoId = 'wtE5gcjJOmY';
...
class _YoutubeEmbeddeddfourteenState extends State<YoutubeEmbeddeddfourteen> {
  late YoutubePlayerController _controller;
  final String _videoId = 'NIOYdwhp12Q';
...
class _YoutubeEmbeddedfifteenState extends State<YoutubeEmbeddedfifteen> {
  late YoutubePlayerController _controller;
  final String _videoId = 'UrHmQHrIzT4';
  final double _startSeconds = 16056;
...
class _YoutubeEmbeddeddeighteenState extends State<YoutubeEmbeddeddeighteen> {
  late YoutubePlayerController _controller;
  final String _videoId = 'nJ4qA-S-KmE';
...
class _YoutubeEmbeddeddnineteenState extends State<YoutubeEmbeddeddnineteen> {
  ...
  final double _startSeconds = 10791;
...
class _YoutubeEmbeddedtwentyState extends State<YoutubeEmbeddedtwenty> {
  late YoutubePlayerController _controller;
  final String _videoId = '6VoHi64t718';
