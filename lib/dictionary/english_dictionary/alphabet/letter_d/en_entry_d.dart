...
Future<void> speakds1(String languageCode) async {
  ...
  await flutterTts.speak(
      "// speakds111111111111111111111111111111111"); // DOPSUM: CHANGE TEXT
}
...
Future<void> speakds2(String languageCode) async {
  ...
  await flutterTts.setPitch(1.0);
  await flutterTts.setSpeechRate(0.5);
  await flutterTts.speak("speakds200"); // DOPSUM: CHANGE TEXT
}
              ...
              child: Column(
                children: [
                  ExampleSentenceEnglish(
                      text:
                          "// speakds111111111111111111111111111111111"),
...
speakd EnglishEntryd
WORD_WEB d haʊʊʊʊʊʊʊ4
""",
);
