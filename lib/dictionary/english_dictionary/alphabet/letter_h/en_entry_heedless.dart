...
class EnglishEntryheedless extends StatefulWidget {
  const EnglishEntryheedless({super.key});

  @override
  State<EnglishEntryheedless> createState() => _EnglishEntryheedlessState();
}

class _EnglishEntryheedlessState extends State<EnglishEntryheedless> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: heedless 
1. Marked by or paying little heed or attention (- unheeding)
"heedless of danger"; "We have always known that heedless self-interest was bad morals; we know now that it is bad economics";
 
2. Characterized by careless unconcern (- reckless)
"the heedless generosity and the spasmodic extravagance of persons used to large fortunes";
""",
  );

  final String keyword = "heedless";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heedless""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heedless""",
                      // alsoEnglishWord: "also: heedless",
                      britshText: """IpaUK: /ˈhiːdləs/""",
                      americanText: """IpaUS: /ˈhiːdləs/""",
...
کوردی: کەمتەرخەم، گوێ‌پێنەدەر، نادەربەست، سەرنج‌پێنەدەر، بەهێندنەگر، بەتەنگەوەنەبوو، لاسار، بێ‌خەم، بێ‌خەیاڵ
"""),
// With short examples define "heedless", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) پێنەدانی سەرنجی تەواو بە کەسێک/شتێک"""),
                    SentencesRow(
                      englishText:
                          """Heedless destruction of the rainforests is contributing to global warming.""",
                      kurdishText:
                          """لەناوچوونی کەمتەرخەمانەی دارستانە باراناوییەکان دەبێت بە هۆکاری گەرمبوونی جیهانی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/V-hU1fEFKus?t=';
const double _startSecondsend = 0000000000000000000000000001019;
const String _videoIdone = 'https://youtu.be/Rxh_SVtyZqo?t=';
const double _startSecondsone = 0000000000000000000000000007751;
const String _videoIdtwo = 'https://youtu.be/detsrwRx3Ao?t=';
const double _startSecondstwo = 0000000000000000000000000002822;
const String _videoIdthree = 'https://youtu.be/UzmbgQmpISk?t=';
const double _startSecondsthree = 000000000000000000000000000829;
const String _videoIdfour = 'https://youtu.be/DkKIoXMmuMA?t=';
const double _startSecondsfour = 0000000000000000000000000001134;
const String _videoIdfive = 'https://youtu.be/HTFd5kAuZi0?t=';
const double _startSecondsfive = 0000000000000000000000000001247;
