...
class EnglishEntrygod extends StatefulWidget {
  const EnglishEntrygod({super.key});

  @override
  State<EnglishEntrygod> createState() => _EnglishEntrygodState();
}

class _EnglishEntrygodState extends State<EnglishEntrygod> {
  @override
  void initState() {
    super.initState();
...
1. The supernatural being conceived as the perfect and omnipotent and omniscient originator and ruler of the universe; the object of worship in monotheistic religions (- Supreme Being)""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Do you believe in God?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Good luck and God bless you.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Christians believe that Jesus is the Son of God.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He has given up drinking and found God.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He saw the accident as the will of God.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Muslims have only one God.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Nothing ever shook her faith in God.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Mars was the Roman god of war.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The people worshipped pagan gods.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The Romans had many gods.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""To her fans she's a god.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Money is his god.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """god""",
                      // alsoEnglishWord: "also: god",
                      britshText: """IpaUK: /ɡɒd/""",
                      americanText: """IpaUS: /ɡɑːd/""",
...
// With short examples define "god", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Do you believe in God?""",
                      kurdishText: """باوەڕت بە خودا هەیە؟""",
                    ...
                    SentencesRow(
                      englishText: """Good luck and God bless you.""",
                      kurdishText: """بەختێکی باش و خودا ڕەحمت پێ بکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """مەسیحییەکان باوەڕیان وایە عیسا کوڕی خودایە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وازی لە خواردنەوە هێناوە و گەڕاوەتەوە لای خودا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕووداوەکەی وەک ویستی خودا بینی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Muslims have only one God.""",
                      kurdishText: """موسڵمانان تەنها یەک خودایان هەیە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Nothing ever shook her faith in God.""",
                      kurdishText:
                          """هیچ شتێک هەرگیز باوەڕیی بە خودا لەق نەکرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) لە هەندێک ئاییندا بوونێکە کە باوەڕ وایە دەسەڵاتی بەسەر لایەنێکی دیاریکراوی سرووشتدا هەبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The people worshipped pagan gods.""",
                      kurdishText: """خەڵکەکە خودا بتینییەکانیان دەپەرست.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The Romans had many gods.""",
                      kurdishText: """ڕۆمەکان زۆر خوداوەندیان هەبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لای هەوادارانی خوداوەندێکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/21Z4RIOFhMA?t=';
const double _startSecondsend = 00000000000000000000000000033;
const String _videoIdone = 'https://youtu.be/cLmCJKT5ssw?t=';
const double _startSecondsone = 00000000000000000000000000030;
const String _videoIdtwo = 'https://youtu.be/SE2B2kVJHns?t=';
const double _startSecondstwo = 0000000000000000000000000001348;
const String _videoIdthree = 'https://youtu.be/2jItoUjEhhg?t=';
const double _startSecondsthree = 000000000000000000000000000582;
const String _videoIdfour = 'https://youtu.be/40a1AAbq_LE?t=';
const double _startSecondsfour = 000000000000000000000000000838;
