...
class EnglishEntrylimitless extends StatefulWidget {
  const EnglishEntrylimitless({super.key});

  @override
  State<EnglishEntrylimitless> createState() => _EnglishEntrylimitlessState();
}

class _EnglishEntrylimitlessState extends State<EnglishEntrylimitless> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""limitless""");
  }
