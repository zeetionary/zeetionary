...
class EnglishEntryfairly extends StatefulWidget {
  const EnglishEntryfairly({super.key});

  @override
  State<EnglishEntryfairly> createState() => _EnglishEntryfairlyState();
}

class _EnglishEntryfairlyState extends State<EnglishEntryfairly> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fairly""",
                      // alsoEnglishWord: "also: fairly",
                      britshText: """IpaUK: /ˈfeəli/""",
                      americanText: """IpaUS: /ˈferli/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This is a fairly common problem.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It's fairly obvious what's going on here.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'm fairly certain I can do the job.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was fairly sure he was right.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He has always treated me very fairly.""");
  }
...
کوردی: تا ئەندازەیێ، تا ڕادەیێ، کەم‌تاکورتێ، بەحاڵ،	دادپەروەرانە، پیاوانە، دروست، دادگەرانە، لانەگرانە
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵکار) بە ئاستێک بەڵام نەک زۆر"""),
          SentencesRow(
            englishText: """This is a fairly common problem.""",
            kurdishText: """ئەمە کێشەیەکی تا ڕادەیەک باوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """It's fairly obvious what's going on here.""",
            kurdishText: """تا ڕادەیەک ئاشکرایە چی ڕوودەدات لێرە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I'm fairly certain I can do the job.""",
            kurdishText: """تا ڕادەیەک دڵنیام کە دەتوانم کارەکە بکەم.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He was fairly sure he was right.""",
            kurdishText: """تا ڕادەیەک دڵنیا بوو کە ڕاستی دەکرد.""",
            onPressedBritish: () => speaksentence6("en-GB"),
            onPressedAmerican: () => speaksentence6("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ھاوەڵکار) بەشێوەیەکی گونجاو و درووست"""),
          const DividerSentences(),
          SentencesRow(
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: fairly
1. To certain extent or degree (= reasonably, moderately, pretty [informal], jolly [Brit, informal], somewhat, middling, passably, middlingly, averagely)
"he is fairly clever with computers";

2. Without favouring one party, in a fair evenhanded manner (= fair, evenhandedly)
"deal fairly with one another";
 
3. In conformity with the rules or laws and without fraud or cheating (= fair, clean)
"they played fairly";
""",
  );
...
const double _startSecondsend = 0000000000000000000000000001037;
const String _videoIdone = 'https://youtu.be/QLq6GEiHqR8?t=';
const double _startSecondsone = 0000000000000000000000000001053;
const String _videoIdtwo = 'https://youtu.be/PkUg89kLLBE?t=';
const double _startSecondstwo = 0000000000000000000000000001027;
...
const String _videoIdfive = 'https://youtu.be/nGrB-5ieeMU?t=';
