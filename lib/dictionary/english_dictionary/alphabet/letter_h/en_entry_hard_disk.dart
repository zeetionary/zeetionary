...
class EnglishEntryharddisk extends StatefulWidget {
  const EnglishEntryharddisk({super.key});

  @override
  State<EnglishEntryharddisk> createState() => _EnglishEntryharddiskState();
}

class _EnglishEntryharddiskState extends State<EnglishEntryharddisk> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hard disk (Derived forms: hard disks)
1. A rigid magnetic disk mounted permanently in a drive unit (- hard disc, fixed disk)
""",
  );

  final String keyword = "hard disk";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hard disk""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The records will be stored on the computer's hard disk.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hard disk""",
                      // alsoEnglishWord: "also: hard disk",
                      britshText: """IpaUK: /ˈhɑːd dɪsk/""",
                      americanText: """IpaUS: /ˈhɑːrd dɪsk/""",
...
// کوردی:
// """),
// With short examples define "hard disk", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئامێرێک کە زانیاریی کۆمپیوتەر لەسەر پەپکێکی سووڕاوە کۆگا دەکات"""),
                    SentencesRow(
                      englishText:
