...
class EnglishEntrylearn extends StatefulWidget {
  const EnglishEntrylearn({super.key});

  @override
  State<EnglishEntrylearn> createState() => _EnglishEntrylearnState();
}

class _EnglishEntrylearnState extends State<EnglishEntrylearn> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: learn (Derived forms: learnt, learns, learning, learned)
1. Gain knowledge or skills (- larn, acquire)
"She learned dancing from her sister"; "I learned Sanskrit";
 
2. Get to know or become aware of, usually accidentally (- hear, get word, get wind, pick up, find out, get a line, discover, see)
"I learned that she has two grown-up children";
 
3. Commit to memory; learn by heart (- memorize, memorise [Brit], con [archaic])
"Have you learned your lines for the play yet?";
 
4. Be a student of a certain subject (- study, read, take)
 
5. Impart skills or knowledge to (- teach, instruct)
 
6. Find out, learn, or determine with certainty, usually by making an inquiry or other effort (- determine, check, find out, see, ascertain, watch)
"learn whether the train leaves on time";
""",
  );

  final String keyword = "learn";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He had the opportunity to learn English in Australia.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I learned a lot from my father.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Everyone in the class had the opportunity to learn from each other.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You can learn a great deal just from watching other players.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She's very keen to learn about Japanese culture.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The book is about how children learn.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She received no training but quickly learnt on the job.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Most people learn to read as children.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Today we learnt how to use the new software.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Students need to learn what to do in an emergency.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I learnt the poem by heart.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We have to learn one of Hamlet's speeches for school.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You'll have to learn your lines by next week.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Some people never learn, do they?""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'm sure she'll learn from her mistakes.""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Why do people so often fail to learn from experience?""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He’ll just have to learn (that) he can’t always have his own way.""");
  }
  ...
  Future<void> speaksentence18(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I soon learned not to ask too many questions.""");
  }
  ...
  Future<void> speaksentence19(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I first learnt of his death many years later.""");
  }
  ...
  Future<void> speaksentence20(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We only learned about the problems in May of this year.""");
  }
  ...
  Future<void> speaksentence21(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We were very surprised to learn (that) she had got married again.""");
  }
  ...
  Future<void> speaksentence22(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We only learned who the new teacher was a few days ago.""");
  }
  ...
  Future<void> speaksentence23(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How did they react when they learned the news?""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/Dvkydwf2Gj8?t=960';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/COFtvPVoPQ8?t=19';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/p9wrJJP68ps?t=210';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/sTPqfmOFgG0?t=114';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/jtoq3S48Pgk?t=748';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/H9rO5sKzOiQ?t=969';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """learn""",
                      // alsoEnglishWord: "also: learn",
                      britshText: """IpaUK: /lɜːn/""",
                      americanText: """IpaUS: /lɜːrn/""",
...
// کوردی: 
// """),
// With short examples define "learn", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) فێربوون"""),
                    SentencesRow(
                      englishText: """He had the opportunity to learn English in Australia.""",
                      kurdishText: """هەلی ئەوەی هەبوو لە ئوسترالیا ئینگلیزی فێر ببێت.""",
                    ...
                    children: [
                    SentencesRow(
                      englishText: """I learned a lot from my father.""",
                      kurdishText: """زۆر لە باوکمەوە فێربووم.""",
                    ...
                    SentencesRow(
                      englishText: """Everyone in the class had the opportunity to learn from each other.""",
                      kurdishText: """هەموان لە پۆلەکە هەلی ئەوەیان هەبوو لە یەکدییەوە شت فێر ببن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """You can learn a great deal just from watching other players.""",
                      kurdishText: """دەتوانیت زۆر فێر ببیت تەنها بە سەیرکردنی یاریزانەکانی دیکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She's very keen to learn about Japanese culture.""",
                      kurdishText: """زۆر تامەزرۆیە بۆ فێربوون لەسەر کەلتووری ژاپۆنی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The book is about how children learn.""",
                      kurdishText: """پەرتووکەکە لەسەر ئەوەیە منداڵان چۆن فێردەبن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She received no training but quickly learnt on the job (= while doing the job).""",
                      kurdishText: """هیچ ڕاهێنانی وەرنەگرت بەڵام زوو لەسەر کار فێربوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Most people learn to read as children.""",
                      kurdishText: """زۆر کەس فێری خوێندنەوە دەبن لە منداڵیدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Today we learnt how to use the new software.""",
                      kurdishText: """ئەمڕۆ فێردەبین چۆن نەرمامێرەکە بەکاربهێنین.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Students need to learn what to do in an emergency.""",
                      kurdishText: """خوێندکاران دەبێت فێر ببن لە دۆخی لەناکاودا چی بکەن.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) لەبەرکردن"""),
                    const AlsoEnglishckb(word: "ھەروەھا: memorize"),
                    SentencesRow(
                      englishText: """I learnt the poem by heart.""",
                      kurdishText: """هۆنراوەکە لە دڵەوە فێربووم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We have to learn one of Hamlet's speeches for school.""",
                      kurdishText: """دەبێت یەکێک لە وتەکانی هاملێت بۆ قوتابخانە لەبەر بکەین.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """You'll have to learn your lines by next week.""",
                      kurdishText: """تا هەفتەی داهاتوو دەبێت دێڕەکانی خۆت لەبەر بکەیت.""",
                      onPressedBritish: () => speaksentence13("en-GB"),
                      onPressedAmerican: () => speaksentence13("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) ئەوەی کەم کەم بۆچوونت لەسەر شتێک بگۆڕیت و بەشێوەیەکی جیاواز ڕەفتار بکەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Some people never learn, do they?""",
                      kurdishText: """هەندێک کەس هەرگیز فێرنابن، وانییە؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I'm sure she'll learn from her mistakes.""",
                      kurdishText: """دڵنیام لە هەڵەکانییەوە دێر دەبێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Why do people so often fail to learn from experience?""",
                      kurdishText: """بۆچی خەڵکی زۆرجار شکست دێنن لەوەی لە هەڵەکانیانەوە دێر ببن؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He’ll just have to learn (that) he can’t always have his own way.""",
                      kurdishText: """هەر ئەوەیە دەبێت فێر ببێت کە هەمیشە ناتوانێت ئەوەی بوێت کە دەیەوێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I soon learned not to ask too many questions.""",
                      kurdishText: """زوو فێربووم کە پرسیاری زۆر نەکەم.""",
                      onPressedBritish: () => speaksentence18("en-GB"),
                      onPressedAmerican: () => speaksentence18("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) ئەوەی لەسەر شتێک بزانیت بەوەی لە کەسێکی دیکەوە بیبیستیت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: discover"),
                    SentencesRow(
                      englishText: """I first learnt of his death many years later.""",
                      kurdishText: """یەکەم جار لەسەر مردنیم زانی لە دوای چەندین ساڵ.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We only learned about the problems in May of this year.""",
                      kurdishText: """تەنها لە ئایاری ئەمساڵدا لەسەر کێشەکانمان زانی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We were very surprised to learn (that) she had got married again.""",
                      kurdishText: """زۆر سەرسام بووین کە زانیمان دووبارە هاوسەرگیری کردووە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We only learned who the new teacher was a few days ago.""",
                      kurdishText: """تەنها چەند ڕۆژێک پێش ئێستا زانیمان مامۆستا تازەکە کێیە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """How did they react when they learned the news?""",
                      kurdishText: """کاردانەوەیان چی بوو کە هەواڵەکەیان بیست؟""",
