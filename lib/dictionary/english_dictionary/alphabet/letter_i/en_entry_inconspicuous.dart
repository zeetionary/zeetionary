...
class EnglishEntryinconspicuous extends StatefulWidget {
  const EnglishEntryinconspicuous({super.key});

  @override
  State<EnglishEntryinconspicuous> createState() => _EnglishEntryinconspicuousState();
}

class _EnglishEntryinconspicuousState extends State<EnglishEntryinconspicuous> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inconspicuous""");
  }
