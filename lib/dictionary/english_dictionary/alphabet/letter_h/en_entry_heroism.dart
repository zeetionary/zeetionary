...
class EnglishEntryheroism extends StatefulWidget {
  const EnglishEntryheroism({super.key});

  @override
  State<EnglishEntryheroism> createState() => _EnglishEntryheroismState();
}

class _EnglishEntryheroismState extends State<EnglishEntryheroism> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heroism (Derived forms: heroisms)
1. The qualities of a hero or heroine; exceptional or heroic courage when facing danger (especially in battle) (- gallantry, valor [US], valour [Brit, Cdn], valorousness, valiance, valiancy)
"he showed great heroism in battle";
""",
  );

  final String keyword = "heroism";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heroism""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The firefighters displayed both heroism and staunchness.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heroism""",
                      // alsoEnglishWord: "also: heroism",
                      britshText: """IpaUK: /ˈherəʊɪzəm/""",
                      americanText: """IpaUS: /ˈherəʊɪzəm/""",
...
کوردی: قارەمانی، قارەمانێتی، پاڵەوانی، ئازایەتی، نەبەزایەتی، شێرانەیی
"""),
// With short examples define "heroism", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) بوێری زۆر"""),
                    SentencesRow(
                      englishText:
                          """The firefighters displayed both heroism and staunchness.""",
                      kurdishText:
                          """ئاگرکوژێنەرەوەکان هەردوو پاڵەوانێتی و دڵسۆزییان پیشان دا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He showed great heroism in going back into the burning building.""",
                      kurdishText:
                          """پاڵەوانێتیی زۆری پیشاندا لە دووبارە گەڕانەوە بۆ ناو بینا سووتاوەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Eg08rJGKjtA?t=';
const double _startSecondsend = 000000000000000000000000000106;
const String _videoIdone = 'https://youtu.be/8tT3FhOA4-g?t=';
const double _startSecondsone = 000000000000000000000000000836;
const String _videoIdtwo = 'https://youtu.be/sQ0WsP7osAU?t=';
const double _startSecondstwo = 0000000000000000000000000002325;
const String _videoIdthree = 'https://youtu.be/IiyBo-qLDeM?t=';
const double _startSecondsthree = 0000000000000000000000000001289;
const String _videoIdfour = 'https://youtu.be/xE-qS1COcPw?t=';
const double _startSecondsfour = 000000000000000000000000000149;
const String _videoIdfive = 'https://youtu.be/Hzv8E3z1nx8?t=';
const double _startSecondsfive = 000000000000000000000000000307;
