...
class EnglishEntryetc extends StatefulWidget {
  const EnglishEntryetc({super.key});

  @override
  State<EnglishEntryetc> createState() => _EnglishEntryetcState();
}

class _EnglishEntryetcState extends State<EnglishEntryetc> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """etc.""",
                      // alsoEnglishWord: "also: etc.",
                      britshText: """IpaUK: /ˌet ˈsetərə/,  /ˌɪt ˈsetərə/""",
                      americanText: """IpaUS: /ˌet ˈsetərə/,  /ˌɪt ˈsetərə/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Remember to take some paper, a pen, etc.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We talked about the contract, pay, etc.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We saw lots of lions, tigers, elephants, etc.""");
  }
...
// With short examples define "etc.", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: و هتد، هەتا دوایی، و تاد، تا دوایی، و وەکوو ئەو، و ئەوانی تر، و شتەکانی هاوشێوەی تر
"""),
          const DefinitionKurdish(
              text:
                  """١. (کورتکراوە) لە لیستێکی بەکاردێت بۆ گوتنی ئەوەی شتی دیکە دەبوو کە دەتتوانی ناوی بهێنی"""),
          SentencesRow(
            englishText: """Remember to take some paper, a pen, etc.""",
            kurdishText: """بیرت بێت هەندێک کاغەز، پێنووس، هتد بێنیت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """We talked about the contract, pay, etc.""",
            kurdishText: """باسی ڕێکەوتنەکە، مووچە، هتد ـمان کرد.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """We saw lots of lions, tigers, elephants, etc.""",
            kurdishText: """ژمارەیەکی زۆر شێر، پڵنگ، فیل> هتد ـمان بینی.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Abbreviation: etc.
1. Continuing in the same way (= and so forth, and so on, etcetera, et cetera)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/dqcSk-EDrRo?t=';
const double _startSecondsend = 000000000000000000000000000000; // 408;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/khOUvmOQExc?t=';
const double _startSecondsone = 00000000000000000000000000000; // 233;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/WfVF-Ec4naQ?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 110;
const String _videoIdthree = 'VIDEOhttps://youtu.be/Ma0b6h4s5bY?t=';
const double _startSecondsthree = 000000000000000000000000000; // 104;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/cY4e0uvp7uI?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 45;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/ZQvfHyfgBtA?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 137;
