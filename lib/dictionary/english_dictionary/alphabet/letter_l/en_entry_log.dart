...
class EnglishEntrylog extends StatefulWidget {
  const EnglishEntrylog({super.key});

  @override
  State<EnglishEntrylog> createState() => _EnglishEntrylogState();
}

class _EnglishEntrylogState extends State<EnglishEntrylog> {
  @override
  void initState() {
    super.initState();
