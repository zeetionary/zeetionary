...
class EnglishEntryinsistent extends StatefulWidget {
  const EnglishEntryinsistent({super.key});

  @override
  State<EnglishEntryinsistent> createState() => _EnglishEntryinsistentState();
}

class _EnglishEntryinsistentState extends State<EnglishEntryinsistent> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insistent""");
  }
