...
class EnglishEntryaccommodating extends StatefulWidget {
  const EnglishEntryaccommodating({super.key});

  @override
  State<EnglishEntryaccommodating> createState() => _EnglishEntryaccommodatingState();
}

class _EnglishEntryaccommodatingState extends State<EnglishEntryaccommodating> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "accommodating";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accommodating""",
                      // alsoEnglishWord: "also: accommodating",
                      britshText: """IpaUK: /əˈkɒmədeɪtɪŋ/""",
                      americanText: """IpaUS: /əˈkɒmədeɪtɪŋ/""",
