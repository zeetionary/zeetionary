...
class EnglishEntryflorid extends StatefulWidget {
  const EnglishEntryflorid({super.key});

  @override
  State<EnglishEntryflorid> createState() => _EnglishEntryfloridState();
}

class _EnglishEntryfloridState extends State<EnglishEntryflorid> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: florid
1. Elaborately or excessively ornamented (= aureate, flamboyant)
"the senator's florid speech";
 
2. Inclined to a healthy reddish colour often associated with outdoor life (= rubicund, ruddy, sanguine)
"Santa's florid cheeks";
""",
  );

  final String keyword = "florid";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Her florid complexion was a result of spending the day in the sun.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """florid""",
                      // alsoEnglishWord: "also: florid",
                      britshText: """IpaUK: /ˈflɒrɪd/""",
                      americanText: """IpaUS: /ˈflɔːrɪd/""",
...
کوردی: ڕازاوە، پرنەخش‌ونیگار، ڕەنگاوڕەنگ،	سوورهەڵگەڕاو، سوور، سوورەوەبوو
"""),
// With short examples define "florid", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Her florid complexion was a result of spending the day in the sun.""",
                      kurdishText:
                          """ڕەنگی سووری ڕوخساری ئەنجامی ئەوە بوو کە ڕۆژەکەی لە بەر خۆردا بەسەر بردبوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The author's writing style is known for its use of florid language.""",
                      kurdishText:
                          """شێوازی نووسینی نووسەرەکە بە بەکارهێنانی زمانێکی ئاڵۆز ناسراوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Hw1X5oFPgro?t=';
const double _startSecondsend = 0000000000000000000000000001830;
const String _videoIdone = 'https://youtu.be/Udk8YHOy0EU?t=';
const double _startSecondsone = 000000000000000000000000000494;
const String _videoIdtwo = 'https://youtu.be/AXSoQ_UKWyg?t=';
const double _startSecondstwo = 000000000000000000000000000401;
const String _videoIdthree = 'https://youtu.be/nEnklxGAmak?t=';
const double _startSecondsthree = 0000000000000000000000000002059;
const String _videoIdfour = 'https://youtu.be/-sLtporEeYw?t=';
const double _startSecondsfour = 0000000000000000000000000002798;
const String _videoIdfive = 'https://youtu.be/zaydSF_0zng?t=';
const double _startSecondsfive = 000000000000000000000000000821;
