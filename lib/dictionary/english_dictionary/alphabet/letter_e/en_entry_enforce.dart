...
class EnglishEntryenforce extends StatefulWidget {
  const EnglishEntryenforce({super.key});

  @override
  State<EnglishEntryenforce> createState() => _EnglishEntryenforceState();
}

class _EnglishEntryenforceState extends State<EnglishEntryenforce> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enforce""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enforce""",
                      // alsoEnglishWord: "also: enforce",
                      britshText: """IpaUK: /ɪnˈfɔːs/""",
                      americanText: """IpaUS: /ɪnˈfɔːrs/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The legislation will be difficult to enforce.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""United Nations troops enforced a ceasefire in the area.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The rules were strictly enforced.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) دڵنیایی کردنەوەی ئەوەی کە خەڵکی پابەندی یاسایەک دەبن"""),
          SentencesRow(
            englishText: """The legislation will be difficult to enforce.""",
            kurdishText: """یاساکە سەخت دەبێت جێبەجێ بکرێت.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """هێزەکانی نەتەوە یەکگرتووەکان ئاگربەستیان لە ناوچەکەدا سەپاند.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The rules were strictly enforced.""",
            kurdishText: """یاساکان بەتوندی جێبەجێ کران.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ناتوانیت هەماهەنگی نێوان دوو یاریزان بسەپێنیت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: enforce (Derived forms: enforcing, enforces, enforced)
1. Ensure observance of laws and rules (= implement, apply)
 
2. Compel to behave in a certain way (= impose, constrain)
"Social relations enforce courtesy";
""",
  );
...
const String _videoIdone = 'https://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondsone = 4697;
const String _videoIdtwo = 'https://youtu.be/G0SpzIIHEaE?t=';
const double _startSecondstwo = 267;
const String _videoIdthree = 'https://youtu.be/tFSgH_cUm2E?t=';
const double _startSecondsthree = 329;
const String _videoIdfour = 'https://youtu.be/7eM7pb5M5DU?t=';
const double _startSecondsfour = 1099;
const String _videoIdfive = 'https://youtu.be/0sazcZ8wwZc?t=';
const double _startSecondsfive = 219;
const String _videoIdsix = 'https://youtu.be/EDx5OFOiQ-I?t=';
const double _startSecondssix = 196;
