...
class EnglishEntryfreighter extends StatefulWidget {
  const EnglishEntryfreighter({super.key});

  @override
  State<EnglishEntryfreighter> createState() => _EnglishEntryfreighterState();
}

class _EnglishEntryfreighterState extends State<EnglishEntryfreighter> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: freighter (Derived forms: freighters)
1. A cargo ship (= bottom, merchantman, merchant ship)
"they did much of their overseas trade in foreign freighters";
""",
  );

  final String keyword = "freighter";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""freighter""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They loaded the freighter with grain for export.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """freighter""",
                      // alsoEnglishWord: "also: freighter",
                      britshText: """IpaUK: /ˈfreɪtə(r)/""",
                      americanText: """IpaUS: /ˈfreɪtər/""",
...
// کوردی: بارهەڵگر (کەشتی یا فڕۆکە)،	بارلێنەر، بارچی
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەشتی یان فڕۆکەیەکی گەورە کە کەلوپەل دەگوازێتەوە"""),
                    SentencesRow(
                      englishText:
                          """They loaded the freighter with grain for export.""",
                      kurdishText:
                          """بەرهەڵگرەکەیان پڕکرد لە گەنم بۆ هەناردە.""",
...
const double _startSecondsend = 000000000000000000000000000906;
const String _videoIdone = 'https://youtu.be/F6R_WTDdx7I?t=';
const double _startSecondsone = 000000000000000000000000000685;
const String _videoIdtwo = 'https://youtu.be/Z9l7aWpqkko?t=';
const double _startSecondstwo = 00000000000000000000000000078;
const String _videoIdthree = 'https://youtu.be/mXpwgg5TxOU?t=';
const double _startSecondsthree = 000000000000000000000000000159;
const String _videoIdfour = 'https://youtu.be/CRmsNf4sWks?t=';
const double _startSecondsfour = 000000000000000000000000000932;
const String _videoIdfive = 'https://youtu.be/ZjBgEkbnX2I?t=';
