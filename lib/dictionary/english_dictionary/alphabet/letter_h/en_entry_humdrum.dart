...
class EnglishEntryhumdrum extends StatefulWidget {
  const EnglishEntryhumdrum({super.key});

  @override
  State<EnglishEntryhumdrum> createState() => _EnglishEntryhumdrumState();
}

class _EnglishEntryhumdrumState extends State<EnglishEntryhumdrum> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: humdrum 
1. Not challenging; dull and lacking excitement (- commonplace, prosaic, unglamorous, unglamourous [Brit, non-standard], mundane)
 
2. Tediously repetitious or lacking in variety (- monotonous)
"a humdrum existence; all work and no play";

- Noun: humdrum (Derived forms: humdrums)
1. The quality of wearisome constancy, routine, and lack of variety (- monotony, sameness)
"he was sick of the humdrum of his fellow prisoners";
""",
  );

  final String keyword = "humdrum";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""humdrum""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""There is a lot of dull, humdrum work in politics.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Zo7sRijXG00?t=';
    const double startSecondsend = 000000000000000000000000000595;
    const String videoIdone = 'https://youtu.be/1eYZnCx-02g?t=';
    const double startSecondsone = 000000000000000000000000000381;
    const String videoIdtwo = 'https://youtu.be/4E793WS72aU?t=';
    const double startSecondstwo = 000000000000000000000000000716;
    const String videoIdthree = 'https://youtu.be/_OpC4fH3mEk?t=';
    const double startSecondsthree = 000000000000000000000000000437;
    const String videoIdfour = 'https://youtu.be/uX_uwG9jQ-8?t=';
    const double startSecondsfour = 000000000000000000000000000117;
    const String videoIdfive = 'https://youtu.be/9a6P8f4zUuY?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """humdrum""",
                      // alsoEnglishWord: "also: humdrum",
                      britshText: """IpaUK: /ˈhʌmdrʌm/""",
                      americanText: """IpaUS: /ˈhʌmdrʌm/""",
...
// With short examples define "humdrum", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """There is a lot of dull, humdrum work in politics.""",
                      kurdishText:
                          """زۆر کاری بێزارکەر و دووبارە هەن لە سیاسەتدا.""",
