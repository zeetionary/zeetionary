...
کوردی: قارەمان، پاڵەوان، نەبەرد، کەوان، دەسکەڵا، قارەمانی چیرۆک، هەڵبەست، شانۆنامە، فیلم، کتێب و هتد
"""),
// With short examples define "hero", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """A statue was erected to glorify the country's national heroes.""",
                      kurdishText:
                          """مات براونی گەنج بە پاڵەوانێک ناودەهێندرێت بۆ ڕزگارکردنی منداڵێک لە خنکان.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) کارەکتەری سەرەکی فیلمێک، ڕۆمانێک، چیرۆکێک، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Our handsome hero manages to dispatch another five villains.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) کەسێک کە سەرسامییت بەهۆی خاسیەت یان شارەزایەک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He became a hero to millions for his decision to oppose the government's reforms.""",
...
const double _startSecondsend = 0000000000000000000000000001285;
const String _videoIdone = 'https://youtu.be/544DTGHIBM0?t=';
const double _startSecondsone = 000000000000000000000000000758;
const String _videoIdtwo = 'https://youtu.be/slmYnJdDQ1U?t=';
const double _startSecondstwo = 000000000000000000000000000228;
const String _videoIdthree = 'https://youtu.be/XrTDwpLECtA?t=';
const double _startSecondsthree = 000000000000000000000000000188;
const String _videoIdfour = 'https://youtu.be/Y5F_ha7d-PI?t=';
const double _startSecondsfour = 000000000000000000000000000746;
const String _videoIdfive = 'https://youtu.be/nMPCXuvL8EM?t=';
