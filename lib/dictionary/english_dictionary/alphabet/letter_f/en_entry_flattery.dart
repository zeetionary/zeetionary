...
class EnglishEntryflattery extends StatefulWidget {
  const EnglishEntryflattery({super.key});

  @override
  State<EnglishEntryflattery> createState() => _EnglishEntryflatteryState();
}

class _EnglishEntryflatteryState extends State<EnglishEntryflattery> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flattery (Derived forms: flatteries)
1. Excessive or insincere praise
"sick to death of flattery"
""",
  );

  final String keyword = "flattery";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flattery""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""You're too intelligent to fall for his flattery.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flattery""",
                      // alsoEnglishWord: "also: flattery",
                      britshText: """IpaUK: /ˈflætəri/""",
                      americanText: """IpaUS: /ˈflætəri/""",
...
// With short examples define "flattery", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ستایشی ناڕاست، زۆرجار بۆ بەدەستهێنانی شتێک"""),
                    SentencesRow(
                      englishText:
                          """You're too intelligent to fall for his flattery.""",
                      kurdishText:
                          """زیرەکتر لەوەیت تێ بکەویت بۆ زمان‌لووسییەکەی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Salespeople are often accused of using artificial flattery.""",
                      kurdishText:
                          """فرۆشیاران زۆرجار تۆمەتبار دەکرێن بۆ بەکارهێنانی زمان‌لووسیی دەستکرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/cxJdKLLEluc?t=';
const double _startSecondsend = 000000000000000000000000000407;
const String _videoIdone = 'https://youtu.be/NA3z2_nFxtw?t=';
const double _startSecondsone = 0000000000000000000000000004;
const String _videoIdtwo = 'https://youtu.be/lBOCzPSgieU?t=';
const double _startSecondstwo = 000000000000000000000000000645;
const String _videoIdthree = 'https://youtu.be/3pfIEgPg4aI?t=';
const double _startSecondsthree = 0000000000000000000000000001503;
const String _videoIdfour = 'https://youtu.be/6MHepIWVzIo?t=';
const double _startSecondsfour = 000000000000000000000000000565;
const String _videoIdfive = 'https://youtu.be/G-2ISN5u4Pg?t=';
