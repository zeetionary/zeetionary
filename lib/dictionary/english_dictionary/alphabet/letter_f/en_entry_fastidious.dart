...
class EnglishEntryfastidious extends StatefulWidget {
  const EnglishEntryfastidious({super.key});

  @override
  State<EnglishEntryfastidious> createState() => _EnglishEntryfastidiousState();
}

class _EnglishEntryfastidiousState extends State<EnglishEntryfastidious> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fastidious""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fastidious""",
                      // alsoEnglishWord: "also: fastidious",
                      britshText: """IpaUK: /fæˈstɪdiəs/""",
                      americanText: """IpaUS: /fæˈstɪdiəs/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "fastidious";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Everything was planned in fastidious detail.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He was fastidious in his preparation for the big day.""");
  }
...
کوردی: سەختگر، بەهانەگر، بەسەرنج، ورد، دێرپەسند، درەنگ‌هەڵبژێر، عەیب‌گر
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) وریا لەوەی کە هەر وردەکارییەک درووستە"""),
          SentencesRow(
            englishText: """Everything was planned in fastidious detail.""",
            kurdishText: """هەموو شتێک بە وریایی ورد پلانی بۆ دانرا.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ورد بوو لە ئامادەکارییەکەی بۆ ڕۆژە گەورەکە.""",
          ...
          SentencesRow(
            englishText:
                """The child seemed fastidious about getting her fingers dirty.""",
            kurdishText:
                """منداڵەکە بەدڵەڕاوکێ بوو لەسەر پیسبوونی پەنجەکانی.""",
...
2. (microbiology) having complicated nutritional requirements; especially growing only in special artificial cultures (= exacting)
...
const String _videoIdend = 'https://youtu.be/wv43IN_cnyw?t=';
const double _startSecondsend = 00000000000000000000000000056;
const String _videoIdone = 'https://youtu.be/bOieHHnaDVI?t=';
const double _startSecondsone = 00000000000000000000000000072;
const String _videoIdtwo = 'https://youtu.be/3vgC7CFbSW0?t=';
const double _startSecondstwo = 000000000000000000000000000420;
const String _videoIdthree = 'https://youtu.be/cpriXP451ys?t=';
const double _startSecondsthree = 0000000000000000000000000001061;
const String _videoIdfour = 'https://youtu.be/Np0hJGKrIWg?t=';
const double _startSecondsfour = 000000000000000000000000000105;
const String _videoIdfive = 'https://youtu.be/fQxiX5JZH6U?t=';
const double _startSecondsfive = 000000000000000000000000000987;
