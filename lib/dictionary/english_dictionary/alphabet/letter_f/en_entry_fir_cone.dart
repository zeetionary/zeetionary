...
class EnglishEntryfircone extends StatefulWidget {
  const EnglishEntryfircone({super.key});

  @override
  State<EnglishEntryfircone> createState() => _EnglishEntryfirconeState();
}

class _EnglishEntryfirconeState extends State<EnglishEntryfircone> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fir cone (Derived forms: fir cones)
1. The seed-producing cone of a fir tree
""",
  );

  final String keyword = "fir cone";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fir cone""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fir cone fell from the tree.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fir cone""",
                      // alsoEnglishWord: "also: fir cone",
                      britshText: """IpaUK: /ˈfɜː kəʊn/""",
                      americanText: """IpaUS: /ˈfɜːr kəʊn/""",
...
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) میوەی ڕەقی دار سنەوبەر"""),
                    SentencesRow(
                      englishText: """The fir cone fell from the tree.""",
                      kurdishText: """میوەی سنەوبەرەکە لە دارەکە کەوت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/EM81V9sgdos?t=';
const double _startSecondsend = 000000000000000000000000000557;
const String _videoIdone = 'https://youtu.be/QsQIBIuOVYw?t=';
const double _startSecondsone = 0000000000000000000000000009;
const String _videoIdtwo = 'https://youtu.be/Br5BNDtxeBk?t=';
const double _startSecondstwo = 000000000000000000000000000755;
const String _videoIdthree = 'https://youtu.be/ze8PGWQg300?t=';
const double _startSecondsthree = 0000000000000000000000000009;
const String _videoIdfour = 'https://youtu.be/c7tBUMFtPtU?t=';
const double _startSecondsfour = 000000000000000000000000000486;
const String _videoIdfive = 'https://youtu.be/rPLvj-GcfSU?t=';
const double _startSecondsfive = 000000000000000000000000000957;
