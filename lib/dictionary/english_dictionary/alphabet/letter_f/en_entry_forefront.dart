...
class EnglishEntryforefront extends StatefulWidget {
  const EnglishEntryforefront({super.key});

  @override
  State<EnglishEntryforefront> createState() => _EnglishEntryforefrontState();
}

class _EnglishEntryforefrontState extends State<EnglishEntryforefront> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forefront (Derived forms: forefronts)
1. The part in the front or nearest the viewer (= head)
"he was in the forefront";
 
2. The position of greatest importance or advancement; the leading position in any movement or field (= vanguard, cutting edge)
"the idea of motion was always to the forefront of his mind and central to his philosophy"; "the Cotswolds were once at the forefront of woollen manufacturing in England";
""",
  );

  final String keyword = "forefront";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forefront""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Women have always been at the forefront of the movement.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forefront""",
                      // alsoEnglishWord: "also: forefront",
                      britshText: """IpaUK: /ˈfɔːfrʌnt/""",
                      americanText: """IpaUS: /ˈfɔːrfrʌnt/""",
...
کوردی: ڕیزی پێشەوە، پێش‌ڕێز، هێڵی پێشەوە،	لەپێشەوە، لەپێش
"""),
// With short examples define "forefront", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Women have always been at the forefront of the movement.""",
                      kurdishText:
                          """ژنان هەمیشە لە بەرەی پێشەوەی بزووتنەوەکە بوونە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """This latest protest has brought prison conditions to the forefront of public attention.""",
                      kurdishText:
                          """ئەم خۆپیشاندانەی کۆتایی دۆخی زیندانەکانی هێناوەتە بەر سەرنجی گشتی.""",
...
const double _startSecondsend = 000000000000000000000000000862;
const String _videoIdone = 'https://youtu.be/ea4Tq7HB7kU?t=';
const double _startSecondsone = 000000000000000000000000000134;
const String _videoIdtwo = 'https://youtu.be/3KC32Vymo0Q?t=';
const double _startSecondstwo = 0000000000000000000000000001659;
const String _videoIdthree = 'https://youtu.be/hGLY5MAAFO4?t=';
const double _startSecondsthree = 0000000000000000000000000001212;
const String _videoIdfour = 'https://youtu.be/vIz9lgLjZtY?t=';
const double _startSecondsfour = 000000000000000000000000000233;
const String _videoIdfive = 'https://youtu.be/qURmdmgCCOI?t=';
