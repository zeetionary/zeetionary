...
class EnglishEntryinconsiderate extends StatefulWidget {
  const EnglishEntryinconsiderate({super.key});

  @override
  State<EnglishEntryinconsiderate> createState() =>
      _EnglishEntryinconsiderateState();
}

class _EnglishEntryinconsiderateState extends State<EnglishEntryinconsiderate> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inconsiderate""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'k9jnxvtJ-34';
    const double startSecondsend = 684;
    const String videoIdone = 'Uhh_An7FGek';
    const double startSecondsone = 1023;
    const String videoIdtwo = 'm0aG6urHpSI';
    const double startSecondstwo = 339;
    const String videoIdthree = 'OFMCW2uP3rc';
    const double startSecondsthree = 80;
    const String videoIdfour = 'nDEyQB0Jjkw';
    const double startSecondsfour = 1921;
    const String videoIdfive = 'PBUWzTESAKI';
