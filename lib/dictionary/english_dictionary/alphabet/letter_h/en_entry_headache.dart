...
class EnglishEntryheadache extends StatefulWidget {
  const EnglishEntryheadache({super.key});

  @override
  State<EnglishEntryheadache> createState() => _EnglishEntryheadacheState();
}

class _EnglishEntryheadacheState extends State<EnglishEntryheadache> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: headache (Derived forms: head aches, headaches)
1. Something or someone that causes anxiety; a source of unhappiness (- concern, worry, vexation)
"New York traffic is a constant headache";
 
2. Pain in the head caused by dilation of cerebral arteries or muscle contractions or a reaction to drugs (- head ache, cephalalgia)
""",
  );

  final String keyword = "headache";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""headache""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He suffered from headaches and loss of appetite.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Take two aspirin(s) for a headache.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He complained of headaches and dizziness.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """headache""",
                      // alsoEnglishWord: "also: headache",
                      britshText: """IpaUK: /ˈhedeɪk/""",
                      americanText: """IpaUS: /ˈhedeɪk/""",
...
کوردی: ژانەسەر، سەرێشە، سەرئێشە، سەرئاسێ
"""),
// With short examples define "headache", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) ئازاری بەردەوام لە سەر بۆ ماوەیەک"""),
                    SentencesRow(
                      englishText:
                    ...
                    const DefinitionKurdish(
                        text: """٢. (ناو) شتێک کە کێشەت بۆ درووست دەکات"""),
                    SentencesRow(
                      englishText:
                          """The real headache will be getting the bank to lend you the money.""",
                      kurdishText:
                          """کێشەی ڕاستی ئەوە دەبێت بانکەکە ڕازی بکەیت پارەکەت بە قەرز پێبدات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/lYu1ysDULwA?t=';
const double _startSecondsend = 000000000000000000000000000953;
const String _videoIdone = 'https://youtu.be/nyf7wNn5fw8?t=';
const double _startSecondsone = 00000000000000000000000000016;
const String _videoIdtwo = 'https://youtu.be/s3B-qp3U5G0?t=';
const double _startSecondstwo = 0000000000000000000000000001629;
const String _videoIdthree = 'https://youtu.be/b1reY72ktEc?t=';
const double _startSecondsthree = 0000000000000000000000000001262;
const String _videoIdfour = 'https://youtu.be/EtgxTKuN018?t=';
const double _startSecondsfour = 000000000000000000000000000262;
const String _videoIdfive = 'https://youtu.be/gjySnrspD7E?t=';
const double _startSecondsfive = 0000000000000000000000000002519;
