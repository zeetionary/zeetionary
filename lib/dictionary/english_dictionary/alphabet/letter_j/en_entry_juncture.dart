...
class EnglishEntryjuncture extends StatefulWidget {
  const EnglishEntryjuncture({super.key});

  @override
  State<EnglishEntryjuncture> createState() => _EnglishEntryjunctureState();
}

class _EnglishEntryjunctureState extends State<EnglishEntryjuncture> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""juncture""");
  }
