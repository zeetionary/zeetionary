...
class EnglishEntryenter extends StatefulWidget {
  const EnglishEntryenter({super.key});

  @override
  State<EnglishEntryenter> createState() => _EnglishEntryenterState();
}

class _EnglishEntryenterState extends State<EnglishEntryenter> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enter""",
                      // alsoEnglishWord: "also: enter",
                      britshText: """IpaUK: /ˈentə(r)/""",
                      americanText: """IpaUS: /ˈentər/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Knock before you enter.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Someone entered the room behind me.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Where did the bullet enter the body?""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He stood back to allow us to enter.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He was refused permission to enter the country.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The dancers entered from the side of the stage.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Over a thousand children entered the competition.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her mum entered her in the baby contest.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""How many students have been entered for the exam?""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Several new firms have now entered the market.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The US entered the war in 1917.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He did not wish to enter the Church like his brothers.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I entered politics late in life.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She entered college in 2006.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""You may need to enter this information manually.""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Your details have been entered in our database.""");
  }
...
کوردی: 
"""),
          const DefinitionKurdish(text: """١. (کردار) چوونە شوێنێک"""),
          SentencesRow(
            englishText: """Knock before you enter.""",
            kurdishText: """لە دەرگا بدە پێش ئەوەی بچیتە ژوورەوە.""",
          ...
          Column(
            children: [
              MyExpansionTile(
                children: [
                  SentencesRow(
                    englishText: """Someone entered the room behind me.""",
                    kurdishText: """کەسێک هاتە ژوورەکەوە لە دوامەوە.""",
                  ...
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """Where did the bullet enter the body?""",
                    kurdishText: """لە کوێوە فیشەکەەک چووە لاشەکەوە.""",
                  ...
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """He stood back to allow us to enter.""",
                    kurdishText:
                        """چووە دواوە تا ڕێگامان پێ بدەن بچینە ژوورەوە.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText: """مۆڵەتی پێ‌نەدرا بچێتە وڵاتەکەوە.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """سەماکارەکان لە قەراغی سەکۆکەوە هاتنە سەرەوە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) ناونووسین بۆ تاقیکردنەوەیەک. پێشبڕکێیەک، هتد"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Over a thousand children entered the competition.""",
            kurdishText: """زیاتر لە ١٠٠٠ منداڵ بەژداری پێشبڕکێیەکە بوون.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Her mum entered her in the baby contest.""",
            kurdishText: """دایکی خستییە پێشبڕکێی منداڵەکانەوە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """چەند خوێندکار خراونەتە تاقیکردنەوەکەوە؟""",
          ...
          const DefinitionKurdish(
              text:
                  """٣. (کردار) دەستپێکردن یان بەژداربوون لە چالاکییەک، دۆخێک، هتد"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Several new firms have now entered the market.""",
            kurdishText:
                """ژمارەیەک کۆمپانیای تازە ئێستا هاتوونەتە بازاڕەکەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The US entered the war in 1917.""",
            kurdishText: """ئەمریکا لە ساڵی ١٩١٧ تێوەگلا لە جەنگەکەوە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """نەیویست ببێت بە ئەندامی کڵێساکە وەک براکانی.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I entered politics late in life.""",
            kurdishText: """لە کۆتاییەکانی ژیاندا چوومە سیاسەتەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She entered college in 2006.""",
            kurdishText: """ساڵی ٢٠٠٦ چووە کۆلێژ.""",
          ...
          const DefinitionKurdish(
              text:
                  """٦. (کردار) دانانی ناو، ژمارە، وردەکاری، هتد لە لیست، کتێب، کۆمپیوتەر"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """You may need to enter this information manually.""",
            kurdishText:
                """ڕەنگە پێویست بکات ئەم زانیارییانە خۆکارانە بنووسیت.""",
          ...
          SentencesRow(
            englishText:
                """Please enter all your personal details on the form provided.""",
            kurdishText:
                """تکایە هەموو زانیارییە کەسییەکانت لەو فۆرمە بنووسە کە دابینکراوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Your details have been entered in our database.""",
            kurdishText: """زانیارییەکانت لە داتابەیسەکەمان نووسراوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: enter (Derived forms: enters, entered, entering)
1. To come or go into (= come in, get into, get in, go into, go in, move into)
"the boat entered an area of shallow marshes";
 
2. Become a participant; be involved in (= participate)
"enter a race"; "enter an agreement"; "enter a drug treatment program"; "enter negotiations";
 
3. Register formally as a participant or member (= enroll [N. Amer], inscribe, enrol [Brit, Cdn], recruit)
 
4. Be or play a part of or in (= figure)
"Elections enter prominently in every government program";
 
5. Make a record of; set down in permanent form (= record, put down)
 
6. (dramaturgy) come on stage
 
7. Take on duties or office (= accede)
"enter to the throne";
 
8. Place onto or put into something (= insert, infix, introduce)
"enter a picture into the text";
 
9. Set out on (an enterprise or subject of study) (= embark)
"she entered upon a new career";

- Noun: enter (Derived forms: enters)
1. The key on a computer keyboard that starts a new line when writing text; in other contexts the key usually causes a form or window to perform a default function, e.g. accept the data that has just been input (= return key, return, enter key)
""",
  );
...
const double _startSecondsend = 545;
const String _videoIdone = 'https://youtu.be/hFZFjoX2cGg?t=';
const double _startSecondsone = 878;
const String _videoIdtwo = 'https://youtu.be/MnExgQ81fhU?t=';
const double _startSecondstwo = 63;
const String _videoIdthree = 'https://youtu.be/zqllxbPWKNI?t=';
const double _startSecondsthree = 678;
const String _videoIdfour = 'https://youtu.be/NFtQOxjWfaA?t=';
const double _startSecondsfour = 11;
const String _videoIdfive = 'https://youtu.be/h0IPcqF2q9U?t=';
const double _startSecondsfive = 1065;
const String _videoIdsix = 'https://youtu.be/EHJNGdFll4o?t=';
const double _startSecondssix = 6;
