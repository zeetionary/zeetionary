...
class EnglishEntryfondly extends StatefulWidget {
  const EnglishEntryfondly({super.key});

  @override
  State<EnglishEntryfondly> createState() => _EnglishEntryfondlyState();
}

class _EnglishEntryfondlyState extends State<EnglishEntryfondly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: fondly
1. With fondness; with love (= lovingly)
"she spoke to her children fondly";
""",
  );

  final String keyword = "fondly";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He looked at her fondly.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I fondly remember my first job as a reporter.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I fondly imagined that you cared for me.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fondly""",
                      // alsoEnglishWord: "also: fondly",
                      britshText: """IpaUK: /ˈfɒndli/""",
                      americanText: """IpaUS: /ˈfɑːndli/""",
...
// With short examples define "fondly", please follow LX instructions
                    ...
                    AlsoEnglishckblink(
                      ...
                      linkText: "affectionately",
                      textAfterLink: ".",
                      onTap: () {
                        Routemaster.of(context)
                            .push("/english-fondly/affectionately");
                      },
                    ),
                    SentencesRow(
                      englishText: """He looked at her fondly.""",
                      kurdishText: """بە خۆشەویستییەوە لێی دەڕوانی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە خۆشەوسیتییەوە یەکەم کارمم وەک پەیامنێر بیردێتەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بەشێوەیەک کە هیوایەک پیشان دەدات کە ئەگەری کەمە بێتە دی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I fondly imagined that you cared for me.""",
                      kurdishText:
                          """هیوابڕاوانە خەیاڵی ئەوەم دەکرد کە گرنگیم پێ دەدەیت.""",
                      englishNote:
                          """This means that I believed, with affection and hope, that you had feelings for me, but this belief was likely mistaken or unrealistic.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/v4r71kEdYME?t=';
const double _startSecondsend = 000000000000000000000000000763;
const String _videoIdone = 'https://youtu.be/uBQJ9iYUgoU?t=';
const double _startSecondsone = 000000000000000000000000000109;
const String _videoIdtwo = 'https://youtu.be/b5ADlXlYaM8?t=';
const double _startSecondstwo = 000000000000000000000000000432;
const String _videoIdthree = 'https://youtu.be/VS0oPwb3sag?t=';
const double _startSecondsthree = 0000000000000000000000000001265;
const String _videoIdfour = 'https://youtu.be/5jjdErDkDZE?t=';
const double _startSecondsfour = 000000000000000000000000000534;
const String _videoIdfive = 'https://youtu.be/s_v-nRbvtqE?t=';
