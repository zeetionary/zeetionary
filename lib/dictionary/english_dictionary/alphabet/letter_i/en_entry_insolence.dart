...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'ijKAtzQY1wc';
    const double startSecondsend = 2;
    const String videoIdone = 'CwlTFQqdI3I';
    const double startSecondsone = 154;
    const String videoIdtwo = 'rGFmEJcTwwQ';
    const double startSecondstwo = 529;
    const String videoIdthree = '7WEGIDZGZas';
    const double startSecondsthree = 67;
    const String videoIdfour = 'Nt4kCgt_Kj4';
    const double startSecondsfour = 626;
    const String videoIdfive = '3V-dmbxWcz4';
    const double startSecondsfive = 5805;
