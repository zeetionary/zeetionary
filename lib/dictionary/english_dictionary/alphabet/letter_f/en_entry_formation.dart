...
class EnglishEntryformation extends StatefulWidget {
  const EnglishEntryformation({super.key});

  @override
  State<EnglishEntryformation> createState() => _EnglishEntryformationState();
}

class _EnglishEntryformationState extends State<EnglishEntryformation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: formation (Derived forms: formations)
...
3. The act of forming or establishing something (= constitution, establishment, organization, organisation [Brit])
 
4. (geology) the geological features of the earth (= geological formation)
...
""",
  ...
  final String keyword = "formation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""formation""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The troops advanced in battle formation.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The team usually plays in a 4-4-2 formation.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """formation""",
                      // alsoEnglishWord: "also: formation",
                      britshText: """IpaUK: /fɔːˈmeɪʃn/""",
                      americanText: """IpaUS: /fɔːrˈmeɪʃn/""",
...
کوردی: پێکهێنان، گووران، دروس‌بوون، چێ‌بوون، ڕسکان، بن‌گیری، بن‌گیربوون، دامەزران، دامەزراندن، پێکهاتن، بنیات‌نان، دروست‌کردن، پێکەوەنان، ڕۆنان، داڕشتن، سازدانم	شێوە، بیچم،	ڕێکخستن،	(زەوی‌ناسی) چین‌چین‌بوون، چین‌بەندی، چینێتی
"""),
// With short examples define "formation", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) پێکهێنانی شتێک"""),
                    SentencesRow(
                      englishText:
                          """This dispute led to the formation of a new breakaway group.""",
                      kurdishText:
                          """ئەم ناکۆکییە بوو بە هۆکاری پێکهێنانی گرووپێکی دابڕاوی تازە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) شتێک کە پێکهێنراوە، بە تایبەتی لە شوێنێکی دیاریکراو یان بە شێوەیەکی دیاریکراو"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Massive rock formations rise some 1 500 feet above the canyon floor.""",
                      kurdishText:
                          """پێکهاتە بەردینە زەبەلاحەکان نزیکەی ١٥٠٠ پێ لە سەرووی بنی دۆڵەکەوە بەرز دەبنەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هێزەکان بۆ پێشەوە چوون بە ڕێکخستنی جەنگی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تیمەکە زۆرجار بە ڕێکخستنی ٤-٤-٢ یاری دەکات.""",
...
const double _startSecondsend = 0000000000000000000000000001154;
const String _videoIdone = 'https://youtu.be/yRmOWcWdQAo?t=';
const double _startSecondsone = 0000000000000000000000000001573;
const String _videoIdtwo = 'https://youtu.be/b1reY72ktEc?t=';
const double _startSecondstwo = 000000000000000000000000000400;
const String _videoIdthree = 'https://youtu.be/X3TAROotFfM?t=';
const double _startSecondsthree = 000000000000000000000000000703;
const String _videoIdfour = 'https://youtu.be/ao2Jfm35XeE?t=';
const double _startSecondsfour = 000000000000000000000000000766;
const String _videoIdfive = 'https://youtu.be/hSmNg2WGXeQ?t=';
