...
class EnglishEntryenabled extends StatefulWidget {
  const EnglishEntryenabled({super.key});

  @override
  State<EnglishEntryenabled> createState() => _EnglishEntryenabledState();
}

class _EnglishEntryenabledState extends State<EnglishEntryenabled> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("-enabled");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "-enabled",
                      // alsoEnglishWord: "also: -enabled",
                      britshText: "IpaUK: /ɪneɪbld/",
                      americanText: "IpaUS: /ɪneɪbld/",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Your browser is not Java-enabled.");
  }
...
// """),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە دەکرێت لەگەڵ سیستەم یان تەکنەلۆژیایەکی دیاریکراودا بەکاربێت"""),
          SentencesRow(
            englishText: """Your browser is not Java-enabled.""",
            kurdishText: """وێبگەڕەکەت جاڤا دەخوێنێتەوە.""",
// With short examples define "-enabled", please follow LX instructions
          ...
          SentencesRow(
            englishText:
                """Their aim is to make sure that every home and business becomes internet-enabled in the next ten years.""",
            kurdishText:
                """ئامانجیان ئەوەیە کە دڵنیایی بکەنەوە کە هەموو ماڵ و بازرگانییەک ئینتەرنێتی هەبێت لە دە ساڵی داهاتوودا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: -enabled
1. (in compound adjectives) that can be used with a particular system or technology, especially the internet
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/IGgblfkAhsE?t=';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/0K1pITq4mSk?t=';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/1iWs3jJih_M';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/wrXf_VznZvM?t=';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/6IcfpSgZbno?t=';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/w8LvGsL6L2c?t=';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/ux6CmsrOFeo?t=';
