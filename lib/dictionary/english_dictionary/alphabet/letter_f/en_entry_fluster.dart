...
class EnglishEntryfluster extends StatefulWidget {
  const EnglishEntryfluster({super.key});

  @override
  State<EnglishEntryfluster> createState() => _EnglishEntryflusterState();
}

class _EnglishEntryflusterState extends State<EnglishEntryfluster> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fluster (Derived forms: flusters)
1. A disposition that is confused or nervous and upset (= perturbation)

- Verb: fluster (Derived forms: flusters, flustering, flustered)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fluster""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Don’t fluster me or I’ll never be ready.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was flustered by all the attention.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fluster""",
                      // alsoEnglishWord: "also: fluster",
                      britshText: """IpaUK: /ˈflʌstə(r)/""",
                      americanText: """IpaUS: /ˈflʌstər/""",
...
// With short examples define "fluster", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """مەم پەشۆکێنە ئەگەرنا هەرگیز ئامادە نابم.""",
                    ...
                    SentencesRow(
                      englishText: """He was flustered by all the attention.""",
                      kurdishText: """پەشۆکا بەو هەموو سەرنجە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The important thing when you're cooking for a lot of people is not to get in a fluster.""",
                      kurdishText:
                          """کاتێک کە خواردن بح ژمارەیەکی زۆر کەس ئامادە دەکەیت شتی گرنگ ئەوەیە کە نەکەویتە پەشۆکان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/JY5t6iUzajk?t=';
const double _startSecondsend = 000000000000000000000000000152;
const String _videoIdone = 'https://youtu.be/zouGFPlbtkk?t=';
const double _startSecondsone = 000000000000000000000000000137;
const String _videoIdtwo = 'https://youtu.be/tPX3PmP8Rr8?t=';
const double _startSecondstwo = 0000000000000000000000000001054;
const String _videoIdthree = 'https://youtu.be/TlOpkgM_WHY?t=';
const double _startSecondsthree = 000000000000000000000000000789;
const String _videoIdfour = 'https://youtu.be/YeE3tDIDF7Q?t=';
const double _startSecondsfour = 0000000000000000000000000001534;
const String _videoIdfive = 'https://youtu.be/KB6NBtmZ2oU?t=';
