...
// replace these: replace EnglishEntryacidtest - replace speakAcidtest - replace acid test - /ˌæsɪd ˈtest/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryacidtest extends StatelessWidget {
  EnglishEntryacidtest({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAcidtest(String languageCode) async {
    // DOPSUM: CHANGE speakAcidtest
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌæsɪd ˈtest/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'dpPQKz6D1Yw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'NyZXH_JEDEk';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'NCTTc_2W7rA';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'PWBUMgAl7wY';
