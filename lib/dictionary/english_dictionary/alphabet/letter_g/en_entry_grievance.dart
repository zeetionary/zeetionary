...
// With short examples define "grievance", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئایا کۆمپانیاکە ڕێگەی فەرمی سکاڵای ھەیە؟""",
...
const String _videoIdtwo = 'eweyhaE6mpI';
const double _startSecondstwo = 260;
const String _videoIdthree = 'zj6p5kYnPPY';
const double _startSecondsthree = 779;
const String _videoIdfour = 's_jaU5V9FUg';
const double _startSecondsfour = 8;
const String _videoIdfive = '9l3f1KrMQeo';
