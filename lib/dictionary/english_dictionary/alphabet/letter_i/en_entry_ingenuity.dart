...
class EnglishEntryingenuity extends StatefulWidget {
  const EnglishEntryingenuity({super.key});

  @override
  State<EnglishEntryingenuity> createState() => _EnglishEntryingenuityState();
}

class _EnglishEntryingenuityState extends State<EnglishEntryingenuity> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ingenuity""");
  }
