...
class EnglishEntryloop extends StatefulWidget {
  const EnglishEntryloop({super.key});

  @override
  State<EnglishEntryloop> createState() => _EnglishEntryloopState();
}

class _EnglishEntryloopState extends State<EnglishEntryloop> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: loop (Derived forms: loops)
1. Fastener consisting of a metal ring for lining a small hole to permit the attachment of cords or lines (- cringle, eyelet, grommet, grummet)
 
2. Anything with a round or oval shape (formed by a curve that is closed and does not intersect itself)
 
3. (computing) a single execution of a set of instructions that are to be repeated (- iteration)
...
7. The topology of a network whose components are serially connected in such a way that the last component is connected to the first component (- loop topology)
 
8. An intrauterine device in the shape of a loop
 
9. A complete electrical circuit around which current flows or a signal circulates (- closed circuit)
 
10. A flight manoeuvre; aircraft flies a complete circle in the vertical plane (- loop-the-loop)

- Verb: loop (Derived forms: loops, looping, looped)
1. Move in loops
"The bicycle looped around the tree"
 
2. Make a loop in (- intertwine)
"loop a rope";
 
3. Fly loops, perform a loop
"the stunt pilot looped his plane"
 
4. Wind around something in coils or loops (- coil, curl)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The road went in a huge loop around the lake.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He tied a loop of rope around his arm.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Make a loop in the string.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The film is on a loop.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He looped the strap over his shoulder.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The horse’s reins were looped around its neck.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The river loops around the valley.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The ball looped high up in the air.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The sample is automatically until you tell it to stop.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/bHIhgxav9LY?t=180';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/tMKXbLBgkEc?t=629';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/khOUvmOQExc?t=551';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/XEZfGlyLQnA?t=413';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/gWOXSh4-Iuc?t=1000';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/5ljluGA4dQU?t=153';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """loop""",
                      // alsoEnglishWord: "also: loop",
                      britshText: """IpaUK: /luːp/""",
                      americanText: """IpaUS: /luːp/""",
...
کوردی: ئاڵقە، ئەڵقە، چەمەرە، گەوە، کەمە، قەف، چەرخ، پێچ، چەماوی،	گرێ،	قەف یان ئاڵقەی تەناف،	قوڵفە، دەسک، مشتە
"""),
// With short examples define "loop", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) شێوەیەکی وەک چەماوە یان بازنە کە بە دەوری شتێکدا بچێت"""),
                    SentencesRow(
                      englishText: """The road went in a huge loop around the lake.""",
                      kurdishText: """ڕێگاکە بە ئەڵقەیەکی بە دەوری دەریاچەکە دەچوو.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) پارچە حەبل، وایەرێک، هتد کە لە شێوەی چەماوەیەک یان بازنەیەکە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He tied a loop of rope around his arm.""",
                      kurdishText: """ئەڵقەیەکی حەبلی لە دەوری باڵی بەست.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Make a loop in the string.""",
                      kurdishText: """ئەڵقەیەک لە تەلەکە درووست بکە.""",
                      englishNote: """This means to bend the string into a curved shape where one end crosses over or touches another part of the string.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) کە وێنە یان دەنگ بەردەوام دووبارە دەبنەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The film is on a loop.""",
                      kurdishText: """فیلمەکە لە دووبارەبوونەوەی بەردەوامدایە.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) کە شتێک بچەمێندرێتەوە و بکرێت بە ئەڵقەیەک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He looped the strap over his shoulder.""",
                      kurdishText: """قایشەکەی بە دەوری شانیدا سووڕدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The horse’s reins were looped around its neck.""",
                      kurdishText: """جڵەوی ئەسپەکە بە دەوری ملیدا سووڕ درابوو.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (کردار) بە شێوەیەک کە ئەڵقەیەک درووست بکات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The river loops around the valley.""",
                      kurdishText: """ڕووبارەکە بە دەوری دۆڵەکەدا دەچێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The ball looped high up in the air.""",
                      kurdishText: """تۆپەکە لە حەوادا سووڕایەوە.""",
                      onPressedBritish: () => speaksentence8("en-GB"),
                      onPressedAmerican: () => speaksentence8("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٦. (کردار) لێدانی وێنە یان دەنگێک بە شێوەیەک کە بەردەوام دووبارە ببێتەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The sample is automatically until you tell it to stop.""",
                      kurdishText: """نموونەکە خۆکارانە بەردەوام دووبارە دەکرێتەوە تاوەکو دەیوەستێنیت.""",
