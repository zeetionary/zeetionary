...
class EnglishEntryeradication extends StatefulWidget {
  const EnglishEntryeradication({super.key});

  @override
  State<EnglishEntryeradication> createState() =>
      _EnglishEntryeradicationState();
}

class _EnglishEntryeradicationState extends State<EnglishEntryeradication> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""eradication""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """eradication""",
                      // alsoEnglishWord: "also: eradication",
                      britshText: """IpaUK: /ɪˌrædɪˈkeɪʃn/""",
                      americanText: """IpaUS: /ɪˌrædɪˈkeɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "eradication";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The organization's goal is the eradication of poverty.""");
  }
...
کوردی: ڕیشەدەرهێنان، هەڵتەکاندن، نەهێشتن، خاشەبڕکردن، بنکۆڵ‌کردن، لەنێوبردن، تیابردن، لەبن‌دەرهێنان، هەڵکێشان، ڕیشەکێش‌کردن، بنبڕکردن، بنەبڕکردن، کوێراندنەوە، کوێرکردنەوە
"""),
          const DefinitionKurdish(text: """١. (ناو) لەناوبردنی تەواوی شتێک"""),
          SentencesRow(
            englishText:
                """The organization's goal is the eradication of poverty.""",
            kurdishText: """ئامانجی دامەزراوەکە بنبڕکردنی گەندەڵییە.""",
          ...
          SentencesRow(
            englishText:
                """These species of weeds are stubbornly resistant to eradication.""",
            kurdishText: """ئەم بژارە شێلگیرانە دژ بە ڕیشەکێش‌کردنن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: eradication (Derived forms: eradications)
1. The complete destruction of every trace of something (= obliteration)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/lwP9H9qTuUY?t=';
const double _startSecondsend = 000000000000000000000000000000; // 833;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/sAiTuitN5b8?t=';
const double _startSecondsone = 00000000000000000000000000000; // 210;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/34oI0yd5YUc?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 155;
const String _videoIdthree = 'VIDEOhttps://youtu.be/8Yjd8pDRgfs?t=';
const double _startSecondsthree = 000000000000000000000000000; // ;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/FwTGU32lSs0?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 530;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/eLdmvZbXzo4?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 532;
