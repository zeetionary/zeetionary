...
// replace these: replace EnglishEntryadulthood - replace speakAdulthood - replace adulthood - /ˈædʌlthʊd/, /əˈdʌlthʊd/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadulthood extends StatelessWidget {
  EnglishEntryadulthood({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdulthood(String languageCode) async {
    // DOPSUM: CHANGE speakAdulthood
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("adulthood"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAdul35729(String languageCode) async {
    ...
    await flutterTts.speak(
        "Her childhood problems persisted into adulthood."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "adulthood", // DOPSUM: CHANGE WORD ENTRY - Find /ˈædʌlthʊd/, /əˈdʌlthʊd/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈædʌlthʊd/, /əˈdʌlthʊd/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'ppGovJuIFdA';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '7zeNDjTtkXM';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'Gybaxdx5ICQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'cJMczh85QRQ';
