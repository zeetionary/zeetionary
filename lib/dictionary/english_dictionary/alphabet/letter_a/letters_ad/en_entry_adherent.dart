...
// replace these: replace EnglishEntryadherent - replace speakAdherent - replace adherent - /ədˈhɪərənt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadherent extends StatelessWidget {
  EnglishEntryadherent({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdherent(String languageCode) async {
    // DOPSUM: CHANGE speakAdherent
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("adherent"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAdh24861(String languageCode) async {
    ...
    await flutterTts.speak(
        "We should not show animosity to adherents of other faiths."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "adherent", // DOPSUM: CHANGE WORD ENTRY - Find /ədˈhɪərənt/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ədˈhɪərənt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAdherent(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ədˈhɪrənt/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'xjEFo3a1AnI';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '1Zim09f0VsQ';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'a-qnFOSjQ-Q';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'Xa-n2_a6Sh8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'BXb2kvKPgNw';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'YMtsodcAsVU';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'xrWGkxmurTk';
