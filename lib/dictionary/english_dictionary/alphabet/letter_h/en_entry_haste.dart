...
class EnglishEntryhaste extends StatefulWidget {
  const EnglishEntryhaste({super.key});

  @override
  State<EnglishEntryhaste> createState() => _EnglishEntryhasteState();
}

class _EnglishEntryhasteState extends State<EnglishEntryhaste> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: haste (Derived forms: hastes)
1. Overly eager speed (and possible carelessness) (- hastiness, hurry, hurriedness, precipitation)
"he soon regretted his haste";
 
2. The act of moving hurriedly and in a careless manner (- hurry, rush, rushing)
"in his haste to leave he forgot his book";
 
3. A condition of urgency making it necessary to move or act fast (- hurry)
""",
  );

  final String keyword = "haste";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The letter had clearly been written in haste.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She made haste to open the door.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """haste""",
                      // alsoEnglishWord: "also: haste",
                      britshText: """IpaUK: /heɪst/""",
                      americanText: """IpaUS: /heɪst/""",
...
کوردی: پەلە، لەز، دەست‌وبرد، زوو، پڕتاو، تاوەبڕکێ، خێرایی
"""),
// With short examples define "haste", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) خێرایی لە کردنی شتێک"""),
                    const AlsoEnglishckb(word: "ھەروەھا: hurry"),
                    SentencesRow(
                      englishText:
                          """The letter had clearly been written in haste.""",
                      kurdishText:
                          """نامەکە بە ئاشکرایی بە پەلەپەل نووسرابوو.""",
                    ...
                    SentencesRow(
                      englishText: """She made haste to open the door.""",
                      kurdishText: """پەلەپەلی کرد لە کردنەوەی دەرگاکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """In her haste to complete the work on time, she made a number of mistakes.""",
                      kurdishText:
                          """لە پەلەکردنی بۆ تەواوکردنی کارەکە لەکاتی خۆیدا، ژمارەیەک هەڵەی کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/KZbzIf_C6Y4?t=';
const double _startSecondsend = 0000000000000000000000000001208;
const String _videoIdone = 'https://youtu.be/xjmXzYdxuTQ?t=';
const double _startSecondsone = 0000000000000000000000000001073;
const String _videoIdtwo = 'https://youtu.be/XUONzsAzv1I?t=';
const double _startSecondstwo = 00000000000000000000000000068;
const String _videoIdthree = 'https://youtu.be/NOeV7t9O6iE?t=';
const double _startSecondsthree = 00000000000000000000000000042;
const String _videoIdfour = 'https://youtu.be/a1I7QBCHqng?t=';
const double _startSecondsfour = 000000000000000000000000000541;
const String _videoIdfive = 'https://youtu.be/n1-hqwaL4-I?t=';
