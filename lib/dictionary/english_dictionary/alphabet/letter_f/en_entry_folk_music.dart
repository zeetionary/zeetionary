...
class EnglishEntryfolkmusic extends StatefulWidget {
  const EnglishEntryfolkmusic({super.key});

  @override
  State<EnglishEntryfolkmusic> createState() => _EnglishEntryfolkmusicState();
}

class _EnglishEntryfolkmusicState extends State<EnglishEntryfolkmusic> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "folk music";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""folk music""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """folk music""",
                      // alsoEnglishWord: "also: folk music",
                      britshText: """IpaUK: /ˈfəʊk mjuːzɪk/""",
                      americanText: """IpaUS: /ˈfəʊk mjuːzɪk/""",
...
// With short examples define "folk music", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئیلهامی وەرگرت لە میوزیکی خۆجێیی هەنگاری.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/vwqd8OXADJQ?t=';
const double _startSecondsend = 000000000000000000000000000227;
const String _videoIdone = 'https://youtu.be/PlDUiC3IVos?t=';
const double _startSecondsone = 000000000000000000000000000391;
const String _videoIdtwo = 'https://youtu.be/In6gCrGeZfA?t=';
const double _startSecondstwo = 00000000000000000000000000068;
const String _videoIdthree = 'https://youtu.be/3QQ3vnKYu4E?t=';
const double _startSecondsthree = 00000000000000000000000000035;
const String _videoIdfour = 'https://youtu.be/4Omkh8QFAdg?t=';
const double _startSecondsfour = 000000000000000000000000000529;
const String _videoIdfive = 'https://youtu.be/wy-GkEI8rXc?t=';
