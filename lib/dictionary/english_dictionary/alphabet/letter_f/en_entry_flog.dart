...
class EnglishEntryflog extends StatefulWidget {
  const EnglishEntryflog({super.key});

  @override
  State<EnglishEntryflog> createState() => _EnglishEntryflogState();
}

class _EnglishEntryflogState extends State<EnglishEntryflog> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: flog (Derived forms: flogging, flogs, flogged)
1. Beat severely with a whip or rod (= welt, whip, lather, lash, slash, strap, trounce, whale [N. Amer, informal])
"The teacher often flogged the students";
 
2. Beat with a cane (= cane, lambaste, lambast)
 
3. [Brit, informal] Exchange or deliver for money or its equivalent (= sell)
...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She flogged her guitar to another student.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We buy them cheaply and then flog them off at a profit.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flog""",
                      // alsoEnglishWord: "also: flog",
                      britshText: """IpaUK: /flɒɡ/""",
                      americanText: """IpaUS: /flɑːɡ/""",
...
// With short examples define "flog", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """He was publicly flogged for breaking the country's alcohol laws.""",
                      kurdishText:
                          """لە شوێنێکی گشتیدا جەڵد کرا بۆ شکاندنی یاساکانی مادەی کحوولیی وڵاتەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """گیتارەکەی فرۆشت بە خوێندکارێکی دیکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە هەرزان دەیان کڕین و دواتر بە قازانج دەیان فرۆشینەوە.""",
                      englishNote:
                          "This means we purchase them at low prices and then sell them at a higher price to make a profit.",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/bcdEFos9YQQ?t=';
const double _startSecondsend = 000000000000000000000000000259;
const String _videoIdone = 'https://youtu.be/HF9zRqlN4T0?t=';
const double _startSecondsone = 000000000000000000000000000951;
const String _videoIdtwo = 'https://youtu.be/TIee4YRROsg?t=';
const double _startSecondstwo = 000000000000000000000000000217;
const String _videoIdthree = 'https://youtu.be/vZRLA7Ivh7Q?t=';
const double _startSecondsthree = 0000000000000000000000000001308;
const String _videoIdfour = 'https://youtu.be/9NfbNPnGBpk?t=';
const double _startSecondsfour = 000000000000000000000000000280;
const String _videoIdfive = 'https://youtu.be/GyS-Ylu7Aho?t=';
