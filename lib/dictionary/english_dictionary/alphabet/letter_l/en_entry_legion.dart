...
class EnglishEntrylegion extends StatefulWidget {
  const EnglishEntrylegion({super.key});

  @override
  State<EnglishEntrylegion> createState() => _EnglishEntrylegionState();
}

class _EnglishEntrylegionState extends State<EnglishEntrylegion> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: legion
1. Amounting to a large indefinite number (- numerous)
"Palomar's fans are legion";

- Noun: legion (Derived forms: legions)
1. Association of ex-servicemen
"the American Legion"
 
2. A large military unit
"the French Foreign Legion"
 
3. A vast multitude (- horde, host)
 
4. [archaic] Army (- host [archaic])
""",
  );

  final String keyword = "legion";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Caesar's legions marched through France and crossed into Britain.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He failed to turn up for the concert, disappointing the legions of fans waiting outside.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The difficulties surrounding the court case are legion.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/xYIuBGOOoKM?t=607';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/hUmnnx-NIow?t=5';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/MVZZoGEVI58?t=336';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/ESBPAFTBvnA?t=66';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/HxRUuGqqMG4?t=21';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/R_fZjGm2OrM?t=10';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """legion""",
                      // alsoEnglishWord: "also: legion",
                      britshText: """IpaUK: /ˈliːdʒən/""",
                      americanText: """IpaUS: /ˈliːdʒən/""",
...
کوردی: هەنگ، ئاپۆرە، لەشکر، خێڵ، خەڵکێکی زۆر
"""),
// With short examples define "legion", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) گرووپێکی گەورە لە سەرباز کە بەشێکی سوپایەک پێکدەهێنێت، بە تایبەتی هی سوپای ڕۆمای کۆن"""),
                    SentencesRow(
                      englishText: """Caesar's legions marched through France and crossed into Britain.""",
                      kurdishText: """لیجنەکانی سیزار بە فەرەنسادا تێپەڕین و پەڕینەوە بەریتانیا.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ڕێژەیەکی زۆر لە خەڵکی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He failed to turn up for the concert, disappointing the legions of fans waiting outside.""",
                      kurdishText: """نەیتوانی ئامادە بێت لە کۆنسێرتەکە و ئاپۆڕەیەکی گەورە لە هەوادارانی بێهیوا کرد کە لە دەرەوە وەستابوون .""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ھاوەڵناو) ژمارەیەکی زۆر"""),
                    const AlsoEnglishckb(word: "ھەروەھا: numerous"),
                    SentencesRow(
                      englishText: """The difficulties surrounding the court case are legion.""",
                      kurdishText: """ئەو ئاڵەنگارییانەی لە کەیسەکەی داگادا هەن زۆرن.""",
