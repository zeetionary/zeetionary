...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'bByJdUw8KtE';
    const double startSecondsend = 518;
    const String videoIdone = 'RQ1nY51txoA';
    const double startSecondsone = 339;
    const String videoIdtwo = 'lPOYV_O21GM';
    const double startSecondstwo = 424;
    const String videoIdthree = 'lSII7Hs8p5Y';
    const double startSecondsthree = 229;
    const String videoIdfour = 'WRUa1JQylQc';
    const double startSecondsfour = 817;
    const String videoIdfive = 'gFUGzVblMss';
    const double startSecondsfive = 225;
