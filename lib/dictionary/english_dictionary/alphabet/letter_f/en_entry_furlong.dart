...
class EnglishEntryfurlong extends StatefulWidget {
  const EnglishEntryfurlong({super.key});

  @override
  State<EnglishEntryfurlong> createState() => _EnglishEntryfurlongState();
}

class _EnglishEntryfurlongState extends State<EnglishEntryfurlong> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: furlong (Derived forms: furlongs)
1. A unit of length equal to 220 yards
""",
  );

  final String keyword = "furlong";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""furlong""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furlong""",
                      // alsoEnglishWord: "also: furlong",
                      britshText: """IpaUK: /ˈfɜːlɒŋ/""",
                      americanText: """IpaUS: /ˈfɜːrlɔːŋ/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) یەکەیەکی پێوان کە یەکسانە بە ٢٢٠ یارد، ٢٠١ مەتر، یان ١ لە ٨ ـی میلێک کە ١٦٠٩ مەترە"""),
                    SentencesRow(
                      englishText: """A furlong is used in horse racing.""",
                      kurdishText:
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/nRnuY1Vao0o?t=';
const double _startSecondsend = 000000000000000000000000000351;
const String _videoIdone = 'https://youtu.be/iJymKowx8cY?t=';
const double _startSecondsone = 000000000000000000000000000505;
const String _videoIdtwo = 'https://youtu.be/O2JMwcxmeTA?t=';
const double _startSecondstwo = 000000000000000000000000000311;
const String _videoIdthree = 'https://youtu.be/zHpth20N174?t=';
const double _startSecondsthree = 000000000000000000000000000936;
const String _videoIdfour = 'https://youtu.be/PCy1IKPev4w?t=';
const double _startSecondsfour = 00000000000000000000000000063;
const String _videoIdfive = 'https://youtu.be/9pVGhcKJk1A?t=';
const double _startSecondsfive = 0000000000000000000000000004771;
