...
class EnglishEntryfilings extends StatefulWidget {
  const EnglishEntryfilings({super.key});

  @override
  State<EnglishEntryfilings> createState() => _EnglishEntryfilingsState();
}

class _EnglishEntryfilingsState extends State<EnglishEntryfilings> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: filings
1. Small pieces of metal that are removed from a larger piece by filing:
""",
  );

  final String keyword = "filings";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""filings""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""A large magnet collects up the iron filings.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Make sure you put all the nail filings in the bin.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """filings""",
                      // alsoEnglishWord: "also: filings",
                      britshText: """IpaUK: /ˈfaɪlɪŋz/""",
                      americanText: """IpaUS: /ˈfaɪlɪŋz/""",
...
// With short examples define "filings", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """A large magnet collects up the iron filings.""",
                      kurdishText:
                          """موگناتیسێکی گەورە کە وردە ئاسن کۆدەکاتەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ob2Lo0sFrtI?t=';
const double _startSecondsend = 000000000000000000000000000152;
const String _videoIdone = 'https://youtu.be/k9NGeMd697w?t=';
const double _startSecondsone = 000000000000000000000000000272;
const String _videoIdtwo = 'https://youtu.be/xrJNjFc-mF4?t=';
const double _startSecondstwo = 000000000000000000000000000142;
const String _videoIdthree = 'https://youtu.be/ZNwvjaIW-pU?t=';
const double _startSecondsthree = 0000000000000000000000000003249;
const String _videoIdfour = 'https://youtu.be/i3jA40arq9Y?t=';
const double _startSecondsfour = 000000000000000000000000000194;
const String _videoIdfive = 'https://youtu.be/g0amdIcZt5I?t=';
const double _startSecondsfive = 000000000000000000000000000283;
