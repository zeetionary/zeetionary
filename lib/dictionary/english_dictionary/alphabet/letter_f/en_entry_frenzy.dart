...
class EnglishEntryfrenzy extends StatefulWidget {
  const EnglishEntryfrenzy({super.key});

  @override
  State<EnglishEntryfrenzy> createState() => _EnglishEntryfrenzyState();
}

class _EnglishEntryfrenzyState extends State<EnglishEntryfrenzy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frenzy (Derived forms: frenzies)
1. State of violent mental agitation (= craze, delirium, fury, hysteria)
"The rock musician worked the crowd of young girls into a frenzy";
""",
  );

  final String keyword = "frenzy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The speaker worked the crowd up into a frenzy.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She tore the letter open in a frenzy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frenzy""",
                      // alsoEnglishWord: "also: frenzy",
                      britshText: """IpaUK: /ˈfrenzi/""",
                      americanText: """IpaUS: /ˈfrenzi/""",
...
کوردی: ڕەفتار یان هەڵس‌وکەوتی شێتانە، شێت‌بوون (بۆ ساتێ)،	ورووژانی توند یان توندوتیژانە
"""),
// With short examples define "frenzy", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """قسەکارەکە جەماوەرەکەی شلۆقاند.""",
                    ...
                    SentencesRow(
                      englishText: """She tore the letter open in a frenzy.""",
                      kurdishText: """لە ورووژاندا نامەکەی لەت‌لەت کرد.""",
...
const String _videoIdtwo = 'https://youtu.be/aYOg8EON29Y?t=';
const double _startSecondstwo = 00000000000000000000000000021;
const String _videoIdthree = 'https://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondsthree = 0000000000000000000000000007021;
const String _videoIdfour = 'https://youtu.be/hGLY5MAAFO4?t=';
const double _startSecondsfour = 00000000000000000000000000093;
const String _videoIdfive = 'https://youtu.be/xRyPWG9PTm4?t=';
const double _startSecondsfive = 000000000000000000000000000680;
