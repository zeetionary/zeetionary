...
class EnglishEntryabashed extends StatefulWidget {
  const EnglishEntryabashed({super.key});

  @override
  State<EnglishEntryabashed> createState() => _EnglishEntryabashedState();
}

class _EnglishEntryabashedState extends State<EnglishEntryabashed> {
  @override
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "abashed");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: abashed");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /əˈbæʃt/");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakabashed(String languageCode) async {
    ...
    await flutterTts.speak("abashed");
  }
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /əˈbæʃt/");
  }
}
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  ...
  final String _videoId = 'XarekSjSj8Y';
...
class _YoutubeEmbeddedendState extends State<YoutubeEmbeddedend> {
  late YoutubePlayerController _controller;
  final String _videoId = 'obuS3teC1Kk';
