...
class EnglishEntryengrave extends StatefulWidget {
  const EnglishEntryengrave({super.key});

  @override
  State<EnglishEntryengrave> createState() => _EnglishEntryengraveState();
}

class _EnglishEntryengraveState extends State<EnglishEntryengrave> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""engrave""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """engrave""",
                      // alsoEnglishWord: "also: engrave",
                      britshText: """IpaUK: /ɪnˈɡreɪv/""",
                      americanText: """IpaUS: /ɪnˈɡreɪv/""",
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) هەلکۆڵینی وشە و دیزاین لەسەر دار، بەرد، کانزا، هتد"""),
          SentencesRow(
            englishText: """The silver cup was engraved with his name.""",
            kurdishText: """جامە زیوییەکە بە ناوی هەلکۆڵدرا.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            englishNote: "Also: His name was engraved on the silver cup.",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: engrave (Derived forms: engraved, engraves, engraving)
1. Carve, cut, or etch into a material or surface (= scratch, grave [archaic], inscribe)
"engrave a pen"; "engraved the trophy cup with the winner's name";
 
2. Impress or affect deeply
"The event engraved itself into her memory"
 
3. (art) carve or cut into a block used for printing or print from such a block (= etch)
"engrave a letter";
 
4. Carve or cut a design or letters into (= etch)
...
const String _videoIdone = 'https://youtu.be/nd5--EqzLPY?t=';
const double _startSecondsone = 499;
const String _videoIdtwo = 'https://youtu.be/-BeTq99LqUo?t=';
const double _startSecondstwo = 462;
const String _videoIdthree = 'https://youtu.be/hI5jggQTAsM?t=';
const double _startSecondsthree = 417;
const String _videoIdfour = 'https://youtu.be/f3DfJxvkN-8?t=';
const double _startSecondsfour = 195;
const String _videoIdfive = 'https://youtu.be/Solb9uA-tgQ?t=';
const double _startSecondsfive = 4260;
const String _videoIdsix = 'https://youtu.be/A0Cz7XCC00w?t=';
const double _startSecondssix = 95;
