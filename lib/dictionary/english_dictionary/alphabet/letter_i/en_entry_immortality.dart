...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1827;
    const String videoIdone = 'oiLdWXLXDeA';
    const double startSecondsone = 235;
    const String videoIdtwo = 'ZU_MF0NMKhU';
    const double startSecondstwo = 135;
    const String videoIdthree = '417Qbwn9yso';
    const double startSecondsthree = 13;
    const String videoIdfour = '9uH8-Gj8XrM';
    const double startSecondsfour = 1137;
    const String videoIdfive = 'zlm1aajH6gY';
