...
class EnglishEntryexhaust extends StatefulWidget {
  const EnglishEntryexhaust({super.key});

  @override
  State<EnglishEntryexhaust> createState() => _EnglishEntryexhaustState();
}

class _EnglishEntryexhaustState extends State<EnglishEntryexhaust> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exhaust""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exhaust""",
                      // alsoEnglishWord: "also: exhaust",
                      britshText: """IpaUK: /ɪɡˈzɔːst/""",
                      americanText: """IpaUS: /ɪɡˈzɔːst/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""My car needs a new exhaust.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Even a short walk exhausted her.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The swimming had completely exhausted him.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) گازی کە لە پێڕۆیەک، بزوێنەرێک، یان ئامێرێک دێتە دەرەوە"""),
          SentencesRow(
            englishText:
                """The car was fitted with a catalytic converter to meet exhaust regulations.""",
            kurdishText:
                """ئۆتۆمبێلەکە کۆنڤێرتەرێکی ھاندەرانەی لەسەر دانرا بۆ پابەند بوون بە ڕێکارەکانەوە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ئۆتۆمبێلەکەم پێویستی بە ئەکسۆزێکی تازە هەیە.""",
          ...
          SentencesRow(
            englishText:
                """There's no need to exhaust yourself clearing up—we'll do it.""",
            kurdishText:
                """پێویست ناکات خۆت بە پاککردنەوە شەکەت بکەیت ـ من دەیکەم.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The swimming had completely exhausted him.""",
            kurdishText: """مەلەکردنەکە بە تەواوی شەکەتی کرد.""",
          ...
          const DefinitionKurdish(
              text:
                  """٤. (کردار) بەکارهێنانی هەموو شتێکی شتێک بەشێوەیەک کە هیچ نەمێنێتەوە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Within three days they had exhausted their supply of food.""",
            kurdishText:
                """لە ماوەی سێ ڕۆژ تەواوی ئازووقەی خواردنیان بەکارهێنا.""",
          ...
          SentencesRow(
            englishText:
                """Don't give up until you have exhausted all the possibilities.""",
            kurdishText: """کۆڵ مەدە تاوەکو هەموو ئەگەرەکانت تاقیکردووەتەوە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """پێموایە هیچمان لەو بابەتە نەهێشتووەتەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: exhaust (Derived forms: exhausts, exhausting, exhausted)
1. Wear out completely (= wash up, beat [informal], tucker [N. Amer, informal], tucker out [N. Amer, informal])
"This kind of work exhausts me";
 
2. Use (resources or materials) over time in order to function (= consume, eat up, use up, eat, deplete, run through, wipe out)
"We exhausted our savings";
 
3. Deplete, exhaust or weaken (= run down, play out, sap, tire)
"exhaust one's savings";
 
4. Use up the whole supply of
"We have exhausted the food supplies"
 
5. Eliminate (a substance) (= discharge, expel, eject, release)
"combustion products are exhausted in the engine";
 
6. Bring out, discuss or develop completely
"to exhaust a subject"

- Noun: exhaust (Derived forms: exhausts)
1. Gases ejected from an engine as waste products (= exhaust fumes, fumes)
 
2. System consisting of the parts of an engine through which burned gases or steam are discharged (= exhaust system)
 
3. [Brit] A pipe carrying fumes from the muffler to the rear of a car (= tailpipe [N. Amer], exhaust pipe [Brit])
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/Ga3Oqhct0C8?t=';
const double _startSecondsend = 000000000000000000000000000000; // 316;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/toVfvRhWbj8?t=';
const double _startSecondsone = 00000000000000000000000000000; // 285;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/q8HRGiUeZwc?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 124;
const String _videoIdthree = 'VIDEOhttps://youtu.be/VNZ0so0LCoM?t=';
const double _startSecondsthree = 000000000000000000000000000; // 611;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/twAP3buj9Og?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 659;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/exWKMguCXfw?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 542;
