...
// replace these: replace EnglishEntryantifreeze - replace speakAntifreeze - replace antifreeze - /ˈæntifriːz/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryantifreeze extends StatelessWidget {
  // blank divider
  EnglishEntryantifreeze({super.key});
  // blank divider
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "antifreeze", // DOPSUM: CHANGE WORD ENTRY - Find /ˈæntifriːz/
                                style: TextStyle(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "37RRmMeNg1I";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "Xn7REstyOUw";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "hBYkSVkIm0g";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "rdvVmtWivUc";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "_DwrtzRY_zo";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "VuBg0Z4CpgE";
