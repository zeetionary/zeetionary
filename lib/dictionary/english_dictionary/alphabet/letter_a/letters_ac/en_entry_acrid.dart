...
class EnglishEntryacrid extends StatefulWidget {
  const EnglishEntryacrid({super.key});

  @override
  State<EnglishEntryacrid> createState() => _EnglishEntryacridState();
}

class _EnglishEntryacridState extends State<EnglishEntryacrid> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakaac4281id(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("acrid smoke from burning tyres");
  }
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'A2VAN7PtQW0';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'MgTtR5YTzvI';
