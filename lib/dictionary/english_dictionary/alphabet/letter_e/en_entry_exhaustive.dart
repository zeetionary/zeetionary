...
class EnglishEntryexhaustive extends StatefulWidget {
  const EnglishEntryexhaustive({super.key});

  @override
  State<EnglishEntryexhaustive> createState() => _EnglishEntryexhaustiveState();
}

class _EnglishEntryexhaustiveState extends State<EnglishEntryexhaustive> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exhaustive""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exhaustive""",
                      // alsoEnglishWord: "also: exhaustive",
                      britshText: """IpaUK: /ɪɡˈzɔːstɪv/""",
                      americanText: """IpaUS: /ɪɡˈzɔːstɪv/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exhaustive";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This list is not intended to be exhaustive.""");
  }
...
کوردی: گشتگیر، گشتگرەوە، تەواو، گش(ت)لایەنە، تەواو، دوورودرێژ
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) زۆر وریایانە و تەواو؛ کە هەموو شتێک لەخۆدەگرێت"""),
          SentencesRow(
            englishText: """This list is not intended to be exhaustive.""",
            kurdishText: """ئەم لیستە ئامانج لێی ئەوە نییە تەواو بێت.""",
          ...
          SentencesRow(
            englishText:
                """The report includes a seemingly exhaustive list of 160 benefits.""",
            kurdishText:
                """ڕاپۆرتەکە وادیارە لیستێکی تەواوی ١٦٠ سوودی لەخۆدەگرێت.""",
...
1. Performed comprehensively and completely; not superficial or partial (= thorough, thoroughgoing, rigorous, in-depth)
"an exhaustive study";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/lDeFSOUHdH4?t=';
const double _startSecondsend = 000000000000000000000000000000; // 802;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/MqyJZsGFZ3M?t=';
const double _startSecondsone = 00000000000000000000000000000; // 899;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/hCDzSR6bW10?t=';
...
const double _startSecondsthree = 000000000000000000000000000; // 1235;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/OnjI-FBdRTQ?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 6231;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/3HrDf6nra-I?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 830;
