...
// replace these: replace EnglishEntryaisle - replace speakAisle - replace aisle - /aɪl/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaisle extends StatelessWidget {
  EnglishEntryaisle({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAisle(String languageCode) async {
    // DOPSUM: CHANGE speakAisle
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("aisle"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAisle3888(String languageCode) async {
    ...
    await flutterTts.speak(
        "She looked radiant as she walked down the aisle on her father’s arm."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "aisle", // DOPSUM: CHANGE WORD ENTRY - Find /aɪl/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              "IpaUK: /aɪl/", // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAisle(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              "IpaUS: /aɪl/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '_UAY_CvFubo';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '8gi2l1ZeRG0';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '_3BohYAen94';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '40IArwTsraI';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'rfldSDTzGP8';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'k6TL7LaAncA';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'm4W5MmKlx4w';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'SefwkguvbYo';
