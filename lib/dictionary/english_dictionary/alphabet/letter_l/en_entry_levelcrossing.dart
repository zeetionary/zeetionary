...
class EnglishEntrylevelcrossing extends StatefulWidget {
  const EnglishEntrylevelcrossing({super.key});

  @override
  State<EnglishEntrylevelcrossing> createState() => _EnglishEntrylevelcrossingState();
}

class _EnglishEntrylevelcrossingState extends State<EnglishEntrylevelcrossing> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""level crossing""");
  }
