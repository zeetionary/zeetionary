...
class EnglishEntrygratitude extends StatefulWidget {
  const EnglishEntrygratitude({super.key});

  @override
  State<EnglishEntrygratitude> createState() => _EnglishEntrygratitudeState();
}

class _EnglishEntrygratitudeState extends State<EnglishEntrygratitude> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gratitude (Derived forms: gratitudes)
1. A feeling of thankfulness and appreciation (- appreciation)
"he was overwhelmed with gratitude for their help";
""",
  );

  final String keyword = "gratitude";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gratitude""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He smiled at them with gratitude.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I feel a deep sense of gratitude to her.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gratitude""",
                      // alsoEnglishWord: "also: gratitude",
                      britshText: """IpaUK: /ˈɡrætɪtjuːd/""",
                      americanText: """IpaUS: /ˈɡrætɪtuːd/""",
...
کوردی: سپاس، ڕێزلێنان، پێزانین، قەدرزانی، پێزانی، ئەمەک‌ناسی، حورمەت بۆدانان
"""),
// With short examples define "gratitude", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەو هەستەی کە سوۆسگوزار بیت و بتەوێت دەری ببڕیت"""),
                    SentencesRow(
                      englishText: """He smiled at them with gratitude.""",
                      kurdishText: """بە پێزانینەوە پێکەنی بۆیان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەستم بە سوپاسگوزارییەکی زۆر کرد بۆی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She was presented with the gift in gratitude for her long service.""",
                      kurdishText:
                          """دیارییەکەی پێدرا وەک قەدرزانین بۆ خزمەتە درێژەکەی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/PKffm2uI4dk?t=';
...
const String _videoIdtwo = 'https://youtu.be/0PufM6dW_to?t=';
...
const String _videoIdfour = 'https://youtu.be/rUWBKjCpZ6o?t=';
