...
class EnglishEntryexhilaration extends StatefulWidget {
  const EnglishEntryexhilaration({super.key});

  @override
  State<EnglishEntryexhilaration> createState() =>
      _EnglishEntryexhilarationState();
}

class _EnglishEntryexhilarationState extends State<EnglishEntryexhilaration> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exhilaration""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exhilaration""",
                      // alsoEnglishWord: "also: exhilaration",
                      britshText: """IpaUK: /ɪɡˌzɪləˈreɪʃn/""",
                      americanText: """IpaUS: /ɪɡˌzɪləˈreɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exhilaration";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Winning the race filled him with exhilaration.""");
  }
...
کوردی: شادی، دڵخۆشی، شاگەشکەیی، سەرخۆشی، سەرمەستی، خۆشی
"""),
          const DefinitionKurdish(text: """١. (ناو) هەستی دڵخۆشی زۆر"""),
          SentencesRow(
            englishText: """Winning the race filled him with exhilaration.""",
            kurdishText: """بردنەوەی پێشبڕکێیەکە دڵخۆشی زۆری پێدا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: exhilaration (Derived forms: exhilarations)
1. The feeling of lively and cheerful joy (= excitement)
"he could hardly conceal his exhilaration when she agreed";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/LDeXDIothkg?t=';
const double _startSecondsend = 000000000000000000000000000000; // 595;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/j7YqdGt19tw?t=';
const double _startSecondsone = 00000000000000000000000000000; // 432;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/eZXtpLxdhOo?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 674;
const String _videoIdthree = 'VIDEOhttps://youtu.be/xGlIfuWCdK4?t=';
const double _startSecondsthree = 000000000000000000000000000; // 412;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/7oY5WNAgb90?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 316;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/lTfCDy4nRkc?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 54;
