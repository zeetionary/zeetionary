...
class EnglishEntrygloatingly extends StatefulWidget {
  const EnglishEntrygloatingly({super.key});

  @override
  State<EnglishEntrygloatingly> createState() => _EnglishEntrygloatinglyState();
}

class _EnglishEntrygloatinglyState extends State<EnglishEntrygloatingly> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gloatingly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gloatingly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The anchorwoman told viewers gloatingly that the footage was exclusive.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gloatingly""",
                      // alsoEnglishWord: "also: gloatingly",
                      britshText: """IpaUK: /ˈɡləʊ.tɪŋ.li/""",
                      americanText: """IpaUS: /ˈɡloʊ.t̬ɪŋ.li/""",
...
کوردی: 
"""),
// With short examples define "gloatingly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە دڵخۆشیت بە سەرکەوتنی خۆت یان بە شکستی کەسێکی دیکە"""),
                    SentencesRow(
                      englishText:
                          """The anchorwoman told viewers gloatingly that the footage was exclusive.""",
                      kurdishText:
                          """پێشکەشکارەکە بە لەخۆبایی‌یانە بە بینەرانی گوت دیمەنەکە تایبەتە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/X1Zd-8duews?t=';
const double _startSecondsend = 000000000000000000000000000484;
const String _videoIdone = 'https://youtu.be/W-t-uhVesQg?t=';
const double _startSecondsone = 00000000000000000000000000013603;
const String _videoIdtwo = 'https://youtu.be/jXRD3HAyN6I?t=';
const double _startSecondstwo = 000000000000000000000000000324;
const String _videoIdthree = 'https://youtu.be/W0ZjrSOQjo4?t=';
const double _startSecondsthree = 0000000000000000000000000001632;
const String _videoIdfour = 'https://youtu.be/v803WGKui0Y?t=';
const double _startSecondsfour = 000000000000000000000000000530;
const String _videoIdfive = 'https://youtu.be/WSOtercokp0?t=';
const double _startSecondsfive = 0000000000000000000000000005437;
