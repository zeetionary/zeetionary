...
// Define the word "baking powder" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace baking powder - replace EnglishEntrybakingpowder

// replace speakBakingpowder - /ˈbeɪkɪŋ paʊdə(r)/

enum TtsState { playing }

class EnglishEntrybakingpowder extends StatelessWidget {
// blank divider
  EnglishEntrybakingpowder({super.key});
// blank divider
  ...
  Future<void> speakBakingpowders7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBakingpowders77"); // DOPSUM: CHANGE TEXT
  }
                        ...
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˈbeɪkɪŋ paʊdər/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "Rzd0mLf366I?t=";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "vzKuobmi3iI?t=";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "LoqwZBkYWqE?t=";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "g9QneAV4fVo?t=";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "lvvwcS-0R-g?t=";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "ImoP-Apzrsg?t=";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "_Q0FYoCl4Cs?t=";
...
// end baking powder // TODO Implement this library.
