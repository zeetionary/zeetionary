...
class EnglishEntryenvelop extends StatefulWidget {
  const EnglishEntryenvelop({super.key});

  @override
  State<EnglishEntryenvelop> createState() => _EnglishEntryenvelopState();
}

class _EnglishEntryenvelopState extends State<EnglishEntryenvelop> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""envelop""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """envelop""",
                      // alsoEnglishWord: "also: envelop",
                      britshText: """IpaUK: /ɪnˈveləp/""",
                      americanText: """IpaUS: /ɪnˈveləp/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Clouds enveloped the mountain tops.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Darkness fell and enveloped the town.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) داپۆشین یان دەورگرتنی کەسێک/شتێک بە تەواوی"""),
          SentencesRow(
            englishText: """Clouds enveloped the mountain tops.""",
            kurdishText: """هەور لوتکەی شاخەکانی داپۆشی.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Darkness fell and enveloped the town.""",
            kurdishText: """تاریکی داهات و لوتکەی شاخەکانی داپۆشی.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """A feeling of despair enveloped him.""",
            kurdishText: """هەستی نائومێدی باڵی کێشا بەسەریدا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: envelop (Derived forms: envelops, enveloping, enveloped)
1. Surround, cover or wrap completely (= enfold, enwrap, wrap, enclose)
...
const double _startSecondsend = 1594;
const String _videoIdone = 'QINII0eeJxc';
const double _startSecondsone = 73;
const String _videoIdtwo = 'tExo3ovEBWQ';
const double _startSecondstwo = 2378;
const String _videoIdthree = 'UrkPC81_QfU';
const double _startSecondsthree = 632;
const String _videoIdfour = 'hCsPV0eiqxg';
const double _startSecondsfour = 157;
const String _videoIdfive = 'PhQksV8fbKw';
