...
class EnglishEntrylightningconductor extends StatefulWidget {
  const EnglishEntrylightningconductor({super.key});

  @override
  State<EnglishEntrylightningconductor> createState() => _EnglishEntrylightningconductorState();
}

class _EnglishEntrylightningconductorState extends State<EnglishEntrylightningconductor> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lightning conductor""");
  }
