...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'R6reyiSpKuw';
    const double startSecondsend = 503;
    const String videoIdone = 'a_TSR_v07m0';
    const double startSecondsone = 325;
    const String videoIdtwo = 'V-jmSjy2ArM';
    const double startSecondstwo = 571;
    const String videoIdthree = '1ykJaIhCIWg';
    const double startSecondsthree = 472;
    const String videoIdfour = 'AGqUCKin4X0';
    const double startSecondsfour = 197;
    const String videoIdfive = 'f9dEf6fPQVs';
    const double startSecondsfive = 181;
