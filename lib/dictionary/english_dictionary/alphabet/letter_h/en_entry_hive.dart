...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/uXx-SvkYaxg?t=';
    const double startSecondsend = 000000000000000000000000000113;
    const String videoIdone = 'https://youtu.be/CVUTvwHKHmU?t=';
    const double startSecondsone = 00000000000000000000000000019;
    const String videoIdtwo = 'https://youtu.be/zDZDYgBkCx0?t=';
    const double startSecondstwo = 00000000000000000000000000017;
    const String videoIdthree = 'https://youtu.be/XPUSI25G90Q';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/-EDiFw6gxEc?t=';
    const double startSecondsfour = 0000000000000000000000000008;
    const String videoIdfive = 'https://youtu.be/544DTGHIBM0?t=';
