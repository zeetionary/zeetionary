...
class EnglishEntryfort extends StatefulWidget {
  const EnglishEntryfort({super.key});

  @override
  State<EnglishEntryfort> createState() => _EnglishEntryfortState();
}

class _EnglishEntryfortState extends State<EnglishEntryfort> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fort (Derived forms: forts)
1. (military) a fortified military post where troops are stationed (= garrison)
 
2. A fortified defensive structure (= fortress)
"an impenetrable fort";

- Verb: fort (Derived forms: forting, forted, forts)
1. Gather in, or as if in, a fort, as for protection or defence (= fort up)
 
2. Enclose by or as if by a fortification (= fortify)
 
3. Station (troops) in a fort
""",
  );

  final String keyword = "fort";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The fort finally fell after a week of intense fighting.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fort was under attack for three days.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fort""",
                      // alsoEnglishWord: "also: fort",
                      britshText: """IpaUK: /fɔːt/""",
...
// With short examples define "fort", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) بینا یان ژمارەیەک بینا بۆ بەرگری لە ناوچەیەک دژ بە هێرش"""),
                    SentencesRow(
                      englishText:
                          """The fort finally fell after a week of intense fighting.""",
                      kurdishText: """قەڵاکە لە کۆتاییدا کەوت لە دوای هەفتەیەک لە شەڕی توند.""",
                    ...
                    SentencesRow(
                      englishText: """The fort was under attack for three days.""",
                      kurdishText: """قەڵاکە بۆ سێ ڕۆژ لە ژێر هێرشدا بوو.""",
...
const double _startSecondsone = 000000000000000000000000000793;
const String _videoIdtwo = 'https://youtu.be/XXhc5UTxv5I?t=';
const double _startSecondstwo = 000000000000000000000000000336;
const String _videoIdthree = 'https://youtu.be/py4zetCEYzA?t=';
const double _startSecondsthree = 00000000000000000000000000075;
const String _videoIdfour = 'https://youtu.be/xjmXzYdxuTQ?t=';
const double _startSecondsfour = 000000000000000000000000000833;
const String _videoIdfive = 'https://youtu.be/afKBOFONecE?t=';
