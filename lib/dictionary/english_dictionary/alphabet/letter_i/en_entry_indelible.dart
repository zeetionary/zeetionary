...
class EnglishEntryindelible extends StatefulWidget {
  const EnglishEntryindelible({super.key});

  @override
  State<EnglishEntryindelible> createState() => _EnglishEntryindelibleState();
}

class _EnglishEntryindelibleState extends State<EnglishEntryindelible> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indelible""");
  }
