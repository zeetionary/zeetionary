...
class EnglishEntrygnarled extends StatefulWidget {
  const EnglishEntrygnarled({super.key});

  @override
  State<EnglishEntrygnarled> createState() => _EnglishEntrygnarledState();
}

class _EnglishEntrygnarledState extends State<EnglishEntrygnarled> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gnarled""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""A gnarled tree trunk stood tall in the old forest.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His hands were gnarled with age and arthritis.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gnarled""",
                      // alsoEnglishWord: "also: gnarled",
                      britshText: """IpaUK: /nɑːld/""",
                      americanText: """IpaUS: /nɑːrld/""",
...
// With short examples define "gnarled", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """A gnarled tree trunk stood tall in the old forest.""",
                      kurdishText:
                          """قەدە دارێکی پێچاوی لە دارستانەکەدا بوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) چەماوە بەهۆی تەمەن و یان نەخۆشی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """His hands were gnarled with age and arthritis.""",
                      kurdishText:
                          """دەستەکانی چەمابوونەوە بەهۆی پیری و ئاوسان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Z0SzIkheaFg?t=';
const double _startSecondsend = 000000000000000000000000000756;
const String _videoIdone = 'https://youtu.be/M73XCOzZAU0?t=';
const double _startSecondsone = 000000000000000000000000000472;
const String _videoIdtwo = 'https://youtu.be/2LCTdBkLn3o?t=';
const double _startSecondstwo = 000000000000000000000000000291;
const String _videoIdthree = 'https://youtu.be/Z2wZkNvMtzo?t=';
const double _startSecondsthree = 000000000000000000000000000275;
const String _videoIdfour = 'https://youtu.be/-BLAUhBl0nA?t=';
const double _startSecondsfour = 0000000000000000000000000001478;
const String _videoIdfive = 'https://youtu.be/c2nVilB8QeY?t=';
const double _startSecondsfive = 000000000000000000000000000823;
