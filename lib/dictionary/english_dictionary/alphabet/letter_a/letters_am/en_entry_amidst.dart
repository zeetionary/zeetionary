...
// replace these: replace EnglishEntryamidst - replace speakAmidst - replace amidst - /əˈmɪdst/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryamidst extends StatelessWidget {
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "amidst"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈmɪdst/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈmɪdst/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'kh9aA6XJp1o';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'n_NwrouHt2U';
