...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000504;
    const String videoIdone = 'https://youtu.be/sV6uuMAnJUE?t=';
    const double startSecondsone = 000000000000000000000000000906;
    const String videoIdtwo = 'https://youtu.be/yRmOWcWdQAo?t=';
    const double startSecondstwo = 000000000000000000000000000377;
    const String videoIdthree = 'https://youtu.be/1Gxrwh4zGPg?t=';
    const double startSecondsthree = 0000000000000000000000000001155;
    const String videoIdfour = 'https://youtu.be/L1kYZHnHS0E?t=';
