...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 755;
    const String videoIdone = 'AF8d72mA41M';
    const double startSecondsone = 935;
    const String videoIdtwo = 'wJa5Ch0O4BI';
    const double startSecondstwo = 5331;
    const String videoIdthree = '4FFsSs5WDXc';
    const double startSecondsthree = 163;
    const String videoIdfour = 'QQyup6ZFsvA';
    const double startSecondsfour = 162;
    const String videoIdfive = 'CzP23Zti-YI';
    const double startSecondsfive = 1587;
