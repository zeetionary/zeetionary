...
// With short examples define "header", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) لێدان لە تۆپ بە سەر"""),
                    SentencesRow(
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) نووسینێک کە لە سەرەوەی هەموو پەڕەیەکی کتێبێک یان بەڵگەنامەیەک دەردەکەوێت"""),
                    SentencesRow(
                      englishText:
                          """The header gives the page number and date of the document.""",
                      kurdishText:
                          """سەرپەڕەکە ژمارەی لاپەڕە و بەرواری بەڵگەنامەکە دەدات.""",
