...
class EnglishEntrylucidly extends StatefulWidget {
  const EnglishEntrylucidly({super.key});

  @override
  State<EnglishEntrylucidly> createState() => _EnglishEntrylucidlyState();
}

class _EnglishEntrylucidlyState extends State<EnglishEntrylucidly> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylucidly lucidly
WORD_WEB lucidly lucidly lucidly
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lucidly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lucidly""");
  }
...
کوردی: 
"""),
// With short examples define "lucidly", please follow LX instructions
