...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'Fi66wFfOC-4';
    const double startSecondsend = 2595;
    const String videoIdone = 'lKq4q6lM2T0';
    const double startSecondsone = 301;
    const String videoIdtwo = 'BtBBBb9OQD0';
    const double startSecondstwo = 1345;
    const String videoIdthree = 'AaTRHFaaPG8';
    const double startSecondsthree = 1107;
    const String videoIdfour = 'y7_wd_FLvu0';
    const double startSecondsfour = 703;
    const String videoIdfive = 'BLKD2Wf8_wk';
    const double startSecondsfive = 10043;
