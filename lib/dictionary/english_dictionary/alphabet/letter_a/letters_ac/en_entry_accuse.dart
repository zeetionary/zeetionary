...
class EnglishEntryaccuse extends StatelessWidget {
  EnglishEntryaccuse({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'accuse', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈkjuːz/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAccuse(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'vfv5hGqj_MI';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '_ZmHwaqCxRY';
