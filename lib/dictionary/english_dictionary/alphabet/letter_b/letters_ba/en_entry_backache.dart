...
class EnglishEntrybackache extends StatelessWidget {
  ...
  Future<void> speakA3(String languageCode) async {
    ...
    await flutterTts.speak("backache"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakA3s1(String languageCode) async {
    ...
    await flutterTts.speak(
        "A lot of sitting gives me such backache."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "backache", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˈbækeɪk/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "دانیشتنی زۆر تووشی پشتئێشەم دەکات.",
                                    textAlign: TextAlign
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "gG29J2SVyj0";

  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 2143, // DOPSUM: CHANGE IT
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "6NYhhRXSOmo";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "HZUy-NjcoAc";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "zgK5BlrqGmM";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "-yt4EsinRjc";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "h2JJKpF-Ci8";
