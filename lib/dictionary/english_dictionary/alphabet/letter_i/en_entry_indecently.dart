...
class EnglishEntryindecently extends StatefulWidget {
  const EnglishEntryindecently({super.key});

  @override
  State<EnglishEntryindecently> createState() => _EnglishEntryindecentlyState();
}

class _EnglishEntryindecentlyState extends State<EnglishEntryindecently> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "indecently";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indecently""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He was charged with indecently assaulting five women.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was deemed to be indecently dressed.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/eOci27e2V8g?t=';
    const double startSecondsend = 00000000000000000000000000076;
    const String videoIdone = 'https://youtu.be/2SZ4NabR0gw?t=';
    const double startSecondsone = 0000000000000000000000000001350;
    const String videoIdtwo = 'https://youtu.be/xOM_ohW6FQc?t=';
    const double startSecondstwo = 0000000000000000000000000002047;
    const String videoIdthree = 'https://youtu.be/XMnuXn-jPLM?t=';
    const double startSecondsthree = 0000000000000000000000000002032;
    const String videoIdfour = 'https://youtu.be/TS3AlBuTxZk?t=';
    const double startSecondsfour = 000000000000000000000000000604;
    const String videoIdfive = 'https://youtu.be/NJN49geD2Ac?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indecently""",
                      // alsoEnglishWord: "also: indecently",
                      britshText: """IpaUK: /ɪnˈdiːsntli/""",
                      americanText: """IpaUS: /ɪnˈdiːsntli/""",
...
کوردی: بێ‌شەرمانە، نانەجیمانە، بێ‌ئابڕووانە
"""),
// With short examples define "indecently", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە لەلایەنی ئەخلاقییەوە بە خراپ دەدەنرێت بەهۆی ئەوەی کە باس لە سێکس یان ڕووتی دەکات"""),
                    SentencesRow(
                      englishText:
                          """He was charged with indecently assaulting five women.""",
                      kurdishText:
                          """تاوانبارکرا بە نانەجیمانە هێرشکردنە سەر پێنج ژن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) کە کەسێک بە شێوەیەک جل لەبەر بکات کە ئەو بەشە پیشان دەدات کە زۆرجار داپۆشراون"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She was deemed to be indecently dressed.""",
                      kurdishText: """وادانرا بێ‌شەرمانە جلی لەبەر بێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵکار) زۆر زۆر، زۆر زوو، هتد کە بە گونجاو دابنرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Chris is indecently cheerful for this time on a Saturday morning.""",
                      kurdishText:
                          """کریس ئێجگار دلخۆشە بەم کاتەی بەیانی شەممەیە.""",
