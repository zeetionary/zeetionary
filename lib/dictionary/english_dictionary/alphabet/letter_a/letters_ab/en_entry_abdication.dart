...
// replace these: EnglishEntryabdication - speakAbdication - /ˌæbdɪˈkeɪʃn/ - abdication
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'abdication', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌæbdɪˈkeɪʃn/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˌæbdɪˈkeɪʃn/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
١. کرداری وازھێنان لە پۆستی پاشایی یان شاژنی
                            ''',
...
class YoutubeEmbeddedOne extends StatelessWidget {
  static String myVideoId = '8yEnqYh5k-A';
...
class YoutubeEmbeddedTwo extends StatelessWidget {
  static String myVideoId = 'FJ6Jz8t1tAk';
