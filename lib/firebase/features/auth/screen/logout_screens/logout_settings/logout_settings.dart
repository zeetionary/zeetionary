...
// class SettingsPageLogout extends ConsumerWidget {
//   const SettingsPageLogout({super.key});
...
//                     child: Text(
//                       isKurdish
//                           ? 'بچۆ ژوورەوە بۆ گۆڕینی قەبارەی وشە'
//                           : 'Sign into an account to change text size',
//                       style: TextStyle(
//                         fontSize: textSize + 2,
//                         color: Colors.green,
//                       ),
...
//                     child: Text(
//                       isKurdish
//                           ? 'بچۆ ژوورەوە بۆ گۆڕینی دۆخ'
//                           : 'Sign into an account to change theme',
//                       style: TextStyle(
//                         fontSize: textSize + 2,
//                         color: Colors.green,
//                       ),
...
//                     child: Text(
//                       isKurdish
//                           ? 'بچۆ ژوورەوە بۆ گۆڕینی زمان'
//                           : 'Sign into an account to change language',
//                       style: TextStyle(
//                         fontSize: textSize + 2,
//                         color: Colors.green,
//                       ),
