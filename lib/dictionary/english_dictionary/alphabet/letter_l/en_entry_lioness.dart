...
class EnglishEntrylioness extends StatefulWidget {
  const EnglishEntrylioness({super.key});

  @override
  State<EnglishEntrylioness> createState() => _EnglishEntrylionessState();
}

class _EnglishEntrylionessState extends State<EnglishEntrylioness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lioness (Derived forms: lionesses)
1. A female lion
""",
  );

  final String keyword = "lioness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lioness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Lionesses hunting in groups have been found to be more successful than lionesses hunting alone.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""To the right, three lionesses and four cubs were feeding on a young zebra they must have killed just before dawn.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/H5QM8bI1vAA?t=387';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/nhZTfQhWCvI?t=151';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/IaxlnmGHg7s';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/LKUIqofoQNM?t=75';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/E5J_ARKyftA?t=124';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/kwQnIsl-xhs?t=41';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lioness""",
                      // alsoEnglishWord: "also: lioness",
                      britshText: """IpaUK: /ˈlaɪənes/""",
                      americanText: """IpaUS: /ˈlaɪənes/""",
...
کوردی: 
"""),
// With short examples define "lioness", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) شێری مێینە"""),
                    SentencesRow(
                      englishText: """Lionesses hunting in groups have been found to be more successful than lionesses hunting alone.""",
                      kurdishText: """دێڵەشێر کە بە گرووپ ڕاوبکەن وەها بینراوە کە سەرکەوتووتر بێت وەک لەوەی دێڵەشێر بە تەنها ڕاو بکات.""",
                    ...
                    SentencesRow(
                      englishText: """To the right, three lionesses and four cubs were feeding on a young zebra they must have killed just before dawn.""",
                      kurdishText: """لە ڕاستەوە، سێ دێڵەشێر و چوار بەچکە کەرەکێوییەکی گەنجیان دەخوارد کە بە ئەگەری زۆرەوە کەمێک پێش بەرەبەیان کوشتبوویان.""",
