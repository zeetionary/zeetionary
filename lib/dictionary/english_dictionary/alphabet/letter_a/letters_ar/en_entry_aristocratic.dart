...
class EnglishEntryaristocratic extends StatelessWidget {
  ...
  Future<void> speakaristocratic(String languageCode) async {
    ...
    await flutterTts.speak("aristocratic");
  }
  ...
  Future<void> speakaristocratic1214(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("They were impressed by his accent and aristocratic manner.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "aristocratic"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌærɪstəˈkrætɪk/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˌrɪstəˈkrætɪk/"),
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = '5pNL7MlUpmI';
  final double _startSeconds = 2387;
