...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000856;
    const String videoIdone = 'https://youtu.be/NUzDLpSkQTg?t=';
    const double startSecondsone = 000000000000000000000000000273;
    const String videoIdtwo = 'https://youtu.be/aCPNlZ7bvRc?t=';
    const double startSecondstwo = 00000000000000000000000000015;
    const String videoIdthree = 'https://youtu.be/3n99jqOdeSw?t=';
    const double startSecondsthree = 000000000000000000000000000305;
    const String videoIdfour = 'https://youtu.be/B18ss3dbRAI?t=';
    const double startSecondsfour = 000000000000000000000000000436;
    const String videoIdfive = 'https://youtu.be/fU-8Rg4CgeI?t=';
    const double startSecondsfive = 000000000000000000000000000852;
