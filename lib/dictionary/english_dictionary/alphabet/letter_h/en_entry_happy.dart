...
""",
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I don't know what you've done, but the boss isn't happy.""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""If there's anything you're not happy about, come and ask.""");
  }
  ...
  Future<void> speaksentence20(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We'd be only too happy to accept your invitation.""");
  }
  ...
  Future<void> speaksentence21(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""By a happy coincidence, we arrived at exactly the same time.""");
  }
...
// With short examples define "happy", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕووکەشانە دوو دڵدارەکە دڵخۆش دیار بوون.""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵناو) کە دەبێتە هۆکاری دڵخۆشی"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I have many happy memories from that time.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Those were the happiest days of my life.""",
                      kurdishText: """ئەوە دڵخۆشترین ڕۆژەکانی ژیانی بوو.""",
                      onPressedBritish: () => speaksentence11("en-GB"),
                      onPressedAmerican: () => speaksentence11("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) خواستنی هیوای بۆنەیەکی خۆش بۆ کەسێک"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ھاوەڵناو) ڕازی بەوەی شتێک باشە یان درووستە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I don't know what you've done, but the boss isn't happy.""",
                      kurdishText: """نازانم چیت کردووە، بەڵام سەرپەرشتیار دڵخۆش نییە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """If there's anything you're not happy about, come and ask.""",
                      kurdishText: """ئەگەر هەر شتێک هەیە پێی دڵخۆش نیت، وەرە و بپرسە.""",
                      onPressedBritish: () => speaksentence17("en-GB"),
                      onPressedAmerican: () => speaksentence17("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (ھاوەڵناو) ڕازی یان دڵخۆش بە کردنی شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """People seemed quite happy to help.""",
                      kurdishText: """خەڵکی زۆر دڵخۆش دیاربوون بۆ یارمەتیدان.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He will be more than happy to come with us.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We'd be only too happy to accept your invitation.""",
                      kurdishText: """زۆر دڵخۆش دەبین بانگهێشتەکەت پەسەند بکەین.""",
                    ...
                    SentencesRow(
                      englishText: """By a happy coincidence, we arrived at exactly the same time.""",
                      kurdishText: """بە ڕێکەوتێکی بەبەختانە، ڕێک لە هەمان کاتدا گەشتین.""",
