...
class EnglishEntryheirloom extends StatefulWidget {
  const EnglishEntryheirloom({super.key});

  @override
  State<EnglishEntryheirloom> createState() => _EnglishEntryheirloomState();
}

class _EnglishEntryheirloomState extends State<EnglishEntryheirloom> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heirloom (Derived forms: heirlooms)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heirloom""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This ring is a family heirloom.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heirloom""",
                      // alsoEnglishWord: "also: heirloom",
                      britshText: """IpaUK: /ˈeəluːm/""",
                      americanText: """IpaUS: /ˈerluːm/""",
...
کوردی: میرات، بەشەماو، بۆماوە، کەلەپوور
"""),
// With short examples define "heirloom", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) شتێکی گران‌بەها کە بۆ چەندین ساڵ هی یەک خێزان بووە"""),
                    SentencesRow(
                      englishText: """This ring is a family heirloom.""",
                      kurdishText: """ئەڵقە میراتێکی خێزانەکەیە.""",
...
const double _startSecondsend = 0000000000000000000000000001909;
const String _videoIdone = 'https://youtu.be/IxD2NbXzgpQ?t=';
const double _startSecondsone = 000000000000000000000000000243;
const String _videoIdtwo = 'https://youtu.be/APwwGy4GzK8?t=';
const double _startSecondstwo = 000000000000000000000000000119;
const String _videoIdthree = 'https://youtu.be/Ya2_Khcdwsk?t=';
...
const String _videoIdfive = 'https://youtu.be/q4IUhZMA9O0?t=';
