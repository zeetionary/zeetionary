...
class EnglishEntryduchy extends StatefulWidget {
  const EnglishEntryduchy({super.key});

  @override
  State<EnglishEntryduchy> createState() => _EnglishEntryduchyState();
}

class _EnglishEntryduchyState extends State<EnglishEntryduchy> {
  @override
  void initState() {
    super.initState();
  }
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "duchy");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: duchy");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /ˈdʌtʃi/");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakduchy(String languageCode) async {
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /ˈdʌtʃi/");
  }
}
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakduchys1(String languageCode) async {
    // DOPSUM: CHANGE speakduchy
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
...
// کوردی: دوک‌نشین، ناوچەی ژێردەسەڵاتی دوک یان دوشێس
// """),
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys200"""),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys2("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys2("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys300"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys3("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys3("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys400"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys4("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys4("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys500"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys5("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys5("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys600"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys6("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys6("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys700"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys7("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys7("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys800"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys8("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys8("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys900"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys9("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys9("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys_1000"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys10("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys10("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys1100"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys11("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys11("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys1200"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys12("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys12("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys1300"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys13("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys13("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys1400"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys14("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys14("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys1500"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys15("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys15("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys1600"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys16("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys16("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys1700"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys17("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys17("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys1800"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys18("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys18("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys1900"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys19("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys19("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys_2000"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys20("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys20("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys2100"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys21("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys21("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: """speakduchys2200"""),
          //           ExampleSentenceKurdish(text: """رستە_رستە_رستە_رستە."""),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakduchys22("en-GB"""),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakduchys22("en-US"""),
          //         ),
          //       ],
          //     ),
          //   ],
...
class _YoutubeEmbeddedtwoState extends State<YoutubeEmbeddedtwo> {
  ...
  final double _startSeconds = 9861;
...
class _YoutubeEmbeddedthreeState extends State<YoutubeEmbeddedthree> {
  late YoutubePlayerController _controller;
  final String _videoId = '36FZowtrSTk';
...
class _YoutubeEmbeddedfourState extends State<YoutubeEmbeddedfour> {
  late YoutubePlayerController _controller;
  final String _videoId = 'gdsa1gBOTDk';
...
class _YoutubeEmbeddedfiveState extends State<YoutubeEmbeddedfive> {
  late YoutubePlayerController _controller;
  final String _videoId = 'muK7iDXR7J4';
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  late YoutubePlayerController _controller;
  final String _videoId = 'KuBuJAA6MNk';
