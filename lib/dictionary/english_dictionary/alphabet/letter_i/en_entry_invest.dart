...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/EHJNGdFll4o?t=';
    const double startSecondsone = 000000000000000000000000000239;
    const String videoIdtwo = 'https://youtu.be/Cln0J87vulU?t=';
    const double startSecondstwo = 000000000000000000000000000263;
    const String videoIdthree = 'https://youtu.be/nGrB-5ieeMU?t=';
    const double startSecondsthree = 000000000000000000000000000443;
    const String videoIdfour = 'https://youtu.be/T48_SrFCdaQ?t=';
    const double startSecondsfour = 000000000000000000000000000410;
    const String videoIdfive = 'https://youtu.be/QtVL76gh09U?t=';
    const double startSecondsfive = 000000000000000000000000000275;
