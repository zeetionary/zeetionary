...
class EnglishEntryanemia extends StatefulWidget {
  const EnglishEntryanemia({super.key});

  @override
  State<EnglishEntryanemia> createState() => _EnglishEntryanemiaState();
}

class _EnglishEntryanemiaState extends State<EnglishEntryanemia> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakanemia558(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("The main symptoms of anemia are tiredness and pallor.");
  }
...
"""),
                    ...
                    SentencesRow(
                      ...
                      onPressedAmerican: () => speakanemia558("en-US"),
                    ),
