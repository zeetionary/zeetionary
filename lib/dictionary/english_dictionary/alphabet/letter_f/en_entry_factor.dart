...
class EnglishEntryfactor extends StatefulWidget {
  const EnglishEntryfactor({super.key});

  @override
  State<EnglishEntryfactor> createState() => _EnglishEntryfactorState();
}

class _EnglishEntryfactorState extends State<EnglishEntryfactor> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """factor""",
                      // alsoEnglishWord: "also: factor",
                      britshText: """IpaUK: /ˈfæktə(r)/""",
                      americanText: """IpaUS: /ˈfæktər/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts
        .speak("""Obesity is a major risk factor for heart disease.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts
        .speak("""The result will depend on a number of different factors.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""1, 2, 3, 4, 6 and 12 are the factors of 12.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) یەکێک لەو ژمارە شتەی کە کاریگەری لە شتێک دەکەن"""),
          SentencesRow(
            englishText:
          ...
          SentencesRow(
            ...
            kurdishText:
                """ئەنجامەکە پشت بە ژمارەیەک فاکتەری جیاواز دەبەستێت.""",
          ...
          SentencesRow(
            englishText:
                """The closure of the mine was the single most important factor in the town's decline.""",
            kurdishText:
                """داخستنی کانەکە گرنگترین تاکە پاڵنەری پووکانەوەی شارۆچکەکە بوو.""",
          ...
          SentencesRow(
            englishText:
                """The real wage of the average worker has increased by a factor of over ten in the last 70 years.""",
            kurdishText:
                """مووچەی ڕاستیی کرێکارێکی ئاسایی زیادی کردووە بە ڕێژەی سەروو ١٠ لە ٧٠ ساڵی ڕابردوودا.""",
...
2. One of two or more integers that can be exactly divided into another integer (= divisor)
"what are the 4 factors of 6?";
 
3. A businessman who buys or sells for another in exchange for a commission (= agent, broker)
...
const double _startSecondsend = 885;
const String _videoIdone = 'rEdl2Uetpvo';
const double _startSecondsone = 165;
const String _videoIdtwo = 'kHrjgWoy8qY';
