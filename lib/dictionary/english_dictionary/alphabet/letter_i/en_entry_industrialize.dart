...
class EnglishEntryindustrialize extends StatefulWidget {
  const EnglishEntryindustrialize({super.key});

  @override
  State<EnglishEntryindustrialize> createState() =>
      _EnglishEntryindustrializeState();
}

class _EnglishEntryindustrializeState extends State<EnglishEntryindustrialize> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: industrialize (Derived forms: industrialized, industrializes, industrializing)
1. Organize (the production of something) into an industry (- industrialise [Brit])
"The Chinese industrialized textile production";
 
2. Develop industry; become industrial (- industrialise [Brit])
"The nations of South East Asia will quickly industrialize and catch up with the West";
""",
  );

  final String keyword = "industrialize";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""industrialize""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/qw-FLc7Z01Q?t=';
    ...
    const String videoIdtwo = 'https://youtu.be/nRnuY1Vao0o?t=';
    const double startSecondstwo = 000000000000000000000000000760;
    const String videoIdthree = 'https://youtu.be/d0rZDL4lL-4?t=';
    const double startSecondsthree = 0000000000000000000000000001453;
    const String videoIdfour = 'https://youtu.be/lejDbulJN54?t=';
    const double startSecondsfour = 000000000000000000000000000181;
    const String videoIdfive = 'https://youtu.be/uDsmQRGdL6k?t=';
    const double startSecondsfive = 000000000000000000000000000918;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """industrialize""",
                      // alsoEnglishWord: "also: industrialize",
                      britshText: """IpaUK: /ɪnˈdʌstriəlaɪz/""",
                      americanText: """IpaUS: /ɪnˈdʌstriəlaɪz/""",
...
کوردی: 
"""),
// With short examples define "industrialize", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) درووستبوونی پیشەسازی لە وڵاتێک یان ناوچەیەک"""),
                    SentencesRow(
                      englishText:
                          """The southern part of the country was slow to industrialize.""",
                      kurdishText:
                          """بەشی باشووری وڵاتەکە هێواش بوو لە بوون بە پیشەسازی.""",
