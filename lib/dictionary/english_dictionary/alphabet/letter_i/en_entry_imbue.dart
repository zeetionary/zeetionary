...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '_fnhy5xO9vQ';
    const double startSecondsend = 377;
    const String videoIdone = '2MZZrDA-I4M';
    const double startSecondsone = 84;
    const String videoIdtwo = 'N5FQRGfPy8I';
    const double startSecondstwo = 2944;
    const String videoIdthree = 'v5tJBLfeurU';
    const double startSecondsthree = 204;
    const String videoIdfour = 'FJocv6OyEFk';
    const double startSecondsfour = 435;
    const String videoIdfive = 'ABtt5y-maO4';
