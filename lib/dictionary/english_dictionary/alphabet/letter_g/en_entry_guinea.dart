...
class EnglishEntryguinea extends StatefulWidget {
  const EnglishEntryguinea({super.key});

  @override
  State<EnglishEntryguinea> createState() => _EnglishEntryguineaState();
}

class _EnglishEntryguineaState extends State<EnglishEntryguinea> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: guinea (Derived forms: guineas)
1. A former British gold coin worth 21 shillings
 
2. A west African bird having dark plumage mottled with white; native to Africa but raised for food in many parts of the world (- guinea fowl, Numida meleagris)
""",
  );

  final String keyword = "guinea";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He paid a guinea for the book.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """guinea""",
                      // alsoEnglishWord: "also: guinea",
                      britshText: """IpaUK: /ˈɡɪni/""",
                      americanText: """IpaUS: /ˈɡɪni/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دراوێکی زێڕی سکەیی بەریتانی کە یەکسانە بە نزیکەی کەمێک زیاتر لە یەک پاوەند"""),
                    SentencesRow(
                      englishText: """He paid a guinea for the book.""",
                      kurdishText: """یەک گینی دا بە کتێبەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/YkmlPaGui5k?t=';
const double _startSecondsend = 0000000000000000000000000001878;
const String _videoIdone = 'https://youtu.be/VZmn_Ws-0hA?t=';
const double _startSecondsone = 000000000000000000000000000746;
const String _videoIdtwo = 'https://youtu.be/inyZwa9rzpg?t=';
const double _startSecondstwo = 0000000000000000000000000008;
const String _videoIdthree = 'https://youtu.be/4Fy-s6L_2O0?t=';
const double _startSecondsthree = 00000000000000000000000000025;
const String _videoIdfour = 'https://youtu.be/AGVkGhtsjIk?t=';
const double _startSecondsfour = 00000000000000000000000000013;
const String _videoIdfive = 'https://youtu.be/kXiN1HE8aSk';
