...
// replace EnglishEntryAdopsummm - replace speakArms

// replace arms - /ɑːmz/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarms extends StatelessWidget {
  // blank divider
  EnglishEntryarms({super.key});
  // blank divider
  ...
  Future<void> speakarms705(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("The UN imposed an arms embargo on the country.");
  }
  ...
  Future<void> speakarms706(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("He's the world's most notorious arms dealer.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arms"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ɑːmz/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ɑːrmz/"),
...
١. (ناو) ئەو چەکانەی لەلایەن سوپاوە بەکاردێن"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakarms705("en-US"),
                          ),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakarms706("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
2. (heraldry) the official symbols of a family, state, etc. (= coat of arms, blazon, blazonry)
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'cG0cbZjMU1s';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '-NJW9vsF0aE';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'fmdMnqWfGLA';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'fAURqUnx7gE';
