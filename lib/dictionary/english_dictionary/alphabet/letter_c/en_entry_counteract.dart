...
class EnglishEntrycounteract extends StatefulWidget {
  const EnglishEntrycounteract({super.key});

  @override
  State<EnglishEntrycounteract> createState() => _EnglishEntrycounteractState();
}

class _EnglishEntrycounteractState extends State<EnglishEntrycounteract> {
  @override
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: counteract");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /ˌkaʊntərˈækt/");
  }
}
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /ˌkaʊntərˈækt/");
  }
}
