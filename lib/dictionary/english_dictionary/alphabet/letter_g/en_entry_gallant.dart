...
class EnglishEntrygallant extends StatefulWidget {
  const EnglishEntrygallant({super.key});

  @override
  State<EnglishEntrygallant> createState() => _EnglishEntrygallantState();
}

class _EnglishEntrygallantState extends State<EnglishEntrygallant> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gallant""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She made a gallant attempt to hide her tears.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gallant""",
                      // alsoEnglishWord: "also: gallant",
                      britshText: """IpaUK: /ˈɡælənt/""",
                      americanText: """IpaUS: /ˈɡælənt/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """That wasn't very gallant of you, Paul, pushing a young lady out of the way like that!""",
                      kurdishText:
                          """ئەوە زۆر لە بەڕەوشتیت نەبوو پاوڵ، کە ژنێکی گەنج بەو شێوەیە لەسەر ڕێگاکە پاڵ بنێیت.""",
...
const String _videoIdend = 'xpSaVRJqs1g?t=';
const double _startSecondsend = 512;
const String _videoIdone = 'n3U2Jx6BVK4?t=';
const double _startSecondsone = 594;
const String _videoIdtwo = 'O6Duf496Ips?t=';
const double _startSecondstwo = 178;
const String _videoIdthree = 'H5yvhP-9mik?t=';
const double _startSecondsthree = 531;
const String _videoIdfour = 'Z-JdfXxNflg?t=';
const double _startSecondsfour = 724;
const String _videoIdfive = '60fWsMyZfX0?t=';
const double _startSecondsfive = 4510;
