...
// """),
          const DefinitionKurdish(
              text:
                  """١. (کردار) بنیاتنانی دیوارێک، پەرژینێک، هتد بە دەوری شتێکدا"""),
          SentencesRow(
...
// With short examples define "enclose", please follow LX instructions
          ...
          SentencesRow(
            ...
            kurdishText:
                """هەموو وشەیەکی وەرگێڕدراو دەبێت بخردرێتە ناو کەوانە .""",
          ...
          SentencesRow(
            ...
            kurdishText: """(خوازراوی) هەستی دەکرد باڵی لە دەوری ئاڵابوو.""",
          ...
          const DefinitionKurdish(
              text:
                  """٣. (کردار) ناردنی شتێک لە هەمان پاکەت یان بەرگەنامەی شتێکی دیکە"""),
          // const DividerSentences(),
          SentencesRow(
            englishText:
                """Please return the completed form, enclosing a recent photograph.""",
            kurdishText:
                """تکایە فۆرمەکە بە تەواوی بگەڕێنەوە، هاوپێچ لەگەڵ وێنەیەکی تازە.""",
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/ktVSavCov9Y?t=';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/xZL3YRZOMW4?t=';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/tqWXteVXo-A?t=';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/PVs_xZ46Cxw?t=';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/tSfrKccioxA?t=';
