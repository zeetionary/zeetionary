...
// With short examples define "enable", please follow LX instructions
          ...
          SentencesRow(
            ...
            kurdishText:
                """ئینسۆلین ڕێگا بە جەستە دەدات کە شەکر بەکاربهێنێت و کۆگای بکات.""",
          ...
          SentencesRow(
            englishText:
                """The irrigation scheme has enabled the development of many small farms.""",
            kurdishText:
                """پلانە ئاودێرییەکە هەلی ڕەخساندووە بۆ زۆر کێڵگەی بچووک.""",
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/CaaJyRvvaq8?t=';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/DfSnHyIryeY?t=';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/cqidD7kVnxY?t=';
