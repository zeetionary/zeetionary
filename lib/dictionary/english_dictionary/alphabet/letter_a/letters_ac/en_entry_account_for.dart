...
class EnglishEntryaccountfor extends StatefulWidget {
  const EnglishEntryaccountfor({super.key});

  @override
  State<EnglishEntryaccountfor> createState() => _EnglishEntryaccountforState();
}

class _EnglishEntryaccountforState extends State<EnglishEntryaccountfor> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "account for";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """account for""",
                      // alsoEnglishWord: "also: account for",
                      britshText: """IpaUK: /əˈkaʊnt fə(r)/""",
                      americanText: """IpaUS: /əˈkaʊnt fər/""",
