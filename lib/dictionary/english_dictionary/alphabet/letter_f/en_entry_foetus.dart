...
class EnglishEntryfoetus extends StatefulWidget {
  const EnglishEntryfoetus({super.key});

  @override
  State<EnglishEntryfoetus> createState() => _EnglishEntryfoetusState();
}

class _EnglishEntryfoetusState extends State<EnglishEntryfoetus> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foetus (Derived forms: foetuses)
Usage: Brit, Cdn (US: fetus)
1. An unborn or unhatched vertebrate in the later stages of development showing the main recognizable features of the mature animal (= fetus)
"she didn't want to know the sex of the foetus";
""",
  );

  final String keyword = "foetus";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        """In some countries there are laws banning doctors from telling pregnant women the sex of the foetus.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foetus""",
                      // alsoEnglishWord: "also: foetus",
                      britshText: """IpaUK: /ˈfiːtəs/""",
                      americanText: """IpaUS: /ˈfiːtəs/""",
...
// With short examples define "foetus", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کۆرپەلەی مرۆڤ یان ئاژەڵ، بە تایبەتی هەشت هەفتە لە دوای پیتاندن"""),
                    SentencesRow(
                      englishText:
                          """Could the anti-nausea tablets she had been prescribed harm the foetus?""",
                      kurdishText:
                          """دەکرێت ئەو دژە دڵ‌تێکهەڵاتنەی کە پێیدرا زیانی بە کۆرپەلەکە گەیاندبێت؟""",
                    ...
                    SentencesRow(
                      englishText:
                          """In some countries there are laws banning doctors from telling pregnant women the sex of the foetus.""",
                      kurdishText:
                          """لە ژمارەیەک وڵات یاسا هەیە کە ڕێگری لە پزیشکان دەکات ڕەگەزی کۆرپەلە بە ژنانی دوگیان بڵێن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/8fvXa5BhR3Y?t=';
const double _startSecondsend = 000000000000000000000000000801;
const String _videoIdone = 'https://youtu.be/zUrDUxh5xS0?t=';
const double _startSecondsone = 000000000000000000000000000349;
const String _videoIdtwo = 'https://youtu.be/BVCZOpGsFkM?t=';
const double _startSecondstwo = 000000000000000000000000000494;
const String _videoIdthree = 'https://youtu.be/H1UZOI1BmD4?t=';
const double _startSecondsthree = 000000000000000000000000000366;
const String _videoIdfour = 'https://youtu.be/WY3rrtRL3os?t=';
const double _startSecondsfour = 000000000000000000000000000609;
const String _videoIdfive = 'https://youtu.be/9Byo0th_muc?t=';
