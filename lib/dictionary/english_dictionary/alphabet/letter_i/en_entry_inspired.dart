...
class EnglishEntryinspired extends StatefulWidget {
  const EnglishEntryinspired({super.key});

  @override
  State<EnglishEntryinspired> createState() => _EnglishEntryinspiredState();
}

class _EnglishEntryinspiredState extends State<EnglishEntryinspired> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inspired""");
  }
