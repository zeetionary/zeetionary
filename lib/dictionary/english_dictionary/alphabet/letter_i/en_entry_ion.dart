...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'hUBsxCcJeUc';
    const double startSecondsone = 417;
    const String videoIdtwo = 'JxGP9cYbwdk';
    const double startSecondstwo = 70;
    const String videoIdthree = '4-1psMHSpKs';
    const double startSecondsthree = 308;
    const String videoIdfour = 'TVrlbMrEcCY';
    const double startSecondsfour = 6;
    const String videoIdfive = 'G5McJw4KkG8';
