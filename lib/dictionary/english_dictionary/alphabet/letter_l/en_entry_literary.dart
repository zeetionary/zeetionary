...
class EnglishEntryliterary extends StatefulWidget {
  const EnglishEntryliterary({super.key});

  @override
  State<EnglishEntryliterary> createState() => _EnglishEntryliteraryState();
}

class _EnglishEntryliteraryState extends State<EnglishEntryliterary> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""literary""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Literary critics raved over his novels.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It was Chaucer who really turned English into a literary language.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was one of the great literary figures of her age.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/VVsdb90aOmA?t=2434';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/y4DTW4B3Sjs?t=410';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/ZOvyn72x6kQ?t=333';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/-aSdFrPnlRg?t=1102';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/Z4pkE3OFpkc?t=1866';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/J0mZYeb4C8k?t=292';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """literary""",
                      // alsoEnglishWord: "also: literary",
                      britshText: """IpaUK: /ˈlɪtərəri/""",
                      americanText: """IpaUS: /ˈlɪtəreri/""",
...
کوردی: وێژەیی، ئەدەبی، سەربە وێژە یان تۆرە
"""),
// With short examples define "literary", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) پەیوەندیدار بە وێژە"""),
                    SentencesRow(
                      englishText: """Literary critics raved over his novels.""",
                      kurdishText: """ڕەخنەگرە وێژەییاکان سەرسام بوون بە ڕۆمانەکانی.""",
                      englishNote: """This means reviewers who analyze and evaluate literature highly praised his novels, expressing admiration and enthusiasm.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵناو) زمانێک کە لە زمانی نووسینی وێژەیی دەچێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """It was Chaucer who really turned English into a literary language.""",
                      kurdishText: """ئەوە چۆسەر بوو کە زمانی ئینگلیزیی کرد بە زمانێکی وێژەیی.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ھاوەڵناو) کە زۆر حەزی بە وێژە هەیە؛ کە وێژە دەنووسێت یان لێکۆڵینەوەی لێ دەکات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She was one of the great literary figures of her age.""",
                      kurdishText: """یەکێک لە کەسایەتییە گەورەکانی وێژە بوو لە سەردەمەکەیدا.""",
