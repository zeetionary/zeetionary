...
class EnglishEntrylefthand extends StatefulWidget {
  const EnglishEntrylefthand({super.key});

  @override
  State<EnglishEntrylefthand> createState() => _EnglishEntrylefthandState();
}

class _EnglishEntrylefthandState extends State<EnglishEntrylefthand> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""left-hand""");
  }
