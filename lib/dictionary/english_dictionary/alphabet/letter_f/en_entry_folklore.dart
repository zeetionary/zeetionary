...
class EnglishEntryfolklore extends StatefulWidget {
  const EnglishEntryfolklore({super.key});

  @override
  State<EnglishEntryfolklore> createState() => _EnglishEntryfolkloreState();
}

class _EnglishEntryfolkloreState extends State<EnglishEntryfolklore> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""folklore""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The story rapidly became part of family folklore.""");
  }
...
// With short examples define "folklore", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Local folklore has it that prehistoric men drove cattle over these cliffs.""",
                      kurdishText:
                          """فۆلکلۆری خۆجێیی دەڵێت پیاوانی پێش مێژوو ڕەشەوڵاخیان بەم قەدپاڵانەدا دەبرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """چیرۆکەکە زوو بوو بە فۆلکلۆری خێزانی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/QjmAqnokOgg?t=';
const double _startSecondsend = 00000000000000000000000000048;
const String _videoIdone = 'https://youtu.be/ErPsyBUCijM?t=';
const double _startSecondsone = 000000000000000000000000000584;
const String _videoIdtwo = 'https://youtu.be/GaLdHd2J-xM?t=';
const double _startSecondstwo = 0000000000000000000000000001075;
const String _videoIdthree = 'https://youtu.be/UopANFTGexA?t=';
const double _startSecondsthree = 000000000000000000000000000147;
const String _videoIdfour = 'https://youtu.be/B3VHd2D-SLM?t=';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/l4XS-T-r4S8?t=';
