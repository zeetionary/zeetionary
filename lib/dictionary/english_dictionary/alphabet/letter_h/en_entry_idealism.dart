...
class EnglishEntryidealism extends StatefulWidget {
  const EnglishEntryidealism({super.key});

  @override
  State<EnglishEntryidealism> createState() => _EnglishEntryidealismState();
}

class _EnglishEntryidealismState extends State<EnglishEntryidealism> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: idealism (Derived forms: idealisms)
...
3. Elevated ideals or conduct; the quality of believing that ideals should be pursued (- high-mindedness, noble-mindedness)
""",
  );

  final String keyword = "idealism";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""idealism""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was full of youthful idealism.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Idealism has no place in modern politics.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/RO30qBPT94s?t=';
    const double startSecondsend = 000000000000000000000000000113;
    const String videoIdone = 'https://youtu.be/4jwBxxgYcaw?t=';
    const double startSecondsone = 000000000000000000000000000613;
    const String videoIdtwo = 'https://youtu.be/1rBcZTRx9o4?t=';
    const double startSecondstwo = 00000000000000000000000000019;
    const String videoIdthree = 'https://youtu.be/1X_KdkoGxSs?t=';
    const double startSecondsthree = 0000000000000000000000000006636;
    const String videoIdfour = 'https://youtu.be/cGyj9M05LxA?t=';
    const double startSecondsfour = 0000000000000000000000000001334;
    const String videoIdfive = 'https://youtu.be/cTRUpxtGM44?t=';
    const double startSecondsfive = 000000000000000000000000000438;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """idealism""",
                      // alsoEnglishWord: "also: idealism",
                      britshText: """IpaUK: /aɪˈdiːəlɪzəm/""",
                      americanText: """IpaUS: /aɪˈdiːəlɪzəm/""",
...
// کوردی: ئایدیاڵیزم، ئایدیاباوەڕی، ئیدەباوەڕی، ئایدیاگەری، نموونەباوەڕی
// """),
// With short examples define "idealism", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) باوەڕی ئەوەی کە دۆخێک، ژیانێک، هتد ــی ناوازە دەکرێت بەدەست بێت ئەگەرچی ئەگەری کەم بێت"""),
                    SentencesRow(
                      englishText: """He was full of youthful idealism.""",
                      kurdishText: """پڕ لە ئایدیاڵیزمی گەنجانە بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئایدیاڵیزم هیچ جێگای نییە لە سیاسەتی سەردەمدا.""",
