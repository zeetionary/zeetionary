...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lectureship (Derived forms: lectureships)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His lectureship at the college lasted five years.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/B4xWUgykSEw?t=66';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/akVL7QY0S8A?t=216';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/0hybqg81n-M?t=1511';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/q9ksgLrPCkg?t=53';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/7BOwqGBLFnI?t=86';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/fHK0G3GaZ3c?t=203';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      britshText: """IpaUK: /ˈlektʃəʃɪp/""",
                      americanText: """IpaUS: /ˈlektʃərʃɪp/""",
...
کوردی: 
"""),
                    const DefinitionKurdish(text: """١. (ناو) ئەوەی وانە بڵێیتەوە لە زانکۆیەک یان کۆلێژێک (لە بەریتانیا)"""),
                    SentencesRow(
                      englishText: """His lectureship at the college lasted five years.""",
                      kurdishText: """وانەبێژییەکەی لە کۆلێژەکە پێنج ساڵی خایاند.""",
