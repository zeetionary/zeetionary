...
class EnglishEntrygrisly extends StatefulWidget {
  const EnglishEntrygrisly({super.key});

  @override
  State<EnglishEntrygrisly> createState() => _EnglishEntrygrislyState();
}

class _EnglishEntrygrislyState extends State<EnglishEntrygrisly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: grisly (Derived forms: grislier, grisliest)
1. Shockingly repellent; inspiring horror (- ghastly, grim, gruesome, macabre, sick)
"a grisly murder";
""",
  );

  final String keyword = "grisly";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The 55-year-old Canadian had suffered a grisly death.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grisly""",
                      // alsoEnglishWord: "also: grisly",
                      britshText: """IpaUK: /ˈɡrɪzli/""",
                      americanText: """IpaUS: /ˈɡrɪzli/""",
...
// With short examples define "grisly", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پیاوە کەنەدییەکە ٥٥ ساڵانەکە تووشی مەرگێکی ترسێنەر بووە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/j9h2-ZVDLB8?t=';
const double _startSecondsend = 0000000000000000000000000001023;
const String _videoIdone = 'https://youtu.be/lDeFSOUHdH4?t=';
const double _startSecondsone = 0000000000000000000000000001131;
const String _videoIdtwo = 'https://youtu.be/bfScSo3lkwo?t=';
const double _startSecondstwo = 000000000000000000000000000412;
const String _videoIdthree = 'https://youtu.be/aABFIzfg72A?t=';
...
const String _videoIdfive = 'https://youtu.be/hDpoRqc7qZ4?t=';
