...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakactual7618("en-US"),
                          ),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakactua9487("en-US"),
                          ),
                          const DividerDefinition(),
...
٢. (ھاوەڵکار) بەکاردێت بۆ وتنی ڕاستی بابەتێک و بەراوردکردنی لەگەڵ باوەڕی کەسێک لەسەری"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakactu35269("en-US"),
                          ),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٣. (ھاوەڵکار) بەکاردێت بۆ بە ڕێزەوە ڕاستکردنەوەی کەسێک"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakactu4562("en-US"),
                          ),
                        ],
                      ),
                    ),
