...
class EnglishEntryinjury extends StatefulWidget {
  const EnglishEntryinjury({super.key});

  @override
  State<EnglishEntryinjury> createState() => _EnglishEntryinjuryState();
}

class _EnglishEntryinjuryState extends State<EnglishEntryinjury> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryinjury injury
WORD_WEB injury injury injury
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "injury";
...
کوردی: 
"""),
// With short examples define "injury", please follow LX instructions
