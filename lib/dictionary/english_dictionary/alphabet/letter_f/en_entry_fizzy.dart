...
class EnglishEntryfizzy extends StatefulWidget {
  const EnglishEntryfizzy({super.key});

  @override
  State<EnglishEntryfizzy> createState() => _EnglishEntryfizzyState();
}

class _EnglishEntryfizzyState extends State<EnglishEntryfizzy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fizzy (Derived forms: fizzier, fizziest)
1. Hissing and bubbling (= fizzing)
"All fizzy drinks contain the gas carbon dioxide";
""",
  );

  final String keyword = "fizzy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The wine was pink and slightly fizzy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fizzy""",
                      // alsoEnglishWord: "also: fizzy",
                      britshText: """IpaUK: /ˈfɪzi/""",
                      americanText: """IpaUS: /ˈfɪzi/""",
...
// کوردی: هەڵچوو و گازدار
// """),
// With short examples define "fizzy", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە کەفی گازی تێدایە"""),
                    SentencesRow(
                      englishText: """The wine was pink and slightly fizzy.""",
                      kurdishText: """شەرابەکە پەمەیی و کەمێک گازدار بوو.""",
...
const double _startSecondsend = 0000000000000000000000000001232;
const String _videoIdone = 'https://youtu.be/g3Ud6mHdhlQ?t=';
const double _startSecondsone = 0000000000000000000000000001348;
const String _videoIdtwo = 'https://youtu.be/Cbyyksb5CRc?t=';
const double _startSecondstwo = 000000000000000000000000000263;
const String _videoIdthree = 'https://youtu.be/XgGIg_KlJsY?t=';
const double _startSecondsthree = 000000000000000000000000000470;
const String _videoIdfour = 'https://youtu.be/l1p--Mr63Gg?t=';
const double _startSecondsfour = 000000000000000000000000000336;
const String _videoIdfive = 'https://youtu.be/26VzqQd-bZg?t=';
