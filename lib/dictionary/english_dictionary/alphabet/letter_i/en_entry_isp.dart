...
class EnglishEntryisp extends StatefulWidget {
  const EnglishEntryisp({super.key});

  @override
  State<EnglishEntryisp> createState() => _EnglishEntryispState();
}

class _EnglishEntryispState extends State<EnglishEntryisp> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryisp ISP
WORD_WEB ISP ISP ISP
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "ISP";
...
// کوردی:
// """),
// With short examples define "ISP", please follow LX instructions
