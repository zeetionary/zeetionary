...
class EnglishEntryfragmentary extends StatefulWidget {
  const EnglishEntryfragmentary({super.key});

  @override
  State<EnglishEntryfragmentary> createState() =>
      _EnglishEntryfragmentaryState();
}

class _EnglishEntryfragmentaryState extends State<EnglishEntryfragmentary> {
  @override
  void initState() {
    super.initState();
...
1. Consisting of small disconnected parts (= fragmental)
"fragmentary remains";
""",
  );

  final String keyword = "fragmentary";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fragmentary""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fragmentary""",
                      // alsoEnglishWord: "also: fragmentary",
                      britshText: """IpaUK: /ˈfræɡməntri/""",
                      americanText: """IpaUS: /ˈfræɡmənteri/""",
...
// With short examples define "fragmentary", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """There is only fragmentary evidence to support this theory.""",
                      kurdishText:
                          """تەنها بەڵگەی ناتەواو هەیە بۆ پشتگیری ئەم بیردۆزە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/4utNXOfQ4cM?t=';
const double _startSecondsend = 000000000000000000000000000544;
const String _videoIdone = 'https://youtu.be/nEnklxGAmak?t=';
const double _startSecondsone = 000000000000000000000000000565;
const String _videoIdtwo = 'https://youtu.be/vgulGB4U4FU?t=';
const double _startSecondstwo = 000000000000000000000000000256;
const String _videoIdthree = 'https://youtu.be/EaDxLCKFvlE?t=';
const double _startSecondsthree = 000000000000000000000000000253;
const String _videoIdfour = 'https://youtu.be/7iJ29LJp-wk?t=';
const double _startSecondsfour = 000000000000000000000000000543;
const String _videoIdfive = 'https://youtu.be/ycOBZZeVeAc?t=';
