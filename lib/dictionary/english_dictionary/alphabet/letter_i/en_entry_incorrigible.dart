...
class EnglishEntryincorrigible extends StatefulWidget {
  const EnglishEntryincorrigible({super.key});

  @override
  State<EnglishEntryincorrigible> createState() =>
      _EnglishEntryincorrigibleState();
}

class _EnglishEntryincorrigibleState extends State<EnglishEntryincorrigible> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incorrigible""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She thought the children were incorrigible brats.""");
  }
...
// With short examples define "incorrigible", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) هەبوونی خووی خراپ کە ناگۆڕدرێن"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وای بیردەکردەوە منداڵەکان لاساری بەدخوو بن.""",
