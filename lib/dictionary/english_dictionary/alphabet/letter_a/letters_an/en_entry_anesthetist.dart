...
class EnglishEntryanesthetist extends StatelessWidget {
  ...
  Future<void> speakanesthetist4805(String languageCode) async {
    ...
    await flutterTts.speak(
        "The anesthetist tried three times to insert the anaesthetic."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "anesthetist"), // Find /əˈniːsθətɪst/
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            CustomIconButtonBritish(
                              onPressed: () => speakanesthetist("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            CustomIconButtonAmerican(
                              onPressed: () => speakanesthetist("en-US"),
                            ),
                          ],
                        ),
                      ],
