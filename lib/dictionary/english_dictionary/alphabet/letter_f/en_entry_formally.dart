...
class EnglishEntryformally extends StatefulWidget {
  const EnglishEntryformally({super.key});

  @override
  State<EnglishEntryformally> createState() => _EnglishEntryformallyState();
}

class _EnglishEntryformallyState extends State<EnglishEntryformally> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""formally""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""‘How do you do?’ she said formally.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The accounts were formally approved by the board.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Formally, the distinction between town and country workers was clear, but in practice there was some overlap.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """formally""",
                      // alsoEnglishWord: "also: formally",
                      britshText: """IpaUK: /ˈfɔːməli/""",
                      americanText: """IpaUS: /ˈfɔːrməli/""",
...
// With short examples define "formally", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵکار) بەشێوەیەک کە گونجاوە بۆ بۆنەی گرنگ یان فەرمی"""),
                    SentencesRow(
                      englishText:
                          """‘How do you do?’ she said formally.""",
                      kurdishText: """بە فەرمییەوە گوتی 'ئەحواڵت چۆنە؟'""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵکار) بەشێوەیەک کە شوێن شێوازی فەرمی کارێک دەکەوێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The accounts were formally approved by the board.""",
                      kurdishText: """هەژمارەکان بە فەرمی لەلایەن دەستەکەوە پەسەند دەکران.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ھاوەڵکار) لە ڕێگەی وانە و تاقیکردنەوەوە کە لە قوتابخانە، کۆلێژ، یان زانکۆ وەردەگیرێت نەک ئەزموونی کردارەکی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Although not formally trained as an art historian, he is widely respected for his knowledge of the period.""",
                      kurdishText: """ئەگەرچی بە فەرمی وەک مێژوونووسی هونەری ڕاهێننای وەرنەگرتووە، تەواو ڕێزی لێ دەنرێت بۆ زانیاریی لەسەر سەردەمەکە.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ھاوەڵکار) بەو شێوازەی کە شتێک دەردەکەوێت یان پێشکەش دەکرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Formally, the distinction between town and country workers was clear, but in practice there was some overlap.""",
                      kurdishText: """بە فەرمی، جیاوازی نێوان کرێکارانی شارۆچکە و لادێ ڕوون بوو، بەڵام بە کرداری ژمارەیەک بەرکەوتن هەبوون.""",
                      englishNote: """This means that officially the difference between town and country workers was well-defined, but in reality, there were some similarities or interactions between them.""",
...
const String _videoIdone = 'https://youtu.be/FUHkTs-Ipfg?t=';
const double _startSecondsone = 000000000000000000000000000494;
const String _videoIdtwo = 'https://youtu.be/48jBi86ih5Q';
...
const String _videoIdfour = 'https://youtu.be/KZbzIf_C6Y4?t=';
