...
class EnglishEntryhaughtiness extends StatefulWidget {
  const EnglishEntryhaughtiness({super.key});

  @override
  State<EnglishEntryhaughtiness> createState() =>
      _EnglishEntryhaughtinessState();
}

class _EnglishEntryhaughtinessState extends State<EnglishEntryhaughtiness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: haughtiness
1. Overbearing pride evidenced by a superior manner toward inferiors (- arrogance, hauteur, high-handedness, lordliness)
""",
  );

  final String keyword = "haughtiness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""haughtiness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He spoke with obvious haughtiness to the waiter.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """haughtiness""",
                      // alsoEnglishWord: "also: haughtiness",
                      britshText: """IpaUK: /ˈhɔːtinəs/""",
                      americanText: """IpaUS: /ˈhɔːtinəs/""",
...
کوردی: خۆبەزل‌زانی، لووت‌بەرزی، تڕزلی، تڕوتۆپ، بەفیزی، فیز، دەمار
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕەفتاری ناشرین لەگەڵ کەسانی دیکە چونکە پێتوایە لەوان باشتریت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: arrogance"),
                    SentencesRow(
                      englishText:
                          """He spoke with obvious haughtiness to the waiter.""",
                      kurdishText:
                          """بە لووت‌بەرزی ئاشکراوە لەگەڵ گارسۆنەکە قسەی کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/RV-ni8Ca0vw?t=';
const double _startSecondsend = 0000000000000000000000000001224;
const String _videoIdone = 'https://youtu.be/7PKoPAMozZo?t=';
const double _startSecondsone = 0000000000000000000000000002342;
const String _videoIdtwo = 'https://youtu.be/rf04j794tas?t=';
const double _startSecondstwo = 000000000000000000000000000617;
const String _videoIdthree = 'https://youtu.be/Czbpxl2ZBio?t=';
const double _startSecondsthree = 000000000000000000000000000190;
const String _videoIdfour = 'https://youtu.be/8QY782ET5y0?t=';
const double _startSecondsfour = 000000000000000000000000000317;
const String _videoIdfive = 'https://youtu.be/hGHhJ1cLvyc?t=';
