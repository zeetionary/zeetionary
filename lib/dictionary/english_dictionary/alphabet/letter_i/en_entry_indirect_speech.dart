...
class EnglishEntryindirectspeech extends StatefulWidget {
  const EnglishEntryindirectspeech({super.key});

  @override
  State<EnglishEntryindirectspeech> createState() =>
      _EnglishEntryindirectspeechState();
}

class _EnglishEntryindirectspeechState
    extends State<EnglishEntryindirectspeech> {
  @override
  void initState() {
    super.initState();
...
1. (grammar) a form of speech used to express what someone else has said; often involves a change in tense (- reported speech)
""",
  );

  final String keyword = "indirect speech";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indirect speech""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """In indirect speech, "I am tired" becomes "She said she was tired.\"""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/d8qV_IM10DA?t=';
    const double startSecondsend = 000000000000000000000000000563;
    const String videoIdone = 'https://youtu.be/26Fq0uGy92I?t=';
    const double startSecondsone = 000000000000000000000000000426;
    const String videoIdtwo = 'https://youtu.be/hBpetDxIEMU?t=';
    const double startSecondstwo = 0000000000000000000000000002470;
    const String videoIdthree = 'https://youtu.be/fJfE-HMfSkk?t=';
    const double startSecondsthree = 0000000000000000000000000001691;
    const String videoIdfour = 'https://youtu.be/CIqrWXeiFUs?t=';
    const double startSecondsfour = 000000000000000000000000000511;
    const String videoIdfive = 'https://youtu.be/AWrU0hAJOcY?t=';
    const double startSecondsfive = 000000000000000000000000000484;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: indirect speech",
                      britshText:
                          """IpaUK: /ˌɪndərekt ˈspiːtʃ/, /ˌɪndaɪrekt ˈspiːtʃ/""",
                      americanText:
                          """IpaUS: /ˌɪndərekt ˈspiːtʃ/, /ˌɪndaɪrekt ˈspiːtʃ/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) قسەیەک کە باس لەوە دەکات کە کەسێک چی گووتووە بەبێ ئەوەی قسەکانی خۆی وەک خۆیان دووبارە بکرێنەوە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: reported speech"),
                    SentencesRow(
                      englishText:
                          """In indirect speech, "I am tired" becomes "She said she was tired.\"""",
                      kurdishText:
                          """لە گێڕانەوەی ناڕاستەوخۆ، "I am tired" دەبێتە "She said she was tired.\"""",
