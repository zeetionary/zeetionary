...
class EnglishEntryindiscriminate extends StatefulWidget {
  ...
  @override
  State<EnglishEntryindiscriminate> createState() => _EnglishEntryindiscriminateState();
}

class _EnglishEntryindiscriminateState extends State<EnglishEntryindiscriminate> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryindiscriminate indiscriminate
WORD_WEB indiscriminate indiscriminate indiscriminate
haʊʊʊʊʊʊʊ4
""",
  );
