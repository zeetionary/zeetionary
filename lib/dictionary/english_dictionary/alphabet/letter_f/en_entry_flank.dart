...
class EnglishEntryflank extends StatefulWidget {
  const EnglishEntryflank({super.key});

  @override
  State<EnglishEntryflank> createState() => _EnglishEntryflankState();
}

class _EnglishEntryflankState extends State<EnglishEntryflank> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: flank (Derived forms: flanking, flanks, flanked)
1. Be located at the sides of something or somebody

- Noun: flank (Derived forms: flanks)
1. (military) The side of a military or naval formation (= wing)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The sun lit up the western flank of the hill.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Our orders were to attack their left flank.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Their centre made a dash down the right flank.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She left the courtroom flanked by armed guards.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The president was flanked by senior advisors.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flank""",
                      // alsoEnglishWord: "also: flank",
                      britshText: """IpaUK: /flæŋk/""",
                      americanText: """IpaUS: /flæŋk/""",
...
// With short examples define "flank", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """خۆرەکە لای ڕاستی گردەکەی ڕووناککردەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """فەرمانەکانمان ئەوە بوو هێرش بکەینە سەر باڵی چەپ.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ناوەڕاستیان هێرشێکی بۆ باڵی ڕاست کرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) هەبوونی کەسێک/شتێک لە لایەک یان هەر دوو لای"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She left the courtroom flanked by armed guards.""",
                      kurdishText:
                          """ژووری دادگای جێهێشت دەوردراو بە پاسەوانی چەکدار.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سەرۆک ڕاوێژکارانی باڵای وەک یاوەری هەبوو.""",
...
const double _startSecondsend = 0000000000000000000000000001104;
const String _videoIdone = 'https://youtu.be/zqllxbPWKNI?t=';
const double _startSecondsone = 0000000000000000000000000001468;
const String _videoIdtwo = 'https://youtu.be/hRSGxw2AQnk?t=';
const double _startSecondstwo = 000000000000000000000000000481;
const String _videoIdthree = 'https://youtu.be/sV6uuMAnJUE?t=';
const double _startSecondsthree = 000000000000000000000000000409;
const String _videoIdfour = 'https://youtu.be/tZktTdGHaJY?t=';
const double _startSecondsfour = 000000000000000000000000000921;
const String _videoIdfive = 'https://youtu.be/Gso2WrBcV2Q?t=';
const double _startSecondsfive = 000000000000000000000000000292;
