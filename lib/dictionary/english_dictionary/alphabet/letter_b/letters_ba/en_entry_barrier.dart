...
// blank divider
  ...
  Future<void> speakbarriers1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The crowd had to stand behind barriers.");
  }
  ...
  Future<void> speakbarriers3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("Despite the language barrier, they soon became good friends.");
  }
  ...
  Future<void> speakbarriers4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The cream acts as a protective barrier against sun damage.");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'd02d9hjDLBk';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'y-1o06rBgGA';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'OwDiONfCt2s';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'hhE6ittsUGs';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'wUnb9TEuUgo';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'UcqqFftEjKQ';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = '70grWA2rZUM';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'e9sN9gOEdG4';
  final double _startSeconds = 0;
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'noWwbvmdhL0';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'N0-YD32ujYY';
  final double _startSeconds = 0;
