...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/cPiwS2Nfz4o?t=';
    const double startSecondsend = 000000000000000000000000000203;
    const String videoIdone = 'https://youtu.be/LYUdnsIn5OU?t=';
    const double startSecondsone = 000000000000000000000000000886;
    const String videoIdtwo = 'https://youtu.be/tZktTdGHaJY?t=';
    const double startSecondstwo = 000000000000000000000000000100;
    const String videoIdthree = 'https://youtu.be/iKhQYYSqhgc?t=';
    const double startSecondsthree = 000000000000000000000000000336;
    const String videoIdfour = 'https://youtu.be/a7DYaTxrDg8?t=';
    const double startSecondsfour = 000000000000000000000000000177;
    const String videoIdfive = 'https://youtu.be/3f1XRiqCifs?t=';
    const double startSecondsfive = 0000000000000000000000000001845;
