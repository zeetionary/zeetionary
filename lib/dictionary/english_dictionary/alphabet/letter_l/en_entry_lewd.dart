...
class EnglishEntrylewd extends StatefulWidget {
  const EnglishEntrylewd({super.key});

  @override
  State<EnglishEntrylewd> createState() => _EnglishEntrylewdState();
}

class _EnglishEntrylewdState extends State<EnglishEntrylewd> {
  @override
  void initState() {
    super.initState();
