...
class EnglishEntryluxuriously extends StatefulWidget {
  const EnglishEntryluxuriously({super.key});

  @override
  State<EnglishEntryluxuriously> createState() => _EnglishEntryluxuriouslyState();
}

class _EnglishEntryluxuriouslyState extends State<EnglishEntryluxuriously> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryluxuriously luxuriously
WORD_WEB luxuriously luxuriously luxuriously
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "luxuriously";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""luxuriously""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """luxuriously""",
                      // alsoEnglishWord: "also: luxuriously",
...
کوردی: 
"""),
// With short examples define "luxuriously", please follow LX instructions
