...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) ھەوڵدان بۆ کردنی شتێک وەک کەسێکی دیکە بەھۆی ئەوەی سەرسامی پێی"""),
          SentencesRow(
            englishText:
                """She hopes to emulate her sister's sporting achievements.""",
            kurdishText:
                """بە ھیوایە بەدەستھێنانە وەرزشییەکانی خووشکەکەی دووبارە بکاتەوە.""",
          ...
          SentencesRow(
            englishText:
                """Officials are looking to emulate successful ideas from other cities.""",
            kurdishText:
                """بەرپرسان ھەوڵ دەدەن بیرۆکە سەرکەوتووەکانی شارەکانی دیکە دووبارە بکەنەوە .""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '3AiDa3ZD20Y';
