...
class EnglishEntryinsistence extends StatefulWidget {
  const EnglishEntryinsistence({super.key});

  @override
  State<EnglishEntryinsistence> createState() => _EnglishEntryinsistenceState();
}

class _EnglishEntryinsistenceState extends State<EnglishEntryinsistence> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insistence""");
  }
