...
class EnglishEntrygenuine extends StatefulWidget {
  const EnglishEntrygenuine({super.key});

  @override
  State<EnglishEntrygenuine> createState() => _EnglishEntrygenuineState();
}

class _EnglishEntrygenuineState extends State<EnglishEntrygenuine> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""genuine""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Is the painting a genuine Picasso?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She is a genuine contender for the title.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The document is not considered genuine.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He made a genuine attempt to improve conditions.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He came across as a very genuine person.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """genuine""",
                      // alsoEnglishWord: "also: genuine",
                      britshText: """IpaUK: /ˈdʒenjuɪn/""",
                      americanText: """IpaUS: /ˈdʒenjuɪn/""",
...
// With short examples define "genuine", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) ڕاست؛ کە هەمان ئەو شتەیە کە دەیبینیت"""),
                    AlsoEnglishckblink(
                    textBeforeLink: "هەروەها: ",
                    linkText: "authentic",
                    textAfterLink: ".",
                    onTap: () {
                    Routemaster.of(context).push("/english-genuine/authentic");
                    },
                    ),
                    SentencesRow(
                      englishText: """Is the painting a genuine Picasso?""",
                      kurdishText: """تابلۆکە دانەیەکی ڕاستەقینەی پیکاسۆیە؟""",
                    ...
                    SentencesRow(
                      englishText: """She is a genuine contender for the title.""",
                      kurdishText: """ڕکابەرێکی ڕاستەقینەیە بۆ نازناوەکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The document is not considered genuine.""",
                      kurdishText: """بەڵگەنامەکە بە ڕاستەقینە داناندرێت.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ھاوەڵناو) کە دەکرێت متمانەی پێ بکرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He made a genuine attempt to improve conditions.""",
                      kurdishText: """هەوڵێکی سەرڕاستانەی دا بۆ باشترکردنی دۆخەکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He came across as a very genuine person.""",
...
const String _videoIdone = 'https://youtu.be/lex6USTugUU?t=';
...
const String _videoIdthree = 'https://youtu.be/D2ZvUJrMZio?t=';
const double _startSecondsthree = 000000000000000000000000000662;
const String _videoIdfour = 'https://youtu.be/UQTtVrEnMNo?t=';
const double _startSecondsfour = 000000000000000000000000000108;
const String _videoIdfive = 'https://youtu.be/JR3z8lq2cNM?t=';
const double _startSecondsfive = 000000000000000000000000000849;
