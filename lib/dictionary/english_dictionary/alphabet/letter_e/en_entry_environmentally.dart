...
class EnglishEntryenvironmentally extends StatefulWidget {
...
class _EnglishEntryenvironmentallyState
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""environmentally""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: environmentally",
                      britshText: """IpaUK: /ɪnˌvaɪrənˈmentəli/""",
                      americanText: """IpaUS: /ɪnˌvaɪrənˈmentəli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "environmentally";
...
"""),
          ...
          CustomRichText(
            textBeforeLink: "١. (ھاوەڵکار) بە شێوەیەک کە پەیوەندیدارە بە ",
            linkText: "ژینگە",
            textAfterLink: "",
            onTap: () {
              Routemaster.of(context)
                  .push("/english-environmentally/environment");
            },
          ),
          SentencesRow(
            englishText:
...
const double _startSecondsend = 000000000000000000000000000000; // 768;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/VS6tnF31zr4?t=';
const double _startSecondsone = 00000000000000000000000000000; // 760;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/JR3z8lq2cNM?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 176;
const String _videoIdthree = 'VIDEOhttps://youtu.be/T48_SrFCdaQ?t=';
const double _startSecondsthree = 000000000000000000000000000; // 411;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/KDGJmzqvKTg?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 285;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/8JFmGxmqkkU?t=';
