...
class EnglishEntryhemisphere extends StatefulWidget {
  const EnglishEntryhemisphere({super.key});

  @override
  State<EnglishEntryhemisphere> createState() => _EnglishEntryhemisphereState();
}

class _EnglishEntryhemisphereState extends State<EnglishEntryhemisphere> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hemisphere (Derived forms: hemispheres)
1. Half of the terrestrial globe
 
2. Half of a sphere
 
3. Either half of the cerebrum (- cerebral hemisphere)
""",
  );

  final String keyword = "hemisphere";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hemisphere""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""In the northern hemisphere, December is a winter month.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """The right hemisphere of the brain helps with recognizing faces.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The bush had been pruned into a perfect hemisphere.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hemisphere""",
                      // alsoEnglishWord: "also: hemisphere",
                      britshText: """IpaUK: /ˈhemɪsfɪə(r)/""",
                      americanText: """IpaUS: /ˈhemɪsfɪr/""",
...
کوردی: 
"""),
// With short examples define "hemisphere", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) نیوەی زەوی، بە تایبەتی نیوەی باکوور و باشوور"""),
                    SentencesRow(
                      englishText:
                          """In the northern hemisphere, December is a winter month.""",
                      kurdishText:
                          """لە خولگەی باکوور، کانوونی یەکەم مانگێکی زستانە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) هەر یەک لە بەشی ڕاست و چەپی مێشک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The right hemisphere of the brain helps with recognizing faces.""",
                      kurdishText:
                          """بەشی ڕاستی مێشک یارمەتی ناسینەوەی ڕووخسار دەدات.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ناو) نیوەی تۆپێک/شتێکی شێوە گۆیی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The bush had been pruned into a perfect hemisphere.""",
                      kurdishText:
                          """دەوەنەکە بە شێوەیەکی تەواو بڕدرابووەوە و کرابووە نیوە گۆیەکی تەواو.""",
...
const String _videoIdone = 'https://youtu.be/xshZZKWBNd0?t=';
const double _startSecondsone = 00000000000000000000000000035;
const String _videoIdtwo = 'https://youtu.be/iO5mfbpq16A?t=';
const double _startSecondstwo = 00000000000000000000000000014;
const String _videoIdthree = 'https://youtu.be/HkJ4zxlY7Rw';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/qXXYEXYLsCY?t=';
const double _startSecondsfour = 0000000000000000000000000009;
const String _videoIdfive = 'https://youtu.be/aXV91wN9Q1I?t=';
