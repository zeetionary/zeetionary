...
class EnglishEntryfade extends StatefulWidget {
  const EnglishEntryfade({super.key});

  @override
  State<EnglishEntryfade> createState() => _EnglishEntryfadeState();
}

class _EnglishEntryfadeState extends State<EnglishEntryfade> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fade""",
                      // alsoEnglishWord: "also: fade",
                      britshText: """IpaUK: /feɪd/""",
                      americanText: """IpaUS: /feɪd/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The curtains had faded in the sun.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They arrived home just as the light was fading.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The laughter faded away.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Hopes of reaching an agreement seem to be fading away.""");
  }
...
"""),
          ...
          SentencesRow(
            ...
            englishNote: "Also: The sun had faded the curtains.",
            kurdishText: """پەردەکان لەبەر خۆرەکەدا کاڵبوو بوون.""",
          ...
          SentencesRow(
            ...
            kurdishText: """گەشتنەوە ماڵ ڕێک کە ڕۆشنایی نەدەما.""",
...
2. Lose freshness, vigour, or vitality (= wither)
"Her bloom was fading";
 
3. Disappear gradually (= evanesce, blow over, pass off, fleet, pass)
...
2. Gradually ceasing to be visible (= disappearance)
""",
  );
...
const String _videoIdone = 'https://youtu.be/RpeYKjzN4HU?t=';
const double _startSecondsone = 000000000000000000000000000374;
const String _videoIdtwo = 'https://youtu.be/Bk0G1f4DpCM?t=';
const double _startSecondstwo = 000000000000000000000000000232;
const String _videoIdthree = 'https://youtu.be/Xzv84ZdtlE0?t=';
const double _startSecondsthree = 000000000000000000000000000598;
const String _videoIdfour = 'https://youtu.be/NUzDLpSkQTg?t=';
const double _startSecondsfour = 000000000000000000000000000423;
const String _videoIdfive = 'https://youtu.be/Y_N0AxCzVLg?t=';
const double _startSecondsfive = 0000000000000000000000000001238;
