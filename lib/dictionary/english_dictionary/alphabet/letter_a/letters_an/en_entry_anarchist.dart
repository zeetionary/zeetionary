...
class EnglishEntryanarchist extends StatelessWidget {
  ...
  Future<void> speakAnarchist(String languageCode) async {
    ...
    await flutterTts.speak("anarchist"); // DOPSUM: CHANGE TEXT
  }
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "cNi_HC839Wo";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "iTkURG6FIZg";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "MLIehuS4xyw";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "Jcmeu5porZA";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "4e9DBXdXxAc";
