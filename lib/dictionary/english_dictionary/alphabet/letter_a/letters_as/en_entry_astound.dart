...
// Define the word "astound" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryastound - replace speakAstound

// replace astound - /əˈstaʊnd/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryastound extends StatelessWidget {
  // blank divider
  EnglishEntryastound({super.key});
  // blank divider
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "astound", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAstound(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "rFYNhX-dSwE";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "Dq7gM1leBho";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "54heYhzfv-Y";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "5f2xOxRGKqk";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "TKiQB_CfMR4";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "a-8f0sRJ7Bc";

  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 2754, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
      autoPlay: true,
      enableCaption: true,
      loop: true,
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "B2ph_FeB7d8";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "LvS0gUlzS-4";
