...
class EnglishEntryleaning extends StatefulWidget {
  const EnglishEntryleaning({super.key});

  @override
  State<EnglishEntryleaning> createState() => _EnglishEntryleaningState();
}

class _EnglishEntryleaningState extends State<EnglishEntryleaning> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""leaning""");
  }
