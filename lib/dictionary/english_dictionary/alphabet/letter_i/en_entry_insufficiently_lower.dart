...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 3077;
    const String videoIdone = '7D-gxaie6UI';
    const double startSecondsone = 270;
    const String videoIdtwo = 'woD6RYptp58';
    const double startSecondstwo = 1293;
    const String videoIdthree = 'MfPHZFsw40M';
    const double startSecondsthree = 357;
    const String videoIdfour = 'um9aGTAU0lg';
    const double startSecondsfour = 1089;
    const String videoIdfive = 'GXgGR8KxFao';
    const double startSecondsfive = 6860;
