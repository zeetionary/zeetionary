...
class EnglishEntryheadmaster extends StatefulWidget {
  const EnglishEntryheadmaster({super.key});

  @override
  State<EnglishEntryheadmaster> createState() => _EnglishEntryheadmasterState();
}

class _EnglishEntryheadmasterState extends State<EnglishEntryheadmaster> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: headmaster (Derived forms: headmasters)
1. Presiding officer of a school (- schoolmaster, master)
""",
  );

  final String keyword = "headmaster";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""headmaster""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He went on to become headmaster of a school in Bath.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """headmaster""",
                      alsoEnglishWord:
                          "Feminine: headmistress, British English usually: head teacher, American English usually principal",
                      britshText: """IpaUK: /ˌhedˈmɑːstə(r)/""",
                      americanText: """IpaUS: /ˌhedˈmæstər/""",
...
// کوردی:
// """),
// With short examples define "headmaster", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مامۆستایەک کە بەڕێوبەری خوێندنگایەکە"""),
                    SentencesRow(
                      englishText:
                          """He went on to become headmaster of a school in Bath.""",
                      kurdishText: """بوو بە بەڕێوبەری خوێندنگایەک لە باس.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/B18ss3dbRAI?t=';
const double _startSecondsend = 000000000000000000000000000186;
const String _videoIdone = 'https://youtu.be/oIUM63yyUY4?t=';
const double _startSecondsone = 00000000000000000000000000046;
const String _videoIdtwo = 'https://youtu.be/cf3ieGJosl0?t=';
const double _startSecondstwo = 000000000000000000000000000967;
const String _videoIdthree = 'https://youtu.be/Bhro-CO1QA4?t=';
const double _startSecondsthree = 000000000000000000000000000548;
const String _videoIdfour = 'https://youtu.be/cVcPVn5Cwzg?t=';
const double _startSecondsfour = 0000000000000000000000000001408;
const String _videoIdfive = 'https://youtu.be/3lUiKhajVFs?t=';
const double _startSecondsfive = 000000000000000000000000000820;
