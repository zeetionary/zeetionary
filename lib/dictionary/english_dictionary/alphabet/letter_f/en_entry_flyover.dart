...
class EnglishEntryflyover extends StatefulWidget {
  const EnglishEntryflyover({super.key});

  @override
  State<EnglishEntryflyover> createState() => _EnglishEntryflyoverState();
}

class _EnglishEntryflyoverState extends State<EnglishEntryflyover> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flyover (Derived forms: flyovers)
1. Bridge formed by the upper level of a crossing of two highways at different levels (= overpass)
 
2. (military) a flight at a low altitude (usually of military aircraft) over spectators on the ground (= fly-by, flypast)
""",
  );

  final String keyword = "flyover";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flyover""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Drivers took the flyover to avoid the busy intersection.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flyover""",
                      alsoEnglishWord: "also : American English: overpass",
                      britshText: """IpaUK: /ˈflaɪəʊvə(r)/""",
                      americanText: """IpaUS: /ˈflaɪəʊvər/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پردێک کە ڕێگایەک بەسەر یەکێکی دیکەدا دەبات"""),
                    SentencesRow(
                      englishText:
                          """Drivers took the flyover to avoid the busy intersection.""",
                      kurdishText:
                          """شۆفێران بەسەر ئۆڤەرپاسەکەدا دەچوون بۆ دووربوون لە یەکتربڕە قەرەباڵغەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/VNZ0so0LCoM?t=';
const double _startSecondsend = 000000000000000000000000000190;
const String _videoIdone = 'https://youtu.be/xjmXzYdxuTQ?t=';
const double _startSecondsone = 0000000000000000000000000001117;
const String _videoIdtwo = 'https://youtu.be/7MWxq80oze0?t=';
const double _startSecondstwo = 000000000000000000000000000242;
const String _videoIdthree = 'https://youtu.be/yKB6Olsn_5o?t=';
const double _startSecondsthree = 000000000000000000000000000338;
const String _videoIdfour = 'https://youtu.be/MV1qaFv4VUg?t=';
const double _startSecondsfour = 000000000000000000000000000586;
const String _videoIdfive = 'https://youtu.be/Crn-I2ZqhXg?t=';
