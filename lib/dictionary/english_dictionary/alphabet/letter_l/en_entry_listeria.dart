...
class EnglishEntrylisteria extends StatefulWidget {
  const EnglishEntrylisteria({super.key});

  @override
  State<EnglishEntrylisteria> createState() => _EnglishEntrylisteriaState();
}

class _EnglishEntrylisteriaState extends State<EnglishEntrylisteria> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: listeria (Derived forms: listerias)
1. Any species of the genus Listeria
""",
  );

  final String keyword = "listeria";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""listeria""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Listeria can grow in refrigerated foods.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Pregnant women should avoid foods that may carry listeria.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/_1F_UGNRI94?t=63';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/lw0NWLmewKo?t=528';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/qNrnwAKBU3Q?t=669';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/zU_F8REaHvI?t=146';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/B4BAP3bV1gM?t=1259';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/qrbFXkI4RzU?t=370';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """listeria""",
                      // alsoEnglishWord: "also: listeria",
                      britshText: """IpaUK: /lɪˈstɪəriə/""",
                      americanText: """IpaUS: /lɪˈstɪriə/""",
...
کوردی: 
"""),
                    const DefinitionKurdish(text: """١. (ناو) جۆرە بەکتریا کە دەبێتە هۆکاری نەخۆشی ئەگەر خەڵکی ئەو خواردنانە بخۆن کە تێیدایە"""),
                    SentencesRow(
                      englishText: """Listeria can grow in refrigerated foods.""",
                      kurdishText: """لیستێریا دەکرێت گەشە بکات لە خواردنی بەستراو.""",
                    ...
                    SentencesRow(
                      englishText: """Pregnant women should avoid foods that may carry listeria.""",
                      kurdishText: """ژنانی دووگیان دەبێت دوور بن لەو خواردنانەی کە لیستریایان تێدایە.""",
