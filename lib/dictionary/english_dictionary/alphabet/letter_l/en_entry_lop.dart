...
class EnglishEntrylop extends StatefulWidget {
  const EnglishEntrylop({super.key});

  @override
  State<EnglishEntrylop> createState() => _EnglishEntrylopState();
}

class _EnglishEntrylopState extends State<EnglishEntrylop> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: lop (Derived forms: lopping, lops, lopped)
1. Cut off from a whole (- discerp, sever)
"The soul lopped from the body";
 
2. Cultivate, tend, and cut back the growth of (- snip, clip, crop, trim, dress, prune, cut back)
"lop the plants in the garden";
""",
  );

  final String keyword = "lop";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We’ve got to lop off the lower branches of this tree.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The city council lopped thousands of dollars from the budget.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/81JUjBvEHtw?t=31';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/Bh9lIfocRMk?t=720';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/LBSFeJ1WLv4?t=51';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/LpVngOxmgjE?t=1822';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/zuS_GQfe7J0?t=470';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/-IvvpJ0-vfY?t=376';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lop""",
                      // alsoEnglishWord: "also: lop",
                      britshText: """IpaUK: /lɒp/""",
                      americanText: """IpaUS: /lɑːp/""",
...
کوردی: 
"""),
// With short examples define "lop", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) بڕینەوەی دارێک یان هەندێک لقی گەورەی"""),
                    SentencesRow(
                      englishText: """We’ve got to lop off the lower branches of this tree.""",
                      kurdishText: """دەبێت لقە بچووکەکانی ئەم دارە ببڕینەوە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The city council lopped thousands of dollars from the budget.""",
                      kurdishText: """(خوازراوی) ئەنجوومەنی شارەکە هەزاران دلاری لە بودجەکە بڕی.""",
