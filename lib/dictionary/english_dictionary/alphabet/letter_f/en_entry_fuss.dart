...
class EnglishEntryfuss extends StatefulWidget {
  const EnglishEntryfuss({super.key});

  @override
  State<EnglishEntryfuss> createState() => _EnglishEntryfussState();
}

class _EnglishEntryfussState extends State<EnglishEntryfuss> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: fuss (Derived forms: fussing, fussed, fusses)
1. Worry unnecessarily or excessively (- niggle, fret)
"don't fuss too much over the grandchildren--they are quite big now";
 
2. Care for like a mother (- mother, overprotect)
"She fusses over her husband";

- Noun: fuss (Derived forms: fusses)
1. An excited state of agitation (- dither, pother, tizzy [informal], flap [informal], tizz [informal])
 
2. An angry disturbance (- trouble, bother, hassle [informal], stink [informal], shindy [informal])
"he didn't want to make a fuss";
 
3. A quarrel about petty points (- bicker, bickering, spat [informal], tiff [informal], squabble, pettifoggery, brannigan [US, informal])
 
4. A rapid active commotion (- bustle, hustle, flurry, ado, stir)
""",
  );

  final String keyword = "fuss";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He does what he's told without any fuss.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We'd like a quiet wedding without any fuss.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""All that fuss over a few pounds!""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Steve kicks up a fuss every time I suggest seeing you.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I'm sorry for making such a fuss about the noise.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Stop fussing around and find something useful to do!""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Don't fuss with your hair!""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Don't fuss, Mum, everything is all right.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Paula’s always fussing about her figure.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fuss""",
                      // alsoEnglishWord: "also: fuss",
                      britshText: """IpaUK: /fʌs/""",
                      americanText: """IpaUS: /fʌs/""",
...
کوردی: زەنازەنا، دەنگ‌وهەرا، جەنجاڵی، هەڵا، گوڕەوبڕە، تەقەوڕەقە، گوڕەونەڕە، نەڕەنەڕ، بگرەوبەردە، چەقەوهەرا، گوڕەوبڕە، سڕمەسڕم، قاوقیژە، شلوقایی، ورووژاوی، ئاڵۆزایی، نگەرانی، دڵەڕاوکێ،	ناڕەزایەتی
"""),
// With short examples define "fuss", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) جۆش‌وخرۆشی، چالاکی، یان نیگەرانی بێ‌هۆکار"""),
                    SentencesRow(
                      englishText:
                          """He does what he's told without any fuss.""",
                      kurdishText:
                          """ئەوە دەکات کە پێی دەگوترێت بەبێ هیچ دەنگ‌وهەرایەک.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """حەزمان بە ئاهەنگێکی هاوسەرگیریی بێ‌دەنگە بەبێ هیچ هەڵایەک.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """All that fuss over a few pounds!""",
                      kurdishText:
                          """هەموو ئەو دەنگە دەنگە لەسەر چەند پاوەندێک!""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ستیڤ تووڕە دەبێت هەر کاتێک کە پێشنیاری بینینت دەکەم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە داخەوەم درووستکردنی ناڕەزاییەکی لەو شێوەیە سەبارەت بە دەنگە دەنگەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بوەستە لە سەرقاڵی بە شتی هیچ و شتێکی باش بدۆزەرەوە بیکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Don't fuss with your hair!""",
                      kurdishText: """کلکەقنگێی قژت مەدە!""",
                      kurdishNote: """واتا ئەوەندە دەست لە قژت مەدە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """نیگەران مەبە، دایە، هەموو شت باش دەبێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پاوڵا هەمیشە نیگەرانە سەبارەت بە شێوەی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/olHw-8py9K0?t=';
const double _startSecondsend = 000000000000000000000000000197;
const String _videoIdone = 'https://youtu.be/Lkl9_3-jX6c?t=';
const double _startSecondsone = 00000000000000000000000000043;
const String _videoIdtwo = 'https://youtu.be/Wao0_uB4Zw4?t=';
const double _startSecondstwo = 0000000000000000000000000002069;
const String _videoIdthree = 'https://youtu.be/h_OeMVcol1g?t=';
const double _startSecondsthree = 000000000000000000000000000451;
const String _videoIdfour = 'https://youtu.be/6gq5t1SBnPs?t=';
