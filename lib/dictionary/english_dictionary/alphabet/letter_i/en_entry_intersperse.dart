...
class EnglishEntryintersperse extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intersperse""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'qSFcXtl9WyU';
    const double startSecondsend = 366;
    const String videoIdone = 'R6reyiSpKuw';
    const double startSecondsone = 385;
    const String videoIdtwo = 'NL_2q0W48-I';
    const double startSecondstwo = 249;
    const String videoIdthree = 'K-Ina_WW4Yc';
    const double startSecondsthree = 1395;
    const String videoIdfour = 'CUbeQ7Q3s2Q';
    const double startSecondsfour = 117;
    const String videoIdfive = 'd6ai8ZGoYjY';
