...
class EnglishEntryjokingly extends StatefulWidget {
  const EnglishEntryjokingly({super.key});

  @override
  State<EnglishEntryjokingly> createState() => _EnglishEntryjokinglyState();
}

class _EnglishEntryjokinglyState extends State<EnglishEntryjokingly> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""jokingly""");
  }
