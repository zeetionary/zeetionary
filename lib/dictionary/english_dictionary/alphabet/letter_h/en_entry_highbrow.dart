...
class EnglishEntryhighbrow extends StatefulWidget {
  const EnglishEntryhighbrow({super.key});

  @override
  State<EnglishEntryhighbrow> createState() => _EnglishEntryhighbrowState();
}

class _EnglishEntryhighbrowState extends State<EnglishEntryhighbrow> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: highbrow
1. Highly cultured or educated (- highbrowed)
"highbrow events such as the ballet or opera";

- Noun: highbrow (Derived forms: highbrows)
1. A person of intellectual or erudite tastes
""",
  );

  final String keyword = "highbrow";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""highbrow""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The journal is aimed at a highbrow readership.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Highbrow critics generally disapprove of this type of novel.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """highbrow""",
                      // alsoEnglishWord: "also: highbrow",
                      britshText: """IpaUK: /ˈhaɪbraʊ/""",
                      americanText: """IpaUS: /ˈhaɪbraʊ/""",
...
کوردی: خاوەن فەرهەنگ و هونەری بەرز، ڕۆشنبیر
"""),
// With short examples define "highbrow", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) هەبوونی حەز بۆ بیرۆکەی هونەری و کەلتووری"""),
                    const AlsoEnglishckb(word: "ھەروەھا: intellectual"),
                    SentencesRow(
                      englishText: """The journal is aimed at a highbrow readership.""",
                      kurdishText: """جۆرناڵەکە بۆ خوێنەری ڕۆشنبیرە.""",
                    ...
                    SentencesRow(
                      englishText: """Highbrow critics generally disapprove of this type of novel.""",
                      kurdishText: """رەخنەگرە ڕۆشنفکرەکان زۆرجار دژ بەم جۆرە لە ڕۆمانن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/rxalEnZ7uok?t=';
const double _startSecondsend = 000000000000000000000000000609;
const String _videoIdone = 'https://youtu.be/BuhZauu188A?t=';
const double _startSecondsone = 00000000000000000000000000017;
const String _videoIdtwo = 'https://youtu.be/EY0uQar5ttU?t=';
const double _startSecondstwo = 000000000000000000000000000380;
const String _videoIdthree = 'https://youtu.be/wfmeJ2T_txk?t=';
const double _startSecondsthree = 0000000000000000000000000001921;
const String _videoIdfour = 'https://youtu.be/DRo03dWEgUo?t=';
const double _startSecondsfour = 0000000000000000000000000002253;
const String _videoIdfive = 'https://youtu.be/WxDd8ocpcHk?t=';
const double _startSecondsfive = 000000000000000000000000000973;
