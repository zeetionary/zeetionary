...
class EnglishEntryexorcist extends StatefulWidget {
  const EnglishEntryexorcist({super.key});

  @override
  State<EnglishEntryexorcist> createState() => _EnglishEntryexorcistState();
}

class _EnglishEntryexorcistState extends State<EnglishEntryexorcist> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exorcist""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exorcist""",
                      // alsoEnglishWord: "also: exorcist",
                      britshText: """IpaUK: /ˈeksɔːsɪst/""",
                      americanText: """IpaUS: /ˈeksɔːrsɪst/""",
...
"""),
          const DefinitionKurdish(
              text: """١. (ناو) کەسێک کە جن و خێو لە لەشی مرۆڤ دەردەکات"""),
          SentencesRow(
            englishText:
                """An exorcist was called in to get rid of the ghost.""",
            kurdishText: """جنۆکەگرێک بانگ کرا بۆ دەرکردنی خێوەکە.""",
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/qjqh9UVfNNk?t=';
const double _startSecondsend = 000000000000000000000000000000; // 485;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/1KgSp94nCZw?t=';
const double _startSecondsone = 00000000000000000000000000000; // 394;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/UzIxYdWVbm0?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 554;
const String _videoIdthree = 'VIDEOhttps://youtu.be/XfOrJp8bKbE?t=';
const double _startSecondsthree = 000000000000000000000000000; // 351;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/3-zXS_1B5oo?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 404;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/gYz0Xel-upA?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 218;
