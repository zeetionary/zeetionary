...
class EnglishEntrykickoff extends StatefulWidget {
  const EnglishEntrykickoff({super.key});

  @override
  State<EnglishEntrykickoff> createState() => _EnglishEntrykickoffState();
}

class _EnglishEntrykickoffState extends State<EnglishEntrykickoff> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""kick-off""");
  }
