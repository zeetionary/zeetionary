...
class EnglishEntryhallucination extends StatefulWidget {
  const EnglishEntryhallucination({super.key});

  @override
  State<EnglishEntryhallucination> createState() => _EnglishEntryhallucinationState();
}

class _EnglishEntryhallucinationState extends State<EnglishEntryhallucination> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hallucination (Derived forms: hallucinations)
1. Illusory perception; a common symptom of severe mental disorder
 
2. A mistaken or unfounded opinion or idea (- delusion)
...
""",
  ...
  final String keyword = "hallucination";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hallucination""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""High temperatures can cause hallucination.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was admitted to hospital suffering from hallucinations.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Was the figure real or just a hallucination?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hallucination""",
                      // alsoEnglishWord: "also: hallucination",
                      britshText: """IpaUK: /həˌluːsɪˈneɪʃn/""",
                      americanText: """IpaUS: /həˌluːsɪˈneɪʃn/""",
...
// With short examples define "hallucination", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ئەوەی کە وادیار بێت شتێک دەبیستیت یان گوێت لێی دەبێت بەبێ ئەوەی لە ڕاستیدا وابێت، بە تایبەتی بەهۆی نەخۆشی، یان مادەی هۆشبەر"""),
                    SentencesRow(
                      englishText: """High temperatures can cause hallucination.""",
                      kurdishText: """پلەی گەرمی بەرز دەکرێت ببێتە هۆکاری خەیاڵاوی.""",
                    ...
                    SentencesRow(
                      englishText: """She was admitted to hospital suffering from hallucinations.""",
                      kurdishText: """بردرا بۆ نەخۆشخانە بەهۆی ئەوەی خۆفاوی بووبوو.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) شتێک کە دەبیسترێت یان دەبیندرێت کە لەوێ نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Was the figure real or just a hallucination?""",
                      kurdishText: """کەسەکە ڕاستی بوو یان خەیاڵاوی؟""",
