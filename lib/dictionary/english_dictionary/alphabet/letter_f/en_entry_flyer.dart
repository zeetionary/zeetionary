...
class EnglishEntryflyer extends StatefulWidget {
  const EnglishEntryflyer({super.key});

  @override
  State<EnglishEntryflyer> createState() => _EnglishEntryflyerState();
}

class _EnglishEntryflyerState extends State<EnglishEntryflyer> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flyer (Derived forms: flyers)
1. An advertisement (usually printed on a page or in a leaflet) intended for wide distribution (= circular, handbill, bill, broadside, broadsheet, flier, throwaway)
"he mailed the flyer to all subscribers";
 
2. Someone who travels by air (= flier)
 
3. Someone who operates an aircraft (= aviator, aeronaut, airman, flier)
""",
  );

  final String keyword = "flyer";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Their mission was to rescue downed American flyers involved in the bombing campaign.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'm a nervous flyer.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Butterflies can be strong flyers.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They distributed flyers promoting the event to students.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flyer""",
                      // alsoEnglishWord: "also: flyer",
                      britshText: """IpaUK: /ˈflaɪə(r)/""",
                      americanText: """IpaUS: /ˈflaɪər/""",
...
کوردی: هەڵفڕ،	فڕۆکەوان،	دووبەختەکی، قومار،	جاڕ، ئاگاداری، ڕاگەیاندن،	تونڕەو، گورج، خۆشبەز (مرۆ، گیانەوەر، ماشێن و هتد)،	بازدان، پەڕین، لووربوون،	مرۆی بەرزەفڕ
"""),
// With short examples define "flyer", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Their mission was to rescue downed American flyers involved in the bombing campaign.""",
                      kurdishText:
                          """ئەرکیان ڕزگارکردنی فڕۆکەوانە ئەمریکییەکان بوو کە لە کەمپینی بۆمبارانەکە خرابوونە خوارەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پەپوولە دەکرێت هەڵفڕی بەهێز بێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئاگادارییان بڵاودەکردەوە کە بۆنەکەی بە خوێندکاران ڕادەگەیاند.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/GManHSgoIbQ?t=';
const double _startSecondsend = 000000000000000000000000000132;
const String _videoIdone = 'https://youtu.be/BztMgcNgobk?t=';
const double _startSecondsone = 000000000000000000000000000348;
const String _videoIdtwo = 'https://youtu.be/JcpboMScfIY?t=';
const double _startSecondstwo = 0000000000000000000000000002020;
const String _videoIdthree = 'https://youtu.be/OPEh7UWmfDc?t=';
const double _startSecondsthree = 000000000000000000000000000483;
const String _videoIdfour = 'https://youtu.be/NQ9Hp1KVzJI';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/bFEj-6tBZeA?t=';
const double _startSecondsfive = 0000000000000000000000000001021;
