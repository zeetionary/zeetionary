...
class EnglishEntryglory extends StatefulWidget {
  const EnglishEntryglory({super.key});

  @override
  State<EnglishEntryglory> createState() => _EnglishEntrygloryState();
}

class _EnglishEntrygloryState extends State<EnglishEntryglory> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I do all the work and he gets all the glory.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She wanted to enjoy her moment of glory.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He covered himself in glory and came home a rich man.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.speak(
        """His moment of glory came when he won the Olympic gold medal.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The city was spread out beneath us in all its glory.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The house has now been restored to its former glory.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The temple is one of the glories of ancient Greece.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glory""",
                      // alsoEnglishWord: "also: glory",
                      britshText: """IpaUK: /ˈɡlɔːri/""",
                      americanText: """IpaUS: /ˈɡlɔːri/""",
...
کوردی: شکۆ، فەڕ، گەورەیی، مەزنی، شانازی، ئەوڕەنگ، سەربەرزی، سەربڵیندی، ناوودەنگ، نێوبەدەرەوەیی، (کتێبی پیرۆز) پەسن، شوکرانەبژێری، سپاس، پەرستن، پیاهەڵدان
"""),
// With short examples define "glory", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) سەرکەوتنی گەورە کە پیاهەڵدان و شانازی دەهێنێت بۆ کەسێک لەگەڵ ناوبانگی زۆر"""),
                    SentencesRow(
                      englishText:
                          """I do all the work and he gets all the glory.""",
                      kurdishText:
                          """من هەموو کارەکە دەکەم و ئەو هەموو شانازییەکە دەبات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ویستی چێژ لە ساتەوەختی شانازیی ببینێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شانازی زۆری بۆ خۆی بەدەستهێنا و وەک پیاوێکی دەوڵەمەند گەڕایەوە ماڵەوە.""",
                      englishNote:
                          """This means he achieved great success and honor, earning widespread admiration and respect, and as a result, he returned with substantial wealth.""",
                    ...
                    SentencesRow(
                      englishText:
                          """His moment of glory came when he won the Olympic gold medal.""",
                      kurdishText:
                          """ساتەوەختی شانازیی هات کە مەدالیای زێڕی ئۆڵۆمپیادی بردەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """They built many churches, great and small, to the glory of God.""",
                      kurdishText:
                          """ژمارەیەکی زۆر کڵێسایان درووستکرد، لە گەورە و بچووک، بۆ پەرستی خودا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شارەکە کەوتە بەرچاو بە هەموو جوانییەکەیەوە.""",
                      englishNote:
                          """This means the city was fully visible from above, showcasing its beauty, size, and grandeur in an impressive and awe-inspiring way.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خانووەکە ئێستا نۆژەنکراوەتەوە بۆ جوانییەکەی پێشووتری.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پەرستگاکە یەکێکە لە جوانییەکانی یۆنانی کۆن.""",
...
const double _startSecondsend = 0000000000000000000000000001255;
...
const double _startSecondstwo = 0000000000000000000000000001468;
const String _videoIdthree = 'https://youtu.be/UoSSCUMk-7I?t=';
const double _startSecondsthree = 000000000000000000000000000706;
const String _videoIdfour = 'https://youtu.be/-7bIDbaU_zQ?t=';
const double _startSecondsfour = 000000000000000000000000000272;
const String _videoIdfive = 'https://youtu.be/agSO-QHxmzY?t=';
const double _startSecondsfive = 000000000000000000000000000508;
