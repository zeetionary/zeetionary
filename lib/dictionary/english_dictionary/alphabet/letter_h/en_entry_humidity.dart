...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Instruments constantly monitor temperature and humidity.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Care should be taken in conditions of high humidity.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""These plants need heat and humidity to grow well.""");
  }
...
// With short examples define "humidity", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئامێرەکان بەردەوام چاودێری پلەی گەرمی و شێداری دەکەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وریایی دەبێت لەبەرچاو بگیرێت لە کەشی شێداری زۆردا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەم ڕووەکانە پێویستییان بە شێدارییە بۆ گەشەکردن بە باشی.""",
