...
class EnglishEntryheap extends StatefulWidget {
  const EnglishEntryheap({super.key});

  @override
  State<EnglishEntryheap> createState() => _EnglishEntryheapState();
}

class _EnglishEntryheapState extends State<EnglishEntryheap> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heap (Derived forms: heaps)
1. A collection of objects laid on top of each other (- pile, mound, agglomerate, cumulation, cumulus)
 
2. (often followed by 'of') a large number, amount or extent (- batch, deal, flock, good deal, great deal, hatful, lot, mass, mess, mickle [archaic], mint, mountain, muckle, passel [US], peck, pile [informal], plenty, pot, quite a little, raft, sight, slew, spate, stack, tidy sum, wad, bunch [informal])
"a heap of letters";
 
3. [informal] A car that is old and unreliable (- bus [informal], jalopy [informal], banger [Brit, informal], hooptie [US, informal], clunker [N. Amer, informal])
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The building was reduced to a heap of rubble.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Papers were piled in great heaps on the desk.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""There's heaps of time before the plane leaves.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I've got a heap of things to do.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Rocks were heaped up on the side of the road.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She looked at the vegetables heaped on the table.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She heaped food on my plate.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He heaped praise on his team.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heap""",
                      // alsoEnglishWord: "also: heap",
                      britshText: """IpaUK: /hiːp/""",
                      americanText: """IpaUS: /hiːp/""",
...
کوردی: کۆما، چینە، کۆگا، کۆمەڵکە، تۆپەڵکە، کەڵەک،	بارخانە، لۆدە، لێشاو، بڕێکی زۆر، پێخوێ
"""),
// With short examples define "heap", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) چینێکی شێواو لە شتێک"""),
                    SentencesRow(
                      englishText:
                          """The building was reduced to a heap of rubble.""",
                      kurdishText:
                          """بیناکە خاپوور کرا بۆ چینێک لە ورکەبەرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کاغەز بە چینی چینی گەورە لەسەر دێسکەکە دانرابوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ماوەیەکی زۆر کات هەیە پێش ئەوەی فڕۆکەکە بچێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I've got a heap of things to do.""",
                      kurdishText: """ژمارەیەکی زۆر شتم هەیە بیکەم.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (کردار) دانانی شت بە شپرزەیی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Rocks were heaped up on the side of the road.""",
                      kurdishText: """بەرد لە قەراغی ڕێگاکە کەڵەکە کرابوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سەیری سەوزەەکانی کرد لەسەر مێزەکە کەڵەکە کرابوون.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (کردار) دانانی ڕێژەیەکی زۆر لە شتێک لەسەر شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She heaped food on my plate.""",
                      kurdishText: """خواردنی لەسەر دەورییەکەم کەڵەکە کرد.""",
                      englishNote: "Also: She heaped my plate with food.",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٥. (کردار) پێدانی ڕێژەیەکی زۆر لە شتێک بە کەسێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He heaped praise on his team.""",
                      kurdishText: """پەسنی زۆری دا بە تیمەکەی.""",
                      englishNote: """Also: He heaped his team with praise.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/EobMnSpjfTU?t=';
const double _startSecondsend = 000000000000000000000000000235;
const String _videoIdone = 'https://youtu.be/LwZIxGAG8xA?t=';
const double _startSecondsone = 000000000000000000000000000255;
const String _videoIdtwo = 'https://youtu.be/j1v2A5pyGlY?t=';
const double _startSecondstwo = 00000000000000000000000000073;
const String _videoIdthree = 'https://youtu.be/wJa5Ch0O4BI?t=';
const double _startSecondsthree = 000000000000000000000000000786;
const String _videoIdfour = 'https://youtu.be/PtkqwslbLY8?t=';
const double _startSecondsfour = 000000000000000000000000000165;
const String _videoIdfive = 'https://youtu.be/NE5H5intsck?t=';
