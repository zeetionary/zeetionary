...
class EnglishEntryideological extends StatefulWidget {
  ...
  @override
  State<EnglishEntryideological> createState() =>
      _EnglishEntryideologicalState();
}
...
1. Concerned with or suggestive of ideas (- ideologic)
"the drama's symbolism was very ideological"; "ideological application of a theory";
 
2. Of or pertaining to or characteristic of an orientation that characterizes the thinking of a group or nation/ˌaɪdiəˈlɒdʒɪkl/
""",
  );
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This was rejected for ideological reasons.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/3PX2d3Zwutg?t=';
    const double startSecondsone = 000000000000000000000000000248;
    const String videoIdtwo = 'https://youtu.be/qqZ_SH9N3Xo?t=';
    const double startSecondstwo = 0000000000000000000000000001297;
    const String videoIdthree = 'https://youtu.be/EmT0i0xG6zg?t=';
    const double startSecondsthree = 0000000000000000000000000005476;
    const String videoIdfour = 'https://youtu.be/MVu8QbxafJE?t=';
    const double startSecondsfour = 000000000000000000000000000132;
    const String videoIdfive = 'https://youtu.be/PhQksV8fbKw?t=';
    const double startSecondsfive = 0000000000000000000000000003055;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      britshText: """IpaUK: /ˌaɪdiəˈlɒdʒɪkl/""",
                      americanText: """IpaUS: /ˌaɪdiəˈlɑːdʒɪkl/""",
...
کوردی: بیروباوەڕی‌یانە، سەربە ئایدیۆلۆژی، ئایدیۆلۆژیکی
"""),
// With short examples define "ideological", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە پشتی بە ئایدۆلۆژیایەک بەستووە یان پەیوەندیدارە پێوەی"""),
                    SentencesRow(
                      englishText:
                          """This was rejected for ideological reasons.""",
                      kurdishText: """بۆ هۆکاری ئایدۆلۆژیایانە ڕەتکرایەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بزووتنەوەکە بە گۆڕانی ئایدیۆلۆژیدا تێدەپەڕێت.""",
