...
class EnglishEntryhumiliate extends StatefulWidget {
  const EnglishEntryhumiliate({super.key});

  @override
  State<EnglishEntryhumiliate> createState() => _EnglishEntryhumiliateState();
}

class _EnglishEntryhumiliateState extends State<EnglishEntryhumiliate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: humiliate (Derived forms: humiliated, humiliates, humiliating)
1. Cause to feel shame; hurt the pride of (- mortify, chagrin, humble, abase)
"He humiliated his colleague by criticising him in front of the boss";
""",
  );

  final String keyword = "humiliate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""humiliate""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I've never felt so humiliated.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How could I humiliate myself like that?""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000774;
    const String videoIdone = 'https://youtu.be/K0j2dlBMzUs?t=';
    const double startSecondsone = 0000000000000000000000000001083;
    const String videoIdtwo = 'https://youtu.be/vdiiIaKSSPA?t=';
    const double startSecondstwo = 000000000000000000000000000344;
    const String videoIdthree = 'https://youtu.be/6b-1YRenm5M?t=';
    const double startSecondsthree = 0000000000000000000000000001406;
    const String videoIdfour = 'https://youtu.be/qWNHsaszXpc?t=';
    const double startSecondsfour = 000000000000000000000000000944;
    const String videoIdfive = 'https://youtu.be/QpbGctuHoMY?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """humiliate""",
                      // alsoEnglishWord: "also: humiliate",
                      britshText: """IpaUK: /hjuːˈmɪlieɪt/""",
                      americanText: """IpaUS: /hjuːˈmɪlieɪt/""",
...
کوردی: 
"""),
// With short examples define "humiliate", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) سووکایەتی پێکردن"""),
                    SentencesRow(
                      englishText:
                          """I didn't want to humiliate her in front of her colleagues.""",
                      kurdishText:
                          """نەمدەویست سوکایەتی پێبکەم لە پێش هاوڕێکانی.""",
                    ...
                    SentencesRow(
                      englishText: """I've never felt so humiliated.""",
                      kurdishText:
                          """هەرگیز هێندە هەستم بە سووکایەتی نەکردووە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چۆن دەتوانم وەها سووکایەتی بە خۆم بکەم.""",
