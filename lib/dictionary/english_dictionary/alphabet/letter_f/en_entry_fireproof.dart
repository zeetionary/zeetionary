...
class EnglishEntryfireproof extends StatefulWidget {
  const EnglishEntryfireproof({super.key});

  @override
  State<EnglishEntryfireproof> createState() => _EnglishEntryfireproofState();
}

class _EnglishEntryfireproofState extends State<EnglishEntryfireproof> {
  @override
  void initState() {
    super.initState();
...
- Verb: fireproof (Derived forms: fireproofing, fireproofs, fireproofed)
1. Make resistant to fire
""",
  );

  final String keyword = "fireproof";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fireproof""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Put the mixture in a fireproof dish and bake for 45 minutes.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fireproof""",
                      // alsoEnglishWord: "also: fireproof",
                      britshText: """IpaUK: /ˈfaɪəpruːf/""",
                      americanText: """IpaUS: /ˈfaɪərpruːf/""",
...
// With short examples define "fireproof", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە توانای بەرگەگرتنی دژ بە گەرمی زۆر هەیە بەبێ ئەوەی زیانی پێ بگات"""),
                    SentencesRow(
                      englishText:
                          """Put the mixture in a fireproof dish and bake for 45 minutes.""",
                      kurdishText:
                          """تێکەڵەکە بکە قاپێکی دژەئاگر و بۆ ٤٥ خولەک بیبرژێنە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/_tHpanD6Nik?t=';
const double _startSecondsend = 000000000000000000000000000909;
const String _videoIdone = 'https://youtu.be/z4Bwb8_k7yM?t=';
const double _startSecondsone = 000000000000000000000000000548;
const String _videoIdtwo = 'https://youtu.be/4XlZHweHEtc?t=';
const double _startSecondstwo = 000000000000000000000000000124;
const String _videoIdthree = 'https://youtu.be/EkP3eDAROhM?t=';
const double _startSecondsthree = 00000000000000000000000000064;
const String _videoIdfour = 'https://youtu.be/4cw5MZkjW5k?t=';
const double _startSecondsfour = 000000000000000000000000000175;
const String _videoIdfive = 'https://youtu.be/ZI-FuZ4frHg?t=';
const double _startSecondsfive = 000000000000000000000000000571;
