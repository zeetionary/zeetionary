...
// Define the word "athlete" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryathlete - replace speakAthlete

// replace athlete - /ˈæθliːt/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryathlete extends StatelessWidget {
  // blank divider
  EnglishEntryathlete({super.key});
  // blank divider
  ...
  Future<void> speakathlete(String languageCode) async {
    ...
    await flutterTts.speak("athlete");
  }
  ...
  Future<void> speakathlete754(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The athletes are training hard for the Olympics.");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "athlete"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæθliːt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæθliːt/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakathlete754("en-GB"),
                            onPressedAmerican: () => speakathlete754("en-US"),
                          ),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'URz-RYEOaig';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'G8PP7_JyYtQ';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'DfhC60OrpEY';
