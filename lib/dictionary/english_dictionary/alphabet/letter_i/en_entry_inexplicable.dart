...
class EnglishEntryinexplicable extends StatefulWidget {
  const EnglishEntryinexplicable({super.key});

  @override
  State<EnglishEntryinexplicable> createState() =>
      _EnglishEntryinexplicableState();
}

class _EnglishEntryinexplicableState extends State<EnglishEntryinexplicable> {
  @override
  void initState() {
    super.initState();
...
1. Incapable of being explained or accounted for (- incomprehensible)
"left the house at three in the morning for inexplicable reasons"; "inexplicable errors";
""",
  );

  final String keyword = "inexplicable";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inexplicable""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""For some inexplicable reason he gave up a fantastic job.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/UrkPC81_QfU?t=';
    const double startSecondsone = 000000000000000000000000000893;
    const String videoIdtwo = 'https://youtu.be/6CN9HpYrjeM?t=';
    const double startSecondstwo = 000000000000000000000000000382;
    const String videoIdthree = 'https://youtu.be/d8AKUKdCTuA';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/i9InAbpM7mU?t=';
    const double startSecondsfour = 000000000000000000000000000778;
    const String videoIdfive = 'https://youtu.be/PhAWyOuIedc?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inexplicable""",
                      // alsoEnglishWord: "also: inexplicable",
                      britshText: """IpaUK: /ˌɪnɪkˈsplɪkəbl/""",
                      americanText: """IpaUS: /ˌɪnɪkˈsplɪkəbl/""",
...
کوردی: ڕوون(ەوە)نەکراو، لێکەوەنەدراو، لێک نادرێتەوە، ڕوون ناکرێتەوە، لەڕوون‌کردنەوەنەهاتوو، ئاڵۆز، لێ‌تێنەگەیشتوو، سەیر
"""),
// With short examples define "inexplicable", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە جێگای تێگەشتن یان ڕوونکردنەوە نییە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: incomprehensible"),
                    SentencesRow(
                      englishText:
                          """For some inexplicable reason he gave up a fantastic job.""",
                      kurdishText:
                          """بۆ هەندێک هۆکاری ڕووننەکراوە وازی لە کارێکی ناوازە هێنا.""",
