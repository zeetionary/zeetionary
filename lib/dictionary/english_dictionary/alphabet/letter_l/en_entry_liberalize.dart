...
class EnglishEntryliberalize extends StatefulWidget {
  const EnglishEntryliberalize({super.key});

  @override
  State<EnglishEntryliberalize> createState() => _EnglishEntryliberalizeState();
}

class _EnglishEntryliberalizeState extends State<EnglishEntryliberalize> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""liberalize""");
  }
