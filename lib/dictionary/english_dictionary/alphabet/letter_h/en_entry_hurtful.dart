...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '6noCpwaFbVw';
    const double startSecondsend = 480;
    const String videoIdone = 'NEoOJ0uRskY';
    const double startSecondsone = 245;
    const String videoIdtwo = 'aTMsfOcHiJg';
    const double startSecondstwo = 682;
    const String videoIdthree = 'fC0eoM5Jwg4';
    const double startSecondsthree = 140;
    const String videoIdfour = 'dwBWTDiR0T4';
    const double startSecondsfour = 47;
    const String videoIdfive = 'cwEM0ib6ZbU';
