...
class EnglishEntryforefinger extends StatefulWidget {
  const EnglishEntryforefinger({super.key});

  @override
  State<EnglishEntryforefinger> createState() => _EnglishEntryforefingerState();
}

class _EnglishEntryforefingerState extends State<EnglishEntryforefinger> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forefinger (Derived forms: forefingers)
1. The finger next to the thumb (= index, index finger)
"His forefinger darted in all directions as he spoke";
""",
  );

  final String keyword = "forefinger";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forefinger""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The forefinger is often used for typing on a keyboard.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forefinger""",
                      // alsoEnglishWord: "also: forefinger",
                      britshText: """IpaUK: /ˈfɔːfɪŋɡə(r)/""",
                      americanText: """IpaUS: /ˈfɔːrfɪŋɡər/""",
...
کوردی: قامکی شادە، دۆشاومژە، شادەنوێژ، پێش‌قامک
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دۆشاومژە؛ پەنجەی شەهادە هێنان؛ پەنجەی تەنیشت پەنجە گەورە (ئەسپێ کوژە)"""),
                    SentencesRow(
                      englishText:
                          """The forefinger is often used for typing on a keyboard.""",
                      kurdishText:
                          """دۆشاومژە زۆرجار بەکاردێت بۆ نووسین لەسەر تەختەکلیل.""",
...
const double _startSecondsend = 000000000000000000000000000860;
const String _videoIdone = 'https://youtu.be/lRTBXOa15n4?t=';
const double _startSecondsone = 00000000000000000000000000082;
const String _videoIdtwo = 'https://youtu.be/KIzqSTEC5kU?t=';
const double _startSecondstwo = 000000000000000000000000000433;
const String _videoIdthree = 'https://youtu.be/v8o-Vd__I-A?t=';
const double _startSecondsthree = 000000000000000000000000000102;
const String _videoIdfour = 'https://youtu.be/alubBa1s2G0?t=';
const double _startSecondsfour = 00000000000000000000000000044;
const String _videoIdfive = 'https://youtu.be/DYULoYxptmk?t=';
const double _startSecondsfive = 000000000000000000000000000300;
