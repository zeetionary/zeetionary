...
// replace these: replace EnglishEntryaerospace - replace speakAerospace - replace aerospace - /ˈerəʊspeɪs/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaerospace extends StatelessWidget {
  EnglishEntryaerospace({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAerospace(String languageCode) async {
    // DOPSUM: CHANGE speakAerospace
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("aerospace"); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈeərəʊspeɪs/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'KCiohr3QDAQ';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'PvBKF1y2Zyk';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'UvtYn2j78gw';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'jpN-mlqwPwM';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'TT0KA3p_EuY';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'cwNVRZCILZA';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'lGjtqxOgHf0';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'Nugc_RO56cQ';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = 'rVAQk8grvA8';
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = 'D2_w38e-o_g';
