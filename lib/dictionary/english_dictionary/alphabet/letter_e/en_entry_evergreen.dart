...
class EnglishEntryevergreen extends StatefulWidget {
  const EnglishEntryevergreen({super.key});

  @override
  State<EnglishEntryevergreen> createState() => _EnglishEntryevergreenState();
}

class _EnglishEntryevergreenState extends State<EnglishEntryevergreen> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evergreen""",
                      // alsoEnglishWord: "also: evergreen",
                      britshText: """IpaUK: /ˈevəɡriːn/""",
                      americanText: """IpaUS: /ˈevərɡriːn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "evergreen";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""People still enjoy the evergreen TV series 'Friends.'""");
  }
...
کوردی: هەمیشەسەوز، سەوزەون، هەمیشەبەهار، بێ‌پاییز،	درێژخایەن، درێژماوە، بەردەوام، ڕووەکی هەمیشەسەوز یا سەوزەون
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) کە تەواوی ساڵ گەڵای سەوزی هەیە"""),
          SentencesRow(
            englishText: """The forest is full of evergreen trees.""",
            kurdishText: """دارستانەکە پڕ لە داری هەمیشەسەوزە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """خەڵکی هێشتا چێژ دەبینن لە زنجیرەی درێژماوەی 'Friends.'""",
            onPressedBritish: () => speaksentence2("en-GB"),
            onPressedAmerican: () => speaksentence2("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) درەختێک کە بەردەوام گەڵای سەوزی هەیە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Few plants grow under the dense shade cast by the evergreens.""",
            kurdishText:
                """کەم ڕووەک گەشە دەکەن لەژێر سێبەری چڕی دارە هەمیشەسەوزەکان.""",
...
- Noun: evergreen (Derived forms: evergreens)
1. A plant having foliage that persists and remains green throughout the year (= evergreen plant)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/y9nBhv0lq1s?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1344;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/oiLdWXLXDeA?t=';
const double _startSecondsone = 00000000000000000000000000000; // 126;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/-QYIm5WV04I?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 242;
const String _videoIdthree = 'VIDEOhttps://youtu.be/ORcTvgK-vPg?t=';
const double _startSecondsthree = 000000000000000000000000000; // 252;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/RgLC_DRd2cg?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 260;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/vvKgnRPThKI?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 178;
