...
class EnglishEntryfuriously extends StatefulWidget {
  const EnglishEntryfuriously({super.key});

  @override
  State<EnglishEntryfuriously> createState() => _EnglishEntryfuriouslyState();
}

class _EnglishEntryfuriouslyState extends State<EnglishEntryfuriously> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "furiously";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""furiously""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furiously""",
                      // alsoEnglishWord: "also: furiously",
                      britshText: """IpaUK: /ˈfjʊəriəsli/""",
                      americanText: """IpaUS: /ˈfjʊriəsli/""",
...
کوردی: بە توندی، توند، بە تووڕەیی‌یەوە، بە ڕق‌هەستانەوە
"""),
// With short examples define "furiously", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """He glared furiously at the teacher and then slammed his book down on the desk.""",
                      kurdishText:
                          """بە تووڕەییەوە دەیڕوانی لە مامۆستاکە و دواتر کتێبەکەیی کێشا بە دێسکەکەدا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """They worked furiously all weekend, trying to get it finished on time.""",
                      kurdishText:
                          """تەواوی کۆتایی هەفتەکە بە جۆشەوە کاریان دەکرد بۆ ئەوەی لە کاتی خۆیدا تەواوی بکەن.""",
...
const String _videoIdone = 'https://youtu.be/3Kd2x1mXV_k?t=';
const double _startSecondsone = 00000000000000000000000000066;
const String _videoIdtwo = 'https://youtu.be/3ESxmyDnTms?t=';
const double _startSecondstwo = 000000000000000000000000000641;
const String _videoIdthree = 'https://youtu.be/kMYZ3fUlZFA?t=';
const double _startSecondsthree = 000000000000000000000000000408;
const String _videoIdfour = 'https://youtu.be/mtDOr9UY-yk?t=';
const double _startSecondsfour = 00000000000000000000000000074;
const String _videoIdfive = 'https://youtu.be/fb_SQOIC_zY?t=';
const double _startSecondsfive = 0000000000000000000000000001884;
