...
class EnglishEntryherd extends StatefulWidget {
  const EnglishEntryherd({super.key});

  @override
  State<EnglishEntryherd> createState() => _EnglishEntryherdState();
}

class _EnglishEntryherdState extends State<EnglishEntryherd> {
  @override
  void initState() {
    super.initState();
...
3. A crowd especially of ordinary or undistinguished persons or things (- ruck)
"the children resembled a fairy herd";

- Verb: herd (Derived forms: herding, herded, herds)
1. Cause to herd, drive, or crowd together (- crowd)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The animals tend to graze in a herd.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Why follow the herd?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We all herded on to the bus.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They were herded together into trucks and driven away.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""An old woman was herding the goats.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """herd""",
                      // alsoEnglishWord: "also: herd",
                      britshText: """IpaUK: /hɜːd/""",
                      americanText: """IpaUS: /hɜːrd/""",
...
کوردی: ڕەوە، ڕەمە، مێگەل، گەل، ڕان، جەلە، جەڵەب،	ڕەشەوڕووتە، جەماوەر، خەڵک
"""),
// With short examples define "herd", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ژمارەیەک ئاژەڵ کە لە هەمان جۆرن و پێکەوە دەژین و دەلەوەڕێن"""),
                    SentencesRow(
                      englishText: """The animals tend to graze in a herd.""",
                      kurdishText:
                          """ئاژەڵەکان مەیلی ئەوەیان هەیە بە ڕان بژین.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ژمارەیەکی زۆر کە کە لە هەمان شێوەن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Why follow the herd (= do and think the same as everyone else)?""",
                      kurdishText: """بۆ شوێن مێگەلەکە دەکەویت؟""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) جووڵاندنی کەسێک/شتێک بە ئاراستەیەکی دیاریکراودا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We all herded on to the bus.""",
                      kurdishText: """هەموومان سەرکەوتینە سەر پاسەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پێکەوە سەرخرانە سەر بارهەڵگر و بردران.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (کردار) لەوەڕاندنی مەڕ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """An old woman was herding the goats.""",
                      kurdishText: """ژنێکی بەتەمەن مەڕەکانی دەلەوەڕاند.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/yBUJpu5sRoo?t=';
const double _startSecondsend = 00000000000000000000000000066;
const String _videoIdone = 'https://youtu.be/L64gojl6IM0?t=';
const double _startSecondsone = 0000000000000000000000000006;
const String _videoIdtwo = 'https://youtu.be/kaI20-T2GNg?t=';
const double _startSecondstwo = 0000000000000000000000000005;
const String _videoIdthree = 'https://youtu.be/R4sk6CwmdIA?t=';
const double _startSecondsthree = 00000000000000000000000000024;
const String _videoIdfour = 'https://youtu.be/yweK_qXp-yM?t=';
const double _startSecondsfour = 00000000000000000000000000037;
const String _videoIdfive = 'https://youtu.be/7sFYxV72YCM';
