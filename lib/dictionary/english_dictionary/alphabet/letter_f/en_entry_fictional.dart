...
class EnglishEntryfictional extends StatefulWidget {
  const EnglishEntryfictional({super.key});

  @override
  State<EnglishEntryfictional> createState() => _EnglishEntryfictionalState();
}

class _EnglishEntryfictionalState extends State<EnglishEntryfictional> {
  @override
  void initState() {
    super.initState();
...
2. Formed or conceived by the imagination (= fabricated, fancied, fictitious, made-up)
"a fictional character";
""",
  );

  final String keyword = "fictional";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fictional""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The names of the characters are entirely fictional.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fictional""",
                      // alsoEnglishWord: "also: fictional",
                      britshText: """IpaUK: /ˈfɪkʃənl/""",
                      americanText: """IpaUS: /ˈfɪkʃənl/""",
...
// With short examples define "fictional", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ناوی کارەکتەرەکان تەواو خەیاڵین.""",
...
const double _startSecondsone = 0000000000000000000000000007;
const String _videoIdtwo = 'https://youtu.be/8eq2vGEEbB4?t=';
const double _startSecondstwo = 000000000000000000000000000586;
const String _videoIdthree = 'https://youtu.be/k4vRFodAqWo?t=';
...
const String _videoIdfive = 'https://youtu.be/-I6YmMAThZ8?t=';
