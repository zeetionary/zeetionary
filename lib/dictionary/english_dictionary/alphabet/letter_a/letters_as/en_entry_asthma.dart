...
class EnglishEntryasthma extends StatelessWidget {
  ...
  Future<void> speakasthma1012(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("We have thousands of asthma cases a year.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "asthma"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæsmə/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæzmə/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'g3TyNYXV250';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'mMbYKmLAtgU';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'dpTNUGwXbTU';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'icbuoq5Dc9A';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'DwemPKOqsio';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'JzMVGHaSufw';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'txUuZFRnQMU';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'F1mjz046XTA';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'ozyruyITxKg';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'qIY0bL3SmHI';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'c2w1A01lSmM';
  final double _startSeconds = 1;
