...
class EnglishEntryexhibitionist extends StatefulWidget {
  const EnglishEntryexhibitionist({super.key});

  @override
  State<EnglishEntryexhibitionist> createState() =>
      _EnglishEntryexhibitionistState();
}

class _EnglishEntryexhibitionistState extends State<EnglishEntryexhibitionist> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exhibitionist""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exhibitionist""",
                      // alsoEnglishWord: "also: exhibitionist",
                      britshText: """IpaUK: /ˌeksɪˈbɪʃənɪst/""",
                      americanText: """IpaUS: /ˌeksɪˈbɪʃənɪst/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exhibitionist";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Children are natural exhibitionists.""");
  }
...
// With short examples define "exhibitionist", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کەسێک کە حەز دەکات سەرنجی کەسانی دیکە ڕابکێشێت"""),
          SentencesRow(
            englishText: """Children are natural exhibitionists.""",
            kurdishText: """منداڵان خۆدەرخەری سرووشتین.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: exhibitionist (Derived forms: exhibitionists)
1. Someone with a compulsive desire to expose the genitals (= flasher [informal])
 
2. Someone who deliberately behaves in such a way as to attract attention (= show-off [informal], showboat [N. Amer, informal])
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/EmT0i0xG6zg?t=';
const double _startSecondsend = 000000000000000000000000000000; // 2400;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/DOj_GoB8xYk?t=';
const double _startSecondsone = 00000000000000000000000000000; // 431;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/Kz8nhdnxfOg?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 303;
const String _videoIdthree = 'VIDEOhttps://youtu.be/rCTs-sprWwA?t=';
const double _startSecondsthree = 000000000000000000000000000; // 436;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/pJP7nOxemr4?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 563;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/CqqjYSXHfpY?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 2431;
