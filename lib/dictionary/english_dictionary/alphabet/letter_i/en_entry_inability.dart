...
class EnglishEntryinability extends StatefulWidget {
  const EnglishEntryinability({super.key});

  @override
  State<EnglishEntryinability> createState() => _EnglishEntryinabilityState();
}

class _EnglishEntryinabilityState extends State<EnglishEntryinability> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inability""");
  }
