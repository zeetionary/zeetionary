...
class EnglishEntryhotheaded extends StatefulWidget {
  const EnglishEntryhotheaded({super.key});

  @override
  State<EnglishEntryhotheaded> createState() => _EnglishEntryhotheadedState();
}

class _EnglishEntryhotheadedState extends State<EnglishEntryhotheaded> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hot-headed
1. Quickly aroused to anger (- choleric, irascible, hot-tempered, quick-tempered, short-tempered)
"a hot-headed commander";
 
2. Characterized by undue haste and lack of thought or deliberation (- impulsive, impetuous, madcap, tearaway, brainish [archaic])
"a hot-headed decision";
""",
  );

  final String keyword = "hot-headed";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hot-headed""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The riots were started by a few hot-headed youths.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/I8dQfQekmcs?t=';
    const double startSecondsend = 00000000000000000000000000069;
    const String videoIdone = 'https://youtu.be/RB8n85r67nE?t=';
    const double startSecondsone = 000000000000000000000000000454;
    const String videoIdtwo = 'https://youtu.be/gTegijTH7rg?t=';
    const double startSecondstwo = 000000000000000000000000000635;
    const String videoIdthree = 'https://youtu.be/aXnCxZXwSzI?t=';
    const double startSecondsthree = 000000000000000000000000000246;
    const String videoIdfour = 'https://youtu.be/7Ocqa9SrqN8?t=';
    const double startSecondsfour = 0000000000000000000000000001890;
    const String videoIdfive = 'https://youtu.be/ligo_LBPfiE?t=';
    const double startSecondsfive = 000000000000000000000000000505;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hot-headed""",
                      // alsoEnglishWord: "also: hot-headed",
                      britshText: """IpaUK: /ˌhɒt ˈhedɪd/""",
                      americanText: """IpaUS: /ˌhɑːt ˈhedɪd/""",
...
کوردی: 
"""),
// With short examples define "hot-headed", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) ڕەفتارکردن زۆر بە خێرایی بەبێ بیرکردنەوە لەوەی چی ڕوودەدات"""),
                    SentencesRow(
                      englishText:
                          """The riots were started by a few hot-headed youths.""",
                      kurdishText:
                          """ئاژاوەکان لەلایەن ژمارەیەک گەنجی هەڵەشەوە دەست پێکران.""",
