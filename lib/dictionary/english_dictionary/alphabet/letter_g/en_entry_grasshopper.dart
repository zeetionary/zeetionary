...
class EnglishEntrygrasshopper extends StatefulWidget {
  const EnglishEntrygrasshopper({super.key});

  @override
  State<EnglishEntrygrasshopper> createState() =>
      _EnglishEntrygrasshopperState();
}

class _EnglishEntrygrasshopperState extends State<EnglishEntrygrasshopper> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grasshopper (Derived forms: grasshoppers)
1. Terrestrial plant-eating insect with hind legs adapted for leaping (- hopper)
 
2. A cocktail made of crème de menthe and cream (sometimes with crème de cacao)
""",
  );

  final String keyword = "grasshopper";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grasshopper""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He watched a grasshopper hop across the yard.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grasshopper""",
                      // alsoEnglishWord: "also: grasshopper",
                      britshText: """IpaUK: /ˈɡrɑːshɒpə(r)/""",
                      americanText: """IpaUS: /ˈɡræshɑːpər/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """He watched a grasshopper hop across the yard.""",
                      kurdishText:
                          """سەیری کەللەیەکی کرد کە بە حەوشەکەدا بازی دەدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/TOTd78ZTDGE?t=';
...
const String _videoIdtwo = 'https://youtu.be/g0amdIcZt5I?t=';
const double _startSecondstwo = 0000000000000000000000000001034;
const String _videoIdthree = 'https://youtu.be/nnzYZdGFzzM?t=';
const double _startSecondsthree = 00000000000000000000000000072;
const String _videoIdfour = 'https://youtu.be/JhOU3FOyApM?t=';
const double _startSecondsfour = 000000000000000000000000000369;
const String _videoIdfive = 'https://youtu.be/j7JHwc607Vk?t=';
const double _startSecondsfive = 000000000000000000000000000602;
