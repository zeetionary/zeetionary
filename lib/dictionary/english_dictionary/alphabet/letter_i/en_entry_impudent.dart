...
class EnglishEntryimpudent extends StatefulWidget {
  const EnglishEntryimpudent({super.key});

  @override
  State<EnglishEntryimpudent> createState() => _EnglishEntryimpudentState();
}

class _EnglishEntryimpudentState extends State<EnglishEntryimpudent> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: impudent
1. Marked by casual disrespect (- insolent, snotty-nosed, flip)
"the student was kept in for impudent behaviour";
 
2. Improperly forward or bold (- fresh, impertinent, overbold, smart, saucy [informal], sassy [N. Amer, informal], wise, lippy [informal])
"an impudent boy given to insulting strangers";
""",
  );

  final String keyword = "impudent";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impudent""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The student’s impudent behavior angered the teacher.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/E1WZ2i6yeWw?t=';
    const double startSecondsend = 000000000000000000000000000756;
    const String videoIdone = 'https://youtu.be/3V-dmbxWcz4?t=';
    const double startSecondsone = 00000000000000000000000000013859;
    const String videoIdtwo = 'https://youtu.be/Vjt6DEGP6cA?t=';
    const double startSecondstwo = 000000000000000000000000000442;
    const String videoIdthree = 'https://youtu.be/oufkGP_3N9A?t=';
    const double startSecondsthree = 000000000000000000000000000210;
    const String videoIdfour = 'https://youtu.be/gcolkUysqro?t=';
    const double startSecondsfour = 0000000000000000000000000008;
    const String videoIdfive = 'https://youtu.be/fSPa402MRPc?t=';
    const double startSecondsfive = 000000000000000000000000000388;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """impudent""",
                      // alsoEnglishWord: "also: impudent",
                      britshText: """IpaUK: /ˈɪmpjədənt/""",
                      americanText: """IpaUS: /ˈɪmpjədənt/""",
...
کوردی: بێ‌شەرم، بێ‌حەیا، هەرزە، ڕووهەڵماڵراو، ئاوەسوو، ڕوودار، هەرزانە، ڕوودارانە
"""),
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) بێ شەرم و ڕێز"""),
                    const AlsoEnglishckb(word: "ھەروەھا: impertinent"),
                    SentencesRow(
                      englishText:
                          """The student’s impudent behavior angered the teacher.""",
                      kurdishText:
                          """ڕەفتاری بێ‌شەرمانەی خوێندکارەکە مامۆستاکەی تووڕە کرد.""",
