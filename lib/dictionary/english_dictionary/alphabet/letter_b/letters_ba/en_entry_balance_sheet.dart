...
// Define the word "balance sheet" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace balance sheet - replace EnglishEntrybalancesheet

// replace speakBalancesheet - /ˈbæləns ʃiːt/

enum TtsState { playing }

class EnglishEntrybalancesheet extends StatelessWidget {
// blank divider
  EnglishEntrybalancesheet({super.key});
// blank divider
  ...
  Future<void> speakbalancesheet(String languageCode) async {
    ...
    await flutterTts.speak("balance sheet");
  }
  ...
  Future<void> speakbalancesheets2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBalancesheets22");
  }
  ...
  Future<void> speakbalancesheets3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBalancesheets33");
  }
  ...
  Future<void> speakbalancesheets4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBalancesheets44");
  }
  ...
  Future<void> speakbalancesheets5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBalancesheets55");
  }
  ...
  Future<void> speakbalancesheets6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBalancesheets66");
  }
  ...
  Future<void> speakbalancesheets7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBalancesheets77");
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "balance sheet"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈbæləns ʃiːt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈbæləns ʃiːt/"),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'k84bDit_wts';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 3485;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'ZcfitxiEJU8';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final double _startSeconds = 8563;
...
// end balance sheet // TODO Implement this library.
