...
class EnglishEntryfinely extends StatefulWidget {
  const EnglishEntryfinely({super.key});

  @override
  State<EnglishEntryfinely> createState() => _EnglishEntryfinelyState();
}

class _EnglishEntryfinelyState extends State<EnglishEntryfinely> {
  @override
  void initState() {
    super.initState();
...
3. In a delicate manner (= fine, delicately, exquisitely)
"finely shaped features";
""",
  );

  final String keyword = "finely";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Chop the carrots very finely.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The painting depicts a finely-dressed couple.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The match was finely balanced throughout.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """finely""",
                      // alsoEnglishWord: "also: finely",
                      britshText: """IpaUK: /ˈfaɪnli/""",
                      americanText: """IpaUS: /ˈfaɪnli/""",
...
کوردی: ناسک، ورد،	زۆر، بە هەرەباشی
"""),
// With short examples define "finely", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) بۆ بەشی زۆر بچووک"""),
                    SentencesRow(
                      englishText: """Chop the carrots very finely.""",
                      kurdishText: """گەزەرەکان زۆر بە بچووکی ورد بکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تابلۆکە دوو خۆشەویستەکە بە جلی زۆر جوانەوە پیشان دەدات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """یارییەکە تا کۆتایی هاوسەنگ بوو.""",
...
const String _videoIdone = 'https://youtu.be/g9QneAV4fVo?t=';
const double _startSecondsone = 000000000000000000000000000299;
const String _videoIdtwo = 'https://youtu.be/_Q0FYoCl4Cs?t=';
const double _startSecondstwo = 000000000000000000000000000508;
const String _videoIdthree = 'https://youtu.be/twAP3buj9Og?t=';
const double _startSecondsthree = 0000000000000000000000000001255;
const String _videoIdfour = 'https://youtu.be/rPdln-PUZuE?t=';
const double _startSecondsfour = 000000000000000000000000000191;
const String _videoIdfive = 'https://youtu.be/w7CtP73taJA?t=';
