...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'https://youtu.be/r5RjuhqQSec?t=';
    const double startSecondstwo = 000000000000000000000000000548;
    const String videoIdthree = 'https://youtu.be/s3B-qp3U5G0?t=';
    const double startSecondsthree = 000000000000000000000000000997;
    const String videoIdfour = 'https://youtu.be/AF8d72mA41M?t=';
    const double startSecondsfour = 0000000000000000000000000001253;
    const String videoIdfive = 'https://youtu.be/PhNUjg9X4g8';
