...
// replace EnglishEntryAdopsum - replace speakArbitrarily

// replace arbitrarily - /ˌɑːbɪˈtrerəli/,  /ˈɑːbɪtrəli/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarbitrarily extends StatelessWidget {
  // blank divider
  EnglishEntryarbitrarily({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakArbitrarily(String languageCode) async {
    // DOPSUM: CHANGE speakArbitrarily
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "arbitrarily"), // DOPSUM: CHANGE WORD ENTRY - Find /ˌɑːbɪˈtrerəli/,  /ˈɑːbɪtrəli/
                            // divvviiider
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /ˌɑːbɪˈtrerəli/,  /ˈɑːbɪtrəli/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                            CustomIconButtonBritish(
                              onPressed: () => speakArbitrarily(
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /ˌɑːrbɪˈtrerəli/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find WORD_WEB
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "IcdSrDsGnZ0";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "FWYsvw_U3Zw";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "F0rXPrnC_Ps";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "8A3jiM2FNR8";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "15SILwg5ehc";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "KA0nGrdrG5A";
