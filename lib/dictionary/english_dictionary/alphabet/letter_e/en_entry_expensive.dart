...
class EnglishEntryexpensive extends StatefulWidget {
  const EnglishEntryexpensive({super.key});

  @override
  State<EnglishEntryexpensive> createState() => _EnglishEntryexpensiveState();
}

class _EnglishEntryexpensiveState extends State<EnglishEntryexpensive> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""expensive""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """expensive""",
                      // alsoEnglishWord: "also: expensive",
                      britshText: """IpaUK: /ɪkˈspensɪv/""",
                      americanText: """IpaUS: /ɪkˈspensɪv/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "expensive";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I can't afford it—it's too expensive.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Making the wrong decision could prove expensive.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Art books are expensive to produce.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It's expensive to live in London.""");
  }
...
کوردی: گرانبایی، گرانبا، گران، زۆربڕ، پڕخەرج، خەرج‌هەڵگر، پڕمەزاخ
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) کە پارەی زۆری دەوێت"""),
          SentencesRow(
            englishText: """I can't afford it—it's too expensive.""",
            kurdishText: """ناتوانم بیکڕم ـ زۆر گران‌بەهایە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Making the wrong decision could prove expensive.""",
            kurdishText: """بڕیاردانی هەڵە ڕەنگە پارەی زۆر بکەوێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Art books are expensive to produce.""",
            kurdishText: """کتێبی هونەری بەرهەمهێنانی پڕخەرجە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """It's expensive to live in London.""",
            kurdishText: """ژیانکردن لە لەندەن پڕخەرجە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """ئێستا گرانترە بۆ ئەورووپییەکان سەردانی ئێرە بکەن.""",
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/f8VTSGLCa1M?t=';
const double _startSecondsend = 000000000000000000000000000000; // 332;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/2TUGZ1VQDss?t=';
const double _startSecondsone = 00000000000000000000000000000; // 533;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/dfuPBC-v5NE?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 200;
const String _videoIdthree = 'VIDEOhttps://youtu.be/B0lwiInZG1E?t=';
const double _startSecondsthree = 000000000000000000000000000; // 6;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/dAMf5L_PLdo?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 114;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/_spuxXnul0U?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 293;
