...
class EnglishEntryinfinitive extends StatefulWidget {
  const EnglishEntryinfinitive({super.key});

  @override
  State<EnglishEntryinfinitive> createState() => _EnglishEntryinfinitiveState();
}

class _EnglishEntryinfinitiveState extends State<EnglishEntryinfinitive> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infinitive""");
  }
