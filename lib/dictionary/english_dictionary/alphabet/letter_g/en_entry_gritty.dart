...
class EnglishEntrygritty extends StatefulWidget {
  const EnglishEntrygritty({super.key});

  @override
  State<EnglishEntrygritty> createState() => _EnglishEntrygrittyState();
}

class _EnglishEntrygrittyState extends State<EnglishEntrygritty> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: gritty
1. Composed of or covered with particles resembling meal in texture or consistency (- farinaceous, coarse-grained, grainy, granular, granulose, mealy)
"the photographs were gritty and indistinct";
 
2. Willing to face danger (- game [informal], gamy, gamey, mettlesome, spirited, spunky [informal])
 
3. Starkly realistic
"It's what our films are known for, a kind of gritty realism."
""",
  );

  final String keyword = "gritty";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He sat uncomfortably on the gritty pavement.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The novel was praised for its gritty realism.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gritty""",
                      // alsoEnglishWord: "also: gritty",
                      britshText: """IpaUK: /ˈɡrɪti/""",
                      americanText: """IpaUS: /ˈɡrɪti/""",
...
"""),
// With short examples define "gritty", please follow LX instructions
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/4VTOplLl2BM?t=';
const double _startSecondsend = 0000000000000000000000000001090;
const String _videoIdone = 'https://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondsone = 0000000000000000000000000003733;
const String _videoIdtwo = 'https://youtu.be/JcpboMScfIY?t=';
const double _startSecondstwo = 000000000000000000000000000363;
const String _videoIdthree = 'https://youtu.be/Jl0IDXkYKbk?t=';
const double _startSecondsthree = 000000000000000000000000000332;
const String _videoIdfour = 'https://youtu.be/0UABTaB-_i8?t=';
const double _startSecondsfour = 000000000000000000000000000482;
const String _videoIdfive = 'https://youtu.be/o1RS7D_szJo?t=';
