...
class EnglishEntrylose extends StatefulWidget {
  const EnglishEntrylose({super.key});

  @override
  State<EnglishEntrylose> createState() => _EnglishEntryloseState();
}

class _EnglishEntryloseState extends State<EnglishEntrylose> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylose lose
WORD_WEB lose lose lose
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lose";
...
کوردی: 
"""),
// With short examples define "lose", please follow LX instructions
