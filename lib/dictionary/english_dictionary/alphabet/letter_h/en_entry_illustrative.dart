...
class EnglishEntryillustrative extends StatefulWidget {
  const EnglishEntryillustrative({super.key});

  @override
  State<EnglishEntryillustrative> createState() =>
      _EnglishEntryillustrativeState();
}

class _EnglishEntryillustrativeState extends State<EnglishEntryillustrative> {
  @override
  void initState() {
    super.initState();
...
1. Clarifying by use of examples (- exemplifying)
 
2. Serving to demonstrate (- demonstrative)
""",
  );

  final String keyword = "illustrative";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""illustrative""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/ZvGFV1WoVeo?t=';
    const double startSecondsend = 00000000000000000000000000091;
    const String videoIdone = 'https://youtu.be/oI_X2cMHNe0?t=';
    const double startSecondsone = 0000000000000000000000000001169;
    const String videoIdtwo = 'https://youtu.be/9yrj2iSuI38?t=';
    const double startSecondstwo = 000000000000000000000000000660;
    const String videoIdthree = 'https://youtu.be/7J7X7aZvMXQ?t=';
    const double startSecondsthree = 000000000000000000000000000875;
    const String videoIdfour = 'https://youtu.be/dtvuMNVLISo?t=';
    const double startSecondsfour = 0000000000000000000000000002027;
    const String videoIdfive = 'https://youtu.be/XbmVKmAA2XU?t=';
    const double startSecondsfive = 000000000000000000000000000346;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """illustrative""",
                      // alsoEnglishWord: "also: illustrative",
                      britshText: """IpaUK: /ˈɪləstrətɪv/,  /ˈɪləstreɪtɪv/""",
                      americanText: """IpaUS: /ɪˈlʌstrətɪv/""",
...
کوردی: ڕوون‌کردنەوەیی، ڕوون‌کەرەوە، ڕۆشن‌گەر، ڕۆشن‌کەرەوە،	وێنەدار،	دەرخەر، نیشان‌دەر
"""),
// With short examples define "illustrative", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە یارمەتیدەر دەبێت لە ڕوونکردنەوەی شتێک یان بە ڕوونتر پیشانی بدات"""),
                    const AlsoEnglishckb(word: "ھەروەھا: explanatory"),
                    SentencesRow(
                      englishText:
                          """Falling house prices are illustrative of the crisis facing the construction industry.""",
                      kurdishText:
                          """دابەزینی نرخی خانوو دەرخەری ئەو قەیرانەن کە ڕووبەڕووی پیشەسازی بنیاتنان بووەتەوە.""",
