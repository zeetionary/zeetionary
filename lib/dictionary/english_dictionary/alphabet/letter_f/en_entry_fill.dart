...
class EnglishEntryfill extends StatefulWidget {
  const EnglishEntryfill({super.key});

  @override
  State<EnglishEntryfill> createState() => _EnglishEntryfillState();
}

class _EnglishEntryfillState extends State<EnglishEntryfill> {
  @override
  void initState() {
    super.initState();
...
2. Become full (= fill up)
"The pool slowly filled with water"; "The theatre filled up slowly";
 
3. Take up all the available space (= occupy)
"The liquid fills the container";
 
4. Assume, as of positions or roles (= take, occupy)
"She filled the job as director of development";
 
5. Obtain something that is wanted, needed or required (= fit, conform to, meet, satisfy, fulfill [N. Amer], fulfil [Brit, Cdn])
 
6. Appoint someone to (a position or a job)
 
7. Eat until one is sated (= fill up)
"He filled up on turkey";
 
8. Fill to satisfaction (= satiate, sate, replete)
"I am filled";
...
2. Any material that fills a space or container (= filling)
"there was not enough fill for the trench";
""",
  );

  final String keyword = "fill";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Please fill this glass for me.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Smoke filled the room.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her image filled the screen.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The wind filled the sails.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""A Disney film can always fill cinemas.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The school is filled to capacity.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She filled the page with writing.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Fill a pan half full of water.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""You've filled it too full.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The sails filled with wind.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The room filled with smoke.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The crack in the wall had been filled with plaster.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I need to have two teeth filled.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""A deep joy filled me.""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We were all filled with admiration for his achievements.""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His heart filled with pride.""");
  }
  ...
  Future<void> speaksentence18(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The sound of bells ringing filled the air.""");
  }
  ...
  Future<void> speaksentence19(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The streets were filled with the smell of food cooking.""");
  }
  ...
  Future<void> speaksentence20(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Sunlight fills the house.""");
  }
  ...
  Future<void> speaksentence21(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The meeting took place in a smoke-filled room.""");
  }
  ...
  Future<void> speaksentence22(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Choose the best word to fill the gap in each sentence.""");
  }
  ...
  Future<void> speaksentence23(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The product has filled a gap in the market.""");
  }
  ...
  Future<void> speaksentence24(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She left a space in his life that nothing could fill.""");
  }
  ...
  Future<void> speaksentence25(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""More reading will fill the gaps in your knowledge.""");
  }
  ...
  Future<void> speaksentence26(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The team needs someone to fill the role of manager.""");
  }
  ...
  Future<void> speaksentence27(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He fills the post satisfactorily.""");
  }
  ...
  Future<void> speaksentence28(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The vacancy has already been filled.""");
  }
  ...
  Future<void> speaksentence29(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""How do you fill your day now that you've retired?""");
  }
  ...
  Future<void> speaksentence30(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Work expands to fill the time available.""");
  }
  ...
  Future<void> speaksentence31(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I have plenty to fill up my leisure hours.""");
  }
  ...
  Future<void> speaksentence32(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The kids filled themselves with snacks.""");
  }
  ...
  Future<void> speaksentence33(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I've had my fill of entertaining for one week.""");
  }
  ...
  Future<void> speaksentence34(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The pigs had had their fill of the leftovers.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fill""",
                      // alsoEnglishWord: "also: fill",
                      britshText: """IpaUK: /fɪl/""",
                      americanText: """IpaUS: /fɪl/""",
...
// With short examples define "fill", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Please fill this glass for me.""",
                      kurdishText: """تکایە ئەم گڵاسەم بۆ پڕبکە.""",
                    ...
                    Column(
                      children: [
                        MyExpansionTile(
                          children: [
                            SentencesRow(
                              englishText: """Smoke filled the room.""",
                              kurdishText: """دووکەڵ ژوورەکەی پڕ کردبوو.""",
                            ...
                            SentencesRow(
                              englishText: """Her image filled the screen.""",
                              kurdishText: """وێنەکەی شاشەکەی گرتبوو.""",
                            ...
                            const DividerSentences(),
                            SentencesRow(
                              englishText: """The wind filled the sails.""",
                              kurdishText: """با پڕی چارۆکەکان بووبوو.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """قوتابخانەکە تا ئاستی تەواو پڕە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText: """پەڕەکەی پڕ لە نووسین کرد.""",
                            ...
                            const DividerSentences(),
                            SentencesRow(
                              englishText: """Fill a pan half full of water.""",
                              kurdishText: """قاپێک نیوەپڕ بکە لە ئاو.""",
                            ...
                            const DividerSentences(),
                            SentencesRow(
                              englishText: """You've filled it too full.""",
                              kurdishText: """زۆر پڕت کردووە.""",
                            ...
                            const DividerSentences(),
                            SentencesRow(
                              englishText: """The sails filled with wind.""",
                              kurdishText: """چارۆکەکان پڕ لە با بوون.""",
                            ...
                            const DividerSentences(),
                            SentencesRow(
                              englishText: """The room filled with smoke.""",
                              kurdishText: """ژوورەکە پڕ لە دووکەڵ بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """درزی دیوارەکە بە پلاستەر پڕلراوەتەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """His heart filled with pride.""",
                      kurdishText: """دڵی پڕ لە شانازی بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەنگی لێدانی زەنگەکان ئاسمانی تەنی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شەقامەکان پڕ لە بۆنی لێنانی خواردن بوون.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Sunlight fills the house.""",
                      kurdishText: """تیشکی خۆر پڕی ژوورەکە بووبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چاوپێکەوتنەکە لە ژوورێکی پڕ لە دووکەڵ ڕوویدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خوێندنەوەی زیاتر دەکرێت کەلێنەکانی زانیاریت پڕ بکاتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تیمەکە پێویستی بە کەسێکە بۆ پڕکردنەوەی ئەرکی بەڕێوەبەر.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە ڕەزامەندانە پۆستەکە پڕدەکاتەوە (= ئەرکەکە ڕادەپەڕێنێت).""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئێستا چۆن کاتت بەسەر دەبەیت کە خانەنشین بوویت؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کار زیاد دەکات بۆ پڕکردنەوەی ئەو کاتەی کە بەردەستە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """منداڵەکان تێریان خوارد لە سووکە خواردن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بەرازەکان بەشی خۆیان لە پاشماوەکەیان خواردووە.""",
...
const String _videoIdone = 'https://youtu.be/Kou7ur5xt_4?t=';
const double _startSecondsone = 00000000000000000000000000063;
const String _videoIdtwo = 'https://youtu.be/_wNsZEqpKUA?t=';
const double _startSecondstwo = 000000000000000000000000000373;
const String _videoIdthree = 'https://youtu.be/8HEfIJlcFbs?t=';
const double _startSecondsthree = 00000000000000000000000000018;
const String _videoIdfour = 'https://youtu.be/1SO0uvexcew?t=';
const double _startSecondsfour = 000000000000000000000000000140;
const String _videoIdfive = 'https://youtu.be/GYMF5mhuBUE';
