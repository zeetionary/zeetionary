...
class EnglishEntryideology extends StatefulWidget {
  const EnglishEntryideology({super.key});

  @override
  State<EnglishEntryideology> createState() => _EnglishEntryideologyState();
}

class _EnglishEntryideologyState extends State<EnglishEntryideology> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryideology ideology
WORD_WEB ideology ideology ideology
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200

  final String keyword = "ideology";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ideology""");
  }
...
کوردی: 
"""),
// With short examples define "ideology", please follow LX instructions
