...
class EnglishEntryequip extends StatefulWidget {
  const EnglishEntryequip({super.key});

  @override
  State<EnglishEntryequip> createState() => _EnglishEntryequipState();
}

class _EnglishEntryequipState extends State<EnglishEntryequip> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equip""",
                      // alsoEnglishWord: "also: equip",
                      britshText: """IpaUK: /ɪˈkwɪp/""",
                      americanText: """IpaUS: /ɪˈkwɪp/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He equipped himself with a street plan.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The car is fully equipped with all the latest gadgets.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) پێدانی ئەو شتانە بە خۆت/کەسێک/شتێک کە ]پێویستن بۆ چالاکییەک یان مەبەستێک"""),
          SentencesRow(
            englishText: """He equipped himself with a street plan.""",
            kurdishText: """نەخشەیەکی سەر شەقامی بۆ خۆی بەدەستخست.""",
          ...
          SentencesRow(
            englishText:
                """Rooms vary in size and come equipped with hairdryers, television and telephone.""",
            kurdishText:
                """ژوورەکان لە قەبارەدا جیاوازن و وشککەرەوە و تەلەفیزیۆن و تەلەفۆنیان تێدایە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """ئۆتۆمبێلەکە بەتەواوی هەموو ئامێرە تازەترینەکانی تێدایە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) ئامادەکردنی کەسێک بۆ چالاکییەک یان ئەرکێک، بەتایبەتی بە فێرکردنیان بەوەی چی بکەن"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The course is designed to equip students for a career in nursing.""",
            kurdishText:
                """کۆرسەکە دیزاین کراوە بۆ ئامادەکردنی خوێندکاران بۆ کارێک لە پەرستاریدا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: equip (Derived forms: equipping, equips, equipped)
1. Provide with (something) usually for a specific purpose (= fit, fit out, outfit)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/LbPw9AlVKVM?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1291;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/tTJeePNgOF8?t=';
const double _startSecondsone = 00000000000000000000000000000; // 902;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/n6h7fL22WCE?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 173;
const String _videoIdthree = 'VIDEOhttps://youtu.be/wujuS9DwCgE?t=';
const double _startSecondsthree = 000000000000000000000000000; // 400;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/mScpHTIi-kM?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1586;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/SdXeOjrHDRE?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 360;
