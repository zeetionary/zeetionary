...
class EnglishEntryforlorn extends StatefulWidget {
  const EnglishEntryforlorn({super.key});

  @override
  State<EnglishEntryforlorn> createState() => _EnglishEntryforlornState();
}

class _EnglishEntryforlornState extends State<EnglishEntryforlorn> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: forlorn 
1. Marked by or showing hopelessness (= lorn)
"a forlorn cause"; "the last forlorn attempt";
""",
  );

  final String keyword = "forlorn";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forlorn""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She looked so forlorn, standing there in the rain.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She looked a forlorn figure standing at the bus stop.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Empty houses quickly take on a forlorn look.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The cottage stood forlorn and empty.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        """His father smiled in a forlorn attempt to reassure him that everything was all right.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forlorn""",
                      // alsoEnglishWord: "also: forlorn",
                      britshText: """IpaUK: /fəˈlɔːn/""",
                      americanText: """IpaUS: /fərˈlɔːrn/""",
...
کوردی: تاق‌وتەنیا، بێ‌کەس،	لێ‌قەوماو، خەم‌بار، خەفەت‌بار، لێوبەبار، ناهومێد، بێچارە، پەرێشان، داماو،	بەجێ‌هێڵراو، کەلاوە، وێرانە، کاولە، وازلێ‌هێنراو، چۆڵ(کراو)،	بێ‌ئەنجام، بێهوودە
"""),
// With short examples define "forlorn", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە تەنها و دڵتەنگ دەردەکەوێت"""),
                    SentencesRow(
                      englishText:
                          """She looked so forlorn, standing there in the rain.""",
                      kurdishText: """زۆر بێ‌کەس لە بەر بارانەکە وەستابوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وەک بێ‌کەسێک دەردەکەوت کە لە پێش بارانەکە وەستابوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خانووی بەتاڵ زوو شێوەیەکی کەلاوەیان لێ دەنیشێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The cottage stood forlorn and empty.""",
                      kurdishText: """کووخەکە بێ‌خاوەن و بەتاڵ دەردەکەوت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵناو) کە ئەگەری کەمە سەرکەوتوو، ڕاست، هتد بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She waited in the forlorn hope that he would one day come back to her.""",
                      kurdishText:
                          """بەو هیوا بێهوودەوە چاوەڕێ بوو کە ڕۆژێک دێتەوە لای.""",
                    ...
                    SentencesRow(
                      englishText:
                          """His father smiled in a forlorn attempt to reassure him that everything was all right.""",
                      kurdishText:
                          """باوکی بە هەوڵێکی بێ‌هوودە پێکەنی بۆ دڵنیاییکردنەوەی لەوەی کە هەموو شت باش دەبێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/MK2USJnG9og?t=';
const double _startSecondsend = 0000000000000000000000000001047;
const String _videoIdone = 'https://youtu.be/Uc8VE1KS9GI?t=';
const double _startSecondsone = 0000000000000000000000000001155;
const String _videoIdtwo = 'https://youtu.be/Fg5gSBL9fy4?t=';
const double _startSecondstwo = 0000000000000000000000000001515;
const String _videoIdthree = 'https://youtu.be/2eq5Zw_wmzg?t=';
const double _startSecondsthree = 000000000000000000000000000182;
const String _videoIdfour = 'https://youtu.be/tFEAVQglOd8?t=';
const double _startSecondsfour = 000000000000000000000000000497;
const String _videoIdfive = 'https://youtu.be/hbhbu_Kf424?t=';
