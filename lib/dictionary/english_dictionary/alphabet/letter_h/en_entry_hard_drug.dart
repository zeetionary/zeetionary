...
class EnglishEntryharddrug extends StatefulWidget {
  const EnglishEntryharddrug({super.key});

  @override
  State<EnglishEntryharddrug> createState() => _EnglishEntryharddrugState();
}

class _EnglishEntryharddrugState extends State<EnglishEntryharddrug> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hard drug""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Cocaine is a hard drug.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hard drug""",
                      // alsoEnglishWord: "also: hard drug",
                      britshText: """IpaUK: /ˌhɑːd ˈdrʌɡ/""",
                      americanText: """IpaUS: /ˌhɑːrd ˈdrʌɡ/""",
