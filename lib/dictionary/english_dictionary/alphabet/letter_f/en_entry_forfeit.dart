...
class EnglishEntryforfeit extends StatefulWidget {
  const EnglishEntryforfeit({super.key});

  @override
  State<EnglishEntryforfeit> createState() => _EnglishEntryforfeitState();
}

class _EnglishEntryforfeitState extends State<EnglishEntryforfeit> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: forfeit (Derived forms: forfeits, forfeiting, forfeited)
1. Lose (something) or lose the right to (something) by some error, offence, or crime (= give up, throw overboard, waive, forgo, forego)
"you've forfeited your right to name your successor"; "forfeited property";

- Noun: forfeit (Derived forms: forfeits)
1. Something that is lost or surrendered as a penalty (= forfeiture)
 
2. A penalty for a fault or mistake that involves losing or giving up something (= forfeiture)
"the contract specified forfeits if the work was not completed on time";
 
3. The act of losing or surrendering something as a penalty for a mistake or fault or failure to perform etc. (= forfeiture, sacrifice)

- Adjective: forfeit
1. Surrendered as a penalty (= confiscate, forfeited)
""",
  );

  final String keyword = "forfeit";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forfeit""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He has forfeited his right to be taken seriously.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""If you cancel your flight, you will forfeit your deposit.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forfeit""",
                      // alsoEnglishWord: "also: forfeit",
                      britshText: """IpaUK: /ˈfɔːfɪt/""",
                      americanText: """IpaUS: /ˈfɔːrfɪt/""",
...
کوردی: سزایانە، زیان، تاوان، هەڵانە، جەریمە، پێ‌بژاردن،	لەکیس‌چوون، لەدەس‌دان، لەدەس‌چوون،	دەس‌بەسەراگرتن، لێ‌سەندن،	نرخ، بەها، لەکیس‌چوو، لەدەس‌دراو، لەدەس‌چوو،	دەس‌بەسەراگیراو
"""),
// With short examples define "forfeit", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) لە دەستدانی شتێک یان ئەوەی شتێکت لێ بسەندرێت بەهۆی ئەوەی کارێکی هەڵەت کردووە"""),
                    SentencesRow(
                      englishText:
                          """He has forfeited his right to be taken seriously.""",
                      kurdishText:
                          """مافی ئەوەی لەدەست دابوو کە بە جدی وەربگیردرێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەگەر گەشتەکەت هەڵبوەشێنیتەوە، ئەوا پێشەکییەکەت لەدەست دەدەیت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) شتێک کە کەسێک دەبێت بیدات یان لەدەستی داوە بەهۆی ئەوەی شتێکی هەڵەی کردووە یان دەرەنجامی شتێکە کە کردوویەتی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The team might have avoided the forfeits if it had handled the situation differently.""",
                      kurdishText:
                          """تیمەکە ڕەنگبایە ڕێگای لە لەدەستچوونەکان بگرتایە ئەگەر بەشێوەیەکی جیاواز مامەڵەی لەگەڵ دۆخەکە.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (هاوەڵناو) کە لە کەسێک سەندراوە وەک سزا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """This booking fee will be forfeit should you decide not to take up the accommodation.""",
                      kurdishText:
                          """ئەم کرێی گرتنە نادرێتەوە ئەگەر بڕیار بدەیت کە شوێنەکە وەرنەگریت.""",
                      englishNote:
                          "This means that if you choose not to take up the accommodation (= place to stay), you will lose (forfeit) the booking fee you paid as a penalty.",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/iekmvWaQf70?t=';
const double _startSecondsend = 0000000000000000000000000001187;
const String _videoIdone = 'https://youtu.be/4IaOeVgZ-wc?t=';
const double _startSecondsone = 0000000000000000000000000002094;
const String _videoIdtwo = 'https://youtu.be/epi2pDmqygc?t=';
const double _startSecondstwo = 00000000000000000000000000055;
const String _videoIdthree = 'https://youtu.be/X1ncuW-bLsw?t=';
const double _startSecondsthree = 0000000000000000000000000002290;
const String _videoIdfour = 'https://youtu.be/XNN1Hbg9oNU?t=';
const double _startSecondsfour = 0000000000000000000000000001120;
const String _videoIdfive = 'https://youtu.be/ncMoQs_HNmY?t=';
const double _startSecondsfive = 000000000000000000000000000390;
