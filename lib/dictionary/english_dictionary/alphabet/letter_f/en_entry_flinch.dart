...
class EnglishEntryflinch extends StatefulWidget {
  const EnglishEntryflinch({super.key});

  @override
  State<EnglishEntryflinch> createState() => _EnglishEntryflinchState();
}

class _EnglishEntryflinchState extends State<EnglishEntryflinch> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: flinch (Derived forms: flinching, flinches, flinched)
1. Draw back, as with fear or pain (= squinch [N. Amer], funk, cringe, shrink, wince, recoil, quail, blench)
"she flinched when they showed the slaughtering of the calf";

- Noun: flinch (Derived forms: flinches)
1. A reflex response to sudden pain (= wince)
""",
  );

  final String keyword = "flinch";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He flinched at the sight of the blood.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flinch""",
                      // alsoEnglishWord: "also: flinch",
                      britshText: """IpaUK: /flɪntʃ/""",
                      americanText: """IpaUS: /flɪntʃ/""",
...
// With short examples define "flinch", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) ئەنجامدانی جووڵەیەکی لەناکاو بە ڕووخسار یان جەستەت بەهۆی ترس، ئازار، یان سەرسامی"""),
                    SentencesRow(
                      englishText: """He flinched at the sight of the blood.""",
                      kurdishText: """داچڵەکی بە دیمەنی خوێن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Her finger touched the scar on his forehead, making him flinch.""",
                      kurdishText:
                          """پەنجەی دای لە برینەکەی سەری و ڕایپەڕاند.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/aTDG16Mh2_w?t=';
const double _startSecondsend = 000000000000000000000000000361;
const String _videoIdone = 'https://youtu.be/hllf45NK-KA?t=';
const double _startSecondsone = 000000000000000000000000000673;
const String _videoIdtwo = 'https://youtu.be/3PX2d3Zwutg?t=';
const double _startSecondstwo = 00000000000000000000000000080;
const String _videoIdthree = 'https://youtu.be/y_v-3_sPsRM?t=';
const double _startSecondsthree = 00000000000000000000000000068;
const String _videoIdfour = 'https://youtu.be/AwodL8z2EtE?t=';
const double _startSecondsfour = 0000000000000000000000000002008;
const String _videoIdfive = 'https://youtu.be/FPvisqTN8UY?t=';
const double _startSecondsfive = 000000000000000000000000000658;
