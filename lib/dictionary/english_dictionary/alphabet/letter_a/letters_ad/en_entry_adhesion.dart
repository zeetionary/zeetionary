...
// replace these: replace EnglishEntryadhesion - replace speakAdhesion - replace adhesion - /ədˈhiː.ʒən/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadhesion extends StatelessWidget {
  EnglishEntryadhesion({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdhesion(String languageCode) async {
    // DOPSUM: CHANGE speakAdhesion
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("adhesion"); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ədˈhiː.ʒən/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'w3PVOjIclJ0';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'xmx2333gQs8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'UdutN9YjFuQ';
