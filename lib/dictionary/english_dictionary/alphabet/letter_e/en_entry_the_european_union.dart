...
class EnglishEntrytheeuropeanunion extends StatefulWidget {
  const EnglishEntrytheeuropeanunion({super.key});

  @override
  State<EnglishEntrytheeuropeanunion> createState() =>
      _EnglishEntrytheeuropeanunionState();
}

class _EnglishEntrytheeuropeanunionState
    extends State<EnglishEntrytheeuropeanunion> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""the European Union""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: the European Union",
                      britshText: """IpaUK: /ðə ˌjʊərəpiːən ˈjuːniən/""",
                      americanText: """IpaUS: /ðə ˌjʊrəpiːən ˈjuːniən/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "the European Union";
...
"""),
          ...
          SentencesRow(
            englishText:
                """Which countries have joined the European Union since 2004?""",
            kurdishText:
                """لە ٢٠٠٤ ـەوە چی وڵاتانێک پەیوەندییان بە یەکێتیی ئەورووپاوە کردووە؟""",
...
1. An international organization of European countries formed after World War II to reduce trade barriers and increase cooperation among its members (= EU, European Community, EC, European Economic Community, EEC, Common Market, Europe)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/MVu8QbxafJE?t=';
const double _startSecondsend = 000000000000000000000000000000; // 239;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/UdgRUCVUts0?t=';
const double _startSecondsone = 00000000000000000000000000000; // 32;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/HZryl5nJr00?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1304;
const String _videoIdthree = 'VIDEOhttps://youtu.be/KPqK5LyGsiE?t=';
const double _startSecondsthree = 000000000000000000000000000; // 434;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/6C38p7N5h9M?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 127;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/df8FRfVtVNw?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 265;
