...
class EnglishEntrygrave extends StatefulWidget {
  const EnglishEntrygrave({super.key});

  @override
  State<EnglishEntrygrave> createState() => _EnglishEntrygraveState();
}

class _EnglishEntrygraveState extends State<EnglishEntrygrave> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grave (Derived forms: graves)
1. A place for the burial of a corpse (especially beneath the ground and marked by a tombstone) (- tomb)
...
- Adjective: grave (Derived forms: gravest, graver)
1. Dignified and sombre in manner or character and committed to keeping promises (- sedate, sober, solemn)
...
- Verb: grave (Derived forms: graving, graved, graven, graves)
Usage: archaic
1. Shape (a material like stone or wood) by whittling away at it (- sculpt, sculpture, sculp)
"She is graving the block of marble into an image of her husband";
 
2. Carve, cut, or etch into a material or surface (- scratch, engrave, inscribe)
 
3. Impress deeply on the mind
""",
  );

  final String keyword = "grave";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We visited Grandma's grave.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The plague victims were buried in a mass grave.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There were flowers on the grave.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Is there life beyond the grave?""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He followed her to the grave.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She smoked herself into an early grave.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The consequences will be very grave if nothing is done.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We were in grave danger.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He looked very grave as he entered the room.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her expression was grave.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grave""",
                      // alsoEnglishWord: "also: grave",
                      britshText: """IpaUK: /ɡreɪv/""",
                      americanText: """IpaUS: /ɡreɪv/""",
...
کوردی: گۆڕ، قەبر، مردن، مەرگ
"""),
// With short examples define "grave", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) شوێنی ناشتنی کەسێک"""),
                    SentencesRow(
                      englishText: """We visited Grandma's grave.""",
                      kurdishText: """سەردانی گۆڕی داپیرەمان کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """قوربانیانی تاعوونەکە لە گۆڕی بە کۆمەڵ نێژران.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There were flowers on the grave.""",
                      kurdishText: """گوڵ لەسەر گۆڕەکە بوون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ژیانی دوای مەرگ بوونی هەیە؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """زوو لە دوای ئەو مرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بە جگەرەکێشان خۆی جوانە مەرگ کرد.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (هاوەڵناو) ڕژد و گرنگ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The police have expressed grave concern about the missing child's safety.""",
                      kurdishText:
                          """پۆلیس نیگەرانیی جدییان دەربڕیوە سەبارەت بە سەلامەتی منداڵە ونبووەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەرئەنجامەکان سەخت دەبێت ئەگەر هیچ نەکرێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We were in grave danger.""",
                      kurdishText: """لە مەترسیی جدیدا بووین.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (هاوەڵناو) کە هەڵسووکەوتی جدییە وەک ئەوەی هیچ ڕووی نەدابێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He looked very grave as he entered the room.""",
                      kurdishText: """زۆر جدی دیار بوو کە هاتە ژوورەکەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her expression was grave.""",
                      kurdishText: """دەربڕینی زۆر جدی بوو.""",
...
const String _videoIdtwo = 'https://youtu.be/Pon4Zux5MaQ?t=';
...
const String _videoIdfour = 'https://youtu.be/dKw_l_yA5Io?t=';
const double _startSecondsfour = 00000000000000000000000000016;
const String _videoIdfive = 'https://youtu.be/Ir3eJ1t13fk?t=';
const double _startSecondsfive = 0000000000000000000000000002862;
