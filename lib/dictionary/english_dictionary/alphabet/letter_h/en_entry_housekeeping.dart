...
class EnglishEntryhousekeeping extends StatefulWidget {
  const EnglishEntryhousekeeping({super.key});

  @override
  State<EnglishEntryhousekeeping> createState() =>
      _EnglishEntryhousekeepingState();
}

class _EnglishEntryhousekeepingState extends State<EnglishEntryhousekeeping> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: housekeeping (Derived forms: housekeepings)
1. The work of cleaning and running a house (- housework)
""",
  );

  final String keyword = "housekeeping";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""housekeeping""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000308;
    const String videoIdone = 'https://youtu.be/49oZt8Sl-JA?t=';
    const double startSecondsone = 000000000000000000000000000119;
    const String videoIdtwo = 'https://youtu.be/GLy2rYHwUqY?t=';
    const double startSecondstwo = 0000000000000000000000000001662;
    const String videoIdthree = 'https://youtu.be/vk7Iplg9dGk?t=';
    const double startSecondsthree = 000000000000000000000000000277;
    const String videoIdfour = 'https://youtu.be/ZThc79RtIeI?t=';
    const double startSecondsfour = 0000000000000000000000000002837;
    const String videoIdfive = 'https://youtu.be/ow7KcAYtmSw?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """housekeeping""",
                      // alsoEnglishWord: "also: housekeeping",
                      britshText: """IpaUK: /ˈhaʊskiːpɪŋ/""",
                      americanText: """IpaUS: /ˈhaʊskiːpɪŋ/""",
...
// With short examples define "housekeeping", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """My financial problems were made worse by my bad housekeeping.""",
                      kurdishText:
                          """کێشە داراییەکانم خراپتر بوون بە ماڵداریی خراپم.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Call housekeeping and ask them to bring us some clean towels.""",
                      kurdishText:
                          """پەیوەندی بە بەشی پاککردنەوە بکە و داوایان لێ بکە ژمارەیەک خاولی تازەمان بۆ بهێنن.""",
