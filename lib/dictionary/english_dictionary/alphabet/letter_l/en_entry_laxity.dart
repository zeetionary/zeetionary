...
class EnglishEntrylaxity extends StatefulWidget {
  const EnglishEntrylaxity({super.key});

  @override
  State<EnglishEntrylaxity> createState() => _EnglishEntrylaxityState();
}

class _EnglishEntrylaxityState extends State<EnglishEntrylaxity> {
  @override
  void initState() {
    super.initState();
...
// With short examples define "laxity", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە شتێک توند یان بەئاگا نەبێت"""),
                    SentencesRow(
                      englishText:
                          """The laxity of prison officers made it easy for the men to get away.""",
                      kurdishText:
                          """کەمتەرخەمیی ئەفسەرانی زیندان وەهای کرد ئاسان بێت بۆ پیاوەکان کە هەڵبێن.""",
