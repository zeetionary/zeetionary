...
class EnglishEntrycanoeist extends StatelessWidget {
// blank divider
  EnglishEntrycanoeist({super.key});
// blank divider
  ...
  Future<void> speakcanoeist(String languageCode) async {
    ...
    await flutterTts.speak("canoeist"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcanoeists1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("He is an experienced canoeist."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcanoeists2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcanoeists22"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcanoeists3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcanoeists33"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcanoeists4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcanoeists44"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcanoeists5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcanoeists55"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcanoeists6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcanoeists66"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcanoeists7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcanoeists77"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcanoeists8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcanoeists88"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcanoeists9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcanoeists99"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcanoeists10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcanoeists1010"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcanoeists11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcanoeists1111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcanoeists12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcanoeists1212"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcanoeists13(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcanoeists1313"); // DOPSUM: CHANGE TEXT
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "canoeist"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /kəˈnuːɪst/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcanoeist("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /kəˈnuːɪst/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcanoeist("en-US"),
                            ),
                          ],
                        ),
                      ],
                          ...
                          Row(
                            children: [
                              ...
                              Column(
                                children: [
                                  CustomIconButtonBritish(
                                    onPressed: () => speakcanoeists1("en-GB"),
                                  ),
                                  CustomIconButtonAmerican(
                                    onPressed: () => speakcanoeists1("en-US"),
                                  ),
                                ],
                              ),
                            ],
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  ...
  final String _videoId = 'oGpc9PfprKc';
...
class _YoutubeEmbeddedtwoState extends State<YoutubeEmbeddedtwo> {
  late YoutubePlayerController _controller;
  final String _videoId = 'DwZqCjj6EVY';
...
class _YoutubeEmbeddedthreeState extends State<YoutubeEmbeddedthree> {
  late YoutubePlayerController _controller;
  final String _videoId = 'lCI88UgMiw8';
...
class _YoutubeEmbeddedfiveState extends State<YoutubeEmbeddedfive> {
  late YoutubePlayerController _controller;
  final String _videoId = 'd6ptNCXYiwI';
...
class _YoutubeEmbeddedeightState extends State<YoutubeEmbeddedeight> {
  late YoutubePlayerController _controller;
  final String _videoId = '64HcZGBs1-Q';
...
class _YoutubeEmbeddednineState extends State<YoutubeEmbeddednine> {
  late YoutubePlayerController _controller;
  final String _videoId = 'ZPIVfzY1bTY';
...
class _YoutubeEmbeddedtenState extends State<YoutubeEmbeddedten> {
  late YoutubePlayerController _controller;
  final String _videoId = 'aRaYuQe48PM';
