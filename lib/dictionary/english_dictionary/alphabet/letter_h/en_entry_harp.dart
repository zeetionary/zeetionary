...
class EnglishEntryharp extends StatefulWidget {
  const EnglishEntryharp({super.key});

  @override
  State<EnglishEntryharp> createState() => _EnglishEntryharpState();
}

class _EnglishEntryharpState extends State<EnglishEntryharp> {
  @override
  void initState() {
    super.initState();
...
3. A small rectangular free-reed instrument having a row of free reeds set back in air holes and played by blowing into the desired hole (- harmonica, mouth organ, mouth harp)

- Verb: harp (Derived forms: harping, harped, harps)
1. (usually with on) repeatedly come back to a subject; persistently complain about (- dwell)
"She is always harping on the same old things";
 
2. (music) play the harp
"She harped the Saint-Saens beautifully"
""",
  );

  final String keyword = "harp";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He bought a new harp for the concert.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harp""",
                      // alsoEnglishWord: "also: harp",
                      britshText: """IpaUK: /hɑːp/""",
                      americanText: """IpaUS: /hɑːrp/""",
...
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئامێرێکی میوزیکی گەورە کە تەلی پێوەیە لە سەرەوە بۆ خوارەوەی چوارچێوەیەک"""),
                    SentencesRow(
                      englishText: """He bought a new harp for the concert.""",
                      kurdishText: """هارپێکی تازەی کڕی بۆ کۆنسێرتەکە.""",
...
const String _videoIdone = 'https://youtu.be/mcZdTvOqmvI?t=';
const double _startSecondsone = 000000000000000000000000000814;
const String _videoIdtwo = 'https://youtu.be/BF2TZq-ntRQ';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/SIM4LxX5eNY';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/pVWbqd5ebYE?t=';
const double _startSecondsfour = 0000000000000000000000000007;
const String _videoIdfive = 'https://youtu.be/_jYhAyj9ahQ?t=';
