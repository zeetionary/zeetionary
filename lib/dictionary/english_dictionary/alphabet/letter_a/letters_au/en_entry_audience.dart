...
class EnglishEntryaudience extends StatelessWidget {
  ...
  Future<void> speakaudience(String languageCode) async {
    ...
    await flutterTts.speak("audience");
  }
  ...
  Future<void> speakaudience117(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The audience was/were clapping for 10 minutes.");
  }
  ...
  Future<void> speakaudience118(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The museum is trying to attract a wider audience.");
  }
  ...
  Future<void> speakaudience123(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She had a private audience with the king.");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "audience"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɔːdiəns/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakaudience("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɔːdiəns/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakaudience("en-US"),
                            ),
                          ],
                        ),
                      ],
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakaudience117("en-US"),
                          ),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakaudience118("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
...
٢. (ناو) ئەو کەسانەی کە گوێگر، بینەر، یان خوێنەری ھەمان شتن"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakaudience121("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٣. (ناو) کۆبوونەوە لەگەڵ کەسێکی گرنگ"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakaudience123("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'HZb-nym3HhA';
