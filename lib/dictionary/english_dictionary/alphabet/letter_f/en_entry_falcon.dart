...
// With short examples define "falcon", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
const String _videoIdend = 'https://youtu.be/jhGeq_yQYyg?t=';
const double _startSecondsend = 00000000000000000000000000015;
const String _videoIdone = 'https://youtu.be/I7LJIuB2CHE?t=';
const double _startSecondsone = 0000000000000000000000000003;
const String _videoIdtwo = 'https://youtu.be/sx-ezmr6OdQ?t=';
const double _startSecondstwo = 000000000000000000000000000146;
const String _videoIdthree = 'https://youtu.be/tgUdRo9eYoQ?t=';
const double _startSecondsthree = 000000000000000000000000000320;
const String _videoIdfour = 'https://youtu.be/R1HAEGyk4Co?t=';
const double _startSecondsfour = 000000000000000000000000000410;
const String _videoIdfive = 'https://youtu.be/lm0CtcEZV4E?t=';
