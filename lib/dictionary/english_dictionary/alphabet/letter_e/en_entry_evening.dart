...
class EnglishEntryevening extends StatefulWidget {
  const EnglishEntryevening({super.key});

  @override
  State<EnglishEntryevening> createState() => _EnglishEntryeveningState();
}

class _EnglishEntryeveningState extends State<EnglishEntryevening> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evening""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evening""",
                      // alsoEnglishWord: "also: evening",
                      britshText: """IpaUK: /ˈiːvnɪŋ/""",
                      americanText: """IpaUS: /ˈiːvnɪŋ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Remember to call me this evening.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We haven't spoken to him since yesterday evening.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'll see you tomorrow evening.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Come over on Thursday evening.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""What do you usually do in the evening?""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Mosquitoes usually bite in the early evening.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's going to her sister's for the evening.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He hardly spoke throughout the evening.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We spent many enjoyable summer evenings together.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He hosted the evening in front of a celebrity audience.""");
  }
...
کوردی: شەو، درەنگان، شێوان، تاریکان، ئێوارە، ڤێرەگا، پاش‌نیوەڕۆ
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ئەو بەشەی ڕۆژ کە دەکەوێتە نێوان دوای نیوەڕۆ و کاتی خەو"""),
          SentencesRow(
            englishText: """Remember to call me this evening.""",
            kurdishText: """لە یادت بێت ئەم ئێوارە پەیوەندیم پێوە بکەیت.""",
          ...
          SentencesRow(
            ...
            kurdishText: """لە دوێنێ ئێوارەوە قسەمان لەگەڵ نەکردووە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I'll see you tomorrow evening.""",
            kurdishText: """سبەی ئێوارە دەتبینم.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Come over on Thursday evening.""",
            kurdishText: """ئێوارەی پێنجشەممە وەرە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """What do you usually do in the evening?""",
            kurdishText: """زۆرجار لە ئێواراندا چی دەکەیت؟""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Mosquitoes usually bite in the early evening.""",
            kurdishText: """مێشوولە زۆرجار لە سەرەتای ئێوارەدا گاز دەگرن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She's going to her sister's for the evening.""",
            kurdishText: """بۆ ئێوارەکە دەچێتە ماڵی خوشکی.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He hardly spoke throughout the evening.""",
            kurdishText: """بە ئەستەم تەواوی ئێوارەکە پێکەنی.""",
          ...
          SentencesRow(
            ...
            kurdishText: """زۆر ئێوارانی خۆشی هاوینمان پێکەوە بەسەر برد.""",
            onPressedBritish: () => speaksentence9("en-GB"),
            onPressedAmerican: () => speaksentence9("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) بۆنەیەکی دیاریکراو کە لە ئێوارەدا ڕوودەدات"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """He hosted the evening in front of a celebrity audience.""",
            kurdishText:
                """شەوە ئاهەنگەکەمان لە پێش گوێگرانی بەناوبانگ ڕێکخست.""",
          ...
          SentencesRow(
            englishText:
                """The club will hold a social evening to welcome new members.""",
            kurdishText:
                """یانەکە ئێوارە خوانێکی تایبەت ڕێک دەخات بۆ خێراتنی ئەندامە تازەکان.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: evening (Derived forms: evenings)
1. The latter part of the day (the period of decreasing daylight from late afternoon until nightfall) (= eve, even, eventide)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/e09xig209cQ?t=';
const double _startSecondsend = 000000000000000000000000000000; // 272;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/HDntl7yzzVI?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1389;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/Z4Dzzwt_rfw?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 136;
const String _videoIdthree = 'VIDEOhttps://youtu.be/r-Or05EFLUM?t=';
const double _startSecondsthree = 000000000000000000000000000; // 179;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/s0hY04WnlWI?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 118;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/UeUPILGGIls?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1159;
