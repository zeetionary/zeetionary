...
class EnglishEntryflyingvisit extends StatefulWidget {
  const EnglishEntryflyingvisit({super.key});

  @override
  State<EnglishEntryflyingvisit> createState() => _EnglishEntryflyingvisitState();
}

class _EnglishEntryflyingvisitState extends State<EnglishEntryflyingvisit> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "flying visit";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flying visit""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The president made a flying visit to the festival.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flying visit""",
                      // alsoEnglishWord: "also: flying visit",
                      britshText: """IpaUK: /ˌflaɪɪŋ ˈvɪzɪt/""",
                      americanText: """IpaUS: /ˌflaɪɪŋ ˈvɪzɪt/""",
...
// With short examples define "flying visit", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) سەردانێکی کورت"""),
                    SentencesRow(
                      englishText:
                          """The president made a flying visit to the festival.""",
                      kurdishText: """سەرۆک سەردانێکی کورتی بۆ فیستیڤاڵەکە ئەنجام دا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/iRftTgyhVHc?t=';
const double _startSecondsend = 00000000000000000000000000021;
const String _videoIdone = 'https://youtu.be/GuVZVwd2iDI?t=';
const double _startSecondsone = 00000000000000000000000000029;
const String _videoIdtwo = 'https://youtu.be/uitwPJEXEGc?t=';
const double _startSecondstwo = 000000000000000000000000000644;
const String _videoIdthree = 'https://youtu.be/QFMoiOAY6i4?t=';
const double _startSecondsthree = 00000000000000000000000000057;
const String _videoIdfour = 'https://youtu.be/pg920F1RTXU?t=';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/y1kafU4oODc?t=';
const double _startSecondsfive = 000000000000000000000000000982;
