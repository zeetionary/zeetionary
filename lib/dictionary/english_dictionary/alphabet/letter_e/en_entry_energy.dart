...
class EnglishEntryenergy extends StatefulWidget {
  const EnglishEntryenergy({super.key});

  @override
  State<EnglishEntryenergy> createState() => _EnglishEntryenergyState();
}

class _EnglishEntryenergyState extends State<EnglishEntryenergy> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """energy""",
                      // alsoEnglishWord: "also: energy",
                      britshText: """IpaUK: /ˈenədʒi/""",
                      americanText: """IpaUS: /ˈenərdʒi/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It's a waste of time and energy.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's always full of energy.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I don't seem to have any energy these days.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He expends great energy trying to help them.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She put all her energies into her work.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He focused his energies on preparing the lectures.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I will put all my energies into improving the situation.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The new power station produces vast amounts of energy.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Locally produced food would reduce energy costs.""");
  }
...
کوردی: (فیزیک) وزە،	هێز، تابشت، توانایی، وزە، گوڕ، گوژم، توانست، شیان، ستین، تیهن،	چالاکی، هەڵسووڕی، پشت‌گەرمی، جم‌وجۆڵ،	شێلگیری، بەڕشتی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) هێز، هەوڵ، و تامەزرۆیی کە پێویستە بۆ کردنی کارێک"""),
          SentencesRow(
            englishText: """It's a waste of time and energy.""",
            kurdishText: """بەفیڕۆدانی کات و وزەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She's always full of energy.""",
            kurdishText: """هەمیشە پڕ لە وزەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I don't seem to have any energy these days.""",
            kurdishText: """ئەم ڕۆژانە وەها دەرناکەون کە هیچ وزەم هەبێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He expends great energy trying to help them.""",
            kurdishText: """هەوڵی زۆر دەدات بۆ هەوڵدان بۆ یارمەتیدانیان.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هەرگیز وەها دەرناکوێت بێ وزە بێت.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) هەوڵی جەستەیی و دەروونی کە دەیدەیت بۆ کردنی شتێک"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """She put all her energies into her work.""",
            kurdishText: """هەموو وزەی بە کارەکەی بەخشی.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هێز و توانای بۆ ئامادەکردنی وانەکە خستەگەڕ.""",
          ...
          SentencesRow(
            ...
            kurdishText: """تەواوی توانام دەخەمەگەڕ بۆ باشکردنی دۆخەکە.""",
          ...
          SentencesRow(
            englishText:
                """The £500 million programme is centred around energy efficiency and renewable power sources.""",
            kurdishText:
                """پڕۆگرامە ٥٠٠ ملیۆن پاوەندییەکە تایبەتە بە دەستگرتووی بە وزە و سەرچاوەی توانای دووبارەبەکارهاتوو.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """وێستگە تازەکەی کارەبا وزەی زۆر زەبەند بەرهەم دەهێنێت.""",
          ...
          SentencesRow(
            englishText:
                """The country could face an energy crisis if demand continues to rise.""",
            kurdishText:
                """وڵاتەکە دەکرێت ڕووبەڕووی قەیرانی وزە ببێتەوە ئەگەر خواست بەردەوام ببێت لە بەرزبوونەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Locally produced food would reduce energy costs.""",
            kurdishText:
                """خواردنی ناوخۆیی بەرهەمهێندراو دەکرێت تێچووی وزە کەم بکاتەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: energy (Derived forms: energies)
...
2. Forceful exertion (= vigor [US], vigour [Brit, Cdn], zip [informal])
"he plays tennis with great energy";
 
3. Enterprising or ambitious drive (= push, get-up-and-go)
"Europeans often laugh at American energy";
 
4. An imaginative lively style (especially style of writing) (= muscularity, vigor [US], vigour [Brit, Cdn], vim)
...
const String _videoIdend = 'https://youtu.be/DwsZggwPRKc?t=';
const double _startSecondsend = 73;
const String _videoIdone = 'https://youtu.be/DPZzrlFCD_I?t=';
const double _startSecondsone = 192;
const String _videoIdtwo = 'https://youtu.be/tMKXbLBgkEc?t=';
const double _startSecondstwo = 329;
const String _videoIdthree = 'https://youtu.be/D-2799Y07Zc?t=';
...
const double _startSecondsfive = 494;
const String _videoIdsix = 'https://youtu.be/AF8d72mA41M?t=';
const double _startSecondssix = 257;
