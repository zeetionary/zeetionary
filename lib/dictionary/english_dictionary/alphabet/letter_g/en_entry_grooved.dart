...
class EnglishEntrygrooved extends StatefulWidget {
  const EnglishEntrygrooved({super.key});

  @override
  State<EnglishEntrygrooved> createState() => _EnglishEntrygroovedState();
}

class _EnglishEntrygroovedState extends State<EnglishEntrygrooved> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: grooved
1. Established as if settled into a groove or rut (- well-grooved)
""",
  );

  final String keyword = "grooved";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grooved""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The grooved surface prevented slipping.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grooved""",
                      // alsoEnglishWord: "also: grooved",
                      britshText: """IpaUK: /ɡruːvd/""",
                      americanText: """IpaUS: /ɡruːvd/""",
...
کوردی: کووزکووز، کووزاوی
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە شتێکی سەخت خەتێکی چاڵی تێدایە"""),
                    SentencesRow(
                      englishText:
                          """The grooved surface prevented slipping.""",
                      kurdishText:
                          """ڕووە کووزاوییەکە ڕێگری لە خلیسکان دەکرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/-RjJtO51ykY?t=';
const double _startSecondsend = 000000000000000000000000000418;
const String _videoIdone = 'https://youtu.be/4utNXOfQ4cM?t=';
const double _startSecondsone = 000000000000000000000000000399;
const String _videoIdtwo = 'https://youtu.be/1O1dOgG9cII?t=';
const double _startSecondstwo = 00000000000000000000000000050;
const String _videoIdthree = 'https://youtu.be/53rtu1wmoAc?t=';
const double _startSecondsthree = 0000000000000000000000000001365;
const String _videoIdfour = 'https://youtu.be/Q2a9Yvo2Yyg?t=';
const double _startSecondsfour = 00000000000000000000000000078;
const String _videoIdfive = 'https://youtu.be/TyVP4td5k_Y?t=';
const double _startSecondsfive = 000000000000000000000000000195;
