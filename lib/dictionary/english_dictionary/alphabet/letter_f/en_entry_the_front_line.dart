...
class EnglishEntrythefrontline extends StatefulWidget {
  const EnglishEntrythefrontline({super.key});

  @override
  State<EnglishEntrythefrontline> createState() =>
      _EnglishEntrythefrontlineState();
}

class _EnglishEntrythefrontlineState extends State<EnglishEntrythefrontline> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: the front line (Derived forms: front lines)
1. The line along which opposing armies face each other (= battlefront, front)
""",
  );

  final String keyword = "the front line";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""the front line""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Tanks have been deployed all along the front line.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The regiment was sent to fight in the front line.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """the front line""",
                      // alsoEnglishWord: "also: the front line",
                      britshText: """IpaUK: /ðə ˌfrʌnt ˈlaɪn/""",
                      americanText: """IpaUS: /ðə ˌfrʌnt ˈlaɪn/""",
...
// With short examples define "the front line", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ناوچەیەک کە تێیدا دوو دوژمن ڕووبەڕووی یەکدی دەبنەوە لە جەنگدا"""),
                    SentencesRow(
                      englishText:
                          """Tanks have been deployed all along the front line.""",
                      kurdishText:
                          """تانک بە درێژایی هەموو بەرەکانی پێشەوە نێردراون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """یەکەکە نێردرا بۆ شەڕکردن لە بەرەکانی پێشەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """They are on the front line, talking to the customers about our products.""",
                      kurdishText:
                          """لە بەشی پێشەوەن قسە بۆ کڕیاران دەکەن لەسەر بەرهەمەکانمان.""",
...
const String _videoIdone = 'https://youtu.be/IgF3OX8nT0w?t=';
const double _startSecondsone = 000000000000000000000000000765;
const String _videoIdtwo = 'https://youtu.be/BztMgcNgobk?t=';
const double _startSecondstwo = 000000000000000000000000000923;
const String _videoIdthree = 'https://youtu.be/Eg08rJGKjtA?t=';
const double _startSecondsthree = 000000000000000000000000000109;
const String _videoIdfour = 'https://youtu.be/Ex6Xw83rszo?t=';
const double _startSecondsfour = 000000000000000000000000000597;
const String _videoIdfive = 'https://youtu.be/KSuYDQ7tFEk?t=';
const double _startSecondsfive = 000000000000000000000000000350;
