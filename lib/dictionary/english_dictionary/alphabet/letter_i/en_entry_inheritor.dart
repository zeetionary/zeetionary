...
class EnglishEntryinheritor extends StatefulWidget {
  const EnglishEntryinheritor({super.key});

  @override
  State<EnglishEntryinheritor> createState() => _EnglishEntryinheritorState();
}

class _EnglishEntryinheritorState extends State<EnglishEntryinheritor> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inheritor""");
  }
