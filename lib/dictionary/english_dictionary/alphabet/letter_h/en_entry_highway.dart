...
class EnglishEntryhighway extends StatefulWidget {
  const EnglishEntryhighway({super.key});

  @override
  State<EnglishEntryhighway> createState() => _EnglishEntryhighwayState();
}

class _EnglishEntryhighwayState extends State<EnglishEntryhighway> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: highway (Derived forms: highways)
1. A major road for any form of motor transport (- main road)
"a diversion from the main highway";
""",
  );

  final String keyword = "highway";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""highway""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Highway patrol officers closed the road.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The tire had a blowout on the highway.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A parked car was obstructing the highway.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""All citizens have the right to use the public highway.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001340;
    const String videoIdone = 'https://youtu.be/wknSc6HRUMI?t=';
    const double startSecondsone = 000000000000000000000000000158;
    const String videoIdtwo = 'https://youtu.be/mZr1nbACmGc?t=';
    const double startSecondstwo = 00000000000000000000000000056;
    const String videoIdthree = 'https://youtu.be/9yjZpBq1XBE?t=';
    const double startSecondsthree = 0000000000000000000000000005028;
    const String videoIdfour = 'https://youtu.be/PLDFgKzWy3o?t=';
    const double startSecondsfour = 000000000000000000000000000175;
    const String videoIdfive = 'https://youtu.be/wrsUbwKGuko?t=';
    const double startSecondsfive = 0000000000000000000000000002422;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """highway""",
                      // alsoEnglishWord: "also: highway",
                      britshText: """IpaUK: /ˈhaɪweɪ/""",
                      americanText: """IpaUS: /ˈhaɪweɪ/""",
...
کوردی: شاڕێ، سەرەڕێ، گەورەڕێ، ڕێگای سەرەکی
"""),
// With short examples define "highway", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕێگایەکی سەرەکی درێژ مەودا، بە تایبەتی کە شار و شارۆچکەکە پێکەوە گرێ دەدا"""),
                    SentencesRow(
                      englishText:
                          """Highway patrol officers closed the road.""",
                      kurdishText:
                          """ئەفسەری چاودێری شاڕێکان ڕێگاکەیان داخست.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The tire had a blowout on the highway.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ڕێگایەکی گشتی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """A parked car was obstructing the highway.""",
                      kurdishText: """ئۆتۆمبێلێک ڕێگاکەی گرتبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەموو هاوڵاتییان مافی ئەوەیان هەیە ڕێگای گشتی بەکاربهێنن.""",
