...
class EnglishEntryflake extends StatefulWidget {
  const EnglishEntryflake({super.key});

  @override
  State<EnglishEntryflake> createState() => _EnglishEntryflakeState();
}

class _EnglishEntryflakeState extends State<EnglishEntryflake> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flake (Derived forms: flakes)
1. A small fragment of something broken off from the whole (= bit, chip, fleck, scrap)
"a flake of rock caught him in the eye";
 
2. A crystal of snow (= snowflake)
 
3. [N. Amer, informal] A person with an unusual or odd personality (= eccentric, eccentric person, oddball [informal], geek [informal], dag [Austral, NZ, informal])

- Verb: flake (Derived forms: flaking, flaked, flakes)
1. Form into flakes
"The substances started to flake"
 
2. Cover with flakes or as if with flakes
 
3. Come off in flakes or thin small pieces (= peel off, peel, flake off)
"The paint in my house is flaking off";
""",
  );

  final String keyword = "flake";
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His skin was dry and flaking.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Flake the tuna and add to the sauce.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flake""",
                      // alsoEnglishWord: "also: flake",
                      britshText: """IpaUK: /fleɪk/""",
                      americanText: """IpaUS: /fleɪk/""",
...
// With short examples define "flake", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """This room needs decorating - flakes of paint keep coming off the walls.""",
                      kurdishText:
                          """ئەم ژوورە پێویستی بە ڕازاندنەوەیە ـ توێژاڵی بۆیە بەردەوام لە دیوارەکان دەبنەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """As the story begins, she seems a bit of a flake, and we're not sure how strong her judgment is.""",
                      kurdishText:
                          """کە چیرۆکەکە بەرەو پێش دەچێت، کەمێک شێتۆکە دەردەکەوێت، و دڵنیا نیین کە بڕیاردانی چەندە بەهێزە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پێستی وشک بوو و توێخی هەڵدەدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ماسییە توناکە پارچە بکە و سۆسەکە زیاد بکە.""",
...
const String _videoIdone = 'https://youtu.be/NHiqsrYkcuk?t=';
const double _startSecondsone = 00000000000000000000000000092;
const String _videoIdtwo = 'https://youtu.be/7EnWiGYT1g4?t=';
const double _startSecondstwo = 000000000000000000000000000127;
const String _videoIdthree = 'https://youtu.be/0buEATF5M0A?t=';
const double _startSecondsthree = 000000000000000000000000000381;
const String _videoIdfour = 'https://youtu.be/LqU9CdPs6ek?t=';
const double _startSecondsfour = 000000000000000000000000000482;
const String _videoIdfive = 'https://youtu.be/ndqjxhi7uZs?t=';
const double _startSecondsfive = 00000000000000000000000000045;
