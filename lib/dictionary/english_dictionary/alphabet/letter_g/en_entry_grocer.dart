...
class EnglishEntrygrocer extends StatefulWidget {
  const EnglishEntrygrocer({super.key});

  @override
  State<EnglishEntrygrocer> createState() => _EnglishEntrygrocerState();
}

class _EnglishEntrygrocerState extends State<EnglishEntrygrocer> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She is a grocer in a small town.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grocer""",
                      // alsoEnglishWord: "also: grocer",
                      britshText: """IpaUK: /ˈɡrəʊsə(r)/""",
                      americanText: """IpaUS: /ˈɡrəʊsər/""",
...
// With short examples define "grocer", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە لە فرۆشگایەک کار دەکات کە میوە و شتی ماڵەوە دەفرۆشێت؛ فرۆشگایەکی وەها"""),
                    SentencesRow(
                      englishText: """She is a grocer in a small town.""",
                      kurdishText:
                          """خواردەمەنی‌فرۆشێکە لە شارۆچکەیەکی بچووک.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/cee6883w2Nk?t=';
const double _startSecondsend = 000000000000000000000000000194;
const String _videoIdone = 'https://youtu.be/YrMGIqecu0Y?t=';
const double _startSecondsone = 0000000000000000000000000001148;
const String _videoIdtwo = 'https://youtu.be/rPdln-PUZuE?t=';
const double _startSecondstwo = 00000000000000000000000000034;
const String _videoIdthree = 'https://youtu.be/tZktTdGHaJY?t=';
const double _startSecondsthree = 000000000000000000000000000599;
const String _videoIdfour = 'https://youtu.be/j4kI2h3iotA?t=';
const double _startSecondsfour = 0000000000000000000000000002472;
const String _videoIdfive = 'https://youtu.be/lF2sKFnuALw?t=';
const double _startSecondsfive = 000000000000000000000000000880;
