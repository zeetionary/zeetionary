...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '99oGcq4-t-4';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'J6d5jSYUjVw';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '8RNGOzJpcEU';
  final double _startSeconds = 3375;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'xwFT9o4IjNc';
  final double _startSeconds = 299;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'rhdZ2RfmiXo';
  final double _startSeconds = 2637;
