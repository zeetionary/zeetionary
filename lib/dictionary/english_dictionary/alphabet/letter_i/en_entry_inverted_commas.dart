...
class EnglishEntryinvertedcommas extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inverted commas""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'zJ-LqeX_fLU';
    const double startSecondsend = 6648;
    const String videoIdone = 'teytUQexPoI';
    const double startSecondsone = 127;
    const String videoIdtwo = 'F_5sV8s9ZEA';
    const double startSecondstwo = 544;
    const String videoIdthree = 'ZCjsnopmYdw';
    const double startSecondsthree = 13;
    const String videoIdfour = '9fpztV4oMd4';
    const double startSecondsfour = 1900;
    const String videoIdfive = 'itLIM38k2r0';
    const double startSecondsfive = 1334;
