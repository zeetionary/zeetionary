...
class EnglishEntryfaithfully extends StatefulWidget {
  const EnglishEntryfaithfully({super.key});

  @override
  State<EnglishEntryfaithfully> createState() => _EnglishEntryfaithfullyState();
}

class _EnglishEntryfaithfullyState extends State<EnglishEntryfaithfully> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""faithfully""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """faithfully""",
                      // alsoEnglishWord: "also: faithfully",
                      britshText: """IpaUK: /ˈfeɪθfəli/""",
                      americanText: """IpaUS: /ˈfeɪθfəli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "faithfully";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The events were faithfully recorded in her diary.""");
  }
...
کوردی: سەرڕاستانە، دروست، بە ئەمەکانە، دڵسۆزانە
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵکار) بە درووستی، بە وریایی"""),
          SentencesRow(
            englishText:
                """The events were faithfully recorded in her diary.""",
            kurdishText: """ڕووداوەکان بە درووستی لە یادنامەکەی تۆمار کران.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: faithfully
1. In a faithful manner (= dependably, reliably, constantly)
...
const String _videoIdend = 'https://youtu.be/PhNUjg9X4g8?t=';
const double _startSecondsend = 000000000000000000000000000157;
const String _videoIdone = 'https://youtu.be/LJUl77rsFEw?t=';
const double _startSecondsone = 000000000000000000000000000480;
const String _videoIdtwo = 'https://youtu.be/JdRoquIwlwI?t=';
const double _startSecondstwo = 000000000000000000000000000105;
const String _videoIdthree = 'https://youtu.be/yXjN5ln-2TQ?t=';
const double _startSecondsthree = 000000000000000000000000000392;
const String _videoIdfour = 'https://youtu.be/P1HiB84S4UI?t=';
const double _startSecondsfour = 000000000000000000000000000444;
const String _videoIdfive = 'https://youtu.be/rbrL40XHlPQ?t=';
