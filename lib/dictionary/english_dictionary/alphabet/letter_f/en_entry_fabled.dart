...
class EnglishEntryfabled extends StatefulWidget {
  const EnglishEntryfabled({super.key});

  @override
  State<EnglishEntryfabled> createState() => _EnglishEntryfabledState();
}

class _EnglishEntryfabledState extends State<EnglishEntryfabled> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fabled""",
                      // alsoEnglishWord: "also: fabled",
                      britshText: """IpaUK: /ˈfeɪbld/""",
                      americanText: """IpaUS: /ˈfeɪbld/""",
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە بەناوبانگە و زۆرجار باس دەکرێت بەڵام بەدەگەمەن دەبیندرێت"""),
          SentencesRow(
            englishText:
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fabled
1. Celebrated in fable or legend (= legendary)
...
const String _videoIdend = 'https://youtu.be/RN8uoBwRr1k?t=';
const double _startSecondsend = 00000000000000000000000000014;
const String _videoIdone = 'https://youtu.be/KmaS21OmhKI?t=';
const double _startSecondsone = 00000000000000000000000000027;
const String _videoIdtwo = 'https://youtu.be/XKDhq2UcjIM?t=';
const double _startSecondstwo = 0000000000000000000000000001606;
...
const String _videoIdfive = 'https://youtu.be/Ob0n6CiIJ70?t=';
