...
class EnglishEntryhandily extends StatefulWidget {
  const EnglishEntryhandily({super.key});

  @override
  State<EnglishEntryhandily> createState() => _EnglishEntryhandilyState();
}

class _EnglishEntryhandilyState extends State<EnglishEntryhandily> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: handily
1. In a convenient manner (- conveniently)
 
2. With no difficulty (- hands down)
"she beat him handily";
""",
  );

  final String keyword = "handily";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""handily""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We're handily placed for the train station.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He handily defeated his challengers.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """handily""",
                      // alsoEnglishWord: "also: handily",
                      britshText: """IpaUK: /ˈhændɪli/""",
                      americanText: """IpaUS: /ˈhændɪli/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە شوێنی سەرەڕێ بۆ وێستگەی شەمەندەفەرداین.""",
