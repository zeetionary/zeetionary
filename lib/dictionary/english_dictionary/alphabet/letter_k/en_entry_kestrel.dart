...
class EnglishEntrykestrel extends StatefulWidget {
  const EnglishEntrykestrel({super.key});

  @override
  State<EnglishEntrykestrel> createState() => _EnglishEntrykestrelState();
}

class _EnglishEntrykestrelState extends State<EnglishEntrykestrel> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""kestrel""");
  }
