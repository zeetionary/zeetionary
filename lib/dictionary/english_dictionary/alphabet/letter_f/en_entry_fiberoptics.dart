...
class EnglishEntryfiberoptics extends StatefulWidget {
  const EnglishEntryfiberoptics({super.key});

  @override
  State<EnglishEntryfiberoptics> createState() =>
      _EnglishEntryfiberopticsState();
}

class _EnglishEntryfiberopticsState extends State<EnglishEntryfiberoptics> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fiberoptics
Usage: US (elsewhere: fibreoptics)
1. The transmission of light signals via glass fibers (= fiber optics [US], fibre optics [Brit, Cdn], fibreoptics [Brit, Cdn])
""",
  );

  final String keyword = "fiber optics";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fiber optics""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiber optics""",
                      // alsoEnglishWord: "also: fiber optics",
                      britshText: """IpaUK: /ˌfaɪbər ˈɒptɪks/""",
                      americanText: """IpaUS: /ˌfaɪbər ˈɑːptɪks/""",
...
const String _videoIdend = 'https://youtu.be/tyixMpuGEL8?t=';
const double _startSecondsend = 0000000000000000000000000001959;
const String _videoIdone = 'https://youtu.be/dYbpekjbK9s?t=';
const double _startSecondsone = 00000000000000000000000000011;
const String _videoIdtwo = 'https://youtu.be/u_1sVri3b2w?t=';
const double _startSecondstwo = 00000000000000000000000000093;
const String _videoIdthree = 'https://youtu.be/pUwVZUOSTvk?t=';
const double _startSecondsthree = 000000000000000000000000000309;
const String _videoIdfour = 'https://youtu.be/qiQR5rTSshw?t=';
const double _startSecondsfour = 0000000000000000000000000003190;
const String _videoIdfive = 'https://youtu.be/CwZdur1Pi3M?t=';
