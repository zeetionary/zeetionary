...
class EnglishEntryinsignia extends StatefulWidget {
  const EnglishEntryinsignia({super.key});

  @override
  State<EnglishEntryinsignia> createState() => _EnglishEntryinsigniaState();
}

class _EnglishEntryinsigniaState extends State<EnglishEntryinsignia> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insignia""");
  }
