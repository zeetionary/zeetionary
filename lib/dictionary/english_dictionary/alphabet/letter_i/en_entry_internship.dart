...
class EnglishEntryinternship extends StatefulWidget {
  const EnglishEntryinternship({super.key});

  @override
  State<EnglishEntryinternship> createState() => _EnglishEntryinternshipState();
}

class _EnglishEntryinternshipState extends State<EnglishEntryinternship> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""internship""");
  }
