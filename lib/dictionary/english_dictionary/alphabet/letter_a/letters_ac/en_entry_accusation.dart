...
class EnglishEntryaccusation extends StatefulWidget {
  const EnglishEntryaccusation({super.key});

  @override
  State<EnglishEntryaccusation> createState() => _EnglishEntryaccusationState();
}

class _EnglishEntryaccusationState extends State<EnglishEntryaccusation> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "accusation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""accusation""");
  }
  ...
  Future<void> speaka125698(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("There was a hint of accusation in her voice.");
  }
  ...
  Future<void> speaka147296(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("At the time, no one believed her accusations against him.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accusation""",
                      // alsoEnglishWord: "also: accusation",
                      britshText: """IpaUK: /ˌækjuˈzeɪʃn/""",
                      americanText: """IpaUS: /ˌækjuˈzeɪʃn/""",
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = '9LCMuKtpnPE';
