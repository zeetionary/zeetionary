...
class EnglishEntryextortion extends StatefulWidget {
  const EnglishEntryextortion({super.key});

  @override
  State<EnglishEntryextortion> createState() => _EnglishEntryextortionState();
}

class _EnglishEntryextortionState extends State<EnglishEntryextortion> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extortion""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extortion""",
                      // alsoEnglishWord: "also: extortion",
                      britshText: """IpaUK: /ɪkˈstɔːʃn/""",
                      americanText: """IpaUS: /ɪkˈstɔːrʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extortion";
...
const String _videoIdone = 'https://youtu.be/L878W_WrTx8?t=';
const double _startSecondsone = 00000000000000000000000000076;
const String _videoIdtwo = 'https://youtu.be/OnjI-FBdRTQ?t=';
const double _startSecondstwo = 0000000000000000000000000009041;
const String _videoIdthree = 'https://youtu.be/Pzz4GKvmLJo?t=';
const double _startSecondsthree = 000000000000000000000000000177;
const String _videoIdfour = 'https://youtu.be/GBXA72S5ADw?t=';
const double _startSecondsfour = 0000000000000000000000000001137;
const String _videoIdfive = 'https://youtu.be/YZAibo7eiik?t=';
const double _startSecondsfive = 0000000000000000000000000001000;
