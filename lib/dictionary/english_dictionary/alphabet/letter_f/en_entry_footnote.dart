...
class EnglishEntryfootnote extends StatefulWidget {
  const EnglishEntryfootnote({super.key});

  @override
  State<EnglishEntryfootnote> createState() => _EnglishEntryfootnoteState();
}

class _EnglishEntryfootnoteState extends State<EnglishEntryfootnote> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: footnote (Derived forms: footnotes)
1. A printed note placed below the text on a printed page (= footer)
 
2. A minor detail or additional minor comment

- Verb: footnote (Derived forms: footnoting, footnotes, footnoted)
1. Add explanatory notes to or supply with critical comments (= annotate)
"The scholar footnoted the early edition of a famous novel";
""",
  );

  final String keyword = "footnote";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""footnote""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The footnote clarified a point made in the paragraph.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """footnote""",
                      // alsoEnglishWord: "also: footnote",
                      britshText: """IpaUK: /ˈfʊtnəʊt/""",
                      americanText: """IpaUS: /ˈfʊtnəʊt/""",
...
کوردی: ژێرنووس، پێ‌نڤیس،	پەراوێز، ڕوون‌کردنەوە، تیشک‌خستنەسەر،	پرس یان مەسەلەی هیچەکە،	لازانیاری، زانیاری پەراوێزی یان لاوەکی
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) زانیارییەکی زیادە کە لە خوارەوەی پەڕەیەک دەنووسرێت"""),
                    SentencesRow(
                      englishText:
                          """The footnote clarified a point made in the paragraph.""",
                      kurdishText:
                          """پەراوێزەکە خاڵێکی ڕوونکردەوە کە لە پەرەگرافەکە باسکرابوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) بۆنەیەک یان کەسێک کە ڕەنگە بە بیربێتەوە بەڵام تەنها وەک ئەوەی کە گرنگ نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The incident seems destined to become a mere footnote in history.""",
                      kurdishText:
                          """ڕووداوەکە وا دیارە تەنها ببێتە پەراوێزێکی بچووک لە مێژوودا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Wao0_uB4Zw4?t=';
const double _startSecondsend = 00000000000000000000000000059;
const String _videoIdone = 'https://youtu.be/3RkhZgRNC1k?t=';
const double _startSecondsone = 0000000000000000000000000001090;
const String _videoIdtwo = 'https://youtu.be/Jb-179F-uyI?t=';
const double _startSecondstwo = 000000000000000000000000000262;
const String _videoIdthree = 'https://youtu.be/7emz4zZ226E?t=';
const double _startSecondsthree = 000000000000000000000000000277;
const String _videoIdfour = 'https://youtu.be/OnjI-FBdRTQ?t=';
const double _startSecondsfour = 00000000000000000000000000019963;
const String _videoIdfive = 'https://youtu.be/Ky1c6d7v0pQ?t=';
const double _startSecondsfive = 000000000000000000000000000179;
