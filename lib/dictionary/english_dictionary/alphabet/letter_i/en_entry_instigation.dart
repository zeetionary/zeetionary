...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'y4DTW4B3Sjs';
    const double startSecondsend = 773;
    const String videoIdone = 'S0w6Ze7_UzA';
    const double startSecondsone = 161;
    const String videoIdtwo = 'hK5KkOC-8Vc';
    const double startSecondstwo = 87;
    const String videoIdthree = 'tFGodTJH4ws';
    const double startSecondsthree = 753;
    const String videoIdfour = 'Ahgcj8DrLiA';
    const double startSecondsfour = 103;
    const String videoIdfive = 'r07YXQNARow';
