...
class EnglishEntryhurried extends StatefulWidget {
  const EnglishEntryhurried({super.key});

  @override
  State<EnglishEntryhurried> createState() => _EnglishEntryhurriedState();
}

class _EnglishEntryhurriedState extends State<EnglishEntryhurried> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hurried""");
  }
