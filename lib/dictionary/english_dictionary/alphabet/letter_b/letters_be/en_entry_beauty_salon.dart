...
// Define the word "beauty salon" and provide five simple example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings or more.

// replace beauty salon - replace EnglishEntrybeautysalon

// replace speakBeautysalon - /ˈbjuːti sælɒn/

enum TtsState { playing }

class EnglishEntrybeautysalon extends StatelessWidget {
// blank divider
  EnglishEntrybeautysalon({super.key});
// blank divider
  ...
  Future<void> speakbeautysalon(String languageCode) async {
    ...
    await flutterTts.speak("beauty salon");
  }
  ...
  Future<void> speakbeautysalons1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She went to a beauty salon for a permanent.");
  }
  ...
  Future<void> speakbeautysalons2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBeautysalons22");
  }
  ...
  Future<void> speakbeautysalons3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBeautysalons33");
  }
  ...
  Future<void> speakbeautysalons4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBeautysalons44");
  }
  ...
  Future<void> speakbeautysalons5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBeautysalons55");
  }
  ...
  Future<void> speakbeautysalons6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBeautysalons66");
  }
  ...
  Future<void> speakbeautysalons7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBeautysalons77");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        const Row(
                          children: [
                            AlsoEnglish(word: "also: beauty parlour"),
                          ],
                        ),
                        Row(
                          children: [
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
Noun: beauty salon (= derived forms: beauty salons)
1. A shop where hairdressers and beauticians work (= salon, beauty parlor [N. Amer], beauty parlour [Brit, Cdn], beauty shop [N. Amer])
""",
  );
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'zsQxHBjk5yM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '8a3roR4VrhQ';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'wtEeFbpCZbQ';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'Zo8r9V6Bwqw';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'yjxwt-1LPws';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'mYExE9HB53w';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = '9XxL6x08Psw';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = '02F2voilvTw';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'QCBIgOzbrzM';
...
class YoutubeEmbeddedthirteen extends StatelessWidget {
  ...
  final String _videoId = 'VfPW2iwJK6U';
