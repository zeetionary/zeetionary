...
class EnglishEntryhemline extends StatefulWidget {
  const EnglishEntryhemline({super.key});

  @override
  State<EnglishEntryhemline> createState() => _EnglishEntryhemlineState();
}

class _EnglishEntryhemlineState extends State<EnglishEntryhemline> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hemline""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Shorter hemlines are back in this season.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""School rules state that hemlines must be below the knee.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hemline""",
                      // alsoEnglishWord: "also: hemline",
                      britshText: """IpaUK: /ˈhemlaɪn/""",
                      americanText: """IpaUS: /ˈhemlaɪn/""",
...
کوردی: 
"""),
// With short examples define "hemline", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بەشی خوارەوەی تەنوورە یان کراس؛ درێژی تەنوورە یان کراس"""),
                    SentencesRow(
                      englishText:
                          """Shorter hemlines are back in this season.""",
                      kurdishText: """لێواری کورت ئەم وەرزە دووبارە باون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """یاساکانی قوتابخانە دەڵێن دامێن دەبێت لە خوار ئەژنۆ بێت.""",
...
const String _videoIdtwo = 'https://youtu.be/YRnFESPckYM?t=';
const double _startSecondstwo = 000000000000000000000000000575;
const String _videoIdthree = 'https://youtu.be/ZeWTbzP6KGQ?t=';
const double _startSecondsthree = 000000000000000000000000000857;
const String _videoIdfour = 'https://youtu.be/7D-gxaie6UI?t=';
const double _startSecondsfour = 0000000000000000000000000001718;
const String _videoIdfive = 'https://youtu.be/tiGfAnIU0J0?t=';
const double _startSecondsfive = 000000000000000000000000000573;
