...
class EnglishEntryhoody extends StatefulWidget {
  const EnglishEntryhoody({super.key});

  @override
  State<EnglishEntryhoody> createState() => _EnglishEntryhoodyState();
}

class _EnglishEntryhoodyState extends State<EnglishEntryhoody> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hoody (Derived forms: hoodies)
1. A sweatshirt with a hood (- hoodie)
 
2. [UK, informal] A young person that wears a hoodie, esp. when associated with yobbish behaviour (- hoodie [UK, informal])
""",
  );

  final String keyword = "hoody";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """He is always seen wearing a blue hoodie with his school uniform worn over it.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/80ULDtPkUQg?t=';
    const double startSecondsend = 000000000000000000000000000238;
    const String videoIdone = 'https://youtu.be/NBWfnOhc34I?t=';
    const double startSecondsone = 0000000000000000000000000001021;
    const String videoIdtwo = 'https://youtu.be/grqdWVXgITM?t=';
    const double startSecondstwo = 000000000000000000000000000913;
    const String videoIdthree = 'https://youtu.be/9_ie0fO4-CM?t=';
    const double startSecondsthree = 000000000000000000000000000156;
    const String videoIdfour = 'https://youtu.be/GplzznHXO04?t=';
    const double startSecondsfour = 000000000000000000000000000200;
    const String videoIdfive = 'https://youtu.be/QLFYJAURgHI?t=';
    const double startSecondsfive = 000000000000000000000000000507;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hoody""",
                      // alsoEnglishWord: "also: hoody",
                      britshText: """IpaUK: /ˈhʊdi/""",
                      americanText: """IpaUS: /ˈhʊdi/""",
...
کوردی: 
"""),
// With short examples define "hoody", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) چاکەتی کڵاودار"""),
                    SentencesRow(
                      englishText:
                          """He is always seen wearing a blue hoodie with his school uniform worn over it.""",
                      kurdishText:
                          """هەمیشە دەبینرێت کە چاکەتێکی شینی لەبەرە لەگەڵ ئەوەی جلی یەکپۆشی قوتابخانە دەکات بە سەریدا.""",
