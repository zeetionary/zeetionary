...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'wknSc6HRUMI';
    const double startSecondsend = 462;
    const String videoIdone = 'lex6USTugUU';
    const double startSecondsone = 862;
    const String videoIdtwo = 'Am1lDj2mUVY';
    const double startSecondstwo = 839;
    const String videoIdthree = 'HAnw168huqA';
    const double startSecondsthree = 2771;
    const String videoIdfour = 'ur-hDqFb0HM';
