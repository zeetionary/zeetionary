...
class EnglishEntryengineering extends StatefulWidget {
  const EnglishEntryengineering({super.key});

  @override
  State<EnglishEntryengineering> createState() =>
      _EnglishEntryengineeringState();
}

class _EnglishEntryengineeringState extends State<EnglishEntryengineering> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""engineering""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """engineering""",
                      // alsoEnglishWord: "also: engineering",
                      britshText: """IpaUK: /ˌendʒɪˈnɪərɪŋ/""",
                      americanText: """IpaUS: /ˌendʒɪˈnɪrɪŋ/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "engineering";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The bridge is a triumph of modern engineering.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ئەندازیاری؛ زانستی بەکارهێنانی زانیاریی زانستی لە درووستکردن و کۆنترۆڵی ئامێر، ڕێگا، پرد، کەرەستەی کارەبایی، هتد"""),
          SentencesRow(
            englishText: """The bridge is a triumph of modern engineering.""",
            kurdishText: """پردەکە سەمەرەیەکی ئەندزایاریی سەردەمە.""",
          ...
          SentencesRow(
            englishText:
                """Train services on Sunday will be restricted because of engineering works.""",
            kurdishText:
                """خزمەتگوزارییەکانی شەمەندەفەر ڕۆژی یەکشەممە دەوەستێندرێن بەهۆی کاری ئەندازیاری.""",
...
2. The discipline dealing with the art or science of applying scientific knowledge to practical problems (= engineering science, applied science, technology, tech [informal])
"he had trouble deciding which branch of engineering to study";
 
3. A room (as on a ship) in which the engine is located (= engine room)
""",
  );
...
const double _startSecondsone = 1896;
const String _videoIdtwo = 'https://youtu.be/xVQxvthAcLU?t=';
const double _startSecondstwo = 207;
const String _videoIdthree = 'https://youtu.be/toVfvRhWbj8?t=';
const double _startSecondsthree = 234;
const String _videoIdfour = 'https://youtu.be/Xzv84ZdtlE0?t=';
const double _startSecondsfour = 755;
const String _videoIdfive = 'https://youtu.be/p3O6bKdPLbw?t=';
const double _startSecondsfive = 2723;
const String _videoIdsix = 'https://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondssix = 610;
