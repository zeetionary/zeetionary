...
class EnglishEntryexecutioner extends StatefulWidget {
  const EnglishEntryexecutioner({super.key});

  @override
  State<EnglishEntryexecutioner> createState() =>
      _EnglishEntryexecutionerState();
}

class _EnglishEntryexecutionerState extends State<EnglishEntryexecutioner> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""executioner""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """executioner""",
                      // alsoEnglishWord: "also: executioner",
                      britshText: """IpaUK: /ˌeksɪˈkjuːʃənə(r)/""",
                      americanText: """IpaUS: /ˌeksɪˈkjuːʃənər/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "executioner";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The executioner prepared the gallows.""");
  }
...
کوردی: جەلاد، لەسێدارەدەر، پیاوکوژ، میری سەربڕ
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کەسێک کە کاری کوشتنی خەڵکییە، بەتایبەتی بۆ بەجێهێنانی سزای یاسایی"""),
          SentencesRow(
            englishText: """The executioner prepared the gallows.""",
            kurdishText: """بکوژەکە قەنارەکەی ئامادە کرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: executioner (Derived forms: executioners)
1. An official who inflicts capital punishment in pursuit of a warrant (= public executioner)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/-HyHZsa79LU?t=';
const double _startSecondsend = 000000000000000000000000000000; // 180;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/4IaOeVgZ-wc?t=';
const double _startSecondsone = 00000000000000000000000000000; // 2730;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/rbrL40XHlPQ?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 613;
const String _videoIdthree = 'VIDEOhttps://youtu.be/AqkMykYQ7eU?t=';
const double _startSecondsthree = 000000000000000000000000000; // 307;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/vNEd9FyG5P4?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 72;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/ncMoQs_HNmY?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1750;
