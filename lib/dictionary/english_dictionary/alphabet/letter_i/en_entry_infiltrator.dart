...
class EnglishEntryinfiltrator extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infiltrator""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'klXaDgmM8Fs';
    const double startSecondsend = 290;
    const String videoIdone = 'E2rtQFAibEA';
    const double startSecondsone = 5026;
    const String videoIdtwo = 'woD6RYptp58';
    const double startSecondstwo = 268;
    const String videoIdthree = 'o0FiG7c6m48';
    const double startSecondsthree = 841;
    const String videoIdfour = 'xrLrb1OQjGs';
    const double startSecondsfour = 362;
    const String videoIdfive = '0HjjYsSuZyM';
    const double startSecondsfive = 533;
