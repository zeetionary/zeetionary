...
class EnglishEntrygauntlet extends StatefulWidget {
  const EnglishEntrygauntlet({super.key});

  @override
  State<EnglishEntrygauntlet> createState() => _EnglishEntrygauntletState();
}

class _EnglishEntrygauntletState extends State<EnglishEntrygauntlet> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gauntlet""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gauntlet""",
                      // alsoEnglishWord: "also: gauntlet",
                      britshText: """IpaUK: gauntlet""",
                      americanText: """IpaUS: gauntlet""",
...
// With short examples define "gauntlet", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """In winter, motorcyclists rely on leather gauntlets for warmth.""",
                      kurdishText:
                          """لە زستاندا، ماتۆڕسواران پشت بە دەستکێشی چەرم دەبەستن بۆ پاراستن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ieamg11HI7c?t=';
const double _startSecondsend = 000000000000000000000000000384;
const String _videoIdone = 'https://youtu.be/Gv4Af83KFrE?t=';
const double _startSecondsone = 0000000000000000000000000001506;
const String _videoIdtwo = 'https://youtu.be/dHPTR96Sc1g?t=';
...
const double _startSecondsfour = 0000000000000000000000000001546;
