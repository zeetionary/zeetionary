...
class EnglishEntrylookin extends StatefulWidget {
  const EnglishEntrylookin({super.key});

  @override
  State<EnglishEntrylookin> createState() => _EnglishEntrylookinState();
}

class _EnglishEntrylookinState extends State<EnglishEntrylookin> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylookin look-in
WORD_WEB look-in look-in look-in
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "look-in";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""look-in""");
  }
...
کوردی: 
"""),
// With short examples define "look-in", please follow LX instructions
