...
class EnglishEntrydecisively extends StatefulWidget {
  const EnglishEntrydecisively({super.key});

  @override
  State<EnglishEntrydecisively> createState() => _EnglishEntrydecisivelyState();
}

class _EnglishEntrydecisivelyState extends State<EnglishEntrydecisively> {
  @override
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "decisively");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: decisively");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /dɪˈsaɪsɪvli/");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakdecisively(String languageCode) async {
  ...
  Widget build(BuildContext context) {
    return CustomIconButtonBritish(
      onPressed: () => speakdecisively("en-GB"),
    );
  }
}
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /dɪˈsaɪsɪvli/");
  }
}
...
class TTSUS extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomIconButtonAmerican(
      onPressed: () => speakdecisively("en-US"),
    );
  }
}
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakdecisivelys1(String languageCode) async {
    // DOPSUM: CHANGE speakdecisively
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
...
// Create an instance of EnglishMeaningConst with the desired text
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: decisively 
1. With firmness of purpose (= resolutely, decidedly)
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/YfP5TM3jThU?t=',
    startSeconds: 12,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/kKkjTbt9ArQ?t=',
    startSeconds: 144,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
