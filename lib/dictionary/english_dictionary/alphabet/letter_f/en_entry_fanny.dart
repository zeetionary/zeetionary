...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) لە ئینگلیزیی بەریتانی واتا ئەندامی زاوزێی مێینە"""),
          SentencesRow(
            englishText: """They warned her about the word fanny in the UK.""",
            kurdishText:
                """ئاگاداریان کردەوە سەبارەت بە وشەی fanny لە بەریتانیا.""",
