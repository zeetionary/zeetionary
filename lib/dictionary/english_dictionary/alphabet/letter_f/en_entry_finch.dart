...
class EnglishEntryfinch extends StatefulWidget {
  const EnglishEntryfinch({super.key});

  @override
  State<EnglishEntryfinch> createState() => _EnglishEntryfinchState();
}

class _EnglishEntryfinchState extends State<EnglishEntryfinch> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The finch perched on the tree branch.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """finch""",
                      // alsoEnglishWord: "also: finch",
                      britshText: """IpaUK: /fɪntʃ/""",
                      americanText: """IpaUS: /fɪntʃ/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هەر یەکێک لە جۆرانەی باڵندەی بچووک کە دەنووکێکی کورتیان هەیە و دەخوێنن"""),
                    SentencesRow(
                      englishText: """The finch perched on the tree branch.""",
                      kurdishText: """کوێشکەکە لەسەر لقی دارەکە نیشتەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ml7bK1jg69I?t=';
...
const String _videoIdtwo = 'https://youtu.be/7XBu3gHPVrM?t=';
const double _startSecondstwo = 000000000000000000000000000377;
const String _videoIdthree = 'https://youtu.be/pDtpEiMyGT4';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/p122jSJ9tqw?t=';
const double _startSecondsfour = 00000000000000000000000000029;
const String _videoIdfive = 'https://youtu.be/dfsUz2O2jww?t=';
