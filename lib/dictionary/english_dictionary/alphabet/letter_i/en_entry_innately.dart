...
class EnglishEntryinnately extends StatefulWidget {
  const EnglishEntryinnately({super.key});

  @override
  State<EnglishEntryinnately> createState() => _EnglishEntryinnatelyState();
}

class _EnglishEntryinnatelyState extends State<EnglishEntryinnately> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""innately""");
  }
