...
class EnglishEntryadmonish extends StatefulWidget {
  const EnglishEntryadmonish({super.key});

  @override
  State<EnglishEntryadmonish> createState() => _EnglishEntryadmonishState();
}

class _EnglishEntryadmonishState extends State<EnglishEntryadmonish> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """admonish""",
                      // alsoEnglishWord: "also: admonish",
                      britshText: """IpaUK: /ədˈmɒnɪʃ/""",
                      americanText: """IpaUS: /ədˈmɑːnɪʃ/""",
