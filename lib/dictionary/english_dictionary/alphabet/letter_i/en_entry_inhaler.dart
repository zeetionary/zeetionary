...
class EnglishEntryinhaler extends StatefulWidget {
  const EnglishEntryinhaler({super.key});

  @override
  State<EnglishEntryinhaler> createState() => _EnglishEntryinhalerState();
}

class _EnglishEntryinhalerState extends State<EnglishEntryinhaler> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inhaler""");
  }
