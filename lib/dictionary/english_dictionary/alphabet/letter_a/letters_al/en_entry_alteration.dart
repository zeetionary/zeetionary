...
// replace these: replace EnglishEntryalteration - replace speakAlteration - replace alteration - /ˌɔːltəˈreɪʃn/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryalteration extends StatelessWidget {
  EnglishEntryalteration({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAlteration(String languageCode) async {
    // DOPSUM: CHANGE speakAlteration
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("alteration"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAlteration4522(String languageCode) async {
    ...
    await flutterTts.speak(
        "They are making some alterations to the house."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "alteration"), // Find /ˌɔːltəˈreɪʃn/
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /ˌɔːltəˈreɪʃn/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                            CustomIconButtonBritish(
                              onPressed: () => speakAlteration("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /ˌɔːltəˈreɪʃn/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                            CustomIconButtonAmerican(
                              onPressed: () => speakAlteration("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'c0pA_vfb5F0';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '1p2Zg6b-BzM';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'N3gj26nqWns';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'QlUQ0nRQ8oU';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'b3ldxcEwlT0';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'gjJdzHIwDDU';
