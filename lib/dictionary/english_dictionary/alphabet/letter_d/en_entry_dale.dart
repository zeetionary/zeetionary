...
"""),
        const DefinitionKurdish(text: "١. (ناو) دۆڵێک، بەتایبەتی لە باکووری ئینگلتەرە"),
        Row(
          children: [
            const Expanded(
              child: Column(
                children: [
                  ...
                  ExampleSentenceKurdish(text: "ئەم هاوینە دەچین بۆ گەڕان لە دۆڵەکانی یۆرکشێر."),
                ],
              ),
            ),
...
final _controller = YoutubePlayerController.fromVideoId(
  videoId: 'https://youtu.be/FXkcTUgItNE?t=',
  startSeconds: 193,
  autoPlay: true,
...
final _controller = YoutubePlayerController.fromVideoId(
  videoId: 'https://youtu.be/cuWUJy-dpVI?t=',
  startSeconds: 282,
  autoPlay: true,
  params: const YoutubePlayerParams(
    enableCaption: true,
...
final _controller = YoutubePlayerController.fromVideoId(
  videoId: 'https://youtu.be/MZzFjeQFpro?t=',
  startSeconds: 83,
  autoPlay: true,
  params: const YoutubePlayerParams(
    enableCaption: true,
...
final _controller = YoutubePlayerController.fromVideoId(
  videoId: 'https://youtu.be/Bejo7eExCA4?t=',
  startSeconds: 3,
  autoPlay: true,
  params: const YoutubePlayerParams(
    enableCaption: true,
...
final _controller = YoutubePlayerController.fromVideoId(
  videoId: 'https://youtu.be/FsSUTSgqL3o?t=',
  startSeconds: 45,
  autoPlay: true,
  params: const YoutubePlayerParams(
    enableCaption: true,
...
final _controller = YoutubePlayerController.fromVideoId(
  videoId: 'https://youtu.be/RQ3wZCBA1_w?t=',
  startSeconds: 1245,
  autoPlay: true,
  params: const YoutubePlayerParams(
    enableCaption: true,
