...
class EnglishEntrygrandson extends StatefulWidget {
  const EnglishEntrygrandson({super.key});

  @override
  State<EnglishEntrygrandson> createState() => _EnglishEntrygrandsonState();
}

class _EnglishEntrygrandsonState extends State<EnglishEntrygrandson> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grandson (Derived forms: grandsons)
1. A male grandchild
""",
  );

  final String keyword = "grandson";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grandson""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She baked cookies with her grandson.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They took their grandson to the zoo.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grandson""",
                      // alsoEnglishWord: "also: grandson",
                      britshText: """IpaUK: /ˈɡrænsʌn/""",
                      americanText: """IpaUS: /ˈɡrænsʌn/""",
...
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) کوڕێک کە منداڵی کوڕ یان کچەکەتە"""),
                    SentencesRow(
                      englishText: """She baked cookies with her grandson.""",
                      kurdishText: """لەگەڵ کوڕەزاکەی بسکیتیان دەبرژاند.""",
                    ...
                    SentencesRow(
                      englishText: """They took their grandson to the zoo.""",
                      kurdishText: """کوڕەزاکەیان برد بۆ باخچەی ئاژەڵان.""",
...
const String _videoIdtwo = 'https://youtu.be/NtUUW_pFs_8?t=';
const double _startSecondstwo = 000000000000000000000000000105;
const String _videoIdthree = 'https://youtu.be/FCmS0mY622k?t=';
...
const String _videoIdfive = 'https://youtu.be/qtlPTE-UmY4?t=';
