...
class EnglishEntrylion extends StatefulWidget {
  const EnglishEntrylion({super.key});

  @override
  State<EnglishEntrylion> createState() => _EnglishEntrylionState();
}

class _EnglishEntrylionState extends State<EnglishEntrylion> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lion (Derived forms: lions)
1. Large gregarious predatory feline of Africa and India having a tawny coat with a shaggy mane in the male (- king of beasts, Panthera leo)
 
2. A celebrity who is lionized (much sought after) (- social lion)
 
3. Someone who shows strength and courage

- Noun: Lion (Derived forms: Lions)
1. (astrology) a person who is born while the sun is in Leo (- Leo)
 
2. The fifth sign of the zodiac; the sun is in this sign from about July 23 to August 22 (- Leo, Leo the Lion)
""",
  );

  final String keyword = "lion";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The lion shook its mane and roared.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Over the past two months, 13 lions have been killed by poachers.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He wrestled the lion to the ground with his bare hands.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/qABX3atNC8o?t=15';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/IVLXHUC1L6k?t=77';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/829YuVH1dg8?t=38';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/JX-sdB72nPw?t=116';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/G5osb9xCri4?t=49';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/XFeItKoT0Fw?t=332';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lion""",
                      // alsoEnglishWord: "also: lion",
                      britshText: """IpaUK: /ˈlaɪən/""",
                      americanText: """IpaUS: /ˈlaɪən/""",
...
کوردی: 
"""),
// With short examples define "lion", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ئاژەڵێکی بەهێزی گەورە کە لە خێزانی پشیلەیە و بە گرووپ ڕاو دەکەن و لە ئەفریقا و باشووری ئاسیا دەژین"""),
                    SentencesRow(
                      englishText: """The lion shook its mane and roared.""",
                      kurdishText: """شیرەکە پرچی ڕاوەشاند و نەڕاندی.""",
                    ...
                    SentencesRow(
                      englishText: """Over the past two months, 13 lions have been killed by poachers.""",
                      kurdishText: """لە دوو مانگی ڕابردوودا، ١٣ شێر لەلایەن ڕاوکەرانەوە کوژراون.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He wrestled the lion to the ground with his bare hands.""",
                      kurdishText: """بە دەستەکانی شێرەکەی کوتا بە زەویدا.""",
