...
class EnglishEntryairhostess extends StatelessWidget {
  EnglishEntryairhostess({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈeə həʊstəs/,  /ˈeə həʊstes/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'DqmViXCyVKA';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'GTlcEVQ_KwA';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '2ew2IWkWe5c';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'vwJVXZbmDVI';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'xIVEKVukAZA';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'Yzn2Dy1ueMI';
