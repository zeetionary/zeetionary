...
class EnglishEntrygrope extends StatefulWidget {
  const EnglishEntrygrope({super.key});

  @override
  State<EnglishEntrygrope> createState() => _EnglishEntrygropeState();
}

class _EnglishEntrygropeState extends State<EnglishEntrygrope> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: grope (Derived forms: groping, gropes, groped)
1. Feel about uncertainly or blindly (- fumble)
"She groped for her glasses in the darkness of the bedroom";
 
2. Search blindly or uncertainly
"His mind groped to make the connection"
 
3. Fondle for sexual pleasure (- feel up [slang], cop a feel [slang], touch up [Brit, slang])
"He made some sexual advances at the woman in his office and groped her repeatedly";

- Noun: grope (Derived forms: gropes)
1. The act of groping; and instance of groping
""",
  );

  final String keyword = "grope";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He groped around in the dark for his other sock.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She groped blindly for the door handle.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She groped through the darkness towards the doors.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grope""",
                      // alsoEnglishWord: "also: grope",
                      britshText: """IpaUK: /ɡrəʊp/""",
                      americanText: """IpaUS: /ɡrəʊp/""",
...
// With short examples define "grope", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) هەوڵدان بۆ دۆزینەوەی شتێک کە نایبینیت بە دەستەکانت"""),
                    SentencesRow(
                      englishText:
                          """He groped around in the dark for his other sock.""",
                      kurdishText:
                          """لە تاریکییەکەدا بۆ گۆرەوییەکانی دەستی دەگێڕا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە نابینایی دەستی دەگێڕا بۆ دەسکی دەرگاکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) هەوڵدان بۆ گەشتن بە شوێنیک بە بەکارهێنانی دەستت بەهۆی ئەوەی بە ڕوونی نابینیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She groped through the darkness towards the doors.""",
                      kurdishText:
                          """بە دەستی ڕێگای خۆی بەرەو دەرگاکە دۆزییەوە لە تاریکییەکەدا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She described how he had groped her whenever they were alone.""",
                      kurdishText:
                          """باسی ئەوەی کرد کە چۆن دەستی لێدەدا هەر کاتێک تەنها بوون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/h_OeMVcol1g?t=';
const double _startSecondsend = 0000000000000000000000000001343;
const String _videoIdone = 'https://youtu.be/rbrL40XHlPQ?t=';
const double _startSecondsone = 000000000000000000000000000524;
const String _videoIdtwo = 'https://youtu.be/rwoPd2MHEh0?t=';
const double _startSecondstwo = 0000000000000000000000000001543;
const String _videoIdthree = 'https://youtu.be/Ir2O2ysWaes?t=';
const double _startSecondsthree = 000000000000000000000000000171;
const String _videoIdfour = 'https://youtu.be/K0PUZ7w_bfI?t=';
const double _startSecondsfour = 000000000000000000000000000262;
const String _videoIdfive = 'https://youtu.be/wkSuMiPFnCU?t=';
const double _startSecondsfive = 0000000000000000000000000001437;
