...
class EnglishEntrylimitedcompany extends StatefulWidget {
  const EnglishEntrylimitedcompany({super.key});

  @override
  State<EnglishEntrylimitedcompany> createState() => _EnglishEntrylimitedcompanyState();
}

class _EnglishEntrylimitedcompanyState extends State<EnglishEntrylimitedcompany> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylimitedcompany limited company
WORD_WEB limited company limited company limited company
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "limited company";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""limited company""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: limited company",
...
کوردی: 
"""),
// With short examples define "limited company", please follow LX instructions
