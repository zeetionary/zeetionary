...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1204;
    const String videoIdone = 'tsxmyL7TUJg';
    const double startSecondsone = 615;
    const String videoIdtwo = 'lex6USTugUU';
    const double startSecondstwo = 1007;
    const String videoIdthree = 'uN84HhcdIws';
    const double startSecondsthree = 1021;
    const String videoIdfour = 'FQ4hvLqNfqo';
    const double startSecondsfour = 393;
    const String videoIdfive = '1jm3K9cm3vI';
    const double startSecondsfive = 1194;
