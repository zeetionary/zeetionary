...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'ni5-3x6ofjc';
    const double startSecondsend = 96;
    const String videoIdone = 'WHnpp823BW8';
    const double startSecondsone = 613;
    const String videoIdtwo = 'H-iM_JhNzIQ';
    const double startSecondstwo = 1131;
    const String videoIdthree = 'f3cQEMLnd_k';
    const double startSecondsthree = 426;
    const String videoIdfour = 'RN8uoBwRr1k';
    const double startSecondsfour = 387;
    const String videoIdfive = 'DWmGArQBtFI';
