...
class EnglishEntryhoarse extends StatefulWidget {
  const EnglishEntryhoarse({super.key});

  @override
  State<EnglishEntryhoarse> createState() => _EnglishEntryhoarseState();
}

class _EnglishEntryhoarseState extends State<EnglishEntryhoarse> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hoarse
1. Deep and harsh sounding as if from shouting, illness or emotion (- gruff, husky)
"hoarse cries";
""",
  );

  final String keyword = "hoarse";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He shouted himself hoarse.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His voice was hoarse with exhaustion.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her voice was hoarse from shouting.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000535;
    const String videoIdone = 'https://youtu.be/tNMZ16h2NXM?t=';
    const double startSecondsone = 000000000000000000000000000382;
    const String videoIdtwo = 'https://youtu.be/p7bZBH2RIms?t=';
    const double startSecondstwo = 000000000000000000000000000185;
    const String videoIdthree = 'https://youtu.be/ykBuiZul2Hw?t=';
    const double startSecondsthree = 000000000000000000000000000312;
    const String videoIdfour = 'https://youtu.be/uGv1xasBCmo?t=';
    const double startSecondsfour = 000000000000000000000000000342;
    const String videoIdfive = 'https://youtu.be/MW8QT5EpH0E?t=';
    const double startSecondsfive = 000000000000000000000000000566;
...
// With short examples define "hoarse", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) کە کەسێک دەنگی دانووساوە، زۆرجار بەهۆی ئەوەی قوڕگی گیراوە؛ دەنگێک کە لەم شێوەیە"""),
                    SentencesRow(
                      englishText: """He shouted himself hoarse.""",
                      kurdishText: """هێندە هاواری کرد قوڕگی دانووسا.""",
                    ...
                    SentencesRow(
                      englishText: """His voice was hoarse with exhaustion.""",
                      kurdishText: """دەنگی نووساو بوو لە ماندوێتیدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her voice was hoarse from shouting.""",
                      kurdishText: """دەنگی دانووساو بوو بە هاوارکردن.""",
