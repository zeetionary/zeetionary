...
class EnglishEntryimpressive extends StatefulWidget {
  const EnglishEntryimpressive({super.key});

  @override
  State<EnglishEntryimpressive> createState() => _EnglishEntryimpressiveState();
}

class _EnglishEntryimpressiveState extends State<EnglishEntryimpressive> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impressive""");
  }
