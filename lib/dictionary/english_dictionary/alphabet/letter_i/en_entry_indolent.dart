...
class EnglishEntryindolent extends StatefulWidget {
  const EnglishEntryindolent({super.key});

  @override
  State<EnglishEntryindolent> createState() => _EnglishEntryindolentState();
}

class _EnglishEntryindolentState extends State<EnglishEntryindolent> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: indolent
1. Disinclined to work or exertion (- fainéant [archaic], lazy, otiose, slothful, work-shy)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indolent""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She stayed indolent all weekend and watched TV.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/NPtBkw5uD-0?t=';
    const double startSecondsend = 0000000000000000000000000008652;
    const String videoIdone = 'https://youtu.be/XUXBgswQX_I?t=';
    const double startSecondsone = 0000000000000000000000000001404;
    const String videoIdtwo = 'https://youtu.be/VeBX4WjhhXs?t=';
    const double startSecondstwo = 000000000000000000000000000837;
    const String videoIdthree = 'https://youtu.be/urFChdLN6nA?t=';
    const double startSecondsthree = 0000000000000000000000000002282;
    const String videoIdfour = 'https://youtu.be/_lpxUM5Yr0s?t=';
    const double startSecondsfour = 00000000000000000000000000046;
    const String videoIdfive = 'https://youtu.be/k-lNeg9e60c?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indolent""",
                      // alsoEnglishWord: "also: indolent",
                      britshText: """IpaUK: /ˈɪndələnt/""",
                      americanText: """IpaUS: /ˈɪndələnt/""",
...
کوردی: تەمەڵ، تەپلۆس، داهێزراو، تەپ، داوەشاو، لەش‌گران، تەوەزەل، سست
"""),
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) تەمەڵ"""),
                    SentencesRow(
                      englishText:
                          """She stayed indolent all weekend and watched TV.""",
                      kurdishText:
                          """تەواوی کۆتایی هەفتە بە تەمەڵی مایەوە و سەیری تەلەفیزیۆنی کرد.""",
