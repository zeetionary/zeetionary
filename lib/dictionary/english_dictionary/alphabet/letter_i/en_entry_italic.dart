...
class EnglishEntryitalic extends StatefulWidget {
  const EnglishEntryitalic({super.key});

  @override
  State<EnglishEntryitalic> createState() => _EnglishEntryitalicState();
}

class _EnglishEntryitalicState extends State<EnglishEntryitalic> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryitalic italic
WORD_WEB italic italic italic
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "italic";
...
// کوردی:
// """),
// With short examples define "italic", please follow LX instructions
