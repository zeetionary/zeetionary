...
class EnglishEntryflatten extends StatefulWidget {
  const EnglishEntryflatten({super.key});

  @override
  State<EnglishEntryflatten> createState() => _EnglishEntryflattenState();
}

class _EnglishEntryflattenState extends State<EnglishEntryflatten> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: flatten (Derived forms: flattening, flattened, flattens)
1. Make flat or flatter (= pancake)
"flatten your stomach with these exercises";
 
2. Become flat or flatter (= flatten out, pancake)
"The landscape flattened";
 
3. (music) lower the pitch of (musical notes) (= drop)
 
4. Destroy (a building or buildings) so as to make nearly level the ground (= level, raze, rase, dismantle, tear down, take down, pull down)
""",
  );

  final String keyword = "flatten";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flatten""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The cookies will flatten slightly while cooking.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""These exercises will help to flatten your stomach.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He flattened his hair down with gel.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Most of the factory was flattened by the explosion.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The hurricane flattened thousands of homes.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She flattened her nose against the window and looked in.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Greg flattened himself against the wall to let me pass.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Our team was flattened this evening!""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'll flatten you if you do that again!""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flatten""",
                      // alsoEnglishWord: "also: flatten",
                      britshText: """IpaUK: /ˈflætn/""",
                      americanText: """IpaUS: /ˈflætn/""",
...
// With short examples define "flatten", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بسکیتەکان کەمێک تەخت دەبن کە ئامادە دەبن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەم ڕاهێنانانە یارمەتیدەر دەبێت بۆ تەختکردنی زگت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He flattened his hair down with gel.""",
                      kurdishText: """بە جێڵ قژی تەخت کرد.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (کردار) لەناوبردنی بینایەک، دارێک، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Most of the factory was flattened by the explosion.""",
                      kurdishText:
                          """زۆرینەی کارگەکە وێران بوو بە تەقینەوەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """گەردەلوول هەزاران ماڵی تەخت کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لووتی توختکرد بە پەنجەرەکەوە و سەیری ژوورەوەی کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """گرێگ خۆی پاڵنا بە دیوارەکەوە و هێشتی تێپەڕم.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (کردار) بە ئاسانی بەزاندنی کەسێک لە ڕکابەرییەک، مشتومڕێک، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DefinitionKurdish(
                        text:
                            """٥. (کردار) لێدان لە کەسێک هێندە بە توندی کە بکەوێت بە زەویدا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I'll flatten you if you do that again!""",
                      kurdishText:
                          """قەپۆزت دەشکێنم ئەگەر دووبارەی بکەیتەوە.""",
...
const double _startSecondsend = 000000000000000000000000000448;
const String _videoIdone = 'https://youtu.be/toVfvRhWbj8?t=';
const double _startSecondsone = 0000000000000000000000000001170;
const String _videoIdtwo = 'https://youtu.be/g9QneAV4fVo?t=';
const double _startSecondstwo = 000000000000000000000000000798;
const String _videoIdthree = 'https://youtu.be/LqU9CdPs6ek?t=';
const double _startSecondsthree = 000000000000000000000000000582;
const String _videoIdfour = 'https://youtu.be/1oa6VziZH78?t=';
const double _startSecondsfour = 000000000000000000000000000675;
const String _videoIdfive = 'https://youtu.be/hapSlAP2xrc?t=';
