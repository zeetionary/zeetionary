...
class EnglishEntryherpes extends StatefulWidget {
  const EnglishEntryherpes({super.key});

  @override
  State<EnglishEntryherpes> createState() => _EnglishEntryherpesState();
}

class _EnglishEntryherpesState extends State<EnglishEntryherpes> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: herpes (Derived forms: herpeses)
1. Viral diseases causing eruptions of the skin or mucous membrane
 
2. Any of the animal viruses that cause painful blisters on the skin (- herpes virus)
""",
  );

  final String keyword = "herpes";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The doctor explained how herpes spreads through close contact.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """herpes""",
                      // alsoEnglishWord: "also: herpes",
                      britshText: """IpaUK: /ˈhɜːpiːz/""",
                      americanText: """IpaUS: /ˈhɜːrpiːz/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) یەکێک لەو گرووپە نەخۆشییانەی کە بەهۆی ڤایرۆسەوە ڕوودەدات و خاڵی بەئازار لەسەر پێست درووست دەکات"""),
                    SentencesRow(
                      englishText:
                          """The doctor explained how herpes spreads through close contact.""",
                      kurdishText:
                          """پزیشکەکە ئەوەی ڕوونکردەوە کە چۆن هێرپیز بە بەرکەوتنی نزیک دەگوێزرێتەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/5K2AI44XI0s?t=';
const double _startSecondsend = 000000000000000000000000000109;
const String _videoIdone = 'https://youtu.be/Zad6v8ZHzdg?t=';
const double _startSecondsone = 000000000000000000000000000317;
const String _videoIdtwo = 'https://youtu.be/-UKaaEvH7uI?t=';
const double _startSecondstwo = 000000000000000000000000000505;
const String _videoIdthree = 'https://youtu.be/NI0_mEMaTyE?t=';
const double _startSecondsthree = 000000000000000000000000000129;
const String _videoIdfour = 'https://youtu.be/qS250xspGmI?t=';
const double _startSecondsfour = 000000000000000000000000000187;
const String _videoIdfive = 'https://youtu.be/2FiNjmGz_2g?t=';
