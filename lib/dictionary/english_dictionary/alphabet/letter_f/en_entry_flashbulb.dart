...
class EnglishEntryflashbulb extends StatefulWidget {
  const EnglishEntryflashbulb({super.key});

  @override
  State<EnglishEntryflashbulb> createState() => _EnglishEntryflashbulbState();
}

class _EnglishEntryflashbulbState extends State<EnglishEntryflashbulb> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flashbulb (Derived forms: flashbulbs, flash bulbs)
Usage: archaic
1. A lamp for providing momentary light to take a photograph (= flash, photoflash [rare], flash lamp, flashgun, flash bulb [archaic], flashlight)
""",
  );

  final String keyword = "flashbulb";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flashbulb""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flashbulb""",
                      // alsoEnglishWord: "also: flashbulb",
                      britshText: """IpaUK: /ˈflæʃbʌlb/""",
                      americanText: """IpaUS: /ˈflæʃbʌlb/""",
...
// With short examples define "flashbulb", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """She wanted to get away from the glare of the public and the flashbulbs of the press.""",
                      kurdishText:
                          """دەیویست هەڵبێت لە نیگای خەڵکی و فلاشی میدیا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/AEm-2giH_zw?t=';
const double _startSecondsend = 000000000000000000000000000178;
const String _videoIdone = 'https://youtu.be/kxcZjUtYR0g?t=';
const double _startSecondsone = 000000000000000000000000000171;
const String _videoIdtwo = 'https://youtu.be/wbbH77rYaa8?t=';
const double _startSecondstwo = 0000000000000000000000000001575;
const String _videoIdthree = 'https://youtu.be/uplxc5lB7cQ?t=';
const double _startSecondsthree = 0000000000000000000000000004733;
const String _videoIdfour = 'https://youtu.be/DMmpN6eETP8?t=';
const double _startSecondsfour = 000000000000000000000000000344;
const String _videoIdfive = 'https://youtu.be/my2oC4vIZjY?t=';
