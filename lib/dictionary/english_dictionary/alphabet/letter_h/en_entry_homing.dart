...
class EnglishEntryhoming extends StatefulWidget {
  const EnglishEntryhoming({super.key});

  @override
  State<EnglishEntryhoming> createState() => _EnglishEntryhomingState();
}

class _EnglishEntryhomingState extends State<EnglishEntryhoming> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Many birds have a remarkable homing instinct.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The president's car is equipped with a homing device.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/fE4Z5hFLrqI?t=';
    const double startSecondsend = 000000000000000000000000000241;
    const String videoIdone = 'https://youtu.be/Szj0GE9tY-M?t=';
    const double startSecondsone = 000000000000000000000000000422;
    const String videoIdtwo = 'https://youtu.be/7u1uRCU5ZeE?t=';
    const double startSecondstwo = 000000000000000000000000000735;
    const String videoIdthree = 'https://youtu.be/v-Ymf_hTbUM?t=';
    const double startSecondsthree = 0000000000000000000000000001402;
    const String videoIdfour = 'https://youtu.be/WefqSN8dqOU?t=';
    const double startSecondsfour = 000000000000000000000000000175;
    const String videoIdfive = 'https://youtu.be/ZRDIHcFRPFs?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homing""",
                      // alsoEnglishWord: "also: homing",
                      britshText: """IpaUK: /ˈhəʊmɪŋ/""",
                      americanText: """IpaUS: /ˈhəʊmɪŋ/""",
...
// With short examples define "homing", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆر باڵندە توانای ناوازەی هێلانەدۆزییان هەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئۆتۆمبێلەکەی سەرۆک ئامێری پەخشداری تێدایە.""",
