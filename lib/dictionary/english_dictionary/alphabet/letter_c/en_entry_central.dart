...
class EnglishEntrycentral extends StatelessWidget {
  // blank divider
  EnglishEntrycentral({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcentral(String languageCode) async {
    // DOPSUM: CHANGE speakcentral
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "central"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈsentrəl/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcentral("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈsentrəl/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcentral("en-US"),
                            ),
                          ],
                        ),
                      ],
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: central 
1. In or near a centre or constituting a centre; the inner area
"a central position"
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'lPD9fx8fK1k';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final double _startSeconds = 1482;
