...
class EnglishEntrygreedy extends StatefulWidget {
  const EnglishEntrygreedy({super.key});

  @override
  State<EnglishEntrygreedy> createState() => _EnglishEntrygreedyState();
}

class _EnglishEntrygreedyState extends State<EnglishEntrygreedy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: greedy (Derived forms: greedier, greediest)
1. Immoderately desirous of acquiring e.g. wealth (- avaricious, covetous, grabby [N. Amer, informal], grasping, prehensile)
"greedy for money and power"; "grew richer and greedier";
 
2. (often followed by 'for') ardently or excessively desirous (- avid, devouring, esurient)
"greedy for fame";
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""You greedy pig! You've already had two helpings!""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He stared at the diamonds with greedy eyes.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The shareholders are greedy for profit.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """greedy""",
                      // alsoEnglishWord: "also: greedy",
                      britshText: """IpaUK: /ˈɡriːdi/""",
                      americanText: """IpaUS: /ˈɡriːdi/""",
...
// With short examples define "greedy", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ویستنی پارە، دەسەڵات، خواردن، هتد ــی زیاتر وەک لەوەی پێویستتە"""),
                    SentencesRow(
                      englishText:
                          """You greedy pig! You've already had two helpings!""",
                      kurdishText:
                          """بەرازی چڵێس! پێشوەختە دوو بەشی خۆتت خواردووە!""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە چاوی تەماحەوە سەیری ئەڵماسەکانی دەکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """خاوەن پشکەکان چڵێسن بۆ قازانج.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/gjySnrspD7E?t=';
const double _startSecondsend = 000000000000000000000000000269;
const String _videoIdone = 'https://youtu.be/mncCR3wehF8?t=';
const double _startSecondsone = 000000000000000000000000000258;
const String _videoIdtwo = 'https://youtu.be/FQ4hvLqNfqo?t=';
const double _startSecondstwo = 0000000000000000000000000001357;
const String _videoIdthree = 'https://youtu.be/PLDFgKzWy3o?t=';
const double _startSecondsthree = 000000000000000000000000000209;
const String _videoIdfour = 'https://youtu.be/Zb5IH57SorQ?t=';
const double _startSecondsfour = 00000000000000000000000000097;
const String _videoIdfive = 'https://youtu.be/LrWv8-NEwV8?t=';
const double _startSecondsfive = 000000000000000000000000000125;
