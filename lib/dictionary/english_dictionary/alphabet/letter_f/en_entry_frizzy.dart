...
class EnglishEntryfrizzy extends StatefulWidget {
  const EnglishEntryfrizzy({super.key});

  @override
  State<EnglishEntryfrizzy> createState() => _EnglishEntryfrizzyState();
}

class _EnglishEntryfrizzyState extends State<EnglishEntryfrizzy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: frizzy (Derived forms: frizziest, frizzier)
1. (of hair) in small tight curls (= crisp, frizzly, kinky, nappy)
""",
  );

  final String keyword = "frizzy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The rain made my hair go frizzy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frizzy""",
                      // alsoEnglishWord: "also: frizzy",
                      britshText: """IpaUK: /ˈfrɪzi/""",
                      americanText: """IpaUS: /ˈfrɪzi/""",
...
// With short examples define "frizzy", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The rain made my hair go frizzy.""",
                      kurdishText: """بارانەکە قژمی تێکدا.""",
...
const String _videoIdone = 'https://youtu.be/PcHuTobEHyQ?t=';
const double _startSecondsone = 00000000000000000000000000060;
const String _videoIdtwo = 'https://youtu.be/5adR9CcyJgg?t=';
const double _startSecondstwo = 000000000000000000000000000283;
const String _videoIdthree = 'https://youtu.be/-z-Zn00n6lA?t=';
const double _startSecondsthree = 000000000000000000000000000537;
const String _videoIdfour = 'https://youtu.be/1OceijOEVqU?t=';
const double _startSecondsfour = 000000000000000000000000000138;
const String _videoIdfive = 'https://youtu.be/MNq7Gf6910k?t=';
