...
// replace these: replace EnglishEntryally - replace speakAlly - replace ally - /ˈælaɪ/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryally extends StatelessWidget {
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "ally"), // DOPSUM: CHANGE WORD ENTRY - Find /ˈælaɪ/
                            // nothing heereee
                        ...
                        Row(
                          children: [
                            ...
                            CustomIconButtonBritish(
                              onPressed: () =>
                                  speakAlly(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
