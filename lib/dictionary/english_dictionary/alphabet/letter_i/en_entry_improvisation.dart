...
class EnglishEntryimprovisation extends StatefulWidget {
  const EnglishEntryimprovisation({super.key});

  @override
  State<EnglishEntryimprovisation> createState() =>
      _EnglishEntryimprovisationState();
}

class _EnglishEntryimprovisationState extends State<EnglishEntryimprovisation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: improvisation (Derived forms: improvisations)
1. A creation spoken, written or composed extemporaneously (without prior preparation)
 
2. An unplanned expedient (- temporary expedient)
 
3. A performance given extempore without planning or preparation (- extemporization, extemporisation [Brit], improv [informal], impro [informal])
""",
  );

  final String keyword = "improvisation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""improvisation""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""There are classes in movement, dance, and improvisation.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000948;
    const String videoIdone = 'https://youtu.be/hkO8qXCFYWA?t=';
    const double startSecondsone = 000000000000000000000000000891;
    const String videoIdtwo = 'https://youtu.be/9mgwZASlFvw?t=';
    const double startSecondstwo = 000000000000000000000000000311;
    const String videoIdthree = 'https://youtu.be/w_kRA9Qe1w0?t=';
    const double startSecondsthree = 000000000000000000000000000587;
    const String videoIdfour = 'https://youtu.be/srksXVEkfAs?t=';
    const double startSecondsfour = 0000000000000000000000000001955;
    const String videoIdfive = 'https://youtu.be/6BTJ7feX0aQ?t=';
    const double startSecondsfive = 000000000000000000000000000326;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """improvisation""",
                      // alsoEnglishWord: "also: improvisation",
                      britshText: """IpaUK: /ˌɪmprəvaɪˈzeɪʃn/""",
                      americanText: """IpaUS: /ɪmˌprɑːvəˈzeɪʃn/""",
...
کوردی: بێ‌ئامادەکاری، سەرپێیی، خۆوێژی، سەرهەم‌بەندی
"""),
// With short examples define "improvisation", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کاری میوزیکدانان، قسەکردن لە شانۆ، هتد بەبێ ئامادەکاری پێشوەختە"""),
                    SentencesRow(
                      englishText:
                          """There are classes in movement, dance, and improvisation.""",
                      kurdishText:
                          """وانە هەیە بۆ جووڵە، سەما، و خۆگونجاندن.""",
