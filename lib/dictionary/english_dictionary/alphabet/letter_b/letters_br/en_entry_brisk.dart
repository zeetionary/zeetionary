...
// blank divider
  ...
  Future<void> speakbrisks1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Ice-cream vendors were doing a brisk trade.");
  }
  ...
  Future<void> speakbrisks2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("We went for a brisk walk before lunch.");
  }
  ...
  Future<void> speakbrisks3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Her tone on the phone was brisk and businesslike.");
  }
  ...
  Future<void> speakbrisks4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("A a brisk wind started once we got into the island.");
  }
  ...
  Future<void> speakbrisks5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbrisks55");
  }
  ...
  Future<void> speakbrisks6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbrisks66");
  }
  ...
  Future<void> speakbrisks7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbrisks77");
  }
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'eq3zolkk-DU';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'HAZlPuL3Qhw';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '9eE7yFxKkyM';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = '0KpxLSC1esI';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'Bn6xAR7FLQc';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = '3EHQ_a1334c';
  final double _startSeconds = 328;
