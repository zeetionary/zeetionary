...
class EnglishEntryharmonious extends StatefulWidget {
  const EnglishEntryharmonious({super.key});

  @override
  State<EnglishEntryharmonious> createState() => _EnglishEntryharmoniousState();
}

class _EnglishEntryharmoniousState extends State<EnglishEntryharmonious> {
  @override
  void initState() {
    super.initState();
...
2. Exhibiting equivalence or correspondence among constituents of an entity or between different entities (- proportionate, symmetrical)
...
""",
  ...
  final String keyword = "harmonious";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""harmonious""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harmonious""",
                      // alsoEnglishWord: "also: harmonious",
                      britshText: """IpaUK: /hɑːˈməʊniəs/""",
                      americanText: """IpaUS: /hɑːrˈməʊniəs/""",
...
const double _startSecondsend = 000000000000000000000000000206;
const String _videoIdone = 'https://youtu.be/wJa5Ch0O4BI?t=';
const double _startSecondsone = 0000000000000000000000000004118;
const String _videoIdtwo = 'https://youtu.be/Jz6l-w7a8N8?t=';
const double _startSecondstwo = 000000000000000000000000000551;
const String _videoIdthree = 'https://youtu.be/zj6p5kYnPPY?t=';
const double _startSecondsthree = 000000000000000000000000000611;
const String _videoIdfour = 'https://youtu.be/m-gYY5cR8M8?t=';
const double _startSecondsfour = 0000000000000000000000000001883;
const String _videoIdfive = 'https://youtu.be/Unl1jXFnzgo?t=';
const double _startSecondsfive = 000000000000000000000000000160;
