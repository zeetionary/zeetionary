...
class EnglishEntryhaltingly extends StatefulWidget {
  const EnglishEntryhaltingly({super.key});

  @override
  State<EnglishEntryhaltingly> createState() => _EnglishEntryhaltinglyState();
}

class _EnglishEntryhaltinglyState extends State<EnglishEntryhaltingly> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "haltingly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""haltingly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She walks haltingly toward him.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """haltingly""",
                      // alsoEnglishWord: "also: haltingly",
                      britshText: """IpaUK: /ˈhɔːltɪŋli/,  /ˈhɒltɪŋli/""",
                      americanText: """IpaUS: /ˈhɔːltɪŋli/""",
...
// With short examples define "haltingly", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بە نابەدڵییەوە چوو بۆ لای.""",
