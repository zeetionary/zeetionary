...
class EnglishEntryflashlight extends StatefulWidget {
  const EnglishEntryflashlight({super.key});

  @override
  State<EnglishEntryflashlight> createState() => _EnglishEntryflashlightState();
}

class _EnglishEntryflashlightState extends State<EnglishEntryflashlight> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flashlight (Derived forms: flashlights)
1. A small portable battery-powered electric lamp (= torch [Brit])
 
2. A lamp for providing momentary light to take a photograph (= flash, photoflash [rare], flash lamp, flashgun, flashbulb [archaic], flash bulb [archaic])
 
3. A light that flashes, e.g. in a lighthouse
""",
  );

  final String keyword = "flashlight";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flashlight""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He shone a flashlight in the boy’s face.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Neesha pointed her flashlight at the floor.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flashlight""",
                      // alsoEnglishWord: "also: flashlight",
                      britshText: """IpaUK: /ˈflæʃlaɪt/""",
                      americanText: """IpaUS: /ˈflæʃlaɪt/""",
...
کوردی: 
"""),
// With short examples define "flashlight", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) لایتێکی کارەبایی کە لەگەڵ خۆت هەڵی دەگریت"""),
                    SentencesRow(
                      englishText:
                          """He shone a flashlight in the boy’s face.""",
                      kurdishText:
                          """فلاشلایتێکی ئاراستەی ڕووخساری کوڕەکە کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """نیشا فلاشلایتەکەی لە دەرگاکە گرت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/1Up20_cLdVQ?t=';
const double _startSecondsend = 000000000000000000000000000233;
const String _videoIdone = 'https://youtu.be/GjMmsEwIcl0?t=';
const double _startSecondsone = 000000000000000000000000000175;
const String _videoIdtwo = 'https://youtu.be/737Xp2J2KSs?t=';
...
const double _startSecondsfour = 000000000000000000000000000676;
const String _videoIdfive = 'https://youtu.be/PkUg89kLLBE?t=';
