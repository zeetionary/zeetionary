...
class EnglishEntryfundamentally extends StatefulWidget {
  const EnglishEntryfundamentally({super.key});

  @override
  State<EnglishEntryfundamentally> createState() =>
      _EnglishEntryfundamentallyState();
}

class _EnglishEntryfundamentallyState extends State<EnglishEntryfundamentally> {
  @override
  void initState() {
    super.initState();
...
1. In essence; at bottom or by one's (or its) very nature (- basically, essentially)
"He is fundamentally dishonest";
""",
  );

  final String keyword = "fundamentally";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fundamentally""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The two approaches are fundamentally different.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""By the 1960s the situation had changed fundamentally.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fundamentally""",
                      // alsoEnglishWord: "also: fundamentally",
                      britshText: """IpaUK: /ˌfʌndəˈmentəli/""",
                      americanText: """IpaUS: /ˌfʌndəˈmentəli/""",
...
// With short examples define "fundamentally", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) کە هەموو لایەنێکەوە کە گرنگ بێت"""),
                    SentencesRow(
                      englishText:
                          """The two approaches are fundamentally different.""",
                      kurdishText: """دوو ڕێگاکە لە بنەڕەتدا جیاوازن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تاوەکو ١٩٦٠ ـەکان دۆخەکە بە بنچینەیی گۆڕا بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Fundamentally, there are two different approaches to the problem.""",
                      kurdishText:
                          """بە شێوەیەکی سەرەکی، دوو ڕێگای چارەسەری کێشەکە هەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She is fundamentally a nice person, but she finds it difficult to communicate.""",
                      kurdishText:
                          """بە شێوەیەکی سەرەکی کەسێکی باشە، بەڵام بە سەختی دەبینێت گفتوگۆ بکات.""",
...
const double _startSecondstwo = 0000000000000000000000000002777;
const String _videoIdthree = 'https://youtu.be/b_rjBWmc1iQ?t=';
const double _startSecondsthree = 000000000000000000000000000497;
const String _videoIdfour = 'https://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondsfour = 0000000000000000000000000005479;
const String _videoIdfive = 'https://youtu.be/86Gy035z_KA?t=';
