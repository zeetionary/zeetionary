...
class EnglishEntrylullaby extends StatefulWidget {
  const EnglishEntrylullaby({super.key});

  @override
  State<EnglishEntrylullaby> createState() => _EnglishEntrylullabyState();
}

class _EnglishEntrylullabyState extends State<EnglishEntrylullaby> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylullaby lullaby
WORD_WEB lullaby lullaby lullaby
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lullaby";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lullaby""");
  }
...
کوردی: 
"""),
// With short examples define "lullaby", please follow LX instructions
