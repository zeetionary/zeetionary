...
class EnglishEntryactively extends StatefulWidget {
  const EnglishEntryactively({super.key});

  @override
  State<EnglishEntryactively> createState() => _EnglishEntryactivelyState();
}

class _EnglishEntryactivelyState extends State<EnglishEntryactively> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""actively""");
  }
  ...
  Future<void> speakactiv2537(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Your proposal is being actively considered.");
  }
  ...
  Future<void> speakact2534(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("She was actively looking for a job.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """actively""",
                      // alsoEnglishWord: "also: actively",
                      britshText: """IpaUK: /ˈæktɪvli/""",
                      americanText: """IpaUS: /ˈæktɪvli/""",
