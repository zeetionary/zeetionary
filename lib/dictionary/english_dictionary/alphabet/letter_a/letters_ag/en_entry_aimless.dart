...
// replace these: replace EnglishEntryaimless - replace speakAimless - replace aimless - /ˈeɪmləs/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaimless extends StatelessWidget {
  EnglishEntryaimless({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAimless(String languageCode) async {
    // DOPSUM: CHANGE speakAimless
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("aimless"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAimless25388(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("My life seemed aimless."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAimless4277(String languageCode) async {
    ...
    await flutterTts.speak(
        "She said that her life seemed aimless after her children left home."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "aimless", // DOPSUM: CHANGE WORD ENTRY - Find /ˈeɪmləs/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈeɪmləs/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˈeɪmləs/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '-Ny30jie9lU';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '0tm1d0z_Zzw';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'v3r_0BqTH10';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'ZC22ceaQuX8';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'bTOkCOKIVeY';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = '190emwcnYJ4';
