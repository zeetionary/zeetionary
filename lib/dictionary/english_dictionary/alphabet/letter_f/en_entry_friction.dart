...
class EnglishEntryfriction extends StatefulWidget {
  const EnglishEntryfriction({super.key});

  @override
  State<EnglishEntryfriction> createState() => _EnglishEntryfrictionState();
}

class _EnglishEntryfrictionState extends State<EnglishEntryfriction> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: friction (Derived forms: frictions)
1. A state of conflict between persons (= clash)
 
2. The resistance encountered when one body is moved in contact with another (= rubbing)
 
3. Effort expended in moving one object over another with pressure (= detrition, rubbing)
""",
  );

  final String keyword = "friction";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""friction""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His decision led to considerable friction in his family.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There's a lot of friction between my wife and my mother.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """friction""",
                      // alsoEnglishWord: "also: friction",
                      britshText: """IpaUK: /ˈfrɪkʃn/""",
                      americanText: """IpaUS: /ˈfrɪkʃn/""",
...
// With short examples define "friction", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) خشانی شتێک بە شتێکی دیکەدا؛ ئەو هێزەی کە وا دەکات شتێک بخشێت بە ڕووی شتێکی دیکەدا یان بەناو شلە یان گاز تێپەڕێت"""),
                    SentencesRow(
                      englishText:
                          """Friction between moving parts had caused the engine to overheat.""",
                      kurdishText:
                          """لێک‌خشانی بەشەکان بووبوو بە هۆکاری ئەوەی بزوێنەرەکە گەرم ببێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """When you rub your hands together the friction produces heat.""",
                      kurdishText:
                          """کە دەستەکانت دەخشێنیت بە یەکدا لێکخشانەکە گەرمی درووست دەکات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) نەبوونی تێگەشتن و ڕێککەوتن لە نێوان ئەو کەسانەی کە بۆچوونی جیاوازیان هەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """His decision led to considerable friction in his family.""",
                      kurdishText:
                          """بڕیارەکەی بوو بە هۆکاری ناکۆکی زۆر لە خێزانەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ململانێی زۆر هەیە لە نێوان ژنەکەم و دایکم.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/58XEfDtU0Z4?t=';
const double _startSecondsend = 0000000000000000000000000001435;
const String _videoIdone = 'https://youtu.be/3RkhZgRNC1k?t=';
const double _startSecondsone = 0000000000000000000000000001377;
const String _videoIdtwo = 'https://youtu.be/DxL2HoqLbyA?t=';
const double _startSecondstwo = 000000000000000000000000000243;
const String _videoIdthree = 'https://youtu.be/_TM3lnF58Hc?t=';
...
const String _videoIdfive = 'https://youtu.be/-RjJtO51ykY?t=';
