...
class EnglishEntrygentle extends StatefulWidget {
  const EnglishEntrygentle({super.key});

  @override
  State<EnglishEntrygentle> createState() => _EnglishEntrygentleState();
}

class _EnglishEntrygentleState extends State<EnglishEntrygentle> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Terry was a gentle soul.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was the gentlest of nurses.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Be gentle with her!""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was very gentle with the children.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The professor gave a gentle smile.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Cook over a gentle heat.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The doctor recommended a little gentle exercise.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This soap is very gentle on the hands.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gentle""",
                      // alsoEnglishWord: "also: gentle",
                      britshText: """IpaUK: /ˈdʒentl/""",
                      americanText: """IpaUS: /ˈdʒentl/""",
...
// With short examples define "gentle", please follow LX instructions
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Be gentle with her!""",
                      kurdishText: """ئاگاداری بە!""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She was very gentle with the children.""",
                      kurdishText: """زۆر لەسەرەخۆ بوو لەگەڵ منداڵەکان.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """This soap is very gentle on the hands.""",
                      kurdishText: """ئەم سابوونە زۆر نەرمە لەسەر دەست.""",
...
const double _startSecondsone = 0000000000000000000000000001662;
const String _videoIdtwo = 'https://youtu.be/47MNn4bsmSw?t=';
const double _startSecondstwo = 0000000000000000000000000004403;
const String _videoIdthree = 'https://youtu.be/AvdIqDP0wbo?t=';
const double _startSecondsthree = 000000000000000000000000000380;
const String _videoIdfour = 'https://youtu.be/Xz2f5qiYzJw?t=';
const double _startSecondsfour = 00000000000000000000000000090;
const String _videoIdfive = 'https://youtu.be/1Tor0LDdVKY?t=';
const double _startSecondsfive = 00000000000000000000000000060;
