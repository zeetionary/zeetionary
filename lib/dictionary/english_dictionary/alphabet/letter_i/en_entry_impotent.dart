...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '36erMl7IgRo';
    const double startSecondsend = 736;
    const String videoIdone = 'vMtwL1lb2_A';
    const double startSecondsone = 2769;
    const String videoIdtwo = '5oGU_8pzigU';
    const double startSecondstwo = 237;
    const String videoIdthree = 'wFtEzyB2uJk';
    const double startSecondsthree = 5197;
    const String videoIdfour = 'i03Jvbxyluk';
    const double startSecondsfour = 824;
    const String videoIdfive = '-9LFSZYiROY';
