...
// replace these: EnglishEntryabolition - speakAbolition - abolition - /ˌæbəˈlɪʃn/

enum TtsState { playing }

class EnglishEntryabolition extends StatelessWidget {
  EnglishEntryabolition({super.key});
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "abolition"), // DOPSUM: CHANGE WORD ENTRY
                          ],
                        ),
                        Row(
                          children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /ˌæbəˈlɪʃn/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '3OED5hnqohY';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'otpq6oI2Q';
  ...
  final YoutubePlayerController _controller = YoutubePlayerController(
    ...
    flags: const YoutubePlayerFlags(
      ...
      loop: true,
      mute: false,
      startAt: 34923, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
    ),
  );
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'smnvJGzOkhU';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'RyMgQS-Hi3w';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'uNsxCU0glHw';
