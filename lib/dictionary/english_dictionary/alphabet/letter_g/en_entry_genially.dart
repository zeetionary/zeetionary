...
class EnglishEntrygenially extends StatefulWidget {
  const EnglishEntrygenially({super.key});

  @override
  State<EnglishEntrygenially> createState() => _EnglishEntrygeniallyState();
}

class _EnglishEntrygeniallyState extends State<EnglishEntrygenially> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""genially""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He smiled genially.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The evening began genially and informally.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """genially""",
                      // alsoEnglishWord: "also: genially",
                      britshText: """IpaUK: /ˈdʒiːniəli/""",
                      americanText: """IpaUS: /ˈdʒiːniəli/""",
...
// With short examples define "genially", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """He smiled genially.""",
                      kurdishText: """دۆستانە پێکەنی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئێوارەکە بە دۆستانە و نافەرمی دەستی پێکرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/-nmNaja6K5k?t=';
const double _startSecondsend = 000000000000000000000000000376;
const String _videoIdone = 'https://youtu.be/6_z_lUNPDE8?t=';
const double _startSecondsone = 000000000000000000000000000295;
const String _videoIdtwo = 'https://youtu.be/ftCls6ZXksY?t=';
const double _startSecondstwo = 000000000000000000000000000678;
const String _videoIdthree = 'https://youtu.be/-fZQOuZSU_E?t=';
const double _startSecondsthree = 000000000000000000000000000294;
const String _videoIdfour = 'https://youtu.be/2X67zX12gS8?t=';
const double _startSecondsfour = 0000000000000000000000000006408;
const String _videoIdfive = 'https://youtu.be/5Fuplg6MhPQ?t=';
const double _startSecondsfive = 0000000000000000000000000004231;
