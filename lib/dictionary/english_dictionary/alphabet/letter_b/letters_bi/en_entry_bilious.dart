...
// Define the word "bilious" and provide five simple example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings or more.

// replace bilious - replace EnglishEntrybilious

// replace speakBilious - /ˈbɪliəs/

enum TtsState { playing }

class EnglishEntrybilious extends StatelessWidget {
// blank divider
  EnglishEntrybilious({super.key});
// blank divider
  ...
  Future<void> speakBiliouss7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBiliouss77"); // DOPSUM: CHANGE TEXT
  }
...
کوردی: هەڵتوزێن، بەدخوڵک، جینگزی، بەدخوو، سەربە زراو، زەردڕەنگ، بێزەون، قێزەون، ڕشێنەرەوە

١. (ھاوەڵناو) هەست بکەیت کە دەڕشێیتەوە"""),
                          Row(
                            children: [
                              ...
                              const ExampleSentenceKurdish(
                                  text:
                                      "هەندێک هەستم بە ڕشانەوە دەکرد لە دوای نانی ئێوارەی دوێنێ شەو."),
...
٣. (ھاوەڵناو) """),
                          Row(
                            children: [
                              ...
                              const ExampleSentenceKurdish(
                                  text:
                                      "لە خەو هەستا و هەستی بە تووڕەیی دەکرد."),
                              const CustomSizedBoxForTTS(),
                              CustomIconButtonBritish(
      ...
      child: Column(
        ...
        children: [
          ...
          EnglishMeaningConst(
            text: """
- Adjective: bilious
1. Suffering from or suggesting a liver disorder or gastric distress (= liverish, livery)
 
2. Irritable as if suffering from indigestion (= atrabilious, dyspeptic, liverish)
"bilious female semi-celebs of a certain age";
 
3. Relating to or containing bile (= biliary)
""",
          )
        ],
      ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/cfOSmkPjuMo?t=";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/LrUbqcBYx6s?t=";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/mHD8R1Dr8-A?t=";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/ZE4VBHVrLM8?t=";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/oqoWqn4h3tw?t=";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/ZiJ8N-YRl6U?t=";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/KGmMJxV4kUc?t=";

  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 14300, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
      autoPlay: true,
      enableCaption: true,
      loop: true,
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/CI4la-iV4RY?t=";

  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 1948, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
      autoPlay: true,
      enableCaption: true,
      loop: true,
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/jZk9vpJkeNA?t=";

  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 6364, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
      autoPlay: true,
      enableCaption: true,
      loop: true,
...
// end bilious// TODO Implement this library.
