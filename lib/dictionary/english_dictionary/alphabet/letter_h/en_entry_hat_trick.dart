...
class EnglishEntryhattrick extends StatefulWidget {
  const EnglishEntryhattrick({super.key});

  @override
  State<EnglishEntryhattrick> createState() => _EnglishEntryhattrickState();
}

class _EnglishEntryhattrickState extends State<EnglishEntryhattrick> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hat-trick (Derived forms: hat tricks)
1. (sport) three consecutive scores by one player or three scores in one game (as in cricket or ice hockey etc.)
""",
  );

  final String keyword = "hat-trick";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hat-trick""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Goal! Fowler makes it a hat trick!""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hat-trick""",
                      // alsoEnglishWord: "also: hat-trick",
                      britshText: """IpaUK: /ˈhæt trɪk/""",
                      americanText: """IpaUS: /ˈhæt trɪk/""",
...
// کوردی:
// """),
// With short examples define "hat-trick", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) سێ گۆڵ لەلایەن یەک یاریزان لە یارییەک"""),
                    SentencesRow(
                      englishText: """Goal! Fowler makes it a hat trick!""",
                      kurdishText: """گۆڵ! فاوڵەر هاتریکی کرد!""",
...
const String _videoIdone = 'https://youtu.be/6781XugwQrA?t=';
const double _startSecondsone = 000000000000000000000000000583;
const String _videoIdtwo = 'https://youtu.be/Szb3H5n62H8?t=';
const double _startSecondstwo = 000000000000000000000000000521;
const String _videoIdthree = 'https://youtu.be/7WtsemKE8Rw?t=';
const double _startSecondsthree = 0000000000000000000000000001264;
const String _videoIdfour = 'https://youtu.be/HDXj6jiCeis?t=';
const double _startSecondsfour = 000000000000000000000000000164;
const String _videoIdfive = 'https://youtu.be/fSQamlph1Vs?t=';
const double _startSecondsfive = 0000000000000000000000000001255;
