...
class EnglishEntryforeignexchange extends StatefulWidget {
  const EnglishEntryforeignexchange({super.key});

  @override
  State<EnglishEntryforeignexchange> createState() => _EnglishEntryforeignexchangeState();
}

class _EnglishEntryforeignexchangeState extends State<EnglishEntryforeignexchange> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foreign exchange""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The euro fell on the foreign exchanges yesterday.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: foreign exchange",
                      britshText: """IpaUK: /ˌfɒrən ɪksˈtʃeɪndʒ/""",
                      americanText: """IpaUS: /ˌfɔːrən ɪksˈtʃeɪndʒ/""",
...
// With short examples define "foreign exchange", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) سیستەمی ئاڵووگۆڕی دراو؛ شوێنێک کە لێی دەتوانیت دراو بگۆڕیتەوە"""),
                    SentencesRow(
                      englishText:
                          """The euro fell on the foreign exchanges yesterday.""",
                      kurdishText: """یۆرۆ دوێنی لە بازاڕی ئاڵووگۆڕ دابەزی.""",
...
const double _startSecondsone = 000000000000000000000000000501;
const String _videoIdtwo = 'https://youtu.be/rPExiTCnLio?t=';
const double _startSecondstwo = 0000000000000000000000000001105;
const String _videoIdthree = 'https://youtu.be/rwoPd2MHEh0?t=';
const double _startSecondsthree = 000000000000000000000000000500;
const String _videoIdfour = 'https://youtu.be/ZeQkzCloCaM?t=';
const double _startSecondsfour = 000000000000000000000000000186;
const String _videoIdfive = 'https://youtu.be/W5zxYDHwf-Y?t=';
