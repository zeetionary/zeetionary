...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I just got a glimpse at the baby, but she was very cute.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Take a glimpse into the future of rail travel.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He'd glimpsed her through the window as he passed.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Anne is glimpsed briefly at the beginning of the film.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Suddenly she glimpsed the truth about her sister.""");
  }
...
// With short examples define "glimpse", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەنھا بە کەمی کۆرپەکەم بینی، بەڵام زۆر ژیکەڵە بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Fans crowded the street outside waiting for a glimpse of their hero.""",
                      kurdishText:
                          """ھەواداران لە شەقامەکانی دەرەوە کۆبووبوونەوە بۆ سووکە بینینێکی پاڵەوانەکەیان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The programme gives us a rare glimpse of a great artist at work.""",
                      kurdishText:
                          """بەرنامەکە دەرفەتێکی دەگمەنمان پێدەدات بۆ بینینی ھونەرمەندێکی مەزن لە کاتی کارکردندا..""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سەیرێکی داھاتووی گەشتکردن بە شەمەندەفەر بکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئان بۆ کەمێک دەبیندرێت لە سەرەتای فیلمەکەدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لەناکاو ڕاستییەکە لەسەر خوشکەکەی تێگەشت.""",
...
const String _videoIdone = '9VsDP584zyQ?t=';
const double _startSecondsone = 402;
const String _videoIdtwo = 'Fr-qagv7ig0?t=';
const double _startSecondstwo = 1094;
const String _videoIdthree = 'HxRUuGqqMG4?t=';
const double _startSecondsthree = 1524;
const String _videoIdfour = 'OOg-4mtA3Zo?t=';
const double _startSecondsfour = 1445;
const String _videoIdfive = 'qg2nGY1aqlg?t=';
const double _startSecondsfive = 879;
