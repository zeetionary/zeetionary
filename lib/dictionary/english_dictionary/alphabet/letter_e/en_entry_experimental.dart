...
class EnglishEntryexperimental extends StatefulWidget {
  const EnglishEntryexperimental({super.key});

  @override
  State<EnglishEntryexperimental> createState() =>
      _EnglishEntryexperimentalState();
}

class _EnglishEntryexperimentalState extends State<EnglishEntryexperimental> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""experimental""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """experimental""",
                      // alsoEnglishWord: "also: experimental",
                      britshText: """IpaUK: /ɪkˌsperɪˈmentl/""",
                      americanText: """IpaUS: /ɪkˌsperɪˈmentl/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The equipment is still at the experimental stage.""");
  }
...
کوردی: تاقی‌کردنەوەیی، تاقی‌گەری‌یانە، ئاروینی، تاقی‌کاری‌یانە، ئەزموونی،	تاقیگەیی، توێژینگەیی،	کردەوەیی، کرداری،	نوێ، تازە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) پشتبەستوو بە بیرۆکە، جۆر، یان ڕێگای تازە کە ئامانج لێیان زانینی کاریگەرییە"""),
          SentencesRow(
            englishText:
                """The school's experimental teaching methods include letting the children decide what to study.""",
            kurdishText:
                """ڕێگا تاقیکارییەکانی وانەگوتنەوەی قوتابخانەکە ئەوە لەخۆدەگرێت ڕێگا بە قوتابیان بدەن کە چی دەخوێنن.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ئامێرەکە هێشتا لە قۆناغی تاقیکارییە.""",
          ...
          SentencesRow(
            englishText:
                """Doctors stress that this kind of treatment is still experimental.""",
            kurdishText:
                """پزیشکان جەختدەکەنەوە ئەم چارەسەرە هێشتا تاقیکارییە.""",
          ...
          SentencesRow(
            englishText:
                """Experimental data suggests that cholesterol may play a role in the disease.""",
            kurdishText:
                """داتای زانستی ئاماژە بەوە دەکات کە کۆلێسترۆڵ ڕەنگە ڕۆڵی هەبێت لە نەخۆشییەکەدا.""",
...
2. Relying on observation or experiment (= data-based, observational)
...
const double _startSecondsend = 000000000000000000000000000000; // 325;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/LBSFeJ1WLv4?t=';
const double _startSecondsone = 00000000000000000000000000000; // 211;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/TRGHIN2PGIA?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1153;
const String _videoIdthree = 'VIDEOhttps://youtu.be/Xzv84ZdtlE0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 69;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/L1kYZHnHS0E?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 293;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/1lTYPvArbGo?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 92;
