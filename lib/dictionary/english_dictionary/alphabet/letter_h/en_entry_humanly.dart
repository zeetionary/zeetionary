...
class EnglishEntryhumanly extends StatefulWidget {
  const EnglishEntryhumanly({super.key});

  @override
  State<EnglishEntryhumanly> createState() => _EnglishEntryhumanlyState();
}

class _EnglishEntryhumanlyState extends State<EnglishEntryhumanly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: humanly
1. In the manner of human beings
"humanly possible"
""",
  );

  final String keyword = "humanly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""humanly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The doctors did all that was humanly possible.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He couldn't humanly refuse to help her.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000390;
    const String videoIdone = 'https://youtu.be/jTRC_FMzLoo?t=';
    const double startSecondsone = 000000000000000000000000000987;
    const String videoIdtwo = 'https://youtu.be/bfIi0gpyVFg?t=';
    const double startSecondstwo = 0000000000000000000000000006;
    const String videoIdthree = 'https://youtu.be/U6OhuqD4w1k?t=';
    const double startSecondsthree = 0000000000000000000000000001277;
    const String videoIdfour = 'https://youtu.be/RYibowrZJeg?t=';
    const double startSecondsfour = 000000000000000000000000000510;
    const String videoIdfive = 'https://youtu.be/p-q1GTtH4LE?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """humanly""",
                      // alsoEnglishWord: "also: humanly",
                      britshText: """IpaUK: /ˈhjuːmənli/""",
                      americanText: """IpaUS: /ˈhjuːmənli/""",
...
// With short examples define "humanly", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پزیشکەکان هەموو شتێکیان کرد کە لە توانای مرۆڤ بێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """نەیدەتوانی بە مرۆڤییەتی خۆی ڕەتی بکاتەوە یارمەتی بدات.""",
