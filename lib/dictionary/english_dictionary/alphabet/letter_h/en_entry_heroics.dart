...
class EnglishEntryheroics extends StatefulWidget {
  const EnglishEntryheroics({super.key});

  @override
  State<EnglishEntryheroics> createState() => _EnglishEntryheroicsState();
}

class _EnglishEntryheroicsState extends State<EnglishEntryheroics> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heroics
1. Ostentatious, vainglorious, extravagant or melodramatic conduct
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heroics""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Remember, no heroics, we just go in there and do our job.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heroics""",
                      // alsoEnglishWord: "also: heroics",
                      britshText: """IpaUK: /həˈrəʊɪks/""",
                      americanText: """IpaUS: /həˈrəʊɪks/""",
...
کوردی: قارەمان‌بازی، خۆهەڵکێشان، پەڵەوان‌بازاڕی، قارەمان‌گەری
"""),
// With short examples define "heroics", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) قسەکردن، ڕەفتار، و کاری گەمژانە و مەترسیدار کە تەنها بۆ ئەوەن کەسانی دیکە سەرسامت بن"""),
                    SentencesRow(
                      englishText:
                          """Remember, no heroics, we just go in there and do our job.""",
                      kurdishText:
                          """بیرت نەچێت، بەبێ خۆهەڵکێشان، تەنها دەچینە ئەوێ و کارەکەمان دەکەین.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) کرداری بوێرانە و شێلگیرانە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Thanks to Bateman's heroics in the second half, the team won 2–0.""",
                      kurdishText:
                          """سوپاس بۆ هەوڵی قارەمانانەی بایتمان لە نیوەی دووەم، تیمەکە بە ٢ - ٠ بردییەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/FQVRIrXOJ_Q?t=';
const double _startSecondsend = 000000000000000000000000000203;
const String _videoIdone = 'https://youtu.be/CCrtZwF2C-8?t=';
const double _startSecondsone = 000000000000000000000000000130;
const String _videoIdtwo = 'https://youtu.be/3lUiKhajVFs?t=';
const double _startSecondstwo = 000000000000000000000000000381;
const String _videoIdthree = 'https://youtu.be/plRER8tLCo4?t=';
const double _startSecondsthree = 000000000000000000000000000255;
const String _videoIdfour = 'https://youtu.be/eO-PqYnTQXs?t=';
const double _startSecondsfour = 000000000000000000000000000555;
const String _videoIdfive = 'https://youtu.be/ZbYInUMpkqs?t=';
const double _startSecondsfive = 000000000000000000000000000502;
