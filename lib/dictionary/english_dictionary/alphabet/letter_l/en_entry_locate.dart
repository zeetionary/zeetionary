...
class EnglishEntrylocate extends StatefulWidget {
  const EnglishEntrylocate({super.key});

  @override
  State<EnglishEntrylocate> createState() => _EnglishEntrylocateState();
}

class _EnglishEntrylocateState extends State<EnglishEntrylocate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: locate (Derived forms: located, locates, locating)
1. Discover the location of; determine the place of; find by searching or examining (- turn up)
"Can you locate your cousins in the Midwest?";
 
2. Determine or indicate the place, site, or limits of, as if by an instrument or by a survey (- situate)
"Locate the boundaries of the property"; "Our sense of sight enables us to locate objects in space";
 
3. Assign a location to (- place, site)
"The company located some of their agents in Los Angeles";
 
4. Take up residence and become established (- settle)
"The immigrants located in the Midwest";
""",
  );

  final String keyword = "locate";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Rescue planes are trying to locate the missing sailors.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We tried to locate the source of the sound.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They located their headquarters in Swindon.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/Js2UoMSumx4?t=637';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/Fr-qagv7ig0?t=1294';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/VrKW58MS12g?t=1025';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/S3ksC_8jGuc?t=496';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/83gLgmynvLM?t=59';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/YZoZr_m9WLU?t=108';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """locate""",
                      // alsoEnglishWord: "also: locate",
                      britshText: """IpaUK: /ləʊˈkeɪt/""",
                      americanText: """IpaUS: /ˈləʊkeɪt/""",
...
کوردی: 
"""),
// With short examples define "locate", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) دۆزینەوەی شوێنی درووستی کەسێک/شتێک"""),
                    SentencesRow(
                      englishText:
                          """Rescue planes are trying to locate the missing sailors.""",
                      kurdishText:
                          """فڕۆکە ڕزگارکەرەکان هەوڵ دەدەن بەلەمەوانە ونبووەکان بدۆزنەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەوڵمان دا سەرچاوەی دەنگەکە بدۆزینەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) دانان یان درووستکردنی شتێک لە شوێنێکی دیاریکراو"""),
                    const AlsoEnglishckb(word: "ھەروەھا: site"),
                    SentencesRow(
                      englishText:
                          """They located their headquarters in Swindon.""",
                      kurdishText: """بارەگاکەیانیان بردە سویندن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Locating offices directly next to the labs is preferred by most researchers.""",
                      kurdishText:
                          """دانانی ئۆفیس ڕێک لە تەنیشت تاقیگە لەلایەن زۆر توێژەرەوە پەسەند کراوە.""",
