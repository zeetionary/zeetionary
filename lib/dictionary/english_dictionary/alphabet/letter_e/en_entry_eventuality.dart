...
class EnglishEntryeventuality extends StatefulWidget {
  const EnglishEntryeventuality({super.key});

  @override
  State<EnglishEntryeventuality> createState() =>
      _EnglishEntryeventualityState();
}

class _EnglishEntryeventualityState extends State<EnglishEntryeventuality> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""eventuality""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """eventuality""",
                      // alsoEnglishWord: "also: eventuality",
                      britshText: """IpaUK: /ɪˌventʃuˈæləti/""",
                      americanText: """IpaUS: /ɪˌventʃuˈæləti/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "eventuality";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We were prepared for every eventuality.""");
  }
...
کوردی: ڕووداو، پێشهات، بوویەر،	ڕێ‌تێچوون، شیان، ئەگەر
"""),
          const DefinitionKurdish(
              text: """١. (ناو) شتێک کە ئەگەری هەیە ڕووبدات"""),
          SentencesRow(
            englishText: """We were prepared for every eventuality.""",
            kurdishText: """بۆ هەموو پێشهاتێک ئامادە بووین.""",
          ...
          SentencesRow(
            ...
            kurdishText: """پارەکە بۆ تەنها پێشهاتێکی ئاوا هەڵگیردرابوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: eventuality (Derived forms: eventualities)
1. A possible event, occurrence or result (= contingency, contingence)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/lsq-f_doKGI?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1949;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/uCM0Tvp6Dko?t=';
const double _startSecondsone = 00000000000000000000000000000; // 523;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/JMcmlEfLRa8?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 647;
const String _videoIdthree = 'VIDEOhttps://youtu.be/j1jkilao3MQ?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1153;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/GWghjoC59_A?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 213;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/lsq-f_doKGI?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1949;
