...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/gqibxjObZ-I?t=';
    const double startSecondsend = 00000000000000000000000000073;
    const String videoIdone = 'https://youtu.be/hOUGNGWmN0k?t=';
    const double startSecondsone = 0000000000000000000000000001258;
    const String videoIdtwo = 'https://youtu.be/Ys1EjAGzuDk?t=';
    const double startSecondstwo = 000000000000000000000000000283;
    const String videoIdthree = 'https://youtu.be/nDEyQB0Jjkw?t=';
    const double startSecondsthree = 0000000000000000000000000001617;
    const String videoIdfour = 'https://youtu.be/RJQPthD9rx8?t=';
    const double startSecondsfour = 000000000000000000000000000576;
    const String videoIdfive = 'https://youtu.be/uL911Qp9tDM?t=';
