...
class EnglishEntryfreight extends StatefulWidget {
  const EnglishEntryfreight({super.key});

  @override
  State<EnglishEntryfreight> createState() => _EnglishEntryfreightState();
}

class _EnglishEntryfreightState extends State<EnglishEntryfreight> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: freight (Derived forms: freights)
1. Goods carried by a large vehicle (= cargo, lading, load, loading, payload, shipment, consignment)
 
2. Transporting goods commercially at rates cheaper than express rates (= freightage)
 
3. The charge for transporting something by common carrier (= freightage, freight rate)
"we pay the freight"; "the freight rate is usually cheaper";

- Verb: freight (Derived forms: freighted, freights, freighting)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""freight""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""All vehicles carrying freight need a special permit.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She runs a freight business in southern Germany.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Grapes from this region are freighted all over the world.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """freight""",
                      // alsoEnglishWord: "also: freight",
                      britshText: """IpaUK: /freɪt/""",
                      americanText: """IpaUS: /freɪt/""",
...
کوردی: هەڵگرتن، بردن،	کرێ‌بار،	بار، کەل‌وپەل،	شەمەندەفەری بارهەڵگر یان باری
"""),
// With short examples define "freight", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەو کەلوپەلانەی کە دەگوازرێنەوە بە کەشتی، فڕۆکە، شەمەندەفەر، هتد؛ ئەو سیستەمەی بۆ ئەمە بەکاردێت"""),
                    SentencesRow(
                      englishText:
                          """All vehicles carrying freight need a special permit.""",
                      kurdishText:
                          """هەموو ئەو پێڕۆیانەی کە کەلوپەل دەگوازنەوە پێویستییان بە مۆڵەتی تایبەتی هەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بازرگانی گواستنەوەی کەلوپەلی هەیە لە باشووری ئەڵمانیا.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) گواستنەوەی کەلوپەل"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Grapes from this region are freighted all over the world.""",
                      kurdishText: """ترێی ئەم هەرێمە بۆ هەموو جیهان دەگوازرێتەوە.""",
...
const String _videoIdone = 'https://youtu.be/y__v0aEgzO0?t=';
const double _startSecondsone = 0000000000000000000000000001116;
const String _videoIdtwo = 'https://youtu.be/kw9Bd96c1ug?t=';
const double _startSecondstwo = 0000000000000000000000000001122;
const String _videoIdthree = 'https://youtu.be/7hGqq35EocY?t=';
const double _startSecondsthree = 00000000000000000000000000018;
const String _videoIdfour = 'https://youtu.be/u1h-jPizdv4?t=';
const double _startSecondsfour = 0000000000000000000000000003;
const String _videoIdfive = 'https://youtu.be/j4kI2h3iotA?t=';
const double _startSecondsfive = 0000000000000000000000000002301;
