...
class EnglishEntryideological extends StatefulWidget {
  const EnglishEntryideological({super.key});

  @override
  State<EnglishEntryideological> createState() => _EnglishEntryideologicalState();
}

class _EnglishEntryideologicalState extends State<EnglishEntryideological> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryideological ideological
WORD_WEB ideological ideological ideological
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200

  final String keyword = "ideological";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ideological""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ideological""",
                      // alsoEnglishWord: "also: ideological",
...
کوردی: 
"""),
// With short examples define "ideological", please follow LX instructions
