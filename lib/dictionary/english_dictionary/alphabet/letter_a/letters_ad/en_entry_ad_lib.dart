...
// replace these: replace EnglishEntryadlib - replace speakAdlib - replace ad lib - /ˌæd ˈlɪb/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadlib extends StatelessWidget {
  EnglishEntryadlib({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdlib(String languageCode) async {
    // DOPSUM: CHANGE speakAdlib
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("ad lib"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAdlib4587(String languageCode) async {
    // DOPSUM: CHANGE speakAdlib
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("She delivered her speech ad lib."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAdlib42587(String languageCode) async {
    // DOPSUM: CHANGE speakAdlib
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "I lost my notes and had to ad-lib the whole speech."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌæd ˈlɪb/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
2. Said or done without having been planned or written in advance (= spontaneous, unwritten)
...
- Verb: ad-lib (ad-libbed,ad-libbing)  ad lib
1. Perform without preparation (= improvise, improvize [non-standard], extemporize, extemporise [Brit], wing it [informal], wing [informal])
"he ad-libbed a speech at the wedding";
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'N4kvtt2T_6Y';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'rhL81MGXBRU';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '2pCRplUQVMI';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'Bv18cPFpb6w';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = '0w0AYg0c0xQ';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'QYigQmDriWw';
