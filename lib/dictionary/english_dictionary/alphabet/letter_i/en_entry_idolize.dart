...
class EnglishEntryidolize extends StatefulWidget {
  const EnglishEntryidolize({super.key});

  @override
  State<EnglishEntryidolize> createState() => _EnglishEntryidolizeState();
}

class _EnglishEntryidolizeState extends State<EnglishEntryidolize> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""idolize""");
  }
