...
class EnglishEntryhospitably extends StatefulWidget {
  const EnglishEntryhospitably({super.key});

  @override
  State<EnglishEntryhospitably> createState() => _EnglishEntryhospitablyState();
}

class _EnglishEntryhospitablyState extends State<EnglishEntryhospitably> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: hospitably
1. In a hospitable manner
"she was received hospitably by her new family"
""",
  );

  final String keyword = "hospitably";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hospitably""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He welcomed me most hospitably.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/xOM_ohW6FQc?t=';
    const double startSecondsend = 0000000000000000000000000001998;
    const String videoIdone = 'https://youtu.be/0tYm41hb48o?t=';
    const double startSecondsone = 0000000000000000000000000002027;
    const String videoIdtwo = 'https://youtu.be/grq9D0smW3w?t=';
    const double startSecondstwo = 000000000000000000000000000183;
    const String videoIdthree = 'https://youtu.be/YN79KeTqcls?t=';
    const double startSecondsthree = 000000000000000000000000000128;
    const String videoIdfour = 'https://youtu.be/V2qam7JV2as?t=';
    const double startSecondsfour = 000000000000000000000000000339;
    const String videoIdfive = 'https://youtu.be/5V99rjwncv0?t=';
    const double startSecondsfive = 00000000000000000000000000027440;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hospitably""",
                      // alsoEnglishWord: "also: hospitably",
                      britshText: """IpaUK: /hɒˈspɪtəbli/,  /ˈhɒspɪtəbli/""",
                      americanText:
                          """IpaUS: /ˈhɑːspɪtəbli/,  /hɑːˈspɪtəbli/""",
...
// With short examples define "hospitably", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """He welcomed me most hospitably.""",
                      kurdishText: """زۆر میواندۆستانە پێشوازی لێم کرد.""",
