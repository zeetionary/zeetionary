...
class EnglishEntryhelpline extends StatefulWidget {
  const EnglishEntryhelpline({super.key});

  @override
  State<EnglishEntryhelpline> createState() => _EnglishEntryhelplineState();
}

class _EnglishEntryhelplineState extends State<EnglishEntryhelpline> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: helpline (Derived forms: helplines)
1. A phone service that offers assistance with problems
"a 24 hour helpline number"
""",
  );

  final String keyword = "helpline";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""helpline""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """helpline""",
                      // alsoEnglishWord: "also: helpline",
                      britshText: """IpaUK: /ˈhelplaɪn/""",
                      americanText: """IpaUS: /ˈhelplaɪn/""",
...
کوردی: 
"""),
// With short examples define "helpline", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) خزمەتگوزارییەکی تەلەفۆنی یان سەر ئینتەرنێت کە یارمەتی و زانیاری پێشکەش دەکات لەسەر ژمارەیەک کێشەی دیاریکراو"""),
                    SentencesRow(
                      englishText:
                          """The helpline was set up for young people in need of guidance and support.""",
                      kurdishText:
...
const String _videoIdone = 'https://youtu.be/itwotkBzZGQ?t=';
const double _startSecondsone = 000000000000000000000000000900;
const String _videoIdtwo = 'https://youtu.be/BqADfq2Tlao?t=';
const double _startSecondstwo = 0000000000000000000000000001656;
const String _videoIdthree = 'https://youtu.be/6OppVf9Ty-E?t=';
const double _startSecondsthree = 000000000000000000000000000146;
const String _videoIdfour = 'https://youtu.be/-XRyx6R6T_o?t=';
const double _startSecondsfour = 000000000000000000000000000707;
const String _videoIdfive = 'https://youtu.be/aegvnPT0re0?t=';
const double _startSecondsfive = 000000000000000000000000000399;
