...
class EnglishEntryequestrian extends StatefulWidget {
  const EnglishEntryequestrian({super.key});

  @override
  State<EnglishEntryequestrian> createState() => _EnglishEntryequestrianState();
}

class _EnglishEntryequestrianState extends State<EnglishEntryequestrian> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""equestrian""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equestrian""",
                      // alsoEnglishWord: "also: equestrian",
                      britshText: """IpaUK: /ɪˈkwestriən/""",
                      americanText: """IpaUS: /ɪˈkwestriən/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "equestrian";
...
کوردی: سوارکارانە، سەربە سوارکاری، سەربە، ئەسپ‌سواری، سوارە
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) پەیوەندیدار بە ئەسپسواری"""),
          SentencesRow(
            englishText:
                """They plan to hold the Olympics' equestrian events in another part of the city.""",
            kurdishText:
                """پلانیان هەیە بۆنەکانی ئەسپسواری ئۆڵۆمپیاد لە شارێکی دیکە ڕێکبخەن.""",
...
- Noun: equestrian (Derived forms: equestrians)
1. A man skilled in equitation (= horseman, horseback rider)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/eWHN7pBRzIo?t=';
const double _startSecondsend = 000000000000000000000000000000; // 478;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/dxr71PsnR3g?t=';
const double _startSecondsone = 00000000000000000000000000000; // 71;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/K2zbN3AuHG8?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 532;
const String _videoIdthree = 'VIDEOhttps://youtu.be/D08SDjJ_niM?t=';
const double _startSecondsthree = 000000000000000000000000000; // 666;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/wAyqGCEIFGU?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 922;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/eR-J_JSBNTI?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 939;
