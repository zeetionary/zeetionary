...
class EnglishEntryendeavour extends StatefulWidget {
  const EnglishEntryendeavour({super.key});

  @override
  State<EnglishEntryendeavour> createState() => _EnglishEntryendeavourState();
}

class _EnglishEntryendeavourState extends State<EnglishEntryendeavour> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""endeavour""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """endeavour""",
                      // alsoEnglishWord: "also: endeavour",
                      britshText: """IpaUK: /ɪnˈdevə(r)/""",
                      americanText: """IpaUS: /ɪnˈdevər/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "endeavour";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We wish her every success in this endeavour.""");
  }
...
کوردی: تێکۆشان، ھەوڵ، خەبات، کردوکۆش، بزاڤ
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ھەوڵێک بۆ کردنی شتێک، بەتایبەتی شتێک کە سەخت یان تازەیە"""),
          SentencesRow(
            englishText:
                """There have been great advances in the field of scientific endeavour.""",
            kurdishText:
                """بەرەوپێشچوونی مەزن ھەبوونە لە بواری تێکۆشانی زانستی.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerSentences(),
          SentencesRow(
            englishText: """Please make every endeavour to arrive on time.""",
            kurdishText: """تکایە ھەموو ھەوڵێک بدە کە لە کاتی خۆیدا بگەیت.""",
          ...
          SentencesRow(
            englishText:
                """Learning a foreign language well can be a lifelong endeavour.""",
            kurdishText:
                """فێربوونی زمانێکی بیانی دەکرێت تێکۆشانێکی ھەمیشەیی بێت.""",
            onPressedBritish: () => speaksentence3("en-GB"),
            onPressedAmerican: () => speaksentence3("en-US" ""),
          ),
          const DividerSentences(),
          SentencesRow(
            englishText: """We wish her every success in this endeavour.""",
            kurdishText: """ھیوای ھەموو سەرکەوتنێکی بۆ دەخوازین لەم ھەوڵەدا.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """ھەوڵی زۆر دەدەم بۆ ئەنجامدانی باشترین بۆ وڵاتەکەم.""",
            onPressedBritish: () => speaksentence5("en-GB"),
            onPressedAmerican: () => speaksentence5("en-US" ""),
          ),
          const DividerSentences(),
          SentencesRow(
            englishText: """He endeavoured in vain to escape the situation.""",
            kurdishText: """بێ‌ھوودە تەقەڵای بوو بۆ دووربوون لە دۆخەکە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: endeavour (derived forms: endeavours)
Usage: Brit, Cdn (US: endeavor)
1. A purposeful or industrious undertaking (especially one that requires effort or boldness) (= enterprise, endeavor [US])
"he had doubts about the whole endeavour";
 
2. Earnest and conscientious activity intended to do or accomplish something (= attempt, effort, endeavor [US], try)
"wished him luck in his endeavour"; "made an endeavour to cover all the reading material";

- Verb: endeavour (derived forms: endeavouring, endeavoured, endeavours)
Usage: Brit, Cdn (US: endeavor)
1. Attempt by employing effort (= endeavor [US], strive)
