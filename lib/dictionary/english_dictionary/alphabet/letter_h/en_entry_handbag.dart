...
class EnglishEntryhandbag extends StatefulWidget {
  const EnglishEntryhandbag({super.key});

  @override
  State<EnglishEntryhandbag> createState() => _EnglishEntryhandbagState();
}

class _EnglishEntryhandbagState extends State<EnglishEntryhandbag> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: handbag (Derived forms: handbags)
1. A container used for carrying money and small personal items or accessories (especially by women) (- bag, pocketbook, purse)
"she reached into her handbag and found a comb";

- Verb: handbag (Derived forms: handbagging, handbags, handbagged)
Usage: UK, informal
1. (of a woman) make a fierce verbal attack on someone
"Thatcher's domineering style was to polarize issues and trash all opponents, as she handbagged her way through the 1980s"
""",
  );

  final String keyword = "handbag";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""handbag""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She was rummaging in her handbag for her keys.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She took a pen out of her large leather handbag.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I had my handbag stolen at the train station.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """handbag""",
                      // alsoEnglishWord: "also: handbag",
                      britshText: """IpaUK: /ˈhændbæɡ/""",
                      americanText: """IpaUS: /ˈhændbæɡ/""",
...
"""),
// With short examples define "handbag", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) جانتایەکی بچووک بۆ پارە، کلیل، هتد کە زۆرجار ژنان هەڵیدەگرن"""),
                    const AlsoEnglishckb(word: "ئینگلیزیی ئەمریکی: purse"),
                    SentencesRow(
                      englishText:
                          """She was rummaging in her handbag for her keys.""",
                      kurdishText: """بە جانتاکەیدا دەگەڕا بۆ کلیلەکان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She took a pen out of her large leather handbag.""",
                      kurdishText:
                          """پێنووسێکی لە جانتا گەورە چەرمە دەستییەکەی دەرهێنا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I had my handbag stolen at the train station.""",
                      kurdishText:
                          """لە وێستگەی شەمەندەفەرەکە جانتا دەستییەکەم دزرا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/kcUFSapjVqk?t=';
const double _startSecondsend = 000000000000000000000000000344;
const String _videoIdone = 'https://youtu.be/544DTGHIBM0?t=';
const double _startSecondsone = 000000000000000000000000000323;
const String _videoIdtwo = 'https://youtu.be/XXhc5UTxv5I?t=';
const double _startSecondstwo = 000000000000000000000000000640;
const String _videoIdthree = 'https://youtu.be/fn--IVarumw?t=';
const double _startSecondsthree = 000000000000000000000000000513;
const String _videoIdfour = 'https://youtu.be/-Je79iRtTTE?t=';
const double _startSecondsfour = 000000000000000000000000000168;
const String _videoIdfive = 'https://youtu.be/lf-KVEXIoqM?t=';
const double _startSecondsfive = 000000000000000000000000000351;
