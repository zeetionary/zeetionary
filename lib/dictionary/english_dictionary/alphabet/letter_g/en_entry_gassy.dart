...
class EnglishEntrygassy extends StatefulWidget {
  const EnglishEntrygassy({super.key});

  @override
  State<EnglishEntrygassy> createState() => _EnglishEntrygassyState();
}

class _EnglishEntrygassyState extends State<EnglishEntrygassy> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""UK lagers are criticized for being weak and gassy.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The dog looked uncomfortable and gassy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gassy""",
                      // alsoEnglishWord: "also: gassy",
                      britshText: """IpaUK: /ˈɡæsi/""",
                      americanText: """IpaUS: /ˈɡæsi/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) خواردنەوەیەک کە گازی زۆری تێدایە"""),
                    SentencesRow(
                      englishText:
                          """UK lagers are criticized for being weak and gassy.""",
                      kurdishText:
                          """بیرەی بەریتانی ڕەخنەیان لێ دەگیردرێت بۆ ئەوەی کە لاواز و گازدارن بن.""",
...
const String _videoIdend = 'https://youtu.be/9GR3XSuInYE?t=';
const double _startSecondsend = 0000000000000000000000000001097;
const String _videoIdone = 'https://youtu.be/epYDHqAwsnY?t=';
const double _startSecondsone = 000000000000000000000000000217;
const String _videoIdtwo = 'https://youtu.be/K4xWCljHJLE?t=';
const double _startSecondstwo = 000000000000000000000000000440;
const String _videoIdthree = 'https://youtu.be/viOpP6P_PrQ?t=';
const double _startSecondsthree = 000000000000000000000000000178;
const String _videoIdfour = 'https://youtu.be/E3EFK020pgw?t=';
const double _startSecondsfour = 000000000000000000000000000267;
const String _videoIdfive = 'https://youtu.be/dQsTUyZYyOw?t=';
