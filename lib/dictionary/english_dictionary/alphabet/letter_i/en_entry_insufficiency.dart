...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '4EkKhkSNjWY';
    const double startSecondsend = 725;
    const String videoIdone = 'ha2mLz-Xdpg';
    const double startSecondsone = 974;
    const String videoIdtwo = 'EmReBWrC17g';
    const double startSecondstwo = 646;
    const String videoIdthree = 'YJQSuUZdcV4';
    const double startSecondsthree = 746;
    const String videoIdfour = '0ZFtHzZqYDY';
    const double startSecondsfour = 418;
    const String videoIdfive = 'pUukStoZYio';
