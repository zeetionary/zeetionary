...
class EnglishEntryhomepage extends StatefulWidget {
  const EnglishEntryhomepage({super.key});

  @override
  State<EnglishEntryhomepage> createState() => _EnglishEntryhomepageState();
}

class _EnglishEntryhomepageState extends State<EnglishEntryhomepage> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: home page
1. The opening page of a web site; also, the first page opened when a web browser is launched (default or start-up page) (- homepage)
Derived forms: homepages, home pages
""",
  );

  final String keyword = "home page";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""home page""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She redesigned the company’s home page last week.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""To make this your home page, click here.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/rvGa0jT43-s?t=';
    const double startSecondsend = 000000000000000000000000000318;
    const String videoIdone = 'https://youtu.be/RyRKKkls3I8?t=';
    const double startSecondsone = 00000000000000000000000000033;
    const String videoIdtwo = 'https://youtu.be/4DfCXjwQBRA';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/TijghKYYeAA?t=';
    const double startSecondsthree = 000000000000000000000000000664;
    const String videoIdfour = 'https://youtu.be/yRUUMTPhLH0?t=';
    const double startSecondsfour = 0000000000000000000000000003605;
    const String videoIdfive = 'https://youtu.be/dsCjRjA4O7Y?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """home page""",
                      // alsoEnglishWord: "also: home page",
                      britshText: """IpaUK: /ˈhəʊm peɪdʒ/""",
                      americanText: """IpaUS: /ˈhəʊm peɪdʒ/""",
...
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) پەڕەی سەرەکی وێبسایتێک"""),
                    SentencesRow(
                      englishText:
                          """She redesigned the company’s home page last week.""",
                      kurdishText:
                          """هەفتەی ڕابردوو پەڕەی سەرەکی کۆمپانیاکەی تازە کردەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بۆ ئەوەی ئەمە بکەیت بە پەڕەی سەرەکیت، گرتە لێرە بکە.""",
