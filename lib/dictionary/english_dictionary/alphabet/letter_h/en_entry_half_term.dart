...
class EnglishEntryhalfterm extends StatefulWidget {
  const EnglishEntryhalfterm({super.key});

  @override
  State<EnglishEntryhalfterm> createState() => _EnglishEntryhalftermState();
}

class _EnglishEntryhalftermState extends State<EnglishEntryhalfterm> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: half-term (Derived forms: half-terms)
Usage: Brit
...
""",
  ...
  final String keyword = "half-term";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""half-term""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What are you doing at half-term?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It’s the half-term break next week.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """half-term""",
                      // alsoEnglishWord: "also: half-term",
                      britshText: """IpaUK: /ˌhɑːf ˈtɜːm/""",
                      americanText: """IpaUS: /ˌhæf ˈtɜːrm/""",
...
// With short examples define "half-term", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پشووی کورتی نێوان دوو وەرزەکەی قوتابخانەیە"""),
                    SentencesRow(
                      englishText: """What are you doing at half-term?""",
                      kurdishText: """لە پشووی وەرزەکاندا چی دەکەیت؟""",
