...
class EnglishEntrylyrically extends StatefulWidget {
  const EnglishEntrylyrically({super.key});

  @override
  State<EnglishEntrylyrically> createState() => _EnglishEntrylyricallyState();
}

class _EnglishEntrylyricallyState extends State<EnglishEntrylyrically> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylyrically lyrically
WORD_WEB lyrically lyrically lyrically
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lyrically";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lyrically""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lyrically""",
                      // alsoEnglishWord: "also: lyrically",
...
کوردی: 
"""),
// With short examples define "lyrically", please follow LX instructions
