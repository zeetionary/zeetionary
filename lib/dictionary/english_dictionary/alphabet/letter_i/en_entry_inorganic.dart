...
class EnglishEntryinorganic extends StatefulWidget {
  const EnglishEntryinorganic({super.key});

  @override
  State<EnglishEntryinorganic> createState() => _EnglishEntryinorganicState();
}

class _EnglishEntryinorganicState extends State<EnglishEntryinorganic> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inorganic""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'brofphmC7GI';
    const double startSecondsend = 1297;
    const String videoIdone = 'JhOU3FOyApM';
    const double startSecondsone = 97;
    const String videoIdtwo = 'RgpJPVoDZf8';
    const double startSecondstwo = 657;
    const String videoIdthree = 'W6aDNutZoB0';
    const double startSecondsthree = 1505;
    const String videoIdfour = 'T7tLon1n4qE';
    const double startSecondsfour = 70;
    const String videoIdfive = 'E2rtQFAibEA';
    const double startSecondsfive = 10937;
