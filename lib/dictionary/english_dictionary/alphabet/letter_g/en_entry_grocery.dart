...
class EnglishEntrygrocery extends StatefulWidget {
  const EnglishEntrygrocery({super.key});

  @override
  State<EnglishEntrygrocery> createState() => _EnglishEntrygroceryState();
}

class _EnglishEntrygroceryState extends State<EnglishEntrygrocery> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grocery (Derived forms: groceries)
1. A marketplace where groceries are sold (- grocery store, food market, market)
"the grocery store included a meat market";
 
2. (usually plural) consumer goods sold by a grocer (- foodstuff)
""",
  );

  final String keyword = "grocery";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grocery""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""More people are buying their groceries online.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grocery""",
                      // alsoEnglishWord: "also: grocery",
                      britshText: """IpaUK: /ˈɡrəʊsəri/""",
                      americanText: """IpaUS: /ˈɡrəʊsəri/""",
...
// With short examples define "grocery", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) فرۆشگایەک کە سەوزە و شتی ماڵەوە دەفرۆشێت. لە ئەمریکا هەمان واتای سوپەرمارکێتی هەیە"""),
                    SentencesRow(
                      englishText:
                          """America's largest grocery store chain will be bringing two new stores to Oakland.""",
                      kurdishText:
                          """گەورەترین زنجیرە فرۆشگای ئەمریکا دوو فرۆشگای دیکە دێنێتە ئۆکلاند.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خەڵکی زیاتر کەلووپەلەکانیان بە ئۆنلاین دەکڕن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/k3aAl92_VDE?t=';
const double _startSecondsend = 00000000000000000000000000051;
const String _videoIdone = 'https://youtu.be/gngPQ771Ahk?t=';
const double _startSecondsone = 000000000000000000000000000297;
const String _videoIdtwo = 'https://youtu.be/h4CyhQqAPpk?t=';
const double _startSecondstwo = 000000000000000000000000000787;
const String _videoIdthree = 'https://youtu.be/SmGPZK5HYvQ?t=';
const double _startSecondsthree = 000000000000000000000000000150;
const String _videoIdfour = 'https://youtu.be/qJ2B_PK7Ikw?t=';
const double _startSecondsfour = 00000000000000000000000000049;
const String _videoIdfive = 'https://youtu.be/OBM2i6NrAFs?t=';
