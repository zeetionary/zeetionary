...
class EnglishEntrycapillary extends StatelessWidget {
  // blank divider
  EnglishEntrycapillary({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcapillary(String languageCode) async {
    // DOPSUM: CHANGE speakcapillary
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "capillary"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /kəˈpɪləri/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcapillary("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈkæpəleri/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcapillary("en-US"),
                            ),
                          ],
                        ),
                      ],
...
کوردی: مووڕەگ، دەزووڕەگ، ڕەهچک، موولوولە، ڕەگەمووینە، دەزوولە
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: capillary (Derived forms: capillaries)
1. A tube of small internal diameter; holds liquid by capillary action (= capillary tube, capillary tubing)
 
2. Any of the minute blood vessels connecting arterioles with venules (= capillary vessel)

- Adjective: capillary 
1. Long and slender with a very small internal diameter (= hairlike)
"a capillary tube";
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/gxxC4JxBZz4?t=',
    startSeconds: 27,
    autoPlay: true,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/rK6cS6FkgkA?t=',
    startSeconds: 10,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/DwHHp4pimCg?t=',
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/00tmGp6TLss',
    // startSeconds: 222222222222222,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/4OgcPI7S8_o?t=',
    startSeconds: 20,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/_qOvyph_EyY?t=',
    startSeconds: 8,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/RmV1JljxeFU?t=',
    startSeconds: 53,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/ONGdehkB8jU?t=',
    startSeconds: 196,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
