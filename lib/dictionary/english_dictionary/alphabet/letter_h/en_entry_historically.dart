...
class EnglishEntryhistorically extends StatefulWidget {
  const EnglishEntryhistorically({super.key});

  @override
  State<EnglishEntryhistorically> createState() =>
      _EnglishEntryhistoricallyState();
}

class _EnglishEntryhistoricallyState extends State<EnglishEntryhistorically> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "historically";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""historically""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The book is historically inaccurate.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The Magna Carta is a historically significant document.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000166;
    const String videoIdone = 'https://youtu.be/Gv4Af83KFrE?t=';
    const double startSecondsone = 0000000000000000000000000001439;
    const String videoIdtwo = 'https://youtu.be/9yjZpBq1XBE?t=';
    const double startSecondstwo = 0000000000000000000000000001003;
    const String videoIdthree = 'https://youtu.be/y4DTW4B3Sjs?t=';
    const double startSecondsthree = 0000000000000000000000000001152;
    const String videoIdfour = 'https://youtu.be/Gi3HnqetpLw?t=';
    const double startSecondsfour = 000000000000000000000000000579;
    const String videoIdfive = 'https://youtu.be/JHjXwicEwQo?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """historically""",
                      // alsoEnglishWord: "also: historically",
                      britshText: """IpaUK: /hɪˈstɒrɪkli/""",
                      americanText: """IpaUS: /hɪˈstɔːrɪkli/""",
...
// With short examples define "historically", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The book is historically inaccurate.""",
                      kurdishText:
                          """پەرتووکەکە لەلایەنی مێژووووییەوە ناڕاستە.""",
                    ...
                    SentencesRow(
                      englishText: """The film is not historically accurate.""",
                      kurdishText: "فیلمەکە لەلایەنی مێژووییەوە درووست نییە.",
                    ...
                    SentencesRow(
                      englishText:
                          """Historically, there has always been a great deal of rivalry between the two families.""",
                      kurdishText:
                          """لە لایەنی مێژووییەوە، هەمیشە ڕێژەیەکی زۆر لە ڕکابەری هەبووە لە نێوان دوو خێزانەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ماگنا کارتا بەڵگەنامەیەکی مێژووی گرنگە.""",
