...
class EnglishEntryhomework extends StatefulWidget {
  const EnglishEntryhomework({super.key});

  @override
  State<EnglishEntryhomework> createState() => _EnglishEntryhomeworkState();
}

class _EnglishEntryhomeworkState extends State<EnglishEntryhomework> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: homework (Derived forms: homeworks)
1. Preparatory school work done outside school (especially at home) (- prep [informal], preparation)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""homework""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I always do my homework on the bus.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I still haven't done my geography homework.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How much homework do you get?""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Please copy the homework from the blackboard.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Did I hear the dreaded word ‘homework’?""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/xfkONdNK96w?t=';
    const double startSecondsend = 000000000000000000000000000253;
    const String videoIdone = 'https://youtu.be/Y_vP8nNpUFM?t=';
    const double startSecondsone = 0000000000000000000000000008;
    const String videoIdtwo = 'https://youtu.be/z9rMuCzSpt4?t=';
    ...
    const String videoIdfour = 'https://youtu.be/-CJ4eUhE3Lw?t=';
    const double startSecondsfour = 000000000000000000000000000372;
    const String videoIdfive = 'https://youtu.be/wVc_ilWtA6g?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homework""",
                      // alsoEnglishWord: "also: homework",
                      britshText: """IpaUK: /ˈhəʊmwɜːk/""",
                      americanText: """IpaUS: /ˈhəʊmwɜːrk/""",
...
// With short examples define "homework", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """I always do my homework on the bus.""",
                      kurdishText: """هەمیشە ئەرکی ماڵەوەم لەناو پاس دەکەم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هێشتا ئەرکی ماڵەوەی جوگرافیام نەکردووە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """How much homework do you get?""",
                      kurdishText: """چەند ئەرکی ماڵەوەت هەیە؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ھەمیشە ئەرکی ماڵەوە ئێجگار زۆرمان پێدەدات.""",
