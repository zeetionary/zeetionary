...
class EnglishEntryetching extends StatefulWidget {
  const EnglishEntryetching({super.key});

  @override
  State<EnglishEntryetching> createState() => _EnglishEntryetchingState();
}

class _EnglishEntryetchingState extends State<EnglishEntryetching> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""etching""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """etching""",
                      // alsoEnglishWord: "also: etching",
                      britshText: """IpaUK: /ˈetʃɪŋ/""",
                      americanText: """IpaUS: /ˈetʃɪŋ/""",
...
کوردی: هەڵکۆڵین، وێنەی هەڵکۆڵراو
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) وێنەیەک کە لە پارچە کانزایەکی نەخشێندراوە هەڵکۆڵدراوە"""),
          SentencesRow(
            englishText:
                """The exhibition features a selection of his early etchings and drawings.""",
            kurdishText:
                """پێشانگایەک ژمارەیەک لە هەڵکۆڵین و وێنەکێشانەکانی لەخۆدەگرێت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: etching (Derived forms: etchings)
1. An impression made from an etched plate
 
2. An etched plate made with the use of acid
 
3. Making engraved or etched plates and printing designs from them (= engraving)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/ih8ex84QoH4?t=';
const double _startSecondsend = 000000000000000000000000000000; // 433;
...
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/LCF05r3CSME?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 539;
const String _videoIdthree = 'VIDEOhttps://youtu.be/drd7jCqfQsY?t=';
const double _startSecondsthree = 000000000000000000000000000; // 715;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/QAjNORYesW8?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 492;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/axiYo61XRRw?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 3650;
