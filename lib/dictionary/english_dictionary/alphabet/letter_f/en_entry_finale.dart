...
class EnglishEntryfinale extends StatefulWidget {
  const EnglishEntryfinale({super.key});

  @override
  State<EnglishEntryfinale> createState() => _EnglishEntryfinaleState();
}

class _EnglishEntryfinaleState extends State<EnglishEntryfinale> {
  @override
  void initState() {
    super.initState();
...
3. The concluding part of any performance (= close, closing curtain, finis)
""",
  );

  final String keyword = "finale";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was a fitting finale to the day's events.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """finale""",
                      // alsoEnglishWord: "also: finale",
                      britshText: """IpaUK: /fɪˈnɑːli/""",
                      americanText: """IpaUS: /fɪˈnæli/""",
...
کوردی: بەشی دوایی، ئەنجامە، فیناڵی (موسیقا و دراما)،	کۆتایی، دوایی، ئاخر
"""),
// With short examples define "finale", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) کۆتا بەشی میوزیکێک یان پڕۆگرامێک"""),
                    SentencesRow(
                      englishText:
                          """The festival ended with a grand finale of fireworks and music.""",
                      kurdishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کۆتاییەکی گونجاو بۆ بۆنەکانی ڕۆژەکە.""",
...
const double _startSecondsend = 000000000000000000000000000645;
const String _videoIdone = 'https://youtu.be/X3n5Pk8fkLg?t=';
const double _startSecondsone = 000000000000000000000000000470;
const String _videoIdtwo = 'https://youtu.be/Mx8JkGHaGUI?t=';
const double _startSecondstwo = 0000000000000000000000000001566;
const String _videoIdthree = 'https://youtu.be/PkUg89kLLBE?t=';
const double _startSecondsthree = 00000000000000000000000000019;
const String _videoIdfour = 'https://youtu.be/V4Uuxg6jmbo?t=';
const double _startSecondsfour = 0000000000000000000000000001020;
const String _videoIdfive = 'https://youtu.be/1oSuoFwPX4E?t=';
const double _startSecondsfive = 000000000000000000000000000769;
