...
class EnglishEntryevacuate extends StatefulWidget {
  const EnglishEntryevacuate({super.key});

  @override
  State<EnglishEntryevacuate> createState() => _EnglishEntryevacuateState();
}

class _EnglishEntryevacuateState extends State<EnglishEntryevacuate> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evacuate""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evacuate""",
                      // alsoEnglishWord: "also: evacuate",
                      britshText: """IpaUK: /ɪˈvækjueɪt/""",
                      americanText: """IpaUS: /ɪˈvækjueɪt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Police evacuated nearby buildings.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Families were evacuated to safer parts of the city.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Locals were told to evacuate.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) گواستنەوەی خەڵکی لە شوێنێکی مەترسیدارەوە بۆ شوێنێکی سەلامەت"""),
          SentencesRow(
            englishText: """Police evacuated nearby buildings.""",
            kurdishText: """پۆلیس بینا نزیکەکانی چۆڵکرد.""",
          ...
          SentencesRow(
            englishText:
                """Children were evacuated from London to escape the bombing.""",
            kurdishText:
                """منداڵان لە لەندەن دەرکران بۆ ڕاکردن لە بۆمبارانەکە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """خێزانەکان بۆ بەشە ئارامەکانی شارەکە گواسترانەوە.""",
          ...
          SentencesRow(
            englishText:
                """Every police unit has been ordered to evacuate all civilians.""",
            kurdishText:
                """هەموو یەکەیەکی پۆلیس فەرمانی پێکراوە کە هەموو خەڵکی مەدەنی بگوازنەوە.""",
            onPressedBritish: () => speaksentence4("en-GB"),
            onPressedAmerican: () => speaksentence4("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (کردار) جێهێشتنی شوێنێک و چوون بۆ سەلامەتی"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Locals were told to evacuate.""",
            kurdishText: """خەڵکە خۆجێییەکە پێیان گوترا هەڵبێن.""",
          ...
          SentencesRow(
            englishText:
                """Employees were urged to evacuate their offices immediately.""",
            kurdishText: """کارمەندان هاندران بەزووی ئۆفیسەکانیان چۆڵ بکەن.""",
            onPressedBritish: () => speaksentence6("en-GB"),
            onPressedAmerican: () => speaksentence6("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """٣. (کردار) پیسایی کردن"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The horse evacuated its bowels all over the path.""",
            kurdishText:
                """ئەسپەکە بەسەر هەموو ڕێگاکەدا ڕیخۆڵەکانی بەتاڵ کردەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: evacuate (Derived forms: evacuated, evacuating, evacuates)
...
5. Excrete or discharge from the body (= void, empty)
""",
  );
...
const double _startSecondsend = 000000000000000000000000000000; // 1514;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/ltOkMlHrGPc?t=';
const double _startSecondsone = 00000000000000000000000000000; // 878;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/dRLCZqEfJFA?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 83;
const String _videoIdthree = 'VIDEOhttps://youtu.be/NWGVFi-213w?t=';
const double _startSecondsthree = 000000000000000000000000000; // 422;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/OP7l1n_8Lh4?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 517;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/4iwlFFM3DDQ?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 4229;
