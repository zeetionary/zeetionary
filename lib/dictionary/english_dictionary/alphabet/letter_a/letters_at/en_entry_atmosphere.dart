                      ...
                      child: Column(
                        ...
                        children: [
                          const Text(
                            ...
                            """
کوردی: بەرگەهەوا، کەش، تەوشک، هەوا، کەش‌وهەوا، هەڵمەگۆ، چینەهەڵمینە 
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "گڕکانەکان و کانیاوە گەرمەکان گازی میسان دەخەنە بەرگەهەواوە.",
                                    textAlign: TextAlign
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "کەشتییە ئاسمانییەکە دەبێت درەنگانی ئەمڕۆ بگەڕێتەوە ناو بەرگەهەوای زەوی.",
                                    textAlign: TextAlign
                                        .right, // Right-to-left direction
                                    textDirection: TextDirection.rtl,
                                  ),
...
٢. (ناو) ئەو گازانەی کە دەوری تەنێکی ئاسمانییان داوە""",
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "دوورترین بەشی ڕووی دەرەوەی بەرگەهەوای خۆر پێی دەوترێت کۆرۆنا.",
                                    textAlign: TextAlign
                                        .right, // Right-to-left direction
                                    textDirection: TextDirection.rtl,
                                  ),
                          ...
                          const Text(
                            // DOPSUM: WRITE DEFINITION IN KURDISH. COPY FOR ANOTHER DEFINITION
                            """
٣. (ناو) هەوای ناو ژوورێک یان شوێنێکی بچووک""",
                            style: TextStyle(fontSize: 18),
                            textAlign: TextAlign.right,
                            textDirection: TextDirection.rtl,
                          ),
                          ...
                          const Text(
                            // DOPSUM: WRITE DEFINITION IN KURDISH. COPY FOR ANOTHER DEFINITION
                            """
٤. (ناو) ئەو کەشەی لە بارودۆخێکدا هەیە""",
                            style: TextStyle(fontSize: 18),
                            textAlign: TextAlign.right,
                            textDirection: TextDirection.rtl,
                          ),
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "کەشێکی متمانەی هاوبەش هەبوو لە نێوانیاندا.",
                                    textAlign: TextAlign
                                        .right, // Right-to-left direction
                                    textDirection: TextDirection.rtl,
                                  ),
