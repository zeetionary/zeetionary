...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'Ax5eAzV5U5s';
    const double startSecondsend = 300;
    const String videoIdone = 'Rvey9g0VgY0';
    const double startSecondsone = 591;
    const String videoIdtwo = 'SczVd4n6KKs';
    const double startSecondstwo = 655;
    const String videoIdthree = 'nC5ghtpeL6I';
    const double startSecondsthree = 626;
    const String videoIdfour = '0tYm41hb48o';
    const double startSecondsfour = 1573;
    const String videoIdfive = 'lI-SfXmeHhY';
    const double startSecondsfive = 1216;
