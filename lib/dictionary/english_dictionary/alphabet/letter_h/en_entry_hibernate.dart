...
class EnglishEntryhibernate extends StatefulWidget {
  const EnglishEntryhibernate({super.key});

  @override
  State<EnglishEntryhibernate> createState() => _EnglishEntryhibernateState();
}

class _EnglishEntryhibernateState extends State<EnglishEntryhibernate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: hibernate (Derived forms: hibernated, hibernates, hibernating)
1. Sleep during winter (- hole up)
...
""",
  ...
  final String keyword = "hibernate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hibernate""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hibernate""",
                      // alsoEnglishWord: "also: hibernate",
                      britshText: """IpaUK: /ˈhaɪbəneɪt/""",
                      americanText: """IpaUS: /ˈhaɪbərneɪt/""",
...
کوردی: 
"""),
// With short examples define "hibernate", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) بەسەربردنی زستان بە خەوی قووڵ"""),
                    SentencesRow(
                      englishText:
                          """The turtle hibernates in a shallow burrow for six months of the year.""",
                      kurdishText:
                          """کیسەڵ دەچێتە متبوون لە چاڵێکی کەم‌قووڵ بۆ شەش مانگی ساڵ.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/rqw4nCEUK4I?t=';
const double _startSecondsend = 000000000000000000000000000294;
const String _videoIdone = 'https://youtu.be/MSRBV9udKi8?t=';
const double _startSecondsone = 000000000000000000000000000654;
const String _videoIdtwo = 'https://youtu.be/oJLA8iNUV-0?t=';
const double _startSecondstwo = 0000000000000000000000000001257;
const String _videoIdthree = 'https://youtu.be/yVgjx6Sw_CA?t=';
const double _startSecondsthree = 000000000000000000000000000160;
const String _videoIdfour = 'https://youtu.be/AKB1dyXsTGM?t=';
const double _startSecondsfour = 000000000000000000000000000319;
const String _videoIdfive = 'https://youtu.be/sGK2Gq7HBBI?t=';
