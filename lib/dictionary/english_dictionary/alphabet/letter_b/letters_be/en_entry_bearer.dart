...
// Define the word "bearer" and provide five simple example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings or more.

// replace bearer - replace EnglishEntrybearer

// replace speakBearer - /ˈbeərə(r)/

enum TtsState { playing }

class EnglishEntrybearer extends StatelessWidget {
// blank divider
  EnglishEntrybearer({super.key});
// blank divider
  ...
  Future<void> speakbearers1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He was a coffin bearer at his father's funeral.");
  }
  ...
  Future<void> speakbearers2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I'm sorry to be the bearer of bad news.");
  }
  ...
  Future<void> speakbearers3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("A pass will allow the bearer to enter the building.");
  }
  ...
  Future<void> speakbearers5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBearers55");
  }
  ...
  Future<void> speakbearers6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBearers66");
  }
  ...
  Future<void> speakbearers7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBearers77");
  }
...
3. One of the mourners carrying the coffin at a funeral (= pallbearer)
 
4. The person who is in possession of a check or note or bond or document of title that is endorsed to him or to whoever holds it (= holder)
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'YGgnza9hLMM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'Bd_Zpqa7X08';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'YmtIrYXlGRM';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'DoI-rn_xNAw';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final double _startSeconds = 3443;
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final double _startSeconds = 2763;
...
// end bearer// TODO Implement this library.
