...
class EnglishEntryarchery extends StatelessWidget {
  ...
  Future<void> speakarchery(String languageCode) async {
    ...
    await flutterTts.speak("archery");
  }
  ...
  Future<void> speakarchery350(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Neither had practised archery before last year.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "archery"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɑːtʃəri/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrtʃəri/"),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'GUY6ulBHI-U';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'CupwiG1eylQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '6-Wef0694aY';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'gumuNn2PAQo';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '5cxUhWUMphM';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'DUmD80K-pOw';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'zVyTkbvL6cI';
