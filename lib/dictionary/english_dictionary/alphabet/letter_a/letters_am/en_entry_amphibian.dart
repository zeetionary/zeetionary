...
// replace these: replace EnglishEntryamphibian - replace speakAmphibian - replace amphibian - /æmˈfɪbiən/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryamphibian extends StatelessWidget {
  ...
  Future<void> speakAmphibian4410(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Salamanders, frogs, and other amphibian life are particularly sensitive to extreme pH levels."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAmphibian44588(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He flew an amphibian, which he could set down on water in case of an engine problem."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "amphibian", // DOPSUM: CHANGE WORD ENTRY - Find /æmˈfɪbiən/
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAmphibian(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () =>
                                    speakAmphibian4410(// REPLACE: amphibian /æmˈfɪbiən/
                                        "en-US"),
                              ),
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () =>
                                    speakAmphibian44588(// REPLACE: amphibian /æmˈfɪbiən/
                                        "en-US"),
                              ),
                            ],
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'ZYf_rUl2TWA';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'CxKArhySbko';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'EladL3ZW8h8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'gN0cpZytGos';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'bJH3YZqrm-8';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'VLgywOXtXjo';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'N0WJL9G6xno';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = '8V3B85bfVFI';
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = 'N6N1T00qslI';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  static String myVideoId = 'laxYhf-uOs4';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  static String myVideoId = '3a9MmVMyoTo';
