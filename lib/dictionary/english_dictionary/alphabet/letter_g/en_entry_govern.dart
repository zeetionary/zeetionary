...
class EnglishEntrygovern extends StatefulWidget {
  const EnglishEntrygovern({super.key});

  @override
  State<EnglishEntrygovern> createState() => _EnglishEntrygovernState();
}

class _EnglishEntrygovernState extends State<EnglishEntrygovern> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He accused the opposition party of being unfit to govern.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There were four parties governing in coalition.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Prices are governed by market demand.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """govern""",
                      // alsoEnglishWord: "also: govern",
                      britshText: """IpaUK: /ˈɡʌvn/""",
                      americanText: """IpaUS: /ˈɡʌvərn/""",
...
کوردی: حکومەت کردن، حوکمڕانی کردن
"""),
// With short examples define "govern", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) بەڕێوەبردنی وڵاتێک یان خەڵکەکەی بەوەی بەرپرسی دانانی یاسا، ڕێکخستنی خزمەتگوزارییە گشتییەکان، هتد بیت"""),
                    SentencesRow(
                      englishText:
                          """The country is governed by elected representatives of the people.""",
                      kurdishText:
                          """وڵاتەکە بەڕێوە دەبردرێت لەلایەن نوێنەرانی هەڵبژێردراوی خەڵکی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پارتی ئۆپۆزسیۆنی بە ناشایستە بۆ حکومڕانی تۆمەتبار کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چوار پارت بوون بە هاوپەیمانی حکومڕانییان دەکرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) کۆنترۆڵ کردن یان کاریگەری دانان لەسەر ئەوەی کەسێک/شتێک چۆن کار دەکات، ڕوودەدات، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Prices are governed by market demand.""",
                      kurdishText:
                          """نرخەکان لەلایەن خواستی بازاڕەوە دیاری دەکرێن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """All his decisions have been entirely governed by self-interest.""",
                      kurdishText:
                          """هەموو بڕیارەکانی کاریگەر بوونە بە بەرژەوەندیی کەسی.""",
...
const String _videoIdone = 'https://youtu.be/0jltioeaEyY?t=';
const double _startSecondsone = 000000000000000000000000000816;
const String _videoIdtwo = 'https://youtu.be/bHIhgxav9LY?t=';
const double _startSecondstwo = 000000000000000000000000000221;
const String _videoIdthree = 'https://youtu.be/3C9wZf88y4Q?t=';
const double _startSecondsthree = 000000000000000000000000000166;
const String _videoIdfour = 'https://youtu.be/DxL2HoqLbyA';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/wJa5Ch0O4BI?t=';
const double _startSecondsfive = 0000000000000000000000000007958;
