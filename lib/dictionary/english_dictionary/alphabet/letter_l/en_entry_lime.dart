...
class EnglishEntrylime extends StatefulWidget {
  const EnglishEntrylime({super.key});

  @override
  State<EnglishEntrylime> createState() => _EnglishEntrylimeState();
}

class _EnglishEntrylimeState extends State<EnglishEntrylime> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lime (Derived forms: limes)
1. A caustic substance produced by heating limestone (- calcium hydroxide, slaked lime, hydrated lime, calcium hydrate, caustic lime, lime hydrate)
 
2. A white crystalline oxide used in the production of calcium hydroxide (- calcium oxide, quicklime, calx, calcined lime, fluxing lime, unslaked lime, burnt lime)
 
3. A sticky adhesive that is smeared on small branches to capture small birds (- birdlime)
 
4. Any of various related trees bearing limes (- lime tree, Citrus aurantifolia)
 
5. Any of various deciduous trees of the genus Tilia with heart-shaped leaves and drooping cymose clusters of yellowish often fragrant flowers; several yield valuable timber (- linden, linden tree, basswood, lime tree)
 
6. The green acidic fruit of any of various lime trees

- Verb: lime (Derived forms: limed, limes, liming)
1. Spread birdlime on branches to catch birds (- birdlime)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The factory produces lime for industrial use.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Serve the dish garnished with wedges of lime.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/TyV-OhCrVDA?t=801';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/bGqvimnOTeg?t=392';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/D_Y18GEjfNY?t=321';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/Ub3sE1ww6ac?t=25';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/AwhBTrzzqeg?t=291';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/IHJI6_VpH00?t=9';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lime""",
                      // alsoEnglishWord: "also: lime",
                      britshText: """IpaUK: /laɪm/""",
                      americanText: """IpaUS: /laɪm/""",
...
کوردی: 
"""),
                    const DefinitionKurdish(text: """١. (ناو) مادەیەکی سپی کە بەدەست دێت لە گەرمکردنی بەردی قسڵەوە و بەکاردێت لە بنیاتنانی بینا و یارمەتیدانی گەشەی ڕووەک"""),
                    const AlsoEnglishckb(word: "ھەروەھا: quicklime"),
                    SentencesRow(
                      englishText: """The factory produces lime for industrial use.""",
                      kurdishText: """کارگەکە گەچ بەرهەم دێنێت بۆ بەکارهێنانی پیشەسازی.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) میوەیەکی سەوز کە وەک لیمۆیە و تامێکی ترشی توندی هەیە؛ دارێک کە ئەم میوەیە دەگرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Serve the dish garnished with wedges of lime.""",
                      kurdishText: """خواردنەکە پێشکەش بکە ڕازاوە بە پارچە لایم.""",
