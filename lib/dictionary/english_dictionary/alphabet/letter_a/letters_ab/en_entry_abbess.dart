...
class EnglishEntryAbbess extends StatelessWidget {
  EnglishEntryAbbess({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'abbess', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈæbes/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAbbess(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
class YoutubeEmbeddedOne extends StatelessWidget {
  static String myVideoId = 'r-r0O5IEd3w';
...
class YoutubeEmbeddedTwo extends StatelessWidget {
  static String myVideoId = 'LcHa-q7zA_M';
