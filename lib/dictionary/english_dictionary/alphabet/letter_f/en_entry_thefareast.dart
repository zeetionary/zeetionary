...
class EnglishEntrythefareast extends StatefulWidget {
  const EnglishEntrythefareast({super.key});

  @override
  State<EnglishEntrythefareast> createState() => _EnglishEntrythefareastState();
}

class _EnglishEntrythefareastState extends State<EnglishEntrythefareast> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""the Far East""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """the Far East""",
                      // alsoEnglishWord: "also: the Far East",
                      britshText: """IpaUK: /ðə ˌfɑːr ˈiːst/""",
                      americanText: """IpaUS: /ðə ˌfɑːr ˈiːst/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "the Far East";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He traveled to the Far East for business.""");
  }
...
const double _startSecondsend = 000000000000000000000000000722;
const String _videoIdone = 'https://youtu.be/FQ4hvLqNfqo?t=';
const double _startSecondsone = 000000000000000000000000000580;
const String _videoIdtwo = 'https://youtu.be/dypj6GBiM2s?t=';
const double _startSecondstwo = 000000000000000000000000000459;
const String _videoIdthree = 'https://youtu.be/ncMoQs_HNmY?t=';
const double _startSecondsthree = 0000000000000000000000000001249;
const String _videoIdfour = 'https://youtu.be/m5q-PIN3KSE?t=';
const double _startSecondsfour = 00000000000000000000000000060;
const String _videoIdfive = 'https://youtu.be/5-QejUTDCWw?t=';
const double _startSecondsfive = 000000000000000000000000000291;
