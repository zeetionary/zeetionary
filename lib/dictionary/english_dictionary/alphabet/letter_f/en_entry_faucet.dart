...
class EnglishEntryfaucet extends StatefulWidget {
  const EnglishEntryfaucet({super.key});

  @override
  State<EnglishEntryfaucet> createState() => _EnglishEntryfaucetState();
}

class _EnglishEntryfaucetState extends State<EnglishEntryfaucet> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """faucet""",
                      // alsoEnglishWord: "also: faucet",
                      britshText: """IpaUK: /ˈfɔːsɪt/""",
                      americanText: """IpaUS: /ˈfɔːsɪt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He stuck his head under the faucet.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Is the faucet dripping again?""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ئامرازێک کە ڕژانی ئاو لە بۆرییەکەوە کۆۆنترۆڵ دەکات"""),
          SentencesRow(
            englishText: """He stuck his head under the faucet.""",
            kurdishText: """سەری خستە ژێر بەلووعەکە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Is the faucet dripping again?""",
            kurdishText: """بەلووعەکە دووبارە تکە دەکات؟""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She repaired a leaky faucet.""",
            kurdishText: """بەلووعەیەکی لێ‌ڕۆیشتووی چاککردەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: faucet (Derived forms: faucets)
Usage: N. Amer (elsewhere: tap)
1. A regulator for controlling the flow of a liquid from a reservoir (= spigot, tap)
...
const String _videoIdend = 'https://youtu.be/yjhibJ-OqxE?t=';
const double _startSecondsend = 000000000000000000000000000307;
const String _videoIdone = 'https://youtu.be/I6vs3jsUCXA?t=';
const double _startSecondsone = 00000000000000000000000000011;
const String _videoIdtwo = 'https://youtu.be/ZOvyn72x6kQ?t=';
const double _startSecondstwo = 000000000000000000000000000691;
const String _videoIdthree = 'https://youtu.be/8HL4RQb-ROA?t=';
const double _startSecondsthree = 000000000000000000000000000111;
const String _videoIdfour = 'https://youtu.be/wjaIRPAxGgA?t=';
const double _startSecondsfour = 000000000000000000000000000148;
const String _videoIdfive = 'https://youtu.be/9KapEXWynrA?t=';
const double _startSecondsfive = 000000000000000000000000000318;
