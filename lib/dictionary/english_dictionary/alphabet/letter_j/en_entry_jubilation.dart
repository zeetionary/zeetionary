...
class EnglishEntryjubilation extends StatefulWidget {
  const EnglishEntryjubilation({super.key});

  @override
  State<EnglishEntryjubilation> createState() => _EnglishEntryjubilationState();
}

class _EnglishEntryjubilationState extends State<EnglishEntryjubilation> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""jubilation""");
  }
