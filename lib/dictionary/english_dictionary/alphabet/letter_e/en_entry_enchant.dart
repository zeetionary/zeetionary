...
class EnglishEntryenchant extends StatefulWidget {
  const EnglishEntryenchant({super.key});

  @override
  State<EnglishEntryenchant> createState() => _EnglishEntryenchantState();
}

class _EnglishEntryenchantState extends State<EnglishEntryenchant> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("enchant");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "enchant",
                      // alsoEnglishWord: "also: enchant",
                      britshText: "IpaUK: /ɪnˈtʃɑːnt/",
                      americanText: "IpaUS: /ɪnˈtʃænt/",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The happy family scene had enchanted him.");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The play enchanted all who watched it.");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She enchanted the prince with her magic.");
  }
...
// کوردی: جادوو کردن، جادووگەریی کردن
// """),
          const DefinitionKurdish(
              text: """١. (کردار) سەرسامکردنی کەسێک بە ئاستێکی زۆر"""),
          SentencesRow(
            englishText: """The happy family scene had enchanted him.""",
            kurdishText: """دیمەنی خێزانە دڵخۆشەکە سەرسامی کردبوو.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerSentences(),
          SentencesRow(
            englishText: """The play enchanted all who watched it.""",
            kurdishText: """شانۆکە هەموو ئەوانەی سەرسام کرد کە سەیریان کرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: enchant (Derived forms: enchanted, enchanting, enchants)
1. Hold spellbound (= enrapture, transport, enthrall [US], ravish [literary], enthral [Brit, Cdn], entrance, captivate)
 
2. Cause rapt attraction or admiration; attract love (= capture, enamour [Brit, Cdn], trance, catch, becharm [archaic], enamor [US], captivate, beguile, charm, fascinate, bewitch, entrance)
"She enchanted all the men's hearts";
 
3. Cast a spell over someone or something; put a hex on someone or something (= hex, bewitch, glamour, witch, jinx)
""",
  );
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/cvrYEJ4gG8U?t=';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/Kq0MttfIZzY?t=';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/BsbVPgh9VWA?t=';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/r9PPgAvXkEY?t=';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/GJbmzqsjW8g?t=';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/sT0gJbZDvL4?t=';
