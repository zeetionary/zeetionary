...
class EnglishEntrylean extends StatefulWidget {
  const EnglishEntrylean({super.key});

  @override
  State<EnglishEntrylean> createState() => _EnglishEntryleanState();
}

class _EnglishEntryleanState extends State<EnglishEntrylean> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: lean (Derived forms: leaning, leans, leaned, leant)
1. To incline or bend from a vertical position (- tilt, tip, slant, angle)
 
2. Cause to incline or bend
 
3. Have a tendency or disposition to do or be something; be inclined (- tend, be given, incline, run)
 
4. Rely on for support
"We can lean on this man"
 
5. Cause to lean to the side (- list)
"Erosion leant the old tree";

- Adjective: lean (Derived forms: leaner, leanest)
1. Lacking excess flesh (- thin, meager [N. Amer], meagre [Brit, Cdn])
"Yon Cassius has a lean and hungry look";
 
2. Lacking in mineral content or combustible material
"lean ore"; "lean fuel"
 
3. Containing little excess (- skimpy)
"a lean budget";
 
4. Not profitable or prosperous
"a lean year"

- Noun: lean (Derived forms: leans)
1. The property possessed by a line or surface that departs from the vertical (- tilt, list, inclination, leaning)
"the tower had a pronounced lean";
""",
  );

  final String keyword = "lean";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She leaned forward and whispered something in his ear.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He leaned over and kissed her.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She leaned in to listen.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A man was leaning out of the window.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The tower is leaning dangerously.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He leaned towards her.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She leaned to one side.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A shovel was leaning against the wall.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The man was leaning heavily on a stick.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He walked slowly, leaning on his daughter's arm.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Can I lean my bike against the wall?""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She leaned her head against his shoulder.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He leaned his elbows on the table and sighed.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He had a lean, muscular body.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was tall, lean and handsome.""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She cooked a lean, tender piece of beef for dinner.""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The company recovered well after going through several lean years.""");
  }
  ...
  Future<void> speaksentence18(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This is the leanest time of the year for the tourist industry.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/_wNsZEqpKUA?t=1220';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/khOUvmOQExc?t=142';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/rWFRxEr6eQ8?t=4';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/ea4Tq7HB7kU?t=167';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/dtp6b76pMak?t=243';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/dgxPlUgIqSA?t=587';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lean""",
                      // alsoEnglishWord: "also: lean",
                      britshText: """IpaUK: /liːn/""",
                      americanText: """IpaUS: /liːn/""",
...
کوردی: لاری، خواری،	داشکانەوە، لاربوونەوە، بنێس، ڕەقەڵ، لەڕ، کز، داڵگۆشت،	کەم‌بڕ، بێ‌پیت، بێ‌بەرەکەت، بێ‌خێر، وشک، بێ‌مایە، کەم‌بڕشت، کەم‌بەرهەم، بێ‌بەرهەم،	خراپ
"""),
// With short examples define "lean", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) چەمانەوە"""),
                    SentencesRow(
                      englishText: """She leaned forward and whispered something in his ear.""",
                      kurdishText: """بۆ پێشەوە چەمایەوە و شتێکی چرپاند بە گوێیدا.""",
                    ...
                    SentencesRow(
                      englishText: """He leaned over and kissed her.""",
                      kurdishText: """چەمایەوە و ماچی کرد.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She leaned in to listen.""",
                      kurdishText: """چەمایەوە بۆ ئەوەی گوێ بگرێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """A man was leaning out of the window.""",
                      kurdishText: """پیاوێک لە پەنجەرەکەوە بۆ دەرەوە خۆی چەماندبووەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The tower is leaning dangerously.""",
                      kurdishText: """تاوەرەکە بە مەترسیدارانە لار بووەتەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He leaned towards her.""",
                      kurdishText: """بەرەو لای چەمایەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She leaned to one side.""",
                      kurdishText: """بەرەو لایەک چەمایەوە.""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) خۆدان بەسەر شتێکدا بۆ ئەوەی ڕابوەستیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """A shovel was leaning against the wall.""",
                      kurdishText: """بێڵێک بە دیوارەکەوە ڕاوەستابوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The man was leaning heavily on a stick.""",
                      kurdishText: """پیاوەکە خۆی پاڵدابوو بەسەر دارێکدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He walked slowly, leaning on his daughter's arm.""",
                      kurdishText: """بە هێواشی ڕێی دەکرد و خۆی دابوو بەسەر شانی کچەکەیدا.""",
                      onPressedBritish: () => speaksentence10("en-GB"),
                      onPressedAmerican: () => speaksentence10("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) واکردنی ئەوەی شتێک بکەوێت بەسەر شتێکی دیکەدا و بە لاری بوەستێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Can I lean my bike against the wall?""",
                      kurdishText: """دەتوانم پاسکیلەکەم پاڵ بدەم بە دیوارەکەوە؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She leaned her head against his shoulder.""",
                      kurdishText: """سەری خستبووە سەر شانی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He leaned his elbows on the table and sighed.""",
                      kurdishText: """دەستەکانی خستە سەر مێزەکە و هەناسەیەکی هەڵکێشا.""",
                      onPressedBritish: () => speaksentence13("en-GB"),
                      onPressedAmerican: () => speaksentence13("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (هاوەڵناو) (خەڵکی، بە تایبەتی پیاوان، و ئاژەڵان) باریک و وەرزشی بەبێ چەوری"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He had a lean, muscular body.""",
                      kurdishText: """جەستەیەکی باریک و بەهێزی هەبوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He was tall, lean and handsome.""",
                      kurdishText: """باڵابەرز و باریک و جوان بوو.""",
                      onPressedBritish: () => speaksentence15("en-GB"),
                      onPressedAmerican: () => speaksentence15("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (هاوەڵناو) گۆشتێک کە چەوری زۆری تێدا نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She cooked a lean, tender piece of beef for dinner.""",
                      kurdishText: """پارچە گۆشتێکی سووری تەنک و نەرمی بۆ نانی ئێوارە ئامادەکرد.""",
                      onPressedBritish: () => speaksentence16("en-GB"),
                      onPressedAmerican: () => speaksentence16("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٦. (هاوەڵناو) ماوەیەکی سەخت کە پارە، خواردن، هتد ــی زۆر بەرهەم نایەت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The company recovered well after going through several lean years.""",
                      kurdishText: """کۆمپانیاکە زوو هەستایەوە لەدوای تێپەڕبوون بە هەندێک ساڵی بێ‌مایە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """This is the leanest time of the year for the tourist industry.""",
                      kurdishText: """ئەمە بێ‌پیتترین کاتی ساڵە بۆ پیشەسازی گەشتیاری.""",
