...
class EnglishEntryabsorbent extends StatefulWidget {
  const EnglishEntryabsorbent({super.key});

  @override
  State<EnglishEntryabsorbent> createState() => _EnglishEntryabsorbentState();
}

class _EnglishEntryabsorbentState extends State<EnglishEntryabsorbent> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "absorbent";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""absorbent""");
  }
  ...
  Future<void> speaka2473(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("The towels are highly absorbent.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """absorbent""",
                      // alsoEnglishWord: "also: absorbent",
                      britshText: """IpaUK: /əbˈzɔːbənt/""",
                      americanText: """IpaUS: /əbˈzɔːrbənt/""",
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'LOvqztX0M5I';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'ATwD5WZmR1g';
