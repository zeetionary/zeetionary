...
class EnglishEntryfreeforall extends StatefulWidget {
  const EnglishEntryfreeforall({super.key});

  @override
  State<EnglishEntryfreeforall> createState() => _EnglishEntryfreeforallState();
}

class _EnglishEntryfreeforallState extends State<EnglishEntryfreeforall> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: free-for-all (Derived forms: free-for-alls)
1. A noisy fight in a crowd (= brawl, stoush [Austral, NZ, informal], bagarre [rare])
 
2. A chaotic or unrestricted situation
""",
  );

  final String keyword = "free-for-all";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""free-for-all""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """free-for-all""",
                      // alsoEnglishWord: "also: free-for-all",
                      britshText: """IpaUK: /ˈfriː fər ɔːl/""",
                      americanText: """IpaUS: /ˈfriː fər ɔːl/""",
...
// With short examples define "free-for-all", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دۆخێک کە تێیدا هیچ یاسایەک نییە و هەموان بۆ سوودی خۆیان کار دەکەن"""),
                    SentencesRow(
                      englishText:
                          """The lowering of trade barriers has led to a free-for-all among exporters.""",
                      kurdishText:
                          """کەمکردنەوەی سنوورداریی بازرگانی بووە بە هۆکاری هەرکێ بۆ خۆیی لە نێوان هەناردەکاراندا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Prompt action by prison staff prevented a violent free-for-all.""",
                      kurdishText:
                          """کاردانەوەی خێرای کارمەندانی بەندیخانە ڕێگری لە ڕوودانی شەڕ و ئاژاوەیەکی توندوتیژ کرد.""",
...
const double _startSecondsend = 0000000000000000000000000002005;
const String _videoIdone = 'https://youtu.be/Aiqa9l1vFNI?t=';
const double _startSecondsone = 0000000000000000000000000001162;
const String _videoIdtwo = 'https://youtu.be/-RjMiWVWJmE?t=';
const double _startSecondstwo = 000000000000000000000000000637;
const String _videoIdthree = 'https://youtu.be/EF-9I38ud4s?t=';
const double _startSecondsthree = 000000000000000000000000000243;
const String _videoIdfour = 'https://youtu.be/EOY1LVjohrw?t=';
const double _startSecondsfour = 000000000000000000000000000538;
const String _videoIdfive = 'https://youtu.be/XrnQiwYqKvQ?t=';
