...
class EnglishEntryenforcement extends StatefulWidget {
  const EnglishEntryenforcement({super.key});

  @override
  State<EnglishEntryenforcement> createState() =>
      _EnglishEntryenforcementState();
}

class _EnglishEntryenforcementState extends State<EnglishEntryenforcement> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enforcement""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enforcement""",
                      // alsoEnglishWord: "also: enforcement",
                      britshText: """IpaUK: /ɪnˈfɔːsmənt/""",
                      americanText: """IpaUS: /ɪnˈfɔːrsmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enforcement";
...
کوردی: جێبەجێ‌کردن، بەجێ‌هێنان، ڕاپەڕاندن، کارپێ‌کردن، پیادەکردن، داسەپاندن، پێکردن،	بەهێزکردن
"""),
          const DefinitionKurdish(text: """١. (ناو) جێبەجێکردنی یاساییەک"""),
          SentencesRow(
            englishText:
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: enforcement (Derived forms: enforcements)
...
const double _startSecondsend = 290;
const String _videoIdone = 'https://youtu.be/raSeaAeryWE?t=';
const double _startSecondsone = 1761;
const String _videoIdtwo = 'https://youtu.be/VRJzvJ5XPQI?t=';
const double _startSecondstwo = 307;
const String _videoIdthree = 'https://youtu.be/FQ4hvLqNfqo?t=';
const double _startSecondsthree = 1238;
const String _videoIdfour = 'https://youtu.be/8sQDCdiuX9U?t=';
const double _startSecondsfour = 53;
const String _videoIdfive = 'https://youtu.be/380Zqbi9luo?t=';
const double _startSecondsfive = 28;
const String _videoIdsix = 'https://youtu.be/KT18KJouHWg?t=';
const double _startSecondssix = 618;
