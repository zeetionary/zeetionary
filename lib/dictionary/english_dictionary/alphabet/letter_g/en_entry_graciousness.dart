...
class EnglishEntrygraciousness extends StatefulWidget {
  ...
  @override
  State<EnglishEntrygraciousness> createState() =>
      _EnglishEntrygraciousnessState();
}
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His humility and graciousness have won our hearts.""");
  }
...
// With short examples define "graciousness", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سادەیی و دلۆڤانییەکەی دڵمانی بەدەست ھێناوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The house retains its air of tranquillity and graciousness.""",
                      kurdishText:
                          """خانووەکە ھێشتا کەشی ئارامی و شکۆمەندی خۆی پاراستووە.""",
...
// 188888880002200
const String _videoIdend = '6p0qaIHMNK0?t=';
const double _startSecondsend = 454;
const String _videoIdone = 'NCeu5Wy-oVI?t=';
const double _startSecondsone = 680;
const String _videoIdtwo = 'P-NTz99Yu74?t=';
const double _startSecondstwo = 105;
const String _videoIdthree = 'qkmJ2i4kZ1c?t=';
const double _startSecondsthree = 973;
const String _videoIdfour = 'gXEWgXNmi-8?t=';
const double _startSecondsfour = 638;
const String _videoIdfive = '96mL1Lmf5Ik?t=';
