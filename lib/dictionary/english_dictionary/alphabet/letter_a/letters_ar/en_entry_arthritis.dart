...
class EnglishEntryarthritis extends StatelessWidget {
  ...
  Future<void> speakarthritis(String languageCode) async {
    ...
    await flutterTts.speak("arthritis");
  }
  ...
  Future<void> speakarthritis450(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("It is unclear why some people develop arthritis.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arthritis"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ɑːˈθraɪtɪs/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ɑːrˈθraɪtɪs/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakarthritis450("en-US"),
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '8B8WZArsTeY';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'PUoRZyIyO6A';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '_RN3AVn2ovM';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'L9XlFNV6Ghg';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'aWrLX4otJAU';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'gCjN1Rya6es';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'tRnqF-AFFdw';
  final double _startSeconds = 1;
