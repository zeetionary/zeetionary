                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "allege"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈledʒ/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈledʒ/"),
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'hzNo5lZCq5M';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'UZ4BGhCShNM';
