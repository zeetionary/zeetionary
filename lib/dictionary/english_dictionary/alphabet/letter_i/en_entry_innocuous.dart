...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'LxdoC2sG1i4';
    const double startSecondsend = 615;
    const String videoIdone = 'MqyJZsGFZ3M';
    const double startSecondsone = 127;
    const String videoIdtwo = 'RZt7kE7PZMQ';
    const double startSecondstwo = 445;
    const String videoIdthree = 'EmT0i0xG6zg';
    const double startSecondsthree = 2416;
    const String videoIdfour = 'gRuarpWsKHY';
    const double startSecondsfour = 158;
    const String videoIdfive = 'cDFFis0j4JM';
    const double startSecondsfive = 239;
