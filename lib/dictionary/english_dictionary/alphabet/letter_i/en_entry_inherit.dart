...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 921;
    const String videoIdtwo = 'KZbzIf_C6Y4';
    const double startSecondstwo = 2073;
    const String videoIdthree = 'FkKPsLxgpuY';
    const double startSecondsthree = 1038;
    const String videoIdfour = 'Uki1czS3tRg';
    const double startSecondsfour = 259;
    const String videoIdfive = '3yvxFFsjcYs';
    const double startSecondsfive = 517;
