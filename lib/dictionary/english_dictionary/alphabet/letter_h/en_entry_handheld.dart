...
class EnglishEntryhandheld extends StatefulWidget {
  const EnglishEntryhandheld({super.key});

  @override
  State<EnglishEntryhandheld> createState() => _EnglishEntryhandheldState();
}

class _EnglishEntryhandheldState extends State<EnglishEntryhandheld> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: handheld 
1. Small and light enough to be operated while you hold it in your hands (- hand-held)
"a handheld computer";
""",
  );

  final String keyword = "handheld";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""handheld""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Handheld cameras can be used for street photography.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """handheld""",
                      // alsoEnglishWord: "also: handheld",
                      britshText: """IpaUK: /ˈhændheld/""",
                      americanText: """IpaUS: /ˈhændheld/""",
...
// """),
                    ...
                    SentencesRow(
                      englishText:
                          """Versions of the game were released for consoles and handhelds.""",
                      kurdishText:
                          """وەشانەکانی یارییەکە لەسەر کۆنسۆڵ و ئامێرە دەستییەکان بڵاوکرانەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کامێرای دەستی دەکرێت بۆ وێنەگریی سەرشەقام بەکاربێت.""",
