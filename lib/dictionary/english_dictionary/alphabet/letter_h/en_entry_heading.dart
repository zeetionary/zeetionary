...
class EnglishEntryheading extends StatefulWidget {
  const EnglishEntryheading({super.key});

  @override
  State<EnglishEntryheading> createState() => _EnglishEntryheadingState();
}

class _EnglishEntryheadingState extends State<EnglishEntryheading> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heading (Derived forms: headings)
...
3. (mining) a horizontal (or nearly horizontal) passageway in a mine (- drift, gallery)
""",
  );

  final String keyword = "heading";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We can examine these issues under four headings.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heading""",
                      // alsoEnglishWord: "also: heading",
                      britshText: """IpaUK: /ˈhedɪŋ/""",
                      americanText: """IpaUS: /ˈhedɪŋ/""",
...
کوردی: سەربەش، سەرپەڕ، سەرپاژ، سەرباس، سەرنامە،	بەش، پشک،	سەرپۆش، سەر، درگا، داڵان،	ڕەهۆڵ
"""),
// With short examples define "heading", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ناونیشانێک کە لە بەشی سەرەوەی پەڕەیەک دانراوە یان لە سەرەتای بەشی پەڕەیەک"""),
                    SentencesRow(
                      englishText:
                          """Books should be listed under a broader heading such as ‘engineering’.""",
                      kurdishText:
                          """کتێب دەبێت دابندرێت لە لیستی فراوانتری وەک 'ئەندازیاری'.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) بابەتی هەر بەشێکی وتارێک یان پارچە نووسینێک"""),
                    SentencesRow(
                      englishText:
                          """We can examine these issues under four headings.""",
                      kurdishText:
                          """دەتوانین لە ژێر چوار بابەتدا لەم کێشانە بکۆڵینەوە.""",
...
const double _startSecondsend = 000000000000000000000000000723;
const String _videoIdone = 'https://youtu.be/aqPvVxxIDr0?t=';
const double _startSecondsone = 0000000000000000000000000001555;
const String _videoIdtwo = 'https://youtu.be/wG8gYDWj-mg?t=';
const double _startSecondstwo = 000000000000000000000000000209;
const String _videoIdthree = 'https://youtu.be/AqqaYs7LjlM?t=';
const double _startSecondsthree = 000000000000000000000000000825;
const String _videoIdfour = 'https://youtu.be/-BNDub3h2_I?t=';
const double _startSecondsfour = 0000000000000000000000000002879;
const String _videoIdfive = 'https://youtu.be/8T_qrsTWnyk?t=';
const double _startSecondsfive = 000000000000000000000000000365;
