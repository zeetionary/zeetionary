...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'eo62AEDwTKY';
    const double startSecondsend = 28;
    const String videoIdone = 'V2ec7EE0pB8';
    const double startSecondsone = 1389;
    const String videoIdtwo = '9hv3CcJYMmU';
    const double startSecondstwo = 523;
    const String videoIdthree = 'RzG-yFh1XGs';
    const double startSecondsthree = 163;
    const String videoIdfour = 'nSMNKrJIm2I';
    const double startSecondsfour = 332;
    const String videoIdfive = 'ISqjBMXuBe4';
