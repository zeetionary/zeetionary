...
class EnglishEntrylimpness extends StatefulWidget {
  const EnglishEntrylimpness({super.key});

  @override
  State<EnglishEntrylimpness> createState() => _EnglishEntrylimpnessState();
}

class _EnglishEntrylimpnessState extends State<EnglishEntrylimpness> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylimpness limpness
WORD_WEB limpness limpness limpness
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "limpness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""limpness""");
  }
...
کوردی: 
"""),
// With short examples define "limpness", please follow LX instructions
