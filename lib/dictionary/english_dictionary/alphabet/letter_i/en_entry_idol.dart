...
class EnglishEntryidol extends StatefulWidget {
  const EnglishEntryidol({super.key});

  @override
  State<EnglishEntryidol> createState() => _EnglishEntryidolState();
}

class _EnglishEntryidolState extends State<EnglishEntryidol> {
  @override
  void initState() {
    super.initState();
