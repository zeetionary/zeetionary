...
class EnglishEntryjeans extends StatefulWidget {
  const EnglishEntryjeans({super.key});

  @override
  State<EnglishEntryjeans> createState() => _EnglishEntryjeansState();
}

class _EnglishEntryjeansState extends State<EnglishEntryjeans> {
  @override
  void initState() {
    super.initState();
