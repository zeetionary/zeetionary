...
class EnglishEntryfootballpools extends StatefulWidget {
  const EnglishEntryfootballpools({super.key});

  @override
  State<EnglishEntryfootballpools> createState() =>
      _EnglishEntryfootballpoolsState();
}

class _EnglishEntryfootballpoolsState extends State<EnglishEntryfootballpools> {
  @override
  void initState() {
    super.initState();
...
- Noun: football pools
Usage: Brit
1. A competition in which people try to predict the results of football matches and win money
""",
  );

  final String keyword = "football pools";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""football pools""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They've had a big win on the football pools.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """football pools""",
                      // alsoEnglishWord: "also: football pools",
                      britshText: """IpaUK: /ˈfʊtbɔːl puːlz/""",
                      americanText: """IpaUS: /ˈfʊtbɔːl puːlz/""",
...
// With short examples define "football pools", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بردنەوەی گەورەیان هەبوو لە گرەوکردنی تۆپێن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/FuxuaZY91ts?t=';
const double _startSecondsend = 000000000000000000000000000177;
const String _videoIdone = 'https://youtu.be/CWWqTDLniIU?t=';
const double _startSecondsone = 000000000000000000000000000515;
const String _videoIdtwo = 'https://youtu.be/hFGyWsY9aHY?t=';
const double _startSecondstwo = 0000000000000000000000000001454;
const String _videoIdthree = 'https://youtu.be/V-PKglUoPt4?t=';
const double _startSecondsthree = 000000000000000000000000000296;
const String _videoIdfour = 'https://youtu.be/xsn1S-fVJw0?t=';
const double _startSecondsfour = 000000000000000000000000000166;
const String _videoIdfive = 'https://youtu.be/yP3uPQPsrys?t=';
