...
class EnglishEntryhighcourt extends StatefulWidget {
  const EnglishEntryhighcourt({super.key});

  @override
  State<EnglishEntryhighcourt> createState() => _EnglishEntryhighcourtState();
}

class _EnglishEntryhighcourtState extends State<EnglishEntryhighcourt> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: high court (Derived forms: high courts)
1. (law) the highest court in most states of the United States (- supreme court, state supreme court)
""",
  );

  final String keyword = "high court";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""high court""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was appointed a high court judge in 2018.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """It took the intervention of the high court for a winner in the election to be declared.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """high court""",
                      // alsoEnglishWord: "also: high court",
                      britshText: """IpaUK: /ˌhaɪ ˈkɔːt/""",
                      americanText: """IpaUS: /ˌhaɪ ˈkɔːrt/""",
...
// With short examples define "high court", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """وەک دادوەرێکی داگای باڵا دیاری کرا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) بەرزترین دادگای وڵات یان ویلایەتێک"""),
                    const AlsoEnglishckb(
                        word: "ھەروەھا لە ئەمریکا: Supreme Court"),
                    SentencesRow(
                      englishText:
                          """It took the intervention of the high court for a winner in the election to be declared.""",
                      kurdishText:
                          """دیاریکردنی ڕاگەیاندنی براوەی هەڵبژاردن پێویستی بە تێوەگلانی دادگای باڵا بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/NU4MgeOb-cc?t=';
const double _startSecondsend = 0000000000000000000000000001469;
const String _videoIdone = 'https://youtu.be/P6bVl47kdNk?t=';
const double _startSecondsone = 0000000000000000000000000001843;
const String _videoIdtwo = 'https://youtu.be/QQyup6ZFsvA?t=';
const double _startSecondstwo = 0000000000000000000000000001594;
const String _videoIdthree = 'https://youtu.be/5tKOV0KqPlg?t=';
const double _startSecondsthree = 000000000000000000000000000318;
const String _videoIdfour = 'https://youtu.be/zrMgqr6SmYo?t=';
const double _startSecondsfour = 000000000000000000000000000107;
const String _videoIdfive = 'https://youtu.be/DWbxIFC0Q2o?t=';
const double _startSecondsfive = 000000000000000000000000000940;
