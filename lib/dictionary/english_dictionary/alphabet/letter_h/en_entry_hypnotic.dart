...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'vchJnrZgz-4';
    const double startSecondsend = 849;
    const String videoIdone = 'EkPZx6hjG7E';
    const double startSecondsone = 31;
    const String videoIdtwo = 'fOGdb1CTu5c';
    const double startSecondstwo = 1059;
    const String videoIdthree = 'Wt4LSaUcid4';
    const double startSecondsthree = 43;
    const String videoIdfour = 'ivfspJOAtBI';
    const double startSecondsfour = 922;
    const String videoIdfive = 'E2rtQFAibEA';
    const double startSecondsfive = 10962;
