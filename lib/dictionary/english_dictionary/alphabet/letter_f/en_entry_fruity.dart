...
class EnglishEntryfruity extends StatefulWidget {
  const EnglishEntryfruity({super.key});

  @override
  State<EnglishEntryfruity> createState() => _EnglishEntryfruityState();
}

class _EnglishEntryfruityState extends State<EnglishEntryfruity> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The wine from this region is rich and fruity.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This cheese has a slightly fruity flavour.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was well known for his fruity jokes.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fruity""",
                      // alsoEnglishWord: "also: fruity",
                      britshText: """IpaUK: /ˈfruːti/""",
                      americanText: """IpaUS: /ˈfruːti/""",
...
کوردی: میوەئاسا، میوەیی، میوەتیابوو، بە تامی میوەوە،	(شۆخی، چیرۆک و هتد) هەرزە، ناحەز، ناشیرین، پیس،	(پێکەنین) لە قووڵایی دڵەوە، لە دڵەوە،	کاریگەر
"""),
// With short examples define "fruity", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە بۆن یان تامی میوەی هەیە"""),
                    SentencesRow(
                      englishText:
                          """The wine from this region is rich and fruity.""",
                      kurdishText: """شەرابی ئەم هەرێمە و تامدار و میوەییە.""",
                      englishNote:
                          "This means the wine produced in this specific area has a strong, full flavor and a noticeable taste similar to that of fruit.",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پەنیرەکە کەمێک تامی میوەی هەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """باش ناسرابوو بۆ نوکتە شێتانەکانی.""",
...
const double _startSecondsend = 0000000000000000000000000001080;
const String _videoIdone = 'https://youtu.be/1Gxrwh4zGPg?t=';
const double _startSecondsone = 000000000000000000000000000563;
const String _videoIdtwo = 'https://youtu.be/vJqEYwrcLBs?t=';
const double _startSecondstwo = 000000000000000000000000000173;
const String _videoIdthree = 'https://youtu.be/JX82wa5HkJg?t=';
const double _startSecondsthree = 0000000000000000000000000001400;
const String _videoIdfour = 'https://youtu.be/_dH5MsC_rtM?t=';
const double _startSecondsfour = 00000000000000000000000000010;
const String _videoIdfive = 'https://youtu.be/Jl0IDXkYKbk?t=';
