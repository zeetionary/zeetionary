...
// replace these: replace EnglishEntryafar - replace speakAfar - replace afar - /əˈfɑːr/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryafar extends StatelessWidget {
  EnglishEntryafar({super.key});
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /frəm əˈfɑːr/"),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'UJtVhPkIE28';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'TjAJ64DJgEI';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'Gkb1QMHrGvA';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'RzlaqZOD7rA';
