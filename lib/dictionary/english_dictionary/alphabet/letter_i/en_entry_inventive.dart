...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'm3MgAOe2zSs';
    const double startSecondsend = 500;
    const String videoIdone = '-mgqMpWKEBk';
    const double startSecondsone = 147;
    const String videoIdtwo = 'HZryl5nJr00';
    const double startSecondstwo = 882;
    const String videoIdthree = 'ShMRAN78598';
    const double startSecondsthree = 176;
    const String videoIdfour = 'ill2cgCyTUc';
    const double startSecondsfour = 627;
    const String videoIdfive = 'J2eU4Ol3IDU';
