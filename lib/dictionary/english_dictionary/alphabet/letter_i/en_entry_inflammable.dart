...
class EnglishEntryinflammable extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inflammable""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'F3rncxf4Or8';
    const double startSecondsend = 118;
    const String videoIdone = 'v5Zo0mUO-GE';
    const double startSecondsone = 72;
    const String videoIdtwo = 'Mvm8RTdJgq0';
    const double startSecondstwo = 657;
    const String videoIdthree = 'wdPWe6DSszA';
    const double startSecondsthree = 364;
    const String videoIdfour = '-6ANOPGnfcU';
    const double startSecondsfour = 976;
    const String videoIdfive = '_uYppDCWHjM';
