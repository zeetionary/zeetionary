...
class EnglishEntryham extends StatefulWidget {
  const EnglishEntryham({super.key});

  @override
  State<EnglishEntryham> createState() => _EnglishEntryhamState();
}

class _EnglishEntryhamState extends State<EnglishEntryham> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: ham (Derived forms: hams)
1. Meat cut from the thigh of a hog (usually smoked) (- jambon, gammon)
 
2. A licensed amateur radio operator
 
3. An unskilled actor who overacts (- ham actor)
 
4. The back of the thigh

- Verb: ham (Derived forms: hamming, hammed, hams)
1. (dramaturgy) exaggerate one's acting (- overact, ham it up, overplay)
""",
  );

  final String keyword = "ham";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hams were cooked whole.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Would you like another slice of ham?""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His critics wrote him off as a ham actor.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ham""",
                      // alsoEnglishWord: "also: ham",
                      britshText: """IpaUK: /hæm/""",
                      americanText: """IpaUS: /hæm/""",
...
// """),
                    ...
                    SentencesRow(
                      englishText:
                          """A radio ham picked up their signal and called the coastguard.""",
                      kurdishText:
                          """کارپێکەرێکی ڕادیۆ شەپۆلەکەیانی گوێ لێ بوو و پەیوەندی بە پاسەوانی دەریایی کرد.""",
