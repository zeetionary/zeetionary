...
class EnglishEntryexhale extends StatefulWidget {
  const EnglishEntryexhale({super.key});

  @override
  State<EnglishEntryexhale> createState() => _EnglishEntryexhaleState();
}

class _EnglishEntryexhaleState extends State<EnglishEntryexhale> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exhale""",
                      // alsoEnglishWord: "also: exhale",
                      britshText: """IpaUK: /eksˈheɪl/""",
                      americanText: """IpaUS: /eksˈheɪl/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He sat back and exhaled deeply.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She exhaled the smoke through her nose.""");
  }
...
// With short examples define "exhale", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: 
"""),
          const DefinitionKurdish(text: """١. (کردار) هەناسە دانەوە"""),
          SentencesRow(
            englishText: """He sat back and exhaled deeply.""",
            kurdishText: """دانیشتەوە و بەقووڵی هەناسەی دایەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She exhaled the smoke through her nose.""",
            kurdishText: """دووکەڵەکەی لە لووتییەوە دەرکردەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: exhale (Derived forms: exhaling, exhales, exhaled)
1. Expel air (= expire, breathe out)
"Exhale when you lift the weight";
 
2. Give out (breath or an odour) (= give forth, emanate)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/-cPdImejxEQ?t=';
const double _startSecondsend = 000000000000000000000000000000; // 260;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/Lc-vyZ6NjtU?t=';
const double _startSecondsone = 00000000000000000000000000000; // 313;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 4711;
const String _videoIdthree = 'VIDEOhttps://youtu.be/_VBNW98c_bU?t=';
const double _startSecondsthree = 000000000000000000000000000; // 318;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/O-6f5wQXSu8?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 17;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/CupbRr2m_sM?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 843;
