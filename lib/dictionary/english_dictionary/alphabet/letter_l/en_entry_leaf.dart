...
class EnglishEntryleaf extends StatefulWidget {
  const EnglishEntryleaf({super.key});

  @override
  State<EnglishEntryleaf> createState() => _EnglishEntryleafState();
}

class _EnglishEntryleafState extends State<EnglishEntryleaf> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A sunflower is a broad-leaved plant.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She carefully turned the leaves of the precious book.""");
  }
...
// With short examples define "leaf", please follow LX instructions
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) هەبوونی ئەو جۆرە گەڵایەی کە باسکراوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """A sunflower is a broad-leaved plant.""",
                      kurdishText: """گوڵەبەڕۆژە ڕووەکێکی گەڵا پانە.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) پارچە کاغەزێک، بە تایبەتی لاپەڕەیەک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She carefully turned the leaves of the precious book.""",
                      kurdishText: """بە وریاییەوە پەڕەکانی کتێبە بەنرخەکەی هەڵدایەوە.""",
