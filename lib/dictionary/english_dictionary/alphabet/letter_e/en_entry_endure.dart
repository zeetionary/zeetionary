...
class EnglishEntryendure extends StatefulWidget {
  const EnglishEntryendure({super.key});

  @override
  State<EnglishEntryendure> createState() => _EnglishEntryendureState();
}

class _EnglishEntryendureState extends State<EnglishEntryendure> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """endure""",
                      // alsoEnglishWord: "also: endure",
                      britshText: """IpaUK: /ɪnˈdjʊə(r)/""",
                      americanText: """IpaUS: /ɪnˈdʊr/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She could not endure the thought of parting.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The pain was almost too great to endure.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He can't endure being defeated.""");
  }
...
// کوردی: خۆڕاگرتن، تاقەتهێنان، پشوو درێژ بوون
// """),
          const DefinitionKurdish(
              text: """١. (کردار) بەرگەگرتنی شتێکی ناخۆش بەبێ وازهێنان"""),
          SentencesRow(
            englishText: """She could not endure the thought of parting.""",
            kurdishText: """نەیدەتوانی بەرگەی بیرکردنەوەی جیابوونەوە بگرێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The pain was almost too great to endure.""",
            kurdishText: """ئازارەکە تا ڕادەیەک زۆر گەورە بوو بۆ بەرگەگرتن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He can't endure being defeated.""",
            kurdishText: """ناتوانێت بەرگەی شکستهێنان بگرێت.""",
            onPressedBritish: () => speaksentence3("en-GB"),
            onPressedAmerican: () => speaksentence3("en-US" ""),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (کردار) بەردەوام بوون لە هەبوون بۆ ماوەیەکی زۆر"""),
          // const DividerSentences(),
          SentencesRow(
            englishText:
                """The political system established in 1400 endured until about 1650.""",
            kurdishText:
                """ئەو سیستەمە سیاسییەی کە لە ١٤٠٠ دامەزرا تاوەکو ١٦٥٠ بەردەوام بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: endure (Derived forms: enduring, endured, endures)
1. Put up with something or somebody unpleasant (= digest, stick out, stomach, bear, stand, tolerate, support, brook, abide, suffer, put up)
"The new secretary had to endure a lot of unprofessional remarks";
 
2. Face and withstand with courage (= weather, brave, brave out)
"She endured the elements";
 
3. Continue to live and avoid dying (= survive, last, live, live on, go, hold up, hold out)
"These superstitions endure in the backwaters of America";
 
4. Undergo or be subjected to (= suffer)
"He endured the penalty";
 
5. Last and be usable (= wear, hold out)
"This dress endured well for almost ten years";
 
6. Persist for a specified period of time (= last)
"The bad weather endured for three days";
 
7. Continue to exist (= prevail, persist, die hard, run)
...
const String _videoIdend = 'https://youtu.be/ngTcyNtDjE8?t=';
const double _startSecondsend = 472;
const String _videoIdone = 'https://youtu.be/_0RTH57v66I?t=';
const double _startSecondsone = 281;
const String _videoIdtwo = 'https://youtu.be/yWhU40m-6uU?t=';
const double _startSecondstwo = 136;
const String _videoIdthree = 'https://youtu.be/JcpboMScfIY?t=';
const double _startSecondsthree = 5541;
const String _videoIdfour = 'https://youtu.be/VjFFrYEZsAQ?t=';
const double _startSecondsfour = 427;
const String _videoIdfive = 'https://youtu.be/drhDGeNauuo?t=';
const double _startSecondsfive = 1433;
const String _videoIdsix = 'https://youtu.be/J_n1FZaKzF8?t=';
const double _startSecondssix = 332;
