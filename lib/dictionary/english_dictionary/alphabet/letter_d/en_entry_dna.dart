...
class EnglishEntrydna extends StatefulWidget {
  const EnglishEntrydna({super.key});

  @override
  State<EnglishEntrydna> createState() => _EnglishEntrydnaState();
}

class _EnglishEntrydnaState extends State<EnglishEntrydna> {
  @override
  void initState() {
    super.initState();
    _initDatabase();
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "DNA");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: DNA");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /ˌdiː en ˈeɪ/");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakDNA(String languageCode) async {
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /ˌdiː en ˈeɪ/");
  }
}
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakDNAs1(String languageCode) async {
    // DOPSUM: CHANGE speakDNA
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
  ...
  Future<void> speakDNAs2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The desire to win is part of his DNA."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakDNAs3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I didn't think it was in my DNA to get on stage and sing like that."); // DOPSUM: CHANGE TEXT
  }
...
// کوردی: 
// """),
          const DefinitionKurdish(text: "١. (ناو) مادەی کیمیایی لە خانەی ڕووەک و گیانلەبەر کە جینی زانیاری هەڵدەگرێت"),
          Row(
            children: [
              const Expanded(
                child: Column(
                  children: [
                    ...
                    ExampleSentenceKurdish(text: "پشکنینێکی دی‌ئێن‌ئەی ئەوەی دڵنیاکردەوە کە گومانلێکراوەکە لە شوێنی تاوانە بوو."),
                  ],
                ),
              ),
          ...
          const DividerDefinition(),
          const DefinitionKurdish(text: "٢. (ناو) ئەو خاسیەت و تایبەتمەندییانەی کە بەشێکن لە ناسنامەی کەسێک"),
          // const DividerSentences(),
          Row(
            children: [
              const Expanded(
                child: Column(
                  children: [
                    ExampleSentenceEnglish(text: "The desire to win is part of his DNA."),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs3("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs3("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs400"),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs4("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs4("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs500"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs5("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs5("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs600"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs6("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs6("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs700"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs7("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs7("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs800"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs8("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs8("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs900"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs9("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs9("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs_1000"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs10("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs10("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs1100"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs11("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs11("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs1200"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs12("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs12("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs1300"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs13("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs13("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs1400"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs14("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs14("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs1500"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs15("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs15("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs1600"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs16("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs16("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs1700"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs17("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs17("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs1800"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs18("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs18("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs1900"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs19("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs19("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs_2000"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs20("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs20("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs2100"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs21("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs21("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakDNAs2200"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakDNAs22("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakDNAs22("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/PfoxQSdGND8?t=',
    startSeconds: 82,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
