...
class EnglishEntryinexcusable extends StatefulWidget {
  const EnglishEntryinexcusable({super.key});

  @override
  State<EnglishEntryinexcusable> createState() =>
      _EnglishEntryinexcusableState();
}

class _EnglishEntryinexcusableState extends State<EnglishEntryinexcusable> {
  @override
  void initState() {
    super.initState();
...
2. Not excusable (- unforgivable)
"the blatancy of his attempt to whitewash the crime was inexcusable";
""",
  );

  final String keyword = "inexcusable";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inexcusable""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/V-4NPyqpTOA?t=';
    const double startSecondsend = 0000000000000000000000000002;
    const String videoIdone = 'https://youtu.be/V3PK_fBIzBM?t=';
    const double startSecondsone = 0000000000000000000000000001192;
    const String videoIdtwo = 'https://youtu.be/p3368WAl0qM?t=';
    const double startSecondstwo = 0000000000000000000000000001587;
    const String videoIdthree = 'https://youtu.be/Wc5aBPYFjFI?t=';
    const double startSecondsthree = 0000000000000000000000000001539;
    const String videoIdfour = 'https://youtu.be/ccpzkvUHXJc?t=';
    const double startSecondsfour = 00000000000000000000000000084;
    const String videoIdfive = 'https://youtu.be/ZZxnDCJTOxs?t=';
    const double startSecondsfive = 0000000000000000000000000001369;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inexcusable""",
                      // alsoEnglishWord: "also: inexcusable",
                      britshText: """IpaUK: /ˌɪnɪkˈskjuːzəbl/""",
                      americanText: """IpaUS: /ˌɪnɪkˈskjuːzəbl/""",
...
کوردی: بێجێ، نەبەخشراو، نابەخشرێ، لەپاساونەهاتوو
"""),
// With short examples define "inexcusable", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) زۆر خراپ کە پەسەند بکرێت یان شیاوی لێخۆشبوون بێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: unjustifiable"),
                    SentencesRow(
                      englishText:
                          """The high level of disorganization at the hospital is inexcusable.""",
                      kurdishText:
