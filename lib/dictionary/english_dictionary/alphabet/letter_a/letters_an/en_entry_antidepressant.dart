...
// replace these: replace EnglishEntryantidepressant - replace speakAntidepressant - replace antidepressant - /ˌæntidɪˈpresnt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryantidepressant extends StatelessWidget {
  // blank divider
  EnglishEntryantidepressant({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "antidepressant"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌæntidɪˈpresnt/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'FRiKK-FH7So';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '3XEe_NeCmec';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final double _startSeconds = 5744;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'tY5f8zltSEU';
