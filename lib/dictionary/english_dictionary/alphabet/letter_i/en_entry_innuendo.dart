...
class EnglishEntryinnuendo extends StatefulWidget {
  const EnglishEntryinnuendo({super.key});

  @override
  State<EnglishEntryinnuendo> createState() => _EnglishEntryinnuendoState();
}

class _EnglishEntryinnuendoState extends State<EnglishEntryinnuendo> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""innuendo""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '3aG3WroJHlk';
    const double startSecondsend = 132;
    const String videoIdone = 'bnnRIrxGGX8';
    const double startSecondsone = 1075;
    const String videoIdtwo = 'EmT0i0xG6zg';
    const double startSecondstwo = 2046;
    const String videoIdthree = 'WwhyZUlmaWA';
    const double startSecondsthree = 1884;
    const String videoIdfour = 'o3QSAgwux5Q';
    const double startSecondsfour = 578;
    const String videoIdfive = 'K3OFzBEZuyM';
    const double startSecondsfive = 1802;
