...
class EnglishEntrykm extends StatefulWidget {
  const EnglishEntrykm({super.key});

  @override
  State<EnglishEntrykm> createState() => _EnglishEntrykmState();
}

class _EnglishEntrykmState extends State<EnglishEntrykm> {
  @override
  void initState() {
    super.initState();
...
کوردی: 
"""),
// With short examples define "km", please follow LX instructions
