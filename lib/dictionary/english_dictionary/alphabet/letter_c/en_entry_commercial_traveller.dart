...
// blank divider
  ...
  Future<void> speakcommercialtraveller(String languageCode) async {
    ...
    await flutterTts.speak("commercial traveller");
  }
  ...
  Future<void> speakcommercialtravellers2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcommercialtravellers200");
  }
  ...
  Future<void> speakcommercialtravellers3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcommercialtravellers300");
  }
  ...
  Future<void> speakcommercialtravellers4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcommercialtravellers400");
  }
  ...
  Future<void> speakcommercialtravellers5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcommercialtravellers500");
  }
  ...
  Future<void> speakcommercialtravellers6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcommercialtravellers600");
  }
  ...
  Future<void> speakcommercialtravellers7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcommercialtravellers700");
  }
  ...
  Future<void> speakcommercialtravellers8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcommercialtravellers800");
  }
  ...
  Future<void> speakcommercialtravellers9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcommercialtravellers900");
  }
  ...
  Future<void> speakcommercialtravellers10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcommercialtravellers1000");
  }
  ...
  Future<void> speakcommercialtravellers11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcommercialtravellers1100");
  }
  ...
  Future<void> speakcommercialtravellers12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcommercialtravellers1200");
  }
  ...
  Future<void> speakcommercialtravellers13(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcommercialtravellers1300");
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUK: /kəˌmɜːʃl ˈtrævələ(r)/"),
                            CustomIconButtonBritish(
                              onPressed: () =>
                                  speakcommercialtraveller("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUS: /kəˌmɜːrʃl ˈtrævələr/"),
                            CustomIconButtonAmerican(
                              onPressed: () =>
                                  speakcommercialtraveller("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class _YoutubeEmbeddedendState extends State<YoutubeEmbeddedend> {
  ...
  final String _videoId = '4v3G10xh4yQ';
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  ...
  final double _startSeconds = 4207;
...
class _YoutubeEmbeddedtwoState extends State<YoutubeEmbeddedtwo> {
  late YoutubePlayerController _controller;
  final String _videoId = '06lO-_CieQQ';
...
class _YoutubeEmbeddedthreeState extends State<YoutubeEmbeddedthree> {
  late YoutubePlayerController _controller;
  final String _videoId = 'a_XE1FsaWBA';
...
class _YoutubeEmbeddedfourState extends State<YoutubeEmbeddedfour> {
  late YoutubePlayerController _controller;
  final String _videoId = 'G049wsu-gpI';
  final double _startSeconds = 12018;
...
class _YoutubeEmbeddedfiveState extends State<YoutubeEmbeddedfive> {
  late YoutubePlayerController _controller;
  final String _videoId = 'RAv1O0g7lbM';
  final double _startSeconds = 11562;
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  late YoutubePlayerController _controller;
  final String _videoId = 'mpDtuFyYS8o';
