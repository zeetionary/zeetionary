...
class EnglishEntryirritable extends StatefulWidget {
  const EnglishEntryirritable({super.key});

  @override
  State<EnglishEntryirritable> createState() => _EnglishEntryirritableState();
}

class _EnglishEntryirritableState extends State<EnglishEntryirritable> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""irritable""");
  }
