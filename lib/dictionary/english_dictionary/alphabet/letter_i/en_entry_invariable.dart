...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'LFaTLCqBi4A';
    const double startSecondsend = 172;
    const String videoIdone = 'yFqpWGL_EQE';
    const double startSecondsone = 372;
    const String videoIdtwo = 'ycmqorBo-Ts';
    const double startSecondstwo = 720;
    const String videoIdthree = 'XbPI6vjMtsM';
    const double startSecondsthree = 183;
    const String videoIdfour = 'GMeLHAuyxIw';
    const double startSecondsfour = 18;
    const String videoIdfive = 'jCPSxk7T0OA';
