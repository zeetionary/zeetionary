...
class EnglishEntryfreezingpoint extends StatefulWidget {
  const EnglishEntryfreezingpoint({super.key});

  @override
  State<EnglishEntryfreezingpoint> createState() =>
      _EnglishEntryfreezingpointState();
}

class _EnglishEntryfreezingpointState extends State<EnglishEntryfreezingpoint> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: freezing point (Derived forms: freezing points)
1. The temperature below which a liquid turns into a solid (= melting point)
""",
  );

  final String keyword = "freezing point";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""freezing point""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """freezing point""",
                      // alsoEnglishWord: "also: freezing point",
                      britshText: """IpaUK: /ˈfriːzɪŋ pɔɪnt/""",
                      americanText: """IpaUS: /ˈfriːzɪŋ pɔɪnt/""",
...
// With short examples define "freezing point", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Tonight temperatures will fall well below freezing (point).""",
                      kurdishText:
                          """پلەی گەرمی ئەمشەو دادەبەزێتە خوار پلەی بەستن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The temperature dropped below freezing point this afternoon.""",
                      kurdishText:
                          """ئەم دوا نیوەڕۆیە پلەی فەرمی دابەزییە خوار پلەی سفری سیلیزی.""",
...
const String _videoIdone = 'https://youtu.be/Oj0plwm_NMs?t=';
const double _startSecondsone = 000000000000000000000000000319;
const String _videoIdtwo = 'https://youtu.be/zXgD-KSb5ZM?t=';
const double _startSecondstwo = 000000000000000000000000000178;
const String _videoIdthree = 'https://youtu.be/TNjOaAIz_ZY?t=';
const double _startSecondsthree = 00000000000000000000000000043;
const String _videoIdfour = 'https://youtu.be/KlAl5RHAAns?t=';
const double _startSecondsfour = 00000000000000000000000000020;
const String _videoIdfive = 'https://youtu.be/0_KhihMIOG8?t=';
const double _startSecondsfive = 000000000000000000000000000259;
