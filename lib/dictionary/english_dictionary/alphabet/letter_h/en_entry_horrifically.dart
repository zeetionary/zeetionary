...
class EnglishEntryhorrifically extends StatefulWidget {
  const EnglishEntryhorrifically({super.key});

  @override
  State<EnglishEntryhorrifically> createState() =>
      _EnglishEntryhorrificallyState();
}

class _EnglishEntryhorrificallyState extends State<EnglishEntryhorrifically> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: horrifically
1. To an appalling extent (- appallingly, shockingly)
"the prisoners were horrifically thin";
""",
  );

  final String keyword = "horrifically";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""horrifically""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/ejFccNmL15g?t=';
    const double startSecondsend = 000000000000000000000000000532;
    const String videoIdone = 'https://youtu.be/qCbfTN-caFI?t=';
    const double startSecondsone = 0000000000000000000000000001214;
    const String videoIdtwo = 'https://youtu.be/cykdSb7xqI4?t=';
    const double startSecondstwo = 000000000000000000000000000210;
    const String videoIdthree = 'https://youtu.be/s3ILZlAhHAM?t=';
    const double startSecondsthree = 0000000000000000000000000001254;
    const String videoIdfour = 'https://youtu.be/iGIbM0JbRlE?t=';
    const double startSecondsfour = 000000000000000000000000000321;
    const String videoIdfive = 'https://youtu.be/OnjI-FBdRTQ?t=';
    const double startSecondsfive = 00000000000000000000000000012980;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """horrifically""",
                      // alsoEnglishWord: "also: horrifically",
                      britshText: """IpaUK: /həˈrɪfɪkli/""",
                      americanText: """IpaUS: /həˈrɪfɪkli/""",
...
// With short examples define "horrifically", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "ڕووخساری بە خراپی سوتێندرابوو بە ئەسید.",
