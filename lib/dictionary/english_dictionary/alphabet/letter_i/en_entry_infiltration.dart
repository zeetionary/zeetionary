...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'VOzUnIu_GP0';
    const double startSecondsend = 107;
    const String videoIdone = 'bLApZfnLJoM';
    const double startSecondsone = 45;
    const String videoIdtwo = 'bG19b06NG_w';
    const double startSecondstwo = 550;
    const String videoIdthree = 'UpHOkHxpTvQ';
    const double startSecondsthree = 164;
    const String videoIdfour = 'ElQdUHSXkME';
    const double startSecondsfour = 406;
    const String videoIdfive = 'AS9-ITLhQxo';
