...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'jrHz8Bti6FY';
    const double startSecondsone = 533;
    const String videoIdtwo = 'Ir3eJ1t13fk';
    const double startSecondstwo = 1224;
    const String videoIdthree = 'V2ec7EE0pB8';
    const double startSecondsthree = 1797;
    const String videoIdfour = 'hGHW6QLrLTY';
    const double startSecondsfour = 312;
    const String videoIdfive = 'XeJ2vOHaATg';
