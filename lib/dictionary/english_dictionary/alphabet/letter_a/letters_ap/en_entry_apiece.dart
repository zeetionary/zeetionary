...
class EnglishEntryapiece extends StatelessWidget {
  ...
  Future<void> speakapiece237(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Sterling and Walcott scored a goal apiece.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "apiece"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈpiːs/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakapiece("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈpiːs/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakapiece("en-US"),
                            ),
                          ],
                        ),
                      ],
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakapiece237("en-US"),
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '4-1GGrcrlPQ';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'Jk4smlKnlqM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'rSLWFA_glbk';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'LBNOr9iRy1w';
