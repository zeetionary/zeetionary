...
class EnglishEntryescapist extends StatefulWidget {
  const EnglishEntryescapist({super.key});

  @override
  State<EnglishEntryescapist> createState() => _EnglishEntryescapistState();
}

class _EnglishEntryescapistState extends State<EnglishEntryescapist> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""escapist""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """escapist""",
                      // alsoEnglishWord: "also: escapist",
                      britshText: """IpaUK: /ɪˈskeɪpɪst/""",
                      americanText: """IpaUS: /ɪˈskeɪpɪst/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The movie is meant to be escapist.""");
  }
...
// With short examples define "escapist", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: ڕاستی‌نەویست، دەرچوون‌گەر، دەرچوون‌خواز
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە یارمەتیت دەدات دووربکەویتەوە شتە ناخۆش و بێزارکەرەکان یان لەبیریان بکەیت"""),
          SentencesRow(
            englishText: """The movie is meant to be escapist.""",
            kurdishText: """فیلمەکە ئامانج لێی ئەوەیە دەرچوون‌خواز بێت .""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: escapist (Derived forms: escapists)
1. A person who escapes into a world of fantasy (= dreamer, wishful thinker, fantasiser [Brit], fantasizer [N. Amer])
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/LQ6EXYXF58Q?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1148;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/cGyj9M05LxA?t=';
const double _startSecondsone = 00000000000000000000000000000; // 435;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/rOrYKJVkreQ?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 658;
const String _videoIdthree = 'VIDEOhttps://youtu.be/b0BC3F0kqtw?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1067;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/K3xznCimClI?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 687;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/4ntg0ZFmyqU?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 608;
