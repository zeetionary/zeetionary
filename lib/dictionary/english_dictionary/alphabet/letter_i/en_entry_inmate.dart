...
class EnglishEntryinmate extends StatefulWidget {
  const EnglishEntryinmate({super.key});

  @override
  State<EnglishEntryinmate> createState() => _EnglishEntryinmateState();
}

class _EnglishEntryinmateState extends State<EnglishEntryinmate> {
  @override
  void initState() {
    super.initState();
