...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'DCHbhDxBLko';
    const double startSecondsone = 97;
    const String videoIdtwo = 'F93WHXewX5c';
    const double startSecondstwo = 2633;
    const String videoIdthree = 'Solb9uA-tgQ';
    const double startSecondsthree = 17300;
    const String videoIdfour = 'pf-CvA_Q7v0';
    const double startSecondsfour = 163;
    const String videoIdfive = 'TlTIpnLL68o';
