...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 951;
    const String videoIdone = 'roCX0AfBseQ';
    const double startSecondsone = 183;
    const String videoIdtwo = '3RkhZgRNC1k';
    const double startSecondstwo = 1647;
    const String videoIdthree = 'SaneSRqePVY';
    const double startSecondsthree = 371;
    const String videoIdfour = 'M73XCOzZAU0';
    const double startSecondsfour = 464;
    const String videoIdfive = '90MNvA5ozcI';
    const double startSecondsfive = 1173;
