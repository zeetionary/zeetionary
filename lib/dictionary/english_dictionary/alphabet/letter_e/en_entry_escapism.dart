...
class EnglishEntryescapism extends StatefulWidget {
  const EnglishEntryescapism({super.key});

  @override
  State<EnglishEntryescapism> createState() => _EnglishEntryescapismState();
}

class _EnglishEntryescapismState extends State<EnglishEntryescapism> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""escapism""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """escapism""",
                      // alsoEnglishWord: "also: escapism",
                      britshText: """IpaUK: /ɪˈskeɪpɪzəm/""",
                      americanText: """IpaUS: /ɪˈskeɪpɪzəm/""",
...
کوردی: ڕاستی‌نەویستی، دەرچوون‌گەری، دەرچوون‌خوازی، هەڵاتن لە ڕاستی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) چالاکییەک، جۆرێک لە چێژبینین، هتد کە یارمەتیت دەدات لە شتە ناخۆش و بێزارکەرەکان دووربکەویتەەو یان لەبیریان بکەیت"""),
          SentencesRow(
            englishText: """For John, books are a form of escapism.""",
            kurdishText: """بۆ جۆن، کتێب جۆرێکە لە دەرچوون‌خوازی.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: escapism (Derived forms: escapisms) 
1. An inclination to retreat from unpleasant realities through diversion or fantasy (= escape)
...
const double _startSecondsend = 000000000000000000000000000000; // 308;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondsone = 00000000000000000000000000000; // 5981;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/okeeKqcmQkw?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 570;
const String _videoIdthree = 'VIDEOhttps://youtu.be/nllZrOoxpzc?t=';
const double _startSecondsthree = 000000000000000000000000000; // 270;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/6v_8egNq9fA?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 566;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/kVrNmOmGB6c?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 686;
