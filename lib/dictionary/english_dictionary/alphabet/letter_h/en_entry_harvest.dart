...
class EnglishEntryharvest extends StatefulWidget {
  const EnglishEntryharvest({super.key});

  @override
  State<EnglishEntryharvest> createState() => _EnglishEntryharvestState();
}

class _EnglishEntryharvestState extends State<EnglishEntryharvest> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: harvest (Derived forms: harvested, harvesting, harvests)
1. Gather, as of natural products (- reap, glean [archaic])
"harvest the grapes";
...
- Noun: harvest (Derived forms: harvests)
1. The yield from plants in a single growing season (- crop)
 
2. The consequence of an effort or activity
"they gathered a harvest of examples"; "a harvest of love"
 
3. The gathering of a ripened crop (- harvesting, harvest home)
 
4. The season for gathering crops (- harvest time)
""",
  );

  final String keyword = "harvest";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""harvest""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Farmers are extremely busy during the harvest.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""During the harvest they work from dawn to dusk.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The strawberry harvest failed because of the drought.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They were busy getting the harvest in.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The nuts are ready to harvest in September.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Winter wheat is harvested in late July and early August.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harvest""",
                      // alsoEnglishWord: "also: harvest",
                      britshText: """IpaUK: /ˈhɑːvɪst/""",
                      americanText: """IpaUS: /ˈhɑːrvɪst/""",
...
کوردی: دروێنە،	دروێنەکردن،	جۆزەردان، گەنم‌زەردان، سەروبەندی دروێنە، قەف‌وگوڵ، گوڵپەڕ،	وەختی خلەوخەرمان، (گێرە و)کێشە، خەرمانان،	خەرمان، بێدەر، ئەژار،	بەروبوو، حاسڵ، خلەوخەرمان، بەرهەم، بەربێڵ،	(خوازە) ئاکام، بەرهەم، ئەنجام
"""),
// With short examples define "harvest", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەو کاتەی ساڵ کە بەرووبووم کۆدەکرێنەوە؛ کۆکردنەوەی بەرووبووم"""),
                    SentencesRow(
                      englishText:
                          """Farmers are extremely busy during the harvest.""",
                      kurdishText:
                          """جوتیاران تەواو سەرقاڵن لە کاتی وەرزی دروێنە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە کاتی دروێنەدا لە بەرەبەیان تاوەکو خۆرئاوابوون کار دەکەن.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) ئەو بەرهەمانەی کە دروێنە کراون"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The strawberry harvest failed because of the drought.""",
                      kurdishText:
                          """بەروبووی گێلاس شکستی هێنا بەهۆی وشکەساڵی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They were busy getting the harvest in.""",
                      kurdishText: """سەرقاڵ بوون بە کۆکردنەوەی بەرهەمەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She returned from the conference with a rich harvest of knowledge.""",
                      kurdishText:
                          """(خوازراوی) لە کۆنفرانسەکە گەڕانەوە بە کۆکردنەوەی زۆری زانیاری.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) دروێنەکردن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The nuts are ready to harvest in September.""",
                      kurdishText:
                          """کاکڵدارەکان ئامادەن بۆ دروێنە لە ئەیلوولدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """گەنمی زستان لە کۆتایی تەممووز و سەرەتای ئاب دروێنە دەکرێن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (کردار) کۆکردنەوەی خانە و شانە کەسێک بۆ کاری پزیشکی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She had her eggs harvested and frozen for her own future use.""",
                      kurdishText:
                          """هێلکەی کۆکرایەوە و بەسترا بۆ بەکارهێنانی خۆی لە داهاتوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/8hL2lue5tRM';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/qvKzFd1fEqY?t=';
const double _startSecondsone = 00000000000000000000000000017;
const String _videoIdtwo = 'https://youtu.be/Sa4zD8ksmBk?t=';
const double _startSecondstwo = 000000000000000000000000000172;
const String _videoIdthree = 'https://youtu.be/yxH0kLkO1Ks';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/ifuJCKldQBU?t=';
const double _startSecondsfour = 0000000000000000000000000004;
const String _videoIdfive = 'https://youtu.be/SHSQKUbGsuI?t=';
