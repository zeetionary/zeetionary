...
class EnglishEntryfrankfurter extends StatefulWidget {
  const EnglishEntryfrankfurter({super.key});

  @override
  State<EnglishEntryfrankfurter> createState() =>
      _EnglishEntryfrankfurterState();
}

class _EnglishEntryfrankfurterState extends State<EnglishEntryfrankfurter> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frankfurter (Derived forms: frankfurters)
1. A smooth-textured sausage of minced beef or pork usually smoked; often served on a bread roll (= frank [US, informal], hotdog, hot dog, dog [informal], wiener [N. Amer, S.Africa], wienerwurst [N. Amer], weenie [N. Amer, informal], wienie [N. Amer, informal])
""",
  );

  final String keyword = "frankfurter";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frankfurter""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I’ll have a frankfurter with mustard.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frankfurter""",
                      // alsoEnglishWord: "also: frankfurter",
                      britshText: """IpaUK: /ˈfræŋkfɜːtə(r)/""",
                      americanText: """IpaUS: /ˈfræŋkfɜːrtər/""",
...
کوردی: 
"""),
// With short examples define "frankfurter", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) سۆسجێکی درێژی باریک کە سووری قاوەیی باوە"""),
                    SentencesRow(
                      englishText: """I’ll have a frankfurter with mustard.""",
                      kurdishText: """فرانکفێرتە دەخۆم لەگەڵ سۆسی خەردەل.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/kOySPGZwxBw?t=';
const double _startSecondsend = 00000000000000000000000000051;
const String _videoIdone = 'https://youtu.be/lslsKgKiqkI?t=';
const double _startSecondsone = 0000000000000000000000000005;
const String _videoIdtwo = 'https://youtu.be/TSoT0qGT2-o?t=';
const double _startSecondstwo = 000000000000000000000000000146;
const String _videoIdthree = 'https://youtu.be/woEAhg71bx4';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/kkDRruNanFA?t=';
const double _startSecondsfour = 000000000000000000000000000599;
const String _videoIdfive = 'https://youtu.be/-a_wDBYNZzk?t=';
const double _startSecondsfive = 000000000000000000000000000442;
