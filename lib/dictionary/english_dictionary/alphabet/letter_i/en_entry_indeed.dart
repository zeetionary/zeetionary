...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001229;
    const String videoIdone = 'https://youtu.be/Mx8JkGHaGUI?t=';
    const double startSecondsone = 0000000000000000000000000002130;
    const String videoIdtwo = 'https://youtu.be/erDE9B-X7mk?t=';
    const double startSecondstwo = 000000000000000000000000000165;
    const String videoIdthree = 'https://youtu.be/raSeaAeryWE?t=';
    const double startSecondsthree = 0000000000000000000000000001860;
    const String videoIdfour = 'https://youtu.be/092PIJKKgFo?t=';
    const double startSecondsfour = 000000000000000000000000000719;
    const String videoIdfive = 'https://youtu.be/6GgwS2cO0_s?t=';
