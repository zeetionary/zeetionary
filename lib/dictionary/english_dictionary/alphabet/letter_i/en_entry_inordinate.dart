...
class EnglishEntryinordinate extends StatefulWidget {
  const EnglishEntryinordinate({super.key});

  @override
  State<EnglishEntryinordinate> createState() => _EnglishEntryinordinateState();
}

class _EnglishEntryinordinateState extends State<EnglishEntryinordinate> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inordinate""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 412;
    const String videoIdone = 'qr4MSVxfYBE';
    const double startSecondsone = 659;
    const String videoIdtwo = 'XXnlVlkkkxM';
    const double startSecondstwo = 162;
    const String videoIdthree = '5uxPYlvOlrE';
    const double startSecondsthree = 29;
    const String videoIdfour = 'gVjX4val91A';
    const double startSecondsfour = 553;
    const String videoIdfive = 'VAB9cUlGrRo';
