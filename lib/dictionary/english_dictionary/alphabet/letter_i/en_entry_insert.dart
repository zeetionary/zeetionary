...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 000000000000000000000000000884;
    const String videoIdtwo = 'https://youtu.be/olHw-8py9K0?t=';
    const double startSecondstwo = 000000000000000000000000000119;
    const String videoIdthree = 'https://youtu.be/xVQxvthAcLU?t=';
    const double startSecondsthree = 000000000000000000000000000578;
    const String videoIdfour = 'https://youtu.be/V3NGBo2M1Ps?t=';
    const double startSecondsfour = 000000000000000000000000000236;
    const String videoIdfive = 'https://youtu.be/WUjVPIEtJd0?t=';
    const double startSecondsfive = 00000000000000000000000000055;
