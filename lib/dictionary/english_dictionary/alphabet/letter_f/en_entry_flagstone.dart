...
class EnglishEntryflagstone extends StatefulWidget {
  const EnglishEntryflagstone({super.key});

  @override
  State<EnglishEntryflagstone> createState() => _EnglishEntryflagstoneState();
}

class _EnglishEntryflagstoneState extends State<EnglishEntryflagstone> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flagstone (Derived forms: flagstones)
1. Stratified stone that splits into pieces suitable as paving stones (= flag)
""",
  );

  final String keyword = "flagstone";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flagstone""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They laid flagstones in their garden path.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flagstone""",
                      // alsoEnglishWord: "also: flagstone",
                      britshText: """IpaUK: /ˈflæɡstəʊn/""",
                      americanText: """IpaUS: /ˈflæɡstəʊn/""",
...
کوردی: بەردی ڕێگا، بەردڕێژە، بەردی تەرک، سەپتک، تاتەبەرد
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پارچە بەردێکی گەورەی تەخت کە بۆ ڕێگا، زەوی، هتد بەکاردێت"""),
                    SentencesRow(
                      englishText:
                          """They laid flagstones in their garden path.""",
                      kurdishText:
                          """تاتەبەردیان لەسەر ڕێگای باخچەکەیان دانا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/n719vzFXhJE?t=';
const double _startSecondsend = 000000000000000000000000000609;
const String _videoIdone = 'https://youtu.be/YN_0dvkUWyE?t=';
const double _startSecondsone = 000000000000000000000000000672;
const String _videoIdtwo = 'https://youtu.be/y7_wd_FLvu0?t=';
const double _startSecondstwo = 000000000000000000000000000215;
const String _videoIdthree = 'https://youtu.be/BtBBBb9OQD0?t=';
const double _startSecondsthree = 000000000000000000000000000321;
const String _videoIdfour = 'https://youtu.be/-ljPxTgQIYo?t=';
const double _startSecondsfour = 000000000000000000000000000351;
const String _videoIdfive = 'https://youtu.be/0WSZibf6Q4Y?t=';
