...
class EnglishEntryhooliganism extends StatefulWidget {
  const EnglishEntryhooliganism({super.key});

  @override
  State<EnglishEntryhooliganism> createState() =>
      _EnglishEntryhooliganismState();
}

class _EnglishEntryhooliganismState extends State<EnglishEntryhooliganism> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hooliganism (Derived forms: hooliganisms)
1. Deliberate destruction, defacement or damage of public or other people's property (- vandalism, malicious mischief)
""",
  );

  final String keyword = "hooliganism";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hooliganism""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The boys were accused of hooliganism.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/JpGq1MEZ2DM?t=';
    const double startSecondsend = 000000000000000000000000000339;
    const String videoIdone = 'https://youtu.be/C_B09FZwSbA?t=';
    const double startSecondsone = 000000000000000000000000000700;
    const String videoIdtwo = 'https://youtu.be/DigTCUKNn2A?t=';
    const double startSecondstwo = 00000000000000000000000000038;
    const String videoIdthree = 'https://youtu.be/rX3xolH-BMQ?t=';
    const double startSecondsthree = 000000000000000000000000000312;
    const String videoIdfour = 'https://youtu.be/Lx4O0TEZFo0?t=';
    const double startSecondsfour = 000000000000000000000000000171;
    const String videoIdfive = 'https://youtu.be/HbZW4LyfXS4?t=';
    const double startSecondsfive = 00000000000000000000000000010;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hooliganism""",
                      // alsoEnglishWord: "also: hooliganism",
                      britshText: """IpaUK: /ˈhuːlɪɡənɪzəm/""",
                      americanText: """IpaUS: /ˈhuːlɪɡənɪzəm/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText: """The boys were accused of hooliganism.""",
                      kurdishText: """منداڵەکان بە کەڵەگایی تۆمەتبار کران.""",
