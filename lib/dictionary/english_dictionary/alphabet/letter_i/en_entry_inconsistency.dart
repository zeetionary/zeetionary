...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/qWIkBMNKj1s?t=';
    const double startSecondsend = 000000000000000000000000000495;
    const String videoIdone = 'https://youtu.be/K0j2dlBMzUs?t=';
    const double startSecondsone = 0000000000000000000000000001598;
    const String videoIdtwo = 'https://youtu.be/GsK5NaSCkho?t=';
    const double startSecondstwo = 000000000000000000000000000649;
    const String videoIdthree = 'https://youtu.be/RentKWlhUXc?t=';
    const double startSecondsthree = 00000000000000000000000000098;
    const String videoIdfour = 'https://youtu.be/Kb09lybZEeA?t=';
    const double startSecondsfour = 000000000000000000000000000822;
    const String videoIdfive = 'https://youtu.be/SaMxjiixJ18?t=';
