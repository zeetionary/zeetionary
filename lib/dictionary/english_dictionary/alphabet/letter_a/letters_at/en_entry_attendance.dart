...
// Define the word "attendance" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace attendance - replace EnglishEntryattendance

// replace speakAttendance - /əˈtendəns/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryattendance extends StatelessWidget {
  // blank divider
  EnglishEntryattendance({super.key});
  // blank divider
  ...
  Future<void> speakattendance(String languageCode) async {
    ...
    await flutterTts.speak("attendance");
  }
  ...
  Future<void> speakattendance817(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Attendance at these lectures is not compulsory.");
  }
  ...
  Future<void> speakattendance819(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("There was an attendance of 42 at the meeting.");
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "attendance"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final double _startSeconds = 1975;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final double _startSeconds = 1991;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'IKn4naaLuqs';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = '-ZtUggBw3Jk';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'nd5--EqzLPY';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'deEAegbA8s4';
