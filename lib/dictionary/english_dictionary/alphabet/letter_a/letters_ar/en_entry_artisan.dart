...
class EnglishEntryartisan extends StatelessWidget {
  ...
  Future<void> speakartisan(String languageCode) async {
    ...
    await flutterTts.speak("artisan");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "artisan"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌɑːtɪˈzæn/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrtəzn/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'C8PUlZrngZQ';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'Xw_NgS8iqhU';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '73oENaDiq04';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'dw651eMFc2A';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'E_MgzS-pQ38';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'FovIyqov1uA';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'JfaSIpv3ti0';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = '4hCy4-G37jA';
