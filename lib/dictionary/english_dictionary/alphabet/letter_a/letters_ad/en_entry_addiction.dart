...
// replace these: replace EnglishEntryaddiction - replace speakAddiction - replace addiction - /əˈdɪkʃn/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaddiction extends StatelessWidget {
  EnglishEntryaddiction({super.key});
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "addiction"), // Find /əˈdɪkʃn/
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈdɪkʃn/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakAddiction("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            CustomIconButtonAmerican(
                              onPressed: () => speakAddiction("en-US"),
                            ),
                          ],
                        ),
                      ],
