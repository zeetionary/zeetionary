...
class EnglishEntryanti extends StatelessWidget {
  ...
  Future<void> speakanti908(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("They’re completely anti the new proposals.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈænti/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'i_ppflSR-ww';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final double _startSeconds = 2702;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'SPFMagxAHl8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'fq6E37Ydr2A';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Vgm0Gfsn1iU';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'cmD4cyEUu7g';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'aVHNOBCsCDc';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'N2yQVMNnGQU';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'fw6L0LX_5IM';
