...
class EnglishEntryformative extends StatefulWidget {
  const EnglishEntryformative({super.key});

  @override
  State<EnglishEntryformative> createState() => _EnglishEntryformativeState();
}

class _EnglishEntryformativeState extends State<EnglishEntryformative> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: formative
1. (biology) capable of forming new cells and tissues
"a formative zone in developing bone"
 
2. Forming or capable of forming or moulding or fashioning (= shaping, plastic)
"a formative influence";

- Noun: formative (Derived forms: formatives)
1. Minimal language unit that has a syntactic (or morphological) function
""",
  );

  final String keyword = "formative";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""formative""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She spent her formative years in Africa.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """formative""",
                      // alsoEnglishWord: "also: formative",
                      britshText: """IpaUK: /ˈfɔːmətɪv/""",
                      americanText: """IpaUS: /ˈfɔːrmətɪv/""",
...
کوردی: پێکهێنەرانە، دامەزرێنەر، پێکهێنەر،	دیاری‌کەر،	کاریگەر (درێژخایەن)
"""),
// With short examples define "formative", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە کاریگەریی زۆری هەیە بەسەر گەشەی شتێک یان کەسایەتی کەسێک"""),
                    SentencesRow(
                      englishText:
                          """She spent her formative years in Africa.""",
                      kurdishText: """ساڵانی کاریگەریی لە ئەفریقا بەسەر برد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/GkgXRyScubI?t=';
const double _startSecondsend = 000000000000000000000000000132;
const String _videoIdone = 'https://youtu.be/hkO8qXCFYWA?t=';
const double _startSecondsone = 0000000000000000000000000001615;
const String _videoIdtwo = 'https://youtu.be/SsuWS6yE478?t=';
const double _startSecondstwo = 000000000000000000000000000665;
const String _videoIdthree = 'https://youtu.be/_wrEYqdTf98?t=';
const double _startSecondsthree = 000000000000000000000000000311;
const String _videoIdfour = 'https://youtu.be/L_Guz73e6fw?t=';
const double _startSecondsfour = 0000000000000000000000000003434;
