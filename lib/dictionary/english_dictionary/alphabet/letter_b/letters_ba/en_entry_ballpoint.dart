...
// blank divider
  ...
  Future<void> speakballpoints1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The letter was written in blue ballpoint pen.");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "ballpoint"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'Ny1aC1T8G20';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '5HQR8TqLJCs';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '6WWNZeTd6so';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'RcxWXY1sIn8';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '6VEQRSeEvwg';
