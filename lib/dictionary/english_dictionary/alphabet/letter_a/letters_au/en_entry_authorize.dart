...
class EnglishEntryauthorize extends StatelessWidget {
  ...
  Future<void> speakauthorize(String languageCode) async {
    ...
    await flutterTts.speak("authorize");
  }
  ...
  Future<void> speakauthorize840(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I can authorize payments up to £5 000.");
  }
  ...
  Future<void> speakauthorize842(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The police were authorized to record his phone conversations.");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "authorize"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɔːθəraɪz/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɔːθəraɪz/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakauthorize840("en-US"),
                          ),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakauthorize842("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final double _startSeconds = 3419;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'fOzFG5m3Y5E';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'rFvfbdqBcqY';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'rwoPd2MHEh0';
  final double _startSeconds = 3052;
