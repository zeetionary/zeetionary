...
class EnglishEntryfizz extends StatefulWidget {
  const EnglishEntryfizz({super.key});

  @override
  State<EnglishEntryfizz> createState() => _EnglishEntryfizzState();
}

class _EnglishEntryfizzState extends State<EnglishEntryfizz> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fizz (Derived forms: fizzes)
1. An effervescent beverage (usually alcoholic)

- Verb: fizz (Derived forms: fizzed, fizzes, fizzing)
1. Become bubbly, frothy or foaming (= foam, froth, effervesce, sparkle, form bubbles)
"The river was fizzing";
""",
  );

  final String keyword = "fizz";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Champagne was fizzing in the glass.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Share prices are fizzing.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He started to fizz with enthusiasm.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The soda had a lot of fizz.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There was a fizz as the tablet dissolved in water.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fireworks ended with a soft fizz.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fizz has gone out of the market.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fizz""",
                      // alsoEnglishWord: "also: fizz",
                      britshText: """IpaUK: /fɪz/""",
                      americanText: """IpaUS: /fɪz/""",
...
کوردی: دەنگی فشە، دەنگی فسە یان فیزە،	شامپانی،	سەرخۆشی، بەکەیفی، شادی، دڵخۆشی
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) کە شلەیەک ڕێژەیەکی زۆر کەف درووست دەکات و دەنگی سسسسسسسس دەردەکات"""),
                    SentencesRow(
                      englishText: """Champagne was fizzing in the glass.""",
                      kurdishText: """شامپەین لە گڵاسەکەدا فسەی دەهات.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He started to fizz with enthusiasm.""",
                      kurdishText: """دەستی کرد بە هەڵبەزین لە خۆشیدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """فسەیەک هەیە کە حەبەکە لە ئاودا دەتوێتەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The fireworks ended with a soft fizz.""",
                      kurdishText:
                          """یارییە ئاگرینەکان بە فسەیەک کۆتاییان هات.""",
...
const String _videoIdone = 'https://youtu.be/GMb6GNYPqXA?t=';
const double _startSecondsone = 000000000000000000000000000133;
const String _videoIdtwo = 'https://youtu.be/y9nBhv0lq1s?t=';
const double _startSecondstwo = 000000000000000000000000000793;
const String _videoIdthree = 'https://youtu.be/__qtH1ly2Sg?t=';
const double _startSecondsthree = 000000000000000000000000000509;
const String _videoIdfour = 'https://youtu.be/_A-FHx1pSHc?t=';
const double _startSecondsfour = 000000000000000000000000000693;
const String _videoIdfive = 'https://youtu.be/x54qPb7DXoQ?t=';
const double _startSecondsfive = 000000000000000000000000000477;
