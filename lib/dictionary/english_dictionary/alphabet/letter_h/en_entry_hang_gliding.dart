...
class EnglishEntryhanggliding extends StatefulWidget {
  const EnglishEntryhanggliding({super.key});

  @override
  State<EnglishEntryhanggliding> createState() =>
      _EnglishEntryhangglidingState();
}

class _EnglishEntryhangglidingState extends State<EnglishEntryhanggliding> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hang gliding (Derived forms: hangglidings)
1. Gliding in a hang glider
""",
  );

  final String keyword = "hang-gliding";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hang-gliding""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She's taken up hang-gliding.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hang-gliding""",
                      // alsoEnglishWord: "also: hang-gliding",
                      britshText: """IpaUK: /ˈhæŋ ɡlaɪdɪŋ/""",
                      americanText: """IpaUS: /ˈhæŋ ɡlaɪdɪŋ/""",
...
// کوردی:
// """),
// With short examples define "hang-gliding", please follow LX instructions
