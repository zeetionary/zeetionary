...
class EnglishEntryevade extends StatefulWidget {
  const EnglishEntryevade({super.key});

  @override
  State<EnglishEntryevade> createState() => _EnglishEntryevadeState();
}

class _EnglishEntryevadeState extends State<EnglishEntryevade> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evade""",
                      // alsoEnglishWord: "also: evade",
                      britshText: """IpaUK: /ɪˈveɪd/""",
                      americanText: """IpaUS: /ɪˈveɪd/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""For two weeks they evaded the press.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He managed to evade capture.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They narrowly evaded a police car which was approaching.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He had tried to evade payment of taxes.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He never sought to evade his responsibilities.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Her response was simply to evade the problem altogether.""");
  }
...
"""),
          const DefinitionKurdish(
              text: """١. (کردار) خۆدزینەوە یان دوورکوتنەوە لە کەسێک/شتێک"""),
          SentencesRow(
            englishText: """For two weeks they evaded the press.""",
            kurdishText: """بۆ دوو هەفتە خۆیان لە میدیاکان دزییەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He managed to evade capture.""",
            kurdishText: """توانی خۆی لە دەستگیرکردن بدزێتەوە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """بە ئاستەنگ خۆیان دزییەوە لە ئۆتۆمبێلێکی پۆلیس کە نزیک دەبوویەوە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) خۆدزینەوە لە کردنی شتێک، بەتایبەتی کە بەپێی یاسایی یان ئەخلاقی دەبێت بیکەیت"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """He had tried to evade payment of taxes.""",
            kurdishText: """هەوڵیدا بوو خۆی لە دانی باج بدزێتەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He never sought to evade his responsibilities.""",
            kurdishText:
                """هەرگیز هەوڵی نەدەدا خۆی لە بەرپرسیاریەتییەکانی بدزێتەوە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٣. (کردار) خۆدزینەوە لە مامەڵەکردن یان قسەکردن لەسەر شتێک"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Her response was simply to evade the problem altogether.""",
            kurdishText:
                """وەڵامەکەی ئەوە بوو کە بە تەواوی خۆی لە کێشەکە لابدات.""",
          ...
          SentencesRow(
            ...
            kurdishText: """وەرە، پێت وانییە خۆت لە باسەکە لا ئەدەیت؟""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: evade (Derived forms: evading, evades, evaded)
1. Avoid or try to avoid fulfilling, answering, or performing (duties, questions, or issues) (= hedge, fudge, put off, circumvent, parry, elude, skirt, dodge, duck [informal], sidestep, finesse, circumnavigate)
"They tend to evade their responsibilities"; "he evaded the questions skilfully";
 
2. Escape, either physically or mentally (= elude, bilk [archaic])
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/OZ_xhkg32nk?t=';
const double _startSecondsend = 000000000000000000000000000000; // 550;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/4U-u4CsnygA?t=';
const double _startSecondsone = 00000000000000000000000000000; // 89;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/J_n1FZaKzF8?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1330;
const String _videoIdthree = 'VIDEOhttps://youtu.be/QICB_puGtYo?t=';
const double _startSecondsthree = 000000000000000000000000000; // 681;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/NcRifDitRnU?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 282;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/wqMMEGW_Uqs?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 48;
