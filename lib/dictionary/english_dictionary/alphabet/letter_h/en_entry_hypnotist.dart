...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'yFGBjXqwzbw';
    const double startSecondsend = 82;
    const String videoIdone = 'Bh9lIfocRMk';
    const double startSecondsone = 913;
    const String videoIdtwo = '2MZZrDA-I4M';
    const double startSecondstwo = 1369;
    const String videoIdthree = 'FiqTmmWfVdg';
    const double startSecondsthree = 17;
    const String videoIdfour = 'Solb9uA-tgQ';
    const double startSecondsfour = 2373;
    const String videoIdfive = '6jaks_F2UFU';
