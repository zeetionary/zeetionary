...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 701;
    const String videoIdone = '1nMm7S8ve9U';
    const double startSecondsone = 105;
    const String videoIdtwo = 'um9aGTAU0lg';
    const double startSecondstwo = 1411;
    const String videoIdthree = 'ubNKSgdT1FQ';
    const double startSecondsthree = 749;
    const String videoIdfour = 'gENRqiaS8xM';
    const double startSecondsfour = 936;
    const String videoIdfive = 'd5o1WaQE57M';
    const double startSecondsfive = 1532;
