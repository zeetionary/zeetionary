...
class EnglishEntryheadland extends StatefulWidget {
  const EnglishEntryheadland({super.key});

  @override
  State<EnglishEntryheadland> createState() => _EnglishEntryheadlandState();
}

class _EnglishEntryheadlandState extends State<EnglishEntryheadland> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: headland (Derived forms: headlands)
1. A natural elevation (especially a rocky one that juts out into the sea) (- promontory, head, foreland)
""",
  );

  final String keyword = "headland";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""headland""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Waves crashed against the rocky headland.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """headland""",
                      // alsoEnglishWord: "also: headland",
                      britshText: """IpaUK: /ˈhedlənd/,  /ˈhedlænd/""",
                      americanText: """IpaUS: /ˈhedlənd/,  /ˈhedlænd/""",
...
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پارچە زەوییەکی باریک کە لە وشکانییەوە بەرەو ناو دەریا دەچێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: promontory"),
                    SentencesRow(
                      englishText:
                          """Waves crashed against the rocky headland.""",
                      kurdishText: """شەپۆل دەیکێشا بە لوتکە باریکەکەدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/1pYjtCaqiys?t=';
const double _startSecondsend = 000000000000000000000000000539;
const String _videoIdone = 'https://youtu.be/buIeZJ1bRZE?t=';
const double _startSecondsone = 000000000000000000000000000130;
const String _videoIdtwo = 'https://youtu.be/XKmsYB54zBk?t=';
const double _startSecondstwo = 0000000000000000000000000003428;
const String _videoIdthree = 'https://youtu.be/RuK7p8iO-o0?t=';
const double _startSecondsthree = 000000000000000000000000000989;
const String _videoIdfour = 'https://youtu.be/oz6gOBN9xn8?t=';
const double _startSecondsfour = 000000000000000000000000000347;
const String _videoIdfive = 'https://youtu.be/apwKo3x8aRg?t=';
const double _startSecondsfive = 0000000000000000000000000001153;
