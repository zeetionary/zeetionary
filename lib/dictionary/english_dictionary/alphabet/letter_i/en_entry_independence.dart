...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'https://youtu.be/wrsUbwKGuko?t=';
    const double startSecondstwo = 000000000000000000000000000219;
    const String videoIdthree = 'https://youtu.be/twAP3buj9Og?t=';
    const double startSecondsthree = 0000000000000000000000000001485;
    const String videoIdfour = 'https://youtu.be/VNZ0so0LCoM?t=';
