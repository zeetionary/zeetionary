...
class EnglishEntryengaging extends StatefulWidget {
  const EnglishEntryengaging({super.key});

  @override
  State<EnglishEntryengaging> createState() => _EnglishEntryengagingState();
}

class _EnglishEntryengagingState extends State<EnglishEntryengaging> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""engaging""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """engaging""",
                      // alsoEnglishWord: "also: engaging",
                      britshText: """IpaUK: /ɪnˈɡeɪdʒɪŋ/""",
                      americanText: """IpaUS: /ɪnˈɡeɪdʒɪŋ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The book has an engaging cover design.""");
  }
...
کوردی: سەرنج‌ڕاکێش، دڵڕفێن، لەدڵەوەنزیک، خوێن‌شیرین، دڵڕفێن، خۆش
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) سەرنجڕاکێش یان خۆش بەشێوەیەک کە سەرنجت ڕادەکێشێت"""),
          SentencesRow(
            englishText: """The book has an engaging cover design.""",
            kurdishText: """کتێبەکە دیزاینێکی سەربەرگی سەرنج‌ڕاکێشی هەیە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: engaging 
1. Attracting or delighting (= piquant)
...
const String _videoIdone = 'https://youtu.be/nedusgCUZC4?t=';
const double _startSecondsone = 359;
const String _videoIdtwo = 'https://youtu.be/Jmq9dSx50OE?t=';
const double _startSecondstwo = 1182;
const String _videoIdthree = 'https://youtu.be/G0Cj6tGnaK8?t=';
const double _startSecondsthree = 220;
const String _videoIdfour = 'https://youtu.be/KIj5cWBIb1c?t=';
const double _startSecondsfour = 25;
const String _videoIdfive = 'https://youtu.be/fRvrG6o6KrE?t=';
const double _startSecondsfive = 413;
const String _videoIdsix = 'https://youtu.be/QAgiyZeELNQ?t=';
const double _startSecondssix = 1107;
