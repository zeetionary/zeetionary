...
class EnglishEntryglower extends StatefulWidget {
  const EnglishEntryglower({super.key});

  @override
  State<EnglishEntryglower> createState() => _EnglishEntryglowerState();
}

class _EnglishEntryglowerState extends State<EnglishEntryglower> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He sent a glower in Lissa's direction.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She gave me an intense glower.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She glowered across the table at me.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glower""",
                      // alsoEnglishWord: "also: glower",
                      britshText: """IpaUK: /ˈɡlaʊə(r)/""",
                      americanText: """IpaUS: /ˈɡlaʊər/""",
...
// With short examples define "glower", please follow LX instructions
                    ...
                    const AlsoEnglishckb(word: "ھەروەھا: glare"),
                    SentencesRow(
                      englishText: """He sent a glower in Lissa's direction.""",
                      kurdishText: """مۆڕەیەکی لە لیسا کرد.""",
                    ...
                    SentencesRow(
                      englishText: """She gave me an intense glower.""",
                      kurdishText: """مۆڕەیەکی توندی لێم کرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) ئەوەی بە توندی بە تووڕەیی و توندی سەیری کەسێک بکەیت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: glare"),
                    SentencesRow(
                      englishText: """She glowered across the table at me.""",
                      kurdishText: """بە مێزەکەدا مۆڕەی لێم کرد.""",
                    ...
                    SentencesRow(
                      englishText:
                          """There's no point glowering at me like that - you know the rules.""",
                      kurdishText:
                          """پێویست ناکات مۆڕەم لێ بکەیت بەو شێوەیە ـ یاساکان دەزانیت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/TWVbZ0WQ3s8?t=';
const double _startSecondsend = 000000000000000000000000000171;
const String _videoIdone = 'https://youtu.be/zqkf2U5jcE0?t=';
const double _startSecondsone = 000000000000000000000000000424;
const String _videoIdtwo = 'https://youtu.be/K-KZwTAkijc?t=';
const double _startSecondstwo = 0000000000000000000000000001003;
const String _videoIdthree = 'https://youtu.be/-4u8sOtTfDg?t=';
const double _startSecondsthree = 000000000000000000000000000468;
const String _videoIdfour = 'https://youtu.be/YJ4Z2YOOGto?t=';
const double _startSecondsfour = 000000000000000000000000000224;
const String _videoIdfive = 'https://youtu.be/LHhFFfv20-4?t=';
const double _startSecondsfive = 000000000000000000000000000887;
