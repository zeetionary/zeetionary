...
""",
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Old people's bones are more prone to fracture.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Ground movements could cause fracture of the pipe.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Cast iron is not only heavy, but likely to fracture.""");
  }
...
// With short examples define "fracture", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئێسکی بەساڵاچووان زیاتر ھەستیارە بە شکان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چووڵەی زەوی دەکرێت ببێتە ھۆکاری شکانی زیاتری بۆرییەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئاسنی پتەوکراو تەنھا ئەوە نییە کە سەخت بێت بەڵکو ئەگەری ھەیە بشکێت.""",
                      englishNote:
                          "This means that cast iron (= a type of strong, heavy metal made from iron and carbon) is not only heavy in weight but also prone to breaking or cracking under stress or pressure.",
                    ...
                    SentencesRow(
                      englishText:
                          """Many people predicted that the party would fracture and split.""",
                      kurdishText:
                          """زۆر کەس پێشبینی ئەوەیان دەکرد کە پارتەکە کەلێنی تێ بکەوێت و ببێتە دوو بەشەوە.""",
...
const double _startSecondsone = 1493;
const String _videoIdtwo = 'qpi9epVHYlc';
const double _startSecondstwo = 449;
const String _videoIdthree = 'SwQhKFMxmDY';
const double _startSecondsthree = 406;
const String _videoIdfour = 'Qiok50TjAIE';
const double _startSecondsfour = 175;
const String _videoIdfive = '7jD5Gkh4K34';
