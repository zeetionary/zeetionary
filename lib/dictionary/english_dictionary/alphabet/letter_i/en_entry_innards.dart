...
class EnglishEntryinnards extends StatefulWidget {
  const EnglishEntryinnards({super.key});

  @override
  State<EnglishEntryinnards> createState() => _EnglishEntryinnardsState();
}

class _EnglishEntryinnardsState extends State<EnglishEntryinnards> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""innards""");
  }
