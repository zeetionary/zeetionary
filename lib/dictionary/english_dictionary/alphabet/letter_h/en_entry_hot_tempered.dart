...
class EnglishEntryhottempered extends StatefulWidget {
  const EnglishEntryhottempered({super.key});

  @override
  State<EnglishEntryhottempered> createState() =>
      _EnglishEntryhottemperedState();
}

class _EnglishEntryhottemperedState extends State<EnglishEntryhottempered> {
  @override
  void initState() {
    super.initState();
...
1. Quickly aroused to anger (- choleric, irascible, hotheaded, quick-tempered, short-tempered)
"a hot-tempered commander";
""",
  );

  final String keyword = "hot-tempered";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hot-tempered""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The hot-tempered coach shouted at the players.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/5c_YoU0Kdvk?t=';
    const double startSecondsend = 000000000000000000000000000384;
    const String videoIdone = 'https://youtu.be/vpArBufV1xg?t=';
    const double startSecondsone = 000000000000000000000000000506;
    const String videoIdtwo = 'https://youtu.be/BOaI_URLqD4?t=';
    const double startSecondstwo = 000000000000000000000000000623;
    const String videoIdthree = 'https://youtu.be/GopUx_Apb1o?t=';
    const double startSecondsthree = 000000000000000000000000000675;
    const String videoIdfour = 'https://youtu.be/8CviaikflJw?t=';
    const double startSecondsfour = 000000000000000000000000000350;
    const String videoIdfive = 'https://youtu.be/iVn37ndpkIc?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hot-tempered""",
                      // alsoEnglishWord: "also: hot-tempered",
                      britshText: """IpaUK: /ˌhɒt ˈtempəd/""",
                      americanText: """IpaUS: /ˌhɑːt ˈtempərd/""",
...
"""),
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە بە ئاسانی زۆر تووڕە دەبێت"""),
                    SentencesRow(
                      englishText:
                          """The hot-tempered coach shouted at the players.""",
                      kurdishText:
                          """ڕاهێنەرە تووڕەکە هاواری بەسەر یاریزانەکاندا کرد..""",
