...
class EnglishEntryforsake extends StatefulWidget {
  const EnglishEntryforsake({super.key});

  @override
  State<EnglishEntryforsake> createState() => _EnglishEntryforsakeState();
}

class _EnglishEntryforsakeState extends State<EnglishEntryforsake> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: forsake (Derived forms: forsakes, forsaken, forsaking, forsook)
Usage: literary
1. Leave someone who needs or counts on you; leave in the lurch (= abandon, desolate, desert)
"The mother forsook her children";
""",
  );

  final String keyword = "forsake";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forsake""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forsake""",
                      // alsoEnglishWord: "also: forsake",
                      britshText: """IpaUK: /fəˈseɪk/""",
                      americanText: """IpaUS: /fərˈseɪk/""",
...
// With short examples define "forsake", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) جێهێشتنی کەسێک/شتێک"""),
                    SentencesRow(
                      englishText:
                          """He had made it clear to his wife that he would never forsake her.""",
                      kurdishText:
                          """ئەوەی بۆ هاوسەرەکەی ڕوون کردبوو کە هەرگیز دەستبەرداری نابێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) وەستان لە کردنی شتێک، یان وازهێنان لە شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She forsook the glamour of the city and went to live in the wilds of Scotland.""",
                      kurdishText:
                          """زریقەوبریقەی شاری جێهێشت و چوو لە دەشتەکانی سکۆتلەندا بژی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/fRcPn3mJSyY?t=';
const double _startSecondsend = 000000000000000000000000000419;
const String _videoIdone = 'https://youtu.be/zJt0e8FRBwM?t=';
const double _startSecondsone = 00000000000000000000000000071;
const String _videoIdtwo = 'https://youtu.be/sJEDfAbuutA?t=';
const double _startSecondstwo = 0000000000000000000000000002979;
const String _videoIdthree = 'https://youtu.be/CzP23Zti-YI?t=';
const double _startSecondsthree = 000000000000000000000000000446;
const String _videoIdfour = 'https://youtu.be/oDDwjhxASqA?t=';
const double _startSecondsfour = 000000000000000000000000000378;
const String _videoIdfive = 'https://youtu.be/gkZaDP0xCdg?t=';
const double _startSecondsfive = 00000000000000000000000000050;
