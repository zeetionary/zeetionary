...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 933;
    const String videoIdone = 'S4qvPouh1gE';
    const double startSecondsone = 2954;
    const String videoIdtwo = 'SHfqtaa0VI8';
    const double startSecondstwo = 178;
    const String videoIdthree = 'j4kI2h3iotA';
    const double startSecondsthree = 385;
    const String videoIdfour = 'vk9nbEdemPo';
    const double startSecondsfour = 7;
    const String videoIdfive = 'lctv_pyT62o';
    const double startSecondsfive = 553;
