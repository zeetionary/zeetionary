...
class EnglishEntryepoch extends StatefulWidget {
  const EnglishEntryepoch({super.key});

  @override
  State<EnglishEntryepoch> createState() => _EnglishEntryepochState();
}

class _EnglishEntryepochState extends State<EnglishEntryepoch> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """epoch""",
                      // alsoEnglishWord: "also: epoch",
                      britshText: """IpaUK: /ˈiːpɒk/""",
                      americanText: """IpaUS: /ˈepək/""",
...
کوردی: سەردەم، قۆناخ، ڕۆژگار، چەرخ،	خاڵی وەرچەرخان یا گۆڕان، ڕووداوی مێژوویی هەرەگرنگ، مێژووی بنەڕەتی هەر شتێ،	(زەوی‌ناسی) لاسەردەم، قۆناخ
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) سەردەمێک لە مێژوو، بەتایبەتی کە ڕووداوی گرنگ تێیدا ڕوویداوە"""),
          SentencesRow(
            englishText:
                """The death of the emperor marked the end of an epoch in the country's history.""",
            kurdishText:
                """کۆچی دوایی ئیمپراتۆرەکە کۆتایی قۆناغێکی لە مێژووی وڵاتەکە دیاری کرد.""",
          ...
          SentencesRow(
            englishText:
                """The president said that his country was moving into a new epoch, which would be one of lasting peace.""",
            kurdishText:
                """سەرۆکەکە گوتی کە وڵاتەکەی دەچێتە سەردەمێکی تازەوە، کە ئاشتی بەردەوام دەبێت.""",
          ...
          SentencesRow(
            englishText:
                """Scientists discovered remains of woolly mammoths and mastodons believed to be from the Pleistocene epoch, more than 10,000 years ago.""",
            kurdishText:
                """زاناکان پاشماوەی مامووسی کوڵکن و ماستۆدۆنیان دۆزییەوە کە باوەڕ وایە سەر بە سەردەمی پلەیستۆسین بن لە زیاتر لە ١٠٠٠٠ ساڵ پێش ئێستا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: epoch (Derived forms: epochs)
1. A period marked by distinctive character or reckoned from a fixed point or event (= era)
 
2. (astronomy) an arbitrarily fixed date that is the point in time relative to which information (as coordinates of a celestial body) is recorded (= date of reference)
 
3. A unit of geological time that is a subdivision of a period and is itself divided into ages
 
4. (machine learning) one iteration of learning with a sample of training data
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/JGVBv7svKLo?t=';
const double _startSecondsend = 000000000000000000000000000000; // 282;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/4HF4Phgafdw?t=';
const double _startSecondsone = 00000000000000000000000000000; // 119;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/UKxQTvqcpSg?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 556;
const String _videoIdthree = 'VIDEOhttps://youtu.be/pn3euL8Tbfw?t=';
const double _startSecondsthree = 000000000000000000000000000; // 457;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/BIhr61lnc3Y?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 751;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/1lPJ5SX5p08?t=';
