...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 12456;
    const String videoIdone = 'wdP_UDSsuro';
    const double startSecondsone = 679;
    const String videoIdtwo = 'Z4mPUWWI_o8';
    const double startSecondstwo = 852;
    const String videoIdthree = 'IifdsfniFS0';
    const double startSecondsthree = 1019;
    const String videoIdfour = 'mVXk2GqhUK4';
    const double startSecondsfour = 45;
    const String videoIdfive = 'DB5DN-nV1PM';
