...
کوردی: کۆتایی، دووماهی، دوایی، ئاخر، ئەنجام، ئاکام
"""),
          const DefinitionKurdish(
              text: """١. (ناو) بەشی کۆتایی چیرۆکێک. فیلمێک، هتد"""),
          SentencesRow(
            englishText: """His stories usually have a happy ending.""",
            kurdishText: """چیرۆکەکانی زۆرجار کۆتاییەکی خۆشیان هەیە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """کتێبەکە کۆتاییەکی ناخۆشی هەیە.""",
            onPressedBritish: () => speaksentence3("en-GB" ""),
            onPressedAmerican: () => speaksentence3("en-US" ""),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """٢. (ناو) کۆتاییهێنان بە شتێک"""),
          // const DividerSentences(),
          SentencesRow(
            englishText:
                """Today is the anniversary of the ending of the Pacific War.""",
            kurdishText: """ئەمڕۆ ساڵیادی کۆتایی هاتنی جەنگی زەریای هێمنە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """کۆتایی هاتنێکی ناوازە بوو بۆ ڕۆژێکی ناوازە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """سەرسام بووم بە کۆتایی هاتنی لەناکاوی گفتوگۆکە.""",
...
const String _videoIdtwo = 'https://youtu.be/GG0Xyc_wo-o?t=';
const double _startSecondstwo = 310;
const String _videoIdthree = 'https://youtu.be/043CQXHfx10?t=';
const double _startSecondsthree = 1311;
const String _videoIdfour = 'https://youtu.be/65CFesU4KVQ?t=';
const double _startSecondsfour = 278;
const String _videoIdfive = 'https://youtu.be/ETBfG6NZ248?t=';
const double _startSecondsfive = 653;
const String _videoIdsix = 'https://youtu.be/uN84HhcdIws?t=';
