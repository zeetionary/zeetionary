...
class EnglishEntryflotilla extends StatefulWidget {
  const EnglishEntryflotilla({super.key});

  @override
  State<EnglishEntryflotilla> createState() => _EnglishEntryflotillaState();
}

class _EnglishEntryflotillaState extends State<EnglishEntryflotilla> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flotilla (Derived forms: flotillas)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flotilla""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The navy deployed a flotilla of ships to patrol the coastline.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flotilla""",
                      // alsoEnglishWord: "also: flotilla",
                      britshText: """IpaUK: /fləˈtɪlə/""",
                      americanText: """IpaUS: /fləʊˈtɪlə/""",
...
کوردی: کەشتی‌گەلی چکۆلە، کەشتی‌گەلی شەڕکەری چکۆلانە
"""),
                    const DefinitionKurdish(text: """١. (ناو) گرووپێک بەلەم و کەشتی بچووک کە پێکەوە گەشت دەکەن"""),
                    SentencesRow(
                      englishText:
                          """The navy deployed a flotilla of ships to patrol the coastline.""",
                      kurdishText: """هێزی دەریایی کەشتی‌گەلی شەڕکەری چکۆلانە نارد بۆ چاودێری کەناراوەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/VhYHehpCZF8?t=';
const double _startSecondsend = 000000000000000000000000000435;
const String _videoIdone = 'https://youtu.be/4jwBxxgYcaw?t=';
const double _startSecondsone = 000000000000000000000000000527;
const String _videoIdtwo = 'https://youtu.be/W5Xy8h_Dfqk?t=';
const double _startSecondstwo = 000000000000000000000000000423;
const String _videoIdthree = 'https://youtu.be/M20PiFxMkrs?t=';
const double _startSecondsthree = 000000000000000000000000000110;
const String _videoIdfour = 'https://youtu.be/3SttYTYYLuk?t=';
const double _startSecondsfour = 00000000000000000000000000084;
const String _videoIdfive = 'https://youtu.be/DP0wLC57oEw?t=';
const double _startSecondsfive = 00000000000000000000000000068;
