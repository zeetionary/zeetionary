...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '7Byk_PmVKqM';
    const double startSecondsend = 534;
    const String videoIdone = '5gOH7Mb1FUo';
    const double startSecondsone = 1310;
    const String videoIdtwo = '6CZ0Q6jw4Z4';
    const double startSecondstwo = 6245;
    const String videoIdthree = 'Xt1G_6cSnO8';
    const double startSecondsthree = 1009;
    const String videoIdfour = 'XcrGQ0npuCw';
    const double startSecondsfour = 189;
    const String videoIdfive = 'Y4HSRtlJAM8';
