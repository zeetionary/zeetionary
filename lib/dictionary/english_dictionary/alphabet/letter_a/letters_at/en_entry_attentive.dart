...
// Define the word "attentive" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace attentive - replace EnglishEntryattentive

// replace speakAttentive - /əˈtentɪv/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryattentive extends StatelessWidget {
  // blank divider
  EnglishEntryattentive({super.key});
  // blank divider
  ...
  Future<void> speakattentive(String languageCode) async {
    ...
    await flutterTts.speak("attentive");
  }
  ...
  Future<void> speakattentive904(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He listened, quiet and attentive.");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "attentive"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'n2aXSpp-TXY';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'ZCqzSF2rt2o';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'XesV-XM_Q6c';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '5kT5FWhFWws';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'QefprURGzzI';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'U5ZcAlsSqio';
