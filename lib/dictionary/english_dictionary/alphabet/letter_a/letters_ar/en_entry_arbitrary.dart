...
class EnglishEntryarbitrary extends StatelessWidget {
  // blank divider
  EnglishEntryarbitrary({super.key});
  // blank divider
  ...
  Future<void> speakarbitrary(String languageCode) async {
    ...
    await flutterTts.speak("arbitrary");
  }
  ...
  Future<void> speakarbitrary1119(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("He makes unpredictable, arbitrary decisions.");
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUK: /ˈɑːbɪtrəri/, /ˈɑːbɪtri/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrbɪtreri/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'tbqh3US6qGI';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'l6MsNVtxpX8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'Z9V515odpf8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '8TC60EeJfr4';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Nsr_unjZw7k';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'xXW0jorau9k';
