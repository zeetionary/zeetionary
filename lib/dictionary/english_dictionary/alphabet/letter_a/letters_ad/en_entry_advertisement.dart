...
class EnglishEntryadvertisement extends StatelessWidget {
  EnglishEntryadvertisement({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "advertisement", // DOPSUM: CHANGE WORD ENTRY - Find /ədˈvɜːtɪsmənt/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ədˈvɜːtɪsmənt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
