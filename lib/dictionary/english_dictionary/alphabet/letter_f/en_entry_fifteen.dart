...
class EnglishEntryfifteen extends StatefulWidget {
  const EnglishEntryfifteen({super.key});

  @override
  State<EnglishEntryfifteen> createState() => _EnglishEntryfifteenState();
}

class _EnglishEntryfifteenState extends State<EnglishEntryfifteen> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fifteen""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They live about fifteen miles away.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They hadn't lost an election in fifteen years.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fifteen""",
                      // alsoEnglishWord: "also: fifteen",
                      britshText: """IpaUK: /ˌfɪfˈtiːn/""",
                      americanText: """IpaUS: /ˌfɪfˈtiːn/""",
...
// With short examples define "fifteen", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە دووری نزیکەی ١٥ میل دەژین.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She has served on the committee for the last fifteen years.""",
                      kurdishText:
                          """بۆ ١٥ ساڵی ڕابردوو خزمەتی لیژنەکەی کردبوو.""",
...
const String _videoIdone = 'https://youtu.be/S-4rhjO6xYg?t=';
const double _startSecondsone = 000000000000000000000000000536;
const String _videoIdtwo = 'https://youtu.be/hTqtGJwsJVE?t=';
const double _startSecondstwo = 0000000000000000000000000002819;
const String _videoIdthree = 'https://youtu.be/wknSc6HRUMI?t=';
const double _startSecondsthree = 000000000000000000000000000186;
const String _videoIdfour = 'https://youtu.be/-cPdImejxEQ?t=';
const double _startSecondsfour = 000000000000000000000000000208;
const String _videoIdfive = 'https://youtu.be/TVKNpjnqeg0?t=';
const double _startSecondsfive = 000000000000000000000000000828;
