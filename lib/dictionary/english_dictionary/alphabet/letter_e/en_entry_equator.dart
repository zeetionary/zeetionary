...
class EnglishEntryequator extends StatefulWidget {
  const EnglishEntryequator({super.key});

  @override
  State<EnglishEntryequator> createState() => _EnglishEntryequatorState();
}

class _EnglishEntryequatorState extends State<EnglishEntryequator> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""equator""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equator""",
                      // alsoEnglishWord: "also: equator",
                      britshText: """IpaUK: /ɪˈkweɪtə(r)/""",
                      americanText: """IpaUS: /ɪˈkweɪtər/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Indonesia is on the equator.""");
  }
...
کوردی: پشتێنەی زەوی، نیوان، یەکسانەهێڵ، پشتێنان
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) هێڵێکی خەیاڵی کە لە ناوەڕاستی زەوییە بە هەمان دووری لە خولگەی باکوور و باشوورەوە"""),
          SentencesRow(
            englishText: """Indonesia is on the equator.""",
            kurdishText: """ئەندەنووسیا لەسەر پشتێنەی زەوییە.""",
          ...
          SentencesRow(
            englishText:
                """The town lies exactly on the Equator, near Lake Victoria.""",
            kurdishText:
                """شارۆچکەکە بە تەواوی لەسەر پشتێنەی زەوییە، لە نزیک دەریاچەی ڤیکتۆریا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: equator (Derived forms: equators)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/T48_SrFCdaQ?t=';
const double _startSecondsend = 000000000000000000000000000000; // 242;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/Zpnykv3zbwg?t=';
const double _startSecondsone = 00000000000000000000000000000; // 82;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/lPNrtjboISg?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 47;
const String _videoIdthree = 'VIDEOhttps://youtu.be/ha2mLz-Xdpg?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1614;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/-aSdFrPnlRg?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 2020;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/eQzeHYI3Q7Q?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 442;
