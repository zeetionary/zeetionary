...
class EnglishEntrycornflour extends StatelessWidget {
// blank divider
  EnglishEntrycornflour({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcornflour(String languageCode) async {
    // DOPSUM: CHANGE speakcornflour
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "cornflour"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈkɔːnflaʊə(r)/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcornflour("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈkɔːrnflaʊər/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcornflour("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'Tl8rcah4jkw';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'KNy23spl2Zk';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'koc4RdafsQY';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'PsM_wA8WLL0';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'pbWALOAnq-M';
