...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1997;
    const String videoIdone = 'H4G2NXsuYyM';
    const double startSecondsone = 34;
    const String videoIdtwo = 'Nfl9KgjWpiw';
    const double startSecondstwo = 568;
    const String videoIdthree = '2nc9AFcKIuM';
    const double startSecondsthree = 146;
    const String videoIdfour = 'sY8aFSY2zv4';
    const double startSecondsfour = 7516;
    const String videoIdfive = '2fE2W8zoMvE';
