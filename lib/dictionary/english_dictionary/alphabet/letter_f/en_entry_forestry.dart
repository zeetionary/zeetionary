...
class EnglishEntryforestry extends StatefulWidget {
  const EnglishEntryforestry({super.key});

  @override
  State<EnglishEntryforestry> createState() => _EnglishEntryforestryState();
}

class _EnglishEntryforestryState extends State<EnglishEntryforestry> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forestry (Derived forms: forestries)
1. The science of planting and caring for forests and the management of growing timber
 
2. Land that is covered with trees and shrubs (= forest, woodland, timberland [N. Amer], timber, forestland [N. Amer])
""",
  );

  final String keyword = "forestry";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forestry""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Forestry workers planted new trees in the forest.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The forestry department managed the national park.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forestry""",
                      // alsoEnglishWord: "also: forestry",
                      britshText: """IpaUK: /ˈfɒrɪstri/""",
                      americanText: """IpaUS: /ˈfɔːrɪstri/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) زانست و کاری ناشتن و ئاگابوون لە دار و دارستان"""),
                    SentencesRow(
                      englishText:
                          """Forestry workers planted new trees in the forest.""",
                      kurdishText:
                          """کرێکارانی دارستانەوانی درەختی تازەیان ناشت لە دارستانەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The forestry department managed the national park.""",
                      kurdishText:
                          """بەشی دارستان پارکە نیشتیمانییەکەی بەڕێوە دەبرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/OnjI-FBdRTQ?t=';
const double _startSecondsend = 0000000000000000000000000008521;
const String _videoIdone = 'https://youtu.be/7bsuXsxX950?t=';
const double _startSecondsone = 000000000000000000000000000110;
const String _videoIdtwo = 'https://youtu.be/JITePXcDoGI?t=';
const double _startSecondstwo = 00000000000000000000000000055;
const String _videoIdthree = 'https://youtu.be/QPRpWg_wU0A?t=';
const double _startSecondsthree = 00000000000000000000000000072;
const String _videoIdfour = 'https://youtu.be/Iyni_oAfOoA?t=';
const double _startSecondsfour = 000000000000000000000000000244;
const String _videoIdfive = 'https://youtu.be/kMA97zbgwtw?t=';
const double _startSecondsfive = 000000000000000000000000000761;
