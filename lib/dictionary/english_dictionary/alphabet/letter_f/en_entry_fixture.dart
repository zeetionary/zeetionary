...
class EnglishEntryfixture extends StatefulWidget {
  const EnglishEntryfixture({super.key});

  @override
  State<EnglishEntryfixture> createState() => _EnglishEntryfixtureState();
}

class _EnglishEntryfixtureState extends State<EnglishEntryfixture> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fixture (Derived forms: fixtures)
1. An object firmly fixed in place (especially in a household)
 
2. A regular patron (= regular, habitué)
"a bum who is a Central Park fixture";
 
3. The quality of being fixed in place as by some firm attachment (= fastness, fixedness, fixity, secureness)
 
4. The act of putting something in working order again (= repair, fix, fixing, mend, mending, reparation)
 
5. [Brit] Sporting game or match on a specific date
""",
  );

  final String keyword = "fixture";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fixture""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There are plans to make the race an annual fixture.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The team is playing an important fixture this evening.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The price of the house includes fixtures and fittings.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fixture""",
                      // alsoEnglishWord: "also: fixture",
                      britshText: """IpaUK: /ˈfɪkstʃə(r)/""",
                      americanText: """IpaUS: /ˈfɪkstʃər/""",
...
کوردی: جێگیرکردن، چەسپاندن، کەل‌وپەلی جێگیری نێوماڵ،	ڕێکەوتی دیاری‌کراوی پێشبڕکێ،	توخمی جێگیر یان هەمیشەیی، مرۆی هەمیشەداکوتاو، مرۆی چەق‌بەستوو یان تەکان‌نەخواردوو، برابەش
"""),
// With short examples define "fixture", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پلان هەیە پێشبڕکێیەکە بکرێت بە یارییەکی ساڵانە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تیمەکە ئەم ئێوارەیە یارییەکی گرنگ دەکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """نرخی خانووەکە کەلووپەلە جێگیر و ناجێگیرەکان لەخۆدەگرێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/VyEf4EBXe8o?t=';
const double _startSecondsend = 000000000000000000000000000216;
const String _videoIdone = 'https://youtu.be/0Anx3VQ2dcc?t=';
const double _startSecondsone = 0000000000000000000000000001940;
const String _videoIdtwo = 'https://youtu.be/Sbp_EeBk-As?t=';
const double _startSecondstwo = 000000000000000000000000000137;
const String _videoIdthree = 'https://youtu.be/LbPw9AlVKVM?t=';
const double _startSecondsthree = 000000000000000000000000000841;
const String _videoIdfour = 'https://youtu.be/XBPV9putsfc?t=';
const double _startSecondsfour = 000000000000000000000000000228;
const String _videoIdfive = 'https://youtu.be/bnnRIrxGGX8?t=';
const double _startSecondsfive = 0000000000000000000000000001037;
