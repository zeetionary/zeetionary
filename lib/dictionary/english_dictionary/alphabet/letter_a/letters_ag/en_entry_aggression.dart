...
// replace these: replace EnglishEntryaggression - replace speakAggression - replace aggression - /əˈɡreʃn/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaggression extends StatelessWidget {
  EnglishEntryaggression({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "aggression", // DOPSUM: CHANGE WORD ENTRY - Find /əˈɡreʃn/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈɡreʃn/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'QMNfJ4ankDE';
