...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'dLNTb2zfh3Q';
    const double startSecondsend = 14;
    const String videoIdone = 'ewLpXw6uN28';
    const double startSecondsone = 904;
    ...
    const double startSecondsfour = 5268;
    const String videoIdfive = 'aABFIzfg72A';
    const double startSecondsfive = 1623;
