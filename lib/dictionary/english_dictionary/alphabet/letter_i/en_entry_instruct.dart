...
class EnglishEntryinstruct extends StatefulWidget {
  const EnglishEntryinstruct({super.key});

  @override
  State<EnglishEntryinstruct> createState() => _EnglishEntryinstructState();
}

class _EnglishEntryinstructState extends State<EnglishEntryinstruct> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: instruct (Derived forms: instructs, instructed, instructing)
1. Impart skills or knowledge to (- teach, learn)
"He instructed me in building a boat";
 
2. Give instructions or directions for some task
"She instructed the students to work on their pronunciation"
 
3. Make aware of (- apprise)
""",
  );

  final String keyword = "instruct";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""instruct""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She arrived at 10 o'clock as instructed.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He instructed that a wall be built around the city.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""All our staff have been instructed in sign language.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000185;
    const String videoIdone = 'https://youtu.be/EjidrUoHvPs?t=';
    const double startSecondsone = 000000000000000000000000000795;
    const String videoIdtwo = 'https://youtu.be/UG61a5vjxuI?t=';
    const double startSecondstwo = 000000000000000000000000000621;
    const String videoIdthree = 'https://youtu.be/_tHpanD6Nik?t=';
    const double startSecondsthree = 000000000000000000000000000172;
    const String videoIdfour = 'https://youtu.be/HYbbmatf6w4?t=';
    const double startSecondsfour = 000000000000000000000000000157;
    const String videoIdfive = 'https://youtu.be/kIwF0z9W5pE?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """instruct""",
                      // alsoEnglishWord: "also: instruct",
                      britshText: """IpaUK: /ɪnˈstrʌkt/""",
                      americanText: """IpaUS: /ɪnˈstrʌkt/""",
...
کوردی: 
"""),
// With short examples define "instruct", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) گوتن بە کەسێک کە شتێک بکات، بە تایبەتی بە فەرمی"""),
                    SentencesRow(
                      englishText:
                          """The letter instructed him to report to headquarters immediately.""",
                      kurdishText:
                          """نامەکە داوای لێیکرد کە دەسبەجێ بچێت بۆ بارەگا.""",
                      englishNote:
                          """This means the letter ordered him to go to the main office or central location without delay, indicating urgency in the matter.""",
                    ...
                    SentencesRow(
                      englishText:
                          """You will be instructed where to go as soon as the plane is ready.""",
                      kurdishText:
                          """هەرکە فڕۆکەکە ئامادە بێت ڕێنمایی دەکرێیت بۆ کوێ بچیت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وەک ئەوەی کە ڕێنمایی کرا لە کاتژمێر ١٠ گەشت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پێشنیاری ئەوەی کرد دیوارێک لە دەوری شارەکە درووست بکرێت.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (کردار) فێرکردنی کەسێک سەبارەت بە شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """All our staff have been instructed in sign language.""",
                      kurdishText:
                          """هەموو ستافەکەمان زمانی ئاماژەیان فێرکراوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) پێدانی زانیاری بە کەسێک سەبارەت بە شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """We have been instructed that a decision will not be made before the end of the week.""",
                      kurdishText:
                          """زانیاریمان پێدراوە کە بڕیار نادرێت لە پێش کۆتایی هەفتەکە.""",
