...
class EnglishEntryerrand extends StatefulWidget {
  const EnglishEntryerrand({super.key});

  @override
  State<EnglishEntryerrand> createState() => _EnglishEntryerrandState();
}

class _EnglishEntryerrandState extends State<EnglishEntryerrand> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """errand""",
                      // alsoEnglishWord: "also: errand",
                      britshText: """IpaUK: /ˈerənd/""",
                      americanText: """IpaUS: /ˈerənd/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He often runs errands for his grandmother.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her boss sent her on an errand into town.""");
  }
...
// With short examples define "errand", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: پەیام، فەرمانبەری، پەیام‌بەری، سپارشت، دەستووربەری، کارسپێری
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کارێک کە بۆ کەسێکی دەکەیت کە ئەوە لەخۆدەگرێت بچیتە شوێنێک، نامەیەک بگەیەنیت، شت بکڕیت، هتد"""),
          SentencesRow(
            englishText: """He often runs errands for his grandmother.""",
            kurdishText: """زۆرجار کارسپێری بۆ داپیرەی دەکات.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Her boss sent her on an errand into town.""",
            kurdishText: """سەرپەرشتیارەکەی بۆ کارسپێرییەک ناردی بۆ شارۆچکە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: errand (Derived forms: errands)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/JmWfY4nb6oM?t=';
const double _startSecondsend = 000000000000000000000000000000; // 219;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/cAfYtXB-qN4?t=';
const double _startSecondsone = 00000000000000000000000000000; // 230;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/lJItKbbnox8?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 14;
const String _videoIdthree = 'VIDEOhttps://youtu.be/l-RzJVQYPi0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 59;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/BztMgcNgobk?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 494;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/YCnFYvL17v4?t=';
