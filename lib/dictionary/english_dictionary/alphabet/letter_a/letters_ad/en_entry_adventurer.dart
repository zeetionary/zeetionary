...
// replace these: replace EnglishEntryadventurer - replace speakAdventurer - replace adventurer - /ədˈventʃərər/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadventurer extends StatelessWidget {
  EnglishEntryadventurer({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdventurer(String languageCode) async {
    // DOPSUM: CHANGE speakAdventurer
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("adventurer"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAdve3566(String languageCode) async {
    ...
    await flutterTts.speak(
        "He was something of an adventurer, living most of his life abroad."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "adventurer", // DOPSUM: CHANGE WORD ENTRY - Find /ədˈventʃərə(r)/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ədˈventʃərə(r)/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'qKfrgvO4IYs';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'ZSd40poykjE';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'p5SygzMSLhM';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = 'bSdnKu1k8Qg';
