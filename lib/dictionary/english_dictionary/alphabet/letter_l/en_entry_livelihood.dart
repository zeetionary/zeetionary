...
class EnglishEntrylivelihood extends StatefulWidget {
  const EnglishEntrylivelihood({super.key});

  @override
  State<EnglishEntrylivelihood> createState() => _EnglishEntrylivelihoodState();
}

class _EnglishEntrylivelihoodState extends State<EnglishEntrylivelihood> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: livelihood (Derived forms: livelihoods)
1. The financial means whereby one lives (- support, keep, living, bread and butter, sustenance)
"he could no longer earn his own livelihood";
""",
  );

  final String keyword = "livelihood";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""livelihood""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Communities on the island depended on fishing for their livelihood.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The boat was his main source of livelihood.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/qg2nGY1aqlg?t=172';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/anbBwpoI9TI?t=653';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/tsxmyL7TUJg?t=551';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/_h95pZQiKwI?t=331';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/oVj4kZF-Fgk?t=659';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/kBdfcR-8hEY?t=1269';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """livelihood""",
                      // alsoEnglishWord: "also: livelihood",
                      britshText: """IpaUK: /ˈlaɪvlihʊd/""",
                      americanText: """IpaUS: /ˈlaɪvlihʊd/""",
...
کوردی: ژیوار، گوزەران، دەرامەت، بەڕێ‌چوون، ئەنوا، هۆی گوزەران یان ژیوار، مایەی ژیوار یان بەڕێ‌چوون
"""),
// With short examples define "livelihood", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ڕێگای بەدەستهێنانی پارە بۆ ژیان"""),
                    const AlsoEnglishckb(word: "ھەروەھا: living"),
                    SentencesRow(
                      englishText: """Communities on the island depended on fishing for their livelihood.""",
                      kurdishText: """کۆمەڵگەکانی سەر دوورگەکە پشتیان بە ماسیگرتن دەبەست بۆ گوزەرانیان.""",
                    ...
                    SentencesRow(
                      englishText: """The boat was his main source of livelihood.""",
                      kurdishText: """بەلەمەکە تەنها سەرچاوەی گوزەرانی بوو.""",
