...
class EnglishEntryenamelled extends StatefulWidget {
  const EnglishEntryenamelled({super.key});

  @override
  State<EnglishEntryenamelled> createState() => _EnglishEntryenamelledState();
}

class _EnglishEntryenamelledState extends State<EnglishEntryenamelled> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("enamelled");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "enamelled",
                      // alsoEnglishWord: "also: enamelled",
                      britshText: "IpaUK: /ɪˈnæmld/",
                      americanText: "IpaUS: /ɪˈnæmld/",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enamelled";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("They used enamelled cookware in the kitchen.");
  }
...
// """),
          CustomRichText(
            ...
            onTap: () {
              Routemaster.of(context).push("/english-enamelled/enamel");
            },
          ),
          SentencesRow(
            englishText: """They used enamelled cookware in the kitchen.""",
            kurdishText: """حاجەتی میناڕێزیان لە چێشتخانەکە بەکاردەھێنا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: enamelled
1. [usually before noun] ​covered or decorated with enamel
""",
  );
