...
class EnglishEntrygradually extends StatefulWidget {
  const EnglishEntrygradually({super.key});

  @override
  State<EnglishEntrygradually> createState() => _EnglishEntrygraduallyState();
}

class _EnglishEntrygraduallyState extends State<EnglishEntrygradually> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gradually";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gradually""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The weather gradually improved.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Gradually, the children began to understand.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gradually""",
                      // alsoEnglishWord: "also: gradually",
                      britshText: """IpaUK: /ˈɡrædʒuəli/""",
                      americanText: """IpaUS: /ˈɡrædʒuəli/""",
...
// With short examples define "gradually", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بەشێوەیەک کە هێواشە و بە ماوەیەکی درێژ ڕوودەدات"""),
                    SentencesRow(
                      englishText: """The weather gradually improved.""",
                      kurdishText: """کەشووهەوا کەم کەم باشتر بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کەم کەم، منداڵان دەست دەکەن بە تێگەشتن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Women have gradually become more involved in the decision-making process.""",
                      kurdishText:
                          """ژنان کەم کەم بوونە بە بەشێک لە پڕۆسەی بڕیاردان.""",
...
const double _startSecondsend = 0000000000000000000000000001519;
const String _videoIdone = 'https://youtu.be/kGg44zdgHYM?t=';
...
const double _startSecondsthree = 0000000000000000000000000001142;
const String _videoIdfour = 'https://youtu.be/IlU-zDU6aQ0?t=';
const double _startSecondsfour = 0000000000000000000000000001545;
const String _videoIdfive = 'https://youtu.be/qr_dTySMl7s?t=';
const double _startSecondsfive = 000000000000000000000000000461;
