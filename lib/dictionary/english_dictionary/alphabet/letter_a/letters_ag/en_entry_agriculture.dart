...
class EnglishEntryagriculture extends StatelessWidget {
  EnglishEntryagriculture({super.key});
                        ...
                        Row(
                          children: [
                            ...
                            CustomIconButtonBritish(
                              onPressed: () => speakagriculture("en-GB"),
                            ),
                          ],
                        ),
                        Row(
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'Tynfe-kaPMg';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'tmQo5-730DI';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'HuRpEA1sFow';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '-cbWMoMs7yM';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'XTYz4m5AcKY';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'Zlpx2UARByo';
