...
class EnglishEntryhitman extends StatefulWidget {
  const EnglishEntryhitman({super.key});

  @override
  State<EnglishEntryhitman> createState() => _EnglishEntryhitmanState();
}

class _EnglishEntryhitmanState extends State<EnglishEntryhitman> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hitman (Derived forms: hit men, hitmen)
1. A professional killer who uses a gun (- gunman, gunslinger, hired gun, gun, gun for hire, triggerman, hit man, torpedo, shooter)
""",
  );

  final String keyword = "hitman";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Maybe somebody hired a hitman.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/j1BfO7VlIw4?t=';
    const double startSecondsend = 000000000000000000000000000298;
    const String videoIdone = 'https://youtu.be/OnjI-FBdRTQ?t=';
    const double startSecondsone = 00000000000000000000000000011605;
    const String videoIdtwo = 'https://youtu.be/obuHcBhlpOQ?t=';
    const double startSecondstwo = 00000000000000000000000000058;
    const String videoIdthree = 'https://youtu.be/Zt4oTxU0MC0?t=';
    const double startSecondsthree = 00000000000000000000000000055;
    const String videoIdfour = 'https://youtu.be/qZz5TBxTzTI?t=';
    const double startSecondsfour = 0000000000000000000000000001296;
    const String videoIdfive = 'https://youtu.be/rKrNfTKiG-M?t=';
    const double startSecondsfive = 0000000000000000000000000003235;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hitman""",
                      // alsoEnglishWord: "also: hitman",
                      britshText: """IpaUK: /ˈhɪtmæn/""",
                      americanText: """IpaUS: /ˈhɪtmæn/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText: """Maybe somebody hired a hitman.""",
                      kurdishText: """ڕەنگە کەسێک پیاوکوژێکی بە کرێ گرتبێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He claimed that a hitman had been paid £20 000 to kill him.""",
                      kurdishText:
                          """بانگەشەی ئەوەی دەکرد پیاوکوژەکە ٢٠٠٠٠ پاوەندی پێدرابوو بۆ کوشتنی.""",
