...
class EnglishEntryeuphemism extends StatefulWidget {
  const EnglishEntryeuphemism({super.key});

  @override
  State<EnglishEntryeuphemism> createState() => _EnglishEntryeuphemismState();
}

class _EnglishEntryeuphemismState extends State<EnglishEntryeuphemism> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""euphemism""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """euphemism""",
                      // alsoEnglishWord: "also: euphemism",
                      britshText: """IpaUK: /ˈjuːfəmɪzəm/""",
                      americanText: """IpaUS: /ˈjuːfəmɪzəm/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "euphemism";
...
کوردی: باش‌دەربڕی(ن)، باش‌دەربڕە، دەربڕینی جوان‌تر
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) وشە یان دەستەواژەیەکی ناڕاستەوخۆ کە خەڵکی بەکاری دەهێنن بۆ دوورکەوتنەوە لە یەکێکی دیکە کە گونجاو نییە یان شەرمهێنەرە"""),
          SentencesRow(
            englishText: """‘Pass away’ is a euphemism for ‘die’.""",
            kurdishText: """'کۆچی دوایی کرد' دەربڕینی گونجاوی 'مرد' ــە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: euphemism (Derived forms: euphemisms)
1. An inoffensive or indirect expression that is substituted for one that is considered offensive or too harsh (= genteelism)
...
const double _startSecondsend = 000000000000000000000000000000; // 678;
...
const double _startSecondstwo = 00000000000000000000000000000; // 1999;
const String _videoIdthree = 'VIDEOhttps://youtu.be/f-hQt7-CHpk?t=';
const double _startSecondsthree = 000000000000000000000000000; // 74;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/1vnbc8PQDCk?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 339;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/AMg4ooa0U-U?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 402;
