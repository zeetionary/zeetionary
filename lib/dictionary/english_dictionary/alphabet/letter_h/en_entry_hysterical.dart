...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'cAfYtXB-qN4';
    const double startSecondsend = 427;
    const String videoIdone = 'OIo2Ie1HwHY';
    const double startSecondsone = 748;
    const String videoIdtwo = 'XvVASCnsal8';
    const double startSecondstwo = 35;
    const String videoIdthree = 'jTRC_FMzLoo';
    const double startSecondsthree = 465;
    const String videoIdfour = 'oHLMla-75QA';
    const double startSecondsfour = 175;
    const String videoIdfive = '1h12uwyMZY0';
