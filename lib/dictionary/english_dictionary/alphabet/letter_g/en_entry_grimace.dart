...
class EnglishEntrygrimace extends StatefulWidget {
  const EnglishEntrygrimace({super.key});

  @override
  State<EnglishEntrygrimace> createState() => _EnglishEntrygrimaceState();
}

class _EnglishEntrygrimaceState extends State<EnglishEntrygrimace> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: grimace (Derived forms: grimaced, grimaces, grimacing)
1. Contort the face to indicate a certain mental or emotional state (- make a face, pull a face)
"He grimaced when he saw the amount of homework he had to do";

- Noun: grimace (Derived forms: grimaces)
1. A contorted facial expression (- face)
"she made a grimace at the prospect";
""",
  );

  final String keyword = "grimace";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grimace""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He grimaced at the bitter taste.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She grimaced as the needle went in.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He acknowledged his mistake with a wry grimace.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grimace""",
                      // alsoEnglishWord: "also: grimace",
                      britshText: """IpaUK: /ˈɡrɪməs/,  /ɡrɪˈmeɪs/""",
                      americanText: """IpaUS: /ˈɡrɪməs/,  /ɡrɪˈmeɪs/""",
...
// With short examples define "grimace", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) ئەنجامدانێکی دەربڕینێکی ناشرین بە ڕووخسارت بۆ پیشاندانی ئازار، حەز نەکردن لە شتێک، هتد"""),
                    SentencesRow(
                      englishText: """He grimaced at the bitter taste.""",
                      kurdishText: """گرژبوویەوە بە تامە تاڵەکە.""",
                    ...
                    SentencesRow(
                      englishText: """She grimaced as the needle went in.""",
                      kurdishText:
                          """خۆی گرژکردەوە کە دەرزییەکە چوو بە ناودا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) دەربڕینێکی ناشرین بە ڕووخسارت بۆ پیشاندانی ئازار، حەز نەکردن لە شتێک، هتد یان بۆ ئەوەی کەسێک پێ بکەنێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He acknowledged his mistake with a wry grimace.""",
                      kurdishText: """بە مۆنبوونەوەیەک دانی نا بە هەڵەکەیدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/NA3z2_nFxtw?t=';
const double _startSecondsend = 000000000000000000000000000227;
const String _videoIdone = 'https://youtu.be/VPYhem4GRGY?t=';
const double _startSecondsone = 0000000000000000000000000002434;
const String _videoIdtwo = 'https://youtu.be/7xXCaQTkrp0?t=';
const double _startSecondstwo = 000000000000000000000000000937;
const String _videoIdthree = 'https://youtu.be/58MRRR6TJgY?t=';
const double _startSecondsthree = 00000000000000000000000000084;
const String _videoIdfour = 'https://youtu.be/36oRiPAn4Tw?t=';
const double _startSecondsfour = 000000000000000000000000000162;
const String _videoIdfive = 'https://youtu.be/-ex7f7KVl3I?t=';
