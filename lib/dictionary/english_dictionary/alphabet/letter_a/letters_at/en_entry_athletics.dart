...
class EnglishEntryathletics extends StatelessWidget {
  ...
  Future<void> speakAthletics(String languageCode) async {
    // DOPSUM: CHANGE speakAthletics
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("athletics"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAthletics825(String languageCode) async {
    // DOPSUM: CHANGE speakAthletics
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "My daughter wants to compete in athletics."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "athletics", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /æθˈletɪks/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "76eGLHYOKBQ";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "R24ihv5JUeU";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "IaoItwBXuPw";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "O8XS2uTMPNk";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "A-2bvxm_pmE";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "yiqfgaf6GXE";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "w6CAS8HRPOc";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "u43hKzC3QTo";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "ai_awBcVL8o";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "fDGDc83ZSRs";
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  static String myVideoId = "33f6aPbUcno";
