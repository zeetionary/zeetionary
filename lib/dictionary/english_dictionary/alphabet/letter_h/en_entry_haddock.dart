...
// """),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ھادۆک سەرچاوەی باشی پڕۆتینە.""",
...
const String _videoIdend = 'KObL442PWhQ';
const double _startSecondsend = 233;
const String _videoIdone = 'ishwT92D8Ec';
const double _startSecondsone = 146;
const String _videoIdtwo = 'A_uyT6UEBFs';
const double _startSecondstwo = 817;
const String _videoIdthree = 'JgA6GWAtIAo';
const double _startSecondsthree = 466;
const String _videoIdfour = 'CYEFR_kg6Us';
const double _startSecondsfour = 16;
const String _videoIdfive = 'ZWmp3a_lQBc';
const double _startSecondsfive = 919;
