...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 357;
    const String videoIdone = 'Unzc731iCUY';
    const double startSecondsone = 2018;
    const String videoIdtwo = 'IesIsKMjB4Y';
    const double startSecondstwo = 132;
    const String videoIdthree = 'NWGVFi-213w';
    const double startSecondsthree = 201;
    const String videoIdfour = '6MoBvV12C58';
    const double startSecondsfour = 322;
    const String videoIdfive = 'w3XS900kg1U';
    const double startSecondsfive = 961;
