...
""",
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She hitched up her skirt and waded into the river.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    // 188888880002200
    const String videoIdend = 'https://youtu.be/OZ_xhkg32nk?t=';
    const double startSecondsend = 000000000000000000000000000257;
    const String videoIdone = 'https://youtu.be/OIo2Ie1HwHY?t=';
    const double startSecondsone = 0000000000000000000000000002359;
    const String videoIdtwo = 'https://youtu.be/LfR4QfmwTAc?t=';
    const double startSecondstwo = 000000000000000000000000000182;
    const String videoIdthree = 'https://youtu.be/s3YTfhJmh1I?t=';
    const double startSecondsthree = 000000000000000000000000000473;
    const String videoIdfour = 'https://youtu.be/XxOh12Uhg08?t=';
    const double startSecondsfour = 000000000000000000000000000895;
    const String videoIdfive = 'https://youtu.be/HbUGTcdFIio?t=';
    const double startSecondsfive = 0000000000000000000000000003039;
...
// With short examples define "hitch", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ئەوەی کەسێک بە بێ‌بەرامبەر بتگەیەنێتە شوێنێک بە ئۆتۆمبێل"""),
                    SentencesRow(
                    ...
                    SentencesRow(
                      englishText: """They tried to hitch a lift back to London.""",
                      kurdishText: """هەوڵیان دا گەڕانەوەیەک بۆ لەندەن بەدەست بخەن.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) بەرزکردنەوەی پارچە جلێکت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: hike up"),
                    SentencesRow(
                      englishText: """She hitched up her skirt and waded into the river.""",
                      kurdishText: """تەنوورەکەیی بەرزکردەوە و ڕۆشتە ناو ڕووبارەکە.""",
                      englishNote: """This means she pulled her skirt higher to avoid getting it wet and then walked into the shallow part of the river.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) بەرزکردنەوەی خۆت بۆ شوێنێکی بەرزتر یان ئەو شوێنەی باسکراوە"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) بەستنەوەی شتێک بە شتێکی دیکە"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (کردار) کێشە یان سەختییەک کە دواکەوتنێکی کورت درووست دەکات"""),
                    const DividerSentences(),
                    SentencesRow(
