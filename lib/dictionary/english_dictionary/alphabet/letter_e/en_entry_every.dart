...
class EnglishEntryevery extends StatefulWidget {
  const EnglishEntryevery({super.key});

  @override
  State<EnglishEntryevery> createState() => _EnglishEntryeveryState();
}

class _EnglishEntryeveryState extends State<EnglishEntryevery> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """every""",
                      // alsoEnglishWord: "also: every",
                      britshText: """IpaUK: /ˈevri/""",
                      americanText: """IpaUS: /ˈevri/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She knows every student in the school.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I could hear every word they said.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We enjoyed every minute of our stay.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I get that wrong every single time.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I read every last article in the newspaper.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They were watching her every movement.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The buses go every 10 minutes.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We had to stop every few miles.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""One in every three marriages ends in divorce.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We see each other every now and again.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We wish you every success.""");
  }
...
کوردی: هەمووی، گشتی، تێکڕای، تەواوی،	هەر، هەریەک لە،	ناوەناوە، جارجار
"""),
          const DefinitionKurdish(
              text:
                  """١. (دیارخەر) لەگەڵ ناوی تاک بەکاردێت بۆ باسکردنی هەموو ئەو کەس و شتانەی لە گرووپێکن"""),
          SentencesRow(
            englishText: """She knows every student in the school.""",
            kurdishText: """هەموو خوێندکارێکی قوتابخانەکە دەناسێنێت.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """ژممارە. (دیارخەر) پێنناسە"""),
          Column(
            children: [
              MyExpansionTile(
                children: [
                  SentencesRow(
                    englishText: """I could hear every word they said.""",
                    kurdishText: """گوێم لە هەر وشەیەک بوو کە گوتیان.""",
                    onPressedBritish: () => speaksentence2("en-GB"),
                    onPressedAmerican: () => speaksentence2("en-US"),
                  ),
                  const DividerDefinition(),
                  const DefinitionKurdish(
                      text: """ژممارە. (دیارخەر) پێنناسە"""),
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """We enjoyed every minute of our stay.""",
                    kurdishText:
                        """چێژمان لە هەموو خولەکێکی مانەوەکەمان بینی.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText: """هەموو ڕۆژێک دەچم بۆ جیم.""",
                  ...
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """I get that wrong every single time.""",
                    kurdishText: """هەموو جارێک ئەوە بە هەڵە وردەگرم.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText: """هەموو وتارێکی ڕۆژنامەکەم خوێندەوە.""",
                  ...
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """They were watching her every movement.""",
                    kurdishText: """چاودێری هەر جوڵەیەکیان دەکرد.""",
          ...
          SentencesRow(
            ...
            kurdishText: """پاسەکان هەر ١٠ خولەکێک دەچن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """We had to stop every few miles.""",
            kurdishText: """هەر چەند میلێک دەبوو بوەستین.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """One in every three marriages ends in divorce.""",
            kurdishText:
                """یەکێک لە کۆی هەر سێ هاوسەرگیرییەک بە جیابوونەوە کۆتایی دێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """We see each other every now and again.""",
            kurdishText: """هەر جار نا جارێک یەکدی دەبینینەوە.""",
            onPressedBritish: () => speaksentence11("en-GB"),
            onPressedAmerican: () => speaksentence11("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٣. (دیارخەر) هەموو ئەوەی ئەگەری هەیە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """We wish you every success.""",
            kurdishText: """هیوای هەموو سەرکەوتنێکت بۆ دەخوازین.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He had every reason to be angry.""",
            kurdishText: """هەموو هۆکارێکی هەبوو کە تووڕە بێت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: every
1. (used of countable nouns) each and all of the members of a group considered singly and without exception
...
const double _startSecondsend = 000000000000000000000000000000; // 92;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/_Z0ZQT0FttM?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1398;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/tuqqRnej8vo?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 87;
const String _videoIdthree = 'VIDEOhttps://youtu.be/fXLrw7XozC8?t=';
const double _startSecondsthree = 000000000000000000000000000; // 64;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/G4BxOhJOmUw?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 55;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/Pto9L7kjuSM?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 43;
