...
class EnglishEntryaboutturn extends StatefulWidget {
  const EnglishEntryaboutturn({super.key});

  @override
  State<EnglishEntryaboutturn> createState() => _EnglishEntryaboutturnState();
}

class _EnglishEntryaboutturnState extends State<EnglishEntryaboutturn> {
  @override
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "about turn");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: about turn");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakaboutturn(String languageCode) async {
    // DOPSUM: CHANGE speakaboutturn
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakaboutturns1(String languageCode) async {
    // DOPSUM: CHANGE speakaboutturn
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
...
// Create an instance of EnglishMeaningConst with the desired text
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: about turn (derived forms: about turns)
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'XMaZ7lrpa7k';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'Suj_JJbgDNA';
...
// speakaboutturns111111111111111111111111111111111
