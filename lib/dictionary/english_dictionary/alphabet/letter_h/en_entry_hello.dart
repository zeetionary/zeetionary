...
class EnglishEntryhello extends StatefulWidget {
  const EnglishEntryhello({super.key});

  @override
  State<EnglishEntryhello> createState() => _EnglishEntryhelloState();
}

class _EnglishEntryhelloState extends State<EnglishEntryhello> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Interjection: hello
1. Used as a greeting (- aloha [US, informal], g'day [Austral, informal], greetings, hi [informal], hiya [informal], hallo, hullo, hey [informal], howdy [informal], howzit [S.Africa, informal], gidday [NZ, informal], yo [informal], wotcha [Brit, informal], wotcher [Brit, informal])
 
2. A call for response if it is not clear whether anyone is present or listening (- hullo, hallo)
 
3. Used sarcastically to imply that something is foolish or unrealistic (- hullo, hallo)

- Noun: hello (Derived forms: hellos)
1. An expression of greeting (- hullo, hi, howdy, how-do-you-do, hallo)
"every morning they exchanged polite hellos";

- Verb: hello (Derived forms: helloed, helloes, helloing)
1. Shout or greet with hello
""",
  );
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Hello John, how are you?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Hello, is there anybody there?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Say hello to Liz for me.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They exchanged hellos and forced smiles.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Hello, hello, what's going on here?""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Hello? You didn't really mean that, did you?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hello""",
                      // alsoEnglishWord: "also: hello",
                      britshText: """IpaUK: /həˈləʊ/""",
                      americanText: """IpaUS: /həˈləʊ/""",
...
کوردی: 
"""),
// With short examples define "hello", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو، سەرسوڕمان) بەکاردێت بۆ سڵاوکردن لە کاتی بینینی کەسێک، نووسینی نامەیەک، یان کە وەڵامی پەیوەندی تەلەفۆنی دەدەیتەوە"""),
                    SentencesRow(
                      englishText: """Hello John, how are you?""",
                      kurdishText: """سڵاو جۆن، چۆنیت؟""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """ژممر. (ناو، سەرسوڕمان) پننسە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Hello, is there anybody there?""",
                      kurdishText: """سڵاو، کەس لەوێیە؟.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Say hello to Liz for me.""",
                      kurdishText: """سڵاو لە لیز بکە بۆم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سڵاویان لە یەکدی کرد و بە زۆر سڵاویان کرد لە یەک.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو، سەرسوڕمان) بۆ گوتنی ئەوەی سەرسامی بە شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Hello, hello, what's going on here?""",
                      kurdishText: """ها، ها، چی ڕوودەدات لێرە؟""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو، سەرسوڕمان) بۆ گوتنی ئەوەی کەسێک شتێکی گەمژانەی گوتووە یان سەرنجدان"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Hello? You didn't really mean that, did you?""",
                      kurdishText: """ها؟ بە راستی مەبەستت ئەوە نەبوو، وایە؟""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/cjLooycOwVc?t=';
const double _startSecondsend = 000000000000000000000000000157;
const String _videoIdone = 'https://youtu.be/YQHsXMglC9A?t=';
const double _startSecondsone = 00000000000000000000000000067;
const String _videoIdtwo = 'https://youtu.be/hTqtGJwsJVE';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/MPS2fwRMFgM?t=';
const double _startSecondsthree = 00000000000000000000000000056;
const String _videoIdfour = 'https://youtu.be/EdQxtsTwHHs?t=';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/QtrRtGC3G_I?t=';
