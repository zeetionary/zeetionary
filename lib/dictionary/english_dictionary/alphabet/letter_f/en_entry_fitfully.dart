...
class EnglishEntryfitfully extends StatefulWidget {
  const EnglishEntryfitfully({super.key});

  @override
  State<EnglishEntryfitfully> createState() => _EnglishEntryfitfullyState();
}

class _EnglishEntryfitfullyState extends State<EnglishEntryfitfully> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fitfully""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fitfully""",
                      // alsoEnglishWord: "also: fitfully",
                      britshText: """IpaUK: /ˈfɪtfəli/""",
                      americanText: """IpaUS: /ˈfɪtfəli/""",
...
// With short examples define "fitfully", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """She slept fitfully throughout the night and arose before dawn.""",
                      kurdishText:
                          """شەوەکە پچڕپچڕانە خەوت و پێش خۆرهەڵاتن هەستا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/0e8woEkKmG8?t=';
const double _startSecondsend = 000000000000000000000000000232;
const String _videoIdone = 'https://youtu.be/KfQOsKmyCNY?t=';
const double _startSecondsone = 0000000000000000000000000001594;
const String _videoIdtwo = 'https://youtu.be/j2WNylgbFWg?t=';
const double _startSecondstwo = 000000000000000000000000000591;
const String _videoIdthree = 'https://youtu.be/qhpjSW1Oeow?t=';
const double _startSecondsthree = 0000000000000000000000000004878;
const String _videoIdfour = 'https://youtu.be/Ne4WITiQBEg?t=';
const double _startSecondsfour = 000000000000000000000000000128;
const String _videoIdfive = 'https://youtu.be/BvhwC3HHWKE?t=';
