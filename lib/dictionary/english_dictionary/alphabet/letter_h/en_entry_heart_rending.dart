...
class EnglishEntryheartrending extends StatefulWidget {
  const EnglishEntryheartrending({super.key});

  @override
  State<EnglishEntryheartrending> createState() =>
      _EnglishEntryheartrendingState();
}

class _EnglishEntryheartrendingState extends State<EnglishEntryheartrending> {
  @override
  void initState() {
    super.initState();
...
1. Causing or marked by grief or anguish (- grievous, heartbreaking)
"the heartrending words of Rabin's granddaughter";
""",
  );

  final String keyword = "heart-rending";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heart-rending""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heart-rending""",
                      // alsoEnglishWord: "also: heart-rending",
                      britshText: """IpaUK: /ˈhɑːt rendɪŋ/""",
                      americanText: """IpaUS: /ˈhɑːrt rendɪŋ/""",
...
کوردی: خەماوی، پشت‌شکێن، جەرگبڕ، دڵ‌شکێن
"""),
// With short examples define "heart-rending", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە هەستی دڵتەنگی درووست دەکات"""),
                    const AlsoEnglishckb(word: "ھەروەھا: heartbreaking"),
                    SentencesRow(
                      englishText:
                          """The film told a heart-rending story of loss and hope.""",
                      kurdishText:
                          """فیلمەکە چیرۆکێکی جەرگبڕی لەدەستدان و هیوای دەگێڕایەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/TewAbpe8RAg?t=';
const double _startSecondsend = 000000000000000000000000000519;
const String _videoIdone = 'https://youtu.be/fvysQgdEJeY?t=';
const double _startSecondsone = 000000000000000000000000000215;
const String _videoIdtwo = 'https://youtu.be/7fK0jZBusJg?t=';
const double _startSecondstwo = 0000000000000000000000000001241;
const String _videoIdthree = 'https://youtu.be/lkiKn9u0bEQ?t=';
const double _startSecondsthree = 000000000000000000000000000233;
const String _videoIdfour = 'https://youtu.be/0ypfzvQ-Q2w?t=';
const double _startSecondsfour = 000000000000000000000000000878;
const String _videoIdfive = 'https://youtu.be/ukzNn1ycKkQ?t=';
const double _startSecondsfive = 000000000000000000000000000758;
