...
class EnglishEntryinducement extends StatefulWidget {
  const EnglishEntryinducement({super.key});

  @override
  State<EnglishEntryinducement> createState() => _EnglishEntryinducementState();
}

class _EnglishEntryinducementState extends State<EnglishEntryinducement> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: inducement (Derived forms: inducements)
1. A positive motivational influence (- incentive, motivator)
 
2. Act of bringing about a desired result (- inducing)
"inducement of sleep";
""",
  );

  final String keyword = "inducement";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inducement""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""There is little inducement for them to work harder.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/spr5smxuO5E?t=';
    const double startSecondsend = 000000000000000000000000000145;
    const String videoIdone = 'https://youtu.be/mOkx6A02ero?t=';
    const double startSecondsone = 000000000000000000000000000371;
    const String videoIdtwo = 'https://youtu.be/HEcI_tCU5DQ?t=';
    const double startSecondstwo = 000000000000000000000000000378;
    const String videoIdthree = 'https://youtu.be/eEaUHrIuWCI?t=';
    const double startSecondsthree = 00000000000000000000000000078;
    const String videoIdfour = 'https://youtu.be/q4245shr_r0?t=';
    const double startSecondsfour = 000000000000000000000000000263;
    const String videoIdfive = 'https://youtu.be/R_59ZeuJCOU?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inducement""",
                      // alsoEnglishWord: "also: inducement",
                      britshText: """IpaUK: /ɪnˈdjuːsmənt/""",
                      americanText: """IpaUS: /ɪnˈduːsmənt/""",
...
// کوردی: بزوێنەر، هان‌دەر، گوڕپێدەر، گوڕ، مایە،	(بۆ جوان‌تر دەربڕین) دەم‌شیرینی، بەرتیل، دیاری
// """),
// With short examples define "inducement", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) شتێک کە دەدرێت بە کەسێک بۆ ڕازیکردنی بۆ کردنی شتێک"""),
                    const AlsoEnglishckb(word: "ھەروەھا: incentive"),
                    SentencesRow(
                      englishText:
                          """There is little inducement for them to work harder.""",
                      kurdishText:
                          """پاڵنەری کەم هەیە بۆیان تاوەکو بە سەختتر کار بکەن.""",
