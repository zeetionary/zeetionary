...
class EnglishEntrylonely extends StatefulWidget {
  const EnglishEntrylonely({super.key});

  @override
  State<EnglishEntrylonely> createState() => _EnglishEntrylonelyState();
}

class _EnglishEntrylonelyState extends State<EnglishEntrylonely> {
  @override
  void initState() {
    super.initState();
