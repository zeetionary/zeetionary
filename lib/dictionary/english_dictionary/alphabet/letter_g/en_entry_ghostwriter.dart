...
class EnglishEntryghostwriter extends StatefulWidget {
  const EnglishEntryghostwriter({super.key});

  @override
  State<EnglishEntryghostwriter> createState() =>
      _EnglishEntryghostwriterState();
}

class _EnglishEntryghostwriterState extends State<EnglishEntryghostwriter> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "ghostwriter";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""ghostwriter""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ghostwriter""",
                      // alsoEnglishWord: "also: ghostwriter",
                      britshText: """IpaUK: /ˈɡəʊstraɪtə(r)/""",
                      americanText: """IpaUS: /ˈɡəʊstraɪtər/""",
...
// With short examples define "ghostwriter", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The novel was largely written by an unacknowledged ghostwriter.""",
                      kurdishText:
                          """ڕۆمانەکە بەشێکی زۆری لەلایەن نووسەرێکی نەناسراو و ئاشکرانەکراو نووسرابوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/nn8zfDv3EbA?t=';
const double _startSecondsend = 000000000000000000000000000319;
const String _videoIdone = 'https://youtu.be/QDkLaDDJhG8?t=';
const double _startSecondsone = 000000000000000000000000000227;
const String _videoIdtwo = 'https://youtu.be/nTXG1qDbOtA?t=';
const double _startSecondstwo = 000000000000000000000000000293;
const String _videoIdthree = 'https://youtu.be/LkNxvUrWQ_Q?t=';
const double _startSecondsthree = 000000000000000000000000000217;
const String _videoIdfour = 'https://youtu.be/AKWZd6dXMYc?t=';
const double _startSecondsfour = 000000000000000000000000000259;
const String _videoIdfive = 'https://youtu.be/k_lzPRbwmMA?t=';
