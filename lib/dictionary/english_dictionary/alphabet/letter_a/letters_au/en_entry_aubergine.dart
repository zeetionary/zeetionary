...
// Define the word "aubergine" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace aubergine - replace EnglishEntryaubergine

// replace speakAubergine - /ˈəʊbəʒiːn/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryaubergine extends StatelessWidget {
  // blank divider
  EnglishEntryaubergine({super.key});
  // blank divider
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "aubergine", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˈəʊbərʒiːn/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "mQoNAR1um_c";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "CMC4g5_ki34";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "6i9UUvxhAlY";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "z4Bwb8_k7yM";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "ex1V3hsi_Nc";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "qJhpVQLGp9g";

  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 1180, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
      autoPlay: true,
      enableCaption: true,
      loop: true,
...
// end aubergine// TODO Implement this library.