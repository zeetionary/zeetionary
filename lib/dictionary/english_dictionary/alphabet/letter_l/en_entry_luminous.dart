...
class EnglishEntryluminous extends StatefulWidget {
  const EnglishEntryluminous({super.key});

  @override
  State<EnglishEntryluminous> createState() => _EnglishEntryluminousState();
}

class _EnglishEntryluminousState extends State<EnglishEntryluminous> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryluminous luminous
WORD_WEB luminous luminous luminous
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "luminous";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""luminous""");
  }
...
کوردی: 
"""),
// With short examples define "luminous", please follow LX instructions
