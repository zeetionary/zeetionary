...
class EnglishEntryenquiring extends StatefulWidget {
  const EnglishEntryenquiring({super.key});

  @override
  State<EnglishEntryenquiring> createState() => _EnglishEntryenquiringState();
}

class _EnglishEntryenquiringState extends State<EnglishEntryenquiring> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enquiring""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enquiring""",
                      // alsoEnglishWord: "also: enquiring",
                      britshText: """IpaUK: /ɪnˈkwaɪərɪŋ/""",
                      americanText: """IpaUS: /ɪnˈkwaɪərɪŋ/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enquiring";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Teachers enjoy a child with an enquiring mind.""");
  }
...
کوردی: بەپرسیار، پرسیارکار، پرسا، پرسیارلێکەر (بۆ زانیاری)، پرسیارکارانە
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) کە حەز بە زانینی شتی تازە دەکات"""),
          SentencesRow(
            englishText: """Teachers enjoy a child with an enquiring mind.""",
            kurdishText: """مامۆستایان حەزیان بە منداڵانی زانین‌خواز هەیە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: enquiring
1. [usually before noun] ​showing an interest in learning new things
...
const String _videoIdend = 'https://youtu.be/bx8voyWV_3w?t=';
const double _startSecondsend = 598;
const String _videoIdone = 'https://youtu.be/1Tu7wh9QMio?t=';
const double _startSecondsone = 443;
const String _videoIdtwo = 'https://youtu.be/Hytoh0BbAOg?t=';
const double _startSecondstwo = 46;
const String _videoIdthree = 'https://youtu.be/MYsW_k3ln3I?t=';
const double _startSecondsthree = 58;
const String _videoIdfour = 'https://youtu.be/5UboO8RjfTs?t=';
const double _startSecondsfour = 239;
const String _videoIdfive = 'https://youtu.be/kBHYfW5J6YE?t=';
const double _startSecondsfive = 678;
const String _videoIdsix = 'https://youtu.be/32uTh62lJeg?t=';
const double _startSecondssix = 64;
