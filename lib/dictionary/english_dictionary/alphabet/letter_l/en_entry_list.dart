...
class EnglishEntrylist extends StatefulWidget {
  const EnglishEntrylist({super.key});

  @override
  State<EnglishEntrylist> createState() => _EnglishEntrylistState();
}

class _EnglishEntrylistState extends State<EnglishEntrylist> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: list (Derived forms: lists)
1. A database containing an ordered array of items (names or topics) (- listing)
 
2. The property possessed by a line or surface that departs from the vertical (- tilt, inclination, lean, leaning)
"the ship developed a list to starboard";

- Verb: list (Derived forms: listed, lists, listing)
1. Give or make a list of; name individually; give the names of (- name)
"List the states west of the Mississippi";
 
3. Include in a list
"Am I listed in your register?"
 
4. Cause to lean to the side (- lean)
"Erosion listed the old tree";
 
5. Tilt to one side (- heel)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Is your name on the list?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'll add you to the email list.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I made a list of things to do.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The key points are listed below.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Key benefits are listed in Table 1.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This laptop lists at £500.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/544DTGHIBM0?t=193';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/_GFkHA5EZdE?t=409';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/a_TSR_v07m0?t=306';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/Cln0J87vulU?t=507';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/_45zjnjrFOA?t=207';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/pTysrwci0pU?t=1095';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """list""",
                      // alsoEnglishWord: "also: list",
                      britshText: """IpaUK: /lɪst/""",
                      americanText: """IpaUS: /lɪst/""",
...
// With short examples define "list", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """I'll add you to the email list.""",
                      kurdishText: """زیادت دەکەم بۆ لیستی ئیمەیڵەکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The key points are listed below.""",
                      kurdishText: """خاڵە سەرەکییەکان لە خوارەوە ڕیز کراون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لاپتۆپەکە بە ٥٠٠ دۆلار دانراوە.""",
