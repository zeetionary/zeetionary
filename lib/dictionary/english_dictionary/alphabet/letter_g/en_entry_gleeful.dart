...
class EnglishEntrygleeful extends StatefulWidget {
  const EnglishEntrygleeful({super.key});

  @override
  State<EnglishEntrygleeful> createState() => _EnglishEntrygleefulState();
}

class _EnglishEntrygleefulState extends State<EnglishEntrygleeful> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gleeful""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was gleeful about the idea of making his own movie.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He laughed with gleeful malice at their embarrassment.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gleeful""",
                      // alsoEnglishWord: "also: gleeful",
                      britshText: """IpaUK: /ˈɡliːfl/""",
                      americanText: """IpaUS: /ˈɡliːfl/""",
...
// With short examples define "gleeful", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) دڵخۆش، بە تایبەتی بەهۆی ئەوەی شتێکی باشت کردووە یان شتێکی خراپ بەسەر کەسێک هاتووە"""),
                    SentencesRow(
                      englishText: """He was gleeful about the idea of making his own movie.""",
                      kurdishText: """بەکەیف بوو سەبارەت بە بیرکردنەوەی ئەوەی کە فیلمی خۆی بەرهەم دەهێنێت.""",
                    ...
                    SentencesRow(
                      englishText: """He laughed with gleeful malice at their embarrassment.""",
                      kurdishText: """بە خۆشحاڵییەکی بەدخوازانەوە پێکەنی بە شەرمەزارییەکەیان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ndHOav52t7k?t=';
const double _startSecondsend = 00000000000000000000000000070;
const String _videoIdone = 'https://youtu.be/i_ppflSR-ww?t=';
const double _startSecondsone = 000000000000000000000000000217;
const String _videoIdtwo = 'https://youtu.be/fz5KrLjCZ1U?t=';
const double _startSecondstwo = 000000000000000000000000000368;
const String _videoIdthree = 'https://youtu.be/rLFns5Tz-Iw?t=';
const double _startSecondsthree = 000000000000000000000000000282;
const String _videoIdfour = 'https://youtu.be/M90i4QAXxy0?t=';
const double _startSecondsfour = 000000000000000000000000000291;
const String _videoIdfive = 'https://youtu.be/wipvkwFPL5g?t=';
