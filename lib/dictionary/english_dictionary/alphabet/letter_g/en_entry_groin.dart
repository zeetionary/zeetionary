...
class EnglishEntrygroin extends StatefulWidget {
  const EnglishEntrygroin({super.key});

  @override
  State<EnglishEntrygroin> createState() => _EnglishEntrygroinState();
}

class _EnglishEntrygroinState extends State<EnglishEntrygroin> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: groin (Derived forms: groins)
1. The crease at the junction of the inner part of the thigh with the trunk together with the adjacent region and often including the external genitals (- inguen)
 
2. A curved edge formed by two intersecting vaults
 
3. A protective structure of stone or concrete; extends from shore into the water to prevent a beach from washing away (- breakwater, groyne, mole, bulwark, seawall, jetty)

- Verb: groin (Derived forms: groined, groining, groins)
1. (construction) build with groins
"The ceiling was groined"
""",
  );

  final String keyword = "groin";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She kicked her attacker in the groin.""");
  }
...
کوردی: بنی ڕان، بێخی ڕان، تەڕاد، کورماتیخ، بەرموسڵدان، سەرووی ڕان، ناوگەڵ
"""),
// With short examples define "groin", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەو بەشەی لاقەکان کە دەگەن بە بەشی سەرەکی جەستە، لەگەڵ کۆئەندامی زاوزێ؛ کۆئەندامی زاوزێی پیاو"""),
                    SentencesRow(
                      englishText: """She kicked her attacker in the groin.""",
                      kurdishText:
                          """شەقێکی هەڵدا لە ناوگەڵی هێرشکارەکەی هەڵدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/FoBCuNmgJ6A?t=';
const double _startSecondsend = 000000000000000000000000000598;
const String _videoIdone = 'https://youtu.be/prDkd60WzmU?t=';
const double _startSecondsone = 00000000000000000000000000017;
const String _videoIdtwo = 'https://youtu.be/PMBYkQ58bMM?t=';
const double _startSecondstwo = 000000000000000000000000000274;
const String _videoIdthree = 'https://youtu.be/QEvSan6oTAc';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/H29Th36wzfs?t=';
const double _startSecondsfour = 00000000000000000000000000035;
const String _videoIdfive = 'https://youtu.be/jZZ1ky9_Q5A?t=';
