...
class EnglishEntryfood extends StatefulWidget {
  const EnglishEntryfood({super.key});

  @override
  State<EnglishEntryfood> createState() => _EnglishEntryfoodState();
}

class _EnglishEntryfoodState extends State<EnglishEntryfood> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: food (Derived forms: foods)
1. Any substance that can be metabolized by an animal to give energy and build tissue (= nutrient)
 
2. Any solid substance (as opposed to liquid) that is used as a source of nourishment (= solid food, grub [informal], khana [Asia], nosh [Brit, informal], kai [NZ, informal])
"food and drink"; "solid food and drink";
 
3. Anything that provides mental stimulus for thinking (= food for thought, intellectual nourishment)
""",
  );

  final String keyword = "food";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Pat had prepared food and drink for the party.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Demand for organic food has been growing fast.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""People worry about food safety.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The store specializes in frozen foods.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""You should eat more fresh foods.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Bears store food for the winter.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Does the food taste good?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """food""",
                      // alsoEnglishWord: "also: food",
                      britshText: """IpaUK: /fuːd/""",
                      americanText: """IpaUS: /fuːd/""",
...
// With short examples define "food", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Pat had prepared food and drink for the party.""",
                      kurdishText:
                          """پات خواردنی ئامادە کدربوو بۆ ئاهەنگەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خواست بۆ خواردنی ئەندامی بە خێرایی زیادی کردووە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خەڵکی نیگەرانن سەبارەت بە سەلامەتی خواردن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The store specializes in frozen foods.""",
                      kurdishText:
                          """کۆگاکە شارەزایی لە خواردنی بەستوو هەیە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """You should eat more fresh foods.""",
                      kurdishText: """دەبێت خواردنی تازەتر بخۆیت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Bears store food for the winter.""",
                      kurdishText: """ورچەکان خۆراک بۆ زستان پاشەکەوت دەکەن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Does the food taste good?""",
                      kurdishText: """خواردنەکە تامی باشە؟""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/kqww4wusbxc?t=';
const double _startSecondsend = 00000000000000000000000000011;
const String _videoIdone = 'https://youtu.be/3cxHwQl9pNM';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/vSDVFnwv0aI?t=';
const double _startSecondstwo = 00000000000000000000000000022;
const String _videoIdthree = 'https://youtu.be/V_pHHFVqMpQ?t=';
const double _startSecondsthree = 0000000000000000000000000004;
const String _videoIdfour = 'https://youtu.be/47ODQI0OSOA?t=';
const double _startSecondsfour = 000000000000000000000000000138;
const String _videoIdfive = 'https://youtu.be/h4CyhQqAPpk?t=';
