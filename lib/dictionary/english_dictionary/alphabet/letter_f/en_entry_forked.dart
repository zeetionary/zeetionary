...
class EnglishEntryforked extends StatefulWidget {
  const EnglishEntryforked({super.key});

  @override
  State<EnglishEntryforked> createState() => _EnglishEntryforkedState();
}

class _EnglishEntryforkedState extends State<EnglishEntryforked> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: forked
1. Resembling a fork; divided or separated into two branches (= bifurcate, biramous, branched, fork-like, forficate, pronged, prongy)
"a forked river"; "forked lightning";
 
2. Having two meanings with intent to deceive (= double)
"spoke with forked tongue";
""",
  );

  final String keyword = "forked";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The clothes line was held up by a forked stick.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forked""",
                      // alsoEnglishWord: "also: forked",
                      britshText: """IpaUK: /fɔːkt/""",
                      americanText: """IpaUS: /fɔːrkt/""",
...
کوردی: چنگاڵ‌ئاسا، چەتاڵ‌ئاسا،	دوولقانە، لقاوی، لک‌لک، چەڵەمەیی، لق‌لق، دووفلیقانە، دوولکانە، دوولکە، دوولپە، دووفاق، دووپەل، دووشاخە، داقڵیشاو، داتڵیشاو، لق‌لێوەبوو، پەل‌هاویشتوو
"""),
// With short examples define "forked", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The clothes line was held up by a forked stick.""",
                      kurdishText:
                          """تەنافی جلەکان بە چکڵێکی دووسەرە ڕاگیرابوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/y-2jd0Ds8Iw?t=';
const double _startSecondsend = 000000000000000000000000000460;
const String _videoIdone = 'https://youtu.be/wh3vW2V7ucU?t=';
const double _startSecondsone = 000000000000000000000000000840;
const String _videoIdtwo = 'https://youtu.be/w0QRliFvOC0?t=';
const double _startSecondstwo = 000000000000000000000000000310;
const String _videoIdthree = 'https://youtu.be/ZBDaeb-XcVc?t=';
const double _startSecondsthree = 000000000000000000000000000748;
const String _videoIdfour = 'https://youtu.be/V3H2uZUDHlg?t=';
const double _startSecondsfour = 000000000000000000000000000295;
const String _videoIdfive = 'https://youtu.be/EywZ5VGNZuQ?t=';
const double _startSecondsfive = 000000000000000000000000000603;
