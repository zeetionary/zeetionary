...
class EnglishEntryletter extends StatefulWidget {
  const EnglishEntryletter({super.key});

  @override
  State<EnglishEntryletter> createState() => _EnglishEntryletterState();
}

class _EnglishEntryletterState extends State<EnglishEntryletter> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: letter (Derived forms: letters)
1. A written message addressed to a person or organization (- missive)
"mailed an indignant letter to the editor";
 
2. A character of the alphabet used in writing (- letter of the alphabet, alphabetic character)
...
5. [N. Amer] An award earned by participation in a school sport (- varsity letter [N. Amer])
"he won letters in three sports";

- Verb: letter (Derived forms: letters, lettering, lettered)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I wrote a letter to the editor of our local paper.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You may need a letter from your doctor.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You will be notified by letter.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her letter was published in the local paper.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There's a letter here addressed to you.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Police received an anonymous letter about the case.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Keep a copy of the letter on file.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""‘B’ is the second letter of the alphabet.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How many letters are in the Greek alphabet?""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I'm thinking of a word that begins with the letter M.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Chai is the 18th letter of the Hebrew alphabet.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""All their names begin with the same letter.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The first letter of my name is K, not C.""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What do those letters after your name mean?""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/vzuo-C0hzpE?t=2039';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/l6vAubuhoYw?t=193';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/qL6Qgxz_oog?t=535';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/WrfxIymvEhQ?t=37';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/HsT3iI6dT5U?t=409';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/DSGYElDi38s?t=49';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """letter""",
                      // alsoEnglishWord: "also: letter",
                      britshText: """IpaUK: /ˈletə(r)/""",
                      americanText: """IpaUS: /ˈletər/""",
...
کوردی: نامە، کاغەز،	(ئەلفوبێ) پیت، تیپ،	بەڵگە، نووسراوە، نڤیسکی،	دەق،	گوتە، وتە، بێژە،	(چاپ) شێوازی فۆنت یان دەستەتیپ، وێژە، تۆرە
"""),
// With short examples define "letter", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) نامە"""),
                    SentencesRow(
                      englishText:
                          """I wrote a letter to the editor of our local paper.""",
                      kurdishText:
                          """نامەیەکم بۆ نووسەری ڕۆژنامە خۆجێیەکەمان نووسی.""",
                        ...
                        MyExpansionTile(
                          children: [
                            SentencesRow(
                              ...
                              kurdishText:
                                  """ڕەنگە پێویستیت بە نامەیەک بێت لە پزیشکەکەتەوە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText: """با نامە ئاگادار دەکرێیتەوە.""",
                            ...
                            SentencesRow(
                              englishText:
                                  """More than 100 scientists have signed a letter to the Prime Minister.""",
                              kurdishText:
                                  """زیاتر لە ١٠٠ زانا نامەیەکیان واژۆکردووە بۆ سەرۆک وەزیران.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """نامەکەی لە ڕۆژنامە ناوخۆییەکە بڵاوکرایەوە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """نامەیەک لێرەیە کە بۆ تۆ نووسراوە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """پۆلیس نامەیەکی نهێنی لەسەر کەیسەکە پێگەشت.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """کۆپییەکەی نامەکە لەسەر فایلێک هەڵبگرە.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) پیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """‘B’ is the second letter of the alphabet.""",
                      kurdishText: """‘B’ دووەم پیتی ئەلفوبێیە.""",
                        ...
                        MyExpansionTile(
                          children: [
                            SentencesRow(
                              ...
                              kurdishText:
                                  """چەند پیت لە ئەلفوبێی یۆنانیدا هەن؟""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """بیر لە وشەیەک دەکەمەوە کە بە M دەست پێدەکات.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """چای هەژدەیەمین پیتی ئەلفوبێی عیبرییە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """هەموو ناوەکانیان بە هەمان پیت دەست پێدەکەن.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText: """یەکەم پیتی ناوم K ــیە نەک C.""",
                            ...
                            SentencesRow(
                              englishText:
                                  """His name is written Louis, but you don't pronounce the last letter.""",
                              kurdishText:
                                  """ناوی بە Louis دەنووسرێت، بەڵام کۆتا پیت ناخوێنیتەوە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """ئەم پیتانەی دوای ناوت واتایان چییە؟""",
