...
class EnglishEntryentirely extends StatefulWidget {
  const EnglishEntryentirely({super.key});

  @override
  State<EnglishEntryentirely> createState() => _EnglishEntryentirelyState();
}

class _EnglishEntryentirelyState extends State<EnglishEntryentirely> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""entirely""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """entirely""",
                      // alsoEnglishWord: "also: entirely",
                      britshText: """IpaUK: /ɪnˈtaɪəli/""",
                      americanText: """IpaUS: /ɪnˈtaɪərli/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The experience was entirely new to me.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""That's an entirely different matter.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We're not entirely sure what to do next.""");
  }
...
کوردی: بە تەواوەتی، بەتەواوی، بەگشتی، هەموو
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵکار) بە تەواوی"""),
          SentencesRow(
            englishText: """The experience was entirely new to me.""",
            kurdishText: """ئەزموونەکە بە تەواوی تازە بوو لام.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """That's an entirely different matter.""",
            kurdishText: """بابەتێکی تەواو جیاوازە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """We're not entirely sure what to do next.""",
            kurdishText: """تەواو دڵنیا نیین دواتر چی بکەین.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I entirely agree with you.""",
            kurdishText: """بە تەواوی ڕازیم لەگەڵت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: entirely 
1. To a complete degree or to the full or entire extent; Completely or entirely (= wholly, completely, totally, all, altogether, whole, right, totes [informal])
"entirely satisfied with the meal";
 
2. Without any others being included or involved (= exclusively, solely, alone, only, purely)
"was entirely to blame"; "a school devoted entirely to the needs of problem children";
""",
  );
...
const double _startSecondsend = 684;
const String _videoIdone = 'https://youtu.be/-CJ4eUhE3Lw?t=';
const double _startSecondsone = 763;
const String _videoIdtwo = 'https://youtu.be/BZbChKzedEk?t=';
const double _startSecondstwo = 448;
const String _videoIdthree = 'https://youtu.be/CaaJyRvvaq8?t=';
const double _startSecondsthree = 512;
const String _videoIdfour = 'https://youtu.be/wir7jmefyec?t=';
const double _startSecondsfour = 103;
const String _videoIdfive = 'https://youtu.be/aBkciAEHslA?t=';
const double _startSecondsfive = 67;
const String _videoIdsix = 'https://youtu.be/C7zy1OQ-2f0?t=';
const double _startSecondssix = 23;
