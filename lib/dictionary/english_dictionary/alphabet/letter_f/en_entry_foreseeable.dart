...
class EnglishEntryforeseeable extends StatefulWidget {
  const EnglishEntryforeseeable({super.key});

  @override
  State<EnglishEntryforeseeable> createState() =>
      _EnglishEntryforeseeableState();
}

class _EnglishEntryforeseeableState extends State<EnglishEntryforeseeable> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "foreseeable";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foreseeable""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foreseeable""",
                      // alsoEnglishWord: "also: foreseeable",
                      britshText: """IpaUK: /fɔːˈsiːəbl/""",
                      americanText: """IpaUS: /fɔːrˈsiːəbl/""",
...
کوردی: لەپێشبینی‌هاتوو، شیاوی پێشبینی، پێشبینی دەکرێ
"""),
// With short examples define "foreseeable", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """There was no foreseeable possibility of such a plan being adopted.""",
                      kurdishText:
                          """هیچ ئەگەرێکی پێشبینی کراو نەبوو کە پلانێکی وەها پەسەند بکرێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """We have to take into account all foreseeable circumstances.""",
                      kurdishText:
                          """دەبێت هەموو هەلومەرجە پێشبینی کراوەکان لەبەرچاو بگرین.""",
...
const double _startSecondsend = 0000000000000000000000000001001;
const String _videoIdone = 'https://youtu.be/Y5F_ha7d-PI?t=';
const double _startSecondsone = 000000000000000000000000000241;
const String _videoIdtwo = 'https://youtu.be/KZbzIf_C6Y4?t=';
const double _startSecondstwo = 0000000000000000000000000002083;
const String _videoIdthree = 'https://youtu.be/FBhGvsnO_2E?t=';
const double _startSecondsthree = 0000000000000000000000000005;
const String _videoIdfour = 'https://youtu.be/RJQPthD9rx8?t=';
const double _startSecondsfour = 000000000000000000000000000236;
const String _videoIdfive = 'https://youtu.be/EDXN2kHTFAM?t=';
const double _startSecondsfive = 000000000000000000000000000408;
