...
// replace these: replace EnglishEntryacquit - replace speakAcquit - replace acquit - /əˈkwɪt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryacquit extends StatelessWidget {
  EnglishEntryacquit({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAcquit(String languageCode) async {
    // DOPSUM: CHANGE speakAcquit
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("acquit"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAc12569(String languageCode) async {
    // DOPSUM: CHANGE speakAcquit
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("She was acquitted on all charges."); // DOPSUM: CHANGE TEXT
  }
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 6, // 2 + VIDEOS FIND: YoutubeEmbeddedone
      child: Scaffold(
        appBar: AppBar(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈkwɪt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'wqgz7kRGVxg';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'OCXHvP78CS8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 's4XVmjfNno4';
