...
class EnglishEntryjustify extends StatefulWidget {
  const EnglishEntryjustify({super.key});

  @override
  State<EnglishEntryjustify> createState() => _EnglishEntryjustifyState();
}

class _EnglishEntryjustifyState extends State<EnglishEntryjustify> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: justify (Derived forms: justified, justifies, justifying)
1. Show to be right by providing justification or proof (- vindicate)
"justify a claim";
 
2. (used of God) declare innocent; absolve from the penalty of sin
 
3. (printing) adjust the spaces between words
"justify the margins"
""",
  );

  final String keyword = "justify";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""justify""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""How can they justify paying such huge salaries?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The senator made an attempt to justify his actions.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You don't need to justify yourself to me.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/dtp6b76pMak?t=1207';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/tsxmyL7TUJg?t=734';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/khOUvmOQExc?t=256';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/FUHkTs-Ipfg?t=450';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/lsbcN9-jU1Y?t=203';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/B35E8QleVhg?t=329';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """justify""",
                      // alsoEnglishWord: "also: justify",
                      britshText: """IpaUK: /ˈdʒʌstɪfaɪ/""",
                      americanText: """IpaUS: /ˈdʒʌstɪfaɪ/""",
...
// With short examples define "justify", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چۆن دەتوانن پاساو بۆ دانی ئەم مووچە زۆرە بهێننەوە؟""",
                    ...
                    SentencesRow(
                      englishText:
                          """Her success had justified the faith her teachers had put in her.""",
                      kurdishText:
                          """سەرکەوتنی ئەو باوەڕەی پشتڕاستکردەوە کە مامۆستاکانی هەیان بوو پێی.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) پێدانی ڕوونکردنەوە بۆ شتێک یان کردنی شتێک"""),
                    const AlsoEnglishckb(word: "ھەروەھا: defend"),
                    SentencesRow(
                      englishText:
                          """The senator made an attempt to justify his actions.""",
                      kurdishText:
                          """سیناتۆرەکە هەوڵی دا بەرگری لە کارەکانی بکات.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The Prime Minister has been asked to justify the decision to Parliament.""",
                      kurdishText:
                          """سەرۆک وەزیران داوای لێکراوە پاساو بۆ بڕیارەکە لە پەرلەمان بهێنێتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پێویست ناکات خۆت بۆ من بسەلمێنیت.""",
