...
class EnglishEntrygranddaughter extends StatefulWidget {
  const EnglishEntrygranddaughter({super.key});

  @override
  State<EnglishEntrygranddaughter> createState() =>
      _EnglishEntrygranddaughterState();
}

class _EnglishEntrygranddaughterState extends State<EnglishEntrygranddaughter> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: granddaughter (Derived forms: granddaughters)
1. A female grandchild
""",
  );

  final String keyword = "granddaughter";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""granddaughter""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She read a story to her granddaughter before bed.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She took her granddaughter to the park.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """granddaughter""",
                      // alsoEnglishWord: "also: granddaughter",
                      britshText: """IpaUK: /ˈɡrændɔːtə(r)/""",
                      americanText: """IpaUS: /ˈɡrændɔːtər/""",
...
کوردی: نەوە، کچی‌‌کچ، کچی‌کوڕ
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) کچێک کە منداڵی کوڕ یان کچەکەتە"""),
                    SentencesRow(
                      englishText:
                          """She read a story to her granddaughter before bed.""",
                      kurdishText:
                          """پێش نووستن چرۆکێکی بۆ کچەزاکەی خوێندەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She took her granddaughter to the park.""",
                      kurdishText: """کچەزاکەی برد بۆ پارک.""",
...
const double _startSecondsend = 00000000000000000000000000017;
const String _videoIdone = 'https://youtu.be/raSeaAeryWE?t=';
const double _startSecondsone = 0000000000000000000000000001178;
const String _videoIdtwo = 'https://youtu.be/nGrB-5ieeMU?t=';
const double _startSecondstwo = 000000000000000000000000000287;
const String _videoIdthree = 'https://youtu.be/BztMgcNgobk?t=';
const double _startSecondsthree = 000000000000000000000000000266;
const String _videoIdfour = 'https://youtu.be/LYUdnsIn5OU?t=';
const double _startSecondsfour = 0000000000000000000000000001018;
const String _videoIdfive = 'https://youtu.be/xjmXzYdxuTQ?t=';
