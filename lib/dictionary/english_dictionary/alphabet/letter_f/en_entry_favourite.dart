...
کوردی: جێی‌پەسند، جێی‌سەرنج، باش،	لەبەردڵان، چاک، تایبەتی، ویستراو، بەردڵ(کەوتوو)، بابەت، پەسند، سەرنج‌پێدراو، نزیک، خۆشەویست،	شت یان مرۆی لەبەردڵ(کەوتوو) یان پەسند، (شتی) هەڵبژاردە، شتی دڵخواز،	بەردەوک، گلێنەی چاو،	هیوای تیم، هیوای پێشبڕکێ
"""),
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) هەڵگرتنی ناونیشانێکی سەر ئینتەرنێت بۆ ئەوەی بە ئاسانی بیدۆزیتەوە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The ‘Favourites’ tab lets you access places you've favourited.""",
          ...
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٣. (ھاوەڵناو) کە زیاتر لە شتی دیکە حەزت لێی هەیە"""),
          const DividerSentences(),
          SentencesRow(
          ...
          const DefinitionKurdish(
              text:
                  """٤. (ناو) کەسێک/شتێک کە زیاتر لە هاوشێوەکانی حەزت لێیەتی"""),
          const DividerSentences(),
          SentencesRow(
          ...
          SentencesRow(
            ...
            kurdishText: """ئەم گۆرانییە هەڵبژاردەی تایبەتی منە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ئەم بسکیتانە هەڵبژاردەی باشی منداڵانن.""",
          ...
          SentencesRow(
            ...
            kurdishText: """دایبابان نابێت هەرگیز هەڵبژاردەیان هەبێت.""",
          ...
          const DefinitionKurdish(
              text:
                  """٧. (ناو) ئەسپیک، ڕاکەرێک، هتد کە چاوەڕوان دەکرێت بباتەوە"""),
          const DividerSentences(),
          SentencesRow(
...
const String _videoIdend = 'https://youtu.be/N7hlIbJkvUQ';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/_Z0ZQT0FttM?t=';
const double _startSecondsone = 000000000000000000000000000510;
const String _videoIdtwo = 'https://youtu.be/BNPPMs9CvDQ?t=';
const double _startSecondstwo = 000000000000000000000000000197;
const String _videoIdthree = 'https://youtu.be/d-S3oubvCu0?t=';
const double _startSecondsthree = 00000000000000000000000000012;
const String _videoIdfour = 'https://youtu.be/XYzdtsDLrCE';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/R_fZjGm2OrM?t=';
