...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 686;
    const String videoIdone = '_wNsZEqpKUA';
    const double startSecondsone = 1227;
    const String videoIdtwo = '7ME1lkuBnCk';
    const double startSecondstwo = 398;
    const String videoIdthree = 'kElsSj8hky4';
    const double startSecondsthree = 265;
    const String videoIdfour = 'hhvjKAQv2cs';
    const double startSecondsfour = 1232;
    const String videoIdfive = 'g5ymJNLURRI';
    const double startSecondsfive = 968;
