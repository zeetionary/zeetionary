...
class EnglishEntryequatorial extends StatefulWidget {
  const EnglishEntryequatorial({super.key});

  @override
  State<EnglishEntryequatorial> createState() => _EnglishEntryequatorialState();
}

class _EnglishEntryequatorialState extends State<EnglishEntryequatorial> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""equatorial""");
  }
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "equatorial";
...
کوردی: پشتێنەیی، نیوانی، سەربە یەکسانەهێڵ، یەکسانەهێڵی، گەرمێنی
"""),
          // const DefinitionKurdish(text: """١. (ناو) نزیک لە پشتێنەی زەوی یان """),
          CustomRichText(
            textBeforeLink: "١. (ھاوەڵناو) نزیک لە ",
...
- Noun: equatorial (Derived forms: equatorials)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/nNaA87PMIQE?t=';
const double _startSecondsend = 000000000000000000000000000000; // 120;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/p9e8qNNe3L0?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1626;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/4HF4Phgafdw?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 193;
const String _videoIdthree = 'VIDEOhttps://youtu.be/BNpk_OGEGlA?t=';
const double _startSecondsthree = 000000000000000000000000000; // 459;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/f66GfsKPTUg?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1154;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/xY5vxLsO_Dc?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 21;
