...
class EnglishEntrygeeky extends StatefulWidget {
  const EnglishEntrygeeky({super.key});

  @override
  State<EnglishEntrygeeky> createState() => _EnglishEntrygeekyState();
}

class _EnglishEntrygeekyState extends State<EnglishEntrygeeky> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There was a geeky-looking guy in glasses at the library.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She has a geeky obsession with Japanese video games.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """geeky""",
                      // alsoEnglishWord: "also: geeky",
                      britshText: """IpaUK: /ˈɡiːki/""",
                      americanText: """IpaUS: /ˈɡiːki/""",
...
// With short examples define "geeky", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """There was a geeky-looking guy in glasses at the library.""",
                      kurdishText:
                          """پیاوێکی شێوە شێوە زانستدۆستی چاویلکەدار لە کتێبخانەکە.""",
...
const String _videoIdend = 'https://youtu.be/kUE2fPLOUxo?t=';
const double _startSecondsend = 000000000000000000000000000640;
const String _videoIdone = 'https://youtu.be/_pc1kON-doU?t=';
const double _startSecondsone = 000000000000000000000000000140;
const String _videoIdtwo = 'https://youtu.be/n5CPMf5eC_s?t=';
const double _startSecondstwo = 000000000000000000000000000871;
const String _videoIdthree = 'https://youtu.be/mdeMkg_5m9w?t=';
const double _startSecondsthree = 00000000000000000000000000034;
const String _videoIdfour = 'https://youtu.be/4oTa1BabYpE?t=';
const double _startSecondsfour = 000000000000000000000000000832;
const String _videoIdfive = 'https://youtu.be/0MY8-uhamJ0?t=';
