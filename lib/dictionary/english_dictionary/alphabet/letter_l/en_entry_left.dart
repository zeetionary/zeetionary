...
class EnglishEntryleft extends StatefulWidget {
  const EnglishEntryleft({super.key});

  @override
  State<EnglishEntryleft> createState() => _EnglishEntryleftState();
}

class _EnglishEntryleftState extends State<EnglishEntryleft> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
Adjective: left (Derived forms: lefter, leftest)
1. Not used up (- leftover, left over, odd, remaining, unexpended)
...
3. Intended for the left hand (- left-hand)
"I rarely lose a left-hand glove";
 
4. Of or belonging to the political or intellectual left

- Noun: left (Derived forms: lefts)
1. Location near or direction toward the left side; i.e. the side to the north when a person or object faces east
"she stood on the left"
 
2. Those who support varying degrees of social, political or economic change designed to promote the public welfare (- left wing)
 
3. The hand that is on the left side of the body (- left hand)
"jab with your left";
 
4. The piece of ground in the outfield on the catcher's left (- left field, leftfield)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Fewer people write with their left hand than with their right.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The university is on the left bank of the river.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Take a left turn at the intersection.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He has no sight in his left eye.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Turn left at the intersection.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Look left and right before you cross the road.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Take the next road on the left.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""My dad's in the front row, on the extreme left of the picture.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""To the left of the library is the bank.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was sitting on my left.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Arabic script is read from right to left.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Take the first left.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Take a left onto Route 130.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The Left only has/have a small chance of winning power.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The proposed changes are popular with Italians, especially those on the left.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/AzzwhmTFf7U?t=2809';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/gngPQ771Ahk?t=1834';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/q8jLyotMMVE?t=624';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/Lhpu3GdlV3w?t=160';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/bxs77K1DkD0?t=137';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/m_lDeHxYwh0?t=969';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """left""",
                      // alsoEnglishWord: "also: left",
                      britshText: """IpaUK: /left/""",
                      americanText: """IpaUS: /left/""",
...
کوردی: 
"""),
// With short examples define "left", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) چەپ"""),
                    SentencesRow(
                      englishText: """Fewer people write with their left hand than with their right.""",
                      kurdishText: """کەسانی کەمتر بە دەستی چەپ دەنووسن وەک لە ڕاست.""",
                    ...
                    SentencesRow(
                      englishText: """The university is on the left bank of the river.""",
                      kurdishText: """زانکۆکە لەسەر قەراغی لای چەپی زانکۆکەیە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Take a left turn at the intersection.""",
                      kurdishText: """بۆ لای چەپ لابدەوە لە یەکتربڕەکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He has no sight in his left eye.""",
                      kurdishText: """هیچ بینایی نەماوە لە چاوی چەپیدا.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵکار) لە لای چەپ یان بەرەو لای چەپ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Turn left at the intersection.""",
                      kurdishText: """لە یەکتربڕەکە بۆ لای چەپ بچۆ.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Look left and right before you cross the road.""",
                      kurdishText: """سەیری لای چەپ و ڕاست بکە پێش ئەوەی لە ڕێگاکە بپەڕیتەوە.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) لای چەپ یان ئاراستەی چەپ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Take the next road on the left.""",
                      kurdishText: """بچۆ ڕێگای دواتر لە لای چەپەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """My dad's in the front row, on the extreme left of the picture.""",
                      kurdishText: """باوکم لە ڕیزی پێشەوەیە لە ئەوپەڕی لای چەپی وێنەکەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """To the left of the library is the bank.""",
                      kurdishText: """لەلای چەپی پەرتووکخانەکەوە بانکەکە هەیە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She was sitting on my left.""",
                      kurdishText: """لەسەر لای چەپم دانیشتبوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Arabic script is read from right to left.""",
                      kurdishText: """پیتی عەرەبی لە ڕاستەوە بۆ چەپ دەخوێندرێتەوە.""",
                      onPressedBritish: () => speaksentence11("en-GB"),
                      onPressedAmerican: () => speaksentence11("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ناو) یەکەم، دووەم، هتد، ڕێگا لای چەپەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Take the first left.""",
                      kurdishText: """لابدەوە بۆ یەکەم ڕێگای لای چەپ.""",
                      onPressedBritish: () => speaksentence12("en-GB"),
                      onPressedAmerican: () => speaksentence12("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (ناو) لادان بە لای چەپدا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Take a left onto Route 130.""",
                      kurdishText: """پێچێک بە لای چەپدا بکەوە بۆ ڕێگای ١٣٠.""",
                      onPressedBritish: () => speaksentence13("en-GB"),
                      onPressedAmerican: () => speaksentence13("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٦. (ناو) ئەو گرووپە سیاسییانەی کە پشتگیری سۆشیاڵیزم دەکەن؛ ئەو بەشەی پارتێکی سیاسی کە ئەندامەکانی کە زیاتر لایەنگیری گۆڕانی کۆمەڵایەتین"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The Left only has/have a small chance of winning power.""",
                      kurdishText: """چەپڕەوەکان تەنها شانسێکی کەمی بردنەوەی دەسەڵاتیان هەیە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The proposed changes are popular with Italians, especially those on the left.""",
                      kurdishText: """گۆڕانکارییە پێشنیارکراوەکان باون زیاتر لای ئیتاڵییەکان، زیاتر ئەوانەی کە چەپڕەون.""",
