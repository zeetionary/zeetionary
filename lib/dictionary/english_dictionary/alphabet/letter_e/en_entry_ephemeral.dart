...
class EnglishEntryephemeral extends StatefulWidget {
  const EnglishEntryephemeral({super.key});

  @override
  State<EnglishEntryephemeral> createState() => _EnglishEntryephemeralState();
}

class _EnglishEntryephemeralState extends State<EnglishEntryephemeral> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""ephemeral""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ephemeral""",
                      // alsoEnglishWord: "also: ephemeral",
                      britshText: """IpaUK: /ɪˈfemərəl/""",
                      americanText: """IpaUS: /ɪˈfemərəl/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "ephemeral";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Fame in the world of rock and pop is largely ephemeral.""");
  }
...
کوردی: ماوەکورت، کورت‌ماوە، سەردەمی، تیژپەڕ، ڕۆژەکی، زوولەنێوچوو، نابەردەوام، کورت‌خایەن
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) کە بۆ ماوەیەکی کەم بەردەوام دەبێت"""),
          SentencesRow(
            englishText:
                """Fame in the world of rock and pop is largely ephemeral.""",
            kurdishText: """ناوبانگ لە جیهانی ڕۆک و پۆپدا زیاتر کورتخایەنە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """ئەوە کاری ڕەخنەگرە ئاگای لە هەر فاشنێکی کورتخایەن بێت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: ephemeral 
1. Lasting a very short time (= passing, short-lived, transient, transitory, fugacious, here today and gone tomorrow [informal], here today gone tomorrow [informal])
"the ephemeral joys of childhood";

- Noun: ephemeral (Derived forms: ephemerals)
1. Anything short-lived, as an insect that lives only for a day in its winged form (= ephemeron)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/yGzJZhtQ9NE?t=';
const double _startSecondsend = 000000000000000000000000000000; // 87;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/Wd4-slNt51s?t=';
const double _startSecondsone = 00000000000000000000000000000; // 56;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/Z3_PwvvfxIU?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1094;
const String _videoIdthree = 'VIDEOhttps://youtu.be/i44KnocYsno?t=';
const double _startSecondsthree = 000000000000000000000000000; // 695;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/VeBX4WjhhXs?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1808;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/Ii5m8Ta1iBY?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 164;
