...
// replace these: replace EnglishEntryaggressiveness - replace speakAggressiveness - replace aggressiveness - /əˈɡresɪvnəs/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaggressiveness extends StatelessWidget {
  EnglishEntryaggressiveness({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAggressiveness(String languageCode) async {
    // DOPSUM: CHANGE speakAggressiveness
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("aggressiveness"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAggressiv3749(String languageCode) async {
    ...
    await flutterTts.speak(
        "Our addiction to oil feeds belligerence, aggressiveness, and war. Wherever oil is drilled, people are killed for profit."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAggressive4699(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "Her talent and aggressiveness make her a tennis star of the future."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "aggressiveness", // DOPSUM: CHANGE WORD ENTRY - Find /əˈɡresɪvnəs/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈɡresɪvnəs/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'mXqDdgiz_MM';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'BD44SVoCIFo';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'fYJvJ3FOL3o';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'V7kXMTflQKU';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'NRdcrrO35bU';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'nBYhHDpkUgM';
