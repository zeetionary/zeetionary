...
class EnglishEntrylinger extends StatefulWidget {
  const EnglishEntrylinger({super.key});

  @override
  State<EnglishEntrylinger> createState() => _EnglishEntrylingerState();
}

class _EnglishEntrylingerState extends State<EnglishEntrylinger> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: linger (Derived forms: lingering, lingers, lingered)
1. Remain present although waning or gradually dying
"Her perfume lingered on"
 
2. Spend time in one place doing little or wasting time (- loiter, lounge, footle [informal], lollygag [N. Amer, informal], loaf [informal], lallygag [N. Amer, informal], hang around, mess about, tarry, lurk, mill about, mill around, dilly-dally [informal], dillydally [informal], mooch [Brit, informal])
"The high school students like to linger in the Central Square";
 
3. Leave slowly and hesitantly (- tarry)
 
4. Take one's time; proceed slowly (- dawdle)
 
5. To hang about in a place beyond the proper or usual time (- hover)
"The shy student lingered in the corner";
""",
  );

  final String keyword = "linger";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The faint smell of her perfume lingered in the room.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The civil war lingered on well into the 1930s.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She lingered for a few minutes to talk to Nick.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His eyes lingered on the diamond ring on her finger.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He lingered on for several months after the heart attack.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/58XEfDtU0Z4?t=1370';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/oLj9qS9EgB8?t=702';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/KByREO4gB0M?t=42';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/yYydSJ-yJfA?t=229';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/tFSgH_cUm2E?t=910';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/Pck5JcnkYYs?t=1363';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """linger""",
                      // alsoEnglishWord: "also: linger",
                      britshText: """IpaUK: /ˈlɪŋɡə(r)/""",
                      americanText: """IpaUS: /ˈlɪŋɡər/""",
...
کوردی: 
"""),
// With short examples define "linger", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) بەردەوام بوون لەوەی بوونی هەبێت زیاتر لەوەی پێشبینی کراوە"""),
                    SentencesRow(
                      englishText: """The faint smell of her perfume lingered in the room.""",
                      kurdishText: """بۆنی کزی عەترەکەی لە ژوورەکەدا مابووەوە.""",
                    ...
                    SentencesRow(
                      englishText: """The civil war lingered on well into the 1930s.""",
                      kurdishText: """جەنگە ناوخۆییەکە تەواو چووە ناو ساڵانی ١٩٣٠ ـەکان.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) مانەوە لە شوێنێک بۆ ماوەیەکی زیاتر چونکە ناتەوێت بچیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She lingered for a few minutes to talk to Nick.""",
                      kurdishText: """بۆ چەند خولەکێک مایەوە بۆ قسەکردن لەگەڵ نیک.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) بیرکردنەوە یان سەیرکردنی شتێک زیاتر لە ماوەی ئاسایی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """His eyes lingered on the diamond ring on her finger.""",
                      kurdishText: """چاوەکانی لەسەر ئەڵقە ئەڵماسییەکەی پەنجەی بوون.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) مانەوە لە ژیاندا بەڵام بە لاوازی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He lingered on for several months after the heart attack.""",
                      kurdishText: """بۆ چەند مانگێک بە لاوازی مایەوە لە دوای جەڵدەی دڵەکە.""",
