...
class EnglishEntryexpertise extends StatefulWidget {
  const EnglishEntryexpertise({super.key});

  @override
  State<EnglishEntryexpertise> createState() => _EnglishEntryexpertiseState();
}

class _EnglishEntryexpertiseState extends State<EnglishEntryexpertise> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""expertise""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """expertise""",
                      // alsoEnglishWord: "also: expertise",
                      britshText: """IpaUK: /ˌekspɜːˈtiːz/""",
                      americanText: """IpaUS: /ˌekspɜːrˈtiːz/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "expertise";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We have the expertise to help you run your business.""");
  }
...
کوردی: پسپۆڕی، تایبەت‌کاری، تایبەت‌گەری، شارەزایی، کارزانی، لێزانی، سەرڕشتەدار، ئاگاداری یان شارەزایی بەربڵاو
"""),
          const DefinitionKurdish(
              text: """١. (ناو) زانیاری و شارەزایی پسپۆڕانە لە شتێک"""),
          SentencesRow(
            englishText:
                """We have the expertise to help you run your business.""",
            kurdishText:
                """پسپۆڕی ئەوەمان هەیە یارمەتیت بدەین بازرگانیی خۆت بەڕێوە ببەیت.""",
          ...
          SentencesRow(
            englishText:
                """It is difficult to find staff with the level of expertise required for this job.""",
            kurdishText:
                """سەختە ستاف بدۆزیتەوە بەو ئاستەی پسپۆڕی کە پێویستە بۆ ئەم کارە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: expertise (Derived forms: expertises)
1. Skilfulness by virtue of possessing special knowledge (= expertness)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/TfaMLqEh1qM?t=';
const double _startSecondsend = 000000000000000000000000000000; // 266;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/TJvHHgGerJg?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1087;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/Oz9zw7-_vhM?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 199;
const String _videoIdthree = 'VIDEOhttps://youtu.be/twAP3buj9Og?t=';
const double _startSecondsthree = 000000000000000000000000000; // 704;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/H1KP4ztKK0A?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 63;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/Hw1X5oFPgro?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1639;
