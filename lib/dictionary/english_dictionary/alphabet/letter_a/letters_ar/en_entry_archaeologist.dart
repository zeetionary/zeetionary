...
// replace EnglishEntryAdopsum - replace speakArchaeologist

// replace archaeologist - /ˌɑːkiˈɒlədʒɪst/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarchaeologist extends StatelessWidget {
  // blank divider
  EnglishEntryarchaeologist({super.key});
  // blank divider
  ...
  Future<void> speakarchaeologist(String languageCode) async {
    ...
    await flutterTts.speak("archaeologist");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "archaeologist"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌɑːkiˈɒlədʒɪst/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'DmKU44ZeuRQ';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'qFkl9KVs1kU';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'SyTkHbyRcko';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'jgoPSBARDG8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'EbHOi5po5QM';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'xDxxvNOaCfM';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'E-SH9XVU4s8';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'LK5cPn6eGbc';
