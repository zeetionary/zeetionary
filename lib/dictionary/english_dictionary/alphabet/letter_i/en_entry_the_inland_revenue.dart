...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'us7u9HDRT1k';
    const double startSecondsend = 3307;
    const String videoIdone = 'O1JuKasJ-vY';
    const double startSecondsone = 432;
    const String videoIdtwo = 'fcN0BXzK8bg';
    const double startSecondstwo = 2883;
    const String videoIdthree = 'PfYYraMgiBA';
    const double startSecondsthree = 371;
    const String videoIdfour = 'Pg13IKAAcNw';
    const double startSecondsfour = 304;
    const String videoIdfive = '1dUzb6RwOa8';
