...
class EnglishEntryever extends StatefulWidget {
  const EnglishEntryever({super.key});

  @override
  State<EnglishEntryever> createState() => _EnglishEntryeverState();
}

class _EnglishEntryeverState extends State<EnglishEntryever> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ever""",
                      // alsoEnglishWord: "also: ever",
                      britshText: """IpaUK: /ˈevə(r)/""",
                      americanText: """IpaUS: /ˈevər/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Nothing ever happens here.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Don't you ever get tired?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""If you're ever in Miami, come and see us.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She hardly ever goes out.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We've only ever talked on the phone.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I don't think I ever really thanked you properly.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He wondered whether it would ever actually happen.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We see them very seldom, if ever.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'll never ever do that again!""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'm never speaking to you ever again!""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was raining harder than ever.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Consumers today have more choices than ever before.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It's the worst film I've ever seen.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Paul, ever the optimist, agreed to try again.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He said he would love her for ever (and ever).""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Their debts grew ever larger.""");
  }
...
کوردی: هیچ‌کات، هیچ وەختێ، هەرگیز، قەت، حەیاکونها، تا ئێستا، تاکوو ئێستا،	هەمیشە، بە بەردەوامی،	ڕۆژێ، کاتێ، وەختێ، سەردەمانێ
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵکار) لە ڕستەی نەرێ یان پرسیاری، یان لەگەڵ if بەکاردێت بە 'واتای هەموو کاتێک'"""),
          SentencesRow(
            englishText: """Nothing ever happens here.""",
            kurdishText: """هیچ شتێک هەرگیز ڕوونادات.""",
          ...
          Column(
            children: [
              MyExpansionTile(
                children: [
                  SentencesRow(
                    englishText: """Don't you ever get tired?""",
                    kurdishText: """هەرگیز ماندوو دەبیت؟""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """ئەگەر هەرگیز هاتیتە میامی، وەرە سەردانمان بکە.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText: """بە ئەستەم هیچ کات دەچێتە دەرەوە.""",
                  ...
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """We've only ever talked on the phone.""",
                    kurdishText: """تا ئێستا تەنها بە تەلەفۆن قسەمان کردووە.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """پێم وانییە هەرگیز بە گونجاوی سوپاسم کردبووی.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """خەیاڵی ئەوەی دەکرد ئەوە هەرگیز بەڕاستی ڕوودەدات.""",
                  ...
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """We see them very seldom, if ever.""",
                    kurdishText:
                        """زۆر دەگمەن دەیان بینین، ئەگەر هەرگیزیش بێت.""",
                  ...
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """I'll never ever do that again!""",
                    kurdishText: """هەرگیزا و هەرگیز ئەوە دووبارە ناکەمەوە.""",
                  ...
                  const DividerSentences(),
                  SentencesRow(
                    englishText: """I'm never speaking to you ever again!""",
                    kurdishText: """هەرگیز قسەت لەگەڵ ناکەمەوە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ھاوەڵکار) بۆ جەختکردنەوە بەکاردێت کە شت بەراورد دەکەیت"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """It was raining harder than ever.""",
            kurdishText: """زیاتر باران دەباری وەک لە هەر کات.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """کڕیاران ئەم سەردەمە هەڵبژاردەی زیاتریان هەیە زیاد لە هەر سەردەمێکی دیکە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """It's the worst film I've ever seen.""",
            kurdishText: """ئەوە خراپترین فیلمە تا ئێستا دیومە.""",
            onPressedBritish: () => speaksentence13("en-GB"),
            onPressedAmerican: () => speaksentence13("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """٣. (ھاوەڵکار) هەمیشە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Paul, ever the optimist, agreed to try again.""",
            kurdishText: """پۆڵی هەمیشە گەشبین ڕازی بوو کە دووبارەی بکاتەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He said he would love her for ever (and ever).""",
            kurdishText: """گوتی بۆ هەمیشە خۆشی دەوێت.""",
          ...
          SentencesRow(
            ...
            kurdishText: """قەرزەکانیان هەمیشە زیاتر دەبوو.""",
          ...
          const DefinitionKurdish(
              text:
                  """٤. (ھاوەڵکار) لە دوای  when، why، هتد بەکاردێت بۆ گوتنی ئەوەی کە سەرسامیی یان شۆکیت"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Why ever did you agree?""",
            kurdishText: """بۆچی ئاخر ڕازی بوویت؟""",
...
const double _startSecondsend = 000000000000000000000000000000; // 904;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/rPe4yziWiOg?t=';
const double _startSecondsone = 00000000000000000000000000000; // 552;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/_Z0ZQT0FttM?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 3652;
const String _videoIdthree = 'VIDEOhttps://youtu.be/hS2x1zl4rn0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 191;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/r8E1Hq5tktg?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 176;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/r5cqa9V0mUo?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 998;
