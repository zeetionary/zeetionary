...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'HV2nMU1pC5Y';
    const double startSecondsone = 80;
    const String videoIdtwo = 'nVuGJ_fusaI';
    const double startSecondstwo = 12;
    const String videoIdthree = 'JVyDGd12p0k';
    const double startSecondsthree = 48;
    const String videoIdfour = 'eGygYgbULv4';
    const double startSecondsfour = 0;
    const String videoIdfive = 'JpefTKVO6q4';
