...
class EnglishEntryimprobability extends StatefulWidget {
  const EnglishEntryimprobability({super.key});

  @override
  State<EnglishEntryimprobability> createState() =>
      _EnglishEntryimprobabilityState();
}

class _EnglishEntryimprobabilityState extends State<EnglishEntryimprobability> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: improbability (Derived forms: improbabilities)
1. The quality of being improbable (- improbableness)
"the improbability of such rare coincidences"; "impossibility should never be confused with improbability";
""",
  );

  final String keyword = "improbability";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""improbability""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I had to laugh at the improbability of the situation.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/hi9Rf0oLdHk?t=';
    const double startSecondsend = 0000000000000000000000000001104;
    const String videoIdone = 'https://youtu.be/b0BC3F0kqtw?t=';
    const double startSecondsone = 0000000000000000000000000001321;
    const String videoIdtwo = 'https://youtu.be/34axirGsSSs?t=';
    const double startSecondstwo = 000000000000000000000000000647;
    const String videoIdthree = 'https://youtu.be/0tYm41hb48o?t=';
    const double startSecondsthree = 0000000000000000000000000003483;
    const String videoIdfour = 'https://youtu.be/pU9iJB0ATpk?t=';
    const double startSecondsfour = 000000000000000000000000000614;
    const String videoIdfive = 'https://youtu.be/qa2aLkXw3OA?t=';
    const double startSecondsfive = 000000000000000000000000000281;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """improbability""",
                      // alsoEnglishWord: "also: improbability",
                      britshText: """IpaUK: /ɪmˌprɒbəˈbɪləti/""",
                      americanText: """IpaUS: /ɪmˌprɑːbəˈbɪləti/""",
...
کوردی: ڕێ‌تێنەچوویی، لەوەنەچوویی، نەشیاوی، شتی نەشیاو، کاری ڕێ‌تێنەچوو
"""),
// With short examples define "improbability", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە ڕێی تێنەچێت ڕووبدات یان ڕاست بێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: unlikelihood"),
                    SentencesRow(
                      englishText:
                          """I had to laugh at the improbability of the situation.""",
                      kurdishText:
                          """دەبوو پێبکەنم بە چاوەڕواننەکراوی دۆخەکە.""",
