...
class EnglishEntryhire extends StatefulWidget {
  const EnglishEntryhire({super.key});

  @override
  State<EnglishEntryhire> createState() => _EnglishEntryhireState();
}

class _EnglishEntryhireState extends State<EnglishEntryhire> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: hire (Derived forms: hiring, hires, hired)
1. Start in a job or pay to do a particular piece of work (- engage, employ)
"They hired two new secretaries in the department";
 
2. Hold under a lease or rental agreement; of goods and services (- rent, charter, lease)
 
3. Engage for service under a term of contract (- lease, rent, charter, engage, take)
"Let's hire a car";

- Noun: hire (Derived forms: hires)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was hired three years ago.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He does the hiring and firing in our company.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We’re not hiring right now.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We only want to hire permanent staff.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Workers were hired by the day.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You will need to hire yourself a lawyer.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We hired a car from a local firm.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Bicycles can be hired from several local shops.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The price includes the hire of the hall.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There are boats for hire on the lake.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""New hires get raises after a set period of time.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000689;
    const String videoIdone = 'https://youtu.be/raSeaAeryWE?t=';
    const double startSecondsone = 0000000000000000000000000002791;
    const String videoIdtwo = 'https://youtu.be/f5NJQiY9AuY?t=';
    const double startSecondstwo = 000000000000000000000000000114;
    const String videoIdthree = 'https://youtu.be/E6LpBIwGyA4?t=';
    ...
    const String videoIdfive = 'https://youtu.be/LruThmuaxms?t=';
    const double startSecondsfive = 000000000000000000000000000303;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hire""",
                      // alsoEnglishWord: "also: hire",
                      britshText: """IpaUK: /ˈhaɪə(r)/""",
                      americanText: """IpaUS: /ˈhaɪər/""",
...
// With short examples define "hire", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """She was hired three years ago.""",
                      kurdishText: """سێ ساڵ پێش ئێستا وەرگیردرا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کاری وەرگرتن و دەکردن دەکات لە کۆمپانیاکەمان.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We’re not hiring right now.""",
                      kurdishText: """لە ئێستادا کەس وەرناگرین.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We only want to hire permanent staff.""",
                      kurdishText:
                          """تەنها دەمانەوێت ستافی هەمیشەیی وەربگرین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کرێکاران بۆ کاری ڕۆژانە بە کرێ دەگیران.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She was hired by the campaign as a foreign-policy adviser.""",
                      kurdishText:
                          """لەلایەن کەمپینەکەوە وەک ڕاوێژکاری سیاسەتی دەرەوە وەرگیردرا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """You will need to hire yourself a lawyer.""",
                      kurdishText: """دەبێت پارێزەرێک بۆ خۆت بگریت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئۆتۆمبێلێکمان لە کۆمپانیایەکی ناوخۆیی بە کرێ گرت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەکرێت پاسکیل بە کرێ بگیرێت لە ژمارەیەک فرۆشگای ناوخۆیی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """نرخەکە بەکرێگرتنی هۆڵەکە لەخۆ دەگرێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There are boats for hire on the lake.""",
                      kurdishText:
                          """لەسەر دەریاچەکە بەلەم هەن بۆ بەکرێ گرتن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تازە وەرگرتووان زیادکردنی پارەیان پێ دەدرێت دوای ماوەیەکی دیاریکراو.""",
