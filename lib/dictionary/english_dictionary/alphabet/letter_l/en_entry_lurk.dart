...
class EnglishEntrylurk extends StatefulWidget {
  const EnglishEntrylurk({super.key});

  @override
  State<EnglishEntrylurk> createState() => _EnglishEntrylurkState();
}

class _EnglishEntrylurkState extends State<EnglishEntrylurk> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylurk lurk
WORD_WEB lurk lurk lurk
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lurk";
...
کوردی: 
"""),
// With short examples define "lurk", please follow LX instructions
