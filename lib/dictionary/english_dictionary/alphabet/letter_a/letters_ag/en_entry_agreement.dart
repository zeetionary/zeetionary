                      ...
                      child: Column(
                        ...
                        children: [
                          const Text(
                            ...
                            '''
کوردی: ڕێک‌کەوتن، هاتنەڕێ، ڕالێ‌بوون، بەرایی(دان)، وتەوبڕە، پێک‌هاتن، تەبایی، سازان، گونجان، یەک‌بیری، قایل‌بوون، قەبووڵ‌کردن، پەسندکردن، بڕیار، بەڵێنی، گفت، پەیمان، ڕێک‌کەوتن‌نامە، (ڕێزمان) یەک‌گیری، یەک‌گرتنەوە یەکان‌گیری (هەبوونی هەمان ژمارە، دۆخ، چاوگ و کەس)
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "ڕێککەوتنێکیان هەبوو کە هەرگیز لە ماڵەوە باسی کار نەکەن",
                                    textAlign: TextAlign
