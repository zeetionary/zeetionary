...
class EnglishEntrygradual extends StatefulWidget {
  const EnglishEntrygradual({super.key});

  @override
  State<EnglishEntrygradual> createState() => _EnglishEntrygradualState();
}

class _EnglishEntrygradualState extends State<EnglishEntrygradual> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gradual""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Recovery from the disease is very gradual.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gradual""",
                      // alsoEnglishWord: "also: gradual",
                      britshText: """IpaUK: /ˈɡrædʒuəl/""",
                      americanText: """IpaUS: /ˈɡrædʒuəl/""",
...
// With short examples define "gradual", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە بە هێواشی و بە ماوەیەکی درێژ ڕوودەدات"""),
                    SentencesRow(
                      englishText:
                          """Recovery from the disease is very gradual.""",
                      kurdishText: """چاکبوونەوە لە نەخۆشییەکە زۆر هێواشە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """There has been a gradual improvement in our sales figures over the last two years.""",
                      kurdishText:
                          """لە ماوەی دوو ساڵی ڕابردوودا باشتربوونی هێواش ڕوویداوە ئامارەکانی فرۆشمان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """As you go further south, you will notice a gradual change of climate.""",
                      kurdishText:
                          """کە زیاتر بەرەو باشوور دەچیت، هەست بە گۆڕانێکی کەم دەکەیت لە ئاووهەوا.""",
...
const String _videoIdtwo = 'https://youtu.be/RXXMJAU6vY8?t=';
const double _startSecondstwo = 0000000000000000000000000001587;
const String _videoIdthree = 'https://youtu.be/n-DTjpde9-0?t=';
const double _startSecondsthree = 00000000000000000000000000074;
const String _videoIdfour = 'https://youtu.be/I-zeJRjP6xA?t=';
const double _startSecondsfour = 00000000000000000000000000091;
const String _videoIdfive = 'https://youtu.be/2-bQnjgUiUs?t=';
