...
class EnglishEntryavian extends StatelessWidget {
  ...
  Future<void> speakAvians7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvians77"); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "avian", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAvian(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˈeɪviən/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "kDrKsHPQFeQ";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "fcL47Kiyuj0";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "dDZJXiHmeZg";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "fFhyQ9dzv_o";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "STJoT_UjkPI";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "e_TjrqWTV5s";
