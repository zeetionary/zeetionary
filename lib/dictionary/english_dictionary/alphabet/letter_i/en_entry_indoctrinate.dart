...
class EnglishEntryindoctrinate extends StatefulWidget {
  const EnglishEntryindoctrinate({super.key});

  @override
  State<EnglishEntryindoctrinate> createState() =>
      _EnglishEntryindoctrinateState();
}

class _EnglishEntryindoctrinateState extends State<EnglishEntryindoctrinate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: indoctrinate (Derived forms: indoctrinated, indoctrinates, indoctrinating)
1. Teach doctrines to; teach uncritically
"The Moonies indoctrinate their disciples"
""",
  );

  final String keyword = "indoctrinate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indoctrinate""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/1Gh5pNg3NOw?t=';
    const double startSecondsend = 00000000000000000000000000080;
    const String videoIdone = 'https://youtu.be/6J5ZJJs7H8g?t=';
    const double startSecondsone = 000000000000000000000000000995;
    const String videoIdtwo = 'https://youtu.be/mzZTLT8WpcQ?t=';
    const double startSecondstwo = 000000000000000000000000000593;
    const String videoIdthree = 'https://youtu.be/dZ_IwkAE2ls?t=';
    const double startSecondsthree = 000000000000000000000000000564;
    const String videoIdfour = 'https://youtu.be/7nJgHBbEgsE?t=';
    const double startSecondsfour = 000000000000000000000000000568;
    const String videoIdfive = 'https://youtu.be/GDDxxUeA514?t=';
    const double startSecondsfive = 000000000000000000000000000516;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indoctrinate""",
                      // alsoEnglishWord: "also: indoctrinate",
                      britshText: """IpaUK: /ɪnˈdɒktrɪneɪt/""",
                      americanText: """IpaUS: /ɪnˈdɑːktrɪneɪt/""",
...
کوردی: 
"""),
// With short examples define "indoctrinate", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) زۆرکردن لە کەسێک کە باوەڕ بە ژمارەیەک بیر و باوەڕ بکات و بیر لە شتی دیکە نەکاتەوە"""),
                    SentencesRow(
                      englishText:
                          """They had been indoctrinated from an early age with their parents' beliefs.""",
                      kurdishText:
                          """لە تەمەنی سەرەتاییەوە مێشکیان شۆردرابوویەوە بە باوەڕەکانی دایبابیان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The regime sought to indoctrinate the people with a sense of their own superiority.""",
                      kurdishText:
                          """ڕژێمەکە هەوڵیدا مێشکی ئەو کەسانە بشواتەوە بە تێگەشتنی ئەوەی خۆیان لە ئاستێکی باڵان.""",
                      englishNote:
                          """This means that the government aimed to teach or instill in the people a belief that they were better than others. The word "indoctrinate" suggests a strong, often biased influence on their thoughts and beliefs, promoting a mindset of superiority.""",
