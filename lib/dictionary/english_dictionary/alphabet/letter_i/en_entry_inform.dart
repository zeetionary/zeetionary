...
class EnglishEntryinform extends StatefulWidget {
  const EnglishEntryinform({super.key});

  @override
  State<EnglishEntryinform> createState() => _EnglishEntryinformState();
}

class _EnglishEntryinformState extends State<EnglishEntryinform> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: inform (Derived forms: informs, informing, informed)
...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Have the police been informed?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Please inform us of any changes of address.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He went to inform them of his decision.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The leaflet informs customers about healthy eating.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Religion informs every aspect of their lives.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000519;
    const String videoIdone = 'https://youtu.be/QLq6GEiHqR8?t=';
    const double startSecondsone = 0000000000000000000000000001620;
    const String videoIdtwo = 'https://youtu.be/9TugA_z5vQE?t=';
    const double startSecondstwo = 000000000000000000000000000389;
    const String videoIdthree = 'https://youtu.be/raSeaAeryWE?t=';
    ...
    const String videoIdfive = 'https://youtu.be/LqU9CdPs6ek?t=';
    const double startSecondsfive = 000000000000000000000000000434;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inform""",
                      // alsoEnglishWord: "also: inform",
                      britshText: """IpaUK: /ɪnˈfɔːm/""",
                      americanText: """IpaUS: /ɪnˈfɔːrm/""",
...
کوردی: 
"""),
// With short examples define "inform", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) ئاگادارکردنەوەی کەسێک سەبارەت بە شتێک، بە تایبەتی بە شێوەیەک فەرمی"""),
                    SentencesRow(
                      englishText:
                          """The government took this decision without consulting Parliament or informing the public.""",
                      kurdishText:
                          """حکومەت ئەم بڕیارەی دا بەبێ ڕاوێژ بە پەرلەمان یان ئاگادارکردنەوەی خەڵکی.""",
                    ...
                    SentencesRow(
                      englishText: """Have the police been informed?""",
                      kurdishText: """پۆلیس ئاگادارکراون؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تکایە ئاگادارمان بکە لە هەر گۆڕانێکی ناونیشان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئاگاداری کردنەوە لە بڕیارەکەی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """نامیلکەکە زانیاری بە کڕیاران دەدات سەبارەت بە خواردنی تەندرووست.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I am pleased to inform you that you have won first prize in this month’s competition.""",
                      kurdishText:
                          """خۆشحاڵم کە پێت ڕابگەیەنم کە خەڵاتی یەکەمی پێشبڕکێی ئەم مانگەت بردووەتەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) دۆزینەوەی زانیاری سەبارەت بە شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """We need time to inform ourselves thoroughly of the problem.""",
                      kurdishText:
                          """کاتمان پێویستە بۆ تەواو تێگەیاندنی خۆمان لە کێشەکە.""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (کردار) هەبوونی کاریگەری لەسەر شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Religion informs every aspect of their lives.""",
                      kurdishText:
                          """ئایین کاریگەری هەیە لەسەر هەموو لایەنێکی ژیان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """These guidelines will be used to inform any future decisions.""",
                      kurdishText:
                          """ئەم ڕێنماییانە بەکاردێن بۆ دانانی بڕیارەکانی داهاتوو.""",
