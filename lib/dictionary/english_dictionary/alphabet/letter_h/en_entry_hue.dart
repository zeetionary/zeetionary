...
class EnglishEntryhue extends StatefulWidget {
  const EnglishEntryhue({super.key});

  @override
  State<EnglishEntryhue> createState() => _EnglishEntryhueState();
}

class _EnglishEntryhueState extends State<EnglishEntryhue> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hue (Derived forms: hues)
1. The quality of a colour as determined by its dominant wavelength (- chromaticity)

- Verb: hue (Derived forms: hues, hued, huing)
1. Take on colour or become coloured
"In highlights it hued to a dull silver-grey"
 
2. Suffuse with colour (- imbue)
""",
  );

  final String keyword = "hue";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His face took on an unhealthy whitish hue.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/JHHYXN52oUo?t=';
    const double startSecondsone = 000000000000000000000000000164;
    const String videoIdtwo = 'https://youtu.be/xKmZGQp6yng?t=';
    ...
    const String videoIdfour = 'https://youtu.be/j9h2-ZVDLB8?t=';
    const double startSecondsfour = 000000000000000000000000000262;
    const String videoIdfive = 'https://youtu.be/wh4aWZRtTwU?t=';
    const double startSecondsfive = 000000000000000000000000000253;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hue""",
                      // alsoEnglishWord: "also: hue",
                      britshText: """IpaUK: /hjuː/""",
                      americanText: """IpaUS: /hjuː/""",
...
// With short examples define "hue", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕووخساری شێوەیەکی ناتەندرووست لە سپییەتی وەرگرت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Her paintings capture the subtle hues of the countryside in autumn.""",
                      kurdishText:
                          """تابلۆکانی ڕەنگی شاراوەی دەشت‌ودەر لە پاییزدا دەردەخەن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Politicians of all hues wish to get controversy off the agenda so that they can discuss the real issues.""",
                      kurdishText:
                          """سیاسەتمەدارانی هەموو بیروڕاکان دەیانەوێت ناکۆکییەکان لە بەرنامەکە دەربکەن تاکو بتوانن باسی کێشە ڕاستەقینەکان بکەن..""",
