...
// Define the word "blotter" and provide five 10-words or less long example sentences for each meaning. Use  Oxford Advanced Learner's Dictionary style. Provide at least 5 meanings or more.

// replace blotter - /ˈblɒtə(r)/

enum TtsState { playing }

class EnglishEntryblotter extends StatelessWidget {
// blank divider
  EnglishEntryblotter({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakblotter(String languageCode) async {
    // DOPSUM: CHANGE speakblotter
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("blotter"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakblotters1(String languageCode) async {
    // DOPSUM: CHANGE speakblotter
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("She kept a fresh blotter on her desk."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakblotters2(String languageCode) async {
    // DOPSUM: CHANGE speakblotter
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "The police officer updated the blotter with new incidents."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakblotters3(String languageCode) async {
    // DOPSUM: CHANGE speakblotter
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakblotters33"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakblotters4(String languageCode) async {
    // DOPSUM: CHANGE speakblotter
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakblotters44"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakblotters5(String languageCode) async {
    // DOPSUM: CHANGE speakblotter
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakblotters55"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakblotters6(String languageCode) async {
    // DOPSUM: CHANGE speakblotter
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakblotters66"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakblotters7(String languageCode) async {
    // DOPSUM: CHANGE speakblotter
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakblotters77"); // DOPSUM: CHANGE TEXT
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "blotter"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈblɒtə(r)/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakblotter("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈblɑːtər/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakblotter("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  ...
  final String _videoId = '7MKeljf6LeE';
...
class _YoutubeEmbeddedtwoState extends State<YoutubeEmbeddedtwo> {
  late YoutubePlayerController _controller;
  final String _videoId = '5cGV1C5jwlM';
  final double _startSeconds = 2771;
...
class _YoutubeEmbeddedthreeState extends State<YoutubeEmbeddedthree> {
  late YoutubePlayerController _controller;
  final String _videoId = 'R6moRys9aZw';
...
class _YoutubeEmbeddedfourState extends State<YoutubeEmbeddedfour> {
  late YoutubePlayerController _controller;
  final String _videoId = 'LVKasemZyg0';
  final double _startSeconds = 2139;
...
class _YoutubeEmbeddedfiveState extends State<YoutubeEmbeddedfive> {
  late YoutubePlayerController _controller;
  final String _videoId = '8DuskrZhd6A';
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  late YoutubePlayerController _controller;
  final String _videoId = 'CMD2nNTtCYk';
...
class _YoutubeEmbeddedsevenState extends State<YoutubeEmbeddedseven> {
  late YoutubePlayerController _controller;
  final String _videoId = '7NF7o5vRGA0';
...
class _YoutubeEmbeddedeightState extends State<YoutubeEmbeddedeight> {
  late YoutubePlayerController _controller;
  final String _videoId = 'vpOybD-67GE';
...
class _YoutubeEmbeddednineState extends State<YoutubeEmbeddednine> {
  late YoutubePlayerController _controller;
  final String _videoId = 'g2sio7bqhfY';
...
class _YoutubeEmbeddedtenState extends State<YoutubeEmbeddedten> {
  late YoutubePlayerController _controller;
  final String _videoId = 'rNzipy5Wp7w';
...
class _YoutubeEmbeddedelevenState extends State<YoutubeEmbeddedeleven> {
  late YoutubePlayerController _controller;
  final String _videoId = 'NxGHGXwZvxQ';
...
class _YoutubeEmbeddedtwelveState extends State<YoutubeEmbeddedtwelve> {
  late YoutubePlayerController _controller;
  final String _videoId = 'jaf1Yoga2OY';
