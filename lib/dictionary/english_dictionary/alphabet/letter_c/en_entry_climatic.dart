...
class EnglishEntryclimatic extends StatelessWidget {
  // blank divider
  EnglishEntryclimatic({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakclimatic(String languageCode) async {
    // DOPSUM: CHANGE speakclimatic
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "climatic"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /klaɪˈmætɪk/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakclimatic("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /klaɪˈmætɪk/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakclimatic("en-US"),
                            ),
                          ],
                        ),
                      ],
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: climatic 
1. Of or relating to a climate (= climatical)
"climatic changes";
""",
  );
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/eXO1EXDnCpE?t=',
    startSeconds: 676,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/cIZ7625Ts6A?t=',
    startSeconds: 268,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/mMcnqpvd8Uo?t=',
    startSeconds: 167,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/kiAR4O7fl-E?t=',
    startSeconds: 868,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/G6A_7KS-eOY?t=',
    startSeconds: 685,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
