...
class EnglishEntryintransitive extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intransitive""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'MWJIScUJSAU';
    const double startSecondsend = 34;
    const String videoIdone = 'AGsLrtjfE_M';
    const double startSecondsone = 0;
    const String videoIdtwo = 'NI9mtgAlanc';
    const double startSecondstwo = 397;
    const String videoIdthree = '4oXwlvjld_o';
    const double startSecondsthree = 350;
    const String videoIdfour = 'mJYrc6oya7c';
    const double startSecondsfour = 495;
    const String videoIdfive = '745WT5bcFwA';
    const double startSecondsfive = 155;
