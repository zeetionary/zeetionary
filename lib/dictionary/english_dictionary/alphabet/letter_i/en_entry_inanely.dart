...
class EnglishEntryinanely extends StatefulWidget {
  const EnglishEntryinanely({super.key});

  @override
  State<EnglishEntryinanely> createState() => _EnglishEntryinanelyState();
}

class _EnglishEntryinanelyState extends State<EnglishEntryinanely> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inanely""");
  }
