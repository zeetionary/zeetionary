...
کوردی: مەست، لاکەوتە، کەیل، سەرخۆش،	بێ‌هێز، تێکچوو، پێچوو، کز، لاواز،	لەق، شل‌وشەوێق
"""),
// With short examples define "groggy", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """حەبە خەوێنەرەکان وایان لێکرد هەست بە بێ‌هێزی بکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هێشتا گێژە بە بەنجەکە.""",
...
const String _videoIdone = 'https://youtu.be/Is1IWMPNqh4?t=';
const double _startSecondsone = 0000000000000000000000000001523;
const String _videoIdtwo = 'https://youtu.be/oHLMla-75QA';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/3nPEkZv0-OU?t=';
const double _startSecondsthree = 000000000000000000000000000273;
const String _videoIdfour = 'https://youtu.be/BviMoX3EtWc?t=';
const double _startSecondsfour = 000000000000000000000000000224;
const String _videoIdfive = 'https://youtu.be/qQHbuZP5-dI?t=';
