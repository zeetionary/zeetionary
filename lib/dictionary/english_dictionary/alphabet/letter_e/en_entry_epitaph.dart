...
class EnglishEntryepitaph extends StatefulWidget {
  const EnglishEntryepitaph({super.key});

  @override
  State<EnglishEntryepitaph> createState() => _EnglishEntryepitaphState();
}

class _EnglishEntryepitaphState extends State<EnglishEntryepitaph> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""epitaph""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """epitaph""",
                      // alsoEnglishWord: "also: epitaph",
                      britshText: """IpaUK: /ˈepɪtɑːf/""",
                      americanText: """IpaUS: /ˈepɪtæf/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His epitaph read: ‘A just and noble countryman’.""");
  }
...
کوردی: بەردەنووسی گۆڕ، کێلی نووسراو
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ئەو وشانەی دەگوترێت یان دەنووسرێت لەسەر کەسێکی مردوو، بەتایبەتی لەسەر کێلی گۆڕ"""),
          SentencesRow(
            englishText: """His epitaph read: ‘A just and noble countryman’.""",
            kurdishText:
                """لەسەر نووسراوی کێلەکەی نووسرابوو 'هاونیشتیمانییەکی دادپەروەر و خانەدان'.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) شتێک کە جێدەهێڵرێت بۆ یادهێنانەوەی کەسێک، ماوەیەک، یان بۆنەیەک"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """These films stand as an epitaph to the great director.""",
            kurdishText:
                """ئەم فیلمانە وەک یادهێنانەوەیەکی دەرهێنەرە مەزنەکە دەمێننەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: epitaph (Derived forms: epitaphs)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/S7bSLlN_C1A?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1671;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/B5ytcg5pYEA?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1575;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/tYrdMjVXyNg?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1511;
const String _videoIdthree = 'VIDEOhttps://youtu.be/UeH426gwVRc?t=';
const double _startSecondsthree = 000000000000000000000000000; // 2203;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/60fWsMyZfX0?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 2134;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/ni9YJ_18dLY?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 184;
