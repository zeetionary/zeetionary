...
class EnglishEntrygushing extends StatefulWidget {
  const EnglishEntrygushing({super.key});

  @override
  State<EnglishEntrygushing> createState() => _EnglishEntrygushingState();
}

class _EnglishEntrygushingState extends State<EnglishEntrygushing> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: gushing
1. Flowing profusely (- pouring)
"a gushing hydrant";
 
2. Uttered with unrestrained enthusiasm (- burbling, burbly, effusive)
 
3. Extravagantly demonstrative (- effusive, gushy)
"a large gushing female";
""",
  );

  final String keyword = "gushing";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gushing""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She gave an embarrassingly gushing acceptance speech.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gushing""",
                      // alsoEnglishWord: "also: gushing",
                      britshText: """IpaUK: /ˈɡʌʃɪŋ/""",
                      americanText: """IpaUS: /ˈɡʌʃɪŋ/""",
