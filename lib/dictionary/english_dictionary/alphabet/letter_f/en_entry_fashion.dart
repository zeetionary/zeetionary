...
class EnglishEntryfashion extends StatefulWidget {
  const EnglishEntryfashion({super.key});

  @override
  State<EnglishEntryfashion> createState() => _EnglishEntryfashionState();
}

class _EnglishEntryfashionState extends State<EnglishEntryfashion> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fashion""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fashion""",
                      // alsoEnglishWord: "also: fashion",
                      britshText: """IpaUK: /ˈfæʃn/""",
                      americanText: """IpaUS: /ˈfæʃn/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Jeans are always in fashion.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Long skirts have come into fashion again.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Some styles never go out of fashion.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Black is always in fashion.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I need your expert fashion advice.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She always wore the latest fashions.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She had no fashion sense whatsoever.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They all want to work in fashion.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Her summer collection took the fashion world by storm.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Fashions in art and literature come and go.""");
  }
...
کوردی: شێوە، ڕێگا، تەرز، جۆر، شێواز،	باو، داب، سان، مۆد،	ڕوسم، دەستوور، شتی باو یان برەومەند
"""),
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Long skirts have come into fashion again.""",
            kurdishText: """تەنوورەی درێژ دووبارە بوونەتەوە فاشن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I need your expert fashion advice.""",
            kurdishText: """پێویستیم بە ڕاوێژی فاشنی شارەزایانەتە.""",
          ...
          SentencesRow(
            englishText:
                """This theory, though recent, is more than a passing fashion.""",
            kurdishText:
                """ئەم بیردۆزە، ئەگەرچی تازەیە، زیاترە لە فاشنێکی کاتی.""",
            onPressedBritish: () => speaksentence10("en-GB"),
            englishNote:
                "This theory, even though it is new, is important and lasting.",
          ...
          SentencesRow(
            englishText:
                """The fashion at the time was for teaching mainly the written language.""",
            kurdishText:
                """ڕێبازی ئەو کاتە زیاتر بۆ فێرکردنی زمانی نووسراو بوو بە سەرەکی.""",
...
3. The latest and most admired style in clothes and cosmetics and behaviour
