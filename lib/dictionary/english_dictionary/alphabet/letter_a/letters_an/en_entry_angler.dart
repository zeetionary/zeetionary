...
class EnglishEntryangler extends StatelessWidget {
  ...
  Future<void> speakangler402(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("The angler reeled in and went home.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "angler"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæŋɡlə(r)/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakangler("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæŋɡlər/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakangler("en-US"),
                            ),
                          ],
                        ),
                      ],
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakangler402("en-US"),
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'NzYX0iV4WI4';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'DZVqjvKIctc';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'T9_anclEpYQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'WGp-4-owh9A';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'YpSYz_2sJq4';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'F_dhdXAtsso';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'SbQZW36aJZQ';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'j42SUHXsVLU';
