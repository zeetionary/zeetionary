...
class EnglishEntryindisputably extends StatefulWidget {
  const EnglishEntryindisputably({super.key});

  @override
  State<EnglishEntryindisputably> createState() =>
      _EnglishEntryindisputablyState();
}

class _EnglishEntryindisputablyState extends State<EnglishEntryindisputably> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: indisputably
1. In a manner or to a degree that could not be doubted (- indubitably, beyond doubt, beyond a doubt, beyond a shadow of a doubt)
"it was immediately and indisputably apparent that I had interrupted a scene of lovers";
""",
  );

  final String keyword = "indisputably";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indisputably""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""This painting is indisputably one of his finest works.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/RhUMA3bCvAY?t=';
    const double startSecondsend = 00000000000000000000000000022;
    const String videoIdone = 'https://youtu.be/ybBxueA5OuA?t=';
    const double startSecondsone = 000000000000000000000000000797;
    const String videoIdtwo = 'https://youtu.be/HF9zRqlN4T0?t=';
    const double startSecondstwo = 000000000000000000000000000563;
    const String videoIdthree = 'https://youtu.be/A5P6vJs1jmY?t=';
    const double startSecondsthree = 0000000000000000000000000005821;
    const String videoIdfour = 'https://youtu.be/1X_KdkoGxSs?t=';
    const double startSecondsfour = 0000000000000000000000000004730;
    const String videoIdfive = 'https://youtu.be/lpFyAu38SbY?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indisputably""",
                      // alsoEnglishWord: "also: indisputably",
                      britshText: """IpaUK: /ˌɪndɪˈspjuːtəbli/""",
                      americanText: """IpaUS: /ˌɪndɪˈspjuːtəbli/""",
...
کوردی: 
"""),
// With short examples define "indisputably", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە ناکرێت لەگەڵی ناڕازی بیت یان حاشای لێی بکەیت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: undeniably"),
                    SentencesRow(
                      englishText:
                          """This painting is indisputably one of his finest works.""",
                      kurdishText:
                          """تابلۆکە حاشاهەڵنەگرانە یەکێکە لە باشترین کارەکانیەتی.""",
