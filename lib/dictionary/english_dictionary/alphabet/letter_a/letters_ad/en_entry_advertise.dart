...
// replace these: replace EnglishEntryadvertise - replace speakAdvertise - replace advertise - /ˈædvərtaɪz/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadvertise extends StatelessWidget {
  EnglishEntryadvertise({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdvertise(String languageCode) async {
    // DOPSUM: CHANGE speakAdvertise
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("advertise"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAdve2568(String languageCode) async {
    ...
    await flutterTts.speak(
        "If you want to attract customers you need to advertise."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAdve35984(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("She coughed to advertise her presence."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "advertise", // DOPSUM: CHANGE WORD ENTRY - Find /ˈædvətaɪz/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈædvətaɪz/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˈædvərtaɪz/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'oK4c3Yw0JJw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'b34mH9oHeJo';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'EvsKF8UaJeY';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'IYrgd4D7CeU';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'C2HJEMmQyIo';
