...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'oJyxh6Hnnmk';
    const double startSecondsend = 650;
    const String videoIdone = 'dNKQYjsxgPU';
    const double startSecondsone = 118;
    const String videoIdtwo = 'pNTwRSKVJLc';
    const double startSecondstwo = 96;
    const String videoIdthree = 'Sx3ORAO1Y6s';
    const double startSecondsthree = 18;
    const String videoIdfour = 'TPNmf6ZlfR4';
    const double startSecondsfour = 340;
    const String videoIdfive = 'L_Guz73e6fw';
    const double startSecondsfive = 1033;
