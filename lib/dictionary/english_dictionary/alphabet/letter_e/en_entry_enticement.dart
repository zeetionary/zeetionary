...
class EnglishEntryenticement extends StatefulWidget {
  const EnglishEntryenticement({super.key});

  @override
  State<EnglishEntryenticement> createState() => _EnglishEntryenticementState();
}

class _EnglishEntryenticementState extends State<EnglishEntryenticement> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enticement""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enticement""",
                      // alsoEnglishWord: "also: enticement",
                      britshText: """IpaUK: /ɪnˈtaɪsmənt/""",
                      americanText: """IpaUS: /ɪnˈtaɪsmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enticement";
...
// کوردی: تەفرەدان، فریودان، لەخشتەبردن، هەڵخەڵەتاندن، هەڵفریواندن، تاودان، ڕاکێشان،	شتی هەڵفریوێنەر، مایەی هەڵفریواندن یان تەفرەدان
// """),
          const DefinitionKurdish(
              text:
                  """١. (ناو) شتێک کە دەیدەیت بە کەسێک بۆ ئەوەی بچێتە شوێنێک یان شتێک بکات"""),
          SentencesRow(
            englishText:
                """One of the enticements of the job is the company car.""",
            kurdishText:
                """یەکێک لە دەم‌شیرینییەکانی کارەکە ئۆتۆمبێلی کۆمپانیا بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: enticement (Derived forms: enticements)
1. Something that seduces or has the quality to seduce (= temptation)
 
2. Qualities that attract by seeming to promise some kind of reward (= lure, come-on [informal])
 
3. The act of influencing by exciting hope or desire (= temptation)
...
const String _videoIdone = 'https://youtu.be/IOgq4Nk2H8w?t=';
const double _startSecondsone = 465;
const String _videoIdtwo = 'https://youtu.be/J44svaQc5WY?t=';
const double _startSecondstwo = 741;
const String _videoIdthree = 'https://youtu.be/5udtSQ-LtM0?t=';
const double _startSecondsthree = 688;
const String _videoIdfour = 'https://youtu.be/GIFV_Z7Y9_w?t=';
const double _startSecondsfour = 1503;
const String _videoIdfive = 'https://youtu.be/p0sNQdOW1CI?t=';
const double _startSecondsfive = 1099;
const String _videoIdsix = 'https://youtu.be/VpetB-aIrMk?t=';
const double _startSecondssix = 685;
