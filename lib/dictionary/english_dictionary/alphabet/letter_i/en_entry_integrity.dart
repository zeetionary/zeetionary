...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'Pl8AJAt3TDg';
    const double startSecondsone = 176;
    const String videoIdtwo = '0ST4_hmop9Y';
    const double startSecondstwo = 1796;
    const String videoIdthree = 'nGrB-5ieeMU';
    const double startSecondsthree = 299;
    const String videoIdfour = '1Gxrwh4zGPg';
    const double startSecondsfour = 1306;
    const String videoIdfive = 'Ihoys69G56U';
    const double startSecondsfive = 549;
