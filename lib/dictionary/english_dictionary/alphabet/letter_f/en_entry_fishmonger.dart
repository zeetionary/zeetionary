...
class EnglishEntryfishmonger extends StatefulWidget {
  const EnglishEntryfishmonger({super.key});

  @override
  State<EnglishEntryfishmonger> createState() => _EnglishEntryfishmongerState();
}

class _EnglishEntryfishmongerState extends State<EnglishEntryfishmonger> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fishmonger (Derived forms: fishmongers)
1. Someone who sells fish (= fishwife [archaic])
""",
  );

  final String keyword = "fishmonger";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fishmonger""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I'll stop at the fishmonger's on my way home from work.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fishmonger""",
                      // alsoEnglishWord: "also: fishmonger",
                      britshText: """IpaUK: /ˈfɪʃmʌŋɡə(r)/""",
                      americanText: """IpaUS: /ˈfɪʃmʌŋɡər/""",
...
// With short examples define "fishmonger", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """In many rural areas the fish available to the fishmongers is so great in quantity that they are refusing it.""",
                      kurdishText:
                          """لە زۆر ناوچەی گوندنشین ئەو ماسییەی بەردەستە بۆ ماسی‌گران هێندە زۆرە کە ڕەتیدەکەنەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە فرۆشگای ماسی‌فرۆشەکە لەسەر ڕێگام لە کارەوە بۆ ماڵ دەوەستم.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/cOEkzIcNFGY?t=';
const double _startSecondsend = 000000000000000000000000000532;
const String _videoIdone = 'https://youtu.be/KObL442PWhQ?t=';
const double _startSecondsone = 00000000000000000000000000076;
const String _videoIdtwo = 'https://youtu.be/HTHw53tZHUE?t=';
...
const String _videoIdfour = 'https://youtu.be/Yh3lKA1J_S4?t=';
const double _startSecondsfour = 000000000000000000000000000480;
const String _videoIdfive = 'https://youtu.be/DAwamRa8m9Y?t=';
