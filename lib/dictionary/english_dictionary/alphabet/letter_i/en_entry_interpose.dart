...
class EnglishEntryinterpose extends StatefulWidget {
  const EnglishEntryinterpose({super.key});

  @override
  State<EnglishEntryinterpose> createState() => _EnglishEntryinterposeState();
}

class _EnglishEntryinterposeState extends State<EnglishEntryinterpose> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""interpose""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '8YXg8oIVaaQ';
    const double startSecondsend = 105;
    const String videoIdone = '_rR3jBjmJhc';
    const double startSecondsone = 271;
    const String videoIdtwo = '4GjXq2Sr55Q';
    const double startSecondstwo = 510;
    const String videoIdthree = '8Yz1pqX_eC0';
    const double startSecondsthree = 601;
    const String videoIdfour = '41x0EjkxATU';
    const double startSecondsfour = 4432;
    const String videoIdfive = 'Jw3h3Vie73w';
    const double startSecondsfive = 2316;
