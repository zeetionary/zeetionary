...
class EnglishEntryfirebrigade extends StatefulWidget {
  const EnglishEntryfirebrigade({super.key});

  @override
  State<EnglishEntryfirebrigade> createState() => _EnglishEntryfirebrigadeState();
}

class _EnglishEntryfirebrigadeState extends State<EnglishEntryfirebrigade> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "fire brigade";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fire brigade""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The fire brigade were there in minutes.""");
  }
...
// With short examples define "fire brigade", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) دامەزراوەیەک لە خەڵکی کە ڕاهێنانیان پێکراوە لە کوژاندنەوەی ئاگر و ڕزگارکردنی خەڵکی لەناو ئاگر"""),
                    SentencesRow(
                      englishText:
                          """The fire brigade were there in minutes.""",
                      kurdishText: """ئاگر کوژێنەرەوە لە چەند خولەکێکدا لەوێ بوون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/EXida4dux_o?t=';
const double _startSecondsend = 000000000000000000000000000357;
const String _videoIdone = 'https://youtu.be/OZbeM3erXeQ?t=';
const double _startSecondsone = 000000000000000000000000000517;
const String _videoIdtwo = 'https://youtu.be/mKXGSwERTLY?t=';
const double _startSecondstwo = 0000000000000000000000000002320;
const String _videoIdthree = 'https://youtu.be/GK419Nlp8eU?t=';
const double _startSecondsthree = 000000000000000000000000000477;
const String _videoIdfour = 'https://youtu.be/r1ZPwQEPNpg?t=';
const double _startSecondsfour = 000000000000000000000000000558;
const String _videoIdfive = 'https://youtu.be/3HF8iR_GB8A?t=';
const double _startSecondsfive = 000000000000000000000000000334;
