...
class EnglishEntryentertainer extends StatefulWidget {
  const EnglishEntryentertainer({super.key});

  @override
  State<EnglishEntryentertainer> createState() =>
      _EnglishEntryentertainerState();
}

class _EnglishEntryentertainerState extends State<EnglishEntryentertainer> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""entertainer""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """entertainer""",
                      // alsoEnglishWord: "also: entertainer",
                      britshText: """IpaUK: /ˌentəˈteɪnə(r)/""",
                      americanText: """IpaUS: /ˌentərˈteɪnər/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "entertainer";
...
کوردی: هونەرمەندی نوکتەبێژ، بەزم‌گێڕ، گاڵتەچی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کەسێک کە کاری گۆرانی گوتن، سەماکردن، یان نمایشکردنە بۆ ئەوەی خەڵکی چێژ ببینن"""),
          SentencesRow(
            englishText:
                """Although her acting skills were limited, she was a great entertainer.""",
            kurdishText:
                """ئەگەرچی تواناکانی نمایشی سنووردار بوون، گاڵتەچییەکی باش بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: entertainer (Derived forms: entertainers)
...
const String _videoIdone = 'https://youtu.be/lz7UgBP-m7w?t=';
const double _startSecondsone = 869;
const String _videoIdtwo = 'https://youtu.be/srksXVEkfAs?t=';
const double _startSecondstwo = 319;
const String _videoIdthree = 'https://youtu.be/jJJ7YTt_C4M?t=';
...
const String _videoIdfive = 'https://youtu.be/bBLki3_bzTI?t=';
const double _startSecondsfive = 43;
const String _videoIdsix = 'https://youtu.be/dy2GCkJiR8E?t=';
const double _startSecondssix = 538;
