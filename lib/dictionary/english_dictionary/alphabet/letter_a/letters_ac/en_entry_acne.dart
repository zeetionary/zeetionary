...
class EnglishEntryacne extends StatefulWidget {
  const EnglishEntryacne({super.key});

  @override
  State<EnglishEntryacne> createState() => _EnglishEntryacneState();
}

class _EnglishEntryacneState extends State<EnglishEntryacne> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakacn1259(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Acne often clears up by itself.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acne""",
                      // alsoEnglishWord: "also: acne",
                      britshText: """IpaUK: /ˈækni/""",
                      americanText: """IpaUS: /ˈækni/""",
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'YMRRrvBlK8I';
