...
class EnglishEntryforcefully extends StatefulWidget {
  const EnglishEntryforcefully({super.key});

  @override
  State<EnglishEntryforcefully> createState() => _EnglishEntryforcefullyState();
}

class _EnglishEntryforcefullyState extends State<EnglishEntryforcefully> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "forcefully";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forcefully""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He argued his case forcefully.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They were forcefully removed from their land.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forcefully""",
                      // alsoEnglishWord: "also: forcefully",
                      britshText: """IpaUK: /ˈfɔːsfəli/""",
                      americanText: """IpaUS: /ˈfɔːrsfəli/""",
...
کوردی: بە هێزەوە،	توند، بە توندی
"""),
// With short examples define "forcefully", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە بەهێزی و ڕوونی کە کەسانی دیکە باوەڕ بکەن"""),
                    SentencesRow(
                      englishText: """He argued his case forcefully.""",
                      kurdishText: """بە توندی بەرگری لە کەیسەکەی کرد.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵکار) بە بەکارهێنانی هێز"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """They were forcefully removed from their land.""",
                      kurdishText: """بە هێز لە خاکەکەیان دەرکران.""",
...
const String _videoIdone = 'https://youtu.be/fGMCjELDyUY?t=';
const double _startSecondsone = 0000000000000000000000000002500;
const String _videoIdtwo = 'https://youtu.be/0Anx3VQ2dcc?t=';
const double _startSecondstwo = 0000000000000000000000000001651;
const String _videoIdthree = 'https://youtu.be/Z0qwi6UkKtQ?t=';
const double _startSecondsthree = 000000000000000000000000000305;
const String _videoIdfour = 'https://youtu.be/a9_JPgwW9nw?t=';
const double _startSecondsfour = 000000000000000000000000000421;
const String _videoIdfive = 'https://youtu.be/Ni8BsXyln_Q?t=';
const double _startSecondsfive = 000000000000000000000000000162;
