...
class EnglishEntryhold extends StatefulWidget {
  const EnglishEntryhold({super.key});

  @override
  State<EnglishEntryhold> createState() => _EnglishEntryholdState();
}

class _EnglishEntryholdState extends State<EnglishEntryhold> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: hold (Derived forms: holding, held, holds)
1. Cause to continue in a certain state, position, or activity (- keep, maintain)
"hold in place"; "She always held herself as a lady";
 
2. Have or keep in one's hands or grip (- take hold)
...
6. Maintain (a theory, thoughts, or feelings) (- harbor [N. Amer], harbour [Brit, Cdn], entertain, nurse, bear)
"hold a resentment";
 
7. To close within bounds, or otherwise limit or deprive of free movement (- restrain, confine, constrain)
...
11. Have within (- bear, carry, contain)
"The canteen holds fresh water";
 
12. Have room for (- accommodate, admit)
...
15. Be valid, applicable, or true (- prevail, obtain)
...
18. Be capable of holding or containing (- contain, take)
"The flask holds one gallon";
 
19. Arrange for and reserve (something for someone else) in advance (- reserve, book)
"please hold a table at Maxim's";
 
20. Protect against a challenge or attack (- defend, guard)
"Hold that position behind the trees!"; "Hold the bridge against the enemy's attacks";
 
21. Bind by an obligation; cause to be indebted (- oblige, bind, obligate)
...
24. Resist or confront with resistance (- defy, withstand, hold up)
"The bridge held"; "The politician held up public opinion";
 
25. Be pertinent, relevant or applicable (- apply, go for)
"This theory holds for all irrational numbers";
 
26. Stop dealing with
"hold all calls to the President's office while he is in a meeting"
 
27. Lessen the intensity of; temper; hold in restraint; hold or keep within limits (- control, hold in, contain, check, curb, moderate, mod [informal])
...
30. Cause to come to an abrupt stop (- halt, arrest)
"hold the engines";
...
32. Drink alcohol without showing ill effects (- carry)
"He can hold his liquor";
 
33. Aim, point, or direct
"Hold the fire extinguisher directly on the flames"
 
34. Judge or state to be (- declare, adjudge)
"judge held that the defendant was innocent";
 
35. Be in accord; be in agreement (- agree, concur, concord)
"I hold with those who say life is sacred";
 
36. Keep from exhaling or expelling
"hold your breath"

- Noun: hold (Derived forms: holds)
1. The act of grasping (- clasp, clench, clutch, clutches, grasp, grip)
"she kept a firm hold on the railing";
 
2. Understanding of the nature, meaning, quality or magnitude of something (- appreciation, grasp)
"he has a good hold of accounting practices";
 
3. Power by which something or someone is affected or dominated
"he has a hold over them"
 
4. Time during which some action is awaited (- delay, time lag, postponement, wait)
"he ordered a hold in the action";
 
5. A state of being confined (usually for a short time) (- detention, detainment, custody)
"the prisoner is on hold";
 
6. A cell in a jail or prison (- keep)
 
7. The appendage to an object that is designed to be held in order to use or move it (- handle, grip, handgrip)
 
8. The space in a ship or aircraft for storing cargo (- cargo area, cargo deck, cargo hold, storage area)
 
9. [archaic] A stronghold
""",
  );

  final String keyword = "hold";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was holding a large box.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They were holding hands.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I held the mouse by its tail.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The girl held her father's hand tightly.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was holding the baby in his arms.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Each woman held a bottle in her hand.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She groaned and held her head.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The prisoner held his head in his hands.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Hold your head up.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Hold this position for a count of 10.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""People held handkerchiefs over their mouths.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I had to hold my stomach in to zip up my jeans.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'll hold the door open for you.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I don't think that branch will hold your weight.""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This barrel holds 25 litres.""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The plane holds about 300 passengers.""");
  }
  ...
  Future<void> speaksentence18(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I don't know what the future holds.""");
  }
  ...
  Future<void> speaksentence19(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""This research holds the key to understanding life.""");
  }
  ...
  Future<void> speaksentence20(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Each month she holds a meeting with her entire staff.""");
  }
  ...
  Future<void> speaksentence22(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He has already held discussions with Irish shareholders.""");
  }
  ...
  Future<void> speaksentence23(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The next conference will be held in Ohio.""");
  }
  ...
  Future<void> speaksentence25(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Who holds the world record for the long jump?""");
  }
  ...
  Future<void> speaksentence26(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She held the title of world champion for three years.""");
  }
  ...
  Future<void> speaksentence27(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How long has he held office?""");
  }
  ...
  Future<void> speaksentence29(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Men still hold most positions of power in this country.""");
  }
  ...
  Future<void> speaksentence30(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The professor will hold a seat on the advisory board.""");
  }
  ...
  Future<void> speaksentence32(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was held prisoner for two years.""");
  }
  ...
  Future<void> speaksentence34(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was held captive in a castle.""");
  }
  ...
  Future<void> speaksentence35(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""There wasn't much in the museum to hold my attention.""");
  }
  ...
  Future<void> speaksentence36(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""These discussions held little interest for Lucy.""");
  }
  ...
  Future<void> speaksentence37(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Hold your speed at 70.""");
  }
  ...
  Future<void> speaksentence38(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Interest rates have been held at 8% for a year now.""");
  }
  ...
  Future<void> speaksentence39(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They are trying to hold public spending to £300 billion.""");
  }
  ...
  Future<void> speaksentence40(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The company's shares held at £3.47.""");
  }
  ...
  Future<void> speaksentence41(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""In trading today the dollar held steady against the yen.""");
  }
  ...
  Future<void> speaksentence43(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She asked me to hold the line.""");
  }
  ...
  Future<void> speaksentence44(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Employees hold 30% of the shares.""");
  }
  ...
  Future<void> speaksentence45(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Applicants must hold a full driving licence.""");
  }
  ...
  Future<void> speaksentence47(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The rebels held the radio station.""");
  }
  ...
  Future<void> speaksentence49(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They were afraid the dam wouldn't hold.""");
  }
  ...
  Future<void> speaksentence50(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How long will the fine weather hold?""");
  }
  ...
  Future<void> speaksentence52(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He holds strange views on education.""");
  }
  ...
  Future<void> speaksentence53(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He has very firmly held religious beliefs.""");
  }
  ...
  Future<void> speaksentence57(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His hold on her arm tightened.""");
  }
  ...
  Future<void> speaksentence59(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Make sure you've got a steady hold on the camera.""");
  }
  ...
  Future<void> speaksentence60(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He still had me in a tight hold.""");
  }
  ...
  Future<void> speaksentence62(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He struggled to get a hold of his anger.""");
  }
  ...
  Future<void> speaksentence63(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""What she knew about his past gave her a hold over him.""");
  }
  ...
  Future<void> speaksentence64(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This crisis had weakened his hold on power.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/HvNdJ2RCReg?t=';
    ...
    const String videoIdtwo = 'https://youtu.be/ozsgl_sLnHQ?t=';
    const double startSecondstwo = 0000000000000000000000000001992;
    const String videoIdthree = 'https://youtu.be/EdQxtsTwHHs';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/Pto9L7kjuSM?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hold""",
                      // alsoEnglishWord: "also: hold",
                      britshText: """IpaUK: /həʊld/""",
                      americanText: """IpaUS: /həʊld/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText: """She was holding a large box.""",
                      kurdishText: """سندووقێکی گەورەی بە دەستەوە بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەستی یەکدیان گرتبوو.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I held the mouse by its tail.""",
                      kurdishText: """مشکەکەم بە کلکی گرتبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کچەکە بە توندی دەستی باوکیی گرتبوو.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He was holding the baby in his arms.""",
                      kurdishText: """ساواکەی لە دەستەکانیدا گرتبوو.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Each woman held a bottle in her hand.""",
                      kurdishText: """هەر ژنێک بوتڵێکی گرتبوو لە دەستیدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زیندانییەکە سەری خستبووە ناو دەستەکانی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Hold this position for a count of 10.""",
                      kurdishText: """بەم شێوەیە بمێنەوە تاوەکو خوێندنی ١٠.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خەڵکی دەستەسڕیان لەسەر دەمیان ڕاگرتبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پێویست بوو سکم ببەمە ناو بۆ ئەوەی زنجیری کابۆیەکەم بدەم.""",
                      onPressedBritish: () => speaksentence12("en-GB"),
                      onPressedAmerican: () => speaksentence12("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I'll hold the door open for you.""",
                      kurdishText: """دەرگاکە بە کراوەیی دەگرم بۆی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پێموانییە ئەو لقە بەرگەی کێشت بگرێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Several pieces of wood joined together can hold more weight than just one piece.""",
                      kurdishText:
                          """ژمارەیەک پارچە تەختە کە پێکەوە لکێنرابن دەتوانن بەرگەی کێشی زیاتر بگرن وەک لە تەنها یەک پارچە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The plane holds about 300 passengers.""",
                      kurdishText: """فڕۆکەکە نزیکەی ٣٠٠ گەشتیار دەگرێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەم توێژینەوەیە کلیلی تێگەشتن لە ژیان دەبێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەموو مانگێک کۆبوونەوەیەکی دەبێت لەگەڵ تەواوی ستافەکەی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The British Foreign Minister held talks with the leaders of the two countries.""",
                      kurdishText:
                          """سەرۆک وەزیرانی بەریتانیا گفتووگۆی ڕێکخست لەگەڵ سەرکردەکانی هەردوو وڵات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پێشوەختە گفتووگۆی کردووە لەگەڵ خاوەن پشکە ئێرلەندییەکان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کۆنفرانسی دواتر لە ئۆهایۆ دەبێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The country is holding its first free elections for 20 years.""",
                      kurdishText:
                          """وڵاتەکە یەکەم هەڵبژاردنی ئازادیی دەبێت لە ماوەی ٢٠ ساڵدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کێ ڕیکۆردی جیهانی هەیە بۆ بازی بەرز؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەڵگری نازناوی پاڵەوانی جیهانی بوو بۆ سێ ساڵ.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Mrs Thatcher held the post of prime minister longer than anyone else last century.""",
                      kurdishText:
                          """خاتوو تاچەر هەڵگری پێگەی سەرۆک وەزیران بوو زیاتر لەهەر کەسی دیکە لە سەدەی ڕابردوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پیاوان هێشتا زۆرترین پێگەی دەسەڵاتیان هەیە لەم وڵاتە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پڕۆفیسۆرەکە پێگەیەکی دەبێت لە دەستەی ڕاوێژکاری.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Police are holding two men in connection with last Thursday's bank raid.""",
                      kurdishText:
                          """پۆلیس دوو پیاویان ڕاگرتووە پەیوەندیدار بە هێرشە بانکییەکەی پێنجشەممەی ڕابردوو.""",
                      onPressedBritish: () => speaksentence31("en-GB"),
                      onPressedAmerican: () => speaksentence31("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He was held prisoner for two years.""",
                      kurdishText: """بۆ دوو ساڵ زیندانی بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """وەک یەخسیر هێڵدرایەوە لە قەڵایەک.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆر شت لە مۆزەخانەکە نەبوو کە سەرنجم ڕابکێشێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەم باسانە کەم حەزی لووسییان ڕاگرت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بۆ ساڵێک دەبێت ئێستا ڕێژەی سوو لە ٨٪ هێڵدراوەتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەوڵ دەدەن خەرجی گشتی لە ٣٠٠ ملیار پاوەند ڕابگرن.""",
                      onPressedBritish: () => speaksentence39("en-GB"),
                      onPressedAmerican: () => speaksentence39("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The company's shares held at £3.47.""",
                      kurdishText:
                          """پشکەکانی کۆمپانیاکە لە ٣,٤٧ پاوەند وەستاون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە ئاڵووگۆڕی ئەمڕۆدا دۆلار بە جێگیری بەرانبەر یەن وەستابوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Employees do not have access to personal records held on computer.""",
                      kurdishText:
                          """کارمەندان دەستیان ناگات بە زانیاری کەسی کە لەسەر کۆمپیوتەر هێڵدراوەتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """داخوازان دەبێت مۆڵەتی شۆفێریی تەواویان هەبێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He was born in South Africa but he holds a British passport.""",
                      kurdishText:
                          """لە ئەفریقای باشوور بووە، بەڵام پاسپۆرتی بەریتانی هەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەبوونی کۆنترۆڵی شتێک و پاراستنی لە هێرش.""",
                    ...
                    SentencesRow(
                      englishText: """The rebels held the radio station.""",
                      kurdishText:
                          """یاخیبووەکان وێستگەی ڕادیۆکەیان بەدەستەوە بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەترسان بەنداوەکە بەرگە نەگرێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """If their luck holds, they could still win the championship.""",
                      kurdishText:
                          """ئەگەر بەخت یاوەریان بێت، هێشتا دەکرێت پاڵەوانێتییەکە ببەنەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """باوەڕی زۆر بەهێزی ئایینی هەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I still hold that the government's economic policies are mistaken.""",
                      kurdishText:
                          """هێشتا باوەڕم وایە کە سیاسەتە ئابوورییەکانی حکومەت هەڵەن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Parents will be held responsible for their children's behaviour.""",
                      kurdishText:
                          """دایبابان بە بەرپرس دادەنرێن بۆ ڕەفتاری منداڵان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """These vases are held to be the finest examples of Greek art.""",
                      kurdishText:
                          """ئەم گۆزانە باوەڕ وایە باشترینی هونەری یۆنانی بن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He lost his hold on the rock and was swept away by the tide.""",
                      kurdishText:
                          """دەستی بەربوو لە بەردەکە و شەپۆلەکە بردی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دڵنیابەرەوە بە جێگیری کامێراکەت گرتووە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەقەڵای بوو دەست بگرێت بەسەر تووڕەییەکەیدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەوەی دەیزانی لەسەر ڕابردووی ئەو کۆنترۆڵی بەسەریدا دەدا پێی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """قەیرانەکە کۆنترۆڵیی بەسەر دەسەڵاتدا لاواز کرد.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She put her foot firmly in the hold and pulled herself up.""",
                      kurdishText:
                          """توند پێی خستەسەر گیرەکە و خۆی بەرزکردەوە.""",
