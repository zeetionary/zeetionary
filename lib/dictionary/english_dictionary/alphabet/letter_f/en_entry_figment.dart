...
class EnglishEntryfigment extends StatefulWidget {
  const EnglishEntryfigment({super.key});

  @override
  State<EnglishEntryfigment> createState() => _EnglishEntryfigmentState();
}

class _EnglishEntryfigmentState extends State<EnglishEntryfigment> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""figment""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Maybe all happiness is a figment too.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """figment""",
                      // alsoEnglishWord: "also: figment",
                      britshText: """IpaUK: /ˈfɪɡmənt/""",
                      americanText: """IpaUS: /ˈfɪɡmənt/""",
...
const String _videoIdone = 'https://youtu.be/-6vzjjIrRK8?t=';
...
const double _startSecondsthree = 0000000000000000000000000001291;
const String _videoIdfour = 'https://youtu.be/ZGGz4iJp9P0?t=';
const double _startSecondsfour = 00000000000000000000000000079;
const String _videoIdfive = 'https://youtu.be/5B4S3zvSkg8?t=';
const double _startSecondsfive = 000000000000000000000000000253;
