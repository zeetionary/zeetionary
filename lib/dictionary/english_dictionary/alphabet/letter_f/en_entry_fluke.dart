...
class EnglishEntryfluke extends StatefulWidget {
  const EnglishEntryfluke({super.key});

  @override
  State<EnglishEntryfluke> createState() => _EnglishEntryflukeState();
}

class _EnglishEntryflukeState extends State<EnglishEntryfluke> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fluke (Derived forms: flukes)
1. A stroke of luck (= good luck, good fortune)
 
2. A barb on a harpoon or arrow
 
3. Flat bladelike projection on the arm of an anchor (= flue)
 
4. Either of the two lobes of the tail of a cetacean
 
5. Parasitic flatworms having external suckers for attaching to a host (= trematode, trematode worm)

- Verb: fluke (Derived forms: fluked, flukes, fluking)
1. Achieve by good luck
""",
  );

  final String keyword = "fluke";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fluke""",
                      // alsoEnglishWord: "also: fluke",
                      britshText: """IpaUK: /fluːk/""",
                      americanText: """IpaUS: /fluːk/""",
...
// With short examples define "fluke", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """They are determined to show that their last win was no fluke.""",
                      kurdishText:
                          """سوورن لەسەر ئەوەی بیسەلمێنن بردنەوەی کۆتاییان تەنها بەختێک نەبوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It was a sheer fluke that I happened to pick the winning number.""",
                      kurdishText:
                          """ئەوە تەنها بەخت بوو کە کە ژمارەی بردنەوەم هەڵبژارد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/QiKZYt9070U?t=';
const double _startSecondsend = 000000000000000000000000000613;
const String _videoIdone = 'https://youtu.be/_h95pZQiKwI?t=';
const double _startSecondsone = 0000000000000000000000000001189;
const String _videoIdtwo = 'https://youtu.be/DRZ3tWu-DzY?t=';
const double _startSecondstwo = 000000000000000000000000000238;
const String _videoIdthree = 'https://youtu.be/VspjfNMPHyc?t=';
const double _startSecondsthree = 000000000000000000000000000860;
const String _videoIdfour = 'https://youtu.be/xSgF24j_LfA?t=';
const double _startSecondsfour = 000000000000000000000000000424;
const String _videoIdfive = 'https://youtu.be/e2Dx4-NQNeE?t=';
