...
class EnglishEntryluxuriant extends StatefulWidget {
  const EnglishEntryluxuriant({super.key});

  @override
  State<EnglishEntryluxuriant> createState() => _EnglishEntryluxuriantState();
}

class _EnglishEntryluxuriantState extends State<EnglishEntryluxuriant> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryluxuriant luxuriant
WORD_WEB luxuriant luxuriant luxuriant
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "luxuriant";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""luxuriant""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """luxuriant""",
                      // alsoEnglishWord: "also: luxuriant",
...
کوردی: 
"""),
// With short examples define "luxuriant", please follow LX instructions
