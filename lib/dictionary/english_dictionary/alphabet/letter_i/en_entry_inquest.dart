...
class EnglishEntryinquest extends StatefulWidget {
  const EnglishEntryinquest({super.key});

  @override
  State<EnglishEntryinquest> createState() => _EnglishEntryinquestState();
}

class _EnglishEntryinquestState extends State<EnglishEntryinquest> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inquest""");
  }
