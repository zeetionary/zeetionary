...
class EnglishEntryacceptable extends StatefulWidget {
  const EnglishEntryacceptable({super.key});

  @override
  State<EnglishEntryacceptable> createState() => _EnglishEntryacceptableState();
}

class _EnglishEntryacceptableState extends State<EnglishEntryacceptable> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "acceptable";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acceptable""",
                      // alsoEnglishWord: "also: acceptable",
                      britshText: """IpaUK: /əkˈseptəbl/""",
                      americanText: """IpaUS: /əkˈseptəbl/""",
