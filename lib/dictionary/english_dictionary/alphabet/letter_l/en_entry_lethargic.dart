...
class EnglishEntrylethargic extends StatefulWidget {
  const EnglishEntrylethargic({super.key});

  @override
  State<EnglishEntrylethargic> createState() => _EnglishEntrylethargicState();
}

class _EnglishEntrylethargicState extends State<EnglishEntrylethargic> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lethargic""");
  }
