...
class EnglishEntrygraphics extends StatefulWidget {
  const EnglishEntrygraphics({super.key});

  @override
  State<EnglishEntrygraphics> createState() => _EnglishEntrygraphicsState();
}

class _EnglishEntrygraphicsState extends State<EnglishEntrygraphics> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: graphics
1. Photographs or other visual representations in a printed publication (- artwork, art, nontextual matter)
"the publisher was responsible for all the graphics in the book";
 
2. The drawings and photographs in the layout of a book
 
3. (computing) images displayed by a computer; a graphical representation of data; the process by which a computer displays data
""",
  );

  final String keyword = "graphics";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""graphics""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The screen can display simple graphics as well as text.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """graphics""",
                      // alsoEnglishWord: "also: graphics",
                      britshText: """IpaUK: /ˈɡræfɪks/""",
                      americanText: """IpaUS: /ˈɡræfɪks/""",
...
کوردی: 
"""),
// With short examples define "graphics", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دیزاین، وێنە، و وێنەکێشان، بە تایبەتی لە بەرهەمهێنانی کتێب، گۆڤار، وێبسایت، هتد"""),
                    SentencesRow(
                      englishText:
                          """Text and graphics are prepared separately and then combined.""",
                      kurdishText:
                          """نووسین و کارە گرافیکیەەکان بە جودایی ئامادە دەکرێن و دواتر کۆدەکرێنەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شاشەکە دەتوانێت گرافیکی سادە و نووسین پیشان بدات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) کەری بەرهەمهێنانی دیزاین، وێنە، و وێنەکێشان، بە تایبەتی لە بەرهەمهێنانی کتێب، گۆڤار، وێبسایت، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The storyline of the game was great but the graphics were very disappointing.""",
                      kurdishText:
                          """چیرۆکی یارییەکە زۆر باش بوو، بەڵام کارە گرافیکییەکانی زۆر نائومێدکەر بوون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/3oYG157BIK0?t=';
const double _startSecondsend = 00000000000000000000000000067;
const String _videoIdone = 'https://youtu.be/TRZqE6H-dww';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/18W_LBNg2_8?t=';
const double _startSecondstwo = 00000000000000000000000000056;
const String _videoIdthree = 'https://youtu.be/oKpv7hRmlRM?t=';
const double _startSecondsthree = 00000000000000000000000000018;
const String _videoIdfour = 'https://youtu.be/C8YtdC8mxTU?t=';
const double _startSecondsfour = 00000000000000000000000000042;
const String _videoIdfive = 'https://youtu.be/mAoZme5rOfM?t=';
