...
class EnglishEntrygrassroots extends StatefulWidget {
  const EnglishEntrygrassroots({super.key});

  @override
  State<EnglishEntrygrassroots> createState() => _EnglishEntrygrassrootsState();
}

class _EnglishEntrygrassrootsState extends State<EnglishEntrygrassroots> {
  @override
  void initState() {
    super.initState();
...
"the problem was attacked at the grassroots"
 
2. The common people at a local level (as distinguished from the centres of political activity)
""",
  );

  final String keyword = "grassroots";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grassroots""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We need support at grassroots level.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grassroots""",
                      // alsoEnglishWord: "also: grassroots",
                      britshText: """IpaUK: /ˌɡrɑːsˈruːts/""",
                      americanText: """IpaUS: /ˌɡræsˈruːts/""",
...
// With short examples define "grassroots", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """We need support at grassroots level.""",
                      kurdishText:
                          """پێویستیمان بە پشتگیرییە لە ئاستی خەڵکی ڕەمەکی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/aSAVPnyQ0bw?t=';
const double _startSecondsend = 000000000000000000000000000695;
const String _videoIdone = 'https://youtu.be/lI-SfXmeHhY?t=';
const double _startSecondsone = 000000000000000000000000000409;
const String _videoIdtwo = 'https://youtu.be/uZxu2BGVbUo?t=';
const double _startSecondstwo = 000000000000000000000000000178;
const String _videoIdthree = 'https://youtu.be/wDktwJoOYQ0?t=';
const double _startSecondsthree = 0000000000000000000000000002831;
const String _videoIdfour = 'https://youtu.be/oqKZWxmI2Pk?t=';
const double _startSecondsfour = 0000000000000000000000000002488;
const String _videoIdfive = 'https://youtu.be/yVnDJZorYPA?t=';
