...
class EnglishEntryglibness extends StatefulWidget {
  const EnglishEntryglibness({super.key});

  @override
  State<EnglishEntryglibness> createState() => _EnglishEntryglibnessState();
}

class _EnglishEntryglibnessState extends State<EnglishEntryglibness> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""glibness""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glibness""",
                      // alsoEnglishWord: "also: glibness",
                      britshText: """IpaUK: /ˈɡlɪb.nəs/""",
                      americanText: """IpaUS: /ˈɡlɪb.nəs/""",
...
// With short examples define "glibness", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە بە بەکارهێنانی وشەی زیرەکانەیە، بەڵام کە زۆر بیری لێ‌نەکراوەتەوە و لە دڵەوە نییە؛ ئەوەی باوەڕبەخۆبوونت زۆر بێت، بەڵام سادە بیت بە بێ بیرکردنەوەی قووڵ"""),
                    SentencesRow(
                      englishText:
                          """A little less glibness and a little more insight would give the show more depth.""",
                      kurdishText:
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/QtFybK9n1EM?t=';
const double _startSecondsend = 0000000000000000000000000001076;
const String _videoIdone = 'https://youtu.be/JXTZSi6q3xE?t=';
const double _startSecondsone = 000000000000000000000000000134;
const String _videoIdtwo = 'https://youtu.be/3df8PYMHRMU?t=';
const double _startSecondstwo = 000000000000000000000000000113;
const String _videoIdthree = 'https://youtu.be/nwWIdlo-sK8?t=';
const double _startSecondsthree = 000000000000000000000000000187;
const String _videoIdfour = 'https://youtu.be/R0NcaJ_xQP0?t=';
const double _startSecondsfour = 000000000000000000000000000746;
const String _videoIdfive = 'https://youtu.be/ZrQFsNom5eo?t=';
