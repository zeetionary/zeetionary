...
class EnglishEntryextinguish extends StatefulWidget {
  const EnglishEntryextinguish({super.key});

  @override
  State<EnglishEntryextinguish> createState() => _EnglishEntryextinguishState();
}

class _EnglishEntryextinguishState extends State<EnglishEntryextinguish> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extinguish""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extinguish""",
                      // alsoEnglishWord: "also: extinguish",
                      britshText: """IpaUK: /ɪkˈstɪŋɡwɪʃ/""",
                      americanText: """IpaUS: /ɪkˈstɪŋɡwɪʃ/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extinguish";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""All lights had been extinguished.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Firefighters tried to extinguish the flames.""");
  }
...
کوردی: کوژاندنەوە، قڕکردن، کوشتن
"""),
          const DefinitionKurdish(
              text: """١. (کردار) کوژاندنەوەی ئاگر یان ڕۆشناییەک"""),
          SentencesRow(
            englishText: """All lights had been extinguished.""",
            kurdishText: """تەواوی ڕۆشناییەکان کۆژێندرابوونەوە.""",
...
2. Extinguish by crushing (= stub, stub out, crush out, press out)
 
3. Terminate, end, or take out (= eliminate, get rid of, do away with)
"Socialism extinguished these archaic customs";
 
4. Kill in large numbers (= eliminate, annihilate, eradicate, wipe out, decimate, carry off)
"the plague extinguished an entire population";
 
5. Put an end to; kill (= snuff out [informal])
...
const String _videoIdone = 'https://youtu.be/WUV6L8sr_gQ?t=';
...
const String _videoIdthree = 'https://youtu.be/vGQQbulRUjY?t=';
const double _startSecondsthree = 000000000000000000000000000350;
const String _videoIdfour = 'https://youtu.be/f8euUepDo5w?t=';
const double _startSecondsfour = 000000000000000000000000000205;
const String _videoIdfive = 'https://youtu.be/hA95iw4B2jg?t=';
const double _startSecondsfive = 000000000000000000000000000895;
