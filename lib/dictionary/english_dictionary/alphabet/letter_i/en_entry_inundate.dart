...
class EnglishEntryinundate extends StatefulWidget {
  const EnglishEntryinundate({super.key});

  @override
  State<EnglishEntryinundate> createState() => _EnglishEntryinundateState();
}

class _EnglishEntryinundateState extends State<EnglishEntryinundate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: inundate (Derived forms: inundates, inundating, inundated)
1. Fill quickly beyond capacity; as with a liquid (- deluge, flood, swamp)
"the basement was inundated after the storm";
 
2. Fill or cover completely, usually with water (- deluge, submerge)
""",
  );

  final String keyword = "inundate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inundate""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We have been inundated with offers of help.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She's inundated with work at the moment.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Flood waters inundate the river plain each spring.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/DqF-gEPcgPo?t=';
    const double startSecondsend = 0000000000000000000000000001181;
    const String videoIdone = 'https://youtu.be/6-ojAez_BUc?t=';
    const double startSecondsone = 0000000000000000000000000001464;
    const String videoIdtwo = 'https://youtu.be/ZU1n3DVlqGU?t=';
    const double startSecondstwo = 000000000000000000000000000144;
    const String videoIdthree = 'https://youtu.be/l-fRxWv_n_U?t=';
    const double startSecondsthree = 000000000000000000000000000481;
    const String videoIdfour = 'https://youtu.be/Z7msRhXgKXk?t=';
    const double startSecondsfour = 000000000000000000000000000251;
    const String videoIdfive = 'https://youtu.be/4sF2utCF3Ek?t=';
    const double startSecondsfive = 000000000000000000000000000373;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inundate""",
                      // alsoEnglishWord: "also: inundate",
                      britshText: """IpaUK: /ˈɪnʌndeɪt/""",
                      americanText: """IpaUS: /ˈɪnʌndeɪt/""",
...
کوردی: 
"""),
// With short examples define "inundate", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) پێدان یان ناردنی ڕێژەیەکی زۆر لە شت بۆ کەسێک کە بەرگەی هەمووی ناگرێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: overwhelm، swamp"),
                    SentencesRow(
                      englishText:
                          """We have been inundated with offers of help.""",
                      kurdishText: """نغرۆی پێشنیاری یارمەتی کراوین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە ئێستادا تژییە لە کارکردن.""",
                      kurdishNote: """واتا کارێکی زۆری هەیە بیکات""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) داپۆشینی ڕێژەیەکی زۆر لە خاک بە ئاو"""),
                    const AlsoEnglishckb(word: "ھەروەھا: flood"),
                    SentencesRow(
                      englishText:
                          """Flood waters inundate the river plain each spring.""",
                      kurdishText:
                          """ئاوی لافاو دەشتایی ڕووبارەکە هەموو بەهارێک پڕ دەکەن.""",
