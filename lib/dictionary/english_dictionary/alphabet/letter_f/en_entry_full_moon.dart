...
class EnglishEntryfullmoon extends StatefulWidget {
  const EnglishEntryfullmoon({super.key});

  @override
  State<EnglishEntryfullmoon> createState() => _EnglishEntryfullmoonState();
}

class _EnglishEntryfullmoonState extends State<EnglishEntryfullmoon> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: full moon (Derived forms: full moons)
1. The time when the Moon is fully illuminated (- full-of-the-moon, full phase of the moon, full)
"the moon is at the full moon";
""",
  );

  final String keyword = "full moon";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""full moon""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The road shone under the full moon.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There's a full moon tonight.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """full moon""",
                      // alsoEnglishWord: "also: full moon",
                      britshText: """IpaUK: /ˌfʊl ˈmuːn/""",
                      americanText: """IpaUS: /ˌfʊl ˈmuːn/""",
...
کوردی: مانگی چاردە، مانگی پڕ، هەلاب، مانگی شەوی چاردە
"""),
// With short examples define "full moon", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) پننسە"""),
                    SentencesRow(
                      englishText: """The road shone under the full moon.""",
                      kurdishText:
                          """ڕێگاکە لەژێر مانگە پڕەکەدا دەدرەوشایەوە.""",
                    ...
                    SentencesRow(
                      englishText: """There's a full moon tonight.""",
                      kurdishText: """ئەمشەو مانگی چواردەیە.""",
...
const String _videoIdone = 'https://youtu.be/T1W4KLi0ClU?t=';
const double _startSecondsone = 000000000000000000000000000268;
const String _videoIdtwo = 'https://youtu.be/zhoTX0RRXPQ?t=';
const double _startSecondstwo = 000000000000000000000000000492;
const String _videoIdthree = 'https://youtu.be/1afpDuTb-P0?t=';
const double _startSecondsthree = 000000000000000000000000000296;
const String _videoIdfour = 'https://youtu.be/KTe9yvjIrRQ?t=';
const double _startSecondsfour = 000000000000000000000000000249;
const String _videoIdfive = 'https://youtu.be/mSWL0GBf-TM?t=';
const double _startSecondsfive = 000000000000000000000000000712;
