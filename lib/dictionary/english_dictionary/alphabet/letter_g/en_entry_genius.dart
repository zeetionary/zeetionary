...
class EnglishEntrygenius extends StatefulWidget {
  const EnglishEntrygenius({super.key});

  @override
  State<EnglishEntrygenius> createState() => _EnglishEntrygeniusState();
}

class _EnglishEntrygeniusState extends State<EnglishEntrygenius> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was at the peak of her creative genius.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It's undoubtedly a work of genius.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was a man of great genius.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He's a genius at organizing people.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""You're an absolute genius!""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He had a genius for making people feel at home.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She has a genius for sorting things out.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her genius idea solved a major problem.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """genius""",
                      // alsoEnglishWord: "also: genius",
                      britshText: """IpaUK: /ˈdʒiːniəs/""",
                      americanText: """IpaUS: /ˈdʒiːniəs/""",
...
// With short examples define "genius", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە لوتکەی بلیمەتییدا بوو.""",
                    ...
                    SentencesRow(
                      englishText: """It's undoubtedly a work of genius.""",
                      kurdishText: """بە بێ‌گومانی کاری بلیمەتی بوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He was a man of great genius.""",
                      kurdishText: """پیاوێکی خاوەن بلیمەتی بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """You don't have to be a genius to see that they are in love!""",
                      kurdishText:
                          """پێویست ناکات بلیمەتێک بیت بۆ ئەوەی بزانیت لە خۆشەویستیدان!""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """You're an absolute genius!""",
                      kurdishText: """بلیمەتێکی تەواویت!""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بیرۆکە بلیمەتانەکەی کێشەیەکی گەورەی چارەسەر کرد.""",
...
const double _startSecondsone = 000000000000000000000000000792;
const String _videoIdtwo = 'https://youtu.be/zqllxbPWKNI?t=';
const double _startSecondstwo = 0000000000000000000000000001404;
const String _videoIdthree = 'https://youtu.be/_a8u4949t_k?t=';
const double _startSecondsthree = 000000000000000000000000000115;
const String _videoIdfour = 'https://youtu.be/iYfQFsilPn8?t=';
const double _startSecondsfour = 000000000000000000000000000148;
const String _videoIdfive = 'https://youtu.be/w-oGpGf03Ag?t=';
