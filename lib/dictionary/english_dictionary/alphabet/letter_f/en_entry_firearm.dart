...
class EnglishEntryfirearm extends StatefulWidget {
  const EnglishEntryfirearm({super.key});

  @override
  State<EnglishEntryfirearm> createState() => _EnglishEntryfirearmState();
}

class _EnglishEntryfirearmState extends State<EnglishEntryfirearm> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: firearm (Derived forms: firearms)
1. A portable gun (= piece, small-arm)
"he wore his firearm in a shoulder holster";
""",
  );

  final String keyword = "firearm";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""firearm""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The police were issued with firearms.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The police charged her with possessing an illegal firearm.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """firearm""",
                      // alsoEnglishWord: "also: firearm",
                      britshText: """IpaUK: /ˈfaɪərɑːm/""",
                      americanText: """IpaUS: /ˈfaɪərɑːrm/""",
...
// With short examples define "firearm", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) چەکێک کە هەڵدەگیرێت"""),
                    SentencesRow(
                      englishText:
                          """The police were issued with firearms.""",
                      kurdishText: """پۆلیس چەکی دەستییان پێدرا.""",
                    ...
                    SentencesRow(
                      englishText: """The police charged her with possessing an illegal firearm.""",
                      kurdishText: """پۆلیس تاوانباریان بە هەڵگرتنی چەکی دەستی بێ‌مۆڵەت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ViW36wuOBBU?t=';
const double _startSecondsend = 00000000000000000000000000068;
const String _videoIdone = 'https://youtu.be/aPn8dGYPoYM?t=';
const double _startSecondsone = 000000000000000000000000000821;
const String _videoIdtwo = 'https://youtu.be/jjlpL2spsrc?t=';
const double _startSecondstwo = 000000000000000000000000000138;
const String _videoIdthree = 'https://youtu.be/fZKrcjURsPM?t=';
const double _startSecondsthree = 000000000000000000000000000143;
const String _videoIdfour = 'https://youtu.be/n3vfP95iRok?t=';
const double _startSecondsfour = 00000000000000000000000000011;
const String _videoIdfive = 'https://youtu.be/F7IQcpalC5M?t=';
