...
// replace these: replace EnglishEntryanchorage - replace speakAnchorage - replace anchorage - /ˈæŋkərɪdʒ/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryanchorage extends StatelessWidget {
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "anchorage"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæŋkərɪdʒ/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæŋkərɪdʒ/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'sr284c-q8oY';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '3htwtaJI2nM';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '-qePXPjPLgM';
