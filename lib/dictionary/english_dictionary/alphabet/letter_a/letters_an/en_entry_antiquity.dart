...
// replace EnglishEntryantiquity - replace speakAntiquity

// replace antiquity - /ænˈtɪkwəti/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryantiquity extends StatelessWidget {
  // blank divider
  EnglishEntryantiquity({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "antiquity"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ænˈtɪkwəti/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ænˈtɪkwəti/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'xxiLuwOhzmo';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'zURaTOnFoFE';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '1bV-UGdOu0I';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'BFC-00cjUgs';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'yvYw5v09kJE';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'q24tXiEuVg4';
