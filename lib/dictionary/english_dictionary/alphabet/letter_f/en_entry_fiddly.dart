...
class EnglishEntryfiddly extends StatefulWidget {
  const EnglishEntryfiddly({super.key});

  @override
  State<EnglishEntryfiddly> createState() => _EnglishEntryfiddlyState();
}

class _EnglishEntryfiddlyState extends State<EnglishEntryfiddly> {
  @override
  void initState() {
    super.initState();
...
- Adjective: fiddly
Usage: Brit, informal
1. Awkward to do or use, requiring a degree of manual dexterity
"Fiddly buttons and braces, and knickers and tap-dancing, were sure to crop up again"
""",
  );

  final String keyword = "fiddly";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Zips are less fiddly than buttons.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was very fiddly to do with gloves on.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiddly""",
                      // alsoEnglishWord: "also: fiddly",
                      britshText: """IpaUK: /ˈfɪdli/""",
                      americanText: """IpaUS: /ˈfɪdli/""",
...
// With short examples define "fiddly", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زنجیر کەمتر دژوارە وەک لە دووگمە/قۆپچە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """زۆر سەخت بوو بۆ کردن بە دەستکێشەوە.""",
...
const String _videoIdend = 'https://youtu.be/tURHTuKHBZs?t=';
const double _startSecondsend = 0000000000000000000000000001483;
const String _videoIdone = 'https://youtu.be/P7pUT0gbZZQ?t=';
const double _startSecondsone = 000000000000000000000000000993;
const String _videoIdtwo = 'https://youtu.be/dpT86z93Ec8?t=';
const double _startSecondstwo = 000000000000000000000000000244;
const String _videoIdthree = 'https://youtu.be/DtXC6Tu5p0M?t=';
const double _startSecondsthree = 0000000000000000000000000001148;
const String _videoIdfour = 'https://youtu.be/Tmg5WOvPKpU?t=';
const double _startSecondsfour = 00000000000000000000000000064;
const String _videoIdfive = 'https://youtu.be/LnP_-dWFk4M?t=';
const double _startSecondsfive = 000000000000000000000000000478;
