...
class EnglishEntryfiber extends StatefulWidget {
  const EnglishEntryfiber({super.key});

  @override
  State<EnglishEntryfiber> createState() => _EnglishEntryfiberState();
}

class _EnglishEntryfiberState extends State<EnglishEntryfiber> {
  @override
  void initState() {
    super.initState();
...
2. Coarse, indigestible plant food low in nutrients; its bulk stimulates intestinal peristalsis (= roughage, fibre [Brit, Cdn])
 
3. Any of several elongated, threadlike cells (especially a muscle fiber or a nerve fiber) (= fibre [Brit, Cdn])
 
4. The inherent complex of attributes that determines a person's moral and ethical actions and reactions (= character, fibre [Brit, Cdn])
 
5. A leatherlike material made by compressing layers of paper or cloth (= fibre [Brit, Cdn], vulcanized fiber [US], vulcanized fibre [Brit, Cdn])
""",
  );

  final String keyword = "fiber";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Dried fruits are especially high in fibre.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He has been advised to increase his fibre intake.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Peaches are a good source of fibre.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Wear underwear that is made from natural fibres.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiber""",
                      alsoEnglishWord: "also: fibre",
                      britshText: """IpaUK: /ˈfaɪbə(r)/""",
                      americanText: """IpaUS: /ˈfaɪbər/""",
...
// With short examples define "fiber", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """میوەی وشک بەتایبەتی پڕن لە ڕیشاڵ.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئامۆژگاری کراوە کە ڕێژەی فایبەر خواردنی زیاد بکات.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Peaches are a good source of fibre.""",
                      kurdishText: """قۆخ سەرچاوەی باشی ڕیشاڵە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """جلی ژێرەوە لەبەر بکە کە لە دەزووی سرووشتی درووستکراوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The disease is characterized by degeneration of muscle fibres.""",
                      kurdishText:
                          """نەخۆشییەکە دەناسرێتەوە بە لاوازبوونی ڕیشاڵە ماسوولکەییەکان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The function of nerve fibres is to transmit coded information from one place to another.""",
                      kurdishText:
                          """ئەرکی ڕیشاڵە دەمارییەکان گواستنەوەی زانیارییە کۆدییە لە شوێنێکەوە بۆ شوێنێکی دیکە.""",
...
const double _startSecondsone = 000000000000000000000000000411;
const String _videoIdtwo = 'https://youtu.be/MjEgF_LrGyc?t=';
const double _startSecondstwo = 000000000000000000000000000101;
const String _videoIdthree = 'https://youtu.be/fQZfxCzUPmw?t=';
const double _startSecondsthree = 000000000000000000000000000320;
const String _videoIdfour = 'https://youtu.be/oTccIyHjxVU?t=';
const double _startSecondsfour = 00000000000000000000000000037;
const String _videoIdfive = 'https://youtu.be/48CcDQ2OrjA?t=';
