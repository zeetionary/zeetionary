...
class EnglishEntryeventempered extends StatefulWidget {
  const EnglishEntryeventempered({super.key});

  @override
  State<EnglishEntryeventempered> createState() =>
      _EnglishEntryeventemperedState();
}

class _EnglishEntryeventemperedState extends State<EnglishEntryeventempered> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""even-tempered""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """even-tempered""",
                      // alsoEnglishWord: "also: even-tempered",
                      britshText: """IpaUK: /ˌiːvn ˈtempəd/""",
                      americanText: """IpaUS: /ˌiːvn ˈtempərd/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "even-tempered";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""An even-tempered person handles conflicts well.""");
  }
...
کوردی: 
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) لەسەرەخۆ"""),
          SentencesRow(
            englishText: """An even-tempered person handles conflicts well.""",
            kurdishText: """کەسێکی لەسەرەخۆ بەباشی کێشمەکێش چارەسەر دەکات.""",
...
1. Not easily irritated (= equable, good-tempered, placid)
"an even-tempered temper";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/gVjX4val91A?t=';
const double _startSecondsend = 000000000000000000000000000000; // 398;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/ojAIgO3BtUY?t=';
const double _startSecondsone = 00000000000000000000000000000; // 404;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/hB7CCgy88Ow?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 384;
const String _videoIdthree = 'VIDEOhttps://youtu.be/QjLEW7iFR5Y?t=';
const double _startSecondsthree = 000000000000000000000000000; // 54;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/2Kktwa0kqaU?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1965;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/iSd5IrtbPcY?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 125;
