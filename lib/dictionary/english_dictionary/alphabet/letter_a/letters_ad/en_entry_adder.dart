...
// replace these: replace EnglishEntryadamsadder - replace speakAdder - replace adder - /ˈædər/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadamsadder extends StatelessWidget {
  EnglishEntryadamsadder({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "adder", // DOPSUM: CHANGE WORD ENTRY - Find /ˈædər/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈædər/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'vhKIUgpy5os';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'sw4T62rNmoA';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'FL3J8SAjpX8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'wUM3zJSl0w4';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'oCYs9lnq1tE';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'K0OB6fGx3bA';
