...
class EnglishEntryheadrest extends StatefulWidget {
  const EnglishEntryheadrest({super.key});

  @override
  State<EnglishEntryheadrest> createState() => _EnglishEntryheadrestState();
}

class _EnglishEntryheadrestState extends State<EnglishEntryheadrest> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: headrest (Derived forms: headrests)
1. A cushion attached to the top of the back of an automobile's seat to prevent whiplash (- head restraint)
 
2. A rest for the head
""",
  );

  final String keyword = "headrest";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""headrest""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The headrest in the airplane seat was soft.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """headrest""",
                      // alsoEnglishWord: "also: headrest",
                      britshText: """IpaUK: /ˈhedrest/""",
                      americanText: """IpaUS: /ˈhedrest/""",
...
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) جێی سەر هە بەستراوە بە کورسی یان کووشنی پێڕۆیەک"""),
                    SentencesRow(
                      englishText:
                          """The headrest in the airplane seat was soft.""",
                      kurdishText: """جێ‌سەری کووشنی فڕۆکەکە نەرم بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/xcaeyJTx4Co?t=';
const double _startSecondsend = 000000000000000000000000000130;
const String _videoIdone = 'https://youtu.be/GTxmMPX06Gs?t=';
const double _startSecondsone = 000000000000000000000000000272;
const String _videoIdtwo = 'https://youtu.be/yjv-NN_rusc?t=';
const double _startSecondstwo = 000000000000000000000000000305;
const String _videoIdthree = 'https://youtu.be/2sCki6KlTf8?t=';
const double _startSecondsthree = 000000000000000000000000000192;
const String _videoIdfour = 'https://youtu.be/swtpoH-HZgY?t=';
const double _startSecondsfour = 000000000000000000000000000304;
const String _videoIdfive = 'https://youtu.be/K-bBOe1d72g?t=';
const double _startSecondsfive = 000000000000000000000000000689;
