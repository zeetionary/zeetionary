...
class EnglishEntryartgallery extends StatelessWidget {
  ...
  Future<void> speakartgallery(String languageCode) async {
    ...
    await flutterTts.speak("art gallery");
  }
  ...
  Future<void> speakartgallery1257(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("He frequently exhibits at the art gallery.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "art gallery"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɑːt ɡæləri/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrt ɡæləri/"),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'nm6iISd3GwQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'rtLTZUaMSDQ';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'uZDNGVmHxn4';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '5m2c7qpGgTM';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'j4ahNpQLgdk';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'S2L0sWMEG-A';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = '1RvBvYrklXM';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'FE1aHAJo-O4';
