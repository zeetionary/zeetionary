...
class EnglishEntrygratuitously extends StatefulWidget {
  const EnglishEntrygratuitously({super.key});

  @override
  State<EnglishEntrygratuitously> createState() =>
      _EnglishEntrygratuitouslyState();
}

class _EnglishEntrygratuitouslyState extends State<EnglishEntrygratuitously> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gratuitously";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gratuitously""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""What that boy wrote was gratuitously offensive.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gratuitously""",
                      // alsoEnglishWord: "also: gratuitously",
                      britshText: """IpaUK: /ɡrəˈtjuːɪtəsli/""",
                      americanText: """IpaUS: /ɡrəˈtuːɪtəsli/""",
...
// With short examples define "gratuitously", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە بە بێ هۆکار یان مەبەستی دیاریکراو دەکرێت و زۆرجار کاریگەری زیانبەخشی هەیە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: unnecessarily"),
                    SentencesRow(
                      englishText:
                          """What that boy wrote was gratuitously offensive.""",
                      kurdishText:
                          """ئەوەی کوڕەکە نووسی لەخۆڕایی بێ‌ڕێزانە بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/fOzFG5m3Y5E?t=';
const double _startSecondsend = 000000000000000000000000000120;
const String _videoIdone = 'https://youtu.be/fFoHzS_XhNY?t=';
const double _startSecondsone = 000000000000000000000000000962;
const String _videoIdtwo = 'https://youtu.be/mtDOr9UY-yk?t=';
const double _startSecondstwo = 0000000000000000000000000002914;
const String _videoIdthree = 'https://youtu.be/f-0fARu60yk?t=';
const double _startSecondsthree = 000000000000000000000000000802;
const String _videoIdfour = 'https://youtu.be/OF4DbkNAY-0?t=';
const double _startSecondsfour = 000000000000000000000000000188;
const String _videoIdfive = 'https://youtu.be/YoXxevp1WRQ?t=';
const double _startSecondsfive = 0000000000000000000000000003334;
