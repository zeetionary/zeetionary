...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'IutULT1kVMA';
    const double startSecondsend = 230;
    const String videoIdone = 'F_l-pxawWOE';
    const double startSecondsone = 259;
    const String videoIdtwo = 'VKqC5w207O4';
    const double startSecondstwo = 1554;
    const String videoIdthree = 'LK5cPn6eGbc';
    const double startSecondsthree = 267;
    const String videoIdfour = 'VPSm9gJkPxU';
    const double startSecondsfour = 1567;
    const String videoIdfive = 'jYMjLgPFSso';
