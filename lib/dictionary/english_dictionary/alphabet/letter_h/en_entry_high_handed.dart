...
class EnglishEntryhighhanded extends StatefulWidget {
  const EnglishEntryhighhanded({super.key});

  @override
  State<EnglishEntryhighhanded> createState() => _EnglishEntryhighhandedState();
}

class _EnglishEntryhighhandedState extends State<EnglishEntryhighhanded> {
  @override
  void initState() {
    super.initState();
...
1. Given to haughty disregard of others (- cavalier)
"This high-handed measure created the greatest sensation in the city, and was strongly resisted by the judges of the Audience";
""",
  );

  final String keyword = "high-handed";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""high-handed""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """high-handed""",
                      // alsoEnglishWord: "also: high-handed",
                      britshText: """IpaUK: /ˌhaɪ ˈhændɪd/""",
                      americanText: """IpaUS: /ˌhaɪ ˈhændɪd/""",
...
کوردی: 
"""),
// With short examples define "high-handed", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) بەکارهێنانی دەسەڵات بە هەڵەشانە، بەبێ گرنگیدان بە بۆچوونی خەڵکی"""),
                    SentencesRow(
                      englishText:
                          """She’s always so arrogant and high-handed in her dealings with people.""",
                      kurdishText:
                          """هەمیشە زۆر خۆبەزلزان و داپڵۆسێنەرە لە مامەڵە لەگەڵ خەڵکیدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/fCu5IZ-2LXo?t=';
const double _startSecondsend = 000000000000000000000000000224;
const String _videoIdone = 'https://youtu.be/Yf_qB3wYtuM?t=';
const double _startSecondsone = 000000000000000000000000000299;
const String _videoIdtwo = 'https://youtu.be/wExK37zBmX8?t=';
const double _startSecondstwo = 0000000000000000000000000008247;
const String _videoIdthree = 'https://youtu.be/MVTJiWRUduo?t=';
const double _startSecondsthree = 000000000000000000000000000544;
const String _videoIdfour = 'https://youtu.be/cSHoGTZnpn8?t=';
const double _startSecondsfour = 000000000000000000000000000527;
const String _videoIdfive = 'https://youtu.be/jNkWrRRz2EI?t=';
const double _startSecondsfive = 000000000000000000000000000997;
