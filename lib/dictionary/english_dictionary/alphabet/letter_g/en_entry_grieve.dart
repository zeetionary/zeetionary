...
class EnglishEntrygrieve extends StatefulWidget {
  const EnglishEntrygrieve({super.key});

  @override
  State<EnglishEntrygrieve> createState() => _EnglishEntrygrieveState();
}

class _EnglishEntrygrieveState extends State<EnglishEntrygrieve> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: grieve (Derived forms: grieving, grieves, grieved)
1. Feel grief (- sorrow)
 
2. Cause to feel sorrow (- aggrieve)
"his behaviour grieves his mother";
""",
  );

  final String keyword = "grieve";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They are still grieving for their dead child.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She grieved the death of her husband.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grieve""",
                      // alsoEnglishWord: "also: grieve",
                      britshText: """IpaUK: /ɡriːv/""",
                      americanText: """IpaUS: /ɡriːv/""",
...
کوردی: 
"""),
// With short examples define "grieve", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) هەستکردن بە نیگەرانی و خەمباری، بە تایبەتی بەهۆی ئەوەی کەسێک مردووە"""),
                    SentencesRow(
                      englishText: """They are still grieving for their dead child.""",
                      kurdishText: """هێشتا شیوەنی مردنی منداڵە کۆچکردووەکەیان دەگێڕن.""",
                    ...
                    SentencesRow(
                      englishText: """She grieved the death of her husband.""",
                      kurdishText: """شیوەنی مەرگی هاوسەرەکەی گێڕا.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) کە وات لێدەکات هەست بە نیگەرانیی زۆر بکەیت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: pain"),
                    SentencesRow(
                      englishText: """It grieved him that he could do nothing to help her.""",
                      kurdishText: """ئەوە ئازاری دەدا کە نەیدەتونی هیچ بکات بۆ یارمەتیدانی.""",
...
const String _videoIdone = 'https://youtu.be/x6a4hMyiwBo?t=';
const double _startSecondsone = 000000000000000000000000000554;
const String _videoIdtwo = 'https://youtu.be/_0MutuU6eks?t=';
const double _startSecondstwo = 000000000000000000000000000491;
const String _videoIdthree = 'https://youtu.be/xU0TmQ56v0U?t=';
const double _startSecondsthree = 000000000000000000000000000443;
const String _videoIdfour = 'https://youtu.be/ltnl4USwPs8?t=';
const double _startSecondsfour = 0000000000000000000000000001471;
const String _videoIdfive = 'https://youtu.be/Aoo9l_w2pq4?t=';
const double _startSecondsfive = 0000000000000000000000000001637;
