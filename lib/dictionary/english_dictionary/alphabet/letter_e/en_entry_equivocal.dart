...
class EnglishEntryequivocal extends StatefulWidget {
  const EnglishEntryequivocal({super.key});

  @override
  State<EnglishEntryequivocal> createState() => _EnglishEntryequivocalState();
}

class _EnglishEntryequivocalState extends State<EnglishEntryequivocal> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""equivocal""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equivocal""",
                      // alsoEnglishWord: "also: equivocal",
                      britshText: """IpaUK: /ɪˈkwɪvəkl/""",
                      americanText: """IpaUS: /ɪˈkwɪvəkl/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "equivocal";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She gave an equivocal answer, typical of a politician.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The experiments produced equivocal results.""");
  }
...
// With short examples define "equivocal", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: واتاڵێڵ، تەژمە، دووواتادار، بەپێچ‌وپەنا، ناڕوون، نادیار، گێژکەر، بەهەڵەدابەر، ناڕۆشن،	جێی‌پرسیار، گومان‌لەسەر، گوماناوی، جێی‌شک
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) کە واتایەکی تەواو و ڕوونی نییە"""),
          SentencesRow(
            englishText:
                """She gave an equivocal answer, typical of a politician.""",
            kurdishText: """وەڵامێکی ناڕوونی دایەوە، وەک هی سیاسییەک.""",
          ...
          SentencesRow(
            englishText:
                """Women were less equivocal than men on the subject of fidelity in marriage.""",
            kurdishText:
                """ژنان کەمتر لە پیاوان ڕوون بوون لەسەر بابەتی وەفاداری و هاوسەرگیری.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ھاوەڵناو) کە سەختە بۆ تێگەشتن یان ڕوونکردنەوە بە ئاسانی یان ڕوونی"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """The experiments produced equivocal results.""",
            kurdishText: """تاقیکردنەوەکان ئەنجامی ناڕوونیان بەرهەمهێنا.""",
...
3. Open to two or more interpretations; or of uncertain nature or significance; or (often) intended to mislead (= ambiguous)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/6LFzk1afiD8?t=';
const double _startSecondsend = 000000000000000000000000000000; // 365;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/vBOhADzfYcE?t=';
const double _startSecondsone = 00000000000000000000000000000; // 48;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/0W8kG0y-JxA?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 358;
const String _videoIdthree = 'VIDEOhttps://youtu.be/8pcIbVvHI2c?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1929;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/qF_1RoMse0E?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 101;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/1HX1Ae-ZJgs?t=';
