...
class EnglishEntryineffectually extends StatefulWidget {
  const EnglishEntryineffectually({super.key});

  @override
  State<EnglishEntryineffectually> createState() =>
      _EnglishEntryineffectuallyState();
}

class _EnglishEntryineffectuallyState extends State<EnglishEntryineffectually> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ineffectually""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She tried ineffectually to encourage him to eat.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/9PWomdbZi2U?t=';
    const double startSecondsend = 000000000000000000000000000159;
    const String videoIdone = 'https://youtu.be/apDoJkfR85A?t=';
    const double startSecondsone = 000000000000000000000000000496;
    const String videoIdtwo = 'https://youtu.be/FJVWoV1AdsQ?t=';
    const double startSecondstwo = 000000000000000000000000000172;
    const String videoIdthree = 'https://youtu.be/Qyrjgf-_Vdk?t=';
    const double startSecondsthree = 0000000000000000000000000009137;
    const String videoIdfour = 'https://youtu.be/qGZhQFlO96E?t=';
    const double startSecondsfour = 000000000000000000000000000335;
    const String videoIdfive = 'https://youtu.be/eX_0J8GQFJ8?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ineffectually""",
                      // alsoEnglishWord: "also: ineffectually",
                      britshText: """IpaUK: /ˌɪnɪˈfektʃuəli/""",
                      americanText: """IpaUS: /ˌɪnɪˈfektʃuəli/""",
...
کوردی: بێ‌ئەنجامانە، ناکەریگەر، بێهوودە
"""),
// With short examples define "ineffectually", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە لاوازە و توانای بەدەستهێنانی زۆری نییە"""),
                    SentencesRow(
                      englishText:
                          """She tried ineffectually to encourage him to eat.""",
                      kurdishText:
                          """بێ‌ئەنجامانە هەوڵیدا هانی بدات نان بخوات.""",
