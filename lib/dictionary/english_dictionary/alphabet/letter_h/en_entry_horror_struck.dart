...
class EnglishEntryhorrorstruck extends StatefulWidget {
...
1. Stricken with horror (- horrified, horror-stricken)
"They suggested that authors are not so much awe-struck or horror-struck as they are provoked by some topical issue";
""",
  );

  final String keyword = "horror-struck";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""horror-struck""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He stared, horror-struck at the sight.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/wExK37zBmX8?t=';
    const double startSecondsone = 0000000000000000000000000003096;
    const String videoIdtwo = 'https://youtu.be/YH6WMN2CfxI?t=';
    const double startSecondstwo = 000000000000000000000000000420;
    const String videoIdthree = 'https://youtu.be/sU7rONs45p4?t=';
    const double startSecondsthree = 000000000000000000000000000591;
    const String videoIdfour = 'https://youtu.be/iMc9mMZ5bIA?t=';
    const double startSecondsfour = 0000000000000000000000000001218;
    const String videoIdfive = 'https://youtu.be/MO0EQi8CL3Q?t=';
    const double startSecondsfive = 0000000000000000000000000001171;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """horror-struck""",
                      // alsoEnglishWord: "also: horror-struck",
                      britshText: """IpaUK: /ˈhɒrə strʌk/""",
                      americanText: """IpaUS: /ˈhɔːrər strʌk/""",
