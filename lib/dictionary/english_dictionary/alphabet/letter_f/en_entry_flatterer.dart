...
class EnglishEntryflatterer extends StatefulWidget {
  const EnglishEntryflatterer({super.key});

  @override
  State<EnglishEntryflatterer> createState() => _EnglishEntryflattererState();
}

class _EnglishEntryflattererState extends State<EnglishEntryflatterer> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flatterer (Derived forms: flatterers)
1. A person who uses flattery (= adulator)
""",
  );

  final String keyword = "flatterer";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flatterer""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flatterer""",
                      // alsoEnglishWord: "also: flatterer",
                      britshText: """IpaUK: /ˈflætərə(r)/""",
                      americanText: """IpaUS: /ˈflætərər/""",
...
// With short examples define "flatterer", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """You can't believe a word Tony says, he's a real flatterer.""",
                      kurdishText:
                          """ناتوانیت باوەڕ بە هیچ بکەیت کە تۆنی دەیڵێت، ڕیایی‌بازێکی ڕەستەقینەیە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/s6Mo7YNAmcs?t=';
const double _startSecondsend = 000000000000000000000000000459;
const String _videoIdone = 'https://youtu.be/UyCbqR4A__M?t=';
const double _startSecondsone = 000000000000000000000000000181;
const String _videoIdtwo = 'https://youtu.be/CCCXPPP3gJU?t=';
const double _startSecondstwo = 000000000000000000000000000328;
const String _videoIdthree = 'https://youtu.be/yk5LeTnt9jU?t=';
const double _startSecondsthree = 000000000000000000000000000275;
const String _videoIdfour = 'https://youtu.be/d85qzE6V38E?t=';
const double _startSecondsfour = 00000000000000000000000000092;
const String _videoIdfive = 'https://youtu.be/8ghoXQxdk6s?t=';
const double _startSecondsfive = 0000000000000000000000000002490;
