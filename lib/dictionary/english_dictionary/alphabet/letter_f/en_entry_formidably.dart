...
class EnglishEntryformidably extends StatefulWidget {
  const EnglishEntryformidably({super.key});

  @override
  State<EnglishEntryformidably> createState() => _EnglishEntryformidablyState();
}

class _EnglishEntryformidablyState extends State<EnglishEntryformidably> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "formidably";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""formidably""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's formidably intelligent.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The team lost the match after starting formidably.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """formidably""",
                      // alsoEnglishWord: "also: formidably",
                      britshText: """IpaUK: /fəˈmɪdəbli/,  /ˈfɔːmɪdəbli/""",
                      americanText: """IpaUS: /ˈfɔːrmɪdəbli/,  /fərˈmɪdəbli/""",
...
// With short examples define "formidably", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بەشێوەیەک کە شتێک وات لێ دەکا هەست بە ترس و ڕێز بکەیت بەهۆی ئەوەی کە ناوازە یان بەهێزە، یان بەهۆی ئەوەی سەخت دیارە"""),
                    SentencesRow(
                      englishText: """She's formidably intelligent.""",
                      kurdishText: """بەشێوەیەکی بەرچاو زیرەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The team lost the match after starting formidably.""",
                      kurdishText:
                          """تیمەکە یارییەکەی دۆڕاند لە دوای ئەوەی بە هەیبەتەوە دەستی پێکرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/CE3OutlMcfM?t=';
const double _startSecondsend = 000000000000000000000000000422;
const String _videoIdone = 'https://youtu.be/4v_tBnyg28I?t=';
const double _startSecondsone = 000000000000000000000000000108;
const String _videoIdtwo = 'https://youtu.be/Dai4hv2juOk?t=';
const double _startSecondstwo = 000000000000000000000000000409;
const String _videoIdthree = 'https://youtu.be/gOGDDh1thaQ?t=';
const double _startSecondsthree = 000000000000000000000000000370;
const String _videoIdfour = 'https://youtu.be/PLgBgDfQPXg?t=';
const double _startSecondsfour = 000000000000000000000000000687;
const String _videoIdfive = 'https://youtu.be/90WVWIcB6Dg?t=';
const double _startSecondsfive = 000000000000000000000000000473;
