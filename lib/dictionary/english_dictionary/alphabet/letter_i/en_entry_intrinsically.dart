...
class EnglishEntryintrinsically extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intrinsically""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'ZOvyn72x6kQ';
    const double startSecondsend = 268;
    const String videoIdone = 'c9_20kflptY';
    const double startSecondsone = 293;
    const String videoIdtwo = 'v9tM_YHvhuA';
    const double startSecondstwo = 676;
    const String videoIdthree = 'VspjfNMPHyc';
    const double startSecondsthree = 1049;
    const String videoIdfour = 'uAPTWTmlc8Q';
