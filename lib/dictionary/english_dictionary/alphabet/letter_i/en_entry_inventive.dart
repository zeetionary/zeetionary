...
class EnglishEntryinventive extends StatefulWidget {
  const EnglishEntryinventive({super.key});

  @override
  State<EnglishEntryinventive> createState() => _EnglishEntryinventiveState();
}

class _EnglishEntryinventiveState extends State<EnglishEntryinventive> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inventive""");
  }
