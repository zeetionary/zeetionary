...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 608;
    const String videoIdone = 'ewLpXw6uN28';
    const double startSecondsone = 505;
    const String videoIdtwo = 'TVKNpjnqeg0';
    const double startSecondstwo = 466;
    const String videoIdthree = '0zXfDafyyao';
    const double startSecondsthree = 110;
    const String videoIdfour = 'NUzDLpSkQTg';
    const double startSecondsfour = 283;
    const String videoIdfive = 'L1kYZHnHS0E';
