...
class EnglishEntrygrudge extends StatefulWidget {
  const EnglishEntrygrudge({super.key});

  @override
  State<EnglishEntrygrudge> createState() => _EnglishEntrygrudgeState();
}

class _EnglishEntrygrudgeState extends State<EnglishEntrygrudge> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grudge (Derived forms: grudges)
1. A resentment strong enough to justify retaliation (- score, grievance)
"holding a grudge";

- Verb: grudge (Derived forms: grudging, grudges, grudged)
1. Bear a grudge; harbour ill feelings (- stew [informal])
 
2. Accept or admit unwillingly
""",
  );

  final String keyword = "grudge";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He has a grudge against the world.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I bear him no grudge.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He's a man with a grudge.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I grudge having to pay so much tax.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He grudges the time he spends travelling to work.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You surely don't grudge her her success?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grudge""",
                      // alsoEnglishWord: "also: grudge",
                      britshText: """IpaUK: /ɡrʌdʒ/""",
                      americanText: """IpaUS: /ɡrʌdʒ/""",
...
// With short examples define "grudge", please follow LX instructions
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He's a man with a grudge.""",
                      kurdishText: """پیاوێکە لە کینە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) کردن یان پێدانی شتێک بە نابەدڵییەوە"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕقی لەو کاتەیە کە بەسەری دەبات بە گەشتکردن بۆ سەر کار.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە دڵنیایی حەسوودی بە سەرکەوتنی نابەیت؟""",
