...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat642("en-US"),
                          ),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat643("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
...
٢. (ئامراز) بۆ پیشاندانی شوێنی کارکردن یان خوێندنی کەسێک"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat645("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٣. (ئامراز) بۆ پیشاندانی کات"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat647("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٤. (ئامراز) بۆ پیشاندانی تەمەنی کەسێک لە کاتی کردنی شتێک"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat648("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٥. (ئامراز) بۆ پیشاندانی ئاراستەی شتێک"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat650("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٦. (ئامراز) لە دوای کردار بەکاردێت بۆ پیشاندانی ئەوەی کەسێک ھەوڵ دەدات شتێک بکات، بەڵام سەرکەوتوو نابێت یان تەواوی ناکات"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat656("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٧. (ئامراز) لە دوای ھاوەڵناو بەکاردێت بۆ پیشاندانی ئاست"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat658("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٨. (ئامراز) بۆ پیشاندنی بڕ و خێرایی"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat659("en-US"),
                          ),
                          const DividerSentences(),
                          // const DividerDefinition(),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat701("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٩. (ئامراز) بۆ پیشاندنی دووری و مەودا"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat703("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
١٠. (ئامراز) بەکاردێت بۆ پیشاندنی ئەو دۆخەی کەسێک/شتێک تێیدایە، ئەوەی کەسێک دەیکات، یان ئەوەی چی ڕوودەدات"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat706("en-US"),
                          ),
                          const DividerSentences(),
                          // const DividerDefinition(),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat707("en-US"),
                          ),
                          const DividerSentences(),
                          // const DividerDefinition(),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat708("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
١١. (ئامراز) بەکاردێت بۆ پیشاندنی باشترین کاتی شتێک"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat710("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
١٢. (ئامراز) بەکاردێت لەگەڵ ھاوەڵناو بۆ پیشاندانی ھۆکار"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat712("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
١٣. (ئامراز) لە وەڵامی شتێکدا"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat716("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
١٤. (ئامراز) بۆ پیشاندانی ژمارە تەلەفۆن"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakat720("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
