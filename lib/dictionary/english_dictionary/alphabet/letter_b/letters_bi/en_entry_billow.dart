...
// Define the word "billow" and provide five simple example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings or more.

// replace billow - replace EnglishEntrybillow

// replace speakBillow - /ˈbɪləʊ/

enum TtsState { playing }

class EnglishEntrybillow extends StatelessWidget {
// blank divider
  EnglishEntrybillow({super.key});
// blank divider
  ...
  Future<void> speakbillows1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("The curtains billowed in the breeze.");
  }
  ...
  Future<void> speakbillows2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("A great cloud of smoke billowed out of the chimney.");
  }
  ...
  Future<void> speakbillows4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("speakBillows44");
  }
  ...
  Future<void> speakbillows5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("speakBillows55");
  }
  ...
  Future<void> speakbillows6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("speakBillows66");
  }
  ...
  Future<void> speakbillows7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("speakBillows77");
  }
...
"""),
                          ...
                          SentencesRow(
                            englishText: "The curtains billowed in the breeze.",
                            kurdishText: "پەردەکان تۆپەڵە بوون لە شنە باکەدا.",
                            onPressedBritish: () => speakbillows1("en-GB"),
                            onPressedAmerican: () => speakbillows1("en-US"),
                          ),
...
٢. (کردار) بەرزبوونەوەی دووکەڵ و ھەور"""),
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbillows2("en-GB"),
                            onPressedAmerican: () => speakbillows2("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٣. (ناو) تۆپەڵێکی گەورە لە دووکەڵ یان ھەڵم لە شێوەی شەپۆلدا"""),
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbillows3("en-GB"),
                            onPressedAmerican: () => speakbillows3("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
3. Rise and move, as in waves or billows (= surge, heave)
"The army billowed forward";
 
4. Become inflated (= balloon, inflate)
"The sails billowed";
""",
  );
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'owxtROejMB0';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'U4zYb7K7xu4';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'DustMUjfk58';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'ID-u83pzwUU';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'Ex74x_gqTU0';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'ZWZW3keTUPE';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'XyS-tYoOj6g';
...
// end billow// TODO Implement this library.
