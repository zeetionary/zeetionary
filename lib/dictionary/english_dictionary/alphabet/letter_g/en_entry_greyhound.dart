...
class EnglishEntrygreyhound extends StatefulWidget {
  const EnglishEntrygreyhound({super.key});

  @override
  State<EnglishEntrygreyhound> createState() => _EnglishEntrygreyhoundState();
}

class _EnglishEntrygreyhoundState extends State<EnglishEntrygreyhound> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""greyhound""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The greyhound chased after the rabbit.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """greyhound""",
                      // alsoEnglishWord: "also: greyhound",
                      britshText: """IpaUK: /ˈɡreɪhaʊnd/""",
                      americanText: """IpaUS: /ˈɡreɪhaʊnd/""",
...
کوردی: تاجی، تاژی، تانجی، سەگ‌تانجی
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) سەگێکی گەورە کە لاقی باریکی هەیە و زۆر خێرایە"""),
                    SentencesRow(
                      englishText: """The greyhound chased after the rabbit.""",
                      kurdishText: """تانجییەکە کەوتە دوای کەروێشکەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/egP2sIzn6uQ?t=';
const double _startSecondsend = 00000000000000000000000000027;
const String _videoIdone = 'https://youtu.be/0nDey0CE4GY?t=';
const double _startSecondsone = 00000000000000000000000000036;
const String _videoIdtwo = 'https://youtu.be/cUw31Kvjtl4?t=';
const double _startSecondstwo = 00000000000000000000000000090;
const String _videoIdthree = 'https://youtu.be/TKoCWh2yneM?t=';
const double _startSecondsthree = 000000000000000000000000000978;
const String _videoIdfour = 'https://youtu.be/GxQW1f1erZw?t=';
const double _startSecondsfour = 0000000000000000000000000009;
const String _videoIdfive = 'https://youtu.be/ToMw8__4MAk?t=';
