...
class EnglishEntryhoarseness extends StatefulWidget {
  const EnglishEntryhoarseness({super.key});

  @override
  State<EnglishEntryhoarseness> createState() => _EnglishEntryhoarsenessState();
}

class _EnglishEntryhoarsenessState extends State<EnglishEntryhoarseness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hoarseness
1. A throaty harshness (- gruffness, huskiness, throatiness)
""",
  );

  final String keyword = "hoarseness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hoarseness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Her symptoms include difficulty breathing and hoarseness.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/YwhBf7n61FE?t=';
    const double startSecondsend = 000000000000000000000000000167;
    const String videoIdone = 'https://youtu.be/8C2mlV_UnNI?t=';
    const double startSecondsone = 000000000000000000000000000344;
    const String videoIdtwo = 'https://youtu.be/Q-4bKSFxzaI?t=';
    const double startSecondstwo = 00000000000000000000000000047;
    const String videoIdthree = 'https://youtu.be/ytM_hc3cgsE?t=';
    const double startSecondsthree = 000000000000000000000000000762;
    const String videoIdfour = 'https://youtu.be/shxOKRSoYfQ?t=';
    const double startSecondsfour = 000000000000000000000000000579;
    const String videoIdfive = 'https://youtu.be/UAzRA1oywfw?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hoarseness""",
                      // alsoEnglishWord: "also: hoarseness",
                      britshText: """IpaUK: /ˈhɔːsnəs/""",
                      americanText: """IpaUS: /ˈhɔːrsnəs/""",
...
// With short examples define "hoarseness", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Her symptoms include difficulty breathing and hoarseness.""",
                      kurdishText:
                          """نیشانەکانی سەختی لە هەناسەدان بوو لەگەڵ دەنگ دانووساوی.""",
