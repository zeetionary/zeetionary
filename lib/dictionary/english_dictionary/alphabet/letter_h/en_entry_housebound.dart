...
class EnglishEntryhousebound extends StatefulWidget {
  const EnglishEntryhousebound({super.key});

  @override
  State<EnglishEntryhousebound> createState() => _EnglishEntryhouseboundState();
}

class _EnglishEntryhouseboundState extends State<EnglishEntryhousebound> {
  @override
  void initState() {
    super.initState();
...
1. Confined usually by illness (- homebound, shut-in)
"The national survey indicates a median age for the housebound is about 77";
""",
  );

  final String keyword = "housebound";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""housebound""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She's been housebound since the accident.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/-Sk9vtegX8k?t=';
    const double startSecondsend = 00000000000000000000000000080;
    const String videoIdone = 'https://youtu.be/5W3MEXLiZoQ?t=';
    const double startSecondsone = 000000000000000000000000000824;
    const String videoIdtwo = 'https://youtu.be/GHjiGwG4cFY?t=';
    const double startSecondstwo = 000000000000000000000000000924;
    const String videoIdthree = 'https://youtu.be/ps013CIR7TU?t=';
    const double startSecondsthree = 000000000000000000000000000756;
    const String videoIdfour = 'https://youtu.be/VwEyLw33qUI?t=';
    const double startSecondsfour = 000000000000000000000000000592;
    const String videoIdfive = 'https://youtu.be/a5t2dufNkvU?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """housebound""",
                      // alsoEnglishWord: "also: housebound",
                      britshText: """IpaUK: /ˈhaʊsbaʊnd/""",
                      americanText: """IpaUS: /ˈhaʊsbaʊnd/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لەوەتەی ڕووداوەکەوە ماڵکەوتە بووە.""",
