...
class EnglishEntryinoffensive extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inoffensive""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'J0mZYeb4C8k';
    const double startSecondsone = 1445;
    const String videoIdtwo = 'Ya2_Khcdwsk';
    const double startSecondstwo = 336;
    const String videoIdthree = 'uczvIKDcnS4';
    const double startSecondsthree = 1692;
    const String videoIdfour = 'Sv7NP9LMU4Q';
    const double startSecondsfour = 148;
    const String videoIdfive = 'wSNYgHiB-N4';
