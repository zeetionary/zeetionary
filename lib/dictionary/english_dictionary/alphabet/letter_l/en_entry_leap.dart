...
class EnglishEntryleap extends StatefulWidget {
  const EnglishEntryleap({super.key});

  @override
  State<EnglishEntryleap> createState() => _EnglishEntryleapState();
}

class _EnglishEntryleapState extends State<EnglishEntryleap> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: leap (Derived forms: leapt, leaping, leaps, leaped)
1. Push upwards with the legs and feet to move upwards (and maybe forwards) with feet clear of the ground (- jump, bound, spring)
"The child leapt across the puddle";
 
2. Pass abruptly from one state or topic to another (- jump)
"leap into fame";
 
3. Descend from an elevated point (- jump, jump off)
"the widow leapt into the funeral pyre";
 
4. Cause to jump or leap

- Noun: leap (Derived forms: leaps)
1. A light, self-propelled movement upwards or forwards (- leaping, spring, saltation, bound, bounce)
 
2. An abrupt transition (- jump, saltation)
"a successful leap from college to the major leagues";
 
3. A sudden and decisive increase (- jump)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A dolphin leapt out of the water.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We leaped over the stream.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The horse leapt a five-foot wall.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He leaped clear of the water.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She leapt out of bed.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He leaped across the room to answer the door.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They leapt into action immediately.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The shares leapt in value from 476p to close at 536p.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The company saw pre-tax profits leap to £14.5 million in 2004.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/xVQxvthAcLU?t=1100';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/lfOakuOT5dY?t=1296';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/hFZFjoX2cGg?t=547';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/mcZdTvOqmvI?t=250';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/esfChb49_Rk?t=78';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/yRmOWcWdQAo?t=536';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """leap""",
                      // alsoEnglishWord: "also: leap",
                      britshText: """IpaUK: /liːp/""",
                      americanText: """IpaUS: /liːp/""",
...
کوردی: باز، گومەتە، پەڕین، خۆهەڵدان،	گۆرانی ناکاو، زۆربوونی کوت‌وپڕ
"""),
// With short examples define "leap", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) بازدان بە بەرزی یان بۆ مەودایەکی زۆر"""),
                    SentencesRow(
                      englishText: """A dolphin leapt out of the water.""",
                      kurdishText: """دۆڵفینێک لە ئاوەکە بازی دایە دەرەوە.""",
                    ...
                    SentencesRow(
                      englishText: """We leaped over the stream.""",
                      kurdishText: """بەسەر زەلکاوەکەدا بازمان دا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The horse leapt a five-foot wall.""",
                      kurdishText: """ئەسپەکە بەسەر دیوارێکی پێنج پێیدا بازی دا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He leaped clear of the water.""",
                      kurdishText: """بازی بەسەر ئاوەکەدا دا.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) جووڵان یان کردنی شتێک لەناکاو و بەخێرایی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She leapt out of bed.""",
                      kurdishText: """لە جێخەوەکە هەڵپەڕی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He leaped across the room to answer the door.""",
                      kurdishText: """بە ژوورەکەدا بۆی دەرچوو بۆ کردنەوەی دەرگاکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They leapt into action immediately.""",
                      kurdishText: """دەستبەجێ کەوتنە کارکردن.""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) زیادکردنی شتێک و بە ڕێژەیەکی زۆر"""),
                    const AlsoEnglishckb(word: "ھەروەھا: shoot up"),
                    SentencesRow(
                      englishText: """The shares leapt in value from 476p to close at 536p.""",
                      kurdishText: """پشکەکان لە نرخدا هەڵبەزین لە ٤٧٦ پێنســەوە بۆ نزیکەی ٥٣٦ پێنس.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The company saw pre-tax profits leap to £14.5 million in 2004.""",
                      kurdishText: """کۆمپانیاکە بەرزبوونەوەی قازانجی پێش باجی بۆ ١٤,٥ ملیۆن پاوەند لە ٢٠٠٤ ــدا بەخۆوە دی.""",
