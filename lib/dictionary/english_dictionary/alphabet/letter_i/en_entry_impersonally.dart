...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'JHOj7BT4kRo';
    const double startSecondsend = 2001;
    const String videoIdone = '355MEuxjcNw';
    const double startSecondsone = 694;
    const String videoIdtwo = 'Bqtq5XU5K6M';
    const double startSecondstwo = 373;
    const String videoIdthree = '5IiTMXl9-Uo';
    const double startSecondsthree = 15435;
    const String videoIdfour = 'NZ20Dx2-CIA';
    const double startSecondsfour = 48;
    const String videoIdfive = 'YDuBh7VbGgU';
