...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'umWOkozTejI';
    const double startSecondsend = 310;
    const String videoIdone = '9P1IVQJdVvE';
    const double startSecondsone = 265;
    const String videoIdtwo = 'ws-GcQ0ht1c';
    const double startSecondstwo = 1305;
    const String videoIdthree = 'gCG52EeOv38';
    const double startSecondsthree = 105;
    const String videoIdfour = 'e0Q4AOrtDd0';
    const double startSecondsfour = 677;
    const String videoIdfive = 'VZqf5rOJNCE';
    const double startSecondsfive = 1451;
