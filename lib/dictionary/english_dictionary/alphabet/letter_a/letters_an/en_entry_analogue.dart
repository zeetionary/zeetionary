                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "analogue"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈænəlɒɡ/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈænəlɔːɡ/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'Wj6pfRcC-xY';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'WmZuywqwrwc';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'b5fYocWAxi0';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'YotUW5WcOh8';
