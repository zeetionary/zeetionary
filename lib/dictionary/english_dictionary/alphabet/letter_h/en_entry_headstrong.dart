...
class EnglishEntryheadstrong extends StatefulWidget {
  const EnglishEntryheadstrong({super.key});

  @override
  State<EnglishEntryheadstrong> createState() => _EnglishEntryheadstrongState();
}

class _EnglishEntryheadstrongState extends State<EnglishEntryheadstrong> {
  @override
  void initState() {
    super.initState();
...
1. Habitually disposed to disobedience and opposition (- froward [archaic], self-willed, willful [N. Amer], wilful [Brit, Cdn])
"The relationship between the intellect and the emotions is like the relationship between parents and their headstrong five-year-old";
""",
  );

  final String keyword = "headstrong";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""headstrong""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She was a headstrong child, always getting into trouble.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """headstrong""",
                      // alsoEnglishWord: "also: headstrong",
                      britshText: """IpaUK: /ˈhedstrɒŋ/""",
                      americanText: """IpaUS: /ˈhedstrɔːŋ/""",
...
کوردی: کەللەڕەق، لاسار، سەرسەخت، کەللەڕەقانە
"""),
// With short examples define "headstrong", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کەسێک کە سوورە لەسەر ئەوەی شتەکان بە شێوازی خۆی بکات و گوێ لە کەس نەگرێت"""),
                    SentencesRow(
                      englishText:
                          """She was a headstrong child, always getting into trouble.""",
                      kurdishText:
                          """منداڵێکی کەللەڕەق بوو کە هەمیشە دەکەوتە کێشەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/mij9B0P5USI?t=';
const double _startSecondsend = 000000000000000000000000000108;
const String _videoIdone = 'https://youtu.be/380Zqbi9luo?t=';
const double _startSecondsone = 00000000000000000000000000091;
const String _videoIdtwo = 'https://youtu.be/bIvqhdoZzo8?t=';
const double _startSecondstwo = 000000000000000000000000000378;
const String _videoIdthree = 'https://youtu.be/uR3GCIjqIFs?t=';
const double _startSecondsthree = 000000000000000000000000000715;
const String _videoIdfour = 'https://youtu.be/ZMQbHMgK2rw?t=';
const double _startSecondsfour = 000000000000000000000000000409;
const String _videoIdfive = 'https://youtu.be/lswKi3SLsy8?t=';
const double _startSecondsfive = 000000000000000000000000000269;
