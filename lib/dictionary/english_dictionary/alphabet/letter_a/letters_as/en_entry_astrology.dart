...
// Define the word "astrology" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryastrology - replace speakAstrology

// replace astrology - /əˈstrɒlədʒi/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryastrology extends StatelessWidget {
  // blank divider
  EnglishEntryastrology({super.key});
  // blank divider
  ...
  Future<void> speakastrology(String languageCode) async {
    ...
    await flutterTts.speak("astrology");
  }
  ...
  Future<void> speakastrology408(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Some people still believe in astrology.");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "astrology"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈstrɒlədʒi/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈstrɑːlədʒi/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakastrology408("en-US"),
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'Tr1FHd_n2_0';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'HGsjNOOaRXg';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'AopuVtzNJo8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Eu46puWv7ts';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'YobOjiepFhc';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final double _startSeconds = 2158;
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'sfsE7w1zZKY';
