...
class EnglishEntryextraction extends StatefulWidget {
  const EnglishEntryextraction({super.key});

  @override
  State<EnglishEntryextraction> createState() => _EnglishEntryextractionState();
}

class _EnglishEntryextractionState extends State<EnglishEntryextraction> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extraction""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extraction""",
                      // alsoEnglishWord: "also: extraction",
                      britshText: """IpaUK: /ɪkˈstrækʃn/""",
                      americanText: """IpaUS: /ɪkˈstrækʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extraction";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Methods of extraction vary from mine to mine.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """Modern techniques improve the extraction of salt from the sea.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He proudly mentions he is of Irish extraction.""");
  }
...
"""),
          ...
          SentencesRow(
            ...
            kurdishText:
                """ڕێگاکانی دەرکردن لە کانێک بۆ یەکێکی دیکە دەگۆڕێت.""",
          ...
          SentencesRow(
            englishText:
                """Modern techniques improve the extraction of salt from the sea.""",
            kurdishText:
                """ڕێگا سەردەمییەکان دەرکردنی خوێ لە دەریاکانەوە باشتر دەکات.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """بە شانازییەوە باسی دەکات کە لە بنەچەی ئێرلەندییە.""",
...
const String _videoIdone = 'https://youtu.be/lGSOWwUvJiU?t=';
const double _startSecondsone = 000000000000000000000000000682;
const String _videoIdtwo = 'https://youtu.be/XMCZEJVlyRY?t=';
const double _startSecondstwo = 000000000000000000000000000133;
const String _videoIdthree = 'https://youtu.be/Unzc731iCUY?t=';
const double _startSecondsthree = 0000000000000000000000000001976;
const String _videoIdfour = 'https://youtu.be/L6P3nI6VnlY?t=';
const double _startSecondsfour = 00000000000000000000000000022;
const String _videoIdfive = 'https://youtu.be/KT18KJouHWg?t=';
const double _startSecondsfive = 000000000000000000000000000378;
