...
// replace these: replace EnglishEntryalms - replace speakAlms - replace alms - /ɑːmz/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryalms extends StatelessWidget {
  EnglishEntryalms({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAlms(String languageCode) async {
    // DOPSUM: CHANGE speakAlms
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("alms"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAlms4266(String languageCode) async {
    ...
    await flutterTts.speak(
        "In the past, people thought it was their religious duty to give alms to the poor."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "alms"), // DOPSUM: CHANGE WORD ENTRY - Find /ɑːmz/
                            // nothing heereee
                        ...
                        Row(
                          children: [
                            ...
                            CustomIconButtonBritish(
                              onPressed: () =>
                                  speakAlms(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              "IpaUS: /ɑːmz/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'elarLmuDtzU';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'RKUNOvgM0Y4';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'hYE5Lipyh_Q';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = '6L1CHVxJ0yY';
