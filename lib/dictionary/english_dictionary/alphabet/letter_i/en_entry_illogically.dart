...
class EnglishEntryillogically extends StatefulWidget {
  const EnglishEntryillogically({super.key});

  @override
  State<EnglishEntryillogically> createState() =>
      _EnglishEntryillogicallyState();
}

class _EnglishEntryillogicallyState extends State<EnglishEntryillogically> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "illogically";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""illogically""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She felt illogically happy when she heard the news.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Rxh_SVtyZqo?t=';
    const double startSecondsend = 0000000000000000000000000009531;
    const String videoIdone = 'https://youtu.be/-zWKNydgmAY?t=';
    const double startSecondsone = 000000000000000000000000000611;
    const String videoIdtwo = 'https://youtu.be/aB5jponXG-w?t=';
    const double startSecondstwo = 0000000000000000000000000001142;
    const String videoIdthree = 'https://youtu.be/zIAUJIT2lZY?t=';
    const double startSecondsthree = 000000000000000000000000000479;
    const String videoIdfour = 'https://youtu.be/agr47RJRMIo?t=';
    const double startSecondsfour = 00000000000000000000000000086;
    const String videoIdfive = 'https://youtu.be/ysf-5MdWDt0?t=';
    const double startSecondsfive = 0000000000000000000000000003321;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """illogically""",
                      // alsoEnglishWord: "also: illogically",
                      britshText: """IpaUK: /ɪˈlɒdʒɪkli/""",
                      americanText: """IpaUS: /ɪˈlɑːdʒɪkli/""",
...
کوردی: بە شێوەیەکی نالۆژیکی یان ناژیرانە، نالۆژیکانە
"""),
// With short examples define "illogically", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) لەبەر هۆکارێک کە عاقڵانی نییە"""),
                    SentencesRow(
                      englishText:
                          """She felt illogically happy when she heard the news.""",
                      kurdishText:
                          """نالۆژیکانە دڵخۆش بوو کە هەواڵەکەی بیست.""",
                      englishNote:
                          """This means she felt happy in a way that didn’t make sense or wasn’t reasonable after receiving the news.""",
