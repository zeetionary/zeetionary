...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'https://youtu.be/BxWw8AO4ZmI?t=';
    const double startSecondstwo = 000000000000000000000000000211;
    const String videoIdthree = 'https://youtu.be/juK9c8zgUvU?t=';
    const double startSecondsthree = 000000000000000000000000000549;
    const String videoIdfour = 'https://youtu.be/WLeUt-jBE4Y?t=';
    const double startSecondsfour = 00000000000000000000000000014;
    const String videoIdfive = 'https://youtu.be/UeUPILGGIls?t=';
    const double startSecondsfive = 0000000000000000000000000001435;
