...
// replace these: replace EnglishEntryairraid - replace speakAirraid - replace air raid - /ˈeə reɪd/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryairraid extends StatelessWidget {
  EnglishEntryairraid({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakairraid(String languageCode) async {
    // DOPSUM: CHANGE speakAirraid
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("air raid");
  }

  Future<void> speakairraid5377(String languageCode) async {
    // DOPSUM: CHANGE speakAirraid
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The family was killed in an air raid.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈeə reɪd/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈer reɪd/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'qyoUv-r43H4';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'd9tA1icDPGY';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'Lnd6gd_9NMw';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'PQ8m5R76COo';
