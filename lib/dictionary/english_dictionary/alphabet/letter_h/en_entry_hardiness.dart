...
class EnglishEntryhardiness extends StatefulWidget {
  const EnglishEntryhardiness({super.key});

  @override
  State<EnglishEntryhardiness> createState() => _EnglishEntryhardinessState();
}

class _EnglishEntryhardinessState extends State<EnglishEntryhardiness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hardiness
1. The property of being strong and healthy in constitution (- robustness, lustiness)
 
2. The trait of being willing to undertake things that involve risk or danger (- boldness, daring, hardihood)
"the plan required great hardiness of heart";
""",
  );

  final String keyword = "hardiness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hardiness""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hardiness""",
                      // alsoEnglishWord: "also: hardiness",
                      britshText: """IpaUK: /ˈhɑːdinəs/""",
                      americanText: """IpaUS: /ˈhɑːrdinəs/""",
...
// With short examples define "hardiness", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The people here are known for their hardiness and courage.""",
                      kurdishText:
                          """خەڵکەکە بۆ جەربەزەیی و بوێرییان ناسراون.""",
