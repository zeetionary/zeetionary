...
class EnglishEntryindoctrination extends StatefulWidget {
  ...
  @override
  State<EnglishEntryindoctrination> createState() => _EnglishEntryindoctrinationState();
}

class _EnglishEntryindoctrinationState extends State<EnglishEntryindoctrination> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryindoctrination indoctrination
WORD_WEB indoctrination indoctrination indoctrination
haʊʊʊʊʊʊʊ4
""",
  );
