...
class EnglishEntrygrandparent extends StatefulWidget {
  const EnglishEntrygrandparent({super.key});

  @override
  State<EnglishEntrygrandparent> createState() =>
      _EnglishEntrygrandparentState();
}

class _EnglishEntrygrandparentState extends State<EnglishEntrygrandparent> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grandparent (Derived forms: grandparents)
1. A parent of your father or mother
""",
  );

  final String keyword = "grandparent";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grandparent""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The children are staying with their grandparents.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grandparent""",
                      // alsoEnglishWord: "also: grandparent",
                      britshText: """IpaUK: /ˈɡrænpeərənt/""",
                      americanText: """IpaUS: /ˈɡrænperənt/""",
...
// With short examples define "grandparent", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """منداڵەکان لەگەڵ باوانیان دەمێننەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I’ve sent photos of the children to both sets of grandparents.""",
                      kurdishText:
                          """وێنەی منداڵەکانم ناردووە بۆ هەر یەک لە باوانیان (= باوان لە دایک و باوکەوە).""",
...
const String _videoIdone = 'https://youtu.be/2RtC3Cb5PN8?t=';
const double _startSecondsone = 00000000000000000000000000015;
const String _videoIdtwo = 'https://youtu.be/npZF5gJHhZM?t=';
const double _startSecondstwo = 000000000000000000000000000273;
const String _videoIdthree = 'https://youtu.be/mfZ39ReYuRE?t=';
const double _startSecondsthree = 000000000000000000000000000134;
const String _videoIdfour = 'https://youtu.be/fP12BcpOAOA?t=';
const double _startSecondsfour = 0000000000000000000000000008;
const String _videoIdfive = 'https://youtu.be/MyxDlshRQRE?t=';
