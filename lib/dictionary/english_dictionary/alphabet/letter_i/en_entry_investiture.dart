...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'h3fKFocGkkk';
    const double startSecondsend = 295;
    const String videoIdone = 'Cln0J87vulU';
    const double startSecondsone = 600;
    const String videoIdtwo = '6NB91zHe7UU';
    const double startSecondstwo = 1058;
    const String videoIdthree = 'vtem1jDziL0';
    const double startSecondsthree = 197;
    const String videoIdfour = 'EZbzCp8HtRQ';
    const double startSecondsfour = 37;
    const String videoIdfive = 'O9GvZhDC9CM';
    const double startSecondsfive = 707;
