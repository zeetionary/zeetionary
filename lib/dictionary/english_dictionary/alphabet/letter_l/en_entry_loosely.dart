...
class EnglishEntryloosely extends StatefulWidget {
  const EnglishEntryloosely({super.key});

  @override
  State<EnglishEntryloosely> createState() => _EnglishEntrylooselyState();
}

class _EnglishEntrylooselyState extends State<EnglishEntryloosely> {
  @override
  void initState() {
    super.initState();
...
3. Without regard to specific details or exceptions (- broadly, broadly speaking, generally, generically)
"he interprets the law loosely";
 
4. Structurally open and not compact or close
"loosely knit"; "loosely woven cloth"; "loosely structured organization"
 
5. (of quantities) imprecise but fairly close to correct (- approximately, about, close to, just about, some, roughly, more or less, around, or so)
"lasted loosely an hour";
""",
  );

  final String keyword = "loosely";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""loosely""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She fastened the belt loosely around her waist.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The play is loosely based on his childhood in Russia.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The two problems are only loosely related.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/fn--IVarumw?t=1100';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/58XEfDtU0Z4?t=215';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/yCdbHiVPYwI?t=1050';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/nJ-ehbVQYxI?t=447';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/SwQhKFMxmDY?t=3659';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/dRLCZqEfJFA?t=85';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """loosely""",
                      // alsoEnglishWord: "also: loosely",
                      britshText: """IpaUK: /ˈluːsli/""",
                      americanText: """IpaUS: /ˈluːsli/""",
...
کوردی: شل، بە شێوەیەکی هەراو، دەڵبانە، بە شێوەیەکی شل(وشەوێق)،	سەرسەرەکی‌یانە، بە شێوەیێکی سەرسەرەکی (یان فشە)، بە بێ‌وردبوونەوە، بە بێ‌سەرنجی زۆرەوە، نە بە تەواوی، کەم‌تاکورتێ، تا ئەندازەیێ
"""),
// With short examples define "loosely", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵکار) کە توند یان بەهێز نییە"""),
                    SentencesRow(
                      englishText: """She fastened the belt loosely around her waist.""",
                      kurdishText: """قایشەکەی بە هێواشی لە کەمەری بەست.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵکار) بە شێوەیەک کە تەواو درووست نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The play is loosely based on his childhood in Russia.""",
                      kurdishText: """شانۆیەکە کەمێک پشتی بەستووە بە منداڵییەتیی لە ڕووسیا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The two problems are only loosely related.""",
                      kurdishText: """دوو کێشەکە کەمێک پێکەوە گرێدراون.""",
