...
class EnglishEntryfiftyfifty extends StatefulWidget {
  const EnglishEntryfiftyfifty({super.key});

  @override
  State<EnglishEntryfiftyfifty> createState() => _EnglishEntryfiftyfiftyState();
}

class _EnglishEntryfiftyfiftyState extends State<EnglishEntryfiftyfifty> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fifty-fifty
1. Equal in degree or extent or amount; or equally matched or balanced (= even)
"it was a fifty-fifty split"; "had a fifty-fifty chance";
""",
  );

  final String keyword = "fifty-fifty";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fifty-fifty""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Let's split this fifty-fifty.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fifty-fifty""",
                      // alsoEnglishWord: "also: fifty-fifty",
                      britshText: """IpaUK: /ˌfɪfti ˈfɪfti/""",
                      americanText: """IpaUS: /ˌfɪfti ˈfɪfti/""",
...
کوردی: 
"""),
// With short examples define "fifty-fifty", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو، ھاوەڵکار) کە بە یەکسانی دابەش دەکرێت لە نێوان دوو کەس، گرووپ، یان ئەگەر"""),
                    SentencesRow(
                      englishText:
                          """Costs are to be shared on a fifty-fifty basis between the government and local businesses.""",
                      kurdishText:
                          """تێچووەکان لەسەر بنەمای پەنجا بە پەنجا خەرج دەکرێن لەلایەن حکومەت و بازرگانییە خۆجێییەکان.""",
                    ...
                    SentencesRow(
                      englishText: """Let's split this fifty-fifty.""",
                      kurdishText: """با ئەمە پەنجا بە پەنجا دابەش بکەیت.""",
...
const String _videoIdend = 'https://youtu.be/4XCtX7H6L2U?t=';
const double _startSecondsend = 000000000000000000000000000775;
const String _videoIdone = 'https://youtu.be/P7wfHk5rZ4k?t=';
const double _startSecondsone = 00000000000000000000000000041;
const String _videoIdtwo = 'https://youtu.be/ppX7Qjbe6BM?t=';
const double _startSecondstwo = 0000000000000000000000000001030;
const String _videoIdthree = 'https://youtu.be/BMf5--QPyNw?t=';
const double _startSecondsthree = 00000000000000000000000000012;
const String _videoIdfour = 'https://youtu.be/SLD-kBdr-PM?t=';
const double _startSecondsfour = 000000000000000000000000000238;
const String _videoIdfive = 'https://youtu.be/i3diNx1fV7E?t=';
const double _startSecondsfive = 000000000000000000000000000822;
