...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'pNTabwioBYM';
    const double startSecondsend = 311;
    const String videoIdone = 'x-QcbOphxYs';
    const double startSecondsone = 513;
    const String videoIdtwo = '7wZUvZJgD4A';
    const double startSecondstwo = 554;
    const String videoIdthree = 'hW9DgwTgWwE';
    const double startSecondsthree = 1563;
    const String videoIdfour = 'kVrNmOmGB6c';
    const double startSecondsfour = 1309;
    const String videoIdfive = 'JAhdb7dKQpU';
