...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'ha2mLz-Xdpg';
    const double startSecondsend = 1279;
    const String videoIdone = '29n2bv7F6uc';
    const double startSecondsone = 1695;
    const String videoIdtwo = 'YyFhQ525tZk';
    const double startSecondstwo = 181;
    const String videoIdthree = 'oeyt2zVqCG8';
    const double startSecondsthree = 584;
    const String videoIdfour = 'GIubKygOjSw';
    const double startSecondsfour = 668;
