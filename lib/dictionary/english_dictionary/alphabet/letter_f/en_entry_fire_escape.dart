...
class EnglishEntryfireescape extends StatefulWidget {
  const EnglishEntryfireescape({super.key});

  @override
  State<EnglishEntryfireescape> createState() => _EnglishEntryfireescapeState();
}

class _EnglishEntryfireescapeState extends State<EnglishEntryfireescape> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fire escape""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The thief got away down the fire escape.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fire escape""",
                      // alsoEnglishWord: "also: fire escape",
                      britshText: """IpaUK: /ˈfaɪər ɪskeɪp/""",
                      americanText: """IpaUS: /ˈfaɪər ɪskeɪp/""",
...
// With short examples define "fire escape", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دزەکە بە پەیژەی هەڵهاتنەکە ڕایکرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/VIRELnXmAgg?t=';
const double _startSecondsend = 000000000000000000000000000248;
const String _videoIdone = 'https://youtu.be/MFEu2yVqWno?t=';
const double _startSecondsone = 00000000000000000000000000084;
const String _videoIdtwo = 'https://youtu.be/kUMQ-bRxOjw?t=';
const double _startSecondstwo = 000000000000000000000000000489;
const String _videoIdthree = 'https://youtu.be/SfsCniN7Nsc?t=';
const double _startSecondsthree = 000000000000000000000000000287;
const String _videoIdfour = 'https://youtu.be/MyeMnJABCeg?t=';
const double _startSecondsfour = 0000000000000000000000000001281;
const String _videoIdfive = 'https://youtu.be/4SveqdXlu88?t=';
