...
class EnglishEntryfurrow extends StatefulWidget {
  const EnglishEntryfurrow({super.key});

  @override
  State<EnglishEntryfurrow> createState() => _EnglishEntryfurrowState();
}

class _EnglishEntryfurrowState extends State<EnglishEntryfurrow> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: furrow (Derived forms: furrows)
1. A long shallow trench in the ground (especially one made by a plough)
 
2. A slight depression or fold in the smoothness of a surface (- wrinkle, crease, crinkle, seam, line)

- Verb: furrow (Derived forms: furrowed, furrows, furrowing)
1. Hollow out in the form of a furrow or groove (- rut, groove)
"furrow soil";
 
2. Make wrinkled or creased (- wrinkle, crease)
"furrow one's brow";
 
3. Cut a furrow into columns (- chamfer, chase)
""",
  );

  final String keyword = "furrow";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Water lay in the furrows of the ploughed fields.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The pain of the headache made him furrow his brow.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The wheels of the heavy tractor furrowed the soft ground.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furrow""",
                      // alsoEnglishWord: "also: furrow",
                      britshText: """IpaUK: /ˈfʌrəʊ/""",
                      americanText: """IpaUS: /ˈfɜːrəʊ/""",
...
کوردی: هێڵ، کووز، خیچ، خەت، گڤاند، لوژنا (کیلەفڕ: هێڵی جووتی لێک‌دوور)،	(ناوچاوان) گنجی، لۆچی، چرچی،	کەردوو، دێراو، بۆ،	زەوی کێڵراوە، شێوەرد، شێوبڕاو، کێڵگە،	ڕێڕەوی کەشتی، ڕێگای کەشتی
"""),
// With short examples define "furrow", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هێڵێکی درێژ لە زەویدا، بە تایبەتی کە بە کێڵان درووست بووە بۆ ناشتنی تۆو تێیدا بەکاردێت"""),
                    SentencesRow(
                      englishText:
                          """Water lay in the furrows of the ploughed fields.""",
                      kurdishText: """ئاو لە هێڵی شێوەردەکەدا کۆبووەتەوە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) هێڵێکی قووڵ لە پێستی ڕووخسار"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Suddenly he looked tired and there were deep furrows in his brow.""",
                      kurdishText:
                          """لەناکاو ماندوو دیاربوو و لۆچی قووڵ لە برۆیدا بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئازاری سەرێشەکە وایکرد برۆیەکانی گرژ بکات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (کردار) درووستکردنی هێڵێکی درێژ لەسەر ڕوویەک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The wheels of the heavy tractor furrowed the soft ground.""",
                      kurdishText:
                          """ویلەکانی تراکتۆرە قورسەکە زەوییە نەرمەکەی خەت خەت کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Ir3eJ1t13fk?t=';
const double _startSecondsend = 0000000000000000000000000001188;
const String _videoIdone = 'https://youtu.be/f2kEGj-S1Tc?t=';
const double _startSecondsone = 000000000000000000000000000125;
const String _videoIdtwo = 'https://youtu.be/9ttxmg2nBOQ?t=';
const double _startSecondstwo = 0000000000000000000000000001276;
const String _videoIdthree = 'https://youtu.be/3iyk8TOlOUo?t=';
const double _startSecondsthree = 000000000000000000000000000735;
const String _videoIdfour = 'https://youtu.be/q43WY5XgSFY?t=';
const double _startSecondsfour = 000000000000000000000000000642;
const String _videoIdfive = 'https://youtu.be/SzzVbWKMmZ0?t=';
const double _startSecondsfive = 000000000000000000000000000619;
