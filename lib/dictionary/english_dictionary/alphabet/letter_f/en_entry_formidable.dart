...
class EnglishEntryformidable extends StatefulWidget {
  const EnglishEntryformidable({super.key});

  @override
  State<EnglishEntryformidable> createState() => _EnglishEntryformidableState();
}

class _EnglishEntryformidableState extends State<EnglishEntryformidable> {
  @override
  void initState() {
    super.initState();
...
2. Inspiring fear (= redoubtable, unnerving, doubtable [archaic])
"the formidable prospect of major surgery";
""",
  );

  final String keyword = "formidable";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""formidable""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The task was a formidable one.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They had to overcome formidable obstacles.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""In debate he was a formidable opponent.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """formidable""",
                      // alsoEnglishWord: "also: formidable",
                      britshText: """IpaUK: /fəˈmɪdəbl/,  /ˈfɔːmɪdəbl/""",
                      americanText: """IpaUS: /ˈfɔːrmɪdəbl/,  /fərˈmɪdəbl/""",
...
کوردی: ترسێنەر، تۆقێنەر، ورەبەر، نگران‌کەر، بەسام، بەهەیبەت، بەئەندێش،	سەخت، گران، دژوار، زەحمەت، چەتوون،	(دوژمن) بەهێز، تۆکمە، لەشکان‌نەهاتوو، سەرسەخت،	(قەرز) قورس، زۆر
"""),
// With short examples define "formidable", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) شتێک، کەسێک، یان دۆخێک کە ترس و ڕێزت بۆی هەیە بەهۆی ئەوەی کە ناوازە یان بەهێزن، یان بەهۆی ئەوەی سەخت دیارن"""),
                    SentencesRow(
                      englishText: """The task was a formidable one.""",
                      kurdishText: """ئەرکەکە دانەیەکی سەخت بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەبوو بەسەر کۆسپی دژواردا زاڵ بن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە دیبەیتدا ڕکابەر سەرسەخت بوو.""",
...
const String _videoIdtwo = 'https://youtu.be/H7Quhnm-Z8A';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/viOpP6P_PrQ';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/LQpLMvC7Et0?t=';
const double _startSecondsfour = 000000000000000000000000000455;
const String _videoIdfive = 'https://youtu.be/Z83I2tz5UzM?t=';
const double _startSecondsfive = 000000000000000000000000000151;
