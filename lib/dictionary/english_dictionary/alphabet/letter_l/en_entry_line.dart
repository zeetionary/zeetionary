...
class EnglishEntryline extends StatefulWidget {
  const EnglishEntryline({super.key});

  @override
  State<EnglishEntryline> createState() => _EnglishEntrylineState();
}

class _EnglishEntrylineState extends State<EnglishEntryline> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: line (Derived forms: lines)
1. A mark that is long relative to its width
"He drew a line on the chart"
 
2. A formation of people or things one beside another
...
8. A course of reasoning aimed at demonstrating a truth or falsehood; the methodical process of logical reasoning (- argumentation, logical argument, argument, line of reasoning)
"I can't follow your line of reasoning";
 
9. A conductor for transmitting electrical or optical signals or electric power (- cable, transmission line)
 
10. A connected series of events, actions or developments (- course)
"historians can only point out those lines for which evidence is available";
 
11. A spatial location defined by a real or imaginary unidimensional extent
 
12. A slight depression or fold in the smoothness of a surface (- wrinkle, furrow, crease, crinkle, seam)
"his face has many lines";
 
13. A pipe used to transport liquids or gases (- pipeline)
"a line runs from the wells to the seaport";
 
14. The road consisting of railway track and roadbed (- railway line [Brit, Cdn], rail line, railroad line [N. Amer])
 
15. A telephone connection (- telephone line, phone line, telephone circuit, subscriber line)
 
16. Acting in conformity
"in line with"; "he got out of line"; "toe the line"
 
17. The hereditary derivation of an individual (- lineage, line of descent, descent, bloodline, blood line, blood, pedigree, ancestry, origin, parentage, stemma, stock)
"his entire line has been warriors";
 
18. Something (as a cord or rope) that is long and thin and flexible
"a washing line"
 
19. What someone normally does to earn money; a person's profession, work, or trade (- occupation, business, job, line of work)
"he's not in my line of business";
 
20. In games or sports; a mark indicating positions or bounds of the playing area
 
21. (often plural) a means of communication or access (- channel, communication channel)
...
26. A succession of notes forming a distinctive sequence (- tune, melody, air, strain, melodic line, melodic phrase)
...
29. A conceptual separation or distinction (- dividing line, demarcation, contrast)
"there is a narrow line between sanity and insanity";
 
30. Mechanical system in a factory whereby an article is conveyed through sites at which successive operations are performed on it (- production line, assembly line)
 
31. [N. Amer] A line of people or vehicles waiting for something (- queue, waiting line [N. Amer])
 
32. [slang] Powdered narcotic laid out in a line for snorting
"snort a line"

- Verb: line (Derived forms: lining, lined, lines)
...
3. Make a mark or lines on a surface (- trace, draw, describe, delineate)
"draw a line";
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He wrote the title and drew a line under it.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She could draw a perfectly straight line.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A red line marks where the wall stood.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The first to cross the line wins the race.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The ball was over the line.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He has fine lines around his eyes.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'm starting to get lines around my mouth.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They formed a line and marched forward.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The children all stood in a line.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They were stuck in a line of traffic.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""If you want a ticket, get in line.""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There's a line for the women's bathroom.""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The lunch line was long as usual.""");
  }
  ...
  Future<void> speaksentence18(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I tried to call but the line was busy.""");
  }
  ...
  Future<void> speaksentence23(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Just keep going in a straight line.""");
  }
  ...
  Future<void> speaksentence27(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Look at line 5 of the text.""");
  }
  ...
  Future<void> speaksentence30(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She quoted a few lines of Shakespeare.""");
  }
  ...
  Future<void> speaksentence32(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I keep forgetting my lines.""");
  }
  ...
  Future<void> speaksentence33(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The way she delivers the line is hilarious.""");
  }
  ...
  Future<void> speaksentence34(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The film includes some great lines.""");
  }
  ...
  Future<void> speaksentence36(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The teacher gave me 100 lines.""");
  }
  ...
  Future<void> speaksentence38(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Towels were hanging on the line.""");
  }
  ...
  Future<void> speaksentence39(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He had a fish on his line.""");
  }
  ...
  Future<void> speaksentence40(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Get the clothes off the line.""");
  }
  ...
  Future<void> speaksentence51(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His research follows quite different lines.""");
  }
  ...
  Future<void> speaksentence53(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She came from a long line of doctors.""");
  }
  ...
  Future<void> speaksentence56(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Orders came down the line from the very top.""");
  }
  ...
  Future<void> speaksentence58(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She lines the drawers with old wallpaper.""");
  }
  ...
  Future<void> speaksentence59(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I lined the sides of the box with black card.""");
  }
  ...
  Future<void> speaksentence60(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I lined the curtains with heavy cotton.""");
  }
  ...
  Future<void> speaksentence61(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""White tiles line the walls.""");
  }
  ...
  Future<void> speaksentence62(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Crowds lined the streets to watch the race.""");
  }
  ...
  Future<void> speaksentence63(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Trees line the road on both sides.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/zsDK94sZpXM?t=1065';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/2vjWxyJtUdo?t=85';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/KYEP1OgoNGM?t=387';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/ojTdYiBRtdU?t=169';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/qmjeUnkUwnw?t=862';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/w0a07NySt6I?t=2';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """line""",
                      // alsoEnglishWord: "also: line",
                      britshText: """IpaUK: /laɪn/""",
                      americanText: """IpaUS: /laɪn/""",
...
کوردی: هێڵ، کێڕ، خیچ، خەت، کێشە، زاخ، ڕایەڵ، میل،	هێڵی تەلەفون،	ڕێی ئاسن، ڕەیل، هێڵی ئاسن، هێڵی پشتێنە (ی زەوی)،	لوولە، بۆڕی،	هێڵی کۆتایی،	هێڵی بەرگری، سپای پیادە، هێزەکانی شەڕ،	پەت، گوریس، تەناف، کەندر،	دەزووی ڕاوەماسی
،	هێڵ، دێڕ، ڕێز،	(هەڵبەست) خشتە، دێڕ، لادێڕ،	هێڵی جیاکەرەوە،	ڕیز،	ڕیزەچادر، ڕێزەرەشماڵ، ڕەچەڵەک، بنەچە، ڕەگەز، تۆمەرە، زنجیرە، قەتارە، لیزگە، جەلە، خێزەرە،	کەوشەن، بەستە، سنوور، تخوب، سەرحەد،	ڕێڕەو، ڕێچکە، ڕێگا، لایەن، لا،	نفش، چەشن، ئاوا، جۆر (بەرهەمێ)،	پیشە، کار، ئیش،	نامە (کورت)،	(دەم‌وچاو و دەست) گنجی، چین، چرچی،	(کارداری) ماڵ، بابەت، بەرهەم، (ئەکتەر) دەق، دیالۆگ
"""),
// With short examples define "line", please follow LX instructions
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The ball was over the line.""",
                      kurdishText: """تۆپەکە لەسەر خەتەکە بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هێڵی بچووکی لە تەنیشت چاوی هەیە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The children all stood in a line.""",
                      kurdishText: """منداڵەکان هەموویان لە ڕیزێکدا وەستان.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They were stuck in a line of traffic.""",
                      kurdishText: """لە ڕیزێکی هاتووچۆدا گیریان خوارد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەگەر بلیتت دەوێت، بچۆ ڕیزەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The lunch line was long as usual.""",
                      kurdishText: """وەک هەمیشە ڕیزی نانی نیوەڕۆ درێژ بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تەنها بە هێڵێکی ڕاست بچۆ.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """سەیری ڕیزی پێنجی نووسینەکە بکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She quoted a few lines of Shakespeare.""",
                      kurdishText: """چەند دێڕێکی شکسپیری باسکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بەردەوام دێڕەکانمم بیر دەچێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The film includes some great lines.""",
                      kurdishText: """فیکمەکە چەند قسەیەکی مەزنی تێدایە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """مامۆستاکە ١٠٠ جار نووسینەوەی پێمدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He had a fish on his line.""",
                      kurdishText: """ماسییەک بە قولابەکەیەوە بوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Get the clothes off the line.""",
                      kurdishText: """جلەکان لە تەنافەکە بکەرەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە بنەماڵەیەکی دکتۆرییەوە هاتووە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کاشیی سپی دیوارەکان پێکدێنن.""",
