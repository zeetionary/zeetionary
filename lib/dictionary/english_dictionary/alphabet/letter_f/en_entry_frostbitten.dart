...
class EnglishEntryfrostbitten extends StatefulWidget {
  const EnglishEntryfrostbitten({super.key});

  @override
  State<EnglishEntryfrostbitten> createState() =>
      _EnglishEntryfrostbittenState();
}

class _EnglishEntryfrostbittenState extends State<EnglishEntryfrostbitten> {
  @override
  void initState() {
    super.initState();
...
"frostbitten fingers"; "frostbitten grapes unsalable as fresh fruit"
""",
  );

  final String keyword = "frostbitten";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frostbitten""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """When parts of the body are frostbitten, they become pale and blistered.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frostbitten""",
                      // alsoEnglishWord: "also: frostbitten",
                      britshText: """IpaUK: /ˈfrɒstbɪtn/""",
                      americanText: """IpaUS: /ˈfrɔːstbɪtn/""",
...
// With short examples define "frostbitten", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە بەشيکانی جەستە زیانیان پێگەشتووە بەهۆی سەرمای زۆر ساردەوە"""),
                    SentencesRow(
                      englishText:
                          """When parts of the body are frostbitten, they become pale and blistered.""",
                      kurdishText:
                          """کە بەشەکانی جەستە سەرمابردوو دەبن، ڕەنگپەڕیو و هەڵتۆقیو دەبن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/hCsPV0eiqxg?t=';
const double _startSecondsend = 000000000000000000000000000716;
const String _videoIdone = 'https://youtu.be/Gs26bZTRkdU?t=';
...
const String _videoIdthree = 'https://youtu.be/OqaBSyE3K3E?t=';
const double _startSecondsthree = 000000000000000000000000000436;
const String _videoIdfour = 'https://youtu.be/xvnOmDQ3bvc?t=';
const double _startSecondsfour = 0000000000000000000000000004857;
const String _videoIdfive = 'https://youtu.be/Pd6E38FfuMg?t=';
const double _startSecondsfive = 000000000000000000000000000756;
