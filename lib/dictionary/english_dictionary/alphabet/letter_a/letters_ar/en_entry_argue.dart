...
class EnglishEntryargue extends StatelessWidget {
  ...
  Future<void> speakargue957(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("My brothers are always arguing.");
  }
  ...
  Future<void> speakargue958(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I know it was a stupid thing to argue about.");
  }
  ...
  Future<void> speakargue1000(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("They argued for the right to strike.");
  }
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'kFBos5m5odU';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'eQKSx-iy0c0';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'Olh06CcNAsk';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'N0OnaALCWtE';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'yXkJp-YpEFA';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'wsGTLuy-7C4';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'vGmAtudQhWA';
  final double _startSeconds = 1;
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = '1ldko5MhsMA';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'b_U9NckZIR4';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = '7uCoMglUDKI';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'AGihRfenfOA';
  final double _startSeconds = 1;
