...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/pFEB0chiuJA?t=';
    const double startSecondsend = 00000000000000000000000000057;
    const String videoIdone = 'https://youtu.be/dtp6b76pMak?t=';
    const double startSecondsone = 000000000000000000000000000379;
    const String videoIdtwo = 'https://youtu.be/EIEwy8rPik4?t=';
    const double startSecondstwo = 00000000000000000000000000021;
    const String videoIdthree = 'https://youtu.be/nn8zfDv3EbA?t=';
    const double startSecondsthree = 000000000000000000000000000328;
    const String videoIdfour = 'https://youtu.be/DxL2HoqLbyA?t=';
    const double startSecondsfour = 000000000000000000000000000363;
    const String videoIdfive = 'https://youtu.be/9yjZpBq1XBE?t=';
    const double startSecondsfive = 0000000000000000000000000002009;
