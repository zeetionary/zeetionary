...
class EnglishEntryachieve extends StatefulWidget {
  const EnglishEntryachieve({super.key});

  @override
  State<EnglishEntryachieve> createState() => _EnglishEntryachieveState();
}

class _EnglishEntryachieveState extends State<EnglishEntryachieve> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """achieve""",
                      // alsoEnglishWord: "also: achieve",
                      britshText: """IpaUK: /əˈtʃiːv/""",
                      americanText: """IpaUS: /əˈtʃiːv/""",
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'IOYfmDbiKBQ';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'EnWiGYT1g4';
