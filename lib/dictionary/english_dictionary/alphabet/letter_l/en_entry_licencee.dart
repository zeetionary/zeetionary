...
class EnglishEntrylicencee extends StatefulWidget {
  const EnglishEntrylicencee({super.key});

  @override
  State<EnglishEntrylicencee> createState() => _EnglishEntrylicenceeState();
}

class _EnglishEntrylicenceeState extends State<EnglishEntrylicencee> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""licencee""");
  }
