...
class EnglishEntrylens extends StatefulWidget {
  const EnglishEntrylens({super.key});

  @override
  State<EnglishEntrylens> createState() => _EnglishEntrylensState();
}

class _EnglishEntrylensState extends State<EnglishEntrylens> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lens (Derived forms: lenses)
1. A transparent optical device used to converge or diverge transmitted light and to form images (- lense [non-standard], lens system)
 
2. (metaphor) a channel through which something can be seen or understood
"the writer is the lens through which history can be seen"
 
3. Biconvex transparent body situated behind the iris in the eye; its role (along with the cornea) is to focus light on the retina (- crystalline lens, lens of the eye)
 
4. Electronic equipment that uses a magnetic or electric field in order to focus a beam of electrons (- electron lens)

- Verb: lens (Derived forms: lensing, lenses, lensed)
1. Cause light to bend, as with a lens
"the glass lensed the light"

- Noun: Lens
1. Genus of small erect or climbing herbs with pinnate leaves and small inconspicuous white flowers and small flattened pods: lentils (- genus Lens)
""",
  );

  final String keyword = "lens";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Put your hand in front of your right lens and just look through your left lens.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She wears glasses with very thick lenses.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This is a view of Mount Kilimanjaro as seen through Eddie's camera lens.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/Um7pMggPnug?t=2';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/mlSRMQCnY1g?t=300';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/DfSnHyIryeY?t=8';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/_a8u4949t_k?t=530';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/toVfvRhWbj8';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/H6Jd149IVSY?t=48';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lens""",
                      // alsoEnglishWord: "also: lens",
                      britshText: """IpaUK: /lenz/""",
                      americanText: """IpaUS: /lenz/""",
...
کوردی: نیسکۆلکە، نیسکۆڵە، نیسکەڵە، هاوێنە، لێنز
"""),
// With short examples define "lens", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) پارچە شووشێکی چەماوە کە شت گەورە، بچووک، یان ڕوون دەکاتەوە کە سەیری دەکەیت"""),
                    SentencesRow(
                      englishText: """Put your hand in front of your right lens and just look through your left lens.""",
                      kurdishText: """دەستت بخە پێش هاوێنەی ڕاست و تەنها لە هاوێنەی چەپەوە سەیر بکە.""",
                    ...
                    SentencesRow(
                      englishText: """She wears glasses with very thick lenses.""",
                      kurdishText: """چاویلکەی هاوێنە ئەستوور لەچاو دەکات.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) بەشێک کە سەر بە کامێرایەکە و یان لێنز یان زیاتری پێوەیە """),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """This is a view of Mount Kilimanjaro as seen through Eddie's camera lens.""",
                      kurdishText: """ئەمە دیمەنی چیای کلیمنجاڕۆیە کە لە لێنزی کامێرای ئێدییەوە دەبینرێت.""",
                    ...
                    linkText: "contact lens",
                    textAfterLink: "",
                    onTap: () {
                    Routemaster.of(context).push("/english-lens/contactlens");
                    },
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """ژممر. (ناو) پننسە"""),
