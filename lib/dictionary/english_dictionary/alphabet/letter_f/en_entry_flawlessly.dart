...
class EnglishEntryflawlessly extends StatefulWidget {
  const EnglishEntryflawlessly({super.key});

  @override
  State<EnglishEntryflawlessly> createState() => _EnglishEntryflawlesslyState();
}

class _EnglishEntryflawlesslyState extends State<EnglishEntryflawlessly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: flawlessly
1. Smoothly and without difficulty; precisely and deftly (= cleanly)
"the gymnast landed flawlessly";
""",
  );

  final String keyword = "flawlessly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flawlessly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The system works flawlessly.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The spacecraft performed flawlessly.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flawlessly""",
                      // alsoEnglishWord: "also: flawlessly",
                      britshText: """IpaUK: /ˈflɔːləsli/""",
                      americanText: """IpaUS: /ˈflɔːləsli/""",
...
کوردی: بێ‌خەوشانە، بێ‌گەردانە
"""),
// With short examples define "flawlessly", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The spacecraft performed flawlessly.""",
                      kurdishText:
                          """کەشتییە ئاسمانییەکە بێ‌خەوشانە کاری کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/xXvgT-AgLAo?t=';
const double _startSecondsend = 00000000000000000000000000034;
const String _videoIdone = 'https://youtu.be/VrKW58MS12g?t=';
const double _startSecondsone = 000000000000000000000000000182;
const String _videoIdtwo = 'https://youtu.be/aa_tCzIMJjE?t=';
const double _startSecondstwo = 000000000000000000000000000383;
const String _videoIdthree = 'https://youtu.be/MEE9n04g7j4?t=';
const double _startSecondsthree = 000000000000000000000000000692;
const String _videoIdfour = 'https://youtu.be/mIbWRTc6kiI?t=';
const double _startSecondsfour = 00000000000000000000000000048;
const String _videoIdfive = 'https://youtu.be/VIRELnXmAgg?t=';
