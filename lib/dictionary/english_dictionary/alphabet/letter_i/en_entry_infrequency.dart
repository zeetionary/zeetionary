...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'cYsznAuvKLs';
    const double startSecondsend = 99;
    const String videoIdone = 'pJ_LUFBSoqM';
    const double startSecondsone = 482;
    const String videoIdtwo = 'C_B09FZwSbA';
    const double startSecondstwo = 275;
    const String videoIdthree = 'p2-8X9vEDRM';
    const double startSecondsthree = 1625;
    const String videoIdfour = 'LElhS5FV0lw';
    const double startSecondsfour = 673;
    const String videoIdfive = 'wEDW3Dzb1Uc';
    const double startSecondsfive = 259;
