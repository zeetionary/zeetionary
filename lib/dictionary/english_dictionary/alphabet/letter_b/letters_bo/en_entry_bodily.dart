...
// blank divider
  ...
  Future<void> speakbodilys3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He carried her bodily up the stairs.");
  }
  ...
  Future<void> speakbodilys5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The monument was moved bodily to a new site.");
  }
  ...
  Future<void> speakbodilys6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbodilys66");
  }
  ...
  Future<void> speakbodilys7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbodilys77");
  }
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbodilys1("en-GB"),
                            onPressedAmerican: () => speakbodilys1("en-US"),
                          ),
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbodilys2("en-GB"),
                            onPressedAmerican: () => speakbodilys2("en-US"),
                          ),
                          const DividerDefinition(),
                          const DefinitionKurdish(
                              text:
                          ...
                          SentencesRow(
                            englishText: "He carried her bodily up the stairs.",
                            kurdishText: "بە باوەش ھەڵیگرت بەسەر پەیژەکەدا.",
                            onPressedBritish: () => speakbodilys3("en-GB"),
                            onPressedAmerican: () => speakbodilys3("en-US"),
                          ),
                          const DividerSentences(),
                          SentencesRow(
                            englishText:
                            ...
                            onPressedBritish: () => speakbodilys4("en-GB"),
                            onPressedAmerican: () => speakbodilys4("en-US"),
                          ),
                          const DividerDefinition(),
                          const DefinitionKurdish(
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbodilys5("en-GB"),
                            onPressedAmerican: () => speakbodilys5("en-US"),
                          ),
                        ],
                      ),
                    ),
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final double _startSeconds = 14565;
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'IOhFk05xASY';
