...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) زیادکردن یان بەھێزکردنی کوالێتی، بەھا، یان پێگەی باشی شتێک"""),
          SentencesRow(
            englishText:
                """Enhancements made to websites often result in increased page views.""",
            kurdishText:
                """باشترکردنی وێبسایت زۆرجار دەبێتە ھۆکاری زیادبوونی بینینی پەڕە.""",
          ...
          SentencesRow(
            englishText:
                """The company also announced enhancements to three of its online databases.""",
            kurdishText:
                """کۆمپانیاکە ھەروەھا بەھێزکردنی سێ لە داتابەیسە سەرھێڵییەکانیی ڕاگەیاند.""",
