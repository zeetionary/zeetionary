...
class EnglishEntryfeverish extends StatefulWidget {
  const EnglishEntryfeverish({super.key});

  @override
  State<EnglishEntryfeverish> createState() => _EnglishEntryfeverishState();
}

class _EnglishEntryfeverishState extends State<EnglishEntryfeverish> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: feverish
1. Marked by intense agitation or emotion (= hectic)
"worked at a feverish pace";
 
2. Having or affected by a fever (= feverous)
 
3. Of or relating to or characterized by fever (= febrile)
"a feverish reaction caused by an allergen";
""",
  );

  final String keyword = "feverish";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""feverish""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The whole place was a scene of feverish activity.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was aching and feverish.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """feverish""",
                      // alsoEnglishWord: "also: feverish",
                      britshText: """IpaUK: /ˈfiːvərɪʃ/""",
                      americanText: """IpaUS: /ˈfiːvərɪʃ/""",
...
// With short examples define "feverish", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەواوی شوێنەکە جێگای چالاکی بێ‌ئۆقرە بوو.""",
...
const String _videoIdone = 'https://youtu.be/61mQx0h3JVA?t=';
const double _startSecondsone = 00000000000000000000000000064;
const String _videoIdtwo = 'https://youtu.be/yiztCUZ7Vzw?t=';
const double _startSecondstwo = 00000000000000000000000000032;
const String _videoIdthree = 'https://youtu.be/PaTCNLy1-H0?t=';
const double _startSecondsthree = 000000000000000000000000000163;
const String _videoIdfour = 'https://youtu.be/O-cKvhA9ZJ4?t=';
const double _startSecondsfour = 000000000000000000000000000727;
const String _videoIdfive = 'https://youtu.be/udbvuqjJHNQ?t=';
const double _startSecondsfive = 0000000000000000000000000001428;
