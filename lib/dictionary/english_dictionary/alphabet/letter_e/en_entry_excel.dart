...
class EnglishEntryexcel extends StatefulWidget {
  const EnglishEntryexcel({super.key});

  @override
  State<EnglishEntryexcel> createState() => _EnglishEntryexcelState();
}

class _EnglishEntryexcelState extends State<EnglishEntryexcel> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """excel""",
                      // alsoEnglishWord: "also: excel",
                      britshText: """IpaUK: /ɪkˈsel/""",
                      americanText: """IpaUS: /ɪkˈsel/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""As a child he excelled at music and art.""");
  }
...
"""),
          ...
          SentencesRow(
            ...
            kurdishText: """ھەمیشە لە زمانی بیانی باش بووە.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerSentences(),
          SentencesRow(
            englishText: """As a child he excelled at music and art.""",
            kurdishText: """وەک منداڵێک نایاب بوو لە میوزیک و ھونەر.""",
            onPressedBritish: () => speaksentence2("en-GB"),
            onPressedAmerican: () => speaksentence2("en-US"),
          ),
          const DividerSentences(),
          SentencesRow(
            englishText: """The team excels at turning defence into attack.""",
            kurdishText: """تیمەکە نایابە لە گۆڕینی بەرگری بۆ ھێرش.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: excel (derived forms: excelled, excels, excelling)
1. Be exceptionally good or the best (= stand out, surpass, rule)
"She excelled in maths";
""",
  );
