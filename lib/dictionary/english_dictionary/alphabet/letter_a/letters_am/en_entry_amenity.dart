                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "amenity"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈmiːnəti/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '6-6U6V3yQWk';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'Zhr7nDNieqw';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'oluwqXzePv8';
  final double _startSeconds = 1581;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '23ErB0axFgw';
