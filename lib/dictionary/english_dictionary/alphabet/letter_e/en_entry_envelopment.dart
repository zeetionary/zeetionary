...
class EnglishEntryenvelopment extends StatefulWidget {
  const EnglishEntryenvelopment({super.key});

  @override
  State<EnglishEntryenvelopment> createState() =>
      _EnglishEntryenvelopmentState();
}

class _EnglishEntryenvelopmentState extends State<EnglishEntryenvelopment> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""envelopment""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """envelopment""",
                      // alsoEnglishWord: "also: envelopment",
                      britshText: """IpaUK: /ɪnˈveləpmənt/""",
                      americanText: """IpaUS: /ɪnˈveləpmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "envelopment";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The envelopment of the area by trees created a peaceful atmosphere.""");
  }
...
کوردی: داپۆشین، پێچانەوە، داپێچان، داگرتن، سەرگرتن
"""),
          const DefinitionKurdish(
              text: """١. (ناو) داپۆشین یان دەورگرتنی کەسێک/شتێک بە تەواوی"""),
          SentencesRow(
            englishText:
                """The envelopment of the area by trees created a peaceful atmosphere.""",
            kurdishText:
                """دەورگرتنی ناوچەکە بە تەواوی بە دار کەشێکی ئارامی درووستکرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: envelopment (Derived forms: envelopments)
1. The act of enclosing something inside something else (= enclosure, enclosing, inclosure)
""",
  );
...
const String _videoIdend = 'Q-nWA0WeF98';
const double _startSecondsend = 153;
const String _videoIdone = 'zHpth20N174';
const double _startSecondsone = 181;
const String _videoIdtwo = '_69AThNKKM0';
const double _startSecondstwo = 276;
const String _videoIdthree = 'Z-BBNgGBTOQ';
const double _startSecondsthree = 1510;
const String _videoIdfour = 'DM16If5OSJU';
const double _startSecondsfour = 248;
const String _videoIdfive = 'BlrRAy2RlqM';
const double _startSecondsfive = 1329;
