...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakcurriculums1(String languageCode) async {
    ...
    await flutterTts.speak(
        "// speakcurriculums111111111111111111111111111111111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcurriculums2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcurriculums200"); // DOPSUM: CHANGE TEXT
  }
                ...
                child: Column(
                  children: [
                    ExampleSentenceEnglish(
                        text:
                            "// speakcurriculums111111111111111111111111111111111"),
...
speakcurriculum EnglishEntrycurriculum
WORD_WEB curriculum /kəˈrɪkjələm/
""",
  );
