...
class EnglishEntryguilt extends StatefulWidget {
  const EnglishEntryguilt({super.key});

  @override
  State<EnglishEntryguilt> createState() => _EnglishEntryguiltState();
}

class _EnglishEntryguiltState extends State<EnglishEntryguilt> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: guilt (Derived forms: guilts)
1. The state of having committed an offence (- guiltiness)
 
2. Remorse caused by feeling responsible for some offence (- guilty conscience, guilt feelings, guilt trip)

- Verb: guilt (Derived forms: guilted, guilting, guilts)
1. Make someone feel guilty, esp. in order to obtain favour (- guilt-trip)
""",
  );

  final String keyword = "guilt";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Many survivors were left with a sense of guilt.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He had no feelings of guilt over what he had done.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I knew that the next day I would be consumed with guilt.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It might be difficult to prove his guilt.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I took his silence as an admission of guilt.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There is no doubt as to where the guilt lies.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """guilt""",
                      // alsoEnglishWord: "also: guilt",
                      britshText: """IpaUK: /ɡɪlt/""",
                      americanText: """IpaUS: /ɡɪlt/""",
...
"""),
                    ...
                    const DefinitionKurdish(
                        text: """٢. (ناو) ئەوەی کەسێک شتێکی نایاسایی کردووە"""),
                    SentencesRow(
                      englishText:
                          """Do you think this statement amounts to an admission of guilt?""",
                      kurdishText:
                          """پێتوایە ئەم قسەیە وەک داننانە بە تاوان؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕەنگە سەخت بێت تاوانبارییەکەی بسەلمێندرێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ىێ‌دەنگییەکەییم وەک داننان بە تاوان وەرگرت.""",
