...
class EnglishEntryfiddle extends StatefulWidget {
  const EnglishEntryfiddle({super.key});

  @override
  State<EnglishEntryfiddle> createState() => _EnglishEntryfiddleState();
}

class _EnglishEntryfiddleState extends State<EnglishEntryfiddle> {
  @override
  void initState() {
    super.initState();
...
3. [Brit, informal] Intentional deception resulting in injury to another person (= fraud)
...
2. [informal] Play around with or alter or falsify, usually secretively or dishonestly (= tamper, monkey)
...
5. Try to fix or mend (= tinker)
"She always fiddles with her van on the weekend";
 
6. Avoid (one's assigned duties) (= shirk, shrink from, goldbrick [N. Amer, informal])
"The derelict soldier fiddled his duties";
""",
  );

  final String keyword = "fiddle";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He was fiddling with his keys while he talked to me.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She fiddled the books while working as an accountant.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Everyone suspected they were on the fiddle.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I find threading a needle a terrible fiddle.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiddle""",
                      // alsoEnglishWord: "also: fiddle",
                      britshText: """IpaUK: /ˈfɪdl/""",
                      americanText: """IpaUS: /ˈfɪdl/""",
...
// With short examples define "fiddle", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کلکەقنەی کلیلەکانی دەدا کە لەگەڵمدا قسەی دەکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کە وەک ژمێریاریک کاری دەکرد حساباتەکەی دەگۆڕی.""",
                    ...
                    CustomRichText(
                      ...
                      textAfterLink: "",
                      onTap: () {
                        Routemaster.of(context).push("/english-fiddle/violin");
                      },
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text:
                            """٤. (ناو) شتێک کە دەکرێت بۆ بردنەوەی پارە بە فێڵبازی"""),
                    SentencesRow(
                      englishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەزووکردن بە دەرزییەوە بە کارێکی سەخت دەزانم.""",
...
const String _videoIdend = 'https://youtu.be/D0x2dgpBDzc?t=';
const double _startSecondsend = 000000000000000000000000000587;
const String _videoIdone = 'https://youtu.be/AwodL8z2EtE?t=';
const double _startSecondsone = 000000000000000000000000000453;
const String _videoIdtwo = 'https://youtu.be/cqidD7kVnxY?t=';
const double _startSecondstwo = 000000000000000000000000000714;
...
const String _videoIdfive = 'https://youtu.be/gQmiqmxJMtA?t=';
const double _startSecondsfive = 00000000000000000000000000015605;
