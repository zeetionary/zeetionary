...
کوردی: سێڵاو، لافاو، شیپ، لەهی، لێمشت،	ئاوکشان، ئاوهەستان، ڕابوونی ئاو،	هەڵڕشتنی فرمێسک یان هەست و سۆز،	(خوازە) سێڵاو، لافاو، لێشاو، ڕەهێڵە
"""),
// With short examples define "flood", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The heavy rain has caused floods in many parts of the country.""",
                      kurdishText:
                          """بارانە دژوارەکە بووە بەهۆی لافاو لە زۆر بەشی وڵاتەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Much had been done in recent years to improve flood defences.""",
                      kurdishText:
                          """لەم چەند ساڵەی ڕابردوودا زۆر کار کراوە بۆ بەهێزکردنی بەرگری لە لافاو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کەس نەیدەزانی لافاوەکە دەهات.""",
                    ...
                    SentencesRow(
                      englishText:
                          """We are unable to compete with a flood of cheap food imports.""",
                      kurdishText:
                          """ناتوانین ڕکابەری لەگەڵ لێشاوی هاوردەی خواردنی هەرزان بکەین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """منداڵەکە لە ڕەهێڵەی فرمێسکدا بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """There has been a flood of tributes on social media from fans.""",
                      kurdishText:
                          """لێشاوێکی هاوخەمی لە هەوادارانەوە لەسەر تۆڕە کۆمەڵایەتییەکان هەبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ناوچەی تەنیشت ڕووبارەکە ئەگەری بەرکەوتن بە لافاوی هەیە.""",
                      englishNote:
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (کردار) کە ڕووبارێک هێندە ئاوی تێدایە دەڕأێتە خاکی دەرووبەری"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کە ڕوباری گەنجیز پڕ دەبێت دەبێتە هۆکاری زیانی گەورە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە کۆتایی یاریگاکە هەوادارانی خاوەن یاریگاکە ڕژانە یاریگاکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کەلووپەلی هاوردەی هەرزان ڕژاونەتە بازاڕ.""",
                    ...
                    SentencesRow(
                      englishText:
                          """A man who planned to flood Britain with cocaine was jailed for 15 years.""",
                      kurdishText:
                          """پیاوێک کە هەوڵی دا کۆکاینی زۆر بهێنێتە بەریتانیا بۆ ١٥ ساڵ زیندانی کرا.""",
...
const double _startSecondsend = 0000000000000000000000000001497;
const String _videoIdone = 'https://youtu.be/-cPdImejxEQ?t=';
const double _startSecondsone = 000000000000000000000000000222;
const String _videoIdtwo = 'https://youtu.be/pHGweqJCx2s?t=';
const double _startSecondstwo = 0000000000000000000000000003;
const String _videoIdthree = 'https://youtu.be/Xzv84ZdtlE0?t=';
const double _startSecondsthree = 0000000000000000000000000001206;
const String _videoIdfour = 'https://youtu.be/T48_SrFCdaQ?t=';
