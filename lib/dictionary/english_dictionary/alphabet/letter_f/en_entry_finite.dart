...
class EnglishEntryfinite extends StatefulWidget {
  const EnglishEntryfinite({super.key});

  @override
  State<EnglishEntryfinite> createState() => _EnglishEntryfiniteState();
}

class _EnglishEntryfiniteState extends State<EnglishEntryfinite> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The world's resources are finite.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """finite""",
                      // alsoEnglishWord: "also: finite",
                      britshText: """IpaUK: /ˈfaɪnaɪt/""",
                      americanText: """IpaUS: /ˈfaɪnaɪt/""",
...
// With short examples define "finite", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە کۆتایی یان سنووری هەیە"""),
                    SentencesRow(
                      englishText: """The world's resources are finite.""",
                      kurdishText: """سەرچاوەکانی جیهان سنووردارن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The funds available for the health service are finite and we cannot afford to waste money.""",
                      kurdishText:
                          """پارەی پێویست بۆ خزمەتگوزاری تەندرووستی سنووردارە و ناتوانین پارە بەفیڕۆ بدەین.""",
...
const double _startSecondsend = 0000000000000000000000000004813;
const String _videoIdone = 'https://youtu.be/rMNAdHqGMhs?t=';
const double _startSecondsone = 00000000000000000000000000018;
const String _videoIdtwo = 'https://youtu.be/UShsgCOzER4?t=';
const double _startSecondstwo = 0000000000000000000000000001217;
const String _videoIdthree = 'https://youtu.be/DxREm3s1scA?t=';
const double _startSecondsthree = 0000000000000000000000000004804;
const String _videoIdfour = 'https://youtu.be/OM9KepKsg6U?t=';
const double _startSecondsfour = 000000000000000000000000000296;
const String _videoIdfive = 'https://youtu.be/HdwzJLTLFqc?t=';
const double _startSecondsfive = 000000000000000000000000000843;
