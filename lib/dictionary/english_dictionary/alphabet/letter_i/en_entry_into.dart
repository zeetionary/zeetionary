...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/bvf5DlhvJJE?t=';
    const double startSecondsone = 00000000000000000000000000024;
    const String videoIdtwo = 'https://youtu.be/r5cqa9V0mUo?t=';
    const double startSecondstwo = 000000000000000000000000000221;
    const String videoIdthree = 'https://youtu.be/Ht0IbFNbfSY?t=';
    const double startSecondsthree = 000000000000000000000000000218;
    const String videoIdfour = 'https://youtu.be/1aHVa2jT3n4?t=';
...
// With short examples define "into", please follow LX instructions
                    ...
                    const DefinitionKurdish(text: """ژممر. (ئامراز) پننسە"""),
