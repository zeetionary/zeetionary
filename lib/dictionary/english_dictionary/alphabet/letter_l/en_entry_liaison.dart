...
class EnglishEntryliaison extends StatefulWidget {
  const EnglishEntryliaison({super.key});

  @override
  State<EnglishEntryliaison> createState() => _EnglishEntryliaisonState();
}

class _EnglishEntryliaisonState extends State<EnglishEntryliaison> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: liaison (Derived forms: liaisons)
1. A channel for communication between groups (- link, contact, inter-group communication)
"he provided a liaison with the guerrillas";
 
2. A usually secretive or illicit sexual relationship (- affair, affaire, intimacy, involvement, amour)
 
3. (linguistics) a sandhi in which a normally silent final consonant is pronounced when the next word begins with a vowel
""",
  );

  final String keyword = "liaison";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""liaison""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We are hoping to establish better customer liaison.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Our role is to ensure liaison between schools and parents.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We hired someone as customer liaison.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He finally admitted to several sexual liaisons.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/S4qvPouh1gE?t=224';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/HBddoNdQDyo?t=28';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/4RlBVzUCYek?t=453';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/GNRnrKUEnCQ?t=41';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/U24fKGJ2JPo';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/mgIr5vC_-h8?t=205';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """liaison""",
                      // alsoEnglishWord: "also: liaison",
                      britshText: """IpaUK: /liˈeɪzn/""",
                      americanText: """IpaUS: /ˈliːəzɑːn/,  /liˈeɪzɑːn/""",
...
کوردی: پێوەندی (دوولایەنە)، پێوەستی، تێکەڵی،	تێکەڵی، پێوەندی سێکسی نهێنی
"""),
// With short examples define "liaison", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) پەیوەندیی نێوان خەڵک یان دامەزراوە کە تێیدا بیرۆکە ئاڵووگۆڕ دەکرێت"""),
                    SentencesRow(
                      englishText: """We are hoping to establish better customer liaison.""",
                      kurdishText: """بەهیواین تێکەڵی زیاتر لەگەڵ کڕیاران درووست بکەین.""",
                    ...
                    SentencesRow(
                      englishText: """Our role is to ensure liaison between schools and parents.""",
                      kurdishText: """ئەرکمان ئەوەیە پەیوەندی لە نێوان خوێندنگاکان و دایبابان درووست بکەین.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) کەسێک کە کاری ئەوەیە پەیوەندیی باش هەیە لە نێوان ژمارەیەک گرووپ یان دامەزراوەدا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We hired someone as customer liaison.""",
                      kurdishText: """کەسێکمان وەرگرت بۆ ئەوەی ببێتە پەیوەندیکار لەگەڵ کڕیارەکان.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) پەیوەندییەکی سێکسی، بە تایبەتی کە یەک یان یان هەردوو کەسەکە پێشوەختە لە پەیوەندیی دیکە دان"""),
                    const AlsoEnglishckb(word: "ھەروەھا: affair"),
                    SentencesRow(
                      englishText: """He finally admitted to several sexual liaisons.""",
                      kurdishText: """لە کۆتاییدا دانینا بە ژمارەیەک پەیوەندیی سێکسیدا.""",
