...
// replace these: EnglishEntryabsentee - speakAbsentee - absentee - /ˌæbsənˈtiː/

enum TtsState { playing }

class EnglishEntryabsentee extends StatelessWidget {
  EnglishEntryabsentee({Key? key}) : super(key: key);
  ...
  Future<void> speakA3546(String languageCode) async {
    ...
    await flutterTts.speak(
        "There are several absentees from school this week, because a lot of people have flu."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'absentee', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌæbsənˈtiː/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '9xYQO1Ja0Yc';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'wSNYgHiB-N4';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'BJPKUw8QIlk';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'YikMbBSPY1w';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'YyV_9nsEGgM';
