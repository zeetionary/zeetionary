...
class EnglishEntryfollowing extends StatefulWidget {
  const EnglishEntryfollowing({super.key});

  @override
  State<EnglishEntryfollowing> createState() => _EnglishEntryfollowingState();
}

class _EnglishEntryfollowingState extends State<EnglishEntryfollowing> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: following
1. Going, proceeding or coming after in the same direction
"the crowd of following cars made the occasion seem like a parade"; "tried to outrun the following footsteps"
 
2. About to be mentioned or specified (= undermentioned)
"the following items";
 
3. Immediately following in time or order (= next)
"the following day";
 
4. In the desired direction
"a following wind"

- Noun: following (Derived forms: followings)
1. A group of followers or enthusiasts (= followers)
 
2. The act of pursuing in an effort to overtake or capture (= pursuit, chase, pursual)

- Preposition: following
1. As a result of (= after)
"she was sacked following her argument with the boss";
 
2. Coming at a later time or previous position (= behind, after)
"he leaves a trail of destruction following him";
""",
  );

  final String keyword = "following";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""following""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Answer the following questions.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The following article was written in 2017.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""In the following nights, Lucy slept poorly.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The following is a summary of events.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The band has a huge following in Italy.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The series enjoys a cult following among young people.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Following the dinner, there will be a dance.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """following""",
                      // alsoEnglishWord: "also: following",
                      britshText: """IpaUK: /ˈfɒləʊɪŋ/""",
                      americanText: """IpaUS: /ˈfɑːləʊɪŋ/""",
...
// With short examples define "following", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Answer the following questions.""",
                      kurdishText: """وەڵامی ئەم پرسیارانەی دواتر بدەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەم وتارەی دواتر ساڵی ٢٠١٧ نووسراو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """شەوەکانی دواتر، لووسی خراپ خەوت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """They arrived on Monday evening and we got there the following day.""",
                      kurdishText:
                          """شەوی دووشەممە گەشتن و ڕۆژی دواتر گەشتینە ئەوێ.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The following have been chosen to take part: Watts, Hodges and Lennox.""",
                      kurdishText:
                          """ئەمانە هەڵبژێردراون بۆ بەشداریکردن: واتس، هۆجێس و لێنۆکس.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (ناو) ژمارەیەک هەوادار"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The band has a huge following in Italy.""",
                      kurdishText:
                          """باندەکە شوێنکەتووی زۆری هەیە لە ئیتالیا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The series enjoys a cult following among young people.""",
                      kurdishText:
                          """زنجیرەکە لایەنگری تایبەت و سەرسەختی لە نێو گەنجاندا هەیە..""",
                    ...
                    SentencesRow(
                      englishText:
                          """He took charge of the family business following his father's death.""",
                      kurdishText:
                          """ئاگای لە کاری بازرگانی خێزانەکە بوو لە دوای مەرگی باوکی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دوای نانی ئێوارە، سەماکردن دەبێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/R_fZjGm2OrM?t=';
const double _startSecondsend = 000000000000000000000000000186;
const String _videoIdone = 'https://youtu.be/yRmOWcWdQAo?t=';
const double _startSecondsone = 0000000000000000000000000001079;
const String _videoIdtwo = 'https://youtu.be/Fon7og7w4Yw?t=';
const double _startSecondstwo = 00000000000000000000000000011;
const String _videoIdthree = 'https://youtu.be/6BTJ7feX0aQ?t=';
const double _startSecondsthree = 0000000000000000000000000001651;
const String _videoIdfour = 'https://youtu.be/wJa5Ch0O4BI?t=';
const double _startSecondsfour = 000000000000000000000000000499;
const String _videoIdfive = 'https://youtu.be/_4xyf0fOd4I?t=';
