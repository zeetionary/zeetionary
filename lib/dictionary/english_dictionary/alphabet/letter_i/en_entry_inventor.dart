...
class EnglishEntryinventor extends StatefulWidget {
  const EnglishEntryinventor({super.key});

  @override
  State<EnglishEntryinventor> createState() => _EnglishEntryinventorState();
}

class _EnglishEntryinventorState extends State<EnglishEntryinventor> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inventor""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 418;
    const String videoIdone = 'DEFD9TSHg_A';
    const double startSecondsone = 64;
    const String videoIdtwo = 'vFymKqUwodY';
    const double startSecondstwo = 90;
    const String videoIdthree = 'lRW6CYfhei0';
    const double startSecondsthree = 841;
    const String videoIdfour = 'n5CPMf5eC_s';
    const double startSecondsfour = 821;
    const String videoIdfive = 'iFcPqXxAUWM';
    const double startSecondsfive = 28;
