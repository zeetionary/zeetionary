...
class EnglishEntryfilingcabinet extends StatefulWidget {
  const EnglishEntryfilingcabinet({super.key});

  @override
  State<EnglishEntryfilingcabinet> createState() =>
      _EnglishEntryfilingcabinetState();
}

class _EnglishEntryfilingcabinetState extends State<EnglishEntryfilingcabinet> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "filing cabinet";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""filing cabinet""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """filing cabinet""",
                      // alsoEnglishWord: "also: filing cabinet",
...
const String _videoIdone = 'https://youtu.be/FkKPsLxgpuY?t=';
const double _startSecondsone = 0000000000000000000000000001059;
const String _videoIdtwo = 'https://youtu.be/gjySnrspD7E?t=';
const double _startSecondstwo = 0000000000000000000000000002258;
const String _videoIdthree = 'https://youtu.be/vchJnrZgz-4?t=';
const double _startSecondsthree = 000000000000000000000000000894;
const String _videoIdfour = 'https://youtu.be/TxXkBhZHoLQ?t=';
const double _startSecondsfour = 000000000000000000000000000898;
const String _videoIdfive = 'https://youtu.be/XB2W_kw62u8?t=';
