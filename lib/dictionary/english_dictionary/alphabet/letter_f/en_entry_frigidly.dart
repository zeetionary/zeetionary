...
class EnglishEntryfrigidly extends StatefulWidget {
  const EnglishEntryfrigidly({super.key});

  @override
  State<EnglishEntryfrigidly> createState() => _EnglishEntryfrigidlyState();
}

class _EnglishEntryfrigidlyState extends State<EnglishEntryfrigidly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: frigidly
1. Without warmth or enthusiasm (- frostily)
"'Come in if you have to,' he said frigidly";
""",
  );

  final String keyword = "frigidly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frigidly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Sarah shook his hand frigidly.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Temperatures were frigidly cold over the last 15 days.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frigidly""",
                      // alsoEnglishWord: "also: frigidly",
                      britshText: """IpaUK: /ˈfrɪdʒɪdli/""",
                      americanText: """IpaUS: /ˈfrɪdʒɪdli/""",
...
// With short examples define "frigidly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە هیچ هەستێکی خۆش یان هاوڕێیانە پیشان نادات"""),
                    SentencesRow(
                      englishText: """Sarah shook his hand frigidly.""",
                      kurdishText: """بە ساردوسڕی دەستی ڕاوەشاند.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە ١٥ ڕۆژی ڕابردوودا پلەی گەرمی ئێجگار سارد بووە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/C8u3ulVNZo4?t=';
const double _startSecondsend = 000000000000000000000000000520;
const String _videoIdone = 'https://youtu.be/HkfL2DUPig8?t=';
const double _startSecondsone = 000000000000000000000000000218;
const String _videoIdtwo = 'https://youtu.be/CyT4FWNlP5w?t=';
const double _startSecondstwo = 000000000000000000000000000192;
const String _videoIdthree = 'https://youtu.be/WMnm4C9V0FY?t=';
const double _startSecondsthree = 000000000000000000000000000769;
const String _videoIdfour = 'https://youtu.be/EfWSgcfKdW4?t=';
const double _startSecondsfour = 00000000000000000000000000081;
const String _videoIdfive = 'https://youtu.be/90h6KEXvXzI?t=';
