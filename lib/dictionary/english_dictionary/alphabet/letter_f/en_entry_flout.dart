...
class EnglishEntryflout extends StatefulWidget {
  const EnglishEntryflout({super.key});

  @override
  State<EnglishEntryflout> createState() => _EnglishEntryfloutState();
}

class _EnglishEntryfloutState extends State<EnglishEntryflout> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: flout (Derived forms: flouting, flouts, flouted)
1. Treat with contemptuous disregard (= scoff)
"flout the rules";
 
2. Shout or laugh at with contempt and derision (= jeer, scoff, barrack [Brit], gibe)
""",
  );

  final String keyword = "flout";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Motorists regularly flout the law.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She likes flouting convention and doing her own thing.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flout""",
                      // alsoEnglishWord: "also: flout",
                      britshText: """IpaUK: /flaʊt/""",
                      americanText: """IpaUS: /flaʊt/""",
...
// With short examples define "flout", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Motorists regularly flout the law.""",
                      kurdishText: """ماتۆڕسواران زۆرجار سەرپێچی یاسا دەکەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """حەز دەکات لە نەریتەکان لابدات و کاری خۆی بکات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/nG3NNWESpCU?t=';
const double _startSecondsend = 000000000000000000000000000585;
const String _videoIdone = 'https://youtu.be/lswKi3SLsy8?t=';
const double _startSecondsone = 000000000000000000000000000273;
const String _videoIdtwo = 'https://youtu.be/ACwutOXamrw?t=';
const double _startSecondstwo = 000000000000000000000000000239;
const String _videoIdthree = 'https://youtu.be/8x9X_FdknNI?t=';
const double _startSecondsthree = 000000000000000000000000000303;
const String _videoIdfour = 'https://youtu.be/20_TlrrB3W4?t=';
const double _startSecondsfour = 0000000000000000000000000001108;
const String _videoIdfive = 'https://youtu.be/Ow50TBiytiE?t=';
const double _startSecondsfive = 0000000000000000000000000001387;
