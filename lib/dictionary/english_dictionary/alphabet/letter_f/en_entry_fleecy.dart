...
class EnglishEntryfleecy extends StatefulWidget {
  const EnglishEntryfleecy({super.key});

  @override
  State<EnglishEntryfleecy> createState() => _EnglishEntryfleecyState();
}

class _EnglishEntryfleecyState extends State<EnglishEntryfleecy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fleecy (Derived forms: fleeciest, fleecier)
1. (of fabrics) having soft nap produced by brushing (= brushed, napped)
"a fleecy lining";
""",
  );

  final String keyword = "fleecy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He wrapped himself in a fleecy blanket.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fleecy""",
                      // alsoEnglishWord: "also: fleecy",
                      britshText: """IpaUK: /ˈfliːsi/""",
                      americanText: """IpaUS: /ˈfliːsi/""",
...
کوردی: خوری‌ئاسا، لە خوری، لەخوری‌چوو، کوڵک، نەرم، پڕ، لۆکەئاسا، لۆکەیی
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە لە مادەی نەرم درووستکراوە، بۆ نموونە خوری مەڕ"""),
                    SentencesRow(
                      englishText:
                          """He wrapped himself in a fleecy blanket.""",
                      kurdishText: """خۆی کە بەتانییەکی خوری پێچایەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/fB_aCv8bYU8?t=';
const double _startSecondsend = 000000000000000000000000000335;
const String _videoIdone = 'https://youtu.be/eWMQkNXIffU?t=';
const double _startSecondsone = 00000000000000000000000000037;
const String _videoIdtwo = 'https://youtu.be/Owgqxs5OUcs?t=';
const double _startSecondstwo = 000000000000000000000000000545;
const String _videoIdthree = 'https://youtu.be/xbyAJXDkxEs?t=';
const double _startSecondsthree = 00000000000000000000000000078;
const String _videoIdfour = 'https://youtu.be/Gulp-dZqvxE?t=';
const double _startSecondsfour = 0000000000000000000000000001518;
const String _videoIdfive = 'https://youtu.be/ZhTkwbS1vlk?t=';
