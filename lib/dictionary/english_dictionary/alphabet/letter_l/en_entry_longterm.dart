...
class EnglishEntrylongterm extends StatefulWidget {
  const EnglishEntrylongterm({super.key});

  @override
  State<EnglishEntrylongterm> createState() => _EnglishEntrylongtermState();
}

class _EnglishEntrylongtermState extends State<EnglishEntrylongterm> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""long-term""");
  }
