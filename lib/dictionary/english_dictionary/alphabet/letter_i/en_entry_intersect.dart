...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'KT18KJouHWg';
    const double startSecondsend = 737;
    const String videoIdone = '_0RTH57v66I';
    const double startSecondsone = 575;
    const String videoIdtwo = 'MBsQOTvWL3Q';
    const double startSecondstwo = 183;
    const String videoIdthree = '3KC32Vymo0Q';
    const double startSecondsthree = 1537;
    const String videoIdfour = 'qh7dgSldw-w';
    const double startSecondsfour = 117;
    const String videoIdfive = 'A0sM6xVAY-A';
