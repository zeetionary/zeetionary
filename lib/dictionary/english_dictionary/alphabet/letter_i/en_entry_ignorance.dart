...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'G0SpzIIHEaE';
    const double startSecondsend = 214;
    const String videoIdone = 'wJa5Ch0O4BI';
    const double startSecondsone = 279;
    const String videoIdtwo = 'wkORnroOOWg';
    const double startSecondstwo = 581;
    const String videoIdthree = 'HE2Jg3GXH6Q';
    const double startSecondsthree = 664;
    const String videoIdfour = 'N3Zj-hMEL-k';
    const double startSecondsfour = 529;
    const String videoIdfive = 'DmqFbgKWoao';
    const double startSecondsfive = 1095;
