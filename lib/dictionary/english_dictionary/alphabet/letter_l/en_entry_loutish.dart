...
class EnglishEntryloutish extends StatefulWidget {
  const EnglishEntryloutish({super.key});

  @override
  State<EnglishEntryloutish> createState() => _EnglishEntryloutishState();
}

class _EnglishEntryloutishState extends State<EnglishEntryloutish> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryloutish loutish
WORD_WEB loutish loutish loutish
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "loutish";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""loutish""");
  }
...
کوردی: 
"""),
// With short examples define "loutish", please follow LX instructions
