...
class EnglishEntryinapplicable extends StatefulWidget {
  const EnglishEntryinapplicable({super.key});

  @override
  State<EnglishEntryinapplicable> createState() =>
      _EnglishEntryinapplicableState();
}

class _EnglishEntryinapplicableState extends State<EnglishEntryinapplicable> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inapplicable""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'wOvvBWSBwU0';
    const double startSecondsend = 654;
    const String videoIdone = '-w7meZX7A1k';
    const double startSecondsone = 137;
    const String videoIdtwo = '2YggFTviC7s';
    const double startSecondstwo = 56;
    const String videoIdthree = 'K6wi81qEDo4';
    const double startSecondsthree = 74;
    const String videoIdfour = 'rJls21AhI1g';
    const double startSecondsfour = 225;
    const String videoIdfive = 'rnLWSC5p1XE';
    const double startSecondsfive = 1696;
