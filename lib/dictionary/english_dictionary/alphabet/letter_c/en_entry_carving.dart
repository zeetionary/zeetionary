...
class EnglishEntrycarving extends StatelessWidget {
  // blank divider
  EnglishEntrycarving({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcarving(String languageCode) async {
    // DOPSUM: CHANGE speakcarving
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "carving"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈkɑːvɪŋ/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcarving("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈkɑːrvɪŋ/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcarving("en-US"),
                            ),
                          ],
                        ),
                      ],
...
3. Creating figures or designs in three dimensions (= sculpture)
""",
  );
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'HDprhP70Zmo';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'J1Rl9cs93eg';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '8AbR55QWodw';
  final double _startSeconds = 3804;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'nSsK19Sp5uY';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Dh6t7ds5yeY';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'X6pdiDuJKd8';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'o9H_hUaINsA';
