...
class EnglishEntryfountainpen extends StatefulWidget {
  const EnglishEntryfountainpen({super.key});

  @override
  State<EnglishEntryfountainpen> createState() =>
      _EnglishEntryfountainpenState();
}

class _EnglishEntryfountainpenState extends State<EnglishEntryfountainpen> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fountain pen (Derived forms: fountain pens)
1. A pen that is supplied with ink from a reservoir in its barrel
""",
  );

  final String keyword = "fountain pen";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fountain pen""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He signed the document with a fountain pen.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fountain pen""",
                      // alsoEnglishWord: "also: fountain pen",
                      britshText: """IpaUK: /ˈfaʊntən pen/""",
                      americanText: """IpaUS: /ˈfaʊntn pen/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پێنووسێک کە شوێنێکی هەیە کەوا پڕی دەکەیت لە مەرەکەب کە دەڕژێتە سەر نووکەکەی"""),
                    SentencesRow(
                      englishText:
                          """He signed the document with a fountain pen.""",
                      kurdishText: """بە پێنووسی جاف بەڵگەنامەکەی واژۆکرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/xSDhnMOFlpA?t=';
const double _startSecondsend = 000000000000000000000000000218;
const String _videoIdone = 'https://youtu.be/JJM2VXjFt7s?t=';
const double _startSecondsone = 0000000000000000000000000001588;
const String _videoIdtwo = 'https://youtu.be/4zgoSs73tSo?t=';
const double _startSecondstwo = 000000000000000000000000000275;
const String _videoIdthree = 'https://youtu.be/TSWRYJfSWNc?t=';
const double _startSecondsthree = 000000000000000000000000000127;
const String _videoIdfour = 'https://youtu.be/R7qsau3X6Ks?t=';
const double _startSecondsfour = 000000000000000000000000000799;
const String _videoIdfive = 'https://youtu.be/ct80P_f_8B0?t=';
const double _startSecondsfive = 000000000000000000000000000354;
