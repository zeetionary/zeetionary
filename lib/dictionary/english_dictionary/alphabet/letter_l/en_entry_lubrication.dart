...
class EnglishEntrylubrication extends StatefulWidget {
  const EnglishEntrylubrication({super.key});

  @override
  State<EnglishEntrylubrication> createState() => _EnglishEntrylubricationState();
}

class _EnglishEntrylubricationState extends State<EnglishEntrylubrication> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylubrication lubrication
WORD_WEB lubrication lubrication lubrication
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lubrication";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lubrication""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lubrication""",
                      // alsoEnglishWord: "also: lubrication",
...
کوردی: 
"""),
// With short examples define "lubrication", please follow LX instructions
