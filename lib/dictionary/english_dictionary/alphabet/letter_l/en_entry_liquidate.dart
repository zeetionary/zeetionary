...
class EnglishEntryliquidate extends StatefulWidget {
  const EnglishEntryliquidate({super.key});

  @override
  State<EnglishEntryliquidate> createState() => _EnglishEntryliquidateState();
}

class _EnglishEntryliquidateState extends State<EnglishEntryliquidate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: liquidate (Derived forms: liquidating, liquidates, liquidated)
1. Get rid of (someone who may be a threat) by killing (- neutralize, neutralise [Brit], waste, knock off [informal], do in)
"The mafia liquidated the informer";
 
2. Eliminate by paying off (debts) (- pay off)
...
""",
  ...
  final String keyword = "liquidate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""liquidate""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/7Z1p7TMPXFM?t=1087';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/rxalEnZ7uok?t=923';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/00yC_W0fUPE?t=160';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/1X_KdkoGxSs?t=13737';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/9J_PvWkkvag?t=436';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/covxjhXsCi8?t=1071';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """liquidate""",
                      // alsoEnglishWord: "also: liquidate",
                      britshText: """IpaUK: /ˈlɪkwɪdeɪt/""",
                      americanText: """IpaUS: /ˈlɪkwɪdeɪt/""",
