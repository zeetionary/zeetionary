...
// replace EnglishEntryAdopsummm - replace speakArcticcircle

// replace the Arctic Circle - /ði ˌɑːktɪk ˈsɜːkl/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarcticcircle extends StatelessWidget {
  // blank divider
  EnglishEntryarcticcircle({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakArcticcircle(String languageCode) async {
    // DOPSUM: CHANGE speakArcticcircle
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("the Arctic Circle"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakArcticcircle505(String languageCode) async {
    // DOPSUM: CHANGE speakArcticcircle
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "Soviet Union tests atomic bomb in Arctic Circle."); // DOPSUM: CHANGE TEXT
  }
...
١. (ناو) هێڵی درێژی سەروو ٧٠ پلەی باکوور کە دەوری خولگەی جەمسەری باکوور دەدات""",
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "https://youtu.be/jLPBJ5EwV2I?t=";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "https://youtu.be/I0SAQ-76C3Q";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "https://youtu.be/JUtAra3pFGs?t=";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "https://youtu.be/s97V9w-9Jao?t=";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "https://youtu.be/06V20tiHSAE?t=";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "https://youtu.be/bsfQzJBkVkg?t=";
