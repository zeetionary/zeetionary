...
class EnglishEntryfinalize extends StatefulWidget {
  const EnglishEntryfinalize({super.key});

  @override
  State<EnglishEntryfinalize> createState() => _EnglishEntryfinalizeState();
}

class _EnglishEntryfinalizeState extends State<EnglishEntryfinalize> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""finalize""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They met to finalize the terms of the treaty.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """finalize""",
                      // alsoEnglishWord: "also: finalize",
                      britshText: """IpaUK: /ˈfaɪnəlaɪz/""",
                      americanText: """IpaUS: /ˈfaɪnəlaɪz/""",
...
const double _startSecondsend = 000000000000000000000000000589;
const String _videoIdone = 'https://youtu.be/8X1xYpPmKvA?t=';
const double _startSecondsone = 0000000000000000000000000008149;
const String _videoIdtwo = 'https://youtu.be/T8uc3NzU7J4?t=';
const double _startSecondstwo = 0000000000000000000000000001043;
const String _videoIdthree = 'https://youtu.be/JfUjz00snVE?t=';
const double _startSecondsthree = 000000000000000000000000000486;
const String _videoIdfour = 'https://youtu.be/K6FteqXWtYI?t=';
const double _startSecondsfour = 0000000000000000000000000001557;
const String _videoIdfive = 'https://youtu.be/XBUq8q1Vwls?t=';
