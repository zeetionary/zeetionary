...
class EnglishEntryfibber extends StatefulWidget {
  const EnglishEntryfibber({super.key});

  @override
  State<EnglishEntryfibber> createState() => _EnglishEntryfibberState();
}

class _EnglishEntryfibberState extends State<EnglishEntryfibber> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""You fibber!""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fibber""",
                      // alsoEnglishWord: "also: fibber",
                      britshText: """IpaUK: /ˈfɪbə(r)/""",
                      americanText: """IpaUS: /ˈfɪbər/""",
...
// With short examples define "fibber", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Fibber! You couldn't run ten kilometres, let alone a marathon!""",
                      kurdishText:
                          """درۆزن! تۆ ناتوانیت ١٠ کیلۆمەتر ڕابکەیت، چی بگات بە ماراسۆنێک.""",
...
const String _videoIdend = 'https://youtu.be/IFk2cbYy6po?t=';
const double _startSecondsend = 00000000000000000000000000061;
const String _videoIdone = 'https://youtu.be/_4xyf0fOd4I?t=';
const double _startSecondsone = 000000000000000000000000000325;
const String _videoIdtwo = 'https://youtu.be/YKrOlLSrnGo?t=';
const double _startSecondstwo = 000000000000000000000000000589;
const String _videoIdthree = 'https://youtu.be/hM_KaA-PJqw?t=';
const double _startSecondsthree = 000000000000000000000000000976;
const String _videoIdfour = 'https://youtu.be/3LpvUS4rvB4?t=';
const double _startSecondsfour = 00000000000000000000000000088;
const String _videoIdfive = 'https://youtu.be/o23PmVbxNNk?t=';
const double _startSecondsfive = 000000000000000000000000000228;
