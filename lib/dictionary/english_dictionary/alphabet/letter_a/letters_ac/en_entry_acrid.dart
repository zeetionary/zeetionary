...
// replace these: replace EnglishEntryacrid - replace speakAacrid - replace acrid - /ˈækrɪd/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryacrid extends StatelessWidget {
  EnglishEntryacrid({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'acrid', // DOPSUM: CHANGE WORD ENTRY - Find /ˈækrɪd/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈækrɪd/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'A2VAN7PtQW0';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'MgTtR5YTzvI';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'kPauR6tP_cg';
