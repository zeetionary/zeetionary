...
class EnglishEntryfag extends StatefulWidget {
  const EnglishEntryfag({super.key});

  @override
  State<EnglishEntryfag> createState() => _EnglishEntryfagState();
}

class _EnglishEntryfagState extends State<EnglishEntryfag> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fag""",
                      // alsoEnglishWord: "also: fag",
                      britshText: """IpaUK: /fæɡ/""",
                      americanText: """IpaUS: /fæɡ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It's too much of a fag to go out.""");
  }
...
"""),
          ...
          CustomRichText(
            ...
            textAfterLink: "",
            onTap: () {
              Routemaster.of(context).push("/english-fag/cigarette");
            },
          ),
          const DividerDefinition(),
          CustomRichText(
            ...
            textAfterLink: "",
            onTap: () {
              Routemaster.of(context).push("/english-fag/faggot");
            },
          ),
          const DividerDefinition(),
...
2. [informal] Exhaust or get tired through overuse or great strain or stress (= tire, wear upon, tire out, wear, weary, jade, wear out, outwear, wear down, fag out [Brit, informal], fatigue, knacker [Brit, informal])
...
const String _videoIdend = 'https://youtu.be/0UmowwMivyU?t=';
const double _startSecondsend = 000000000000000000000000000172;
const String _videoIdone = 'https://youtu.be/lww1rm07jMs?t=';
const double _startSecondsone = 000000000000000000000000000245;
const String _videoIdtwo = 'https://youtu.be/-6EKrSZ6nu0?t=';
const double _startSecondstwo = 000000000000000000000000000412;
const String _videoIdthree = 'https://youtu.be/Ehq8dCl3cgU?t=';
const double _startSecondsthree = 000000000000000000000000000207;
const String _videoIdfour = 'https://youtu.be/lxW4EjFmnAQ?t=';
const double _startSecondsfour = 000000000000000000000000000197;
const String _videoIdfive = 'https://youtu.be/sxo4wULffKY?t=';
