...
// replace EnglishEntryAdopsum - replace speakAppal

// replace appal - /əˈpɔːl/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryappal extends StatelessWidget {
  // blank divider
  EnglishEntryappal({super.key});
  // blank divider
  ...
  Future<void> speakappal737(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("The idea of sharing a room appalled her.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "appal"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈpɔːl/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈpɔːl/"),
...
١. (کردار) کەسێک بە تەواوی بتاسێنی و ھەست بکات شتێک خراپە"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakappal737("en-US"),
                          ),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'K2rY7JkwL2k';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'aBohGITX4SQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'C_LHPOesjnM';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'ftQlDnqkw5c';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'u5ZraSSCgjQ';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '4HljsKwpv3g';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'iw4gjl2aako';
