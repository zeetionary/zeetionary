...
class EnglishEntryenduring extends StatefulWidget {
  const EnglishEntryenduring({super.key});

  @override
  State<EnglishEntryenduring> createState() => _EnglishEntryenduringState();
}

class _EnglishEntryenduringState extends State<EnglishEntryenduring> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enduring""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enduring""",
                      // alsoEnglishWord: "also: enduring",
                      britshText: """IpaUK: /ɪnˈdjʊərɪŋ/""",
                      americanText: """IpaUS: /ɪnˈdʊrɪŋ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""What is your most enduring memory of her?""");
  }
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: enduring
1. Lasting a long time (= abiding, imperishable)
"an enduring belief";
 
2. Patiently bearing continual wrongs or trouble (= long-suffering)
