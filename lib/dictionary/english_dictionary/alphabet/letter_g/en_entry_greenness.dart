...
class EnglishEntrygreenness extends StatefulWidget {
  const EnglishEntrygreenness({super.key});

  @override
  State<EnglishEntrygreenness> createState() => _EnglishEntrygreennessState();
}

class _EnglishEntrygreennessState extends State<EnglishEntrygreenness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: greenness
1. The lush appearance of flourishing vegetation (- verdancy, verdure)
 
2. The state of not being ripe
 
3. Green colour or pigment; resembling the colour of growing grass (- green, viridity)
""",
  );

  final String keyword = "greenness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""greenness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'll never forget the greenness of the grass.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """greenness""",
                      // alsoEnglishWord: "also: greenness",
                      britshText: """IpaUK: /ˈɡriːnnəs/""",
                      americanText: """IpaUS: /ˈɡriːnnəs/""",
...
کوردی: سەوزایی، سەوزاوەرد، سەرسەوزی،	ژینگەپارێزی، لایەنگری لە پاراستنی ژینگە
"""),
// With short examples define "greenness", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) ئەوەی شتێک سەوز بێت لە ڕەنگدا"""),
                    SentencesRow(
                      englishText:
                          """I'll never forget the greenness of the grass.""",
                      kurdishText: """هەرگیز سەوزێتی سەوزەگیاکە لەبیر ناکەم.""",
                    ...
                    SentencesRow(
                      englishText:
                          """A warming trend on Arctic land causes an increase in greenness.""",
                      kurdishText:
                          """ترێندی گەرمبوونی جەمسەری باکوور بووە بە هۆکاری زیادبوونی سەوزایی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Supermarkets have started proclaiming the greenness of their products.""",
                      kurdishText:
                          """سوپەرمارکێتەکان دەستیان کردووە بە ناساندنی ژینگەدۆستی بەرهەمەکانیان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Ozb2r7c0hxA?t=';
const double _startSecondsend = 0000000000000000000000000001288;
const String _videoIdone = 'https://youtu.be/wfmeJ2T_txk?t=';
const double _startSecondsone = 0000000000000000000000000001732;
const String _videoIdtwo = 'https://youtu.be/xgs2ZIJqf7s?t=';
const double _startSecondstwo = 00000000000000000000000000048;
const String _videoIdthree = 'https://youtu.be/ZBt9EjmFBEg?t=';
const double _startSecondsthree = 000000000000000000000000000977;
const String _videoIdfour = 'https://youtu.be/azb3Ih68awQ?t=';
const double _startSecondsfour = 0000000000000000000000000006006;
const String _videoIdfive = 'https://youtu.be/WN1yCigL3Hk?t=';
const double _startSecondsfive = 000000000000000000000000000379;
