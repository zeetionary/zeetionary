...
class EnglishEntrylunacy extends StatefulWidget {
  const EnglishEntrylunacy({super.key});

  @override
  State<EnglishEntrylunacy> createState() => _EnglishEntrylunacyState();
}

class _EnglishEntrylunacyState extends State<EnglishEntrylunacy> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylunacy lunacy
WORD_WEB lunacy lunacy lunacy
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lunacy";
...
کوردی: 
"""),
// With short examples define "lunacy", please follow LX instructions
