...
class EnglishEntryhateful extends StatefulWidget {
  const EnglishEntryhateful({super.key});

  @override
  State<EnglishEntryhateful> createState() => _EnglishEntryhatefulState();
}

class _EnglishEntryhatefulState extends State<EnglishEntryhateful> {
  @override
  void initState() {
    super.initState();
...
2. Characterized by malice (- mean)
"a hateful thing to do";
""",
  );

  final String keyword = "hateful";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hateful""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I tried to ignore her hateful words.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hateful""",
                      // alsoEnglishWord: "also: hateful",
                      britshText: """IpaUK: /ˈheɪtfl/""",
                      americanText: """IpaUS: /ˈheɪtfl/""",
...
کوردی: بێزاوی، ناخۆش، قێزەون، پیس، بێزەون، ناشیرین، کرێت، دزێو
"""),
// With short examples define "hateful", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) زۆر نامیهرەبانانە و ناخۆش"""),
                    SentencesRow(
                      englishText:
                          """I don't understand how people can be so hateful to one another.""",
                      kurdishText:
                          """تێناگەم کە خەڵکی چۆن دەکرێت هێندە قێزەون بن دژ بە یەکدی.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I tried to ignore her hateful words.""",
                      kurdishText: """هەوڵم دا قسە ڕقاوییەکانی پشتگوێ بخەم.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/bXoXM0X9d0U?t=';
const double _startSecondsend = 000000000000000000000000000222;
const String _videoIdone = 'https://youtu.be/Ys1EjAGzuDk?t=';
const double _startSecondsone = 0000000000000000000000000001887;
const String _videoIdtwo = 'https://youtu.be/EmT0i0xG6zg?t=';
const double _startSecondstwo = 000000000000000000000000000659;
const String _videoIdthree = 'https://youtu.be/fC0eoM5Jwg4?t=';
const double _startSecondsthree = 000000000000000000000000000117;
const String _videoIdfour = 'https://youtu.be/RVEm5Am-tYc?t=';
const double _startSecondsfour = 000000000000000000000000000555;
const String _videoIdfive = 'https://youtu.be/j4kI2h3iotA?t=';
const double _startSecondsfive = 0000000000000000000000000001221;
