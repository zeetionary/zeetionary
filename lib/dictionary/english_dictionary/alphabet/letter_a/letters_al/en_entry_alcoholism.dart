...
// replace these: replace EnglishEntryalcoholism - replace speakAlcoholism - replace alcoholism - /ˈælkəhɒlɪzəm/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryalcoholism extends StatelessWidget {
  ...
  Future<void> speakalcoholism(String languageCode) async {
    ...
    await flutterTts.speak("alcoholism");
  }
  ...
  Future<void> speakalcoholism6582(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He finally sought treatment for his alcoholism.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈælkəhɒlɪzəm/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈælkəhɑːlɪzəm/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'cZ1ZJa6A5TY';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'Dtn47pm9w-Q';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'mfMBCBLVCvY';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '0uIdqmYoPEU';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'G7in_7y40e4';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'sSlqIB0mfmg';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'EIftRKJZXg0';
