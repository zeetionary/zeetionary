...
""",
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He could see a faint glow through the curtains.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fresh air had brought a healthy glow to her cheeks.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The sunset threw an orange glow on the cliffs.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""When she looked at her children, she felt a glow of pride.""");
  }
  ...
  Future<void> speaksentence100(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fresh air had brought a healthy glow to her cheeks.0""");
  }
...
کوردی: شەوق، ڕۆشنایی، ڕووناکی، تروسکە، بروسکە، درەوشانەوە، بریسکانەوە، بریقانەوە، بریقە، ورشە،	سوورهەڵگەڕان، گەرمی، تین‌وگوڕ، کوڵان، کەف‌وکوڵ، تاووتین، تاوتوێ، جۆش‌وخرۆش، جۆش‌سەندن، تاوسەندن، کڵپەکردن،	شادی، خۆشی، دڵخۆشی، سەرخۆشی، بەکەیفی، پێخۆش‌بوون، ڕەزامەندی، قایلی
"""),
// With short examples define "glow", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) درەوشانەوە بە کەمی"""),
                    SentencesRow(
                      englishText: """The lighted candles glowed in the darkness.""",
                      kurdishText: """مۆمەکە داگیرساوەکە لە تاریکییەکەدا دەدرەوشایەوە.""",
                    ...
                    SentencesRow(
                      englishText: """A dull light glowed in the kitchen window.""",
                      kurdishText: """ڕۆشناییەکی کز لە پەنجەرەی چێشتخانەکە دەدرەوشایەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """A red light glowed faintly just ahead of us.""",
                      kurdishText: """ڕووناکییەکی سووڕ بە کزی لە پێشمانەوە دەدرەوشایەوە.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) ئەوەی گەرمات بێت یان سوور بووبوویتەوە بەهۆی ڕاهێنانەوە یان بەهۆی ئەوەی بەجۆشیت، شەرمەزاریت، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕووخساری لە شەرمەزاریدا سوور بووبوویەوە.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) ئەوەی دڵخۆش یان ئاسوودە بیت"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She glowed with pleasure at the compliment.""",
                      kurdishText: """بە خۆشییەوە دەگەشایەوە بە ستایشکردنەکە.""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ناو) ڕۆشناییەک کە زۆر درەوشاوە نییە، وەک ڕۆشناییەکی ئاگرێک کە خەریکە دەکوژێتەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The city was just a red glow on the horizon.""",
                      kurdishText: """شارەکە لە ئاسۆوە تەنها درەوشانەوەیەکی سوور بوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He could see a faint glow through the curtains.""",
                      kurdishText: """دەیتوانی درەوشانەوەیەکی کز ببینێت لە پەردەکانەوە.""",
                      onPressedBritish: () => speaksentence9("en-GB"),
                      onPressedAmerican: () => speaksentence9("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (ناو) ڕەنگی سوور یان پەمەیی سەر ڕووخسار کە ڕاهێنانت زۆر کردووە یان دڵخۆش یان بەجۆشیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The fresh air had brought a healthy glow to her cheeks.""",
                      kurdishText: """هەوا پاکەکە تووشی سوورهەڵگەڕانی گۆناکانیی کردبوو.""",
                      onPressedBritish: () => speaksentence10("en-GB"),
                      onPressedAmerican: () => speaksentence10("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٦. (ناو) ڕەنگی ئاڵتوونی یان سوور"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The sunset threw an orange glow on the cliffs.""",
                      kurdishText: """خۆرئاوابوونەکە ڕەنگێکی پرتەقاڵی کرد بە بەری قەدپاڵەکاندا.""",
                      onPressedBritish: () => speaksentence11("en-GB"),
                      onPressedAmerican: () => speaksentence11("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٧. (ناو) هەستی دڵخۆشی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """When she looked at her children, she felt a glow of pride.""",
                      kurdishText: """کە سەیری منداڵەکانیی کرد هەستی بە دڵخۆشیی شانازی کرد.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The fresh air had brought a healthy glow to her cheeks.0""",
                      kurdishText: """رستە_رستە_رستە_رستە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/AF8d72mA41M';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/CXvG2CBJ3SE?t=';
const double _startSecondsone = 000000000000000000000000000223;
const String _videoIdtwo = 'https://youtu.be/dtp6b76pMak?t=';
const double _startSecondstwo = 000000000000000000000000000294;
const String _videoIdthree = 'https://youtu.be/fZJGTevM3QI?t=';
const double _startSecondsthree = 000000000000000000000000000146;
const String _videoIdfour = 'https://youtu.be/wir7jmefyec?t=';
const double _startSecondsfour = 000000000000000000000000000192;
const String _videoIdfive = 'https://youtu.be/3RkhZgRNC1k?t=';
const double _startSecondsfive = 0000000000000000000000000001375;
