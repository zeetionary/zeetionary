...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'iI48g7YTZFA';
    const double startSecondsend = 927;
    const String videoIdone = 'OPEh7UWmfDc';
    const double startSecondsone = 608;
    const String videoIdtwo = 'runjda4La_4';
    const double startSecondstwo = 1256;
    const String videoIdthree = 'pzE9HZHJ_ME';
    const double startSecondsthree = 984;
    const String videoIdfour = 'ncMoQs_HNmY';
    const double startSecondsfour = 4165;
    const String videoIdfive = 'K7XKmrGwmgY';
