                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "apprenticeship"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈprentɪʃɪp/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈprentɪʃɪp/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '21LvbKpHSiQ';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'j9Yg3gXgknI';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'G5cOZmbALxE';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'DTxiYm98hBs';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'H1jqxo5f-1g';
  final double _startSeconds = 1;
