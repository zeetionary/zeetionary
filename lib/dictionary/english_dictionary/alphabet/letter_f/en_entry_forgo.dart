...
class EnglishEntryforgo extends StatefulWidget {
  const EnglishEntryforgo({super.key});

  @override
  State<EnglishEntryforgo> createState() => _EnglishEntryforgoState();
}

class _EnglishEntryforgoState extends State<EnglishEntryforgo> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: forgo
1. Do without or cease to hold or adhere to (= waive, relinquish, forego, foreswear, dispense with)
"forgo the old ideas";
 
2. Lose (something) or lose the right to (something) by some error, offence, or crime (= forfeit, give up, throw overboard, waive, forego)
""",
  );

  final String keyword = "forgo";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forgo""",
                      // alsoEnglishWord: "also: forgo",
                      britshText: """IpaUK: /fɔːˈɡəʊ/""",
                      americanText: """IpaUS: /fɔːrˈɡəʊ/""",
...
// With short examples define "forgo", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) ئەوەی بڕیار بدەیت دەستبەرداری هەبوون یان کردنی شتێک ببیت"""),
                    SentencesRow(
                      englishText:
                          """No one was prepared to forgo their lunch hour to attend the meeting.""",
                      kurdishText:
                          """هیچ کەس ئامادە نەبوو دەستبەرداری کاتی نانی نیوەڕۆ بێت بۆ بەژداری لە چاوپێکەوتنەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I shall have to forgo the pleasure of seeing you this week.""",
                      kurdishText:
                          """دەبێت دەستبەرداری تامی بینینت بم بۆ ئەم هەفتەیە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/KxoktuehP3c?t=';
const double _startSecondsend = 000000000000000000000000000123;
const String _videoIdone = 'https://youtu.be/Ky1c6d7v0pQ?t=';
const double _startSecondsone = 000000000000000000000000000922;
const String _videoIdtwo = 'https://youtu.be/CCrtZwF2C-8?t=';
const double _startSecondstwo = 000000000000000000000000000729;
const String _videoIdthree = 'https://youtu.be/Oid4FlNR83Y?t=';
const double _startSecondsthree = 000000000000000000000000000396;
const String _videoIdfour = 'https://youtu.be/eJ-WJssJgdg?t=';
const double _startSecondsfour = 0000000000000000000000000003944;
const String _videoIdfive = 'https://youtu.be/jb5Q-wQh4GI?t=';
