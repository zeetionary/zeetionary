...
class EnglishEntryhighlife extends StatefulWidget {
  const EnglishEntryhighlife({super.key});

  @override
  State<EnglishEntryhighlife> createState() => _EnglishEntryhighlifeState();
}

class _EnglishEntryhighlifeState extends State<EnglishEntryhighlife> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: highlife
1. The activity of excessive spending (- extravagance, prodigality, lavishness, high life)
""",
  );

  final String keyword = "highlife";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""highlife""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The band played highlife music at the party.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """highlife""",
                      // alsoEnglishWord: "also: highlife",
                      britshText: """IpaUK: /ˈhaɪlaɪf/""",
                      americanText: """IpaUS: /ˈhaɪlaɪf/""",
...
کوردی: ژیانی دەوڵەمەندانە، ژیانی پڕدێدی‌وبۆدی
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) جۆرێک لە سەما و میوزیکی ڕۆژئاوای ئەفریقا کە کاریگەر بوو بە ڕؤک و جاز و زیاتر لە ساڵانی ١٩٥٠ ــیەکان و ١٩٦٠ ـەکان بەناوبانگ بوو"""),
                    SentencesRow(
                      englishText:
                          """The band played highlife music at the party.""",
                      kurdishText:
                          """باندەکە میوزیکی هایلایفیان لێدا لە ئاهەنگەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ytMNr9gLqE4?t=';
const double _startSecondsend = 0000000000000000000000000001371;
const String _videoIdone = 'https://youtu.be/gKEEgMf45HM?t=';
const double _startSecondsone = 000000000000000000000000000113;
const String _videoIdtwo = 'https://youtu.be/ryTTHmUYc2o?t=';
const double _startSecondstwo = 000000000000000000000000000195;
const String _videoIdthree = 'https://youtu.be/QDYBvXWYfwA?t=';
const double _startSecondsthree = 000000000000000000000000000200;
const String _videoIdfour = 'https://youtu.be/eLuFoKE3zn4?t=';
const double _startSecondsfour = 000000000000000000000000000291;
const String _videoIdfive = 'https://youtu.be/xE4IevvfVZ4?t=';
