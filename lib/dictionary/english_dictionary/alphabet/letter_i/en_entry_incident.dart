...
class EnglishEntryincident extends StatefulWidget {
  const EnglishEntryincident({super.key});

  @override
  State<EnglishEntryincident> createState() => _EnglishEntryincidentState();
}

class _EnglishEntryincidentState extends State<EnglishEntryincident> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incident""");
  }
...
// With short examples define "incident", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) شتێک کە ڕوودەدات، بە تایبەتی شتێکی ناخۆش"""),
                    SentencesRow(
