...
class EnglishEntryaccession extends StatefulWidget {
  const EnglishEntryaccession({super.key});

  @override
  State<EnglishEntryaccession> createState() => _EnglishEntryaccessionState();
}

class _EnglishEntryaccessionState extends State<EnglishEntryaccession> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "accession";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accession""",
                      // alsoEnglishWord: "also: accession",
                      britshText: """IpaUK: /əkˈseʃn/""",
                      americanText: """IpaUS: /əkˈseʃn/""",
