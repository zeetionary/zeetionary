...
class EnglishEntryhardpressed extends StatefulWidget {
  const EnglishEntryhardpressed({super.key});

  @override
  State<EnglishEntryhardpressed> createState() =>
      _EnglishEntryhardpressedState();
}

class _EnglishEntryhardpressedState extends State<EnglishEntryhardpressed> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hard-pressed
1. Facing or experiencing financial trouble or difficulty (- distressed, hard put, in a bad way)
"financially hard-pressed Mexican hotels are lowering their prices";
""",
  );

  final String keyword = "hard-pressed";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hard-pressed""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""You would be hard-pressed to find a better secretary.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hard-pressed""",
                      // alsoEnglishWord: "also: hard-pressed",
                      britshText: """IpaUK: /ˌhɑːd ˈprest/""",
                      americanText: """IpaUS: /ˌhɑːrd ˈprest/""",
...
// With short examples define "hard-pressed", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The latest education reforms have put extra pressure on teachers who are already hard-pressed.""",
                      kurdishText:
                          """تازەترین چاکسازییەکانی پەروەردە فشاری زیاتری خستووەتە سەر مامۆستایان کە بۆ خۆیان لەژێر گوشار بوون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """سەخت دەبێت بۆت سکرتێرێک بدۆزیتەوە.""",
