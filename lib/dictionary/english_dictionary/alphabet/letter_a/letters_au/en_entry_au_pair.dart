...
class EnglishEntryaupair extends StatelessWidget {
  ...
  Future<void> speakaupair(String languageCode) async {
    ...
    await flutterTts.speak("au pair");
  }
  ...
  Future<void> speakaupair402(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She worked in Paris for six months as an au pair.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌəʊ ˈpeə(r)/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌəʊ ˈper/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'OvJWpCAO6Bo';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'AL2W3nm-GJ4';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'H9VtJ5xjND4';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'kudHVV791As';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'N4uZPwRL6PQ';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'sNxUFB6hf-0';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'R6mCwMbJDFs';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = '4ImneY-SZAA';
