...
class EnglishEntryhappily extends StatefulWidget {
  const EnglishEntryhappily({super.key});

  @override
  State<EnglishEntryhappily> createState() => _EnglishEntryhappilyState();
}

class _EnglishEntryhappilyState extends State<EnglishEntryhappily> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: happily
1. In a joyous manner (- merrily, mirthfully, gayly, blithely, jubilantly, euphorically)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""happily""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I think we can manage quite happily on our own.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""And they all lived happily ever after.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Happily, the damage was only slight.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'll happily help, if I can.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """happily""",
                      // alsoEnglishWord: "also: happily",
                      britshText: """IpaUK: /ˈhæpɪli/""",
                      americanText: """IpaUS: /ˈhæpɪli/""",
...
// With short examples define "happily", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پێموایە دەتوانین زۆر دڵخۆشانە بۆ خۆمان بژین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە ئامادەییەوە یارمەتی دەدەم، ئەگەر بتوانم.""",
                    ...
                    SentencesRow(
                      englishText:
                          """This suggestion did not fit very happily with our existing plans.""",
                      kurdishText:
                          """ئەم پێشنیارە زۆر باش نەگونجا لەگەڵ پلانەکانی خۆمان.""",
