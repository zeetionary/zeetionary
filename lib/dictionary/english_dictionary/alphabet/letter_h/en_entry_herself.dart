...
class EnglishEntryherself extends StatefulWidget {
  const EnglishEntryherself({super.key});

  @override
  State<EnglishEntryherself> createState() => _EnglishEntryherselfState();
}

class _EnglishEntryherselfState extends State<EnglishEntryherself> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Pronoun: herself
1. Reflexive form of "her"
"she never lost control of herself"
""",
  );

  final String keyword = "herself";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""herself""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She hurt herself.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She must be very proud of herself.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She stared at herself in the bathroom mirror.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She berated herself for being a bad mother.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She could not bring herself to tell him the news.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She told me the news herself.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Jane herself was at the meeting.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """herself""",
                      // alsoEnglishWord: "also: herself",
                      britshText: """IpaUK: /hɜːˈself/, weak form /həˈself/""",
                      americanText:
                          """IpaUS: /hɜːrˈself/, weak form /hərˈself/""",
...
کوردی: 
"""),
// With short examples define "herself", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (جێناو) (جێناوی خۆیی) بەکاردێت کە ژنێک یان کچێک کە کارێک دەکات کاریگەر دەبێت پێی"""),
                    SentencesRow(
                      englishText: """She hurt herself.""",
                      kurdishText: """ئازاری خۆی دا.""",
                        ...
                        MyExpansionTile(
                          children: [
                            SentencesRow(
                              ...
                              kurdishText:
                                  """دەبێت زۆر شانازی بە خۆیەوە بکات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (جێناو) بۆ جەختکردنەوە لە بکەر یان بەرکاری مێینە لە ڕستەیەک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She told me the news herself.""",
                      kurdishText: """خودی خۆی هەواڵەکەی پێ گوتم.""",
...
const double _startSecondsend = 000000000000000000000000000533;
const String _videoIdone = 'https://youtu.be/544DTGHIBM0?t=';
const double _startSecondsone = 000000000000000000000000000513;
const String _videoIdtwo = 'https://youtu.be/NZ74oFctP_g?t=';
...
const String _videoIdfour = 'https://youtu.be/tsE1rMH18Tk?t=';
const double _startSecondsfour = 000000000000000000000000000430;
const String _videoIdfive = 'https://youtu.be/MiipO0rq-g0?t=';
const double _startSecondsfive = 0000000000000000000000000006;
