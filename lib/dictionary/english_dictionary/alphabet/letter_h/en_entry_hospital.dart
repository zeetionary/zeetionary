...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '2fch6wJNuxE';
    const double startSecondsend = 3;
    const String videoIdone = 'ztH77Bl4qns';
    const double startSecondsone = 18;
    const String videoIdtwo = 'AdqQWg3ImEw';
    const double startSecondstwo = 158;
    const String videoIdthree = 'CmhFPjE6U8k';
    const double startSecondsthree = 100;
    const String videoIdfour = 'e8Zbzv8Vq2o';
    const double startSecondsfour = 25;
    const String videoIdfive = '4tZt5axOB80';
