...
class EnglishEntrycircumstantial extends StatelessWidget {
  // blank divider
  EnglishEntrycircumstantial({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcircumstantial(String languageCode) async {
    // DOPSUM: CHANGE speakcircumstantial
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "circumstantial"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌsɜːkəmˈstænʃl/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcircumstantial("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUS: /ˌsɜːrkəmˈstænʃl/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcircumstantial("en-US"),
                            ),
                          ],
                        ),
                      ],
...
کوردی: تێروتەسەل، چڕوپڕ، ورد، پڕ لە وردەکاری، دوورودرێژ،	لاوەکی، ناگرنگ، ڕێکەوتی، پێوەندی‌دار بەڵام نە بنەڕەتی
"""),
...
1. Indirectly suggesting something (esp. guilt), but not directly proving it
...
2. Fully detailed and specific about particulars
