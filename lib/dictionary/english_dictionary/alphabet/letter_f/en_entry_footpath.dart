...
class EnglishEntryfootpath extends StatefulWidget {
  const EnglishEntryfootpath({super.key});

  @override
  State<EnglishEntryfootpath> createState() => _EnglishEntryfootpathState();
}

class _EnglishEntryfootpathState extends State<EnglishEntryfootpath> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
Noun: footpath (Derived forms: footpaths)
1. A trodden path (= pathway)
 
2. [Austral, NZ, Ireland] Walk consisting of a paved area for pedestrians; usually beside a street or roadway (= sidewalk [N. Amer], pavement [Brit])
""",
  );

  final String keyword = "footpath";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""footpath""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We walked along the footpath.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Follow the marked footpath.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """footpath""",
                      // alsoEnglishWord: "also: footpath",
                      britshText: """IpaUK: /ˈfʊtpɑːθ/""",
                      americanText: """IpaUS: /ˈfʊtpæθ/""",
...
// With short examples define "footpath", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """We walked along the footpath.""",
                      kurdishText: """بە کوێرەڕێیەکەدا چووین.""",
                    ...
                    SentencesRow(
                      englishText: """Follow the marked footpath.""",
                      kurdishText: """بە پێڕێیە دیاریکراوەکەدا بچۆ.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Gfj5f0GVLZ0?t=';
const double _startSecondsend = 000000000000000000000000000101;
const String _videoIdone = 'https://youtu.be/vWhYlu7ZfYM?t=';
const double _startSecondsone = 00000000000000000000000000072;
const String _videoIdtwo = 'https://youtu.be/jyYqhRc9Qsw?t=';
const double _startSecondstwo = 000000000000000000000000000846;
const String _videoIdthree = 'https://youtu.be/yM5psEkA1t4?t=';
const double _startSecondsthree = 000000000000000000000000000486;
const String _videoIdfour = 'https://youtu.be/IqbAkAjOw5s?t=';
const double _startSecondsfour = 000000000000000000000000000414;
const String _videoIdfive = 'https://youtu.be/EQXyhM592RU?t=';
