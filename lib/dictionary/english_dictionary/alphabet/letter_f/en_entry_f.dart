...
class EnglishEntryf extends StatefulWidget {
  const EnglishEntryf({super.key});

  @override
  State<EnglishEntryf> createState() => _EnglishEntryfState();
}

class _EnglishEntryfState extends State<EnglishEntryf> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """f""",
                      // alsoEnglishWord: "also: f",
                      britshText: """IpaUK: /ef/""",
                      americanText: """IpaUS: /ef/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""‘Fox’ begins with (an) F/‘F’.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He got an F in chemistry.""");
  }
...
"""),
          ...
          SentencesRow(
            englishText: """‘Fox’ begins with (an) F/‘F’.""",
            kurdishText: """وشەی Fox بە F/F دەست پێدەکات.""",
          ...
          const DividerDefinition(),
          const DefinitionKurdish(text: """ژممارە. (کورتکراوە) پێنناسە"""),
          const DividerSentences(),
          SentencesRow(
...
3. The capacitance of a capacitor that has an equal and opposite charge of 1 coulomb on each plate and a voltage difference of 1 volt between the plates (= farad)
""",
  );
...
const String _videoIdend = 'https://youtu.be/BuWkV5ckB4s?t=';
const double _startSecondsend = 00000000000000000000000000064;
const String _videoIdone = 'https://youtu.be/xY3Z8acE8ew?t=';
const double _startSecondsone = 00000000000000000000000000024;
const String _videoIdtwo = 'https://youtu.be/8G7fr3MonQY?t=';
const double _startSecondstwo = 0000000000000000000000000004;
const String _videoIdthree = 'https://youtu.be/hTqtGJwsJVE?t=';
const double _startSecondsthree = 000000000000000000000000000811;
const String _videoIdfour = 'https://youtu.be/tsxmyL7TUJg?t=';
const double _startSecondsfour = 000000000000000000000000000896;
const String _videoIdfive = 'https://youtu.be/RIQDmnIJZv8?t=';
