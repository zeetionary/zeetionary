...
class EnglishEntrylacquer extends StatefulWidget {
  const EnglishEntrylacquer({super.key});

  @override
  State<EnglishEntrylacquer> createState() => _EnglishEntrylacquerState();
}

class _EnglishEntrylacquerState extends State<EnglishEntrylacquer> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lacquer""");
  }
