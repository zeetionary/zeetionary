...
// Define the word "have had a bellyful of" and provide five simple example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings or more.

// replace have had a bellyful of - replace EnglishEntryhavehadabellyfulof

// replace speakHavehadabellyfulof - /hæv hæd ə ˈbelifʊl əv/

enum TtsState { playing }

class EnglishEntryhavehadabellyfulof extends StatelessWidget {
// blank divider
  EnglishEntryhavehadabellyfulof({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakHavehadabellyfulof(String languageCode) async {
    // DOPSUM: CHANGE speakHavehadabellyfulof
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "have had a bellyful of"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUK: /hæv hæd ə ˈbelifʊl əv/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakHavehadabellyfulof("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUS: /hæv hæd ə ˈbelifʊl əv/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakHavehadabellyfulof("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  static String myVideoId = "VxAkNnEONWw";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  static String myVideoId = "8OA7fc2kEck";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  static String myVideoId = "qWC5GZ2lEMw";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  static String myVideoId = "Kpq892DX63g";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  static String myVideoId = "pYifwjUomYY";
