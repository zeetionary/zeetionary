...
class EnglishEntryaccompany extends StatefulWidget {
  const EnglishEntryaccompany({super.key});

  @override
  State<EnglishEntryaccompany> createState() => _EnglishEntryaccompanyState();
}

class _EnglishEntryaccompanyState extends State<EnglishEntryaccompany> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "accompany";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accompany""",
                      // alsoEnglishWord: "also: accompany",
                      britshText: """IpaUK: /əˈkʌmpəni/""",
                      americanText: """IpaUS: /əˈkʌmpəni/""",
