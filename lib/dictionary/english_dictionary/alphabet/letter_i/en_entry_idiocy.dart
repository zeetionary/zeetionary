...
class EnglishEntryidiocy extends StatefulWidget {
  const EnglishEntryidiocy({super.key});

  @override
  State<EnglishEntryidiocy> createState() => _EnglishEntryidiocyState();
}

class _EnglishEntryidiocyState extends State<EnglishEntryidiocy> {
  @override
  void initState() {
    super.initState();
