...
class EnglishEntrygreasily extends StatefulWidget {
  const EnglishEntrygreasily({super.key});

  @override
  State<EnglishEntrygreasily> createState() => _EnglishEntrygreasilyState();
}

class _EnglishEntrygreasilyState extends State<EnglishEntrygreasily> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""greasily""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Lice scuttled greasily through her hair.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The newspaper commented greasily about her sexual affair.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """greasily""",
                      // alsoEnglishWord: "also: greasily",
                      britshText: """IpaUK: /ˈɡriː.səl.i/""",
                      americanText: """IpaUS: /ˈɡriː.səl.i/""",
...
کوردی: 
"""),
// With short examples define "greasily", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) کە چەوری زۆرە"""),
                    SentencesRow(
                      englishText:
                          """Lice scuttled greasily through her hair.""",
                      kurdishText:
                          """ئەسپێ بە چەوری زۆرەوە لە قژیدا هاتووچۆیان بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕۆژنامەکە بە ناشرینی باسی پەیوەندییە سۆزدارییەکەیی کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/29CwHDrJYfY?t=';
const double _startSecondsend = 000000000000000000000000000185;
const String _videoIdone = 'https://youtu.be/BLKD2Wf8_wk?t=';
const double _startSecondsone = 00000000000000000000000000014072;
const String _videoIdtwo = 'https://youtu.be/tX3ZyprxRPA?t=';
const double _startSecondstwo = 000000000000000000000000000139;
const String _videoIdthree = 'https://youtu.be/2UNX3YrDe-4?t=';
const double _startSecondsthree = 000000000000000000000000000539;
const String _videoIdfour = 'https://youtu.be/cezNlHiHnhQ?t=';
const double _startSecondsfour = 0000000000000000000000000001293;
const String _videoIdfive = 'https://youtu.be/2jKcype2Ei4?t=';
const double _startSecondsfive = 0000000000000000000000000004983;
