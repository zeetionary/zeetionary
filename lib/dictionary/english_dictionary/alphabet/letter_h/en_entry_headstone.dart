...
class EnglishEntryheadstone extends StatefulWidget {
  const EnglishEntryheadstone({super.key});

  @override
  State<EnglishEntryheadstone> createState() => _EnglishEntryheadstoneState();
}

class _EnglishEntryheadstoneState extends State<EnglishEntryheadstone> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: headstone (Derived forms: headstones)
1. The central building block at the top of an arch or vault (- keystone, key)
 
2. A stone that is used to mark a grave (- gravestone, tombstone)
""",
  );

  final String keyword = "headstone";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""headstone""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """headstone""",
                      // alsoEnglishWord: "also: headstone",
                      britshText: """IpaUK: /ˈhedstəʊn/""",
                      americanText: """IpaUS: /ˈhedstəʊn/""",
...
کوردی: سەرین، هەنگێز، کێل، بەردی گۆر، میل
"""),
// With short examples define "headstone", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) کێلی سەر قەبر"""),
                    SentencesRow(
                      englishText:
                          """Both are buried at Orton churchyard in a grave without a headstone.""",
                      kurdishText:
                          """هەردووکیان لە گۆڕستانی ئۆرتۆن نێژراون لە گۆڕێک بەبێ کێل.""",
...
const double _startSecondsend = 0000000000000000000000000001073;
const String _videoIdone = 'https://youtu.be/ejFccNmL15g?t=';
const double _startSecondsone = 000000000000000000000000000559;
const String _videoIdtwo = 'https://youtu.be/B5ytcg5pYEA?t=';
const double _startSecondstwo = 000000000000000000000000000264;
const String _videoIdthree = 'https://youtu.be/pSFc9hCNq9E?t=';
const double _startSecondsthree = 0000000000000000000000000001430;
const String _videoIdfour = 'https://youtu.be/T_JWN08tx1g?t=';
const double _startSecondsfour = 000000000000000000000000000564;
const String _videoIdfive = 'https://youtu.be/zmsUAEctRLY?t=';
