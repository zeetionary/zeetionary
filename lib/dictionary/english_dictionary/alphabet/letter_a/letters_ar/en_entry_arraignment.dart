...
class EnglishEntryarraignment extends StatelessWidget {
  ...
  Future<void> speakarraignment(String languageCode) async {
    ...
    await flutterTts.speak("arraignment");
  }
  ...
  Future<void> speakarraignment1250(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("A date for her arraignment has not yet been set.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arraignment"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈreɪnmənt/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakarraignment("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈreɪnmənt/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakarraignment("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'TBRGdhSF3WA';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'T8s2vqUqYCg';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'NRGULmBPS8c';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'yfljFmhqFm4';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Wr0G0CbK2tw';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final double _startSeconds = 2914;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'B-KroMPyUFU';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'UlRPE1OPAWw';
