...
class EnglishEntryinterlude extends StatefulWidget {
  const EnglishEntryinterlude({super.key});

  @override
  State<EnglishEntryinterlude> createState() => _EnglishEntryinterludeState();
}

class _EnglishEntryinterludeState extends State<EnglishEntryinterlude> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""interlude""");
  }
