...
class EnglishEntryhail extends StatefulWidget {
  const EnglishEntryhail({super.key});

  @override
  State<EnglishEntryhail> createState() => _EnglishEntryhailState();
}

class _EnglishEntryhailState extends State<EnglishEntryhail> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: hail (Derived forms: hailed, hailing, hails)
1. Praise vociferously (- acclaim, herald)
"The critics hailed the young pianist as a new Rubinstein";
 
2. Be a native of (- come)
"She hails from Kalamazoo";
 
3. Call for
"hail a cab"
 
4. Greet enthusiastically or joyfully (- herald)
 
5. Precipitate as small ice particles
"It hailed for an hour"

- Noun: hail (Derived forms: hails)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The conference was hailed as a great success.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She hailed a taxi on the busy street.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""A voice hailed us from the other side of the street.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It's hailing!""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We drove through hail and snow.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hail""",
                      // alsoEnglishWord: "also: hail",
                      britshText: """IpaUK: /heɪl/""",
                      americanText: """IpaUS: /heɪl/""",
...
// With short examples define "hail", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کۆنفرانسەکە بە سەرکەوتنێکی گەورە ناوزەد کرا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لەسەر شەقامە قەرەباڵغەکە دەستی لە تەکسییەک ڕاگرت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەنگێک لە لایەکەی دیکەی شەقامەکەوە بانگی کردین.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The soldiers faced a deadly hail of arrows from the enemy.""",
                      kurdishText:
                          """سەربازەکان ڕووبەڕووی تیربارانێکی کوشندەی دوژمن بوونەوە.""",
...
const double _startSecondsone = 000000000000000000000000000454;
const String _videoIdtwo = 'https://youtu.be/tXjHb5QmDV0?t=';
...
const String _videoIdfour = 'https://youtu.be/lGSOWwUvJiU?t=';
const double _startSecondsfour = 0000000000000000000000000001402;
const String _videoIdfive = 'https://youtu.be/YwOMc-4OEWg?t=';
const double _startSecondsfive = 00000000000000000000000000075;
