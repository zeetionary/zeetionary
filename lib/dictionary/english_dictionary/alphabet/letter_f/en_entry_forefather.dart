...
class EnglishEntryforefather extends StatefulWidget {
  const EnglishEntryforefather({super.key});

  @override
  State<EnglishEntryforefather> createState() => _EnglishEntryforefatherState();
}

class _EnglishEntryforefatherState extends State<EnglishEntryforefather> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forefather (Derived forms: forefathers)
1. The founder of a family (= father, sire)
...
""",
  ...
  final String keyword = "forefather";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forefather""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Our forefathers fought for equal justice under the law.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forefather""",
                      // alsoEnglishWord: "also: forefather",
                      britshText: """IpaUK: /ˈfɔːfɑːðə(r)/""",
                      americanText: """IpaUS: /ˈfɔːrfɑːðər/""",
...
// With short examples define "forefather", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """باپیرانمان جەنگان بۆ دادپەروەری یەکسان بە پێی یاسا.""",
...
const String _videoIdone = 'https://youtu.be/AecFpnj383A?t=';
const double _startSecondsone = 000000000000000000000000000558;
const String _videoIdtwo = 'https://youtu.be/qypTsTciYFc?t=';
const double _startSecondstwo = 000000000000000000000000000862;
const String _videoIdthree = 'https://youtu.be/QefprURGzzI?t=';
const double _startSecondsthree = 00000000000000000000000000089;
const String _videoIdfour = 'https://youtu.be/YZTJGMHBJ4M?t=';
const double _startSecondsfour = 000000000000000000000000000666;
const String _videoIdfive = 'https://youtu.be/f7rlG7MOlsY?t=';
