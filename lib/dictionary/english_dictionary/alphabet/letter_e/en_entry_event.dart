...
class EnglishEntryevent extends StatefulWidget {
  const EnglishEntryevent({super.key});

  @override
  State<EnglishEntryevent> createState() => _EnglishEntryeventState();
}

class _EnglishEntryeventState extends State<EnglishEntryevent> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """event""",
                      // alsoEnglishWord: "also: event",
                      britshText: """IpaUK: /ɪˈvent/""",
                      americanText: """IpaUS: /ɪˈvent/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Why should we believe his version of events?""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The election was the main event of 2017.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Outside big cities, murder is a rare event.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Is the city ready to host such a major sporting event?""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They were invited to attend the social event of the year.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Forty such events are scheduled this year.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The 800 metres is the fourth event of the afternoon.""");
  }
...
کوردی: ڕووداو، بوویەر، بەسەرهات، سەرهات، سەربورد، قەوماو، قەومین، پێشهات، ڕوودان،	ئاکام، ئەنجام،	پێشبڕکێ
"""),
          const DefinitionKurdish(
              text: """١. (ناو) شتێک کە ڕوودەدات، بەتایبەتی شتێکی گرنگ"""),
          SentencesRow(
            englishText:
                """Historians long ago established that the event never happened.""",
            kurdishText:
                """مێژوونووسان زوو سەلماندیان کە ڕووداوەکە ڕووینەدا.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """TV viewers watched in horror as events unfolded.""",
            kurdishText:
          ...
          SentencesRow(
            ...
            kurdishText: """بۆچی دەبێت باوەڕ بە گێڕانەوەی ڕووداوەکانی بکەین؟""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """ئەو بڕیارانەی ئێستا دەیان دەین ڕەنگە کاریگەری لەسەر ئاقاری ڕووداوەکان لە داهاتوودا دابنێن.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """زانی کە ئەو ڕاپۆرتەی نووسیبووی لە ڕووداوەکان جێماوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The election was the main event of 2017.""",
            kurdishText: """هەڵبژاردنەکە ڕووداوی سەرەکیی ٢٠١٧ بوو.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Outside big cities, murder is a rare event.""",
            kurdishText:
                """لە دەرەوەی شارە گەورەکان، کوشتن ڕووداوێکی دەگمەنە.""",
            onPressedBritish: () => speaksentence7("en-GB"),
            onPressedAmerican: () => speaksentence7("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) بۆنەیەکی گشتی یان کۆمەڵایەتی"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Is the city ready to host such a major sporting event?""",
            kurdishText:
                """ئایا شارەکە ئامادەیە میوانداری بۆنەیەکی وەرزشی وەها گەورە بکات؟""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """بانگهێشت کران بۆ بەژداری لە بۆنەی کۆمەڵایەتی ساڵەکە.""",
          ...
          SentencesRow(
            englishText:
                """Events are taking place throughout the summer to celebrate the city's centenary.""",
            kurdishText:
                """بە درێژایی هاوین بۆنە ساز دەکرێت بۆ یادکردنەوەی سەد ساڵەی شارەکە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Forty such events are scheduled this year.""",
            kurdishText: """چل بۆنەیەک (نزیکەی چل) بۆ ئەمساڵ ڕێکخراون.""",
          ...
          const DefinitionKurdish(
              text:
                  """٣. (ناو) یەکێک لە پێشبڕکێ یان ڕکابەرییەکانی پڕۆگرامی تەلەفیزیۆنی"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The 800 metres is the fourth event of the afternoon.""",
            kurdishText: """٨٠٠ مەترییەکە بۆنەی چوارەمی نیوەرۆکەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He will represent Scotland in the team event.""",
            kurdishText: """لە پێشبڕکێ تیمییەکە نوێنەرایەتی سکۆتلەندا دەکات.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: event (Derived forms: events)
1. Something that happens at a given place and time
 
2. A special set of circumstances (= case)
"in that event, the first possibility is excluded";
 
3. (physics) a phenomenon located at a single point in space-time; the fundamental observational entity in relativity theory
 
4. A phenomenon that follows and is caused by some previous phenomenon (= consequence, effect, outcome, result, issue, upshot)
"he acted very wise after the event";
 
5. (computing) a possible action that the user can perform, monitored by an application or the operating system
""",
  );
...
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/D0x2dgpBDzc?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1324;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/lsFPbgK1v9I?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 263;
const String _videoIdthree = 'VIDEOhttps://youtu.be/U1KGRnWjllg?t=';
const double _startSecondsthree = 000000000000000000000000000; // 267;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/D5mAhrkaMds?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 281;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/pwKxCVcQU60?t=';
