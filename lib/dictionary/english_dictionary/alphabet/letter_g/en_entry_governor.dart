...
class EnglishEntrygovernor extends StatefulWidget {
  const EnglishEntrygovernor({super.key});

  @override
  State<EnglishEntrygovernor> createState() => _EnglishEntrygovernorState();
}

class _EnglishEntrygovernorState extends State<EnglishEntrygovernor> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""governor""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I'll have to present my plan to the board of governors.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He is a former governor of the Bank of England.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """governor""",
                      // alsoEnglishWord: "also: governor",
                      britshText: """IpaUK: /ˈɡʌvənə(r)/""",
                      americanText: """IpaUS: /ˈɡʌvərnər/""",
...
// With short examples define "governor", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە حکومڕانی هەرێم یان وڵاتێکە کە لەلایەن وڵاتێکی دیکەوە بەڕێوە دەبرێت"""),
                    SentencesRow(
                      englishText:
                          """He was confirmed as the provincial governor for another five-year term.""",
                      kurdishText:
                          """وەک حاکمی پارێزگاکە بۆ پێنج ساڵی دیکە دانرایەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The report was written by Chris Patten, the former governor of Hong Kong.""",
                      kurdishText:
                          """ڕاپۆرتەکە لەلایەن کریس پاتنی پارێزگاری پێشووی هۆنگ کۆنگەوە نووسرابوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She has officially launched her campaign to become state governor.""",
                      kurdishText:
                          """بە فەرمی کەمپینەکەیی دەستپێکردووە بۆ بوون بە حاکمی ویلایەتەکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) کەسێک کە سەر بە دەستەی بەڕێوەبردنی قوتابخانە، کۆلێژ، نەخۆشخانە، هتد ــە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I'll have to present my plan to the board of governors.""",
                      kurdishText:
                          """دەبێت پلانەکەم پێشکەشی دەستەی بەڕێوەبەران بکەم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بەرپرسی پێشووتری بانکی ئینگلاندە.""",
...
const double _startSecondsend = 000000000000000000000000000655;
const String _videoIdone = 'https://youtu.be/QLq6GEiHqR8?t=';
const double _startSecondsone = 000000000000000000000000000668;
const String _videoIdtwo = 'https://youtu.be/Unzc731iCUY?t=';
const double _startSecondstwo = 0000000000000000000000000003528;
const String _videoIdthree = 'https://youtu.be/bcdEFos9YQQ?t=';
const double _startSecondsthree = 000000000000000000000000000952;
const String _videoIdfour = 'https://youtu.be/Is1IWMPNqh4?t=';
const double _startSecondsfour = 000000000000000000000000000599;
const String _videoIdfive = 'https://youtu.be/W5tlGJwvmCQ?t=';
