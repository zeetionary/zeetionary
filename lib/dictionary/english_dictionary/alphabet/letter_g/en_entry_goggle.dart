...
class EnglishEntrygoggle extends StatefulWidget {
  const EnglishEntrygoggle({super.key});

  @override
  State<EnglishEntrygoggle> createState() => _EnglishEntrygoggleState();
}

class _EnglishEntrygoggleState extends State<EnglishEntrygoggle> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The cathedral was full of goggling tourists.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""My swimming goggles keep steaming up so I can’t see.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """goggle""",
                      // alsoEnglishWord: "also: goggle",
                      britshText: """IpaUK: /ˈɡɒɡl/""",
                      americanText: """IpaUS: /ˈɡɑːɡl/""",
...
// With short examples define "goggle", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) سەیرکردنی شتێک، بە تایبەتی بەهۆی ئەوەی سەرسامیت"""),
                    SentencesRow(
                      englishText:
                          """The cathedral was full of goggling tourists.""",
                      kurdishText: """کڵێساکە پڕ بوو لە گەشتیاری چاوگێڕ.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) چاویلکەیەک کە تەواو دەنووسێت بە دەرووبەری چاو بۆ پاراستنی لە تۆز، با، ئاو، هتد، یان بۆ پێدانی بینایی زیاتر"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """My swimming goggles keep steaming up so I can’t see.""",
                      kurdishText:
                          """چاوپارێزەکانم بەردەوام هەڵم دەگرن بۆیە ناتوانم ببینم.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/FPAk81X3tTY?t=';
...
const String _videoIdtwo = 'https://youtu.be/IZ_SFbaysHk?t=';
const double _startSecondstwo = 000000000000000000000000000154;
const String _videoIdthree = 'https://youtu.be/W2hRTTTpmr8?t=';
const double _startSecondsthree = 000000000000000000000000000665;
const String _videoIdfour = 'https://youtu.be/GjwZMyf2WmU?t=';
const double _startSecondsfour = 0000000000000000000000000001074;
const String _videoIdfive = 'https://youtu.be/-BeTq99LqUo?t=';
