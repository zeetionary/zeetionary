...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'zQZAIhP0H2A';
    const double startSecondsone = 729;
    const String videoIdtwo = 'Vnf6hbRfIv0';
    const double startSecondstwo = 570;
    const String videoIdthree = 'DG8rPBlbOrY';
    const double startSecondsthree = 375;
    const String videoIdfour = 'WCG3WgYxPkI';
    const double startSecondsfour = 10;
    const String videoIdfive = '1eYZnCx-02g';
