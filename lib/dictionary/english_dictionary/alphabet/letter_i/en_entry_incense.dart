...
class EnglishEntryincense extends StatefulWidget {
  const EnglishEntryincense({super.key});

  @override
  State<EnglishEntryincense> createState() => _EnglishEntryincenseState();
}

class _EnglishEntryincenseState extends State<EnglishEntryincense> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incense""");
  }
