...
class EnglishEntryfiddling extends StatefulWidget {
  const EnglishEntryfiddling({super.key});

  @override
  State<EnglishEntryfiddling> createState() => _EnglishEntryfiddlingState();
}

class _EnglishEntryfiddlingState extends State<EnglishEntryfiddling> {
  @override
  void initState() {
    super.initState();
...
- Adjective: fiddling
Usage: informal
1. Small and of little importance (= footling [informal], lilliputian [informal], little [informal], niggling [informal], piddling [informal], piffling [informal], petty [informal], picayune [N. Amer, informal], trivial [informal], niggly [informal], piddly [informal])
"a fiddling sum of money";
""",
  );

  final String keyword = "fiddling";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fiddling""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiddling""",
                      // alsoEnglishWord: "also: fiddling",
                      britshText: """IpaUK: /ˈfɪdlɪŋ/""",
                      americanText: """IpaUS: /ˈfɪdlɪŋ/""",
...
const double _startSecondsone = 0000000000000000000000000002216;
const String _videoIdtwo = 'https://youtu.be/slw_ee-Z5_A?t=';
const double _startSecondstwo = 0000000000000000000000000007395;
const String _videoIdthree = 'https://youtu.be/PLqCWWD4HRg?t=';
const double _startSecondsthree = 000000000000000000000000000796;
const String _videoIdfour = 'https://youtu.be/DNBuq2e6i5k?t=';
const double _startSecondsfour = 0000000000000000000000000002269;
const String _videoIdfive = 'https://youtu.be/DcN_HNbEpqw?t=';
