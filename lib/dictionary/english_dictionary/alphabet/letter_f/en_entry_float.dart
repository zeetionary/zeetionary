...
کوردی: سەراوکەوتە، مەلەون، سەرکەوتە، سواراو،	پشتێنەی ڕزگاری، ئاڵقەی مەلێ (بۆ فێرکردن)،	گۆی کۆنتڕۆڵی تێڕژانی ئاو، نەوت و هتد بۆ نێو تانکی،	چوارپێچکە، هەرزاڵە یان سەکۆی پێچکەدار، عەڕابە (لە کەرنەڤاڵ و ئاهەنگی سەرشەقام)،	خەمازە، چێوپەمە (سەرئاو)، تۆپەوانەی ڕاوەماسی،	ڕیزە چرای پێشەوەی شانۆ،	ماڵە،	کارتیخ، بڕبەند،	وردەپارە، قۆشە، وردەپووڵ
"""),
// With short examples define "float", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) جووڵان بە هێواشی لەسەر ئاو یان لە حەوادا"""),
                    SentencesRow(
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """میوزیکی خۆش لە پەنجەرەکەوە هات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بەلەمەکان بە هێواشی بە ڕووبارەکەدا دەچوون.""",
                      englishNote:
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خوازراوی خەڵکی وەها دەردەکەون کە دێنە ژیانمەوە و دەردەچن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """حەسایەوە بە هێمنی سەرئاو کەوتن.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (کردار) ڕێکردن بە هێواشی و لەسەرخۆیی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She floated down the steps to greet us.""",
                      kurdishText:
                          """بە پلەکانەکاندا هاتە خوارەوە بۆ خێراتن کردنمان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تۆڕەکانی ڕاوەماسی زۆرجار بە هۆی تۆپەوانەوە لە شوێنی خۆیاندا ڕادەگیرێن.""",
                    ...
                    // const DividerDefinition(),
                    // const DefinitionKurdish(text: """١١. (ناو) خواردنەوەیەک کە سەهۆڵی لەسەرە"""),
                    // const DividerSentences(),
                    // SentencesRow(
...
const double _startSecondstwo = 0000000000000000000000000001342;
const String _videoIdthree = 'https://youtu.be/v6yg4ImnYwA?t=';
const double _startSecondsthree = 000000000000000000000000000576;
const String _videoIdfour = 'https://youtu.be/mY3SEMTROas?t=';
const double _startSecondsfour = 0000000000000000000000000001102;
const String _videoIdfive = 'https://youtu.be/dtp6b76pMak?t=';
const double _startSecondsfive = 000000000000000000000000000492;
