...
// replace these: replace EnglishEntryacrylic - replace speakAcrylic - replace acrylic - /əˈkrɪlɪk/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryacrylic extends StatelessWidget {
  EnglishEntryacrylic({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAcrylic(String languageCode) async {
    // DOPSUM: CHANGE speakAcrylic
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("acrylic"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAcryl1256(String languageCode) async {
    // DOPSUM: CHANGE speakAcrylic
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("an acrylic sweater"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAcry4289(String languageCode) async {
    // DOPSUM: CHANGE speakAcrylic
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("acrylic paint"); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈkrɪlɪk/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'RLW5fSJd03s';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '7t9Syo1SWs0';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'v15w3t2ws6E';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'tSc7F_fxvMI';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'zn3pCipJdks';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = '9a5gfmRm0yU';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = '7R10DA5Cm-c';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = 'I2EFeaMkqwA';
