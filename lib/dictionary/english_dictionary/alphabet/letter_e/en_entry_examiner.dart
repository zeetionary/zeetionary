...
class EnglishEntryexaminer extends StatefulWidget {
  const EnglishEntryexaminer({super.key});

  @override
  State<EnglishEntryexaminer> createState() => _EnglishEntryexaminerState();
}

class _EnglishEntryexaminerState extends State<EnglishEntryexaminer> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""examiner""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """examiner""",
                      // alsoEnglishWord: "also: examiner",
                      britshText: """IpaUK: /ɪɡˈzæmɪnə(r)/""",
                      americanText: """IpaUS: /ɪɡˈzæmɪnər/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The papers are sent to external examiners.""");
  }
...
کوردی: تاقی‌کاری‌دەرهێن، دەرهێنەری تاقی‌کاری
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کەسێک کە پرسیارەکانی تاقیکردنەوەیەک دەنووسێت یان نمرەکان دابەش دەکات"""),
          SentencesRow(
            englishText:
                """The papers are sent to external examiners (= ones not connected with the students' school or college).""",
            kurdishText: """وەڵامەکان بۆ تاقیکاری دەرەوە دەنێردرێن.""",
          ...
          SentencesRow(
            englishText:
                """She was a member of the board of examiners of the college.""",
            kurdishText: """ئەندامێکی دەستەی تاقیکاری کۆلێژەکە بوو.""",
          ...
          SentencesRow(
            englishText:
                """He was the official examiner of electronic voting systems for Pennsylvania and Texas for 20 years.""",
            kurdishText:
                """بۆ ٢٠ ساڵ چاودێری فەرمی سیستەمی دەنگدانی پێنسیلڤانیا و تێکساس بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: examiner (Derived forms: examiners)
1. Someone who administers a test to determine your qualifications (= tester, quizzer)
 
2. An investigator who observes carefully (= inspector)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/H5_HVUS1l0Y?t=';
const double _startSecondsend = 000000000000000000000000000000; // 657;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/YCnFYvL17v4?t=';
const double _startSecondsone = 00000000000000000000000000000; // 359;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/1GgD0CpMkyA?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 701;
const String _videoIdthree = 'VIDEOhttps://youtu.be/1h12uwyMZY0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 859;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/B5ytcg5pYEA?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 379;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/bfScSo3lkwo?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 40;
