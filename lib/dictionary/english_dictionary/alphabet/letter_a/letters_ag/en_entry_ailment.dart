...
// replace these: replace EnglishEntryailment - replace speakAilment - replace ailment - /ˈeɪlmənt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryailment extends StatelessWidget {
  EnglishEntryailment({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAilment(String languageCode) async {
    // DOPSUM: CHANGE speakAilment
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("ailment"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAilment1249(String languageCode) async {
    // DOPSUM: CHANGE speakAilment
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "I got all the usual childhood ailments."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "ailment", // DOPSUM: CHANGE WORD ENTRY - Find /ˈeɪlmənt/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈeɪlmənt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAilment(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˈeɪlmənt/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
    ...
    return const SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          Text('''
- Noun: ailment 
1. An often persistent bodily disorder or disease; a cause for complaining (= complaint, ill)
'''),
        ],
      ),
    );
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'oHSehKtDyoI';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '5rY6sMfX8P0';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'AX4JrqSpbtQ';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'I9dKoNFZJdo';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'BbW-a7ZVGag';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'OoVDnTEzeVc';
