...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/Kou7ur5xt_4?t=';
    const double startSecondsone = 00000000000000000000000000027;
    const String videoIdtwo = 'https://youtu.be/8cJSRC1VAJo?t=';
    const double startSecondstwo = 000000000000000000000000000952;
    const String videoIdthree = 'https://youtu.be/AHgU10z9LNA?t=';
    const double startSecondsthree = 00000000000000000000000000074;
    const String videoIdfour = 'https://youtu.be/IILklP-sj_0?t=';
    const double startSecondsfour = 00000000000000000000000000041;
    const String videoIdfive = 'https://youtu.be/FCmS0mY622k?t=';
    const double startSecondsfive = 00000000000000000000000000026;
