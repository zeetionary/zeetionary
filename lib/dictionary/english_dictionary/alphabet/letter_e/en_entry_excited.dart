...
class EnglishEntryexcited extends StatefulWidget {
  const EnglishEntryexcited({super.key});

  @override
  State<EnglishEntryexcited> createState() => _EnglishEntryexcitedState();
}

class _EnglishEntryexcitedState extends State<EnglishEntryexcited> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """excited""",
                      // alsoEnglishWord: "also: excited",
                      britshText: """IpaUK: /ɪkˈsaɪtɪd/""",
                      americanText: """IpaUS: /ɪkˈsaɪtɪd/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The children were excited about opening their presents.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'm so excited for you!""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He was very excited to be asked to play for Wales.""");
  }
...
// With short examples define "excited", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: خرۆشاو، هەژیو، ورووژاو، بزواو، شاگەشکە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) هەستکردن بە خۆشی و تامەزرۆیی یان پیشاندانی"""),
          SentencesRow(
            englishText:
                """Staff got excited when they heard they were getting a bonus.""",
            kurdishText: """ستافەکە خرۆشاو بوون کە بیستیان بەخشیش وەردەگرن.""",
          ...
          SentencesRow(
            englishText:
                """I am really excited about the opportunity to work with her.""",
            kurdishText: """بەڕاستی دڵخۆشم بە هەلی کارکردن لەگەڵی.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """منداڵەکان بەجۆش بوون سەبارەت بە کردنەوەی دەرییەکانیان.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I'm so excited for you!""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """زۆر دڵخۆش بوو بە داواکردن لێی بۆ یاریکردن بۆ وێڵز.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هەندێک ئەسپ دەشڵەژێن کە لە هاتووچۆدان.""",
...
2. (of persons) excessively affected by emotion (= aroused, emotional, worked up)
"he would become excited over nothing at all";
 
3. Marked by uncontrolled excitement or emotion (= delirious, frantic, mad, unrestrained)
"a crowd of excited baseball fans";
 
4. (of e.g. a molecule) made reactive or more reactive (= activated)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/Oq61TxejZ5g?t=';
const double _startSecondsend = 000000000000000000000000000000; // 21;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/rPe4yziWiOg?t=';
const double _startSecondsone = 00000000000000000000000000000; // 22;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/HDntl7yzzVI?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1108;
const String _videoIdthree = 'VIDEOhttps://youtu.be/gFuEoxh5hd4?t=';
const double _startSecondsthree = 000000000000000000000000000; // 3;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/2TUGZ1VQDss?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 209;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/8wewPn7TZfs?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 69;
