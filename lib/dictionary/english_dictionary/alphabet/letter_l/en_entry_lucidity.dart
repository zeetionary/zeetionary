...
class EnglishEntrylucidity extends StatefulWidget {
  const EnglishEntrylucidity({super.key});

  @override
  State<EnglishEntrylucidity> createState() => _EnglishEntrylucidityState();
}

class _EnglishEntrylucidityState extends State<EnglishEntrylucidity> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylucidity lucidity
WORD_WEB lucidity lucidity lucidity
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lucidity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lucidity""");
  }
...
کوردی: 
"""),
// With short examples define "lucidity", please follow LX instructions
