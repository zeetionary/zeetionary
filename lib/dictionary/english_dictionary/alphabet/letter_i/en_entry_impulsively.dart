...
class EnglishEntryimpulsively extends StatefulWidget {
  const EnglishEntryimpulsively({super.key});

  @override
  State<EnglishEntryimpulsively> createState() =>
      _EnglishEntryimpulsivelyState();
}

class _EnglishEntryimpulsivelyState extends State<EnglishEntryimpulsively> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: impulsively
1. In an impulsive or impetuous way; without taking cautions (- impetuously, hotheadedly)
"he often acts impulsively and later regrets it";
""",
  );

  final String keyword = "impulsively";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impulsively""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Impulsively he reached out and took her hand.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""As a child, she was fearless and often acted impulsively.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/kUE2fPLOUxo?t=';
    const double startSecondsend = 000000000000000000000000000453;
    const String videoIdone = 'https://youtu.be/H-u6a66rTpQ?t=';
    const double startSecondsone = 000000000000000000000000000651;
    const String videoIdtwo = 'https://youtu.be/PidSL9ceaEw?t=';
    const double startSecondstwo = 000000000000000000000000000213;
    const String videoIdthree = 'https://youtu.be/ENw2y0ek1Jg?t=';
    const double startSecondsthree = 000000000000000000000000000293;
    const String videoIdfour = 'https://youtu.be/Yi0Mdvcg1Dg?t=';
    const double startSecondsfour = 0000000000000000000000000001022;
    const String videoIdfive = 'https://youtu.be/TM_s9lkFfTQ?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """impulsively""",
                      // alsoEnglishWord: "also: impulsively",
                      britshText: """IpaUK: impulsively""",
                      americanText: """IpaUS: impulsively""",
...
کوردی: بەپەلە، بە شێوەیەکی لێکەوەنەدراو
"""),
// With short examples define "impulsively", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) کردنی شت لەناکاو و بەبێ ئەوەی بەوریایی بیربکەیتەوە لەسەر ئەوەی چی ڕوودەدات لە ئەنجامدا"""),
                    const AlsoEnglishckb(word: "ھەروەھا: impetuously، rashly"),
                    SentencesRow(
                      englishText:
                          """Impulsively he reached out and took her hand.""",
                      kurdishText: """هەڵەشانە دەستی ڕاکێشا و دەستی گرت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وەک منداڵێک، بێ‌ترس بوو و زۆرجار هەڵەشانە هەنگاوی دەنا.""",
