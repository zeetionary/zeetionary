...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Hi0zbU3DW6o?t=';
    const double startSecondsend = 000000000000000000000000000105;
    const String videoIdone = 'https://youtu.be/przDcQe6n5o?t=';
    const double startSecondsone = 000000000000000000000000000782;
    const String videoIdtwo = 'https://youtu.be/AF8d72mA41M?t=';
    const double startSecondstwo = 000000000000000000000000000962;
    const String videoIdthree = 'https://youtu.be/s3B-qp3U5G0?t=';
    const double startSecondsthree = 00000000000000000000000000035;
    const String videoIdfour = 'https://youtu.be/R0wa9IlCA_w?t=';
    const double startSecondsfour = 00000000000000000000000000087;
    const String videoIdfive = 'https://youtu.be/gEKAzZEJIQY?t=';
    const double startSecondsfive = 000000000000000000000000000112;
