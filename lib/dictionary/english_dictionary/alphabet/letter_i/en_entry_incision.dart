...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'U91AUYttTyc';
    const double startSecondsend = 15;
    const String videoIdone = 'xBNfOg0FxDM';
    const double startSecondsone = 53;
    const String videoIdtwo = 'AhjrZCSF6Hw';
    const double startSecondstwo = 195;
    const String videoIdthree = '-Tg9xiJ6D6k';
    const double startSecondsthree = 0;
    const String videoIdfour = '417Qbwn9yso';
    const double startSecondsfour = 370;
    const String videoIdfive = 'B5ytcg5pYEA';
    const double startSecondsfive = 348;
