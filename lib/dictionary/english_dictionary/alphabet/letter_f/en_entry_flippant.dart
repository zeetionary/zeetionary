...
class EnglishEntryflippant extends StatefulWidget {
  const EnglishEntryflippant({super.key});

  @override
  State<EnglishEntryflippant> createState() => _EnglishEntryflippantState();
}

class _EnglishEntryflippantState extends State<EnglishEntryflippant> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flippant 
1. Showing inappropriate levity (= light-minded)
"He made a flippant statement";
""",
  );

  final String keyword = "flippant";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flippant""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Sorry, I didn't mean to sound flippant.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""You can’t afford to be flippant about such matters.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flippant""",
                      // alsoEnglishWord: "also: flippant",
                      britshText: """IpaUK: /ˈflɪpənt/""",
                      americanText: """IpaUS: /ˈflɪpənt/""",
...
// With short examples define "flippant", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ببوورە، نەمویست گەڵتەجاڕانە دەربکەوم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ناتوانیت شۆخییانە دەربکەویت سەبارەت بەم بابەتانە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/w6EblErBJqw?t=';
const double _startSecondsend = 000000000000000000000000000524;
const String _videoIdone = 'https://youtu.be/2PdC9gtYovw?t=';
const double _startSecondsone = 000000000000000000000000000180;
const String _videoIdtwo = 'https://youtu.be/lsWndfzuOc4?t=';
const double _startSecondstwo = 0000000000000000000000000001020;
const String _videoIdthree = 'https://youtu.be/LCeH19PIk8U?t=';
const double _startSecondsthree = 00000000000000000000000000014;
const String _videoIdfour = 'https://youtu.be/ARd4jsThc2c?t=';
const double _startSecondsfour = 000000000000000000000000000490;
const String _videoIdfive = 'https://youtu.be/FRfoEzZbK_Y?t=';
