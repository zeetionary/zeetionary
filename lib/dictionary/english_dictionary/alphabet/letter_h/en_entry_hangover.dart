...
class EnglishEntryhangover extends StatefulWidget {
  const EnglishEntryhangover({super.key});

  @override
  State<EnglishEntryhangover> createState() => _EnglishEntryhangoverState();
}

class _EnglishEntryhangoverState extends State<EnglishEntryhangover> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hangover (Derived forms: hangovers)
1. Disagreeable aftereffects from the use of drugs (especially alcohol) (- katzenjammer [US])
 
2. An official who remains in office after his term (- holdover)
 
3. Something that has survived from the past (- holdover)
"hangovers from the 19th century";
""",
  );

  final String keyword = "hangover";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hangover""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She woke up with a terrible hangover.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hangover""",
                      // alsoEnglishWord: "also: hangover",
                      britshText: """IpaUK: /ˈhæŋəʊvə(r)/""",
                      americanText: """IpaUS: /ˈhæŋəʊvər/""",
...
// """),
                    ...
                    SentencesRow(
                      englishText:
                          """The present political system is a hangover from the colonial era.""",
                      kurdishText:
                          """سیستەمە سیاسییەکەی ئێستا پاشـاوەی سەردەمی کۆلۆنیاڵیزمە.""",
