...
class EnglishEntryaudible extends StatelessWidget {
  ...
  Future<void> speakaudible(String languageCode) async {
    ...
    await flutterTts.speak("audible");
  }
  ...
  Future<void> speakaudible1255(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Her voice was barely audible above the noise.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɔːdəbl/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɔːdəbl/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakaudible1255("en-US"),
                          ),
