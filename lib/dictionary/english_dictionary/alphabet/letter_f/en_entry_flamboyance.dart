...
class EnglishEntryflamboyance extends StatefulWidget {
  const EnglishEntryflamboyance({super.key});

  @override
  State<EnglishEntryflamboyance> createState() =>
      _EnglishEntryflamboyanceState();
}

class _EnglishEntryflamboyanceState extends State<EnglishEntryflamboyance> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flamboyance (Derived forms: flamboyances)
1. Extravagant elaborateness (= floridness, floridity, showiness)
"he wrote with great flamboyance";
""",
  );

  final String keyword = "flamboyance";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flamboyance""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They were noted for the flamboyance of their dress.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flamboyance""",
                      // alsoEnglishWord: "also: flamboyance",
                      britshText: """IpaUK: /flæmˈbɔɪəns/""",
                      americanText: """IpaUS: /flæmˈbɔɪəns/""",
...
// With short examples define "flamboyance", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی جیاواز و بەجۆشهێنەر بەشێوەیەک کە سەرنج ڕادەکێشێت"""),
                    SentencesRow(
                      englishText:
                          """He lacked the flamboyance of other members of the band.""",
                      kurdishText:
                          """ئەو ئەو دەرکەوتن و سەرنجڕاکێشییەی نەبوو کە ئەندامانی دیکەی گروپەکە هەیانبوو..""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ناسرابوون بۆ ئاڵوواڵای جلەکانیان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/x6ieHhsRE3w?t=';
const double _startSecondsend = 000000000000000000000000000255;
const String _videoIdone = 'https://youtu.be/njSSCBjnsbU?t=';
const double _startSecondsone = 00000000000000000000000000037;
const String _videoIdtwo = 'https://youtu.be/WoeeMLCopu8?t=';
const double _startSecondstwo = 000000000000000000000000000427;
const String _videoIdthree = 'https://youtu.be/gVU6nZNMjvw?t=';
const double _startSecondsthree = 000000000000000000000000000473;
const String _videoIdfour = 'https://youtu.be/8pALdP35zAU?t=';
const double _startSecondsfour = 000000000000000000000000000495;
const String _videoIdfive = 'https://youtu.be/BuimvwZrs_g?t=';
const double _startSecondsfive = 0000000000000000000000000001376;
