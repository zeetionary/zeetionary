...
// replace these: EnglishEntryabet - speakAbet - abet - /əˈbet/

enum TtsState { playing }

class EnglishEntryabet extends StatelessWidget {
  EnglishEntryabet({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈbet/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAbet(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /əˈbet/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedOne extends StatelessWidget {
  static String myVideoId = '1ddmUSPKEnI';
...
class YoutubeEmbeddedTwo extends StatelessWidget {
  static String myVideoId = 'FyvP5WhHc6o';
...
class YoutubeEmbeddedThree extends StatelessWidget {
  static String myVideoId = 'RxDqK94xi1k';
