...
class EnglishEntryhasten extends StatefulWidget {
  const EnglishEntryhasten({super.key});

  @override
  State<EnglishEntryhasten> createState() => _EnglishEntryhastenState();
}

class _EnglishEntryhastenState extends State<EnglishEntryhasten> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: hasten (Derived forms: hastens, hastening, hastened)
1. Move faster or act quickly or quicker (- rush, hurry, look sharp, festinate [archaic], hurry up, get a move on [informal], make haste)
"We have to hasten!";
 
2. Move or travel very quickly (- rush, hotfoot, hie [archaic], speed, race, pelt along [informal], rush along, bucket along [informal], belt along [informal], step on it [informal], travel rapidly, hurry, zip [informal], zoom, zoom along, whizz [informal], whizz along [informal], bucket [informal], wing [informal], pelt [informal], barrel [informal], rocket [informal], belt [informal])
"He hastened down the hall to receive his guests";
 
3. Speed up the progress of; facilitate (- expedite)
"This should hasten the process";
 
4. Cause to occur rapidly (- induce, stimulate, rush, accelerate, speed up)
""",
  );

  final String keyword = "hasten";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She saw his frown and hastened to explain.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We hastened back to Rome.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hasten""",
                      // alsoEnglishWord: "also: hasten",
                      britshText: """IpaUK: /ˈheɪsn/""",
                      americanText: """IpaUS: /ˈheɪsn/""",
...
// With short examples define "hasten", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """زوو گەڕاینەوە ڕۆما.""",
...
const double _startSecondsend = 0000000000000000000000000008015;
const String _videoIdone = 'https://youtu.be/3RkhZgRNC1k?t=';
const double _startSecondsone = 000000000000000000000000000763;
const String _videoIdtwo = 'https://youtu.be/Ty-m4pm8oog?t=';
const double _startSecondstwo = 000000000000000000000000000243;
const String _videoIdthree = 'https://youtu.be/FuyNyn99NWs?t=';
const double _startSecondsthree = 000000000000000000000000000954;
const String _videoIdfour = 'https://youtu.be/2G_Jqz2ctlA?t=';
const double _startSecondsfour = 000000000000000000000000000108;
const String _videoIdfive = 'https://youtu.be/0Yl6uIJZm4c?t=';
