...
class EnglishEntrytheconservativeparty extends StatelessWidget {
// blank divider
  EnglishEntrytheconservativeparty({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speaktheConservativeParty(String languageCode) async {
    // DOPSUM: CHANGE speaktheConservativeParty
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "the Conservative Party"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUK: /ðə kənˈsɜːvətɪv pɑːti/"),
                            CustomIconButtonBritish(
                              onPressed: () =>
                                  speaktheConservativeParty("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUS: /ðə kənˈsɜːrvətɪv pɑːrti/"),
                            CustomIconButtonAmerican(
                              onPressed: () =>
                                  speaktheConservativeParty("en-US"),
                            ),
                          ],
                        ),
                      ],
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    ExampleSentenceKurdish(
                                        text:
                                            "پارتی پارێزگاران هەڵبژاردنی بردەوە و حکومەتی پێکهێنا لە ساڵی ٢٠١٠."),
                                  ],
                                ),
                              ),
...
// Create an instance of EnglishMeaningConst with the desired text
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
Noun: the Conservative Party
1. one of the main British political parties, on the political right, which especially believes in free enterprise and that industry should be privately owned
""",
  );
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/TwBieZjhNT0?t=',
    startSeconds: 696,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/DlTq8DbRs4k?t=',
    startSeconds: 75,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/KkJZIQ_Wt_Q?t=',
    startSeconds: 217,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/AGaPaOPNubo?t=',
    startSeconds: 321,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/IAYGk4XP23M?t=',
    startSeconds: 218,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/hoULXtnLpNg?t=',
    startSeconds: 67,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
