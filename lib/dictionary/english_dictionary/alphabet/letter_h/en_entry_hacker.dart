...
class EnglishEntryhacker extends StatefulWidget {
  const EnglishEntryhacker({super.key});

  @override
  State<EnglishEntryhacker> createState() => _EnglishEntryhackerState();
}

class _EnglishEntryhackerState extends State<EnglishEntryhacker> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hacker (Derived forms: hackers)
1. Someone who tries to obtain unauthorized access to a computer, network or data
 
2. [informal] A skilled programmer or computing expert
"true hackers subscribe to a code of ethics and look down upon crackers"
 
3. [informal] One who works hard at boring tasks (- hack, drudge)
 
4. Someone who plays golf poorly
""",
  );

  final String keyword = "hacker";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The hacker stole sensitive data from the company.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hacker""",
                      // alsoEnglishWord: "also: hacker",
                      britshText: """IpaUK: /ˈhækə(r)/""",
                      americanText: """IpaUS: /ˈhækər/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هاککەرەکە زیاریی هەستیاری کۆمپانیاکەی دزی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The software is so complicated that only experienced hackers can use it.""",
                      kurdishText:
                          """نەرمامێرەکە هێندە ئاڵۆزە کە تەنها کۆمپیوتەرزانانی بەئەزموون دەتوانن بەکاری بهێنن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/iI48g7YTZFA?t=';
const double _startSecondsend = 000000000000000000000000000971;
const String _videoIdone = 'https://youtu.be/s0hY04WnlWI?t=';
const double _startSecondsone = 000000000000000000000000000212;
const String _videoIdtwo = 'https://youtu.be/6BqpU4V0Ypk?t=';
const double _startSecondstwo = 000000000000000000000000000241;
const String _videoIdthree = 'https://youtu.be/iU3YRKQnb6s?t=';
const double _startSecondsthree = 0000000000000000000000000007;
const String _videoIdfour = 'https://youtu.be/tlezBUdD53w?t=';
const double _startSecondsfour = 0000000000000000000000000008;
const String _videoIdfive = 'https://youtu.be/-ni_PWxrsNo';
