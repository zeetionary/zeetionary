...
class EnglishEntryflower extends StatefulWidget {
  const EnglishEntryflower({super.key});

  @override
  State<EnglishEntryflower> createState() => _EnglishEntryflowerState();
}

class _EnglishEntryflowerState extends State<EnglishEntryflower> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flower (Derived forms: flowers)
1. A plant cultivated for its blooms or blossoms
 
2. Reproductive organ of angiosperm plants especially one having showy or colourful parts (= bloom, blossom)
 
3. The period of greatest prosperity or productivity (= prime, peak, heyday, bloom, blossom, efflorescence, flush)

- Verb: flower (Derived forms: flowered, flowers, flowering)
1. Produce or yield flowers (= bloom, blossom)
"The cherry tree flowered";
 
2. Make steady progress; be at the high point in one's career or reach a high point in historical significance or importance (= thrive, prosper, fly high, flourish, bloom)
""",
  );

  final String keyword = "flower";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The plant has a beautiful bright red flower.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It has deep pink scented flowers.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The flowers are pollinated by insects.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The flowers were still tightly closed.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The forest floor was a carpet of wild flowers.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Flowers were blooming everywhere.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The spring flowers were just coming out.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I picked some flowers.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He took her flowers and chocolates.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'm learning flower arranging.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This particular variety flowers in July.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""What time of year do daffodils flower?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flower""",
                      // alsoEnglishWord: "also: flower",
                      britshText: """IpaUK: /ˈflaʊə(r)/""",
                      americanText: """IpaUS: /ˈflaʊər/""",
...
کوردی: گوڵ،	هەڵبژاردە، سەرتۆپ، سەرگوڵ، سەرتل، باش‌ترین، باش‌ترین بەش
"""),
// With short examples define "flower", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕووەکەکە گوڵێکی سووری درەوشاوەی جوان دەگرێت.""",
                    ...
                    SentencesRow(
                      englishText: """It has deep pink scented flowers.""",
                      kurdishText: """گوڵی بۆن توندی پەمەیی هەیە.""",
                      englishNote: """This means the flowers are strongly scented and colored in deep pink.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The flowers are pollinated by insects.""",
                      kurdishText: """گوڵەکان بە مێروو دەپیتێندرێن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The flowers were still tightly closed.""",
                      kurdishText: """گوڵەکان هێشتا بە توندی داخراو بوون.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ڕووەکێک کە بۆ جوانی گوڵەکانی دەچێندرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The forest floor was a carpet of wild flowers.""",
                      kurdishText: """زەوی دارستانە پڕ لە گوڵی دەشتی بوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Flowers were blooming everywhere.""",
                      kurdishText: """گوڵ لە هەموو شوێنێک دەردەچوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The spring flowers were just coming out.""",
                      kurdishText: """گوڵی بەهاران دەردەچوون.""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) گوڵێک بە قەدەکەیەوە کە بۆ ڕازاندنەوە لێکراوەتەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I picked some flowers.""",
                      kurdishText: """هەندێک گوڵم لێکردەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He took her flowers and chocolates.""",
                      kurdishText: """گوڵ و چکلێتی بۆ برد.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I'm learning flower arranging.""",
                      kurdishText: """فێری ڕێکخستنی گوڵ دەبم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """This particular variety flowers in July.""",
                      kurdishText: """ئەم جۆرە دیاریکراوە لە تەمموز گوڵ دەگرێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """What time of year do daffodils flower?""",
                      kurdishText: """چی کاتێکی ساڵ نێرگز گوڵ دەگرێت؟""",
...
const double _startSecondsend = 0000000000000000000000000001331;
const String _videoIdone = 'https://youtu.be/yjhibJ-OqxE?t=';
const double _startSecondsone = 00000000000000000000000000075;
const String _videoIdtwo = 'https://youtu.be/gngPQ771Ahk?t=';
const double _startSecondstwo = 0000000000000000000000000004500;
const String _videoIdthree = 'https://youtu.be/E2_kRmS6y8A?t=';
const double _startSecondsthree = 0000000000000000000000000001641;
const String _videoIdfour = 'https://youtu.be/OyClEw5GCMA?t=';
const double _startSecondsfour = 00000000000000000000000000016;
const String _videoIdfive = 'https://youtu.be/nEUdhHrqOf8?t=';
const double _startSecondsfive = 000000000000000000000000000139;
