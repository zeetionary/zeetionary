...
class EnglishEntryacreage extends StatefulWidget {
  const EnglishEntryacreage({super.key});

  @override
  State<EnglishEntryacreage> createState() => _EnglishEntryacreageState();
}

class _EnglishEntryacreageState extends State<EnglishEntryacreage> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acreage""",
                      // alsoEnglishWord: "also: acreage",
                      britshText: """IpaUK: /ˈeɪkərɪdʒ/""",
                      americanText: """IpaUS: /ˈeɪkərɪdʒ/""",
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakacr21374("en-GB"),
                            onPressedAmerican: () => speakacr21374(
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'rmgAqYwFFA8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'rqtzP6YN9QQ';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'Ak6aB5vwdiw';
