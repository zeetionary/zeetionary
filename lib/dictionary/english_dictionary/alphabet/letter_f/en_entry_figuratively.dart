...
class EnglishEntryfiguratively extends StatefulWidget {
  const EnglishEntryfiguratively({super.key});

  @override
  State<EnglishEntryfiguratively> createState() =>
      _EnglishEntryfigurativelyState();
}

class _EnglishEntryfigurativelyState extends State<EnglishEntryfiguratively> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "figuratively";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""figuratively""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She is, figuratively speaking, holding a gun to his head.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """figuratively""",
                      // alsoEnglishWord: "also: figuratively",
...
// With short examples define "figuratively", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە خوازەیی قسە بکەین، چەکێکی لەسەر سەری داناوە.""",
...
const double _startSecondsend = 000000000000000000000000000377;
const String _videoIdone = 'https://youtu.be/6WV-Y8CeluQ?t=';
const double _startSecondsone = 000000000000000000000000000890;
const String _videoIdtwo = 'https://youtu.be/kHTcoPoAnys?t=';
const double _startSecondstwo = 000000000000000000000000000130;
const String _videoIdthree = 'https://youtu.be/C1oxhniG_Fc?t=';
...
const String _videoIdfive = 'https://youtu.be/x629nYBuLpY?t=';
const double _startSecondsfive = 0000000000000000000000000001205;
