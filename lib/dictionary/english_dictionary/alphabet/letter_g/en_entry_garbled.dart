...
class EnglishEntrygarbled extends StatefulWidget {
  const EnglishEntrygarbled({super.key});

  @override
  State<EnglishEntrygarbled> createState() => _EnglishEntrygarbledState();
}

class _EnglishEntrygarbledState extends State<EnglishEntrygarbled> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""garbled""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He gave a garbled account of what had happened.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """garbled""",
                      // alsoEnglishWord: "also: garbled",
                      britshText: """IpaUK: /ˈɡɑːbld/""",
                      americanText: """IpaUS: /ˈɡɑːrbld/""",
...
// With short examples define "garbled", please follow LX instructions
                    ...
                    const AlsoEnglishckb(word: "ھەروەھا: confused"),
                    SentencesRow(
                      englishText:
                          """He gave a garbled account of what had happened.""",
                      kurdishText:
                          """گێڕانەوەیەکی شێواوی ئەوەی گوت کە ڕوویدابوو.""",
...
const double _startSecondsend = 000000000000000000000000000296;
const String _videoIdone = 'https://youtu.be/Bh9lIfocRMk?t=';
const double _startSecondsone = 000000000000000000000000000955;
const String _videoIdtwo = 'https://youtu.be/nRyIGTkcmII?t=';
const double _startSecondstwo = 000000000000000000000000000502;
const String _videoIdthree = 'https://youtu.be/qKzmJhSFHzc?t=';
const double _startSecondsthree = 000000000000000000000000000390;
const String _videoIdfour = 'https://youtu.be/ZTV7njKIhww?t=';
const double _startSecondsfour = 0000000000000000000000000001062;
const String _videoIdfive = 'https://youtu.be/dLCkK_HoKyk?t=';
