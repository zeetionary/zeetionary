...
// With short examples define "-enabled", please follow LX instructions
          ...
          SentencesRow(
            englishText:
                """Their aim is to make sure that every home and business becomes internet-enabled in the next ten years.""",
            kurdishText:
                """ئامانجیان ئەوەیە کە دڵنیایی بکەنەوە کە ھەموو ماڵ و بازرگانییەک ئینتەرنێتی ھەبێت لە دە ساڵی داھاتوودا.""",
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'IGgblfkAhsE';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '0K1pITq4mSk';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '1iWs3jJih_M';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'wrXf_VznZvM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '6IcfpSgZbno';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'w8LvGsL6L2c';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'ux6CmsrOFeo';
