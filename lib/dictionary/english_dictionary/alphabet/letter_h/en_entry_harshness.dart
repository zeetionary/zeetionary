...
class EnglishEntryharshness extends StatefulWidget {
  const EnglishEntryharshness({super.key});

  @override
  State<EnglishEntryharshness> createState() => _EnglishEntryharshnessState();
}

class _EnglishEntryharshnessState extends State<EnglishEntryharshness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: harshness
1. The roughness of a substance that causes abrasions (- abrasiveness, scratchiness)
 
2. The quality of being harsh, rough or grating to the senses (- roughness)
 
3. The quality of being cruel and causing tension or annoyance (- cruelty, cruelness)
 
4. Excessive sternness (- severity, severeness, rigor [US], rigour [Brit, Cdn], rigorousness, rigourousness [Brit, non-standard], inclemency, hardness, stiffness)
"the harshness of his punishment was inhuman";
""",
  );

  final String keyword = "harshness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""harshness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The staff have been treated with undue harshness.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He struggled with the harshness of life on the streets.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The harshness of the sun was of concern to the visitors.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harshness""",
                      // alsoEnglishWord: "also: harshness",
                      britshText: """IpaUK: /ˈhɑːʃnəs/""",
                      americanText: """IpaUS: /ˈhɑːrʃnəs/""",
...
کوردی: سەختی، چەتوونی، گرانی، ئاسێ‌بوون، زبری، توندی، توندوتیژی، بێ‌بەزەیێتی، ڕەشکوژی، بێ‌ڕەحمی، دڵڕەقی، دڕێتی، سەختگری
"""),
// With short examples define "harshness", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی شتێک توند و نامیهرەبانانە بێت"""),
                    SentencesRow(
                      englishText:
                          """The staff have been treated with undue harshness.""",
                      kurdishText:
                          """ستافەکە بە توندی نابەجێ مامەڵەیان لەگەڵ کراوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ئەوەی کە کەشێک یان دۆخی ژیان سەخت بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He struggled with the harshness of life on the streets.""",
                      kurdishText:
                          """تەقەڵای بوو لەگەڵ سەختی ژیان لەسەر شەقامەکان.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) ئەوەی شتێک زۆر زۆر بەهێز و ڕۆشن بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The harshness of the sun was of concern to the visitors.""",
                      kurdishText:
                          """توندی خۆرەکە جێگای نیگەرانی بوو بۆ گەشتیاران.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ناو) ئەوەی کە کە ناخۆش بێت بۆ گوێگرتن لێی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The engine is designed for reduced noise, vibration and harshness.""",
                      kurdishText:
                          """بزوێنەرەکە دیزاین کراوە بۆ دەنگە دەنگ، هەزە، و دەنگی ناخۆشی کەمتر.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٥. (ناو) ئەوەی کە زۆر بەهێز بێت کە دەکرێت زیانبەخش بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The tobacco industry adds flavours to relieve the harshness of the smoke.""",
                      kurdishText:
                          """پیشەسازی تۆباکۆ تامێک زیاد دەکات بۆ کەمکردنی توندی دووکەڵەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/5p4s4k3eB_I?t=';
const double _startSecondsend = 00000000000000000000000000012;
const String _videoIdone = 'https://youtu.be/PtrF9hx0ygw?t=';
const double _startSecondsone = 000000000000000000000000000215;
const String _videoIdtwo = 'https://youtu.be/_V_HjDMU6js?t=';
const double _startSecondstwo = 000000000000000000000000000292;
const String _videoIdthree = 'https://youtu.be/p3368WAl0qM?t=';
const double _startSecondsthree = 000000000000000000000000000340;
const String _videoIdfour = 'https://youtu.be/ew1edqVqCu0?t=';
const double _startSecondsfour = 00000000000000000000000000032;
const String _videoIdfive = 'https://youtu.be/nk44yPCN3gM?t=';
