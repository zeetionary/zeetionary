...
class EnglishEntryfibrous extends StatefulWidget {
  const EnglishEntryfibrous({super.key});

  @override
  State<EnglishEntryfibrous> createState() => _EnglishEntryfibrousState();
}

class _EnglishEntryfibrousState extends State<EnglishEntryfibrous> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fibrous
1. Having or resembling fibers especially fibers used in making cordage such as those of jute (= hempen)
"From the frame is suspended a bag, about two feet in depth, of wide netting or fibrous cord";
 
2. (of meat) full of sinews; especially impossible to chew (= sinewy, stringy, unchewable)
""",
  );

  final String keyword = "fibrous";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fibrous""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Grass plants have fibrous roots.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fibrous""",
                      // alsoEnglishWord: "also: fibrous",
                      britshText: """IpaUK: /ˈfaɪbrəs/""",
                      americanText: """IpaUS: /ˈfaɪbrəs/""",
...
const double _startSecondsend = 000000000000000000000000000197;
const String _videoIdone = 'https://youtu.be/7aIS-SLQmOk?t=';
const double _startSecondsone = 00000000000000000000000000070;
const String _videoIdtwo = 'https://youtu.be/alIyLX9LUhU?t=';
const double _startSecondstwo = 000000000000000000000000000312;
const String _videoIdthree = 'https://youtu.be/Yz7Ofr9z1co?t=';
const double _startSecondsthree = 000000000000000000000000000588;
const String _videoIdfour = 'https://youtu.be/yUWYFCKSJvo?t=';
const double _startSecondsfour = 000000000000000000000000000813;
const String _videoIdfive = 'https://youtu.be/g09731mD-s8?t=';
const double _startSecondsfive = 000000000000000000000000000248;
