...
class EnglishEntryglass extends StatefulWidget {
  const EnglishEntryglass({super.key});

  @override
  State<EnglishEntryglass> createState() => _EnglishEntryglassState();
}

class _EnglishEntryglassState extends State<EnglishEntryglass> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I cut myself on a piece of broken glass.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He could see the light through the glass.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The books were all behind glass.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The floor was littered with fragments of broken glass.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He poured orange juice into a glass.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The waiter filled their glasses.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She raised the glass to her lips.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He poured her a fresh glass of water.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She sat sipping a glass of champagne.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I wear glasses for driving.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She has a fine collection of Bohemian glass.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I got glassed in the face and needed treatment.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.speak(
        """He was sentenced to two years in jail for glassing a student.""");
  }
  ...
  Future<void> speaksentence100(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I wear glasses for driving.0""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glass""",
                      // alsoEnglishWord: "also: glass",
                      britshText: """IpaUK: /ɡlɑːs/""",
                      americanText: """IpaUS: /ɡlæs/""",
...
// With short examples define "glass", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لەسەر پارچە شووشەیەکی شکاو بریندار بووم.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He could see the light through the glass.""",
                      kurdishText:
                          """دەیتوانی ڕۆشناییەکە لە شووشەکەوە ببینێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The books were all behind glass.""",
                      kurdishText: """کتێبەکان هەموویان لە پشت شووشەوە بوون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زەوییەکە پڕبووبوو لە پارچەی بچووک لە شووشەی شکاو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The waiter filled their glasses.""",
                      kurdishText: """گارسۆنەکە گڵاسەکانیانی پڕ کرد.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She raised the glass to her lips.""",
                      kurdishText: """گڵاسەکەی تا لێوەکانی بەرزکردەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She sat sipping a glass of champagne.""",
                      kurdishText:
                          """دانیشت و قومی لە گڵاسێک لە شامپەین دەدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کۆکراوەیەکی باش لە شتی شووشەیی بۆهیمی هەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە شووشە لێمدرا لە ڕووخسارم و پێویستیم بە چارەسەر بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He was sentenced to two years in jail for glassing a student.""",
                      kurdishText:
                          """سزا درا بە دوو ساڵ زیندانی بۆ شووشەلێدان لە منداڵێک.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I wear glasses for driving.0""",
                      kurdishText: """رستە_رستە_رستە_رستە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/-HyHZsa79LU?t=';
const double _startSecondsend = 000000000000000000000000000629;
const String _videoIdone = 'https://youtu.be/pFEB0chiuJA?t=';
const double _startSecondsone = 000000000000000000000000000445;
...
const String _videoIdfour = 'https://youtu.be/yjhibJ-OqxE?t=';
const double _startSecondsfour = 000000000000000000000000000542;
const String _videoIdfive = 'https://youtu.be/7j5ul4XBjAI?t=';
const double _startSecondsfive = 00000000000000000000000000063;
