...
// replace these: replace EnglishEntryagonizing - replace speakAgonizing - replace agonizing - /ˈæɡənaɪzɪŋ/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryagonizing extends StatelessWidget {
  EnglishEntryagonizing({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAgonizing(String languageCode) async {
    // DOPSUM: CHANGE speakAgonizing
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("agonizing"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakA145233(String languageCode) async {
    ...
    await flutterTts.speak(
        "His father’s agonizing death devastated her."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈæɡənaɪzɪŋ/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'IEe1qxFp7R4';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '3PISCb7dd3Q';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'SM9pS86Q5p4';
