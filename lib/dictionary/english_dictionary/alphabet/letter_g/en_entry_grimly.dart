...
class EnglishEntrygrimly extends StatefulWidget {
  const EnglishEntrygrimly({super.key});

  @override
  State<EnglishEntrygrimly> createState() => _EnglishEntrygrimlyState();
}

class _EnglishEntrygrimlyState extends State<EnglishEntrygrimly> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grimly""",
                      // alsoEnglishWord: "also: grimly",
                      britshText: """IpaUK: /ˈɡrɪmli/""",
                      americanText: """IpaUS: /ˈɡrɪmli/""",
...
کوردی: 
"""),
// With short examples define "grimly", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەڵسەنگاندنی بۆ جەنگەکە بە جدییەوە ڕەشبینانەیە.""",
...
const double _startSecondsend = 000000000000000000000000000647;
const String _videoIdone = 'https://youtu.be/HZq_HjKCRB4?t=';
const double _startSecondsone = 000000000000000000000000000476;
const String _videoIdtwo = 'https://youtu.be/mPg1tnfUguo?t=';
const double _startSecondstwo = 000000000000000000000000000608;
const String _videoIdthree = 'https://youtu.be/grRK7nIKCkI?t=';
const double _startSecondsthree = 000000000000000000000000000260;
const String _videoIdfour = 'https://youtu.be/T4NlZQb1-aQ?t=';
const double _startSecondsfour = 000000000000000000000000000340;
const String _videoIdfive = 'https://youtu.be/b5PGklsD5j8?t=';
