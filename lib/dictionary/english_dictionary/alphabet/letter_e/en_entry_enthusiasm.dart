...
class EnglishEntryenthusiasm extends StatefulWidget {
  const EnglishEntryenthusiasm({super.key});

  @override
  State<EnglishEntryenthusiasm> createState() => _EnglishEntryenthusiasmState();
}

class _EnglishEntryenthusiasmState extends State<EnglishEntryenthusiasm> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enthusiasm""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enthusiasm""",
                      // alsoEnglishWord: "also: enthusiasm",
                      britshText: """IpaUK: /ɪnˈθjuːziæzəm/""",
                      americanText: """IpaUS: /ɪnˈθuːziæzəm/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enthusiasm";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her voice was full of enthusiasm.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Bella responded with great enthusiasm.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Reading is one of her many enthusiasms.""");
  }
...
// With short examples define "enthusiasm", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: بەپەرۆشی، تامەزرۆیی، تین‌وگوڕ، تاوسەندن، بەشەوقی، هۆگری، دڵبەستەیی، ورووژان، هەژان، سەرقاڵی، ڕابواردن،	(کۆن، سووکانە) لەدڵ‌نران، ئیلهام، سەرۆ
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) هەستێکی بەهێزی حەز و تاسە بۆ شتێک و ئەوەی کە ببیت بە بەشێک لێی"""),
          SentencesRow(
            englishText: """Her voice was full of enthusiasm.""",
            kurdishText: """دەنگی پڕ بوو لە جۆش‌وخرۆشی.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Bella responded with great enthusiasm.""",
            kurdishText: """بێلا بە بەپەرۆشی زۆرەوە وەڵامی دایەوە.""",
          ...
          SentencesRow(
            englishText:
                """The threat of violence did not dampen the enthusiasm of voters.""",
            kurdishText:
                """هەڕەشەی توندوتیژی تامەزرۆیی دەنگدەرانی کەم نەکردەوە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) شتێک کە زۆرت حەز پێیە و کاتی زۆر بەسەر دەبەیت بە کردنی"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Reading is one of her many enthusiasms.""",
            kurdishText:
                """خوێندنەوە یەکێکە لەو ژمارە زۆرە ئارەزووانەی هەیە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: enthusiasm (Derived forms: enthusiasms)
1. A feeling of excitement
 
2. Overflowing with eager enjoyment or approval (= exuberance, ebullience)
...
const double _startSecondsone = 1752;
const String _videoIdtwo = 'https://youtu.be/8eq2vGEEbB4?t=';
const double _startSecondstwo = 289;
const String _videoIdthree = 'https://youtu.be/Am1lDj2mUVY?t=';
const double _startSecondsthree = 491;
const String _videoIdfour = 'https://youtu.be/9GR3XSuInYE?t=';
const double _startSecondsfour = 477;
const String _videoIdfive = 'https://youtu.be/fez7X_oevNs?t=';
const double _startSecondsfive = 519;
const String _videoIdsix = 'https://youtu.be/qh7dgSldw-w?t=';
const double _startSecondssix = 1403;
