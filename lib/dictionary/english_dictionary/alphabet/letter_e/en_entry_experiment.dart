...
class EnglishEntryexperiment extends StatefulWidget {
  const EnglishEntryexperiment({super.key});

  @override
  State<EnglishEntryexperiment> createState() => _EnglishEntryexperimentState();
}

class _EnglishEntryexperimentState extends State<EnglishEntryexperiment> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""experiment""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """experiment""",
                      // alsoEnglishWord: "also: experiment",
                      britshText: """IpaUK: /ɪkˈsperɪmənt/""",
                      americanText: """IpaUS: /ɪkˈsperɪmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "experiment";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The students freely experimented with paints.""");
  }
...
// With short examples define "experiment", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: experiment (Derived forms: experiments)
1. The act of conducting a controlled test or investigation (= experimentation)
 
2. The testing of an idea (= experimentation)
"it was an experiment in living";
 
3. A venture at something new or different
"as an experiment he decided to grow a beard"

- Verb: experiment (Derived forms: experimented, experimenting, experiments)
1. To conduct a test or investigation
"We are experimenting with the new drug in order to fight this disease"
 
2. Try something new, as in order to gain experience (= try out)
"The composer experimented with a new style"; "Students experiment sexually";
""",
  );
...
const double _startSecondsend = 000000000000000000000000000000; // 977;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/MnExgQ81fhU?t=';
const double _startSecondsone = 00000000000000000000000000000; // 205;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/_RSojioTtUU?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 360;
const String _videoIdthree = 'VIDEOhttps://youtu.be/s3B-qp3U5G0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1194;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/AF8d72mA41M?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 948;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/7j5ul4XBjAI?t=';
