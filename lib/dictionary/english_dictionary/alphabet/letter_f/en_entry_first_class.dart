...
class EnglishEntryfirstclass extends StatefulWidget {
  const EnglishEntryfirstclass({super.key});

  @override
  State<EnglishEntryfirstclass> createState() => _EnglishEntryfirstclassState();
}

class _EnglishEntryfirstclassState extends State<EnglishEntryfirstclass> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: first class (Derived forms: first classes)
...
1. Of the highest quality, skill, etc.; very good or impressive (= ace [informal], A-one [informal], crack [informal], first-rate, super, tiptop, topnotch [informal], top-notch [informal], tops [informal], A1 [informal], excellent, fantabulous [informal], splendid, ripping [Brit, informal], mean [informal], beezer [UK, archaic], lush [Brit, informal], stellar [informal], awesome [informal], brilliant, outstanding, top-drawer)
"a first-class mind";
""",
  );

  final String keyword = "first class";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""first class""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There is more room in first class.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""First class costs more.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She always travels first class.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(""" sent the package first class on Monday.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The car was in first-class condition.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I know a place where the food is first-class.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She bought a first-class ticket for her trip to Paris.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She was awarded a first-class degree in English.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """first class""",
                      // alsoEnglishWord: "also: first class",
                      britshText: """IpaUK: /ˌfɜːst ˈklɑːs/""",
                      americanText: """IpaUS: /ˌfɜːrst ˈklæs/""",
...
// With short examples define "first class", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """There is more room in first class.""",
                      kurdishText: """جێگای زیاتر هەیە لە فێرست کلاس.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەمیشە بە فێرست کلاس گەشت دەکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پاکێجەکەم دووشەممە بە خێراترین نارد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """شوێنێک دەزانم خواردنەکەی باشترینە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بلیتێکی گرانی کڕی بۆ گەشتەکەی بۆ پاریس.""",
                    ...
                    SentencesRow(
                      englishText:
                          """They used to guarantee that a first-class letter would arrive the next day.""",
                      kurdishText:
                          """جاران گەرەنتی ئەوە دەکرا کە نامەی پلە یەک لە ڕۆژی دواتردا دەگەشت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بڕوانامەی باشترینی پێدرا لە ئینگلیزیدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ltOkMlHrGPc?t=';
const double _startSecondsend = 000000000000000000000000000333;
const String _videoIdone = 'https://youtu.be/rxhKrtb3XsE?t=';
const double _startSecondsone = 000000000000000000000000000216;
const String _videoIdtwo = 'https://youtu.be/5hgJOzmXtWw?t=';
const double _startSecondstwo = 00000000000000000000000000034;
const String _videoIdthree = 'https://youtu.be/JN1q2NCNRPg?t=';
const double _startSecondsthree = 000000000000000000000000000410;
const String _videoIdfour = 'https://youtu.be/IBCoZQfKhY4?t=';
const double _startSecondsfour = 00000000000000000000000000061;
const String _videoIdfive = 'https://youtu.be/vp-8-WXeq-E?t=';
