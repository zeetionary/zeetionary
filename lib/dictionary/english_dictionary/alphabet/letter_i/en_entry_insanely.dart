...
class EnglishEntryinsanely extends StatefulWidget {
  const EnglishEntryinsanely({super.key});

  @override
  State<EnglishEntryinsanely> createState() => _EnglishEntryinsanelyState();
}

class _EnglishEntryinsanelyState extends State<EnglishEntryinsanely> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insanely""");
  }
