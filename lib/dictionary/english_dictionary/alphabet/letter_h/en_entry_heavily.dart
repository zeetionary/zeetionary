...
class EnglishEntryheavily extends StatefulWidget {
  const EnglishEntryheavily({super.key});

  @override
  State<EnglishEntryheavily> createState() => _EnglishEntryheavilyState();
}

class _EnglishEntryheavilyState extends State<EnglishEntryheavily> {
  @override
  void initState() {
    super.initState();
...
5. Slowly as if burdened by much weight (- heavy)
"time hung heavily on their hands";
 
6. In a laboured manner
"he breathed heavily"
 
7. Indulging excessively (- intemperately, hard)
"he drank heavily";
""",
  );

  final String keyword = "heavily";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heavily""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It was raining heavily.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They are both heavily involved in politics.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He relies heavily on his parents.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She has been heavily criticized in the press.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""These companies depend heavily on government support.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She fell heavily to the ground.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The heavily built guard stood at the entrance.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was snoring heavily.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He sighed heavily.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Silence hung heavily in the room.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The car was heavily laden on the way home.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heavily""",
                      // alsoEnglishWord: "also: heavily",
                      britshText: """IpaUK: /ˈhevɪli/""",
                      americanText: """IpaUS: /ˈhevɪli/""",
...
کوردی: بە سەختی، زۆر، یەکجار، قورس، گران، بە قورسی، بە زەحمەت
"""),
// With short examples define "heavily", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) بە ئاستێکی زۆر"""),
                    SentencesRow(
                      englishText: """It was raining heavily.""",
                      kurdishText: """بە سەختی باران دەباری.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەردووکیان بە ئاستێکی زۆر بەژداری سیاسەتن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە ئاستێکی زۆر پشت بە دایبابی دەبەستێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە ئاستێکی زۆر ڕەخنەی لێ گیردراوە لە میدیادا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەم کۆمپانیایانە بە ئاستێکی زۆر پشت بە پشتیوانی حکومەت دەبەستن.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵکار) بە هەوڵ و هێزی زۆرەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She fell heavily to the ground.""",
                      kurdishText: """بە سەختی کەوت بە زەویدا.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ھاوەڵکار) بە جەستەیەکی بەهێزو پتەوەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The heavily built guard stood at the entrance.""",
                      kurdishText:
                          """پاسەوانەکە کەتەکە لە پێش دەرگاکە وەستابوو.""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (ھاوەڵکار) بە هێواشی و دەنگی بەرز"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He was snoring heavily.""",
                      kurdishText: """بە دەنگی بەرز پرخەی دەهات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٥. (ھاوەڵکار) بە هێواشی وەک ئەوەی کە نیگەران یان دڵتەنگیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He sighed heavily.""",
                      kurdishText: """بە هێواشی ئاهی هەڵکێشا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٦. (ھاوەڵکار) بە شێوەیەک کە نائاسوودەت دەکات یان دەتشڵەژێنێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Silence hung heavily in the room.""",
                      kurdishText:
                          """کپی بە توندی باڵی بەسەر ژوورەکە کێشا بوو.""",
                      onPressedBritish: () => speaksentence10("en-GB"),
                      onPressedAmerican: () => speaksentence10("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٧. (ھاوەڵکار) پڕ لە شت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The car was heavily laden on the way home.""",
                      kurdishText:
                          """ئۆتۆمبێلەکە بە قورسی بارکرابوو بەرەو ڕێگای ماڵەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/kGg44zdgHYM?t=';
...
const double _startSecondstwo = 000000000000000000000000000896;
const String _videoIdthree = 'https://youtu.be/zqllxbPWKNI?t=';
const double _startSecondsthree = 0000000000000000000000000001681;
const String _videoIdfour = 'https://youtu.be/UuGpm01SPcA?t=';
const double _startSecondsfour = 000000000000000000000000000226;
