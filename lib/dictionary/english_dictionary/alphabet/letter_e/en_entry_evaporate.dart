...
class EnglishEntryevaporate extends StatefulWidget {
  const EnglishEntryevaporate({super.key});

  @override
  State<EnglishEntryevaporate> createState() => _EnglishEntryevaporateState();
}

class _EnglishEntryevaporateState extends State<EnglishEntryevaporate> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evaporate""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evaporate""",
                      // alsoEnglishWord: "also: evaporate",
                      britshText: """IpaUK: /ɪˈvæpəreɪt/""",
                      americanText: """IpaUS: /ɪˈvæpəreɪt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "evaporate";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Heat until all the water has evaporated.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The sun is constantly evaporating the earth's moisture.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her confidence had now completely evaporated.""");
  }
...
کوردی: بە هەڵم کردن، بوونە هەڵم
"""),
          const DefinitionKurdish(text: """١. (کردار) بوون بە هەڵم"""),
          SentencesRow(
            englishText: """Heat until all the water has evaporated.""",
            kurdishText: """گەرمی بکە تاوەکو ئاوەکە دەبێت بە هەڵم.""",
          ...
          SentencesRow(
            ...
            kurdishText: """خۆر بەردەوام شێی زەوی دەکات بە هەڵم.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) نەمان، بەتایبەتی بەوەی کەم‌کەم کەم ببێتەوە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Her confidence had now completely evaporated.""",
            kurdishText: """باوەڕی لەم کاتەدا بە تەواوی نەمابوو.""",
          ...
          SentencesRow(
            englishText:
                """Halfway through the movie reality evaporates and we enter a world of pure fantasy.""",
            kurdishText:
                """لە نیوەی فیلمەکەدا ڕاستی بوونی نامێنێت و دەچینە ناو دونیای خەیاڵەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: evaporate (Derived forms: evaporated, evaporating, evaporates)
1. Lose or cause to lose liquid by vaporization leaving a more concentrated residue (= vaporize, vaporise [Brit])
"evaporate milk";
 
2. Cause to change into a vapour (= vaporise [Brit], vaporize)
"The chemist evaporated the water";
 
3. Change into a vapour (= vaporise [Brit], vaporize)
"The water evaporated in front of our eyes";
 
4. Become less intense and fade away gradually (= melt, disappear)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/tsk9c7KF76E?t=';
const double _startSecondsend = 000000000000000000000000000000; // 138;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/h4CyhQqAPpk?t=';
const double _startSecondsone = 00000000000000000000000000000; // 465;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/-cPdImejxEQ?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 123;
const String _videoIdthree = 'VIDEOhttps://youtu.be/Js2UoMSumx4?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1126;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/W2hRTTTpmr8?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1879;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/02tRxM_1VsE?t=';
