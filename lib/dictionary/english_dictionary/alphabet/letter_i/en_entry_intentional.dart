...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 122;
    const String videoIdone = '-6vzjjIrRK8';
    const double startSecondsone = 41;
    const String videoIdtwo = 'inpok4MKVLM';
    const double startSecondstwo = 2;
    const String videoIdthree = 'W2hRTTTpmr8';
    const double startSecondsthree = 1855;
    const String videoIdfour = 'OgFcz6klaeg';
    const double startSecondsfour = 1078;
    const String videoIdfive = 'nWZMfPP34g8';
