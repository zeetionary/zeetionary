...
class EnglishEntrylunar extends StatefulWidget {
  const EnglishEntrylunar({super.key});

  @override
  State<EnglishEntrylunar> createState() => _EnglishEntrylunarState();
}

class _EnglishEntrylunarState extends State<EnglishEntrylunar> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylunar lunar
WORD_WEB lunar lunar lunar
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lunar";
...
کوردی: 
"""),
// With short examples define "lunar", please follow LX instructions
