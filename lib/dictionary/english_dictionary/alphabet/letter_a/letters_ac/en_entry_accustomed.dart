...
class EnglishEntryaccustomed extends StatelessWidget {
  EnglishEntryaccustomed({super.key});
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "accustomed"), // Find /əˈkʌstəmd/
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈkʌstəmd/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakaccustomed("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈkʌstəmd/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakaccustomed("en-US"),
                            ),
                          ],
                        ),
                      ],
