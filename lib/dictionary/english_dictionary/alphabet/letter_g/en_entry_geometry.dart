...
class EnglishEntrygeometry extends StatefulWidget {
  const EnglishEntrygeometry({super.key});

  @override
  State<EnglishEntrygeometry> createState() => _EnglishEntrygeometryState();
}

class _EnglishEntrygeometryState extends State<EnglishEntrygeometry> {
  @override
  void initState() {
    super.initState();
...
2. The spatial shape and alignment of something
""",
  );

  final String keyword = "geometry";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""geometry""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He analyzed the geometry of chemical bonds.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """geometry""",
                      // alsoEnglishWord: "also: geometry",
                      britshText: """IpaUK: /dʒiˈɒmətri/""",
                      americanText: """IpaUS: /dʒiˈɑːmətri/""",
...
کوردی: 
"""),
// With short examples define "geometry", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Understanding the laws of geometry is essential for architecture.""",
                      kurdishText:
                          """تێگەشتن لە یاساکانی جیۆمەتری گرنگە بۆ تەلارسازی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لێکۆڵینەوەی کرد لە جیۆلۆجی بۆندە کیمیاییەکان.""",
...
const double _startSecondsend = 0000000000000000000000000001437;
const String _videoIdone = 'https://youtu.be/-7bIDbaU_zQ?t=';
const double _startSecondsone = 0000000000000000000000000001084;
const String _videoIdtwo = 'https://youtu.be/Wao0_uB4Zw4?t=';
const double _startSecondstwo = 0000000000000000000000000001042;
const String _videoIdthree = 'https://youtu.be/bw84NjOzdbY?t=';
const double _startSecondsthree = 000000000000000000000000000218;
const String _videoIdfour = 'https://youtu.be/QcUey-DVYjk?t=';
const double _startSecondsfour = 0000000000000000000000000001560;
const String _videoIdfive = 'https://youtu.be/3KC32Vymo0Q?t=';
