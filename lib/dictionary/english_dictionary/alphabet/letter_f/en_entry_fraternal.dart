...
class EnglishEntryfraternal extends StatefulWidget {
  const EnglishEntryfraternal({super.key});

  @override
  State<EnglishEntryfraternal> createState() => _EnglishEntryfraternalState();
}

class _EnglishEntryfraternalState extends State<EnglishEntryfraternal> {
  @override
  void initState() {
    super.initState();
...
2. (of twins) derived from two separate fertilized ova (= biovular)
"fraternal twins are biovular";
 
3. Like or characteristic of or befitting a brother (= brotherly, brotherlike)
"close fraternal ties";
""",
  );

  final String keyword = "fraternal";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fraternal""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He joined a fraternal organization to meet new people.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fraternal""",
                      // alsoEnglishWord: "also: fraternal",
                      britshText: """IpaUK: /frəˈtɜːnl/""",
                      americanText: """IpaUS: /frəˈtɜːrnl/""",
...
// With short examples define "fraternal", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) پەیوەندیدار بە پەیوەندیی ئەو کەسانەی کە هەمان بەرژەوەندی و بیرکردنەوەیان هەیە"""),
                    SentencesRow(
                      englishText:
                          """He joined a fraternal organization to meet new people.""",
                      kurdishText:
                          """پەیوەندیی بە دامەزراوەیەکی هاوبیرانەوە کرد بۆ ناسینی خەڵکی تازە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Her fraternal rivalry with her sister pushed both to excel.""",
                      kurdishText:
                          """ڕکابەریی خوشکانەیی لەگەڵ خوشکەکەی وایکرد هەردووکیان نایاب بن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/kpcLiJezXQw?t=';
const double _startSecondsend = 00000000000000000000000000048;
const String _videoIdone = 'https://youtu.be/38xccDS1wuQ?t=';
const double _startSecondsone = 000000000000000000000000000262;
const String _videoIdtwo = 'https://youtu.be/a2J7foqGExE?t=';
const double _startSecondstwo = 000000000000000000000000000258;
const String _videoIdthree = 'https://youtu.be/otLexmIcqHI?t=';
const double _startSecondsthree = 000000000000000000000000000300;
const String _videoIdfour = 'https://youtu.be/dsz-EcBi9lk?t=';
const double _startSecondsfour = 0000000000000000000000000001174;
const String _videoIdfive = 'https://youtu.be/XWAEKQjN-yM?t=';
const double _startSecondsfive = 0000000000000000000000000005729;
