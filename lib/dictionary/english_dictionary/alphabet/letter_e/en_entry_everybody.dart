...
class EnglishEntryeverybody extends StatefulWidget {
  const EnglishEntryeverybody({super.key});

  @override
  State<EnglishEntryeverybody> createState() => _EnglishEntryeverybodyState();
}

class _EnglishEntryeverybodyState extends State<EnglishEntryeverybody> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""everybody""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """everybody""",
                      alsoEnglishWord: "also: everyone",
                      britshText: """IpaUK: /ˈevribɒdi/""",
                      americanText: """IpaUS: /ˈevribɑːdi/,  /ˈevribʌdi/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "everybody";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Everybody knows Tom.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Have you asked everybody?""");
  }
...
کوردی: هەرکەس، هەرکەسێ، هەموو، هەمووکەسێ
"""),
          const DefinitionKurdish(text: """١. (جێناو) هەموو کەسێک"""),
          SentencesRow(
            englishText: """Everybody knows Tom.""",
            kurdishText: """هەموان تۆم دەناسن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Have you asked everybody?""",
            kurdishText: """پرسیارت لە هەموان کردووە؟""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Didn't you like it? Everybody else did.""",
            kurdishText: """حەزت لێ نەبوو؟ هەموان حەزیان لێ‌بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Pronoun: everybody
1. All people (= everyone, all, all and sundry, one and all)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/hS2x1zl4rn0?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1151;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/_spuxXnul0U?t=';
const double _startSecondsone = 00000000000000000000000000000; // 237;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/_Z0ZQT0FttM?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 195;
const String _videoIdthree = 'VIDEOhttps://youtu.be/r8E1Hq5tktg?t=';
const double _startSecondsthree = 000000000000000000000000000; // 43;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/_wNsZEqpKUA?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 149;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/tXjHb5QmDV0?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 533;
