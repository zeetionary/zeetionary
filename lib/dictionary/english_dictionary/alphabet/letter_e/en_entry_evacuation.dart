...
class EnglishEntryevacuation extends StatefulWidget {
  const EnglishEntryevacuation({super.key});

  @override
  State<EnglishEntryevacuation> createState() => _EnglishEntryevacuationState();
}

class _EnglishEntryevacuationState extends State<EnglishEntryevacuation> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evacuation""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evacuation""",
                      // alsoEnglishWord: "also: evacuation",
                      britshText: """IpaUK: /ɪˌvækjuˈeɪʃn/""",
                      americanText: """IpaUS: /ɪˌvækjuˈeɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "evacuation";
...
کوردی: چۆڵ‌کردن، ڕۆیشتن، بەجێ‌هێشتن، لابردن، تیانەهێشتن، بەتاڵ‌کردن، بردنەدەرەوە، ڕاگوێستن،	دەردان، دەرکردن،	(سەربازی) پاشەکشێ،	پیسایی، گوو
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) گواستنەوەی خەڵکی لە شوێنێکی مەترسیدارەوە بۆ شوێنێکی سەلامەت"""),
          SentencesRow(
            englishText:
                """The evacuation of civilians remains out of the question while the fighting continues.""",
            kurdishText:
                """گواستنەوەی خەڵکی مەدەنی لە دەرەوەی پرسیارە لە کاتێکدا شەڕ بەردەوامە.""",
            englishNote:
                "This means that as long as the fighting persists, it is not considered possible or feasible to evacuate civilians from the area.",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) چۆڵکردنی بینایەک یان شوێنێک بەهۆی ئەوەی مەترسیدارە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Officials ordered the evacuation of the building as the fire spread.""",
            kurdishText:
                """بەرپرسان فەرمانی چۆڵکردنی بیناکەیان دا کە ئاگرەکە بڵاوبوویەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: evacuation (Derived forms: evacuations)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/05gCLHlpzTU?t=';
const double _startSecondsend = 000000000000000000000000000000; // 327;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/J74RN69k6wQ?t=';
const double _startSecondsone = 00000000000000000000000000000; // 10;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/C6YqSTh7loA?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 34;
const String _videoIdthree = 'VIDEOhttps://youtu.be/7hGqq35EocY?t=';
const double _startSecondsthree = 000000000000000000000000000; // 304;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/CxDVAd_N5nI?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1078;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/SIgwJO_ZsIw?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 2306;
