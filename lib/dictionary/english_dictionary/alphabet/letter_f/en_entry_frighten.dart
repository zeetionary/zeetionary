...
class EnglishEntryfrighten extends StatefulWidget {
  const EnglishEntryfrighten({super.key});

  @override
  State<EnglishEntryfrighten> createState() => _EnglishEntryfrightenState();
}

class _EnglishEntryfrightenState extends State<EnglishEntryfrighten> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: frighten (Derived forms: frightened, frightening, frightens)
1. Cause fear in (= fright [archaic], scare, affright)
"The stranger who hangs around the building frightens me";
""",
  );

  final String keyword = "frighten";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frighten""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Sorry, I didn't mean to frighten you.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's not easily frightened.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She doesn't frighten easily.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frighten""",
                      // alsoEnglishWord: "also: frighten",
                      britshText: """IpaUK: /ˈfraɪtn/""",
                      americanText: """IpaUS: /ˈfraɪtn/""",
...
// With short examples define "frighten", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Sorry, I didn't mean to frighten you.""",
                      kurdishText: """ببوورە، نەمویست بتتۆقێنم.""",
                    ...
                    SentencesRow(
                      englishText: """She's not easily frightened.""",
                      kurdishText: """بە ئاسانی ناترسێندرێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It really frightens me to think how this might have ended.""",
                      kurdishText:
                          """ئەوە بەڕاستی دەمتۆقێنێت کە ئەمە دەکرا چۆن تەواو ببایە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/P8m-KThvtxA?t=';
const double _startSecondsend = 000000000000000000000000000151;
const String _videoIdone = 'https://youtu.be/i7mqjhOYL-8?t=';
const double _startSecondsone = 000000000000000000000000000241;
const String _videoIdtwo = 'https://youtu.be/62EGPCEmeh4?t=';
const double _startSecondstwo = 000000000000000000000000000628;
const String _videoIdthree = 'https://youtu.be/0TQEfdweQ14?t=';
const double _startSecondsthree = 00000000000000000000000000060;
const String _videoIdfour = 'https://youtu.be/rhzgUq-lDVU?t=';
const double _startSecondsfour = 0000000000000000000000000001449;
const String _videoIdfive = 'https://youtu.be/SHfqtaa0VI8?t=';
