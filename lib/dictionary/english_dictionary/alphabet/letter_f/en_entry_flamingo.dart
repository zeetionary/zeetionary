...
class EnglishEntryflamingo extends StatefulWidget {
  const EnglishEntryflamingo({super.key});

  @override
  State<EnglishEntryflamingo> createState() => _EnglishEntryflamingoState();
}

class _EnglishEntryflamingoState extends State<EnglishEntryflamingo> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flamingo""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The flamingo stood gracefully in the water.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She saw a flamingo at the zoo.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flamingo""",
                      // alsoEnglishWord: "also: flamingo",
                      britshText: """IpaUK: /fləˈmɪŋɡəʊ/""",
                      americanText: """IpaUS: /fləˈmɪŋɡəʊ/""",
...
کوردی: (گیانەوەرناسی) قورینگ، سوورەقورینگ، کەرنگ، قوڵینگ
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """فلامینگۆیەکە بەشکۆوە لە ئاوەکە وەستابوو.""",
                    ...
                    SentencesRow(
                      englishText: """She saw a flamingo at the zoo.""",
                      kurdishText: """فلامینگۆیەکی لە باخچە ئاژەڵانەکە بینی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Ejttw_yBHRE?t=';
const double _startSecondsend = 00000000000000000000000000036;
const String _videoIdone = 'https://youtu.be/b2AN1cPn3zY';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/Krv3fMogsTc?t=';
const double _startSecondstwo = 00000000000000000000000000012;
const String _videoIdthree = 'https://youtu.be/gyWH0SOHCuE?t=';
const double _startSecondsthree = 00000000000000000000000000054;
const String _videoIdfour = 'https://youtu.be/HF8PCofUiBE?t=';
const double _startSecondsfour = 0000000000000000000000000005;
const String _videoIdfive = 'https://youtu.be/uY2hoaiuR5I?t=';
