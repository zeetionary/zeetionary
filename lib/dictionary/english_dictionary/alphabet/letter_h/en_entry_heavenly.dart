...
class EnglishEntryheavenly extends StatefulWidget {
  const EnglishEntryheavenly({super.key});

  @override
  State<EnglishEntryheavenly> createState() => _EnglishEntryheavenlyState();
}

class _EnglishEntryheavenlyState extends State<EnglishEntryheavenly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: heavenly (Derived forms: heavenlier, heavenliest)
1. Relating to or inhabiting a divine heaven (- celestial)
"heavenly hosts";
 
2. Of or relating to the sky (- celestial)
"a heavenly body";
 
3. Of or belonging to heaven or god
 
4. [informal] Extraordinarily good or great; used especially as an intensifier (- fantastic, grand, howling [informal], marvelous [US], marvellous [Brit, Cdn], rattling [informal], terrific, tremendous, wonderful, wondrous, phenomenal, epic [slang], magnificent)
"a heavenly trip to the Orient";
""",
  );

  final String keyword = "heavenly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heavenly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """They believed in eternal peace within the Heavenly Kingdom.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The night sky was filled with countless heavenly bodies.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This place is heavenly.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heavenly""",
                      // alsoEnglishWord: "also: heavenly",
                      britshText: """IpaUK: /ˈhevnli/""",
                      americanText: """IpaUS: /ˈhevnli/""",
...
کوردی: بەهەشتی، ئاسمانی، خودایی، پیرۆز،	یەکجار خۆش یان جوان، سەیر
"""),
// With short examples define "heavenly", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) پەیوەندیدار بە بەهەشت"""),
                    SentencesRow(
                      englishText:
                          """They believed in eternal peace within the Heavenly Kingdom.""",
                      kurdishText:
                          """باوەڕیان بە ئاشتی بێ‌کۆتا هەبوو لە شانشینی بەهەشت.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) پەیوەندیدار بە ئاسمان"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The night sky was filled with countless heavenly bodies.""",
                      kurdishText:
                          """ئاسمانی شەو پڕ بوو لە تەنی ئاسمانی لەژمارە نەهاتوو.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ھاوەڵناو) زۆر جوان"""),
                    const AlsoEnglishckb(word: "ھەروەھا: wonderful"),
                    SentencesRow(
                      englishText: """This place is heavenly.""",
                      kurdishText: """ئەم شوێنە بەهەشتە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/_Q0FYoCl4Cs';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/b7Plu03Fp7I?t=';
const double _startSecondsone = 000000000000000000000000000240;
const String _videoIdtwo = 'https://youtu.be/BJh3RKMrbUM?t=';
const double _startSecondstwo = 000000000000000000000000000777;
const String _videoIdthree = 'https://youtu.be/GaLdHd2J-xM?t=';
const double _startSecondsthree = 00000000000000000000000000018;
const String _videoIdfour = 'https://youtu.be/lEgPVrSZa6w?t=';
const double _startSecondsfour = 000000000000000000000000000751;
const String _videoIdfive = 'https://youtu.be/nATIs_oIL8U?t=';
