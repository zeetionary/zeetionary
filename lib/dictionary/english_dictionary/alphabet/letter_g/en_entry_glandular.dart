...
class EnglishEntryglandular extends StatefulWidget {
  const EnglishEntryglandular({super.key});

  @override
  State<EnglishEntryglandular> createState() => _EnglishEntryglandularState();
}

class _EnglishEntryglandularState extends State<EnglishEntryglandular> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: glandular
1. Relating to, affecting or functioning as a gland
"glandular malfunctions"
""",
  );

  final String keyword = "glandular";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""glandular""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The glandular cells release hormones into the blood.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glandular""",
                      // alsoEnglishWord: "also: glandular",
                      britshText: """IpaUK: /ˈɡlændʒələ(r)/""",
                      americanText: """IpaUS: /ˈɡlændʒələr/""",
...
کوردی: 
"""),
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) پەیوەندیدار بە ڕژێنەکانی جەستە کە شتێک بەرهەم دەهێنن بۆ بەکارهێنان"""),
                    SentencesRow(
                      englishText: """The glandular cells release hormones into the blood.""",
                      kurdishText: """خانە ڕژێنەرەکان هۆرمۆن دەڕژێننە ناو خوێن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/BYLXg8WlS_w?t=';
const double _startSecondsend = 0000000000000000000000000001017;
const String _videoIdone = 'https://youtu.be/Solb9uA-tgQ?t=';
const double _startSecondsone = 0000000000000000000000000004747;
const String _videoIdtwo = 'https://youtu.be/9woWpUIhQ9o?t=';
const double _startSecondstwo = 000000000000000000000000000653;
const String _videoIdthree = 'https://youtu.be/urIzKcCWFws?t=';
const double _startSecondsthree = 000000000000000000000000000478;
const String _videoIdfour = 'https://youtu.be/P3qwJjxzgRY?t=';
const double _startSecondsfour = 000000000000000000000000000508;
const String _videoIdfive = 'https://youtu.be/1H2EGYcKF-c?t=';
