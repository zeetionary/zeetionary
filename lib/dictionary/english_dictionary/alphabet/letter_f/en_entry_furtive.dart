...
class EnglishEntryfurtive extends StatefulWidget {
  const EnglishEntryfurtive({super.key});

  @override
  State<EnglishEntryfurtive> createState() => _EnglishEntryfurtiveState();
}

class _EnglishEntryfurtiveState extends State<EnglishEntryfurtive> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: furtive
1. Marked by quiet and caution and secrecy; taking pains to avoid being observed (- sneak, sneaky, stealthy, surreptitious)
"a furtive manner";
 
2. Secret and sly or sordid (- backstair, backstairs)
"furtive behaviour";
""",
  );

  final String keyword = "furtive";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""furtive""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The look in his eyes became furtive.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furtive""",
                      // alsoEnglishWord: "also: furtive",
                      britshText: """IpaUK: /ˈfɜːtɪv/""",
                      americanText: """IpaUS: /ˈfɜːrtɪv/""",
...
کوردی: بەدزی‌یەوە، لەبنەوە، پەنامەکی، بەنهێنی، نهێنی‌یانە، نەتەنی، شاراوە،	جێی‌گومان، گوماناوی، جێگای شک
"""),
// With short examples define "furtive", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) ڕەفتارکردن بە شێوەیەک کە دەتەوێت شتێک بە نهێنی بهێڵیتەوە و ماتەوێت ببیندرێیت"""),
                    SentencesRow(
                      englishText: """The look in his eyes became furtive.""",
                      kurdishText: """نیگای چوەکانی پەنامەکی بوون.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I saw him cast a furtive glance at the woman at the table to his right.""",
                      kurdishText:
                          """بینییم کە نیگایەکی نهێنییانەی کرد لەو ژنەی لە مێزەکەی لای ڕاستی بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/UJi-0nl5icI?t=';
const double _startSecondsend = 000000000000000000000000000693;
const String _videoIdone = 'https://youtu.be/jmKfs40arbg?t=';
const double _startSecondsone = 00000000000000000000000000069;
const String _videoIdtwo = 'https://youtu.be/tdnOebPWrcI?t=';
const double _startSecondstwo = 00000000000000000000000000084;
const String _videoIdthree = 'https://youtu.be/Rxh_SVtyZqo?t=';
const double _startSecondsthree = 0000000000000000000000000001747;
const String _videoIdfour = 'https://youtu.be/cfyeXOUNbJ8?t=';
const double _startSecondsfour = 000000000000000000000000000299;
const String _videoIdfive = 'https://youtu.be/rvHBZtFExH4?t=';
