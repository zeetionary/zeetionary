...
// replace these: replace EnglishEntryunderage - replace speakUnderage - replace under age - /ˈʌndər eɪdʒ/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryunderage extends StatelessWidget {
  EnglishEntryunderage({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakUnderage(String languageCode) async {
    // DOPSUM: CHANGE speakUnderage
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("underage");
  }
  ...
  //   await flutterTts.setPitch(1.0);
  //   await flutterTts.setSpeechRate(0.5);
  //   await flutterTts.speak("under age");
  // }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'dQuRfXhjld4';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'ncP-T9NB-8A';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '2gU8lXbqN68';
