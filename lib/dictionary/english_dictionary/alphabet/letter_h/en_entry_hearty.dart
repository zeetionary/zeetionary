...
class EnglishEntryhearty extends StatefulWidget {
  const EnglishEntryhearty({super.key});

  @override
  State<EnglishEntryhearty> createState() => _EnglishEntryheartyState();
}

class _EnglishEntryheartyState extends State<EnglishEntryhearty> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hearty (Derived forms: heartier, heartiest)
1. Showing warm and heartfelt friendliness
"a hearty welcome"; "gave us a hearty reception"
 
2. Providing abundant nourishment (- satisfying, solid, square, substantial)
"a hearty meal";
 
3. Endowed with or exhibiting great bodily or mental health (- full-blooded, lusty, red-blooded)
...
- Noun: hearty (Derived forms: hearties)
Usage: Brit
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The Colonel gave me a hearty handshake.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her laugh was far too hearty to be genuine.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""A hearty breakfast kept her full until lunchtime.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""After the workout, he had a hearty appetite.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He nodded his head in hearty agreement.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The old sailor was known as a true hearty among his crew.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hearty""",
                      // alsoEnglishWord: "also: hearty",
                      britshText: """IpaUK: /ˈhɑːti/""",
                      americanText: """IpaUS: /ˈhɑːrti/""",
...
کوردی: گەرم‌وگوڕانە، دۆستانە، گەرم، بەپەرۆشانە، تامەزۆریانە،	بەکەیف، بەگوڕ، شاد، بەتین،	زۆر، گەلێ، گەورە،	ساغ، سڵامەت، بەهێز، ساخلەم
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) هەبوونی هەستی دۆستانە بۆ کەسێک"""),
                    SentencesRow(
                      englishText:
                          """The Colonel gave me a hearty handshake.""",
                      kurdishText: """کۆلۆنێڵەکە تەوقەیەکی دۆستانەی پێمدا.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) بە دەنگی بەرز و پڕ لە وزە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Her laugh was far too hearty to be genuine.""",
                      kurdishText:
                          """پێکەنینەکەی زۆر بەتین بوو کە ڕاستی بێت.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ھاوەڵناو) ژەمە خواردنێکی گەورە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """A hearty breakfast kept her full until lunchtime.""",
                      kurdishText:
                          """نانێکی زۆری بەیانی تا نیوەڕۆ بە تێری هێشتییەوە.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (ھاوەڵناو) هەبوونی ئیشتیای زۆری خواردن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """After the workout, he had a hearty appetite.""",
                      kurdishText: """لە دوای ڕاهێنان ئیشتیایەکی زۆری هەبوو.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٥. (ھاوەڵناو) پیشاندانی هەستی زۆر بۆ شتێک """),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He nodded his head in hearty agreement.""",
                      kurdishText: """بە ڕازیبوونی بەکەیف سەری لەقاند.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٦. (ناو) کەسێک کە دەنگی بەرزە، خۆشحاڵە، و پڕ لە وزەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The old sailor was known as a true hearty among his crew.""",
                      kurdishText:
                          """دەریاوانە بەتەمەنەکە بە پیاوێکی بەگوڕ ناسراو بوو لە نێوان تاقمەکەیدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/a9m3GD0DbPY?t=';
const double _startSecondsend = 0000000000000000000000000001876;
const String _videoIdone = 'https://youtu.be/Fr-qagv7ig0?t=';
const double _startSecondsone = 0000000000000000000000000001502;
const String _videoIdtwo = 'https://youtu.be/6Xf858oNEak?t=';
const double _startSecondstwo = 000000000000000000000000000118;
const String _videoIdthree = 'https://youtu.be/Q-nWA0WeF98?t=';
const double _startSecondsthree = 000000000000000000000000000621;
const String _videoIdfour = 'https://youtu.be/350Xlkvn0Ko?t=';
const double _startSecondsfour = 000000000000000000000000000471;
const String _videoIdfive = 'https://youtu.be/ATwD5WZmR1g?t=';
const double _startSecondsfive = 00000000000000000000000000035;
