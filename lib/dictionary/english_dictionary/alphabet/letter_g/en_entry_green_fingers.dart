...
class EnglishEntrygreenfingers extends StatefulWidget {
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: green fingers
Usage: Brit (N. Amer: green thumb)
1. A special ability to make plants grow (- green thumb [N. Amer])
""",
  );

  final String keyword = "green fingers";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""green fingers""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She has green fingers and a beautiful garden.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """green fingers""",
                      // alsoEnglishWord: "also: green fingers",
                      britshText: """IpaUK: /ˌɡriːn ˈfɪŋɡəz/""",
                      americanText: """IpaUS: /ˌɡriːn ˈfɪŋɡərz/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەست ڕەنگینە و باخچەیەکی جوانی هەیە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/x0f7Vb8u3FA?t=';
const double _startSecondsend = 000000000000000000000000000875;
const String _videoIdone = 'https://youtu.be/haAjZnWwE1s?t=';
const double _startSecondsone = 000000000000000000000000000491;
const String _videoIdtwo = 'https://youtu.be/T2GByAxJp0Y?t=';
const double _startSecondstwo = 0000000000000000000000000001170;
const String _videoIdthree = 'https://youtu.be/vE-LjdlwgrE?t=';
const double _startSecondsthree = 0000000000000000000000000001199;
const String _videoIdfour = 'https://youtu.be/Cq6m7xq-lic?t=';
const double _startSecondsfour = 00000000000000000000000000040;
const String _videoIdfive = 'https://youtu.be/OWpEbz3Dfuc?t=';
const double _startSecondsfive = 000000000000000000000000000844;
