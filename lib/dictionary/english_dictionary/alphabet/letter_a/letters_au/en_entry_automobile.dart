...
class EnglishEntryautomobile extends StatelessWidget {
  ...
  Future<void> speakautomobile(String languageCode) async {
    ...
    await flutterTts.speak("automobile");
  }
  ...
  Future<void> speakautomobile847(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Learning to drive an automobile is not easy.");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'voXzQppLGuo';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'z0tCWKKfNAw';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '6Qou6qu4Gz8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '5hV3cMuQ7uk';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'itUQU1jtwz4';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '0CYYfSGTcyY';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = '-ZDZtBRTyeI';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = '9JL3XxbL4Sw';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'VdG4gUTowXc';
