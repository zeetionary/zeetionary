...
class EnglishEntryfairtrade extends StatefulWidget {
  const EnglishEntryfairtrade({super.key});

  @override
  State<EnglishEntryfairtrade> createState() => _EnglishEntryfairtradeState();
}

class _EnglishEntryfairtradeState extends State<EnglishEntryfairtrade> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fair-trade""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fair-trade""",
                      // alsoEnglishWord: "also: fair-trade",
                      britshText: """IpaUK: /ˌfeə ˈtreɪd/""",
                      americanText: """IpaUS: /ˌfer ˈtreɪd/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "fair-trade";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We buy 10% of our bananas from fair-trade sources.""");
  }
...
// With short examples define "fair-trade", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          ...
          SentencesRow(
            ...
            kurdishText:
                """١٠٪ ـی مۆزەکانمان لە سەرچاوەی بازرگانیی دادپەروەرانە دەکڕین.""",
...
​1. involving trade that supports producers in developing countries by paying fair prices and making sure that workers have good working conditions and fair pay
...
const String _videoIdend = 'https://youtu.be/c162wQ_VSKE?t=';
const double _startSecondsend = 000000000000000000000000000168;
const String _videoIdone = 'https://youtu.be/PimOYAxsqqI?t=';
const double _startSecondsone = 000000000000000000000000000119;
const String _videoIdtwo = 'https://youtu.be/CZyp67TpM3k?t=';
const double _startSecondstwo = 00000000000000000000000000073;
const String _videoIdthree = 'https://youtu.be/0xJbwEl-QXw?t=';
const double _startSecondsthree = 000000000000000000000000000375;
const String _videoIdfour = 'https://youtu.be/apaZbbTtvQw?t=';
const double _startSecondsfour = 0000000000000000000000000002017;
const String _videoIdfive = 'https://youtu.be/41_6RGrZA5o?t=';
