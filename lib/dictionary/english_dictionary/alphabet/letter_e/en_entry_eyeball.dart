...
class EnglishEntryeyeball extends StatefulWidget {
  const EnglishEntryeyeball({super.key});

  @override
  State<EnglishEntryeyeball> createState() => _EnglishEntryeyeballState();
}

class _EnglishEntryeyeballState extends State<EnglishEntryeyeball> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""eyeball""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """eyeball""",
                      // alsoEnglishWord: "also: eyeball",
                      britshText: """IpaUK: /ˈaɪbɔːl/""",
                      americanText: """IpaUS: /ˈaɪbɔːl/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She felt pain in her left eyeball.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They eyeballed each other across the room.""");
  }
...
// کوردی: گۆی چاو، تۆپی چاو، گلێنە، بیبیلە
// """),
...
const double _startSecondsend = 000000000000000000000000000425;
const String _videoIdone = 'https://youtu.be/iCdmg4bDHY4?t=';
const double _startSecondsone = 000000000000000000000000000207;
const String _videoIdtwo = 'https://youtu.be/ztH77Bl4qns?t=';
const double _startSecondstwo = 000000000000000000000000000105;
const String _videoIdthree = 'https://youtu.be/6OT4GW2A-AQ?t=';
const double _startSecondsthree = 000000000000000000000000000416;
const String _videoIdfour = 'https://youtu.be/SHniDEf3pxU?t=';
