...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'Y8hi6A5MPVY';
    const double startSecondsone = 18;
    const String videoIdtwo = '0IoJBV29zMg';
    const double startSecondstwo = 479;
    const String videoIdthree = 'qr4MSVxfYBE';
    const double startSecondsthree = 0;
    const String videoIdfour = 'UOc7xdRhAAY';
    const double startSecondsfour = 199;
    const String videoIdfive = 'D6V85qfsu3g';
    const double startSecondsfive = 1165;
