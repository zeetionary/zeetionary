...
class EnglishEntryabsolutely extends StatefulWidget {
  const EnglishEntryabsolutely({super.key});

  @override
  State<EnglishEntryabsolutely> createState() => _EnglishEntryabsolutelyState();
}

class _EnglishEntryabsolutelyState extends State<EnglishEntryabsolutely> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "absolutely";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""absolutely""");
  }
  ...
  Future<void> speaka2143(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She absolutely adores you.");
  }

  Future<void> speakab7569(String languageCode) async {
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The place was absolutely packed.");
  }

  Future<void> speaka8632(String languageCode) async {
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("You're absolutely right.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """absolutely""",
                      // alsoEnglishWord: "also: absolutely",
                      britshText: """IpaUK: /ˈæbsəluːtli/""",
                      americanText: """IpaUS: /ˈæbsəluːtli/""",
