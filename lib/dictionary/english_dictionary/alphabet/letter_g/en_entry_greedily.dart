...
class EnglishEntrygreedily extends StatefulWidget {
  const EnglishEntrygreedily({super.key});

  @override
  State<EnglishEntrygreedily> createState() => _EnglishEntrygreedilyState();
}

class _EnglishEntrygreedilyState extends State<EnglishEntrygreedily> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: greedily
1. In a greedy manner (- avariciously, covetously)
"greedily chewing a crust of bread and filling himself another glass";
""",
  );

  final String keyword = "greedily";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""greedily""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She ate noisily and greedily.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """greedily""",
                      // alsoEnglishWord: "also: greedily",
                      britshText: """IpaUK: /ˈɡriːdɪli/""",
                      americanText: """IpaUS: /ˈɡriːdɪli/""",
...
// With short examples define "greedily", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک پارە، دەسەڵات، خواردن، هتد ــی زیاترت دەوێت وەک لەوەی پێویستتە"""),
                    SentencesRow(
                      englishText: """She ate noisily and greedily.""",
                      kurdishText: """بە مڵچەمڵچ و چڵێسانە دەیخوارد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/8y58X14nYcM?t=';
const double _startSecondsend = 000000000000000000000000000726;
const String _videoIdone = 'https://youtu.be/6EuzOQOnX2A?t=';
const double _startSecondsone = 000000000000000000000000000518;
const String _videoIdtwo = 'https://youtu.be/h_gv2BnM9To?t=';
const double _startSecondstwo = 0000000000000000000000000001013;
const String _videoIdthree = 'https://youtu.be/DczPnt0YCTg?t=';
const double _startSecondsthree = 000000000000000000000000000899;
const String _videoIdfour = 'https://youtu.be/iDUqUpNWtl4?t=';
const double _startSecondsfour = 000000000000000000000000000517;
const String _videoIdfive = 'https://youtu.be/598YV7DbwJU?t=';
const double _startSecondsfive = 000000000000000000000000000264;
