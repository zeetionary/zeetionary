...
class EnglishEntryforearm extends StatefulWidget {
  const EnglishEntryforearm({super.key});

  @override
  State<EnglishEntryforearm> createState() => _EnglishEntryforearmState();
}

class _EnglishEntryforearmState extends State<EnglishEntryforearm> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forearm (Derived forms: forearms)
1. The part of the superior limb between the elbow and the wrist

- Verb: forearm (Derived forms: forearming, forearms, forearmed)
1. Arm in advance of a confrontation
""",
  );

  final String keyword = "forearm";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forearm""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her forearm was covered in a tattoo.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forearm""",
                      // alsoEnglishWord: "also: forearm",
                      britshText: """IpaUK: /ˈfɔːrɑːm/""",
                      americanText: """IpaUS: /ˈfɔːrɑːrm/""",
...
کوردی: قۆڵ، باسک، بەوش، پێش‌قۆڵ، ئەرەج، ئەشک
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بەشی خوارەوەی باڵ لە نێوان ئانیشک و مەچەک"""),
                    SentencesRow(
                      englishText: """Her forearm was covered in a tattoo.""",
                      kurdishText: """باسکی بە تاتۆداپۆشرابوو.""",
...
const double _startSecondsend = 000000000000000000000000000600;
...
const String _videoIdthree = 'https://youtu.be/a9m3GD0DbPY?t=';
const double _startSecondsthree = 0000000000000000000000000001210;
const String _videoIdfour = 'https://youtu.be/58XEfDtU0Z4?t=';
const double _startSecondsfour = 000000000000000000000000000649;
const String _videoIdfive = 'https://youtu.be/6QgR6Tjle7g?t=';
const double _startSecondsfive = 000000000000000000000000000447;
