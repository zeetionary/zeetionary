...
class EnglishEntryentanglement extends StatefulWidget {
  const EnglishEntryentanglement({super.key});

  @override
  State<EnglishEntryentanglement> createState() =>
      _EnglishEntryentanglementState();
}

class _EnglishEntryentanglementState extends State<EnglishEntryentanglement> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""entanglement""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """entanglement""",
                      // alsoEnglishWord: "also: entanglement",
                      britshText: """IpaUK: /ɪnˈtæŋɡlmənt/""",
                      americanText: """IpaUS: /ɪnˈtæŋɡlmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "entanglement";
...
کوردی: گیرکردن، پێوەبوون، تووش‌بوون، گیر، قۆرت، گرێ، تێوەگلان، دوچاربوون، ئاڵاوی، گێچەڵ، مایەی تووش‌بوون یان گیر، تێوەگلێنە، (سەربازی) تۆڕی تێلبەند، تێلبەندان، لەمپەری ئاسن‌دڕک
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) پەیوەندییەکی سەخت لەگەڵ کەسێکی دیکە یان وڵاتێک"""),
          SentencesRow(
            englishText:
                """The book describes the complex emotional and sexual entanglements between the members of the group.""",
            kurdishText:
                """کتێبەکە باسی پەیوەندییە ئاڵۆزییە دەروونی و سێکسییەکان لە نێوان ئەندامانی گرووپەکە.""",
          ...
          SentencesRow(
            englishText:
                """Many dolphins die each year from entanglement in fishing nets.""",
            kurdishText:
                """زۆر دۆڵفین ساڵانە دەمرن بە ئازڵکان لە تۆڕەکانی ماسی‌گرتن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: entanglement (Derived forms: entanglements)
1. An intricate trap that entangles or ensnares its victim (= web)
""",
  );
...
const String _videoIdend = 'https://youtu.be/DuFyGHgGIKg';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/QINII0eeJxc?t=';
const double _startSecondsone = 318;
const String _videoIdtwo = 'https://youtu.be/pXoZQsZP2PY?t=';
const double _startSecondstwo = 884;
const String _videoIdthree = 'https://youtu.be/D0-JbxX209g?t=';
const double _startSecondsthree = 113;
const String _videoIdfour = 'https://youtu.be/JnKzt6Xq-w4?t=';
const double _startSecondsfour = 179;
const String _videoIdfive = 'https://youtu.be/pWlk1gLkF2Y?t=';
const double _startSecondsfive = 825;
const String _videoIdsix = 'https://youtu.be/1E_q-sN-0LM?t=';
const double _startSecondssix = 287;
