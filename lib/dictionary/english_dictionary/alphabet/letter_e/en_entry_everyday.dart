...
class EnglishEntryeveryday extends StatefulWidget {
  const EnglishEntryeveryday({super.key});

  @override
  State<EnglishEntryeveryday> createState() => _EnglishEntryeverydayState();
}

class _EnglishEntryeverydayState extends State<EnglishEntryeveryday> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""everyday""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """everyday""",
                      // alsoEnglishWord: "also: everyday",
                      britshText: """IpaUK: ˈevrideɪ/""",
                      americanText: """IpaUS: ˈevrideɪ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Change is a part of everyday life in business.""");
  }
...
کوردی: هەر ڕۆژ، هەموو ڕۆژێ، گ ڕۆژێ،	ڕۆژانە، ئاسایی، عەدەتی
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) کە هەموو ڕۆژێک ڕوودەدات یان بەکاردێت"""),
          SentencesRow(
            englishText: """Change is a part of everyday life in business.""",
            kurdishText: """گۆڕان بەشێکە لە ژیانی ڕۆژانە لە کاردا.""",
          ...
          SentencesRow(
            englishText:
                """Violent crime is part of the everyday experience of the people in these neighbourhoods.""",
            kurdishText:
                """تاوانی توندوتیژی بەشێکە لە ئەزموونی ڕۆژانەی خەڵکی لەم گەڕەکانە.""",
          ...
          SentencesRow(
            englishText:
                """They are good at finding inventive solutions to everyday problems.""",
            kurdishText:
                """باشن لە دۆزینەوەی چارەسەری داهێنەرانە بۆ کێشەکانی ڕۆژانە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: everyday
1. Found in the ordinary course of events (= mundane, quotidian, routine, unremarkable, workaday)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/UuGpm01SPcA?t=';
const double _startSecondsend = 000000000000000000000000000000; // 148;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/_LUX70mXcEE?t=';
const double _startSecondsone = 00000000000000000000000000000; // 95;
...
const String _videoIdthree = 'VIDEOhttps://youtu.be/yPM77NPZyJo?t=';
const double _startSecondsthree = 000000000000000000000000000; // 116;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/e2cdTIaQph4?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 207;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/ad_higXixRA';
