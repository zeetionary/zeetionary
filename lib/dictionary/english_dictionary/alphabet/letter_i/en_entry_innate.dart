...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'JTB5T5aldNo';
    const double startSecondsend = 408;
    const String videoIdone = 'ha2mLz-Xdpg';
    const double startSecondsone = 670;
    const String videoIdtwo = '2ot7GKuEqas';
    const double startSecondstwo = 557;
    const String videoIdthree = 'gi6SYQyVIf8';
    const double startSecondsthree = 81;
    const String videoIdfour = 'gzjasvooSG8';
    const double startSecondsfour = 620;
    const String videoIdfive = 'atNiYtCTcPc';
