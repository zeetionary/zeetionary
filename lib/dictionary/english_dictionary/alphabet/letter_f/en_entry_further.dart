...
"""),
                        ...
                        MyExpansionTile(
                          children: [
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """دەتوانیت ھیچ زانیاریی دیکەم پێ بدەیت؟""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """ھیچ بەرەوپێشچوونی زیاتر ڕانەگەیەندراوە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """بڕیارمانداوە ھەنگاوی زیاتر نەنێین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کەمێک زیاتر لەوە ڕێمان کرد کە ھەستم پێکردبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """زۆر ماندووم کە ھیچی دیکە بچم.""",
                    ...
                    SentencesRow(
                      englishText:
                          """My life is further complicated by having to work such long hours.""",
                      kurdishText:
                          """ژیانم زیاتر ئاڵۆزە بەوەی دەبێت کاتژمێری وەھا درێژ کار بکەم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ھیچ نەدەکرا زیاتر (لەوە) لە ڕاستییەوە دوور بێت.""",
...
const String _videoIdthree = 't6fIp7mMJ90';
const double _startSecondsthree = 12;
const String _videoIdfour = 'DesEUpFgGrQ';
const double _startSecondsfour = 13;
const String _videoIdfive = 'u1GZk3TWNQQ';
