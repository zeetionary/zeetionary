...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/0jltioeaEyY?t=';
    const double startSecondsone = 000000000000000000000000000348;
    const String videoIdtwo = 'https://youtu.be/Sbp_EeBk-As?t=';
    const double startSecondstwo = 0000000000000000000000000001917;
    const String videoIdthree = 'https://youtu.be/58XEfDtU0Z4?t=';
    const double startSecondsthree = 0000000000000000000000000001366;
    const String videoIdfour = 'https://youtu.be/1I1vxu5qIUM?t=';
