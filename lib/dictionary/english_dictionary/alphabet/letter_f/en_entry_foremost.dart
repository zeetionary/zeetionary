...
class EnglishEntryforemost extends StatefulWidget {
  const EnglishEntryforemost({super.key});

  @override
  State<EnglishEntryforemost> createState() => _EnglishEntryforemostState();
}

class _EnglishEntryforemostState extends State<EnglishEntryforemost> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: foremost
1. Ranking above all others (= first, world-class, world-beating)
"the foremost figure among marine artists";
 
2. Preceding all others in spatial position (= frontmost)
...
- Adverb: foremost
1. Prominently forward (= first)
"he put his best foot foremost";
 
2. Before anything else (= first, firstly, first of all, first off)
"foremost we must consider the garter snake";
""",
  );

  final String keyword = "foremost";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foremost""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""This question has been foremost in our minds recently.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foremost""",
                      // alsoEnglishWord: "also: foremost",
                      britshText: """IpaUK: /ˈfɔːməʊst/""",
                      americanText: """IpaUS: /ˈfɔːrməʊst/""",
...
کوردی: ناسراوترین، ناودارترین،	گرنگ‌ترین،	باش‌ترین، چاک‌ترین،	سەرەکی، بنچینەیی،	(لە)پێش‌ترین، لەپێشەوەترین، پێش‌تر لە هەموو
"""),
// With short examples define "foremost", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """I'd like to introduce you to the world's foremost authority on the subject.""",
                      kurdishText:
                          """دەمەوێت ئاشنات بکەم بە باشترین سەرچاوە لەسەر بابەتەکە.""",
                      englishNote:
                          """This means that I want to present to you the person who is the most knowledgeable and respected expert in this particular field or subject.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەم پرسیارە لەپێشینەترین بووە تازەگی لە هزرماندا.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵکار) زیاتر لە هەر شتی دیکە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He does a little teaching, but first and foremost he's a writer.""",
                      kurdishText:
                          """کەمێک وانە دەڵێتەوە، بەڵام بەشێوەیەکی سەرەکی نووسەرە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """This memoir is, foremost, a declaration of the enduring power of love.""",
                      kurdishText:
                          """ئەم بیرنامەیە، لە هەر شت زیاتر، بەیانکردنی هێزی بەرفراوانی خۆشەویستییە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/D_Y18GEjfNY?t=';
const double _startSecondsend = 000000000000000000000000000320;
...
const double _startSecondstwo = 0000000000000000000000000001626;
const String _videoIdthree = 'https://youtu.be/esfChb49_Rk?t=';
const double _startSecondsthree = 000000000000000000000000000357;
const String _videoIdfour = 'https://youtu.be/_0RTH57v66I?t=';
const double _startSecondsfour = 000000000000000000000000000599;
const String _videoIdfive = 'https://youtu.be/q8y-RLkpsnk?t=';
const double _startSecondsfive = 000000000000000000000000000239;
