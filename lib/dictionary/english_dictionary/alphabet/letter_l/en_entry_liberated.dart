...
class EnglishEntryliberated extends StatefulWidget {
  const EnglishEntryliberated({super.key});

  @override
  State<EnglishEntryliberated> createState() => _EnglishEntryliberatedState();
}

class _EnglishEntryliberatedState extends State<EnglishEntryliberated> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""liberated""");
  }
