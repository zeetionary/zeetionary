...
class EnglishEntryindignantly extends StatefulWidget {
  const EnglishEntryindignantly({super.key});

  @override
  State<EnglishEntryindignantly> createState() =>
      _EnglishEntryindignantlyState();
}

class _EnglishEntryindignantlyState extends State<EnglishEntryindignantly> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "indignantly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indignantly""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/2U54vTpMMsc?t=';
    const double startSecondsend = 0000000000000000000000000001107;
    const String videoIdone = 'https://youtu.be/CZ6oNlZJXL0?t=';
    const double startSecondsone = 00000000000000000000000000095;
    const String videoIdtwo = 'https://youtu.be/-YNVeakBFqw?t=';
    const double startSecondstwo = 000000000000000000000000000805;
    const String videoIdthree = 'https://youtu.be/Pv22YmaaObo?t=';
    const double startSecondsthree = 000000000000000000000000000523;
    const String videoIdfour = 'https://youtu.be/x0f7Vb8u3FA?t=';
    const double startSecondsfour = 00000000000000000000000000033;
    const String videoIdfive = 'https://youtu.be/0SARbwvhupQ?t=';
    const double startSecondsfive = 0000000000000000000000000002327;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indignantly""",
                      // alsoEnglishWord: "also: indignantly",
                      britshText: """IpaUK: /ɪnˈdɪɡnəntli/""",
                      americanText: """IpaUS: /ɪnˈdɪɡnəntli/""",
...
کوردی: 
"""),
// With short examples define "indignantly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە تووڕەیی یان سەرسامی چونکە پێتوایە خراپ مامەڵەت لەگەڵ کراوە"""),
                    SentencesRow(
                      englishText:
                          """He indignantly denied that he ever treated the two children differently.""",
                      kurdishText:
                          """بە تووڕەییەوە نکووڵی لەوە کرد کە هەرگیز بە جیاوازییەوە مامەڵەی لەگەڵ دوو منداڵەکە کردبێت.""",
