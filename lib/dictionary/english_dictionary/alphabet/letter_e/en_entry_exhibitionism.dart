...
class EnglishEntryexhibitionism extends StatefulWidget {
  const EnglishEntryexhibitionism({super.key});

  @override
  State<EnglishEntryexhibitionism> createState() =>
      _EnglishEntryexhibitionismState();
}

class _EnglishEntryexhibitionismState extends State<EnglishEntryexhibitionism> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exhibitionism""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exhibitionism""",
                      // alsoEnglishWord: "also: exhibitionism",
                      britshText: """IpaUK: /ˌeksɪˈbɪʃənɪzəm/""",
                      americanText: """IpaUS: /ˌeksɪˈbɪʃənɪzəm/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exhibitionism";
...
کوردی: خۆپیشان‌دان، خۆشیرین‌کردن، خۆنواندن،	خۆدەرخستن
"""),
          const DefinitionKurdish(
              text: """١. (ناو) ڕەفتار کە مەبەست لێی سەرنج ڕاکێشانە"""),
          SentencesRow(
            englishText:
                """It's exhibitionism to flaunt wealth so blatantly.""",
            kurdishText:
                """ئەوە خۆ نواندنە سامان ئەوەها بە ڕوونی نمایش بکەیت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: exhibitionism (Derived forms: exhibitionisms)
1. Extravagant and conspicuous behaviour intended to attract attention to yourself
 
2. The perverse act of exposing and attracting attention to your own genitals (= immodesty, impudicity)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/FkBmAOwkVIE?t=';
const double _startSecondsend = 000000000000000000000000000000; // 524;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/udYEwqM3z_8?t=';
const double _startSecondsone = 00000000000000000000000000000; // 751;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/q2BNEZuZu1g?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 427;
const String _videoIdthree = 'VIDEOhttps://youtu.be/8byxtmcIJHk?t=';
const double _startSecondsthree = 000000000000000000000000000; // 355;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/RZvBzXgfZvs?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 588;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/ijIeC1-_I0s?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 11658;
