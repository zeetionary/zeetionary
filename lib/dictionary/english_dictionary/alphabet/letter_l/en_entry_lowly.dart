...
class EnglishEntrylowly extends StatefulWidget {
  const EnglishEntrylowly({super.key});

  @override
  State<EnglishEntrylowly> createState() => _EnglishEntrylowlyState();
}

class _EnglishEntrylowlyState extends State<EnglishEntrylowly> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylowly lowly
WORD_WEB lowly lowly lowly
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lowly";
...
کوردی: 
"""),
// With short examples define "lowly", please follow LX instructions
