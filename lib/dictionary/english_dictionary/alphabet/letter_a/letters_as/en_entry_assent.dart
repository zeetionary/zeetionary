...
class EnglishEntryassent extends StatelessWidget {
  ...
  Future<void> speakassent1012(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The director has given her assent to the proposals.");
  }
  ...
  Future<void> speakassent1015(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Nobody would assent to the terms they proposed.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "assent"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈsent/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈsent/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakassent1012("en-US"),
                          ),
...
٢. (کردار) ڕازیبوون بە داوایەک، بیرۆکەیەک، یان پێشنیارێک"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakassent1015("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'wiDCwqpupj8';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '1qbna6t1bzw';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'WRPxYGqOEL4';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'w1AZhlyoD9s';
  final double _startSeconds = 5045;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'l-y98OYaXu8';
  final double _startSeconds = 6202;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'msxQWb4eR14';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'jDsNgZy12_w';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'ZGmI8WArKdo';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'n9Y2aMT2I0E';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'KdqZonkOlDU';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'C_cb7kwRv-0';
