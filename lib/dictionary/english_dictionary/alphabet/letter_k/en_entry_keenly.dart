...
class EnglishEntrykeenly extends StatefulWidget {
  const EnglishEntrykeenly({super.key});

  @override
  State<EnglishEntrykeenly> createState() => _EnglishEntrykeenlyState();
}

class _EnglishEntrykeenlyState extends State<EnglishEntrykeenly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: keenly
1. In a keen or penetrating way (- acutely)
"he was keenly aware of his own shortcomings";
""",
  );

  final String keyword = "keenly";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We were keenly aware of the danger.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They felt the pressure keenly.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The dogs are keenly intelligent.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The championship was keenly fought this year.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They waited keenly to hear her speak.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/zFaUY3OAzow?t=471';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/vdiiIaKSSPA?t=257';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/3lr7H7wm2tU?t=48';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/YEbretrjgh4?t=171';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/-fy9U8246mk?t=306';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/oBsMQOHWiWM?t=288';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """keenly""",
                      // alsoEnglishWord: "also: keenly",
                      britshText: """IpaUK: /ˈkiːnli/""",
                      americanText: """IpaUS: /ˈkiːnli/""",
...
کوردی: 
"""),
// With short examples define "keenly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە هەستی بەهێز ئاگایی لەخۆ دەگرێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: acutely"),
                    SentencesRow(
                      englishText: """We were keenly aware of the danger.""",
                      kurdishText: """زۆر باش ئاگاداری مەترسییەکە بووین.""",
                    ...
                    SentencesRow(
                      englishText: """They felt the pressure keenly.""",
                      kurdishText: """بە باشی هەستیان بە فشارەکە کرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بە شێوەیەک کە تێگەشتنی خێرا لەخۆ دەگرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The dogs are keenly intelligent.""",
                      kurdishText: """سەگەکان هۆشمەندانە ژیرن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵکار) بە شێوەیەک کە خەڵکی زۆر بە بەهێزی بۆ شتێک ڕکابەری بکەن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The championship was keenly fought this year.""",
                      kurdishText:
                          """پاڵەوانێتییەکە ئەمساڵ بە توندی هەوڵی بۆ درا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ھاوەڵکار) بە شێوەیەک کە زۆر بەپەرۆشیت یان دەتەوێت شتێک ڕووبدات"""),
                    const AlsoEnglishckb(word: "ھەروەھا: eagerly"),
                    SentencesRow(
                      englishText: """They waited keenly to hear her speak.""",
                      kurdishText:
                          """بەپەرۆشەوە وەستابوون بۆی تاوەکو قسە بکات.""",
