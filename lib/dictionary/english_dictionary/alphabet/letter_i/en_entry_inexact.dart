...
class EnglishEntryinexact extends StatefulWidget {
  const EnglishEntryinexact({super.key});

  @override
  State<EnglishEntryinexact> createState() => _EnglishEntryinexactState();
}

class _EnglishEntryinexactState extends State<EnglishEntryinexact> {
  @override
  void initState() {
    super.initState();
...
- Adjective: inexact
1. Not exact
"Probably the most important contribution in the book is the discussion of inexact classes and indefinite individuals"
""",
  );

  final String keyword = "inexact";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inexact""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Economics is an inexact science.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Estimates of the numbers involved remain inexact.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/GVsUOuSjvcg?t=';
    const double startSecondsend = 000000000000000000000000000195;
    const String videoIdone = 'https://youtu.be/7nBo3jtiDmg?t=';
    const double startSecondsone = 000000000000000000000000000666;
    const String videoIdtwo = 'https://youtu.be/E7RT4wNhiYQ?t=';
    const double startSecondstwo = 0000000000000000000000000001790;
    const String videoIdthree = 'https://youtu.be/MQS6Jg87uk8?t=';
    const double startSecondsthree = 0000000000000000000000000001004;
    const String videoIdfour = 'https://youtu.be/TqnYf2h6A-k?t=';
    const double startSecondsfour = 00000000000000000000000000073;
    const String videoIdfive = 'https://youtu.be/mkrhwBl3jms?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inexact""",
                      // alsoEnglishWord: "also: inexact",
                      britshText: """IpaUK: /ˌɪnɪɡˈzækt/""",
                      americanText: """IpaUS: /ˌɪnɪɡˈzækt/""",
...
کوردی: نادروست، ڕاست نییە، ورد نییە، ناورد
"""),
// With short examples define "inexact", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە درووست نییە"""),
                    SentencesRow(
                      englishText: """Economics is an inexact science.""",
                      kurdishText: """زانستی ئابووری زانستێکی نادرووستە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """خەمڵاندنی ئەو ژمارانەی هەن نادرووستن.""",
