...
class EnglishEntryignorantly extends StatefulWidget {
  const EnglishEntryignorantly({super.key});

  @override
  State<EnglishEntryignorantly> createState() => _EnglishEntryignorantlyState();
}

class _EnglishEntryignorantlyState extends State<EnglishEntryignorantly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: ignorantly
1. In ignorance; in an ignorant manner (- obliviously)
"they lived ignorantly in their own small world";
""",
  );

  final String keyword = "ignorantly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ignorantly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """They ignorantly forgot about the events of recent history.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000003282;
    const String videoIdone = 'https://youtu.be/kkAkx6vDff8?t=';
    const double startSecondsone = 0000000000000000000000000001616;
    const String videoIdtwo = 'https://youtu.be/LZ3fEUrqCxQ?t=';
    const double startSecondstwo = 0000000000000000000000000002773;
    const String videoIdthree = 'https://youtu.be/sTd2Dvnck1Q?t=';
    const double startSecondsthree = 0000000000000000000000000001319;
    const String videoIdfour = 'https://youtu.be/2vw89ssewNc?t=';
    const double startSecondsfour = 000000000000000000000000000158;
    const String videoIdfive = 'https://youtu.be/V72L6RH3OD8?t=';
    const double startSecondsfive = 0000000000000000000000000003299;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ignorantly""",
                      // alsoEnglishWord: "also: ignorantly",
                      britshText: """IpaUK: /ˈɪɡnərəntli/""",
                      americanText: """IpaUS: /ˈɪɡnərəntli/""",
...
کوردی: 
"""),
// With short examples define "ignorantly", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) بەبێ ئەوەی لەسەر شتێک بزانیت"""),
                    SentencesRow(
                      englishText:
                          """They ignorantly forgot about the events of recent history.""",
                      kurdishText:
                          """نەزانانە ڕووداوەکانی مێژووی تازەیان لەبیرکرد.""",
