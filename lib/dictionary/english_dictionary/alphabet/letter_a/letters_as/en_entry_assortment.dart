...
// Define the word "assortment" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryassortment - replace speakAssortment

// replace assortment - /əˈsɔːtmənt/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryassortment extends StatelessWidget {
  // blank divider
  EnglishEntryassortment({super.key});
  // blank divider
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "assortment", // DOPSUM: CHANGE WORD ENTRY - Find /əˈsɔːtmənt/
                                style: TextStyle(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "https://youtu.be/-BeTq99LqUo?t=";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "https://youtu.be/jJx-f_VZK2c?t=";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "https://youtu.be/epYDHqAwsnY?t=";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "https://youtu.be/h31p4OLbqSc?t=";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "https://youtu.be/HYbbmatf6w4?t=";
