...
class EnglishEntryincestuous extends StatefulWidget {
  const EnglishEntryincestuous({super.key});

  @override
  State<EnglishEntryincestuous> createState() => _EnglishEntryincestuousState();
}

class _EnglishEntryincestuousState extends State<EnglishEntryincestuous> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incestuous""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1153;
    const String videoIdone = 'Ic_IapE_D-Q';
    const double startSecondsone = 1582;
    const String videoIdtwo = 'PN3Mrwk8AVQ';
    const double startSecondstwo = 503;
    const String videoIdthree = 'NLJdY1Y9k9g';
    const double startSecondsthree = 93;
    const String videoIdfour = 'v-Ymf_hTbUM';
    const double startSecondsfour = 1679;
    const String videoIdfive = 'am6c_-upsOY';
    const double startSecondsfive = 559;
