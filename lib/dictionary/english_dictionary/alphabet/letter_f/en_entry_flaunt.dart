...
class EnglishEntryflaunt extends StatefulWidget {
  const EnglishEntryflaunt({super.key});

  @override
  State<EnglishEntryflaunt> createState() => _EnglishEntryflauntState();
}

class _EnglishEntryflauntState extends State<EnglishEntryflaunt> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: flaunt (Derived forms: flaunts, flaunting, flaunted)
1. Display proudly; act ostentatiously or pretentiously (= flash [informal], show off, ostentate [archaic], swank [informal], parade, showboat [N. Amer, informal])
"he flaunted his new sports car";

- Noun: flaunt (Derived forms: flaunts)
1. The act of displaying something ostentatiously
"his behaviour was an outrageous flaunt"
""",
  );

  final String keyword = "flaunt";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He did not believe in flaunting his wealth.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She openly flaunted her affair with the senator.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flaunt""",
                      // alsoEnglishWord: "also: flaunt",
                      britshText: """IpaUK: /flɔːnt/""",
                      americanText: """IpaUS: /flɔːnt/""",
...
// With short examples define "flaunt", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """باوەڕی بە نمایشکردنی سامانەکەی نەبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە ئاشکرایی پەیوەندییە سۆزدارییەکەی لەگەڵ سیناتۆرەکە نمایش دەکرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/iS5WZoQGP4I?t=';
const double _startSecondsend = 000000000000000000000000000114;
const String _videoIdone = 'https://youtu.be/eNChF-u-BQg?t=';
const double _startSecondsone = 000000000000000000000000000120;
const String _videoIdtwo = 'https://youtu.be/ZSiKL_zDsgA?t=';
const double _startSecondstwo = 000000000000000000000000000657;
const String _videoIdthree = 'https://youtu.be/UsKtLoHRi4k?t=';
const double _startSecondsthree = 000000000000000000000000000132;
const String _videoIdfour = 'https://youtu.be/1CsN6ZYgp2Y?t=';
const double _startSecondsfour = 000000000000000000000000000228;
const String _videoIdfive = 'https://youtu.be/KQOzjSPIdqE?t=';
const double _startSecondsfive = 000000000000000000000000000505;
