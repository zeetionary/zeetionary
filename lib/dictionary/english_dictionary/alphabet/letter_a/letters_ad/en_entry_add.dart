...
// replace these: replace EnglishEntryadamsadd - replace speakAdd - replace add - /æd/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadamsadd extends StatelessWidget {
  EnglishEntryadamsadd({Key? key}) : super(key: key);
