...
class EnglishEntryknowledge extends StatefulWidget {
  const EnglishEntryknowledge({super.key});

  @override
  State<EnglishEntryknowledge> createState() => _EnglishEntryknowledgeState();
}

class _EnglishEntryknowledgeState extends State<EnglishEntryknowledge> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryknowledge knowledge
WORD_WEB knowledge knowledge knowledge
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "knowledge";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""knowledge""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """knowledge""",
                      // alsoEnglishWord: "also: knowledge",
...
کوردی: 
"""),
// With short examples define "knowledge", please follow LX instructions
