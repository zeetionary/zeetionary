...
class EnglishEntryfuse extends StatefulWidget {
  const EnglishEntryfuse({super.key});

  @override
  State<EnglishEntryfuse> createState() => _EnglishEntryfuseState();
}

class _EnglishEntryfuseState extends State<EnglishEntryfuse> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: fuse (Derived forms: fused, fuses, fusing)
1. Add together different elements (- blend, flux, mix, conflate, commingle, immix, coalesce, meld, combine, merge)
"The colours fuse well";
...
5. [Brit] Stop working because of a blown fuse

- Noun: fuse (Derived forms: fuses)
1. An electrical device that can interrupt the flow of electrical current when it is overloaded (- electrical fuse, safety fuse)
 
2. Any igniter that is used to initiate the burning of a propellant (- fuze [N. Amer], fusee, fuzee [N. Amer], primer, priming)
""",
  );

  final String keyword = "fuse";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Check whether a fuse has blown.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""When the machine was switched on it blew a fuse.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He set the fuse to three minutes.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""As they heal, the bones will fuse together.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Their lips fused in a passionate kiss.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The lights have fused.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Is this plug fused?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fuse""",
                      // alsoEnglishWord: "also: fuse",
                      britshText: """IpaUK: /fjuːz/""",
                      americanText: """IpaUS: /fjuːz/""",
...
// With short examples define "fuse", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) وایەرێک یان ئامرازێکی بچووک کە لەناو ئامێرێکی کارەباییە و دەشکێت و جووڵەی کارەبا دەوەستێنێت کە جووڵەی کارەباکە زۆر بەهێزە"""),
                    SentencesRow(
                      englishText: """Check whether a fuse has blown.""",
                      kurdishText: """سەیر بکە بزانە هیچ فیوزێک تەقیوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کە ئامێرەکە کرایەوە فیوزێکی تەقاند.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) کە دوو شت پێکەوە دەلکێندرێن بۆ پێکهێنانی یەک شت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """As they heal, the bones will fuse together.""",
                      kurdishText:
                          """کە باش دەبنەوە، ئێسکەکان دەلکێن بە یەکەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Their lips fused in a passionate kiss.""",
                      kurdishText: """لێویان چوو بە یەکدا بە ماچێکی بەتین.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The sperm fuses with the egg to begin the process of fertilization.""",
                      kurdishText:
                          """سپێرم لەگەڵ هێلکە یەک دەگرێت بۆ دەستپێکردنی پیتاندن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The two companies have been fused into a single organization.""",
                      kurdishText: """دوو کۆمپانیاکە کراون بە یەک.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (کردار) وەستان لە کارکردن یان ئەوەی شتێک بوەستێنیت لە کارکردن بەهۆی ئەوەی فیوزێک تەقیوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The lights have fused.""",
                      kurdishText: """لایتەکە لایتەکان سووتاون.""",
                      englishNote:
                          """This means the lights have stopped working because their electrical components have blown out or burned.""",
...
const String _videoIdtwo = 'https://youtu.be/FaCeZsOOKEY?t=';
const double _startSecondstwo = 000000000000000000000000000204;
const String _videoIdthree = 'https://youtu.be/m3MgAOe2zSs?t=';
const double _startSecondsthree = 00000000000000000000000000087;
const String _videoIdfour = 'https://youtu.be/6MoBvV12C58?t=';
const double _startSecondsfour = 000000000000000000000000000488;
const String _videoIdfive = 'https://youtu.be/PHLY4a5fTjU?t=';
