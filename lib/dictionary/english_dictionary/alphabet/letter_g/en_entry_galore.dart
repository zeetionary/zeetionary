...
class EnglishEntrygalore extends StatefulWidget {
  const EnglishEntrygalore({super.key});

  @override
  State<EnglishEntrygalore> createState() => _EnglishEntrygaloreState();
}

class _EnglishEntrygaloreState extends State<EnglishEntrygalore> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There will be games and prizes galore.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """galore""",
                      // alsoEnglishWord: "also: galore",
                      britshText: """IpaUK: /ɡəˈlɔː(r)/""",
                      americanText: """IpaUS: /ɡəˈlɔːr/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText: """There will be games and prizes galore.""",
                      kurdishText: """ڕێژەیەکی زۆر یاری و خەڵات دەبێت.""",
...
const String _videoIdtwo = 'https://youtu.be/vx09_4cEzlM?t=';
const double _startSecondstwo = 000000000000000000000000000307;
const String _videoIdthree = 'https://youtu.be/h5rliCqB-4Y?t=';
const double _startSecondsthree = 000000000000000000000000000551;
const String _videoIdfour = 'https://youtu.be/dcWxethwL1Y?t=';
const double _startSecondsfour = 00000000000000000000000000078;
const String _videoIdfive = 'https://youtu.be/Zj35vRgeXLs?t=';
const double _startSecondsfive = 000000000000000000000000000207;
