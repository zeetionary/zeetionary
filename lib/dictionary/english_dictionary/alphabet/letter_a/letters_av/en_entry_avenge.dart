...
// Define the word "avenge" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace avenge - replace EnglishEntryavenge

// replace speakAvenge - /əˈvendʒ/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryavenge extends StatelessWidget {
  // blank divider
  EnglishEntryavenge({super.key});
  // blank divider
  ...
  Future<void> speakavenges1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He promised to avenge his father's murder.");
  }
  ...
  Future<void> speakavenges2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvenges2c");
  }
  ...
  Future<void> speakavenges3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvenges3c");
  }
  ...
  Future<void> speakavenges4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvenges4c");
  }
  ...
  Future<void> speakavenges5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvenges5c");
  }
  ...
  Future<void> speakavenges6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvenges6c");
  }
  ...
  Future<void> speakavenges7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvenges7c");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "avenge"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈvendʒ/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈvendʒ/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakavenges1("en-US"),
                          ),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'oMSdFM12hOw';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'mOJkVcXgxpI';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '9TimmdqACAs';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '0hdnQ8EXdEs';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'SqH0nJngy-c';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'epi2pDmqygc';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'L1A9A_shNV0';
  final double _startSeconds = 1177;
...
// end avenge // TODO Implement this library.
