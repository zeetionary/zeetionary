...
// Define the word "atrocity" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryatrocity - replace speakAtrocity

// replace atrocity - /əˈtrɒsəti/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryatrocity extends StatelessWidget {
  // blank divider
  EnglishEntryatrocity({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakatrocity(String languageCode) async {
    // DOPSUM: CHANGE speakAtrocity
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("atrocity"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakatrocity310(String languageCode) async {
    // DOPSUM: CHANGE speakAtrocity
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "In the war, both sides committed atrocities."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "atrocity"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /əˈtrɒsəti/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                            CustomIconButtonBritish(
                              onPressed: () => speakatrocity("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /əˈtrɑːsəti/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find WORD_WEB
                            CustomIconButtonAmerican(
                              onPressed: () => speakatrocity("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class _YoutubeEmbeddedfiveState extends State<YoutubeEmbeddedfive> {
  ...
  final double _startSeconds = 3746;
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  ...
  final double _startSeconds = 12889;
...
class _YoutubeEmbeddedeightState extends State<YoutubeEmbeddedeight> {
  late YoutubePlayerController _controller;
  final String _videoId = 'VKuurDOxvVA';
...
class _YoutubeEmbeddednineState extends State<YoutubeEmbeddednine> {
  late YoutubePlayerController _controller;
  final String _videoId = 'IP-CH34tKgY';
...
class _YoutubeEmbeddedtenState extends State<YoutubeEmbeddedten> {
  late YoutubePlayerController _controller;
  final String _videoId = 'lfeYMl9ycFo';
