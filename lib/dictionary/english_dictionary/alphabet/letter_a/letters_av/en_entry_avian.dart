...
// Define the word "avian" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace avian - replace EnglishEntryavian

// replace speakAvian - /ˈeɪviən/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryavian extends StatelessWidget {
  // blank divider
  EnglishEntryavian({super.key});
  // blank divider
  ...
  Future<void> speakavians2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvians22");
  }
  ...
  Future<void> speakavians3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvians33");
  }
  ...
  Future<void> speakavians4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvians44");
  }
  ...
  Future<void> speakavians5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvians55");
  }
  ...
  Future<void> speakavians6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvians66");
  }
  ...
  Future<void> speakavians7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvians77");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "avian"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈeɪviən/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈeɪviən/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakavians1("en-US"),
                          ),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'Vk5bxHetL4s';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'fcL47Kiyuj0';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'dDZJXiHmeZg';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'fFhyQ9dzv_o';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'STJoT_UjkPI';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'e_TjrqWTV5s';
...
// end avian // TODO Implement this library.
