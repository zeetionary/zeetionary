...
class EnglishEntryimpair extends StatefulWidget {
  const EnglishEntryimpair({super.key});

  @override
  State<EnglishEntryimpair> createState() => _EnglishEntryimpairState();
}

class _EnglishEntryimpairState extends State<EnglishEntryimpair> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: impair (Derived forms: impairs, impairing, impaired)
1. Make worse or less effective
"His vision was impaired"
 
2. Make imperfect (- mar, spoil, deflower, vitiate, pollute)
"nothing impaired her beauty";
""",
  );

  final String keyword = "impair";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""His age impaired his chances of finding a new job.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/cciw0MyXMyI?t=';
    const double startSecondsend = 000000000000000000000000000205;
    const String videoIdone = 'https://youtu.be/05gCLHlpzTU?t=';
    const double startSecondsone = 000000000000000000000000000634;
    const String videoIdtwo = 'https://youtu.be/Sbp_EeBk-As?t=';
    const double startSecondstwo = 00000000000000000000000000082;
    const String videoIdthree = 'https://youtu.be/62EGPCEmeh4?t=';
    const double startSecondsthree = 000000000000000000000000000129;
    const String videoIdfour = 'https://youtu.be/Z0IADN0jOw8';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/UdgRUCVUts0?t=';
    const double startSecondsfive = 000000000000000000000000000437;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """impair""",
                      // alsoEnglishWord: "also: impair",
                      britshText: """IpaUK: /ɪmˈpeə(r)/""",
                      americanText: """IpaUS: /ɪmˈper/""",
...
کوردی: خراپ کردن، زیان پێگەیاندن
"""),
// With short examples define "impair", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) شکاندن یان خراپکردنی شتێک"""),
                    SentencesRow(
                      englishText:
                          """His age impaired his chances of finding a new job.""",
                      kurdishText:
                          """تەمەنی شانسیی بۆ دۆزینەوەی کارێک لاواز کرد.""",
                    ...
                    SentencesRow(
                      englishText:
                          """There are a number of factors which can directly impair memory.""",
                      kurdishText:
                          """ژمارەیەک فاکتەر هەن کە دەکرێن ڕاستەوخۆ یادەوەری خراپ بکەن.""",
