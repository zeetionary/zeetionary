...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'G2wPCbazMjQ';
    ...
    const String videoIdthree = '-aSdFrPnlRg';
    const double startSecondsthree = 1113;
    const String videoIdfour = 'iZd1aQ7TY9c';
    const double startSecondsfour = 515;
    const String videoIdfive = 'H5yvhP-9mik';
    const double startSecondsfive = 272;
