...
class EnglishEntryinfidelity extends StatefulWidget {
  const EnglishEntryinfidelity({super.key});

  @override
  State<EnglishEntryinfidelity> createState() => _EnglishEntryinfidelityState();
}

class _EnglishEntryinfidelityState extends State<EnglishEntryinfidelity> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infidelity""");
  }
