...
class EnglishEntryaccrue extends StatefulWidget {
  const EnglishEntryaccrue({super.key});

  @override
  State<EnglishEntryaccrue> createState() => _EnglishEntryaccrueState();
}

class _EnglishEntryaccrueState extends State<EnglishEntryaccrue> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accrue""",
                      // alsoEnglishWord: "also: accrue",
                      britshText: """IpaUK: /əˈkruː/""",
                      americanText: """IpaUS: /əˈkruː/""",
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '-T64FLsJnAU';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '15RhQpLA6HU';
