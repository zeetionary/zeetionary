...
class EnglishEntrygoddess extends StatefulWidget {
  const EnglishEntrygoddess({super.key});

  @override
  State<EnglishEntrygoddess> createState() => _EnglishEntrygoddessState();
}

class _EnglishEntrygoddessState extends State<EnglishEntrygoddess> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""goddess""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Aphrodite, the goddess of love, was often depicted with roses.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She dreamed of becoming a Hollywood screen goddess.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """goddess""",
                      // alsoEnglishWord: "also: goddess",
                      britshText: """IpaUK: /ˈɡɒdes/,  /ˈɡɒdəs/""",
                      americanText: """IpaUS: /ˈɡɑːdəs/""",
...
// With short examples define "goddess", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Aphrodite, the goddess of love, was often depicted with roses.""",
                      kurdishText: """ئافرۆدایتت خودای خۆشەویستی ززۆرجار بە گوڵەوە پیشان دەدرا.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ژنێک کە کەسانی دیکە زۆریان خۆشدەوێت و ڕێزی دەگرن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She dreamed of becoming a Hollywood screen goddess.""",
                      kurdishText: """خەونی ئەوەی هەبوو ببێت بە خوداوەندی سەر شاشەی هۆڵیوود.""",
...
const double _startSecondsone = 0000000000000000000000000001042;
const String _videoIdtwo = 'https://youtu.be/lGSOWwUvJiU?t=';
const double _startSecondstwo = 000000000000000000000000000744;
const String _videoIdthree = 'https://youtu.be/NbIJtUg27fY?t=';
const double _startSecondsthree = 000000000000000000000000000191;
const String _videoIdfour = 'https://youtu.be/X7eJqVDdFlo?t=';
const double _startSecondsfour = 00000000000000000000000000049;
const String _videoIdfive = 'https://youtu.be/hsoYHzRwcno?t=';
