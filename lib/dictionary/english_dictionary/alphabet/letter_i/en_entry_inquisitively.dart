...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'OFkeKKszXTw';
    const double startSecondsend = 21;
    const String videoIdone = 'gqDkQ8XmP8Q';
    const double startSecondsone = 438;
    const String videoIdtwo = 'fWUAGfduUlg';
    const double startSecondstwo = 2739;
    const String videoIdthree = 'bu9YoasvU7w';
    const double startSecondsthree = 254;
    const String videoIdfour = 'xIrbmivRg7k';
    const double startSecondsfour = 2091;
    const String videoIdfive = 'i0ytVNxJM8E';
    const double startSecondsfive = 3408;
