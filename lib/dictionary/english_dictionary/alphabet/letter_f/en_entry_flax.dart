...
class EnglishEntryflax extends StatefulWidget {
  const EnglishEntryflax({super.key});

  @override
  State<EnglishEntryflax> createState() => _EnglishEntryflaxState();
}

class _EnglishEntryflaxState extends State<EnglishEntryflax> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flax (Derived forms: flaxes)
1. Plant of the genus Linum that is cultivated for its seeds and for the fibers of its stem
 
2. Fibre of the flax plant that is made into thread and woven into linen fabric
""",
  );

  final String keyword = "flax";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flax""",
                      // alsoEnglishWord: "also: flax",
                      britshText: """IpaUK: /flæks/""",
                      americanText: """IpaUS: /flæks/""",
...
کوردی: (ڕووەک‌ناسی) گوش، گیاکەتان، کەتان، بەزەرەک، لۆکەکێوی، گیاهەڵاوە
"""),
...
const String _videoIdone = 'https://youtu.be/cCP9vjp4kSg?t=';
...
const String _videoIdthree = 'https://youtu.be/KLGSLCaksdY?t=';
const double _startSecondsthree = 00000000000000000000000000095;
const String _videoIdfour = 'https://youtu.be/66VdylXI0nQ?t=';
const double _startSecondsfour = 000000000000000000000000000511;
const String _videoIdfive = 'https://youtu.be/7z8AxykKIfA?t=';
