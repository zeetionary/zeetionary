...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000754;
    const String videoIdone = 'https://youtu.be/alGeuUZPJgA?t=';
    const double startSecondsone = 000000000000000000000000000266;
    const String videoIdtwo = 'https://youtu.be/q6KYgr_KJDY?t=';
    const double startSecondstwo = 00000000000000000000000000089;
    const String videoIdthree = 'https://youtu.be/UJtVhPkIE28';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/HfV_GyC3oM4?t=';
    const double startSecondsfour = 000000000000000000000000000233;
    const String videoIdfive = 'https://youtu.be/YAKcbvioxFk?t=';
    const double startSecondsfive = 0000000000000000000000000001320;
