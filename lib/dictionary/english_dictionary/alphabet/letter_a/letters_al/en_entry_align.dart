...
// replace these: replace EnglishEntryalign - replace speakAlign - replace align - /əˈlaɪn/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryalign extends StatelessWidget {
  EnglishEntryalign({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAlign(String languageCode) async {
    // DOPSUM: CHANGE speakAlign
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("align"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAlign43659(String languageCode) async {
    ...
    await flutterTts.speak(
        "The top and bottom line of each column on the page should align."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAlign35255(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "This pillar is roughly aligned with the others."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "align"), // DOPSUM: CHANGE WORD ENTRY - Find /əˈlaɪn/
                            // nothing heereee
                        ...
                        Row(
                          children: [
                            const Text(
                              "IpaUK: /əˈlaɪn/", // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            CustomIconButtonBritish(
                              onPressed: () =>
                                  speakAlign(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              "IpaUS: /əˈlaɪn/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            CustomIconButtonAmerican(
                              onPressed: () => speakAlign(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'Q1oJy3pWTyA';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'z822U6adC2I';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'ecypANL48j0';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '4EawDIAZTEk';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'zKvyZ7MCks8';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'iJueYgDbeyQ';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'eZQyzJ4dITk';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = 'oLYbcsTa73I';
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = '2n9IySf2wr0';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  static String myVideoId = '6yWs9XshwOE';
