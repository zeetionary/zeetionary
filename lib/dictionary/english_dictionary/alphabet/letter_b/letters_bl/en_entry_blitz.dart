...
// blank divider
  ...
  Future<void> speakblitzs1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Five shops were damaged in a firebomb blitz.");
  }
  ...
  Future<void> speakblitzs2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Many people died in the London Blitz.");
  }
  ...
  Future<void> speakblitzs3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I've had a blitz on the house.");
  }
  ...
  Future<void> speakblitzs4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("London was heavily blitzed in the war.");
  }
  ...
  Future<void> speakblitzs5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Blitz until smooth and creamy.");
  }
  ...
  Future<void> speakblitzs6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakblitzs66");
  }
  ...
  Future<void> speakblitzs7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakblitzs77");
  }
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakblitzs1("en-GB"),
                            onPressedAmerican: () => speakblitzs1("en-US"),
                          ),
                          const DividerDefinition(),
                          const DefinitionKurdish(
                              text:
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakblitzs2("en-GB"),
                            onPressedAmerican: () => speakblitzs2("en-US"),
                          ),
                          const DividerDefinition(),
                          const DefinitionKurdish(
                              text:
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakblitzs3("en-GB"),
                            onPressedAmerican: () => speakblitzs3("en-US"),
                          ),
                          const DividerDefinition(),
                          const DefinitionKurdish(
                              text:
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakblitzs4("en-GB"),
                            onPressedAmerican: () => speakblitzs4("en-US"),
                          ),
                          const DividerDefinition(),
                          const DefinitionKurdish(
                              text:
                          ...
                          SentencesRow(
                            englishText: "Blitz until smooth and creamy.",
                            kurdishText: "تێکی بدە تا لووس و کرێمدار دەبێت.",
                            onPressedBritish: () => speakblitzs5("en-GB"),
                            onPressedAmerican: () => speakblitzs5("en-US"),
                          ),
                        ],
                      ),
                    ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'bIDKhZ_4jLQ';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'OPVZcsdy9RY';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'BriBDiBxaMY';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'akA_Z9Xmnvc';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'wEIWMfij7_U';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'uWSOJMcvDec';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'ZijqVV1NqYQ';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = '2_5jjUmlh6I';
