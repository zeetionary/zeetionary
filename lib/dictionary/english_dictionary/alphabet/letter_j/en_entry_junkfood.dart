...
// With short examples define "junk food", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەو خواردنانەی کە هەرزان و خێران بۆ ئامادەکردن بەڵام وەها دادەنرێن خراپ بن بۆ تەندرووستی"""),
                    SentencesRow(
                      englishText:
                          """On a daily basis, the average child in America is exposed to dozens of television advertisements for junk food.""",
                      kurdishText:
                          """بە شێوەیەکی ڕۆژانە منداڵێکی ئاسایی لە ئەمریکا چەندان ڕیکلامی تەلەفیزیۆن بۆ خواردنی خێرا دەبینێت.""",
