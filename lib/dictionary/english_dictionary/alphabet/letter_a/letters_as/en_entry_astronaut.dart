...
// Define the word "astronaut" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryastronaut - replace speakAstronaut

// replace astronaut - /ˈæstrənɔːt/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryastronaut extends StatelessWidget {
  // blank divider
  EnglishEntryastronaut({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAstronaut(String languageCode) async {
    // DOPSUM: CHANGE speakAstronaut
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("astronaut"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAstronaut442(String languageCode) async {
    // DOPSUM: CHANGE speakAstronaut
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "The astronauts trained for years for their mission to the moon."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "astronaut", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "f8-UKqGZ_hs";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "TZkuQUCUYgM";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "lyhTkX3e-U0";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "YtIw3wqHeNY";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "fTvZfbYj7MQ";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "xW_847wnZVA";
