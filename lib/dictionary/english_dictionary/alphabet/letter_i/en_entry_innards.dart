...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'vAInhpCWDUc';
    const double startSecondsend = 494;
    const String videoIdone = '4zDZV-jGJ6w';
    const double startSecondsone = 655;
    const String videoIdtwo = 'Z0SzIkheaFg';
    const double startSecondstwo = 86;
    const String videoIdthree = 'Upqp21Dm5vg';
    const double startSecondsthree = 217;
    const String videoIdfour = 'bA6-VEVAzCE';
    const double startSecondsfour = 1486;
    const String videoIdfive = 'M9U692gPH44';
