...
class EnglishEntryincarcerate extends StatefulWidget {
  const EnglishEntryincarcerate({super.key});

  @override
  State<EnglishEntryincarcerate> createState() =>
      _EnglishEntryincarcerateState();
}

class _EnglishEntryincarcerateState extends State<EnglishEntryincarcerate> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incarcerate""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 3059;
    const String videoIdtwo = 'SG1vNoErfQw';
    const double startSecondstwo = 98;
    const String videoIdthree = 'YEhUUQQekkQ';
    const double startSecondsthree = 174;
    const String videoIdfour = 'tkxR1TcG4n4';
    const double startSecondsfour = 365;
    const String videoIdfive = 'g0MkYazCxyA';
