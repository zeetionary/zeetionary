...
class EnglishEntrygrowth extends StatefulWidget {
  const EnglishEntrygrowth({super.key});

  @override
  State<EnglishEntrygrowth> createState() => _EnglishEntrygrowthState();
}

class _EnglishEntrygrowthState extends State<EnglishEntrygrowth> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: growth (Derived forms: growths)
1. A process of becoming larger or longer or more numerous or more important (- increase, increment)
"the growth of population";
 
2. (biology) the process of an individual organism growing organically; a purely biological unfolding of events involved in an organism changing gradually from a simple to a more complex level (- growing, maturation, development, ontogeny, ontogenesis)
"he proposed an indicator of osseous growth in children";
...
5. The gradual beginning or coming forth (- emergence, outgrowth)
"figurines presage the growth of sculpture in Greece";
 
6. (pathology) an abnormal proliferation of tissue (as in a tumour)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Lack of water will stunt the plant's growth.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Remove dead leaves to encourage new growth.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Lack of food had stunted his growth.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The report links population growth with rural poverty.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""There was a rapid growth in the numbers of private cars.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The country is experiencing a period of high growth.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The economy enjoyed the highest growth rate in Asia.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He had a cancerous growth on his lung.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """growth""",
                      // alsoEnglishWord: "also: growth",
                      britshText: """IpaUK: /ɡrəʊθ/""",
                      americanText: """IpaUS: /ɡrəʊθ/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کەمئاوی ڕێگا لە گەشەی ڕووەکەکە دەگرێت.""",
                      englishNote:
                          """This means that without enough water, the plant will not develop properly or reach its full size. The plant's development will be hindered or slowed down.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It may be the most effective way to inhibit the growth of cancer cells""",
                      kurdishText:
                          """ڕەنگە کاریگەرترین ڕێگا بێت بۆ ڕێگری لە گەشەی خانە شێرپەنجەییەکان.""",
                    ...
                    const DefinitionKurdish(
                        text: """٢. (ناو) زیادبوون لە قەبارە یان ڕێژەی شتێک"""),
                    SentencesRow(
                      englishText:
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ناو) گەشەی چالاکیی ئابووری"""),
                    SentencesRow(
                      englishText:
                          """The country is experiencing a period of high growth.""",
                      kurdishText:
                          """وڵاتەکە بە ماوەیەک لە گەشەی خێرا تێدەپەڕێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئابووری ئابووری بە خێراترین بووژانەوە لە ئاسیادا تێپەڕی.""",
