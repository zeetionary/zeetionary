...
class EnglishEntryhenchman extends StatefulWidget {
  const EnglishEntryhenchman({super.key});

  @override
  State<EnglishEntryhenchman> createState() => _EnglishEntryhenchmanState();
}

class _EnglishEntryhenchmanState extends State<EnglishEntryhenchman> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: henchman (Derived forms: henchmen)
1. Someone who assists in a plot (- confederate, collaborator, partner in crime)
""",
  );

  final String keyword = "henchman";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""henchman""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """henchman""",
                      // alsoEnglishWord: "also: henchman",
                      britshText: """IpaUK: /ˈhentʃmən/""",
                      americanText: """IpaUS: /ˈhentʃmən/""",
...
کوردی: پشتیوان، پشتگیر، لایەنگر، نۆکەر، ئالیگر، دواکەوتە، دواڕەو، شوێن‌کەوتوو
"""),
// With short examples define "henchman", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە یارمەتیی کەسێکی دیکە، بۆ نموونە سیاسییەک یان تاوانکارێک، دەدات و ئامادەیە تێوەبگلێت لە کاری تاوانکاری بۆ یارمەتیدانی ئەو کەسە"""),
                    SentencesRow(
                      englishText:
                          """He sent one of his henchmen with orders to seize the pictures.""",
                      kurdishText:
                          """یەکێک لە نۆکەرەکانیی نارد بە فەرمانی ئەوەوە کە وێنەکان بهێنێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/05gCLHlpzTU?t=';
const double _startSecondsend = 000000000000000000000000000660;
const String _videoIdone = 'https://youtu.be/hWp61OEy4R4?t=';
const double _startSecondsone = 000000000000000000000000000173;
const String _videoIdtwo = 'https://youtu.be/ill2cgCyTUc?t=';
const double _startSecondstwo = 0000000000000000000000000001034;
const String _videoIdthree = 'https://youtu.be/NOXSz3nJgTs?t=';
const double _startSecondsthree = 000000000000000000000000000788;
const String _videoIdfour = 'https://youtu.be/QpyHrQYeoIE?t=';
const double _startSecondsfour = 000000000000000000000000000729;
const String _videoIdfive = 'https://youtu.be/PW2duKZChA8?t=';
const double _startSecondsfive = 0000000000000000000000000002;
