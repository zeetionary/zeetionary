...
class EnglishEntryencouragement extends StatefulWidget {
  const EnglishEntryencouragement({super.key});

  @override
  State<EnglishEntryencouragement> createState() =>
      _EnglishEntryencouragementState();
}

class _EnglishEntryencouragementState extends State<EnglishEntryencouragement> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "encouragement",
                      // alsoEnglishWord: "also: encouragement",
                      britshText: "IpaUK: /ɪnˈkʌrɪdʒmənt/",
                      americanText: "IpaUS: /ɪnˈkɜːrɪdʒmənt/",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "encouragement";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He needs all the support and encouragement he can get.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Her words were a great encouragement to them.");
  }
...
کوردی: هان(دان)، تاودان، تین‌دان، دڵ‌خۆش‌کردن، هیواپێدان، ورە، دڵ‌گەرمی، پشت‌گەرمی، پشت‌ئەستووری
"""),
          const DefinitionKurdish(
              text: """١. (ناو) هاندانی کەسێک بۆ کردنی شتێک"""),
          SentencesRow(
            englishText:
                """He needs all the support and encouragement he can get.""",
            kurdishText:
                """پێویستیی بە هەموو پشتیوانی و هاندانێکە کە بەدەستی بهێنێت.""",
          ...
          SentencesRow(
            englishText:
                """With a little encouragement from his parents he should do well.""",
            kurdishText: """بە کەمێک هاندانی دایبابی دەبێت باش بێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Her words were a great encouragement to them.""",
            kurdishText: """قسەکانی هاندانی باش بوون بۆیان.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: encouragement (Derived forms: encouragements)
1. The expression of approval and support
 
2. The act of giving hope or support to someone (= boost, fillip)
...
const String _videoIdend = 'https://youtu.be/SsqasJoanUQ?t=';
const double _startSecondsend = 274;
const String _videoIdone = 'https://youtu.be/WV0OBRJKeYA?t=';
const double _startSecondsone = 782;
const String _videoIdtwo = 'https://youtu.be/VG7arSAYvQI?t=';
const double _startSecondstwo = 830;
const String _videoIdthree = 'https://youtu.be/YpkP6BZIFDE?t=';
const double _startSecondsthree = 209;
const String _videoIdfour = 'https://youtu.be/pLwHTqU2r_Y?t=';
const double _startSecondsfour = 1222;
const String _videoIdfive = 'https://youtu.be/eVSsHWl_Qec?t=';
const double _startSecondsfive = 150;
const String _videoIdsix = 'https://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondssix = 6168;
