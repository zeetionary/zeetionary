...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '8A3jiM2FNR8';
    const double startSecondsend = 296;
    const String videoIdone = 'pLwHTqU2r_Y';
    const double startSecondsone = 1543;
    const String videoIdtwo = 'lBYxXSUDV8o';
    const double startSecondstwo = 669;
    const String videoIdthree = '4mjvZrLnlCg';
    const double startSecondsthree = 259;
    const String videoIdfour = '63yNAJSeVEE';
    const double startSecondsfour = 209;
    const String videoIdfive = 'cfDDFbX46i8';
