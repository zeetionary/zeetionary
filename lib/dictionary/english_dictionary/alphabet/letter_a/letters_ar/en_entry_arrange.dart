                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "arrange", // DOPSUM: CHANGE WORD ENTRY - Find /əˈreɪndʒ/
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakArrange(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "__qtH1ly2Sg";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "Lk9ZihSgjdo";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "J2eU4Ol3IDU";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "8bQf9URnIAY";
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 16054, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
      autoPlay: true,
      enableCaption: true,
      loop: true,
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  static String myVideoId = "HzUIUTatyZI";

  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 2232, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
      autoPlay: true,
      enableCaption: true,
      loop: true,
