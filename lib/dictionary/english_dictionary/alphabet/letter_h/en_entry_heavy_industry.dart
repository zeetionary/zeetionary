...
class EnglishEntryheavyindustry extends StatefulWidget {
  const EnglishEntryheavyindustry({super.key});

  @override
  State<EnglishEntryheavyindustry> createState() =>
      _EnglishEntryheavyindustryState();
}

class _EnglishEntryheavyindustryState extends State<EnglishEntryheavyindustry> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heavy industry (derived forms: heavy industries)
1. industry that uses large machines to produce either materials, such as steel, or large goods, such as ships or trains
""",
  );

  final String keyword = "heavy industry";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heavy industry""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heavy industry""",
                      // alsoEnglishWord: "also: heavy industry",
                      britshText: """IpaUK: /ˌhevi ˈɪndəstri/""",
                      americanText: """IpaUS: /ˌhevi ˈɪndəstri/""",
...
// With short examples define "heavy industry", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پیشەسازی درووستکردنی ئۆتۆمبێل، کانزا، کەلووپەلی قورس، هتد بە ئامێری گەورە"""),
                    SentencesRow(
                      englishText:
                          """Pollution from the country's heavy industry is probably the worst in Europe.""",
                      kurdishText:
                          """پیسبوون لە پیشەسازی قورسی وڵاتەکەوە ئەگەری هەیە خراپترین بێت لە ئەورووپادا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/hkO8qXCFYWA?t=';
const double _startSecondsend = 0000000000000000000000000001254;
const String _videoIdone = 'https://youtu.be/uK3OBAxCi6k?t=';
const double _startSecondsone = 000000000000000000000000000478;
const String _videoIdtwo = 'https://youtu.be/ITvXlax4ZXk?t=';
const double _startSecondstwo = 000000000000000000000000000601;
const String _videoIdthree = 'https://youtu.be/GBp_NgrrtPM?t=';
const double _startSecondsthree = 000000000000000000000000000660;
const String _videoIdfour = 'https://youtu.be/YZAibo7eiik?t=';
const double _startSecondsfour = 00000000000000000000000000097;
const String _videoIdfive = 'https://youtu.be/4wvAwVwc6sY?t=';
const double _startSecondsfive = 000000000000000000000000000218;
