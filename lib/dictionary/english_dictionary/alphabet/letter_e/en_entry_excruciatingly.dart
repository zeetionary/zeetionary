...
class EnglishEntryexcruciatingly extends StatefulWidget {
  const EnglishEntryexcruciatingly({super.key});

  @override
  State<EnglishEntryexcruciatingly> createState() =>
      _EnglishEntryexcruciatinglyState();
}

class _EnglishEntryexcruciatinglyState
    extends State<EnglishEntryexcruciatingly> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""excruciatingly""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """excruciatingly""",
                      // alsoEnglishWord: "also: excruciatingly",
                      britshText: """IpaUK: /ɪkˈskruːʃieɪtɪŋli/""",
                      americanText: """IpaUS: /ɪkˈskruːʃieɪtɪŋli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "excruciatingly";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Progress has been excruciatingly slow.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She finds being a mother excruciatingly difficult.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His spine still hurts excruciatingly.""");
  }
...
// With short examples define "excruciatingly", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: بە توندی، بە سەختی، یەکجار
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵکار) بەشێوەیەکی زۆر بەئازار یان خراپ"""),
          SentencesRow(
            englishText: """Progress has been excruciatingly slow.""",
            kurdishText: """بەرەوپێشچوون تەواو هێواش بووە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """دایکایەتی بە ئێجگار سەخت دەبینێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """His spine still hurts excruciatingly.""",
            kurdishText: """بڕبڕەی پشتی هێشتا یەکجار ئازاری هەیە.""",
...
1. In a very painful manner (= agonizingly, torturously, agonisingly [Brit])
"the progress was excruciatingly slow";
""",
  );
...
const double _startSecondsend = 000000000000000000000000000000; // 31;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondsone = 00000000000000000000000000000; // 78;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/mjCAyo2Litw?t=';
...
const double _startSecondsthree = 000000000000000000000000000; // 1050;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/VQLi2GYVULc?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 555;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/-gNqECgR-Vk?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 511;
