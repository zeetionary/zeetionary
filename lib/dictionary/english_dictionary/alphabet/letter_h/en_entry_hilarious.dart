...
class EnglishEntryhilarious extends StatefulWidget {
  const EnglishEntryhilarious({super.key});

  @override
  State<EnglishEntryhilarious> createState() => _EnglishEntryhilariousState();
}

class _EnglishEntryhilariousState extends State<EnglishEntryhilarious> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hilarious
1. Marked by or causing boisterous merriment or convulsive laughter (- screaming, uproarious)
"hilarious broad comedy";
""",
  );

  final String keyword = "hilarious";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hilarious""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Lynn found the whole situation hilarious.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Do you know Pete? He's hilarious.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/rsaLUIeurZ8?t=';
    const double startSecondsend = 000000000000000000000000000187;
    const String videoIdone = 'https://youtu.be/rPe4yziWiOg?t=';
    const double startSecondsone = 000000000000000000000000000553;
    const String videoIdtwo = 'https://youtu.be/dqcSk-EDrRo?t=';
    const double startSecondstwo = 0000000000000000000000000001512;
    const String videoIdthree = 'https://youtu.be/QyL9P1ccy-w?t=';
    const double startSecondsthree = 000000000000000000000000000614;
    const String videoIdfour = 'https://youtu.be/mcZdTvOqmvI?t=';
    const double startSecondsfour = 000000000000000000000000000177;
    const String videoIdfive = 'https://youtu.be/Mmdc9RIhmOI?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hilarious""",
                      // alsoEnglishWord: "also: hilarious",
                      britshText: """IpaUK: /hɪˈleəriəs/""",
                      americanText: """IpaUS: /hɪˈleriəs/""",
...
کوردی: پێکەنینی، قۆشمە، گاڵتەجاڕ
"""),
// With short examples define "hilarious", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) پننسە"""),
                    SentencesRow(
                      englishText:
                          """Lynn found the whole situation hilarious.""",
                      kurdishText: """لین تەواوی دۆخەکەی بە گاڵتەجاڕی بینی.""",
                    ...
                    SentencesRow(
                      englishText: """Do you know Pete? He's hilarious.""",
                      kurdishText: """پیت دەناسیت؟ زۆر گەڵتەجاڕە.""",
