...
class EnglishEntryfuelinjection extends StatefulWidget {
  const EnglishEntryfuelinjection({super.key});

  @override
  State<EnglishEntryfuelinjection> createState() =>
      _EnglishEntryfuelinjectionState();
}

class _EnglishEntryfuelinjectionState extends State<EnglishEntryfuelinjection> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fuel injection (Derived forms: fuel injections)
1. Mechanical system to inject atomized fuel directly into the cylinders of an internal-combustion engine; avoids the need for a carburettor (- fuel injection system)
""",
  );

  final String keyword = "fuel injection";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fuel injection""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Fuel injection helps the engine run more cleanly.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fuel injection""",
                      // alsoEnglishWord: "also: fuel injection",
                      britshText: """IpaUK: /ˈfjuːəl ɪndʒekʃn/""",
                      americanText: """IpaUS: /ˈfjuːəl ɪndʒekʃn/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) سیستەمی ناردنی سووتەمەنی بۆ بزوێنەری ئۆتۆمبێل لەژێر فشاردا بۆ ئەوەی ئاستێکی باشی هەبێت"""),
                    SentencesRow(
                      englishText:
                          """Fuel injection helps the engine run more cleanly.""",
                      kurdishText:
                          """فیچقە کردنی سووتەمەنی یارمەتی بزوێنەرەکە دەدات باشتر کار بکات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/dK4mb1yS0dY?t=';
const double _startSecondsend = 00000000000000000000000000066;
const String _videoIdone = 'https://youtu.be/XBN3IuVCxl8?t=';
const double _startSecondsone = 000000000000000000000000000788;
const String _videoIdtwo = 'https://youtu.be/82UH7MQ42W0?t=';
const double _startSecondstwo = 0000000000000000000000000002;
const String _videoIdthree = 'https://youtu.be/1_hFKRDDP_o?t=';
const double _startSecondsthree = 0000000000000000000000000001764;
const String _videoIdfour = 'https://youtu.be/Kj7xCmdu11I';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/UkeGQotnsDU?t=';
const double _startSecondsfive = 000000000000000000000000000194;
