...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/XpImIRSDwmI?t=';
    const double startSecondsend = 000000000000000000000000000127;
    const String videoIdone = 'https://youtu.be/VFoUXFxmnSM?t=';
    const double startSecondsone = 000000000000000000000000000191;
    const String videoIdtwo = 'https://youtu.be/Aoof8rEPQb0?t=';
    const double startSecondstwo = 000000000000000000000000000154;
    const String videoIdthree = 'https://youtu.be/bC7ckGiCd3I?t=';
    const double startSecondsthree = 000000000000000000000000000260;
    const String videoIdfour = 'https://youtu.be/Solb9uA-tgQ?t=';
    const double startSecondsfour = 00000000000000000000000000022298;
    const String videoIdfive = 'https://youtu.be/Qe8of66Nkio?t=';
    const double startSecondsfive = 000000000000000000000000000359;
