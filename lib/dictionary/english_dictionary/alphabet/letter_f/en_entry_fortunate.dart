...
class EnglishEntryfortunate extends StatefulWidget {
  const EnglishEntryfortunate({super.key});

  @override
  State<EnglishEntryfortunate> createState() => _EnglishEntryfortunateState();
}

class _EnglishEntryfortunateState extends State<EnglishEntryfortunate> {
  @override
  void initState() {
    super.initState();
...
2. Supremely favoured (= golden)
"fortunate son";
 
3. Presaging good fortune (= rosy)
"she made a fortunate decision to go to medical school";
""",
  );

  final String keyword = "fortunate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fortunate""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Remember those less fortunate than yourselves.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I have been fortunate enough to visit many parts of the world as a lecturer.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fortunate""",
                      // alsoEnglishWord: "also: fortunate",
                      britshText: """IpaUK: /ˈfɔːtʃənət/""",
                      americanText: """IpaUS: /ˈfɔːrtʃənət/""",
...
کوردی: خواپێداو، بەخت‌ڕووتێکردوو، بەختەوەر، بەبەخت، بەهرەوەر، ناوچاوان‌هێناو،	مەبارەک، خێران‌دار، بارەدار، پیرۆز، باش
"""),
// With short examples define "fortunate", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) کە قازانجێک، هەلێک، بەختێکی باش، هتد دەهێنێت بۆ کەسێک"""),
                    SentencesRow(
                      englishText:
                          """Remember those less fortunate than yourselves.""",
                      kurdishText: """ئەو کەسانەت بیر بێت کە کەمتر لە خواپێداو بوونە.""",
                    ...
                    SentencesRow(
                      englishText: """I have been fortunate enough to visit many parts of the world as a lecturer.""",
                      kurdishText: """بەشی ئەوەندە بەبەخت بوومە کە وەک مامۆستا سەردانی زۆر بەشی جیهان بکەم.""",
...
const String _videoIdone = 'https://youtu.be/6YxGCccOEHc?t=';
const double _startSecondsone = 000000000000000000000000000371;
const String _videoIdtwo = 'https://youtu.be/HAnw168huqA?t=';
const double _startSecondstwo = 000000000000000000000000000690;
const String _videoIdthree = 'https://youtu.be/OZ_xhkg32nk?t=';
const double _startSecondsthree = 000000000000000000000000000410;
const String _videoIdfour = 'https://youtu.be/380Zqbi9luo?t=';
const double _startSecondsfour = 000000000000000000000000000389;
const String _videoIdfive = 'https://youtu.be/B1r4Z3nXPVA?t=';
