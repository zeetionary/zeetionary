...
class EnglishEntryfragile extends StatefulWidget {
  const EnglishEntryfragile({super.key});

  @override
  State<EnglishEntryfragile> createState() => _EnglishEntryfragileState();
}

class _EnglishEntryfragileState extends State<EnglishEntryfragile> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fragile 
1. Easily broken, damaged or destroyed (= delicate, frail)
"fragile porcelain plates";
 
2. Vulnerably delicate
"she has the fragile beauty of youth"

3. Lacking substance or significance (= flimsy, slight, tenuous, thin)
"a fragile claim to fame";
""",
  );

  final String keyword = "fragile";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fragile""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Be careful not to drop it; it’s very fragile.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Be careful with that vase - it's very fragile.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The economy remains extremely fragile.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The woman's fragile face broke into a smile.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her father is now 86 and in fragile health.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fragile""",
                      // alsoEnglishWord: "also: fragile",
                      britshText: """IpaUK: /ˈfrædʒaɪl/""",
                      americanText: """IpaUS: /ˈfrædʒl/""",
...
کوردی: ناسک، زووشکاو، قرپ، قرچ، ڕێزەڵۆک، هەڵپەڕیو، لەشکان‌هاتوو، بشکێن،	هەستیار، ناسک،	لاواز، سست، فشە، بێ‌هێز،	نەشە، خومار
"""),
// With short examples define "fragile", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """وریابە نەکەوێت لە دەستت؛ زۆر ناسکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئاگاداری ئەو گوڵدانە بە ـ ۆزر ناسکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕووخسارە جوانەکەی ژنەکە کەوتە پێکەنین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """باوکی ئێستا ٨٦ ساڵە و تەندرووستی لاوازە.""",
...
const double _startSecondsend = 000000000000000000000000000445;
const String _videoIdone = 'https://youtu.be/j1BfO7VlIw4?t=';
const double _startSecondsone = 0000000000000000000000000001171;
...
const String _videoIdfour = 'https://youtu.be/ndqjxhi7uZs?t=';
const double _startSecondsfour = 000000000000000000000000000370;
const String _videoIdfive = 'https://youtu.be/GIJ_olY4BnE?t=';
const double _startSecondsfive = 000000000000000000000000000565;
