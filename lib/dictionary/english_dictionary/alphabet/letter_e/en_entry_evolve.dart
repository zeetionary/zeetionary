...
class EnglishEntryevolve extends StatefulWidget {
  const EnglishEntryevolve({super.key});

  @override
  State<EnglishEntryevolve> createState() => _EnglishEntryevolveState();
}

class _EnglishEntryevolveState extends State<EnglishEntryevolve> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evolve""",
                      // alsoEnglishWord: "also: evolve",
                      britshText: """IpaUK: /ɪˈvɒlv/""",
                      americanText: """IpaUS: /ɪˈvɑːlv/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The idea evolved from a drawing I discovered.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Each school must evolve its own way of working.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The market has evolved considerably in recent years.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Africa and its wildlife evolved together.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""These are very highly evolved animals.""");
  }
...
// With short examples define "evolve", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: کردنەوە، دەرکێشان، هەڵێنجان
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) گەشەکردن بە هێواشی، بەتایبەتی لە شێوەیەکی سادەوە بۆ یەکێکی ئاڵۆز"""),
          SentencesRow(
            englishText: """The idea evolved from a drawing I discovered.""",
            kurdishText: """بیرۆکەکە پەرەی سەند لە وێنەیەکەوە کە دۆزیمەوە.""",
          ...
          SentencesRow(
            englishText:
                """The company has evolved into a major chemical manufacturer.""",
            kurdishText:
                """کۆمپانیاکە گەشەی کردووە بۆ بەرهەمهێنەرێکی سەرەکیی مادەی کیمیایی.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Each school must evolve its own way of working.""",
            kurdishText:
                """هەر قوتابخانەیەک دەبیت شێوازی کارکردنی خۆی پەرە پێ‌بدات.""",
            englishNote:
                "This means that every school needs to develop and adapt its unique methods and practices to function effectively and meet its specific needs and challenges.",
          ...
          SentencesRow(
            ...
            kurdishText:
                """بازاڕەکە بە ئاستێکی زۆر گەشەی کردووە لە چەند ساڵی دواییدا.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) گۆڕانی ڕووەک، ئاژەڵ، مرۆڤ، ڕووەک، هتد، زۆرجار بە درێژایی چەند نەوەیەک، بۆ شێوەی دیکە کە باشتر لەگەڵ ژینگە دەگونجێت"""),
          const DividerSentences(),
          SentencesRow(
          ...
          SentencesRow(
            englishText:
                """Monkeys in the New World evolved quite separately from those in the Old World.""",
            kurdishText:
                """مەیموونەکانی جیهانی تازە زۆر جیاواز پەرەیان سەند وەک لەوانەی جیهانی کۆن.""",
            englishNote:
                "In this context, the New World refers to the Americas, including North, Central, and South America, while Old World refers to Africa, Europe, and Asia.",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """These are very highly evolved animals.""",
            kurdishText: """ئەمانە ئاژەڵی زۆر پەرەسەندوون.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: evolve (Derived forms: evolved, evolving, evolves)
1. Undergo development or evolution
"Modern man evolved a long time ago"
 
2. Start and work to gradually produce or understand (= germinate, develop)
"We have evolved a new theory of evolution";
 
3. Gain through experience (= develop, acquire)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/YRhqMWUH2Ig?t=';
const double _startSecondsend = 000000000000000000000000000000; // 467;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/HxRUuGqqMG4?t=';
const double _startSecondsone = 00000000000000000000000000000; // 455;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/QtVL76gh09U?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 794;
const String _videoIdthree = 'VIDEOhttps://youtu.be/Wao0_uB4Zw4?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1767;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/4U2ZxO7b8iM?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 976;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/NNnIGh9g6fA?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 3141;
