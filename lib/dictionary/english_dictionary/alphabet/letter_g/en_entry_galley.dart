...
class EnglishEntrygalley extends StatefulWidget {
  const EnglishEntrygalley({super.key});

  @override
  State<EnglishEntrygalley> createState() => _EnglishEntrygalleyState();
}

class _EnglishEntrygalleyState extends State<EnglishEntrygalley> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The ancient galley had many rowers.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The cook prepared meals in the ship's galley.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """galley""",
                      // alsoEnglishWord: "also: galley",
                      britshText: """IpaUK: /ˈɡæli/""",
                      americanText: """IpaUS: /ˈɡæli/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چێشتلێنەرەکە خواردنی لەسەر چێشتخانەی کەشتییەکە ئامادە کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/4DFl6GFf04E?t=';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/AhW3jlg7NQw';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/vbtdMOmCwWY?t=';
const double _startSecondstwo = 00000000000000000000000000090;
const String _videoIdthree = 'https://youtu.be/2LAl2qAmp7c?t=';
...
const double _startSecondsfive = 0000000000000000000000000001200;
