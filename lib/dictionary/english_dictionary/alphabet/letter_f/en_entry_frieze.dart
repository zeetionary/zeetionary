...
class EnglishEntryfrieze extends StatefulWidget {
  const EnglishEntryfrieze({super.key});

  @override
  State<EnglishEntryfrieze> createState() => _EnglishEntryfriezeState();
}

class _EnglishEntryfriezeState extends State<EnglishEntryfrieze> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The frieze on the building showed ancient battles.""");
  }
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """The frieze on the building showed ancient battles.""",
                      kurdishText:
                          """نەخشی سەر بیناکە جەنگی کۆنی پیشان دەدا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The children made a frieze showing traders and their camels crossing the desert.""",
                      kurdishText:
                          """منداڵەکان وێنەیەکیان کێشا کە بازرگان و وشتر بە بیابانەکەدا دەچوون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/SJXFcEYjZEw?t=';
const double _startSecondsend = 000000000000000000000000000331;
const String _videoIdone = 'https://youtu.be/OUYCbQSErAU?t=';
const double _startSecondsone = 000000000000000000000000000230;
const String _videoIdtwo = 'https://youtu.be/PEcd7eOnLIU?t=';
const double _startSecondstwo = 00000000000000000000000000018;
const String _videoIdthree = 'https://youtu.be/Za_Lze3CZn4?t=';
const double _startSecondsthree = 000000000000000000000000000979;
const String _videoIdfour = 'https://youtu.be/BLKD2Wf8_wk?t=';
const double _startSecondsfour = 0000000000000000000000000008597;
const String _videoIdfive = 'https://youtu.be/_r9d904zRE4?t=';
const double _startSecondsfive = 0000000000000000000000000003871;
