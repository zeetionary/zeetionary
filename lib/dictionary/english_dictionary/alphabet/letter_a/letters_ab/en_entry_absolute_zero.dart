...
class EnglishEntryabsolutezero extends StatefulWidget {
  const EnglishEntryabsolutezero({super.key});

  @override
  State<EnglishEntryabsolutezero> createState() =>
      _EnglishEntryabsolutezeroState();
}

class _EnglishEntryabsolutezeroState extends State<EnglishEntryabsolutezero> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "absolute zero";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """absolute zero""",
                      // alsoEnglishWord: "also: absolute zero",
                      britshText: """IpaUK: /ˌæbsəluːt ˈzɪərəʊ/""",
                      americanText: """IpaUS: /ˌæbsəluːt ˈzɪrəʊ/""",
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'ykHH4aBAUmA';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'ctwqG7qAbAg';
