...
class EnglishEntrygenealogy extends StatefulWidget {
  const EnglishEntrygenealogy({super.key});

  @override
  State<EnglishEntrygenealogy> createState() => _EnglishEntrygenealogyState();
}

class _EnglishEntrygenealogyState extends State<EnglishEntrygenealogy> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "genealogy";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""genealogy""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I became interested in the genealogy of my family.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """genealogy""",
                      // alsoEnglishWord: "also: genealogy",
                      britshText: """IpaUK: /ˌdʒiːniˈælədʒi/""",
                      americanText: """IpaUS: /ˌdʒiːniˈælədʒi/""",
...
// With short examples define "genealogy", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """حەزم کرد لە زانینی ڕەچەڵەکی خێزانەکەم.""",
...
const String _videoIdtwo = 'https://youtu.be/qKtHwc3mMY8?t=';
const double _startSecondstwo = 000000000000000000000000000899;
const String _videoIdthree = 'https://youtu.be/Jelo4bliA1Y?t=';
const double _startSecondsthree = 000000000000000000000000000295;
const String _videoIdfour = 'https://youtu.be/Pl8B55MqOQo?t=';
const double _startSecondsfour = 0000000000000000000000000003000;
const String _videoIdfive = 'https://youtu.be/z3uvnwBMTdY?t=';
const double _startSecondsfive = 0000000000000000000000000003791;
