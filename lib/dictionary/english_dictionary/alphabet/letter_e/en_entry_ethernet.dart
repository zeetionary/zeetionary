...
class EnglishEntryethernet extends StatefulWidget {
  const EnglishEntryethernet({super.key});

  @override
  State<EnglishEntryethernet> createState() => _EnglishEntryethernetState();
}

class _EnglishEntryethernetState extends State<EnglishEntryethernet> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""ethernet""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ethernet""",
                      // alsoEnglishWord: "also: ethernet",
                      britshText: """IpaUK: /ˈiːθənet/""",
                      americanText: """IpaUS: /ˈiːθərnet/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The office uses Ethernet for fast internet.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) سیستەمێک بۆ پەیوەستکردنی ژمارەیەک سیستەمی کۆمپیوتەری بە یەکەوە بۆ درووستکردنی تۆڕێک"""),
          SentencesRow(
            englishText: """The office uses Ethernet for fast internet.""",
            kurdishText: """ئۆفیسەکە ئیسەرنێت بەکاردێنێت بۆ ئینەرنێتی خێرا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: ethernet (Derived forms: ethernets)
1. A type of network cabling and technology for carrying (e.g. internet) signals within local area networks
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/rr2XfL_df3o?t=';
const double _startSecondsend = 000000000000000000000000000000; // 398;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/d86ws7mQYIg?t=';
...
const double _startSecondstwo = 00000000000000000000000000000; // 2979;
const String _videoIdthree = 'VIDEOhttps://youtu.be/wvhP1al3Ur4?t=';
const double _startSecondsthree = 000000000000000000000000000; // 149;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/quouML5-UZI?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 97;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/-EZ_3Tq9a8c?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 161;
