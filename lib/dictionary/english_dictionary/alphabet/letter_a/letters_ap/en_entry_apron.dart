...
class EnglishEntryapron extends StatelessWidget {
  ...
  Future<void> speakapron728(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Her apron was speckled with oil.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "apron"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈeɪprən/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈeɪprən/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'lp85yyPSP10';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'r42TD3H7uOo';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'Alq0B2KZ-ME';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'XpWJSWBRy-0';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'aWJmCO9ikHo';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'JqcJ5aEwRb0';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '1Pt7p64NLtg';
  final double _startSeconds = 14;
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'MFtEOCe59gA';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'DsjJBYhHWac';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = '7KrNXLU-TyM';
