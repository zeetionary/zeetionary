...
class EnglishEntryinterjection extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""interjection""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'MTDjXr7cUnY';
    const double startSecondsend = 69;
    const String videoIdone = 'lfkjm2YRG-Q';
    const double startSecondsone = 1361;
    const String videoIdtwo = 'CHjVz6nHh7Y';
    const double startSecondstwo = 6067;
    const String videoIdthree = 'kjN4uH3nRCA';
    const double startSecondsthree = 2;
    const String videoIdfour = '5Ik-KQFm9oQ';
    const double startSecondsfour = 517;
    const String videoIdfive = 'l30sADfDiM8';
    const double startSecondsfive = 1831;
