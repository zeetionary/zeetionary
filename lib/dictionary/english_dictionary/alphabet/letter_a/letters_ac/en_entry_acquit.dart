...
class EnglishEntryacquit extends StatefulWidget {
  const EnglishEntryacquit({super.key});

  @override
  State<EnglishEntryacquit> createState() => _EnglishEntryacquitState();
}

class _EnglishEntryacquitState extends State<EnglishEntryacquit> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakac12569(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She was acquitted on all charges.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acquit""",
                      // alsoEnglishWord: "also: acquit",
                      britshText: """IpaUK: /əˈkwɪt/""",
                      americanText: """IpaUS: /əˈkwɪt/""",
...
١. (کردار) لێخۆشبوون لە گومانلێکراوێک لە دادگا"""),
                          SentencesRow(
                            ...
                            kurdishText: "لە ھەموو تۆمەتەکان بێبەری کرا.",
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'wqgz7kRGVxg';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'OCXHvP78CS8';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 's4XVmjfNno4';
