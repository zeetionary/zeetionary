...
class EnglishEntrygin extends StatefulWidget {
  const EnglishEntrygin({super.key});

  @override
  State<EnglishEntrygin> createState() => _EnglishEntryginState();
}

class _EnglishEntryginState extends State<EnglishEntrygin> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She poured herself a large gin.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gin""",
                      // alsoEnglishWord: "also: gin",
                      britshText: """IpaUK: /dʒɪn/""",
                      americanText: """IpaUS: /dʒɪn/""",
...
// With short examples define "gin", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """She poured herself a large gin.""",
                      kurdishText: """گڵاسێکی گەورە لە جینی بۆ خۆی تێکرد.""",
...
const double _startSecondsone = 0000000000000000000000000001765;
const String _videoIdtwo = 'https://youtu.be/M7ikhWfHQc8?t=';
const double _startSecondstwo = 00000000000000000000000000087;
const String _videoIdthree = 'https://youtu.be/iht8e_HtLso?t=';
const double _startSecondsthree = 000000000000000000000000000607;
const String _videoIdfour = 'https://youtu.be/y9nBhv0lq1s?t=';
const double _startSecondsfour = 000000000000000000000000000790;
const String _videoIdfive = 'https://youtu.be/QJY5VVQsFZ0?t=';
