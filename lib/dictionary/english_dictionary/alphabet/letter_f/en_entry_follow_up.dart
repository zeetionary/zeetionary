...
class EnglishEntryfollowup extends StatefulWidget {
  const EnglishEntryfollowup({super.key});

  @override
  State<EnglishEntryfollowup> createState() => _EnglishEntryfollowupState();
}

class _EnglishEntryfollowupState extends State<EnglishEntryfollowup> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: follow-up (Derived forms: followups, follow-ups)
1. A piece of work that exploits or builds on earlier work (= followup)
"his new software is a followup to the programs they started with";
 
2. An activity that continues something that has already begun or that repeats something that has already been done (= followup)
 
3. A subsequent examination of a patient for the purpose of monitoring earlier treatment (= followup, reexamination, review)
""",
  );

  final String keyword = "follow-up";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""follow-up""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We are planning a follow-up to today's event.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """follow-up""",
                      // alsoEnglishWord: "also: follow-up",
                      britshText: """IpaUK: /ˈfɒləʊ ʌp/""",
                      americanText: """IpaUS: /ˈfɑːləʊ ʌp/""",
...
کوردی: 
"""),
// With short examples define "follow-up", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) شتێک کە بە دوای شتێکی دیکە دێت یان هاوشێوەی شتێکی دیکە"""),
                    SentencesRow(
                      englishText:
                          """The book is a follow-up to her excellent television series.""",
                      kurdishText:
                          """ئەم کتێبە درێژەپێدەری زنجیرە تەلەفزیۆنییە نایابەکەیەتی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پلانی درێژەپێدانێکمان هەیە بۆ بۆنەکەی ئەمڕۆ.""",
...
const String _videoIdone = 'https://youtu.be/JCcl--4PhF4?t=';
const double _startSecondsone = 000000000000000000000000000487;
const String _videoIdtwo = 'https://youtu.be/2GTWD4AWPww?t=';
const double _startSecondstwo = 000000000000000000000000000559;
const String _videoIdthree = 'https://youtu.be/Sh2tWaYElCc?t=';
const double _startSecondsthree = 0000000000000000000000000001068;
const String _videoIdfour = 'https://youtu.be/qQ01eLt_bxo?t=';
const double _startSecondsfour = 000000000000000000000000000937;
const String _videoIdfive = 'https://youtu.be/fez7X_oevNs?t=';
