...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/pFmtmO2cnlg?t=';
    const double startSecondsend = 00000000000000000000000000078;
    const String videoIdone = 'https://youtu.be/SwQhKFMxmDY?t=';
    const double startSecondsone = 0000000000000000000000000001739;
    const String videoIdtwo = 'https://youtu.be/XHXLbp7x3MM?t=';
    const double startSecondstwo = 000000000000000000000000000196;
    const String videoIdthree = 'https://youtu.be/6etTERFUlUI?t=';
    const double startSecondsthree = 000000000000000000000000000390;
    const String videoIdfour = 'https://youtu.be/XKDhq2UcjIM?t=';
    const double startSecondsfour = 000000000000000000000000000353;
    const String videoIdfive = 'https://youtu.be/EI-ToB0tG9A?t=';
