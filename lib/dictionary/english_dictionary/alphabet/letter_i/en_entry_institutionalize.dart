...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/vy3IsfyS2Ng?t=';
    const double startSecondsend = 0000000000000000000000000001276;
    const String videoIdone = 'https://youtu.be/aYKKsRxhcro?t=';
    const double startSecondsone = 0000000000000000000000000003811;
    const String videoIdtwo = 'https://youtu.be/ML0LEcF2bH8?t=';
    const double startSecondstwo = 000000000000000000000000000163;
    const String videoIdthree = 'https://youtu.be/dd399ppGoBU?t=';
    const double startSecondsthree = 000000000000000000000000000552;
    const String videoIdfour = 'https://youtu.be/nZqfGrjIqaE?t=';
    const double startSecondsfour = 000000000000000000000000000622;
    const String videoIdfive = 'https://youtu.be/71lrn2BxIvQ?t=';
    const double startSecondsfive = 0000000000000000000000000003040;
