...
class EnglishEntryfeminist extends StatefulWidget {
  const EnglishEntryfeminist({super.key});

  @override
  State<EnglishEntryfeminist> createState() => _EnglishEntryfeministState();
}

class _EnglishEntryfeministState extends State<EnglishEntryfeminist> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """feminist""",
                      // alsoEnglishWord: "also: feminist",
                      britshText: """IpaUK: /ˈfemənɪst/""",
                      americanText: """IpaUS: /ˈfemənɪst/""",
...
// With short examples define "feminist", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تەواوی ژیانی فێمینیستێکی کۆڵنەدەر بوو.""",
...
const String _videoIdend = 'https://youtu.be/DEFD9TSHg_A?t=';
const double _startSecondsend = 000000000000000000000000000185;
const String _videoIdone = 'https://youtu.be/hkO8qXCFYWA?t=';
const double _startSecondsone = 0000000000000000000000000001582;
const String _videoIdtwo = 'https://youtu.be/B1r4Z3nXPVA?t=';
const double _startSecondstwo = 000000000000000000000000000535;
const String _videoIdthree = 'https://youtu.be/NOXSz3nJgTs?t=';
const double _startSecondsthree = 000000000000000000000000000123;
const String _videoIdfour = 'https://youtu.be/slZKqXY-k-U?t=';
const double _startSecondsfour = 00000000000000000000000000028;
const String _videoIdfive = 'https://youtu.be/BBnlC9lrKVM?t=';
const double _startSecondsfive = 000000000000000000000000000926;
