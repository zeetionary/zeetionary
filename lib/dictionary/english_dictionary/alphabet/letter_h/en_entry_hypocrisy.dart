...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 561;
    const String videoIdone = 'G_FUmf0T8YI';
    const double startSecondsone = 275;
    const String videoIdtwo = 'kzgFwZEAHZQ';
    const double startSecondstwo = 2563;
    const String videoIdthree = 'JN3KPFbWCy8';
    const double startSecondsthree = 7248;
    const String videoIdfour = 'Gfj5f0GVLZ0';
