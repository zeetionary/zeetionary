...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You should insure the car against fire and theft.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Luckily he had insured himself against long-term illness.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The company can refuse to insure a property that does not have window locks.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/Z0SzIkheaFg?t=';
    const double startSecondsend = 000000000000000000000000000469;
    const String videoIdone = 'https://youtu.be/63tQ7yGmsmI?t=';
    const double startSecondsone = 0000000000000000000000000001319;
    const String videoIdtwo = 'https://youtu.be/6QgR6Tjle7g?t=';
    const double startSecondstwo = 000000000000000000000000000513;
    const String videoIdthree = 'https://youtu.be/j3Xf1x5GmiQ?t=';
    const double startSecondsthree = 000000000000000000000000000443;
    const String videoIdfour = 'https://youtu.be/df8FRfVtVNw?t=';
    const double startSecondsfour = 0000000000000000000000000001113;
    const String videoIdfive = 'https://youtu.be/PljDuynF-j0?t=';
    const double startSecondsfive = 000000000000000000000000000595;
...
// With short examples define "insure", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) دابینکردنی بیمە بۆ خۆت لە حاڵەتی مردن یان نەخۆشی، یان نەخۆش بکەویت و بمریت"""),
                    SentencesRow(
                      englishText: """The painting is insured for £1 million.""",
                      kurdishText: """تابلۆکە زەمانی ١ ملیۆن پاوەندی لەسەرە.""",
                      englishNote: """This means the painting is protected by an insurance policy, guaranteeing that if it is damaged or lost, the owner will receive compensation of up to £1 million.""",
                    ...
                    SentencesRow(
                      englishText: """You should insure the car against fire and theft.""",
                      kurdishText: """دەبێت زەمان بۆ ئۆتۆمبێلەکە وەربگریت دژ بە ئاگر و دزین.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Luckily he had insured himself against long-term illness.""",
                      kurdishText: """خۆشبەختانە بیمەی خۆی دژ بە نەخۆشی درێژخایەن هەبوو.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) پێدانی بیمە بە کەسێک بۆ شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The company can refuse to insure a property that does not have window locks.""",
                      kurdishText: """کۆمپانیاکە دەتوانێت بیمە ڕەتبکاتەوە بۆ زەوییەک کە پارێزەری پەنجەرەی نییە.""",
