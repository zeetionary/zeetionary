...
class EnglishEntryfudge extends StatefulWidget {
  const EnglishEntryfudge({super.key});

  @override
  State<EnglishEntryfudge> createState() => _EnglishEntryfudgeState();
}

class _EnglishEntryfudgeState extends State<EnglishEntryfudge> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fudge (Derived forms: fudges)
1. Soft creamy candy

- Verb: fudge (Derived forms: fudged, fudges, fudging)
1. Tamper, with the purpose of deception (- manipulate, fake, falsify, cook [informal], wangle [informal], misrepresent, spoof [informal])
"Fudge the figures";
 
2. Avoid or try to avoid fulfilling, answering, or performing (duties, questions, or issues) (- hedge, evade, put off, circumvent, parry, elude, skirt, dodge, duck [informal], sidestep, finesse, circumnavigate)
"They tend to fudge their responsibilities";
""",
  );

  final String keyword = "fudge";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She made chocolate fudge for the party.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Politicians are often very clever at fudging the issue.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fudge""",
                      // alsoEnglishWord: "also: fudge",
                      britshText: """IpaUK: /fʌdʒ/""",
                      americanText: """IpaUS: /fʌdʒ/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """She made chocolate fudge for the party.""",
                      kurdishText: """شیرینی چکلێتی بۆ ئاهەنگەکە درووست کرد.""",
                    ...
                    SentencesRow(
                      englishText:
                          """This solution is a fudge rushed in to win cheers at the party conference.""",
                      kurdishText:
                          """چارەسەرەکە تەنها پینەوپەڕۆیە کە ئەنجام دراوە بح بردنەوەی دەستخۆشی لە کۆنفرانسی پارتەکە.""",
                      englishNote:
                          """This means that the solution is a quick and possibly inadequate fix made to gain approval or applause, rather than being a well-thought-out or effective resolution.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کەسانی سیاسی زۆرجار زۆر زیرەکن لە خۆدزینەوە لە کێشە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/043CQXHfx10?t=';
const double _startSecondsend = 000000000000000000000000000866;
const String _videoIdone = 'https://youtu.be/VvJm4pQZ04s?t=';
const double _startSecondsone = 000000000000000000000000000301;
const String _videoIdtwo = 'https://youtu.be/LoqwZBkYWqE?t=';
const double _startSecondstwo = 000000000000000000000000000177;
const String _videoIdthree = 'https://youtu.be/xxn8bUcjukU?t=';
const double _startSecondsthree = 0000000000000000000000000001920;
const String _videoIdfour = 'https://youtu.be/6Xf858oNEak?t=';
const double _startSecondsfour = 000000000000000000000000000136;
const String _videoIdfive = 'https://youtu.be/SsuuUlVixI8?t=';
