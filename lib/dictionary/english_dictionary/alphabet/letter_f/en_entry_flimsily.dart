...
class EnglishEntryflimsily extends StatefulWidget {
  const EnglishEntryflimsily({super.key});

  @override
  State<EnglishEntryflimsily> createState() => _EnglishEntryflimsilyState();
}

class _EnglishEntryflimsilyState extends State<EnglishEntryflimsily> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flimsily""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The allegations against him were flimsily based.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flimsily""",
                      // alsoEnglishWord: "also: flimsily",
                      britshText: """IpaUK: /ˈflɪmzɪli/""",
                      americanText: """IpaUS: /ˈflɪmzɪli/""",
...
کوردی: بە سستی، بێ‌هێزانە
"""),
// With short examples define "flimsily", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بەشێوەیەک کە زۆر بەهێز نییە بۆ ئەو مەبەستەی درووستکراوە"""),
                    SentencesRow(
                      englishText:
                          """The huts were flimsily constructed and did not keep out the rain.""",
                      kurdishText:
                          """کوخەکان بە شێوەیەکی لاواز دروستکرابوون و نەیاندەتوانی پێش بە باران بگرن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تۆمەتەکانی دژی بناغەیان لاواز بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/WWhApKOCqqA?t=';
const double _startSecondsend = 000000000000000000000000000341;
const String _videoIdone = 'https://youtu.be/P4mA_rIeBAQ?t=';
const double _startSecondsone = 000000000000000000000000000264;
const String _videoIdtwo = 'https://youtu.be/dsdSsmVWO8M?t=';
const double _startSecondstwo = 00000000000000000000000000037;
const String _videoIdthree = 'https://youtu.be/RX3P505I0bo?t=';
const double _startSecondsthree = 0000000000000000000000000001037;
const String _videoIdfour = 'https://youtu.be/4VBD62OTfnU?t=';
const double _startSecondsfour = 00000000000000000000000000069;
const String _videoIdfive = 'https://youtu.be/U0sPpKf3_iI?t=';
