...
کوردی: پێویست، پێدڤی، بنچینەیی، گەوھەری، بنەڕەتی، بنەمایی، بنگەھی، سەرەکی، گرنگ،	گەوھەری، کرۆکی، زاتی، سروشتی
"""),
          ...
          SentencesRow(
            ...
            kurdishText:
                """ئەم کتێبە خوێندنەوەیەکی سەرەکییە بۆ ھەموو ئاشقانی سرووشت.""",
          ...
          SentencesRow(
            englishText:
                """He describes what he thinks is the essential nature of America.""",
            kurdishText:
                """ئەوە باس دەکات کە وەھا بیردەکاتەوە سرووشتی بنچینەیی ئەمریکایە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """کاتم ھەبوو تەنھا شتە ھەرە سەرەکییەکان کۆبکەمەوە.""",
          ...
          SentencesRow(
            englishText:
                """The studio had all the essentials like heating and running water.""",
            kurdishText:
                """ستودیۆکە ھەموو شتە سەرەکییەکانی وەک گەرمکەرەوە و ئاوی ھەبوو.""",
