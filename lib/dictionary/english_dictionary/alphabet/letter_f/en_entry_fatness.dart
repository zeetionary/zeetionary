...
class EnglishEntryfatness extends StatefulWidget {
  const EnglishEntryfatness({super.key});

  @override
  State<EnglishEntryfatness> createState() => _EnglishEntryfatnessState();
}

class _EnglishEntryfatnessState extends State<EnglishEntryfatness> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fatness""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fatness""",
                      // alsoEnglishWord: "also: fatness",
                      britshText: """IpaUK: /ˈfætnəs/""",
                      americanText: """IpaUS: /ˈfætnəs/""",
...
کوردی: قەڵەوی
"""),
          const DefinitionKurdish(text: """١. (ناو) قەڵەوی"""),
          SentencesRow(
            englishText: """Fatness tends to run in families.""",
            kurdishText: """قەڵەوی لە خێزانەکان بەردەوام دەبێت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fatness
1. Excess bodily weight (= fat, blubber, avoirdupois)
...
const String _videoIdend = 'https://youtu.be/VS0oPwb3sag?t=';
const double _startSecondsend = 000000000000000000000000000659;
const String _videoIdone = 'https://youtu.be/FoqHB7BMduw?t=';
const double _startSecondsone = 000000000000000000000000000196;
const String _videoIdtwo = 'https://youtu.be/OoH1oGAJ7jI?t=';
const double _startSecondstwo = 000000000000000000000000000697;
const String _videoIdthree = 'https://youtu.be/EB4ZCKkBT1Y?t=';
const double _startSecondsthree = 000000000000000000000000000624;
const String _videoIdfour = 'https://youtu.be/ShzDEEmYbuE?t=';
const double _startSecondsfour = 0000000000000000000000000001685;
const String _videoIdfive = 'https://youtu.be/KWhrR9Fztss?t=';
