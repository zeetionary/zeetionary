...
class EnglishEntrylubricate extends StatefulWidget {
  const EnglishEntrylubricate({super.key});

  @override
  State<EnglishEntrylubricate> createState() => _EnglishEntrylubricateState();
}

class _EnglishEntrylubricateState extends State<EnglishEntrylubricate> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylubricate lubricate
WORD_WEB lubricate lubricate lubricate
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lubricate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lubricate""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lubricate""",
                      // alsoEnglishWord: "also: lubricate",
...
کوردی: 
"""),
// With short examples define "lubricate", please follow LX instructions
