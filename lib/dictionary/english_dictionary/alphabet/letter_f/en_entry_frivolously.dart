...
class EnglishEntryfrivolously extends StatefulWidget {
  const EnglishEntryfrivolously({super.key});

  @override
  State<EnglishEntryfrivolously> createState() =>
      _EnglishEntryfrivolouslyState();
}

class _EnglishEntryfrivolouslyState extends State<EnglishEntryfrivolously> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "frivolously";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frivolously""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I never spend money frivolously—I can't afford to.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frivolously""",
                      // alsoEnglishWord: "also: frivolously",
                      britshText: """IpaUK: /ˈfrɪvələsli/""",
                      americanText: """IpaUS: /ˈfrɪvələsli/""",
...
// With short examples define "frivolously", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە گەمژانە یان پێکەنیناوییە، بە تایبەتی لە دۆخێک کە نەگونجاوە"""),
                    SentencesRow(
                      englishText:
                          """A teacher should not behave frivolously in front of their students.""",
                      kurdishText:
                          """مامۆستا نابێت سەرچڵانە لە پێش خوێندکارەکانی ڕەفتار بکات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بە شێوەیەک کە هیچ مەبەستێکی نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I never spend money frivolously—I can't afford to.""",
                      kurdishText:
                          """هەرگیز هیچ پارە لەخۆڕا خەرج ناکەم ـ هێندەم نییە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/RN3wYVRkmno?t=';
const double _startSecondsend = 0000000000000000000000000001049;
const String _videoIdone = 'https://youtu.be/TXKeqco1yR4?t=';
const double _startSecondsone = 000000000000000000000000000486;
const String _videoIdtwo = 'https://youtu.be/ccAS2stpkmA?t=';
const double _startSecondstwo = 000000000000000000000000000506;
const String _videoIdthree = 'https://youtu.be/SURU8r2o95w?t=';
const double _startSecondsthree = 000000000000000000000000000173;
const String _videoIdfour = 'https://youtu.be/VVHdPjnDQx0?t=';
const double _startSecondsfour = 00000000000000000000000000025;
const String _videoIdfive = 'https://youtu.be/zMjmWainsA0?t=';
const double _startSecondsfive = 000000000000000000000000000203;
