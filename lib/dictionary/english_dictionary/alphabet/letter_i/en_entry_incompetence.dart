...
class EnglishEntryincompetence extends StatefulWidget {
  const EnglishEntryincompetence({super.key});

  @override
  State<EnglishEntryincompetence> createState() => _EnglishEntryincompetenceState();
}

class _EnglishEntryincompetenceState extends State<EnglishEntryincompetence> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incompetence""");
  }
