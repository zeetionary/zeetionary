...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'wVNbd7mC4Jg';
    const double startSecondsend = 430;
    const String videoIdone = 'GYNsox4n9l0';
    const double startSecondsone = 1088;
    const String videoIdtwo = 'QlAsSye1jR4';
    const double startSecondstwo = 456;
    const String videoIdthree = 'ha7iWECm_8E';
    const double startSecondsthree = 1149;
    const String videoIdfour = 'WiJfGq-iyp0';
    const double startSecondsfour = 2145;
    const String videoIdfive = '0tYm41hb48o';
    const double startSecondsfive = 7900;
