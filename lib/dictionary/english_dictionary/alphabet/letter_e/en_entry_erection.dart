...
class EnglishEntryerection extends StatefulWidget {
  const EnglishEntryerection({super.key});

  @override
  State<EnglishEntryerection> createState() => _EnglishEntryerectionState();
}

class _EnglishEntryerectionState extends State<EnglishEntryerection> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""erection""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """erection""",
                      // alsoEnglishWord: "also: erection",
                      britshText: """IpaUK: /ɪˈrekʃn/""",
                      americanText: """IpaUS: /ɪˈrekʃn/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Sexual arousal can cause a man to have an erection.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """It's common for teenage boys to have an erection frequently.""");
  }
...
کوردی: دامەزراندن، دانان، بنیات‌نان، دروست‌کردن، چەقاندن، داکوتاندن، دابەستن،	خانووبەرە، بینا، دەزگا،	ڕەپ‌بوون، هەستان، ڕەق‌بوون، ڕاستەوەبوون
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کە پیاوێک لە ڕووی سێکسییەوە ورووژاوە و چووکی ڕەق بووە"""),
          SentencesRow(
            englishText:
                """Sexual arousal can cause a man to have an erection.""",
            kurdishText: """ورووژانی سێکسی دەکرێت وا لە پیاو بکات ڕەق ببێت.""",
          ...
          SentencesRow(
            englishText:
                """It's common for teenage boys to have an erection frequently.""",
            kurdishText:
                """شتێکی باوە بۆ کوڕانی گەنج زووزوو تووشی ڕەقبوون بن.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) بنیاتنانی شتێک یان دانانی بەشێوەیەک کە ڕاوەستاو بێت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """They approved the erection of an electric fence around the prison.""",
            kurdishText:
                """بنیاتنانی پەرژینێکی کارەباییان بە دەوری زیندانەکە پەسەند کرد.""",
            onPressedBritish: () => speaksentence3("en-GB"),
            onPressedAmerican: () => speaksentence3("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٣. (ناو) بینایەک، بەتایبەتی یەکێکی گەورە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The cafe was a bleak, concrete erection with plastic tables and chairs.""",
            kurdishText:
                """قاوەخانەکە بینایەکی چۆڵ و کۆنکریتی بوو بە مێز و کورسی پلاستیکی.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: erection (Derived forms: erections)
1. An erect penis
 
2. A structure that has been erected
 
3. The act of building or putting up (= erecting)
""",
  );
...
const String _videoIdend = 'VIDEO_Dhttps://youtu.be/9qw3lkpa5lY?t=';
const double _startSecondsend = 00000000000000000000000000000; // 96;
const String _videoIdone = 'VIDEO_IDhttps://youtu.be/fXLrw7XozC8?t=';
const double _startSecondsone = 000000000000000000000000000000; // 43;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/B5ytcg5pYEA?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 906;
const String _videoIdthree = 'VIDEOhttps://youtu.be/L94M4xQcPYk?t=';
const double _startSecondsthree = 000000000000000000000000000; // 431;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/vI9vvJbnlXE?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 204;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/K83zdXu2xrw?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 655;
