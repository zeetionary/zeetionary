...
class EnglishEntryattend extends StatelessWidget {
  ...
  Future<void> speakattend759(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("We'd like as many people as possible to attend.");
  }
  ...
  Future<void> speakattend800(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Our children attend the same school.");
  }
  ...
  Future<void> speakattend802(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("She hadn't been attending during the lesson.");
  }
  ...
  Future<void> speakattend808(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Success attended their hard work.");
  }
  ...
  Future<void> speakattend809(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("The president was attended by several members of his staff.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "attend"),
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈtend/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈtend/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakattend759("en-US"),
                          ),
...
٢. (کردار) چوون بۆ شوێنێک بە بەردەوامی"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakattend800("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٣. (کردار) سەرنجدان بە شتێک کە دەیکەیت، یان ئەوەی کەسێک دەیڵێت"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakattend802("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٤. (کردار) ڕوودان لە ھەمان کاتی شتێکدا"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakattend808("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٥. (کردار) لەگەڵ کەسێک بوون و یارمەتیدانی"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakattend809("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 2604;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '_dxjgROKQJ0';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'rsNskDfd5CM';
