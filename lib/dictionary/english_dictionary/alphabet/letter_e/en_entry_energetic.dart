...
class EnglishEntryenergetic extends StatefulWidget {
  const EnglishEntryenergetic({super.key});

  @override
  State<EnglishEntryenergetic> createState() => _EnglishEntryenergeticState();
}

class _EnglishEntryenergeticState extends State<EnglishEntryenergetic> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""energetic""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """energetic""",
                      // alsoEnglishWord: "also: energetic",
                      britshText: """IpaUK: /ˌenəˈdʒetɪk/""",
                      americanText: """IpaUS: /ˌenərˈdʒetɪk/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "energetic";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He knew I was energetic and would get things done.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The heart responds well to energetic exercise.""");
  }
...
کوردی: چالاک، هەڵسووڕ، پڕجم‌وجۆڵ، بەکار، پشت‌گەرم، دڵ‌گەرم، توندوتۆڵ، بەگوژم، بەگوڕ، بەتاو، پڕوزە، بەشیان، بەزەبر، کاریگەر، کارا،	شێلگیر، بەڕشت،	سەخت، توند،	وزەیی، سەربە وزە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە پێویستی بە وزە و تامەزرۆیی زۆر هەیە؛ کە وزە و تامەزرۆیی زۆری هەیە"""),
          SentencesRow(
            englishText:
                """He knew I was energetic and would get things done.""",
            kurdishText: """دەیزانی کە چالاکم و کارەکان دەکەم.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The heart responds well to energetic exercise.""",
            kurdishText: """دڵ حەزی بە ڕاهێنانی پڕجم‌وجۆڵە.""",
          ...
          SentencesRow(
            englishText:
                """She seems remarkably energetic for a woman who has been so ill.""",
            kurdishText: """زۆر چالاک دیارە لە چاو ژنێک کە هێندە نەخۆش بووە.""",
            kurdishNote: "ئەگەرچی زۆر نەخۆش بووە بەڵام پێیەوە دیار نییە",
...
2. Working hard to promote an enterprise (= gumptious, industrious)
...
const String _videoIdone = 'https://youtu.be/tMNxgi_0eKA?t=';
const double _startSecondsone = 510;
const String _videoIdtwo = 'https://youtu.be/gjySnrspD7E?t=';
const double _startSecondstwo = 350;
const String _videoIdthree = 'https://youtu.be/OgFcz6klaeg?t=';
const double _startSecondsthree = 612;
const String _videoIdfour = 'https://youtu.be/6etTERFUlUI?t=';
const double _startSecondsfour = 700;
const String _videoIdfive = 'https://youtu.be/j71q6zlbO3I?t=';
const double _startSecondsfive = 104;
const String _videoIdsix = 'https://youtu.be/PCuyCJocJWg?t=';
const double _startSecondssix = 176;
