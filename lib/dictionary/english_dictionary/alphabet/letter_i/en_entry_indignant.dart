...
class EnglishEntryindignant extends StatefulWidget {
  const EnglishEntryindignant({super.key});

  @override
  State<EnglishEntryindignant> createState() => _EnglishEntryindignantState();
}

class _EnglishEntryindignantState extends State<EnglishEntryindignant> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: indignant
1. Angered at something unjust or wrong (- incensed, outraged, umbrageous)
"an indignant denial";
""",
  );

  final String keyword = "indignant";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indignant""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She was very indignant at the way she had been treated.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They were indignant that they hadn't been invited.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They were quite indignant at his remarks.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/wZ6zKtsN_WI?t=';
    const double startSecondsone = 000000000000000000000000000573;
    const String videoIdtwo = 'https://youtu.be/L2gT8fbEq54?t=';
    const double startSecondstwo = 000000000000000000000000000424;
    const String videoIdthree = 'https://youtu.be/Zgaf9ycRLJE?t=';
    const double startSecondsthree = 000000000000000000000000000847;
    const String videoIdfour = 'https://youtu.be/EmT0i0xG6zg?t=';
    const double startSecondsfour = 0000000000000000000000000005465;
    const String videoIdfive = 'https://youtu.be/hSNWkRw53Jo?t=';
    const double startSecondsfive = 0000000000000000000000000006776;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indignant""",
                      // alsoEnglishWord: "also: indignant",
                      britshText: """IpaUK: /ɪnˈdɪɡnənt/""",
                      americanText: """IpaUS: /ɪnˈdɪɡnənt/""",
...
کوردی: تووڕە، ڕق‌هەستاو، سوورەوەبوو
"""),
// With short examples define "indignant", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە هەست بە تووڕەیی و سەرسامی دەکەیت چونکە هەست دەکەیت بە نادادی ڕەفتارت لەگەڵ کراوە"""),
                    SentencesRow(
                      englishText:
                          """She was very indignant at the way she had been treated.""",
                      kurdishText:
                          """زۆر تووڕە بوو لە شێوازی مامەڵەکردن لەگەڵی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تووڕە بوون لەوەی کە بانگهێشت نەکرابوون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تەواو تووڕە بوون بە لێدوانەکانی.""",
