...
class EnglishEntryflu extends StatefulWidget {
  const EnglishEntryflu({super.key});

  @override
  State<EnglishEntryflu> createState() => _EnglishEntryfluState();
}

class _EnglishEntryfluState extends State<EnglishEntryflu> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flu (Derived forms: flus)
1. An acute and highly contagious viral disease causing a high body temperature (fever) (= influenza, grippe [archaic])
"money was allocated to study the cause and prevention of flu";
""",
  );

  final String keyword = "flu";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The whole family has the flu.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's got flu.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He is suffering from flu-like symptoms.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flu""",
                      // alsoEnglishWord: "also: flu",
                      britshText: """IpaUK: /fluː/""",
                      americanText: """IpaUS: /fluː/""",
...
کوردی: ئانفولانزا، هەڵامەت، ئاهۆ
"""),
// With short examples define "flu", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) نەخۆشییەکی توند کە بەهۆی توند کە بەهۆی ڤایرۆسەوە تووشی دەبیت و دەبێتە هۆکاری پلەی گەرمی بەرز و ئازاری زۆر و لاوازی"""),
                    SentencesRow(
                      englishText: """The whole family has the flu.""",
                      kurdishText: """تەواوی خێزانەکە هەڵامەتیان هەیە.""",
                    ...
                    SentencesRow(
                      englishText: """She's got flu.""",
                      kurdishText: """هەڵامەتی گرتووە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تووشی نیشانەکانی هاوشێوەی هەڵامەت بووە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Ihoys69G56U?t=';
const double _startSecondsend = 000000000000000000000000000588;
const String _videoIdone = 'https://youtu.be/GBvfiCdk-jc?t=';
const double _startSecondsone = 000000000000000000000000000235;
const String _videoIdtwo = 'https://youtu.be/y4DTW4B3Sjs?t=';
const double _startSecondstwo = 0000000000000000000000000001296;
const String _videoIdthree = 'https://youtu.be/Ir3eJ1t13fk?t=';
const double _startSecondsthree = 000000000000000000000000000568;
const String _videoIdfour = 'https://youtu.be/Se7ZoTON-ZE?t=';
const double _startSecondsfour = 00000000000000000000000000078;
const String _videoIdfive = 'https://youtu.be/6noCpwaFbVw?t=';
const double _startSecondsfive = 0000000000000000000000000001123;
