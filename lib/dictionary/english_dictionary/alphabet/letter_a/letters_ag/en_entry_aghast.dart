...
// replace these: replace EnglishEntryaghast - replace speakAghast - replace aghast - /əˈɡɑːst/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaghast extends StatelessWidget {
  EnglishEntryaghast({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAghast(String languageCode) async {
    // DOPSUM: CHANGE speakAghast
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("aghast"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAghas15622(String languageCode) async {
    ...
    await flutterTts.speak(
        "He stood aghast at the sight of so much blood."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈɡɑːst/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '5dseN1kve_Q';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'JHjXwicEwQo';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'U6EvOWXyWGQ';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'ts3s738ZkcQ';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'kaUemcqIQ-k';
