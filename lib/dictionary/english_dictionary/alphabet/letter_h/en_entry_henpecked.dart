...
class EnglishEntryhenpecked extends StatefulWidget {
  const EnglishEntryhenpecked({super.key});

  @override
  State<EnglishEntryhenpecked> createState() => _EnglishEntryhenpeckedState();
}

class _EnglishEntryhenpeckedState extends State<EnglishEntryhenpecked> {
  @override
  void initState() {
    super.initState();
...
- Adjective: henpecked
Usage: informal
1. Harassed by persistent nagging (- dominated)
"The man who won't admit he's henpecked probably smokes a big cigar";
""",
  );

  final String keyword = "henpecked";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""henpecked""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Everyone joked that he was a henpecked husband.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """henpecked""",
                      // alsoEnglishWord: "also: henpecked",
                      britshText: """IpaUK: /ˈhenpekt/""",
                      americanText: """IpaUS: /ˈhenpekt/""",
...
کوردی: ئاڵی، لە ژن‌ترس، قوزەخۆرە، دەڵەچە
"""),
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) پیاوێک کە لە ژنەکەی دەترسێت"""),
                    SentencesRow(
                      englishText:
                          """Everyone joked that he was a henpecked husband.""",
                      kurdishText:
                          """هەموان گاڵتەیان دەکرد کەوا پیاوێکی ئاڵییە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/KIu8Tv0HS_4?t=';
const double _startSecondsend = 000000000000000000000000000323;
const String _videoIdone = 'https://youtu.be/AO_sw-nAlEI?t=';
const double _startSecondsone = 0000000000000000000000000005;
const String _videoIdtwo = 'https://youtu.be/GB9_FUeuYO4?t=';
const double _startSecondstwo = 0000000000000000000000000001058;
const String _videoIdthree = 'https://youtu.be/xJ2vEchex2k?t=';
const double _startSecondsthree = 000000000000000000000000000419;
const String _videoIdfour = 'https://youtu.be/o6vDB9l_0JA?t=';
const double _startSecondsfour = 00000000000000000000000000054;
const String _videoIdfive = 'https://youtu.be/6lStqfytVlE?t=';
const double _startSecondsfive = 000000000000000000000000000471;
