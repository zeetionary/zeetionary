...
class EnglishEntryglean extends StatefulWidget {
  const EnglishEntryglean({super.key});

  @override
  State<EnglishEntryglean> createState() => _EnglishEntrygleanState();
}

class _EnglishEntrygleanState extends State<EnglishEntryglean> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""These figures have been gleaned from a number of studies.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glean""",
                      // alsoEnglishWord: "also: glean",
                      britshText: """IpaUK: /ɡliːn/""",
                      americanText: """IpaUS: /ɡliːn/""",
...
// With short examples define "glean", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) بەدەستهێنانی زانیاری، هتد، زۆرجار بە سەختی و لە شوێنی جیاوازەوە"""),
                    SentencesRow(
                      englishText:
                          """These figures have been gleaned from a number of studies.""",
                      kurdishText:
                          """ئەم ئامارانە لە ژمارەیەک توێژینەوەوە وەرگیردراون.""",
...
const double _startSecondsend = 0000000000000000000000000001095;
const String _videoIdone = 'https://youtu.be/CiHUcQG7bH4?t=';
const double _startSecondsone = 000000000000000000000000000116;
const String _videoIdtwo = 'https://youtu.be/lNlKKB_p-4s?t=';
const double _startSecondstwo = 00000000000000000000000000077;
const String _videoIdthree = 'https://youtu.be/xMa7EGVRiak?t=';
const double _startSecondsthree = 000000000000000000000000000301;
const String _videoIdfour = 'https://youtu.be/4aAy2KGHX0w?t=';
const double _startSecondsfour = 000000000000000000000000000245;
const String _videoIdfive = 'https://youtu.be/axiYo61XRRw?t=';
const double _startSecondsfive = 0000000000000000000000000001548;
