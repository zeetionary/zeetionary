...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'https://youtu.be/4_X6EyqXa2s?t=';
    const double startSecondstwo = 00000000000000000000000000069;
    const String videoIdthree = 'https://youtu.be/RXXMJAU6vY8?t=';
    const double startSecondsthree = 0000000000000000000000000001551;
    const String videoIdfour = 'https://youtu.be/4l8M3dQlUwg?t=';
    const double startSecondsfour = 00000000000000000000000000040;
    const String videoIdfive = 'https://youtu.be/qkYoBNdcXBU?t=';
    const double startSecondsfive = 000000000000000000000000000895;
