...
class EnglishEntryharsh extends StatefulWidget {
  const EnglishEntryharsh({super.key});

  @override
  State<EnglishEntryharsh> createState() => _EnglishEntryharshState();
}

class _EnglishEntryharshState extends State<EnglishEntryharsh> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: harsh (Derived forms: harshed, harshing, harshes)
1. Of textures that are rough to the touch or substances consisting of relatively large particles (- coarse)
"harsh meal";
 
2. Unpleasantly stern (- rough)
...
4. Unkind, cruel or uncivil (- rough)
"had harsh words"; "a harsh and unlovable old tyrant";
 
5. Severe
"a harsh penalty"
 
6. Sharply disagreeable; rigorous (- abrasive)
"the harsh facts of court delays";

- Verb: harsh (Derived forms: harshed, harshing, harshes)
Usage: N. Amer, informal
1. Criticize harshly (- harsh on [N. Amer, informal], dis [informal], diss [informal])
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The punishment was harsh and unfair.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The minister received some harsh criticism.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He regretted his harsh words.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They've painted the walls with harsh bright colours.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""‘Stop it!’ she said in a harsh voice.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Ordinary soap can be too harsh for delicate skin.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harsh""",
                      // alsoEnglishWord: "also: harsh",
                      britshText: """IpaUK: /hɑːʃ/""",
                      americanText: """IpaUS: /hɑːrʃ/""",
...
"""),
// With short examples define "harsh", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) توند و نامیهرەبانانە"""),
                    SentencesRow(
                      englishText: """The punishment was harsh and unfair.""",
                      kurdishText: """سزاکە توند و نادادی بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وەزیرەکە هەندێک ڕەخنەی توندی لێ گیردرا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He regretted his harsh words.""",
                      kurdishText: """پەشیمان بوویەوە لە قسە توندەکانی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """We had to face up to the harsh realities of life sooner or later.""",
                      kurdishText:
                          """دەبوو ڕووبەڕووی ڕاستییە تاڵەکانی ژیان ببینەوە زوو یان درەنگ.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) کەشێکی سەخت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Many of the prisoners died during the harsh winter of 1683.""",
                      kurdishText:
                          """زۆرێک لە زیندانییەکان لە زستانە سەختەکەی ١٦٨٣ ــدا مردن.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ھاوەڵناو) زۆر بەهێز و ڕۆشن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """For a moment she was blinded by the harsh glare of the sun.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دیوارەکانیان بە ڕەنگی ڕۆشنی بەهێز بۆیە کردووە.""",
                      onPressedBritish: () => speaksentence8("en-GB"),
                      onPressedAmerican: () => speaksentence8("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (ھاوەڵناو) کە ناخۆشە بۆ گوێگرتن لێی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """‘Stop it!’ she said in a harsh voice.""",
                      kurdishText: """بە دەنگێکی ناخۆش گوتی 'بەسیکە!'""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٥. (ھاوەڵناو) زۆر بەهێز کە دەکرێت زیانبەخش بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Ordinary soap can be too harsh for delicate skin.""",
                      kurdishText:
                          """سابوونی ئاسایی دەکرێت توند بێت بۆ پێستی هەستیار.""",
...
const double _startSecondsthree = 0000000000000000000000000001011;
const String _videoIdfour = 'https://youtu.be/dfuPBC-v5NE?t=';
const double _startSecondsfour = 000000000000000000000000000501;
const String _videoIdfive = 'https://youtu.be/RR_JOLFJmgM?t=';
