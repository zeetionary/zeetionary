...
class EnglishEntryferment extends StatefulWidget {
  const EnglishEntryferment({super.key});

  @override
  State<EnglishEntryferment> createState() => _EnglishEntryfermentState();
}

class _EnglishEntryfermentState extends State<EnglishEntryferment> {
  @override
  void initState() {
    super.initState();
...
2. Go sour or spoil (= sour, turn, work)
"The milk has fermented";
 
3. Be in an agitated or excited state
...
2. [archaic] A substance capable of bringing about fermentation
""",
  );

  final String keyword = "ferment";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""ferment""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Fruit juices ferment if they are kept for too long.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Red wine is fermented at a higher temperature than white.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The country is in ferment.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ferment""",
                      // alsoEnglishWord: "also: ferment",
                      britshText: """IpaUK: /fəˈment/""",
                      americanText: """IpaUS: /fərˈment/""",
...
// With short examples define "ferment", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شەرابی سوور لە پلەیەکی گەرمی بەرزتر ئامادە دەکرێت وەک لە شەرابی سپی.""",
...
const String _videoIdend = 'https://youtu.be/Fr-qagv7ig0?t=';
const double _startSecondsend = 000000000000000000000000000522;
const String _videoIdone = 'https://youtu.be/iN8zmmCRqUA?t=';
const double _startSecondsone = 000000000000000000000000000323;
const String _videoIdtwo = 'https://youtu.be/dRLCZqEfJFA?t=';
const double _startSecondstwo = 00000000000000000000000000089;
const String _videoIdthree = 'https://youtu.be/-gal8E_dgE8?t=';
const double _startSecondsthree = 000000000000000000000000000594;
const String _videoIdfour = 'https://youtu.be/NM4ArR-qbHQ?t=';
const double _startSecondsfour = 000000000000000000000000000165;
const String _videoIdfive = 'https://youtu.be/ihwAF-zahsA?t=';
const double _startSecondsfive = 000000000000000000000000000372;
