...
// blank divider
  ...
  Future<void> speakblindfold(String languageCode) async {
    ...
    await flutterTts.speak("blindfold");
  }
  ...
  Future<void> speakblindfolds1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("She used a scarf as a blindfold.");
  }
  ...
  Future<void> speakblindfolds3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("The reporter was taken blindfold to a secret location.");
  }
  ...
  Future<void> speakblindfolds4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("I knew the way home blindfold.");
  }
  ...
  Future<void> speakblindfolds5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("speakblindfolds55");
  }
  ...
  Future<void> speakblindfolds6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("speakblindfolds66");
  }
  ...
  Future<void> speakblindfolds7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("speakblindfolds77");
  }
...
"""),
                          ...
                          SentencesRow(
                            englishText: "She used a scarf as a blindfold.",
                            kurdishText: "لەچکێکی وەک چاوبەست بەکارھێنا.",
                            onPressedBritish: () => speakblindfolds1("en-GB"),
                            onPressedAmerican: () => speakblindfolds1("en-US"),
                          ),
                          const DividerDefinition(),
                          const DefinitionKurdish(
                              text:
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakblindfolds2("en-GB"),
                            onPressedAmerican: () => speakblindfolds2("en-US"),
                          ),
                          const DividerDefinition(),
                          const DefinitionKurdish(
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakblindfolds3("en-GB"),
                            onPressedAmerican: () => speakblindfolds3("en-US"),
                          ),
                          const DividerSentences(),
                          SentencesRow(
                            englishText:
                                "I knew the way home blindfold (= because it was so familiar).",
                            kurdishText: "ڕێگای ماڵەوەم بە چاوبەستراوی دەزانی.",
                            onPressedBritish: () => speakblindfolds4("en-GB"),
                            onPressedAmerican: () => speakblindfolds4("en-US"),
                          ),
                        ],
                      ),
                    ),
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'U8L0NlstyhU';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'vfvaWZj5tys';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'ELYyCw6Ywr8';
