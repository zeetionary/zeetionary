...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/MqyJZsGFZ3M?t=';
    const double startSecondsend = 000000000000000000000000000349;
    const String videoIdone = 'https://youtu.be/s3B-qp3U5G0?t=';
    const double startSecondsone = 00000000000000000000000000076;
    ...
    const double startSecondsthree = 0000000000000000000000000001238;
    const String videoIdfour = 'https://youtu.be/qr4MSVxfYBE?t=';
    const double startSecondsfour = 000000000000000000000000000626;
    const String videoIdfive = 'https://youtu.be/hS2emKDlGmE?t=';
    const double startSecondsfive = 0000000000000000000000000001347;
