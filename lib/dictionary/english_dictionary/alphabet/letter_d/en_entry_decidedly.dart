...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakdecidedlys1(String languageCode) async {
    ...
    await flutterTts.speak(
        "// speakdecidedlys111111111111111111111111111111111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakdecidedlys2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakdecidedlys200"); // DOPSUM: CHANGE TEXT
  }
...
"""),
                ...
                child: Column(
                  children: [
                    ExampleSentenceEnglish(
                        text:
                            "// speakdecidedlys111111111111111111111111111111111"),
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdecidedlys200"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
