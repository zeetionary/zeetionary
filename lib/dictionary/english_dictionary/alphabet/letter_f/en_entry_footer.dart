...
class EnglishEntryfooter extends StatefulWidget {
  const EnglishEntryfooter({super.key});

  @override
  State<EnglishEntryfooter> createState() => _EnglishEntryfooterState();
}

class _EnglishEntryfooterState extends State<EnglishEntryfooter> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: footer (Derived forms: footers)
...
2. A person who travels by foot (= pedestrian, walker)
 
3. A printed note placed below the text on a printed page (= footnote)
""",
  );

  final String keyword = "footer";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The footer gives the page number of the document.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""You can repeat the navigation links in the footer.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His boat is an eighteen-footer.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """footer""",
                      // alsoEnglishWord: "also: footer",
                      britshText: """IpaUK: /ˈfʊtə(r)/""",
                      americanText: """IpaUS: /ˈfʊtər/""",
...
کوردی: پێڕەو، پیادەڕۆ، پیادهڕێ
"""),
// With short examples define "footer", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) نووسراوێک کە لە بەشی خوارەوەی هەموو پەڕەیەک دەردەکەوێت کە لە کۆمپیوتەرێک چاپکراوە"""),
                    SentencesRow(
                      englishText:
                          """The footer gives the page number of the document.""",
                      kurdishText:
                          """پێپەڕە ژمارەی لاپەڕەی بەڵگەنامەکە دەدات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) هێڵێک لە خوارەوەی وێبسایتێک لەسەر ئینتەرنێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """You can repeat the navigation links in the footer.""",
                      kurdishText:
                          """دەتوانیت بەستەرەکانی ڕێدۆزی لە بەشی خوارەوە دووبارە بکەیتەوە.""",
                      englishNote:
                          "This means you can place the same navigation links at the bottom of the webpage as you have in other parts of the site, allowing users to easily access them from different sections.",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بەلەمەکەی هەژدە پێییەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/aoXJfuPaFF8?t=';
const double _startSecondsend = 0000000000000000000000000001339;
const String _videoIdone = 'https://youtu.be/qjubq284yVk?t=';
const double _startSecondsone = 000000000000000000000000000170;
const String _videoIdtwo = 'https://youtu.be/WihpfXxGOBo?t=';
const double _startSecondstwo = 0000000000000000000000000001442;
const String _videoIdthree = 'https://youtu.be/hDWwa4grA0M?t=';
const double _startSecondsthree = 000000000000000000000000000299;
const String _videoIdfour = 'https://youtu.be/0fWdU8JCT6Y?t=';
const double _startSecondsfour = 000000000000000000000000000426;
const String _videoIdfive = 'https://youtu.be/2p3NIR8LYoo?t=';
