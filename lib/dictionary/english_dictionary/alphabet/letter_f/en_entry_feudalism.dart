...
class EnglishEntryfeudalism extends StatefulWidget {
  const EnglishEntryfeudalism({super.key});

  @override
  State<EnglishEntryfeudalism> createState() => _EnglishEntryfeudalismState();
}

class _EnglishEntryfeudalismState extends State<EnglishEntryfeudalism> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "feudalism";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""feudalism""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """feudalism""",
                      // alsoEnglishWord: "also: feudalism",
                      britshText: """IpaUK: /ˈfjuːdəlɪzəm/""",
                      americanText: """IpaUS: /ˈfjuːdəlɪzəm/""",
...
کوردی: فیوداڵیزم، دەرەبەگایەتی، سیستم یان ڕێکخستەی فیوداڵی، خان‌خانی
"""),
// With short examples define "feudalism", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) سیستەمی دەرەبەگایەتی ئەورووپا کە تێیدا خەڵکی زەوییان لەلایەن کەسێکی خانەدانەوە پێدەدرا و لە بەرامبەردا دەبوو شەڕی بۆ بکەن"""),
                    SentencesRow(
                      englishText:
                          """Land reform was the only way of ensuring an end to feudalism.""",
                      kurdishText:
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/YJQSuUZdcV4?t=';
const double _startSecondsend = 00000000000000000000000000013;
const String _videoIdone = 'https://youtu.be/hSNWkRw53Jo?t=';
const double _startSecondsone = 0000000000000000000000000003284;
const String _videoIdtwo = 'https://youtu.be/dG3XfkVIAA8?t=';
const double _startSecondstwo = 00000000000000000000000000096;
const String _videoIdthree = 'https://youtu.be/1rzFyBdKLvU?t=';
const double _startSecondsthree = 000000000000000000000000000469;
const String _videoIdfour = 'https://youtu.be/ynbgMKclWWc?t=';
const double _startSecondsfour = 000000000000000000000000000576;
const String _videoIdfive = 'https://youtu.be/T1uNZvZg72o?t=';
const double _startSecondsfive = 0000000000000000000000000001161;
