...
class EnglishEntryinsipidly extends StatefulWidget {
  const EnglishEntryinsipidly({super.key});

  @override
  State<EnglishEntryinsipidly> createState() => _EnglishEntryinsipidlyState();
}

class _EnglishEntryinsipidlyState extends State<EnglishEntryinsipidly> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insipidly""");
  }
