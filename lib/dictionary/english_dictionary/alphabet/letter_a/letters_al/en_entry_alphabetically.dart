...
// replace these: replace EnglishEntryalphabetically - replace speakAlphabetically - replace alphabetically - /ˌælfəˈbetɪkli/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryalphabetically extends StatelessWidget {
  ...
  Future<void> speakalphabetically(String languageCode) async {
    ...
    await flutterTts.speak("alphabetically");
  }
  ...
  Future<void> speakalphabetically548(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The names of the contest winners are listed alphabetically.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌælfəˈbetɪkli/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌælfəˈbetɪkli/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'vXsutlz0GIQ';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'yQhC1Kfrs3o';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'ED0b0E6xUL8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'IqgyBN0OIns';
