...
class EnglishEntryexclusion extends StatefulWidget {
  const EnglishEntryexclusion({super.key});

  @override
  State<EnglishEntryexclusion> createState() => _EnglishEntryexclusionState();
}

class _EnglishEntryexclusionState extends State<EnglishEntryexclusion> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exclusion""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exclusion""",
                      // alsoEnglishWord: "also: exclusion",
                      britshText: """IpaUK: /ɪkˈskluːʒn/""",
                      americanText: """IpaUS: /ɪkˈskluːʒn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exclusion";
...
کوردی: ڕێ(گە)نەدان، نەهێشتن، پێش‌گرتن، بەرگرتن، بەرگیری، ڕێ‌لێ‌گرتن، لەدەرەوە ڕاگرتن،	ڕێ‌گرتن لە هاتنەژوورەوە، قەدەغەکردن، دەرکردن، وەدەرنان، دەرپەڕاندن، پەڕکردن، پاتراندن، خستنەدەرەوە،	بێ‌بەری، بێ‌بەشی، بێ‌بەش‌کردن، بێ‌بەری‌کردن،	هەڵاواردن، ئاوارتە،	لابردن،	لەبەرچاونەگرتن، گوێ‌پێ‌نەدان
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ڕێگرتن لە کەسێک لەوەی بچێتە شوێنێکەوە یان شتێک بکات"""),
          SentencesRow(
            englishText:
                """He was disappointed with his exclusion from the England squad.""",
            kurdishText:
                """نائومێد بوو بە بانگهێشت نەکردنی بۆ تیمی ئینگلتەرە.""",
          ...
          SentencesRow(
            englishText:
                """Memories of the past filled her mind to the exclusion of all else.""",
            kurdishText:
                """یادەوەریی ڕابردوو زیاتر لە هەر شتێکی دیکە مێشکی داگیر کرد.""",
          ...
          SentencesRow(
            ...
            kurdishText: """سەیری لیستی لەخۆنەگتنەکان بکە لە سیاسەتی بیمەکە.""",
          ...
          SentencesRow(
            englishText:
                """The police announced the exclusion of robbery as a motive.""",
            kurdishText: """پۆلیس ڕەتکردنەوەی دزی وەک پاڵنەرێک ڕاگەیاند.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: exclusion (Derived forms: exclusions)
1. The state of being excluded
 
2. The state of being excommunicated (= excommunication, censure)
 
3. A deliberate act of omission (= exception, elision)
"with the exclusion of the children, everyone was told the news";
 
4. The act of forcing out someone or something (= ejection, expulsion, riddance)
"the exclusion of troublemakers by the police";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/qqZ_SH9N3Xo?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1662;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/tILIeNjbH1E?t=';
const double _startSecondsone = 00000000000000000000000000000; // 371;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/P8A4ivmCCk4?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 640;
const String _videoIdthree = 'VIDEOhttps://youtu.be/YJQSuUZdcV4?t=';
const double _startSecondsthree = 000000000000000000000000000; // 3192;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/tkD6QfeRil8?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 794;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/6akmv1bsz1M?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 604;
