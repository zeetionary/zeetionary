...
class EnglishEntryhymn extends StatefulWidget {
  const EnglishEntryhymn({super.key});

  @override
  State<EnglishEntryhymn> createState() => _EnglishEntryhymnState();
}

class _EnglishEntryhymnState extends State<EnglishEntryhymn> {
  @override
  void initState() {
    super.initState();
