...
class EnglishEntryindolence extends StatefulWidget {
  const EnglishEntryindolence({super.key});

  @override
  State<EnglishEntryindolence> createState() => _EnglishEntryindolenceState();
}

class _EnglishEntryindolenceState extends State<EnglishEntryindolence> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: indolence (Derived forms: indolences)
1. Inactivity resulting from a dislike of work (- laziness)
""",
  );

  final String keyword = "indolence";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indolence""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""My failure is probably due to my own indolence.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/Gfj5f0GVLZ0?t=';
    const double startSecondsend = 000000000000000000000000000548;
    const String videoIdone = 'https://youtu.be/VeBX4WjhhXs?t=';
    const double startSecondsone = 0000000000000000000000000002286;
    const String videoIdtwo = 'https://youtu.be/5c_YoU0Kdvk?t=';
    const double startSecondstwo = 000000000000000000000000000422;
    const String videoIdthree = 'https://youtu.be/0O2Rq4HJBxw?t=';
    const double startSecondsthree = 0000000000000000000000000002920;
    const String videoIdfour = 'https://youtu.be/9CaEat3ojNo?t=';
    const double startSecondsfour = 00000000000000000000000000092;
    const String videoIdfive = 'https://youtu.be/KVvPss1W450?t=';
    const double startSecondsfive = 0000000000000000000000000001430;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indolence""",
                      // alsoEnglishWord: "also: indolence",
                      britshText: """IpaUK: /ˈɪndələns/""",
                      americanText: """IpaUS: /ˈɪndələns/""",
...
کوردی: تەمەڵی، داهێزراوی، تەپی، داوەشاوی، لەش‌گرانی، تەوەزەلی، سستی
"""),
// With short examples define "indolence", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) هەستی ئەوەی نەتەوێت کار بکەیت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: laziness"),
                    SentencesRow(
                      englishText:
                          """My failure is probably due to my own indolence.""",
                      kurdishText: """شکستەکەم ڕەنگە بەهۆی تەمەڵیم بووبێت.""",
