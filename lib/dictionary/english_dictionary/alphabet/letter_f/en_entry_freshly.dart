...
class EnglishEntryfreshly extends StatefulWidget {
  const EnglishEntryfreshly({super.key});

  @override
  State<EnglishEntryfreshly> createState() => _EnglishEntryfreshlyState();
}

class _EnglishEntryfreshlyState extends State<EnglishEntryfreshly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: freshly
1. Very recently (= newly, fresh, new)
"a freshly cleaned floor";
 
2. [informal] In an impudent or impertinent manner (= impertinently, saucily [informal], pertly, impudently)
""",
  );

  final String keyword = "freshly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""freshly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She had had her hair freshly washed and styled.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """freshly""",
                      // alsoEnglishWord: "also: freshly",
                      britshText: """IpaUK: /ˈfreʃli/""",
                      americanText: """IpaUS: /ˈfreʃli/""",
...
// With short examples define "freshly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) شتێک کە تازە درووستکراوە، ئامادەکراوە، هتد"""),
                    SentencesRow(
                      englishText:
                          """She had had her hair freshly washed and styled.""",
                      kurdishText: """تازەگی قژی شۆردبوو و ڕێکی خستبوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Rzd0mLf366I?t=';
const double _startSecondsend = 00000000000000000000000000062;
const String _videoIdone = 'https://youtu.be/roCX0AfBseQ?t=';
...
const String _videoIdthree = 'https://youtu.be/kTaYet07Ioo?t=';
const double _startSecondsthree = 0000000000000000000000000001064;
const String _videoIdfour = 'https://youtu.be/7aIS-SLQmOk?t=';
const double _startSecondsfour = 000000000000000000000000000320;
const String _videoIdfive = 'https://youtu.be/v3ohyHjJy3M?t=';
