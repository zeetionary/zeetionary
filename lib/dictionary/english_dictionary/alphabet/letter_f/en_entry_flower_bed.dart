...
class EnglishEntryflowerbed extends StatefulWidget {
  const EnglishEntryflowerbed({super.key});

  @override
  State<EnglishEntryflowerbed> createState() => _EnglishEntryflowerbedState();
}

class _EnglishEntryflowerbedState extends State<EnglishEntryflowerbed> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flowerbed (Derived forms: flowerbeds, flower beds)
1. A bed in which flowers are growing (= flower bed, bed of flowers)
""",
  );

  final String keyword = "flower bed";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flower bed""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The flower bed was filled with tulips and daffodils.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flower bed""",
                      // alsoEnglishWord: "also: flower bed",
                      britshText: """IpaUK: /ˈflaʊə bed/""",
                      americanText: """IpaUS: /ˈflaʊər bed/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پارچە زەوییەک کە گوڵی تێدا دەچێنرێت"""),
                    SentencesRow(
                      englishText:
                          """The flower bed was filled with tulips and daffodils.""",
                      kurdishText: """گوڵستانەکە پڕ لە گوڵباخ و نێرگز بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/YZkXDuKto_Y?t=';
const double _startSecondsend = 000000000000000000000000000875;
const String _videoIdone = 'https://youtu.be/Q2L-bZiqckM?t=';
const double _startSecondsone = 000000000000000000000000000714;
const String _videoIdtwo = 'https://youtu.be/EFJjYnfjWyM?t=';
const double _startSecondstwo = 00000000000000000000000000037;
const String _videoIdthree = 'https://youtu.be/gM_Jm_6tqEQ?t=';
const double _startSecondsthree = 000000000000000000000000000147;
const String _videoIdfour = 'https://youtu.be/3denP7wX2XU?t=';
const double _startSecondsfour = 00000000000000000000000000046;
const String _videoIdfive = 'https://youtu.be/GxneUVJLuxE?t=';
const double _startSecondsfive = 000000000000000000000000000494;
