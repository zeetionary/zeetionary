...
class EnglishEntryinfrared extends StatefulWidget {
  const EnglishEntryinfrared({super.key});

  @override
  State<EnglishEntryinfrared> createState() => _EnglishEntryinfraredState();
}

class _EnglishEntryinfraredState extends State<EnglishEntryinfrared> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infrared""");
  }
