...
class EnglishEntrygranule extends StatefulWidget {
  const EnglishEntrygranule({super.key});

  @override
  State<EnglishEntrygranule> createState() => _EnglishEntrygranuleState();
}

class _EnglishEntrygranuleState extends State<EnglishEntrygranule> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: granule (Derived forms: granules)
1. A tiny grain
""",
  );

  final String keyword = "granule";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""granule""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She added coffee granules to her cup.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """granule""",
                      // alsoEnglishWord: "also: granule",
                      britshText: """IpaUK: /ˈɡrænjuːl/""",
                      americanText: """IpaUS: /ˈɡrænjuːl/""",
...
کوردی: دەنک، دانە، دەنکۆڵە
"""),
// With short examples define "granule", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) دەنکێکی بچووکی سەخت"""),
                    SentencesRow(
                      englishText: """She added coffee granules to her cup.""",
                      kurdishText: """دەنکە قاوەی کردە کووپەکەیەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/YZoZr_m9WLU?t=';
const double _startSecondsend = 000000000000000000000000000487;
const String _videoIdone = 'https://youtu.be/EF-9I38ud4s?t=';
const double _startSecondsone = 00000000000000000000000000038;
const String _videoIdtwo = 'https://youtu.be/__qtH1ly2Sg?t=';
const double _startSecondstwo = 000000000000000000000000000420;
const String _videoIdthree = 'https://youtu.be/wv43IN_cnyw?t=';
const double _startSecondsthree = 000000000000000000000000000269;
const String _videoIdfour = 'https://youtu.be/1R5uPaL0V-0?t=';
const double _startSecondsfour = 000000000000000000000000000252;
