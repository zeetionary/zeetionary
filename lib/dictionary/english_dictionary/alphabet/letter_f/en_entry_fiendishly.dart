...
class EnglishEntryfiendishly extends StatefulWidget {
  const EnglishEntryfiendishly({super.key});

  @override
  State<EnglishEntryfiendishly> createState() => _EnglishEntryfiendishlyState();
}

class _EnglishEntryfiendishlyState extends State<EnglishEntryfiendishly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: fiendishly
1. As a devil; in an evil manner (= diabolically, devilishly)
"his writing could be fiendishly satiric";
""",
  );

  final String keyword = "fiendishly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fiendishly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The murder mystery had a fiendishly clever plot.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiendishly""",
                      // alsoEnglishWord: "also: fiendishly",
                      britshText: """IpaUK: /ˈfiːndɪʃli/""",
                      americanText: """IpaUS: /ˈfiːndɪʃli/""",
...
const String _videoIdend = 'https://youtu.be/XOAOqQuMgao?t=';
const double _startSecondsend = 000000000000000000000000000470;
const String _videoIdone = 'https://youtu.be/gufZgb9ArKU?t=';
const double _startSecondsone = 00000000000000000000000000092;
const String _videoIdtwo = 'https://youtu.be/xkegkO-7-N8?t=';
const double _startSecondstwo = 00000000000000000000000000021;
const String _videoIdthree = 'https://youtu.be/XSyOOMQw1iU?t=';
const double _startSecondsthree = 000000000000000000000000000283;
const String _videoIdfour = 'https://youtu.be/dRyGiQMWi6Y?t=';
const double _startSecondsfour = 00000000000000000000000000089;
const String _videoIdfive = 'https://youtu.be/nYvnRSrlYCI?t=';
const double _startSecondsfive = 000000000000000000000000000129;
