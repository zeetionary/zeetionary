...
کوردی: تام، چێژ، مەزە،	بەهارات، کاری، هەزوێلە،	کەش، تایبەتمەندی، تام‌وبۆ، سەنگ‌وڕەنگ، ڕەنگ‌وبۆ
"""),
// With short examples define "flavour", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تامئ بەهێزترە وەک لە پەنیرەکانی دیکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ماستەکە دە تامی جیاوازی هەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The following extract gives a flavour of the poet’s later works.""",
                      kurdishText:
                          """ئەم پارچەی دواتر نموونەیەکی کارەکانی دواتری هۆنەرەکە دەدات بەدەستەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/cY4e0uvp7uI?t=';
const double _startSecondsend = 000000000000000000000000000600;
const String _videoIdone = 'https://youtu.be/5fTd1aYzNHI?t=';
...
const String _videoIdthree = 'https://youtu.be/MJFyzG0ES5g?t=';
const double _startSecondsthree = 0000000000000000000000000006;
const String _videoIdfour = 'https://youtu.be/n9XDIydPXsg?t=';
const double _startSecondsfour = 000000000000000000000000000263;
const String _videoIdfive = 'https://youtu.be/4JyhBkXMymo?t=';
