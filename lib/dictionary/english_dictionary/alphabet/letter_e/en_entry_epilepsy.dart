...
class EnglishEntryepilepsy extends StatefulWidget {
  const EnglishEntryepilepsy({super.key});

  @override
  State<EnglishEntryepilepsy> createState() => _EnglishEntryepilepsyState();
}

class _EnglishEntryepilepsyState extends State<EnglishEntryepilepsy> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""epilepsy""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """epilepsy""",
                      // alsoEnglishWord: "also: epilepsy",
                      britshText: """IpaUK: /ˈepɪlepsi/""",
                      americanText: """IpaUS: /ˈepɪlepsi/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She can't drive because she suffers from/has epilepsy.""");
  }
...
// With short examples define "epilepsy", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: فێ، پەرکەم، عەدر، سەرودڵ
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) دۆخێک کە کەسێک تووشی دەبیت کە وا دەکات لەناکاو لەهۆش بچێت، زۆرجار بە جووڵەی توندی جەستەوە"""),
          SentencesRow(
            englishText:
                """She can't drive because she suffers from/has epilepsy.""",
            kurdishText: """ناتوانێت شۆفێری بکات چوونکە تووشبووی پەرکەمە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: epilepsy (Derived forms: epilepsies)
...
const double _startSecondsend = 000000000000000000000000000000; // 1299;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/1KgSp94nCZw?t=';
const double _startSecondsone = 00000000000000000000000000000; // 185;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/BuX6-lvUwd0?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 126;
const String _videoIdthree = 'VIDEOhttps://youtu.be/CeoYBYth9UA?t=';
const double _startSecondsthree = 000000000000000000000000000; // 188;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/02_I4tToeLo';
const double _startSecondsfour = 000000000000000000000000000000; // 0;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/OScBxa6FpCk?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 23;
