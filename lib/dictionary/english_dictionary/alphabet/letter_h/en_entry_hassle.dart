...
class EnglishEntryhassle extends StatefulWidget {
  const EnglishEntryhassle({super.key});

  @override
  State<EnglishEntryhassle> createState() => _EnglishEntryhassleState();
}

class _EnglishEntryhassleState extends State<EnglishEntryhassle> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hassle (Derived forms: hassles)
Usage: informal
1. Something annoying or fiddly that takes some time to do (- faff [Brit, informal], bother)
"it was a bit of a hassle";
 
2. An angry disturbance (- fuss, trouble, bother, stink [informal], shindy [informal])
 
3. Disorderly fighting (- scuffle, tussle, dogfight, rough-and-tumble)

- Verb: hassle (Derived forms: hassled, hassling, hassles)
Usage: informal
1. Annoy or hinder continually or in many ways (- harass, harry, chivy, chivvy, chevy, chevvy [non-standard], beset, plague, molest, provoke)
"This man hassles his female co-workers";
""",
  );

  final String keyword = "hassle";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It’s a hassle having to travel with so many bags.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Send them an email—it's a lot less hassle than phoning.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Do as you're told and don't give me any hassle!""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Try not to get into a hassle with this guy.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Don't keep hassling me! I'll do it later.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Your brother’s been hassling me for cash.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hassle""",
                      // alsoEnglishWord: "also: hassle",
                      britshText: """IpaUK: /ˈhæsl/""",
                      americanText: """IpaUS: /ˈhæsl/""",
...
کوردی: شەڕەقسە، مشت‌ومڕ، دمێ‌دمێ، شەڕەچەلەحانێ،	بەڵا، کێشە، دژواری، کێشمەکێش
"""),
// With short examples define "hassle", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دۆخێکی ناخۆش کە شتێکی سەخت یان ئاڵۆز لەخۆدەگرێت کە هەوڵی زۆری دەوێت"""),
                    SentencesRow(
                      englishText:
                          """It’s a hassle having to travel with so many bags.""",
                      kurdishText:
                          """کێشەیەکە کە بەم هەموو جانتایەوە گەشت بکەیت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئیمەیڵێک بنێرە ـ دژوارییەکی زۆر کەمە وەک لە پەیوەندی کردن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) دۆخێک کە تێیدا خەڵکی مشتومڕیانە یان کێشەیان هەیە"""),
                    SentencesRow(
                      englishText:
                          """Do as you're told and don't give me any hassle!""",
                      kurdishText:
                          """ئەوە بکە کە پێت دەگوترێت و هیچ مناقەشە مەکە!""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەوڵ بدە نەکەویتە دەمەدەم لەگەڵ ئەم پیاوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) بێزارکردنی کەسێک یان درووستکردنی کێشە بۆی"""),
                    const AlsoEnglishckb(word: "ھەروەھا: bother"),
                    SentencesRow(
                      englishText:
                          """Don't keep hassling me! I'll do it later.""",
                      kurdishText: """سەرمەخەسەرم! دواتر دەیکەم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """براکەت بێزاری کردووم بە پارە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Oj4ueoyfpeU?t=';
const double _startSecondsend = 000000000000000000000000000171;
...
const double _startSecondstwo = 000000000000000000000000000890;
const String _videoIdthree = 'https://youtu.be/-RjJtO51ykY?t=';
const double _startSecondsthree = 000000000000000000000000000573;
const String _videoIdfour = 'https://youtu.be/K0c94ghBS4A?t=';
const double _startSecondsfour = 000000000000000000000000000352;
const String _videoIdfive = 'https://youtu.be/BGLZoBFKvNk?t=';
