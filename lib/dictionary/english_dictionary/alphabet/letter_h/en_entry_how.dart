...
class EnglishEntryhow extends StatefulWidget {
  const EnglishEntryhow({super.key});

  @override
  State<EnglishEntryhow> createState() => _EnglishEntryhowState();
}

class _EnglishEntryhowState extends State<EnglishEntryhow> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: how
1. In what way or manner or by what means (- however)
"how did you catch the snake?"; "he told us how he did it";
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How does it work?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He did not know how he ought to behave.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'll show you how to load the software.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How ever did you get here so quickly?""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How are you?""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How are you feeling now?""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Hey, how are you doing?""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How was your trip?""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How did they play?""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How often do you go swimming?""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I didn't know how much to bring.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How much are those earrings?""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How many people were there?""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How old is she?""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How kind of you to help!""");
  }
  ...
  Future<void> speaksentence18(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""How he wished he had been there!""");
  }
  ...
  Future<void> speaksentence19(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'll dress how I like in my own house!""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'https://youtu.be/F5T2-u5WJH8?t=';
    const double startSecondstwo = 00000000000000000000000000087;
    const String videoIdthree = 'https://youtu.be/ZuYTtKZUkJc?t=';
    const double startSecondsthree = 000000000000000000000000000796;
    const String videoIdfour = 'https://youtu.be/VrKW58MS12g?t=';
    const double startSecondsfour = 00000000000000000000000000035;
    const String videoIdfive = 'https://youtu.be/DPZzrlFCD_I?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """how""",
                      // alsoEnglishWord: "also: how",
                      britshText: """IpaUK: /haʊ/""",
                      americanText: """IpaUS: /haʊ/""",
...
// With short examples define "how", please follow LX instructions
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """How ever did you get here so quickly?""",
                      kurdishText: """چۆن هێندە بە خێرایی گەشتیتە ئێرە؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """How are you feeling now?""",
                      kurdishText: """هەستت چۆنە ئێستا؟""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Hey, how are you doing?""",
                      kurdishText: """سڵاو، دۆخت چۆنە؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """How did they play?""",
                      kurdishText: """چۆن یارییان کرد؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I didn't know how much to bring.""",
                      kurdishText: """نەمدەزانی چەند بهێنم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """How many people were there?""",
                      kurdishText: """چەند کەس لەوێ بوون؟""",
                      onPressedBritish: () => speaksentence15("en-GB"),
                      onPressedAmerican: () => speaksentence15("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """How old is she?""",
                      kurdishText: """تەمەنی چەندە؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """How he wished he had been there!""",
                      kurdishText: """چەندە ئاواتی دەخواست لەوێ ببایە.""",
