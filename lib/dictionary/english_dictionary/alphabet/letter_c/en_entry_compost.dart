...
class EnglishEntrycompost extends StatelessWidget {
// blank divider
  EnglishEntrycompost({super.key});
// blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "compost"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈkɒmpɒst/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcompost("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈkɑːmpəʊst/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcompost("en-US"),
                            ),
                          ],
                        ),
                      ],
...
کوردی: پەیینک(لێکدراو یان تێکەڵ)، پیتێنە (بەتایبەت لە گەڵای دار)
"""),
...
class _YoutubeEmbeddedendState extends State<YoutubeEmbeddedend> {
  ...
  final String _videoId = 'dFqV7ThF4TI';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '_xjvnaWw1qE';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '_hw61fYnx1I';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'weeXffl4VOA';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '6nVnKMoPgl4';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'PWrxXkE_s3M';
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  late YoutubePlayerController _controller;
  final String _videoId = 'q7LnBpJkuhs';
