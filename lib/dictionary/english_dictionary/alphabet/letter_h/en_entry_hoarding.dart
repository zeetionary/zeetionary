...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/4fxRniPGn5k?t=';
    const double startSecondsend = 000000000000000000000000000505;
    const String videoIdone = 'https://youtu.be/TjUKjrg--OI?t=';
    const double startSecondsone = 000000000000000000000000000835;
    const String videoIdtwo = 'https://youtu.be/vSm19OlSZTk?t=';
    const double startSecondstwo = 00000000000000000000000000013991;
    const String videoIdthree = 'https://youtu.be/JdDEawcFq3Q?t=';
    const double startSecondsthree = 0000000000000000000000000001139;
    const String videoIdfour = 'https://youtu.be/PWjEwV48rbg?t=';
    const double startSecondsfour = 000000000000000000000000000576;
    const String videoIdfive = 'https://youtu.be/PsKYHVzp8ps?t=';
