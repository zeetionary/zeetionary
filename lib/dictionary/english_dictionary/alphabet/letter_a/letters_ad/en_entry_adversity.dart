...
// replace these: replace EnglishEntryadversity - replace speakAdversity - replace adversity - /ədˈvɜːrsəti/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadversity extends StatelessWidget {
  EnglishEntryadversity({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "adversity", // DOPSUM: CHANGE WORD ENTRY - Find /ədˈvɜːsəti/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ədˈvɜːsəti/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ədˈvɜːrsəti/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'NfpXeLVzJIw';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'THwTUsF0yQQ';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'RSyHWuVHuzk';
