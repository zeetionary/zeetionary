...
class EnglishEntrylimit extends StatefulWidget {
  const EnglishEntrylimit({super.key});

  @override
  State<EnglishEntrylimit> createState() => _EnglishEntrylimitState();
}

class _EnglishEntrylimitState extends State<EnglishEntrylimit> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: limit (Derived forms: limited, limiting, limits)
1. Place limits on (extent, amount or access) (- restrict, trammel, bound, confine, throttle)
"limit the time you can spend with your friends";
 
2. Restrict or confine within limits (- circumscribe, confine to)
"I limit you to two visits to the pub a day";
 
3. Decide upon definitely; give a value (- specify, set, determine, define, fix)
"limit the parameters";

 -Noun: limit (Derived forms: limits)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His speed was double the legal limit.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Do not exceed the recommended limit of 6g of salt per day.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The EU has set strict limits on levels of pollution.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Banks may import currency without limit.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They called for a limit on the use of pesticides.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She knew the limits of her power.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His arrogance knew no limits.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There is a limit to the amount of pain we can bear.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I knew I had reached my limit and couldn't do any more.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We were reaching the limits of civilization.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There was no school within a limit of ten miles.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Let us wonder what stops at the limits of the universe.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The amount of money you have to spend will limit your choice.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Try to limit the number of trips you make.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You can use any material available—why limit yourself?""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I've limited myself to 1 000 calories a day to try and lose weight.""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Families are limited to four free tickets each.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/qw8Tkmxk5Hs?t=89';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/BDvjjQvM498?t=153';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/hBIwamP7ygY?t=263';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/vQSkLuEOdMM?t=105';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/gqe-oAUoEto?t=120';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/5VmWe3LyUDM?t=43';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """limit""",
                      // alsoEnglishWord: "also: limit",
                      britshText: """IpaUK: /ˈlɪmɪt/""",
                      americanText: """IpaUS: /ˈlɪmɪt/""",
...
کوردی: ڕادە، ئەندازە، سنوور، تخوب،	دەوروبەر،	دیاری‌کراوی، سنوورداری، بەرتەسکی، بەرتەنگی، دواڕادە، ئەوپەڕ، زۆرترین
"""),
// With short examples define "limit", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) زۆرترین یان کەمترین بڕی ڕێگەپێدراوی شتێک کە ڕێگاپێدراوە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: restriction"),
                    SentencesRow(
                      englishText: """His speed was double the legal limit.""",
                      kurdishText: """خێراییەکەی دوو هێندەی سنووری ڕێگەپێدراو بوو.""",
                    ...
                    SentencesRow(
                      englishText: """Do not exceed the recommended limit of 6g of salt per day.""",
                      kurdishText: """سنووری پێشنیارکراوی ٦ گرامی ڕۆژانە لە خوێ تێمەپەڕێنە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The EU has set strict limits on levels of pollution.""",
                      kurdishText: """یەکێتیی ئەورووپا سنووری توندی هەیە لەسەر ئاستی پیسکردن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Banks may import currency without limit.""",
                      kurdishText: """بانکەکان ڕەنگە دراو بەبێ سنوور هاوردە بکەن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They called for a limit on the use of pesticides.""",
                      kurdishText: """داوایان کرد بۆ هەبوونی سنوورێک بۆ بەکارهێنانی مێرووکوژ.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) خاڵێک کە تێیدا شتێک چی دیکە ئەستەمە یان بوونی نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She knew the limits of her power.""",
                      kurdishText: """سنوورەکانی دەسەڵاتیی دەزانی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """His arrogance knew (= had) no limits.""",
                      kurdishText: """فیزەکەی سنووری نەبوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There is a limit to the amount of pain we can bear.""",
                      kurdishText: """سنوورێک هەیە بۆ ئاستی ئەو ئازارەی کە دەتوانین بەرگەی بگرین.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I knew I had reached my limit and couldn't do any more.""",
                      kurdishText: """دەمزانی سنوورمم تێپەڕاندووە و نەمدەتوانی هیچی دیکە بکەم.""",
                      onPressedBritish: () => speaksentence9("en-GB"),
                      onPressedAmerican: () => speaksentence9("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) ئەوپەڕی ناوچەیەک یان شوێنێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We were reaching the limits of civilization.""",
                      kurdishText: """دەگەشتین بە سنوورەکانی شارستانییەت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There was no school within a limit of ten miles.""",
                      kurdishText: """هیچ قوتابخانەیەک نەبوو لە سنووری دە میلدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Let us wonder what stops at the limits of the universe.""",
                      kurdishText: """با تێبفکرین چی دەوەستێت لە سنوورەکانی گەردووندا.""",
                      onPressedBritish: () => speaksentence12("en-GB"),
                      onPressedAmerican: () => speaksentence12("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) وەستاندنی شتێک لەوەی زیاد بکات زیاتر لە بڕ یان ئاستێکی دیاریکراو"""),
                    const AlsoEnglishckb(word: "ھەروەھا: restrict"),
                    SentencesRow(
                      englishText: """The amount of money you have to spend will limit your choice.""",
                      kurdishText: """ئەو بڕە پارەیەی کە دەبێت خەرجی بکەیت هەڵبژاردەکەت سنووردار دەکات.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Try to limit the number of trips you make.""",
                      kurdishText: """هەوڵ بدە ڕێژەی ئەو گەشتانە سنووردار بکە کە دەیانکەیت.""",
                      onPressedBritish: () => speaksentence14("en-GB"),
                      onPressedAmerican: () => speaksentence14("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (کردار) وەستاندنی خۆت یان کەسێک لە هەبوون، بەکارهێنان، یان کردنی شتێک زیاتر لە بڕێکی دیاریکراو"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """You can use any material available—why limit yourself?""",
                      kurdishText: """دەتوانیت هەر مادەیەک بەکاربێنیت کە بەردەستە ـ بۆچی خۆت سنووردار دەکەیت؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I've limited myself to 1 000 calories a day to try and lose weight.""",
                      kurdishText: """خۆم سنووردار کردووە بە ١٠٠٠ کالۆری لە ڕۆژێکدا بۆ هەوڵدان و لەدەستدانی کێش.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Families are limited to four free tickets each.""",
                      kurdishText: """خێزانەکان سنووردار کراون بە چوار بلیتی بێ بەرامبەر بۆ هەر یەکێک.""",
