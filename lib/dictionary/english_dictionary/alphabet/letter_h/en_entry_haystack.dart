...
class EnglishEntryhaystack extends StatefulWidget {
  const EnglishEntryhaystack({super.key});

  @override
  State<EnglishEntryhaystack> createState() => _EnglishEntryhaystackState();
}

class _EnglishEntryhaystackState extends State<EnglishEntryhaystack> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: haystack (Derived forms: haystacks)
1. A stack of hay (- hayrick, rick)
""",
  );

  final String keyword = "haystack";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""haystack""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The farmer built a tall haystack in the field.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """haystack""",
                      // alsoEnglishWord: "also: haystack",
                      britshText: """IpaUK: /ˈheɪstæk/""",
                      americanText: """IpaUS: /ˈheɪstæk/""",
...
// کوردی: تایە، گیشە، گزرە، تەرمەک، پووت، گرشە
// """),
                    const DefinitionKurdish(
                        text: """١. (ناو) پارچەیەکی گەورە لە وشکەگیا"""),
                    SentencesRow(
                      englishText:
                          """The farmer built a tall haystack in the field.""",
                      kurdishText:
                          """جووتیارەکە گورزە وشکەگیایەکی لە کێڵگەکە کۆکردەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/lt5ryf8EtZQ?t=';
const double _startSecondsend = 00000000000000000000000000084;
const String _videoIdone = 'https://youtu.be/96BhTy93MN0?t=';
const double _startSecondsone = 0000000000000000000000000001107;
const String _videoIdtwo = 'https://youtu.be/I-uIQDRS4a8?t=';
const double _startSecondstwo = 00000000000000000000000000059;
const String _videoIdthree = 'https://youtu.be/dvQocRS3RdE?t=';
const double _startSecondsthree = 000000000000000000000000000359;
const String _videoIdfour = 'https://youtu.be/UeeqU_b2xBw?t=';
const double _startSecondsfour = 000000000000000000000000000413;
const String _videoIdfive = 'https://youtu.be/L2Xb7AUFh28?t=';
