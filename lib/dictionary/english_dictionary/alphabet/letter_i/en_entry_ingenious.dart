...
class EnglishEntryingenious extends StatefulWidget {
  const EnglishEntryingenious({super.key});

  @override
  State<EnglishEntryingenious> createState() => _EnglishEntryingeniousState();
}

class _EnglishEntryingeniousState extends State<EnglishEntryingenious> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ingenious""");
  }
