...
class EnglishEntryanaesthesia extends StatefulWidget {
  const EnglishEntryanaesthesia({super.key});

  @override
  State<EnglishEntryanaesthesia> createState() =>
      _EnglishEntryanaesthesiaState();
}

class _EnglishEntryanaesthesiaState extends State<EnglishEntryanaesthesia> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "anaesthesia";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""anaesthesia""");
  }

  Future<void> speakanaesthesia25630(String languageCode) async {
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("The surgery is performed under general anaesthesia.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """anaesthesia""",
                      // alsoEnglishWord: "also: anaesthesia",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      onPressedBritish: () => speakanaesthesia25630("en-GB"),
                      onPressedAmerican: () => speakanaesthesia25630("en-US"),
                    ),
