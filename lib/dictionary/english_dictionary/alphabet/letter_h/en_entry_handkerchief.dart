...
class EnglishEntryhandkerchief extends StatefulWidget {
  const EnglishEntryhandkerchief({super.key});

  @override
  State<EnglishEntryhandkerchief> createState() =>
      _EnglishEntryhandkerchiefState();
}

class _EnglishEntryhandkerchiefState extends State<EnglishEntryhandkerchief> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: handkerchief (Derived forms: handkerchiefs, handkerchieves)
1. A square piece of cloth used for wiping the eyes, nose or as a costume accessory (- hankie, hanky, hankey [non-standard], fogle [archaic])
""",
  );

  final String keyword = "handkerchief";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""handkerchief""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He blew his nose on a dirty handkerchief.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He dabbed at the cut with his handkerchief.""");
  }
...
// With short examples define "handkerchief", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لووتی پاککردنەوە ناو دەستەسڕێکی پیس.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەستەسڕەکە بە کوتاڵی تۆڕی لێودار کرابوو.""",
