...
class EnglishEntryheathen extends StatefulWidget {
  const EnglishEntryheathen({super.key});

  @override
  State<EnglishEntryheathen> createState() => _EnglishEntryheathenState();
}

class _EnglishEntryheathenState extends State<EnglishEntryheathen> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: heathen
1. Not acknowledging the God of Christianity and Judaism and Islam (- heathenish, pagan, ethnic)
"His goal was to eliminate heathen practices among the Indians";

- Noun: heathen (Derived forms: heathens)
1. A person who does not acknowledge your god (- pagan, gentile, infidel)
""",
  );

  final String keyword = "heathen";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heathen""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He set out to convert the heathen.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The ancient tribes worshipped heathen gods.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heathen""",
                      // alsoEnglishWord: "also: heathen",
                      britshText: """IpaUK: /ˈhiːðn/""",
                      americanText: """IpaUS: /ˈhiːðn/""",
...
کوردی: کافر، خوانەناس، زەندیق، بت‌پەرست
"""),
// With short examples define "heathen", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە باوەڕی بە هیچ ئایینێک یان ئایینە سەرەکییەکانی جیهان نییە"""),
                    SentencesRow(
                      englishText:
                          """He set out to convert the heathen (= people who are heathens).""",
                      kurdishText: """دەستی کرد بە باوەڕهێنان بە خوانەناسان.""",
                      kurdishNote:
                          """واتا دەستیکرد بەوەی وایان لێ بکات کە باوەڕ بە خودا بهێنن""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) پەیوەندیدار بە بێ‌باوەڕان؛ پەیوەندیدار بەو شتانەی کە ئایینە سەرەکییەکان باوەڕیان پیی نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The ancient tribes worshipped heathen gods.""",
                      kurdishText:
                          """تیرە کۆنەکان باوەڕیان بە خودا ناڕاستەکان هەبوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/f5jwTft6654?t=';
const double _startSecondsend = 000000000000000000000000000803;
const String _videoIdone = 'https://youtu.be/Oxo3lqHwB0s?t=';
const double _startSecondsone = 00000000000000000000000000010;
const String _videoIdtwo = 'https://youtu.be/wGSOMKSRjkc?t=';
const double _startSecondstwo = 000000000000000000000000000406;
const String _videoIdthree = 'https://youtu.be/jLIUkk6Esr0?t=';
const double _startSecondsthree = 000000000000000000000000000987;
const String _videoIdfour = 'https://youtu.be/7oi3tkW7z-k?t=';
const double _startSecondsfour = 00000000000000000000000000044;
const String _videoIdfive = 'https://youtu.be/rWUx8F7CGq8?t=';
