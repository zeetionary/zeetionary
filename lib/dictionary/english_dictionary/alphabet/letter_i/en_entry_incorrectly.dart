...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 590;
    const String videoIdone = 'CaaJyRvvaq8';
    const double startSecondsone = 170;
    const String videoIdtwo = 'Syff4tqo7w0';
    const double startSecondstwo = 1194;
    const String videoIdthree = 'Am1lDj2mUVY';
    const double startSecondsthree = 1714;
    const String videoIdfour = 'X2jakwIVLbY';
    const double startSecondsfour = 802;
    const String videoIdfive = 'UzIxYdWVbm0';
