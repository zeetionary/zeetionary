                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "angelic"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ænˈdʒelɪk/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakangelic("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ænˈdʒelɪk/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakangelic("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'EuNEDD_6zW4';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '8m-V53p1WWo';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'iICE-gW8rIk';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'tC_BjnRc94o';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'iwJNi-f1NPc';
