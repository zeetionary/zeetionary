...
class EnglishEntryaccelerator extends StatelessWidget {
  EnglishEntryaccelerator({super.key});
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "accelerator"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUK: /əkˈseləreɪtə(r)/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakaccelerator("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əkˈseləreɪtər/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakaccelerator("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'cT_rEa4X1nA';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = '9nF0K2nJ7N8';
