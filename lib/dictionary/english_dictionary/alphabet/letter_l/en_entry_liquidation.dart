...
class EnglishEntryliquidation extends StatefulWidget {
  const EnglishEntryliquidation({super.key});

  @override
  State<EnglishEntryliquidation> createState() => _EnglishEntryliquidationState();
}

class _EnglishEntryliquidationState extends State<EnglishEntryliquidation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: liquidation (Derived forms: liquidations)
1. Termination of a business operation by using its assets to discharge its liabilities (- settlement)
 
2. The act of exterminating (- extermination)
 
3. The murder of a competitor (- elimination)
""",
  );

  final String keyword = "liquidation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""liquidation""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The company has gone into liquidation.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/NPtBkw5uD-0?t=5486';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/00yC_W0fUPE?t=471';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/kTaYet07Ioo?t=35';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/lGhFX4Pwj6Y?t=871';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/T1x_knZmZAk?t=273';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/JTuB5tfuz4Y?t=401';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """liquidation""",
                      // alsoEnglishWord: "also: liquidation",
                      britshText: """IpaUK: /ˌlɪkwɪˈdeɪʃn/""",
                      americanText: """IpaUS: /ˌlɪkwɪˈdeɪʃn/""",
...
// کوردی: هەڵوەشانەوە، پاڵاوتن (وەکوو کۆمپانیایێ، بەمەبەستی دانەوەی قەرز یان بەرشکستی)،	تێکردن، پاکتاوکردن، دانەوە (قەرز)،	نەغدکردنەوە، کردنەپارە، تواندنەوە، وردکردنەوە،	تیابردن، لەنێوبردن، پاک‌کردنەوە، کوشتن، پاتراندن
// """),
// With short examples define "liquidation", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) داخستنی بازرگانییەک و فرۆشتنی هەموو شتێکی بۆ دانەوەی قەرزەکانی"""),
                    SentencesRow(
                      englishText: """The company has gone into liquidation.""",
                      kurdishText: """کۆمپانیاکە ئیفلاسی کردووە.""",
