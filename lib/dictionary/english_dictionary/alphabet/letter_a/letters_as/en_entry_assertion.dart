...
class EnglishEntryassertion extends StatelessWidget {
  ...
  Future<void> speakassertion(String languageCode) async {
    ...
    await flutterTts.speak("assertion");
  }
  ...
  Future<void> speakassertion1046(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("Do you have any evidence to support your assertions?");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "assertion"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈsɜːʃn/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈsɜːrʃn/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'S7tab68FNI4';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '7950IuJ0RHg';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final double _startSeconds = 5293;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 3084;
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'O4ciwjHVHYg';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'HopEHvZY-08';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final double _startSeconds = 22517;
