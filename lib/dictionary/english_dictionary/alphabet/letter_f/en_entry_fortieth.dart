...
class EnglishEntryfortieth extends StatefulWidget {
  const EnglishEntryfortieth({super.key});

  @override
  State<EnglishEntryfortieth> createState() => _EnglishEntryfortiethState();
}

class _EnglishEntryfortiethState extends State<EnglishEntryfortieth> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fortieth
1. The ordinal number of forty in counting order (= 40th)

- Noun: fortieth (Derived forms: fortieths)
1. Position 40 in a countable series of things
""",
  );

  final String keyword = "fortieth";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fortieth""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She celebrated her fortieth birthday with a big party.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This is my fortieth time visiting the park.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fortieth""",
                      // alsoEnglishWord: "also: fortieth",
                      britshText: """IpaUK: /ˈfɔːtiəθ/""",
                      americanText: """IpaUS: /ˈfɔːrtiəθ/""",
...
"""),
                    const DefinitionKurdish(
                        text: """١. (ژمارەی پلەیی) چلەمین"""),
                    SentencesRow(
                      englishText:
                          """She celebrated her fortieth birthday with a big party.""",
                      kurdishText:
                          """بە ئاهەنگێکی گەورە چلەمین یادی لە دایکبوونی گێڕا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """This is my fortieth time visiting the park.""",
                      kurdishText:
                          """ئەمە چلەمین جارمە سەردانی پارکەکە بکەم.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/L2ivI-WIunc?t=';
const double _startSecondsend = 000000000000000000000000000121;
const String _videoIdone = 'https://youtu.be/XmBCd4d0c7o?t=';
const double _startSecondsone = 0000000000000000000000000003044;
const String _videoIdtwo = 'https://youtu.be/ZlwkKxyusGc?t=';
const double _startSecondstwo = 00000000000000000000000000041;
const String _videoIdthree = 'https://youtu.be/ywShIOcqLBU?t=';
const double _startSecondsthree = 000000000000000000000000000455;
const String _videoIdfour = 'https://youtu.be/wSGek9VitHQ?t=';
const double _startSecondsfour = 0000000000000000000000000001477;
const String _videoIdfive = 'https://youtu.be/gD9m9GcUWcI?t=';
