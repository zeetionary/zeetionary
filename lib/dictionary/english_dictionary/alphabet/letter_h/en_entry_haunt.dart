...
class EnglishEntryhaunt extends StatefulWidget {
  const EnglishEntryhaunt({super.key});

  @override
  State<EnglishEntryhaunt> createState() => _EnglishEntryhauntState();
}

class _EnglishEntryhauntState extends State<EnglishEntryhaunt> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: haunt (Derived forms: haunted, haunts, haunting)
1. Follow stealthily or recur constantly and spontaneously to (- stalk)
"the ghost of her mother haunted her";
 
2. Haunt like a ghost; pursue (- obsess, ghost)
"Fear of illness haunts her";
 
3. Be a regular visitor to a certain place (- frequent)
"She haunts the ballet";

- Noun: haunt (Derived forms: haunts)
1. A frequently visited place (- hangout [informal], resort, repair, stamping ground [informal], stomping ground [N. Amer])
""",
  );

  final String keyword = "haunt";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I’ll come back to haunt you!""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A headless rider haunts the country lanes.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The memory of that day still haunts me.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""For years she was haunted by guilt.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""That decision came back to haunt him.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We’ve been back to some of our old haunts.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Is this one of your usual haunts?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """haunt""",
                      // alsoEnglishWord: "also: haunt",
                      britshText: """IpaUK: /hɔːnt/""",
                      americanText: """IpaUS: /hɔːnt/""",
...
کوردی: 
"""),
// With short examples define "haunt", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) ئەوەی تارمایی کەسێک لە شوێنێک دەربکەوێت"""),
                    SentencesRow(
                      englishText: """I’ll come back to haunt you!""",
                      kurdishText: """دەگەڕێمەوە دەتتۆقێنم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕۆحی سوارچاکێکی بێ‌سەر بە ڕێگاکانی وڵاتەکەدا دەگەڕێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) کە شتێکی ناخۆش بەردەوام دێتە یادت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The memory of that day still haunts me.""",
                      kurdishText: """یادەوەری ئەو ڕۆژە دەمتۆقێنێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """For years she was haunted by guilt.""",
                      kurdishText: """بۆ چەندین ساڵ بە تاوان ئازاری دەچەشت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) ئەوەی بەردەوام بۆ ماوەیەکی زۆر کێشە بۆ کەسێک درووست بکەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """That decision came back to haunt him.""",
                      kurdishText:
                          """بڕیارەکە گەڕایەوە سەرێشەی بۆ درووستکرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ناو) شوێنێک کە کەسێک زۆر سەردانی دەکات یان کاتی زۆری لێ بەسەر دەبات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """We’ve been back to some of our old haunts.""",
                      kurdishText:
                          """گەڕاوینەتەوە بۆ ژمارەیەک لە هەوارگە کۆنەکانمان.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Is this one of your usual haunts?""",
                      kurdishText: """ئەمە یەکێک لە لانە هەمیشەییەکانتە؟""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/dhbiS7ZSRpA?t=';
const double _startSecondsend = 000000000000000000000000000275;
const String _videoIdone = 'https://youtu.be/-HyHZsa79LU?t=';
const double _startSecondsone = 000000000000000000000000000149;
const String _videoIdtwo = 'https://youtu.be/qWAagS_MANg?t=';
const double _startSecondstwo = 0000000000000000000000000001480;
const String _videoIdthree = 'https://youtu.be/s3B-qp3U5G0?t=';
const double _startSecondsthree = 000000000000000000000000000586;
const String _videoIdfour = 'https://youtu.be/_ysHglSjKds?t=';
const double _startSecondsfour = 000000000000000000000000000112;
const String _videoIdfive = 'https://youtu.be/_ENo4LaYEOU?t=';
