...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000804;
    const String videoIdone = 'https://youtu.be/wJa5Ch0O4BI?t=';
    const double startSecondsone = 0000000000000000000000000007445;
    const String videoIdtwo = 'https://youtu.be/LFtz5ZTJxxw?t=';
    const double startSecondstwo = 0000000000000000000000000001166;
    const String videoIdthree = 'https://youtu.be/lSHsZbt0VjY?t=';
    const double startSecondsthree = 000000000000000000000000000702;
    const String videoIdfour = 'https://youtu.be/ZV7zymlZRPg?t=';
    const double startSecondsfour = 000000000000000000000000000672;
    const String videoIdfive = 'https://youtu.be/Gz5Ovd08cz4?t=';
