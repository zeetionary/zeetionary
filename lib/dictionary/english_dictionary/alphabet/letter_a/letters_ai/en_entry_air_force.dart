...
class EnglishEntryairforce extends StatelessWidget {
  ...
  Future<void> speakairforce(String languageCode) async {
    ...
    await flutterTts.speak("speakAirforce");
  }
  ...
  Future<void> speakairforce3528(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("His parents discouraged him from joining the airforce.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈer fɔːrs/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'yVgjx6Sw_CA';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'SfZrnoo1GPM';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'CwwP3SiBIC8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'HR8Ue1RTyh8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'HsQmtG1fnqc';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '1D3ZvBqPg6I';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '3LrRKKRUbM4';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'AmVMNMPwfUM';
