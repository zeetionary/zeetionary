...
class EnglishEntryfervently extends StatefulWidget {
  const EnglishEntryfervently({super.key});

  @override
  State<EnglishEntryfervently> createState() => _EnglishEntryferventlyState();
}

class _EnglishEntryferventlyState extends State<EnglishEntryfervently> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fervently""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She prayed fervently for his complete recovery.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fervently""",
                      // alsoEnglishWord: "also: fervently",
                      britshText: """IpaUK: /ˈfɜːvəntli/""",
                      americanText: """IpaUS: /ˈfɜːrvəntli/""",
...
// With short examples define "fervently", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە توندی نزای بۆ چاکبوونەوەی تەاوەتیی دەکرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/1KgSp94nCZw?t=';
const double _startSecondsend = 000000000000000000000000000199;
const String _videoIdone = 'https://youtu.be/_WjUFuW2J0A?t=';
const double _startSecondsone = 000000000000000000000000000594;
const String _videoIdtwo = 'https://youtu.be/cC6zxh4MFBI?t=';
const double _startSecondstwo = 0000000000000000000000000004;
const String _videoIdthree = 'https://youtu.be/XrE0SnWsMIw?t=';
const double _startSecondsthree = 0000000000000000000000000001162;
const String _videoIdfour = 'https://youtu.be/w-dxMTDzMLY?t=';
const double _startSecondsfour = 000000000000000000000000000175;
const String _videoIdfive = 'https://youtu.be/UtcoJ8xX8Ps?t=';
