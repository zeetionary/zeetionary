...
class EnglishEntryinnocence extends StatefulWidget {
  const EnglishEntryinnocence({super.key});

  @override
  State<EnglishEntryinnocence> createState() => _EnglishEntryinnocenceState();
}

class _EnglishEntryinnocenceState extends State<EnglishEntryinnocence> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: innocence (Derived forms: innocences)
1. A state or condition of being innocent of a specific crime or offence
"the trial established his innocence"
 
2. The quality of innocent naiveté (- artlessness, ingenuousness, naturalness)
 
3. The state of being unsullied by sin or moral wrong; lacking a knowledge of evil (- purity, pureness, sinlessness, whiteness)
 
4. Californian wild flower with white and lavender to pale-blue flowers (- purple chinese houses, Collinsia bicolor, Collinsia heterophylla)
""",
  );

  final String keyword = "innocence";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""innocence""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She protested her innocence.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This new evidence will prove their innocence.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She has maintained her innocence throughout the trial.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He claimed total innocence of all charges.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Children lose their innocence as they grow older.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/ii50SWTJSoA?t=';
    const double startSecondsend = 00000000000000000000000000052;
    const String videoIdone = 'https://youtu.be/fGMCjELDyUY?t=';
    const double startSecondsone = 0000000000000000000000000001997;
    const String videoIdtwo = 'https://youtu.be/YLmDE_JYUNU?t=';
    const double startSecondstwo = 000000000000000000000000000470;
    const String videoIdthree = 'https://youtu.be/KT18KJouHWg?t=';
    const double startSecondsthree = 0000000000000000000000000001370;
    const String videoIdfour = 'https://youtu.be/vx09_4cEzlM?t=';
    const double startSecondsfour = 000000000000000000000000000530;
    const String videoIdfive = 'https://youtu.be/THIGSnMP3io?t=';
    const double startSecondsfive = 000000000000000000000000000787;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """innocence""",
                      // alsoEnglishWord: "also: innocence",
                      britshText: """IpaUK: /ˈɪnəsns/""",
                      americanText: """IpaUS: /ˈɪnəsns/""",
...
کوردی: بێ‌گوناهـی، بێ‌تاوانی، بێ‌سووچی، پاکی، داوێن‌پاکی،	سادەیی، فەقیری، ساویلکەیی، بێ‌ئازاری، بێ‌قەلەودەلەیی
"""),
// With short examples define "innocence", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) ئەوەی کە تاوانبار نەبیت"""),
                    SentencesRow(
                      englishText:
                          """She protested her innocence (= said repeatedly that she was innocent).""",
                      kurdishText: """بێ‌تاوانیی جاڕدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بەڵگە تازەکە بێ‌تاوانیی دەسەلمێنێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە ماوەی دانیشنی دادگادا ڕایگەیاندووە کە بێ‌تاوانە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بێ‌تاوانیی تەواوی لە هەموو تۆمەتەکان ڕاگەیاند.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) نەبوونی زانیاری و ئەزموونی جیهان"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Children lose their innocence as they grow older.""",
                      kurdishText:
                          """منداڵان سادەییان لەدەست دەدەن کە گەورە دەبن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """In her innocence, she agreed to go back with him to his house.""",
                      kurdishText:
                          """لە ساویلکەییدا ڕازی بوو کە لەگەڵی بچێتەوە ژوورەکە.""",
