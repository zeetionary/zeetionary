...
// replace these: replace EnglishEntryairconditioned - replace speakAirconditioned - replace air-conditioned - /ˈeə kəndɪʃnd/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryairconditioned extends StatelessWidget {
  EnglishEntryairconditioned({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAirconditioned(String languageCode) async {
    // DOPSUM: CHANGE speakAirconditioned
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("air-conditioned"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAirconditioned341(String languageCode) async {
    // DOPSUM: CHANGE speakAirconditioned
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The restaurant is air-conditioned."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈeə kəndɪʃnd/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'WoNAt9bQZtY';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '2horH-IeurA';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'g4i1FpcGzvU';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'tNami65DCyE';
