...
class EnglishEntrycooking extends StatelessWidget {
  ...
  Future<void> speakcooking(String languageCode) async {
    ...
    await flutterTts.speak("cooking");
  }
  ...
  Future<void> speakcookings1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("My husband does all the cooking.");
  }
  ...
  Future<void> speakcookings2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("We always use olive oil for cooking.");
  }
  ...
  Future<void> speakcookings3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("They serve good French cooking.");
  }
  ...
  Future<void> speakcookings4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Her cooking is wonderful.");
  }
...
"""),
                          ...
                          SentencesRow(
                            englishText: "We always use olive oil for cooking.",
                            kurdishText:
                                "ھەمیشە ڕۆزی زەیتوون بۆ چێشتلێنان بەکاردێنین.",
                            onPressedBritish: () => speakcookings2("en-GB"),
                            onPressedAmerican: () => speakcookings2("en-US"),
                          ),
                          ...
                          SentencesRow(
                            englishText: "They serve good French cooking.",
                            kurdishText: "خواردنی فەرەنسی باش پێشکەش دەکەن.",
                            onPressedBritish: () => speakcookings3("en-GB"),
                            onPressedAmerican: () => speakcookings3("en-US"),
                          ),
                          const DividerSentences(),
                          SentencesRow(
                            englishText: "Her cooking is wonderful.",
                            kurdishText: "خواردنەکەی نایابە.",
                            onPressedBritish: () => speakcookings4("en-GB"),
                            onPressedAmerican: () => speakcookings4("en-US"),
                          ),
                        ],
                      ),
                    ),
