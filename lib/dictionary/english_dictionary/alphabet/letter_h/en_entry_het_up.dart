...
class EnglishEntryhetup extends StatefulWidget {
  const EnglishEntryhetup({super.key});

  @override
  State<EnglishEntryhetup> createState() => _EnglishEntryhetupState();
}

class _EnglishEntryhetupState extends State<EnglishEntryhetup> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: het up
1. [informal] Worked up emotionally by anger or excitement
...
2. [UK, dialect] Made warm or hot (- heated, heated up, het [UK, dialect])
"he was all het up and sweaty";
""",
  );

  final String keyword = "het up";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What are you getting so het up about?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was all het up about the extra cost.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """het up""",
                      // alsoEnglishWord: "also: het up",
                      britshText: """IpaUK: /ˌhet ˈʌp/""",
                      americanText: """IpaUS: /ˌhet ˈʌp/""",
...
کوردی: ڕق‌هەستاو، تووڕە، سوورەوەبوو، تێکچوو، ناڕەحەت
"""),
// With short examples define "het up", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """What are you getting so het up about?""",
                      kurdishText: """چییە کە هێندە تووڕە بوونە پێی؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """زۆر تووڕە بوو بە تێچووە زیادەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/XiLzYeIujvM?t=';
const double _startSecondsend = 000000000000000000000000000834;
const String _videoIdone = 'https://youtu.be/Xk8Wxlqc_7w?t=';
const double _startSecondsone = 000000000000000000000000000205;
const String _videoIdtwo = 'https://youtu.be/mdrtC8d1MxU?t=';
const double _startSecondstwo = 0000000000000000000000000002279;
const String _videoIdthree = 'https://youtu.be/yWuMW-9pAEM?t=';
const double _startSecondsthree = 000000000000000000000000000371;
const String _videoIdfour = 'https://youtu.be/oW4hfaiXKG8?t=';
const double _startSecondsfour = 00000000000000000000000000015;
const String _videoIdfive = 'https://youtu.be/xUDNG063ZxA?t=';
const double _startSecondsfive = 000000000000000000000000000655;
