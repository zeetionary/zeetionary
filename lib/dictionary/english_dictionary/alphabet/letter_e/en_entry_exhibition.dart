...
class EnglishEntryexhibition extends StatefulWidget {
  const EnglishEntryexhibition({super.key});

  @override
  State<EnglishEntryexhibition> createState() => _EnglishEntryexhibitionState();
}

class _EnglishEntryexhibitionState extends State<EnglishEntryexhibition> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exhibition""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exhibition""",
                      // alsoEnglishWord: "also: exhibition",
                      britshText: """IpaUK: /ˌeksɪˈbɪʃn/""",
                      americanText: """IpaUS: /ˌeksɪˈbɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exhibition";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Have you seen the Picasso exhibition?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The gallery is hosting an exhibition of his work.""");
  }
...
کوردی: پیشانگا،	پیشاندان، خستنەبەرچاو، نیشان‌دان، خستنەڕوو، هەڵخستن، نواندن، ڕانان
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) شتێک یان کۆمەڵە شتێک کە دەخرێنە شوێنێکی گشتی، بۆ نموونە مۆزەخانە، بۆ ئەوەی خەڵکی بیان بینن"""),
          const AlsoEnglishckb(word: "ھەروەھا: exhibit"),
          SentencesRow(
            englishText: """Have you seen the Picasso exhibition?""",
            kurdishText: """خستنەبەرچاوی پیکاسۆت دیوە؟""",
          ...
          SentencesRow(
            englishText:
                """His first solo exhibition took place in Barcelona in 1925.""",
            kurdishText:
                """یەکەم نمایشی تاکەکەسیی ساڵی ١٩٢٥ لە بەرشەلۆنە بوو.""",
          ...
          SentencesRow(
            ...
            kurdishText: """پێشانگاکە نمایشێکی کارەکانی لەخۆدەگرێت.""",
          ...
          SentencesRow(
            englishText:
                """His sculptures have been featured in exhibitions all over the world.""",
            kurdishText:
                """پەیکەرەکانی لە نمایشەکانی هەموو جیهاندا خراونەتە بەرچاو.""",
          ...
          SentencesRow(
            englishText:
                """She refused to allow the exhibition of her husband's work.""",
            kurdishText:
                """ڕەتیکردەوە ڕێگا بە نمایشی کارەکانی هاوسەرەکەی بدات.""",
          ...
          SentencesRow(
            englishText:
                """The new wing will provide 20 000 more square feet of exhibition space.""",
            kurdishText:
                """بەشە تازەکە ٢٠٠٠٠ پێ چوارگۆشەی زیادە لە شوێنی نمایش دابین دەکات.""",
          ...
          const DefinitionKurdish(
              text:
                  """٣. (ناو) پیشاندانی ئەزموونێک، سۆزێک، یان ڕەفتاری میهرەبانابە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """We were treated to an exhibition of the footballer's speed and skill.""",
            kurdishText:
                """نمایشی خێرایی و شارەزایی یاریزانی تۆپێنەکەمان پێ پیشاندرا.""",
            englishNote:
                "This means that we had the opportunity to watch a demonstration showcasing the footballer's impressive speed and skill during a performance or event.",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: exhibition (Derived forms: exhibitions)
1. The act of exhibiting
"a remarkable exhibition of musicianship"
 
2. (art) a collection of things (goods or works of art etc.) for public display (= exposition, expo)
 
3. [Brit] A financial award or prize given to a student by a school or university, usually on the basis of academic merit
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/NHIT9vq6mJU?t=';
const double _startSecondsend = 000000000000000000000000000000; // 36;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/IdaX96pvI1E?t=';
const double _startSecondsone = 00000000000000000000000000000; // 5;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/n8NrMKd1OHo?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 43;
const String _videoIdthree = 'VIDEOhttps://youtu.be/HknFAfJgPU8?t=';
const double _startSecondsthree = 000000000000000000000000000; // 69;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/jMh_WRH1PHQ?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1393;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/q0hbqMGrLdg?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 6;
