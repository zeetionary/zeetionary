...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 't-wD0fVXI7k';
    const double startSecondsend = 13823;
    const String videoIdone = 'wkUfj7WvXpg';
    const double startSecondsone = 423;
    const String videoIdtwo = 'nXVBjrFTZ9Y';
    const double startSecondstwo = 7357;
    const String videoIdthree = '7rV7tibLxPY';
    const double startSecondsthree = 9520;
    const String videoIdfour = 'x3GUtguvEPg';
    const double startSecondsfour = 218;
    const String videoIdfive = 'lHd26dg5P0Y';
    const double startSecondsfive = 1732;
