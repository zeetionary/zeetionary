...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/n4bucphC9r4?t=';
    ...
    const String videoIdtwo = 'https://youtu.be/n5x7GLl-mMo?t=';
    const double startSecondstwo = 000000000000000000000000000202;
    const String videoIdthree = 'https://youtu.be/G0SpzIIHEaE?t=';
    const double startSecondsthree = 00000000000000000000000000016;
    const String videoIdfour = 'https://youtu.be/Mp11EzxCOG4?t=';
    const double startSecondsfour = 000000000000000000000000000200;
    const String videoIdfive = 'https://youtu.be/hkO8qXCFYWA?t=';
    const double startSecondsfive = 0000000000000000000000000001217;
