...
""",
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We can handle up to 500 calls an hour at our new offices.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Garden tools can be hazardous if carelessly handled.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The books are ancient, and need to be handled very carefully.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I wasn't sure if I could handle such a powerful car.""");
  }
...
// With short examples define "handle", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) مامەڵەکردن لەگەڵ کەسێک، کارێک، دۆخێک، یان هەست‌وسۆزێک"""),
                    SentencesRow(
                      englishText: """A new man was appointed to handle the crisis.""",
                      kurdishText: """پیاوێکی تازە دانرا بۆ مامەڵەکردن لەگەڵ دۆخەکە.""",
                    ...
                    SentencesRow(
                      englishText: """She's very good at handling her patients.""",
                      kurdishText: """زۆر باشە لە مامەڵەکردن لەگەڵ نەخۆشەکانی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بڕیاریدا بۆ خۆی مامەڵە لەگەڵ شتەکان بکات.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """This matter has been handled very badly.""",
                      kurdishText: """ئەم بابەتە زۆر خراپ مامەڵەی لەگەڵ کراوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We can handle up to 500 calls an hour at our new offices.""",
                      kurdishText: """لە ئۆفیسە تازەکانمان دەتوانین لە کاتژمێرێکدا ٥٠٠ پەیوەندی وەربگرین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەموومان دەبێت فێربین مامەڵە لەگەڵ سترێس بکەین.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her next question was not so easily handled.""",
                      kurdishText: """پرسیاری دواتری ئاسان مامەڵەی لەگەڵ نەکرا.""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) گرتن، جوڵاندن، یان دەستدان لە شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Garden tools can be hazardous if carelessly handled.""",
                      kurdishText: """کەلوپەلی باخچە دەکرێت زیانبەخش بن ئەگەر بەناوریاییەوە دەستیان لێ بدرێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The books are ancient, and need to be handled very carefully.""",
                      kurdishText: """کتێبەکان کۆنن و دەبێت زۆر بەوریاییەوە دەستیان لێ بدرێت.""",
                      onPressedBritish: () => speaksentence10("en-GB"),
                      onPressedAmerican: () => speaksentence10("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) کۆنترۆڵکردنی پێڕۆیەک، ئاژەڵێک، ئامرازێک، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I wasn't sure if I could handle such a powerful car.""",
                      kurdishText: """دڵنیانەبوم کە بتوانم ئۆۆتمبێلێکی وەها بەهێز کۆنترۆڵ بکەم.""",
                      onPressedBritish: () => speaksentence12("en-GB"),
                      onPressedAmerican: () => speaksentence12("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) ئەوەی پێڕۆیەک ئاسان یان سەخت بێت بۆ کۆنترۆڵکردن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The car handles well in any weather.""",
                      kurdishText: """ئۆتۆمبێلەکە باش کار دەکات لە هەر کەشووهەوایەک.""",
                      onPressedBritish: () => speaksentence13("en-GB"),
                      onPressedAmerican: () => speaksentence13("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (کردار) کڕین یان فرۆشتنی شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They were arrested for handling stolen goods.""",
                      kurdishText: """دەستگیرکران بۆ کڕین و فرۆشتنی شتی دزراو.""",
