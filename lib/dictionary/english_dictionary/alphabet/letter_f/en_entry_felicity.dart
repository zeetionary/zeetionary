...
class EnglishEntryfelicity extends StatefulWidget {
  const EnglishEntryfelicity({super.key});

  @override
  State<EnglishEntryfelicity> createState() => _EnglishEntryfelicityState();
}

class _EnglishEntryfelicityState extends State<EnglishEntryfelicity> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""felicity""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She felt pure felicity on her wedding day.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The story is told with great felicity of style.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Her book displays many subtle linguistic felicities.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """felicity""",
                      // alsoEnglishWord: "also: felicity",
                      britshText: """IpaUK: /fəˈlɪsəti/""",
                      americanText: """IpaUS: /fəˈlɪsəti/""",
...
کوردی: شاگەشکەیی، سەرخۆشی، سەرمەستی، شادی، دڵخۆشی، خۆشی،	ڕەوانی، زمان‌پاراوی، خۆش‌ڕاوێژی
"""),
                    const DefinitionKurdish(text: """١. (ناو) دڵخۆشی زۆر"""),
                    SentencesRow(
                      englishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چیرۆکەکە بە شێوازی زمان‌پاراوی زۆرەوە دەگوترێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کتێبەکە زۆر تایبەتمەندیی زمانەوانی گونجاوی تێدایە.""",
...
const double _startSecondsend = 0000000000000000000000000001262;
const String _videoIdone = 'https://youtu.be/r7IPeilxCOE?t=';
const double _startSecondsone = 000000000000000000000000000221;
const String _videoIdtwo = 'https://youtu.be/GKsvKiXoNhE?t=';
const double _startSecondstwo = 00000000000000000000000000011364;
const String _videoIdthree = 'https://youtu.be/zOL8jkWy8MY?t=';
const double _startSecondsthree = 0000000000000000000000000001072;
const String _videoIdfour = 'https://youtu.be/rtepIKeNHPU?t=';
const double _startSecondsfour = 000000000000000000000000000266;
const String _videoIdfive = 'https://youtu.be/0-88I88gH5M?t=';
const double _startSecondsfive = 0000000000000000000000000004127;
