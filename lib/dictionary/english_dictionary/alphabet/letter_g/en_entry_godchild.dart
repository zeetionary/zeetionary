...
class EnglishEntrygodchild extends StatefulWidget {
  const EnglishEntrygodchild({super.key});

  @override
  State<EnglishEntrygodchild> createState() => _EnglishEntrygodchildState();
}

class _EnglishEntrygodchildState extends State<EnglishEntrygodchild> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""godchild""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She bought a gift for her godchild's birthday.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """godchild""",
                      // alsoEnglishWord: "also: godchild",
                      britshText: """IpaUK: /ˈɡɒdtʃaɪld/""",
                      americanText: """IpaUS: /ˈɡɑːdtʃaɪld/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) منداڵێک/کوڕێک/کچێک کە لە مەراسیمی تەوفنیدا هەندێک لە پەروەردەی لایەنی ئەخلاقی و ئایینیی دەدرێت بە دوو کەسی دیکە کە زۆرجار کەسانی نزیکی دایک و باوکیین"""),
                    SentencesRow(
                      englishText:
                          """She bought a gift for her godchild's birthday.""",
                      kurdishText:
                          """دیارییەکی کڕی بۆ یادی لەدایکبوونی منداڵە تەوفنییەکەی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/TEZ9mmaKfYw?t=';
const double _startSecondsend = 000000000000000000000000000677;
const String _videoIdone = 'https://youtu.be/BTAd8GqsQ14?t=';
const double _startSecondsone = 000000000000000000000000000613;
const String _videoIdtwo = 'https://youtu.be/aYJ8gK8txbI?t=';
const double _startSecondstwo = 000000000000000000000000000145;
const String _videoIdthree = 'https://youtu.be/Y3X1S_BgOec?t=';
const double _startSecondsthree = 0000000000000000000000000001141;
const String _videoIdfour = 'https://youtu.be/w2SOhY-vUno?t=';
const double _startSecondsfour = 000000000000000000000000000393;
const String _videoIdfive = 'https://youtu.be/xtOfwDKROLI?t=';
