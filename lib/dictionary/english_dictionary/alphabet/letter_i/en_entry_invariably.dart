...
class EnglishEntryinvariably extends StatefulWidget {
  const EnglishEntryinvariably({super.key});

  @override
  State<EnglishEntryinvariably> createState() => _EnglishEntryinvariablyState();
}

class _EnglishEntryinvariablyState extends State<EnglishEntryinvariably> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""invariably""");
  }
