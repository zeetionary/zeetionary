...
class EnglishEntryfiller extends StatefulWidget {
  const EnglishEntryfiller({super.key});

  @override
  State<EnglishEntryfiller> createState() => _EnglishEntryfillerState();
}

class _EnglishEntryfillerState extends State<EnglishEntryfiller> {
  @override
  void initState() {
    super.initState();
...
4. Anything added to fill out a whole (= makeweight)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She applied some filler to smooth the cracks.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The song was originally a filler on their first album.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """filler""",
                      // alsoEnglishWord: "also: filler",
                      britshText: """IpaUK: /ˈfɪlə(r)/""",
                      americanText: """IpaUS: /ˈfɪlər/""",
...
const double _startSecondsone = 0000000000000000000000000001967;
...
const String _videoIdfour = 'https://youtu.be/Bbi0kEaTgio?t=';
const double _startSecondsfour = 000000000000000000000000000985;
const String _videoIdfive = 'https://youtu.be/8GKI2sYe1CI?t=';
const double _startSecondsfive = 000000000000000000000000000890;
