...
class EnglishEntryhalfwitted extends StatefulWidget {
  const EnglishEntryhalfwitted({super.key});

  @override
  State<EnglishEntryhalfwitted> createState() => _EnglishEntryhalfwittedState();
}

class _EnglishEntryhalfwittedState extends State<EnglishEntryhalfwitted> {
  @override
  void initState() {
    super.initState();
...
1. Slow to understand, learn or think; stupid (- backward, slow-witted, feebleminded, dull-witted [archaic])
"Poor half-witted Charlie was kept steadily at work";
""",
  );

  final String keyword = "half-witted";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""half-witted""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The half-witted man couldn't follow simple instructions.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """half-witted""",
                      // alsoEnglishWord: "also: half-witted",
                      britshText: """IpaUK: /ˌhɑːf ˈwɪtɪd/""",
                      americanText: """IpaUS: /ˌhæf ˈwɪtɪd/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """The half-witted man couldn't follow simple instructions.""",
                      kurdishText:
                          """پیاوە گەمژەکە نەیدەتوانی شوێن ڕێنمایی سادە بکەوێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Cu9079rbaLY?t=';
...
const String _videoIdtwo = 'https://youtu.be/xRmVfKOOh5o?t=';
const double _startSecondstwo = 00000000000000000000000000075;
const String _videoIdthree = 'https://youtu.be/xy9RsPvUAwE?t=';
const double _startSecondsthree = 00000000000000000000000000053;
const String _videoIdfour = 'https://youtu.be/rnq3VBQu_kI?t=';
const double _startSecondsfour = 000000000000000000000000000707;
const String _videoIdfive = 'https://youtu.be/xwFWArFiiNM?t=';
