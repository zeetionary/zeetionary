...
class EnglishEntryfake extends StatefulWidget {
  const EnglishEntryfake({super.key});

  @override
  State<EnglishEntryfake> createState() => _EnglishEntryfakeState();
}

class _EnglishEntryfakeState extends State<EnglishEntryfake> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fake""",
                      // alsoEnglishWord: "also: fake",
                      britshText: """IpaUK: /feɪk/""",
                      americanText: """IpaUS: /feɪk/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The caller appeared to have a fake American accent.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Experts revealed that the painting was a fake.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The gun in his hand was a fake.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""All the paintings proved to be fakes.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She faked her mother's signature on the document.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He arranged the accident in order to fake his own death.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's not really sick—she's just faking it.""");
  }
...
"""),
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Experts revealed that the painting was a fake.""",
            kurdishText: """شارەزایان ئاشکرایان کرد کە تابلۆکە ساختە بوو.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The gun in his hand was a fake.""",
            kurdishText: """چەکەکەی دەستی ساختە بوو.""",
          ...
          SentencesRow(
            englishText:
                """We sprayed fake snow over the trees to make it look like winter.""",
            kurdishText:
                """بەفری ساختەمان پرژاند بەسەر دارەکاندا تاوەکو وا دەربکەوێت کە زستانە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """لەسەر بەڵگەنامەکە واژۆی دایکیی ساختە کرد.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ڕووداوەکەی ڕێکخست بۆ ئەوەی مردنی خۆی ساختە بکات.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He faked a yawn.""",
            kurdishText: """باوێشکێکی بە ساختە کرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fake
1. Fraudulent; having a misleading appearance (= bogus, phony [N. Amer], phoney, cod [Brit, informal])
...
2. Tamper, with the purpose of deception (= fudge, manipulate, falsify, cook [informal], wangle [informal], misrepresent, spoof [informal])
"fake the figures";
 
3. [US, informal] Speak insincerely or without regard for facts or truths (= talk through one's hat [informal], bull [informal])
...
const String _videoIdfour = 'https://youtu.be/vuDMiFwWTM4?t=';
