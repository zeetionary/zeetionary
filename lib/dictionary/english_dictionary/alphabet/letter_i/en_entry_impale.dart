...
class EnglishEntryimpale extends StatefulWidget {
  const EnglishEntryimpale({super.key});

  @override
  State<EnglishEntryimpale> createState() => _EnglishEntryimpaleState();
}

class _EnglishEntryimpaleState extends State<EnglishEntryimpale> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: impale (Derived forms: impales, impaling, impaled)
1. Pierce with a sharp stake or point (- transfix, empale, spike)
"impale a shrimp on a skewer";
 
2. Kill by piercing with a spear or sharp pole (- stake)
"the enemies were impaled and left to die";
""",
  );

  final String keyword = "impale";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She impaled a lump of meat on her fork.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He had fallen and been impaled on some iron railings.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/tCqwT2MqLxI?t=';
    const double startSecondsend = 000000000000000000000000000753;
    const String videoIdone = 'https://youtu.be/__qtH1ly2Sg?t=';
    const double startSecondsone = 000000000000000000000000000582;
    const String videoIdtwo = 'https://youtu.be/iErqWGwso7o?t=';
    const double startSecondstwo = 000000000000000000000000000428;
    const String videoIdthree = 'https://youtu.be/xPGdOXstSyk?t=';
    const double startSecondsthree = 0000000000000000000000000001033;
    const String videoIdfour = 'https://youtu.be/AdZ9kGwqkTM?t=';
    const double startSecondsfour = 000000000000000000000000000534;
    const String videoIdfive = 'https://youtu.be/vC2BSb9MZYc?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """impale""",
                      // alsoEnglishWord: "also: impale",
                      britshText: """IpaUK: /ɪmˈpeɪl/""",
                      americanText: """IpaUS: /ɪmˈpeɪl/""",
...
کوردی: 
"""),
// With short examples define "impale", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) ئەوەی شتێکی تیژ بکەیت بە شتێکدا"""),
                    const AlsoEnglishckb(word: "ھەروەھا: spear"),
                    SentencesRow(
                      englishText:
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) ئەوەی شتێکی تیژ بە ڕێکەوت بکەیت بە جەستەی خۆتدا یان بچێت بە جەستەتدا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He had fallen and been impaled on some iron railings.""",
                      kurdishText:
                          """کەوتبوو و چووبوو بە هەندێک محاجەرەی ئاسنیندا.""",
