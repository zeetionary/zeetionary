...
// replace these: replace EnglishEntryanecdote - replace speakAnecdote - replace anecdote - /ˈænɪkdəʊt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryanecdote extends StatelessWidget {
  EnglishEntryanecdote({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAnecdote(String languageCode) async {
    // DOPSUM: CHANGE speakAnecdote
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("anecdote"); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "anecdote", // DOPSUM: CHANGE WORD ENTRY - Find /ˈænɪkdəʊt/
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: const Text(
                                "IpaUK: /ˈænɪkdəʊt/", // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAnecdote(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˈænɪkdəʊt/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "p1Iybu8VcGo";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "_uSJDq7VPrw";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "vchJnrZgz-4";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "AVYNk2dPb9U";
