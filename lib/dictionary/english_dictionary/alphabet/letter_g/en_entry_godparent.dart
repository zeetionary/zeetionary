...
class EnglishEntrygodparent extends StatefulWidget {
  const EnglishEntrygodparent({super.key});

  @override
  State<EnglishEntrygodparent> createState() => _EnglishEntrygodparentState();
}

class _EnglishEntrygodparentState extends State<EnglishEntrygodparent> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "godparent";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""godparent""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The godparents attended all the important events in the child's life.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """godparent""",
                      // alsoEnglishWord: "also: godparent",
                      britshText: """IpaUK: /ˈɡɒdpeərənt/""",
                      americanText: """IpaUS: /ˈɡɑːdperənt/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە بەڵێن دەدات لە مەراسیمی تەوفنکەدندا کە ببێت بە دایک یان باوکی کەسێک و ئەوەی فێری بکات لەسەر ئایینی مەسیحی"""),
                    SentencesRow(
                      englishText:
                          """The godparents attended all the important events in the child's life.""",
                      kurdishText:
                          """دایبابە تەوفنییەکە بەژداری هەموو بۆنە گرنگەکانی ژیانی منداڵەکەیان کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/3_QuoAgPbys?t=';
const double _startSecondsend = 000000000000000000000000000189;
const String _videoIdone = 'https://youtu.be/RNRvYXKxiIE?t=';
const double _startSecondsone = 00000000000000000000000000071;
const String _videoIdtwo = 'https://youtu.be/iT-HFkChZEA?t=';
const double _startSecondstwo = 00000000000000000000000000019;
const String _videoIdthree = 'https://youtu.be/O2TGON58p6c?t=';
const double _startSecondsthree = 000000000000000000000000000672;
const String _videoIdfour = 'https://youtu.be/XppShCFq6C8?t=';
const double _startSecondsfour = 000000000000000000000000000151;
const String _videoIdfive = 'https://youtu.be/-TLx6obW-Tk?t=';
const double _startSecondsfive = 0000000000000000000000000001346;
