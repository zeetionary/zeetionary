...
class EnglishEntryherbaceous extends StatefulWidget {
  const EnglishEntryherbaceous({super.key});

  @override
  State<EnglishEntryherbaceous> createState() => _EnglishEntryherbaceousState();
}

class _EnglishEntryherbaceousState extends State<EnglishEntryherbaceous> {
  @override
  void initState() {
    super.initState();
...
1. (botany) characteristic of a nonwoody herb or plant part
"These red, pink, and white herbaceous peonies are planted in a rectangular island"
""",
  );

  final String keyword = "herbaceous";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""herbaceous""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """herbaceous""",
                      // alsoEnglishWord: "also: herbaceous",
                      britshText: """IpaUK: /hɜːˈbeɪʃəs/""",
                      americanText: """IpaUS: /ɜːrˈbeɪʃəs/,  /hɜːrˈbeɪʃəs/""",
...
const String _videoIdone = 'https://youtu.be/ZGc9H3BJGZo?t=';
const double _startSecondsone = 000000000000000000000000000505;
const String _videoIdtwo = 'https://youtu.be/bA6-VEVAzCE?t=';
const double _startSecondstwo = 0000000000000000000000000001012;
const String _videoIdthree = 'https://youtu.be/fYVouIyOXC0?t=';
const double _startSecondsthree = 000000000000000000000000000496;
const String _videoIdfour = 'https://youtu.be/hNQMVweQjlw?t=';
const double _startSecondsfour = 000000000000000000000000000182;
const String _videoIdfive = 'https://youtu.be/Z-w_KPvZA80?t=';
