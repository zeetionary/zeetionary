...
class EnglishEntryincorrectness extends StatefulWidget {
  const EnglishEntryincorrectness({super.key});

  @override
  State<EnglishEntryincorrectness> createState() => _EnglishEntryincorrectnessState();
}

class _EnglishEntryincorrectnessState extends State<EnglishEntryincorrectness> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incorrectness""");
  }
