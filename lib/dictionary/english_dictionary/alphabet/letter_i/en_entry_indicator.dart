...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 00000000000000000000000000017;
    const String videoIdone = 'https://youtu.be/AF8d72mA41M?t=';
    const double startSecondsone = 00000000000000000000000000026;
    const String videoIdtwo = 'https://youtu.be/CaaJyRvvaq8?t=';
    const double startSecondstwo = 000000000000000000000000000203;
    const String videoIdthree = 'https://youtu.be/PmlRbfSavbI?t=';
    const double startSecondsthree = 000000000000000000000000000356;
    const String videoIdfour = 'https://youtu.be/LMIu4fqi8jI?t=';
    const double startSecondsfour = 000000000000000000000000000434;
    const String videoIdfive = 'https://youtu.be/mRj1RKh4xyY?t=';
