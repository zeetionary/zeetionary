...
class EnglishEntrylinoleum extends StatefulWidget {
  const EnglishEntrylinoleum({super.key});

  @override
  State<EnglishEntrylinoleum> createState() => _EnglishEntrylinoleumState();
}

class _EnglishEntrylinoleumState extends State<EnglishEntrylinoleum> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: linoleum (Derived forms: linoleums)
1. A floor covering (- lino)
""",
  );

  final String keyword = "linoleum";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""linoleum""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The kitchen floor was covered with green linoleum.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/soVrto5reI0';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/CIWKjBMYfBw?t=136';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/ONs4CHk5bWQ';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/2E0xg6D3fW4?t=93';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/uvU5dmu4sl8?t=135';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/WrerqYACSQU?t=1340';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """linoleum""",
                      // alsoEnglishWord: "also: linoleum",
                      britshText: """IpaUK: /lɪˈnəʊliəm/""",
                      americanText: """IpaUS: /lɪˈnəʊliəm/""",
...
کوردی: 
"""),
                    const DefinitionKurdish(text: """١. (ناو) مادەیەکی بەهێز کە کە ڕوویەکی بریقەداری هەیە و زەوی پێ ڕووپۆش دەکرێت"""),
                    SentencesRow(
                      englishText: """The kitchen floor was covered with green linoleum.""",
                      kurdishText: """زەوی چێشتخانەکە بە لینۆلیۆمی سەوزی داپۆشرابوو.""",
