...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'OL1RmlJdW5I';
    const double startSecondsend = 943;
    const String videoIdone = 'Uc8VE1KS9GI';
    const double startSecondsone = 994;
    const String videoIdtwo = '4FGnb2lgPBA';
    const double startSecondstwo = 21;
    const String videoIdthree = 'KCvImODyOUg';
    const double startSecondsthree = 322;
    const String videoIdfour = 'mLEWj-61a4I';
    const double startSecondsfour = 919;
    const String videoIdfive = 'jvNN_ehD_0M';
