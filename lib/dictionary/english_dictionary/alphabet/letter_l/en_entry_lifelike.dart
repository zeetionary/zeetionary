...
class EnglishEntrylifelike extends StatefulWidget {
  const EnglishEntrylifelike({super.key});

  @override
  State<EnglishEntrylifelike> createState() => _EnglishEntrylifelikeState();
}

class _EnglishEntrylifelikeState extends State<EnglishEntrylifelike> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lifelike""");
  }
