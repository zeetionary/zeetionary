...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'WUzeOF_QTWY';
    const double startSecondsend = 1261;
    const String videoIdone = 'TL4ti1EGNiw';
    const double startSecondsone = 1066;
    const String videoIdtwo = 'a1Z7U9ywLSs';
    const double startSecondstwo = 32;
    const String videoIdthree = 'jrIogch5DBU';
    const double startSecondsthree = 427;
    const String videoIdfour = 'gokZgvLPe1g';
    const double startSecondsfour = 719;
    const String videoIdfive = 'vyGdzbEd22M';
    const double startSecondsfive = 542;
