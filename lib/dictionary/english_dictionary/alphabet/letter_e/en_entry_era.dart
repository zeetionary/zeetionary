...
class EnglishEntryera extends StatefulWidget {
  const EnglishEntryera({super.key});

  @override
  State<EnglishEntryera> createState() => _EnglishEntryeraState();
}

class _EnglishEntryeraState extends State<EnglishEntryera> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """era""",
                      // alsoEnglishWord: "also: era",
                      britshText: """IpaUK: /ˈɪərə/""",
                      americanText: """IpaUS: /ˈɪrə/,  /ˈerə/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""When she left the firm, it was the end of an era.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""This is the start of a new era of peace and prosperity.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The room had the elegance of a bygone era.""");
  }
...
کوردی: سەردەم، قۆناخ، سووڕ، چاخ، چەرخ، ڕۆژگار
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ماوەیەک، بەتایبەتی لە مێژوودا، کە جیاوازە لە ماوەکانی دیکە بەهۆی خاسیەت و ڕووداوی دیاریکراو"""),
          SentencesRow(
            englishText:
                """When she left the firm, it was the end of an era (= things were different after that).""",
            kurdishText: """کە کۆمپانیاکەی جێهێشت کۆتایی سەردەمێک بوو.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """ئەمە سەرەتای سەردەمێکی تازە لە ئاشتی و بوژانەوەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The room had the elegance of a bygone era.""",
            kurdishText: """ژوورەکە ئەدای سەردەمانێکی تێپەڕیوی هەیە.""",
          ...
          SentencesRow(
            englishText:
                """It is one of the most famous churches built in the Victorian era.""",
            kurdishText:
                """یەکێک لە بەناوبانگترین کڵێساکانە کە لە سەردەمی شاژن ڤیکتۆریا درووستکراوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: era (Derived forms: eras)
1. A period marked by distinctive character or reckoned from a fixed point or event (= epoch)
 
2. A major division of geological time; an era is usually divided into two or more periods (= geological era)

- Noun: ERA
1. (baseball) a measure of a pitcher's effectiveness; calculated as the average number of earned runs allowed by the pitcher for every nine innings pitched (= earned run average)
""",
  );
...
const double _startSecondsend = 000000000000000000000000000000; // 425;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/sV6uuMAnJUE?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1293;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/Bl5630CeYFs?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 313;
const String _videoIdthree = 'VIDEOhttps://youtu.be/fn--IVarumw?t=';
const double _startSecondsthree = 000000000000000000000000000; // 192;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/PLDFgKzWy3o?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 333;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/b4wRdoWpw0w?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 235;
