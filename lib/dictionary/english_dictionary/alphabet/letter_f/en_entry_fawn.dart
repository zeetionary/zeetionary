...
class EnglishEntryfawn extends StatefulWidget {
  const EnglishEntryfawn({super.key});

  @override
  State<EnglishEntryfawn> createState() => _EnglishEntryfawnState();
}

class _EnglishEntryfawnState extends State<EnglishEntryfawn> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fawn""",
                      // alsoEnglishWord: "also: fawn",
                      britshText: """IpaUK: /fɔːn/""",
                      americanText: """IpaUS: /fɔːn/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She wore a fawn coat.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She saw a fawn with its mother.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They painted the baby's room fawn.""");
  }
...
کوردی: بەچکە ئاسک، بێچووە گاکێوی، ئاسکۆڵ، کارمامز، قاوەیی ئاماڵ‌زەرد، قاوەیی مەیلەوزەرد
"""),
          const DefinitionKurdish(
              text: """١. (ناو) هەبوونی ڕەنگی زەردی مەیلەو قاوەیی ڕۆشن"""),
          SentencesRow(
            englishText: """She wore a fawn coat.""",
            kurdishText: """قەمسەڵەیەکی قاوەیی ئاماڵ‌زەردی لەبەر کرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fawn (Derived forms: fawns)
1. A colour or pigment varying around a light grey-brown colour (= dun, greyish brown [Brit, Cdn], grayish brown [US])
"she wore fawn";
 
2. A young deer

- Verb: fawn (Derived forms: fawned, fawning, fawns)
1. Show submission or fear (= crawl, cringe, cower, grovel)
 
2. Try to gain favour by cringing or flattering (= toady, truckle, bootlick [informal], kowtow, kotow, suck up [informal], smoodge [Austral, informal])
"He is always fawning to his boss";
...
const String _videoIdend = 'https://youtu.be/hGLY5MAAFO4?t=';
const double _startSecondsend = 0000000000000000000000000001839;
const String _videoIdone = 'https://youtu.be/fY2CF-T05qY?t=';
const double _startSecondsone = 000000000000000000000000000787;
const String _videoIdtwo = 'https://youtu.be/0WIwQgH4lKg?t=';
const double _startSecondstwo = 000000000000000000000000000749;
const String _videoIdthree = 'https://youtu.be/cDPeXoQUrbI?t=';
const double _startSecondsthree = 000000000000000000000000000218;
const String _videoIdfour = 'https://youtu.be/H7pZeqAGal8?t=';
const double _startSecondsfour = 00000000000000000000000000045;
const String _videoIdfive = 'https://youtu.be/p9e8qNNe3L0?t=';
