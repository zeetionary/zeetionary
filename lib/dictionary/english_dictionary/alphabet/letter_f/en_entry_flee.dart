...
class EnglishEntryflee extends StatefulWidget {
  const EnglishEntryflee({super.key});

  @override
  State<EnglishEntryflee> createState() => _EnglishEntryfleeState();
}

class _EnglishEntryfleeState extends State<EnglishEntryflee> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: flee (Derived forms: fled, fleeing, flees)
1. Run away quickly (= fly, take flight, cut and run [informal])
"He threw down his gun and fled";
""",
  );

  final String keyword = "flee";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She burst into tears and fled.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He fled to London after an argument with his family.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was caught trying to flee the country.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flee""",
                      // alsoEnglishWord: "also: flee",
                      britshText: """IpaUK: /fliː/""",
                      americanText: """IpaUS: /fliː/""",
...
// With short examples define "flee", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) ڕاکردن یان هەڵهاتن لە شوێنێک"""),
                    SentencesRow(
                      englishText: """She burst into tears and fled.""",
                      kurdishText: """دەستی کرد بە گریان و هەڵهات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە دوای مشتومڕێک لەگەڵ خێزانەکەی هەڵهات بۆ لەندەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """گیرا کە دەیویست لە وڵاتەکە هەڵبێت.""",
...
const double _startSecondsend = 0000000000000000000000000001110;
const String _videoIdone = 'https://youtu.be/zqllxbPWKNI?t=';
const double _startSecondsone = 0000000000000000000000000001485;
const String _videoIdtwo = 'https://youtu.be/-VRx0GRo-Ws?t=';
const double _startSecondstwo = 00000000000000000000000000052;
const String _videoIdthree = 'https://youtu.be/0jltioeaEyY?t=';
const double _startSecondsthree = 000000000000000000000000000237;
const String _videoIdfour = 'https://youtu.be/LQk4t5rUQXA?t=';
const double _startSecondsfour = 00000000000000000000000000022;
const String _videoIdfive = 'https://youtu.be/slXoVn8AL9Y?t=';
const double _startSecondsfive = 0000000000000000000000000001406;
