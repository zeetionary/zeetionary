...
class EnglishEntryliteral extends StatefulWidget {
  const EnglishEntryliteral({super.key});

  @override
  State<EnglishEntryliteral> createState() => _EnglishEntryliteralState();
}

class _EnglishEntryliteralState extends State<EnglishEntryliteral> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: literal
1. Being or reflecting the essential or genuine character of something (- actual, genuine, real)
...
- Noun: literal (Derived forms: literals)
1. A mistake in printed matter resulting from mechanical failures of some kind (- misprint, erratum, typographical error, typo, literal error)
""",
  );

  final String keyword = "literal";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""literal""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The literal meaning of ‘petrify’ is ‘turn to stone’.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her translation is too literal, resulting in unnatural-sounding prose.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her interpretation of the music was too literal.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/hS2x1zl4rn0?t=122';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/dgxPlUgIqSA?t=666';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/R_fZjGm2OrM?t=96';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/gWOXSh4-Iuc?t=856';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/dtp6b76pMak?t=1098';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/_a8u4949t_k?t=82';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """literal""",
                      // alsoEnglishWord: "also: literal",
                      britshText: """IpaUK: /ˈlɪtərəl/""",
                      americanText: """IpaUS: /ˈlɪtərəl/""",
...
کوردی: 
"""),
// With short examples define "literal", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) کە سەرەتاییترین واتای وشەیەک بێت نەک واتای وێژەیی یان خوازراوی"""),
                    SentencesRow(
                      englishText: """The literal meaning of ‘petrify’ is ‘turn to stone’.""",
                      kurdishText: """واتای بنچینەیی 'petrify' 'کردنە بە بەرد'.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵناو) کە هەمان واتای وشە ڕەسەنەکانی هەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her translation is too literal, resulting in unnatural-sounding prose.""",
                      kurdishText: """وەرگێڕانەکەی زۆر دەقاودەقە، بۆیە بووە بە هۆکاری نووسینێکی ناسرووشتی دەرکەوتوو.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ھاوەڵناو) کە هیچ وێنایەکی تێدا نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her interpretation of the music was too literal.""",
                      kurdishText: """تێگەشتنی لە میوزیکەکە زۆر حەقیقی بوو.""",
                      englishNote: """This means her understanding of the music focused only on its exact notes and structure, without adding emotion or creative expression.""",
