...
class EnglishEntryhoarsely extends StatefulWidget {
  const EnglishEntryhoarsely({super.key});

  @override
  State<EnglishEntryhoarsely> createState() => _EnglishEntryhoarselyState();
}

class _EnglishEntryhoarselyState extends State<EnglishEntryhoarsely> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: hoarsely
1. In a hoarse or husky voice (- huskily, throatily)
"'Excuse me,' he said hoarsely";
""",
  );

  final String keyword = "hoarsely";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hoarsely""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """'I can't kiss you,' said Julia hoarsely, 'because I've got a terrible cold.'""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/f9eseIr2US0?t=';
    const double startSecondsone = 000000000000000000000000000935;
    const String videoIdtwo = 'https://youtu.be/RnqpeFJPsBQ?t=';
    const double startSecondstwo = 0000000000000000000000000002441;
    const String videoIdthree = 'https://youtu.be/Q-v-252PY6k?t=';
    const double startSecondsthree = 000000000000000000000000000145;
    const String videoIdfour = 'https://youtu.be/wExK37zBmX8?t=';
    const double startSecondsfour = 0000000000000000000000000006202;
    const String videoIdfive = 'https://youtu.be/0WHJryZ_Bq8?t=';
    const double startSecondsfive = 0000000000000000000000000001143;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hoarsely""",
                      // alsoEnglishWord: "also: hoarsely",
                      britshText: """IpaUK: /ˈhɔːsli/""",
                      americanText: """IpaUS: /ˈhɔːrsli/""",
...
// With short examples define "hoarsely", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """'I can't kiss you,' said Julia hoarsely, 'because I've got a terrible cold.'""",
                      kurdishText:
                          """جولیا بە دەنگی گڕەوە گوتی 'ناتوانم ماچت بکەم، چونکە هەڵامەتم گرتووە.'""",
