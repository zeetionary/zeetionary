...
// Define the word "awkwardness" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace awkwardness - replace EnglishEntryawkwardness

// replace speakAwkwardness - /ˈɔːkwədnəs/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryawkwardness extends StatelessWidget {
  // blank divider
  EnglishEntryawkwardness({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAwkwardness(String languageCode) async {
    // DOPSUM: CHANGE speakAwkwardness
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("awkwardness"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAwkwardnesss1(String languageCode) async {
    // DOPSUM: CHANGE speakAwkwardness
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
  ...
  Future<void> speakAwkwardnesss4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAwkwardnesss44"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAwkwardnesss5(String languageCode) async {
    // DOPSUM: CHANGE speakAwkwardness
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAwkwardnesss55"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAwkwardnesss6(String languageCode) async {
    // DOPSUM: CHANGE speakAwkwardness
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAwkwardnesss66"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAwkwardnesss7(String languageCode) async {
    // DOPSUM: CHANGE speakAwkwardness
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAwkwardnesss77"); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "awkwardness", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˈɔːkwərdnəs/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
2. The quality of an embarrassing situation (= nuisance value)
"he sensed the awkwardness of his proposal";
 
3. The carriage of someone whose movements and posture are ungainly or inelegant (= clumsiness)
 
4. The inelegance of someone stiff and unrelaxed (as by embarrassment) (= clumsiness, gracelessness, stiffness)
...
// end awkwardness // TODO Implement this library.
