...
class EnglishEntryfickle extends StatefulWidget {
  const EnglishEntryfickle({super.key});

  @override
  State<EnglishEntryfickle> createState() => _EnglishEntryfickleState();
}

class _EnglishEntryfickleState extends State<EnglishEntryfickle> {
  @override
  void initState() {
    super.initState();
...
2. Liable to sudden unpredictable change (= erratic, mercurial, quicksilver)
"fickle weather";
""",
  );

  final String keyword = "fickle";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The weather here is notoriously fickle.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She had been a fickle friend, even at the best of times.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fickle""",
                      // alsoEnglishWord: "also: fickle",
                      britshText: """IpaUK: /ˈfɪkl/""",
                      americanText: """IpaUS: /ˈfɪkl/""",
...
// With short examples define "fickle", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The latest downturn in sales shows just what a fickle business this is.""",
                      kurdishText:
                          """کۆتا نزمبوونەوەی فرۆشتن پیشانی دەدات ئەمە چی بازرگانییەکی ناجێگیرە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Q-nWA0WeF98?t=';
const double _startSecondsend = 000000000000000000000000000835;
const String _videoIdone = 'https://youtu.be/qJl1p0W5-y4?t=';
const double _startSecondsone = 000000000000000000000000000234;
const String _videoIdtwo = 'https://youtu.be/kVOTPAxrrP4?t=';
const double _startSecondstwo = 000000000000000000000000000175;
const String _videoIdthree = 'https://youtu.be/O_KpLrHCAx0?t=';
const double _startSecondsthree = 000000000000000000000000000195;
const String _videoIdfour = 'https://youtu.be/riI_uwcmJvU?t=';
const double _startSecondsfour = 000000000000000000000000000571;
const String _videoIdfive = 'https://youtu.be/Lwn6uTEkJyE?t=';
