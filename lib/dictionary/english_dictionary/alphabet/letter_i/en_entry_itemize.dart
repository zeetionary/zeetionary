...
class EnglishEntryitemize extends StatefulWidget {
  const EnglishEntryitemize({super.key});

  @override
  State<EnglishEntryitemize> createState() => _EnglishEntryitemizeState();
}

class _EnglishEntryitemizeState extends State<EnglishEntryitemize> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryitemize itemize
WORD_WEB itemize itemize itemize
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "itemize";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""itemize""");
  }
...
// کوردی:
// """),
// With short examples define "itemize", please follow LX instructions
