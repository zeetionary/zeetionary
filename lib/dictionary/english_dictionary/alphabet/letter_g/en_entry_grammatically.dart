...
class EnglishEntrygrammatically extends StatefulWidget {
  const EnglishEntrygrammatically({super.key});

  @override
  State<EnglishEntrygrammatically> createState() =>
      _EnglishEntrygrammaticallyState();
}

class _EnglishEntrygrammaticallyState extends State<EnglishEntrygrammatically> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "grammatically";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""grammatically""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It is a grammatically correct sentence.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """Children know how to speak grammatically a long time before they learn grammar.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grammatically""",
                      // alsoEnglishWord: "also: grammatically",
                      britshText: """IpaUK: /ɡrəˈmætɪkli/""",
                      americanText: """IpaUS: /ɡrəˈmætɪkli/""",
...
// With short examples define "grammatically", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕستەیەکی ڕێزمانییانە درووستە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بە شێوەیەک کە بە پێی یاساکانی ڕێزمان ڕاستە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Children know how to speak grammatically a long time before they learn grammar.""",
                      kurdishText:
                          """منداڵان فێردەبن چۆن ڕێزمانیانە قسە بکەن ماوەیەکی زۆر پێش ئەوەی فێری ڕێزمان بن.""",
...
const String _videoIdone = 'https://youtu.be/JTslqcXsFd4?t=';
const double _startSecondsone = 000000000000000000000000000565;
const String _videoIdtwo = 'https://youtu.be/9hvjBi4PKWA?t=';
const double _startSecondstwo = 000000000000000000000000000465;
const String _videoIdthree = 'https://youtu.be/-aq1n8MSk8c?t=';
...
const String _videoIdfive = 'https://youtu.be/K9ki5uCZalg?t=';
const double _startSecondsfive = 000000000000000000000000000491;
