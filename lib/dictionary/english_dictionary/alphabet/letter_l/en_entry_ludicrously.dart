...
class EnglishEntryludicrously extends StatefulWidget {
  const EnglishEntryludicrously({super.key});

  @override
  State<EnglishEntryludicrously> createState() => _EnglishEntryludicrouslyState();
}

class _EnglishEntryludicrouslyState extends State<EnglishEntryludicrously> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryludicrously ludicrously
WORD_WEB ludicrously ludicrously ludicrously
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "ludicrously";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ludicrously""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ludicrously""",
                      // alsoEnglishWord: "also: ludicrously",
...
کوردی: 
"""),
// With short examples define "ludicrously", please follow LX instructions
