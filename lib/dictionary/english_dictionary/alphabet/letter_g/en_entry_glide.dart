...
class EnglishEntryglide extends StatefulWidget {
  const EnglishEntryglide({super.key});

  @override
  State<EnglishEntryglide> createState() => _EnglishEntryglideState();
}

class _EnglishEntryglideState extends State<EnglishEntryglide> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Swans went gliding past.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Boats were gliding gracefully on the lake.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""An eagle was gliding high overhead.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The plane managed to glide down to the runway.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She didn't exactly walk - it was more of a glide.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glide""",
                      // alsoEnglishWord: "also: glide",
                      britshText: """IpaUK: /ɡlaɪd/""",
                      americanText: """IpaUS: /ɡlaɪd/""",
...
// With short examples define "glide", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Swans went gliding past.""",
                      kurdishText: """سۆنەکان تێپەڕین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بەلەم لەسەر دەریاچەکە بەجوانی دەچوون.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) ئەوەی بە جووڵی هەوا بفڕیت، بۆ باڵندە بە بێ ئەوەی باڵی بشەقێنێت، و فڕۆکە بە بێ ئەوەی بزوێنەرەکانی کار بکات"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """فڕۆکەکە توانی بنیشێتەوە سەر ڕێڕەوی فڕینەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە ڕاستیدا ڕێی نەدەکرد ـ زیاتر وەک خزان بوو.""",
...
const double _startSecondsone = 000000000000000000000000000264;
const String _videoIdtwo = 'https://youtu.be/wir7jmefyec?t=';
const double _startSecondstwo = 000000000000000000000000000407;
const String _videoIdthree = 'https://youtu.be/YttEM8d5uhk?t=';
const double _startSecondsthree = 00000000000000000000000000057;
const String _videoIdfour = 'https://youtu.be/7ijzCB-A76A?t=';
const double _startSecondsfour = 000000000000000000000000000324;
const String _videoIdfive = 'https://youtu.be/vhmtoAYVRSo?t=';
const double _startSecondsfive = 000000000000000000000000000107;
