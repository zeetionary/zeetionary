...
class EnglishEntryadornment extends StatefulWidget {
  const EnglishEntryadornment({super.key});

  @override
  State<EnglishEntryadornment> createState() => _EnglishEntryadornmentState();
}

class _EnglishEntryadornmentState extends State<EnglishEntryadornment> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "adornment";
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'aZw9xyfMJ80';
    const double startSecondstwo = 471;
    const String videoIdthree = 'x5SDu9huoTA';
    const double startSecondsthree = 35;
    const String videoIdfour = 'dIES7oFtPbI';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """adornment""",
                      // alsoEnglishWord: "also: adornment",
                      britshText: """IpaUK: /əˈdɔːnmənt/""",
                      americanText: """IpaUS: /əˈdɔːrnmənt/""",
