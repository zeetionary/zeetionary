...
// Define the word "aspersion" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryaspersion - replace speakAspersion

// replace aspersion - /əˈspɜːʃnz/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryaspersion extends StatelessWidget {
  // blank divider
  EnglishEntryaspersion({super.key});
  // blank divider
  ...
  Future<void> speakaspersion(String languageCode) async {
    ...
    await flutterTts.speak("aspersion");
  }
  ...
  Future<void> speakaspersion518(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("I wouldn't want to cast aspersions on your honesty.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "aspersion"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈspɜːʃnz/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈspɜːrʒnz/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakaspersion518("en-US"),
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'ml5H4dQkvMY';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '_mGFeOwjfbs';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'n-EJYtFFeDs';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'XA6ISKKH5z8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Q3Z3qxLNQOk';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'qXzGEmt4CvI';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final double _startSeconds = 5795;
