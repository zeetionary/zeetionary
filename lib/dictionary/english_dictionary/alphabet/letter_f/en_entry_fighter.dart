...
class EnglishEntryfighter extends StatefulWidget {
  const EnglishEntryfighter({super.key});

  @override
  State<EnglishEntryfighter> createState() => _EnglishEntryfighterState();
}

class _EnglishEntryfighterState extends State<EnglishEntryfighter> {
  @override
  void initState() {
    super.initState();
...
3. Someone who fights for a cause (= champion, hero, paladin [archaic])
""",
  );

  final String keyword = "fighter";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fighter""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The supersonic fighter plane was shot down by a missile.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Rebel fighters still control most of the city.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fighter""",
                      // alsoEnglishWord: "also: fighter",
                      britshText: """IpaUK: /ˈfaɪtə(r)/""",
                      americanText: """IpaUS: /ˈfaɪtər/""",
...
// With short examples define "fighter", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """فڕۆکە شەڕکەرە دەنگبڕەکە بە مووشەکێک خرایە خوارەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The fighters are equipped with the latest radar technology.""",
                      kurdishText:
                          """فڕۆکە شەڕکەرەکان تازەترین تەکنەلۆژیای ڕاداریان پێوە بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She is a true fighter and she is resolved to beat this disease.""",
                      kurdishText:
                          """جەنگاوەرێکی کۆڵنەدەرە و سوورە لەسەر بەزاندنی ئەم نەخۆشییە.""",
...
const String _videoIdone = 'https://youtu.be/GeOUZ_pIwB4?t=';
const double _startSecondsone = 000000000000000000000000000151;
const String _videoIdtwo = 'https://youtu.be/YO6dUWjVmvI?t=';
...
const String _videoIdfive = 'https://youtu.be/k7YVxLLIuGM?t=';
