...
class EnglishEntryhereditary extends StatefulWidget {
  const EnglishEntryhereditary({super.key});

  @override
  State<EnglishEntryhereditary> createState() => _EnglishEntryhereditaryState();
}

class _EnglishEntryhereditaryState extends State<EnglishEntryhereditary> {
  @override
  void initState() {
    super.initState();
...
1. Occurring among members of a family usually by heredity (- familial, genetic, inherited, transmitted, transmissible)
"hereditary traits";
 
2. (law) inherited or inheritable by established rules (usually legal rules) of descent (- ancestral, patrimonial, transmissible)
"hereditary monarchy";
""",
  );

  final String keyword = "hereditary";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hereditary""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Hair loss is often hereditary.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Epilepsy is hereditary in her family.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hereditary""",
                      // alsoEnglishWord: "also: hereditary",
                      britshText: """IpaUK: /həˈredɪtri/""",
                      americanText: """IpaUS: /həˈredɪteri/""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/y4DTW4B3Sjs?t=';
const double _startSecondsend = 000000000000000000000000000672;
const String _videoIdone = 'https://youtu.be/Lp5uh6ztGJo?t=';
const double _startSecondsone = 000000000000000000000000000189;
const String _videoIdtwo = 'https://youtu.be/qqZ_SH9N3Xo?t=';
const double _startSecondstwo = 000000000000000000000000000730;
const String _videoIdthree = 'https://youtu.be/dzRNswfny3A?t=';
const double _startSecondsthree = 0000000000000000000000000001010;
const String _videoIdfour = 'https://youtu.be/uIsg5x19Xu8?t=';
const double _startSecondsfour = 00000000000000000000000000093;
const String _videoIdfive = 'https://youtu.be/NG4Ws74RV04?t=';
const double _startSecondsfive = 000000000000000000000000000305;
