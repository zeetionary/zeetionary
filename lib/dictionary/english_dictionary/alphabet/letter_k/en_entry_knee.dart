...
class EnglishEntryknee extends StatefulWidget {
  const EnglishEntryknee({super.key});

  @override
  State<EnglishEntryknee> createState() => _EnglishEntrykneeState();
}

class _EnglishEntrykneeState extends State<EnglishEntryknee> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: knee (Derived forms: knees)
1. Hinge joint in the human leg connecting the tibia and fibula with the femur and protected in front by the patella (- knee joint, human knee, articulatio genus, genu)
 
2. Joint between the femur and tibia in a quadruped; corresponds to the human knee (- stifle)
 
3. The part of a trouser leg that provides the cloth covering for the knee

- Verb: knee (Derived forms: knees, kneeing, kneed)
1. Hit with the knee
""",
  );

  final String keyword = "knee";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I had knee surgery three years ago.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I grazed my knee when I fell.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He went down on one knee and asked her to marry him.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He fell to his knees and begged for mercy.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I brushed the dust from the knees of my trousers.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""These jeans are torn at the knee.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Come and sit on Daddy's knee.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She had a blanket draped across her knees.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He kneed his attacker in the groin.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/3YltYCrPZos?t=16';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/pOrc3zADC7k?t=49';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/gAanxnCYWhc?t=8';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/fMFsolDB5yg?t=30';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/ShlL9EHohug?t=73';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/JVc18fb5ApI?t=69';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """knee""",
                      // alsoEnglishWord: "also: knee",
                      britshText: """IpaUK: /niː/""",
                      americanText: """IpaUS: /niː/""",
...
کوردی: ئەژنۆ، چۆک، چۆنگ، ژنۆ، کودک
"""),
// With short examples define "knee", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەژنۆ؛ جومگەی نێوان بەشی سەرەوە و خوارەوەی لاق"""),
                    SentencesRow(
                      englishText: """I had knee surgery three years ago.""",
                      kurdishText:
                          """سێ ساڵ پێش ئێستا نەشتەرگەری ئەژنۆم کرد.""",
                    ...
                    SentencesRow(
                      englishText: """I grazed my knee when I fell.""",
                      kurdishText: """ئەژنۆمم داڕووشاند کە کەوتم.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Bend your knees until you feel your thigh muscles working.""",
                      kurdishText:
                          """ئەژنۆکانت بچەمێنەوە تاوەکو هەست دەکەیت ماسولکەکانی ڕانت دەجووڵێن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کەوتە سەر یەک ئەژنۆ و داوای لێکرد هاوسەرگیری لەگەڵ بکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کەوتە سەر ئەژنۆی تکای بەخشینی کرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ئەو بەشەی جل کە سەر ئەژنۆ دادەپۆشێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I brushed the dust from the knees of my trousers.""",
                      kurdishText:
                          """خۆڵەکەم لە سەرئەژنۆی شەرواڵەکەم تەکاند.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """These jeans are torn at the knee.""",
                      kurdishText: """ئەم کابۆیانە لە سەر ئەژنۆ دڕاون.""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ناو) بەشی سەرەوەی لاق کە دادەنیشیت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: lap"),
                    SentencesRow(
                      englishText: """Come and sit on Daddy's knee.""",
                      kurdishText: """وەرە و لە کۆشی بابە دابنیشە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بەتانییەکی کێشا بوو بە باوەشیدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەژنۆی بە ناوگەڵی هێرشکارەکەدا.""",
