...
class EnglishEntryale extends StatefulWidget {
  const EnglishEntryale({super.key});

  @override
  State<EnglishEntryale> createState() => _EnglishEntryaleState();
}

class _EnglishEntryaleState extends State<EnglishEntryale> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Widget build(BuildContext context) {
    const String videoIdend = 'BCGRSQ6GSKM';
    const double startSecondsend = 17;
    const String videoIdone = 'eFMLO396aPY';
    const double startSecondsone = 1;
    const String videoIdtwo = '0XuprES_geo';
    const double startSecondstwo = 127;
    const String videoIdthree = 'WpucGoO0kQ8';
    const double startSecondsthree = 346;
    const String videoIdfour = '3qW4hkMGkDQ';
    const double startSecondsfour = 10;
    const String videoIdfive = 'Oic24eEK7yc';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ale""",
                      // alsoEnglishWord: "also: ale",
                      britshText: """IpaUK: /eɪl/""",
                      americanText: """IpaUS: /eɪl/""",
