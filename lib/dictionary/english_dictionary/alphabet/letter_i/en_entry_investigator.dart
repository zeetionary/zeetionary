...
class EnglishEntryinvestigator extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""investigator""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'eTvrSLFWmLo';
    ...
    const double startSecondstwo = 1191;
    const String videoIdthree = 'Mx8JkGHaGUI';
    const double startSecondsthree = 1702;
    const String videoIdfour = 'raSeaAeryWE';
    const double startSecondsfour = 1581;
    const String videoIdfive = 'XEZfGlyLQnA';
