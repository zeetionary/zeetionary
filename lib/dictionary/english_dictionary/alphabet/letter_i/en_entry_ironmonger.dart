...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'icFxTrhfI3s';
    const double startSecondsend = 555;
    const String videoIdone = 'GMgP-4O99qU';
    const double startSecondsone = 20;
    const String videoIdtwo = '2sPyzDeRvgs';
    const double startSecondstwo = 585;
    const String videoIdthree = 'BYI91BpDyJ8';
    const double startSecondsthree = 1008;
    const String videoIdfour = 'BY5ZcvgHDvo';
    const double startSecondsfour = 315;
    const String videoIdfive = '7MPIwc-wfkM';
