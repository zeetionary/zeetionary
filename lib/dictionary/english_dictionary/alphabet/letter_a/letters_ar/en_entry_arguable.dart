...
class EnglishEntryarguable extends StatelessWidget {
  ...
  Future<void> speakarguable(String languageCode) async {
    ...
    await flutterTts.speak("arguable");
  }
  ...
  Future<void> speakarguable1013(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("It is arguable which way is quicker.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arguable"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɑːɡjuəbl/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrɡjuəbl/"),
...
کوردی: جێی‌گومان، گومان‌لەسەر، مشت‌ومڕلەسەر، قسەلەسەر، نامسۆگەر، شیاوی بەڵگەھێنانەوە
"""),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'TM_s9lkFfTQ';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'Oos0BdVnAR8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'kr8gSdJ_Ggw';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'v1MZkVJz90Q';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'riB39LVbAG0';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final double _startSeconds = 4981;
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'r4ULWwMPfqA';
