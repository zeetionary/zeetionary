...
class EnglishEntryincognito extends StatefulWidget {
  const EnglishEntryincognito({super.key});

  @override
  State<EnglishEntryincognito> createState() => _EnglishEntryincognitoState();
}

class _EnglishEntryincognitoState extends State<EnglishEntryincognito> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incognito""");
  }
