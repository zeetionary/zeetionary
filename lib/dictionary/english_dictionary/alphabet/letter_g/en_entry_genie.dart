...
class EnglishEntrygenie extends StatefulWidget {
  const EnglishEntrygenie({super.key});

  @override
  State<EnglishEntrygenie> createState() => _EnglishEntrygenieState();
}

class _EnglishEntrygenieState extends State<EnglishEntrygenie> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """genie""",
                      // alsoEnglishWord: "also: genie",
                      britshText: """IpaUK: /ˈdʒiːni/""",
                      americanText: """IpaUS: /ˈdʒiːni/""",
...
// کوردی: جنۆکە، جن
// """),
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) جنۆکە، جن"""),
//                     SentencesRow(
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Rg4Tu6p7A3Y?t=';
...
const String _videoIdthree = 'https://youtu.be/bCxm7cTpBAs?t=';
const double _startSecondsthree = 0000000000000000000000000007;
const String _videoIdfour = 'https://youtu.be/Ov2rndaPlwA?t=';
const double _startSecondsfour = 00000000000000000000000000060;
const String _videoIdfive = 'https://youtu.be/rr2XfL_df3o?t=';
