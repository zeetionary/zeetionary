...
class EnglishEntryexistent extends StatefulWidget {
  const EnglishEntryexistent({super.key});

  @override
  State<EnglishEntryexistent> createState() => _EnglishEntryexistentState();
}

class _EnglishEntryexistentState extends State<EnglishEntryexistent> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""existent""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """existent""",
                      // alsoEnglishWord: "also: existent",
                      britshText: """IpaUK: /ɪɡˈzɪstənt/""",
                      americanText: """IpaUS: /ɪɡˈzɪstənt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The problem is existent in many areas.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Existent evidence supports the theory.""");
  }
...
کوردی: 
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) کە بوونی هەیە"""),
          SentencesRow(
            englishText: """The problem is existent in many areas.""",
            kurdishText: """کێشەکە لە زۆر ناوچە بوونی هەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Existent evidence supports the theory.""",
            kurdishText: """بەڵگەی بەردەست پشتگیری ئەم بیردۆزە دەکات.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: existent
1. Having existence, being or actuality (= existing)
"an attempt to refine the existent machinery to make it more efficient";
 
2. Being or occurring in fact or actuality; having verified existence; not illusory (= real)
"existent objects";
 
3. Presently existing in fact and not merely potential or possible (= actual)
"the predicted temperature and the existent temperature were markedly different";
""",
  );
...
const double _startSecondsend = 000000000000000000000000000000; // 679;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/st8-EY71K84?t=';
const double _startSecondsone = 00000000000000000000000000000; // 117;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/prvXCuEA1lw?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1059;
const String _videoIdthree = 'VIDEOhttps://youtu.be/IGoC4sYmybE?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1522;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/2ZAc0xC9hbw?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 95;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/2H5uWPdAj7M?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1011;
