...
class EnglishEntryhelplessly extends StatefulWidget {
  const EnglishEntryhelplessly({super.key});

  @override
  State<EnglishEntryhelplessly> createState() => _EnglishEntryhelplesslyState();
}

class _EnglishEntryhelplesslyState extends State<EnglishEntryhelplessly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: helplessly
1. In a helpless manner (- impotently)
"the crowd watched him helplessly";
""",
  );

  final String keyword = "helplessly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""helplessly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They watched helplessly as their home went up in flames.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Both sisters started to laugh helplessly.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """helplessly""",
                      // alsoEnglishWord: "also: helplessly",
                      britshText: """IpaUK: /ˈhelpləsli/""",
                      americanText: """IpaUS: /ˈhelpləsli/""",
...
کوردی: داماوانە، بە داماوی، دەستبەستراوانە
"""),
// With short examples define "helplessly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە ئەوە پیشان دەدات ناتوانیت شتێک بکەیت لە دۆخێکی دیاریکراودا"""),
                    SentencesRow(
                      englishText:
                          """They watched helplessly as their home went up in flames.""",
                      kurdishText:
                          """دەستبەستراوانە سەیریان کرد کە خانووەکەیان لە بڵێسەی ئاگردا بوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بە شێوەیەک کە ئەوە پیشان دەدات کە ناتوانیت دۆخێکی دیاریکراو کۆنترۆڵ بکەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Both sisters started to laugh helplessly.""",
                      kurdishText:
                          """هەردوو خوشکەکە دەستیان کرد بەوەی کۆنترۆڵ‌نەکراوانە پێبکەنن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/JcpboMScfIY?t=';
const double _startSecondsend = 0000000000000000000000000001532;
...
const String _videoIdthree = 'https://youtu.be/eZStocbI6O0?t=';
const double _startSecondsthree = 0000000000000000000000000002562;
const String _videoIdfour = 'https://youtu.be/Hzv8E3z1nx8?t=';
const double _startSecondsfour = 000000000000000000000000000441;
const String _videoIdfive = 'https://youtu.be/P8A4ivmCCk4?t=';
const double _startSecondsfive = 000000000000000000000000000331;
