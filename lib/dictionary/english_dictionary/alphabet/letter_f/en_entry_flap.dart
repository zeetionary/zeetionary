...
کوردی: درگا، سەر، زمانە (گیرفان، بەرگ و هتد)،	دەنگی شەقەشەق، شەق‌وکوت،	فلەپ، پەردەباڵ، باڵۆچکەی زیادی جووڵۆک، باڵەجووڵە، شەقەباڵ، دەربیجەی باڵ (بەشێ لە باڵی فڕۆکە بۆ کۆنتڕۆڵی بەرز یان نەوی‌بووەنەوەی بەکاردێ)،	پەشۆکان، گێژی، سەرسامی، باری نیگەرانی، هەژان، ورووژان،	(میز، فڕۆکە) لا، باڵ، بەشی هەڵواسراوی میز(ی قەدکراو)
"""),
// With short examples define "flap", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پارچەیەک لە پەڕۆ، کانزا، کاغەز، هتد کە لە لایەکەوە دەبەسترێتەوە و دادەدرێتەوە یان شتێک دادەپۆشێت"""),
                    SentencesRow(
                      englishText:
                          """The officer undid the flap of his holster and drew his gun.""",
                      kurdishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لەسەر بچووکترین شت دەهەژێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هاری لە کەمێک شڵەژاندایە بۆ چاوپێکەوتنەکەی سبەی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She claimed to have had an affair with the candidate, which produced a huge media flap.""",
                      kurdishText:
                          """بانگەشەی ئەوەی کرد کە پەیوەندیی سۆزداری هەبووبێت لەگەڵ بەربژێرەکە کە ڕەخنەیەکی توندی میدیای لێکەوتەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The pilot lowered the flaps as the aircraft came into land.""",
                      kurdishText:
                          """فڕۆکەوانەکە فلاپەکانی داگرت کە فڕۆکەکە هاتە سەر زەوی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """There's no need to flap—I've got everything under control.""",
                      kurdishText:
                          """هیچ هۆکارێک بۆ شڵەژان نییە ـ هەموو شتێک لەژێر کۆنترۆڵمە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/_RSojioTtUU?t=';
const double _startSecondsend = 000000000000000000000000000720;
const String _videoIdone = 'https://youtu.be/LDP08F3op80?t=';
const double _startSecondsone = 000000000000000000000000000107;
const String _videoIdtwo = 'https://youtu.be/9TugA_z5vQE?t=';
const double _startSecondstwo = 0000000000000000000000000001128;
const String _videoIdthree = 'https://youtu.be/erDE9B-X7mk?t=';
const double _startSecondsthree = 000000000000000000000000000320;
const String _videoIdfour = 'https://youtu.be/B35E8QleVhg?t=';
const double _startSecondsfour = 000000000000000000000000000109;
const String _videoIdfive = 'https://youtu.be/KQWGHE7NTUA?t=';
const double _startSecondsfive = 000000000000000000000000000634;
