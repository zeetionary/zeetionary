...
"""),
// With short examples define "hide", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پەڕە تایبەتییەکانم بە شاردراوەیی دەهێڵمەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خۆمان لە هێرشکارەکانمان شاردەوە لە ماڵێکی چۆڵدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هیچ بڕە مەیکەپێک نەیدەتوانی تەمەنی بشارێتەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (کردار) هێشتنەوەی شتێک بە شاراوەیی، بە تایبەتی هەستەکانت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: conceal"),
                    SentencesRow(
                      englishText:
                          """They didn't try to hide the fact that the film was a remake.""",
                      kurdishText:
                          """هەوڵیان نەدا ئەو ڕاستییە بشارنەوە کە فیلمەکە دووبارە درووستکراو بوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٥. (ناو) پێستی بەهێز و ئەستووری ئاژەڵێک کە بۆ درووستکردنی چەرم بەکاردێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/khOUvmOQExc?t=';
const double _startSecondsend = 000000000000000000000000000459;
const String _videoIdone = 'https://youtu.be/zmEv7vTOQGE?t=';
const double _startSecondsone = 000000000000000000000000000979;
const String _videoIdtwo = 'https://youtu.be/BxWw8AO4ZmI?t=';
const double _startSecondstwo = 000000000000000000000000000117;
const String _videoIdthree = 'https://youtu.be/tsxmyL7TUJg?t=';
const double _startSecondsthree = 000000000000000000000000000783;
const String _videoIdfour = 'https://youtu.be/HDntl7yzzVI?t=';
const double _startSecondsfour = 000000000000000000000000000983;
const String _videoIdfive = 'https://youtu.be/CvjoXdC-WkM?t=';
const double _startSecondsfive = 000000000000000000000000000159;
