...
// replace these: replace EnglishEntryalludeto - replace speakAlludeto - replace allude to - /əˈluːd tə/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryalludeto extends StatelessWidget {
  EnglishEntryalludeto({super.key});
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈluːd tə/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈluːd tə/"),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'sULBN9ptwsg';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'SFZrC8Y7ALc';
