...
class EnglishEntryinterim extends StatefulWidget {
  const EnglishEntryinterim({super.key});

  @override
  State<EnglishEntryinterim> createState() => _EnglishEntryinterimState();
}

class _EnglishEntryinterimState extends State<EnglishEntryinterim> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""interim""");
  }
