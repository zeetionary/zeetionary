...
class EnglishEntryfavouritism extends StatefulWidget {
  const EnglishEntryfavouritism({super.key});

  @override
  State<EnglishEntryfavouritism> createState() =>
      _EnglishEntryfavouritismState();
}

class _EnglishEntryfavouritismState extends State<EnglishEntryfavouritism> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""favouritism""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """favouritism""",
                      // alsoEnglishWord: "also: favouritism",
                      britshText: """IpaUK: /ˈfeɪvərɪtɪzəm/""",
                      americanText: """IpaUS: /ˈfeɪvərɪtɪzəm/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "favouritism";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The students accused the teacher of favouritism.""");
  }
...
کوردی: جیاوازی‌دانان،	لایەنگری، پشتیوانی لەئەندازبەدەر، جیاوازی‌گەری
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ئەوەی کە بە نادادپەروەرانە لایەنگیری کەسێک بکەیت دژ بە کەسێکی دیکە"""),
          SentencesRow(
            englishText: """The students accused the teacher of favouritism.""",
            kurdishText:
                """خوێندکارەکان مامۆستاکەیان تۆمەتبار کرد بە جیاوازی کردن.""",
          ...
          SentencesRow(
            ...
            kurdishText: """چوار منداڵی هەبوو بەڵام هەرگیز جیاوازی نەدەکردن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: favouritism (Derived forms: favouritisms)
Usage: Brit, Cdn (US: favoritism)
1. An inclination to favour some person or group (= favoritism [US])
 
2. Unfair treatment of a person or group on the basis of prejudice (= discrimination, favoritism [US])
""",
  );
...
const String _videoIdend = 'https://youtu.be/2Vp0J_nH41c?t=';
const double _startSecondsend = 000000000000000000000000000272;
const String _videoIdone = 'https://youtu.be/1RXECZHrr9g?t=';
const double _startSecondsone = 000000000000000000000000000505;
const String _videoIdtwo = 'https://youtu.be/cGJZfDmvf24?t=';
const double _startSecondstwo = 000000000000000000000000000396;
const String _videoIdthree = 'https://youtu.be/yZwADCF4fU8?t=';
const double _startSecondsthree = 00000000000000000000000000094;
const String _videoIdfour = 'https://youtu.be/wrFGCLcD3bo?t=';
const double _startSecondsfour = 000000000000000000000000000128;
const String _videoIdfive = 'https://youtu.be/LqcZ0m0d5pU?t=';
const double _startSecondsfive = 000000000000000000000000000811;
