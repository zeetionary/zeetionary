...
class EnglishEntryillnatured extends StatefulWidget {
  const EnglishEntryillnatured({super.key});

  @override
  State<EnglishEntryillnatured> createState() => _EnglishEntryillnaturedState();
}

class _EnglishEntryillnaturedState extends State<EnglishEntryillnatured> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "ill-natured";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ill-natured""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The allegations are completely misguided and ill-natured.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/AGWsHgn8J_8?t=';
    const double startSecondsend = 000000000000000000000000000768;
    const String videoIdone = 'https://youtu.be/1KTri5LMf2s?t=';
    const double startSecondsone = 000000000000000000000000000148;
    const String videoIdtwo = 'https://youtu.be/TUhwCIHqVOs?t=';
    const double startSecondstwo = 00000000000000000000000000037238;
    const String videoIdthree = 'https://youtu.be/94UmEEIOidE?t=';
    const double startSecondsthree = 000000000000000000000000000287;
    const String videoIdfour = 'https://youtu.be/5Brmzsx92OI?t=';
    const double startSecondsfour = 000000000000000000000000000100;
    const String videoIdfive = 'https://youtu.be/QZ2Md83uIP4?t=';
    const double startSecondsfive = 0000000000000000000000000003136;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ill-natured""",
                      // alsoEnglishWord: "also: ill-natured",
                      britshText: """IpaUK: /ɪl ˈneɪtʃəd/""",
                      americanText: """IpaUS: /ɪl ˈneɪtʃərd/""",
...
کوردی: 
"""),
// With short examples define "ill-natured", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) بێزارکەر، نامیهرەبان، و نادۆست"""),
                    SentencesRow(
                      englishText:
                          """The allegations are completely misguided and ill-natured.""",
                      kurdishText: """تۆمەتەکان تەواو نابەجێ و دوژمنکارانەن.""",
