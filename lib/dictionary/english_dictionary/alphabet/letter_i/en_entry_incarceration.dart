...
class EnglishEntryincarceration extends StatefulWidget {
  const EnglishEntryincarceration({super.key});

  @override
  State<EnglishEntryincarceration> createState() => _EnglishEntryincarcerationState();
}

class _EnglishEntryincarcerationState extends State<EnglishEntryincarceration> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incarceration""");
  }
