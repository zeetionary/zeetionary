...
class EnglishEntryincursion extends StatefulWidget {
  const EnglishEntryincursion({super.key});

  @override
  State<EnglishEntryincursion> createState() => _EnglishEntryincursionState();
}

class _EnglishEntryincursionState extends State<EnglishEntryincursion> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incursion""");
  }
