...
class EnglishEntryinherent extends StatefulWidget {
  const EnglishEntryinherent({super.key});

  @override
  State<EnglishEntryinherent> createState() => _EnglishEntryinherentState();
}

class _EnglishEntryinherentState extends State<EnglishEntryinherent> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inherent""");
  }
