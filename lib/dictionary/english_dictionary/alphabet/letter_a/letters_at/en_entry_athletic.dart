...
// Define the word "athletic" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryathletic - replace speakAthletic

// replace athletic - /æθˈletɪk/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryathletic extends StatelessWidget {
  // blank divider
  EnglishEntryathletic({super.key});
  // blank divider
  ...
  Future<void> speakathletic(String languageCode) async {
    ...
    await flutterTts.speak("athletic");
  }
  ...
  Future<void> speakathletic808(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She looks very athletic.");
  }
  ...
  Future<void> speakathletic813(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("This college has a long tradition of athletic excellence.");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "athletic"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: athletic
1. Vigorously active (= acrobatic, gymnastic)
"an athletic child"; "athletic playing";
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'u4aOgymBGVw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '2SBlO_o1B2s';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'aKhPDprqB_c';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'W-Jucd7Kcx4';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'z29hpBDsbAk';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'qUhYjY6HGpA';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'dnaZq3JuYPw';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'OxXySLvtShk';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'rBr3BeXe9oA';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'agAXIpZx5KU';
  final double _startSeconds = 18;
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'fLzW-0lh16s';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'LlbrTMox--A';
  final double _startSeconds = 1;
