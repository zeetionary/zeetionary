...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'zlg03lfBrEA';
    const double startSecondsend = 541;
    const String videoIdone = 'HG29zeyWn58';
    const double startSecondsone = 595;
    const String videoIdtwo = 'Khsssa7xCR8';
    const double startSecondstwo = 886;
    const String videoIdthree = 'E2rtQFAibEA';
    const double startSecondsthree = 5412;
    const String videoIdfour = 'KIDLu5pVoWM';
    const double startSecondsfour = 596;
    const String videoIdfive = '1Ooogc0CJo0';
