...
class EnglishEntryfurthermost extends StatefulWidget {
  const EnglishEntryfurthermost({super.key});

  @override
  State<EnglishEntryfurthermost> createState() =>
      _EnglishEntryfurthermostState();
}

class _EnglishEntryfurthermostState extends State<EnglishEntryfurthermost> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: furthermost
1. (comparatives of 'far') most remote in space, time or order (- farthermost, farthest, furthest, utmost, uttermost)
"don't go beyond the furthermost tree";
""",
  );

  final String keyword = "furthermost";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""furthermost""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The furthermost house was beyond the hills.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furthermost""",
                      // alsoEnglishWord: "also: furthermost",
                      britshText: """IpaUK: /ˈfɜːðəməʊst/""",
                      americanText: """IpaUS: /ˈfɜːrðərməʊst/""",
...
کوردی: دوورترین، ئەوسەر، لەو پەڕی دووری‌دا
"""),
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە دوورترینە لە شوێنێکەوە"""),
                    SentencesRow(
                      englishText:
                          """The furthermost house was beyond the hills.""",
                      kurdishText: """دوورترین خانوو لەوپەڕی گردەکان بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/3nxjcK4xS9U?t=';
const double _startSecondsend = 00000000000000000000000000075;
const String _videoIdone = 'https://youtu.be/euBWHpd1BmE?t=';
const double _startSecondsone = 00000000000000000000000000011778;
const String _videoIdtwo = 'https://youtu.be/tuvZggWv5cc?t=';
const double _startSecondstwo = 000000000000000000000000000305;
const String _videoIdthree = 'https://youtu.be/l7-N7ontCWg?t=';
const double _startSecondsthree = 000000000000000000000000000456;
const String _videoIdfour = 'https://youtu.be/1Nh_D-6-RuU?t=';
const double _startSecondsfour = 000000000000000000000000000296;
const String _videoIdfive = 'https://youtu.be/GLXM6IiuuLw?t=';
const double _startSecondsfive = 0000000000000000000000000002793;
