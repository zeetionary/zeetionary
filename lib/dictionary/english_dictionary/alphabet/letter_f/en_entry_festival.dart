...
class EnglishEntryfestival extends StatefulWidget {
  const EnglishEntryfestival({super.key});

  @override
  State<EnglishEntryfestival> createState() => _EnglishEntryfestivalState();
}

class _EnglishEntryfestivalState extends State<EnglishEntryfestival> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""festival""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The festival attracts thousands of visitors every year.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The school has taken part in the festival since 1997.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The family always celebrates the Jewish festivals.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """festival""",
                      // alsoEnglishWord: "also: festival",
                      britshText: """IpaUK: /ˈfestɪvl/""",
                      americanText: """IpaUS: /ˈfestɪvl/""",
...
// With short examples define "festival", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """قوتابخانەکە لە ساڵی ١٩٩٧ ــەوە بەژداریی لە فیستیڤاڵەکە کردووە.""",
...
const String _videoIdend = 'https://youtu.be/7GmPzViDotM?t=';
const double _startSecondsend = 00000000000000000000000000026;
const String _videoIdone = 'https://youtu.be/sjDRzahgrTI?t=';
const double _startSecondsone = 00000000000000000000000000011;
const String _videoIdtwo = 'https://youtu.be/zKX9OjNy_NI?t=';
const double _startSecondstwo = 00000000000000000000000000010;
const String _videoIdthree = 'https://youtu.be/Og46rQq-Tpg?t=';
const double _startSecondsthree = 0000000000000000000000000007;
const String _videoIdfour = 'https://youtu.be/fC993hX_E4Q?t=';
const double _startSecondsfour = 00000000000000000000000000028;
const String _videoIdfive = 'https://youtu.be/SSi3NRjitTI';
