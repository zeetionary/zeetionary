...
class EnglishEntryhiding extends StatefulWidget {
  const EnglishEntryhiding({super.key});

  @override
  State<EnglishEntryhiding> createState() => _EnglishEntryhidingState();
}

class _EnglishEntryhidingState extends State<EnglishEntryhiding> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hiding (Derived forms: hidings)
1. The activity of keeping something secret (- concealment, concealing)
 
2. The state of being hidden
"he went into hiding"
 
3. [informal] The act of inflicting corporal punishment with repeated blows (- beating, thrashing, licking, drubbing, lacing, trouncing, whacking)
""",
  );

  final String keyword = "hiding";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We spent months in hiding.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The team got a hiding in their last game.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""If you break that vase, you'll get a good hiding.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hiding""",
                      // alsoEnglishWord: "also: hiding",
                      britshText: """IpaUK: /ˈhaɪdɪŋ/""",
                      americanText: """IpaUS: /ˈhaɪdɪŋ/""",
...
کوردی: شاردنەوە، ڤەشارتن، لەبەرچاولابردن، پەنادان، بزرکردن، حەشاردان
"""),
// With short examples define "hiding", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) ئەوەی شتێک شاردرابێتەوە"""),
                    SentencesRow(
                      englishText: """We spent months in hiding.""",
                      kurdishText:
                          """چەندین مانگمان لە خۆحەشاردان بەسەر برد.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He only came out of hiding ten years after the war was over.""",
                      kurdishText:
                          """لە خۆحەشاردان دەرچوو تەنها دوای ئەوەی دە ساڵ بەسەر جەنگ تێپەڕی.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) ئەوەی شتێک بشاریتەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I could understand the hiding of certain military secrets.""",
                      kurdishText:
                          """تێدەگەشتم لە شاردنەوەی هەندێک لە نهێنی دیاریکراوی سەربازی.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) سزای جەستەیی، بە تایبەتی ئەوەی کە بۆ ماوەیەکی زۆر لێت بدرێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: beating"),
                    SentencesRow(
                      englishText:
                          """The team got a hiding in their last game.""",
                      kurdishText:
                          """(خوازراوی) تیمەکە لە یاری کۆتایی‌یدا کوترا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """If you break that vase, you'll get a good hiding.""",
                      kurdishText:
                          """ئەگەر گۆزەکە بشکێنیت کوتەکێکی باش ئەخۆیت.""",
...
const String _videoIdone = 'https://youtu.be/fBTjbGfHx0s?t=';
const double _startSecondsone = 0000000000000000000000000001292;
const String _videoIdtwo = 'https://youtu.be/y4DTW4B3Sjs?t=';
const double _startSecondstwo = 000000000000000000000000000811;
const String _videoIdthree = 'https://youtu.be/XxtYu9kXJl0?t=';
const double _startSecondsthree = 000000000000000000000000000440;
const String _videoIdfour = 'https://youtu.be/6y8BiXC8c98?t=';
const double _startSecondsfour = 000000000000000000000000000348;
const String _videoIdfive = 'https://youtu.be/rTNbZrmnIyc?t=';
const double _startSecondsfive = 000000000000000000000000000608;
