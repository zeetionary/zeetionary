...
class EnglishEntryhaunch extends StatefulWidget {
  const EnglishEntryhaunch({super.key});

  @override
  State<EnglishEntryhaunch> createState() => _EnglishEntryhaunchState();
}

class _EnglishEntryhaunchState extends State<EnglishEntryhaunch> {
  @override
  void initState() {
    super.initState();
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بەشی سەرەوەی لاق و سمت؛ ئەم بەشەی ئاژەڵێک کە چوار لاقی ھەیە"""),
                    SentencesRow(
                      englishText:
...
const String _videoIdend = 'sfJxmorY4DY';
const double _startSecondsend = 60;
const String _videoIdone = 'EnTrExZo46U';
const double _startSecondsone = 127;
const String _videoIdtwo = 'f5XhEdGzQOc';
const double _startSecondstwo = 1052;
const String _videoIdthree = 'MFPjygCuYrE';
const double _startSecondsthree = 346;
const String _videoIdfour = 'OWPj3DG68SQ';
const double _startSecondsfour = 523;
const String _videoIdfive = 'FxtnJjdNhMQ';
const double _startSecondsfive = 902;
