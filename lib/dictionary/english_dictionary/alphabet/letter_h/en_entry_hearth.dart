...
class EnglishEntryhearth extends StatefulWidget {
  const EnglishEntryhearth({super.key});

  @override
  State<EnglishEntryhearth> createState() => _EnglishEntryhearthState();
}

class _EnglishEntryhearthState extends State<EnglishEntryhearth> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hearth (Derived forms: hearths)
1. An open recess in a wall at the base of a chimney where a fire can be built (- fireplace, open fireplace)
"he laid a fire in the hearth and lit it"; "the hearth was black with the charcoal of many fires";
 
2. Home symbolized as a part of the fireplace (- fireside)
"driven from hearth and home";
 
3. An area near a fireplace (usually paved and extending out into a room) (- fireside)
"they sat on the hearth and warmed themselves before the fire";
""",
  );

  final String keyword = "hearth";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A bright fire was burning in the hearth.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They were reluctant to leave hearth and home.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hearth""",
                      // alsoEnglishWord: "also: hearth",
                      britshText: """IpaUK: /hɑːθ/""",
                      americanText: """IpaUS: /hɑːrθ/""",
...
کوردی: 
"""),
// With short examples define "hearth", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) بەشی خوارەوەی ئاگردان"""),
                    SentencesRow(
                      englishText:
                          """A bright fire was burning in the hearth.""",
                      kurdishText: """ئاگرێکی گەش لە ئاگردانەکەدا دەگیرسا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ماڵێک، بە تایبەتی کە وەک شوێنی خۆشەویستی و ئاسوودەیی دەبیندرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """They were reluctant to leave hearth and home.""",
                      kurdishText:
                          """نابەدڵ بوون کە لانە و قوژبنیان جێبهێڵن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/D2yzondJyB8?t=';
const double _startSecondsend = 000000000000000000000000000325;
const String _videoIdone = 'https://youtu.be/z56d4f1uT3k?t=';
const double _startSecondsone = 000000000000000000000000000528;
const String _videoIdtwo = 'https://youtu.be/190emwcnYJ4?t=';
const double _startSecondstwo = 00000000000000000000000000069;
const String _videoIdthree = 'https://youtu.be/mBxRFw9W_xs?t=';
const double _startSecondsthree = 000000000000000000000000000216;
const String _videoIdfour = 'https://youtu.be/2O4t_oWgHF8?t=';
const double _startSecondsfour = 000000000000000000000000000909;
const String _videoIdfive = 'https://youtu.be/KhSbEsFtvFs?t=';
const double _startSecondsfive = 000000000000000000000000000553;
