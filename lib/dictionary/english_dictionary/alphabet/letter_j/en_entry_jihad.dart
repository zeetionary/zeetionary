...
class EnglishEntryjihad extends StatefulWidget {
  const EnglishEntryjihad({super.key});

  @override
  State<EnglishEntryjihad> createState() => _EnglishEntryjihadState();
}

class _EnglishEntryjihadState extends State<EnglishEntryjihad> {
  @override
  void initState() {
    super.initState();
