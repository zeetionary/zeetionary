...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = '-HyHZsa79LU';
    const double startSecondsone = 340;
    const String videoIdtwo = '8HEfIJlcFbs';
    const double startSecondstwo = 216;
    const String videoIdthree = 'y1sF6ZeASU0';
    const double startSecondsthree = 1282;
    const String videoIdfour = 'CQc7LMVlnOc';
    const double startSecondsfour = 79;
    const String videoIdfive = 'od6Zq5T57R0';
    const double startSecondsfive = 127;
