...
// replace these: replace EnglishEntryagility - replace speakAgility - replace agility - /əˈdʒɪləti/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryagility extends StatelessWidget {
  EnglishEntryagility({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAgility(String languageCode) async {
    // DOPSUM: CHANGE speakAgility
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("agility"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAgility1562(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("He has the agility of a mountain goat."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAgilit48966(String languageCode) async {
    ...
    await flutterTts.speak(
        "We underestimate the agility of a child's mind."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈdʒɪləti/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'JEVJaUsDAvw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'ko3rCOeFu-o';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'Ge2zgGnlV-0';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'gxFtEyTkKvI';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'LsZq6_wZAHM';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = '5mqY7VnhVGs';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'F6ejGzsYQFI';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'AN10gGJD36I';
