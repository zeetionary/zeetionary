...
// replace these: replace EnglishEntryagelimit - replace speakAgelimit - replace age limit - /ˈeɪdʒ lɪmɪt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryagelimit extends StatelessWidget {
  EnglishEntryagelimit({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAgelimit(String languageCode) async {
    // DOPSUM: CHANGE speakAgelimit
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈeɪdʒ lɪmɪt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'Q7sSxKsj1II';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'RIPnuRI6Pb0';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'PnDgZuGIhHs';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'dNY5YGRkNqs';
