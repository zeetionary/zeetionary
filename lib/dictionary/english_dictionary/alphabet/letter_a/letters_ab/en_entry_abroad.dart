...
class EnglishEntryabroad extends StatelessWidget {
  EnglishEntryabroad({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'abroad', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈbrɔːd/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /əˈbrɔːd/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
١. (ھاوەڵکار) پەیوەندیدار بە وڵاتێکی بیانی''',
                          ...
                          const Text(
                            // DOPSUM: WRITE DEFINITION IN KURDISH. COPY FOR ANOTHER DEFINITION
                            '''
١. شتێک کە لەلایەن زۆر کەسەوە باس دەکرێت''',
                            style: TextStyle(fontSize: 18),
                            textAlign: TextAlign.right,
                          ),
                          Row(
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'EWX0bbGAd0k';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'wuPIqYFBfUk';
