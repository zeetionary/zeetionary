...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'XbxRqlHtKUE';
    const double startSecondsend = 201;
    const String videoIdone = '9A49p8lkmuM';
    const double startSecondsone = 314;
    const String videoIdtwo = 'gxR_ktz18Q0';
    const double startSecondstwo = 284;
    const String videoIdthree = 'dg86BVdufyI';
    const double startSecondsthree = 141;
    const String videoIdfour = 'X0i5ndMWSBM';
    const double startSecondsfour = 243;
    const String videoIdfive = 'xav31sXLn2g';
