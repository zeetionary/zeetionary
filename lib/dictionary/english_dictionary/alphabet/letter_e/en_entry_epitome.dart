...
class EnglishEntryepitome extends StatefulWidget {
  const EnglishEntryepitome({super.key});

  @override
  State<EnglishEntryepitome> createState() => _EnglishEntryepitomeState();
}

class _EnglishEntryepitomeState extends State<EnglishEntryepitome> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""epitome""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """epitome""",
                      // alsoEnglishWord: "also: epitome",
                      britshText: """IpaUK: /ɪˈpɪtəmi/""",
                      americanText: """IpaUS: /ɪˈpɪtəmi/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He is the epitome of a modern young man.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They regarded him as the epitome of evil.""");
  }
...
// With short examples define "epitome", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: نموونە، میناک، هێما،	کورتە، پوختە، نموونەی تەواو، سەرنموونە
"""),
          const DefinitionKurdish(text: """١. (ناو) نموونەی تەواوی شتێک"""),
          SentencesRow(
            englishText: """He is the epitome of a modern young man.""",
            kurdishText: """نموونەی تەواوی پیاوێکی گەنجی سەردەمیانەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """They regarded him as the epitome of evil.""",
            kurdishText: """بە وێنای شەیتان دایدەنێن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: epitome (Derived forms: epitomes)
1. A standard, typical or perfect example (= embodiment, prototype, paradigm, image)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/ewLpXw6uN28?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1573;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/Un1gfVckcVw?t=';
const double _startSecondsone = 00000000000000000000000000000; // 343;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/5wcPcb_R0Ek?t=';
const double _startSecondstwo = 00000000000000000000000000000; // ڤ;
const String _videoIdthree = 'VIDEOhttps://youtu.be/Wxdj970RM7M?t=';
const double _startSecondsthree = 000000000000000000000000000; // 387;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/_V_HjDMU6js?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 209;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/CwlTFQqdI3I?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 414;
