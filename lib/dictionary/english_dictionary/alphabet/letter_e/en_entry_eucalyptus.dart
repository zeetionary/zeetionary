...
class EnglishEntryeucalyptus extends StatefulWidget {
  const EnglishEntryeucalyptus({super.key});

  @override
  State<EnglishEntryeucalyptus> createState() => _EnglishEntryeucalyptusState();
}

class _EnglishEntryeucalyptusState extends State<EnglishEntryeucalyptus> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""eucalyptus""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """eucalyptus""",
                      // alsoEnglishWord: "also: eucalyptus",
                      britshText: """IpaUK: /ˌjuːkəˈlɪptəs/""",
                      americanText: """IpaUS: /ˌjuːkəˈlɪptəs/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "eucalyptus";
...
کوردی: داری کافوور یان قەڵەم‌تۆز، قەڵەمتۆز
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) دارێکی بەرزی ڕاست کە گەڵاکانی زەیتێک بەرهەم دەهێنن کە بۆنێکی توندی هەیە کە لە پزیشکیدا بەکاردێت. دارەکە چەند جۆرێکی هەیە و بە تایبەتی لە ئوسترالیا گەشە دەکەن."""),
          SentencesRow(
            englishText:
                """Koalas eat very few things besides eucalyptus leaves.""",
            kurdishText: """کوالا کەم شت دەخوات جگە لە گەڵای قەڵەمتۆز.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: eucalyptus (Derived forms: eucalyptuses, eucalypti)
1. A tree of the genus Eucalyptus (= eucalypt, eucalyptus tree)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/s3B-qp3U5G0?t=';
const double _startSecondsend = 000000000000000000000000000000; // 606;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/1Gxrwh4zGPg?t=';
const double _startSecondsone = 00000000000000000000000000000; // 925;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/Re-kLhcCxUk?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 2;
const String _videoIdthree = 'VIDEOhttps://youtu.be/a7wC2M0b5u0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 386;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/gNqQL-1gZF8?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 222;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/y-2jd0Ds8Iw?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 291;
