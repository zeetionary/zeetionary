...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 841;
    const String videoIdone = 'lXXDpWMM-q4';
    const double startSecondsone = 42;
    const String videoIdtwo = 'ha7iWECm_8E';
    const double startSecondstwo = 457;
    const String videoIdthree = '7WtsemKE8Rw';
    const double startSecondsthree = 486;
    const String videoIdfour = 'vhAcTYgwsnM';
    const double startSecondsfour = 490;
    const String videoIdfive = 'sXRhgFFQ5jA';
