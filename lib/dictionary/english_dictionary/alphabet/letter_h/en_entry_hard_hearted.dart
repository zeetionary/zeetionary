...
class EnglishEntryhardhearted extends StatefulWidget {
  const EnglishEntryhardhearted({super.key});

  @override
  State<EnglishEntryhardhearted> createState() =>
      _EnglishEntryhardheartedState();
}

class _EnglishEntryhardheartedState extends State<EnglishEntryhardhearted> {
  @override
  void initState() {
    super.initState();
...
1. Devoid of feeling for others (- stonyhearted, unfeeling)
 
2. Lacking in feeling, pity or warmth (- heartless)
""",
  );

  final String keyword = "hard-hearted";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hard-hearted""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He remained hard-hearted despite their tears.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hard-hearted""",
                      // alsoEnglishWord: "also: hard-hearted",
                      britshText: """IpaUK: /ˌhɑːd ˈhɑːtɪd/""",
                      americanText: """IpaUS: /ˌhɑːrd ˈhɑːrtɪd/""",
...
// """),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """سەرەڕای فرمێسکەکانیان بەدڵڕەقی مایەوە.""",
