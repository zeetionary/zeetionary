...
class EnglishEntryharpsichord extends StatefulWidget {
  const EnglishEntryharpsichord({super.key});

  @override
  State<EnglishEntryharpsichord> createState() =>
      _EnglishEntryharpsichordState();
}

class _EnglishEntryharpsichordState extends State<EnglishEntryharpsichord> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: harpsichord (Derived forms: harpsichords)
1. A clavier with strings that are plucked by plectra mounted on pivots (- cembalo)
""",
  );

  final String keyword = "harpsichord";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""harpsichord""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She played a beautiful melody on the harpsichord.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harpsichord""",
                      // alsoEnglishWord: "also: harpsichord",
                      britshText: """IpaUK: /ˈhɑːpsɪkɔːd/""",
                      americanText: """IpaUS: /ˈhɑːrpsɪkɔːrd/""",
...
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئامێرێکی میوزیکی کەمێک کۆن کە وەک پیانۆ وایە بەڵام تەلەکانی ڕادەکێشرێن نەک پەنجەیان پێدا بنرێن"""),
                    SentencesRow(
                      englishText:
                          """She played a beautiful melody on the harpsichord.""",
                      kurdishText: """ئاوازێکی خۆشی ژەنی بە هارپسیکۆردەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/-yE8SYzZ6Eo?t=';
const double _startSecondsend = 000000000000000000000000000289;
const String _videoIdone = 'https://youtu.be/B7XIUxyTi_8?t=';
const double _startSecondsone = 000000000000000000000000000205;
const String _videoIdtwo = 'https://youtu.be/itLh_yWsOX0?t=';
const double _startSecondstwo = 00000000000000000000000000021;
const String _videoIdthree = 'https://youtu.be/gA_ICL0jYWo?t=';
const double _startSecondsthree = 000000000000000000000000000259;
const String _videoIdfour = 'https://youtu.be/L3Pv41Nz9J0';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/Wuq7U6_8xo0?t=';
