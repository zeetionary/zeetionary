...
class EnglishEntryfriendless extends StatefulWidget {
  const EnglishEntryfriendless({super.key});

  @override
  State<EnglishEntryfriendless> createState() => _EnglishEntryfriendlessState();
}

class _EnglishEntryfriendlessState extends State<EnglishEntryfriendless> {
  @override
  void initState() {
    super.initState();
...
1. Excluded from a society (= outcast)
""",
  );

  final String keyword = "friendless";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""friendless""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He died alone and friendless.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """friendless""",
                      // alsoEnglishWord: "also: friendless",
                      britshText: """IpaUK: /ˈfrendləs/""",
                      americanText: """IpaUS: /ˈfrendləs/""",
...
// With short examples define "friendless", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) بەبێ هاوڕێ"""),
                    SentencesRow(
                      englishText: """He died alone and friendless.""",
                      kurdishText: """بە تەنهایی و بێکەس مرد.""",
...
const String _videoIdone = 'https://youtu.be/iZbala54uzk?t=';
const double _startSecondsone = 000000000000000000000000000169;
const String _videoIdtwo = 'https://youtu.be/t-osG0F2MZM?t=';
const double _startSecondstwo = 000000000000000000000000000317;
const String _videoIdthree = 'https://youtu.be/HWl2z48mVNI?t=';
const double _startSecondsthree = 000000000000000000000000000872;
const String _videoIdfour = 'https://youtu.be/jyHIMN-W3Gk?t=';
const double _startSecondsfour = 000000000000000000000000000567;
const String _videoIdfive = 'https://youtu.be/8Hya-sd4sWY?t=';
