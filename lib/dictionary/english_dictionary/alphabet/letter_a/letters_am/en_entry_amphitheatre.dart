                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "amphitheatre"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæmfɪθɪətə(r)/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæmfɪθiːətər/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '7pEeYUdlq6U';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'OLkc7s7jZMg';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'QnBJODYcFsI';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'kjqNsQWi9e4';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Cg5AzNbZGgM';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'qHHpTYmEsao';
  final double _startSeconds = 2166;
