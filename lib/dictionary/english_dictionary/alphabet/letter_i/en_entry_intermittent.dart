...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'jFk-L7Wcg0g';
    const double startSecondsend = 228;
    const String videoIdone = 'CsTmgX32Uk8';
    const double startSecondsone = 334;
    const String videoIdtwo = 'sY8aFSY2zv4';
    const double startSecondstwo = 7617;
    const String videoIdthree = 'FqdxxSWKmw4';
    const double startSecondsthree = 71;
    const String videoIdfour = 'LQ8JOsc3-wU';
    const double startSecondsfour = 274;
    const String videoIdfive = '08mwXICY4JM';
    const double startSecondsfive = 775;
