...
class EnglishEntryfishing extends StatefulWidget {
  const EnglishEntryfishing({super.key});

  @override
  State<EnglishEntryfishing> createState() => _EnglishEntryfishingState();
}

class _EnglishEntryfishingState extends State<EnglishEntryfishing> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fishing
1. The act of someone who fishes as a diversion (= sportfishing)
 
2. The occupation of catching fish for a living
""",
  );

  final String keyword = "fishing";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fishing""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""My dad loves to go fishing.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They often go fishing.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We enjoyed a day's fishing by the river.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fishing""",
                      // alsoEnglishWord: "also: fishing",
                      britshText: """IpaUK: /ˈfɪʃɪŋ/""",
                      americanText: """IpaUS: /ˈfɪʃɪŋ/""",
...
// With short examples define "fishing", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """باوکم حەزدەکات بچێت بۆ ماسیگرتن.""",
                    ...
                    SentencesRow(
                      englishText: """They often go fishing.""",
                      kurdishText: """زۆرجار دەچنە ماسیگرتن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چێژمان لە ڕۆژێکی ماسیگرتن بینی لای ڕووبارەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/0ST4_hmop9Y?t=';
const double _startSecondsend = 0000000000000000000000000001215;
const String _videoIdone = 'https://youtu.be/6j5Rr9hWxz8?t=';
const double _startSecondsone = 000000000000000000000000000921;
const String _videoIdtwo = 'https://youtu.be/c6QYERflO-Y?t=';
const double _startSecondstwo = 000000000000000000000000000459;
const String _videoIdthree = 'https://youtu.be/7YNPbY6deQ0?t=';
const double _startSecondsthree = 000000000000000000000000000111;
const String _videoIdfour = 'https://youtu.be/s6ezEPk_tIo?t=';
const double _startSecondsfour = 000000000000000000000000000109;
const String _videoIdfive = 'https://youtu.be/yG2uv1-baSY?t=';
const double _startSecondsfive = 000000000000000000000000000853;
