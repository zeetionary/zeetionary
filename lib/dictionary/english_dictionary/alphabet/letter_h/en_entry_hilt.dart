...
class EnglishEntryhilt extends StatefulWidget {
  const EnglishEntryhilt({super.key});

  @override
  State<EnglishEntryhilt> createState() => _EnglishEntryhiltState();
}

class _EnglishEntryhiltState extends State<EnglishEntryhilt> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hilt (Derived forms: hilts)
1. The handle of a sword or dagger
""",
  );

  final String keyword = "hilt";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He gripped the hilt of his sword tightly.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdfive = 'https://youtu.be/nm4Ck6bD2_0?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hilt""",
                      // alsoEnglishWord: "also: hilt",
                      britshText: """IpaUK: /hɪlt/""",
                      americanText: """IpaUS: /hɪlt/""",
...
کوردی: کلک(ە)، دەسک، قوڵفە، چەمبەری، قەفت، جێ‌دەس، مشتە، مشتۆ
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) دەسکی شمشێر، چەقۆ، هتد"""),
                    SentencesRow(
                      englishText:
                          """He gripped the hilt of his sword tightly.""",
                      kurdishText:
                          """بە توندی دەستی گرت بە دەسکی شمشێرەکەیەوە.""",
