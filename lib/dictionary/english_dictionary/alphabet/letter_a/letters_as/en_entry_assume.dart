...
// Define the word "assume" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryassume - replace speakAssume

// replace assume - /əˈsjuːm/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryassume extends StatelessWidget {
  // blank divider
  EnglishEntryassume({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "assume"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈsjuːm/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈsuːm/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakassume843("en-US"),
                          ),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakassume844("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
...
٢. (کردار) وەرگرتنی دەسەڵات یان بەرپرسیاریەتی """),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakassume846("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٣. (کردار) ھەبوونی شێوەیەک یان خاسیەتێک """),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakassume848("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٤. (کردار) واپیشاندان بەوەی خاسیەتێک یان ھەستێکی تایبەتت ھەیە """),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakassume851("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
2. Take on titles, offices, duties, responsibilities (= adopt, take on, take over)
"When will the new President assume office?";
 
3. Take on a certain form, attribute, or aspect (= acquire, adopt, take on, take)
"She assumed strange manners"; "The gods assume human or animal form in these fables";
 
4. Take on as one's own the expenses or debts of another person (= bear, take over, accept)
"She agreed to assume the responsibility";
 
5. Occupy or take on (= take, strike, take up)
"He assumes the lotus position";
 
6. Take control of (without authority and possibly with force); take as one's right or possession (= usurp, seize, take over, arrogate)
"He assumed to himself the right to fill all positions in the town";
 
7. Make a pretence of (= simulate, sham, feign)
"She assumed indifference, even though she was seething with anger";
 
8. (Christianity) take up someone's soul into heaven
"This is the day when Mary was assumed into heaven"
 
9. Put clothing on one's body (= wear, put on, get into, don)
