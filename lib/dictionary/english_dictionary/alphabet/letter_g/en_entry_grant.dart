...
class EnglishEntrygrant extends StatefulWidget {
  const EnglishEntrygrant({super.key});

  @override
  State<EnglishEntrygrant> createState() => _EnglishEntrygrantState();
}

class _EnglishEntrygrantState extends State<EnglishEntrygrant> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: grant (Derived forms: granted, grants, granting)
1. Let have; give the right to; give the opportunity or permission to (- allow, accord, allot)
"grant permission"; "grant a privilege";
 
2. Give as judged due or on the basis of merit (- award)
"Funds are granted to qualified researchers";
 
3. Be willing to admit or forced to agree (- concede, yield)
"I grant you this much";
 
4. Allow, esp. in an official capacity (- give)
"grant a degree"; "This bill grants us new rights";
 
5. Give over; surrender or relinquish to the physical control of another (- concede, yield, cede)
 
6. Transfer by deed (- deed over)
"grant land";

- Noun: grant (Derived forms: grants)
1. Any monetary aid
 
2. The act of providing a subsidy (- subsidization, subsidisation [Brit])
 
3. (law) a transfer of property by deed of conveyance (- assignment)
 
4. A contract granting the right to operate a subsidiary business (- concession)
"he got the beer grant at the ball park";
 
5. A right or privilege that has been granted

- Noun: Grant (Derived forms: Grants)
1. 18th President of the United States; commander of the Union armies in the American Civil War (1822-1885) (- Ulysses Grant, Ulysses S. Grant, Ulysses Simpson Grant, Hiram Ulysses Grant, President Grant)
 
2. United States actor (born in England) who was the elegant leading man in many films (1904-1986) (- Cary Grant)
 
3. Scottish painter; cousin of Lytton Strachey and member of the Bloomsbury Group (1885-1978) (- Duncan Grant, Duncan James Corrow Grant)
""",
  );

  final String keyword = "grant";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""My request was granted.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was granted a divorce.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I was granted permission to visit the palace.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The court granted him leave to appeal.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The bank finally granted me a £500 loan.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She's a smart woman, I grant you, but she's no genius.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""There is a lot of competition for research grants.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak(
        """The money is used for small grants to deserving organizations.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grant""",
                      // alsoEnglishWord: "also: grant",
                      britshText: """IpaUK: /ɡrɑːnt/""",
                      americanText: """IpaUS: /ɡrænt/""",
...
// With short examples define "grant", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """My request was granted.""",
                      kurdishText: """داواکەم پەسەندکرا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The judge granted an injunction preventing the newspaper from printing the names.""",
                      kurdishText:
                          """دادوەرەکە دەستوورێکت دەرکرد کە ڕێگری لە ڕۆژنامەکە دەکرد ناوەکان بڵاوبکاتەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She was granted a divorce.""",
                      kurdishText: """جیابوونەوەی پێ بەخشرا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """مۆڵەتم پێدرا کۆشکەکە جێبهێڵم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The court granted him leave to appeal.""",
                      kurdishText: """دادگا مۆڵەتی پەڵپ گرتنی پێدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بانکەکە لە کۆتاییدا قەرزێکی ٥٠٠ پاوەندی پێمدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ژنێکی زیرەکە، دانی پێدا دەنێم، بەڵام هیچ بلیمەت نییە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕکابەری زۆر هەیە بۆ کۆمەکی توێژینەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The money is used for small grants to deserving organizations.""",
                      kurdishText:
                          """پارەکە وەک کۆمەکی بچووک بۆ دامەزراوەی شایستە بەکاردێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The government has awarded a grant for the restoration of the building.""",
                      kurdishText:
                          """حکومەت بڕە پارەیەکی تەرخان کردووە بۆ نۆژەنکردنەوەی بیناکە.""",
...
const String _videoIdtwo = 'https://youtu.be/jUodZ6HqvnY?t=';
const double _startSecondstwo = 00000000000000000000000000065;
const String _videoIdthree = 'https://youtu.be/AFS6saV981Q?t=';
const double _startSecondsthree = 000000000000000000000000000907;
const String _videoIdfour = 'https://youtu.be/_6I90FKwCBI?t=';
const double _startSecondsfour = 00000000000000000000000000054;
const String _videoIdfive = 'https://youtu.be/1IY93VzCa-Y?t=';
const double _startSecondsfive = 000000000000000000000000000672;
