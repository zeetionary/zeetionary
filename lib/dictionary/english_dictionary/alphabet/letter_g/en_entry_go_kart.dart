...
class EnglishEntrygokart extends StatefulWidget {
  const EnglishEntrygokart({super.key});

  @override
  State<EnglishEntrygokart> createState() => _EnglishEntrygokartState();
}

class _EnglishEntrygokartState extends State<EnglishEntrygokart> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""go-kart""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She won the go-kart race against her friends.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """go-kart""",
                      // alsoEnglishWord: "also: go-kart",
                      britshText: """IpaUK: /ˈɡəʊ kɑːt/""",
                      americanText: """IpaUS: /ˈɡəʊ kɑːrt/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئۆتۆمبێلێکی نزمی کە سەرەکەی دانەخراوە و بۆ پێشبڕکێ بەکاردێت"""),
                    SentencesRow(
                      englishText:
                          """She won the go-kart race against her friends.""",
                      kurdishText:
                          """لە پێشبڕکێی گۆکارتدا بەسەر هاوڕێکانیدا سەرکەوت.""",
...
const double _startSecondsone = 0000000000000000000000000002113;
const String _videoIdtwo = 'https://youtu.be/t3e7I0N3XE0?t=';
const double _startSecondstwo = 0000000000000000000000000004;
const String _videoIdthree = 'https://youtu.be/H4BsZTsNMkQ?t=';
const double _startSecondsthree = 000000000000000000000000000173;
const String _videoIdfour = 'https://youtu.be/b4GtGmAEheo?t=';
const double _startSecondsfour = 000000000000000000000000000164;
const String _videoIdfive = 'https://youtu.be/JUjkRIFZ7Do?t=';
const double _startSecondsfive = 000000000000000000000000000556;
