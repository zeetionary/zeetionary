...
class EnglishEntryheadon extends StatefulWidget {
  const EnglishEntryheadon({super.key});

  @override
  State<EnglishEntryheadon> createState() => _EnglishEntryheadonState();
}

class _EnglishEntryheadonState extends State<EnglishEntryheadon> {
  @override
  void initState() {
    super.initState();
...
2. Meeting front to front (- frontal)
"a head-on collision";
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""head-on""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The head-on collision left three people dead.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The cars crashed head-on.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We should have sat down and addressed the issues head-on.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """head-on""",
                      // alsoEnglishWord: "also: head-on",
                      britshText: """IpaUK: /ˌhed ˈɒn/""",
                      americanText: """IpaUS: /ˌhed ˈɑːn/""",
...
کوردی: ڕووبەڕوو، ڕاست، شاخ‌بەشاخ
"""),
// With short examples define "head-on", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) بە شێوەیەک کە بەشی پێشەوەی ئۆتۆمبێلێک لە بەشی پێشەوەی یەکێکی دیکە دەدات"""),
                    SentencesRow(
                      englishText:
                          """The head-on collision left three people dead.""",
                      kurdishText:
                          """پێکدادانەکە ڕووبەڕووەکە سێ کوژراوی لێکەوتەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە تێیدا خەڵکی بۆچوونی توند دەردەبڕن و ڕاسەتەوخۆ مامەڵە لەگەڵ شتێک دەکەن"""),
                    SentencesRow(
                      englishText:
                          """There was a head-on confrontation between management and unions.""",
                      kurdishText:
                          """ڕووبەڕووبوونەوەیەکی ڕاستەوخۆ لە نێوان بەڕێوبەرایەتی و سەندیکاکان ڕوویدا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵکار) بە شێوەیەک کە بە شێوەیەک کە بەشی پێشەوەی ئۆتۆمبێلێک لە بەشی پێشەوەی یەکێکی دیکە یان شتێک دەدات"""),
                    SentencesRow(
                      englishText: """The cars crashed head-on.""",
                      kurdishText: """ئۆتۆمبێلەکان ڕووبەڕوو بە یەکیاندا دا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەبوو دابنیشتاباین و ڕاستەوخۆ باسی کێشەکەمان بکردایە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/1hzFeX6VFis?t=';
const double _startSecondsend = 000000000000000000000000000202;
const String _videoIdone = 'https://youtu.be/U2_kXUJ4HBs?t=';
const double _startSecondsone = 000000000000000000000000000875;
const String _videoIdtwo = 'https://youtu.be/AGqUCKin4X0?t=';
const double _startSecondstwo = 000000000000000000000000000654;
const String _videoIdthree = 'https://youtu.be/Hez55mhB8UA?t=';
const double _startSecondsthree = 000000000000000000000000000100;
const String _videoIdfour = 'https://youtu.be/u429Qgvoxw4?t=';
const double _startSecondsfour = 000000000000000000000000000312;
const String _videoIdfive = 'https://youtu.be/oiLdWXLXDeA?t=';
const double _startSecondsfive = 0000000000000000000000000001197;
