...
class EnglishEntryhydrogenbomb extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hydrogen bomb""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1619;
    const String videoIdone = '3fILUAGw2mE';
    const double startSecondsone = 734;
    const String videoIdtwo = 'Xm6Y3Rl9u1Q';
    const double startSecondstwo = 679;
    const String videoIdthree = 'FU_YFpfDqqA';
    const double startSecondsthree = 908;
    const String videoIdfour = 'EexZjx3YOuQ';
    const double startSecondsfour = 753;
    const String videoIdfive = 'ILgSesWMUEI';
