...
// replace these: replace EnglishEntryalarmclock - replace speakAlarmclock - replace alarm clock - /əˈlɑːm klɒk/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryalarmclock extends StatelessWidget {
  ...
  Future<void> speakalarmclock(String languageCode) async {
    ...
    await flutterTts.speak("alarm clock");
  }
  ...
  Future<void> speakalarmclock349(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I set the alarm clock for 7 o'clock.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈlɑːm klɒk/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈlɑːrm klɑːk/"),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'unSlnMWUzr4';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'y_tb1Tn17pA';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'oOPwdp_3Xqc';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'FFrOfbynlgY';
