...
class EnglishEntryexpertly extends StatefulWidget {
  const EnglishEntryexpertly({super.key});

  @override
  State<EnglishEntryexpertly> createState() => _EnglishEntryexpertlyState();
}

class _EnglishEntryexpertlyState extends State<EnglishEntryexpertly> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""expertly""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """expertly""",
                      // alsoEnglishWord: "also: expertly",
                      britshText: """IpaUK: /ˈekspɜːtli/""",
                      americanText: """IpaUS: /ˈekspɜːrtli/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The roads were icy but she stopped the car expertly.""");
  }
...
کوردی: شارەزایانە، کارزانانە، بە شێوەیێکی کارامە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵکار) بەشێوەیەک کە شارەزایی و زانیاری زۆر لەخۆدەگرێت"""),
          SentencesRow(
            englishText:
                """The roads were icy but she stopped the car expertly.""",
            kurdishText:
                """ڕێگاکان سەهۆڵاوی بوون بەڵام شارەزایانە ئۆتۆمبێلەکەی وەستاند.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The music was expertly performed.""",
            kurdishText: """میوزیکەکە شارەزایانە لێدرا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: expertly
1. In an expert manner (= like an expert, adeptly)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/FLqvTE1Eqfg?t=';
const double _startSecondsend = 000000000000000000000000000000; // 277;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/oOAyQUBithQ?t=';
const double _startSecondsone = 00000000000000000000000000000; // 136;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/_9rucsh5brg?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 79;
const String _videoIdthree = 'VIDEOhttps://youtu.be/5ueSUnUL3ek?t=';
const double _startSecondsthree = 000000000000000000000000000; // 480;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/QfVQMYvgXuQ?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 866;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/f0gMdGrVteI?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 66;
