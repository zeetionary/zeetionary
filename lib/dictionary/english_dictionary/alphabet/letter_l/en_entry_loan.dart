...
class EnglishEntryloan extends StatefulWidget {
  const EnglishEntryloan({super.key});

  @override
  State<EnglishEntryloan> createState() => _EnglishEntryloanState();
}

class _EnglishEntryloanState extends State<EnglishEntryloan> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: loan (Derived forms: loans)
1. The temporary provision of money (usually at interest)
 
2. A word borrowed from another language; e.g. 'blitz' is a German word borrowed into modern English (- loanword)

- Verb: loan (Derived forms: loaning, loaned, loans)
1. Give temporarily; let have for a limited time (- lend)
"loan me some money";
""",
  );

  final String keyword = "loan";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She took out an £8  000 personal loan.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It took three years to repay my student loan.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The bank almost collapsed under the weight of bad loans.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The loan repayment period is 10 years.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I even gave her the loan of my car.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The book must be returned by the end of the loan period.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The bank is happy to loan money to small businesses.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A friend loaned me \$1 000.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The painting has been loaned to the Walker Art Gallery.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/KmpSuLIaTG8?t=177';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/VXISYMYpfaI?t=21';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/TheylbfroxY?t=282';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/itgcAFNe35Q?t=48';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/qNsOMd1NwxA?t=25';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/KuXQa8N-kLo?t=5';
...
کوردی: قەرز، دەسی، واو، وام، قەرزکردن
"""),
// With short examples define "loan", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ئەو پارەیەی کە دامەزراوەیەک، بۆ نموونە بانکێک، بە قەرز دەیدات"""),
                    SentencesRow(
                      englishText: """She took out an £8  000 personal loan.""",
                      kurdishText: """قەرزێکی کەسی ٨٠٠٠ پاوەندی وەرگرت.""",
                    ...
                    SentencesRow(
                      englishText: """It took three years to repay my student loan (= money lent to a student).""",
                      kurdishText: """سێ ساڵی پێچوو کە قەرزی خوێندکارێتیم بدەمەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The bank almost collapsed under the weight of bad loans (= loans that will never be paid back).""",
                      kurdishText: """بانکەکە خەریک بوو دابڕووخێت لەژێر فشاری قەرزی خراپدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The loan repayment period is 10 years.""",
                      kurdishText: """ماوەی دانەوەی قەرزەکە.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ئەوەی شتێک بە قەرز بدەیت؛ ئەوەی کە قەرزت پێبدرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I even gave her the loan of my car.""",
                      kurdishText: """تەنانەت قەرزی ئۆتۆمبێلەکەشمم پێیدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The book must be returned by the end of the loan period.""",
                      kurdishText: """کتێبەکە دەبێت بگەڕێندرێتەوە لە کۆتایی ماوەی وەرگرتنەکە.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) بە قەرزپێدانی شتێک بە کەسێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The bank is happy to loan money to small businesses.""",
                      kurdishText: """بانکەکە دڵخۆشە کە پارەی قەرز بدات بە بازرگانییە بچووکەکان.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """A friend loaned me \$1 000.""",
                      kurdishText: """هاوڕێیەک ١٠٠٠ دۆلاری پێمدا.""",
                      onPressedBritish: () => speaksentence8("en-GB"),
                      onPressedAmerican: () => speaksentence8("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) ئەوەی شتێکی گرانبەها بە قەرز بدەیت بە مۆزەخانەیەک، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The painting has been loaned to the Walker Art Gallery.""",
                      kurdishText: """تابلۆکە بە قەرز دراوە بە پێشانگای هونەریی واکەر.""",
