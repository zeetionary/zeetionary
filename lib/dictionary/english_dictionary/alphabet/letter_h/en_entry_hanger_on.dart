...
class EnglishEntryhangeron extends StatefulWidget {
  const EnglishEntryhangeron({super.key});

  @override
  State<EnglishEntryhangeron> createState() => _EnglishEntryhangeronState();
}

class _EnglishEntryhangeronState extends State<EnglishEntryhangeron> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hanger-on (Derived forms: hangers-on)
1. Someone who persistently (and annoyingly) follows along (- tagalong [N. Amer])
"an indolent hanger-on";
""",
  );

  final String keyword = "hanger-on";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hanger-on""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She arrived with at least 50 assorted helpers and hangers-on.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hanger-on""",
                      // alsoEnglishWord: "also: hanger-on",
                      britshText: """IpaUK: /ˌhæŋər ˈɒn/""",
                      americanText: """IpaUS: /ˌhæŋər ˈɑːn/""",
...
// With short examples define "hanger-on", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) کەسێک کە خۆی لە کەسانی بەناوبانگ نزیک دەکاتەوە یان دەچێتە بۆنەی گرنگ بۆ سوودی خۆی"""),
                    SentencesRow(
                      englishText: """She arrived with at least 50 assorted helpers and hangers-on.""",
                      kurdishText: """گەشت بە لایەنی کەمەوە لەگەڵ ٥٠ یارمەتیدەر و کاسەلێس.""",
