...
class EnglishEntryfountain extends StatefulWidget {
  const EnglishEntryfountain({super.key});

  @override
  State<EnglishEntryfountain> createState() => _EnglishEntryfountainState();
}

class _EnglishEntryfountainState extends State<EnglishEntryfountain> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fountain (Derived forms: fountains)
1. A structure from which an artificially produced jet of water arises
 
2. A natural flow of ground water (= spring, outflow, outpouring, natural spring)
 
3. An artificially produced flow of water (= jet)
 
4. A plumbing fixture that provides a flow of water (= fount)

- Verb: fountain (Derived forms: fountained, fountaining, fountains)
1. Flow or gush as if from a fountain
""",
  );

  final String keyword = "fountain";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fountain""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Tourism is a fountain of wealth for the city.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fountain""",
                      // alsoEnglishWord: "also: fountain",
                      britshText: """IpaUK: /ˈfaʊntən/""",
                      americanText: """IpaUS: /ˈfaʊntn/""",
...
// With short examples define "fountain", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """There was a picture of the Trevi fountain on the front of the book.""",
                      kurdishText:
                          """وێنەیەکی کوفارەی ترێڤی لەسەر بەرگی کتێبەکە بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The shell exploded, sending a fountain of sand and grit into the air.""",
                      kurdishText:
                          """گوللەتۆپەکە تەقییەوە و تەپوتۆزێک لە خۆڵ و زیخی کرد بە حەوادا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """گەشتیاری سەرچاوەیەکی سامانە بۆ شارەکە.""",
...
const String _videoIdone = 'https://youtu.be/lEgPVrSZa6w?t=';
const double _startSecondsone = 000000000000000000000000000547;
const String _videoIdtwo = 'https://youtu.be/D0ZUDvoJFzY?t=';
const double _startSecondstwo = 000000000000000000000000000170;
const String _videoIdthree = 'https://youtu.be/BihMQVi5T00';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/UkZH3a79tOM?t=';
const double _startSecondsfour = 000000000000000000000000000214;
