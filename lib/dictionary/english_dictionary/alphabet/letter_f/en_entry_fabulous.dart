...
class EnglishEntryfabulous extends StatefulWidget {
  const EnglishEntryfabulous({super.key});

  @override
  State<EnglishEntryfabulous> createState() => _EnglishEntryfabulousState();
}

class _EnglishEntryfabulousState extends State<EnglishEntryfabulous> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fabulous""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fabulous""",
                      // alsoEnglishWord: "also: fabulous",
                      britshText: """IpaUK: /ˈfæbjələs/""",
                      americanText: """IpaUS: /ˈfæbjələs/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They put on a fabulous performance.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Jana is a fabulous cook.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The food looks fabulous.""");
  }
...
"""),
          ...
          SentencesRow(
            englishText: """They put on a fabulous performance.""",
            kurdishText: """نمایشێکی خەیاڵی پێشکەش دەکەن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Jana is a fabulous cook.""",
            kurdishText: """جانا چێشتلێنەرێکی ناوازەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The food looks fabulous.""",
            kurdishText: """خواردنەکە باوەڕپێنەکراوە.""",
            onPressedBritish: () => speaksentence3("en-GB"),
            onPressedAmerican: () => speaksentence3("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """٢. (ھاوەڵناو) ئێجگار زۆر"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Much of his fabulous wealth was acquired dishonestly.""",
            kurdishText:
                """زۆرینەی سامانە زۆر و زەبەندەکەی بە فێڵبازی بەدەستخرا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fabulous
1. Extremely pleasing (= fab [informal])
"a fabulous vacation";
 
2. Based on or told of in traditional stories; lacking factual basis or historical validity (= mythic, mythical, mythologic, mythological)
...
const String _videoIdone = 'https://youtu.be/idWpZ63isMo?t=';
const double _startSecondsone = 000000000000000000000000000275;
const String _videoIdtwo = 'https://youtu.be/SiUotSKZUtM?t=';
const double _startSecondstwo = 00000000000000000000000000088;
const String _videoIdthree = 'https://youtu.be/U38i32CpYow?t=';
const double _startSecondsthree = 0000000000000000000000000001297;
const String _videoIdfour = 'https://youtu.be/j3o6RLBehlc?t=';
const double _startSecondsfour = 000000000000000000000000000227;
const String _videoIdfive = 'https://youtu.be/FaCeZsOOKEY?t=';
