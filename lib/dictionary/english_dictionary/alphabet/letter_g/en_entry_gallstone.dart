...
class EnglishEntrygallstone extends StatefulWidget {
  const EnglishEntrygallstone({super.key});

  @override
  State<EnglishEntrygallstone> createState() => _EnglishEntrygallstoneState();
}

class _EnglishEntrygallstoneState extends State<EnglishEntrygallstone> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gallstone";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gallstone""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The doctor detected a gallstone during the scan.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gallstone""",
                      // alsoEnglishWord: "also: gallstone",
                      britshText: """IpaUK: /ˈɡɔːlstəʊn/""",
                      americanText: """IpaUS: /ˈɡɔːlstəʊn/""",
...
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) بەردی توورەگەی زراو"""),
                    SentencesRow(
                      englishText:
                          """The doctor detected a gallstone during the scan.""",
                      kurdishText:
                          """پزیشکەکە بەردێکی زراوی دی لە کاتی سکانەکە.""",
...
const String _videoIdend = 'https://youtu.be/XeHl5Y7m1xM?t=';
const double _startSecondsend = 000000000000000000000000000218;
const String _videoIdone = 'https://youtu.be/Solb9uA-tgQ?t=';
const double _startSecondsone = 0000000000000000000000000009007;
const String _videoIdtwo = 'https://youtu.be/ZalRkxn3qYY?t=';
const double _startSecondstwo = 000000000000000000000000000785;
const String _videoIdthree = 'https://youtu.be/phMNlOwjNOw?t=';
const double _startSecondsthree = 00000000000000000000000000074;
const String _videoIdfour = 'https://youtu.be/JWaODotJ0uY?t=';
const double _startSecondsfour = 000000000000000000000000000722;
const String _videoIdfive = 'https://youtu.be/ieRXuTkbWEw?t=';
