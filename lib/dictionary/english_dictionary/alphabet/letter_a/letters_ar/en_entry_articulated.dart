...
class EnglishEntryarticulated extends StatelessWidget {
  ...
  Future<void> speakarticulated(String languageCode) async {
    ...
    await flutterTts.speak("articulated");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "articulated"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ɑːˈtɪkjuleɪtɪd/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'Uh5jUpsb18k';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'vjseth58FjM';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'xEwIpOpzapg';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '8-Jg89riwYs';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'i9Uwsbcf97s';
