...
class EnglishEntryexclusive extends StatefulWidget {
  const EnglishEntryexclusive({super.key});

  @override
  State<EnglishEntryexclusive> createState() => _EnglishEntryexclusiveState();
}

class _EnglishEntryexclusiveState extends State<EnglishEntryexclusive> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exclusive""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exclusive""",
                      // alsoEnglishWord: "also: exclusive",
                      britshText: """IpaUK: /ɪkˈskluːsɪv/""",
                      americanText: """IpaUS: /ɪkˈskluːsɪv/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exclusive";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This room is for the exclusive use of guests.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He belongs to an exclusive club.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His clientele was exclusive and wealthy.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He had an exclusive focus on success and making money.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The price is for accommodation only, exclusive of meals.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The two options are not mutually exclusive.""");
  }
...
کوردی: تایبەتی، تایبەت‌دراو، تەرخان‌کراو، بێ‌هاوتا،	داخراو (دەستە یان کۆمەڵەیێ)، پاوان‌کراو، تایبەتی، قۆرخ‌کراو
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) کە تایبەتە بە یەک کەس یان گرووپ"""),
          SentencesRow(
            englishText:
                """His mother has told ‘The Times’ about his death in an exclusive interview (= not given to any other newspaper).""",
            kurdishText:
                """سەیکی قسەی بۆ The Times کردووە سەبارەت بە مردنەکەی لە چاوپێکەوتنێکی تایبەتدا.""",
          ...
          SentencesRow(
            englishText:
                """The recording deal is not necessarily exclusive. The band can record material for other companies as well.""",
            kurdishText:
                """ڕێکەوتنی تۆمارکردنەکە تایبەت نییە. باندەکە دەتوانن بەرهەم بۆ کۆمپانیای دیکەش تۆمار بکەن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """This room is for the exclusive use of guests.""",
            kurdishText: """ژوورەکە بۆ بەکارهێنانی تایبەتیی میوانەکانە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """His clientele was exclusive and wealthy.""",
            kurdishText: """مشتەرییەکانی گرووپێکی تایبەتی و دەوڵەمەندن.""",
            englishNote:
                "This means that the group of clients he served consisted of high-status, affluent individuals who were part of a select or privileged group.",
            onPressedBritish: () => speaksentence5("en-GB"),
            onPressedAmerican: () => speaksentence5("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٣. (ھاوەڵناو) شتێکی گران‌بەها و کوالێتی بەرز"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """She had been sent to one of London's most exclusive girls' schools.""",
            kurdishText:
                """نێردراوە بۆ یەکێک لە قوتابخانە تایبەتییەکانی کچان لە لەندەن .""",
          ...
          SentencesRow(
            englishText:
                """It is one of the most expensive, exclusive resorts in the Mediterranean.""",
            kurdishText:
                """یەکێک لە گران‌بەهاترین و تایبەتترین هاوینەهەوارەکانی دەریای ناوەڕاستە.""",
            onPressedBritish: () => speaksentence7("en-GB"),
            onPressedAmerican: () => speaksentence7("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٥. (ھاوەڵناو) کە هیچی دیکە لەخۆناگرێت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """He had an exclusive focus on success and making money.""",
            kurdishText:
                """سەرنجێکی تەواوی لەسەر سەرکەوتن و پەیداکردنی پارە بوو.""",
            englishNote:
                "This means that his attention and efforts were entirely dedicated to achieving success and earning money, with little or no consideration for other aspects of life.",
          ...
          SentencesRow(
            ...
            kurdishText:
                """نرخەکە تەنها بۆ شوێنی مانەوەیە، خواردن ناگرێتەوە.""",
            englishNote:
                "This means that the cost covers only the lodging, and meals are not included in the price.",
          ...
          SentencesRow(
            ...
            kurdishText: """دوو هەڵبژاردەکە دژ بە یەک نین.""",
            kurdishNote: "واتا دەکرێت هەردووکیانت هەبێت لە هەمان کاتدا",
          ...
          const DefinitionKurdish(
              text:
                  """٧. (ناو) هەواڵێک کە تایبەتە بە یەک ڕۆژنامە، کەناڵی تەلەفیزیۆنی، هتد"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """We feature an exclusive on the mothers whose babies were swapped at birth.""",
            kurdishText:
                """ڕاپۆرتێکی تایبەتمان دەبێت لەسەر ئەو دایکانەی منداڵەکانیان لەکاتی لەدایکبووندا گۆڕدرانەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: exclusive
1. Not divided or shared with others (= sole)
...
3. Not divided among or brought to bear on more than one object or objective (= single, undivided)
"gained their exclusive attention";

- Noun: exclusive (Derived forms: exclusives)
1. A news report that is reported first by one news organization (= scoop)
""",
  );
...
const double _startSecondsend = 000000000000000000000000000000; // 499;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/55XJ1ObZKaM?t=';
const double _startSecondsone = 00000000000000000000000000000; // 930;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/lGSOWwUvJiU?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 258;
const String _videoIdthree = 'VIDEOhttps://youtu.be/SrDEtSlqJC4?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1297;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/yRmOWcWdQAo';
const double _startSecondsfour = 000000000000000000000000000000; // 0;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/hRSGxw2AQnk?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 316;
