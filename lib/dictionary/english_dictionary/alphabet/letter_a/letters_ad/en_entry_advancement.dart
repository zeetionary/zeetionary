...
class EnglishEntryadvancement extends StatelessWidget {
  EnglishEntryadvancement({super.key});
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "advancement"), // Find /ədˈvɑːnsmənt/
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ədˈvɑːnsmənt/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakAdvancement("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            ...
                            CustomIconButtonAmerican(
                              onPressed: () => speakAdvancement("en-US"),
                            ),
                          ],
                        ),
                      ],
