...
class EnglishEntrylitre extends StatefulWidget {
  const EnglishEntrylitre({super.key});

  @override
  State<EnglishEntrylitre> createState() => _EnglishEntrylitreState();
}

class _EnglishEntrylitreState extends State<EnglishEntrylitre> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylitre litre
WORD_WEB litre litre litre
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "litre";
...
کوردی: 
"""),
// With short examples define "litre", please follow LX instructions
