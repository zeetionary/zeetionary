...
class EnglishEntryimmunity extends StatefulWidget {
  const EnglishEntryimmunity({super.key});

  @override
  State<EnglishEntryimmunity> createState() => _EnglishEntryimmunityState();
}

class _EnglishEntryimmunityState extends State<EnglishEntryimmunity> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: immunity (Derived forms: immunities)
1. The state of not being susceptible (- unsusceptibility)
"immunity to rust";
 
2. (medicine) the condition in which an organism can resist disease (- resistance)
 
3. The quality of being unaffected by something
"immunity to criticism"
 
4. An act exempting someone (- exemption, granting immunity)
"he was granted immunity from prosecution";
""",
  );

  final String keyword = "immunity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""immunity""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The vaccine provides longer immunity against flu.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The vaccine only confers immunity for a few months.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.speak(
        """The president's seeming immunity to criticism surprised many people.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The spies were all granted immunity from prosecution.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/TKoCWh2yneM?t=';
    const double startSecondsend = 000000000000000000000000000546;
    const String videoIdone = 'https://youtu.be/NpBPm0b9deQ?t=';
    const double startSecondsone = 00000000000000000000000000074;
    const String videoIdtwo = 'https://youtu.be/yTsxY0mRIGs?t=';
    const double startSecondstwo = 0000000000000000000000000001426;
    const String videoIdthree = 'https://youtu.be/7ziWrneMYss?t=';
    const double startSecondsthree = 000000000000000000000000000770;
    const String videoIdfour = 'https://youtu.be/63tQ7yGmsmI?t=';
    const double startSecondsfour = 000000000000000000000000000750;
    const String videoIdfive = 'https://youtu.be/Yz7Ofr9z1co?t=';
    const double startSecondsfive = 000000000000000000000000000673;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """immunity""",
                      // alsoEnglishWord: "also: immunity",
                      britshText: """IpaUK: /ɪˈmjuːnəti/""",
                      americanText: """IpaUS: /ɪˈmjuːnəti/""",
...
کوردی: پارێزراوی، پاراستن، ئازادی، بەرگری،	بەخشراوی، بەخشین، لێخوش‌بوون
"""),
// With short examples define "immunity", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) توانای جەستە بۆ بەرگری لە نەخۆشی"""),
                    SentencesRow(
                      englishText:
                          """The vaccine provides longer immunity against flu.""",
                      kurdishText:
                          """ڤاکسینەکە بەرگری زیاتر دژ بە هەڵامەت دابین دەکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڤاکسینەکە تەنها بۆ چەند مانگێک بەرگری دەبەخشێت.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) ئەوەی کە کاریگەر نەبیت بە شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The president's seeming immunity to criticism surprised many people.""",
                      kurdishText:
                          """دەرکەوتنی سەرۆک بەوەی کە بەدەر بێت لە ڕەخنە هەموانی سەرسام کرد.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ناو) ئەوەی لە شتێک پارێزراو بیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The spies were all granted immunity from prosecution.""",
                      kurdishText:
                          """سیخوڕەکان هەموویان پارێزبەندی لە لێپێچینەوە پێدرا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Officials of all member states receive certain privileges and immunities.""",
                      kurdishText:
                          """بەرپرسانی هەموو دەوڵەتە ئەندامەکان ماف و پارێزبەندی دیاریکراو وەردەگرن.""",
