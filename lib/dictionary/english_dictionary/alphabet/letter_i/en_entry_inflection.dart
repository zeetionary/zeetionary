...
class EnglishEntryinflection extends StatefulWidget {
  const EnglishEntryinflection({super.key});

  @override
  State<EnglishEntryinflection> createState() => _EnglishEntryinflectionState();
}

class _EnglishEntryinflectionState extends State<EnglishEntryinflection> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inflection""");
  }
