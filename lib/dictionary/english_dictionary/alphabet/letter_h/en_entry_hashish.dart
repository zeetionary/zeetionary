...
class EnglishEntryhashish extends StatefulWidget {
  const EnglishEntryhashish({super.key});

  @override
  State<EnglishEntryhashish> createState() => _EnglishEntryhashishState();
}

class _EnglishEntryhashishState extends State<EnglishEntryhashish> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hashish (Derived forms: hashishes)
1. Purified resinous extract of the hemp plant; used as a hallucinogen (- hasheesh, haschisch, hash)
""",
  );

  final String keyword = "hashish";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hashish""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was caught with hashish in his pocket.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hashish""",
                      // alsoEnglishWord: "also: hashish",
                      britshText: """IpaUK: /hæˈʃiːʃ/,  /ˈhæʃiːʃ/""",
                      americanText: """IpaUS: /hæˈʃiːʃ/,  /ˈhæʃiːʃ/""",
...
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مادەیەکی هۆشبەر کە دەخرێتە دەم یان دەجوێت و ئاسوودەت دەکات، و بەکارهێنانی لە زۆر وڵات نایاساییە"""),
                    SentencesRow(
                      englishText:
                          """He was caught with hashish in his pocket.""",
                      kurdishText: """گیردرا بە حەشیشەوە لە گیرفانیدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/OUVY3CFQAGY?t=';
const double _startSecondsend = 000000000000000000000000000922;
const String _videoIdone = 'https://youtu.be/WWRTZ8IHFg4?t=';
const double _startSecondsone = 000000000000000000000000000697;
const String _videoIdtwo = 'https://youtu.be/tHjFCRzOgAg?t=';
const double _startSecondstwo = 0000000000000000000000000001635;
const String _videoIdthree = 'https://youtu.be/gd6rIngnSCA?t=';
const double _startSecondsthree = 000000000000000000000000000476;
const String _videoIdfour = 'https://youtu.be/bs0zhMCul5Q?t=';
const double _startSecondsfour = 0000000000000000000000000001237;
const String _videoIdfive = 'https://youtu.be/c1tnNjzy7gI?t=';
const double _startSecondsfive = 000000000000000000000000000440;
