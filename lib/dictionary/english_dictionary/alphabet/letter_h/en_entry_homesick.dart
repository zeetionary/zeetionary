...
class EnglishEntryhomesick extends StatefulWidget {
  const EnglishEntryhomesick({super.key});

  @override
  State<EnglishEntryhomesick> createState() => _EnglishEntryhomesickState();
}

class _EnglishEntryhomesickState extends State<EnglishEntryhomesick> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""homesick""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She felt homesick for her country.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was beginning to get a bit homesick.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/NoPkjPCk_Tc?t=';
    const double startSecondsone = 00000000000000000000000000023;
    const String videoIdtwo = 'https://youtu.be/nd5--EqzLPY?t=';
    const double startSecondstwo = 000000000000000000000000000439;
    const String videoIdthree = 'https://youtu.be/-YR2TxHkb4c?t=';
    const double startSecondsthree = 000000000000000000000000000382;
    const String videoIdfour = 'https://youtu.be/-YR2TxHkb4c?t=';
    const double startSecondsfour = 000000000000000000000000000375;
    const String videoIdfive = 'https://youtu.be/L3eC_HAeWtU?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homesick""",
                      // alsoEnglishWord: "also: homesick",
                      britshText: """IpaUK: /ˈhəʊmsɪk/""",
                      americanText: """IpaUS: /ˈhəʊmsɪk/""",
