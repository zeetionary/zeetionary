...
class EnglishEntryivf extends StatefulWidget {
  const EnglishEntryivf({super.key});

  @override
  State<EnglishEntryivf> createState() => _EnglishEntryivfState();
}

class _EnglishEntryivfState extends State<EnglishEntryivf> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryivf IVF
WORD_WEB IVF IVF IVF
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "IVF";
...
// کوردی:
// """),
// With short examples define "IVF", please follow LX instructions
