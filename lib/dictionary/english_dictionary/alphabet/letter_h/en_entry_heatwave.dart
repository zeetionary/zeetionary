...
class EnglishEntryheatwave extends StatefulWidget {
  const EnglishEntryheatwave({super.key});

  @override
  State<EnglishEntryheatwave> createState() => _EnglishEntryheatwaveState();
}

class _EnglishEntryheatwaveState extends State<EnglishEntryheatwave> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heatwave (Derived forms: heat waves, heatwaves)
Usage: Brit
1. A wave of unusually hot weather (- heat wave)
""",
  );

  final String keyword = "heatwave";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heatwave""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heatwave""",
                      // alsoEnglishWord: "also: heatwave",
                      britshText: """IpaUK: /ˈhiːtweɪv/""",
                      americanText: """IpaUS: /ˈhiːtweɪv/""",
...
کوردی: شەپۆلی هەوای گەرم، گڕە، سەردەمی گەرمی هەوا
"""),
// With short examples define "heatwave", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) ماوەیەکی لەناکاو لە گەرمای زۆر"""),
                    SentencesRow(
                      englishText:
                          """A long summer heatwave had caused most of the crops to die.""",
                      kurdishText:
                          """شەپۆلێکی درێژ لە گەرمای هاوین بووە بە هۆکاری وشکبوونەوەی دانەوێڵە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/wY3Ehw7_4Sg?t=';
const double _startSecondsend = 00000000000000000000000000096;
const String _videoIdone = 'https://youtu.be/asAd-E5_HPo?t=';
const double _startSecondsone = 000000000000000000000000000792;
const String _videoIdtwo = 'https://youtu.be/JUluqPR35rY?t=';
const double _startSecondstwo = 00000000000000000000000000028;
const String _videoIdthree = 'https://youtu.be/0f9GpMWdvWI?t=';
const double _startSecondsthree = 000000000000000000000000000554;
const String _videoIdfour = 'https://youtu.be/n8_nJGg0dEc?t=';
const double _startSecondsfour = 000000000000000000000000000680;
const String _videoIdfive = 'https://youtu.be/JUluqPR35rY?t=';
