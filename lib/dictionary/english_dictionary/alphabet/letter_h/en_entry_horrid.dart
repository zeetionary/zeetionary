...
class EnglishEntryhorrid extends StatefulWidget {
  const EnglishEntryhorrid({super.key});

  @override
  State<EnglishEntryhorrid> createState() => _EnglishEntryhorridState();
}

class _EnglishEntryhorridState extends State<EnglishEntryhorrid> {
  @override
  void initState() {
    super.initState();
...
2. Grossly offensive to decency or morality; causing horror (- hideous, horrific, outrageous)
"a horrid pattern of injustice";
""",
  );

  final String keyword = "horrid";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Don't be so horrid to your brother.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The meat tasted horrid.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/-UEs4Ikf-_4?t=';
    const double startSecondsend = 000000000000000000000000000224;
    const String videoIdone = 'https://youtu.be/Gmjd6Zad1Ag?t=';
    const double startSecondsone = 000000000000000000000000000669;
    const String videoIdtwo = 'https://youtu.be/d3vtx9QzkIA?t=';
    const double startSecondstwo = 000000000000000000000000000513;
    const String videoIdthree = 'https://youtu.be/zNv9xWxFX7E?t=';
    const double startSecondsthree = 000000000000000000000000000147;
    const String videoIdfour = 'https://youtu.be/B3ddiZGZqt8?t=';
    const double startSecondsfour = 000000000000000000000000000278;
    const String videoIdfive = 'https://youtu.be/pMszOwO4lPQ?t=';
    const double startSecondsfive = 0000000000000000000000000002878;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """horrid""",
                      // alsoEnglishWord: "also: horrid",
                      britshText: """IpaUK: /ˈhɒrɪd/""",
                      americanText: """IpaUS: /ˈhɔːrɪd/""",
...
// With short examples define "horrid", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Don't be so horrid to your brother.""",
                      kurdishText: """هێندە دزێو مەبە لەگەڵ براکەت.""",
                    ...
                    SentencesRow(
                      englishText: """The meat tasted horrid.""",
                      kurdishText: """گۆشتەکە تامی زۆر خراپ بوو.""",
