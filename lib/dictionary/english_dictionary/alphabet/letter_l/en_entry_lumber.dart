...
class EnglishEntrylumber extends StatefulWidget {
  const EnglishEntrylumber({super.key});

  @override
  State<EnglishEntrylumber> createState() => _EnglishEntrylumberState();
}

class _EnglishEntrylumberState extends State<EnglishEntrylumber> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylumber lumber
WORD_WEB lumber lumber lumber
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lumber";
...
کوردی: 
"""),
// With short examples define "lumber", please follow LX instructions
