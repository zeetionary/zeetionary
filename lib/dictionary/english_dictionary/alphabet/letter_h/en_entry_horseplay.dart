...
class EnglishEntryhorseplay extends StatefulWidget {
  const EnglishEntryhorseplay({super.key});

  @override
  State<EnglishEntryhorseplay> createState() => _EnglishEntryhorseplayState();
}

class _EnglishEntryhorseplayState extends State<EnglishEntryhorseplay> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: horseplay (Derived forms: horseplays)
1. Rowdy or boisterous play
""",
  );

  final String keyword = "horseplay";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""horseplay""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The horseplay led to someone accidentally getting hurt.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/_3tdqQR8j28?t=';
    const double startSecondsend = 000000000000000000000000000371;
    const String videoIdone = 'https://youtu.be/DOgjmkKUIDs?t=';
    const double startSecondsone = 000000000000000000000000000855;
    const String videoIdtwo = 'https://youtu.be/44fjX-rgJ7s?t=';
    const double startSecondstwo = 00000000000000000000000000027;
    const String videoIdthree = 'https://youtu.be/lp-3uQxVZ_o?t=';
    const double startSecondsthree = 000000000000000000000000000562;
    const String videoIdfour = 'https://youtu.be/tYRYvJK-dDI?t=';
    const double startSecondsfour = 000000000000000000000000000243;
    const String videoIdfive = 'https://youtu.be/euH3nNi66vU?t=';
    const double startSecondsfive = 0000000000000000000000000001240;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """horseplay""",
                      // alsoEnglishWord: "also: horseplay",
                      britshText: """IpaUK: /ˈhɔːspleɪ/""",
                      americanText: """IpaUS: /ˈhɔːrspleɪ/""",
...
کوردی: دەس‌بازی، شەڕەشەق، زرمەزلێ، شۆخی یان کایەی کەرانە
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) یاری بە دەنگەدەنگ و گاڵتەوە کە خەڵکی لە یەکدی دەدەن و یەکتری پاڵ دەنێن"""),
                    SentencesRow(
                      englishText:
                          """The horseplay led to someone accidentally getting hurt.""",
                      kurdishText:
                          """شەڕەشەقەکە گەشت بەوەی کەسێک بە ڕێکەوت ئازاری پێبگات.""",
