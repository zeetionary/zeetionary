...
class EnglishEntryincoming extends StatefulWidget {
  const EnglishEntryincoming({super.key});

  @override
  State<EnglishEntryincoming> createState() => _EnglishEntryincomingState();
}

class _EnglishEntryincomingState extends State<EnglishEntryincoming> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incoming""");
  }
