...
class EnglishEntryimprobably extends StatefulWidget {
  const EnglishEntryimprobably({super.key});

  @override
  State<EnglishEntryimprobably> createState() => _EnglishEntryimprobablyState();
}

class _EnglishEntryimprobablyState extends State<EnglishEntryimprobably> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: improbably
1. Surprisingly and in a very unlikely way (- incredibly, implausibly, unbelievably)
"improbably, she survived the crash";
""",
  );

  final String keyword = "improbably";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""improbably""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He claimed, improbably, that he had never been there.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/6ta_sftSfIw?t=';
    const double startSecondsend = 0000000000000000000000000001085;
    const String videoIdone = 'https://youtu.be/rL4Gj9zQqTE?t=';
    const double startSecondsone = 0000000000000000000000000001382;
    const String videoIdtwo = 'https://youtu.be/QAgiyZeELNQ?t=';
    const double startSecondstwo = 000000000000000000000000000101;
    const String videoIdthree = 'https://youtu.be/QpBPIk3oS6Q?t=';
    const double startSecondsthree = 0000000000000000000000000001046;
    const String videoIdfour = 'https://youtu.be/RpQvj9YCo5g?t=';
    const double startSecondsfour = 000000000000000000000000000651;
    const String videoIdfive = 'https://youtu.be/PXG1e4r5qeQ?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """improbably""",
                      // alsoEnglishWord: "also: improbably",
                      britshText: """IpaUK: /ɪmˈprɒbəbli/""",
                      americanText: """IpaUS: /ɪmˈprɑːbəbli/""",
...
کوردی: ڕێ‌تێنەچووانە، ڕێی تێناچێ، لەوە ناچێ
"""),
// With short examples define "improbably", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بۆ گوتنی ئەوەی شتێک ئەگەری کەمە ڕووبدات یان ڕاست بێت"""),
                    SentencesRow(
                      englishText:
                          """He claimed, improbably, that he had never been there.""",
                      kurdishText:
                          """ڕێ‌تێنەچووانە بانگەشەی ئەوەی کرد کە هەرگیز لەوێ نەبووە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بە شێوەیەک کە نامۆیە بەهۆی ئەوەی پێشبینی نەکراوە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: unexpectedly"),
                    SentencesRow(
                      englishText:
                          """Gilmore was the son of a butcher who had improbably risen to become a local prosecutor.""",
                      kurdishText:
                          """کوڕی قەسابێک بوو کە چاوەڕواننەکراوانە گەشطبوو بە بوون بە پشکنەری لۆکاڵی.""",
