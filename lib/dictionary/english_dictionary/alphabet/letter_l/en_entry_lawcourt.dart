...
class EnglishEntrylawcourt extends StatefulWidget {
  const EnglishEntrylawcourt({super.key});

  @override
  State<EnglishEntrylawcourt> createState() => _EnglishEntrylawcourtState();
}

class _EnglishEntrylawcourtState extends State<EnglishEntrylawcourt> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""law court""");
  }
