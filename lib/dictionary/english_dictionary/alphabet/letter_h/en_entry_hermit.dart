...
class EnglishEntryhermit extends StatefulWidget {
  const EnglishEntryhermit({super.key});

  @override
  State<EnglishEntryhermit> createState() => _EnglishEntryhermitState();
}

class _EnglishEntryhermitState extends State<EnglishEntryhermit> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hermit (Derived forms: hermits)
1. One retired from society for religious reasons (- anchorite)
 
2. One who lives in solitude (- recluse, solitary, solitudinarian, troglodyte)
""",
  );

  final String keyword = "hermit";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The hermit lived in a small cabin deep in the woods.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hermit""",
                      // alsoEnglishWord: "also: hermit",
                      britshText: """IpaUK: /ˈhɜːmɪt/""",
                      americanText: """IpaUS: /ˈhɜːrmɪt/""",
...
کوردی: لاتەریک، گۆشەگیر، دوورەپەرێز، وشکەسۆفی
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە ژیانێکی سادە دەژی و کەسانی دیکە نابینێت، زۆرجار بۆ هۆکاری ئایینی"""),
                    SentencesRow(
                      englishText:
                          """The hermit lived in a small cabin deep in the woods.""",
                      kurdishText:
                          """گۆشەگیرەکە قووڵ لە دارستانەکان لە کابینەیەکدا دەژیا.""",
...
const String _videoIdone = 'https://youtu.be/4Q1FzhMY8FQ?t=';
const double _startSecondsone = 000000000000000000000000000645;
const String _videoIdtwo = 'https://youtu.be/VjFFrYEZsAQ?t=';
const double _startSecondstwo = 000000000000000000000000000344;
const String _videoIdthree = 'https://youtu.be/HWB3VhIPWrU?t=';
const double _startSecondsthree = 000000000000000000000000000160;
const String _videoIdfour = 'https://youtu.be/F5FEj9U-CJM?t=';
const double _startSecondsfour = 000000000000000000000000000177;
const String _videoIdfive = 'https://youtu.be/3lr7H7wm2tU?t=';
const double _startSecondsfive = 000000000000000000000000000127;
