...
class EnglishEntryaccolade extends StatefulWidget {
  const EnglishEntryaccolade({super.key});

  @override
  State<EnglishEntryaccolade> createState() => _EnglishEntryaccoladeState();
}

class _EnglishEntryaccoladeState extends State<EnglishEntryaccolade> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""accolade""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accolade""",
                      // alsoEnglishWord: "also: accolade",
                      britshText: """IpaUK: /ˈækəleɪd/""",
                      americanText: """IpaUS: /ˈækəleɪd/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '29aLEnKvSAA';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'ligo_LBPfiE';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'f3UOtY647GU';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'yXc-BNchgdg';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '8VE_AxA2e6I';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'Io0v8y_zzpM';
