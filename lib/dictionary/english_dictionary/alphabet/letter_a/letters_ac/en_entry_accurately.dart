...
class EnglishEntryaccurately extends StatefulWidget {
  const EnglishEntryaccurately({super.key});

  @override
  State<EnglishEntryaccurately> createState() => _EnglishEntryaccuratelyState();
}

class _EnglishEntryaccuratelyState extends State<EnglishEntryaccurately> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: accurately
1. With few or no mistakes
"he works very accurately"
 
2. Strictly correctly
"repeated the order accurately"
""",
  );
// 188888880002200

  final String keyword = "accurately";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accurately""",
                      // alsoEnglishWord: "also: accurately",
                      britshText: """IpaUK: /ˈækjərətli/""",
                      americanText: """IpaUS: /ˈækjərətli/""",
...
١. (ھاوەڵکار) بە وردی و درووستی"""),
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakac2145("en-GB"),
                            onPressedAmerican: () => speakac2145("en-US"),
                          ),
...
٢. (ھاوەڵکار) بەشێوەیەکی تەواو"""),
                          SentencesRow(
                            ...
                            kurdishText: "بڕەکان دەبێت بە تەواوی بپێورێن.",
                            onPressedBritish: () => speaka21659("en-GB"),
                            onPressedAmerican: () => speaka21659("en-US"),
                          ),
                        ],
                      ),
                    ),
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 2128;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'vDhA3f_uSl8';
