...
class EnglishEntryfidelity extends StatefulWidget {
  const EnglishEntryfidelity({super.key});

  @override
  State<EnglishEntryfidelity> createState() => _EnglishEntryfidelityState();
}

class _EnglishEntryfidelityState extends State<EnglishEntryfidelity> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fidelity""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They swore an oath of fidelity to their king.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The story is told with great fidelity to the original.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fidelity""",
                      // alsoEnglishWord: "also: fidelity",
                      britshText: """IpaUK: /fɪˈdeləti/""",
                      americanText: """IpaUS: /fɪˈdeləti/""",
...
// With short examples define "fidelity", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """سوێندی وەفادارییان بۆ پاشاکەیان خوارد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چیرۆکەکە بە درووستیی زۆرەوە بەرامبەر بە ڕەسەنەکە دەگوترێت.""",
...
const String _videoIdfive = 'https://youtu.be/EobNj9QwVSA?t=';
const double _startSecondsfive = 000000000000000000000000000297;
