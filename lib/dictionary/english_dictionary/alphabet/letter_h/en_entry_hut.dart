...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'su6zJeRQLUQ';
    const double startSecondsend = 515;
    const String videoIdone = 'YO7nBuUO9as';
    const double startSecondsone = 573;
    const String videoIdtwo = 'YhDhIfWFgeM';
    const double startSecondstwo = 202;
    const String videoIdthree = 'EzfnpJ6sAos';
    const double startSecondsthree = 269;
    const String videoIdfour = 'IOgq4Nk2H8w';
    const double startSecondsfour = 1405;
    const String videoIdfive = 'm1vXAPxPmL8';
