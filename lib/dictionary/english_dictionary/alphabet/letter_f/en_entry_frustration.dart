...
class EnglishEntryfrustration extends StatefulWidget {
  const EnglishEntryfrustration({super.key});

  @override
  State<EnglishEntryfrustration> createState() =>
      _EnglishEntryfrustrationState();
}

class _EnglishEntryfrustrationState extends State<EnglishEntryfrustration> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frustration (Derived forms: frustrations)
1. The feeling that accompanies an experience of being thwarted in attaining your goals (- defeat)
 
2. An act of hindering someone's plans or efforts (- thwarting, foiling)
...
""",
  ...
  final String keyword = "frustration";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frustration""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Dave thumped the table in frustration.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I could have wept with frustration.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There were tears of frustration in her eyes.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She took out her frustrations on the children.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Every job has its difficulties and frustrations.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""My biggest frustration was not having enough time.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frustration""",
                      // alsoEnglishWord: "also: frustration",
                      britshText: """IpaUK: /frʌˈstreɪʃn/""",
                      americanText: """IpaUS: /frʌˈstreɪʃn/""",
...
کوردی: تێشکان، سەرنەکەوتوویی، نامرادی، خەفەکراوی، کپ‌کراوی، دامرکاوی، دامراوی، ناهومێدی، دڵساردی، سەرکوێری، بێ‌هیوایی، دەس‌شکاوی، داماوی، بێ‌دەسەڵاتی، بەیدەسی،	پووچەڵ‌کردنەوە، لەکارخستن، نەزۆکاندن، لە کاریگەری خستن،	بێ‌بەشی، بێ‌بەری،	ناقایلی، پێخۆش‌نەبوون، ناڕەزایەتی،	ڕق‌هەستاوی، ناڕەحەتی
"""),
// With short examples define "frustration", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی هەست بە بێزاری یان بێ‌ئۆقرەیی بکەیت چونکە ناتوانێت ئەوە بکەیت کە دەتەوێت"""),
                    SentencesRow(
                      englishText: """Dave thumped the table in frustration.""",
                      kurdishText: """دەیڤ لە بێزاریدا کێشای بە مێزەکەدا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She couldn't stand the frustration of not being able to help.""",
                      kurdishText:
                          """نەیدەتوانی بەرگەی ئەو بێزارییە بگرێت کە ناتوانێت یارمەتی بدات.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I could have wept with frustration.""",
                      kurdishText: """دەکرا لە بێزاریدا گریابام.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """فرمێسکی بێزاری لە چاوانیدا بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بێزاری خۆی بە منداڵەکان ڕشت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەموو کارێک سەختی و ناڕەحەتی خۆی هەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """گەورەترین بێزاریم ئەوە بوو کاتم زۆر نەبوو.""",
...
const double _startSecondsend = 0000000000000000000000000001540;
const String _videoIdone = 'https://youtu.be/mY3SEMTROas?t=';
const double _startSecondsone = 0000000000000000000000000001654;
const String _videoIdtwo = 'https://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondstwo = 0000000000000000000000000002975;
...
const double _startSecondsfour = 0000000000000000000000000002333;
const String _videoIdfive = 'https://youtu.be/Ir3eJ1t13fk?t=';
const double _startSecondsfive = 0000000000000000000000000001319;
