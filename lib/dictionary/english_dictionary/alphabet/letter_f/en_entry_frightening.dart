...
class EnglishEntryfrightening extends StatefulWidget {
  const EnglishEntryfrightening({super.key});

  @override
  State<EnglishEntryfrightening> createState() =>
      _EnglishEntryfrighteningState();
}

class _EnglishEntryfrighteningState extends State<EnglishEntryfrightening> {
  @override
  void initState() {
    super.initState();
...
1. Causing fear, dread or terror (= awful, dire, direful, dread, dreaded, dreadful, fearful, fearsome, horrendous, horrific, terrible)
"the frightening war";

- Noun: frightening
The act of inspiring with fear (= terrorization, terrorisation [Brit])
""",
  );

  final String keyword = "frightening";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frightening""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The noise was frightening.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It's frightening to think it could happen again.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was all very frightening to a small boy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frightening""",
                      // alsoEnglishWord: "also: frightening",
                      britshText: """IpaUK: /ˈfraɪtnɪŋ/""",
                      americanText: """IpaUS: /ˈfraɪtnɪŋ/""",
...
// With short examples define "frightening", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The noise was frightening.""",
                      kurdishText: """دەنگەدەنگەکە ترسێنەر بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بیرکردنەوەی ئەوەی کە ئەوە دەکرا دووبارە ڕووبدا ترسێنەر بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەمووی ترسێنەر بوو کوڕێکی بچووک.""",
...
const String _videoIdone = 'https://youtu.be/kElsSj8hky4?t=';
const double _startSecondsone = 000000000000000000000000000278;
const String _videoIdtwo = 'https://youtu.be/mncCR3wehF8?t=';
const double _startSecondstwo = 000000000000000000000000000367;
const String _videoIdthree = 'https://youtu.be/YwOMc-4OEWg?t=';
const double _startSecondsthree = 000000000000000000000000000477;
const String _videoIdfour = 'https://youtu.be/hkO8qXCFYWA?t=';
const double _startSecondsfour = 000000000000000000000000000498;
const String _videoIdfive = 'https://youtu.be/vRw8Yn6C108?t=';
const double _startSecondsfive = 00000000000000000000000000082;
