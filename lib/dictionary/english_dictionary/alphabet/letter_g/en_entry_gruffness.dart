...
class EnglishEntrygruffness extends StatefulWidget {
  const EnglishEntrygruffness({super.key});

  @override
  State<EnglishEntrygruffness> createState() => _EnglishEntrygruffnessState();
}

class _EnglishEntrygruffnessState extends State<EnglishEntrygruffness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gruffness
1. A throaty harshness (- hoarseness, huskiness, throatiness)
 
2. An abrupt discourteous manner (- abruptness, brusqueness, curtness, shortness)
"his antagonistic gruffness";
""",
  );

  final String keyword = "gruffness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gruffness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He has a reputation for gruffness.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gruffness""",
                      // alsoEnglishWord: "also: gruffness",
                      britshText: """IpaUK: /ˈɡrʌf.nəs/""",
                      americanText: """IpaUS: /ˈɡrʌf.nəs/""",
