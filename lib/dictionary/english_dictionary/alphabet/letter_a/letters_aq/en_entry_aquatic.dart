...
class EnglishEntryaquatic extends StatelessWidget {
  ...
  Future<void> speakaquatic(String languageCode) async {
    ...
    await flutterTts.speak("aquatic");
  }
  ...
  Future<void> speakaquatic938(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Aquatic sports include swimming and rowing.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "aquatic"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈkwætɪk/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈkwɑːtɪk/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'vEsZeHfv73U';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '9LPZD5XwEE8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'G1aqd7mnKCU';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'cAY6jtd1iho';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'FC8ivbROHug';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '8XIdJywUAF8';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '_35G-yITC8g';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'GzC1kEINUnk';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'ZgxniVfKT4I';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = '0W2FKDtPH2I';
