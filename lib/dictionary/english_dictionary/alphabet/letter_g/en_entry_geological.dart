...
class EnglishEntrygeological extends StatefulWidget {
  const EnglishEntrygeological({super.key});

  @override
  State<EnglishEntrygeological> createState() => _EnglishEntrygeologicalState();
}

class _EnglishEntrygeologicalState extends State<EnglishEntrygeological> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "geological";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""geological""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """geological""",
                      // alsoEnglishWord: "also: geological",
                      britshText: """IpaUK: /ˌdʒiːəˈlɒdʒɪkl/""",
                      americanText: """IpaUS: /ˌdʒiːəˈlɑːdʒɪkl/""",
...
// With short examples define "geological", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """A geological survey is essential before construction projects.""",
                      kurdishText:
                          """ڕووپێوی زەویناسی گرنگە پێش پڕۆژەی نیشتەجێبوون.""",
...
const String _videoIdtwo = 'https://youtu.be/ErPsyBUCijM?t=';
const double _startSecondstwo = 000000000000000000000000000885;
const String _videoIdthree = 'https://youtu.be/CjiKlLE3NuI?t=';
const double _startSecondsthree = 000000000000000000000000000584;
const String _videoIdfour = 'https://youtu.be/o_CRqBIHkdA?t=';
const double _startSecondsfour = 00000000000000000000000000057;
const String _videoIdfive = 'https://youtu.be/v394vC23HW0?t=';
const double _startSecondsfive = 000000000000000000000000000298;
