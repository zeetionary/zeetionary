...
class EnglishEntryimmensity extends StatefulWidget {
  const EnglishEntryimmensity({super.key});

  @override
  State<EnglishEntryimmensity> createState() => _EnglishEntryimmensityState();
}

class _EnglishEntryimmensityState extends State<EnglishEntryimmensity> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: immensity (Derived forms: immensities)
1. Unusual largeness in size, extent or number (- enormousness, grandness, greatness, immenseness, sizeableness, vastness, wideness, hugeness, vastitude)
"limitless immensity of our solar system";
""",
  );

  final String keyword = "immensity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""immensity""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We were overwhelmed by the sheer immensity of the task.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000965;
    const String videoIdone = 'https://youtu.be/EnTrExZo46U?t=';
    const double startSecondsone = 000000000000000000000000000147;
    const String videoIdtwo = 'https://youtu.be/gPfriiHBBek?t=';
    const double startSecondstwo = 000000000000000000000000000131;
    const String videoIdthree = 'https://youtu.be/p0_-7FmrDq8?t=';
    const double startSecondsthree = 0000000000000000000000000003710;
    const String videoIdfour = 'https://youtu.be/0ZO28NtkwwQ?t=';
    const double startSecondsfour = 0000000000000000000000000003902;
    const String videoIdfive = 'https://youtu.be/H8llZJhMk-c?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """immensity""",
                      // alsoEnglishWord: "also: immensity",
                      britshText: """IpaUK: /ɪˈmensəti/""",
                      americanText: """IpaUS: /ɪˈmensəti/""",
...
کوردی: گەورەیی، کەڵەیی، زۆری، زەبەندی، فرەیی، گەپی، زلەیی، بەرینایی، بەربڵاوی
"""),
// With short examples define "immensity", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) قەبارەی گەورەی شتێک"""),
                    SentencesRow(
                      englishText:
                          """We were overwhelmed by the sheer immensity of the task.""",
                      kurdishText:
                          """سەرسام بووین بە فرەیی ئێجگار گەورەی ئەرکەکە.""",
