...
// blank divider
  ...
  Future<void> speakbarometers1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("The barometer has been steady for three days now.");
  }
  ...
  Future<void> speakbarometers3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("The skin is an accurate barometer of your state of health.");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'oQj_ODZA6Zo';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'i2UKTpIQG6M';
  final double _startSeconds = 0;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final double _startSeconds = 1855;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'FvdcFMquMg4';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = '5MSQm3hqEUU';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = '7x8vIvwYzFg';
...
class YoutubeEmbeddedthirteen extends StatelessWidget {
  ...
  final String _videoId = 'oFAAnDM3-48';
