...
class EnglishEntryexempt extends StatefulWidget {
  const EnglishEntryexempt({super.key});

  @override
  State<EnglishEntryexempt> createState() => _EnglishEntryexemptState();
}

class _EnglishEntryexemptState extends State<EnglishEntryexempt> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exempt""",
                      // alsoEnglishWord: "also: exempt",
                      britshText: """IpaUK: ɪɡˈzempt/""",
                      americanText: """IpaUS: ɪɡˈzempt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The interest on the money is exempt from tax.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Some students are exempt from certain exams.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This income is totally exempt from taxation.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Charities were exempted from paying the tax.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His bad eyesight exempted him from military service.""");
  }
...
کوردی: (پێ)بەخشراو، تەرخان، جەبەکراو، هەڵاوێردراو، هەڵاوێردە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) بەخشراو لە کردن، پارەدان، شوێنکەوتنی یاسا، هتد"""),
          SentencesRow(
            englishText: """The interest on the money is exempt from tax.""",
            kurdishText: """سووی سەر پارەکە باج نایگرێتەوە.""",
            englishNote:
                "This means that the additional earnings or income generated from the money is not subject to taxation and does not need to be included when calculating taxes owed.",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Some students are exempt from certain exams.""",
            kurdishText:
                """هەندێک خوێندکار لە ژمارەیەک تاقیکردنەوەی دیاریکراو بەخشراون.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """This income is totally exempt from taxation.""",
            kurdishText: """ئەم داهاتە بە تەواوی لە باج بەخشراوە.""",
          ...
          SentencesRow(
            englishText:
                """Goods exempt from this tax include books and children's clothes.""",
            kurdishText:
                """ئەو کەلوپەلانەی کە لەم باجە بەخشراون کتێب و جلی منداڵانن.""",
          ...
          SentencesRow(
            englishText:
                """Pregnant women are exempt from dental charges under the current health system.""",
            kurdishText:
                """ژنانی دووگیان بەپێی سیستەمی تەندرووستی ئێستا لە پارەدانی ددانسازی بەخشراون.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) ڕێگادان بە کەسێک کە شتێک نەکات یان پارەی شتێک نەدات کە بە شێوەی ئاسایی دەبێت بیکەن"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Charities were exempted from paying the tax.""",
            kurdishText: """ڕێکخراوە خێرخوازییەکان لە دانی باج بەخشراون.""",
          ...
          SentencesRow(
            ...
            kurdishText: """بینایی لاوازی لە خزمەتی سەربازی بەخشی.""",
          ...
          SentencesRow(
            englishText:
                """Small businesses have been exempted from the tax increase.""",
            kurdishText: """بازرگانییە بچووکەکان لە زیادکردنی باج بەخشراون.""",
...
2. (of goods or funds) not subject to taxation (= nontaxable)
"income exempt from taxation";

- Verb: exempt (Derived forms: exempted, exempting, exempts)
1. Grant relief or an exemption from a rule or requirement to (= relieve, free)
"She exempted me from the exam";
 
2. Grant exemption or release to (= excuse, relieve, let off)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/K3v5wFMQRqs?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1880;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/Ex6Xw83rszo?t=';
const double _startSecondsone = 00000000000000000000000000000; // 411;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/SOa6PA8XQtQ?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 122;
const String _videoIdthree = 'VIDEOhttps://youtu.be/7_9mtr_G550?t=';
const double _startSecondsthree = 000000000000000000000000000; // 2039;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/xWISyLpF8yg?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 90;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/cDPeXoQUrbI?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1301;
