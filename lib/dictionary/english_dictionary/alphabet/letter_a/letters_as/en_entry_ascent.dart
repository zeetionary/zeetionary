...
// Define the word "ascent" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryascent - replace speakAscent

// replace ascent - /əˈsent/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryascent extends StatelessWidget {
  // blank divider
  EnglishEntryascent({super.key});
  // blank divider
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "ascent", // DOPSUM: CHANGE WORD ENTRY - Find /əˈsent/
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAscent(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                      ...
                      child: Column(
                        ...
                        children: [
                          const Text(
                            ...
                            """
کوردی: سەرکەوتن، ژووربوونەوە، سەرووبوونەوە، هەڵکشان، چوونەسەرەوە، پیاهەڵچوون، پێشکەوتن، ڕێگای سەرەوژووری، سەرەوژووری، هەوراز، تەلان
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "یەکەم سەرکەوتن  بەسەر چیای ئێڤرست لە ساڵی ١٩٥٣ لەلایەن ئێدمند هیلاری و تێنزینگ نۆرگای بوو، و ساتێکی وەرچەرخێنەر بوو لە مێژووی شاخەوانیدا.",
                                    textAlign: TextAlign
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "https://youtu.be/QxZ_iPldGtI?t=";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "https://youtu.be/isqd8OOcJpQ?t=";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "https://youtu.be/b6OvrRbGU68?t=";
