...
// replace these: EnglishEntryaccumulate - speakAccumulate - accumulate - /əˈkjuːmjəleɪt/

enum TtsState { playing }

class EnglishEntryaccumulate extends StatelessWidget {
  EnglishEntryaccumulate({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAccumulate(String languageCode) async {
    // DOPSUM: CHANGE speakAccumulate
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈkjuːmjəleɪt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'fd97OJtYtZw';
