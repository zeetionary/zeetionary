...
class EnglishEntryHMS extends StatefulWidget {
  const EnglishEntryHMS({super.key});

  @override
  State<EnglishEntryHMS> createState() => _EnglishEntryHMSState();
}

class _EnglishEntryHMSState extends State<EnglishEntryHMS> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""HMS Queen Elizabeth is a modern aircraft carrier.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/fU-8Rg4CgeI?t=';
    const double startSecondsend = 000000000000000000000000000153;
    const String videoIdone = 'https://youtu.be/4Nr1AgIfajI?t=';
    const double startSecondsone = 0000000000000000000000000004;
    const String videoIdtwo = 'https://youtu.be/k_LjfwrMr9I?t=';
    const double startSecondstwo = 000000000000000000000000000853;
    const String videoIdthree = 'https://youtu.be/c0pS3Zx7Fc8?t=';
    const double startSecondsthree = 000000000000000000000000000147;
    const String videoIdfour = 'https://youtu.be/2LCTdBkLn3o?t=';
    const double startSecondsfour = 000000000000000000000000000582;
    const String videoIdfive = 'https://youtu.be/Q3nDfku5ibA?t=';
    const double startSecondsfive = 000000000000000000000000000725;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """HMS""",
                      // alsoEnglishWord: "also: HMS",
                      britshText: """IpaUK: /ˌeɪtʃ em ˈes/""",
                      americanText: """IpaUS: /ˌeɪtʃ em ˈes/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) لە پێش ناوی کەشتی بەریتانییەوە بەکاردێت و کورتکراوەیە بۆ Her/His Majesty’s Ship"""),
                    SentencesRow(
                      englishText:
                          """HMS Queen Elizabeth is a modern aircraft carrier.""",
                      kurdishText:
                          """ئەیچ‌ئێم‌ئێس کوین ئیلیزابێس کەشتییەکی فڕۆکەهەڵگری سەردەمییانەیە.""",
