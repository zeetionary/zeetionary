...
class EnglishEntryexclamation extends StatefulWidget {
  const EnglishEntryexclamation({super.key});

  @override
  State<EnglishEntryexclamation> createState() =>
      _EnglishEntryexclamationState();
}

class _EnglishEntryexclamationState extends State<EnglishEntryexclamation> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exclamation""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exclamation""",
                      // alsoEnglishWord: "also: exclamation",
                      britshText: """IpaUK: /ˌekskləˈmeɪʃn/""",
                      americanText: """IpaUS: /ˌekskləˈmeɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exclamation";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He gave an exclamation of surprise.""");
  }
...
کوردی: سەرسووڕمان، تاسان، دەربڕینی سەرسووڕمان،	هاوار، ناڵە،	ئاگادارکردنەوە، هۆژداری،	نیشانەی سەرسووڕمان
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) هاوارکردنی بەرز و لەناکاو بۆ دەربڕینی هەستێک"""),
          SentencesRow(
            englishText: """He gave an exclamation of surprise.""",
            kurdishText: """هاوارکردنێکی سوپرایزی کرد.""",
          ...
          SentencesRow(
            englishText:
                """She took his hand and uttered an exclamation of shock.""",
            kurdishText: """تەوقەیەکی کرد و هاوارکردنێکی لە شۆکدا قیژاند.""",
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/Am1lDj2mUVY?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1340;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/THIGSnMP3io?t=';
const double _startSecondsone = 00000000000000000000000000000; // 295;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/fY2CF-T05qY?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 395;
const String _videoIdthree = 'VIDEOhttps://youtu.be/st-pYtU5I4s?t=';
const double _startSecondsthree = 000000000000000000000000000; // 581;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/y1cdhzGXWY0?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 540;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/RM7SobH8ZO0?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 848;
