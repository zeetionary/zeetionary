...
class EnglishEntryflounder extends StatefulWidget {
  const EnglishEntryflounder({super.key});

  @override
  State<EnglishEntryflounder> createState() => _EnglishEntryflounderState();
}

class _EnglishEntryflounderState extends State<EnglishEntryflounder> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: flounder (Derived forms: flounders, floundering, floundered)
1. Walk with great difficulty (= stagger)
"He floundered along in the heavy snow";
 
2. Behave awkwardly; have difficulties
"She is floundering in college"

- Noun: flounder (Derived forms: flounders)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flounder""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""At that time the industry was floundering.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The new democracy there continues to flounder.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flounder""",
                      // alsoEnglishWord: "also: flounder",
                      britshText: """IpaUK: /ˈflaʊndə(r)/""",
                      americanText: """IpaUS: /ˈflaʊndər/""",
...
// With short examples define "flounder", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """He lost the next page of his speech and floundered around/about for a few seconds.""",
                      kurdishText:
                          """پەڕەی دواتری وتارەکەی ونکرد و بۆ چەند چرکەیەک دەستەپاچەبوو و نەیدەزانی چی بڵێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) هەبوونی کێشەی زۆر و ئەوەی ئەگەر هەبێت تەواو شکست بهێنیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """At that time the industry was floundering.""",
                      kurdishText: """لەو کاتەدا پیشەسازی لە قەیراندا بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سیستەمە دیموکراسییە تازەکە لەوێ هێشتا کێشەی هەیە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) هەبوونی کێشە لەوەی ڕێ بکەیت یان بگەیت بە شوێنێک لە بەفر، قوڕ، هتد ــدا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She was floundering around in the deep end of the swimming pool.""",
                      kurdishText:
                          """لە لایەکەی دیکەی مەلەوانگەکە پەلەقاژەی بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/N-FqJzC3tA8?t=';
const double _startSecondsend = 00000000000000000000000000033;
const String _videoIdone = 'https://youtu.be/jh8V4fOgHSU?t=';
const double _startSecondsone = 000000000000000000000000000247;
const String _videoIdtwo = 'https://youtu.be/wfUJvB3YZq0?t=';
const double _startSecondstwo = 0000000000000000000000000002461;
const String _videoIdthree = 'https://youtu.be/a1I7QBCHqng?t=';
const double _startSecondsthree = 0000000000000000000000000001412;
const String _videoIdfour = 'https://youtu.be/fd2zFJ3QRzk?t=';
const double _startSecondsfour = 000000000000000000000000000200;
const String _videoIdfive = 'https://youtu.be/bnlI2EhVWhc?t=';
