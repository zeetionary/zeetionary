...
class EnglishEntryerr extends StatefulWidget {
  const EnglishEntryerr({super.key});

  @override
  State<EnglishEntryerr> createState() => _EnglishEntryerrState();
}

class _EnglishEntryerrState extends State<EnglishEntryerr> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """err""",
                      // alsoEnglishWord: "also: err",
                      britshText: """IpaUK: /ɜː(r)/""",
...
"""),
          const DefinitionKurdish(
              text: """١. (کردار) کردنی هەڵەیەک یان شتێک بە هەڵە"""),
          SentencesRow(
            englishText:
                """He erred in agreeing to her appointment to the position.""",
            kurdishText: """هەڵەی کرد لە ڕازیبوون بە دیاری کردنی بۆ پێگەکە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: err (Derived forms: erring, erred, errs)
1. To make a mistake or be incorrect (= mistake, slip)

2. Wander from a direct course or at random (= stray, drift)
"The child erred from the path and her parents lost sight of her";
""",
  );
...
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/YrMGIqecu0Y?t=';
const double _startSecondsone = 00000000000000000000000000000; // 95;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/EF-9I38ud4s?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 452;
const String _videoIdthree = 'VIDEOhttps://youtu.be/E3e20718ioY?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1770;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/AvFPefNzx00?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 398;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/HrBTbfrucGk?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 548;
