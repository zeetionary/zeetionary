...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdthree = 'CURLWPCxe-c';
    const double startSecondsthree = 370;
    const String videoIdfour = 'tJuYL3nPINM';
    const double startSecondsfour = 1140;
    const String videoIdfive = 'YLmDE_JYUNU';
    const double startSecondsfive = 509;
