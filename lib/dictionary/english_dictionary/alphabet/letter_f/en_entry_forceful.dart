...
class EnglishEntryforceful extends StatefulWidget {
  const EnglishEntryforceful({super.key});

  @override
  State<EnglishEntryforceful> createState() => _EnglishEntryforcefulState();
}

class _EnglishEntryforcefulState extends State<EnglishEntryforceful> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: forceful 
1. Forceful and definite in expression or action (= emphatic)
"the document contained a particularly forceful guarantee of religious liberty";
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forceful""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The minister launched a forceful defence of the policy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forceful""",
                      // alsoEnglishWord: "also: forceful",
                      britshText: """IpaUK: /ˈfɔːsfl/""",
                      americanText: """IpaUS: /ˈfɔːrsfl/""",
...
کوردی: پتەو، بەهێز، تۆکمە،	بەزەبر، بەهێز، کاریگەر، کاری، چالاک،	بڕا، یەکلایی‌کەرەوە، توند، سەخت،	زۆرەملی، بەزۆری
"""),
// With short examples define "forceful", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) دەربڕینی بۆچوون بە بەهێزی و ڕوونی بە شێوەیەک کە کەسانی دیکە ڕازی دەکات باوەڕ بکەن"""),
                    SentencesRow(
                      englishText:
                          """His mother was a forceful character and had a big influence on him.""",
                      kurdishText:
                          """دایکی خاوەن کەسایەتی بەهێز بوو و کاریگەریی گەورەی لەسەری هەبوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە بە ڕوونی و بەهێزی دەربڕدراون بەشێوەیەک کە کەسانی دیکە باوەڕ دەکەن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He was never afraid to speak his mind in a forceful manner.""",
                      kurdishText:
                          """هەرگیز نەدەترسا لەوەی بۆچوونی بە تۆکمەیی دەرببڕێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وەزیرەکە بەرگریی توندی سیاسەتەکەی ئەنجام دا.""",
...
const double _startSecondsend = 000000000000000000000000000937;
const String _videoIdone = 'https://youtu.be/0pAz6LTdTrw?t=';
const double _startSecondsone = 000000000000000000000000000261;
const String _videoIdtwo = 'https://youtu.be/NC1WnxsNQaI?t=';
const double _startSecondstwo = 000000000000000000000000000457;
const String _videoIdthree = 'https://youtu.be/Ni8BsXyln_Q?t=';
const double _startSecondsthree = 00000000000000000000000000070;
const String _videoIdfour = 'https://youtu.be/LnV3Q2xIb1U?t=';
const double _startSecondsfour = 000000000000000000000000000424;
const String _videoIdfive = 'https://youtu.be/NC1WnxsNQaI?t=';
const double _startSecondsfive = 000000000000000000000000000455;
