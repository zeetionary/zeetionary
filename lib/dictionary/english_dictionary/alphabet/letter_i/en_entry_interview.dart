...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000881;
    const String videoIdone = 'https://youtu.be/_GFkHA5EZdE';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/hS2x1zl4rn0?t=';
    const double startSecondstwo = 000000000000000000000000000476;
    const String videoIdthree = 'https://youtu.be/WUjVPIEtJd0?t=';
    const double startSecondsthree = 0000000000000000000000000001544;
    const String videoIdfour = 'https://youtu.be/raSeaAeryWE?t=';
    const double startSecondsfour = 00000000000000000000000000092;
    const String videoIdfive = 'https://youtu.be/TRGHIN2PGIA?t=';
