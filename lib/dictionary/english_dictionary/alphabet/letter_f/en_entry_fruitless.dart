...
class EnglishEntryfruitless extends StatefulWidget {
  const EnglishEntryfruitless({super.key});

  @override
  State<EnglishEntryfruitless> createState() => _EnglishEntryfruitlessState();
}

class _EnglishEntryfruitlessState extends State<EnglishEntryfruitless> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fruitless
1. Unproductive of success (= bootless, futile, sleeveless, vain)
"a fruitless search";
""",
  );

  final String keyword = "fruitless";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fruitless""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Our efforts to persuade her proved fruitless.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""All the signs were that this was going to be a fruitless exercise.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fruitless""",
                      // alsoEnglishWord: "also: fruitless",
                      britshText: """IpaUK: /ˈfruːtləs/""",
                      americanText: """IpaUS: /ˈfruːtləs/""",
...
کوردی: بێ‌بەر، بێ‌میوە، بێ‌بەرهەم،	بێ‌ئەنجام، بێ‌برەو، بێهوودە، نەزۆک
"""),
// With short examples define "fruitless", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) کە هیچ ئەنجامی باشی نابێت"""),
                    SentencesRow(
                      englishText:
                          """Our efforts to persuade her proved fruitless.""",
                      kurdishText: """هەوڵەکانمان بۆ ڕازیکردنی بێ ئەنجام بووون.""",
                    ...
                    SentencesRow(
                      englishText: """All the signs were that this was going to be a fruitless exercise.""",
                      kurdishText: """هەموو ئاماژەکان وەها بوون کە ئەمە ڕاهێنانێکی بێ‌سوود دەبێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Y8hi6A5MPVY?t=';
const double _startSecondsend = 000000000000000000000000000242;
const String _videoIdone = 'https://youtu.be/CupbRr2m_sM?t=';
const double _startSecondsone = 000000000000000000000000000244;
const String _videoIdtwo = 'https://youtu.be/5zfZhskSmp0?t=';
const double _startSecondstwo = 000000000000000000000000000857;
const String _videoIdthree = 'https://youtu.be/V2RytpvQ9BA?t=';
const double _startSecondsthree = 000000000000000000000000000802;
const String _videoIdfour = 'https://youtu.be/-ZMzfihqOkQ?t=';
const double _startSecondsfour = 00000000000000000000000000021;
const String _videoIdfive = 'https://youtu.be/qNCHu3qn-PU?t=';
