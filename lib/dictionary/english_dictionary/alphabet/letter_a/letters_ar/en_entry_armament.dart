...
// replace EnglishEntryAdopsummm - replace speakArmament

// replace armament - /ˈɑːməmənt/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarmament extends StatelessWidget {
  // blank divider
  EnglishEntryarmament({super.key});
  // blank divider
  ...
  Future<void> speakarmament(String languageCode) async {
    ...
    await flutterTts.speak("armament");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "armament"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɑːməmənt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrməmənt/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakarmament455("en-US"),
                          ),
...
٢. (ناو) پڕۆسەی زیادکردنی ڕێژەی چەک و تەقەمەنی سوپا یان وڵاتێک"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakarmament458("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'wI38Yiu4KrM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'DGMGCgA5fvM';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'w8hRRCFdnnk';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'H346eSUs3Z0';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'Ncx12zlq3cs';
