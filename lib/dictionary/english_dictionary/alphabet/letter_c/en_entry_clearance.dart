...
class EnglishEntryclearance extends StatelessWidget {
  ...
  Future<void> speakclearances1(String languageCode) async {
    ...
    await flutterTts.speak(
        "// speakclearances111111111111111111111111111111111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclearances2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclearances200"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclearances3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclearances300"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclearances4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclearances400"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclearances5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclearances500"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclearances6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclearances600"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclearances7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclearances700"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclearances8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclearances800"); // DOPSUM: CHANGE TEXT
  }
                                ...
                                child: Column(
                                  children: [
                                    ExampleSentenceEnglish(
                                        text:
                                            "// speakclearances111111111111111111111111111111111"),
...
speakclearance EnglishEntryclearance
WORD_WEB clearance haʊʊʊʊʊʊʊ4
""",
  );
