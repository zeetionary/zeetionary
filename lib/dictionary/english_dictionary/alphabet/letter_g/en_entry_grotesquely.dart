...
class EnglishEntrygrotesquely extends StatefulWidget {
  const EnglishEntrygrotesquely({super.key});

  @override
  State<EnglishEntrygrotesquely> createState() =>
      _EnglishEntrygrotesquelyState();
}

class _EnglishEntrygrotesquelyState extends State<EnglishEntrygrotesquely> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grotesquely""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The body was grotesquely bruised and swollen.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grotesquely""",
                      // alsoEnglishWord: "also: grotesquely",
                      britshText: """IpaUK: /ɡrəʊˈteskli/""",
                      americanText: """IpaUS: /ɡrəʊˈteskli/""",
...
// With short examples define "grotesquely", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەکی هەڵە و نادادپەروەرانە؛ بە شێوەیەکی سەیر کە ناخۆش یان بێ‌ڕێزانەیە"""),
                    SentencesRow(
                      englishText:
                          """He was a grotesquely inappropriate choice of speaker.""",
                      kurdishText:
                          """هەڵبژاردەیەکی قەبیحانە نەگونجاو بوو بۆ وتاربێژی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لاشەکە بە ناشرینی کەوە بووبووەوە و هەڵئاوساو بوو.""",
...
const double _startSecondsone = 0000000000000000000000000001791;
const String _videoIdtwo = 'https://youtu.be/hSNWkRw53Jo?t=';
const double _startSecondstwo = 0000000000000000000000000007074;
const String _videoIdthree = 'https://youtu.be/_p5Yvl2PbBU?t=';
const double _startSecondsthree = 000000000000000000000000000271;
const String _videoIdfour = 'https://youtu.be/fDuz6KLxitA?t=';
const double _startSecondsfour = 000000000000000000000000000403;
const String _videoIdfive = 'https://youtu.be/i3L8wsopkmM?t=';
