...
class EnglishEntryexperimentation extends StatefulWidget {
  const EnglishEntryexperimentation({super.key});

  @override
  State<EnglishEntryexperimentation> createState() =>
      _EnglishEntryexperimentationState();
}

class _EnglishEntryexperimentationState
    extends State<EnglishEntryexperimentation> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""experimentation""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: experimentation",
                      britshText: """IpaUK: /ɪkˌsperɪmenˈteɪʃn/""",
                      americanText: """IpaUS: /ɪkˌsperɪmenˈteɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "experimentation";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Many people object to experimentation on embryos.""");
  }
...
کوردی: تاقی‌کردنەوە، تاقی‌گەری، تاقی‌کاری‌یەکان
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) چالاکی یان پڕۆسەی ئەنجامدانی تاقیکردنەوەی زانستی"""),
          SentencesRow(
            englishText:
                """Further experimentation is needed to verify this hypothesis.""",
            kurdishText:
          ...
          SentencesRow(
            ...
            kurdishText:
                """زۆر کەس دژی ئەنجامدانی پڕۆسەی تاقیکردنەوەن لەسەر ئاوڵەمە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) چالاکی یان پڕۆسەی تاقیکردنەوەی بیرۆکە، ڕێگا، هتد بۆ زانینی کاریگەریی"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """Experimentation with illegal drugs is dangerous.""",
            kurdishText: """تاقیکردنەوەی مادەی هۆشبەری نایاسایی مەترسیدارە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: experimentation (Derived forms: experimentations)
1. The testing of an idea (= experiment)
"not all experimentation is done in laboratories";
 
2. The act of conducting a controlled test or investigation (= experiment)
""",
  );
...
const double _startSecondsend = 000000000000000000000000000000; // 216;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/b_rjBWmc1iQ?t=';
const double _startSecondsone = 00000000000000000000000000000; // 890;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/IwJzsE8CvzQ?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 335;
const String _videoIdthree = 'VIDEOhttps://youtu.be/JHjXwicEwQo?t=';
const double _startSecondsthree = 000000000000000000000000000; // 233;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/-Je79iRtTTE?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 774;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/tURHTuKHBZs?t=';
