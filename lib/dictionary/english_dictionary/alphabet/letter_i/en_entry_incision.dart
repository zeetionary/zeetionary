...
class EnglishEntryincision extends StatefulWidget {
  const EnglishEntryincision({super.key});

  @override
  State<EnglishEntryincision> createState() => _EnglishEntryincisionState();
}

class _EnglishEntryincisionState extends State<EnglishEntryincision> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incision""");
  }
