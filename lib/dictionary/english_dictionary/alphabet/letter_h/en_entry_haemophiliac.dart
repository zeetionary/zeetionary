...
// """),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کەسانی تووشبوو بە ھیمۆفیلیا ڕووبەڕووی ئاڵەنگاری دەبنەوە لە ژیانی ڕۆژانەدا.""",
...
const String _videoIdend = 'JyxNKJ9ypcw';
const double _startSecondsend = 322;
const String _videoIdone = 'MvVeyetd334';
const double _startSecondsone = 1432;
const String _videoIdtwo = 'xiHzyTcxsOo';
const double _startSecondstwo = 33;
const String _videoIdthree = '2SE1SWashuU';
const double _startSecondsthree = 34;
const String _videoIdfour = 'fnqMq-QCJEo';
const double _startSecondsfour = 501;
const String _videoIdfive = 'KV7cuH7vJ9Q';
