...
// With short examples define "footstep", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ھەنگاوەکانی دەنگیان نەما کە بە ڕێگاکەدا چووە خوارەوە.""",
                      englishNote:
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """گوێی ڕاگرت بۆ ھەنگاوەکانی دایکی.""",
...
const String _videoIdtwo = 'WnozP8OWeik';
const double _startSecondstwo = 66;
const String _videoIdthree = 'UO3N_PRIgX0';
const double _startSecondsthree = 24;
const String _videoIdfour = 'YrMGIqecu0Y';
const double _startSecondsfour = 963;
const String _videoIdfive = '6BVMjlWja_8';
const double _startSecondsfive = 168;
