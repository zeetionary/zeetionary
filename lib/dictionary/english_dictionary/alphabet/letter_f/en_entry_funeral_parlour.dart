...
class EnglishEntryfuneralparlour extends StatefulWidget {
  const EnglishEntryfuneralparlour({super.key});

  @override
  State<EnglishEntryfuneralparlour> createState() =>
      _EnglishEntryfuneralparlourState();
}

class _EnglishEntryfuneralparlourState
    extends State<EnglishEntryfuneralparlour> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: funeral parlour (Derived forms: funeral parlours)
Usage: Brit, Cdn (US: funeral parlor)
1. A mortuary where those who knew the deceased can come to pay their last respects (- funeral home, funeral parlor [N. Amer], funeral chapel, funeral church, funeral-residence)
""",
  );

  final String keyword = "funeral parlour";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""funeral parlour""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The family gathered at the funeral parlour.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: funeral parlour",
                      britshText: """IpaUK: /ˈfjuːnərəl pɑːlə(r)/""",
                      americanText: """IpaUS: /ˈfjuːnərəl pɑːrlər/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """The family gathered at the funeral parlour.""",
                      kurdishText: """خێزانەکە لە مردووشۆرییەکە کۆبوونەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Z9O5BiS79DU?t=';
const double _startSecondsend = 00000000000000000000000000021;
const String _videoIdone = 'https://youtu.be/ehDYphVfiYM?t=';
const double _startSecondsone = 000000000000000000000000000231;
const String _videoIdtwo = 'https://youtu.be/iJ7VfdS-OBk?t=';
const double _startSecondstwo = 000000000000000000000000000530;
const String _videoIdthree = 'https://youtu.be/h0349bmXyVE?t=';
const double _startSecondsthree = 000000000000000000000000000115;
const String _videoIdfour = 'https://youtu.be/TMxIWvETWc0?t=';
const double _startSecondsfour = 0000000000000000000000000001705;
const String _videoIdfive = 'https://youtu.be/SbWEuF99vZg?t=';
const double _startSecondsfive = 000000000000000000000000000287;
