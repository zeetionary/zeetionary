...
class EnglishEntryhovel extends StatefulWidget {
  const EnglishEntryhovel({super.key});

  @override
  State<EnglishEntryhovel> createState() => _EnglishEntryhovelState();
}

class _EnglishEntryhovelState extends State<EnglishEntryhovel> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hovel (Derived forms: hovels)
1. Small crude shelter used as a dwelling (- hut, hutch, shack, shanty)
""",
  );

  final String keyword = "hovel";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Your house is a miserable hovel compared with my palace.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 00000000000000000000000000012595;
    const String videoIdone = 'https://youtu.be/hc6VP7Qp-Y8?t=';
    const double startSecondsone = 000000000000000000000000000134;
    const String videoIdtwo = 'https://youtu.be/5vhaQIp5PBs?t=';
    const double startSecondstwo = 000000000000000000000000000899;
    const String videoIdthree = 'https://youtu.be/ROSIxOFMELY?t=';
    const double startSecondsthree = 000000000000000000000000000260;
    const String videoIdfour = 'https://youtu.be/__H0ysmN4b8?t=';
    const double startSecondsfour = 000000000000000000000000000321;
    const String videoIdfive = 'https://youtu.be/eX_EeLs8cmI?t=';
    const double startSecondsfive = 000000000000000000000000000431;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hovel""",
                      // alsoEnglishWord: "also: hovel",
                      britshText: """IpaUK: /ˈhɒvl/""",
                      americanText: """IpaUS: /ˈhʌvl/""",
...
// With short examples define "hovel", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خانووەکەت کەلاوەیەکە بەراورد بە کۆشکەکەم.""",
