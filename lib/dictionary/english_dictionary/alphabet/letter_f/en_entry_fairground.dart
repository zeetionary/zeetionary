...
class EnglishEntryfairground extends StatefulWidget {
  const EnglishEntryfairground({super.key});

  @override
  State<EnglishEntryfairground> createState() => _EnglishEntryfairgroundState();
}

class _EnglishEntryfairgroundState extends State<EnglishEntryfairground> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fairground""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fairground""",
                      // alsoEnglishWord: "also: fairground",
                      britshText: """IpaUK: /ˈfeəɡraʊnd/""",
                      americanText: """IpaUS: /ˈferɡraʊnd/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "fairground";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There was a small fairground just by the river.""");
  }
...
// With short examples define "fairground", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
// کوردی: شوێنی کایە یا یاری،	شوێنی پیشانگا
// """),
...
const String _videoIdend = 'https://youtu.be/gGCZ96ayj_4?t=';
const double _startSecondsend = 000000000000000000000000000347;
const String _videoIdone = 'https://youtu.be/ri2Aj44PA8E?t=';
const double _startSecondsone = 0000000000000000000000000001296;
const String _videoIdtwo = 'https://youtu.be/Ix6vtM4gP8g?t=';
const double _startSecondstwo = 000000000000000000000000000117;
const String _videoIdthree = 'https://youtu.be/8y58X14nYcM?t=';
const double _startSecondsthree = 00000000000000000000000000052;
const String _videoIdfour = 'https://youtu.be/8fCqhpV2SG4?t=';
const double _startSecondsfour = 0000000000000000000000000002930;
const String _videoIdfive = 'https://youtu.be/rT9euCQzgaI?t=';
const double _startSecondsfive = 0000000000000000000000000002026;
