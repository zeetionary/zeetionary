...
class EnglishEntryfearless extends StatefulWidget {
  const EnglishEntryfearless({super.key});

  @override
  State<EnglishEntryfearless> createState() => _EnglishEntryfearlessState();
}

class _EnglishEntryfearlessState extends State<EnglishEntryfearless> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fearless""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fearless""",
                      // alsoEnglishWord: "also: fearless",
                      britshText: """IpaUK: /ˈfɪələs/""",
                      americanText: """IpaUS: /ˈfɪrləs/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was fearless and full of energy.""");
  }
...
کوردی: بێ‌باک، نەترس، بەدڵ‌وجەرگ، بەزات، شێرکرۆژ، کۆنەکردوو، چاوتوند، بێ‌ترس
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە ناترسێت بەشێوەیەک کە خەڵکی سەرسامن پێی"""),
          SentencesRow(
            englishText: """She was fearless and full of energy.""",
            kurdishText: """چاونەترس و پڕ لە وزە بوو.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """وەک پاشایەکی بەهێز و جەنگاوەرێکی چاونەترس ناسرابوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fearless
1. Oblivious of dangers, perils or calmly resolute in facing them (= unafraid)
 
2. Invulnerable to fear or intimidation (= audacious, brave, dauntless, hardy, intrepid, unfearing)
...
const String _videoIdtwo = 'https://youtu.be/W8uXhQnWgj4?t=';
const double _startSecondstwo = 000000000000000000000000000161;
const String _videoIdthree = 'https://youtu.be/8o12WrHBhU0?t=';
const double _startSecondsthree = 000000000000000000000000000673;
const String _videoIdfour = 'https://youtu.be/unk6n3_QdlM?t=';
const double _startSecondsfour = 000000000000000000000000000369;
const String _videoIdfive = 'https://youtu.be/MITeeIbCatY?t=';
const double _startSecondsfive = 0000000000000000000000000001090;
