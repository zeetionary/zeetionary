...
class EnglishEntrydormitory extends StatefulWidget {
  const EnglishEntrydormitory({super.key});

  @override
  State<EnglishEntrydormitory> createState() => _EnglishEntrydormitoryState();
}

class _EnglishEntrydormitoryState extends State<EnglishEntrydormitory> {
  @override
  void initState() {
    super.initState();
    _initDatabase();
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "dormitory";
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "dormitory");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: dormitory");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /ˈdɔːmətri/");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakdormitory(String languageCode) async {
  ...
  Widget build(BuildContext context) {
    return CustomIconButtonBritish(
      onPressed: () => speakdormitory("en-GB"),
    );
  }
}
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /ˈdɔːrmətɔːri/");
  }
}
...
class TTSUS extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomIconButtonAmerican(
      onPressed: () => speakdormitory("en-US"),
    );
  }
}
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakdormitorys1(String languageCode) async {
    // DOPSUM: CHANGE speakdormitory
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
...
کوردی: خەوتنگە، نووستنگە، دیوی خەوتن
"""),
          const DefinitionKurdish(
              text:
                  "١. (ناو) ژوورێک بۆ   ئەوەی ژمارەیەک کەس تێیدا بخەون، بەتایبەتی لە قوتابخانە یان دامەزراوەی دیکە؛ بینای خوێندکارانی کۆلێژ و زانکۆ"),
                ...
                child: Column(
                  children: [
                    ...
                    ExampleSentenceKurdish(
                        text: "ژوورێکی داخلی هەبوو لەگەڵ سێ خوێندکاری دیکە."),
                  ],
                ),
              ),
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys200"),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys2("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys2("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys300"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys3("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys3("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys400"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys4("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys4("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys500"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys5("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys5("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys600"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys6("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys6("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys700"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys7("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys7("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys800"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys8("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys8("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys900"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys9("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys9("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys_1000"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys10("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys10("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys1100"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys11("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys11("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys1200"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys12("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys12("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys1300"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys13("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys13("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys1400"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys14("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys14("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys1500"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys15("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys15("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys1600"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys16("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys16("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys1700"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys17("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys17("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys1800"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys18("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys18("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys1900"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys19("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys19("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys_2000"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys20("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys20("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys2100"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys21("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys21("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
          ...
          //       child: Column(
          //         children: [
          //           ExampleSentenceEnglish(text: "speakdormitorys2200"),
          //           ExampleSentenceKurdish(text: "رستە_رستە_رستە_رستە."),
          //         ],
          //       ),
          //     ),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => speakdormitorys22("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          //           onPressed: () => speakdormitorys22("en-US"),
          //         ),
          //       ],
          //     ),
          //   ],
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/s1dsz7A7woQ?t=',
    startSeconds: 164,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/ruBJmkk1kmo?t=',
    startSeconds: 5,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/FNuvso78g8I?t=',
    startSeconds: 287,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/3S8Tom-9OaU?t=',
    startSeconds: 384,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/PusuRNXh75E?t=',
    startSeconds: 467,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
