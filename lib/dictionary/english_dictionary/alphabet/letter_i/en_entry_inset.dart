...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'lf-KVEXIoqM';
    const double startSecondsend = 346;
    const String videoIdone = 'JuWF9G6SSi0';
    const double startSecondsone = 522;
    const String videoIdtwo = 'rr2XfL_df3o';
    const double startSecondstwo = 467;
    const String videoIdthree = 'YCjy9cU-3NA';
    const double startSecondsthree = 341;
    const String videoIdfour = 'Zrjp_F5FSjo';
    const double startSecondsfour = 851;
    const String videoIdfive = 'gvqZCMGjh3s';
