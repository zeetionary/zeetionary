...
// replace these: replace EnglishEntryairfield - replace speakspeakAirfield - replace airfield - /ˈeəfiːld/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryairfield extends StatelessWidget {
  EnglishEntryairfield({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakspeakAirfield(String languageCode) async {
    // DOPSUM: CHANGE speakspeakAirfield
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "airfield"), // Find /ˈeəfiːld/
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈeəfiːld/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakspeakAirfield("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /ˈeəfiːld/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                            CustomIconButtonAmerican(
                              onPressed: () => speakspeakAirfield("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '4mkpJkdk-1A';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'dNHrSScKvoA';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'rqhW6ZwjkgM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'M2RCPiZp3ds';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'SbLHah4XUwk';
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = '1xMokJARESU';
