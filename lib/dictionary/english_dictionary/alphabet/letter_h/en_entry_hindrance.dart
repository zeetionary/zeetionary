...
class EnglishEntryhindrance extends StatefulWidget {
  const EnglishEntryhindrance({super.key});

  @override
  State<EnglishEntryhindrance> createState() => _EnglishEntryhindranceState();
}

class _EnglishEntryhindranceState extends State<EnglishEntryhindrance> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hindrance (Derived forms: hindrances)
1. Something that interferes with (or delays) action or progress (- hinderance, deterrent, impediment, balk, baulk [Brit], check, handicap)
 
2. Any obstruction that impedes or is burdensome (- hinderance, hitch, preventive, preventative, encumbrance, incumbrance, interference)
 
3. The act of hindering, obstructing or impeding (- hinderance, interference)
""",
  );

  final String keyword = "hindrance";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hindrance""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""To be honest, she was more of a hindrance than a help.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The new regulations are actually a great hindrance to teachers.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    // 188888880002200
    const String videoIdend = 'https://youtu.be/L87HuKmGwVQ?t=';
    const double startSecondsend = 000000000000000000000000000717;
    const String videoIdone = 'https://youtu.be/KmaS21OmhKI?t=';
    const double startSecondsone = 000000000000000000000000000132;
    const String videoIdtwo = 'https://youtu.be/vojsscI61Sk?t=';
    const double startSecondstwo = 00000000000000000000000000088;
    const String videoIdthree = 'https://youtu.be/eJP93u7n5Ok?t=';
    const double startSecondsthree = 0000000000000000000000000001041;
    const String videoIdfour = 'https://youtu.be/NTpd-KE2aw0?t=';
    const double startSecondsfour = 000000000000000000000000000474;
    const String videoIdfive = 'https://youtu.be/YBx7ZT6FIrU?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hindrance""",
                      // alsoEnglishWord: "also: hindrance",
                      britshText: """IpaUK: /ˈhɪndrəns/""",
                      americanText: """IpaUS: /ˈhɪndrəns/""",
...
کوردی: کۆسپ، ڕێگر، ئاستەنگ، مڵۆزم
"""),
// With short examples define "hindrance", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) کەسێک یان شتێک کە وا دەکات سەختتر بێت بۆ کەسێک کە شتێک بکات یان شتێک ڕووبدات"""),
                    SentencesRow(
                      englishText: """To be honest, she was more of a hindrance than a help.""",
                      kurdishText: """لە ڕاستیدا، زیاتر کۆسپ بوو وەک لە یارمەتی.""",
                    ...
                    SentencesRow(
                      englishText: """The new regulations are actually a great hindrance to teachers.""",
