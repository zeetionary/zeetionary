...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1088;
    const String videoIdone = 'wQSxY7TR6mI';
    const double startSecondsone = 1411;
    const String videoIdtwo = 'TNIYnbj5edw';
    const double startSecondstwo = 455;
    const String videoIdthree = '64pA31_WJa0';
    const double startSecondsthree = 501;
    const String videoIdfour = 'Zo7sRijXG00';
    const double startSecondsfour = 308;
    const String videoIdfive = 'uaMqzIo5KWY';
