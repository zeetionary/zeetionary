...
class EnglishEntryevaporation extends StatefulWidget {
  const EnglishEntryevaporation({super.key});

  @override
  State<EnglishEntryevaporation> createState() =>
      _EnglishEntryevaporationState();
}

class _EnglishEntryevaporationState extends State<EnglishEntryevaporation> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evaporation""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evaporation""",
                      // alsoEnglishWord: "also: evaporation",
                      britshText: """IpaUK: /ɪˌvæpəˈreɪʃn/""",
                      americanText: """IpaUS: /ɪˌvæpəˈreɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "evaporation";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Heat and wind can cause evaporation.""");
  }
...
کوردی: هەڵماندن، هوڵماندن، هەڵمێن
"""),
          const DefinitionKurdish(text: """١. (ناو) پڕۆسەی بوون بە هەڵم"""),
          SentencesRow(
            englishText: """Heat and wind can cause evaporation.""",
            kurdishText: """گەرمی و با دەکرێت ببنە هۆکاری هەڵماندن.""",
          ...
          SentencesRow(
            englishText:
                """Political events caused an evaporation of confidence in the nation’s currency.""",
            kurdishText:
                """ڕووداوە سیاسییەکان بوون بە هۆکاری نەمانی متمانە بە دراوی وڵاتەکە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: evaporation (Derived forms: evaporations)
1. The process of becoming a vapour (= vaporization, vaporisation [Brit], vapor [US], vapour [Brit, Cdn])
 
2. The process of extracting moisture (= dehydration, desiccation, drying up)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/737r0mRf0hY?t=';
const double _startSecondsend = 000000000000000000000000000000; // 623;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/UvjSXBqQe4A?t=';
const double _startSecondsone = 00000000000000000000000000000; // 603;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/MBsQOTvWL3Q?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 337;
const String _videoIdthree = 'VIDEOhttps://youtu.be/p-LY9b1u_io?t=';
const double _startSecondsthree = 000000000000000000000000000; // 114;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/7fOY40FvF9Q?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 221;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/saLcKOmPVlg?t=';
