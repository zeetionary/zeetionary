...
class EnglishEntryfirealarm extends StatefulWidget {
  const EnglishEntryfirealarm({super.key});

  @override
  State<EnglishEntryfirealarm> createState() => _EnglishEntryfirealarmState();
}

class _EnglishEntryfirealarmState extends State<EnglishEntryfirealarm> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fire alarm (Derived forms: fire alarms)
1. A shout or bell to warn that fire has broken out
 
2. An alarm that is tripped off by fire or smoke (= smoke alarm, smoke detector)
""",
  );

  final String keyword = "fire alarm";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fire alarm""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Who set off the fire alarm?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The fire alarm went off when I was making a coffee.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We had a fire alarm at work this morning.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fire alarm""",
                      // alsoEnglishWord: "also: fire alarm",
                      britshText: """IpaUK: /ˈfaɪər əlɑːm/""",
                      americanText: """IpaUS: /ˈfaɪər əlɑːrm/""",
...
// With short examples define "fire alarm", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Who set off the fire alarm?""",
                      kurdishText: """کێ زەنگی ئاگرەکەی لێدا؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کاتێک خەریکی دروستکردنی قاوەیەک بووم، زەنگی ئاگرەکە لێی دا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەمڕۆ بەیانی لە شوێنی کارەکەمان زەنگی ئاگادارکردنەوەی ئاگر لێی دا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/6ta_sftSfIw?t=';
const double _startSecondsend = 0000000000000000000000000001624;
const String _videoIdone = 'https://youtu.be/ziLWkhO93lI?t=';
const double _startSecondsone = 000000000000000000000000000253;
const String _videoIdtwo = 'https://youtu.be/UJhqHjwBfAg?t=';
const double _startSecondstwo = 000000000000000000000000000719;
const String _videoIdthree = 'https://youtu.be/hWuOAgJkylU?t=';
const double _startSecondsthree = 000000000000000000000000000758;
const String _videoIdfour = 'https://youtu.be/9Lc3QKplEiI?t=';
const double _startSecondsfour = 0000000000000000000000000001224;
const String _videoIdfive = 'https://youtu.be/gJ5q_AOWv5g?t=';
const double _startSecondsfive = 00000000000000000000000000080;
