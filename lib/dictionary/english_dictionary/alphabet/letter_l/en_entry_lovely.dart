...
class EnglishEntrylovely extends StatefulWidget {
  const EnglishEntrylovely({super.key});

  @override
  State<EnglishEntrylovely> createState() => _EnglishEntrylovelyState();
}

class _EnglishEntrylovelyState extends State<EnglishEntrylovely> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylovely lovely
WORD_WEB lovely lovely lovely
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lovely";
...
کوردی: 
"""),
// With short examples define "lovely", please follow LX instructions
