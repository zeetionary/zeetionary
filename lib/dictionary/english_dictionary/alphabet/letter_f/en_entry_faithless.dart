...
class EnglishEntryfaithless extends StatefulWidget {
  const EnglishEntryfaithless({super.key});

  @override
  State<EnglishEntryfaithless> createState() => _EnglishEntryfaithlessState();
}

class _EnglishEntryfaithlessState extends State<EnglishEntryfaithless> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""faithless""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """faithless""",
                      // alsoEnglishWord: "also: faithless",
                      britshText: """IpaUK: /ˈfeɪθləs/""",
                      americanText: """IpaUS: /ˈfeɪθləs/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "faithless";
...
کوردی: بێ‌وەفا، بێ‌ئەمەک، پێنەزان، خایین، بێ‌بەڵێن، پەیمان‌شکێن،	بێ‌دین، بێ‌ئیمان، بێ‌بڕوا، بێ‌باوەڕ،	بێ‌باوەڕ، لێ‌ڕانەبینراو، پشت‌پێ‌نەبەستراو، باوەڕپێ‌نەکراو
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە ناتوانی باوەڕی پێ بکەیت یان پشتی پێ ببەستیت"""),
          SentencesRow(
            englishText: """She had written a letter to her faithless lover.""",
            kurdishText: """نامەیەکی بۆ خۆشەویستە بێ‌وەفاکەی نووسی بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: faithless
1. Having the character of, or characteristic of, a traitor (= traitorous, unfaithful, treasonable, treasonous)
...
const String _videoIdend = 'https://youtu.be/CzP23Zti-YI?t=';
const double _startSecondsend = 000000000000000000000000000349;
const String _videoIdone = 'https://youtu.be/AXeEEyPeDTo?t=';
const double _startSecondsone = 0000000000000000000000000001274;
const String _videoIdtwo = 'https://youtu.be/RzjF4kKzjaA?t=';
const double _startSecondstwo = 0000000000000000000000000004994;
const String _videoIdthree = 'https://youtu.be/KYVw9lPiCHQ?t=';
const double _startSecondsthree = 000000000000000000000000000172;
const String _videoIdfour = 'https://youtu.be/TvmPZNxXRiM?t=';
const double _startSecondsfour = 00000000000000000000000000021;
const String _videoIdfive = 'https://youtu.be/s6HFdSCDq48?t=';
