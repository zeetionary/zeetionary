...
class EnglishEntryhighlevel extends StatefulWidget {
  const EnglishEntryhighlevel({super.key});

  @override
  State<EnglishEntryhighlevel> createState() => _EnglishEntryhighlevelState();
}

class _EnglishEntryhighlevelState extends State<EnglishEntryhighlevel> {
  @override
  void initState() {
    super.initState();
...
1. At an elevated level in rank or importance (- high-ranking, upper-level)
"a high-level official";
 
2. Occurring at or from a relative high altitude (- high-altitude)
"high-level bombing";
""",
  );

  final String keyword = "high-level";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""high-level""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The meeting was attended by high-level staff only.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """They planned a high-level walk in the hills for the weekend.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He completed a high-level course in software engineering.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """high-level""",
                      // alsoEnglishWord: "also: high-level",
                      britshText: """IpaUK: /ˌhaɪ ˈlevl/""",
                      americanText: """IpaUS: /ˌhaɪ ˈlevl/""",
...
کوردی: 
"""),
// With short examples define "high-level", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە کەسانی ئاست باڵا لەخۆدەگرێت"""),
                    SentencesRow(
                      englishText:
                          """The meeting was attended by high-level staff only.""",
                      kurdishText:
                          """چاوپێکەوتنەکە تەنها کەسانی ئاست باڵا بەژدارییان تێیدا کرد.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) لە شوێن یان پێگەیەکی بەرز"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """They planned a high-level walk in the hills for the weekend.""",
                      kurdishText:
                          """پلانی پیاسەیەکی بەرزاییان هەبوو لە گردەکان بۆ کۆتایی هەفتە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ھاوەڵناو) لە ئاستی بەرز"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He completed a high-level course in software engineering.""",
                      kurdishText:
                          """کۆرسێکی باڵای لە ئەندازیاری نەرمامێر تەواو کرد.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (ھاوەڵناو) بەبێ وردەکاریی زۆر"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """That’s the high-level description, but the details get more complicated.""",
                      kurdishText:
                          """ئەوە ناساندنە سادەکەیە، بەڵام وردەکارییەکان ئاڵۆزتر دەبن.""",
...
const double _startSecondsend = 000000000000000000000000000928;
const String _videoIdone = 'https://youtu.be/fez7X_oevNs?t=';
const double _startSecondsone = 000000000000000000000000000358;
const String _videoIdtwo = 'https://youtu.be/CMKw77fbkOs?t=';
const double _startSecondstwo = 00000000000000000000000000030;
const String _videoIdthree = 'https://youtu.be/eNChF-u-BQg?t=';
const double _startSecondsthree = 000000000000000000000000000267;
const String _videoIdfour = 'https://youtu.be/nnzYZdGFzzM?t=';
const double _startSecondsfour = 000000000000000000000000000186;
const String _videoIdfive = 'https://youtu.be/knjliFs3gR8?t=';
const double _startSecondsfive = 000000000000000000000000000470;
