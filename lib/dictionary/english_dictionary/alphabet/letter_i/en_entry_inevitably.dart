...
class EnglishEntryinevitably extends StatefulWidget {
  const EnglishEntryinevitably({super.key});

  @override
  State<EnglishEntryinevitably> createState() => _EnglishEntryinevitablyState();
}

class _EnglishEntryinevitablyState extends State<EnglishEntryinevitably> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: inevitably
1. In such a manner as could not be otherwise (- necessarily, of necessity, needs [archaic])
"it is inevitably so";
 
2. By necessity (- inescapably, ineluctably, unavoidably)
"the situation slid inevitably toward disaster";
""",
  );

  final String keyword = "inevitably";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inevitably""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Inevitably, the press exaggerated the story.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Inevitably, it rained on the day of the wedding.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/Bl5630CeYFs?t=';
    const double startSecondsone = 000000000000000000000000000291;
    const String videoIdtwo = 'https://youtu.be/0zXfDafyyao?t=';
    const double startSecondstwo = 0000000000000000000000000001078;
    const String videoIdthree = 'https://youtu.be/erDE9B-X7mk?t=';
    const double startSecondsthree = 0000000000000000000000000001382;
    const String videoIdfour = 'https://youtu.be/q8HRGiUeZwc?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inevitably""",
                      // alsoEnglishWord: "also: inevitably",
                      britshText: """IpaUK: /ɪnˈevɪtəbli/""",
                      americanText: """IpaUS: /ɪnˈevɪtəbli/""",
...
کوردی: 
"""),
// With short examples define "inevitably", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) کە بە دڵنیایی ڕوودەدات"""),
                    SentencesRow(
                      englishText:
                          """Inevitably, the press exaggerated the story.""",
                      kurdishText:
                          """بەدڵنیایی، میدیا زیادەڕەوی کرد لە چیرۆکەکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بەو شێوەیەی کە پێشبینی دەکەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Inevitably, it rained on the day of the wedding.""",
                      kurdishText:
                          """بێ‌ئەملاوئەولا، لە ڕۆژی ئاهەنگەکە باران باری.""",
