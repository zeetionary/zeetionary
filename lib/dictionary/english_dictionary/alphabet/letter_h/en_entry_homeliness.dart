...
class EnglishEntryhomeliness extends StatefulWidget {
  const EnglishEntryhomeliness({super.key});

  @override
  State<EnglishEntryhomeliness> createState() => _EnglishEntryhomelinessState();
}

class _EnglishEntryhomelinessState extends State<EnglishEntryhomeliness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: homeliness
1. Having a drab or dowdy quality; lacking stylishness or elegance (- dowdiness, drabness)
 
2. An appearance that is not attractive or beautiful (- plainness)
"fine clothes could not conceal the girl's homeliness";
""",
  );

  final String keyword = "homeliness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""homeliness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The homeliness of the café made everyone feel at ease.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He joked about the homeliness of the reporters.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/QDGbAv-g060?t=';
    const double startSecondsend = 0000000000000000000000000001215;
    const String videoIdone = 'https://youtu.be/7DTOvEXFlHY?t=';
    const double startSecondsone = 000000000000000000000000000604;
    const String videoIdtwo = 'https://youtu.be/GA9ylnr2kKo?t=';
    const double startSecondstwo = 000000000000000000000000000149;
    const String videoIdthree = 'https://youtu.be/0EZjrCzESEw?t=';
    const double startSecondsthree = 0000000000000000000000000001802;
    const String videoIdfour = 'https://youtu.be/6UdaclCKF9o?t=';
    const double startSecondsfour = 00000000000000000000000000083;
    const String videoIdfive = 'https://youtu.be/g-2EELtByoY?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homeliness""",
                      // alsoEnglishWord: "also: homeliness",
                      britshText: """IpaUK: /ˈhəʊm.li.nəs/""",
                      americanText: """IpaUS: /ˈhəʊm.li.nəs/""",
...
کوردی: 
"""),
// With short examples define "homeliness", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی شتێک سادە بەڵام جوان بێت بەشێوەیەک کە ماڵت بیربهێنێتەوە"""),
                    SentencesRow(
                      englishText:
                          """The homeliness of the café made everyone feel at ease.""",
                      kurdishText:
                          """سادەیی قاوەخانەکە وایکرد هەموان هەست بە ئارامی بکەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """گاڵتەی کرد بە ناشرینی پەیامنێرەکان.""",
