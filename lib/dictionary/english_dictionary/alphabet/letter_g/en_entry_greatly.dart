...
class EnglishEntrygreatly extends StatefulWidget {
  const EnglishEntrygreatly({super.key});

  @override
  State<EnglishEntrygreatly> createState() => _EnglishEntrygreatlyState();
}

class _EnglishEntrygreatlyState extends State<EnglishEntrygreatly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: greatly
1. By a significant amount (- significantly, markedly, muchly [informal])
"he improved greatly";
 
2. To a great extent; over a large range or scale (- enormously, terrifically [informal], tremendously, hugely, immensely, vastly, massively [informal])
"salaries vary greatly";
""",
  );

  final String keyword = "greatly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""greatly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""People's reaction to the film has varied greatly.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Your help would be greatly appreciated.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The reports were greatly exaggerated.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """greatly""",
                      // alsoEnglishWord: "also: greatly",
                      britshText: """IpaUK: /ˈɡreɪtli/""",
                      americanText: """IpaUS: /ˈɡreɪtli/""",
...
کوردی: یەکجار، زۆر، گەلێ زۆر
"""),
// With short examples define "greatly", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کاردانەوەی خەڵکی بۆ فیلمەکە زۆر خراپ بووە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """یارمەتیت بە ئاستێکی زۆر هەڵدەسەنگێنرێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The reports were greatly exaggerated.""",
                      kurdishText:
                          """ڕاپۆرتەکان بە ئاستێکی زۆر زیادەڕۆییان تێدا کرابوو.""",
...
const double _startSecondsend = 000000000000000000000000000577;
const String _videoIdone = 'https://youtu.be/cqidD7kVnxY?t=';
const double _startSecondsone = 0000000000000000000000000001373;
const String _videoIdtwo = 'https://youtu.be/pFmtmO2cnlg?t=';
const double _startSecondstwo = 000000000000000000000000000528;
const String _videoIdthree = 'https://youtu.be/SDLprj_JXE8?t=';
const double _startSecondsthree = 000000000000000000000000000127;
const String _videoIdfour = 'https://youtu.be/rN9NzgryhMY?t=';
const double _startSecondsfour = 000000000000000000000000000200;
const String _videoIdfive = 'https://youtu.be/bp6kmcno9SI?t=';
