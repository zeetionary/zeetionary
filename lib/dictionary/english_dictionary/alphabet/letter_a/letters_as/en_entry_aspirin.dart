...
class EnglishEntryaspirin extends StatelessWidget {
  ...
  Future<void> speakaspirin(String languageCode) async {
    ...
    await flutterTts.speak("aspirin");
  }
  ...
  Future<void> speakaspirin814(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Do you have any aspirin?");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'fecZsFwETII';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'dZobSE6dOZU';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'WD6YwwW8kWM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '-9NZSNWfOwo';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'cKDP1MbUWow';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '1pp2vIsrOlE';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'E61AdIYEBuk';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'RYeEGetrjqQ';
  final double _startSeconds = 1;
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'VBpP1fShX8w';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'bOZ43J87M_E';
