...
class EnglishEntryflightpath extends StatefulWidget {
  const EnglishEntryflightpath({super.key});

  @override
  State<EnglishEntryflightpath> createState() => _EnglishEntryflightpathState();
}

class _EnglishEntryflightpathState extends State<EnglishEntryflightpath> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flight path (Derived forms: flight paths)
1. The path of a rocket, projectile or aircraft through the air
 
2. A designated route followed by airplanes in flying from one airport to another (= air lane, airway, skyway)
""",
  );

  final String keyword = "flight path";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flight path""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The pilot was instructed to change his flight path.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flight path""",
                      // alsoEnglishWord: "also: flight path",
                      britshText: """IpaUK: /ˈflaɪt pɑːθ/""",
                      americanText: """IpaUS: /ˈflaɪt pæθ/""",
...
// With short examples define "flight path", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """فڕۆکەوانە ڕێنمایی پێدرا ڕێڕەوی گەشتەکەی بگۆڕێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Residents are trying to have flight paths diverted away from their town.""",
                      kurdishText:
                          """دانیشتووانەکە هەوڵ دەدەن ڕێڕەوی گەشت لە شارۆچکەکەیان لابدەن.""",
