...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'PoNCG3PZKII';
    const double startSecondsend = 215;
    const String videoIdone = 'fKewkAww5Ko';
    const double startSecondsone = 694;
    const String videoIdtwo = '2zWf2sSDmF0';
    const double startSecondstwo = 26;
    const String videoIdthree = 'hW9DgwTgWwE';
    const double startSecondsthree = 163;
    const String videoIdfour = 'ugTrjZQdLj8';
    const double startSecondsfour = 241;
    const String videoIdfive = 'v0V_zkng4go';
    const double startSecondsfive = 1299;
