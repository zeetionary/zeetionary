...
class EnglishEntryabbot extends StatefulWidget {
  const EnglishEntryabbot({super.key});

  @override
  State<EnglishEntryabbot> createState() => _EnglishEntryabbotState();
}

class _EnglishEntryabbotState extends State<EnglishEntryabbot> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """abbot""",
                      // alsoEnglishWord: "also: abbot",
                      britshText: """IpaUK: /ˈæbət/""",
                      americanText: """IpaUS: /ˈæbət/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'UruU8mCvxRI';
  final double _startSeconds = 3473;
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'kOo4GQ1aE3E';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'gnFi96PLlFY';
