...
class EnglishEntrychamois extends StatelessWidget {
  ...
  Future<void> speakchamois(String languageCode) async {
    ...
    await flutterTts.speak("chamois");
  }
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = '1jNOGxTNHhw';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'D-dN47z8S4Q';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'SbqVQbPrHqo';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'hH2n1MX2rzg';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'ary5gNCeKPY';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '4uMBINlVubQ';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'SlJpGqUBvSA';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'wzsoRrR7CdE';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'TX9f2u6tUWw';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = '-hvDiJIp8O4';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'CbABrFZ6s0Q';
