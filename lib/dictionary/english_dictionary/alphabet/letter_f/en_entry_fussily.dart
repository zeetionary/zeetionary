...
class EnglishEntryfussily extends StatefulWidget {
  const EnglishEntryfussily({super.key});

  @override
  State<EnglishEntryfussily> createState() => _EnglishEntryfussilyState();
}

class _EnglishEntryfussilyState extends State<EnglishEntryfussily> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fussily""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fussily""",
                      // alsoEnglishWord: "also: fussily",
                      britshText: """IpaUK: /ˈfʌsəli/""",
                      americanText: """IpaUS: /ˈfʌsəli/""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/oLxYklZAnBs?t=';
const double _startSecondsend = 0000000000000000000000000002290;
const String _videoIdone = 'https://youtu.be/BI2jPp-W724?t=';
const double _startSecondsone = 0000000000000000000000000001573;
const String _videoIdtwo = 'https://youtu.be/UDWUmcHeB5A?t=';
const double _startSecondstwo = 000000000000000000000000000397;
const String _videoIdthree = 'https://youtu.be/pkQYqXScw7M?t=';
const double _startSecondsthree = 000000000000000000000000000294;
const String _videoIdfour = 'https://youtu.be/ZQTRjUtS1VI?t=';
const double _startSecondsfour = 00000000000000000000000000012797;
const String _videoIdfive = 'https://youtu.be/nKjJGqZJ_VI?t=';
