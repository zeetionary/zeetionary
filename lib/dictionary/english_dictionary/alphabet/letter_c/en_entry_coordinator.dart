...
class EnglishEntrycoordinator extends StatelessWidget {
// blank divider
  EnglishEntrycoordinator({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcoordinator(String languageCode) async {
    // DOPSUM: CHANGE speakcoordinator
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "coordinator"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUK: /kəʊˈɔːdɪneɪtə(r)/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcoordinator("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text: "IpaUS: /kəʊˈɔːrdɪneɪtər/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcoordinator("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/glS3RDoxYMM?t=',
    startSeconds: 943,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/cApVVuuqLFY?t=',
    startSeconds: 566,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
