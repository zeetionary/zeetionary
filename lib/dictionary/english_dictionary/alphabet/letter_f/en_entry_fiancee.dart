...
class EnglishEntryfiancee extends StatefulWidget {
  const EnglishEntryfiancee({super.key});

  @override
  State<EnglishEntryfiancee> createState() => _EnglishEntryfianceeState();
}

class _EnglishEntryfianceeState extends State<EnglishEntryfiancee> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fiancée""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Paul and his fiancée were there.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiancée""",
                      // alsoEnglishWord: "also: fiancée",
                      britshText: """IpaUK: /fiˈɒnseɪ/""",
                      americanText: """IpaUS: /ˌfiːɑːnˈseɪ/""",
...
// With short examples define "fiancée", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Paul and his fiancée were there.""",
                      kurdishText: """پاوڵ و دەستگیرانەکەی لەوێ بوون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/apmF_FXcZKc?t=';
const double _startSecondsend = 000000000000000000000000000277;
const String _videoIdone = 'https://youtu.be/f7QWMUCMYOE?t=';
const double _startSecondsone = 0000000000000000000000000001316;
const String _videoIdtwo = 'https://youtu.be/y4DTW4B3Sjs?t=';
const double _startSecondstwo = 000000000000000000000000000172;
const String _videoIdthree = 'https://youtu.be/KhBxCx11eck?t=';
const double _startSecondsthree = 000000000000000000000000000337;
const String _videoIdfour = 'https://youtu.be/OIo2Ie1HwHY?t=';
const double _startSecondsfour = 0000000000000000000000000001247;
const String _videoIdfive = 'https://youtu.be/2KRQGfYfAoU?t=';
