...
class EnglishEntryimminently extends StatefulWidget {
  const EnglishEntryimminently({super.key});

  @override
  State<EnglishEntryimminently> createState() => _EnglishEntryimminentlyState();
}

class _EnglishEntryimminentlyState extends State<EnglishEntryimminently> {
  @override
  void initState() {
    super.initState();
...
"Terminal sedation must be restricted to use in imminently dying patients"
""",
  );

  final String keyword = "imminently";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""imminently""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A decision is expected imminently.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/L4PKj9UNyGM?t=';
    const double startSecondsend = 00000000000000000000000000076;
    const String videoIdone = 'https://youtu.be/7Z1p7TMPXFM?t=';
    const double startSecondsone = 00000000000000000000000000072;
    const String videoIdtwo = 'https://youtu.be/tHS3qxU_3RE?t=';
    const double startSecondstwo = 000000000000000000000000000570;
    const String videoIdthree = 'https://youtu.be/XwqAInN9HWI?t=';
    const double startSecondsthree = 000000000000000000000000000293;
    const String videoIdfour = 'https://youtu.be/3zx3i9s7lLY?t=';
    const double startSecondsfour = 000000000000000000000000000688;
    const String videoIdfive = 'https://youtu.be/lhVNq89b110?t=';
    const double startSecondsfive = 000000000000000000000000000322;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """imminently""",
                      // alsoEnglishWord: "also: imminently",
                      britshText: """IpaUK: /ˈɪmɪnəntli/""",
                      americanText: """IpaUS: /ˈɪmɪnəntli/""",
...
کوردی: 
"""),
// With short examples define "imminently", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵکار) زۆر زوو"""),
                    SentencesRow(
                      englishText: """A decision is expected imminently.""",
                      kurdishText: """بڕیارێک بە زووی پێشبینی کراوە.""",
