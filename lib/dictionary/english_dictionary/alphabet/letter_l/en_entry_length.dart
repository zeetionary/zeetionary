...
class EnglishEntrylength extends StatefulWidget {
  const EnglishEntrylength({super.key});

  @override
  State<EnglishEntrylength> createState() => _EnglishEntrylengthState();
}

class _EnglishEntrylengthState extends State<EnglishEntrylength> {
  @override
  void initState() {
    super.initState();
...
4. Size of the gap between two places (- distance)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Measure the length of the line from A to B.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The river is 300 miles in length.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The snake usually reaches a length of 100 cm.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He ran the entire length of the beach.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Look at the length of that queue!""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Did you see the length of his hair?""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The average length of each song on the album is six minutes.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""These changes will shorten the length of time spent waiting for test results.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Each class is 45 minutes in length.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The document is over 800 pages in length.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her novels vary in length.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The store sells knee-length skirts in various colors.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He swims 50 lengths a day.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/VrKW58MS12g?t=637';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/FPAk81X3tTY?t=1024';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/Cxqca4RQd_M?t=3';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/NFtQOxjWfaA?t=91';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/D_Y18GEjfNY?t=351';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/P8m-KThvtxA?t=395';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """length""",
                      // alsoEnglishWord: "also: length",
                      britshText: """IpaUK: /leŋkθ/""",
                      americanText: """IpaUS: /leŋkθ/""",
...
کوردی: درێژی، درێژایی، هەوا، لیپ (بۆ دەزوو، بەن و هتد)،	ماوە،	ئەندازە، درێژایی، باڵا،	لەت، کوت، پارچە،	(پارچە) قەوارە،	(دەنگ‌ناسی) خایاندن، کێشان
"""),
// With short examples define "length", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) درێژی"""),
                    SentencesRow(
                      englishText: """Measure the length of the line from A to B.""",
                      kurdishText: """درێژی هێڵەکە لە A ــەوە بۆ B بپێوە.""",
                    ...
                    SentencesRow(
                      englishText: """The river is 300 miles in length.""",
                      kurdishText: """ڕووبارەکە درێژی ٣٠٠ میلی هەیە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The snake usually reaches a length of 100 cm.""",
                      kurdishText: """مارەکە زۆرجار درێژی دەگەشتە ١٠٠ سم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He ran the entire length of the beach.""",
                      kurdishText: """تەواوی درێژایی کەناراوەکە ڕایکرد.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Look at the length of that queue!""",
                      kurdishText: """سەیری درێژی ئەو ڕیزە.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ئەوەی شتێک درێژ بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Did you see the length of his hair?""",
                      kurdishText: """درێژیی قژیت دیت؟""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) ئەو بڕە کاتەی کە شتێک بەردەوام دەبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The average length of each song on the album is six minutes.""",
                      kurdishText: """ماوەی تێکڕای هەر گۆرانییەکە لە ئەلبوومەکە شەش خولەکە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """These changes will shorten the length of time spent waiting for test results.""",
                      kurdishText: """ئەم گۆڕانکارییانە ماوەی کاتی چاوەڕوانی بۆ ئەنجامی پشکنینەکان کەم دەکاتەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Each class is 45 minutes in length.""",
                      kurdishText: """هەر وانەیەک ٤٥ خولەکە.""",
                      onPressedBritish: () => speaksentence9("en-GB"),
                      onPressedAmerican: () => speaksentence9("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ناو) بڕی نووسین لە کتێبێک، بەڵگەنامەیەک، هتد؛ ماوەی فیلمێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The document is over 800 pages in length.""",
                      kurdishText: """بەڵگەنامەکە سەروو ٨٠٠ لاپەڕەیە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her novels vary in length.""",
                      kurdishText: """ڕۆمانەکانی لە درێژیدا جیاوازن.""",
                      onPressedBritish: () => speaksentence11("en-GB"),
                      onPressedAmerican: () => speaksentence11("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (ناو) هەبوونی ئەو درێژییەی کە باسکراوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The store sells knee-length skirts in various colors.""",
                      kurdishText: """فرۆشگاکە تەنوورەی تاوەکو ئەژنۆ درێژ بە ڕەنگی جیاواز دەفرۆشێت.""",
                      onPressedBritish: () => speaksentence12("en-GB"),
                      onPressedAmerican: () => speaksentence12("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٦. (ناو) دووری لە لایەکی حەوزی مەلەوە بۆ لایەکەی دیکە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He swims 50 lengths a day.""",
                      kurdishText: """هەر ڕۆژێک ٥٠ فڕە مەلە دەکات.""",
                      kurdishNote: """هەروەها: ئەو ڕۆژانە ٥٠ جار درێژایی مەلەوانگەکە دەبڕێت.""",
                      englishNote: """This means he swims the full distance of a pool back and forth 50 times every day.""",
