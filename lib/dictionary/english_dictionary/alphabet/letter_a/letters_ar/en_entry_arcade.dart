...
// replace EnglishEntryAdopsum - replace speakArcade

// replace arcade - /ɑːˈkeɪd/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarcade extends StatelessWidget {
  // blank divider
  EnglishEntryarcade({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arcade"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ɑːˈkeɪd/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ɑːrˈkeɪd/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakarcade105("en-US"),
                          ),
...
٢. (ناو) شوێنێک کە دەتوانی یاری بە ئامێر بکەیت بە پێدانی دراو"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakarcade109("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'gn9uUjwBaEk';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '2StbJSMX_D4';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'nwLxTWzvSkw';
  final double _startSeconds = 1006;
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = '-naamtpQ8lw';
