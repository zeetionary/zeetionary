...
class EnglishEntryliveliness extends StatefulWidget {
  const EnglishEntryliveliness({super.key});

  @override
  State<EnglishEntryliveliness> createState() => _EnglishEntrylivelinessState();
}

class _EnglishEntrylivelinessState extends State<EnglishEntryliveliness> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""liveliness""");
  }
