...
class EnglishEntryhis extends StatefulWidget {
  const EnglishEntryhis({super.key});

  @override
  State<EnglishEntryhis> createState() => _EnglishEntryhisState();
}

class _EnglishEntryhisState extends State<EnglishEntryhis> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Pronoun: his
1. Male possessive pronoun

- Noun: hi
1. An expression of greeting (- hello, hullo, howdy, how-do-you-do, hallo)
""",
  );

  final String keyword = "his";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""James has sold his car.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He took my hand in his.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The choice was his.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Wm4R8d0d8kU?t=';
    ...
    const String videoIdtwo = 'https://youtu.be/hS2x1zl4rn0?t=';
    const double startSecondstwo = 000000000000000000000000000271;
    const String videoIdthree = 'https://youtu.be/Ht0IbFNbfSY?t=';
    const double startSecondsthree = 000000000000000000000000000206;
    const String videoIdfour = 'https://youtu.be/iAnlaR398hs?t=';
    const double startSecondsfour = 00000000000000000000000000080;
    const String videoIdfive = 'https://youtu.be/lrNcx2D_FZI?t=';
    const double startSecondsfive = 00000000000000000000000000070;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """his""",
                      // alsoEnglishWord: "also: his",
                      britshText: """IpaUK: /hɪz/, /ɪz/""",
                      americanText: """IpaUS: /hɪz/, /ɪz/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText: """James has sold his car.""",
                      kurdishText: """جەیمس ئۆتۆمبێلەکەیی فرۆشتووە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Discuss the reasons the author gives for his or her opinion.""",
                      kurdishText:
                          """باسی ئەو هۆکارانە بکە کە نووسەر دەیڵێیت بۆ بۆچوونی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The choice was his.""",
                      kurdishText: """هەڵبژاردەکە هی ئەو بوو.""",
