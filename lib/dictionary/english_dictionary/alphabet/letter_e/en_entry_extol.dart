...
class EnglishEntryextol extends StatefulWidget {
  const EnglishEntryextol({super.key});

  @override
  State<EnglishEntryextol> createState() => _EnglishEntryextolState();
}

class _EnglishEntryextolState extends State<EnglishEntryextol> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extol""",
                      // alsoEnglishWord: "also: extol",
                      britshText: """IpaUK: /ɪkˈstəʊl/""",
                      americanText: """IpaUS: /ɪkˈstəʊl/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Doctors often extol the virtues of eating less fat.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was extolled as a genius.""");
  }
...
// With short examples define "extol", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She was extolled as a genius.""",
            kurdishText: """وەک بلیمەتێک پەسن دەدرا.""",
...
const String _videoIdend = 'https://youtu.be/Gj5uEr0Lh-k?t=';
const double _startSecondsend = 0000000000000000000000000001908;
const String _videoIdone = 'https://youtu.be/xT_d97MayLg?t=';
const double _startSecondsone = 0000000000000000000000000001480;
const String _videoIdtwo = 'https://youtu.be/XxZB3Q6EFJU?t=';
const double _startSecondstwo = 000000000000000000000000000310;
const String _videoIdthree = 'https://youtu.be/fDzDh0DLtz8?t=';
const double _startSecondsthree = 000000000000000000000000000677;
const String _videoIdfour = 'https://youtu.be/WDJsC_Fwcvk?t=';
const double _startSecondsfour = 000000000000000000000000000508;
const String _videoIdfive = 'https://youtu.be/jgQeoMEj0NY?t=';
