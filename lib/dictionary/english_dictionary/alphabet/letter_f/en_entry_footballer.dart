...
class EnglishEntryfootballer extends StatefulWidget {
  const EnglishEntryfootballer({super.key});

  @override
  State<EnglishEntryfootballer> createState() => _EnglishEntryfootballerState();
}

class _EnglishEntryfootballerState extends State<EnglishEntryfootballer> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: footballer (Derived forms: footballers)
1. [N. Amer] An athlete who plays American football (= football player [N. Amer])
 
2. [Brit] An athlete who plays soccer (= soccer player, football player [Brit])
""",
  );

  final String keyword = "footballer";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""footballer""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He is a famous footballer in his country.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """footballer""",
                      // alsoEnglishWord: "also: footballer",
                      britshText: """IpaUK: /ˈfʊtbɔːlə(r)/""",
                      americanText: """IpaUS: /ˈfʊtbɔːlər/""",
...
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) یاریزانی تۆپێن"""),
                    SentencesRow(
                      englishText:
                          """He is a famous footballer in his country.""",
                      kurdishText:
                          """یاریزانێکی تۆپێنی بەناوبانگە لە وڵاتەکەی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/0CYYfSGTcyY?t=';
const double _startSecondsend = 000000000000000000000000000230;
const String _videoIdone = 'https://youtu.be/_V8_f2jUfac?t=';
const double _startSecondsone = 000000000000000000000000000276;
const String _videoIdtwo = 'https://youtu.be/xG1xQfvIvqQ?t=';
const double _startSecondstwo = 000000000000000000000000000221;
const String _videoIdthree = 'https://youtu.be/ENhfIeZF_AY?t=';
const double _startSecondsthree = 0000000000000000000000000001709;
const String _videoIdfour = 'https://youtu.be/l4yZQZf2g5Y?t=';
const double _startSecondsfour = 000000000000000000000000000110;
const String _videoIdfive = 'https://youtu.be/WaxmPWwqZls?t=';
