...
// replace these: replace EnglishEntryalluring - replace speakAlluring - replace alluring - /əˈlʊərɪŋ/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryalluring extends StatelessWidget {
  EnglishEntryalluring({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAlluring(String languageCode) async {
    // DOPSUM: CHANGE speakAlluring
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("alluring"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAlluring8588(String languageCode) async {
    ...
    await flutterTts.speak(
        "She was wearing a most alluring dress at the wedding."); // DOPSUM: CHANGE TEXT
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'lQwxF45PUBM';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'tFB0e0MR3r8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'wQAyu2dOW-c';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'Doxx0xwT8TI';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'Gx2RscQMajE';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'knvaU52YQSY';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = 'glmHTRw739M';
