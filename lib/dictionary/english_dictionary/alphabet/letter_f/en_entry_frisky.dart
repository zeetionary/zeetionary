...
class EnglishEntryfrisky extends StatefulWidget {
  const EnglishEntryfrisky({super.key});

  @override
  State<EnglishEntryfrisky> createState() => _EnglishEntryfriskyState();
}

class _EnglishEntryfriskyState extends State<EnglishEntryfrisky> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: frisky (Derived forms: friskier, friskiest)
1. Playful like a lively kitten (= kittenish)
"It was mating season, and Grasshopper was getting frisky";

""",
  );

  final String keyword = "frisky";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He always gets a bit frisky after a few drinks.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frisky""",
                      // alsoEnglishWord: "also: frisky",
                      britshText: """IpaUK: /ˈfrɪski/""",
                      americanText: """IpaUS: /ˈfrɪski/""",
...
// With short examples define "frisky", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Her horse seemed rather frisky.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەمیشە لە دوای چەند خواردنەوەیەک کەمێک زەوقن دەبێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/IuUpkdnBi-M?t=';
const double _startSecondsend = 000000000000000000000000000312;
const String _videoIdone = 'https://youtu.be/Mf4wwXM2o_M?t=';
const double _startSecondsone = 000000000000000000000000000711;
const String _videoIdtwo = 'https://youtu.be/KKoOIyhJwA4?t=';
const double _startSecondstwo = 000000000000000000000000000139;
const String _videoIdthree = 'https://youtu.be/7EWs5QBv6_w?t=';
const double _startSecondsthree = 000000000000000000000000000602;
const String _videoIdfour = 'https://youtu.be/m6Pl9Wke5fQ?t=';
const double _startSecondsfour = 000000000000000000000000000351;
const String _videoIdfive = 'https://youtu.be/paP3r1Q0xfk?t=';
