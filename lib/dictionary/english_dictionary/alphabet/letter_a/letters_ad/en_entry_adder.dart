...
// replace these: replace EnglishEntryadder - replace speakAdder - replace adder - /ˈædər/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadder extends StatelessWidget {
  EnglishEntryadder({Key? key}) : super(key: key);
