...
class EnglishEntryimpede extends StatefulWidget {
  const EnglishEntryimpede({super.key});

  @override
  State<EnglishEntryimpede> createState() => _EnglishEntryimpedeState();
}

class _EnglishEntryimpedeState extends State<EnglishEntryimpede> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: impede (Derived forms: impeding, impedes, impeded)
1. Be a hindrance or obstacle to (- hinder, fetter [literary], entrammel [literary], trammel [literary])
"She is impeding the progress of our project";

2. Block passage through (- obstruct, obturate, occlude, jam, block, close up)
"impede the path";
""",
  );

  final String keyword = "impede";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Work on the building was impeded by severe weather.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""In what ways did economic factors impede progress?""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Gv4Af83KFrE?t=';
    ...
    const String videoIdtwo = 'https://youtu.be/hGLY5MAAFO4?t=';
    const double startSecondstwo = 0000000000000000000000000001520;
    const String videoIdthree = 'https://youtu.be/V2_2UGeGL9M?t=';
    const double startSecondsthree = 000000000000000000000000000238;
    const String videoIdfour = 'https://youtu.be/xX0ozxrZlEQ?t=';
    const double startSecondsfour = 000000000000000000000000000427;
    const String videoIdfive = 'https://youtu.be/KFy2LgHmB9g?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """impede""",
                      // alsoEnglishWord: "also: impede",
                      britshText: """IpaUK: /ɪmˈpiːd/""",
                      americanText: """IpaUS: /ɪmˈpiːd/""",
...
کوردی: گیردان، تەگەرەخستنە بەر، ڕێگرتن
"""),
// With short examples define "impede", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) وەستاندن یان دواخستنی بەرەوپێشچوونی شتێک"""),
                    SentencesRow(
                      englishText:
                          """Work on the building was impeded by severe weather.""",
                      kurdishText:
                          """کار لەسەر بیناکە تەگەرەی تێخرا لەلایەن کەشووهەوای خراپ.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە چی لایەنێکەوە فاکتەری ئابووری بەرەوپێشچوونی هێواش کردووە؟""",
