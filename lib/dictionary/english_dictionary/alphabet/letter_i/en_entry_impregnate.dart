...
class EnglishEntryimpregnate extends StatefulWidget {
  const EnglishEntryimpregnate({super.key});

  @override
  State<EnglishEntryimpregnate> createState() => _EnglishEntryimpregnateState();
}

class _EnglishEntryimpregnateState extends State<EnglishEntryimpregnate> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impregnate""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 858;
    const String videoIdone = 'RZt7kE7PZMQ';
    const double startSecondsone = 455;
    const String videoIdtwo = 'fhn8JrO8xyA';
    const double startSecondstwo = 965;
    const String videoIdthree = 'dypj6GBiM2s';
    const double startSecondsthree = 209;
    const String videoIdfour = '2gMcRhrDXAs';
    const double startSecondsfour = 625;
    const String videoIdfive = 'I-GpS5PCcLc';
