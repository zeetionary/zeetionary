...
class EnglishEntryaquamarine extends StatelessWidget {
  ...
  Future<void> speakaquamarine(String languageCode) async {
    ...
    await flutterTts.speak("aquamarine");
  }
  ...
  Future<void> speakaquamarine857(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Beads made of aquamarine can bring luck in love.");
  }
  ...
  Future<void> speakaquamarine902(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The television screen became a rectangle of icy aquamarine.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "aquamarine"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌækwəməˈriːn/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌɑːkwəməˈriːn/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '_PH5pmo9Vzs';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'NPodBNK6jkM';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '2DIR53X-NaQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '384FbcQ5U7s';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '2Q4fHdCygNs';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = '3TAIDRfWx-4';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = '-S_f-huz-EU';
