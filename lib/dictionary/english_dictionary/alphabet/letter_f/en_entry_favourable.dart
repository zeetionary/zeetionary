...
class EnglishEntryfavourable extends StatefulWidget {
  const EnglishEntryfavourable({super.key});

  @override
  State<EnglishEntryfavourable> createState() => _EnglishEntryfavourableState();
}

class _EnglishEntryfavourableState extends State<EnglishEntryfavourable> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""favourable""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """favourable""",
                      // alsoEnglishWord: "also: favourable",
                      britshText: """IpaUK: /ˈfeɪvərəbl/""",
                      americanText: """IpaUS: /ˈfeɪvərəbl/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "favourable";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Their demands received a favourable response.""");
  }
...
کوردی: باش، چاک، قایل‌کەر، (جێی)پەسند، بەقازانج، بەبەهرە، بەسوود، خۆش، سازگار، گونجاو، ئەرێنی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە لە بەرژەوەندی کەسێک/شتێکە و وادەکات بۆچوونی باش درووست بکات"""),
          SentencesRow(
            englishText: """She made a favourable impression on his parents.""",
          ...
          SentencesRow(
            englishText:
                """The performance drew a lot of favourable comments from reviewers.""",
            kurdishText:
                """نمایشەکە زۆر لێدوانی جێی‌پەسەندی لە ڕەخنەگرانەوە بەدەستهێنا.""",
          ...
          SentencesRow(
            ...
            kurdishText: """داواکانیان وەڵامی ئەرێنی بەدەستهێنا.""",
          ...
          SentencesRow(
            englishText:
                """An area with a favourable climate will inevitably be richer than one without.""",
            kurdishText:
                """ناوچەیەک بە ئاووهەوایەکی گونجاو دەوڵەمەندتر دەبێت لە یەکێک بەبێ ئەوە.""",
...
1. Encouraging, approving or pleasing (= favorable [US])
"a favourable reply"; "he received a favourable rating"; "listened with a favourable ear"; "made a favourable impression";
 
2. (of winds or weather) tending to promote or facilitate (= favorable [US])
"the days were fair and the winds were favourable";
 
3. Giving an advantage (= advantageous, favorable [US])
 
4. Presaging or likely to bring good luck or a good outcome (= golden, favorable [US], lucky, prosperous)
...
const String _videoIdend = 'https://youtu.be/PkJlTKUaF3Q?t=';
const double _startSecondsend = 000000000000000000000000000229;
const String _videoIdone = 'https://youtu.be/469chceiiUQ?t=';
const double _startSecondsone = 000000000000000000000000000165;
const String _videoIdtwo = 'https://youtu.be/TViVAmSlLG4?t=';
const double _startSecondstwo = 0000000000000000000000000001037;
const String _videoIdthree = 'https://youtu.be/PVF1NDrHPeo?t=';
const double _startSecondsthree = 000000000000000000000000000545;
const String _videoIdfour = 'https://youtu.be/K6R_eFCcVfM?t=';
const double _startSecondsfour = 000000000000000000000000000798;
const String _videoIdfive = 'https://youtu.be/eH2kohmyqm4?t=';
