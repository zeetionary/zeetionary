...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/PhNUjg9X4g8?t=';
    const double startSecondsone = 00000000000000000000000000094;
    const String videoIdtwo = 'https://youtu.be/FSHITL5oedk?t=';
    const double startSecondstwo = 0000000000000000000000000001108;
    const String videoIdthree = 'https://youtu.be/LfeEu4_vtfQ?t=';
    const double startSecondsthree = 000000000000000000000000000579;
    const String videoIdfour = 'https://youtu.be/Mhlpk5ZrYLM?t=';
    const double startSecondsfour = 000000000000000000000000000262;
    const String videoIdfive = 'https://youtu.be/JFqiSr9A-Go?t=';
