...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'G61QhQjsvpw';
    const double startSecondsone = 173;
    const String videoIdtwo = 'xPNA9RlpkdI';
    const double startSecondstwo = 50;
    const String videoIdthree = 'yljsHQgJx9k';
    const double startSecondsthree = 1128;
    const String videoIdfour = 'MCBBV9CVeI4';
    const double startSecondsfour = 813;
    const String videoIdfive = 'ycOBZZeVeAc';
    const double startSecondsfive = 2138;
