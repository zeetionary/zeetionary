...
class EnglishEntryhandicraft extends StatefulWidget {
  const EnglishEntryhandicraft({super.key});

  @override
  State<EnglishEntryhandicraft> createState() => _EnglishEntryhandicraftState();
}

class _EnglishEntryhandicraftState extends State<EnglishEntryhandicraft> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: handicraft (Derived forms: handicrafts)
1. A work produced by hand labour (- handcraft, handiwork, handwork)
 
2. A craft that requires skilful hands
""",
  );

  final String keyword = "handicraft";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""handicraft""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Her hobbies are music, reading and handicraft.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """handicraft""",
                      // alsoEnglishWord: "also: handicraft",
                      britshText: """IpaUK: /ˈhændikrɑːft/""",
                      americanText: """IpaUS: /ˈhændikræft/""",
...
// With short examples define "handicraft", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خولیاکانی میوزیک، خوێندنەوە، و کاری دەستین.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The huge market is noted for superb local food specialities and handicrafts.""",
                      kurdishText:
                          """بازاڕە زەبەلاحەکە ناسراوە بۆ خواردنی تایبەتی خۆماڵی و کاری دەستی.""",
