...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/qQ01eLt_bxo?t=';
    const double startSecondsend = 0000000000000000000000000001519;
    const String videoIdone = 'https://youtu.be/cCP9vjp4kSg?t=';
    const double startSecondsone = 0000000000000000000000000001891;
    const String videoIdtwo = 'https://youtu.be/62EGPCEmeh4?t=';
    const double startSecondstwo = 000000000000000000000000000108;
    const String videoIdthree = 'https://youtu.be/B4Jlofn3qZI?t=';
    const double startSecondsthree = 000000000000000000000000000545;
    const String videoIdfour = 'https://youtu.be/oU0uNGUxdyo?t=';
    const double startSecondsfour = 00000000000000000000000000023;
    const String videoIdfive = 'https://youtu.be/BriBDiBxaMY?t=';
    const double startSecondsfive = 0000000000000000000000000001319;
