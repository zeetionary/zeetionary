...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵکار) بۆ تەنھا یەک کەس، گرووپ، یان بەکارھێنان"""),
          SentencesRow(
            englishText:
                """Some products are labelled exclusively for indoor or outdoor use.""",
            kurdishText:
                """ھەندێک بەرھەم بەتایبەتی نیشان کراون بۆ بەکارھێنانی ماڵەوە یان دەرەوە.""",
          ...
          SentencesRow(
            englishText:
                """This is a charity that relies almost exclusively on voluntary contributions.""",
            kurdishText:
                """ئەمە ڕێکخراوێکی خێرخوازییە کە بە تەواوی/تەنھا پشت بە بەخشینی خۆبەخشان دەبەستێت.""",
...
const double _startSecondsend = 700;
const String _videoIdone = '-PSgBCQpEt8';
const double _startSecondsone = 81;
const String _videoIdtwo = 'YrMGIqecu0Y';
const double _startSecondstwo = 32;
const String _videoIdthree = 'oHSehKtDyoI';
const double _startSecondsthree = 152;
const String _videoIdfour = 'aHIoQfsh59w';
const double _startSecondsfour = 322;
const String _videoIdfive = 'vKMNZyJRhBg';
