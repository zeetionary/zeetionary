...
class EnglishEntryflint extends StatefulWidget {
  const EnglishEntryflint({super.key});

  @override
  State<EnglishEntryflint> createState() => _EnglishEntryflintState();
}

class _EnglishEntryflintState extends State<EnglishEntryflint> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flint
1. Showing unfeeling resistance to tender feelings (= flinty, granitic, obdurate, stony)
"his flint gaze";

- Noun: flint (Derived forms: flints)
1. A hard kind of stone; a form of silica more opaque than chalcedony
""",
  );

  final String keyword = "flint";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His eyes were as hard as flint.""");
  }
...
// With short examples define "flint", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """His eyes were as hard as flint.""",
                      kurdishText: """چاوەکانی وەک بەردە چەخماخە سەخت بوون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/m9VT2qhHLj8?t=';
const double _startSecondsend = 000000000000000000000000000246;
const String _videoIdone = 'https://youtu.be/k_9CSr3nGqE?t=';
const double _startSecondsone = 00000000000000000000000000059;
const String _videoIdtwo = 'https://youtu.be/rgY7j-ulcyo?t=';
...
const String _videoIdfour = 'https://youtu.be/zLeKK_eWDjo?t=';
const double _startSecondsfour = 0000000000000000000000000001216;
const String _videoIdfive = 'https://youtu.be/qO9g1_BTz0o?t=';
