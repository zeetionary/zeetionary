...
class EnglishEntryheretical extends StatefulWidget {
  const EnglishEntryheretical({super.key});

  @override
  State<EnglishEntryheretical> createState() => _EnglishEntryhereticalState();
}

class _EnglishEntryhereticalState extends State<EnglishEntryheretical> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: heretical
1. Characterized by departure from accepted beliefs or standards (- dissident, heterodox)
"heretical beliefs";
""",
  );

  final String keyword = "heretical";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heretical""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """He says that he and his wife are free of sin - a heretical claim for Christians.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heretical""",
                      // alsoEnglishWord: "also: heretical",
                      britshText: """IpaUK: /həˈretɪkl/""",
                      americanText: """IpaUS: /həˈretɪkl/""",
...
کوردی: جیاباوەڕانە، لەدین‌لاداوانە، لەئایین‌لاداوانە، هەڵگەڕاوانە
"""),
// With short examples define "heretical", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) دژ بە باوەڕی ئایینێکی دیاریکراو"""),
                    SentencesRow(
                      englishText:
                          """He says that he and his wife are free of sin - a heretical claim for Christians.""",
                      kurdishText:
                          """دەڵێت خۆی و ژنەکەی پاکن لە تاوان ـ بانگەشەیەکی دژ بە دین بۆ مەسیحییەکانە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) باوەڕێک کە دژ بە باوەڕی زۆرینەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Many economists consider this view of how markets work to be heretical.""",
                      kurdishText:
                          """زۆر ئابووریزان ئەم دیدەی شێوازی کارکردنی بازاڕ بە جیاباوەڕی دادەنێن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/sGOXHdf-_dM?t=';
const double _startSecondsend = 000000000000000000000000000369;
const String _videoIdone = 'https://youtu.be/02LYLz1y6x4?t=';
const double _startSecondsone = 0000000000000000000000000002139;
const String _videoIdtwo = 'https://youtu.be/0RA_B5p2JYg?t=';
const double _startSecondstwo = 000000000000000000000000000941;
const String _videoIdthree = 'https://youtu.be/EmT0i0xG6zg?t=';
const double _startSecondsthree = 0000000000000000000000000003034;
const String _videoIdfour = 'https://youtu.be/TKhVE-pP7hA?t=';
const double _startSecondsfour = 000000000000000000000000000572;
const String _videoIdfive = 'https://youtu.be/xjEFo3a1AnI?t=';
const double _startSecondsfive = 0000000000000000000000000002845;
