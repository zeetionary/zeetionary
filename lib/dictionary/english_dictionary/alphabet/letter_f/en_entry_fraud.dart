...
class EnglishEntryfraud extends StatefulWidget {
  const EnglishEntryfraud({super.key});

  @override
  State<EnglishEntryfraud> createState() => _EnglishEntryfraudState();
}

class _EnglishEntryfraudState extends State<EnglishEntryfraud> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fraud (Derived forms: frauds)
1. Intentional deception resulting in injury to another person (= fiddle [Brit, informal])
 
2. A person who makes deceitful pretences (= imposter, impostor, pretender, fake, faker, sham, shammer, pseudo, pseud, role player)
 
3. Something intended to deceive; deliberate trickery intended to gain an advantage (= fraudulence, dupery, hoax, humbug, put-on [N. Amer, informal], spoof [informal])
 
4. The act of swindling by some fraudulent scheme (= swindle, cheat, rig)
"that book is a fraud";
""",
  );

  final String keyword = "fraud";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He helped prevent a £100 million fraud.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It was said that the property had been obtained by fraud.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He's nothing but a liar and a fraud.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fraud""",
                      // alsoEnglishWord: "also: fraud",
                      britshText: """IpaUK: /frɔːd/""",
                      americanText: """IpaUS: /frɔːd/""",
...
کوردی: کڵاولەسەرنان، دەسبڕی، فێڵ‌لێ‌کردن، گزی، تەڵەکە، هەڵفریواندن، فریو، فریودان، لەخشتەبردن،	دەسبڕ، گوێبڕ، گزەون، فێڵباز
"""),
// With short examples define "fraud", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """یارمەتیی دا لە ڕێگری لە دەسبڕییەکەی ١٠٠ ملیۆن پاوەندی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەوە گوترا کە زەوییەکە بە فێڵبازی بە دەستهێندرا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) کەسێک کە وەها پیشان دەدات کە خاسیەت. توانا، هتد ـی هەبێت کە لە ڕاستیدا نییەتی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He's nothing but a liar and a fraud.""",
                      kurdishText: """هیچ نییە جگە لە درۆزن و ساختەچییەک.""",
...
const double _startSecondsend = 000000000000000000000000000511;
const String _videoIdone = 'https://youtu.be/y4DTW4B3Sjs?t=';
const double _startSecondsone = 000000000000000000000000000904;
const String _videoIdtwo = 'https://youtu.be/Y5F_ha7d-PI?t=';
const double _startSecondstwo = 000000000000000000000000000179;
const String _videoIdthree = 'https://youtu.be/G3LZ-Jh2L6E?t=';
const double _startSecondsthree = 000000000000000000000000000587;
const String _videoIdfour = 'https://youtu.be/YVDJqipoohc?t=';
const double _startSecondsfour = 00000000000000000000000000011;
const String _videoIdfive = 'https://youtu.be/GaLdHd2J-xM?t=';
const double _startSecondsfive = 000000000000000000000000000346;
