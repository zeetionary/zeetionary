...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'Nd7cohTdRAo';
    const double startSecondsend = 602;
    const String videoIdone = 'oBsMQOHWiWM';
    const double startSecondsone = 197;
    const String videoIdtwo = 'XB2W_kw62u8';
    const double startSecondstwo = 947;
    const String videoIdthree = 'zj6p5kYnPPY';
    const double startSecondsthree = 413;
    const String videoIdfour = 'ZU_MF0NMKhU';
    const double startSecondsfour = 299;
    const String videoIdfive = '9yjZpBq1XBE';
    const double startSecondsfive = 2285;
