...
class EnglishEntryexhausted extends StatefulWidget {
  const EnglishEntryexhausted({super.key});

  @override
  State<EnglishEntryexhausted> createState() => _EnglishEntryexhaustedState();
}

class _EnglishEntryexhaustedState extends State<EnglishEntryexhausted> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exhausted""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exhausted""",
                      // alsoEnglishWord: "also: exhausted",
                      britshText: """IpaUK: /ɪɡˈzɔːstɪd/""",
                      americanText: """IpaUS: /ɪɡˈzɔːstɪd/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exhausted";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'm exhausted!""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The exhausted climbers were rescued by helicopter.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I was exhausted from the day's work.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She felt emotionally exhausted.""");
  }
...
کوردی: ماندوو، شەکەت، هیلاک، کەوەڕە، ڕەتاو، بێ‌قەوەت، لەپەل‌وپۆکەوتوو، لەپێ‌کەوتوو
"""),
          ...
          SentencesRow(
            ...
            kurdishText: """شاخەوانە ماندووەکان بە هەلیکۆپتەر ڕزگارکران.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I was exhausted from the day's work.""",
            kurdishText: """شەکەت بووم بەدەست کاری ڕۆژەکەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She felt emotionally exhausted.""",
            kurdishText: """لەلایەنی دەروونییەوە هەستی بە ماندوێتی دەکرد.""",
            onPressedBritish: () => speaksentence4("en-GB"),
            onPressedAmerican: () => speaksentence4("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ھاوەڵناو) کە بە تەواوی بەکارهێندراوە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """You cannot grow crops on exhausted land.""",
            kurdishText:
                """ناتوانیت دانەوێڵە بچینیت لەسەر زەوییەکی هەڵچۆڕاو.""",
...
const double _startSecondsend = 000000000000000000000000000000; // 240;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/_spuxXnul0U?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1144;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/tXjHb5QmDV0?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1122;
const String _videoIdthree = 'VIDEOhttps://youtu.be/zqllxbPWKNI?t=';
const double _startSecondsthree = 000000000000000000000000000; // 522;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/mY3SEMTROas?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1098;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/oD9BaNAH-eE?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 2304;
