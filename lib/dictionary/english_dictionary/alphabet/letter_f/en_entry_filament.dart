...
class EnglishEntryfilament extends StatefulWidget {
  const EnglishEntryfilament({super.key});

  @override
  State<EnglishEntryfilament> createState() => _EnglishEntryfilamentState();
}

class _EnglishEntryfilamentState extends State<EnglishEntryfilament> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""filament""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The light bulb has a tungsten filament inside.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """filament""",
                      // alsoEnglishWord: "also: filament",
                      britshText: """IpaUK: /ˈfɪləmənt/""",
                      americanText: """IpaUS: /ˈfɪləmənt/""",
...
// With short examples define "filament", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Underground fungi filaments provide nutrients and water to the trees.""",
                      kurdishText:
                          """دەزووە کەڕووییە ژێرزەمینییەکان خۆراک و ئاو بۆ دارەکان دابین دەکەن.""",
...
const String _videoIdtwo = 'https://youtu.be/qVfJheBp7Ys?t=';
const double _startSecondstwo = 000000000000000000000000000261;
const String _videoIdthree = 'https://youtu.be/oI_X2cMHNe0?t=';
const double _startSecondsthree = 000000000000000000000000000163;
const String _videoIdfour = 'https://youtu.be/ElSJb6CmS3c?t=';
