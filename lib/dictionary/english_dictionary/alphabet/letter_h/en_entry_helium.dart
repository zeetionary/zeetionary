...
class EnglishEntryhelium extends StatefulWidget {
  const EnglishEntryhelium({super.key});

  @override
  State<EnglishEntryhelium> createState() => _EnglishEntryheliumState();
}

class _EnglishEntryheliumState extends State<EnglishEntryhelium> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: helium (Derived forms: heliums)
1. A very light colourless element that is one of the six inert gasses; the most difficult gas to liquefy; occurs in economically extractable amounts in certain natural gases (as those found in Texas and Kansas) (- He, atomic number 2)
""",
  );

  final String keyword = "helium";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The balloons floated because they were filled with helium.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Helium is the second lightest element in the universe.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """helium""",
                      // alsoEnglishWord: "also: helium",
                      britshText: """IpaUK: /ˈhiːliəm/""",
                      americanText: """IpaUS: /ˈhiːliəm/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مادەیەکی کیمیایی زۆر سووک کە کە ناسووتێت و زۆرجار بەکاردێت بۆ پڕکردنی باڵۆن یان بەستنی خۆراک"""),
                    SentencesRow(
                      englishText:
                          """The balloons floated because they were filled with helium.""",
                      kurdishText:
                          """باڵۆنەکان چوونە ئاسماندا چونکە بە هیلیۆم پڕکرابوون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هیلیۆم دووەم بەربڵاوترین گازی گەردوونە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Kp_kqamkYpw?t=';
...
const String _videoIdtwo = 'https://youtu.be/k5m2kX7HEQ8?t=';
const double _startSecondstwo = 0000000000000000000000000009;
const String _videoIdthree = 'https://youtu.be/pa6PCcKgaa4?t=';
const double _startSecondsthree = 00000000000000000000000000019;
const String _videoIdfour = 'https://youtu.be/eCorxPmmLa8?t=';
const double _startSecondsfour = 0000000000000000000000000009;
const String _videoIdfive = 'https://youtu.be/tzecE6XDFgg?t=';
