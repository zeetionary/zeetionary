...
// replace EnglishEntryAdopsum - replace speakAppetite

// replace appetite - /ˈæpɪtaɪt/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryappetite extends StatelessWidget {
  // blank divider
  EnglishEntryappetite({super.key});
  // blank divider
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "appetite", // DOPSUM: CHANGE WORD ENTRY - Find /ˈæpɪtaɪt/
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAppetite(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
١. (ناو) ئیشتیا؛ هەبوونی حەزی خواردن""",
                          ...
                          const Text(
                            // DOPSUM: WRITE DEFINITION IN KURDISH. COPY FOR ANOTHER DEFINITION
                            """
٢. (ناو) هەبوونی حەزێکی زۆر بۆ شتێک""",
                            style: TextStyle(fontSize: 18),
                            textAlign: TextAlign.right,
                            textDirection: TextDirection.rtl,
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "https://youtu.be/nydm6xwfPr0?t=";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "https://youtu.be/I6vs3jsUCXA?t=";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "https://youtu.be/mRj1RKh4xyY?t=";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "https://youtu.be/bV9f3DE4LlM?t=";
