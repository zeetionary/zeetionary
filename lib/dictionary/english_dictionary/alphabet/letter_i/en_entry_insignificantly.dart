...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'E01J_uAPM64';
    const double startSecondsend = 243;
    const String videoIdone = 'sY8aFSY2zv4';
    const double startSecondsone = 5176;
    const String videoIdtwo = 'UiBq5UKHnRs';
    const double startSecondstwo = 241;
    const String videoIdthree = 'yjeS0Q-KDvc';
    const double startSecondsthree = 1896;
    const String videoIdfour = 'FvGvE1P0_p0';
    const double startSecondsfour = 471;
    const String videoIdfive = 'U6fI3brP8V4';
    const double startSecondsfive = 4084;
