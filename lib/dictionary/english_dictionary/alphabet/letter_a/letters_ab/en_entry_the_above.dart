...
class EnglishEntrytheabove extends StatefulWidget {
  const EnglishEntrytheabove({super.key});

  @override
  State<EnglishEntrytheabove> createState() => _EnglishEntrytheaboveState();
}

class _EnglishEntrytheaboveState extends State<EnglishEntrytheabove> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "the above";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """the above""",
                      // alsoEnglishWord: "also: the above",
                      britshText: """IpaUK: /ði əˈbʌv/""",
                      americanText: """IpaUS: /ði əˈbʌv/""",
