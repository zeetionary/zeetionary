...
class EnglishEntryforebear extends StatefulWidget {
  const EnglishEntryforebear({super.key});

  @override
  State<EnglishEntryforebear> createState() => _EnglishEntryforebearState();
}

class _EnglishEntryforebearState extends State<EnglishEntryforebear> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forebear (Derived forms: forebears)
1. A person from whom you are descended (= forbear)
""",
  );

  final String keyword = "forebear";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forebear""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her forebears came from Ireland.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He admired the achievements of his forebears.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forebear""",
                      // alsoEnglishWord: "also: forebear",
                      britshText: """IpaUK: /ˈfɔːbeə(r)/""",
                      americanText: """IpaUS: /ˈfɔːrber/""",
...
کوردی: کال‌وباب، پێشینیان، باو و باپیران
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێکی خێزانەکەت کە ساڵانێکی زۆر پێش ئێستا ژیاوە"""),
                    SentencesRow(
                      englishText: """Her forebears came from Ireland.""",
                      kurdishText: """باوباپیرانی خەڵکی ئێرلەندان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He admired the achievements of his forebears.""",
                      kurdishText: """سەرسامی دەستکەوتەکانی باوباپیرانی بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/P4l9Y5OHqpk?t=';
const double _startSecondsend = 000000000000000000000000000813;
const String _videoIdone = 'https://youtu.be/IfYRzxeMdGs?t=';
const double _startSecondsone = 000000000000000000000000000312;
const String _videoIdtwo = 'https://youtu.be/WWRTZ8IHFg4?t=';
const double _startSecondstwo = 000000000000000000000000000275;
const String _videoIdthree = 'https://youtu.be/3kIc70VqZ5U?t=';
const double _startSecondsthree = 00000000000000000000000000089;
const String _videoIdfour = 'https://youtu.be/UNHtj7QtCdk?t=';
const double _startSecondsfour = 000000000000000000000000000777;
const String _videoIdfive = 'https://youtu.be/BFrBr8oUVXU?t=';
const double _startSecondsfive = 000000000000000000000000000729;
