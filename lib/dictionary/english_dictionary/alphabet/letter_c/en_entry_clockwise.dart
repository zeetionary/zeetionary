...
class EnglishEntryclockwise extends StatelessWidget {
  // blank divider
  EnglishEntryclockwise({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakclockwise(String languageCode) async {
    // DOPSUM: CHANGE speakclockwise
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "clockwise"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈklɒkwaɪz/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakclockwise("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈklɑːkwaɪz/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakclockwise("en-US"),
                            ),
                          ],
                        ),
                      ],
...
کوردی: سەعات‌سووڕ، میل‌سووڕ، لە لای یان بە لای سووڕانی میلی کات‌ژمێر، ڕاست‌سووڕ
"""),
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/CiOZ2rQWfc4?t=',
    startSeconds: 8,
    autoPlay: true,
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/eeWmo8yx8AY?t=',
    startSeconds: 23,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/7Dc6s9MF9us?t=',
    startSeconds: 34,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/86nlzBF_LlI?t=',
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/d_fHun8jj2g?t=',
    startSeconds: 376,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
