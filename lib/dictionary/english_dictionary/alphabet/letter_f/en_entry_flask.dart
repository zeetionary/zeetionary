...
class EnglishEntryflask extends StatefulWidget {
  const EnglishEntryflask({super.key});

  @override
  State<EnglishEntryflask> createState() => _EnglishEntryflaskState();
}

class _EnglishEntryflaskState extends State<EnglishEntryflask> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flask (Derived forms: flasks)
1. Bottle that has a narrow neck
 
2. The quantity a flask will hold (= flaskful)
""",
  );

  final String keyword = "flask";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Heat the solution gently in a flask.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flask""",
                      // alsoEnglishWord: "also: flask",
                      britshText: """IpaUK: /flɑːsk/""",
                      americanText: """IpaUS: /flæsk/""",
...
// With short examples define "flask", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Heat the solution gently in a flask.""",
                      kurdishText:
                          """گیراوەکە بە هێواشی گەرم بکە لە شووشەیەکی تاقیگەدا.""",
...
const double _startSecondsend = 0000000000000000000000000009;
const String _videoIdone = 'https://youtu.be/kWN-CiUaHtQ?t=';
const double _startSecondsone = 000000000000000000000000000346;
const String _videoIdtwo = 'https://youtu.be/TsNvYjJ_JcE?t=';
const double _startSecondstwo = 000000000000000000000000000546;
const String _videoIdthree = 'https://youtu.be/dCXkaQa53QQ?t=';
const double _startSecondsthree = 000000000000000000000000000596;
const String _videoIdfour = 'https://youtu.be/VfC-wAJqksU?t=';
const double _startSecondsfour = 0000000000000000000000000001634;
const String _videoIdfive = 'https://youtu.be/6IIZJ4VOJZ8?t=';
const double _startSecondsfive = 000000000000000000000000000446;
