...
class EnglishEntryknowhow extends StatefulWidget {
  const EnglishEntryknowhow({super.key});

  @override
  State<EnglishEntryknowhow> createState() => _EnglishEntryknowhowState();
}

class _EnglishEntryknowhowState extends State<EnglishEntryknowhow> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryknowhow know-how
WORD_WEB know-how know-how know-how
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "know-how";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""know-how""");
  }
...
کوردی: 
"""),
// With short examples define "know-how", please follow LX instructions
