...
class EnglishEntrylousy extends StatefulWidget {
  const EnglishEntrylousy({super.key});

  @override
  State<EnglishEntrylousy> createState() => _EnglishEntrylousyState();
}

class _EnglishEntrylousyState extends State<EnglishEntrylousy> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylousy lousy
WORD_WEB lousy lousy lousy
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lousy";
...
کوردی: 
"""),
// With short examples define "lousy", please follow LX instructions
