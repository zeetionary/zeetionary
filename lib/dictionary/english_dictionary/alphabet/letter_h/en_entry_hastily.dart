...
class EnglishEntryhastily extends StatefulWidget {
  const EnglishEntryhastily({super.key});

  @override
  State<EnglishEntryhastily> createState() => _EnglishEntryhastilyState();
}

class _EnglishEntryhastilyState extends State<EnglishEntryhastily> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: hastily
1. In a hurried or hasty manner (- hurriedly, in haste)
"hastily, he scanned the headlines";
""",
  );

  final String keyword = "hastily";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hastily""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She hastily changed the subject.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Perhaps I spoke too hastily.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hastily""",
                      // alsoEnglishWord: "also: hastily",
                      britshText: """IpaUK: /ˈheɪstɪli/""",
                      americanText: """IpaUS: /ˈheɪstɪli/""",
...
کوردی: بە پەلە، بە پڕتاو، بە هەشتاو، بە تاوەتڕێ، (بە) تەقڵەکوت
"""),
// With short examples define "hastily", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) زۆر بە خێرایی بەهۆی ئەوەی پەلەتە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: hurriedly"),
                    SentencesRow(
                      englishText: """She hastily changed the subject.""",
                      kurdishText: """زوو بابەتەکەی گۆڕی.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵکار) زوو بەبێ بیرکردنەوەی زۆر"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Perhaps I spoke too hastily.""",
                      kurdishText: """ئەگەری هەیە زۆر بە خێرایی قسەم کردبێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/hRSGxw2AQnk?t=';
const double _startSecondsend = 000000000000000000000000000669;
const String _videoIdone = 'https://youtu.be/QLq6GEiHqR8?t=';
const double _startSecondsone = 0000000000000000000000000001560;
const String _videoIdtwo = 'https://youtu.be/rtAAjKBH9GU?t=';
const double _startSecondstwo = 000000000000000000000000000541;
const String _videoIdthree = 'https://youtu.be/qg2nGY1aqlg?t=';
...
const double _startSecondsfive = 000000000000000000000000000137;
