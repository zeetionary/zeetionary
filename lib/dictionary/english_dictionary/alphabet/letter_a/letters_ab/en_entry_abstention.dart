...
class EnglishEntryabstention extends StatefulWidget {
  const EnglishEntryabstention({super.key});

  @override
  State<EnglishEntryabstention> createState() => _EnglishEntryabstentionState();
}

class _EnglishEntryabstentionState extends State<EnglishEntryabstention> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "abstention";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""abstention""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """abstention""",
                      // alsoEnglishWord: "also: abstention",
                      britshText: """IpaUK: /əbˈstenʃn/""",
                      americanText: """IpaUS: /əbˈstenʃn/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'lZ3bPUKo5zc';
  final double _startSeconds = 2360;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '4CUg424lmG4';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'thXe-rtpl6U';
  final double _startSeconds = 4188;
