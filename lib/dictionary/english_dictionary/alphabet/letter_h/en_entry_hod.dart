...
class EnglishEntryhod extends StatefulWidget {
  const EnglishEntryhod({super.key});

  @override
  State<EnglishEntryhod> createState() => _EnglishEntryhodState();
}

class _EnglishEntryhodState extends State<EnglishEntryhod> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The worker filled the hod with bricks.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/OBJStOs1Ofc?t=';
    const double startSecondsend = 000000000000000000000000000328;
    const String videoIdone = 'https://youtu.be/uCX9nMaZ7xM?t=';
    const double startSecondsone = 000000000000000000000000000607;
    const String videoIdtwo = 'https://youtu.be/ZPr-a8kht2E?t=';
    const double startSecondstwo = 0000000000000000000000000001407;
    const String videoIdthree = 'https://youtu.be/xnIUrpFo7vM?t=';
    const double startSecondsthree = 00000000000000000000000000074;
    const String videoIdfour = 'https://youtu.be/L2_4TWZBc54?t=';
    const double startSecondsfour = 0000000000000000000000000001437;
    const String videoIdfive = 'https://youtu.be/pAtUfZ_TQ5Y?t=';
    const double startSecondsfive = 000000000000000000000000000803;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hod""",
                      // alsoEnglishWord: "also: hod",
                      britshText: """IpaUK: /hɒd/""",
                      americanText: """IpaUS: /hɑːd/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) شتێک کە بە ستوونێک بەستراوە و کرێکاران بۆ هەڵگرتنی خشت بەکاری دێنن"""),
                    SentencesRow(
                      englishText: """The worker filled the hod with bricks.""",
                      kurdishText: """کرێکارەکە خشتهەڵگرەکەی پڕکرد لە خشت.""",
