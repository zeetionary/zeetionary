...
class EnglishEntrygoingson extends StatefulWidget {
  const EnglishEntrygoingson({super.key});

  @override
  State<EnglishEntrygoingson> createState() => _EnglishEntrygoingsonState();
}

class _EnglishEntrygoingsonState extends State<EnglishEntrygoingson> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "goings-on";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""goings-on""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There were some strange goings-on next door last night.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """goings-on""",
                      // alsoEnglishWord: "also: goings-on",
                      britshText: """IpaUK: /ˌɡəʊɪŋz ˈɒn/""",
                      americanText: """IpaUS: /ˌɡəʊɪŋz ˈɑːn/""",
...
// With short examples define "goings-on", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەو چالاکی و بۆنانەی کە نامۆ، جێگەی سەرسامی، یان فێڵبازانەن"""),
                    SentencesRow(
                      englishText:
                          """There were some strange goings-on next door last night.""",
                      kurdishText:
                          """شەوی ڕابردوو لە ماڵی دراوسێمان هەندێک شتی نائاسایی ڕوویان دا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/MzSktgpfD84?t=';
const double _startSecondsend = 000000000000000000000000000134;
const String _videoIdone = 'https://youtu.be/1Gxrwh4zGPg?t=';
const double _startSecondsone = 00000000000000000000000000084;
const String _videoIdtwo = 'https://youtu.be/9n4j9KaQfqk?t=';
const double _startSecondstwo = 000000000000000000000000000129;
const String _videoIdthree = 'https://youtu.be/TWd6_Eoey_U?t=';
const double _startSecondsthree = 0000000000000000000000000001100;
const String _videoIdfour = 'https://youtu.be/m1VdwNOWhWI?t=';
const double _startSecondsfour = 000000000000000000000000000726;
const String _videoIdfive = 'https://youtu.be/WgTr1Nq-yC4?t=';
const double _startSecondsfive = 000000000000000000000000000215;
