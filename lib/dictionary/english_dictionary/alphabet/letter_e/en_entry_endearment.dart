...
class EnglishEntryendearment extends StatefulWidget {
  const EnglishEntryendearment({super.key});

  @override
  State<EnglishEntryendearment> createState() => _EnglishEntryendearmentState();
}

class _EnglishEntryendearmentState extends State<EnglishEntryendearment> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""endearment""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """endearment""",
                      // alsoEnglishWord: "also: endearment",
                      britshText: """IpaUK: /ɪnˈdɪəmənt/""",
                      americanText: """IpaUS: /ɪnˈdɪrmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "endearment";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They were whispering endearments to each other.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""‘Darling’ is a term of endearment.""");
  }
...
کوردی: قسە یان دەستەوشەی خۆشەویستانە، قسەی دڵدارانە،	خۆشەویستی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) وشە یان دەربڕینێک کە ئامانج لێی دەربڕینیخۆشەویستییە"""),
          SentencesRow(
            englishText: """They were whispering endearments to each other.""",
            kurdishText: """قسەی دڵدارانەیان دەچرپاند بۆ یەکدی.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """‘Darling’ is a term of endearment.""",
            kurdishText: """'ئازیزەکەم' واژەیەکی خۆشەویستانەیە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: endearment (Derived forms: endearments)
...
const String _videoIdend = 'https://youtu.be/WV0OBRJKeYA?t=';
const double _startSecondsend = 763;
const String _videoIdone = 'https://youtu.be/WrN3Dx3EBVI?t=';
const double _startSecondsone = 612;
const String _videoIdtwo = 'https://youtu.be/36oRiPAn4Tw?t=';
const double _startSecondstwo = 688;
const String _videoIdthree = 'https://youtu.be/h_o-WCll7Fs?t=';
const double _startSecondsthree = 531;
const String _videoIdfour = 'https://youtu.be/booTTAIvKf8?t=';
const double _startSecondsfour = 172;
const String _videoIdfive = 'https://youtu.be/2QpdimsgZGg?t=';
const double _startSecondsfive = 3477;
const String _videoIdsix = 'https://youtu.be/uUteMtNhe3g?t=';
const double _startSecondssix = 132;
