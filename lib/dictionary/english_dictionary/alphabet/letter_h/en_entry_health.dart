...
class EnglishEntryhealth extends StatefulWidget {
  const EnglishEntryhealth({super.key});

  @override
  State<EnglishEntryhealth> createState() => _EnglishEntryhealthState();
}

class _EnglishEntryhealthState extends State<EnglishEntryhealth> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: health (Derived forms: healths)
1. The state of being free of physical or psychological disease, illness, or malfunction (- wellness)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Exhaust fumes are bad for your health.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Grandma is not in the best of health.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Smoking can seriously damage your health.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She aborted the child due to health issues.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Her health was adversely affected by the climate.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""kurdishText:
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her mental health began to deteriorate.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Slowly they nursed him back to health.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Rest and exercise restored her health.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""You need to maintain your physical and mental health.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""All parties are promising to increase spending on health.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak(
        """The government is working to improve the health of the economy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """health""",
                      // alsoEnglishWord: "also: health",
                      britshText: """IpaUK: /helθ/""",
                      americanText: """IpaUS: /helθ/""",
...
کوردی: سڵامەتی، ساغی، لەش‌ساغی، باشی، ساخلەمی، تەندروستی،	باری لەش، خوو، واز
"""),
// With short examples define "health", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) دۆخی دەروونی یان جەستەیی کەسێک"""),
                    SentencesRow(
                      englishText: """Exhaust fumes are bad for your health.""",
                      kurdishText: """دووکەڵی ئەگسۆز خراپە بۆ تەندرووستی.""",
                        ...
                        MyExpansionTile(
                          children: [
                            SentencesRow(
                              ...
                              kurdishText:
                                  """داپیرە لە باشترین تەندرووستییدا نییە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """جگەرەکێشان دەکرێت بە ئاستێکی زۆر کاریگەری خراپی لەسەر تەندرووستی هەبێت.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """دۆخی تەندرووستیی دەستی بە خراپبوون کرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ئەوەی لە ڕووی دەروونی و جەستەیی سەلامەت بیت"""),
                    SentencesRow(
                      englishText: """Slowly they nursed him back to health.""",
                      kurdishText: """بە هێواشی تەندرووستییان بۆ گەڕاندەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """حەسانەوە و ڕاهێنان تەندرووستییان بۆ گەڕاندەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەبێت ئاگاداری تەندرووستی جەستەیی و دەروونیت بیت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) کاری پێدانی خزمەتگوزاری تەندرووستی"""),
                    SentencesRow(
                      englishText:
                          """All parties are promising to increase spending on health.""",
                      kurdishText:
                          """هەموو پارتەکان بەڵێن دەدەن خەرجی زیاد بکەن بۆ تەندرووستی.""",
                      onPressedBritish: () => speaksentence12("en-GB"),
                      onPressedAmerican: () => speaksentence12("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (ناو) ئاستی سەرکەوتنی شتێک"""),
                    SentencesRow(
                      englishText:
                          """The government is working to improve the health of the economy.""",
                      kurdishText:
                          """حکومەت کار دەکات بۆ باشترکردنی تەندروستیی ئابووری..""",
...
const double _startSecondsend = 000000000000000000000000000107;
const String _videoIdone = 'https://youtu.be/WDetHC86Dgo?t=';
const double _startSecondsone = 000000000000000000000000000307;
const String _videoIdtwo = 'https://youtu.be/UuGpm01SPcA?t=';
const double _startSecondstwo = 000000000000000000000000000500;
const String _videoIdthree = 'https://youtu.be/juK9c8zgUvU?t=';
const double _startSecondsthree = 000000000000000000000000000262;
const String _videoIdfour = 'https://youtu.be/zX5TrXxnx7k?t=';
const double _startSecondsfour = 00000000000000000000000000012;
const String _videoIdfive = 'https://youtu.be/eT_Gzi0HN4E?t=';
