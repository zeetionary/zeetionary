...
class EnglishEntryextrapolation extends StatefulWidget {
  const EnglishEntryextrapolation({super.key});

  @override
  State<EnglishEntryextrapolation> createState() =>
      _EnglishEntryextrapolationState();
}

class _EnglishEntryextrapolationState extends State<EnglishEntryextrapolation> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extrapolation""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extrapolation""",
                      // alsoEnglishWord: "also: extrapolation",
                      britshText: """IpaUK: /ɪkˌstræpəˈleɪʃn/""",
                      americanText: """IpaUS: /ɪkˌstræpəˈleɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extrapolation";
...
"""),
          ...
          SentencesRow(
            englishText:
                """Their age can be determined by extrapolation from their growth rate.""",
            kurdishText:
                """تەمەنی دەکرێت دیاری بکرێت بە مەزەندەکردنی ئاستی گەشەیان.""",
          ...
          SentencesRow(
            ...
            kurdishText: """گریمانەکە مەزەندەی زۆر لەخۆ دەگرێت.""",
...
const String _videoIdend = 'https://youtu.be/BLK6dV76XTQ?t=';
const double _startSecondsend = 000000000000000000000000000272;
const String _videoIdone = 'https://youtu.be/9s9UXXAmlTg?t=';
const double _startSecondsone = 000000000000000000000000000682;
const String _videoIdtwo = 'https://youtu.be/CZP6nogQYPg?t=';
const double _startSecondstwo = 000000000000000000000000000121;
const String _videoIdthree = 'https://youtu.be/219YybX66MY?t=';
const double _startSecondsthree = 000000000000000000000000000294;
const String _videoIdfour = 'https://youtu.be/50FKlr6-ie4?t=';
const double _startSecondsfour = 000000000000000000000000000782;
const String _videoIdfive = 'https://youtu.be/39XmffMuds0?t=';
