...
class EnglishEntryadditional extends StatefulWidget {
  const EnglishEntryadditional({super.key});

  @override
  State<EnglishEntryadditional> createState() => _EnglishEntryadditionalState();
}

class _EnglishEntryadditionalState extends State<EnglishEntryadditional> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "additional";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """additional""",
                      // alsoEnglishWord: "also: additional",
                      britshText: """IpaUK: /əˈdɪʃənl/""",
                      americanText: """IpaUS: /əˈdɪʃənl/""",
