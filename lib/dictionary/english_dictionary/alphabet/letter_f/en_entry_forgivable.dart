...
class EnglishEntryforgivable extends StatefulWidget {
  const EnglishEntryforgivable({super.key});

  @override
  State<EnglishEntryforgivable> createState() => _EnglishEntryforgivableState();
}

class _EnglishEntryforgivableState extends State<EnglishEntryforgivable> {
  @override
  void initState() {
    super.initState();
...
1. Easily excused or forgiven (= excusable, venial)
"a forgivable error";
""",
  );

  final String keyword = "forgivable";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forgivable""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His rudeness was forgivable in the circumstances.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forgivable""",
                      // alsoEnglishWord: "also: forgivable",
                      britshText: """IpaUK: /fəˈɡɪvəbl/""",
                      americanText: """IpaUS: /fərˈɡɪvəbl/""",
...
کوردی: شیاوی لێ‌خۆشبوون، شیاوی چاپۆشی، لەبەخشین‌هاتوو، لەبوردن‌هاتوو، هیچ نییە، دەبەخشرێ
"""),
// With short examples define "forgivable", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بێڕێزییەکەی شیاوی لێ‌خۆشبوون بوو لەو هەلوومەرجەدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/C_7tn_oGHI0?t=';
const double _startSecondsend = 0000000000000000000000000003181;
const String _videoIdone = 'https://youtu.be/FCZ06Sfr9Cg?t=';
const double _startSecondsone = 000000000000000000000000000387;
const String _videoIdtwo = 'https://youtu.be/rsnnmlIqS2M?t=';
const double _startSecondstwo = 000000000000000000000000000839;
const String _videoIdthree = 'https://youtu.be/UsD87v8F914?t=';
const double _startSecondsthree = 000000000000000000000000000158;
const String _videoIdfour = 'https://youtu.be/w1vuhrFfEkE?t=';
const double _startSecondsfour = 000000000000000000000000000488;
const String _videoIdfive = 'https://youtu.be/LbalOCu5Xqc?t=';
const double _startSecondsfive = 000000000000000000000000000382;
