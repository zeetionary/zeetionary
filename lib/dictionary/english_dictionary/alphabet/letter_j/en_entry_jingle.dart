...
class EnglishEntryjingle extends StatefulWidget {
  const EnglishEntryjingle({super.key});

  @override
  State<EnglishEntryjingle> createState() => _EnglishEntryjingleState();
}

class _EnglishEntryjingleState extends State<EnglishEntryjingle> {
  @override
  void initState() {
    super.initState();
