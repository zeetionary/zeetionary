...
class EnglishEntrygreymatter extends StatefulWidget {
  const EnglishEntrygreymatter({super.key});

  @override
  State<EnglishEntrygreymatter> createState() => _EnglishEntrygreymatterState();
}

class _EnglishEntrygreymatterState extends State<EnglishEntrygreymatter> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grey matter
Usage: Brit, Cdn (US: gray matter)
1. Greyish nervous tissue containing cell bodies as well as fibers; forms the cerebral cortex consisting of unmyelinated neurons (- gray matter [US], grey substance [Brit, Cdn], gray substance [US], substantia grisea)
""",
  );

  final String keyword = "grey matter";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grey matter""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This should exercise the old grey matter.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grey matter""",
                      // alsoEnglishWord: "also: grey matter",
                      britshText: """IpaUK: /ˈɡreɪ mætə(r)/""",
                      americanText: """IpaUS: /ˈɡreɪ mætər/""",
...
// With short examples define "grey matter", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەمە دەبێت زیرەکی جارانت بخاتەوە کار.""",
                      englishNote:
                          """This means 'This should make you think hard or use your brain actively.'""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/txAC4WMD5f8?t=';
const double _startSecondsend = 000000000000000000000000000293;
const String _videoIdone = 'https://youtu.be/w-dxMTDzMLY?t=';
const double _startSecondsone = 0000000000000000000000000001746;
const String _videoIdtwo = 'https://youtu.be/fi8P_XYiykQ?t=';
const double _startSecondstwo = 000000000000000000000000000373;
const String _videoIdthree = 'https://youtu.be/gUkJ0T3NpN8?t=';
const double _startSecondsthree = 00000000000000000000000000026;
const String _videoIdfour = 'https://youtu.be/wOFuVNiAJQQ?t=';
const double _startSecondsfour = 000000000000000000000000000126;
const String _videoIdfive = 'https://youtu.be/FaIBdVdu0wo?t=';
