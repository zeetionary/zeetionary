...
class EnglishEntryliquidizer extends StatefulWidget {
  const EnglishEntryliquidizer({super.key});

  @override
  State<EnglishEntryliquidizer> createState() => _EnglishEntryliquidizerState();
}

class _EnglishEntryliquidizerState extends State<EnglishEntryliquidizer> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: liquidizer (Derived forms: liquidizers)
1. An electrically powered mixer with whirling blades that mix, chop or liquefy foods (- blender, liquidiser [Brit])
""",
  );

  final String keyword = "liquidizer";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""liquidizer""");
  }
...
""");
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/MMm_kkwkYQM?t=59';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/0J0h5nmnnfU?t=677';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/WzMo5mMn0gY?t=42';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/QPIylInMqqM?t=88';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/xnq8ICpDZI8?t=74';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/in2fY6FfKsk?t=23';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """liquidizer""",
                      // alsoEnglishWord: "also: liquidizer",
                      britshText: """IpaUK: /ˈlɪkwɪdaɪzə(r)/""",
                      americanText: """IpaUS: /ˈlɪkwɪdaɪzər/""",
...
کوردی: 
"""),
// With short examples define "liquidizer", please follow LX instructions
                    ...
                    CustomRichText(
                      ...
                      onTap: () {
                        Routemaster.of(context)
                            .push("/english-liquidizer/blender");
                      },
                    ),
//                     const DefinitionKurdish(text: """١. (ھاوەڵناو) پننسە"""),
//                     const AlsoEnglishckb(word: "ھەروەھا: blender"),
//                     SentencesRow(
