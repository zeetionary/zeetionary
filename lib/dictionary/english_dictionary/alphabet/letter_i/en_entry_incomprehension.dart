...
class EnglishEntryincomprehension extends StatefulWidget {
  const EnglishEntryincomprehension({super.key});

  @override
  State<EnglishEntryincomprehension> createState() =>
      _EnglishEntryincomprehensionState();
}

class _EnglishEntryincomprehensionState
    extends State<EnglishEntryincomprehension> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incomprehension""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'Okp0pfExsHc';
    const double startSecondsend = 43;
    const String videoIdone = 'Cl5iPga0bI8';
    const double startSecondsone = 564;
    const String videoIdtwo = 'ydXL_7Bjiqw';
    const double startSecondstwo = 182;
    const String videoIdthree = 'flpoHS1k6Lo';
    const double startSecondsthree = 1374;
    const String videoIdfour = 'gub38Cd4E0g';
    const double startSecondsfour = 130;
    const String videoIdfive = 'm8Sv5Hn26OQ';
