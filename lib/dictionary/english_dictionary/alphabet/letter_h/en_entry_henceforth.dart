...
class EnglishEntryhenceforth extends StatefulWidget {
  const EnglishEntryhenceforth({super.key});

  @override
  State<EnglishEntryhenceforth> createState() => _EnglishEntryhenceforthState();
}

class _EnglishEntryhenceforthState extends State<EnglishEntryhenceforth> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: henceforth
1. From this time forth; from now on (- henceforward)
"henceforth she will be known as Mrs. Smith";
""",
  );

  final String keyword = "henceforth";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""henceforth""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """henceforth""",
                      alsoEnglishWord: "also: henceforward",
                      britshText: """IpaUK: /ˌhensˈfɔːθ/""",
                      americanText: """IpaUS: /ˌhensˈfɔːrθ/""",
...
کوردی: 
"""),
// With short examples define "henceforth", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) لە ئێستاوە"""),
                    SentencesRow(
                      englishText:
                          """Henceforth, the said building shall be the property of Brendan Duggan.""",
                      kurdishText:
                          """لە ئێستاوە، بینا باسکراوەکە دەبێت بە سامانی برێندن دوگان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Friday 31 July 1925 henceforth became known as ‘Red Friday’.""",
                      kurdishText:
                          """هەینیی ٣١ ـی تەمووزی ١٩٢٥ لەو کاتەوە ناسرا بە 'هەینیی سوور'.""",
...
const double _startSecondsend = 0000000000000000000000000001180;
const String _videoIdone = 'https://youtu.be/6y8BiXC8c98?t=';
const double _startSecondsone = 000000000000000000000000000826;
const String _videoIdtwo = 'https://youtu.be/l4arxvePtCQ?t=';
const double _startSecondstwo = 000000000000000000000000000139;
const String _videoIdthree = 'https://youtu.be/3u2FauOIPh8?t=';
const double _startSecondsthree = 0000000000000000000000000001400;
const String _videoIdfour = 'https://youtu.be/kw2NxzfP8K4?t=';
const double _startSecondsfour = 0000000000000000000000000001598;
const String _videoIdfive = 'https://youtu.be/4wAs6B9SV1E?t=';
const double _startSecondsfive = 0000000000000000000000000001039;
