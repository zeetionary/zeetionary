...
class EnglishEntryevasion extends StatefulWidget {
  const EnglishEntryevasion({super.key});

  @override
  State<EnglishEntryevasion> createState() => _EnglishEntryevasionState();
}

class _EnglishEntryevasionState extends State<EnglishEntryevasion> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evasion""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evasion""",
                      // alsoEnglishWord: "also: evasion",
                      britshText: """IpaUK: /ɪˈveɪʒn/""",
                      americanText: """IpaUS: /ɪˈveɪʒn/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's been charged with tax evasion.""");
  }
...
کوردی: دەرچوون، هەڵاتن، لەژێرکاردەرچوون، خۆدزینەوە، خۆلێ‌لادان، خۆلێ‌بواردن،	پێچ‌وپەنا، بە کنگاخستن، پرینگانەوە، هەواڵە بە گەواڵە، خۆگێل‌کردن،	بەهانە، پەڵپ
"""),
          const DefinitionKurdish(
              text: """١. (ناو) خۆدزینەوە لە بینینی کەسێک یان کردنی شتێک"""),
          SentencesRow(
            englishText: """She's been charged with tax evasion.""",
            kurdishText: """بە خۆدزینەوە لە باج تاوانبار کراوە.""",
          ...
          SentencesRow(
            englishText:
                """His behaviour was an evasion of his responsibilities as a father.""",
            kurdishText:
                """ڕەفتارەکەی خۆدزینەوە لە بەرپرسیاریەتی بوو وەک باوک.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) شتێک کە کەسێک دەیڵێت کە باس لە شتێک ناکات بە ڕاستگۆیی و ڕاستەوخۆ"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """His speech was full of evasions and half-truths.""",
            kurdishText: """وتارەکەی پڕ لە خۆدزینەوە و نیوە ڕاستی.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: evasion (Derived forms: evasions)
1. A statement that is not literally false but that cleverly avoids an unpleasant truth (= equivocation)
 
2. The deliberate act of failing to pay money (= nonpayment)
"his evasion of all his creditors";
 
3. Nonperformance of something distasteful (as by deceit or trickery) that you are supposed to do (= escape, dodging)
"his evasion of his clear duty was reprehensible";
 
4. The act of physically escaping from something (an opponent or a pursuer or an unpleasant situation) by some adroit manoeuvre
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/Gi3HnqetpLw?t=';
const double _startSecondsend = 000000000000000000000000000000; // 326;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/uhMoAkjcEO4?t=';
const double _startSecondsone = 00000000000000000000000000000; // 148;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/kBdfcR-8hEY?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1306;
const String _videoIdthree = 'VIDEOhttps://youtu.be/KSuYDQ7tFEk?t=';
const double _startSecondsthree = 000000000000000000000000000; // 627;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/Iv7PW4ZEFD4?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 969;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/QLNCl3dBqG8?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 822;
