...
class EnglishEntrygrandfather extends StatefulWidget {
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grandfather (Derived forms: grandfathers)
1. The father of your father or mother (- gramps, granddad, grandad, granddaddy, grandpa, grandaddy [N. Amer, informal], grandpapa [archaic])

- Verb: grandfather (Derived forms: grandfathers, grandfathering, grandfathered)
Usage: N. Amer
1. Exempt pre-existing conditions from new requirements, legislation, or restrictions
""",
  );

  final String keyword = "grandfather";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grandfather""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The firm had been founded by his grandfather.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grandfather""",
                      alsoEnglishWord: "also: grandad, granddad, grandpa",
                      britshText: """IpaUK: /ˈɡrænfɑːðə(r)/""",
                      americanText: """IpaUS: /ˈɡrænfɑːðər/""",
...
"""),
// With short examples define "grandfather", please follow LX instructions
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/1XKSo2mFC6c?t=';
...
const String _videoIdthree = 'https://youtu.be/2ryj5SYpub0?t=';
const double _startSecondsthree = 00000000000000000000000000068;
const String _videoIdfour = 'https://youtu.be/-llpMjs_9jE?t=';
const double _startSecondsfour = 000000000000000000000000000113;
const String _videoIdfive = 'https://youtu.be/plgokMdHX_4?t=';
