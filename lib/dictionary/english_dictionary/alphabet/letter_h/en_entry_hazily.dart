...
class EnglishEntryhazily extends StatefulWidget {
  const EnglishEntryhazily({super.key});

  @override
  State<EnglishEntryhazily> createState() => _EnglishEntryhazilyState();
}

class _EnglishEntryhazilyState extends State<EnglishEntryhazily> {
  @override
  void initState() {
    super.initState();
...
2. In an indistinct way
"he remembered her only hazily"
""",
  );

  final String keyword = "hazily";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The sun was shining hazily through the palm leaves.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This all seems hazily familiar.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hazily""",
                      // alsoEnglishWord: "also: hazily",
                      britshText: """IpaUK: /ˈheɪzɪli/""",
                      americanText: """IpaUS: /ˈheɪzɪli/""",
...
کوردی: تەماوی‌یانە، بە شێوەیەکی تەماوی
"""),
// With short examples define "hazily", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵکار) کە ڕوون نییە بەهۆی تەمەوە"""),
                    SentencesRow(
                      englishText: """The sun was shining hazily through the palm leaves.""",
                      kurdishText: """خۆرەکە تەماوییانە بە گەڵای دار خورماکاندا دەدرەوشایەوە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵکار) بە شێوەیەک کە ڕوون نییە بەهۆی کەمی یادەوەری، زانیاری، یان وردەکاری"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """This all seems hazily familiar.""",
                      kurdishText: """ئەمە هەمووی تەم‌ومژاوییانە ئاشنا دیارە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/UtwUBL0mMQQ?t=';
const double _startSecondsend = 000000000000000000000000000184;
const String _videoIdone = 'https://youtu.be/JyZ5Zb7SLn8?t=';
const double _startSecondsone = 0000000000000000000000000009914;
const String _videoIdtwo = 'https://youtu.be/A4AsHUg5kAA?t=';
const double _startSecondstwo = 000000000000000000000000000704;
const String _videoIdthree = 'https://youtu.be/OUf-QXDJgF8?t=';
const double _startSecondsthree = 00000000000000000000000000092;
const String _videoIdfour = 'https://youtu.be/tDb01ggyDfo?t=';
const double _startSecondsfour = 000000000000000000000000000658;
const String _videoIdfive = 'https://youtu.be/JyZ5Zb7SLn8?t=';
const double _startSecondsfive = 0000000000000000000000000009914;
