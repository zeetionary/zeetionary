...
class EnglishEntryassess extends StatelessWidget {
  ...
  Future<void> speakassess1114(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("Accurately assessing environmental impacts is very complex.");
  }
  ...
  Future<void> speakassess1116(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Damage to the building was assessed at £40 000.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "assess"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈses/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakassess("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈses/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakassess("en-US"),
                            ),
                          ],
                        ),
                      ],
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakassess1114("en-US"),
                          ),
...
٢. (کردار) خەمڵاندنی شتێک"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakassess1116("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'Op_v2PHDn-0';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'zEYE-vcVKy8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'ZasotzWSUIA';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'Vs-bzasuCoc';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '5LbVzNvh0nA';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'sI0EKDljqXo';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'qoHnwOHLiMk';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'rU8APAwp6io';
