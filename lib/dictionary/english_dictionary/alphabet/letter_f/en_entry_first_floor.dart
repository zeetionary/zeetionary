...
class EnglishEntryfirstfloor extends StatefulWidget {
  const EnglishEntryfirstfloor({super.key});

  @override
  State<EnglishEntryfirstfloor> createState() => _EnglishEntryfirstfloorState();
}

class _EnglishEntryfirstfloorState extends State<EnglishEntryfirstfloor> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: first floor (Derived forms: first floors)
1. [N. Amer] The floor of a building that is at or nearest to the level of the ground around the building (= ground floor, ground level)
 
2. [Brit] The first floor of a building above ground level
""",
  );

  final String keyword = "first floor";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""first floor""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Menswear is on the first floor.""");
  }
...
کوردی: 
"""),
// With short examples define "first floor", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) لە بەریتانیا نهۆمی یەکەمی لە سەروو نهۆمی ئەرزییەوە"""),
                    SentencesRow(
                      englishText: """Menswear is on the first floor.""",
                      kurdishText:
                          """جلی پیاوان لە یەکەم (= لە کوردستان دووەم) نهۆمە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) لە ئەمریکا ئەو نهۆمەیە کە هاوتایە لەگەڵ بەرزی دەرەوەی بیناکە، یان کە ڕاستەوخۆ لە پلەکانەی دەرەوەی بیناکەوە دێیتە ناوی"""),
                    AlsoEnglishckblink(
                      textBeforeLink: "هەروەها: لە بەریتانیا",
                      linkText: "ground floor",
                      textAfterLink: ".",
                      onTap: () {
                        Routemaster.of(context)
                            .push("/english-firstfloor/groundfloor");
                      },
                    ),
                    SentencesRow(
                      englishText:
                          """She got on the elevator on the first floor and pushed the button for the 35th.""",
                      kurdishText:
                          """لە یەکەم نهۆم چووە ناو بەرزکەرەوەکەوە و پەنجەی نا بە دووگمەی نهۆمی ٣٥.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/f7QWMUCMYOE?t=';
const double _startSecondsend = 000000000000000000000000000883;
const String _videoIdone = 'https://youtu.be/LXhLlWQtdt0?t=';
const double _startSecondsone = 000000000000000000000000000208;
const String _videoIdtwo = 'https://youtu.be/LhR5w1bc6Xg?t=';
const double _startSecondstwo = 00000000000000000000000000013;
const String _videoIdthree = 'https://youtu.be/LwZIxGAG8xA?t=';
const double _startSecondsthree = 00000000000000000000000000018;
const String _videoIdfour = 'https://youtu.be/7xRit3yRim0?t=';
const double _startSecondsfour = 000000000000000000000000000941;
const String _videoIdfive = 'https://youtu.be/knjliFs3gR8?t=';
const double _startSecondsfive = 000000000000000000000000000383;
