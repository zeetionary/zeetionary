...
class EnglishEntryhighgrade extends StatefulWidget {
  const EnglishEntryhighgrade({super.key});

  @override
  State<EnglishEntryhighgrade> createState() => _EnglishEntryhighgradeState();
}

class _EnglishEntryhighgradeState extends State<EnglishEntryhighgrade> {
  @override
  void initState() {
    super.initState();
...
1. Surpassing in quality (- top-quality, top-grade)
"high-grade ore";
""",
  );

  final String keyword = "high-grade";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""high-grade""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The price of high-grade aluminum rose.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """high-grade""",
                      // alsoEnglishWord: "also: high-grade",
                      britshText: """IpaUK: /ˌhaɪ ˈɡreɪd/""",
                      americanText: """IpaUS: /ˌhaɪ ˈɡreɪd/""",
...
کوردی: 
"""),
// With short examples define "high-grade", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) لە ئاستی زۆر بەرز"""),
                    SentencesRow(
                      englishText: """The price of high-grade aluminum rose.""",
                      kurdishText: """نرخی ئەلەمنیۆمی ئاست بەرز بەرزبوویەوە.""",
...
const String _videoIdtwo = 'https://youtu.be/5obktsi8XdI?t=';
const double _startSecondstwo = 000000000000000000000000000536;
const String _videoIdthree = 'https://youtu.be/SqH0nJngy-c?t=';
const double _startSecondsthree = 000000000000000000000000000299;
const String _videoIdfour = 'https://youtu.be/-ju6y-pHByw?t=';
const double _startSecondsfour = 000000000000000000000000000253;
const String _videoIdfive = 'https://youtu.be/VfC-wAJqksU?t=';
const double _startSecondsfive = 000000000000000000000000000275;
