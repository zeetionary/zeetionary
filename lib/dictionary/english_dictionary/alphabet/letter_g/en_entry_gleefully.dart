...
class EnglishEntrygleefully extends StatefulWidget {
  const EnglishEntrygleefully({super.key});

  @override
  State<EnglishEntrygleefully> createState() => _EnglishEntrygleefullyState();
}

class _EnglishEntrygleefullyState extends State<EnglishEntrygleefully> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gleefully";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gleefully""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gleefully""",
                      // alsoEnglishWord: "also: gleefully",
                      britshText: """IpaUK: /ˈɡliːfəli/""",
                      americanText: """IpaUS: /ˈɡliːfəli/""",
...
// With short examples define "gleefully", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) دڵخۆشانە، بە تایبەتی بەهۆی ئەوەی شتێکی باشت کردووە یان شتێکی خراپ بەسەر کەسێک هاتووە"""),
                    SentencesRow(
                      englishText:
                          """He gleefully told me about all the different diseases that I could catch.""",
                      kurdishText:
                          """بەدڵخۆشییەوە پێی گوتم سەبارەت بەو هەموو نەخۆشییانەی کە دەکرێت تووشیان ببم.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/WtAoc3_1Ido?t=';
...
const String _videoIdtwo = 'https://youtu.be/ueUeMFbGq9o?t=';
const double _startSecondstwo = 0000000000000000000000000002029;
const String _videoIdthree = 'https://youtu.be/jPtI-PdG8iQ?t=';
const double _startSecondsthree = 000000000000000000000000000491;
const String _videoIdfour = 'https://youtu.be/jPtI-PdG8iQ?t=';
const double _startSecondsfour = 000000000000000000000000000491;
const String _videoIdfive = 'https://youtu.be/EwGCEQ-2P9Q?t=';
