...
class EnglishEntryexistence extends StatefulWidget {
  const EnglishEntryexistence({super.key});

  @override
  State<EnglishEntryexistence> createState() => _EnglishEntryexistenceState();
}

class _EnglishEntryexistenceState extends State<EnglishEntryexistence> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""existence""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """existence""",
                      // alsoEnglishWord: "also: existence",
                      britshText: """IpaUK: /ɪɡˈzɪstəns/""",
                      americanText: """IpaUS: /ɪɡˈzɪstəns/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "existence";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I was unaware of his existence until today.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The company has been in existence since 1924.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""This is the oldest Hebrew manuscript in existence.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They eke out a precarious existence.""");
  }
...
کوردی: بوون، بوونەوەری، هەبوون، ژیان، ژین، ژیوار، مان، هەیی، بوونەوەر، بوونایەتی، بوونێتی،	ڕوودانی ڕاستەقینە
"""),
          const DefinitionKurdish(
              text: """١. (ناو) ئەوەی کە شتێک بوونی هەبێت"""),
          SentencesRow(
            englishText: """I was unaware of his existence until today.""",
            kurdishText: """بێ ئاگا بووم لە بوونی تاوەکو ئەمڕۆ.""",
                ...
                children: [
                  SentencesRow(
                    englishText:
                        """The mere existence of these strange creatures fascinated him.""",
                    kurdishText:
                        """تەنها بوونی ئەم گیانلەبەرە نامۆیانە سەرنجی ڕادەکێشا.""",
                  ...
                  SentencesRow(
                    englishText:
                        """Some groups in the industry seek to deny the existence of a global warming problem.""",
                    kurdishText:
                        """هەندێک گرووپی پیشەسازی هەوڵ دەدەن نکۆڵی لە بوونی گەرمبوونی جیهانی بکەن.""",
                  ...
                  SentencesRow(
                    englishText:
                        """The school owed its existence to the generosity of one man.""",
                    kurdishText:
                        """قوتابخانەکە بۆ بوونی قەرزاری بەخشندەیی یەک کەس بوو.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """کۆمپانیاکە لە ساڵی ١٩٢٤ ـەوە بوونی هەبووە.""",
                  ...
                  SentencesRow(
                    ...
                    kurdishText:
                        """ئەمە کۆنترین بەڵگەنامەی عیبرییە بوونی هەبێت.""",
                  ...
                  SentencesRow(
                    englishText:
                        """Pakistan came into existence as an independent country in 1947.""",
                    kurdishText:
                        """پاکستان وەک وڵاتێکی سەربەخۆ درووست بوو لە ساڵی ١٩٤٧.""",
                  ...
                  SentencesRow(
                    englishText:
                        """The book acknowledges the existence of graffiti as an art form.""",
                    kurdishText:
                        """کتێبەکە دان بە بوونی گرافیتی وەک جۆرێک لە هونەر دەنێت.""",
          ...
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) شێوازێکی ژیان، بەتایبەتی کە ناخۆش یان سەختە"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """They eke out a precarious existence (= they have hardly enough money to live on).""",
            kurdishText: """ژیانێکی خراپ دەگوزەرێنن.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """وەک منداڵ ژیانێکی هەژارانە بەس بەپێی پێویست خۆش ژیاین.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: existence (Derived forms: existences)
1. The state or fact of being objectively real (= being, beingness, face of the earth)
"laws in existence for centuries";
 
2. Everything that exists anywhere (= universe, creation, world, cosmos, macrocosm)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/DwsZggwPRKc?t=';
const double _startSecondsend = 000000000000000000000000000000; // 109;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/SrDEtSlqJC4?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1172;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/Mx8JkGHaGUI?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1170;
const String _videoIdthree = 'VIDEOhttps://youtu.be/Fon7og7w4Yw?t=';
const double _startSecondsthree = 000000000000000000000000000; // 81;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/3C9wZf88y4Q?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 846;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/qg2nGY1aqlg?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1683;
