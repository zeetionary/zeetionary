                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "article"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɑːtɪkl/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrtɪkl/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '3xpZzOIDd9I';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 2729;
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = '_WGmcdPSSsg';
