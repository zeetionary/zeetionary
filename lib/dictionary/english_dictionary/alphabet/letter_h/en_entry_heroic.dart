...
class EnglishEntryheroic extends StatefulWidget {
  const EnglishEntryheroic({super.key});

  @override
  State<EnglishEntryheroic> createState() => _EnglishEntryheroicState();
}

class _EnglishEntryheroicState extends State<EnglishEntryheroic> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: heroic
1. Having or displaying qualities appropriate for heroes (- heroical)
"heroic explorers"; "the heroic attack on the beaches of Normandy";
 
2. Showing extreme courage; especially of actions courageously undertaken in desperation as a last resort (- desperate)
"they took heroic measures to save his life";
 
3. Very imposing or impressive; surpassing the ordinary (especially in size or scale) (- epic, larger-than-life)
"of heroic proportions"; "heroic sculpture";
 
4. Of behaviour that is impressive and ambitious in scale or scope (- expansive, grand)
"heroic undertakings";
 
5. Relating to or characteristic of heroes of antiquity
"heroic legends"; "the heroic age"

- Noun: heroic (Derived forms: heroics)
1. A verse form suited to the treatment of heroic or elevated themes; dactylic hexameter or iambic pentameter (- heroic verse, heroic meter)
""",
  );

  final String keyword = "heroic";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She is a heroic figure we can all look up to.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Rescuers made heroic efforts to save the crew.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak(
        """Every child in the village knew the heroic story of their ancestors.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This was foolishness on a heroic scale.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heroic""",
                      // alsoEnglishWord: "also: heroic",
                      britshText: """IpaUK: /həˈrəʊɪk/""",
                      americanText: """IpaUS: /həˈrəʊɪk/""",
...
کوردی: 	قارەمانانە، پاڵەوانانە، ئازایانە، کەڵانە، شێرانە، قارەمانی، پاڵەوانی
"""),
// With short examples define "heroic", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) پاڵەوانانە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: courageous"),
                    SentencesRow(
                      englishText:
                          """She is a heroic figure we can all look up to.""",
                      kurdishText:
                          """کەسێکی پاڵەوانە کە هەموان دەکرێت چاوی لێ بکەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕزگارکەران هەوڵی پاڵەوانانەیان دا بۆ ڕزگارکردنی تاقمەکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) پیشاندانی هەوڵی شێلگیرانە بۆ بەدەستهێنان یان سەرکەوتن لە شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """We watched our team's heroic struggle to win back the cup.""",
                      kurdishText:
                          """سەیری هەوڵدانی پاڵەوانانەی تیمەکەمانمان کرد بۆ بردنەوەی جامەکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵناو) کە پەیوەندی بە پاڵەوانێک هەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Every child in the village knew the heroic story of their ancestors.""",
                      kurdishText:
                          """هەموو منداڵێکی گوندە چیرۆکی پاڵەوانانەی باوانیان دەزانن.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (ھاوەڵناو) زۆر گەورە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """This was foolishness on a heroic scale.""",
                      kurdishText: """ئەمە گەمژەییەک بوو لە ئاستێکی گەورەدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/b1reY72ktEc?t=';
const double _startSecondsend = 000000000000000000000000000855;
const String _videoIdone = 'https://youtu.be/Xp4Y2nCNNS8?t=';
const double _startSecondsone = 000000000000000000000000000954;
const String _videoIdtwo = 'https://youtu.be/zhdBNVY55oM?t=';
const double _startSecondstwo = 000000000000000000000000000596;
const String _videoIdthree = 'https://youtu.be/LQpLMvC7Et0?t=';
const double _startSecondsthree = 000000000000000000000000000276;
const String _videoIdfour = 'https://youtu.be/-oHGafLPvEE?t=';
const double _startSecondsfour = 000000000000000000000000000617;
const String _videoIdfive = 'https://youtu.be/Zf1QQO1HgYs?t=';
