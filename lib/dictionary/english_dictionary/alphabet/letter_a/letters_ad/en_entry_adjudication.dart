...
class EnglishEntryadjudication extends StatefulWidget {
...
// 188888880002200
  ...
  final String keyword = "adjudication";
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'mSm7sRx-0hA';
    const double startSecondstwo = 308;
    const String videoIdthree = 'C5K8pM9WP9E';
    const double startSecondsthree = 639;
    const String videoIdfour = 'zsd3YH3vGS0';
    const double startSecondsfour = 625;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """adjudication""",
                      // alsoEnglishWord: "also: adjudication",
                      britshText: """IpaUK: /əˌdʒuːdɪˈkeɪʃn/""",
                      americanText: """IpaUS: /əˌdʒuːdɪˈkeɪʃn/""",
