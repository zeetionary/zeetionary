...
class EnglishEntryforecast extends StatefulWidget {
  const EnglishEntryforecast({super.key});

  @override
  State<EnglishEntryforecast> createState() => _EnglishEntryforecastState();
}

class _EnglishEntryforecastState extends State<EnglishEntryforecast> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: forecast (Derived forms: forecasts, forecasting, forecast, forecasted)
1. Predict in advance (= calculate)
 
1. Judge to be probable (= calculate, estimate, reckon, count on, figure)
 
2. Be a sign of something to come, esp. something important or bad (= bode, portend, auspicate, prognosticate, omen, presage, betoken [archaic], foreshadow, augur, foretell, prefigure, predict, foretoken)
"These signs forecast bad news";

- Noun: forecast (Derived forms: forecasts)
1. A prediction about how something (as the weather) will develop (= prognosis)
""",
  );

  final String keyword = "forecast";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forecast""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The sales forecasts are encouraging.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Forecasts about the economy are often misleading.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Snow is forecast for tomorrow.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Experts are forecasting a recovery in the economy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forecast""",
                      // alsoEnglishWord: "also: forecast",
                      britshText: """IpaUK: /ˈfɔːkɑːst/""",
                      americanText: """IpaUS: /ˈfɔːrkæst/""",
...
کوردی: 	پێش‌بینی، بەربووری، پێش‌زانی،	پێشبینی باری کەش‌وهەوا
"""),
// With short examples define "forecast", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پێشبینییەکانی فرۆشتن جێگای دڵخۆشین.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The forecast said there would be sunny intervals and showers.""",
                      kurdishText:
                          """پێشبینییەکە گوتی کە ماوەماوەی خۆرەتاو و بارانی بەخوڕ دەبێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پێشبینی ئابووری زۆرجار چەواشەکارن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شارەزایان پێشبینی باشبوونەوەی ئابووری دەکەن.""",
...
const double _startSecondsend = 000000000000000000000000000266;
const String _videoIdone = 'https://youtu.be/mncCR3wehF8?t=';
const double _startSecondsone = 000000000000000000000000000281;
const String _videoIdtwo = 'https://youtu.be/WfVF-Ec4naQ?t=';
const double _startSecondstwo = 000000000000000000000000000183;
const String _videoIdthree = 'https://youtu.be/eNChF-u-BQg?t=';
const double _startSecondsthree = 000000000000000000000000000226;
const String _videoIdfour = 'https://youtu.be/A0sM6xVAY-A?t=';
const double _startSecondsfour = 000000000000000000000000000417;
const String _videoIdfive = 'https://youtu.be/5d6SEQQbwtU?t=';
