...
// With short examples define "high street", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ژمارەیەک بانک لەسەر شەقامە سەرەکییەکەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """باشترین فرۆشگاکان لەسەر شەقامی سەرەکین.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ئەو فرۆشگا و بازرگانییانەی کە خزمەتی خەڵکی گشتی دەکەن"""),
                    SentencesRow(
                      englishText:
                          """Sales on the UK high street are in decline.""",
                      kurdishText:
                          """ڕێژەی فرۆشی فرۆشگا گشتییەکان لە کەمیدایە.""",
...
const String _videoIdend = 'lEgPVrSZa6w';
const double _startSecondsend = 268;
const String _videoIdone = 'bITz9yQPjy8';
const double _startSecondsone = 1025;
const String _videoIdtwo = 'HvWavE-yeGE';
const double _startSecondstwo = 501;
const String _videoIdthree = 'JcgGiHZoWBc';
const double _startSecondsthree = 121;
const String _videoIdfour = 'XxnLmD9y_uY';
const double _startSecondsfour = 168;
const String _videoIdfive = 'jKNKLBAcvLE';
const double _startSecondsfive = 400;
