...
class EnglishEntryamenity extends StatelessWidget {
  ...
  Future<void> speakAmenity4777(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Many of the houses lacked even basic amenities."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAmenity7622(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The hotel has excellent amenities."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "amenity", // DOPSUM: CHANGE WORD ENTRY - Find /əˈmiːnəti/
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAmenity(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () =>
                                    speakAmenity4777(// REPLACE: amenity /əˈmenəti/,  /əˈmiːnəti/
                                        "en-US"),
                              ),
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () =>
                                    speakAmenity7622(// REPLACE: amenity /əˈmenəti/,  /əˈmiːnəti/
                                        "en-US"),
                              ),
                            ],
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '6-6U6V3yQWk';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'Zhr7nDNieqw';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'oluwqXzePv8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'YytF2v7Vvw0';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'OU-DF-JcXkw';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = '23ErB0axFgw';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'pxoWZiK_Deo';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'l0Lux9vW8ZM';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = 'np1if0hc_30';
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = 'CHrhZvT6kJk';
