...
// """),
          ...
          SentencesRow(
            englishText:
                """The election victory is a clear endorsement of their policies.""",
            kurdishText:
                """سەرکەوتنەکەی ھەڵبژاردن پشتگیری ڕوونی سیاسەتەکانیانە.""",
          ...
          SentencesRow(
            englishText:
                """These measures have the strong endorsement of the Labour party.""",
            kurdishText:
                """ئەم ڕێکارانە پشتگیری بەھێزی پارتی کرێکارانیان ھەیە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """دڵخۆشین کە پشتگیری تەواومان بدەین بە بەرھەمەکە.""",
