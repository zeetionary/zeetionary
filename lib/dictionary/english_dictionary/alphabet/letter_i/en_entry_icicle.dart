...
class EnglishEntryicicle extends StatefulWidget {
  const EnglishEntryicicle({super.key});

  @override
  State<EnglishEntryicicle> createState() => _EnglishEntryicicleState();
}

class _EnglishEntryicicleState extends State<EnglishEntryicicle> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Icicles hung from the roof.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/1Gxrwh4zGPg?t=';
    const double startSecondsend = 000000000000000000000000000518;
    const String videoIdone = 'https://youtu.be/BpyicVVx4QE?t=';
    const double startSecondsone = 000000000000000000000000000673;
    const String videoIdtwo = 'https://youtu.be/BLK6dV76XTQ?t=';
    const double startSecondstwo = 00000000000000000000000000022;
    const String videoIdthree = 'https://youtu.be/Cdx7a7Rn-wY?t=';
    const double startSecondsthree = 000000000000000000000000000231;
    const String videoIdfour = 'https://youtu.be/vo1BzyBwZ1E?t=';
    const double startSecondsfour = 000000000000000000000000000166;
    const String videoIdfive = 'https://youtu.be/EQcz6WVozKI?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """icicle""",
                      // alsoEnglishWord: "also: icicle",
                      britshText: """IpaUK: /ˈaɪsɪkl/""",
                      americanText: """IpaUS: /ˈaɪsɪkl/""",
...
کوردی: چلوورە، کیرەکەڵە، شووشەسۆڵ، ئاوبەست، کلوو، قەندیل، سەهۆڵەشۆڕ، شۆڕەسەهۆڵ، شووشەسەهۆڵ، چێوەزمە
"""),
// With short examples define "icicle", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پارچە سەهۆڵێکی تیژ کە بەستوویەتی لە کاتێکدا ئاو لە شوێنێکەوە دەکەوێتە خوارەوە، بۆ نموونە لە بنبانێکەوە"""),
                    SentencesRow(
                      englishText: """Icicles hung from the roof.""",
                      kurdishText: """چلوورە بە بنبانەکە شۆڕبووبوونەوە.""",
