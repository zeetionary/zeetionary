...
class EnglishEntryexemplify extends StatefulWidget {
  const EnglishEntryexemplify({super.key});

  @override
  State<EnglishEntryexemplify> createState() => _EnglishEntryexemplifyState();
}

class _EnglishEntryexemplifyState extends State<EnglishEntryexemplify> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exemplify""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exemplify""",
                      // alsoEnglishWord: "also: exemplify",
                      britshText: """IpaUK: /ɪɡˈzemplɪfaɪ/""",
                      americanText: """IpaUS: /ɪɡˈzemplɪfaɪ/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exemplify";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His food exemplifies Italian cooking at its best.""");
  }
...
کوردی: بە وێنە حاڵی کردن، نموونە نیشاندان
"""),
          ...
          SentencesRow(
            ...
            kurdishText: """خواردنەکەی نموونەی باشترینی چێشتلێنانی ئیتالییە.""",
          ...
          SentencesRow(
            englishText:
                """She exemplified each of the points she was making with an amusing anecdote.""",
            kurdishText:
                """بە بەسەرهاتێک هەر یەک لەو خاڵانەی ڕووندەکردەوە کە باسی دەکردن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: exemplify (Derived forms: exemplified, exemplifies, exemplifying)
1. Be typical of (= represent)
"This compositional style is exemplified by this fugue";
 
2. Clarify by giving an example of (= illustrate, instance, example [rare])
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/qQ01eLt_bxo?t=';
const double _startSecondsend = 000000000000000000000000000000; // 864;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/l6PlMpncVuc?t=';
const double _startSecondsone = 00000000000000000000000000000; // 296;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/8tT3FhOA4-g?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 882;
const String _videoIdthree = 'VIDEOhttps://youtu.be/TByLlkbUa8A?t=';
const double _startSecondsthree = 000000000000000000000000000; // 670;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/_wIOqHSsV9c?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 74;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/sig8X_kojco?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1839;
