...
class EnglishEntryillegality extends StatefulWidget {
  const EnglishEntryillegality({super.key});

  @override
  State<EnglishEntryillegality> createState() => _EnglishEntryillegalityState();
}

class _EnglishEntryillegalityState extends State<EnglishEntryillegality> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: illegality (Derived forms: illegalities)
1. Unlawfulness by virtue of violating some legal statute
""",
  );

  final String keyword = "illegality";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""illegality""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""No illegality is suspected.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/FUrrk4QSnXM?t=';
    const double startSecondsone = 000000000000000000000000000212;
    const String videoIdtwo = 'https://youtu.be/ZCxgLCDdStA?t=';
    const double startSecondstwo = 0000000000000000000000000001124;
    const String videoIdthree = 'https://youtu.be/f66GfsKPTUg?t=';
    const double startSecondsthree = 000000000000000000000000000948;
    const String videoIdfour = 'https://youtu.be/gXvuJu1kt48?t=';
    const double startSecondsfour = 0000000000000000000000000008383;
    const String videoIdfive = 'https://youtu.be/8wziYxLBkUo?t=';
    const double startSecondsfive = 000000000000000000000000000335;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """illegality""",
                      // alsoEnglishWord: "also: illegality",
                      britshText: """IpaUK: /ˌɪliˈɡæləti/""",
                      americanText: """IpaUS: /ˌɪliˈɡæləti/""",
...
کوردی: ناڕەوایی، ناقانوونێتی، قەدەخەبوون، کردەوەی ناقانوونی، کرداری نایاسایی
"""),
// With short examples define "illegality", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) ئەوەی شتێک نایاسایی بێت"""),
                    SentencesRow(
                      englishText: """No illegality is suspected.""",
                      kurdishText: """گومان بۆ هیچ نایاساییەتییەک ناچێت.""",
