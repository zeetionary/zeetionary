...
class EnglishEntryinstructor extends StatefulWidget {
  const EnglishEntryinstructor({super.key});

  @override
  State<EnglishEntryinstructor> createState() => _EnglishEntryinstructorState();
}

class _EnglishEntryinstructorState extends State<EnglishEntryinstructor> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""instructor""");
  }
