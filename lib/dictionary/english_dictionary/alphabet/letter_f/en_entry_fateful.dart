...
class EnglishEntryfateful extends StatefulWidget {
  const EnglishEntryfateful({super.key});

  @override
  State<EnglishEntryfateful> createState() => _EnglishEntryfatefulState();
}

class _EnglishEntryfatefulState extends State<EnglishEntryfateful> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fateful""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fateful""",
                      // alsoEnglishWord: "also: fateful",
                      britshText: """IpaUK: /ˈfeɪtfl/""",
                      americanText: """IpaUS: /ˈfeɪtfl/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He made the fateful decision to send in the troops.""");
  }
...
// With short examples define "fateful", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: دیاری‌کەر، بڕیاردەر، یەکسەرەکەرەوە، بڕێنەرەوە، یەکلایی‌کەرەوە، گرنگ، چارەنووس‌ساز،	بەدفەڕ، نگریس، نەگریس، بەدشووم، بێ‌ودم
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە کاریگەرییەکی گرنگ، زۆرجار بە خراپی، هەیە لەسەر ڕووداوەکانی داهاتوو"""),
          SentencesRow(
            englishText:
                """He made the fateful decision to send in the troops.""",
            kurdishText: """ئەو بڕیارە یەکلایی‌کەرەوەی دا کە هێزەکان بنێرێت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fateful
1. Having momentous consequences; of decisive importance (= fatal)
"that fateful meeting of the U.N. when...it declared war on North Korea";
 
2. Ominously prophetic (= foreboding, portentous)
 
3. (of events) having extremely unfortunate or dire consequences; bringing ruin (= black, calamitous, disastrous, fatal)
"a fateful error";
 
4. Controlled or decreed by fate; predetermined (= fatal)
"a fateful series of events";
""",
  );
...
const double _startSecondsend = 000000000000000000000000000351;
const String _videoIdone = 'https://youtu.be/QLq6GEiHqR8?t=';
const double _startSecondsone = 0000000000000000000000000001830;
const String _videoIdtwo = 'https://youtu.be/Cln0J87vulU?t=';
const double _startSecondstwo = 000000000000000000000000000784;
const String _videoIdthree = 'https://youtu.be/lsbcN9-jU1Y?t=';
const double _startSecondsthree = 000000000000000000000000000856;
const String _videoIdfour = 'https://youtu.be/vIz9lgLjZtY?t=';
const double _startSecondsfour = 000000000000000000000000000313;
const String _videoIdfive = 'https://youtu.be/62EGPCEmeh4?t=';
const double _startSecondsfive = 000000000000000000000000000914;
