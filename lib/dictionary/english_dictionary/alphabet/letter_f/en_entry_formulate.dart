...
class EnglishEntryformulate extends StatefulWidget {
  const EnglishEntryformulate({super.key});

  @override
  State<EnglishEntryformulate> createState() => _EnglishEntryformulateState();
}

class _EnglishEntryformulateState extends State<EnglishEntryformulate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: formulate (Derived forms: formulating, formulates, formulated)
1. Elaborate, as of theories and hypotheses (= explicate, develop)
"Could you formulate the ideas in your thesis";
 
2. Come up with (an idea, plan, explanation, theory, or principle) after a mental effort (= invent, contrive, devise, excogitate, forge)
"formulate a way to measure the speed of light";
 
3. Put into words or an expression (= give voice, word, phrase, articulate)
...
""",
  ...
  final String keyword = "formulate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""formulate""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The compost is specially formulated for pot plants.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His ideas are always very carefully formulated.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He struggled to formulate an answer.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """formulate""",
                      // alsoEnglishWord: "also: formulate",
                      britshText: """IpaUK: /ˈfɔːmjuleɪt/""",
                      americanText: """IpaUS: /ˈfɔːrmjuleɪt/""",
...
// With short examples define "formulate", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پەیینەکە بە تایبەتی ئامادە کراوە بۆ ڕووکی ناو گوڵدان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بیرۆکەکانی هەمیشە بە وریایی ئامادە کراوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) دەربڕینی بیرۆکەکانت بە وشەی هەڵبژێردراو بە وریایی"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    SentencesRow(
                      englishText:
                          """She has lots of good ideas, but she has difficulty formulating them.""",
                      kurdishText:
                          """بیرۆکەی باشی زۆری هەیە بەڵام کێشەی هەیە لە دەربڕینیان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/SUc87t6yIF8?t=';
const double _startSecondsend = 0000000000000000000000000001401;
const String _videoIdone = 'https://youtu.be/ri2Aj44PA8E?t=';
const double _startSecondsone = 0000000000000000000000000001602;
const String _videoIdtwo = 'https://youtu.be/8X1xYpPmKvA?t=';
const double _startSecondstwo = 0000000000000000000000000006467;
const String _videoIdthree = 'https://youtu.be/_mqP7kd1H_Y?t=';
const double _startSecondsthree = 000000000000000000000000000867;
const String _videoIdfour = 'https://youtu.be/9mgwZASlFvw?t=';
const double _startSecondsfour = 000000000000000000000000000549;
const String _videoIdfive = 'https://youtu.be/s4qz7PwbuhQ?t=';
const double _startSecondsfive = 000000000000000000000000000549;
