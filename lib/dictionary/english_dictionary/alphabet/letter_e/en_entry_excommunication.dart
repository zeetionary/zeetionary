...
class EnglishEntryexcommunication extends StatefulWidget {
  const EnglishEntryexcommunication({super.key});

  @override
  State<EnglishEntryexcommunication> createState() =>
      _EnglishEntryexcommunicationState();
}

class _EnglishEntryexcommunicationState
    extends State<EnglishEntryexcommunication> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""excommunication""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: excommunication",
                      britshText: """IpaUK: /ˌekskəˌmjuːnɪˈkeɪʃn/""",
                      americanText: """IpaUS: /ˌekskəˌmjuːnɪˈkeɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "excommunication";
...
کوردی: بێ‌بەری‌کردن، بێ‌بەش‌کردن، تەکفیر
"""),
          const DefinitionKurdish(
              text: """١. (ناو) سزادانی کەسێک بە دەرکردنی لە کڵێسای کاسۆلیک"""),
          SentencesRow(
            englishText: """They were threatened with excommunication.""",
            kurdishText: """بە تەکفیرکردن هەڕەشەیان لێکرا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: excommunication (Derived forms: excommunications)
1. The act of banishing a member of a church from the communion of believers and the privileges of the church; cutting a person off from a religious society (= excision)
 
2. The state of being excommunicated (= exclusion, censure)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/0Lu4Uvc5EhA?t=';
const double _startSecondsend = 000000000000000000000000000000; // 142;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/EGYVTNH1GXo?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1233;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/lUa700Vc-o8?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 301;
const String _videoIdthree = 'VIDEOhttps://youtu.be/kC0antZogec?t=';
const double _startSecondsthree = 000000000000000000000000000; // 2234;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/6NB91zHe7UU?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 824;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/1yZFkI292CA?t=';
