...
class EnglishEntrylad extends StatefulWidget {
  const EnglishEntrylad({super.key});

  @override
  State<EnglishEntrylad> createState() => _EnglishEntryladState();
}

class _EnglishEntryladState extends State<EnglishEntrylad> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lad (Derived forms: lads)
Usage: informal
1. A boy or man (- chap [Brit, informal], fellow, feller [non-standard], fella [informal], gent [informal], blighter [Brit, informal], cuss [informal], bloke [Brit, informal], boyo [UK, Ireland], bucko [informal], dog [informal])
"you lucky lad";
 
2. A male child (a familiar term of address to a boy) (- cub, laddie [UK, informal], sonny, sonny boy, boyo [UK, Ireland], son [informal])
""",
  );

  final String keyword = "lad";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He's a nice lad.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Things have changed since I was a lad.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Hurry up, lad.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They're a nice bunch of lads.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I tried to fit in and be one of the lads.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/b5fNif_WGdc?t=876';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/pz52gPH3ou4?t=32';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/QWz07MktCKg?t=108';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/yRmOWcWdQAo?t=389';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/qNDnYLYXprA?t=125';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/4J0xFUyz1nw?t=831';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lad""",
                      // alsoEnglishWord: "also: lad",
                      britshText: """IpaUK: /læd/""",
                      americanText: """IpaUS: /læd/""",
...
کوردی: کوڕ، پس،	پیاو،	جەحێڵ، لاو، گەنج،	تازەلاو، مناڵکار، یاران، دۆستان، کوڕەکان، برادەران
"""),
// With short examples define "lad", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) کوڕ یان پیاوێکی گەنج"""),
                    SentencesRow(
                      englishText: """He's a nice lad.""",
                      kurdishText: """کوڕێکی باشە.""",
                    ...
                    SentencesRow(
                      englishText: """Things have changed since I was a lad.""",
                      kurdishText: """شتەکان گۆڕاون لەوکاتەی کە کوڕێک بووم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Hurry up, lad.""",
                      kurdishText: """زووکە کوڕە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They're a nice bunch of lads.""",
                      kurdishText: """ژمارەیەک کوڕی باشن.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ژمارەیەک هاوڕێ کە پیاوێک کاریان لەگەڵ دەکات یان کاتی بەتاڵیان لەگەڵ بەسەر دەبات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I tried to fit in and be one of the lads.""",
                      kurdishText: """دەمویست خۆم بگونجێنم و یەکێک لە گرووپەکە بم.""",
