...
class EnglishEntryexcusable extends StatefulWidget {
  const EnglishEntryexcusable({super.key});

  @override
  State<EnglishEntryexcusable> createState() => _EnglishEntryexcusableState();
}

class _EnglishEntryexcusableState extends State<EnglishEntryexcusable> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""excusable""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """excusable""",
                      // alsoEnglishWord: "also: excusable",
                      britshText: """IpaUK: /ɪkˈskjuːzəbl/""",
                      americanText: """IpaUS: /ɪkˈskjuːzəbl/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "excusable";
...
کوردی: شیاوی لێ‌خوش‌بوون، جەبە دەکرێ، بەخشین‌هەڵگر، دەبەخشرێ، لەبەخشین‌هاتوو
"""),
          ...
          SentencesRow(
            englishText:
                """Doing it once was just about excusable—doing it twice was certainly not.""",
            kurdishText:
                """کردنی بۆ یەکجار شیاوی لێ‌خوش‌بوون بوو، کردنی بۆ دووەم جار بەدڵنیاییەوە وانەبوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: excusable
1. Easily excused or forgiven (= forgivable, venial)
 
2. Capable of being overlooked
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/YJQSuUZdcV4?t=';
const double _startSecondsend = 000000000000000000000000000000; // 471;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/Xngfshnwm9s?t=';
const double _startSecondsone = 00000000000000000000000000000; // 652;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/ZT6dde0Tz2c?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 207;
const String _videoIdthree = 'VIDEOhttps://youtu.be/3h9bTxnKAg0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 399;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/Pc2vbyZGJlE?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 557;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/ZV7zymlZRPg?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1305;
