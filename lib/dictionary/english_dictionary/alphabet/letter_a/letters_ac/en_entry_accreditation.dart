...
class EnglishEntryaccreditation extends StatefulWidget {
  const EnglishEntryaccreditation({super.key});

  @override
  State<EnglishEntryaccreditation> createState() =>
      _EnglishEntryaccreditationState();
}

class _EnglishEntryaccreditationState extends State<EnglishEntryaccreditation> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "accreditation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""accreditation""");
  }
  ...
  Future<void> speaka24894(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("The college was given full accreditation in 1965.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accreditation""",
                      // alsoEnglishWord: "also: accreditation",
                      britshText: """IpaUK: /əˌkredɪˈteɪʃn/""",
                      americanText: """IpaUS: /əˌkredɪˈteɪʃn/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '3u2FauOIPh8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'YSFCN5I0NLc';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'AOzXPSv-PjU';
