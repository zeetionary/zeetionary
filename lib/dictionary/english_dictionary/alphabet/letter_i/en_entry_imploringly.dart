...
class EnglishEntryimploringly extends StatefulWidget {
  const EnglishEntryimploringly({super.key});

  @override
  State<EnglishEntryimploringly> createState() =>
      _EnglishEntryimploringlyState();
}

class _EnglishEntryimploringlyState extends State<EnglishEntryimploringly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: imploringly
1. In a beseeching manner (- beseechingly, importunately, pleadingly, entreatingly)
"'You must help me,' she said imploringly";
""",
  );

  final String keyword = "imploringly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""imploringly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She called out to me imploringly.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Uc8VE1KS9GI?t=';
    const double startSecondsend = 000000000000000000000000000370;
    const String videoIdone = 'https://youtu.be/pSZ7LYlv3Vc?t=';
    const double startSecondsone = 000000000000000000000000000674;
    const String videoIdtwo = 'https://youtu.be/dsxwAEjEfFw?t=';
    const double startSecondstwo = 000000000000000000000000000754;
    const String videoIdthree = 'https://youtu.be/t-wD0fVXI7k?t=';
    const double startSecondsthree = 00000000000000000000000000025877;
    const String videoIdfour = 'https://youtu.be/nHC-3ayq2tY?t=';
    const double startSecondsfour = 0000000000000000000000000001814;
    const String videoIdfive = 'https://youtu.be/Q1NJbEBUhp4?t=';
    const double startSecondsfive = 0000000000000000000000000004322;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """imploringly""",
                      // alsoEnglishWord: "also: imploringly",
                      britshText: """IpaUK: /ɪmˈplɔːrɪŋli/""",
                      americanText: """IpaUS: /ɪmˈplɔːrɪŋli/""",
...
کوردی: داوێن‌گرانە، داوێن‌گیرانە، بە پاڕانەوە
"""),
// With short examples define "imploringly", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە داوا لە کەسێک بکەیت بە شێوەیەکی شڵەژاوانە کە شتێک بکات بەهۆی ئەوەی زۆر دەتەوێت"""),
                    SentencesRow(
                      englishText: """She called out to me imploringly.""",
                      kurdishText: """بە پاڕانەوەوە بانگی کردم.""",
