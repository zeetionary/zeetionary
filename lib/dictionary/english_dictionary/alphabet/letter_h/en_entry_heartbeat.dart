...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She was suddenly aware of her racing heartbeat.""");
  }
...
// With short examples define "heartbeat", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) جووڵە یان دەنگی دڵ کە لێدەدات بۆ ناردنی خوێن"""),
                    SentencesRow(
                      englishText:
                          """She was suddenly aware of her racing heartbeat.""",
                      kurdishText:
                          """لەناکاو بەئاگا بوو لە لێدانی خێرای دڵی.""",
                    ...
                    const DefinitionKurdish(
                        text: """٢. (ناو) تایبەتمەندییەکی گرنگی شتێک"""),
                    SentencesRow(
                      englishText:
                          """The candidate said that he understood the heartbeat of the Hispanic community in California.""",
                      kurdishText:
                          """بەربژێرەکە گوتی کە تێدەگات لە گرنگی کۆمەڵگەی ئیسپانی لە کالیفۆرنیا.""",
