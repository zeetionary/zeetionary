...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'KDthN45L57Q';
    const double startSecondsend = 621;
    const String videoIdone = 'FSHITL5oedk';
    const double startSecondsone = 711;
    const String videoIdtwo = 'nQ4R94HF3GA';
    const double startSecondstwo = 739;
    const String videoIdthree = 'ODjhSF53LiI';
    const double startSecondsthree = 753;
    const String videoIdfour = 'aBppb2quqkE';
    const double startSecondsfour = 366;
    const String videoIdfive = 'hmNw_zZ4BZY';
    const double startSecondsfive = 269;
