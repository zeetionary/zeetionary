...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 129;
    const String videoIdone = 'QMlI778Jhsg';
    const double startSecondsone = 642;
    const String videoIdtwo = '2MZZrDA-I4M';
    const double startSecondstwo = 224;
    const String videoIdthree = 'LUhbZdvtzcw';
    const double startSecondsthree = 117;
    const String videoIdfour = '1C3iFrC-dRw';
    const double startSecondsfour = 803;
    const String videoIdfive = '2J1i8Qi5e6I';
