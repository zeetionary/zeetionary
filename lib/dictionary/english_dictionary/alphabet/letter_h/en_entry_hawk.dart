...
""",
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The senator is known as a hawk in foreign policy.""");
  }
...
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) باڵندەیەکی ڕاوکەری بەهێز و خێرا"""),
                    SentencesRow(
                      englishText:
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) کەسێک، بە تایبەتی سیاسەتمەدارێک، کە لەگەڵ شەڕ دایە بۆ چارەسەری کێشە"""),
                    SentencesRow(
                      englishText:
                          """The senator is known as a hawk in foreign policy.""",
                      kurdishText:
                          """سیناتۆرەکە لە سیاسەتی دەرەوەدا بە شەڕخواز ناسراوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) هەوڵدان بۆ فرۆشتنی شت بەوەی لە شوێنێک بۆ شوێنێکی دیکە بچیت بۆ ئەوەی خەڵکی لێت بکڕێت"""),
                    SentencesRow(
                      englishText:
                          """He made a living hawking cleaning products from door to door.""",
                      kurdishText:
                          """بژێوی پەیدا دەکرد بەوەی دەرگا بە دەرگا دەچوو بۆ فرۆشتنی بەرهەمی پاککەرەوە.""",
