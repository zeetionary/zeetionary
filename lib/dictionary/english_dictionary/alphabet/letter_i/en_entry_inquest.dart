...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'zwZY-PknSQw';
    const double startSecondsone = 1057;
    const String videoIdtwo = 'OnjI-FBdRTQ';
    const double startSecondstwo = 18422;
    const String videoIdthree = 'O-cKvhA9ZJ4';
    const double startSecondsthree = 1140;
    const String videoIdfour = 'NUxxB6Yvm4E';
    const double startSecondsfour = 332;
    const String videoIdfive = 'bH1xAbhlJSo';
