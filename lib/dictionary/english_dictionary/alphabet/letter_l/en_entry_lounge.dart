...
class EnglishEntrylounge extends StatefulWidget {
  const EnglishEntrylounge({super.key});

  @override
  State<EnglishEntrylounge> createState() => _EnglishEntryloungeState();
}

class _EnglishEntryloungeState extends State<EnglishEntrylounge> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylounge lounge
WORD_WEB lounge lounge lounge
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lounge";
...
کوردی: 
"""),
// With short examples define "lounge", please follow LX instructions
