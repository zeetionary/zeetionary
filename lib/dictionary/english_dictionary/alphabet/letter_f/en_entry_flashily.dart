...
class EnglishEntryflashily extends StatefulWidget {
  const EnglishEntryflashily({super.key});

  @override
  State<EnglishEntryflashily> createState() => _EnglishEntryflashilyState();
}

class _EnglishEntryflashilyState extends State<EnglishEntryflashily> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: flashily
1. In a meretricious manner (= meretriciously)
 
2. In a fancy colourful manner (= flamboyantly, showily)
""",
  );

  final String keyword = "flashily";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flashily""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The apartment is located in a flashily modernized old building.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flashily""",
                      // alsoEnglishWord: "also: flashily",
                      britshText: """IpaUK: /ˈflæʃɪli/""",
                      americanText: """IpaUS: /ˈflæʃɪli/""",
...
// With short examples define "flashily", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵکار) بەشێوەیەک کە سەرنج ڕادەکێشێت بە لەبەرکردنی جلی گران‌بەها یان بەوەی کە درەوشاوەیە، گران‌بەهایە، گەورەیە، هتد"""),
                    SentencesRow(
                      englishText:
                          """The apartment is located in a flashily modernized old building.""",
                      kurdishText: """باڵەخانەکە کەوتووەتە بینایەکی کۆنی جوان نۆژەنکراوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/OrOZRVxyR3I?t=';
const double _startSecondsend = 0000000000000000000000000001920;
const String _videoIdone = 'https://youtu.be/HofndKVwWwM?t=';
const double _startSecondsone = 000000000000000000000000000414;
const String _videoIdtwo = 'https://youtu.be/7V9xm5KWtkI?t=';
const double _startSecondstwo = 0000000000000000000000000004048;
const String _videoIdthree = 'https://youtu.be/fOhzzfVgodY?t=';
const double _startSecondsthree = 000000000000000000000000000380;
const String _videoIdfour = 'https://youtu.be/7Y59KkgOB5g?t=';
const double _startSecondsfour = 00000000000000000000000000027;
const String _videoIdfive = 'https://youtu.be/Nm955hJNbiw?t=';
const double _startSecondsfive = 000000000000000000000000000381;
