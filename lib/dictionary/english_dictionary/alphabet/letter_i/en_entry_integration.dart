...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/_0RTH57v66I?t=';
    const double startSecondsend = 000000000000000000000000000582;
    const String videoIdone = 'https://youtu.be/Bg_tJvCA8zw?t=';
    const double startSecondsone = 000000000000000000000000000383;
    const String videoIdtwo = 'https://youtu.be/LJNtfyq3TDE?t=';
    const double startSecondstwo = 000000000000000000000000000864;
    const String videoIdthree = 'https://youtu.be/wVyu7NB7W6Y?t=';
    const double startSecondsthree = 0000000000000000000000000001591;
    const String videoIdfour = 'https://youtu.be/rr2XfL_df3o?t=';
    const double startSecondsfour = 000000000000000000000000000860;
    const String videoIdfive = 'https://youtu.be/BlU49dJhfcw?t=';
    const double startSecondsfive = 000000000000000000000000000422;
