...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001341;
    const String videoIdone = 'https://youtu.be/SrDEtSlqJC4?t=';
    const double startSecondsone = 0000000000000000000000000001458;
    ...
    const String videoIdfour = 'https://youtu.be/Pon4Zux5MaQ?t=';
    const double startSecondsfour = 000000000000000000000000000673;
    const String videoIdfive = 'https://youtu.be/Am1lDj2mUVY?t=';
    const double startSecondsfive = 000000000000000000000000000883;
