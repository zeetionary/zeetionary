...
class EnglishEntryinlet extends StatefulWidget {
  const EnglishEntryinlet({super.key});

  @override
  State<EnglishEntryinlet> createState() => _EnglishEntryinletState();
}

class _EnglishEntryinletState extends State<EnglishEntryinlet> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'Fr-qagv7ig0';
    const double startSecondsend = 1046;
    const String videoIdone = '_rBO8neWw04';
    const double startSecondsone = 544;
    const String videoIdtwo = 'Ek1buV2HA68';
    const double startSecondstwo = 238;
    const String videoIdthree = 'D-L4NMHpBWs';
    const double startSecondsthree = 183;
    const String videoIdfour = 'mjeltClqfF0';
    const double startSecondsfour = 481;
    const String videoIdfive = 'M3whX_peJiY';
