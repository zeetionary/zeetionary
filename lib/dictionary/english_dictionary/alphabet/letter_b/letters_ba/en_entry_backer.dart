...
class EnglishEntrybacker extends StatelessWidget {
  ...
  Future<void> speakb3s1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("The project receives its money from European backers.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "backer"),
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈbækə(r)/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈbækər/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'yYnXBRo9TVA';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'VocK9wSP5q8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'OiLmSszm2qA';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'jO3F9kMGVAo';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'cAAJUHwh9F4';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'l-nwYlrROl8';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'lsn-V-CBEgU';
  final double _startSeconds = 94;
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = '53rtu1wmoAc';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'yplI48hSt2E';
