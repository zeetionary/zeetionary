...
class EnglishEntryfauxpas extends StatefulWidget {
  const EnglishEntryfauxpas({super.key});

  @override
  State<EnglishEntryfauxpas> createState() => _EnglishEntryfauxpasState();
}

class _EnglishEntryfauxpasState extends State<EnglishEntryfauxpas> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""faux pas""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """faux pas""",
                      // alsoEnglishWord: "also: faux pas",
                      britshText: """IpaUK: /ˌfəʊ ˈpɑː/""",
                      americanText: """IpaUS: /ˌfəʊ ˈpɑː/""",
...
کوردی: لێ‌هەڵ‌قڵیشان، لێ‌داقڵیشان، کردەوە یان وتەی نابەجێ، قسە لە دەم دەرپەڕین
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) شتێک کە وا لە کەسێک دەکات شەرمەزار بێت بەهۆی ئەوەی درووست نییە"""),
          SentencesRow(
            englishText:
                """I committed a faux pas that my friends have never let me forget.""",
            kurdishText:
                """کارێکی نابەجێم کرد کە هاوڕێکانم هەرگیز ناهێڵن بیرم بچێتەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: faux pas (Derived forms: faux pas)
1. A socially awkward or tactless act (= gaffe, solecism, slip, gaucherie)
""",
  );
...
const String _videoIdend = 'https://youtu.be/wtXjHtnglxU?t=';
const double _startSecondsend = 0000000000000000000000000006;
const String _videoIdone = 'https://youtu.be/RwTvjfma_Sg?t=';
const double _startSecondsone = 000000000000000000000000000596;
const String _videoIdtwo = 'https://youtu.be/gghRXOXY820?t=';
const double _startSecondstwo = 000000000000000000000000000302;
const String _videoIdthree = 'https://youtu.be/fKGoVefhtMQ?t=';
const double _startSecondsthree = 00000000000000000000000000094;
const String _videoIdfour = 'https://youtu.be/0sCBFxf8WDw?t=';
const double _startSecondsfour = 000000000000000000000000000149;
const String _videoIdfive = 'https://youtu.be/tcqiJAqjoxE?t=';
const double _startSecondsfive = 0000000000000000000000000005332;
