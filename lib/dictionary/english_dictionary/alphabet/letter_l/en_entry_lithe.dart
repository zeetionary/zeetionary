...
class EnglishEntrylithe extends StatefulWidget {
  const EnglishEntrylithe({super.key});

  @override
  State<EnglishEntrylithe> createState() => _EnglishEntrylitheState();
}

class _EnglishEntrylitheState extends State<EnglishEntrylithe> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: lithe (Derived forms: lithest, lither)
1. Gracefully thin and bending and moving with ease (- lissome, lissom, lithesome, supple, sinuous)
"Her hands are white and long and lithe";
""",
  );

  final String keyword = "lithe";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He had the lithe, athletic body of a ballet dancer.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/ELBAwXxusZk?t=157';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/ipeoe_6J2ys?t=29';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/4utNXOfQ4cM?t=350';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/Uly8iW-oowE?t=3923';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/Seu7V91vxAo?t=395';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/C7IvcKhZvD8?t=398';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lithe""",
                      // alsoEnglishWord: "also: lithe",
                      britshText: """IpaUK: /laɪð/""",
                      americanText: """IpaUS: /laɪð/""",
...
کوردی: نەرم، شلک، لەش‌نەرم، بە لەشێکی نەرمەوە
"""),
// With short examples define "lithe", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) کە بە ئاسانی دەجووڵێتەوە یان دەچەمێتەوە"""),
                    SentencesRow(
                      englishText: """He had the lithe, athletic body of a ballet dancer.""",
                      kurdishText: """جەستەی نەرمی وەرزشکارانەی سەماکارێکی بالێی هەبوو.""",
