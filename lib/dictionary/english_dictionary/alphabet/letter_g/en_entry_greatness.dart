...
class EnglishEntrygreatness extends StatefulWidget {
  const EnglishEntrygreatness({super.key});

  @override
  State<EnglishEntrygreatness> createState() => _EnglishEntrygreatnessState();
}

class _EnglishEntrygreatnessState extends State<EnglishEntrygreatness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: greatness
1. The property possessed by something or someone of outstanding importance or eminence (- illustriousness)
 
2. Unusual largeness in size, extent or number (- enormousness, grandness, immenseness, immensity, sizeableness, vastness, wideness, hugeness, vastitude)
""",
  );

  final String keyword = "greatness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""greatness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He was made into a symbol of national greatness.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The novel's greatness lies in its simplicity.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """greatness""",
                      // alsoEnglishWord: "also: greatness",
                      britshText: """IpaUK: /ˈɡreɪtnəs/""",
                      americanText: """IpaUS: /ˈɡreɪtnəs/""",
...
// With short examples define "greatness", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە پێگە و کاریگەریی زۆرت هەبێت"""),
                    SentencesRow(
                      englishText:
                          """He was made into a symbol of national greatness.""",
                      kurdishText: """کرا بە سمبوولی مەزنی نیشتیمانی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Napoleon promised to restore France to its former greatness.""",
                      kurdishText:
                          """ناپلیۆن بەڵێنی دا فەرەنسا بگەڕێنێتەوە بۆ شكۆمەندیی پێشووتری.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ئەوەی شتێک کوالێتی یان توانای باش و بەرزی هەبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The novel's greatness lies in its simplicity.""",
                      kurdishText: """مەزنی ڕۆمانەکە لە سادەییەتی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/WYW1g6u9M5I?t=';
const double _startSecondsend = 000000000000000000000000000152;
const String _videoIdone = 'https://youtu.be/mY3SEMTROas?t=';
const double _startSecondsone = 0000000000000000000000000001703;
const String _videoIdtwo = 'https://youtu.be/HAnw168huqA?t=';
const double _startSecondstwo = 0000000000000000000000000001425;
const String _videoIdthree = 'https://youtu.be/HiWXeWQAsUE?t=';
const double _startSecondsthree = 000000000000000000000000000422;
const String _videoIdfour = 'https://youtu.be/Unzc731iCUY?t=';
const double _startSecondsfour = 0000000000000000000000000003545;
const String _videoIdfive = 'https://youtu.be/UvIkojfQDxA?t=';
const double _startSecondsfive = 000000000000000000000000000421;
