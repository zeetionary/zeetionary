...
class EnglishEntryheader extends StatefulWidget {
  const EnglishEntryheader({super.key});

  @override
  State<EnglishEntryheader> createState() => _EnglishEntryheaderState();
}

class _EnglishEntryheaderState extends State<EnglishEntryheader> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: header (Derived forms: headers)
1. A line of text serving to indicate what the passage below it is about (- heading, head)
"the header seemed to have little to do with the text";
 
2. Horizontal beam used as a finishing piece over a door or window (- lintel)
 
3. Brick that is laid sideways at the top of a wall (- coping, cope)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A fine header!""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The header gives the page number and date of the document.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """header""",
                      // alsoEnglishWord: "also: header",
                      britshText: """IpaUK: /ˈhedə(r)/""",
                      americanText: """IpaUS: /ˈhedər/""",
...
کوردی: 
"""),
// With short examples define "header", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) لێدان لە تۆپ بە سەر"""),
                    SentencesRow(
                      englishText: """A fine header!""",
                      kurdishText: """کەللەیەکی جوان!""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) نووسینێک کە لە سەرەوەی هەموو پەڕەیەکی کتێبێک یان بەڵگەنامەیەک دەردەکەوێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The header gives the page number and date of the document.""",
                      kurdishText: """سەرپەڕەکە ژمارەی لاپەڕە و بەرواری بەڵگەنامەکە دەدات.""",
...
const double _startSecondsend = 0000000000000000000000000001224;
const String _videoIdone = 'https://youtu.be/LfR4QfmwTAc?t=';
const double _startSecondsone = 000000000000000000000000000636;
const String _videoIdtwo = 'https://youtu.be/NL8ohG3Zv-o?t=';
const double _startSecondstwo = 000000000000000000000000000286;
const String _videoIdthree = 'https://youtu.be/LCF05r3CSME?t=';
const double _startSecondsthree = 000000000000000000000000000685;
const String _videoIdfour = 'https://youtu.be/gO-V8E9MIBg?t=';
const double _startSecondsfour = 000000000000000000000000000240;
const String _videoIdfive = 'https://youtu.be/q9ZcPtvTKpY?t=';
