...
کوردی: کەوان، کەمە، کەوانە (نێوان دوو سەری کەوان: ماڵ)، دەنووکە، ئاڕشە، ژێژەنە(ک)، نووشتانەوە، چەمانەوە، چەمینەوە، نووچ، گرێ قوڵفە یان خزیو، پاپیۆن، پەلکەزێڕینە، کۆلکەزێڕینە، کەسک‌وسۆر، بۆنووشتانەوە، داهاتنەو بە نیشانەی ڕێز، کڕنۆش
...
١. (کردار) چەمانەوە بۆ ڕێزگرتن یان ماڵئاوایی"""),
                          ...
                          Row(
                            children: [
                              ...
                              const ExampleSentenceKurdish(
                                  text:
                                      "خەڵکەکە هەموو لە پێش ئیمپراتۆر چەمانەوە."),
                              const CustomSizedBoxForTTS(),
                              Column(
                                children: [
                                  CustomIconButtonBritish(
                          ...
                          const DefinitionKurdish(
                              text:
                                  "٤. (کردار) لێدانی میوزیک بە بەکارهێنانی ئاڕشەیەک"),
                          Row(
                            children: [
                              const ExampleSentenceEnglish(
                                  text:
                          ...
                          Row(
                            children: [
                              ...
                              const ExampleSentenceKurdish(
                                  text:
                                      "پەیامهێنەرەکە نووشتاوەیەکی فەرمی ئەنجامدا و ژوورەکەی جێهێشت."),
                              const CustomSizedBoxForTTS(),
                              Column(
                                children: [
                                  CustomIconButtonBritish(
                          ...
                          const DefinitionKurdish(
                              text:
                                  "٧. (ناو) کەوان کە بۆ تیر هاویشتن بەکاردێت"),
                          Row(
                            children: [
                              const ExampleSentenceEnglish(
                          ...
                          Row(
                            children: [
                              ...
                              const ExampleSentenceKurdish(
                                  text: "ئاڕشەکەی هێنا بە تەلەکاندا."),
                              const CustomSizedBoxForTTS(),
                              Column(
                                children: [
                                  CustomIconButtonBritish(
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/pdipblQmgnw?t=";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/ZDIvj1GvH64?t=";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/OeVp9S1HzqI?t=";
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/Mj3hMXIQsoc?t=";
