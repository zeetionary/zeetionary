...
// replace these: replace EnglishEntryaffable - replace speakAffable - replace affable - /ˈæfəbl/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaffable extends StatelessWidget {
  EnglishEntryaffable({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAffable(String languageCode) async {
    // DOPSUM: CHANGE speakAffable
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("affable"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAffab2569(String languageCode) async {
    ...
    await flutterTts.speak(
        "He struck me as an affable sort of a man."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "affable", // DOPSUM: CHANGE WORD ENTRY - Find /ˈæfəbl/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈæfəbl/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '0num7Zb4iu4';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'l4bAoNAx2uo';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'h-uAcFczh_I';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final YoutubePlayerController _controller = YoutubePlayerController(
    ...
    flags: const YoutubePlayerFlags(
      ...
      loop: true,
      mute: false,
      startAt: 25427, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
    ),
  );
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'pE1Qk90pxE4';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'GPTQlfPQo6o';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'PBev_kFPQQk';
