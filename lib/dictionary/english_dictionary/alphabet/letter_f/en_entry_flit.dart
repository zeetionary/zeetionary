...
class EnglishEntryflit extends StatefulWidget {
  const EnglishEntryflit({super.key});

  @override
  State<EnglishEntryflit> createState() => _EnglishEntryflitState();
}

class _EnglishEntryflitState extends State<EnglishEntryflit> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flit (Derived forms: flits)
1. A sudden quick movement (= dart)
 
2. [Brit] A secret move (to avoid paying debts)
"they did a moonlight flit"

- Verb: flit (Derived forms: flitted, flits, flitting)
1. Move along rapidly and lightly; skim or dart (= flutter, fleet, dart)
"The hummingbird flitted among the branches";
""",
  );

  final String keyword = "flit";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Butterflies flitted from flower to flower.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He flits from one job to another.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I had to change schools every time my parents flitted.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flit""",
                      // alsoEnglishWord: "also: flit",
                      britshText: """IpaUK: /flɪt/""",
                      americanText: """IpaUS: /flɪt/""",
...
کوردی: خۆدزینەوە، هەڵاتن، بە دزی‌یەوە کۆچ کردن
"""),
// With short examples define "flit", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) رۆشتن بە هێواشی و خێرایی لە شوێنێکەوە بۆ یەکێکی دیکە"""),
                    SentencesRow(
                      englishText:
                          """Butterflies flitted from flower to flower.""",
                      kurdishText: """پەپوولە لە گوڵ بۆ گوڵ جرت و فاتیان بوو.""",
                    ...
                    SentencesRow(
                      englishText: """He flits from one job to another.""",
                      kurdishText: """لە کارێکەوە بۆ یەکێکی دیکە دەچوو.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) گۆڕینی خانوو، بەتایبەتی بە نهێنی بۆ ئەوەی قەرز نەدەیتەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I had to change schools every time my parents flitted.""",
                      kurdishText: """دەبوو قوتابخانە بگۆڕم هەر کات دایک و باوکم باریان دەکرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Qy9_lfjQopU?t=';
const double _startSecondsend = 00000000000000000000000000066;
const String _videoIdone = 'https://youtu.be/v-Ymf_hTbUM?t=';
const double _startSecondsone = 0000000000000000000000000001380;
const String _videoIdtwo = 'https://youtu.be/k9-wTnqIidY?t=';
const double _startSecondstwo = 000000000000000000000000000134;
const String _videoIdthree = 'https://youtu.be/NXlTO0dti3k?t=';
const double _startSecondsthree = 000000000000000000000000000533;
const String _videoIdfour = 'https://youtu.be/qBuzN1dP06M?t=';
const double _startSecondsfour = 00000000000000000000000000010059;
const String _videoIdfive = 'https://youtu.be/CDKASJDakiA?t=';
const double _startSecondsfive = 0000000000000000000000000002212;
