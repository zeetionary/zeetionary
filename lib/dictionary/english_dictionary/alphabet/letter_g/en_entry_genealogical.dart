...
class EnglishEntrygenealogical extends StatefulWidget {
  const EnglishEntrygenealogical({super.key});

  @override
  State<EnglishEntrygenealogical> createState() =>
      _EnglishEntrygenealogicalState();
}

class _EnglishEntrygenealogicalState extends State<EnglishEntrygenealogical> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "genealogical";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""genealogical""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Genealogical research traced his roots back to Europe.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """genealogical""",
                      // alsoEnglishWord: "also: genealogical",
                      britshText: """IpaUK: /ˌdʒiːniəˈlɒdʒɪkl/""",
                      americanText: """IpaUS: /ˌdʒiːniəˈlɑːdʒɪkl/""",
...
// With short examples define "genealogical", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Genealogical research traced his roots back to Europe.""",
                      kurdishText:
                          """توێژینەوەی ڕەچەڵەکناسییانە بنەچەی بۆ ئەورووپا گەڕاندەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/6zTn9Yk_6_4?t=';
const double _startSecondsend = 0000000000000000000000000001203;
const String _videoIdone = 'https://youtu.be/akoNcDKCr-o?t=';
const double _startSecondsone = 000000000000000000000000000426;
const String _videoIdtwo = 'https://youtu.be/HclD2E_3rhI?t=';
const double _startSecondstwo = 000000000000000000000000000273;
const String _videoIdthree = 'https://youtu.be/7H1kAa9aLbA?t=';
const double _startSecondsthree = 000000000000000000000000000698;
const String _videoIdfour = 'https://youtu.be/S_VjJBYUgko?t=';
const double _startSecondsfour = 000000000000000000000000000630;
const String _videoIdfive = 'https://youtu.be/7q8Oa97a04g?t=';
