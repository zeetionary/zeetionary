...
class EnglishEntryaccentuate extends StatefulWidget {
  const EnglishEntryaccentuate({super.key});

  @override
  State<EnglishEntryaccentuate> createState() => _EnglishEntryaccentuateState();
}

class _EnglishEntryaccentuateState extends State<EnglishEntryaccentuate> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "accentuate";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accentuate""",
                      // alsoEnglishWord: "also: accentuate",
                      britshText: """IpaUK: /əkˈsentʃueɪt/""",
                      americanText: """IpaUS: /əkˈsentʃueɪt/""",
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'd3qOoYZppaQ';
