...
// blank divider
  ...
  Future<void> speakBarcodes7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBarcodes77"); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "barcode", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakBarcode(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˈbɑːrkəʊd/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  static String myVideoId = "5K8UpMNYIPo";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  static String myVideoId = "FKdCQkM5_8g";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  static String myVideoId = "tPeOW3nLEws";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  static String myVideoId = "DBREP1Pdtpc";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  static String myVideoId = "q-wm5NvZGD4";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  static String myVideoId = "5kZRY5xlP6Y";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  static String myVideoId = "qnKtglBqe78";
