...
class EnglishEntryinsidious extends StatefulWidget {
  const EnglishEntryinsidious({super.key});

  @override
  State<EnglishEntryinsidious> createState() => _EnglishEntryinsidiousState();
}

class _EnglishEntryinsidiousState extends State<EnglishEntryinsidious> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insidious""");
  }
