...
class EnglishEntryhotline extends StatefulWidget {
  const EnglishEntryhotline({super.key});

  @override
  State<EnglishEntryhotline> createState() => _EnglishEntryhotlineState();
}

class _EnglishEntryhotlineState extends State<EnglishEntryhotline> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hotline (Derived forms: hotlines)
1. A telefone line that provides direct and prompt information or advice to the caller in relation to a specific subject (- hotline)
 
2. A direct telephone line between two officials
""",
  );

  final String keyword = "hotline";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hotline""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The hotline to the White House is always open.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/AKNcIO3mum0?t=';
    const double startSecondsend = 000000000000000000000000000346;
    const String videoIdone = 'https://youtu.be/yij2FpHYdwE?t=';
    const double startSecondsone = 000000000000000000000000000397;
    const String videoIdtwo = 'https://youtu.be/HH3C1pYXCl0?t=';
    const double startSecondstwo = 00000000000000000000000000024;
    const String videoIdthree = 'https://youtu.be/bnnRIrxGGX8?t=';
    const double startSecondsthree = 0000000000000000000000000002121;
    const String videoIdfour = 'https://youtu.be/oAADFdfa-G4?t=';
    const double startSecondsfour = 0000000000000000000000000001437;
    const String videoIdfive = 'https://youtu.be/5zfZhskSmp0?t=';
    const double startSecondsfive = 000000000000000000000000000652;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hotline""",
                      // alsoEnglishWord: "also: hotline",
                      britshText: """IpaUK: /ˈhɒtlaɪn/""",
                      americanText: """IpaUS: /ˈhɑːtlaɪn/""",
...
// With short examples define "hotline", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """An emergency hotline has been set up for the relatives of those involved in the disaster.""",
                      kurdishText:
                          """هێڵێکی فریاگوزاری سەرەتایی درووستکراوە بۆ خزمانی ئەو کەسانەی بەشێک بوون لە کارەساتەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هێڵی تەلەفۆنی کۆشکی سپی هەمیشە کراوەیە.""",
