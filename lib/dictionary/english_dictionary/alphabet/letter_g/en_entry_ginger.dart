...
class EnglishEntryginger extends StatefulWidget {
  const EnglishEntryginger({super.key});

  @override
  State<EnglishEntryginger> createState() => _EnglishEntrygingerState();
}

class _EnglishEntrygingerState extends State<EnglishEntryginger> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Make sure you chop the ginger into tiny pieces.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The cat's fur is a bright ginger.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The painting featured a ginger sunset over the hills.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Hey, ginger, what are you doing?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ginger""",
                      // alsoEnglishWord: "also: ginger",
                      britshText: """IpaUK: /ˈdʒɪndʒə(r)/""",
                      americanText: """IpaUS: /ˈdʒɪndʒər/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕەگی زەنجەفیل کە لە خواردندا وەک توونی بەکاردێت"""),
                    SentencesRow(
                      englishText:
                          """Make sure you chop the ginger into tiny pieces.""",
                      kurdishText:
                          """دڵنیابەرەوە کە زەنجەفیلەکە ورد دەکەیت بۆ بەشی بچووکتر.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) کەسێک کە قژی سوور یان پرتەقاڵی مەیلەو قاوەیی هەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Hey, ginger, what are you doing?""",
                      kurdishText: """ها، قژسوور، چی دەکەیت؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تابلۆکە خۆرئاوابوونێکی پرتەقاڵی بەسەر گردەکانەوە تێدا بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/LbbRwURcPrY?t=';
const double _startSecondsend = 00000000000000000000000000047;
const String _videoIdone = 'https://youtu.be/RXAEN8MP8N4?t=';
const double _startSecondsone = 00000000000000000000000000027;
const String _videoIdtwo = 'https://youtu.be/dAMf5L_PLdo?t=';
const double _startSecondstwo = 00000000000000000000000000017;
const String _videoIdthree = 'https://youtu.be/3up7u81byE8?t=';
const double _startSecondsthree = 000000000000000000000000000119;
const String _videoIdfour = 'https://youtu.be/1-P8tAmFvTs?t=';
const double _startSecondsfour = 00000000000000000000000000061;
const String _videoIdfive = 'https://youtu.be/OlLwgjL5h3k?t=';
