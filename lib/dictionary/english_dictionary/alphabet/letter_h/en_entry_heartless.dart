...
class EnglishEntryheartless extends StatefulWidget {
  const EnglishEntryheartless({super.key});

  @override
  State<EnglishEntryheartless> createState() => _EnglishEntryheartlessState();
}

class _EnglishEntryheartlessState extends State<EnglishEntryheartless> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: heartless
1. Lacking in feeling, pity or warmth (- hardhearted)
 
2. [archaic] Devoid of courage or enthusiasm
""",
  );

  final String keyword = "heartless";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heartless""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The decision does seem a little heartless.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What a heartless thing to say!""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heartless""",
                      // alsoEnglishWord: "also: heartless",
                      britshText: """IpaUK: /ˈhɑːtləs/""",
                      americanText: """IpaUS: /ˈhɑːrtləs/""",
...
کوردی: بێ‌بەزەیی، بێ‌دڵ، بێ‌ڕەحم، دڵڕەق
"""),
// With short examples define "heartless", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) نەبوونی بەزەیی بۆ کەسانی دیکە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: cruel"),
                    SentencesRow(
                      englishText:
                          """The decision does seem a little heartless.""",
                      kurdishText: """بڕیارەکە کەمێک دڵڕەقانە دیارە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """What a heartless thing to say!""",
                      kurdishText: """چی شتێکی بێ‌ڕەحمانە بۆ گوتن!""",
...
const String _videoIdone = 'https://youtu.be/9OzZZkx_4MQ?t=';
const double _startSecondsone = 000000000000000000000000000502;
const String _videoIdtwo = 'https://youtu.be/OPVZcsdy9RY?t=';
const double _startSecondstwo = 000000000000000000000000000258;
const String _videoIdthree = 'https://youtu.be/-P5m5rqL7gM?t=';
const double _startSecondsthree = 000000000000000000000000000119;
const String _videoIdfour = 'https://youtu.be/8tT3FhOA4-g?t=';
const double _startSecondsfour = 00000000000000000000000000061;
const String _videoIdfive = 'https://youtu.be/o7N5I-wYgRs?t=';
