...
class EnglishEntrygastropub extends StatefulWidget {
  const EnglishEntrygastropub({super.key});

  @override
  State<EnglishEntrygastropub> createState() => _EnglishEntrygastropubState();
}

class _EnglishEntrygastropubState extends State<EnglishEntrygastropub> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gastropub";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gastropub""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gastropub""",
                      // alsoEnglishWord: "also: gastropub",
                      britshText: """IpaUK: /ˈɡæstrəʊpʌb/""",
                      americanText: """IpaUS: /ˈɡæstrəʊpʌb/""",
...
const String _videoIdone = 'https://youtu.be/_6v-fJUtNqU?t=';
const double _startSecondsone = 000000000000000000000000000241;
const String _videoIdtwo = 'https://youtu.be/jNkPg4LiRd4?t=';
const double _startSecondstwo = 000000000000000000000000000607;
const String _videoIdthree = 'https://youtu.be/S3UnqJFdZFE?t=';
const double _startSecondsthree = 000000000000000000000000000523;
const String _videoIdfour = 'https://youtu.be/_zGlBd4HG2I?t=';
const double _startSecondsfour = 000000000000000000000000000520;
const String _videoIdfive = 'https://youtu.be/r-0QwkuRQcw?t=';
const double _startSecondsfive = 000000000000000000000000000124;
