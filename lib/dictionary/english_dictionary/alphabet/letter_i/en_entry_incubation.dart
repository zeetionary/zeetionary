...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/sth0GSJdzFY?t=';
    const double startSecondsend = 000000000000000000000000000144;
    const String videoIdone = 'https://youtu.be/417Qbwn9yso?t=';
    const double startSecondsone = 00000000000000000000000000052;
    const String videoIdtwo = 'https://youtu.be/oJLA8iNUV-0?t=';
    const double startSecondstwo = 000000000000000000000000000274;
    const String videoIdthree = 'https://youtu.be/xCat5fXRyyU?t=';
    const double startSecondsthree = 00000000000000000000000000041;
    const String videoIdfour = 'https://youtu.be/zPwdjOPTodk?t=';
    const double startSecondsfour = 000000000000000000000000000633;
    const String videoIdfive = 'https://youtu.be/JNiH18JNmqA?t=';
    const double startSecondsfive = 000000000000000000000000000101;
