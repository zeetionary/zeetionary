...
class EnglishEntryequitable extends StatefulWidget {
  const EnglishEntryequitable({super.key});

  @override
  State<EnglishEntryequitable> createState() => _EnglishEntryequitableState();
}

class _EnglishEntryequitableState extends State<EnglishEntryequitable> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""equitable""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equitable""",
                      // alsoEnglishWord: "also: equitable",
                      britshText: """IpaUK: /ˈekwɪtəbl/""",
                      americanText: """IpaUS: /ˈekwɪtəbl/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "equitable";
...
کوردی: دادپەروەرانە، دادپەروەر، بەداد، خودابین، بەرامبەربین، حەق، دروست، بەرحەق، ژیرانە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) یەکسان؛ مامەڵەکردن لەگەڵ هەموان بە یەکسانی"""),
          SentencesRow(
            englishText:
                """We need to construct an equitable method of local taxation.""",
            kurdishText: """دەبێت ڕێگایەکی یەکسانی باجدانی خۆجێیی دابڕێژین.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: equitable 
1. Fair to all parties as dictated by reason and conscience (= just)
"an equitable distribution of gifts among the children"; "equitable treatment of all citizens";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/dGpJRvawgNI?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1047;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/Ot4qdCs54ZE?t=';
const double _startSecondsone = 00000000000000000000000000000; // 849;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/yRA0KMCEP2o?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 604;
const String _videoIdthree = 'VIDEOhttps://youtu.be/IfYRzxeMdGs?t=';
const double _startSecondsthree = 000000000000000000000000000; // 473;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/mzZTLT8WpcQ?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 214;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/0t1OddjmpCI?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1975;
