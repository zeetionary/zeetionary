...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/z3uvnwBMTdY?t=';
    const double startSecondsend = 0000000000000000000000000004571;
    const String videoIdone = 'https://youtu.be/1qbna6t1bzw?t=';
    const double startSecondsone = 0000000000000000000000000005583;
    const String videoIdtwo = 'https://youtu.be/b2lFauyNMVA?t=';
    const double startSecondstwo = 0000000000000000000000000001413;
    const String videoIdthree = 'https://youtu.be/cUP8bGWln6M?t=';
    const double startSecondsthree = 000000000000000000000000000629;
    const String videoIdfour = 'https://youtu.be/VC7ZqkV1_yw?t=';
    const double startSecondsfour = 000000000000000000000000000402;
    const String videoIdfive = 'https://youtu.be/ZmcnSs58uVk?t=';
    const double startSecondsfive = 000000000000000000000000000248;
