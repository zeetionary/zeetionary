...
class EnglishEntryfacility extends StatefulWidget {
  const EnglishEntryfacility({super.key});

  @override
  State<EnglishEntryfacility> createState() => _EnglishEntryfacilityState();
}

class _EnglishEntryfacilityState extends State<EnglishEntryfacility> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""facility""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """facility""",
                      // alsoEnglishWord: "also: facility",
                      britshText: """IpaUK: /fəˈsɪləti/""",
                      americanText: """IpaUS: /fəˈsɪləti/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts
        .speak("""The school is upgrading its outdoor play facilities.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.speak("""The communal facilities were in a bad state.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts
        .speak("""The hotel provides excellent facilities for children.""");
  }

  Future<void> speaksentence5(String languageCode) async {
    await flutterTts.setLanguage(languageCode);

    await flutterTts.speak("""There are childcare facilities on site.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts
        .speak("""She trains with the team at their practice facility.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts
        .speak("""The device has a facility for storing any sound you like.""");
  }

  Future<void> speaksentence10(String languageCode) async {
    await flutterTts.setLanguage(languageCode);

    await flutterTts.speak("""She has a facility for languages.""");
  }
...
"""),
          ...
          SentencesRow(
            ...
            kurdishText:
                """قوتابخانەکە گۆڕەپان و کەلوپەلی یاریکردن باشتر دەکات.""",
          ...
          SentencesRow(
            englishText:
                """There are not enough facilities for families with young children.""",
            kurdishText: """شوێنی زۆر بۆ خێزانی خاوەن منداڵ نییە.""",
            onPressedBritish: () => speaksentence2("en-GB"),
            onPressedAmerican: () => speaksentence2("en-US"),
          ),
          const DividerSentences(),
          SentencesRow(
            englishText: """The communal facilities were in a bad state.""",
            kurdishText: """شوێنە نیشتەجێبوونەکان لە دۆخی خراپدا بوون.""",
          ...
          SentencesRow(
            englishText:
                """A doctor visited the facility and found deplorable conditions.""",
            kurdishText:
                """پزیشکێک سەردانی شوێنەکەی کرد و دۆخی زۆر خراپی بینی.""",
          ...
          SentencesRow(
            englishText:
                """The company expects to open its facility by late September.""",
            kurdishText:
                """کۆمپانیاکە چاوەڕێ دەکات تاوەکو ئەیلوول بیناکەی بکاتەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He plays the piano with surprising facility.""",
            kurdishText: """بە توانای سەرنڕاکێشەوە پیانۆ دەژەنێت.""",
...
2. Skilful performance or ability without difficulty (= adeptness, adroitness, deftness, quickness)
"he was famous for his facility as an archer";
 
3. A natural effortlessness (= readiness)
...
const String _videoIdend = 'SDW41S5yWPw';
const double _startSecondsend = 10;
const String _videoIdone = 'cdWBJvW-Usk';
const double _startSecondsone = 2;
const String _videoIdtwo = 'knLOLYbz_E4';
const double _startSecondstwo = 0;
const String _videoIdthree = 'TKoCWh2yneM';
