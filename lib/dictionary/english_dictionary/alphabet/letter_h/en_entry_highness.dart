...
class EnglishEntryhighness extends StatefulWidget {
  const EnglishEntryhighness({super.key});

  @override
  State<EnglishEntryhighness> createState() => _EnglishEntryhighnessState();
}

class _EnglishEntryhighnessState extends State<EnglishEntryhighness> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Highness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Will that be all, Your Highness?""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/PGu_g9De_Ms?t=';
    const double startSecondsend = 000000000000000000000000000967;
    const String videoIdone = 'https://youtu.be/OoVYhJmKB4k?t=';
    const double startSecondsone = 000000000000000000000000000852;
    const String videoIdtwo = 'https://youtu.be/LCRc9_6YxPQ?t=';
    const double startSecondstwo = 0000000000000000000000000006;
    const String videoIdthree = 'https://youtu.be/HARP7YxJnOA?t=';
    const double startSecondsthree = 000000000000000000000000000552;
    const String videoIdfour = 'https://youtu.be/UFmHNCNMJFo?t=';
    const double startSecondsfour = 00000000000000000000000000023;
    const String videoIdfive = 'https://youtu.be/bhBkB-wQCnE?t=';
    const double startSecondsfive = 0000000000000000000000000005847;
...
کوردی: 
"""),
// With short examples define "Highness", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) نازناوێک کە دەدرێت بە ئەندامانی خێزانی شاهانە"""),
                    SentencesRow(
                      englishText: """Will that be all, Your Highness?""",
                      kurdishText: """ئەوە هەموویەتی، خاوەنشکۆ؟""",
