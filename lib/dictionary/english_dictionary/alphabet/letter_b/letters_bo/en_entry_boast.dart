...
کوردی: هاڕەوگیفە، پێچ و پڵووچ، لاف‌وگەزاف، لاف‌وگاف، لافاندن، لاف‌لێدان، خۆدەماندن، فڕوفیشاڵ، تڕلێدان، خوهەڵێکشان، جێی‌شانازی، مایەی سەربەرزی یان شانازی

١. (کردار) قسەکردن بە شێوەیەک کە پیشانی دەدات زۆر شانازی بە شتێکەوە دەکەیت کە هەتە یان دەتوانی بیکەیت"""),
                          Row(
                            children: [
                              ...
                              const ExampleSentenceKurdish(
                                  text:
                                      "نامەوێت خۆم‌هەڵکێشم بەڵام لە ڕاستیدا دەتوانم بە شەش زمان قسە بکەم."),
                          ...
                          Row(
                            children: [
                              ...
                              const ExampleSentenceKurdish(
                                  text:
                                      "هەمیشە فڕوفیشاڵیەتی سەبارەت بەوەی منداڵەکانیان چەندە جوانن."),
                              const CustomSizedBoxForTTS(),
                              CustomIconButtonBritish(
                          ...
                          const DefinitionKurdish(
                              text: "٢. (کردار) هەبوونی شتێکی سەرسوڕهێنەر"),
                          Row(
                            children: [
                              const ExampleSentenceEnglish(
                                  text:
                              ...
                              const ExampleSentenceKurdish(
                                  text:
                                      "دوورگەی ڕەودز ٣٠٠ ڕۆژی لە تیشکی خۆر هەیە لە ساڵێکدا."),
                              const CustomSizedBoxForTTS(),
                              CustomIconButtonBritish(
                          ...
                          Row(
                            children: [
                              ...
                              const ExampleSentenceKurdish(
                                  text:
                                      "ئەمە هەرێمێکە کە بە شانازییەوە کەلتووری جیاوازی خۆی هەیە."),
                              const CustomSizedBoxForTTS(),
                              CustomIconButtonBritish(
                          ...
                          Row(
                            children: [
                              ...
                              const ExampleSentenceKurdish(
                                  text:
                                      "سەرەڕای لاف‌لێدانی کە منداڵەکانی بلیمەت بوون، هیچیان نەگەشتن بە کۆلێژ."),
                              const CustomSizedBoxForTTS(),
                              CustomIconButtonBritish(
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/mqxHzWJlqps?t=";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/pAyljtELZ8k?t=";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/ZIc4VEFFotg?t=";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/Yql-9LHorTo?t=";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/1v32Op5Uwdc?t=";
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/XFWI1gRJkP8?t=";
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/JgkgBZfLu2I?t=";
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/JUJOe2MCJp8?t=";
