...
class EnglishEntryfund extends StatefulWidget {
  const EnglishEntryfund({super.key});

  @override
  State<EnglishEntryfund> createState() => _EnglishEntryfundState();
}

class _EnglishEntryfundState extends State<EnglishEntryfund> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fund (Derived forms: funds)
1. A reserve of money set aside for some purpose (- monetary fund)

2. A supply of something available for future use (- store, stock, arsenal)
 
3. A financial institution that sells shares to individuals and invests in securities issued by other companies (- investment company, investment trust, investment firm)

- Verb: fund (Derived forms: funding, funds, funded)
1. Furnish money for
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There is currently over £200 000 in the fund.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They don't want to draw on the fund unless they have to.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The project has been cancelled because of lack of funds.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Most of the funds are spent on software.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She is a fund manager for an Asian bank.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The company has agreed to fund my trip to Australia.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Who is funding this research?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fund""",
                      // alsoEnglishWord: "also: fund",
                      britshText: """IpaUK: /fʌnd/""",
                      americanText: """IpaUS: /fʌnd/""",
...
کوردی: دراونامە، بودجە،	سنووق،	پارە، پووڵ، ماڵ،	سەرمایە، دەسمایە،	سەرمایەی هەمیشەیی یان جێگیر
"""),
// With short examples define "fund", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بڕە پارەیەک کە هەڵگیراوە یان بەردەستە بۆ مەبەستێکی دیاریکراو"""),
                    SentencesRow(
                      englishText:
                          """There is currently over £200 000 in the fund.""",
                      kurdishText:
                          """لە ئێستادا ٢٠٠٠٠٠ پاوەند هەیە لە بودجەکەدا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The newspaper launched an appeal fund for victims of the disaster.""",
                      kurdishText:
                          """ڕۆژنامەکە تکایەکی یارمەتیدانی دارایی بۆ قوربانیانی کارەساتەکە دەست پێکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """نایانەوێت بودجەکە بەکاربهێنن مەگەر ئەوەی پێویست بکات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ئەو پارەیەی کە بەردەستە بۆ بەکارهێنان"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The hospital is trying to raise funds for a new kidney machine.""",
                      kurdishText:
                          """نەخۆشخانەکە هەوڵ دەدات پارە کۆبکاتەوە بۆ ئامێرێکی تازەی گورچیلە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پڕۆژەکە هەڵوەشێدراوەتەوە بەهۆی کەمیی پارەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I'm short of funds at the moment—can I pay you back next week?""",
                      kurdishText:
                          """لە ئێستادا پارەم کەمە ـ دەکرێت هەفتەی داهاتوو پارەت بدەمەوە؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆرینەی بودجەکە لەسەر نەرمامێر خەرج دەکرێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) کۆمپانیایەک کە پارەی خەڵک بەڕێوە دەبات بەوەی بۆیان دەخاتە وەبەرهێنانەوە؛ بڕە پارەیەک کە بۆ ئەم جۆرە وەبەرهێنانە بەکاردێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She is a fund manager for an Asian bank.""",
                      kurdishText:
                          """بەڕێوەبەری کاری وەبەرهێنانە بۆ کۆمپانیایەکی ئاسیا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کۆمپانیاکە ڕازی بووە کە پارەی گەشتەکەم بۆ ئوسترالیا بدات.""",
                    ...
                    SentencesRow(
                      englishText:
                          """We'll need accurate costings before we can agree to fund the scheme.""",
                      kurdishText:
                          """پێویستیمان بە خەرجییەکان بە درووستی هەیە پێش ئەوەی تێچووی پلانەکە دابین بکەین.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Who is funding this research?""",
                      kurdishText: """کێ پارەی ئەم توێژینەوەیە دەدات؟""",
...
const double _startSecondsend = 000000000000000000000000000998;
const String _videoIdone = 'https://youtu.be/mY3SEMTROas?t=';
const double _startSecondsone = 00000000000000000000000000062;
const String _videoIdtwo = 'https://youtu.be/Cqbleas1mmo?t=';
const double _startSecondstwo = 0000000000000000000000000001067;
const String _videoIdthree = 'https://youtu.be/Js2UoMSumx4?t=';
const double _startSecondsthree = 0000000000000000000000000001054;
const String _videoIdfour = 'https://youtu.be/TRGHIN2PGIA?t=';
const double _startSecondsfour = 000000000000000000000000000730;
const String _videoIdfive = 'https://youtu.be/Xzv84ZdtlE0?t=';
const double _startSecondsfive = 0000000000000000000000000001904;
