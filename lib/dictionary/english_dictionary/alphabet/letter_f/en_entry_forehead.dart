...
class EnglishEntryforehead extends StatefulWidget {
  const EnglishEntryforehead({super.key});

  @override
  State<EnglishEntryforehead> createState() => _EnglishEntryforeheadState();
}

class _EnglishEntryforeheadState extends State<EnglishEntryforehead> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forehead (Derived forms: foreheads)
1. The part of the face above the eyes (= brow)
 
2. The large cranial bone forming the front part of the cranium: includes the upper part of the orbits (= frontal bone, os frontale)
""",
  );

  final String keyword = "forehead";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forehead""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He wiped the sweat from his forehead.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His hair fell over his forehead.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forehead""",
                      // alsoEnglishWord: "also: forehead",
                      britshText: """IpaUK: /ˈfɔːhed/,  /ˈfɒrɪd/""",
                      americanText: """IpaUS: /ˈfɔːrhed/,  /ˈfɔːrəd/""",
...
کوردی: ناوچاوان، تەختی ناوچاوان، تەوێڵ، ئەنی، هانیە، نۆتک
"""),
// With short examples define "forehead", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """He wiped the sweat from his forehead.""",
                      kurdishText: """ئارەقەی ناوچاوانی سڕی.""",
                    ...
                    SentencesRow(
                      englishText: """His hair fell over his forehead.""",
                      kurdishText: """قژی هات بەسەر تەوێڵیدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/3cxHwQl9pNM?t=';
const double _startSecondsend = 000000000000000000000000000250;
const String _videoIdone = 'https://youtu.be/pTysrwci0pU?t=';
const double _startSecondsone = 000000000000000000000000000168;
const String _videoIdtwo = 'https://youtu.be/JgQVj4iMm8Y?t=';
const double _startSecondstwo = 00000000000000000000000000080;
const String _videoIdthree = 'https://youtu.be/xVQxvthAcLU?t=';
const double _startSecondsthree = 000000000000000000000000000982;
const String _videoIdfour = 'https://youtu.be/SaneSRqePVY?t=';
const double _startSecondsfour = 000000000000000000000000000619;
const String _videoIdfive = 'https://youtu.be/fn--IVarumw?t=';
const double _startSecondsfive = 000000000000000000000000000597;
