...
class EnglishEntryhere extends StatefulWidget {
  const EnglishEntryhere({super.key});

  @override
  State<EnglishEntryhere> createState() => _EnglishEntryhereState();
}

class _EnglishEntryhereState extends State<EnglishEntryhere> {
  @override
  void initState() {
    super.initState();
...
3. To this place (especially toward the speaker) (- hither)
"come here, please";
...
- Noun: here (Derived forms: heres)
1. The present location; this place; location, proximal pronoun; demonstrative pronoun, location; quantifier: demonstrative determiner, singular, proximal
"where do we go from here?"

- Noun: Here
1. Queen of the Olympian gods in ancient Greek mythology; sister and wife of Zeus remembered for her jealousy of the many mortal women Zeus fell in love with; identified with Roman Juno (- Hera)
""",
  );

  final String keyword = "here";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I live here.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Put the box here.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Click here for more details.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Let's get out of here.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Come over here.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Here's the money I promised you.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Here's a dish that is simple and quick to make.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Here is your opportunity.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Here comes the bus.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I can't find my keys. Oh, here they are.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Here we are.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'm here to help you.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Here the speaker paused to have a drink.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""My friend here saw it happen.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Here, where are you going with that ladder?""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Here, let me carry that for you.""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Here, have another piece of cake.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """here""",
                      // alsoEnglishWord: "also: here",
                      britshText: """IpaUK: /hɪə(r)/""",
                      americanText: """IpaUS: /hɪr/""",
...
کوردی: لێرە، ئێرەکانە، لە ئەمێ، وا، لەم کاتەدا، لەم وەختەدا، لەم سەروبەندەدا، لەم دەمەدا،	لێرەم، ئامادەم
"""),
// With short examples define "here", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) لە دوای کردارێک یان ئامرازێک بەکاردێت بۆ گوتنی ئێرە"""),
                    SentencesRow(
                      englishText: """I live here.""",
                      kurdishText: """لێرە دەژیم.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بەکاردێت کە شتێک دەدەیت بە کەسێک یان یان پیشانی دەدەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Here's the money I promised you.""",
                      kurdishText: """ئەمە ئەو پارەیە کە بەڵێنم پێتدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەمە خواردنێکە کە سادەیە و ئاسانە بۆ درووستکردن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ناتوانم کلیلەکانم بدۆزمەوە. ئاه، ئەمەتان.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵکار) بۆ پیشاندانی ئەرکت لە دۆخێکدا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I'm here to help you.""",
                      kurdishText: """لێرەم بۆ یارمەتیدانت.""",
                      onPressedBritish: () => speaksentence12("en-GB"),
                      onPressedAmerican: () => speaksentence12("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (ھاوەڵکار) ئێستا؛ لەم کاتەدا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Here the speaker paused to have a drink.""",
                      kurdishText:
                          """لێرەدا وتاربێژەکە وەستا بۆ خواردنەوەیەک.""",
                      onPressedBritish: () => speaksentence13("en-GB"),
                      onPressedAmerican: () => speaksentence13("en-US"),
                    ),
                    // skipped_meaning
                    // const DividerDefinition(),
                    // const DefinitionKurdish(text: """٥. (ھاوەڵکار) لە دوای ناوێک بۆ جەختکردنەوە بەکاردێت"""),
                    // const DividerSentences(),
                    // SentencesRow(
                    //   englishText: """My friend here saw it happen.""",
                    //   kurdishText: """هاوڕێکەم.""",
                    //   onPressedBritish: () => speaksentence14("en-GB"),
                    //   onPressedAmerican: () => speaksentence14("en-US"),
                    // ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٥. (سەرسوڕمان) بۆ ڕاکێشانی سەرنجی کەسێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Here, where are you going with that ladder?""",
                      kurdishText: """ها، بۆ کوێ دەچیت بەوە پلەکانەوە؟""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٦. (سەرسوڕمان) بەکاردێت کە دەتەوێت یارمەتی کەسێک بدەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Here, let me carry that for you.""",
                      kurdishText: """بێنە، بهێڵە ئەوەت بۆ هەڵبگرم.""",
...
const String _videoIdone = 'https://youtu.be/3YltYCrPZos?t=';
const double _startSecondsone = 000000000000000000000000000167;
const String _videoIdtwo = 'https://youtu.be/hTqtGJwsJVE?t=';
const double _startSecondstwo = 0000000000000000000000000001283;
const String _videoIdthree = 'https://youtu.be/4itx6mXEJ6c';
