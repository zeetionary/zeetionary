...
class EnglishEntryleadastray extends StatelessWidget {
  ...
  Future<void> speakaeadastray(String languageCode) async {
    ...
    await flutterTts.speak("lead astray");
  }
  ...
  Future<void> speakaeadastray1140(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("Jack's parents thought the other boys might lead him astray.");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '7Te-I22UEUI';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'h_LoRbTI0g8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '0vyPwg5nEDA';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'yvEMuQuJKSM';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Lv5A9bCtc6E';
  final double _startSeconds = 2141;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'wUDTFVqr-5I';
