...
class EnglishEntryliberal extends StatefulWidget {
  const EnglishEntryliberal({super.key});

  @override
  State<EnglishEntryliberal> createState() => _EnglishEntryliberalState();
}

class _EnglishEntryliberalState extends State<EnglishEntryliberal> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: liberal (Derived forms: liberals)
1. A person who favours a political philosophy of progress and reform and the protection of civil liberties (- liberalist, progressive)
 
2. A person who favours an economic theory of laissez-faire and self-regulating markets

- Adjective: liberal
1. Showing or characterized by broad-mindedness (- broad, large-minded, tolerant)
"a liberal newspaper";
 
2. Tolerant of change; not bound by authoritarianism, orthodoxy, or tradition
 
3. Having political or social views favouring reform and progress
 
4. Given or giving freely (- big, bighearted, bounteous, bountiful, freehanded, handsome, giving, openhanded)
"a liberal backer of the arts";
 
5. Not literal (- free, loose)
"a liberal translation of the poem";

- Noun: Liberal (Derived forms: Liberals)
1. A supporter of the Liberal party (- Lib [Austral, informal])
 
2. [UK] Member or supporter of the Liberal Democrats (- Liberal Democrat [UK], Lib-Dem [UK])
""",
  );

  final String keyword = "liberal";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""liberal""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""My parents were very liberal when we were growing up.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He is relatively liberal on social issues.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her attitudes are fairly liberal.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Even in famously liberal New York her views were considered too radical.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He accused them of espousing liberal ideas from the left of the party.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Some politicians want more liberal trade relations with Europe.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She is very liberal with her money.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He liked to think of himself as a liberal.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She is an outspoken liberal and supporter of workers' rights.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""As a liberal, I treasure individual freedom.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/WUjVPIEtJd0?t=1185';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/-L7o6HtX8Vg?t=1236';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/AAGIi62-sAU?t=442';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/w2DTEOB5rhk?t=3141';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/CURLWPCxe-c?t=370';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/VUEXPAHqmIs?t=361';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """liberal""",
                      // alsoEnglishWord: "also: liberal",
                      britshText: """IpaUK: /ˈlɪbərəl/""",
                      americanText: """IpaUS: /ˈlɪbərəl/""",
...
کوردی: ئازادبیر، لێبوردە، نادەمارگرژ، بێ‌لایەن، ڕزگاری‌خواز، ئازادی‌خواز، نەرم‌ڕەو، لیبراڵ،	ڕزگاری‌خوازانە، ئازادی‌خوازانە،	ڕۆشنبیرانە، ڕووناکبیرانە،	(وەرگێڕان) ئازاد،	دەس‌ودڵباز، بەدەهندە،	زۆر، فرە 
"""),
// With short examples define "liberal", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) کە ئامادەیە ڕێز لە ڕەفتار، بۆچوون، هتدی خەڵکانی دیکە بگرێت و لێیان تێ بگات، بە تایبەتی کە جیاواز لە هی خۆت"""),
                    SentencesRow(
                      englishText: """My parents were very liberal when we were growing up.""",
                      kurdishText: """دایبابم زۆر نەرم‌ڕەو بوون کە گەورە دەبووین.""",
                    ...
                    SentencesRow(
                      englishText: """He is relatively liberal on social issues.""",
                      kurdishText: """تا ئاستێکی زۆر لیبڕاڵە لە بابەتە کۆمەڵایەتییەکان.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her attitudes are fairly liberal.""",
                      kurdishText: """هەڵسووکەوتەکانی تا ئاستێکی زۆر لیبڕاڵن.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵناو) باوەڕبوون بەو سیاسەتە سیاسییانەی کە هانی گۆڕانی کۆمەڵایەتی دەدەن و باوەڕیان وایە کە سەروەت و سامان دەبێت یەکسانترانە دابەش بکرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Even in famously liberal New York her views were considered too radical.""",
                      kurdishText: """تەنانەت لە نیویۆرکی بەناوبانگانە لیبراڵ دیدەکانی بە توند دادەبران.""",
                      englishNote: """This means that her opinions were so extreme that even in New York, a place well-known for its progressive and open-minded attitudes, they were not widely accepted.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He accused them of espousing liberal ideas from the left of the party.""",
                      kurdishText: """تۆمەتباری کردن بە پەیڕەوکردنی بیروباوەڕی لیبراڵی باڵی چەپی حیزبەکە.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ھاوەڵناو) باوەڕبوون بەو باوەڕە کۆمەڵایەتی و سیاسییانەی کە پشتگیری دیموکراسی، ئازادی کەسی، و بازاڕی ئازاد دەکەن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Some politicians want more liberal trade relations with Europe.""",
                      kurdishText: """هەندێک سیاسەتمەدار پەیوەندیی بازرگانیی زیاتر لیبراڵیان دەوێت لەگەل ئەورووپا.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ھاوەڵناو) کە بە ڕێژەیەکی زۆر دەدرێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: lavish"),
                    SentencesRow(
                      englishText: """She is very liberal with her money.""",
                      kurdishText: """زۆر دەسبڵاوە لەگەڵ پارەکەیدا.""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (ناو) کەسێک کە ئامادەیە ڕێز لە ڕەفتار، بۆچوون، هتدی خەڵکانی دیکە بگرێت و لێیان تێ بگات، بە تایبەتی کە جیاواز لە هی خۆت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He liked to think of himself as a liberal.""",
                      kurdishText: """مەیلی ئەوەی هەبوو کە خۆی وەک لیبراڵ ببینێت.""",
                      onPressedBritish: () => speaksentence8("en-GB"),
                      onPressedAmerican: () => speaksentence8("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٦. (ناو) کەسێک کە باوەڕی هەیە بەو سیاسەتە سیاسییانەی کە هانی گۆڕانی کۆمەڵایەتی دەدەن و باوەڕیان وایە کە سەروەت و سامان دەبێت یەکسانترانە دابەش بکرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She is an outspoken liberal and supporter of workers' rights.""",
                      kurdishText: """لیبراڵێکی زووڵاڵە و پشتیوانی مافی کرێکاران دەکات.""",
                      onPressedBritish: () => speaksentence9("en-GB"),
                      onPressedAmerican: () => speaksentence9("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٧. (ناو) کەسێک کە باوەڕی هەیە بەو باوەڕە کۆمەڵایەتی و سیاسییانەی کە پشتگیری دیموکراسی، ئازادی کەسی، و بازاڕی ئازاد دەکەن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """As a liberal, I treasure individual freedom.""",
                      kurdishText: """وەک لیبراڵێک، ئازادیی کەسی لام گرنگە.""",
