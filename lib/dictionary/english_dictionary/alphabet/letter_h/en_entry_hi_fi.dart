...
class EnglishEntryhifi extends StatefulWidget {
  const EnglishEntryhifi({super.key});

  @override
  State<EnglishEntryhifi> createState() => _EnglishEntryhifiState();
}

class _EnglishEntryhifiState extends State<EnglishEntryhifi> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hi-fi
1. Characterized by minimal distortion in sound reproduction (- high-fidelity)
"a hi-fi system";

- Noun: hi-fi (Derived forms: hi-fis)
1. Equipment for the reproduction of sound with high fidelity (- high fidelity sound system)
 
2. The reproduction of sound with little or no distortion (- high fidelity)
""",
  );

  final String keyword = "hi-fi";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """They connected the hi-fi system to their TV for better audio.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I've just bought a new hi-fi.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hi-fi""",
                      // alsoEnglishWord: "also: hi-fi",
                      britshText: """IpaUK: /ˈhaɪ faɪ/""",
                      americanText: """IpaUS: /ˈhaɪ faɪ/""",
...
کوردی: 
"""),
// With short examples define "hi-fi", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە جۆرە ئامێرێک بەکاردێنێت کە دەنگ بە ئاستێکی زۆر بەرز تۆمار دەکات"""),
                    SentencesRow(
                      englishText:
                          """They connected the hi-fi system to their TV for better audio.""",
                      kurdishText:
                          """سیستەمە های‌فاییەکەیان پەیوەست کرد بە تەلەفیزیۆنەکەوە بۆ دەنگی باشتر.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) ئامێرێک کە سیستەمی های‌فای تێدایە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I've just bought a new hi-fi.""",
                      kurdishText: """تازەگی های‌فاییەکی تازەم کڕیوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/kPshZQQuslg?t=';
const double _startSecondsend = 000000000000000000000000000873;
const String _videoIdone = 'https://youtu.be/RkLn2gR7SyE?t=';
const double _startSecondsone = 00000000000000000000000000022;
const String _videoIdtwo = 'https://youtu.be/2ta77xmA7D4?t=';
const double _startSecondstwo = 0000000000000000000000000001141;
const String _videoIdthree = 'https://youtu.be/h7uYyXVH5bo?t=';
const double _startSecondsthree = 000000000000000000000000000548;
const String _videoIdfour = 'https://youtu.be/PFXKGJ8tjD0?t=';
const double _startSecondsfour = 000000000000000000000000000174;
const String _videoIdfive = 'https://youtu.be/KgNaNiLA7dI?t=';
