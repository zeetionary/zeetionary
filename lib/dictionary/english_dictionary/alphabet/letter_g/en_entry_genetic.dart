...
class EnglishEntrygenetic extends StatefulWidget {
  const EnglishEntrygenetic({super.key});

  @override
  State<EnglishEntrygenetic> createState() => _EnglishEntrygeneticState();
}

class _EnglishEntrygeneticState extends State<EnglishEntrygenetic> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""genetic""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The condition is a genetic inheritance.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """genetic""",
                      // alsoEnglishWord: "also: genetic",
                      britshText: """IpaUK: /dʒəˈnetɪk/""",
                      americanText: """IpaUS: /dʒəˈnetɪk/""",
...
// With short examples define "genetic", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """نەخۆشییەکە بۆماوەی جێتەتیکییە.""",
...
const String _videoIdone = 'https://youtu.be/GIJ_olY4BnE?t=';
const double _startSecondsone = 000000000000000000000000000865;
...
const double _startSecondsthree = 0000000000000000000000000006409;
const String _videoIdfour = 'https://youtu.be/y4DTW4B3Sjs?t=';
const double _startSecondsfour = 000000000000000000000000000966;
const String _videoIdfive = 'https://youtu.be/UzIxYdWVbm0?t=';
const double _startSecondsfive = 000000000000000000000000000579;
