...
class EnglishEntrylagoon extends StatefulWidget {
  const EnglishEntrylagoon({super.key});

  @override
  State<EnglishEntrylagoon> createState() => _EnglishEntrylagoonState();
}

class _EnglishEntrylagoonState extends State<EnglishEntrylagoon> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lagoon (Derived forms: lagoons)
1. A body of water cut off from a larger body by a reef of sand or coral (- laguna, lagune)
""",
  );

  final String keyword = "lagoon";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She took a boat ride across the tropical lagoon.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We loved to go swimming in the lagoon.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/WBcQOYKc3EM?t=178';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/oS830cxjVFk?t=129';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/y9nBhv0lq1s?t=1075';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/w0xPJDeTOc8?t=445';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/Uhh_An7FGek?t=266';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/W8uXhQnWgj4?t=319';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lagoon""",
                      // alsoEnglishWord: "also: lagoon",
                      britshText: """IpaUK: /ləˈɡuːn/""",
                      americanText: """IpaUS: /ləˈɡuːn/""",
...
کوردی: زەلکاو، زۆنگاو، چامۆر، تاڵاو، گەنداو، باتڵاخ
"""),
// With short examples define "lagoon", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ناوچەیەکی ئاوی دەریا کە جیاکراوەتەوە بە بەرد و خۆڵ"""),
                    SentencesRow(
                      englishText:
                          """She took a boat ride across the tropical lagoon.""",
                      kurdishText:
                          """پیاسەیەکی بەلەمی کرد بە زەلکاوە خولگەییەکەدا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ناوچەیەک کە ئاوی سازگاری تێدایە و نزیکە لە ڕووبار یان دەریاچەیەک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We loved to go swimming in the lagoon.""",
                      kurdishText:
                          """حەزمان بە چوونە مەلەوانییە لە زەلکاوەکە.""",
