...
class EnglishEntryfaulty extends StatefulWidget {
  const EnglishEntryfaulty({super.key});

  @override
  State<EnglishEntryfaulty> createState() => _EnglishEntryfaultyState();
}

class _EnglishEntryfaultyState extends State<EnglishEntryfaulty> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """faulty""",
                      // alsoEnglishWord: "also: faulty",
                      britshText: """IpaUK: faulty""",
                      americanText: """IpaUS: faulty""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Ask for a refund if the goods are faulty.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The accident was caused by a faulty signal.""");
  }
...
کوردی: بەعەیب، بەخەوش، عەیب‌دار، نیوەچڵ، ناتەواو، هەڵە، نادروست، شاش، چەوت
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) کە کێشەی تێدایە"""),
          SentencesRow(
            englishText: """Ask for a refund if the goods are faulty.""",
            kurdishText:
                """داوای قەرەبوو بکە ئەگەر کەلوپەلەکان کێشەیان هەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The accident was caused by a faulty signal.""",
            kurdishText: """ڕووداوەکە بەهۆی شەپۆلێکی هەڵەوە ڕوویدا.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I suppose her memory's a bit faulty.""",
            kurdishText: """پێموایە یادەوەریی کەمێک کێشەی هەیە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: faulty (Derived forms: faultiest, faultier)
1. Having a defect (= defective)
"I returned the appliance because it was faulty";
 
2. Characterized by errors; not agreeing with a model or not following established rules (= incorrect, wrong)
...
const String _videoIdend = 'https://youtu.be/NpBPm0b9deQ?t=';
...
const double _startSecondstwo = 000000000000000000000000000638;
const String _videoIdthree = 'https://youtu.be/wePfbUetYJI?t=';
const double _startSecondsthree = 000000000000000000000000000216;
const String _videoIdfour = 'https://youtu.be/XkYvo6S82LE?t=';
const double _startSecondsfour = 0000000000000000000000000002253;
const String _videoIdfive = 'https://youtu.be/wQSxY7TR6mI?t=';
const double _startSecondsfive = 000000000000000000000000000960;
