...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1455;
    const String videoIdone = 'UvjSXBqQe4A';
    const double startSecondsone = 378;
    const String videoIdtwo = 'H1KP4ztKK0A';
    const double startSecondstwo = 709;
    const String videoIdthree = 'VNZ0so0LCoM';
    const double startSecondsthree = 1076;
    const String videoIdfour = '7EDflnGzjTY';
    const double startSecondsfour = 173;
    const String videoIdfive = '7ziWrneMYss';
