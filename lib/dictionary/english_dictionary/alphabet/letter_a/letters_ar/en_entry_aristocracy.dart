...
class EnglishEntryaristocracy extends StatelessWidget {
  ...
  Future<void> speakaristocracy(String languageCode) async {
    ...
    await flutterTts.speak("aristocracy");
  }
  ...
  Future<void> speakaristocracy1158(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He married into the French aristocracy.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "aristocracy"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌærɪˈstɒkrəsi/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakaristocracy("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌærɪˈstɑːkrəsi/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakaristocracy("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'a2-IwnoTrOI';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'FHuQzvYA3H0';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'wYK14Fg0oAA';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'VruE3QHGKtw';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'iNl0U1KCPZQ';
