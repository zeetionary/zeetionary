...
const String _videoIdone = 'https://youtu.be/8g18jFHCLXk?t=';
const double _startSecondsone = 00000000000000000000000000066;
const String _videoIdtwo = 'https://youtu.be/mcZdTvOqmvI?t=';
const double _startSecondstwo = 000000000000000000000000000251;
const String _videoIdthree = 'https://youtu.be/1KgSp94nCZw?t=';
const double _startSecondsthree = 000000000000000000000000000477;
const String _videoIdfour = 'https://youtu.be/Gv4Af83KFrE?t=';
const double _startSecondsfour = 000000000000000000000000000314;
const String _videoIdfive = 'https://youtu.be/3C9wZf88y4Q?t=';
