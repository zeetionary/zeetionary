...
class EnglishEntrythelowerclass extends StatefulWidget {
  const EnglishEntrythelowerclass({super.key});

  @override
  State<EnglishEntrythelowerclass> createState() => _EnglishEntrythelowerclassState();
}

class _EnglishEntrythelowerclassState extends State<EnglishEntrythelowerclass> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrythelowerclass the lower class
WORD_WEB the lower class the lower class the lower class
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "the lower class";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""the lower class""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """the lower class""",
                      // alsoEnglishWord: "also: the lower class",
...
کوردی: 
"""),
// With short examples define "the lower class", please follow LX instructions
