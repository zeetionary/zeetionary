...
class EnglishEntryfirstaid extends StatefulWidget {
  const EnglishEntryfirstaid({super.key});

  @override
  State<EnglishEntryfirstaid> createState() => _EnglishEntryfirstaidState();
}

class _EnglishEntryfirstaidState extends State<EnglishEntryfirstaid> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "first aid";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""first aid""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """first aid""",
                      // alsoEnglishWord: "also: first aid",
                      britshText: """IpaUK: /ˌfɜːst ˈeɪd/""",
                      americanText: """IpaUS: /ˌfɜːrst ˈeɪd/""",
...
// With short examples define "first aid", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """At least one member of staff should be trained in first aid.""",
                      kurdishText:
                          """بەلایەنی کەمەوە یەک ئەندامی ستافەکە دەبێت ڕاهێنانی لە فریاگوزاری سەرەتایی پێ بکرێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """While one of you gives first aid, the other should call an ambulance.""",
                      kurdishText:
                          """لە کاتێکدا یەکێکتان فریاگوزاری سەرەتایی دەکات ئەوی دیکە دەبێت پەیوەندی بە ئەمبولانسەوە بکات.""",
...
const String _videoIdone = 'https://youtu.be/Z36OznHFIt4?t=';
const double _startSecondsone = 000000000000000000000000000330;
const String _videoIdtwo = 'https://youtu.be/tCqwT2MqLxI?t=';
const double _startSecondstwo = 0000000000000000000000000001130;
const String _videoIdthree = 'https://youtu.be/qjubq284yVk?t=';
const double _startSecondsthree = 000000000000000000000000000280;
const String _videoIdfour = 'https://youtu.be/5QOOrKY_aJ0?t=';
const double _startSecondsfour = 000000000000000000000000000512;
const String _videoIdfive = 'https://youtu.be/NZLbTuBDhJg?t=';
const double _startSecondsfive = 0000000000000000000000000001277;
