...
class EnglishEntrygravely extends StatefulWidget {
  const EnglishEntrygravely({super.key});

  @override
  State<EnglishEntrygravely> createState() => _EnglishEntrygravelyState();
}

class _EnglishEntrygravelyState extends State<EnglishEntrygravely> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: gravely
1. In a grave and sober manner (- soberly, staidly)
"he walked gravely toward the altar";
 
2. To a severe or serious degree (- badly, severely, seriously, critically)
"is gravely ill";
""",
  );

  final String keyword = "gravely";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gravely""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She is gravely ill.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Local people are gravely concerned.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gravely""",
                      // alsoEnglishWord: "also: gravely",
                      britshText: """IpaUK: /ˈɡreɪvli/""",
                      americanText: """IpaUS: /ˈɡreɪvli/""",
...
// With short examples define "gravely", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Local people are gravely concerned.""",
                      kurdishText: """خەڵکە خۆجێییەکە بەجدی نیگەرانن.""",
...
const String _videoIdone = 'https://youtu.be/zJU_Bp-Yp1c?t=';
const double _startSecondsone = 000000000000000000000000000324;
const String _videoIdtwo = 'https://youtu.be/DHbkuHJ4GV8?t=';
const double _startSecondstwo = 00000000000000000000000000094;
const String _videoIdthree = 'https://youtu.be/KSuYDQ7tFEk?t=';
const double _startSecondsthree = 000000000000000000000000000381;
const String _videoIdfour = 'https://youtu.be/NFyjp98azjU?t=';
const double _startSecondsfour = 000000000000000000000000000664;
const String _videoIdfive = 'https://youtu.be/BusdooE10vQ';
