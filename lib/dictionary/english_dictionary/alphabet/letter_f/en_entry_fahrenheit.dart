...
class EnglishEntryfahrenheit extends StatefulWidget {
  const EnglishEntryfahrenheit({super.key});

  @override
  State<EnglishEntryfahrenheit> createState() => _EnglishEntryfahrenheitState();
}

class _EnglishEntryfahrenheitState extends State<EnglishEntryfahrenheit> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""Fahrenheit""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """Fahrenheit""",
                      // alsoEnglishWord: "also: Fahrenheit",
                      britshText: """IpaUK: /ˈfærənhaɪt/""",
                      americanText: """IpaUS: /ˈfærənhaɪt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "Fahrenheit";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was 80°F in the shade.""");
  }
...
1. of or using a scale of temperature in which water freezes at 32° and boils at 212°
...
const String _videoIdthree = 'https://youtu.be/Rzd0mLf366I?t=';
const double _startSecondsthree = 000000000000000000000000000142;
const String _videoIdfour = 'https://youtu.be/vzKuobmi3iI?t=';
