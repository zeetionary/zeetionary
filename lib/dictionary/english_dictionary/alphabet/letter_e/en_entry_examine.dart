...
class EnglishEntryexamine extends StatefulWidget {
  const EnglishEntryexamine({super.key});

  @override
  State<EnglishEntryexamine> createState() => _EnglishEntryexamineState();
}

class _EnglishEntryexamineState extends State<EnglishEntryexamine> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""examine""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """examine""",
                      // alsoEnglishWord: "also: examine",
                      britshText: """IpaUK: /ɪɡˈzæmɪn/""",
                      americanText: """IpaUS: /ɪɡˈzæmɪn/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""This important issue must be carefully examined.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She examined herself closely in the mirror.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The goods were examined for damage on arrival.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Investigators examined the room minutely for clues.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""You are only being examined on this semester's work.""");
  }
...
کوردی: ئەزموون کردن، تاقی کردنەوە، پشکنین، پشکنینی لەش
"""),
          const DefinitionKurdish(
              text: """١. (کردار) وردبوونەوە لە بیرۆکەیەک، بابەتێک، هتد"""),
          SentencesRow(
            englishText:
                """This study sets out to examine in detail the possible effects of climate change.""",
            kurdishText:
                """توێژینەوەکە هەوڵ دەدات بە وردی بکۆڵێتەوە لە کاریگەرییە ڕێتێچووەکانی گۆڕانی ئاووهەوا.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """This important issue must be carefully examined.""",
            kurdishText:
                """ئەم بابەتە گرنگە دەبێت بە وریاییەوە لێی بکۆڵدرێتەوە.""",
          ...
          SentencesRow(
            englishText:
                """Only recently have historians begun to examine the impact and influence of these changes.""",
            kurdishText:
                """تەنها تازەگی مێژوونووسان دەستیان کردووە بە لێکۆڵینەوە لە کاریگەریی ئەم گۆڕانانە.""",
          ...
          SentencesRow(
            englishText:
                """It is necessary to examine how the proposals can be carried out.""",
            kurdishText:
                """پێویستە کە لێکۆڵینەو لەوە بکرێت چۆن پێشنیارەکان دەکرێت جێبەجێ بکردرێن.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) پشکنینی کەسێک/شتێک و دۆزینەوەی هەر کێشەیەک ئەگەر هەبێت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The doctor examined her carefully but could find nothing wrong.""",
            kurdishText:
                """پزیشکەکە بە وریایی پشکنی بەڵام نەیتوانی هیچی هەڵە بدۆزێتەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She examined herself closely in the mirror.""",
            kurdishText: """بە وردی لە خۆی ڕوانی لە ئاوێنەکە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The goods were examined for damage on arrival.""",
            kurdishText: """لەگەڵ گەشتن کەلوپەلەکان بۆ زیان پشکندران.""",
          ...
          SentencesRow(
            ...
            kurdishText: """لێکۆڵەران بە وردی ژوورەکەیان پشکنی بۆ سەرەداو.""",
          ...
          SentencesRow(
            englishText:
                """The students will be examined in all subjects at the end of term.""",
            kurdishText:
                """لە کۆتایی خولەکە خوێندکاران بۆ هەموو بابەتەکان تاقی دەکرێنەوە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """تەنها بۆ بابەتی ئەم وەرزە تاقی دەکرێیتەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: examine (Derived forms: examining, examines, examined)
1. Consider in detail and subject to an analysis in order to discover essential features or meaning (= analyze [N. Amer], analyse [Brit, Cdn], study, canvass)
"examine a sonnet by Shakespeare";
 
2. Observe, check out, and look over carefully or inspect (= see)
"The customs agent examined the baggage";
 
3. Investigate thoroughly to see if true (= probe)
 
4. Ask questions as a test of knowledge
 
5. Put to the test, as for its quality, or give experimental use to (= test, prove, try, try out, essay, trial)
"examine this recipe";
""",
  );
...
const double _startSecondsend = 000000000000000000000000000000; // 166;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/kTaYet07Ioo?t=';
const double _startSecondsone = 00000000000000000000000000000; // 702;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 69;
const String _videoIdthree = 'VIDEOhttps://youtu.be/qg2nGY1aqlg?t=';
const double _startSecondsthree = 000000000000000000000000000; // 952;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/CURLWPCxe-c?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 343;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/cMBrvHsFD_8?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 100;
