...
// With short examples define "flicker", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تەنها کاردانەوەی پرتەیەکی چاوانی بوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٦. (ناو) هەستێک کە بۆ ماوەیەکی کەم بەردەوام دەبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """A flicker of guilt crossed his face.""",
                      kurdishText:
                          """هەستێکی کورتی تاوانباری بە ڕوخساریدا تێپەڕی..""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەستی بە ساتێکی کورت لە بەخیلی کرد.""",
...
const double _startSecondsend = 0000000000000000000000000001120;
