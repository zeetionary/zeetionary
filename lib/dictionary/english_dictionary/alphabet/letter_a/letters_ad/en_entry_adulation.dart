...
class EnglishEntryadulation extends StatelessWidget {
  EnglishEntryadulation({super.key});
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "adulation"), // Find /ˌædjuˈleɪʃn/
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌædjuˈleɪʃn/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakadulation("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌædʒəˈleɪʃn/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakadulation("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'nG3NNWESpCU';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'rr6OfJlQe0c';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '99NA0m6FZRA';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'VgcrUfGZq-c';
