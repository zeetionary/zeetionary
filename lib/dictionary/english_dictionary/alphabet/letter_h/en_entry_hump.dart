...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 0000000000000000000000000001296;
    const String videoIdtwo = 'https://youtu.be/oyM_AXN_QNI?t=';
    const double startSecondstwo = 00000000000000000000000000013;
    const String videoIdthree = 'https://youtu.be/NKof472Gquo?t=';
    const double startSecondsthree = 0000000000000000000000000008;
    const String videoIdfour = 'https://youtu.be/BAHvSVNGQKk?t=';
    const double startSecondsfour = 0000000000000000000000000007;
    const String videoIdfive = 'https://youtu.be/cJugV-Pc5z0';
