...
class EnglishEntryencyclopedia extends StatefulWidget {
  const EnglishEntryencyclopedia({super.key});

  @override
  State<EnglishEntryencyclopedia> createState() =>
      _EnglishEntryencyclopediaState();
}

class _EnglishEntryencyclopediaState extends State<EnglishEntryencyclopedia> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("encyclopedia");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "encyclopedia",
                      // alsoEnglishWord: "also: encyclopedia",
                      britshText: "IpaUK: /ɪnˌsaɪkləˈpiːdiə/",
                      americanText: "IpaUS: /ɪnˌsaɪkləˈpiːdiə/",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "encyclopedia";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I looked the Civil War up in my encyclopedia.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("There are over 20 000 entries in the encyclopedia.");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The man is a walking encyclopedia.");
  }
...
کوردی: ئینسایکلۆپیدیا، زانست‌نامە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کتێبێک یان کۆمەڵە کتێبێک کە زانیاری دەدات لەسەر هەموو بوارەکانی زانیاری یان لەسەر یەک بوار"""),
          SentencesRow(
            englishText: """I looked the Civil War up in my encyclopedia.""",
            kurdishText: """بۆ شەڕی ناوخۆ گەڕام لە زانست‌نامەکەم.""",
          ...
          SentencesRow(
            ...
            kurdishText: """٢٠٠٠٠ سەروشە هەیە لە ئینسایکلۆپیدیایەکە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """(خوازراوی) پیاوەکە ئینسایکلۆپیدیاکە لەسەر دوو پێ.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: encyclopedia (Derived forms: encyclopedias)
1. A reference work (often in several volumes) containing articles on various topics (often arranged in alphabetical order) dealing with the entire range of human knowledge or with some particular speciality (= cyclopedia [archaic], encyclopaedia [Brit], cyclopaedia [archaic])
""",
  );
...
const String _videoIdend = 'https://youtu.be/okAAL53Rj_0?t=';
const double _startSecondsend = 695;
const String _videoIdone = 'https://youtu.be/QcUey-DVYjk?t=';
const double _startSecondsone = 1829;
const String _videoIdtwo = 'https://youtu.be/UOc7xdRhAAY?t=';
const double _startSecondstwo = 104;
const String _videoIdthree = 'https://youtu.be/XeHl5Y7m1xM?t=';
...
const String _videoIdfive = 'https://youtu.be/0n89GZvmeXI?t=';
const double _startSecondsfive = 91;
const String _videoIdsix = 'https://youtu.be/b_rjBWmc1iQ?t=';
const double _startSecondssix = 3033;
