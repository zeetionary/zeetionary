...
class EnglishEntryhighereducation extends StatefulWidget {
  const EnglishEntryhighereducation({super.key});

  @override
  State<EnglishEntryhighereducation> createState() => _EnglishEntryhighereducationState();
}

class _EnglishEntryhighereducationState extends State<EnglishEntryhighereducation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: higher education (Derived forms: higher educations)
1. Education provided by a college or university
""",
  );

  final String keyword = "higher education";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""higher education""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Will she go on to higher education?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: higher education",
                      britshText: """IpaUK: /ˌhaɪər edʒuˈkeɪʃn/""",
                      americanText: """IpaUS: /ˌhaɪər edʒuˈkeɪʃn/""",
...
// With short examples define "higher education", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) خوێندن لە زانکۆ، بە تایبەتی بۆ بڕوانامە"""),
                    SentencesRow(
                      englishText: """Will she go on to higher education?""",
                      kurdishText: """دەچێتە خوێندنی زانکۆ؟""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/6DYgImG1CKo?t=';
const double _startSecondsend = 000000000000000000000000000732;
const String _videoIdone = 'https://youtu.be/E37swnRU2fs?t=';
const double _startSecondsone = 000000000000000000000000000130;
const String _videoIdtwo = 'https://youtu.be/v-eLrAw-gGc?t=';
...
const String _videoIdfour = 'https://youtu.be/BBnlC9lrKVM?t=';
const double _startSecondsfour = 000000000000000000000000000424;
const String _videoIdfive = 'https://youtu.be/PkJlTKUaF3Q?t=';
