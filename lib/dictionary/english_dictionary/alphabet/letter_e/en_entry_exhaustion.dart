...
class EnglishEntryexhaustion extends StatefulWidget {
  const EnglishEntryexhaustion({super.key});

  @override
  State<EnglishEntryexhaustion> createState() => _EnglishEntryexhaustionState();
}

class _EnglishEntryexhaustionState extends State<EnglishEntryexhaustion> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exhaustion""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exhaustion""",
                      // alsoEnglishWord: "also: exhaustion",
                      britshText: """IpaUK: /ɪɡˈzɔːstʃən/""",
                      americanText: """IpaUS: /ɪɡˈzɔːstʃən/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exhaustion";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Never had she felt such utter exhaustion.""");
  }
...
کوردی: لەپێکەوتن، زۆرماندوویی، ڕەتان، شەکەتی،	هەڵچۆڕان، لەبن‌هاتن، تەواوبوون، بەکارهێنران، لەبن‌هێنان، خلاس‌بوون، دواهاتن، تەواوکردن، بەتاڵ‌کردن
"""),
          const DefinitionKurdish(text: """١. (ناو) ماندوویەتی زۆر"""),
          SentencesRow(
            englishText: """Never had she felt such utter exhaustion.""",
            kurdishText: """هەرگیز هەستی بە ماندوویەتی وەها زۆر نەکردبوو.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Two of the horses collapsed with exhaustion.""",
            kurdishText: """دوو لە ئەسپەکان لە مادوویەتیدا کەوتن بە زەویدا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: exhaustion (Derived forms: exhaustions)
1. Extreme fatigue
 
2. Serious weakening and loss of energy (= debilitation, enervation, enfeeblement)
...
const double _startSecondsend = 000000000000000000000000000000; // 622;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/q8HRGiUeZwc?t=';
const double _startSecondsone = 00000000000000000000000000000; // 52;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/L87HuKmGwVQ?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 719;
const String _videoIdthree = 'VIDEOhttps://youtu.be/H5_HVUS1l0Y?t=';
const double _startSecondsthree = 000000000000000000000000000; // 680;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/nd5--EqzLPY?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 683;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/UrkPC81_QfU?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 334;
