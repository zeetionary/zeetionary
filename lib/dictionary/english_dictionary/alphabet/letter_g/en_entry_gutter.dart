...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The blocked gutter was filled with leaves and debris.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She rose from the gutter to become a great star.""");
  }
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """The blocked gutter was filled with leaves and debris.""",
                      kurdishText:
                          """ئاوەڕۆ گیراوەکە پڕبوو لە گەڵا و پاشماوە.""",
