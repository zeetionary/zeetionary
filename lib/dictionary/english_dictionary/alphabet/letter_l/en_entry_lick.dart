...
class EnglishEntrylick extends StatefulWidget {
  const EnglishEntrylick({super.key});

  @override
  State<EnglishEntrylick> createState() => _EnglishEntrylickState();
}

class _EnglishEntrylickState extends State<EnglishEntrylick> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: lick (Derived forms: licking, licks, licked)
1. Pass the tongue over (- lap)
"the dog licked her hand";
 
2. Take up with the tongue (- lap, lap up)
"the cub licked the milk from its mother's breast";
 
3. [informal] Beat thoroughly and conclusively in a competition or fight (- cream [informal], bat, clobber [informal], drub, thrash [informal], marmalise [Brit, informal], marmelize [Brit, informal], marmelise [Brit, informal], wipe the floor [informal], paste [informal], beat hollow [informal], whale [N. Amer, informal], marmalize [Brit, informal], smoke [N. Amer, informal], hammer [informal], muller [Brit, informal], blow away [informal], slaughter [informal], tromp [N. Amer, informal], trounce)
"We licked the other team on Sunday!";
 
4. [N. Amer, informal] Find the solution to (a problem or question) or understand the meaning of (- solve, work out, figure out, puzzle out, work, suss [Brit, informal], suss out [Brit, informal], unriddle)
"did you lick the problem?";

- Noun: lick (Derived forms: licks)
1. A salt deposit that animals regularly lick (- salt lick)
 
2. Touching with the tongue (- lap)
 
3. (boxing) a blow with the fist (- punch, clout, poke, biff [informal], slug, dong [Austral, NZ, informal])
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He licked his fingers.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The cat sat licking its paws.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She licked the spoon clean.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The cat licked up the milk.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She licked the honey off the spoon.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Flames were soon licking the curtains.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We thought we had them licked.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Can I have a lick of your ice cream?""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What this room needs is a lick of paint.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/qAlPTMceE8E?t=49';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/w0a07NySt6I?t=394';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/WVxz2j4_skI?t=63';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/IgI8_npvjkI?t=1174';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/H9rO5sKzOiQ?t=163';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/3QtsTmVTHyQ?t=1156';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lick""",
                      // alsoEnglishWord: "also: lick",
                      britshText: """IpaUK: /lɪk/""",
                      americanText: """IpaUS: /lɪk/""",
...
کوردی: لستنەوە، لێسانەوە، زمان‌پیاهێنان، جێگای لستنەوە، لێسایی،	بڕێکی کەم، خێرایی
"""),
// With short examples define "lick", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) هێنانی زمان بەسەر ڕووی شتێکدا بۆ تامکردنی، تەڕکردنی، یان پاککردنەوەی"""),
                    SentencesRow(
                      englishText: """He licked his fingers.""",
                      kurdishText: """پەنجەیی لێسایەوە.""",
                    ...
                    SentencesRow(
                      englishText: """The cat sat licking its paws.""",
                      kurdishText: """پشیلەکانی دانیشت چنگەکانیی دەلێسایەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She licked the spoon clean.""",
                      kurdishText: """کەوچکەکەی بە لێسانەوە پاککردەوە.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) خواردن یان خواردنەوەی شتێک بە لێسانەوەی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The cat licked up the milk.""",
                      kurdishText: """پشیلەکە شیرەکەی لێسایەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She licked the honey off the spoon.""",
                      kurdishText: """هەنگوینەکەی بە کەوچکەکەوە لێسایەوە.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) دەستدان لە شتێک بە سووکی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Flames were soon licking the curtains.""",
                      kurdishText: """هرزوو بڵێسە بەر پەردەکان کەوت.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) بە ئاسانی شکستهێنان بە کەسێک یان مامەڵەکردن لەگەڵ شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We thought we had them licked.""",
                      kurdishText: """وامان بیکردەوە تێکمان شکاندوون.""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (ناو) ئەوەی شتێک بە زمان بلێسیتەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Can I have a lick of your ice cream?""",
                      kurdishText: """دەتوانم ئایس کرێمەکەت بلێسمەوە؟""",
                      onPressedBritish: () => speaksentence8("en-GB"),
                      onPressedAmerican: () => speaksentence8("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٦. (ناو) کەمێک بۆیە بۆ جوانترکردنی شوێنێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """What this room needs is a lick of paint.""",
                      kurdishText: """ئەوەی ئەم ژوورە پێویستییەتی بڕێک بۆیەیە.""",
