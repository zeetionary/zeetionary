...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '29n2bv7F6uc';
    const double startSecondsend = 72;
    const String videoIdone = 'jcM_Nd9xWeA';
    const double startSecondsone = 487;
    const String videoIdtwo = 'o5Q0sEeYNU4';
    const double startSecondstwo = 1228;
    const String videoIdthree = 'bJMh-nQ5r_0';
    const double startSecondsthree = 568;
    const String videoIdfour = 'QLNCl3dBqG8';
    const double startSecondsfour = 1587;
    const String videoIdfive = 'bJMh-nQ5r_0';
