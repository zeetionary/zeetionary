...
class EnglishEntrygroundless extends StatefulWidget {
  const EnglishEntrygroundless({super.key});

  @override
  State<EnglishEntrygroundless> createState() => _EnglishEntrygroundlessState();
}

class _EnglishEntrygroundlessState extends State<EnglishEntrygroundless> {
  @override
  void initState() {
    super.initState();
...
1. Without a basis in reason or fact (- baseless, idle, unfounded, unwarranted, wild)
"the allegations proved groundless";
""",
  );

  final String keyword = "groundless";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""groundless""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Our fears proved groundless.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Their suspicions were dismissed as groundless.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """groundless""",
                      // alsoEnglishWord: "also: groundless",
                      britshText: """IpaUK: /ˈɡraʊndləs/""",
                      americanText: """IpaUS: /ˈɡraʊndləs/""",
...
کوردی: لەخۆوە، لەخۆڕایی، بی‌بنچینە، بێ‌هۆ، هیچ
"""),
// With short examples define "groundless", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە پشتی بە هیچ هۆکار یان بەڵگە نەبەستووە"""),
                    SentencesRow(
                      englishText: """Our fears proved groundless.""",
                      kurdishText: """ترسەکانمان بێ‌هۆکار دەرچوون.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Their suspicions were dismissed as groundless.""",
                      kurdishText: """گومانەکانیان وەک لەخۆڕایی دانران.""",
...
const double _startSecondsend = 0000000000000000000000000009194;
const String _videoIdone = 'https://youtu.be/b0BC3F0kqtw?t=';
const double _startSecondsone = 000000000000000000000000000278;
const String _videoIdtwo = 'https://youtu.be/Uh9xSA2gOZQ?t=';
const double _startSecondstwo = 000000000000000000000000000577;
const String _videoIdthree = 'https://youtu.be/XSlgzpPfJuI?t=';
const double _startSecondsthree = 000000000000000000000000000165;
const String _videoIdfour = 'https://youtu.be/Yygzd9-nwuY?t=';
const double _startSecondsfour = 000000000000000000000000000379;
const String _videoIdfive = 'https://youtu.be/Wfk4KmkbAfM?t=';
const double _startSecondsfive = 000000000000000000000000000352;
