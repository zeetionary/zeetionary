...
class EnglishEntryinter extends StatefulWidget {
  const EnglishEntryinter({super.key});

  @override
  State<EnglishEntryinter> createState() => _EnglishEntryinterState();
}

class _EnglishEntryinterState extends State<EnglishEntryinter> {
  @override
  void initState() {
    super.initState();
