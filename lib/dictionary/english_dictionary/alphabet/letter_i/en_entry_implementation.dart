...
class EnglishEntryimplementation extends StatefulWidget {
  const EnglishEntryimplementation({super.key});

  @override
  State<EnglishEntryimplementation> createState() =>
      _EnglishEntryimplementationState();
}

class _EnglishEntryimplementationState
    extends State<EnglishEntryimplementation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: implementation (Derived forms: implementations)
1. The act of accomplishing some aim or executing some order (- execution, carrying out)
"the agency was created for the implementation of the policy";
 
2. The act of implementing (providing a practical means for accomplishing something); carrying into effect (- effectuation)
""",
  );

  final String keyword = "implementation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""implementation""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/TnkdoEZhTbc?t=';
    const double startSecondsend = 000000000000000000000000000359;
    const String videoIdone = 'https://youtu.be/BuaKzm7Kq9Q?t=';
    const double startSecondsone = 000000000000000000000000000925;
    const String videoIdtwo = 'https://youtu.be/UShsgCOzER4?t=';
    const double startSecondstwo = 000000000000000000000000000590;
    const String videoIdthree = 'https://youtu.be/DxREm3s1scA?t=';
    const double startSecondsthree = 0000000000000000000000000002617;
    const String videoIdfour = 'https://youtu.be/iQ5GfDbjos8?t=';
    const double startSecondsfour = 000000000000000000000000000488;
    const String videoIdfive = 'https://youtu.be/b1JlYZQG3lI?t=';
    const double startSecondsfive = 000000000000000000000000000992;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """implementation""",
                      // alsoEnglishWord: "also: implementation",
                      britshText: """IpaUK: /ˌɪmplɪmenˈteɪʃn/""",
                      americanText: """IpaUS: /ˌɪmplɪmenˈteɪʃn/""",
...
کوردی: جێبەجێ‌کردن، ڕاپەڕاندن، کردن، بەجێ‌هێنان، هێنانەدی، پیادەکردن، ئەنجام‌دان
"""),
// With short examples define "implementation", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە شتێک کە بڕیاری لێدراوە بخەیتە کار"""),
                    SentencesRow(
                      englishText:
                          """The airy promises proved empty in practical implementation.""",
                      kurdishText:
