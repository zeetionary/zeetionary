...
class EnglishEntrylasting extends StatefulWidget {
  const EnglishEntrylasting({super.key});

  @override
  State<EnglishEntrylasting> createState() => _EnglishEntrylastingState();
}

class _EnglishEntrylastingState extends State<EnglishEntrylasting> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lasting""");
  }
