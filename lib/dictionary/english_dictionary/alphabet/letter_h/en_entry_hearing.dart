...
""",
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""An appeal hearing is scheduled for later this month.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His views may be unfashionable but he deserves a hearing.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""At least give our ideas a fair hearing before you reject them.""");
  }
...
کوردی: هەستی بیستن،	بیستن، ژنەفتن،	دەنگاوێژ، ماوەبڕی دەنگ، دەنگ‌بڕ،	دەرفەتی ڕادەربڕین، هەل یا بواری قسەکردن،	گوێ‌لێ‌ڕاگرتن، دادگەری، دادپرسی
"""),
// With short examples define "hearing", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تەقینەوەکە زیانی بە توانای بیستنی گەیاند.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەستی کرد بە لە دەستدانی توانای بیستنی.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) کۆبوونەوەیەکی فەرمی کە تێیدا گوێ لە ڕاستییەکانی کەیسێک دەگیردرێت بۆ بڕیاردان"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """An appeal hearing is scheduled for later this month.""",
                      kurdishText: """دانیشتنێکی تانەدان ڕێکخراوە بۆ کۆتایی ئەم مانگە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Protesters are calling for a public hearing.""",
                      kurdishText: """خۆپیشاندەران داوای دانیشتنی گشتی دەکەن.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) هەلێک بۆ ڕوونکردنەوەی کارەکانت، بیرۆکەکانت، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """His views may be unfashionable but he deserves a hearing.""",
                      kurdishText: """دیدەکانی ڕەنگە ناباو بن بەڵام شایەنی بیستنن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """At least give our ideas a fair hearing before you reject them.""",
                      kurdishText: """بە لایەنی کەمەوە گوێگرتنێکی بدە بە بیرۆکەکانمان پێش ئەوەی ڕەتیان بکەیتەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/udI0QnkMRi4?t=';
const double _startSecondsend = 000000000000000000000000000537;
const String _videoIdone = 'https://youtu.be/KGqexebCcUo?t=';
const double _startSecondsone = 000000000000000000000000000206;
const String _videoIdtwo = 'https://youtu.be/98Njh9UmkxU?t=';
const double _startSecondstwo = 0000000000000000000000000001480;
const String _videoIdthree = 'https://youtu.be/FCZ06Sfr9Cg?t=';
const double _startSecondsthree = 000000000000000000000000000689;
const String _videoIdfour = 'https://youtu.be/QKIobyk6Isc?t=';
const double _startSecondsfour = 000000000000000000000000000678;
const String _videoIdfive = 'https://youtu.be/zVlmQx36Sh4?t=';
const double _startSecondsfive = 000000000000000000000000000385;
