...
class EnglishEntryextraordinarily extends StatefulWidget {
  const EnglishEntryextraordinarily({super.key});

  @override
  State<EnglishEntryextraordinarily> createState() =>
      _EnglishEntryextraordinarilyState();
}

class _EnglishEntryextraordinarilyState
    extends State<EnglishEntryextraordinarily> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extraordinarily""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: extraordinarily",
                      britshText: """IpaUK: /ɪkˈstrɔːdnrəli/""",
                      americanText: """IpaUS: /ɪkˈstrɔːdnrəli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extraordinarily";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He behaves extraordinarily for someone in his position.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She did extraordinarily well.""");
  }
...
// With short examples define "extraordinarily", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          ...
          SentencesRow(
            ...
            kurdishText:
                """بە ئاستێکی نائاسایی ڕەفتار دەکات بۆ کەسێک کە لە پێگەکەی دایە.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            englishNote:
                "This means he acts in a very unusual and surprising way, which is not typical or expected for someone who has his job or holds his level of authority or responsibility.",
...
1. To a surprising degree (= inordinately)
...
const double _startSecondsend = 0000000000000000000000000001229;
const String _videoIdone = 'https://youtu.be/_iz5_DuY_II?t=';
const double _startSecondsone = 000000000000000000000000000415;
const String _videoIdtwo = 'https://youtu.be/iI48g7YTZFA?t=';
const double _startSecondstwo = 000000000000000000000000000532;
const String _videoIdthree = 'https://youtu.be/TRGHIN2PGIA?t=';
const double _startSecondsthree = 000000000000000000000000000766;
const String _videoIdfour = 'https://youtu.be/ndqjxhi7uZs?t=';
const double _startSecondsfour = 000000000000000000000000000363;
const String _videoIdfive = 'https://youtu.be/x6a4hMyiwBo?t=';
const double _startSecondsfive = 000000000000000000000000000816;
