...
class EnglishEntryforwardness extends StatefulWidget {
  const EnglishEntryforwardness({super.key});

  @override
  State<EnglishEntryforwardness> createState() =>
      _EnglishEntryforwardnessState();
}

class _EnglishEntryforwardnessState extends State<EnglishEntryforwardness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forwardness
1. Offensive boldness and assertiveness (= bumptiousness, cockiness, pushiness)
 
2. An advanced stage
"the forwardness of the harvest this year"; "the arts are in no kind of forwardness in this matter"
 
3. Prompt willingness (= readiness, eagerness, zeal)
"he tried to explain his forwardness in battle";
""",
  );

  final String keyword = "forwardness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forwardness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """His forwardness in asking for a promotion surprised his manager.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forwardness""",
                      // alsoEnglishWord: "also: forwardness",
                      britshText: """IpaUK: /ˈfɔːwədnəs/""",
                      americanText: """IpaUS: /ˈfɔːrwərdnəs/""",
...
کوردی: ڕووداری، ڕووهەڵماڵراوی، بێ‌شەرمی
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕەفتارێک کە متمانەبەخۆیی یان نافەرمییەتی زۆری تێدایە"""),
                    SentencesRow(
                      englishText:
                          """His forwardness in asking for a promotion surprised his manager.""",
                      kurdishText:
                          """ڕووداریی ئەوەی کە داوای پلەبەرزکردنەوە بکات بەڕێوەبەرەکەی سەرسام کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/cvrYEJ4gG8U?t=';
const double _startSecondsend = 000000000000000000000000000166;
const String _videoIdone = 'https://youtu.be/keSkvlvrtag?t=';
const double _startSecondsone = 000000000000000000000000000997;
const String _videoIdtwo = 'https://youtu.be/3tCWWnXicC0?t=';
const double _startSecondstwo = 000000000000000000000000000789;
const String _videoIdthree = 'https://youtu.be/23IPdgjjkME?t=';
const double _startSecondsthree = 000000000000000000000000000188;
const String _videoIdfour = 'https://youtu.be/fK0SrE-zQnw?t=';
const double _startSecondsfour = 000000000000000000000000000218;
const String _videoIdfive = 'https://youtu.be/nQ16ysYPGIA?t=';
const double _startSecondsfive = 00000000000000000000000000073;
