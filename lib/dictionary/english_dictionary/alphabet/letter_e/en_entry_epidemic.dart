...
class EnglishEntryepidemic extends StatefulWidget {
  const EnglishEntryepidemic({super.key});

  @override
  State<EnglishEntryepidemic> createState() => _EnglishEntryepidemicState();
}

class _EnglishEntryepidemicState extends State<EnglishEntryepidemic> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""epidemic""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """epidemic""",
                      // alsoEnglishWord: "also: epidemic",
                      britshText: """IpaUK: /ˌepɪˈdemɪk/""",
                      americanText: """IpaUS: /ˌepɪˈdemɪk/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Poverty in this country has reached epidemic proportions.""");
  }
...
کوردی: نەخۆشی پەتایی، نەخۆشی درمی، درم، پەتا، کولک، پەژیک،	بڵاوبوونەوە، تەنینەوە، باوبوون، بەبڕەوی، پەتائاسا، پەتایی، درم‌ئاسا
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) حاڵەتێکی زۆری تووشبوون بە نەخۆشییەک کە پێکەوە لە کۆمەڵگەیەکی دیاریکراودا ڕوودەدات"""),
          SentencesRow(
            englishText:
                """An epidemic of measles broke out, and over 200 children died.""",
            kurdishText: """پەتایەکی سوورێژە ڕوویدا و سەروو ٢٠٠ منداڵ مردن.""",
          ...
          SentencesRow(
            englishText:
                """Over fifty people died during the flu epidemic last winter.""",
            kurdishText:
                """سەروو ٥٠ کەس مردن لە دەمی پەتای هەڵامەت لە زستانی ڕابردوو.""",
          ...
          SentencesRow(
            englishText:
                """A recent report describes an epidemic of crime in the city.""",
            kurdishText:
                """ڕاپۆرتێکی تازە باس لە تەشەنەسەندنی تاوان دەکات لە شارەکە.""",
          ...
          const DefinitionKurdish(
              text:
                  """٣. (هاوەڵناو) کە زۆر ڕوودەدات و کاریگەری لەسەر زۆر کەس دەبێت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Poverty in this country has reached epidemic proportions.""",
            kurdishText: """هەژاری لەم وڵاتە گەشتووە بە ئاستی زۆر بەرز.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Crime and poverty are epidemic in the city.""",
            kurdishText: """تاوان و هەژاری بەربڵاون لە شارەکە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: epidemic (Derived forms: epidemics)
...
const double _startSecondsend = 000000000000000000000000000000; // 173;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/b1reY72ktEc?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1232;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/p3O6bKdPLbw?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 3205;
const String _videoIdthree = 'VIDEOhttps://youtu.be/S3ksC_8jGuc?t=';
const double _startSecondsthree = 000000000000000000000000000; // 361;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/LXhLlWQtdt0?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 107;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/T-_HKFjxVl0?t=';
