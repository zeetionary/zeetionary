...
class EnglishEntryfinding extends StatefulWidget {
  const EnglishEntryfinding({super.key});

  @override
  State<EnglishEntryfinding> createState() => _EnglishEntryfindingState();
}

class _EnglishEntryfindingState extends State<EnglishEntryfinding> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: finding (Derived forms: findings)
1. The act of determining the properties of something, usually by research or calculation (= determination)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""finding""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The court made a finding in favour of the defendant.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """finding""",
                      // alsoEnglishWord: "also: finding",
                      britshText: """IpaUK: /ˈfaɪndɪŋ/""",
                      americanText: """IpaUS: /ˈfaɪndɪŋ/""",
...
// With short examples define "finding", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Our research findings indicate that pregnant women benefit from this treatment.""",
                      kurdishText:
                          """دۆزینەوەکانی توێژینەوەکەمان ئەوە پیشان دەدات ژنانی دووگیان سوود لەم چارەسەرە دەبینن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """These findings suggest that there is no direct link between unemployment and crime.""",
                      kurdishText:
                          """ئەم دۆزینەوانە دەری دەخەن هیچ پەیوەندیی ڕاستەوخۆ لە نێوان بێ‌کاری و تاوان نییە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دادگاکەکە لە بەرژەوەندیی تاوانبارکراو بڕیاری دا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/CaaJyRvvaq8?t=';
const double _startSecondsend = 00000000000000000000000000095;
const String _videoIdone = 'https://youtu.be/G3pJOg1MJuo?t=';
const double _startSecondsone = 000000000000000000000000000308;
const String _videoIdtwo = 'https://youtu.be/1afpDuTb-P0?t=';
const double _startSecondstwo = 00000000000000000000000000069;
const String _videoIdthree = 'https://youtu.be/YyFhQ525tZk?t=';
const double _startSecondsthree = 000000000000000000000000000261;
const String _videoIdfour = 'https://youtu.be/wlbO-DyxwYA?t=';
const double _startSecondsfour = 0000000000000000000000000001063;
const String _videoIdfive = 'https://youtu.be/RTOuKWojGss?t=';
const double _startSecondsfive = 000000000000000000000000000249;
