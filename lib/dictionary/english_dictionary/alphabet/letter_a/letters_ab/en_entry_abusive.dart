...
// replace these: EnglishEntryabusive - speakAbusive - abusive - /əˈbjuːsɪv/

enum TtsState { playing }

class EnglishEntryabusive extends StatelessWidget {
  EnglishEntryabusive({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAbusive(String languageCode) async {
    // DOPSUM: CHANGE speakAbusive
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("abusive"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakA1574(String languageCode) async {
    ...
    await flutterTts.speak(
        "After many years in an abusive relationship, she left her husband."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAb582(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("He became abusive when he was drunk."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'abusive', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈbjuːsɪv/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '8pdXHVbbPWo';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'fpf0dbF0CFk';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'GxLwDHjIp4c';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = '_P1zYEq4PHg';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'cw5gCoIbUbg';
