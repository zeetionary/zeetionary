...
class EnglishEntrygiddiness extends StatefulWidget {
  const EnglishEntrygiddiness({super.key});

  @override
  State<EnglishEntrygiddiness> createState() => _EnglishEntrygiddinessState();
}

class _EnglishEntrygiddinessState extends State<EnglishEntrygiddiness> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "giddiness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""giddiness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Symptoms include nausea and giddiness.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His childlike excitement verged on giddiness.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """giddiness""",
                      // alsoEnglishWord: "also: giddiness",
                      britshText: """IpaUK: /ˈɡɪdinəs/""",
                      americanText: """IpaUS: /ˈɡɪdinəs/""",
...
// With short examples define "giddiness", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ھەستی ئەوەی ھەموو شتێک دەسووڕێتەوە ناتوانیت ھاوسەنگی ڕابگریت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: dizziness"),
                    SentencesRow(
                      englishText: """Symptoms include nausea and giddiness.""",
                      kurdishText: """نیشانەکان دڵ‌تێکهەڵاتن و سەرگێژخواردووی دەگرێتەوە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) هەستی ئەوەی زۆر دڵخۆش و بەجۆش بیت کە کۆنترۆڵی ڕەفتاری خۆت ناکەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """His childlike excitement verged on giddiness.""",
                      kurdishText: """جۆش‌وخرۆشیی منداڵانەی نزیک بوو لە هەیەجانییەوە.""",
                      englishNote: """This means his innocent enthusiasm almost made him feel lightheaded or overly excited.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/6521a_4tUYA?t=';
const double _startSecondsend = 000000000000000000000000000495;
const String _videoIdone = 'https://youtu.be/iT1l8Dcjb1Y?t=';
const double _startSecondsone = 000000000000000000000000000605;
const String _videoIdtwo = 'https://youtu.be/cwUKLmGHAsw?t=';
const double _startSecondstwo = 000000000000000000000000000324;
const String _videoIdthree = 'https://youtu.be/OUL3FS-0GhI?t=';
const double _startSecondsthree = 000000000000000000000000000539;
const String _videoIdfour = 'https://youtu.be/U-QE4NQm4Ig?t=';
const double _startSecondsfour = 000000000000000000000000000258;
const String _videoIdfive = 'https://youtu.be/EmEQzlqhp9w?t=';
const double _startSecondsfive = 0000000000000000000000000003556;
