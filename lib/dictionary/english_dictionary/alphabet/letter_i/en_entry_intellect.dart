...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'dPicox3QWC0';
    const double startSecondsend = 136;
    const String videoIdone = 'Sbp_EeBk-As';
    const double startSecondsone = 2358;
    const String videoIdtwo = 'E44kFkyl_Y8';
    const double startSecondstwo = 101;
    const String videoIdthree = 'wJa5Ch0O4BI';
    const double startSecondsthree = 513;
    const String videoIdfour = '-Mkp4oavz2M';
    const double startSecondsfour = 301;
    const String videoIdfive = 'mW-C7WE1xOs';
    const double startSecondsfive = 409;
