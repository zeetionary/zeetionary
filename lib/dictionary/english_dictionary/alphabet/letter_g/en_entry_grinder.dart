...
کوردی: دەزگای لێکردن یان ھاڕین، ئاش
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) ئامێرێک کە بۆ ھاڕین بەکاردێت"""),
                    SentencesRow(
                      englishText: """She bought an electric coffee grinder.""",
                      kurdishText: """ھاڕەڕێکی کارەبایی قاوەی کڕی.""",
...
// 188888880002200
const String _videoIdend = 'YgO3JKRcrHU';
const double _startSecondsend = 0;
const String _videoIdone = 'oJRSkBSb5S8';
const double _startSecondsone = 47;
const String _videoIdtwo = 'kCl8oepseDw';
const double _startSecondstwo = 11;
const String _videoIdthree = '2dxCAHU_xpY';
const double _startSecondsthree = 136;
const String _videoIdfour = 'p2asguzWKVI';
const double _startSecondsfour = 21;
const String _videoIdfive = 'Dnl0HEBU8jM';
