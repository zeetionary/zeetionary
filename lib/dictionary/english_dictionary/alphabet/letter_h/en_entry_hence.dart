...
class EnglishEntryhence extends StatefulWidget {
  const EnglishEntryhence({super.key});

  @override
  State<EnglishEntryhence> createState() => _EnglishEntryhenceState();
}

class _EnglishEntryhenceState extends State<EnglishEntryhence> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: hence
1. (used to introduce a logical conclusion) from that fact, reason or as a result (- therefore, thence, thus, so)
"the eggs were fresh and hence satisfactory";
 
2. From this time
"a year hence it will be forgotten"
 
3. [archaic] From this place
"get thee hence!"
""",
  );

  final String keyword = "hence";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hence""",
                      // alsoEnglishWord: "also: hence",
                      britshText: """IpaUK: /hens/""",
                      americanText: """IpaUS: /hens/""",
...
const String _videoIdtwo = 'https://youtu.be/BZbChKzedEk?t=';
const double _startSecondstwo = 000000000000000000000000000312;
const String _videoIdthree = 'https://youtu.be/SrDEtSlqJC4?t=';
const double _startSecondsthree = 0000000000000000000000000001464;
const String _videoIdfour = 'https://youtu.be/IgF3OX8nT0w?t=';
const double _startSecondsfour = 000000000000000000000000000531;
const String _videoIdfive = 'https://youtu.be/yRmOWcWdQAo?t=';
const double _startSecondsfive = 000000000000000000000000000242;
