...
class EnglishEntryacidtest extends StatefulWidget {
  const EnglishEntryacidtest({super.key});

  @override
  State<EnglishEntryacidtest> createState() => _EnglishEntryacidtestState();
}

class _EnglishEntryacidtestState extends State<EnglishEntryacidtest> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "acid test";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acid test""",
                      // alsoEnglishWord: "also: acid test",
                      britshText: """IpaUK: /ˌæsɪd ˈtest/""",
                      americanText: """IpaUS: /ˌæsɪd ˈtest/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'dpPQKz6D1Yw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'NyZXH_JEDEk';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'NCTTc_2W7rA';
