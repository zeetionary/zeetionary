...
class EnglishEntrygrapefruit extends StatefulWidget {
  const EnglishEntrygrapefruit({super.key});

  @override
  State<EnglishEntrygrapefruit> createState() => _EnglishEntrygrapefruitState();
}

class _EnglishEntrygrapefruitState extends State<EnglishEntrygrapefruit> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grapefruit (Derived forms: grapefruits)
1. Citrus tree bearing large round edible fruit having a thick yellow rind and juicy somewhat acid pulp (- Citrus paradisi)
 
2. Large yellow fruit with somewhat acid juicy pulp; usual serving consists of a half
""",
  );

  final String keyword = "grapefruit";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grapefruit""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Grapefruit juice is often served in the morning.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grapefruit""",
                      // alsoEnglishWord: "also: grapefruit",
                      britshText: """IpaUK: /ˈɡreɪpfruːt/""",
                      americanText: """IpaUS: /ˈɡreɪpfruːt/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) میوەیەکی ترشی گەورەی خڕی زەرد کە تامێکی کەمێک ترشی هەیە"""),
                    SentencesRow(
                      englishText:
                          """Grapefruit juice is often served in the morning.""",
                      kurdishText:
                          """شەربەتی سندی زۆرجار لە بەیانیاندا پێشکەش دەکرێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/BE-KFNO6pE0?t=';
const double _startSecondsend = 00000000000000000000000000045;
const String _videoIdone = 'https://youtu.be/HcNSwogkT9Y?t=';
const double _startSecondsone = 00000000000000000000000000010;
const String _videoIdtwo = 'https://youtu.be/NN_Ci716Jk4';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/qTbUuM8E8L8';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/FQJ4NO6SDqg';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/1sdSsxFZMCQ';
