...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'TVe5XPU10Zc';
    const double startSecondsend = 394;
    const String videoIdone = 'tyixMpuGEL8';
    const double startSecondsone = 153;
    const String videoIdtwo = '9TimmdqACAs';
    const double startSecondstwo = 218;
    const String videoIdthree = 'ajbooXnvsE8';
    const double startSecondsthree = 455;
    const String videoIdfour = 'JN3KPFbWCy8';
    const double startSecondsfour = 3032;
    const String videoIdfive = 'ElQdUHSXkME';
