...
class EnglishEntryhotly extends StatefulWidget {
  const EnglishEntryhotly({super.key});

  @override
  State<EnglishEntryhotly> createState() => _EnglishEntryhotlyState();
}

class _EnglishEntryhotlyState extends State<EnglishEntryhotly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: hotly
1. In a heated manner (- heatedly)
"the children were arguing hotly";
""",
  );

  final String keyword = "hotly";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Recent reports in the press have been hotly denied.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/QbDuBTWrU-o';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/Cg10exNmf7I?t=';
    const double startSecondsone = 000000000000000000000000000702;
    const String videoIdtwo = 'https://youtu.be/LCF05r3CSME?t=';
    const double startSecondstwo = 000000000000000000000000000236;
    const String videoIdthree = 'https://youtu.be/Gso2WrBcV2Q?t=';
    const double startSecondsthree = 00000000000000000000000000015;
    const String videoIdfour = 'https://youtu.be/2ot7GKuEqas?t=';
    const double startSecondsfour = 000000000000000000000000000675;
    const String videoIdfive = 'https://youtu.be/plHRRFHZ_f0?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hotly""",
                      // alsoEnglishWord: "also: hotly",
                      britshText: """IpaUK: /ˈhɒtli/""",
                      americanText: """IpaUS: /ˈhɑːtli/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕاپۆرتە تازەکانی میدیا بە توندی ڕەتکراونەتەوە.""",
                    ...
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵکار) بە وزە و شێلگیریی زۆرەوە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: closely"),
                    SentencesRow(
                      englishText:
                          """He ran down the street, hotly pursued by two police officers.""",
                      kurdishText:
                          """بە شەقامەکەدا ڕایکرد و دوو ئەفسەری پۆلیس شێلگیرانە بە شوێنییەوە بوون.""",
