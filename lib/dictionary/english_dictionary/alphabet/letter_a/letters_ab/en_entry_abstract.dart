...
class EnglishEntryabstract extends StatelessWidget {
  EnglishEntryabstract({Key? key}) : super(key: key);
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "پلانەکەیان ئەوەبوو کە ھەشت ملیان گاڵۆن ئاو لە ڕووبارەکە دەربکەن ",
                                    textAlign: TextAlign
                                        .right, // Right-to-left direction
                                  ),
                                ),
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  YoutubeEmbeddedeleven({Key? key}) : super(key: key);
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  YoutubeEmbeddedtwelve({Key? key}) : super(key: key);
