...
class EnglishEntrygearlever extends StatefulWidget {
  const EnglishEntrygearlever({super.key});

  @override
  State<EnglishEntrygearlever> createState() => _EnglishEntrygearleverState();
}

class _EnglishEntrygearleverState extends State<EnglishEntrygearlever> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gear lever";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gear lever""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Push the gear lever into first.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gear lever""",
                      alsoEnglishWord: "also: gearstick, gearshift",
                      britshText: """IpaUK: /ˈɡɪə liːvə(r)/""",
                      americanText: """IpaUS: /ˈɡɪr levər/""",
...
// With short examples define "gear lever", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Push the gear lever into first.""",
                      kurdishText: """دەسکەگێڕەکە بخە سەر یەکەم.""",
...
const double _startSecondsone = 000000000000000000000000000586;
const String _videoIdtwo = 'https://youtu.be/ERgp4bmr228?t=';
const double _startSecondstwo = 000000000000000000000000000206;
const String _videoIdthree = 'https://youtu.be/TYJ8uoJ7DAk?t=';
const double _startSecondsthree = 0000000000000000000000000001139;
const String _videoIdfour = 'https://youtu.be/pdlyyulxiy0?t=';
const double _startSecondsfour = 000000000000000000000000000166;
const String _videoIdfive = 'https://youtu.be/LKqiDy_Po2M?t=';
