...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'l4yZQZf2g5Y';
    const double startSecondsend = 8;
    const String videoIdone = 'ymIF1sPtcJc';
    const double startSecondsone = 64;
    const String videoIdtwo = 'tBINxc7KkwI';
    const double startSecondstwo = 839;
    const String videoIdthree = 'nPZPrs2Uf_g';
    const double startSecondsthree = 1128;
    const String videoIdfour = '_r8yyTtKK2k';
    const double startSecondsfour = 723;
    const String videoIdfive = 'wZSV_p8rEDI';
