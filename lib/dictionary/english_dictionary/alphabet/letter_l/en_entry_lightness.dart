...
class EnglishEntrylightness extends StatefulWidget {
  const EnglishEntrylightness({super.key});

  @override
  State<EnglishEntrylightness> createState() => _EnglishEntrylightnessState();
}

class _EnglishEntrylightnessState extends State<EnglishEntrylightness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lightness
1. A feeling of joy and pride (- elation, high spirits)
 
2. The property of being comparatively small in weight (- weightlessness)
"the lightness of balsa wood";
 
3. The gracefulness of a person or animal that is quick and nimble (- agility, legerity, lightsomeness, nimbleness)
"leaped up with surprising lightness";
 
4. Having a light colour
 
5. The visual effect of illumination on objects or scenes as created in pictures (- light)
"he could paint the lightest lightness and the darkest dark";
 
6. The trait of being lighthearted and frivolous (- lightsomeness)
""",
  );

  final String keyword = "lightness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lightness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The lightness of the box made it easy to carry.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The lightness of her dress was perfect for the summer heat.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She handled the baby with the lightness of her touch.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He enjoyed the lightness of the work compared to his last job.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The lightness of the traffic was unusual for a weekday.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The lightness of the punishment upset the victim's family.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She handles the material with great lightness of touch.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/J0mZYeb4C8k?t=796';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/wJa5Ch0O4BI?t=5328';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/ecFS2JSbn-0?t=2012';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/86Gy035z_KA?t=108';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/EI-ToB0tG9A?t=339';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/wh4aWZRtTwU?t=607';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lightness""",
                      // alsoEnglishWord: "also: lightness",
                      britshText: """IpaUK: /ˈlaɪtnəs/""",
                      americanText: """IpaUS: /ˈlaɪtnəs/""",
...
کوردی: ڕۆشنایی، ڕووناکایی، بەشەوقی،	کەم‌ڕەنگی، کاڵی، گەشی،	سووکی، نەقورسی،	کەمی،	شادی، دڵشادی، بەکەیفی، خۆشحاڵی،	هەڵەشەیی، سەرچڵی
"""),
                    const DefinitionKurdish(text: """١. (ناو) ئەوەی شتێک سووک بێت بۆ هەڵگرتن"""),
                    SentencesRow(
                      englishText: """The lightness of the box made it easy to carry.""",
                      kurdishText: """سووکی سندووقەکە ئاسانی کرد بۆ هەڵگرتن.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ئەوەی شتێک ناسک بێت نەک قەبە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The lightness of her dress was perfect for the summer heat.""",
                      kurdishText: """ناسکی جلەکەی زۆر گونجاو بوو بۆ گەرمی هاوین.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) ئەوەی شتێک هێزی زۆری لەگەڵ نەبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She handled the baby with the lightness of her touch.""",
                      kurdishText: """منداڵەکەی ژیرکردەوە بە نەرمی دەستی.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ناو) ئەوەی لە بڕ، ئاست، هتد زۆر نەبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The lightness of the traffic was unusual for a weekday.""",
                      kurdishText: """کەمیی هاتووچۆ شتێکی نائاسایی بوو بۆ ڕۆژێکی هەفتە ( = ڕۆژی کار نەک پشوو).""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (ناو) ئەوەی ئاسان بێت بۆ کردن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He enjoyed the lightness of the work compared to his last job.""",
                      kurdishText: """حەزی بە سووکی کارەکەی بوو بەراورد بە کاری پێشووی.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٦. (ناو) ئەوەی کە جدی یان قورس نەبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The lightness of the punishment upset the victim's family.""",
                      kurdishText: """سووکی سزاکە خێزانی قوربانییەکەی نیگەران کرد.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    // const DividerDefinition(),
                    // const DefinitionKurdish(text: """٧. (ناو) ئەوەی کە خۆشی تێدا بێت و جدی نەبێت"""),
                    // const DividerSentences(),
                    // SentencesRow(
                    //   englishText: """She handles the material with great lightness of touch.""",
