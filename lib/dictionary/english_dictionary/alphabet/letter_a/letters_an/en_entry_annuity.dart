...
// replace these: replace EnglishEntryannuity - replace speakAnnuity - replace annuity - /əˈnjuːəti/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryannuity extends StatelessWidget {
  // blank divider
  ...
  Future<void> speakannuity(String languageCode) async {
    ...
    await flutterTts.speak("annuity");
  }
  ...
  Future<void> speakannuity848(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She receives a small annuity.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "annuity"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈnjuːəti/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: //əˈnuːəti//"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '98ikQoTblnw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'HHxvfj2ys0A';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'lW36jYkv0lM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'DE9QA-nbkUo';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'wN8f7KEi5ys';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '_k1QWDKnAhI';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '-YqCVJhI9NE';
  final double _startSeconds = 7;
