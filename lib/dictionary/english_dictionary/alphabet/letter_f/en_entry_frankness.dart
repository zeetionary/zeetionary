...
class EnglishEntryfrankness extends StatefulWidget {
  const EnglishEntryfrankness({super.key});

  @override
  State<EnglishEntryfrankness> createState() => _EnglishEntryfranknessState();
}

class _EnglishEntryfranknessState extends State<EnglishEntryfrankness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frankness
1. The quality of being honest and straightforward in attitude and speech (= candor [US], candour [Brit, Cdn], candidness, directness, forthrightness)
 
2. The trait of being blunt and outspoken (= outspokenness)
""",
  );

  final String keyword = "frankness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frankness""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They outlined their aims with disarming frankness.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frankness""",
                      // alsoEnglishWord: "also: frankness",
                      britshText: """IpaUK: /ˈfræŋknəs/""",
                      americanText: """IpaUS: /ˈfræŋknəs/""",
...
// With short examples define "frankness", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """A lot more frankness is needed in sex education if we are to reduce the number of teenage pregnancies.""",
                      kurdishText:
                          """ڕاشکاوی زیاتر پێویستە لە پەروەردەی سێکس ئەگەر بمانەوێت ژمارەی دووگیانی هەرزەکاران کەم بکەینەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئامانجەکانیان بە ڕاشکاوییەکی ئارام‌کەرەوە خستەڕوو..""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/oVPD5eFihKw?t=';
const double _startSecondsend = 000000000000000000000000000651;
const String _videoIdone = 'https://youtu.be/wyac0t4avCc?t=';
const double _startSecondsone = 00000000000000000000000000020;
const String _videoIdtwo = 'https://youtu.be/59Epd37cqVI?t=';
const double _startSecondstwo = 0000000000000000000000000001000;
const String _videoIdthree = 'https://youtu.be/K7rANu5vlnA?t=';
const double _startSecondsthree = 000000000000000000000000000264;
const String _videoIdfour = 'https://youtu.be/bNn7SR_2iIE?t=';
const double _startSecondsfour = 0000000000000000000000000001584;
const String _videoIdfive = 'https://youtu.be/AdZPaAuUVjQ?t=';
const double _startSecondsfive = 0000000000000000000000000002210;
