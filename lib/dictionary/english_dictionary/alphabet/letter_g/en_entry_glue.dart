...
class EnglishEntryglue extends StatefulWidget {
  const EnglishEntryglue({super.key});

  @override
  State<EnglishEntryglue> createState() => _EnglishEntryglueState();
}

class _EnglishEntryglueState extends State<EnglishEntryglue> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""All you will need is a sharp knife and a tube of glue.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He sticks to her like glue.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Make sure the edges are glued down.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Glue the pieces firmly together.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glue""",
                      // alsoEnglishWord: "also: glue",
                      britshText: """IpaUK: /ɡluː/""",
                      americanText: """IpaUS: /ɡluː/""",
...
کوردی: چەسپ، سرێش، کەتیرە، هێلم، دەباش، دەبووش، غری
"""),
// With short examples define "glue", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەموو ئەوەی پێویستتە چەقۆیەکی تیژ و تیوبێک چەسپە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """وەک چەسپ پێیەوە دەنووسێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دڵنیابەرەوە قەراغەکان تاوەکو خوارەوە بە چەسپ بەستراون.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Glue the pieces firmly together.""",
                      kurdishText: """پارچەکان بە توندی پێکەوە ببەستەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/19v2oBBEz-4?t=';
const double _startSecondsend = 00000000000000000000000000015;
const String _videoIdone = 'https://youtu.be/1a0EL1gibdU?t=';
const double _startSecondsone = 000000000000000000000000000201;
const String _videoIdtwo = 'https://youtu.be/nKyZIPEHY58?t=';
const double _startSecondstwo = 0000000000000000000000000007;
const String _videoIdthree = 'https://youtu.be/VZqf5rOJNCE?t=';
const double _startSecondsthree = 00000000000000000000000000073;
const String _videoIdfour = 'https://youtu.be/-HWCyqeygbU?t=';
const double _startSecondsfour = 00000000000000000000000000074;
const String _videoIdfive = 'https://youtu.be/7i_sJC_zfpk';
