...
class EnglishEntryinsatiable extends StatefulWidget {
  const EnglishEntryinsatiable({super.key});

  @override
  State<EnglishEntryinsatiable> createState() => _EnglishEntryinsatiableState();
}

class _EnglishEntryinsatiableState extends State<EnglishEntryinsatiable> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insatiable""");
  }
