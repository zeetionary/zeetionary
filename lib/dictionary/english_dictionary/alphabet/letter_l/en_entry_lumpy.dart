...
class EnglishEntrylumpy extends StatefulWidget {
  const EnglishEntrylumpy({super.key});

  @override
  State<EnglishEntrylumpy> createState() => _EnglishEntrylumpyState();
}

class _EnglishEntrylumpyState extends State<EnglishEntrylumpy> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylumpy lumpy
WORD_WEB lumpy lumpy lumpy
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lumpy";
...
کوردی: 
"""),
// With short examples define "lumpy", please follow LX instructions
