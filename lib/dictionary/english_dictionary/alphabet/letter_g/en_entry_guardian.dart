...
class EnglishEntryguardian extends StatefulWidget {
  const EnglishEntryguardian({super.key});

  @override
  State<EnglishEntryguardian> createState() => _EnglishEntryguardianState();
}

class _EnglishEntryguardianState extends State<EnglishEntryguardian> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: guardian (Derived forms: guardians)
1. A person who cares for persons or property (- defender, protector, shielder)
 
2. (law) a person legally responsible for an incompetent person, esp. a child
"the guardian signed the contract on behalf of the minor child"
""",
  );

  final String keyword = "guardian";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""guardian""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The police are guardians of law and order.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Farmers should be guardians of the countryside.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The court appoints a legal guardian for the child.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """guardian""",
                      // alsoEnglishWord: "also: guardian",
                      britshText: """IpaUK: /ˈɡɑːdiən/""",
                      americanText: """IpaUS: /ˈɡɑːrdiən/""",
...
کوردی: سەرپەرشت، سەرپەرست،	نۆبەدار، ئاگادێر، ئاگاوان، پارێزەر، ئێشک‌گر، چاودێر، پشتیوان، داکۆکی‌کار
"""),
// With short examples define "guardian", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) کەسێک کە شتێک دەپارێزێت"""),
                    SentencesRow(
                      englishText: """The police are guardians of law and order.""",
                      kurdishText: """پۆلیس پارێزەری یاسا و ڕێسان.""",
                    ...
                    SentencesRow(
                      englishText: """Farmers should be guardians of the countryside.""",
                      kurdishText: """جووتیاران دەبێت پارێزەری دەشت‌ودەر بن.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) کەسێک کە لە لایەنی یاساییەوە بەرپرسە بۆ چاودێری کەسێکی دیکە، بە تایبەتی منداڵێک کە دایبابی مردوون"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The court appoints a legal guardian for the child.""",
                      kurdishText: """دادگا چاودێرێکی یاسایی بۆ منداڵەکە دیاری دەکات.""",
...
const double _startSecondsend = 0000000000000000000000000001050;
...
const String _videoIdthree = 'https://youtu.be/9BPMTr-NS9s?t=';
...
const String _videoIdfive = 'https://youtu.be/VumA-qcMahk?t=';
