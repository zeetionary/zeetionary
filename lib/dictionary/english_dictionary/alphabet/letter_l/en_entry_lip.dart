...
class EnglishEntrylip extends StatefulWidget {
  const EnglishEntrylip({super.key});

  @override
  State<EnglishEntrylip> createState() => _EnglishEntrylipState();
}

class _EnglishEntrylipState extends State<EnglishEntrylip> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lip (Derived forms: lips)
1. Either of two fleshy folds of tissue that surround the mouth and play a role in speaking
 
2. [informal] An impudent or insolent rejoinder (- sass [N. Amer, informal], sassing [N. Amer, informal], backtalk [N. Amer, informal], back talk [N. Amer, informal], mouth, backchat [Brit, informal])
"don't give me any of your lip";
 
3. The top edge of a vessel or other container (- brim, rim)
...
- Verb: lip (Derived forms: lips, lipped, lipping)
1. Touch with the lips
""",
  );

  final String keyword = "lip";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The assistant pursed her lips.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She kissed him on the lips.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He raised the bottle to his lips and took a large swig from it.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He bit his lip nervously, trying not to cry.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He licked his lips hungrily.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The thin-lipped man rarely showed any emotion.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He ran his finger around the lip of the cup.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Don't let him give you any lip!""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/Dvkydwf2Gj8?t=12314';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/IE9S8CehYco?t=9';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/OJZhDHdlk3w?t=53';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/lPQ6VQzuyxU?t=53';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/DECt9uTxaLE?t=73';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/modppXCKk4g?t=65';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lip""",
                      // alsoEnglishWord: "also: lip",
                      britshText: """IpaUK: /lɪp/""",
                      americanText: """IpaUS: /lɪp/""",
...
کوردی: لێو، لچ،	لێوار، قەراخ،	(ئامێری فویی) لێوگر،	زمان‌درێژی، دەم‌درێژی
"""),
// With short examples define "lip", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) لێو"""),
                    SentencesRow(
                      englishText: """The assistant pursed her lips.""",
                      kurdishText: """یاریدەدەرەکە لێوەکانیی توند کرد.""",
                    ...
                    SentencesRow(
                      englishText: """She kissed him on the lips.""",
                      kurdishText: """ماچی ناو لێویی کرد.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He raised the bottle to his lips and took a large swig from it.""",
                      kurdishText: """بوتڵەکەی بەرز کردەوە بۆ لێوەکانی و قومێکی گەورەی لێدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He bit his lip nervously, trying not to cry.""",
                      kurdishText: """بە شڵەژانەوە گازی لە لێوی گرت و هەوڵی دەدا نەگری.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He licked his lips hungrily.""",
                      kurdishText: """بەسییانە لێویی دەلێسایەوە.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) هەبوونی ئەو جۆرە لێوەی کە باسکراوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The thin-lipped man rarely showed any emotion.""",
                      kurdishText: """پیاوە لێو باریکەکە بە ئەستەم هیچ سۆزێکی پیشان دەدا.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) قەراغی پیاڵەیەک، دەفرێک، هتد یان چاڵێک لە زەویدا"""),
                    const AlsoEnglishckb(word: "ھەروەھا: rim"),
                    SentencesRow(
                      englishText: """He ran his finger around the lip of the cup.""",
                      kurdishText: """دەستیی هێنا بە قەراغی کوپەکەدا.""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ناو) قسەی توند کە بە کەسێک دەکرێت و بێ ڕێزییە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: cheek"),
                    SentencesRow(
                      englishText: """Don't let him give you any lip!""",
                      kurdishText: """مەهێڵە هیچ زمان‌درێژییەکت بەرامبەر بکات!""",
