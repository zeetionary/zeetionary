...
// Define the word "beetroot" and provide five simple example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings or more.

// replace beetroot - replace EnglishEntrybeetroot

// replace speakBeetroot - /ˈbiːtruːt/

enum TtsState { playing }

class EnglishEntrybeetroot extends StatelessWidget {
// blank divider
  EnglishEntrybeetroot({super.key});
// blank divider
  ...
  Future<void> speakbeetroot(String languageCode) async {
    ...
    await flutterTts.speak("beetroot");
  }
  ...
  Future<void> speakbeetroots1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("She grated the beetroot into the salad for color and crunch.");
  }
  ...
  Future<void> speakbeetroots2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBeetroots22");
  }
  ...
  Future<void> speakbeetroots3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBeetroots33");
  }
  ...
  Future<void> speakbeetroots4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBeetroots44");
  }
  ...
  Future<void> speakbeetroots5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBeetroots55");
  }
  ...
  Future<void> speakbeetroots6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBeetroots66");
  }
  ...
  Future<void> speakbeetroots7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBeetroots77");
  }
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: beetroot (derived forms: beetroots)
Usage: Brit (N. Amer: beet)
1. Beet having a massively swollen red root; widely grown for human consumption (= Beta vulgaris rubra, beet [N. Amer])
 
2. Round red root vegetable (= beet [N. Amer])
""",
  );
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'QzqgvpNjQtE';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'eMf3N-zAV-U';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'xdzoeDkpTxw';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'Ya2_Khcdwsk';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'xV9spqCzSkQ';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'tlQF-OrhZ5I';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'YqJH3Ebkhq8';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = '17DnI1RfGAk';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = '4lzJa-Ff2-o';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'MWzxDFRtVbc';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'Yos-oMxLV_M';
...
class YoutubeEmbeddedthirteen extends StatelessWidget {
  ...
  final String _videoId = 'RATQTsyH8XY';
