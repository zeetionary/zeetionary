...
class EnglishEntryfragrance extends StatefulWidget {
  const EnglishEntryfragrance({super.key});

  @override
  State<EnglishEntryfragrance> createState() => _EnglishEntryfragranceState();
}

class _EnglishEntryfragranceState extends State<EnglishEntryfragrance> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fragrance (Derived forms: fragrances)
1. A distinctive odour that is pleasant (= aroma, perfume, scent)
 
2. A pleasingly sweet olfactory property (= bouquet, fragrancy, redolence, sweetness)
""",
  );

  final String keyword = "fragrance";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fragrance""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The bath oil comes in various fragrances.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The flowers are chosen for their delicate fragrance.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fragrance of lavender filled the room.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They are about to launch their first fragrance for men.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fragrance""",
                      // alsoEnglishWord: "also: fragrance",
                      britshText: """IpaUK: /ˈfreɪɡrəns/""",
                      americanText: """IpaUS: /ˈfreɪɡrəns/""",
...
کوردی: 	بەرامە، بۆنی خۆش، بۆن‌خۆشی، لابانتە، عەتر، گوڵاو
"""),
// With short examples define "fragrance", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) بۆنی خۆش"""),
                    SentencesRow(
                      englishText:
                          """The bath oil comes in various fragrances.""",
                      kurdishText: """زەیت حەمامەکە ژمارەیەک بۆنی هەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """گوڵەکان بۆ بۆن‌خۆشی ناسک.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بۆنی خۆشی لاڤندەر ژوورەکەی پڕکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """یەکەم عەتریان بۆ پیاوان بڵاودەکەنەوە.""",
...
const double _startSecondsone = 000000000000000000000000000710;
...
const double _startSecondsthree = 000000000000000000000000000763;
const String _videoIdfour = 'https://youtu.be/sf7NfCe3_5Y?t=';
const double _startSecondsfour = 000000000000000000000000000756;
const String _videoIdfive = 'https://youtu.be/XKDhq2UcjIM?t=';
const double _startSecondsfive = 0000000000000000000000000001609;
