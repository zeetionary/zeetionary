...
class EnglishEntryfraternity extends StatefulWidget {
  const EnglishEntryfraternity({super.key});

  @override
  State<EnglishEntryfraternity> createState() => _EnglishEntryfraternityState();
}

class _EnglishEntryfraternityState extends State<EnglishEntryfraternity> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fraternity (Derived forms: fraternities)
1. [N. Amer] A social club for male undergraduates (= frat [N. Amer, informal])
 
2. People engaged in a particular occupation (= brotherhood, sodality)
"the medical fraternity";
 
3. Friendship and mutual support within a group of people
""",
  );

  final String keyword = "fraternity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fraternity""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The police are cracking down on the criminal fraternity.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fraternity""",
                      // alsoEnglishWord: "also: fraternity",
                      britshText: """IpaUK: /frəˈtɜːnəti/""",
                      americanText: """IpaUS: /frəˈtɜːrnəti/""",
...
کوردی: برایەتی، برادەری، دۆستایەتی،	کۆڕ، کۆمەڵە (ڕێکخراو بۆ مەبەستێکی هاوبەش)،	یەکێتی
"""),
// With short examples define "fraternity", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) گرووپێک کەس کە هەمان کار، بەرژەوەندی و باوەڕیان هەیە"""),
                    SentencesRow(
                      englishText:
                          """The police are cracking down on the criminal fraternity.""",
                      kurdishText:
                          """پۆلیس بە توندی لێکۆڵینەوە لە تۆڕی تاوانکاران دەکات.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) هەستی دۆستایەتی و پشتگیری"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He described sport as a symbol of peace and a means of promoting fraternity between nations.""",
                      kurdishText:
                          """وەرزشی وەک سمبولی ئاشتی و ڕێگای زیادکردنی دۆستایەتی نێوان گەلان ناوزەند کرد.""",
...
const double _startSecondsend = 00000000000000000000000000025;
const String _videoIdone = 'https://youtu.be/nGrB-5ieeMU?t=';
const double _startSecondsone = 000000000000000000000000000304;
const String _videoIdtwo = 'https://youtu.be/r7_fe-bPWnM?t=';
const double _startSecondstwo = 000000000000000000000000000211;
const String _videoIdthree = 'https://youtu.be/Unzc731iCUY?t=';
const double _startSecondsthree = 0000000000000000000000000001684;
const String _videoIdfour = 'https://youtu.be/yRFPjBuRRCg?t=';
const double _startSecondsfour = 000000000000000000000000000361;
