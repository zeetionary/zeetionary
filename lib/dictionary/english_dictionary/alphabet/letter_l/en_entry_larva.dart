...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Butterflies start as a small larva in the egg.""");
  }
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مێروویەک کە تازە لە هێلکە هاتووەتە دەرەوە و وەک کرمێکی قەڵەوی کورتە"""),
                    SentencesRow(
                      englishText:
                          """Butterflies start as a small larva in the egg.""",
                      kurdishText:
                          """پەپوولە وەک کرمۆکە لە هێلکە دەست پێدەکات.""",
