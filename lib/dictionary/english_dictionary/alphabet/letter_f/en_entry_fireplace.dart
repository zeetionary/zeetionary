...
class EnglishEntryfireplace extends StatefulWidget {
  const EnglishEntryfireplace({super.key});

  @override
  State<EnglishEntryfireplace> createState() => _EnglishEntryfireplaceState();
}

class _EnglishEntryfireplaceState extends State<EnglishEntryfireplace> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fireplace (Derived forms: fireplaces)
1. An open recess in a wall at the base of a chimney where a fire can be built (= hearth, open fireplace)
"the fireplace was so large you could walk inside it"; "the open fireplace was so large you could walk inside it";
""",
  );

  final String keyword = "fireplace";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fireplace""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""A log fire crackled in the fireplace.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Every room in the house has a fireplace.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fireplace""",
                      // alsoEnglishWord: "also: fireplace",
                      britshText: """IpaUK: /ˈfaɪəpleɪs/""",
                      americanText: """IpaUS: /ˈfaɪərpleɪs/""",
...
// With short examples define "fireplace", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """A log fire crackled in the fireplace.""",
                      kurdishText:
                          """تەختە دارێک قرچەی دەهات لە ئاگردانەکەدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەر ژوورێکی خانووەکە ئاگردانێکی هەیە.""",
...
const double _startSecondsend = 000000000000000000000000000515;
const String _videoIdone = 'https://youtu.be/XnbCSboujF4?t=';
const double _startSecondsone = 000000000000000000000000000422;
const String _videoIdtwo = 'https://youtu.be/PqpCeiYycVM?t=';
const double _startSecondstwo = 000000000000000000000000000648;
const String _videoIdthree = 'https://youtu.be/gO_gm74yiUY?t=';
const double _startSecondsthree = 00000000000000000000000000047;
const String _videoIdfour = 'https://youtu.be/vx09_4cEzlM?t=';
