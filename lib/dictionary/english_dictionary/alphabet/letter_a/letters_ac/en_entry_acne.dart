...
// replace these: replace EnglishEntryacne - replace speakAcne - replace acne - /ˈækni/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryacne extends StatelessWidget {
  EnglishEntryacne({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'acne', // DOPSUM: CHANGE WORD ENTRY - Find /ˈækni/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈækni/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '57htei0Xw1E';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'YMRRrvBlK8I';
