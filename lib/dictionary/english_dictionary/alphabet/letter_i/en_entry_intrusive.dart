...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1538;
    const String videoIdone = 'Sbp_EeBk-As';
    const double startSecondsone = 1056;
    const String videoIdtwo = 'Upqp21Dm5vg';
    const double startSecondstwo = 331;
    const String videoIdthree = 'BaVpeJlcQzg';
    const double startSecondsthree = 1664;
    const String videoIdfour = 'bH-TlC0111Q';
