...
class EnglishEntryfrolic extends StatefulWidget {
  const EnglishEntryfrolic({super.key});

  @override
  State<EnglishEntryfrolic> createState() => _EnglishEntryfrolicState();
}

class _EnglishEntryfrolicState extends State<EnglishEntryfrolic> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frolic (Derived forms: frolicking, frolicked, frolics)
1. Gay or light-hearted recreational activity for diversion or amusement (= play, romp, gambol, caper [informal])
"their frolic in the surf threatened to become ugly";

- Verb: frolic
1. Play boisterously (- lark [informal], rollick, skylark [informal], disport, sport, cavort, gambol, frisk, romp, run around, lark about [informal])
"The children frolicked in the garden";
""",
  );

  final String keyword = "frolic";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""A group of children were frolicking on the beach.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The days of fun and frolic were gone for ever.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frolic""",
                      // alsoEnglishWord: "also: frolic",
                      britshText: """IpaUK: /ˈfrɒlɪk/""",
                      americanText: """IpaUS: /ˈfrɑːlɪk/""",
...
کوردی: شادی، خۆشی، بەکەیفی، شەیتانی، قۆشمەیی، شلوقی، هەڵبەز و دابەز، تەقڵەدەو، فڕک‌وهۆڕ
"""),
// With short examples define "frolic", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ژمارەیەک منداڵ یارییان دەکرد لە کەنارەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تەنها شادییەکی بێ‌زیان بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕۆژانی خۆشی و شادی بۆ هەمیشە نەمابوون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/P2EjH7l_N70?t=';
...
const String _videoIdthree = 'https://youtu.be/Dz7HUEUVbf4?t=';
const double _startSecondsthree = 000000000000000000000000000564;
const String _videoIdfour = 'https://youtu.be/_S_dc2cmoZY?t=';
const double _startSecondsfour = 000000000000000000000000000697;
const String _videoIdfive = 'https://youtu.be/y4VJS45Q2tM';
