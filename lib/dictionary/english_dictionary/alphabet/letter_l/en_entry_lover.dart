...
class EnglishEntrylover extends StatefulWidget {
  const EnglishEntrylover({super.key});

  @override
  State<EnglishEntrylover> createState() => _EnglishEntryloverState();
}

class _EnglishEntryloverState extends State<EnglishEntrylover> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylover lover
WORD_WEB lover lover lover
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lover";
...
کوردی: 
"""),
// With short examples define "lover", please follow LX instructions
