...
class EnglishEntryflorist extends StatefulWidget {
  const EnglishEntryflorist({super.key});

  @override
  State<EnglishEntryflorist> createState() => _EnglishEntryfloristState();
}

class _EnglishEntryfloristState extends State<EnglishEntryflorist> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: florist (Derived forms: florists)
1. Someone who grows and deals in flowers
"the florist made up an attractive bouquet"
 
2. A shop where flowers and ornamental plants are sold (= florist shop, flower store)
""",
  );

  final String keyword = "florist";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""florist""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """She visited the local florist to pick out flowers for her wedding.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I've ordered some flowers from the florist's.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """florist""",
                      // alsoEnglishWord: "also: florist",
                      britshText: """IpaUK: /ˈflɒrɪst/""",
                      americanText: """IpaUS: /ˈflɔːrɪst/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """She visited the local florist to pick out flowers for her wedding.""",
                      kurdishText:
                          """سەردانی گوڵفرۆشەکەی کرد بۆ هەڵبژاردنی گوڵ بۆ هاوسەرگیرییەکەی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ژمارەیەک گوڵم لە گوڵفرۆشییەکە داواکردووە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/-gal8E_dgE8?t=';
const double _startSecondsend = 000000000000000000000000000976;
const String _videoIdone = 'https://youtu.be/wJa5Ch0O4BI?t=';
const double _startSecondsone = 000000000000000000000000000607;
const String _videoIdtwo = 'https://youtu.be/ieM3GuymwUE?t=';
const double _startSecondstwo = 000000000000000000000000000116;
const String _videoIdthree = 'https://youtu.be/lCiZPZkvOBE?t=';
const double _startSecondsthree = 000000000000000000000000000195;
const String _videoIdfour = 'https://youtu.be/i6nKfOMME8Y?t=';
const double _startSecondsfour = 000000000000000000000000000301;
const String _videoIdfive = 'https://youtu.be/1Y0F7zZ_Ws0?t=';
const double _startSecondsfive = 000000000000000000000000000136;
