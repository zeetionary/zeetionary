...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'rqwX-4VLkuw';
    const double startSecondsend = 385;
    const String videoIdone = 'BbCJ1DiJ_Cs';
    const double startSecondsone = 228;
    const String videoIdtwo = 'IsdX3-MHrUM';
    const double startSecondstwo = 531;
    const String videoIdthree = 'N0U-XEmKPKg';
    const double startSecondsthree = 960;
    const String videoIdfour = 'OjIEHMfO-t4';
    const double startSecondsfour = 142;
    const String videoIdfive = 'k7J3AwgQCLU';
    const double startSecondsfive = 1445;
