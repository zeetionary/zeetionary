...
class EnglishEntrybabysit extends StatelessWidget {
  ...
  Future<void> speaka3(String languageCode) async {
    ...
    await flutterTts.speak("babysit");
  }
  ...
  Future<void> speaka3s1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He's babysitting the neighbour's children.");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "babysit"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈbeɪbisɪt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈbeɪbisɪt/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'y6GNrpcXtqM';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'pT9Wayl-Gag';
  final double _startSeconds = 0;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'tz8me_-yLXk';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '_9vTdTKVrt4';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'nHttheXCeTw';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'SsqasJoanUQ';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'MqPpaOheDXc';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = '7EHsCsxTSJ4';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'OCMpEggsV6w';
  final double _startSeconds = 0;
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'LkQU5pjZikk';
