...
class EnglishEntrygynaecological extends StatefulWidget {
  const EnglishEntrygynaecological({super.key});

  @override
  State<EnglishEntrygynaecological> createState() =>
      _EnglishEntrygynaecologicalState();
}

class _EnglishEntrygynaecologicalState
    extends State<EnglishEntrygynaecological> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: gynaecological
Usage: Brit, Cdn (US: gynecological)
1. Of or relating to or practising gynaecology (- gynecological [N. Amer], gynecologic [N. Amer], gynaecologic [Brit, Cdn])
"gynaecological examination";
""",
  );

  final String keyword = "gynaecological";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gynaecological""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gynaecological""",
                      // alsoEnglishWord: "also: gynaecological",
                      britshText: """IpaUK: /ˌɡaɪnəkəˈlɒdʒɪkl/""",
                      americanText: """IpaUS: /ˌɡaɪnəkəˈlɑːdʒɪkl/""",
...
کوردی: 
"""),
// \b(gynaecological)(s|ed|es|ing)?\b(?=[.!?]?)
