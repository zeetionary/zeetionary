...
class EnglishEntryhostess extends StatefulWidget {
  const EnglishEntryhostess({super.key});

  @override
  State<EnglishEntryhostess> createState() => _EnglishEntryhostessState();
}

class _EnglishEntryhostessState extends State<EnglishEntryhostess> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hostess (Derived forms: hostesses)
1. A woman host
 
2. A woman innkeeper
 
3. A woman steward on an aeroplane (- stewardess, air hostess [Brit])
""",
  );

  final String keyword = "hostess";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hostess""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Mary was always the perfect hostess.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/hCsPV0eiqxg';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/qswjaM5yCro?t=';
    const double startSecondstwo = 000000000000000000000000000117;
    const String videoIdthree = 'https://youtu.be/asrGCMGSmY0?t=';
    const double startSecondsthree = 000000000000000000000000000587;
    const String videoIdfour = 'https://youtu.be/SqH0nJngy-c?t=';
    const double startSecondsfour = 000000000000000000000000000947;
    const String videoIdfive = 'https://youtu.be/zZN4Rvb8EuU?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hostess""",
                      // alsoEnglishWord: "also: hostess",
                      britshText: """IpaUK: /ˈhəʊstəs/,  /həʊˈstes/""",
                      americanText: """IpaUS: /ˈhəʊstəs/""",
