...
class EnglishEntryeverlasting extends StatefulWidget {
  const EnglishEntryeverlasting({super.key});

  @override
  State<EnglishEntryeverlasting> createState() =>
      _EnglishEntryeverlastingState();
}

class _EnglishEntryeverlastingState extends State<EnglishEntryeverlasting> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""everlasting""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """everlasting""",
                      // alsoEnglishWord: "also: everlasting",
                      britshText: """IpaUK: /ˌevəˈlɑːstɪŋ/""",
                      americanText: """IpaUS: /ˌevərˈlæstɪŋ/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "everlasting";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The raven is used by the poet as a symbol of everlasting despair.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I wish someone would invent an everlasting light bulb.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'm tired of your everlasting complaints.""");
  }
...
// With short examples define "everlasting", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: هەمیشەیی، هەتاهەتایی، تاسەر، نەمر(ی)، بێ‌کۆتایی، دوایی‌پێ‌نەهاتوو،	بەرگەگر، قایم،	دوورودرێژ،	لەسەریەک، بەردەوام، یەکبینە
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) کە بۆ هەمیشە بەردەوام دەبێت"""),
          SentencesRow(
            englishText:
                """The raven is used by the poet as a symbol of everlasting despair.""",
            kurdishText:
                """قەلەڕەش لەلایەن هۆزانڤانەکەوە وەک سمبولی نائومێدی هەمیشەیی بەکاردێت.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ئاواتەخوازم کەسێک گڵۆپێکی هەمیشەیی دابهێنایە.""",
          ...
          SentencesRow(
            englishText:
                """Their contributions to science have earned them an everlasting place in history.""",
            kurdishText:
                """بەخشینەکانیان بە زانست پێگەیەکی هەمیشەیی لە مێژوودا پێداون.""",
            onPressedBritish: () => speaksentence3("en-GB"),
            onPressedAmerican: () => speaksentence3("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ھاوەڵناو) کە زۆر بەردەوام دەبێت"""),
          // const DividerSentences(),
          const AlsoEnglishckb(
              word: "ھەروەھا: constant، interminable، never-ending"),
          SentencesRow(
            englishText: """I'm tired of your everlasting complaints.""",
            kurdishText: """بێزرام لە بۆڵەبۆڵی نەبڕاوەت.""",
...
1. Continuing forever or indefinitely (= ageless, aeonian, eonian [N. Amer], eternal, perpetual, unending, unceasing, eviternal [archaic])
"life everlasting";
 
2. Without qualification; used informally as an (often pejorative) intensifier (= arrant, complete, consummate, double-dyed, gross, perfect, pure, sodding, stark, staring, thorough, thoroughgoing, utter, unadulterated, rigorous)
"an everlasting fool";

- Noun: everlasting (Derived forms: everlastings)
1. Any of various plants of various genera of the family Compositae having flowers that can be dried without loss of form or colour (= everlasting flower)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/7eM7pb5M5DU?t=';
const double _startSecondsend = 000000000000000000000000000000; // 2912;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/-8jjTVuev_s?t=';
const double _startSecondsone = 00000000000000000000000000000; // 1029;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/HbUGTcdFIio?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1458;
const String _videoIdthree = 'VIDEOhttps://youtu.be/Udk8YHOy0EU?t=';
const double _startSecondsthree = 000000000000000000000000000; // 994;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/0hg5n3KnrGo?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 722;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/eaa5onIXG_0?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 240;
