...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Ducks have a thick layer of fat to keep them warm.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The product is made from a single layer of plastic.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They put on thick hats and extra layers of clothing.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There were too many layers of management in the company.""");
  }
...
// With short examples define "layer", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) چین؛ بڕێک لە شتێک کە لەسەر ڕوویەکە یان لە نێوان چەند ڕوویەکە"""),
                    SentencesRow(
                      englishText: """A thin layer of dust covered everything.""",
                      kurdishText: """چینێکی تەنک لە تۆز هەموو شتی داپۆشی بوو.""",
                    ...
                    SentencesRow(
                      englishText: """Ducks have a thick layer of fat to keep them warm.""",
                      kurdishText: """سۆنە چینێکی ئەستوور لە چەوری هەیە بۆ هێشتنەوەی بە گەرمی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """How many layers of clothing are you wearing?""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The product is made from a single layer of plastic.""",
                      kurdishText: """بەرهەمەکە بە تاکە چینێک لە پلاستیک درووستکراوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They put on thick hats and extra layers of clothing.""",
                      kurdishText: """کڵاوی ئەستوور و چینی زیادە لە جل لەبەر دەکەن.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ئاست یان بەشێکی سیستەمێک یان ژمارەیەک بیرۆکە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There were too many layers of management in the company.""",
                      kurdishText: """ژمارەیەکی زۆری ئاستی بەڕێوەبردن هەبوو لە کۆمپانیاکە.""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) ڕێکخستنی شتێک بە چین"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Layer the potatoes and onions in a dish.""",
