...
class EnglishEntryfagged extends StatefulWidget {
  const EnglishEntryfagged({super.key});

  @override
  State<EnglishEntryfagged> createState() => _EnglishEntryfaggedState();
}

class _EnglishEntryfaggedState extends State<EnglishEntryfagged> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fagged""",
                      alsoEnglishWord: "also: fagged out",
                      britshText: """IpaUK: /fæɡd/""",
                      americanText: """IpaUS: /fæɡd/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They were fagged from studying all night.""");
  }
...
"""),
          ...
          SentencesRow(
            englishText: """They were fagged from studying all night.""",
            kurdishText: """شەکەت بوون بە خوێندن بۆ تەواوی شەوەکە.""",
...
const String _videoIdend = 'https://youtu.be/it4BGLrnl-g?t=';
const double _startSecondsend = 00000000000000000000000000022018;
const String _videoIdone = 'https://youtu.be/Gnh6pWiOOHs?t=';
const double _startSecondsone = 000000000000000000000000000539;
const String _videoIdtwo = 'https://youtu.be/TUhwCIHqVOs?t=';
const double _startSecondstwo = 00000000000000000000000000011177;
const String _videoIdthree = 'https://youtu.be/6CZ0Q6jw4Z4?t=';
const double _startSecondsthree = 00000000000000000000000000014373;
const String _videoIdfour = 'https://youtu.be/5C-ofwiClGM?t=';
const double _startSecondsfour = 0000000000000000000000000003393;
const String _videoIdfive = 'https://youtu.be/3NHeBlJwc3I?t=';
const double _startSecondsfive = 000000000000000000000000000934;
