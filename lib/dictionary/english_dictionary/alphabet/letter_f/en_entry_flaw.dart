...
class EnglishEntryflaw extends StatefulWidget {
  const EnglishEntryflaw({super.key});

  @override
  State<EnglishEntryflaw> createState() => _EnglishEntryflawState();
}

class _EnglishEntryflawState extends State<EnglishEntryflaw> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flaw (Derived forms: flaws, flawing, flawed)
1. An imperfection in an object or machine (= defect, fault)
...
- Verb: flaw (Derived forms: flaws, flawing, flawed)
1. Add a flaw or blemish to; make imperfect or defective (= blemish)
""",
  );

  final String keyword = "flaw";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Flaws have appeared in the new version of the software.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It took me a long time to find the flaw in her logic.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There is always a flaw in the character of a tragic hero.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The hero's fatal flaw is ambition.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Unfortunately, this plate has a slight flaw in it.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flaw""",
                      // alsoEnglishWord: "also: flaw",
                      britshText: """IpaUK: /flɔː/""",
                      americanText: """IpaUS: /flɔː/""",
...
کوردی: ناتەواوی، عەیب، خەوش،	(شووشە، چینکۆ و هتد) موو، چڕژ، چڕژاوی، قەڵەشێوی، درز،	خاڵی لاوازی، کەم‌وکووڕی، ناتەواوی، شکستی، عەیب، ئیراد،	هەڵە، لێ‌هەڵقڵیشان، خەتا
"""),
// With short examples define "flaw", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هەڵەی شتێک کە واتای ئەوەیە هەڵەی تێدایە یان باش کار ناکات"""),
                    SentencesRow(
                      englishText:
                          """The report reveals fatal flaws in security at the airport.""",
                      kurdishText:
                          """ڕاپۆرتەکە خەوشی کوشندە لە سەلامەتیی فڕۆکەخانەکە پیشان دەدات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کێشە دەرکەوتووە لە وەشانی تازەی نەرمامێرەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کاتێکی زۆری پێچوو بۆم بۆ دۆزینەوەی هەڵەی لۆژیکەکەی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەمیشە هەڵەیەک هەیە لە کەسایەتیی پاڵەوانی تراژیدی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The hero's fatal flaw is ambition.""",
                      kurdishText: """کەم‌وکووڕی پاڵەوانەکە تەماحە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) هەڵە یان شکانی بچووک کە وا دەکات شتێک جوانی یان بەهای کەمتر بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Unfortunately, this plate has a slight flaw in it.""",
                      kurdishText:
                          """بەداخەوە ئەم دەورییە شکاوییەکی بچووکی هەیە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/dtp6b76pMak?t=';
const double _startSecondsend = 0000000000000000000000000002179;
const String _videoIdone = 'https://youtu.be/KQWGHE7NTUA?t=';
const double _startSecondsone = 000000000000000000000000000157;
const String _videoIdtwo = 'https://youtu.be/wknSc6HRUMI?t=';
const double _startSecondstwo = 000000000000000000000000000238;
const String _videoIdthree = 'https://youtu.be/g9QneAV4fVo?t=';
...
const double _startSecondsfive = 000000000000000000000000000388;
