...
class EnglishEntrylobster extends StatefulWidget {
  const EnglishEntrylobster({super.key});

  @override
  State<EnglishEntrylobster> createState() => _EnglishEntrylobsterState();
}

class _EnglishEntrylobsterState extends State<EnglishEntrylobster> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lobster""");
  }
