...
class EnglishEntryintend extends StatefulWidget {
  const EnglishEntryintend({super.key});

  @override
  State<EnglishEntryintend> createState() => _EnglishEntryintendState();
}

class _EnglishEntryintendState extends State<EnglishEntryintend> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: intend (Derived forms: intends, intended, intending)
1. Have in mind as a purpose (- mean, think)
"I intend no harm";
 
2. Design or destine (- destine, designate, specify)
"She was intended to become the director";
 
3. Have the intention to express or convey; have a particular sense or meaning (- mean)
"what do his words intend?";
 
4. Denote or connote (- mean, signify, stand for)
 
5. Have as a plan or objective (- aim, purpose, purport, propose)
"I intend to arrive at noon";
""",
  );

  final String keyword = "intend";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We finished later than we had intended.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I fully intended to pay for the damage.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I never intended to hurt you.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He intended her no harm.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It is intended that production will start next month.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We intend that production will start next month.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What exactly did you intend by that remark?""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He intended it as a joke.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001754;
    const String videoIdone = 'https://youtu.be/FPAk81X3tTY?t=';
    const double startSecondsone = 000000000000000000000000000819;
    const String videoIdtwo = 'https://youtu.be/k4vRFodAqWo?t=';
    const double startSecondstwo = 000000000000000000000000000108;
    const String videoIdthree = 'https://youtu.be/sV6uuMAnJUE?t=';
    const double startSecondsthree = 00000000000000000000000000065;
    const String videoIdfour = 'https://youtu.be/gjySnrspD7E?t=';
    const double startSecondsfour = 0000000000000000000000000001399;
    const String videoIdfive = 'https://youtu.be/_0RTH57v66I?t=';
    const double startSecondsfive = 000000000000000000000000000503;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """intend""",
                      // alsoEnglishWord: "also: intend",
                      britshText: """IpaUK: /ɪnˈtend/""",
                      americanText: """IpaUS: /ɪnˈtend/""",
...
کوردی: 
"""),
// With short examples define "intend", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) هەبوونی پلان، ئەنجام، یان مەبەستێک لە مێشکتدا کە شتێک دەکەیت"""),
                    SentencesRow(
                      englishText:
                          """We finished later than we had intended.""",
                      kurdishText:
                          """درەنگتر لەوە تەواوبووین کە نیازمان هەبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە تەواوی نیازی ئەوەم هەبوو کە زیانەکە ببژێرم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I never intended to hurt you.""",
                      kurdishText: """هەرگیز مەبەستم نەبوو کە ئازارت بدەم.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The train we had originally intended to catch had already left.""",
                      kurdishText:
                          """ئەو شەمەندەفەرەی سەرەتا ویستمان بیگرین پێشوەختە ڕۆشتبوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The writer clearly intends his readers to identify with the main character.""",
                      kurdishText:
                          """نووسەرەکە بە ڕوونی دەیەوێت خوێنەران خۆیان بە کارەکتەری سەرەکییەوە ببەستنەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """نەیدەویست هیچ زیانێکی پێبگەیەنێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئامانجی ئەوەیە هەیە کە بەرهەمهێنان لە مانگی داهاتوو دەست پێبکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئامانجمانە بەرهەمهێنان لە مانگی داهاتوو دەست پێبکات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) هەبوونی مەبەستی ئەوەی شتێک واتایەکی هەبێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: mean"),
                    SentencesRow(
                      englishText:
                          """What exactly did you intend by that remark?""",
                      kurdishText: """مەبەستت چی بوو لەو لێدوانە؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He intended it as a joke.""",
                      kurdishText: """بە نوکتە مەبەستی بوو.""",
