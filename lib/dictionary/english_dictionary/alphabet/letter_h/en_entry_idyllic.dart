...
class EnglishEntryidyllic extends StatefulWidget {
  const EnglishEntryidyllic({super.key});

  @override
  State<EnglishEntryidyllic> createState() => _EnglishEntryidyllicState();
}

class _EnglishEntryidyllicState extends State<EnglishEntryidyllic> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""idyllic""");
  }
