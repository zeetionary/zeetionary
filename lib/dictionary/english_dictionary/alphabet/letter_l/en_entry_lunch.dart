...
class EnglishEntrylunch extends StatefulWidget {
  const EnglishEntrylunch({super.key});

  @override
  State<EnglishEntrylunch> createState() => _EnglishEntrylunchState();
}

class _EnglishEntrylunchState extends State<EnglishEntrylunch> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylunch lunch
WORD_WEB lunch lunch lunch
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lunch";
...
کوردی: 
"""),
// With short examples define "lunch", please follow LX instructions
