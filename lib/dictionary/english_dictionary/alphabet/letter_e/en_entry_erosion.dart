...
class EnglishEntryerosion extends StatefulWidget {
  const EnglishEntryerosion({super.key});

  @override
  State<EnglishEntryerosion> createState() => _EnglishEntryerosionState();
}

class _EnglishEntryerosionState extends State<EnglishEntryerosion> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""erosion""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """erosion""",
                      // alsoEnglishWord: "also: erosion",
                      britshText: """IpaUK: /ɪˈrəʊʒn/""",
                      americanText: """IpaUS: /ɪˈrəʊʒn/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Storms accelerate the erosion of the coastline by the sea.""");
  }
...
کوردی: داکڕاندن، داخوراندن، کڕاندن، ڕووتاندنەوە، ساورانەوە، داکڕان، کڕان، ڕووتانەوە، ڕاماڵین، داخوران، داشۆران (بە کاری با، باران و هتد)،	پووکانەوە، داچوون، تیاچوون،	کەم‌بوونەوە، دابەزین، داکشان
"""),
          const DefinitionKurdish(
              text: """١. (ناو) پڕۆسەی کەم‌کەم لەناوچوون بە با، باران، هتد"""),
          SentencesRow(
            englishText:
                """Storms accelerate the erosion of the coastline by the sea.""",
            kurdishText:
                """زریانەکان داخورانی کەنارەکە بە دەریاکە خێراتر دەکەن.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) پڕۆسەی لەناوبردن یان لاوازکردنی شتێک بە تێپەڕبوونی کات"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """Many see these security measures as an erosion of civil liberties.""",
            kurdishText:
                """زۆر کەس ڕێکارەکانی ئاسایش وەک لەناوبردنی ئازادیی تاک دەبینن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: erosion (Derived forms: erosions)
1. (geology) the mechanical process of wearing or grinding something down (as by particles washing over it), also figuratively (= eroding, eating away, wearing, wearing away, degradation)
...
4. Wearing away by chemical action (= corrosion, corroding)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/_rBO8neWw04?t=';
const double _startSecondsend = 000000000000000000000000000000; // 268;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/-cPdImejxEQ?t=';
const double _startSecondsone = 00000000000000000000000000000; // 220;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/Ek1buV2HA68?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 338;
const String _videoIdthree = 'VIDEOhttps://youtu.be/9bPIaHg11mI?t=';
const double _startSecondsthree = 000000000000000000000000000; // 191;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/jxNM4DGBRMU?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 173;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/eXaIpTj3vOs?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 647;
