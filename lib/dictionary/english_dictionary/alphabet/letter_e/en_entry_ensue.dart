...
class EnglishEntryensue extends StatefulWidget {
  const EnglishEntryensue({super.key});

  @override
  State<EnglishEntryensue> createState() => _EnglishEntryensueState();
}

class _EnglishEntryensueState extends State<EnglishEntryensue> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ensue""",
                      // alsoEnglishWord: "also: ensue",
                      britshText: """IpaUK: /ɪnˈsjuː/""",
                      americanText: """IpaUS: /ɪnˈsuː/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""An argument ensued.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The riot police swooped in and chaos ensued.""");
  }
...
// With short examples define "ensue", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          const DefinitionKurdish(
              text: """١. (کردار) ڕوودان لە دوای شتێک یان لە ئەنجامی"""),
          SentencesRow(
            englishText: """An argument ensued.""",
            kurdishText: """مشتومڕێک درووست بوو (لە ئەنجامی شتێک).""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The riot police swooped in and chaos ensued.""",
            kurdishText: """پۆلیسی ئاژاوەگێڕی هاتنە ژوورەوە و ئاڵۆزی ڕوویدا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: ensue (Derived forms: ensued, ensues, ensuing)
1. Happen afterwards as a consequence (= result)
""",
  );
...
const String _videoIdend = 'https://youtu.be/pHGweqJCx2s?t=';
const double _startSecondsend = 309;
const String _videoIdone = 'https://youtu.be/tMNxgi_0eKA?t=';
const double _startSecondsone = 376;
...
const double _startSecondsthree = 3368;
const String _videoIdfour = 'https://youtu.be/6y8BiXC8c98?t=';
const double _startSecondsfour = 651;
const String _videoIdfive = 'https://youtu.be/XkYvo6S82LE?t=';
const double _startSecondsfive = 1587;
const String _videoIdsix = 'https://youtu.be/fBTjbGfHx0s?t=';
const double _startSecondssix = 973;
