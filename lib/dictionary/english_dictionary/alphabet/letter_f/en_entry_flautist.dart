...
class EnglishEntryflautist extends StatefulWidget {
  const EnglishEntryflautist({super.key});

  @override
  State<EnglishEntryflautist> createState() => _EnglishEntryflautistState();
}

class _EnglishEntryflautistState extends State<EnglishEntryflautist> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flautist
Usage: Brit (N. Amer: flutist)
1. Someone who plays the flute (= flutist [N. Amer], flute player) (= Derived forms: flautists)
""",
  );

  final String keyword = "flautist";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flautist""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The orchestra featured a talented flautist.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flautist""",
                      // alsoEnglishWord: "also: flautist",
                      britshText: """IpaUK: /ˈflɔːtɪst/""",
                      americanText: """IpaUS: /ˈflɔːtɪst/,  /ˈflaʊtɪst/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """The orchestra featured a talented flautist.""",
                      kurdishText:
                          """ئۆرکێستراکە فلوت‌ژەنێکی بەهرەمەندی تێدا بوو.""",
...
const double _startSecondsend = 000000000000000000000000000404;
const String _videoIdone = 'https://youtu.be/93A1ryc-WW0?t=';
const double _startSecondsone = 000000000000000000000000000542;
const String _videoIdtwo = 'https://youtu.be/ArD1vHwFjNg?t=';
const double _startSecondstwo = 00000000000000000000000000018;
const String _videoIdthree = 'https://youtu.be/OFUt6fjBiQk?t=';
const double _startSecondsthree = 000000000000000000000000000305;
const String _videoIdfour = 'https://youtu.be/wsqCjO3D9yc?t=';
const double _startSecondsfour = 000000000000000000000000000150;
const String _videoIdfive = 'https://youtu.be/azfup51PURc?t=';
