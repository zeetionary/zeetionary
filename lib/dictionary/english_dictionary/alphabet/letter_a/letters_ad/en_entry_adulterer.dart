...
class EnglishEntryadulterer extends StatelessWidget {
  EnglishEntryadulterer({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈdʌltərə(r)/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '6tYxnt3gCyI';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'mL-1OdkF0nE';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'hlCc_TA7gw8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'z0-Q3Jl7vng';
