...
class EnglishEntryinfatuated extends StatefulWidget {
  const EnglishEntryinfatuated({super.key});

  @override
  State<EnglishEntryinfatuated> createState() => _EnglishEntryinfatuatedState();
}

class _EnglishEntryinfatuatedState extends State<EnglishEntryinfatuated> {
  @override
  void initState() {
    super.initState();
...
1. Feeling strong, obsessive or foolish love (- enamored [US], in love, potty [Brit, informal], smitten, soft on, taken with, enamoured [Brit, Cdn], besotted, lovestruck [informal])
"he was infatuated with her";
""",
  );

  final String keyword = "infatuated";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infatuated""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was completely infatuated with him.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He’s behaving like an infatuated teenager.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/3miuxAnawmM?t=';
    const double startSecondsend = 00000000000000000000000000019;
    const String videoIdone = 'https://youtu.be/g-7ZWPCWv0U?t=';
    const double startSecondsone = 00000000000000000000000000011;
    const String videoIdtwo = 'https://youtu.be/cMBrvHsFD_8?t=';
    const double startSecondstwo = 000000000000000000000000000792;
    const String videoIdthree = 'https://youtu.be/H5_HVUS1l0Y?t=';
    const double startSecondsthree = 000000000000000000000000000246;
    const String videoIdfour = 'https://youtu.be/YpkP6BZIFDE?t=';
    const double startSecondsfour = 000000000000000000000000000124;
    const String videoIdfive = 'https://youtu.be/2sCki6KlTf8?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """infatuated""",
                      // alsoEnglishWord: "also: infatuated",
                      britshText: """IpaUK: /ɪnˈfætʃueɪtɪd/""",
                      americanText: """IpaUS: /ɪnˈfætʃueɪtɪd/""",
...
// With short examples define "infatuated", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تەواو شێت و شەیدای بووبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەو وەک هەرزەکارێکی شەیدا هەڵسوکەوت دەکات.""",
