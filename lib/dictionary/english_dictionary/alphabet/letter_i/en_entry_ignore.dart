...
class EnglishEntryignore extends StatefulWidget {
  const EnglishEntryignore({super.key});

  @override
  State<EnglishEntryignore> createState() => _EnglishEntryignoreState();
}

class _EnglishEntryignoreState extends State<EnglishEntryignore> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: ignore (Derived forms: ignored, ignores, ignoring)
1. Refuse to acknowledge (- disregard, snub, cut)
 
2. Bar from attention or consideration (- dismiss, disregard, brush aside, brush off [informal], discount, push aside)
"She ignored his advances";
 
3. Fail to notice
 
4. Give little or no attention to (- neglect, disregard)
"ignore the errors";
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """He ignored the speed limit sign and accelerated down the road.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I made a suggestion but they chose to ignore it.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""His work was largely ignored and forgotten for 30 years.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She ignored him and carried on with her work.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""If he tries to start an argument, just ignore him.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/QaZ93sibpk0?t=';
    const double startSecondsend = 000000000000000000000000000431;
    const String videoIdone = 'https://youtu.be/j1BfO7VlIw4?t=';
    const double startSecondsone = 000000000000000000000000000619;
    const String videoIdtwo = 'https://youtu.be/tLD-OUkYtk4?t=';
    const double startSecondstwo = 000000000000000000000000000221;
    const String videoIdthree = 'https://youtu.be/9TugA_z5vQE?t=';
    const double startSecondsthree = 0000000000000000000000000001421;
    const String videoIdfour = 'https://youtu.be/dqcSk-EDrRo?t=';
    const double startSecondsfour = 0000000000000000000000000001124;
    const String videoIdfive = 'https://youtu.be/b2lDdwxNWto?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ignore""",
                      // alsoEnglishWord: "also: ignore",
                      britshText: """IpaUK: /ɪɡˈnɔː(r)/""",
                      americanText: """IpaUS: /ɪɡˈnɔːr/""",
...
// کوردی: خۆ گێلکردن، دەبەرچاونەگرتن، چاوپۆشیکردن
// """),
// With short examples define "ignore", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) ئەوەی کە سەرنج بە شتێک نەدەیت"""),
                    SentencesRow(
                      englishText:
                          """He ignored the speed limit sign and accelerated down the road.""",
                      kurdishText:
                          """نیشانەی تیژڕەوەی سنوورداری سەری ڕێگاکەی پشتگوێ خست و بە ڕێگاکە خێراتر بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پێشنیارێکم کرد بەڵام بڕیاریان دا پشتگوێی بخەن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She deliberately ignored my question and changed the subject.""",
                      kurdishText:
                          """بە ئەنقەست پرسیارەکەمی پشتگوێ خست و بابەتەکەی گۆڕی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """We can't ignore the fact that there is a huge problem here.""",
                      kurdishText:
                          """ناتوانین ئەو ڕاستییە پشتگوێ بخەین کە کێشەیەکی گەورە هەیە لێرە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کارەکەی تا ڕادەیەکی زۆر پشتگوێ خرا و بۆ ٣٠ ساڵ لەبیرکرا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Much of social science research simply ignores these sectors.""",
                      kurdishText:
                          """زۆرینەی توێژینەوەی زانستی کۆمەڵایەتی بە سادەیی ئەم سێکتەرانە پشتگوێ دەخەن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I've learned to ignore all of my sister's hurtful comments.""",
                      kurdishText:
                          """فێربوومە هەموو لێدوانە زیانبەخشەکانی خوشکەکەم پشتگوێ بخەم.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) ئەوەی وەها پیشانی بدەیت کەسێکت نەدیوە یان شتێک نابینیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She ignored him and carried on with her work.""",
                      kurdishText: """پشتگوێی خست و لە کارەکەی بەردەوام بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەگەر هەوڵی دا مشتومڕ دەست پێبکات، تەنها پشتگوێی بخە.""",
