...
class EnglishEntrybiodegradable extends StatelessWidget {
  ...
  Future<void> speakbiodegradables1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Most plastics are not biodegradable.");
  }
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'Lx0aUk2AiNQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'tp-FsXHVFoU';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'bBI2-tI95nM';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'wt32GgQGTcI';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'qANWN0TKH0A';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'z88mX0tSPdc';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'H39duDP0E4w';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'dzI3yzwztzg';
  final double _startSeconds = 0;
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'C-M4v5xzfbs';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'zoMxteyzSPo';
