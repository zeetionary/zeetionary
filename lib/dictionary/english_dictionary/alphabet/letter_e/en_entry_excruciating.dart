...
class EnglishEntryexcruciating extends StatefulWidget {
  const EnglishEntryexcruciating({super.key});

  @override
  State<EnglishEntryexcruciating> createState() =>
      _EnglishEntryexcruciatingState();
}

class _EnglishEntryexcruciatingState extends State<EnglishEntryexcruciating> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""excruciating""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """excruciating""",
                      // alsoEnglishWord: "also: excruciating",
                      britshText: """IpaUK: /ɪkˈskruːʃieɪtɪŋ/""",
                      americanText: """IpaUS: /ɪkˈskruːʃieɪtɪŋ/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "excruciating";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The pain in my back was excruciating.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He rolled on the floor in excruciating agony.""");
  }
...
// With short examples define "excruciating", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: بەژان، توند، کەسکوون، بەئازار، بەئێش، گران، سەخت،	لە ڕادەبەدەر، لە ئەندازبەدەر
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) تەواو بەئازار یان خراپ"""),
          SentencesRow(
            englishText: """The pain in my back was excruciating.""",
            kurdishText: """ئازاری پشتم تەواو بەئازار بوو.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He rolled on the floor in excruciating agony.""",
            kurdishText: """لە ئازاری توندا بەسەر زەوییەکەدا دەگەوزا.""",
...
1. Extremely painful (= agonizing, agonising [Brit], harrowing, torturing, torturous, torturesome)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/tXjHb5QmDV0?t=';
const double _startSecondsend = 000000000000000000000000000000; // 72;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/pFmtmO2cnlg?t=';
const double _startSecondsone = 00000000000000000000000000000; // 238;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/hoihoGGdQ4U?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 750;
const String _videoIdthree = 'VIDEOhttps://youtu.be/BmwVxj6E2KE?t=';
const double _startSecondsthree = 000000000000000000000000000; // 52;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/zVqFAMOtwaI?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 381;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/qPSYkdhR890?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 2331;
