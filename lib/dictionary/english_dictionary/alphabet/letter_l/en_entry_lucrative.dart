...
class EnglishEntrylucrative extends StatefulWidget {
  const EnglishEntrylucrative({super.key});

  @override
  State<EnglishEntrylucrative> createState() => _EnglishEntrylucrativeState();
}

class _EnglishEntrylucrativeState extends State<EnglishEntrylucrative> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylucrative lucrative
WORD_WEB lucrative lucrative lucrative
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lucrative";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lucrative""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lucrative""",
                      // alsoEnglishWord: "also: lucrative",
...
کوردی: 
"""),
// With short examples define "lucrative", please follow LX instructions
