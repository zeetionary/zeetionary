...
class EnglishEntrygristle extends StatefulWidget {
  const EnglishEntrygristle({super.key});

  @override
  State<EnglishEntrygristle> createState() => _EnglishEntrygristleState();
}

class _EnglishEntrygristleState extends State<EnglishEntrygristle> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gristle (Derived forms: gristles)
1. Tough elastic tissue; mostly converted to bone in adults (- cartilage)
""",
  );

  final String keyword = "gristle";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gristle""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He chewed on a lump of gristle and spat it out.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gristle""",
                      // alsoEnglishWord: "also: gristle",
                      britshText: """IpaUK: /ˈɡrɪsl/""",
                      americanText: """IpaUS: /ˈɡrɪsl/""",
...
// With short examples define "gristle", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """He chewed on a lump of gristle and spat it out.""",
                      kurdishText:
                          """قەپی لە پارچەیەک لە ئێسکە نەرمە گرت و تفاندییەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/eqAcVASDZ3g?t=';
const double _startSecondsend = 00000000000000000000000000087;
const String _videoIdone = 'https://youtu.be/21igfoUrRCg?t=';
const double _startSecondsone = 000000000000000000000000000571;
const String _videoIdtwo = 'https://youtu.be/uw58vDsGbOg?t=';
const double _startSecondstwo = 000000000000000000000000000760;
const String _videoIdthree = 'https://youtu.be/eQ9eY0_DoEk?t=';
const double _startSecondsthree = 000000000000000000000000000132;
const String _videoIdfour = 'https://youtu.be/7sNBAoPYWKQ?t=';
const double _startSecondsfour = 000000000000000000000000000571;
const String _videoIdfive = 'https://youtu.be/Ob8gpcBmGvg?t=';
