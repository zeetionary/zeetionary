...
class EnglishEntryeyesore extends StatefulWidget {
  const EnglishEntryeyesore({super.key});

  @override
  State<EnglishEntryeyesore> createState() => _EnglishEntryeyesoreState();
}

class _EnglishEntryeyesoreState extends State<EnglishEntryeyesore> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""eyesore""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """eyesore""",
                      // alsoEnglishWord: "also: eyesore",
                      britshText: """IpaUK: /ˈaɪsɔː(r)/""",
                      americanText: """IpaUS: /ˈaɪsɔːr/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""That old factory is a real eyesore!""");
  }
...
const String _videoIdend = 'https://youtu.be/PzNxcyslplw?t=';
const double _startSecondsend = 000000000000000000000000000339;
const String _videoIdone = 'https://youtu.be/YkmlPaGui5k?t=';
const double _startSecondsone = 0000000000000000000000000001828;
const String _videoIdtwo = 'https://youtu.be/4brrubUsqB0?t=';
const double _startSecondstwo = 000000000000000000000000000288;
const String _videoIdthree = 'https://youtu.be/qrx8FB41qpo';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/9m8n8RXTtEU?t=';
const double _startSecondsfour = 000000000000000000000000000;
const String _videoIdfive = 'https://youtu.be/kvo-n2AYZnA?t=';
