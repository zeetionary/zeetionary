...
class EnglishEntryhardcopy extends StatefulWidget {
  const EnglishEntryhardcopy({super.key});

  @override
  State<EnglishEntryhardcopy> createState() => _EnglishEntryhardcopyState();
}

class _EnglishEntryhardcopyState extends State<EnglishEntryhardcopy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hard copy (Derived forms: hard copies)
1. (computing) matter that is held in a computer and is typed or printed on paper
"he ran off a hard copy of the report"
""",
  );

  final String keyword = "hard copy";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hard copy""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""You will need to supply a hard copy version of all files.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hard copy""",
                      // alsoEnglishWord: "also: hard copy",
                      britshText: """IpaUK: /ˌhɑːd ˈkɒpi/""",
                      americanText: """IpaUS: /ˌhɑːrd ˈkɑːpi/""",
