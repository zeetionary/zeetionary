...
class EnglishEntryindustrious extends StatefulWidget {
  const EnglishEntryindustrious({super.key});

  @override
  State<EnglishEntryindustrious> createState() =>
      _EnglishEntryindustriousState();
}

class _EnglishEntryindustriousState extends State<EnglishEntryindustrious> {
  @override
  void initState() {
    super.initState();
...
1. Characterized by hard work and perseverance (- hardworking, tireless, untiring)
"These industrious people must have higher income";
 
2. Working hard to promote an enterprise (- energetic, gumptious)
""",
  );

  final String keyword = "industrious";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""industrious""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She was surrounded by energetic, industrious people.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She's extremely competent and industrious.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000670;
    const String videoIdone = 'https://youtu.be/HtLddZHaXOk?t=';
    const double startSecondsone = 00000000000000000000000000051;
    const String videoIdtwo = 'https://youtu.be/aTMsfOcHiJg?t=';
    const double startSecondstwo = 0000000000000000000000000001174;
    const String videoIdthree = 'https://youtu.be/zj6p5kYnPPY?t=';
    const double startSecondsthree = 00000000000000000000000000056;
    const String videoIdfour = 'https://youtu.be/hoTxiRWrvp8?t=';
    const double startSecondsfour = 000000000000000000000000000166;
    const String videoIdfive = 'https://youtu.be/Mn4VDwaV-oo?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """industrious""",
                      // alsoEnglishWord: "also: industrious",
                      britshText: """IpaUK: /ɪnˈdʌstriəs/""",
                      americanText: """IpaUS: /ɪnˈdʌstriəs/""",
...
کوردی: بەکار، بەچنگ، زەحمەت‌کێش، ڕەنج‌کێش، تێکۆشەر، (بە)ڕشت، شارەزا، کارامە، لێزان، کارزان
"""),
// With short examples define "industrious", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە سەرقاڵە و بە سەختی کار دەکات"""),
                    SentencesRow(
                      englishText:
                          """She was surrounded by energetic, industrious people.""",
                      kurdishText:
                          """لەلایەن کەسانی پڕوزەی زەئمەتکێش دەور درابوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تەواو کارامە و تێکۆشەرە.""",
