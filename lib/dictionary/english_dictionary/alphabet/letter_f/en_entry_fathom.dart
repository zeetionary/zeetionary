...
class EnglishEntryfathom extends StatefulWidget {
  const EnglishEntryfathom({super.key});

  @override
  State<EnglishEntryfathom> createState() => _EnglishEntryfathomState();
}

class _EnglishEntryfathomState extends State<EnglishEntryfathom> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fathom""",
                      // alsoEnglishWord: "also: fathom",
                      britshText: """IpaUK: /ˈfæðəm/""",
                      americanText: """IpaUS: /ˈfæðəm/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He couldn't fathom out what the man could possibly mean.""");
  }
...
کوردی: 
"""),
          const DefinitionKurdish(text: """١. (کردار) تێگەشتن لە شتێک"""),
          SentencesRow(
            englishText:
                """She knew he was angry with her, for some reason she couldn't fathom.""",
            kurdishText:
                """دەیزانی تووڕە بوو لەگەڵی، بۆ چەند هۆکارێک تێنەدەگەشت بۆچی.""",
          ...
          SentencesRow(
            englishText:
                """It is hard to fathom the pain felt at the death of a child.""",
            kurdishText:
                """سەختە تێگەشتن بکرێت بۆ ئازاری تووشبوو بە مەرگی منداڵێک.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """نەیدەتوانی تێبگات کە پیاوەکە دەکرا مەبەستی چی بێت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: fathom (Derived forms: fathomed, fathoming, fathoms)
1. Come to understand (= penetrate, bottom)
 
2. Measure the depth of (a body of water) with a sounding line (= sound)

- Noun: fathom (Derived forms: fathoms)
1. A linear unit of measurement (equal to 6 feet) for water depth (= fthm)
 
2. (mining) a unit of volume (equal to 6 cubic feet) used in measuring bodies of ore (= fthm)
""",
  );
...
const String _videoIdend = 'https://youtu.be/gwZuUxeBYV8?t=';
const double _startSecondsend = 000000000000000000000000000244;
const String _videoIdone = 'https://youtu.be/tMNxgi_0eKA?t=';
const double _startSecondsone = 000000000000000000000000000374;
const String _videoIdtwo = 'https://youtu.be/jw7LD2-gg14?t=';
const double _startSecondstwo = 000000000000000000000000000487;
const String _videoIdthree = 'https://youtu.be/-BeTq99LqUo?t=';
const double _startSecondsthree = 000000000000000000000000000920;
const String _videoIdfour = 'https://youtu.be/YJn6kJcDDTA?t=';
const double _startSecondsfour = 000000000000000000000000000402;
const String _videoIdfive = 'https://youtu.be/USL6P8haroY?t=';
