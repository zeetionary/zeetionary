...
class EnglishEntryageing extends StatelessWidget {
  ...
  //   await flutterTts.speak("ageing (or aging)");
  // }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈeɪdʒɪŋ/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakageing("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈeɪdʒɪŋ/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakageing("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'cuC-V-A_5vY';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'wc4fJdVIpMc';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '-tKdxZ7LV2A';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '9Zja_cIAwY8';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'xY1b3-8IEac';
