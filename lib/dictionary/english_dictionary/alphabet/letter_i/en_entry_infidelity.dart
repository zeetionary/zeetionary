...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'jxahNT2pHkg';
    const double startSecondsend = 403;
    const String videoIdone = 'XNN1Hbg9oNU';
    const double startSecondsone = 636;
    const String videoIdtwo = 'QLv7SkInz70';
    const double startSecondstwo = 692;
    const String videoIdthree = 'HbUGTcdFIio';
    const double startSecondsthree = 615;
    const String videoIdfour = '3yi0FNwOYiI';
