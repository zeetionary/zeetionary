...
class EnglishEntryadjudicator extends StatefulWidget {
...
// 188888880002200
  ...
  final String keyword = "adjudicator";
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsone = 593;
    const String videoIdtwo = 'qBEKBgIVGxE';
    const double startSecondstwo = 94;
    const String videoIdthree = 'Xw4K-fW32zQ';
    const double startSecondsthree = 314;
    const String videoIdfour = 'CyVw2bz4Roc';
    const double startSecondsfour = 1;
    const String videoIdfive = 'w5K2ZoPVD5E';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """adjudicator""",
                      // alsoEnglishWord: "also: adjudicator",
                      britshText: """IpaUK: /əˈdʒuːdɪkeɪtə(r)/""",
                      americanText: """IpaUS: /əˈdʒuːdɪkeɪtər/""",
