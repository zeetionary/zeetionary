                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "ancestor"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈænsestə(r)/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈænsestər/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '9kakBfGxhpM';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'KN7sekRxFHg';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'QkCJcTtjDME';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'jBBJvgK5YAg';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'KD1R9AIFB0c';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'M8lm9HOHwZY';
