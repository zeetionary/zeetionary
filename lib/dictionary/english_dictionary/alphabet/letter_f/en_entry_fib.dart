...
class EnglishEntryfib extends StatefulWidget {
  const EnglishEntryfib({super.key});

  @override
  State<EnglishEntryfib> createState() => _EnglishEntryfibState();
}

class _EnglishEntryfibState extends State<EnglishEntryfib> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Stop telling fibs.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Come on, don't fib! Where were you really last night?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fib""",
                      // alsoEnglishWord: "also: fib",
                      britshText: """IpaUK: /fɪb/""",
                      americanText: """IpaUS: /fɪb/""",
...
// With short examples define "fib", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وازبێنە، درۆمەکە! دوێنێ شەو لە کوێ بوویت؟""",
...
const double _startSecondsend = 000000000000000000000000000136;
const String _videoIdone = 'https://youtu.be/waZyyWnNJ_Y?t=';
const double _startSecondsone = 000000000000000000000000000568;
const String _videoIdtwo = 'https://youtu.be/pLwHTqU2r_Y?t=';
const double _startSecondstwo = 000000000000000000000000000285;
const String _videoIdthree = 'https://youtu.be/0xvp0xMKyvI?t=';
const double _startSecondsthree = 00000000000000000000000000038;
const String _videoIdfour = 'https://youtu.be/oBt53YbR9Kk?t=';
const double _startSecondsfour = 000000000000000000000000000641;
const String _videoIdfive = 'https://youtu.be/wwzFB_UjtVQ?t=';
const double _startSecondsfive = 0000000000000000000000000003337;
