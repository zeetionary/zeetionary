...
class EnglishEntryfrank extends StatefulWidget {
  const EnglishEntryfrank({super.key});

  @override
  State<EnglishEntryfrank> createState() => _EnglishEntryfrankState();
}

class _EnglishEntryfrankState extends State<EnglishEntryfrank> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: frank (Derived forms: franker, frankest)
1. Characterized by directness in manner or speech; without subtlety or evasion (= blunt, candid, forthright, free-spoken, outspoken, plainspoken, point-blank, straight-from-the-shoulder)
"tell me what you think--and you may just as well be frank";
 
2. Clearly manifest; evident
"frank enjoyment"

- Noun: frank (Derived forms: franks)
1. [US, informal] A smooth-textured sausage of minced beef or pork usually smoked; often served on a bread roll (= frankfurter, hotdog, hot dog, dog [informal], wiener [N. Amer, S.Africa], wienerwurst [N. Amer], weenie [N. Amer, informal], wienie [N. Amer, informal])
 
3. Device or marking such as postage stamp, printed or stamped impressions, codings, labels, manuscript writings, or any other authorized form of markings affixed or applied to mails to qualify them to be postally serviced. (= franking)

- Verb: frank (Derived forms: Derived forms: franked, franking, franks)
1. Stamp with a postmark to indicate date and time of mailing (= postmark)
...
""",
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""To be frank, I don't care who wins.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frank""",
                      // alsoEnglishWord: "also: frank",
                      britshText: """IpaUK: /fræŋk/""",
                      americanText: """IpaUS: /fræŋk/""",
...
// With short examples define "frank", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) گوتنی ئەوەی کە دەتەوێت، کە هەندێک جار کەسانی دیکە ڕەنگە حەزیان لێی نەبێت"""),
                    SentencesRow(
                      englishText:
                          """He was very frank about his relationship with the actress.""",
                      kurdishText:
                          """زۆر ڕاشکاو بوو سەبارەت بە پەیوەندیی لەگەڵ خانمە ئەکتەرەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """To be frank with you, I think your son has little chance of passing the exam.""",
                      kurdishText:
                          """ڕاشکاو بم لەگەڵت، پێموایە کوڕەکەت ئەگەری کەمە لە تاقیکردنەوەکە دەربچێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """To be frank, I don't care who wins.""",
                      kurdishText:
                          """بە ڕاشکاوی، گرنگ نییە لام کێ دەیباتەوە.""",
...
const double _startSecondsend = 000000000000000000000000000321;
const String _videoIdone = 'https://youtu.be/3ewyEF3Wd9M?t=';
const double _startSecondsone = 000000000000000000000000000134;
const String _videoIdtwo = 'https://youtu.be/bJWDajO2SZE?t=';
const double _startSecondstwo = 000000000000000000000000000374;
const String _videoIdthree = 'https://youtu.be/XXhc5UTxv5I?t=';
const double _startSecondsthree = 000000000000000000000000000166;
const String _videoIdfour = 'https://youtu.be/S4qvPouh1gE?t=';
const double _startSecondsfour = 0000000000000000000000000002950;
const String _videoIdfive = 'https://youtu.be/zouGFPlbtkk?t=';
const double _startSecondsfive = 00000000000000000000000000017;
