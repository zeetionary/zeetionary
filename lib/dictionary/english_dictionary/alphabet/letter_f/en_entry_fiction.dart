...
class EnglishEntryfiction extends StatefulWidget {
  const EnglishEntryfiction({super.key});

  @override
  State<EnglishEntryfiction> createState() => _EnglishEntryfictionState();
}

class _EnglishEntryfictionState extends State<EnglishEntryfiction> {
  @override
  void initState() {
    super.initState();
...
3. The creation of something in the mind (= invention, innovation, excogitation, conception, design)
""",
  );

  final String keyword = "fiction";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fiction""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She has written novels and short fiction.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Don't believe what she says—it's pure fiction!""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiction""",
                      // alsoEnglishWord: "also: fiction",
                      britshText: """IpaUK: /ˈfɪkʃn/""",
                      americanText: """IpaUS: /ˈfɪkʃn/""",
...
// With short examples define "fiction", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕۆمان و چیرۆکی کورتی خەیاڵی نووسیوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She has written novels and short fiction.""",
                      kurdishText: """زیاتر لە ٢٠ کاری خەیاڵی نووسیوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/GYk4ymtQ1WM?t=';
const double _startSecondsend = 0000000000000000000000000001557;
const String _videoIdone = 'https://youtu.be/8eq2vGEEbB4?t=';
const double _startSecondsone = 000000000000000000000000000511;
const String _videoIdtwo = 'https://youtu.be/3RkhZgRNC1k?t=';
const double _startSecondstwo = 0000000000000000000000000001143;
const String _videoIdthree = 'https://youtu.be/V3NGBo2M1Ps?t=';
const double _startSecondsthree = 000000000000000000000000000142;
const String _videoIdfour = 'https://youtu.be/Wao0_uB4Zw4?t=';
const double _startSecondsfour = 0000000000000000000000000002634;
const String _videoIdfive = 'https://youtu.be/9GR3XSuInYE?t=';
const double _startSecondsfive = 000000000000000000000000000401;
