                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "amplitude"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæmplɪtjuːd/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæmplɪtuːd/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'KT3yNuY_FPM';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '41ee6EsHchA';
  final double _startSeconds = 1483;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'a4Qtf5D0rso';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'DjcS1kRkc6M';
