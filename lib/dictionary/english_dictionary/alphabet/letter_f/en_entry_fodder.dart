...
class EnglishEntryfodder extends StatefulWidget {
  const EnglishEntryfodder({super.key});

  @override
  State<EnglishEntryfodder> createState() => _EnglishEntryfodderState();
}

class _EnglishEntryfodderState extends State<EnglishEntryfodder> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fodder (Derived forms: fodders)
...
3. Soldiers who are regarded as expendable in the face of artillery fire (= cannon fodder, fresh fish)

- Verb: fodder (Derived forms: foddered, foddering, fodders)
1. Give fodder (to domesticated animals)
""",
  );

  final String keyword = "fodder";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """He regarded lists of rules, regulations and procedures as dustbin fodder.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fodder""",
                      // alsoEnglishWord: "also: fodder",
                      britshText: """IpaUK: /ˈfɒdə(r)/""",
                      americanText: """IpaUS: /ˈfɑːdər/""",
...
کوردی: تفاق، واشە، ئاڵف، کاوجۆ، ئالیک، ئالک، ئاژو، یێم، دیزی،	(خوازە) خۆراک
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) خواردنی ئەسپ و ئاژەڵی مەزرا"""),
                    SentencesRow(
                      englishText:
                          """He loaded the wagon with fodder for the horses.""",
                      kurdishText: """ئەڕابەکەی بارکرد لە ئالیک بۆ ئەسپەکان.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) خەڵک و شت کە وەها دادەنرێن کە تەنها یەک بەکارهێنانیان هەبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He regarded lists of rules, regulations and procedures as dustbin fodder (= only fit to be thrown away).""",
                      kurdishText:
                          """لیستی یاساکان، ڕێساکان و ڕێگاکانی تەنها بە شایستە بە زباڵە زانی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بەبێ خوێندن، ئەم منداڵانە تەنها بە کەڵکی کارگە دێن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Gi3HnqetpLw?t=';
const double _startSecondsend = 000000000000000000000000000343;
const String _videoIdone = 'https://youtu.be/Sbp_EeBk-As?t=';
const double _startSecondsone = 0000000000000000000000000001425;
const String _videoIdtwo = 'https://youtu.be/Q-nWA0WeF98?t=';
const double _startSecondstwo = 0000000000000000000000000001711;
const String _videoIdthree = 'https://youtu.be/JN3KPFbWCy8?t=';
const double _startSecondsthree = 000000000000000000000000000713;
const String _videoIdfour = 'https://youtu.be/LJ0Hfc8hvpE?t=';
const double _startSecondsfour = 000000000000000000000000000365;
const String _videoIdfive = 'https://youtu.be/TBE1pFBoiTY?t=';
