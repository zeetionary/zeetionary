...
class EnglishEntryengineer extends StatefulWidget {
  const EnglishEntryengineer({super.key});

  @override
  State<EnglishEntryengineer> createState() => _EnglishEntryengineerState();
}

class _EnglishEntryengineerState extends State<EnglishEntryengineer> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""engineer""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """engineer""",
                      // alsoEnglishWord: "also: engineer",
                      britshText: """IpaUK: /ˌendʒɪˈnɪə(r)/""",
                      americanText: """IpaUS: /ˌendʒɪˈnɪr/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""You need the advice of a qualified engineer.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She engineered a further meeting with him.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کەسێک کە کاری بنیاتنانی ئامێر، بزوێنەر، ڕێگا، پرد، ھتد ــە"""),
          SentencesRow(
            englishText:
                """We worked with a team of scientists and engineers.""",
            kurdishText: """لەگەڵ تیمێک لە زانایان و ئەندازیاران کارمان کرد.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerSentences(),
          SentencesRow(
            englishText: """You need the advice of a qualified engineer.""",
            kurdishText: """پێویستیت بە ڕاوێژی ئەندازیارێکی شارەزایە.""",
          ...
          CustomRichText(
            ...
            linkText: "engine driver",
            textAfterLink: "",
            onTap: () {
              Routemaster.of(context).push("/english-engineer/enginedriver");
            },
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
          ...
          SentencesRow(
            englishText:
                """He had no idea that his downfall had been engineered by his deputy.""",
            kurdishText:
                """ھیچ نەیدەزانی کە لەناوبردنی لەلایەن جێگرەکەیەوە ڕێکخرابوو.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """ھەندێک دانەوێڵەی کیمیایی دیزیان کراون کە مەگەز دووربخەنەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: engineer (derived forms: engineers)
1. A person who uses scientific knowledge to solve practical problems (= applied scientist, technologist)
 
2. The operator of a railway locomotive (= locomotive engineer, railroad engineer [N. Amer], engine driver)

- Verb: engineer (derived forms: engineered, engineering, engineers)
1. Design as an engineer
"He engineered the water supply project"
 
2. Plan and control how a complex undertaking is done (= mastermind, direct, organize, organise [Brit], orchestrate)
