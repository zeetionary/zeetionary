...
class EnglishEntryinfuriate extends StatefulWidget {
  const EnglishEntryinfuriate({super.key});

  @override
  State<EnglishEntryinfuriate> createState() => _EnglishEntryinfuriateState();
}

class _EnglishEntryinfuriateState extends State<EnglishEntryinfuriate> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infuriate""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 2179;
    const String videoIdone = 'YZkXDuKto_Y';
    const double startSecondsone = 849;
    const String videoIdtwo = 'p3368WAl0qM';
    const double startSecondstwo = 723;
    const String videoIdthree = 'T-E246eXcmg';
    const double startSecondsthree = 161;
    const String videoIdfour = '4R3LA4awCCM';
    const double startSecondsfour = 439;
    const String videoIdfive = '_qiJO4OpyJs';
    const double startSecondsfive = 499;
