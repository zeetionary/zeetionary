...
class EnglishEntryhousemaster extends StatefulWidget {
  const EnglishEntryhousemaster({super.key});

  @override
  State<EnglishEntryhousemaster> createState() =>
      _EnglishEntryhousemasterState();
}

class _EnglishEntryhousemasterState extends State<EnglishEntryhousemaster> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: housemaster (Derived forms: housemasters)
1. Teacher in charge of a school boardinghouse
""",
  );

  final String keyword = "housemaster";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""housemaster""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He spoke with the housemaster about his behavior.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/KXexRtomseI?t=';
    const double startSecondsend = 0000000000000000000000000003468;
    const String videoIdone = 'https://youtu.be/EWGAg9iGPLQ?t=';
    const double startSecondsone = 000000000000000000000000000244;
    const String videoIdtwo = 'https://youtu.be/uh7Fb7c_KrM?t=';
    const double startSecondstwo = 000000000000000000000000000426;
    const String videoIdthree = 'https://youtu.be/y_iXVzJBu9U?t=';
    const double startSecondsthree = 000000000000000000000000000514;
    const String videoIdfour = 'https://youtu.be/n2E4eQ6_bvE?t=';
    const double startSecondsfour = 0000000000000000000000000001782;
    const String videoIdfive = 'https://youtu.be/EDzU4Ki1q-w?t=';
    const double startSecondsfive = 0000000000000000000000000001687;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """housemaster""",
                      alsoEnglishWord: "feminine: housemistress",
                      britshText: """IpaUK: /ˈhaʊsmɑːstə(r)/""",
                      americanText: """IpaUS: /ˈhaʊsmæstər/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مامۆستایەک کە چاودێری ژمارەیەک منداڵ دەکات لە قوتابخانەیەک، بە تایبەتی لە قوتابخانەی تایبەت"""),
                    SentencesRow(
                      englishText:
                          """He spoke with the housemaster about his behavior.""",
                      kurdishText:
                          """لەگەڵ مامۆستاکە قسەی کرد سەبارەت بە هەڵسووکەوتی.""",
