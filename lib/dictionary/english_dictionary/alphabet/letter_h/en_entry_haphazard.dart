...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The government's approach to the problem was haphazard.""");
  }
...
// With short examples define "haphazard", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The books had been piled on the shelves in a haphazard fashion.""",
                      kurdishText:
                          """کتێبەکان لەسەر ڕەفەکان بە شێوەیەکی شپرزانە دانرابوون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """مامەڵەی حکومەت لەگەڵ کێشەکە شپرزانە بوو.""",
