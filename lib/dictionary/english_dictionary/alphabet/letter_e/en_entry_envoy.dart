...
class EnglishEntryenvoy extends StatefulWidget {
  const EnglishEntryenvoy({super.key});

  @override
  State<EnglishEntryenvoy> createState() => _EnglishEntryenvoyState();
}

class _EnglishEntryenvoyState extends State<EnglishEntryenvoy> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """envoy""",
                      // alsoEnglishWord: "also: envoy",
                      britshText: """IpaUK: /ˈenvɔɪ/""",
                      americanText: """IpaUS: /ˈenvɔɪ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The President has suggested sending a US peace envoy to the Middle East.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He served as envoy to the French government.""");
  }
...
// With short examples define "envoy", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: نێردراو، ڕاسپاردە،	نوێنەری حکومەت،	(کۆپلە) هۆنراوەی کۆتایی کتێب، دوایین وتە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کەسێک کە نوێنەرایەتی حکومەتێک یان دامەزراوەیەک دەکات لە گفتوگۆ لەگەڵ حکومەت و دامەزراوەی دیکە"""),
          SentencesRow(
            englishText:
                """The President has suggested sending a US peace envoy to the Middle East.""",
            kurdishText:
                """سەرۆک پێشنیاری ناردنی نوێنەری ئاشتی بۆ ڕۆژهەڵاتی ناوەڕاست کردووە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He served as envoy to the French government.""",
            kurdishText: """وەک نوێنەر لای حکومەتی فەرەنسا خزمەتی کرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: envoy (Derived forms: envoys)
1. A diplomat having less authority than an ambassador (= envoy extraordinary, minister plenipotentiary)
 
2. Someone sent on a mission to represent the interests of someone else (= emissary)
 
3. A brief stanza concluding certain forms of poetry (= envoi)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/ociHVDWxDaY?t=';
const double _startSecondsend = 000000000000000000000000000000; // 287;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/I3Y_FQMFMWE?t=';
const double _startSecondsone = 00000000000000000000000000000; // 348;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/36erMl7IgRo?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 263;
const String _videoIdthree = 'VIDEOhttps://youtu.be/OUVY3CFQAGY?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1194;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/1X_KdkoGxSs?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 5689;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/-mv1Pdyh23Y?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 269;
