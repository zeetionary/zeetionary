...
// Define the word "ballot" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace ballot - replace EnglishEntryballot

// replace speakBallot - /ˈbælət/

enum TtsState { playing }

class EnglishEntryballot extends StatelessWidget {
// blank divider
  EnglishEntryballot({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakBallot(String languageCode) async {
    // DOPSUM: CHANGE speakBallot
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("ballot"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakBallots1(String languageCode) async {
    // DOPSUM: CHANGE speakBallot
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "The club members decided in a ballot to suspend the captain."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakBallots2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "What percentage of voters cast their ballots?"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakBallots3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("She won 58.8% of the ballot."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakBallots6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBallots66"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakBallots7(String languageCode) async {
    // DOPSUM: CHANGE speakBallot
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBallots77"); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "ballot", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˈbælət/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
"there were only 17 ballots in favour of the motion";
...
// end ballot // TODO Implement this library.
