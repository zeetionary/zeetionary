...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'aWiFsm87H_I';
    const double startSecondsend = 128;
    const String videoIdone = 'cbSGWcNS0D4';
    const double startSecondsone = 678;
    const String videoIdtwo = 'cbSGWcNS0D4';
    const double startSecondstwo = 674;
    const String videoIdthree = '_uS4WCsGi0k';
    const double startSecondsthree = 178;
    const String videoIdfour = 'w5KGgR7v8OM';
    const double startSecondsfour = 581;
    const String videoIdfive = 'BlgTQN-esjM';
