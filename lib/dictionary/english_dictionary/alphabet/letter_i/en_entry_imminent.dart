...
class EnglishEntryimminent extends StatefulWidget {
  const EnglishEntryimminent({super.key});

  @override
  State<EnglishEntryimminent> createState() => _EnglishEntryimminentState();
}

class _EnglishEntryimminentState extends State<EnglishEntryimminent> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: imminent
1. Close in time; about to occur (- at hand, close at hand, impendent, impending, approach, approaching, coming)
"in imminent danger";
""",
  );

  final String keyword = "imminent";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""imminent""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The system is in imminent danger of collapse.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """imminent""",
                      // alsoEnglishWord: "also: imminent",
                      britshText: """IpaUK: /ˈɪmɪnənt/""",
                      americanText: """IpaUS: /ˈɪmɪnənt/""",
...
کوردی: هاکا، خەریکە، نزیکە، نزیک، بەڕێوە، بە دەم‌ڕێوە، هاکا ڕوویدا
"""),
// With short examples define "imminent", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە ئەگەری هەیە زۆر زوو ڕووبدات"""),
                    SentencesRow(
                      englishText:
                          """The system is in imminent danger of collapse.""",
                      kurdishText: """سیستەمەکە لە مەترسیی نزیکی داڕماندایە.""",
