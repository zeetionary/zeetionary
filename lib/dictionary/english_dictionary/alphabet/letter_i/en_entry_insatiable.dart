...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'futIzImamM8';
    const double startSecondsend = 387;
    const String videoIdone = 'ZT3X1fYFViE';
    const double startSecondsone = 130;
    const String videoIdtwo = 'kw9Bd96c1ug';
    const double startSecondstwo = 734;
    const String videoIdthree = '5Wq0yv73NpY';
    const double startSecondsthree = 194;
    const String videoIdfour = 'RzG-yFh1XGs';
    const double startSecondsfour = 29;
    const String videoIdfive = 'wVt7YCjF1AI';
