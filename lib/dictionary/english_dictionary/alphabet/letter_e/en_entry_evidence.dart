...
class EnglishEntryevidence extends StatefulWidget {
  const EnglishEntryevidence({super.key});

  @override
  State<EnglishEntryevidence> createState() => _EnglishEntryevidenceState();
}

class _EnglishEntryevidenceState extends State<EnglishEntryevidence> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evidence""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evidence""",
                      // alsoEnglishWord: "also: evidence",
                      britshText: """IpaUK: /ˈevɪdəns/""",
                      americanText: """IpaUS: /ˈevɪdəns/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Have you any evidence to support this allegation?""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The cave contained evidences of prehistoric settlement.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We found further scientific evidence for this theory.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""No new evidence has contradicted this research.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        """The scale of the problem is not evidenced in police statistics.""");
  }
...
کوردی: بەڵگە، سەلمێنە، شایەت، گەواهـ، ستۆڤ، شایەتی، شایەدی، گەواهی
"""),
          const DefinitionKurdish(text: """١. (ناو) بەڵگە"""),
          SentencesRow(
            englishText:
                """Researchers have found clear scientific evidence of a link between exposure to sun and skin cancer.""",
            kurdishText:
                """توێژەران بەڵگەی زانستیی ڕوونیان دۆزیوەتەوە بۆ پەیوەندیی نێوان بەرکەوتن بە خۆر و شێرپەنجەی پێست.""",
          ...
          SentencesRow(
            englishText:
                """There is a growing body of evidence for the existence of black holes that are ten times as massive as the Sun.""",
            kurdishText:
                """کۆمەڵەی زیادبوو لە بەڵگە هەیە بۆ هەبوونی کونی ڕەش کە ١٠ جار لە خۆر گەورەترن.""",
          ...
          SentencesRow(
            englishText:
                """There is not a shred of evidence that the meeting actually took place.""",
            kurdishText: """یەک تۆزقاڵ بەڵگە نییە کە کۆبوونەوەکە ڕوویدابێت.""",
          ...
          SentencesRow(
            ...
            kurdishText: """هیچ بەڵگەت هەیە پشتگیری ئەم تۆمەتە بکات؟""",
          ...
          SentencesRow(
            ...
            englishNote:
                "In general English, evidence is always uncountable. However, in academic English the plural evidences is sometimes used, such as this sentence.",
            kurdishText:
                """ئەشکەوتەکە بەڵگەی نیشتەجێبوونی پێش مێژووی لەخۆ دەگرت.""",
          ...
          SentencesRow(
            ...
            kurdishText: """بەڵگەی زانستیی زیاترمان بۆ ئەم بیردۆزە دۆزییەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """No new evidence has contradicted this research.""",
            kurdishText: """هیچ بەڵگەیەک دژ بەم توێژینەوە نەبووە.""",
          ...
          SentencesRow(
            englishText:
                """Available evidence points to pilot error as the cause of the crash.""",
            kurdishText:
                """بەڵگەی بەردەست ئاماژە بە هەڵەی فڕۆکەوان دەکەن بۆ هۆکاری ئەم تێکشکانە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """لە دانیشتنەکەی دادگا داوام لێکرا بەڵگە پێشکەش بکەم.""",
          ...
          SentencesRow(
            englishText:
                """Despite a lack of evidence against him, Burton will appear in court next week.""",
            kurdishText:
                """سەرەڕای نەبوونی بەڵگە دژی، بێرتن هەفتەی داهاتوو لە دەنیشتنی دادگا ئامادە دەبێت.""",
          ...
          SentencesRow(
            englishText:
                """He was released when the judge ruled there was no evidence against him.""",
            kurdishText:
                """ئازاد کرا کە دادوەرەکە بڕیاری دا هیچ بەڵگەیەک لە دژی نییە.""",
          ...
          SentencesRow(
            englishText:
                """The emails were presented as evidence of his involvement in the fraud.""",
            kurdishText:
                """ئیمەیڵەکان وەک بەڵگەی بەژداریی لە ساختەکارییەکە پێشکەش کران.""",
          ...
          SentencesRow(
            englishText:
                """The legal profession is still a largely male world, as evidenced by the small number of women judges.""",
            kurdishText:
                """پیشەی یاسایی هێشتا جیهانێکی پیاوانەیە، وەک دەردەکەوێت بە ژمارەی کەمی ژنە دادوەرەکان.""",
          ...
          SentencesRow(
            englishText:
                """The scale of the problem is not evidenced in police statistics.""",
            kurdishText: """ئاستی کێشەکە لە ئامارەکانی پۆلیسدا دەرنەکەوتووە.""",
          ...
          SentencesRow(
            englishText:
                """These emails are still circulating, as evidenced by my receiving one just this morning.""",
            kurdishText:
                """ئەم ئیمەیڵانە هێشتا دەنێردرێن، وەک دەردەکەوێت بەوەی من ئەم بەیانییە وەرمگرت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: evidence (Derived forms: evidenced, evidences, evidencing)
1. Your basis for belief or disbelief; knowledge on which to base belief (= grounds)
...
- Verb: evidence
1. Provide evidence for; stand as proof of; show by one's behaviour, attitude, or external attributes (= attest, certify, manifest, demonstrate)
 
2. (law) provide evidence for (= testify, bear witness, prove, show, witness)
 
3. Give evidence (= tell)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/sSdMX8AWurI?t=';
const double _startSecondsend = 000000000000000000000000000000; // 490;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/VrKW58MS12g?t=';
const double _startSecondsone = 00000000000000000000000000000; // 34;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/ewLpXw6uN28?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 879;
const String _videoIdthree = 'VIDEOhttps://youtu.be/SrDEtSlqJC4?t=';
const double _startSecondsthree = 000000000000000000000000000; // 83;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/Mx8JkGHaGUI?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 568;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/raSeaAeryWE?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1586;
