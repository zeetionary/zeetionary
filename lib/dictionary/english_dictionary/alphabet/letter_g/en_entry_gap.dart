...
""",
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There’s a big age gap between them.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      britshText: """IpaUK: /ɡæp/""",
                      americanText: """IpaUS: /ɡæp/""",
...
// With short examples define "gap", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پارەی زیاتر پێویستە بۆ پڕکردنەوەی کەلێنەکە.""",
                      englishNote:
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لەم ڕستانەدا بۆشاییەکان پڕبکەرەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """توانیم خۆم بکەم بە بۆشاییەکەدا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He wrote his first novel in the gap between school and university.""",
                      kurdishText:
                          """یەکەم ڕۆمانیی لە ماوەی نێوان قوتابخانە و زانکۆ نووسی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دووبارە یەکیان بینیوە دوای ماوەی بیست ساڵ.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """گەڕایەوە بۆ کاری مامۆستایەتی لە دوای ماوەی دوازدە ساڵ.""",
                    ...
                    SentencesRow(
                      englishText:
                          """A huge gap has opened up between expectations and what is deliverable.""",
                      kurdishText:
                          """جیاوازییەکی زۆر درووست بووە لە نێوان پێشبینی و ئەوەی کە پێشکەش دەکرێت.""",
...
const String _videoIdone = 'AF8d72mA41M?t=';
const double _startSecondsone = 316;
const String _videoIdtwo = 'qYXw_qvtNQc?t=';
const double _startSecondstwo = 201;
const String _videoIdthree = 'SEZu7K5tGxw?t=';
const double _startSecondsthree = 323;
const String _videoIdfour = 'bHIhgxav9LY?t=';
const double _startSecondsfour = 134;
const String _videoIdfive = 'fZJGTevM3QI?t=';
