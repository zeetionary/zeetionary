...
class EnglishEntryairbag extends StatefulWidget {
  const EnglishEntryairbag({super.key});

  @override
  State<EnglishEntryairbag> createState() => _EnglishEntryairbagState();
}

class _EnglishEntryairbagState extends State<EnglishEntryairbag> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Widget build(BuildContext context) {
    const String videoIdend = 'KRcajZHc6Yk';
    const double startSecondsend = 13;
    const String videoIdone = '9VWDqq4JsrA';
    const double startSecondsone = 10;
    const String videoIdtwo = 'DkGCZk3F2HI';
    const double startSecondstwo = 33;
    const String videoIdthree = 'quCtqX42a8s';
    const double startSecondsthree = 5;
    const String videoIdfour = '7HF6fstZnts';
    const double startSecondsfour = 20;
    const String videoIdfive = 'RZD7R_8K6lY';
    const double startSecondsfive = 27;
    // final String _videoId = 'g9jfJ9QoQTw';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """airbag""",
                      // alsoEnglishWord: "also: airbag",
                      britshText: """IpaUK: /ˈeəbæɡ/""",
                      americanText: """IpaUS: /ˈeərbæɡ/""",
