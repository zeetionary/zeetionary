...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'JfUjz00snVE';
    const double startSecondsend = 233;
    const String videoIdone = 'kUOnXLsGrjA';
    const double startSecondsone = 115;
    const String videoIdtwo = 'jR1GlpPVewg';
    const double startSecondstwo = 336;
    const String videoIdthree = 'T8IIeuy30cc';
    const double startSecondsthree = 720;
    const String videoIdfour = 'f7rlG7MOlsY';
    const double startSecondsfour = 1033;
    const String videoIdfive = 'gLoLCUhuAP4';
