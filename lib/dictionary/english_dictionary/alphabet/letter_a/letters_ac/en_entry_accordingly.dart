...
class EnglishEntryaccordingly extends StatelessWidget {
  EnglishEntryaccordingly({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈkɔːdɪŋli/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'mZr1nbACmGc';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'nOyvyEUvjVA';
