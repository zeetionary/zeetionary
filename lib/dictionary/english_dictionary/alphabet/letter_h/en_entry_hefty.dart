...
class EnglishEntryhefty extends StatefulWidget {
  const EnglishEntryhefty({super.key});

  @override
  State<EnglishEntryhefty> createState() => _EnglishEntryheftyState();
}

class _EnglishEntryheftyState extends State<EnglishEntryhefty> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hefty (Derived forms: heftier, heftiest)
1. (of a person) possessing physical strength and weight; rugged and powerful (- brawny, muscular, powerful, sinewy, muscly)
"a hefty athlete";
 
2. Of considerable weight and size
"a hefty dictionary"
 
3. Large in amount, extent or degree (- goodly, goodish, healthy, respectable, sizable, sizeable, tidy [informal])
"received a hefty bonus";
""",
  );

  final String keyword = "hefty";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Her brothers were both hefty men in their forties.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They sold it easily and made a hefty profit.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He gave the door a hefty kick.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hefty""",
                      // alsoEnglishWord: "also: hefty",
                      britshText: """IpaUK: /ˈhefti/""",
                      americanText: """IpaUS: /ˈhefti/""",
...
کوردی: هەیکەلی، بەقەڵافەت،	زلە و بەهێز، زلەوقورس، پووتەقوڕ، قەبە،	بەهێز، بەقەوەت، یەکجار، زۆر، لۆدە، سەروزیاد
"""),
// With short examples define "hefty", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کەسێکی گەورە و زل"""),
                    SentencesRow(
                      englishText:
                          """Her brothers were both hefty men in their forties.""",
                      kurdishText:
                          """براکانی هەردووکیان پیاوی کەتە بوون لە تەمەنی چل ساڵیدا.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) گەورە؛ زیاتر لە ئاسایی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """They sold it easily and made a hefty profit.""",
                      kurdishText:
                          """بە ئاسانی فرۆشتیان و قازانجێکی گەورەیان کرد.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ھاوەڵناو) بە هێزێکی زۆرەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He gave the door a hefty kick.""",
...
const double _startSecondsend = 0000000000000000000000000001091;
const String _videoIdone = 'https://youtu.be/mY3SEMTROas?t=';
const double _startSecondsone = 0000000000000000000000000001821;
const String _videoIdtwo = 'https://youtu.be/yRmOWcWdQAo?t=';
const double _startSecondstwo = 000000000000000000000000000255;
const String _videoIdthree = 'https://youtu.be/lsbcN9-jU1Y?t=';
const double _startSecondsthree = 0000000000000000000000000001273;
const String _videoIdfour = 'https://youtu.be/Am1lDj2mUVY?t=';
const double _startSecondsfour = 0000000000000000000000000001139;
const String _videoIdfive = 'https://youtu.be/SiUotSKZUtM?t=';
