...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001060;
    const String videoIdone = 'https://youtu.be/3Y-SozZO51A?t=';
    const double startSecondsone = 00000000000000000000000000012;
    const String videoIdtwo = 'https://youtu.be/cAsr6HTELeQ?t=';
    const double startSecondstwo = 0000000000000000000000000002913;
    const String videoIdthree = 'https://youtu.be/k8kTK_cqbHg?t=';
    const double startSecondsthree = 0000000000000000000000000001295;
    const String videoIdfour = 'https://youtu.be/Vb90YPtr2EY?t=';
    const double startSecondsfour = 0000000000000000000000000001601;
    const String videoIdfive = 'https://youtu.be/CNKaKHD6aqA?t=';
    const double startSecondsfive = 0000000000000000000000000003069;
