...
class EnglishEntryluxuriance extends StatefulWidget {
  const EnglishEntryluxuriance({super.key});

  @override
  State<EnglishEntryluxuriance> createState() => _EnglishEntryluxurianceState();
}

class _EnglishEntryluxurianceState extends State<EnglishEntryluxuriance> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryluxuriance luxuriance
WORD_WEB luxuriance luxuriance luxuriance
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "luxuriance";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""luxuriance""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """luxuriance""",
                      // alsoEnglishWord: "also: luxuriance",
...
کوردی: 
"""),
// With short examples define "luxuriance", please follow LX instructions
