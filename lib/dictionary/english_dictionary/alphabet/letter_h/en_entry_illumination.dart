...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/nMPCXuvL8EM?t=';
    const double startSecondsend = 00000000000000000000000000046;
    const String videoIdone = 'https://youtu.be/5xxdh3bmgfw?t=';
    const double startSecondsone = 000000000000000000000000000147;
    const String videoIdtwo = 'https://youtu.be/cRLnR4Kot2M?t=';
    const double startSecondstwo = 00000000000000000000000000019;
    const String videoIdthree = 'https://youtu.be/tURHTuKHBZs?t=';
    const double startSecondsthree = 000000000000000000000000000497;
    const String videoIdfour = 'https://youtu.be/gQmiqmxJMtA?t=';
    const double startSecondsfour = 0000000000000000000000000005703;
    const String videoIdfive = 'https://youtu.be/SAaESb4wTCM?t=';
    const double startSecondsfive = 000000000000000000000000000599;
