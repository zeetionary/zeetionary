...
class EnglishEntryairless extends StatelessWidget {
  EnglishEntryairless({Key? key}) : super(key: key);
  ...
  Future<void> speakAirless(String languageCode) async {
    ...
    await flutterTts.speak("airless"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAirless4562(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The night was hot and airless."); // DOPSUM: CHANGE TEXT
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'Y-NGUOI6tP0';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'CC0MYg1cuOI';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'vSNtifE0Z2Q';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'aw_WUel_zJg';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '-EAcB7PvTEk';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'sf36euTbI9w';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'oLsbqTLTXlk';
