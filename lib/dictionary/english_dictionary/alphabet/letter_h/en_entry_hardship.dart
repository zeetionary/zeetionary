...
class EnglishEntryhardship extends StatefulWidget {
  const EnglishEntryhardship({super.key});

  @override
  State<EnglishEntryhardship> createState() => _EnglishEntryhardshipState();
}

class _EnglishEntryhardshipState extends State<EnglishEntryhardship> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hardship (Derived forms: hardships)
1. A state of misfortune or affliction (- adversity, hard knocks)
"a life of hardship";
 
2. The quality of being hard to endure, uninviting or formidable (- asperity, grimness, rigor [US], rigour [Brit, Cdn], severity, severeness, rigorousness, rigourousness [Brit, non-standard])
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hardship""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""People suffered many hardships during that long winter.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They are living in genuine hardship.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hardship""",
                      // alsoEnglishWord: "also: hardship",
                      britshText: """IpaUK: /ˈhɑːdʃɪp/""",
                      americanText: """IpaUS: /ˈhɑːrdʃɪp/""",
...
// With short examples define "hardship", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خەڵکی بە زۆر کوێرەوەریدا تێپەڕین لەو زستانە درێژەدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They are living in genuine hardship.""",
                      kurdishText: """لە سەختی تەواودا دەژین.""",
