...
class EnglishEntryhomonym extends StatefulWidget {
  const EnglishEntryhomonym({super.key});

  @override
  State<EnglishEntryhomonym> createState() => _EnglishEntryhomonymState();
}

class _EnglishEntryhomonymState extends State<EnglishEntryhomonym> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""homonym""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak(""""No" and "know" are homonyms.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/H6WVDlYXD9I?t=';
    const double startSecondsend = 000000000000000000000000000316;
    const String videoIdone = 'https://youtu.be/65CFesU4KVQ?t=';
    const double startSecondsone = 000000000000000000000000000148;
    const String videoIdtwo = 'https://youtu.be/gTKeB8BnzPY?t=';
    const double startSecondstwo = 00000000000000000000000000019;
    const String videoIdthree = 'https://youtu.be/BOaI_URLqD4?t=';
    const double startSecondsthree = 000000000000000000000000000307;
    const String videoIdfour = 'https://youtu.be/TOVN9YsIyao?t=';
    const double startSecondsfour = 000000000000000000000000000306;
    const String videoIdfive = 'https://youtu.be/6URaEPh59pU?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homonym""",
                      // alsoEnglishWord: "also: homonym",
                      britshText: """IpaUK: /ˈhɒmənɪm/""",
                      americanText: """IpaUS: /ˈhɑːmənɪm/""",
...
// With short examples define "homonym", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """"No" and "know" are homonyms.""",
                      kurdishText: """"No" و "know" هۆمۆنیمن.""",
