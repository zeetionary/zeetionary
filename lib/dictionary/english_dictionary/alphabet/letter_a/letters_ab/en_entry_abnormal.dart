...
class EnglishEntryabnormal extends StatelessWidget {
  EnglishEntryabnormal({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'abnormal', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /æbˈnɔːml/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAbnormal(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /æbˈnɔːrml/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '-rSDUsMwakI';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '9ItlOFLTUAs';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '8fBimVfIwGQ';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'pflmIVb5Mbg';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'CAn3FQgDYgM';
