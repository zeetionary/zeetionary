...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '3i1lNJPY-4Q';
    const double startSecondsend = 792;
    const String videoIdone = 'u7Wja0rdc-U';
    const double startSecondsone = 390;
    const String videoIdtwo = 'vLpSeMlfZ60';
    const double startSecondstwo = 615;
    const String videoIdthree = 'vFANgWN2Ul0';
    const double startSecondsthree = 784;
    const String videoIdfour = 'mtKJTulTrAs';
    const double startSecondsfour = 387;
    const String videoIdfive = 'Lg-nUy2DalM';
    const double startSecondsfive = 1573;
