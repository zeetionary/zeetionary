...
class EnglishEntryhesitate extends StatefulWidget {
  const EnglishEntryhesitate({super.key});

  @override
  State<EnglishEntryhesitate> createState() => _EnglishEntryhesitateState();
}

class _EnglishEntryhesitateState extends State<EnglishEntryhesitate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: hesitate (Derived forms: hesitated, hesitating, hesitates)
1. Pause or hold back in uncertainty or unwillingness (- waver, waffle [N. Amer, informal], baulk [Brit], balk)
"Authorities hesitate to quote exact figures";
 
2. Interrupt temporarily an activity before continuing (- pause)
"The speaker hesitated";
""",
  );

  final String keyword = "hesitate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hesitate""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She hesitated before replying.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I didn't hesitate for a moment about taking the job.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hesitate""",
                      // alsoEnglishWord: "also: hesitate",
                      britshText: """IpaUK: /ˈhezɪteɪt/""",
                      americanText: """IpaUS: /ˈhezɪteɪt/""",
...
کوردی: تێفکرین، دڕدۆنگ بوون، دوودڵ بوون
"""),
// With short examples define "hesitate", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) هێواش بوون لە قسەکردن یان هەنگاونان بەهۆی ئەوەی دوودڵ یان شڵەژاویت"""),
                    SentencesRow(
                      englishText: """She hesitated before replying.""",
                      kurdishText: """دوودڵ بوو پێش وەڵامدانەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بۆ ساتێک دوودڵ نەبووم سەبارەت بە وەرگرتنی کارەکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) نیگەران بوون سەبارەت بە کردنی شتێک، بە تایبەتی کە دڵنیا نییت کە ڕاست یان گونجاوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Please do not hesitate to contact me if you have any questions.""",
...
const double _startSecondsend = 0000000000000000000000000001200;
const String _videoIdone = 'https://youtu.be/QLq6GEiHqR8?t=';
const double _startSecondsone = 000000000000000000000000000684;
const String _videoIdtwo = 'https://youtu.be/q8HRGiUeZwc?t=';
const double _startSecondstwo = 000000000000000000000000000334;
const String _videoIdthree = 'https://youtu.be/KQWGHE7NTUA?t=';
const double _startSecondsthree = 000000000000000000000000000412;
const String _videoIdfour = 'https://youtu.be/VRJzvJ5XPQI';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/YkmlPaGui5k?t=';
const double _startSecondsfive = 0000000000000000000000000001184;
