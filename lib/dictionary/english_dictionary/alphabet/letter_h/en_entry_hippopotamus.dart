...
class EnglishEntryhippopotamus extends StatefulWidget {
  const EnglishEntryhippopotamus({super.key});

  @override
  State<EnglishEntryhippopotamus> createState() =>
      _EnglishEntryhippopotamusState();
}

class _EnglishEntryhippopotamusState extends State<EnglishEntryhippopotamus> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hippopotamus (Derived forms: hippopotamuses, hippopotami)
1. Massive thick-skinned herbivorous animal living in or around rivers of tropical Africa (- hippo, river horse, Hippopotamus amphibius)
""",
  );

  final String keyword = "hippopotamus";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hippopotamus""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hippopotamus swims in the river all day.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/HWhaVKZBOcE?t=';
    const double startSecondsone = 000000000000000000000000000721;
    const String videoIdtwo = 'https://youtu.be/jnB2Uj7gWSE?t=';
    const double startSecondstwo = 00000000000000000000000000052;
    const String videoIdthree = 'https://youtu.be/UeH426gwVRc?t=';
    const double startSecondsthree = 0000000000000000000000000001044;
    const String videoIdfour = 'https://youtu.be/BfUoopDpmmY?t=';
    const double startSecondsfour = 00000000000000000000000000066;
    const String videoIdfive = 'https://youtu.be/LXQ9eaa7avI?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hippopotamus""",
                      // alsoEnglishWord: "also: hippopotamus",
                      britshText: """IpaUK: /ˌhɪpəˈpɒtəməs/""",
                      americanText: """IpaUS: /ˌhɪpəˈpɑːtəməs/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئاژەڵێکی قورسی گەورەی ئەفریقی کە پێستی تاریکی ئەستوور و لاقی کورتی هەیە و لە ئاودا دەژی"""),
                    SentencesRow(
                      englishText:
                          """The hippopotamus swims in the river all day.""",
                      kurdishText:
                          """ئەسپە ئاوییەکە تەواوی ڕۆژ لە ڕووبارەکەدا مەلە دەکات.""",
