...
// replace EnglishEntryAdopsum - replace speakAppreciate

// replace appreciate - /əˈpriːʃieɪt/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryappreciate extends StatelessWidget {
  // blank divider
  EnglishEntryappreciate({super.key});
  // blank divider
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "appreciate", // DOPSUM: CHANGE WORD ENTRY - Find /əˈpriːʃieɪt/
                                style: TextStyle(
...
٢. (کردار) دەربڕینی سوپاسگوزاری بۆ شتێک""",
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "پێزانینم دەبێ بۆ هەندێک یارمەتی.",
                                    textAlign: TextAlign
                                        .right, // Right-to-left direction
                                    textDirection: TextDirection.rtl,
                                  ),
                          ...
                          const Text(
                            // DOPSUM: WRITE DEFINITION IN KURDISH. COPY FOR ANOTHER DEFINITION
                            """
٣. (کردار) هەست‌کردن بەوەی شتێک ڕاستە""",
                            style: TextStyle(fontSize: 18),
                            textAlign: TextAlign.right,
                            textDirection: TextDirection.rtl,
                          ),
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "ساڵ دوای ساڵ وەبەرهێنانەکانیان نرخی زیادبووە.",
                                    textAlign: TextAlign
                                        .right, // Right-to-left direction
                                    textDirection: TextDirection.rtl,
                                  ),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "https://youtu.be/njn6krU3tQ8?t=";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "https://youtu.be/JNMGrbHYUUM?t=";
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  static String myVideoId = "https://youtu.be/0zwNZJbM-Gw?t=";
