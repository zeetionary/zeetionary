...
class EnglishEntryframework extends StatefulWidget {
  const EnglishEntryframework({super.key});

  @override
  State<EnglishEntryframework> createState() => _EnglishEntryframeworkState();
}

class _EnglishEntryframeworkState extends State<EnglishEntryframework> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: framework (Derived forms: frameworks)
1. A hypothetical description of a complex entity or process (= model, theoretical account)
"the computer program was based on a framework of the circulatory and respiratory systems";
 
2. The underlying structure (= fabric)
"providing a factual framework for future research";
 
3. A structure supporting or containing something (= frame)
""",
  );

  final String keyword = "framework";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""framework""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The house is built on a wooden framework.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The report provides a framework for further research.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """framework""",
                      // alsoEnglishWord: "also: framework",
                      britshText: """IpaUK: /ˈfreɪmwɜːk/""",
                      americanText: """IpaUS: /ˈfreɪmwɜːrk/""",
...
کوردی: لاشە، پەیکەر، چوارچێوە، شیپانە، شیرازە، چێوە، داربەند	پێکهاتە، ڕێکخستە، دەزگا، سیستم،	بنچینە، بنەڕەت، بنیان، بنەما،	پێودانگ، پێوەر
"""),
// With short examples define "framework", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The house is built on a wooden framework.""",
                      kurdishText:
                          """خانووەکە لەسەر چوارچێوەیەکی دارین درووستکراوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕاپۆرتەکە دەبێت بە بناغەی توێژینەوەی زیاتر.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The committee will work within the framework of certain broad objectives.""",
                      kurdishText:
                          """لیژنەکە لە چوارچێوەی ژمارەیەک ئامانجی دیاریکراوی بەرفراوان کار دەکات.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ناو) پێکهێنەری سیستەمێکی یاسایی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """We need to establish a legal framework for the protection of the environment.""",
                      kurdishText:
                          """دەبێت بناغەیەکی یاسایی دابنێین بۆ پاراستنی ژینگە.""",
...
const double _startSecondsend = 0000000000000000000000000002881;
const String _videoIdone = 'https://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondsone = 0000000000000000000000000002135;
const String _videoIdtwo = 'https://youtu.be/oLwTC-lAJws?t=';
const double _startSecondstwo = 00000000000000000000000000030;
const String _videoIdthree = 'https://youtu.be/3KC32Vymo0Q?t=';
...
const String _videoIdfive = 'https://youtu.be/aTMsfOcHiJg?t=';
