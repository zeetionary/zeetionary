...
// replace these: replace EnglishEntryadherence - replace speakAdherence - replace adherence - /ədˈhɪrəns/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadherence extends StatelessWidget {
  EnglishEntryadherence({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdherence(String languageCode) async {
    // DOPSUM: CHANGE speakAdherence
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("adherence"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAdh2558(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("strict adherence to the rules"); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "adherence", // DOPSUM: CHANGE WORD ENTRY - Find /ədˈhɪərəns/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ədˈhɪərəns/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ədˈhɪrəns/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'GxmDeU_4UlQ';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'd0ItVdi8Jkg';
