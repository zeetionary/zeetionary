...
class EnglishEntryindoctrination extends StatefulWidget {
  const EnglishEntryindoctrination({super.key});

  @override
  State<EnglishEntryindoctrination> createState() =>
      _EnglishEntryindoctrinationState();
}

class _EnglishEntryindoctrinationState
    extends State<EnglishEntryindoctrination> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: indoctrination (Derived forms: indoctrinations)
1. Teaching someone to accept doctrines uncritically
""",
  );

  final String keyword = "indoctrination";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indoctrination""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/FghSUttp6Lc?t=';
    const double startSecondsend = 000000000000000000000000000763;
    const String videoIdone = 'https://youtu.be/aFX6-Td1MUQ?t=';
    const double startSecondsone = 00000000000000000000000000068;
    const String videoIdtwo = 'https://youtu.be/rwVSF1L53Gs?t=';
    const double startSecondstwo = 0000000000000000000000000003;
    const String videoIdthree = 'https://youtu.be/kRO5jOa06Qw?t=';
    const double startSecondsthree = 000000000000000000000000000789;
    const String videoIdfour = 'https://youtu.be/McEWh87szQY?t=';
    const double startSecondsfour = 0000000000000000000000000002651;
    const String videoIdfive = 'https://youtu.be/TBJGgCHgf5w?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indoctrination""",
                      // alsoEnglishWord: "also: indoctrination",
                      britshText: """IpaUK: /ɪnˌdɒktrɪˈneɪʃn/""",
                      americanText: """IpaUS: /ɪnˌdɑːktrɪˈneɪʃn/""",
...
کوردی: 
"""),
// With short examples define "indoctrination", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە زۆر لە کەسێک بکەیت کە باوەڕ بە ژمارەیەک بیر و باوەڕ بکات و بیر لە شتی دیکە نەکاتەوە"""),
                    SentencesRow(
                      englishText:
                          """The level of indoctrination among the nation’s youth had reached fever pitch.""",
                      kurdishText:
                          """ئاستی مێشک شۆردنەوە لە ناو گەنجانی وڵاتەکە گەشتبووە ئەوپەڕی.""",
                      englishNote:
                          """This means the intensity of teaching biased ideas to the country's young people had reached an extreme or critical point.""",
