...
class EnglishEntryexultation extends StatefulWidget {
  const EnglishEntryexultation({super.key});

  @override
  State<EnglishEntryexultation> createState() => _EnglishEntryexultationState();
}

class _EnglishEntryexultationState extends State<EnglishEntryexultation> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exultation""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exultation""",
                      // alsoEnglishWord: "also: exultation",
                      britshText: """IpaUK: /ˌeɡzʌlˈteɪʃn/""",
                      americanText: """IpaUS: /ˌeɡzʌlˈteɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exultation";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There is exultation over how well he has done.""");
  }
...
کوردی: شادی، خۆشی، سەرخۆشی، خۆشحاڵی، شاگەشکەیی، سەرمەستی
"""),
          ...
          SentencesRow(
            englishText:
                """The expression on his face was a blend of exultation and hostility.""",
            kurdishText:
                """دەربڕینی ڕووخساری تێکەڵەیەک لە شادی و دوژمنکاری بوو.""",
...
const String _videoIdend = 'https://youtu.be/WLoVHyuYVBY?t=';
const double _startSecondsend = 000000000000000000000000000137;
const String _videoIdone = 'https://youtu.be/2pwXo6MzNjA?t=';
const double _startSecondsone = 0000000000000000000000000001928;
const String _videoIdtwo = 'https://youtu.be/uscb1h5QzoQ?t=';
const double _startSecondstwo = 000000000000000000000000000259;
const String _videoIdthree = 'https://youtu.be/hDU7tj7whLE?t=';
const double _startSecondsthree = 000000000000000000000000000815;
const String _videoIdfour = 'https://youtu.be/JyZ5Zb7SLn8?t=';
const double _startSecondsfour = 0000000000000000000000000006206;
const String _videoIdfive = 'https://youtu.be/JBriZO5ALoQ?t=';
const double _startSecondsfive = 0000000000000000000000000009167;
