...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/zqUopiAYdRg?t=';
    const double startSecondsend = 00000000000000000000000000083;
    const String videoIdone = 'https://youtu.be/NNnIGh9g6fA?t=';
    const double startSecondsone = 000000000000000000000000000611;
    const String videoIdtwo = 'https://youtu.be/TfH85qWVilQ?t=';
    const double startSecondstwo = 000000000000000000000000000467;
    const String videoIdthree = 'https://youtu.be/vojsscI61Sk?t=';
    const double startSecondsthree = 000000000000000000000000000181;
    const String videoIdfour = 'https://youtu.be/4IaOeVgZ-wc?t=';
    const double startSecondsfour = 0000000000000000000000000005302;
    const String videoIdfive = 'https://youtu.be/KMtrY6lbjcY?t=';
