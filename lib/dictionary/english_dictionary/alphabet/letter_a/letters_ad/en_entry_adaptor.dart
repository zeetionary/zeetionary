...
// replace these: replace EnglishEntryadamsadaptor - replace speakAdaptor - replace adaptor - /əˈdæptə(r)/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadamsadaptor extends StatelessWidget {
  EnglishEntryadamsadaptor({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "adaptor (or adapter)", // DOPSUM: CHANGE WORD ENTRY - Find /əˈdæptə(r)/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈdæptə(r)/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAdaptor(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'r2lDXoW78u0';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'cqjn3mup1So';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'FMDjaU9pD2I';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '16q8_32M03k';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'mYH74v3jWjs';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'MYBef-Ggm8c';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'gw9kwsAgLRo';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'DG6own141z0';
