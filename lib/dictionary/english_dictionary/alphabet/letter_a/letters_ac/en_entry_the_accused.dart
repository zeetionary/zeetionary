...
class EnglishEntrytheaccused extends StatefulWidget {
  const EnglishEntrytheaccused({super.key});

  @override
  State<EnglishEntrytheaccused> createState() => _EnglishEntrytheaccusedState();
}

class _EnglishEntrytheaccusedState extends State<EnglishEntrytheaccused> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "the accused";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""the accused""");
  }
  ...
  Future<void> speakT21536(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("All the accused have pleaded guilty.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """the accused""",
                      // alsoEnglishWord: "also: the accused",
                      britshText: """IpaUK: /ði əˈkjuːzd/""",
                      americanText: """IpaUS: /ði əˈkjuːzd/""",
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () =>
                                speakTh1547("en-US"), // find the accused
                          ),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () =>
                                speakT21536("en-US"), // find the accused
                          ),
                        ],
                      ),
                    ),
