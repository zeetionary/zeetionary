...
class EnglishEntryicing extends StatefulWidget {
  const EnglishEntryicing({super.key});

  @override
  State<EnglishEntryicing> createState() => _EnglishEntryicingState();
}

class _EnglishEntryicingState extends State<EnglishEntryicing> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: icing (Derived forms: icings)
1. A flavoured sugar topping used to coat and decorate cakes (- frosting, ice)
 
2. The formation of frost or ice on a surface (- frost)
 
3. (ice hockey) the act of shooting the puck from within your own defensive area the length of the rink beyond the opponent's goal (- icing the puck)
""",
  );

  final String keyword = "icing";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Roll out the icing into a large square.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/7Xcv3s_7XFI?t=';
    const double startSecondsend = 000000000000000000000000000342;
    const String videoIdone = 'https://youtu.be/n4bucphC9r4?t=';
    const double startSecondsone = 000000000000000000000000000309;
    const String videoIdtwo = 'https://youtu.be/a9m3GD0DbPY?t=';
    const double startSecondstwo = 000000000000000000000000000996;
    const String videoIdthree = 'https://youtu.be/W2hRTTTpmr8?t=';
    const double startSecondsthree = 0000000000000000000000000001316;
    const String videoIdfour = 'https://youtu.be/0ST4_hmop9Y?t=';
    const double startSecondsfour = 0000000000000000000000000001528;
    const String videoIdfive = 'https://youtu.be/Fon7og7w4Yw?t=';
    const double startSecondsfive = 000000000000000000000000000675;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """icing""",
                      alsoEnglishWord: "American English: frosting",
                      britshText: """IpaUK: /ˈaɪsɪŋ/""",
                      americanText: """IpaUS: /ˈaɪsɪŋ/""",
...
کوردی: 
"""),
// With short examples define "icing", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) تێکەڵەیەکی شیرین لە شەکر، ئاو، شیر، کەرە، و سپێنەی هێلکە کە بەکاردێت بۆ داپۆشین و ڕازاندنەوەی کێک"""),
                    SentencesRow(
                      englishText:
                          """Roll out the icing into a large square.""",
                      kurdishText:
                          """کێک‌پۆشەکە بڵاوبەکەرە چوارگۆشەیەکی گەورە.""",
