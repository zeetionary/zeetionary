...
class EnglishEntryheight extends StatefulWidget {
  const EnglishEntryheight({super.key});

  @override
  State<EnglishEntryheight> createState() => _EnglishEntryheightState();
}

class _EnglishEntryheightState extends State<EnglishEntryheight> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: height (Derived forms: heights)
1. The vertical dimension of extension; distance from the base of something to the top (- tallness)
 
2. The highest level or degree attainable; the highest stage of development (- acme, elevation, peak, pinnacle, summit, superlative, meridian, tiptop, top)
"at the height of her career";
 
3. (of a standing person) the distance from head to foot (- stature)
 
4. Elevation especially above sea level or above the earth's surface (- altitude)
"the height gave her a headache";
""",
  );

  final String keyword = "height";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Height: 210 mm. Width: 57 mm. Length: 170 mm.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Please state your height and weight.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She is the same height as her sister.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It is almost two metres in height.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You can adjust the height of the chair.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The plant can reach a height of over six feet.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The table is available in several different heights.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The height of the mountain did not discourage them.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The aircraft was gaining height.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The plane flew at a height of 3 000 metres.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The stone was dropped from a great height.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Bring your hands to shoulder height.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He doesn't have a head for heights.""");
  }
  ...
  Future<void> speaksentence16(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The crisis was at its height in May.""");
  }
  ...
  Future<void> speaksentence17(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She is still at the height of her powers.""");
  }
  ...
  Future<void> speaksentence18(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I wouldn't go there in the height of summer.""");
  }
  ...
  Future<void> speaksentence19(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Their success had reached new heights.""");
  }
  ...
  Future<void> speaksentence21(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It would be the height of folly to change course now.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """height""",
                      // alsoEnglishWord: "also: height",
                      britshText: """IpaUK: /haɪt/""",
                      americanText: """IpaUS: /haɪt/""",
...
کوردی: بەرزایی، بڵیندایی، گڤاندە، باڵا، کەڵەگەتی، درێژی،	چڵەپۆپە، لووتکە، ئەوپەڕ،	جەنگە، هەڕەت، تاف،	زەوی بەرز، بارستایی
"""),
// With short examples define "height", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) بەرزی"""),
                    SentencesRow(
                      englishText:
                          """Height: 210 mm. Width: 57 mm. Length: 170 mm.""",
                      kurdishText:
                          """بەرزی: ٢١٠ مم. پانی: ٥٧ مم. درێژی: ١٧٠ مم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەمان بەرزیی خوشکەکەی هەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەتوانیت بەرزی کورسییەکە ڕێکبخەیت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕووەکەکە دەکرێت بگات بە بەرزی سەروو شەش پێ.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """مێزەکە بە ژمارەیەک بەرزی جیاواز بەردەستە.""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) ئەوەی شتێک درێژ یان بەرز بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The height of the mountain did not discourage them.""",
                      kurdishText: """بەرزی شاخەکە ورەی دانەڕووخاندن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """His height sometimes makes it difficult to find clothes that fit.""",
                      kurdishText:
                          """باڵای هەندێک جار وا دەکات بە سەختی جل بدۆزێتەوە پڕ بە باڵای.""",
                      onPressedBritish: () => speaksentence9("en-GB"),
                      onPressedAmerican: () => speaksentence9("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ناو) مەودایەکی دیاریکراو لە زەوییەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The aircraft was gaining height.""",
                      kurdishText: """فڕۆکەکە بەرزییەکەی زیادی دەکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """فڕۆکەکە لە بەرزی ٣٠٠٠ مەتر دەفڕی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بەردەکە لە بەرزییەکی زۆرەوە بەردرایەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەستەکانت بهێنە بەرزی شانت.""",
                      onPressedBritish: () => speaksentence13("en-GB"),
                      onPressedAmerican: () => speaksentence13("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (ناو) شوێن یان جێگایەکی بەرز"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He doesn't have a head for heights (= is afraid of high places).""",
                      kurdishText: """بە کەڵکی بەرزایی نایەت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """We looked out over the city from the heights of Edinburgh Castle.""",
                      kurdishText:
                          """بەسەر شارەکەماندا ڕووانی لە بەرزایی قەڵای ئیدنبرەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٥. (ناو) ئەو شوێنەی شتێک تێیدا لە باشترین یان بەهێزترین خاڵە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The crisis was at its height in May.""",
                      kurdishText: """قەیرانەکە لە لوتکەدا بوو لە ئایار.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هێشتا لە لوتکەی هێزیدایە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە چەقی هاویندا ناچمە ئەوێ.""",
                      onPressedBritish: () => speaksentence18("en-GB"),
                      onPressedAmerican: () => speaksentence18("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٦. (ناو) ئاستێکی باشتر یان زیاتری شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Their success had reached new heights.""",
                      kurdishText: """سەرکەوتنیان گەشتبوو بە قۆناغێکی تازە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He didn’t know it was possible to reach such heights of happiness.""",
                      kurdishText:
                          """نەیدەزانی دەکرا بگات بە ئاستی وەها لە خۆشبەختی.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٧. (ناو) نموونەیەکی بەهێزی خاسیەتێکی دیاریکراو"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """It would be the height of folly (= very stupid) to change course now.""",
                      kurdishText:
                          """ئەوپەڕی گەمژەیی دەبێت ئێستا ڕێڕەو بگۆڕیت.""",
...
const double _startSecondsend = 000000000000000000000000000698;
const String _videoIdone = 'https://youtu.be/MGO4_8YRKro?t=';
const double _startSecondsone = 000000000000000000000000000473;
const String _videoIdtwo = 'https://youtu.be/s3B-qp3U5G0?t=';
const double _startSecondstwo = 0000000000000000000000000001165;
const String _videoIdthree = 'https://youtu.be/zqllxbPWKNI?t=';
const double _startSecondsthree = 000000000000000000000000000569;
const String _videoIdfour = 'https://youtu.be/lex6USTugUU?t=';
const double _startSecondsfour = 000000000000000000000000000683;
const String _videoIdfive = 'https://youtu.be/Rzd0mLf366I?t=';
