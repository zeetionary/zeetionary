...
// replace these: replace EnglishEntryairmail - replace speakAirmail - replace airmail - /ˈeəmeɪl/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryairmail extends StatelessWidget {
  EnglishEntryairmail({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "airmail", // DOPSUM: CHANGE WORD ENTRY - Find /ˈeəmeɪl/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈeəmeɪl/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'ZQ0LjKr4WZ4';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'iurYQ-VIwpM';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'zwjxZ19Gvfo';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '0F26G0PwZVI';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'bVOZ7YPOakI';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'H63GrkmeNvs';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'AtNTi7aiLi4';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = '4wXB8htl3Zo';
