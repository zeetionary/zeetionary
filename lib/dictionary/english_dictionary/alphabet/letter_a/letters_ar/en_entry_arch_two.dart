...
// replace EnglishEntryAdopsum - replace speakArchtwo

// replace arch- - /haʊ/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarchtwo extends StatelessWidget {
  // blank divider
  EnglishEntryarchtwo({super.key});
  // blank divider
  ...
  Future<void> speakarchtwo213(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He's always been an arch-opponent of the project.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /haʊ/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /haʊ/"),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'awoxe5jdYBs';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Syf2d5vdQEg';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final double _startSeconds = 2791;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'ZBovy3gUxCE';
