...
class EnglishEntryfiend extends StatefulWidget {
  const EnglishEntryfiend({super.key});

  @override
  State<EnglishEntryfiend> createState() => _EnglishEntryfiendState();
}

class _EnglishEntryfiendState extends State<EnglishEntryfiend> {
  @override
  void initState() {
    super.initState();
...
3. A person motivated by irrational enthusiasm (as for a cause) (= fanatic)
"A fiend is one who can't change his mind and won't change the subject";
""",
  );

  final String keyword = "fiend";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He was portrayed in the media as a complete fiend.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""McCormack is a fiend for punctuality.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiend""",
                      // alsoEnglishWord: "also: fiend",
                      britshText: """IpaUK: /fiːnd/""",
                      americanText: """IpaUS: /fiːnd/""",
...
// With short examples define "fiend", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە میدیادا بە دێوەزمەیەکی تەواو پیشان دەدار.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) کەسێک کە زۆر حەزی بە شتێکە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """McCormack is a fiend for punctuality.""",
                      kurdishText: """ماک کۆرماک شەیدای پابەندبوون بە کاتە.""",
...
const String _videoIdthree = 'https://youtu.be/dHPTR96Sc1g?t=';
const double _startSecondsthree = 00000000000000000000000000091;
const String _videoIdfour = 'https://youtu.be/Ukrfw8-SYSY?t=';
const double _startSecondsfour = 00000000000000000000000000073;
const String _videoIdfive = 'https://youtu.be/ni5-3x6ofjc?t=';
