...
class EnglishEntryhunter extends StatefulWidget {
  const EnglishEntryhunter({super.key});

  @override
  State<EnglishEntryhunter> createState() => _EnglishEntryhunterState();
}

class _EnglishEntryhunterState extends State<EnglishEntryhunter> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The outlaw was tracked down and killed by bounty hunters.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'XlHzvTEstz8';
    const double startSecondsone = 1129;
    const String videoIdtwo = 'AwhBTrzzqeg';
    const double startSecondstwo = 181;
    const String videoIdthree = 'IVUjJpk0qWc';
    const double startSecondsthree = 47;
    const String videoIdfour = 'fhpAIPFNYag';
    const double startSecondsfour = 0;
    const String videoIdfive = 'PbemQhFSid8';
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """یاخیبووەکە دۆزرایەوە و کوژرا لەلایەن ڕاوچییە بەکرێ‌گیراوەکانەوە.""",
