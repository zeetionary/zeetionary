...
// With short examples define "forge", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) هەوڵدانی زۆر بۆ ئەوەی وا بکەیت شتێک سەرکەوتوو بێت یان بەردەوام بێت"""),
                    SentencesRow(
                      englishText:
                          """Strategic alliances are being forged with major European companies.""",
                      kurdishText:
                          """هاوپەیمانی ستراتیژی لەگەڵ کۆمپانیا ئەورووپییە گرنگەکان دەبەسترێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پێشەنگییان بەدەستهێننا لە یەکەم ٣٠ خولەکی یارییەکە.""",
...
const double _startSecondsend = 000000000000000000000000000727;
const String _videoIdone = 'https://youtu.be/0ST4_hmop9Y?t=';
const double _startSecondsone = 0000000000000000000000000001074;
const String _videoIdtwo = 'https://youtu.be/U38i32CpYow?t=';
const double _startSecondstwo = 000000000000000000000000000727;
const String _videoIdthree = 'https://youtu.be/NICir0cWsEY?t=';
const double _startSecondsthree = 0000000000000000000000000001112;
const String _videoIdfour = 'https://youtu.be/GaLdHd2J-xM?t=';
const double _startSecondsfour = 000000000000000000000000000258;
const String _videoIdfive = 'https://youtu.be/l2FuvKTyRMQ?t=';
