...
class EnglishEntryabsorbent extends StatelessWidget {
  EnglishEntryabsorbent({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'absorbent', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əbˈzɔːbənt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'LOvqztX0M5I';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'RpA_xkUG2yM';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'ATwD5WZmR1g';
