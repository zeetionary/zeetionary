...
class EnglishEntrygranulatedsugar extends StatefulWidget {
  const EnglishEntrygranulatedsugar({super.key});

  @override
  State<EnglishEntrygranulatedsugar> createState() =>
      _EnglishEntrygranulatedsugarState();
}

class _EnglishEntrygranulatedsugarState
    extends State<EnglishEntrygranulatedsugar> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: granulated sugar (Derived forms: granulated sugars)
1. Sugar in the form of small grains
""",
  );

  final String keyword = "granulated sugar";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""granulated sugar""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Some people like sweeter sauces, so you can add honey or granulated sugar to taste.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: granulated sugar",
                      britshText: """IpaUK: /ˌɡrænjuleɪtɪd ˈʃʊɡə(r)/""",
                      americanText: """IpaUS: /ˌɡrænjuleɪtɪd ˈʃʊɡər/""",
...
کوردی: 
"""),
// With short examples define "granulated sugar", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) شەکری سپی لە شێوەی دەنکی ورد"""),
                    SentencesRow(
                      englishText:
                          """Some people like sweeter sauces, so you can add honey or granulated sugar to taste.""",
                      kurdishText:
                          """هەندێک کەس حەزیان بە سەرچاوەی شیرینتر هەیە، بۆیە دەتوانی هەنگوین یان شەکری ورد بۆ تام زیاد بکەیت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/VvJm4pQZ04s?t=';
...
const String _videoIdtwo = 'https://youtu.be/q7JDYiLz9Mo?t=';
const double _startSecondstwo = 00000000000000000000000000048;
const String _videoIdthree = 'https://youtu.be/kDdUdvNQndo?t=';
const double _startSecondsthree = 000000000000000000000000000228;
const String _videoIdfour = 'https://youtu.be/TudhYwBrgYg?t=';
const double _startSecondsfour = 000000000000000000000000000370;
const String _videoIdfive = 'https://youtu.be/o41k-faChfA?t=';
