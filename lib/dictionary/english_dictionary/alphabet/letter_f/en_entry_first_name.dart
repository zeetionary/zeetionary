...
class EnglishEntryfirstname extends StatefulWidget {
  const EnglishEntryfirstname({super.key});

  @override
  State<EnglishEntryfirstname> createState() => _EnglishEntryfirstnameState();
}

class _EnglishEntryfirstnameState extends State<EnglishEntryfirstname> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: first name (Derived forms: first names)
1. The name that precedes the surname (= given name, forename)
""",
  );

  final String keyword = "first name";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""first name""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His first name is Tom and his surname is Green.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Please give all your first names.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Please call me by my first name.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """first name""",
                      // alsoEnglishWord: "also: first name",
                      britshText: """IpaUK: /ˈfɜːst neɪm/""",
                      americanText: """IpaUS: /ˈfɜːrst neɪm/""",
...
// With short examples define "first name", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ناوی یەکەمی تۆمە و نازناوەکەی گرینە.""",
                    ...
                    SentencesRow(
                      englishText: """Please give all your first names.""",
                      kurdishText:
                          """تکایە هەموو ناوە یەکەمینەکانیانتان بڵێن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Please call me by my first name.""",
                      kurdishText: """تکایە بە ناوی یەکەمم بانگم بکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/UoSSCUMk-7I?t=';
const double _startSecondsend = 000000000000000000000000000416;
const String _videoIdone = 'https://youtu.be/f--yOQ29icA';
...
const double _startSecondsthree = 0000000000000000000000000001427;
const String _videoIdfour = 'https://youtu.be/CD7UmmLhFR8?t=';
const double _startSecondsfour = 000000000000000000000000000823;
const String _videoIdfive = 'https://youtu.be/hDDTUb_1cQc?t=';
