...
class EnglishEntryfoolhardy extends StatefulWidget {
  const EnglishEntryfoolhardy({super.key});

  @override
  State<EnglishEntryfoolhardy> createState() => _EnglishEntryfoolhardyState();
}

class _EnglishEntryfoolhardyState extends State<EnglishEntryfoolhardy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: foolhardy (Derived forms: foolhardiest, foolhardier)
1. Marked by defiant disregard for danger or consequences (= heady, rash, reckless)
"foolhardy enough to try to seize the gun from the hijacker";
""",
  );

  final String keyword = "foolhardy";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foolhardy""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foolhardy""",
                      // alsoEnglishWord: "also: foolhardy",
                      britshText: """IpaUK: /ˈfuːlhɑːdi/""",
                      americanText: """IpaUS: /ˈfuːlhɑːrdi/""",
...
کوردی: 	هەڵەشە، سەرچڵ،	گەوج، گەوجانە، کەرانە
"""),
// With short examples define "foolhardy", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """It would be foolhardy to try and predict the outcome of the talks at this stage.""",
                      kurdishText:
                          """گەمژانە دەبێت هەوڵ بدەیت دەرەنجامی گفتوگۆکان لەم قۆناغەدا پێشبینی بکەیت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Wzn6BAJwqB8?t=';
const double _startSecondsend = 000000000000000000000000000119;
const String _videoIdone = 'https://youtu.be/xzZH151_wXo?t=';
const double _startSecondsone = 000000000000000000000000000474;
const String _videoIdtwo = 'https://youtu.be/rEDkdPJHScA?t=';
const double _startSecondstwo = 000000000000000000000000000443;
const String _videoIdthree = 'https://youtu.be/n9_KeIfJdPM?t=';
const double _startSecondsthree = 000000000000000000000000000991;
const String _videoIdfour = 'https://youtu.be/XI4wNY61cl4?t=';
const double _startSecondsfour = 0000000000000000000000000001935;
const String _videoIdfive = 'https://youtu.be/0dy5uhZSG18?t=';
