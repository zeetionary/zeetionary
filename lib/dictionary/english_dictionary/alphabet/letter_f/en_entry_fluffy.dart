...
class EnglishEntryfluffy extends StatefulWidget {
  const EnglishEntryfluffy({super.key});

  @override
  State<EnglishEntryfluffy> createState() => _EnglishEntryfluffyState();
}

class _EnglishEntryfluffyState extends State<EnglishEntryfluffy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fluffy (Derived forms: fluffier, fluffiest)
1. Like down or as soft as down (= downy, downlike, flossy)
 
2. [informal] Lacking depth of intellect or knowledge; concerned only with what is obvious (= shallow)
 
3. Covered with fluff
""",
  );

  final String keyword = "fluffy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fluffy kitten played with a ball of yarn.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Beat the butter and sugar until soft and fluffy.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The airplane flew above the fluffy white clouds.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fluffy""",
                      // alsoEnglishWord: "also: fluffy",
                      britshText: """IpaUK: /ˈflʌfi/""",
                      americanText: """IpaUS: /ˈflʌfi/""",
...
// With short examples define "fluffy", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بێچووەپشیلە تووکنەکە بە گلۆرەیەک ڕیس یاری دەکرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) خواردنێک کە نەرم و سووکە و هەوای تێدایە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Beat the butter and sugar until soft and fluffy.""",
                      kurdishText:
                          """کەرە و شەکر تێکەڵ بکە تاوەکو نەرم و پفەڵ دەبێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """فڕۆکەکە بەسەر هەورە سپییە پفەڵەکانەوە دەفڕی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/DO9U_XxN-Kc?t=';
const double _startSecondsend = 000000000000000000000000000376;
const String _videoIdone = 'https://youtu.be/qWAagS_MANg?t=';
const double _startSecondsone = 000000000000000000000000000855;
const String _videoIdtwo = 'https://youtu.be/9TugA_z5vQE?t=';
const double _startSecondstwo = 000000000000000000000000000426;
const String _videoIdthree = 'https://youtu.be/rRymSi8SmqA?t=';
const double _startSecondsthree = 000000000000000000000000000281;
const String _videoIdfour = 'https://youtu.be/P8m-KThvtxA?t=';
const double _startSecondsfour = 000000000000000000000000000313;
const String _videoIdfive = 'https://youtu.be/vzKuobmi3iI';
