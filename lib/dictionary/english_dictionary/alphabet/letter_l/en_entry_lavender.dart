...
class EnglishEntrylavender extends StatefulWidget {
  const EnglishEntrylavender({super.key});

  @override
  State<EnglishEntrylavender> createState() => _EnglishEntrylavenderState();
}

class _EnglishEntrylavenderState extends State<EnglishEntrylavender> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lavender""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We have an extensive range of lavender-scented products.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He bought lavender curtains for the living room.""");
  }
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕووەکێکی باخچە کە پەڕی مۆری هەیە و بۆنی خۆشە؛ گوڵی وشکبووی کە لە درووستکردنی هەندێک بەرهەمدا بەکاردێت"""),
                    SentencesRow(
                      englishText:
                          """We have an extensive range of lavender-scented products.""",
                      kurdishText:
                          """ژمارەیەکی زۆر بەرهەمی بۆن لاڤندەرمان هەیە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) ڕەنگێکی مۆری کاڵ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He bought lavender curtains for the living room.""",
