...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 4832;
    const String videoIdone = 'Ad-YqwhUsTE';
    const double startSecondsone = 94;
    const String videoIdtwo = 'RVxgyz_avQM';
    const double startSecondstwo = 658;
    const String videoIdthree = '-C5XV5o9nvc';
    const double startSecondsthree = 197;
    const String videoIdfour = 'Te2IqFbRR7A';
    const double startSecondsfour = 866;
    const String videoIdfive = 'QHbqHx3TLBE';
    const double startSecondsfive = 1123;
