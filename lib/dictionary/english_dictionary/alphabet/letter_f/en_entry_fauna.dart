...
class EnglishEntryfauna extends StatefulWidget {
  const EnglishEntryfauna({super.key});

  @override
  State<EnglishEntryfauna> createState() => _EnglishEntryfaunaState();
}

class _EnglishEntryfaunaState extends State<EnglishEntryfauna> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fauna""",
                      // alsoEnglishWord: "also: fauna",
                      britshText: """IpaUK: /ˈfɔːnə/""",
                      americanText: """IpaUS: /ˈfɔːnə/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""While she was in Hawaii, she studied the local flora and fauna.""");
  }
...
// With short examples define "fauna", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: 
"""),
          const DefinitionKurdish(text: """١. (ناو) تەواوی ئەو ئاژەڵانەی لە ناوچەیەکدا یان لە قۆناغێکی دیاریکراوی مێژوودا ژیاون"""),
          SentencesRow(
            englishText:
                """While she was in Hawaii, she studied the local flora and fauna.""",
            kurdishText: """کە لە هاوایی بوو لێکۆڵینەوەی لە ڕووەک و گیانلەبەرە خۆجێییەکان کرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fauna
1. All the animal life in a particular region or period (= zoology)
"the fauna of China";
 
2. A living organism characterized by voluntary movement (= animal, animate being, beast, brute, creature)
""",
  );
...
const String _videoIdend = 'https://youtu.be/2DsnWcWeyoI?t=';
const double _startSecondsend = 000000000000000000000000000148;
const String _videoIdone = 'https://youtu.be/kw2NxzfP8K4?t=';
const double _startSecondsone = 000000000000000000000000000812;
const String _videoIdtwo = 'https://youtu.be/K-9iQqrHgj8?t=';
const double _startSecondstwo = 000000000000000000000000000508;
const String _videoIdthree = 'https://youtu.be/mw9uKzy4GRs?t=';
const double _startSecondsthree = 000000000000000000000000000722;
const String _videoIdfour = 'https://youtu.be/Hcq9_Tw2eTE?t=';
const double _startSecondsfour = 0000000000000000000000000001418;
const String _videoIdfive = 'https://youtu.be/eDyTyszVyCM?t=';
