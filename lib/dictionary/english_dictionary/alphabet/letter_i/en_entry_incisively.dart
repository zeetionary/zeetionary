...
class EnglishEntryincisively extends StatefulWidget {
  const EnglishEntryincisively({super.key});

  @override
  State<EnglishEntryincisively> createState() => _EnglishEntryincisivelyState();
}

class _EnglishEntryincisivelyState extends State<EnglishEntryincisively> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incisively""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'ePBk89ABOJ4';
    const double startSecondsend = 2016;
    const String videoIdone = 'lldfiKVLxz0';
    const double startSecondsone = 876;
    const String videoIdtwo = 'mj8yxkE7Btc';
    const double startSecondstwo = 199;
    const String videoIdthree = '3idbxKUcjqg';
    const double startSecondsthree = 192;
    const String videoIdfour = 'otDt_gN5YFQ';
    const double startSecondsfour = 590;
    const String videoIdfive = '3n4qQo4ObJQ';
    const double startSecondsfive = 2303;
