...
class EnglishEntryleapyear extends StatefulWidget {
  const EnglishEntryleapyear({super.key});

  @override
  State<EnglishEntryleapyear> createState() => _EnglishEntryleapyearState();
}

class _EnglishEntryleapyearState extends State<EnglishEntryleapyear> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""leap year""");
  }
