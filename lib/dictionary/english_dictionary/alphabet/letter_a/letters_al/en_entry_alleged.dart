...
class EnglishEntryalleged extends StatelessWidget {
  ...
  Future<void> speakalleged(String languageCode) async {
    ...
    await flutterTts.speak("alleged");
  }
  ...
  Future<void> speakalleged35962(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The girl gave evidence in court against her alleged attacker.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈledʒd/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈledʒd/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'BLn-Kkq_fwQ';
