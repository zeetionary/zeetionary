...
class EnglishEntryleadingarticle extends StatefulWidget {
  const EnglishEntryleadingarticle({super.key});

  @override
  State<EnglishEntryleadingarticle> createState() => _EnglishEntryleadingarticleState();
}

class _EnglishEntryleadingarticleState extends State<EnglishEntryleadingarticle> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""leading article""");
  }
