...
class EnglishEntryinefficiently extends StatefulWidget {
  const EnglishEntryinefficiently({super.key});

  @override
  State<EnglishEntryinefficiently> createState() =>
      _EnglishEntryinefficientlyState();
}

class _EnglishEntryinefficientlyState extends State<EnglishEntryinefficiently> {
  @override
  void initState() {
    super.initState();
...
1. In an inefficient manner
"he dealt inefficiently with the crisis"
""",
  );

  final String keyword = "inefficiently";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inefficiently""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""These cities were inefficiently organized for production.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/YDvXOHjV4UM?t=';
    const double startSecondsend = 000000000000000000000000000696;
    const String videoIdone = 'https://youtu.be/PIulbHyK0bc?t=';
    const double startSecondsone = 000000000000000000000000000150;
    const String videoIdtwo = 'https://youtu.be/YJi-Kdy84_k?t=';
    const double startSecondstwo = 00000000000000000000000000099;
    const String videoIdthree = 'https://youtu.be/8ge3ah1G8ok?t=';
    const double startSecondsthree = 000000000000000000000000000118;
    const String videoIdfour = 'https://youtu.be/Kj4PE9uATJA?t=';
    const double startSecondsfour = 0000000000000000000000000002405;
    const String videoIdfive = 'https://youtu.be/KkSLRMCVc9E?t=';
    const double startSecondsfive = 00000000000000000000000000044;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inefficiently""",
                      // alsoEnglishWord: "also: inefficiently",
                      britshText: """IpaUK: /ˌɪnɪˈfɪʃntli/""",
                      americanText: """IpaUS: /ˌɪnɪˈfɪʃntli/""",
...
// کوردی: لێنەهاتووانە، لێنەوەشاوانە، بەکارنەهاتووانە
// """),
// With short examples define "inefficiently", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە کارێک بە باشی ناکات بەوەی بە باشترین شێوە کات، پارە، وزە، هتد بەکاربێنێت"""),
                    SentencesRow(
                      englishText:
                          """These cities were inefficiently organized for production.""",
                      kurdishText:
                          """ئەم شارانە ناکارامانە ڕێکخرابوون بۆ بەرهەمهێنان.""",
