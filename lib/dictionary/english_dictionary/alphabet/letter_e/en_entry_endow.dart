...
// """),
          const DefinitionKurdish(
              text:
                  """١. (کردار) پێدانی داھات یان پارەیەکی زۆر بە قوتابخانە، کۆلێژ، یان پەیمانگایەکی دیکە"""),
          SentencesRow(
            englishText:
                """The state of Michigan has endowed three institutes to do research for industry.""",
            kurdishText:
          ...
          SentencesRow(
            ...
            kurdishText:
                """لە ساڵی ١٩٣٧ میڵۆن خەرجی پێشانگای نیشتیمانیی ھونەری کرد""",
