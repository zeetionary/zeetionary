...
class EnglishEntryiridescent extends StatefulWidget {
  const EnglishEntryiridescent({super.key});

  @override
  State<EnglishEntryiridescent> createState() => _EnglishEntryiridescentState();
}

class _EnglishEntryiridescentState extends State<EnglishEntryiridescent> {
  @override
  void initState() {
    super.initState();
...
1. Varying in colour when seen in different lights or from different angles (- changeable, chatoyant, shot)
"iridescent silk"; "a dragonfly hovered, vibrating and iridescent";
 
2. Having a play of lustrous rainbow colours (- nacreous, opalescent, opaline, pearlescent)
"an iridescent oil slick"; "iridescent clouds looking like mother-of-pearl";
""",
  );

  final String keyword = "iridescent";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""iridescent""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Her latest fashion collection features iridescent materials.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/unk6n3_QdlM?t=';
    const double startSecondsend = 000000000000000000000000000582;
    const String videoIdone = 'https://youtu.be/HxRUuGqqMG4?t=';
    const double startSecondsone = 0000000000000000000000000001161;
    const String videoIdtwo = 'https://youtu.be/Df3u46xBVMY?t=';
    const double startSecondstwo = 000000000000000000000000000648;
    const String videoIdthree = 'https://youtu.be/cmSphKD18uo?t=';
    const double startSecondsthree = 000000000000000000000000000169;
    const String videoIdfour = 'https://youtu.be/v4GiajimGnE?t=';
    const double startSecondsfour = 000000000000000000000000000882;
    const String videoIdfive = 'https://youtu.be/h4vFpXImJZY?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """iridescent""",
                      // alsoEnglishWord: "also: iridescent",
                      britshText: """IpaUK: /ˌɪrɪˈdesnt/""",
                      americanText: """IpaUS: /ˌɪrɪˈdesnt/""",
...
کوردی: کۆلکەزێڕینەیی، پڕئاڵاوواڵا
"""),
// With short examples define "iridescent", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە زۆر ڕەنگی ڕەنگینی هەیە کە وا دەردەکەوێت لە ڕۆشنایی جیاوازدا بگۆڕێت"""),
                    SentencesRow(
                      englishText:
                          """Her latest fashion collection features iridescent materials.""",
                      kurdishText:
                          """تازەترین کۆکراوەی فاشنی مادەی پڕئاڵاوواڵا لەخۆ دەگرێت.""",
