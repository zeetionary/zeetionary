...
class EnglishEntryflex extends StatefulWidget {
  const EnglishEntryflex({super.key});

  @override
  State<EnglishEntryflex> createState() => _EnglishEntryflexState();
}

class _EnglishEntryflexState extends State<EnglishEntryflex> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: flex (Derived forms: flexing, flexed, flexes)
1. Bend a joint (= bend)
"flex your wrists";
...
5. Cause (an object) to assume a crooked or angular form (= bend, deform, twist, turn)
"flex the rod";

- Noun: flex (Derived forms: flexes)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""First, straighten your legs, then flex your feet.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He tried to impress me by flexing his huge muscles.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The appliance comes with a flex and a plug.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flex""",
                      // alsoEnglishWord: "also: flex",
                      britshText: """IpaUK: /fleks/""",
                      americanText: """IpaUS: /fleks/""",
...
// With short examples define "flex", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) چەماندنەوەی لاق، باڵ، هتد، یان گرژکردنی ماسوولکە"""),
                    SentencesRow(
                      englishText:
                          """First, straighten your legs, then flex your feet.""",
                      kurdishText:
                          """سەرەتا لاقەکانت ڕاست بکەرەوە، و دواتر پێت گرژ بکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەوڵیدا سەرنج، ڕابکێشێت بە گرژکردنی ماسوولکە گەورەکانی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئامێرەکە وایەر و پلاکی لەگەڵە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/NdTalMWrQ7c?t=';
const double _startSecondsend = 00000000000000000000000000021;
const String _videoIdone = 'https://youtu.be/yRmOWcWdQAo?t=';
const double _startSecondsone = 0000000000000000000000000001275;
const String _videoIdtwo = 'https://youtu.be/Gv4Af83KFrE?t=';
const double _startSecondstwo = 0000000000000000000000000001636;
const String _videoIdthree = 'https://youtu.be/3RkhZgRNC1k?t=';
const double _startSecondsthree = 000000000000000000000000000421;
const String _videoIdfour = 'https://youtu.be/Ihoys69G56U?t=';
const double _startSecondsfour = 000000000000000000000000000646;
const String _videoIdfive = 'https://youtu.be/5MwEBEq2Axw?t=';
const double _startSecondsfive = 000000000000000000000000000486;
