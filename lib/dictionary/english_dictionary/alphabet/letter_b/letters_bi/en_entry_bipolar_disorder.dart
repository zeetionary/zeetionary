...
// blank divider
  ...
  Future<void> speakbipolardisorders1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("At age 13 she was diagnosed with bipolar disorder.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "bipolar disorder"),
                          ],
                        ),
                        const Row(
                          children: [
                            AlsoEnglish(word: "also: manic depression"),
                          ],
                        ),
                        Row(
                          children: [
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final double _startSeconds = 6205;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final double _startSeconds = 1922;
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'Tf7c7tOUXTc';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'YH9GnNzG-ds';
