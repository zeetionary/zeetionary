...
// replace these: EnglishEntryabridge - speakAbridge - abridge - /əˈbrɪdʒ/

enum TtsState { playing }

class EnglishEntryabridge extends StatelessWidget {
  EnglishEntryabridge({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'abridge', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈbrɪdʒ/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'F1R_IFveYkw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'w9MO18F5Wi8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'B-s3YxqCt6g';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '5ntV_XX_Er0';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'l1dyox71Y7o';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'ymKFl7rJY48';
