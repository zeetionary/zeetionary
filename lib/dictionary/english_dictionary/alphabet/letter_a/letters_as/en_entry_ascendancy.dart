                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "ascendancy"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈsendənsi/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈsendənsi/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'pSIh_mTEy_o';
  final double _startSeconds = 1191;
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'yfoCcEWkpDQ';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Lp0a-0oIz_Q';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '5y7a1Eb6QR4';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'qvO3_kYRRw8';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'BQ_XckGOn9o';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'W3wncm9s2AM';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = '-bcKRd_lfAg';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'qm2dCDUcQ9o';
  final double _startSeconds = 1835;
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = '3OkxTWoNf0I';
