...
class EnglishEntrylimb extends StatefulWidget {
  const EnglishEntrylimb({super.key});

  @override
  State<EnglishEntrylimb> createState() => _EnglishEntrylimbState();
}

class _EnglishEntrylimbState extends State<EnglishEntrylimb> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: limb (Derived forms: limbs)
1. One of the jointed appendages of an animal used for locomotion or grasping: arm; leg; wing; flipper
 
2. Any of the main branches arising from the trunk or a bough of a tree (- tree branch)
...
6. Any projection that is thought to resemble a human arm (- arm, branch)
"the limb of the record player";
""",
  );

  final String keyword = "limb";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""For a while, she lost the use of her limbs.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I stretched my limbs lazily as I sat up.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The animal is able to stand up on its hind limbs.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Giraffes are known for their long-limbed elegance.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/qjqh9UVfNNk?t=739';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/P8m-KThvtxA?t=519';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/hFZFjoX2cGg?t=1047';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/WNOgyKJlh6w?t=2661';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/hRSGxw2AQnk?t=1247';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/J-K5OjAkiEA?t=75';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """limb""",
                      // alsoEnglishWord: "also: limb",
                      britshText: """IpaUK: /lɪm/""",
                      americanText: """IpaUS: /lɪm/""",
...
کوردی: دەس، دەست، ئەندام، پێ، لاق، پەل، باڵ،	ئەندام،	لق، تا؛ پەلی دار،	ئەندامێکی چالاک،	بەشێکی دەرپەڕیوی خانوویێ،	هەر بەشێکی کەوان،	بەش یان ئەندامێکی دەرپەڕیو
"""),
// With short examples define "limb", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) پەل؛ باڵ و یان لاق"""),
                    SentencesRow(
                      englishText: """For a while, she lost the use of her limbs.""",
                      kurdishText: """بۆ ماویەک بەکارهێنانی پەلەکانیی لەدەستدا.""",
                    ...
                    SentencesRow(
                      englishText: """I stretched my limbs lazily as I sat up.""",
                      kurdishText: """تەمەڵانە پەلەکانمم درێژ کرد کە هەستامە سەر پێ.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The animal is able to stand up on its hind limbs.""",
                      kurdishText: """ئاژەڵەکە دەتوانێت هەستێتە سەر پەلەکانی دواوەی.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) هەبوونی ئەو جۆرە پەلەی کە باسکراوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Giraffes are known for their long-limbed elegance.""",
                      kurdishText: """زەڕافە ناسراوە بۆ جوانیی پەلە درێژەکانیان.""",
