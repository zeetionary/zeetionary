...
class EnglishEntryeruption extends StatefulWidget {
  const EnglishEntryeruption({super.key});

  @override
  State<EnglishEntryeruption> createState() => _EnglishEntryeruptionState();
}

class _EnglishEntryeruptionState extends State<EnglishEntryeruption> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""eruption""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """eruption""",
                      // alsoEnglishWord: "also: eruption",
                      britshText: """IpaUK: /ɪˈrʌpʃn/""",
                      americanText: """IpaUS: /ɪˈrʌpʃn/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Recent volcanic eruptions have claimed the lives of journalists and scientists.""");
  }
...
کوردی: تەقینەوە، هەڵچوون، فیشقان،	دەس‌پێکردن، دەسپێک، سەرەتا،	پەیدابوون، دەرکەوتن، دەرهاتن، سەردەرهێنان، هاتنەدەرێ، هەڵزڵەپان، دەرکردن، هەڵتۆقین، هەڵپشکوتن،	تەنینەوە،	ئاژاوە، پشێوی، ئاڵۆزایی
"""),
          const DefinitionKurdish(text: """١. (ناو) تەقینەوەی گڕکان"""),
          SentencesRow(
            englishText:
                """Recent volcanic eruptions have claimed the lives of journalists and scientists.""",
            kurdishText:
                """تەقینەوەی گڕکانی ئەم ماوەیە بووە بە هۆکاری مردنی ڕۆژنامەنووسان و زاناکان.""",
          ...
          SentencesRow(
            englishText:
                """The curfew was aimed at preventing any eruption of violence in the capital.""",
            kurdishText:
                """قەدەغەی هاتووچۆکە ئامانجی بوو کە ڕێگا لە تەشەنەسەندنی توندوتیژی بگرێت لە پایتەخت.""",
            onPressedBritish: () => speaksentence2("en-GB"),
            onPressedAmerican: () => speaksentence2("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٣. (ناو) دەربڕینی لەناکاوی هەستی بەهێز"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """His comment triggered an eruption of laughter.""",
            kurdishText: """لێدوانەکەی بووە هۆکاری پێکەنینێکی لەپڕ.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: eruption (Derived forms: eruptions)
1. The sudden occurrence of a violent discharge of steam and volcanic material (= volcanic eruption)
 
2. (medicine) symptom consisting a rash or blemish appearing on the skin
 
3. (of volcanoes) pouring out fumes or lava (or a deposit so formed) (= eructation [formal], extravasation)
 
4. A sudden violent spontaneous occurrence (usually of some undesirable condition) (= outbreak, irruption)
"the eruption of hostilities";
 
5. A sudden very loud noise (= bang, clap, blast, bam)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/Q4Xys-IRMr0?t=';
const double _startSecondsend = 000000000000000000000000000000; // 115;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/s3YTfhJmh1I?t=';
const double _startSecondsone = 00000000000000000000000000000; // 118;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/jTRC_FMzLoo?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 117;
const String _videoIdthree = 'VIDEOhttps://youtu.be/LXkO4HdQXdo?t=';
const double _startSecondsthree = 000000000000000000000000000; // 226;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/PhQksV8fbKw?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1707;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/7EDflnGzjTY?t=';
