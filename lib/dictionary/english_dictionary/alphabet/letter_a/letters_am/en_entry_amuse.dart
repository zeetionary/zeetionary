...
// replace these: replace EnglishEntryamuse - replace speakAmuse - replace amuse - /əˈmjuːz/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryamuse extends StatelessWidget {
  EnglishEntryamuse({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAmuse(String languageCode) async {
    // DOPSUM: CHANGE speakAmuse
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("amuse"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAmuse448096(String languageCode) async {
    ...
    await flutterTts.speak(
        "I've brought an article from yesterday's paper that I thought might amuse you."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "amuse", // DOPSUM: CHANGE WORD ENTRY - Find /əˈmjuːz/
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: const Text(
                                "IpaUK: /əˈmjuːz/", // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAmuse(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /əˈmjuːz/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'PEZiiKpE-jY';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = '7qmj0a8srCg';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'cpHNwgM1_oE';
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = 'Xp_YghlYskU';
