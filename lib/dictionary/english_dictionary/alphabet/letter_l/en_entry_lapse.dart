...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I had a momentary lapse when I couldn't remember his name.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It was an odd lapse for one who is normally so polite.""");
  }
...
// With short examples define "lapse", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) هەڵەیەکی بچووک، بە تایبەتی بە کە بە لەبیرکردنی شتێک یان بە بێ‌ئاگایی درووست دەبێت"""),
                    SentencesRow(
                      englishText: """I had a momentary lapse when I couldn't remember his name.""",
                      kurdishText: """تێکچوونێکی کورتخایەنم هەبوو کە نەمتوانی ناویم بیربکەوێتەوە.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ماوەی نێوان دوو شت کە ڕووددەەن"""),
                    const AlsoEnglishckb(word: "ھەروەھا: interval"),
                    SentencesRow(
                      englishText: """After a lapse of six months we met up again.""",
                      kurdishText: """لە دوای ماوەی شەش مانگ دووبارە یەکدیمان بینیوە.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) نموونە یان ماوەیەک لە ڕەفتاری خراپی کەسێک کە بە شێوەی ئاسایی باشە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """It was an odd lapse for one who is normally so polite.""",
                      kurdishText: """ڕەفتارێکی نامۆ بوو بۆ کەسێک کە زۆرجار بەڕێزە.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) ئەوەی چی دیکە بە فەرمی دانپێدانراو نەبێت بەهۆی ئەوەی ماوەی تەواو بووە"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (کردار) ئەوەی کەم کەم لاواز بێت یان کۆتایی بێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: expire"),
                    SentencesRow(
                      englishText: """This custom had lapsed over the years.""",
                      kurdishText: """ئەم نەریتە لە ماوەی ساڵاندا کاڵ بووەتەوە.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٦. (کردار) ئەوەی واز لە ئایینەکەت بهێنیت یان چی دیکە پەیڕەوی نەکەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He lapsed from Judaism when he was a student.""",
                      kurdishText: """باوەڕی بە جودایزم نەما کە خوێندکار بوو.""",
