...
// replace EnglishEntryartfully - replace speakArtfully

// replace artfully - /ˈɑːtfəli/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryartfully extends StatelessWidget {
  // blank divider
  EnglishEntryartfully({super.key});
  // blank divider
  ...
  Future<void> speakartfully(String languageCode) async {
    ...
    await flutterTts.speak("artfully");
  }
  ...
  Future<void> speakartfully441(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("In our conversation, he was artfully vague about his plans.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "artfully"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɑːtfəli/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrtfəli/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakartfully441("en-US"),
                          ),
...
٢. (ھاوەڵکار) بەشێوەیەکی زیرەکانە و وتنی درۆ"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakartfully443("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
