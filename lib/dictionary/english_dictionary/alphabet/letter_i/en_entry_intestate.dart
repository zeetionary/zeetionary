...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'Gq6s6W0yVWk';
    const double startSecondsend = 165;
    const String videoIdone = '4anVYVJvtBI';
    const double startSecondsone = 605;
    const String videoIdtwo = 'FdSe-YvTFe0';
    const double startSecondstwo = 47;
    const String videoIdthree = 'hlfv4puOXUA';
    const double startSecondsthree = 88;
    const String videoIdfour = 'P3bqYF6cVe0';
    const double startSecondsfour = 74;
    const String videoIdfive = 'x3k01A7hWG0';
    const double startSecondsfive = 1657;
