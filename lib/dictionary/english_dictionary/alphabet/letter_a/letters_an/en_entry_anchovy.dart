...
class EnglishEntryanchovy extends StatelessWidget {
  ...
  Future<void> speakanchovy(String languageCode) async {
    ...
    await flutterTts.speak("anchovy");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'VMEyb5ngWFM';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'YpUDblEURdY';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'nwnhoOIQ5KU';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'MP_nWuLYpJw';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'dr3rMTxq3bA';
