...
class EnglishEntryexhilarate extends StatefulWidget {
  const EnglishEntryexhilarate({super.key});

  @override
  State<EnglishEntryexhilarate> createState() => _EnglishEntryexhilarateState();
}

class _EnglishEntryexhilarateState extends State<EnglishEntryexhilarate> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exhilarate""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exhilarate""",
                      // alsoEnglishWord: "also: exhilarate",
                      britshText: """IpaUK: /ɪɡˈzɪləreɪt/""",
                      americanText: """IpaUS: /ɪɡˈzɪləreɪt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exhilarate";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Speed had always exhilarated him.""");
  }
...
// With short examples define "exhilarate", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          const DefinitionKurdish(
              text: """١. (کردار) دڵخۆشکردنی کەسێک بە ئاستێکی زۆر"""),
          SentencesRow(
            englishText: """Speed had always exhilarated him.""",
            kurdishText: """خێرایی هەمیشە دڵخۆشی کردبوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: exhilarate (Derived forms: exhilarating, exhilarates, exhilarated)
1. Fill with sublime emotion (= tickle pink, inebriate, thrill, exalt, beatify)
"He was exhilarated by his phenomenal success";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/SCJ3AyGypFg?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1333;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/2Uswoc6EcPc?t=';
const double _startSecondsone = 00000000000000000000000000000; // 10;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/fr2T6gZOFko?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 412;
const String _videoIdthree = 'VIDEOhttps://youtu.be/9U4LlVHwuQw?t=';
const double _startSecondsthree = 000000000000000000000000000; // 853;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/YJqihBR-C0A?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 2294;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/h4aftFAP6uQ?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 242;
