...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'dTSOeQWjXN4';
    const double startSecondsend = 4315;
    const String videoIdone = 'TQH99-5O95A';
    const double startSecondsone = 9;
    const String videoIdtwo = 'CmFbML8rBt0';
    const double startSecondstwo = 703;
    const String videoIdthree = 'rZjkunmvLUk';
    const double startSecondsthree = 644;
    const String videoIdfour = 'mY6-98r52SI';
    const double startSecondsfour = 104;
    const String videoIdfive = '1_EjDyafhBY';
    const double startSecondsfive = 5151;
