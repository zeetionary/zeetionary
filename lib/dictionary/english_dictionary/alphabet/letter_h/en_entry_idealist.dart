...
class EnglishEntryidealist extends StatefulWidget {
  const EnglishEntryidealist({super.key});

  @override
  State<EnglishEntryidealist> createState() => _EnglishEntryidealistState();
}

class _EnglishEntryidealistState extends State<EnglishEntryidealist> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: idealist (Derived forms: idealists)
1. Someone guided more by ideals than by practical considerations (- dreamer)
""",
  );

  final String keyword = "idealist";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""idealist""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He's too much of an idealist for this government.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/qDjRoNlSrLI?t=';
    const double startSecondsend = 00000000000000000000000000012;
    const String videoIdone = 'https://youtu.be/DXlEoS6GkPI?t=';
    const double startSecondsone = 000000000000000000000000000193;
    const String videoIdtwo = 'https://youtu.be/s07dzQpyNaY?t=';
    const double startSecondstwo = 000000000000000000000000000514;
    const String videoIdthree = 'https://youtu.be/wp34lj6re2M?t=';
    const double startSecondsthree = 000000000000000000000000000519;
    const String videoIdfour = 'https://youtu.be/lYwQDNZrbWQ?t=';
    const double startSecondsfour = 000000000000000000000000000322;
    const String videoIdfive = 'https://youtu.be/AZYiZ42TqMs?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """idealist""",
                      // alsoEnglishWord: "also: idealist",
                      britshText: """IpaUK: /aɪˈdiːəlɪst/""",
                      americanText: """IpaUS: /aɪˈdiːəlɪst/""",
...
کوردی: ئایدیاڵیست، ئایدیاباوەڕ، ئیدەباوەڕ، ئایدیاگەر، نموونەباوەڕ
"""),
// With short examples define "idealist", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە پێی وایە دۆخێک، ژیانێک، هتد ــی ناوازە دەکرێت بەدەست بێت ئەگەرچی ئەگەری کەم بێت"""),
                    SentencesRow(
                      englishText:
                          """He's too much of an idealist for this government.""",
                      kurdishText:
                          """کەسێکی تاڕادەیەک ئایدیاڵیستە بۆ ئەم حکومەتە.""",
                      englishNote:
                          """This means he holds unrealistic or overly optimistic beliefs and values, which make him unsuited for the practical or pragmatic nature of this government.""",
