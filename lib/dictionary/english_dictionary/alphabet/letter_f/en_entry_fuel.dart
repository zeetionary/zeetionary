...
class EnglishEntryfuel extends StatefulWidget {
  const EnglishEntryfuel({super.key});

  @override
  State<EnglishEntryfuel> createState() => _EnglishEntryfuelState();
}

class _EnglishEntryfuelState extends State<EnglishEntryfuel> {
  @override
  void initState() {
    super.initState();
...
- Verb: fuel (Derived forms: fuels, fuelling, fuelled)
1. Provide with a combustible substance that provides energy
"fuel aircraft, ships, and cars"
 
2. Provide as a source of energy or heat (- fire)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The car has a 65-litre fuel tank.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We use fuel oil to heat our house.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The power plant burns sugar cane as fuel.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Make sure you don't run out of fuel.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Uranium is used to fuel nuclear plants.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The helicopter was already fuelled (up) and ready to go.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Higher salaries helped to fuel inflation.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fuel""",
                      // alsoEnglishWord: "also: fuel",
                      britshText: """IpaUK: /ˈfjuːəl/""",
                      americanText: """IpaUS: /ˈfjuːəl/""",
...
کوردی: سووتەمەنی، سوخت، سووتەک، شەواتەک، ئاوردوو، بزوێنەر، پاڵنەر، مایە، هۆ
"""),
// With short examples define "fuel", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هەر مادەیەک کە گەرمی یان وزە بەرهەم دەهێنێت کە دەسووتێندرێت"""),
                    SentencesRow(
                      englishText: """The car has a 65-litre fuel tank.""",
                      kurdishText:
                          """ئۆتۆمبێلەکە تانکییەکی ٦٥ لیتری سووتەمەنی هەیە.""",
                    ...
                    SentencesRow(
                      englishText: """We use fuel oil to heat our house.""",
                      kurdishText:
                          """سووتەمەنی نەوت بەکاردەهێنین بۆ گەرمکردنی خانووەکەمان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وێستگەی وزەکە قامیشی شەکر وەک سووتەمەنی دەسووتێنێت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Make sure you don't run out of fuel.""",
                      kurdishText:
                          """دڵنیابەروە کە بەبێ سووتەمەنی نامێنیتەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """His remarks simply added fuel to the fire/flames of her rage.""",
                      kurdishText:
                          """لێدوانەکانی تەنها سووتەمەنی زیادکرد بۆ ئاگری تووڕەییەکەی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """یۆرانیۆم بەکاردێت بۆ کارپێکردنی وێستگە ئەتۆمییەکان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Most electric plants in California are fuelled by natural gas.""",
                      kurdishText:
                          """زۆرێک لە وێستگەکانی کارەبا لە کالیفۆرنیا بە گازی سرووشتی وزەیان پێدەدرێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (کردار) زیادکردنی بەنزین بۆ ناو پێڕۆیەک (ئۆتۆمبێل، هەلیکۆپتەر، هتد)"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The helicopter was already fuelled (up) and ready to go.""",
                      kurdishText:
                          """هەلیکۆپتەرەکە پێشوەختە پڕ لە سووتەمەنی کرابوو و ئامادەی ڕۆشتن بوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٥. (کردار) زیادکردنی شتێک؛ ئەوەی شتێک بەهێز بێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Higher salaries helped to fuel inflation.""",
                      kurdishText: """مووچەی زیاتر یارمەتیی هەڵاوسانی دا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تاوان زیاد دەکات بەهۆی ڕێژەی زۆری مادەی هۆشبەر.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/AFS6saV981Q?t=';
const double _startSecondsend = 000000000000000000000000000949;
const String _videoIdone = 'https://youtu.be/ARomrjtLTQU?t=';
const double _startSecondsone = 000000000000000000000000000125;
const String _videoIdtwo = 'https://youtu.be/ImN2ze6opHE?t=';
const double _startSecondstwo = 000000000000000000000000000102;
const String _videoIdthree = 'https://youtu.be/AF8d72mA41M?t=';
const double _startSecondsthree = 000000000000000000000000000680;
const String _videoIdfour = 'https://youtu.be/XI9kKiyIMf0?t=';
const double _startSecondsfour = 000000000000000000000000000210;
const String _videoIdfive = 'https://youtu.be/W2hRTTTpmr8?t=';
