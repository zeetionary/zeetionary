...
class EnglishEntryfraternally extends StatefulWidget {
  const EnglishEntryfraternally({super.key});

  @override
  State<EnglishEntryfraternally> createState() =>
      _EnglishEntryfraternallyState();
}

class _EnglishEntryfraternallyState extends State<EnglishEntryfraternally> {
  @override
  void initState() {
    super.initState();
...
"He signed the letter: 'Respectfully and fraternally yours.'"
""",
  );

  final String keyword = "fraternally";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fraternally""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """People of faith are called to love every creature and live fraternally with them.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He kissed her fraternally on the cheek.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fraternally""",
                      // alsoEnglishWord: "also: fraternally",
                      britshText: """IpaUK: /frəˈtɜːnəli/""",
                      americanText: """IpaUS: /frəˈtɜːrnəli/""",
...
کوردی: 
"""),
// With short examples define "fraternally", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) دۆستانە"""),
                    SentencesRow(
                      englishText:
                          """People of faith are called to love every creature and live fraternally with them.""",
                      kurdishText:
                          """کەسانی باوەڕدار داوایان لێدەکرێت هەموو گیانلەبەرێکیان خۆش بوێت و برایانە لەگەڵیان بژین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """برایانە ماچی گۆنایی کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/q1RnjJd2c88?t=';
const double _startSecondsend = 000000000000000000000000000337;
const String _videoIdone = 'https://youtu.be/NMSuOh_ZSWc?t=';
const double _startSecondsone = 000000000000000000000000000749;
const String _videoIdtwo = 'https://youtu.be/JjI7sN91so4?t=';
const double _startSecondstwo = 0000000000000000000000000002082;
const String _videoIdthree = 'https://youtu.be/QZZ1K5QH-_Y?t=';
const double _startSecondsthree = 000000000000000000000000000126;
const String _videoIdfour = 'https://youtu.be/65go0zxmP5Y?t=';
const double _startSecondsfour = 0000000000000000000000000002515;
const String _videoIdfive = 'https://youtu.be/CzeNqR_yZ64?t=';
