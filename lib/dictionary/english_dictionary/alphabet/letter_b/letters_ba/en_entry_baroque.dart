...
// Define the word "baroque" and provide five simple example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings or more.

// replace baroque - replace EnglishEntrybaroque

// replace speakBaroque - /bəˈrɒk/

enum TtsState { playing }

class EnglishEntrybaroque extends StatelessWidget {
// blank divider
  EnglishEntrybaroque({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakbaroque(String languageCode) async {
    // DOPSUM: CHANGE speakBaroque
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("baroque"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbaroques1(String languageCode) async {
    // DOPSUM: CHANGE speakBaroque
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
  ...
  Future<void> speakbaroques3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBaroques33"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbaroques4(String languageCode) async {
    // DOPSUM: CHANGE speakBaroque
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBaroques44"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbaroques5(String languageCode) async {
    // DOPSUM: CHANGE speakBaroque
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBaroques55"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbaroques6(String languageCode) async {
    // DOPSUM: CHANGE speakBaroque
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBaroques66"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbaroques7(String languageCode) async {
    // DOPSUM: CHANGE speakBaroque
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBaroques77"); // DOPSUM: CHANGE TEXT
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "baroque"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /bəˈrɒk/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakbaroque("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /bəˈrəʊk/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakbaroque("en-US"),
                            ),
                          ],
                        ),
                      ],
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: baroque
1. Having elaborate symmetrical ornamentation (= churrigueresque, churrigueresco)
"all those frilly facades and windows are ridiculously baroque";
...
- Noun: Baroque
1. The historic period from about 1600 until 1750 when the Baroque style of art, architecture, and music flourished in Europe (= Baroque era, Baroque period)
""",
  );
...
class _YoutubeEmbeddedtwoState extends State<YoutubeEmbeddedtwo> {
  late YoutubePlayerController _controller;
  final String _videoId = 'kKkjTbt9ArQ';
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  late YoutubePlayerController _controller;
  final String _videoId = 'BFKzX7u-3yg';
...
class _YoutubeEmbeddedsevenState extends State<YoutubeEmbeddedseven> {
  late YoutubePlayerController _controller;
  final String _videoId = 'hjVkIoNCnyU';
...
class _YoutubeEmbeddedeightState extends State<YoutubeEmbeddedeight> {
  late YoutubePlayerController _controller;
  final String _videoId = 'RykewR-BdzA';
...
// end baroque// TODO Implement this library.
