...
class EnglishEntryhardcurrency extends StatefulWidget {
  const EnglishEntryhardcurrency({super.key});

  @override
  State<EnglishEntryhardcurrency> createState() => _EnglishEntryhardcurrencyState();
}

class _EnglishEntryhardcurrencyState extends State<EnglishEntryhardcurrency> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hard currency (Derived forms: hard currencies)
...
2. Money in the form of bills or coins (- cash, hard cash)
""",
  );

  final String keyword = "hard currency";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hard currency""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Trade was halted because of a hard currency shortage on the island.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hard currency""",
                      // alsoEnglishWord: "also: hard currency",
                      britshText: """IpaUK: /ˌhɑːd ˈkʌrənsi/""",
                      americanText: """IpaUS: /ˌhɑːrd ˈkɜːrənsi/""",
...
// With short examples define "hard currency", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) پارەیەک کە بە ئاسانی دەگۆڕدرێتەوە بە پارەی وڵاتانی دیکە بەهۆی ئەوەی نرخی جێگیرە"""),
                    SentencesRow(
                      englishText: """Trade was halted because of a hard currency shortage on the island.""",
                      kurdishText: """بازرگانی ڕاگیردرا بەهۆی کەمی دراوی جێگیر لەسەر دوورگەکە.""",
