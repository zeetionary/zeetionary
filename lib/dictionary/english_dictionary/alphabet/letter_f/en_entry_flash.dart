...
// With short examples define "flash", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """درەوشانەوەی ڕووناکی تەقینەوەی بەدوادا هات.""",
                    ...
                    SentencesRow(
                      englishText:
                          """There was a blinding flash and the whole building shuddered.""",
                      kurdishText:
                          """درەوشانەوەیەکی ئێجگار زۆر هەبوو و تەواوی بیناکە لەرییەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """منارە ئاگادارکەرەوەکە هەر ١٥ چرکە جارێک ڕووناکی لێدەدات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٥. (ناو) بیرۆکەیەک یان هەستێک کە زوو دێتە مێشکت یان لەسەر ڕووخسارت دەردەکەوێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەستی بە چرکەساتێک لە بەخیکی کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕێبەرەکە لایتێکی هەڵدا بۆ ناو ئەشکەوتەکە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٧. (کردار) بەکارهێنانی ڕووناکی بۆ پێدانی ئاماژە بە کەسێک"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بیرکردنەوەیەکی ناخۆش هات بە مێشکمدا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """١٢. (کردار) ناردنی زانیاری بە خێرایی بە تەلەفیزیۆن، ڕادیۆ، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """News of their triumph was flashed around the world.""",
                      kurdishText:
                          """هەواڵی سەرکەوتنەکەیان بۆ هەموو جیهان نێردرا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """١٣. (هاوەڵناو) کە سەرنج ڕادەکێشێت بەوەی گەورە یان گران‌بەهایە"""),
                    const DividerSentences(),
                    SentencesRow(
...
const double _startSecondsend = 000000000000000000000000000118;
const String _videoIdone = 'https://youtu.be/F5pgG1M_h_U?t=';
const double _startSecondsone = 000000000000000000000000000110;
const String _videoIdtwo = 'https://youtu.be/7nGz7xgGJzc?t=';
const double _startSecondstwo = 00000000000000000000000000027;
const String _videoIdthree = 'https://youtu.be/oD9BaNAH-eE?t=';
const double _startSecondsthree = 0000000000000000000000000001186;
const String _videoIdfour = 'https://youtu.be/8eq2vGEEbB4?t=';
const double _startSecondsfour = 000000000000000000000000000513;
const String _videoIdfive = 'https://youtu.be/Z5FoX3ju2J0?t=';
