...
class EnglishEntryfortunately extends StatefulWidget {
  const EnglishEntryfortunately({super.key});

  @override
  State<EnglishEntryfortunately> createState() =>
      _EnglishEntryfortunatelyState();
}

class _EnglishEntryfortunatelyState extends State<EnglishEntryfortunately> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: fortunately
1. By good fortune (= fortuitously, luckily, as luck would have it)
"fortunately the weather was good";
""",
  );

  final String keyword = "fortunately";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fortunately""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I was late, but fortunately the meeting hadn't started.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The documents fortunately survived the fire.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fortunately""",
                      // alsoEnglishWord: "also: fortunately",
                      britshText: """IpaUK: /ˈfɔːtʃənətli/""",
                      americanText: """IpaUS: /ˈfɔːrtʃənətli/""",
...
// With short examples define "fortunately", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """درەنگ کەوت بووم، بەڵام خۆشبەختانە کۆبوونەوەکە هێشتا دەستی پێنەکردبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بەڵگەنامەکان خۆشبەختانە لە ئاگرەکە ڕزگاریان بوو.""",
...
const double _startSecondsend = 000000000000000000000000000110;
const String _videoIdone = 'https://youtu.be/zqllxbPWKNI?t=';
const double _startSecondsone = 000000000000000000000000000298;
const String _videoIdtwo = 'https://youtu.be/uN84HhcdIws?t=';
const double _startSecondstwo = 0000000000000000000000000001351;
const String _videoIdthree = 'https://youtu.be/MzSktgpfD84?t=';
const double _startSecondsthree = 000000000000000000000000000732;
const String _videoIdfour = 'https://youtu.be/Xzv84ZdtlE0?t=';
const double _startSecondsfour = 0000000000000000000000000001449;
const String _videoIdfive = 'https://youtu.be/YZoZr_m9WLU?t=';
