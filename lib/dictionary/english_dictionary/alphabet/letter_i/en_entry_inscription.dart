...
class EnglishEntryinscription extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inscription""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'twAP3buj9Og';
    const double startSecondsone = 1109;
    const String videoIdtwo = 'hapSlAP2xrc';
    const double startSecondstwo = 427;
    const String videoIdthree = 'UeRa9bEhgXg';
    const double startSecondsthree = 1309;
    const String videoIdfour = 'yA79KYMLUpI';
    const double startSecondsfour = 229;
    const String videoIdfive = 'HZq_HjKCRB4';
