...
// replace these: replace EnglishEntryadjudication - replace speakAdjudication - replace adjudication - /əˌdʒuːdɪˈkeɪʃn/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadjudication extends StatelessWidget {
  EnglishEntryadjudication({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdjudication(String languageCode) async {
    // DOPSUM: CHANGE speakAdjudication
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("adjudication"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAdjudi5684(String languageCode) async {
    // DOPSUM: CHANGE speakAdjudication
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "The case was referred to a higher court for adjudication."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˌdʒuːdɪˈkeɪʃn/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'mSm7sRx-0hA';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'C5K8pM9WP9E';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'zsd3YH3vGS0';
