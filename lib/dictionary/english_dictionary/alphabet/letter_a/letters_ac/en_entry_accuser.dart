...
// replace these: replace EnglishEntrytheaccuser - replace speakAccuser - replace accuser - /əˈkjuːzə(r)/ - find Dopsum2

enum TtsState { playing }

class EnglishEntrytheaccuser extends StatelessWidget {
  EnglishEntrytheaccuser({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAccuser(String languageCode) async {
    // DOPSUM: CHANGE speakAccuser
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("accuser"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakA91573(String languageCode) async {
    // DOPSUM: CHANGE speakAccuser
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "He demanded the right to face his accusers at a public hearing."); // DOPSUM: CHANGE TEXT
  }
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      length: 6, // 2 + VIDEOS FIND: DOPSUM_WRITE_A_SENTENCE
      child: Scaffold(
        appBar: AppBar(
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'accuser', // DOPSUM: CHANGE WORD ENTRY - Find /əˈkjuːzə(r)/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈkjuːzə(r)/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAccuser(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /əˈkjuːzər/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'Ad-YqwhUsTE';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'UwsgFMSd98I';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '2xLuCn5WlsY';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '6bqd8CLAjBw';
