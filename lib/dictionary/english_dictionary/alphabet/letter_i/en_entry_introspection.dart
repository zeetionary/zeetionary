...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'zqkf2U5jcE0';
    const double startSecondsend = 145;
    const String videoIdone = 'HBhXvLlB-kY';
    const double startSecondsone = 8722;
    const String videoIdtwo = 'zrqqrQmeQS4';
    const double startSecondstwo = 83;
    const String videoIdthree = 'CAmQ5ODJJfA';
    const double startSecondsthree = 3151;
    const String videoIdfour = 'UlY4TnCdL0s';
    const double startSecondsfour = 168;
    const String videoIdfive = 'UeH426gwVRc';
    const double startSecondsfive = 855;
