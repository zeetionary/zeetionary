...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'P3CjYb5VRik';
    const double startSecondsend = 145;
    const String videoIdone = '9yjZpBq1XBE';
    const double startSecondsone = 4780;
    const String videoIdtwo = 'KK3Yr80lPOY';
    const double startSecondstwo = 1629;
    const String videoIdthree = 'ew1edqVqCu0';
    const double startSecondsthree = 335;
    const String videoIdfour = '-XUzpAiYuVA';
    const double startSecondsfour = 174;
    const String videoIdfive = 'bzG4UOaGy7M';
    const double startSecondsfive = 660;
