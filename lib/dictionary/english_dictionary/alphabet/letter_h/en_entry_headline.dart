...
class EnglishEntryheadline extends StatefulWidget {
  const EnglishEntryheadline({super.key});

  @override
  State<EnglishEntryheadline> createState() => _EnglishEntryheadlineState();
}

class _EnglishEntryheadlineState extends State<EnglishEntryheadline> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: headline (Derived forms: headlines)
1. The heading or caption of a newspaper article (- newspaper headline)

- Verb: headline (Derived forms: headlined, headlines, headlining)
1. Publicize widely or highly, as if with a headline
 
2. (publication) provide (a newspaper page or a story) with a headline
""",
  );

  final String keyword = "headline";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""headline""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They ran the story under the headline ‘Home at last!’.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The scandal was in the headlines for several days.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Let's just hear the news headlines.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The story was headlined ‘Back to the future’.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The concert is to be headlined by Adele.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The story was headline news for two weeks.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """headline""",
                      // alsoEnglishWord: "also: headline",
                      britshText: """IpaUK: /ˈhedlaɪn/""",
                      americanText: """IpaUS: /ˈhedlaɪn/""",
...
کوردی: 
"""),
// With short examples define "headline", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ناونیشانی هەواڵێک کە لە سەرەوە دەنووسێت لەسەر ڕۆژنامەیەک یان وێبسایتێک"""),
                    SentencesRow(
                      englishText:
                          """They ran the story under the headline ‘Home at last!’.""",
                      kurdishText:
                          """بابەتەکەیان بڵاوکردەوە بە ناونیشانی 'لە کۆتاییدا لە ماڵەوە'.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئابڕووچوونەکە بۆ چەند ڕۆژێک لە سەردێڕەکاندا بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Journalists don't usually write the headlines for their stories.""",
                      kurdishText:
                          """ڕۆژنامەنووسان زۆرجار سەردێڕی بابەتەکانیان نانووسن (= بەشی هەواڵ بەرپرسن لە نووسینیان).""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) سەردێڕی هەواڵ کە لە سەرەتای پڕۆگرامی هەواڵی دەخوێندرێتەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Let's just hear the news headlines.""",
                      kurdishText:
                          """با تەنها گوێ لە دەردێڕی هەواڵەکان بگرین.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) پێدانی ناونیشان بە بابەتێکی هەواڵی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The story was headlined ‘Back to the future’.""",
                      kurdishText:
                          """بابەتەکە ناونیشانی 'گەڕانەوە بۆ داهاتوو' ـی پێدرا.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (کردار) بوون بە نمایشکاری سەرەکی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The concert is to be headlined by Adele.""",
                      kurdishText:
                          """کۆنسێرتەکە ئادێڵی وەک نمایشکاری سەرەکی دەبێت.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٥. (ھاوەڵناو) هەواڵێکی بە تایبەت گرنگ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The story was headline news for two weeks.""",
                      kurdishText:
                          """چیرۆکەکە هەواڵی سەرەکی بوو بۆ دوو هەفتە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/pFmtmO2cnlg?t=';
const double _startSecondsend = 00000000000000000000000000045;
const String _videoIdone = 'https://youtu.be/qg2nGY1aqlg?t=';
const double _startSecondsone = 0000000000000000000000000001104;
const String _videoIdtwo = 'https://youtu.be/VYJtb2YXae8?t=';
const double _startSecondstwo = 000000000000000000000000000412;
const String _videoIdthree = 'https://youtu.be/Oz9zw7-_vhM?t=';
const double _startSecondsthree = 000000000000000000000000000713;
const String _videoIdfour = 'https://youtu.be/_plgHxLyCt4?t=';
const double _startSecondsfour = 000000000000000000000000000159;
const String _videoIdfive = 'https://youtu.be/L87HuKmGwVQ?t=';
