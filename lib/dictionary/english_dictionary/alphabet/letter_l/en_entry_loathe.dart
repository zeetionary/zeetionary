...
class EnglishEntryloathe extends StatefulWidget {
  const EnglishEntryloathe({super.key});

  @override
  State<EnglishEntryloathe> createState() => _EnglishEntryloatheState();
}

class _EnglishEntryloatheState extends State<EnglishEntryloathe> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: loathe (Derived forms: loathes, loathed, loathing)
1. Find repugnant (- abhor, abominate, execrate)
"I loathe that man";
""",
  );

  final String keyword = "loathe";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They loathe each other.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I loathe modern art.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/Jmi5trYwggM?t=370';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/JgQVj4iMm8Y?t=120';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/ewLpXw6uN28?t=193';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/Ll6-eGDpimU?t=1421';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/CU8qwXYH83c?t=2';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/rHyIOIstYRA?t=12';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """loathe""",
                      // alsoEnglishWord: "also: loathe",
                      britshText: """IpaUK: /ləʊð/""",
                      americanText: """IpaUS: /ləʊð/""",
...
کوردی: 
"""),
// With short examples define "loathe", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) هەبوونی ڕقێکی زۆر بۆ کەسێک/شتێک"""),
                    const AlsoEnglishckb(word: "ھەروەھا: detest"),
                    SentencesRow(
                      englishText: """They loathe each other.""",
                      kurdishText: """ڕقی زۆریان لە یەکدییە.""",
                    ...
                    SentencesRow(
                      englishText: """I loathe modern art.""",
                      kurdishText: """ڕقم لە هونەری سەردەمە.""",
