...
class EnglishEntryadvisable extends StatelessWidget {
  EnglishEntryadvisable({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ədˈvaɪzəbl/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'bDcfrpbNorw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'lF2sKFnuALw';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'o3gfdG2gMGk';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'ydfyM48MtsY';
