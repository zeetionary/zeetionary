...
class EnglishEntryhyperactive extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hyperactive""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 204;
    const String videoIdone = 'mY3SEMTROas';
    const double startSecondsone = 1219;
    const String videoIdtwo = 'P6z_WJgajSg';
    const double startSecondstwo = 310;
    const String videoIdthree = 'wqMMEGW_Uqs';
    const double startSecondsthree = 314;
    const String videoIdfour = 'nJR8Nfi8wg8';
    const double startSecondsfour = 53;
    const String videoIdfive = 'gn5FF2pxL_M';
    const double startSecondsfive = 2889;
