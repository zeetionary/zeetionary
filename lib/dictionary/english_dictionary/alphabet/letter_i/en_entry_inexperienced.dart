...
class EnglishEntryinexperienced extends StatefulWidget {
  const EnglishEntryinexperienced({super.key});

  @override
  State<EnglishEntryinexperienced> createState() => _EnglishEntryinexperiencedState();
}

class _EnglishEntryinexperiencedState extends State<EnglishEntryinexperienced> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryinexperienced inexperienced
WORD_WEB inexperienced inexperienced inexperienced
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "inexperienced";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inexperienced""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inexperienced""",
                      // alsoEnglishWord: "also: inexperienced",
...
کوردی: 
"""),
// With short examples define "inexperienced", please follow LX instructions
