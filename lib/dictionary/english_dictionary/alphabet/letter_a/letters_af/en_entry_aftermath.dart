...
// replace these: replace EnglishEntryaftermath - replace speakAftermath - replace aftermath - /ˈɑːftərmæθ/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryaftermath extends StatelessWidget {
  EnglishEntryaftermath({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAftermath(String languageCode) async {
    // DOPSUM: CHANGE speakAftermath
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("aftermath"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAfterm92483(String languageCode) async {
    ...
    await flutterTts.speak(
        "The president visited the region in the immediate aftermath of the disaster."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "aftermath", // DOPSUM: CHANGE WORD ENTRY - Find /ˈɑːftəmæθ/,  /ˈɑːftəmɑːθ/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈɑːftəmæθ/,  /ˈɑːftəmɑːθ/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˈɑːftərmæθ/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'qjubq284yVk';
