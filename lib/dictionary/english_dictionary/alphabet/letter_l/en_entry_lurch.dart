...
class EnglishEntrylurch extends StatefulWidget {
  const EnglishEntrylurch({super.key});

  @override
  State<EnglishEntrylurch> createState() => _EnglishEntrylurchState();
}

class _EnglishEntrylurchState extends State<EnglishEntrylurch> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylurch lurch
WORD_WEB lurch lurch lurch
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lurch";
...
کوردی: 
"""),
// With short examples define "lurch", please follow LX instructions
