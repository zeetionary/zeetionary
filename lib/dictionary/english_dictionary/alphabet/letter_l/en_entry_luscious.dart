...
class EnglishEntryluscious extends StatefulWidget {
  const EnglishEntryluscious({super.key});

  @override
  State<EnglishEntryluscious> createState() => _EnglishEntrylusciousState();
}

class _EnglishEntrylusciousState extends State<EnglishEntryluscious> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryluscious luscious
WORD_WEB luscious luscious luscious
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "luscious";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""luscious""");
  }
...
کوردی: 
"""),
// With short examples define "luscious", please follow LX instructions
