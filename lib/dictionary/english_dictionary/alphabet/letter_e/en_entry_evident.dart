...
class EnglishEntryevident extends StatefulWidget {
  const EnglishEntryevident({super.key});

  @override
  State<EnglishEntryevident> createState() => _EnglishEntryevidentState();
}

class _EnglishEntryevidentState extends State<EnglishEntryevident> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evident""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evident""",
                      // alsoEnglishWord: "also: evident",
                      britshText: """IpaUK: /ˈevɪdənt/""",
                      americanText: """IpaUS: /ˈevɪdənt/""",
...
کوردی: ڕوون، ئاشکرا، دیار، پەیدا، خۆیا، بەرچاو
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) ئاشکرا"""),
          SentencesRow(
            englishText:
                """It has now become evident to us that a mistake has been made.""",
            kurdishText: """ئەوە ئێستا ئاشکرا بوو بۆمان کە ھەڵەیەک کردرا.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ئەوە ئاشکرا بوو بۆم کە ئەرکەکە شکست دەھێنیت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: evident 
1. Clearly revealed to the mind or the senses or judgment (= apparent, manifest, palpable, patent, plain, unmistakable, unmistakeable)
"evident hostility";
 
2. Capable of being seen or noticed (= discernible, observable)
