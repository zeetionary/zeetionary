...
class EnglishEntryholdall extends StatefulWidget {
  const EnglishEntryholdall({super.key});

  @override
  State<EnglishEntryholdall> createState() => _EnglishEntryholdallState();
}

class _EnglishEntryholdallState extends State<EnglishEntryholdall> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: holdall (Derived forms: holdalls)
1. Usage: Brit (N. Amer: carryall) (- carryall [N. Amer], tote, tote bag)
A capacious bag or basket
""",
  );

  final String keyword = "holdall";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""holdall""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She unzipped the holdall and took out a book.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/btljR4Wzydg?t=';
    const double startSecondsend = 000000000000000000000000000471;
    const String videoIdone = 'https://youtu.be/qwRl-2_pHSA?t=';
    const double startSecondsone = 0000000000000000000000000002982;
    const String videoIdtwo = 'https://youtu.be/7HU6HYOyjiw?t=';
    const double startSecondstwo = 000000000000000000000000000305;
    const String videoIdthree = 'https://youtu.be/GAjoOo18hs8?t=';
    const double startSecondsthree = 000000000000000000000000000408;
    const String videoIdfour = 'https://youtu.be/x7JuYrrJmjk?t=';
    const double startSecondsfour = 0000000000000000000000000002109;
    const String videoIdfive = 'https://youtu.be/8IZSlW8ULL8?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """holdall""",
                      // alsoEnglishWord: "also: holdall",
                      britshText: """IpaUK: /ˈhəʊldɔːl/""",
                      americanText: """IpaUS: /ˈhəʊldɔːl/""",
...
// With short examples define "holdall", please follow LX instructions
                    ...
                    const AlsoEnglishckb(word: "ھەروەھا: duffel bag"),
                    SentencesRow(
                      englishText:
                          """She unzipped the holdall and took out a book.""",
                      kurdishText:
                          """زنجیری جانتاکەی کردەوە و کتێبێکی دەرهێنا.""",
