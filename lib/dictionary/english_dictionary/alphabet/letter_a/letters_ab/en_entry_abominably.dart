...
class EnglishEntryabominably extends StatefulWidget {
  ...
  @override
  State<EnglishEntryabominably> createState() => _EnglishEntryabominablyState();
}
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  ...
  final String _videoId = '3kfGIz3u0RA';
...
class _YoutubeEmbeddedthreeState extends State<YoutubeEmbeddedthree> {
  late YoutubePlayerController _controller;
  final String _videoId = 'kEMJRjEdNzM';
  final double _startSeconds = 3756;
...
class _YoutubeEmbeddedfourState extends State<YoutubeEmbeddedfour> {
  late YoutubePlayerController _controller;
  final String _videoId = 'WNHr7VHlzT4';
...
class _YoutubeEmbeddedfiveState extends State<YoutubeEmbeddedfive> {
  late YoutubePlayerController _controller;
  final String _videoId = 'jKevzVKCFCg';
...
class _YoutubeEmbeddedendState extends State<YoutubeEmbeddedend> {
  late YoutubePlayerController _controller;
  final String _videoId = 'BNYh4p6tNr8';
...
// speakabominablys111111111111111111111111111111111
