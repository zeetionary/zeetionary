...
class EnglishEntryimpossible extends StatefulWidget {
  const EnglishEntryimpossible({super.key});

  @override
  State<EnglishEntryimpossible> createState() => _EnglishEntryimpossibleState();
}

class _EnglishEntryimpossibleState extends State<EnglishEntryimpossible> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impossible""");
  }
...
// With short examples define "impossible", please follow LX instructions
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) زۆر سەخت بۆ مامەڵە لەگەڵ کردن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕاستگۆ بم، هەندێک جار زۆر سەختی بۆ مامەڵە لەگەڵ کردن.""",
