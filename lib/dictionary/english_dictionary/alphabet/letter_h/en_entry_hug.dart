...
class EnglishEntryhug extends StatefulWidget {
  const EnglishEntryhug({super.key});

  @override
  State<EnglishEntryhug> createState() => _EnglishEntryhugState();
}

class _EnglishEntryhugState extends State<EnglishEntryhug> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: hug (Derived forms: hugged, hugs, hugging)
1. Hold (someone) tightly in your arms, usually with fondness (- embrace, bosom, squeeze)
"Hug me, please"; "He hugged her close to him";
 
2. Fit closely or tightly
"The dress hugged her hips"
 
3. Stay close to
"the road hugged the shore"

- Noun: hug (Derived forms: hugs)
1. A tight or amorous embrace (- clinch, squeeze)
"come here and give me a big hug";
""",
  );

  final String keyword = "hug";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They hugged each other.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She hugged him tightly.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He hugged Anna to him.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They put their arms around each other and hugged.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She gave him a big hug and he hugged her back.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She sat in the chair, hugging her knees.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The track hugs the coast for a mile.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She gave her mother a big hug.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He stopped to receive hugs and kisses from the fans.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It was always nice to get a hug from Evan.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Oq61TxejZ5g?t=';
    const double startSecondsend = 000000000000000000000000000143;
    const String videoIdone = 'https://youtu.be/hTqtGJwsJVE?t=';
    const double startSecondsone = 0000000000000000000000000002204;
    const String videoIdtwo = 'https://youtu.be/CvjoXdC-WkM?t=';
    const double startSecondstwo = 000000000000000000000000000431;
    const String videoIdthree = 'https://youtu.be/aKlLgwyqsqY?t=';
    const double startSecondsthree = 00000000000000000000000000073;
    const String videoIdfour = 'https://youtu.be/4RKOBJMpjeE?t=';
    const double startSecondsfour = 00000000000000000000000000021;
    const String videoIdfive = 'https://youtu.be/H3fUn4le238?t=';
    const double startSecondsfive = 000000000000000000000000000212;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hug""",
                      // alsoEnglishWord: "also: hug",
                      britshText: """IpaUK: /hʌɡ/""",
                      americanText: """IpaUS: /hʌɡ/""",
...
// With short examples define "hug", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """They hugged each other.""",
                      kurdishText: """یەکدییان لەباوەش گرت.""",
                    ...
                    SentencesRow(
                      englishText: """She hugged him tightly.""",
                      kurdishText: """بە توندی لە باوەشی گرت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He hugged Anna to him.""",
                      kurdishText: """ئانای لە باوەش گرت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەستیان لێک ئاڵاند و یەکدیان لە باوەش گرت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """باوەشێکی گەورەی پێیدا کرد و ئەویش لە باوەشی گرتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لەسەر کورسییەکە دانیشت بوو و دەستی لە دەوری ئەژنۆی بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕێگاکە بۆ یەک میل لە نزیک کەناراوەکەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وەستا لەوەی باوەش و ماچ لە هاواداران وەربگرێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەمیشە خۆش بوو باوەشێک لە ئێڤن وەربگریت.""",
