                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "annotate"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈænəteɪt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈænəteɪt/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'mI3yiPA6npA';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'lPqCrq6MWts';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'Z_xvDWu5bIg';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'b9sRdWBmamQ';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'bUN9dlL9lJE';
