...
class EnglishEntryactivate extends StatefulWidget {
  const EnglishEntryactivate({super.key});

  @override
  State<EnglishEntryactivate> createState() => _EnglishEntryactivateState();
}

class _EnglishEntryactivateState extends State<EnglishEntryactivate> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """activate""",
                      // alsoEnglishWord: "also: activate",
                      britshText: """IpaUK: /ˈæktɪveɪt/""",
                      americanText: """IpaUS: /ˈæktɪveɪt/""",
