...
class EnglishEntryfelony extends StatefulWidget {
  const EnglishEntryfelony({super.key});

  @override
  State<EnglishEntryfelony> createState() => _EnglishEntryfelonyState();
}

class _EnglishEntryfelonyState extends State<EnglishEntryfelony> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was charged with felony assault.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was convicted of a felony.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Robbery is a felony.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """felony""",
                      // alsoEnglishWord: "also: felony",
                      britshText: """IpaUK: /ˈfeləni/""",
                      americanText: """IpaUS: /ˈfeləni/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText: """He was convicted of a felony.""",
                      kurdishText: """بە تاوانێک تاوانبار کرا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Robbery is a felony.""",
                      kurdishText: """دزیکردن تاوانی سەختە.""",
...
const String _videoIdend = 'https://youtu.be/BztMgcNgobk?t=';
const double _startSecondsend = 0000000000000000000000000001813;
const String _videoIdone = 'https://youtu.be/vstnLLViSgM?t=';
const double _startSecondsone = 000000000000000000000000000633;
const String _videoIdtwo = 'https://youtu.be/k1aGKIKWcyg?t=';
const double _startSecondstwo = 000000000000000000000000000218;
const String _videoIdthree = 'https://youtu.be/tKZ2ILu_EMc?t=';
const double _startSecondsthree = 0000000000000000000000000001060;
const String _videoIdfour = 'https://youtu.be/daMJS6dk80o?t=';
const double _startSecondsfour = 000000000000000000000000000443;
const String _videoIdfive = 'https://youtu.be/WA4a8ouaars?t=';
