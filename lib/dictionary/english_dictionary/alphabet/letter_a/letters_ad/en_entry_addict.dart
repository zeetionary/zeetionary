...
// replace these: replace EnglishEntryadamsaddict - replace speakAddict - replace addict - /ˈædɪkt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadamsaddict extends StatelessWidget {
  EnglishEntryadamsaddict({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAddict(String languageCode) async {
    // DOPSUM: CHANGE speakAddict
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("addict"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAdd2354(String languageCode) async {
    ...
    await flutterTts.speak(
        "Many young boys become computer addicts."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAddi2541(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("He used to be a drug addict for years."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈædɪkt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'r8E1Hq5tktg';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'BvBQVvuP-BY';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'nBnip0Vjn5s';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'fbWNvNQ3mbg';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'Ab5niZNeE1k';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'I0iVAkyjrm8';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'jX04_ON3_2M';
