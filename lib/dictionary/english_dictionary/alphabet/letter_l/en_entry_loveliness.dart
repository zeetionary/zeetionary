...
class EnglishEntryloveliness extends StatefulWidget {
  const EnglishEntryloveliness({super.key});

  @override
  State<EnglishEntryloveliness> createState() => _EnglishEntrylovelinessState();
}

class _EnglishEntrylovelinessState extends State<EnglishEntryloveliness> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryloveliness loveliness
WORD_WEB loveliness loveliness loveliness
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "loveliness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""loveliness""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """loveliness""",
                      // alsoEnglishWord: "also: loveliness",
...
کوردی: 
"""),
// With short examples define "loveliness", please follow LX instructions
