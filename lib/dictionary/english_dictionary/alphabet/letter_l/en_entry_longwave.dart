...
class EnglishEntrylongwave extends StatefulWidget {
  const EnglishEntrylongwave({super.key});

  @override
  State<EnglishEntrylongwave> createState() => _EnglishEntrylongwaveState();
}

class _EnglishEntrylongwaveState extends State<EnglishEntrylongwave> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""long wave""");
  }
