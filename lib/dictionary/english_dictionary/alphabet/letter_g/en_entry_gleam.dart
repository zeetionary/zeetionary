...
class EnglishEntrygleam extends StatefulWidget {
  const EnglishEntrygleam({super.key});

  @override
  State<EnglishEntrygleam> createState() => _EnglishEntrygleamState();
}

class _EnglishEntrygleamState extends State<EnglishEntrygleam> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her eyes gleamed in the dark.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The moonlight gleamed on the water.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The house was gleaming with fresh white paint.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His eyes gleamed with amusement.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We could see the gleam of moonlight on the water.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""A few gleams of sunshine lit up the gloomy afternoon.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The gleam in his eye made her uncomfortable.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gleam""",
                      // alsoEnglishWord: "also: gleam",
                      britshText: """IpaUK: /ɡliːm/""",
                      americanText: """IpaUS: /ɡliːm/""",
...
// With short examples define "gleam", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Her eyes gleamed in the dark.""",
                      kurdishText: """چاوەکانی لە تاریکییەکەدا دەدرەوشانەوە.""",
                    ...
                    SentencesRow(
                      englishText: """The moonlight gleamed on the water.""",
                      kurdishText: """تریفەی مانگ لەسەر ئاوەکە دەدرەوشایەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خانووەکە بە بۆیەی تازەی سپییەوە دەدرەوشایەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Her teeth gleamed white against the tanned skin of her face.""",
                      kurdishText:
                          """ددانە سپییەکانی لە بەرانبەر پێستە ڕەشهەڵگەڕاوەکەی ڕووخساریدا دەدرەوشانەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) ئەوەی کە کەسێک هەستێک پیشان بدات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """His eyes gleamed with amusement.""",
                      kurdishText: """چاوەکانی لە دڵخۆشیدا دەگەشانەوە.""",
                      englishNote: """Also: Amusement gleamed in his eyes.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەمانتوانی درەوشانەوەی تریفەی مانگ ببینین لەسەر ئاوەکە .""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چەند کزەڕووناکییەکی خۆر دوانیوەڕۆ تاریکەکەی ڕووناک کردەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تۆزقاڵێکی کەم لە هیوا لە چاوەکانیدا بوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٦. (ناو) دەربڕینی هەست و سۆزێکی دیاریکراو لە چاوی کەسێکدا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The gleam in his eye made her uncomfortable (= as if he was planning something secret or unpleasant).""",
                      kurdishText: """دەربڕینی چاوەکانی نائاسوودەی دەکرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/5zvnFM2BXqY?t=';
const double _startSecondsend = 000000000000000000000000000391;
const String _videoIdone = 'https://youtu.be/kawym8ZwhwA?t=';
const double _startSecondsone = 000000000000000000000000000109;
const String _videoIdtwo = 'https://youtu.be/qW_ThmMnZI0?t=';
const double _startSecondstwo = 000000000000000000000000000104;
const String _videoIdthree = 'https://youtu.be/eXaIpTj3vOs?t=';
const double _startSecondsthree = 0000000000000000000000000001311;
const String _videoIdfour = 'https://youtu.be/ipeoe_6J2ys';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/Um8tDEVYwJg?t=';
