...
// replace these: replace EnglishEntryadvertising - replace speakAdvertising - replace advertising - /ˈædvərtaɪzɪŋ/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadvertising extends StatelessWidget {
  EnglishEntryadvertising({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdvertising(String languageCode) async {
    // DOPSUM: CHANGE speakAdvertising
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈædvətaɪzɪŋ/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'cwf2c7ByOas';
