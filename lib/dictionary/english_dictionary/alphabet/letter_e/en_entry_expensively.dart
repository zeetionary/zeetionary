...
class EnglishEntryexpensively extends StatefulWidget {
  const EnglishEntryexpensively({super.key});

  @override
  State<EnglishEntryexpensively> createState() =>
      _EnglishEntryexpensivelyState();
}

class _EnglishEntryexpensivelyState extends State<EnglishEntryexpensively> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""expensively""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """expensively""",
                      // alsoEnglishWord: "also: expensively",
                      britshText: """IpaUK: /ɪkˈspensɪvli/""",
                      americanText: """IpaUS: /ɪkˈspensɪvli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "expensively";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Sarah is always expensively dressed.""");
  }
...
// With short examples define "expensively", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: پڕخەرجانە، زۆرتێچووانە
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵکار) بەشێوەیەک کە پارەی زۆری تێدەچێت"""),
          SentencesRow(
            englishText:
                """There are other restaurants where you can eat less expensively.""",
            kurdishText:
                """چێشتخانە هەیە کە دەتوانیت لێی نان بخۆیت بە خەرجی زۆر کەمتر گران‌بەها.""",
          ...
          SentencesRow(
            ...
            kurdishText: """سارا هەمیشە جلی گران‌بەهایانە جل لەبەر دەکات.""",
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/Zr2bmYV6I-4?t=';
const double _startSecondsend = 000000000000000000000000000000; // 672;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/Uh4QGey2zTk?t=';
const double _startSecondsone = 00000000000000000000000000000; // 160;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/JSg6eOmgvW8?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1968;
const String _videoIdthree = 'VIDEOhttps://youtu.be/q1n2DR6H7mk?t=';
const double _startSecondsthree = 000000000000000000000000000; // 385;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/yZDtxWVG7Tg?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 607;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/mIGzHXmcyg0?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 603;
