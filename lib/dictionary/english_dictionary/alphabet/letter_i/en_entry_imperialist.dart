...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 232;
    const String videoIdone = 'w0QRliFvOC0';
    const double startSecondsone = 623;
    const String videoIdtwo = 'Gfj5f0GVLZ0';
    const double startSecondstwo = 0;
    const String videoIdthree = 'En8Tz2RzubE';
    const double startSecondsthree = 317;
    const String videoIdfour = 'Kxio4_ISHyg';
    const double startSecondsfour = 15;
    const String videoIdfive = 'lswKi3SLsy8';
