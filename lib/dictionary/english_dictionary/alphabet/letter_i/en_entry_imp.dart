...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '_spuxXnul0U';
    const double startSecondsend = 527;
    const String videoIdone = 'tLD-OUkYtk4';
    const double startSecondsone = 108;
    const String videoIdtwo = 'D-2799Y07Zc';
    const double startSecondstwo = 561;
    const String videoIdthree = 'Ym4mYSgMzh8';
    const double startSecondsthree = 919;
    const String videoIdfour = 'ujEfyjoS1T4';
    const double startSecondsfour = 565;
    const String videoIdfive = 'VzFf_0rvKgI';
    const double startSecondsfive = 1610;
