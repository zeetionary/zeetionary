...
class EnglishEntrylistener extends StatefulWidget {
  const EnglishEntrylistener({super.key});

  @override
  State<EnglishEntrylistener> createState() => _EnglishEntrylistenerState();
}

class _EnglishEntrylistenerState extends State<EnglishEntrylistener> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: listener (Derived forms: listeners)
1. Someone who listens attentively (- hearer, auditor, attender)
""",
  );

  final String keyword = "listener";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""listener""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We've received a lot of complaints about the changes from listeners to the programme.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""An attentive listener catches all the key points in a conversation.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/O15kBAODBo4?t=101';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/FftKFR2yzF4?t=74';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/j-zCKl_eda4?t=10';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/nH89FZBr7kU?t=10';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/B1WG5mK06fA?t=20';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/HRTCrjp1ScY?t=922';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """listener""",
                      // alsoEnglishWord: "also: listener",
                      britshText: """IpaUK: /ˈlɪsənə(r)/""",
                      americanText: """IpaUS: /ˈlɪsənər/""",
...
کوردی: بیسەر، گوێگر، گوێدێر، گۆهدار
"""),
// With short examples define "listener", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) کەسێک کە گوێ دەگرێت"""),
                    SentencesRow(
                      englishText: """We've received a lot of complaints about the changes from listeners to the programme.""",
                      kurdishText: """ژمارەیەک زۆر ناڕەزایی لە گوێگرانەوە پێگەشتووە سەبارەت بە گۆڕانکارییەکان لە پڕۆگرامەکەدا.""",
                    ...
                    SentencesRow(
                      englishText: """An attentive listener catches all the key points in a conversation.""",
                      kurdishText: """گوێگرێکی بەپەرۆش هەموو خاڵە گرنگەکان لە گفتووگۆدا وەردەگرێت.""",
