...
class EnglishEntryinsides extends StatefulWidget {
  const EnglishEntryinsides({super.key});

  @override
  State<EnglishEntryinsides> createState() => _EnglishEntryinsidesState();
}

class _EnglishEntryinsidesState extends State<EnglishEntryinsides> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryinsides insides
WORD_WEB insides insides insides
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "insides";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insides""");
  }
...
کوردی: 
"""),
// With short examples define "insides", please follow LX instructions
