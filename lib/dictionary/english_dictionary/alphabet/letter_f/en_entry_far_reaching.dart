...
class EnglishEntryfarreaching extends StatefulWidget {
  const EnglishEntryfarreaching({super.key});

  @override
  State<EnglishEntryfarreaching> createState() =>
      _EnglishEntryfarreachingState();
}

class _EnglishEntryfarreachingState extends State<EnglishEntryfarreaching> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""far-reaching""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """far-reaching""",
                      // alsoEnglishWord: "also: far-reaching",
                      britshText: """IpaUK: /ˌfɑː ˈriːtʃɪŋ/""",
                      americanText: """IpaUS: /ˌfɑːr ˈriːtʃɪŋ/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "far-reaching";
...
// With short examples define "far-reaching", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: پان وبەربڵاو، بەرفراوان
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە ئەگەری هەیە کاریگەری زۆر بێت یان لە زۆر لایەنەوە کاریگەری هەبێت"""),
          SentencesRow(
            englishText:
                """The changes have far-reaching implications for the food industry.""",
            kurdishText:
...
1. Having many important consequences or implications
""",
  );
...
const String _videoIdend = 'https://youtu.be/2zWf2sSDmF0?t=';
const double _startSecondsend = 00000000000000000000000000078;
const String _videoIdone = 'https://youtu.be/u6PNjgn1ocM?t=';
const double _startSecondsone = 00000000000000000000000000028;
const String _videoIdtwo = 'https://youtu.be/mS9CFBlLOcg?t=';
const double _startSecondstwo = 000000000000000000000000000799;
const String _videoIdthree = 'https://youtu.be/P4l9Y5OHqpk?t=';
const double _startSecondsthree = 000000000000000000000000000900;
const String _videoIdfour = 'https://youtu.be/uMlcnmS46SA?t=';
const double _startSecondsfour = 000000000000000000000000000532;
const String _videoIdfive = 'https://youtu.be/8MELKXZqMQo?t=';
const double _startSecondsfive = 000000000000000000000000000296;
