...
class EnglishEntryabsorption extends StatefulWidget {
  const EnglishEntryabsorption({super.key});

  @override
  State<EnglishEntryabsorption> createState() => _EnglishEntryabsorptionState();
}

class _EnglishEntryabsorptionState extends State<EnglishEntryabsorption> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "absorption";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """absorption""",
                      // alsoEnglishWord: "also: absorption",
                      britshText: """IpaUK: /əbˈzɔːpʃn/""",
                      americanText: """IpaUS: /əbˈzɔːrpʃn/""",
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = '72p58Iy6u7M';
