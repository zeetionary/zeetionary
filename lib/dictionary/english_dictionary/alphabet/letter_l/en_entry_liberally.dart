...
class EnglishEntryliberally extends StatefulWidget {
  const EnglishEntryliberally({super.key});

  @override
  State<EnglishEntryliberally> createState() => _EnglishEntryliberallyState();
}

class _EnglishEntryliberallyState extends State<EnglishEntryliberally> {
  @override
  void initState() {
    super.initState();
...
2. In a generous manner (- munificently, generously)
"he gave liberally to several charities";
""",
  );

  final String keyword = "liberally";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""liberally""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Apply the cream liberally.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The word ‘original’ is liberally interpreted in copyright law.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was a highly cultivated, liberally educated woman.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was a modern, liberally inclined father.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I used to think more liberally.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/rPdln-PUZuE?t=127';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/hQT7PN4Tzsg?t=49';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/D_Y18GEjfNY?t=136';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/8UkNOQDTb7c?t=40';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/NUcP7pNTq9k?t=125';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/hzAgFNh4vRY?t=35';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """liberally""",
                      // alsoEnglishWord: "also: liberally",
                      britshText: """IpaUK: /ˈlɪbərəli/""",
                      americanText: """IpaUS: /ˈlɪbərəli/""",
...
کوردی: 
"""),
// With short examples define "liberally", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵکار) بە ئاستێکی زۆر"""),
                    const AlsoEnglishckb(word: "ھەروەھا: generously, lavishly"),
                    SentencesRow(
                      englishText: """Apply the cream liberally.""",
                      kurdishText: """دەسکراوانە کرێمەکە لێبدە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵکار) بە شێوەیەک کە بە تەواوی درووست نییە"""),
                    const AlsoEnglishckb(word: "ھەروەھا:  freely"),
                    SentencesRow(
                      englishText: """The word ‘original’ is liberally interpreted in copyright law.""",
                      kurdishText: """وشەی ‘original’ بەشێوەیەکی نادرووست لە یاسای لەبەرگرتنەوەدا لێکدەدرێتەوە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ھاوەڵکار) بە شێویەک کە زانیاریی گشتی و ئەزموونی کەسێک زیاد دەکات نەک شارەزاییەکی دیاریکراو"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She was a highly cultivated, liberally educated woman.""",
                      kurdishText: """ژنێکی ڕۆشنبیر و بەشێوەیەکی گشتی خوێندەوار بوو.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (ھاوەڵکار) بە شێوەیەک کە ئامادە بیت ڕێز لە ڕەفتار، بۆچوون، هتدی خەڵکانی دیکە بگریت و لێیان تێ بگەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He was a modern, liberally inclined father.""",
                      kurdishText: """باوکێکی سەردەمییانە و بیرکراوە بوو.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (ھاوەڵکار) بە شێوەیەک کە پشتیوانیی ئازادیی کەسی و گۆڕانی سیاسی و کۆمەڵایەتی دەکات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I used to think more liberally.""",
                      kurdishText: """جاران زۆر ڕۆشنفکرانە بیرمدەکردەوە.""",
