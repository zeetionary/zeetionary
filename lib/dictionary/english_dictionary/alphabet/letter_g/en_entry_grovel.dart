...
class EnglishEntrygrovel extends StatefulWidget {
  const EnglishEntrygrovel({super.key});

  @override
  State<EnglishEntrygrovel> createState() => _EnglishEntrygrovelState();
}

class _EnglishEntrygrovelState extends State<EnglishEntrygrovel> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: grovel (Derived forms: grovelling, groveled, grovelled, grovels)
1. Show submission or fear (- fawn, crawl, cringe, cower)
"Artists are expected to grovel, aren't they?";
""",
  );

  final String keyword = "grovel";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He went grovelling to her for forgiveness.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I’ve made a terrible mistake. Now I have to go back and grovel for my job.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was grovelling around on the floor, looking for her glasses.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grovel""",
                      // alsoEnglishWord: "also: grovel",
                      britshText: """IpaUK: /ˈɡrɒvl/""",
                      americanText: """IpaUS: /ˈɡrɑːvl/""",
...
کوردی: 
"""),
// With short examples define "grovel", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) پیشاندانی ڕێزی زۆر بۆ کەسێک کە گرنگترە لە تۆ یان دەتوانێت شتێکت پێ بدات لە دەتەوێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: crawl"),
                    SentencesRow(
                      englishText: """He went grovelling to her for forgiveness.""",
                      kurdishText: """چوو بۆ لای لێی پاڕایەوە بۆ لێخۆشبوون.""",
                    ...
                    SentencesRow(
                      englishText: """I’ve made a terrible mistake. Now I have to go back and grovel for my job.""",
                      kurdishText: """هەڵەیەکی گەورەم کرد. ئێستا دەبێت بچم و بپاڕێمەوە بۆ کارەکەم.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) جووڵان بە زەویدا لەسەر دەست و قاچت، بە تایبەتی بۆ دۆزینەوەی شتێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She was grovelling around on the floor, looking for her glasses.""",
                      kurdishText: """لەسەر زەوییەکە گاگۆرەی بوو بۆ چاویلکەکانی دەگەڕا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/tCqwT2MqLxI?t=';
const double _startSecondsend = 000000000000000000000000000760;
const String _videoIdone = 'https://youtu.be/aNoH0RdN91k?t=';
const double _startSecondsone = 000000000000000000000000000235;
const String _videoIdtwo = 'https://youtu.be/n2xATB5vYLA?t=';
const double _startSecondstwo = 0000000000000000000000000001226;
const String _videoIdthree = 'https://youtu.be/1HDYtDDskxM?t=';
const double _startSecondsthree = 000000000000000000000000000303;
const String _videoIdfour = 'https://youtu.be/ae3DMlXcybg?t=';
const double _startSecondsfour = 000000000000000000000000000345;
const String _videoIdfive = 'https://youtu.be/3W1Oh4sHaNw?t=';
const double _startSecondsfive = 000000000000000000000000000637;
