...
class EnglishEntrycombustion extends StatelessWidget {
  // blank divider
  EnglishEntrycombustion({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcombustion(String languageCode) async {
    // DOPSUM: CHANGE speakcombustion
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "combustion"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /kəmˈbʌstʃən/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcombustion("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /kəmˈbʌstʃən/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcombustion("en-US"),
                            ),
                          ],
                        ),
                      ],
...
کوردی: سووتان، گڕگرتن، گرکێشان، گڕیان، ئاگرتێبەربوون
"""),
...
"the combustion of leaves was prohibited by a town ordinance";
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/wwD-7q6KIpg?t=',
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/jaUhmhl9BPo?t=',
    startSeconds: 112,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/CT7GkNu8PTQ?t=',
    startSeconds: 868,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/Bch5B23_pu0?t=',
    startSeconds: 70,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/tC2tcsJPhjc',
    // startSeconds: 222222222222222,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
