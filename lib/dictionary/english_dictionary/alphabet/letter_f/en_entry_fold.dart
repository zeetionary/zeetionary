...
کوردی: قەد، تا، (دا)نووشتاوی، گنج‌تێکەوتن، قەدکراوی، سەرگێڕ، هۆڵ، شەوگا، ئاخڵە،	دەستەی شوێنکەوتووان، کۆمەڵی بڕواداران
"""),
// With short examples define "fold", please follow LX instructions
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) چەماندنەوەی شتێک بۆ ئەوەی بچووکتر یان تەختتر ببێت و ئاسانتر هەڵبگیرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەختەی ئووتووکردنەکە قەد دەکرێت بۆ هەڵگرتنی ئاسان.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (کردار) داخران بەهۆی شکستەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """His business folded and his wife left him.""",
                      kurdishText:
                          """بازرگانییەکەی شکستی هێنا و ژنەکەی جێیهێشت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٦. (ناو) هێڵێک یان خاڵێک کە بە قەدکردن درووست دەبێت، یان کە پیشانی دەدات لە کوێدا شتێک قەد بکرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Why is the place I want to find always on the fold of the map?""",
                      kurdishText:
                          """بۆچی ئەو شوێنەی هەمیشە دەمەوێت بیدۆزمەوە هەمیشە لەسەر هێڵی قەدکراوی نەخشەکەیە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٧. (ناو) گرووپێک خەڵک کە هەمان بیرکردنەوەیان هەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He called on former Republican voters to return to the fold.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/dJOz8SYbN28?t=';
...
const double _startSecondsthree = 000000000000000000000000000800;
const String _videoIdfour = 'https://youtu.be/_a8u4949t_k?t=';
const double _startSecondsfour = 000000000000000000000000000526;
const String _videoIdfive = 'https://youtu.be/jxk259Eqnks?t=';
