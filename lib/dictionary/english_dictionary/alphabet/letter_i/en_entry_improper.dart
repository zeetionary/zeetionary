...
class EnglishEntryimproper extends StatefulWidget {
  const EnglishEntryimproper({super.key});

  @override
  State<EnglishEntryimproper> createState() => _EnglishEntryimproperState();
}

class _EnglishEntryimproperState extends State<EnglishEntryimproper> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: improper
1. Not conforming to legality, moral law, or social convention (- unconventional, unlawful)
"improper banking practices";
 
2. Not appropriate for a purpose or occasion (- wrong)
"said all the improper things";
 
3. Not suitable, right or appropriate
"slightly improper to dine alone with a married man"; "improper medication"; "improper attire for the golf course"
""",
  );

  final String keyword = "improper";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""improper""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He had been indulging in improper business practices.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was suspended for improper conduct.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It would be improper to comment at this stage.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/0sazcZ8wwZc?t=';
    const double startSecondsend = 000000000000000000000000000231;
    const String videoIdone = 'https://youtu.be/f8euUepDo5w?t=';
    const double startSecondsone = 0000000000000000000000000001082;
    const String videoIdtwo = 'https://youtu.be/W-ZuKp8P7gA?t=';
    const double startSecondstwo = 000000000000000000000000000307;
    const String videoIdthree = 'https://youtu.be/b8WnPAxVxRY?t=';
    const double startSecondsthree = 000000000000000000000000000150;
    const String videoIdfour = 'https://youtu.be/hA95iw4B2jg?t=';
    const double startSecondsfour = 000000000000000000000000000534;
    const String videoIdfive = 'https://youtu.be/FCZ06Sfr9Cg?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """improper""",
                      // alsoEnglishWord: "also: improper",
                      britshText: """IpaUK: /ɪmˈprɒpə(r)/""",
                      americanText: """IpaUS: /ɪmˈprɑːpər/""",
...
کوردی: نەگونجاو، بێجێ، نەشیاو، ناڕەوا، لێنەوەشاو، نالێوەشاو، نابەجێ، نالەبار، نادروست، جوان نییە، هەڵە، چەوت،	ناحەز، هەرزە، ناشیرین، دزێو
"""),
// With short examples define "improper", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) خراپ و لە ڕووی ئەخلاقییەوە خراپ"""),
                    SentencesRow(
                      englishText:
                          """He had been indulging in improper business practices.""",
                      kurdishText:
                          """لە ژمارەیەک کاری بازرگانی نەگونجاو تێوەگلاوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بۆ کاری نەگونجاو سڕکرا.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) کە درووست نییە بۆ دۆخەکە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: inappropriate"),
                    SentencesRow(
                      englishText:
                          """It would be improper to comment at this stage.""",
                      kurdishText:
                          """نەگونجاو دەبێت لەم قۆناغەدا لێدوان بدەیت.""",
