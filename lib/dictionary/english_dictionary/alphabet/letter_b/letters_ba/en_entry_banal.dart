...
// Define the word "banal" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace banal - replace EnglishEntrybanal

// replace speakBanal - /bəˈnɑːl/

enum TtsState { playing }

class EnglishEntrybanal extends StatelessWidget {
// blank divider
  EnglishEntrybanal({super.key});
// blank divider
  ...
  Future<void> speakBanals1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He knew how banal the question was as soon as he had asked it."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakBanals7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBanals77"); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "banal", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakBanal(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /bəˈnɑːl/, /ˈbeɪnl/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
                      ...
                      child: Column(
                        ...
                        children: [
                          const Text(
                            ...
                            """
کوردی: ئاسایی، ڕەمەکی، سەرپێیی، ناسەرنج‌ڕاکێش، هیچەکە، ناگرنگ، ئایەخ

١. (ھاوەڵناو) شتێکی ئاسایی کە هیچی سەرنجڕاکێشی تێدا نییە""",
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "دەیزانی پرسیارەکە چەندە هیچ بوو هەرکە پرسی.",
                                    textAlign: TextAlign
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "https://youtu.be/6UcQxHYda54?t=";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "https://youtu.be/ccTYpVUP4kA?t=";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "https://youtu.be/DtXC6Tu5p0M?t=";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "https://youtu.be/VPbiBE0dZQ8?t=";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "https://youtu.be/i8xelajthM0?t=";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "https://youtu.be/l8EcUIFL-fI?t=";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "https://youtu.be/cA8VoY3dUFU?t=";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "https://youtu.be/jlIBGl5-j_4?t=";
...
// end banal// TODO Implement this library.