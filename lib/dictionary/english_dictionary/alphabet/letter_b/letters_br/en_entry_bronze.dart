...
// blank divider
  ...
  Future<void> speakbronzes1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The figure was cast in bronze.");
  }
  ...
  Future<void> speakbronzes4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She got a bronze in the long jump.");
  }
  ...
  Future<void> speakbronzes6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbronzes66");
  }
  ...
  Future<void> speakbronzes7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbronzes77");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'AS_12ankZfg';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '0vOoXJDNNCw';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'EmalfB008xQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'iztEcBMFcjA';
  final double _startSeconds = 0;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '0AQivD_S-gk';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'nv3iOH_XYdo';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'iVqjKpTvpM8';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'XSVZB3zJ35I';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final double _startSeconds = 3531;
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'GehAc5VoaX4';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'STJApVnIaLM';
  final double _startSeconds = 10;
