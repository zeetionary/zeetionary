...
class EnglishEntryhotdesking extends StatefulWidget {
  const EnglishEntryhotdesking({super.key});

  @override
  State<EnglishEntryhotdesking> createState() => _EnglishEntryhotdeskingState();
}

class _EnglishEntryhotdeskingState extends State<EnglishEntryhotdesking> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hot-desking
1. Sharing desks or workstations between office workers (- hoteling [US])
"We're now working storing our data online to take advantage of hot-desking, online collaboration and teleworking";
""",
  );

  final String keyword = "hot-desking";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hot-desking""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/p_J3o8VU5rw?t=';
    const double startSecondsend = 000000000000000000000000000273;
    const String videoIdone = 'https://youtu.be/UK67Fg6_Sgc?t=';
    const double startSecondsone = 00000000000000000000000000078;
    const String videoIdtwo = 'https://youtu.be/30dOLcZ4_9U?t=';
    const double startSecondstwo = 000000000000000000000000000512;
    const String videoIdthree = 'https://youtu.be/c2vJ7cS3Sh8?t=';
    const double startSecondsthree = 000000000000000000000000000207;
    const String videoIdfour = 'https://youtu.be/Wns4QnGhV30?t=';
    const double startSecondsfour = 000000000000000000000000000177;
    const String videoIdfive = 'https://youtu.be/lXAyZtA4hd8?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hot-desking""",
                      // alsoEnglishWord: "also: hot-desking",
                      britshText: """IpaUK: /ˈhɒt deskɪŋ/""",
                      americanText: """IpaUS: /ˈhɑːt deskɪŋ/""",
...
کوردی: 
"""),
// With short examples define "hot-desking", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە لە ئۆفیسێک دێسک بدرێت بە کارمەند تەنها کە پێویستییەتی"""),
                    SentencesRow(
                      englishText:
                          """Hot-desking allows a company to have significantly smaller premises.""",
                      kurdishText:
                          """بە گەڕۆک کارکردن ڕێگە بە کۆمپانیاکان دەدات کە شوێنی کارکردنی زۆر بچووکتریان هەبێت.""",
