...
class EnglishEntrygravity extends StatefulWidget {
  const EnglishEntrygravity({super.key});

  @override
  State<EnglishEntrygravity> createState() => _EnglishEntrygravityState();
}

class _EnglishEntrygravityState extends State<EnglishEntrygravity> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gravity (Derived forms: gravities)
1. (physics) the force of attraction between all masses in the universe; especially the attraction of the earth's mass for bodies near its surface (- gravitation, gravitational attraction, gravitational force)
"the more remote the body the less the gravity";
 
2. A manner that is serious and solemn (- graveness, sobriety, soberness, somberness [US], sombreness [Brit, Cdn])
 
3. A solemn and dignified feeling (- solemnity, solemnness, solemness)
"the gravity of a funeral";
""",
  );

  final String keyword = "gravity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gravity""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Gravity pulls objects together.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The building leans so much that it seems to defy gravity.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I don't think you realise the gravity of the situation.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gravity""",
                      // alsoEnglishWord: "also: gravity",
                      britshText: """IpaUK: /ˈɡrævəti/""",
                      americanText: """IpaUS: /ˈɡrævəti/""",
...
// With short examples define "gravity", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هێزی کێشکردنی زەوی، یان ئەو هێزەی لە بۆشایی ئاسماندا شتەکان ڕادەکێشێت"""),
                    SentencesRow(
                      englishText: """Gravity pulls objects together.""",
                      kurdishText:
                          """هێزی کێشکردن شتەکان بۆ یەکدی ڕادەکێشێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بیناکە هێندە لار بووەتەوە کە وەها دیارە لە هێزی کێشکردن لا بدات.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The water flows from the tank by gravity to the houses below.""",
                      kurdishText:
                          """ئاوی تانکییەکە بە هێزی کێشکردن بۆ خانووەکانی خوارەوە دەچێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) گرنگیی زۆر کە نیگەرانی درووست دەکات"""),
                    const AlsoEnglishckb(word: "ھەروەھا: seriousness"),
                    SentencesRow(
                      englishText:
                          """I don't think you realise the gravity of the situation.""",
                      kurdishText: """پێم وانییە لە گرنگیی دۆخەکە تێگەشتبیت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Punishment varies according to the gravity of the offence.""",
                      kurdishText: """سزا دەگۆڕێت بەپیێ سەختی تاوان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """They were asked to behave with the gravity that was appropriate in a court of law.""",
                      kurdishText:
                          """داوایان لێکرا بە جدی ڕەفتار بکەن کە شیاو بێت بۆ دادگا.""",
...
const String _videoIdone = 'https://youtu.be/g-7ZWPCWv0U?t=';
const double _startSecondsone = 000000000000000000000000000209;
...
const double _startSecondsthree = 0000000000000000000000000001580;
const String _videoIdfour = 'https://youtu.be/m4riEU1_Bgo?t=';
const double _startSecondsfour = 000000000000000000000000000248;
const String _videoIdfive = 'https://youtu.be/0jltioeaEyY?t=';
