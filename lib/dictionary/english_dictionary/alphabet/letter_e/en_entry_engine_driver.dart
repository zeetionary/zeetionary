...
class EnglishEntryenginedriver extends StatefulWidget {
  const EnglishEntryenginedriver({super.key});

  @override
  State<EnglishEntryenginedriver> createState() =>
      _EnglishEntryenginedriverState();
}

class _EnglishEntryenginedriverState extends State<EnglishEntryenginedriver> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""engine driver""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """engine driver""",
                      // alsoEnglishWord: "also: engine driver",
                      britshText: """IpaUK: /ˈendʒɪn draɪvə(r)/""",
                      americanText: """IpaUS: /ˈendʒɪn draɪvər/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "engine driver";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The engine driver controls the train's speed.""");
  }
...
کوردی: شۆفیری لۆکۆمۆتیڤ، شەمەندەفەرەوان، شۆفیری شەمەندەفەر، لۆکۆمۆتیڤ‌وان
"""),
          const DefinitionKurdish(
              text: """١. (ناو) کەسێک کە کاری شۆفێری شەمەندەفەرە"""),
          const AlsoEnglishckb(word: "ھەروەھا: engineer لە ئەمریکا"),
          SentencesRow(
            englishText: """The engine driver controls the train's speed.""",
            kurdishText: """شەمەندەفەرەوانەکە کۆنترۆڵی خێرایی دەکات.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: engine driver (Derived forms: engine drivers)
1. The operator of a railway locomotive (= engineer, locomotive engineer, railroad engineer [N. Amer])
""",
  );
...
const String _videoIdend = 'https://youtu.be/gckQWaEYK_M?t=';
const double _startSecondsend = 14;
const String _videoIdone = 'https://youtu.be/urTjW_5ICHY?t=';
const double _startSecondsone = 430;
const String _videoIdtwo = 'https://youtu.be/gZFBLJCk7pU?t=';
const double _startSecondstwo = 887;
const String _videoIdthree = 'https://youtu.be/BdzXBwShBcU?t=';
const double _startSecondsthree = 24;
const String _videoIdfour = 'https://youtu.be/TKtjZiTcWKg?t=';
const double _startSecondsfour = 506;
const String _videoIdfive = 'https://youtu.be/1AWd-qACnUo?t=';
const double _startSecondsfive = 8;
const String _videoIdsix = 'https://youtu.be/_e3ntT54kpo?t=';
const double _startSecondssix = 21;
