...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/UQTtVrEnMNo?t=';
    const double startSecondsend = 00000000000000000000000000014;
    const String videoIdone = 'https://youtu.be/W7jYqsNFZ8c?t=';
    const double startSecondsone = 000000000000000000000000000261;
    const String videoIdtwo = 'https://youtu.be/YB6O7jS_VBM?t=';
    const double startSecondstwo = 000000000000000000000000000153;
    const String videoIdthree = 'https://youtu.be/bUia-EbqS7A?t=';
    const double startSecondsthree = 000000000000000000000000000477;
    const String videoIdfour = 'https://youtu.be/s3YTfhJmh1I?t=';
    const double startSecondsfour = 000000000000000000000000000218;
    const String videoIdfive = 'https://youtu.be/T-_HKFjxVl0?t=';
    const double startSecondsfive = 000000000000000000000000000639;
