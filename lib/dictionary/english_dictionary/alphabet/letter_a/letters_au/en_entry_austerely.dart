...
class EnglishEntryausterely extends StatelessWidget {
  ...
  Future<void> speakausterely(String languageCode) async {
    ...
    await flutterTts.speak("austerely");
  }
  ...
  Future<void> speakausterely506(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Her dress was simple and austerely elegant.");
  }
  ...
  Future<void> speakausterely509(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She lived austerely and in constant prayer.");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'eO3RNUAFtDE';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'b4FZ2f-keYI';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'G8uzfNXIRBA';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'gM-MIBxpXmg';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'aYDnem3MLfQ';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'fYfnpW9juf8';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'AKEsNRX9dO4';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'E82WkYc6y6I';
  final double _startSeconds = 3933;
