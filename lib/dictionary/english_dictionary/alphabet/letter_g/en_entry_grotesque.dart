...
class EnglishEntrygrotesque extends StatefulWidget {
  const EnglishEntrygrotesque({super.key});

  @override
  State<EnglishEntrygrotesque> createState() => _EnglishEntrygrotesqueState();
}

class _EnglishEntrygrotesqueState extends State<EnglishEntrygrotesque> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: grotesque (Derived forms: grotesquer, grotesquest)
1. Distorted and unnatural in shape or size; abnormal and hideous (- monstrous)
"tales of grotesque serpents eight fathoms long that churned the seas";
 
2. Ludicrously odd (- antic [archaic], fantastic, fantastical)
"a grotesque reflection in the mirror";

- Noun: grotesque (Derived forms: grotesques)
1. Art characterized by an incongruous mixture of parts of humans and animals interwoven with plants
""",
  );

  final String keyword = "grotesque";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grotesque""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The story was too grotesque to believe.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grotesque""",
                      // alsoEnglishWord: "also: grotesque",
                      britshText: """IpaUK: /ɡrəʊˈtesk/""",
                      americanText: """IpaUS: /ɡrəʊˈtesk/""",
...
// With short examples define "grotesque", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """چیرۆکەکە زۆر سەیر بوو بۆ باوەڕپێکردن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """By now she'd had so much cosmetic surgery that she looked quite grotesque.""",
                      kurdishText:
                          """تا ئەم کاتە هێندە نەشتەرگەری جوانکاری کردبوو کە وەک گاڵتەجاڕ دەردەکەوت.""",
...
const double _startSecondsone = 0000000000000000000000000002647;
const String _videoIdtwo = 'https://youtu.be/Muv7K0aXteA?t=';
const double _startSecondstwo = 000000000000000000000000000367;
const String _videoIdthree = 'https://youtu.be/lknCE7fn7k8?t=';
const double _startSecondsthree = 000000000000000000000000000693;
const String _videoIdfour = 'https://youtu.be/fY2CF-T05qY?t=';
const double _startSecondsfour = 000000000000000000000000000530;
const String _videoIdfive = 'https://youtu.be/mscDaDd1ipk?t=';
const double _startSecondsfive = 0000000000000000000000000001126;
