...
class EnglishEntryairstrip extends StatelessWidget {
  EnglishEntryairstrip({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAirstrip(String languageCode) async {
    // DOPSUM: CHANGE speakAirstrip
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("airstrip"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAirstrip7655(String languageCode) async {
    ...
    await flutterTts.speak(
        "We landed at a tiny airstrip in the middle of the jungle."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "airstrip", // DOPSUM: CHANGE WORD ENTRY - Find /ˈeəstrɪp/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAirstrip(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'En1O-ESR-vY';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'orRjAZ8XasM';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'nmTK-fdqe_M';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '1JX1oL8Wnms';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '_pqITTLzFIM';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'hAQJ9bNENyA';
