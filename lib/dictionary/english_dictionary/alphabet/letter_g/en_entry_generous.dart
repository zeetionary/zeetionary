...
class EnglishEntrygenerous extends StatefulWidget {
  const EnglishEntrygenerous({super.key});

  @override
  State<EnglishEntrygenerous> createState() => _EnglishEntrygenerousState();
}

class _EnglishEntrygenerousState extends State<EnglishEntrygenerous> {
  @override
  void initState() {
    super.initState();
...
3. More than is usual or necessary
"a generous portion"
""",
  );

  final String keyword = "generous";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""generous""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was generous to his friends and family.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She was generous in her praise for her co-stars.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They were very generous in giving help.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Thank you for your donation. It was very generous of you.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The car has a generous amount of space.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He wrote a very generous assessment of my work.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Her generous spirit shone through in everything she did.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """generous""",
                      // alsoEnglishWord: "also: generous",
                      britshText: """IpaUK: /ˈdʒenərəs/""",
                      americanText: """IpaUS: /ˈdʒenərəs/""",
...
// With short examples define "generous", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """زۆر بەخشەر بوون لە پێدانی یارمەتی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سوپاس بۆ بەخشینەکەت. زۆر لە بەخشندەیی خۆت بوو.""",
...
const double _startSecondsone = 296;
const String _videoIdtwo = 'ewLpXw6uN28?t=';
const double _startSecondstwo = 366;
const String _videoIdthree = 'XnbCSboujF4?t=';
const double _startSecondsthree = 230;
const String _videoIdfour = 'Rzd0mLf366I?t=';
const double _startSecondsfour = 97;
const String _videoIdfive = 'FSHITL5oedk?t=';
const double _startSecondsfive = 832;
