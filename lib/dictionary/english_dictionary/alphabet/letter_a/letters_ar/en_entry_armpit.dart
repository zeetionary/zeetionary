...
// replace EnglishEntryAdopsummm - replace speakArmpit

// replace armpit - /ˈɑːmpɪt/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarmpit extends StatelessWidget {
  // blank divider
  EnglishEntryarmpit({super.key});
  // blank divider
  ...
  Future<void> speakarmpit412(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("To my mind, a hairless armpit looks unnatural.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "armpit"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɑːmpɪt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrmpɪt/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '4AlDFFJ_PNw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'j7rs22KGXVE';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'rUFnFM2O4ys';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'bGUqT7Y8lJY';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'jLWRJwXqDFI';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '7x91lXCSPaY';
  final double _startSeconds = 1;
