...
class EnglishEntryfist extends StatefulWidget {
  const EnglishEntryfist({super.key});

  @override
  State<EnglishEntryfist> createState() => _EnglishEntryfistState();
}

class _EnglishEntryfistState extends State<EnglishEntryfist> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fist (Derived forms: fists)
1. A hand with the fingers clenched in the palm (as for hitting) (= clenched fist)

- Verb: fist (Derived forms: fisted, fists, fisting)
1. Hit with the fist
""",
  );

  final String keyword = "fist";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He punched me with his fist.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He got into a fist fight in the bar.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fist""",
                      // alsoEnglishWord: "also: fist",
                      britshText: """IpaUK: /fɪst/""",
                      americanText: """IpaUS: /fɪst/""",
...
// With short examples define "fist", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """He punched me with his fist.""",
                      kurdishText: """بۆکسێکی لێدام بە مستی.""",
                    ...
                    SentencesRow(
                      englishText: """He got into a fist fight in the bar.""",
                      kurdishText: """لە باڕەکە تووشی شەڕە مستێک بوو.""",
...
const double _startSecondsone = 0000000000000000000000000001143;
const String _videoIdtwo = 'https://youtu.be/P8m-KThvtxA?t=';
const double _startSecondstwo = 000000000000000000000000000133;
const String _videoIdthree = 'https://youtu.be/10FiSsim_a4?t=';
const double _startSecondsthree = 000000000000000000000000000384;
const String _videoIdfour = 'https://youtu.be/6C4ZV4TW86g?t=';
const double _startSecondsfour = 118;
const String _videoIdfive = 'https://youtu.be/Gv4Af83KFrE?t=';
const double _startSecondsfive = 0000000000000000000000000001135;
