...
class EnglishEntrygold extends StatefulWidget {
  const EnglishEntrygold({super.key});

  @override
  State<EnglishEntrygold> createState() => _EnglishEntrygoldState();
}

class _EnglishEntrygoldState extends State<EnglishEntrygold> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He always wore a gold chain.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He spent weeks panning for gold in the river.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She was absolutely dripping with gold.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The bank holds large reserves of gold.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The team look set to win Olympic gold.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He won three golds and a bronze.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His hair was a pale gold.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I love the reds and golds of autumn.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The company name was spelled out in gold letters.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The performers' faces were covered in gold paint.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gold""",
                      // alsoEnglishWord: "also: gold",
                      britshText: """IpaUK: /ɡəʊld/""",
                      americanText: """IpaUS: /ɡəʊld/""",
...
// With short examples define "gold", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەمیشە زنجیرێکی زێڕی دەبەست.""",
                    ...
                    SentencesRow(
                      englishText: """He spent weeks panning for gold in the river.""",
                      kurdishText: """چەندین هەفتەی بەسەر برد بە گەڕان بۆ زێڕ لە ڕووبارەکە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) پارە، خشڵ، هتد کە لە زێڕ درووستکراوە"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The bank holds large reserves of gold.""",
                      kurdishText: """بانکەکە یەدەگێکی زۆری زێڕی هەیە.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) مەدالیایەک کە لە زێڕ درووستکراوە و دەدرێت بە براوی پێشبڕکێیەک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The team look set to win Olympic gold.""",
                      kurdishText: """تیمەکە پێشبینی دەکرێت زێڕی ئۆڵمپیاد بباتەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He won three golds and a bronze.""",
                      kurdishText: """سێ زێڕ و یەک برۆنزی بردەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I love the reds and golds of autumn.""",
                      kurdishText: """حەزم لە سووری و زێڕیی پاییزە.""",
                      onPressedBritish: () => speaksentence8("en-GB"),
                      onPressedAmerican: () => speaksentence8("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (هاوەڵناو) زێڕی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The company name was spelled out in gold letters.""",
                      kurdishText: """ناوی کۆمپانیاکە بە پیتی زێڕی نووسرا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The performers' faces were covered in gold paint.""",
                      kurdishText: """ڕووخساری نمایشکارەکان بە بۆیەی زێڕی داپۆشرا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/GlcB2unJL1Q?t=';
const double _startSecondsend = 00000000000000000000000000031;
const String _videoIdone = 'https://youtu.be/I4ltDLUviSA?t=';
const double _startSecondsone = 000000000000000000000000000222;
const String _videoIdtwo = 'https://youtu.be/HDntl7yzzVI?t=';
const double _startSecondstwo = 000000000000000000000000000519;
const String _videoIdthree = 'https://youtu.be/rEdl2Uetpvo?t=';
const double _startSecondsthree = 000000000000000000000000000235;
const String _videoIdfour = 'https://youtu.be/G3JZ4uMu4YQ?t=';
const double _startSecondsfour = 00000000000000000000000000085;
const String _videoIdfive = 'https://youtu.be/gZDrXWsaZtk?t=';
const double _startSecondsfive = 00000000000000000000000000041;
