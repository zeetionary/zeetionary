...
// replace these: replace EnglishEntryairmarshal - replace speakAirmarshal - replace air marshal - /ˈeə mɑːʃl/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryairmarshal extends StatelessWidget {
  EnglishEntryairmarshal({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈeə mɑːʃl/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '_3Z3lmErOTo';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'vOH8eWO4H1Q';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'NUbVeDDKa0Y';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'ZBYC7QnHrQA';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'hn1B7EDsVkU';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'IlaW6MQIbpY';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'PP_5UuCxqCM';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'qNNNUeRJrlk';
