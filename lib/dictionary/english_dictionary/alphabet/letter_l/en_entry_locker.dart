...
class EnglishEntrylocker extends StatefulWidget {
  const EnglishEntrylocker({super.key});

  @override
  State<EnglishEntrylocker> createState() => _EnglishEntrylockerState();
}

class _EnglishEntrylockerState extends State<EnglishEntrylocker> {
  @override
  void initState() {
    super.initState();
