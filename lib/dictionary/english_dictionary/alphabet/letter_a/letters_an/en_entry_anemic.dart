...
// replace these: replace EnglishEntryanemic - replace speakanemic - replace anemic - /əˈniːmɪk/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryanemic extends StatelessWidget {
  EnglishEntryanemic({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakanemic(String languageCode) async {
    // DOPSUM: CHANGE speakanemic
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("anemic"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakanemic55580(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She looks anemic."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakanemic4966(String languageCode) async {
    ...
    await flutterTts.speak(
        "Both actors gave fairly anemic performances."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "anemic"), // DOPSUM: CHANGE WORD ENTRY - Find /əˈniːmɪk/
                            // divvviiider
                        ...
                        Row(
                          children: [
                            ...
                            CustomIconButtonBritish(
                              onPressed: () =>
                                  speakanemic(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'lZJzs9X2VLo';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'OKrlc5h6FiA';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'xOX21MhEIXo';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'gxHzkeT9O24';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'niqum9l4mhs';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = '853qx7pJGZ0';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = '1UOLfL8wnoE';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'sxSZDnhU-Jw';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = 'aWjp47K-axY';
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = 'JIE448LBcvM';
