...
// Define the word "beef" and provide five simple example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings or more.

// replace beef - replace EnglishEntrybeef

// replace speakBeef - /biːf/

enum TtsState { playing }

class EnglishEntrybeef extends StatelessWidget {
// blank divider
  EnglishEntrybeef({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakbeef(String languageCode) async {
    // DOPSUM: CHANGE speakBeef
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("beef"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbeefs1(String languageCode) async {
    // DOPSUM: CHANGE speakBeef
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("Dad stood up to carve the beef."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbeefs2(String languageCode) async {
    // DOPSUM: CHANGE speakBeef
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "I bought a kilo of very lean minced beef."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbeefs3(String languageCode) async {
    // DOPSUM: CHANGE speakBeef
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("What's his latest beef?"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbeefs4(String languageCode) async {
    // DOPSUM: CHANGE speakBeef
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("Don't just beef about it—do something!"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbeefs5(String languageCode) async {
    // DOPSUM: CHANGE speakBeef
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBeefs55"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbeefs6(String languageCode) async {
    // DOPSUM: CHANGE speakBeef
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBeefs66"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbeefs7(String languageCode) async {
    // DOPSUM: CHANGE speakBeef
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBeefs77"); // DOPSUM: CHANGE TEXT
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "beef"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /biːf/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakbeef("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /biːf/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakbeef("en-US"),
                            ),
                          ],
                        ),
                      ],
...
1. Cattle that are reared for their meat (= beef cattle)
 
2. Meat from an adult domestic bovine (= boeuf)
 
3. [informal] A complaint or act of complaining (= objection, gripe [informal], kick [informal], bitch [informal], squawk [informal])
"I have a beef about the service here";

- Verb: beef (derived forms: beefing, beefed, beefs)
Usage: informal
1. Complain (= gripe, bitch [informal], grouse, crab [informal], squawk, bellyache [informal], holler [informal])
""",
  );
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  ...
  final String _videoId = 'vo8HZ6cMsO4';
...
class _YoutubeEmbeddedtwoState extends State<YoutubeEmbeddedtwo> {
  late YoutubePlayerController _controller;
  final String _videoId = 'Vnf6hbRfIv0';
...
class _YoutubeEmbeddedthreeState extends State<YoutubeEmbeddedthree> {
  late YoutubePlayerController _controller;
  final String _videoId = '1W9RAHtmBUU';
...
class _YoutubeEmbeddedfourState extends State<YoutubeEmbeddedfour> {
  late YoutubePlayerController _controller;
  final String _videoId = '8p-f9DcVkgE';
  final double _startSeconds = 0;
...
class _YoutubeEmbeddedfiveState extends State<YoutubeEmbeddedfive> {
  late YoutubePlayerController _controller;
  final String _videoId = '7r3dlmYUf4s';
  final double _startSeconds = 0;
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  late YoutubePlayerController _controller;
  final String _videoId = 'YW249cc4NhQ';
  final double _startSeconds = 0;
...
class _YoutubeEmbeddedsevenState extends State<YoutubeEmbeddedseven> {
  late YoutubePlayerController _controller;
  final String _videoId = 'EgZeQbwcmz4';
...
class _YoutubeEmbeddedeightState extends State<YoutubeEmbeddedeight> {
  late YoutubePlayerController _controller;
  final String _videoId = '3_hCLjUrK1E';
...
class _YoutubeEmbeddednineState extends State<YoutubeEmbeddednine> {
  late YoutubePlayerController _controller;
  final String _videoId = 'f4EXpaZYzt8';
...
class _YoutubeEmbeddedtenState extends State<YoutubeEmbeddedten> {
  late YoutubePlayerController _controller;
  final String _videoId = 'MGDT0LYJmxc';
...
class _YoutubeEmbeddedelevenState extends State<YoutubeEmbeddedeleven> {
  late YoutubePlayerController _controller;
  final String _videoId = 'rApdDLwp_gM';
  final double _startSeconds = 0;
...
class _YoutubeEmbeddedtwelveState extends State<YoutubeEmbeddedtwelve> {
  late YoutubePlayerController _controller;
  final String _videoId = 'p8VBYnByPds';
...
class _YoutubeEmbeddedthirteenState extends State<YoutubeEmbeddedthirteen> {
  late YoutubePlayerController _controller;
  final String _videoId = '-hju_hgB-VE';
...
// end beef// TODO Implement this library.
