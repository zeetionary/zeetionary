...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/63tQ7yGmsmI?t=';
    const double startSecondsend = 0000000000000000000000000001350;
    const String videoIdone = 'https://youtu.be/P6bVl47kdNk?t=';
    const double startSecondsone = 000000000000000000000000000116;
    const String videoIdtwo = 'https://youtu.be/eaQfEP45LEs?t=';
    const double startSecondstwo = 000000000000000000000000000160;
    const String videoIdthree = 'https://youtu.be/gHjbay54F4U?t=';
    const double startSecondsthree = 0000000000000000000000000001026;
    const String videoIdfour = 'https://youtu.be/a7DYaTxrDg8?t=';
    const double startSecondsfour = 000000000000000000000000000345;
    const String videoIdfive = 'https://youtu.be/j4kI2h3iotA?t=';
    const double startSecondsfive = 0000000000000000000000000003143;
