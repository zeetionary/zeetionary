...
class EnglishEntrygratis extends StatefulWidget {
  const EnglishEntrygratis({super.key});

  @override
  State<EnglishEntrygratis> createState() => _EnglishEntrygratisState();
}

class _EnglishEntrygratisState extends State<EnglishEntrygratis> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: gratis
1. Costing nothing (- complimentary, costless, free, gratuitous, courtesy)
"gratis tickets";

- Adverb: gratis
1. Without charge (- for free, free of charge)
"I'll give you this gratis";
""",
  );

  final String keyword = "gratis";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I knew his help wouldn't be given gratis.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Drinks were gratis.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gratis""",
                      // alsoEnglishWord: "also: gratis",
                      britshText: """IpaUK: /ˈɡrætɪs/,  /ˈɡrɑːtɪs/""",
                      americanText: """IpaUS: /ˈɡrætɪs/""",
...
کوردی: مفت، خۆڕایی، بەلاش، بێ‌مز
"""),
// With short examples define "gratis", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) بە خۆڕایی"""),
                    SentencesRow(
                      englishText:
                          """I knew his help wouldn't be given gratis.""",
                      kurdishText: """دەمزانی یارمەتییەکەی بە خۆڕایی نابێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/GiEQO77PV9Q?t=';
const double _startSecondsend = 0000000000000000000000000003189;
const String _videoIdone = 'https://youtu.be/LeOiag-hnG0?t=';
const double _startSecondsone = 000000000000000000000000000699;
const String _videoIdtwo = 'https://youtu.be/a_F_8QFRWuc?t=';
const double _startSecondstwo = 000000000000000000000000000100;
const String _videoIdthree = 'https://youtu.be/PGu8K17MDjY?t=';
const double _startSecondsthree = 000000000000000000000000000178;
const String _videoIdfour = 'https://youtu.be/OzSyIla5Z-Q?t=';
const double _startSecondsfour = 0000000000000000000000000005080;
const String _videoIdfive = 'https://youtu.be/m4_wdAY8opM?t=';
const double _startSecondsfive = 0000000000000000000000000001971;
