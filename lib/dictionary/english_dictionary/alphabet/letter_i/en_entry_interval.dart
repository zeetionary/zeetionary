...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'https://youtu.be/twAP3buj9Og?t=';
    const double startSecondstwo = 000000000000000000000000000437;
    const String videoIdthree = 'https://youtu.be/4U2ZxO7b8iM?t=';
    const double startSecondsthree = 000000000000000000000000000467;
    const String videoIdfour = 'https://youtu.be/epAuo2_6gR8?t=';
    const double startSecondsfour = 000000000000000000000000000285;
    const String videoIdfive = 'https://youtu.be/lwCRjwDs1Ek?t=';
