...
class EnglishEntryimmeasurable extends StatefulWidget {
  const EnglishEntryimmeasurable({super.key});

  @override
  State<EnglishEntryimmeasurable> createState() => _EnglishEntryimmeasurableState();
}

class _EnglishEntryimmeasurableState extends State<EnglishEntryimmeasurable> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryimmeasurable immeasurable
WORD_WEB immeasurable immeasurable immeasurable
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200

  final String keyword = "immeasurable";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""immeasurable""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """immeasurable""",
                      // alsoEnglishWord: "also: immeasurable",
...
کوردی: 
"""),
// With short examples define "immeasurable", please follow LX instructions
