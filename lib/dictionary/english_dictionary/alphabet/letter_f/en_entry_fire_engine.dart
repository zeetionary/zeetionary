...
class EnglishEntryfireengine extends StatefulWidget {
  const EnglishEntryfireengine({super.key});

  @override
  State<EnglishEntryfireengine> createState() => _EnglishEntryfireengineState();
}

class _EnglishEntryfireengineState extends State<EnglishEntryfireengine> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fire engine""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The fire engine raced to the burning building.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fire engine""",
                      // alsoEnglishWord: "also: fire engine",
                      britshText: """IpaUK: /ˈfaɪər endʒɪn/""",
                      americanText: """IpaUS: /ˈfaɪər endʒɪn/""",
...
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) ئۆتۆمبێلی ئاگرکوژێنەوە"""),
                    SentencesRow(
                      englishText:
                          """The fire engine raced to the burning building.""",
                      kurdishText:
                          """ئۆتۆمبێلە ئاگرکوژێنەوەکە بەخێرایی بۆ بینا سووتاوەکە دەچوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/nATIs_oIL8U?t=';
const double _startSecondsend = 000000000000000000000000000386;
const String _videoIdone = 'https://youtu.be/R2-wrPJH-Pw?t=';
const double _startSecondsone = 00000000000000000000000000078;
const String _videoIdtwo = 'https://youtu.be/w-3GR1xFtjE?t=';
const double _startSecondstwo = 00000000000000000000000000019;
const String _videoIdthree = 'https://youtu.be/gckQWaEYK_M?t=';
const double _startSecondsthree = 00000000000000000000000000012;
const String _videoIdfour = 'https://youtu.be/52IhYO_4k5Q?t=';
const double _startSecondsfour = 000000000000000000000000000585;
const String _videoIdfive = 'https://youtu.be/PQ8m5R76COo?t=';
const double _startSecondsfive = 000000000000000000000000000193;
