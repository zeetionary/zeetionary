...
class EnglishEntryglobalization extends StatefulWidget {
  const EnglishEntryglobalization({super.key});

  @override
  State<EnglishEntryglobalization> createState() => _EnglishEntryglobalizationState();
}

class _EnglishEntryglobalizationState extends State<EnglishEntryglobalization> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "globalization";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""globalization""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We must take advantage of the increased globalization of the commodity trading business.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """globalization""",
                      // alsoEnglishWord: "also: globalization",
                      britshText: """IpaUK: /ˌɡləʊbəlaɪˈzeɪʃn/""",
                      americanText: """IpaUS: /ˌɡləʊbələˈzeɪʃn/""",
...
کوردی: بەجیهانی‌کردن، بەجیهانی‌بوون
"""),
// With short examples define "globalization", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ئەوەی کە کەلتوور و سیستەمە ئابوورییە جیاوازەکان لە سەرانسەری جیهاندا خەریکە بەیەکەوە دەبەسترێنەوە و دەبن بە لێکچووی یەکدی بەهۆی کاریگەری کۆمپانیا گەورە فرەنەتەوەییەکان و باشتربوونی پەیوەندیکردن"""),
                    SentencesRow(
                      englishText: """We must take advantage of the increased globalization of the commodity trading business.""",
                      kurdishText: """دەبێت سوود ببینین لە زیادبوونی بەجیهانی‌بوونی بزنسی بازرگانی کەلووپەل.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/wGSOMKSRjkc?t=';
const double _startSecondsend = 0000000000000000000000000001438;
const String _videoIdone = 'https://youtu.be/b1JlYZQG3lI?t=';
const double _startSecondsone = 000000000000000000000000000579;
const String _videoIdtwo = 'https://youtu.be/20TAkcy3aBY?t=';
const double _startSecondstwo = 000000000000000000000000000789;
const String _videoIdthree = 'https://youtu.be/qw-FLc7Z01Q?t=';
const double _startSecondsthree = 000000000000000000000000000522;
const String _videoIdfour = 'https://youtu.be/BmYv8XGl-YU?t=';
const double _startSecondsfour = 0000000000000000000000000001415;
const String _videoIdfive = 'https://youtu.be/jYPrH4xANpU?t=';
const double _startSecondsfive = 000000000000000000000000000422;
