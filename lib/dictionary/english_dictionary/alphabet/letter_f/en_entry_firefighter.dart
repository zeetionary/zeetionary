...
class EnglishEntryfirefighter extends StatefulWidget {
  const EnglishEntryfirefighter({super.key});

  @override
  State<EnglishEntryfirefighter> createState() =>
      _EnglishEntryfirefighterState();
}

class _EnglishEntryfirefighterState extends State<EnglishEntryfirefighter> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: firefighter (Derived forms: firefighters, fire fighters)
1. A member of a fire department who tries to extinguish fires (= fireman, fire fighter, fire-eater)
""",
  );

  final String keyword = "firefighter";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""firefighter""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Firefighters were called to a house in Summertown.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """firefighter""",
                      alsoEnglishWord: "also: fireman (usually a man)",
                      britshText: """IpaUK: /ˈfaɪəfaɪtə(r)/""",
                      americanText: """IpaUS: /ˈfaɪərfaɪtər/""",
...
کوردی: 
"""),
// With short examples define "firefighter", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) کەسێک کە کاری کوژاندنەوەی ئاگرە"""),
                    SentencesRow(
                      englishText:
                          """Firefighters were called to a house in Summertown.""",
                      kurdishText:
                          """ئاگرکوژێنەوەکان بانگکران بۆ خانوویەک لە سەمەرتاون.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Firefighters rescued a driver trapped in the wreckage of his car.""",
                      kurdishText:
                          """ئاگرکوژێنەوەکان شۆفێرێکیان ڕزگارکرد کە لە پاشماوەی ئۆتۆمبێلەکەی گیری کردبوو.""",
...
const double _startSecondsend = 0000000000000000000000000001085;
const String _videoIdone = 'https://youtu.be/hTqtGJwsJVE?t=';
const double _startSecondsone = 0000000000000000000000000003485;
const String _videoIdtwo = 'https://youtu.be/uQtw2_7oXV0?t=';
const double _startSecondstwo = 000000000000000000000000000429;
const String _videoIdthree = 'https://youtu.be/gFuEoxh5hd4?t=';
const double _startSecondsthree = 000000000000000000000000000331;
const String _videoIdfour = 'https://youtu.be/R2-wrPJH-Pw?t=';
const double _startSecondsfour = 00000000000000000000000000011;
const String _videoIdfive = 'https://youtu.be/gm4AYeWZB5s?t=';
const double _startSecondsfive = 000000000000000000000000000268;
