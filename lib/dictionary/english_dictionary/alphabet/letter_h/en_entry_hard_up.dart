...
class EnglishEntryhardup extends StatefulWidget {
  const EnglishEntryhardup({super.key});

  @override
  State<EnglishEntryhardup> createState() => _EnglishEntryhardupState();
}

class _EnglishEntryhardupState extends State<EnglishEntryhardup> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hard up
1. Not having enough money to pay for necessities (- impecunious, in straitened circumstances, penniless, penurious, pinched, badly-off)
"The hard up gentlemen asked for a loan";
""",
  );

  final String keyword = "hard up";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hard up""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They’re not really as hard up as they say they are.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hard up""",
                      // alsoEnglishWord: "also: hard up",
                      britshText: """IpaUK: /ˌhɑːd ˈʌp/""",
                      americanText: """IpaUS: /ˌhɑːrd ˈʌp/""",
