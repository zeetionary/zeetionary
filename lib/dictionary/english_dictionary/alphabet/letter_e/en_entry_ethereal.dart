...
class EnglishEntryethereal extends StatefulWidget {
  const EnglishEntryethereal({super.key});

  @override
  State<EnglishEntryethereal> createState() => _EnglishEntryetherealState();
}

class _EnglishEntryetherealState extends State<EnglishEntryethereal> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""ethereal""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ethereal""",
                      // alsoEnglishWord: "also: ethereal",
                      britshText: """IpaUK: /ɪˈθɪəriəl/""",
                      americanText: """IpaUS: /ɪˈθɪriəl/""",
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) تەواو ناسک و جوان؛ کە وەها دەردەکەوێت سەر بە جیهانێکی دیکەی ڕۆحی بێت"""),
          SentencesRow(
            englishText: """Many admired her ethereal beauty at the party.""",
            kurdishText:
                """زۆر کەس لە ئاهەنگەکە سەرسامی جوانییە خوداوەندییەکەی بوون.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: ethereal 
1. Characterized by lightness and insubstantiality; as impalpable or intangible as air (= aeriform, aerial, airy, aery, etherial)
"physical rather than ethereal forms";
 
2. Of heaven or the spirit (= celestial, supernal, etherial)
"ethereal melodies";
 
3. Characterized by unusual lightness and delicacy (= gossamer, etherial)
"this smallest and most ethereal of birds";
 
4. (chemistry) of, containing or dissolved in ether (= etherial)
"ethereal solution";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/mcZdTvOqmvI?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1127;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/ndqjxhi7uZs?t=';
const double _startSecondsone = 00000000000000000000000000000; // 234;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/qOY8F_ngNWI?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 112;
const String _videoIdthree = 'VIDEOhttps://youtu.be/RhUMA3bCvAY?t=';
const double _startSecondsthree = 000000000000000000000000000; // 284;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/xi4wZJ-7ZCg?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 181;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/-UY-KkPY3vc?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 222;
