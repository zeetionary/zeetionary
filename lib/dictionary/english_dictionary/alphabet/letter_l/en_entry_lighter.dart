...
class EnglishEntrylighter extends StatefulWidget {
  const EnglishEntrylighter({super.key});

  @override
  State<EnglishEntrylighter> createState() => _EnglishEntrylighterState();
}

class _EnglishEntrylighterState extends State<EnglishEntrylighter> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lighter""");
  }
