...
class EnglishEntryfinery extends StatefulWidget {
  const EnglishEntryfinery({super.key});

  @override
  State<EnglishEntryfinery> createState() => _EnglishEntryfineryState();
}

class _EnglishEntryfineryState extends State<EnglishEntryfinery> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: finery (Derived forms: fineries)
1. Elaborate or showy attire and accessories
""",
  );

  final String keyword = "finery";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """finery""",
                      // alsoEnglishWord: "also: finery",
                      britshText: """IpaUK: /ˈfaɪnəri/""",
                      americanText: """IpaUS: /ˈfaɪnəri/""",
...
کوردی: خشڵ‌وزێو، خشڵ‌وزەنبەر، زێڕوزیو، جل‌وبەرگ و جەواهێرات
"""),
// With short examples define "finery", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """There we all were in our finery, waiting for the bride and groom to arrive.""",
                      kurdishText:
                          """لەوێ هەموومان بە جلی جوانەوە چاوەڕێی بووک و زاوا بووین.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/sjvlW0AzKlY?t=';
const double _startSecondsend = 000000000000000000000000000100;
const String _videoIdone = 'https://youtu.be/xxSyov0Hjz8?t=';
const double _startSecondsone = 0000000000000000000000000001096;
const String _videoIdtwo = 'https://youtu.be/WJBA1bidwis?t=';
const double _startSecondstwo = 000000000000000000000000000303;
const String _videoIdthree = 'https://youtu.be/OXhEBfK3Njc?t=';
const double _startSecondsthree = 000000000000000000000000000540;
const String _videoIdfour = 'https://youtu.be/R_59ZeuJCOU?t=';
const double _startSecondsfour = 000000000000000000000000000678;
const String _videoIdfive = 'https://youtu.be/vVVTDwxJBWU?t=';
const double _startSecondsfive = 0000000000000000000000000001460;
