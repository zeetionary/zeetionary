...
class EnglishEntrygymnastic extends StatefulWidget {
  const EnglishEntrygymnastic({super.key});

  @override
  State<EnglishEntrygymnastic> createState() => _EnglishEntrygymnasticState();
}

class _EnglishEntrygymnasticState extends State<EnglishEntrygymnastic> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: gymnastic
1. Vigorously active (- acrobatic, athletic)
"gymnastic exercises";
...
""",
  ...
  final String keyword = "gymnastic";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gymnastic""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """She is now president of the gymnastic federation in Ukraine.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gymnastic""",
                      // alsoEnglishWord: "also: gymnastic",
                      britshText: """IpaUK: /dʒɪmˈnæstɪk/""",
                      americanText: """IpaUS: /dʒɪmˈnæstɪk/""",
                    ...
                    CustomRichText(
                      ...
                      onTap: () {
                        Routemaster.of(context)
                            .push("/english-gymnastic/gymnastics");
                      },
                    ),
                    SentencesRow(
                      englishText:
                          """She is now president of the gymnastic federation in Ukraine.""",
                      kurdishText:
                          """ئێستا سەرۆکە لە فیدراسیۆنی جیمناستیکی ئۆکرانیا.""",
