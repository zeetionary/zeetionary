...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'ebQU7GipJcA';
    const double startSecondsend = 29;
    const String videoIdone = 'hFL6qRIJZ_Y';
    const double startSecondsone = 1086;
    const String videoIdtwo = 'gjIv_u4zmck';
    const double startSecondstwo = 518;
    const String videoIdthree = 'KAJsdgTPJpU';
    const double startSecondsthree = 0;
    const String videoIdfour = 'O177L4pu2jg';
    const double startSecondsfour = 272;
    const String videoIdfive = '4GJtGpvE1sQ';
