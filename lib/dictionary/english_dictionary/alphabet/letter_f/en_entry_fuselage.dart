...
class EnglishEntryfuselage extends StatefulWidget {
  const EnglishEntryfuselage({super.key});

  @override
  State<EnglishEntryfuselage> createState() => _EnglishEntryfuselageState();
}

class _EnglishEntryfuselageState extends State<EnglishEntryfuselage> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fuselage (Derived forms: fuselages)
1. The central body of an aeroplane that is designed to accommodate the crew and passengers (or cargo)
"the fuselage cracked along the rivet line"
""",
  );

  final String keyword = "fuselage";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fuselage""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Repairs to the fuselage are almost complete.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fuselage""",
                      // alsoEnglishWord: "also: fuselage",
                      britshText: """IpaUK: /ˈfjuːzəlɑːʒ/""",
                      americanText: """IpaUS: /ˈfjuːsəlɑːʒ/""",
...
کوردی: 
"""),
// With short examples define "fuselage", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) بەشی سەرەکی لاشەی فڕۆکە"""),
                    SentencesRow(
                      englishText:
                          """Repairs to the fuselage are almost complete.""",
                      kurdishText: """چاککردنەوەی لاشەی فڕۆکەکە بەنزیکەیی تەواو بووە.""",
...
const String _videoIdone = 'https://youtu.be/yyIOtN339q4?t=';
...
const double _startSecondsthree = 000000000000000000000000000724;
const String _videoIdfour = 'https://youtu.be/RJQPthD9rx8?t=';
const double _startSecondsfour = 000000000000000000000000000908;
const String _videoIdfive = 'https://youtu.be/hjsrqMe0B3s?t=';
