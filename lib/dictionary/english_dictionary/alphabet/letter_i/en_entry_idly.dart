...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'kbdJqkKQCzc';
    const double startSecondsend = 97;
    const String videoIdone = 'pzvbUpKU4eE';
    const double startSecondsone = 661;
    const String videoIdtwo = '2MZZrDA-I4M';
    const double startSecondstwo = 723;
    const String videoIdthree = 'K_q-xnYRugQ';
    const double startSecondsthree = 176;
    const String videoIdfour = 'e4wajXk_cDs';
    const double startSecondsfour = 154;
    const String videoIdfive = 'kgMtMUDL51M';
    const double startSecondsfive = 835;
