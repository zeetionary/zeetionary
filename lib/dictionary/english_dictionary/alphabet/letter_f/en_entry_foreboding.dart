...
class EnglishEntryforeboding extends StatefulWidget {
  const EnglishEntryforeboding({super.key});

  @override
  State<EnglishEntryforeboding> createState() => _EnglishEntryforebodingState();
}

class _EnglishEntryforebodingState extends State<EnglishEntryforeboding> {
  @override
  void initState() {
    super.initState();
...
1. Ominously prophetic (= fateful, portentous)

- Noun: foreboding (Derived forms: forebodings)
1. A feeling of evil to come (= premonition, presentiment, boding)
"a steadily escalating sense of foreboding";
 
2. An unfavourable omen (= abodement [archaic])
""",
  );

  final String keyword = "foreboding";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foreboding""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The letter filled him with foreboding.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She had a foreboding feeling as the storm approached.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foreboding""",
                      // alsoEnglishWord: "also: foreboding",
                      britshText: """IpaUK: /fɔːˈbəʊdɪŋ/""",
                      americanText: """IpaUS: /fɔːrˈbəʊdɪŋ/""",
...
// With short examples define "foreboding", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هەستێکی بەهێز کە شتێکی خراپ ڕوودەدات"""),
                    SentencesRow(
                      englishText: """The letter filled him with foreboding.""",
                      kurdishText: """نامەکە پڕی کرد لە دڵەخورپە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He knew from her face that his forebodings had been justified.""",
                      kurdishText:
                          """بە ڕووخساریدا دەیزانی کە نیگەرانییەکانی لە جێگای خۆیان بوون.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە وات لێ دەکات هەست بکەیت شتی خراپ ڕوودەدات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She had a foreboding feeling as the storm approached.""",
                      kurdishText:
                          """هەستێکی بەدشوومی هەبوو کە زریانەکە نزیک بوویەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/XEZfGlyLQnA?t=';
const double _startSecondsend = 000000000000000000000000000554;
const String _videoIdone = 'https://youtu.be/ndHOav52t7k?t=';
const double _startSecondsone = 000000000000000000000000000270;
const String _videoIdtwo = 'https://youtu.be/b4wRdoWpw0w?t=';
const double _startSecondstwo = 000000000000000000000000000208;
const String _videoIdthree = 'https://youtu.be/8X1xYpPmKvA?t=';
const double _startSecondsthree = 000000000000000000000000000994;
const String _videoIdfour = 'https://youtu.be/tTKX6P4g20U?t=';
const double _startSecondsfour = 0000000000000000000000000001441;
const String _videoIdfive = 'https://youtu.be/CiRBQ3frG6U?t=';
const double _startSecondsfive = 000000000000000000000000000212;
