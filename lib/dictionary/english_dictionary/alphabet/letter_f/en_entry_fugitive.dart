...
class EnglishEntryfugitive extends StatefulWidget {
  const EnglishEntryfugitive({super.key});

  @override
  State<EnglishEntryfugitive> createState() => _EnglishEntryfugitiveState();
}

class _EnglishEntryfugitiveState extends State<EnglishEntryfugitive> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fugitive
1. Lasting for a markedly brief time (= - fleeting, momentaneous, momentary)
"fugitive hours";

- Noun: fugitive (Derived forms: fugitives)
1. Someone who flees from an uncongenial situation (- runaway, fleer)
"fugitives from the sweatshops";
 
2. Someone who is sought by law officers; someone trying to elude justice (- fugitive from justice)
""",
  );

  final String keyword = "fugitive";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fugitive""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""A fugitive from justice was spotted in the city.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She had a fugitive idea about the new project.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fugitive""",
                      // alsoEnglishWord: "also: fugitive",
                      britshText: """IpaUK: /ˈfjuːdʒətɪv/""",
                      americanText: """IpaUS: /ˈfjuːdʒətɪv/""",
...
کوردی: هەڵاتوو، ڕاکردوو،	دەربەدەر، مشەخت، هەڵوەدا، تەرە، پەڕەوازە،	نابەردەوام، کورت‌خایەن، کورت‌ماوە، تیژپەڕ، زووبەسەرچوو، سەردەمی، ساتی، کاتی،	مرۆی هەڵاتوو،	پەنابەر، کۆچەر، پەناخواز
"""),
// With short examples define "fugitive", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە هەڵهاتووە و دەیەوێت نەگیردرێت"""),
                    SentencesRow(
                      englishText:
                          """Thousands of fugitives are fleeing from the war-torn area.""",
                      kurdishText:
                          """هەزاران هەڵهاتوو لە ناوچە وێرانبوو بە جەنگەکە هەڵدێن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """A fugitive from justice was spotted in the city.""",
                      kurdishText:
                          """هەڵهاتوویەکی دەستی یاسا لە شارەکە بینرا.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) کەسێکی هەڵهاتوو"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Fugitive families who have fled the fighting in the cities are now trying to survive in the mountains.""",
                      kurdishText:
                          """ئەو خێزانە هەڵهاتووانەی کە لە شەڕی ناو شارەکان هەڵهاتوون ئێستا هەوڵ دەدەن لە شاخەکان بەردەوام بن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵناو) کە تەنها بۆ کەمێک بەردەوام دەبێت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: fleeting"),
                    SentencesRow(
                      englishText:
                          """She had a fugitive idea about the new project.""",
                      kurdishText:
                          """بیرۆکەیەکی کورتخایەنی هەبوو سەبارەت بە پڕۆژەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/qr4MSVxfYBE?t=';
const double _startSecondsend = 0000000000000000000000000001003;
const String _videoIdone = 'https://youtu.be/yRFPjBuRRCg?t=';
const double _startSecondsone = 000000000000000000000000000315;
const String _videoIdtwo = 'https://youtu.be/IOgq4Nk2H8w?t=';
const double _startSecondstwo = 000000000000000000000000000767;
const String _videoIdthree = 'https://youtu.be/Fut0t204JvE?t=';
const double _startSecondsthree = 000000000000000000000000000496;
const String _videoIdfour = 'https://youtu.be/uBgiDlEbmx8?t=';
const double _startSecondsfour = 0000000000000000000000000001164;
const String _videoIdfive = 'https://youtu.be/zsSOA9YsFDc?t=';
