...
class EnglishEntryabstinence extends StatefulWidget {
  const EnglishEntryabstinence({super.key});

  @override
  State<EnglishEntryabstinence> createState() => _EnglishEntryabstinenceState();
}

class _EnglishEntryabstinenceState extends State<EnglishEntryabstinence> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "abstinence";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """abstinence""",
                      // alsoEnglishWord: "also: abstinence",
                      britshText: """IpaUK: /ˈæbstɪnəns/""",
                      americanText: """IpaUS: /ˈæbstɪnəns/""",
