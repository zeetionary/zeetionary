...
class EnglishEntryhanker extends StatefulWidget {
  const EnglishEntryhanker({super.key});

  @override
  State<EnglishEntryhanker> createState() => _EnglishEntryhankerState();
}

class _EnglishEntryhankerState extends State<EnglishEntryhanker> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: hanker (Derived forms: hankers, hankering, hankered)
1. Desire strongly or persistently (- long, yearn, pant [informal])
"Psychiatrists still hanker after classifications of mental diseases";
""",
  );

  final String keyword = "hanker";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He had hankered after fame all his life.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hanker""",
                      // alsoEnglishWord: "also: hanker",
                      britshText: """IpaUK: /ˈhæŋkə(r)/""",
                      americanText: """IpaUS: /ˈhæŋkər/""",
...
کوردی: 
"""),
// With short examples define "hanker", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) هەبوونی حەزی زۆر بۆ شتێک"""),
                    SentencesRow(
                      englishText: """He had hankered after fame all his life.""",
                      kurdishText: """تەواوی ژیانی ئارەزووی ناوبانگی هەبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هێشتا بە تاسەی نیشتیمانەکەی بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/LXhLlWQtdt0?t=';
...
const String _videoIdtwo = 'https://youtu.be/1SEjzS0C53k?t=';
const double _startSecondstwo = 0000000000000000000000000002478;
const String _videoIdthree = 'https://youtu.be/DF27vNz7Z-8?t=';
const double _startSecondsthree = 000000000000000000000000000679;
const String _videoIdfour = 'https://youtu.be/P7qSzC8wrIk?t=';
const double _startSecondsfour = 000000000000000000000000000161;
const String _videoIdfive = 'https://youtu.be/5Vst0FCeZq0?t=';
