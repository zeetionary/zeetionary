...
class EnglishEntryfavourably extends StatefulWidget {
  const EnglishEntryfavourably({super.key});

  @override
  State<EnglishEntryfavourably> createState() => _EnglishEntryfavourablyState();
}

class _EnglishEntryfavourablyState extends State<EnglishEntryfavourably> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""favourably""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """favourably""",
                      // alsoEnglishWord: "also: favourably",
                      britshText: """IpaUK: /ˈfeɪvərəbli/""",
                      americanText: """IpaUS: /ˈfeɪvərəbli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "favourably";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He speaks very favourably of your work.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I was very favourably impressed with her work.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵکار) کە ئەرێنییە و بۆچوونی باش لەسەر کەسێک/شتێک پیشان دەدات"""),
          SentencesRow(
            englishText: """He speaks very favourably of your work.""",
            kurdishText: """زۆر ئەرێنییانە قسە لەسەر کارەکەت دەکات.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I was very favourably impressed with her work.""",
            kurdishText: """زۆر ئەرێنییانە سەرسام بووم بە کارەکەی.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ھاوەڵکار) بەشێوەیەک کە بۆ شتێک باشە و وادەکات بەسوود یان سەرکەوتوو بێت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """These figures compare favourably with last year's.""",
            kurdishText: """ئەم ئامارانە باشترن لەوانەی ساڵی ڕابردوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: favourably
Usage: Brit, Cdn (US: favorably)
1. Showing approval (= favorably [US])
"he reviewed the play favourably";
""",
  );
...
const String _videoIdend = 'https://youtu.be/PSMoIC-tUSE?t=';
const double _startSecondsend = 000000000000000000000000000184;
const String _videoIdone = 'https://youtu.be/t3W8YNGcqQY?t=';
const double _startSecondsone = 000000000000000000000000000419;
const String _videoIdtwo = 'https://youtu.be/041iK0Xm2_U?t=';
const double _startSecondstwo = 00000000000000000000000000088;
const String _videoIdthree = 'https://youtu.be/TH893QGNQ4k?t=';
const double _startSecondsthree = 000000000000000000000000000360;
const String _videoIdfour = 'https://youtu.be/DB6Sk6ssuEw?t=';
const double _startSecondsfour = 000000000000000000000000000328;
const String _videoIdfive = 'https://youtu.be/gcJWOoNamZA?t=';
