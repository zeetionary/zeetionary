...
class EnglishEntryastrologer extends StatelessWidget {
  ...
  Future<void> speakastrologer(String languageCode) async {
    ...
    await flutterTts.speak("astrologer");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "astrologer"),
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈstrɒlədʒə(r)/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakastrologer("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈstrɑːlədʒər/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakastrologer("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'MFrUeWSeNNw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '1Zfvn_Moa8E';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'Gu7Mq9O6gXE';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'oXZsua79yXM';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '5FKZJHMzvL8';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'hZth1kp01HY';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'IVMPQUzW4Lc';
