...
// replace these: EnglishEntryaccidentally - speakAccidentally - accidentally - /ˌæksɪˈdentəli/

enum TtsState { playing }

class EnglishEntryaccidentally extends StatelessWidget {
  EnglishEntryaccidentally({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAccidentally(String languageCode) async {
    // DOPSUM: CHANGE speakAccidentally
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("accidentally"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakA21589(String languageCode) async {
    ...
    await flutterTts.speak(
        "The damage couldn't have been caused accidentally."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌæksɪˈdentəli/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
2. Of a minor or subordinate nature (= incidentally)
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '466uN84HhcdIws';
