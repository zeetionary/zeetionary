...
class EnglishEntryaccustomto extends StatefulWidget {
  const EnglishEntryaccustomto({super.key});

  @override
  State<EnglishEntryaccustomto> createState() => _EnglishEntryaccustomtoState();
}

class _EnglishEntryaccustomtoState extends State<EnglishEntryaccustomto> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "accustom to";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accustom to""",
                      // alsoEnglishWord: "also: accustom to",
                      britshText: """IpaUK: /əˈkʌstəm tə/""",
                      americanText: """IpaUS: /əˈkʌstəm tə/""",
