...
class EnglishEntryavarice extends StatelessWidget {
  ...
  Future<void> speakavarice(String languageCode) async {
    ...
    await flutterTts.speak("avarice");
  }
  ...
  Future<void> speakavarices2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvarices2c");
  }
  ...
  Future<void> speakavarices3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvarices3c");
  }
  ...
  Future<void> speakavarices4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvarices4c");
  }
  ...
  Future<void> speakavarices5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvarices5c");
  }
  ...
  Future<void> speakavarices6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvarices6c");
  }
  ...
  Future<void> speakavarices7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvarices7c");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "avarice"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈævərɪs/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakavarice("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈævərɪs/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakavarice("en-US"),
                            ),
                          ],
                        ),
                      ],
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakavarices1("en-US"),
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '1Sm8fi3jodA';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'ZWkicUhQ7yE';
  final double _startSeconds = 8804;
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'xKyerxA_aRs';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'C_4LmbuSmpI';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '2YSkXgqFTDs';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'VuoBU1cyDIc';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'xOM_ohW6FQc';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'AGXASWS1g54';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'eqXu4RHHkt0';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = '-azFNwF6fa0';
