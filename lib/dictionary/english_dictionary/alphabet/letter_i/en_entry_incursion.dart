...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'ErPsyBUCijM';
    const double startSecondsend = 2785;
    const String videoIdone = 'hDNiNdsPHNA';
    const double startSecondsone = 0;
    const String videoIdtwo = 'pzvbUpKU4eE';
    const double startSecondstwo = 371;
    const String videoIdthree = 'mteaH6F-Jd8';
    const double startSecondsthree = 87;
    const String videoIdfour = 'PQl82pAgnLo';
    const double startSecondsfour = 706;
    const String videoIdfive = 'AGqUCKin4X0';
