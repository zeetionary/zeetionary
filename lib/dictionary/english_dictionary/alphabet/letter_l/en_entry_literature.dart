...
class EnglishEntryliterature extends StatefulWidget {
  const EnglishEntryliterature({super.key});

  @override
  State<EnglishEntryliterature> createState() => _EnglishEntryliteratureState();
}

class _EnglishEntryliteratureState extends State<EnglishEntryliterature> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: literature (Derived forms: literatures)
1. Creative writing of recognized artistic value
 
2. The humanistic study of a body of literature (- lit)
"he took a course in Russian literature";
...
""",
  ...
  final String keyword = "literature";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""literature""");
  }
...
""");
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/MLd4K5hKosw?t=598';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/8eq2vGEEbB4?t=665';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/rOqUiXhECos?t=140';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/Unzc731iCUY?t=2507';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/IlU-zDU6aQ0?t=337';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/eIQuuoTQIoc?t=88';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """literature""",
                      // alsoEnglishWord: "also: literature",
                      britshText: """IpaUK: /ˈlɪtrətʃə(r)/""",
                      americanText: """IpaUS: /ˈlɪtrətʃər/,  /ˈlɪtrətʃʊr/""",
