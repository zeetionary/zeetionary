...
class EnglishEntryhandlebar extends StatefulWidget {
  const EnglishEntryhandlebar({super.key});

  @override
  State<EnglishEntryhandlebar> createState() => _EnglishEntryhandlebarState();
}

class _EnglishEntryhandlebarState extends State<EnglishEntryhandlebar> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: handlebar (derived forms: handlebar)
1. The shaped bar used to steer a bicycle
""",
  );

  final String keyword = "handlebar";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""handlebar""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was hunched over the handlebars, pedalling furiously.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """handlebar""",
                      // alsoEnglishWord: "also: handlebar",
                      britshText: """IpaUK: /ˈhændlbɑː(r)/""",
                      americanText: """IpaUS: /ˈhændlbɑːr/""",
...
// With short examples define "handlebar", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) دەسکی پاسکیل یان ماتۆڕسکیل"""),
                    SentencesRow(
                      englishText: """He was hunched over the handlebars, pedalling furiously.""",
                      kurdishText: """خۆی کێشابوو بەسەر دەسکەکە بە تووڕەییەوە پایدانی لێدەدا.""",
