...
class EnglishEntrydarling extends StatefulWidget {
  const EnglishEntrydarling({super.key});

  @override
  State<EnglishEntrydarling> createState() => _EnglishEntrydarlingState();
}

class _EnglishEntrydarlingState extends State<EnglishEntrydarling> {
  @override
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "darling");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: darling");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /ˈdɑːlɪŋ/");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakdarling(String languageCode) async {
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /ˈdɑːrlɪŋ/");
  }
}
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakdarlings1(String languageCode) async {
    // DOPSUM: CHANGE speakdarling
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
...
// Create an instance of EnglishMeaningConst with the desired text
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: darling (Derived forms: darlings)
1. A special loved one (= favorite [US], favourite [Brit, Cdn], pet, dearie [Brit, informal], deary [informal], ducky [informal], jo [UK, archaic, dialect], acushla [Ireland], duckie [informal], honeybunch [informal], honeybun [N. Amer, informal])
 
2. Someone who is loved (used as term of endearment) (= beloved, dear, dearest, honey [informal], love, sweetheart, sugar [informal], baby [informal], duck [Brit, informal], hon [informal])
 
3. A kind, charming, lovable person (= angel)

- Adjective: darling 
1. Dearly loved (= beloved, dear)

- Noun: Darling 
1. An Australian river; tributary of the Murray River (= Darling River)
""",
  );
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/5udTCrpppUc?t=',
    startSeconds: 58,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
