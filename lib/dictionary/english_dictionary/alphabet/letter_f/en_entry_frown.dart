...
class EnglishEntryfrown extends StatefulWidget {
  const EnglishEntryfrown({super.key});

  @override
  State<EnglishEntryfrown> createState() => _EnglishEntryfrownState();
}

class _EnglishEntryfrownState extends State<EnglishEntryfrown> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: frown (Derived forms: frowned, frowns, frowning)
1. Look angry or sullen, wrinkle one's forehead, as if to signal disapproval (= glower, lour, lower)

- Noun: frown (Derived forms: frowns)
1. A facial expression of dislike or displeasure (- scowl, lour, lower)
""",
  );

  final String keyword = "frown";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""What are you frowning at me for?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He frowned with annoyance.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""A small frown creased her forehead.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His brows drew together in a frown.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frown""",
                      // alsoEnglishWord: "also: frown",
                      britshText: """IpaUK: /fraʊn/""",
                      americanText: """IpaUS: /fraʊn/""",
...
// With short examples define "frown", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """What are you frowning at me for?""",
                      kurdishText: """بەچی هۆکارێک ڕووت لێم گرژ دەکەیت؟""",
                    ...
                    SentencesRow(
                      englishText: """He frowned with annoyance.""",
                      kurdishText: """لە بێزاریدا خۆی مۆن کردبوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """His brows drew together in a frown.""",
                      kurdishText:
                          """برۆیەکانی هاتنەوە یەک لە مۆن‌بوونەوەدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/7c1FO8FT__U?t=';
const double _startSecondsend = 000000000000000000000000000111;
const String _videoIdone = 'https://youtu.be/hTqtGJwsJVE?t=';
const double _startSecondsone = 0000000000000000000000000001481;
const String _videoIdtwo = 'https://youtu.be/Pon4Zux5MaQ?t=';
const double _startSecondstwo = 000000000000000000000000000618;
const String _videoIdthree = 'https://youtu.be/awoQuVq2yYc?t=';
const double _startSecondsthree = 000000000000000000000000000262;
const String _videoIdfour = 'https://youtu.be/RONuW3-fr0U?t=';
const double _startSecondsfour = 000000000000000000000000000490;
const String _videoIdfive = 'https://youtu.be/dcWxethwL1Y?t=';
