...
class EnglishEntryfry extends StatefulWidget {
  const EnglishEntryfry({super.key});

  @override
  State<EnglishEntryfry> createState() => _EnglishEntryfryState();
}

class _EnglishEntryfryState extends State<EnglishEntryfry> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: fry (Derived forms: fries, frying, fried)
...
3. [informal] Kill by electrocution, as in the electric chair (- electrocute)
"The serial killer was fried";

- Noun: fry (Derived forms: fries)
1. A fish that is young (- young fish)
 
2. A dish that is fried or an event where fried food is served
 
3. [archaic] A young person of either sex (- child, kid [informal], youngster, minor, shaver [informal], nipper [informal], small fry [informal], tiddler [Brit, informal], tike [informal], tyke [informal], nestling [informal], wean [UK, Ireland, dialect], kiddy [informal], kiddie [informal])
"she writes books for fries";
""",
  );

  final String keyword = "fry";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We had fried chicken for dinner.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Fry the onions gently in oil.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""You'll fry on the beach if you're not careful.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Would you like ketchup with your fries?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fry""",
                      // alsoEnglishWord: "also: fry",
                      britshText: """IpaUK: /fraɪ/""",
                      americanText: """IpaUS: /fraɪ/""",
...
// With short examples define "fry", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """We had fried chicken for dinner.""",
                      kurdishText: """بۆ نانی ئێوارە مریشکی برژاومان هەبوو.""",
                    ...
                    SentencesRow(
                      englishText: """Fry the onions gently in oil.""",
                      kurdishText: """بە هێواشی پیازەکان لە ڕۆندا ببرژێنە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە کەنارەکە دەسووتێیت ئەگەر وریا نەبیت.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ناو) ماسییەکی زۆر بچووک"""),
                    const DividerSentences(),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text:
                            """٤. (ناو) قاژێکی باریک و درێژی پەتاتە کە لە ڕۆندا برژێندراوە"""),
                    AlsoEnglishckblink(
                      textBeforeLink: "هەروەها: ",
                      linkText: "chip",
                      textAfterLink: ".",
                      onTap: () {
                        Routemaster.of(context).push("/english-fry/chip");
                      },
                    ),
                    SentencesRow(
                      englishText:
                          """Would you like ketchup with your fries?""",
                      kurdishText: """حەزت بە کەچەپ هەیە لەسەر پەتاتەکەت؟""",
...
const double _startSecondsend = 000000000000000000000000000166;
const String _videoIdone = 'https://youtu.be/D_Y18GEjfNY?t=';
const double _startSecondsone = 000000000000000000000000000257;
const String _videoIdtwo = 'https://youtu.be/3cxHwQl9pNM?t=';
const double _startSecondstwo = 000000000000000000000000000234;
const String _videoIdthree = 'https://youtu.be/1Jr2P4Sjgf0';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/E42c5DgJ7G0?t=';
const double _startSecondsfour = 00000000000000000000000000092;
const String _videoIdfive = 'https://youtu.be/2KNlXt0u_5o';
