...
class EnglishEntryaccessible extends StatelessWidget {
  EnglishEntryaccessible({Key? key}) : super(key: key);
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "ناوچە بیابانە دوورەدەستەکە تەنھا لە ڕێگەی ھەلیجۆپتەرەوە دەتوانرێت سەردانی بکرێت",
                                    textAlign: TextAlign
