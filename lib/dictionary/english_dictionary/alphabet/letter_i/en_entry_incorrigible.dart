...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'Zad6v8ZHzdg';
    const double startSecondsend = 735;
    const String videoIdone = 'jMw1NAwYDbQ';
    const double startSecondsone = 133;
    const String videoIdtwo = '65vK_gbsgwI';
    const double startSecondstwo = 874;
    const String videoIdthree = 'YEhUUQQekkQ';
    const double startSecondsthree = 0;
    const String videoIdfour = 'hi9Rf0oLdHk';
    const double startSecondsfour = 12847;
    const String videoIdfive = 'MavIx74cYBk';
    const double startSecondsfive = 1846;
