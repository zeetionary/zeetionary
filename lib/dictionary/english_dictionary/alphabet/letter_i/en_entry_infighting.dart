...
class EnglishEntryinfighting extends StatefulWidget {
  const EnglishEntryinfighting({super.key});

  @override
  State<EnglishEntryinfighting> createState() => _EnglishEntryinfightingState();
}

class _EnglishEntryinfightingState extends State<EnglishEntryinfighting> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infighting""");
  }
