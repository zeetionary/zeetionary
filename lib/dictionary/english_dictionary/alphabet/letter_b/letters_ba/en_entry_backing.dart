...
// Define the word "backing" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace backing - replace EnglishEntrybacking

// replace speakBacking - /ˈbækɪŋ/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntrybacking extends StatelessWidget {
  // blank divider
  EnglishEntrybacking({super.key});
  // blank divider
  ...
  Future<void> speakbacking(String languageCode) async {
    ...
    await flutterTts.speak("backing");
  }
  ...
  Future<void> speakbackings1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The police gave the proposals their full backing.");
  }
  ...
  Future<void> speakbackings2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("It's strong cloth - it might be useful as (a) backing.");
  }
  ...
  Future<void> speakbackings3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("She sang as part of an backing group.");
  }
  ...
  Future<void> speakbackings4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBackings44");
  }
  ...
  Future<void> speakbackings5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBackings55");
  }
  ...
  Future<void> speakbackings6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBackings66");
  }
  ...
  Future<void> speakbackings7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBackings77");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "backing"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈbækɪŋ/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈbækɪŋ/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbackings1("en-US"),
                          ),
...
٢. (ناو) مادەی پارێزەر"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbackings2("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٣. (ناو) میوزیک یان سەما کە دەکرێت بۆ بەشی سەرەکی گۆرانییەک"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbackings3("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'NnTSpkgVHQQ';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'JabVnDhZKdI';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'E3hceCMoTQY';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'YLeMKM4ArlA';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'ydCv7repAHs';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'T7tLon1n4qE';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'QSlYJi7IZGc';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'hdtNbiQdsZM';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'ltcOfkYyg_w';
...
// end backing // TODO Implement this library.
