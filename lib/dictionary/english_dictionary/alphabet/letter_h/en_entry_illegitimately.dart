...
class EnglishEntryillegitimately extends StatefulWidget {
  const EnglishEntryillegitimately({super.key});

  @override
  State<EnglishEntryillegitimately> createState() =>
      _EnglishEntryillegitimatelyState();
}

class _EnglishEntryillegitimatelyState
    extends State<EnglishEntryillegitimately> {
  @override
  void initState() {
    super.initState();
...
1. In a manner disapproved or not allowed by custom (- illicitly)
"He acted illegitimately when he increased the rent fourfold";
 
2. Of biological parents not married to each other (- out of wedlock)
"this child was born illegitimately";
""",
  );

  final String keyword = "illegitimately";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""illegitimately""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Peter had been born illegitimately and was brought up by his mother alone.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The government had illegitimately gained power.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/b8WnPAxVxRY?t=';
    const double startSecondsend = 000000000000000000000000000149;
    const String videoIdone = 'https://youtu.be/RI0vy-XsTmU?t=';
    const double startSecondsone = 000000000000000000000000000155;
    const String videoIdtwo = 'https://youtu.be/ecRLtzu_-UI?t=';
    ...
    const String videoIdfour = 'https://youtu.be/W3qZIPiWKc4?t=';
    const double startSecondsfour = 000000000000000000000000000755;
    const String videoIdfive = 'https://youtu.be/xhL8J-HMF2M?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """illegitimately""",
                      // alsoEnglishWord: "also: illegitimately",
                      britshText: """IpaUK: /ˌɪləˈdʒɪtəmətli/""",
                      americanText: """IpaUS: /ˌɪləˈdʒɪtəmətli/""",
...
کوردی: 
"""),
// With short examples define "illegitimately", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە دایک و باوکێک بێت کە هاوسەرگیرییان نەکردووە"""),
                    SentencesRow(
                      englishText:
                          """Peter had been born illegitimately and was brought up by his mother alone.""",
                      kurdishText:
                          """پیتەر بە ناشەرعی لەدایک ببوو و بە تەنیا لەلایەن دایکییەوە پەروەردە کرابوو.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵکار) بە شێوەیەک کە دژ بە یاسایە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The government had illegitimately gained power.""",
                      kurdishText:
                          """حکومەت بە نایاسایی دەسەڵاتی بەدەست هێنابوو.""",
