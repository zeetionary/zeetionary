...
class EnglishEntryexpire extends StatefulWidget {
  const EnglishEntryexpire({super.key});

  @override
  State<EnglishEntryexpire> createState() => _EnglishEntryexpireState();
}

class _EnglishEntryexpireState extends State<EnglishEntryexpire> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """expire""",
                      // alsoEnglishWord: "also: expire",
                      britshText: """IpaUK: /ɪkˈspaɪə(r)/""",
                      americanText: """IpaUS: /ɪkˈspaɪər/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""When does your driving licence expire?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His term of office expires at the end of June.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) کە چی دیکە ناکرێت بەکاربێت چونکە ماوەی یاسایی بەکارهێنانی بەسەرچووە"""),
          SentencesRow(
            englishText: """When does your driving licence expire?""",
            kurdishText: """کەی مۆڵەتی شۆفێریت بەسەر دەچێت؟""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (کردار) کۆتایی هاتنی ماوەی کاتێک"""),
          const DividerSentences(),
          SentencesRow(
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/sxt4YCIsn2I?t=';
const double _startSecondsend = 000000000000000000000000000000; // 449;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/05gCLHlpzTU?t=';
const double _startSecondsone = 00000000000000000000000000000; // 403;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/JX82wa5HkJg?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1011;
const String _videoIdthree = 'VIDEOhttps://youtu.be/86SDpAhBsSc?t=';
const double _startSecondsthree = 000000000000000000000000000; // 664;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/jGrp_qIoGFM?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 378;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/fOzFG5m3Y5E?t=';
