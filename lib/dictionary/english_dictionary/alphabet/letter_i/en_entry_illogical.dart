...
class EnglishEntryillogical extends StatefulWidget {
  const EnglishEntryillogical({super.key});

  @override
  State<EnglishEntryillogical> createState() => _EnglishEntryillogicalState();
}

class _EnglishEntryillogicalState extends State<EnglishEntryillogical> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: illogical
1. Lacking in correct logical relation (- unlogical)
 
2. Lacking orderly continuity (- confused, disconnected, disjointed, disordered, garbled, scattered, unconnected)
""",
  );

  final String keyword = "illogical";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""illogical""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She has an illogical fear of insects.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """From all this evidence he drew a strange and illogical conclusion.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/4Q1FzhMY8FQ?t=';
    const double startSecondsone = 0000000000000000000000000001048;
    const String videoIdtwo = 'https://youtu.be/XkYvo6S82LE?t=';
    const double startSecondstwo = 0000000000000000000000000001711;
    const String videoIdthree = 'https://youtu.be/XeSu9fBJ2sI?t=';
    const double startSecondsthree = 000000000000000000000000000383;
    const String videoIdfour = 'https://youtu.be/MLIehuS4xyw?t=';
    const double startSecondsfour = 0000000000000000000000000001029;
    const String videoIdfive = 'https://youtu.be/nRnuY1Vao0o?t=';
    const double startSecondsfive = 000000000000000000000000000948;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """illogical""",
                      // alsoEnglishWord: "also: illogical",
                      britshText: """IpaUK: /ɪˈlɒdʒɪkl/""",
                      americanText: """IpaUS: /ɪˈlɑːdʒɪkl/""",
...
کوردی: نالۆژیکی، ناژیرانە، ڕێ‌تێنەچوو، پێچەوانە یان بە دژی لۆژیک
"""),
// With short examples define "illogical", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە عاقڵانی نییە، یان بە تەواوی بیری لێ نەکراوەتەوە"""),
                    SentencesRow(
                      englishText: """She has an illogical fear of insects.""",
                      kurdishText: """ترسێکی نالۆژیکی لە مێروو هەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """From all this evidence he drew a strange and illogical conclusion.""",
                      kurdishText:
                          """لەم هەموو بەڵگەیە دەرەنجامێکی نامۆ و نالۆژیکی درووست کرد.""",
