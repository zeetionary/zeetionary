...
class EnglishEntryhelpful extends StatefulWidget {
  const EnglishEntryhelpful({super.key});

  @override
  State<EnglishEntryhelpful> createState() => _EnglishEntryhelpfulState();
}

class _EnglishEntryhelpfulState extends State<EnglishEntryhelpful> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""helpful""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Sorry I can't be more helpful.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """helpful""",
                      // alsoEnglishWord: "also: helpful",
                      britshText: """IpaUK: /ˈhelpfl/""",
                      americanText: """IpaUS: /ˈhelpfl/""",
...
کوردی: یاریدەدەر، یارمەتیدەر، کاریگەر، کارا، ئازا، ئاریکار، بەسوود، بەقازانج، بەکارهاتوو، دەسگر، بەخزمەت، دڵسۆز، بەهاناوەهاتوو، کۆمەک
"""),
// With short examples define "helpful", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە دۆخێکی دیاریکراو باش دەکات و بەسوودە بۆی"""),
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) کە یارمەتی کەسێک دەدات"""),
                    SentencesRow(
                      englishText: """Sorry I can't be more helpful.""",
                      kurdishText:
                          """ببوورە ناتوانم لەوە زیاتر یارمەتیدەر بم.""",
...
const String _videoIdone = 'https://youtu.be/dqcSk-EDrRo?t=';
const double _startSecondsone = 000000000000000000000000000337;
const String _videoIdtwo = 'https://youtu.be/9VsDP584zyQ?t=';
const double _startSecondstwo = 000000000000000000000000000403;
const String _videoIdthree = 'https://youtu.be/jxk259Eqnks?t=';
const double _startSecondsthree = 00000000000000000000000000057;
const String _videoIdfour = 'https://youtu.be/SrDEtSlqJC4?t=';
const double _startSecondsfour = 0000000000000000000000000001099;
const String _videoIdfive = 'https://youtu.be/1Tor0LDdVKY?t=';
const double _startSecondsfive = 000000000000000000000000000829;
