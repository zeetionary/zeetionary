...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '4I-p8vjQ95s';
    const double startSecondsend = 955;
    const String videoIdone = '3yvxFFsjcYs';
    const double startSecondsone = 410;
    const String videoIdtwo = 'L1HCG3BGK8I';
    const double startSecondstwo = 161;
    const String videoIdthree = 'uaaC57tcci0';
    const double startSecondsthree = 120;
    const String videoIdfour = '29n2bv7F6uc';
