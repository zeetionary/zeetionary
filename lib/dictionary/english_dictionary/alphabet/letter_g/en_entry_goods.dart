...
class EnglishEntrygoods extends StatefulWidget {
  const EnglishEntrygoods({super.key});

  @override
  State<EnglishEntrygoods> createState() => _EnglishEntrygoodsState();
}

class _EnglishEntrygoodsState extends State<EnglishEntrygoods> {
  @override
  void initState() {
    super.initState();
...
3. things (not people) that are transported by railway or road
""",
  );

  final String keyword = "goods";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The goods will be delivered within ten days.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They sell household goods as well as food.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was accused of handling stolen goods.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The plastic bag contained all his worldly goods.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""A goods train was derailed last night.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """goods""",
                      // alsoEnglishWord: "also: goods",
                      britshText: """IpaUK: /ɡʊdz/""",
                      americanText: """IpaUS: /ɡʊdz/""",
...
// With short examples define "goods", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەو شتانەی کە بەرهەم دەهێندرێن بۆ ئەوەی بفرۆشرێن"""),
                    SentencesRow(
                      englishText:
                          """The goods will be delivered within ten days.""",
                      kurdishText:
                          """کەلووپەلەکان لە ماوەی ١٠ ڕۆژدا دەگەیەندرێن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """There is a 25 percent discount on all electrical goods until the end of the week.""",
                      kurdishText:
                          """داشکاندنی ٢٥ لە سەد هەیە لەسەر هەموو کەلووپەلە کارەباییەکان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کەلووپەلی ماڵ لەگەڵ خواردن دەفرۆشن.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) ئەو شتانەی کە دەکرێت هەڵبگیردرێن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He was accused of handling stolen goods.""",
                      kurdishText: """تۆمەتبارکرا بە هەڵگرتنی شتی دزراو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """جانتا پلاستیکییەکە هەموو شتەکانیی تێدابوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شەمەندەفەرێکی کەلووپەل گواستنەوە دوێنێ شەو لە سکە دەرچوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """You need a special licence to drive a heavy goods vehicle.""",
                      kurdishText:
                          """پێویستیت بە مۆڵەتی تایبەت هەیە بۆ لێخوڕینی بارهەڵگری کەلووپەلی قورس.""",
...
const double _startSecondsend = 000000000000000000000000000123;
const String _videoIdone = 'https://youtu.be/s3B-qp3U5G0?t=';
const double _startSecondsone = 0000000000000000000000000001441;
const String _videoIdtwo = 'https://youtu.be/lGSOWwUvJiU?t=';
...
const String _videoIdfive = 'https://youtu.be/M7ikhWfHQc8?t=';
const double _startSecondsfive = 00000000000000000000000000099;
