...
class EnglishEntryidiomatic extends StatefulWidget {
  const EnglishEntryidiomatic({super.key});

  @override
  State<EnglishEntryidiomatic> createState() => _EnglishEntryidiomaticState();
}

class _EnglishEntryidiomaticState extends State<EnglishEntryidiomatic> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""idiomatic""");
  }
