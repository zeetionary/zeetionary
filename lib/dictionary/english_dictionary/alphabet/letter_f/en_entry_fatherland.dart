...
class EnglishEntryfatherland extends StatefulWidget {
  const EnglishEntryfatherland({super.key});

  @override
  State<EnglishEntryfatherland> createState() => _EnglishEntryfatherlandState();
}

class _EnglishEntryfatherlandState extends State<EnglishEntryfatherland> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fatherland""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fatherland""",
                      // alsoEnglishWord: "also: fatherland",
                      britshText: """IpaUK: /ˈfɑːðəlænd/""",
                      americanText: """IpaUS: /ˈfɑːðərlænd/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "fatherland";
...
کوردی: زێد، نیشتمان، ئاووگڵ، وڵاتی باو و باپیران
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) وڵاتێک کە کەسێک یان خێزانەکەی تێیدا لەدایک بوو و هەست بە سەرفرازی ئەکەن پێوەی (بەتایبەتی سەبارەت بە ئەڵمانیا)"""),
          SentencesRow(
            englishText:
                """Citizens honor their fatherland on national holidays.""",
            kurdishText:
                """لە بۆنە نیشتیمانییەکان هاوڵاتییان ڕێز لە خاکی باوباپیران دەنێن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fatherland (Derived forms: fatherlands)
1. The country where you were born (= homeland, motherland, mother country, country of origin, native land)
""",
  );
...
const String _videoIdend = 'https://youtu.be/MLIehuS4xyw?t=';
const double _startSecondsend = 000000000000000000000000000726;
const String _videoIdone = 'https://youtu.be/pEJCPIxHjOk?t=';
const double _startSecondsone = 0000000000000000000000000001279;
const String _videoIdtwo = 'https://youtu.be/4qsdxkRhapU?t=';
const double _startSecondstwo = 00000000000000000000000000092;
const String _videoIdthree = 'https://youtu.be/kdh_rcSU41g?t=';
const double _startSecondsthree = 0000000000000000000000000002077;
const String _videoIdfour = 'https://youtu.be/V_aHTeHVB58?t=';
const double _startSecondsfour = 000000000000000000000000000155;
const String _videoIdfive = 'https://youtu.be/9A9rH8nbNFk?t=';
