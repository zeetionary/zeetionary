...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/a_TSR_v07m0?t=';
    const double startSecondsend = 000000000000000000000000000246;
    const String videoIdone = 'https://youtu.be/Js2UoMSumx4?t=';
    const double startSecondsone = 000000000000000000000000000695;
    const String videoIdtwo = 'https://youtu.be/hRSGxw2AQnk?t=';
    const double startSecondstwo = 000000000000000000000000000828;
    const String videoIdthree = 'https://youtu.be/sAiTuitN5b8?t=';
    const double startSecondsthree = 000000000000000000000000000383;
    const String videoIdfour = 'https://youtu.be/GVsUOuSjvcg?t=';
    const double startSecondsfour = 0000000000000000000000000001103;
