...
// replace EnglishEntryAdopsummm - replace speakArid

// replace arid - /ˈærɪd/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarid extends StatelessWidget {
  // blank divider
  EnglishEntryarid({super.key});
  // blank divider
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "arid", // DOPSUM: CHANGE WORD ENTRY - Find /ˈærɪd/
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakArid(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
2. Lacking vitality or spirit; lifeless (= desiccate, desiccated)
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "8I4x40LlTsw";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "GV0QLFcCJ1I";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "XJXA1Br0j6o";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "GgtQ01ROYLo";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "4iTAkRHGbuM";
