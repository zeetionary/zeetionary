...
class EnglishEntryfedup extends StatefulWidget {
  const EnglishEntryfedup({super.key});

  @override
  State<EnglishEntryfedup> createState() => _EnglishEntryfedupState();
}

class _EnglishEntryfedupState extends State<EnglishEntryfedup> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fed up""",
                      // alsoEnglishWord: "also: fed up",
                      britshText: """IpaUK: /ˌfed ˈʌp/""",
                      americanText: """IpaUS: /ˌfed ˈʌp/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""You look fed up. What's the matter?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""People are fed up with all these traffic jams.""");
  }
...
کوردی: هیلاک، ماندوو، شەکەت،	وەڕەس، جاڕز، عاجز، بێزار، منج
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) بێزار و دڵتەنگ، بەتایبەتی بەهۆی دۆخێک کە زۆر بەردەوام بووە"""),
          SentencesRow(
            englishText: """You look fed up. What's the matter?""",
            kurdishText: """بێزار دیاریت. کێشە چییە؟""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """People are fed up with all these traffic jams.""",
            kurdishText: """خەڵکی بێزارن لەم هەموو قەرەباڵغییەی هاتووچۆ.""",
          ...
          SentencesRow(
            englishText:
                """In the end, I just got fed up with his constant complaining.""",
            kurdishText: """لە کۆتاییدا، بێزار بوو لە بۆڵەبۆڵی بەردەوامی.""",
...
const double _startSecondsend = 000000000000000000000000000707;
const String _videoIdone = 'https://youtu.be/lsbcN9-jU1Y?t=';
const double _startSecondsone = 000000000000000000000000000362;
const String _videoIdtwo = 'https://youtu.be/lDeFSOUHdH4?t=';
const double _startSecondstwo = 0000000000000000000000000001135;
const String _videoIdthree = 'https://youtu.be/BmUrJaOo1Lw?t=';
const double _startSecondsthree = 0000000000000000000000000004;
const String _videoIdfour = 'https://youtu.be/Bj6ulLJGPB8?t=';
const double _startSecondsfour = 0000000000000000000000000001410;
const String _videoIdfive = 'https://youtu.be/Bh9lIfocRMk?t=';
const double _startSecondsfive = 0000000000000000000000000001191;
