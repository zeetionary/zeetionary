...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 's7TbxgeNx_0';
    const double startSecondsend = 399;
    const String videoIdone = 'v7hz64aVcRw';
    const double startSecondsone = 210;
    const String videoIdtwo = 'oDjDzZdMoVM';
    const double startSecondstwo = 219;
    const String videoIdthree = 'DcWqzZ3I2cY';
    const double startSecondsthree = 5346;
    const String videoIdfour = 'keZnAtBxO-c';
    const double startSecondsfour = 678;
    const String videoIdfive = 'eq2y1JhZYi8';
