...
class EnglishEntrydowntoearth extends StatefulWidget {
  const EnglishEntrydowntoearth({super.key});

  @override
  State<EnglishEntrydowntoearth> createState() =>
      _EnglishEntrydowntoearthState();
}

class _EnglishEntrydowntoearthState extends State<EnglishEntrydowntoearth> {
  @override
  void initState() {
    super.initState();
  }
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "down-to-earth";
...
class TitleOfEntry extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const EntryTitle(word: "down-to-earth");
  }
}
...
class TitleOfEntryAlso extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const AlsoEnglish(word: "also: down-to-earth");
  }
}
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /ˌdaʊn tu ˈɜːθ/");
  }
}
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> downtoearthth(String languageCode) async {
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /ˌdaʊn tu ˈɜːrθ/");
  }
}
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> downtoearthths1(String languageCode) async {
    // DOPSUM: CHANGE downtoearthth
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
...
// """),
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths2("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths3("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths4("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths5("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths6("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths7("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths8("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths9("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths10("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths11("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths12("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths13("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths14("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths15("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths16("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths17("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths18("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths19("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths20("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths21("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
          ...
          //       children: [
          //         CustomIconButtonBritish(
          //           onPressed: () => downtoearthths22("en-GB"),
          //         ),
          //         CustomIconButtonAmerican(
...
1. Sensible and practical (= earthy)
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/21Z4RIOFhMA?t=',
    startSeconds: 485,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/B1r4Z3nXPVA?t=',
    startSeconds: 340,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/ttgy4vhW-WQ?t=',
    startSeconds: 148,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
