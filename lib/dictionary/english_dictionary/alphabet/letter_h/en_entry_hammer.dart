...
""",
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She took a hammer and knocked a hole in the wall.""");
  }
...
// With short examples define "hammer", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """He struck her on the head with a hammer.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She took a hammer and knocked a hole in the wall.""",
                      kurdishText: """چەکووشەکەی هێنا و کونێکی کردە دیوارەکە.""",
