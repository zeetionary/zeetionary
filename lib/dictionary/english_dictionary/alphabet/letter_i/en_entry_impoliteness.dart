...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'DGXfuoAIGi8';
    const double startSecondsend = 2366;
    const String videoIdone = 'F6cOLFWzNME';
    const double startSecondsone = 445;
    const String videoIdtwo = '_8tTk8FlF1A';
    const double startSecondstwo = 151;
    const String videoIdthree = 'lDW78GWnnBc';
    const double startSecondsthree = 1368;
    const String videoIdfour = 'bdwifbKeL0w';
    const double startSecondsfour = 73;
    const String videoIdfive = '1fde8o2osAE';
