...
// replace these: EnglishEntryabsurdity - speakAabsurdity - absurdity - /əbˈsɜːdəti/

enum TtsState { playing }

class EnglishEntryabsurdity extends StatelessWidget {
  EnglishEntryabsurdity({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAabsurdity(String languageCode) async {
    // DOPSUM: CHANGE speakAabsurdity
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("absurdity"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakA27416(String languageCode) async {
    // DOPSUM: CHANGE speakAabsurdity
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "It was only later that she could see the absurdity of the situation."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'absurdity', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əbˈsɜːdəti/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'muga0O0tT6U';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'tExo3ovEBWQ';
