                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "antenatal"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌæntiˈneɪtl/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌæntiˈneɪtl/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'c_yU5AQ3Tnw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'A9AbYAFfiVA';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'bZegjT-i2Ps';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '-XRG18acDWs';
  final double _startSeconds = 4937;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'ev8AU7c-Sj8';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'cFhYejxJEjs';
