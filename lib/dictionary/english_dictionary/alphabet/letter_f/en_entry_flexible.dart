...
class EnglishEntryflexible extends StatefulWidget {
  const EnglishEntryflexible({super.key});

  @override
  State<EnglishEntryflexible> createState() => _EnglishEntryflexibleState();
}

class _EnglishEntryflexibleState extends State<EnglishEntryflexible> {
  @override
  void initState() {
    super.initState();
...
2. Able to flex; able to bend easily (= flexile)
"slim flexible birches";
 
3. Making or willing to make concessions (= compromising, conciliatory)
"loneliness tore through him...whenever he thought of...even the flexible Louis du Tillet";
 
4. Able to adjust readily to different conditions (= elastic, pliable, pliant)
"a flexible personality";
 
5. Bending and snapping back readily without breaking (= whippy)
""",
  );

  final String keyword = "flexible";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flexible""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We can offer you flexible working hours.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Rubber is a flexible substance.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flexible""",
                      // alsoEnglishWord: "also: flexible",
                      britshText: """IpaUK: /ˈfleksəbl/""",
                      americanText: """IpaUS: /ˈfleksəbl/""",
...
کوردی: نەرم، جیڕ، لەداهاتنەوەهاتوو، داهاتوو، بگۆڕ، لەگۆڕان‌هاتوو، دەچەمێتەوە، دادێتەوە، دەنووشتێتەوە
"""),
// With short examples define "flexible", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Our plans need to be flexible enough to cater for the needs of everyone.""",
                      kurdishText:
                          """پلانەکانمان دەبێت هێندە لەگۆڕان‌هاتوو بن کە بۆ پێویستی هەموان بگونجێن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """My mother is fairly flexible about what time I need to be home.""",
                      kurdishText:
                          """دایکم زۆر نەرمە لەوەی چی کاتێک پێویستە لە ماڵەوە بم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەتوانین کاتی کارکردنی گۆڕاوت پێ بدەین.""",
                      englishNote:
                          "This means we can let you work different hours that fit your schedule.",
...
const double _startSecondsend = 000000000000000000000000000744;
const String _videoIdone = 'https://youtu.be/bHIhgxav9LY?t=';
const double _startSecondsone = 00000000000000000000000000085;
...
const String _videoIdfive = 'https://youtu.be/X3TAROotFfM?t=';
