...
class EnglishEntryfragment extends StatefulWidget {
  const EnglishEntryfragment({super.key});

  @override
  State<EnglishEntryfragment> createState() => _EnglishEntryfragmentState();
}

class _EnglishEntryfragmentState extends State<EnglishEntryfragment> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fragment (Derived forms: fragments)
1. A piece broken off or cut off of something else
"a fragment of rock"
 
2. A broken piece of a brittle artifact (= shard, sherd)
 
3. An incomplete piece
"fragments of a play"

- Verb: fragment (Derived forms: fragmented, fragmenting, fragments)
1. Break or cause to break into pieces (= break up, fragmentize, fragmentise [Brit])
"The plate fragmented";
""",
  );

  final String keyword = "fragment";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The shattered vase lay in fragments on the floor.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Police found fragments of glass near the scene.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I overheard a fragment of their conversation.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She could recall only fragments of his poetry.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His day was fragmented by meetings and phone calls.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fragment""",
                      // alsoEnglishWord: "also: fragment",
                      britshText: """IpaUK: /ˈfræɡmənt/""",
                      americanText: """IpaUS: /ˈfræɡmənt/""",
...
// With short examples define "fragment", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """گوڵدانەکە خاشبووەکە بە پارچەبووی لەسەر زەوییەکە کەوت بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پۆلیس پارچەی شووشەی لە نزیک شوێنی ڕووداوەکە دۆزییەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """گوێم لە بەشێکی گفتوگۆکەیان بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەنها بەش بەشی هۆنراوەکەیی بیردەهاتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕۆژەکەی دابەشبوو بەسەر چاوپێکەوتن و پەیوەندیی تەلەفۆنی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The satellite will fragment and burn up as it falls through the earth's atmosphere.""",
                      kurdishText:
                          """سەتەلایتەکە پارچەپارچە دەبێت و دەسووتێت کە دەکەوێتە ناو بارگەهەوای زەوی.""",
...
const double _startSecondsone = 0000000000000000000000000001040;
const String _videoIdtwo = 'https://youtu.be/1KgSp94nCZw?t=';
const double _startSecondstwo = 000000000000000000000000000225;
const String _videoIdthree = 'https://youtu.be/UvjSXBqQe4A?t=';
const double _startSecondsthree = 000000000000000000000000000639;
const String _videoIdfour = 'https://youtu.be/n-DTjpde9-0?t=';
