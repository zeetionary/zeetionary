...
class EnglishEntryironingboard extends StatefulWidget {
  const EnglishEntryironingboard({super.key});

  @override
  State<EnglishEntryironingboard> createState() =>
      _EnglishEntryironingboardState();
}

class _EnglishEntryironingboardState extends State<EnglishEntryironingboard> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: ironing board (Derived forms: ironing boards)
1. Narrow padded board on collapsible supports; used for ironing clothes
""",
  );

  final String keyword = "ironing board";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ironing board""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She needs a new cover for her old ironing board.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/rYaOZlBVmmk?t=';
    const double startSecondsend = 00000000000000000000000000057;
    const String videoIdone = 'https://youtu.be/4G3ntNytm9U?t=';
    const double startSecondsone = 000000000000000000000000000158;
    const String videoIdtwo = 'https://youtu.be/oP_C4SeHEm8?t=';
    const double startSecondstwo = 000000000000000000000000000742;
    const String videoIdthree = 'https://youtu.be/mQWlqt4xOY0?t=';
    const double startSecondsthree = 000000000000000000000000000253;
    const String videoIdfour = 'https://youtu.be/RgcTJJQ92jM?t=';
    const double startSecondsfour = 000000000000000000000000000325;
    const String videoIdfive = 'https://youtu.be/vgghAp0wknQ?t=';
    const double startSecondsfive = 0000000000000000000000000003239;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ironing board""",
                      // alsoEnglishWord: "also: ironing board",
                      britshText: """IpaUK: /ˈaɪənɪŋ bɔːd/""",
                      americanText: """IpaUS: /ˈaɪərnɪŋ bɔːrd/""",
...
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مێزێک کە پارچە جلێکی لەسەرە و دەنووشتێتەوە، و جلی لەسەر ئوتوو دەکەیت"""),
                    SentencesRow(
                      englishText:
                          """She needs a new cover for her old ironing board.""",
                      kurdishText:
                          """پێویستی بە بەرگێکی تازەیە بۆ مێزە ئوتووە کۆنەکەی.""",
