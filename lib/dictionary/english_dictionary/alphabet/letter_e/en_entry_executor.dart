...
class EnglishEntryexecutor extends StatefulWidget {
  const EnglishEntryexecutor({super.key});

  @override
  State<EnglishEntryexecutor> createState() => _EnglishEntryexecutorState();
}

class _EnglishEntryexecutorState extends State<EnglishEntryexecutor> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""executor""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """executor""",
                      // alsoEnglishWord: "also: executor",
                      britshText: """IpaUK: /ɪɡˈzekjətə(r)/""",
                      americanText: """IpaUS: /ɪɡˈzekjətər/""",
...
کوردی: سەروەسێت، وەسی، سەرپەرشت، ڕاسپێراو، ڕاپەڕێنەر، جێبەجی‌کەر
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کەسێک، بانکێک، هتد کە جێبەجێکاری وەسیەتی کەسێکە"""),
          SentencesRow(
            englishText: """She appointed him executor of her will.""",
            kurdishText: """وەک جێبەجێکاری وەسێتەکەی دیاری کرد.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          // skipped_meaning
          // const DividerDefinition(),
          // const DefinitionKurdish(text: """٢. (ناو) کەسێک کە شتێک بەرهەم دەهێنێت یان دەیهێنێتە بوون"""),
          // const DividerSentences(),
          // SentencesRow(
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: executor (Derived forms: executors)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/ill2cgCyTUc?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1123;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/f2kEGj-S1Tc?t=';
const double _startSecondsone = 00000000000000000000000000000; // 165;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/JqGCFfOhd-M?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 91;
const String _videoIdthree = 'VIDEOhttps://youtu.be/4M4HjCAdoAg?t=';
const double _startSecondsthree = 000000000000000000000000000; // 189;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/-m9p2Z5DqWY?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1298;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/W5Yst1Si3fw?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 750;
