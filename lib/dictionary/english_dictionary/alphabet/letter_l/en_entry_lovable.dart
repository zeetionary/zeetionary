...
class EnglishEntrylovable extends StatefulWidget {
  const EnglishEntrylovable({super.key});

  @override
  State<EnglishEntrylovable> createState() => _EnglishEntrylovableState();
}

class _EnglishEntrylovableState extends State<EnglishEntrylovable> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylovable lovable
WORD_WEB lovable lovable lovable
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lovable";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lovable""");
  }
...
کوردی: 
"""),
// With short examples define "lovable", please follow LX instructions
