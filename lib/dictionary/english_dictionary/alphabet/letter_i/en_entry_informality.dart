...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'akPZjOZZVNk';
    const double startSecondsend = 511;
    const String videoIdone = 'kUjcTNljZt0';
    const double startSecondsone = 52;
    const String videoIdtwo = 'BFKzX7u-3yg';
    const double startSecondstwo = 532;
    const String videoIdthree = 'pR0ph5r9jmw';
    const double startSecondsthree = 133;
    const String videoIdfour = 'EuNguMnSKnA';
    const double startSecondsfour = 680;
    const String videoIdfive = 'auQxY4ZEqP0';
