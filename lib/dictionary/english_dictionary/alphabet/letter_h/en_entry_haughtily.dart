...
class EnglishEntryhaughtily extends StatefulWidget {
  const EnglishEntryhaughtily({super.key});

  @override
  State<EnglishEntryhaughtily> createState() => _EnglishEntryhaughtilyState();
}

class _EnglishEntryhaughtilyState extends State<EnglishEntryhaughtily> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "haughtily";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""haughtily""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She stood up and haughtily walked across the room.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """haughtily""",
                      // alsoEnglishWord: "also: haughtily",
                      britshText: """IpaUK: /ˈhɔːtɪli/""",
                      americanText: """IpaUS: /ˈhɔːtɪli/""",
...
کوردی: لە ڕووی خۆبەزل‌زانی‌یەوە، لووت‌بەرزانە، تڕزلانە
"""),
// With short examples define "haughtily", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە ڕەفتارکردن بە ناشرینی لەگەڵ کەسانی دیکە چونکە پێتوایە لەوان باشتریت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: arrogantly"),
                    SentencesRow(
                      englishText:
                          """She stood up and haughtily walked across the room.""",
                      kurdishText:
                          """هەستایە سەر پێ و لووت‌بەرزانە بە ژوورەکەدا چوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Hhkw5kSx4D4?t=';
const double _startSecondsend = 000000000000000000000000000179;
const String _videoIdone = 'https://youtu.be/1NOGEzyyrRA?t=';
const double _startSecondsone = 0000000000000000000000000001662;
const String _videoIdtwo = 'https://youtu.be/QsWIRwlpJew?t=';
const double _startSecondstwo = 000000000000000000000000000173;
const String _videoIdthree = 'https://youtu.be/bZcRYQO4s70?t=';
const double _startSecondsthree = 000000000000000000000000000469;
const String _videoIdfour = 'https://youtu.be/EhVsUs0Pf6U?t=';
const double _startSecondsfour = 00000000000000000000000000029;
const String _videoIdfive = 'https://youtu.be/auQxY4ZEqP0?t=';
const double _startSecondsfive = 000000000000000000000000000659;
