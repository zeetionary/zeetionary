...
class EnglishEntryfatuous extends StatefulWidget {
  const EnglishEntryfatuous({super.key});

  @override
  State<EnglishEntryfatuous> createState() => _EnglishEntryfatuousState();
}

class _EnglishEntryfatuousState extends State<EnglishEntryfatuous> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fatuous""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fatuous""",
                      // alsoEnglishWord: "also: fatuous",
                      britshText: """IpaUK: /ˈfætʃuəs/""",
                      americanText: """IpaUS: /ˈfætʃuəs/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Their arguments are completely fatuous.""");
  }
...
// With short examples define "fatuous", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: کەر، گەوج، حەپە، نەفام، گەمژەڵ، دەبەنگ،	گەوجانە
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) گەمژە"""),
          SentencesRow(
            englishText:
                """Their arguments are completely fatuous.""",
            kurdishText: """مشتومڕەکانیان تەواو گەمژانەیە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fatuous
1. Showing a lack of intelligence or thought; stupid and silly (= asinine, inane)
"When passion and commitment are present but without intimacy, the experience is fatuous love";
""",
  );
...
const double _startSecondsend = 00000000000000000000000000097;
const String _videoIdone = 'https://youtu.be/Cqbleas1mmo?t=';
const double _startSecondsone = 000000000000000000000000000513;
const String _videoIdtwo = 'https://youtu.be/JXAG_SZ3gaU?t=';
const double _startSecondstwo = 00000000000000000000000000086;
const String _videoIdthree = 'https://youtu.be/To3DVfPf2-4?t=';
const double _startSecondsthree = 000000000000000000000000000322;
const String _videoIdfour = 'https://youtu.be/qE8PG2mpo58?t=';
const double _startSecondsfour = 000000000000000000000000000454;
const String _videoIdfive = 'https://youtu.be/QCjB4_0PYNQ?t=';
const double _startSecondsfive = 000000000000000000000000000169;
