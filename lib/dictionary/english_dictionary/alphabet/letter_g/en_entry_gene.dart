...
class EnglishEntrygene extends StatefulWidget {
  const EnglishEntrygene({super.key});

  @override
  State<EnglishEntrygene> createState() => _EnglishEntrygeneState();
}

class _EnglishEntrygeneState extends State<EnglishEntrygene> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The gene is passed on to their children.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gene""",
                      // alsoEnglishWord: "also: gene",
                      britshText: """IpaUK: /dʒiːn/""",
                      americanText: """IpaUS: /dʒiːn/""",
...
// With short examples define "gene", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """جینەکان کۆنترۆڵی گەشەی کۆرپەلە دەکەن.""",
