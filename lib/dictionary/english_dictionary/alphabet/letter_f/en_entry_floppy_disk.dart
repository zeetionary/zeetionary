...
class EnglishEntryfloppydisk extends StatefulWidget {
  const EnglishEntryfloppydisk({super.key});

  @override
  State<EnglishEntryfloppydisk> createState() => _EnglishEntryfloppydiskState();
}

class _EnglishEntryfloppydiskState extends State<EnglishEntryfloppydisk> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: floppy disk (Derived forms: floppy disks)
1. A small plastic magnetic disk enclosed in a stiff envelope with a radial slit; used to store data or programs for a microcomputer (= diskette, floppy)
"floppy disks are noted for their relatively slow speed and small capacity and low price";
""",
  );

  final String keyword = "floppy disk";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""floppy disk""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She found old files on a floppy disk in the drawer.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """floppy disk""",
                      // alsoEnglishWord: "also: floppy disk",
                      britshText: """IpaUK: /ˌflɒpi ˈdɪsk/""",
                      americanText: """IpaUS: /ˌflɑːpi ˈdɪsk/""",
...
کوردی: سێڵکی نەرم، نەرمە پەپکە، فلاپی، دیسکێت
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پەپکێک کە لە ناو پلاستیکدایە و زانیاری تێدەخرێت بۆ ئەوەی کۆمپیویتەر بیخوێنێتەوە"""),
                    SentencesRow(
                      englishText:
                          """She found old files on a floppy disk in the drawer.""",
                      kurdishText:
                          """فایلی کۆنی لە نەرمە پەپکێک دۆزییەوە لە چەکمەجەکەدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Ucd6QskoD_A?t=';
const double _startSecondsend = 000000000000000000000000000450;
const String _videoIdone = 'https://youtu.be/J-K2yeQylCk?t=';
const double _startSecondsone = 000000000000000000000000000330;
const String _videoIdtwo = 'https://youtu.be/AnjSjJOEfSc?t=';
const double _startSecondstwo = 00000000000000000000000000085;
const String _videoIdthree = 'https://youtu.be/TfzEPtLPnP4?t=';
const double _startSecondsthree = 000000000000000000000000000110;
const String _videoIdfour = 'https://youtu.be/AvXXkB2jic0?t=';
const double _startSecondsfour = 000000000000000000000000000302;
const String _videoIdfive = 'https://youtu.be/eO-PqYnTQXs?t=';
