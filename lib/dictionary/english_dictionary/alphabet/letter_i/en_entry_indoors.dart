...
class EnglishEntryindoors extends StatefulWidget {
  const EnglishEntryindoors({super.key});

  @override
  State<EnglishEntryindoors> createState() => _EnglishEntryindoorsState();
}

class _EnglishEntryindoorsState extends State<EnglishEntryindoors> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: indoors
1. Within a building (- inside)
"in winter we play indoors";
""",
  );

  final String keyword = "indoors";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indoors""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I prefer to stay indoors in this really hot weather.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She added that in Hong Kong most cats were kept indoors.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Let's go indoors.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001091;
    const String videoIdone = 'https://youtu.be/Ir3eJ1t13fk?t=';
    const double startSecondsone = 0000000000000000000000000003381;
    const String videoIdtwo = 'https://youtu.be/Is1IWMPNqh4?t=';
    const double startSecondstwo = 0000000000000000000000000001354;
    const String videoIdthree = 'https://youtu.be/u-gDURgeXUU?t=';
    const double startSecondsthree = 000000000000000000000000000286;
    const String videoIdfour = 'https://youtu.be/86Gy035z_KA?t=';
    const double startSecondsfour = 000000000000000000000000000105;
    const String videoIdfive = 'https://youtu.be/OOXZb0P1tsA?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indoors""",
                      // alsoEnglishWord: "also: indoors",
                      britshText: """IpaUK: /ˌɪnˈdɔːz/""",
                      americanText: """IpaUS: /ˌɪnˈdɔːrz/""",
...
کوردی: لە ماڵەوە، لە ژوورەوە، لەنێو ماڵ‌دا
"""),
// With short examples define "indoors", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) لە ناو یان بەرەو ناو بینایەک"""),
                    SentencesRow(
                      englishText:
                          """I prefer to stay indoors in this really hot weather.""",
                      kurdishText:
                          """پێم باشترە لە ژوورەوە بمێنمەوە لەم کەشە گەرمەدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەوەی گوت کە لە هۆنگ کۆنگ زۆرینەی پشیلە لە ژوورەوە دەهێڵدرێنەوە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Let's go indoors.""",
                      kurdishText: """با بچینە ژوورەوە.""",
