...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/VS6tnF31zr4?t=';
    const double startSecondsend = 000000000000000000000000000193;
    const String videoIdone = 'https://youtu.be/toVfvRhWbj8?t=';
    const double startSecondsone = 000000000000000000000000000239;
    const String videoIdtwo = 'https://youtu.be/nGrB-5ieeMU?t=';
    const double startSecondstwo = 000000000000000000000000000399;
    const String videoIdthree = 'https://youtu.be/Yt9sPsdml7g?t=';
    const double startSecondsthree = 000000000000000000000000000156;
    const String videoIdfour = 'https://youtu.be/C6Ni9rH6VmA?t=';
    const double startSecondsfour = 000000000000000000000000000206;
    const String videoIdfive = 'https://youtu.be/vp-8-WXeq-E?t=';
