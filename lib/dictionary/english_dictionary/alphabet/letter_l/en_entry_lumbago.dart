...
class EnglishEntrylumbago extends StatefulWidget {
  const EnglishEntrylumbago({super.key});

  @override
  State<EnglishEntrylumbago> createState() => _EnglishEntrylumbagoState();
}

class _EnglishEntrylumbagoState extends State<EnglishEntrylumbago> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylumbago lumbago
WORD_WEB lumbago lumbago lumbago
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lumbago";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lumbago""");
  }
...
کوردی: 
"""),
// With short examples define "lumbago", please follow LX instructions
