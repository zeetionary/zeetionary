...
class EnglishEntryinc extends StatefulWidget {
  const EnglishEntryinc({super.key});

  @override
  State<EnglishEntryinc> createState() => _EnglishEntryincState();
}

class _EnglishEntryincState extends State<EnglishEntryinc> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryinc inc
WORD_WEB inc inc inc
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "inc";
...
کوردی: 
"""),
// With short examples define "inc", please follow LX instructions
