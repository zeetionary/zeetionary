...
class EnglishEntryindecency extends StatefulWidget {
  const EnglishEntryindecency({super.key});

  @override
  State<EnglishEntryindecency> createState() => _EnglishEntryindecencyState();
}

class _EnglishEntryindecencyState extends State<EnglishEntryindecency> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: indecency (Derived forms: indecencies)
1. The quality of being indecent
 
2. An indecent or improper act (- impropriety)
""",
  );

  final String keyword = "indecency";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indecency""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He was appalled by the indecency of their songs.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He shouted indecencies at anyone who passed.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/9ZHVur0iX7M?t=';
    const double startSecondsend = 00000000000000000000000000038;
    const String videoIdone = 'https://youtu.be/HRi1Ee2iP0A?t=';
    const double startSecondsone = 000000000000000000000000000282;
    const String videoIdtwo = 'https://youtu.be/tdVv_Kws_0I?t=';
    const double startSecondstwo = 000000000000000000000000000276;
    const String videoIdthree = 'https://youtu.be/H7haxkYwAaU?t=';
    const double startSecondsthree = 0000000000000000000000000002362;
    const String videoIdfour = 'https://youtu.be/6NrYBa1id1E?t=';
    const double startSecondsfour = 000000000000000000000000000294;
    const String videoIdfive = 'https://youtu.be/njSSCBjnsbU?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indecency""",
                      // alsoEnglishWord: "also: indecency",
                      britshText: """IpaUK: /ɪnˈdiːsnsi/""",
                      americanText: """IpaUS: /ɪnˈdiːsnsi/""",
...
کوردی: هەرزەیی، ناشیرینی، بێ‌شەرمی، لێنەوەشاوەیی، دەم‌پیسی، کار یان قسەی ناحەز
"""),
// With short examples define "indecency", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕەفتارێک کە لەلایەنی ئەخلاقی یان سێکس بە خراپ دادەنرێت"""),
                    SentencesRow(
                      englishText:
                          """He was appalled by the indecency of their songs.""",
                      kurdishText: """تاسا بە بێ‌سەرمی گۆرانییەکانیان.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) کارێک، دەربڕینێک، هتد ـی ناشرین"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He shouted indecencies at anyone who passed.""",
                      kurdishText:
                          """دەمپیسی ڕوو لە هەر کەس دەکرد کە تێدەپەڕی.""",
