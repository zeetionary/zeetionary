...
class EnglishEntryhaphazardly extends StatefulWidget {
  const EnglishEntryhaphazardly({super.key});

  @override
  State<EnglishEntryhaphazardly> createState() =>
      _EnglishEntryhaphazardlyState();
}

class _EnglishEntryhaphazardlyState extends State<EnglishEntryhaphazardly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: haphazardly
1. In a random manner (- randomly, indiscriminately, willy-nilly, arbitrarily, at random, every which way)
"the houses were haphazardly scattered";
 
2. Without care; in a slapdash manner (- haphazard)
""",
  );

  final String keyword = "haphazardly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""haphazardly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Vehicles are parked haphazardly on the narrow streets.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """haphazardly""",
                      // alsoEnglishWord: "also: haphazardly",
                      britshText: """IpaUK: /hæpˈhæzədli/""",
                      americanText: """IpaUS: /hæpˈhæzərdli/""",
...
کوردی: ناڕێکانە، شپرزانە
"""),
// With short examples define "haphazardly", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) بەشێوەیەک کە ڕێکخراو نییە"""),
                    SentencesRow(
                      englishText:
                          """Vehicles are parked haphazardly on the narrow streets.""",
                      kurdishText:
                          """پێڕۆکان شپرزانە لە شەقامە تەسکەکان وەستێنراون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Udk8YHOy0EU?t=';
const double _startSecondsend = 000000000000000000000000000668;
const String _videoIdone = 'https://youtu.be/kTaYet07Ioo?t=';
const double _startSecondsone = 000000000000000000000000000843;
const String _videoIdtwo = 'https://youtu.be/1ykJaIhCIWg?t=';
const double _startSecondstwo = 000000000000000000000000000664;
const String _videoIdthree = 'https://youtu.be/1Y0F7zZ_Ws0?t=';
const double _startSecondsthree = 000000000000000000000000000854;
const String _videoIdfour = 'https://youtu.be/wNqxKmPNgko?t=';
const double _startSecondsfour = 000000000000000000000000000188;
const String _videoIdfive = 'https://youtu.be/a5MLuWgGYa4?t=';
const double _startSecondsfive = 00000000000000000000000000074;
