...
class EnglishEntryacid extends StatefulWidget {
  const EnglishEntryacid({super.key});

  @override
  State<EnglishEntryacid> createState() => _EnglishEntryacidState();
}

class _EnglishEntryacidState extends State<EnglishEntryacid> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acid""",
                      // alsoEnglishWord: "also: acid",
                      britshText: """IpaUK: /ˈæsɪd/""",
                      americanText: """IpaUS: /ˈæsɪd/""",
