                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "advise"), // Find /ədˈvaɪz/
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ədˈvaɪz/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakadvise("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ədˈvaɪz/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakadvise("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'ZCbAx9pZU7k';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '7jt-g00I9N0';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'NYQZx1irvYc';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'iXl0rCHpk60';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'n5CPMf5eC_s';
