...
class EnglishEntryinsoluble extends StatefulWidget {
  const EnglishEntryinsoluble({super.key});

  @override
  State<EnglishEntryinsoluble> createState() => _EnglishEntryinsolubleState();
}

class _EnglishEntryinsolubleState extends State<EnglishEntryinsoluble> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insoluble""");
  }
