...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'nmxELJUWFBw';
    const double startSecondsend = 179;
    const String videoIdone = 'gozU3CUIizs';
    const double startSecondsone = 679;
    const String videoIdtwo = '_qDIfaNIPYU';
    const double startSecondstwo = 54;
    const String videoIdthree = 'UAeJHAFjwPM';
    const double startSecondsthree = 374;
    const String videoIdfour = '1hQjWI-afE4';
    const double startSecondsfour = 66;
    const String videoIdfive = 's-C9GC59W3c';
