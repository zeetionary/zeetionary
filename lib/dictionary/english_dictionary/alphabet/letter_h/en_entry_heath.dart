...
class EnglishEntryheath extends StatefulWidget {
  const EnglishEntryheath({super.key});

  @override
  State<EnglishEntryheath> createState() => _EnglishEntryheathState();
}

class _EnglishEntryheathState extends State<EnglishEntryheath> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heath (Derived forms: heaths)
1. [Brit] A tract of level wasteland; uncultivated land with sandy soil and scrubby vegetation (- heathland [Brit])
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Wild ponies roam free on the heath.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heath""",
                      // alsoEnglishWord: "also: heath",
                      britshText: """IpaUK: /hiːθ/""",
                      americanText: """IpaUS: /hiːθ/""",
...
کوردی: 
"""),
// With short examples define "heath", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ناوچەیەک کە بۆ کشتووکاڵ بەکارنایەت و بە ڕووەکی دەشتی داپۆشراوە"""),
                    SentencesRow(
                      englishText: """Wild ponies roam free on the heath.""",
                      kurdishText:
                          """بەچکە ئەسپی کێوی بە ئازادی لەسەر جاڕەگیاگەسکەکە دەسووڕێنەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Jt3s6hvbs1U?t=';
const double _startSecondsend = 000000000000000000000000000433;
const String _videoIdone = 'https://youtu.be/CM_NCq1r2zg?t=';
const double _startSecondsone = 00000000000000000000000000049;
const String _videoIdtwo = 'https://youtu.be/4YPru6_sMZQ?t=';
const double _startSecondstwo = 000000000000000000000000000558;
const String _videoIdthree = 'https://youtu.be/PnTJ-nonTiM?t=';
const double _startSecondsthree = 000000000000000000000000000486;
const String _videoIdfour = 'https://youtu.be/DWemca-ljTM?t=';
const double _startSecondsfour = 0000000000000000000000000002746;
const String _videoIdfive = 'https://youtu.be/IYD7RO4vcFQ?t=';
const double _startSecondsfive = 0000000000000000000000000002142;
