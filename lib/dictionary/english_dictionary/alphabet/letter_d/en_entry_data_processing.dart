...
// """),
          const DefinitionKurdish(
              text:
                  "١. (ناو) زنجیرە کردارێک کە کۆمپیوتەرێک لەسەر داتا ئەنجامی دەدات بۆ بەرهەمهێنانی ئەنجام"),
          Row(
            children: [
              const Expanded(
                child: Column(
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/EkRRo5DN9lI?t=',
    startSeconds: 28,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/3hLmDS179YE?t=',
    startSeconds: 11317,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/hdwaWxY11jQ?t=',
    startSeconds: 560,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/SN8nTQiWOYY?t=',
    startSeconds: 1154,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
