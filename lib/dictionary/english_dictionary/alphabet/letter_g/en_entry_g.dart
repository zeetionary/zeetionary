...
class EnglishEntryg extends StatefulWidget {
  const EnglishEntryg({super.key});

  @override
  State<EnglishEntryg> createState() => _EnglishEntrygState();
}

class _EnglishEntrygState extends State<EnglishEntryg> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""‘Gold’ begins with (a) G.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Add 400g of sugar.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """g""",
                      // alsoEnglishWord: "also: g",
                      britshText: """IpaUK: /dʒiː/""",
                      americanText: """IpaUS: /dʒiː/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText: """‘Gold’ begins with (a) G/‘G’.""",
                      kurdishText: """وشەی 'Gold' بە 'G' دەست پێدەکات.""",
...
const String _videoIdthree = 'https://youtu.be/WDetHC86Dgo?t=';
const double _startSecondsthree = 00000000000000000000000000070;
const String _videoIdfour = 'https://youtu.be/1Gxrwh4zGPg?t=';
const double _startSecondsfour = 000000000000000000000000000382;
const String _videoIdfive = 'https://youtu.be/HAnw168huqA?t=';
const double _startSecondsfive = 0000000000000000000000000002066;
