...
class EnglishEntryfragrant extends StatefulWidget {
  const EnglishEntryfragrant({super.key});

  @override
  State<EnglishEntryfragrant> createState() => _EnglishEntryfragrantState();
}

class _EnglishEntryfragrantState extends State<EnglishEntryfragrant> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fragrant""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The sauce itself was fragrant and slightly sweet.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fragrant""",
                      // alsoEnglishWord: "also: fragrant",
                      britshText: """IpaUK: /ˈfreɪɡrənt/""",
                      americanText: """IpaUS: /ˈfreɪɡrənt/""",
...
// With short examples define "fragrant", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) هەبوونی بۆنی خۆش"""),
                    SentencesRow(
                      englishText:
                          """The air was fragrant with scents from the sea and the hills.""",
                      kurdishText:
                          """کەشەکە پڕ بوو لە بۆنی خۆشی دەریا و گردەکان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The sauce itself was fragrant and slightly sweet.""",
                      kurdishText: """سۆسەکە بۆنخۆش و کەمێک شیرین بوو.""",
