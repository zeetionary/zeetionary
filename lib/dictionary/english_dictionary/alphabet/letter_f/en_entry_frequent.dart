...
class EnglishEntryfrequent extends StatefulWidget {
  const EnglishEntryfrequent({super.key});

  @override
  State<EnglishEntryfrequent> createState() => _EnglishEntryfrequentState();
}

class _EnglishEntryfrequentState extends State<EnglishEntryfrequent> {
  @override
  void initState() {
    super.initState();
...
- Verb: frequent (Derived forms: frequented, frequenting, frequents)
1. Do one's shopping at; do business with; be a customer or client of (= patronize, patronise [Brit], shop, shop at, buy at, sponsor)
 
2. Be a regular visitor to a certain place (= haunt)
"She frequents the ballet";
""",
  );

  final String keyword = "frequent";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frequent""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He is a frequent visitor to this country.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her calls became less frequent.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There is a frequent bus service into the centre of town.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We met in a local bar much frequented by students.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Various native and migratory birds frequent this area.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frequent""",
                      // alsoEnglishWord: "also: frequent",
                      britshText: """IpaUK: /ˈfriːkwənt/""",
                      americanText: """IpaUS: /ˈfriːkwənt/""",
...
کوردی: زۆر، فرەهـ، فرە، فراوان، لەسەریەک، زووزوو، پەیتاپەیتا،	دووبارەوەبوو، پەستایی، چەندبارەوەبوو، ، چەندپاتە، زۆرڕووداو، پڕڕووداو، زۆرقەوماو،	ئاسایی، باو، هەمیشەیی
"""),
// With short examples define "frequent", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """سەردانکارێکی هەمیشەیی ئەم وڵاتەیە.""",
                    ...
                    SentencesRow(
                      englishText: """Her calls became less frequent.""",
                      kurdishText: """پەیوەندییەکانی کەمتر بوونەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خزمەتگوزاریی فراوانی پاس هەیە بۆ ناوجەرگەی شارەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە باڕێکی لۆکاڵی یەکیان دی کە خوێندکاران زۆر بۆی دەچوون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """چەندین باڵندەی خۆماڵی و کۆچەری هاتووچۆی ئەم ناوچەیە دەکەن.""",
...
const String _videoIdtwo = 'https://youtu.be/D8tPkb98Fkk?t=';
const double _startSecondstwo = 000000000000000000000000000298;
const String _videoIdthree = 'https://youtu.be/qg2nGY1aqlg?t=';
const double _startSecondsthree = 0000000000000000000000000001445;
const String _videoIdfour = 'https://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondsfour = 0000000000000000000000000004853;
