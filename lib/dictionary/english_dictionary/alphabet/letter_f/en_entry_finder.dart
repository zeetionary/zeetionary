...
class EnglishEntryfinder extends StatefulWidget {
  const EnglishEntryfinder({super.key});

  @override
  State<EnglishEntryfinder> createState() => _EnglishEntryfinderState();
}

class _EnglishEntryfinderState extends State<EnglishEntryfinder> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: finder (Derived forms: finders)
1. Someone who comes upon something after searching
 
2. Someone who is the first to observe something (= discoverer, spotter)
 
3. Optical device that helps a user to find the target of interest (= viewfinder, view finder)
""",
  );

  final String keyword = "finder";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """finder""",
                      // alsoEnglishWord: "also: finder",
                      britshText: """IpaUK: /ˈfaɪndə(r)/""",
                      americanText: """IpaUS: /ˈfaɪndər/""",
...
// With short examples define "finder", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """If the money remains unclaimed for a certain time it is returned to the finder.""",
                      kurdishText:
                          """ئەگەر پارەکە بۆ ماوەیەک بە بێ‌خاوەن مایەوە دەگەڕێندرێتەوە بۆ دۆزەرەوەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/p0jt4n92ZMY?t=';
const double _startSecondsend = 000000000000000000000000000265;
const String _videoIdone = 'https://youtu.be/oiLdWXLXDeA?t=';
const double _startSecondsone = 0000000000000000000000000001370;
const String _videoIdtwo = 'https://youtu.be/SsuWS6yE478?t=';
const double _startSecondstwo = 000000000000000000000000000378;
const String _videoIdthree = 'https://youtu.be/oIDU5o9uzxs?t=';
const double _startSecondsthree = 000000000000000000000000000177;
const String _videoIdfour = 'https://youtu.be/HjEqOWjTkHE?t=';
const double _startSecondsfour = 000000000000000000000000000598;
const String _videoIdfive = 'https://youtu.be/8MwkoYhZPmk?t=';
