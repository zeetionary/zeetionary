...
class EnglishEntryherein extends StatefulWidget {
  const EnglishEntryherein({super.key});

  @override
  State<EnglishEntryherein> createState() => _EnglishEntryhereinState();
}

class _EnglishEntryhereinState extends State<EnglishEntryherein> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: herein
1. In this place, thing or document
"I shall discuss the question herein"
""",
  );

  final String keyword = "herein";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """herein""",
                      // alsoEnglishWord: "also: herein",
                      britshText: """IpaUK: /ˌhɪərˈɪn/""",
                      americanText: """IpaUS: /ˌhɪrˈɪn/""",
...
کوردی: لێرەدا، ل ڤێرێ، لەم حەنە، لەم حاندە، لەم جێگایەدا، لەم شوێنە، لەم حاستە
"""),
// With short examples define "herein", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) لەم شوێنە، بەڵگەنامە، ڕاستییە، یان قسەدا"""),
                    SentencesRow(
                      englishText:
                          """Neither party is willing to compromise and herein lies the problem.""",
                      kurdishText:
                          """هیچ پارتێک ئامادەی سازان نییە و ئەمە کێشەکەیە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/cLmK2qrQDdU?t=';
const double _startSecondsend = 00000000000000000000000000035;
const String _videoIdone = 'https://youtu.be/pf6DcLlRaaw?t=';
const double _startSecondsone = 000000000000000000000000000708;
const String _videoIdtwo = 'https://youtu.be/sGOXHdf-_dM?t=';
const double _startSecondstwo = 000000000000000000000000000983;
const String _videoIdthree = 'https://youtu.be/Solb9uA-tgQ?t=';
const double _startSecondsthree = 0000000000000000000000000001204;
const String _videoIdfour = 'https://youtu.be/iQTZxUgt4Z8?t=';
const double _startSecondsfour = 0000000000000000000000000001451;
const String _videoIdfive = 'https://youtu.be/r0znjWhAhY4?t=';
