...
class EnglishEntryarchaeological extends StatelessWidget {
  ...
  Future<void> speakarchaeological(String languageCode) async {
    ...
    await flutterTts.speak("archaeological");
  }
  ...
  Future<void> speakarchaeological240(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("Further archaeological excavations are now being carried out.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "archaeological"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌɑːkiəˈlɒdʒɪkl/"),
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'Xnyju9RMG1s';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'tx7UlYB2qXM';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'RSOUrsU0A5A';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'BVCZOpGsFkM';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'VJjgFeGszT8';
  final double _startSeconds = 1;
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = '9JT14Oi7hLU';
