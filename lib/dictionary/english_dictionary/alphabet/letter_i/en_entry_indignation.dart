...
class EnglishEntryindignation extends StatefulWidget {
  const EnglishEntryindignation({super.key});

  @override
  State<EnglishEntryindignation> createState() =>
      _EnglishEntryindignationState();
}

class _EnglishEntryindignationState extends State<EnglishEntryindignation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: indignation (Derived forms: indignations)
1. Anger aroused by some perceived offence or injustice (- outrage)
"righteous indignation";
""",
  );

  final String keyword = "indignation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indignation""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The rise in train fares has aroused public indignation.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/yE-8iTNMlro?t=';
    const double startSecondsend = 0000000000000000000000000001270;
    const String videoIdone = 'https://youtu.be/2nw_jXM1nUk?t=';
    const double startSecondsone = 00000000000000000000000000056;
    const String videoIdtwo = 'https://youtu.be/WrKwysaZIww?t=';
    const double startSecondstwo = 000000000000000000000000000728;
    const String videoIdthree = 'https://youtu.be/8AHOgvsno5Q?t=';
    const double startSecondsthree = 000000000000000000000000000579;
    const String videoIdfour = 'https://youtu.be/6521a_4tUYA?t=';
    const double startSecondsfour = 000000000000000000000000000687;
    const String videoIdfive = 'https://youtu.be/qqLj6O9kXEQ?t=';
    const double startSecondsfive = 000000000000000000000000000668;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indignation""",
                      // alsoEnglishWord: "also: indignation",
                      britshText: """IpaUK: /ˌɪndɪɡˈneɪʃn/""",
                      americanText: """IpaUS: /ˌɪndɪɡˈneɪʃn/""",
...
کوردی: تووڕەیی، ڕق‌هەستان، غەییدین، ئاژر
"""),
// With short examples define "indignation", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هەستی تووڕەیی و سەرسامی چونکە هەست دەکەیت بە نادادی ڕەفتارت لەگەڵ کراوە"""),
                    SentencesRow(
                      englishText:
                          """The rise in train fares has aroused public indignation.""",
                      kurdishText:
                          """زیادبوونی کرێی شەمەندەفەر بووە بە هۆکاری تووڕەیی خەڵکی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The government expressed its indignation over the way the incident had been handled.""",
                      kurdishText:
                          """حکومەت تووڕەیی خۆی دەربڕی بەرامبەر بەوەی چۆن ڕووداوەکە مامەڵەی لەگەڵ کرابوو.""",
