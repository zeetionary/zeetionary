...
class EnglishEntryheartattack extends StatefulWidget {
  const EnglishEntryheartattack({super.key});

  @override
  State<EnglishEntryheartattack> createState() =>
      _EnglishEntryheartattackState();
}

class _EnglishEntryheartattackState extends State<EnglishEntryheartattack> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heart attack (Derived forms: heart attacks)
1. A sudden severe instance of abnormal heart function
""",
  );

  final String keyword = "heart attack";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heart attack""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She died of a massive heart attack.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He suffered a fatal heart attack while cycling.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heart attack""",
                      // alsoEnglishWord: "also: heart attack",
                      britshText: """IpaUK: /ˈhɑːt ətæk/""",
                      americanText: """IpaUS: /ˈhɑːrt ətæk/""",
...
// With short examples define "heart attack", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دۆخێکی تەندرووستی لەناکاو کە تێیدا چوونی خوێن بۆ دڵ دەوەستێت و هەندێک جار دەبێتە هۆکاری مەرگ"""),
                    SentencesRow(
                      englishText: """She died of a massive heart attack.""",
                      kurdishText: """بە جەڵدەیەکی لەناکاو مرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تووشی جەڵتەیەکی کوشندە بوو لە کاتی پاسکیلسواری.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/qjqh9UVfNNk?t=';
const double _startSecondsend = 000000000000000000000000000987;
const String _videoIdone = 'https://youtu.be/Pon4Zux5MaQ?t=';
const double _startSecondsone = 000000000000000000000000000348;
const String _videoIdtwo = 'https://youtu.be/5R65skWdg7Y?t=';
const double _startSecondstwo = 0000000000000000000000000002623;
const String _videoIdthree = 'https://youtu.be/mRj1RKh4xyY?t=';
const double _startSecondsthree = 000000000000000000000000000268;
const String _videoIdfour = 'https://youtu.be/HOBDzc1ME5M?t=';
const double _startSecondsfour = 00000000000000000000000000026;
const String _videoIdfive = 'https://youtu.be/57nZ7LaVAH0?t=';
const double _startSecondsfive = 000000000000000000000000000261;
