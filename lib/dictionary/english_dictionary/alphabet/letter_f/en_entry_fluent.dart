...
class EnglishEntryfluent extends StatefulWidget {
  const EnglishEntryfluent({super.key});

  @override
  State<EnglishEntryfluent> createState() => _EnglishEntryfluentState();
}

class _EnglishEntryfluentState extends State<EnglishEntryfluent> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fluent
1. Unconstrained and flowing smoothly in movement (= fluid, liquid, smooth)
"the fluent motion of a cat";
 
2. Speaking readily, clearly, and effectively (= eloquent, facile, silver, silver-tongued, smooth-spoken)
"able to dazzle with his fluent tongue";
""",
  );

  final String keyword = "fluent";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's fluent in Polish.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She's fluent in French.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He's a fluent Russian speaker.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He speaks fluent Italian.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Arsenal were no match for Barcelona's fluent passing.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fluent""",
                      // alsoEnglishWord: "also: fluent",
                      britshText: """IpaUK: /ˈfluːənt/""",
                      americanText: """IpaUS: /ˈfluːənt/""",
...
// With short examples define "fluent", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) هەبوونی توانای قسەکردن، خوێندنەوە، و نووسین بە زمانێک، بە تایبەتی زمانی بیانی، بە باشی"""),
                    SentencesRow(
                      englishText: """She's fluent in Polish.""",
                      kurdishText: """زمان‌پاراوە لە پۆڵەندی.""",
                    ...
                    SentencesRow(
                      englishText: """She's fluent in French.""",
                      kurdishText: """ڕەوانە لە فەرەنسی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He's a fluent Russian speaker.""",
                      kurdishText: """ئاخێوەرێکی ڕەوانی ڕووسییە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەرسناڵ هیچ ڕکابەرێک نەبوون بۆ پاسدانی بارشلۆنا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/3C0BdIn6Hdo?t=';
const double _startSecondsend = 00000000000000000000000000021;
const String _videoIdone = 'https://youtu.be/L6QJS8djygk?t=';
const double _startSecondsone = 000000000000000000000000000660;
const String _videoIdtwo = 'https://youtu.be/jfhEbHJoZZ8?t=';
const double _startSecondstwo = 000000000000000000000000000324;
const String _videoIdthree = 'https://youtu.be/fgfqV6SJyHo?t=';
const double _startSecondsthree = 000000000000000000000000000137;
const String _videoIdfour = 'https://youtu.be/mBbOF8LVCj4?t=';
const double _startSecondsfour = 000000000000000000000000000375;
const String _videoIdfive = 'https://youtu.be/b5fNif_WGdc?t=';
const double _startSecondsfive = 00000000000000000000000000076;
