...
// replace these: replace EnglishEntryamusing - replace speakAmusing - replace amusing - /əˈmjuːzɪŋ/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryamusing extends StatelessWidget {
  EnglishEntryamusing({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAmusing(String languageCode) async {
    // DOPSUM: CHANGE speakAmusing
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("amusing"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAmusing7603(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("I didn't find the joke at all amusing."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "amusing"), // DOPSUM: CHANGE WORD ENTRY - Find /əˈmjuːzɪŋ/
                            // divvviiider
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /əˈmjuːzɪŋ/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                            CustomIconButtonBritish(
                              onPressed: () =>
                                  speakAmusing(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /əˈmjuːzɪŋ/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                            CustomIconButtonAmerican(
                              onPressed: () => speakAmusing(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'GqWvv0aKeK4';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '6QDvJ7Vtfac';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'jJJ7YTt_C4M';
