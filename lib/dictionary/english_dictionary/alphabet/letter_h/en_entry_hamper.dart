...
class EnglishEntryhamper extends StatefulWidget {
  const EnglishEntryhamper({super.key});

  @override
  State<EnglishEntryhamper> createState() => _EnglishEntryhamperState();
}

class _EnglishEntryhamperState extends State<EnglishEntryhamper> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: hamper (Derived forms: hampered, hampers, hampering)
1. Prevent the progress or free movement of (- halter, cramp, strangle)
"He was hampered in his efforts by the bad weather";
 
2. Put at a disadvantage (- handicap, hinder)
"The brace I have to wear is hampering my movements";

- Noun: hamper (Derived forms: hampers)
1. A restraint that confines or restricts freedom (especially something used to tie down or restrain a prisoner) (- shackle, bond, trammel)
 
2. A basket usually with a cover
""",
  );

  final String keyword = "hamper";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""High winds hampered the rescue attempt.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Our efforts were severely hampered by a lack of money.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hamper""",
                      // alsoEnglishWord: "also: hamper",
                      britshText: """IpaUK: /ˈhæmpə(r)/""",
                      americanText: """IpaUS: /ˈhæmpər/""",
