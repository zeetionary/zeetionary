...
class EnglishEntryhesitancy extends StatefulWidget {
  const EnglishEntryhesitancy({super.key});

  @override
  State<EnglishEntryhesitancy> createState() => _EnglishEntryhesitancyState();
}

class _EnglishEntryhesitancyState extends State<EnglishEntryhesitancy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hesitancy (Derived forms: hesitancies)
1. A feeling of diffidence and indecision about doing something (- hesitance)
 
2. A certain degree of unwillingness (- reluctance, hesitation, disinclination, indisposition)
"his hesitancy revealed his basic indisposition";
""",
  );

  final String keyword = "hesitancy";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hesitancy""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I noticed a certain hesitancy in his voice.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hesitancy""",
                      // alsoEnglishWord: "also: hesitancy",
                      britshText: """IpaUK: /ˈhezɪtənsi/""",
                      americanText: """IpaUS: /ˈhezɪtənsi/""",
...
کوردی: دوودڵی، دڕدۆنگی، شک، گیر، گومان، بەگومانی، نادڵنیایی
"""),
// With short examples define "hesitancy", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هێواش یان نەبوونی دڵنیایی لە کردن یان گوتنی شتێک"""),
                    SentencesRow(
                      englishText:
                          """I noticed a certain hesitancy in his voice.""",
                      kurdishText: """تێبینی دوودڵی تەواوم کرد لە دەنگیدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/KXRtNwUju5g?t=';
const double _startSecondsend = 000000000000000000000000000327;
const String _videoIdone = 'https://youtu.be/ht7MNqZT_hU?t=';
const double _startSecondsone = 0000000000000000000000000001159;
const String _videoIdtwo = 'https://youtu.be/z78QLNFAIhk?t=';
const double _startSecondstwo = 0000000000000000000000000001808;
const String _videoIdthree = 'https://youtu.be/bWLGTB0coec?t=';
const double _startSecondsthree = 0000000000000000000000000005;
const String _videoIdfour = 'https://youtu.be/WALpdDTyj8o?t=';
const double _startSecondsfour = 000000000000000000000000000505;
const String _videoIdfive = 'https://youtu.be/O4stI2TVPIc?t=';
const double _startSecondsfive = 000000000000000000000000000907;
