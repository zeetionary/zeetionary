...
class EnglishEntryflexibility extends StatefulWidget {
  const EnglishEntryflexibility({super.key});

  @override
  State<EnglishEntryflexibility> createState() => _EnglishEntryflexibilityState();
}

class _EnglishEntryflexibilityState extends State<EnglishEntryflexibility> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flexibility (Derived forms: flexibilities)
1. The property of being flexible; easily bent or shaped (= flexibleness)
 
2. The quality of being adaptable or variable (= flexibleness)
"he enjoyed the flexibility of his working arrangement";
 
3. The trait of being easily persuaded (= tractability, tractableness)
""",
  );

  final String keyword = "flexibility";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flexibility""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The new system offers a much greater degree of flexibility in the way work is organized.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Plastic is more suitable because of its flexibility.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flexibility""",
                      // alsoEnglishWord: "also: flexibility",
                      britshText: """IpaUK: /ˌfleksəˈbɪləti/""",
                      americanText: """IpaUS: /ˌfleksəˈbɪləti/""",
...
کوردی: نەرمی، لەداهاتنەوەهاتوویی، داهاتوویی، جیری، بگۆڕی، لەگۆڕان‌هاتوویی
"""),
// With short examples define "flexibility", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) توانای گۆڕان بۆ گونجان لەگەڵ دۆخی تازە"""),
                    SentencesRow(
                      englishText:
                          """The new system offers a much greater degree of flexibility in the way work is organized.""",
                      kurdishText: """سیستەمە تازەکە ڕێژەیەکی زۆر زیاتری گۆڕان دابین دەکات بۆ ئەو شێوازەی کار ڕێکدەخرێت.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) توانای چەمانەوە بە ئاسانی بەبێ شکان"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Plastic is more suitable because of its flexibility.""",
                      kurdishText: """پلاستیک گونجاوترە بەهۆی نەرمییەکەی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/c65wnT5hM5w?t=';
const double _startSecondsend = 000000000000000000000000000153;
const String _videoIdone = 'https://youtu.be/oBcxuzdP3rs?t=';
const double _startSecondsone = 000000000000000000000000000417;
const String _videoIdtwo = 'https://youtu.be/9yjZpBq1XBE?t=';
const double _startSecondstwo = 0000000000000000000000000003356;
const String _videoIdthree = 'https://youtu.be/VYJtb2YXae8?t=';
const double _startSecondsthree = 000000000000000000000000000166;
const String _videoIdfour = 'https://youtu.be/Ir3eJ1t13fk?t=';
const double _startSecondsfour = 0000000000000000000000000003547;
const String _videoIdfive = 'https://youtu.be/TlNzKjxCIK4?t=';
