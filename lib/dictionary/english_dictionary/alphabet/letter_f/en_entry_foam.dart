...
class EnglishEntryfoam extends StatefulWidget {
  const EnglishEntryfoam({super.key});

  @override
  State<EnglishEntryfoam> createState() => _EnglishEntryfoamState();
}

class _EnglishEntryfoamState extends State<EnglishEntryfoam> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foam (Derived forms: foams)
1. A mass of small bubbles formed in or on a liquid (= froth)
"the beer had a thick head of foam";
 
2. A lightweight material in cellular form; made by introducing gas bubbles during manufacture

- Verb: foam (Derived forms: foamed, foaming, foams)
1. Become bubbly, frothy or foaming (= froth, fizz, effervesce, sparkle, form bubbles)
"The river was foaming";
""",
  );

  final String keyword = "foam";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The foam mattress molds to your body shape.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The waves left the beach covered with foam.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The fire extinguisher directs foam onto the fire.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The toothpaste foamed in his mouth.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foam""",
                      // alsoEnglishWord: "also: foam",
                      britshText: """IpaUK: /fəʊm/""",
                      americanText: """IpaUS: /fəʊm/""",
...
کوردی: کەف، سەرکەف، سەرکوڵ، دەوژن،	هەور، ئەبر
"""),
// With short examples define "foam", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مادەیەکی لاستیکی سووک کە کونی زۆری تێدایە و بۆ درووستکردنی جێگای دانیشتن، پێخەف، هتد بەکاردێت"""),
                    SentencesRow(
                      englishText:
                          """The foam mattress molds to your body shape.""",
                      kurdishText:
                          """پێخەفە ئسفەنجەکە لەگەڵ شێوەی جەستەت دەگونجێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """شەپۆلەکان کەنارەکەیان پڕ کرد لە کەف.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) مادەیەکی کیمیایی کە وەک کرێم وەهایە و ڕێژەیەکی زۆر لە کەفی نەرم درووست دەکات و بۆ تەراش، ششتن، هتد بەکاردێت، یان بۆ کوژاندنەوەی ئاگر"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The fire extinguisher directs foam onto the fire.""",
                      kurdishText: """ئاگر کوژێنەرەوەکە کەف دەگرێتە ئاگرەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەویرە ددانەکە بوو بە کەف لە دەمیدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Kou7ur5xt_4';
...
const String _videoIdtwo = 'https://youtu.be/kGg44zdgHYM?t=';
...
const String _videoIdfour = 'https://youtu.be/CJUKVmkRx_E?t=';
const double _startSecondsfour = 000000000000000000000000000107;
const String _videoIdfive = 'https://youtu.be/erDE9B-X7mk?t=';
