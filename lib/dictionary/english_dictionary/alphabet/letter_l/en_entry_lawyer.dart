...
class EnglishEntrylawyer extends StatefulWidget {
  const EnglishEntrylawyer({super.key});

  @override
  State<EnglishEntrylawyer> createState() => _EnglishEntrylawyerState();
}

class _EnglishEntrylawyerState extends State<EnglishEntrylawyer> {
  @override
  void initState() {
    super.initState();
