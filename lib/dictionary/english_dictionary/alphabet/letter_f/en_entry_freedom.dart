...
class EnglishEntryfreedom extends StatefulWidget {
  const EnglishEntryfreedom({super.key});

  @override
  State<EnglishEntryfreedom> createState() => _EnglishEntryfreedomState();
}

class _EnglishEntryfreedomState extends State<EnglishEntryfreedom> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: freedom (Derived forms: freedoms)
1. The condition of being free; the power to act, speak or think without externally imposed restraints
 
2. Immunity from an obligation or duty (= exemption)
""",
  );

  final String keyword = "freedom";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""freedom""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Press freedom is under attack.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""All groups enjoyed religious freedom.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""As a society we value personal freedom and privacy.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We just want freedom of choice.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Everyone has the right to freedom of expression.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He finally won his freedom after twenty years in jail.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We believe in freedom and democracy.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was a champion of Irish freedom.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The skirt has a side split for freedom of movement.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""All people should be guaranteed freedom from fear.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """freedom""",
                      // alsoEnglishWord: "also: freedom",
                      britshText: """IpaUK: /ˈfriːdəm/""",
                      americanText: """IpaUS: /ˈfriːdəm/""",
...
کوردی: ئازادی، سەربەستی، سەرازایی، سەربەخۆیی، بەڕەڵایی، نەگیراوی، ناکۆیلەیی، ڕزگاری،	مافی بەکارهێنان، بەکارهێنانی ناسنوورداری شتێ،	مافی ڕامیاری،	ماف،	مافی جیابوونەوە یان تەڵاق،	قسەلەڕوویی
"""),
// With short examples define "freedom", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئازادیی میدیا لە ژێر مەترسییە.""",
                    ...
                    SentencesRow(
                      englishText: """All groups enjoyed religious freedom.""",
                      kurdishText: """هەموو گرووپەکان ئازادیی ئاینییان هەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وەک کۆمەڵگایەک ئێمە بەهای ئازادی و زانیاریی کەسی دەزانین.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We just want freedom of choice.""",
                      kurdishText: """تەنها ئازادیی هەڵبژاردنمان دەوێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەموان مافی ئازادیی دەربڕینیان هەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە دوای بیست ساڵ لە زیندانی لە کۆتاییدا ئازادیی بەدەستهێنا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Many slaves who gained their freedom lost it again after the war.""",
                      kurdishText:
                          """زۆر کۆیلە کە ئازادییان بەدەستهێنا دووبارە لەدەستیان دایەوە لە دوای جەنگەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """باوەڕمان بە ئازادی و دیموکراسی هەیە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He was a champion of Irish freedom.""",
                      kurdishText: """پاڵەوانێکی ئازادیی ئێرلەندا بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەنوورەکە فەتحێکی تێدایە بۆ ئازادیی جووڵە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەموان دەبێت ئازادییان لە ترس بۆ بەروەرار بکرێت.""",
...
const double _startSecondsend = 0000000000000000000000000001275;
const String _videoIdone = 'https://youtu.be/zqllxbPWKNI?t=';
const double _startSecondsone = 0000000000000000000000000001094;
...
const double _startSecondsthree = 000000000000000000000000000469;
const String _videoIdfour = 'https://youtu.be/UuGpm01SPcA?t=';
const double _startSecondsfour = 000000000000000000000000000535;
const String _videoIdfive = 'https://youtu.be/55XJ1ObZKaM?t=';
const double _startSecondsfive = 0000000000000000000000000001015;
