...
class EnglishEntryastronomy extends StatelessWidget {
  ...
  Future<void> speakastronomy(String languageCode) async {
    ...
    await flutterTts.speak("astronomy");
  }
  ...
  Future<void> speakastronomy456(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Astronomy is one of the oldest sciences.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "astronomy"),
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈstrɒnəmi/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈstrɑːnəmi/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakastronomy456("en-US"),
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'SSNkuqD_ZbQ';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'xPFqWkUx0NI';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'Jdy09y0A4t0';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'g1TtmoPOUws';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '-FYvy3_egHw';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'IfqBQOxqALQ';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '1ToESJjKen8';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'h-MyGNyX4Zw';
  final double _startSeconds = 1;
