...
class EnglishEntrycannibal extends StatelessWidget {
// blank divider
  EnglishEntrycannibal({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcannibal(String languageCode) async {
    // DOPSUM: CHANGE speakcannibal
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "cannibal"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈkænɪbl/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcannibal("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈkænɪbl/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcannibal("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'FSX9unLd62Q';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'hW2fMCdauTM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'hAHDxczzwMc';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'n6lo1j9_2cU';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'oBkUUr_LK7Q';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'HRNravHcb_Q';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'krQr6mDkaS4';
...
class _YoutubeEmbeddednineState extends State<YoutubeEmbeddednine> {
  ...
  final String _videoId = '1hZIHoFvkws';
...
class _YoutubeEmbeddedtenState extends State<YoutubeEmbeddedten> {
  late YoutubePlayerController _controller;
  final String _videoId = 'GUPLHI0BDPs';
