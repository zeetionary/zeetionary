...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'eKVkQqFeTsQ';
    const double startSecondsone = 60;
    const String videoIdtwo = 'lyEQCYnYbyU';
    const double startSecondstwo = 537;
    const String videoIdthree = 'gfabA0KdniY';
    const double startSecondsthree = 304;
    const String videoIdfour = 'ohzFHI3PIW4';
    const double startSecondsfour = 0;
    const String videoIdfive = 'dFIBwOSnih0';
    const double startSecondsfive = 2211;
