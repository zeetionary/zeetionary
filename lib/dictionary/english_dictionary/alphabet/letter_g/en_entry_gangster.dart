...
class EnglishEntrygangster extends StatefulWidget {
  const EnglishEntrygangster({super.key});

  @override
  State<EnglishEntrygangster> createState() => _EnglishEntrygangsterState();
}

class _EnglishEntrygangsterState extends State<EnglishEntrygangster> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gangster (Derived forms: gangsters)
1. A criminal who is a member of gang (- mobster)
""",
  );

  final String keyword = "gangster";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gangster""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He was known as a notorious gangster in the city.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gangster""",
                      // alsoEnglishWord: "also: gangster",
                      britshText: """IpaUK: /ˈɡæŋstə(r)/""",
                      americanText: """IpaUS: /ˈɡæŋstər/""",
...
"""),
                    const DefinitionKurdish(
                        text: """١. (ناو) ئەندامێکی گرووپێکی تاوانکاری"""),
                    SentencesRow(
                      englishText:
                          """He was known as a notorious gangster in the city.""",
                      kurdishText:
                          """لە شارەکەدا وەک تاوانکارێکی بەدناو ناسراوبوو.""",
...
const String _videoIdone = 'https://youtu.be/_UyjnR-XBtU?t=';
const double _startSecondsone = 0000000000000000000000000004000;
const String _videoIdtwo = 'https://youtu.be/7REVysZgqhs?t=';
const double _startSecondstwo = 00000000000000000000000000052;
const String _videoIdthree = 'https://youtu.be/NysITFb_Wbs?t=';
const double _startSecondsthree = 00000000000000000000000000044;
const String _videoIdfour = 'https://youtu.be/ZZDDbqWze3M?t=';
const double _startSecondsfour = 00000000000000000000000000085;
const String _videoIdfive = 'https://youtu.be/ZL1fg9UCVIQ?t=';
