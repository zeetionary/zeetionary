...
class EnglishEntryenrich extends StatefulWidget {
  const EnglishEntryenrich({super.key});

  @override
  State<EnglishEntryenrich> createState() => _EnglishEntryenrichState();
}

class _EnglishEntryenrichState extends State<EnglishEntryenrich> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enrich""",
                      // alsoEnglishWord: "also: enrich",
                      britshText: """IpaUK: /ɪnˈrɪtʃ/""",
                      americanText: """IpaUS: /ɪnˈrɪtʃ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The study of science has enriched all our lives.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Reading good literature can enrich all our lives.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Most breakfast cereals are enriched with vitamins.""");
  }
...
کوردی: دەوڵەمەند کردن، بەپێز کردن، بەپیت کردن
"""),
          const DefinitionKurdish(
              text: """١. (کردار) باشترکردنی کوالێتیی شتێک """),
          SentencesRow(
            englishText: """The study of science has enriched all our lives.""",
            kurdishText: """توێژینەوە لە زانست ژیانمانی باشتر کردووە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """خوێندنەوەی وێژەی باش دەکرێت ژیانی هەموومان دەوڵەمەند بکات.""",
          ...
          SentencesRow(
            ...
            kurdishText: """زۆرینەی خواردنی بەیانی ڤیتامینیان تێدەکرێت.""",
          ...
          SentencesRow(
            ...
            kurdishText: """پێگەکەی بەکارهێنا بۆ دەوڵەمەندکردنی.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: enrich (Derived forms: enriching, enriches, enriched)
...
3. (farming) provide with fertilizers or add nutrients to (= fertilize, fertilise [Brit], feed)
""",
  );
...
const String _videoIdone = 'https://youtu.be/_Q0FYoCl4Cs?t=';
const double _startSecondsone = 47;
const String _videoIdtwo = 'https://youtu.be/Gi3HnqetpLw?t=';
const double _startSecondstwo = 750;
const String _videoIdthree = 'https://youtu.be/KbNRvWfndjA?t=';
const double _startSecondsthree = 185;
const String _videoIdfour = 'https://youtu.be/w6TxH8ha8XU?t=';
const double _startSecondsfour = 156;
const String _videoIdfive = 'https://youtu.be/jBnWZijMbMY?t=';
const double _startSecondsfive = 289;
const String _videoIdsix = 'https://youtu.be/g09731mD-s8?t=';
const double _startSecondssix = 61;
