...
class EnglishEntryenfold extends StatefulWidget {
  const EnglishEntryenfold({super.key});

  @override
  State<EnglishEntryenfold> createState() => _EnglishEntryenfoldState();
}

class _EnglishEntryenfoldState extends State<EnglishEntryenfold> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enfold""",
                      // alsoEnglishWord: "also: enfold",
                      britshText: """IpaUK: /ɪnˈfəʊld/""",
                      americanText: """IpaUS: /ɪnˈfəʊld/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She lay quietly, enfolded in his arms.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Darkness spread and enfolded him.""");
  }
...
// """),
          const DefinitionKurdish(
              text: """١. (کردار) لە باوەش گرتن بە سۆزەوە"""),
          SentencesRow(
            englishText: """She lay quietly, enfolded in his arms.""",
            kurdishText: """بە بێ‌دەنگی دانیشتبوو لە باوەشیدا.""",
          ...
          SentencesRow(
            ...
            kurdishText: """لوتکەکە بە هەوریکی سپی دەوردرا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: enfold (Derived forms: enfolded, enfolding, enfolds)
1. Surround, cover or wrap completely (= envelop, enwrap, wrap, enclose)
"Fog enfolded the house";
""",
  );
...
const double _startSecondsend = 18396;
const String _videoIdone = 'https://youtu.be/oDDwjhxASqA?t=';
const double _startSecondsone = 453;
const String _videoIdtwo = 'https://youtu.be/3_YpuIBtAAY?t=';
const double _startSecondstwo = 3912;
const String _videoIdthree = 'https://youtu.be/ZvF_Sk9mRhg?t=';
const double _startSecondsthree = 551;
const String _videoIdfour = 'https://youtu.be/TXKeqco1yR4?t=';
const double _startSecondsfour = 3716;
const String _videoIdfive = 'https://youtu.be/0uZXtzx8I9M?t=';
const double _startSecondsfive = 103;
const String _videoIdsix = 'https://youtu.be/-0aYKWH_VHA?t=';
const double _startSecondssix = 387;
