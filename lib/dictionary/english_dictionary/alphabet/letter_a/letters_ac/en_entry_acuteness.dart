...
class EnglishEntryacuteness extends StatefulWidget {
  const EnglishEntryacuteness({super.key});

  @override
  State<EnglishEntryacuteness> createState() => _EnglishEntryacutenessState();
}

class _EnglishEntryacutenessState extends State<EnglishEntryacuteness> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "acuteness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""acuteness""");
  }
  ...
  Future<void> speakacuten524(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("He is remembered for the acuteness of his intellect.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acuteness""",
                      // alsoEnglishWord: "also: acuteness",
                      britshText: """IpaUK: /əˈkjuːtnəs/""",
                      americanText: """IpaUS: /əˈkjuːtnəs/""",
...
١. (ناو) ڕێژەی کوشندەیی و سەختی شتێک"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakacute2471("en-US"),
                          ),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٢. (ناو) ڕێژەی ھەستیاریی ھەستێک"""),
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakacuten524("en-US"),
                          ),
                        ],
                      ),
                    ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'MT13cEfHzMs';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'q85KLUl2x-g';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '_1VmCh2QIpE';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'u-4-SSTu0RA';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'E0l7sZ_T5dE';
