...
class EnglishEntryfoothill extends StatefulWidget {
  const EnglishEntryfoothill({super.key});

  @override
  State<EnglishEntryfoothill> createState() => _EnglishEntryfoothillState();
}

class _EnglishEntryfoothillState extends State<EnglishEntryfoothill> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foothill (Derived forms: foothills)
1. A relatively low hill on the lower slope of a mountain
""",
  );

  final String keyword = "foothill";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foothill""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Villages dot the foothills of the Himalayas.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foothill""",
                      // alsoEnglishWord: "also: foothill",
                      britshText: """IpaUK: /ˈfʊthɪl/""",
                      americanText: """IpaUS: /ˈfʊthɪl/""",
...
// With short examples define "foothill", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Villages dot the foothills of the Himalayas.""",
                      kurdishText:
                          """گوندەکان بە داوێنی زنجیرە چیای هێمالایایەوەن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/dNEp3hoHSDI?t=';
const double _startSecondsend = 000000000000000000000000000719;
const String _videoIdone = 'https://youtu.be/GBYvJgrf-Dk?t=';
const double _startSecondsone = 000000000000000000000000000518;
const String _videoIdtwo = 'https://youtu.be/vTEi5FFxMuE?t=';
const double _startSecondstwo = 000000000000000000000000000245;
const String _videoIdthree = 'https://youtu.be/MtgVXp8s2iU?t=';
const double _startSecondsthree = 000000000000000000000000000597;
const String _videoIdfour = 'https://youtu.be/uCpISJqUeEQ?t=';
const double _startSecondsfour = 00000000000000000000000000088;
const String _videoIdfive = 'https://youtu.be/pafA-RU3q7U?t=';
const double _startSecondsfive = 000000000000000000000000000332;
