...
class EnglishEntryliberation extends StatefulWidget {
  const EnglishEntryliberation({super.key});

  @override
  State<EnglishEntryliberation> createState() => _EnglishEntryliberationState();
}

class _EnglishEntryliberationState extends State<EnglishEntryliberation> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""liberation""");
  }
