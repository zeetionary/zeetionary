...
class EnglishEntryhearingaid extends StatefulWidget {
  const EnglishEntryhearingaid({super.key});

  @override
  State<EnglishEntryhearingaid> createState() => _EnglishEntryhearingaidState();
}

class _EnglishEntryhearingaidState extends State<EnglishEntryhearingaid> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hearing aid (Derived forms: hearing aids)
1. An electronic device that amplifies sound and is worn to compensate for poor hearing (- deaf-aid)
 
2. A conical acoustic device formerly used to direct sound to the ear of a hearing-impaired person (- ear trumpet)
""",
  );

  final String keyword = "hearing aid";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hearing aid""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The doctor recommended a new hearing aid for her.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hearing aid""",
                      // alsoEnglishWord: "also: hearing aid",
                      britshText: """IpaUK: /ˈhɪərɪŋ eɪd/""",
                      americanText: """IpaUS: /ˈhɪrɪŋ eɪd/""",
...
// """),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئامێرێکی بچووک کە دەخرێتە گوێوە و دەنگ بەرز دەکات بۆ ئەو کەسانەی باش نابیستن"""),
                    SentencesRow(
                      englishText:
                          """The doctor recommended a new hearing aid for her.""",
                      kurdishText:
                          """پزیشکەکە پێشنیاری ئامێرێکی تازەی بیستنی بۆی کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/hSmNg2WGXeQ?t=';
...
const String _videoIdtwo = 'https://youtu.be/eNpkhX85yf0?t=';
const double _startSecondstwo = 0000000000000000000000000002858;
const String _videoIdthree = 'https://youtu.be/UdgRUCVUts0?t=';
const double _startSecondsthree = 000000000000000000000000000446;
const String _videoIdfour = 'https://youtu.be/MbnLKQssfLc?t=';
const double _startSecondsfour = 00000000000000000000000000082;
const String _videoIdfive = 'https://youtu.be/CuKqMoWHt54';
