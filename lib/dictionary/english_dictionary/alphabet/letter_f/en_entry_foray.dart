...
class EnglishEntryforay extends StatefulWidget {
  const EnglishEntryforay({super.key});

  @override
  State<EnglishEntryforay> createState() => _EnglishEntryforayState();
}

class _EnglishEntryforayState extends State<EnglishEntryforay> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foray (Derived forms: forays)
1. A sudden short attack (= raid, maraud)
 
2. An initial attempt (especially outside your usual areas of competence)
"scientists' forays into politics"

- Verb: foray (Derived forms: forayed, foraying, forays)
1. Steal goods; take as spoils (= plunder, despoil, loot, reave [archaic], strip, rifle, ransack, pillage)
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foray""",
                      // alsoEnglishWord: "also: foray",
                      britshText: """IpaUK: /ˈfɒreɪ/""",
                      americanText: """IpaUS: /ˈfɔːreɪ/""",
...
کوردی: هێرشی کت‌وپڕ، پارێز، پەلامار، تەپ‌دانەسەر،	چەپاو، ڕاوڕووت، تاڵان
"""),
// With short examples define "foray", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هەوڵدان بۆ کارکردن لە چالاکییەک یان پیشەیەکی تازە"""),
                    SentencesRow(
                      englishText:
                          """She made a brief foray into acting before becoming a teacher.""",
                      kurdishText:
                          """پێش ئەوەی ببێتە مامۆستا، بۆ ماوەیەکی کورت دەستی دایە نواندن.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) هێرشی لەناکاوی ژمارەیەک سەرباز"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Those on the front line make regular forays into enemy territory.""",
                      kurdishText:
                          """ئەوانەی بەرەی پێشەوە هەڵمەتی لەناکاوی گەورە دەکەنە سەر ناوچەی دوژمن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I made a quick foray into town before lunch to get my sister a present.""",
                      kurdishText:
                          """سەردانێکی کورتی شارم کرد بۆ کڕینی دیارییەک بۆ خوشکەکەم.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/b_rjBWmc1iQ?t=';
const double _startSecondsend = 0000000000000000000000000004242;
const String _videoIdone = 'https://youtu.be/2POq39ce_5I?t=';
const double _startSecondsone = 000000000000000000000000000148;
const String _videoIdtwo = 'https://youtu.be/vOxFgZaD0tQ?t=';
const double _startSecondstwo = 0000000000000000000000000001384;
const String _videoIdthree = 'https://youtu.be/ajbooXnvsE8?t=';
const double _startSecondsthree = 0000000000000000000000000001688;
const String _videoIdfour = 'https://youtu.be/B-6ET2TUCgs';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/cvTchBdrqdw?t=';
