...
class EnglishEntryfundamental extends StatefulWidget {
  const EnglishEntryfundamental({super.key});

  @override
  State<EnglishEntryfundamental> createState() =>
      _EnglishEntryfundamentalState();
}

class _EnglishEntryfundamentalState extends State<EnglishEntryfundamental> {
  @override
  void initState() {
    super.initState();
...
1. Serving as an essential component (- cardinal, central, key, primal)
"an example that was fundamental to the argument"; "computers are fundamental to modern industrial structure";
 
2. Being or involving basic facts or principles (- rudimentary, underlying)
"the fundamental laws of the universe"; "a fundamental incompatibility between them";
 
3. Far-reaching and thoroughgoing in effect especially on the nature of something (- profound)
...
- Noun: fundamental (Derived forms: fundamentals)
...
2. The lowest tone of a harmonic series (- fundamental frequency, first harmonic)
""",
  );

  final String keyword = "fundamental";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fundamental""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This principle is absolutely fundamental.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I think they made a very fundamental mistake.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Hard work is fundamental to success.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Low interest rates are fundamental for growth.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He taught me the fundamentals of the job.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fundamental""",
                      // alsoEnglishWord: "also: fundamental",
                      britshText: """IpaUK: /ˌfʌndəˈmentl/""",
                      americanText: """IpaUS: /ˌfʌndəˈmentl/""",
...
کوردی: بنچینەیی، بنەمایی، بنەڕەتی، ناوەندی، بنگەهی، بناخەیی، ڕیشەیی، گرنگ، سەرەکی، بەرکەفتی، سەرەتایی، ئامادەکاری،	پێویست، پێدڤی،	گەوهەری، زاتی، خودایی، خۆماکی، کرۆکی، بنەماکان، بنچینەکان، بنچینان، ماکان noun بەشی بنەڕەتی، پشکی بنگەهی
"""),
// With short examples define "fundamental", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە زۆر گرنگە و کاریگەری لە شتە هەرە گرنگەکان دەکات"""),
                    SentencesRow(
                      englishText:
                          """This principle is absolutely fundamental.""",
                      kurdishText: """ئەم بەهایە تەواو بنچینەییە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """There is a fundamental difference between the two points of view.""",
                      kurdishText:
                          """جیاوازییەکی بنچینەیی هەیە لە نێوان دوو لایەنەکەی بیرکردنەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """A fundamental change in the organization of health services was required.""",
                      kurdishText:
                          """گۆڕانی بنچینەیی لە ڕێکخستنی خزمەتگوزارییە تەندرووستییەکان پێویست بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پێموایە هەڵەیەکی زۆر بنچینەییان کرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە بەشی سەرەکیی شتێک پێکدەهێنێت"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کەمی ئاستی سوو بناغەیە بۆ گەشە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵناو) بەشێکی گرنگ؛ یاسا یان بەهایەکی بنچینەیی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He taught me the fundamentals of the job.""",
                      kurdishText: """شتە بنچینەییەکانی کارەکەی پێگوتم.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/rEdl2Uetpvo?t=';
const double _startSecondsend = 000000000000000000000000000150;
...
const String _videoIdthree = 'https://youtu.be/VvJm4pQZ04s?t=';
const double _startSecondsthree = 000000000000000000000000000347;
const String _videoIdfour = 'https://youtu.be/toVfvRhWbj8?t=';
const double _startSecondsfour = 0000000000000000000000000001302;
const String _videoIdfive = 'https://youtu.be/_0RTH57v66I?t=';
