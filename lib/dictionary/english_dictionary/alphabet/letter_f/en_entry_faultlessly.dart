...
class EnglishEntryfaultlessly extends StatefulWidget {
  const EnglishEntryfaultlessly({super.key});

  @override
  State<EnglishEntryfaultlessly> createState() =>
      _EnglishEntryfaultlesslyState();
}

class _EnglishEntryfaultlesslyState extends State<EnglishEntryfaultlessly> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""faultlessly""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """faultlessly""",
                      // alsoEnglishWord: "also: faultlessly",
                      britshText: """IpaUK: /ˈfɔːltləsli/""",
                      americanText: """IpaUS: /ˈfɔːltləsli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "faultlessly";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The engine performed faultlessly.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He drove the car faultlessly.""");
  }
...
// With short examples define "faultlessly", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: بێ‌خەوشانە، بێگەردانە
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵکار) بەشێوەیەک کە هەڵەی نییە"""),
          SentencesRow(
            englishText: """The engine performed faultlessly.""",
            kurdishText: """بزوێنەرەکە بەبێ کێشە کاری کرد.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He drove the car faultlessly.""",
            kurdishText: """بێ کێشە ئۆتۆمبێلەکەی لێخوڕی.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: faultlessly
1. Without a fault; in a faultless manner
...
const String _videoIdend = 'https://youtu.be/06vvAAEXFqc?t=';
const double _startSecondsend = 000000000000000000000000000676;
const String _videoIdone = 'https://youtu.be/QyGZ7DuuEY4?t=';
const double _startSecondsone = 0000000000000000000000000001274;
const String _videoIdtwo = 'https://youtu.be/7EQT1gVsE6I?t=';
const double _startSecondstwo = 0000000000000000000000000001819;
const String _videoIdthree = 'https://youtu.be/hNGOR5qN0No?t=';
const double _startSecondsthree = 000000000000000000000000000532;
const String _videoIdfour = 'https://youtu.be/lHLtnhg7O80?t=';
const double _startSecondsfour = 000000000000000000000000000474;
const String _videoIdfive = 'https://youtu.be/HlyjL_1mdZ8?t=';
