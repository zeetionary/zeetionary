...
class EnglishEntryheartbroken extends StatefulWidget {
  const EnglishEntryheartbroken({super.key});

  @override
  State<EnglishEntryheartbroken> createState() =>
      _EnglishEntryheartbrokenState();
}

class _EnglishEntryheartbrokenState extends State<EnglishEntryheartbroken> {
  @override
  void initState() {
    super.initState();
...
1. Full of sorrow (- brokenhearted, heartsick)
"they were heartbroken when they learned their child was abnormal";
""",
  );

  final String keyword = "heartbroken";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heartbroken""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was heartbroken when she left him.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""His wife's death left him absolutely heartbroken.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heartbroken""",
                      // alsoEnglishWord: "also: heartbroken",
                      britshText: """IpaUK: /ˈhɑːtbrəʊkən/""",
                      americanText: """IpaUS: /ˈhɑːrtbrəʊkən/""",
...
کوردی: خەمبار، لێوبەبار، کۆست‌کەوتوو، پشت‌شکاو، دڵ‌شکاو
"""),
// With short examples define "heartbroken", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) تەواو دڵتەنگ بەهۆی ئەوەی شتێکی خراپ ڕوویداوە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: broken-hearted"),
                    SentencesRow(
                      englishText: """He was heartbroken when she left him.""",
                      kurdishText: """دڵشکاو بوو کە جێیهێشت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """His wife's death left him absolutely heartbroken.""",
                      kurdishText: """مەرگی ژنەکەی تەواو دڵشکاوی کرد.""",
...
const double _startSecondsone = 0000000000000000000000000001235;
const String _videoIdtwo = 'https://youtu.be/aAByKcPJ5NQ';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/4wli0ULFIbk?t=';
const double _startSecondsthree = 000000000000000000000000000265;
const String _videoIdfour = 'https://youtu.be/-oHGafLPvEE?t=';
const double _startSecondsfour = 000000000000000000000000000508;
const String _videoIdfive = 'https://youtu.be/AhjrZCSF6Hw?t=';
const double _startSecondsfive = 000000000000000000000000000377;
