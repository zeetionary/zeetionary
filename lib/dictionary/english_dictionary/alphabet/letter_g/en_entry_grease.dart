...
class EnglishEntrygrease extends StatefulWidget {
  const EnglishEntrygrease({super.key});

  @override
  State<EnglishEntrygrease> createState() => _EnglishEntrygreaseState();
}

class _EnglishEntrygreaseState extends State<EnglishEntrygrease> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: grease (Derived forms: greases)
1. A thick fatty oil (especially one used to lubricate machinery) (- lubricating oil)
 
2. Anything regarded as making something unclean (- dirt, filth, grime, soil, stain, grunge)

- Verb: grease (Derived forms: greases, greasing, greased)
1. Lubricate with grease
"grease the wheels"
 
2. [informal] Make something go easily or smoothly
 
3. [informal] Make easier (- facilitate, ease, alleviate)
""",
  );

  final String keyword = "grease";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Grease marks can be removed with liquid detergent.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her hands were covered with oil and grease.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He collected the plates, which were covered with grease.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Place the cakes on a lightly greased baking tray.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grease""",
                      // alsoEnglishWord: "also: grease",
                      britshText: """IpaUK: /ɡriːs/""",
                      americanText: """IpaUS: /ɡriːs/""",
...
کوردی: ڕۆن، ڕۆن یان بەزی دووگ، چەوری، بەز،	گریس، ماسڵە،	پیوی قاڵ‌کراو،	ڕۆنی گیانەوەری
"""),
// With short examples define "grease", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هەر مادەیەکی چەوری خەست، بە تایبەتی کە دەدرێت لە ئامێر بۆ ئەوەی باش کار بکات"""),
                    SentencesRow(
                      englishText:
                          """Grease marks can be removed with liquid detergent.""",
                      kurdishText:
                          """پەڵەی گریس دەکرێت بە پاککەرەوەی شلە لابدرێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """دەستی بە ڕۆن و گریس پیس بووبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """قاپ‌وقاچاخەکەی کۆکردەوە کە پڕ لە چەوری بوون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کێکەکان لەسەر سینییەکی برژاندنی کەمێک چەورکراو دابنێ..""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/1p8r-2ffK_c?t=';
const double _startSecondsend = 000000000000000000000000000346;
const String _videoIdone = 'https://youtu.be/iGQ1YmjY5l0?t=';
const double _startSecondsone = 00000000000000000000000000016;
const String _videoIdtwo = 'https://youtu.be/YRG04fgRAqU?t=';
const double _startSecondstwo = 000000000000000000000000000236;
const String _videoIdthree = 'https://youtu.be/UJfaZswThVI?t=';
const double _startSecondsthree = 00000000000000000000000000091;
const String _videoIdfour = 'https://youtu.be/biXxMLcKa2g?t=';
const double _startSecondsfour = 000000000000000000000000000542;
const String _videoIdfive = 'https://youtu.be/6ta_sftSfIw?t=';
const double _startSecondsfive = 0000000000000000000000000001733;
