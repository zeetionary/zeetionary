...
class EnglishEntryinhale extends StatefulWidget {
  const EnglishEntryinhale({super.key});

  @override
  State<EnglishEntryinhale> createState() => _EnglishEntryinhaleState();
}

class _EnglishEntryinhaleState extends State<EnglishEntryinhale> {
  @override
  void initState() {
    super.initState();
