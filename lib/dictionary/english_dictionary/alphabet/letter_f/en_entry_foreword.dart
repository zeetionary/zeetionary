...
class EnglishEntryforeword extends StatefulWidget {
  const EnglishEntryforeword({super.key});

  @override
  State<EnglishEntryforeword> createState() => _EnglishEntryforewordState();
}

class _EnglishEntryforewordState extends State<EnglishEntryforeword> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foreword (Derived forms: forewords)
1. A short introductory essay preceding the text of a book (= preface, prolusion)
""",
  );

  final String keyword = "foreword";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foreword""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foreword""",
                      // alsoEnglishWord: "also: foreword",
                      britshText: """IpaUK: /ˈfɔːwɜːd/""",
                      americanText: """IpaUS: /ˈfɔːrwɜːrd/""",
...
کوردی: پێشەکی، پێش‌وتە، کورتە پێشەکی
"""),
// With short examples define "foreword", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ناساندنێکی کورت لە سەرەتای کتێبێک، زۆرجار کە کەسێک دەینووسێت کە خودی نووسەرەکە نییە"""),
                    SentencesRow(
                      englishText:
                          """He was asked if he would consider writing a foreword for her book.""",
                      kurdishText:
                          """داوای لێکرا کە ئاخۆ پێشەکییەکە بۆ کتێبەکەی دەنووسێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/pTk9HnIwEYU?t=';
const double _startSecondsend = 000000000000000000000000000449;
const String _videoIdone = 'https://youtu.be/mscDaDd1ipk?t=';
const double _startSecondsone = 000000000000000000000000000423;
const String _videoIdtwo = 'https://youtu.be/JUTC9ROB-kw?t=';
const double _startSecondstwo = 000000000000000000000000000269;
const String _videoIdthree = 'https://youtu.be/VYDaqto22NY?t=';
const double _startSecondsthree = 0000000000000000000000000005679;
const String _videoIdfour = 'https://youtu.be/AlqyKZpZHac?t=';
const double _startSecondsfour = 000000000000000000000000000722;
const String _videoIdfive = 'https://youtu.be/hlCc_TA7gw8?t=';
