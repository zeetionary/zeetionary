...
class EnglishEntrygrannyflat extends StatefulWidget {
  const EnglishEntrygrannyflat({super.key});

  @override
  State<EnglishEntrygrannyflat> createState() => _EnglishEntrygrannyflatState();
}

class _EnglishEntrygrannyflatState extends State<EnglishEntrygrannyflat> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: granny flat (Derived forms: granny flats)
Usage: Brit
1. A self-contained section of a larger house suitable for an elderly relative to live in
""",
  );

  final String keyword = "granny flat";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""granny flat""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The granny flat has its own kitchen and bathroom.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """granny flat""",
                      // alsoEnglishWord: "also: granny flat",
                      britshText: """IpaUK: /ˈɡræni flæt/""",
                      americanText: """IpaUS: /ˈɡræni flæt/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ژمارەیەک ژووڕ کە زۆرجار سەر بە خانووی خزمێکە و کەسێکی بەتەمەن تێیدا دەژی"""),
                    SentencesRow(
                      englishText:
                          """The granny flat has its own kitchen and bathroom.""",
                      kurdishText:
                          """دیوە پیرانەکە چێشتخانە و گەرماوی خۆی هەیە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/fwXGuujZKw4?t=';
const double _startSecondsend = 0000000000000000000000000001630;
const String _videoIdone = 'https://youtu.be/sDkYMT6p280?t=';
const double _startSecondsone = 000000000000000000000000000115;
const String _videoIdtwo = 'https://youtu.be/f3Bqr6mihIg?t=';
const double _startSecondstwo = 000000000000000000000000000383;
const String _videoIdthree = 'https://youtu.be/PuPF8vpyA6Y?t=';
const double _startSecondsthree = 000000000000000000000000000240;
const String _videoIdfour = 'https://youtu.be/hcMPLDN16ko?t=';
const double _startSecondsfour = 0000000000000000000000000001846;
const String _videoIdfive = 'https://youtu.be/bQpohdDNWL8?t=';
