...
class EnglishEntryequivocate extends StatefulWidget {
  const EnglishEntryequivocate({super.key});

  @override
  State<EnglishEntryequivocate> createState() => _EnglishEntryequivocateState();
}

class _EnglishEntryequivocateState extends State<EnglishEntryequivocate> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""equivocate""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equivocate""",
                      // alsoEnglishWord: "also: equivocate",
                      britshText: """IpaUK: /ɪˈkwɪvəkeɪt/""",
                      americanText: """IpaUS: /ɪˈkwɪvəkeɪt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "equivocate";
...
// کوردی: بەتێکوڵەوە قسە کردن، دوو پاڵوو قسە کردن
// """),
          const DefinitionKurdish(
              text:
                  """١. (کردار) قسەکردن لەسەر شتێک بە ئەنقەست بەشێوەیەک کە ڕوون نییە بۆ ئەوەی لە ڕاستی دوور بکەویتەوە یان بیشاریتەوە"""),
          SentencesRow(
            englishText:
                """He initially equivocated on the question of whether he was religious.""",
            kurdishText:
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: equivocate (Derived forms: equivocating, equivocated, equivocates)
1. Be deliberately ambiguous or unclear in order to mislead or withhold information (= beat around the bush [informal], tergiversate, prevaricate, palter, beat about the bush [informal], weasel [informal])
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/6kih0WCsqnE?t=';
const double _startSecondsend = 000000000000000000000000000000; // 638;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/wSNYgHiB-N4?t=';
const double _startSecondsone = 00000000000000000000000000000; // 91;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/VFlyQk_uVAI?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 372;
const String _videoIdthree = 'VIDEOhttps://youtu.be/OtTQkIvvfEU?t=';
const double _startSecondsthree = 000000000000000000000000000; // 295;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/uiAklhuvwro?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 97;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/2yHr9DPnSzk?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 2523;
