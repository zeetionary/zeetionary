...
class EnglishEntryfive extends StatefulWidget {
  const EnglishEntryfive({super.key});

  @override
  State<EnglishEntryfive> createState() => _EnglishEntryfiveState();
}

class _EnglishEntryfiveState extends State<EnglishEntryfive> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: five
1. Being one more than four (= 5, v)

- Noun: five (Derived forms: fives)
1. The cardinal number that is the sum of four and one (= 5, V, cinque, quint, quintet, fivesome, quintuplet, pentad, Phoebe, Little Phoebe)
 
2. A team that plays basketball (= basketball team)
 
3. A playing card or a domino or a die whose upward face shows five pips (= five-spot [US])
""",
  );

  final String keyword = "five";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There are only five cookies left.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Ten people were invited but only five turned up.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Do you have change for five dollars?""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Look at page five.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Three fives are fifteen.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I can't read your writing—is this meant to be a five?""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Shall we meet at five, then?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """five""",
                      // alsoEnglishWord: "also: five",
                      britshText: """IpaUK: /faɪv/""",
                      americanText: """IpaUS: /faɪv/""",
...
کوردی: 
"""),
// With short examples define "five", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ژمارە) ژمارە پێنج ٥"""),
                    SentencesRow(
                      englishText: """There are only five cookies left.""",
                      kurdishText: """تەنها هەشت بسکیت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دە کەس بانگهێشت کران بەڵام تەنها پێنج هاتن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Do you have change for five dollars?""",
                      kurdishText: """هیچ باقیت پێیە بۆ پێنج دۆلار؟""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Look at page five.""",
                      kurdishText: """سەیری لاپەڕە پێنج.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پێنج و چوار سێ دەکەن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Three fives are fifteen.""",
                      kurdishText: """سێ پێنجی پازدە دەکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ناتوانم دەستووخەتت بخوێنمەوە ـ ئەمە بۆ پێنج نووسراوە؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کەواتە لە پێنج یەکدی ببینین؟""",
...
const double _startSecondsend = 000000000000000000000000000441;
const String _videoIdone = 'https://youtu.be/wTNJZEcHdPw?t=';
const double _startSecondsone = 00000000000000000000000000020;
const String _videoIdtwo = 'https://youtu.be/YWTGTWnxR2k?t=';
const double _startSecondstwo = 00000000000000000000000000014;
const String _videoIdthree = 'https://youtu.be/_wNsZEqpKUA?t=';
const double _startSecondsthree = 0000000000000000000000000005;
const String _videoIdfour = 'https://youtu.be/4J0xFUyz1nw?t=';
const double _startSecondsfour = 000000000000000000000000000645;
const String _videoIdfive = 'https://youtu.be/hTqtGJwsJVE?t=';
const double _startSecondsfive = 0000000000000000000000000001391;
