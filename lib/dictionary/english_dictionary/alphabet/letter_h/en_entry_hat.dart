...
class EnglishEntryhat extends StatefulWidget {
  const EnglishEntryhat({super.key});

  @override
  State<EnglishEntryhat> createState() => _EnglishEntryhatState();
}

class _EnglishEntryhatState extends State<EnglishEntryhat> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hat (Derived forms: hats)
1. Headgear that is worn for warmth, to protect the head, or as a fashion or uniform item (- chapeau, lid [informal])
 
2. [informal] An informal term for a person's role
"he took off his politician's hat and talked frankly"

- Verb: hat (Derived forms: hatting, hatted, hats)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He placed a hat on his head.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He pulled his hat down over his face.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I'm wearing two hats tonight—parent and teacher.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hat""",
                      // alsoEnglishWord: "also: hat",
                      britshText: """IpaUK: /hæt/""",
                      americanText: """IpaUS: /hæt/""",
...
کوردی: کڵاو، تەقیلە، شەپکە،	پلەوپایە، پۆست، پێگە
"""),
// With short examples define "hat", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) کڵاو"""),
                    SentencesRow(
                      englishText: """He placed a hat on his head.""",
                      kurdishText: """کڵاوێکی خستە سەری.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He pulled his hat down over his face.""",
                      kurdishText: """کڵاوەکەی بۆ سەر ڕووخساری نزمکردەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) یەکێک لەو ئەرک و پێگانەی کە کەسێک هەیەتی"""),
                    SentencesRow(
                      englishText:
                          """I'm wearing two hats tonight—parent and teacher.""",
                      kurdishText:
                          """ئەمشەو دوو پێگەم هەیە ـ دایکایەتی (یان باوکایەتی) و مامۆستایی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I'm telling you this with my lawyer's hat on, you understand.""",
                      kurdishText: """ئەمەت وەک پارێزەرێک پێدەڵێم، تێدەگەیت.""",
...
const double _startSecondsend = 000000000000000000000000000125;
const String _videoIdone = 'https://youtu.be/zmEv7vTOQGE?t=';
const double _startSecondsone = 0000000000000000000000000001711;
const String _videoIdtwo = 'https://youtu.be/iAnlaR398hs?t=';
const double _startSecondstwo = 00000000000000000000000000090;
const String _videoIdthree = 'https://youtu.be/tsE1rMH18Tk?t=';
const double _startSecondsthree = 000000000000000000000000000373;
const String _videoIdfour = 'https://youtu.be/z4L2E6_Gmkk?t=';
const double _startSecondsfour = 000000000000000000000000000488;
const String _videoIdfive = 'https://youtu.be/QLq6GEiHqR8?t=';
const double _startSecondsfive = 000000000000000000000000000274;
