...
class EnglishEntryflirtation extends StatefulWidget {
  const EnglishEntryflirtation({super.key});

  @override
  State<EnglishEntryflirtation> createState() => _EnglishEntryflirtationState();
}

class _EnglishEntryflirtationState extends State<EnglishEntryflirtation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flirtation (Derived forms: flirtations)
1. Playful behaviour intended to arouse sexual interest (= flirting, coquetry, dalliance, toying)
""",
  );

  final String keyword = "flirtation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flirtation""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Their flirtation with the property market ended quickly.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was a harmless flirtation and nothing more.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flirtation""",
                      // alsoEnglishWord: "also: flirtation",
                      britshText: """IpaUK: /flɜːˈteɪʃn/""",
                      americanText: """IpaUS: /flɜːrˈteɪʃn/""",
...
// With short examples define "flirtation", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) ماوەیەکی کورت کە کەسێک حەزی بە شتێکە"""),
                    SentencesRow(
                      englishText:
                          """Their flirtation with the property market ended quickly.""",
                      kurdishText: """تێوەگلانیان لە بازاڕی خانووبەرە زوو کۆتایی هات.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ڕەفتارێک کە ئەوە پیشان دەدات کەسێک بە سەرنجڕاکێش دەبینیت بەڵام جدی نیت لەسەری"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """It was a harmless flirtation and nothing more.""",
                      kurdishText: """تەنها داڵدارییەکی بێ‌زیان بوو و هیچی تر.""",
...
const String _videoIdtwo = 'https://youtu.be/Gfj5f0GVLZ0?t=';
const double _startSecondstwo = 000000000000000000000000000638;
const String _videoIdthree = 'https://youtu.be/Li9ff4rQlck?t=';
const double _startSecondsthree = 000000000000000000000000000378;
const String _videoIdfour = 'https://youtu.be/wptLQv0po88?t=';
const double _startSecondsfour = 00000000000000000000000000083;
const String _videoIdfive = 'https://youtu.be/VOzUnIu_GP0?t=';
