...
class EnglishEntryfreewill extends StatefulWidget {
  const EnglishEntryfreewill({super.key});

  @override
  State<EnglishEntryfreewill> createState() => _EnglishEntryfreewillState();
}

class _EnglishEntryfreewillState extends State<EnglishEntryfreewill> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: free will
1. The power of making free choices unconstrained by external agencies (= discretion)
""",
  );

  final String keyword = "free will";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""free will""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""No one told me to do it - I did it of my own free will.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """free will""",
                      // alsoEnglishWord: "also: free will",
                      britshText: """IpaUK: /ˌfriː ˈwɪl/""",
                      americanText: """IpaUS: /ˌfriː ˈwɪl/""",
...
کوردی: ویست، هێز یان توانایی بڕیاردان، بڕیاربەدەستی
"""),
// With short examples define "free will", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە ئەو شتانە بکەیت کە دەتەوێت بەبێ کۆنترۆڵی خودا، قەدەر، یان هەلومەرج"""),
                    SentencesRow(
                      englishText:
                          """No one told me to do it - I did it of my own free will.""",
                      kurdishText:
                          """کەس پێی نەگوتم بیکەم ـ بە ویستی ئازادی خۆم کردم.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/SKV6h_5XFbk?t=';
const double _startSecondsend = 000000000000000000000000000179;
const String _videoIdone = 'https://youtu.be/NNnIGh9g6fA?t=';
const double _startSecondsone = 000000000000000000000000000132;
const String _videoIdtwo = 'https://youtu.be/tZBk_Hb-X0w?t=';
const double _startSecondstwo = 000000000000000000000000000139;
const String _videoIdthree = 'https://youtu.be/THIGSnMP3io?t=';
const double _startSecondsthree = 000000000000000000000000000741;
const String _videoIdfour = 'https://youtu.be/0jAUNM2g3w0?t=';
const double _startSecondsfour = 000000000000000000000000000667;
const String _videoIdfive = 'https://youtu.be/TSmEn1qfhnU?t=';
const double _startSecondsfive = 00000000000000000000000000079;
