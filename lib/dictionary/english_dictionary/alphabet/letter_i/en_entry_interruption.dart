...
class EnglishEntryinterruption extends StatefulWidget {
  const EnglishEntryinterruption({super.key});

  @override
  State<EnglishEntryinterruption> createState() =>
      _EnglishEntryinterruptionState();
}

class _EnglishEntryinterruptionState extends State<EnglishEntryinterruption> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: interruption (Derived forms: interruptions)
1. An act of delaying or interrupting the continuity (- break, disruption, gap)
 
2. Some abrupt occurrence that interrupts an ongoing activity (- break)
"the telephone is an annoying interruption";
 
3. A time interval during which there is a temporary cessation of something (- pause, intermission, break, suspension)
""",
  );

  final String keyword = "interruption";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""interruption""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""There's been an interruption in the power supply.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He ignored her interruptions.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She spoke for 20 minutes without interruption.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/DG8rPBlbOrY?t=';
    const double startSecondsend = 000000000000000000000000000258;
    const String videoIdone = 'https://youtu.be/3C9wZf88y4Q?t=';
    const double startSecondsone = 000000000000000000000000000601;
    const String videoIdtwo = 'https://youtu.be/l9LpRpgnyqc?t=';
    const double startSecondstwo = 0000000000000000000000000001404;
    const String videoIdthree = 'https://youtu.be/AKN2yG3ik4Q?t=';
    const double startSecondsthree = 000000000000000000000000000947;
    const String videoIdfour = 'https://youtu.be/hQ3GW7lVBWY?t=';
    const double startSecondsfour = 000000000000000000000000000800;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """interruption""",
                      // alsoEnglishWord: "also: interruption",
                      britshText: """IpaUK: /ˌɪntəˈrʌpʃn/""",
                      americanText: """IpaUS: /ˌɪntəˈrʌpʃn/""",
...
کوردی: بڕین، دابڕین، دابڕان، پسان، پچڕان، قرتان، لەت‌کردن،	پشوو، وچان، ماوە
"""),
// With short examples define "interruption", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) شتێک کە بۆ ماوەیەکی کاتی چالاکی یان دۆخێک دەوەستێنێت"""),
                    SentencesRow(
                      englishText:
                          """The game continued after a short interruption because of rain.""",
                      kurdishText:
                          """یارییەکە بەردەوام بوو لە دوای پچڕانێکی کورت بەهۆی بارانەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The birth of her son was a minor interruption to her career.""",
                      kurdishText:
                          """لەدایکبوونی کوڕەکەی وچانێکی کورت بوو لە کارکردنیدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پچڕانێک لە سەرچاوەی وزە ڕوویداوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بۆ ٢٠ خولەک بەبێ پچڕان.""",
