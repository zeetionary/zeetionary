...
// blank divider
  ...
  Future<void> speakbreakfast(String languageCode) async {
    ...
    await flutterTts.speak("breakfast");
  }
  ...
  Future<void> speakbreakfasts7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakbreakfasts77");
  }
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'ZgYJXAVl7Rg';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'ACKYhlBi98Q';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'BW1YOwD1ueo';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'vbtPtgzpBqc';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 's-nY6tBpCeA';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'orMFXE8hk7Y';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'o9qESpMBSD0';
  final double _startSeconds = 0;
