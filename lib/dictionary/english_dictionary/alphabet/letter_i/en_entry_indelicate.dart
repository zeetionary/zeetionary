...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/aVHsIuNi8iQ?t=';
    const double startSecondsend = 0000000000000000000000000001392;
    const String videoIdone = 'https://youtu.be/IUPpDb4Zr9w?t=';
    const double startSecondsone = 000000000000000000000000000944;
    const String videoIdtwo = 'https://youtu.be/4HTNORwxJ3o?t=';
    const double startSecondstwo = 000000000000000000000000000327;
    const String videoIdthree = 'https://youtu.be/gdApiTAK734?t=';
    const double startSecondsthree = 000000000000000000000000000171;
    const String videoIdfour = 'https://youtu.be/MoRgK9OcfBU?t=';
    const double startSecondsfour = 00000000000000000000000000050;
    const String videoIdfive = 'https://youtu.be/v02HyWCouFc?t=';
