...
class EnglishEntryflourish extends StatefulWidget {
  const EnglishEntryflourish({super.key});

  @override
  State<EnglishEntryflourish> createState() => _EnglishEntryflourishState();
}

class _EnglishEntryflourishState extends State<EnglishEntryflourish> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: flourish (Derived forms: flourished, flourishing, flourishes)
1. Grow vigorously (= boom, thrive, expand)
"business is flourishing";
 
2. Make steady progress; be at the high point in one's career or reach a high point in historical significance or importance (= thrive, prosper, fly high, bloom, flower)
"The new student is flourishing";
 
3. Move or swing back and forth (= brandish, wave)
"She flourished her gun";

- Noun: flourish (Derived forms: flourishes)
1. A showy gesture
...
4. The act of waving (= brandish)
 
5. (music) a short lively tune played on brass instruments (= fanfare, tucket)
"he entered to a flourish of trumpets";
""",
  );

  final String keyword = "flourish";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flourish""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The arts began to flourish at that time.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The company has continued to flourish over the years.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The town still flourishes as a fishing port.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""These plants flourish in a damp climate.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I'm glad to hear you're all flourishing.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He rushed into the room flourishing the newspaper.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He opened the door for her with a flourish.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flourish""",
                      // alsoEnglishWord: "also: flourish",
                      britshText: """IpaUK: /ˈflʌrɪʃ/""",
                      americanText: """IpaUS: /ˈflɜːrɪʃ/""",
...
کوردی: تەکان، توند جووڵانەوە، جیفڕک، تەکانی توند،	ڕازاندنەوە، نەخش‌ونیگار، هێڵی چەماوە، جوان‌نووسی، کەوانەهێڵ، پێچ‌وخەم، کێش‌وسووڕ، هێڵی کەوانەیی،	فانفار، بەرز و بەشکۆ،	ڕووان، شین‌بوون، هەڵدان، گەشەکردن، نەش‌ونەما، پەرەسەندن، پێشکەوتن
"""),
// With short examples define "flourish", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Few businesses are flourishing in the present economic climate.""",
                      kurdishText:
                          """کەم بازرگانی لەم کەشە ئابوورییەی ئێستادا گەشە دەکەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هونەر دەستی بە بوژانەوە کرد لەو کاتەدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کۆمپانیاکە بەردەوام بوو لە بووژانەوە ساڵ دوای ساڵ.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شارۆچکەکە هێشتا وەک بەندەرێکی ماسیگرتن دەبووژێتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەم ڕووەکانە لە کەشێکی شێداردا گەشە دەکەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """خۆشحاڵم بە بیستنی ئەوەی تەواو تەندرووستیت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕایکردە ژوورەکە بە بادانی ڕۆژنامەیەکەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بە تەکانێکەوە دەرگاکەی بۆ کردەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The season ended with a flourish for Kane, when he scored in the final minute of the match.""",
                      kurdishText:
                          """وەرزەکە بە شکۆدارییەوە بۆ کەین کۆتایی هات، کاتێک لە خولەکی کۆتایی یارییەکەدا گۆڵی تۆمار کرد.""",
                    ...
                    SentencesRow(
                      englishText:
                          """His writing is plain and direct, with no stylistic flourishes.""",
                      kurdishText:
                          """نووسینی سادە و ڕاستەوخۆیە، بەبێ هیچ جوان‌نووسییەک.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/n5x7GLl-mMo?t=';
const double _startSecondsend = 000000000000000000000000000232;
const String _videoIdone = 'https://youtu.be/J-K5OjAkiEA?t=';
const double _startSecondsone = 000000000000000000000000000185;
const String _videoIdtwo = 'https://youtu.be/DxL2HoqLbyA?t=';
const double _startSecondstwo = 0000000000000000000000000001413;
const String _videoIdthree = 'https://youtu.be/FaCeZsOOKEY?t=';
const double _startSecondsthree = 00000000000000000000000000054;
const String _videoIdfour = 'https://youtu.be/d3qOoYZppaQ?t=';
const double _startSecondsfour = 000000000000000000000000000621;
const String _videoIdfive = 'https://youtu.be/tKZ2ILu_EMc?t=';
