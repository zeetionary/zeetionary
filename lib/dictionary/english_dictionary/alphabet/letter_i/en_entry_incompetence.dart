...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = '_gM6NG2PN4Q';
    const double startSecondsone = 372;
    const String videoIdtwo = '5Wq0yv73NpY';
    const double startSecondstwo = 513;
    const String videoIdthree = 'LJ0Hfc8hvpE';
    const double startSecondsthree = 374;
    const String videoIdfour = 'j0iOuOMh_JE';
