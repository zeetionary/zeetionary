...
class EnglishEntryfurtively extends StatefulWidget {
  const EnglishEntryfurtively({super.key});

  @override
  State<EnglishEntryfurtively> createState() => _EnglishEntryfurtivelyState();
}

class _EnglishEntryfurtivelyState extends State<EnglishEntryfurtively> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: furtively
1. In a furtive manner (- on the sly)
"the soldiers were furtively crawling through the night";
""",
  );

  final String keyword = "furtively";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""furtively""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He glanced furtively around.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She saw him talking furtively to another man.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furtively""",
                      // alsoEnglishWord: "also: furtively",
                      britshText: """IpaUK: /ˈfɜːtɪvli/""",
                      americanText: """IpaUS: /ˈfɜːrtɪvli/""",
...
کوردی: بە نهێنی یان نەهێنی، (بە)پەنامەکی، بەدزی‌یەوە، لەبنەوە
"""),
// With short examples define "furtively", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بە شێوەیەک کە ڕەفتار دەکەیت بە شێوەیەک کە دەتەوێت شتێک بە نهێنی بهێڵیتەوە و ماتەوێت ببیندرێیت"""),
                    SentencesRow(
                      englishText: """He glanced furtively around.""",
                      kurdishText: """بە نهێنی سەیری دەورووبەری دەکرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بینیی کە بە نهێنی قسەی لەگەڵ پیاوێکی دیکە دەکرد.""",
...
const String _videoIdone = 'https://youtu.be/U8Cq8c-Ohps?t=';
const double _startSecondsone = 000000000000000000000000000298;
const String _videoIdtwo = 'https://youtu.be/pNEkFRUy9Ow?t=';
const double _startSecondstwo = 00000000000000000000000000095;
const String _videoIdthree = 'https://youtu.be/Rxh_SVtyZqo?t=';
const double _startSecondsthree = 0000000000000000000000000003737;
const String _videoIdfour = 'https://youtu.be/mjx38mlgNmw?t=';
const double _startSecondsfour = 000000000000000000000000000156;
const String _videoIdfive = 'https://youtu.be/YPvGvqVJNEg?t=';
