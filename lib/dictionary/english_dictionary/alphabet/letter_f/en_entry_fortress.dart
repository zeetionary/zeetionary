...
class EnglishEntryfortress extends StatefulWidget {
  const EnglishEntryfortress({super.key});

  @override
  State<EnglishEntryfortress> createState() => _EnglishEntryfortressState();
}

class _EnglishEntryfortressState extends State<EnglishEntryfortress> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fortress (Derived forms: fortresses)
1. A fortified defensive structure (= fort)
"an impenetrable fortress";
""",
  );

  final String keyword = "fortress";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fortress""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The fortress fell after a nine-day siege.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fortress""",
                      // alsoEnglishWord: "also: fortress",
                      britshText: """IpaUK: /ˈfɔːtrəs/""",
                      americanText: """IpaUS: /ˈfɔːrtrəs/""",
...
// With short examples define "fortress", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بینایەک یان شوێنیک کە بەهێز کراوە دژ بە هێرش"""),
                    SentencesRow(
                      englishText:
                          """Fear of terrorist attack has turned the conference centre into a fortress.""",
                      kurdishText:
                          """ترسی هێرشی تیرۆریستی سەنتەری کۆنفرانسەکەی کردبوو بە قەڵایەک.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """قەڵاکە لە دوای گەمارۆیەکی نۆ ڕۆژە کەوت.""",
...
const double _startSecondsend = 0000000000000000000000000001438;
const String _videoIdone = 'https://youtu.be/qr4MSVxfYBE?t=';
const double _startSecondsone = 000000000000000000000000000237;
const String _videoIdtwo = 'https://youtu.be/4XlZHweHEtc?t=';
const double _startSecondstwo = 0000000000000000000000000001893;
const String _videoIdthree = 'https://youtu.be/9apHooK3PPE?t=';
const double _startSecondsthree = 00000000000000000000000000057;
const String _videoIdfour = 'https://youtu.be/9bPIaHg11mI?t=';
const double _startSecondsfour = 000000000000000000000000000514;
const String _videoIdfive = 'https://youtu.be/MjLQ2iJfktY';
