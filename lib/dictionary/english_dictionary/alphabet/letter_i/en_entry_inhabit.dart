...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1370;
    const String videoIdone = 'lsbcN9-jU1Y';
    const double startSecondsone = 459;
    const String videoIdtwo = 'helhqdNlWhg';
    const double startSecondstwo = 30;
    const String videoIdthree = 'BRrWiW1o19E';
    const double startSecondsthree = 238;
    const String videoIdfour = 'RQYuyHNLPTQ';
    const double startSecondsfour = 140;
    const String videoIdfive = 'lwe5KTdzSHg';
...
// With short examples define "inhabit", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) ژیان کردن لە شوێنێکی دیاریکراو"""),
                    SentencesRow(
                      englishText:
                          """Some of the rare species that inhabit the area are under threat.""",
                      kurdishText:
