...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = '5lEp4djm4s0';
    const double startSecondsend = 67;
    const String videoIdone = 'iZbala54uzk';
    const double startSecondsone = 370;
    const String videoIdtwo = 'NOXSz3nJgTs';
    const double startSecondstwo = 196;
    const String videoIdthree = 'Rd_AzqOqgrk';
    const double startSecondsthree = 61;
    const String videoIdfour = 'rhzgUq-lDVU';
    const double startSecondsfour = 828;
    const String videoIdfive = 'Eupw-yTBkQI';
