...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'K4Ze-Sp6aUE';
    const double startSecondsend = 801;
    const String videoIdone = 'uAJ6-X3ESS4';
    const double startSecondsone = 350;
    const String videoIdtwo = '3eLVXX6aIig';
    const double startSecondstwo = 370;
    const String videoIdthree = 'HrBTbfrucGk';
    const double startSecondsthree = 111;
    const String videoIdfour = '41IfdwLqtkA';
    const double startSecondsfour = 2700;
    const String videoIdfive = 'yMB2TvdmACU';
