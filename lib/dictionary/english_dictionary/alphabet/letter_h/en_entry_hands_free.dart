...
class EnglishEntryhandsfree extends StatefulWidget {
  const EnglishEntryhandsfree({super.key});

  @override
  State<EnglishEntryhandsfree> createState() => _EnglishEntryhandsfreeState();
}

class _EnglishEntryhandsfreeState extends State<EnglishEntryhandsfree> {
  @override
  void initState() {
    super.initState();
...
1. ​(of a phone, etc.) able to be used without needing to be held in the hand
""",
  );

  final String keyword = "hands-free";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hands-free""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Hands-free calling is safer while driving.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hands-free""",
                      // alsoEnglishWord: "also: hands-free",
                      britshText: """IpaUK: /ˈhændz friː/""",
                      americanText: """IpaUS: /ˈhændz friː/""",
...
// """),
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پەیوەندیکردنی نادەستی سەلامەتترە لە کاتی شۆفێری.""",
