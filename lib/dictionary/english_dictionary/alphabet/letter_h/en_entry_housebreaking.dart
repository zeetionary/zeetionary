...
class EnglishEntryhousebreaking extends StatefulWidget {
  const EnglishEntryhousebreaking({super.key});

  @override
  State<EnglishEntryhousebreaking> createState() =>
      _EnglishEntryhousebreakingState();
}

class _EnglishEntryhousebreakingState extends State<EnglishEntryhousebreaking> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: housebreaking
1. Trespassing for an unlawful purpose; illegal entrance into premises with criminal intent (- break-in, breaking and entering)
""",
  );

  final String keyword = "housebreaking";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""housebreaking""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Housebreakings fell by almost 15 percent.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/DJQS4k7tbhg?t=';
    const double startSecondsend = 0000000000000000000000000004591;
    const String videoIdone = 'https://youtu.be/C7tzJ70LEwI?t=';
    const double startSecondsone = 000000000000000000000000000359;
    const String videoIdtwo = 'https://youtu.be/B1twIxyZojs?t=';
    const double startSecondstwo = 00000000000000000000000000077;
    const String videoIdthree = 'https://youtu.be/S-G0F_bp0fY?t=';
    const double startSecondsthree = 000000000000000000000000000359;
    const String videoIdfour = 'https://youtu.be/v51NS-eQ3V4?t=';
    const double startSecondsfour = 000000000000000000000000000590;
    const String videoIdfive = 'https://youtu.be/6CZ0Q6jw4Z4?t=';
    const double startSecondsfive = 00000000000000000000000000026120;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """housebreaking""",
                      // alsoEnglishWord: "also: housebreaking",
                      britshText: """IpaUK: /ˈhaʊsbreɪkɪŋ/""",
                      americanText: """IpaUS: /ˈhaʊsbreɪkɪŋ/""",
...
// With short examples define "housebreaking", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ماڵبڕی بە نزیکەی ١٥ لە سەد کەمی کرد.""",
