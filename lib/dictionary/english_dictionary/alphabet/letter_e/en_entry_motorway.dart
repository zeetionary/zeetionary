...
const String _videoIdend = 'oADU2PIzhD0';
const double _startSecondsend = 570;
const String _videoIdone = 'gkTpC0HJj6A';
const double _startSecondsone = 45;
const String _videoIdtwo = 'qarOwn74AjQ';
const double _startSecondstwo = 180;
const String _videoIdthree = 'ZZkT18CXFHU';
const double _startSecondsthree = 404;
const String _videoIdfour = 'T1uNZvZg72o';
const double _startSecondsfour = 784;
const String _videoIdfive = 'HGs9e8j54vA';
