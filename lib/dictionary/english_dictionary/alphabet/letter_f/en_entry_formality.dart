...
class EnglishEntryformality extends StatefulWidget {
  const EnglishEntryformality({super.key});

  @override
  State<EnglishEntryformality> createState() => _EnglishEntryformalityState();
}

class _EnglishEntryformalityState extends State<EnglishEntryformality> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: formality (Derived forms: formalities)
1. A requirement of etiquette or custom (= formalities)
"a mere formality";
 
2. A manner that strictly observes all forms and ceremonies (= formalness)
...
""",
  ...
  final String keyword = "formality";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""formality""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Let's skip the formalities and get down to business.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Your acceptance into the club will be a mere formality.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She greeted him with stiff formality.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """formality""",
                      // alsoEnglishWord: "also: formality",
                      britshText: """IpaUK: /fɔːˈmæləti/""",
                      americanText: """IpaUS: /fɔːrˈmæləti/""",
...
کوردی: فەرمی‌بوون، ڕەسمی‌بوون، فەرمێتی،	ڕووکەشێتی، ڕواڵەتیێتی، ڕواڵەتی‌بوون، داب‌ودەستوور، دێدی‌وبۆدی، هۆرتەوبەرە، ڕێ‌وڕەسم
"""),
// With short examples define "formality", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) شتێک کە دەبێت بیکەیت وەک بەشێکی فەرمی پڕۆسەیەکی یاسایی، بابەتێکی کۆمەڵایەتی، هتد"""),
                    SentencesRow(
                      englishText:
                          """Let's skip the formalities and get down to business.""",
                      kurdishText:
                          """با شتە فەرمییەکان پەڕ بدەین و دەست بە کار بکەین.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It only took a few minutes to complete the legal formalities.""",
                      kurdishText:
                          """تەنها چەند خولەکێکی پێچوو کە فەرمێتییە یاساییەکان تەواو بکەین.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) شتێک کە مەرجە بیکەیت وەک بەشێک لە پڕۆسەیەکی فەرمی، بەڵام گرنگی کەمی هەیە و کاریگەری نابێت لەسەر ئەوەی چی ڕوودەدات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Your acceptance into the club will be a mere formality.""",
                      kurdishText:
                          """پەسەندکردنت بۆ ناو یانەکە تەنها پڕۆسەی فەرمییە.""",
                      englishNote:
                          """This means that your acceptance into the club is certain and the official procedure is just a routine step.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He already knows he has the job so the interview is a mere formality.""",
                      kurdishText:
                          """پێشوەختە دەزانێت کە کارەکەی هەیە، بۆیە چاوپێکەوتنەکە تەنها شتێکی فەرمییە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Different levels of formality are appropriate in different situations.""",
                      kurdishText:
                          """ئاستی جیاوازی فەرمیەتی گونجاون لە دۆخی جیاوازدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/HBFMysfLlJU?t=';
const double _startSecondsend = 0000000000000000000000000003094;
const String _videoIdone = 'https://youtu.be/xu6ZRWp9rA4?t=';
const double _startSecondsone = 000000000000000000000000000717;
const String _videoIdtwo = 'https://youtu.be/_zZxCVBi7-k?t=';
const double _startSecondstwo = 000000000000000000000000000456;
const String _videoIdthree = 'https://youtu.be/3a3w-A0NUIg?t=';
const double _startSecondsthree = 0000000000000000000000000003341;
const String _videoIdfour = 'https://youtu.be/fmwXRE5fkjM?t=';
const double _startSecondsfour = 00000000000000000000000000035;
const String _videoIdfive = 'https://youtu.be/WKuE4a8XXjc?t=';
const double _startSecondsfive = 000000000000000000000000000419;
