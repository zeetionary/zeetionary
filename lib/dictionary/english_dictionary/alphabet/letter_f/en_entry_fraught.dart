...
class EnglishEntryfraught extends StatefulWidget {
  const EnglishEntryfraught({super.key});

  @override
  State<EnglishEntryfraught> createState() => _EnglishEntryfraughtState();
}

class _EnglishEntryfraughtState extends State<EnglishEntryfraught> {
  @override
  void initState() {
    super.initState();
...
2. Filled with or attended with (= pregnant)
"words fraught with meaning"; "an incident fraught with danger";
""",
  );

  final String keyword = "fraught";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fraught""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She looked/sounded fraught.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There was a fraught silence.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fraught""",
                      // alsoEnglishWord: "also: fraught",
                      britshText: """IpaUK: /frɔːt/""",
                      americanText: """IpaUS: /frɔːt/""",
...
// With short examples define "fraught", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The negotiations have been fraught with difficulties right from the start.""",
                      kurdishText:
                          """دانووستانەکان هەر لە سەرەتاوە پە لە سەختی بوونە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) هەستکردن بە نیگەرانی و سترێس"""),
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There was a fraught silence.""",
                      kurdishText: """بێ‌دەنگییەکی نیگەرانکەر بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/h8VHaNeuw3o?t=';
const double _startSecondsend = 000000000000000000000000000234;
const String _videoIdone = 'https://youtu.be/1ykJaIhCIWg?t=';
const double _startSecondsone = 00000000000000000000000000037;
const String _videoIdtwo = 'https://youtu.be/xRyPWG9PTm4?t=';
const double _startSecondstwo = 00000000000000000000000000091;
const String _videoIdthree = 'https://youtu.be/aJbdYcCFp50?t=';
const double _startSecondsthree = 000000000000000000000000000205;
const String _videoIdfour = 'https://youtu.be/DBG1Wgg32Ok?t=';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/B3VHd2D-SLM?t=';
const double _startSecondsfive = 000000000000000000000000000860;
