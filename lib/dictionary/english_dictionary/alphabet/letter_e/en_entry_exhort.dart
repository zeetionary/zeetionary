...
class EnglishEntryexhort extends StatefulWidget {
  const EnglishEntryexhort({super.key});

  @override
  State<EnglishEntryexhort> createState() => _EnglishEntryexhortState();
}

class _EnglishEntryexhortState extends State<EnglishEntryexhort> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exhort""",
                      // alsoEnglishWord: "also: exhort",
                      britshText: """IpaUK: /ɪɡˈzɔːt/""",
                      americanText: """IpaUS: /ɪɡˈzɔːrt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They had been exhorted to action.""");
  }
...
// With short examples define "exhort", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) هەوڵدانی زۆر بۆ ڕازیکردنی کەسێک تاوەکو شتێک بکات"""),
          SentencesRow(
            englishText:
                """The party leader exhorted his members to start preparing for government.""",
            kurdishText:
                """سەرکردەی پاریەکە هانی ئەندامەکانی دا کە ئامادەکاری بۆ حکومەت بکەن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """They had been exhorted to action.""",
            kurdishText: """هاندرا بوون بۆ هەنگاونان.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: exhort (Derived forms: exhorts, exhorting, exhorted)
1. Spur on or encourage especially by cheers and shouts (= cheer, root on [N. Amer, informal], inspire, urge, barrack [Austral, NZ], urge on)
"The crowd exhorted the demonstrating strikers";
 
2. Force or impel in an indicated direction (= urge, urge on, press)
"I exhorted him to finish his studies";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/ZBNps1piT7E?t=';
const double _startSecondsend = 000000000000000000000000000000; // 1626;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/nowsS7pMApI?t=';
const double _startSecondsone = 00000000000000000000000000000; // 288;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/1xVw6PsSinI?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1220;
const String _videoIdthree = 'VIDEOhttps://youtu.be/n_il3v50tM4?t=';
const double _startSecondsthree = 000000000000000000000000000; // 54;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/zPx5N6Lh3sw?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1573;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/LZ3fEUrqCxQ?t=';
