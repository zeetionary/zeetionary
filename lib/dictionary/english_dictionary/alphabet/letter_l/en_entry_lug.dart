...
class EnglishEntrylug extends StatefulWidget {
  const EnglishEntrylug({super.key});

  @override
  State<EnglishEntrylug> createState() => _EnglishEntrylugState();
}

class _EnglishEntrylugState extends State<EnglishEntrylug> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylug lug
WORD_WEB lug lug lug
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lug";
...
کوردی: 
"""),
// With short examples define "lug", please follow LX instructions
