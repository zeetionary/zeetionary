...
class EnglishEntryfbi extends StatefulWidget {
  const EnglishEntryfbi({super.key});

  @override
  State<EnglishEntryfbi> createState() => _EnglishEntryfbiState();
}

class _EnglishEntryfbiState extends State<EnglishEntryfbi> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """FBI""",
                      // alsoEnglishWord: "also: FBI",
                      britshText: """IpaUK: /ˌef biː ˈaɪ/""",
                      americanText: """IpaUS: /ˌef biː ˈaɪ/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The FBI was called in to solve the case.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) بەشی پۆلیسی ئەمریکا کە لەلایەن حکومەتی نیشتیمانی کۆنترۆڵ دەکرێت و ئەو تاوانانە چارەسەر دەکات کە لە زیاتر لە یەک ویلایەت ڕوویانداوە. کورتکراوەیەک بۆ Federal Bureau of Investigation"""),
          SentencesRow(
            englishText: """The FBI was called in to solve the case.""",
            kurdishText: """ئێف‌بی‌ئای بانگکرا بۆ چارەسەری کێشەکە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: FBI 
1. (law) a federal law enforcement agency that is the principal investigative arm of the Department of Justice (= Federal Bureau of Investigation)
""",
  );
...
const String _videoIdend = 'https://youtu.be/lilmwfmUIjQ?t=';
const double _startSecondsend = 00000000000000000000000000072;
const String _videoIdone = 'https://youtu.be/CCfV2a7b6MM?t=';
const double _startSecondsone = 000000000000000000000000000110;
const String _videoIdtwo = 'https://youtu.be/TuvSVH-UNAE?t=';
const double _startSecondstwo = 00000000000000000000000000045;
const String _videoIdthree = 'https://youtu.be/KDr1AEaBK98?t=';
const double _startSecondsthree = 00000000000000000000000000073;
const String _videoIdfour = 'https://youtu.be/8T7lEvtwETA?t=';
const double _startSecondsfour = 00000000000000000000000000042;
const String _videoIdfive = 'https://youtu.be/XpDjqbPyqRM?t=';
