...
class EnglishEntryinsanity extends StatefulWidget {
  const EnglishEntryinsanity({super.key});

  @override
  State<EnglishEntryinsanity> createState() => _EnglishEntryinsanityState();
}

class _EnglishEntryinsanityState extends State<EnglishEntryinsanity> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insanity""");
  }
