...
class EnglishEntryflavouring extends StatefulWidget {
  const EnglishEntryflavouring({super.key});

  @override
  State<EnglishEntryflavouring> createState() => _EnglishEntryflavouringState();
}

class _EnglishEntryflavouringState extends State<EnglishEntryflavouring> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flavouring (Derived forms: flavourings)
Usage: Brit, Cdn (US: flavoring) 
1. Something added to food primarily for the savour it imparts (= flavorer [US], flavourer [Brit, Cdn], flavoring [US], seasoner, seasoning, flavour [Brit, Cdn], flavor [US])
""",
  );

  final String keyword = "flavouring";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flavouring""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This food contains no artificial flavourings.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flavouring""",
                      // alsoEnglishWord: "also: flavouring",
                      britshText: """IpaUK: /ˈfleɪvərɪŋ/""",
                      americanText: """IpaUS: /ˈfleɪvərɪŋ/""",
...
کوردی: بەهارات، کاری، هەزوێلە، بۆن(یا تام)خۆشکەر
"""),
// With short examples define "flavouring", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەم خواردنە هیچ تامێکی دەستکردی تێدا نییە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/hA9n_eCFeWY?t=';
const double _startSecondsend = 00000000000000000000000000018;
const String _videoIdone = 'https://youtu.be/PziWjFeCjms?t=';
const double _startSecondsone = 000000000000000000000000000240;
const String _videoIdtwo = 'https://youtu.be/MeKIiVIctf4?t=';
const double _startSecondstwo = 000000000000000000000000000284;
const String _videoIdthree = 'https://youtu.be/TL1XJfo1VAg?t=';
const double _startSecondsthree = 000000000000000000000000000155;
const String _videoIdfour = 'https://youtu.be/pfJ9Kc5JCq0?t=';
const double _startSecondsfour = 000000000000000000000000000284;
const String _videoIdfive = 'https://youtu.be/rHMRTap9SGI?t=';
const double _startSecondsfive = 0000000000000000000000000001110;
