...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'OHnNOnk7CXI';
    const double startSecondsend = 161;
    const String videoIdone = 'gftHWQ6CLu8';
    const double startSecondsone = 251;
    const String videoIdtwo = 'Y8pIidfrSG4';
    const double startSecondstwo = 223;
    const String videoIdthree = '5mC0X9SUUVw';
    const double startSecondsthree = 550;
    const String videoIdfour = 'JTslqcXsFd4';
    const double startSecondsfour = 529;
    const String videoIdfive = '5Dq7lEw7CKM';
