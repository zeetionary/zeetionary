...
class EnglishEntryfistful extends StatefulWidget {
  const EnglishEntryfistful({super.key});

  @override
  State<EnglishEntryfistful> createState() => _EnglishEntryfistfulState();
}

class _EnglishEntryfistfulState extends State<EnglishEntryfistful> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
1. Noun: fistful (Derived forms: fistfuls)
1. The quantity that can be held in the hand (= handful)
"he flashed a fistful of bills of large denominations";
""",
  );

  final String keyword = "fistful";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fistful""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was holding a fistful of crumpled dollars.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fistful""",
                      // alsoEnglishWord: "also: fistful",
                      britshText: """IpaUK: /ˈfɪstfʊl/""",
                      americanText: """IpaUS: /ˈfɪstfʊl/""",
...
// With short examples define "fistful", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """He was holding a fistful of crumpled dollars.""",
                      kurdishText: """ئەو مشتێک دۆلاری چرچ و لۆچی هەڵگرتبوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/rUXG_p64Lzo?t=';
const double _startSecondsend = 000000000000000000000000000761;
const String _videoIdone = 'https://youtu.be/E2rtQFAibEA?t=';
const double _startSecondsone = 0000000000000000000000000003174;
const String _videoIdtwo = 'https://youtu.be/xHk0vkwM7mM?t=';
const double _startSecondstwo = 000000000000000000000000000823;
const String _videoIdthree = 'https://youtu.be/xxSyov0Hjz8?t=';
const double _startSecondsthree = 0000000000000000000000000001682;
const String _videoIdfour = 'https://youtu.be/ZuMoD0qdBDw?t=';
const double _startSecondsfour = 000000000000000000000000000299;
const String _videoIdfive = 'https://youtu.be/ZRJKde6lH88?t=';
