...
class EnglishEntrycasualty extends StatelessWidget {
  // blank divider
  EnglishEntrycasualty({super.key});
  // blank divider
  ...
  Future<void> speakcasualty(String languageCode) async {
    ...
    await flutterTts.speak("casualty"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcasualtys1(String languageCode) async {
    ...
    await flutterTts.speak(
        "Our primary objective is reducing road casualties."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcasualtys2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "Both sides had suffered heavy casualties."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcasualtys3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "Small shops have been a casualty of the recession."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcasualtys4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "She lost her job in 2011, a casualty of the recession."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcasualtys5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("The victims were rushed to casualty."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcasualtys6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcasualtys66"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcasualtys7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcasualtys77"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcasualtys8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcasualtys88"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcasualtys9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcasualtys99"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcasualtys10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcasualtys1010"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcasualtys11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcasualtys1111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcasualtys12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcasualtys1212"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcasualtys13(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcasualtys1313"); // DOPSUM: CHANGE TEXT
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "casualty"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈkæʒuəlti/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcasualty("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈkæʒuəlti/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcasualty("en-US"),
                            ),
                          ],
                        ),
                      ],
...
3. An accident that causes someone to die (= fatal accident)
 
4. (military) a decrease of military personnel or equipment
 
5. [Brit] Emergency department in a hospital or clinic, staffed and equipped to provide emergency care to people requiring immediate medical treatment (= emergency room [N. Amer], ER [N. Amer], A&E [Brit], accident and emergency [Brit], emergency [N. Amer])
""",
  );
...
class _YoutubeEmbeddedendState extends State<YoutubeEmbeddedend> {
  ...
  final String _videoId = 'FRri_EwEd1Q';
...
class _YoutubeEmbeddedoneState extends State<YoutubeEmbeddedone> {
  late YoutubePlayerController _controller;
  final String _videoId = 'dWs9a9bFzo4';
...
class _YoutubeEmbeddedtwoState extends State<YoutubeEmbeddedtwo> {
  late YoutubePlayerController _controller;
  final String _videoId = 'x6PutWIZwpU';
...
class _YoutubeEmbeddedthreeState extends State<YoutubeEmbeddedthree> {
  ...
  final double _startSeconds = 2208;
...
class _YoutubeEmbeddedfiveState extends State<YoutubeEmbeddedfive> {
  late YoutubePlayerController _controller;
  final String _videoId = '69YvS3ALths';
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  late YoutubePlayerController _controller;
  final String _videoId = 'Ro1-FkHX2zY';
...
class _YoutubeEmbeddedsevenState extends State<YoutubeEmbeddedseven> {
  late YoutubePlayerController _controller;
  final String _videoId = 'b-gOkb3Qe4I';
