...
// replace EnglishEntryAdopsummm - replace speakArmadillo

// replace armadillo - /ˌɑːməˈdɪləʊ/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarmadillo extends StatelessWidget {
  // blank divider
  EnglishEntryarmadillo({super.key});
  // blank divider
  ...
  Future<void> speakarmadillo(String languageCode) async {
    ...
    await flutterTts.speak("armadillo");
  }
  ...
  Future<void> speakarmadillo440(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I have never seen an armadillo.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "armadillo"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˌɑːməˈdɪləʊ/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˌɑːrməˈdɪləʊ/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '110iUX1Ursk';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'LFxRkS7V0sE';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'ezaXX8c2r20';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'PipGic1RIGs';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'aVIfmVK7AK4';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'No6mB6V1wL4';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '31Gk9p4mi70';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'n4pGi7RN_w8';
