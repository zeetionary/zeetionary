...
class EnglishEntryeradicate extends StatefulWidget {
  const EnglishEntryeradicate({super.key});

  @override
  State<EnglishEntryeradicate> createState() => _EnglishEntryeradicateState();
}

class _EnglishEntryeradicateState extends State<EnglishEntryeradicate> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""eradicate""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """eradicate""",
                      // alsoEnglishWord: "also: eradicate",
                      britshText: """IpaUK: /ɪˈrædɪkeɪt/""",
                      americanText: """IpaUS: /ɪˈrædɪkeɪt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "eradicate";
...
"""),
          const DefinitionKurdish(
              text: """١. (کردار) بە تەواوی کۆتایی هێنان بە شتێک"""),
          SentencesRow(
            englishText:
                """Diphtheria has been virtually eradicated in the United States.""",
            kurdishText:
                """نەخۆشی پێران یا ڕادەیەکی زۆر لە ئەمریکا بنبڕ کراوە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """سوورین لەسەر ئەوەی ڕەگەزپەرستی ڕیشەکێش بکەین لە وەرزشەکەمان.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: eradicate (Derived forms: eradicated, eradicates, eradicating)
1. Kill in large numbers (= eliminate, annihilate, extinguish, wipe out, decimate, carry off)
"the plague eradicated an entire population";
 
2. Remove, destroy or wipe out completely (= uproot, extirpate [formal], root out, exterminate)
"the vestiges of political democracy were soon eradicated";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/FWYsvw_U3Zw?t=';
const double _startSecondsend = 000000000000000000000000000000; // 36;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/EmT0i0xG6zg?t=';
const double _startSecondsone = 00000000000000000000000000000; // 4166;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/iQ5GfDbjos8?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 562;
const String _videoIdthree = 'VIDEOhttps://youtu.be/qgpYjwp-W84?t=';
const double _startSecondsthree = 000000000000000000000000000; // 104;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/fBTjbGfHx0s?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 605;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/sQ0WsP7osAU?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 2352;
