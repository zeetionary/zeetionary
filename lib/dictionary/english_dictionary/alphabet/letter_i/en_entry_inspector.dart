...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'eT_Gzi0HN4E';
    const double startSecondsend = 0;
    const String videoIdone = '1B9Kng2BN7s';
    const double startSecondsone = 1832;
    const String videoIdtwo = 'zz5MV_qB36Q';
    ...
    const double startSecondsfour = 1370;
    const String videoIdfive = 'wdLzMyqDuDY';
