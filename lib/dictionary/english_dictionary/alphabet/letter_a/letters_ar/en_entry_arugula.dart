...
class EnglishEntryarugula extends StatelessWidget {
  ...
  Future<void> speakarugula(String languageCode) async {
    ...
    await flutterTts.speak("arugula");
  }
  ...
  Future<void> speakarugula1018(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("I love the peppery flavor of arugula in salads.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arugula"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈruːɡjʊlə/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈruːɡələ/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'eOu2aLDGaMI';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'veel2QMC-Xc';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'y2R2fG4xZKo';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'p7SjToCrNYM';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Oh6i1Oirwq8';
  final double _startSeconds = 43;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'qu_SeiBzhAI';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'zi3oX4AruTo';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'mDTEpduTssc';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final double _startSeconds = 3377;
