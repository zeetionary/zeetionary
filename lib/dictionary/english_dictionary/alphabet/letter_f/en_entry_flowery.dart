...
class EnglishEntryflowery extends StatefulWidget {
  const EnglishEntryflowery({super.key});

  @override
  State<EnglishEntryflowery> createState() => _EnglishEntryfloweryState();
}

class _EnglishEntryfloweryState extends State<EnglishEntryflowery> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flowery 
1. Marked by elaborate rhetoric and elaborated with decorative details (= ornate)
"a flowery speech";
 
2. Of or relating to or suggestive of flowers
"a flowery hat"; "flowery wine"
""",
  );

  final String keyword = "flowery";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flowery""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The little girl twirled in her flowery dress.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She chose a flowery perfume for the special occasion.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She prefers clear instructions over flowery language.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flowery""",
                      // alsoEnglishWord: "also: flowery",
                      britshText: """IpaUK: /ˈflaʊəri/""",
                      americanText: """IpaUS: /ˈflaʊəri/""",
...
// With short examples define "flowery", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The little girl twirled in her flowery dress.""",
                      kurdishText:
                          """کچە بچکۆلەکە بە جلە گوڵدارەکەیەوە خولایەوە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) کە بۆن یان تامی گوڵی هەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She chose a flowery perfume for the special occasion.""",
                      kurdishText: """بۆنی گوڵی هەڵبژارد بۆ بۆنە تایبەتەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕێنمایی ڕوونی پێباشترە وەک لە زمانی ئاڵۆز.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/g9QneAV4fVo?t=';
const double _startSecondsend = 0000000000000000000000000001178;
const String _videoIdone = 'https://youtu.be/tkXtBNb5VzE?t=';
const double _startSecondsone = 000000000000000000000000000178;
const String _videoIdtwo = 'https://youtu.be/-wpHszfnJns?t=';
const double _startSecondstwo = 0000000000000000000000000001531;
const String _videoIdthree = 'https://youtu.be/NU4MgeOb-cc?t=';
const double _startSecondsthree = 0000000000000000000000000001380;
const String _videoIdfour = 'https://youtu.be/6d0caGV1eTg?t=';
const double _startSecondsfour = 000000000000000000000000000898;
const String _videoIdfive = 'https://youtu.be/25ycxcrep6Y?t=';
