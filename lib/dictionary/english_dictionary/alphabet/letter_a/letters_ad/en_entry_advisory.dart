...
// replace these: replace EnglishEntryadvisory - replace speakAdvisory - replace advisory - /ədˈvaɪzəri/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadvisory extends StatelessWidget {
  EnglishEntryadvisory({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdvisory(String languageCode) async {
    // DOPSUM: CHANGE speakAdvisory
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("advisory"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAdvi36511(String languageCode) async {
    ...
    await flutterTts.speak(
        "She is employed by the president in an advisory capacity."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "advisory", // DOPSUM: CHANGE WORD ENTRY - Find /ədˈvaɪzəri/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ədˈvaɪzəri/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ədˈvaɪzəri/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'QZSZPop_dxk';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'r7IPeilxCOE';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'e6v8QbpOCbs';
