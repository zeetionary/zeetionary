...
class EnglishEntryexcrete extends StatefulWidget {
  const EnglishEntryexcrete({super.key});

  @override
  State<EnglishEntryexcrete> createState() => _EnglishEntryexcreteState();
}

class _EnglishEntryexcreteState extends State<EnglishEntryexcrete> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""excrete""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """excrete""",
                      // alsoEnglishWord: "also: excrete",
                      britshText: """IpaUK: /ɪkˈskriːt/""",
                      americanText: """IpaUS: /ɪkˈskriːt/""",
...
کوردی: دەرهاویشتن، دەردان، دەرکردن
"""),
          const DefinitionKurdish(
              text: """١. (ناو) دەردانی پیسایی جەستە، چی شلە یان توند"""),
          SentencesRow(
            englishText:
                """Most toxins are naturally excreted from the body.""",
            kurdishText: """زۆرێک لە ژاراو بە سرووشتی دەردەدرێن لە جەستەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: excrete (Derived forms: excreted, excretes, excreting)
1. Expel from the body (= egest, eliminate, pass)
"excrete a kidney stone";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/Cpiy3XhxuFw?t=';
const double _startSecondsend = 000000000000000000000000000000; // 192;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/0n89GZvmeXI?t=';
const double _startSecondsone = 00000000000000000000000000000; // 32;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/HhSNbKezP64?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 446;
const String _videoIdthree = 'VIDEOhttps://youtu.be/TsNvYjJ_JcE?t=';
const double _startSecondsthree = 000000000000000000000000000; // 231;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/3CGhng_VviU?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 328;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/1h7KV2sjUWY?t=';
