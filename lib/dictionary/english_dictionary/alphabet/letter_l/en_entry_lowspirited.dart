...
class EnglishEntrylowspirited extends StatefulWidget {
  const EnglishEntrylowspirited({super.key});

  @override
  State<EnglishEntrylowspirited> createState() => _EnglishEntrylowspiritedState();
}

class _EnglishEntrylowspiritedState extends State<EnglishEntrylowspirited> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylowspirited low-spirited
WORD_WEB low-spirited low-spirited low-spirited
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "low-spirited";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""low-spirited""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """low-spirited""",
                      // alsoEnglishWord: "also: low-spirited",
...
کوردی: 
"""),
// With short examples define "low-spirited", please follow LX instructions
