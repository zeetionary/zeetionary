...
class EnglishEntryhearsay extends StatefulWidget {
  const EnglishEntryhearsay({super.key});

  @override
  State<EnglishEntryhearsay> createState() => _EnglishEntryhearsayState();
}

class _EnglishEntryhearsayState extends State<EnglishEntryhearsay> {
  @override
  void initState() {
    super.initState();
...
- Noun: hearsay (Derived forms: hearsays)
1. Gossip (usually a mixture of truth and untruth) passed around by word of mouth (- rumor [US], rumour [Brit, Cdn], furphy [Austral, informal])
""",
  );

  final String keyword = "hearsay";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hearsay""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We can't make a decision based on hearsay.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They started to piece the story together from hearsay.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hearsay""",
                      // alsoEnglishWord: "also: hearsay",
                      britshText: """IpaUK: /ˈhɪəseɪ/""",
                      americanText: """IpaUS: /ˈhɪrseɪ/""",
...
کوردی: قسەڵۆک، گوت‌گوتک، شافە، دەنگۆ، قسەوباسی سەرزار
"""),
// With short examples define "hearsay", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەو شتانەی لە خەڵکی دیکەوە دەیبیستیت بەڵام دڵنیا نیت کە ڕاستن"""),
                    SentencesRow(
                      englishText:
                          """We can't make a decision based on hearsay.""",
                      kurdishText:
                          """ناتوانین بڕیارێک بدەین بە پشتبەستن بە قسەڵۆک.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەستی کرد بەوەی چیرۆکەکە پێکەوە بنێت بە پشتبەستن بە قسەڵۆک.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/LJUl77rsFEw?t=';
const double _startSecondsend = 000000000000000000000000000643;
const String _videoIdone = 'https://youtu.be/Bh9lIfocRMk?t=';
const double _startSecondsone = 000000000000000000000000000858;
const String _videoIdtwo = 'https://youtu.be/tExo3ovEBWQ?t=';
const double _startSecondstwo = 000000000000000000000000000856;
const String _videoIdthree = 'https://youtu.be/hA95iw4B2jg?t=';
const double _startSecondsthree = 000000000000000000000000000138;
const String _videoIdfour = 'https://youtu.be/NU4MgeOb-cc?t=';
const double _startSecondsfour = 0000000000000000000000000001577;
const String _videoIdfive = 'https://youtu.be/ltnl4USwPs8?t=';
const double _startSecondsfive = 0000000000000000000000000001559;
