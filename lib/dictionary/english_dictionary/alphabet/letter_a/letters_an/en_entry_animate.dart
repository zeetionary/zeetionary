                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "animate"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈænɪmeɪt/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakanimate("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈænɪmeɪt/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakanimate("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'v7L0nvzmfdE';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '2FsSp7R2zT0';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'eivn-6ayGT4';
