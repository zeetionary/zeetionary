...
class EnglishEntryinescapable extends StatefulWidget {
  const EnglishEntryinescapable({super.key});

  @override
  State<EnglishEntryinescapable> createState() =>
      _EnglishEntryinescapableState();
}

class _EnglishEntryinescapableState extends State<EnglishEntryinescapable> {
  @override
  void initState() {
    super.initState();
...
1. Impossible to avoid or evade (- ineluctable, unavoidable, ineludible [archaic])
"inescapable conclusion";
""",
  );

  final String keyword = "inescapable";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inescapable""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/qr4MSVxfYBE?t=';
    const double startSecondsend = 00000000000000000000000000043;
    const String videoIdone = 'https://youtu.be/5jh9JSzNbOA?t=';
    const double startSecondsone = 000000000000000000000000000891;
    const String videoIdtwo = 'https://youtu.be/8jNs5G88TiI?t=';
    const double startSecondstwo = 00000000000000000000000000034;
    const String videoIdthree = 'https://youtu.be/UShsgCOzER4?t=';
    const double startSecondsthree = 00000000000000000000000000059;
    const String videoIdfour = 'https://youtu.be/HhSNbKezP64?t=';
    const double startSecondsfour = 000000000000000000000000000574;
    const String videoIdfive = 'https://youtu.be/YEhUUQQekkQ?t=';
    const double startSecondsfive = 00000000000000000000000000048;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inescapable""",
                      // alsoEnglishWord: "also: inescapable",
                      britshText: """IpaUK: /ˌɪnɪˈskeɪpəbl/""",
                      americanText: """IpaUS: /ˌɪnɪˈskeɪpəbl/""",
...
کوردی: لێ‌دەربازنەبوو، ناچاری، ناتوانی لەی دەرباز بی، دیاری‌کراو، چارە نییە، دووری‌لێ‌نەکراو، چارەنەهاتوو، لێ‌هەڵنەهاتوو
"""),
// With short examples define "inescapable", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە ناتوانیت لێی دوور بیت یان پشتگوێی بخەیت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: unavoidable"),
                    SentencesRow(
                      englishText:
                          """This leads to the inescapable conclusion that the two things are connected.""",
                      kurdishText:
                          """ئەمە دەگات بەو دەرەنجامە حەتمییەی کە دوو شتەکە پەیوەستن.""",
