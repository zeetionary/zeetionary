...
const double _startSecondsend = 000000000000000000000000000528;
const String _videoIdone = 'https://youtu.be/MnExgQ81fhU?t=';
const double _startSecondsone = 000000000000000000000000000383;
const String _videoIdtwo = 'https://youtu.be/V1PABydQ668?t=';
const double _startSecondstwo = 000000000000000000000000000100;
const String _videoIdthree = 'https://youtu.be/Zad6v8ZHzdg?t=';
const double _startSecondsthree = 000000000000000000000000000680;
const String _videoIdfour = 'https://youtu.be/b_rjBWmc1iQ?t=';
const double _startSecondsfour = 0000000000000000000000000005016;
const String _videoIdfive = 'https://youtu.be/Unzc731iCUY?t=';
const double _startSecondsfive = 0000000000000000000000000001445;
