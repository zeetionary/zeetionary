...
// replace these: EnglishEntryabsolutemajority - speakAbsolutemajority - absolute majority - /ˌæbsəluːt məˈdʒɒrəti/

enum TtsState { playing }

class EnglishEntryabsolutemajority extends StatelessWidget {
  EnglishEntryabsolutemajority({Key? key}) : super(key: key);
  ...
  Future<void> speakAbsolutemajority(String languageCode) async {
    ...
    await flutterTts.speak("absolute majority"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakA2147(String languageCode) async {
    ...
    await flutterTts.speak(
        "280 seats are needed for an absolute majority in the National Assembly."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌæbsəluːt məˈdʒɒrəti/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'OTDY--Qb72E';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'KYVw9lPiCHQ';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'ozj-ZZMXP0c';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'WH6S0EukOG4';
