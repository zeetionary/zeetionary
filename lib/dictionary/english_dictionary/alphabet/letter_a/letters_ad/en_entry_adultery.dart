...
// replace these: replace EnglishEntryadultery - replace speakAdultery - replace adultery - /əˈdʌltəri/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadultery extends StatelessWidget {
  EnglishEntryadultery({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdultery(String languageCode) async {
    // DOPSUM: CHANGE speakAdultery
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("adultery"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAdult53891(String languageCode) async {
    // DOPSUM: CHANGE speakAdultery
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("He was accused of committing adultery."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "adultery", // DOPSUM: CHANGE WORD ENTRY - Find /əˈdʌltəri/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈdʌltəri/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /əˈdʌltəri/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'Ziw3-XfNKd8';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'm7A6bUFZ29c';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'ouAhDiJKXgs';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'Qia6xHBS-Ww';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'eYcMU1P33g0';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 't6sh5aUUY7w';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'iDGCrGSFAiU';
