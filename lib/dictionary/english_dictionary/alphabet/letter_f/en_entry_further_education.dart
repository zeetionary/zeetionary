...
class EnglishEntryfurthereducation extends StatefulWidget {
  const EnglishEntryfurthereducation({super.key});

  @override
  State<EnglishEntryfurthereducation> createState() =>
      _EnglishEntryfurthereducationState();
}

class _EnglishEntryfurthereducationState
    extends State<EnglishEntryfurthereducation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: further education (Derived forms: further educations)
Usage: Brit
1. Education for people who have left school but do not go to university
""",
  );

  final String keyword = "further education";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""further education""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She teaches at a college of further education.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: further education",
                      britshText: """IpaUK: /ˌfɜːðər edʒuˈkeɪʃn/""",
                      americanText: """IpaUS: /ˌfɜːrðər edʒuˈkeɪʃn/""",
...
// With short examples define "further education", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """She teaches at a college of further education.""",
                      kurdishText:
                          """لە کۆلێژێکی خوێندنی نازانکۆیی وانە دەڵێتەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/zmvbSoO0Qq4?t=';
const double _startSecondsend = 000000000000000000000000000233;
const String _videoIdone = 'https://youtu.be/0VI57viMdps?t=';
const double _startSecondsone = 0000000000000000000000000003499;
const String _videoIdtwo = 'https://youtu.be/9DRZUPrSayg?t=';
const double _startSecondstwo = 0000000000000000000000000001000;
const String _videoIdthree = 'https://youtu.be/QoqjGUIk5NE?t=';
const double _startSecondsthree = 0000000000000000000000000001482;
const String _videoIdfour = 'https://youtu.be/VwhxSCmUoJQ?t=';
const double _startSecondsfour = 0000000000000000000000000005783;
const String _videoIdfive = 'https://youtu.be/C_IurzJsQtE?t=';
