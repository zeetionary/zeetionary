...
class EnglishEntryfarmersmarket extends StatefulWidget {
  const EnglishEntryfarmersmarket({super.key});

  @override
  State<EnglishEntryfarmersmarket> createState() =>
      _EnglishEntryfarmersmarketState();
}

class _EnglishEntryfarmersmarketState extends State<EnglishEntryfarmersmarket> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""farmer's market""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: farmer's market",
                      britshText: """IpaUK: /ˈfɑːməz mɑːkɪt/""",
                      americanText: """IpaUS: /ˈfɑːrmərz mɑːrkɪt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "farmer's market";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She buys fresh vegetables at the farmer's market.""");
  }
...
"""),
          ...
          SentencesRow(
            ...
            kurdishText: """سەوزەی تازە دەکڕێت لە بازاڕی جوتیاران.""",
...
const String _videoIdend = 'https://youtu.be/qO--hy6Q-LA?t=';
const double _startSecondsend = 000000000000000000000000000161;
const String _videoIdone = 'https://youtu.be/417Qbwn9yso?t=';
const double _startSecondsone = 000000000000000000000000000669;
const String _videoIdtwo = 'https://youtu.be/SP_3sVbvK6Y?t=';
const double _startSecondstwo = 000000000000000000000000000465;
const String _videoIdthree = 'https://youtu.be/67yX1C4gaDA?t=';
const double _startSecondsthree = 00000000000000000000000000028;
const String _videoIdfour = 'https://youtu.be/m58_ky4kNxk?t=';
const double _startSecondsfour = 000000000000000000000000000176;
const String _videoIdfive = 'https://youtu.be/J214OrZYJmA?t=';
const double _startSecondsfive = 000000000000000000000000000341;
