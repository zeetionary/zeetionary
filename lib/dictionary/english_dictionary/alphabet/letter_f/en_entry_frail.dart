...
class EnglishEntryfrail extends StatefulWidget {
  const EnglishEntryfrail({super.key});

  @override
  State<EnglishEntryfrail> createState() => _EnglishEntryfrailState();
}

class _EnglishEntryfrailState extends State<EnglishEntryfrail> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: frail (Derived forms: frailest, frailer)
1. Physically weak
"an invalid's frail body"
 
2. Wanting in moral strength, courage, or will; having the attributes of man as opposed to e.g. divine beings (= fallible, imperfect, weak)
"frail humanity";
 
3. Easily broken, damaged or destroyed (= delicate, fragile)
"a frail craft";

- Noun: frail (Derived forms: frails)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Mother was becoming too frail to live alone.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She looked old and frail.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His frail hands were shaking.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Human nature is frail.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frail""",
                      // alsoEnglishWord: "also: frail",
                      britshText: """IpaUK: /freɪl/""",
                      americanText: """IpaUS: /freɪl/""",
...
کوردی: کز، ڕەقەڵ، سست، لاواز، بێ‌هێز، بێ‌بنگە، بێ‌ڕەگ،	زووشکاو، ناسک، تورت، هەڵپەڕیو،	کەم، پرزۆڵ، کەموسکە
"""),
// With short examples define "frail", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دایکە زۆر لاواز دەبوو تاوەکو بە تەنها بژی.""",
                    ...
                    SentencesRow(
                      englishText: """She looked old and frail.""",
                      kurdishText: """بەتەمەن و لاواز دەردەکەوت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """His frail hands were shaking.""",
                      kurdishText: """دەستە لاوازەکانی دەلەرزین.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/pLUy9VzwnyM?t=';
const double _startSecondsend = 000000000000000000000000000365;
const String _videoIdone = 'https://youtu.be/1KgSp94nCZw?t=';
const double _startSecondsone = 000000000000000000000000000443;
const String _videoIdtwo = 'https://youtu.be/VpnandCVKXU?t=';
const double _startSecondstwo = 00000000000000000000000000056;
const String _videoIdthree = 'https://youtu.be/AwodL8z2EtE?t=';
const double _startSecondsthree = 000000000000000000000000000263;
const String _videoIdfour = 'https://youtu.be/1lOd7rDFYbc?t=';
const double _startSecondsfour = 00000000000000000000000000048;
const String _videoIdfive = 'https://youtu.be/2Kf-H4L67W8?t=';
const double _startSecondsfive = 000000000000000000000000000782;
