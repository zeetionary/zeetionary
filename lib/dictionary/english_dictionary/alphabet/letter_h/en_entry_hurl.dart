...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/NZ74oFctP_g';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/58XEfDtU0Z4?t=';
    const double startSecondsone = 000000000000000000000000000569;
    const String videoIdtwo = 'https://youtu.be/jTRC_FMzLoo?t=';
    const double startSecondstwo = 000000000000000000000000000358;
    const String videoIdthree = 'https://youtu.be/K1uxO79V-II?t=';
    const double startSecondsthree = 00000000000000000000000000078;
    const String videoIdfour = 'https://youtu.be/PhQksV8fbKw?t=';
    const double startSecondsfour = 0000000000000000000000000001340;
    const String videoIdfive = 'https://youtu.be/OL7e2eW-aOA?t=';
