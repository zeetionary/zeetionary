...
class EnglishEntrylicense extends StatefulWidget {
  const EnglishEntrylicense({super.key});

  @override
  State<EnglishEntrylicense> createState() => _EnglishEntrylicenseState();
}

class _EnglishEntrylicenseState extends State<EnglishEntrylicense> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylicense license
WORD_WEB license license license
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "license";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""license""");
  }
...
کوردی: 
"""),
// With short examples define "license", please follow LX instructions
