...
class EnglishEntryflammable extends StatefulWidget {
  const EnglishEntryflammable({super.key});

  @override
  State<EnglishEntryflammable> createState() => _EnglishEntryflammableState();
}

class _EnglishEntryflammableState extends State<EnglishEntryflammable> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flammable
1. Easily ignited (= inflammable)
"Some solvents readily evaporate and are highly flammable";
""",
  );

  final String keyword = "flammable";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flammable""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""These materials are highly flammable.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flammable""",
                      // alsoEnglishWord: "also: flammable",
                      britshText: """IpaUK: /ˈflæməbl/""",
                      americanText: """IpaUS: /ˈflæməbl/""",
...
کوردی: گڕکێش، ئاگرگرتوو، زووگرتوو، لەگڕگرتن‌هاتوو، لەداگیرسان‌هاتوو، بە ئاسانی ئاور دەگرێ
"""),
// With short examples define "flammable", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە بە ئاسانی ئاگر دەگرێت"""),
                    SentencesRow(
                      englishText: """These materials are highly flammable.""",
                      kurdishText: """ئەم مادانە زۆر گڕگڕتوون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Bbi0kEaTgio?t=';
const double _startSecondsend = 0000000000000000000000000001059;
const String _videoIdone = 'https://youtu.be/XEOzx3_C0oo?t=';
const double _startSecondsone = 000000000000000000000000000264;
const String _videoIdtwo = 'https://youtu.be/7k2pnj-Zy4s?t=';
const double _startSecondstwo = 000000000000000000000000000101;
const String _videoIdthree = 'https://youtu.be/yUYxk-y-tU8?t=';
const double _startSecondsthree = 00000000000000000000000000033;
const String _videoIdfour = 'https://youtu.be/qypTsTciYFc?t=';
