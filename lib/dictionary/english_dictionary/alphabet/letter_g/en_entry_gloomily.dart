...
class EnglishEntrygloomily extends StatefulWidget {
  const EnglishEntrygloomily({super.key});

  @override
  State<EnglishEntrygloomily> createState() => _EnglishEntrygloomilyState();
}

class _EnglishEntrygloomilyState extends State<EnglishEntrygloomily> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gloomily""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He stared gloomily at the phone.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Kelly shook her head gloomily.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gloomily""",
                      // alsoEnglishWord: "also: gloomily",
                      britshText: """IpaUK: /ˈɡluːmɪli/""",
                      americanText: """IpaUS: /ˈɡluːmɪli/""",
...
// With short examples define "gloomily", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) بە دڵتەنگی و بێ‌هیوایی"""),
                    SentencesRow(
                      englishText: """He stared gloomily at the phone.""",
                      kurdishText: """بە دڵتەنگییەوە لە تەلەفۆنەکەی دەڕوانی.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Kelly shook her head gloomily.""",
                      kurdishText: """کێڵی بە بێ‌هیواییەوە سەری لەقاند.""",
...
const double _startSecondsend = 000000000000000000000000000226;
const String _videoIdone = 'https://youtu.be/TewAbpe8RAg?t=';
const double _startSecondsone = 0000000000000000000000000001159;
const String _videoIdtwo = 'https://youtu.be/TpQsJdoKSr4?t=';
const double _startSecondstwo = 000000000000000000000000000594;
const String _videoIdthree = 'https://youtu.be/Jg24PWpdlSQ?t=';
const double _startSecondsthree = 000000000000000000000000000705;
const String _videoIdfour = 'https://youtu.be/qPk7P8YXpoM?t=';
const double _startSecondsfour = 00000000000000000000000000090;
const String _videoIdfive = 'https://youtu.be/WYLTAwxmQ6U?t=';
const double _startSecondsfive = 000000000000000000000000000488;
