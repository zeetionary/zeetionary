...
class EnglishEntryaccordingly extends StatefulWidget {
  const EnglishEntryaccordingly({super.key});

  @override
  State<EnglishEntryaccordingly> createState() => _EnglishEntryaccordinglyState();
}

class _EnglishEntryaccordinglyState extends State<EnglishEntryaccordingly> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "accordingly";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accordingly""",
                      // alsoEnglishWord: "also: accordingly",
                      britshText: """IpaUK: /əˈkɔːdɪŋli/""",
                      americanText: """IpaUS: /əˈkɔːrdɪŋli/""",
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '8mAITcNt710';
  final double _startSeconds = 4480;
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'nOyvyEUvjVA';
