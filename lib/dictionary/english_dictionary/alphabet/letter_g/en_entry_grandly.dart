...
class EnglishEntrygrandly extends StatefulWidget {
  const EnglishEntrygrandly({super.key});

  @override
  State<EnglishEntrygrandly> createState() => _EnglishEntrygrandlyState();
}

class _EnglishEntrygrandlyState extends State<EnglishEntrygrandly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: grandly
1. In a grand manner (= - imposingly)
"the mansion seemed grandly large by today's standards";
""",
  );

  final String keyword = "grandly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grandly""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Their house is very grandly furnished.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grandly""",
                      // alsoEnglishWord: "also: grandly",
                      britshText: """IpaUK: /ˈɡrændli/""",
                      americanText: """IpaUS: /ˈɡrændli/""",
...
// With short examples define "grandly", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """She announced grandly that she was spending Christmas in the Caribbean.""",
                      kurdishText:
                          """بە شکۆوە ئەوەی ڕاگەیاند کە کریسمس لە کاریبی بەسەر دەبات.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بە شێوەیەک کە پێویستی بە هەوڵ، پارە، و کاتی زۆر هەیە بۆ سەرکەوتن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Their house is very grandly furnished.""",
                      kurdishText:
                          """خانووەکەیان زۆر شکۆمەندانە کەلووپەلی ماڵی تێدا دانراوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/WJBA1bidwis?t=';
const double _startSecondsend = 000000000000000000000000000346;
const String _videoIdone = 'https://youtu.be/hmpBODRtwfw?t=';
const double _startSecondsone = 000000000000000000000000000150;
const String _videoIdtwo = 'https://youtu.be/AU8TveIz61E?t=';
const double _startSecondstwo = 00000000000000000000000000028;
const String _videoIdthree = 'https://youtu.be/RWS5Ru8QNig?t=';
const double _startSecondsthree = 00000000000000000000000000092;
const String _videoIdfour = 'https://youtu.be/GYNoy7Bd-kM?t=';
const double _startSecondsfour = 000000000000000000000000000379;
const String _videoIdfive = 'https://youtu.be/rLibXEawkTI?t=';
