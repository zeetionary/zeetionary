...
class EnglishEntryhighcommissioner extends StatefulWidget {
  const EnglishEntryhighcommissioner({super.key});

  @override
  State<EnglishEntryhighcommissioner> createState() =>
      _EnglishEntryhighcommissionerState();
}

class _EnglishEntryhighcommissionerState
    extends State<EnglishEntryhighcommissioner> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: High Commissioner (Derived forms: High Commissioners)
1. A senior diplomat from one country to another who is assigned ambassadorial rank
""",
  );

  final String keyword = "High Commissioner";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""High Commissioner""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """He was issued with a new passport by the British High Commissioner and allowed to return to the UK.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak(
        """She worked with the United Nations High Commissioner for Refugees in Africa.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: High Commissioner",
                      britshText: """IpaUK: /ˌhaɪ kəˈmɪʃənə(r)/""",
                      americanText: """IpaUS: /ˌhaɪ kəˈmɪʃənər/""",
...
// With short examples define "High Commissioner", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە لەلایەن وڵاتێکەوە دەنێردرێت بۆ وڵاتێکی دیکە بۆ پاراستنی بەرژەوەندییەکانی وڵاتەکەی خۆی (کە هەردوو وڵاتەکە سەر بە ئیمپراتۆرییەتی کۆنی بەریتانین)"""),
                    SentencesRow(
                      englishText:
                          """He was issued with a new passport by the British High Commissioner and allowed to return to the UK.""",
                      kurdishText:
                          """پاسپۆرتی تازەی لەلایەن کۆمسیاری باڵای بەریتانیا پێدرا و ڕێگا درا بگەڕێتەوە بۆ شانشینی یەکگرتوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) کەسێک کە بەرپرسی پڕۆژەیەکی نێودەوڵەتی گرنگە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She worked with the United Nations High Commissioner for Refugees in Africa.""",
                      kurdishText:
                          """لەگەڵ کۆمسیاری باڵای نەتوە یەکگرتووکان بۆ پەنابەران لە ئەفریقا کاری کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/SgiXLwTAyXU?t=';
const double _startSecondsend = 000000000000000000000000000431;
const String _videoIdone = 'https://youtu.be/1X_KdkoGxSs?t=';
const double _startSecondsone = 00000000000000000000000000016603;
const String _videoIdtwo = 'https://youtu.be/WrKwysaZIww?t=';
const double _startSecondstwo = 000000000000000000000000000944;
const String _videoIdthree = 'https://youtu.be/hh9xT9d6SJU?t=';
const double _startSecondsthree = 0000000000000000000000000001476;
const String _videoIdfour = 'https://youtu.be/VvWQ4w1VFBE?t=';
const double _startSecondsfour = 000000000000000000000000000330;
const String _videoIdfive = 'https://youtu.be/tf0xtR7Py1Y?t=';
const double _startSecondsfive = 000000000000000000000000000812;
