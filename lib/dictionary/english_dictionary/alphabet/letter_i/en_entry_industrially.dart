...
class EnglishEntryindustrially extends StatefulWidget {
  const EnglishEntryindustrially({super.key});

  @override
  State<EnglishEntryindustrially> createState() =>
      _EnglishEntryindustriallyState();
}

class _EnglishEntryindustriallyState extends State<EnglishEntryindustrially> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "industrially";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""industrially""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""At present, coffee is decaffeinated industrially.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """I don't like those fancy bags of industrially produced salad.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/ImpROVueIcE?t=';
    const double startSecondsend = 0000000000000000000000000005;
    const String videoIdone = 'https://youtu.be/2VrsmahNcfI?t=';
    const double startSecondsone = 0000000000000000000000000001699;
    const String videoIdtwo = 'https://youtu.be/AiZd5yBWvYY?t=';
    const double startSecondstwo = 000000000000000000000000000707;
    const String videoIdthree = 'https://youtu.be/eIpDILFHTBw?t=';
    const double startSecondsthree = 000000000000000000000000000654;
    const String videoIdfour = 'https://youtu.be/vo04BNTNm1c?t=';
    const double startSecondsfour = 000000000000000000000000000262;
    const String videoIdfive = 'https://youtu.be/y5AApxSzlyY?t=';
    const double startSecondsfive = 0000000000000000000000000003;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """industrially""",
                      // alsoEnglishWord: "also: industrially",
                      britshText: """IpaUK: /ɪnˈdʌstriəli/""",
                      americanText: """IpaUS: /ɪnˈdʌstriəli/""",
...
// کوردی: لەباری پیشەسازی(یەوە)
// """),
// With short examples define "industrially", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە بەکارهێنانی پڕۆسەی پیشەسازی"""),
                    SentencesRow(
                      englishText:
                          """At present, coffee is decaffeinated industrially.""",
                      kurdishText:
                          """لە ئێستادا، قاوە بە پڕۆسەی پیشەسازییانە کافینی لێ دەردەکرێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بە شێوەیەک کە پیشەسازییەکان لەخۆ دەگرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I don't like those fancy bags of industrially produced salad.""",
                      kurdishText:
                          """حەزم بەو کیسە باق و بریقانەی زەڵاتەی بە پیشەسازی درووستکراو نییە.""",
