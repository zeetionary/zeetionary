...
class EnglishEntrylethargy extends StatefulWidget {
  const EnglishEntrylethargy({super.key});

  @override
  State<EnglishEntrylethargy> createState() => _EnglishEntrylethargyState();
}

class _EnglishEntrylethargyState extends State<EnglishEntrylethargy> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lethargy""");
  }
