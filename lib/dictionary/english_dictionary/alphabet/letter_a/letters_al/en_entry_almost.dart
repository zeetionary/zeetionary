...
class EnglishEntryalmost extends StatelessWidget {
  EnglishEntryalmost({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakalmost(String languageCode) async {
    // DOPSUM: CHANGE speakAlmost
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɔːlməʊst/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɔːlməʊst/"),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'dOOYvTc2vgA';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'l5XP6T7xqek';
