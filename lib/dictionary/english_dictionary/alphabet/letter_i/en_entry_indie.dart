...
class EnglishEntryindie extends StatefulWidget {
  const EnglishEntryindie({super.key});

  @override
  State<EnglishEntryindie> createState() => _EnglishEntryindieState();
}

class _EnglishEntryindieState extends State<EnglishEntryindie> {
  @override
  void initState() {
    super.initState();
...
2. (of a company, developer, etc.) small and independent (not owned by a larger company or publisher)
"Every gamer is a potential indie developer"

- Noun: indie (Derived forms: indies)
...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/FaNatwnARUQ?t=';
    const double startSecondsend = 00000000000000000000000000092;
    const String videoIdone = 'https://youtu.be/kawym8ZwhwA?t=';
    const double startSecondsone = 00000000000000000000000000021;
    const String videoIdtwo = 'https://youtu.be/tExo3ovEBWQ?t=';
    const double startSecondstwo = 000000000000000000000000000140;
    const String videoIdthree = 'https://youtu.be/XnNk647Ko0E?t=';
    const double startSecondsthree = 000000000000000000000000000502;
    const String videoIdfour = 'https://youtu.be/bUia-EbqS7A?t=';
    const double startSecondsfour = 00000000000000000000000000049;
    const String videoIdfive = 'https://youtu.be/NOXSz3nJgTs?t=';
    const double startSecondsfive = 000000000000000000000000000289;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indie""",
                      // alsoEnglishWord: "also: indie",
                      britshText: """IpaUK: /ˈɪndi/""",
                      americanText: """IpaUS: /ˈɪndi/""",
...
کوردی: 
"""),
// With short examples define "indie", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە سەربەخۆیە و سەر بە کۆمپانیا یان دامەزراوەیەک نییە"""),
                    SentencesRow(
                      englishText:
                          """Indie filmmakers and musicians both rely heavily on festivals.""",
                      kurdishText:
                          """بەرهەمهێنەرانی فیلم و میوزیکژەنە سەربەخۆکان بە قورسی پشت دەبەسستن بە فیستیڤاڵەکان.""",
