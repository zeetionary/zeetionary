...
class EnglishEntryglut extends StatefulWidget {
  const EnglishEntryglut({super.key});

  @override
  State<EnglishEntryglut> createState() => _EnglishEntryglutState();
}

class _EnglishEntryglutState extends State<EnglishEntryglut> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The market has been glutted with foreign cars.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glut""",
                      // alsoEnglishWord: "also: glut",
                      britshText: """IpaUK: /ɡlʌt/""",
                      americanText: """IpaUS: /ɡlʌt/""",
...
// With short examples define "glut", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) دۆخێک کە تێیدا زۆر لە شتێک هەیە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: surfeit"),
                    SentencesRow(
                      englishText:
                          """The fall in demand for coffee could cause a glut on/in the market.""",
                      kurdishText:
                          """کەمبوونەوەی خواست لەسەر قاوە دەکرێت ببێتە هۆک زەبەنی لە بازاڕدا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The current glut of graduates means that many of them will not be able to find jobs.""",
                      kurdishText:
                          """زەبەنی زۆری دەرچووانی زانکۆ واتا ژمارەیەکی زۆریان دەکرێت کار نەدۆزنەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بازاڕ پڕکراوە لە ئۆتۆمبێلی بیانی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/CMkYw4dp_NI?t=';
const double _startSecondsend = 000000000000000000000000000318;
const String _videoIdone = 'https://youtu.be/gIhCuqtC0r0?t=';
const double _startSecondsone = 000000000000000000000000000190;
const String _videoIdtwo = 'https://youtu.be/9TjUWnAK0cg?t=';
const double _startSecondstwo = 0000000000000000000000000007;
const String _videoIdthree = 'https://youtu.be/TQqgf8kB6R8?t=';
const double _startSecondsthree = 000000000000000000000000000238;
const String _videoIdfour = 'https://youtu.be/oXfzWRXMOKg?t=';
const double _startSecondsfour = 000000000000000000000000000435;
const String _videoIdfive = 'https://youtu.be/jPJje65SnJY?t=';
