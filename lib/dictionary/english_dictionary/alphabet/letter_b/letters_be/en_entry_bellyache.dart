...
// Define the word "bellyache" and provide five simple example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings or more.

// replace bellyache - replace EnglishEntrybellyache

// replace speakBellyache - /ˈbelieɪk/

enum TtsState { playing }

class EnglishEntrybellyache extends StatelessWidget {
// blank divider
  EnglishEntrybellyache({super.key});
// blank divider
  ...
  Future<void> speakbellyache(String languageCode) async {
    ...
    await flutterTts.speak("bellyache");
  }
  ...
  Future<void> speakbellyaches1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I’ve got (a) bellyache.");
  }
  ...
  Future<void> speakbellyaches2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("He’s always bellyaching about how much work he has to do.");
  }
  ...
  Future<void> speakbellyaches3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBellyaches33");
  }
  ...
  Future<void> speakbellyaches4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBellyaches44");
  }
  ...
  Future<void> speakbellyaches5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBellyaches55");
  }
  ...
  Future<void> speakbellyaches6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBellyaches66");
  }
  ...
  Future<void> speakbellyaches7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBellyaches77");
  }
...
Usage: informal
1. An ache localized in the stomach or abdominal region (= stomachache, stomach ache, gastralgia)

- Verb: bellyache
Usage: informal
1. Complain (= gripe, bitch [informal], grouse, crab [informal], beef [informal], squawk, holler [informal])
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '_wWI3Efv9Zg';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'A9b-Z___neA';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '3ppYKAGTZj4';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'm4rCurNdW1w';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Qi1-3PzoVfk';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'AUQOUChTUwg';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'HiolEzoofpk';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'EC3Lm-_b0YI';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'cofdZJJXguw';
...
// end bellyache// TODO Implement this library.
