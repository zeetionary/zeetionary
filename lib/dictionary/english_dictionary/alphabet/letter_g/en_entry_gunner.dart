...
class EnglishEntrygunner extends StatefulWidget {
  const EnglishEntrygunner({super.key});

  @override
  State<EnglishEntrygunner> createState() => _EnglishEntrygunnerState();
}

class _EnglishEntrygunnerState extends State<EnglishEntrygunner> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gunner (Derived forms: gunners)
1. A serviceman in the artillery (- artilleryman, cannoneer, machine gunner)
""",
  );

  final String keyword = "gunner";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The tank’s gunner fired at the enemy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gunner""",
                      // alsoEnglishWord: "also: gunner",
                      britshText: """IpaUK: /ˈɡʌnə(r)/""",
                      americanText: """IpaUS: /ˈɡʌnər/""",
