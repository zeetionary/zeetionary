...
class EnglishEntryineffectively extends StatefulWidget {
  const EnglishEntryineffectively({super.key});

  @override
  State<EnglishEntryineffectively> createState() =>
      _EnglishEntryineffectivelyState();
}

class _EnglishEntryineffectivelyState extends State<EnglishEntryineffectively> {
  @override
  void initState() {
    super.initState();
...
1. In an ineffective manner (- inefficaciously)
"he dealt with the problem rather ineffectively";
""",
  );

  final String keyword = "ineffectively";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ineffectively""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The government is dealing ineffectively with these economic problems.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/RFcfJm3SqGk?t=';
    const double startSecondsend = 0000000000000000000000000001768;
    const String videoIdone = 'https://youtu.be/RGiZtld9ssc?t=';
    const double startSecondsone = 0000000000000000000000000001003;
    const String videoIdtwo = 'https://youtu.be/KOYToS_pdFs?t=';
    const double startSecondstwo = 000000000000000000000000000202;
    const String videoIdthree = 'https://youtu.be/2NPGrKItt3E?t=';
    const double startSecondsthree = 0000000000000000000000000001207;
    const String videoIdfour = 'https://youtu.be/xNR-_d4l3Fk?t=';
    const double startSecondsfour = 0000000000000000000000000002740;
    const String videoIdfive = 'https://youtu.be/lT9d7Z1o1mk?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ineffectively""",
                      // alsoEnglishWord: "also: ineffectively",
                      britshText: """IpaUK: /ˌɪnɪˈfektɪvli/""",
                      americanText: """IpaUS: /ˌɪnɪˈfektɪvli/""",
...
کوردی: ناکاریگەرانە، بە شێوەیەکی ناکاریگەر

"""),
// With short examples define "ineffectively", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە ئەنجامی مەبەست یان سەرکەوتوو بەدەست ناهێنێت"""),
                    SentencesRow(
                      englishText:
                          """The government is dealing ineffectively with these economic problems.""",
                      kurdishText:
                          """حکومەت ناکاریگەرانە مامەڵە دەکات لەگەڵ ئەم کێشە ئابوورییانە.""",
