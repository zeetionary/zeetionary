...
// Define the word "banjo" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace banjo - replace EnglishEntrybanjo

// replace speakBanjo - /ˈbændʒəʊ/

enum TtsState { playing }

class EnglishEntrybanjo extends StatelessWidget {
// blank divider
  EnglishEntrybanjo({super.key});
// blank divider
  ...
  Future<void> speakbanjos2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBanjos22");
  }
  ...
  Future<void> speakbanjos3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBanjos33");
  }
  ...
  Future<void> speakbanjos4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBanjos44");
  }
  ...
  Future<void> speakbanjos5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBanjos55");
  }
  ...
  Future<void> speakbanjos6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBanjos66");
  }
  ...
  Future<void> speakbanjos7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBanjos77");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "banjo"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'oki150lYgWU';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '1DRjBGKbIMs';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'Xizp9MqZY10';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'N7SWUCpHme8';
  final double _startSeconds = 0;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'DkPhdIT0-vU';
  final double _startSeconds = 0;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'pb7jOme3LCk';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'E7u8-rS4Asg';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'h_cK-mtyKSg';
