...
class EnglishEntryfriendly extends StatefulWidget {
  const EnglishEntryfriendly({super.key});

  @override
  State<EnglishEntryfriendly> createState() => _EnglishEntryfriendlyState();
}

class _EnglishEntryfriendlyState extends State<EnglishEntryfriendly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: friendly (Derived forms: friendlier, friendliest)
...
4. Inclined to help or support; not antagonistic or hostile (= well-disposed, well disposed)
"a government friendly to our interests";

- Noun: friendly (Derived forms: friendlies)
1. (military) troops belonging to or allied with your own military forces
"friendlies came to their rescue"
""",
  );

  final String keyword = "friendly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""friendly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The bar is great and the staff are friendly.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Everyone was very friendly towards me.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This is a very friendly neighbourhood.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""John gave me a friendly smile.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We soon became friendly with the couple next door.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He played for England in a friendly against Spain.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """friendly""",
                      // alsoEnglishWord: "also: friendly",
                      britshText: """IpaUK: /ˈfrendli/""",
                      americanText: """IpaUS: /ˈfrendli/""",
...
کوردی:  دڵسۆز، گەرم‌وگوڕ، دۆستانە، برایانە، خۆشەویستانە، دۆست، خۆشەویستی، دۆستایەتی، هەڤاڵەتی، برایەتی، دڵسۆزی
"""),
// With short examples define "friendly", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) ڕەفتارکردن بە هاوڕێیانە"""),
                    SentencesRow(
                      englishText:
                          """The bar is great and the staff are friendly.""",
                      kurdishText: """باڕەکە زۆر باشە و ستافەکە دۆستانەن.""",
                    ...
                    SentencesRow(
                      englishText: """Everyone was very friendly towards me.""",
                      kurdishText: """هەموان زۆر دۆستانە بوون لەگەڵم.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I'm sure that the people are friendlier to strangers in Romania.""",
                      kurdishText:
                          """دڵنیام کە خەڵکی هاوڕێیانەترن لەگەڵ کەسانی نەناس لە ڕۆمانیا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) کە کەسێک وەک میهرەبان پیشان دەدات؛ کە وات لێدەکات وەها هەست بکەیت لەناو دۆستان دایت"""),
                    const DividerSentences(),
                    SentencesRow(
                    ...
                    SentencesRow(
                      englishText:
                          """Instantly I felt at home with her big smile and friendly face.""",
                      kurdishText:
                          """دەستبەجێ هەستم بەوە کرد وەک ئەوەی لە ماڵەوە بە بزە گەورەکەی و ڕووخسارە دۆستانەکەی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """John gave me a friendly smile.""",
                      kurdishText: """جۆن بزەیەکی دۆستانەی بۆم کرد.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵناو) مامەڵەکردن لەگەڵ کەسێک وەک هاوڕێ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """We soon became friendly with the couple next door.""",
                      kurdishText:
                          """زوو بووین بە دۆستی ژن و مێردەکەی دراوسێمان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She was on friendly terms with most of the hospital staff.""",
                      kurdishText:
                          """دۆست بوو لەگەڵ زۆرینەی ستافی نەخۆشخانەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The government has maintained friendly relations with the Japanese.""",
                      kurdishText:
                          """حکومەت پەیوەندیی دۆستانەی لەگەڵ ژاپۆنییەکان هێشتووەتەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٥. (ھاوەڵناو) کە خۆشە بۆ بەکارهێنان؛ کە یارمەتیی کەسێک دەدات؛ کە یارمەتی کەسێک دەدات یان زیان ناگەیەنێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """This software is much friendlier than the previous version.""",
                      kurdishText:
                          """ئەم نەرمامێرە زۆر بێ‌کێشەترە وەک لەوانی دیکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Without a doubt, friendly bacteria are essential for good health.""",
                      kurdishText:
                          """بێ هیچ گومانێک، بەکتریای بێ‌زیان گرنگن بۆ تەندرووستی باش.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """یاریی بۆ ئینگلتەرە کرد لە یارییەکی دۆستانە دژ بە ئیسپانیا.""",
...
const double _startSecondsend = 000000000000000000000000000310;
const String _videoIdone = 'https://youtu.be/4J0xFUyz1nw?t=';
const double _startSecondsone = 000000000000000000000000000838;
const String _videoIdtwo = 'https://youtu.be/8HEfIJlcFbs';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/tsxmyL7TUJg?t=';
const double _startSecondsthree = 0000000000000000000000000001173;
const String _videoIdfour = 'https://youtu.be/P8m-KThvtxA?t=';
const double _startSecondsfour = 000000000000000000000000000113;
const String _videoIdfive = 'https://youtu.be/PXsZntwnArQ?t=';
const double _startSecondsfive = 000000000000000000000000000157;
