...
class EnglishEntrylamentably extends StatefulWidget {
  const EnglishEntrylamentably({super.key});

  @override
  State<EnglishEntrylamentably> createState() => _EnglishEntrylamentablyState();
}

class _EnglishEntrylamentablyState extends State<EnglishEntrylamentably> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lamentably""");
  }
