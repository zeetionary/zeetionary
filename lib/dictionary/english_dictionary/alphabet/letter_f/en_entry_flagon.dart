...
class EnglishEntryflagon extends StatefulWidget {
  const EnglishEntryflagon({super.key});

  @override
  State<EnglishEntryflagon> createState() => _EnglishEntryflagonState();
}

class _EnglishEntryflagonState extends State<EnglishEntryflagon> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flagon
1. A large metal or pottery vessel with a handle and spout; used to hold alcoholic beverages (usually wine) (= Derived forms: flagons)
""",
  );

  final String keyword = "flagon";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She returned bearing two flagons of ale.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flagon""",
                      // alsoEnglishWord: "also: flagon",
                      britshText: """IpaUK: /ˈflæɡən/""",
                      americanText: """IpaUS: /ˈflæɡən/""",
...
// With short examples define "flagon", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) بوتڵێکی گەورە لە تێیدا شەراب دەفرۆشرێت یان دەخورێتەوە"""),
                    SentencesRow(
                      englishText:
                          """She returned bearing two flagons of ale.""",
                      kurdishText: """گەڕایەوە بە دوو تۆنگە مەیەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/qR_vpCtNcXg?t=';
const double _startSecondsend = 000000000000000000000000000220;
const String _videoIdone = 'https://youtu.be/TeRwScNWUZc?t=';
const double _startSecondsone = 00000000000000000000000000058;
const String _videoIdtwo = 'https://youtu.be/7NT6_bL2HL4?t=';
const double _startSecondstwo = 000000000000000000000000000481;
const String _videoIdthree = 'https://youtu.be/jgmBV5NA2A8?t=';
const double _startSecondsthree = 00000000000000000000000000010766;
const String _videoIdfour = 'https://youtu.be/MTPZpmn2wuA?t=';
const double _startSecondsfour = 000000000000000000000000000;
const String _videoIdfive = 'https://youtu.be/-aAy34s5D20?t=';
