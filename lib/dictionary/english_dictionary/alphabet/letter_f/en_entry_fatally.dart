...
class EnglishEntryfatally extends StatefulWidget {
  const EnglishEntryfatally({super.key});

  @override
  State<EnglishEntryfatally> createState() => _EnglishEntryfatallyState();
}

class _EnglishEntryfatallyState extends State<EnglishEntryfatally> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fatally""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fatally""",
                      // alsoEnglishWord: "also: fatally",
                      britshText: """IpaUK: /ˈfeɪtəli/""",
                      americanText: """IpaUS: /ˈfeɪtəli/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Several people were injured, two fatally.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He was convicted of fatally stabbing a police officer.""");
  }
...
کوردی: کوشندانە، بە شێوەیەکی کوشندە، ، بە شێوەیەکی مەرگ‌بار، مەرگاوی‌یانە
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵکار) بەشێوەیەک کە دەبێتە هۆکاری مەرگ"""),
          SentencesRow(
            englishText: """Several people were injured, two fatally.""",
            kurdishText: """ژمارەیەک کەس بریندار بوون، دوو دانە بە کوشندەیی.""",
          ...
          SentencesRow(
            englishText:
                """He was convicted of fatally stabbing a police officer.""",
            kurdishText:
                """تاوانبار کرا بەوەی کوشندانە چەقۆی دا لە ئەفسەرێکی پۆلیس.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ھاوەڵکار) بەشێوەیەک کە شکست یان کارەساتی لێدەکەوێتەوە"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """The plan was fatally flawed from the start.""",
            kurdishText: """پلانەکە هەر لە سەرەتاوە کارەسات‌بارانە هەڵە بوو.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: fatally
1. With fatal consequences or implications (= lethally)
...
const String _videoIdend = 'https://youtu.be/Gv4Af83KFrE?t=';
const double _startSecondsend = 000000000000000000000000000687;
const String _videoIdone = 'https://youtu.be/hS2x1zl4rn0?t=';
const double _startSecondsone = 000000000000000000000000000764;
const String _videoIdtwo = 'https://youtu.be/y4DTW4B3Sjs?t=';
const double _startSecondstwo = 000000000000000000000000000747;
const String _videoIdthree = 'https://youtu.be/lVQFRJFge3E?t=';
const double _startSecondsthree = 000000000000000000000000000842;
const String _videoIdfour = 'https://youtu.be/DZTTdYCBqqg?t=';
const double _startSecondsfour = 0000000000000000000000000001337;
const String _videoIdfive = 'https://youtu.be/NwSigxj-KWA?t=';
