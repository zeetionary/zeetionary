...
class EnglishEntryeventual extends StatefulWidget {
  const EnglishEntryeventual({super.key});

  @override
  State<EnglishEntryeventual> createState() => _EnglishEntryeventualState();
}

class _EnglishEntryeventualState extends State<EnglishEntryeventual> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""eventual""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """eventual""",
                      // alsoEnglishWord: "also: eventual",
                      britshText: """IpaUK: /ɪˈventʃuəl/""",
                      americanText: """IpaUS: /ɪˈventʃuəl/""",
...
کوردی: دواتر، پاش‌تر، پاشەجار، پاشین،	دووماهی، کۆتایی، دوایی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە لە کۆتایی ماوەیەک یان پڕۆسەیەک ڕوودەدات"""),
          SentencesRow(
            englishText:
                """It is impossible to predict what the eventual outcome will be.""",
            kurdishText:
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The village school may face eventual closure.""",
            kurdishText:
                """قوتابخانەی گوندەکە ڕەنگە تووشی داخستن ببێت لەکۆتاییدا.""",
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/YLmDE_JYUNU?t=';
const double _startSecondsend = 000000000000000000000000000000; // 898;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/NWGVFi-213w?t=';
const double _startSecondsone = 00000000000000000000000000000; // 328;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/H1KP4ztKK0A?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1079;
const String _videoIdthree = 'VIDEOhttps://youtu.be/7eM7pb5M5DU?t=';
const double _startSecondsthree = 000000000000000000000000000; // 2520;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/0vZvPtI5Uk8?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 343;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/uhIdijSrnVc?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 758;
