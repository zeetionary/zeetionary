...
class EnglishEntryincredulous extends StatefulWidget {
  const EnglishEntryincredulous({super.key});

  @override
  State<EnglishEntryincredulous> createState() => _EnglishEntryincredulousState();
}

class _EnglishEntryincredulousState extends State<EnglishEntryincredulous> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incredulous""");
  }
