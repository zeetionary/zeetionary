...
class EnglishEntryincompatibility extends StatefulWidget {
  ...
  @override
  State<EnglishEntryincompatibility> createState() => _EnglishEntryincompatibilityState();
}

class _EnglishEntryincompatibilityState extends State<EnglishEntryincompatibility> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryincompatibility incompatibility
WORD_WEB incompatibility incompatibility incompatibility
haʊʊʊʊʊʊʊ4
""",
  );
