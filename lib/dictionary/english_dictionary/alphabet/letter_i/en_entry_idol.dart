...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 142;
    const String videoIdone = 'PbKYAks6044';
    const double startSecondsone = 1058;
    const String videoIdtwo = 'HxRUuGqqMG4';
    const double startSecondstwo = 180;
    const String videoIdthree = 'HiWXeWQAsUE';
    const double startSecondsthree = 503;
    const String videoIdfour = 'XrTDwpLECtA';
    const double startSecondsfour = 67;
    const String videoIdfive = 'YZkXDuKto_Y';
    const double startSecondsfive = 1889;
