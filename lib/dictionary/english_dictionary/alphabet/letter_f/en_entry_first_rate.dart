...
class EnglishEntryfirstrate extends StatefulWidget {
  const EnglishEntryfirstrate({super.key});

  @override
  State<EnglishEntryfirstrate> createState() => _EnglishEntryfirstrateState();
}

class _EnglishEntryfirstrateState extends State<EnglishEntryfirstrate> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""first-rate""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The food here is absolutely first-rate.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We aim to provide a first-rate service.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """first-rate""",
                      // alsoEnglishWord: "also: first-rate",
                      britshText: """IpaUK: /ˌfɜːst ˈreɪt/""",
                      americanText: """IpaUS: /ˌfɜːrst ˈreɪt/""",
...
"""),
// With short examples define "first-rate", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) لە باشترین جۆر"""),
                    SentencesRow(
                      englishText:
                          """The food here is absolutely first-rate.""",
                      kurdishText: """خواردنی ئێرە تەواو نایابترینە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەوڵ دەدەین خزمەتگوزارییەکی بێ‌وێنە پێشکەش بکەین.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/TYo-ziwOAWQ?t=';
const double _startSecondsend = 000000000000000000000000000680;
const String _videoIdone = 'https://youtu.be/G2D7WJTN6to?t=';
const double _startSecondsone = 000000000000000000000000000167;
const String _videoIdtwo = 'https://youtu.be/lctv_pyT62o?t=';
const double _startSecondstwo = 000000000000000000000000000200;
const String _videoIdthree = 'https://youtu.be/qMXqg2PKJZU?t=';
const double _startSecondsthree = 000000000000000000000000000187;
const String _videoIdfour = 'https://youtu.be/m7F5ioUQLJc?t=';
const double _startSecondsfour = 000000000000000000000000000196;
const String _videoIdfive = 'https://youtu.be/0tYm41hb48o?t=';
