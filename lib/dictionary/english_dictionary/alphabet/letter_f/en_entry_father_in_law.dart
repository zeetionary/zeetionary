...
class EnglishEntryfatherinlaw extends StatefulWidget {
  const EnglishEntryfatherinlaw({super.key});

  @override
  State<EnglishEntryfatherinlaw> createState() =>
      _EnglishEntryfatherinlawState();
}

class _EnglishEntryfatherinlawState extends State<EnglishEntryfatherinlaw> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""father-in-law""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """father-in-law""",
                      // alsoEnglishWord: "also: father-in-law",
                      britshText: """IpaUK: /ˈfɑːðər ɪn lɔː/""",
                      americanText: """IpaUS: /ˈfɑːðər ɪn lɔː/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "father-in-law";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They visited her father-in-law on the weekend.""");
  }
...
کوردی: خەزور، باوکی هاوسەر
"""),
          const DefinitionKurdish(text: """١. (ناو) باوکی هاوژینەکەت"""),
          SentencesRow(
            englishText: """They visited her father-in-law on the weekend.""",
            kurdishText: """لە کۆتایی هەفتەدا سەردانی خەزوورەی کرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: father-in-law (Derived forms: fathers-in-law)
...
const String _videoIdend = 'https://youtu.be/Yaui2pL26ZQ?t=';
const double _startSecondsend = 0000000000000000000000000001433;
const String _videoIdone = 'https://youtu.be/4l8M3dQlUwg?t=';
const double _startSecondsone = 0000000000000000000000000001560;
const String _videoIdtwo = 'https://youtu.be/77Syz-AF4nE?t=';
const double _startSecondstwo = 000000000000000000000000000462;
const String _videoIdthree = 'https://youtu.be/B5PqLSZPIOM?t=';
const double _startSecondsthree = 00000000000000000000000000044;
const String _videoIdfour = 'https://youtu.be/AecFpnj383A?t=';
const double _startSecondsfour = 0000000000000000000000000001610;
const String _videoIdfive = 'https://youtu.be/-N4MBIichQY?t=';
