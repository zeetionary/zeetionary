...
class EnglishEntryincumbent extends StatefulWidget {
  const EnglishEntryincumbent({super.key});

  @override
  State<EnglishEntryincumbent> createState() => _EnglishEntryincumbentState();
}

class _EnglishEntryincumbentState extends State<EnglishEntryincumbent> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incumbent""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = '4IaOeVgZ-wc';
    const double startSecondsone = 354;
    const String videoIdtwo = 'JN3KPFbWCy8';
    const double startSecondstwo = 3203;
    const String videoIdthree = 'mXpwgg5TxOU';
    const double startSecondsthree = 393;
    const String videoIdfour = '-7i9dTJgsdI';
    const double startSecondsfour = 155;
    const String videoIdfive = 'yat1PBrsbQo';
