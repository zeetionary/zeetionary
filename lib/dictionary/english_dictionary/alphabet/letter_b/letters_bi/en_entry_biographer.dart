...
// blank divider
  ...
  Future<void> speakBiographers7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBiographers77"); // DOPSUM: CHANGE TEXT
  }
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  static String myVideoId = "LP80jo1_UgU";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 13933, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
      autoPlay: true,
      enableCaption: true,
      loop: true,
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  static String myVideoId = "Kk2MH9O4pXY";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  static String myVideoId = "HnP8BfBYAjw";
