...
class EnglishEntryfrontier extends StatefulWidget {
  const EnglishEntryfrontier({super.key});

  @override
  State<EnglishEntryfrontier> createState() => _EnglishEntryfrontierState();
}

class _EnglishEntryfrontierState extends State<EnglishEntryfrontier> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frontier (Derived forms: frontiers)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frontier""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Many people travelling across the frontier were refugees.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The army crossed the frontier in the middle of the night.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There was an army checkpoint at the frontier.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The Homestead Act of 1862 gave free land to pioneers who settled the frontier.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Space is the final frontier for us to explore.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frontier""",
                      // alsoEnglishWord: "also: frontier",
                      britshText: """IpaUK: /ˈfrʌntɪə(r)/""",
                      americanText: """IpaUS: /frʌnˈtɪr/""",
...
// With short examples define "frontier", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) سنووری نێوان دوو وڵات؛ ناوچەکانی سەر سنوور"""),
                    SentencesRow(
                      englishText:
                          """Many people travelling across the frontier were refugees.""",
                      kurdishText: """زۆر لەو کەسانەی بە سنوورەکەدا گەشتیان دەکرد پەنابەر بوون.""",
                    ...
                    SentencesRow(
                      englishText: """The army crossed the frontier in the middle of the night.""",
                      kurdishText: """سوپا لە سنوور پەڕییەوە لە نیوەشەدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There was an army checkpoint at the frontier.""",
                      kurdishText: """خاڵێکی پشکنینی سوپا لەسەر سنوور هەبوو.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ئەو پەڕی ئەو شوێنانەی کە خەڵکی لێی نیشتەجێبوونە و شارۆچکەیان درووست کردووە و لەو پەڕییەوە دەشتە و زانیاری نییە لەسەری"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The Homestead Act of 1862 gave free land to pioneers who settled the frontier.""",
                      kurdishText: """یاسای هەومستێید ١٨٦٢ زەویی بێبەرامبەری دا بەو کەسانەی کە بۆ یەکەمجار لە دەشتەکان نیشتەجێ دەبوون.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) سنووری شتێک، بە تایبەتی ئەوەی چی زانراوە سەبارەت بە چالاکییەک یان بابەتێکی دیاریکراو"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Space is the final frontier for us to explore.""",
                      kurdishText: """بۆشایی ئاسمان کۆتا سنوورمانە بۆ تێگەشتن.""",
...
const double _startSecondsone = 0000000000000000000000000001526;
...
const String _videoIdfour = 'https://youtu.be/EjidrUoHvPs?t=';
const double _startSecondsfour = 00000000000000000000000000083;
const String _videoIdfive = 'https://youtu.be/dl5FHmL_6rE?t=';
