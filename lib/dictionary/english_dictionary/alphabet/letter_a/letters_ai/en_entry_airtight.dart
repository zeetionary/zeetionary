...
// replace these: replace EnglishEntryairtight - replace speakAirtight - replace airtight - /ˈeətaɪt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryairtight extends StatelessWidget {
  EnglishEntryairtight({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAirtight(String languageCode) async {
    // DOPSUM: CHANGE speakAirtight
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("airtight"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAirtight45222(String languageCode) async {
    ...
    await flutterTts.speak(
        "Store the cake in an airtight container."); // DOPSUM: CHANGE TEXT
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '_k7fQTWTglU';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'Nq8DsngS_SI';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'fbagcbl9Jts';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = '7OeeHz0uNdM';
