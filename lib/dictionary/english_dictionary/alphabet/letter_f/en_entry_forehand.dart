...
class EnglishEntryforehand extends StatefulWidget {
  const EnglishEntryforehand({super.key});

  @override
  State<EnglishEntryforehand> createState() => _EnglishEntryforehandState();
}

class _EnglishEntryforehandState extends State<EnglishEntryforehand> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: forehand
1. (of racket strokes) made with palm facing direction of stroke (= forehanded)

- Noun: forehand (Derived forms: forehands)
1. (sport) a return made with the palm of the hand facing the direction of the stroke (as in tennis, badminton or squash) (= forehand stroke, forehand shot)
""",
  );

  final String keyword = "forehand";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forehand""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She has a strong forehand.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forehand""",
                      // alsoEnglishWord: "also: forehand",
                      britshText: """IpaUK: /ˈfɔːhænd/""",
                      americanText: """IpaUS: /ˈfɔːrhænd/""",
...
// With short examples define "forehand", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """She has a strong forehand.""",
                      kurdishText: """لێدانی پێشەوەی بەهێزی هەیە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/nd5--EqzLPY?t=';
const double _startSecondsend = 00000000000000000000000000067;
const String _videoIdone = 'https://youtu.be/nlz5Z86G9V0?t=';
const double _startSecondsone = 00000000000000000000000000076;
const String _videoIdtwo = 'https://youtu.be/d-yWx772qFU?t=';
const double _startSecondstwo = 000000000000000000000000000103;
const String _videoIdthree = 'https://youtu.be/ugTrjZQdLj8?t=';
const double _startSecondsthree = 000000000000000000000000000428;
const String _videoIdfour = 'https://youtu.be/JmD98FradyQ?t=';
const double _startSecondsfour = 000000000000000000000000000410;
const String _videoIdfive = 'https://youtu.be/S1Fu2H21_wA?t=';
