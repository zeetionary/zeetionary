...
class EnglishEntryheartburn extends StatefulWidget {
  const EnglishEntryheartburn({super.key});

  @override
  State<EnglishEntryheartburn> createState() => _EnglishEntryheartburnState();
}

class _EnglishEntryheartburnState extends State<EnglishEntryheartburn> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heartburn (Derived forms: heartburns)
1. A painful burning sensation in the chest caused by gastroesophageal reflux (backflow from the stomach irritating the oesophagus); symptomatic of an ulcer or a diaphragmatic hernia or other disorder (- pyrosis)
""",
  );

  final String keyword = "heartburn";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heartburn""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He felt heartburn after eating spicy food.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heartburn""",
                      // alsoEnglishWord: "also: heartburn",
                      britshText: """IpaUK: /ˈhɑːtbɜːn/""",
                      americanText: """IpaUS: /ˈhɑːrtbɜːrn/""",
...
// کوردی: گەدەکزێ، دڵەکزە، سووتانەوەی سەری گەدە
// """),
                    const DefinitionKurdish(text: """١. (ناو) ئەو هەستەی کە وادەزانیت شتێک لە سنگتدا دەسووتێتەوە کە درووست دەبێت بەهۆی گەڕانەوەی ترشی لە گەددەوە"""),
                    SentencesRow(
                      englishText: """He felt heartburn after eating spicy food.""",
                      kurdishText: """هەستی بە دڵە کزە دەکرد لە دوای خواردنی توون.""",
...
const String _videoIdone = 'https://youtu.be/eNpkhX85yf0?t=';
const double _startSecondsone = 000000000000000000000000000609;
const String _videoIdtwo = 'https://youtu.be/DgTJ3-WMAWY?t=';
const double _startSecondstwo = 000000000000000000000000000234;
const String _videoIdthree = 'https://youtu.be/Z7P0KFGDGrI?t=';
const double _startSecondsthree = 000000000000000000000000000149;
const String _videoIdfour = 'https://youtu.be/aJbdYcCFp50?t=';
const double _startSecondsfour = 000000000000000000000000000311;
const String _videoIdfive = 'https://youtu.be/Xc4YH0nv_90?t=';
const double _startSecondsfive = 000000000000000000000000000158;
