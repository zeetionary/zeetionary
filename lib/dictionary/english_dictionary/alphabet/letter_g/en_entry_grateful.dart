...
class EnglishEntrygrateful extends StatefulWidget {
  const EnglishEntrygrateful({super.key});

  @override
  State<EnglishEntrygrateful> createState() => _EnglishEntrygratefulState();
}

class _EnglishEntrygratefulState extends State<EnglishEntrygrateful> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: grateful
1. Feeling or showing gratitude (- thankful)
"a grateful heart"; "grateful for the tree's shade";
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""grateful""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Thank you for doing this. I really am so grateful.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We are very grateful to all those who contributed.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """grateful""",
                      // alsoEnglishWord: "also: grateful",
                      britshText: """IpaUK: /ˈɡreɪtfl/""",
                      americanText: """IpaUS: /ˈɡreɪtfl/""",
...
// With short examples define "grateful", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) سوپاسگوزار بەهۆی ئەوەی کەسێک میهرەبان بووە لەگەڵت یان یارمەتی داویت"""),
                    SentencesRow(
                      englishText:
                          """Thank you for doing this. I really am so grateful.""",
                      kurdishText:
                          """سوپاس بۆ کردنی ئەمە. بەڕاستی زۆر سوپاسگوزارم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆر سوپاسگوزاری هەموو ئەوانەین کە بەژداربوون.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I am extremely grateful to all the teachers for their help.""",
                      kurdishText:
                          """تەواو سوپاسگوزاری هەموو مامۆستاکانم بۆ یارمەتیدانیان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She seems to think I should be grateful to have a job at all.""",
                      kurdishText:
                          """وادیارە وەها بیر بکاتەوە کە دەبێت سوپاسگوزار بم بۆ ئەوەی کە هەر کارێکم هەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He was grateful that she didn't tell his parents about the incident.""",
                      kurdishText:
                          """سوپاسگوزار بوو کە دەربارەی ڕووداوەکە بە دایک و باوکی نەگوت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I would be most grateful if you would keep this matter confidential.""",
                      kurdishText:
                          """زۆر سوپاسگوزار دەبم ئەگەر ئەم بابەتە بە نهێنی بهێڵیتەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I would be grateful if you could send the completed form back as soon as possible.""",
                      kurdishText:
                          """سوپاسگوزار دەبم ئەگەر چەند بکرێت زوو فۆرمە تەواوکراوەکە بنێریتەوە.""",
...
const double _startSecondsend = 000000000000000000000000000220;
const String _videoIdone = 'https://youtu.be/_wNsZEqpKUA?t=';
const double _startSecondsone = 000000000000000000000000000119;
const String _videoIdtwo = 'https://youtu.be/E2_kRmS6y8A?t=';
const double _startSecondstwo = 0000000000000000000000000002623;
const String _videoIdthree = 'https://youtu.be/9TugA_z5vQE?t=';
const double _startSecondsthree = 0000000000000000000000000001363;
const String _videoIdfour = 'https://youtu.be/4itx6mXEJ6c?t=';
const double _startSecondsfour = 000000000000000000000000000771;
