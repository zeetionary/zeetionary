...
class EnglishEntryforecourt extends StatefulWidget {
  const EnglishEntryforecourt({super.key});

  @override
  State<EnglishEntryforecourt> createState() => _EnglishEntryforecourtState();
}

class _EnglishEntryforecourtState extends State<EnglishEntryforecourt> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forecourt (Derived forms: forecourts)
1. The outer or front court of a building or of a group of buildings
""",
  );

  final String keyword = "forecourt";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forecourt""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The forecourt of the museum had space for visitors to park.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forecourt""",
                      // alsoEnglishWord: "also: forecourt",
                      britshText: """IpaUK: /ˈfɔːkɔːt/""",
                      americanText: """IpaUS: /ˈfɔːrkɔːrt/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بەشێکی چۆڵ لە بەشێک بینایەک کە زۆرجار بۆ ڕاگرتنی ئۆتۆمبێل بەکاردێت"""),
                    SentencesRow(
                      englishText:
                          """The forecourt of the museum had space for visitors to park.""",
                      kurdishText:
                          """حەوشەی مۆزەخانەکە جێگای هەبوو بۆ خەڵکی کە ئۆتۆمبێل بوەستێنن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/9mgwZASlFvw?t=';
const double _startSecondsend = 000000000000000000000000000243;
const String _videoIdone = 'https://youtu.be/NKzImGbTbbw?t=';
const double _startSecondsone = 000000000000000000000000000269;
const String _videoIdtwo = 'https://youtu.be/0PUNVBhuVow?t=';
const double _startSecondstwo = 000000000000000000000000000283;
const String _videoIdthree = 'https://youtu.be/Tya0zX7czD4?t=';
const double _startSecondsthree = 000000000000000000000000000247;
const String _videoIdfour = 'https://youtu.be/lZJzs9X2VLo?t=';
const double _startSecondsfour = 000000000000000000000000000609;
const String _videoIdfive = 'https://youtu.be/lSkY7I8CMWI?t=';
const double _startSecondsfive = 000000000000000000000000000411;
