                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "Arabic"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈærəbɪk/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈærəbɪk/"),
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'rdeQT7KkqM8';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = '8OqdiU5u4vs';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'Dt-PEVm8754';
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'UB4BgwVJUjs';
