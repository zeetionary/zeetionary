...
class EnglishEntryfactually extends StatefulWidget {
  const EnglishEntryfactually({super.key});

  @override
  State<EnglishEntryfactually> createState() => _EnglishEntryfactuallyState();
}

class _EnglishEntryfactuallyState extends State<EnglishEntryfactually> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""factually""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """factually""",
                      // alsoEnglishWord: "also: factually",
                      britshText: """IpaUK: /ˈfæktʃuəli/""",
                      americanText: """IpaUS: /ˈfæktʃuəli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "factually";
...
کوردی: 
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵکار) کە پشتی بە ڕاستی بەستووە"""),
          SentencesRow(
            englishText:
                """He's making statements that are not factually accurate.""",
            kurdishText: """ژمارەیەک قسە دەکات کە لەلایەنی ڕاستییەوە درووست نین.""",
...
const String _videoIdend = 'https://youtu.be/9bPIaHg11mI?t=';
const double _startSecondsend = 0000000000000000000000000001699;
const String _videoIdone = 'https://youtu.be/S6rDvbQ-mz4?t=';
const double _startSecondsone = 000000000000000000000000000180;
const String _videoIdtwo = 'https://youtu.be/112H-vY4Wdo?t=';
const double _startSecondstwo = 000000000000000000000000000525;
const String _videoIdthree = 'https://youtu.be/0gNauGdOkro?t=';
const double _startSecondsthree = 000000000000000000000000000448;
const String _videoIdfour = 'https://youtu.be/l4yZQZf2g5Y?t=';
const double _startSecondsfour = 0000000000000000000000000009;
const String _videoIdfive = 'https://youtu.be/PLHo6uyICVk?t=';
