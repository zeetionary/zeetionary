...
class EnglishEntryexecutive extends StatefulWidget {
  const EnglishEntryexecutive({super.key});

  @override
  State<EnglishEntryexecutive> createState() => _EnglishEntryexecutiveState();
}

class _EnglishEntryexecutiveState extends State<EnglishEntryexecutive> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""executive""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """executive""",
                      // alsoEnglishWord: "also: executive",
                      britshText: """IpaUK: /ɪɡˈzekjətɪv/""",
                      americanText: """IpaUS: /ɪɡˈzekjətɪv/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "executive";
...
کوردی: ڕاپەڕێنەرانە، بەڕێوەبەر، ڕاپەڕێنەر، ھەڵسووڕێنەر، جێبەکێ‌کار، دەسەڵات یان ھێزی جێبەجی‌کردن یان ڕاپەڕاندن، دەزگای جێبەجی‌کردن یان ڕاپەڕاندن،	دەستەی جێبەجێ‌کردن، لێژنەی ڕاپەڕاندن،	بەڕێوەبەر
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کەسێک کە پێگەیەکی گرنگی ھەیە وەک بەڕێوەبەری کۆمپانیایەک"""),
          SentencesRow(
          ...
          SentencesRow(
            ...
            kurdishText:
                """بەڕێوەبەرایەتی سەندیکاکە ھێشتا لە خەریکی بڕیاردانن.""",
          ...
          SentencesRow(
            englishText:
                """Conservatives are by tradition believers in a strong executive.""",
            kurdishText:
                """پارێزگاران لە کۆنەوە باوەڕیان بە دەسەڵاتی بەھێزی جێبەجێکردن ھەیە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """پێگەی بەڕێوەبەری ھەیە لە کۆمپانیایەکی دارایی.""",
          ...
          SentencesRow(
            englishText:
                """Some members of the executive board are thought to be against the merger.""",
            kurdishText:
                """ھەندێک ئەندامی دەستەی بەڕێوەبەری باوەڕ وایە دژ بە یەکخستنەکە بن.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """سەرپەرشتیارەکە بڕیارێکی بەڕێوەبەرانەی دا بۆ ھەڵوەشاندنەوەی پڕۆژەکە.""",
            onPressedBritish: () => speaksentence8("en-GB"),
            onPressedAmerican: () => speaksentence8("en-US"),
          ),
          SentencesRow(
            englishText: """Executive power is held by the president.""",
            kurdishText: """دەسەڵاتی جێبەجێکردن لای سەرۆکە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: executive (derived forms: executives)
1. A person responsible for the administration of a business (= executive director, exec [informal])
 
2. A person who administers the law
