                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arouse"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈraʊz/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈraʊz/"),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'nJR8Nfi8wg8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'jAXEM8qhfMU';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'dkcUyEcGzNo';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final double _startSeconds = 11758;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'DnKRjSAJb8Q';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'h66CvBSHvJs';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'JZatLcsuL4U';
  final double _startSeconds = 5375;
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'JXAG_SZ3gaU';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = '30ui1x-eKIw';
