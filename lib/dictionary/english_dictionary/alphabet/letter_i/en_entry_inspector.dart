...
class EnglishEntryinspector extends StatefulWidget {
  const EnglishEntryinspector({super.key});

  @override
  State<EnglishEntryinspector> createState() => _EnglishEntryinspectorState();
}

class _EnglishEntryinspectorState extends State<EnglishEntryinspector> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inspector""");
  }
