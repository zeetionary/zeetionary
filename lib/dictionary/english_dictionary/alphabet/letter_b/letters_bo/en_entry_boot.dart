...
کوردی: چەکمە، لاپچین، پۆتین، لەقە، شەق، شەپ، تێهەڵدان، سنووقی پشتەوەی ماشێن، دەرکردن، تەکاندنەوە، سوود، قازانج، کەڵک، (کامپیوتێر) بووت، خستنەڕێ، (مێژوویی) ئامێرێکی ئەشکەنجە بۆ شکاندنی پێ، سەرەڕای ئەمەش، سەرباری ئەمەش، لەگەڵ ئەمەش‌دا

١. (ناو) پێڵاوێکی بەهێز کە پێ و لاق دادەپۆشێت"""),
                          Row(
                            children: [
                          ...
                          const DividerDefinition(),
                          const DefinitionKurdish(
                              text: "٣. (ناو) لێدانێکی بەهێز و خێرا"),
                          Row(
                            children: [
                              const ExampleSentenceEnglish(
                                  text: "He gave the ball a tremendous boot."),
                              const ExampleSentenceKurdish(
                                  text: "شەپێکی بەهێزی لە تۆپەکە دا."),
                              const CustomSizedBoxForTTS(),
                              CustomIconButtonBritish(
                          ...
                          const DefinitionKurdish(
                              text:
                                  "٤. (کردار) لەقەدان لە شتێک یان کەسێک بە بەهێزی"),
                          Row(
                            children: [
                              const ExampleSentenceEnglish(
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/Aj7FrvupKWE?t=";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/a1vlNaj5ah4?t=";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/kVwp-BfarxI?t=";
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/nEDgG5MKndo?t=";
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  static String myVideoId = "https://youtu.be/LYmRyVaX3rQ?t=";
