...
class EnglishEntryinfectious extends StatefulWidget {
  const EnglishEntryinfectious({super.key});

  @override
  State<EnglishEntryinfectious> createState() => _EnglishEntryinfectiousState();
}

class _EnglishEntryinfectiousState extends State<EnglishEntryinfectious> {
  @override
  void initState() {
    super.initState();
...
1. Caused by infection or capable of causing infection (- infective)
...
""",
  ...
  final String keyword = "infectious";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infectious""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Flu is highly infectious.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I'm still infectious.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/8X1xYpPmKvA?t=';
    const double startSecondsone = 0000000000000000000000000009047;
    const String videoIdtwo = 'https://youtu.be/8A3jiM2FNR8';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/hkO8qXCFYWA?t=';
    const double startSecondsthree = 000000000000000000000000000197;
    const String videoIdfour = 'https://youtu.be/esJkln9wAEg?t=';
    const double startSecondsfour = 000000000000000000000000000352;
    const String videoIdfive = 'https://youtu.be/TfaMLqEh1qM?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """infectious""",
                      // alsoEnglishWord: "also: infectious",
                      britshText: """IpaUK: /ɪnˈfekʃəs/""",
                      americanText: """IpaUS: /ɪnˈfekʃəs/""",
...
// کوردی: چڵکی،	بگرەوە، پەڕۆک، بەتەشەنە، تەشەنەدار، درم، پەتا
// """),
// With short examples define "infectious", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە نەخۆشییەک لە کەسێک بۆ کەسێکی دیکە بگوازرێتەوە؛ کە کەسێک نەخۆشییەکی وەهای هەبێت"""),
                    SentencesRow(
                      englishText: """Flu is highly infectious.""",
                      kurdishText: """هەڵامەت تەواو ڕاگوێزەرەو.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I'm still infectious.""",
                      kurdishText: """هێشتا تووشبووم.""",
