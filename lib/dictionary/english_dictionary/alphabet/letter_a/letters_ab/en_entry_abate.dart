...
class EnglishEntryabate extends StatefulWidget {
  const EnglishEntryabate({super.key});

  @override
  State<EnglishEntryabate> createState() => _EnglishEntryabateState();
}

class _EnglishEntryabateState extends State<EnglishEntryabate> {
  @override
...
class IpaUKtext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUK: /əˈbeɪt/");
  }
}
...
class IpaUStext extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return const IPAofEnglish(text: "IpaUS: /əˈbeɪt/");
  }
}
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speak1142566(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The storm showed no signs of abating.");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'Sw7acXGiQeQ';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'eCptiecm0ZM';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'Vw1rjqdRonw';
  final double _startSeconds = 3175;
