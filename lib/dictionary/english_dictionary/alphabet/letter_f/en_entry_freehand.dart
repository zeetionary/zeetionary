...
class EnglishEntryfreehand extends StatefulWidget {
  const EnglishEntryfreehand({super.key});

  @override
  State<EnglishEntryfreehand> createState() => _EnglishEntryfreehandState();
}

class _EnglishEntryfreehandState extends State<EnglishEntryfreehand> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: freehand
1. Done by hand without mechanical aids or devices (= freehanded)
"a freehand drawing";
""",
  );

  final String keyword = "freehand";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""freehand""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Many hours of the course were devoted to freehand drawing.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was all done free-hand.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """freehand""",
                      // alsoEnglishWord: "also: freehand",
                      britshText: """IpaUK: /ˈfriːhænd/""",
                      americanText: """IpaUS: /ˈfriːhænd/""",
...
// With short examples define "freehand", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Many hours of the course were devoted to freehand drawing.""",
                      kurdishText:
                          """زۆر کاتژمێری کۆرسەکە تەرخان کرابوو بۆ وێنەکێشانی بەدەست.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەمووی تەنها بەدەستی کرا.""",
...
const String _videoIdone = 'https://youtu.be/NUzDLpSkQTg?t=';
const double _startSecondsone = 000000000000000000000000000153;
const String _videoIdtwo = 'https://youtu.be/H3Den05Q_D0?t=';
const double _startSecondstwo = 000000000000000000000000000140;
const String _videoIdthree = 'https://youtu.be/EI-ToB0tG9A?t=';
const double _startSecondsthree = 000000000000000000000000000668;
const String _videoIdfour = 'https://youtu.be/iojNr30s0TY?t=';
const double _startSecondsfour = 000000000000000000000000000611;
const String _videoIdfive = 'https://youtu.be/rba-NkJjSNg?t=';
