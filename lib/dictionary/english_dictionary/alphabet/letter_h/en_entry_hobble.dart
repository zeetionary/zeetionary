...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/NQZ5BfdjDv0?t=';
    const double startSecondsend = 0000000000000000000000000001492;
    const String videoIdone = 'https://youtu.be/l9LpRpgnyqc?t=';
    const double startSecondsone = 0000000000000000000000000001616;
    const String videoIdtwo = 'https://youtu.be/DCVcZ2STflI?t=';
    const double startSecondstwo = 000000000000000000000000000219;
    const String videoIdthree = 'https://youtu.be/vc90NQpY_4s?t=';
    const double startSecondsthree = 000000000000000000000000000721;
    const String videoIdfour = 'https://youtu.be/rsnnmlIqS2M?t=';
    const double startSecondsfour = 000000000000000000000000000619;
    const String videoIdfive = 'https://youtu.be/8HgybmaEvFQ?t=';
    const double startSecondsfive = 000000000000000000000000000353;
