...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1201;
    const String videoIdone = 'BNpk_OGEGlA';
    const double startSecondsone = 680;
    const String videoIdtwo = '4bxI803q6i8';
    const double startSecondstwo = 3046;
    const String videoIdthree = 'va1rzP2xIx4';
    const double startSecondsthree = 107;
    const String videoIdfour = 'O7kRQ5WCkpU';
    const double startSecondsfour = 225;
    const String videoIdfive = 'pJ_LUFBSoqM';
