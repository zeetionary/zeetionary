...
class EnglishEntryfloodlight extends StatefulWidget {
  const EnglishEntryfloodlight({super.key});

  @override
  State<EnglishEntryfloodlight> createState() => _EnglishEntryfloodlightState();
}

class _EnglishEntryfloodlightState extends State<EnglishEntryfloodlight> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: floodlight (Derived forms: floodlights)
1. Light that is a source of artificial illumination having a broad beam; used in photography (= flood, flood lamp, photoflood)

- Verb: floodlight (Derived forms: floodlit, floodlights, floodlighting)
1. Illuminate with floodlights
""",
  );

  final String keyword = "floodlight";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""floodlight""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""This evening's match will be played under floodlights.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The swimming pool is floodlit in the evenings.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """floodlight""",
                      // alsoEnglishWord: "also: floodlight",
                      britshText: """IpaUK: /ˈflʌdlaɪt/""",
                      americanText: """IpaUS: /ˈflʌdlaɪt/""",
...
// With short examples define "floodlight", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) گڵۆپێکی گەورە کە بەکاردێت بۆ ڕووناککردنەوەی یاریگای وەرزشی، هۆڵی شانۆ، یان دەرەوەی بینا"""),
                    SentencesRow(
                      englishText:
                          """This evening's match will be played under floodlights.""",
                      kurdishText:
                          """یاریی ئەم ئێوارەیە لەژێر شەقاوێژ دەکرێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """مەلەوانگەکە بە ئێواران ڕووناک دەکرێتەوە.""",
...
const double _startSecondsend = 0000000000000000000000000007619;
const String _videoIdone = 'https://youtu.be/1I1vxu5qIUM?t=';
const double _startSecondsone = 000000000000000000000000000687;
const String _videoIdtwo = 'https://youtu.be/bmIVWe3Cux8?t=';
const double _startSecondstwo = 000000000000000000000000000287;
const String _videoIdthree = 'https://youtu.be/2WV_0hiuVOg?t=';
const double _startSecondsthree = 0000000000000000000000000001082;
const String _videoIdfour = 'https://youtu.be/Mn4VDwaV-oo?t=';
const double _startSecondsfour = 000000000000000000000000000171;
const String _videoIdfive = 'https://youtu.be/ZMKG0z12Pyc?t=';
const double _startSecondsfive = 000000000000000000000000000577;
