...
class EnglishEntryacquire extends StatefulWidget {
  const EnglishEntryacquire({super.key});

  @override
  State<EnglishEntryacquire> createState() => _EnglishEntryacquireState();
}

class _EnglishEntryacquireState extends State<EnglishEntryacquire> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """acquire""",
                      // alsoEnglishWord: "also: acquire",
                      britshText: """IpaUK: /əˈkwaɪə(r)/""",
                      americanText: """IpaUS: /əˈkwaɪər/""",
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'ioVAbpKCDxI';
