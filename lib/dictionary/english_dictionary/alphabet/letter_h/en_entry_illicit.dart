...
class EnglishEntryillicit extends StatefulWidget {
  const EnglishEntryillicit({super.key});

  @override
  State<EnglishEntryillicit> createState() => _EnglishEntryillicitState();
}

class _EnglishEntryillicitState extends State<EnglishEntryillicit> {
  @override
  void initState() {
    super.initState();
...
2. Contrary to or forbidden by law (- illegitimate, outlaw, outlawed, unlawful)
"illicit trade";
""",
  );

  final String keyword = "illicit";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""illicit""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""They were involved in an illicit love affair for years.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/94O7hjS5dHg?t=';
    const double startSecondsend = 000000000000000000000000000894;
    const String videoIdone = 'https://youtu.be/sAiTuitN5b8?t=';
    const double startSecondsone = 000000000000000000000000000364;
    const String videoIdtwo = 'https://youtu.be/vKDYfRtfqng?t=';
    const double startSecondstwo = 00000000000000000000000000086;
    const String videoIdthree = 'https://youtu.be/Un1gfVckcVw?t=';
    const double startSecondsthree = 0000000000000000000000000001547;
    const String videoIdfour = 'https://youtu.be/4IaOeVgZ-wc?t=';
    const double startSecondsfour = 000000000000000000000000000796;
    const String videoIdfive = 'https://youtu.be/N-FqJzC3tA8?t=';
    const double startSecondsfive = 000000000000000000000000000224;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """illicit""",
                      // alsoEnglishWord: "also: illicit",
                      britshText: """IpaUK: /ɪˈlɪsɪt/""",
                      americanText: """IpaUS: /ɪˈlɪsɪt/""",
...
کوردی: ناقانوونی، نایاسایی، ناڕەوا، ڕێگەنەدراو، قەدەغە، بەربەند، پەسندنەکراو
"""),
// With short examples define "illicit", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە دژ بە یاسایە یان پەسەندنەکراوە لە کۆمەڵگادا"""),
                    const AlsoEnglishckb(word: "ھەروەھا: illegal"),
                    SentencesRow(
                      englishText:
                          """The college cannot condone any behaviour that involves illicit drugs.""",
                      kurdishText:
                    ...
                    SentencesRow(
                      englishText:
                          """They were involved in an illicit love affair for years.""",
                      kurdishText:
                          """بۆ چەندین جار لە پەیوەندییەکی خۆشەویستی پەسەندنەکراو بوون.""",
