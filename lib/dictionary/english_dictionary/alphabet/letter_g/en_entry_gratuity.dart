...
class EnglishEntrygratuity extends StatefulWidget {
  const EnglishEntrygratuity({super.key});

  @override
  State<EnglishEntrygratuity> createState() => _EnglishEntrygratuityState();
}

class _EnglishEntrygratuityState extends State<EnglishEntrygratuity> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gratuity (Derived forms: gratuities)
1. A relatively small amount of money given for services rendered (as by a waiter) (- tip, pourboire, baksheesh [Asia], bakshish [Asia], backsheesh, bonsella [S.Africa])
 
2. An award (as for meritorious service) given without claim or obligation
""",
  );

  final String keyword = "gratuity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gratuity""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Our staff may not accept gratuities.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gratuity""",
                      // alsoEnglishWord: "also: gratuity",
                      britshText: """IpaUK: /ɡrəˈtjuːəti/""",
                      americanText: """IpaUS: /ɡrəˈtuːəti/""",
...
کوردی: دەس‌خۆشانە، دەسمەرێزانە، شاگردانە، کاڵەدڕانە
"""),
// With short examples define "gratuity", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەو پارەیەی کە دەیدەیت بە کەسێک بەهۆی ئەوەی خزمەتێکی پێ بەخشیویت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: tip"),
                    SentencesRow(
                      englishText: """Our staff may not accept gratuities.""",
                      kurdishText:
                          """ستافەکەمان ڕێگا پێنەدراون لەوەی شاگردانە وەربگرن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) بڕە پارەیەکی زۆر کە دەدرێت بە کەسێک کە کارەکەی جێدەهێڵێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """After he was disabled in the accident, he left the army with a one-off gratuity of £5,000.""",
                      kurdishText:
                          """دوای ئەوەی لە ڕووداوەکەدا کەمئەندام بوو، بە پاداشتێکی یەکجارەکی بە بڕی ٥٠٠٠ پاوەند لە سوپا دەرچوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/nyVOi3X53bk?t=';
const double _startSecondsend = 000000000000000000000000000839;
const String _videoIdone = 'https://youtu.be/6bNWSo7EBUc?t=';
const double _startSecondsone = 000000000000000000000000000200;
const String _videoIdtwo = 'https://youtu.be/2w6ephOxnTY?t=';
const double _startSecondstwo = 000000000000000000000000000247;
const String _videoIdthree = 'https://youtu.be/eQ3jox-dosQ?t=';
const double _startSecondsthree = 000000000000000000000000000300;
const String _videoIdfour = 'https://youtu.be/5dqrOSk-Wyk?t=';
const double _startSecondsfour = 0000000000000000000000000002315;
const String _videoIdfive = 'https://youtu.be/AsM1KDn0qGA?t=';
const double _startSecondsfive = 000000000000000000000000000872;
