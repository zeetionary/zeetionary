...
class EnglishEntryjazzy extends StatefulWidget {
  const EnglishEntryjazzy({super.key});

  @override
  State<EnglishEntryjazzy> createState() => _EnglishEntryjazzyState();
}

class _EnglishEntryjazzyState extends State<EnglishEntryjazzy> {
  @override
  void initState() {
    super.initState();
