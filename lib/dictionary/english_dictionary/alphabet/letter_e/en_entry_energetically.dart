...
class EnglishEntryenergetically extends StatefulWidget {
  const EnglishEntryenergetically({super.key});

  @override
  State<EnglishEntryenergetically> createState() =>
      _EnglishEntryenergeticallyState();
}

class _EnglishEntryenergeticallyState extends State<EnglishEntryenergetically> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""energetically""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """energetically""",
                      // alsoEnglishWord: "also: energetically",
                      britshText: """IpaUK: /ˌenəˈdʒetɪkli/""",
                      americanText: """IpaUS: /ˌenərˈdʒetɪkli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "energetically";
...
کوردی: بە توندی، چالاکانە، هەڵسووڕانە
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵکار) بە وزە و تامەزرۆیی زۆرەوە"""),
          SentencesRow(
            englishText: """He energetically denied the charge.""",
            kurdishText: """بەتوندی نکۆڵی لە تۆمەتەکە کرد.""",
...
"The children energetically ran towards the carnival"
""",
  );
...
const String _videoIdend = 'https://youtu.be/N4wW85WZMJQ?t=';
const double _startSecondsend = 621;
const String _videoIdone = 'https://youtu.be/V10mnsWiu7M?t=';
const double _startSecondsone = 282;
const String _videoIdtwo = 'https://youtu.be/lKTmu5DnW6U?t=';
const double _startSecondstwo = 643;
const String _videoIdthree = 'https://youtu.be/ZAlrKsMf9C4?t=';
const double _startSecondsthree = 967;
const String _videoIdfour = 'https://youtu.be/wOueNQy6MZk?t=';
const double _startSecondsfour = 379;
const String _videoIdfive = 'https://youtu.be/BX4i8qprP2I?t=';
const double _startSecondsfive = 1156;
const String _videoIdsix = 'https://youtu.be/469chceiiUQ?t=';
const double _startSecondssix = 165;
