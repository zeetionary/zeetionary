...
class EnglishEntryevenness extends StatefulWidget {
  const EnglishEntryevenness({super.key});

  @override
  State<EnglishEntryevenness> createState() => _EnglishEntryevennessState();
}

class _EnglishEntryevennessState extends State<EnglishEntryevenness> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evenness""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evenness""",
                      // alsoEnglishWord: "also: evenness",
                      britshText: """IpaUK: /ˈiːvənnəs/""",
                      americanText: """IpaUS: /ˈiːvənnəs/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""What she liked in him was his evenness of temper.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The score, 6–6, illustrated the evenness of the contest.""");
  }
...
کوردی: 
"""),
          const DefinitionKurdish(text: """١. (ناو) لەسەرەخۆیی"""),
          SentencesRow(
            englishText:
                """What she liked in him was his evenness of temper.""",
            kurdishText:
                """ئەوەی حەزی لێی بوو تێیدا لەسەرەخۆیی باری دەروونیی بوو.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) جێگیری؛ نەگۆڕانی بڕ، خێرایی، هتد"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """She possessed a voice of immaculate beauty and evenness of tone.""",
            kurdishText: """خاوەنی دەنگێکی جوانی بێ‌خەوش و جێگیری تۆنی بوو.""",
          ...
          const DefinitionKurdish(
              text:
                  """٣. (ناو) ئەوەی کە بۆ کەسێک، شوێنێک، تیمێک، هتد هەمان شت بێت"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The population declines took place with evenness across the nation.""",
            kurdishText: """کەمبوونی دانیشتووان بە یەکسانی لە وڵاتەکەدا.""",
            onPressedBritish: () => speaksentence3("en-GB"),
            onPressedAmerican: () => speaksentence3("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """٤. (ناو) هاوئاستی"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The score, 6–6, illustrated the evenness of the contest.""",
            kurdishText: """خاڵەەک، ٦-٦، هاوئاستی ڕکابەرییەکەی پیشان دا.""",
          ...
          SentencesRow(
            englishText:
                """Results will be affected by the degree of evenness of the surface.""",
            kurdishText: """ئەنجامەکان کاریگەر دەبن بە ئاستی سافی ڕووەکە.""",
...
2. A quality of uniformity and lack of variation (= invariability)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/LmpAntNjPj0?t=';
const double _startSecondsend = 000000000000000000000000000000; // 206;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/yssNu8Eynb8?t=';
const double _startSecondsone = 00000000000000000000000000000; // 602;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/npbj6Z-JL8U?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 143;
const String _videoIdthree = 'VIDEOhttps://youtu.be/DKsxda--GVA?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1015;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/QHcQ80_PcAU?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 637;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/UWVEgoEGnkY?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 393;
