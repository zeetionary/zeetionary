...
class EnglishEntryinclude extends StatefulWidget {
  const EnglishEntryinclude({super.key});

  @override
  State<EnglishEntryinclude> createState() => _EnglishEntryincludeState();
}

class _EnglishEntryincludeState extends State<EnglishEntryinclude> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: include (Derived forms: included, includes, including)
...
3. (chemistry) add as part of something else; put in as part of a set, group, or category
"We must include this chemical element in the group"
 
4. Allow participation in or the right to be part of; permit to exercise the rights, functions, and responsibilities of (- admit, let in)
"include someone to the profession";
""",
  );

  final String keyword = "include";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""include""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The tour included a visit to the Science Museum.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Does the price include tax?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The report includes a number of recommendations.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""You should include some examples in your essay.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We need to include children in our study.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001267;
    const String videoIdone = 'https://youtu.be/zZM57oTu9Ng?t=';
    const double startSecondsone = 00000000000000000000000000072;
    const String videoIdtwo = 'https://youtu.be/dqcSk-EDrRo?t=';
    const double startSecondstwo = 000000000000000000000000000265;
    const String videoIdthree = 'https://youtu.be/K12WhrZfxxw?t=';
    const double startSecondsthree = 0000000000000000000000000009;
    const String videoIdfour = 'https://youtu.be/iKv4oc2zbeA?t=';
    const double startSecondsfour = 000000000000000000000000000527;
    const String videoIdfive = 'https://youtu.be/dtp6b76pMak?t=';
    const double startSecondsfive = 0000000000000000000000000001649;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """include""",
                      // alsoEnglishWord: "also: include",
                      britshText: """IpaUK: /ɪnˈkluːd/""",
                      americanText: """IpaUS: /ɪnˈkluːd/""",
...
کوردی: 
"""),
// With short examples define "include", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) لەخۆگرتن"""),
                    SentencesRow(
                      englishText:
                          """The tour included a visit to the Science Museum.""",
                      kurdishText:
                          """گەشتەکە سەردانێک بۆ مۆزەخانەی زانستی لەخۆ دەگرێت.""",
                    ...
                    SentencesRow(
                      englishText: """Does the price include tax?""",
                      kurdishText: """نرخەکە باج لەخۆ دەگرێت؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ڕاپۆرتەکە ژمارەیەک پێشنیار لەخۆ دەگرێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Your duties will include greeting visitors and directing them to the appropriate department.""",
                      kurdishText:
                          """ئەرکەکانت خێراتنی میوانان و ڕێنوێنیان بۆ بەشی گونجاو لەخۆ دەگرێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەبێت هەندێک نموونە دابنێیت لە داڕشتنەکەت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دەبێت منداڵان لەخۆ بگرین لە لێکۆڵینەوەکەمان.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Quite a few members are worried and I include myself among them.""",
                      kurdishText:
                          """ژمارەیەک ئەندام نیگەران و خۆمیش لەناویان حساب دەکەم.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Representatives from the country were included as observers at the conference.""",
                      kurdishText:
                          """نوێنەرانی وڵاتەکە وەک چاودێر لە کۆنفرانسەکە بەشداریان پێکرا.""",
