...
class EnglishEntrygyrate extends StatefulWidget {
  const EnglishEntrygyrate({super.key});

  @override
  State<EnglishEntrygyrate> createState() => _EnglishEntrygyrateState();
}

class _EnglishEntrygyrateState extends State<EnglishEntrygyrate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: gyrate (Derived forms: gyrated, gyrates, gyrating)
1. To wind or move in a spiral course (- spiral, coil)
"the young people gyrated on the dance floor";
 
2. Revolve quickly and repeatedly around one's own axis (- spin, spin around, whirl, reel)
"The dervishes gyrate around and around without getting dizzy";
""",
  );

  final String keyword = "gyrate";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They began gyrating to the music.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The leaves gyrated slowly to the ground.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gyrate""",
                      // alsoEnglishWord: "also: gyrate",
                      britshText: """IpaUK: /dʒaɪˈreɪt/""",
                      americanText: """IpaUS: /ˈdʒaɪreɪt/""",
...
// \b(gyrate)(s|ed|es|ing)?\b(?=[.!?]?)
                    ...
                    SentencesRow(
                      englishText: """They began gyrating to the music.""",
                      kurdishText:
                          """دەستیان کرد بە خۆبادان لەگەڵ میوزیکەکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """گەڵاکان بە هێواشی لە زەویدا دەسووڕانەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Rj_4XAzS6uw?t=';
const double _startSecondsend = 000000000000000000000000000526;
const String _videoIdone = 'https://youtu.be/2JhGnVpoUgU?t=';
const double _startSecondsone = 000000000000000000000000000292;
const String _videoIdtwo = 'https://youtu.be/k7VGqK6kdM8?t=';
const double _startSecondstwo = 000000000000000000000000000477;
const String _videoIdthree = 'https://youtu.be/AYvuovuMpkI?t=';
const double _startSecondsthree = 000000000000000000000000000757;
const String _videoIdfour = 'https://youtu.be/7lvfdEY7rIE?t=';
const double _startSecondsfour = 000000000000000000000000000323;
const String _videoIdfive = 'https://youtu.be/LPeRHEd0e1o?t=';
