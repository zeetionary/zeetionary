...
// replace these: replace EnglishEntryadventure - replace speakAdventure - replace adventure - /ədˈventʃə(r)/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadventure extends StatelessWidget {
  EnglishEntryadventure({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdventure(String languageCode) async {
    // DOPSUM: CHANGE speakAdventure
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ədˈventʃə(r)/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'qmnUl8jJKGM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '9PYNyL29OOI';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'bx79vJP4zWI';
