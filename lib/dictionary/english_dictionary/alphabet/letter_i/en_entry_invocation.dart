...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'b0KbZl4upQQ';
    const double startSecondsend = 47;
    const String videoIdone = 'JUnWk4s4_js';
    const double startSecondsone = 187;
    const String videoIdtwo = 'P43wVDiZs8k';
    const double startSecondstwo = 824;
    const String videoIdthree = '1X_KdkoGxSs';
    const double startSecondsthree = 13399;
    const String videoIdfour = 'XJ0SMDQZrCQ';
    const double startSecondsfour = 3683;
    const String videoIdfive = 'TDKfqpnFoeQ';
    const double startSecondsfive = 701;
