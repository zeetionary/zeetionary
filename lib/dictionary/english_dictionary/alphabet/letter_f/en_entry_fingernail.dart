...
class EnglishEntryfingernail extends StatefulWidget {
  const EnglishEntryfingernail({super.key});

  @override
  State<EnglishEntryfingernail> createState() => _EnglishEntryfingernailState();
}

class _EnglishEntryfingernailState extends State<EnglishEntryfingernail> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fingernail (Derived forms: fingernails)
1. The nail at the end of a finger
""",
  );

  final String keyword = "fingernail";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fingernail""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I noticed I had dirt under my fingernails.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fingernail""",
                      // alsoEnglishWord: "also: fingernail",
                      britshText: """IpaUK: /ˈfɪŋɡəneɪl/""",
                      americanText: """IpaUS: /ˈfɪŋɡərneɪl/""",
...
// With short examples define "fingernail", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تێبینیم کرد کە پیسی لەژێر نینۆکم هەیە.""",
...
const String _videoIdone = 'https://youtu.be/IBEg-jygXrE?t=';
const double _startSecondsone = 000000000000000000000000000343;
const String _videoIdtwo = 'https://youtu.be/g9QneAV4fVo?t=';
const double _startSecondstwo = 000000000000000000000000000649;
const String _videoIdthree = 'https://youtu.be/D7Cv7x6jjYQ?t=';
const double _startSecondsthree = 000000000000000000000000000233;
const String _videoIdfour = 'https://youtu.be/3XI_i6_ekP4?t=';
const double _startSecondsfour = 00000000000000000000000000053;
const String _videoIdfive = 'https://youtu.be/wZ6zKtsN_WI?t=';
