...
class EnglishEntryformat extends StatefulWidget {
  const EnglishEntryformat({super.key});

  @override
  State<EnglishEntryformat> createState() => _EnglishEntryformatState();
}

class _EnglishEntryformatState extends State<EnglishEntryformat> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: format (Derived forms: formats)
1. The general appearance, lay out or arrangement of something
 
2. The organization of information according to preset specifications (usually for computer processing) (= formatting, data format, data formatting)

- Verb: format (Derived forms: formatting, formatted, formats)
1. Put or arrange a document into a specific format (= arrange)
"Format this letter so it can be printed out";
 
2. Determine the arrangement of (data) for storage and display (in computer science)
 
3. Divide (a disk) into marked sectors so that it may store data (= initialize, initialise [Brit])
"Please format this disk before entering data!";
""",
  );

  final String keyword = "format";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The course is different in format from previous ones.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We will follow the same format as last year.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They've brought out the magazine in a new format.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The book is now available in a slightly smaller format.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """format""",
                      // alsoEnglishWord: "also: format",
                      britshText: """IpaUK: /ˈfɔːmæt/""",
                      americanText: """IpaUS: /ˈfɔːrmæt/""",
...
// With short examples define "format", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕێکخستن، پلان، دیزاین، هتد ـی گشتی شتێک"""),
                    SentencesRow(
                      englishText:
                          """For this year, we have decided to change the format of the conference slightly.""",
                      kurdishText:
                          """بۆ ئەمساڵ بڕیارمان داوە کە شێوەی کۆنفرانسەکە کەمێک بگۆڕین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کۆرسەکە لە شێوەدا جیاوازە لە ئەوانەی پێشووتر.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """شوێن هەمان شیوەی ساڵی ڕابردوو دەکەوین.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) شێوە و قەبارەی کتێبێک، گۆڤارێک، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """They've brought out the magazine in a new format.""",
                      kurdishText:
                          """گۆڤارەکەیان بە شێوەیەکی جیاواز دەرکردووە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کتێبەکە ئێستا بە شێوەیەکی کەمێک بچووکتر بەردەستە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) شێوازی هەڵگرتنی زانیاری لەسەر کۆمپیوتەر"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The images are stored in a digital format within the database.""",
                      kurdishText:
                          """وێنەکان بەشێوەی دیجیتاڵی هەڵگیراون لەناو داتابەیسەکە.""",
...
const double _startSecondsone = 0000000000000000000000000001011;
const String _videoIdtwo = 'https://youtu.be/jrHz8Bti6FY?t=';
const double _startSecondstwo = 000000000000000000000000000364;
const String _videoIdthree = 'https://youtu.be/b_rjBWmc1iQ?t=';
const double _startSecondsthree = 0000000000000000000000000002461;
const String _videoIdfour = 'https://youtu.be/WfVF-Ec4naQ?t=';
const double _startSecondsfour = 000000000000000000000000000442;
const String _videoIdfive = 'https://youtu.be/Am1lDj2mUVY?t=';
const double _startSecondsfive = 0000000000000000000000000002203;
