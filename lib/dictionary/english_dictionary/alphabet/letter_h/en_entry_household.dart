...
class EnglishEntryhousehold extends StatefulWidget {
  const EnglishEntryhousehold({super.key});

  @override
  State<EnglishEntryhousehold> createState() => _EnglishEntryhouseholdState();
}

class _EnglishEntryhouseholdState extends State<EnglishEntryhousehold> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: household (Derived forms: households)
1. A social unit living together (- family, house, home, ménage)
"It was a good Christian household";
""",
  );

  final String keyword = "household";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""household""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The kids all help out with the household chores.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Leaflets have been delivered to every household.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Many household products are potentially harmful.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsthree = 0000000000000000000000000001939;
    const String videoIdfour = 'https://youtu.be/Xzv84ZdtlE0?t=';
    const double startSecondsfour = 0000000000000000000000000001582;
    const String videoIdfive = 'https://youtu.be/YrMGIqecu0Y?t=';
    const double startSecondsfive = 00000000000000000000000000078;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """household""",
                      // alsoEnglishWord: "also: household",
                      britshText: """IpaUK: /ˈhaʊshəʊld/""",
                      americanText: """IpaUS: /ˈhaʊshəʊld/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "لە دەیەی ڕابردوودا پێکھاتەی ماڵ گۆڕاوە؟",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زۆر بەرھەمی ماڵەوە دەکرێت لە ڕاستیدا زیانبەخش بن.""",
