...
class EnglishEntryincinerator extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incinerator""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 1824;
    const String videoIdone = 'sAiTuitN5b8';
    const double startSecondsone = 132;
    const String videoIdtwo = 'Q4Xys-IRMr0';
    const double startSecondstwo = 47;
    const String videoIdthree = 'OIo2Ie1HwHY';
    const double startSecondsthree = 2195;
    const String videoIdfour = 'S758wEniU0c';
    const double startSecondsfour = 281;
    const String videoIdfive = 'KXRtNwUju5g';
    const double startSecondsfive = 928;
