...
class EnglishEntryhumidity extends StatefulWidget {
  const EnglishEntryhumidity({super.key});

  @override
  State<EnglishEntryhumidity> createState() => _EnglishEntryhumidityState();
}

class _EnglishEntryhumidityState extends State<EnglishEntryhumidity> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: humidity (Derived forms: humidities)
1. Wetness in the atmosphere (- humidness)
""",
  );

  final String keyword = "humidity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""humidity""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Instruments constantly monitor temperature and humidity.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Care should be taken in conditions of high humidity.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""These plants need heat and humidity to grow well.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    // 188888880002200
    const String videoIdend = 'https://youtu.be/Mq0-B1kkfRo';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/wB3Yyq4xy_Y?t=';
    const double startSecondsone = 0000000000000000000000000004;
    const String videoIdtwo = 'https://youtu.be/OgMFtn_iFZc?t=';
    const double startSecondstwo = 00000000000000000000000000025;
    const String videoIdthree = 'https://youtu.be/4I0qG-8Pbps?t=';
    const double startSecondsthree = 00000000000000000000000000084;
    const String videoIdfour = 'https://youtu.be/cee6883w2Nk?t=';
    const double startSecondsfour = 000000000000000000000000000208;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """humidity""",
                      // alsoEnglishWord: "also: humidity",
                      britshText: """IpaUK: /hjuːˈmɪdəti/""",
                      americanText: """IpaUS: /hjuːˈmɪdəti/""",
...
// With short examples define "humidity", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) شێداری؛ ڕێژەی ئاو لە هەوادا"""),
                    SentencesRow(
                      englishText: """Instruments constantly monitor temperature and humidity.""",
                      kurdishText: """ئامێرەکان بەردەوام چاودێری پلەی گەرمی و شێداری دەکەن.""",
                    ...
                    SentencesRow(
                      englishText: """Care should be taken in conditions of high humidity.""",
                      kurdishText: """وریایی دەبێت لەبەرچاو بگیرێت لە کەشی شێداری زۆردا.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) دۆخێک کە تێیدا کەشووهەوا شێدار و گەرمە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """These plants need heat and humidity to grow well.""",
                      kurdishText: """ئەم ڕووەکانە پێویستییان بە شێدارییە بۆ گەشەکردن بە باشی.""",
