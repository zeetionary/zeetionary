...
class EnglishEntryimpressionism extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Impressionism""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'YooFwA7xj18';
    const double startSecondsend = 43;
    const String videoIdone = 'Lf3ER5Ope_s';
    const double startSecondsone = 84;
    const String videoIdtwo = '_tw51Eh9vcw';
    const double startSecondstwo = 52;
    const String videoIdthree = 'SHYfsYQDr6M';
    const double startSecondsthree = 87;
    const String videoIdfour = '4HjRR0l21Y0';
    const double startSecondsfour = 839;
    const String videoIdfive = '-i-EgBilwks';
    const double startSecondsfive = 1156;
