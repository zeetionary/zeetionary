...
class EnglishEntryailing extends StatelessWidget {
  EnglishEntryailing({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "ailing", // DOPSUM: CHANGE WORD ENTRY - Find /ˈeɪlɪŋ/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈeɪlɪŋ/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'owVtsJ56WXE';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '6QGtKkpJlV8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'l6PlMpncVuc';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'OXhEBfK3Njc';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'D9s5Brovelc';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'Q97K6CDje3w';
