...
class EnglishEntryloosen extends StatefulWidget {
  const EnglishEntryloosen({super.key});

  @override
  State<EnglishEntryloosen> createState() => _EnglishEntryloosenState();
}

class _EnglishEntryloosenState extends State<EnglishEntryloosen> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: loosen (Derived forms: loosened, loosens, loosening)
1. Make less tight or stiff (- loose)
"loosen the tension on a rope";
 
2. Make less severe or strict (- relax)
"The government loosened the curfew after most of the rebels were caught";
 
3. Become less severe or strict (- relax, soften)
"The rules loosened after the new director arrived";
 
4. Disentangle and raise the fibers of (- tease, tease apart)
"loosen wool";
 
5. Make less dense
"loosen the soil"
 
6. Become loose, looser or less tight (- relax, loose)
"The noose loosened";
""",
  );

  final String keyword = "loosen";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""First loosen the nuts, then take off the wheel.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The rope holding the boat loosened.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She loosened her hair so that it fell over her shoulders.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He loosened his grip and let her go.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/mRj1RKh4xyY?t=135';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/Pon4Zux5MaQ?t=129';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/ujREEgxEP7g?t=35';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/rQM4-zbS9fc?t=330';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/4dBPGLmNzb8?t=242';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/L1kYZHnHS0E?t=454';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """loosen""",
                      // alsoEnglishWord: "also: loosen",
                      britshText: """IpaUK: /ˈluːsn/""",
                      americanText: """IpaUS: /ˈluːsn/""",
...
کوردی: 
"""),
// With short examples define "loosen", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) شلکردنەوە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: slacken"),
                    SentencesRow(
                      englishText: """First loosen the nuts, then take off the wheel.""",
                      kurdishText: """سەرەتا نەتەکان شل بکەرەوە، دواتر ویلەکە لێبکەرەوە.""",
                    ...
                    SentencesRow(
                      englishText: """The rope holding the boat loosened.""",
                      kurdishText: """ئەو حەبلەی بەلەمەکەی گرتبوو شلبوویەوە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) کردنەوەی قژی بەستراو"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She loosened her hair so that it fell over her shoulders.""",
                      kurdishText: """قژی کردەوە بە شێوەیەک کە کەوت بەسەر شانیدا.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) گرتنی ک/ست بە کەمتر توندییەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He loosened his grip and let her go.""",
                      kurdishText: """چنگی شلکردەوە و هێشتی بچێت.""",
