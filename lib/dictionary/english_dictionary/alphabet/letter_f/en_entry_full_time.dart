...
class EnglishEntryfulltime extends StatefulWidget {
  const EnglishEntryfulltime({super.key});

  @override
  State<EnglishEntryfulltime> createState() => _EnglishEntryfulltimeState();
}

class _EnglishEntryfulltimeState extends State<EnglishEntryfulltime> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "full-time";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""full-time""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The referee blew his whistle for full time.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She works full-time and still manages to run a home.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """full-time""",
                      // alsoEnglishWord: "also: full-time",
                      britshText: """IpaUK: /ˌfʊl ˈtaɪm/""",
                      americanText: """IpaUS: /ˌfʊl ˈtaɪm/""",
...
// With short examples define "full-time", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ناوبژیونەکە فیکەی کاتی کۆتایی لێدا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) بۆ تەواوی کاتژمێرەکانی کارکردنی هەفتە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She works full-time and still manages to run a home.""",
                      kurdishText:
                          """کاری تەواوەتی دەکات و هێشتا دەتوانێت ماڵێک بەڕێوە ببات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/fU1L780mPiM?t=';
const double _startSecondsend = 000000000000000000000000000261;
...
const String _videoIdthree = 'https://youtu.be/7NtSNFUyPes?t=';
...
const String _videoIdfive = 'https://youtu.be/a6HJkshGqEQ?t=';
