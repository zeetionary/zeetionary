...
class EnglishEntryhectic extends StatefulWidget {
  const EnglishEntryhectic({super.key});

  @override
  State<EnglishEntryhectic> createState() => _EnglishEntryhecticState();
}

class _EnglishEntryhecticState extends State<EnglishEntryhectic> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hectic
1. Marked by intense agitation or emotion (- feverish)
"worked at a hectic pace";
""",
  );

  final String keyword = "hectic";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Today was too hectic for me.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The job gets a bit hectic at times.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hectic""",
                      // alsoEnglishWord: "also: hectic",
                      britshText: """IpaUK: /ˈhektɪk/""",
                      americanText: """IpaUS: /ˈhektɪk/""",
...
// With short examples define "hectic", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """کارەکە هەندێک جار پڕجم‌وجۆڵ دەبێت.""",
...
const String _videoIdtwo = 'https://youtu.be/dT5ALH3ICTc?t=';
const double _startSecondstwo = 000000000000000000000000000723;
const String _videoIdthree = 'https://youtu.be/Uhh_An7FGek?t=';
const double _startSecondsthree = 0000000000000000000000000001033;
const String _videoIdfour = 'https://youtu.be/OqQ1rW6xQ-k?t=';
const double _startSecondsfour = 00000000000000000000000000031;
const String _videoIdfive = 'https://youtu.be/k1aGKIKWcyg?t=';
const double _startSecondsfive = 000000000000000000000000000618;
