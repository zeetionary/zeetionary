...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'WVzvTLSK5dY';
    const double startSecondsend = 67;
    const String videoIdone = 'Fkeltn6xVHs';
    const double startSecondsone = 289;
    const String videoIdtwo = 'QefprURGzzI';
    const double startSecondstwo = 140;
    const String videoIdthree = 'BItZw88qcpk';
    const double startSecondsthree = 18;
    const String videoIdfour = 'dLYUc5t6wag';
    const double startSecondsfour = 587;
    const String videoIdfive = 'ybM6nU9EU7Y';
