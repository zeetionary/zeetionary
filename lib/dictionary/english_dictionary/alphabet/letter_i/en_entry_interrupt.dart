...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'https://youtu.be/TOzQrOPrjwk?t=';
    const double startSecondstwo = 00000000000000000000000000045;
    const String videoIdthree = 'https://youtu.be/sDmeXdC3myg?t=';
    const double startSecondsthree = 000000000000000000000000000717;
    const String videoIdfour = 'https://youtu.be/CZ7pXbAU3Hc?t=';
    const double startSecondsfour = 000000000000000000000000000457;
    const String videoIdfive = 'https://youtu.be/3NxenCGfxEk?t=';
