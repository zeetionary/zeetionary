...
class EnglishEntrylibrarian extends StatefulWidget {
  const EnglishEntrylibrarian({super.key});

  @override
  State<EnglishEntrylibrarian> createState() => _EnglishEntrylibrarianState();
}

class _EnglishEntrylibrarianState extends State<EnglishEntrylibrarian> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""librarian""");
  }
