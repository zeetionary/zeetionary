...
class EnglishEntryfrosty extends StatefulWidget {
  const EnglishEntryfrosty({super.key});

  @override
  State<EnglishEntryfrosty> createState() => _EnglishEntryfrostyState();
}

class _EnglishEntryfrostyState extends State<EnglishEntryfrosty> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: frosty (Derived forms: frostier, frostiest)
1. Devoid of warmth and cordiality; expressive of unfriendliness or disdain (= frigid, frozen, glacial, icy, wintry)
"got a frosty reception";
 
2. Covered with frost (- rimed, rimy)
"a frosty glass";

3. Pleasantly cold and invigorating (- crisp, nipping, nippy [informal], snappy [informal])
"crisp clear nights and frosty mornings";
""",
  );

  final String keyword = "frosty";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He breathed in the frosty air.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It’s frosty outside.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The weather turned frosty.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I looked out over the frosty fields.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""My questions were met with a frosty silence.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frosty""",
                      // alsoEnglishWord: "also: frosty",
                      britshText: """IpaUK: /ˈfrɒsti/""",
                      americanText: """IpaUS: /ˈfrɔːsti/""",
...
کوردی: زۆر سارد، ساردوسڕ (لە ڕەفتاردا)،	بەستوو، شەختەبەند، سەهۆڵ‌بەند
"""),
// With short examples define "frosty", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە هەوا ساردەکەدا هەناسەی دا.""",
                    ...
                    SentencesRow(
                      englishText: """It’s frosty outside.""",
                      kurdishText: """دەرەوە زۆر ساردە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The weather turned frosty.""",
                      kurdishText: """کەشووهەواکە ساردی کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پریسیارەکانم بە بێ‌دەنگیی ساردوسڕانە وەڵام درانەوە.""",
