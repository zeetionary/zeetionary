...
class EnglishEntryinn extends StatefulWidget {
  const EnglishEntryinn({super.key});

  @override
  State<EnglishEntryinn> createState() => _EnglishEntryinnState();
}

class _EnglishEntryinnState extends State<EnglishEntryinn> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: inn (Derived forms: inns)
1. A hotel providing overnight lodging for travellers (- hostel, hostelry, lodge, auberge)
 
2. [Brit] A building with a bar that is licensed to sell alcoholic drinks (- tavern, tap house [archaic], watering hole [informal], public house [Brit], pub [Brit, Cdn], saloon [Brit], pothouse [archaic], gin mill [N. Amer, informal], taphouse [archaic], groggery [US, archaic], boozer [Brit, informal])
""",
  );

  final String keyword = "inn";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It was very warm in the inn.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We had dinner at the inn.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We stayed at a country inn.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/p-L0WIQsi5o?t=';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/YZkXDuKto_Y?t=';
    const double startSecondsone = 000000000000000000000000000512;
    const String videoIdtwo = 'https://youtu.be/6CN9HpYrjeM?t=';
    const double startSecondstwo = 000000000000000000000000000140;
    const String videoIdthree = 'https://youtu.be/r7ccg1nIE_c?t=';
    const double startSecondsthree = 000000000000000000000000000675;
    const String videoIdfour = 'https://youtu.be/rtLTZUaMSDQ?t=';
    const double startSecondsfour = 00000000000000000000000000071;
    const String videoIdfive = 'https://youtu.be/UX4KklvCDmg?t=';
    const double startSecondsfive = 000000000000000000000000000623;
...
کوردی: 
"""),
// With short examples define "inn", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) میوانخانەیەک، زۆرجار کە لە دەشت‌ودەرە و خەڵکی دەتوانن شەو لێی بمێننەوە"""),
                    SentencesRow(
                      englishText: """It was very warm in the inn.""",
                      kurdishText: """زۆر گەرم بوو لە میوانخانەکە.""",
                    ...
                    SentencesRow(
                      englishText: """We had dinner at the inn.""",
                      kurdishText: """نانی ئێوارەمان لە میوانخانەکە خوارد.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ناو) هوتێلێکی بچووک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We stayed at a country inn.""",
                      kurdishText: """لە هوتێلێکی دەشت ماینەوە.""",
