...
class EnglishEntryaccident extends StatefulWidget {
  const EnglishEntryaccident({super.key});

  @override
  State<EnglishEntryaccident> createState() => _EnglishEntryaccidentState();
}

class _EnglishEntryaccidentState extends State<EnglishEntryaccident> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accident""",
                      // alsoEnglishWord: "also: accident",
                      britshText: """IpaUK: /ˈæksɪdənt/""",
                      americanText: """IpaUS: /ˈæksɪdənt/""",
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = '-HfyDaFb6ok';
  final double _startSeconds = 0;
