...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000005010;
    const String videoIdone = 'https://youtu.be/WA4a8ouaars?t=';
    const double startSecondsone = 000000000000000000000000000491;
    const String videoIdtwo = 'https://youtu.be/qCbfTN-caFI?t=';
    const double startSecondstwo = 0000000000000000000000000001752;
    const String videoIdthree = 'https://youtu.be/d1eaQrxA6ZE?t=';
    const double startSecondsthree = 000000000000000000000000000363;
    const String videoIdfour = 'https://youtu.be/YMRRrvBlK8I?t=';
    const double startSecondsfour = 000000000000000000000000000273;
    const String videoIdfive = 'https://youtu.be/Aks0W6OSM2k?t=';
