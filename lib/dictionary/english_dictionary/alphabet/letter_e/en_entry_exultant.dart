...
class EnglishEntryexultant extends StatefulWidget {
  const EnglishEntryexultant({super.key});

  @override
  State<EnglishEntryexultant> createState() => _EnglishEntryexultantState();
}

class _EnglishEntryexultantState extends State<EnglishEntryexultant> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exultant""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """exultant""",
                      // alsoEnglishWord: "also: exultant",
                      britshText: """IpaUK: /ɪɡˈzʌltənt/""",
                      americanText: """IpaUS: /ɪɡˈzʌltənt/""",
...
کوردی: شاد، خۆش، سەرخۆش، بەکەیف، خۆشحاڵ 
"""),
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: exultant
1. Joyful and proud especially because of triumph or success (= exulting, jubilant, prideful, rejoicing, triumphal, triumphant)
"exultant crowds filled the streets on VJ Day";
""",
  );
...
const String _videoIdend = 'https://youtu.be/U5rM3RTTDx0?t=';
const double _startSecondsend = 000000000000000000000000000408;
const String _videoIdone = 'https://youtu.be/SAxhFQr9ZdQ?t=';
const double _startSecondsone = 0000000000000000000000000001268;
const String _videoIdtwo = 'https://youtu.be/yBLoZcOuboA?t=';
const double _startSecondstwo = 000000000000000000000000000300;
const String _videoIdthree = 'https://youtu.be/7-nxopj-9eM?t=';
const double _startSecondsthree = 0000000000000000000000000001788;
const String _videoIdfour = 'https://youtu.be/ejBJaHFPC6o?t=';
const double _startSecondsfour = 0000000000000000000000000001776;
const String _videoIdfive = 'https://youtu.be/qWm_6l5m8uc?t=';
const double _startSecondsfive = 0000000000000000000000000002365;
