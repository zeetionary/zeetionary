...
// replace these: replace EnglishEntryamass - replace speakAmass - replace amass - /əˈmæs/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryamass extends StatelessWidget {
  EnglishEntryamass({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAmass(String languageCode) async {
    // DOPSUM: CHANGE speakAmass
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "amass"), // DOPSUM: CHANGE WORD ENTRY - Find /əˈmæs/
                            // nothing heereee
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /əˈmæs/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                            CustomIconButtonBritish(
                              onPressed: () =>
                                  speakAmass(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /əˈmæs/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                            CustomIconButtonAmerican(
                              onPressed: () => speakAmass(
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'y4-yJ5hg8Ww';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = '3ulWkFs-OGM';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'JYJq02OTdSs';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'BNpk_OGEGlA';
