...
class EnglishEntryevidently extends StatefulWidget {
  const EnglishEntryevidently({super.key});

  @override
  State<EnglishEntryevidently> createState() => _EnglishEntryevidentlyState();
}

class _EnglishEntryevidentlyState extends State<EnglishEntryevidently> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evidently""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evidently""",
                      // alsoEnglishWord: "also: evidently",
                      britshText: """IpaUK: /ˈevɪdəntli/""",
                      americanText: """IpaUS: /ˈevɪdəntli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "evidently";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She walked slowly down the road, evidently in pain.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He was evidently upset by the news of the accident.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Evidently, she had nothing to do with the whole affair.""");
  }
...
// With short examples define "evidently", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: وادیارە، بە ڕوونی، بە ئاشکرایی
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵکار) بە ڕوونی و ئاشکرایی"""),
          SentencesRow(
            englishText:
                """She walked slowly down the road, evidently in pain.""",
            kurdishText:
                """بەهێواشی بە ڕێگاکەدا دەچوو و بە ڕوونی ئازاری هەبوو.""",
          ...
          SentencesRow(
            ...
            kurdishText: """بە ڕوونی بێزار بوو هەواڵی ڕووداوەکە.""",
            onPressedBritish: () => speaksentence2("en-GB"),
            onPressedAmerican: () => speaksentence2("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ھاوەڵکار) بەپیی ئەوەی خەڵک دەیڵێن"""),
          // const DividerSentences(),
          const AlsoEnglishckb(word: "ھەروەھا: apparently"),
          SentencesRow(
            englishText:
                """Evidently, she had nothing to do with the whole affair.""",
            kurdishText: """خەڵک گوتەنی، هیچ پەیوەندی بە ڕووداوەکە نەبوو.""",
          ...
          SentencesRow(
            englishText:
                """He had an accident, evidently because he was driving at excessive speed.""",
            kurdishText:
                """تووشی ڕووداوێک بوو، گوایە بەهۆی شۆفێری کردن بە خێرایی زۆر.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: evidently
1. Unmistakably; visibly clear; in an evident manner (= obviously, manifestly, patently, apparently, plainly, plain, obvs [non-standard, informal], clearly)
...
const double _startSecondsend = 000000000000000000000000000000; // 163;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/8eq2vGEEbB4?t=';
const double _startSecondsone = 00000000000000000000000000000; // 477;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/hS2emKDlGmE?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 1416;
const String _videoIdthree = 'VIDEOhttps://youtu.be/wJa5Ch0O4BI?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1424;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/P2EjH7l_N70?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 202;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/_JZxFm4MXMI?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 216;
