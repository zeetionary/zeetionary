...
class EnglishEntryhorticulture extends StatefulWidget {
  const EnglishEntryhorticulture({super.key});

  @override
  State<EnglishEntryhorticulture> createState() =>
      _EnglishEntryhorticultureState();
}

class _EnglishEntryhorticultureState extends State<EnglishEntryhorticulture> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: horticulture (Derived forms: horticultures)
1. The cultivation of plants (- gardening)
""",
  );

  final String keyword = "horticulture";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""horticulture""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """He is passionate about horticulture and grows his own garden.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/sJLHRGasLWk?t=';
    const double startSecondsend = 000000000000000000000000000656;
    const String videoIdone = 'https://youtu.be/K9UtK-bVpsg?t=';
    const double startSecondsone = 00000000000000000000000000090;
    const String videoIdtwo = 'https://youtu.be/J_htLIUKX1Y?t=';
    const double startSecondstwo = 00000000000000000000000000048;
    const String videoIdthree = 'https://youtu.be/pQJmn6z3h5Q?t=';
    const double startSecondsthree = 000000000000000000000000000896;
    const String videoIdfour = 'https://youtu.be/dTrFW-4gM4I?t=';
    const double startSecondsfour = 000000000000000000000000000116;
    const String videoIdfive = 'https://youtu.be/ZHanNbB2OaI?t=';
    const double startSecondsfive = 000000000000000000000000000418;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """horticulture""",
                      // alsoEnglishWord: "also: horticulture",
                      britshText: """IpaUK: /ˈhɔːtɪkʌltʃə(r)/""",
                      americanText: """IpaUS: /ˈhɔːrtɪkʌltʃər/""",
...
کوردی: باخەوانی، هونەری باخەوانی، بێستانەوانی
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) لێکۆڵینەوە کاری چاندنی گوڵ، سەوزە، و میوە"""),
                    SentencesRow(
                      englishText:
                          """He is passionate about horticulture and grows his own garden.""",
                      kurdishText:
                          """حەزی بە باخەوانی و باخچەی خۆی بەڕێوە دەبات.""",
