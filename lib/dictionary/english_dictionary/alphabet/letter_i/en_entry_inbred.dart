...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 678;
    const String videoIdone = 'OJ17e8U-5LE';
    const double startSecondsone = 181;
    const String videoIdtwo = 'T9Nx3RQkAB0';
    const double startSecondstwo = 352;
    const String videoIdthree = 'XrE0SnWsMIw';
    const double startSecondsthree = 2387;
    const String videoIdfour = 'h66CvBSHvJs';
    const double startSecondsfour = 328;
    const String videoIdfive = 'uuXlIbd50DQ';
    const double startSecondsfive = 1447;
