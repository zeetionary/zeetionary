...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 3757;
    const String videoIdone = 'wVyu7NB7W6Y';
    const double startSecondsone = 438;
    const String videoIdtwo = 'jTRC_FMzLoo';
    const double startSecondstwo = 449;
    const String videoIdthree = '_braqNPY0hM';
    const double startSecondsthree = 96;
    const String videoIdfour = 'kIwF0z9W5pE';
    const double startSecondsfour = 33;
    const String videoIdfive = 'iQ5GfDbjos8';
