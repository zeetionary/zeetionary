...
class EnglishEntryjeopardy extends StatefulWidget {
  const EnglishEntryjeopardy({super.key});

  @override
  State<EnglishEntryjeopardy> createState() => _EnglishEntryjeopardyState();
}

class _EnglishEntryjeopardyState extends State<EnglishEntryjeopardy> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryjeopardy jeopardy
WORD_WEB jeopardy jeopardy jeopardy
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "jeopardy";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""jeopardy""");
  }
...
کوردی: 
"""),
// With short examples define "jeopardy", please follow LX instructions
