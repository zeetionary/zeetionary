...
// replace EnglishEntryarthritic - replace speakArthritic

// replace arthritic - /ɑːˈθrɪtɪk/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarthritic extends StatelessWidget {
  // blank divider
  EnglishEntryarthritic({super.key});
  // blank divider
  ...
  Future<void> speakarthritic(String languageCode) async {
    ...
    await flutterTts.speak("arthritic");
  }
  ...
  Future<void> speakarthritic457(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Her hands were swollen and arthritic.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arthritic"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ɑːˈθrɪtɪk/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ɑːrˈθrɪtɪk/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'xxWeDt_Bi4Q';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '3Oq5o-g-vgY';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'udDv4IHOhDo';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final double _startSeconds = 9372;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'tbQifj7gCzQ';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = '-o8ZWkKZfiE';
