...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'wwWWPFPutNk';
    const double startSecondsend = 381;
    const String videoIdone = '3miuxAnawmM';
    const double startSecondsone = 220;
    const String videoIdtwo = 'yWI61kpFEAA';
    const double startSecondstwo = 171;
    const String videoIdthree = 'GW80IH-qpH4';
    const double startSecondsthree = 63;
    const String videoIdfour = '5zfZhskSmp0';
    const double startSecondsfour = 587;
    const String videoIdfive = 'cXEuZGkPYyw';
