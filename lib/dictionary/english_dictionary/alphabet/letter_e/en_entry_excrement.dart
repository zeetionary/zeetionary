...
class EnglishEntryexcrement extends StatefulWidget {
  const EnglishEntryexcrement({super.key});

  @override
  State<EnglishEntryexcrement> createState() => _EnglishEntryexcrementState();
}

class _EnglishEntryexcrementState extends State<EnglishEntryexcrement> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""excrement""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """excrement""",
                      // alsoEnglishWord: "also: excrement",
                      britshText: """IpaUK: /ˈekskrɪmənt/""",
                      americanText: """IpaUS: /ˈekskrɪmənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "excrement";
...
کوردی: پیسایی، ڕیخ، گوو، تەرسەقول، تڕۆڵ، لاز، شیاکە، لاسک، تەرس
"""),
          const DefinitionKurdish(
              text: """١. (ناو) پیسایی کە لە جەستەوە دەکرێتە دەرەوە"""),
          SentencesRow(
            englishText: """There was excrement smeared up the wall.""",
            kurdishText: """پیسایی ساوێندرا بوو بە دیوارەکەدا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: excrement (Derived forms: excrements)
1. Waste matter (as urine or sweat but especially faeces) discharged from the body (= body waste, excretion, excreta, excretory product)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/-obKX-mqjXQ?t=';
const double _startSecondsend = 000000000000000000000000000000; // 2104;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/mcZdTvOqmvI?t=';
const double _startSecondsone = 00000000000000000000000000000; // 620;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/9s9UXXAmlTg?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 400;
const String _videoIdthree = 'VIDEOhttps://youtu.be/Y-SnB10ihD4?t=';
const double _startSecondsthree = 000000000000000000000000000; // 451;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/EmT0i0xG6zg?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 927;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/Sew4rctKghY?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 400;
