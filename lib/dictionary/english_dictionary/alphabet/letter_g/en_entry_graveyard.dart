...
class EnglishEntrygraveyard extends StatefulWidget {
  const EnglishEntrygraveyard({super.key});

  @override
  State<EnglishEntrygraveyard> createState() => _EnglishEntrygraveyardState();
}

class _EnglishEntrygraveyardState extends State<EnglishEntrygraveyard> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: graveyard (Derived forms: graveyards)
1. A tract of land used for burials (- cemetery, burial site, burial ground, burying ground, memorial park, necropolis, boneyard [informal])
 
2. A final resting place for something that is obsolete, broken or no longer useable
"Afghanistan has been known over the years as the graveyard of empires"; "Off the shore of Staten Island rests a veritable graveyard of decommissioned, scrapped, and abandoned ships"
""",
  );

  final String keyword = "graveyard";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""graveyard""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The backyard became a graveyard for old cars.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """graveyard""",
                      // alsoEnglishWord: "also: graveyard",
                      britshText: """IpaUK: /ˈɡreɪvjɑːd/""",
                      americanText: """IpaUS: /ˈɡreɪvjɑːrd/""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/94O7hjS5dHg?t=';
const double _startSecondsend = 000000000000000000000000000994;
const String _videoIdone = 'https://youtu.be/p3O6bKdPLbw?t=';
const double _startSecondsone = 0000000000000000000000000001954;
const String _videoIdtwo = 'https://youtu.be/y4DTW4B3Sjs?t=';
const double _startSecondstwo = 000000000000000000000000000590;
const String _videoIdthree = 'https://youtu.be/kHTcoPoAnys?t=';
const double _startSecondsthree = 000000000000000000000000000307;
const String _videoIdfour = 'https://youtu.be/yRFPjBuRRCg?t=';
const double _startSecondsfour = 0000000000000000000000000001149;
const String _videoIdfive = 'https://youtu.be/qSmyimnMOBo?t=';
const double _startSecondsfive = 0000000000000000000000000003352;
