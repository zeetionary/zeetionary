...
class EnglishEntryfluctuation extends StatefulWidget {
  const EnglishEntryfluctuation({super.key});

  @override
  State<EnglishEntryfluctuation> createState() =>
      _EnglishEntryfluctuationState();
}

class _EnglishEntryfluctuationState extends State<EnglishEntryfluctuation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fluctuation (Derived forms: fluctuations)
1. A wave motion
"the fluctuations of the sea"
 
2. An instance of change; the rate or magnitude of change (= variation)
 
3. The quality of being unsteady and subject to changes (= wavering)
"he kept a record of price fluctuations";
""",
  );

  final String keyword = "fluctuation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fluctuation""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The temperature showed fluctuation throughout the day.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fluctuation""",
                      // alsoEnglishWord: "also: fluctuation",
                      britshText: """IpaUK: /ˌflʌktʃuˈeɪʃn/""",
                      americanText: """IpaUS: /ˌflʌktʃuˈeɪʃn/""",
...
کوردی: هەڵکشان و داکشان، هەستان و کەوتن، بەرزی و نزمی، کەمی و زۆری، هەڵس‌وکەوت، هەست‌وکەوت، گۆڕان، زووزووگۆڕان
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) یەکێک لە ژمارەیەک گۆڕان لە ئەندازە، بڕ، کوالێتی، هتد کە زووزوو ڕوودەدات"""),
                    SentencesRow(
                      englishText:
                          """The temperature showed fluctuation throughout the day.""",
                      kurdishText:
                          """پلەی گەرمی بۆ تەواوی ڕۆژەکە گۆڕانی هەبوو.""",
...
const double _startSecondsend = 0000000000000000000000000002135;
const String _videoIdone = 'https://youtu.be/0Anx3VQ2dcc?t=';
const double _startSecondsone = 000000000000000000000000000835;
const String _videoIdtwo = 'https://youtu.be/NNnIGh9g6fA?t=';
const double _startSecondstwo = 000000000000000000000000000352;
const String _videoIdthree = 'https://youtu.be/RONuW3-fr0U?t=';
const double _startSecondsthree = 000000000000000000000000000423;
const String _videoIdfour = 'https://youtu.be/a_wuykzfFzE?t=';
const double _startSecondsfour = 000000000000000000000000000411;
const String _videoIdfive = 'https://youtu.be/VqFwo4g_X7g?t=';
