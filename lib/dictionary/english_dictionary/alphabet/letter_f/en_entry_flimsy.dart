...
class EnglishEntryflimsy extends StatefulWidget {
  const EnglishEntryflimsy({super.key});

  @override
  State<EnglishEntryflimsy> createState() => _EnglishEntryflimsyState();
}

class _EnglishEntryflimsyState extends State<EnglishEntryflimsy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flimsy (Derived forms: flimsiest, flimsier)
1. Lacking solidity or strength (= insubstantial)
"a flimsy table"; "flimsy construction";
 
2. Lacking substance or significance (= fragile, slight, tenuous, thin)
 
3. Not convincing (= unconvincing)
"a flimsy argument";

- Noun: flimsy (Derived forms: flimsies)
1. A thin strong lightweight translucent paper used especially for making carbon copies (= onionskin)
""",
  );

  final String keyword = "flimsy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We spent the night in a flimsy wooden hut.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""You won't be warm enough in that flimsy dress.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The evidence against him is pretty flimsy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flimsy""",
                      // alsoEnglishWord: "also: flimsy",
                      britshText: """IpaUK: /ˈflɪmzi/""",
                      americanText: """IpaUS: /ˈflɪmzi/""",
...
کوردی: ناسک، تەنک، ڕوون، ڕۆشن (پارچە)،	نابەردەوام، لەق، بەکارنەهاتوو، بەرگەنەگر، لۆق، ناقایم، نەرم، ناسک، قرچ، بازاڕی، خراپ، ڕێزەڵۆک،	سست، بێ‌هێز، بێجێ، ناژیرانە،	کاغزی ناسک
"""),
// With short examples define "flimsy", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شەوەکەمان لە کوخێکی خراپی دارین بەسەر برد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """گەرم نابیتەوە لەو جلە ناسکەدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بەڵگەی دژی تەواو بێ‌هێزە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """When I asked him why he was late, he gave me some flimsy excuse about having car trouble.""",
                      kurdishText:
                          """کە لێیم پرسی بۆچی درەنگ کەوتووە ژمارەیەک بیانووی لاوازی هێنایەوە سەبارەت بە هەبوونی کێشەی ئۆتۆمبێل.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/VS6tnF31zr4';
...
const String _videoIdtwo = 'https://youtu.be/SaneSRqePVY?t=';
const double _startSecondstwo = 00000000000000000000000000084;
const String _videoIdthree = 'https://youtu.be/YLmDE_JYUNU?t=';
const double _startSecondsthree = 0000000000000000000000000001097;
const String _videoIdfour = 'https://youtu.be/viOpP6P_PrQ?t=';
const double _startSecondsfour = 000000000000000000000000000721;
const String _videoIdfive = 'https://youtu.be/X-EIkF5GF7k?t=';
