...
class EnglishEntryhighjump extends StatefulWidget {
  const EnglishEntryhighjump({super.key});

  @override
  State<EnglishEntryhighjump> createState() => _EnglishEntryhighjumpState();
}

class _EnglishEntryhighjumpState extends State<EnglishEntryhighjump> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: high jump (Derived forms: high jumps)
...
""",
  ...
  final String keyword = "high jump";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""high jump""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She won a silver medal in the high jump.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """high jump""",
                      // alsoEnglishWord: "also: high jump",
                      britshText: """IpaUK: /ˈhaɪ dʒʌmp/""",
                      americanText: """IpaUS: /ˈhaɪ dʒʌmp/""",
...
// With short examples define "high jump", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) یارییەکی وەرزشی کە تێیدا وەرزشوانان هەوڵ دەدەن بەسەر ستوونێکدا باز بدەن کە زیاتر و زیاتر بەرز دەکرێتەوە"""),
                    SentencesRow(
                      englishText: """She won a silver medal in the high jump.""",
                      kurdishText: """مەدالیایەکی سلڤەری بەردەوە لە بازی بەرزدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ZMQbHMgK2rw?t=';
const double _startSecondsend = 000000000000000000000000000782;
const String _videoIdone = 'https://youtu.be/a1jF-AokfCQ?t=';
const double _startSecondsone = 000000000000000000000000000342;
const String _videoIdtwo = 'https://youtu.be/m622EACPek4?t=';
const double _startSecondstwo = 000000000000000000000000000350;
const String _videoIdthree = 'https://youtu.be/uvFnLay7-z4?t=';
const double _startSecondsthree = 00000000000000000000000000044;
const String _videoIdfour = 'https://youtu.be/Xdz6jxscD0w?t=';
const double _startSecondsfour = 000000000000000000000000000615;
const String _videoIdfive = 'https://youtu.be/rcTn5iZa5Ms?t=';
