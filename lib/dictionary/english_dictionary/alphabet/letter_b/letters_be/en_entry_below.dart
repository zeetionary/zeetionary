...
class EnglishEntrybelow extends StatelessWidget {
  ...
  Future<void> speakbelows1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("They live on the floor below.");
  }
  ...
  Future<void> speakbelows2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("I could still see the airport buildings far below.");
  }
  ...
  Future<void> speakbelows3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("See below for references.");
  }
  ...
  Future<void> speakbelows4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("This ruling applies to the ranks of officers and below.");
  }
  ...
  Future<void> speakbelows5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("The thermometer had dropped to a record 40 below.");
  }
  ...
  Future<void> speakbelows6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Please do not write below this line.");
  }
  ...
  Future<void> speakbelows7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("He dived below the surface of the water.");
  }
  ...
  Future<void> speakbelows8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("In this school, skirts will be worn below the knee.");
  }
  ...
  Future<void> speakbelows9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("The temperatures remained below freezing all day.");
  }
  ...
  Future<void> speakbelows10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("She held a position below manager in the company.");
  }
  ...
  Future<void> speakbelows11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("speakBelows1111");
  }
  ...
  Future<void> speakbelows12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("speakBelows1212");
  }
  ...
  Future<void> speakbelows13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("speakBelows1313");
  }
...
"""),
                          ...
                          SentencesRow(
                            englishText: "They live on the floor below.",
                            kurdishText: "لە نھۆمی خوارەوە دەژین.",
                            onPressedBritish: () => speakbelows1("en-GB"),
                            onPressedAmerican: () => speakbelows1("en-US"),
                          ),
                          ...
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbelows2("en-GB"),
                            onPressedAmerican: () => speakbelows2("en-US"),
                          ),
                          const DividerSentences(),
                          // const DividerDefinition(),
                          SentencesRow(
                            ...
                            kurdishText: "سەیری خوارەوە بکە بۆ سەرچاوەکان.",
                            onPressedBritish: () => speakbelows3("en-GB"),
                            onPressedAmerican: () => speakbelows3("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
...
٢. (ھاوەڵکار) لە پلەیەکی نزمتر"""),
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbelows4("en-GB"),
                            onPressedAmerican: () => speakbelows4("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٣. (ھاوەڵکار) نزمتر لە سفر"""),
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbelows5("en-GB"),
                            onPressedAmerican: () => speakbelows5("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٤. (ئامراز) لە ئاست یان جێگەیەکی خوارتر وەک لە کەسێکی تر"""),
                          SentencesRow(
                            englishText: "Please do not write below this line.",
                            kurdishText: "تکایە لە خوار ئەم ھێڵەوە مەنووسە.",
                            onPressedBritish: () => speakbelows6("en-GB"),
                            onPressedAmerican: () => speakbelows6("en-US"),
                          ),
                          const DividerSentences(),
                          // const DividerDefinition(),
                          SentencesRow(
                            ...
                            kurdishText: "دابەزییە ژێر ئاوەکە.",
                            onPressedBritish: () => speakbelows7("en-GB"),
                            onPressedAmerican: () => speakbelows7("en-US"),
                          ),
                          const DividerSentences(),
                          // const DividerDefinition(),
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbelows8("en-GB"),
                            onPressedAmerican: () => speakbelows8("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٥. (ئامراز) لە ئاستێک یان ستانداردی کەمتر"""),
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbelows9("en-GB"),
                            onPressedAmerican: () => speakbelows9("en-US"),
                          ),
                          // const DividerSentences(),
                          const DividerDefinition(),
                          const DefinitionKurdish(text: """
٦. (ئامراز) لە پلەیەکی نزمتر"""),
                          SentencesRow(
                            ...
                            onPressedBritish: () => speakbelows10("en-GB"),
                            onPressedAmerican: () => speakbelows10("en-US"),
                          ),
                          // const DividerSentences(),
                          // const DividerDefinition(),
                        ],
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'FY6KvRmlp14';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'eIQuuoTQIoc';
...
class YoutubeEmbeddeddfourteen extends StatelessWidget {
  ...
  final String _videoId = 'giQ_EUUEv1g';
...
class YoutubeEmbeddeddsixteen extends StatelessWidget {
  ...
  final String _videoId = '3oIakJekCZU';
