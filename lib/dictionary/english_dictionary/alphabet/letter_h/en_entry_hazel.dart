...
class EnglishEntryhazel extends StatefulWidget {
  const EnglishEntryhazel({super.key});

  @override
  State<EnglishEntryhazel> createState() => _EnglishEntryhazelState();
}

class _EnglishEntryhazelState extends State<EnglishEntryhazel> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hazel
1. Of a light brown or yellowish brown colour

- Noun: hazel (Derived forms: hazels)
1. Australian tree or shrub of the genus Corylus, bearing edible nuts called hazelnuts or filberts; grown especially for ornament and its fine-grained wood (- hazel tree, Pomaderris apetala)
 
2. The fine-grained wood of a hazelnut tree (genus Corylus) and the hazel tree (Australian genus Pomaderris)
 
3. Any of several shrubs or small trees of the genus Corylus bearing edible nuts enclosed in a leafy husk (- hazelnut, hazelnut tree)
 
4. A shade of brown that is yellowish or reddish; it is a greenish shade of brown when used to describe the colour of someone's eyes
""",
  );

  final String keyword = "hazel";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hazel tree grew in the backyard.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her eyes were a beautiful hazel shade.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hazel""",
                      // alsoEnglishWord: "also: hazel",
                      britshText: """IpaUK: /ˈheɪzl/""",
                      americanText: """IpaUS: /ˈheɪzl/""",
...
// """),
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) ڕەنگی چاو کە لە نێوان قاوەیی کاڵ و سەوز یان ئاڵتوونییە"""),
                    SentencesRow(
                      englishText: """Her eyes were a beautiful hazel shade.""",
                      kurdishText:
                          """چاوەکانی ڕەنگێکی مەیلەو قاوەیی جوان بوون.""",
...
const double _startSecondsend = 0000000000000000000000000001206;
const String _videoIdone = 'https://youtu.be/zpDuNzO_rwA?t=';
const double _startSecondsone = 000000000000000000000000000101;
const String _videoIdtwo = 'https://youtu.be/O_qgaOUR3Fo?t=';
const double _startSecondstwo = 000000000000000000000000000297;
const String _videoIdthree = 'https://youtu.be/gJ5q_AOWv5g?t=';
const double _startSecondsthree = 00000000000000000000000000065;
const String _videoIdfour = 'https://youtu.be/CzoG2Mld3I0?t=';
const double _startSecondsfour = 000000000000000000000000000104;
const String _videoIdfive = 'https://youtu.be/72HFPTaQ4os?t=';
const double _startSecondsfive = 000000000000000000000000000429;
