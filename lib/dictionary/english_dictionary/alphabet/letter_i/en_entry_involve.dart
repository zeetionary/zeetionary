...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/bhRCzudj3rA?t=';
    const double startSecondsend = 193;
    const String videoIdone = 'https://youtu.be/J-K5OjAkiEA?t=';
    const double startSecondsone = 00000000000000000000000000038;
    const String videoIdtwo = 'https://youtu.be/b4wRdoWpw0w?t=';
    const double startSecondstwo = 000000000000000000000000000675;
    const String videoIdthree = 'https://youtu.be/bV9f3DE4LlM?t=';
    const double startSecondsthree = 000000000000000000000000000112;
    const String videoIdfour = 'https://youtu.be/G3pJOg1MJuo?t=';
    const double startSecondsfour = 000000000000000000000000000274;
    const String videoIdfive = 'https://youtu.be/7eM7pb5M5DU?t=';
