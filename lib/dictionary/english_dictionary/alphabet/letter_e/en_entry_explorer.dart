...
class EnglishEntryexplorer extends StatefulWidget {
  const EnglishEntryexplorer({super.key});

  @override
  State<EnglishEntryexplorer> createState() => _EnglishEntryexplorerState();
}

class _EnglishEntryexplorerState extends State<EnglishEntryexplorer> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""explorer""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """explorer""",
                      // alsoEnglishWord: "also: explorer",
                      britshText: """IpaUK: /ɪkˈsplɔːrə(r)/""",
                      americanText: """IpaUS: /ɪkˈsplɔːrər/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Early explorers traded directly with Indigenous people.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The river Amazon was named by Spanish explorer Francisco de Orellana.""");
  }
...
کوردی: گەڕیدە، گەڕوان، گەشتیار،	دۆزەرەوە
"""),
          const DefinitionKurdish(text: """١. (ناو) کەسێک کە گەشت بۆ ئەو شوێنانە دەکات کە پێشووتر کەم کەس بۆی چوونە، یان بۆ شوێنی نەزانراو"""),
          SentencesRow(
            englishText:
                """Early explorers traded directly with Indigenous people.""",
            kurdishText: """گەڕیدە سەرەتاییەکان ڕاستەوخۆ لەگەڵ خەڵکە ڕەسەنەکە بازرگانییان دەکرد.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The river Amazon was named by Spanish explorer Francisco de Orellana.""",
            kurdishText: """ڕووباری ئەمازۆن لەلایەن گەڕیدەی ئیسپانی فرانسیسکۆ دی ئۆریلانا ناونرا.""",
...
const String _videoIdend = 'https://youtu.be/KVUJkcy5dq8?t=';
const double _startSecondsend = 00000000000000000000000000091;
const String _videoIdone = 'https://youtu.be/FIsNnVwY3ts';
...
const String _videoIdthree = 'https://youtu.be/mjCAyo2Litw?t=';
const double _startSecondsthree = 0000000000000000000000000001164;
const String _videoIdfour = 'https://youtu.be/fU-8Rg4CgeI?t=';
const double _startSecondsfour = 000000000000000000000000000122;
const String _videoIdfive = 'https://youtu.be/-obKX-mqjXQ?t=';
const double _startSecondsfive = 000000000000000000000000000216;
