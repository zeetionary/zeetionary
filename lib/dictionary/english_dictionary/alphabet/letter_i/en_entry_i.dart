...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'e_04ZrNroTo';
    const double startSecondsend = 160;
    const String videoIdone = 'ohHYABXMqUQ';
    const double startSecondsone = 11;
    const String videoIdtwo = 'Wm4R8d0d8kU';
    const double startSecondstwo = 14;
    const String videoIdthree = '3YltYCrPZos';
    const double startSecondsthree = 14;
    const String videoIdfour = 'rPe4yziWiOg';
    const double startSecondsfour = 141;
    const String videoIdfive = 'HvNdJ2RCReg';
