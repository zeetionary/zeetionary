...
class EnglishEntryindustrialist extends StatefulWidget {
  const EnglishEntryindustrialist({super.key});

  @override
  State<EnglishEntryindustrialist> createState() =>
      _EnglishEntryindustrialistState();
}

class _EnglishEntryindustrialistState extends State<EnglishEntryindustrialist> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""industrialist""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was the son of a wealthy industrialist.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/oL0umpPPe-8?t=';
    const double startSecondsend = 000000000000000000000000000163;
    const String videoIdone = 'https://youtu.be/pv-c70rrKZI?t=';
    const double startSecondsone = 000000000000000000000000000702;
    const String videoIdtwo = 'https://youtu.be/Solb9uA-tgQ?t=';
    const double startSecondstwo = 00000000000000000000000000013644;
    const String videoIdthree = 'https://youtu.be/YC_PXwvGmRk?t=';
    const double startSecondsthree = 000000000000000000000000000243;
    const String videoIdfour = 'https://youtu.be/kRO5jOa06Qw?t=';
    const double startSecondsfour = 0000000000000000000000000002568;
    const String videoIdfive = 'https://youtu.be/Ujp4jbliyig?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """industrialist""",
                      // alsoEnglishWord: "also: industrialist",
                      britshText: """IpaUK: /ɪnˈdʌstriəlɪst/""",
                      americanText: """IpaUS: /ɪnˈdʌstriəlɪst/""",
...
کوردی: کارخانەدار، خاوەن‌کارخانە، خاوەن‌کارگە
"""),
// With short examples define "industrialist", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە خاوەنداری کارگەیەکی گەورە یان کۆمپانیایەکی پیشەسازی دەکات، یان بەڕێوەی دەبات"""),
                    SentencesRow(
                      englishText:
                          """He was the son of a wealthy industrialist.""",
                      kurdishText: """کوڕی خاوەن‌کارخانەیەکی دەوڵەمەند بوو.""",
