...
// replace these: replace EnglishEntryanalyze - replace speakanalyze - replace analyze - /ˈænəlaɪz/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryanalyze extends StatelessWidget {
  EnglishEntryanalyze({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakanalyze(String languageCode) async {
    // DOPSUM: CHANGE speakanalyze
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("analyze"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakanalyze7950(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The job involves collecting and analyzing data."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakanalyze4920(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He tried to analyze his feelings."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakanalyze469(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("We need to analyze what went wrong."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "analyze", // DOPSUM: CHANGE WORD ENTRY - Find /ˈænəlaɪz/
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakanalyze(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () =>
                                    speakanalyze7950(// REPLACE: analyze /ˈænəlaɪz/
                                        "en-US"),
                              ),
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () =>
                                    speakanalyze4920(// REPLACE: analyze /ˈænəlaɪz/
                                        "en-US"),
                              ),
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () =>
                                    speakanalyze469(// REPLACE: analyze /ˈænəlaɪz/
                                        "en-US"),
                              ),
                            ],
                          ),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "L878W_WrTx8";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "p6Un9LY6V5w";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "uqIhHDuE62g";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "y_D4Slu-Wl4";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "tF_2QZo90lw";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "1xZzv95AOMk";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "CvhMPA9oNBI";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "MSBxQEFGytk";
