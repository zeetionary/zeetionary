...
class EnglishEntryequality extends StatefulWidget {
  const EnglishEntryequality({super.key});

  @override
  State<EnglishEntryequality> createState() => _EnglishEntryequalityState();
}

class _EnglishEntryequalityState extends State<EnglishEntryequality> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""equality""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equality""",
                      // alsoEnglishWord: "also: equality",
                      britshText: """IpaUK: /iˈkwɒləti/""",
                      americanText: """IpaUS: /iˈkwɑːləti/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Don't you believe in equality between men and women?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They fought for greater equality between the sexes.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Women do not yet have true equality in the company.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The State shall not deny anyone equality before the law.""");
  }
...
کوردی: بەرامبەری، بەقەدیەکی، یەکسانی، هاوپلەیی، لێکچوویی، وەکیەک‌بوون
"""),
          const DefinitionKurdish(
              text: """١. (ناو) یەکسانی لە ماف، پێگە، هتد"""),
          SentencesRow(
            englishText:
                """Don't you believe in equality between men and women?""",
            kurdishText: """باوەڕت بە یەکسانی نێوان ژن و پیاو نییە؟""",
          ...
          SentencesRow(
            ...
            kurdishText: """بۆ یەکسانی زیاتر لەنێوان ڕەگەزەکان دەجەنگان.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ژنان هێشتا یەکسانیی تەواویان لە کۆمپانیاکە نییە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """ویلایەتەکە نابێت کەس لە ناکۆکی بێ‌بەش بکات لە پێش یاسا.""",
          ...
          SentencesRow(
            englishText:
                """Is there a society in the world where women have true equality?""",
            kurdishText:
                """کۆمەڵگایەک هەیە لە جیهاندا کە تێیدا ژنان یەکسانی تەواویان هەبێت؟""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: equality (Derived forms: equalities)
1. The quality of being the same in quantity, measure, value or status
 
2. A state of being essentially equal or equivalent; equally balanced (= equivalence, equation, par)
 
3. (mathematics) fact or representation of being equal, of having the same value
""",
  );
...
const double _startSecondsend = 000000000000000000000000000000; // 1048;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/zZM57oTu9Ng?t=';
const double _startSecondsone = 00000000000000000000000000000; // 134;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/ea4Tq7HB7kU?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 125;
const String _videoIdthree = 'VIDEOhttps://youtu.be/b1reY72ktEc?t=';
const double _startSecondsthree = 000000000000000000000000000; // 921;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/hOUGNGWmN0k?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 194;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/kBdfcR-8hEY?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 991;
