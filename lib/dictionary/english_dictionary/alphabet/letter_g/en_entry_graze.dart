...
class EnglishEntrygraze extends StatefulWidget {
  const EnglishEntrygraze({super.key});

  @override
  State<EnglishEntrygraze> createState() => _EnglishEntrygrazeState();
}

class _EnglishEntrygrazeState extends State<EnglishEntrygraze> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: graze (Derived forms: grazed, grazes, grazing)
1. Feed as in a meadow or pasture (- crop, browse, range, pasture)
"the herd was grazing";
 
2. Break the skin (of a body part) by scraping
"She was grazed by the stray bullet"
 
3. Let feed in a field, pasture or meadow (- crop, pasture)
 
4. Scrape gently (- crease, rake)
"graze the skin";
 
5. Eat lightly, try different dishes (- browse)
"There was so much food at the party that we quickly got sated just by grazing";

- Noun: graze (Derived forms: grazes)
1. A superficial abrasion
 
2. Eating small snacks throughout the day rather than having meals (- grazing)
""",
  );

  final String keyword = "graze";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There were cows grazing beside the river.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The horses were grazing on the lush grass.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The land is used by local people to graze their animals.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I have this really bad habit of grazing on junk food.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I fell and grazed my knee.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He grazed his elbow on a sharp piece of rock.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The bullet grazed his cheek.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I've got a graze on my leg.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """graze""",
                      // alsoEnglishWord: "also: graze",
                      britshText: """IpaUK: /ɡreɪz/""",
                      americanText: """IpaUS: /ɡreɪz/""",
...
// With short examples define "graze", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ژمارەیەک مانگا لە کەناری ڕووبارەکە دەلەوەڕان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەسپەکان لەسەر گژووگیا پڕگەڵاکە دەلەوەڕان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زەوییەکە لەلایەن خەڵکە ناوخۆییەکەوە بەکاردێت بۆ لەوەڕاندنی ئاژەڵەکانیان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەم خووە خراپەم هەیە کە خواردنی خێرا دەخۆم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئانیشكی ڕووشا کە دای بە پارچە بەردێکی تیژدا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Adam walked away from the crash with just cuts and grazes.""",
                      kurdishText:
                          """ئادەم لە پێکدادانەکە دەرچوو تەنها بە برین و ڕووشاوی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I've got a graze on my leg.""",
                      kurdishText: """لاقم ڕووشاوی بەرکەوتووە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/hS2emKDlGmE?t=';
const double _startSecondsend = 0000000000000000000000000001294;
const String _videoIdone = 'https://youtu.be/K4jIAdAUjHc?t=';
const double _startSecondsone = 000000000000000000000000000276;
const String _videoIdtwo = 'https://youtu.be/PoNCG3PZKII?t=';
const double _startSecondstwo = 00000000000000000000000000070;
const String _videoIdthree = 'https://youtu.be/Q1bSDnuIPbo?t=';
const double _startSecondsthree = 000000000000000000000000000881;
const String _videoIdfour = 'https://youtu.be/4kEil-H7490?t=';
const double _startSecondsfour = 000000000000000000000000000579;
const String _videoIdfive = 'https://youtu.be/zwZY-PknSQw?t=';
const double _startSecondsfive = 0000000000000000000000000001981;
