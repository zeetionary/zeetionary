...
class EnglishEntryhomesickness extends StatefulWidget {
  const EnglishEntryhomesickness({super.key});

  @override
  State<EnglishEntryhomesickness> createState() =>
      _EnglishEntryhomesicknessState();
}

class _EnglishEntryhomesicknessState extends State<EnglishEntryhomesickness> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "homesickness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""homesickness""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She soon got over her homesickness.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/HxuHo62reRw?t=';
    const double startSecondsend = 000000000000000000000000000322;
    const String videoIdone = 'https://youtu.be/qSNKesrUC_8?t=';
    const double startSecondsone = 000000000000000000000000000931;
    const String videoIdtwo = 'https://youtu.be/0H5QZvOqlJM?t=';
    const double startSecondstwo = 000000000000000000000000000975;
    const String videoIdthree = 'https://youtu.be/7x8L87akI5s?t=';
    const double startSecondsthree = 000000000000000000000000000283;
    const String videoIdfour = 'https://youtu.be/TTgzD_limcs?t=';
    const double startSecondsfour = 000000000000000000000000000315;
    const String videoIdfive = 'https://youtu.be/qaqT1kNMqNg?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homesickness""",
                      // alsoEnglishWord: "also: homesickness",
                      britshText: """IpaUK: /ˈhəʊmsɪknəs/""",
                      americanText: """IpaUS: /ˈhəʊmsɪknəs/""",
...
// With short examples define "homesickness", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """She soon got over her homesickness.""",
                      kurdishText: """زوو زاڵ بوو بەسەر غەریبییەکەیدا.""",
