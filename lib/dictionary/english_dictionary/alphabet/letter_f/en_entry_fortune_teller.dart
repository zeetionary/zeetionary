...
class EnglishEntryfortuneteller extends StatefulWidget {
  const EnglishEntryfortuneteller({super.key});

  @override
  State<EnglishEntryfortuneteller> createState() =>
      _EnglishEntryfortunetellerState();
}

class _EnglishEntryfortunetellerState extends State<EnglishEntryfortuneteller> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fortune teller (Derived forms: fortunetellers, fortune tellers)
1. A person who foretells your personal future (= fortuneteller)
""",
  );

  final String keyword = "fortune teller";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fortune teller""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The fortune teller read his palm and made predictions.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fortune teller""",
                      // alsoEnglishWord: "also: fortune teller",
                      britshText: """IpaUK: /ˈfɔːtʃuːn telə(r)/""",
                      americanText: """IpaUS: /ˈfɔːrtʃən telər/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە بانگەشەی ئەوە دەکات هێزی سیحری هەبێت چارەنووس بزانێت"""),
                    SentencesRow(
                      englishText:
                          """The fortune teller read his palm and made predictions.""",
                      kurdishText:
                          """فاڵچییەکە ناولەپی خوێندەوە و زۆر پێشبینی کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/H5_HVUS1l0Y?t=';
const double _startSecondsend = 00000000000000000000000000088;
const String _videoIdone = 'https://youtu.be/Bj6ulLJGPB8?t=';
const double _startSecondsone = 0000000000000000000000000001078;
const String _videoIdtwo = 'https://youtu.be/KUd7nJJtM6M?t=';
const double _startSecondstwo = 000000000000000000000000000171;
const String _videoIdthree = 'https://youtu.be/IVLSZiEFVVo?t=';
const double _startSecondsthree = 00000000000000000000000000068;
const String _videoIdfour = 'https://youtu.be/Ufg8NWyW7rw?t=';
const double _startSecondsfour = 000000000000000000000000000111;
const String _videoIdfive = 'https://youtu.be/jENKT7mLuc4?t=';
