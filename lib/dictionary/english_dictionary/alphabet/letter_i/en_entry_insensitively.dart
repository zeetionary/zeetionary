...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'gpbgIbXNkfc';
    const double startSecondsend = 99;
    const String videoIdone = 'vlPhAFixBL4';
    const double startSecondsone = 2421;
    const String videoIdtwo = 'xNTBF2JTx7U';
    const double startSecondstwo = 569;
    const String videoIdthree = 'klKmNtafBY0';
    const double startSecondsthree = 120;
    const String videoIdfour = 'ZKxetTClQj0';
    const double startSecondsfour = 164;
    const String videoIdfive = 'XXm4xYcNSlA';
