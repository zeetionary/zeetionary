...
class EnglishEntrylimitation extends StatefulWidget {
  const EnglishEntrylimitation({super.key});

  @override
  State<EnglishEntrylimitation> createState() => _EnglishEntrylimitationState();
}

class _EnglishEntrylimitationState extends State<EnglishEntrylimitation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: limitation (Derived forms: limitations)
1. A principle that limits the extent of something (- restriction)
"I am willing to accept certain limitations on my movements";
 
2. The quality of being limited or restricted
"it is a good plan but it has serious limitations"
 
3. The greatest amount of something that is possible or allowed (- limit)
"it is growing rapidly with no limitation in sight";
 
4. (law) a time period after which suits cannot be brought
"statute of limitations"
 
5. An act of limiting or restricting (as by regulation) (- restriction)
""",
  );

  final String keyword = "limitation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""limitation""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/fbkfr-S420o?t=81';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/s6nEiC6A43E?t=2221';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/9q4z10gBQYw?t=28';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/WmYZ9-uc9Jw?t=3633';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/QfVKP_ibzsI?t=14';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/VIA2wUCj36Q?t=130';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """limitation""",
                      // alsoEnglishWord: "also: limitation",
                      britshText: """IpaUK: /ˌlɪmɪˈteɪʃn/""",
                      americanText: """IpaUS: /ˌlɪmɪˈteɪʃn/""",
