...
class EnglishEntryevangelist extends StatefulWidget {
  const EnglishEntryevangelist({super.key});

  @override
  State<EnglishEntryevangelist> createState() => _EnglishEntryevangelistState();
}

class _EnglishEntryevangelistState extends State<EnglishEntryevangelist> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""evangelist""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evangelist""",
                      // alsoEnglishWord: "also: evangelist",
                      britshText: """IpaUK: /ɪˈvændʒəlɪst/""",
                      americanText: """IpaUS: /ɪˈvændʒəlɪst/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "evangelist";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""In Texas she became involved with Christian evangelists.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I've always been an evangelist for new technology.""");
  }
...
// With short examples define "evangelist", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کەسێک کە بانگەشە بۆ ئایینی مەسیحی دەکات، بەتایبەتی بەوەی کە بە وڵاتێکدا گەشط دەکات و کۆبوونەوە دەکات یان لەسەر ڕادیۆ و تەلەفیزیۆن وتاری دەبێت"""),
          SentencesRow(
            englishText:
                """In Texas she became involved with Christian evangelists.""",
            kurdishText: """لە تێکساس تێکەڵ بە بانگەشەکارە مەسیحییەکان بوو.""",
          ...
          const DefinitionKurdish(
              text:
                  """٢. (ناو) یەکێک لە چوار نووسەرەکەی کتێبی گۆسپڵی ئینجیل"""),
          const DividerDefinition(),
          const DefinitionKurdish(
              text:
                  """٣. (ناو) کەسێک کە بە تامەزرۆیی هەوڵ دەدات خەڵکی ڕازی بکات باوەڕ بە شتێک بکەن، شتێک بە بەهاوە سەیر بکەن، هتد"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """I've always been an evangelist for new technology.""",
            kurdishText: """هەمیشە هەواداری تەکنەلۆژیای تازە بوومە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: evangelist (Derived forms: evangelists)
1. A preacher of the Christian gospel (= revivalist, gospeler [US], gospeller)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/T1qjjr2V-7g?t=';
const double _startSecondsend = 000000000000000000000000000000; // 600;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/M-JssjBJKMw?t=';
const double _startSecondsone = 00000000000000000000000000000; // 357;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/BbW-a7ZVGag?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 2588;
const String _videoIdthree = 'VIDEOhttps://youtu.be/Fi66wFfOC-4?t=';
const double _startSecondsthree = 000000000000000000000000000; // 393;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/1qbna6t1bzw?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 4487;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/UsPvDYO19ys?t=';
