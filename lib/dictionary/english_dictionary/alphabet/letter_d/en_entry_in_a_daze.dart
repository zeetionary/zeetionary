...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakinadaze(String languageCode) async {
    ...
    await flutterTts.speak("in a daze");
  }
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakinadazes1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("I've been in a complete daze since hearing the news.");
  }
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'yBlBesZnbvY';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'im4uhmbSNYQ';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '0tFuHyC4y6c';
