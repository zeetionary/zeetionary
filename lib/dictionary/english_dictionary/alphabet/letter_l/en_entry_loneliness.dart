...
class EnglishEntryloneliness extends StatefulWidget {
  const EnglishEntryloneliness({super.key});

  @override
  State<EnglishEntryloneliness> createState() => _EnglishEntrylonelinessState();
}

class _EnglishEntrylonelinessState extends State<EnglishEntryloneliness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: loneliness
1. The state of being alone in solitary isolation (- solitariness)
 
2. Sadness resulting from being forsaken or abandoned (- forlornness, desolation)
 
3. A disposition toward being alone (- aloneness, lonesomeness, solitariness)
""",
  );

  final String keyword = "loneliness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""loneliness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He went through a period of loneliness in his life.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He tried to escape the loneliness of all those evenings at home just watching TV.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/hUJpHUWKjiY?t=142';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/9GR3XSuInYE?t=281';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/q8HRGiUeZwc?t=119';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/R21IXVYnvHk?t=101';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/LFOUK8OCopM?t=121';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/uaaC57tcci0?t=116';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """loneliness""",
                      // alsoEnglishWord: "also: loneliness",
                      britshText: """IpaUK: /ˈləʊnlinəs/""",
                      americanText: """IpaUS: /ˈləʊnlinəs/""",
...
کوردی: تەنیایی، بە تەنێ‌بوون، بێ‌کەسی
"""),
                    const DefinitionKurdish(text: """١. (ناو) ئەوەی دڵخۆش نەبیت بەهۆی ئەوەی کەست نییە قسەی لەگەڵ بکەیت"""),
                    SentencesRow(
                      englishText: """He went through a period of loneliness in his life.""",
                      kurdishText: """بە ماوەیەک لە تەنهایی لە ژیانیدا تێپەڕی.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ئەوەی ماوەیەکی دیاریکراو دڵتەنگ بیت و بە تەنها بەسەری ببەیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He tried to escape the loneliness of all those evenings at home just watching TV.""",
                      kurdishText: """هەوڵی دا کۆتایی بهێنێت بە تەنهایی ئەو ئێوارانەی کە لە ماڵەوە سەیری تەلەفیزیۆنی دەکرد.""",
