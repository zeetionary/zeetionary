...
const String _videoIdone = '7c1FO8FT__U';
const double _startSecondsone = 191;
const String _videoIdtwo = 'hS2emKDlGmE';
const double _startSecondstwo = 1922;
const String _videoIdthree = 'vojsscI61Sk';
const double _startSecondsthree = 258;
const String _videoIdfour = 'dzRNswfny3A';
const double _startSecondsfour = 1389;
const String _videoIdfive = 'Fut0t204JvE';
const double _startSecondsfive = 276;
