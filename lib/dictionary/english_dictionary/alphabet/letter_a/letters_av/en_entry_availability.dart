...
class EnglishEntryavailability extends StatelessWidget {
  ...
  Future<void> speakAvailabilitys7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvailabilitys7c"); // DOPSUM: CHANGE TEXT
  }
                        ...
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /əˌveɪləˈbɪləti/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "https://youtu.be/08mwXICY4JM?t=";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "https://youtu.be/s7fplB1Ajxw?t=";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "https://youtu.be/UiSWqvF0M6o?t=";
