...
class EnglishEntrycompel extends StatelessWidget {
// blank divider
  EnglishEntrycompel({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcompel(String languageCode) async {
    // DOPSUM: CHANGE speakcompel
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "compel"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /kəmˈpel/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcompel("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /kəmˈpel/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcompel("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = '2-WISvX-SKI';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'SjTUAKjr_1w';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'EuarZ_DB6Zs';
