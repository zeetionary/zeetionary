...
class EnglishEntryintricacy extends StatefulWidget {
  const EnglishEntryintricacy({super.key});

  @override
  State<EnglishEntryintricacy> createState() => _EnglishEntryintricacyState();
}

class _EnglishEntryintricacyState extends State<EnglishEntryintricacy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: intricacy (Derived forms: intricacies)
1. Marked by elaborately complex detail (- elaborateness, elaboration, involution)
""",
  );

  final String keyword = "intricacy";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intricacy""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I’ve never mastered the intricacies of dancing.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """He grasped the intricacies of the financial system better than any of us.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The intricacy of the design made it hard to copy.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/0e8woEkKmG8?t=';
    const double startSecondsend = 0000000000000000000000000001290;
    const String videoIdone = 'https://youtu.be/brKw9KtNm04?t=';
    const double startSecondsone = 000000000000000000000000000542;
    const String videoIdtwo = 'https://youtu.be/KKlO3Bof7uw?t=';
    const double startSecondstwo = 000000000000000000000000000276;
    const String videoIdthree = 'https://youtu.be/OnjI-FBdRTQ?t=';
    const double startSecondsthree = 0000000000000000000000000003314;
    const String videoIdfour = 'https://youtu.be/ZZ3F3zWiEmc?t=';
    const double startSecondsfour = 000000000000000000000000000614;
    const String videoIdfive = 'https://youtu.be/bK4AWtTV3h4?t=';
    const double startSecondsfive = 000000000000000000000000000267;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """intricacy""",
                      // alsoEnglishWord: "also: intricacy",
                      britshText: """IpaUK: /ˈɪntrɪkəsi/""",
                      americanText: """IpaUS: /ˈɪntrɪkəsi/""",
...
کوردی: 
"""),
// With short examples define "intricacy", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بەش و وردەکارییە ئاڵۆزییەکانی شتێک"""),
                    SentencesRow(
                      englishText:
                          """I’ve never mastered the intricacies of dancing.""",
                      kurdishText:
                          """هەرگیز فێری ئاڵۆزییەکانی سەماکردن نەبوومە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He grasped the intricacies of the financial system better than any of us.""",
                      kurdishText:
                          """تێگەشتنی بۆ ئاڵۆزییەکانی سیستەمی دارایی هەبوو زیاتر لە هەر یەکێکمان.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ئەوەی کە بەش، وردەکاری، یان شێوەی ئاڵۆزی هەبێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The intricacy of the design made it hard to copy.""",
                      kurdishText:
                          """ئاڵۆزیی دیزاینەکە وایکرد سەخت بێت کۆپی بکرێت.""",
