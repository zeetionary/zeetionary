...
class EnglishEntrylistlessly extends StatefulWidget {
  const EnglishEntrylistlessly({super.key});

  @override
  State<EnglishEntrylistlessly> createState() => _EnglishEntrylistlesslyState();
}

class _EnglishEntrylistlesslyState extends State<EnglishEntrylistlessly> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "listlessly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""listlessly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He sat listlessly in the chair.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/9QRg2YEkVLU?t=8543';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/wu95JPidByY?t=474';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/ZQAGfqHALWk?t=5225';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/L1my0d5iKMw?t=175';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/APDqaM8CNJ8?t=2074';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/Eafg9LdOxFk?t=898';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """listlessly""",
                      // alsoEnglishWord: "also: listlessly",
                      britshText: """IpaUK: /ˈlɪstləsli/""",
                      americanText: """IpaUS: /ˈlɪstləsli/""",
...
کوردی: وەڕەزانە، بە شێوەیێکی داهێزراو، داهێزراواوانە
"""),
// With short examples define "listlessly", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵکار) بە شێوەیەک کە بەبێ هیچ وزە و توانایەک بیت بۆ کردنی شتێک"""),
                    SentencesRow(
                      englishText: """He sat listlessly in the chair.""",
                      kurdishText: """وەڕەزانە لە کورسییەکەدا دانیشت.""",
