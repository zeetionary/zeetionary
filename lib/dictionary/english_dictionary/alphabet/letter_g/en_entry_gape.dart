...
class EnglishEntrygape extends StatefulWidget {
  const EnglishEntrygape({super.key});

  @override
  State<EnglishEntrygape> createState() => _EnglishEntrygapeState();
}

class _EnglishEntrygapeState extends State<EnglishEntrygape> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Isabel gaped at him, horrified.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""What are you gaping at?""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The empty cash box lay gaping open in one corner.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gape""",
                      // alsoEnglishWord: "also: gape",
                      britshText: """IpaUK: /ɡeɪp/""",
                      americanText: """IpaUS: /ɡeɪp/""",
...
// With short examples define "gape", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """She climbed into her sports car to the gapes of passers-by.""",
                      kurdishText:
                          """چووە ناو ئۆتۆمبێلە وەرزشییەکەی بە جێگای سەرسامیی ڕێبواران.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """What are you gaping at?""",
                      kurdishText: """لە چی چاو زاق دەکەیتەوە؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """سندووقە بەتاڵەکەی پارەکە بە کراوەیی لە سووچێک کەوتبوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Js2UoMSumx4?t=';
const double _startSecondsend = 000000000000000000000000000219;
const String _videoIdone = 'https://youtu.be/g2nXwiNl9tg?t=';
const double _startSecondsone = 00000000000000000000000000052;
const String _videoIdtwo = 'https://youtu.be/hCrJTLdmkHo?t=';
const double _startSecondstwo = 0000000000000000000000000001556;
const String _videoIdthree = 'https://youtu.be/Og_XYDDyguc?t=';
const double _startSecondsthree = 000000000000000000000000000201;
const String _videoIdfour = 'https://youtu.be/nBYhHDpkUgM?t=';
const double _startSecondsfour = 000000000000000000000000000974;
const String _videoIdfive = 'https://youtu.be/S-eGN7jHADY?t=';
const double _startSecondsfive = 000000000000000000000000000972;
