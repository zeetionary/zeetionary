...
class EnglishEntryinternally extends StatefulWidget {
  const EnglishEntryinternally({super.key});

  @override
  State<EnglishEntryinternally> createState() => _EnglishEntryinternallyState();
}

class _EnglishEntryinternallyState extends State<EnglishEntryinternally> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "internally";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""internally""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The library now looks much better both externally and internally.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He was bleeding internally.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Internally, I was laughing.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The new posts were only advertised internally.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""You still need photo ID even if you're flying internally.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/q8HRGiUeZwc?t=';
    const double startSecondsend = 00000000000000000000000000043;
    const String videoIdone = 'https://youtu.be/9yjZpBq1XBE?t=';
    const double startSecondsone = 0000000000000000000000000002176;
    const String videoIdtwo = 'https://youtu.be/SwQhKFMxmDY?t=';
    const double startSecondstwo = 0000000000000000000000000003960;
    const String videoIdthree = 'https://youtu.be/hUBsxCcJeUc?t=';
    const double startSecondsthree = 00000000000000000000000000048;
    const String videoIdfour = 'https://youtu.be/djU7rduvo6s?t=';
    const double startSecondsfour = 000000000000000000000000000178;
    const String videoIdfive = 'https://youtu.be/vstnLLViSgM?t=';
    const double startSecondsfive = 0000000000000000000000000001001;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """internally""",
                      // alsoEnglishWord: "also: internally",
                      britshText: """IpaUK: /ɪnˈtɜːnəli/""",
                      americanText: """IpaUS: /ɪnˈtɜːrnəli/""",
...
کوردی: 
"""),
// With short examples define "internally", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) لە بەشی ناوەوەی شتێک"""),
                    SentencesRow(
                      englishText:
                          """The library now looks much better both externally and internally.""",
                      kurdishText:
                          """کتێبخانەکە ئێستا چی لە دەرەوە و ناوەوە باشتر دەردەکەوێت.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵکار) لە ناوەوەی جەستە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He was bleeding internally.""",
                      kurdishText: """لە ناوەوە خوێنبەربوونی هەبوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵکار) بەشێوەیەک کە پەیوەندیدارە بە هزری مرۆڤ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Internally, I was laughing.""",
                      kurdishText: """لە مێشکمدا، پێدەکەنیم.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ھاوەڵکار) بەشێوەیەک کە تەنها ئەو کەسانە لەخۆ دەگرێت کە بەشێکن لە دامەزراوەیەک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The new posts were only advertised internally.""",
                      kurdishText:
                          """پێگە تازەکان تەنها لە ناوخۆ بانگەشەیان بۆ کرا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٥. (ھاوەڵکار) بەشێوەیەک کە پەیوەندیدارە بە ناوخۆی وڵاتێک"""),
                    const AlsoEnglishckb(word: "ھەروەھا: domestically"),
                    SentencesRow(
                      englishText:
                          """You still need photo ID even if you're flying internally.""",
                      kurdishText:
                          """هێشتا پێویستیت بە ناسنامەی وێنەیی هەیە تەنانەت ئەگەر لە ناوخۆش گەشتی ئاسمانی بکەیت.""",
