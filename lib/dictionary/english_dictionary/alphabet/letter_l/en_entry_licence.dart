...
class EnglishEntrylicence extends StatefulWidget {
  const EnglishEntrylicence({super.key});

  @override
  State<EnglishEntrylicence> createState() => _EnglishEntrylicenceState();
}

class _EnglishEntrylicenceState extends State<EnglishEntrylicence> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: licence (Derived forms: licences)
Usage: Brit, Cdn (US: license)
1. (law) a legal document giving official permission to do something (- license [N. Amer], permit)
 
2. Freedom to deviate deliberately from normally applicable rules or practices (especially in behaviour or speech) (- license [N. Amer])
 
3. Excessive freedom; lack of due restraint (- license [N. Amer])
...
4. The act of giving a formal (usually written) authorization (- license [N. Amer], permission, permit)

- Verb: licence (Derived forms: licencing, licences, licenced)
Usage: Brit, Cdn (US: license)
1. Authorize officially (- license, certify)
"I am licenced to practice law in this state";
""",
  );

  final String keyword = "licence";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""licence""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The driver did not hold a valid licence.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""James lost his licence for six months.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her licence was revoked by the court.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""You need a licence to fish in this river.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Lack of punishment seems to give youngsters licence to break the law.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The new drug has not yet been licensed in the US.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The company plans to license the technology to others.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/i7ZE8eK6lTQ?t=359';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/UqbTLJ0U84M?t=1';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/uBstq-_zaYk?t=101';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/xkNNB9f_3Mc?t=33';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/bHlkVDqpCRg?t=1048';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/DgAoy7XaFgk?t=142';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """licence""",
                      alsoEnglishWord: "American: license",
                      britshText: """IpaUK: /ˈlaɪsns/""",
                      americanText: """IpaUS: /ˈlaɪsns/""",
...
کوردی: 
"""),
// With short examples define "licence", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) بەڵگەنامەیەکی فەرمی کە ئەوە پیشان دەدات مۆڵەت دراوە بە کردن، هەبوون، یان بەکارهێنانی شتێک"""),
                    SentencesRow(
                      englishText: """The driver did not hold a valid licence.""",
                      kurdishText: """شۆفێرەکە مۆڵەتێکی پەسەندکراوی نەبوو.""",
                    ...
                    SentencesRow(
                      englishText: """James lost his licence for six months.""",
                      kurdishText: """جەیمس بۆ شەش مانگ مۆڵەتی شۆفێریی لەدەست دا.""",
                      englishNote: """He had his licence taken away by the police as a punishment""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her licence was revoked by the court.""",
                      kurdishText: """مۆڵەتەکەی لەلایەن دادگاوە هەڵوەشێندرایەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """You need a licence to fish in this river.""",
                      kurdishText: """پێویستیت بە مۆڵەتە بۆ ڕاوەماسی لەم ڕووبارە.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ئازادیی ئەوەی کە ئەوە بکەیت کە دەتەوێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Lack of punishment seems to give youngsters licence to break the law.""",
                      kurdishText: """کەمی سزا وەها دیارە کە ئازادیی داوە بە گەنجان کە یاسا بشکێنن.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) پێدانی مۆڵەت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The new drug has not yet been licensed in the US.""",
                      kurdishText: """دەرمانە تازەکە هێشتا مۆڵەتی وەرنەگرتووە لە ئەمریکا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The company plans to license the technology to others.""",
                      kurdishText: """کۆمپانیاکە پلانی هەیە مۆڵەتی تەکنەلۆژیاکە بدات بە ئەوانی دیکە.""",
