...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'DKsE6NfVvBg';
    const double startSecondsend = 227;
    const String videoIdone = 'CupbRr2m_sM';
    const double startSecondsone = 558;
    const String videoIdtwo = '-p9Us1_VDMM';
    const double startSecondstwo = 30;
    const String videoIdthree = '-kyz3UpQGYY';
    const double startSecondsthree = 0;
    const String videoIdfour = 'YGZfy964JBs';
    const double startSecondsfour = 160;
    const String videoIdfive = 'DJgGpnLVnfU';
