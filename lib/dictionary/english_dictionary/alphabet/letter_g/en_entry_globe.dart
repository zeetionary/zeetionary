...
class EnglishEntryglobe extends StatefulWidget {
  const EnglishEntryglobe({super.key});

  @override
  State<EnglishEntryglobe> createState() => _EnglishEntryglobeState();
}

class _EnglishEntryglobeState extends State<EnglishEntryglobe> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The news soon spread across the globe.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""A dusty old globe stood in the corner of the schoolroom.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Find Laos on the globe.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """globe""",
                      // alsoEnglishWord: "also: globe",
                      britshText: """IpaUK: /ɡləʊb/""",
                      americanText: """IpaUS: /ɡləʊb/""",
...
کوردی: زەوی، گۆی زەوی،	جیهان، جەهان،	گۆ یان تۆپی جوگرافیایی،	گۆ،	شووشەی خڕ بۆ ڕاگرتنی ماسی،	(توێکاری) گۆی چاو
"""),
// With short examples define "globe", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) جیهان"""),
                    SentencesRow(
                      englishText:
                          """Athletes from every corner of the globe competed in the Games.""",
                      kurdishText:
                          """وەرزشوانان لە هەموو سووچێکی جیهانەوە بەژدار بوو لە کێبڕکێیەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """She travelled the globe in search of good writers of children's stories.""",
                      kurdishText:
                          """بە جیهاندا گەشتی کرد بۆ گەڕان بە دوای نووسەری باشی چیرۆکی منداڵان.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The news soon spread across the globe.""",
                      kurdishText: """هەواڵەکە زوو بە جیهاندا بڵاوبوویەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) نەخشەیەکی جیهان کە وەک تۆپێک وایە """),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """A dusty old globe stood in the corner of the schoolroom.""",
                      kurdishText:
                          """نەخشەیەکی گۆیی کۆنی تۆزگرتوو لە سووچێکی پۆلەکە دانرابوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Find Laos on the globe.""",
                      kurdishText: """لاوس لەسەر نەخشە گۆییەکە بدۆزەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/0POHnKF2pH4?t=';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/0POHnKF2pH4?t=';
const double _startSecondsone = 0000000000000000000000000002;
const String _videoIdtwo = 'https://youtu.be/hOUGNGWmN0k?t=';
const double _startSecondstwo = 000000000000000000000000000764;
const String _videoIdthree = 'https://youtu.be/x__65wKXBvA?t=';
const double _startSecondsthree = 0000000000000000000000000008;
const String _videoIdfour = 'https://youtu.be/Oij-BdIkPgQ?t=';
