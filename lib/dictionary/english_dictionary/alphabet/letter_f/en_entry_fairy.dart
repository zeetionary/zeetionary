...
class EnglishEntryfairy extends StatefulWidget {
  const EnglishEntryfairy({super.key});

  @override
  State<EnglishEntryfairy> createState() => _EnglishEntryfairyState();
}

class _EnglishEntryfairyState extends State<EnglishEntryfairy> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fairy""",
                      // alsoEnglishWord: "also: fairy",
                      britshText: """IpaUK: /ˈfeəri/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Do you believe in fairies?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She used to think there were fairies at the bottom of her garden.""");
  }
...
کوردی: 
"""),
          const DefinitionKurdish(text: """١. (ناو) گیانەلەبەرێک کە وەک مرۆڤی بچووک وایە و دەسەڵاتی موعجیزەئاسای هەیە"""),
          SentencesRow(
            englishText:
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """She used to think there were fairies at the bottom of her garden.""",
          ...
          CustomRichText(
            ...
            textAfterLink: "",
            onTap: () {
              Routemaster.of(context).push("/english-fairy/faggot");
            },
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """ژممارە. (ھاوەڵناو) پێنناسە"""),
...
const double _startSecondsone = 000000000000000000000000000810;
const String _videoIdtwo = 'https://youtu.be/wir7jmefyec?t=';
const double _startSecondstwo = 000000000000000000000000000404;
...
const String _videoIdfive = 'https://youtu.be/vJqEYwrcLBs?t=';
