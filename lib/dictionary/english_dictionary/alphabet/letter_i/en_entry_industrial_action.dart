...
class EnglishEntryindustrialaction extends StatefulWidget {
  ...
  @override
  State<EnglishEntryindustrialaction> createState() => _EnglishEntryindustrialactionState();
}

class _EnglishEntryindustrialactionState extends State<EnglishEntryindustrialaction> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryindustrialaction industrial action
WORD_WEB industrial action industrial action industrial action
haʊʊʊʊʊʊʊ4
""",
  );
