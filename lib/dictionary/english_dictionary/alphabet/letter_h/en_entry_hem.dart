...
class EnglishEntryhem extends StatefulWidget {
  const EnglishEntryhem({super.key});

  @override
  State<EnglishEntryhem> createState() => _EnglishEntryhemState();
}

class _EnglishEntryhemState extends State<EnglishEntryhem> {
  @override
  void initState() {
    super.initState();
...
2. The utterance of a sound similar to clearing the throat; intended to get attention, express hesitancy, fill a pause, hide embarrassment, warn a friend, etc. (- ahem)

- Verb: hem (Derived forms: hemmed, hemming, hems)
...
- Interjection: hem
1. Gentle utterance used to call someone's attention (- ahem, hmm, h'm)
""",
  );

  final String keyword = "hem";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I took the hem up/let the hem down.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I need to hem those curtains.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hem""",
                      // alsoEnglishWord: "also: hem",
                      britshText: """IpaUK: /hem/""",
                      americanText: """IpaUS: /hem/""",
...
کوردی: پەراوێز، زێوار، لێوار، داوێن، دامێن، قەراخ، کەنارە، هەڵپێچ، بنتیک
"""),
// With short examples define "hem", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) قەراغی پارچە جلێک کە چەمێندراوەتەوە و دووراوەتەوە"""),
                    SentencesRow(
                      englishText: """I took the hem up/let the hem down.""",
                      kurdishText: """داوێنی جلەکەم درێژکردەوە/کورتکردەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) چەماندنەوەی لێواری جلێک و دوورینەوەی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I need to hem those curtains.""",
                      kurdishText: """دەبێت لێواری ئەو پەردانە بدوورمەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/uHEkwltmCL0?t=';
const double _startSecondsend = 00000000000000000000000000040;
const String _videoIdone = 'https://youtu.be/UgBMzeIqM18';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/5VzcBpESsRM';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/hIitimk594A?t=';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/uWz-wD7Ql8g';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/wGqQQMQl33o';
