...
class EnglishEntryhelpfulness extends StatefulWidget {
  const EnglishEntryhelpfulness({super.key});

  @override
  State<EnglishEntryhelpfulness> createState() =>
      _EnglishEntryhelpfulnessState();
}

class _EnglishEntryhelpfulnessState extends State<EnglishEntryhelpfulness> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "helpfulness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""helpfulness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """I should emphasize the helpfulness of sharing problems and asking difficult questions.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """helpfulness""",
                      // alsoEnglishWord: "also: helpfulness",
                      britshText: """IpaUK: /ˈhelpflnəs/""",
                      americanText: """IpaUS: /ˈhelpflnəs/""",
...
کوردی: کاریگەری، بەسوودی، بەکارهاتوویی، دڵسۆزی، کۆمەک
"""),
// With short examples define "helpfulness", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە شتێک دۆخێکی دیاریکراو باش بکات و بەسوود بێت بۆی"""),
                    const AlsoEnglishckb(word: "ھەروەھا: usefulness"),
                    SentencesRow(
                      englishText:
                          """I should emphasize the helpfulness of sharing problems and asking difficult questions.""",
                      kurdishText:
                          """دەبێت جەخت بکەمەوە لە سوودی باسکردنی کێشە و پرسینی پرسیارە سەختەکان.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ئەوەی کە پیشانی بدەیت ئامادەی یارمەتیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """We were very impressed with the friendliness and helpfulness of the locals.""",
                      kurdishText:
                          """زۆر سەرسام بووین بە دۆستایەتی و یارمەتیدۆستی خەڵکە خۆجێییەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/9UHIWVtAdhY?t=';
const double _startSecondsend = 00000000000000000000000000079;
const String _videoIdone = 'https://youtu.be/o76fNafY2Zg?t=';
const double _startSecondsone = 000000000000000000000000000100;
const String _videoIdtwo = 'https://youtu.be/xH-oQiOKukE?t=';
const double _startSecondstwo = 000000000000000000000000000496;
const String _videoIdthree = 'https://youtu.be/-SL9KRvzVmo?t=';
const double _startSecondsthree = 000000000000000000000000000483;
const String _videoIdfour = 'https://youtu.be/xYZnyhOc4Rw?t=';
const double _startSecondsfour = 000000000000000000000000000581;
const String _videoIdfive = 'https://youtu.be/EsoQGTA1SxY?t=';
const double _startSecondsfive = 0000000000000000000000000002039;
