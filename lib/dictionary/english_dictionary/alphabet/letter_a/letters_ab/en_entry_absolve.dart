...
class EnglishEntryabsolve extends StatefulWidget {
  const EnglishEntryabsolve({super.key});

  @override
  State<EnglishEntryabsolve> createState() => _EnglishEntryabsolveState();
}

class _EnglishEntryabsolveState extends State<EnglishEntryabsolve> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """absolve""",
                      // alsoEnglishWord: "also: absolve",
                      britshText: """IpaUK: /əbˈzɒlv/""",
                      americanText: """IpaUS: /əbˈzɑːlv/""",
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'QMiOMNIRs3k';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'c0xkUFe21Rk';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'Tprvv8OwRgA';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = '_qHqox5GbeM';
