...
class EnglishEntryhectare extends StatefulWidget {
  const EnglishEntryhectare({super.key});

  @override
  State<EnglishEntryhectare> createState() => _EnglishEntryhectareState();
}

class _EnglishEntryhectareState extends State<EnglishEntryhectare> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hectare""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hectare""",
                      // alsoEnglishWord: "also: hectare",
                      britshText: """IpaUK: /ˈhekteə(r)/,  /ˈhektɑː(r)/""",
                      americanText: """IpaUS: /ˈhekter/""",
...
کوردی: 
"""),
// With short examples define "hectare", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) یەکەیەکی پێوانی زەوی کە نزیکەی ١٠٠٠٠ مەتر چوارگۆشەیە"""),
                    SentencesRow(
                      englishText:
                          """Over the last decade, fires have claimed nearly one million hectares of forest land in Portugal.""",
                      kurdishText:
                          """لە ماوەی دە ساڵی ڕابردوودا ئاگر بووە بە هۆکاری سووتانی نزیکەی یەک ملیۆن هێکتار زەویی دارستان لە پرتوگال.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/XFeItKoT0Fw?t=';
const double _startSecondsend = 00000000000000000000000000037;
const String _videoIdone = 'https://youtu.be/JGVBv7svKLo?t=';
const double _startSecondsone = 000000000000000000000000000420;
const String _videoIdtwo = 'https://youtu.be/OPta1DBLD90?t=';
const double _startSecondstwo = 00000000000000000000000000077;
const String _videoIdthree = 'https://youtu.be/1xcqXBGv5DM?t=';
const double _startSecondsthree = 000000000000000000000000000164;
const String _videoIdfour = 'https://youtu.be/pnrAxfzHElo?t=';
const double _startSecondsfour = 000000000000000000000000000545;
const String _videoIdfive = 'https://youtu.be/E6GoyeTBEFs?t=';
