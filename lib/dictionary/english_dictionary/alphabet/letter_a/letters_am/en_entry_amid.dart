...
// replace these: replace EnglishEntryamid - replace speakAmid - replace amid - /əˈmɪd/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryamid extends StatelessWidget {
  EnglishEntryamid({super.key});
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAmid(String languageCode) async {
    // DOPSUM: CHANGE speakAmid
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("amid"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAmid77744(String languageCode) async {
    ...
    await flutterTts.speak(
        "He finished his speech amid tremendous applause."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAmid7741(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "On the floor, amid mounds of books, were two small envelopes."); // DOPSUM: CHANGE TEXT
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "amid"), // Find /əˈmɪd/
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /əˈmɪd/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                            CustomIconButtonBritish(
                              onPressed: () => speakAmid("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /əˈmɪd/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                            CustomIconButtonAmerican(
                              onPressed: () => speakAmid("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'JmtUqciXyzw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'fET0WTxfRFI';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'wStmZQkbKbA';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'oa4V1riEfUs';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'H2QdceCNOxc';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'q9kceBpFfgU';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = '3-p6G3f3LvY';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'jfyk0rh6uro';
