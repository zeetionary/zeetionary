...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """It is fitting that the new centre for European studies should be in a university that teaches every European language.""",
                      kurdishText:
                          """گونجاوە کە سەنتەری تازە بۆ لێکۆڵینەوە لە ئەورووپا پێویستە لە زانکۆیەک بێت کە ھەموو زمانێکی ئەورووپا دەڵێتەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ژوورەکە ھێشتا کەلوپەلە جێگیر و ناجێگیرەکانی خۆی ھەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I'm having the final fitting of my wedding dress on Thursday.""",
                      kurdishText:
                          """ڕۆژی پێنجشەممە کۆتا تاقیکردنەوەی جلی ھاوسەرگیرییەکەم دەکەم.""",
...
const String _videoIdtwo = 'yjhibJ-OqxE';
const double _startSecondstwo = 366;
const String _videoIdthree = 'raSeaAeryWE';
const double _startSecondsthree = 413;
const String _videoIdfour = 'Bk0G1f4DpCM';
const double _startSecondsfour = 21;
const String _videoIdfive = '0zXfDafyyao';
const double _startSecondsfive = 1223;
