...
class EnglishEntryfetish extends StatefulWidget {
  const EnglishEntryfetish({super.key});

  @override
  State<EnglishEntryfetish> createState() => _EnglishEntryfetishState();
}

class _EnglishEntryfetishState extends State<EnglishEntryfetish> {
  @override
  void initState() {
    super.initState();
...
2. A charm superstitiously believed to embody magical powers (= juju, voodoo, hoodoo, fetich)
 
3. Excessive or irrational devotion to some activity (= fetich)
"made a fetish of cleanliness";
""",
  );

  final String keyword = "fetish";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She has a fetish about cleanliness.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He has a fetish for high heels.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It is possible to develop a fetish about almost anything.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fetish""",
                      // alsoEnglishWord: "also: fetish",
                      britshText: """IpaUK: /ˈfetɪʃ/""",
                      americanText: """IpaUS: /ˈfetɪʃ/""",
...
const String _videoIdend = 'https://youtu.be/GqWvv0aKeK4?t=';
...
const String _videoIdtwo = 'https://youtu.be/AwodL8z2EtE?t=';
const double _startSecondstwo = 0000000000000000000000000002505;
const String _videoIdthree = 'https://youtu.be/8PJGIEz5YJ4?t=';
const double _startSecondsthree = 000000000000000000000000000869;
const String _videoIdfour = 'https://youtu.be/ZFRnQ-Ti6Is?t=';
const double _startSecondsfour = 000000000000000000000000000600;
const String _videoIdfive = 'https://youtu.be/lknCE7fn7k8?t=';
