...
class EnglishEntryclever extends StatelessWidget {
  ...
  Future<void> speakclever(String languageCode) async {
    ...
    await flutterTts.speak("clever"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclevers1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Clever girl!"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclevers2(String languageCode) async {
    ...
    await flutterTts.speak(
        "They're not clever enough to find the code."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclevers3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "Judy has never been very clever, but she tries hard."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclevers4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("Fiona is very clever at physics."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclevers5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("He's always been clever at chess."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclevers6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "She's clever at getting what she wants."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclevers7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("What a clever idea!"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclevers8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "Admitting her mistake may have been quite a clever move on her part."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclevers9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "It was clever of him to have spotted the mistake."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclevers10(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("That wasn't a very clever thing to do."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclevers11(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("Don't you get clever with me!"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakclevers12(String languageCode) async {
    // DOPSUM: CHANGE speakclever
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclevers1200"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakclevers13(String languageCode) async {
    // DOPSUM: CHANGE speakclever
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclevers1300"); // DOPSUM: CHANGE TEXT
  }
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        children: [
                                          CustomIconButtonBritish(
                                            onPressed: () =>
                                                speakclevers10("en-GB"),
                                          ),
                                          CustomIconButtonAmerican(
                                            onPressed: () =>
                                                speakclevers10("en-US"),
                                          ),
                                        ],
                                      ),
                                    ],
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/xEKY7lZStE4?t=',
    startSeconds: 50,
    autoPlay: true,
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/wT6dbcXEyXM?t=',
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/SGUZd5YtObw?t=',
    startSeconds: 7,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/mfZ39ReYuRE?t=',
    startSeconds: 119,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/Twb47ynU4lw?t=',
    startSeconds: 245,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final _controller = YoutubePlayerController.fromVideoId(
    videoId: 'https://youtu.be/zN6esFH8Bes?t=',
    startSeconds: 104,
    autoPlay: true,
    params: const YoutubePlayerParams(
      enableCaption: true,
