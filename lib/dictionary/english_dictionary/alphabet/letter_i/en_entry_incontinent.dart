...
class EnglishEntryincontinent extends StatefulWidget {
  const EnglishEntryincontinent({super.key});

  @override
  State<EnglishEntryincontinent> createState() => _EnglishEntryincontinentState();
}

class _EnglishEntryincontinentState extends State<EnglishEntryincontinent> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incontinent""");
  }
