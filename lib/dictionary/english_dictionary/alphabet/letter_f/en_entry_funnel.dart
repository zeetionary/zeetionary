...
class EnglishEntryfunnel extends StatefulWidget {
  const EnglishEntryfunnel({super.key});

  @override
  State<EnglishEntryfunnel> createState() => _EnglishEntryfunnelState();
}

class _EnglishEntryfunnelState extends State<EnglishEntryfunnel> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: funnel (Derived forms: funnels)
1. A conical shape with a wider and a narrower opening at the two ends (= - funnel shape)
...
Verb: funnel (Derived forms: funnels, funnelled, funnelling, funneling, funneled)
...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He saw smoke rising from the factory's funnel.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Huge pipes funnel the water down the mountainside.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Barricades funnelled the crowds towards the square.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """funnel""",
                      // alsoEnglishWord: "also: funnel",
                      britshText: """IpaUK: /ˈfʌnl/""",
                      americanText: """IpaUS: /ˈfʌnl/""",
...
کوردی: ڕەحەتی، سەرتلیک، ماستیرگ، بەتو، کۆڤک
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئامرازێک کە لە سەرەوە فراوانە و  لە خوارەوە تەسکە و بەکاردێت بۆ ڕژاندنی شلە یان هاڕاوە بۆ ناو دەرچەیەکی بچووک"""),
                    SentencesRow(
                      englishText:
                          """After you grind the coffee, use a funnel to pour it into the jar.""",
                      kurdishText:
                          """لە دوای ئەوەی قاوەکە دەهاریت، ڕەحەتییەک بەکاربهێنە بۆ ئەوەی بیڕژێنیتە دۆڵکەیەکەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دووکەڵی دەبینی لە دووکەڵکێشی کارگەکەوە دەردەهات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بۆری گەورە ئاو بە لای شاخەکەدا دەگوازنەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Wind was funnelling through the gorge.""",
                      kurdishText: """با بە تەنگەڵانەکەدا دەرچوو.""",
...
const String _videoIdone = 'https://youtu.be/58XEfDtU0Z4?t=';
const double _startSecondsone = 000000000000000000000000000136;
const String _videoIdtwo = 'https://youtu.be/idWpZ63isMo?t=';
const double _startSecondstwo = 000000000000000000000000000203;
const String _videoIdthree = 'https://youtu.be/JmWfY4nb6oM?t=';
const double _startSecondsthree = 000000000000000000000000000400;
const String _videoIdfour = 'https://youtu.be/-BeTq99LqUo?t=';
const double _startSecondsfour = 00000000000000000000000000072;
const String _videoIdfive = 'https://youtu.be/Q-nWA0WeF98?t=';
const double _startSecondsfive = 0000000000000000000000000001907;
