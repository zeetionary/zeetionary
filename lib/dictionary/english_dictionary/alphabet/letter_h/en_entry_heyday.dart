...
class EnglishEntryheyday extends StatefulWidget {
  const EnglishEntryheyday({super.key});

  @override
  State<EnglishEntryheyday> createState() => _EnglishEntryheydayState();
}

class _EnglishEntryheydayState extends State<EnglishEntryheyday> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heyday (Derived forms: heydays)
1. The period of greatest prosperity or productivity (- flower, prime, peak, bloom, blossom, efflorescence, flush)
""",
  );

  final String keyword = "heyday";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heyday""",
                      // alsoEnglishWord: "also: heyday",
                      britshText: """IpaUK: /ˈheɪdeɪ/""",
                      americanText: """IpaUS: /ˈheɪdeɪ/""",
...
کوردی: هەڕەت، تاف، جەنگە، لووتکە، پۆپە، ترۆپک
"""),
// With short examples define "heyday", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کاتێک کە کەسێک/شتێک لە ئەوپەڕی سەرکەوتن، هێز، یان ناوبانگە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: prime"),
                    SentencesRow(
                      englishText:
                          """In its heyday, the company ran trains every fifteen minutes.""",
                      kurdishText:
                          """لە لووتکەیدا، کۆمپانیاکە هەر پازدە خولەک جارێک شەمەندەفەرێکی بەڕێدەخست.""",
...
const double _startSecondsend = 0000000000000000000000000002769;
const String _videoIdone = 'https://youtu.be/lwP9H9qTuUY?t=';
const double _startSecondsone = 00000000000000000000000000016;
const String _videoIdtwo = 'https://youtu.be/c0pS3Zx7Fc8?t=';
const double _startSecondstwo = 000000000000000000000000000495;
const String _videoIdthree = 'https://youtu.be/Fkeltn6xVHs?t=';
const double _startSecondsthree = 000000000000000000000000000362;
const String _videoIdfour = 'https://youtu.be/qw-FLc7Z01Q?t=';
const double _startSecondsfour = 000000000000000000000000000488;
const String _videoIdfive = 'https://youtu.be/hAQJ9bNENyA?t=';
