...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/6wm-NtMkqz8?t=';
const double _startSecondsend = 000000000000000000000000000000; // 60;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/_2ThNd8DBEI?t=';
const double _startSecondsone = 00000000000000000000000000000; // 71;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/4o3NVOQp4jo?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 415;
const String _videoIdthree = 'VIDEOhttps://youtu.be/mqxgP8WlxJQ?t=';
const double _startSecondsthree = 000000000000000000000000000; // 473;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/DxREm3s1scA?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 3441;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/3NVpz6FgwOU?t=';
