...
class EnglishEntryglance extends StatefulWidget {
  const EnglishEntryglance({super.key});

  @override
  State<EnglishEntryglance> createState() => _EnglishEntryglanceState();
}

class _EnglishEntryglanceState extends State<EnglishEntryglance> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She glanced at her watch.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He glanced around the room.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I glanced up quickly to see who had come in.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He turned to glance in our direction.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I only had time to glance at my emails.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He glanced briefly down the list of names.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I just took a quick glance at the company's website.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She cast a glance at the kitchen clock.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glance""",
                      // alsoEnglishWord: "also: glance",
                      britshText: """IpaUK: /ɡlɑːns/""",
                      americanText: """IpaUS: /ɡlæns/""",
...
// With short examples define "glance", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """She glanced at her watch.""",
                      kurdishText: """چاوێکی لە کاتژمێرەکەی کرد.""",
                    ...
                    SentencesRow(
                      englishText: """He glanced around the room.""",
                      kurdishText: """چاوێکی بە ژوورەکەدا خشاند.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بەخێرایی سەرم بەرز کردەوە تا ببینم کێ هاتووەتە ژوورەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He turned to glance in our direction.""",
                      kurdishText:
                          """سووڕایەوە بۆ ئەوەی لە ئاراستەکەمان بڕوانێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کاتم هەبوو تەنها چاوێک بخشێنم بە ئیمەیڵەکانم.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە کورتی چاوێکی خشاند بە لیستی باوەکان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەنها چاوپیاگێڕانێکم کرد بە وێبسایتی کۆمپانیاکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئاوڕێکی دایەوە لە کاتژمێری چێشتخانەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/tLD-OUkYtk4?t=';
const double _startSecondsend = 000000000000000000000000000679;
const String _videoIdone = 'https://youtu.be/FT3ODSg1GFE?t=';
const double _startSecondsone = 00000000000000000000000000038;
const String _videoIdtwo = 'https://youtu.be/g9QneAV4fVo?t=';
const double _startSecondstwo = 000000000000000000000000000874;
const String _videoIdthree = 'https://youtu.be/4I-p8vjQ95s?t=';
const double _startSecondsthree = 000000000000000000000000000707;
const String _videoIdfour = 'https://youtu.be/PqpCeiYycVM?t=';
const double _startSecondsfour = 000000000000000000000000000661;
const String _videoIdfive = 'https://youtu.be/1oa6VziZH78?t=';
const double _startSecondsfive = 000000000000000000000000000757;
