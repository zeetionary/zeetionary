...
class EnglishEntryarchitect extends StatelessWidget {
  ...
  Future<void> speakarchitect(String languageCode) async {
    ...
    await flutterTts.speak("architect");
  }
  ...
  Future<void> speakarchitect407(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The house was designed by architect Louis Kahn.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "architect"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɑːkɪtekt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrkɪtekt/"),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'kYnvq0s17lI';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'p9Q5a1Vn-Hk';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'p4O27MTXivI';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'EuNguMnSKnA';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'nualB4Fl88k';
  final double _startSeconds = 1;
