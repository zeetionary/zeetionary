...
class EnglishEntryintimately extends StatefulWidget {
  const EnglishEntryintimately({super.key});

  @override
  State<EnglishEntryintimately> createState() => _EnglishEntryintimatelyState();
}

class _EnglishEntryintimatelyState extends State<EnglishEntryintimately> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: intimately
1. In a close manner (- closely, nearly)
"the two phenomena are intimately connected";
 
2. With great or especially intimate knowledge (- well)
"we knew them intimately";
""",
  );

  final String keyword = "intimately";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intimately""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was talking intimately with a young man.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They touched each other intimately.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The two issues are intimately connected.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/-aq1n8MSk8c?t=';
    const double startSecondsend = 000000000000000000000000000248;
    const String videoIdone = 'https://youtu.be/EmT0i0xG6zg?t=';
    const double startSecondsone = 0000000000000000000000000003887;
    const String videoIdtwo = 'https://youtu.be/pm-7WzUrmzo?t=';
    const double startSecondstwo = 000000000000000000000000000262;
    const String videoIdthree = 'https://youtu.be/uBQJ9iYUgoU?t=';
    const double startSecondsthree = 000000000000000000000000000201;
    const String videoIdfour = 'https://youtu.be/ydprH3pQofE?t=';
    const double startSecondsfour = 0000000000000000000000000001304;
    const String videoIdfive = 'https://youtu.be/iJjEAWkFCHA?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """intimately""",
                      // alsoEnglishWord: "also: intimately",
                      britshText: """IpaUK: /ˈɪntɪmətli/""",
                      americanText: """IpaUS: /ˈɪntɪmətli/""",
...
کوردی: گەرم‌وگوڕانە،	تایبەتانە، بە شێوەیەکی تایبەتی،	بەتەواوەتی
"""),
// With short examples define "intimately", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) بەشێوەیەکی نزیک و دۆستانە"""),
                    SentencesRow(
                      englishText:
                          """The characters in the film become intimately involved in each other's lives.""",
                      kurdishText:
                          """کارەکتەرەکانی فیلمەکە بە ئاستێکی نزیک تێکەڵ بە ژیانی یەکدی دەبن.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) بەشێوەیەکی تایبەت و کەسی، زۆرجار بە شێوەی سێکسی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She was talking intimately with a young man.""",
                      kurdishText:
                          """بە سۆزەوە قسەی لەگەڵ پیاوێکی گەنج دەکرد.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They touched each other intimately.""",
                      kurdishText: """بە سۆزدارییەوە دەستیان لە یەکدی دەدا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵکار) بەشێوەیەک کە بە وردەکاریی زۆرەوەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """They were intimately familiar with the US laws and regulations.""",
                      kurdishText:
                          """بە تەواوی ئاشنا بوون بە یاسا و ڕێساکانی ئەمریکا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ھاوەڵکار) بەشێوەیەک کە بە ئاستێکی نزیک پەیوەستن بە یەکەوە یان بەژدارن"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The two issues are intimately connected.""",
                      kurdishText: """دوو بابەتەکە زۆر تێکەڵ بە یەکدین.""",
