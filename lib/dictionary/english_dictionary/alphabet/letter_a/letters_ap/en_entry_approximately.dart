...
// replace EnglishEntryAdopsum - replace speakApproximately

// replace approximately - /əˈprɒksɪmətli/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryapproximately extends StatelessWidget {
  // blank divider
  EnglishEntryapproximately({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "approximately"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈprɒksɪmətli/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈprɑːksɪmətli/"),
