...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 655;
    const String videoIdone = 'esJkln9wAEg';
    const double startSecondsone = 277;
    const String videoIdtwo = 'p-q1GTtH4LE';
    const double startSecondstwo = 665;
    const String videoIdthree = 'AEhRu5y2IV0';
    const double startSecondsthree = 606;
    const String videoIdfour = 'dQrBgda0sEY';
    const double startSecondsfour = 477;
    const String videoIdfive = '-RdOwhmqP5s';
    const double startSecondsfive = 163;
