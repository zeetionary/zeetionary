...
class EnglishEntrylawful extends StatefulWidget {
  const EnglishEntrylawful({super.key});

  @override
  State<EnglishEntrylawful> createState() => _EnglishEntrylawfulState();
}

class _EnglishEntrylawfulState extends State<EnglishEntrylawful> {
  @override
  void initState() {
    super.initState();
