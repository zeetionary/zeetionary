...
class EnglishEntryclip extends StatelessWidget {
  ...
  Future<void> speakclips1(String languageCode) async {
    ...
    await flutterTts.speak(
        "// speakclips111111111111111111111111111111111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclips2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclips200"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclips3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclips300"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclips4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclips400"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclips5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclips500"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclips6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclips600"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclips7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclips700"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclips8(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclips800"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclips9(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclips900"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclips10(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclips1000"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclips11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclips1100"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakclips12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakclips1200"); // DOPSUM: CHANGE TEXT
  }
...
کوردی: گیرە، گیرگە، بەست،	دەرزی، گوڵی سەرسنگ،	خەشاب
"""),
                                ...
                                child: Column(
                                  children: [
                                    ExampleSentenceEnglish(
                                        text:
                                            "// speakclips111111111111111111111111111111111"),
