...
class EnglishEntryfreckled extends StatefulWidget {
  const EnglishEntryfreckled({super.key});

  @override
  State<EnglishEntryfreckled> createState() => _EnglishEntryfreckledState();
}

class _EnglishEntryfreckledState extends State<EnglishEntryfreckled> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: freckled
1. Relating to or covered with or resembling freckles (= lentiginous, lentiginose)
"a plain girl with a freckled face";
""",
  );

  final String keyword = "freckled";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""freckled""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He’s a red-haired, freckled 34-year-old.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """freckled""",
                      // alsoEnglishWord: "also: freckled",
                      britshText: """IpaUK: /ˈfrekld/""",
                      americanText: """IpaUS: /ˈfrekld/""",
...
// With short examples define "freckled", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هەبوونی خاڵی قاوەیی لەسەر پێست کە ڕەش دەبنەوە لە دوای چوونە بەر خۆر"""),
                    SentencesRow(
                      englishText:
                          """He’s a red-haired, freckled 34-year-old.""",
                      kurdishText: """قژ سوورێکی پێست خاڵ خاڵی ٣٤ ساڵانە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/V_E1ARR_AAg?t=';
const double _startSecondsend = 000000000000000000000000000916;
const String _videoIdone = 'https://youtu.be/ThMcjCpQf1Y?t=';
const double _startSecondsone = 000000000000000000000000000329;
const String _videoIdtwo = 'https://youtu.be/ba247LJyjfU?t=';
const double _startSecondstwo = 000000000000000000000000000681;
const String _videoIdthree = 'https://youtu.be/lqfXej30Zzw?t=';
const double _startSecondsthree = 00000000000000000000000000067;
const String _videoIdfour = 'https://youtu.be/AwVMukShmRE?t=';
const double _startSecondsfour = 00000000000000000000000000048;
const String _videoIdfive = 'https://youtu.be/QZkQumiXioY?t=';
const double _startSecondsfive = 000000000000000000000000000412;
