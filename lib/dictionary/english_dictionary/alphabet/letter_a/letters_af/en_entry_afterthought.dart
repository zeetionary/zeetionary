...
// replace these: replace EnglishEntryafterthought - replace speakAfterthought - replace afterthought - /ˈɑːftərθɔːt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryafterthought extends StatelessWidget {
  EnglishEntryafterthought({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAfterthought(String languageCode) async {
    // DOPSUM: CHANGE speakAfterthought
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈɑːftəθɔːt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'Ww8gHl1tOCI';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'u8P9YW5YkL0';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'DuMVJj6jBpA';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = '07MdzMu2nS8';
