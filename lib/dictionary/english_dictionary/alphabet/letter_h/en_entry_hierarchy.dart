...
class EnglishEntryhierarchy extends StatefulWidget {
  const EnglishEntryhierarchy({super.key});

  @override
  State<EnglishEntryhierarchy> createState() => _EnglishEntryhierarchyState();
}

class _EnglishEntryhierarchyState extends State<EnglishEntryhierarchy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hierarchy (Derived forms: hierarchies)
1. A series of ordered groupings of people or things within a system
"put honesty first in her hierarchy of values"
 
2. The organization of people at different ranks in an administrative body (- power structure, pecking order)
""",
  );

  final String keyword = "hierarchy";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hierarchy""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She's quite high up in the management hierarchy.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He joined the party in 1966 and quickly moved up the hierarchy.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She is above me in the hierarchy.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It was on orders from the party hierarchy that she dropped the investigation.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hierarchy""",
                      // alsoEnglishWord: "also: hierarchy",
                      britshText: """IpaUK: /ˈhaɪərɑːki/""",
                      americanText: """IpaUS: /ˈhaɪərɑːrki/""",
...
کوردی: پلەمەندی، پلەبەرزبوونەوەیی، زنجیرەپایە، زنجیرەپلە، پایەمەنی، پلەمەنی
"""),
// With short examples define "hierarchy", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) سیستەمێک، بە تایبەتی لە دامەزراوەیەک یان کۆمەڵگا، کە خەڵکی دابەشکراون لە بەرزەوە بۆ نزم بە پێی ئاستی گرنگی"""),
                    SentencesRow(
                      englishText: """She's quite high up in the management hierarchy.""",
                      kurdishText: """تا ڕادەیەک بەرزە لە پلەبەندیی بەڕێوەبردندا.""",
                    ...
                    SentencesRow(
                      englishText: """He joined the party in 1966 and quickly moved up the hierarchy.""",
                      kurdishText: """ساڵی ١٩٦٦ پەیوەندی بە پارتەکەوە کرد و زوو بە پلەبەندیدا بەرزبوویەوە.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ئەو گرووپە خەڵکەی کە کاریان بەڕێوەبردنی دامەزراوەیەکی گەورەیە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """It was on orders from the party hierarchy that she dropped the investigation.""",
                      kurdishText: """بە فەرمانی کاربەدەستانی پارتەکە بوو کە وازی لە لێکۆڵینەوەکە هێنا.""",
...
const double _startSecondsend = 000000000000000000000000000779;
const String _videoIdone = 'https://youtu.be/-C3CjOkF-jY?t=';
const double _startSecondsone = 0000000000000000000000000001014;
const String _videoIdtwo = 'https://youtu.be/KhBxCx11eck?t=';
const double _startSecondstwo = 0000000000000000000000000001121;
const String _videoIdthree = 'https://youtu.be/7eM7pb5M5DU?t=';
const double _startSecondsthree = 000000000000000000000000000835;
const String _videoIdfour = 'https://youtu.be/29n2bv7F6uc?t=';
const double _startSecondsfour = 000000000000000000000000000348;
const String _videoIdfive = 'https://youtu.be/Udk8YHOy0EU?t=';
