...
class EnglishEntryfiver extends StatefulWidget {
  const EnglishEntryfiver({super.key});

  @override
  State<EnglishEntryfiver> createState() => _EnglishEntryfiverState();
}

class _EnglishEntryfiverState extends State<EnglishEntryfiver> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fiver (Derived forms: fivers)
Usage: informal
1. [US, informal] A United States bill worth 5 dollars (= five-spot [US], five dollar bill [US], fin [US, informal])
 
2. [UK, informal] Five pounds; five pound note
""",
  );

  final String keyword = "fiver";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiver""",
                      // alsoEnglishWord: "also: fiver",
                      britshText: """IpaUK: /ˈfaɪvə(r)/""",
                      americanText: """IpaUS: /ˈfaɪvər/""",
...
// With short examples define "fiver", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) پێنج پاوەند یان دۆلار"""),
                    SentencesRow(
                      englishText:
                          """Can you lend me a fiver?""",
                      kurdishText: """دەتوانیت پێنجییەکم بە قەرز پێ بدەیت؟""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/2IxD3WFHXxs?t=';
const double _startSecondsend = 000000000000000000000000000452;
const String _videoIdone = 'https://youtu.be/dWJ_WwWSabw?t=';
const double _startSecondsone = 0000000000000000000000000005757;
const String _videoIdtwo = 'https://youtu.be/ybBxueA5OuA?t=';
const double _startSecondstwo = 000000000000000000000000000942;
const String _videoIdthree = 'https://youtu.be/FQBZrPVQUyM?t=';
const double _startSecondsthree = 000000000000000000000000000591;
const String _videoIdfour = 'https://youtu.be/TfBQgs4FqG4?t=';
const double _startSecondsfour = 000000000000000000000000000920;
const String _videoIdfive = 'https://youtu.be/nXnY0lAdhII?t=';
const double _startSecondsfive = 000000000000000000000000000708;
