...
کوردی: خوازیار، بەشداری‌کەر، ژوورەوەهاتوو، نەیار، هەڤرک، بەرچەپ،	تازەهاتوو
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کەسێک کە تازە پەیوەندیی کردووە بە کارێک، زانکۆیەک، بازرگانییەک، هتد"""),
          SentencesRow(
            englishText:
                """The book is a useful guide for university entrants.""",
            kurdishText:
                """کتێبەکە ڕێبەرییەکی بەسوودە بۆ تازەهاتووانی زانکۆ.""",
          ...
          SentencesRow(
            ...
            kurdishText: """لە ئێستادا تازەهاتووی زیاتری ژن هەیە بۆ پیشەکە.""",
          ...
          SentencesRow(
            englishText:
                """Samsung and Apple have met strong competition from new entrants in the smartphone market.""",
            kurdishText:
                """سامسونگ و ئەپڵ ڕکابەریی بەهێزیان دیوە لە ڕکابەرە تازەکان لە بازاڕی موبایلی زیرەکدا.""",
