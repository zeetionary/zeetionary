...
class EnglishEntryaint extends StatelessWidget {
  ...
  Future<void> speakaint286599(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Things ain't what they used to be.");
  }
  ...
  Future<void> speakaint8411(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("I ain't got no money.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /eɪnt/"),
...
- Contraction: ain't  
Usage: informal
1. (colloquial) am not, has not, have not, is not, are not
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '9nFrp7Z9wEU';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'JEsQCm9Q3pk';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'FGUHHsBDvpA';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'mnFLfVbwO7k';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'GTIeOF_udfU';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'ujhXgFBjcZA';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'jBZgANtcXm8';
