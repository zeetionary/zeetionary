...
class EnglishEntryaccurate extends StatefulWidget {
  const EnglishEntryaccurate({super.key});

  @override
  State<EnglishEntryaccurate> createState() => _EnglishEntryaccurateState();
}

class _EnglishEntryaccurateState extends State<EnglishEntryaccurate> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""accurate""");
  }
  ...
  Future<void> speakac21546(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("The film is not historically accurate.");
  }
  ...
  Future<void> speaka2158(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("My watch is not very accurate.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accurate""",
                      // alsoEnglishWord: "also: accurate",
                      britshText: """IpaUK: /ˈækjərət/""",
                      americanText: """IpaUS: /ˈækjərət/""",
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 't5ci74tWOdY';
