...
class EnglishEntryenquire extends StatefulWidget {
  const EnglishEntryenquire({super.key});

  @override
  State<EnglishEntryenquire> createState() => _EnglishEntryenquireState();
}

class _EnglishEntryenquireState extends State<EnglishEntryenquire> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enquire""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enquire""",
                      // alsoEnglishWord: "also: enquire",
                      britshText: """IpaUK: /ɪnˈkwaɪə(r)/""",
                      americanText: """IpaUS: /ɪnˈkwaɪər/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She enquired as to your whereabouts.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He enquired her name.""");
  }
...
// With short examples define "enquire", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
"""),
          const DefinitionKurdish(
              text: """١. (کردار) داواکردنی زانیاری لە کەسێک"""),
          SentencesRow(
            englishText: """She enquired as to your whereabouts.""",
            kurdishText: """سەبارەت بە شوێنەکەت پرسیاری لێمان کرد.""",
          ...
          SentencesRow(
            englishText:
                """Might I enquire why you have not mentioned this until now?""",
            kurdishText:
                """دەکرێت بپرسم بۆچی ئەمەت تاوەکو ئێستا باس نەکردووە؟""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He enquired her name.""",
            kurdishText: """پرسیاری ناویی کرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: enquire (Derived forms: enquires, enquiring, enquired)
Usage: Brit, Cdn (US: inquire)
1. Address a question to and expect an answer from (= ask, inquire)
 
2. Conduct an inquiry or investigation of (= investigate, inquire)
 
3. Have a wish or desire to know something (= wonder, inquire)
"He enquired who had built this beautiful church";
""",
  );
...
const String _videoIdend = 'https://youtu.be/p6OVtsH6Feg?t=';
const double _startSecondsend = 528;
const String _videoIdone = 'https://youtu.be/rL1s7ZRk85Q?t=';
const double _startSecondsone = 79;
const String _videoIdtwo = 'https://youtu.be/jLP6QUOoNcw?t=';
const double _startSecondstwo = 376;
const String _videoIdthree = 'https://youtu.be/rcTbPTbochg?t=';
const double _startSecondsthree = 984;
const String _videoIdfour = 'https://youtu.be/ebYNt8Yh6QE?t=';
const double _startSecondsfour = 1380;
const String _videoIdfive = 'https://youtu.be/SCfdXOl-jVM?t=';
const double _startSecondsfive = 536;
const String _videoIdsix = 'https://youtu.be/cINzqxm2-xA?t=';
const double _startSecondssix = 102;
