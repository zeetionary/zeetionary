...
class EnglishEntryfurtherance extends StatefulWidget {
  const EnglishEntryfurtherance({super.key});

  @override
  State<EnglishEntryfurtherance> createState() =>
      _EnglishEntryfurtheranceState();
}

class _EnglishEntryfurtheranceState extends State<EnglishEntryfurtherance> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: furtherance (Derived forms: furtherances)
1. Encouragement of the progress, growth or acceptance of something (- promotion, advancement)
 
2. The advancement of some enterprise (- forwarding, promotion)
"his experience in marketing resulted in the furtherance of his career";

""",
  );

  final String keyword = "furtherance";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""furtherance""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furtherance""",
                      // alsoEnglishWord: "also: furtherance",
                      britshText: """IpaUK: /ˈfɜːðərəns/""",
                      americanText: """IpaUS: /ˈfɜːrðərəns/""",
...
کوردی: پێشوەچوون، چوونەپێش، پێشوەبردن، پێشڤەچوون،	بەدی‌هێنان، بەجێ‌هێنان،	پشتیوانی، لایەنگری،	پێشکەوتن،	بەهێزکردن، پێزاندن، یارمەتی
"""),
// With short examples define "furtherance", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """He took these actions purely in (the) furtherance of his own career.""",
                      kurdishText:
                          """هەنگاوەکانی تەنها تەنها بۆ بەرەوپێشبردنی کارکردنی خۆی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Dz7HUEUVbf4?t=';
const double _startSecondsend = 000000000000000000000000000330;
const String _videoIdone = 'https://youtu.be/Gkd1Q0Ntt9s?t=';
const double _startSecondsone = 0000000000000000000000000001054;
const String _videoIdtwo = 'https://youtu.be/AO5QAB7seAM?t=';
const double _startSecondstwo = 0000000000000000000000000004185;
const String _videoIdthree = 'https://youtu.be/hlCc_TA7gw8?t=';
const double _startSecondsthree = 000000000000000000000000000917;
const String _videoIdfour = 'https://youtu.be/e5SUhbegZtc?t=';
const double _startSecondsfour = 000000000000000000000000000325;
const String _videoIdfive = 'https://youtu.be/oxONnsOSwN4?t=';
const double _startSecondsfive = 000000000000000000000000000662;
