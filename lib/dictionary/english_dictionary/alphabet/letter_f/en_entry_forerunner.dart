...
class EnglishEntryforerunner extends StatefulWidget {
  const EnglishEntryforerunner({super.key});

  @override
  State<EnglishEntryforerunner> createState() => _EnglishEntryforerunnerState();
}

class _EnglishEntryforerunnerState extends State<EnglishEntryforerunner> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forerunner (Derived forms: forerunners)
1. A person who goes before or announces the coming of another (= precursor)
 
2. Something that precedes and indicates the approach of something or someone (= harbinger, predecessor, herald, precursor)
 
3. Anything that precedes something similar in time (= antecedent)
"phrenology was a forerunner of modern neuroscience";
""",
  );

  final String keyword = "forerunner";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forerunner""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forerunner""",
                      // alsoEnglishWord: "also: forerunner",
                      britshText: """IpaUK: /ˈfɔːrʌnə(r)/""",
                      americanText: """IpaUS: /ˈfɔːrʌnər/""",
...
// With short examples define "forerunner", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک یان شتێک کە پێش شتێکی هاوشێوە هەبووە و کاریگەریی هەبووە؛ ئاماژەی ئەوەی چی ڕوودەدات"""),
                    SentencesRow(
                      englishText:
                          """He is recognized as the forerunner of all modern-day British Prime Ministers.""",
                      kurdishText:
                          """وەک پێشەنگی هەموو سەرۆک وەزیرانە سەردەمییەکانی بەریتانیا ناسراوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Germany's Green party was said to be the forerunner of environmental parties throughout Europe.""",
                      kurdishText:
                          """پارتی سەوزی ئەڵمانیا وەک پێشەنگی هەموو پارتە ژینگەییەکانی هەموو ئەورووپا دادەنرێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/Kh2NRdVx_ns?t=';
const double _startSecondsend = 000000000000000000000000000498;
const String _videoIdone = 'https://youtu.be/iX3E_IjSMAc?t=';
const double _startSecondsone = 000000000000000000000000000447;
const String _videoIdtwo = 'https://youtu.be/YJQSuUZdcV4?t=';
const double _startSecondstwo = 000000000000000000000000000312;
const String _videoIdthree = 'https://youtu.be/q4vdACLx-hQ?t=';
const double _startSecondsthree = 0000000000000000000000000001611;
const String _videoIdfour = 'https://youtu.be/yJjs8_LsAms?t=';
const double _startSecondsfour = 0000000000000000000000000001577;
const String _videoIdfive = 'https://youtu.be/9f6d40Ppz3M?t=';
const double _startSecondsfive = 000000000000000000000000000100;
