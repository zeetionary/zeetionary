...
// replace these: replace EnglishEntryactivate - replace speakActivate - replace activate - /ˈæktɪveɪt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryactivate extends StatelessWidget {
  EnglishEntryactivate({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakActivate(String languageCode) async {
    // DOPSUM: CHANGE speakActivate
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'activate', // DOPSUM: CHANGE WORD ENTRY - Find /ˈæktɪveɪt/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈæktɪveɪt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakActivate(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˈæktɪveɪt/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'iWTzXgTp_aQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'E-KgQ-OZJZ8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'OPD4OzryRas';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'H1YrUqwGzzU';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'qfNrlHb_niw';
