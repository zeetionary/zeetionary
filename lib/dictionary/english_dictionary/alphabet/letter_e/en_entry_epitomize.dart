...
class EnglishEntryepitomize extends StatefulWidget {
  const EnglishEntryepitomize({super.key});

  @override
  State<EnglishEntryepitomize> createState() => _EnglishEntryepitomizeState();
}

class _EnglishEntryepitomizeState extends State<EnglishEntryepitomize> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""epitomize""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """epitomize""",
                      // alsoEnglishWord: "also: epitomize",
                      britshText: """IpaUK: /ɪˈpɪtəmaɪz/""",
                      americanText: """IpaUS: /ɪˈpɪtəmaɪz/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "epitomize";
...
"""),
          const DefinitionKurdish(
              text: """١. (کردار) بوون بە نموونەی تەواوی شتێک"""),
          SentencesRow(
            englishText: """These movies seem to epitomize the 1950s.""",
            kurdishText: """ئەم فیلمانە وێنای ١٩٥٠ ــیەکان دەکەن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: epitomize (Derived forms: epitomizing, epitomizes, epitomized)
1. Embody the essential characteristics of or be a typical example of (= typify, epitomise [Brit])
"The fugue epitomizes Bach's style of composition";
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/BPGgyputhpA?t=';
const double _startSecondsend = 000000000000000000000000000000; // 747;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/-Mkp4oavz2M?t=';
const double _startSecondsone = 00000000000000000000000000000; // 165;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/IfYRzxeMdGs?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 34;
const String _videoIdthree = 'VIDEOhttps://youtu.be/IjMl-_owmIg?t=';
const double _startSecondsthree = 000000000000000000000000000; // 378;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/DhddmUcmMDw?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 35;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/Jcmeu5porZA?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 68;
