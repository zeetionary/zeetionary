...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'xfkONdNK96w';
    const double startSecondsend = 253;
    const String videoIdone = 'Y_vP8nNpUFM';
    const double startSecondsone = 8;
    const String videoIdtwo = 'z9rMuCzSpt4';
    const double startSecondstwo = 96;
    const String videoIdthree = 'lex6USTugUU';
    const double startSecondsthree = 30;
    const String videoIdfour = '-CJ4eUhE3Lw';
    const double startSecondsfour = 372;
    const String videoIdfive = 'wVc_ilWtA6g';
