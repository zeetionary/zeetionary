...
class EnglishEntryloom extends StatefulWidget {
  const EnglishEntryloom({super.key});

  @override
  State<EnglishEntryloom> createState() => _EnglishEntryloomState();
}

class _EnglishEntryloomState extends State<EnglishEntryloom> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: loom (Derived forms: loomed, looming, looms)
1. Come into view indistinctly, often threateningly
"Another air plane loomed into the sky"
 
2. Appear very large or occupy a commanding position (- tower, predominate, hulk)
"Large shadows loomed on the canyon wall";
 
3. Hang over, as of something threatening, dark, or menacing (- brood, hover, bulk large)
"The terrible vision loomed over her all day long";
 
4. Weave on a loom
"materials loomed in Egypt"

- Noun: loom (Derived forms: looms)
1. A textile machine for weaving yarn into a textile
""",
  );

  final String keyword = "loom";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A dark shape loomed up ahead of us.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The tower loomed over the city.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There was a crisis looming.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Further problems loomed ahead of us.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/J-K5OjAkiEA?t=241';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/AI8Rl6WK2H8?t=200';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/a9m3GD0DbPY?t=1710';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/1rZ5VyxZmyM?t=6';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/9UHIWVtAdhY?t=281';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/Zad6v8ZHzdg?t=640';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """loom""",
                      // alsoEnglishWord: "also: loom",
                      britshText: """IpaUK: /luːm/""",
                      americanText: """IpaUS: /luːm/""",
...
کوردی: 
"""),
// With short examples define "loom", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) دەرکەوتن وەک شێوەیەکی گەورە کە ڕوون نییە و زۆرجار ترسێنەرە"""),
                    SentencesRow(
                      englishText: """A dark shape loomed up ahead of us.""",
                      kurdishText: """شێوەیەکی تاریک لەسەر سەرمانەوە دەرکەوت.""",
                    ...
                    SentencesRow(
                      englishText: """The tower loomed over the city.""",
                      kurdishText: """قولوکە دەیڕوانی بەسەر شارەکەدا.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) ئەوەی کە شتێکی خراپ جدی دەربکەوێت و ئەگەری هەبێت ڕووبدات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There was a crisis looming.""",
                      kurdishText: """قەیرانێک باڵی کێشابوو.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Further problems loomed ahead of us.""",
                      kurdishText: """کێشەی زیاتر باڵی بەسەرماندا کێشابوو.""",
