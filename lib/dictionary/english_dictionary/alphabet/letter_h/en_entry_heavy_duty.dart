...
class EnglishEntryheavyduty extends StatefulWidget {
  const EnglishEntryheavyduty({super.key});

  @override
  State<EnglishEntryheavyduty> createState() => _EnglishEntryheavydutyState();
}

class _EnglishEntryheavydutyState extends State<EnglishEntryheavyduty> {
  @override
  void initState() {
    super.initState();
...
1. Designed for heavy work
"a heavy-duty detergent"; "heavy-duty gloves"
""",
  );

  final String keyword = "heavy-duty";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heavy-duty""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I think you need some heavy-duty advice.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heavy-duty""",
                      // alsoEnglishWord: "also: heavy-duty",
                      britshText: """IpaUK: /ˌhevi ˈdjuːti/""",
                      americanText: """IpaUS: /ˌhevi ˈduːti/""",
...
const double _startSecondsthree = 000000000000000000000000000771;
const String _videoIdfour = 'https://youtu.be/XnNk647Ko0E?t=';
const double _startSecondsfour = 000000000000000000000000000301;
const String _videoIdfive = 'https://youtu.be/BzAlVPQXHk8?t=';
