...
class EnglishEntrygenerously extends StatefulWidget {
  const EnglishEntrygenerously({super.key});

  @override
  State<EnglishEntrygenerously> createState() => _EnglishEntrygenerouslyState();
}

class _EnglishEntrygenerouslyState extends State<EnglishEntrygenerously> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "generously";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""generously""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Please give generously.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Season generously with salt and pepper.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She speaks generously about everyone.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """generously""",
                      // alsoEnglishWord: "also: generously",
                      britshText: """IpaUK: /ˈdʒenərəsli/""",
                      americanText: """IpaUS: /ˈdʒenərəsli/""",
...
کوردی: زۆر، گەلێ،	دڵاوایانە، بەخشندانە، بەرچاوتێرانە، دەس‌کراوانە
"""),
// With short examples define "generously", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بەشێوەیەک کە ئەوە پیشان دەدات کە کەسێک ئامادەی بەخشینە"""),
                    SentencesRow(
                      englishText: """Please give generously.""",
                      kurdishText: """تکایە دەستکراوانە ببەخشە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕێژەیەکی زۆر خوێ و بیبەری پێدا بکە.""",
...
const String _videoIdone = 'https://youtu.be/ndqjxhi7uZs?t=';
const double _startSecondsone = 00000000000000000000000000082;
const String _videoIdtwo = 'https://youtu.be/wMxKbkWrvDc?t=';
const double _startSecondstwo = 000000000000000000000000000195;
const String _videoIdthree = 'https://youtu.be/lvvwcS-0R-g?t=';
const double _startSecondsthree = 000000000000000000000000000318;
const String _videoIdfour = 'https://youtu.be/LsNg-KrFxCA?t=';
const double _startSecondsfour = 000000000000000000000000000503;
const String _videoIdfive = 'https://youtu.be/WtAoc3_1Ido?t=';
const double _startSecondsfive = 000000000000000000000000000437;
