...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '9hv3CcJYMmU';
    const double startSecondsend = 106;
    const String videoIdone = 'UOc7xdRhAAY';
    const double startSecondsone = 149;
    const String videoIdtwo = 'O_KpLrHCAx0';
    const double startSecondstwo = 204;
    const String videoIdthree = '2MZZrDA-I4M';
    const double startSecondsthree = 554;
    const String videoIdfour = '6VaRZRUi78U';
    const double startSecondsfour = 25;
    const String videoIdfive = '2Ilu0Px_wE4';
    const double startSecondsfive = 443;
