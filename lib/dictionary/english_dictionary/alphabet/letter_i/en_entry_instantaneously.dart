...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'nsnyl8llfH4';
    const double startSecondsone = 203;
    const String videoIdtwo = 'oI_X2cMHNe0';
    const double startSecondstwo = 382;
    const String videoIdthree = '7XLd9zX6PqU';
    const double startSecondsthree = 236;
    const String videoIdfour = '6ta_sftSfIw';
    const double startSecondsfour = 283;
    const String videoIdfive = 'QcUey-DVYjk';
    const double startSecondsfive = 1043;
