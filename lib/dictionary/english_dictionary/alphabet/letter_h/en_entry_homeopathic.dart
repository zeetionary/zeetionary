...
class EnglishEntryhomeopathic extends StatefulWidget {
  const EnglishEntryhomeopathic({super.key});

  @override
  State<EnglishEntryhomeopathic> createState() =>
      _EnglishEntryhomeopathicState();
}

class _EnglishEntryhomeopathicState extends State<EnglishEntryhomeopathic> {
  @override
  void initState() {
    super.initState();
...
Usage: N. Amer (elsewhere: homoeopathic)
1. Of or relating to the practice of homeopathy (- homoeopathic [Brit, Cdn])
"homeopathic medicine";
""",
  );

  final String keyword = "homeopathic";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""homeopathic""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He questions the effectiveness of homeopathic treatments.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/YmtIrYXlGRM?t=';
    const double startSecondsend = 000000000000000000000000000156;
    const String videoIdone = 'https://youtu.be/OCFmQd15SRo?t=';
    const double startSecondsone = 000000000000000000000000000291;
    const String videoIdtwo = 'https://youtu.be/Nqr5wBXydkQ?t=';
    const double startSecondstwo = 000000000000000000000000000321;
    const String videoIdthree = 'https://youtu.be/6521a_4tUYA?t=';
    const double startSecondsthree = 000000000000000000000000000341;
    const String videoIdfour = 'https://youtu.be/y8wnS6jJlwc?t=';
    const double startSecondsfour = 000000000000000000000000000191;
    const String videoIdfive = 'https://youtu.be/vj71yGp-8WM?t=';
    const double startSecondsfive = 000000000000000000000000000386;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homeopathic""",
                      // alsoEnglishWord: "also: homeopathic",
                      britshText: """IpaUK: /ˌhəʊmiəˈpæθɪk/,  /ˌhɒmiəˈpæθɪk/""",
                      americanText: """IpaUS: /ˌhəʊmiəˈpæθɪk/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) پەیوەندیدار بە چارەسەرکردنی دۆخێکی تەندرووستی یان نەخۆشییەک بە بەکارهێنانی بڕی کەمی ئەو مادەیەی کە بووە بە هۆکاری"""),
                    SentencesRow(
                      englishText:
                          """He questions the effectiveness of homeopathic treatments.""",
                      kurdishText:
                          """گومانی هەیە لە کاریگەری چارەسەری هۆمیۆپاسیک.""",
