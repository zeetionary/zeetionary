...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 391;
    const String videoIdone = '2INKRjtw_cI';
    const double startSecondsone = 687;
    const String videoIdtwo = 'hSNWkRw53Jo';
    const double startSecondstwo = 4790;
    const String videoIdthree = 'z2W-5J1vl8o';
    const double startSecondsthree = 443;
    const String videoIdfour = '_DMhb1FWHso';
    const double startSecondsfour = 612;
    const String videoIdfive = 'XejfyN6i0lM';
