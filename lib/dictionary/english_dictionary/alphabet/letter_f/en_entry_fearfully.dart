...
class EnglishEntryfearfully extends StatefulWidget {
  const EnglishEntryfearfully({super.key});

  @override
  State<EnglishEntryfearfully> createState() => _EnglishEntryfearfullyState();
}

class _EnglishEntryfearfullyState extends State<EnglishEntryfearfully> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fearfully""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fearfully""",
                      // alsoEnglishWord: "also: fearfully",
                      britshText: """IpaUK: /ˈfɪəfəli/""",
                      americanText: """IpaUS: /ˈfɪrfəli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "fearfully";
...
کوردی: بە ترسەوە، لە ڕووی ترسەوە
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵکار) پێنناسە"""),
          SentencesRow(
            englishText: """We watched fearfully.""",
            kurdishText: """بە ترسەوە سەیرمان کرد.""",
...
const String _videoIdend = 'https://youtu.be/dB18p5JiFfY?t=';
const double _startSecondsend = 0000000000000000000000000001018;
const String _videoIdone = 'https://youtu.be/c8ccsE_IumM?t=';
const double _startSecondsone = 000000000000000000000000000381;
const String _videoIdtwo = 'https://youtu.be/KFjQ-3vDRXs?t=';
const double _startSecondstwo = 000000000000000000000000000230;
const String _videoIdthree = 'https://youtu.be/Q0AUPpx8i7A?t=';
const double _startSecondsthree = 000000000000000000000000000316;
const String _videoIdfour = 'https://youtu.be/Z7RUjD0yEZw?t=';
const double _startSecondsfour = 000000000000000000000000000782;
const String _videoIdfive = 'https://youtu.be/x1Bcq0RPGt8?t=';
const double _startSecondsfive = 0000000000000000000000000001299;
