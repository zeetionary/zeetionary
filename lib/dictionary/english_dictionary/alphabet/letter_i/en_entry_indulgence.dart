...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/cCP9vjp4kSg?t=';
    const double startSecondsend = 00000000000000000000000000064;
    const String videoIdone = 'https://youtu.be/f5NJQiY9AuY?t=';
    const double startSecondsone = 000000000000000000000000000173;
    const String videoIdtwo = 'https://youtu.be/_-Ic5nS5TXA?t=';
    const double startSecondstwo = 000000000000000000000000000289;
    const String videoIdthree = 'https://youtu.be/vsMydMDi3rI?t=';
    const double startSecondsthree = 00000000000000000000000000017;
    const String videoIdfour = 'https://youtu.be/CjiKlLE3NuI?t=';
    const double startSecondsfour = 000000000000000000000000000839;
    const String videoIdfive = 'https://youtu.be/2MZZrDA-I4M?t=';
    const double startSecondsfive = 000000000000000000000000000528;
