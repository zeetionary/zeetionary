...
class EnglishEntryequinox extends StatefulWidget {
  const EnglishEntryequinox({super.key});

  @override
  State<EnglishEntryequinox> createState() => _EnglishEntryequinoxState();
}

class _EnglishEntryequinoxState extends State<EnglishEntryequinox> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""equinox""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equinox""",
                      // alsoEnglishWord: "also: equinox",
                      britshText: """IpaUK: /ˈekwɪnɒks/,  /ˈiːkwɪnɒks/""",
                      americanText: """IpaUS: /ˈekwɪnɑːks/,  /ˈiːkwɪnɑːks/""",
...
کوردی: ڕۆژگەڕانەوە، بەرامبەران، شەوڕێکان، ڕێکەمەنی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) یەکێک لە دوو ماوەکەی ساڵ (٢٠ ـی ئادار و ٢٢ ـی ئەیلوول) کە خۆر لەسەر هێڵی سفری درێژییە کە دەکەوێتە ناوەڕاستی زەوی و شەو و ڕۆژ یەکساننه"""),
          SentencesRow(
            englishText: """The vernal equinox marks the start of spring.""",
            kurdishText: """بەرامبەرانی بەهارە سەرەتای بەهار دیاری دەکات.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: equinox (Derived forms: equinoxes)
...
2. (astronomy) either of the two celestial points at which the celestial equator intersects the ecliptic (= equinoctial point)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/MYnjzsjeMK8?t=';
const double _startSecondsend = 000000000000000000000000000000; // 249;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/jySqbJwKXb0?t=';
const double _startSecondsone = 00000000000000000000000000000; // 612;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/wQeFsMArKRY?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 465;
const String _videoIdthree = 'VIDEOhttps://youtu.be/cFVRCo6-FUU?t=';
const double _startSecondsthree = 000000000000000000000000000; // 10;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/yEs933aETJU?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 314;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/ji6HQJOM_lc?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 1;
