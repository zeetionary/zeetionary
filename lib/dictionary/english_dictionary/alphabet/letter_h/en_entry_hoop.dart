...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000420;
    const String videoIdone = 'https://youtu.be/9K_CZizKdVs?t=';
    const double startSecondsone = 000000000000000000000000000799;
    const String videoIdtwo = 'https://youtu.be/Js2UoMSumx4?t=';
    const double startSecondstwo = 000000000000000000000000000524;
    const String videoIdthree = 'https://youtu.be/p3O6bKdPLbw?t=';
    const double startSecondsthree = 000000000000000000000000000373;
    const String videoIdfour = 'https://youtu.be/Am1lDj2mUVY?t=';
    const double startSecondsfour = 000000000000000000000000000416;
    const String videoIdfive = 'https://youtu.be/h_OeMVcol1g?t=';
    const double startSecondsfive = 000000000000000000000000000942;
