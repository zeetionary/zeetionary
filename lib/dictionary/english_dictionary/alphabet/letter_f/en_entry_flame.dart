...
// With short examples define "flame", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەموو شتێک گڕی گرت.""",
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ناو) هەستی زۆر بەهێز"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """His childhood interest in the game had ignited a flame of passion for football.""",
                      kurdishText:
                          """حەزی منداڵیی بۆ یارییەکە حەزێکی بەهێزی خۆشەویستی بۆ تۆپی پێ درووست کردبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هیوا بوژایەوە تێیدا.""",
                      onPressedBritish: () => speaksentence9("en-GB"),
                      onPressedAmerican: () => speaksentence9("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٥. (کردار) سووربەنەوە بەهۆی هەستی بەهێزەوە"""),
                    const DividerSentences(),
                    SentencesRow(
...
const double _startSecondsend = 000000000000000000000000000772;
...
const double _startSecondsfour = 0000000000000000000000000001144;
const String _videoIdfive = 'https://youtu.be/D8tPkb98Fkk?t=';
