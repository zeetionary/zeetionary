...
class EnglishEntrygodliness extends StatefulWidget {
  const EnglishEntrygodliness({super.key});

  @override
  State<EnglishEntrygodliness> createState() => _EnglishEntrygodlinessState();
}

class _EnglishEntrygodlinessState extends State<EnglishEntrygodliness> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "godliness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""godliness""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """godliness""",
                      // alsoEnglishWord: "also: godliness",
                      britshText: """IpaUK: /ˈɡɒdlinəs/""",
                      americanText: """IpaUS: /ˈɡɑːdlinəs/""",
...
// With short examples define "godliness", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """They employed their money and influence to promote godliness.""",
                      kurdishText:
                          """پارە و خواناسییان بەکارهێنا بۆ برەودان بە خواناسی.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/zJt0e8FRBwM?t=';
...
const String _videoIdtwo = 'https://youtu.be/y08pbpn98rs?t=';
const double _startSecondstwo = 00000000000000000000000000087;
const String _videoIdthree = 'https://youtu.be/bOGSRJ1_7DI?t=';
const double _startSecondsthree = 000000000000000000000000000435;
const String _videoIdfour = 'https://youtu.be/7eFMaG4CXOM?t=';
const double _startSecondsfour = 0000000000000000000000000006;
const String _videoIdfive = 'https://youtu.be/geOYbxEvYFQ?t=';
const double _startSecondsfive = 0000000000000000000000000003179;
