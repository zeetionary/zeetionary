...
class EnglishEntryhedgerow extends StatefulWidget {
  const EnglishEntryhedgerow({super.key});

  @override
  State<EnglishEntryhedgerow> createState() => _EnglishEntryhedgerowState();
}

class _EnglishEntryhedgerowState extends State<EnglishEntryhedgerow> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hedgerow (Derived forms: hedgerows)
1. A fence formed by a row of closely planted shrubs or bushes (- hedge)
""",
  );

  final String keyword = "hedgerow";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hedgerow""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hedgerow provided shelter from the wind.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hedgerow""",
                      // alsoEnglishWord: "also: hedgerow",
                      britshText: """IpaUK: /ˈhedʒrəʊ/""",
                      americanText: """IpaUS: /ˈhedʒrəʊ/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕیزێک لە داری بچووک و دەوەن کە بە درێژایی کێڵگەیەک یان ڕێگایەک چاندراوە"""),
                    SentencesRow(
                      englishText:
                          """The hedgerow provided shelter from the wind.""",
                      kurdishText:
                          """چەپەرەکە پەناگەی لە بایەکە دابین کردبوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/_zZxCVBi7-k?t=';
const double _startSecondsend = 000000000000000000000000000158;
const String _videoIdone = 'https://youtu.be/mJ-8devarFA?t=';
const double _startSecondsone = 00000000000000000000000000020;
const String _videoIdtwo = 'https://youtu.be/C-IHzxj4oDI?t=';
const double _startSecondstwo = 000000000000000000000000000511;
const String _videoIdthree = 'https://youtu.be/CYO34sUCBL0?t=';
const double _startSecondsthree = 000000000000000000000000000152;
const String _videoIdfour = 'https://youtu.be/DZRIzGMr4jE?t=';
const double _startSecondsfour = 0000000000000000000000000001671;
const String _videoIdfive = 'https://youtu.be/THK9c4MMBhE?t=';
