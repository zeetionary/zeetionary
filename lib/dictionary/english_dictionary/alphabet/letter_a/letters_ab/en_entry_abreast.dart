...
// replace these: EnglishEntryabreast - speakAbreast - abreast - /əˈbrest/

enum TtsState { playing }

class EnglishEntryabreast extends StatelessWidget {
  EnglishEntryabreast({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'abreast', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈbrest/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '9fVot8fIX-o';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'eR-J_JSBNTI';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '2LJ8nBgEA2Q';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'xDf7OUKpyvs';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'kx-K4-8-RvM';
