...
class EnglishEntryghosttown extends StatefulWidget {
  const EnglishEntryghosttown({super.key});

  @override
  State<EnglishEntryghosttown> createState() => _EnglishEntryghosttownState();
}

class _EnglishEntryghosttownState extends State<EnglishEntryghosttown> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "ghost town";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""ghost town""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They visited an old ghost town in the desert.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ghost town""",
                      // alsoEnglishWord: "also: ghost town",
                      britshText: """IpaUK: /ˈɡəʊst taʊn/""",
                      americanText: """IpaUS: /ˈɡəʊst taʊn/""",
...
کوردی: شاری تارمایی‌یەکان، شاری چۆڵ، چۆڵگە
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) شارۆچکەیەک کە جاران قەرەباڵغ بوو بەڵام ئێستا چۆڵە"""),
                    SentencesRow(
                      englishText:
                          """They visited an old ghost town in the desert.""",
                      kurdishText:
                          """سەردانی شارۆچکەیەکی چۆڵیان لە بیابانەکە کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/PkUg89kLLBE?t=';
const double _startSecondsend = 000000000000000000000000000508;
const String _videoIdone = 'https://youtu.be/02Nm2B4hkYc?t=';
const double _startSecondsone = 000000000000000000000000000120;
const String _videoIdtwo = 'https://youtu.be/9TimmdqACAs?t=';
const double _startSecondstwo = 000000000000000000000000000521;
const String _videoIdthree = 'https://youtu.be/vntKopJeeuo?t=';
const double _startSecondsthree = 00000000000000000000000000021;
const String _videoIdfour = 'https://youtu.be/XG4rnKlgCN8?t=';
const double _startSecondsfour = 00000000000000000000000000050;
const String _videoIdfive = 'https://youtu.be/KK3Yr80lPOY?t=';
