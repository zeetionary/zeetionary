...
class EnglishEntryinefficient extends StatefulWidget {
  const EnglishEntryinefficient({super.key});

  @override
  State<EnglishEntryinefficient> createState() =>
      _EnglishEntryinefficientState();
}

class _EnglishEntryinefficientState extends State<EnglishEntryinefficient> {
  @override
  void initState() {
    super.initState();
...
1. Lacking the ability or skill to perform effectively; inadequate (- ineffective)
"inefficient workers";
...
""",
  ...
  final String keyword = "inefficient";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inefficient""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 00000000000000000000000000042;
    const String videoIdone = 'https://youtu.be/AF8d72mA41M?t=';
    const double startSecondsone = 000000000000000000000000000846;
    const String videoIdtwo = 'https://youtu.be/G0SpzIIHEaE?t=';
    const double startSecondstwo = 000000000000000000000000000564;
    const String videoIdthree = 'https://youtu.be/r5yCk6Qpuv4?t=';
    const double startSecondsthree = 000000000000000000000000000366;
    const String videoIdfour = 'https://youtu.be/RQYuyHNLPTQ?t=';
    const double startSecondsfour = 000000000000000000000000000787;
    const String videoIdfive = 'https://youtu.be/Wk1oClYJE58?t=';
    const double startSecondsfive = 000000000000000000000000000350;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inefficient""",
                      // alsoEnglishWord: "also: inefficient",
                      britshText: """IpaUK: /ˌɪnɪˈfɪʃnt/""",
                      americanText: """IpaUS: /ˌɪnɪˈfɪʃnt/""",
...
کوردی: کەم‌بەرهەم،	بەکارنەهاتوو، ناکارا، بێهوودە، بێ‌بەرهەم، لێنەهاتوو، لێنەوەشاو
"""),
// With short examples define "inefficient", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە کارێک بە باشی ناکات بەوەی بە باشترین شێوە کات، پارە، وزە، هتد بەکاربێنێت"""),
                    SentencesRow(
                      englishText:
                          """The company was inefficient because it was highly bureaucratic.""",
                      kurdishText:
