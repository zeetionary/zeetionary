...
// replace these: replace EnglishEntryadore - replace speakAdore - replace adore - /əˈdɔːr/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadore extends StatelessWidget {
  EnglishEntryadore({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "adore", // DOPSUM: CHANGE WORD ENTRY - Find /əˈdɔː(r)/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈdɔː(r)/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'vY3qtx4IFgo';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'VQLi2GYVULc';
