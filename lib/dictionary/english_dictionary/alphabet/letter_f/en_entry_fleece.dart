...
class EnglishEntryfleece extends StatefulWidget {
  const EnglishEntryfleece({super.key});

  @override
  State<EnglishEntryfleece> createState() => _EnglishEntryfleeceState();
}

class _EnglishEntryfleeceState extends State<EnglishEntryfleece> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fleece (Derived forms: fleeces)
1. The wool of a sheep or similar animal
 
2. Tanned skin of a sheep with the fleece left on; used for clothing (= sheepskin)
 
3. A soft bulky fabric with deep pile; used chiefly for clothing
 
4. Outer coat of especially sheep and yaks (= wool)

- Verb: fleece (Derived forms: fleeced, fleeces, fleecing) 
1. [informal] Rip off; ask an unreasonable price (= overcharge, soak [informal], surcharge, gazump [Brit, informal], pluck [informal], rob, hook [informal], skin [informal])

2. Shave the wool from (= shear)
"fleece sheep";
""",
  );

  final String keyword = "fleece";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He was wearing a green fleece and hiking boots.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Some local shops have been fleecing tourists.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fleece""",
                      // alsoEnglishWord: "also: fleece",
                      britshText: """IpaUK: /fliːs/""",
                      americanText: """IpaUS: /fliːs/""",
...
// With short examples define "fleece", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """فلیسێکی سەوز و پووتی شاخەوانی لەبەرکردبوو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) وەرگرتنی پارەیەکی زۆر لە کەسێک بە فرۆشتنی شت بە گران‌بەها"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Some local shops have been fleecing tourists.""",
                      kurdishText:
                          """ژمارەیەکی فرۆشگای خۆجێیی قۆڵی گەشتیارانیان بڕیوە.""",
...
const String _videoIdone = 'https://youtu.be/aTrtKikAW6E?t=';
...
const String _videoIdthree = 'https://youtu.be/EkIbC5JqVck?t=';
const double _startSecondsthree = 00000000000000000000000000064;
const String _videoIdfour = 'https://youtu.be/okAAL53Rj_0?t=';
const double _startSecondsfour = 000000000000000000000000000140;
const String _videoIdfive = 'https://youtu.be/Lp5uh6ztGJo?t=';
const double _startSecondsfive = 000000000000000000000000000568;
