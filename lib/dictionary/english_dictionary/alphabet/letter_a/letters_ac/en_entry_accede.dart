...
class EnglishEntryaccede extends StatefulWidget {
  const EnglishEntryaccede({super.key});

  @override
  State<EnglishEntryaccede> createState() => _EnglishEntryaccedeState();
}

class _EnglishEntryaccedeState extends State<EnglishEntryaccede> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accede""",
                      // alsoEnglishWord: "also: accede",
                      britshText: """IpaUK: /əkˈsiːd/""",
                      americanText: """IpaUS: /əkˈsiːd/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '3zx3i9s7lLY';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'bhTRxyXtfUU';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'SzJvpmoWQrI';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'vYDxOnDGpHc';
