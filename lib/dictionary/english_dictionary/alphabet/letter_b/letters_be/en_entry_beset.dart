...
// Define the word "beset" and provide five simple example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings or more.

// replace beset - replace EnglishEntrybeset

// replace speakBeset - /bɪˈset/

enum TtsState { playing }

class EnglishEntrybeset extends StatelessWidget {
// blank divider
  EnglishEntrybeset({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakbeset(String languageCode) async {
    // DOPSUM: CHANGE speakBeset
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("beset"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbesets1(String languageCode) async {
    // DOPSUM: CHANGE speakBeset
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "The team was beset by injury all season."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbesets2(String languageCode) async {
    // DOPSUM: CHANGE speakBeset
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "It's one of the most difficult problems besetting our modern way of life."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbesets3(String languageCode) async {
    // DOPSUM: CHANGE speakBeset
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBesets33"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbesets4(String languageCode) async {
    // DOPSUM: CHANGE speakBeset
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBesets44"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbesets5(String languageCode) async {
    // DOPSUM: CHANGE speakBeset
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBesets55"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbesets6(String languageCode) async {
    // DOPSUM: CHANGE speakBeset
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBesets66"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakbesets7(String languageCode) async {
    // DOPSUM: CHANGE speakBeset
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBesets77"); // DOPSUM: CHANGE TEXT
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "beset"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /bɪˈset/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakbeset("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /bɪˈset/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakbeset("en-US"),
                            ),
                          ],
                        ),
                      ],
...
1. Annoy or hinder continually or in many ways (= harass, hassle [informal], harry, chivy, chivvy, chevy, chevvy [non-standard], plague, molest, provoke)
...
2. Assail or attack on all sides (= set upon)
"the ship was beset by pirates";
 
3. Decorate or cover lavishly (as with gems) (= encrust, incrust)
""",
  );
...
class _YoutubeEmbeddedtwoState extends State<YoutubeEmbeddedtwo> {
  late YoutubePlayerController _controller;
  final String _videoId = 'L3eC_HAeWtU';
...
class _YoutubeEmbeddedthreeState extends State<YoutubeEmbeddedthree> {
  late YoutubePlayerController _controller;
  final String _videoId = 'dtjHZqVMXSI';
...
class _YoutubeEmbeddedfiveState extends State<YoutubeEmbeddedfive> {
  late YoutubePlayerController _controller;
  final String _videoId = 'NIgqhU4lkgo';
  final double _startSeconds = 3029;
...
class _YoutubeEmbeddedsixState extends State<YoutubeEmbeddedsix> {
  late YoutubePlayerController _controller;
  final String _videoId = 'xrLrb1OQjGs';
...
class _YoutubeEmbeddedsevenState extends State<YoutubeEmbeddedseven> {
  late YoutubePlayerController _controller;
  final String _videoId = 'FKTicVgp8zU';
...
class _YoutubeEmbeddednineState extends State<YoutubeEmbeddednine> {
  late YoutubePlayerController _controller;
  final String _videoId = 'Ot6Irvxn-v4';
...
class _YoutubeEmbeddedelevenState extends State<YoutubeEmbeddedeleven> {
  ...
  final double _startSeconds = 7116;
...
class _YoutubeEmbeddedtwelveState extends State<YoutubeEmbeddedtwelve> {
  late YoutubePlayerController _controller;
  final String _videoId = '9ksj6J7sNBk';
...
class _YoutubeEmbeddedthirteenState extends State<YoutubeEmbeddedthirteen> {
  late YoutubePlayerController _controller;
  final String _videoId = 'pdxjlRFjNLU';
...
// end beset// TODO Implement this library.
