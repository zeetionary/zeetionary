...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '41elK59iygE';
    const double startSecondsend = 3935;
    const String videoIdone = '1jc30CC6Xiw';
    const double startSecondsone = 198;
    const String videoIdtwo = '0vRlyPH6REM';
    const double startSecondstwo = 144;
    const String videoIdthree = 'Rxh_SVtyZqo';
    const double startSecondsthree = 1876;
    const String videoIdfour = 'IXu7tXixrtQ';
    const double startSecondsfour = 474;
    const String videoIdfive = 'e-PT9poDL3E';
    const double startSecondsfive = 811;
