...
const String _videoIdend = 'd7gsPmWOU-g';
const double _startSecondsend = 22;
const String _videoIdone = 'ykTqPOaYbDE';
const double _startSecondsone = 406;
const String _videoIdtwo = 'yThjSE7wLmA';
const double _startSecondstwo = 148;
const String _videoIdthree = 'tYvMpH_IDIk';
const double _startSecondsthree = 1095;
const String _videoIdfour = '0NhS5D_uXxI';
const double _startSecondsfour = 40;
const String _videoIdfive = 'qaR8rFsWoEo';
