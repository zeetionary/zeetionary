...
class EnglishEntryfreshwater extends StatefulWidget {
  const EnglishEntryfreshwater({super.key});

  @override
  State<EnglishEntryfreshwater> createState() => _EnglishEntryfreshwaterState();
}

class _EnglishEntryfreshwaterState extends State<EnglishEntryfreshwater> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: freshwater (Derived forms: freshwaters, fresh waters)
1. Water that is not salty (= fresh water)
""",
  );

  final String keyword = "freshwater";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""freshwater""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She caught a large freshwater fish in the lake.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The village is near a freshwater lake.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """freshwater""",
                      // alsoEnglishWord: "also: freshwater",
                      britshText: """IpaUK: /ˈfreʃwɔːtə(r)/""",
                      americanText: """IpaUS: /ˈfreʃwɔːtər/""",
...
// With short examples define "freshwater", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """She caught a large freshwater fish in the lake.""",
                      kurdishText:
                          """ماسییەکی گەورەی ئاوی شیرینی لە دەریاچەکەدا گرت.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵناو) کە ئاوی بێ خوێی هەیە"""),
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/6_Vrg3zAKl4?t=';
const double _startSecondsend = 000000000000000000000000000126;
const String _videoIdone = 'https://youtu.be/qO--hy6Q-LA?t=';
const double _startSecondsone = 00000000000000000000000000061;
const String _videoIdtwo = 'https://youtu.be/iXexmZm3_j8?t=';
const double _startSecondstwo = 000000000000000000000000000315;
const String _videoIdthree = 'https://youtu.be/bPJUVKizh90?t=';
const double _startSecondsthree = 0000000000000000000000000005;
const String _videoIdfour = 'https://youtu.be/MdNFkKjvSLo?t=';
const double _startSecondsfour = 000000000000000000000000000186;
const String _videoIdfive = 'https://youtu.be/ifhY_AHbSRA?t=';
