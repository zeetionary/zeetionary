...
// """),
          const DefinitionKurdish(
              text:
                  """١. (کردار) خستنە دۆخێکەوە کە ئەگەری ھەیە زیان و مەترسی ھەیە"""),
          SentencesRow(
            englishText:
                """The health of our children is being endangered by exhaust fumes.""",
            kurdishText:
          ...
          SentencesRow(
            englishText:
                """He denied possessing a rifle with intent to endanger life.""",
            kurdishText:
                """نکۆڵی لەوە کرد کە چەکێکی ھەبێت بە ئامانجی زیان گەیاندن بە خەڵکی.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """بەکارھێنانی ئەم دەرمانانە دەکرێت بە ئاستێکی زۆر تەندرووستیت بخاتە مەترسییەوە.""",
