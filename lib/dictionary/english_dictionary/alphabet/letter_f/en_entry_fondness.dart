...
class EnglishEntryfondness extends StatefulWidget {
  const EnglishEntryfondness({super.key});

  @override
  State<EnglishEntryfondness> createState() => _EnglishEntryfondnessState();
}

class _EnglishEntryfondnessState extends State<EnglishEntryfondness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fondness
1. A predisposition to like something (= fancy, partiality)
"he had a fondness for whiskey";
 
2. A positive feeling of liking (= affection, affectionateness, tenderness, heart, warmness, warmheartedness, philia)
"he had trouble expressing the fondness he felt";
 
3. A quality proceeding from feelings of affection or love (= affectionateness, lovingness, warmth)
""",
  );

  final String keyword = "fondness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fondness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He will be remembered by the staff with great fondness.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fondness""",
                      // alsoEnglishWord: "also: fondness",
                      britshText: """IpaUK: /ˈfɒndnəs/""",
                      americanText: """IpaUS: /ˈfɑːndnəs/""",
...
کوردی: خولیایی، دڵبەستەیی، خۆشەویستی، بەپەرۆشی، تامەزرۆیی، هۆگری، شەیدایی، تاسە
"""),
// With short examples define "fondness", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە لایەن ستافەکەوە بە خۆشەویستیی زۆرەوە بیردێتەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It was her father’s fondness for drink that brought about the break-up of her parents’ marriage.""",
                      kurdishText:
                          """ئەوە حەزی باوکی بۆ خواردنەوە بوو کە هەڵوەشانەوەی هاوسەرگیریی دایبابی لێکەوتەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/GjbxgP9jL18?t=';
const double _startSecondsend = 00000000000000000000000000033;
const String _videoIdone = 'https://youtu.be/WVzvTLSK5dY?t=';
const double _startSecondsone = 000000000000000000000000000173;
const String _videoIdtwo = 'https://youtu.be/Eu46puWv7ts?t=';
const double _startSecondstwo = 00000000000000000000000000016;
const String _videoIdthree = 'https://youtu.be/P76HRtZYlLA?t=';
const double _startSecondsthree = 000000000000000000000000000246;
const String _videoIdfour = 'https://youtu.be/NU4MgeOb-cc?t=';
const double _startSecondsfour = 000000000000000000000000000615;
const String _videoIdfive = 'https://youtu.be/bwvGL21aJ_s?t=';
