...
class EnglishEntrygeometric extends StatefulWidget {
  const EnglishEntrygeometric({super.key});

  @override
  State<EnglishEntrygeometric> createState() => _EnglishEntrygeometricState();
}

class _EnglishEntrygeometricState extends State<EnglishEntrygeometric> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "geometric";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""geometric""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Architects use geometric methods to design buildings.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """geometric""",
                      alsoEnglishWord: "also: geometrical",
                      britshText: """IpaUK: /ˌdʒiːəˈmetrɪk/""",
                      americanText: """IpaUS: /ˌdʒiːəˈmetrɪk/""",
...
const double _startSecondsend = 000000000000000000000000000902;
...
const double _startSecondstwo = 0000000000000000000000000001551;
const String _videoIdthree = 'https://youtu.be/LbPw9AlVKVM?t=';
const double _startSecondsthree = 0000000000000000000000000001188;
const String _videoIdfour = 'https://youtu.be/3hurvRBoYgM?t=';
