                      ...
                      child: Column(
                        ...
                        children: [
                          const Text(
                            ...
                            """
کوردی: دەس(ت)، باڵ، بازۆڵە، بازوو، باسک، قۆڵ، بەوش، باوش، باوەش، باخڵ، هەنگڵ، لق، تا، بەشی کرداری گروپ، ڕێکخراوە، دامەزراوە یان چالاکی‌یێ، دەسک، جێ‌دەس، دەستە، چەک، تەرک، هێز، دەسەڵات، (ڕووبار) لق
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "قۆڵەکەی پێویستیی بە کورتکردنەوە هەیە.",
                                    textAlign: TextAlign
                                        .right, // Right-to-left direction
                                    textDirection: TextDirection.rtl,
                                  ),
...
٥. (ناو) ڕێڕەوێکی بچووکی ئاو یان پارچە زەوی کە دەگەیەت بە یەکێکی گەورەتر""",
                          ...
                          const Text(
                            // DOPSUM: WRITE DEFINITION IN KURDISH. COPY FOR ANOTHER DEFINITION
                            """
٦. (ناو) بەشێکی بچووکی دامەزراوەیەکی گەورەتر کە تەنها یەک چالاکی هەیە""",
                            style: TextStyle(fontSize: 18),
                            textAlign: TextAlign.right,
                            textDirection: TextDirection.rtl,
                          ),
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "بانکەکە پلانی هەیە بەشێکی لقی ئەمریکای بفرۆشێت.",
                                    textAlign: TextAlign
                                        .right, // Right-to-left direction
                                    textDirection: TextDirection.rtl,
                                  ),
                            ...
                            children: [
                              ...
                              const Expanded(
                                child: Align(
                                  alignment: Alignment.topLeft,
                                  child: Text(
                                    "پێش‌وەختە خۆی ئامادەکرد بۆ چاوپێکەوتنەکە بە دۆزینەوەی هەر شتێک کە دەیتوانی بیکات سەبارەت بە کۆمپانیاکە.",
                                    textAlign: TextAlign
                                        .right, // Right-to-left direction
                                    textDirection: TextDirection.rtl,
                                  ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "https://youtu.be/Qiok50TjAIE?t=";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "https://youtu.be/vFymKqUwodY?t=";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "https://youtu.be/XKBbn5GBw0Y?t=";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "https://youtu.be/oYO7o1Z8gk4?t=";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "https://youtu.be/cYXUu3qT36c?t=";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "https://youtu.be/AcLh-aSUdx0?t=";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "https://youtu.be/3TSD9TJ5sVM?t=";
