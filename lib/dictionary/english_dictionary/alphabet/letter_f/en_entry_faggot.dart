...
class EnglishEntryfaggot extends StatefulWidget {
  const EnglishEntryfaggot({super.key});

  @override
  State<EnglishEntryfaggot> createState() => _EnglishEntryfaggotState();
}

class _EnglishEntryfaggotState extends State<EnglishEntryfaggot> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """faggot""",
                      // alsoEnglishWord: "also: faggot",
                      britshText: """IpaUK: /ˈfæɡət/""",
                      americanText: """IpaUS: /ˈfæɡət/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He cooked faggots for dinner.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Calling someone a faggot is disrespectful.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They used a faggot to start the fire.""");
  }
...
"""),
          ...
          SentencesRow(
            englishText: """He cooked faggots for dinner.""",
            kurdishText: """بۆ نانی ئێوارە کفتەی لێنا.""",
...
3. Bind or tie up in or as if in a faggot (= fagot [N. Amer], faggot up)
...
const String _videoIdend = 'https://youtu.be/PBUWzTESAKI?t=';
const double _startSecondsend = 00000000000000000000000000093;
const String _videoIdone = 'https://youtu.be/P4hNG60NHM8?t=';
const double _startSecondsone = 000000000000000000000000000139;
const String _videoIdtwo = 'https://youtu.be/4_FHvf9typs?t=';
const double _startSecondstwo = 00000000000000000000000000094;
const String _videoIdthree = 'https://youtu.be/iRuixhxXt0k?t=';
const double _startSecondsthree = 000000000000000000000000000640;
const String _videoIdfour = 'https://youtu.be/lww1rm07jMs?t=';
const double _startSecondsfour = 000000000000000000000000000245;
const String _videoIdfive = 'https://youtu.be/iDQri838PIA?t=';
const double _startSecondsfive = 00000000000000000000000000037;
