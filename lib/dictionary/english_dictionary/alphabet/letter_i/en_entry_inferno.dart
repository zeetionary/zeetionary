...
class EnglishEntryinferno extends StatefulWidget {
  const EnglishEntryinferno({super.key});

  @override
  State<EnglishEntryinferno> createState() => _EnglishEntryinfernoState();
}

class _EnglishEntryinfernoState extends State<EnglishEntryinferno> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inferno""");
  }
