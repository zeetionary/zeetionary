...
class EnglishEntryits extends StatefulWidget {
  const EnglishEntryits({super.key});

  @override
  State<EnglishEntryits> createState() => _EnglishEntryitsState();
}

class _EnglishEntryitsState extends State<EnglishEntryits> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryits its
WORD_WEB its its its
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "its";
...
// کوردی:
// """),
// With short examples define "its", please follow LX instructions
