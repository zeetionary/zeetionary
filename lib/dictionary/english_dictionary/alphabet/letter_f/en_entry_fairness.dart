...
class EnglishEntryfairness extends StatefulWidget {
  const EnglishEntryfairness({super.key});

  @override
  State<EnglishEntryfairness> createState() => _EnglishEntryfairnessState();
}

class _EnglishEntryfairnessState extends State<EnglishEntryfairness> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fairness""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fairness""",
                      // alsoEnglishWord: "also: fairness",
                      britshText: """IpaUK: /ˈfeənəs/""",
                      americanText: """IpaUS: /ˈfernəs/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The fairness of the judicial system is being questioned.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Fairness demanded an equal division of the winnings.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Many people questioned the fairness of the election.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""A tan emphasized the fairness of her hair.""");
  }
...
// With short examples define "fairness", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: دادپەروەری، داد، دادگەری، دادمەندی، پیاوەتی، ویژدان، جوامێری، بێ‌لایەنی، لانەگری، بێ‌غەرەزی،	ڕەنگی کاڵ،	جوانی، ڕندی،	سپێتی، سپی‌بوون
"""),
          const DefinitionKurdish(
              text: """١. (ناو) مامەڵەکردن لەگەڵ خەڵکی بە دادپەروەری"""),
          SentencesRow(
            englishText:
                """The fairness of the judicial system is being questioned.""",
            kurdishText: """دادپەروەری سیستەمی دادگایی پرسیاری لەسەرە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """دادپەروەری دابەشکردنی یەکسانی بردنەوەکانی دەخواست.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fairness
1. Conformity with rules or standards (= equity)
"the judge recognized the fairness of my claim";
 
2. Ability to make judgments free from discrimination or dishonesty (= fair-mindedness, candor [US], candour [Brit, Cdn])
 
3. The property of having a naturally light complexion (= paleness, blondness)
 
4. The quality of being good looking and attractive (= comeliness, loveliness, beauteousness, gorgeousness)
""",
  );
...
const String _videoIdone = 'https://youtu.be/q8y-RLkpsnk?t=';
...
const String _videoIdthree = 'https://youtu.be/kbdJqkKQCzc?t=';
const double _startSecondsthree = 00000000000000000000000000082;
const String _videoIdfour = 'https://youtu.be/K4xWCljHJLE?t=';
const double _startSecondsfour = 000000000000000000000000000232;
const String _videoIdfive = 'https://youtu.be/nuWDXoSe9Vo?t=';
