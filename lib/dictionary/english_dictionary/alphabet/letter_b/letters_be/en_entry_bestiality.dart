...
// blank divider
  ...
  Future<void> speakBestialitys7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBestialitys77"); // DOPSUM: CHANGE TEXT
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  static String myVideoId = "Sv1fDOwyK4s";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  static String myVideoId = "G46n2JMJb48";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 19899, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
      autoPlay: true,
      enableCaption: true,
      loop: true,
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  static String myVideoId = "syKcCOE6Tus";
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  static String myVideoId = "9A2Tqp05LZQ";
