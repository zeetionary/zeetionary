...
// replace EnglishEntryAdopsum - replace speakApathetic

// replace apathetic - /ˌæpəˈθetɪk/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryapathetic extends StatelessWidget {
  // blank divider
  EnglishEntryapathetic({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakApathetic(String languageCode) async {
    // DOPSUM: CHANGE speakApathetic
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("apathetic"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakApathetic1229(String languageCode) async {
    ...
    await flutterTts.speak(
        "The illness made her apathetic and unwilling to meet people."); // DOPSUM: CHANGE TEXT
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "3mdkXtNOiOk";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "mLFTAly2rVc";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "oJ1qQ0ACp-E";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "E9SeECaq30g";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "pa2C6bZpCPc";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "nQHrgadyTpc";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "B7V9KZjm_rs";

  final YoutubePlayerController _controller = YoutubePlayerController(
    initialVideoId: myVideoId,
    flags: const YoutubePlayerFlags(
      startAt: 2169, // DOPSUM: CHANGE IT
      // endAt: 253, // DOPSUM: CHANGE IT
      autoPlay: true,
      enableCaption: true,
      loop: true,
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "YBx7ZT6FIrU";
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  static String myVideoId = "p2LiMTtGrAY";
