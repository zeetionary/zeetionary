...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/JOWHyVC4HDE?t=';
    const double startSecondsend = 0000000000000000000000000007;
    const String videoIdone = 'https://youtu.be/pflucFXDuCU?t=';
    const double startSecondsone = 00000000000000000000000000026;
    const String videoIdtwo = 'https://youtu.be/UFa0_QIzYgU';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/BZbChKzedEk?t=';
    const double startSecondsthree = 000000000000000000000000000545;
    const String videoIdfour = 'https://youtu.be/EHJNGdFll4o?t=';
    const double startSecondsfour = 000000000000000000000000000152;
    const String videoIdfive = 'https://youtu.be/oI_X2cMHNe0?t=';
