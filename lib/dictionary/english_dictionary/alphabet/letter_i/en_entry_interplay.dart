...
class EnglishEntryinterplay extends StatefulWidget {
  const EnglishEntryinterplay({super.key});

  @override
  State<EnglishEntryinterplay> createState() => _EnglishEntryinterplayState();
}

class _EnglishEntryinterplayState extends State<EnglishEntryinterplay> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""interplay""");
  }
