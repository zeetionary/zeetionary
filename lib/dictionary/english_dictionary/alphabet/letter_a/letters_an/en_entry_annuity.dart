...
class EnglishEntryannuity extends StatefulWidget {
  const EnglishEntryannuity({super.key});

  @override
  State<EnglishEntryannuity> createState() => _EnglishEntryannuityState();
}

class _EnglishEntryannuityState extends State<EnglishEntryannuity> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Widget build(BuildContext context) {
    const String videoIdend = '98ikQoTblnw';
    const double startSecondsend = 16;
    const String videoIdone = 'HHxvfj2ys0A';
    const double startSecondsone = 7;
    const String videoIdtwo = 'lW36jYkv0lM';
    const double startSecondstwo = 22;
    const String videoIdthree = 'DE9QA-nbkUo';
    const double startSecondsthree = 351;
    const String videoIdfour = 'wN8f7KEi5ys';
    const double startSecondsfour = 51;
    const String videoIdfive = '_k1QWDKnAhI';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """annuity""",
                      // alsoEnglishWord: "also: annuity",
                      britshText: """IpaUK: /əˈnjuːəti/""",
                      americanText: """IpaUS: /əˈnuːəti/""",
