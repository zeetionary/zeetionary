...
class EnglishEntryflatter extends StatefulWidget {
  const EnglishEntryflatter({super.key});

  @override
  State<EnglishEntryflatter> createState() => _EnglishEntryflatterState();
}

class _EnglishEntryflatterState extends State<EnglishEntryflatter> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: flatter (Derived forms: flattered, flattering, flatters)
1. Praise or compliment someone, esp. insincerely or to win favour (= blandish)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flatter""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Are you trying to flatter me?""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""That colour doesn't flatter many people.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flatter""",
                      // alsoEnglishWord: "also: flatter",
                      britshText: """IpaUK: /ˈflætə(r)/""",
                      americanText: """IpaUS: /ˈflætər/""",
...
// With short examples define "flatter", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Are you trying to flatter me?""",
                      kurdishText: """هەوڵی پیاهەڵدانم دەدەیت؟.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I knew he was only flattering me because he wanted to borrow some money.""",
                      kurdishText:
                          """دەزانم تەنها ستایشی درۆینەی دەکردم چونکە دەیویست هەندێک پارە قەرز بکات.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I had thought I was quite good with tricky people but perhaps I flatter myself.""",
                      kurdishText:
                          """وام دەزانی لە مامەڵەکردن لەگەڵ کەسانی تەڵەکەبازدا باشم، بەڵام لەوانەیە خۆم هەڵخەڵەتاندبێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ئەو ڕەنگە ئەوە نییە بە زۆر کەس بکەوێت.""",
...
const String _videoIdtwo = 'https://youtu.be/IlU-zDU6aQ0?t=';
const double _startSecondstwo = 0000000000000000000000000002414;
const String _videoIdthree = 'https://youtu.be/yifZtA3uF-E?t=';
const double _startSecondsthree = 00000000000000000000000000086;
const String _videoIdfour = 'https://youtu.be/R1XDuS8680M?t=';
const double _startSecondsfour = 000000000000000000000000000542;
const String _videoIdfive = 'https://youtu.be/CMKw77fbkOs?t=';
const double _startSecondsfive = 00000000000000000000000000016;
