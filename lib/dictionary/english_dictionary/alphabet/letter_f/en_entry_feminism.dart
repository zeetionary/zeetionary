...
class EnglishEntryfeminism extends StatefulWidget {
  const EnglishEntryfeminism({super.key});

  @override
  State<EnglishEntryfeminism> createState() => _EnglishEntryfeminismState();
}

class _EnglishEntryfeminismState extends State<EnglishEntryfeminism> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""feminism""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She had a lifelong commitment to feminism.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """feminism""",
                      // alsoEnglishWord: "also: feminism",
                      britshText: """IpaUK: /ˈfemənɪzəm/""",
                      americanText: """IpaUS: /ˈfemənɪzəm/""",
...
const String _videoIdend = 'https://youtu.be/hOUGNGWmN0k?t=';
const double _startSecondsend = 000000000000000000000000000859;
const String _videoIdone = 'https://youtu.be/DEFD9TSHg_A?t=';
const double _startSecondsone = 000000000000000000000000000190;
const String _videoIdtwo = 'https://youtu.be/D6Nt0JFM3_A?t=';
const double _startSecondstwo = 000000000000000000000000000695;
const String _videoIdthree = 'https://youtu.be/E37swnRU2fs?t=';
const double _startSecondsthree = 00000000000000000000000000052;
const String _videoIdfour = 'https://youtu.be/wVS5BMH-Fu4?t=';
const double _startSecondsfour = 000000000000000000000000000187;
const String _videoIdfive = 'https://youtu.be/UeRa9bEhgXg?t=';
const double _startSecondsfive = 0000000000000000000000000001269;
