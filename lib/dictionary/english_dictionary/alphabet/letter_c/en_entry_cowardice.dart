...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakcowardices1(String languageCode) async {
    ...
    await flutterTts.speak(
        "// speakcowardices111111111111111111111111111111111"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakcowardices2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakcowardices200"); // DOPSUM: CHANGE TEXT
  }
                ...
                child: Column(
                  children: [
                    ExampleSentenceEnglish(
                        text:
                            "// speakcowardices111111111111111111111111111111111"),
