...
class EnglishEntryexpressiveness extends StatefulWidget {
  const EnglishEntryexpressiveness({super.key});

  @override
  State<EnglishEntryexpressiveness> createState() =>
      _EnglishEntryexpressivenessState();
}

class _EnglishEntryexpressivenessState
    extends State<EnglishEntryexpressiveness> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""expressiveness""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """expressiveness""",
                      // alsoEnglishWord: "also: expressiveness",
                      britshText: """IpaUK: /ɪkˈspresɪvnəs/""",
                      americanText: """IpaUS: /ɪkˈspresɪvnəs/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "expressiveness";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The expressiveness of his eyes is remarkable.""");
  }
...
"""),
          ...
          SentencesRow(
            englishText:
                """People remarked on the expressiveness of her face and hands.""",
            kurdishText:
                """خەڵکی لێدوانیان دا لەسەر دەربڕیی ڕووخسار و دەستەکانی.""",
...
const String _videoIdend = 'https://youtu.be/uBQJ9iYUgoU?t=';
const double _startSecondsend = 000000000000000000000000000210;
const String _videoIdone = 'https://youtu.be/MVYrJJNdrEg?t=';
const double _startSecondsone = 0000000000000000000000000003446;
const String _videoIdtwo = 'https://youtu.be/BEieYcoUqLA?t=';
const double _startSecondstwo = 000000000000000000000000000354;
const String _videoIdthree = 'https://youtu.be/JXYMdxwTf8s?t=';
const double _startSecondsthree = 000000000000000000000000000568;
const String _videoIdfour = 'https://youtu.be/psL_5RIBqnY?t=';
const double _startSecondsfour = 0000000000000000000000000007651;
const String _videoIdfive = 'https://youtu.be/tWmxb9fHyCo?t=';
