...
class EnglishEntryfleck extends StatefulWidget {
  const EnglishEntryfleck({super.key});

  @override
  State<EnglishEntryfleck> createState() => _EnglishEntryfleckState();
}

class _EnglishEntryfleckState extends State<EnglishEntryfleck> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fleck (Derived forms: flecks)
1. A small fragment of something broken off from the whole (= bit, chip, flake, scrap)
"a fleck of rock caught him in the eye";
 
2. A small contrasting part of something (= spot, speckle, dapple, patch, maculation)
"a fleck of red";

- Verb: fleck (Derived forms: flecked, flecking, flecks)
1. Make a spot or mark onto (= spot, blob, blot)
"The wine flecked the tablecloth";
""",
  );

  final String keyword = "fleck";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His hair was dark, with flecks of grey.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her face was covered with flecks of paint.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His hair was flecked with paint.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fleck""",
                      // alsoEnglishWord: "also: fleck",
                      britshText: """IpaUK: /flek/""",
                      americanText: """IpaUS: /flek/""",
...
// With short examples define "fleck", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ناوچەیەکی بچووک کە ڕەنگێکی دیاریکراوی هەیە"""),
                    SentencesRow(
                      englishText:
                          """His hair was dark, with flecks of grey.""",
                      kurdishText: """قژی ڕەش بوو بە بڕێک خۆڵەمێشییەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕووخساری داپۆشرابوو بە وردە خاڵی بۆیە.""",
...
const double _startSecondsend = 0000000000000000000000000001279;
const String _videoIdone = 'https://youtu.be/IesIsKMjB4Y?t=';
const double _startSecondsone = 00000000000000000000000000041;
const String _videoIdtwo = 'https://youtu.be/fjCinn-sjzk?t=';
const double _startSecondstwo = 000000000000000000000000000427;
const String _videoIdthree = 'https://youtu.be/J_n1FZaKzF8?t=';
const double _startSecondsthree = 000000000000000000000000000259;
const String _videoIdfour = 'https://youtu.be/E7uGvsT_nnM?t=';
const double _startSecondsfour = 000000000000000000000000000559;
const String _videoIdfive = 'https://youtu.be/_rBO8neWw04?t=';
const double _startSecondsfive = 0000000000000000000000000001231;
