...
class EnglishEntrylacerate extends StatefulWidget {
  const EnglishEntrylacerate({super.key});

  @override
  State<EnglishEntrylacerate> createState() => _EnglishEntrylacerateState();
}

class _EnglishEntrylacerateState extends State<EnglishEntrylacerate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: lacerate (Derived forms: lacerates, lacerated, lacerating)
...
- Adjective: lacerate
1. Irregularly slashed and jagged as if torn (- lacerated)
"lacerate leaves";
 
2. Having edges that are jagged from injury (- lacerated, mangled, torn)
""",
  );

  final String keyword = "lacerate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lacerate""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His hand had been badly lacerated.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The sharp branches lacerated my bare arms.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/e-WLyv6UBGg?t=939';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/HeJKz1Cc0mc?t=1266';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/UIyfNM6y3vU?t=395';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/UWelcIFAPxE?t=262';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/qNv9QquB_IQ?t=53';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/PhQksV8fbKw?t=2327';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lacerate""",
                      // alsoEnglishWord: "also: lacerate",
                      britshText: """IpaUK: lacerate""",
                      americanText: """IpaUS: lacerate""",
...
کوردی: 
"""),
// With short examples define "lacerate", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) بڕینی پێست یان بەشێکی جەستە بە شتێکی تیژ"""),
                    SentencesRow(
                      englishText: """His hand had been badly lacerated.""",
                      kurdishText: """دەستی هەڵدرابوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لقە تیژەکان دەستی ڕووتمیان کۆڵەوار کرد.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (کردار) ڕەخنەگرتن زۆر بە توندی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Critics have lacerated the press for getting the facts wrong in this case.""",
                      kurdishText:
                          """ڕەخنەگران میدیایان سەرزەنشت کردووە بۆ وەرگرتنی ڕاستییەکان بە هەڵە لەم کەیسەدا.""",
