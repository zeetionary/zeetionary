...
class EnglishEntryfortification extends StatefulWidget {
  const EnglishEntryfortification({super.key});

  @override
  State<EnglishEntryfortification> createState() =>
      _EnglishEntryfortificationState();
}

class _EnglishEntryfortificationState extends State<EnglishEntryfortification> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fortification (Derived forms: fortifications)
1. Defensive structure consisting of walls or mounds built around a stronghold to strengthen it (= munition)
 
2. The art or science of strengthening defences
...
""",
  ...
  final String keyword = "fortification";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fortification""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Some of the old fortifications still exist.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The fortifications of the castle were massive.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fortification""",
                      // alsoEnglishWord: "also: fortification",
                      britshText: """IpaUK: /ˌfɔːtɪfɪˈkeɪʃn/""",
                      americanText: """IpaUS: /ˌfɔːrtɪfɪˈkeɪʃn/""",
...
کوردی: پتەوکردن، سەنگەردانان، قایم‌کاری، توندکردن،	پتەوی، تۆکمەیی، بەهێزکردن، پێزدارکردن، قەڵا، شوورە، خەنەک، کەندەک، خەندەک (بە مەبەستی بەرگری یان پاراستن)
"""),
// With short examples define "fortification", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) شوورایەک، جێگایەکی چەک، هتد کە درووستکراوە بۆ بەرگری لە شوێنێک دژ بە هێرش"""),
                    SentencesRow(
                      englishText:
                          """Some of the old fortifications still exist.""",
                      kurdishText:
                          """هەندێک لە سەنگەردانانە کۆنەکان هێشتا بوونیان هەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The fortifications of the castle were massive.""",
                      kurdishText: """شوورای قەڵاکە زەبەلاح بوون.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/xjmXzYdxuTQ?t=';
const double _startSecondsend = 000000000000000000000000000833;
const String _videoIdone = 'https://youtu.be/HbUGTcdFIio?t=';
const double _startSecondsone = 0000000000000000000000000002445;
const String _videoIdtwo = 'https://youtu.be/tTJeePNgOF8?t=';
const double _startSecondstwo = 000000000000000000000000000568;
const String _videoIdthree = 'https://youtu.be/JAOYywV_gvc?t=';
const double _startSecondsthree = 000000000000000000000000000749;
const String _videoIdfour = 'https://youtu.be/xPGdOXstSyk?t=';
const double _startSecondsfour = 000000000000000000000000000196;
const String _videoIdfive = 'https://youtu.be/ha2mLz-Xdpg?t=';
const double _startSecondsfive = 0000000000000000000000000001215;
