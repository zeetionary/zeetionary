...
class EnglishEntryenvironmentalist extends StatefulWidget {
  const EnglishEntryenvironmentalist({super.key});

  @override
  State<EnglishEntryenvironmentalist> createState() =>
      _EnglishEntryenvironmentalistState();
}

class _EnglishEntryenvironmentalistState
    extends State<EnglishEntryenvironmentalist> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""environmentalist""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: environmentalist",
                      britshText: """IpaUK: /ɪnˌvaɪrənˈmentəlɪst/""",
                      americanText: """IpaUS: /ɪnˌvaɪrənˈmentəlɪst/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "environmentalist";
...
کوردی: ژینگەپارێز،	(دەروون‌ناسی) مەڵبەندخواز، مەڵبەندگەر، مەڵبەندبین
"""),
          const DefinitionKurdish(
              text: """١. (ناو) کەسێک کە گرنگی بە پاراستنی ژینگە دەدات"""),
          SentencesRow(
            englishText:
                """Some environmentalists argue for a return to a pre-industrial society.""",
            kurdishText:
                """هەندێک ژینگەپارێز داوای گەڕانەوە بۆ کۆمەڵگای پێش پیشەسازی.""",
          ...
          SentencesRow(
            englishText:
                """The expansion plans will face fierce resistance from environmentalists.""",
            kurdishText:
                """پلانەکانی بەرفراوانبوون ڕووبەڕووی بەرەنگاری توندی ژینگەدۆستان دەبێتەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: environmentalist (Derived forms: environmentalists)
1. Someone who works to protect the environment from destruction or pollution (= conservationist, eco-warrior [informal])
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/Va_XMMR4R2I?t=';
const double _startSecondsend = 000000000000000000000000000000; // 474;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/GyD8aTwrGo8?t=';
const double _startSecondsone = 00000000000000000000000000000; // 350;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/EgffyL600Zo?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 691;
const String _videoIdthree = 'VIDEOhttps://youtu.be/0RFvMSwh-_0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 82;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/0mpsro3s5pI?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 401;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/DcWqzZ3I2cY?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 3106;
