...
class EnglishEntryfrequently extends StatefulWidget {
  const EnglishEntryfrequently({super.key});

  @override
  State<EnglishEntryfrequently> createState() => _EnglishEntryfrequentlyState();
}

class _EnglishEntryfrequentlyState extends State<EnglishEntryfrequently> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: frequently
1. Many times at short intervals (= often, oftentimes [N. Amer], oft, ofttimes [archaic])
"we frequently met over a cup of coffee";
""",
  );

  final String keyword = "frequently";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frequently""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Buses run frequently between the city and the airport.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was a word he used frequently.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frequently""",
                      // alsoEnglishWord: "also: frequently",
                      britshText: """IpaUK: /ˈfriːkwəntli/""",
                      americanText: """IpaUS: /ˈfriːkwəntli/""",
...
کوردی: زوو زوو، بارها، چەندجاران، بەتیکڕاڕ
"""),
// With short examples define "frequently", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پاسەکان زۆرجار دەچن لە نێوان شارەکە و فڕۆکەخانەکەدا.""",
                    ...
                    SentencesRow(
                      englishText: """It was a word he used frequently.""",
                      kurdishText: """وشەیەک بوو کە زۆرجار بەکاری دەهێنا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/nyf7wNn5fw8?t=';
const double _startSecondsend = 0000000000000000000000000004;
const String _videoIdone = 'https://youtu.be/pFEB0chiuJA?t=';
const double _startSecondsone = 000000000000000000000000000202;
...
const double _startSecondsthree = 0000000000000000000000000001224;
const String _videoIdfour = 'https://youtu.be/NFtQOxjWfaA?t=';
const double _startSecondsfour = 000000000000000000000000000253;
const String _videoIdfive = 'https://youtu.be/WUjVPIEtJd0?t=';
