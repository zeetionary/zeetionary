...
class EnglishEntryindiscriminately extends StatefulWidget {
  ...
  @override
  State<EnglishEntryindiscriminately> createState() => _EnglishEntryindiscriminatelyState();
}

class _EnglishEntryindiscriminatelyState extends State<EnglishEntryindiscriminately> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryindiscriminately indiscriminately
WORD_WEB indiscriminately indiscriminately indiscriminately
haʊʊʊʊʊʊʊ4
""",
  );
