...
class EnglishEntryavenge extends StatelessWidget {
  ...
  Future<void> speakAvenges7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakAvenges7c"); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "avenge", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAvenge(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /əˈvendʒ/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "oMSdFM12hOw";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "mOJkVcXgxpI";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "9TimmdqACAs";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "0hdnQ8EXdEs";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "epi2pDmqygc";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "6EdYzbgScOU";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "L1A9A_shNV0";
