...
class EnglishEntryforgetful extends StatefulWidget {
  const EnglishEntryforgetful({super.key});

  @override
  State<EnglishEntryforgetful> createState() => _EnglishEntryforgetfulState();
}

class _EnglishEntryforgetfulState extends State<EnglishEntryforgetful> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: forgetful
1. Failing to keep in mind (= oblivious)
"forgetful of her responsibilities";
 
2. (of memory) deficient in retentiveness or range (= unretentive, short)
"a forgetful memory";
 
3. Not mindful or attentive (= unmindful, mindless)
"while thus forgetful of his steps he stumbled";
""",
  );

  final String keyword = "forgetful";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forgetful""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She has become very forgetful in recent years.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was soon forgetful of all dangers.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forgetful""",
                      // alsoEnglishWord: "also: forgetful",
                      britshText: """IpaUK: /fəˈɡetfl/""",
                      americanText: """IpaUS: /fərˈɡetfl/""",
...
کوردی: لەبیربەرەوە، فەرامۆش‌کار، کەمیاد، کەم‌هۆش، بێ‌بیر،	کەمتەرخەم، گوێ‌پێنەدەر، نادرەبەست، بێ‌خەیاڵ
"""),
// With short examples define "forgetful", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لەم ساڵانەی دوایی زۆر کەم‌هۆش بووە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """زوو گوێ‌پێنەدەر بوو بە هەموو مەترسییەک.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/joQHh8XzPLU?t=';
const double _startSecondsend = 000000000000000000000000000348;
const String _videoIdone = 'https://youtu.be/ZYoYffXWiwk?t=';
const double _startSecondsone = 000000000000000000000000000174;
const String _videoIdtwo = 'https://youtu.be/K4LpIMvi-8Q?t=';
const double _startSecondstwo = 0000000000000000000000000001589;
const String _videoIdthree = 'https://youtu.be/Swg05Gv0wMU?t=';
const double _startSecondsthree = 000000000000000000000000000408;
const String _videoIdfour = 'https://youtu.be/ynQOgG7B8Ck?t=';
const double _startSecondsfour = 000000000000000000000000000193;
const String _videoIdfive = 'https://youtu.be/H0KtItvB7QY?t=';
const double _startSecondsfive = 000000000000000000000000000449;
