...
class EnglishEntryhousework extends StatefulWidget {
  const EnglishEntryhousework({super.key});

  @override
  State<EnglishEntryhousework> createState() => _EnglishEntryhouseworkState();
}

class _EnglishEntryhouseworkState extends State<EnglishEntryhousework> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: housework (Derived forms: houseworks)
1. The work of cleaning and running a house (- housekeeping)
""",
  );

  final String keyword = "housework";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""housework""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He does his fair share of housework.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Do your kids help with the housework?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The doctor said I could do a little light housework.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They share the housework equally.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/I0y4ArySalk?t=';
    const double startSecondsend = 000000000000000000000000000213;
    const String videoIdone = 'https://youtu.be/HjgSBJdtrcc?t=';
    const double startSecondsone = 000000000000000000000000000551;
    const String videoIdtwo = 'https://youtu.be/DgwZebuIiXc?t=';
    const double startSecondstwo = 00000000000000000000000000089;
    const String videoIdthree = 'https://youtu.be/E7oEq6CE78g?t=';
    const double startSecondsthree = 0000000000000000000000000001059;
    const String videoIdfour = 'https://youtu.be/TKhVE-pP7hA?t=';
    const double startSecondsfour = 000000000000000000000000000427;
    const String videoIdfive = 'https://youtu.be/Yl0m3pm5SCo?t=';
    const double startSecondsfive = 000000000000000000000000000131;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """housework""",
                      // alsoEnglishWord: "also: housework",
                      britshText: """IpaUK: /ˈhaʊswɜːk/""",
                      americanText: """IpaUS: /ˈhaʊswɜːrk/""",
...
// With short examples define "housework", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """He does his fair share of housework.""",
                      kurdishText: """بەشی هاوبەشی خۆی بۆ کاری ماڵەوە دەکات.""",
                    ...
                    SentencesRow(
                      englishText: """Do your kids help with the housework?""",
                      kurdishText:
                          """منداڵەکانت بەژداری لە کاری ماڵەوە دەکەن؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پزیشکەکە گوتی کە دەتوانم چەند کارێکی سووکی ماڵەوە بکەم.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They share the housework equally.""",
                      kurdishText: """کاری ماڵەەو بە ھاوبەشی دەکەن.""",
