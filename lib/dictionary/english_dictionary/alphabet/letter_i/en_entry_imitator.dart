...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'Bj6ulLJGPB8';
    const double startSecondsone = 469;
    const String videoIdtwo = 'bTOkCOKIVeY';
    const double startSecondstwo = 401;
    const String videoIdthree = 'Ma3vLsadGnE';
    const double startSecondsthree = 8;
    const String videoIdfour = 'TSoT0qGT2-o';
    const double startSecondsfour = 9;
    const String videoIdfive = 'uWEooJ_xiyU';
