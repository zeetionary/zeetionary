...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/OP7l1n_8Lh4?t=';
    const double startSecondsend = 000000000000000000000000000426;
    const String videoIdone = 'https://youtu.be/b5fNif_WGdc?t=';
    const double startSecondsone = 00000000000000000000000000079;
    const String videoIdtwo = 'https://youtu.be/6HEheIozS5c?t=';
    const double startSecondstwo = 000000000000000000000000000170;
    const String videoIdthree = 'https://youtu.be/v123rKyXlZ4?t=';
    const double startSecondsthree = 000000000000000000000000000245;
    const String videoIdfour = 'https://youtu.be/at-xZA5U1ps?t=';
    const double startSecondsfour = 000000000000000000000000000204;
    const String videoIdfive = 'https://youtu.be/Hybm--GAgmo?t=';
