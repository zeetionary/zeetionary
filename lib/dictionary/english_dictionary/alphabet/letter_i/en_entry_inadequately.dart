...
class EnglishEntryinadequately extends StatefulWidget {
  const EnglishEntryinadequately({super.key});

  @override
  State<EnglishEntryinadequately> createState() => _EnglishEntryinadequatelyState();
}

class _EnglishEntryinadequatelyState extends State<EnglishEntryinadequately> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inadequately""");
  }
