...
class EnglishEntryheroine extends StatefulWidget {
  const EnglishEntryheroine({super.key});

  @override
  State<EnglishEntryheroine> createState() => _EnglishEntryheroineState();
}

class _EnglishEntryheroineState extends State<EnglishEntryheroine> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heroine (Derived forms: heroines)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heroine""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She remains one of the heroines of the Second World War.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The heroine made her exit to great applause.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The heroine is played by Demi Moore.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Madonna was her teenage heroine.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heroine""",
                      // alsoEnglishWord: "also: heroine",
                      britshText: """IpaUK: /ˈherəʊɪn/""",
                      americanText: """IpaUS: /ˈherəʊɪn/""",
...
کوردی: ژنە قارەمان، پاڵەوان
"""),
// With short examples define "heroine", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ژنە پاڵەوان؛ ژنێک کە زۆر کەس پێی سەرسامن"""),
                    SentencesRow(
                      englishText:
                          """She remains one of the heroines of the Second World War.""",
                      kurdishText:
                          """وەک یەکێک لە ژنە پاڵەوانەکانی دووەم جەنگی جیهانی ماوەتەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ژنە کارەکتەری سەرەکی فیلمێک، ڕۆمانێک، چیرۆکێک، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The heroine made her exit to great applause.""",
                      kurdishText:
                          """ژنە پاڵەوانەکە بە چەپڵەڕێزانی چووە دەرەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ژنە پاڵەوانەکە لەلایەن دێمی موورەوە ڕۆڵی دەبیندرێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) ژنێک کە سەرسامییت بەهۆی خاسیەت یان شارەزایەک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Madonna was her teenage heroine.""",
                      kurdishText: """مادۆنا پاڵەوانی هەرزەکاریی بوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/x629nYBuLpY?t=';
const double _startSecondsend = 00000000000000000000000000028;
const String _videoIdone = 'https://youtu.be/qPUZo3dQSEM?t=';
const double _startSecondsone = 0000000000000000000000000008;
const String _videoIdtwo = 'https://youtu.be/uR3GCIjqIFs?t=';
const double _startSecondstwo = 000000000000000000000000000115;
const String _videoIdthree = 'https://youtu.be/JIGmtnlHFrk?t=';
const double _startSecondsthree = 000000000000000000000000000174;
const String _videoIdfour = 'https://youtu.be/8aICVBnO4Us?t=';
const double _startSecondsfour = 000000000000000000000000000607;
const String _videoIdfive = 'https://youtu.be/tIVoCh6Znfg?t=';
