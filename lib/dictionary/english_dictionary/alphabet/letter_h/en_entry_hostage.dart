...
class EnglishEntryhostage extends StatefulWidget {
  const EnglishEntryhostage({super.key});

  @override
  State<EnglishEntryhostage> createState() => _EnglishEntryhostageState();
}

class _EnglishEntryhostageState extends State<EnglishEntryhostage> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hostage (Derived forms: hostages)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hostage""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The hostages were tied up and blindfolded.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The hostages were treated well by their captors.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He spoke haltingly about his experiences as a hostage.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Eight people were held hostage for four months.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001204;
    const String videoIdone = 'https://youtu.be/tsxmyL7TUJg?t=';
    const double startSecondsone = 000000000000000000000000000615;
    const String videoIdtwo = 'https://youtu.be/lex6USTugUU?t=';
    const double startSecondstwo = 0000000000000000000000000001007;
    const String videoIdthree = 'https://youtu.be/uN84HhcdIws?t=';
    const double startSecondsthree = 0000000000000000000000000001021;
    const String videoIdfour = 'https://youtu.be/FQ4hvLqNfqo?t=';
    const double startSecondsfour = 000000000000000000000000000393;
    const String videoIdfive = 'https://youtu.be/1jm3K9cm3vI?t=';
    const double startSecondsfive = 0000000000000000000000000001194;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hostage""",
                      // alsoEnglishWord: "also: hostage",
                      britshText: """IpaUK: /ˈhɒstɪdʒ/""",
                      americanText: """IpaUS: /ˈhɑːstɪdʒ/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: "بارمتەکان بەسترانەوە و چاوبەستکران.",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە پچڕپچڕەوە قسەی دەکرد لەسەر ئەزموونی وەک بارمتەیەک.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شەش کەس وەک بارمتە ڕاگیران بۆ چوار مانگ.""",
