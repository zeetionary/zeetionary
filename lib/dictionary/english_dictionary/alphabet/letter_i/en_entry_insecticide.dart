...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'ZqdU4KOZvnY';
    const double startSecondsend = 23;
    const String videoIdone = 'RDtN4pndR1E';
    const double startSecondsone = 0;
    const String videoIdtwo = 'cZ3EVLQbA40';
    const double startSecondstwo = 19;
    const String videoIdthree = 'pFmtmO2cnlg';
    const double startSecondsthree = 330;
    const String videoIdfour = 'Yb26BBvAAWU';
    const double startSecondsfour = 139;
    const String videoIdfive = 'ToeWrGTGOOI';
    const double startSecondsfive = 106;
