...
class EnglishEntryensign extends StatefulWidget {
  const EnglishEntryensign({super.key});

  @override
  State<EnglishEntryensign> createState() => _EnglishEntryensignState();
}

class _EnglishEntryensignState extends State<EnglishEntryensign> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ensign""",
                      // alsoEnglishWord: "also: ensign",
                      britshText: """IpaUK: /ˈensən/""",
                      americanText: """IpaUS: /ˈensən/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The ship raised the national ensign before departing.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The ensign led the team during the rescue operation.""");
  }
...
کوردی: ئاڵا، بەیداخ
"""),
          const DefinitionKurdish(text: """١. (ناو) ئاڵای سەر کەشتی"""),
          SentencesRow(
            englishText:
                """The ship raised the national ensign before departing.""",
            kurdishText:
                """کەشتییەکە ئاڵای نیشتیمانی بەرزکردەوە پێش دەرچوون.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ناو) ئەفسەرێکی پلە نزم لە هێزی دەریایی ئەمریکا"""),
          const DividerSentences(),
          SentencesRow(
            englishText:
                """The ensign led the team during the rescue operation.""",
            kurdishText:
                """ئەفسەرە پلە نزمەکە ڕێبەرایەتیی تیمەکەی کرد لە کاتی ئۆپەراسیۆنی ڕزگارکردنەکە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: ensign (Derived forms: ensigns)
1. (military) a person who holds a commissioned rank in the United States Navy or the United States Coast Guard; below lieutenant junior grade
 
2. An emblem flown as a symbol of nationality (= national flag)
 
3. Colours flown by a ship to show its nationality
""",
  );
...
const String _videoIdend = 'https://youtu.be/JLOFZoBJnd8?t=';
const double _startSecondsend = 558;
const String _videoIdone = 'https://youtu.be/cfs3SSNB6rI?t=';
const double _startSecondsone = 825;
const String _videoIdtwo = 'https://youtu.be/H9PlH_n2plw?t=';
const double _startSecondstwo = 633;
const String _videoIdthree = 'https://youtu.be/g-PfD0VO02s?t=';
const double _startSecondsthree = 2650;
const String _videoIdfour = 'https://youtu.be/2UQI-zB7Rwo?t=';
const double _startSecondsfour = 25;
const String _videoIdfive = 'https://youtu.be/rsj5WgebCsA?t=';
const double _startSecondsfive = 59;
const String _videoIdsix = 'https://youtu.be/II7jld-SS84?t=';
const double _startSecondssix = 579;
