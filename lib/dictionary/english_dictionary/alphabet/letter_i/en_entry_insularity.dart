...
class EnglishEntryinsularity extends StatefulWidget {
  const EnglishEntryinsularity({super.key});

  @override
  State<EnglishEntryinsularity> createState() => _EnglishEntryinsularityState();
}

class _EnglishEntryinsularityState extends State<EnglishEntryinsularity> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""insularity""");
  }
