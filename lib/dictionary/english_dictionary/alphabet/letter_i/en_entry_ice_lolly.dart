...
class EnglishEntryicelolly extends StatefulWidget {
  const EnglishEntryicelolly({super.key});

  @override
  State<EnglishEntryicelolly> createState() => _EnglishEntryicelollyState();
}

class _EnglishEntryicelollyState extends State<EnglishEntryicelolly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: ice lolly (Derived forms: ice lollies)
Usage: Brit (N. Amer: popsicle)
1. Ice cream or water ice on a small wooden stick (- lolly [Brit, informal], lollipop, popsicle [N. Amer], icy pole [Austral])
""",
  );

  final String keyword = "ice lolly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ice lolly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She bought an ice lolly to cool down on a hot day.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/NV79A4u328Y?t=';
    const double startSecondsend = 000000000000000000000000000218;
    const String videoIdone = 'https://youtu.be/QF4rR23c2s4?t=';
    const double startSecondsone = 000000000000000000000000000148;
    const String videoIdtwo = 'https://youtu.be/AS77Mnbk8vI?t=';
    const double startSecondstwo = 0000000000000000000000000002621;
    const String videoIdthree = 'https://youtu.be/H9WuNphUX9g?t=';
    const double startSecondsthree = 000000000000000000000000000202;
    const String videoIdfour = 'https://youtu.be/sUVw2OZlGg0?t=';
    const double startSecondsfour = 0000000000000000000000000004751;
    const String videoIdfive = 'https://youtu.be/o1wkftKH7L8?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ice lolly""",
                      // alsoEnglishWord: "also: ice lolly",
                      britshText: """IpaUK: /ˈaɪs lɒli/""",
                      americanText: """IpaUS: /ˈaɪs lɑːli/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پارچە سەهۆڵێکی شیرین کە لەسەر چکڵێکە"""),
                    SentencesRow(
                      englishText:
                          """She bought an ice lolly to cool down on a hot day.""",
                      kurdishText:
                          """چلوورەیەکی کڕی بۆ فێنکبوونەوە لە ڕۆژێکی گەرمدا.""",
