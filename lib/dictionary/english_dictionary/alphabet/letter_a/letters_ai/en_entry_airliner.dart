...
class EnglishEntryairliner extends StatelessWidget {
  EnglishEntryairliner({Key? key}) : super(key: key);
  ...
  Future<void> speakAirliner(String languageCode) async {
    ...
    await flutterTts.speak("airliner"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAirliner3522(String languageCode) async {
    ...
    await flutterTts.speak(
        "The airliner was hijacked by a group of terrorists."); // DOPSUM: CHANGE TEXT
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'JONkLEx6zeE';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'TYJ8uoJ7DAk';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'msCVVkTSSqQ';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'pQXaFzx6Xuc';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'YEyZqs4Fg-o';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'gM_RmOuz7wQ';
