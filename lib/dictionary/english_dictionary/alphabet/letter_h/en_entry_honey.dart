...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'https://youtu.be/nRafaCcfrcI?t=';
    const double startSecondstwo = 000000000000000000000000000231;
    const String videoIdthree = 'https://youtu.be/KJy7T24rhg0?t=';
    const double startSecondsthree = 000000000000000000000000000371;
    const String videoIdfour = 'https://youtu.be/lYu1ysDULwA?t=';
    const double startSecondsfour = 000000000000000000000000000136;
    const String videoIdfive = 'https://youtu.be/kHrjgWoy8qY?t=';
