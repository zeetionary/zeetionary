...
class EnglishEntrygoody extends StatefulWidget {
  const EnglishEntrygoody({super.key});

  @override
  State<EnglishEntrygoody> createState() => _EnglishEntrygoodyState();
}

class _EnglishEntrygoodyState extends State<EnglishEntrygoody> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """goody""",
                      // alsoEnglishWord: "also: goody",
                      britshText: """IpaUK: /ˈɡʊdi/""",
                      americanText: """IpaUS: /ˈɡʊdi/""",
...
// With short examples define "goody", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هەر شتێک کە خەڵکی دەیانەوێت، بە تایبەتی شتێک کە زۆر خۆشە بۆ خواردن"""),
                    SentencesRow(
                      englishText:
                          """All the children were given a bag of goodies - mostly sweets and toys.""",
                      kurdishText:
                          """هەموو منداڵەکان کیسەیەک شتی خۆشیان پێدرا - زۆربەی شیرینی و یاری بوون.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It's sometimes difficult to tell who are the goodies and who are the baddies.""",
                      kurdishText:
                          """هەندێک جار زەحمەتە بزانرێت کێ باشەکانن و کێ خراپەکان.""",
...
const String _videoIdone = 'https://youtu.be/G1FLUuDKRYI?t=';
const double _startSecondsone = 000000000000000000000000000734;
const String _videoIdtwo = 'https://youtu.be/N3-akAxrlIc';
const double _startSecondstwo = 0;
const String _videoIdthree = 'https://youtu.be/9uH8-Gj8XrM?t=';
const double _startSecondsthree = 000000000000000000000000000161;
const String _videoIdfour = 'https://youtu.be/j0iOuOMh_JE?t=';
const double _startSecondsfour = 000000000000000000000000000823;
const String _videoIdfive = 'https://youtu.be/KXsRrXvqRro?t=';
