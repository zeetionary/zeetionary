...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/S3ksC_8jGuc?t=';
    const double startSecondsone = 000000000000000000000000000454;
    const String videoIdtwo = 'https://youtu.be/Bbi0kEaTgio?t=';
    const double startSecondstwo = 000000000000000000000000000366;
    const String videoIdthree = 'https://youtu.be/LwZIxGAG8xA?t=';
    const double startSecondsthree = 00000000000000000000000000090;
    const String videoIdfour = 'https://youtu.be/g1gj65PLt_0?t=';
    const double startSecondsfour = 00000000000000000000000000077;
    const String videoIdfive = 'https://youtu.be/THIGSnMP3io?t=';
    const double startSecondsfive = 0000000000000000000000000001503;
