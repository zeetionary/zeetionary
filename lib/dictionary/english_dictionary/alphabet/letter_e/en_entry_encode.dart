...
class EnglishEntryencode extends StatefulWidget {
  const EnglishEntryencode({super.key});

  @override
  State<EnglishEntryencode> createState() => _EnglishEntryencodeState();
}

class _EnglishEntryencodeState extends State<EnglishEntryencode> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "encode",
                      // alsoEnglishWord: "also: encode",
                      britshText: "IpaUK: /ɪnˈkəʊd/",
                      americanText: "IpaUS: /ɪnˈkəʊd/",
...
// """),
          const DefinitionKurdish(
              text:
                  """١. (کردار) گۆڕین بۆ کۆد بۆ ئەوەی ببێت بە نهێنی؛ ناردنی زانیاری بە شێوەیەک کە کۆمپیوتەر بیخوێنێتەوە"""),
          SentencesRow(
            englishText:
                """Many satellite broadcasts are encoded so that they can only be received by people who have paid to see them.""",
            kurdishText:
                """زۆر پەخشی سەتەلایت دەکرێن بە کۆد بۆ ئەوەی تەنها ئەو بتوانن بیان بینن کە پارەیان بۆی داوە.""",
// With short examples define "encode", please follow LX instructions
          ...
          const DefinitionKurdish(
              text:
                  """٢. (کردار) هەبوونی ئەرکی درووستکردنی پڕۆتینێکی تایبەت"""),
          // const DividerSentences(),
          SentencesRow(
            englishText:
                """These genes encode proteins that play essential roles in cell physiology.""",
            kurdishText:
                """جینەکان ئەو پڕۆتینانە درووست دەکەن کە ڕۆڵی سەرەکی گرنگ دەبینن لە کارئەندامزانیی خانە.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """زانیاریی ڕێزمان یارمەتیی فێرخوازان دەدات کە ڕستە درووست بکەن.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: encode (Derived forms: encoding, encodes, encoded)
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/AqkMykYQ7eU?t=';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/WZ256UU8xJ0?t=';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/RRuovINxpPc?t=';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/Y2VlTpe4srk?t=';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/LXkO4HdQXdo?t=';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/1PQCAOLpPTg?t=';
