...
// Define the word "belong to" and provide five simple example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings or more.

// replace belong to - replace EnglishEntrybelongto

// replace speakBelongto - /bɪˈlɒŋ tə/

enum TtsState { playing }

class EnglishEntrybelongto extends StatelessWidget {
// blank divider
  EnglishEntrybelongto({super.key});
// blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakbelongto(String languageCode) async {
    // DOPSUM: CHANGE speakBelongto
  ...
  Future<void> speakbelongtos1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Who does this watch belong to?");
  }
  ...
  Future<void> speakbelongtos2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The islands belong to Spain.");
  }
  ...
  Future<void> speakbelongtos4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Have you ever belonged to a political party?");
  }
  ...
  Future<void> speakbelongtos5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Lions and tigers belong to the cat family.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "belong to"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /bɪˈlɒŋ tə/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakbelongto("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /bɪˈlɔːŋ tə/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakbelongto("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final double _startSeconds = 1917;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'O2mURzlsivY';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'AVYfyTvc9KY';
  final double _startSeconds = 5101;
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = 'eqCHNY1wlJo';
...
// end belong to// TODO Implement this library.
