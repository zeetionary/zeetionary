...
class EnglishEntryfieldmarshal extends StatefulWidget {
  const EnglishEntryfieldmarshal({super.key});

  @override
  State<EnglishEntryfieldmarshal> createState() =>
      _EnglishEntryfieldmarshalState();
}

class _EnglishEntryfieldmarshalState extends State<EnglishEntryfieldmarshal> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "field marshal";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""field marshal""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Yes, Field Marshal.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """field marshal""",
                      // alsoEnglishWord: "also: field marshal",
                      britshText: """IpaUK: /ˈfiːld mɑːʃl/""",
                      americanText: """IpaUS: /ˈfiːld mɑːrʃl/""",
...
const String _videoIdend = 'https://youtu.be/3HrDf6nra-I?t=';
const double _startSecondsend = 000000000000000000000000000417;
const String _videoIdone = 'https://youtu.be/SgiXLwTAyXU?t=';
const double _startSecondsone = 000000000000000000000000000113;
const String _videoIdtwo = 'https://youtu.be/WrKwysaZIww?t=';
const double _startSecondstwo = 000000000000000000000000000565;
const String _videoIdthree = 'https://youtu.be/PI2HmOuzOBk?t=';
const double _startSecondsthree = 0000000000000000000000000009;
const String _videoIdfour = 'https://youtu.be/CJo3aRHOh6o?t=';
const double _startSecondsfour = 000000000000000000000000000128;
const String _videoIdfive = 'https://youtu.be/-sbmgOiQWjc?t=';
const double _startSecondsfive = 000000000000000000000000000952;
