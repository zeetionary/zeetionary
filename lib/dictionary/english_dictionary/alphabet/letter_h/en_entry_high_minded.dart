...
class EnglishEntryhighminded extends StatefulWidget {
  const EnglishEntryhighminded({super.key});

  @override
  State<EnglishEntryhighminded> createState() => _EnglishEntryhighmindedState();
}

class _EnglishEntryhighmindedState extends State<EnglishEntryhighminded> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: high-minded
1. Of high moral or intellectual value; elevated in nature or style (- exalted, elevated, sublime, grand, high-flown, lofty, rarefied, rarified, idealistic, noble-minded)
""",
  );

  final String keyword = "high-minded";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""high-minded""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I don't believe any of their motives are as high-minded as they pretend.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """high-minded""",
                      // alsoEnglishWord: "also: high-minded",
                      britshText: """IpaUK: /ˌhaɪ ˈmaɪndɪd/""",
                      americanText: """IpaUS: /ˌhaɪ ˈmaɪndɪd/""",
...
کوردی: 
"""),
// With short examples define "high-minded", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) هەبوونی بەهای ئەخلاقی بەهێز"""),
                    SentencesRow(
                      englishText: """I don't believe any of their motives are as high-minded as they pretend.""",
                      kurdishText: """پێموانییە هیچ یەک لە پاڵنەرەکانیان هێندە ئەخلاقی بن کە وەها پیشانی دەدەن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/EHrrjQ-zVO0?t=';
const double _startSecondsend = 00000000000000000000000000052;
const String _videoIdone = 'https://youtu.be/_ilrMO0kjzg?t=';
const double _startSecondsone = 000000000000000000000000000744;
const String _videoIdtwo = 'https://youtu.be/HIk-nRAvmg4?t=';
const double _startSecondstwo = 000000000000000000000000000531;
const String _videoIdthree = 'https://youtu.be/FXRhteOcHj4?t=';
const double _startSecondsthree = 0000000000000000000000000002258;
const String _videoIdfour = 'https://youtu.be/rW4XFiHUQAs?t=';
const double _startSecondsfour = 000000000000000000000000000179;
const String _videoIdfive = 'https://youtu.be/ubSZAnXQYOQ?t=';
