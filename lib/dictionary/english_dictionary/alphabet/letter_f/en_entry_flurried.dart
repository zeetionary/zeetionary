...
class EnglishEntryflurried extends StatefulWidget {
  const EnglishEntryflurried({super.key});

  @override
  State<EnglishEntryflurried> createState() => _EnglishEntryflurriedState();
}

class _EnglishEntryflurriedState extends State<EnglishEntryflurried> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: flurried
1. Nervous and confused, especially because there is too much to do
""",
  );

  final String keyword = "flurried";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flurried""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flurried""",
                      // alsoEnglishWord: "also: flurried",
                      britshText: """IpaUK: /ˈflʌrid/""",
                      americanText: """IpaUS: /ˈflɜːrid/""",
...
// With short examples define "flurried", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) شڵەژاو و سەرلێشێواو، بە تایبەتی بەهۆی ئەوەی شتی زۆر هەیە بیکەیت"""),
                    SentencesRow(
                      englishText:
                          """She hoped he wouldn’t notice her pink cheeks and flurried manner.""",
                      kurdishText:
                          """بەهیوا بوو کە کوڕەکە تێبینی گۆنا پەمەیی و هەڵسوکەوتە پەشۆکاوییەکەی نەکات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/pTNo_5T-P14?t=';
const double _startSecondsend = 0000000000000000000000000002233;
const String _videoIdone = 'https://youtu.be/Kj5YYTaNT1g?t=';
const double _startSecondsone = 0000000000000000000000000001156;
const String _videoIdtwo = 'https://youtu.be/4__zR10Q0N0?t=';
const double _startSecondstwo = 000000000000000000000000000973;
const String _videoIdthree = 'https://youtu.be/O1TtrIC4-Vo?t=';
const double _startSecondsthree = 0;
const String _videoIdfour = 'https://youtu.be/h9550qKGiZo?t=';
const double _startSecondsfour = 00000000000000000000000000025255;
const String _videoIdfive = 'https://youtu.be/TKMN6oERDD8?t=';
const double _startSecondsfive = 0000000000000000000000000001185;
