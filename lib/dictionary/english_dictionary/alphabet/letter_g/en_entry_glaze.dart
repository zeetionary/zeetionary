...
class EnglishEntryglaze extends StatefulWidget {
  const EnglishEntryglaze({super.key});

  @override
  State<EnglishEntryglaze> createState() => _EnglishEntryglazeState();
}

class _EnglishEntryglazeState extends State<EnglishEntryglaze> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Glaze the pastry with beaten egg.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Brush the top of the cake with the apricot glaze.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """glaze""",
                      // alsoEnglishWord: "also: glaze",
                      britshText: """IpaUK: /ɡleɪz/""",
                      americanText: """IpaUS: /ɡleɪz/""",
...
// With short examples define "glaze", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """A lot of people's eyes glaze over if you say you are a feminist.""",
                      kurdishText:
                          """زۆر کەس چاویان بەوە هەڵنایە کە بڵێیت فێمینیستم.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) ئەوەی کە وابکەیت ڕوویەک بدرەوشێتەوە بەوەی مادەیەکی شلی بەسەردا بکەیت و گەرمی بکەیت یان جێیبهێڵیت بۆ ئەوەی وشک ببێتەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Glaze the pastry with beaten egg.""",
                      kurdishText: """هەویرەکە بە هێلکەی تێکدراو چەور بکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The house is nearly finished but it hasn't been glazed yet.""",
                      kurdishText:
                          """خانووەکە بەنزیکەیی هەموو کەلوپەلی ناوماڵی تێدا دانراوە بەڵام هێشتا شووشەی پەنجەرەی نییە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ناو) مادەیەکی شلە کە لە هێلکە، شیر، یان شەکر پێکهاتووە و ڕووی کێک، نان، هتد ـی پێ چەور دەکرێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Brush the top of the cake with the apricot glaze.""",
                      kurdishText: """سەرەوەی کێکە بە شلەی قەیسی چەور بکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/n4bucphC9r4?t=';
const double _startSecondsend = 000000000000000000000000000323;
...
const double _startSecondstwo = 0000000000000000000000000001157;
const String _videoIdthree = 'https://youtu.be/kElsSj8hky4?t=';
const double _startSecondsthree = 000000000000000000000000000312;
const String _videoIdfour = 'https://youtu.be/0n89GZvmeXI?t=';
const double _startSecondsfour = 00000000000000000000000000074;
const String _videoIdfive = 'https://youtu.be/hQT7PN4Tzsg?t=';
