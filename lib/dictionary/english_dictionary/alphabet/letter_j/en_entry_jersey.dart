...
class EnglishEntryjersey extends StatefulWidget {
  const EnglishEntryjersey({super.key});

  @override
  State<EnglishEntryjersey> createState() => _EnglishEntryjerseyState();
}

class _EnglishEntryjerseyState extends State<EnglishEntryjersey> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: jersey (Derived forms: jerseys)
1. A slightly elastic machine-knit fabric
 
2. A crocheted or knitted garment covering the upper part of the body (- sweater [Brit], jumper [Brit])
""",
  );

  final String keyword = "jersey";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Each player gets a new football jersey every season.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She wore a soft jersey to stay warm.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/Uo58B6rYVQU?t=152';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/pJBRqespiOA?t=116';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/kjulGt3rolY?t=367';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/We5mxT5f43E?t=352';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/rHsczN-G3JM?t=674';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/SdXeOjrHDRE?t=802';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """jersey""",
                      // alsoEnglishWord: "also: jersey",
                      britshText: """IpaUK: /ˈdʒɜːzi/""",
                      americanText: """IpaUS: /ˈdʒɜːrzi/""",
...
کوردی: 
"""),
// With short examples define "jersey", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) فانیلەیەک کە کەسێک لەبەری دەکات کەوا یارییەکی وەرزشی دەکات"""),
                    SentencesRow(
                      englishText:
                          """Each player gets a new football jersey every season.""",
                      kurdishText:
                          """هەموو یاریزانێک هەت وەرزێک فانیلەیەکی تازە وەردەگرێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) فانیلەیەکی چندراو کە لە خوری یان لۆکە درووستکراوە، قۆڵی درێژی هەیە و دووگمەی نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She wore a soft jersey to stay warm.""",
                      kurdishText:
                          """فانیلەیەکی نەرمی لەبەر کرد بۆ مانەوە بە گەرمی.""",
