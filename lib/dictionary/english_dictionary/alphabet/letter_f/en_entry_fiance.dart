...
class EnglishEntryfiance extends StatefulWidget {
  const EnglishEntryfiance({super.key});

  @override
  State<EnglishEntryfiance> createState() => _EnglishEntryfianceState();
}

class _EnglishEntryfianceState extends State<EnglishEntryfiance> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Linda and her fiancé were there.""");
  }
...
کوردی: 
"""),
// With short examples define "fiancé", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەو پیاوەی کە کەسێک لێی مارەبڕدراوە"""),
                    SentencesRow(
                      englishText: """Linda and her fiancé were there.""",
                      kurdishText: """لیندا و دەزگیرانەکەی لەوێ بوون.""",
...
const double _startSecondsend = 0000000000000000000000000001173;
const String _videoIdone = 'https://youtu.be/V1PABydQ668?t=';
const double _startSecondsone = 000000000000000000000000000128;
const String _videoIdtwo = 'https://youtu.be/KhBxCx11eck?t=';
const double _startSecondstwo = 000000000000000000000000000360;
const String _videoIdthree = 'https://youtu.be/NICir0cWsEY?t=';
const double _startSecondsthree = 000000000000000000000000000598;
const String _videoIdfour = 'https://youtu.be/YVRmfWT84ME?t=';
const double _startSecondsfour = 00000000000000000000000000043;
const String _videoIdfive = 'https://youtu.be/jbZzOlG7H6w?t=';
