...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'NDf6hg2HS3w';
    const double startSecondsend = 76;
    const String videoIdone = '5o3KtecMN4Y';
    const double startSecondsone = 383;
    const String videoIdtwo = '6MHepIWVzIo';
    const double startSecondstwo = 1278;
    const String videoIdthree = '9ZZQX1MJjp0';
    const double startSecondsthree = 88;
    const String videoIdfour = 'IisS64k9RM4';
    const double startSecondsfour = 352;
    const String videoIdfive = 'opXFR6ab214';
