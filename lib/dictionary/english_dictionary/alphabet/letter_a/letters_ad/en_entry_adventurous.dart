...
class EnglishEntryadventurous extends StatelessWidget {
  EnglishEntryadventurous({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "adventurous", // DOPSUM: CHANGE WORD ENTRY - Find /ədˈventʃərəs/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ədˈventʃərəs/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = '3boMRfx6cjE';
