...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/_iz5_DuY_II?t=';
    const double startSecondsend = 000000000000000000000000000458;
    const String videoIdone = 'https://youtu.be/UG61a5vjxuI?t=';
    const double startSecondsone = 000000000000000000000000000331;
    const String videoIdtwo = 'https://youtu.be/EmT0i0xG6zg?t=';
    const double startSecondstwo = 0000000000000000000000000002396;
    const String videoIdthree = 'https://youtu.be/KDGJmzqvKTg?t=';
    const double startSecondsthree = 00000000000000000000000000074;
    const String videoIdfour = 'https://youtu.be/wfUJvB3YZq0?t=';
    const double startSecondsfour = 000000000000000000000000000410;
    const String videoIdfive = 'https://youtu.be/umWOkozTejI?t=';
    const double startSecondsfive = 0000000000000000000000000001059;
