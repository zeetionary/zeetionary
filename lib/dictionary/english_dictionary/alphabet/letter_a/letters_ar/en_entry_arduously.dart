...
class EnglishEntryarduously extends StatelessWidget {
  ...
  Future<void> speakarduously(String languageCode) async {
    ...
    await flutterTts.speak("arduously");
  }
  ...
  Future<void> speakarduously715(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("They searched arduously for clues.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arduously"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɑːdʒuəsli/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrdʒuəsli/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final double _startSeconds = 20683;
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'CmRfj2fFw-8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = '7QOTexnD-NE';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '3tbwCS5SNgw';
  final double _startSeconds = 4693;
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'HqOoqBEIM5I';
  final double _startSeconds = 8686;
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'ylOpide9dus';
