...
// replace these: replace EnglishEntryalcohol - replace speakAlcohol - replace alcohol - /ˈælkəhɒl/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryalcohol extends StatelessWidget {
  EnglishEntryalcohol({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAlcohol(String languageCode) async {
    // DOPSUM: CHANGE speakAlcohol
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "alcohol", // DOPSUM: CHANGE WORD ENTRY - Find /ˈælkəhɒl/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              "IpaUK: /ˈælkəhɒl/", // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAlcohol(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              "IpaUS: /ˈælkəhɔːl/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '73iY6R_3nts';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '_SmZpuF13o4';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'O3i7PMfGWYU';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = 'azxCUOE6srI';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'nvXiPz4y_Ts';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'lcssRU5G9Gk';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'bz82dn5cvBE';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = 'GsJpF0edPxw';
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = 'Kn64M4ZIDvk';
