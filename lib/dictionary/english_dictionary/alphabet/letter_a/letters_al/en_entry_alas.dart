...
class EnglishEntryalas extends StatefulWidget {
  const EnglishEntryalas({super.key});

  @override
  State<EnglishEntryalas> createState() => _EnglishEntryalasState();
}

class _EnglishEntryalasState extends State<EnglishEntryalas> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakalas2569(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("For many people, alas, hunger is part of everyday life.");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'LqU9CdPs6ek';
    const double startSecondstwo = 565;
    const String videoIdthree = '6DYgImG1CKo';
    const double startSecondsthree = 249;
    const String videoIdfour = 'PoNCG3PZKII';
    const double startSecondsfour = 931;
    const String videoIdfive = '7Vm282YvOGw';
    const double startSecondsfive = 1333;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """alas""",
                      // alsoEnglishWord: "also: alas",
                      britshText: """IpaUK: /əˈlæs/""",
                      americanText: """IpaUS: /əˈlæs/""",
