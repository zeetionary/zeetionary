...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 182;
    const String videoIdone = 'tnzz-eFmKaw';
    const double startSecondsone = 188;
    const String videoIdtwo = '_Z0ZQT0FttM';
    const double startSecondstwo = 1205;
    const String videoIdthree = 'wizgxRBfVTY';
    const double startSecondsthree = 159;
    const String videoIdfour = 'DA2ukcfd9Vo';
    const double startSecondsfour = 3;
    const String videoIdfive = '4FSKz0-a-qQ';
