...
class EnglishEntryensemble extends StatefulWidget {
  const EnglishEntryensemble({super.key});

  @override
  State<EnglishEntryensemble> createState() => _EnglishEntryensembleState();
}

class _EnglishEntryensembleState extends State<EnglishEntryensemble> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""ensemble""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """ensemble""",
                      // alsoEnglishWord: "also: ensemble",
                      britshText: """IpaUK: /ɒnˈsɒmbl/""",
                      americanText: """IpaUS: /ɑːnˈsɑːmbl/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The ensemble is/are based in Lyons.""");
  }
...
کوردی: (لە فەڕەنسەوە) تیپی مۆسیقا،	تیپی هەڵپەڕکێ،	دەستەی ئەکتەران،	تیپی مۆسیقاژەنان،	کۆمەڵە، دەستە؛ دەستە جل (پێکەوە دەپۆشرێن)،	پێکەوە، هەموو، گشت، تێکڕا،	یەکێتی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) گرووپێکی بچووک لە میوزیکژەن، سەماکەر، و ئەکتەر کە پێکەوە کار دەکەن"""),
          SentencesRow(
            englishText: """The ensemble is/are based in Lyons.""",
            kurdishText: """تیپەکە لە لیۆنن.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """جووتێک پێڵاوی پەمەیی دەستە جلە ناوازەکەی تەواو کرد.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: ensemble (Derived forms: ensembles)
1. A group of musicians playing or singing together
"a string ensemble"
 
2. A cast other than the principals (= supporting players)
 
3. The chorus of a ballet company (= corps de ballet)
 
4. (art) an assemblage of parts or details (as in a work of art) considered as forming a whole (= tout ensemble)
...
const double _startSecondsend = 1367;
const String _videoIdone = 'https://youtu.be/HxRUuGqqMG4?t=';
const double _startSecondsone = 1477;
...
const String _videoIdfour = 'https://youtu.be/b5fNif_WGdc?t=';
const double _startSecondsfour = 674;
const String _videoIdfive = 'https://youtu.be/C1oxhniG_Fc?t=';
const double _startSecondsfive = 1131;
const String _videoIdsix = 'https://youtu.be/lEgPVrSZa6w?t=';
