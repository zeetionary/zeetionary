...
class EnglishEntryhenna extends StatefulWidget {
  const EnglishEntryhenna({super.key});

  @override
  State<EnglishEntryhenna> createState() => _EnglishEntryhennaState();
}

class _EnglishEntryhennaState extends State<EnglishEntryhenna> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: henna (Derived forms: hennas)
1. A reddish brown dye used especially on hair

- Verb: henna (Derived forms: hennas, hennaing, hennaed)
1. Apply henna to one's hair
"She hennas her hair every month"
""",
  );

  final String keyword = "henna";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Is her hair hennaed or is that a natural red?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """henna""",
                      // alsoEnglishWord: "also: henna",
                      britshText: """IpaUK: /ˈhenə/""",
                      americanText: """IpaUS: /ˈhenə/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بۆیەیەکی قاوەیی مەیلەو سوور کە لە قژ و پێست دەدرێت"""),
                    SentencesRow(
                      englishText:
                    ...
                    const DefinitionKurdish(text: """٢. (کردار) لێدانی خەنە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Is her hair hennaed or is that a natural red?""",
                      kurdishText: """قژی خەنە کراوە یان سووری سرووشتییە؟""",
...
const double _startSecondsend = 000000000000000000000000000413;
const String _videoIdone = 'https://youtu.be/OnbFJPlBXD0?t=';
const double _startSecondsone = 000000000000000000000000000281;
const String _videoIdtwo = 'https://youtu.be/mgIr5vC_-h8?t=';
const double _startSecondstwo = 000000000000000000000000000534;
const String _videoIdthree = 'https://youtu.be/vNGDv0zPths?t=';
const double _startSecondsthree = 000000000000000000000000000820;
const String _videoIdfour = 'https://youtu.be/O1P6oZjfR54?t=';
const double _startSecondsfour = 000000000000000000000000000324;
const String _videoIdfive = 'https://youtu.be/btQY_vY75G8?t=';
