...
// replace these: replace EnglishEntryadjunct - replace speakAdjunct - replace adjunct - /ˈædʒʌŋkt/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadjunct extends StatelessWidget {
  EnglishEntryadjunct({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdjunct(String languageCode) async {
    // DOPSUM: CHANGE speakAdjunct
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "adjunct", // DOPSUM: CHANGE WORD ENTRY - Find /ˈædʒʌŋkt/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈædʒʌŋkt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAdjunct(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /ˈædʒʌŋkt/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'UbZlYl92OGU';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '5-IuFSt5xWA';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = '_h-u20eMwlw';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'TAPOQFWSUkE';
