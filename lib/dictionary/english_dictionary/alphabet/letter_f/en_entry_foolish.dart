...
class EnglishEntryfoolish extends StatefulWidget {
  const EnglishEntryfoolish({super.key});

  @override
  State<EnglishEntryfoolish> createState() => _EnglishEntryfoolishState();
}

class _EnglishEntryfoolishState extends State<EnglishEntryfoolish> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: foolish
1. Devoid of good sense or judgment (= daft [Brit, informal], dumb, stupid, imbecilic, imbecile)
"foolish remarks"; "a foolish decision";
 
2. Having or revealing stupidity (= anserine, dopy, dopey, goosey, goosy, gooselike, jerky)
"ridiculous foolish behaviour";
""",
  );

  final String keyword = "foolish";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foolish""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""There are some very foolish people out there.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I was foolish enough to believe what Jeff told me.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He's afraid of looking foolish in front of his friends.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foolish""",
                      // alsoEnglishWord: "also: foolish",
                      britshText: """IpaUK: /ˈfuːlɪʃ/""",
                      americanText: """IpaUS: /ˈfuːlɪʃ/""",
...
// With short examples define "foolish", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ژمارەیەک خەڵکی گەمژە هەن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئەوەندە گەمژە بووم باوەڕم بەوە کرد کە جێف گوتی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The accident was my fault—it would be foolish to pretend otherwise.""",
                      kurdishText:
                          """ڕووداوەکە هەڵەی من بوو ـ گەمژانە دەبێت پێچەوانەکەی بڵێم.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) هەستکردن یان دەرکەوتن وەک گەمژە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He's afraid of looking foolish in front of his friends.""",
                      kurdishText:
                          """ئەترسێت لە پێش هاوڕێکانی وەک گەمژە دەربکەوێت.""",
...
const double _startSecondsend = 0000000000000000000000000002523;
const String _videoIdone = 'https://youtu.be/Js2UoMSumx4?t=';
const double _startSecondsone = 000000000000000000000000000721;
const String _videoIdtwo = 'https://youtu.be/L9Mu93VJLcc?t=';
const double _startSecondstwo = 000000000000000000000000000551;
const String _videoIdthree = 'https://youtu.be/YrMGIqecu0Y?t=';
const double _startSecondsthree = 000000000000000000000000000483;
const String _videoIdfour = 'https://youtu.be/hXRst2j9P3g?t=';
const double _startSecondsfour = 00000000000000000000000000052;
const String _videoIdfive = 'https://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondsfive = 0000000000000000000000000001137;
