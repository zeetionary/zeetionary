...
class EnglishEntryfryingpan extends StatefulWidget {
  const EnglishEntryfryingpan({super.key});

  @override
  State<EnglishEntryfryingpan> createState() => _EnglishEntryfryingpanState();
}

class _EnglishEntryfryingpanState extends State<EnglishEntryfryingpan> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: frying pan (Derived forms: frying pans)
1. A pan used for frying foods (- frypan [N. Amer], skillet [N. Amer])
""",
  );

  final String keyword = "frying pan";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""frying pan""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Heat the butter in a frying pan.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """frying pan""",
                      // alsoEnglishWord: "also: frying pan",
                      britshText: """IpaUK: /ˈfraɪɪŋ pæn/""",
                      americanText: """IpaUS: /ˈfraɪɪŋ pæn/""",
...
// With short examples define "frying pan", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) تاوەیەکی کەم‌قووڵ کە دەسکێکی درێژی هەیە"""),
                    SentencesRow(
                      englishText: """Heat the butter in a frying pan.""",
                      kurdishText: """کەرەکە لە تاوەیەکی برژاندندا گەرم بکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/4dBPGLmNzb8?t=';
const double _startSecondsend = 000000000000000000000000000872;
const String _videoIdone = 'https://youtu.be/hzAgFNh4vRY?t=';
const double _startSecondsone = 00000000000000000000000000030;
const String _videoIdtwo = 'https://youtu.be/FCsz4nMUQCI?t=';
const double _startSecondstwo = 000000000000000000000000000335;
const String _videoIdthree = 'https://youtu.be/UPccIAVvQA4?t=';
const double _startSecondsthree = 000000000000000000000000000212;
const String _videoIdfour = 'https://youtu.be/yUYxk-y-tU8?t=';
const double _startSecondsfour = 0000000000000000000000000003;
const String _videoIdfive = 'https://youtu.be/y9nBhv0lq1s?t=';
const double _startSecondsfive = 000000000000000000000000000875;
