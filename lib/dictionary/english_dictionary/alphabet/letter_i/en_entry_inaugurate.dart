...
class EnglishEntryinaugurate extends StatefulWidget {
  const EnglishEntryinaugurate({super.key});

  @override
  State<EnglishEntryinaugurate> createState() => _EnglishEntryinaugurateState();
}

class _EnglishEntryinaugurateState extends State<EnglishEntryinaugurate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: inaugurate (Derived forms: inaugurates, inaugurating, inaugurated)
1. Commence officially (- kick off [informal])
 
2. Open ceremoniously or dedicate formally
 
3. Be a precursor of (- usher in, introduce)
"The fall of the Berlin Wall inaugurated the post-Cold War period";
""",
  );

  final String keyword = "inaugurate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""inaugurate""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He will be inaugurated (as) President in January.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The new theatre was inaugurated by the mayor.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/tBu97te_D58?t=';
    const double startSecondsend = 000000000000000000000000000398;
    const String videoIdone = 'https://youtu.be/PVQFvHuJHec?t=';
    const double startSecondsone = 000000000000000000000000000743;
    const String videoIdtwo = 'https://youtu.be/fytsaon_eOo?t=';
    const double startSecondstwo = 000000000000000000000000000352;
    const String videoIdthree = 'https://youtu.be/5y7a1Eb6QR4?t=';
    const double startSecondsthree = 00000000000000000000000000034;
    const String videoIdfour = 'https://youtu.be/lV8u3TS0CRw?t=';
    const double startSecondsfour = 000000000000000000000000000544;
    const String videoIdfive = 'https://youtu.be/YfaApD1OLak?t=';
    const double startSecondsfive = 000000000000000000000000000829;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """inaugurate""",
                      // alsoEnglishWord: "also: inaugurate",
                      britshText: """IpaUK: /ɪˈnɔːɡjəreɪt/""",
                      americanText: """IpaUS: /ɪˈnɔːɡjəreɪt/""",
...
کوردی: 
"""),
// With short examples define "inaugurate", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) ناساندنی بەرپرس یان سەرکردەیەکی تازە لە بۆنەیەکی تایبەتدا"""),
                    SentencesRow(
                      englishText:
                          """He will be inaugurated (as) President in January.""",
                      kurdishText: """لە کانوونی دووەم وەک سەرۆک دەناسرێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) بە فەرمی کردنەوەی بینایەک یان دامەزراوەیەک لە بۆنەیەکی تایبەتدا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The new theatre was inaugurated by the mayor.""",
                      kurdishText:
                          """هۆڵە شانۆ تازەکە لەلایەن سەرۆک شارەوانییەوە کرایەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (کردار) ناساندنی بەرەوپێشچوون یان گۆڕانێکی تازە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The moon landing inaugurated a new era in space exploration.""",
                      kurdishText:
                          """نیشتنەوە لەسەر مانگ سەردەمێکی تازەی لە گەڕانی بۆشایی ئاسمان دەستپێکرد.""",
