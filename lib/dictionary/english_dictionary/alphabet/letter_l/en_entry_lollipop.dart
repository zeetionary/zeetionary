...
class EnglishEntrylollipop extends StatefulWidget {
  const EnglishEntrylollipop({super.key});

  @override
  State<EnglishEntrylollipop> createState() => _EnglishEntrylollipopState();
}

class _EnglishEntrylollipopState extends State<EnglishEntrylollipop> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lollipop""");
  }
