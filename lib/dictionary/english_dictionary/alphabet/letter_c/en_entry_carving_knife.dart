...
class EnglishEntrycarvingknife extends StatelessWidget {
  // blank divider
  EnglishEntrycarvingknife({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakcarvingknife(String languageCode) async {
    // DOPSUM: CHANGE speakcarvingknife
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "carving knife"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈkɑːvɪŋ naɪf/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakcarvingknife("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈkɑːrvɪŋ naɪf/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakcarvingknife("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = '1DnxzrLde-A';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '9nTFOWmun2o';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'X0XpFwKKxXQ';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'NM_g4_5cnMA';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '6CboeCnjpbE';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'PMo8WfA_FIg';
