...
کوردی: ڕووبەڕووبوونەوە، پێکادان، تێک‌هەڵچوون، لێکدان، بەرەنگاری، بەرەنگاربوونەوە، تووش‌بوون، تووش،	یەکتردیتنی چاوەڕوان‌نەکراو یان ناکاو، توش‌بوونی کوت‌وپڕی، لەپڕایەکتردیتن
"""),
          ...
          SentencesRow(
            englishText:
                """We encountered a number of difficulties in the first week.""",
            kurdishText: """لە یەکەم هەفتەدا تووشی ژمارەیەکی سەختی بووین.""",
// With short examples define "encounter", please follow LX instructions
          ...
          SentencesRow(
            ...
            kurdishText: """هەرگیز پێشووتر تووشی ڕکابەری وەها نەبوومە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """سەرسوڕهێنەرترین ژن بوو کە تا ئێستا بینیبووی.""",
