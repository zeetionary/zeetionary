...
class EnglishEntryassignment extends StatelessWidget {
  ...
  Future<void> speakassignment(String languageCode) async {
    ...
    await flutterTts.speak("assignment");
  }
  ...
  Future<void> speakassignment724(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("Students are required to complete all homework assignments.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "assignment"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈsaɪnmənt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈsaɪnmənt/"),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final double _startSeconds = 3103;
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'FHYtj1m_5QI';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'KjkFfPhWO18';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'tkGbJMpad5o';
