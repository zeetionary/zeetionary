...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'BLK6dV76XTQ';
    const double startSecondsend = 90;
    const String videoIdone = '5pgxzPoxv4w';
    const double startSecondsone = 124;
    const String videoIdtwo = 'q5jnslfwazg';
    const double startSecondstwo = 5190;
    const String videoIdthree = 'fIspXVHv3QY';
    const double startSecondsthree = 86;
    const String videoIdfour = 'PCacb5G_MZo';
    const double startSecondsfour = 572;
    const String videoIdfive = 'ghaZf1ODia0';
