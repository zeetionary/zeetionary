...
class EnglishEntryfireside extends StatefulWidget {
  const EnglishEntryfireside({super.key});

  @override
  State<EnglishEntryfireside> createState() => _EnglishEntryfiresideState();
}

class _EnglishEntryfiresideState extends State<EnglishEntryfireside> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fireside (Derived forms: firesides)
1. An area near a fireplace (usually paved and extending out into a room) (= hearth)
"they sat on the fireside and warmed themselves before the fire";
 
2. Home symbolized as a part of the fireplace (= hearth)
"fighting in defence of their firesides";
""",
  );

  final String keyword = "fireside";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fireside""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She sat reading by the fireside.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fireside""",
                      // alsoEnglishWord: "also: fireside",
                      britshText: """IpaUK: /ˈfaɪəsaɪd/""",
                      americanText: """IpaUS: /ˈfaɪərsaɪd/""",
...
// With short examples define "fireside", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """She sat reading by the fireside.""",
                      kurdishText: """بە پاڵ ئاگردانەکەوە دانیشت خوێندییەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/qRLjB5LS_-g?t=';
const double _startSecondsend = 000000000000000000000000000540;
const String _videoIdone = 'https://youtu.be/f10-hSdykYQ?t=';
const double _startSecondsone = 000000000000000000000000000905;
const String _videoIdtwo = 'https://youtu.be/YsN4YIbN7LM?t=';
const double _startSecondstwo = 00000000000000000000000000054;
const String _videoIdthree = 'https://youtu.be/fxUnwsttr_8?t=';
const double _startSecondsthree = 000000000000000000000000000757;
const String _videoIdfour = 'https://youtu.be/vFwlw7ku4q0?t=';
const double _startSecondsfour = 00000000000000000000000000096;
const String _videoIdfive = 'https://youtu.be/lI-SfXmeHhY?t=';
