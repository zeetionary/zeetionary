...
class EnglishEntrylaughing extends StatefulWidget {
  const EnglishEntrylaughing({super.key});

  @override
  State<EnglishEntrylaughing> createState() => _EnglishEntrylaughingState();
}

class _EnglishEntrylaughingState extends State<EnglishEntrylaughing> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: laughing
1. Showing or feeling mirth or pleasure or happiness (- riant)
"laughing children";
""",
  );

  final String keyword = "laughing";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""laughing""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His laughing face cheered everyone in the room.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/JN1q2NCNRPg?t=520';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/gOZJgHnClCA?t=316';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/tth90qiKXgY?t=433';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/65I0Qijv9yk?t=564';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/jXExtnVpCb4?t=425';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/WFn55BBOFI0?t=388';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """laughing""",
                      // alsoEnglishWord: "also: laughing",
                      britshText: """IpaUK: /ˈlɑːfɪŋ/""",
                      americanText: """IpaUS: /ˈlæfɪŋ/""",
...
کوردی: 
"""),
// With short examples define "laughing", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) ئەوە پیشان بدەیت کە وەها هەست دەکەیت شتێک جێگای پێکەنینە"""),
                    SentencesRow(
                      englishText: """His laughing face cheered everyone in the room.""",
                      kurdishText: """ڕووخسارە دەم بەخەندەکەی هەموانی دڵخۆش کرد لە ژوورەکە.""",
