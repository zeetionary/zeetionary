...
class EnglishEntryhomophobic extends StatefulWidget {
  const EnglishEntryhomophobic({super.key});

  @override
  State<EnglishEntryhomophobic> createState() => _EnglishEntryhomophobicState();
}

class _EnglishEntryhomophobicState extends State<EnglishEntryhomophobic> {
  @override
  void initState() {
    super.initState();
...
"One idea is that a homophobic attitude is part of a defence mechanism that helps these people control, hide from, or mask their own sexuality"
""",
  );

  final String keyword = "homophobic";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""homophobic""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His homophobic comments led to his dismissal.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her critics say she is racist and homophobic.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/wZXoErL2124?t=';
    const double startSecondsend = 00000000000000000000000000059;
    const String videoIdone = 'https://youtu.be/H0c2ErVOmog?t=';
    const double startSecondsone = 000000000000000000000000000204;
    const String videoIdtwo = 'https://youtu.be/gR9izDp89c0?t=';
    const double startSecondstwo = 000000000000000000000000000197;
    const String videoIdthree = 'https://youtu.be/OPEh7UWmfDc?t=';
    const double startSecondsthree = 000000000000000000000000000655;
    const String videoIdfour = 'https://youtu.be/aTMsfOcHiJg?t=';
    const double startSecondsfour = 000000000000000000000000000809;
    const String videoIdfive = 'https://youtu.be/Ys1EjAGzuDk?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """homophobic""",
                      // alsoEnglishWord: "also: homophobic",
                      britshText: """IpaUK: /ˌhəʊməˈfəʊbɪk/,  /ˌhɒməˈfəʊbɪk/""",
                      americanText: """IpaUS: /ˌhəʊməˈfəʊbɪk/""",
...
کوردی: 
"""),
// With short examples define "homophobic", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) هەبوونی ڕق و مامەڵەی خراپ لەگەڵ کەسانی هاوڕەگەزخواز"""),
                    SentencesRow(
                      englishText:
                          """His homophobic comments led to his dismissal.""",
                      kurdishText:
                          """لێدوانە هۆمۆفۆبیکییەکانی گەیاندی بە دەرکردنی لە کارەکەی.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Her critics say she is racist and homophobic.""",
                      kurdishText:
                          """ڕەخنەگرانی دەڵێن ڕەگەزپەرست و هۆمۆفۆبیکە.""",
