...
class EnglishEntrygem extends StatefulWidget {
  const EnglishEntrygem({super.key});

  @override
  State<EnglishEntrygem> createState() => _EnglishEntrygemState();
}

class _EnglishEntrygemState extends State<EnglishEntrygem> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She wore a ring with a sparkling gem.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""This picture is the gem of the collection.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He's a real gem - you'd be a fool to break up with him.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gem""",
                      // alsoEnglishWord: "also: gem",
                      britshText: """IpaUK: /dʒem/""",
                      americanText: """IpaUS: /dʒem/""",
...
const double _startSecondsend = 876;
const String _videoIdone = 'TVKNpjnqeg0?t=';
const double _startSecondsone = 34;
const String _videoIdtwo = 'lDeFSOUHdH4?t=';
const double _startSecondstwo = 69;
const String _videoIdthree = 'oiLdWXLXDeA?t=';
const double _startSecondsthree = 328;
const String _videoIdfour = 'LJNtfyq3TDE?t=';
const double _startSecondsfour = 662;
const String _videoIdfive = '98UBT3Iw7i8?t=';
