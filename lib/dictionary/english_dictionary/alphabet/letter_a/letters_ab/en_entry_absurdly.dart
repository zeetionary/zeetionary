...
class EnglishEntryabsurdly extends StatelessWidget {
  EnglishEntryabsurdly({Key? key}) : super(key: key);
  ...
  Future<void> speakAbsurdly(String languageCode) async {
    ...
    await flutterTts.speak("absurdly"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakA41758(String languageCode) async {
    ...
    await flutterTts.speak(
        "The paintings were sold for absurdly high prices."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'absurdly', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əbˈsɜːdli/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAbsurdly(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '0UABTaB-_i8';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '433iKnR2pzb4Gg';
