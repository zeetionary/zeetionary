...
class EnglishEntrygettogether extends StatefulWidget {
  const EnglishEntrygettogether({super.key});

  @override
  State<EnglishEntrygettogether> createState() =>
      _EnglishEntrygettogetherState();
}

class _EnglishEntrygettogetherState extends State<EnglishEntrygettogether> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "get-together";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""get-together""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """get-together""",
                      // alsoEnglishWord: "also: get-together",
                      britshText: """IpaUK: /ˈɡet təɡeðə(r)/""",
                      americanText: """IpaUS: /ˈɡet təɡeðər/""",
...
// With short examples define "get-together", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Most of the students were more interested in social get-togethers than going to lectures.""",
                      kurdishText:
                          """زۆرێک لە خوێندکاران زیاتر حەزیان بە کۆبوونەوەی کۆمەڵایەتی بوو وەک لە چوون بۆ بابەتەکان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/vQtj7ARVxoM?t=';
const double _startSecondsend = 0000000000000000000000000001054;
const String _videoIdone = 'https://youtu.be/WbBx0vQBLFQ?t=';
const double _startSecondsone = 000000000000000000000000000101;
const String _videoIdtwo = 'https://youtu.be/lCiZPZkvOBE?t=';
const double _startSecondstwo = 000000000000000000000000000244;
const String _videoIdthree = 'https://youtu.be/neD0BpcS7eA?t=';
const double _startSecondsthree = 0000000000000000000000000002929;
const String _videoIdfour = 'https://youtu.be/1jm3K9cm3vI?t=';
const double _startSecondsfour = 0000000000000000000000000001574;
const String _videoIdfive = 'https://youtu.be/4yqOOxk0fIg?t=';
const double _startSecondsfive = 000000000000000000000000000511;
