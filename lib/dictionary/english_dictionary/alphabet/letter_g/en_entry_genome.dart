...
class EnglishEntrygenome extends StatefulWidget {
  const EnglishEntrygenome({super.key});

  @override
  State<EnglishEntrygenome> createState() => _EnglishEntrygenomeState();
}

class _EnglishEntrygenomeState extends State<EnglishEntrygenome> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The human genome contains all the DNA in our cells.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """genome""",
                      // alsoEnglishWord: "also: genome",
                      britshText: """IpaUK: /ˈdʒiːnəʊm/""",
                      americanText: """IpaUS: /ˈdʒiːnəʊm/""",
...
// With short examples define "genome", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """جینۆمی مرۆڤ تەواوی دی‌ئێن‌ئەی خانەکانمان لەخۆدەگرێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/KT18KJouHWg?t=';
const double _startSecondsend = 000000000000000000000000000335;
const String _videoIdone = 'https://youtu.be/NNnIGh9g6fA?t=';
const double _startSecondsone = 0000000000000000000000000002197;
const String _videoIdtwo = 'https://youtu.be/dKiFkwsVIWA?t=';
...
const String _videoIdfive = 'https://youtu.be/KKYJf2DL1FM?t=';
