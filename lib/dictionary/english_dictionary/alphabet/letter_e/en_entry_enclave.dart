...
class EnglishEntryenclave extends StatefulWidget {
  const EnglishEntryenclave({super.key});

  @override
  State<EnglishEntryenclave> createState() => _EnglishEntryenclaveState();
}

class _EnglishEntryenclaveState extends State<EnglishEntryenclave> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("enclave");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "enclave",
                      // alsoEnglishWord: "also: enclave",
                      britshText: "IpaUK: /ˈenkleɪv/",
                      americanText: "IpaUS: /ˈenkleɪv/",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The northern part of the city is a Christian enclave.""");
  }
...
// """),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ناوچەیەکی وڵاتێک کە ئایین، کەلتوور، یان ناسنامەی جیاوازیان هەیە وەک لە خەڵکی دورووبەریان، بۆ نموونە کالینینگرادی سەر بە ڕووسیا"""),
          SentencesRow(
            englishText:
                """The northern part of the city is a Christian enclave.""",
            kurdishText: """بەشی باکووری وڵاتەکە هەرێمێکی مەسیحییە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: enclave (Derived forms: enclaves)
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/woD6RYptp58?t=';
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/xykDDyHDTZY?t=';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/SvGbt99BHEg?t=';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/NKfW8ijmRQ4?t=';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/J1kOkoma_hM?t=';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/mXpwgg5TxOU?t=';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/P6bVl47kdNk?t=';
