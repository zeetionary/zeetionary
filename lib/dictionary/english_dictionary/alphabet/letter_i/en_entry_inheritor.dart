...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'LJUl77rsFEw';
    const double startSecondsend = 279;
    const String videoIdone = 'PkJlTKUaF3Q';
    const double startSecondsone = 751;
    const String videoIdtwo = '7DWWkU6Jerw';
    const double startSecondstwo = 672;
    const String videoIdthree = 'dZ_IwkAE2ls';
    const double startSecondsthree = 255;
    const String videoIdfour = 'WwIZPoGD2Cc';
    const double startSecondsfour = 131;
    const String videoIdfive = 'fq1o93Uo1fA';
    const double startSecondsfive = 757;
