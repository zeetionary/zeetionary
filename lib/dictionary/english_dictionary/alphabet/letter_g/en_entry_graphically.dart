...
class EnglishEntrygraphically extends StatefulWidget {
  const EnglishEntrygraphically({super.key});

  @override
  State<EnglishEntrygraphically> createState() =>
      _EnglishEntrygraphicallyState();
}

class _EnglishEntrygraphicallyState extends State<EnglishEntrygraphically> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: graphically
1. In a diagrammatic manner (- diagrammatically)
"the landscape unit drawn graphically illustrates the gentle rolling relief, with a peat-filled basin";
...
""",
  ...
  final String keyword = "graphically";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""graphically""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""This data is shown graphically on the opposite page.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The murders are graphically described in the article.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """graphically""",
                      // alsoEnglishWord: "also: graphically",
                      britshText: """IpaUK: /ˈɡræfɪkli/""",
                      americanText: """IpaUS: /ˈɡræfɪkli/""",
...
کوردی: بە ڕوونی، بە ئاشکرایی
"""),
// With short examples define "graphically", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) بە شێوەی هێڵکاری"""),
                    SentencesRow(
                      englishText:
                          """This data is shown graphically on the opposite page.""",
                      kurdishText:
                          """ئەم داتایە بە هێڵکارییەوە لە پەڕەی بەرانبەر پیشان دراوە.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵکار) بە ڕوونی و وردەکاریی تەواو"""),
                    const AlsoEnglishckb(word: "ھەروەھا: vividly"),
                    SentencesRow(
                      englishText:
                          """The murders are graphically described in the article.""",
                      kurdishText:
                          """کوشتنەکان بە ڕوونی لە وتارەکە باسکراون.""",
...
const double _startSecondsend = 0000000000000000000000000004786;
const String _videoIdone = 'https://youtu.be/IlU-zDU6aQ0?t=';
const double _startSecondsone = 000000000000000000000000000230;
const String _videoIdtwo = 'https://youtu.be/glS3RDoxYMM?t=';
const double _startSecondstwo = 000000000000000000000000000975;
...
const double _startSecondsfour = 0000000000000000000000000001489;
const String _videoIdfive = 'https://youtu.be/GBYvJgrf-Dk?t=';
