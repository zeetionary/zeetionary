...
class EnglishEntryluckily extends StatefulWidget {
  const EnglishEntryluckily({super.key});

  @override
  State<EnglishEntryluckily> createState() => _EnglishEntryluckilyState();
}

class _EnglishEntryluckilyState extends State<EnglishEntryluckily> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryluckily luckily
WORD_WEB luckily luckily luckily
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "luckily";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""luckily""");
  }
...
کوردی: 
"""),
// With short examples define "luckily", please follow LX instructions
