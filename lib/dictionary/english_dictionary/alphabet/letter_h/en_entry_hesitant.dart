...
class EnglishEntryhesitant extends StatefulWidget {
  const EnglishEntryhesitant({super.key});

  @override
  State<EnglishEntryhesitant> createState() => _EnglishEntryhesitantState();
}

class _EnglishEntryhesitantState extends State<EnglishEntryhesitant> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hesitant
1. Lacking decisiveness of character; unable to act or decide quickly or firmly (- hesitating)
"his narration was hesitant";
""",
  );

  final String keyword = "hesitant";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hesitant""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It was a few seconds before she heard a hesitant reply.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hesitant""",
                      // alsoEnglishWord: "also: hesitant",
                      britshText: """IpaUK: /ˈhezɪtənt/""",
                      americanText: """IpaUS: /ˈhezɪtənt/""",
...
کوردی: دوودڵ، دڕدۆنگ، بەشک، بەگومان، نادڵنیا
"""),
// With short examples define "hesitant", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) هێواش لە قسەکردن یان هەنگاونان بەهۆی ئەوەی کە دڵنیا نییت، شەرمەزاریت، یان ئامادە نییت"""),
                    SentencesRow(
                      englishText:
                          """It was a few seconds before she heard a hesitant reply.""",
                      kurdishText:
                          """چەند چرکەیەکی پێچوو پێش ئەوەی وەڵامێکی دوودڵانە ببیستێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It was a few seconds before she heard a hesitant reply.""",
                      kurdishText: """دوودڵە لەسەر واژۆکردنی ڕێککەوتنەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/yRmOWcWdQAo?t=';
const double _startSecondsend = 000000000000000000000000000523;
const String _videoIdone = 'https://youtu.be/Zqe0u55j1gk?t=';
const double _startSecondsone = 0000000000000000000000000001562;
const String _videoIdtwo = 'https://youtu.be/TVKNpjnqeg0?t=';
const double _startSecondstwo = 000000000000000000000000000247;
const String _videoIdthree = 'https://youtu.be/b_rjBWmc1iQ?t=';
const double _startSecondsthree = 0000000000000000000000000005002;
const String _videoIdfour = 'https://youtu.be/eVSsHWl_Qec?t=';
const double _startSecondsfour = 000000000000000000000000000115;
const String _videoIdfive = 'https://youtu.be/p7iwXvBnbIE?t=';
const double _startSecondsfive = 000000000000000000000000000280;
