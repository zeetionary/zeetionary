...
class EnglishEntryintriguing extends StatefulWidget {
  const EnglishEntryintriguing({super.key});

  @override
  State<EnglishEntryintriguing> createState() => _EnglishEntryintriguingState();
}

class _EnglishEntryintriguingState extends State<EnglishEntryintriguing> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intriguing""");
  }
