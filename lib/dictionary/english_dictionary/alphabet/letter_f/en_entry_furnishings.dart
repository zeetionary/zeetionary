...
class EnglishEntryfurnishings extends StatefulWidget {
  const EnglishEntryfurnishings({super.key});

  @override
  State<EnglishEntryfurnishings> createState() =>
      _EnglishEntryfurnishingsState();
}

class _EnglishEntryfurnishingsState extends State<EnglishEntryfurnishings> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: furnishings
1. (usually plural) accessory wearing apparel (- trappings)
...
""",
  ...
  final String keyword = "furnishings";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""furnishings""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The wallpaper should match the furnishings.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """furnishings""",
                      // alsoEnglishWord: "also: furnishings",
                      britshText: """IpaUK: /ˈfɜːnɪʃɪŋz/""",
                      americanText: """IpaUS: /ˈfɜːrnɪʃɪŋz/""",
...
// With short examples define "furnishings", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) کەلوپەلی ناوماڵ، فەرش، پەردە، هتد"""),
                    SentencesRow(
                      englishText:
                          """The wallpaper should match the furnishings.""",
                      kurdishText:
                          """وێنەکە دەبیت لەگەڵ کەلوپەلەکان بگونجێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/9zX2BQFZ_BI?t=';
const double _startSecondsend = 00000000000000000000000000052;
const String _videoIdone = 'https://youtu.be/ipeoe_6J2ys?t=';
const double _startSecondsone = 000000000000000000000000000687;
const String _videoIdtwo = 'https://youtu.be/I6qhthBz-ag?t=';
const double _startSecondstwo = 000000000000000000000000000326;
const String _videoIdthree = 'https://youtu.be/haK2TnmVoT0?t=';
const double _startSecondsthree = 00000000000000000000000000070;
const String _videoIdfour = 'https://youtu.be/190emwcnYJ4?t=';
const double _startSecondsfour = 00000000000000000000000000068;
const String _videoIdfive = 'https://youtu.be/JKMFXi4xPLM?t=';
