...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/CXvG2CBJ3SE?t=';
    const double startSecondsone = 00000000000000000000000000020;
    const String videoIdtwo = 'https://youtu.be/pTysrwci0pU?t=';
    const double startSecondstwo = 000000000000000000000000000355;
    const String videoIdthree = 'https://youtu.be/L6QJS8djygk?t=';
    const double startSecondsthree = 000000000000000000000000000537;
    const String videoIdfour = 'https://youtu.be/3RkhZgRNC1k?t=';
    const double startSecondsfour = 0000000000000000000000000001443;
    const String videoIdfive = 'https://youtu.be/oBcxuzdP3rs?t=';
    const double startSecondsfive = 00000000000000000000000000035;
...
کوردی: 
"""),
// With short examples define "highlight", please follow LX instructions
