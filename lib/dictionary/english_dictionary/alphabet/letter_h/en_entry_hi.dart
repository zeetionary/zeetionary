...
class EnglishEntryhi extends StatefulWidget {
  const EnglishEntryhi({super.key});

  @override
  State<EnglishEntryhi> createState() => _EnglishEntryhiState();
}

class _EnglishEntryhiState extends State<EnglishEntryhi> {
  @override
  void initState() {
    super.initState();
...
- Interjection: hi
Usage: informal
1. Used as a greeting (- aloha [US, informal], g'day [Austral, informal], greetings, hello, hiya [informal], hallo, hullo, hey [informal], howdy [informal], howzit [S.Africa, informal], gidday [NZ, informal], yo [informal], wotcha [Brit, informal], wotcher [Brit, informal])
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Say hi to her from me.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Hi guys!""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Hi, there! How're you doing?""");
  }
...
کوردی: هەی، سڵاو، چۆنی، باشی
"""),
// With short examples define "hi", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (سەرسوڕمان) بۆ سڵاوکردن بەکاردێت"""),
                    SentencesRow(
                      englishText: """Say hi to her from me.""",
                      kurdishText: """لە جیاتی من سڵاوی لێ بکە.""",
...
const double _startSecondsend = 00000000000000000000000000022;
const String _videoIdone = 'https://youtu.be/hTqtGJwsJVE?t=';
const double _startSecondsone = 000000000000000000000000000646;
const String _videoIdtwo = 'https://youtu.be/NCLZi2Rn_ug';
...
const String _videoIdfour = 'https://youtu.be/q_2Wvqljob8?t=';
