...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/NZ74oFctP_g?t=';
    const double startSecondsend = 00000000000000000000000000067;
    const String videoIdone = 'https://youtu.be/zqllxbPWKNI?t=';
    const double startSecondsone = 0000000000000000000000000001270;
    const String videoIdtwo = 'https://youtu.be/pFmtmO2cnlg?t=';
    const double startSecondstwo = 00000000000000000000000000047;
    const String videoIdthree = 'https://youtu.be/Xzv84ZdtlE0?t=';
    const double startSecondsthree = 0000000000000000000000000001799;
    const String videoIdfour = 'https://youtu.be/IgF3OX8nT0w?t=';
    const double startSecondsfour = 000000000000000000000000000630;
    const String videoIdfive = 'https://youtu.be/FQ4hvLqNfqo?t=';
