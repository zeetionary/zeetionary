...
class EnglishEntryhesitation extends StatefulWidget {
  const EnglishEntryhesitation({super.key});

  @override
  State<EnglishEntryhesitation> createState() => _EnglishEntryhesitationState();
}

class _EnglishEntryhesitationState extends State<EnglishEntryhesitation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hesitation (Derived forms: hesitations)
1. Indecision in speech or action (- vacillation, wavering)
 
2. A certain degree of unwillingness (- reluctance, hesitancy, disinclination, indisposition)
"after some hesitation he agreed";
 
3. The act of pausing uncertainly (- waver, falter, faltering)
"there was a hesitation in his speech";
""",
  );

  final String keyword = "hesitation";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She agreed without the slightest hesitation.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""I have no hesitation in recommending her for the job.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hesitation""",
                      // alsoEnglishWord: "also: hesitation",
                      britshText: """IpaUK: /ˌhezɪˈteɪʃn/""",
                      americanText: """IpaUS: /ˌhezɪˈteɪʃn/""",
...
کوردی: دوودڵی، دڕدۆنگی، شک، گومان، گیر
"""),
// With short examples define "hesitation", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) هێواشی لە قسەکردن یان هەنگاونان بەهۆی ئەوەی دوودڵ یان شڵەژاویت"""),
                    SentencesRow(
                      englishText:
                          """She agreed without the slightest hesitation.""",
                      kurdishText: """ڕازی بوو بە بێ هیچ دوودڵی.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) ئەوەی نیگەران بیت سەبارەت بە کردنی شتێک، بە تایبەتی کە دڵنیا نییت کە ڕاست یان گونجاوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I have no hesitation in recommending her for the job.""",
                      kurdishText:
                          """هیچ گومانم نییە بۆ پێشنیارکردنی بۆ کارەکە.""",
...
const double _startSecondsend = 0000000000000000000000000001537;
const String _videoIdone = 'https://youtu.be/dtp6b76pMak?t=';
const double _startSecondsone = 000000000000000000000000000697;
const String _videoIdtwo = 'https://youtu.be/Js2UoMSumx4?t=';
const double _startSecondstwo = 000000000000000000000000000247;
const String _videoIdthree = 'https://youtu.be/Zqe0u55j1gk?t=';
const double _startSecondsthree = 0000000000000000000000000001167;
const String _videoIdfour = 'https://youtu.be/i4FkQMDTqYc?t=';
const double _startSecondsfour = 00000000000000000000000000082;
const String _videoIdfive = 'https://youtu.be/VRJzvJ5XPQI?t=';
