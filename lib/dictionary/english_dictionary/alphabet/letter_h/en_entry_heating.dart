...
class EnglishEntryheating extends StatefulWidget {
  const EnglishEntryheating({super.key});

  @override
  State<EnglishEntryheating> createState() => _EnglishEntryheatingState();
}

class _EnglishEntryheatingState extends State<EnglishEntryheating> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heating (Derived forms: heatings)
1. The process of becoming warmer; a rising temperature (- warming)
 
2. Utility to warm a building (- heating system, heating plant, heat)
"the heating system wasn't working"; "they have radiant heating"; "the heating plant wasn't working";
""",
  );

  final String keyword = "heating";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heating""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Who turned the heating off?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What type of heating do you have?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heating""",
                      // alsoEnglishWord: "also: heating",
                      britshText: """IpaUK: /ˈhiːtɪŋ/""",
                      americanText: """IpaUS: /ˈhiːtɪŋ/""",
...
// With short examples define "heating", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """What type of heating do you have?""",
                      kurdishText: """چی جۆرە گەرمییەکت هەیە؟""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/gKinPCgOMxE?t=';
const double _startSecondsend = 000000000000000000000000000268;
const String _videoIdone = 'https://youtu.be/4VTOplLl2BM?t=';
const double _startSecondsone = 000000000000000000000000000308;
const String _videoIdtwo = 'https://youtu.be/D6V85qfsu3g?t=';
const double _startSecondstwo = 0000000000000000000000000001432;
const String _videoIdthree = 'https://youtu.be/6MoBvV12C58?t=';
const double _startSecondsthree = 000000000000000000000000000170;
const String _videoIdfour = 'https://youtu.be/sS2YceA2fKg?t=';
const double _startSecondsfour = 000000000000000000000000000265;
const String _videoIdfive = 'https://youtu.be/RhTDneoDUdc?t=';
const double _startSecondsfive = 000000000000000000000000000962;
