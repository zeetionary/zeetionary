...
class EnglishEntryheredity extends StatefulWidget {
  const EnglishEntryheredity({super.key});

  @override
  State<EnglishEntryheredity> createState() => _EnglishEntryheredityState();
}

class _EnglishEntryheredityState extends State<EnglishEntryheredity> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heredity (Derived forms: heredities)
1. The biological process whereby genetic factors are transmitted from one generation to the next
 
2. The total of inherited attributes (- genetic endowment)
""",
  );

  final String keyword = "heredity";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heredity""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heredity""",
                      // alsoEnglishWord: "also: heredity",
                      britshText: """IpaUK: /həˈredəti/""",
                      americanText: """IpaUS: /həˈredəti/""",
...
کوردی: 
"""),
// With short examples define "heredity", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی کە خاسیەتێک لە دایک و باوکەوە بۆ منداڵ دەگوازرێتەوە"""),
                    SentencesRow(
                      englishText:
                          """Diet and exercise can influence a person's weight, but heredity is also a factor.""",
                      kurdishText:
                          """خواردن و ڕاهێنان دەکریت کار لە کێشی کەسێک بکەن، بەڵام بۆماوەییش هۆکارێکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/QHscMam4W7s?t=';
const double _startSecondsend = 000000000000000000000000000160;
const String _videoIdone = 'https://youtu.be/H9D2hr0WWh0?t=';
const double _startSecondsone = 000000000000000000000000000788;
const String _videoIdtwo = 'https://youtu.be/p3JLaF_4Tz8?t=';
const double _startSecondstwo = 000000000000000000000000000630;
const String _videoIdthree = 'https://youtu.be/0ens0WjAyOc?t=';
const double _startSecondsthree = 0000000000000000000000000004155;
const String _videoIdfour = 'https://youtu.be/bilIMsopfvA?t=';
const double _startSecondsfour = 000000000000000000000000000279;
const String _videoIdfive = 'https://youtu.be/foduemIqFGM?t=';
