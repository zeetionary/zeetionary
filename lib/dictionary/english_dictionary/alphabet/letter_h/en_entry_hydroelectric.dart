...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'lhK7hMBli4s';
    const double startSecondsend = 572;
    const String videoIdone = 'uDsmQRGdL6k';
    const double startSecondsone = 228;
    const String videoIdtwo = 'GBp_NgrrtPM';
    const double startSecondstwo = 723;
    const String videoIdthree = 'sKeQe7oc2gk';
    const double startSecondsthree = 114;
    const String videoIdfour = 'QfAXbGInwno';
    const double startSecondsfour = 365;
    const String videoIdfive = 'MFEHFsO-XSI';
