...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 477;
    const String videoIdone = '-I6YmMAThZ8';
    const double startSecondsone = 665;
    const String videoIdtwo = 'A7beCOs4yAw';
    const double startSecondstwo = 448;
    const String videoIdthree = '4oXZXT3D0UE';
    const double startSecondsthree = 271;
    const String videoIdfour = 'bolyiGMcjBs';
    const double startSecondsfour = 75;
    const String videoIdfive = 'XB2W_kw62u8';
