...
class EnglishEntryimplicate extends StatefulWidget {
  const EnglishEntryimplicate({super.key});

  @override
  State<EnglishEntryimplicate> createState() => _EnglishEntryimplicateState();
}

class _EnglishEntryimplicateState extends State<EnglishEntryimplicate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: implicate (Derived forms: implicates, implicated, implicating)
1. Bring into intimate and incriminating connection
"He is implicated in the scheme to defraud the government"
 
2. Impose, involve, or imply as a necessary accompaniment or result (- entail)
"What does this move implicate?";
""",
  );

  final String keyword = "implicate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""implicate""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/UzIxYdWVbm0?t=';
    const double startSecondsend = 000000000000000000000000000635;
    const String videoIdone = 'https://youtu.be/USL6P8haroY?t=';
    const double startSecondsone = 000000000000000000000000000812;
    const String videoIdtwo = 'https://youtu.be/GaLdHd2J-xM?t=';
    const double startSecondstwo = 000000000000000000000000000523;
    const String videoIdthree = 'https://youtu.be/c6n0rFMsVh0?t=';
    const double startSecondsthree = 0000000000000000000000000001243;
    const String videoIdfour = 'https://youtu.be/MXQ43yyJvgs?t=';
    const double startSecondsfour = 000000000000000000000000000463;
    const String videoIdfive = 'https://youtu.be/eJ-WJssJgdg?t=';
    const double startSecondsfive = 0000000000000000000000000001946;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """implicate""",
                      // alsoEnglishWord: "also: implicate",
                      britshText: """IpaUK: /ˈɪmplɪkeɪt/""",
                      americanText: """IpaUS: /ˈɪmplɪkeɪt/""",
...
کوردی: 
"""),
// With short examples define "implicate", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) پیشاندان یان ئاماژەکردن بەوەی کەسێک لە شتێکی خراپ یان تاوانکاری تێوەگلاوە"""),
                    SentencesRow(
                      englishText:
                          """He tried to avoid saying anything that would implicate him further.""",
                      kurdishText:
                          """هەوڵی دا دووربێت لە گوتنی هەر شتێک کە زیاتر تێوەی بگلێنێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) پیشاندان یان ئاماژەکردن بەوەی شتێک هۆکار شتێکی خراپە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The results implicate poor hygiene as one cause of the outbreak.""",
                      kurdishText:
                          """ئەنجامەکان کەمی پاکوخاوێنی بە یەکێک لە هۆکارەکانی نەخۆشییەکە دادەنێن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Free radicals have been implicated in cancer and many other serious diseases.""",
                      kurdishText:
                          """ئەتۆمە ئازادەکان بەژداری  شێرپەنجە و زۆر نەخۆشی توندی دیکە بوونە.""",
