...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'ke0TvWC2jT4';
    const double startSecondsend = 831;
    const String videoIdone = '-hfl0zbTzoY';
    const double startSecondsone = 458;
    const String videoIdtwo = 'bLHVFKYdmzw';
    const double startSecondstwo = 599;
    const String videoIdthree = 'OauAdYIrTwQ';
    const double startSecondsthree = 528;
    const String videoIdfour = 'J5DQRPRBiFI';
    const double startSecondsfour = 663;
    const String videoIdfive = 'XGE_TZfTaH8';
