...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She has fearlessly exposed corruption.""");
  }
...
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵکار) بەشێوەیەک کە ترس پیشان نادات"""),
          SentencesRow(
            englishText: """She has fearlessly exposed corruption.""",
...
const double _startSecondsend = 1804;
const String _videoIdone = 'sV6uuMAnJUE';
const double _startSecondsone = 854;
const String _videoIdtwo = 'WwhyZUlmaWA';
const double _startSecondstwo = 259;
const String _videoIdthree = 'qgVsKzfRo3Q';
const double _startSecondsthree = 254;
const String _videoIdfour = 'vc90NQpY_4s';
const double _startSecondsfour = 994;
const String _videoIdfive = 'HAZlPuL3Qhw';
const double _startSecondsfive = 1173;
