...
class EnglishEntryheritage extends StatefulWidget {
  const EnglishEntryheritage({super.key});

  @override
  State<EnglishEntryheritage> createState() => _EnglishEntryheritageState();
}

class _EnglishEntryheritageState extends State<EnglishEntryheritage> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heritage (Derived forms: heritages)
1. Practices that are handed down from the past by tradition
"a heritage of freedom"
 
2. Any attribute or immaterial possession that is inherited from ancestors (- inheritance)
"the world's heritage of knowledge";
 
3. (law) that which is inherited; a title, property or estate that passes by law to the heir on the death of the owner (- inheritance)
 
4. Hereditary succession to a title or an office or property (- inheritance)
""",
  );

  final String keyword = "heritage";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heritage""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The building is part of our national heritage.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The country has a long and proud heritage.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""What's your heritage?""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her heritage is Chinese and Vietnamese.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heritage""",
                      // alsoEnglishWord: "also: heritage",
                      britshText: """IpaUK: /ˈherɪtɪdʒ/""",
                      americanText: """IpaUS: /ˈherɪtɪdʒ/""",
...
کوردی: میرات، بۆماوە، ڕەچەڵەک، کەلەپوور، بەشەماڵ، بەش، یادگار،	بەش، پشک
"""),
// With short examples define "heritage", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مێژوو، نەریت، بیناکان، و شتەکانی وڵات یان کۆمەڵگایەک بۆ ماوەیەکی زۆر هەیبووە و ئێستا بە گرنگ دەبینرێن"""),
                    SentencesRow(
                      englishText:
                          """The building is part of our national heritage.""",
                      kurdishText:
                          """بیناکە بەشێکە لە ڕەچەڵەکی نیشتیمانیمان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """وڵاتەکە ڕەچەڵەکێکی ماوە درێژ و جێگای شانازی هەیە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The city has an exceptionally rich heritage of historic buildings.""",
                      kurdishText:
                          """شارەکە ڕەچەڵەکێکی تەواو دەوڵەمەندی هەیە لە بینای مێژووی.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) پێشینەی ئیتنیکی کەسێک؛ ئەو وڵات، کەلتوور، ئایین، هتد ــەی کە هی کەسێک یان باوانیەتی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """What's your heritage?""",
                      kurdishText: """ڕەچەڵەکت چییە؟""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ڕەچەڵەکی چینی و ڤێتنامییە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) بۆ باسکردنی بەرهەمێک، براندێک، ئاژەڵێک، یان جۆری ڕووەک کە کۆن، دەگمەن، یان کوالێتی بەرزە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """They work with some of Britain's oldest heritage brands, including Jaguar, Harrods and the BBC.""",
                      kurdishText:
                          """لەگەڵ کۆنترین براندە کەلەپوورییەکانی بەریتانیا کار دەکەن، بۆ نموونە جاگوار، هارۆدز، و بی‌بی‌سی.""",
...
const String _videoIdone = 'https://youtu.be/uKgaVlMN7IY?t=';
...
const String _videoIdthree = 'https://youtu.be/dRLCZqEfJFA?t=';
...
const String _videoIdfive = 'https://youtu.be/FIDsKWis3jo?t=';
