...
class EnglishEntryhimself extends StatefulWidget {
  const EnglishEntryhimself({super.key});

  @override
  State<EnglishEntryhimself> createState() => _EnglishEntryhimselfState();
}

class _EnglishEntryhimselfState extends State<EnglishEntryhimself> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Pronoun: himself
1. Reflexive form of "him" (- hisself [non-standard])
"He got himself out of those icy clothes, put some water on to heat up";
""",
  );

  final String keyword = "himself";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""himself""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He introduced himself.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Peter ought to be ashamed of himself.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""How can he afford to buy himself a brand new car?""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The doctor said so himself.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Did you see the manager himself?""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/ozsgl_sLnHQ?t=';
    const double startSecondsone = 0000000000000000000000000002017;
    ...
    const double startSecondsthree = 0000000000000000000000000001000;
    const String videoIdfour = 'https://youtu.be/YgRjRox5QLg?t=';
    const double startSecondsfour = 0000000000000000000000000008;
    const String videoIdfive = 'https://youtu.be/wV-NcNwXqcA?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """himself""",
                      // alsoEnglishWord: "also: himself",
                      britshText: """IpaUK: /hɪmˈself/""",
                      americanText: """IpaUS: /hɪmˈself/""",
...
کوردی: 
"""),
// With short examples define "himself", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (جێناو) (جێناوی خۆیی) بەکاردێت کە پیاوێک یان کوڕێک کە کارێک دەکات کاریگەر دەبێت پێی"""),
                    SentencesRow(
                      englishText: """He introduced himself.""",
                      kurdishText: """خۆی ناساند.""",
                        ...
                        MyExpansionTile(
                          children: [
                            SentencesRow(
                              ...
                              kurdishText:
                                  """پیتەر دەبێت شەرم لە خۆی بکاتەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (جێناو) بۆ جەختکردنەوە لە بکەر یان بەرکاری نێرینە لە ڕستەیەک"""),
                    SentencesRow(
                      englishText: """The doctor said so himself.""",
                      kurdishText: """پزیشکەکە خودی خۆی گوتی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Did you see the manager himself?""",
                      kurdishText: """خودی بەڕێوەبەرەکەت دی؟""",
