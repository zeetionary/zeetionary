...
class EnglishEntryhalloween extends StatefulWidget {
  const EnglishEntryhalloween({super.key});

  @override
  State<EnglishEntryhalloween> createState() => _EnglishEntryhalloweenState();
}

class _EnglishEntryhalloweenState extends State<EnglishEntryhalloween> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: Halloween (Derived forms: Hallowe'ens, Halloweens)
1. The evening before All Saints' Day; often devoted to pranks played by young people (- Hallowe'en, Allhallows Eve)
""",
  );

  final String keyword = "Halloween";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Halloween""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Halloween is a popular holiday for children and adults.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """Halloween""",
                      // alsoEnglishWord: "also: Halloween",
                      britshText: """IpaUK: /ˌhæləʊˈiːn/""",
                      americanText: """IpaUS: /ˌhæləʊˈiːn/""",
