...
// replace these: EnglishEntryaccompanist - speakAccompanist - accompanist - /əˈkʌmpənɪst/

enum TtsState { playing }

class EnglishEntryaccompanist extends StatelessWidget {
  EnglishEntryaccompanist({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAccompanist(String languageCode) async {
    // DOPSUM: CHANGE speakAccompanist
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("accompanist"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAc98832(String languageCode) async {
    ...
    await flutterTts.speak(
        "The singer's accompanist on the piano was Charles Harman."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈkʌmpənɪst/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'JngOMNHInC8';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'F15-PVberTs';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'MU8mKZqfAWs';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'r-ZNdy53CjA';
