...
class EnglishEntryhideaway extends StatefulWidget {
  const EnglishEntryhideaway({super.key});

  @override
  State<EnglishEntryhideaway> createState() => _EnglishEntryhideawayState();
}

class _EnglishEntryhideawayState extends State<EnglishEntryhideaway> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hideaway (Derived forms: hideaways)
1. A hiding place; usually a remote place used by outlaws (- hideout, den)
"a snug hideaway";
 
2. An area where you can be alone (- retreat)
""",
  );

  final String keyword = "hideaway";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hideaway""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He escaped to his hideaway in the country at weekends.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hideaway""",
                      // alsoEnglishWord: "also: hideaway",
                      britshText: """IpaUK: /ˈhaɪdəweɪ/""",
                      americanText: """IpaUS: /ˈhaɪdəweɪ/""",
...
کوردی: حەشارگە، مالیتە، پەناوپەسیو، پەناگە، سیپە، بۆسە،	شوێنی خەڵوەت، جێی چۆڵ، پەنا، ستار
"""),
// With short examples define "hideaway", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) شوێنێک کە تێیدا دەتوانیت خۆت بشاریتەوە یان تەنها بیت"""),
                    SentencesRow(
                      englishText: """He escaped to his hideaway in the country at weekends.""",
                      kurdishText: """هەڵدەهات بۆ حەشارگەکەی لە دەشت‌ودەر لە کۆتاییەکانی هەفتەدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/1h12uwyMZY0';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/P52pqNMpXSU?t=';
const double _startSecondsone = 000000000000000000000000000487;
const String _videoIdtwo = 'https://youtu.be/qtZLLn6S6Vk?t=';
const double _startSecondstwo = 000000000000000000000000000497;
const String _videoIdthree = 'https://youtu.be/yjv-NN_rusc?t=';
const double _startSecondsthree = 000000000000000000000000000253;
const String _videoIdfour = 'https://youtu.be/h2m6sHaZ6H4?t=';
const double _startSecondsfour = 000000000000000000000000000132;
const String _videoIdfive = 'https://youtu.be/l4Iu3YB0pTs?t=';
const double _startSecondsfive = 0000000000000000000000000001385;
