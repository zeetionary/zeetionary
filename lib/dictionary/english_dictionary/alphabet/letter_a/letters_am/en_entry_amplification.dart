...
// replace these: replace EnglishEntryamplification - replace speakAmplification - replace amplification - /ˌæmplɪfɪˈkeɪʃn/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryamplification extends StatelessWidget {
  ...
  Future<void> speakAmplification102(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Amplification of this energy promotes fertilization of the surrounding area."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakAmplification44140(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("That comment needs some amplification."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "amplification", // DOPSUM: CHANGE WORD ENTRY - Find /ˌæmplɪfɪˈkeɪʃn/
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAmplification(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () =>
                                    speakAmplification102(// REPLACE: amplification /ˌæmplɪfɪˈkeɪʃn/
                                        "en-US"),
                              ),
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () => speakAmplification44140("en-GB"),
                              ),
                              IconButton(
                                iconSize: 18,
                                icon: const Icon(
                                ...
                                onPressed: () =>
                                    speakAmplification44140(// REPLACE: amplification /ˌæmplɪfɪˈkeɪʃn/
                                        "en-US"),
                              ),
                            ],
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'wBrNbbAIAFo';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'EMeI4N5dui4';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'l23uC4nFIZo';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'wY3Ehw7_4Sg';
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = 'FoLIoqxEBcQ';
