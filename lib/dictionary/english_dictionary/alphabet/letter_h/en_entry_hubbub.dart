...
class EnglishEntryhubbub extends StatefulWidget {
  const EnglishEntryhubbub({super.key});

  @override
  State<EnglishEntryhubbub> createState() => _EnglishEntryhubbubState();
}

class _EnglishEntryhubbubState extends State<EnglishEntryhubbub> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hubbub (Derived forms: hubbubs)
1. Loud confused noise from many sources (- uproar, brouhaha, katzenjammer [US])
""",
  );

  final String keyword = "hubbub";
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It was some time before the hubbub of laughter died down.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/42rA4LkXgvE';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/BgWBZlWjjJk?t=';
    const double startSecondsone = 000000000000000000000000000252;
    const String videoIdtwo = 'https://youtu.be/eZ4nhZnPV9U?t=';
    const double startSecondstwo = 00000000000000000000000000046;
    const String videoIdthree = 'https://youtu.be/--7vNbh4UNA?t=';
    const double startSecondsthree = 000000000000000000000000000122;
    const String videoIdfour = 'https://youtu.be/0mpsro3s5pI?t=';
    const double startSecondsfour = 000000000000000000000000000222;
    const String videoIdfive = 'https://youtu.be/cfOSmkPjuMo?t=';
    const double startSecondsfive = 0000000000000000000000000001146;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hubbub""",
                      // alsoEnglishWord: "also: hubbub",
                      britshText: """IpaUK: /ˈhʌbʌb/""",
                      americanText: """IpaUS: /ˈhʌbʌb/""",
...
// With short examples define "hubbub", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """It was difficult to hear what he was saying over the hubbub.""",
                      kurdishText:
                          """سەخت بوو ببیستیت چی دەگوت لە قاڵەقاڵەکەدا.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ماوەیەکی پێچوو پێش ئەوەی دەنگەدەنگی پێکەنین نەمێنێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Once the hubbub of the election had died down, it was back to normal for the president.""",
                      kurdishText:
                          """هەرکە هەراهەرای هەڵبژاردن نەما، ئاسایی بووەوە بۆ سەرۆک.""",
