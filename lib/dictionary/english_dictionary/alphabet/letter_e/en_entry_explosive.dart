...
class EnglishEntryexplosive extends StatefulWidget {
  const EnglishEntryexplosive({super.key});

  @override
  State<EnglishEntryexplosive> createState() => _EnglishEntryexplosiveState();
}

class _EnglishEntryexplosiveState extends State<EnglishEntryexplosive> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""explosive""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """explosive""",
                      // alsoEnglishWord: "also: explosive",
                      britshText: """IpaUK: /ɪkˈspləʊsɪv/,  /ɪkˈspləʊzɪv/""",
                      americanText: """IpaUS: /ɪkˈspləʊsɪv/,  /ɪkˈspləʊzɪv/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "explosive";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The political situation is potentially explosive.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She has an explosive temper.""");
  }
...
"""),
          ...
          SentencesRow(
            ...
            kurdishText: """دۆخی سیاسی بە ئەگەرەوە پڕمەترسییە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: explosive
1. Liable to lead to sudden change or violence (= volatile)
"an explosive issue";
...
const double _startSecondsend = 0000000000000000000000000001495;
...
const double _startSecondstwo = 000000000000000000000000000965;
const String _videoIdthree = 'https://youtu.be/-L7o6HtX8Vg?t=';
const double _startSecondsthree = 000000000000000000000000000507;
const String _videoIdfour = 'https://youtu.be/Cqbleas1mmo?t=';
const double _startSecondsfour = 000000000000000000000000000190;
const String _videoIdfive = 'https://youtu.be/XI9kKiyIMf0?t=';
