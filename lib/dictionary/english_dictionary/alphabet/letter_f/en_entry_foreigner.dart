...
class EnglishEntryforeigner extends StatefulWidget {
  const EnglishEntryforeigner({super.key});

  @override
  State<EnglishEntryforeigner> createState() => _EnglishEntryforeignerState();
}

class _EnglishEntryforeignerState extends State<EnglishEntryforeigner> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foreigner (Derived forms: foreigners)
1. A person who comes from a foreign country; someone who does not owe allegiance to your country (= alien, noncitizen, outlander)
 
2. Someone who is excluded from or is not a member of a group (= outsider)
""",
  );

  final String keyword = "foreigner";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foreigner""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The fact that I was a foreigner was a big disadvantage.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foreigner""",
                      // alsoEnglishWord: "also: foreigner",
                      britshText: """IpaUK: /ˈfɒrənə(r)/""",
                      americanText: """IpaUS: /ˈfɔːrənər/""",
...
// With short examples define "foreigner", please follow LX instructions
                    const DefinitionKurdish(
                      ...
                      note:
                          "هەندێک جار بەکارهێنانی ئەم وشەیە بەم واتایە گونجاو نییە. دەکرێت بڵێیت 'a person is from overseas'",
                    ),
                    SentencesRow(
                      englishText:
                          """The fact that I was a foreigner was a big disadvantage.""",
                      kurdishText: """ئەوەی کە بیانی بووم کۆسپێک بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I have always been regarded as a foreigner by the local folk.""",
                      kurdishText:
                          """هەمیشە لەلایەن خەڵکە خۆچییەکەوە وەک بێگانە سەیر کراوم.""",
...
const String _videoIdone = 'https://youtu.be/3C0BdIn6Hdo?t=';
const double _startSecondsone = 000000000000000000000000000211;
const String _videoIdtwo = 'https://youtu.be/DS6v2dR4Xbw?t=';
const double _startSecondstwo = 00000000000000000000000000045;
const String _videoIdthree = 'https://youtu.be/76X4JvjpXug?t=';
const double _startSecondsthree = 000000000000000000000000000119;
const String _videoIdfour = 'https://youtu.be/vchJnrZgz-4?t=';
const double _startSecondsfour = 000000000000000000000000000903;
const String _videoIdfive = 'https://youtu.be/ExoOL2lwlWE?t=';
