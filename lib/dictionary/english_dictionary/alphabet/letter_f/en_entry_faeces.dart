...
class EnglishEntryfaeces extends StatefulWidget {
  const EnglishEntryfaeces({super.key});

  @override
  State<EnglishEntryfaeces> createState() => _EnglishEntryfaecesState();
}

class _EnglishEntryfaecesState extends State<EnglishEntryfaeces> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """faeces""",
                      alsoEnglishWord: "also: feces",
                      britshText: """IpaUK: /ˈfiːsiːz/""",
                      americanText: """IpaUS: /ˈfiːsiːz/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""A sample of fresh faeces should be collected each day.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The amount of blood in the faeces was measured.""");
  }
...
کوردی: پیسایی، گوو، ڕیاو(ە)
"""),
          const DefinitionKurdish(text: """١. (ناو) پیسایی مرۆڤ یان ئاژەڵ"""),
          SentencesRow(
            englishText:
                """A sample of fresh faeces should be collected each day.""",
            kurdishText: """نموونەیەکی پیسایی تازە دەبێت هەموو ڕۆژێک کۆبکرێتەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The amount of blood in the faeces was measured.""",
            kurdishText: """بڕی خوێن لە پیساییەکەدا پێورا.""",
...
const String _videoIdend = 'https://youtu.be/w5DDs7qENQY?t=';
const double _startSecondsend = 000000000000000000000000000423;
const String _videoIdone = 'https://youtu.be/77TFgWlpoc8?t=';
const double _startSecondsone = 0000000000000000000000000001300;
const String _videoIdtwo = 'https://youtu.be/8B6paShzbBU?t=';
const double _startSecondstwo = 000000000000000000000000000457;
const String _videoIdthree = 'https://youtu.be/xZbcJ0ocZ2E?t=';
const double _startSecondsthree = 000000000000000000000000000465;
const String _videoIdfour = 'https://youtu.be/iKnEJXOz6nY?t=';
const double _startSecondsfour = 00000000000000000000000000097;
const String _videoIdfive = 'https://youtu.be/8tbWgnFbEBI?t=';
const double _startSecondsfive = 000000000000000000000000000418;
