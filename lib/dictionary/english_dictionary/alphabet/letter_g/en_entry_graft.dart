...
// کوردی: تووز، چووز، پەیوەند، متوربە، پەیوەست،	جێگای متوربە، فتروونە، پەیوەستگا،	نەمام، چووز، خەڵف، قەڵەمە،	ڕووەکی متوربەکراو، پارتی‌بازی،	بەرتیل، بەرتیل‌خۆری، دزی، دەسکیسی، کاری گران یا سەخت، کردوکۆش، هەوڵ، چنگەکڕێ، کڕناوکڕن
// """),
// With short examples define "graft", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) پارچەیەک کە لە ڕووەکێک کراوەتەوە و دەدرێت لە یەکێکی دیکە بۆ ئەوەی لەوێ گەشە بکات؛ پڕۆسەی لێکردنەوەی پێست، ئێسک، هتد لە بەشێکی جەستە و دانانی لە بەشێکی دیکە کە زیانی پێگەشتووە؛ پڕۆسەی کردنی ئەمە"""),
                    SentencesRow(
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) بەکارهێنانی ڕێگای نادادی یان نایاسایی، بە تایبەتی بەرتیل، بۆ بەدەستهێنانی شتێک؛ ئەو پارەیەی بەم شێوەیە دەست دەکەوێت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He promised an end to graft and corruption in public life.""",
                      kurdishText:
                          """بەڵێنی دا کۆتایی بە دەسکیسی و گەندەڵی بهێنێت لە ژیانی گشتیدا.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (کردار) گوستنەوەی پێست، ئێسک، هتد لە بەشێکی زیندووی لەش و دانانی لەسەر بەشێکی زیان پێگەشتوو؛ بڕینی بەشێکی ڕووەکێک و دانانی لەسەر ڕووەکیکی دیکە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                    ...
                    const DefinitionKurdish(
                        text:
                            """٥. (کردار) ئەوەی بیرۆکەیەک، سیستەمێک، هتد بکەیت بە بەشێک لە دانەیەکی دیکە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The management tried unsuccessfully to graft new working methods onto the existing ways of doing things.""",
                      kurdishText:
                          """بەڕێوەبەرایەتییەکە بێسوود هەوڵی دا شێوازی کارکردنی نوێ زیاد بکات بۆ ڕێگە باوەکانی ئێستای ئەنجامدانی کارەکان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/HZryl5nJr00?t=';
const double _startSecondsend = 000000000000000000000000000908;
const String _videoIdone = 'https://youtu.be/HZryl5nJr00?t=';
const double _startSecondsone = 000000000000000000000000000907;
const String _videoIdtwo = 'https://youtu.be/apDoJkfR85A?t=';
const double _startSecondstwo = 000000000000000000000000000834;
const String _videoIdthree = 'https://youtu.be/CdGKfBir7bI?t=';
...
const String _videoIdfive = 'https://youtu.be/PhJhJfMp658?t=';
const double _startSecondsfive = 000000000000000000000000000654;
