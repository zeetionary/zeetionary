...
class EnglishEntryknowingly extends StatefulWidget {
  const EnglishEntryknowingly({super.key});

  @override
  State<EnglishEntryknowingly> createState() => _EnglishEntryknowinglyState();
}

class _EnglishEntryknowinglyState extends State<EnglishEntryknowingly> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryknowingly knowingly
WORD_WEB knowingly knowingly knowingly
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "knowingly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""knowingly""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """knowingly""",
                      // alsoEnglishWord: "also: knowingly",
...
کوردی: 
"""),
// With short examples define "knowingly", please follow LX instructions
