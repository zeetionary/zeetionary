...
class EnglishEntryfreshness extends StatefulWidget {
  const EnglishEntryfreshness({super.key});

  @override
  State<EnglishEntryfreshness> createState() => _EnglishEntryfreshnessState();
}

class _EnglishEntryfreshnessState extends State<EnglishEntryfreshness> {
  @override
  void initState() {
    super.initState();
...
2. Originality by virtue of being refreshingly novel (= novelty)
 
3. An alert and refreshed state (= glow)
 
4. Originality by virtue of being new and surprising (= novelty)
 
5. The trait of being rude and impertinent; inclined to take liberties (= crust, gall, impertinence, impudence, insolence, cheekiness)
""",
  );

  final String keyword = "freshness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""freshness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We guarantee the freshness of all our produce.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I like the freshness of his approach to the problem.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """freshness""",
                      // alsoEnglishWord: "also: freshness",
                      britshText: """IpaUK: /ˈfreʃnəs/""",
                      americanText: """IpaUS: /ˈfreʃnəs/""",
...
// With short examples define "freshness", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """گەرەنتی تازەیی هەموو بەرهەمەکانمان دەکەین.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Based on the freshness of the tyre tracks, they were only one or two hours' drive ahead of us.""",
                      kurdishText:
                          """بە پێی تازەیی شوێنی تایەکان، ئەوان تەنها یەک یان دوو کاتژمێر لە پێشمانەوە بوون.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """حەزم لە تازەگەریی چارەسەرەکەیەتی بۆ کێشەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """This wine has a freshness and vitality that appeals to many drinkers.""",
                      kurdishText:
                          """شەرابەکە خۆشییەکی هەیە کە سەرنجی زۆر مەیخۆر ڕادەکێشێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/X5oD_thIk3c?t=';
const double _startSecondsend = 000000000000000000000000000251;
const String _videoIdone = 'https://youtu.be/NM4ArR-qbHQ?t=';
const double _startSecondsone = 000000000000000000000000000542;
const String _videoIdtwo = 'https://youtu.be/Z36OznHFIt4?t=';
const double _startSecondstwo = 000000000000000000000000000312;
const String _videoIdthree = 'https://youtu.be/jwZBl6KQojM?t=';
const double _startSecondsthree = 000000000000000000000000000287;
const String _videoIdfour = 'https://youtu.be/xj-6hC5GFfI?t=';
const double _startSecondsfour = 000000000000000000000000000106;
const String _videoIdfive = 'https://youtu.be/HzUIUTatyZI?t=';
const double _startSecondsfive = 000000000000000000000000000315;
