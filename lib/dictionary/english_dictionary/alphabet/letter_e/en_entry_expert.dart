...
class EnglishEntryexpert extends StatefulWidget {
  const EnglishEntryexpert({super.key});

  @override
  State<EnglishEntryexpert> createState() => _EnglishEntryexpertState();
}

class _EnglishEntryexpertState extends State<EnglishEntryexpert> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """expert""",
                      // alsoEnglishWord: "also: expert",
                      britshText: """IpaUK: /ˈekspɜːt/""",
                      americanText: """IpaUS: /ˈekspɜːrt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I don't pretend to be an expert on the subject .""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Nobody can be an expert at everything.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""You will need to become an expert in analysing data.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Don't ask me—I'm no expert!""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Only a fully qualified doctor can give an expert opinion.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They are expert in these matters.""");
  }
...
کوردی: شارەزا، کارزان، لێزان، سەرڕشتەدار، پسپۆڕ، تایبەت‌کار، تایبەت‌گەر، بەئەزموون، کارامە، خاراو
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) کەسێک کە شارەزایی، زانیاری، یان ڕاهێنانی لە شتێک هەبووە """),
          SentencesRow(
            englishText:
                """Experts in the field of child psychology warn of the dangers of social media.""",
            kurdishText:
                """شارەزایانی بواری دەروونناسیی منداڵان هۆشداری دەدەن سەبارەت بە مەترسی تۆڕە کۆمەڵایەتییەکان.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """I don't pretend to be an expert on the subject .""",
            kurdishText: """وای پیشان نادەم شارەزا بم لە بابەتەکە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Nobody can be an expert at everything.""",
            kurdishText: """کەس ناتوانێت شارەزا بێت لە هەموو شت.""",
          ...
          SentencesRow(
            ...
            kurdishText: """دەبێت ببیت بە شارەزا لە شیکردنەوەی داتا.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """Don't ask me—I'm no expert!""",
            kurdishText: """لە من مەپرسە ـ پسپۆڕ نیم.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """تەنها پزیشکێکی تەواو لێوەشاوە دەتوانێت بۆچوونێکی وەها شارەزایانە بدات.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """They are expert in these matters.""",
            kurdishText: """لەم بابەتانە پسپۆڕن.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He has become expert on European politics.""",
            kurdishText: """بووە بە پسپۆڕی لە سیاسەتی ئەورووپا.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: expert (Derived forms: experts)
1. A person with special knowledge or ability who performs skilfully

- Adjective: expert
1. Having or showing knowledge and skill and aptitude (= adept, good, practiced [N. Amer], proficient, skillful [N. Amer], skilful [Brit, Cdn], practised [Brit, Cdn])
"an expert job";
 
2. Of or relating to or requiring special knowledge to be understood (= technical)
"expert terminology";
""",
  );
...
const double _startSecondsend = 000000000000000000000000000000; // 13;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/NZ74oFctP_g?t=';
const double _startSecondsone = 00000000000000000000000000000; // 25;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/h4CyhQqAPpk?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 705;
const String _videoIdthree = 'VIDEOhttps://youtu.be/s3B-qp3U5G0?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1494;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/AF8d72mA41M?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 870;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/3cxHwQl9pNM?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 202;
