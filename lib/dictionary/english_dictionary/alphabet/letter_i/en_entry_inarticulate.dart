...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'i44KnocYsno';
    const double startSecondsend = 416;
    const String videoIdone = '4vjCdHWAmps';
    const double startSecondsone = 341;
    const String videoIdtwo = 'IHy6iXcj004';
    const double startSecondstwo = 937;
    const String videoIdthree = 'exk8GrGwxGs';
    const double startSecondsthree = 1137;
    const String videoIdfour = 'e-_lA2Ug-cE';
    const double startSecondsfour = 982;
    const String videoIdfive = 'b8IYV_R72VE';
