...
class EnglishEntryhate extends StatefulWidget {
  const EnglishEntryhate({super.key});

  @override
  State<EnglishEntryhate> createState() => _EnglishEntryhateState();
}

class _EnglishEntryhateState extends State<EnglishEntryhate> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: hate (Derived forms: hating, hated, hates)
1. Dislike intensely; feel antipathy or aversion towards (- detest)
"I hate Mexican food";
 
2. To have and express negative sentiments about a person

- Noun: hate (Derived forms: hates)
1. The emotion of intense dislike; a feeling of dislike so strong that it demands action (- hatred)
 
2. A person or thing that is strongly disliked
"one of my pet hates is graffiti vandalism"
""",
  );

  final String keyword = "hate";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The two boys hated each other.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Sometimes I really hate him.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I hate spinach.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I really hate Monday mornings.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I hate the way she always criticizes me.""");
  }
  ...
  Future<void> speaksentence21(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She hated the dreariness of her everyday life.""");
  }
  ...
  Future<void> speaksentence26(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She gave him a look of real hate.""");
  }
  ...
  Future<void> speaksentence28(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She was full of hate for the people who had betrayed her.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hate""",
                      // alsoEnglishWord: "also: hate",
                      britshText: """IpaUK: /heɪt/""",
                      americanText: """IpaUS: /heɪt/""",
...
// کوردی:
// """),
// With short examples define "hate", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (کردار) ڕقی زۆر لە کەسێک/شتێک"""),
                    SentencesRow(
                      englishText: """The two boys hated each other.""",
                      kurdishText: """دوو کوڕەکە ڕقیان لە یەکدی بوو.""",
                    ...
                    Column(
                      children: [
                        MyExpansionTile(
                          children: [
                            SentencesRow(
                              englishText: """Sometimes I really hate him.""",
                              kurdishText: """هەندێکجار بە ڕاستی ڕقم لێیەتی.""",
                              onPressedBritish: () => speaksentence2("en-GB"),
                              onPressedAmerican: () => speaksentence2("en-US"),
                            ),
                            const DividerSentences(),
                            SentencesRow(
                              englishText: """I hate spinach.""",
                              kurdishText: """ڕقم لە سپێناخە.""",
                              onPressedBritish: () => speaksentence3("en-GB"),
                              onPressedAmerican: () => speaksentence3("en-US"),
                            ),
                            const DividerSentences(),
                            SentencesRow(
                              englishText: """I really hate Monday mornings.""",
                              kurdishText:
                                  """بە ڕاستی ڕقم لە بەیانیانی دووشەممەیە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """ڕقم لەوەیە هەمیشە ڕەخنەم لێ دەگرێت.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  "ڕقم لێیە نائومێدت بکەم، بەڵام حەزم پێی نییە.",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  "زۆرینەی پشیلە ماڵییەکان ڕقیان لەوەیە تەڕبن.",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """ڕقی لێیە قسە لەسەر ھەستەکانی بکات.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """پشیلەکەمان ڕقی لێیە دەستی لێبدرێت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) بەکاردێت لە کاتی گوتنی شتێک کە حەز ناکەیت بیڵێیت، یان کە بە ڕێزەە داوای کردنی شتێک دەکەیت"""),
                    SentencesRow(
                      englishText:
                          """I hate to say it, but I don't think their marriage will last.""",
                      kurdishText:
                          """بەداخەوەم کە بیڵێم، بەڵام پێم وانییە هاوسەرگیرییەکەیان بەردەوام ببێت.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I hate to say it, but I don't think their marriage will last.""",
                      kurdishText:
                          """بەداخەوەم کە لە کاتت بگرم، بەڵام دەتوانم موبایلەکەت بەکاربهێنم؟""",
                      onPressedBritish: () => speaksentence25("en-GB"),
                      onPressedAmerican: () => speaksentence25("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ڕق لە کەسێک"""),
                    const AlsoEnglishckb(word: "ھەروەھا: hatred"),
                    SentencesRow(
                      englishText: """She gave him a look of real hate.""",
                      kurdishText: """نیگایەکی ڕقی ڕاستی لێی کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پڕ لە ڕق بوو بۆ ئەو کەسانەی خیانەتیان لێی کردبوو.""",
                      onPressedBritish: () => speaksentence28("en-GB"),
                      onPressedAmerican: () => speaksentence28("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (ناو) کەسێک/شتێک کە ڕقت لێیەتی"""),
                    SentencesRow(
                      englishText:
                          """Plastic flowers have always been a particular hate of mine.""",
                      kurdishText:
                          """گوڵی پلاستیکی هەمیشە جێگای ڕقی من بوونە.""",
...
const double _startSecondstwo = 000000000000000000000000000402;
const String _videoIdthree = 'https://youtu.be/f8VTSGLCa1M?t=';
const double _startSecondsthree = 000000000000000000000000000324;
const String _videoIdfour = 'https://youtu.be/BNRItz1Ngt0?t=';
