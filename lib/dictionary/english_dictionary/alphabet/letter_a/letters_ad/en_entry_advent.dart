...
// replace these: replace EnglishEntryadvent - replace speakAdvent - replace advent - /ˈædvent/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadvent extends StatelessWidget {
  EnglishEntryadvent({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "advent", // DOPSUM: CHANGE WORD ENTRY - Find /ˈædvent/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˈædvent/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'ErWndm9sz7M';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'gvoPG9DFv-g';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'FLnzShTUYGc';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'yPH0Y_ZLS5k';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '7BA3LFP5pFA';
