...
class EnglishEntrylaxative extends StatefulWidget {
  const EnglishEntrylaxative({super.key});

  @override
  State<EnglishEntrylaxative> createState() => _EnglishEntrylaxativeState();
}

class _EnglishEntrylaxativeState extends State<EnglishEntrylaxative> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""laxative""");
  }
