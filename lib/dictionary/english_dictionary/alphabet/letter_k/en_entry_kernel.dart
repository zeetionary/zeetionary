...
class EnglishEntrykernel extends StatefulWidget {
  const EnglishEntrykernel({super.key});

  @override
  State<EnglishEntrykernel> createState() => _EnglishEntrykernelState();
}

class _EnglishEntrykernelState extends State<EnglishEntrykernel> {
  @override
  void initState() {
    super.initState();
