...
class EnglishEntryhighly extends StatefulWidget {
  const EnglishEntryhighly({super.key});

  @override
  State<EnglishEntryhighly> createState() => _EnglishEntryhighlyState();
}

class _EnglishEntryhighlyState extends State<EnglishEntryhighly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: highly
1. To a high degree or extent; favourably or with much respect (- extremely, majorly [informal])
"highly successful"; "He spoke highly of her"; "does not think highly of his writing";
 
2. At a high rate or wage
"highly paid workers"
 
3. In a high position, level or rank
"details known by only a few highly placed persons"
""",
  );

  final String keyword = "highly";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It is highly unlikely that she'll be late.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The US car market is highly competitive.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His choice of subject is highly significant.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The region boasts a highly skilled workforce.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She speaks highly of you.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her novels are very highly regarded.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/rsaLUIeurZ8?t=';
    const double startSecondsone = 000000000000000000000000000342;
    const String videoIdtwo = 'https://youtu.be/yjhibJ-OqxE?t=';
    ...
    const double startSecondsfour = 000000000000000000000000000107;
    const String videoIdfive = 'https://youtu.be/sV6uuMAnJUE?t=';
    const double startSecondsfive = 000000000000000000000000000712;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """highly""",
                      // alsoEnglishWord: "also: highly",
                      britshText: """IpaUK: /ˈhaɪli/""",
                      americanText: """IpaUS: /ˈhaɪli/""",
...
کوردی: زۆر، یەکجار
"""),
// With short examples define "highly", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵکار) زۆر"""),
                    SentencesRow(
                      englishText:
                          """It is highly unlikely that she'll be late.""",
                      kurdishText: """تەواو ئەگەری کەمە کە درەنگ بکەوێت.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بازاڕی ئۆتۆمبێلی ئەمریکا تەواو ڕکەبەرانەیە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەڵبژاردنی بابەتەکی تەواو گرنگە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵکار) لە ستاندارد، بڕ، یان ئاستێکی بەرز"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The region boasts a highly skilled workforce.""",
                      kurdishText:
                          """هەرێمەکە دەستێکی کاری زۆری شارەزای هەیە.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ھاوەڵکار) بە ڕێزی زۆرەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She speaks highly of you.""",
                      kurdishText: """بە ڕێزەوە باست دەکات.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her novels are very highly regarded.""",
                      kurdishText: """ڕؤمانەکانی بە ڕێزەوە سەیر دەکرێن.""",
