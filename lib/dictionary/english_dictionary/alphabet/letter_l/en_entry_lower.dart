...
class EnglishEntrylower extends StatefulWidget {
  const EnglishEntrylower({super.key});

  @override
  State<EnglishEntrylower> createState() => _EnglishEntrylowerState();
}

class _EnglishEntrylowerState extends State<EnglishEntrylower> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylower lower
WORD_WEB lower lower lower
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lower";
...
کوردی: 
"""),
// With short examples define "lower", please follow LX instructions
