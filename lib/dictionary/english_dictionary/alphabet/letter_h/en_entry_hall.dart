...
class EnglishEntryhall extends StatefulWidget {
  const EnglishEntryhall({super.key});

  @override
  State<EnglishEntryhall> createState() => _EnglishEntryhallState();
}

class _EnglishEntryhallState extends State<EnglishEntryhall> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hall (Derived forms: halls, Halls)
1. An interior passage or corridor onto which rooms open (- hallway)
"the elevators were at the end of the hall";
 
2. A large entrance, reception room, or waiting area (- anteroom, antechamber, entrance hall, foyer, lobby, vestibule)
 
3. A large room for gatherings, receiving guests, or entertainment
"lecture hall"; "pool hall"
 
4. A college or university building containing living quarters for students (- dormitory, dorm, residence hall, student residence)
 
5. The large room of a manor or castle (- manor hall)
 
6. A large and imposing house (- mansion, mansion house, manse [archaic], residence)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her brother was standing in the front hall.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She ran into the hall and up the stairs.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I headed for Scott's office down the hall.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There are three dining halls on campus.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""next meeting is in the hall on Tuesday.""");
  }
...
// With short examples define "hall", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) بۆشاییەک یان ڕێڕەوێک لە دەرگای سەرەکی بینایەک"""),
                    SentencesRow(
                      englishText: """Her brother was standing in the front hall.""",
                    ...
                    SentencesRow(
                      englishText: """She ran into the hall and up the stairs.""",
                      kurdishText: """ڕایکرد هۆڵەکە بە پلەکانەکەدا چووە سەرەوە.""",
                      onPressedBritish: () => speaksentence2("en-GB"),
                      onPressedAmerican: () => speaksentence2("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) ڕێڕەوی بینایەک کە لە هەردوو لایەوە ژووڕی تێدایە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: corridor"),
                    SentencesRow(
                      englishText: """I headed for Scott's office down the hall.""",
                      kurdishText: """بە ڕێڕەوەکەدا چووم بۆ ئۆفیسی سکۆت.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) بینا یان ژوورێکی گەورە بۆ چاوپێکەوتنی گشتی، نانخواردن، کۆنسێرت، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There are three dining halls on campus.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """next meeting is in the hall on Tuesday.""",
                      kurdishText: """چاوپێکەوتنی دواتر لە هۆڵەکەیە لە ڕۆژی سێشەممە.""",
                    ...
                    textAfterLink: "",
                    onTap: () {
                    Routemaster.of(context).push("/english-hall/dormitory");
                    },
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """ژممر. (ناو) پننسە"""),
