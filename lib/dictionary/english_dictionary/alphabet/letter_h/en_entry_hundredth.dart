...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'AwodL8z2EtE';
    const double startSecondsend = 1246;
    const String videoIdone = 'gkJ4qv5RLRc';
    const double startSecondsone = 262;
    const String videoIdtwo = 'XHXLbp7x3MM';
    const double startSecondstwo = 721;
    const String videoIdthree = 'A7afwIxo5lE';
    const double startSecondsthree = 191;
    const String videoIdfour = 'xmQJGsyFPXA';
    const double startSecondsfour = 655;
    const String videoIdfive = 'wQ-3fUJlNuc';
