...
class EnglishEntryimagination extends StatefulWidget {
  const EnglishEntryimagination({super.key});

  @override
  State<EnglishEntryimagination> createState() =>
      _EnglishEntryimaginationState();
}

class _EnglishEntryimaginationState extends State<EnglishEntryimagination> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: imagination (Derived forms: imaginations)
1. The formation of a mental image of something that is not perceived as real and is not present to the senses (- imaginativeness, vision)
"popular imagination created a world of demons"; "imagination reveals what the world could be";
 
2. The ability to form mental images of things or events (- imaging, imagery, mental imagery)
"he could still hear her in his imagination";
 
3. The ability to deal resourcefully with unusual problems (- resource, resourcefulness)
"a man of imagination";
""",
  );

  final String keyword = "imagination";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""imagination""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""It doesn't take much imagination to guess what she meant.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Is it my imagination or have you lost a lot of weight?""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/-6vzjjIrRK8?t=';
    const double startSecondsend = 000000000000000000000000000198;
    const String videoIdone = 'https://youtu.be/AdYaTa_lOf4?t=';
    const double startSecondsone = 00000000000000000000000000054;
    const String videoIdtwo = 'https://youtu.be/Js2UoMSumx4?t=';
    const double startSecondstwo = 00000000000000000000000000046;
    const String videoIdthree = 'https://youtu.be/qjqh9UVfNNk?t=';
    const double startSecondsthree = 000000000000000000000000000113;
    const String videoIdfour = 'https://youtu.be/anbBwpoI9TI?t=';
    const double startSecondsfour = 000000000000000000000000000287;
    const String videoIdfive = 'https://youtu.be/UO3N_PRIgX0?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """imagination""",
                      // alsoEnglishWord: "also: imagination",
                      britshText: """IpaUK: /ɪˌmædʒɪˈneɪʃn/""",
                      americanText: """IpaUS: /ɪˌmædʒɪˈneɪʃn/""",
...
کوردی: 
"""),
// With short examples define "imagination", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) خەیاڵکردن"""),
                    SentencesRow(
                      englishText:
                          """It doesn't take much imagination to guess what she meant.""",
                      kurdishText:
                          """پێویستی بە خەیاڵکردنی زۆر نییە کە ئەوە بخەمڵێنیت مەبەستی چییە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """It requires no great exertion of the imagination to recognize the truth of this.""",
                      kurdishText:
                          """پێویستیی بە ھێزی زۆری خەیاڵ نییە بۆ بینینی ڕاستی ئەمە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) شتێک کە خەیاڵت کردووە و بوونی نییە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Is it my imagination or have you lost a lot of weight?""",
                      kurdishText:
                          """ئەوە خەیاڵی منە یان کێشی زۆرت لەدەستداوە؟""",
                    ...
                    SentencesRow(
                      englishText:
                          """She was no longer able to distinguish between imagination and reality.""",
                      kurdishText:
                          """چیتر نەیدەتوانی جیاوازی نێوان خەیاڵ و ڕاستی بکات؟""",
                      onPressedBritish: () => speaksentence7("en-GB"),
                      onPressedAmerican: () => speaksentence7("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٣. (ناو) توانای هەبوونی بیرۆکەی تازە و خۆش"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """With a little imagination, you could turn this place into a palace.""",
                      kurdishText:
                          """بە کەمێک خەیاڵکردن، دەتوانیت ئەم شوێنە بکەیت بە کۆشک.""",
