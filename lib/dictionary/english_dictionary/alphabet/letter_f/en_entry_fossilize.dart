...
class EnglishEntryfossilize extends StatefulWidget {
  const EnglishEntryfossilize({super.key});

  @override
  State<EnglishEntryfossilize> createState() => _EnglishEntryfossilizeState();
}

class _EnglishEntryfossilizeState extends State<EnglishEntryfossilize> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: fossilize (Derived forms: fossilized, fossilizes, fossilizing)
1. Convert to a fossil (= fossilise [Brit])
"The little animals fossilized and are now embedded in the limestone";
 
2. Become mentally inflexible (= fossilise [Brit])
""",
  );

  final String keyword = "fossilize";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fossilize""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Flowers do not readily fossilize.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Our ideas can sometimes fossilize as we get older.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fossilize""",
                      // alsoEnglishWord: "also: fossilize",
                      britshText: """IpaUK: /ˈfɒsəlaɪz/""",
                      americanText: """IpaUS: /ˈfɑːsəlaɪz/""",
...
// With short examples define "fossilize", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Flowers do not readily fossilize.""",
                      kurdishText: """گوڵ نابێت بە بەبەردبوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بیرۆکەکانمان هەندێک جار جێگیر دەبن کە دەچین بە تەمەندا.""",
                      englishNote:
                          "This means that our ideas or opinions can become outdated or fixed over time as we age.",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/BMoF4iupwfw?t=';
...
const String _videoIdtwo = 'https://youtu.be/ut6vosxD_lM?t=';
const double _startSecondstwo = 00000000000000000000000000055;
const String _videoIdthree = 'https://youtu.be/ok7sBzo8R34?t=';
const double _startSecondsthree = 00000000000000000000000000077;
const String _videoIdfour = 'https://youtu.be/p0_-7FmrDq8?t=';
const double _startSecondsfour = 0000000000000000000000000002378;
const String _videoIdfive = 'https://youtu.be/TxmkZBYDPOQ?t=';
