...
class EnglishEntrygodly extends StatefulWidget {
  const EnglishEntrygodly({super.key});

  @override
  State<EnglishEntrygodly> createState() => _EnglishEntrygodlyState();
}

class _EnglishEntrygodlyState extends State<EnglishEntrygodly> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """She is considered a godly woman in her community for her faith.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """godly""",
                      // alsoEnglishWord: "also: godly",
                      britshText: """IpaUK: /ˈɡɒdli/""",
                      americanText: """IpaUS: /ˈɡɑːdli/""",
...
// With short examples define "godly", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) هەبوونی ژیانێکی باوەڕدارانە"""),
                    SentencesRow(
                      englishText:
                          """She is considered a godly woman in her community for her faith.""",
                      kurdishText:
                          """بەهۆی باوەڕەکەیەوە لە کۆمەڵگاکەیدا بە ژنێکی خواناس دادەنرێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/YlQn51TCCpo?t=';
const double _startSecondsend = 000000000000000000000000000145;
const String _videoIdone = 'https://youtu.be/G3LZ-Jh2L6E?t=';
const double _startSecondsone = 0000000000000000000000000001013;
const String _videoIdtwo = 'https://youtu.be/kAgTZSJ4jo8?t=';
const double _startSecondstwo = 00000000000000000000000000010;
const String _videoIdthree = 'https://youtu.be/FPRExtm7MTQ?t=';
...
const String _videoIdfive = 'https://youtu.be/kpDpiYmPcMM?t=';
