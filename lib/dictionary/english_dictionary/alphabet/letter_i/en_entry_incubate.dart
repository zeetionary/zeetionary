...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000617;
    const String videoIdone = 'https://youtu.be/zPwdjOPTodk?t=';
    const double startSecondsone = 000000000000000000000000000613;
    const String videoIdtwo = 'https://youtu.be/EywZ5VGNZuQ?t=';
    const double startSecondstwo = 000000000000000000000000000886;
    const String videoIdthree = 'https://youtu.be/9E_ETcBUdPw?t=';
    const double startSecondsthree = 000000000000000000000000000835;
    const String videoIdfour = 'https://youtu.be/yPnoyh04h_0?t=';
    const double startSecondsfour = 000000000000000000000000000616;
    const String videoIdfive = 'https://youtu.be/jn9Od4oP8D0?t=';
