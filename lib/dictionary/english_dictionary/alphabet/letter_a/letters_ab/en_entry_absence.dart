...
class EnglishEntryabsence extends StatefulWidget {
  const EnglishEntryabsence({super.key});

  @override
  State<EnglishEntryabsence> createState() => _EnglishEntryabsenceState();
}

class _EnglishEntryabsenceState extends State<EnglishEntryabsence> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""absence""");
  }
  ...
  Future<void> speaka2134(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("The case was dismissed in the absence of any definite proof.");
  }
  ...
  Future<void> speaka2689(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("We did not receive any news during his long absence.");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """absence""",
                      // alsoEnglishWord: "also: absence",
                      britshText: """IpaUK: /ˈæbsəns/""",
                      americanText: """IpaUS: /ˈæbsəns/""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final double _startSeconds = 2031;
