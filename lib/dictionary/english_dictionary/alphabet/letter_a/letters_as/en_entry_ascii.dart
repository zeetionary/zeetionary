...
class EnglishEntryASCII extends StatelessWidget {
  ...
  Future<void> speakascii130(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Save the text as an ASCII file.");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "ASCII"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈæski/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈæski/"),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'TmoRowBRZvY';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = '6BqpU4V0Ypk';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'ggasfCOmQK8';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '55iwMYv8tGI';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'hF1bIT1ym4g';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'YoXxevp1WRQ';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'vpbH_A2vya8';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = '1tnj3UCkuxU';
