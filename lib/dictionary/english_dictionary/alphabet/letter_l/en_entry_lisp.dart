...
class EnglishEntrylisp extends StatefulWidget {
  const EnglishEntrylisp({super.key});

  @override
  State<EnglishEntrylisp> createState() => _EnglishEntrylispState();
}

class _EnglishEntrylispState extends State<EnglishEntrylisp> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: lisp (Derived forms: lisps)
1. A speech defect that involves pronouncing 's' like voiceless 'th' and 'z' like voiced 'th'

- Verb: lisp (Derived forms: lisps, lisping, lisped)
1. Speak with a lisp

- Noun: LISP
1. A flexible procedure-oriented programing language that manipulates symbols in the form of lists (- list-processing language)
""",
  );

  final String keyword = "lisp";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She spoke with a slight lisp.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/irBVm7xvxR0?t=75';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/LhR5w1bc6Xg?t=749';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/nYRefC7E9gU?t=70';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/xgQT4A6dS_o?t=451';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/D1HdqsZ9cGw';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/CR-mfXneiho?t=37';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lisp""",
                      // alsoEnglishWord: "also: lisp",
                      britshText: """IpaUK: /lɪsp/""",
                      americanText: """IpaUS: /lɪsp/""",
...
کوردی: 
"""),
// With short examples define "lisp", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) کێشەیەک لە قسەکردندا کە تێیدا س بە ث دەخوێندرێتەوە"""),
                    SentencesRow(
                      englishText: """She spoke with a slight lisp.""",
                      kurdishText: """بە کەمێک سەرزمان گرتنەوە قسەی دەکرد.""",
