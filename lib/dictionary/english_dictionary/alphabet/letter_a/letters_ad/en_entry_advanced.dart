...
// replace these: replace EnglishEntryadvanced - replace speakAdvanced - replace advanced - /ədˈvænst/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadvanced extends StatelessWidget {
  EnglishEntryadvanced({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "advanced", // DOPSUM: CHANGE WORD ENTRY - Find /ədˈvɑːnst/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ədˈvɑːnst/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                              ...
                              onPressed: () =>
                                  speakAdvanced(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'Zo7sRijXG00';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'jpSRHB-wJ14';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = '19fxN2lXQXU';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'aPEy3QwsKjQ';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'Fa4jyM-p8zI';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = 'dsN6FiF9ncI';
