...
// Define the word "bagpipes" and provide three example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace bagpipes - replace EnglishEntrybagpipes

// replace speakBagpipes - /ˈbæɡpaɪps/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntrybagpipes extends StatelessWidget {
// blank divider
  EnglishEntrybagpipes({super.key});
// blank divider
  ...
  Future<void> speakbagpipes(String languageCode) async {
    ...
    await flutterTts.speak("bagpipes");
  }
  ...
  Future<void> speakbagpipess1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("She started learning the bagpipes three years ago.");
  }
  ...
  Future<void> speakbagpipess2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBagpipess22");
  }
  ...
  Future<void> speakbagpipess3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBagpipess33");
  }
  ...
  Future<void> speakbagpipess4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBagpipess44");
  }
  ...
  Future<void> speakbagpipess5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBagpipess55");
  }
  ...
  Future<void> speakbagpipess6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBagpipess66");
  }
  ...
  Future<void> speakbagpipess7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBagpipess77");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈbæɡpaɪps/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈbæɡpaɪps/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakbagpipess1("en-US"),
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'YlUCOd9jCZM';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'jgOi_gxyQ0c';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '5nxgO9b_qVY';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'hm7x0PEX8j0';
  final double _startSeconds = 0;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'yW2lW121lrQ';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'IQriT9dPq60';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'LdJbBWpa9DU';
...
// end bagpipes // TODO Implement this library.
