...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 2559;
    const String videoIdone = 'hS2emKDlGmE';
    const double startSecondsone = 302;
    const String videoIdtwo = 'P6bVl47kdNk';
    const double startSecondstwo = 1778;
    const String videoIdthree = 'RXXMJAU6vY8';
    const double startSecondsthree = 943;
    const String videoIdfour = 'BmUrJaOo1Lw';
    const double startSecondsfour = 314;
    const String videoIdfive = 'dUjlMY_Y1Mg';
    const double startSecondsfive = 1130;
