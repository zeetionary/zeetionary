...
class EnglishEntryfury extends StatefulWidget {
  const EnglishEntryfury({super.key});

  @override
  State<EnglishEntryfury> createState() => _EnglishEntryfuryState();
}

class _EnglishEntryfuryState extends State<EnglishEntryfury> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fury (Derived forms: furies)
1. A feeling of intense anger (- rage, madness)
"hell hath no fury like a woman scorned";
 
2. State of violent mental agitation (- craze, delirium, frenzy, hysteria)
"The rock musician worked the crowd of young girls into a fury";
 
3. The property of being wild or turbulent (- ferocity, fierceness, furiousness, vehemence, violence, wildness, vehemency)
"the storm's fury";
""",
  );

  final String keyword = "fury";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her eyes blazed with fury.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Fury over tax increases.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Fury erupted over a speech made by the Prime Minister.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She kicked the tree in fury at her own stupidity.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She directed her fury at her father.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He flew into a fury when I refused.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He shouted at her in a fury, ‘Get out of my house!’""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fury""",
                      // alsoEnglishWord: "also: fury",
                      britshText: """IpaUK: /ˈfjʊəri/""",
                      americanText: """IpaUS: /ˈfjʊri/""",
...
کوردی: توورەیی زۆر، ورووژاوی، هەژیوی، ئاڵۆزاوی،	توندوتیژی، سەختی،	شێتی
"""),
// With short examples define "fury", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """Her eyes blazed with fury.""",
                      kurdishText:
                          """چاوەکانی لە تووڕەییدا ئاگریان لێدەباری.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تووڕەیی بەهۆی باجەوە زیاد دەکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تووڕەیی درووست بوو بەهۆی وتارێکی سەرۆک وەزیرانەوە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لە گەمژەیی خۆیدا شەقێکی لە دارەکە دا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She directed her fury at her father.""",
                      kurdishText: """تووڕەیی خۆی ئاراستەی باوکی کرد.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە تووڕەییدا هاواری کرد 'لە ماڵەکەم بچۆ دەرەوە!'""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/ZYVVUQ80Okk?t=';
const double _startSecondsend = 00000000000000000000000000011;
const String _videoIdone = 'https://youtu.be/eDqjIY7xL-4?t=';
const double _startSecondsone = 000000000000000000000000000620;
...
const double _startSecondsthree = 00000000000000000000000000086;
const String _videoIdfour = 'https://youtu.be/EmT0i0xG6zg?t=';
const double _startSecondsfour = 0000000000000000000000000004016;
const String _videoIdfive = 'https://youtu.be/B5ytcg5pYEA?t=';
const double _startSecondsfive = 0000000000000000000000000001022;
