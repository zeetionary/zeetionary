...
class EnglishEntrygoodtempered extends StatefulWidget {
  const EnglishEntrygoodtempered({super.key});

  @override
  State<EnglishEntrygoodtempered> createState() =>
      _EnglishEntrygoodtemperedState();
}

class _EnglishEntrygoodtemperedState extends State<EnglishEntrygoodtempered> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "good-tempered";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""good-tempered""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She was good-tempered and popular with the carers.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """good-tempered""",
                      // alsoEnglishWord: "also: good-tempered",
                      britshText: """IpaUK: /ˌɡʊd ˈtempəd/""",
                      americanText: """IpaUS: /ˌɡʊd ˈtempərd/""",
...
کوردی: 
"""),
// With short examples define "good-tempered", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کەسێک کە بە ئاسانی تووڕە یان بێزار نابێت"""),
                    SentencesRow(
                      englishText:
                          """She was good-tempered and popular with the carers.""",
                      kurdishText:
                          """خۆش مەزاج بوو و خۆشەویست بوو لەلای چاودێرەکان.""",
...
const double _startSecondsend = 0000000000000000000000000006476;
const String _videoIdone = 'https://youtu.be/QTSYYtcsuzA?t=';
const double _startSecondsone = 00000000000000000000000000078;
const String _videoIdtwo = 'https://youtu.be/adOg5MwrTFE?t=';
const double _startSecondstwo = 000000000000000000000000000804;
const String _videoIdthree = 'https://youtu.be/kilmCIKe4wA?t=';
const double _startSecondsthree = 000000000000000000000000000164;
const String _videoIdfour = 'https://youtu.be/j0d0xkbxHVE?t=';
const double _startSecondsfour = 000000000000000000000000000268;
const String _videoIdfive = 'https://youtu.be/a1QvfcaAep0?t=';
