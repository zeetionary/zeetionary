...
class EnglishEntrygasp extends StatefulWidget {
  const EnglishEntrygasp({super.key});

  @override
  State<EnglishEntrygasp> createState() => _EnglishEntrygaspState();
}

class _EnglishEntrygaspState extends State<EnglishEntrygasp> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She gasped at the wonderful view.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He came to the surface of the water gasping for air.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She managed to gasp out her name.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""His breath came in short gasps.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gasp""",
                      // alsoEnglishWord: "also: gasp",
                      britshText: """IpaUK: /ɡɑːsp/""",
                      americanText: """IpaUS: /ɡæsp/""",
...
// With short examples define "gasp", please follow LX instructions
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She managed to gasp out her name.""",
                      kurdishText: """توانی ناوی دەرببڕێت.""",
...
const String _videoIdone = 'https://youtu.be/M_ROduqXkpE?t=';
const double _startSecondsone = 00000000000000000000000000050;
const String _videoIdtwo = 'https://youtu.be/ZT3X1fYFViE?t=';
const double _startSecondstwo = 000000000000000000000000000467;
const String _videoIdthree = 'https://youtu.be/l8BiYE2rctA?t=';
const double _startSecondsthree = 000000000000000000000000000118;
const String _videoIdfour = 'https://youtu.be/J-4FaTv1mcM?t=';
const double _startSecondsfour = 000000000000000000000000000784;
const String _videoIdfive = 'https://youtu.be/Gc-B-a5FrvU?t=';
