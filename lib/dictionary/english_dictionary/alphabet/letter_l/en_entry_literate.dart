...
class EnglishEntryliterate extends StatefulWidget {
  const EnglishEntryliterate({super.key});

  @override
  State<EnglishEntryliterate> createState() => _EnglishEntryliterateState();
}

class _EnglishEntryliterateState extends State<EnglishEntryliterate> {
  @override
  void initState() {
    super.initState();
...
- Noun: literate (Derived forms: literates)
1. A person who can read and write (- literate person)
""",
  );

  final String keyword = "literate";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""literate""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Though nearly twenty he was barely literate.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Employees today are more digitally literate and connected than ever.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/f2kEGj-S1Tc?t=293';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/zFaUY3OAzow?t=199';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/EmT0i0xG6zg?t=1203';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/fwVjPU-xNPQ?t=359';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/R1ss7ybBX44?t=301';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/chpT0TzietQ?t=245';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """literate""",
                      // alsoEnglishWord: "also: literate",
                      britshText: """IpaUK: /ˈlɪtərət/""",
                      americanText: """IpaUS: /ˈlɪtərət/""",
...
کوردی: خوێندەوار، میرزا، ڕۆشنبیر، ڕووناکبیر
"""),
// With short examples define "literate", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ھاوەڵناو) کە دەتوانێت بخوێنێتەوە یان بنووسێت"""),
                    SentencesRow(
                      englishText: """Though nearly twenty he was barely literate.""",
                      kurdishText: """ئەگەرچی نزیکەی بیست ساڵ بوو بە ئەستەم خوێندەوار بوو.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ھاوەڵناو) هەبوونی شارەزایی و زانیاری لە بوارێکی دیاریکراو"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Employees today are more digitally literate and connected than ever.""",
                      kurdishText: """کارمەندان لەم سەردەمەدا زیاتر لە ڕووێ تەکنەلۆژیاوە شارەزان و تێکەڵین وەک لە هەر کاتێکی دیکە.""",
