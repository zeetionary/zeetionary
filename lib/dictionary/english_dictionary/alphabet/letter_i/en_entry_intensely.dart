...
class EnglishEntryintensely extends StatefulWidget {
  const EnglishEntryintensely({super.key});

  @override
  State<EnglishEntryintensely> createState() => _EnglishEntryintenselyState();
}

class _EnglishEntryintenselyState extends State<EnglishEntryintensely> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""intensely""");
  }
