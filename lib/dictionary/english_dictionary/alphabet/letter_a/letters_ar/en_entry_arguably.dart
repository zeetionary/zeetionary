...
// replace EnglishEntryAdopsummm - replace speakArguably

// replace arguably - /ˈɑːɡjuəbli/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarguably extends StatelessWidget {
  // blank divider
  EnglishEntryarguably({super.key});
  // blank divider
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arguably"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈɑːɡjuəbli/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈɑːrɡjuəbli/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakarguably1020("en-US"),
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'fS422O4SLc4';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'ugElBfp0j98';
