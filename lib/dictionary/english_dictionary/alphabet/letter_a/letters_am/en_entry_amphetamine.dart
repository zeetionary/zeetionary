...
class EnglishEntryamphetamine extends StatelessWidget {
  ...
  Future<void> speakAmphetamine450(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("Floyd was banned from racing after a test revealed traces of amphetamine in his urine."); // DOPSUM: CHANGE TEXT
  }
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAmphetamine(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                          ...
                          Row(
                            children: [
                              ...
                              IconButton(
                                ...
                                onPressed: () =>
                                    speakAmphetamine450(// REPLACE: amphetamine /æmˈfetəmiːn/,  /æmˈfetəmɪn/
                                        "en-US"),
                              ),
                            ],
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '616ZazYNg_c';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'UlYC0syLe7g';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'nEnklxGAmak';
