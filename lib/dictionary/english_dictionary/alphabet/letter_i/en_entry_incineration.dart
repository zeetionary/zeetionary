...
class EnglishEntryincineration extends StatefulWidget {
  const EnglishEntryincineration({super.key});

  @override
  State<EnglishEntryincineration> createState() =>
      _EnglishEntryincinerationState();
}

class _EnglishEntryincinerationState extends State<EnglishEntryincineration> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incineration""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'Q4Xys-IRMr0';
    const double startSecondsend = 230;
    const String videoIdone = 'k8fsVzyj-PA';
    const double startSecondsone = 442;
    const String videoIdtwo = 'KXRtNwUju5g';
    const double startSecondstwo = 196;
    const String videoIdthree = 'E2rtQFAibEA';
    const double startSecondsthree = 6722;
    const String videoIdfour = 'WyT8i6NYLZM';
    const double startSecondsfour = 245;
    const String videoIdfive = 'V1o_jEplpmw';
    const double startSecondsfive = 784;
