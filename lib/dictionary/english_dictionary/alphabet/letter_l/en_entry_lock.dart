...
class EnglishEntrylock extends StatefulWidget {
  const EnglishEntrylock({super.key});

  @override
  State<EnglishEntrylock> createState() => _EnglishEntrylockState();
}

class _EnglishEntrylockState extends State<EnglishEntrylock> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: lock (Derived forms: locks, locked, locking)
1. Fasten with a lock
"lock the bike to the fence"
 
2. Keep engaged (- engage, mesh, operate)
"locked the gears";
 
3. Become rigid or immoveable
"The therapist noticed that the patient's knees tended to lock in this exercise"
 
4. Hold in a locking position (- interlock, interlace)
"He locked his hands around her neck";
 
5. Become engaged or intermeshed with one another (- interlock)
"They were locked in embrace";
 
6. Hold fast (in a certain state)
"He was locked in a laughing fit"
 
7. Place in a place where something cannot be removed or someone cannot escape (- lock in, lock away, put away, shut up, shut away, lock up)
...
4. Enclosure consisting of a section of canal that can be closed to control the water level; used to raise or lower vessels that pass through it (- lock chamber)
 
5. A restraint incorporated into the ignition switch to prevent the use of a vehicle by persons who do not have the key (- ignition lock)
 
6. Any wrestling hold in which some part of the opponent's body is twisted or pressured
""",
  );

  final String keyword = "lock";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Did you lock the door?""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""David locked the room and slipped the key into his pocket.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The gates are locked at 6 o'clock.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This suitcase doesn't lock.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She locked her passport and money in the safe.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The brakes locked and the car skidded.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The two sides are locked into a bitter dispute.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She felt locked in a loveless marriage.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She turned the key in the lock.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""It's a good idea to have locks fitted on all your windows.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They changed the locks on the doors and windows.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A safety lock for handguns can prevent many accidents.""");
  }
  ...
  Future<void> speaksentence13(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There's a security lock on the phone.""");
  }
  ...
  Future<void> speaksentence14(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I had the steering wheel on full lock.""");
  }
  ...
  Future<void> speaksentence15(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She kept a lock of her mother’s hair.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/55XJ1ObZKaM?t=991';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/D-2799Y07Zc?t=372';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/hFZFjoX2cGg?t=1001';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/IgI8_npvjkI?t=1436';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/dJxP85txY9I?t=290';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/FEkG-kMMkik?t=99';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lock""",
                      // alsoEnglishWord: "also: lock",
                      britshText: """IpaUK: /lɒk/""",
                      americanText: """IpaUS: /lɑːk/""",
...
کوردی: قوفڵ، کێلوون، گاڵە، کڵۆم،	قوفڵی گێلەنگێدەن، زامن،	گیران، گیراوی، گیرکردوویی، گیر، قوفڵ‌کردویی، تێک‌ئاڵان،	میکانیزمی تەقاندنی تەقەک یان خەرجی تفەنگ، چەخماخی تفەنگ،	ئاوبەست، ئاوبەند،	هەڵپێکان، پەلکە، کەزی، گێسوو، تووکەسەر، ئەگریجە، کاکۆڵ، پرچ، قژ، موو، زڵف، (لۆکە و خوری) چنگ، لیسپ، تۆپەڵ، چەپک، تۆپ
"""),
// With short examples define "lock", please follow LX instructions
                    const DefinitionKurdish(text: """١. (کردار) بەستن بە قوفڵ"""),
                    SentencesRow(
                      englishText: """Did you lock the door?""",
                      kurdishText: """دەرگاکەت قوفڵ کرد؟""",
                    ...
                    SentencesRow(
                      englishText: """David locked the room and slipped the key into his pocket.""",
                      kurdishText: """دەیڤید دەرگاکەی قوفڵ کرد و کلیلەکەی خستە گیرفانی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The gates are locked at 6 o'clock.""",
                      kurdishText: """دەروازەکان لە کاتژمێر شەش دادەخرێن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """This suitcase doesn't lock.""",
                      kurdishText: """ئەم جانتایە قوفڵ نادرێت.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (کردار) دانانی شتێک لە شوێنێکی سەلامەت و قوفڵدانی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She locked her passport and money in the safe.""",
                      kurdishText: """لە قاسەکەدا پاسپۆڕت و پارەکەیی قوفڵ دا.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (کردار) ئەوەی شتێک لە شوێنێکدا گیر بدەیت/بخوات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The brakes locked and the car skidded.""",
                      kurdishText: """برێکەکان گیریان کرد و ئۆتۆمبێلەکە خلیسکا.""",
                      onPressedBritish: () => speaksentence6("en-GB"),
                      onPressedAmerican: () => speaksentence6("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٤. (کردار) ئەوەی بکەویتە دۆخێک، مشتومڕێک، هتد ـی سەختەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The two sides are locked into a bitter dispute.""",
                      kurdishText: """دوو لایەنەکە کەوتوونەتە ناکۆکی توندەوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She felt locked in a loveless marriage.""",
                      kurdishText: """هەستی دەکرد زیندانی کراوە لە هاوسەرگیرییەکی بێ خۆشەویستی.""",
                      onPressedBritish: () => speaksentence8("en-GB"),
                      onPressedAmerican: () => speaksentence8("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (ناو) قوفڵ"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She turned the key in the lock.""",
                      kurdishText: """کلیلەکەی کرد بە قوفڵەکەدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """It's a good idea to have locks fitted on all your windows.""",
                      kurdishText: """بیرۆکەیەکی باشە کە قوفڵ ببەستیت لە هەموو پەنجەرەکانت.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They changed the locks on the doors and windows.""",
                      kurdishText: """قوفڵەکانی سەر دەرگا و پەنجەرەکانیان گۆڕی.""",
                      onPressedBritish: () => speaksentence11("en-GB"),
                      onPressedAmerican: () => speaksentence11("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٦. (ناو) ئامێرێک کە ناهێڵێت پێڕۆیەک، ئامێرێک، هتد بەکاربێنیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """A safety lock for handguns can prevent many accidents.""",
                      kurdishText: """قوفڵی سەلامەتی بۆ دەمانچە دەکرێت زۆر ڕووداو دووربخاتەوە.""",
                      onPressedBritish: () => speaksentence12("en-GB"),
                      onPressedAmerican: () => speaksentence12("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٧. (ناو) تایبەتمەندییەکی موبایل یان کۆمپیوتەر کە ڕێگری دەکات لەوەی کەسێک بەکاری بێنێت بەبێ کۆد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """There's a security lock on the phone.""",
                      kurdishText: """قوفڵی سەلامەتی لەسەر موبایلەکە هەیە.""",
                      onPressedBritish: () => speaksentence13("en-GB"),
                      onPressedAmerican: () => speaksentence13("en-US"),
                    ),
                    // skipped_meaning
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٨. (ناو) ئەو ڕێژەیەی کە ویلی پیشەوەی ئۆتۆمبێل دەتوانێت بسووڕێتەوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """I had the steering wheel on full lock (= I had turned it as far as it would turn).""",
                      kurdishText: """سووکانەکەم تەواو سووڕدابوو.""",
                      onPressedBritish: () => speaksentence14("en-GB"),
                      onPressedAmerican: () => speaksentence14("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٩. (ناو) چەند تەڵە قژێک کە پێکەوەن لە سەردا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She kept a lock of her mother’s hair.""",
                      kurdishText: """پەلکێک لە قژی دایکیی پاراست.""",
