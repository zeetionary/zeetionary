...
class EnglishEntryforwardlooking extends StatefulWidget {
  const EnglishEntryforwardlooking({super.key});

  @override
  State<EnglishEntryforwardlooking> createState() =>
      _EnglishEntryforwardlookingState();
}

class _EnglishEntryforwardlookingState
    extends State<EnglishEntryforwardlooking> {
  @override
  void initState() {
    super.initState();
...
1. Ahead of the times (= advanced, innovative, modern, forward-thinking)
"a forward-looking corporation";
""",
  );

  final String keyword = "forward-looking";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forward-looking""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: forward-looking",
                      britshText: """IpaUK: /ˈfɔːwəd lʊkɪŋ/""",
                      americanText: """IpaUS: /ˈfɔːrwərd lʊkɪŋ/""",
...
کوردی: 
"""),
// With short examples define "forward-looking", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە لە داهاتوو دەڕوانێت"""),
                    SentencesRow(
                      englishText:
                          """My intention is to build a successful, highly forward-looking organization.""",
                      kurdishText:
                          """ئامانجم ئەوەیە دامەزراوەیەکی سەرکەوتووی ڕوو لە پاشەڕۆژ دابمەزرێنم.""",
...
const double _startSecondsend = 0000000000000000000000000009275;
const String _videoIdone = 'https://youtu.be/oBt53YbR9Kk?t=';
const double _startSecondsone = 00000000000000000000000000013448;
const String _videoIdtwo = 'https://youtu.be/NdJ6BbvTw-s?t=';
const double _startSecondstwo = 000000000000000000000000000650;
const String _videoIdthree = 'https://youtu.be/yJ6bmkjZW_E?t=';
const double _startSecondsthree = 000000000000000000000000000645;
const String _videoIdfour = 'https://youtu.be/R6WsHO8CKrQ?t=';
const double _startSecondsfour = 000000000000000000000000000158;
const String _videoIdfive = 'https://youtu.be/9a8HDBCH_8A?t=';
