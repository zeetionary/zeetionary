...
class EnglishEntryincurable extends StatefulWidget {
  const EnglishEntryincurable({super.key});

  @override
  State<EnglishEntryincurable> createState() => _EnglishEntryincurableState();
}

class _EnglishEntryincurableState extends State<EnglishEntryincurable> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incurable""");
  }
