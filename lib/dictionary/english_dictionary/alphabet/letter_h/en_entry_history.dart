...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'LAOoF2gyQaA';
    const double startSecondsend = 66;
    const String videoIdone = 'zqllxbPWKNI';
    const double startSecondsone = 53;
    const String videoIdtwo = 'WDetHC86Dgo';
    const double startSecondstwo = 309;
    const String videoIdthree = '-L7o6HtX8Vg';
    const double startSecondsthree = 1573;
    const String videoIdfour = 'aAByKcPJ5NQ';
    const double startSecondsfour = 108;
    const String videoIdfive = 'N4kvtt2T_6Y';
    const double startSecondsfive = 395;
