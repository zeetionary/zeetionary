...
class EnglishEntryinfluential extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""influential""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 637;
    const String videoIdone = 'HxRUuGqqMG4';
    const double startSecondsone = 221;
    const String videoIdtwo = 'kBdfcR-8hEY';
    const double startSecondstwo = 929;
    const String videoIdthree = 'qCbfTN-caFI';
    const double startSecondsthree = 1709;
    const String videoIdfour = 'Bj6ulLJGPB8';
    const double startSecondsfour = 228;
    const String videoIdfive = 'K0j2dlBMzUs';
    const double startSecondsfive = 458;
