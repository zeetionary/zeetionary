...
کوردی: ھێرش، پەلامار،	لەشکرکێشی، سپاڕانی، ئەرتەش‌کێشی،	گەشتی دۆزینەویی، سەفەری لێکۆڵینەوەیی،	گەڕان، گەشت، گەڕوانی، سەردان، سەرکێشی،	شاند(ە)، نێردە،	خێرایی، توندوتۆڵی، گورج‌وگۆڵی، گورجی، پەلە، لەز
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) گەشتێکی ڕێکخراو بە ھۆکارێکی دیاریکراو، بەتایبەتی بۆ شوێنێک کە کە نەزانراوە"""),
          SentencesRow(
            englishText:
                """Hawkins had died on the same expedition a few weeks earlier.""",
            kurdishText:
                """ھاوکینز چەند ھەفتەیەک پێشووتر لە ھەمان گەشتدا مردبوو.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """بەریتانییەکان ڕازی بوون بە گەشتێکی ھاوبەش لەگەڵ فەرەنسییەکان.""",
