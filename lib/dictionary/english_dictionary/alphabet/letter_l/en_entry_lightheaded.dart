...
class EnglishEntrylightheaded extends StatefulWidget {
  const EnglishEntrylightheaded({super.key});

  @override
  State<EnglishEntrylightheaded> createState() => _EnglishEntrylightheadedState();
}

class _EnglishEntrylightheadedState extends State<EnglishEntrylightheaded> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""light-headed""");
  }
