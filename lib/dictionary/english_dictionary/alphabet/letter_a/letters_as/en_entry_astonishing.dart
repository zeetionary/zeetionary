...
// Define the word "astonishing" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryastonishing - replace speakAstonishing

// replace astonishing - /əˈstɒnɪʃɪŋ/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryastonishing extends StatelessWidget {
  // blank divider
  EnglishEntryastonishing({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAstonishing(String languageCode) async {
    // DOPSUM: CHANGE speakAstonishing
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("astonishing"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAstonishing1043(String languageCode) async {
    // DOPSUM: CHANGE speakAstonishing
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "She ran 100m in an astonishing 10.6 seconds."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word:
                                    "astonishing"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "NWGVFi-213w";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "161WT6TeYig";
