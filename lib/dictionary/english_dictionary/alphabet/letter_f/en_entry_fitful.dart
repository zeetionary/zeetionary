...
class EnglishEntryfitful extends StatefulWidget {
  const EnglishEntryfitful({super.key});

  @override
  State<EnglishEntryfitful> createState() => _EnglishEntryfitfulState();
}

class _EnglishEntryfitfulState extends State<EnglishEntryfitful> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fitful
1. Occurring in spells and often abruptly (= spasmodic)
"fitful bursts of energy";
 
2. Intermittently stopping and starting (= interrupted, off-and-on)
"fitful sleep";
""",
  );

  final String keyword = "fitful";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The wind was fitful but very strong.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Her breathing is fitful.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fitful""",
                      // alsoEnglishWord: "also: fitful",
                      britshText: """IpaUK: /ˈfɪtfl/""",
                      americanText: """IpaUS: /ˈfɪtfl/""",
...
کوردی: پچڕپچڕ، جارجار، جارناجار، تاوتاو، ناوەناوە، ناڕێک، نابەردەوام، لێهاتەیی، بگرەوبەردە
"""),
// With short examples define "fitful", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """The wind was fitful but very strong.""",
                      kurdishText: """بایە پچڕپچڕ بەڵام بەهێز بوو .""",
                    ...
                    SentencesRow(
                      englishText: """Her breathing is fitful.""",
                      kurdishText: """هەناسەدانی پچڕپچڕە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/y7voToyTmOE?t=';
const double _startSecondsend = 00000000000000000000000000083;
const String _videoIdone = 'https://youtu.be/xdyhGyW4pbo?t=';
const double _startSecondsone = 000000000000000000000000000771;
const String _videoIdtwo = 'https://youtu.be/3lX59lKV0oA?t=';
const double _startSecondstwo = 0000000000000000000000000004697;
const String _videoIdthree = 'https://youtu.be/y7voToyTmOE?t=';
const double _startSecondsthree = 00000000000000000000000000081;
const String _videoIdfour = 'https://youtu.be/oPxRuc8EroQ?t=';
const double _startSecondsfour = 000000000000000000000000000313;
const String _videoIdfive = 'https://youtu.be/vazbtnih3ks?t=';
const double _startSecondsfive = 000000000000000000000000000428;
