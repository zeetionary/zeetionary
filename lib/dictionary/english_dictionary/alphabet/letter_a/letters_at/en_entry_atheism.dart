...
// Define the word "atheism" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryatheism - replace speakAtheism

// replace atheism - /ˈeɪθiɪzəm/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryatheism extends StatelessWidget {
  // blank divider
  EnglishEntryatheism({super.key});
  // blank divider
  ...
  Future<void> speakatheism(String languageCode) async {
    ...
    await flutterTts.speak("atheism");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ˈeɪθiɪzəm/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ˈeɪθiɪzəm/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakatheism731("en-US"),
                          ),
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final double _startSeconds = 10699;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'oYJ15by205Q';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'gI0ztr3Rn0E';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'Z2jPkKNCyz8';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'HDOClTy0Xdk';
...
class YoutubeEmbeddedten extends StatelessWidget {
  ...
  final String _videoId = 'qLt2YMSUyT4';
  final double _startSeconds = 1;
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  ...
  final String _videoId = '8EUH1MZkNT0';
...
class YoutubeEmbeddedtwelve extends StatelessWidget {
  ...
  final String _videoId = 'tIe0G-gGSrY';
