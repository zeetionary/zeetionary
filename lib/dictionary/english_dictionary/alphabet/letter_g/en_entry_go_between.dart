...
class EnglishEntrygobetween extends StatefulWidget {
  const EnglishEntrygobetween({super.key});

  @override
  State<EnglishEntrygobetween> createState() => _EnglishEntrygobetweenState();
}

class _EnglishEntrygobetweenState extends State<EnglishEntrygobetween> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "go-between";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""go-between""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """go-between""",
                      // alsoEnglishWord: "also: go-between",
                      britshText: """IpaUK: /ˈɡəʊ bɪtwiːn/""",
                      americanText: """IpaUS: /ˈɡəʊ bɪtwiːn/""",
...
کوردی: 
"""),
// With short examples define "go-between", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە پەیامی کەسێک یان گرووپێکی بۆ یەکێکی دیکە دەبات"""),
                    SentencesRow(
                      englishText:
                          """A number of local church leaders have acted as go-betweens with the paramilitaries.""",
                      kurdishText:
                          """ژمارەیەک لە ڕێبەرانی کڵێسا ناوبژیوان لەگەڵ لایەنگرانی پەرلەمان ڕۆڵیان بینیوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/laxYhf-uOs4?t=';
const double _startSecondsend = 000000000000000000000000000559;
const String _videoIdone = 'https://youtu.be/1mSqo_SKjMk?t=';
const double _startSecondsone = 000000000000000000000000000199;
const String _videoIdtwo = 'https://youtu.be/Msucso9PsJw?t=';
const double _startSecondstwo = 000000000000000000000000000120;
const String _videoIdthree = 'https://youtu.be/uy-_VAriRoc?t=';
const double _startSecondsthree = 000000000000000000000000000379;
const String _videoIdfour = 'https://youtu.be/eBA7P-zKbi8?t=';
const double _startSecondsfour = 000000000000000000000000000244;
const String _videoIdfive = 'https://youtu.be/cg-jRW2hvfg?t=';
const double _startSecondsfive = 0000000000000000000000000002847;
