...
class EnglishEntrygravel extends StatefulWidget {
  const EnglishEntrygravel({super.key});

  @override
  State<EnglishEntrygravel> createState() => _EnglishEntrygravelState();
}

class _EnglishEntrygravelState extends State<EnglishEntrygravel> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gravel (Derived forms: gravels)
1. Rock fragments and pebbles (- crushed rock)

- Verb: gravel (Derived forms: gravelled, gravelling, graveled, graveling, gravels)
1. [US] Cause annoyance in; disturb, especially by minor irritations (- annoy, rag, get to, bother, get at [informal], irritate, rile, nark [Brit, slang], nettle, vex, chafe, devil, tick off [informal], roil [N. Amer])
"Mosquitoes buzzing in my ear really gravels me";
 
2. Cover with gravel
 
3. Confuse or leave at a loss because of something complex or difficult to understand (- confuse, throw, fox, befuddle, fuddle, bedevil, confound, discombobulate [informal], perplex, vex, stick, get, puzzle, mystify, baffle, beat, pose, bewilder, flummox, stupefy, nonplus, dumbfound)
"These questions gravel even the experts";
""",
  );

  final String keyword = "gravel";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A gravel drive led up to the house.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""We parked on the gravel at the side of the road.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gravel""",
                      // alsoEnglishWord: "also: gravel",
                      britshText: """IpaUK: /ˈɡrævl/""",
                      americanText: """IpaUS: /ˈɡrævl/""",
...
کوردی: زیخ، خیز، چەو، وردەبەرد، ورکەبەرد
"""),
// With short examples define "gravel", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) وردە بەرد کە دەکرێت بەسەر ڕێگایەکدا"""),
                    SentencesRow(
                      englishText: """A gravel drive led up to the house.""",
                      kurdishText: """ڕێگایەکی چەوڕێژ بەرەو ماڵەکە دەچوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """لەسەر زیخی تەنیشت ڕێگاکە وەستاین.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/cgOITABvj5g?t=';
const double _startSecondsend = 000000000000000000000000000207;
const String _videoIdone = 'https://youtu.be/aJSD8XV3qzE?t=';
const double _startSecondsone = 000000000000000000000000000482;
const String _videoIdtwo = 'https://youtu.be/Xq_uh1r_gXs?t=';
const double _startSecondstwo = 0000000000000000000000000001193;
const String _videoIdthree = 'https://youtu.be/fvnjrNE5z7A?t=';
const double _startSecondsthree = 000000000000000000000000000322;
const String _videoIdfour = 'https://youtu.be/1nBNRLZjYL4?t=';
const double _startSecondsfour = 000000000000000000000000000280;
const String _videoIdfive = 'https://youtu.be/hPyTHzNapDs?t=';
