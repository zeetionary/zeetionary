...
class EnglishEntryindebted extends StatefulWidget {
  const EnglishEntryindebted({super.key});

  @override
  State<EnglishEntryindebted> createState() => _EnglishEntryindebtedState();
}

class _EnglishEntryindebtedState extends State<EnglishEntryindebted> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indebted""");
  }
