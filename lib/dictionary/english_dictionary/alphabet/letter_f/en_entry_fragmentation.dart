...
class EnglishEntryfragmentation extends StatefulWidget {
  const EnglishEntryfragmentation({super.key});

  @override
  State<EnglishEntryfragmentation> createState() => _EnglishEntryfragmentationState();
}

class _EnglishEntryfragmentationState extends State<EnglishEntryfragmentation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fragmentation (Derived forms: fragmentations)
1. Separating something into fine particles (= atomization, atomisation [Brit])
...
""",
  ...
  final String keyword = "fragmentation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fragmentation""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It was partly the fragmentation of the opposition which helped to get the Republicans re-elected.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fragmentation""",
                      // alsoEnglishWord: "also: fragmentation",
                      britshText: """IpaUK: /ˌfræɡmenˈteɪʃn/""",
                      americanText: """IpaUS: /ˌfræɡmenˈteɪʃn/""",
...
کوردی: لێک‌هەڵوەشان، لێک‌بوونەوە، لێک‌ترازان، جیابوونەوە، لێک‌دابڕان، پچڕپچڕبوون، پارچەپارچەبوون، پل‌پل‌کردن، پچڕپچڕبوون، بەش‌بەش‌بوون، پەرچقین
"""),
// With short examples define "fragmentation", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) شکان یان دابەشبوون بۆ بەشی بچووکتر"""),
                    SentencesRow(
                      englishText:
                          """It was partly the fragmentation of the opposition which helped to get the Republicans re-elected.""",
                      kurdishText: """ئەوە تا ڕادەیەک دابەشبوونی ئۆپۆزسیۆن بوو کە وایکرد کۆمارییەکان دووبارە هەڵببژێردرێنەوە.""",
