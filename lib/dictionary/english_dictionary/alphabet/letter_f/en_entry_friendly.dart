...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """ھەموان زۆر دۆستانە بوون لەگەڵم.""",
                    ...
                    SentencesRow(
                      englishText:
                          """I'm sure that the people are friendlier to strangers in Romania.""",
                      kurdishText:
                          """دڵنیام کە خەڵکی ھاوڕێیانەترن لەگەڵ کەسانی نەناس لە ڕۆمانیا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """The government has maintained friendly relations with the Japanese.""",
                      kurdishText:
                          """حکومەت پەیوەندیی دۆستانەی لەگەڵ ژاپۆنییەکان ھێشتووەتەوە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Without a doubt, friendly bacteria are essential for good health.""",
                      kurdishText:
                          """بێ ھیچ گومانێک، بەکتریای بێ‌زیان گرنگن بۆ تەندرووستی باش.""",
...
const double _startSecondsone = 838;
const String _videoIdtwo = '8HEfIJlcFbs';
const double _startSecondstwo = 0;
const String _videoIdthree = 'tsxmyL7TUJg';
const double _startSecondsthree = 1173;
const String _videoIdfour = 'P8m-KThvtxA';
const double _startSecondsfour = 113;
const String _videoIdfive = 'PXsZntwnArQ';
const double _startSecondsfive = 157;
