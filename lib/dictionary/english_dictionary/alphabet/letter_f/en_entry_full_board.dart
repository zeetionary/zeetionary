...
class EnglishEntryfullboard extends StatefulWidget {
  const EnglishEntryfullboard({super.key});

  @override
  State<EnglishEntryfullboard> createState() => _EnglishEntryfullboardState();
}

class _EnglishEntryfullboardState extends State<EnglishEntryfullboard> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: full board
Usage: Brit, Cdn (US: American plan)
1. A hotel plan that includes three meals daily (- American plan [N. Amer])
""",
  );

  final String keyword = "full board";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""full board""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Do you require full or half board?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """full board""",
                      // alsoEnglishWord: "also: full board",
                      britshText: """IpaUK: /ˌfʊl ˈbɔːd/""",
                      americanText: """IpaUS: /ˌfʊl ˈbɔːrd/""",
...
// With short examples define "full board", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) جۆرێکی مانەوە لە هوتێل کە هەموو ژەمە خواردنێکی لەگەڵە"""),
                    SentencesRow(
                      englishText: """Do you require full or half board?""",
                      kurdishText:
                          """پێویستت بە ژەمە تەواو یان نیوەیە لەگەڵ ژوورەکە؟""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/rmgAqYwFFA8?t=';
const double _startSecondsend = 000000000000000000000000000422;
const String _videoIdone = 'https://youtu.be/4se4_ZqkcKw?t=';
const double _startSecondsone = 00000000000000000000000000046;
const String _videoIdtwo = 'https://youtu.be/3dh0FJjJi44?t=';
const double _startSecondstwo = 000000000000000000000000000684;
const String _videoIdthree = 'https://youtu.be/PUjf2TQKzBM?t=';
const double _startSecondsthree = 0000000000000000000000000001692;
const String _videoIdfour = 'https://youtu.be/H6y8p8Q29z4?t=';
const double _startSecondsfour = 0000000000000000000000000001844;
const String _videoIdfive = 'https://youtu.be/jGCuhl5wkkE?t=';
const double _startSecondsfive = 0000000000000000000000000001144;
