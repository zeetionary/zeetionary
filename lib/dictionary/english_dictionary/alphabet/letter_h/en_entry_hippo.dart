...
class EnglishEntryhippo extends StatefulWidget {
  const EnglishEntryhippo({super.key});

  @override
  State<EnglishEntryhippo> createState() => _EnglishEntryhippoState();
}

class _EnglishEntryhippoState extends State<EnglishEntryhippo> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hippo (Derived forms: hippos)
1. Massive thick-skinned herbivorous animal living in or around rivers of tropical Africa (- hippopotamus, river horse, Hippopotamus amphibius)

- Noun: Hippo 
1. An ancient Numidian town in northwestern Africa adjoining present-day Annaba in northeastern Algeria (- Hippo Regius)
""",
  );

  final String keyword = "hippo";
...
""");
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/sK6qzykWURM?t=';
    const double startSecondsone = 00000000000000000000000000023;
    const String videoIdtwo = 'https://youtu.be/eRtBMHEngcA?t=';
    const double startSecondstwo = 00000000000000000000000000046;
    const String videoIdthree = 'https://youtu.be/xklNdnkOYFw?t=';
    const double startSecondsthree = 00000000000000000000000000072;
    const String videoIdfour = 'https://youtu.be/wXfO9ngX-OA?t=';
    const double startSecondsfour = 00000000000000000000000000030;
    const String videoIdfive = 'https://youtu.be/zD9VtZqG2WQ?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hippo""",
                      // alsoEnglishWord: "also: hippo",
                      britshText: """IpaUK: /ˈhɪpəʊ/""",
                      americanText: """IpaUS: /ˈhɪpəʊ/""",
