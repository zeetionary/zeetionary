...
class EnglishEntryhammock extends StatefulWidget {
  const EnglishEntryhammock({super.key});

  @override
  State<EnglishEntryhammock> createState() => _EnglishEntryhammockState();
}

class _EnglishEntryhammockState extends State<EnglishEntryhammock> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hammock (Derived forms: hammocks)
1. A small natural hill (- knoll, mound, hillock, hummock)
 
2. A hanging bed of canvas or rope netting (usually suspended between two trees); swings easily (- sack)
""",
  );

  final String keyword = "hammock";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hammock""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He relaxed in the hammock under the shade of a tree.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hammock""",
                      // alsoEnglishWord: "also: hammock",
                      britshText: """IpaUK: /ˈhæmək/""",
                      americanText: """IpaUS: /ˈhæmək/""",
...
کوردی: هەلۆرکە، جۆلانی لە تۆڕ، جۆلانک، جۆلانێی تۆڕی، دەرگووش، لەلو
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) جێخەوێک کە لە تۆڕ یان مادەیەکی بەهێز درووستکراوە و حەبل لە سەرەکانییەوەیە بۆ هەڵواسینی"""),
                    SentencesRow(
                      englishText:
                          """He relaxed in the hammock under the shade of a tree.""",
                      kurdishText: """لە هەلۆرەی سێبەری دارەکە حەسایەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/HPv1GQ6ojcE?t=';
const double _startSecondsend = 000000000000000000000000000143;
const String _videoIdone = 'https://youtu.be/xEDuF4yFXtE?t=';
const double _startSecondsone = 000000000000000000000000000213;
const String _videoIdtwo = 'https://youtu.be/87y1_IbJRZE?t=';
...
const String _videoIdfour = 'https://youtu.be/d2WjA753yPI?t=';
const double _startSecondsfour = 000000000000000000000000000329;
const String _videoIdfive = 'https://youtu.be/4Nr1AgIfajI?t=';
