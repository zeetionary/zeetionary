...
// replace these: replace EnglishEntryadamsadditional - replace speakAdditional - replace additional - /əˈdɪʃənl/ - find Dopsum2

enum TtsState { playing }

class EnglishEntryadamsadditional extends StatelessWidget {
  EnglishEntryadamsadditional({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAdditional(String languageCode) async {
    // DOPSUM: CHANGE speakAdditional
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("additional"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAdditi77(String languageCode) async {
    // DOPSUM: CHANGE speakAdditional
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "He provided additional information about this incident."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              "additional", // DOPSUM: CHANGE WORD ENTRY - Find /əˈdɪʃənl/
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈdɪʃənl/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /əˈdɪʃənl/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find Dopsum2
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'N3FHeBnTnVs';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = '1ddO62_r7yY';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = '0gXHPcllF2o';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'oeyt2zVqCG8';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'YtUhl7q82i4';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = 'hp1uI4D7NRQ';
