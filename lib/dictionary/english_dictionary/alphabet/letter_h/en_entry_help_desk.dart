...
// With short examples define "help desk", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """Staff experiencing problems with their computers should call the help desk.""",
                      kurdishText:
                          """ئەو ستافانەی کە کێشەیان هەیە لە کۆمپیوتەرەکانیان دەبێت پەیوندی بە مێزی یارمەتییەوە بکەن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/l9YxTXDiiFY';
const double _startSecondsend = 0;
const String _videoIdone = 'https://youtu.be/Kx4y9c7w2JQ?t=';
const double _startSecondsone = 000000000000000000000000000287;
const String _videoIdtwo = 'https://youtu.be/zE9U7zuLDFI?t=';
const double _startSecondstwo = 0000000000000000000000000001306;
const String _videoIdthree = 'https://youtu.be/W2tTsjkX76o?t=';
const double _startSecondsthree = 00000000000000000000000000020;
const String _videoIdfour = 'https://youtu.be/uTAaFExLgwQ?t=';
const double _startSecondsfour = 000000000000000000000000000155;
const String _videoIdfive = 'https://youtu.be/BVVvSOCZ1g8?t=';
