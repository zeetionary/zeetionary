...
// With short examples define "graceless", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """He is generally disliked, seen by his fellow players as selfish, mean, graceless and arrogant.""",
                      kurdishText:
                          """بە گشتی بێزراوە، و یاریزانە ھاوڕێکانی وەک کەسێکی خۆپەرست، بەدخوو، ناشیرین و لووتبەرز دەیبینن.""",
                    ...
                    SentencesRow(
                      englishText:
                          """When did their seductive swagger cease to be sexy, and begin to seem graceless?""",
                      kurdishText:
                          """لە کەیەوە لەنجەولارە سەرنجڕاکێشەیان وەستا لەوەی سێکسی بێت ھێنا و بووە بەوەی ناڕێک بێت؟""",
...
// 188888880002200
const String _videoIdend = 'Ae1tSWWPNrQ?t=';
const double _startSecondsend = 149;
const String _videoIdone = 'Lx_ORMhpmoU?t=';
const double _startSecondsone = 105;
const String _videoIdtwo = 'AWv5jk8uqtg?t=';
const double _startSecondstwo = 213;
const String _videoIdthree = '1REA0VJsYWQ?t=';
const double _startSecondsthree = 1093;
const String _videoIdfour = 'vHD4V8s8Jik?t=';
const double _startSecondsfour = 303;
const String _videoIdfive = '_SidCppOfJY?t=';
const double _startSecondsfive = 2309;
