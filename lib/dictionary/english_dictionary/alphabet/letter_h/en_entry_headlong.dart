...
class EnglishEntryheadlong extends StatefulWidget {
  const EnglishEntryheadlong({super.key});

  @override
  State<EnglishEntryheadlong> createState() => _EnglishEntryheadlongState();
}

class _EnglishEntryheadlongState extends State<EnglishEntryheadlong> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: headlong
1. With the head before the body (- headfirst)
"the runner slid headlong into third base";
 
2. At breakneck speed (- precipitately)
"burst headlong through the gate";
 
3. In a hasty and foolhardy manner (- rashly)
"he fell headlong in love with his cousin";

- Adjective: headlong
1. Excessively quick (- hasty, Gadarene, gadarene)
"a headlong rush to sell";
 
2. With the head foremost (- headfirst)
"a headlong dive into the pool";
""",
  );

  final String keyword = "headlong";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""headlong""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She fell headlong into the icy pool.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He ran headlong into a police car.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """headlong""",
                      // alsoEnglishWord: "also: headlong",
                      britshText: """IpaUK: /ˈhedlɒŋ/""",
                      americanText: """IpaUS: /ˈhedlɔːŋ/""",
...
کوردی: بە سەر، بە کەللە، بە سەرەوە ڕۆیشتن،	بەپەلە، بەپڕتاو، هەڵەشانە، سەرچڵانە، بێ‌بیرلێ‌کردنەوە، توند
"""),
// With short examples define "headlong", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بەوەی سەر سەرەتا بچێت و دواتر بشەکانی دیکەی جەستە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: head first"),
                    SentencesRow(
                      englishText: """She fell headlong into the icy pool.""",
                      kurdishText: """بە سەردا کەوتە ناو حەوزێکی بەستوو.""",
                      onPressedBritish: () => speaksentence1("en-GB"),
                      onPressedAmerican: () => speaksentence1("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٢. (ھاوەڵکار) بەبێ بیرکردنەوەی تەواو"""),
                    SentencesRow(
                      englishText:
                          """In the headlong rush to buy houses, many people got into debt.""",
                      kurdishText:
                          """لە پەلەپەلی هەڵەشانە بۆ کڕینی خانوو، زۆر کەس کەوتنە ناو قەرزەوە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵکار) بە خێرایی و بەبێ سەیرکردنی ئەوەی بۆ کوێ دەچیت"""),
                    SentencesRow(
                      englishText: """He ran headlong into a police car.""",
                      kurdishText:
                          """بەخێرایی کەوتە بەردەم ئۆتۆمبێلێکی پۆلیس.""",
...
const String _videoIdone = 'https://youtu.be/W6aDNutZoB0?t=';
const double _startSecondsone = 0000000000000000000000000001589;
const String _videoIdtwo = 'https://youtu.be/U51jj6-K0so?t=';
const double _startSecondstwo = 0000000000000000000000000001385;
const String _videoIdthree = 'https://youtu.be/XaVm9YenVJQ?t=';
const double _startSecondsthree = 00000000000000000000000000043;
const String _videoIdfour = 'https://youtu.be/qoixtV5igUo?t=';
const double _startSecondsfour = 000000000000000000000000000964;
const String _videoIdfive = 'https://youtu.be/ebFPyi0O1yw?t=';
