...
class EnglishEntryhorribly extends StatefulWidget {
  const EnglishEntryhorribly({super.key});

  @override
  State<EnglishEntryhorribly> createState() => _EnglishEntryhorriblyState();
}

class _EnglishEntryhorriblyState extends State<EnglishEntryhorribly> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: horribly
1. Of a dreadful kind (- dreadfully, awfully, devastatingly, horrendously)
""",
  );

  final String keyword = "horribly";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""horribly""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The stain on her dress was horribly conspicuous.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was horribly disfigured by burns.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000620;
    ...
    const double startSecondstwo = 0000000000000000000000000001097;
    const String videoIdthree = 'https://youtu.be/xVQxvthAcLU?t=';
    const double startSecondsthree = 0000000000000000000000000001093;
    const String videoIdfour = 'https://youtu.be/OOg-4mtA3Zo?t=';
    const double startSecondsfour = 0000000000000000000000000001401;
    const String videoIdfive = 'https://youtu.be/oiLdWXLXDeA?t=';
    const double startSecondsfive = 000000000000000000000000000729;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """horribly""",
                      // alsoEnglishWord: "also: horribly",
                      britshText: """IpaUK: /ˈhɒrəbli/""",
                      americanText: """IpaUS: /ˈhɔːrəbli/""",
