...
class EnglishEntryfacade extends StatefulWidget {
  const EnglishEntryfacade({super.key});

  @override
  State<EnglishEntryfacade> createState() => _EnglishEntryfacadeState();
}

class _EnglishEntryfacadeState extends State<EnglishEntryfacade> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """facade""",
                      // alsoEnglishWord: "also: facade",
                      britshText: """IpaUK: /fəˈsɑːd/""",
                      americanText: """IpaUS: /fəˈsɑːd/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Tourists often photographed the gallery's elegant façade.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They seem happy together, but it’s all a facade.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He kept his hostility hidden behind a friendly façade.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We are fed up with this façade of democracy.""");
  }
...
// With short examples define "facade", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: ڕووکار، پێشەوەی خانوو، دیوی دەرەوە، پێش‌خانوو،	ڕواڵەت، ڕووکەش، ڕووی دەرەوە
"""),
          const DefinitionKurdish(text: """١. (ناو) پێشەوەی بینایەک"""),
          SentencesRow(
            englishText:
                """Tourists often photographed the gallery's elegant façade.""",
            kurdishText:
                """گەشتیاران زۆرجار وێنەی ڕووە جوانەکەی دەرەوەی پێشانگاکەیان دەگرت.""",
...
const double _startSecondsone = 000000000000000000000000000822;
const String _videoIdtwo = 'https://youtu.be/7eM7pb5M5DU?t=';
const double _startSecondstwo = 000000000000000000000000000946;
const String _videoIdthree = 'https://youtu.be/4wli0ULFIbk?t=';
const double _startSecondsthree = 000000000000000000000000000295;
const String _videoIdfour = 'https://youtu.be/TSmEn1qfhnU?t=';
const double _startSecondsfour = 000000000000000000000000000894;
const String _videoIdfive = 'https://youtu.be/QINII0eeJxc?t=';
const double _startSecondsfive = 0000000000000000000000000001019;
