...
class EnglishEntryattache extends StatelessWidget {
  ...
  Future<void> speakAttache(String languageCode) async {
    // DOPSUM: CHANGE speakAttache
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("attaché"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAttache432(String languageCode) async {
    // DOPSUM: CHANGE speakAttache
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "The commercial attaché was tasked with promoting trade between the two countries."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "attaché", // DOPSUM: CHANGE WORD ENTRY
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: () =>
                                  speakAttache(// DOPSUM: CHANGE THE WORD ABOVE
                                      "en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /ˌætəˈʃeɪ/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "4ShB0YWRrNs";
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = "eikcIIW9rrg";
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = "U2WPTNOTFpI";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "BtHLwjo4C3I";
...
class YoutubeEmbeddedseven extends StatelessWidget {
  static String myVideoId = "1Oq-gR1gzoc";
...
class YoutubeEmbeddedeight extends StatelessWidget {
  static String myVideoId = "Dr6yd0eANAU";
...
class YoutubeEmbeddednine extends StatelessWidget {
  static String myVideoId = "hfAzVL4mCeY";
