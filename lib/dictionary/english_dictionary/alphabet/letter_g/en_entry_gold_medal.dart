...
class EnglishEntrygoldmedal extends StatefulWidget {
  const EnglishEntrygoldmedal({super.key});

  @override
  State<EnglishEntrygoldmedal> createState() => _EnglishEntrygoldmedalState();
}

class _EnglishEntrygoldmedalState extends State<EnglishEntrygoldmedal> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gold medal";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gold medal""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """There is every likelihood that they will win a fourth gold medal.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gold medal""",
                      // alsoEnglishWord: "also: gold medal",
                      britshText: """IpaUK: /ˌɡəʊld ˈmedl/""",
                      americanText: """IpaUS: /ˌɡəʊld ˈmedl/""",
...
کوردی: 
"""),
// With short examples define "gold medal", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) مەدالیایەک کە لە زێڕ درووستکراوە و دەدرێت بە براوی پێشبڕکێیەک"""),
                    SentencesRow(
                      englishText:
                          """There is every likelihood that they will win a fourth gold medal.""",
                      kurdishText:
                          """هەموو ئەگەرێک هەیە کە چوارەم مەدالیای زێڕ دەبەنەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/aAByKcPJ5NQ?t=';
const double _startSecondsend = 000000000000000000000000000103;
const String _videoIdone = 'https://youtu.be/60FM9WjkXtA?t=';
const double _startSecondsone = 000000000000000000000000000923;
const String _videoIdtwo = 'https://youtu.be/L1kYZHnHS0E?t=';
const double _startSecondstwo = 0000000000000000000000000001162;
const String _videoIdthree = 'https://youtu.be/XXnlVlkkkxM?t=';
const double _startSecondsthree = 000000000000000000000000000485;
const String _videoIdfour = 'https://youtu.be/sTTvilkyTLY?t=';
const double _startSecondsfour = 000000000000000000000000000265;
const String _videoIdfive = 'https://youtu.be/v5DWJv1hiwM?t=';
const double _startSecondsfive = 0000000000000000000000000001441;
