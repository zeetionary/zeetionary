...
class EnglishEntryaccomplish extends StatefulWidget {
  const EnglishEntryaccomplish({super.key});

  @override
  State<EnglishEntryaccomplish> createState() => _EnglishEntryaccomplishState();
}

class _EnglishEntryaccomplishState extends State<EnglishEntryaccomplish> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "accomplish";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """accomplish""",
                      // alsoEnglishWord: "also: accomplish",
                      britshText: """IpaUK: /əˈkʌmplɪʃ/""",
                      americanText: """IpaUS: /əˈkɑːmplɪʃ/""",
