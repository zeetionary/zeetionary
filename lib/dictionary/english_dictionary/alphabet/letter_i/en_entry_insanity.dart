...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = '9vK1vtRJn24';
    const double startSecondsend = 129;
    const String videoIdone = 'OZdW1heGWFw';
    const double startSecondsone = 166;
    const String videoIdtwo = 'kElsSj8hky4';
    const double startSecondstwo = 517;
    const String videoIdthree = 'Oij-BdIkPgQ';
    const double startSecondsthree = 966;
    const String videoIdfour = 'mjCAyo2Litw';
    const double startSecondsfour = 682;
    const String videoIdfive = 'qCbfTN-caFI';
    const double startSecondsfive = 1304;
