...
class EnglishEntryevict extends StatefulWidget {
  const EnglishEntryevict({super.key});

  @override
  State<EnglishEntryevict> createState() => _EnglishEntryevictState();
}

class _EnglishEntryevictState extends State<EnglishEntryevict> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """evict""",
                      // alsoEnglishWord: "also: evict",
                      britshText: """IpaUK: /ɪˈvɪkt/""",
                      americanText: """IpaUS: /ɪˈvɪkt/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The council has tried to get them evicted.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (کردار) دەرکردنی کەسێک لە ژوور یان زەوییەک، بەتایبەتی کە مافی یاساییت هەیە"""),
          SentencesRow(
            englishText: """The council has tried to get them evicted.""",
            kurdishText: """ئەنجوومەنەکە هەوڵیداوە دەریان بکات.""",
          ...
          SentencesRow(
            ...
            kurdishText: """پۆلیس پێویست بوو خۆپیشاندەران لە بیناکە دەربکات.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: evict (Derived forms: evicted, evicting, evicts)
...
2. Expel from one's property or force to move out by a legal process (= force out)
...
const double _startSecondsend = 000000000000000000000000000000; // 1170;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/W5tlGJwvmCQ?t=';
const double _startSecondsone = 00000000000000000000000000000; // 270;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/Bbu7oq1kAL4?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 806;
const String _videoIdthree = 'VIDEOhttps://youtu.be/DbhuZFVqAqc?t=';
const double _startSecondsthree = 000000000000000000000000000; // 1623;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/A7beCOs4yAw?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 358;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/iVxdMDtjQ34?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 32;
