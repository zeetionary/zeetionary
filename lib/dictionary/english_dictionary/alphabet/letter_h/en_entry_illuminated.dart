...
class EnglishEntryilluminated extends StatefulWidget {
  const EnglishEntryilluminated({super.key});

  @override
  State<EnglishEntryilluminated> createState() =>
      _EnglishEntryilluminatedState();
}

class _EnglishEntryilluminatedState extends State<EnglishEntryilluminated> {
  @override
  void initState() {
    super.initState();
...
1. Provided with artificial light (- lighted, lit, well-lighted)
"illuminated advertising";
""",
  );

  final String keyword = "illuminated";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""illuminated""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The doctor examined his x-ray on an illuminated screen.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001429;
    ...
    const String videoIdthree = 'https://youtu.be/ZT3X1fYFViE?t=';
    const double startSecondsthree = 000000000000000000000000000254;
    const String videoIdfour = 'https://youtu.be/SAaESb4wTCM?t=';
    const double startSecondsfour = 00000000000000000000000000094;
    const String videoIdfive = 'https://youtu.be/P3o2z03JUSU?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """illuminated""",
                      // alsoEnglishWord: "also: illuminated",
                      britshText: """IpaUK: /ɪˈluːmɪneɪtɪd/""",
                      americanText: """IpaUS: /ɪˈluːmɪneɪtɪd/""",
...
کوردی: ڕۆشن(کراو)، ڕۆشنایی‌پێدراو، چراخانی‌کراو، ڕۆشنایی‌تێ‌گیراو، ڕووناک
"""),
// With short examples define "illuminated", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە بە لایتی ڕووناک ڕۆشنکراوە"""),
                    SentencesRow(
                      englishText:
                          """The doctor examined his x-ray on an illuminated screen.""",
                      kurdishText:
                          """پزیشکەکە پشکنینی کرد بۆ تیشکە ئێکسەکەی لەسەر شاشەیەکی ڕووناک.""",
