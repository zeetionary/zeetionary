...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'https://youtu.be/XnbCSboujF4?t=';
    const double startSecondstwo = 000000000000000000000000000532;
    const String videoIdthree = 'https://youtu.be/bwQR4WnTYdQ?t=';
    const double startSecondsthree = 000000000000000000000000000278;
    const String videoIdfour = 'https://youtu.be/SURIyuxfYJw?t=';
    const double startSecondsfour = 000000000000000000000000000265;
    const String videoIdfive = 'https://youtu.be/oD9BaNAH-eE?t=';
    const double startSecondsfive = 000000000000000000000000000797;
