...
class EnglishEntryfinger extends StatefulWidget {
  const EnglishEntryfinger({super.key});

  @override
  State<EnglishEntryfinger> createState() => _EnglishEntryfingerState();
}

class _EnglishEntryfingerState extends State<EnglishEntryfinger> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: finger (Derived forms: fingers)
1. Any of the terminal members of the hand (sometimes excepting the thumb)
"her fingers were long and thin"
 
2. The length of breadth of a finger used as a linear measure (= fingerbreadth, finger's breadth, digit)
 
3. One of the parts of a glove that provides covering for a finger or thumb

- Verb: finger (Derived forms: fingers, fingered, fingering)
1. Feel or handle with the fingers (= thumb)
"finger the binding of the book";
 
2. Examine by touch (= feel)
...
5. [informal] Recognize as being; establish the identity of someone or something (= identify, place)
 
6. [informal] Sexually stimulate using a finger or fingers
""",
  );

  final String keyword = "finger";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She ran her fingers through her hair.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Dad started twiddling his fingers nervously.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He gently laced his fingers between mine.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He held up his hand with the fingers extended.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""His clumsy fingers struggled with the buttons.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I dipped my finger in the sauce and licked it.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""It's easiest to eat chicken legs with your fingers.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The long-fingered athlete excelled in basketball.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Gary sat fingering his beard, saying nothing.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Who fingered him for the burglaries?""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """finger""",
                      // alsoEnglishWord: "also: finger",
                      britshText: """IpaUK: /ˈfɪŋɡə(r)/""",
                      americanText: """IpaUS: /ˈfɪŋɡər/""",
...
// With short examples define "finger", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText: """She ran her fingers through her hair.""",
                      kurdishText: """پەنجەکانیی هێنا بە قژیدا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """He was about to speak but she raised a finger to her lips.""",
                      kurdishText:
                          """خەریک بوو قسە بکات بەڵام پەنجەی خستە سەر لێوی.""",
                        ...
                        MyExpansionTile(
                          children: [
                            SentencesRow(
                              ...
                              kurdishText:
                                  """باوکم بە شڵەژاوی دەستی کرد بە گەمەکردن بە پەنجەکانی.""",
                            ...
                            SentencesRow(
                              englishText:
                                  """Everyone put their fingers in their ears when the shooting started.""",
                              kurdishText:
                                  """هەموان پەنجەیان ئاخنییە گوێیان کە هاوارکردنەکە دەستی پێکرد.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """بە هێمنی پەنجەی لە هی من ئاڵاند.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """دەستی بەرزکردەوە بەوەی پەنجەی درێژکردبوو.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """پەنجە ناشارەزاکانی دەستەپاچە بوون بەدەست دوگمەکانەوە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """پەنجەم کرد بە سۆسەکەدا و لێسامەوە.""",
                            ...
                            SentencesRow(
                              ...
                              kurdishText:
                                  """ئاسانترینە ڕانی مریشک بە پەنجەکانت بخۆیت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) هەبوونی ئەو جۆرە پەنجەیەی باسکراوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """The long-fingered athlete excelled in basketball.""",
                      kurdishText:
                          """وەرزشانە پەنجە درێژەکە نایاب بوو لە یاری باسکە.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """گاری دەنیشت بوو پەنجەی لە ڕیشی دەدا و هیچی نەدەگوت.""",
...
const double _startSecondsone = 000000000000000000000000000629;
const String _videoIdtwo = 'https://youtu.be/_GFkHA5EZdE?t=';
const double _startSecondstwo = 000000000000000000000000000381;
const String _videoIdthree = 'https://youtu.be/_Z0ZQT0FttM?t=';
const double _startSecondsthree = 0000000000000000000000000004346;
const String _videoIdfour = 'https://youtu.be/8wewPn7TZfs?t=';
const double _startSecondsfour = 000000000000000000000000000212;
const String _videoIdfive = 'https://youtu.be/L81XWiDgmTk?t=';
const double _startSecondsfive = 000000000000000000000000000110;
