...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/exWKMguCXfw?t=';
    const double startSecondsone = 0000000000000000000000000001166;
    const String videoIdtwo = 'https://youtu.be/5o_vCPJpPOs?t=';
    const double startSecondstwo = 000000000000000000000000000346;
    const String videoIdthree = 'https://youtu.be/lnx9MRWc_bY?t=';
    const double startSecondsthree = 0000000000000000000000000005;
    const String videoIdfour = 'https://youtu.be/vFANgWN2Ul0?t=';
    const double startSecondsfour = 000000000000000000000000000202;
    const String videoIdfive = 'https://youtu.be/3_Z2AnIpgOc?t=';
    const double startSecondsfive = 000000000000000000000000000319;
