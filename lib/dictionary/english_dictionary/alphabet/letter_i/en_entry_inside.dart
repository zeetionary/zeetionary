...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/zmEv7vTOQGE?t=';
    const double startSecondsend = 000000000000000000000000000493;
    const String videoIdone = 'https://youtu.be/MnExgQ81fhU?t=';
    const double startSecondsone = 0000000000000000000000000007;
    const String videoIdtwo = 'https://youtu.be/HDntl7yzzVI?t=';
    const double startSecondstwo = 000000000000000000000000000686;
    const String videoIdthree = 'https://youtu.be/Xtwar56r4Lg?t=';
    const double startSecondsthree = 00000000000000000000000000011;
    const String videoIdfour = 'https://youtu.be/oFKbvpXJ83w?t=';
    const double startSecondsfour = 0000000000000000000000000006;
    const String videoIdfive = 'https://youtu.be/MiipO0rq-g0?t=';
    const double startSecondsfive = 00000000000000000000000000097;
