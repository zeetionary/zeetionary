...
class EnglishEntryerase extends StatefulWidget {
  const EnglishEntryerase({super.key});

  @override
  State<EnglishEntryerase> createState() => _EnglishEntryeraseState();
}

class _EnglishEntryeraseState extends State<EnglishEntryerase> {
  @override
  void initState() {
    super.initState();
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """erase""",
                      // alsoEnglishWord: "also: erase",
                      britshText: """IpaUK: /ɪˈreɪz/""",
                      americanText: """IpaUS: /ɪˈreɪz/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She tried to erase the memory of that evening.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""All doubts were suddenly erased from his mind.""");
  }
...
"""),
          const DefinitionKurdish(
              text: """١. (کردار) بە تەواوی سڕینەوەی شتێک"""),
          SentencesRow(
            englishText: """She tried to erase the memory of that evening.""",
            kurdishText: """هەوڵی دا یادەوەریی ئەو شەوە بسڕێتەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """All doubts were suddenly erased from his mind.""",
            kurdishText: """هەموو گومانێک لەناکاو لە مێشکی سڕدرایەوە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """You cannot erase injustice from the world.""",
            kurdishText: """ناتوانیت نادادی لە جیهان بنبڕ بکەیت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: erase (Derived forms: erasing, erases, erased)
1. Remove from memory or existence (= wipe out)
 
2. Remove by or as if by rubbing or erasing (= rub out, score out, efface, wipe off)
"Please erase the formula on the blackboard--it is wrong!";
 
3. (recording) wipe out digitally or magnetically recorded information (= delete)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/lVoGZiL-kns?t=';
const double _startSecondsend = 000000000000000000000000000000; // 172;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/PhNUjg9X4g8?t=';
const double _startSecondsone = 00000000000000000000000000000; // 57;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/-PSgBCQpEt8?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 256;
const String _videoIdthree = 'VIDEOhttps://youtu.be/L1kYZHnHS0E?t=';
const double _startSecondsthree = 000000000000000000000000000; // 519;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/WfVF-Ec4naQ?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 136;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/bhRCzudj3rA?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 123;
