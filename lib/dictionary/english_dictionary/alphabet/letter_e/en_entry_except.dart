...
class EnglishEntryexcept extends StatefulWidget {
  const EnglishEntryexcept({super.key});

  @override
  State<EnglishEntryexcept> createState() => _EnglishEntryexceptState();
}

class _EnglishEntryexceptState extends State<EnglishEntryexcept> {
  @override
  void initState() {
    super.initState();
  }
...
"""),
          ...
          SentencesRow(
            ...
            kurdishText: """ھەموو ڕۆژێک کار دەکەین جگە لە یەکشەممە.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ھەموان ھاتن جگە لە مات.""",
          ...
          SentencesRow(
            ...
            kurdishText: """ھیچم لەبەر نەبوو جگە لە گۆرەوییەکانم.""",
          ...
          SentencesRow(
            englishText:
                """I didn't tell him anything except that I needed the money.""",
            kurdishText:
                """ھیچم پێ نەگوت جگە لەوەی کە پێویستیم بە پارەکە بوو.""",
