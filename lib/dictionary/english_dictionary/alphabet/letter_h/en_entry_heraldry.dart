...
class EnglishEntryheraldry extends StatefulWidget {
  const EnglishEntryheraldry({super.key});

  @override
  State<EnglishEntryheraldry> createState() => _EnglishEntryheraldryState();
}

class _EnglishEntryheraldryState extends State<EnglishEntryheraldry> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heraldry (Derived forms: heraldries)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heraldry""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heraldry""",
                      // alsoEnglishWord: "also: heraldry",
                      britshText: """IpaUK: /ˈherəldri/""",
                      americanText: """IpaUS: /ˈherəldri/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) لێکۆڵینەوە لە مێژووی درووشمە سەربازی و خێزانە کۆنەکان"""),
                    SentencesRow(
                      englishText:
                          """Heraldry helps identify different noble families in history.""",
                      kurdishText:
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/NG4Ws74RV04?t=';
const double _startSecondsend = 000000000000000000000000000226;
const String _videoIdone = 'https://youtu.be/y3h5OlgoSc4?t=';
const double _startSecondsone = 000000000000000000000000000249;
const String _videoIdtwo = 'https://youtu.be/t2RYl6QHVe4?t=';
const double _startSecondstwo = 000000000000000000000000000242;
const String _videoIdthree = 'https://youtu.be/iqVa8gP-d9s?t=';
const double _startSecondsthree = 00000000000000000000000000069;
const String _videoIdfour = 'https://youtu.be/ZXsZlNSUphc?t=';
const double _startSecondsfour = 000000000000000000000000000560;
const String _videoIdfive = 'https://youtu.be/SWXNSkE3YEk?t=';
const double _startSecondsfive = 000000000000000000000000000570;
