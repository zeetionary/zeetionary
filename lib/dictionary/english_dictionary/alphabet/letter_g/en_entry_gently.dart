...
class EnglishEntrygently extends StatefulWidget {
  const EnglishEntrygently({super.key});

  @override
  State<EnglishEntrygently> createState() => _EnglishEntrygentlyState();
}

class _EnglishEntrygentlyState extends State<EnglishEntrygently> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She held the baby gently.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Massage the area gently but firmly.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Simmer the soup gently for 30 minutes.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""‘You miss them, don't you?’ he asked gently.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The path ran gently down to the sea.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Don't go too fast—gently does it!""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gently""",
                      // alsoEnglishWord: "also: gently",
                      britshText: """IpaUK: /ˈdʒentli/""",
                      americanText: """IpaUS: /ˈdʒentli/""",
...
// With short examples define "gently", please follow LX instructions
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Simmer the soup gently for 30 minutes.""",
                      kurdishText: """بۆ ٣٠ خولەک شۆرباکە مێروولەکوڵ بکە.""",
...
const double _startSecondstwo = 0000000000000000000000000001505;
const String _videoIdthree = 'https://youtu.be/kHrjgWoy8qY?t=';
const double _startSecondsthree = 000000000000000000000000000333;
const String _videoIdfour = 'https://youtu.be/h26QXErwAtc?t=';
const double _startSecondsfour = 000000000000000000000000000162;
const String _videoIdfive = 'https://youtu.be/xVQxvthAcLU?t=';
const double _startSecondsfive = 0000000000000000000000000001339;
