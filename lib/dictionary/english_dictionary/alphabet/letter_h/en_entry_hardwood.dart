...
class EnglishEntryhardwood extends StatefulWidget {
  const EnglishEntryhardwood({super.key});

  @override
  State<EnglishEntryhardwood> createState() => _EnglishEntryhardwoodState();
}

class _EnglishEntryhardwoodState extends State<EnglishEntryhardwood> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hardwood""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hardwood""",
                      // alsoEnglishWord: "also: hardwood",
                      britshText: """IpaUK: /ˈhɑːdwʊd/""",
                      americanText: """IpaUS: /ˈhɑːrdwʊd/""",
