...
class EnglishEntryfiberglass extends StatefulWidget {
  const EnglishEntryfiberglass({super.key});

  @override
  State<EnglishEntryfiberglass> createState() => _EnglishEntryfiberglassState();
}

class _EnglishEntryfiberglassState extends State<EnglishEntryfiberglass> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fiberglass
Usage: US (elsewhere: fibreglass)
1. A covering material made of glass fibers in resins (= fibreglass [Brit, Cdn])
""",
  );

  final String keyword = "fiberglass";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fiberglass""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fiberglass""",
                      alsoEnglishWord: "also: fibreglass",
                      britshText: """IpaUK: /ˈfaɪbəɡlɑːs/""",
                      americanText: """IpaUS: /ˈfaɪbərɡlæs/""",
...
const String _videoIdtwo = 'https://youtu.be/6QDvJ7Vtfac?t=';
const double _startSecondstwo = 000000000000000000000000000318;
const String _videoIdthree = 'https://youtu.be/QxZ_iPldGtI?t=';
const double _startSecondsthree = 000000000000000000000000000665;
const String _videoIdfour = 'https://youtu.be/Spx6s9Q2xFg?t=';
const double _startSecondsfour = 000000000000000000000000000472;
const String _videoIdfive = 'https://youtu.be/tyixMpuGEL8?t=';
