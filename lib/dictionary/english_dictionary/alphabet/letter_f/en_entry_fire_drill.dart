...
class EnglishEntryfiredrill extends StatefulWidget {
  const EnglishEntryfiredrill({super.key});

  @override
  State<EnglishEntryfiredrill> createState() => _EnglishEntryfiredrillState();
}

class _EnglishEntryfiredrillState extends State<EnglishEntryfiredrill> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fire drill""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fire drill""",
                      // alsoEnglishWord: "also: fire drill",
                      britshText: """IpaUK: /ˈfaɪə drɪl/""",
                      americanText: """IpaUS: /ˈfaɪər drɪl/""",
...
// With short examples define "fire drill", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ڕاهێنانی ئەوەی دەبێت چی بکەیت بۆ هەڵهاتن لە بینایەکی ئاگرگرتوو"""),
                    SentencesRow(
                      englishText:
                          """We have regular fire drills to ensure that the staff know how to evacuate the building.""",
                      kurdishText:
                          """ڕاهێنانی ئاگرکەوتنەوەی بەردەواممان هەیە بۆ دڵنیایی کردنەوە لەوەی ستافەکە دەزانن چۆن بیناکە جێبهێڵن.""",
...
const double _startSecondsend = 0000000000000000000000000001664;
const String _videoIdone = 'https://youtu.be/R2-wrPJH-Pw?t=';
const double _startSecondsone = 000000000000000000000000000125;
const String _videoIdtwo = 'https://youtu.be/spr5smxuO5E?t=';
const double _startSecondstwo = 000000000000000000000000000127;
const String _videoIdthree = 'https://youtu.be/95kU0jbB4e4?t=';
const double _startSecondsthree = 00000000000000000000000000074;
const String _videoIdfour = 'https://youtu.be/TPPT5LBnHoY?t=';
const double _startSecondsfour = 00000000000000000000000000091;
const String _videoIdfive = 'https://youtu.be/bDnjiNCtFk4?t=';
const double _startSecondsfive = 000000000000000000000000000709;
