...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "distribute";
...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakdistribute(String languageCode) async {
    ...
    await flutterTts.speak("distribute");
  }
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakdistributes1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("The leaflets have been widely distributed.");
  }
  ...
  Future<void> speakdistributes2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("The newspaper is distributed free.");
  }
  ...
  Future<void> speakdistributes3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Viruses are often distributed via email.");
  }
  ...
  Future<void> speakdistributes4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("The organization distributed food to the earthquake victims.");
  }
  ...
  Future<void> speakdistributes5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("The money was distributed among schools in the area.");
  }
  ...
  Future<void> speakdistributes6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Who distributes our products in the UK?");
  }
  ...
  Future<void> speakdistributes7(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("Hood distributes dairy products throughout the United States.");
  }
  ...
  Future<void> speakdistributes8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("Make sure your weight is evenly distributed.");
  }
  ...
  Future<void> speakdistributes9(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("Cases of the disease are widely distributed through Europe.");
  }
...
// """),
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: "The newspaper is distributed free.",
            kurdishText: "ڕۆژنامەکە بێبەرامبەر دابەش دەکرێت.",
            onPressedBritish: () => speakdistributes2("en-GB"),
            onPressedAmerican: () => speakdistributes2("en-US"),
          ),
          const DividerSentences(),
          SentencesRow(
            englishText: "Viruses are often distributed via email.",
            kurdishText: "ڤایرۆس زۆرجار بە ئیمەیڵ بڵاودەکرێتەوە.",
            onPressedBritish: () => speakdistributes3("en-GB"),
            onPressedAmerican: () => speakdistributes3("en-US"),
          ),
          const DividerSentences(),
          SentencesRow(
            englishText:
            ...
            onPressedBritish: () => speakdistributes4("en-GB"),
            onPressedAmerican: () => speakdistributes4("en-US"),
          ),
          const DividerSentences(),
          SentencesRow(
            englishText: "The money was distributed among schools in the area.",
            kurdishText: "پارەکە بەسەر قوتابخانەکانی ناوچەکەدا دابەشکرا.",
            onPressedBritish: () => speakdistributes5("en-GB"),
            onPressedAmerican: () => speakdistributes5("en-US"),
          ),
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: "Who distributes our products in the UK?",
            kurdishText: "کێ بەرھەمەکانمان لە بەریتانیا بەبازاڕ دەکات؟",
            onPressedBritish: () => speakdistributes6("en-GB"),
            onPressedAmerican: () => speakdistributes6("en-US"),
          ),
          const DividerSentences(),
          SentencesRow(
            englishText:
                "Hood distributes dairy products throughout the United States.",
            kurdishText: "ھوود بەرھەمی شیرەمەنی بە ھەموو ئەمریکادا دەفرۆشێت.",
            onPressedBritish: () => speakdistributes7("en-GB"),
            onPressedAmerican: () => speakdistributes7("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: "٣. (کردار) بڵاوکردنەوەی شتێک ین بەشەکانی بە ناوچەیەکدا"),
          SentencesRow(
            englishText: "Make sure your weight is evenly distributed.",
            kurdishText: "دڵنیابەرەوە کێشت بە یەکسانی دابەش بووە.",
            onPressedBritish: () => speakdistributes8("en-GB"),
            onPressedAmerican: () => speakdistributes8("en-US"),
          ),
          const DividerSentences(),
          SentencesRow(
            englishText:
            ...
            onPressedBritish: () => speakdistributes9("en-GB"),
            onPressedAmerican: () => speakdistributes9("en-US"),
          ),
        ],
      ),
    );
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final double _startSeconds = 5660;
