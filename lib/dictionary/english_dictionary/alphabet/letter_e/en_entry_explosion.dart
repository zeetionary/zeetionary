...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The accused denies conspiring to cause an explosion.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""In the 1860s an explosion of major scientific publications took place.""");
  }
...
"""),
          ...
          SentencesRow(
            englishText:
                """There were two loud explosions and then the building burst into flames.""",
            kurdishText: """دوو تەقینەوەی گەورە هەبوو و دواتر بیناکە کەوتە ناو بڵێسە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The accused denies conspiring to cause an explosion.""",
            kurdishText: """تاوانبارەکە ڕەتیدەکاتەوە پلانی ئەنجامدانی تەقینەوەیەکی دانابێت.""",
          ...
          const DividerDefinition(),
          const DefinitionKurdish(text: """٢. (ناو) زۆربوونی لەناکاو لە بڕ یان ژمارەی شتێک"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """In the 1860s an explosion of major scientific publications took place.""",
            kurdishText: """ساڵانی ١٨٦٠ ـەکان تەنینەوەیەکی بڵاوکراوەی زانستیی گرنگ ڕوویدا.""",
            onPressedBritish: () => speaksentence6("en-GB"),
            onPressedAmerican: () => speaksentence6("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """٢. (ناو) دەربڕینی لەناکاوی هەست و سۆز، بەتایبەتی تووڕەیی"""),
          const DividerSentences(),
          SentencesRow(
...
const String _videoIdtwo = 'https://youtu.be/QiKZYt9070U?t=';
const double _startSecondstwo = 000000000000000000000000000442;
const String _videoIdthree = 'https://youtu.be/XI9kKiyIMf0?t=';
const double _startSecondsthree = 000000000000000000000000000208;
const String _videoIdfour = 'https://youtu.be/ReLgZFNYQ5k?t=';
const double _startSecondsfour = 00000000000000000000000000021;
const String _videoIdfive = 'https://youtu.be/uXG31J68dcY?t=';
