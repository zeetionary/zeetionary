...
class EnglishEntryadhesion extends StatefulWidget {
  const EnglishEntryadhesion({super.key});

  @override
  State<EnglishEntryadhesion> createState() => _EnglishEntryadhesionState();
}

class _EnglishEntryadhesionState extends State<EnglishEntryadhesion> {
  @override
  void initState() {
    super.initState();
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """adhesion""",
                      // alsoEnglishWord: "also: adhesion",
                      britshText: """IpaUK: /ədˈhiː.ʒən/""",
                      americanText: """IpaUS: /ədˈhiː.ʒən/""",
