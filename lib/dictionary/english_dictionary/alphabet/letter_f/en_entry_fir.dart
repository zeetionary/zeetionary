...
class EnglishEntryfir extends StatefulWidget {
  const EnglishEntryfir({super.key});

  @override
  State<EnglishEntryfir> createState() => _EnglishEntryfirState();
}

class _EnglishEntryfirState extends State<EnglishEntryfir> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fir (Derived forms: firs)
1. Any of various evergreen trees of the genus Abies; chiefly of upland areas (= fir tree, true fir)
 
2. Nonresinous wood of a fir tree
""",
  );

  final String keyword = "fir";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They decorated a small fir tree for Christmas.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fir""",
                      // alsoEnglishWord: "also: fir",
                      britshText: """IpaUK: /fɜː(r)/""",
                      americanText: """IpaUS: /fɜːr/""",
...
// With short examples define "fir", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دارێکی هەمیشەسەوز کە گەڵاکەی وەک دەرزی هەیە"""),
                    SentencesRow(
                      englishText:
                          """They decorated a small fir tree for Christmas.""",
                      kurdishText: """سنەوبەرەکەیان بۆ کریسمس ڕازاندەوە.""",
...
const double _startSecondsend = 000000000000000000000000000832;
const String _videoIdone = 'https://youtu.be/9GR3XSuInYE?t=';
const double _startSecondsone = 000000000000000000000000000225;
const String _videoIdtwo = 'https://youtu.be/4Nr1AgIfajI?t=';
const double _startSecondstwo = 00000000000000000000000000032;
const String _videoIdthree = 'https://youtu.be/HdwzJLTLFqc?t=';
const double _startSecondsthree = 000000000000000000000000000645;
const String _videoIdfour = 'https://youtu.be/LQEzTcLH27U?t=';
const double _startSecondsfour = 000000000000000000000000000424;
const String _videoIdfive = 'https://youtu.be/hUTCAIiL8j0?t=';
const double _startSecondsfive = 000000000000000000000000000409;
