...
class EnglishEntrylearned extends StatefulWidget {
  const EnglishEntrylearned({super.key});

  @override
  State<EnglishEntrylearned> createState() => _EnglishEntrylearnedState();
}

class _EnglishEntrylearnedState extends State<EnglishEntrylearned> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""learned""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We all have different learned responses to anger.""");
  }
...
// With short examples define "learned", please follow LX instructions
                    ...
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ھاوەڵناو) کە بە ڕاهێنان یان خوێندن بەدەستهاتووە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We all have different learned responses to anger.""",
                      kurdishText: """هەموومان وەڵامدانەوەی جیاوازی فێربوومان هەیە بۆ مەترسی.""",
