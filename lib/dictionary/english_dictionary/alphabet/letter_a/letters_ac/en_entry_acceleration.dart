...
// replace these: EnglishEntryacceleration - speakAcceleration - acceleration - /əkˌseləˈreɪʃn/

enum TtsState { playing }

class EnglishEntryacceleration extends StatelessWidget {
  EnglishEntryacceleration({Key? key}) : super(key: key);
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAcceleration(String languageCode) async {
    // DOPSUM: CHANGE speakAcceleration
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("acceleration"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAc45987(String languageCode) async {
    // DOPSUM: CHANGE speakAcceleration
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("a car with good acceleration"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAc95741(String languageCode) async {
    // DOPSUM: CHANGE speakAcceleration
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "There has been a rapid acceleration in the growth of industry."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əkˌseləˈreɪʃn/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
2. The act of accelerating; increasing the speed (= quickening, speedup)
