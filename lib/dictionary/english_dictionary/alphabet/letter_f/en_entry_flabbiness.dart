...
class EnglishEntryflabbiness extends StatefulWidget {
  const EnglishEntryflabbiness({super.key});

  @override
  State<EnglishEntryflabbiness> createState() => _EnglishEntryflabbinessState();
}

class _EnglishEntryflabbinessState extends State<EnglishEntryflabbiness> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: flabbiness
1. A flabby softness (= limpness, flaccidity)
""",
  );

  final String keyword = "flabbiness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""flabbiness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""There was a little flabbiness in his lower belly.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """They needed exercise to become athletic and lose the flabbiness of age.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """flabbiness""",
                      // alsoEnglishWord: "also: flabbiness",
                      britshText: """IpaUK: /ˈflæb.i.nəs/""",
                      americanText: """IpaUS: /ˈflæb.i.nəs/""",
...
کوردی: بێ‌هێزی، خاوی، شلی، خۆنەگرتوویی، نەبەگەیی، شەوێقی، پفەڵی، نەرمی، شۆڕی، داکەوتوویی
"""),
// With short examples define "flabbiness", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """There was a little flabbiness in his lower belly.""",
                      kurdishText: """کەمێک شل‌شۆڕی لە زگی خوارەوەی هەبوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """They needed exercise to become athletic and lose the flabbiness of age.""",
                      kurdishText:
                          """پێویستییان بە ڕاهێنان بوو بۆ بوون بە وەرزشی و لەدەستدانی نەرم و شلی تەمەن.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/4h36wfqcg9A?t=';
const double _startSecondsend = 000000000000000000000000000407;
const String _videoIdone = 'https://youtu.be/jrIogch5DBU?t=';
const double _startSecondsone = 0000000000000000000000000003196;
const String _videoIdtwo = 'https://youtu.be/JL024_E1AUk?t=';
const double _startSecondstwo = 0000000000000000000000000002721;
const String _videoIdthree = 'https://youtu.be/JgXlIOGXhTc?t=';
const double _startSecondsthree = 000000000000000000000000000137;
const String _videoIdfour = 'https://youtu.be/dfk9BlggPkI?t=';
const double _startSecondsfour = 0000000000000000000000000001784;
const String _videoIdfive = 'https://youtu.be/FT4-kTZuRiA?t=';
