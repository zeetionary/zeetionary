...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000002143;
    const String videoIdone = 'https://youtu.be/QcUey-DVYjk?t=';
    const double startSecondsone = 0000000000000000000000000001802;
    const String videoIdtwo = 'https://youtu.be/YLmDE_JYUNU?t=';
    const double startSecondstwo = 0000000000000000000000000001170;
    const String videoIdthree = 'https://youtu.be/JcpboMScfIY?t=';
    const double startSecondsthree = 0000000000000000000000000002056;
    const String videoIdfour = 'https://youtu.be/j2KKUcxAdjc?t=';
    const double startSecondsfour = 000000000000000000000000000183;
    const String videoIdfive = 'https://youtu.be/Poe76zLndr8?t=';
