...
"""),
// With short examples define "grill", please follow LX instructions
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (کردار) ئامادەکردنی خواردن لەسەر ئاگری بەهێز"""),
                    const DividerSentences(),
                    SentencesRow(
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/kjWcE3EvX-0?t=';
const double _startSecondsend = 0000000000000000000000000007;
const String _videoIdone = 'https://youtu.be/82_LJz76NSs?t=';
const double _startSecondsone = 000000000000000000000000000264;
const String _videoIdtwo = 'https://youtu.be/ktJZdZ8SVJ8?t=';
const double _startSecondstwo = 00000000000000000000000000020;
const String _videoIdthree = 'https://youtu.be/jQZK52C0hPI?t=';
const double _startSecondsthree = 00000000000000000000000000038;
const String _videoIdfour = 'https://youtu.be/xfMAfesUHOY';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/ZHp-VmvqLQk?t=';
