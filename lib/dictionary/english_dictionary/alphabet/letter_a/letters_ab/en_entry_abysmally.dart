...
class EnglishEntryabysmally extends StatefulWidget {
  const EnglishEntryabysmally({super.key});

  @override
  State<EnglishEntryabysmally> createState() => _EnglishEntryabysmallyState();
}

class _EnglishEntryabysmallyState extends State<EnglishEntryabysmally> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "abysmally";
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """abysmally""",
                      // alsoEnglishWord: "also: abysmally",
                      britshText: """IpaUK: /əˈbɪzməli/""",
                      americanText: """IpaUS: /əˈbɪzməli/""",
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'uRHkJ4NyRlI';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'ZJOfyMCEzjQ';
