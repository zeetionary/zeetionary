...
class EnglishEntryfond extends StatefulWidget {
  const EnglishEntryfond({super.key});

  @override
  State<EnglishEntryfond> createState() => _EnglishEntryfondState();
}

class _EnglishEntryfondState extends State<EnglishEntryfond> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: fond (Derived forms: fonder, fondest)
1. Having or displaying warmth or affection (= affectionate, lovesome, tender)
"a fond embrace"; "fond of his nephew";
 
2. Extravagantly or foolishly loving and indulgent (= adoring, doting)
"hopelessly spoiled by a fond mother";
 
3. (followed by 'of' or 'to') having a strong preference or liking for (= partial)
"fond of chocolate";
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Over the years, I have grown quite fond of her.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I’ve always been very fond of your mother.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We had grown fond of the house and didn't want to leave.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Sheila's very fond of telling other people what to do.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I have very fond memories of my time in Spain.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fond""",
                      // alsoEnglishWord: "also: fond",
                      britshText: """IpaUK: /fɒnd/""",
                      americanText: """IpaUS: /fɑːnd/""",
...
کوردی: هۆگر، تامەزرۆ، بەتاسە، خووگرتوو، مایل، بەپەرۆش، خولیا، سەوداسەر، دڵبەستە،	لە ئەندازبەدەر دڵسۆز،	گەرم‌وگوڕانە، بەتین، بەحورمەت،	(هیوا، ئاوات، هتد) گەوجانە، مناڵانە، پووچەڵ،	خۆش‌باوەڕ، زووباوەڕ، سادە
"""),
// With short examples define "fond", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) هەبوونی هۆگری و خۆشەویستی بۆ کەسێک، بە تایبەتی یەکێک کە لە کۆنەوە ناسیوتە"""),
                    SentencesRow(
                      englishText:
                          """Over the years, I have grown quite fond of her.""",
                      kurdishText:
                          """بە درێژایی ساڵان، تەواو خووگرتوو بوومە پێوەی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """هەمیشە زۆر هۆگری دایکت بوومە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ھاوەڵناو) ئەوەی هۆگری شتێک بیت، بە تایبەتی شتێک کە لە کۆنەوە حەزت لێی کردووە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """We had grown fond of the house and didn't want to leave.""",
                      kurdishText:
                          """هۆگر بووبووین بە خانووەکەوە و نەمان دەویست جێی بهێڵین.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """شەیلا زۆر حەزی بەوەیە بە کەسانی دیکە بڵێت چی بکەن.""",
                      onPressedBritish: () => speaksentence4("en-GB"),
                      onPressedAmerican: () => speaksentence4("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(
                        text: """٤. (ھاوەڵناو) میهرەبان و خۆشەویست"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I have very fond memories of my time in Spain (= I remember it with affection and pleasure).""",
                      kurdishText:
                          """یادەوەریی زۆر خۆشی کاتمم لە ئیسپانیا هەیە.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٥. (ھاوەڵناو) هیوایەک سەبارەت بە شتێک کە ئەگەری کەمە ڕووبدات"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """I waited all day in the fond hope that she would change her mind.""",
                      kurdishText:
                          """تەواوی ڕۆژەکە چاوەڕێ بووم بەو هیوا لاوازەی کە بڕیارەکەی بگۆڕێت.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/G4BxOhJOmUw?t=';
const double _startSecondsend = 000000000000000000000000000218;
const String _videoIdone = 'https://youtu.be/_I0N-w7QEHc?t=';
const double _startSecondsone = 000000000000000000000000000251;
const String _videoIdtwo = 'https://youtu.be/Stl6OZo7wzg?t=';
const double _startSecondstwo = 000000000000000000000000000371;
const String _videoIdthree = 'https://youtu.be/gjp_ZNJoB54?t=';
const double _startSecondsthree = 00000000000000000000000000061;
const String _videoIdfour = 'https://youtu.be/ewLpXw6uN28?t=';
const double _startSecondsfour = 000000000000000000000000000329;
const String _videoIdfive = 'https://youtu.be/Xzv84ZdtlE0?t=';
const double _startSecondsfive = 0000000000000000000000000001914;
