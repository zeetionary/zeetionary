...
class EnglishEntryhiv extends StatefulWidget {
  const EnglishEntryhiv({super.key});

  @override
  State<EnglishEntryhiv> createState() => _EnglishEntryhivState();
}

class _EnglishEntryhivState extends State<EnglishEntryhiv> {
  @override
  void initState() {
    super.initState();
...
2. The virus that causes acquired immune deficiency syndrome (AIDS); it replicates in and kills the helper T cells (- human immunodeficiency virus)
""",
  );

  final String keyword = "HIV";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Blood is screened for HIV.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Antiretroviral drugs are the only way to treat HIV.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Condoms can help to minimize the risk of contracting HIV.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""All donated blood is tested for HIV and other infections.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""They block the entry of the HIV virus into the cells.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    // 188888880002200
    const String videoIdend = 'https://youtu.be/U52g6ZlR1W0?t=';
    const double startSecondsend = 00000000000000000000000000034;
    const String videoIdone = 'https://youtu.be/_VVlGOFgtE8?t=';
    const double startSecondsone = 000000000000000000000000000104;
    const String videoIdtwo = 'https://youtu.be/izwomieBwG0?t=';
    const double startSecondstwo = 00000000000000000000000000018;
    const String videoIdthree = 'https://youtu.be/DkpesT4gUBI?t=';
    const double startSecondsthree = 00000000000000000000000000019;
    const String videoIdfour = 'https://youtu.be/E2Hfz45e17w?t=';
    const double startSecondsfour = 0000000000000000000000000002;
    const String videoIdfive = 'https://youtu.be/yvvZDByU8h0?t=';
    const double startSecondsfive = 00000000000000000000000000033;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """HIV""",
                      // alsoEnglishWord: "also: HIV",
                      britshText: """IpaUK: /ˌeɪtʃ aɪ ˈviː/""",
                      americanText: """IpaUS: /ˌeɪtʃ aɪ ˈviː/""",
...
// With short examples define "HIV", please follow LX instructions
                    ...
                    CustomRichText(
                    textBeforeLink: "١. ئەو ڤایرۆسەی کە دەبێتە هۆکاری نەخۆشی ",
                    linkText: "ئایدز",
                    textAfterLink: "",
                    onTap: () {
                    Routemaster.of(context).push("/english-hiv/aids");
                    },
                    ),
                    SentencesRow(
                      englishText: """Blood is screened for HIV.""",
                      kurdishText: """خوێن پشکنینی بۆ دەکرێت بۆ ئێچ‌ئای‌ڤی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Antiretroviral drugs are the only way to treat HIV.""",
                      kurdishText:
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Condoms can help to minimize the risk of contracting HIV.""",
                      kurdishText:
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """All donated blood is tested for HIV and other infections.""",
                      kurdishText:
            ...
            onPressedBritish: () => speaksentence5("en-GB"),
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """They block the entry of the HIV virus into the cells.""",
                      kurdishText:
            ...
            onPressedBritish: () => speaksentence6("en-GB"),
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """He found out that he had HIV just last year.""",
                      kurdishText:
