...
class EnglishEntrygravy extends StatefulWidget {
  const EnglishEntrygravy({super.key});

  @override
  State<EnglishEntrygravy> createState() => _EnglishEntrygravyState();
}

class _EnglishEntrygravyState extends State<EnglishEntrygravy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: gravy (Derived forms: gravies)
1. A sauce made by adding stock, flour, or other ingredients to the juice and fat that drips from cooking meats
 
2. The seasoned but not thickened juices that drip from cooking meats; often a little water is added (- pan gravy)
 
3. [informal] A sudden happening that brings good fortune (as a sudden opportunity to make money) (- boom, bonanza, gold rush, godsend, manna from heaven, windfall, bunce [Brit, informal])

""",
  );

  final String keyword = "gravy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He made gravy using the drippings from the turkey.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gravy""",
                      // alsoEnglishWord: "also: gravy",
                      britshText: """IpaUK: /ˈɡreɪvi/""",
                      americanText: """IpaUS: /ˈɡreɪvi/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """He made gravy using the drippings from the turkey.""",
                      kurdishText:
                          """سۆسی گۆشتی درووستکرد بە گۆشتاوی قەلەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Anything on top of eight percent profit is just gravy for the industry.""",
                      kurdishText:
                          """هەر شتێک زیاتر لە هەشت لە سەد پارەی مفتە بۆ پیشەسازییەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/D8tPkb98Fkk?t=';
const double _startSecondsend = 000000000000000000000000000619;
const String _videoIdone = 'https://youtu.be/Yaui2pL26ZQ?t=';
const double _startSecondsone = 0000000000000000000000000001183;
const String _videoIdtwo = 'https://youtu.be/xk8PdL_PdSo?t=';
const double _startSecondstwo = 000000000000000000000000000101;
const String _videoIdthree = 'https://youtu.be/iN8zmmCRqUA?t=';
const double _startSecondsthree = 000000000000000000000000000612;
const String _videoIdfour = 'https://youtu.be/4H5--Qy3h9Q?t=';
const double _startSecondsfour = 000000000000000000000000000536;
const String _videoIdfive = 'https://youtu.be/JoGjIRVY9t4?t=';
const double _startSecondsfive = 000000000000000000000000000630;
