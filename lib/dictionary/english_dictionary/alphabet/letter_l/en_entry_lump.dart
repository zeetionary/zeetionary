...
class EnglishEntrylump extends StatefulWidget {
  const EnglishEntrylump({super.key});

  @override
  State<EnglishEntrylump> createState() => _EnglishEntrylumpState();
}

class _EnglishEntrylumpState extends State<EnglishEntrylump> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylump lump
WORD_WEB lump lump lump
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lump";
...
کوردی: 
"""),
// With short examples define "lump", please follow LX instructions
