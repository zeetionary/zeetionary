...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 2704;
    const String videoIdone = '3X4PxUCRDzU';
    const double startSecondsone = 159;
    const String videoIdtwo = 'iTjDi2ZO0n8';
    const double startSecondstwo = 68;
    const String videoIdthree = 'x4m_PdFbu-s';
    const double startSecondsthree = 2853;
    const String videoIdfour = 'LBuoQ3PjRrE';
    const double startSecondsfour = 31;
    const String videoIdfive = 'NubH0oxyQAI';
