...
class EnglishEntryfreckle extends StatefulWidget {
  const EnglishEntryfreckle({super.key});

  @override
  State<EnglishEntryfreckle> createState() => _EnglishEntryfreckleState();
}

class _EnglishEntryfreckleState extends State<EnglishEntryfreckle> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: freckle (Derived forms: freckles)
1. A small brownish spot (of the pigment melanin) on the skin (= lentigo)

- Verb: freckle (Derived forms: freckled, freckles, freckling)
1. Become freckled
"I freckle easily"
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""freckle""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He has red hair and freckles.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """freckle""",
                      // alsoEnglishWord: "also: freckle",
                      britshText: """IpaUK: /ˈfrekl/""",
                      americanText: """IpaUS: /ˈfrekl/""",
...
// With short examples define "freckle", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """She had wonderful clear skin with an attractive sprinkling of freckles.""",
                      kurdishText:
                          """پێستێکی ڕوون و جوانی هەبوو لەگەڵ خاڵی سەرنجڕاکێش لە ڕوخساریدا..""",
                    ...
                    SentencesRow(
                      englishText: """He has red hair and freckles.""",
                      kurdishText: """قژی سوور و خاڵی ڕووخساری هەیە.""",
...
const String _videoIdone = 'https://youtu.be/5mflPrZQnZY?t=';
const double _startSecondsone = 000000000000000000000000000762;
const String _videoIdtwo = 'https://youtu.be/kOd19ljsklQ?t=';
const double _startSecondstwo = 000000000000000000000000000894;
const String _videoIdthree = 'https://youtu.be/5ng7aqMtEp4?t=';
const double _startSecondsthree = 00000000000000000000000000097;
const String _videoIdfour = 'https://youtu.be/_786oEo0tiY';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/lDZGNgsBrLY?t=';
