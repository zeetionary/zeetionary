...
class EnglishEntryfraternization extends StatefulWidget {
  const EnglishEntryfraternization({super.key});

  @override
  State<EnglishEntryfraternization> createState() =>
      _EnglishEntryfraternizationState();
}

class _EnglishEntryfraternizationState
    extends State<EnglishEntryfraternization> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fraternization (Derived forms: fraternizations)
1. Associating with others in a brotherly or friendly way; especially with an enemy (= fraternisation [Brit])
""",
  );

  final String keyword = "fraternization";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fraternization""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Fraternization with the enemy was against the rules.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fraternization""",
                      // alsoEnglishWord: "also: fraternization",
                      britshText: """IpaUK: /ˌfrætənaɪˈzeɪʃn/""",
                      americanText: """IpaUS: /ˌfrætərnəˈzeɪʃn/""",
...
کوردی: برایەتی، دۆستایەتی، هەڵس‌وکەوت بە شێوازی دۆستانە
"""),
// With short examples define "fraternization", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """دۆستایەتی کردنی دوژمن دژ بە یاساکان بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Army regulations prohibit fraternization between men and women.""",
                      kurdishText:
                          """ڕێساکانی سوپا تێکەڵبوونی دۆستانەی پیاوان و ژنان قەدەغە دەکات.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/VDypP98aI20?t=';
const double _startSecondsend = 000000000000000000000000000810;
const String _videoIdone = 'https://youtu.be/LQwUJsR4w5c?t=';
const double _startSecondsone = 000000000000000000000000000212;
const String _videoIdtwo = 'https://youtu.be/Jh-L-jwmUAc?t=';
const double _startSecondstwo = 000000000000000000000000000321;
const String _videoIdthree = 'https://youtu.be/IIiDULrXaqQ?t=';
const double _startSecondsthree = 000000000000000000000000000430;
const String _videoIdfour = 'https://youtu.be/2IDl6rrlFt8?t=';
const double _startSecondsfour = 000000000000000000000000000361;
const String _videoIdfive = 'https://youtu.be/LwM9lP8XAh0?t=';
const double _startSecondsfive = 000000000000000000000000000930;
