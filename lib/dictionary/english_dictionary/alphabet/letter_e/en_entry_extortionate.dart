...
const String _videoIdend = 'https://youtu.be/ZcfitxiEJU8?t=';
const double _startSecondsend = 0000000000000000000000000001415;
const String _videoIdone = 'https://youtu.be/JITePXcDoGI?t=';
const double _startSecondsone = 00000000000000000000000000047;
const String _videoIdtwo = 'https://youtu.be/NwnDtE5G2ww?t=';
const double _startSecondstwo = 000000000000000000000000000315;
const String _videoIdthree = 'https://youtu.be/7TKbegvkLjw?t=';
const double _startSecondsthree = 000000000000000000000000000750;
const String _videoIdfour = 'https://youtu.be/F-_ffPsIcS0?t=';
const double _startSecondsfour = 000000000000000000000000000735;
const String _videoIdfive = 'https://youtu.be/lSII7Hs8p5Y?t=';
