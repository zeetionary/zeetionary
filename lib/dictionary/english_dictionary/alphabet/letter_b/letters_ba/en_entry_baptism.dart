...
// Define the word "baptism" and provide five example sentences for each meaning. Use Merriam Webster style. Provide at least 3 meanings.

// replace baptism - replace EnglishEntrybaptism

// replace speakBaptism - /ˈbæptɪzəm/

enum TtsState { playing }

class EnglishEntrybaptism extends StatelessWidget {
// blank divider
  EnglishEntrybaptism({super.key});
// blank divider
  ...
  Future<void> speakbaptism(String languageCode) async {
    ...
    await flutterTts.speak("baptism");
  }
  ...
  Future<void> speakbaptisms2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBaptisms22");
  }
  ...
  Future<void> speakbaptisms3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBaptisms33");
  }
  ...
  Future<void> speakbaptisms4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBaptisms44");
  }
  ...
  Future<void> speakbaptisms5(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBaptisms55");
  }
  ...
  Future<void> speakbaptisms6(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBaptisms66");
  }
  ...
  Future<void> speakbaptisms7(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("speakBaptisms77");
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(
                                word: "baptism"), // DOPSUM: CHANGE WORD ENTRY
                            // divvviiider
                          ],
                        ),
                        Row(
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'rMNAdHqGMhs';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'QpyHrQYeoIE';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 14709;
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'q6zPd5xE_Y8';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'sK6qDTtsZs8';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = '-a_WqkoQxVM';
...
// end baptism// TODO Implement this library.