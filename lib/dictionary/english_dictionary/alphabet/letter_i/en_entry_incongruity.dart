...
class EnglishEntryincongruity extends StatefulWidget {
  const EnglishEntryincongruity({super.key});

  @override
  State<EnglishEntryincongruity> createState() => _EnglishEntryincongruityState();
}

class _EnglishEntryincongruityState extends State<EnglishEntryincongruity> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incongruity""");
  }
