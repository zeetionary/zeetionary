...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'YGs9-_Fe74g';
    const double startSecondsend = 93;
    const String videoIdone = 'MOJ9gBQkZsE';
    const double startSecondsone = 343;
    const String videoIdtwo = 'aJSD8XV3qzE';
    const double startSecondstwo = 785;
    const String videoIdthree = 'ddVMceYCFiY';
    const double startSecondsthree = 2247;
    const String videoIdfour = 'HZq_HjKCRB4';
    const double startSecondsfour = 499;
    const String videoIdfive = 'aJQEQDFMRoo';
    const double startSecondsfive = 391;
