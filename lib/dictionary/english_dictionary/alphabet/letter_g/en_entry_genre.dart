...
class EnglishEntrygenre extends StatefulWidget {
  const EnglishEntrygenre({super.key});

  @override
  State<EnglishEntrygenre> createState() => _EnglishEntrygenreState();
}

class _EnglishEntrygenreState extends State<EnglishEntrygenre> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Crime fiction is a genre which seems likely to stay with us for many years.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The film is generally regarded as a classic of the genre.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """genre""",
                      // alsoEnglishWord: "also: genre",
                      britshText: """IpaUK: /ˈʒɒ̃rə/,  /ˈʒɒnrə/""",
                      americanText: """IpaUS: /ˈʒɑːnrə/""",
...
// With short examples define "genre", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) جۆرێکی دیاریکراو لە میوزیک، هونەر، وێژە، یان فیلم کە دەیناسیتەوە بەهۆی تایبەتمەندییەکانی"""),
                    SentencesRow(
                      englishText: """Crime fiction is a genre which seems likely to stay with us for many years.""",
                      kurdishText: """تاوانی خەیاڵی ژانەرێک کە وادیارە بۆ چەندین ساڵ لەگەڵمان بمێنێتەوە.""",
                    ...
                    SentencesRow(
                      englishText: """The film is generally regarded as a classic of the genre.""",
                      kurdishText: """فیلمەکە بە گشتی بە ژانەری کلاسیک دادەندرێت.""",
