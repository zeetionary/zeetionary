...
class EnglishEntryeuphemistic extends StatefulWidget {
  const EnglishEntryeuphemistic({super.key});

  @override
  State<EnglishEntryeuphemistic> createState() =>
      _EnglishEntryeuphemisticState();
}

class _EnglishEntryeuphemisticState extends State<EnglishEntryeuphemistic> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""euphemistic""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """euphemistic""",
                      // alsoEnglishWord: "also: euphemistic",
                      britshText: """IpaUK: /ˌjuːfəˈmɪstɪk/""",
                      americanText: """IpaUS: /ˌjuːfəˈmɪstɪk/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "euphemistic";
...
کوردی: باش‌دەربڕی‌یانە، سەربە باش‌دەربڕە،	بەڕێزانە، بەڕەوشتانە
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵناو) کە وا دەکات شتێک کەمتر نەگونجاو یان شەرمهێنەر بێت"""),
          SentencesRow(
            englishText:
                """‘We’re letting you go’ is a euphemistic way of saying ‘You’re fired.’""",
            kurdishText:
                """'ڕێگەت پێ دەدەین بچین' جۆری گونجاوی گوتنی 'دەرکراویت' ــە.""",
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/p0_-7FmrDq8?t=';
const double _startSecondsend = 000000000000000000000000000000; // 2994;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/1X_KdkoGxSs?t=';
const double _startSecondsone = 00000000000000000000000000000; // 14438;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/VSFadN1BrTI?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 305;
const String _videoIdthree = 'VIDEOhttps://youtu.be/VVMaiFIecjY?t=';
const double _startSecondsthree = 000000000000000000000000000; // 596;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/gGDKO5xuJow?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 877;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/AEbEpFAm1gk?t=';
