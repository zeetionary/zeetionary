...
class EnglishEntryinfallibility extends StatefulWidget {
  const EnglishEntryinfallibility({super.key});

  @override
  State<EnglishEntryinfallibility> createState() =>
      _EnglishEntryinfallibilityState();
}

class _EnglishEntryinfallibilityState extends State<EnglishEntryinfallibility> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: infallibility (Derived forms: infallibilities)
1. The quality of never making an error
""",
  );

  final String keyword = "infallibility";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""infallibility""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000001001;
    const String videoIdone = 'https://youtu.be/4qsdxkRhapU?t=';
    const double startSecondsone = 000000000000000000000000000175;
    const String videoIdtwo = 'https://youtu.be/Mdmhiv7O5m8?t=';
    const double startSecondstwo = 0000000000000000000000000001697;
    const String videoIdthree = 'https://youtu.be/8xtg9EOsEsg?t=';
    const double startSecondsthree = 000000000000000000000000000870;
    const String videoIdfour = 'https://youtu.be/U5tv10RpEPg?t=';
    const double startSecondsfour = 000000000000000000000000000753;
    const String videoIdfive = 'https://youtu.be/Mde2q7GFCrw?t=';
    const double startSecondsfive = 0000000000000000000000000003992;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """infallibility""",
                      // alsoEnglishWord: "also: infallibility",
                      britshText: """IpaUK: /ɪnˌfæləˈbɪləti/""",
                      americanText: """IpaUS: /ɪnˌfæləˈbɪləti/""",
...
کوردی: هەڵەنەکردوویی، هەڵەنەکەری، خەتانەکردوویی، لەهەڵەبەدووری، گوناەپێنەکراوی
"""),
// With short examples define "infallibility", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """His stubborn belief in his own infallibility kept him from listening to others.""",
                      kurdishText:
                          """باوەڕی شێلگیرانەیی بە هەڵەنەکردوویی خۆی هێشتییەوە لەوەی گوێ لە هیچ کەس بگرێت.""",
