...
class EnglishEntryfigurative extends StatefulWidget {
  const EnglishEntryfigurative({super.key});

  @override
  State<EnglishEntryfigurative> createState() => _EnglishEntryfigurativeState();
}

class _EnglishEntryfigurativeState extends State<EnglishEntryfigurative> {
  @override
  void initState() {
    super.initState();
...
1. (used of the meanings of words or text) not literal; using figures of speech (= nonliteral)
"figurative language";
 
2. Consisting of or forming human or animal figures (= figural)
"the figurative art of the humanistic tradition";
""",
  );

  final String keyword = "figurative";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""figurative""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He studied under a renowned figurative artist.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """figurative""",
                      // alsoEnglishWord: "also: figurative",
                      britshText: """IpaUK: /ˈfɪɡərətɪv/""",
                      americanText: """IpaUS: /ˈfɪɡjərətɪv/""",
...
const String _videoIdend = 'https://youtu.be/HaP_OeRuNew?t=';
const double _startSecondsend = 000000000000000000000000000414;
const String _videoIdone = 'https://youtu.be/GLy2rYHwUqY?t=';
const double _startSecondsone = 000000000000000000000000000206;
const String _videoIdtwo = 'https://youtu.be/UpHOkHxpTvQ?t=';
const double _startSecondstwo = 00000000000000000000000000012;
const String _videoIdthree = 'https://youtu.be/J44svaQc5WY?t=';
const double _startSecondsthree = 0000000000000000000000000003;
const String _videoIdfour = 'https://youtu.be/--jhKVdZOJM?t=';
const double _startSecondsfour = 0000000000000000000000000001725;
const String _videoIdfive = 'https://youtu.be/f66GfsKPTUg?t=';
const double _startSecondsfive = 000000000000000000000000000850;
