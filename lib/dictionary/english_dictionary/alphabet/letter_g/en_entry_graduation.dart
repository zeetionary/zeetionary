...
class EnglishEntrygraduation extends StatefulWidget {
  const EnglishEntrygraduation({super.key});

  @override
  State<EnglishEntrygraduation> createState() => _EnglishEntrygraduationState();
}

class _EnglishEntrygraduationState extends State<EnglishEntrygraduation> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "graduation";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""graduation""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""It was my first job after graduation.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""On graduation, he plans to travel around Asia.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""My whole family came to my graduation.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """graduation""",
                      // alsoEnglishWord: "also: graduation",
                      britshText: """IpaUK: /ˌɡrædʒuˈeɪʃn/""",
                      americanText: """IpaUS: /ˌɡrædʒuˈeɪʃn/""",
...
// With short examples define "graduation", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) بەدەستهێنانی بڕوانامەی زانکۆ، یان تەواوکردنی خوێندنی ئامادەیی لە ئەمریکا"""),
                    SentencesRow(
                      englishText: """It was my first job after graduation.""",
                      kurdishText: """یەکەم کارم بوو دوای تەواوکردنی زانکۆ.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لەگەڵ لە خوێندن‌بوونەوە، پلانی هەیە بە ئاسیادا گەشت بکات.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تەواوی خێزانەکەم هاتن بۆ ئاهەنگی دەرچوونم.""",
...
const String _videoIdone = 'https://youtu.be/BNPPMs9CvDQ?t=';
const double _startSecondsone = 000000000000000000000000000514;
const String _videoIdtwo = 'https://youtu.be/VI2B3sZ1GaY?t=';
const double _startSecondstwo = 00000000000000000000000000098;
const String _videoIdthree = 'https://youtu.be/g8n_0nIQWp0?t=';
...
const String _videoIdfive = 'https://youtu.be/4brrubUsqB0?t=';
