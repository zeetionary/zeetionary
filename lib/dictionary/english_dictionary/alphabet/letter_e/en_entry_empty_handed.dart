...
class EnglishEntryemptyhanded extends StatefulWidget {
  const EnglishEntryemptyhanded({super.key});

  @override
  State<EnglishEntryemptyhanded> createState() =>
      _EnglishEntryemptyhandedState();
}

class _EnglishEntryemptyhandedState extends State<EnglishEntryemptyhanded> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("empty-handed");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "empty-handed",
                      // alsoEnglishWord: "also: empty-handed",
                      britshText: "IpaUK: /ˌempti ˈhændɪd/",
                      americanText: "IpaUS: /ˌempti ˈhændɪd/",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "empty-handed";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("The robbers fled empty-handed.");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts
        .speak("She visited every Sunday and never arrived empty-handed.");
  }
...
کوردی: دەس‌بەتاڵ، دەس‌تەنگ، دەس‌بۆش، دەس‌خاڵی
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) بەبێ بەدەستخستنی ئەوەی کە دەتەوێت"""),
          SentencesRow(
            englishText: """The robbers fled empty-handed.""",
            kurdishText: """دزەکان بە دەستبەتاڵی ھەڵھاتن.""",
          ...
          SentencesRow(
            ...
            kurdishText:
                """ھەموو یەکشەممانێک دەچوون و ھەرگیز بە دەستبەتاڵی نەدەگەشتن.""",
          ...
          //   onPressedAmerican: () => speaksentence49sentence_6000""",
          ...
          //   onPressedAmerican: () => speaksentence59sentence6000""",
          ...
          //   onPressedAmerican: () => speaksentence79sentence8000""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: empty-handed
1. Having acquired or gained nothing (= unrewarded)
