...
class EnglishEntryilluminating extends StatefulWidget {
  const EnglishEntryilluminating({super.key});

  @override
  State<EnglishEntryilluminating> createState() =>
      _EnglishEntryilluminatingState();
}

class _EnglishEntryilluminatingState extends State<EnglishEntryilluminating> {
  @override
  void initState() {
    super.initState();
...
1. Tending to increase knowledge or dissipate ignorance (- enlightening, informative)
"an illuminating lecture";
""",
  );

  final String keyword = "illuminating";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""illuminating""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/XMCZEJVlyRY?t=';
    const double startSecondsend = 000000000000000000000000000293;
    const String videoIdone = 'https://youtu.be/v8Nv4rTKlMM?t=';
    const double startSecondsone = 0000000000000000000000000001066;
    const String videoIdtwo = 'https://youtu.be/-4uzyhbDFas?t=';
    const double startSecondstwo = 000000000000000000000000000212;
    const String videoIdthree = 'https://youtu.be/4XAzYP7Lsyo?t=';
    const double startSecondsthree = 0000000000000000000000000007040;
    const String videoIdfour = 'https://youtu.be/auH6Tz2aNF0?t=';
    const double startSecondsfour = 000000000000000000000000000195;
    const String videoIdfive = 'https://youtu.be/Ulgz-ZvY1aU';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """illuminating""",
                      // alsoEnglishWord: "also: illuminating",
                      britshText: """IpaUK: /ɪˈluːmɪneɪtɪŋ/""",
                      americanText: """IpaUS: /ɪˈluːmɪneɪtɪŋ/""",
...
// کوردی: ڕۆشن‌کەرەوە، ڕۆشنگەر، ڕوون‌کەرەوە
// """),
// With short examples define "illuminating", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە وا دەکات شتێک ڕوونتر بێت یان ئاسانتر بێت بۆ تێگەشتن """),
                    SentencesRow(
                      englishText:
                          """We didn't find the examples he used particularly illuminating.""",
                      kurdishText:
                          """ئەو نموونانەمان بە ڕوونکەرەوە نەبینی کە بەکاری هێنان.""",
