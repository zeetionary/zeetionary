...
class EnglishEntryhovercraft extends StatefulWidget {
  const EnglishEntryhovercraft({super.key});

  @override
  State<EnglishEntryhovercraft> createState() => _EnglishEntryhovercraftState();
}

class _EnglishEntryhovercraftState extends State<EnglishEntryhovercraft> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hovercraft (Derived forms: hovercrafts)
1. A craft capable of moving over water or land on a cushion of air created by jet engines (- ground-effect machine)
""",
  );

  final String keyword = "hovercraft";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hovercraft""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""A hovercraft travels on a cushion of air.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/pvJqvA0QU1g?t=';
    const double startSecondsone = 000000000000000000000000000154;
    const String videoIdtwo = 'https://youtu.be/oBoCEINoHtc?t=';
    const double startSecondstwo = 000000000000000000000000000153;
    const String videoIdthree = 'https://youtu.be/Ypduew1MTRk?t=';
    const double startSecondsthree = 0000000000000000000000000001262;
    const String videoIdfour = 'https://youtu.be/prE67lUm8nE?t=';
    const double startSecondsfour = 000000000000000000000000000462;
    const String videoIdfive = 'https://youtu.be/4URdXTPAgRE?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hovercraft""",
                      // alsoEnglishWord: "also: hovercraft",
                      britshText: """IpaUK: /ˈhɒvəkrɑːft/""",
                      americanText: """IpaUS: /ˈhʌvərkræft/""",
