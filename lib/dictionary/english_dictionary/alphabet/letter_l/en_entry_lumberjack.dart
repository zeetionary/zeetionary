...
class EnglishEntrylumberjack extends StatefulWidget {
  const EnglishEntrylumberjack({super.key});

  @override
  State<EnglishEntrylumberjack> createState() => _EnglishEntrylumberjackState();
}

class _EnglishEntrylumberjackState extends State<EnglishEntrylumberjack> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylumberjack lumberjack
WORD_WEB lumberjack lumberjack lumberjack
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "lumberjack";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lumberjack""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """lumberjack""",
                      // alsoEnglishWord: "also: lumberjack",
...
کوردی: 
"""),
// With short examples define "lumberjack", please follow LX instructions
