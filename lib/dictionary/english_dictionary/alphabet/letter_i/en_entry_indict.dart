...
class EnglishEntryindict extends StatefulWidget {
  const EnglishEntryindict({super.key});

  @override
  State<EnglishEntryindict> createState() => _EnglishEntryindictState();
}

class _EnglishEntryindictState extends State<EnglishEntryindict> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: indict (Derived forms: indicted, indicting, indicts)
1. Accuse formally of a crime
"When they find a sufficient ground to indict, the case is transferred to the court"

""",
  );

  final String keyword = "indict";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The senator was indicted for murder.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She was indicted on charges of corruption.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/oHSehKtDyoI?t=';
    const double startSecondsend = 000000000000000000000000000424;
    ...
    const String videoIdthree = 'https://youtu.be/USL6P8haroY?t=';
    const double startSecondsthree = 000000000000000000000000000799;
    const String videoIdfour = 'https://youtu.be/4l8M3dQlUwg?t=';
    const double startSecondsfour = 0000000000000000000000000002076;
    const String videoIdfive = 'https://youtu.be/ycFziHLcxdY?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indict""",
                      // alsoEnglishWord: "also: indict",
                      britshText: """IpaUK: /ɪnˈdaɪt/""",
                      americanText: """IpaUS: /ɪnˈdaɪt/""",
...
کوردی: 
"""),
// With short examples define "indict", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) بە فەرمی تاوانبارکردنی کەسێک بۆ تاوانێک"""),
                    SentencesRow(
                      englishText: """The senator was indicted for murder.""",
                      kurdishText: """سیناتۆرەکە تاوانبارکرا بە کوشتن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بە تاوانی گەندەڵی تاوانبار کرا.""",
