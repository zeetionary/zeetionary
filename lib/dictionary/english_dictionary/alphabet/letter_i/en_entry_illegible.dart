...
class EnglishEntryillegible extends StatefulWidget {
  const EnglishEntryillegible({super.key});

  @override
  State<EnglishEntryillegible> createState() => _EnglishEntryillegibleState();
}

class _EnglishEntryillegibleState extends State<EnglishEntryillegible> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "illegible";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""illegible""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000783;
    const String videoIdone = 'https://youtu.be/9vuqI2v2IRs?t=';
    const double startSecondsone = 000000000000000000000000000260;
    const String videoIdtwo = 'https://youtu.be/ArcI4A5nvBo?t=';
    const double startSecondstwo = 000000000000000000000000000438;
    const String videoIdthree = 'https://youtu.be/afTv-DVZBTo?t=';
    const double startSecondsthree = 000000000000000000000000000588;
    const String videoIdfour = 'https://youtu.be/WIT5_SMIaHE?t=';
    const double startSecondsfour = 000000000000000000000000000614;
    const String videoIdfive = 'https://youtu.be/EAAbIA5gPh0?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """illegible""",
                      // alsoEnglishWord: "also: illegible",
                      britshText: """IpaUK: /ɪˈledʒəbl/""",
                      americanText: """IpaUS: /ɪˈledʒəbl/""",
...
کوردی: ناخوانا، ناوانا، نەخوێندراوە، سەخت بۆ خوێندنەوە، شپرزە
"""),
// With short examples define "illegible", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) کە سەختە یان ئەستەمە بخوێندرێتەوە"""),
                    SentencesRow(
