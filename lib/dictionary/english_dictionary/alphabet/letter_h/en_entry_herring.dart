...
class EnglishEntryherring extends StatefulWidget {
  const EnglishEntryherring({super.key});

  @override
  State<EnglishEntryherring> createState() => _EnglishEntryherringState();
}

class _EnglishEntryherringState extends State<EnglishEntryherring> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: herring (Derived forms: herring, herrings)
1. Valuable flesh of fatty fish from shallow waters of northern Atlantic or Pacific; usually salted or pickled
 
2. Commercially important food fish of northern waters of both Atlantic and Pacific (- Clupea harangus)
""",
  );

  final String keyword = "herring";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""herring""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The chef prepared a dish with fresh herring.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """herring""",
                      // alsoEnglishWord: "also: herring",
                      britshText: """IpaUK: /ˈherɪŋ/""",
                      americanText: """IpaUS: /ˈherɪŋ/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) جۆرە ماسییەکی باکووری زەریای ئەتڵەسی کە بە گرووپی گەورە مەلە دەکەن و بۆ خواردن بەکاردێن"""),
                    SentencesRow(
                      englishText:
                          """The chef prepared a dish with fresh herring.""",
                      kurdishText:
                          """چێشتلێنەرەکە ژەمە خواردنێکی بە ماسی یازەی هێرینگ ئامادە کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/eGfU7DaAwpc?t=';
const double _startSecondsend = 00000000000000000000000000036;
const String _videoIdone = 'https://youtu.be/lNlKKB_p-4s?t=';
const double _startSecondsone = 0000000000000000000000000001129;
const String _videoIdtwo = 'https://youtu.be/R319_g4KAJ8?t=';
const double _startSecondstwo = 000000000000000000000000000293;
const String _videoIdthree = 'https://youtu.be/Jw_ysaoVlt4?t=';
const double _startSecondsthree = 000000000000000000000000000743;
const String _videoIdfour = 'https://youtu.be/6gr_gMSF0c0?t=';
const double _startSecondsfour = 000000000000000000000000000368;
const String _videoIdfive = 'https://youtu.be/eZN2q4NMCm4?t=';
const double _startSecondsfive = 000000000000000000000000000251;
