...
class EnglishEntrygullible extends StatefulWidget {
  const EnglishEntrygullible({super.key});

  @override
  State<EnglishEntrygullible> createState() => _EnglishEntrygullibleState();
}

class _EnglishEntrygullibleState extends State<EnglishEntrygullible> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: gullible
1. Naive and easily deceived or tricked (- fleeceable, green)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""gullible""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gullible""",
                      // alsoEnglishWord: "also: gullible",
                      britshText: """IpaUK: /ˈɡʌləbl/""",
                      americanText: """IpaUS: /ˈɡʌləbl/""",
...
کوردی: ساویلکە، خۆش‌باوەڕ، زوولەخشتەچوو، زووباوەڕ، فەقیر، گوێ‌لەمست، سادە
"""),
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە بە ئاسانی دەخەڵێیت"""),
                    const AlsoEnglishckb(word: "ھەروەھا: naive"),
                    SentencesRow(
                      englishText:
                          """The advertisement is aimed at gullible young women worried about their weight.""",
                      kurdishText:
                          """ڕیکلامەکە بۆ ئەو ژنە ساویلکە گەنجانەیە کە زۆر نیگەرانن سەبارەت بە کێشیان.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/JE6nrwxvcEM?t=';
const double _startSecondsend = 000000000000000000000000000200;
const String _videoIdone = 'https://youtu.be/MLd4K5hKosw?t=';
const double _startSecondsone = 000000000000000000000000000203;
const String _videoIdtwo = 'https://youtu.be/B7gKA1o31rM?t=';
const double _startSecondstwo = 0000000000000000000000000002237;
const String _videoIdthree = 'https://youtu.be/3PX2d3Zwutg?t=';
const double _startSecondsthree = 000000000000000000000000000883;
const String _videoIdfour = 'https://youtu.be/BvHCpWixZRA?t=';
const double _startSecondsfour = 000000000000000000000000000237;
const String _videoIdfive = 'https://youtu.be/05cLDzx64nQ?t=';
