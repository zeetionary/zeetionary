...
class EnglishEntryinky extends StatefulWidget {
  const EnglishEntryinky({super.key});

  @override
  State<EnglishEntryinky> createState() => _EnglishEntryinkyState();
}

class _EnglishEntryinkyState extends State<EnglishEntryinky> {
  @override
  void initState() {
    super.initState();
