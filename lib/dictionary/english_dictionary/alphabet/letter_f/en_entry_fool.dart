...
// With short examples define "fool", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """هەستم بە گەمژەیی کرد کە بە هەڵەکەمم زانی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """وەک گەمژەیەک، هەموو شتێکم پێ گوت.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (ناو) کەسێک کە جاران لە لایەن پاشا یان شاژنەوە بە کرێ دەگیرا بۆ خۆشبەختکردنی بە گوتنی نوکتە، گۆرانی، هتد"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Fools used to provide entertainment in the royal court.""",
                      kurdishText:
                          """لۆتییەکان جاران چێژیان دەبەخشی لە دەرباری شاهانە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Don't be fooled into thinking they're going to change anything.""",
                      kurdishText:
                          """مەگەوجێ بەوەی بیربکەیتەوە کە هیچ دەگۆڕن.""",
...
const double _startSecondsend = 0000000000000000000000000001167;
const String _videoIdone = 'https://youtu.be/qWAagS_MANg?t=';
const double _startSecondsone = 0000000000000000000000000001605;
const String _videoIdtwo = 'https://youtu.be/UuGpm01SPcA?t=';
const double _startSecondstwo = 000000000000000000000000000410;
const String _videoIdthree = 'https://youtu.be/9wY7u3bVnDs?t=';
const double _startSecondsthree = 000000000000000000000000000480;
const String _videoIdfour = 'https://youtu.be/r--i0PjLHtM?t=';
const double _startSecondsfour = 00000000000000000000000000070;
const String _videoIdfive = 'https://youtu.be/02l6OL0Op9I?t=';
const double _startSecondsfive = 000000000000000000000000000105;
