...
class EnglishEntryfriendliness extends StatefulWidget {
  const EnglishEntryfriendliness({super.key});

  @override
  State<EnglishEntryfriendliness> createState() =>
      _EnglishEntryfriendlinessState();
}

class _EnglishEntryfriendlinessState extends State<EnglishEntryfriendliness> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "friendliness";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""friendliness""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""We were greeted with warmth and friendliness.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Her sudden friendliness towards him was unsettling.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I was impressed by the friendliness of the website.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """friendliness""",
                      // alsoEnglishWord: "also: friendliness",
                      britshText: """IpaUK: /ˈfrendlinəs/""",
                      americanText: """IpaUS: /ˈfrendlinəs/""",
...
کوردی: خۆشەویستی، دۆستایەتی، هەڤاڵەتی، برایەتی، دڵسۆزی
"""),
// With short examples define "friendliness", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە گەرمی و دۆستایەتییەوە پێشوازیمان لێکرا.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Her sudden friendliness towards him was unsettling.""",
                      kurdishText:
                          """دۆستایەتی کردنی لەناکاوی لەگەڵی شڵەژێنەر بوو.""",
                    ...
                    SentencesRow(
                      englishText:
                          """They valued the friendliness of their neighboring villages.""",
                      kurdishText:
                          """بەهای دۆستایەتی گوندەکانی دەورووبەریانیان دەزانی.""",
                      onPressedBritish: () => speaksentence3("en-GB"),
                      onPressedAmerican: () => speaksentence3("en-US"),
                    ),
                    // skipped_meaning
                    // const DividerDefinition(),
                    // const DefinitionKurdish(text: """٣. (ھاوەڵناو) ئەوەی کە ئاسان بێت بۆ بەکارهێنان و یارمەتی کەسێک بدات نەک زیانی هەبێت"""),
                    // const DividerSentences(),
                    // SentencesRow(
                    //   englishText: """I was impressed by the friendliness of the website.""",
                    //   kurdishText: """سەرسام بووم بە .""",
...
const double _startSecondsend = 0000000000000000000000000001160;
const String _videoIdone = 'https://youtu.be/KhBxCx11eck?t=';
const double _startSecondsone = 000000000000000000000000000405;
const String _videoIdtwo = 'https://youtu.be/6Pm0Mn0-jYU?t=';
const double _startSecondstwo = 000000000000000000000000000889;
const String _videoIdthree = 'https://youtu.be/WVzvTLSK5dY?t=';
const double _startSecondsthree = 00000000000000000000000000034;
const String _videoIdfour = 'https://youtu.be/U2_kXUJ4HBs?t=';
const double _startSecondsfour = 000000000000000000000000000722;
const String _videoIdfive = 'https://youtu.be/l4bAoNAx2uo?t=';
