...
class EnglishEntryfell extends StatefulWidget {
  const EnglishEntryfell({super.key});

  @override
  State<EnglishEntryfell> createState() => _EnglishEntryfellState();
}

class _EnglishEntryfellState extends State<EnglishEntryfell> {
  @override
  void initState() {
    super.initState();
...
2. Pass away rapidly (= fly, vanish)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""I love being up on the fells.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He felled his opponent with a single blow.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""The knight faced a fell enemy.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fell""",
                      // alsoEnglishWord: "also: fell",
                      britshText: """IpaUK: /fel/""",
                      americanText: """IpaUS: /fel/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) گرد یان ناوچەیەکی گردی لە باکووری ئینگلتەرە"""),
                    SentencesRow(
                      englishText: """I love being up on the fells.""",
                      kurdishText: """حەز دەکەم لەسەر گردەکان بم.""",
                    ...
                    SentencesRow(
                      englishText:
                          """A great number of trees were felled to provide space for grazing.""",
                      kurdishText:
                          """ژمارەیەکی زۆر درەخت بڕدرانەوە بۆ درووستکردنی شوێن بۆ لەوەڕان.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """بە یەک لێدان ڕکابەرەکەی خست.""",
...
const String _videoIdend = 'https://youtu.be/6781XugwQrA?t=';
const double _startSecondsend = 000000000000000000000000000588;
const String _videoIdone = 'https://youtu.be/3ZRVpYPFOl0?t=';
const double _startSecondsone = 000000000000000000000000000109;
const String _videoIdtwo = 'https://youtu.be/Gc-B-a5FrvU?t=';
const double _startSecondstwo = 000000000000000000000000000130;
const String _videoIdthree = 'https://youtu.be/MuDYgss7lZE?t=';
const double _startSecondsthree = 000000000000000000000000000877;
const String _videoIdfour = 'https://youtu.be/agnuTbXuXu0?t=';
const double _startSecondsfour = 0000000000000000000000000001286;
const String _videoIdfive = 'https://youtu.be/AABzM6UmIN4?t=';
