...
class EnglishEntryincidentally extends StatefulWidget {
  const EnglishEntryincidentally({super.key});

  @override
  State<EnglishEntryincidentally> createState() =>
      _EnglishEntryincidentallyState();
}

class _EnglishEntryincidentallyState extends State<EnglishEntryincidentally> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""incidentally""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'kPqY_09Eouk';
    const double startSecondsone = 287;
    const String videoIdtwo = 'wh4aWZRtTwU';
    const double startSecondstwo = 1079;
    const String videoIdthree = 'h31p4OLbqSc';
    const double startSecondsthree = 1070;
    const String videoIdfour = 'P6bVl47kdNk';
    const double startSecondsfour = 1314;
    const String videoIdfive = 'BPGgyputhpA';
