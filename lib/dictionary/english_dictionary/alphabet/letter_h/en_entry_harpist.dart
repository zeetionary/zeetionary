...
class EnglishEntryharpist extends StatefulWidget {
  const EnglishEntryharpist({super.key});

  @override
  State<EnglishEntryharpist> createState() => _EnglishEntryharpistState();
}

class _EnglishEntryharpistState extends State<EnglishEntryharpist> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: harpist (Derived forms: harpists)
1. Someone who plays the harp (- harper)
""",
  );

  final String keyword = "harpist";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""harpist""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""At just 13, she was the harpist in a popular band.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """harpist""",
                      alsoEnglishWord: "also US: harper",
                      britshText: """IpaUK: /ˈhɑːpɪst/""",
                      americanText: """IpaUS: /ˈhɑːrpɪst/""",
...
کوردی: 
"""),
// With short examples define "harpist", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە ئامێری میوزیکی هارپ دەژەنێت"""),
                    SentencesRow(
                      englishText:
                          """At just 13, she was the harpist in a popular band.""",
                      kurdishText:
                          """لە تەمەنی تەنها ١٣ ساڵیدا هارپژەن بوو لە باندێکی بەناوبانگدا.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/MykMQfmLIro?t=';
const double _startSecondsend = 000000000000000000000000000119;
const String _videoIdone = 'https://youtu.be/n5aZobr3CAc?t=';
const double _startSecondsone = 000000000000000000000000000720;
const String _videoIdtwo = 'https://youtu.be/i-MecHFGa-4?t=';
const double _startSecondstwo = 00000000000000000000000000027480;
const String _videoIdthree = 'https://youtu.be/r3xzJbXy1eU?t=';
const double _startSecondsthree = 00000000000000000000000000069;
const String _videoIdfour = 'https://youtu.be/C9T9m5N3Hvw?t=';
const double _startSecondsfour = 000000000000000000000000000166;
const String _videoIdfive = 'https://youtu.be/r3xzJbXy1eU?t=';
