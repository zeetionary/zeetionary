...
class EnglishEntrycontralto extends StatelessWidget {
  ...
  Future<void> speakContralto(String languageCode) async {
    ...
    await flutterTts.speak("contralto");
  }
  ...
  Future<void> speakContralto6955(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("She began by singing soprano, then changed to contralto.");
  }
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'tC5PRRGB1dc';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'VrXrd-dtFjE';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'yTLXKCb2Ywk';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'tMy4ShVmYus';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'PyHeu-65RXs';
...
class YoutubeEmbeddedseven extends StatelessWidget {
  ...
  final String _videoId = 'YskDcHgXWSo';
...
class YoutubeEmbeddedeight extends StatelessWidget {
  ...
  final String _videoId = 'd8nEa48_bIE';
...
class YoutubeEmbeddednine extends StatelessWidget {
  ...
  final String _videoId = 'BaorodmHZnM';
