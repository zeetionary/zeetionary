...
class EnglishEntryheckler extends StatefulWidget {
  const EnglishEntryheckler({super.key});

  @override
  State<EnglishEntryheckler> createState() => _EnglishEntryhecklerState();
}

class _EnglishEntryhecklerState extends State<EnglishEntryheckler> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: heckler (Derived forms: hecklers)
1. Someone who tries to embarrass you with gibes and questions and objections (- badgerer)
""",
  );

  final String keyword = "heckler";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""heckler""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""His speech was interrupted by hecklers.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """heckler""",
                      // alsoEnglishWord: "also: heckler",
                      britshText: """IpaUK: /ˈheklə(r)/""",
                      americanText: """IpaUS: /ˈheklər/""",
...
کوردی: 
"""),
// With short examples define "heckler", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە وتاربێژێک دەوەستێنێت بەوەی پرسیار یان قسەی توند دەکات"""),
                    SentencesRow(
                      englishText:
                          """His speech was interrupted by hecklers.""",
                      kurdishText:
                          """وتارەکەی ناوبڕی تێخرا لەلایەن گێرەشێوێنەرانەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/c2gw-asbBIM?t=';
const double _startSecondsend = 000000000000000000000000000247;
const String _videoIdone = 'https://youtu.be/THIGSnMP3io?t=';
const double _startSecondsone = 000000000000000000000000000420;
const String _videoIdtwo = 'https://youtu.be/wK-XjdN1IKs?t=';
const double _startSecondstwo = 000000000000000000000000000104;
const String _videoIdthree = 'https://youtu.be/feHnfZ7Tsyc?t=';
const double _startSecondsthree = 0000000000000000000000000002370;
const String _videoIdfour = 'https://youtu.be/XwqAInN9HWI?t=';
const double _startSecondsfour = 000000000000000000000000000391;
const String _videoIdfive = 'https://youtu.be/-6EKrSZ6nu0?t=';
