                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "appeasement"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈpiːzmənt/"),
                        ...
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈpiːzmənt/"),
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakappeasement("en-US"),
                          ),
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = '_yEpBKpK2Yw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final double _startSeconds = 12072;
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'eL9RB_jG6SY';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final double _startSeconds = 20194;
