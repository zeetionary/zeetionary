...
class EnglishEntryindirectspeech extends StatefulWidget {
  ...
  @override
  State<EnglishEntryindirectspeech> createState() => _EnglishEntryindirectspeechState();
}

class _EnglishEntryindirectspeechState extends State<EnglishEntryindirectspeech> {
  @override
  void initState() {
    super.initState();
...
EnglishEntryindirectspeech indirect speech
WORD_WEB indirect speech indirect speech indirect speech
haʊʊʊʊʊʊʊ4
""",
  );
...
کوردی: 
"""),
// With short examples define "indirect speech", please follow LX instructions
