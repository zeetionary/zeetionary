...
class TTSUK extends StatelessWidget {
  ...
  Future<void> speakdisparaging(String languageCode) async {
    ...
    await flutterTts.speak("disparaging");
  }
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speakdisparagings1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("She was rather disparaging about her boss.");
  }
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'npJXqRifMLw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'm_Z1B7cHOgE';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'ASwBItUKzWo';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final double _startSeconds = 8027;
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'l9u-bHLsW0M';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '1nFNadfw028';
