...
""",
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'EyA2podwo6Y';
    const double startSecondsend = 211;
    const String videoIdone = 'bLpYSGe4cAw';
    const double startSecondsone = 1425;
    const String videoIdtwo = 'st6fJtdey24';
    const double startSecondstwo = 689;
    const String videoIdthree = 'Co4cjpXXKaA';
    const double startSecondsthree = 441;
    const String videoIdfour = 'PL2ZlxrE3uo';
    const double startSecondsfour = 420;
    const String videoIdfive = 'pWs0TnwIH7Q';
    const double startSecondsfive = 621;
