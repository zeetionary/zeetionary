...
class EnglishEntryestateagent extends StatefulWidget {
  const EnglishEntryestateagent({super.key});

  @override
  State<EnglishEntryestateagent> createState() =>
      _EnglishEntryestateagentState();
}

class _EnglishEntryestateagentState extends State<EnglishEntryestateagent> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""estate agent""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """estate agent""",
                      // alsoEnglishWord: "also: estate agent",
                      britshText: """IpaUK: /ɪˈsteɪt eɪdʒənt/""",
                      americanText: """IpaUS: /ɪˈsteɪt eɪdʒənt/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "estate agent";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He works as an estate agent in the city.""");
  }
...
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) دەڵاڵی خانووبەرەو زەوی؛ کەسێک کە کاری فرۆشتنی زەوی‌وزارە بۆ خەڵکی"""),
          SentencesRow(
            englishText: """He works as an estate agent in the city.""",
            kurdishText: """وەک دەڵاڵی خانوو و زەوی کار دەکات لە شارەکە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: estate agent (Derived forms: estate agents)
Usage: Brit, Cdn (US: realtor)
1. A person who is authorized to act as an agent for the sale of land (= real estate broker [N. Amer], real estate agent [N. Amer], land agent, house agent, realtor [N. Amer])
"the estate agent took her on a walk-through of the apartment"; "the real estate agent took her on a walk-through of the apartment"; "the estate agent took her on a walk-through of the apartment";
""",
  );
