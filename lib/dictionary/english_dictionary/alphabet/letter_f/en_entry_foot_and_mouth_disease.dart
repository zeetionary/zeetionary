...
class EnglishEntryfootandmouthdisease extends StatefulWidget {
  const EnglishEntryfootandmouthdisease({super.key});

  @override
  State<EnglishEntryfootandmouthdisease> createState() =>
      _EnglishEntryfootandmouthdiseaseState();
}

class _EnglishEntryfootandmouthdiseaseState
    extends State<EnglishEntryfootandmouthdisease> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foot-and-mouth disease (Derived forms: foot-and-mouth diseases)
1. Acute contagious disease of cloven-footed animals marked by ulcers in the mouth and around the hoofs (= hoof-and-mouth disease)
""",
  );

  final String keyword = "foot-and-mouth disease";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foot-and-mouth disease""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """Farmers vaccinated their livestock against foot-and-mouth disease.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: foot-and-mouth disease",
                      britshText: """IpaUK: /ˌfʊt ən ˈmaʊθ dɪziːz/""",
                      americanText: """IpaUS: /ˌfʊt ən ˈmaʊθ dɪziːz/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) نەخۆشییەکی مانگا، مەڕ، هتد کە دەبێتە هۆکاری هەبوونی شوێنی بەئازار لە دەم و پێدا"""),
                    SentencesRow(
                      englishText:
                          """Farmers vaccinated their livestock against foot-and-mouth disease.""",
                      kurdishText:
                          """ئاژەڵداران مەڕوماڵاتیان دژ بە نەخۆشی دەم و پێ ڤاکسین کرد.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/4Mr3WL9zD_o?t=';
const double _startSecondsend = 00000000000000000000000000025;
const String _videoIdone = 'https://youtu.be/cpgrZr38I_8?t=';
const double _startSecondsone = 000000000000000000000000000164;
const String _videoIdtwo = 'https://youtu.be/IUwqf08-FKU?t=';
const double _startSecondstwo = 000000000000000000000000000200;
const String _videoIdthree = 'https://youtu.be/hKyArsq6NJ8?t=';
const double _startSecondsthree = 0000000000000000000000000001470;
const String _videoIdfour = 'https://youtu.be/wkFKf-YnzvY?t=';
const double _startSecondsfour = 000000000000000000000000000960;
const String _videoIdfive = 'https://youtu.be/giqj6RymWV0?t=';
const double _startSecondsfive = 000000000000000000000000000246;
