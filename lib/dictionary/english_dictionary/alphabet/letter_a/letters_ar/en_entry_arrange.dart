...
// replace EnglishEntryarrange - replace speakArrange

// replace arrange - /əˈreɪndʒ/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryarrange extends StatelessWidget {
  // blank divider
  EnglishEntryarrange({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakarrange(String languageCode) async {
    // DOPSUM: CHANGE speakArrange
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "arrange"), // Find /əˈreɪndʒ/
                            // divvviiider
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUK: /əˈreɪndʒ/"), // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                            CustomIconButtonBritish(
                              onPressed: () => speakarrange("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(
                                text:
                                    "IpaUS: /əˈreɪndʒ/"), // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find WORD_WEB
                            CustomIconButtonAmerican(
                              onPressed: () => speakarrange("en-US"),
                            ),
                          ],
                        ),
                      ],
...
2. Make arrangements for (= fix up)
"Can you arrange a meeting with the President?";
 
3. Plan, organize, and carry out (an event) (= stage)
"the neighbouring tribe arranged an invasion";
 
4. Put or arrange a document into a specific format (= format)
"arrange this letter so it can be printed out";
 
5. Style or arrange hair attractively (= dress, set, do, coif, coiffe, coiffure)
"arrange my hair for the wedding";
 
6. (music) adapt for performance in a different way (= set)
"arrange this poem to music";
 
7. Organize thoughts, ideas, or temporal events (= set up, put, order)
"arrange my schedule";
""",
  );
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'DER7bCtHLLM';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'ki4Fbctwnjs';
...
class _YoutubeEmbeddedeightState extends State<YoutubeEmbeddedeight> {
  late YoutubePlayerController _controller;
  final String _videoId = 'Lk9ZihSgjdo';
...
class _YoutubeEmbeddednineState extends State<YoutubeEmbeddednine> {
  late YoutubePlayerController _controller;
  final String _videoId = 'J2eU4Ol3IDU';
...
class _YoutubeEmbeddedtenState extends State<YoutubeEmbeddedten> {
  late YoutubePlayerController _controller;
  final String _videoId = '8bQf9URnIAY';
...
class _YoutubeEmbeddedelevenState extends State<YoutubeEmbeddedeleven> {
  ...
  final double _startSeconds = 16054;
...
class _YoutubeEmbeddedtwelveState extends State<YoutubeEmbeddedtwelve> {
  late YoutubePlayerController _controller;
  final String _videoId = 'HzUIUTatyZI';
  final double _startSeconds = 2232;
