...
class EnglishEntryendlessly extends StatefulWidget {
  const EnglishEntryendlessly({super.key});

  @override
  State<EnglishEntryendlessly> createState() => _EnglishEntryendlesslyState();
}

class _EnglishEntryendlesslyState extends State<EnglishEntryendlessly> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""endlessly""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """endlessly""",
                      // alsoEnglishWord: "also: endlessly",
                      britshText: """IpaUK: /ˈendləsli/""",
                      americanText: """IpaUS: /ˈendləsli/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "endlessly";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She talks endlessly about her problems.""");
  }
...
کوردی: یەکبینە، لەسەریەک، یەک‌ڕێز، بە بەردەوامی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ھاوەڵکار) بەشێوەیەک کە بۆ ماوەیەکی درێژ بەردەوامە وەها دەردەکەوێت کە کۆتایی نەبێت"""),
          SentencesRow(
            englishText: """She talks endlessly about her problems.""",
            kurdishText: """بە نەبڕاوەیی قسەی کرد لەسەر کێشەکانی.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: endlessly
1. Continuing forever without end (= infinitely)
"there are endlessly many possibilities";
 
2. With unflagging resolve (= ceaselessly, incessantly, unceasingly, unendingly, continuously, unremittingly)
 
3. (spatial sense) seeming to have no bounds
"the Nubian desert stretched out before them endlessly"
 
4. All the time; seemingly without stopping (= interminably)
...
const String _videoIdone = 'https://youtu.be/WfVF-Ec4naQ?t=';
const double _startSecondsone = 450;
...
const double _startSecondsthree = 6620;
const String _videoIdfour = 'https://youtu.be/vUbIA9zjTSs?t=';
const double _startSecondsfour = 543;
const String _videoIdfive = 'https://youtu.be/rdt5-S5ZaYo?t=';
const double _startSecondsfive = 135;
const String _videoIdsix = 'https://youtu.be/KJU6ZK4EWVw?t=';
const double _startSecondssix = 217;
