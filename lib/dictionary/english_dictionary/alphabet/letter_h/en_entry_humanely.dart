...
class EnglishEntryhumanely extends StatefulWidget {
  const EnglishEntryhumanely({super.key});

  @override
  State<EnglishEntryhumanely> createState() => _EnglishEntryhumanelyState();
}

class _EnglishEntryhumanelyState extends State<EnglishEntryhumanely> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: humanely
1. In a humane manner
"let's treat the prisoners of war humanely"
""",
  );

  final String keyword = "humanely";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""humanely""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The dog was humanely destroyed.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'https://youtu.be/vS7hMricwm0?t=';
    const double startSecondsone = 000000000000000000000000000153;
    const String videoIdtwo = 'https://youtu.be/hFL6qRIJZ_Y?t=';
    const double startSecondstwo = 000000000000000000000000000346;
    const String videoIdthree = 'https://youtu.be/3-zXS_1B5oo?t=';
    const double startSecondsthree = 00000000000000000000000000098;
    const String videoIdfour = 'https://youtu.be/3a9MmVMyoTo?t=';
    const double startSecondsfour = 000000000000000000000000000887;
    const String videoIdfive = 'https://youtu.be/xl_H9zvMsOk?t=';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """humanely""",
                      // alsoEnglishWord: "also: humanely",
                      britshText: """IpaUK: /hjuːˈmeɪnli/""",
                      americanText: """IpaUS: /hjuːˈmeɪnli/""",
