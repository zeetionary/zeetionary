...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 878;
    const String videoIdone = 'ZUoOrL0G4pA';
    const double startSecondsone = 494;
    const String videoIdtwo = 'wKKM0MTlv9U';
    const double startSecondstwo = 212;
    const String videoIdthree = 'peg3vTiWAj8';
    const double startSecondsthree = 1287;
    const String videoIdfour = 'HPtcDrbUa1A';
    const double startSecondsfour = 428;
    const String videoIdfive = 'KIGmsxBMnjA';
    const double startSecondsfive = 706;
