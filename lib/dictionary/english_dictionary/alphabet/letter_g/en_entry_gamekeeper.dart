...
class EnglishEntrygamekeeper extends StatefulWidget {
  const EnglishEntrygamekeeper({super.key});

  @override
  State<EnglishEntrygamekeeper> createState() => _EnglishEntrygamekeeperState();
}

class _EnglishEntrygamekeeperState extends State<EnglishEntrygamekeeper> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "gamekeeper";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gamekeeper""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She spoke to the gamekeeper about the deer population.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gamekeeper""",
                      // alsoEnglishWord: "also: gamekeeper",
                      britshText: """IpaUK: /ˈɡeɪmkiːpə(r)/""",
                      americanText: """IpaUS: /ˈɡeɪmkiːpər/""",
...
کوردی: نێچیروان، ڕاوپرس، نێچیرپارێز، ڕاوەپارێز، قۆرخ‌چی
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کەسێک کە کاری چاودێری ئەو ئاژەڵ و باڵندانەیە کە لەسەر زەویی تایبەت ڕادەگیردرێن بۆ ئەوەی ڕاو بکرێن"""),
                    SentencesRow(
                      englishText:
                          """She spoke to the gamekeeper about the deer population.""",
                      kurdishText:
                          """قسەی لەگەڵ ڕاوەپارێزەکە کرد سەبارەت بە ژمارەی ئاسکەکان.""",
...
const String _videoIdend = 'https://youtu.be/PoNCG3PZKII?t=';
const double _startSecondsend = 000000000000000000000000000814;
const String _videoIdone = 'https://youtu.be/w4HmK4JCN2U?t=';
const double _startSecondsone = 000000000000000000000000000705;
const String _videoIdtwo = 'https://youtu.be/BpwDSPh-qbk?t=';
const double _startSecondstwo = 000000000000000000000000000109;
const String _videoIdthree = 'https://youtu.be/CQ-c1wVwk60?t=';
const double _startSecondsthree = 0000000000000000000000000002034;
const String _videoIdfour = 'https://youtu.be/sH3Y_-Hxh_Q?t=';
const double _startSecondsfour = 000000000000000000000000000564;
const String _videoIdfive = 'https://youtu.be/MzZgFtHikO8?t=';
