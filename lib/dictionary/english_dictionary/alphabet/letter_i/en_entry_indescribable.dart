...
class EnglishEntryindescribable extends StatefulWidget {
  const EnglishEntryindescribable({super.key});

  @override
  State<EnglishEntryindescribable> createState() =>
      _EnglishEntryindescribableState();
}

class _EnglishEntryindescribableState extends State<EnglishEntryindescribable> {
  @override
  void initState() {
    super.initState();
...
1. Defying expression or description (- indefinable, ineffable, unspeakable, untellable, unutterable, undescribable)
"indescribable beauty";
""",
  );

  final String keyword = "indescribable";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indescribable""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The pain was indescribable.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""I felt a sense of indescribable relief.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/uxJs7N51BmQ?t=';
    const double startSecondsend = 000000000000000000000000000332;
    const String videoIdone = 'https://youtu.be/JYZdZcqebaE?t=';
    const double startSecondsone = 000000000000000000000000000820;
    const String videoIdtwo = 'https://youtu.be/eQNxklMsZxc?t=';
    const double startSecondstwo = 000000000000000000000000000868;
    const String videoIdthree = 'https://youtu.be/26VzqQd-bZg?t=';
    const double startSecondsthree = 0000000000000000000000000001511;
    const String videoIdfour = 'https://youtu.be/dWJ_WwWSabw?t=';
    const double startSecondsfour = 00000000000000000000000000012270;
    const String videoIdfive = 'https://youtu.be/bK0NdaDOsG0';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """indescribable""",
                      // alsoEnglishWord: "also: indescribable",
                      britshText: """IpaUK: /ˌɪndɪˈskraɪbəbl/""",
                      americanText: """IpaUS: /ˌɪndɪˈskraɪbəbl/""",
...
کوردی: لەباس(کردن)نەهاتوو، باس‌نەکراو، باس ناکرێ
"""),
// With short examples define "indescribable", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) بە ئاستێکی هێندە زۆر کە ناتوانیت باسی بکەیت"""),
                    SentencesRow(
                      englishText: """The pain was indescribable.""",
                      kurdishText: """ئازارەکە لە باس‌نەهاتوو بوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """تووشی هەستێکی حەسانەوەی لە باس‌نەهاتوو بووم.""",
