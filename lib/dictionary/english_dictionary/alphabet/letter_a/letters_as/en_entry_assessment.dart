...
// Define the word "assessment" and provide three example sentences for each meaning. Use Merriam Webster style.

// replace EnglishEntryassessment - replace speakAssessment

// replace assessment - /əˈsesmənt/ - find WORD_WEB

enum TtsState { playing }

class EnglishEntryassessment extends StatelessWidget {
  // blank divider
  EnglishEntryassessment({super.key});
  // blank divider
  final FlutterTts flutterTts = FlutterTts();

  Future<void> speakAssessment(String languageCode) async {
    // DOPSUM: CHANGE speakAssessment
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("assessment"); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAssessment1125(String languageCode) async {
    // DOPSUM: CHANGE speakAssessment
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "We conducted the initial assessments defining the scope of work."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAssessment1128(String languageCode) async {
    // DOPSUM: CHANGE speakAssessment
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "Needs assessment is crucial if the hospital is to deliver effective healthcare."); // DOPSUM: CHANGE TEXT
  }

  Future<void> speakAssessment1131(String languageCode) async {
    // DOPSUM: CHANGE speakAssessment
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak(
        "The usual means of assessment for our taught courses is by written essay."); // DOPSUM: CHANGE TEXT
  }
                      ...
                      children: [
                        const Row(
                          children: [
                            Expanded(
                              child: Text(
                                "assessment", // DOPSUM: CHANGE WORD ENTRY - Find /əˈsesmənt/
                                style: TextStyle(
                        ...
                        Row(
                          children: [
                            Container(
                              ...
                              child: const Text(
                                "IpaUK: /əˈsesmənt/", // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
                        ...
                        Row(
                          children: [
                            Container(
                              constraints: const BoxConstraints(maxWidth: 300),
                              child: const Text(
                                "IpaUS: /əˈsesmənt/", // DOPSUM: WRITE IPA IN AMERICAN ENGLISH - find WORD_WEB
                                style: TextStyle(fontSize: 14),
                              ),
                            ),
                            IconButton(
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = "https://youtu.be/FCtQPoHzeU4?t=";
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = "https://youtu.be/KGigeZp2Pls?t=";
...
class YoutubeEmbeddedfive extends StatelessWidget {
  static String myVideoId = "https://youtu.be/RbIxYm3mKzI?t=";
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = "https://youtu.be/pbXObwWIbBU?t=";
...
class YoutubeEmbeddedten extends StatelessWidget {
  static String myVideoId = "https://youtu.be/-YR2TxHkb4c?t=";
...
class YoutubeEmbeddedeleven extends StatelessWidget {
  static String myVideoId = "https://youtu.be/c324y0OVqVI?t=";
