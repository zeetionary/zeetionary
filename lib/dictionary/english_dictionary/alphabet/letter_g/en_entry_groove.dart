...
class EnglishEntrygroove extends StatefulWidget {
  const EnglishEntrygroove({super.key});

  @override
  State<EnglishEntrygroove> createState() => _EnglishEntrygrooveState();
}

class _EnglishEntrygrooveState extends State<EnglishEntrygroove> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: groove (Derived forms: grooves)
1. A long narrow furrow cut either by a natural process (such as erosion) or by a tool (as e.g. a groove in a phonograph record) (- channel)
 
2. A settled and monotonous routine that is hard to escape (- rut)
"they fell into a conversational groove";
 
3. (anatomy) any furrow or channel on a bodily structure or part (- vallecula)
 
4. (baseball) the middle of the strike zone

- Verb: groove (Derived forms: grooving, grooves, grooved)
1. Make a groove in, or provide with a groove
"groove a vinyl record"
 
2. Hollow out in the form of a furrow or groove (- furrow, rut)
"groove soil";
 
3. [informal] Dance to rock or pop music (- boogie [informal])
""",
  );

  final String keyword = "groove";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""Cut a groove 3 cm from the top of the piece of wood.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """groove""",
                      // alsoEnglishWord: "also: groove",
                      britshText: """IpaUK: /ɡruːv/""",
                      americanText: """IpaUS: /ɡruːv/""",
...
// With short examples define "groove", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """کووزێکی ٣ سانتیمەتری لە سەرەوەی پارچە تەختەکە ببڕە.""",
...
const double _startSecondsend = 000000000000000000000000000400;
...
const double _startSecondstwo = 000000000000000000000000000922;
const String _videoIdthree = 'https://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondsthree = 0000000000000000000000000002768;
const String _videoIdfour = 'https://youtu.be/JX82wa5HkJg?t=';
const double _startSecondsfour = 000000000000000000000000000899;
