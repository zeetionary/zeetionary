...
class EnglishEntryherbal extends StatefulWidget {
  const EnglishEntryherbal({super.key});

  @override
  State<EnglishEntryherbal> createState() => _EnglishEntryherbalState();
}

class _EnglishEntryherbalState extends State<EnglishEntryherbal> {
  @override
  void initState() {
    super.initState();
...
- Noun: herbal (Derived forms: herbals)
1. Tea-like drink made of leaves of various herbs (- herb tea, herbal tea)
""",
  );

  final String keyword = "herbal";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""The herbal ointment helped soothe her skin irritation.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """herbal""",
                      // alsoEnglishWord: "also: herbal",
                      britshText: """IpaUK: /ˈhɜːbl/""",
                      americanText: """IpaUS: /ˈɜːrbl/, /ˈhɜːrbl/""",
...
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵناو) پەیوەندیدار بە ڕووەکێک کە گەڵاکانی، گوڵەکانی، یان تۆوەکانی بەکاردێت بۆ زیادکردنی تام بۆ خواردن، چارەسەری پزیشکی، یان بۆ بۆنەکەی"""),
                    SentencesRow(
                      englishText:
                          """The herbal ointment helped soothe her skin irritation.""",
                      kurdishText:
                          """مەرهەمە گیاییەکە یارمەتیدەر بوو لە کەمکردنی هەوکردنی پێستی.""",
...
const String _videoIdone = 'https://youtu.be/2tstiVq4hEg?t=';
const double _startSecondsone = 000000000000000000000000000153;
const String _videoIdtwo = 'https://youtu.be/SnuYD9_nrD4?t=';
const double _startSecondstwo = 0000000000000000000000000006;
const String _videoIdthree = 'https://youtu.be/If9ZJ8s87O4?t=';
const double _startSecondsthree = 00000000000000000000000000024;
const String _videoIdfour = 'https://youtu.be/3CO8FN_GtIg?t=';
const double _startSecondsfour = 000000000000000000000000000262;
const String _videoIdfive = 'https://youtu.be/_nxFjhcyTMQ?t=';
const double _startSecondsfive = 000000000000000000000000000153;
