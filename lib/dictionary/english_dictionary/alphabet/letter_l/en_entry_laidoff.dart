...
class EnglishEntrylaidoff extends StatefulWidget {
  const EnglishEntrylaidoff({super.key});

  @override
  State<EnglishEntrylaidoff> createState() => _EnglishEntrylaidoffState();
}

class _EnglishEntrylaidoffState extends State<EnglishEntrylaidoff> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylaidoff laid-off
WORD_WEB laid-off laid-off laid-off
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "laid-off";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""laid-off""");
  }
...
کوردی: 
"""),
// With short examples define "laid-off", please follow LX instructions
