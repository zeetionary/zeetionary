...
class EnglishEntrygreasy extends StatefulWidget {
  const EnglishEntrygreasy({super.key});

  @override
  State<EnglishEntrygreasy> createState() => _EnglishEntrygreasyState();
}

class _EnglishEntrygreasyState extends State<EnglishEntrygreasy> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: greasy (Derived forms: greasier, greasiest)
1. Containing an unusual amount of grease or oil (- oily, sebaceous, oleaginous)
"greasy hamburgers";
 
2. Smeared or soiled with grease or oil (- oily)
"greasy coveralls";
""",
  );

  final String keyword = "greasy";
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The sink was piled high with greasy dishes.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""This food's a bit greasy, isn't it?""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She tied back her long greasy hair.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""He told me how well I’d done in that greasy way of his.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """greasy""",
                      // alsoEnglishWord: "also: greasy",
                      britshText: """IpaUK: /ˈɡriːsi/,  /ˈɡriːzi/""",
                      americanText: """IpaUS: /ˈɡriːsi/,  /ˈɡriːzi/""",
...
کوردی: چەور، چەوروچڵێک، گریساوی، ڕۆناوی، چەوراوی، خز، خلیسک
"""),
// With short examples define "greasy", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵناو) کە بە گریس یان ڕۆن داپۆشراوە"""),
                    SentencesRow(
                      englishText:
                          """The sink was piled high with greasy dishes.""",
                      kurdishText:
                          """دەستشۆرەکە پڕ بوو لە قاپی چەوری کەڵەکەکراو.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٤. (ھاوەڵناو) ڕەفتارکردن بە هاوڕێیانە کە لە دڵەوە نییە"""),
                    const AlsoEnglishckb(word: "ھەروەھا: smarmy"),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """He told me how well I’d done in that greasy way of his.""",
                      kurdishText:
                          """پێی گوتم چەندە باش بوومە بەو زمان‌لووسییەی خۆی.""",
...
const String _videoIdthree = 'https://youtu.be/LfeEu4_vtfQ?t=';
const double _startSecondsthree = 000000000000000000000000000695;
const String _videoIdfour = 'https://youtu.be/wMxKbkWrvDc?t=';
const double _startSecondsfour = 000000000000000000000000000142;
const String _videoIdfive = 'https://youtu.be/T-_HKFjxVl0?t=';
const double _startSecondsfive = 000000000000000000000000000131;
