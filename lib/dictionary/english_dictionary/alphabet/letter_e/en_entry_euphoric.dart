...
class EnglishEntryeuphoric extends StatefulWidget {
  const EnglishEntryeuphoric({super.key});

  @override
  State<EnglishEntryeuphoric> createState() => _EnglishEntryeuphoricState();
}

class _EnglishEntryeuphoricState extends State<EnglishEntryeuphoric> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""euphoric""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """euphoric""",
                      // alsoEnglishWord: "also: euphoric",
                      britshText: """IpaUK: /juːˈfɒrɪk/""",
                      americanText: """IpaUS: /juːˈfɔːrɪk/""",
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""My euphoric mood could not last.""");
  }
...
// With short examples define "euphoric", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: سەرخۆشانە، سەرمەستانە، شاگەشکانە، سەرخۆش، شاد، بەکەیف، بەنەشە، لەجۆش، بەگوڕ، بەجم‌وجۆڵ، دڵخۆش، بەپەرۆش
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) تەواو دڵخۆش و بەجۆش"""),
          SentencesRow(
            englishText: """My euphoric mood could not last.""",
            kurdishText: """کەشە دڵخۆشییەکەم نەدەکرا بەردەوام ببێت.""",
...
"Euphoric recall is the most difficult of the three memory distortions to understand"
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/ugElBfp0j98?t=';
const double _startSecondsend = 000000000000000000000000000000; // 621;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/tqX4jKktiS0?t=';
const double _startSecondsone = 00000000000000000000000000000; // 463;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/1uNpjqH-mQQ?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 374;
const String _videoIdthree = 'VIDEOhttps://youtu.be/-PHcdn8R4d4?t=';
const double _startSecondsthree = 000000000000000000000000000; // 388;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/WwhyZUlmaWA?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 1437;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/mCNecSWZbs0?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 489;
