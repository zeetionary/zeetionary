...
class EnglishEntryexclamationpoint extends StatefulWidget {
  const EnglishEntryexclamationpoint({super.key});

  @override
  State<EnglishEntryexclamationpoint> createState() =>
      _EnglishEntryexclamationpointState();
}

class _EnglishEntryexclamationpointState
    extends State<EnglishEntryexclamationpoint> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""exclamation point""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      ...
                      // alsoEnglishWord: "also: exclamation point",
                      britshText: """IpaUK: /ˌekskləˈmeɪʃn mɑːk/""",
                      americanText: """IpaUS: /ˌekskləˈmeɪʃn mɑːrk/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "exclamation point";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""She uses a lot of exclamation marks in her emails.""");
  }
...
// With short examples define "exclamation point", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
// کوردی: نیشانەی سەرسووڕمان (!)
// """),
          const DefinitionKurdish(text: """١. (ناو) نیشانەی سەرسووڕمان (!)"""),
          SentencesRow(
            englishText:
                """She uses a lot of exclamation marks in her emails.""",
            kurdishText:
                """نیشانەی سەرسوڕمانی زۆر لە ئیمەیڵەکانیدا بەکاردەهێنێت.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """The letter was peppered with exclamation marks.""",
            kurdishText: """نامەکە پڕ کرابوو لە نیشانەی سەرسوڕمان.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: exclamation (Derived forms: exclamations)
1. An abrupt excited utterance (= exclaiming)
"she gave an exclamation of delight";
 
2. A loud complaint, protest or reproach
 
3. An exclamatory rhetorical device (= ecphonesis)
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/kawym8ZwhwA?t=';
const double _startSecondsend = 000000000000000000000000000000; // 318;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/Jb88eui8SqQ?t=';
const double _startSecondsone = 00000000000000000000000000000; // 192;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/9nCFgaFA9Cw?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 198;
const String _videoIdthree = 'VIDEOhttps://youtu.be/JvoCIahJZ6s?t=';
const double _startSecondsthree = 000000000000000000000000000; // 605;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/CniX_zqMgJc?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 65;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/oloBebBQE38?t=';
const double _startSecondsfive = 00000000000000000000000000000; // 217;
