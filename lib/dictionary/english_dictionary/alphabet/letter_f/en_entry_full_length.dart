...
class EnglishEntryfulllength extends StatefulWidget {
  const EnglishEntryfulllength({super.key});

  @override
  State<EnglishEntryfulllength> createState() => _EnglishEntryfulllengthState();
}

class _EnglishEntryfulllengthState extends State<EnglishEntryfulllength> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  final String keyword = "full-length";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""full-length""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was lying full-length on the grass.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""He bought a full-length mirror for the bedroom.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She wrote a full-length novel last year.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They installed full-length windows in the office.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Victoria wore a full-length skirt to the party.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """full-length""",
                      // alsoEnglishWord: "also: full-length",
                      britshText: """IpaUK: /ˌfʊl ˈleŋkθ/""",
                      americanText: """IpaUS: /ˌfʊl ˈleŋkθ/""",
...
// With short examples define "full-length", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) کە کەسێک پالدەکەوێت بە ڕاکشاوی و لاقەکانی درێژ دەکات"""),
                    SentencesRow(
                      englishText: """He was lying full-length on the grass.""",
                      kurdishText: """بە درێژی ڕاکشابوو.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """ئاوێنەیەکی تەواو درێژی بۆ ژووری نووستنەکە کڕی.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ھاوەڵناو) کتێبێک، شانۆیەک، فیلمێک، هتد کە کورت نەکراوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """She wrote a full-length novel last year.""",
                      kurdishText:
                          """ساڵی ڕابردوو ڕۆمانێکی تەواو درێژی نووسی.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """پەنجەرەی تەواو درێژیان لە نووسینگەکە دامەزراند.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٥. (ھاوەڵناو) جلێک کە دەگاتە سەر ئەهنۆی کەسێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """Victoria wore a full-length skirt to the party.""",
                      kurdishText:
                          """ڤیکتۆریا تەنوورەیەکی درێژی لەبەر کرد بۆ ئاهەنگەکە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/LbPw9AlVKVM?t=';
const double _startSecondsend = 000000000000000000000000000253;
const String _videoIdone = 'https://youtu.be/JHjXwicEwQo?t=';
const double _startSecondsone = 000000000000000000000000000799;
const String _videoIdtwo = 'https://youtu.be/LL_JCVWWaeA?t=';
const double _startSecondstwo = 000000000000000000000000000168;
const String _videoIdthree = 'https://youtu.be/DEDAjw9Ljrw?t=';
const double _startSecondsthree = 000000000000000000000000000867;
const String _videoIdfour = 'https://youtu.be/fY2CF-T05qY?t=';
const double _startSecondsfour = 000000000000000000000000000896;
const String _videoIdfive = 'https://youtu.be/qTPKGVrFtQU?t=';
const double _startSecondsfive = 00000000000000000000000000025;
