...
class EnglishEntryj extends StatefulWidget {
  const EnglishEntryj({super.key});

  @override
  State<EnglishEntryj> createState() => _EnglishEntryjState();
}

class _EnglishEntryjState extends State<EnglishEntryj> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: j (Derived forms: js)
1. The 10th letter of the Roman alphabet (- J)

- Noun: J (Derived forms: Js)
1. A unit of electrical energy equal to the work done when a current of one ampere passes through a resistance of one ohm for one second (- joule, watt second)
""",
  );
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""‘Jelly’ begins with (a) J/‘J’.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/ML8IL77gQ3k?t=41';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/nRafaCcfrcI?t=334';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/hTqtGJwsJVE?t=810';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/h4etY0PSI1E?t=102';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/Bl5630CeYFs?t=19';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/Xzv84ZdtlE0';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """j""",
                      // alsoEnglishWord: "also: j",
                      britshText: """IpaUK: /dʒeɪ/""",
                      americanText: """IpaUS: /dʒeɪ/""",
...
کوردی: 
"""),
// With short examples define "j", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ناو) دەیەم پیتی ئەلفوبێی ئینگلیزی"""),
                    SentencesRow(
                      englishText: """‘Jelly’ begins with (a) J/‘J’.""",
                      kurdishText: """وشەی ‘Jelly’ بە J/‘J’ دەست پێدەکات.""",
