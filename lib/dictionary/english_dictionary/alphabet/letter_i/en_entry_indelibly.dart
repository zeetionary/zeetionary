...
class EnglishEntryindelibly extends StatefulWidget {
  const EnglishEntryindelibly({super.key});

  @override
  State<EnglishEntryindelibly> createState() => _EnglishEntryindeliblyState();
}

class _EnglishEntryindeliblyState extends State<EnglishEntryindelibly> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""indelibly""");
  }
