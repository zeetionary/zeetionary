...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/5j-R06GLvvU?t=';
    const double startSecondsend = 000000000000000000000000000768;
    const String videoIdone = 'https://youtu.be/aT0TZDDxCAs?t=';
    const double startSecondsone = 000000000000000000000000000240;
    const String videoIdtwo = 'https://youtu.be/lte3JOnyXlo?t=';
    const double startSecondstwo = 00000000000000000000000000014;
    const String videoIdthree = 'https://youtu.be/AKHmC8CmBeU?t=';
    const double startSecondsthree = 0000000000000000000000000001168;
    const String videoIdfour = 'https://youtu.be/P9DFrSLIIuU?t=';
    const double startSecondsfour = 00000000000000000000000000040;
    const String videoIdfive = 'https://youtu.be/prkb-TYJeDM?t=';
    const double startSecondsfive = 000000000000000000000000000604;
