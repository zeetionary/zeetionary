...
کوردی: پڕنھێنی، ڕەمزاوی، لەتێگەیشتن‌نەھاتوو، تەماوی، لێڵ، تەژمە، ئاڵۆز، سەخت
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) نھێنی و سەخت بۆ تێگەشتن"""),
          SentencesRow(
            englishText: """The Mona Lisa has a famously enigmatic smile.""",
            kurdishText: """مۆنالیسا بزەیەکی پڕنھێنی بەناوبانگی ھەیە.""",
