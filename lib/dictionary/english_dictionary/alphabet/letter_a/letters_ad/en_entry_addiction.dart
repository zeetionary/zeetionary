...
class EnglishEntryaddiction extends StatefulWidget {
  const EnglishEntryaddiction({super.key});

  @override
  State<EnglishEntryaddiction> createState() => _EnglishEntryaddictionState();
}

class _EnglishEntryaddictionState extends State<EnglishEntryaddiction> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200
  ...
  final String keyword = "addiction";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""addiction""");
  }
  ...
  Future<void> speakaddict2541(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("He is now fighting his addiction to alcohol.");
  }

  @override
  Widget build(BuildContext context) {
    
    const String videoIdend = 'ENWDU_RkUb8';
    const double startSecondsend = 10;
    const String videoIdone = 'yl_7qSgrf3Y';
    const double startSecondsone = 260;
    const String videoIdtwo = 'vgZ-GLXFQJw';
    const double startSecondstwo = 26;
    const String videoIdthree = 'Gupq0-5DYUQ';
    const double startSecondsthree = 13;
    const String videoIdfour = 'xe0Idx7xjTg';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """addiction""",
                      // alsoEnglishWord: "also: addiction",
                      britshText: """IpaUK: /əˈdɪkʃn/""",
                      americanText: """IpaUS: /əˈdɪkʃn/""",
...
"""),
                          ...
                          SentencesRow(
                            ...
                            onPressedAmerican: () => speakaddict2541("en-US"),
                          ),
                  ],
                ),
              ),
