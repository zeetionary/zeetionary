...
class EnglishEntryextradition extends StatefulWidget {
  const EnglishEntryextradition({super.key});

  @override
  State<EnglishEntryextradition> createState() =>
      _EnglishEntryextraditionState();
}

class _EnglishEntryextraditionState extends State<EnglishEntryextradition> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""extradition""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """extradition""",
                      // alsoEnglishWord: "also: extradition",
                      britshText: """IpaUK: /ˌekstrəˈdɪʃn/""",
                      americanText: """IpaUS: /ˌekstrəˈdɪʃn/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "extradition";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""They have applied for his extradition to Ireland.""");
  }
...
کوردی: بەدەستەوەدان، ڕادەست(کردنەوە)، دانەدەست، پێدانەوە، گێڕانەوە، دانەوە (ـی تاوان‌کار)
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) ناردنەوەی تاوانبارێک بۆ وڵاتێک کە تێیدا تاوانەکەی ئەنجام داوە"""),
          SentencesRow(
            englishText:
                """They have applied for his extradition to Ireland.""",
            kurdishText: """داوای ناردنەوەیان بۆ ئێرلەندا کردووە.""",
...
const double _startSecondsend = 0000000000000000000000000001033;
const String _videoIdone = 'https://youtu.be/Gi3HnqetpLw?t=';
const double _startSecondsone = 000000000000000000000000000320;
const String _videoIdtwo = 'https://youtu.be/4IaOeVgZ-wc?t=';
const double _startSecondstwo = 0000000000000000000000000003364;
const String _videoIdthree = 'https://youtu.be/p4WlHPIntCQ?t=';
const double _startSecondsthree = 000000000000000000000000000437;
const String _videoIdfour = 'https://youtu.be/32KTKXZZ-BI?t=';
const double _startSecondsfour = 000000000000000000000000000358;
const String _videoIdfive = 'https://youtu.be/XvVCc1Ts0MA?t=';
