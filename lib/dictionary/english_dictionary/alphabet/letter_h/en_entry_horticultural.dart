...
class EnglishEntryhorticultural extends StatefulWidget {
  const EnglishEntryhorticultural({super.key});

  @override
  State<EnglishEntryhorticultural> createState() =>
      _EnglishEntryhorticulturalState();
}

class _EnglishEntryhorticulturalState extends State<EnglishEntryhorticultural> {
  @override
  void initState() {
    super.initState();
...
"The profession of horticultural therapy is the result of two disciplines merging together"
""",
  );

  final String keyword = "horticultural";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""horticultural""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""He is a professor of horticultural science.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/_g2CaF12xxw?t=';
    const double startSecondsend = 000000000000000000000000000324;
    const String videoIdone = 'https://youtu.be/bITz9yQPjy8?t=';
    const double startSecondsone = 000000000000000000000000000496;
    const String videoIdtwo = 'https://youtu.be/fcR_qktp_2M?t=';
    const double startSecondstwo = 000000000000000000000000000192;
    const String videoIdthree = 'https://youtu.be/VZ_xwRhGH54?t=';
    const double startSecondsthree = 000000000000000000000000000249;
    const String videoIdfour = 'https://youtu.be/dUZzU6kEtUk?t=';
    const double startSecondsfour = 000000000000000000000000000937;
    const String videoIdfive = 'https://youtu.be/ripz4yqWPzo?t=';
    const double startSecondsfive = 000000000000000000000000000282;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """horticultural""",
                      // alsoEnglishWord: "also: horticultural",
                      britshText: """IpaUK: /ˌhɔːtɪˈkʌltʃərəl/""",
                      americanText: """IpaUS: /ˌhɔːrtɪˈkʌltʃərəl/""",
...
"""),
                    ...
                    SentencesRow(
                      englishText:
                          """He is a professor of horticultural science.""",
                      kurdishText: """پڕۆفیسۆری زانستی باخەوانییە.""",
