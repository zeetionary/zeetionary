...
class EnglishEntryfluency extends StatefulWidget {
  const EnglishEntryfluency({super.key});

  @override
  State<EnglishEntryfluency> createState() => _EnglishEntryfluencyState();
}

class _EnglishEntryfluencyState extends State<EnglishEntryfluency> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fluency (Derived forms: fluencies)
1. Powerful and effective language (= eloquence, smoothness)
"fluency in spoken and written English is essential";
 
2. Skilfulness in speaking or writing
 
3. The quality of being facile in speech and writing (= volubility, articulateness)
""",
  );

  final String keyword = "fluency";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fluency""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""Fluency in French is required for this job.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.speak(
        """Some young children achieve great fluency in their speaking.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""The team lacked fluency during the first half.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fluency""",
                      // alsoEnglishWord: "also: fluency",
                      britshText: """IpaUK: /ˈfluːənsi/""",
                      americanText: """IpaUS: /ˈfluːənsi/""",
...
// With short examples define "fluency", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) ئەوەی توانای قسەکردن، خوێندنەوە، و نووسینت هەبێت بە زمانێک، بە تایبەتی زمانی بیانی، بە باشی"""),
                    SentencesRow(
                      englishText:
                          """Fluency in French is required for this job.""",
                      kurdishText:
                          """زمان‌پاراوی لە فەرەنسیدا پێویستە بۆ کارەکە.""",
                    ...
                    SentencesRow(
                      englishText:
                          """Some young children achieve great fluency in their speaking.""",
                      kurdishText:
                          """هەندێک منداڵی گەنج توانای ڕەوانی لە باش لە قسەکردن بەدەست دەهێنن.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """تیمەکە لە یەکەم گێم هاوئاهەنگی نەبوو.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/HAnw168huqA?t=';
const double _startSecondsend = 0000000000000000000000000002351;
const String _videoIdone = 'https://youtu.be/GdD065F54ko';
const double _startSecondsone = 0;
const String _videoIdtwo = 'https://youtu.be/pb_fdgm4VIQ?t=';
const double _startSecondstwo = 000000000000000000000000000117;
const String _videoIdthree = 'https://youtu.be/Hn96E-KioKU?t=';
const double _startSecondsthree = 000000000000000000000000000152;
const String _videoIdfour = 'https://youtu.be/2pCRplUQVMI?t=';
const double _startSecondsfour = 0000000000000000000000000003037;
const String _videoIdfive = 'https://youtu.be/u6zHzNEKsVg?t=';
const double _startSecondsfive = 000000000000000000000000000277;
