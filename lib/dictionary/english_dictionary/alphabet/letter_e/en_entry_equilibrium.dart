...
class EnglishEntryequilibrium extends StatefulWidget {
  const EnglishEntryequilibrium({super.key});

  @override
  State<EnglishEntryequilibrium> createState() =>
      _EnglishEntryequilibriumState();
}

class _EnglishEntryequilibriumState extends State<EnglishEntryequilibrium> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""equilibrium""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """equilibrium""",
                      // alsoEnglishWord: "also: equilibrium",
                      britshText:
                          """IpaUK: /ˌiːkwɪˈlɪbriəm/,  /ˌekwɪˈlɪbriəm/""",
                      americanText:
                          """IpaUS: /ˌiːkwɪˈlɪbriəm/,  /ˌekwɪˈlɪbriəm/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "equilibrium";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""We have achieved an equilibrium in the economy.""");
  }
...
کوردی: هاوکێشی، هاوسەنگی، تەرازمەندی، لەنگەر، لەنگەرگیری،	لەسەرەخۆیی، ئارامی
"""),
          const DefinitionKurdish(
              text:
                  """١. (ناو) دۆخی هاوسەنگی، بەتایبەتی لە نێوان ژمارەیەک هێزی جیاواز """),
          SentencesRow(
            englishText:
                """Any disturbance to the body's state of equilibrium can produce stress.""",
            kurdishText:
                """هەر تێکچوونێک لە دۆخی هاوسەنگیی جەستە دەکرێت فشار درووست بکات.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """We have achieved an equilibrium in the economy.""",
            kurdishText: """هاوسەنگی ئابووریمان بەدەستهێناوە.""",
            kurdishNote:
                "ئەم ڕستە واتا ئابووری گەیشتووەتە حاڵەتێک کە هەموو فاکتەرەکان هاوسەنگ و جێگیرن. هیچ هەڵاوسان و ناهاوسەنگییەکی بەرچاو نییە، ئەمەش ئاماژەیە بۆ بارودۆخێکی ئابووری سەقامگیر و تەندروست.",
            onPressedBritish: () => speaksentence2("en-GB"),
            onPressedAmerican: () => speaksentence2("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(
              text: """٢. (ھاوەڵناو) دۆخێکی لەسەرخۆی و جێگیری دەروونی"""),
          const DividerSentences(),
          SentencesRow(
            englishText: """He sat down to try and recover his equilibrium.""",
            kurdishText: """دانیشت و هەوڵی دا لەسەرەخۆیی بگەڕێنێتەوە.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: equilibrium (Derived forms: equilibria, equilibriums)
1. A stable situation in which forces cancel one another
 
2. A chemical reaction and its reverse proceed at equal rates (= chemical equilibrium)
 
3. Equality of distribution (= balance, equipoise, counterbalance)
 
4. A sensory system located in structures of the inner ear that registers the orientation of the head (= labyrinthine sense, vestibular sense, sense of balance, sense of equilibrium)
""",
  );
...
const String _videoIdend = 'VIDEO_IDhttps://youtu.be/ao2Jfm35XeE?t=';
const double _startSecondsend = 000000000000000000000000000000; // 375;
const String _videoIdone = 'VIDEO_Dhttps://youtu.be/ibpdNqrtar0?t=';
const double _startSecondsone = 00000000000000000000000000000; // 119;
const String _videoIdtwo = 'VIDEO_Dhttps://youtu.be/NZLbTuBDhJg?t=';
const double _startSecondstwo = 00000000000000000000000000000; // 963;
const String _videoIdthree = 'VIDEOhttps://youtu.be/0e8woEkKmG8?t=';
const double _startSecondsthree = 000000000000000000000000000; // 866;
const String _videoIdfour = 'VIDEO_IDhttps://youtu.be/WEvd4scefqI?t=';
const double _startSecondsfour = 000000000000000000000000000000; // 138;
const String _videoIdfive = 'VIDEO_Dhttps://youtu.be/FrbiPlT-rJU?t=';
