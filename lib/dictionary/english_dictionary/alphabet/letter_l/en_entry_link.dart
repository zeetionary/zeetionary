...
class EnglishEntrylink extends StatefulWidget {
  const EnglishEntrylink({super.key});

  @override
  State<EnglishEntrylink> createState() => _EnglishEntrylinkState();
}

class _EnglishEntrylinkState extends State<EnglishEntrylink> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Verb: link (Derived forms: links, linking, linked)
1. Make a logical or causal connection (- associate, tie in, relate, colligate, link up, connect)
"I cannot link these events at all";
 
2. Join together or make a link between two or more pieces (- connect, tie, link up)
...
4. (animal husbandry) Join with or as if with a yoke (- yoke)
"link the oxen together";
 
5. Add a web link to piece of text or other item in an electronic document (- hyperlink, hotlink)

- Noun: link (Derived forms: links)
...
4. A connecting shape (- connection, connexion [Brit])
...
6. A two-way radio communication system (usually microwave); part of a more extensive telecommunication network (- radio link)
 
7. An interconnecting circuit between two or more locations for the purpose of transmitting and receiving data (- data link)
 
8. A link from a hypertext file to another location or file; typically activated by clicking on a highlighted word or icon at a particular location on the screen (- hyperlink, weblink, hotlink)
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Police suspect there may be a link between the two murders.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""There is evidence for a strong causal link between exposure to sun and skin cancer.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Many of them had no previous links to terrorism.""");
  }
  ...
  Future<void> speaksentence4(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Her work explores the links between violence and gender relations.""");
  }
  ...
  Future<void> speaksentence5(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The author denies the link between capitalism and fascism.""");
  }
  ...
  Future<void> speaksentence6(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""Producers are forging direct links with consumers.""");
  }
  ...
  Future<void> speaksentence7(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The agreement will strengthen the links between the two countries.""");
  }
  ...
  Future<void> speaksentence8(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She has severed her last links with her family.""");
  }
  ...
  Future<void> speaksentence9(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The department is interested in developing closer links with industry.""");
  }
  ...
  Future<void> speaksentence10(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The canal was an important transport link between England and Wales.""");
  }
  ...
  Future<void> speaksentence11(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""We're trying to establish a link via satellite.""");
  }
  ...
  Future<void> speaksentence12(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The chain was too long so I removed a few of the links.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'https://youtu.be/IrX2bYIa2qY?t=55';
    const double startSecondsend = 0;
    const String videoIdone = 'https://youtu.be/y3JQOUaypWQ?t=1031';
    const double startSecondsone = 0;
    const String videoIdtwo = 'https://youtu.be/My8kfz_Ddqg?t=89';
    const double startSecondstwo = 0;
    const String videoIdthree = 'https://youtu.be/s1IPhnjHpSk?t=726';
    const double startSecondsthree = 0;
    const String videoIdfour = 'https://youtu.be/Jc3GBDJ2sK0?t=16';
    const double startSecondsfour = 0;
    const String videoIdfive = 'https://youtu.be/UjMojh4L_pg?t=25';
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """link""",
                      // alsoEnglishWord: "also: link",
                      britshText: """IpaUK: /lɪŋk/""",
                      americanText: """IpaUS: /lɪŋk/""",
...
کوردی: ئاڵقەی زنجیر، ڕەوق، قەف، خەلەک، تەوق،	ئاڵقەی پێوەندی، بەستەر، پێکەبەند، پێکەوەبەستن، پێوەندی، گرێ‌دراوی، تێکەڵی
"""),
// With short examples define "link", please follow LX instructions
                    const DefinitionKurdish(text: """١. (ناو) پەیوەندیی نێوان دوو یان زیاتر لە کەس یان شت"""),
                    SentencesRow(
                      englishText: """Police suspect there may be a link between the two murders.""",
                      kurdishText: """پۆلیس گومان دەکەن پەیوەندی هەبێت لە نێوان کوشتنەکان.""",
                    ...
                    SentencesRow(
                      englishText: """There is evidence for a strong causal link between exposure to sun and skin cancer.""",
                      kurdishText: """بەڵگە هەیە ]پەیوەندیی هۆکاری بەهێز لە نێوان بەرکەوتن بە خۆر و شێرپەنجەی پێست.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Many of them had no previous links to terrorism.""",
                      kurdishText: """زۆرێکیان هیچ پەیوەندییەکی پێشووتریان لەگەڵ تیرۆریزم نەبووە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Her work explores the links between violence and gender relations.""",
                      kurdishText: """کارەکەی دەڕوانێت لە پەیوەندیی نێوان توندوتیژی و پەیوەندیی ڕەگەزی.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The author denies the link between capitalism and fascism.""",
                      kurdishText: """نووسەرەکە نکۆڵی دەکات لە پەیوەندیی نێوان سەرمایەداری و فاشیزم.""",
                      onPressedBritish: () => speaksentence5("en-GB"),
                      onPressedAmerican: () => speaksentence5("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٢. (ناو) پەیوەندیی نێوان دوو یان زیاتر لە خەڵکی، وڵات، یان دامەزراوە"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """Producers are forging direct links with consumers.""",
                      kurdishText: """بەرهەمهێنەران پەیوەندیی ڕاستەوخۆ لەگەڵ بەکارهێنەران درووست دەکەن.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The agreement will strengthen the links between the two countries.""",
                      kurdishText: """ڕێککەوتنەکە پەیوەندیی نێوان دوو وڵاتەکە بەهێز دەکات.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """She has severed her last links with her family.""",
                      kurdishText: """پەیوەندییەکانی ڕابردووی لەگەڵ خێزانەکەی بڕیوە.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The department is interested in developing closer links with industry.""",
                      kurdishText: """بەشەکە ئاواتەخوازە کە پەیوەندیی نزیکتر لەگەڵ پیشەسازی درووست بکات.""",
                      onPressedBritish: () => speaksentence9("en-GB"),
                      onPressedAmerican: () => speaksentence9("en-US"),
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٣. (ناو) ڕێگای پەیوەندی یان گەشتکردن لە نێوان دوو شوێندا"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The canal was an important transport link between England and Wales.""",
                      kurdishText: """کەناڵەکە ڕێگایەکی گرێدەری گرنگ بوو لە نێوان ئینگلاند و وێڵزدا.""",
                    ...
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """We're trying to establish a link via satellite.""",
                      kurdishText: """هەوڵ دەدەین پەیوەندییەک لە ڕێگای سەتەلایتەوە درووست بکەین.""",
                    ...
                    textAfterLink: "",
                    onTap: () {
                    Routemaster.of(context).push("/english-link/hyperlink");
                    },
                    ),
                    const DividerDefinition(),
                    const DefinitionKurdish(text: """٥. (ناو) هەر ئەڵقەیەکی زنجیرێک"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText: """The chain was too long so I removed a few of the links.""",
                      kurdishText: """زنجیرەکە زۆر درێژ بوو بۆیە هەندێک لە ئەڵقەکانیم لابرد.""",
