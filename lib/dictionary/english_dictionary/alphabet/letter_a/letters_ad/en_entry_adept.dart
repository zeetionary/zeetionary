                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "adept"), // Find /əˈdept/
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /əˈdept/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakadept("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /əˈdept/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakadept("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'iWaIFn4Yerk';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'gTZo4Cs8Zc8';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = '6Awx8MvT7qk';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'XwM7SWJ6dr0';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'rr1wNpNMw-s';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = '1YxH43Cw6tI';
...
class YoutubeEmbeddedend extends StatelessWidget {
  ...
  final String _videoId = 'wZd7bUrhPF4';
