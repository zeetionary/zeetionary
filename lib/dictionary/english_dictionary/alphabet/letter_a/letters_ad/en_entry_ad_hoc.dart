...
class EnglishEntryadhoc extends StatelessWidget {
  EnglishEntryadhoc({Key? key}) : super(key: key);
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /ˌæd ˈhɒk/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = '06EG6jpCBBk';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  static String myVideoId = 'iyFT8qXcOrM';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  static String myVideoId = 'eHSvv8eSsvc';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  static String myVideoId = 'L7INxfISGFs';
