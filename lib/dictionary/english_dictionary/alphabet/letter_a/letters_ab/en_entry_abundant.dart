...
class EnglishEntryabundant extends StatelessWidget {
  ...
  Future<void> speakAbundant(String languageCode) async {
    // DOPSUM: CHANGE speakAbundant
    await flutterTts.setLanguage(languageCode);
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("abundant"); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakA15742(String languageCode) async {
    ...
    await flutterTts.speak(
        "We have abundant evidence to prove his guilt."); // DOPSUM: CHANGE TEXT
  }
  ...
  Future<void> speakA96852(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("Fish are abundant in the lake."); // DOPSUM: CHANGE TEXT
  }
                    ...
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            Text(
                              'abundant', // DOPSUM: CHANGE WORD ENTRY
                              style: TextStyle(
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUK: /əˈbʌndənt/', // DOPSUM: WRITE IPA IN BRITISH ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
                        ...
                        Row(
                          children: [
                            const Text(
                              'IpaUS: /əˈbʌndənt/', // DOPSUM: WRITE IPA IN AMERICAN ENGLISH
                              style: TextStyle(fontSize: 14),
                            ),
                            IconButton(
                              iconSize: 16,
...
class YoutubeEmbeddedone extends StatelessWidget {
  static String myVideoId = 'aCQmxEFrgaw';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  static String myVideoId = 'F6R_WTDdx7I';
