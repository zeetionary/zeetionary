...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'MQS6Jg87uk8';
    const double startSecondsend = 476;
    const String videoIdone = 'xPG3_8m1NQA';
    const double startSecondsone = 493;
    const String videoIdtwo = '8o9dLnQZIB8';
    const double startSecondstwo = 431;
    const String videoIdthree = 'jX_LdG8-egE';
    const double startSecondsthree = 126;
    const String videoIdfour = 'T7cer9dKCcQ';
    const double startSecondsfour = 165;
    const String videoIdfive = '0P9SauG4f70';
    const double startSecondsfive = 2983;
