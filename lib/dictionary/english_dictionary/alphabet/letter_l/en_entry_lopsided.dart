...
class EnglishEntrylopsided extends StatefulWidget {
  const EnglishEntrylopsided({super.key});

  @override
  State<EnglishEntrylopsided> createState() => _EnglishEntrylopsidedState();
}

class _EnglishEntrylopsidedState extends State<EnglishEntrylopsided> {
  @override
  void initState() {
    super.initState();
...
// 188888880002200000000000
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""lopsided""");
  }
