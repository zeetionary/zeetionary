...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdone = 'iDyRszZKPFw';
    const double startSecondsone = 47;
    const String videoIdtwo = 'qY5xsdhaeO4';
    const double startSecondstwo = 221;
    const String videoIdthree = 'Z4uAq_-t-eI';
    const double startSecondsthree = 0;
    const String videoIdfour = 'uISyLEAHZBI';
    const double startSecondsfour = 58;
    const String videoIdfive = 'XPFJs9nYroo';
