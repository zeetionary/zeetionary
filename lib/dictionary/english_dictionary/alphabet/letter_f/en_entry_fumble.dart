...
class EnglishEntryfumble extends StatefulWidget {
  const EnglishEntryfumble({super.key});

  @override
  State<EnglishEntryfumble> createState() => _EnglishEntryfumbleState();
}

class _EnglishEntryfumbleState extends State<EnglishEntryfumble> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""She fumbled in her pocket for a handkerchief.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He fumbled with the buttons on his shirt.""");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""During the interview, she fumbled helplessly for words.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fumble""",
                      // alsoEnglishWord: "also: fumble",
                      britshText: """IpaUK: /ˈfʌmbl/""",
                      americanText: """IpaUS: /ˈfʌmbl/""",
...
// With short examples define "fumble", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (کردار) بەکارهێنانی دەست بە شێوەیەک کە جێگیر یان بە وریایی نییە کە شتێک دەکەیت یان بۆ شتێک دەگەڕێیت"""),
                    SentencesRow(
                      englishText:
                          """She fumbled in her pocket for a handkerchief.""",
                      kurdishText: """باخەڵی گەڕا بۆ دەستەسڕێک.""",
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """بە دەستەپاچەیی دووگمەکانی کراسەکەی دەبەست.""",
                      englishNote:
                          """This means he clumsily or awkwardly handled the buttons on his shirt, possibly struggling to fasten or unfasten them.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٢. (کردار) هەبوونی کێشەی ئەوەی بە ڕوونی قسە بکەیت یان وشەی گونجاو بەکاربهێنیت"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """During the interview, she fumbled helplessly for words.""",
                      kurdishText:
                          """لە چاوپێکەوتنەکەدا، بێ توانایانە تەتەڵەی بوو بۆ وشي.""",
                    ...
                    const DefinitionKurdish(
                        text:
                            """٣. (ناو) بەکارهێنانی دەست بە لەرزۆکی و نا وریایی"""),
                    const DividerSentences(),
                    SentencesRow(
                      englishText:
                          """After a brief fumble in her handbag, she produced a clean handkerchief.""",
                      kurdishText:
                          """لە دوای کەمێک لە دەستکردن بە جانتاکەیدا، دەستەسڕێکی پاکی دەرهێنا.""",
...
const String _videoIdone = 'https://youtu.be/vORV4D6Af88?t=';
const double _startSecondsone = 0000000000000000000000000001451;
const String _videoIdtwo = 'https://youtu.be/U_dDpmoQjqg?t=';
const double _startSecondstwo = 000000000000000000000000000103;
const String _videoIdthree = 'https://youtu.be/P_HfOYKmeEk?t=';
const double _startSecondsthree = 000000000000000000000000000154;
const String _videoIdfour = 'https://youtu.be/c0qbw_AGCkw?t=';
const double _startSecondsfour = 000000000000000000000000000658;
const String _videoIdfive = 'https://youtu.be/O-buiiyp_xU?t=';
const double _startSecondsfive = 000000000000000000000000000543;
