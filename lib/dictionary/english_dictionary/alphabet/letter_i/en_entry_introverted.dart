...
class EnglishEntryintroverted extends StatefulWidget {
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""introverted""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdtwo = 'd6S0u8VENOE';
    const double startSecondstwo = 797;
    const String videoIdthree = 'tqX4jKktiS0';
    const double startSecondsthree = 603;
    const String videoIdfour = 'DG8rPBlbOrY';
    const double startSecondsfour = 277;
    const String videoIdfive = '8PJGIEz5YJ4';
    const double startSecondsfive = 682;
