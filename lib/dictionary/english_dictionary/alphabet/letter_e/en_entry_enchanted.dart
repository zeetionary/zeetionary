...
class EnglishEntryenchanted extends StatefulWidget {
  const EnglishEntryenchanted({super.key});

  @override
  State<EnglishEntryenchanted> createState() => _EnglishEntryenchantedState();
}

class _EnglishEntryenchantedState extends State<EnglishEntryenchanted> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("enchanted");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: "enchanted",
                      // alsoEnglishWord: "also: enchanted",
                      britshText: "IpaUK: /ɪnˈtʃɑːntɪd/",
                      americanText: "IpaUS: /ɪnˈtʃæntɪd/",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enchanted";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The princess lives in an enchanted castle.");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("He was enchanted to see her again after so long.");
  }
  ...
  Future<void> speaksentence3(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("The children were enchanted with the present.");
  }
...
کوردی: خۆشحاڵ، شاد، دڵ‌خۆش، بەکەیف،	جادووکراو، تەلەسماوی، تەلەسم‌بەند(کراو)
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) کە جادووی لێکراوە"""),
          SentencesRow(
            englishText: """The princess lives in an enchanted castle.""",
            kurdishText: """شازادە خاتوونەکە لە قەڵایەکی جادوولێکراودا دەژی.""",
            onPressedBritish: () => speaksentence1("en-GB"),
            onPressedAmerican: () => speaksentence1("en-US"),
          ),
          const DividerDefinition(),
          const DefinitionKurdish(text: """٢. (ھاوەڵناو) کە پڕ لە خۆشییە"""),
          // const DividerSentences(),
          SentencesRow(
            englishText: """He was enchanted to see her again after so long.""",
            kurdishText: """شاگەشکە بوو بە بینینی لە دوای ماوەیەکی وەها زۆر.""",
            onPressedBritish: () => speaksentence2("en-GB"),
            onPressedAmerican: () => speaksentence2("en-US" ""),
          ),
          const DividerSentences(),
          SentencesRow(
            englishText: """The children were enchanted with the present.""",
            kurdishText: """منداڵەکان بەکەیف بوون بە دیارییەکە.""",
...
class YoutubeEmbeddedone extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/Hzv8E3z1nx8?t=';
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/tqIXjSjmE78?t=';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/DUbQkkB5rQE?t=';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/-8jjTVuev_s?t=';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/fE4Z5hFLrqI?t=';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'https://youtu.be/AM6PdUq0G9U?t=';
