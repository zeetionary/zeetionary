...
class EnglishEntryhatchway extends StatefulWidget {
  const EnglishEntryhatchway({super.key});

  @override
  State<EnglishEntryhatchway> createState() => _EnglishEntryhatchwayState();
}

class _EnglishEntryhatchwayState extends State<EnglishEntryhatchway> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: hatchway (Derived forms: hatchways)
1. An entrance equipped with a hatch; especially a passageway between decks of a ship (- opening, scuttle, hatch)
""",
  );

  final String keyword = "hatchway";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hatchway""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts
        .speak("""She descended the ladder through the hatchway.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hatchway""",
                      // alsoEnglishWord: "also: hatchway",
                      britshText: """IpaUK: /ˈhætʃweɪ/""",
                      americanText: """IpaUS: /ˈhætʃweɪ/""",
...
کوردی: دەربیجە، دەلاقە، کولاوکە، کڵاوڕۆژنە، درگا، دەرکە، درگای دادراوە
"""),
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) دەرگا یان دەلاقەی فڕۆکەیەک یان کەشتییەک"""),
                    SentencesRow(
                      englishText:
                          """She descended the ladder through the hatchway.""",
                      kurdishText:
                          """بە پەیژەکەدا بە دەلاقەکەدا چووە خوارەوە.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/O6Duf496Ips?t=';
const double _startSecondsend = 000000000000000000000000000509;
const String _videoIdone = 'https://youtu.be/I_17-FIqadU?t=';
const double _startSecondsone = 0000000000000000000000000001189;
const String _videoIdtwo = 'https://youtu.be/i1fgNzaEKG8?t=';
const double _startSecondstwo = 000000000000000000000000000586;
const String _videoIdthree = 'https://youtu.be/PmeutZCDQhw?t=';
const double _startSecondsthree = 000000000000000000000000000296;
const String _videoIdfour = 'https://youtu.be/yg4pbyu5jUc?t=';
const double _startSecondsfour = 000000000000000000000000000778;
const String _videoIdfive = 'https://youtu.be/En03sKGZU8g?t=';
const double _startSecondsfive = 000000000000000000000000000762;
