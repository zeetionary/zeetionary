...
class EnglishEntryartiste extends StatelessWidget {
  ...
  Future<void> speakartiste(String languageCode) async {
    ...
    await flutterTts.speak("artiste");
  }
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        const Row(
                          children: [
                            EntryTitle(word: "artiste"),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUK: /ɑːˈtiːst/"),
                            CustomIconButtonBritish(
                              onPressed: () => speakartiste("en-GB"),
                            ),
                          ],
                        ),
                        Row(
                          children: [
                            const IPAofEnglish(text: "IpaUS: /ɑːrˈtiːst/"),
                            CustomIconButtonAmerican(
                              onPressed: () => speakartiste("en-US"),
                            ),
                          ],
                        ),
                      ],
...
class YoutubeEmbeddedtwo extends StatelessWidget {
  ...
  final String _videoId = 'Lf3ER5Ope_s';
...
class YoutubeEmbeddedthree extends StatelessWidget {
  ...
  final String _videoId = 'ZOa-KB8Lmg4';
...
class YoutubeEmbeddedfour extends StatelessWidget {
  ...
  final String _videoId = '4XbmGpYxZwM';
...
class YoutubeEmbeddedfive extends StatelessWidget {
  ...
  final String _videoId = 'Gp2YPRqTw-I';
...
class YoutubeEmbeddedsix extends StatelessWidget {
  ...
  final String _videoId = 'iiNvxty3zfE';
