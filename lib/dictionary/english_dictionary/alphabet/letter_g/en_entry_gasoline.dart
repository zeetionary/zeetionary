...
class EnglishEntrygasoline extends StatefulWidget {
  const EnglishEntrygasoline({super.key});

  @override
  State<EnglishEntrygasoline> createState() => _EnglishEntrygasolineState();
}

class _EnglishEntrygasolineState extends State<EnglishEntrygasoline> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""gasoline""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""I fill up the tank with gasoline about once a week.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """gasoline""",
                      // alsoEnglishWord: "also: gasoline",
                      britshText: """IpaUK: /ˈɡæsəliːn/,  /ˌɡæsəˈliːn/""",
                      americanText: """IpaUS: /ˈɡæsəliːn/,  /ˌɡæsəˈliːn/""",
...
const double _startSecondsone = 0000000000000000000000000001048;
const String _videoIdtwo = 'https://youtu.be/YCnFYvL17v4?t=';
const double _startSecondstwo = 000000000000000000000000000371;
const String _videoIdthree = 'https://youtu.be/ycFziHLcxdY?t=';
const double _startSecondsthree = 00000000000000000000000000090;
const String _videoIdfour = 'https://youtu.be/D6YmAecTolQ';
const double _startSecondsfour = 0;
const String _videoIdfive = 'https://youtu.be/kB9fEC4CK6I?t=';
