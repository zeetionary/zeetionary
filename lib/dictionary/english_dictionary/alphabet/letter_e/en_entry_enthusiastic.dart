...
class EnglishEntryenthusiastic extends StatefulWidget {
  const EnglishEntryenthusiastic({super.key});

  @override
  State<EnglishEntryenthusiastic> createState() =>
      _EnglishEntryenthusiasticState();
}

class _EnglishEntryenthusiasticState extends State<EnglishEntryenthusiastic> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""enthusiastic""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """enthusiastic""",
                      // alsoEnglishWord: "also: enthusiastic",
                      britshText: """IpaUK: /ɪnˌθjuːziˈæstɪk/""",
                      americanText: """IpaUS: /ɪnˌθuːziˈæstɪk/""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "enthusiastic";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""They gave her an enthusiastic reception.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""You don't sound very enthusiastic about the idea.""");
  }
...
// With short examples define "enthusiastic", please follow LX instructions
  @override
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
...
کوردی: تامەزرۆ، بەئارەزوو، هۆگر
"""),
          const DefinitionKurdish(
              text: """١. (ھاوەڵناو) بوونی حەز و تامەزرۆیی زۆر بۆ شتێک"""),
          SentencesRow(
            englishText: """They gave her an enthusiastic reception.""",
            kurdishText: """پێشوازییەکی تامەزرۆییانەیان پیشان دا.""",
          ...
          SentencesRow(
            ...
            kurdishText: """زۆر تامەزرۆ دیار نیت سەبارەت بە بیرۆکەکە.""",
...
1. Having or showing great excitement and interest (= keen)
...
const String _videoIdend = 'https://youtu.be/F0rXPrnC_Ps?t=';
const double _startSecondsend = 107;
const String _videoIdone = 'https://youtu.be/Xt8EWjTrnEY?t=';
const double _startSecondsone = 181;
const String _videoIdtwo = 'https://youtu.be/pz52gPH3ou4?t=';
const double _startSecondstwo = 140;
const String _videoIdthree = 'https://youtu.be/SwQhKFMxmDY?t=';
const double _startSecondsthree = 627;
const String _videoIdfour = 'https://youtu.be/y4DTW4B3Sjs?t=';
const double _startSecondsfour = 9;
const String _videoIdfive = 'https://youtu.be/hkO8qXCFYWA?t=';
const double _startSecondsfive = 201;
const String _videoIdsix = 'https://youtu.be/Md-iBTwN4Kc?t=';
const double _startSecondssix = 548;
