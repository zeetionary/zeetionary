...
class EnglishEntrylightyear extends StatefulWidget {
  const EnglishEntrylightyear({super.key});

  @override
  State<EnglishEntrylightyear> createState() => _EnglishEntrylightyearState();
}

class _EnglishEntrylightyearState extends State<EnglishEntrylightyear> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""light year""");
  }
