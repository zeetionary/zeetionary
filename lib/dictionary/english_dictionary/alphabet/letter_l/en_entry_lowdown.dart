...
class EnglishEntrylowdown extends StatefulWidget {
  const EnglishEntrylowdown({super.key});

  @override
  State<EnglishEntrylowdown> createState() => _EnglishEntrylowdownState();
}

class _EnglishEntrylowdownState extends State<EnglishEntrylowdown> {
  @override
  void initState() {
    super.initState();
...
EnglishEntrylowdown low-down
WORD_WEB low-down low-down low-down
haʊʊʊʊʊʊʊ4
""",
  );
// 188888880002200000000000

  final String keyword = "low-down";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""low-down""");
  }
...
کوردی: 
"""),
// With short examples define "low-down", please follow LX instructions
