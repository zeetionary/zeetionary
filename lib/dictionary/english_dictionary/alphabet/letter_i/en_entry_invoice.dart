...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'SUc87t6yIF8';
    const double startSecondsend = 3468;
    const String videoIdone = 'SrDEtSlqJC4';
    const double startSecondsone = 850;
    const String videoIdtwo = 'RjAx-Ei_b78';
    const double startSecondstwo = 514;
    const String videoIdthree = 'wVyu7NB7W6Y';
    const double startSecondsthree = 699;
    const String videoIdfour = 'u9zaDWOKLXU';
    const double startSecondsfour = 174;
    const String videoIdfive = 'kPshZQQuslg';
    const double startSecondsfive = 521;
