...
class EnglishEntryfaultless extends StatefulWidget {
  const EnglishEntryfaultless({super.key});

  @override
  State<EnglishEntryfaultless> createState() => _EnglishEntryfaultlessState();
}

class _EnglishEntryfaultlessState extends State<EnglishEntryfaultless> {
  @override
  void initState() {
    super.initState();
  }
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""faultless""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """faultless""",
                      // alsoEnglishWord: "also: faultless",
                      britshText: """IpaUK: faultless""",
                      americanText: """IpaUS: faultless""",
...
class _SentencesFromDatabaseState extends State<SentencesFromDatabase> {
  final String keyword = "faultless";
...
class KurdishMeaning extends StatelessWidget {
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setSpeechRate(0.5);
    await flutterTts
        .speak("""Her piano-playing was faultless.""");
  }
...
کوردی: بێ‌عەیب، بێ‌خەوش، بێ‌گەرد، بێ‌قەباحەت، تەواو
"""),
          const DefinitionKurdish(text: """١. (ھاوەڵناو) بێ‌هەڵە"""),
          SentencesRow(
            englishText:
                """Her piano-playing was faultless.""",
            kurdishText: """پیانۆ ژەنینی بێ‌هەڵەیە.""",
          ...
          const DividerSentences(),
          SentencesRow(
            englishText: """He speaks faultless English.""",
            kurdishText: """ئینگلیزی بێ‌هەڵە دەئاخێوێت.""",
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: faultless
1. Without fault or error (= immaculate, impeccable, incorrupted)
"faultless logic";
""",
  );
...
const String _videoIdend = 'https://youtu.be/j7YqdGt19tw?t=';
const double _startSecondsend = 0000000000000000000000000001127;
const String _videoIdone = 'https://youtu.be/VeBX4WjhhXs?t=';
const double _startSecondsone = 0000000000000000000000000001840;
const String _videoIdtwo = 'https://youtu.be/ZlQqnvI1e08?t=';
const double _startSecondstwo = 000000000000000000000000000933;
const String _videoIdthree = 'https://youtu.be/aOn0GURmpPA?t=';
...
const String _videoIdfive = 'https://youtu.be/X-ugIZeZ14w?t=';
