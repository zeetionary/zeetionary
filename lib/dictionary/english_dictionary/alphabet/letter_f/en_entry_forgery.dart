...
class EnglishEntryforgery extends StatefulWidget {
  const EnglishEntryforgery({super.key});

  @override
  State<EnglishEntryforgery> createState() => _EnglishEntryforgeryState();
}

class _EnglishEntryforgeryState extends State<EnglishEntryforgery> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: forgery (Derived forms: forgeries)
1. A copy that is represented as the original (= counterfeit)
 
2. Criminal falsification by making or altering an instrument with intent to defraud
""",
  );

  final String keyword = "forgery";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""forgery""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He was convicted of forgery.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """forgery""",
                      // alsoEnglishWord: "also: forgery",
                      britshText: """IpaUK: /ˈfɔːdʒəri/""",
                      americanText: """IpaUS: /ˈfɔːrdʒəri/""",
...
کوردی: هەڵبەستن، ساختەکاری، گزی، فرت‌وفێڵ
"""),
// With short examples define "forgery", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ناو) کاری ساختەکردنی پارە، بەڵگەنامە، هتد بۆ مەبەستی ساختەکاری؛ شتێک کە ساختە کراو"""),
                    SentencesRow(
                      englishText:
                          """Experts are dismissing claims that the painting is a forgery.""",
                      kurdishText:
                          """شارەزایان ئەو بانگەشەیە ڕەتدەکەنەوە کە تابلۆکە ساختە بێت.""",
                    ...
                    SentencesRow(
                      englishText: """He was convicted of forgery.""",
                      kurdishText:
                          """بە کاری ساختەکاری بە تاوانبار ناسێندرا .""",
...
const String _videoIdtwo = 'https://youtu.be/NU4MgeOb-cc?t=';
const double _startSecondstwo = 000000000000000000000000000881;
const String _videoIdthree = 'https://youtu.be/N-FqJzC3tA8?t=';
const double _startSecondsthree = 000000000000000000000000000311;
const String _videoIdfour = 'https://youtu.be/q4vdACLx-hQ?t=';
const double _startSecondsfour = 000000000000000000000000000404;
const String _videoIdfive = 'https://youtu.be/ybBxueA5OuA?t=';
const double _startSecondsfive = 000000000000000000000000000935;
