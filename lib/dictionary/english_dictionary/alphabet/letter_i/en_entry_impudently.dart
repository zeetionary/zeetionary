...
class EnglishEntryimpudently extends StatefulWidget {
  const EnglishEntryimpudently({super.key});

  @override
  State<EnglishEntryimpudently> createState() => _EnglishEntryimpudentlyState();
}

class _EnglishEntryimpudentlyState extends State<EnglishEntryimpudently> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: impudently
1. In an impudent or impertinent manner (- impertinently, saucily [informal], pertly, freshly [informal])
"a lean, swarthy fellow was peering through the window, grinning impudently";
""",
  );

  final String keyword = "impudently";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""impudently""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The child impudently refused to obey, running in the opposite direction.""");
  }
  ...
  Widget build(BuildContext context) {
    // 188888880002200
    const String videoIdend = 'https://youtu.be/LK7xXFYyggc?t=';
    const double startSecondsend = 000000000000000000000000000516;
    const String videoIdone = 'https://youtu.be/V72L6RH3OD8?t=';
    const double startSecondsone = 00000000000000000000000000062;
    const String videoIdtwo = 'https://youtu.be/Jh7FkS0Y-JY?t=';
    const double startSecondstwo = 000000000000000000000000000120;
    const String videoIdthree = 'https://youtu.be/TR22T_8vwfc?t=';
    const double startSecondsthree = 0000000000000000000000000001356;
    const String videoIdfour = 'https://youtu.be/p6bOah8XY3I?t=';
    const double startSecondsfour = 0000000000000000000000000001749;
    const String videoIdfive = 'https://youtu.be/tRIhyqbcKO8?t=';
    const double startSecondsfive = 0000000000000000000000000003125;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """impudently""",
                      // alsoEnglishWord: "also: impudently",
                      britshText: """IpaUK: /ˈɪmpjədəntli/""",
                      americanText: """IpaUS: /ˈɪmpjədəntli/""",
...
کوردی: 
"""),
// With short examples define "impudently", please follow LX instructions
                    const DefinitionKurdish(
                        text:
                            """١. (ھاوەڵکار) بە شێوەیەک کە بێ‌شەرمانەیە و ڕێز پیشان نادات"""),
                    SentencesRow(
                      englishText:
                          """The child impudently refused to obey, running in the opposite direction.""",
                      kurdishText:
                          """منداڵەکە بێ‌شەرمانە ڕەتیکردەوە گوێ بگرێت و بە ئاراستەکەی دیکەدا ڕایکرد.""",
