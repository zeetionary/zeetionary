...
class EnglishEntryhardboiled extends StatefulWidget {
  const EnglishEntryhardboiled({super.key});

  @override
  State<EnglishEntryhardboiled> createState() => _EnglishEntryhardboiledState();
}

class _EnglishEntryhardboiledState extends State<EnglishEntryhardboiled> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adjective: hard-boiled
1. Tough and callous by virtue of experience (- hard-bitten, pugnacious)
"The hard-boiled politician seeks relief from his everyday battles";
 
2. Used of persons; emotionally hardened (- case-hardened, hardened)
"faced a hard-boiled judge";
 
3. (eggs) cooked until the yolk is solid
""",
  );

  final String keyword = "hard-boiled";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""hard-boiled""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""She ate a hard-boiled egg for breakfast.""");
  }
  ...
  Future<void> speaksentence2(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The detective was hard-boiled and fearless.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """hard-boiled""",
                      // alsoEnglishWord: "also: hard-boiled",
                      britshText: """IpaUK: /ˌhɑːd ˈbɔɪld/""",
                      americanText: """IpaUS: /ˌhɑːrd ˈbɔɪld/""",
...
"""),
                    ...
                    SentencesRow(
                      ...
                      kurdishText: """پشکنەرەکە چاونەترس و بێ‌ترس بوو.""",
