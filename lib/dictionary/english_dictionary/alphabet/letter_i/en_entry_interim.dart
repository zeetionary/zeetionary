...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const String videoIdend = 'at_1INOoKps';
    const double startSecondsend = 184;
    const String videoIdone = 'CeSAjK2CBEA';
    const double startSecondsone = 68;
    const String videoIdtwo = 'kzgFwZEAHZQ';
    const double startSecondstwo = 2937;
    const String videoIdthree = 'OK8IAAvpYKw';
    const double startSecondsthree = 853;
    const String videoIdfour = '5c_YoU0Kdvk';
    const double startSecondsfour = 488;
    const String videoIdfive = 'oXPhvh4eGcM';
    const double startSecondsfive = 688;
