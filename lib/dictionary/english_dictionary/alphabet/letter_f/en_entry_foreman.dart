...
class EnglishEntryforeman extends StatefulWidget {
  const EnglishEntryforeman({super.key});

  @override
  State<EnglishEntryforeman> createState() => _EnglishEntryforemanState();
}

class _EnglishEntryforemanState extends State<EnglishEntryforeman> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: foreman (Derived forms: foremen)
1. A person who exercises control over workers (= chief, gaffer [Brit, informal], honcho [N. Amer, informal], boss)
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""foreman""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(1.0);
    await flutterTts.setSpeechRate(0.5);
    await flutterTts.speak("""He got a job as foreman of a building site.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """foreman""",
                      // alsoEnglishWord: "also: foreman",
                      britshText: """IpaUK: /ˈfɔːmən/""",
                      americanText: """IpaUS: /ˈfɔːrmən/""",
...
// With short examples define "foreman", please follow LX instructions
                    ...
                    SentencesRow(
                      ...
                      kurdishText:
                          """لە شوێنێکی بنیاتنان کارێکی وەک سەرپەرشتیار بەدەستخست.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/-7bIDbaU_zQ?t=';
const double _startSecondsend = 0000000000000000000000000001278;
const String _videoIdone = 'https://youtu.be/qWAagS_MANg?t=';
const double _startSecondsone = 000000000000000000000000000705;
const String _videoIdtwo = 'https://youtu.be/RZt7kE7PZMQ?t=';
const double _startSecondstwo = 000000000000000000000000000380;
const String _videoIdthree = 'https://youtu.be/L878W_WrTx8?t=';
const double _startSecondsthree = 000000000000000000000000000464;
const String _videoIdfour = 'https://youtu.be/DZziNktXZcU?t=';
const double _startSecondsfour = 000000000000000000000000000975;
const String _videoIdfive = 'https://youtu.be/s5V_qIZEOUg?t=';
const double _startSecondsfive = 000000000000000000000000000436;
