...
class EnglishEntryingrained extends StatefulWidget {
  const EnglishEntryingrained({super.key});

  @override
  State<EnglishEntryingrained> createState() => _EnglishEntryingrainedState();
}

class _EnglishEntryingrainedState extends State<EnglishEntryingrained> {
  @override
  void initState() {
    super.initState();
...
""",
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""ingrained""");
  }
