...
""",
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 0000000000000000000000000002125;
    const String videoIdone = 'https://youtu.be/b_rjBWmc1iQ?t=';
    const double startSecondsone = 0000000000000000000000000002273;
    ...
    const String videoIdfour = 'https://youtu.be/JcpboMScfIY?t=';
    const double startSecondsfour = 0000000000000000000000000003100;
    const String videoIdfive = 'https://youtu.be/cMBrvHsFD_8?t=';
    const double startSecondsfive = 0000000000000000000000000001341;
