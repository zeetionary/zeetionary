...
class EnglishEntryfirestation extends StatefulWidget {
  const EnglishEntryfirestation({super.key});

  @override
  State<EnglishEntryfirestation> createState() =>
      _EnglishEntryfirestationState();
}

class _EnglishEntryfirestationState extends State<EnglishEntryfirestation> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Noun: fire station (Derived forms: fire stations)
1. A station housing fire apparatus and firemen (= firehouse)
""",
  );

  final String keyword = "fire station";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.speak("""fire station""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.speak(
        """The meeting had to be abandoned after fire station officer, Dave Temple, was called away to a fire.""");
  }
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """fire station""",
                      // alsoEnglishWord: "also: fire station",
                      britshText: """IpaUK: /ˈfaɪə steɪʃn/""",
                      americanText: """IpaUS: /ˈfaɪər steɪʃn/""",
...
// With short examples define "fire station", please follow LX instructions
                    ...
                    SentencesRow(
                      englishText:
                          """The meeting had to be abandoned after fire station officer, Dave Temple, was called away to a fire.""",
                      kurdishText:
                          """چاوپێکەوتنەکە پێویست بوو کۆتایی پێ بهێندرێت لە دوای ئەوەی ئەفسەری بنکەی ئاگرکوژاندنەوە، دەیڤ تێمپڵ، بانگکرا بۆ ئاگرێک.""",
...
// 188888880002200
const String _videoIdend = 'https://youtu.be/67JzSRnyXr4?t=';
const double _startSecondsend = 000000000000000000000000000513;
const String _videoIdone = 'https://youtu.be/XlHzvTEstz8?t=';
const double _startSecondsone = 000000000000000000000000000738;
const String _videoIdtwo = 'https://youtu.be/9Lc3QKplEiI?t=';
const double _startSecondstwo = 0000000000000000000000000001719;
const String _videoIdthree = 'https://youtu.be/EikT1yA5b5E?t=';
const double _startSecondsthree = 0000000000000000000000000001432;
const String _videoIdfour = 'https://youtu.be/UFSsc8Dqz-g?t=';
const double _startSecondsfour = 000000000000000000000000000249;
const String _videoIdfive = 'https://youtu.be/c0A41LlIOTc?t=';
