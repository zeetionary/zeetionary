...
class EnglishEntryidentically extends StatefulWidget {
  const EnglishEntryidentically({super.key});

  @override
  State<EnglishEntryidentically> createState() =>
      _EnglishEntryidenticallyState();
}

class _EnglishEntryidenticallyState extends State<EnglishEntryidentically> {
  @override
  void initState() {
    super.initState();
...
""";
  ...
  final EnglishMeaningConst englishMeaningConst = const EnglishMeaningConst(
    text: """
- Adverb: identically
1. With complete identity; in an identical manner
"he is fitted with an identically similar one"
""",
  );

  final String keyword = "identically";
  ...
  Future<void> speakheadword(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""identically""");
  }
  ...
  Future<void> speaksentence1(String languageCode) async {
    ...
    await flutterTts.setPitch(ttsPitch);
    await flutterTts.setSpeechRate(ttsSpeechRate);
    await flutterTts.speak("""The children were dressed identically.""");
  }
  ...
  Widget build(BuildContext context) {
    ...
    const double startSecondsend = 000000000000000000000000000520;
    const String videoIdone = 'https://youtu.be/RQYuyHNLPTQ?t=';
    const double startSecondsone = 000000000000000000000000000790;
    const String videoIdtwo = 'https://youtu.be/aABFIzfg72A?t=';
    const double startSecondstwo = 000000000000000000000000000271;
    const String videoIdthree = 'https://youtu.be/9yrj2iSuI38?t=';
    const double startSecondsthree = 00000000000000000000000000069;
    const String videoIdfour = 'https://youtu.be/KIqQ0gowzt4?t=';
    const double startSecondsfour = 000000000000000000000000000322;
    const String videoIdfive = 'https://youtu.be/t5k7feqZUD0?t=';
    const double startSecondsfive = 000000000000000000000000000739;
                ...
                flexibleSpace: FlexibleSpaceBar(
                  background: SingleChildScrollView(
                    child: EntryPageColumn(
                      word: """identically""",
                      // alsoEnglishWord: "also: identically",
                      britshText: """IpaUK: /aɪˈdentɪkli/""",
                      americanText: """IpaUS: /aɪˈdentɪkli/""",
...
کوردی: دروست وەکوو یەک، وەک یەک
"""),
// With short examples define "identically", please follow LX instructions
                    const DefinitionKurdish(
                        text: """١. (ھاوەڵکار) ڕێک وەک یەکدی"""),
                    SentencesRow(
                      englishText: """The children were dressed identically.""",
                      kurdishText:
                          """منداڵەکان درووست وەک یەکدی جلیان لەبەربوو.""",
